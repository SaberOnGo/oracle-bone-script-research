# obs-char-000439 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000439`
- primary external id: `hust-obc-cat-0499`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/439_obs-char-000439_hust-obc-cat-0499_orac
  le-character/03_visual-assets/001_asset-000444_hust-obc-cat-0499_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0499/G_0499_前3.33.8(甲).png`
- asset id: `asset-000444`
...
- source category: `0499`
- validation class: `438`
- source image route: `HUST-OBC/deciphered/0499/G_0499_前3.33.8(甲).png`
- asset id: `asset-000444`
...
- English observation: `A compact angular cluster at left connects or
  closely approaches a thin branching form at upper right; two long angled
  strokes descend below.`
- 中文观察: `左侧紧凑折角笔画群与右上纤细分支形体相接或紧邻，下方有两条长斜笔。`
...
- dataset label text: `㗩`
- dataset label codepoints: `U+35E9`
...
- Which source records identify obs-char-000439 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000439？
