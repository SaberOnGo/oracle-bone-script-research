# obs-char-000170 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/170_obs-char-000170_hust-obc-cat-0186_orac
  le-character/03_visual-assets/001_asset-000175_hust-obc-cat-0186_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0186/G_0186_乙3798合17644.png`
- asset id: `asset-000175`
...
- source category: `0186`
- validation class: `169`
- source image route: `HUST-OBC/deciphered/0186/G_0186_乙3798合17644.png`
- asset id: `asset-000175`
...
- English observation: `The low-resolution gray image has a thin central
  vertical stroke, a small upper branch, and short side strokes crossing
  near the middle.`
- 中文观察: `低分辨率灰度图像有细中央竖笔，上方有小分支，中部附近有短侧笔交叉。`
...
- dataset label text: `㒰`
- dataset label codepoints: `U+34B0`
...
- filename catalog route clues: `Heji-like filename clue: 合17644
  (G_0186_乙3798合17644.png)`
...
- Which source records identify obs-char-000170 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000170？
