...
- `obs-evo-cand-013279-route-category-staging`
...
- `obs-evo-cand-013279-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013279-route-evolution-graph`
