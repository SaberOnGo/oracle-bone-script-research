...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000493` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2417` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `335` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `385` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `40920` [route_present_image_or_text_not_collected]
