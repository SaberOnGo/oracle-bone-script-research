...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000363` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2082` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `440` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `***` [route_missing_or_unassigned]
- `heji_reference`: Heji reference `41184` [route_present_image_or_text_not_collected]
