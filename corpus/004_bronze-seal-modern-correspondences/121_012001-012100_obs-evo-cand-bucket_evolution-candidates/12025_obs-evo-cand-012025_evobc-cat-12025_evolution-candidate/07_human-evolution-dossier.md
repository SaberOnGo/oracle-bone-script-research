...
- Project ID: `obs-evo-cand-012025`
- EVOBC category candidate ID: `evobc-evo-cat-12025`
- External category reference: `evobc-cat-12025`
- Source category ID: `12025`
- Source label for human review: `𦓥`
- Source codepoints: `U+264E5`
...
- `obs-evo-cand-012025-route-category-staging`
...
- `obs-evo-cand-012025-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012025-route-evolution-graph`
