# obs-unk-004211 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/011_obs-unk-004211_h
  ust-obc-und-L-004211_oracle-character-candidate/03_visual-assets/001_asset
  -005804_hust-obc-und-L-004211_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4211/L_？_9170.jpg`
- asset id: `asset-005804`
...
- source class: `HUST-OBC/undeciphered/L/4211/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4211/L_？_9170.jpg`
- asset id: `asset-005804`
...
- English observation: `Upper outline, central trace, lower diagonals visible.`
- 中文观察: `上部轮廓、中央痕迹和下部斜笔画可见。`
...
- Which source records identify obs-unk-004211 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004211？
