# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001514
...
| Glyph or codepoint route / 字形或码位路线 | 5 OBIMD route rows; examples U+F8C29; U+F8C2A; 另有 3 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
