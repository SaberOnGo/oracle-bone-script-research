# obs-unk-000611 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000611`
- primary external id: `hust-obc-und-L-000611`
...
- local review image route: `corpus/001_oracle-characters/023_undeciphered-000
  601-000700_obs-unk-bucket_oracle-character-candidates/011_obs-unk-000611_h
  ust-obc-und-L-000611_oracle-character-candidate/03_visual-assets/001_asset
  -002204_hust-obc-und-L-000611_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/611/L_？_11840.jpg`
- asset id: `asset-002204`
...
- source class: `HUST-OBC/undeciphered/L/611/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/611/L_？_11840.jpg`
- asset id: `asset-002204`
...
- Which source records identify obs-unk-000611 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000611？
