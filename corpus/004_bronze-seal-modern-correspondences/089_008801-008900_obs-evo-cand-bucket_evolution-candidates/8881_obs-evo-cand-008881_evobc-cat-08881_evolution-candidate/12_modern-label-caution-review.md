# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008881
...
- EVOBC candidate category: `evobc-evo-cat-08881`.
- Source label for search only: `轛`.
- Source codepoints for search only: `U+8F5B`.
