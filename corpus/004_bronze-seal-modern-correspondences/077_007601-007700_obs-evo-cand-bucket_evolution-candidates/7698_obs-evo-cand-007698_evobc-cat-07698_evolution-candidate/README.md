# obs-evo-cand-007698 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-007698`
- EVOBC category candidate ID: `evobc-evo-cat-07698`
- External category ref: `evobc-cat-07698`
- Source label: `處`
- Source codepoints: `U+8655`
- Image reference count: `65`
- Era token counts: `BI:24;CS:1;SS:2;WSC:38`
- Source token counts: `Book:30;Web:35`

## Observed Code Rows / 观察到的代码行

- era 1 / BI: 24 image references
- era 2 / SS: 2 image references
- era 4 / WSC: 38 image references
