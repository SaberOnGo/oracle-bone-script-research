...
Project ID: `obs-evo-cand-004879`
...
- Project ID: `obs-evo-cand-004879`
- EVOBC category candidate ID: `evobc-evo-cat-04879`
- External category reference: `evobc-cat-04879`
- Source category ID: `04879`
- Source label for human review: `漮`
- Source codepoints: `U+6F2E`
...
- `obs-evo-cand-004879-route-category-staging`
...
- `obs-evo-cand-004879-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004879-route-evolution-graph`
