...
- External category reference: `evobc-cat-04447`
- Source category ID: `04447`
- Source label for human review: `毒`
- Source codepoints: `U+6BD2`
...
- `obs-evo-cand-004447-route-category-staging`
...
- `obs-evo-cand-004447-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004447-route-evolution-graph`
