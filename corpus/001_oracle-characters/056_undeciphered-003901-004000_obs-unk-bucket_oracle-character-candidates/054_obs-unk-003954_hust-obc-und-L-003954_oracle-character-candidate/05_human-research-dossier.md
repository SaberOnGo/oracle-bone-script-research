# obs-unk-003954 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003954`
- primary external id: `hust-obc-und-L-003954`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/054_obs-unk-003954_h
  ust-obc-und-L-003954_oracle-character-candidate/03_visual-assets/001_asset
  -005547_hust-obc-und-L-003954_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3954/L_？_8340.jpg`
- asset id: `asset-005547`
...
- source class: `HUST-OBC/undeciphered/L/3954/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3954/L_？_8340.jpg`
- asset id: `asset-005547`
...
- English observation: A rounded enclosure has a short inner angled trace and
  two narrow lower traces meeting a low curved or horizontal base.
- 中文观察：弧状围合轮廓内有短斜痕，下方两条窄痕与低处弧线或横痕相接。
...
- Which source records identify obs-unk-003954 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003954？
