# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000448
...
| --- | --- | --- | --- |
| `obimd-glyph-link-006409` | 󲥈 | `U+F2948` | `reviewed_metadata_only` |
| `obimd-glyph-link-006410` | 󲥉 | `U+F2949` | `reviewed_metadata_only` |
| `obimd-glyph-link-006411` | 󲥋 | `U+F294B` | `reviewed_metadata_only` |
