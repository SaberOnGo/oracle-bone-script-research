# obs-char-000472 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000472`
- primary external id: `hust-obc-cat-0534`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/472_obs-char-000472_hust-obc-cat-0534_orac
  le-character/03_visual-assets/001_asset-000477_hust-obc-cat-0534_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0534/G_0534_甲骨文.png`
- asset id: `asset-000477`
...
- source category: `0534`
- validation class: `471`
- source image route: `HUST-OBC/deciphered/0534/G_0534_甲骨文.png`
- asset id: `asset-000477`
...
- English observation: `A broad arched outer outline encloses an irregular
  inner form with an upper curve, a left angular branch, and two narrow
  descending strokes.`
- 中文观察: `宽拱形外轮廓包围不规则内形，其中有上部弧线、左侧折角分支和两条狭长下行笔画。`
...
- dataset label text: `㘌`
- dataset label codepoints: `U+360C`
...
- Which source records identify obs-char-000472 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000472？
