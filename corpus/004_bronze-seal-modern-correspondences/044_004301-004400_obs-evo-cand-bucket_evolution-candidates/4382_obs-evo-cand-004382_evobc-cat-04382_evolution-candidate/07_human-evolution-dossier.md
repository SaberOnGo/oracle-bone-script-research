...
- External category reference: `evobc-cat-04382`
- Source category ID: `04382`
- Source label for human review: `歟`
...
- `obs-evo-cand-004382-route-category-staging`
...
- `obs-evo-cand-004382-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004382-route-evolution-graph`
