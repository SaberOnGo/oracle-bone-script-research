...
Project ID: `obs-evo-cand-005670`
...
- Project ID: `obs-evo-cand-005670`
- EVOBC category candidate ID: `evobc-evo-cat-05670`
- External category reference: `evobc-cat-05670`
- Source category ID: `05670`
- Source label for human review: `瘛`
- Source codepoints: `U+761B`
...
- `obs-evo-cand-005670-route-category-staging`
...
- `obs-evo-cand-005670-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005670-route-evolution-graph`
