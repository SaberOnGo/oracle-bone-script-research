...
- Yingguo / 英国所藏: `y2551` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `373` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `492` in source row; primary catalog entry pending
- Heji / 合集: `41830` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000546`
