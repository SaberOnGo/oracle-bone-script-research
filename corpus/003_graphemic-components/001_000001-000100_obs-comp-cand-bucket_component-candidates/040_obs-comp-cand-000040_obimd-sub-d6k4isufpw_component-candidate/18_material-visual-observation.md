# Material Visual Observation / obs-comp-cand-000040 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000040`
- External reference / 外部参照: `obimd-sub-d6k4isufpw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011297_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/d6k4isufpw/d6k4isufpw/d6k4isufpw.png`
- Checksum / 校验和:
  `fc1251e5fe8ec28602a84ffcfd796e5e5ce1654269c699962704a1fa8ee26b34`
...
- Marked-pixel bounds: (75,22)–(174,227); span 100 × 206 px; the marked
...
- 痕迹范围：(75,22)–(174,227)；跨度100 × 206 px；痕迹矩形高于宽。
