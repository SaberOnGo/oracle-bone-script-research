# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010504
...
- EVOBC candidate category: `evobc-evo-cat-10504`.
- Source label for search only: `鴻`.
- Source codepoints for search only: `U+9D3B`.
