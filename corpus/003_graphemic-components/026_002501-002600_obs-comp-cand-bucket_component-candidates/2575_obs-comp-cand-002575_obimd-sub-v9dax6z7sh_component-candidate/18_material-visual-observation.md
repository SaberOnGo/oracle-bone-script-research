# Material Visual Observation / obs-comp-cand-002575 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002575`
- External reference / 外部参照: `obimd-sub-v9dax6z7sh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021107_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/v9dax6z7sh/v9dax6z7sh/v9dax6z7sh.png`
- Checksum / 校验和:
  `13542a4f30cbe0eb6a173588f7ee07732af3edcbaabfeed6974cbce75209379e`
...
- Marked-pixel bounds: (65,35)–(202,214); span 138 × 180 px; the marked
...
- 痕迹范围：(65,35)–(202,214)；跨度138 × 180 px；痕迹矩形高于宽。
