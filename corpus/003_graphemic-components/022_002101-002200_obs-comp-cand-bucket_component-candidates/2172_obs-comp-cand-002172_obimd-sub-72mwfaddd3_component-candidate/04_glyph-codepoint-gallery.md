# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002172
...
| --- | --- | --- | --- |
| `obimd-glyph-link-033833` | 󼟻 | `U+FC7FB` | `reviewed_metadata_only` |
| `obimd-glyph-link-033834` | 󼟼 | `U+FC7FC` | `reviewed_metadata_only` |
| `obimd-glyph-link-033835` | 󼟽 | `U+FC7FD` | `reviewed_metadata_only` |
