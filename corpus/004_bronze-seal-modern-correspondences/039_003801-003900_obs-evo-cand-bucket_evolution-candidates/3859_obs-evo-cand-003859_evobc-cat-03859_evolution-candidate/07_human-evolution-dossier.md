...
- Project ID: `obs-evo-cand-003859`
- EVOBC category candidate ID: `evobc-evo-cat-03859`
- External category reference: `evobc-cat-03859`
- Source category ID: `03859`
- Source label for human review: `机`
- Source codepoints: `U+673A`
...
- `obs-evo-cand-003859-route-category-staging`
...
- `obs-evo-cand-003859-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003859-route-evolution-graph`
