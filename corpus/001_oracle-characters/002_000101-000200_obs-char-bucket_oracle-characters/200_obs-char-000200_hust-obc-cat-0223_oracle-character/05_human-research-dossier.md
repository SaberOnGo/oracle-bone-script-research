# obs-char-000200 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000200`
- primary external id: `hust-obc-cat-0223`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/200_obs-char-000200_hust-obc-cat-0223_orac
  le-character/03_visual-assets/001_asset-000205_hust-obc-cat-0223_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0223/G_0223_乙5303(甲).png`
- asset id: `asset-000205`
...
- source category: `0223`
- validation class: `199`
- source image route: `HUST-OBC/deciphered/0223/G_0223_乙5303(甲).png`
- asset id: `asset-000205`
...
- English observation: `The image has a small upper cap above a rectangular
  enclosure on the left, with a long descending stroke and a short branch on
  the right.`
- 中文观察: `图像上方有小盖状笔，左侧为长方形围合，右侧有长下行笔并带短分支。`
...
- dataset label text: `㓕`
- dataset label codepoints: `U+34D5`
...
- Which source records identify obs-char-000200 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000200？
