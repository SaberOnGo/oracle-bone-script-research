# Material Visual Observation / obs-comp-cand-000012 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000012`
- External reference / 外部参照: `obimd-sub-jnpp6r84xp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011077_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jnpp6r84xp/jnpp6r84xp/jnpp6r84xp.png`
- Checksum / 校验和:
  `e184b26640f36a77d33417557cae224223a559f3b68dca1a7f44676b492cf0a3`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.20%.
- Marked-pixel bounds: (83,17)–(166,231); span 84 × 215 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.20%。
- 痕迹范围：(83,17)–(166,231)；跨度84 × 215 px；痕迹矩形高于宽。
