...
Project ID: `obs-evo-cand-002495`
...
- Project ID: `obs-evo-cand-002495`
- EVOBC category candidate ID: `evobc-evo-cat-02495`
- External category reference: `evobc-cat-02495`
- Source category ID: `02495`
- Source label for human review: `局`
- Source codepoints: `U+5C40`
...
- `obs-evo-cand-002495-route-category-staging`
...
- `obs-evo-cand-002495-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002495-route-evolution-graph`
