...
Project ID: `obs-evo-cand-013628`
...
- Project ID: `obs-evo-cand-013628`
- EVOBC category candidate ID: `evobc-evo-cat-13628`
- External category reference: `evobc-cat-13628`
- Source category ID: `13628`
- Source label for human review: `𮏍`
- Source codepoints: `U+2E3CD`
...
- `obs-evo-cand-013628-route-category-staging`
...
- `obs-evo-cand-013628-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013628-route-evolution-graph`
