...
- External category reference: `evobc-cat-01151`
- Source category ID: `01151`
...
- `obs-evo-cand-001151-route-category-staging`
...
- `obs-evo-cand-001151-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001151-route-evolution-graph`
