# Material Visual Observation / obs-comp-cand-000767 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000767`
- External reference / 外部参照: `obimd-sub-rmhcdsa8k2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013530_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/imnwy7c15d/rmhcdsa8k2/rmhcdsa8k2.png`
- Checksum / 校验和:
  `adf815ed84c65bc3b69a976c15f7b27fd0cb24a64e39e0cad19f4e346fb9c1ca`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.87%.
- Marked-pixel bounds: (83,22)–(166,228); span 84 × 207 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.87%。
- 痕迹范围：(83,22)–(166,228)；跨度84 × 207 px；痕迹矩形高于宽。
