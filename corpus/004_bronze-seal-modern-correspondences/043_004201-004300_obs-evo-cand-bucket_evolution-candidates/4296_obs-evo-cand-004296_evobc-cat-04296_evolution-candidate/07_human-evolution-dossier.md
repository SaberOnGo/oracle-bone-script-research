...
Project ID: `obs-evo-cand-004296`
...
- Project ID: `obs-evo-cand-004296`
- EVOBC category candidate ID: `evobc-evo-cat-04296`
- External category reference: `evobc-cat-04296`
- Source category ID: `04296`
- Source label for human review: `檮`
- Source codepoints: `U+6AAE`
...
- `obs-evo-cand-004296-route-category-staging`
...
- `obs-evo-cand-004296-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004296-route-evolution-graph`
