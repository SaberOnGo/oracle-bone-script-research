...
- External category reference: `evobc-cat-09427`
- Source category ID: `09427`
...
- `obs-evo-cand-009427-route-category-staging`
...
- `obs-evo-cand-009427-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009427-route-evolution-graph`
