# obs-char-000313 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/313_obs-char-000313_hust-obc-cat-0353_orac
  le-character/03_visual-assets/001_asset-000318_hust-obc-cat-0353_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0353/G_0353_中大107.png`
- asset id: `asset-000318`
...
- source category: `0353`
- validation class: `312`
- source image route: `HUST-OBC/deciphered/0353/G_0353_中大107.png`
- asset id: `asset-000318`
...
- English observation: `A broad arched enclosure spans the middle, with a
  small upper enclosure and several pointed strokes descending from the
  lower edge.`
- 中文观察: `图像中部为宽拱形闭合轮廓，上方有小型闭合轮廓，下缘向下伸出数道尖状笔画。`
...
- dataset label text: `㕗`
- dataset label codepoints: `U+3557`
...
- Which source records identify obs-char-000313 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000313？
