...
Project ID: `obs-evo-cand-007149`
...
- Project ID: `obs-evo-cand-007149`
- EVOBC category candidate ID: `evobc-evo-cat-07149`
- External category reference: `evobc-cat-07149`
- Source category ID: `07149`
- Source label for human review: `臇`
- Source codepoints: `U+81C7`
...
- `obs-evo-cand-007149-route-category-staging`
...
- `obs-evo-cand-007149-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007149-route-evolution-graph`
