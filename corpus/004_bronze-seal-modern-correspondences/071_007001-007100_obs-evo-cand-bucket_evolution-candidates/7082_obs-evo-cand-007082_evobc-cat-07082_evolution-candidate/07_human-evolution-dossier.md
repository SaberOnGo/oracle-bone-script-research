...
- Project ID: `obs-evo-cand-007082`
- EVOBC category candidate ID: `evobc-evo-cat-07082`
- External category reference: `evobc-cat-07082`
- Source category ID: `07082`
- Source label for human review: `脽`
- Source codepoints: `U+813D`
- Image reference count in source metadata: `37`
...
- `obs-evo-cand-007082-route-category-staging`
...
- `obs-evo-cand-007082-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007082-route-evolution-graph`
