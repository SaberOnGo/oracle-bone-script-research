# obs-unk-006637 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/083_undeciphered-006
  601-006700_obs-unk-bucket_oracle-character-candidates/037_obs-unk-006637_h
  ust-obc-und-X-006637_oracle-character-candidate/03_visual-assets/001_asset
  -008228_hust-obc-und-X-006637_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2193/X_？_6526_1.png`
- asset id: `asset-008228`
...
- source class: `HUST-OBC/undeciphered/X/2193/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2193/X_？_6526_1.png`
- asset id: `asset-008228`
...
- Which source records identify obs-unk-006637 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006637？
