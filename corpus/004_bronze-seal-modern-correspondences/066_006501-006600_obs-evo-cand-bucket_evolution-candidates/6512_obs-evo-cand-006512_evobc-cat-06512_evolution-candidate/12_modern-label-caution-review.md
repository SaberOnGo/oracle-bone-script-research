# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006512
...
- EVOBC candidate category: `evobc-evo-cat-06512`.
- Source label for search only: `絡`.
- Source codepoints for search only: `U+7D61`.
