...
- `obs-evo-cand-004873-route-category-staging`
...
- `obs-evo-cand-004873-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004873-route-evolution-graph`
