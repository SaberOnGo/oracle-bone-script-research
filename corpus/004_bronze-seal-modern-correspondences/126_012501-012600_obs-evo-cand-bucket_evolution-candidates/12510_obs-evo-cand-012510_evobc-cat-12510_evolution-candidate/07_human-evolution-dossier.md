...
- Project ID: `obs-evo-cand-012510`
- EVOBC category candidate ID: `evobc-evo-cat-12510`
- External category reference: `evobc-cat-12510`
- Source category ID: `12510`
- Source label for human review: `𨴲`
- Source codepoints: `U+28D32`
...
- `obs-evo-cand-012510-route-category-staging`
...
- `obs-evo-cand-012510-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012510-route-evolution-graph`
