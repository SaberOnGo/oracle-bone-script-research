...
- `obs-evo-cand-013481-route-category-staging`
...
- `obs-evo-cand-013481-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013481-route-evolution-graph`
