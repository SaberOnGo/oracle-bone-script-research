...
- External category reference: `evobc-cat-01872`
- Source category ID: `01872`
- Source label for human review: `埍`
- Source codepoints: `U+57CD`
...
- `obs-evo-cand-001872-route-category-staging`
...
- `obs-evo-cand-001872-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001872-route-evolution-graph`
