...
Project ID: `obs-evo-cand-007919`
...
- Project ID: `obs-evo-cand-007919`
- EVOBC category candidate ID: `evobc-evo-cat-07919`
- External category reference: `evobc-cat-07919`
- Source category ID: `07919`
- Source label for human review: `补`
- Source codepoints: `U+8865`
...
- `obs-evo-cand-007919-route-category-staging`
...
- `obs-evo-cand-007919-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007919-route-evolution-graph`
