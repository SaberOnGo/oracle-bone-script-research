# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000827
...
| --- | --- | --- | --- |
| `obimd-glyph-link-011861` | 󴪢 | `U+F4AA2` | `reviewed_metadata_only` |
| `obimd-glyph-link-011862` | 󴪣 | `U+F4AA3` | `reviewed_metadata_only` |
| `obimd-glyph-link-011863` | 󴪤 | `U+F4AA4` | `reviewed_metadata_only` |
