...
- External category reference: `evobc-cat-10563`
- Source category ID: `10563`
- Source label for human review: `鷯`
- Source codepoints: `U+9DEF`
...
- `obs-evo-cand-010563-route-category-staging`
...
- `obs-evo-cand-010563-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010563-route-evolution-graph`
