...
- External category reference: `evobc-cat-11366`
- Source category ID: `11366`
- Source label for human review: `𣀘`
...
- `obs-evo-cand-011366-route-category-staging`
...
- `obs-evo-cand-011366-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011366-route-evolution-graph`
