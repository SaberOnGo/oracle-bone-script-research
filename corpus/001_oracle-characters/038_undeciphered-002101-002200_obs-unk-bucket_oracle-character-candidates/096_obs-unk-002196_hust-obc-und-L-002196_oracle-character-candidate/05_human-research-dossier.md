# obs-unk-002196 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002196`
- primary external id: `hust-obc-und-L-002196`
...
- local review image route: `corpus/001_oracle-characters/038_undeciphered-002
  101-002200_obs-unk-bucket_oracle-character-candidates/096_obs-unk-002196_h
  ust-obc-und-L-002196_oracle-character-candidate/03_visual-assets/001_asset
  -003789_hust-obc-und-L-002196_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2196/L_？_2605.jpg`
- asset id: `asset-003789`
...
- source class: `HUST-OBC/undeciphered/L/2196/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2196/L_？_2605.jpg`
- asset id: `asset-003789`
...
- Which source records identify obs-unk-002196 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002196？
