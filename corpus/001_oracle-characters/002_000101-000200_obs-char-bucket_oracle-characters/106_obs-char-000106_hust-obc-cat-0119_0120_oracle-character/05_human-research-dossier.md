# obs-char-000106 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000106`
- primary external id: `hust-obc-cat-0119_0120`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/106_obs-char-000106_hust-obc-cat-0119_0120
  _oracle-character/03_visual-assets/001_asset-000111_hust-obc-cat-0119_0120
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0119_0120/0119/G_0119_乙108合2102
  2𠂤組.png`
- asset id: `asset-000111`
...
- source category: `0119_0120`
- validation class: `105`
- source image route: `HUST-OBC/deciphered/0119_0120/0119/G_0119_乙108合21022𠂤組.
  png`
- asset id: `asset-000111`
...
- English observation: `The image has two short upper horizontal strokes, a
  curved lower loop, and a separate hooked stroke on the lower left.`
- 中文观察: `图像上方有两道短横笔，下方有弧形环状笔，左下另有分离的钩状笔。`
...
- dataset label text: `㑭㑮`
- dataset label codepoints: `U+346D;U+346E`
...
- graph edge count: `2`
- codepoint routes: `U+346D;U+346E`
...
- filename catalog route clues: `Heji-like filename clue: 合21022
  (G_0119_乙108合21022𠂤組.png)`
...
- Which source records identify obs-char-000106 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000106？
