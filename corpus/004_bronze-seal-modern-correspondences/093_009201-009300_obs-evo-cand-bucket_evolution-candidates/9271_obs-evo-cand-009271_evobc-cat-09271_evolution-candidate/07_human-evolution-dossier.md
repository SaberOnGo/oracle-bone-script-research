...
- External category reference: `evobc-cat-09271`
- Source category ID: `09271`
- Source label for human review: `醒`
- Source codepoints: `U+9192`
...
- `obs-evo-cand-009271-route-category-staging`
...
- `obs-evo-cand-009271-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009271-route-evolution-graph`
