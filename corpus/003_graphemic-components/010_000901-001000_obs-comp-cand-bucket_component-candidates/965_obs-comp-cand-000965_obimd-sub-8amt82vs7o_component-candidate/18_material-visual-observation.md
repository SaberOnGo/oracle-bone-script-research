# Material Visual Observation / obs-comp-cand-000965 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000965`
- External reference / 外部参照: `obimd-sub-8amt82vs7o`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014048_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8amt82vs7o/8amt82vs7o/8amt82vs7o.png`
- Checksum / 校验和:
  `d016ffa3d09eb20f6e508cd66686274d36a94a0e5ff777cd9cd080cab675ed98`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.89%.
- Marked-pixel bounds: (69,31)–(167,213); span 99 × 183 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.89%。
- 痕迹范围：(69,31)–(167,213)；跨度99 × 183 px；痕迹矩形高于宽。
