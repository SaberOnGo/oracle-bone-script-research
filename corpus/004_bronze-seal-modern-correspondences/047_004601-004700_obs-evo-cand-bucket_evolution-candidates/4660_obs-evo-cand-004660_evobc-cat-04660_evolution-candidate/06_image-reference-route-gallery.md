...
- `obs-evo-cand-004660-route-category-staging`
...
- `obs-evo-cand-004660-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004660-route-evolution-graph`
