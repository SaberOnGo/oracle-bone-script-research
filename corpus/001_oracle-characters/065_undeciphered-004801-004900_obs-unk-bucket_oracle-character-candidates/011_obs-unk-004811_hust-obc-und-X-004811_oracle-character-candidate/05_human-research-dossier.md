# obs-unk-004811 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004811`
- primary external id: `hust-obc-und-X-004811`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/011_obs-unk-004811_h
  ust-obc-und-X-004811_oracle-character-candidate/03_visual-assets/001_asset
  -006404_hust-obc-und-X-004811_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/367/X_？_7352_1.png`
- asset id: `asset-006404`
...
- source class: `HUST-OBC/undeciphered/X/367/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/367/X_？_7352_1.png`
- asset id: `asset-006404`
...
- English observation: `upper fragments, long left stroke, and lower curve`
- 中文观察: `上部片段、左侧长笔画和下部曲线`
...
- Which source records identify obs-unk-004811 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004811？
