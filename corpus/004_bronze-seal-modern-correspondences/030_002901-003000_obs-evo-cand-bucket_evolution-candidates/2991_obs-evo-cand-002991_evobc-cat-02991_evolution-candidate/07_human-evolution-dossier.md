...
Project ID: `obs-evo-cand-002991`
...
- Project ID: `obs-evo-cand-002991`
- EVOBC category candidate ID: `evobc-evo-cat-02991`
- External category reference: `evobc-cat-02991`
- Source category ID: `02991`
- Source label for human review: `恰`
- Source codepoints: `U+6070`
...
- `obs-evo-cand-002991-route-category-staging`
...
- `obs-evo-cand-002991-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002991-route-evolution-graph`
