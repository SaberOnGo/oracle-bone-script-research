...
- External category reference: `evobc-cat-04882`
- Source category ID: `04882`
- Source label for human review: `漸`
- Source codepoints: `U+6F38`
...
- `obs-evo-cand-004882-route-category-staging`
...
- `obs-evo-cand-004882-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004882-route-evolution-graph`
