# obs-unk-006732 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006732`
- primary external id: `hust-obc-und-X-006732`
...
- local review image route: `corpus/001_oracle-characters/084_undeciphered-006
  701-006800_obs-unk-bucket_oracle-character-candidates/032_obs-unk-006732_h
  ust-obc-und-X-006732_oracle-character-candidate/03_visual-assets/001_asset
  -008323_hust-obc-und-X-006732_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2288/X_？_996_1.png`
- asset id: `asset-008323`
...
- source class: `HUST-OBC/undeciphered/X/2288/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2288/X_？_996_1.png`
- asset id: `asset-008323`
...
- Which source records identify obs-unk-006732 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006732？
