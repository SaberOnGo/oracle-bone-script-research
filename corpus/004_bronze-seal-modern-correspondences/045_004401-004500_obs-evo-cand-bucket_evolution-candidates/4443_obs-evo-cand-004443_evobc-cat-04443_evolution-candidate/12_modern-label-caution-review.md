# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004443
...
- EVOBC candidate category: `evobc-evo-cat-04443`.
- Source label for search only: `毌`.
- Source codepoints for search only: `U+6BCC`.
