...
|---|---|---|
| Source Codepoint Route | `U+36B8` | not identity |
| HUST candidate route | `hust-obc-cat-0706` | not reading |
| OBIMD route | `obimd-main-cand-001412` | not component |
| EVOBC route | `evobc-evo-cat-00049` | not evolution |
