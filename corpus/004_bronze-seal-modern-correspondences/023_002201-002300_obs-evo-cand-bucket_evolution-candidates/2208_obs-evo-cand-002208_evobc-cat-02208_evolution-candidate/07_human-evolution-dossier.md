...
- External category reference: `evobc-cat-02208`
- Source category ID: `02208`
- Source label for human review: `婦`
...
- `obs-evo-cand-002208-route-category-staging`
...
- `obs-evo-cand-002208-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002208-route-evolution-graph`
