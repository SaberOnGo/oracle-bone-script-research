...
- Project ID: `obs-evo-cand-000260`
- EVOBC category candidate ID: `evobc-evo-cat-00260`
- External category reference: `evobc-cat-00260`
- Source category ID: `00260`
- Source label for human review: `㾜`
- Source codepoints: `U+3F9C`
...
- `obs-evo-cand-000260-route-category-staging`
...
- `obs-evo-cand-000260-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000260-route-evolution-graph`
