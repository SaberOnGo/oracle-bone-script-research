# obs-char-000873 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000873`
- primary external id: `hust-obc-cat-0984_0985`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/873_obs-char-000873_hust-obc-cat-0984_0985
  _oracle-character/03_visual-assets/001_asset-000878_hust-obc-cat-0984_0985
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0984_0985/0984/G_0984_乙7336合831
  0賓組.png`
- asset id: `asset-000878`
...
- source category: `0984_0985`
- validation class: `872`
- source image route: `HUST-OBC/deciphered/0984_0985/0984/G_0984_乙7336合8310賓組.
  png`
- asset id: `asset-000878`
...
- English observation: `Several thin diagonal strokes form a central
  triangular lower junction, with tall side strokes and a detached short
  mark at right.`
- 中文观察: `数条纤细斜笔在下中部形成三角接点，两侧有高长侧笔，右侧另有分离短笔。`
...
- dataset label text: `㟎㟏`
- dataset label codepoints: `U+37CE;U+37CF`
...
- graph edge count: `2`
- codepoint routes: `U+37CE;U+37CF`
...
- filename catalog route clues: `Heji-like filename clue: 合8310
  (G_0984_乙7336合8310賓組.png)`
...
- Which source records identify obs-char-000873 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000873？
