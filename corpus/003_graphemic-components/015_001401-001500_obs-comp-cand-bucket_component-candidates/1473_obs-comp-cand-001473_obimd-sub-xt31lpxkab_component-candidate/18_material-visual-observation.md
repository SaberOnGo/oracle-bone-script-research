# Material Visual Observation / obs-comp-cand-001473 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001473`
- External reference / 外部参照: `obimd-sub-xt31lpxkab`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016050_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gqezg03aqo/xt31lpxkab/xt31lpxkab.png`
- Checksum / 校验和:
  `1ebb2e78633cc41842b68855106b61acaf78eb9c5118a2334e271a9a08556d31`
...
- Marked-pixel bounds: (85,33)–(164,224); span 80 × 192 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.16%。
- 痕迹范围：(85,33)–(164,224)；跨度80 × 192 px；痕迹矩形高于宽。
