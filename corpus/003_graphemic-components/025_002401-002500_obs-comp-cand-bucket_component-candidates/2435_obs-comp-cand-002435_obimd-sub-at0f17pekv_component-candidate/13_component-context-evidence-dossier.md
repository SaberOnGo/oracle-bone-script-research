# obs-comp-cand-002435 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002435`
- 首选外部 ID: `obimd-sub-at0f17pekv`
- OBIMD subcharacter UID: `at0f17pekv`
- OBIMD main character UID: `at0f17pekv`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+FDE7E; U+FDE7F; 另有 1 项
