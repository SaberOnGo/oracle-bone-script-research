...
- External category reference: `evobc-cat-00838`
- Source category ID: `00838`
- Source label for human review: `侈`
- Source codepoints: `U+4F88`
...
- `obs-evo-cand-000838-route-category-staging`
...
- `obs-evo-cand-000838-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000838-route-evolution-graph`
