...
- Project ID: `obs-evo-cand-003834`
- EVOBC category candidate ID: `evobc-evo-cat-03834`
- External category reference: `evobc-cat-03834`
- Source category ID: `03834`
- Source label for human review: `朐`
- Source codepoints: `U+6710`
...
- `obs-evo-cand-003834-route-category-staging`
...
- `obs-evo-cand-003834-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003834-route-evolution-graph`
