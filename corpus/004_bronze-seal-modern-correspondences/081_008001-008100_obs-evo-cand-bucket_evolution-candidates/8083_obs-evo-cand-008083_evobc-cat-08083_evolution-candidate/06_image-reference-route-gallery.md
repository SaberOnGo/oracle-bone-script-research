...
- `obs-evo-cand-008083-route-category-staging`
...
- `obs-evo-cand-008083-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008083-route-evolution-graph`
