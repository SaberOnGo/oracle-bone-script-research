# obs-char-000968 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000968`
- primary external id: `hust-obc-cat-1088`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/968_obs-char-000968_hust-obc-cat-1088_orac
  le-character/03_visual-assets/001_asset-000973_hust-obc-cat-1088_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1088/G_1088_珠437合13000.png`
- asset id: `asset-000973`
...
- source category: `1088`
- validation class: `967`
- source image route: `HUST-OBC/deciphered/1088/G_1088_珠437合13000.png`
- asset id: `asset-000973`
...
- English observation: `A pointed oval-like enclosure is crossed by a
  horizontal stroke and a central vertical line.`
- 中文观察: `尖形椭圆状闭合轮廓被横笔和中央竖线交叉。`
...
- dataset label text: `㠶`
- dataset label codepoints: `U+3836`
...
- filename catalog route clues: `Heji-like filename clue: 合13000
  (G_1088_珠437合13000.png)`
...
- Which source records identify obs-char-000968 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000968？
