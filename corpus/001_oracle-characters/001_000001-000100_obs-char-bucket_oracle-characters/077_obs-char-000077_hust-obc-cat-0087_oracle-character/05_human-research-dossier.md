# obs-char-000077 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/077_obs-char-000077_hust-obc-cat-0087_orac
  le-character/03_visual-assets/001_asset-000082_hust-obc-cat-0087_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0087/G_0087_乙2243反合7440反.png`
- asset id: `asset-000082`
...
- source category: `0087`
- validation class: `76`
- source image route: `HUST-OBC/deciphered/0087/G_0087_乙2243反合7440反.png`
- asset id: `asset-000082`
...
- English observation: `The image shows several short parallel horizontal
  strokes grouped closely together.`
- 中文观察: `图像可见数条彼此接近的短平行横向笔画。`
...
- dataset label text: `㑍`
- dataset label codepoints: `U+344D`
...
- Which source records identify obs-char-000077 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000077？
