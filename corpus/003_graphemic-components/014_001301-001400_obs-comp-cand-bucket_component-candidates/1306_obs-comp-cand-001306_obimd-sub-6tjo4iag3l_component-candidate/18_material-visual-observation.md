# Material Visual Observation / obs-comp-cand-001306 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001306`
- External reference / 外部参照: `obimd-sub-6tjo4iag3l`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015643_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6tjo4iag3l/6tjo4iag3l/6tjo4iag3l.png`
- Checksum / 校验和:
  `14adbf780a8551b24e48988f444081833fae08fdda9db19dc2ee2ba2e261d6c2`
...
- Marked-pixel bounds: (91,30)–(163,225); span 73 × 196 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.93%。
- 痕迹范围：(91,30)–(163,225)；跨度73 × 196 px；痕迹矩形高于宽。
