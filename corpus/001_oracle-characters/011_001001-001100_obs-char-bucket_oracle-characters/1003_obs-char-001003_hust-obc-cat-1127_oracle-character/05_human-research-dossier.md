# obs-char-001003 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001003`
- primary external id: `hust-obc-cat-1127`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1003_obs-char-001003_hust-obc-cat-1127_ora
  cle-character/03_visual-assets/001_asset-001008_hust-obc-cat-1127_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1127/G_1127_京津4437合29112.png`
- asset id: `asset-001008`
...
- source category: `1127`
- validation class: `1002`
- source image route: `HUST-OBC/deciphered/1127/G_1127_京津4437合29112.png`
- asset id: `asset-001008`
...
- English observation: `A narrow rounded upper contour contains a central
  upright and ends in two short lower supports, with a small upper-left
  projection.`
- 中文观察: `狭长圆弧上部轮廓含中央直立笔，底部以两条短支撑笔收束，左上有小幅外伸笔。`
...
- dataset label text: `㡝`
- dataset label codepoints: `U+385D`
...
- filename catalog route clues: `Heji-like filename clue: 合29112
  (G_1127_京津4437合29112.png)`
...
- Which source records identify obs-char-001003 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001003？
