...
- External category reference: `evobc-cat-11247`
- Source category ID: `11247`
- Source label for human review: `𢝅`
- Source codepoints: `U+22745`
...
- `obs-evo-cand-011247-route-category-staging`
...
- `obs-evo-cand-011247-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011247-route-evolution-graph`
