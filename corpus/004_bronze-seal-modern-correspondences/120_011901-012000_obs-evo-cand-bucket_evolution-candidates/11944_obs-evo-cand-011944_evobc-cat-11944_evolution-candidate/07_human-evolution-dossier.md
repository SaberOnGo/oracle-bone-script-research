...
- External category reference: `evobc-cat-11944`
- Source category ID: `11944`
- Source label for human review: `𥿽`
...
- `obs-evo-cand-011944-route-category-staging`
...
- `obs-evo-cand-011944-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011944-route-evolution-graph`
