# Material Visual Observation / obs-comp-cand-002200 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002200`
- External reference / 外部参照: `obimd-sub-vpcd7inkf9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019906_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vpcd7inkf9/vpcd7inkf9/vpcd7inkf9.png`
- Checksum / 校验和:
  `195757422fb342804002989ceabcc3a3b582991117fe1d009617b3c172a40930`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.36%.
- Marked-pixel bounds: (95,31)–(167,212); span 73 × 182 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.36%。
- 痕迹范围：(95,31)–(167,212)；跨度73 × 182 px；痕迹矩形高于宽。
