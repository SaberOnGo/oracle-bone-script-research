...
- External category reference: `evobc-cat-10519`
- Source category ID: `10519`
- Source label for human review: `鵱`
- Source codepoints: `U+9D71`
...
- `obs-evo-cand-010519-route-category-staging`
...
- `obs-evo-cand-010519-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010519-route-evolution-graph`
