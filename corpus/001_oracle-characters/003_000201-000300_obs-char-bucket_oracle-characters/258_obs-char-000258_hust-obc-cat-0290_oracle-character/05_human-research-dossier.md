# obs-char-000258 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000258`
- primary external id: `hust-obc-cat-0290`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/258_obs-char-000258_hust-obc-cat-0290_orac
  le-character/03_visual-assets/001_asset-000263_hust-obc-cat-0290_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0290/G_0290_花275(甲).png`
- asset id: `asset-000263`
...
- source category: `0290`
- validation class: `257`
- source image route: `HUST-OBC/deciphered/0290/G_0290_花275(甲).png`
- asset id: `asset-000263`
...
- English observation: `The compact dark image has a dense rounded stroke
  cluster on the left and a taller angular open form on the right.`
- 中文观察: `紧凑深色图像左侧有密集圆弧笔画聚集，右侧有较高的开放折角形体。`
...
- dataset label text: `㔘`
- dataset label codepoints: `U+3518`
...
- Which source records identify obs-char-000258 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000258？
