...
- External category reference: `evobc-cat-07059`
- Source category ID: `07059`
- Source label for human review: `脑`
...
- `obs-evo-cand-007059-route-category-staging`
...
- `obs-evo-cand-007059-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007059-route-evolution-graph`
