# Material Visual Observation / obs-comp-cand-000299 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000299`
- External reference / 外部参照: `obimd-sub-f8y0ib1uvx`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012065_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qzgadtxm9i/f8y0ib1uvx/f8y0ib1uvx.png`
- Checksum / 校验和:
  `aaccba9746072868c66f73c81adc6e38d5abe4b1b91f5dfb92a49d26b534fc09`
...
- Marked-pixel bounds: (54,34)–(195,215); span 142 × 182 px; the marked
...
- 痕迹范围：(54,34)–(195,215)；跨度142 × 182 px；痕迹矩形高于宽。
