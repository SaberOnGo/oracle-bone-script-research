...
- External category reference: `evobc-cat-01346`
- Source category ID: `01346`
- Source label for human review: `匪`
...
- `obs-evo-cand-001346-route-category-staging`
...
- `obs-evo-cand-001346-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001346-route-evolution-graph`
