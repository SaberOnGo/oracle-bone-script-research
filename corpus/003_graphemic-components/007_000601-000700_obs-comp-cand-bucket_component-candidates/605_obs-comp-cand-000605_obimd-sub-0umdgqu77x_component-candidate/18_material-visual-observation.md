# Material Visual Observation / obs-comp-cand-000605 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000605`
- External reference / 外部参照: `obimd-sub-0umdgqu77x`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013138_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0umdgqu77x/0umdgqu77x/0umdgqu77x.png`
- Checksum / 校验和:
  `9573737df6c6cf48cc06abcec268182ea9073f9a72c743c0bd24f25133e921c1`
...
- Marked-pixel bounds: (67,12)–(182,236); span 116 × 225 px; the marked
...
- 痕迹范围：(67,12)–(182,236)；跨度116 × 225 px；痕迹矩形高于宽。
