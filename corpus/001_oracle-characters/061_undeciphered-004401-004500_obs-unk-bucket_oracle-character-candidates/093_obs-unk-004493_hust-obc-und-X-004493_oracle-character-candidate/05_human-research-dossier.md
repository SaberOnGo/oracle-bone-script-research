# obs-unk-004493 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004493`
- primary external id: `hust-obc-und-X-004493`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/093_obs-unk-004493_h
  ust-obc-und-X-004493_oracle-character-candidate/03_visual-assets/001_asset
  -006086_hust-obc-und-X-004493_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/49/X_？_8233_1.png`
- asset id: `asset-006086`
...
- source class: `HUST-OBC/undeciphered/X/49/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/49/X_？_8233_1.png`
- asset id: `asset-006086`
...
- English observation: `The upper enclosed marks, broad bar, lower open area,
  and long right-hand trace are directly recorded.`
- 中文观察: `已直接记录上部封闭痕迹、宽横痕、下部空白区和右侧长痕。`
...
- Which source records identify obs-unk-004493 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004493？
