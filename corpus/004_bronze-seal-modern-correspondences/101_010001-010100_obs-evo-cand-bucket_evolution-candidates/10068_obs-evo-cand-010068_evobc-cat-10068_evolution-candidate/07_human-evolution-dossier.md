...
- External category reference: `evobc-cat-10068`
- Source category ID: `10068`
- Source label for human review: `颯`
...
- `obs-evo-cand-010068-route-category-staging`
...
- `obs-evo-cand-010068-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010068-route-evolution-graph`
