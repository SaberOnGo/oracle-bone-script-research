...
- External category reference: `evobc-cat-07461`
- Source category ID: `07461`
- Source label for human review: `葈`
...
- `obs-evo-cand-007461-route-category-staging`
...
- `obs-evo-cand-007461-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007461-route-evolution-graph`
