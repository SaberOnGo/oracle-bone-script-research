...
Project ID: `obs-evo-cand-004148`
...
- Project ID: `obs-evo-cand-004148`
- EVOBC category candidate ID: `evobc-evo-cat-04148`
- External category reference: `evobc-cat-04148`
- Source category ID: `04148`
- Source label for human review: `楒`
- Source codepoints: `U+6952`
...
- `obs-evo-cand-004148-route-category-staging`
...
- `obs-evo-cand-004148-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004148-route-evolution-graph`
