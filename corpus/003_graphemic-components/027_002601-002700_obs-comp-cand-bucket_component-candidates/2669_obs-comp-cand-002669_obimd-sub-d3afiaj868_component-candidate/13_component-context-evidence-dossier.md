# obs-comp-cand-002669 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002669`
- 首选外部 ID: `obimd-sub-d3afiaj868`
- OBIMD subcharacter UID: `d3afiaj868`
- OBIMD main character UID: `d3afiaj868`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+FF091; U+FF092; 另有 2 项
