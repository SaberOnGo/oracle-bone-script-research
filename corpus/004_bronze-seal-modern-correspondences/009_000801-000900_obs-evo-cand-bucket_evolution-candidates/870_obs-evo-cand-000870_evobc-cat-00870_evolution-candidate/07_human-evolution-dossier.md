...
Project ID: `obs-evo-cand-000870`
...
- Project ID: `obs-evo-cand-000870`
- EVOBC category candidate ID: `evobc-evo-cat-00870`
- External category reference: `evobc-cat-00870`
- Source category ID: `00870`
- Source label for human review: `便`
- Source codepoints: `U+4FBF`
...
- `obs-evo-cand-000870-route-category-staging`
...
- `obs-evo-cand-000870-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000870-route-evolution-graph`
