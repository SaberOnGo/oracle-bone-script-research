...
- `obs-evo-cand-006552-route-category-staging`
...
- `obs-evo-cand-006552-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006552-route-evolution-graph`
