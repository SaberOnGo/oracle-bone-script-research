...
- Project ID: `obs-evo-cand-013302`
- EVOBC category candidate ID: `evobc-evo-cat-13302`
- External category reference: `evobc-cat-13302`
- Source category ID: `13302`
- Source label for human review: `𬚮`
- Source codepoints: `U+2C6AE`
- Image reference count in source metadata: `17`
...
- `obs-evo-cand-013302-route-category-staging`
...
- `obs-evo-cand-013302-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013302-route-evolution-graph`
