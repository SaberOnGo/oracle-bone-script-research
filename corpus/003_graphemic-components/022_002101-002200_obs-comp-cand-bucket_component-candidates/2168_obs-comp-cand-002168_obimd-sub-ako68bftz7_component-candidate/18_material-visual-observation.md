# Material Visual Observation / obs-comp-cand-002168 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002168`
- External reference / 外部参照: `obimd-sub-ako68bftz7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019869_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/medazzhc49/ako68bftz7/ako68bftz7.png`
- Checksum / 校验和:
  `e6791e811fb1a721f13cdc99affe88ac6e11d9420e1fb1ae20fa5df130606ebf`
...
- Marked-pixel bounds: (82,19)–(164,230); span 83 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.53%。
- 痕迹范围：(82,19)–(164,230)；跨度83 × 212 px；痕迹矩形高于宽。
