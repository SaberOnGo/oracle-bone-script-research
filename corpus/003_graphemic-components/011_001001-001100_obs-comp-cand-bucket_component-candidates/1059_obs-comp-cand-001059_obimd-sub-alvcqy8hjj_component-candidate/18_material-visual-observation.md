# Material Visual Observation / obs-comp-cand-001059 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001059`
- External reference / 外部参照: `obimd-sub-alvcqy8hjj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014609_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/alvcqy8hjj/alvcqy8hjj/alvcqy8hjj.png`
- Checksum / 校验和:
  `a43fba31649d7b153d8b9f5675c572ad694c91a0175435cafa4b6933fed30577`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.28%.
- Marked-pixel bounds: (68,38)–(181,215); span 114 × 178 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.28%。
- 痕迹范围：(68,38)–(181,215)；跨度114 × 178 px；痕迹矩形高于宽。
