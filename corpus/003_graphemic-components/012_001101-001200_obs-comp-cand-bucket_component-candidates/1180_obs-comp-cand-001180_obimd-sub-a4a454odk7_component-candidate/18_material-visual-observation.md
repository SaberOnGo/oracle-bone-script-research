# Material Visual Observation / obs-comp-cand-001180 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001180`
- External reference / 外部参照: `obimd-sub-a4a454odk7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015370_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/a4a454odk7/a4a454odk7/a4a454odk7.png`
- Checksum / 校验和:
  `7c908e909e15379ab2b45cfb88e493b7dfa2a451cd5907fd65e3d36aea2d3528`
...
- Marked-pixel bounds: (94,29)–(155,224); span 62 × 196 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.52%。
- 痕迹范围：(94,29)–(155,224)；跨度62 × 196 px；痕迹矩形高于宽。
