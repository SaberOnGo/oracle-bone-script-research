...
- External category reference: `evobc-cat-00953`
- Source category ID: `00953`
- Source label for human review: `偋`
...
- `obs-evo-cand-000953-route-category-staging`
...
- `obs-evo-cand-000953-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000953-route-evolution-graph`
