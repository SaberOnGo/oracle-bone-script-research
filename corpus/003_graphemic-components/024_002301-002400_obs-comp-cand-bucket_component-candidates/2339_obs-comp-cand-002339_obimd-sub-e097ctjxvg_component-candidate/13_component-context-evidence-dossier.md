# obs-comp-cand-002339 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002339`
- 首选外部 ID: `obimd-sub-e097ctjxvg`
- OBIMD subcharacter UID: `e097ctjxvg`
- OBIMD main character UID: `e097ctjxvg`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `8`
- codepoint 示例: U+A713E;U+FD659; U+FD65A; 另有 6 项
