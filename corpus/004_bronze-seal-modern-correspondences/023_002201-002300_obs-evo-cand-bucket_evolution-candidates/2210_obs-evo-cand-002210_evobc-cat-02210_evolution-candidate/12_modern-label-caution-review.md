# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002210
...
- EVOBC candidate category: `evobc-evo-cat-02210`.
- Source label for search only: `婪`.
- Source codepoints for search only: `U+5A6A`.
