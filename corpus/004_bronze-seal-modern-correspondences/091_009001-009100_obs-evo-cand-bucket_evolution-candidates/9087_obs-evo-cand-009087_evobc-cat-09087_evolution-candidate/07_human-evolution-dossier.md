...
Project ID: `obs-evo-cand-009087`
...
- Project ID: `obs-evo-cand-009087`
- EVOBC category candidate ID: `evobc-evo-cat-09087`
- External category reference: `evobc-cat-09087`
- Source category ID: `09087`
- Source label for human review: `邕`
- Source codepoints: `U+9095`
...
- `obs-evo-cand-009087-route-category-staging`
...
- `obs-evo-cand-009087-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009087-route-evolution-graph`
