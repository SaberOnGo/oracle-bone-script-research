# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012757
...
- EVOBC candidate category: `evobc-evo-cat-12757`.
- Source label for search only: `𪑪`.
- Source codepoints for search only: `U+2A46A`.
