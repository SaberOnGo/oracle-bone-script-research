# Material Visual Observation / obs-comp-cand-001299 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001299`
- External reference / 外部参照: `obimd-sub-an5u5r611e`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015636_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2sdz63p9g6/an5u5r611e/an5u5r611e.png`
- Checksum / 校验和:
  `0308d4a71e0601c655c1b6d6dbc2dde34f8ed8827518ac4d1760c7c9c9a7eb01`
...
- Marked-pixel bounds: (88,34)–(161,220); span 74 × 187 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.77%。
- 痕迹范围：(88,34)–(161,220)；跨度74 × 187 px；痕迹矩形高于宽。
