...
- External category reference: `evobc-cat-00693`
- Source category ID: `00693`
- Source label for human review: `亙`
- Source codepoints: `U+4E99`
...
- `obs-evo-cand-000693-route-category-staging`
...
- `obs-evo-cand-000693-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000693-route-evolution-graph`
