...
Project ID: `obs-evo-cand-004131`
...
- Project ID: `obs-evo-cand-004131`
- EVOBC category candidate ID: `evobc-evo-cat-04131`
- External category reference: `evobc-cat-04131`
- Source category ID: `04131`
- Source label for human review: `椳`
- Source codepoints: `U+6933`
...
- `obs-evo-cand-004131-route-category-staging`
...
- `obs-evo-cand-004131-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004131-route-evolution-graph`
