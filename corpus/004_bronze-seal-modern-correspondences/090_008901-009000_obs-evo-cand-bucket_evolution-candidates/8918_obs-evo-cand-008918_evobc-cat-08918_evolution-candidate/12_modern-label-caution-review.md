# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008918
...
- EVOBC candidate category: `evobc-evo-cat-08918`.
- Source label for search only: `辩`.
- Source codepoints for search only: `U+8FA9`.
