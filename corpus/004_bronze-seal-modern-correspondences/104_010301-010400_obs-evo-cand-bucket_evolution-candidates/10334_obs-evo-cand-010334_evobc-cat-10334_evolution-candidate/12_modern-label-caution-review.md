# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010334
...
- EVOBC candidate category: `evobc-evo-cat-10334`.
- Source label for search only: `鬟`.
- Source codepoints for search only: `U+9B1F`.
