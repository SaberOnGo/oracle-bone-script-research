...
- `obs-evo-cand-013091-route-category-staging`
...
- `obs-evo-cand-013091-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013091-route-evolution-graph`
