...
- `obs-evo-cand-002835-route-category-staging`
...
- `obs-evo-cand-002835-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002835-route-evolution-graph`
