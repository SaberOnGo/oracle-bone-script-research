...
Project ID: `obs-evo-cand-003792`
...
- Project ID: `obs-evo-cand-003792`
- EVOBC category candidate ID: `evobc-evo-cat-03792`
- External category reference: `evobc-cat-03792`
- Source category ID: `03792`
- Source label for human review: `曄`
- Source codepoints: `U+66C4`
...
- `obs-evo-cand-003792-route-category-staging`
...
- `obs-evo-cand-003792-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003792-route-evolution-graph`
