...
- External category reference: `evobc-cat-06596`
- Source category ID: `06596`
- Source label: `緟`
...
- `obs-evo-cand-006596-route-category-staging`
...
- `obs-evo-cand-006596-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006596-route-evolution-graph`
