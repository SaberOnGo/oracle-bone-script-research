...
- External category reference: `evobc-cat-13178`
- Source category ID: `13178`
- Source label: `𫿺`
...
- `obs-evo-cand-013178-route-category-staging`
...
- `obs-evo-cand-013178-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013178-route-evolution-graph`
