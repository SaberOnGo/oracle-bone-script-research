...
- External category reference: `evobc-cat-00197`
- Source category ID: `00197`
- Source label for human review: `㱿`
- Source codepoints: `U+3C7F`
- Image reference count in source metadata: `107`
...
- `obs-evo-cand-000197-route-category-staging`
...
- `obs-evo-cand-000197-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000197-route-evolution-graph`
