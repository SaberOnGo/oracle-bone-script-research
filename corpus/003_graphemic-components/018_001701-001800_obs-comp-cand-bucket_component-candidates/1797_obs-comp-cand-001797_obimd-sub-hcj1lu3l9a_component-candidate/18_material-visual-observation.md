# Material Visual Observation / obs-comp-cand-001797 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001797`
- External reference / 外部参照: `obimd-sub-hcj1lu3l9a`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018018_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hcj1lu3l9a/hcj1lu3l9a/hcj1lu3l9a.png`
- Checksum / 校验和:
  `364e730d8efce904377d48102f620bfec7eecebea6ee7f79a59d82ab67abc1fb`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.85%.
- Marked-pixel bounds: (57,38)–(202,207); span 146 × 170 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.85%。
- 痕迹范围：(57,38)–(202,207)；跨度146 × 170 px；痕迹矩形近方形。
