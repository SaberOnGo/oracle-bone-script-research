...
- External category reference: `evobc-cat-13681`
- Source category ID: `13681`
- Source label for human review: `𮧷`
...
- `obs-evo-cand-013681-route-category-staging`
...
- `obs-evo-cand-013681-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013681-route-evolution-graph`
