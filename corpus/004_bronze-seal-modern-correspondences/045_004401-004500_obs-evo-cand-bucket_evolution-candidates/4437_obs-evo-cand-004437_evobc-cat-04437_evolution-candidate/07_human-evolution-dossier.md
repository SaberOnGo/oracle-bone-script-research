...
- External category reference: `evobc-cat-04437`
- Source category ID: `04437`
- Source label for human review: `毃`
...
- `obs-evo-cand-004437-route-category-staging`
...
- `obs-evo-cand-004437-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004437-route-evolution-graph`
