...
Project ID: `obs-evo-cand-011273`
...
- Project ID: `obs-evo-cand-011273`
- EVOBC category candidate ID: `evobc-evo-cat-11273`
- External category reference: `evobc-cat-11273`
- Source category ID: `11273`
- Source label for human review: `𢣘`
- Source codepoints: `U+228D8`
...
- `obs-evo-cand-011273-route-category-staging`
...
- `obs-evo-cand-011273-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011273-route-evolution-graph`
