# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002567
...
- EVOBC candidate category: `evobc-evo-cat-02567`.
- Source label for search only: `崛`.
- Source codepoints for search only: `U+5D1B`.
