...
Project ID: `obs-evo-cand-012515`
...
- Project ID: `obs-evo-cand-012515`
- EVOBC category candidate ID: `evobc-evo-cat-12515`
- External category reference: `evobc-cat-12515`
- Source category ID: `12515`
- Source label for human review: `𨸓`
- Source codepoints: `U+28E13`
...
- `obs-evo-cand-012515-route-category-staging`
...
- `obs-evo-cand-012515-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012515-route-evolution-graph`
