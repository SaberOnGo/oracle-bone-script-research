...
- Project ID / 项目 ID: `obs-char-001023`
- Primary external ID / 首选外部 ID: `hust-obc-cat-1148`
...
- Source image / 来源图: `H_1148_60FA4_0.png`
- Image / 图像: `001_asset-001028_hust-obc-cat-1148_glyph.png`
...
- target node: `evobc-evo-cat-00093`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/093_obs-evo-cand-000093_evobc-cat-00093_evoluti
...
- Source label text / 来源标签文字: `㡲`
- Source label codepoint / 来源标签 codepoint: `U+3872`
