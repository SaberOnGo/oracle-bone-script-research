...
- External category reference: `evobc-cat-03029`
- Source category ID: `03029`
- Source label for human review: `悶`
...
- `obs-evo-cand-003029-route-category-staging`
...
- `obs-evo-cand-003029-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003029-route-evolution-graph`
