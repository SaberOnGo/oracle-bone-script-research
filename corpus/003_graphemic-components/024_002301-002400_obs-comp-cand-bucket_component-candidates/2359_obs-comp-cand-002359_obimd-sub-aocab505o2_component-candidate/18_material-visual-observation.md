# Material Visual Observation / obs-comp-cand-002359 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002359`
- External reference / 外部参照: `obimd-sub-aocab505o2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020430_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rp1zjtuksu/aocab505o2/aocab505o2.png`
- Checksum / 校验和:
  `cb2e526fc4b186e2473229aeb4f7170c185c1c8698d8805bbef19f437dddf1ac`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.80%.
- Marked-pixel bounds: (58,56)–(193,198); span 136 × 143 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.80%。
- 痕迹范围：(58,56)–(193,198)；跨度136 × 143 px；痕迹矩形近方形。
