# Material Visual Observation / obs-comp-cand-001232 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001232`
- External reference / 外部参照: `obimd-sub-epuiyzcv4m`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015470_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/epuiyzcv4m/epuiyzcv4m/epuiyzcv4m.png`
- Checksum / 校验和:
  `98347ec708732910b5d680eee5001cb90371d3a15c4836caf4720670aeb8e2f2`
...
- Marked-pixel bounds: (67,48)–(181,194); span 115 × 147 px; the marked
...
- 痕迹范围：(67,48)–(181,194)；跨度115 × 147 px；痕迹矩形高于宽。
