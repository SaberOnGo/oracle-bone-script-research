...
- Project ID: `obs-evo-cand-009705`
- EVOBC category candidate ID: `evobc-evo-cat-09705`
- External category reference: `evobc-cat-09705`
- Source category ID: `09705`
- Source label for human review: `防`
- Source codepoints: `U+9632`
...
- `obs-evo-cand-009705-route-category-staging`
...
- `obs-evo-cand-009705-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009705-route-evolution-graph`
