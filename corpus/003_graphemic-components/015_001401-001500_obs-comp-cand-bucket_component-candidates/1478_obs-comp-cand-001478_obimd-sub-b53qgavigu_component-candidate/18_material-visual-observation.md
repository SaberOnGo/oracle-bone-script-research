# Material Visual Observation / obs-comp-cand-001478 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001478`
- External reference / 外部参照: `obimd-sub-b53qgavigu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016055_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dlpctjqwqf/b53qgavigu/b53qgavigu.png`
- Checksum / 校验和:
  `4e4792399983952c7c5863a0321406236d12d3ad2540b2affaecd660afa85c18`
...
- Marked-pixel bounds: (62,33)–(192,209); span 131 × 177 px; the marked
...
- 痕迹范围：(62,33)–(192,209)；跨度131 × 177 px；痕迹矩形高于宽。
