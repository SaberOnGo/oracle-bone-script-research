# Material Visual Observation / obs-comp-cand-001156 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001156`
- External reference / 外部参照: `obimd-sub-izi8zofon5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015346_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/27jl2n6uoo/izi8zofon5/izi8zofon5.png`
- Checksum / 校验和:
  `13530255d6444816b0a5c6fdedcd9bbbdd9bef1ab7b756e1086c4fbcae8f8d6b`
...
- Marked-pixel bounds: (83,39)–(166,216); span 84 × 178 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.52%。
- 痕迹范围：(83,39)–(166,216)；跨度84 × 178 px；痕迹矩形高于宽。
