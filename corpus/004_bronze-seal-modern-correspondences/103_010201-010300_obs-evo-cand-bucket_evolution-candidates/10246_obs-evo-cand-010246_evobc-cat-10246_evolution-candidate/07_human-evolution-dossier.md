...
- External category reference: `evobc-cat-10246`
- Source category ID: `10246`
- Source label: `驄`
...
- `obs-evo-cand-010246-route-category-staging`
...
- `obs-evo-cand-010246-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010246-route-evolution-graph`
