# obs-xwalk-cand-001550 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+3AC3` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-1741` | not reading |
| OBIMD route / OBIMD 路线 | `obimd-main-cand-002692` | not component |
| EVOBC route / EVOBC 路线 | `evobc-evo-cat-00154` | not evolution |
