# Material Visual Observation / obs-comp-cand-000989 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000989`
- External reference / 外部参照: `obimd-sub-tp2kuz956n`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014359_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tp2kuz956n/tp2kuz956n/tp2kuz956n.png`
- Checksum / 校验和:
  `9a9837d2577cf3a140c89e1dfaa3eaf6216e441e4bd518f848eafe365908209a`
...
- Marked-pixel bounds: (68,49)–(181,213); span 114 × 165 px; the marked
...
- 痕迹范围：(68,49)–(181,213)；跨度114 × 165 px；痕迹矩形高于宽。
