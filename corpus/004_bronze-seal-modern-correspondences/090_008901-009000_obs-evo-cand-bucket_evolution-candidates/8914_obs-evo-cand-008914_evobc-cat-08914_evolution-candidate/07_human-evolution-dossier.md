...
- External category reference: `evobc-cat-08914`
- Source category ID: `08914`
...
- `obs-evo-cand-008914-route-category-staging`
...
- `obs-evo-cand-008914-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008914-route-evolution-graph`
