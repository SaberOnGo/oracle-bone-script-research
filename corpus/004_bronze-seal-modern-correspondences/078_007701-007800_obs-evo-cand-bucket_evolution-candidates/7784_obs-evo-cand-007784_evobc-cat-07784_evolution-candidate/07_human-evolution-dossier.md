...
- Project ID: `obs-evo-cand-007784`
- EVOBC category candidate ID: `evobc-evo-cat-07784`
- External category reference: `evobc-cat-07784`
- Source category ID: `07784`
- Source label for human review: `蜡`
- Source codepoints: `U+8721`
...
- `obs-evo-cand-007784-route-category-staging`
...
- `obs-evo-cand-007784-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007784-route-evolution-graph`
