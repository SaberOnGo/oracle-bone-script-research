# obs-char-001225 Visual Gallery / obs-char-001225 图像资料页
...
- Project ID / 项目 ID: `obs-char-001225`
- Primary external reference / 首选外部参考: `hust-obc-cat-1370`
...
## obs-char-001225-visual-source-001 / 图像条目

![obs-char-001225 glyph candidate](03_visual-assets/001_asset-001230_hust-obc-cat-1370_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-001230_hust-obc-cat-1370_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-001230_hust-obc-cat-1370_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/1370/L_1370_13471.jpg`
