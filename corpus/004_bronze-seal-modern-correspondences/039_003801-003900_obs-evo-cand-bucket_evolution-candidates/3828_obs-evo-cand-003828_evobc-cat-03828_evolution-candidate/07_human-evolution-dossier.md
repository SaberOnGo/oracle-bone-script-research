...
- External category reference: `evobc-cat-03828`
- Source category ID: `03828`
- Source label for human review: `月`
- Source codepoints: `U+6708`
- Image reference count in source metadata: `422`
...
- era `0`
  token: `OBC`
  image references: 104
- era `1`
  token: `BI`
  image references: 116
- era `2`
  token: `SS`
  image references: 2
- era `3`
...
- era `4`
  token: `WSC`
  image references: 148
- era `5`
  token: `CS`
  image references: 1
- source `1`
  token: `Web:105952;說文Web:58`
  image references: 248
- source `2`
  token: `Book:17600`
  image references: 48
- source `3`
...
- `obs-evo-cand-003828-route-category-staging`
...
- `obs-evo-cand-003828-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003828-route-evolution-graph`
