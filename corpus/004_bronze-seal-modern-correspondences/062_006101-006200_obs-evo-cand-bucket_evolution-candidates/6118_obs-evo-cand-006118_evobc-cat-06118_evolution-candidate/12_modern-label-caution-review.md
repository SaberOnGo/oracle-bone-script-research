# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006118
...
- EVOBC candidate category: `evobc-evo-cat-06118`.
- Source label for search only: `稽`.
- Source codepoints for search only: `U+7A3D`.
