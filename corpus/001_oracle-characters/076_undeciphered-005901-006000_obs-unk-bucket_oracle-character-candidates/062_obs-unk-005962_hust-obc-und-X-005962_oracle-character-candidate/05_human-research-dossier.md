# obs-unk-005962 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005962`
- primary external id: `hust-obc-und-X-005962`
...
- local review image route: `corpus/001_oracle-characters/076_undeciphered-005
  901-006000_obs-unk-bucket_oracle-character-candidates/062_obs-unk-005962_h
  ust-obc-und-X-005962_oracle-character-candidate/03_visual-assets/001_asset
  -007554_hust-obc-und-X-005962_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1518/X_？_2827_1.png`
- asset id: `asset-007554`
...
- source class: `HUST-OBC/undeciphered/X/1518/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1518/X_？_2827_1.png`
- asset id: `asset-007554`
...
- Which source records identify obs-unk-005962 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005962？
