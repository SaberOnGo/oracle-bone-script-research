...
- Project ID: `obs-evo-cand-013583`
- EVOBC category candidate ID: `evobc-evo-cat-13583`
- External category reference: `evobc-cat-13583`
- Source category ID: `13583`
- Source label for human review: `𭺡`
- Source codepoints: `U+2DEA1`
...
- `obs-evo-cand-013583-route-category-staging`
...
- `obs-evo-cand-013583-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013583-route-evolution-graph`
