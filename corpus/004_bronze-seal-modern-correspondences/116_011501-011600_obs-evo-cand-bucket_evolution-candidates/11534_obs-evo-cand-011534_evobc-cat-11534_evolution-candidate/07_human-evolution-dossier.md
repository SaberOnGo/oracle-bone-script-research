...
- External category reference: `evobc-cat-11534`
- Source category ID: `11534`
- Source label for human review: `𣻞`
- Source codepoints: `U+23EDE`
...
- `obs-evo-cand-011534-route-category-staging`
...
- `obs-evo-cand-011534-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011534-route-evolution-graph`
