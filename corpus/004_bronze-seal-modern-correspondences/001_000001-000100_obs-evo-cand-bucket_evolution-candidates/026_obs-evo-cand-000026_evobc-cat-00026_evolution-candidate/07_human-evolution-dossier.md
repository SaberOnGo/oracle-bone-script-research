...
Project ID: `obs-evo-cand-000026`
...
- Project ID: `obs-evo-cand-000026`
- EVOBC category candidate ID: `evobc-evo-cat-00026`
- External category reference: `evobc-cat-00026`
- Source category ID: `00026`
- Source label for human review: `㕎`
- Source codepoints: `U+354E`
...
- `obs-evo-cand-000026-route-category-staging`
...
- `obs-evo-cand-000026-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000026-route-evolution-graph`
