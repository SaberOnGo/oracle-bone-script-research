# obs-char-000536 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000536`
- primary external id: `hust-obc-cat-0610`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/536_obs-char-000536_hust-obc-cat-0610_orac
  le-character/03_visual-assets/001_asset-000541_hust-obc-cat-0610_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0610/G_0610_乙1215合6477賓組.png`
- asset id: `asset-000541`
...
- source category: `0610`
- validation class: `535`
- source image route: `HUST-OBC/deciphered/0610/G_0610_乙1215合6477賓組.png`
- asset id: `asset-000541`
...
- English observation: `A very narrow curved outer stroke encloses two short
  upper slants and bends beside a small angular open loop at the lower
  right.`
- 中文观察: `极狭长弯曲外笔包围两条上部短斜笔，并在右下小型折角开口环旁弯折。`
...
- dataset label text: `㙘`
- dataset label codepoints: `U+3658`
...
- filename catalog route clues: `Heji-like filename clue: 合6477
  (G_0610_乙1215合6477賓組.png)`
...
- Which source records identify obs-char-000536 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000536？
