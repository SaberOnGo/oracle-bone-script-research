...
- External category reference: `evobc-cat-12216`
- Source category ID: `12216`
- Source label for human review: `𧥇`
- Source codepoints: `U+27947`
...
- `obs-evo-cand-012216-route-category-staging`
...
- `obs-evo-cand-012216-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012216-route-evolution-graph`
