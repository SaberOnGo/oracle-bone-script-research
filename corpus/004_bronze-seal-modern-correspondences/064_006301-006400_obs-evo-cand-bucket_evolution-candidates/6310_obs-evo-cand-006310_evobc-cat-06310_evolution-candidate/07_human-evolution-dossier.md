...
Project ID: `obs-evo-cand-006310`
...
- Project ID: `obs-evo-cand-006310`
- EVOBC category candidate ID: `evobc-evo-cat-06310`
- External category reference: `evobc-cat-06310`
- Source category ID: `06310`
- Source label for human review: `篁`
- Source codepoints: `U+7BC1`
...
- `obs-evo-cand-006310-route-category-staging`
...
- `obs-evo-cand-006310-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006310-route-evolution-graph`
