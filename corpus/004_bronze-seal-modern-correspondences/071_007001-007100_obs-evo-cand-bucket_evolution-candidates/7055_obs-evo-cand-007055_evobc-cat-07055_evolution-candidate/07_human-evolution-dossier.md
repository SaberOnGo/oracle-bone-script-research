...
- External category reference: `evobc-cat-07055`
- Source category ID: `07055`
- Source label for human review: `脆`
- Source codepoints: `U+8106`
...
- `obs-evo-cand-007055-route-category-staging`
...
- `obs-evo-cand-007055-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007055-route-evolution-graph`
