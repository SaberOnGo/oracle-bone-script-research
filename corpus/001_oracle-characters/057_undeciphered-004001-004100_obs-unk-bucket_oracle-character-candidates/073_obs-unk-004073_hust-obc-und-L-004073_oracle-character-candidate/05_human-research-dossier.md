# obs-unk-004073 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004073`
- primary external id: `hust-obc-und-L-004073`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/073_obs-unk-004073_h
  ust-obc-und-L-004073_oracle-character-candidate/03_visual-assets/001_asset
  -005666_hust-obc-und-L-004073_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4073/L_？_8722.jpg`
- asset id: `asset-005666`
...
- source class: `HUST-OBC/undeciphered/L/4073/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4073/L_？_8722.jpg`
- asset id: `asset-005666`
...
- English observation: A broad upper bar or enclosure sits above a narrow
  descending trace. The lower area has a small angular outline with a darker
  interior; the upper and lower parts may be separated by a faint break.
...
- Which source records identify obs-unk-004073 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004073？
