...
Project ID: `obs-evo-cand-001276`
...
- Project ID: `obs-evo-cand-001276`
- EVOBC category candidate ID: `evobc-evo-cat-01276`
- External category reference: `evobc-cat-01276`
- Source category ID: `01276`
- Source label for human review: `劲`
- Source codepoints: `U+52B2`
...
- `obs-evo-cand-001276-route-category-staging`
...
- `obs-evo-cand-001276-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001276-route-evolution-graph`
