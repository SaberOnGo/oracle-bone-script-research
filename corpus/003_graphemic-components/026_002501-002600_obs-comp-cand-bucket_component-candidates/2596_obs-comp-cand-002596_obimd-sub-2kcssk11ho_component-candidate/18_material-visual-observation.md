# Material Visual Observation / obs-comp-cand-002596 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002596`
- External reference / 外部参照: `obimd-sub-2kcssk11ho`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021135_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2kcssk11ho/2kcssk11ho/2kcssk11ho.png`
- Checksum / 校验和:
  `c53a097f9345352f0e4ef1bef4c96cbccbe79f83eb34faf10f4156199b355d9b`
...
- Marked-pixel bounds: (72,20)–(161,231); span 90 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.69%。
- 痕迹范围：(72,20)–(161,231)；跨度90 × 212 px；痕迹矩形高于宽。
