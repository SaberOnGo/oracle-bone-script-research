...
- External category reference: `evobc-cat-01004`
- Source category ID: `01004`
- Source label for human review: `僄`
- Source codepoints: `U+50C4`
...
- `obs-evo-cand-001004-route-category-staging`
...
- `obs-evo-cand-001004-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001004-route-evolution-graph`
