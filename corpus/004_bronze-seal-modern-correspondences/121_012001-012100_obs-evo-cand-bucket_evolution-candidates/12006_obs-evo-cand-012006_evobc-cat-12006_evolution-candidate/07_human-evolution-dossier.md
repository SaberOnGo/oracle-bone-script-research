...
- External category reference: `evobc-cat-12006`
- Source category ID: `12006`
...
- `obs-evo-cand-012006-route-category-staging`
...
- `obs-evo-cand-012006-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012006-route-evolution-graph`
