# obs-unk-004436 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/036_obs-unk-004436_h
  ust-obc-und-L-004436_oracle-character-candidate/03_visual-assets/001_asset
  -006029_hust-obc-und-L-004436_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4436/L_？_9966.jpg`
- asset id: `asset-006029`
...
- source class: `HUST-OBC/undeciphered/L/4436/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4436/L_？_9966.jpg`
- asset id: `asset-006029`
...
- English observation: `A curved left stem stands beside a central`
  `stem and right loop.`
- 中文观察: `左侧弯曲竖干旁有中央竖干和右侧环状轮廓。`
...
- Which source records identify obs-unk-004436 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004436？
