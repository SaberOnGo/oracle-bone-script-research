# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008703
...
- EVOBC candidate category: `evobc-evo-cat-08703`.
- Source label for search only: `趿`.
- Source codepoints for search only: `U+8DBF`.
