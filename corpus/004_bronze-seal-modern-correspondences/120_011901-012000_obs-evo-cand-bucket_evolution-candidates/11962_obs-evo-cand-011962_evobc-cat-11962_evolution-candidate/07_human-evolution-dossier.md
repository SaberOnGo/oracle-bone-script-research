...
Project ID: `obs-evo-cand-011962`
...
- Project ID: `obs-evo-cand-011962`
- EVOBC category candidate ID: `evobc-evo-cat-11962`
- External category reference: `evobc-cat-11962`
- Source category ID: `11962`
- Source label for human review: `𦃜`
- Source codepoints: `U+260DC`
...
- `obs-evo-cand-011962-route-category-staging`
...
- `obs-evo-cand-011962-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011962-route-evolution-graph`
