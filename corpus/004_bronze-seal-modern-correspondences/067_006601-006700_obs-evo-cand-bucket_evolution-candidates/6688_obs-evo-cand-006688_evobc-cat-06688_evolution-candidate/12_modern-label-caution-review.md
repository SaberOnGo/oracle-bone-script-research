# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006688
...
- EVOBC candidate category: `evobc-evo-cat-06688`.
- Source label for search only: `繪`.
- Source codepoints for search only: `U+7E6A`.
