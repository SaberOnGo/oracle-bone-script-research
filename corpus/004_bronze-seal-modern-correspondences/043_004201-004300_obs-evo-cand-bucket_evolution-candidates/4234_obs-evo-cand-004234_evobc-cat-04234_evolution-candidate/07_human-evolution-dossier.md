...
- External category reference: `evobc-cat-04234`
- Source category ID: `04234`
- Source label for human review: `樊`
- Source codepoints: `U+6A0A`
...
- `obs-evo-cand-004234-route-category-staging`
...
- `obs-evo-cand-004234-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004234-route-evolution-graph`
