# Material Visual Observation / obs-comp-cand-001851 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001851`
- External reference / 外部参照: `obimd-sub-w2c6ufsar5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018230_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/mgs4xhu5g3/w2c6ufsar5/w2c6ufsar5.png`
- Checksum / 校验和:
  `e8d84165ac994505e4207bd1b0d387c40a9cbf2b60a8e6a41a0170db6723abf4`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.23%.
- Marked-pixel bounds: (69,26)–(189,228); span 121 × 203 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.23%。
- 痕迹范围：(69,26)–(189,228)；跨度121 × 203 px；痕迹矩形高于宽。
