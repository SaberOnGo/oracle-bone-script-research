...
- `obs-evo-cand-009541-route-category-staging`
...
- `obs-evo-cand-009541-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009541-route-evolution-graph`
