# Material Visual Observation / obs-comp-cand-000143 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000143`
- External reference / 外部参照: `obimd-sub-le6c7kj0kg`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011555_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/yfnx5cwgq6/le6c7kj0kg/le6c7kj0kg.png`
- Checksum / 校验和:
  `8f1f44230a5d611f9400cd9e819fa0d4f21e780caf725d9985b4a4cc506eef57`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.03%.
- Marked-pixel bounds: (54,32)–(211,215); span 158 × 184 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.03%。
- 痕迹范围：(54,32)–(211,215)；跨度158 × 184 px；痕迹矩形近方形。
