# obs-unk-004252 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/052_obs-unk-004252_h
  ust-obc-und-L-004252_oracle-character-candidate/03_visual-assets/001_asset
  -005845_hust-obc-und-L-004252_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4252/L_？_9365.jpg`
- asset id: `asset-005845`
...
- source class: `HUST-OBC/undeciphered/L/4252/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4252/L_？_9365.jpg`
- asset id: `asset-005845`
...
- English observation: `Left curve, angular middle block, lower bar visible.`
- 中文观察: `左侧弯曲痕迹、中部棱角块面和下部横痕可见。`
...
- Which source records identify obs-unk-004252 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004252？
