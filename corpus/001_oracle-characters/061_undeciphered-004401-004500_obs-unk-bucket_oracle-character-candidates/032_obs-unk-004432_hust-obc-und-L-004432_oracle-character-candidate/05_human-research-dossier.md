# obs-unk-004432 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004432`
- primary external id: `hust-obc-und-L-004432`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/032_obs-unk-004432_h
  ust-obc-und-L-004432_oracle-character-candidate/03_visual-assets/001_asset
  -006025_hust-obc-und-L-004432_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4432/L_？_9931.jpg`
- asset id: `asset-006025`
...
- source class: `HUST-OBC/undeciphered/L/4432/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4432/L_？_9931.jpg`
- asset id: `asset-006025`
...
- English observation: `A broad diagonal crosses a short upper bar`
  `above a lower curve.`
- 中文观察: `宽斜痕与上部短横线交叉，位于下部弯痕之上。`
...
- Which source records identify obs-unk-004432 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004432？
