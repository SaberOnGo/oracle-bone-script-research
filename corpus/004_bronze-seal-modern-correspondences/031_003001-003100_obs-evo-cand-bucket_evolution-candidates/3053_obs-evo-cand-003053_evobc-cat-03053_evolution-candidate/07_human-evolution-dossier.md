...
- External category reference: `evobc-cat-03053`
- Source category ID: `03053`
- Source label for human review: `惟`
- Source codepoints: `U+60DF`
...
- `obs-evo-cand-003053-route-category-staging`
...
- `obs-evo-cand-003053-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003053-route-evolution-graph`
