...
- External category reference: `evobc-cat-07169`
- Source category ID: `07169`
- Source label for human review: `臮`
...
- `obs-evo-cand-007169-route-category-staging`
...
- `obs-evo-cand-007169-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007169-route-evolution-graph`
