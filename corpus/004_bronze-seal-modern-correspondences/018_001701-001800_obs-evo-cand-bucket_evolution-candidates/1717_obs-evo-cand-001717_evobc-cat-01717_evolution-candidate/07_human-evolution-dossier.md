...
- External category reference: `evobc-cat-01717`
- Source category ID: `01717`
- Source label for human review: `噞`
...
- `obs-evo-cand-001717-route-category-staging`
...
- `obs-evo-cand-001717-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001717-route-evolution-graph`
