...
- External category reference: `evobc-cat-06624`
- Source category ID: `06624`
- Source label for human review: `縊`
...
- `obs-evo-cand-006624-route-category-staging`
...
- `obs-evo-cand-006624-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006624-route-evolution-graph`
