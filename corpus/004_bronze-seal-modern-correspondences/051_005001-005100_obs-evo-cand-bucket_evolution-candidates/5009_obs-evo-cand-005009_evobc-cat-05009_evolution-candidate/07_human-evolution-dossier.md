...
- External category reference: `evobc-cat-05009`
- Source category ID: `05009`
- Source label for human review: `灂`
- Source codepoints: `U+7042`
...
- `obs-evo-cand-005009-route-category-staging`
...
- `obs-evo-cand-005009-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005009-route-evolution-graph`
