...
- Project ID: `obs-evo-cand-009177`
- EVOBC category candidate ID: `evobc-evo-cat-09177`
- External category reference: `evobc-cat-09177`
- Source category ID: `09177`
- Source label for human review: `鄅`
- Source codepoints: `U+9105`
...
- `obs-evo-cand-009177-route-category-staging`
...
- `obs-evo-cand-009177-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009177-route-evolution-graph`
