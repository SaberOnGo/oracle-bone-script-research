...
Project ID: `obs-evo-cand-003026`
...
- Project ID: `obs-evo-cand-003026`
- EVOBC category candidate ID: `evobc-evo-cat-03026`
- External category reference: `evobc-cat-03026`
- Source category ID: `03026`
- Source label for human review: `悳`
- Source codepoints: `U+60B3`
...
- `obs-evo-cand-003026-route-category-staging`
...
- `obs-evo-cand-003026-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003026-route-evolution-graph`
