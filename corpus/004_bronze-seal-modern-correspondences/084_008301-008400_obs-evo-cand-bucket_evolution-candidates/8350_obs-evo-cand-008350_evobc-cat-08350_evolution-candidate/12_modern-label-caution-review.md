# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008350
...
- EVOBC candidate category: `evobc-evo-cat-08350`.
- Source label for search only: `譊`.
- Source codepoints for search only: `U+8B4A`.
