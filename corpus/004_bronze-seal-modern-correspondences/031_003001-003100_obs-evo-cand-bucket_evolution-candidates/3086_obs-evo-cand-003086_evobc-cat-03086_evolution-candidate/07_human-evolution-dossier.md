...
Project ID: `obs-evo-cand-003086`
...
- Project ID: `obs-evo-cand-003086`
- EVOBC category candidate ID: `evobc-evo-cat-03086`
- External category reference: `evobc-cat-03086`
- Source category ID: `03086`
- Source label for human review: `愚`
- Source codepoints: `U+611A`
...
- `obs-evo-cand-003086-route-category-staging`
...
- `obs-evo-cand-003086-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003086-route-evolution-graph`
