# obs-char-000616 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000616`
- primary external id: `hust-obc-cat-0701`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/616_obs-char-000616_hust-obc-cat-0701_orac
  le-character/03_visual-assets/001_asset-000621_hust-obc-cat-0701_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0701/G_0701_乙4692合22043午組.png`
- asset id: `asset-000621`
...
- source category: `0701`
- validation class: `615`
- source image route: `HUST-OBC/deciphered/0701/G_0701_乙4692合22043午組.png`
- asset id: `asset-000621`
...
- English observation: `A long right-hand vertical stem has short forked
  tips at top and bottom, while a broad rounded loop projects from its upper
  left.`
- 中文观察: `右侧长竖干顶部和底部带短叉尖，上部左侧伸出宽圆环。`
...
- dataset label text: `㚳`
- dataset label codepoints: `U+36B3`
...
- filename catalog route clues: `Heji-like filename clue: 合22043
  (G_0701_乙4692合22043午組.png)`
...
- Which source records identify obs-char-000616 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000616？
