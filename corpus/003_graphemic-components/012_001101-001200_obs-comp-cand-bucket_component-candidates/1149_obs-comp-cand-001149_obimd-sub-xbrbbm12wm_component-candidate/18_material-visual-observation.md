# Material Visual Observation / obs-comp-cand-001149 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001149`
- External reference / 外部参照: `obimd-sub-xbrbbm12wm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015339_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xbrbbm12wm/xbrbbm12wm/xbrbbm12wm.png`
- Checksum / 校验和:
  `a013a7da035c4f35cf8edf92d414e6f1395129e7988ad143052a1190bae398f0`
...
- Marked-pixel bounds: (84,35)–(165,207); span 82 × 173 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.14%。
- 痕迹范围：(84,35)–(165,207)；跨度82 × 173 px；痕迹矩形高于宽。
