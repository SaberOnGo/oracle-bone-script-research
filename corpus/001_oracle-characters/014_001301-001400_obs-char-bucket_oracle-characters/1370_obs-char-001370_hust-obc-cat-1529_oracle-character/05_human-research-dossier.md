# obs-char-001370 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1370_obs-char-001370_hust-obc-cat-1529_ora
  cle-character/03_visual-assets/001_asset-001375_hust-obc-cat-1529_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1529/X_1529_6334_1.png`
- asset id: `asset-001375`
...
- source category: `1529`
- validation class: `1369`
- source image route: `HUST-OBC/deciphered/1529/X_1529_6334_1.png`
- asset id: `asset-001375`
...
- English observation: `A tall composite has detached curved marks, central
  branches, and lower strokes.`
- 中文观察: `高大组合形体有分离弧线、中央分枝和下部笔画。`
...
- dataset label text: `㧯`
- dataset label codepoints: `U+39EF`
...
- Which source records identify obs-char-001370 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001370？
