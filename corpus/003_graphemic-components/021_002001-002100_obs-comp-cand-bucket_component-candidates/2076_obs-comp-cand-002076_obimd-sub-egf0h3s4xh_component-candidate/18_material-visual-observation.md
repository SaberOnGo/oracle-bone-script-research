# Material Visual Observation / obs-comp-cand-002076 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002076`
- External reference / 外部参照: `obimd-sub-egf0h3s4xh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019463_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/egf0h3s4xh/egf0h3s4xh/egf0h3s4xh.png`
- Checksum / 校验和:
  `714998a73502807fa2bda0cf21d19c936247fdb4a81f4946aa3e14e853a86cfb`
...
- Marked-pixel bounds: (64,23)–(194,226); span 131 × 204 px; the marked
...
- 痕迹范围：(64,23)–(194,226)；跨度131 × 204 px；痕迹矩形高于宽。
