# Material Visual Observation / obs-comp-cand-001629 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001629`
- External reference / 外部参照: `obimd-sub-7e0bc7s6s0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017305_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7e0bc7s6s0/7e0bc7s6s0/7e0bc7s6s0.png`
- Checksum / 校验和:
  `99553e8e043d25a270df4c6a08cdfa7013462a366637c0e6f1fbc648baeda2bb`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.98%.
- Marked-pixel bounds: (74,17)–(184,230); span 111 × 214 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.98%。
- 痕迹范围：(74,17)–(184,230)；跨度111 × 214 px；痕迹矩形高于宽。
