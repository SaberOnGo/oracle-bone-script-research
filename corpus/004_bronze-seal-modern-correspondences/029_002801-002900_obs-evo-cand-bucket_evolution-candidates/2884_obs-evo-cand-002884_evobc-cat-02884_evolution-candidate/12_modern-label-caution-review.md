# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002884
...
- EVOBC candidate category: `evobc-evo-cat-02884`.
- Source label for search only: `徬`.
- Source codepoints for search only: `U+5FAC`.
