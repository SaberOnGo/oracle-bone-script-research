...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000112` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y614` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `246` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `412` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `39927` [route_present_image_or_text_not_collected]
