# Material Visual Observation / obs-comp-cand-002471 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002471`
- External reference / 外部参照: `obimd-sub-bgt08n4j9p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020656_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/v7qghw0r67/bgt08n4j9p/bgt08n4j9p.png`
- Checksum / 校验和:
  `e6b6a186bb82a45fd6fcdaa0fd4ddee2b54f60bc9627a2c99ef0467ca62f1cb1`
...
- Marked-pixel bounds: (58,20)–(193,230); span 136 × 211 px; the marked
...
- 痕迹范围：(58,20)–(193,230)；跨度136 × 211 px；痕迹矩形高于宽。
