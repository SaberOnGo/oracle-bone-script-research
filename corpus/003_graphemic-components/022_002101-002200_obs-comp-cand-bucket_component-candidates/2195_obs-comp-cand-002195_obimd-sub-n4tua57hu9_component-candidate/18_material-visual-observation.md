# Material Visual Observation / obs-comp-cand-002195 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002195`
- External reference / 外部参照: `obimd-sub-n4tua57hu9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019901_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/n4tua57hu9/n4tua57hu9/n4tua57hu9.png`
- Checksum / 校验和:
  `5a53a6c9475102f5f6de3b130a75bc81793c2abec315b07fd1182508239035e2`
...
- Marked-pixel bounds: (76,43)–(170,212); span 95 × 170 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.65%。
- 痕迹范围：(76,43)–(170,212)；跨度95 × 170 px；痕迹矩形高于宽。
