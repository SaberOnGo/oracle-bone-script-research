...
- External category reference: `evobc-cat-03879`
- Source category ID: `03879`
- Source label for human review: `杕`
- Source codepoints: `U+6755`
...
- `obs-evo-cand-003879-route-category-staging`
...
- `obs-evo-cand-003879-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003879-route-evolution-graph`
