# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-007280
...
- EVOBC candidate category: `evobc-evo-cat-07280`.
- Source label for search only: `苛`.
- Source codepoints for search only: `U+82DB`.
