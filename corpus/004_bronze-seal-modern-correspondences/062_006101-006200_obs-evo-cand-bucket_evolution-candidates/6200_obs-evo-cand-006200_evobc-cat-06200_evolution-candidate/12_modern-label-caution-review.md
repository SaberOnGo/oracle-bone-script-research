# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006200
...
- EVOBC candidate category: `evobc-evo-cat-06200`.
- Source label for search only: `竝`.
- Source codepoints for search only: `U+7ADD`.
