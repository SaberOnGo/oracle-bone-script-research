# obs-unk-005857 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/075_undeciphered-005
  801-005900_obs-unk-bucket_oracle-character-candidates/057_obs-unk-005857_h
  ust-obc-und-X-005857_oracle-character-candidate/03_visual-assets/001_asset
  -007449_hust-obc-und-X-005857_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1413/X_？_2134_1.png`
- asset id: `asset-007449`
...
- source class: `HUST-OBC/undeciphered/X/1413/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1413/X_？_2134_1.png`
- asset id: `asset-007449`
...
- Which source records identify obs-unk-005857 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005857？
