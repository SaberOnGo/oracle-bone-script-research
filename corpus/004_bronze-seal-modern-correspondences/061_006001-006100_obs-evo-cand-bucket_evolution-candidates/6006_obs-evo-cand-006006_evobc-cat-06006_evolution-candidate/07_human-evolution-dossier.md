...
Project ID: `obs-evo-cand-006006`
...
- Project ID: `obs-evo-cand-006006`
- EVOBC category candidate ID: `evobc-evo-cat-06006`
- External category reference: `evobc-cat-06006`
- Source category ID: `06006`
- Source label for human review: `祴`
- Source codepoints: `U+7974`
...
- `obs-evo-cand-006006-route-category-staging`
...
- `obs-evo-cand-006006-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006006-route-evolution-graph`
