...
Project ID: `obs-evo-cand-009352`
...
- Project ID: `obs-evo-cand-009352`
- EVOBC category candidate ID: `evobc-evo-cat-09352`
- External category reference: `evobc-cat-09352`
- Source category ID: `09352`
- Source label for human review: `鉅`
- Source codepoints: `U+9245`
...
- `obs-evo-cand-009352-route-category-staging`
...
- `obs-evo-cand-009352-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009352-route-evolution-graph`
