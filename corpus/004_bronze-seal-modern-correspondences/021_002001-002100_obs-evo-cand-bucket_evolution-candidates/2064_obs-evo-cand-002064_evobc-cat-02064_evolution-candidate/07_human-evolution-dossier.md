...
Project ID: `obs-evo-cand-002064`
...
- Project ID: `obs-evo-cand-002064`
- EVOBC category candidate ID: `evobc-evo-cat-02064`
- External category reference: `evobc-cat-02064`
- Source category ID: `02064`
- Source label for human review: `好`
- Source codepoints: `U+597D`
- Image reference count in source metadata: `245`
...
- `obs-evo-cand-002064-route-category-staging`
...
- `obs-evo-cand-002064-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002064-route-evolution-graph`
