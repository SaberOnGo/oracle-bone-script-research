# Material Visual Observation / obs-comp-cand-001889 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001889`
- External reference / 外部参照: `obimd-sub-25kcf9kzds`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018268_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xclyxu4uku/25kcf9kzds/25kcf9kzds.png`
- Checksum / 校验和:
  `e87fcb527869d186434f41bd248dd7461d9a4fdaacbbf6ffb7a1ac1bc83e93b9`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.00%.
- Marked-pixel bounds: (60,20)–(193,233); span 134 × 214 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.00%。
- 痕迹范围：(60,20)–(193,233)；跨度134 × 214 px；痕迹矩形高于宽。
