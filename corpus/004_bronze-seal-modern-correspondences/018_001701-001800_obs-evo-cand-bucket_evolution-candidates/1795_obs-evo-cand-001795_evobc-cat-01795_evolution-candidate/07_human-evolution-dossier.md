...
- Project ID: `obs-evo-cand-001795`
- EVOBC category candidate ID: `evobc-evo-cat-01795`
- External category reference: `evobc-cat-01795`
- Source category ID: `01795`
- Source label for human review: `圯`
- Source codepoints: `U+572F`
...
- `obs-evo-cand-001795-route-category-staging`
...
- `obs-evo-cand-001795-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001795-route-evolution-graph`
