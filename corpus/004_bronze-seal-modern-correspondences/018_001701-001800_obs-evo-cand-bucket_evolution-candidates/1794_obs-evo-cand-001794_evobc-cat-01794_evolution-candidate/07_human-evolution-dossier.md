...
Project ID: `obs-evo-cand-001794`
...
- Project ID: `obs-evo-cand-001794`
- EVOBC category candidate ID: `evobc-evo-cat-01794`
- External category reference: `evobc-cat-01794`
- Source category ID: `01794`
- Source label for human review: `圮`
- Source codepoints: `U+572E`
...
- `obs-evo-cand-001794-route-category-staging`
...
- `obs-evo-cand-001794-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001794-route-evolution-graph`
