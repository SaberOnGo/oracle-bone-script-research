# obs-char-000650 Visual Gallery / obs-char-000650 图像资料页
...
- Project ID / 项目 ID: `obs-char-000650`
- Primary external reference / 首选外部参考: `hust-obc-cat-0738`
...
## obs-char-000650-visual-source-001 / 图像条目

![obs-char-000650 glyph candidate](03_visual-assets/001_asset-000655_hust-obc-cat-0738_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000655_hust-obc-cat-0738_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000655_hust-obc-cat-0738_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/0738/X_0738_5455_1.png`
