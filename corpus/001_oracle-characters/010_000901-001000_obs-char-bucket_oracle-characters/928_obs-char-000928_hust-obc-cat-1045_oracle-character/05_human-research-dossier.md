# obs-char-000928 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000928`
- primary external id: `hust-obc-cat-1045`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/928_obs-char-000928_hust-obc-cat-1045_orac
  le-character/03_visual-assets/001_asset-000933_hust-obc-cat-1045_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1045/G_1045_存下915合36481黃組.png`
- asset id: `asset-000933`
...
- source category: `1045`
- validation class: `927`
- source image route: `HUST-OBC/deciphered/1045/G_1045_存下915合36481黃組.png`
- asset id: `asset-000933`
...
- English observation: `Detached marks at left accompany an upper jagged
  branch, a central descending stroke, and a lower enclosed leaf-like
  cluster.`
- 中文观察: `左侧分离痕迹旁有上部曲折分枝、中央下行笔和下部叶片状闭合笔群。`
...
- dataset label text: `㠋`
- dataset label codepoints: `U+380B`
...
- filename catalog route clues: `Heji-like filename clue: 合36481
  (G_1045_存下915合36481黃組.png)`
...
- Which source records identify obs-char-000928 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000928？
