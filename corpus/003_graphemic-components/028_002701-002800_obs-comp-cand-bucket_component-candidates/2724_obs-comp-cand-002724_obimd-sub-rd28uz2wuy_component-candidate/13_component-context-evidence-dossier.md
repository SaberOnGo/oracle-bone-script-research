# obs-comp-cand-002724 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002724`
- 首选外部 ID: `obimd-sub-rd28uz2wuy`
- OBIMD subcharacter UID: `rd28uz2wuy`
- OBIMD main character UID: `rd28uz2wuy`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `8`
- codepoint 示例: U+FF5AF; U+FF5B0; 另有 6 项
