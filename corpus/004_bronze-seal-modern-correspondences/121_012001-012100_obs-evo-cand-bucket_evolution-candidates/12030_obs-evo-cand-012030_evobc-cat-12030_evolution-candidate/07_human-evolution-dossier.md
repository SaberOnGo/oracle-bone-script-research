...
- Project ID: `obs-evo-cand-012030`
- EVOBC category candidate ID: `evobc-evo-cat-12030`
- External category reference: `evobc-cat-12030`
- Source category ID: `12030`
- Source label for human review: `𦕏`
- Source codepoints: `U+2654F`
...
- `obs-evo-cand-012030-route-category-staging`
...
- `obs-evo-cand-012030-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012030-route-evolution-graph`
