# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013558
...
- EVOBC candidate category: `evobc-evo-cat-13558`.
- Source label for search only: `𭭍`.
- Source codepoints for search only: `U+2DB4D`.
