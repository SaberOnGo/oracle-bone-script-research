# obs-unk-004173 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/073_obs-unk-004173_h
  ust-obc-und-L-004173_oracle-character-candidate/03_visual-assets/001_asset
  -005766_hust-obc-und-L-004173_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4173/L_？_9040.jpg`
- asset id: `asset-005766`
...
- source class: `HUST-OBC/undeciphered/L/4173/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4173/L_？_9040.jpg`
- asset id: `asset-005766`
...
- English observation: An upper crossed group sits above a rounded chain and a
  separate lower mark.
- 中文观察: 上部交叉组位于圆弧链状痕迹和下方独立痕迹之上。
...
- Which source records identify obs-unk-004173 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004173？
