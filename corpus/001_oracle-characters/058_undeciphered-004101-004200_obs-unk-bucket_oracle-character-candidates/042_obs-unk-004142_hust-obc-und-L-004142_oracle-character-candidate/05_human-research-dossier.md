# obs-unk-004142 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004142`
- primary external id: `hust-obc-und-L-004142`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/042_obs-unk-004142_h
  ust-obc-und-L-004142_oracle-character-candidate/03_visual-assets/001_asset
  -005735_hust-obc-und-L-004142_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4142/L_？_8957.jpg`
- asset id: `asset-005735`
...
- source class: `HUST-OBC/undeciphered/L/4142/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4142/L_？_8957.jpg`
- asset id: `asset-005735`
...
- English observation: A rounded central outline is crossed by a horizontal
  trace, with inner marks below.
- 中文观察：中央圆弧状轮廓被横向痕迹穿过，下部有内部痕迹。
...
- Which source records identify obs-unk-004142 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004142？
