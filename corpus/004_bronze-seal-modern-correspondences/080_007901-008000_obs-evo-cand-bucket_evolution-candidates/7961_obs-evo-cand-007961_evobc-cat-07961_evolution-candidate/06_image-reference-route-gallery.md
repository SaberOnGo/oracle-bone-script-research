...
- `obs-evo-cand-007961-route-category-staging`
...
- `obs-evo-cand-007961-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007961-route-evolution-graph`
