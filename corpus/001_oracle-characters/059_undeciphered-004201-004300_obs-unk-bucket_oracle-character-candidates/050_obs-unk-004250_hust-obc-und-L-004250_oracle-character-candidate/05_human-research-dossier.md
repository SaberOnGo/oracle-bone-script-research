# obs-unk-004250 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004250`
- primary external id: `hust-obc-und-L-004250`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/050_obs-unk-004250_h
  ust-obc-und-L-004250_oracle-character-candidate/03_visual-assets/001_asset
  -005843_hust-obc-und-L-004250_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4250/L_？_9360.jpg`
- asset id: `asset-005843`
...
- source class: `HUST-OBC/undeciphered/L/4250/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4250/L_？_9360.jpg`
- asset id: `asset-005843`
...
- English observation: `Left angle, two rounded curves, central gap visible.`
- 中文观察: `左侧倾斜痕迹、两处圆转痕迹和中央间隙可见。`
...
- Which source records identify obs-unk-004250 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004250？
