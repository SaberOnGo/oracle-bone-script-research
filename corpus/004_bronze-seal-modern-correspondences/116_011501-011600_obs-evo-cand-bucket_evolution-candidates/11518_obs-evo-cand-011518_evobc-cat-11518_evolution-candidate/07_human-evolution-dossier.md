...
- External category reference: `evobc-cat-11518`
- Source category ID: `11518`
- Source label for human review: `𣳪`
- Source codepoints: `U+23CEA`
...
- `obs-evo-cand-011518-route-category-staging`
...
- `obs-evo-cand-011518-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011518-route-evolution-graph`
