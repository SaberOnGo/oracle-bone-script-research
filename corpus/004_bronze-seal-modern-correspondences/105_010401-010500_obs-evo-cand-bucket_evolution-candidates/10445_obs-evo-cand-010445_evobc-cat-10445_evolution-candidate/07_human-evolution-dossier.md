...
Project ID: `obs-evo-cand-010445`
...
- Project ID: `obs-evo-cand-010445`
- EVOBC category candidate ID: `evobc-evo-cat-10445`
- External category reference: `evobc-cat-10445`
- Source category ID: `10445`
- Source label for human review: `鱓`
- Source codepoints: `U+9C53`
...
- `obs-evo-cand-010445-route-category-staging`
...
- `obs-evo-cand-010445-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010445-route-evolution-graph`
