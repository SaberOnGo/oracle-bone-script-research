...
- External category reference: `evobc-cat-08924`
- Source category ID: `08924`
- Source label for human review: `辰`
- Source codepoints: `U+8FB0`
- Image reference count in source metadata: `322`
...
- `obs-evo-cand-008924-route-category-staging`
...
- `obs-evo-cand-008924-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008924-route-evolution-graph`
