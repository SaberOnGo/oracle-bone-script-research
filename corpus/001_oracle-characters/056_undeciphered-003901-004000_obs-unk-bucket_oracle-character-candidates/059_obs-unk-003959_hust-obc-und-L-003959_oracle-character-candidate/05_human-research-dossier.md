# obs-unk-003959 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003959`
- primary external id: `hust-obc-und-L-003959`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/059_obs-unk-003959_h
  ust-obc-und-L-003959_oracle-character-candidate/03_visual-assets/001_asset
  -005552_hust-obc-und-L-003959_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3959/L_？_8352.jpg`
- asset id: `asset-005552`
...
- source class: `HUST-OBC/undeciphered/L/3959/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3959/L_？_8352.jpg`
- asset id: `asset-005552`
...
- English observation: Compact upper traces meet above a pointed junction, with
  angular marks spreading into the lower area.
- 中文观察：紧凑上部痕迹在尖点状交接处上方汇合，折线向下部展开。
...
- Which source records identify obs-unk-003959 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003959？
