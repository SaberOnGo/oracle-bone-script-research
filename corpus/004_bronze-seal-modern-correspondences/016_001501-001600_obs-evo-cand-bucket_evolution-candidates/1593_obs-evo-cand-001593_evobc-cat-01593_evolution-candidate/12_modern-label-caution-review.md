# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001593
...
- EVOBC candidate category: `evobc-evo-cat-01593`.
- Source label for search only: `哲`.
- Source codepoints for search only: `U+54F2`.
