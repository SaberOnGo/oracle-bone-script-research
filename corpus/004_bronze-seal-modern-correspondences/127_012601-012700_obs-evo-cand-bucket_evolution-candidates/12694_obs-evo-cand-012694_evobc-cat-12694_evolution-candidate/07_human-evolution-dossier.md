...
- External category reference: `evobc-cat-12694`
- Source category ID: `12694`
- Source label for human review: `𩲣`
- Source codepoints: `U+29CA3`
...
- `obs-evo-cand-012694-route-category-staging`
...
- `obs-evo-cand-012694-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012694-route-evolution-graph`
