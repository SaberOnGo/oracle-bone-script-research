# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010730
...
- EVOBC candidate category: `evobc-evo-cat-10730`.
- Source label for search only: `齬`.
- Source codepoints for search only: `U+9F6C`.
