...
Project ID: `obs-evo-cand-012570`
...
- Project ID: `obs-evo-cand-012570`
- EVOBC category candidate ID: `evobc-evo-cat-12570`
- External category reference: `evobc-cat-12570`
- Source category ID: `12570`
- Source label for human review: `𩊅`
- Source codepoints: `U+29285`
...
- `obs-evo-cand-012570-route-category-staging`
...
- `obs-evo-cand-012570-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012570-route-evolution-graph`
