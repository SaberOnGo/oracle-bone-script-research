# obs-unk-005582 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005582`
- primary external id: `hust-obc-und-X-005582`
...
- local review image route: `corpus/001_oracle-characters/072_undeciphered-005
  501-005600_obs-unk-bucket_oracle-character-candidates/082_obs-unk-005582_h
  ust-obc-und-X-005582_oracle-character-candidate/03_visual-assets/001_asset
  -007175_hust-obc-und-X-005582_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1138/X_？_8092_1.png`
- asset id: `asset-007175`
...
- source class: `HUST-OBC/undeciphered/X/1138/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1138/X_？_8092_1.png`
- asset id: `asset-007175`
...
- Which source records identify obs-unk-005582 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005582？
