...
Project ID: `obs-evo-cand-001877`
...
- Project ID: `obs-evo-cand-001877`
- EVOBC category candidate ID: `evobc-evo-cat-01877`
- External category reference: `evobc-cat-01877`
- Source category ID: `01877`
- Source label for human review: `埜`
- Source codepoints: `U+57DC`
...
- `obs-evo-cand-001877-route-category-staging`
...
- `obs-evo-cand-001877-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001877-route-evolution-graph`
