...
- External category reference: `evobc-cat-13185`
- Source category ID: `13185`
- Source label for human review: `𬀑`
- Source codepoints: `U+2C011`
...
- `obs-evo-cand-013185-route-category-staging`
...
- `obs-evo-cand-013185-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013185-route-evolution-graph`
