...
- Project ID: `obs-evo-cand-001166`
- EVOBC category candidate ID: `evobc-evo-cat-01166`
- External category reference: `evobc-cat-01166`
- Source category ID: `01166`
- Source label for human review: `凱`
- Source codepoints: `U+51F1`
...
- `obs-evo-cand-001166-route-category-staging`
...
- `obs-evo-cand-001166-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001166-route-evolution-graph`
