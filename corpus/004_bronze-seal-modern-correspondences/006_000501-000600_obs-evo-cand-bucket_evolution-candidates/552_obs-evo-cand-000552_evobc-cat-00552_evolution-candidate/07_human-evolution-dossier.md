...
- Project ID: `obs-evo-cand-000552`
- EVOBC category candidate ID: `evobc-evo-cat-00552`
- External category reference: `evobc-cat-00552`
- Source category ID: `00552`
- Source label for human review: `䬤`
- Source codepoints: `U+4B24`
...
- `obs-evo-cand-000552-route-category-staging`
...
- `obs-evo-cand-000552-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000552-route-evolution-graph`
