...
Project ID: `obs-evo-cand-008658`
...
- Project ID: `obs-evo-cand-008658`
- EVOBC category candidate ID: `evobc-evo-cat-08658`
- External category reference: `evobc-cat-08658`
- Source category ID: `08658`
- Source label for human review: `赬`
- Source codepoints: `U+8D6C`
...
- `obs-evo-cand-008658-route-category-staging`
...
- `obs-evo-cand-008658-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008658-route-evolution-graph`
