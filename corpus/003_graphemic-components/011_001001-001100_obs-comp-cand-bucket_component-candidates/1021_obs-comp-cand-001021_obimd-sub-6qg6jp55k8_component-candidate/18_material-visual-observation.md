# Material Visual Observation / obs-comp-cand-001021 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001021`
- External reference / 外部参照: `obimd-sub-6qg6jp55k8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014503_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/50z922qja8/6qg6jp55k8/6qg6jp55k8.png`
- Checksum / 校验和:
  `d05912343f0d26273ce35a5577fcc7474ce0b82385e73e20fda90da65da9c2cc`
...
- Marked-pixel bounds: (69,38)–(171,209); span 103 × 172 px; the marked
...
- 痕迹范围：(69,38)–(171,209)；跨度103 × 172 px；痕迹矩形高于宽。
