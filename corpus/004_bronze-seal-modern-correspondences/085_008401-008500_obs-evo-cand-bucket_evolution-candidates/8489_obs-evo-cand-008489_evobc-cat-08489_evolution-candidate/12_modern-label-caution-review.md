# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008489
...
- EVOBC candidate category: `evobc-evo-cat-08489`.
- Source label for search only: `豜`.
- Source codepoints for search only: `U+8C5C`.
