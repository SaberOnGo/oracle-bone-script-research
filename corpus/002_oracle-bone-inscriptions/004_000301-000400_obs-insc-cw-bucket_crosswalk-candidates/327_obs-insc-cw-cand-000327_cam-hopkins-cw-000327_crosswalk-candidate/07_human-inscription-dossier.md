...
Project ID: `obs-insc-cw-cand-000327`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000327`
...
- Source page section: `Period II Group 4` /
  `第 II 期第 4 组`
- Source section key: `period-ii-group-4`
- Section declared count: `16`
- Section observed row count: `21`
...
- Yingguo / 英国所藏: `y2001` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `514` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `397` in source row; primary catalog entry pending
- Heji / 合集: `41041` in source row; primary catalog entry pending
...
- Group and batch / 组类与批次: group `4`; batch or pit context pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000327`
