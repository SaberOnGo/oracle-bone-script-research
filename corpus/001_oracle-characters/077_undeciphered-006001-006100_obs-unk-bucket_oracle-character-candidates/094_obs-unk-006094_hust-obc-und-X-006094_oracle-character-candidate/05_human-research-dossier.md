# obs-unk-006094 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006094`
- primary external id: `hust-obc-und-X-006094`
...
- local review image route: `corpus/001_oracle-characters/077_undeciphered-006
  001-006100_obs-unk-bucket_oracle-character-candidates/094_obs-unk-006094_h
  ust-obc-und-X-006094_oracle-character-candidate/03_visual-assets/001_asset
  -007686_hust-obc-und-X-006094_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1650/X_？_3606_1.png`
- asset id: `asset-007686`
...
- source class: `HUST-OBC/undeciphered/X/1650/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1650/X_？_3606_1.png`
- asset id: `asset-007686`
...
- Which source records identify obs-unk-006094 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006094？
