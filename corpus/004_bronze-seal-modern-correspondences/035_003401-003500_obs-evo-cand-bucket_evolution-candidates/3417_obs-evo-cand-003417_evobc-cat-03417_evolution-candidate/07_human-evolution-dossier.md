...
- External category reference: `evobc-cat-03417`
- Source category ID: `03417`
- Source label for human review: `掫`
...
- `obs-evo-cand-003417-route-category-staging`
...
- `obs-evo-cand-003417-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003417-route-evolution-graph`
