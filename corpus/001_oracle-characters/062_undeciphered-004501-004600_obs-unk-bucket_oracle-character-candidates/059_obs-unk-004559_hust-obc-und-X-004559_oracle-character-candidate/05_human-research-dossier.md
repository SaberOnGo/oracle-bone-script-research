# obs-unk-004559 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/059_obs-unk-004559_h
  ust-obc-und-X-004559_oracle-character-candidate/03_visual-assets/001_asset
  -006152_hust-obc-und-X-004559_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/115/X_？_8295_1.png`
- asset id: `asset-006152`
...
- source class: `HUST-OBC/undeciphered/X/115/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/115/X_？_8295_1.png`
- asset id: `asset-006152`
...
- English observation: `Left openings, diagonal trace, and right form recorded.`
- 中文观察: `已记录左侧开口、斜向痕迹和右侧轮廓。`
...
- Which source records identify obs-unk-004559 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004559？
