# Material Visual Observation / obs-comp-cand-001317 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001317`
- External reference / 外部参照: `obimd-sub-ogt487t2u1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015654_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ogt487t2u1/ogt487t2u1/ogt487t2u1.png`
- Checksum / 校验和:
  `d048992885986295dc26e5c67528f239bc0d3ec0d25317c11ea145fd52c3647a`
...
- Marked-pixel bounds: (65,28)–(188,227); span 124 × 200 px; the marked
...
- 痕迹范围：(65,28)–(188,227)；跨度124 × 200 px；痕迹矩形高于宽。
