# Material Visual Observation / obs-comp-cand-002394 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002394`
- External reference / 外部参照: `obimd-sub-tyqo1wtoe5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020465_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kbaaq0n44y/tyqo1wtoe5/tyqo1wtoe5.png`
- Checksum / 校验和:
  `1138429eaeece955dc212077e9d61d66b8e6f0bd6993aa428f8ef9a096dd206d`
...
- Marked-pixel bounds: (90,32)–(157,213); span 68 × 182 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.86%。
- 痕迹范围：(90,32)–(157,213)；跨度68 × 182 px；痕迹矩形高于宽。
