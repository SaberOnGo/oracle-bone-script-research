# Material Visual Observation / obs-comp-cand-000121 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000121`
- External reference / 外部参照: `obimd-sub-iho3azmdgu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011533_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/iho3azmdgu/iho3azmdgu/iho3azmdgu.png`
- Checksum / 校验和:
  `f1e7320f48025f1d2fcdc74a574125f327824f79a2b5b96a8d679688e1df33dd`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.47%.
- Marked-pixel bounds: (62,43)–(202,220); span 141 × 178 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.47%。
- 痕迹范围：(62,43)–(202,220)；跨度141 × 178 px；痕迹矩形高于宽。
