# Material Visual Observation / obs-comp-cand-001534 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001534`
- External reference / 外部参照: `obimd-sub-58rt2jv8ut`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016948_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/58rt2jv8ut/58rt2jv8ut/58rt2jv8ut.png`
- Checksum / 校验和:
  `7069a161f385d172bac71007045c03459cfb0f8bd6a3ecf4568e5f5dbc911e9e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.19%.
- Marked-pixel bounds: (84,19)–(164,231); span 81 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.19%。
- 痕迹范围：(84,19)–(164,231)；跨度81 × 213 px；痕迹矩形高于宽。
