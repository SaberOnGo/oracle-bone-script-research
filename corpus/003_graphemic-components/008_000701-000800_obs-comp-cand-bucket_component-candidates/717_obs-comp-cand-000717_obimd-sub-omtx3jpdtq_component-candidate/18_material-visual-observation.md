# Material Visual Observation / obs-comp-cand-000717 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000717`
- External reference / 外部参照: `obimd-sub-omtx3jpdtq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013429_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/omtx3jpdtq/omtx3jpdtq/omtx3jpdtq.png`
- Checksum / 校验和:
  `bd525d1dc3e9a602e0b95c4bb2ebbdfd3ed3dc9e603b11e100637fd97e079199`
...
- Marked-pixel bounds: (82,34)–(167,220); span 86 × 187 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.62%。
- 痕迹范围：(82,34)–(167,220)；跨度86 × 187 px；痕迹矩形高于宽。
