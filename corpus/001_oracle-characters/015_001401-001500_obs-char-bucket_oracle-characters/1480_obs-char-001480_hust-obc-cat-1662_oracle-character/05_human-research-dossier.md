# obs-char-001480 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001480`
- primary external id: `hust-obc-cat-1662`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1480_obs-char-001480_hust-obc-cat-1662_ora
  cle-character/03_visual-assets/001_asset-001485_hust-obc-cat-1662_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1662/G_1662_乙8187合5401賓組.png`
- asset id: `asset-001485`
...
- source category: `1662`
- validation class: `1479`
- source image route: `HUST-OBC/deciphered/1662/G_1662_乙8187合5401賓組.png`
- asset id: `asset-001485`
...
- English observation: `A rectangular upper frame contains a diagonal and
  two short lower supports.`
- 中文观察: `矩形上部框形内部有斜笔，下接两个短支撑笔。`
...
- dataset label text: `㩴`
- dataset label codepoints: `U+3A74`
...
- filename catalog route clues: `Heji-like filename clue: 合5401
  (G_1662_乙8187合5401賓組.png)`
...
- Which source records identify obs-char-001480 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001480？
