# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001535
...
| --- | --- | --- | --- |
| `obimd-glyph-link-023879` | 𬪰󇰚󸞴 | `U+2CAB0;U+C7C1A;U+F87B4` | `reviewed_metadata_only` |
| `obimd-glyph-link-023880` | 󸾥 | `U+F8FA5` | `reviewed_metadata_only` |
| `obimd-glyph-link-023881` | 󸾦 | `U+F8FA6` | `reviewed_metadata_only` |
