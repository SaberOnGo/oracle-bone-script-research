...
- External category reference: `evobc-cat-06669`
- Source category ID: `06669`
- Source label for human review: `繐`
...
- `obs-evo-cand-006669-route-category-staging`
...
- `obs-evo-cand-006669-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006669-route-evolution-graph`
