# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-000028
...
- candidate_component_id: `obs-comp-cand-000028`
- primary_external_ref_id: `obimd-sub-8jtrxi583p`
- source_subcharacter_uid: `8jtrxi583p`
- source_main_character_uid: `8jtrxi583p`
- main_character_external_ref_id: `obimd-main-8jtrxi583p`
...
- glyph_codepoint_uplus_sample: `U+4F9A;U+F02C8, U+F02C9`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-011180` | `001_asset-011180_img.png` | `042b4d93c7619a420c29c1dbfa4865bc88b661732abe297cb4ff6363c34841a6` |
