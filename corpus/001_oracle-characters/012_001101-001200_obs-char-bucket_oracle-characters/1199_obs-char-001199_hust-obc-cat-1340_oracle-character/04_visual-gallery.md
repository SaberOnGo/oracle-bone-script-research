# obs-char-001199 Visual Gallery / obs-char-001199 图像资料页
...
- Primary external reference / 首选外部参考: `hust-obc-cat-1340`
...
## obs-char-001199-visual-source-001 / 图像条目

![obs-char-001199 glyph candidate](03_visual-assets/001_asset-001204_hust-obc-cat-1340_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-001204_hust-obc-cat-1340_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-001204_hust-obc-cat-1340_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/1340/G_1340_前4.1.7(甲).png`
