# obs-xwalk-cand-001280 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+398E` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-1432` | not reading |
