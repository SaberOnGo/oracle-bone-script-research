...
Project ID: `obs-insc-cw-cand-000087`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000087`
...
- Yingguo / 英国所藏: `y551` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `102` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `592` in source row; primary catalog entry pending
- Heji / 合集: `40032` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000087`
