# Material Visual Observation / obs-comp-cand-001624 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001624`
- External reference / 外部参照: `obimd-sub-egd60be7r0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017300_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/egd60be7r0/egd60be7r0/egd60be7r0.png`
- Checksum / 校验和:
  `4741f459a8d0bb8f2660f7d5b4dcfa52c65fe44f41112ce065f25b4bb89d1471`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.53%.
- Marked-pixel bounds: (77,25)–(172,220); span 96 × 196 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.53%。
- 痕迹范围：(77,25)–(172,220)；跨度96 × 196 px；痕迹矩形高于宽。
