# obs-char-000109 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000109`
- primary external id: `hust-obc-cat-0123`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/109_obs-char-000109_hust-obc-cat-0123_orac
  le-character/03_visual-assets/001_asset-000114_hust-obc-cat-0123_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0123/G_0123_乙6310反合6948反賓組.png`
- asset id: `asset-000114`
...
- source category: `0123`
- validation class: `108`
- source image route: `HUST-OBC/deciphered/0123/G_0123_乙6310反合6948反賓組.png`
- asset id: `asset-000114`
...
- English observation: `The image has two short upper horizontal strokes
  above an open angular enclosure with a small inner corner.`
...
- dataset label text: `㑱`
- dataset label codepoints: `U+3471`
...
- filename catalog route clues: `Heji-like filename clue: 合6948
  (G_0123_乙6310反合6948反賓組.png)`
...
- Which source records identify obs-char-000109 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000109？
