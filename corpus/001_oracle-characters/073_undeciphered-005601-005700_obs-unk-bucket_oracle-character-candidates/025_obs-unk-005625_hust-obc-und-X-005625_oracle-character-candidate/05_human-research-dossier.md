# obs-unk-005625 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/073_undeciphered-005
  601-005700_obs-unk-bucket_oracle-character-candidates/025_obs-unk-005625_h
  ust-obc-und-X-005625_oracle-character-candidate/03_visual-assets/001_asset
  -007218_hust-obc-und-X-005625_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1181/X_？_7197_1.png`
- asset id: `asset-007218`
...
- source class: `HUST-OBC/undeciphered/X/1181/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1181/X_？_7197_1.png`
- asset id: `asset-007218`
...
- Which source records identify obs-unk-005625 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005625？
