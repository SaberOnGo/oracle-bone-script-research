# Material Visual Observation / obs-comp-cand-001163 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001163`
- External reference / 外部参照: `obimd-sub-wu9j4fyp5p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015353_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wu9j4fyp5p/wu9j4fyp5p/wu9j4fyp5p.png`
- Checksum / 校验和:
  `4cbb8999a6119cb1364f43f9863f15119bd7fbba9d4c2cd85c54908d9374d0da`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.45%.
- Marked-pixel bounds: (80,17)–(167,231); span 88 × 215 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.45%。
- 痕迹范围：(80,17)–(167,231)；跨度88 × 215 px；痕迹矩形高于宽。
