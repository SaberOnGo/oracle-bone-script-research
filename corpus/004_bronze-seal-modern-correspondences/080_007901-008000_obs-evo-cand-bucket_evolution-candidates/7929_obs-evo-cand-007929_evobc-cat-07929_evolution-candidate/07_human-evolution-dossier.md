...
Project ID: `obs-evo-cand-007929`
...
- Project ID: `obs-evo-cand-007929`
- EVOBC category candidate ID: `evobc-evo-cat-07929`
- External category reference: `evobc-cat-07929`
- Source category ID: `07929`
- Source label for human review: `衵`
- Source codepoints: `U+8875`
...
- `obs-evo-cand-007929-route-category-staging`
...
- `obs-evo-cand-007929-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007929-route-evolution-graph`
