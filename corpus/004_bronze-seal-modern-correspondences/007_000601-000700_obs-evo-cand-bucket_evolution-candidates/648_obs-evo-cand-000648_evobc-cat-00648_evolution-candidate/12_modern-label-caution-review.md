# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000648
...
- EVOBC candidate category: `evobc-evo-cat-00648`.
- Source label for search only: `丽`.
- Source codepoints for search only: `U+4E3D`.
