# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006297
...
- EVOBC candidate category: `evobc-evo-cat-06297`.
- Source label for search only: `箝`.
- Source codepoints for search only: `U+7B9D`.
