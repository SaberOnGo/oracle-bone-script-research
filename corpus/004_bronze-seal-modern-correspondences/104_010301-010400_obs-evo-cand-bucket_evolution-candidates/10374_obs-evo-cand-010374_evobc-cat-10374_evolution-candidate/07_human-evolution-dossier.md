...
Project ID: `obs-evo-cand-010374`
...
- Project ID: `obs-evo-cand-010374`
- EVOBC category candidate ID: `evobc-evo-cat-10374`
- External category reference: `evobc-cat-10374`
- Source category ID: `10374`
- Source label for human review: `魭`
- Source codepoints: `U+9B6D`
...
- `obs-evo-cand-010374-route-category-staging`
...
- `obs-evo-cand-010374-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010374-route-evolution-graph`
