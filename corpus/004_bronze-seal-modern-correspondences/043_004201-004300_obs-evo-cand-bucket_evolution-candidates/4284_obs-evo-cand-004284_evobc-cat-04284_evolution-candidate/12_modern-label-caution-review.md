# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004284
...
- EVOBC candidate category: `evobc-evo-cat-04284`.
- Source label for search only: `檇`.
- Source codepoints for search only: `U+6A87`.
