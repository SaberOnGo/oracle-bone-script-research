...
- Project ID: `obs-evo-cand-013079`
- EVOBC category candidate ID: `evobc-evo-cat-13079`
- External category reference: `evobc-cat-13079`
- Source category ID: `13079`
- Source label for human review: `𫱹`
- Source codepoints: `U+2BC79`
...
- `obs-evo-cand-013079-route-category-staging`
...
- `obs-evo-cand-013079-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013079-route-evolution-graph`
