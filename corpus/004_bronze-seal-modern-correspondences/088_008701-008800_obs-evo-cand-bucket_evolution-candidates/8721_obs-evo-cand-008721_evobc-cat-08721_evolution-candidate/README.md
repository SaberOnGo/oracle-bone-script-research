# obs-evo-cand-008721 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-08721`
- Source label: `路`
- Source codepoints: `U+8DEF`
- Image reference count: `54`
- Era token counts: `BI:4;CS:1;SS:2;WSC:47`
- Source token counts: `Book:13;Web:41`
