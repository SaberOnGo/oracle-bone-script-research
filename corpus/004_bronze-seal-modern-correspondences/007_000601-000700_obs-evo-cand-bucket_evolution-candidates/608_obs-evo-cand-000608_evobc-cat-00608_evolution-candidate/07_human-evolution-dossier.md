...
- Project ID: `obs-evo-cand-000608`
- EVOBC category candidate ID: `evobc-evo-cat-00608`
- External category reference: `evobc-cat-00608`
- Source category ID: `00608`
- Source label for human review: `丈`
- Source codepoints: `U+4E08`
...
- `obs-evo-cand-000608-route-category-staging`
...
- `obs-evo-cand-000608-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000608-route-evolution-graph`
