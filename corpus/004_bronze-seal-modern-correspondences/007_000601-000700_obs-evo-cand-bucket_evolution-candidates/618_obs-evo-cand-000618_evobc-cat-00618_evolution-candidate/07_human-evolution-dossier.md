...
- External category reference: `evobc-cat-00618`
- Source category ID: `00618`
- Source label for human review: `且`
- Source codepoints: `U+4E14`
- Image reference count in source metadata: `380`
...
- `obs-evo-cand-000618-route-category-staging`
...
- `obs-evo-cand-000618-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000618-route-evolution-graph`
