# Material Visual Observation / obs-comp-cand-001929 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001929`
- External reference / 外部参照: `obimd-sub-52a130pcmy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018339_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/52a130pcmy/52a130pcmy/059q2v1s77.png`
- Checksum / 校验和:
  `99b56d220d313c613343b2cb26f0e13b20195153780dc52b0cd493fc88731f99`
...
- Marked-pixel bounds: (92,19)–(157,230); span 66 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.62%。
- 痕迹范围：(92,19)–(157,230)；跨度66 × 212 px；痕迹矩形高于宽。
