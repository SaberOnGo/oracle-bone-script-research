...
Project ID: `obs-evo-cand-004245`
...
- Project ID: `obs-evo-cand-004245`
- EVOBC category candidate ID: `evobc-evo-cat-04245`
- External category reference: `evobc-cat-04245`
- Source category ID: `04245`
- Source label for human review: `樠`
- Source codepoints: `U+6A20`
...
- `obs-evo-cand-004245-route-category-staging`
...
- `obs-evo-cand-004245-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004245-route-evolution-graph`
