# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001636
...
| --- | --- | --- | --- |
| `obimd-glyph-link-025300` | 󹟽 | `U+F97FD` | `reviewed_metadata_only` |
| `obimd-glyph-link-025301` | 󹟾 | `U+F97FE` | `reviewed_metadata_only` |
