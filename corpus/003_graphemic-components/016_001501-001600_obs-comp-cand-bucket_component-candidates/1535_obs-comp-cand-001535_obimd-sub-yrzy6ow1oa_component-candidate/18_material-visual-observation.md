# Material Visual Observation / obs-comp-cand-001535 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001535`
- External reference / 外部参照: `obimd-sub-yrzy6ow1oa`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016949_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/58rt2jv8ut/yrzy6ow1oa/yrzy6ow1oa.png`
- Checksum / 校验和:
  `afc4208494ac956e8508390e6c15454a92b96198f2ea0cd915654b9985a51178`
...
- Marked-pixel bounds: (78,10)–(161,237); span 84 × 228 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.68%。
- 痕迹范围：(78,10)–(161,237)；跨度84 × 228 px；痕迹矩形高于宽。
