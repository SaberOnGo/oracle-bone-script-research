# Material Visual Observation / obs-comp-cand-002153 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002153`
- External reference / 外部参照: `obimd-sub-c4uzt5w1qm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019794_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/c4uzt5w1qm/c4uzt5w1qm/c4uzt5w1qm.png`
- Checksum / 校验和:
  `e90eb73f538fc83d47fb63ecd265c504745ac7e17710b7a078e74be22d575de0`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.76%.
- Marked-pixel bounds: (90,20)–(183,229); span 94 × 210 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.76%。
- 痕迹范围：(90,20)–(183,229)；跨度94 × 210 px；痕迹矩形高于宽。
