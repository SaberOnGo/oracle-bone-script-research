# obs-char-000853 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/853_obs-char-000853_hust-obc-cat-0962_orac
  le-character/03_visual-assets/001_asset-000858_hust-obc-cat-0962_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0962/X_0962_5009_1.png`
- asset id: `asset-000858`
...
- source category: `0962`
- validation class: `852`
- source image route: `HUST-OBC/deciphered/0962/X_0962_5009_1.png`
- asset id: `asset-000858`
...
- English observation: `Two broad outer curves enclose a central pointed
  opening and a horizontal crossing; small detached marks sit near the lower
  left.`
...
- dataset label text: `㞸`
- dataset label codepoints: `U+37B8`
...
- Which source records identify obs-char-000853 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000853？
