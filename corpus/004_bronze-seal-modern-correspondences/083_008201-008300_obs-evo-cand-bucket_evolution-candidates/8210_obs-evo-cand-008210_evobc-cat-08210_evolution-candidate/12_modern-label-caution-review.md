# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008210
...
- EVOBC candidate category: `evobc-evo-cat-08210`.
- Source label for search only: `詿`.
- Source codepoints for search only: `U+8A7F`.
