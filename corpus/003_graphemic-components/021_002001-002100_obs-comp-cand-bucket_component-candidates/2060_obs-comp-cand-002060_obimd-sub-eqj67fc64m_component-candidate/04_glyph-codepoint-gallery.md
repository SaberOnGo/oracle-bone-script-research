# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002060
...
| --- | --- | --- | --- |
| `obimd-glyph-link-031644` | 󻵛 | `U+FBD5B` | `reviewed_metadata_only` |
| `obimd-glyph-link-031645` | 󻵜 | `U+FBD5C` | `reviewed_metadata_only` |
