# obs-char-000887 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/887_obs-char-000887_hust-obc-cat-0999_orac
  le-character/03_visual-assets/001_asset-000892_hust-obc-cat-0999_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0999/G_0999_前1.3.5(甲).png`
- asset id: `asset-000892`
...
- source category: `0999`
- validation class: `886`
- source image route: `HUST-OBC/deciphered/0999/G_0999_前1.3.5(甲).png`
- asset id: `asset-000892`
...
- dataset label text: `㟝`
- dataset label codepoints: `U+37DD`
...
- Which source records identify obs-char-000887 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000887？
