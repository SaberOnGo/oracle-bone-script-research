# obs-unk-009367 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-009367`
- primary external id: `hust-obc-und-YH-009367`
...
- local review image route: `corpus/001_oracle-characters/110_undeciphered-009
  301-009400_obs-unk-bucket_oracle-character-candidates/067_obs-unk-009367_h
  ust-obc-und-YH-009367_oracle-character-candidate/03_visual-assets/001_asse
  t-010958_hust-obc-und-YH-009367_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/617C1/H_？_617C1_0.png`
- asset id: `asset-010958`
...
- source class: `HUST-OBC/undeciphered/Y+H/617C1/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/617C1/H_？_617C1_0.png`
- asset id: `asset-010958`
...
- Which source records identify obs-unk-009367 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009367？
