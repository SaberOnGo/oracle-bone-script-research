# Material Visual Observation / obs-comp-cand-000014 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000014`
- External reference / 外部参照: `obimd-sub-plssynksd8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011079_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0wfbo7ml5k/plssynksd8/0hkcyx5cti.png`
- Checksum / 校验和:
  `2e7c8678eb24e44e49246638f141070c361db75bba6d181b898565eeeb38f1f6`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.98%.
- Marked-pixel bounds: (59,45)–(190,197); span 132 × 153 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.98%。
- 痕迹范围：(59,45)–(190,197)；跨度132 × 153 px；痕迹矩形近方形。
