...
- External category reference: `evobc-cat-00116`
- Source category ID: `00116`
- Source label for human review: `㤣`
- Source codepoints: `U+3923`
...
- `obs-evo-cand-000116-route-category-staging`
...
- `obs-evo-cand-000116-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000116-route-evolution-graph`
