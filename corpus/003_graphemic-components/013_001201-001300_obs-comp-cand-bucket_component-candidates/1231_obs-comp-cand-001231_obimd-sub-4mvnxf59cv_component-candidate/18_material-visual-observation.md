# Material Visual Observation / obs-comp-cand-001231 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001231`
- External reference / 外部参照: `obimd-sub-4mvnxf59cv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015469_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/u7j8pvl5zq/4mvnxf59cv/4mvnxf59cv.png`
- Checksum / 校验和:
  `f0f66f9e7f63a0b052d63e0af8b07d6290140a99dacb5e1b7379d20426a6619e`
...
- Marked-pixel bounds: (58,23)–(198,227); span 141 × 205 px; the marked
...
- 痕迹范围：(58,23)–(198,227)；跨度141 × 205 px；痕迹矩形高于宽。
