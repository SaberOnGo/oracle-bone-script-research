...
- Source page section: `Period V Group 7` /
  `第 V 期第 7 组`
- Source section key: `period-v-group-7`
...
- Yingguo / 英国所藏: `y2538` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `342` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `448` in source row; primary catalog entry pending
- Heji / 合集: `41761` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000537`
