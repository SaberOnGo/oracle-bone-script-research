# obs-unk-004894 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004894`
- primary external id: `hust-obc-und-X-004894`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/094_obs-unk-004894_h
  ust-obc-und-X-004894_oracle-character-candidate/03_visual-assets/001_asset
  -006487_hust-obc-und-X-004894_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/450/X_？_7430_1.png`
- asset id: `asset-006487`
...
- source class: `HUST-OBC/undeciphered/X/450/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/450/X_？_7430_1.png`
- asset id: `asset-006487`
...
- English observation: `tall right curve and broad left branch`
- 中文观察: `右侧高弧线和左侧宽大分枝`
...
- Which source records identify obs-unk-004894 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004894？
