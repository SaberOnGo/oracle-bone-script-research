# Material Visual Observation / obs-comp-cand-002512 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002512`
- External reference / 外部参照: `obimd-sub-vnnwra099w`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020818_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/pymg8s4d83/vnnwra099w/vnnwra099w.png`
- Checksum / 校验和:
  `078667a557490716809fa18dee361f43493813ffaede539dc4587ddd2517c248`
...
- Marked-pixel bounds: (72,38)–(177,205); span 106 × 168 px; the marked
...
- 痕迹范围：(72,38)–(177,205)；跨度106 × 168 px；痕迹矩形高于宽。
