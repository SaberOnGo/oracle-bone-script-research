# obs-char-001433 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1433_obs-char-001433_hust-obc-cat-1605_160
  6_oracle-character/03_visual-assets/001_asset-001438_hust-obc-cat-1605_160
  6_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1605_1606/1606/G_1606_甲2091(甲).
  png`
- asset id: `asset-001438`
...
- source category: `1605_1606`
- validation class: `1432`
- source image route: `HUST-OBC/deciphered/1605_1606/1606/G_1606_甲2091(甲).png`
- asset id: `asset-001438`
...
- dataset label text: `㨻㨼`
- dataset label codepoints: `U+3A3B;U+3A3C`
...
- graph edge count: `2`
- codepoint routes: `U+3A3B;U+3A3C`
...
- Which source records identify obs-char-001433 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001433？
