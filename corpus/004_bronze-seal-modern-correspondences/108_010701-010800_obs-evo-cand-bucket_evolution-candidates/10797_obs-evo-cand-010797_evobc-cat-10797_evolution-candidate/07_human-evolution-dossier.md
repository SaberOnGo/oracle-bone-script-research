...
- External category reference: `evobc-cat-10797`
- Source category ID: `10797`
- Source label for human review: `𠉤`
- Source codepoints: `U+20264`
...
- `obs-evo-cand-010797-route-category-staging`
...
- `obs-evo-cand-010797-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010797-route-evolution-graph`
