# Material Visual Observation / obs-comp-cand-001502 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001502`
- External reference / 外部参照: `obimd-sub-y2ewmrnlib`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016430_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/353gxm6hd4/y2ewmrnlib/y2ewmrnlib.png`
- Checksum / 校验和:
  `b75d1a6a85f2a92b077bb43308ec13e3897d1f8c3619ca2da4596cdf3b0ed8dc`
...
- Marked-pixel bounds: (73,50)–(177,194); span 105 × 145 px; the marked
...
- 痕迹范围：(73,50)–(177,194)；跨度105 × 145 px；痕迹矩形高于宽。
