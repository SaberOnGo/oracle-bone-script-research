# obs-comp-cand-002680 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002680`
- 首选外部 ID: `obimd-sub-o9mnopmdba`
- OBIMD subcharacter UID: `o9mnopmdba`
- OBIMD main character UID: `o9mnopmdba`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+FF1CE; U+FF1CF; 另有 2 项
