...
- `obs-evo-cand-001778-route-category-staging`
...
- `obs-evo-cand-001778-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001778-route-evolution-graph`
