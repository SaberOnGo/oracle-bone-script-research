...
- `obs-evo-cand-002388-route-category-staging`
...
- `obs-evo-cand-002388-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002388-route-evolution-graph`
