# Material Visual Observation / obs-comp-cand-001361 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001361`
- External reference / 外部参照: `obimd-sub-hynap6jf6z`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015780_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tp5ykv5jzh/hynap6jf6z/hynap6jf6z.png`
- Checksum / 校验和:
  `c1e47a55429bcafec9c9594ffba3d0f7ed99879915926975d4a151604755cf15`
...
- Marked-pixel bounds: (72,54)–(177,190); span 106 × 137 px; the marked
...
- 痕迹范围：(72,54)–(177,190)；跨度106 × 137 px；痕迹矩形高于宽。
