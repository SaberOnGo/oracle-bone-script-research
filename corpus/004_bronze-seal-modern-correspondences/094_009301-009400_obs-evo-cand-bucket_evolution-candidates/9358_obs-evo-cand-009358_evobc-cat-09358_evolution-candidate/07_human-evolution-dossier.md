...
- External category reference: `evobc-cat-09358`
- Source category ID: `09358`
- Source label for human review: `鉐`
...
- `obs-evo-cand-009358-route-category-staging`
...
- `obs-evo-cand-009358-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009358-route-evolution-graph`
