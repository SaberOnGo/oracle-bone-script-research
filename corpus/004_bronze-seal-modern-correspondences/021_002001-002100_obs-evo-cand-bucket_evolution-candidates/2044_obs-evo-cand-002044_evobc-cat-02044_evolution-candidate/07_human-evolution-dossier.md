...
- External category reference: `evobc-cat-02044`
- Source category ID: `02044`
- Source label for human review: `奚`
- Source codepoints: `U+595A`
- Image reference count in source metadata: `164`
...
- `obs-evo-cand-002044-route-category-staging`
...
- `obs-evo-cand-002044-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002044-route-evolution-graph`
