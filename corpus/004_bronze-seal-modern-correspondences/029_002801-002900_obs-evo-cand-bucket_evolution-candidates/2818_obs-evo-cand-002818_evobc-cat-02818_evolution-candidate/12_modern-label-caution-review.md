# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002818
...
- EVOBC candidate category: `evobc-evo-cat-02818`.
- Source label for search only: `强`.
- Source codepoints for search only: `U+5F3A`.
