# obs-unk-005215 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/069_undeciphered-005
  201-005300_obs-unk-bucket_oracle-character-candidates/015_obs-unk-005215_h
  ust-obc-und-X-005215_oracle-character-candidate/03_visual-assets/001_asset
  -006808_hust-obc-und-X-005215_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/771/X_？_7733_1.png`
- asset id: `asset-006808`
...
- source class: `HUST-OBC/undeciphered/X/771/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/771/X_？_7733_1.png`
- asset id: `asset-006808`
...
- Which source records identify obs-unk-005215 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005215？
