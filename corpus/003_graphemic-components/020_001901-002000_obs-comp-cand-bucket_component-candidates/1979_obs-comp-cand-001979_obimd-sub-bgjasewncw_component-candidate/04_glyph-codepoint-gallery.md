# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001979
...
| --- | --- | --- | --- |
| `obimd-glyph-link-030116` | 򨲃󻓷 | `U+A8C83;U+FB4F7` | `reviewed_metadata_only` |
| `obimd-glyph-link-030117` | 󻓸 | `U+FB4F8` | `reviewed_metadata_only` |
