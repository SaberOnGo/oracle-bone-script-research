...
- External category reference: `evobc-cat-07338`
- Source category ID: `07338`
- Source label for human review: `荃`
...
- `obs-evo-cand-007338-route-category-staging`
...
- `obs-evo-cand-007338-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007338-route-evolution-graph`
