# Material Visual Observation / obs-comp-cand-002073 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002073`
- External reference / 外部参照: `obimd-sub-ce6gcjhck6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019460_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/p6gn06lpie/ce6gcjhck6/ce6gcjhck6.png`
- Checksum / 校验和:
  `a3be9e10fa065c68924e146f61e20c102e83f6e772869a35ae91cf7878002c32`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.76%.
- Marked-pixel bounds: (56,23)–(197,225); span 142 × 203 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.76%。
- 痕迹范围：(56,23)–(197,225)；跨度142 × 203 px；痕迹矩形高于宽。
