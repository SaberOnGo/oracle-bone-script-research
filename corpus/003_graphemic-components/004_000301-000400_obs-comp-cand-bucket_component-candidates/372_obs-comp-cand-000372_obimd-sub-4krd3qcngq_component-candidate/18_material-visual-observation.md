# Material Visual Observation / obs-comp-cand-000372 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000372`
- External reference / 外部参照: `obimd-sub-4krd3qcngq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012295_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4krd3qcngq/4krd3qcngq/4krd3qcngq.png`
- Checksum / 校验和:
  `dbcc276053fb50cea987623d761091d25575386df3111685d08bad4570561d22`
...
- Marked-pixel bounds: (56,38)–(193,208); span 138 × 171 px; the marked
...
- 痕迹范围：(56,38)–(193,208)；跨度138 × 171 px；痕迹矩形高于宽。
