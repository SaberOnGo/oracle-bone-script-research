...
- External category reference: `evobc-cat-04667`
- Source category ID: `04667`
...
- `obs-evo-cand-004667-route-category-staging`
...
- `obs-evo-cand-004667-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004667-route-evolution-graph`
