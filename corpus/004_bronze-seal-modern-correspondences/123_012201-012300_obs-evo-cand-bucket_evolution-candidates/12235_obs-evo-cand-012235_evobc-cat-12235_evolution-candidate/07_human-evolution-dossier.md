...
- Project ID: `obs-evo-cand-012235`
- EVOBC category candidate ID: `evobc-evo-cat-12235`
- External category reference: `evobc-cat-12235`
- Source category ID: `12235`
- Source label for human review: `𧩨`
- Source codepoints: `U+27A68`
...
- `obs-evo-cand-012235-route-category-staging`
...
- `obs-evo-cand-012235-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012235-route-evolution-graph`
