...
Project ID: `obs-evo-cand-011319`
...
- Project ID: `obs-evo-cand-011319`
- EVOBC category candidate ID: `evobc-evo-cat-11319`
- External category reference: `evobc-cat-11319`
- Source category ID: `11319`
- Source label for human review: `𢸑`
- Source codepoints: `U+22E11`
...
- `obs-evo-cand-011319-route-category-staging`
...
- `obs-evo-cand-011319-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011319-route-evolution-graph`
