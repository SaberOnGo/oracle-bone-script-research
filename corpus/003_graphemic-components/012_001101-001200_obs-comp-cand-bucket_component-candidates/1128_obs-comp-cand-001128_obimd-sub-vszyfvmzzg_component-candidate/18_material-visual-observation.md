# Material Visual Observation / obs-comp-cand-001128 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001128`
- External reference / 外部参照: `obimd-sub-vszyfvmzzg`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015082_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vszyfvmzzg/vszyfvmzzg/vszyfvmzzg.png`
- Checksum / 校验和:
  `96ca5041e566188fa24612cd6b73295a91deac8e35036e7fc94d1f7b503807de`
...
- Marked-pixel bounds: (52,26)–(195,222); span 144 × 197 px; the marked
...
- 痕迹范围：(52,26)–(195,222)；跨度144 × 197 px；痕迹矩形高于宽。
