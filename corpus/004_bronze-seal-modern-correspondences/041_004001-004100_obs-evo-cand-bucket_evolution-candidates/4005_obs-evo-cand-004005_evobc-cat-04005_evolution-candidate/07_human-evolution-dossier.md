...
- External category reference: `evobc-cat-04005`
- Source category ID: `04005`
- Source label for human review: `栭`
- Source codepoints: `U+682D`
...
- `obs-evo-cand-004005-route-category-staging`
...
- `obs-evo-cand-004005-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004005-route-evolution-graph`
