...
Project ID: `obs-evo-cand-001576`
...
- Project ID: `obs-evo-cand-001576`
- EVOBC category candidate ID: `evobc-evo-cat-01576`
- External category reference: `evobc-cat-01576`
- Source category ID: `01576`
- Source label for human review: `咽`
- Source codepoints: `U+54BD`
...
- `obs-evo-cand-001576-route-category-staging`
...
- `obs-evo-cand-001576-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001576-route-evolution-graph`
