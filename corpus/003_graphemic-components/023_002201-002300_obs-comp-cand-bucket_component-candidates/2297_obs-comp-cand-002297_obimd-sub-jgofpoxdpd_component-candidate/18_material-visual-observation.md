# Material Visual Observation / obs-comp-cand-002297 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002297`
- External reference / 外部参照: `obimd-sub-jgofpoxdpd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020316_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jgofpoxdpd/jgofpoxdpd/jgofpoxdpd.png`
- Checksum / 校验和:
  `2627023f23f96bc51dbf0ebb54c658236e1ebc375874cac3191f4ea75c1516fd`
...
- Marked-pixel bounds: (66,30)–(187,224); span 122 × 195 px; the marked
...
- 痕迹范围：(66,30)–(187,224)；跨度122 × 195 px；痕迹矩形高于宽。
