# Material Visual Observation / obs-comp-cand-001942 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001942`
- External reference / 外部参照: `obimd-sub-g6g2sgdmcc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018728_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/41cgu5ewmd/g6g2sgdmcc/1va8ix542i.png`
- Checksum / 校验和:
  `672569924813d018c5be2fc03f42eb1f9198f73637db679857d3a82de2040139`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.43%.
- Marked-pixel bounds: (76,25)–(173,218); span 98 × 194 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.43%。
- 痕迹范围：(76,25)–(173,218)；跨度98 × 194 px；痕迹矩形高于宽。
