...
- External category reference: `evobc-cat-02177`
- Source category ID: `02177`
- Source label for human review: `娧`
- Source codepoints: `U+5A27`
...
- `obs-evo-cand-002177-route-category-staging`
...
- `obs-evo-cand-002177-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002177-route-evolution-graph`
