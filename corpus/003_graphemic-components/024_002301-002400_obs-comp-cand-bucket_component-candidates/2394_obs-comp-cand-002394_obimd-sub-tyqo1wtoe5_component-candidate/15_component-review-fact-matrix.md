# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002394
...
| Glyph or codepoint route / 字形或码位路线 | 2 OBIMD route rows; examples U+FDB1C; U+FDB1D | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
