# obs-unk-003979 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/079_obs-unk-003979_h
  ust-obc-und-L-003979_oracle-character-candidate/03_visual-assets/001_asset
  -005572_hust-obc-und-L-003979_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3979/L_？_8421.jpg`
- asset id: `asset-005572`
...
- source class: `HUST-OBC/undeciphered/L/3979/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3979/L_？_8421.jpg`
- asset id: `asset-005572`
...
- English observation: A separate left trace accompanies a compact central form
  with curved, angular, and narrow lower marks.
- 中文观察：分开左侧短痕邻近紧凑中央形体，中央有弧向、折角和下部窄痕。
...
- Which source records identify obs-unk-003979 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003979？
