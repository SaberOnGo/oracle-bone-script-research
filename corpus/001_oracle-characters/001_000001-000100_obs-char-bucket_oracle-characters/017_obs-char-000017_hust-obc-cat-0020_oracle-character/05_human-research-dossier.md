# obs-char-000017 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000017`
- primary external id: `hust-obc-cat-0020`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/017_obs-char-000017_hust-obc-cat-0020_orac
  le-character/03_visual-assets/001_asset-000022_hust-obc-cat-0020_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0020/G_0020_寧滬1.340合34676歷組.png
  `
- asset id: `asset-000022`
...
- source category: `0020`
- validation class: `16`
- source image route: `HUST-OBC/deciphered/0020/G_0020_寧滬1.340合34676歷組.png`
- asset id: `asset-000022`
...
- English observation: `The image has a tall arched outer contour, a curved
  interior mark, and two long lower strokes.`
- 中文观察: `图像有高拱形外轮廓，内部有弯曲痕迹，下方有两条较长笔画。`
...
- dataset label text: `㐊`
- dataset label codepoints: `U+340A`
...
- filename catalog route clues: `Heji-like filename clue: 合34676
  (G_0020_寧滬1.340合34676歷組.png)`
...
- Which source records identify obs-char-000017 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000017？
