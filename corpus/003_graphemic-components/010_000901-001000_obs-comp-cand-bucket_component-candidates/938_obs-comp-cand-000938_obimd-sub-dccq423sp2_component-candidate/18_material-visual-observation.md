# Material Visual Observation / obs-comp-cand-000938 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000938`
- External reference / 外部参照: `obimd-sub-dccq423sp2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014021_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dccq423sp2/dccq423sp2/dccq423sp2.png`
- Checksum / 校验和:
  `bd8977f44685d8e22c7563758e172258808cace3f009c58feadea9dd1d2c7c5e`
...
- Marked-pixel bounds: (65,37)–(184,215); span 120 × 179 px; the marked
...
- 痕迹范围：(65,37)–(184,215)；跨度120 × 179 px；痕迹矩形高于宽。
