...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1404`
...
- Source image / 来源图: `L_1404_11400.jpg`
- Image / 图像: `001_asset-001261_hust-obc-cat-1404_glyph.png`
...
- target node: `evobc-evo-cat-00131`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00131`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00131`
...
- Matched candidate folders / 匹配候选目录: `evobc-evo-cat-00131`
- Human review files / 人类复核文件:
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/131_obs-evo-cand-000131_evobc-cat-00131_evoluti
...
- Source label text / 来源标签文字: `㥲`
- Source label codepoint / 来源标签 codepoint: `U+3972`
