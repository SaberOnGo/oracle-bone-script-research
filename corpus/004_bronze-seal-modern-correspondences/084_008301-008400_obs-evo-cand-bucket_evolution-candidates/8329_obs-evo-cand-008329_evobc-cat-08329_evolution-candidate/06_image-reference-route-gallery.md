...
- `obs-evo-cand-008329-route-category-staging`
...
- `obs-evo-cand-008329-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008329-route-evolution-graph`
