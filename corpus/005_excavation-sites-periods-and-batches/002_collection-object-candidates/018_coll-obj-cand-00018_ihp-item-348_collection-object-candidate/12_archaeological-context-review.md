# Archaeological Context Review / 考古语境复核: coll-obj-cand-00018
...
| Source item | `348` | `01_collection-object-packet.json` |
| Catalog description | `Chia 2336` | `01_collection-object-packet.json` |
...
| Live source evidence | source description and image checked; 3D route pending | `18_live-source-evidence-review.md` |
...
- Which source description, 3D object, or image observation still needs an
  independent check?
- 先打开哪个机构页和登记号？
- 缺哪项出土地、时期或批次？
- 哪条图版或著录路线待复核？
- 哪些卜辞或单字关联仍为候选？
- 哪项来源说明、3D 对象或图像观察仍需独立核对？
