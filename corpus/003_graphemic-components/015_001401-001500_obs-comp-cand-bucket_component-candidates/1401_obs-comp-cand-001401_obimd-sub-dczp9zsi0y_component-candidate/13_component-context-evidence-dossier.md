# obs-comp-cand-001401 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001401`
- 首选外部 ID: `obimd-sub-dczp9zsi0y`
- OBIMD subcharacter UID: `dczp9zsi0y`
- OBIMD main character UID: `bnzum9xkvt`
- 来源 ID: `src-obimd`
...
- codepoint 示例: U+F7FDC; U+F7FDD; 另有 9 项
