# obs-comp-cand-001047 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001047`
- 首选外部 ID: `obimd-sub-a9n7vw34kp`
- OBIMD subcharacter UID: `a9n7vw34kp`
- OBIMD main character UID: `a9n7vw34kp`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+BA5C7;U+F5128; U+F54DF
