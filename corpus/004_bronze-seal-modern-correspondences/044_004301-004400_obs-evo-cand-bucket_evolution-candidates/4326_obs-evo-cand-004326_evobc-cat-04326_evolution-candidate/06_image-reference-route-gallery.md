...
- `obs-evo-cand-004326-route-category-staging`
...
- `obs-evo-cand-004326-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004326-route-evolution-graph`
