# obs-char-001560 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001560`
- primary external id: `hust-obc-cat-1751`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1560_obs-char-001560_hust-obc-cat-1751_ora
  cle-character/03_visual-assets/001_asset-001565_hust-obc-cat-1751_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1751/X_1751_4706_1.png`
- asset id: `asset-001565`
...
- source category: `1751`
- validation class: `1559`
- source image route: `HUST-OBC/deciphered/1751/X_1751_4706_1.png`
- asset id: `asset-001565`
...
- dataset label text: `㫍`
- dataset label codepoints: `U+3ACD`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00156`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00156`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00156`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/156_obs-evo-can
  d-000156_evobc-cat-00156_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/156_obs-evo-cand-000156_evobc-cat-00156_evolu
...
- Which source records identify obs-char-001560 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001560？
