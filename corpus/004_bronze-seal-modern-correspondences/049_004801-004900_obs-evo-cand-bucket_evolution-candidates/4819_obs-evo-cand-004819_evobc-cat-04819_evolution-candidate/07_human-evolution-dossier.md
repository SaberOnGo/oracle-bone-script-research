...
- Project ID: `obs-evo-cand-004819`
- EVOBC category candidate ID: `evobc-evo-cat-04819`
- External category reference: `evobc-cat-04819`
- Source category ID: `04819`
- Source label for human review: `溪`
- Source codepoints: `U+6EAA`
...
- `obs-evo-cand-004819-route-category-staging`
...
- `obs-evo-cand-004819-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004819-route-evolution-graph`
