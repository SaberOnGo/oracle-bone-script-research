...
- External category reference: `evobc-cat-09930`
- Source category ID: `09930`
- Source label for human review: `鞶`
- Source codepoints: `U+97B6`
...
- `obs-evo-cand-009930-route-category-staging`
...
- `obs-evo-cand-009930-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009930-route-evolution-graph`
