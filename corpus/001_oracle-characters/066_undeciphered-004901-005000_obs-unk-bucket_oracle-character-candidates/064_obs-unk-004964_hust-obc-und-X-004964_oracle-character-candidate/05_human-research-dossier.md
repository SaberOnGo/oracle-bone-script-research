# obs-unk-004964 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/064_obs-unk-004964_h
  ust-obc-und-X-004964_oracle-character-candidate/03_visual-assets/001_asset
  -006557_hust-obc-und-X-004964_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/520/X_？_7501_1.png`
- asset id: `asset-006557`
...
- A short left form and a taller branched right form are visible.
...
- source class: `HUST-OBC/undeciphered/X/520/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/520/X_？_7501_1.png`
- asset id: `asset-006557`
...
- Which source records identify obs-unk-004964 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004964？
