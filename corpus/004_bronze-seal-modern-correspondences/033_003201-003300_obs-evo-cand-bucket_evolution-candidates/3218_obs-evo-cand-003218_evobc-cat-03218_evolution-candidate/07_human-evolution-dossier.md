...
- External category reference: `evobc-cat-03218`
- Source category ID: `03218`
- Source label for human review: `戡`
- Source codepoints: `U+6221`
...
- `obs-evo-cand-003218-route-category-staging`
...
- `obs-evo-cand-003218-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003218-route-evolution-graph`
