# Material Visual Observation / obs-comp-cand-002682 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002682`
- External reference / 外部参照: `obimd-sub-econ137w5q`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021258_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/econ137w5q/econ137w5q/econ137w5q.png`
- Checksum / 校验和:
  `99ede76ef7fbc803c7db8f21600a645725226f81d24456f6eb6d9b2e1da79efc`
...
- Marked-pixel bounds: (82,19)–(166,230); span 85 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.24%。
- 痕迹范围：(82,19)–(166,230)；跨度85 × 212 px；痕迹矩形高于宽。
