# obs-unk-008015 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008015`
- primary external id: `hust-obc-und-YH-008015`
...
- local review image route: `corpus/001_oracle-characters/097_undeciphered-008
  001-008100_obs-unk-bucket_oracle-character-candidates/015_obs-unk-008015_h
  ust-obc-und-YH-008015_oracle-character-candidate/03_visual-assets/001_asse
  t-009606_hust-obc-und-YH-008015_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6061F/H_？_6061F_0.png`
- asset id: `asset-009606`
...
- source class: `HUST-OBC/undeciphered/Y+H/6061F/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6061F/H_？_6061F_0.png`
- asset id: `asset-009606`
...
- Which source records identify obs-unk-008015 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008015？
