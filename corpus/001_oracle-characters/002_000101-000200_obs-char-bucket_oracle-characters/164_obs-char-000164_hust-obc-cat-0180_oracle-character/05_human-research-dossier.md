# obs-char-000164 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/164_obs-char-000164_hust-obc-cat-0180_orac
  le-character/03_visual-assets/001_asset-000169_hust-obc-cat-0180_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0180/G_0180_乙1138合10950𠂤賓間.png`
- asset id: `asset-000169`
...
- source category: `0180`
- validation class: `163`
- source image route: `HUST-OBC/deciphered/0180/G_0180_乙1138合10950𠂤賓間.png`
- asset id: `asset-000169`
...
- English observation: `The image is formed by two long narrow strokes
  crossing near the middle, with both ends tapering unevenly.`
...
- dataset label text: `㒪`
- dataset label codepoints: `U+34AA`
...
- filename catalog route clues: `Heji-like filename clue: 合10950
  (G_0180_乙1138合10950𠂤賓間.png)`
...
- Which source records identify obs-char-000164 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000164？
