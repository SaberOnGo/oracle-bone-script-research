...
- External category reference: `evobc-cat-11114`
- Source category ID: `11114`
- Source label: `𡷖`
...
- `obs-evo-cand-011114-route-category-staging`
...
- `obs-evo-cand-011114-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011114-route-evolution-graph`
