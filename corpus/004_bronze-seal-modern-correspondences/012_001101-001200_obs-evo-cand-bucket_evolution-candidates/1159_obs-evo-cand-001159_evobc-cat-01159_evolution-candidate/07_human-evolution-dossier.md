...
- External category reference: `evobc-cat-01159`
- Source category ID: `01159`
- Source label for human review: `凡`
- Source codepoints: `U+51E1`
- Image reference count in source metadata: `134`
...
- `obs-evo-cand-001159-route-category-staging`
...
- `obs-evo-cand-001159-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001159-route-evolution-graph`
