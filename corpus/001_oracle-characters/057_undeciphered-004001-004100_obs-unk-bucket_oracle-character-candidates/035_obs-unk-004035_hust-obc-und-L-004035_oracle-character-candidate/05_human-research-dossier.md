# obs-unk-004035 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004035`
- primary external id: `hust-obc-und-L-004035`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/035_obs-unk-004035_h
  ust-obc-und-L-004035_oracle-character-candidate/03_visual-assets/001_asset
  -005628_hust-obc-und-L-004035_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4035/L_？_862.jpg`
- asset id: `asset-005628`
...
- source class: `HUST-OBC/undeciphered/L/4035/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4035/L_？_862.jpg`
- asset id: `asset-005628`
...
- English observation: A thin branching trace rises on the left, with several
  short marks distributed near the upper right. A longer central trace descends
  toward the lower edge. The crop is small and the marks are separated.
- 中文观察：左侧有细长分叉痕迹，右上附近分布数枚短痕；较长的中央痕迹向下延伸至下缘。
    图像较小，各痕迹之间的关系尚不明确。
...
- Which source records identify obs-unk-004035 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004035？
