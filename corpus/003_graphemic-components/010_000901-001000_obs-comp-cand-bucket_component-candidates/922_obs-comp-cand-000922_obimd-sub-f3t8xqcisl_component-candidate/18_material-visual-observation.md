# Material Visual Observation / obs-comp-cand-000922 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000922`
- External reference / 外部参照: `obimd-sub-f3t8xqcisl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014005_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/x4mvyzj0ob/f3t8xqcisl/f3t8xqcisl.png`
- Checksum / 校验和:
  `152cd4522e8ace265a320942f8a77cae4d1d0a14d9c6bb571757738bd44b93f5`
...
- Marked-pixel bounds: (90,26)–(158,224); span 69 × 199 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.32%。
- 痕迹范围：(90,26)–(158,224)；跨度69 × 199 px；痕迹矩形高于宽。
