...
- External category reference: `evobc-cat-00147`
- Source category ID: `00147`
- Source label: `㪇`
...
- `obs-evo-cand-000147-route-category-staging`
...
- `obs-evo-cand-000147-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-000147-route-evolution-graph`
