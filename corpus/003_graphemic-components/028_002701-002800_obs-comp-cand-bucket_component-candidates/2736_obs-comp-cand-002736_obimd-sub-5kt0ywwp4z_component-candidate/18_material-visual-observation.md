# Material Visual Observation / obs-comp-cand-002736 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002736`
- External reference / 外部参照: `obimd-sub-5kt0ywwp4z`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021352_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5kt0ywwp4z/5kt0ywwp4z/5kt0ywwp4z.png`
- Checksum / 校验和:
  `986a292002984998953b8f1bf7470e7e88b5c7824382414c8109fb93657d8670`
...
- Marked-pixel bounds: (28,46)–(223,211); span 196 × 166 px; the marked
...
- 痕迹范围：(28,46)–(223,211)；跨度196 × 166 px；痕迹矩形近方形。
