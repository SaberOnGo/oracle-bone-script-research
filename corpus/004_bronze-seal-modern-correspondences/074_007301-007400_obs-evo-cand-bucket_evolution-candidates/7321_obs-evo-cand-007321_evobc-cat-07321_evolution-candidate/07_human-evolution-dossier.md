...
Project ID: `obs-evo-cand-007321`
...
- Project ID: `obs-evo-cand-007321`
- EVOBC category candidate ID: `evobc-evo-cat-07321`
- External category reference: `evobc-cat-07321`
- Source category ID: `07321`
- Source label for human review: `茩`
- Source codepoints: `U+8329`
...
- `obs-evo-cand-007321-route-category-staging`
...
- `obs-evo-cand-007321-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007321-route-evolution-graph`
