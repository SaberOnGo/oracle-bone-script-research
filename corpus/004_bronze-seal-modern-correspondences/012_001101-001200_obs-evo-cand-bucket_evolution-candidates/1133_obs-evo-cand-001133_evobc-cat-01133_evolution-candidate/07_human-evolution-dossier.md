...
- Project ID: `obs-evo-cand-001133`
- EVOBC category candidate ID: `evobc-evo-cat-01133`
- External category reference: `evobc-cat-01133`
- Source category ID: `01133`
- Source label for human review: `冥`
- Source codepoints: `U+51A5`
...
- `obs-evo-cand-001133-route-category-staging`
...
- `obs-evo-cand-001133-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001133-route-evolution-graph`
