...
Project ID: `obs-evo-cand-008513`
...
- Project ID: `obs-evo-cand-008513`
- EVOBC category candidate ID: `evobc-evo-cat-08513`
- External category reference: `evobc-cat-08513`
- Source category ID: `08513`
- Source label for human review: `貀`
- Source codepoints: `U+8C80`
...
- `obs-evo-cand-008513-route-category-staging`
...
- `obs-evo-cand-008513-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008513-route-evolution-graph`
