...
- Project ID: `obs-evo-cand-008940`
- EVOBC category candidate ID: `evobc-evo-cat-08940`
- External category reference: `evobc-cat-08940`
- Source category ID: `08940`
- Source label for human review: `过`
- Source codepoints: `U+8FC7`
...
- `obs-evo-cand-008940-route-category-staging`
...
- `obs-evo-cand-008940-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008940-route-evolution-graph`
