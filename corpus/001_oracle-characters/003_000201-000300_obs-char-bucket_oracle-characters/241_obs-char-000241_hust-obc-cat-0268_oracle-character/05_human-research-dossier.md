# obs-char-000241 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/241_obs-char-000241_hust-obc-cat-0268_orac
  le-character/03_visual-assets/001_asset-000246_hust-obc-cat-0268_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0268/G_0268_佚718合26964.png`
- asset id: `asset-000246`
...
- source category: `0268`
- validation class: `240`
- source image route: `HUST-OBC/deciphered/0268/G_0268_佚718合26964.png`
- asset id: `asset-000246`
...
- English observation: `The narrow image has a long upright stroke, a short
  horizontal branch near the middle, and a longer stroke extending toward
  the lower right.`
...
- dataset label text: `㔂`
- dataset label codepoints: `U+3502`
...
- filename catalog route clues: `Heji-like filename clue: 合26964
...
- Which source records identify obs-char-000241 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000241？
