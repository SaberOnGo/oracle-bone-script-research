...
Project ID: `obs-evo-cand-008444`
...
- Project ID: `obs-evo-cand-008444`
- EVOBC category candidate ID: `evobc-evo-cat-08444`
- External category reference: `evobc-cat-08444`
- Source category ID: `08444`
- Source label for human review: `读`
- Source codepoints: `U+8BFB`
...
- `obs-evo-cand-008444-route-category-staging`
...
- `obs-evo-cand-008444-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008444-route-evolution-graph`
