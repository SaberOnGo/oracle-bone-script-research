# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-000856
...
- glyph_codepoint_count: `131`
- glyph_codepoint_uplus_sample: `U+82E5;U+F4D59, U+F4D5A, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-013854` | `001_asset-013854_img.png` | `c011b7d93e142cf6e1cd8b5f52c0401486508f0708a45fead2a7697f637658de` |
