...
- External category reference: `evobc-cat-08950`
- Source category ID: `08950`
- Source label for human review: `还`
- Source codepoints: `U+8FD8`
...
- `obs-evo-cand-008950-route-category-staging`
...
- `obs-evo-cand-008950-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008950-route-evolution-graph`
