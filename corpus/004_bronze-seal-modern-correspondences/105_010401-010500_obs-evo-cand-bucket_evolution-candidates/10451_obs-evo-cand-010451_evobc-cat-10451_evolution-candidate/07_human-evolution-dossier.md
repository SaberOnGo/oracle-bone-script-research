...
- External category reference: `evobc-cat-10451`
- Source category ID: `10451`
- Source label for human review: `鱧`
- Source codepoints: `U+9C67`
...
- `obs-evo-cand-010451-route-category-staging`
...
- `obs-evo-cand-010451-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010451-route-evolution-graph`
