# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002336
...
- EVOBC candidate category: `evobc-evo-cat-02336`.
- Source label for search only: `孝`.
- Source codepoints for search only: `U+5B5D`.
