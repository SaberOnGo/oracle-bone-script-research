# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001409
...
| --- | --- | --- | --- |
| `obimd-glyph-link-021289` | 豆󸄀 | `U+8C46;U+F8100` | `reviewed_metadata_only` |
| `obimd-glyph-link-021290` | 󸄁 | `U+F8101` | `reviewed_metadata_only` |
| `obimd-glyph-link-021291` | 󸄂 | `U+F8102` | `reviewed_metadata_only` |
| `obimd-glyph-link-021292` | 󸄃 | `U+F8103` | `reviewed_metadata_only` |
