# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002875
...
- EVOBC candidate category: `evobc-evo-cat-02875`.
- Source label for search only: `徝`.
- Source codepoints for search only: `U+5F9D`.
