# obs-unk-004087 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/087_obs-unk-004087_h
  ust-obc-und-L-004087_oracle-character-candidate/03_visual-assets/001_asset
  -005680_hust-obc-und-L-004087_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4087/L_？_8776.jpg`
- asset id: `asset-005680`
...
- source class: `HUST-OBC/undeciphered/L/4087/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4087/L_？_8776.jpg`
- asset id: `asset-005680`
...
- English observation: A short upright trace with a small horizontal top mark
  appears above two slanting side traces. The lower marks form an open angular
  outline with a darker central area; the joins are not fully resolved.
- 中文观察：上部有一条短竖向痕迹，顶端带小横痕，下方有两条向两侧斜出的痕迹。下部
  形成开放的折角轮廓，中央较深；各痕迹的连接处尚未完全分辨。
...
- Which source records identify obs-unk-004087 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004087？
