...
- Yingguo / 英国所藏: `y610` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `139` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `509` in source row; primary catalog entry pending
- Heji / 合集: `39513` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000110`
