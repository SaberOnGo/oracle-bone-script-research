# Material Visual Observation / obs-comp-cand-002713 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002713`
- External reference / 外部参照: `obimd-sub-xq3vzel7mw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021289_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xq3vzel7mw/xq3vzel7mw/xq3vzel7mw.png`
- Checksum / 校验和:
  `095891a81d79adab2e1b7069949e42000fc01b2c7ea0d51f7e60dce063d7a123`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.37%.
- Marked-pixel bounds: (96,20)–(155,228); span 60 × 209 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.37%。
- 痕迹范围：(96,20)–(155,228)；跨度60 × 209 px；痕迹矩形高于宽。
