# obs-comp-cand-002617 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002617`
- 首选外部 ID: `obimd-sub-rbfxjlia3f`
- OBIMD subcharacter UID: `rbfxjlia3f`
- OBIMD main character UID: `rbfxjlia3f`
- 来源 ID: `src-obimd`
...
- codepoint 示例: U+FEBF0; U+FEBF1; 另有 16 项
