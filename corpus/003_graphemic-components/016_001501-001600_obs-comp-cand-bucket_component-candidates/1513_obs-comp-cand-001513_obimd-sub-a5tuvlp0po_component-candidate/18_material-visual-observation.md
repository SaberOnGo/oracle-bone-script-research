# Material Visual Observation / obs-comp-cand-001513 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001513`
- External reference / 外部参照: `obimd-sub-a5tuvlp0po`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016476_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/a5tuvlp0po/a5tuvlp0po/a5tuvlp0po.png`
- Checksum / 校验和:
  `466ecca6258b864580f569586d9e3116049d3b65665674427db9213a44ef760c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.27%.
- Marked-pixel bounds: (78,31)–(171,218); span 94 × 188 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.27%。
- 痕迹范围：(78,31)–(171,218)；跨度94 × 188 px；痕迹矩形高于宽。
