# obs-unk-003764 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/054_undeciphered-003
  701-003800_obs-unk-bucket_oracle-character-candidates/064_obs-unk-003764_h
  ust-obc-und-L-003764_oracle-character-candidate/03_visual-assets/001_asset
  -005357_hust-obc-und-L-003764_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3764/L_？_776.jpg`
- asset id: `asset-005357`
...
- source class: `HUST-OBC/undeciphered/L/3764/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3764/L_？_776.jpg`
- asset id: `asset-005357`
...
- Which source records identify obs-unk-003764 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003764？
