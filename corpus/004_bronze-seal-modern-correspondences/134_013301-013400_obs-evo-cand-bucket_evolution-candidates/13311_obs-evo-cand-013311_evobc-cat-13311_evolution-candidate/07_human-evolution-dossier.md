...
Project ID: `obs-evo-cand-013311`
...
- Project ID: `obs-evo-cand-013311`
- EVOBC category candidate ID: `evobc-evo-cat-13311`
- External category reference: `evobc-cat-13311`
- Source category ID: `13311`
- Source label for human review: `𬝕`
- Source codepoints: `U+2C755`
...
- `obs-evo-cand-013311-route-category-staging`
...
- `obs-evo-cand-013311-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013311-route-evolution-graph`
