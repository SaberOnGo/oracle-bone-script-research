# obs-char-000090 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/090_obs-char-000090_hust-obc-cat-0100_orac
  le-character/03_visual-assets/001_asset-000095_hust-obc-cat-0100_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0100/G_0100_乙3387合716賓組.png`
- asset id: `asset-000095`
...
- source category: `0100`
- validation class: `89`
- source image route: `HUST-OBC/deciphered/0100/G_0100_乙3387合716賓組.png`
- asset id: `asset-000095`
...
- English observation: `The image has a broad open rectangular outline with
  two parallel interior horizontal strokes and short outer end strokes.`
- 中文观察: `图像呈宽阔的开放方框轮廓，内部有两道平行横笔，外侧端部有短出笔。`
...
- dataset label text: `㑚`
- dataset label codepoints: `U+345A`
...
- filename catalog route clues: `Heji-like filename clue: 合716
  (G_0100_乙3387合716賓組.png)`
...
- Which source records identify obs-char-000090 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000090？
