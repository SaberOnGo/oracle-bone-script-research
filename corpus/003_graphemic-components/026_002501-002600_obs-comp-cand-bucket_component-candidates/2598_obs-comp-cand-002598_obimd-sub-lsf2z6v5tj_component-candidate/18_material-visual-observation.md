# Material Visual Observation / obs-comp-cand-002598 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002598`
- External reference / 外部参照: `obimd-sub-lsf2z6v5tj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021137_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lsf2z6v5tj/lsf2z6v5tj/lsf2z6v5tj.png`
- Checksum / 校验和:
  `392e2cfdb5bd266050b6480d8a96bd4aecc1f38db1dee4935c7058db9c2119b6`
...
- Marked-pixel bounds: (90,28)–(181,229); span 92 × 202 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.55%。
- 痕迹范围：(90,28)–(181,229)；跨度92 × 202 px；痕迹矩形高于宽。
