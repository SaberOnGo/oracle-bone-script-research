# obs-char-001004 Visual Gallery / obs-char-001004 图像资料页
...
- Project ID / 项目 ID: `obs-char-001004`
- Primary external reference / 首选外部参考: `hust-obc-cat-1128`
...
## obs-char-001004-visual-source-001 / 图像条目

![obs-char-001004 glyph candidate](03_visual-assets/001_asset-001009_hust-obc-cat-1128_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-001009_hust-obc-cat-1128_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-001009_hust-obc-cat-1128_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/1128/G_1128_甲骨文.png`
