# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013029
...
- EVOBC candidate category: `evobc-evo-cat-13029`.
- Source label for search only: `𫧌`.
- Source codepoints for search only: `U+2B9CC`.
