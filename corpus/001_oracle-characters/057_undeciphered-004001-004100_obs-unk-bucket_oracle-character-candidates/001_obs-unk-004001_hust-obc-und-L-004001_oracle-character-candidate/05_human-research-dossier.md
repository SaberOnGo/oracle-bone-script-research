# obs-unk-004001 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/001_obs-unk-004001_h
  ust-obc-und-L-004001_oracle-character-candidate/03_visual-assets/001_asset
  -005594_hust-obc-und-L-004001_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4001/L_？_849.jpg`
- asset id: `asset-005594`
...
- source class: `HUST-OBC/undeciphered/L/4001/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4001/L_？_849.jpg`
- asset id: `asset-005594`
...
- English observation: Several narrow curving traces run roughly vertically;
  a darker grouped stroke sits near the center.
- 中文观察：数条窄弯曲痕迹大致纵向排列；中部附近有较深的痕迹簇。
...
- Which source records identify obs-unk-004001 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004001？
