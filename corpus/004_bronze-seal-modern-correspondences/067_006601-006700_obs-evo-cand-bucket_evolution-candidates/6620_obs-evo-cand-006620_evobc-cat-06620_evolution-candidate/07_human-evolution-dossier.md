...
- External category reference: `evobc-cat-06620`
- Source category ID: `06620`
- Source label for human review: `緿`
...
- `obs-evo-cand-006620-route-category-staging`
...
- `obs-evo-cand-006620-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006620-route-evolution-graph`
