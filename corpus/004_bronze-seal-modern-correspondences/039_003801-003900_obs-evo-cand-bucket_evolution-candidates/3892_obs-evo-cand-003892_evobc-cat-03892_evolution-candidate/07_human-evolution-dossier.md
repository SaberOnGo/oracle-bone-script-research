...
- External category reference: `evobc-cat-03892`
- Source category ID: `03892`
- Source label for human review: `杪`
- Source codepoints: `U+676A`
...
- `obs-evo-cand-003892-route-category-staging`
...
- `obs-evo-cand-003892-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003892-route-evolution-graph`
