# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010221
...
- EVOBC candidate category: `evobc-evo-cat-10221`.
- Source label for search only: `騜`.
- Source codepoints for search only: `U+9A1C`.
