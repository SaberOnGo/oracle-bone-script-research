...
- External category reference: `evobc-cat-07794`
- Source category ID: `07794`
- Source label for human review: `蜱`
- Source codepoints: `U+8731`
...
- `obs-evo-cand-007794-route-category-staging`
...
- `obs-evo-cand-007794-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007794-route-evolution-graph`
