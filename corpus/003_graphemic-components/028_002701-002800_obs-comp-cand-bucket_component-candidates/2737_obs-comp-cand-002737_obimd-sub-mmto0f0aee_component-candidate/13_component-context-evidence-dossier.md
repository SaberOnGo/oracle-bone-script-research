# obs-comp-cand-002737 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002737`
- 首选外部 ID: `obimd-sub-mmto0f0aee`
- OBIMD subcharacter UID: `mmto0f0aee`
- OBIMD main character UID: `mmto0f0aee`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `6`
- codepoint 示例: U+FF727; U+FF728; 另有 4 项
