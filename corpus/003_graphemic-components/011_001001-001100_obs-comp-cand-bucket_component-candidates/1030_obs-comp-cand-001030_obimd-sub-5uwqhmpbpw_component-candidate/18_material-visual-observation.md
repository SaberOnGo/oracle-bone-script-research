# Material Visual Observation / obs-comp-cand-001030 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001030`
- External reference / 外部参照: `obimd-sub-5uwqhmpbpw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014523_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5uwqhmpbpw/5uwqhmpbpw/5uwqhmpbpw.png`
- Checksum / 校验和:
  `ed41917ae9eef75740639c400abf79c7d8165295308cbe7a802e6b2997aacfaa`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.50%.
- Marked-pixel bounds: (65,32)–(188,219); span 124 × 188 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.50%。
- 痕迹范围：(65,32)–(188,219)；跨度124 × 188 px；痕迹矩形高于宽。
