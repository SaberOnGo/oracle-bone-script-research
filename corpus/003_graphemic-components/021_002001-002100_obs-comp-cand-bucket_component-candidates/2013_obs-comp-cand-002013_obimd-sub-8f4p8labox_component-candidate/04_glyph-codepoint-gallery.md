# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002013
...
| --- | --- | --- | --- |
| `obimd-glyph-link-031017` | 󻥧 | `U+FB967` | `reviewed_metadata_only` |
| `obimd-glyph-link-031018` | 󻥨 | `U+FB968` | `reviewed_metadata_only` |
| `obimd-glyph-link-031019` | 󻥩 | `U+FB969` | `reviewed_metadata_only` |
| `obimd-glyph-link-031020` | 󻥪 | `U+FB96A` | `reviewed_metadata_only` |
