# Material Visual Observation / obs-comp-cand-000105 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000105`
- External reference / 外部参照: `obimd-sub-sq81wh8r3p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011517_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/sq81wh8r3p/sq81wh8r3p/sq81wh8r3p.png`
- Checksum / 校验和:
  `67555f2c79c47b195067ebff142950bc1b9043511d9c2793cbba70bbc3938377`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.99%.
- Marked-pixel bounds: (68,46)–(181,210); span 114 × 165 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.99%。
- 痕迹范围：(68,46)–(181,210)；跨度114 × 165 px；痕迹矩形高于宽。
