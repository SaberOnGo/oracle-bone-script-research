# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008204
...
- EVOBC candidate category: `evobc-evo-cat-08204`.
- Source label for search only: `詶`.
- Source codepoints for search only: `U+8A76`.
