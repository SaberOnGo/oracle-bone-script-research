# obs-char-000446 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000446`
- primary external id: `hust-obc-cat-0506`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/446_obs-char-000446_hust-obc-cat-0506_orac
  le-character/03_visual-assets/001_asset-000451_hust-obc-cat-0506_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0506/G_0506_林1.21.12合3097賓組.png
  `
- asset id: `asset-000451`
...
- source category: `0506`
- validation class: `445`
- source image route: `HUST-OBC/deciphered/0506/G_0506_林1.21.12合3097賓組.png`
- asset id: `asset-000451`
...
- English observation: `Two narrow upright forms are separated; the left
  stacks a forked top, small box, and curved lower outline, while the right
  is crossed and sinuous.`
- 中文观察: `两个狭长直立形体彼此分离；左侧层叠分叉顶部、小框和弯曲下轮廓，右侧交叉且曲折。`
...
- dataset label text: `㗰`
- dataset label codepoints: `U+35F0`
...
- filename catalog route clues: `Heji-like filename clue: 合3097
  (G_0506_林1.21.12合3097賓組.png)`
...
- Which source records identify obs-char-000446 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000446？
