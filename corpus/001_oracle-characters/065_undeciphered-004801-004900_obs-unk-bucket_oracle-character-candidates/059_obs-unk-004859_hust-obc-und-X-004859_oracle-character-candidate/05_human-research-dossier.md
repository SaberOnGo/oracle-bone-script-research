# obs-unk-004859 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/059_obs-unk-004859_h
  ust-obc-und-X-004859_oracle-character-candidate/03_visual-assets/001_asset
  -006452_hust-obc-und-X-004859_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/415/X_？_7122_1.png`
- asset id: `asset-006452`
...
- source class: `HUST-OBC/undeciphered/X/415/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/415/X_？_7122_1.png`
- asset id: `asset-006452`
...
- English observation: `parallel left strokes and right pale opening`
- 中文观察: `左侧平行曲线和右侧浅色开口`
...
- Which source records identify obs-unk-004859 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004859？
