# obs-char-000725 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000725`
- primary external id: `hust-obc-cat-0823_0824`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/725_obs-char-000725_hust-obc-cat-0823_0824
  _oracle-character/03_visual-assets/001_asset-000730_hust-obc-cat-0823_0824
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0823_0824/0823/G_0823_乙163合2101
  6𠂤組.png`
- asset id: `asset-000730`
...
- source category: `0823_0824`
- validation class: `724`
- source image route: `HUST-OBC/deciphered/0823_0824/0823/G_0823_乙163合21016𠂤組.
  png`
- asset id: `asset-000730`
...
- English observation: `A thick crescent-like vertical stands separately at
  left, beside a rounded rectangular loop containing one short horizontal
  white opening.`
- 中文观察: `左侧独立竖立一条粗重月牙形笔，右侧为圆角矩形环，内含一道短横白色空隙。`
...
- dataset label text: `㜭㜮`
- dataset label codepoints: `U+372D;U+372E`
...
- graph edge count: `2`
- codepoint routes: `U+372D;U+372E`
...
- Which source records identify obs-char-000725 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000725？
