# obs-char-000495 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/495_obs-char-000495_hust-obc-cat-0562_0563
  _0564_oracle-character/03_visual-assets/001_asset-000500_hust-obc-cat-0562
  _0563_0564_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0562_0563_0564/0562/G_0562_京津53
  50合36462.png`
- asset id: `asset-000500`
...
- source category: `0562_0563_0564`
- validation class: `494`
- source image route: `HUST-OBC/deciphered/0562_0563_0564/0562/G_0562_京津5350合3
  6462.png`
- asset id: `asset-000500`
...
- English observation: `The very small image shows a pointed outer outline,
  a compact crossed triangular cluster in the center, and a detached short
  horizontal mark below.`
- 中文观察: `极小图像显示尖顶外轮廓、中央紧凑交叉三角笔画群和下方分离短横。`
...
- dataset label text: `㘨㘩㘪`
- dataset label codepoints: `U+3628;U+3629;U+362A`
...
- filename catalog route clues: `Heji-like filename clue: 合36462
...
- Which source records identify obs-char-000495 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000495？
