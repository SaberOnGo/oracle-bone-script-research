# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003749
...
- EVOBC candidate category: `evobc-evo-cat-03749`.
- Source label for search only: `晟`.
- Source codepoints for search only: `U+665F`.
