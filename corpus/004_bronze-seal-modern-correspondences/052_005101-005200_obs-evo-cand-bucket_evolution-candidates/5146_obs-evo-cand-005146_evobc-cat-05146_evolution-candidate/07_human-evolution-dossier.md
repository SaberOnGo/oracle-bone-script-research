...
Project ID: `obs-evo-cand-005146`
...
- Project ID: `obs-evo-cand-005146`
- EVOBC category candidate ID: `evobc-evo-cat-05146`
- External category reference: `evobc-cat-05146`
- Source category ID: `05146`
- Source label for human review: `燅`
- Source codepoints: `U+71C5`
...
- `obs-evo-cand-005146-route-category-staging`
...
- `obs-evo-cand-005146-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005146-route-evolution-graph`
