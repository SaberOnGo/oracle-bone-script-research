# Material Visual Observation / obs-comp-cand-001649 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001649`
- External reference / 外部参照: `obimd-sub-s6js5wopjo`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017325_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kzmitqixsp/s6js5wopjo/s6js5wopjo.png`
- Checksum / 校验和:
  `daf878d8dff7333d3513992414b8c7b99933caf30aa3505da63bb6404d763338`
...
- Marked-pixel bounds: (71,47)–(178,197); span 108 × 151 px; the marked
...
- 痕迹范围：(71,47)–(178,197)；跨度108 × 151 px；痕迹矩形高于宽。
