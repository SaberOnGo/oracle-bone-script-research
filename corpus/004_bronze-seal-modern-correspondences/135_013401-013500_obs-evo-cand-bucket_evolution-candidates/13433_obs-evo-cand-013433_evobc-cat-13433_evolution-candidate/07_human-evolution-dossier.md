...
- External category reference: `evobc-cat-13433`
- Source category ID: `13433`
- Source label for human review: `𬲋`
- Source codepoints: `U+2CC8B`
...
- `obs-evo-cand-013433-route-category-staging`
...
- `obs-evo-cand-013433-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013433-route-evolution-graph`
