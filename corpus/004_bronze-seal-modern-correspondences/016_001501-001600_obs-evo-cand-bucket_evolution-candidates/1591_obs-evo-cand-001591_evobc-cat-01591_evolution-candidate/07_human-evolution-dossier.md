...
- External category reference: `evobc-cat-01591`
- Source category ID: `01591`
- Source label for human review: `哮`
- Source codepoints: `U+54EE`
...
- `obs-evo-cand-001591-route-category-staging`
...
- `obs-evo-cand-001591-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001591-route-evolution-graph`
