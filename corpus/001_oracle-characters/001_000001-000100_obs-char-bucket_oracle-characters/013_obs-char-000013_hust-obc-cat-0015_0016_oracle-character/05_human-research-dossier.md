# obs-char-000013 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000013`
- primary external id: `hust-obc-cat-0015_0016`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/013_obs-char-000013_hust-obc-cat-0015_0016
  _oracle-character/03_visual-assets/001_asset-000018_hust-obc-cat-0015_0016
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0015_0016/0015/G_0015_乙105(甲).p
  ng`
- asset id: `asset-000018`
...
- source category: `0015_0016`
- validation class: `12`
- source image route: `HUST-OBC/deciphered/0015_0016/0015/G_0015_乙105(甲).png`
- asset id: `asset-000018`
...
- English observation: `The thin upright image has branching strokes at the
  top, a narrow central stem, and a trailing diagonal mark below.`
- 中文观察: `纤细直立图像顶部有分叉笔画，中部为窄长主干，下方有拖出的斜向痕迹。`
...
- dataset label text: `㐅㐆`
- dataset label codepoints: `U+3405;U+3406`
...
- graph edge count: `2`
- codepoint routes: `U+3405;U+3406`
...
- Which source records identify obs-char-000013 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000013？
