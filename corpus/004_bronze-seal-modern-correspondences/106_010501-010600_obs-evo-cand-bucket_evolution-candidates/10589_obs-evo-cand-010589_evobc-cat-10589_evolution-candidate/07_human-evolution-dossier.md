...
- External category reference: `evobc-cat-10589`
- Source category ID: `10589`
- Source label for human review: `鹏`
- Source codepoints: `U+9E4F`
...
- `obs-evo-cand-010589-route-category-staging`
...
- `obs-evo-cand-010589-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010589-route-evolution-graph`
