# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001290
...
| --- | --- | --- | --- |
| `obimd-glyph-link-019346` | 󷘿 | `U+F763F` | `reviewed_metadata_only` |
| `obimd-glyph-link-019347` | 󷙀 | `U+F7640` | `reviewed_metadata_only` |
