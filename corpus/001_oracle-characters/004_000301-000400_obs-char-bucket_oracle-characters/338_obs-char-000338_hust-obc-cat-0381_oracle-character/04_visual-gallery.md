# obs-char-000338 Visual Gallery / obs-char-000338 图像资料页
...
- Project ID / 项目 ID: `obs-char-000338`
- Primary external reference / 首选外部参考: `hust-obc-cat-0381`
...
## obs-char-000338-visual-source-001 / 图像条目

![obs-char-000338 glyph candidate](03_visual-assets/001_asset-000343_hust-obc-cat-0381_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000343_hust-obc-cat-0381_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000343_hust-obc-cat-0381_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/0381/G_0381_甲骨文.png`
