# obs-unk-004596 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/096_obs-unk-004596_h
  ust-obc-und-X-004596_oracle-character-candidate/03_visual-assets/001_asset
  -006189_hust-obc-und-X-004596_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/152/X_？_8329_1.png`
- asset id: `asset-006189`
...
- source class: `HUST-OBC/undeciphered/X/152/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/152/X_？_8329_1.png`
- asset id: `asset-006189`
...
- English observation: `Thick upper-right terminal, left hook, and split`
  `lower traces recorded.`
- 中文观察: `已记录粗重右上末端、左侧钩痕和分开的下部痕迹。`
...
- Which source records identify obs-unk-004596 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004596？
