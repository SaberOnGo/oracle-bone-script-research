# obs-evo-cand-001092 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-001092`
- EVOBC category candidate ID: `evobc-evo-cat-01092`
- External category ref: `evobc-cat-01092`
- Source label: `公`
- Source codepoints: `U+516C`
- Image reference count: `337`
- Era token counts: `BI:86;CS:1;OBC:64;SAC:28;SS:2;WSC:156`
- Source token counts: `Book:113;Web:224`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 64 image references
- era 1 / BI: 86 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 28 image references
- era 4 / WSC: 156 image references
- era 5 / CS: 1 image references
- source 0 / Web:1633: 2 image references
- source 1 / Web:105952;說文Web:58: 182 image references
- source 2 / Book:17600: 8 image references
- source 3 / Book:21681: 34 image references
- source 4 / Book:9131: 28 image references
- source 5 / Book:32794: 39 image references
- source 6 / Web:30645: 40 image references
