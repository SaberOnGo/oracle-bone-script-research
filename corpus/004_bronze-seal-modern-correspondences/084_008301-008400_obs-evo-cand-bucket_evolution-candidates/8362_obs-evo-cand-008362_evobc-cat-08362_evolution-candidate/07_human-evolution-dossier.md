...
- External category reference: `evobc-cat-08362`
- Source category ID: `08362`
- Source label for human review: `譚`
...
- `obs-evo-cand-008362-route-category-staging`
...
- `obs-evo-cand-008362-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008362-route-evolution-graph`
