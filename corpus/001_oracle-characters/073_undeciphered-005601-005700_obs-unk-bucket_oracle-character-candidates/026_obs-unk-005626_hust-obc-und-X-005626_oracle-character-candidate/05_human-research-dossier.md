# obs-unk-005626 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/073_undeciphered-005
  601-005700_obs-unk-bucket_oracle-character-candidates/026_obs-unk-005626_h
  ust-obc-und-X-005626_oracle-character-candidate/03_visual-assets/001_asset
  -007219_hust-obc-und-X-005626_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1182/X_？_8136_1.png`
- asset id: `asset-007219`
...
- source class: `HUST-OBC/undeciphered/X/1182/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1182/X_？_8136_1.png`
- asset id: `asset-007219`
...
- Which source records identify obs-unk-005626 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005626？
