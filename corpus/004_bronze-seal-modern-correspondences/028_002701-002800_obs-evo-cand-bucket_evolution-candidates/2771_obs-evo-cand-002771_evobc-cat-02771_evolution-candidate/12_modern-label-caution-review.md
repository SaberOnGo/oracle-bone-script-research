# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002771
...
- EVOBC candidate category: `evobc-evo-cat-02771`.
- Source label for search only: `廬`.
- Source codepoints for search only: `U+5EEC`.
