# obs-char-000030 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000030`
- primary external id: `hust-obc-cat-0035`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/030_obs-char-000030_hust-obc-cat-0035_orac
  le-character/03_visual-assets/001_asset-000035_hust-obc-cat-0035_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0035/G_0035_乙357合21988子組.png`
- asset id: `asset-000035`
...
- source category: `0035`
- validation class: `29`
- source image route: `HUST-OBC/deciphered/0035/G_0035_乙357合21988子組.png`
- asset id: `asset-000035`
...
- English observation: `The narrow image shows a slightly curved upright
  stroke with two short diagonal branches on its left side.`
...
- dataset label text: `㐙`
- dataset label codepoints: `U+3419`
...
- filename catalog route clues: `Heji-like filename clue: 合21988
  (G_0035_乙357合21988子組.png)`
...
- Which source records identify obs-char-000030 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000030？
