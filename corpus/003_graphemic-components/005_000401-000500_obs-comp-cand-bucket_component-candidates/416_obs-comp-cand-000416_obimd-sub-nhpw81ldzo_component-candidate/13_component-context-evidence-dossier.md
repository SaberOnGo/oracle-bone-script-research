# obs-comp-cand-000416 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000416`
- 首选外部 ID: `obimd-sub-nhpw81ldzo`
- OBIMD subcharacter UID: `nhpw81ldzo`
...
- glyph-codepoint 数: `8`
- codepoint 示例: U+F268C; U+F268D; 另有 6 项
