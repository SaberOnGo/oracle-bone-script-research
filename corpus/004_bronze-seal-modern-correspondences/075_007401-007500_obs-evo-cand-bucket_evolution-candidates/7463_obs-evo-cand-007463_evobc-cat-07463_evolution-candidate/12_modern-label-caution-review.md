# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-007463
...
- EVOBC candidate category: `evobc-evo-cat-07463`.
- Source label for search only: `葌`.
- Source codepoints for search only: `U+844C`.
