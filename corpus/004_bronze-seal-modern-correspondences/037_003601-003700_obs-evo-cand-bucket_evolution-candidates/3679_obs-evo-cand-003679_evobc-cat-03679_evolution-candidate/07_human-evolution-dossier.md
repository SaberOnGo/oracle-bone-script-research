...
- External category reference: `evobc-cat-03679`
- Source category ID: `03679`
- Source label for human review: `旟`
- Source codepoints: `U+65DF`
...
- `obs-evo-cand-003679-route-category-staging`
...
- `obs-evo-cand-003679-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003679-route-evolution-graph`
