...
Project ID: `obs-evo-cand-006262`
...
- Project ID: `obs-evo-cand-006262`
- EVOBC category candidate ID: `evobc-evo-cat-06262`
- External category reference: `evobc-cat-06262`
- Source category ID: `06262`
- Source label for human review: `筒`
- Source codepoints: `U+7B52`
...
- `obs-evo-cand-006262-route-category-staging`
...
- `obs-evo-cand-006262-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006262-route-evolution-graph`
