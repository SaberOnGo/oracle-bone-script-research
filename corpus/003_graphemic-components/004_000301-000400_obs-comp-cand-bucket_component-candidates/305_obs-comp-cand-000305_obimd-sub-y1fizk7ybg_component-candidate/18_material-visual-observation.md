# Material Visual Observation / obs-comp-cand-000305 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000305`
- External reference / 外部参照: `obimd-sub-y1fizk7ybg`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012167_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/y1fizk7ybg/y1fizk7ybg/y1fizk7ybg.png`
- Checksum / 校验和:
  `8706c7f5fef4d814cc70865b56b70850419dfb3d70270d61079e1b65e70ffaba`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.88%.
- Marked-pixel bounds: (66,29)–(183,224); span 118 × 196 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.88%。
- 痕迹范围：(66,29)–(183,224)；跨度118 × 196 px；痕迹矩形高于宽。
