...
- External category reference: `evobc-cat-05805`
- Source category ID: `05805`
- Source label for human review: `眩`
...
- `obs-evo-cand-005805-route-category-staging`
...
- `obs-evo-cand-005805-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005805-route-evolution-graph`
