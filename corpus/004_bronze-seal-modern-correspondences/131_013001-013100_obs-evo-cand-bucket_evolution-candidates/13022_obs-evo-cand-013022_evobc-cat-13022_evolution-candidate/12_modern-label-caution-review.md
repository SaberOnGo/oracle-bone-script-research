# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013022
...
- EVOBC candidate category: `evobc-evo-cat-13022`.
- Source label for search only: `𫦮`.
- Source codepoints for search only: `U+2B9AE`.
