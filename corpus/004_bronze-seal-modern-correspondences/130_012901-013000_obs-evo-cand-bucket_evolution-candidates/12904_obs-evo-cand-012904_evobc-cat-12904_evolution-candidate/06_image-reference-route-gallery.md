...
- `obs-evo-cand-012904-route-category-staging`
...
- `obs-evo-cand-012904-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012904-route-evolution-graph`
