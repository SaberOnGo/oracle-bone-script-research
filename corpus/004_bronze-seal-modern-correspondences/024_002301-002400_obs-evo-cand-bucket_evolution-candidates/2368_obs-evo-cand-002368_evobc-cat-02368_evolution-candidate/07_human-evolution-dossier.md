...
- Project ID: `obs-evo-cand-002368`
- EVOBC category candidate ID: `evobc-evo-cat-02368`
- External category reference: `evobc-cat-02368`
- Source category ID: `02368`
- Source label for human review: `宐`
- Source codepoints: `U+5B90`
...
- `obs-evo-cand-002368-route-category-staging`
...
- `obs-evo-cand-002368-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002368-route-evolution-graph`
