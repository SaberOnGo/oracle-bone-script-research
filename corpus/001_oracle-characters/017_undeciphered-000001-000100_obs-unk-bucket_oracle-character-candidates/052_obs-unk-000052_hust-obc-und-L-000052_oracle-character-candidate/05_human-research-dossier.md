# obs-unk-000052 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000052`
- primary external id: `hust-obc-und-L-000052`
...
- local review image route: `corpus/001_oracle-characters/017_undeciphered-000
  001-000100_obs-unk-bucket_oracle-character-candidates/052_obs-unk-000052_h
  ust-obc-und-L-000052_oracle-character-candidate/03_visual-assets/001_asset
  -001645_hust-obc-und-L-000052_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/52/L_？_10156.jpg`
- asset id: `asset-001645`
...
- source class: `HUST-OBC/undeciphered/L/52/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/52/L_？_10156.jpg`
- asset id: `asset-001645`
...
- Which source records identify obs-unk-000052 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000052？
