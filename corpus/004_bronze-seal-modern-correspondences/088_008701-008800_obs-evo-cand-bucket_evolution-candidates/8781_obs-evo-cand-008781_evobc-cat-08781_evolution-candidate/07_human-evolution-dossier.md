...
Project ID: `obs-evo-cand-008781`
...
- Project ID: `obs-evo-cand-008781`
- EVOBC category candidate ID: `evobc-evo-cat-08781`
- External category reference: `evobc-cat-08781`
- Source category ID: `08781`
- Source label for human review: `躖`
- Source codepoints: `U+8E96`
...
- `obs-evo-cand-008781-route-category-staging`
...
- `obs-evo-cand-008781-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008781-route-evolution-graph`
