# Human Collection Object Dossier / 馆藏对象研究档案: coll-obj-cand-00036
...
- project_id: `coll-obj-cand-00036`
- candidate_collection_object_id: `ihp-mus-obj-00036`
- source_collection_item_id: `506`
...
| `source_collection_item_id` | `506` |
| `object_title_en` | `Inscribed Plastron Ping 0538` |
| `catalog_reference_text` | `Ping 0538` |
| `object_page_url` | `https://museum.sinica.edu.tw/en/collection/32/item/506/` |
| `thumbnail_url` | `https://museum.sinica.edu.tw/_upload/image/collection_item/thumbnail/15959e86fbe02d72.jpg` |
...
- live source page, private hashes, and pixel observations:
...
- live page evidence remains source-reported and rights-limited; see
  `18_live-source-evidence-review.md`.
