# Material Visual Observation / obs-comp-cand-002380 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002380`
- External reference / 外部参照: `obimd-sub-u7vprt88m4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020451_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3lxxctblxe/u7vprt88m4/u7vprt88m4.png`
- Checksum / 校验和:
  `ef6b0d4cc318e548033e78a4351c2417f86af47c28b11a1df2af44a0fd3702de`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.66%.
- Marked-pixel bounds: (88,30)–(161,215); span 74 × 186 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.66%。
- 痕迹范围：(88,30)–(161,215)；跨度74 × 186 px；痕迹矩形高于宽。
