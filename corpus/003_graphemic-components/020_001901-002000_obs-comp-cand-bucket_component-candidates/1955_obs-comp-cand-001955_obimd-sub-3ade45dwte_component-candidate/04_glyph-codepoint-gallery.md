# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001955
...
| --- | --- | --- | --- |
| `obimd-glyph-link-029621` | 󻊪 | `U+FB2AA` | `reviewed_metadata_only` |
| `obimd-glyph-link-029622` | 󻊫 | `U+FB2AB` | `reviewed_metadata_only` |
