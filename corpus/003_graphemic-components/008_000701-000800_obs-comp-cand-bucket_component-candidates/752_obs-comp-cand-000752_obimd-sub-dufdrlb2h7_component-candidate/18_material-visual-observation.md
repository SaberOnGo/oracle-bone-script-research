# Material Visual Observation / obs-comp-cand-000752 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000752`
- External reference / 外部参照: `obimd-sub-dufdrlb2h7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013517_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h81pl2i5a6/dufdrlb2h7/dufdrlb2h7.png`
- Checksum / 校验和:
  `2237dbeb09ffd351ca1cced9aa8cac20c4ad47ea581cdcfdab3c506a750a819e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.92%.
- Marked-pixel bounds: (93,21)–(156,229); span 64 × 209 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.92%。
- 痕迹范围：(93,21)–(156,229)；跨度64 × 209 px；痕迹矩形高于宽。
