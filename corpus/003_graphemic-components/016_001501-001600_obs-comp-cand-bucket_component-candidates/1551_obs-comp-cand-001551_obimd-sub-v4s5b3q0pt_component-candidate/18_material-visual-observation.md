# Material Visual Observation / obs-comp-cand-001551 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001551`
- External reference / 外部参照: `obimd-sub-v4s5b3q0pt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016965_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6hyn7a9bnx/v4s5b3q0pt/v4s5b3q0pt.png`
- Checksum / 校验和:
  `f9163052355d63836049e4b6494efb99fa4c105b5d2f4f14ea4274c47a92b0cf`
...
- Marked-pixel bounds: (62,47)–(187,206); span 126 × 160 px; the marked
...
- 痕迹范围：(62,47)–(187,206)；跨度126 × 160 px；痕迹矩形高于宽。
