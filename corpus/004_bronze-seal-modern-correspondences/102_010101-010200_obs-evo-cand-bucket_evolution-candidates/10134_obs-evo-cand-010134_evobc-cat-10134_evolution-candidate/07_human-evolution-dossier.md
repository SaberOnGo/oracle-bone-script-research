...
- External category reference: `evobc-cat-10134`
- Source category ID: `10134`
- Source label for human review: `饑`
- Source codepoints: `U+9951`
...
- `obs-evo-cand-010134-route-category-staging`
...
- `obs-evo-cand-010134-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010134-route-evolution-graph`
