...
- External category reference: `evobc-cat-05573`
- Source category ID: `05573`
- Source label for human review: `畟`
- Source codepoints: `U+755F`
...
- `obs-evo-cand-005573-route-category-staging`
...
- `obs-evo-cand-005573-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005573-route-evolution-graph`
