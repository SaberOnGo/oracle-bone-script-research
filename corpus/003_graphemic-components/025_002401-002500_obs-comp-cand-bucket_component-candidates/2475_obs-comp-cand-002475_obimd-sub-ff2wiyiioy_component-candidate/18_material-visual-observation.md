# Material Visual Observation / obs-comp-cand-002475 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002475`
- External reference / 外部参照: `obimd-sub-ff2wiyiioy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020660_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/v7qghw0r67/ff2wiyiioy/ff2wiyiioy.png`
- Checksum / 校验和:
  `917f7fee0e01227dbdb8ccc7a9f7f04f20b937df7ece596ca6b6ac4a75ae8a74`
...
- Marked-pixel bounds: (84,36)–(165,220); span 82 × 185 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.25%。
- 痕迹范围：(84,36)–(165,220)；跨度82 × 185 px；痕迹矩形高于宽。
