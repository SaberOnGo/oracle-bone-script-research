...
- External category reference: `evobc-cat-04878`
- Source category ID: `04878`
- Source label for human review: `漬`
- Source codepoints: `U+6F2C`
...
- `obs-evo-cand-004878-route-category-staging`
...
- `obs-evo-cand-004878-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004878-route-evolution-graph`
