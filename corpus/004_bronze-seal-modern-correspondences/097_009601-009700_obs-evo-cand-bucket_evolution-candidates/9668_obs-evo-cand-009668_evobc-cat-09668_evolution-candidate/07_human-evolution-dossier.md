...
Project ID: `obs-evo-cand-009668`
...
- Project ID: `obs-evo-cand-009668`
- EVOBC category candidate ID: `evobc-evo-cat-09668`
- External category reference: `evobc-cat-09668`
- Source category ID: `09668`
- Source label for human review: `闣`
- Source codepoints: `U+95E3`
...
- `obs-evo-cand-009668-route-category-staging`
...
- `obs-evo-cand-009668-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009668-route-evolution-graph`
