# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006104
...
- EVOBC candidate category: `evobc-evo-cat-06104`.
- Source label for search only: `稟`.
- Source codepoints for search only: `U+7A1F`.
