# obs-unk-006712 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/084_undeciphered-006
  701-006800_obs-unk-bucket_oracle-character-candidates/012_obs-unk-006712_h
  ust-obc-und-X-006712_oracle-character-candidate/03_visual-assets/001_asset
  -008303_hust-obc-und-X-006712_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2268/X_？_910_1.png`
- asset id: `asset-008303`
...
- source class: `HUST-OBC/undeciphered/X/2268/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2268/X_？_910_1.png`
- asset id: `asset-008303`
...
- Which source records identify obs-unk-006712 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006712？
