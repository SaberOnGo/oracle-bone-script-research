...
- External category reference: `evobc-cat-08225`
- Source category ID: `08225`
- Source label for human review: `誑`
- Source codepoints: `U+8A91`
...
- `obs-evo-cand-008225-route-category-staging`
...
- `obs-evo-cand-008225-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008225-route-evolution-graph`
