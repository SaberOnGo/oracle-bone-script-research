# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006569
...
- EVOBC candidate category: `evobc-evo-cat-06569`.
- Source label for search only: `綾`.
- Source codepoints for search only: `U+7DBE`.
