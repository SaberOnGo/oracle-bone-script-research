# obs-comp-cand-000404 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000404`
- 首选外部 ID: `obimd-sub-no8hgfw0su`
- OBIMD subcharacter UID: `no8hgfw0su`
- OBIMD main character UID: `no8hgfw0su`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+C22B2;U+F2595; U+F2596; 另有 1 项
