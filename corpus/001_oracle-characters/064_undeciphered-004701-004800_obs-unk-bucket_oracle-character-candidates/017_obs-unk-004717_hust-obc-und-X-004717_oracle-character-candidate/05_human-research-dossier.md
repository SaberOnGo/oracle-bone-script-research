# obs-unk-004717 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/017_obs-unk-004717_h
  ust-obc-und-X-004717_oracle-character-candidate/03_visual-assets/001_asset
  -006310_hust-obc-und-X-004717_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/273/X_？_7246_1.png`
- asset id: `asset-006310`
...
- source class: `HUST-OBC/undeciphered/X/273/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/273/X_？_7246_1.png`
- asset id: `asset-006310`
...
- English observation: `rectangular upper enclosure with lower split strokes`
- 中文观察: `带下部开叉笔画的矩形上部围合结构`
...
- Which source records identify obs-unk-004717 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004717？
