...
- External category reference: `evobc-cat-09279`
- Source category ID: `09279`
- Source label for human review: `醪`
...
- `obs-evo-cand-009279-route-category-staging`
...
- `obs-evo-cand-009279-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009279-route-evolution-graph`
