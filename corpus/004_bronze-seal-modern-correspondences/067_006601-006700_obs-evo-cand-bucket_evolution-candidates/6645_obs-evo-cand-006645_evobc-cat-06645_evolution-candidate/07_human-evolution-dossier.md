...
- External category reference: `evobc-cat-06645`
- Source category ID: `06645`
- Source label for human review: `縭`
- Source codepoints: `U+7E2D`
...
- `obs-evo-cand-006645-route-category-staging`
...
- `obs-evo-cand-006645-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006645-route-evolution-graph`
