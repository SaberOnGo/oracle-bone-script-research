# Material Visual Observation / obs-comp-cand-000245 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000245`
- External reference / 外部参照: `obimd-sub-49lxhylgu1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011891_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/49lxhylgu1/49lxhylgu1/49lxhylgu1.png`
- Checksum / 校验和:
  `2a3d7694dbeae2c6fc66a9a8c76baf552337dad297bfa84b632a0a45aed1780c`
...
- Marked-pixel bounds: (66,28)–(183,221); span 118 × 194 px; the marked
...
- 痕迹范围：(66,28)–(183,221)；跨度118 × 194 px；痕迹矩形高于宽。
