...
- External category reference: `evobc-cat-00875`
- Source category ID: `00875`
- Source label for human review: `俅`
- Source codepoints: `U+4FC5`
...
- `obs-evo-cand-000875-route-category-staging`
...
- `obs-evo-cand-000875-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000875-route-evolution-graph`
