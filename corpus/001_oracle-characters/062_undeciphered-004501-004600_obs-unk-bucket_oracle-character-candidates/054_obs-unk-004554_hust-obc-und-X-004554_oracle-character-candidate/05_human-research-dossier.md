# obs-unk-004554 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004554`
- primary external id: `hust-obc-und-X-004554`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/054_obs-unk-004554_h
  ust-obc-und-X-004554_oracle-character-candidate/03_visual-assets/001_asset
  -006147_hust-obc-und-X-004554_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/110/X_？_8292_1.png`
- asset id: `asset-006147`
...
- source class: `HUST-OBC/undeciphered/X/110/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/110/X_？_8292_1.png`
- asset id: `asset-006147`
...
- English observation: `Upper trace, central junction, and lower base recorded.`
- 中文观察: `已记录上部痕迹、中央连接处和下部底边。`
...
- Which source records identify obs-unk-004554 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004554？
