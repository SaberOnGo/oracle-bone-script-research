# obs-char-000027 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000027`
- primary external id: `hust-obc-cat-0032`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/027_obs-char-000027_hust-obc-cat-0032_orac
  le-character/03_visual-assets/001_asset-000032_hust-obc-cat-0032_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0032/L_0032_10560.jpg`
- asset id: `asset-000032`
...
- source category: `0032`
- validation class: `26`
- source image route: `HUST-OBC/deciphered/0032/L_0032_10560.jpg`
- asset id: `asset-000032`
...
- English observation: `The small dark image shows paired upright strokes,
  several short interior marks, and a narrow rectangular lower base.`
- 中文观察: `小型深色图像可见成对竖向笔画、数处内部短痕和窄长方形底部。`
...
- dataset label text: `㐖`
- dataset label codepoints: `U+3416`
...
- Which source records identify obs-char-000027 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000027？
