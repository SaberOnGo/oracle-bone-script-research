# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-011744
...
- EVOBC candidate category: `evobc-evo-cat-11744`.
- Source label for search only: `𤽺`.
- Source codepoints for search only: `U+24F7A`.
