# Material Visual Observation / obs-comp-cand-000869 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000869`
- External reference / 外部参照: `obimd-sub-os0bklwwmx`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013866_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/os0bklwwmx/os0bklwwmx/os0bklwwmx.png`
- Checksum / 校验和:
  `5bcf69f58ba039be282cf29a7c7d5ac49944aebf3cb4fbf7efce3dabe17faf38`
...
- Marked-pixel bounds: (58,44)–(198,208); span 141 × 165 px; the marked
...
- 痕迹范围：(58,44)–(198,208)；跨度141 × 165 px；痕迹矩形近方形。
