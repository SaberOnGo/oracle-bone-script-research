...
Project ID: `obs-evo-cand-011401`
...
- Project ID: `obs-evo-cand-011401`
- EVOBC category candidate ID: `evobc-evo-cat-11401`
- External category reference: `evobc-cat-11401`
- Source category ID: `11401`
- Source label for human review: `𣆖`
- Source codepoints: `U+23196`
...
- `obs-evo-cand-011401-route-category-staging`
...
- `obs-evo-cand-011401-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011401-route-evolution-graph`
