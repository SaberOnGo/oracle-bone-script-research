...
- External category reference: `evobc-cat-04099`
- Source category ID: `04099`
- Source label for human review: `棟`
...
- `obs-evo-cand-004099-route-category-staging`
...
- `obs-evo-cand-004099-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004099-route-evolution-graph`
