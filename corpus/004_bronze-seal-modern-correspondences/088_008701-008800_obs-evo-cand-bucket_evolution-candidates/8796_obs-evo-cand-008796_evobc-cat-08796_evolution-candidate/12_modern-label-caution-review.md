# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008796
...
- EVOBC candidate category: `evobc-evo-cat-08796`.
- Source label for search only: `軎`.
- Source codepoints for search only: `U+8ECE`.
