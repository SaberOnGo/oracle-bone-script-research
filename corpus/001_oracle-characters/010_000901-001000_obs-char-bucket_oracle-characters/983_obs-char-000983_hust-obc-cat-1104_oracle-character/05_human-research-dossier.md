# obs-char-000983 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000983`
- primary external id: `hust-obc-cat-1104`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/983_obs-char-000983_hust-obc-cat-1104_orac
  le-character/03_visual-assets/001_asset-000988_hust-obc-cat-1104_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1104/X_1104_614_1.png`
- asset id: `asset-000988`
...
- source category: `1104`
- validation class: `982`
- source image route: `HUST-OBC/deciphered/1104/X_1104_614_1.png`
- asset id: `asset-000988`
...
- English observation: `A tall central stem has angled upper and side
  branches, a lower enclosed loop, and a pointed terminal.`
- 中文观察: `高长中央笔干有上部和侧部斜向分枝、下部闭合环以及尖形末端。`
...
- dataset label text: `㡆`
- dataset label codepoints: `U+3846`
...
- Which source records identify obs-char-000983 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000983？
