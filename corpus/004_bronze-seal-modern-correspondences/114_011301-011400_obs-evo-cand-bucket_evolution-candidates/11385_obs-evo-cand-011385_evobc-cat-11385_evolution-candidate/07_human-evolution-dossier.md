...
- External category reference: `evobc-cat-11385`
- Source category ID: `11385`
- Source label for human review: `𣃹`
...
- `obs-evo-cand-011385-route-category-staging`
...
- `obs-evo-cand-011385-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011385-route-evolution-graph`
