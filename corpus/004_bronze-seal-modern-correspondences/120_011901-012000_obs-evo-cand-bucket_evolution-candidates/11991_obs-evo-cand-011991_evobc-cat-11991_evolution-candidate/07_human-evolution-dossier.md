...
- External category reference: `evobc-cat-11991`
- Source category ID: `11991`
- Source label for human review: `𦊁`
...
- `obs-evo-cand-011991-route-category-staging`
...
- `obs-evo-cand-011991-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011991-route-evolution-graph`
