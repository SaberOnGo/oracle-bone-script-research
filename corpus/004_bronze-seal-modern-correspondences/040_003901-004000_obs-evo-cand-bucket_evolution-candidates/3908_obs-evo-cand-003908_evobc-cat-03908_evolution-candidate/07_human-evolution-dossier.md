...
Project ID: `obs-evo-cand-003908`
...
- Project ID: `obs-evo-cand-003908`
- EVOBC category candidate ID: `evobc-evo-cat-03908`
- External category reference: `evobc-cat-03908`
- Source category ID: `03908`
- Source label for human review: `板`
- Source codepoints: `U+677F`
...
- `obs-evo-cand-003908-route-category-staging`
...
- `obs-evo-cand-003908-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003908-route-evolution-graph`
