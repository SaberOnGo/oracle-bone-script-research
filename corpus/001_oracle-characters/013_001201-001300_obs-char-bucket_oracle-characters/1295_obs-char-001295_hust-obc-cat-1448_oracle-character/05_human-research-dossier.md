# obs-char-001295 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001295`
- primary external id: `hust-obc-cat-1448`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1295_obs-char-001295_hust-obc-cat-1448_ora
  cle-character/03_visual-assets/001_asset-001300_hust-obc-cat-1448_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1448/L_1448_10827.jpg`
- asset id: `asset-001300`
...
- source category: `1448`
- validation class: `1294`
- source image route: `HUST-OBC/deciphered/1448/L_1448_10827.jpg`
- asset id: `asset-001300`
...
- English observation: `A small low-contrast cluster combines several
  upright curves, a short lower baseline, and indistinct edges.`
- 中文观察: `小型低对比度笔画群结合数条直立弧笔和短下部基线，边缘辨识度有限。`
...
- dataset label text: `㦞`
- dataset label codepoints: `U+399E`
...
- Which source records identify obs-char-001295 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001295？
