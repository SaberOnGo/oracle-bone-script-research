...
Project ID: `obs-evo-cand-006264`
...
- Project ID: `obs-evo-cand-006264`
- EVOBC category candidate ID: `evobc-evo-cat-06264`
- External category reference: `evobc-cat-06264`
- Source category ID: `06264`
- Source label for human review: `答`
- Source codepoints: `U+7B54`
...
- `obs-evo-cand-006264-route-category-staging`
...
- `obs-evo-cand-006264-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006264-route-evolution-graph`
