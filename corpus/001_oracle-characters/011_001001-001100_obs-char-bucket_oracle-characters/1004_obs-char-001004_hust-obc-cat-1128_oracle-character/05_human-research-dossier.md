# obs-char-001004 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001004`
- primary external id: `hust-obc-cat-1128`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1004_obs-char-001004_hust-obc-cat-1128_ora
  cle-character/03_visual-assets/001_asset-001009_hust-obc-cat-1128_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1128/G_1128_甲骨文.png`
- asset id: `asset-001009`
...
- source category: `1128`
- validation class: `1003`
- source image route: `HUST-OBC/deciphered/1128/G_1128_甲骨文.png`
- asset id: `asset-001009`
...
- English observation: `A slim curved enclosure has a short upper-left
  projection, a long right upright, and two short lower strokes.`
- 中文观察: `狭长弯曲闭合轮廓有左上短外伸笔、右侧长直立笔和两条下部短笔。`
...
- dataset label text: `㡞`
- dataset label codepoints: `U+385E`
...
- Which source records identify obs-char-001004 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001004？
