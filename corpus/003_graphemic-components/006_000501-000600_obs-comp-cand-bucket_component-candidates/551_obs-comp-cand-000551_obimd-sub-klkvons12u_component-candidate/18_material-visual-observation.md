# Material Visual Observation / obs-comp-cand-000551 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000551`
- External reference / 外部参照: `obimd-sub-klkvons12u`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012784_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rgq9fk24zd/klkvons12u/klkvons12u.png`
- Checksum / 校验和:
  `7e8439c7adce90f16977a6e558bfb90a38073d815cd3a3c1a5c5bd7c2ff48b7f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.04%.
- Marked-pixel bounds: (63,54)–(186,187); span 124 × 134 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.04%。
- 痕迹范围：(63,54)–(186,187)；跨度124 × 134 px；痕迹矩形近方形。
