# Material Visual Observation / obs-comp-cand-000053 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000053`
- External reference / 外部参照: `obimd-sub-tv3occt3a7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011449_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/pkibwuo4bv/tv3occt3a7/1v1pbhpn8j.png`
- Checksum / 校验和:
  `768dd591d80d1b9f9a4eca4df017bfa2c784803d56c8e48501f33993aefc611c`
...
- Marked-pixel bounds: (60,47)–(189,194); span 130 × 148 px; the marked
...
- 痕迹范围：(60,47)–(189,194)；跨度130 × 148 px；痕迹矩形近方形。
