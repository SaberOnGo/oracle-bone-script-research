...
- External category reference: `evobc-cat-09678`
- Source category ID: `09678`
- Source label for human review: `闷`
- Source codepoints: `U+95F7`
...
- `obs-evo-cand-009678-route-category-staging`
...
- `obs-evo-cand-009678-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009678-route-evolution-graph`
