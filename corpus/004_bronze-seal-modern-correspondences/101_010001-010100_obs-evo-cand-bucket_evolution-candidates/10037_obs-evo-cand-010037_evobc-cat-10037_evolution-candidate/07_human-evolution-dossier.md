...
- External category reference: `evobc-cat-10037`
- Source category ID: `10037`
- Source label for human review: `顯`
- Source codepoints: `U+986F`
- Image reference count in source metadata: `173`
...
- `obs-evo-cand-010037-route-category-staging`
...
- `obs-evo-cand-010037-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010037-route-evolution-graph`
