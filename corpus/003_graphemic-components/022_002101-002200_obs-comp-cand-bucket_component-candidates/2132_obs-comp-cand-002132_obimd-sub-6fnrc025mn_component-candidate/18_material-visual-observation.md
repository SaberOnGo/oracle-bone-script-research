# Material Visual Observation / obs-comp-cand-002132 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002132`
- External reference / 外部参照: `obimd-sub-6fnrc025mn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019689_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6fnrc025mn/6fnrc025mn/6fnrc025mn.png`
- Checksum / 校验和:
  `aea20d214b38042a90adb8fbb5cdaac609db4126b36c47c45021504ff44af24b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.77%.
- Marked-pixel bounds: (95,19)–(171,234); span 77 × 216 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.77%。
- 痕迹范围：(95,19)–(171,234)；跨度77 × 216 px；痕迹矩形高于宽。
