# Collection Provenance Evidence Dossier / 馆藏来源证据档案: coll-obj-cand-00039
...
The live source page and image evidence are recorded in
...
| source_row_id | `39` |
| object_page_url | `https://museum.sinica.edu.tw/en/collection/32/item/770/` |
...
| asset_id | `` |
| asset_path | `` |
| thumbnail_url | `https://museum.sinica.edu.tw/_upload/image/collection_item/thumbnail/8985f48895902dc4.jpg` |
| source_image_url | `` |
...
| `source_collection_item_id` | `770` |
| `object_title_en` | `Inscribed Plastron Colored with Cinnabar I 0778` |
| `catalog_reference_text` | `I 0778` |
| `accession_number` | `` |
| `historical_period` | `` |
| `object_date` | `` |
| `provenience` | `` |
