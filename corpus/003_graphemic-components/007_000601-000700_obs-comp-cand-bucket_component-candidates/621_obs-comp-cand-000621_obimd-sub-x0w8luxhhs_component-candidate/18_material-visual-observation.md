# Material Visual Observation / obs-comp-cand-000621 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000621`
- External reference / 外部参照: `obimd-sub-x0w8luxhhs`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013184_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/x0w8luxhhs/x0w8luxhhs/x0w8luxhhs.png`
- Checksum / 校验和:
  `3fd636491eb0e255dc5c8e0467c566eaea8c2c450041e4786cbd6383a7c4a25c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.95%.
- Marked-pixel bounds: (83,18)–(171,231); span 89 × 214 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.95%。
- 痕迹范围：(83,18)–(171,231)；跨度89 × 214 px；痕迹矩形高于宽。
