# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001937
...
| --- | --- | --- | --- |
| `obimd-glyph-link-029433` | 󺸅 | `U+FAE05` | `reviewed_metadata_only` |
| `obimd-glyph-link-029434` | 󻆃 | `U+FB183` | `reviewed_metadata_only` |
| `obimd-glyph-link-029435` | 󻆄 | `U+FB184` | `reviewed_metadata_only` |
