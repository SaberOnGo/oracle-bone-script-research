...
- Yingguo / 英国所藏: `y2465` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `591` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `379` in source row; primary catalog entry pending
- Heji / 合集: `41638` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000506`
