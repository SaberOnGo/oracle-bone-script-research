...
- External category reference: `evobc-cat-13382`
- Source category ID: `13382`
- Source label for human review: `𬪋`
- Source codepoints: `U+2CA8B`
...
- `obs-evo-cand-013382-route-category-staging`
...
- `obs-evo-cand-013382-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013382-route-evolution-graph`
