...
Project ID: `obs-evo-cand-003373`
...
- Project ID: `obs-evo-cand-003373`
- EVOBC category candidate ID: `evobc-evo-cat-03373`
- External category reference: `evobc-cat-03373`
- Source category ID: `03373`
- Source label for human review: `捚`
- Source codepoints: `U+635A`
...
- `obs-evo-cand-003373-route-category-staging`
...
- `obs-evo-cand-003373-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003373-route-evolution-graph`
