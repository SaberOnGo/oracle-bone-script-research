...
- Source page section: `Period IV Group 10` /
  `第 IV 期第 10 组`
- Source section key: `period-iv-group-10`
...
- Yingguo / 英国所藏: `y2432` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `336` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `184` in source row; primary catalog entry pending
- Heji / 合集: `41560` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000497`
