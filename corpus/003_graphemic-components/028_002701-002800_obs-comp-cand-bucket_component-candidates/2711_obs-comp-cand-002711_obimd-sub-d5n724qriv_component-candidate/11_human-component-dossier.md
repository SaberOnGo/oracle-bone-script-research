# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-002711
...
- candidate_component_id: `obs-comp-cand-002711`
- primary_external_ref_id: `obimd-sub-d5n724qriv`
- source_subcharacter_uid: `d5n724qriv`
- source_main_character_uid: `d5n724qriv`
- main_character_external_ref_id: `obimd-main-d5n724qriv`
...
- glyph_codepoint_uplus_sample: `U+FF4B5, U+FF4B6, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-021287` | `001_asset-021287_img.png` | `80c033ba78140357f170201c4cd88f49cc71bbd3aefa622a466b5729def12a07` |
