# obs-char-000337 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/337_obs-char-000337_hust-obc-cat-0380_orac
  le-character/03_visual-assets/001_asset-000342_hust-obc-cat-0380_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0380/G_0380_京津2453合695賓組.png`
- asset id: `asset-000342`
...
- source category: `0380`
- validation class: `336`
- source image route: `HUST-OBC/deciphered/0380/G_0380_京津2453合695賓組.png`
- asset id: `asset-000342`
...
- English observation: `The broad rounded outer contour contains several
  dark internal rounded marks and an irregular lower crossing area.`
- 中文观察: `宽大的圆弧外轮廓内部有数个深色圆弧痕迹，下部有不规则交叉区域。`
...
- dataset label text: `㕲`
- dataset label codepoints: `U+3572`
...
- filename catalog route clues: `Heji-like filename clue: 合695
...
- Which source records identify obs-char-000337 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000337？
