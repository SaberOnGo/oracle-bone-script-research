# Material Visual Observation / obs-comp-cand-001612 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001612`
- External reference / 外部参照: `obimd-sub-ivi5wk8quf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017288_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/yo5h3qdl2s/ivi5wk8quf/ivi5wk8quf.png`
- Checksum / 校验和:
  `a77d1c5fc6179644711f43e60209c4ef0e313b7a30541f8e31c4cf74bc2674da`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.69%.
- Marked-pixel bounds: (87,18)–(163,231); span 77 × 214 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.69%。
- 痕迹范围：(87,18)–(163,231)；跨度77 × 214 px；痕迹矩形高于宽。
