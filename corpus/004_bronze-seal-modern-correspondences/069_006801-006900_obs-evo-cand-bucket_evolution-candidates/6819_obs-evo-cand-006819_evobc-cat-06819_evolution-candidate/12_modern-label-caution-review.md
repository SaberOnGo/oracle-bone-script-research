# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006819
...
- EVOBC candidate category: `evobc-evo-cat-06819`.
- Source label for search only: `罯`.
- Source codepoints for search only: `U+7F6F`.
