...
- External category reference: `evobc-cat-02699`
- Source category ID: `02699`
- Source label for human review: `幸`
...
- `obs-evo-cand-002699-route-category-staging`
...
- `obs-evo-cand-002699-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002699-route-evolution-graph`
