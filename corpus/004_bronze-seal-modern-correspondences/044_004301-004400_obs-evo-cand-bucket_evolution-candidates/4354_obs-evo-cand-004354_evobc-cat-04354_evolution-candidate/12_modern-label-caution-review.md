# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004354
...
- Project ID: `obs-evo-cand-004354`.
- EVOBC candidate category: `evobc-evo-cat-04354`.
- Source label for search only: `欺`.
- Source codepoints for search only: `U+6B3A`.
