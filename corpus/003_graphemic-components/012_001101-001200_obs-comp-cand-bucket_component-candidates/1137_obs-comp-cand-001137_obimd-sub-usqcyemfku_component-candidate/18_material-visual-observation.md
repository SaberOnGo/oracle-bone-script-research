# Material Visual Observation / obs-comp-cand-001137 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001137`
- External reference / 外部参照: `obimd-sub-usqcyemfku`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015091_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/usqcyemfku/usqcyemfku/usqcyemfku.png`
- Checksum / 校验和:
  `7a24f6bbdf8fe3d5f2b4ac7742d5b814581e078b36422b1e64007407cb8dd223`
...
- Marked-pixel bounds: (86,19)–(175,230); span 90 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.66%。
- 痕迹范围：(86,19)–(175,230)；跨度90 × 212 px；痕迹矩形高于宽。
