...
- External category reference: `evobc-cat-10824`
- Source category ID: `10824`
- Source label for human review: `𠐦`
- Source codepoints: `U+20426`
...
- `obs-evo-cand-010824-route-category-staging`
...
- `obs-evo-cand-010824-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010824-route-evolution-graph`
