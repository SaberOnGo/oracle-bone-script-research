...
- Project ID: `obs-evo-cand-010919`
- EVOBC category candidate ID: `evobc-evo-cat-10919`
- External category reference: `evobc-cat-10919`
- Source category ID: `10919`
- Source label for human review: `𠬟`
- Source codepoints: `U+20B1F`
...
- `obs-evo-cand-010919-route-category-staging`
...
- `obs-evo-cand-010919-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010919-route-evolution-graph`
