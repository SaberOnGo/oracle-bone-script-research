# Material Visual Observation / obs-comp-cand-002203 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002203`
- External reference / 外部参照: `obimd-sub-55qv0winah`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019909_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/55qv0winah/55qv0winah/1f25c3nuym.png`
- Checksum / 校验和:
  `77154f112d0d2ecf532ae50720076360b420cd708f703a8a491fb45c95a7ed70`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.32%.
- Marked-pixel bounds: (94,40)–(155,202); span 62 × 163 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.32%。
- 痕迹范围：(94,40)–(155,202)；跨度62 × 163 px；痕迹矩形高于宽。
