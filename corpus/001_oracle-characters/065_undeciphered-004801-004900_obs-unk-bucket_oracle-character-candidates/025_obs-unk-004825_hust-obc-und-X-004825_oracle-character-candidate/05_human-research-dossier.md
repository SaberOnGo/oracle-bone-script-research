# obs-unk-004825 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/025_obs-unk-004825_h
  ust-obc-und-X-004825_oracle-character-candidate/03_visual-assets/001_asset
  -006418_hust-obc-und-X-004825_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/381/X_？_7365_1.png`
- asset id: `asset-006418`
...
- source class: `HUST-OBC/undeciphered/X/381/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/381/X_？_7365_1.png`
- asset id: `asset-006418`
...
- English observation: `paired side openings and lower U-shaped outline`
- 中文观察: `两侧成对开口和下部 U 形围合`
...
- Which source records identify obs-unk-004825 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004825？
