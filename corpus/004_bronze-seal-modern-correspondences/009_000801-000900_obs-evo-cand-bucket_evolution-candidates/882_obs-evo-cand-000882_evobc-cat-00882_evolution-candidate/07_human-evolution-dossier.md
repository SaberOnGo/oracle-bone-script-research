...
Project ID: `obs-evo-cand-000882`
...
- Project ID: `obs-evo-cand-000882`
- EVOBC category candidate ID: `evobc-evo-cat-00882`
- External category reference: `evobc-cat-00882`
- Source category ID: `00882`
- Source label for human review: `俍`
- Source codepoints: `U+4FCD`
...
- `obs-evo-cand-000882-route-category-staging`
...
- `obs-evo-cand-000882-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000882-route-evolution-graph`
