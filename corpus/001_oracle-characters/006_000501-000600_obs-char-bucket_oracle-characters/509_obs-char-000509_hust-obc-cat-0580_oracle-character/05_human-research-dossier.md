# obs-char-000509 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000509`
- primary external id: `hust-obc-cat-0580`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/509_obs-char-000509_hust-obc-cat-0580_orac
  le-character/03_visual-assets/001_asset-000514_hust-obc-cat-0580_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0580/G_0580_佚326合23339出組.png`
- asset id: `asset-000514`
...
- source category: `0580`
- validation class: `508`
- source image route: `HUST-OBC/deciphered/0580/G_0580_佚326合23339出組.png`
- asset id: `asset-000514`
...
- English observation: `A very narrow form has a small upper crossing and a
  long diagonal-to-curved stroke descending below it; fine boundaries are
  difficult to resolve.`
- 中文观察: `极狭长形体上部有小型交叉，下方延伸一条由斜转弯的长笔，细部边界难以辨清。`
...
- dataset label text: `㘺`
- dataset label codepoints: `U+363A`
...
- filename catalog route clues: `Heji-like filename clue: 合23339
  (G_0580_佚326合23339出組.png)`
...
- Which source records identify obs-char-000509 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000509？
