...
- External category reference: `evobc-cat-13083`
- Source category ID: `13083`
- Source label for human review: `𫲱`
- Source codepoints: `U+2BCB1`
- Image reference count in source metadata: `4`
...
- `obs-evo-cand-013083-route-category-staging`
...
- `obs-evo-cand-013083-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013083-route-evolution-graph`
