# obs-char-000863 Visual Gallery / obs-char-000863 图像资料页
...
- Primary external reference / 首选外部参考: `hust-obc-cat-0973`
...
## obs-char-000863-visual-source-001 / 图像条目

![obs-char-000863 glyph candidate](03_visual-assets/001_asset-000868_hust-obc-cat-0973_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000868_hust-obc-cat-0973_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000868_hust-obc-cat-0973_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/0973/G_0973_前2.16.2(甲).png`
