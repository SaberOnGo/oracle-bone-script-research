# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002340
...
| Glyph or codepoint route / 字形或码位路线 | 20 OBIMD route rows; examples U+5DF1;U+FD671; U+FD672; 另有 18 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 20 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
