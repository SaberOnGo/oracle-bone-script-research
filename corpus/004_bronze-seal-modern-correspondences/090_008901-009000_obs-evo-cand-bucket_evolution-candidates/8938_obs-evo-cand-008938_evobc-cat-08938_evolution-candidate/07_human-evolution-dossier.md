...
Project ID: `obs-evo-cand-008938`
...
- Project ID: `obs-evo-cand-008938`
- EVOBC category candidate ID: `evobc-evo-cat-08938`
- External category reference: `evobc-cat-08938`
- Source category ID: `08938`
- Source label for human review: `迅`
- Source codepoints: `U+8FC5`
...
- `obs-evo-cand-008938-route-category-staging`
...
- `obs-evo-cand-008938-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008938-route-evolution-graph`
