...
- `obs-evo-cand-004596-route-category-staging`
...
- `obs-evo-cand-004596-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004596-route-evolution-graph`
