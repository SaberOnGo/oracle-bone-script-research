...
- Project ID: `obs-evo-cand-011860`
- EVOBC category candidate ID: `evobc-evo-cat-11860`
- External category reference: `evobc-cat-11860`
- Source category ID: `11860`
- Source label for human review: `𥩶`
- Source codepoints: `U+25A76`
...
- `obs-evo-cand-011860-route-category-staging`
...
- `obs-evo-cand-011860-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011860-route-evolution-graph`
