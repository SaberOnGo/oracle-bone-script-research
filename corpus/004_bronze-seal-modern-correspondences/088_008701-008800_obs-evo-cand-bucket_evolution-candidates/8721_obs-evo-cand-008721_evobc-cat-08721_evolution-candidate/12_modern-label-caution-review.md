# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008721
...
- EVOBC candidate category: `evobc-evo-cat-08721`.
- Source label for search only: `路`.
- Source codepoints for search only: `U+8DEF`.
