...
- `obs-evo-cand-013281-route-category-staging`
...
- `obs-evo-cand-013281-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013281-route-evolution-graph`
