# Material Visual Observation / obs-comp-cand-001181 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001181`
- External reference / 外部参照: `obimd-sub-4vpgmxwaa2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015371_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4vpgmxwaa2/4vpgmxwaa2/4vpgmxwaa2.png`
- Checksum / 校验和:
  `4063968d58533f7ec0c08ab79f6f611914633f07b935e16feeb1c8ac0493c022`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.06%.
- Marked-pixel bounds: (96,31)–(153,226); span 58 × 196 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.06%。
- 痕迹范围：(96,31)–(153,226)；跨度58 × 196 px；痕迹矩形高于宽。
