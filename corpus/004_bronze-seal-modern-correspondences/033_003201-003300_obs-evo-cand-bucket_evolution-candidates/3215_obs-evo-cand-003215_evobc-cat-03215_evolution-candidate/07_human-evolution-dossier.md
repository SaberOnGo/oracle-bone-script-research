...
Project ID: `obs-evo-cand-003215`
...
- Project ID: `obs-evo-cand-003215`
- EVOBC category candidate ID: `evobc-evo-cat-03215`
- External category reference: `evobc-cat-03215`
- Source category ID: `03215`
- Source label for human review: `戜`
- Source codepoints: `U+621C`
...
- `obs-evo-cand-003215-route-category-staging`
...
- `obs-evo-cand-003215-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003215-route-evolution-graph`
