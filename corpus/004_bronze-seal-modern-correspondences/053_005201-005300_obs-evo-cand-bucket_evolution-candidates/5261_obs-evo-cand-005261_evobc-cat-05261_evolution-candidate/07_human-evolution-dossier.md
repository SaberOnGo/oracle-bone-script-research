...
- External category reference: `evobc-cat-05261`
- Source category ID: `05261`
- Source label for human review: `狊`
- Source codepoints: `U+72CA`
...
- `obs-evo-cand-005261-route-category-staging`
...
- `obs-evo-cand-005261-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005261-route-evolution-graph`
