...
Project ID: `obs-evo-cand-001392`
...
- Project ID: `obs-evo-cand-001392`
- EVOBC category candidate ID: `evobc-evo-cat-01392`
- External category reference: `evobc-cat-01392`
- Source category ID: `01392`
- Source label for human review: `卩`
- Source codepoints: `U+5369`
...
- `obs-evo-cand-001392-route-category-staging`
...
- `obs-evo-cand-001392-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001392-route-evolution-graph`
