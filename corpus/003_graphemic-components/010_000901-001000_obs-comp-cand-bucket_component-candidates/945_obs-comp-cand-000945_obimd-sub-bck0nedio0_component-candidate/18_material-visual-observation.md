# Material Visual Observation / obs-comp-cand-000945 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000945`
- External reference / 外部参照: `obimd-sub-bck0nedio0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014028_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bck0nedio0/bck0nedio0/bck0nedio0.png`
- Checksum / 校验和:
  `e01695cdd2c51feebeb8ac27f9c0c11ec23841c54c2a973ee4505220ab951c4f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.39%.
- Marked-pixel bounds: (80,17)–(154,238); span 75 × 222 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.39%。
- 痕迹范围：(80,17)–(154,238)；跨度75 × 222 px；痕迹矩形高于宽。
