# obs-char-000242 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000242`
- primary external id: `hust-obc-cat-0269`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/242_obs-char-000242_hust-obc-cat-0269_orac
  le-character/03_visual-assets/001_asset-000247_hust-obc-cat-0269_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0269/G_0269_乙2684反合9013反賓組.png`
- asset id: `asset-000247`
...
- source category: `0269`
- validation class: `241`
- source image route: `HUST-OBC/deciphered/0269/G_0269_乙2684反合9013反賓組.png`
- asset id: `asset-000247`
...
- English observation: `The thin upright image has a pointed upper turn, a
  short cross stroke, and a narrow descending tail below the crossing.`
- 中文观察: `纤细直立图像上方有尖转笔，中部有短交叉笔，交叉处下方有窄长下行尾笔。`
...
- dataset label text: `㔃`
- dataset label codepoints: `U+3503`
...
- filename catalog route clues: `Heji-like filename clue: 合9013
  (G_0269_乙2684反合9013反賓組.png)`
...
- Which source records identify obs-char-000242 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000242？
