# obs-comp-cand-000229 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000229`
- 首选外部 ID: `obimd-sub-aqf754j3rb`
- OBIMD subcharacter UID: `aqf754j3rb`
- OBIMD main character UID: `aqf754j3rb`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+9B31;U+F1576; U+F1577; 另有 1 项
