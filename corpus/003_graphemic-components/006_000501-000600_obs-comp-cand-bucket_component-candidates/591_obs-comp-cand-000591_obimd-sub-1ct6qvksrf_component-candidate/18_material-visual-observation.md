# Material Visual Observation / obs-comp-cand-000591 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000591`
- External reference / 外部参照: `obimd-sub-1ct6qvksrf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013119_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1ct6qvksrf/1ct6qvksrf/1ct6qvksrf.png`
- Checksum / 校验和:
  `38f44859c1965d1836601a2a5f01206a01a7f04f93a8e3809a0acb7fc7ee00a8`
...
- Marked-pixel bounds: (73,28)–(176,222); span 104 × 195 px; the marked
...
- 痕迹范围：(73,28)–(176,222)；跨度104 × 195 px；痕迹矩形高于宽。
