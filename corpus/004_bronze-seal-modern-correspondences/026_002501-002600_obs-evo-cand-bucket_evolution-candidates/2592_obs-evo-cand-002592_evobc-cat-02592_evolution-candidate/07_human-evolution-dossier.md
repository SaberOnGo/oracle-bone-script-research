...
Project ID: `obs-evo-cand-002592`
...
- Project ID: `obs-evo-cand-002592`
- EVOBC category candidate ID: `evobc-evo-cat-02592`
- External category reference: `evobc-cat-02592`
- Source category ID: `02592`
- Source label for human review: `嶘`
- Source codepoints: `U+5D98`
...
- `obs-evo-cand-002592-route-category-staging`
...
- `obs-evo-cand-002592-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002592-route-evolution-graph`
