...
Project ID: `obs-evo-cand-000247`
...
- Project ID: `obs-evo-cand-000247`
- EVOBC category candidate ID: `evobc-evo-cat-00247`
- External category reference: `evobc-cat-00247`
- Source category ID: `00247`
- Source label for human review: `㽙`
- Source codepoints: `U+3F59`
...
- `obs-evo-cand-000247-route-category-staging`
...
- `obs-evo-cand-000247-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000247-route-evolution-graph`
