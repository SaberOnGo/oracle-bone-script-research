# obs-unk-004094 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/094_obs-unk-004094_h
  ust-obc-und-L-004094_oracle-character-candidate/03_visual-assets/001_asset
  -005687_hust-obc-und-L-004094_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4094/L_？_8802.jpg`
- asset id: `asset-005687`
...
- source class: `HUST-OBC/undeciphered/L/4094/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4094/L_？_8802.jpg`
- asset id: `asset-005687`
...
- English observation: A broad rounded lower outline supports several upright
  traces. At least two upper traces fork into short angled tips; the lower
  outline is darker and its joins with the upper marks are not fully clear.
- 中文观察：图像下部有一个较宽的弧形轮廓，上方连接数条竖向痕迹。
...
- Which source records identify obs-unk-004094 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004094？
