...
- External category reference: `evobc-cat-01801`
- Source category ID: `01801`
- Source label for human review: `圼`
...
- `obs-evo-cand-001801-route-category-staging`
...
- `obs-evo-cand-001801-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001801-route-evolution-graph`
