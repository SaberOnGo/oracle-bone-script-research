# Material Visual Observation / obs-comp-cand-000617 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000617`
- External reference / 外部参照: `obimd-sub-b2onzh8y22`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013180_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zapprwvtx9/b2onzh8y22/b2onzh8y22.png`
- Checksum / 校验和:
  `d4764982fef338ff0d887c9087d30b38ef14afe4ef41396e9f8ff72d8dcef702`
...
- Marked-pixel bounds: (86,20)–(178,229); span 93 × 210 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.67%。
- 痕迹范围：(86,20)–(178,229)；跨度93 × 210 px；痕迹矩形高于宽。
