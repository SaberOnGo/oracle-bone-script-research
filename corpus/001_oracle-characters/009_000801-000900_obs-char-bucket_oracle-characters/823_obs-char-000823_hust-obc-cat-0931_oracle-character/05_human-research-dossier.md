# obs-char-000823 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000823`
- primary external id: `hust-obc-cat-0931`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/823_obs-char-000823_hust-obc-cat-0931_orac
  le-character/03_visual-assets/001_asset-000828_hust-obc-cat-0931_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0931/H_0931_60705_0.png`
- asset id: `asset-000828`
...
- source category: `0931`
- validation class: `822`
- source image route: `HUST-OBC/deciphered/0931/H_0931_60705_0.png`
- asset id: `asset-000828`
...
- English observation: `Two broad curving outer strokes flank a separate
  central angular mark; the lower ends taper, with gaps between the parts.`
...
- dataset label text: `㞙`
- dataset label codepoints: `U+3799`
...
- filename catalog route clues: `catalog-like filename clue: H_0931
  (H_0931_60705_0.png)`
...
- Which source records identify obs-char-000823 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000823？
