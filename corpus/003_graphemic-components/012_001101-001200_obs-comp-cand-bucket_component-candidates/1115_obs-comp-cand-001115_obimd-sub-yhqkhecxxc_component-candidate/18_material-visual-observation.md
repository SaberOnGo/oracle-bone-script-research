# Material Visual Observation / obs-comp-cand-001115 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001115`
- External reference / 外部参照: `obimd-sub-yhqkhecxxc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015056_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/yhqkhecxxc/yhqkhecxxc/yhqkhecxxc.png`
- Checksum / 校验和:
  `f19b47b0c291914217e38f9990c27d02e88c47fb9eab2b1887ee76ee5ff35d1a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.63%.
- Marked-pixel bounds: (77,32)–(171,203); span 95 × 172 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.63%。
- 痕迹范围：(77,32)–(171,203)；跨度95 × 172 px；痕迹矩形高于宽。
