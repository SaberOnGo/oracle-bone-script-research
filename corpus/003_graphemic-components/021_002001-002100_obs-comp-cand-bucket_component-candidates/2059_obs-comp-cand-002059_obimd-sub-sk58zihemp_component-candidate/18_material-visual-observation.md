# Material Visual Observation / obs-comp-cand-002059 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002059`
- External reference / 外部参照: `obimd-sub-sk58zihemp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019446_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ls6kprxw1j/sk58zihemp/sk58zihemp.png`
- Checksum / 校验和:
  `c85bc25ee7075fe456081fefb2f5294683b9b4642adbc3b493f377c57ca5bbe5`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.29%.
- Marked-pixel bounds: (92,19)–(170,229); span 79 × 211 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.29%。
- 痕迹范围：(92,19)–(170,229)；跨度79 × 211 px；痕迹矩形高于宽。
