...
Project ID: `obs-evo-cand-003579`
...
- Project ID: `obs-evo-cand-003579`
- EVOBC category candidate ID: `evobc-evo-cat-03579`
- External category reference: `evobc-cat-03579`
- Source category ID: `03579`
- Source label for human review: `敏`
- Source codepoints: `U+654F`
...
- `obs-evo-cand-003579-route-category-staging`
...
- `obs-evo-cand-003579-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003579-route-evolution-graph`
