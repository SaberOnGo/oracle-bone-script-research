# obs-char-000201 Visual Gallery / obs-char-000201 图像资料页
...
- Project ID / 项目 ID: `obs-char-000201`
- Primary external reference / 首选外部参考: `hust-obc-cat-0224`
...
## obs-char-000201-visual-source-001 / 图像条目

![obs-char-000201 glyph candidate](03_visual-assets/001_asset-000206_hust-obc-cat-0224_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000206_hust-obc-cat-0224_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000206_hust-obc-cat-0224_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/0224/G_0224_甲骨文0.png`
