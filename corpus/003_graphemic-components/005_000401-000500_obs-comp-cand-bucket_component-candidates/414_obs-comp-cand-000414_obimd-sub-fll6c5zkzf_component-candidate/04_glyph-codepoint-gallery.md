# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000414
...
| --- | --- | --- | --- |
| `obimd-glyph-link-006018` | 󲙮 | `U+F266E` | `reviewed_metadata_only` |
| `obimd-glyph-link-006019` | 󲙯 | `U+F266F` | `reviewed_metadata_only` |
