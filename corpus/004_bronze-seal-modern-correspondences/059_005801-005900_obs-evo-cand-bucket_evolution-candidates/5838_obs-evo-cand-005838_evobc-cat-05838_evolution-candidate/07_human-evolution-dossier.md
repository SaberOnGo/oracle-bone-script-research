...
- External category reference: `evobc-cat-05838`
- Source category ID: `05838`
...
- `obs-evo-cand-005838-route-category-staging`
...
- `obs-evo-cand-005838-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005838-route-evolution-graph`
