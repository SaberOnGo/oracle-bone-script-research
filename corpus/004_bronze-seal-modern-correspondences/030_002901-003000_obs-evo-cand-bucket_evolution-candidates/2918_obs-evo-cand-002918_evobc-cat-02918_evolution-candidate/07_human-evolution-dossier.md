...
- External category reference: `evobc-cat-02918`
- Source category ID: `02918`
- Source label for human review: `忮`
- Source codepoints: `U+5FEE`
...
- `obs-evo-cand-002918-route-category-staging`
...
- `obs-evo-cand-002918-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002918-route-evolution-graph`
