...
- External category reference: `evobc-cat-11065`
- Source category ID: `11065`
- Source label for human review: `𡧔`
- Source codepoints: `U+219D4`
...
- `obs-evo-cand-011065-route-category-staging`
...
- `obs-evo-cand-011065-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011065-route-evolution-graph`
