...
- `obs-evo-cand-011499-route-category-staging`
...
- `obs-evo-cand-011499-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011499-route-evolution-graph`
