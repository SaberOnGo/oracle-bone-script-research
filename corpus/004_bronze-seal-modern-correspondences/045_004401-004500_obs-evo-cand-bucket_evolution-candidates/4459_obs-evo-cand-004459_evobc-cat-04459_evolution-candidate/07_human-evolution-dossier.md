...
Project ID: `obs-evo-cand-004459`
...
- Project ID: `obs-evo-cand-004459`
- EVOBC category candidate ID: `evobc-evo-cat-04459`
- External category reference: `evobc-cat-04459`
- Source category ID: `04459`
- Source label for human review: `毬`
- Source codepoints: `U+6BEC`
...
- `obs-evo-cand-004459-route-category-staging`
...
- `obs-evo-cand-004459-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004459-route-evolution-graph`
