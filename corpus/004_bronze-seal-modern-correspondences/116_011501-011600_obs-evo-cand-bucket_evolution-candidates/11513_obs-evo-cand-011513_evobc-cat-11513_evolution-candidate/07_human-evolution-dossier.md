...
- External category reference: `evobc-cat-11513`
- Source category ID: `11513`
- Source label for human review: `𣲫`
- Source codepoints: `U+23CAB`
...
- `obs-evo-cand-011513-route-category-staging`
...
- `obs-evo-cand-011513-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011513-route-evolution-graph`
