...
Project ID: `obs-evo-cand-005913`
...
- Project ID: `obs-evo-cand-005913`
- EVOBC category candidate ID: `evobc-evo-cat-05913`
- External category reference: `evobc-cat-05913`
- Source category ID: `05913`
- Source label for human review: `确`
- Source codepoints: `U+786E`
...
- `obs-evo-cand-005913-route-category-staging`
...
- `obs-evo-cand-005913-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005913-route-evolution-graph`
