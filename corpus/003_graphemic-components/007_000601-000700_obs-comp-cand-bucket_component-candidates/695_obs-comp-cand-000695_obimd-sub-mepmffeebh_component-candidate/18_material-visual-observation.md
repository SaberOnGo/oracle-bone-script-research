# Material Visual Observation / obs-comp-cand-000695 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000695`
- External reference / 外部参照: `obimd-sub-mepmffeebh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013294_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/mepmffeebh/mepmffeebh/mepmffeebh.png`
- Checksum / 校验和:
  `f4ec8fd86159ca962982de5346c9885b4270270030662629f49689296abb1f67`
...
- Marked-pixel bounds: (82,26)–(167,225); span 86 × 200 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.05%。
- 痕迹范围：(82,26)–(167,225)；跨度86 × 200 px；痕迹矩形高于宽。
