...
- External category reference: `evobc-cat-00214`
- Source category ID: `00214`
- Source label for human review: `㴲`
- Source codepoints: `U+3D32`
...
- `obs-evo-cand-000214-route-category-staging`
...
- `obs-evo-cand-000214-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000214-route-evolution-graph`
