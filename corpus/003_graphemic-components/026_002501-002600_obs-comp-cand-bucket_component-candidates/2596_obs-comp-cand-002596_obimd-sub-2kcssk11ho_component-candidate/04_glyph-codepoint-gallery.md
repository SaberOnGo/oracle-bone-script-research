# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002596
...
| --- | --- | --- | --- |
| `obimd-glyph-link-039519` | 󾬞 | `U+FEB1E` | `reviewed_metadata_only` |
| `obimd-glyph-link-039520` | 󾬟 | `U+FEB1F` | `reviewed_metadata_only` |
| `obimd-glyph-link-039521` | 󾬠 | `U+FEB20` | `reviewed_metadata_only` |
| `obimd-glyph-link-039522` | 󾬡 | `U+FEB21` | `reviewed_metadata_only` |
