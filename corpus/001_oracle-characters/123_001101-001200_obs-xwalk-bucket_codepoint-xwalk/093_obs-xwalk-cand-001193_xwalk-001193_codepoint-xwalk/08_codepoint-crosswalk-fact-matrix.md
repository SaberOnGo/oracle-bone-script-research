# obs-xwalk-cand-001193 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+392C` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-1334` | not reading |
