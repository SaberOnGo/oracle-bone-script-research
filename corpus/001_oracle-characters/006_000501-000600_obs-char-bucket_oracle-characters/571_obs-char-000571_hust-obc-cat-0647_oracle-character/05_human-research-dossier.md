# obs-char-000571 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000571`
- primary external id: `hust-obc-cat-0647`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/571_obs-char-000571_hust-obc-cat-0647_orac
  le-character/03_visual-assets/001_asset-000576_hust-obc-cat-0647_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0647/G_0647_乙2672合13840.png`
- asset id: `asset-000576`
...
- source category: `0647`
- validation class: `570`
- source image route: `HUST-OBC/deciphered/0647/G_0647_乙2672合13840.png`
- asset id: `asset-000576`
...
- English observation: `Two long vertical strokes and several horizontal
  bars form a compact uneven grid, with multiple ends extending beyond the
  central intersections.`
- 中文观察: `两条长竖笔与数条横栏组成紧凑不齐的网格，多处笔端伸出中央交点之外。`
...
- dataset label text: `㙽`
- dataset label codepoints: `U+367D`
...
- filename catalog route clues: `Heji-like filename clue: 合13840
  (G_0647_乙2672合13840.png)`
...
- Which source records identify obs-char-000571 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000571？
