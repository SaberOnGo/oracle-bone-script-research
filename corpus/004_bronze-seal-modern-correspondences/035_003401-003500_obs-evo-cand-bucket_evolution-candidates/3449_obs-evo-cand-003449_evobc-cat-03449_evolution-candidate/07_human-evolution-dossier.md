...
- External category reference: `evobc-cat-03449`
- Source category ID: `03449`
- Source label for human review: `搑`
- Source codepoints: `U+6411`
...
- `obs-evo-cand-003449-route-category-staging`
...
- `obs-evo-cand-003449-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003449-route-evolution-graph`
