...
- External category reference: `evobc-cat-03764`
- Source category ID: `03764`
- Source label for human review: `智`
- Source codepoints: `U+667A`
- Image reference count in source metadata: `297`
...
- `obs-evo-cand-003764-route-category-staging`
...
- `obs-evo-cand-003764-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003764-route-evolution-graph`
