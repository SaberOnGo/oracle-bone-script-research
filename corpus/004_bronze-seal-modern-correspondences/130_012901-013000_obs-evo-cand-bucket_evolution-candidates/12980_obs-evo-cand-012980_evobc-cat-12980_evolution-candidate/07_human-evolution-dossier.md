...
- External category reference: `evobc-cat-12980`
- Source category ID: `12980`
- Source label: `𫛓`
...
- `obs-evo-cand-012980-route-category-staging`
...
- `obs-evo-cand-012980-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012980-route-evolution-graph`
