# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008192
...
- EVOBC candidate category: `evobc-evo-cat-08192`.
- Source label for search only: `詨`.
- Source codepoints for search only: `U+8A68`.
