...
- Project ID: `obs-evo-cand-000061`
- EVOBC category candidate ID: `evobc-evo-cat-00061`
- External category reference: `evobc-cat-00061`
- Source category ID: `00061`
- Source label for human review: `㜬`
- Source codepoints: `U+372C`
...
- `obs-evo-cand-000061-route-category-staging`
...
- `obs-evo-cand-000061-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000061-route-evolution-graph`
