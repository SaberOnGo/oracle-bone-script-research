# Material Visual Observation / obs-comp-cand-001888 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001888`
- External reference / 外部参照: `obimd-sub-xclyxu4uku`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018267_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xclyxu4uku/xclyxu4uku/xclyxu4uku.png`
- Checksum / 校验和:
  `c5b0eb2370afbe9ec2e114146716dbf33762f215db811cffa28379e5989d0315`
...
- Marked-pixel bounds: (71,17)–(179,228); span 109 × 212 px; the marked
...
- 痕迹范围：(71,17)–(179,228)；跨度109 × 212 px；痕迹矩形高于宽。
