# Material Visual Observation / obs-comp-cand-001406 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001406`
- External reference / 外部参照: `obimd-sub-514idmuclv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015825_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/v34viqk9rx/514idmuclv/514idmuclv.png`
- Checksum / 校验和:
  `f22b83a038ade9c567736cdba929545d65950285f0a34a337d087b10506634d1`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.60%.
- Marked-pixel bounds: (61,28)–(195,222); span 135 × 195 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.60%。
- 痕迹范围：(61,28)–(195,222)；跨度135 × 195 px；痕迹矩形高于宽。
