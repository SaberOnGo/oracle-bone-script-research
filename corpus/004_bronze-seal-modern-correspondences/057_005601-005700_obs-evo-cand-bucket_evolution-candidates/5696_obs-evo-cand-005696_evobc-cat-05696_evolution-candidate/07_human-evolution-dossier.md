...
- Project ID: `obs-evo-cand-005696`
- EVOBC category candidate ID: `evobc-evo-cat-05696`
- External category reference: `evobc-cat-05696`
- Source category ID: `05696`
- Source label for human review: `癑`
- Source codepoints: `U+7651`
...
- `obs-evo-cand-005696-route-category-staging`
...
- `obs-evo-cand-005696-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005696-route-evolution-graph`
