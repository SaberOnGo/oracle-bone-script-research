...
Project ID: `obs-evo-cand-010653`
...
- Project ID: `obs-evo-cand-010653`
- EVOBC category candidate ID: `evobc-evo-cat-10653`
- External category reference: `evobc-cat-10653`
- Source category ID: `10653`
- Source label for human review: `黣`
- Source codepoints: `U+9EE3`
...
- `obs-evo-cand-010653-route-category-staging`
...
- `obs-evo-cand-010653-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010653-route-evolution-graph`
