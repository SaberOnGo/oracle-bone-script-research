...
- External category reference: `evobc-cat-04944`
- Source category ID: `04944`
- Source label for human review: `澬`
- Source codepoints: `U+6FAC`
...
- `obs-evo-cand-004944-route-category-staging`
...
- `obs-evo-cand-004944-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004944-route-evolution-graph`
