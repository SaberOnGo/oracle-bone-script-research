# obs-unk-004934 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004934`
- primary external id: `hust-obc-und-X-004934`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/034_obs-unk-004934_h
  ust-obc-und-X-004934_oracle-character-candidate/03_visual-assets/001_asset
  -006527_hust-obc-und-X-004934_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/490/X_？_7474_1.png`
- asset id: `asset-006527`
...
- A dense left group and separate right curved enclosure are visible.
...
- source class: `HUST-OBC/undeciphered/X/490/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/490/X_？_7474_1.png`
- asset id: `asset-006527`
...
- Which source records identify obs-unk-004934 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004934？
