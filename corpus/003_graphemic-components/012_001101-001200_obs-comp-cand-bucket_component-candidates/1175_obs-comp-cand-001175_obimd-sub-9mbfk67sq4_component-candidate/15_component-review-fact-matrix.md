# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001175
...
| Glyph or codepoint route / 字形或码位路线 | 2 OBIMD route rows; examples U+F6C4C; U+F6C4D | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
