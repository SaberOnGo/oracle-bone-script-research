# obs-unk-004891 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004891`
- primary external id: `hust-obc-und-X-004891`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/091_obs-unk-004891_h
  ust-obc-und-X-004891_oracle-character-candidate/03_visual-assets/001_asset
  -006484_hust-obc-und-X-004891_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/447/X_？_7429_1.png`
- asset id: `asset-006484`
...
- source class: `HUST-OBC/undeciphered/X/447/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/447/X_？_7429_1.png`
- asset id: `asset-006484`
...
- English observation: `left curved stroke and lower pale enclosure`
- 中文观察: `左侧弧形长笔画和下部浅色外框`
...
- Which source records identify obs-unk-004891 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004891？
