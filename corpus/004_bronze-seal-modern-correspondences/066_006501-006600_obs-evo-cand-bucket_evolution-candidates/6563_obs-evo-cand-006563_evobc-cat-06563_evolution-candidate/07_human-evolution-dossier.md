...
- External category reference: `evobc-cat-06563`
- Source category ID: `06563`
- Source label for human review: `綸`
...
- `obs-evo-cand-006563-route-category-staging`
...
- `obs-evo-cand-006563-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006563-route-evolution-graph`
