...
Project ID: `obs-evo-cand-012334`
...
- Project ID: `obs-evo-cand-012334`
- EVOBC category candidate ID: `evobc-evo-cat-12334`
- External category reference: `evobc-cat-12334`
- Source category ID: `12334`
- Source label for human review: `𨍜`
- Source codepoints: `U+2835C`
...
- `obs-evo-cand-012334-route-category-staging`
...
- `obs-evo-cand-012334-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012334-route-evolution-graph`
