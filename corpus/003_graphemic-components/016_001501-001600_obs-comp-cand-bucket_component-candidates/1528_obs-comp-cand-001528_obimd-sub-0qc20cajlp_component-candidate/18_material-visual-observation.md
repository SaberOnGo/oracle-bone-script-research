# Material Visual Observation / obs-comp-cand-001528 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001528`
- External reference / 外部参照: `obimd-sub-0qc20cajlp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016942_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0qc20cajlp/0qc20cajlp/0qc20cajlp.png`
- Checksum / 校验和:
  `4dbbf5e7308e072047f72e4f1f453e05e922d56f2edec059f46aee65b9553729`
...
- Marked-pixel bounds: (91,21)–(168,224); span 78 × 204 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.77%。
- 痕迹范围：(91,21)–(168,224)；跨度78 × 204 px；痕迹矩形高于宽。
