# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013488
...
- EVOBC candidate category: `evobc-evo-cat-13488`.
- Source label for search only: `𭈬`.
- Source codepoints for search only: `U+2D22C`.
