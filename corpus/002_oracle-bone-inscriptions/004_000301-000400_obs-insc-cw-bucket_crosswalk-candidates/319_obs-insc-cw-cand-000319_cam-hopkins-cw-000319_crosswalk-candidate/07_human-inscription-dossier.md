...
Project ID: `obs-insc-cw-cand-000319`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000319`
...
- Yingguo / 英国所藏: `y1976` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `451` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `500` in source row; primary catalog entry pending
- Heji / 合集: `41005` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000319`
