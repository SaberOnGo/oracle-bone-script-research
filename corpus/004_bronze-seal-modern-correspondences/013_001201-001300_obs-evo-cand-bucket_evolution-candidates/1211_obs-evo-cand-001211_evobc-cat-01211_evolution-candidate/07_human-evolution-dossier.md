...
Project ID: `obs-evo-cand-001211`
...
- Project ID: `obs-evo-cand-001211`
- EVOBC category candidate ID: `evobc-evo-cat-01211`
- External category reference: `evobc-cat-01211`
- Source category ID: `01211`
- Source label for human review: `刺`
- Source codepoints: `U+523A`
...
- `obs-evo-cand-001211-route-category-staging`
...
- `obs-evo-cand-001211-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001211-route-evolution-graph`
