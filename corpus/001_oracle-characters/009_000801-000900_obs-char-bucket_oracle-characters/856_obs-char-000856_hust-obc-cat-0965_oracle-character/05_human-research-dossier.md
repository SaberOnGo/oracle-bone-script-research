# obs-char-000856 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/856_obs-char-000856_hust-obc-cat-0965_orac
  le-character/03_visual-assets/001_asset-000861_hust-obc-cat-0965_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0965/L_0965_1003.jpg`
- asset id: `asset-000861`
...
- source category: `0965`
- validation class: `855`
- source image route: `HUST-OBC/deciphered/0965/L_0965_1003.jpg`
- asset id: `asset-000861`
...
- English observation: `The tiny gray image shows a small angular loop at
  left and a tall curving stroke at right; the gap between them is difficult
  to resolve.`
- 中文观察: `微小灰度图像显示左侧小型折角环和右侧高长弯曲笔；两者之间的间隔难以辨清。`
...
- dataset label text: `㞻`
- dataset label codepoints: `U+37BB`
...
- Which source records identify obs-char-000856 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000856？
