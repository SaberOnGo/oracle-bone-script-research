# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004659
...
- EVOBC candidate category: `evobc-evo-cat-04659`.
- Source label for search only: `浟`.
- Source codepoints for search only: `U+6D5F`.
