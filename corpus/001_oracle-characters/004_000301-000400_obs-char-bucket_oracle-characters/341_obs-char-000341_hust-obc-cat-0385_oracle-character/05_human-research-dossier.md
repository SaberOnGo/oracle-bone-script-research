# obs-char-000341 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/341_obs-char-000341_hust-obc-cat-0385_orac
  le-character/03_visual-assets/001_asset-000346_hust-obc-cat-0385_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0385/G_0385_京津2651(甲).png`
- asset id: `asset-000346`
...
- source category: `0385`
- validation class: `340`
- source image route: `HUST-OBC/deciphered/0385/G_0385_京津2651(甲).png`
- asset id: `asset-000346`
...
- English observation: `The rectangular outer enclosure contains central
  diagonal and vertical strokes with small upper and lower extensions.`
...
- dataset label text: `㕷`
- dataset label codepoints: `U+3577`
...
- Which source records identify obs-char-000341 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000341？
