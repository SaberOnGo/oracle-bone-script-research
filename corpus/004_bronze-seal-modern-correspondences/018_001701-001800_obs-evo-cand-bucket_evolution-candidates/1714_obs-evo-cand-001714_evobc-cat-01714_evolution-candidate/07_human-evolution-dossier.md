...
Project ID: `obs-evo-cand-001714`
...
- Project ID: `obs-evo-cand-001714`
- EVOBC category candidate ID: `evobc-evo-cat-01714`
- External category reference: `evobc-cat-01714`
- Source category ID: `01714`
- Source label for human review: `噍`
- Source codepoints: `U+564D`
...
- `obs-evo-cand-001714-route-category-staging`
...
- `obs-evo-cand-001714-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001714-route-evolution-graph`
