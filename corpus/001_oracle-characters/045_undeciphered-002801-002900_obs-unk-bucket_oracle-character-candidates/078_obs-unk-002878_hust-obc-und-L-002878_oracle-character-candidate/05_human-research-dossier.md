# obs-unk-002878 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002878`
- primary external id: `hust-obc-und-L-002878`
...
- local review image route: `corpus/001_oracle-characters/045_undeciphered-002
  801-002900_obs-unk-bucket_oracle-character-candidates/078_obs-unk-002878_h
  ust-obc-und-L-002878_oracle-character-candidate/03_visual-assets/001_asset
  -004471_hust-obc-und-L-002878_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2878/L_？_4918.jpg`
- asset id: `asset-004471`
...
- source class: `HUST-OBC/undeciphered/L/2878/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2878/L_？_4918.jpg`
- asset id: `asset-004471`
...
- Which source records identify obs-unk-002878 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002878？
