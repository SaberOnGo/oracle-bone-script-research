# obs-unk-004795 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004795`
- primary external id: `hust-obc-und-X-004795`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/095_obs-unk-004795_h
  ust-obc-und-X-004795_oracle-character-candidate/03_visual-assets/001_asset
  -006388_hust-obc-und-X-004795_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/351/X_？_7333_1.png`
- asset id: `asset-006388`
...
- source class: `HUST-OBC/undeciphered/X/351/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/351/X_？_7333_1.png`
- asset id: `asset-006388`
...
- English observation: `upper opening, lower enclosure, and missing views`
- 中文观察: `上部开口、下部三角围合和缺失来源视图`
...
- Which source records identify obs-unk-004795 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004795？
