...
- External category reference: `evobc-cat-11348`
- Source category ID: `11348`
- Source label for human review: `𢽵`
...
- `obs-evo-cand-011348-route-category-staging`
...
- `obs-evo-cand-011348-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011348-route-evolution-graph`
