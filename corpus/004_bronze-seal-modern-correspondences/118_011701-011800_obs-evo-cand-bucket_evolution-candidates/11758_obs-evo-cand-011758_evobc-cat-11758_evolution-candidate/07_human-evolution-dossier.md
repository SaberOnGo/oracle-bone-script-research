...
- External category reference: `evobc-cat-11758`
- Source category ID: `11758`
- Source label for human review: `𥂗`
...
- `obs-evo-cand-011758-route-category-staging`
...
- `obs-evo-cand-011758-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011758-route-evolution-graph`
