# Material Visual Observation / obs-comp-cand-002625 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002625`
- External reference / 外部参照: `obimd-sub-0tve12gh3k`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021164_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kqep0e5n7r/0tve12gh3k/0tve12gh3k.png`
- Checksum / 校验和:
  `57527888aa786ad1833ae9bc246c78d0026dd3077ff41215624b27783de433b0`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.13%.
- Marked-pixel bounds: (44,28)–(212,223); span 169 × 196 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.13%。
- 痕迹范围：(44,28)–(212,223)；跨度169 × 196 px；痕迹矩形近方形。
