# Material Visual Observation / obs-comp-cand-001347 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001347`
- External reference / 外部参照: `obimd-sub-wnk1om8h9s`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015736_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wnk1om8h9s/wnk1om8h9s/wnk1om8h9s.png`
- Checksum / 校验和:
  `adf7b1c549ba33b5049e71e033650173b20eb700ab88dbc09032b87fc2f73dcf`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.23%.
- Marked-pixel bounds: (64,48)–(185,198); span 122 × 151 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.23%。
- 痕迹范围：(64,48)–(185,198)；跨度122 × 151 px；痕迹矩形高于宽。
