# obs-char-001491 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1491_obs-char-001491_hust-obc-cat-1673_ora
  cle-character/03_visual-assets/001_asset-001496_hust-obc-cat-1673_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1673/G_1673_乙1907合6484賓組.png`
- asset id: `asset-001496`
...
- source category: `1673`
- validation class: `1490`
- source image route: `HUST-OBC/deciphered/1673/G_1673_乙1907合6484賓組.png`
- asset id: `asset-001496`
...
- English observation: `A broad lower enclosure has two upper loops and
  several inner divisions.`
...
- dataset label text: `㩿`
- dataset label codepoints: `U+3A7F`
...
- Which source records identify obs-char-001491 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001491？
