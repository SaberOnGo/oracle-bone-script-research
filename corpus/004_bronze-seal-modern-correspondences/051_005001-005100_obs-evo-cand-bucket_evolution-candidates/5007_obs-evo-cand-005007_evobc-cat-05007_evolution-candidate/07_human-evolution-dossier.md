...
- External category reference: `evobc-cat-05007`
- Source category ID: `05007`
- Source label: `瀼`
...
- `obs-evo-cand-005007-route-category-staging`
...
- `obs-evo-cand-005007-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005007-route-evolution-graph`
