# Material Visual Observation / obs-comp-cand-002723 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002723`
- External reference / 外部参照: `obimd-sub-xjszizqtbx`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021339_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xjszizqtbx/xjszizqtbx/xjszizqtbx.png`
- Checksum / 校验和:
  `482ff3966a7581802777ebc4fa608b65cf6df71684603eb50100746d57c96f5b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.71%.
- Marked-pixel bounds: (78,28)–(174,212); span 97 × 185 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.71%。
- 痕迹范围：(78,28)–(174,212)；跨度97 × 185 px；痕迹矩形高于宽。
