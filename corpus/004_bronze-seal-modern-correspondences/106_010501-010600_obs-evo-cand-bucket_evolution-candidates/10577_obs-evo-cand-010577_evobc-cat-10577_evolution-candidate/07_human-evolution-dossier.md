...
- External category reference: `evobc-cat-10577`
- Source category ID: `10577`
- Source label for human review: `鸔`
- Source codepoints: `U+9E14`
...
- `obs-evo-cand-010577-route-category-staging`
...
- `obs-evo-cand-010577-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010577-route-evolution-graph`
