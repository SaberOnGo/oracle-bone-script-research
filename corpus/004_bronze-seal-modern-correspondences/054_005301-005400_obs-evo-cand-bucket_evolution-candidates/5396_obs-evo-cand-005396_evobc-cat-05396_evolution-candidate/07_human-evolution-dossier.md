...
Project ID: `obs-evo-cand-005396`
...
- Project ID: `obs-evo-cand-005396`
- EVOBC category candidate ID: `evobc-evo-cat-05396`
- External category reference: `evobc-cat-05396`
- Source category ID: `05396`
- Source label for human review: `珽`
- Source codepoints: `U+73FD`
...
- `obs-evo-cand-005396-route-category-staging`
...
- `obs-evo-cand-005396-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005396-route-evolution-graph`
