# Material Visual Observation / obs-comp-cand-001170 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001170`
- External reference / 外部参照: `obimd-sub-env42ca0w7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015360_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7fhnqn7giq/env42ca0w7/env42ca0w7.png`
- Checksum / 校验和:
  `af30dd6773cd28766cc4e3ef790b3dc25a47e5232fe5705a259aa543d771421b`
...
- Marked-pixel bounds: (73,47)–(176,199); span 104 × 153 px; the marked
...
- 痕迹范围：(73,47)–(176,199)；跨度104 × 153 px；痕迹矩形高于宽。
