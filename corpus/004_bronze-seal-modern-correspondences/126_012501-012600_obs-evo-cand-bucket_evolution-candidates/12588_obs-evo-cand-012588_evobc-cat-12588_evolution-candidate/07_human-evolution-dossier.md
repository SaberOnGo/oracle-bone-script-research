...
Project ID: `obs-evo-cand-012588`
...
- Project ID: `obs-evo-cand-012588`
- EVOBC category candidate ID: `evobc-evo-cat-12588`
- External category reference: `evobc-cat-12588`
- Source category ID: `12588`
- Source label for human review: `𩎒`
- Source codepoints: `U+29392`
...
- `obs-evo-cand-012588-route-category-staging`
...
- `obs-evo-cand-012588-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012588-route-evolution-graph`
