# Material Visual Observation / obs-comp-cand-001284 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001284`
- External reference / 外部参照: `obimd-sub-b9q6ewwhki`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015569_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/b9q6ewwhki/b9q6ewwhki/b9q6ewwhki.png`
- Checksum / 校验和:
  `6c998455d1d60aaa5cbc0177683d01210afe9147cbcd7bccbbbe71dd4a8184e2`
...
- Marked-pixel bounds: (77,37)–(172,217); span 96 × 181 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.07%。
- 痕迹范围：(77,37)–(172,217)；跨度96 × 181 px；痕迹矩形高于宽。
