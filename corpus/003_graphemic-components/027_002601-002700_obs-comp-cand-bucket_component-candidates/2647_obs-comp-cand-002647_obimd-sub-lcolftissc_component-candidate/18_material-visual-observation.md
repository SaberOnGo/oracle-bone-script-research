# Material Visual Observation / obs-comp-cand-002647 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002647`
- External reference / 外部参照: `obimd-sub-lcolftissc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021196_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lcolftissc/lcolftissc/lcolftissc.png`
- Checksum / 校验和:
  `f963db9613c7cd128f7c4907708f5b1dd3197559c64fced5d82ce8139522c8b2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.08%.
- Marked-pixel bounds: (88,23)–(161,225); span 74 × 203 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.08%。
- 痕迹范围：(88,23)–(161,225)；跨度74 × 203 px；痕迹矩形高于宽。
