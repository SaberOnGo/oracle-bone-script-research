...
- `obs-evo-cand-000053-route-category-staging`
...
- `obs-evo-cand-000053-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000053-route-evolution-graph`
