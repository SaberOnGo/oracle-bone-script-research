...
- `obs-evo-cand-006274-route-category-staging`
...
- `obs-evo-cand-006274-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006274-route-evolution-graph`
