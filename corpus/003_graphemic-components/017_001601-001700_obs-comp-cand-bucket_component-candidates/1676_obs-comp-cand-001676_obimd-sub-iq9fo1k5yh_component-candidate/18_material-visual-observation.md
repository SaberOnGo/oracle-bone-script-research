# Material Visual Observation / obs-comp-cand-001676 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001676`
- External reference / 外部参照: `obimd-sub-iq9fo1k5yh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017592_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cixqnyxp9v/iq9fo1k5yh/iq9fo1k5yh.png`
- Checksum / 校验和:
  `4ad4bc274a84acf8669fa2fe8055bd0fbd3d2cc05d03a622a731270b8c23d68a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.22%.
- Marked-pixel bounds: (68,40)–(181,205); span 114 × 166 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.22%。
- 痕迹范围：(68,40)–(181,205)；跨度114 × 166 px；痕迹矩形高于宽。
