# Material Visual Observation / obs-comp-cand-002245 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002245`
- External reference / 外部参照: `obimd-sub-8wzlxmpbz0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020058_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8wzlxmpbz0/8wzlxmpbz0/8wzlxmpbz0.png`
- Checksum / 校验和:
  `17039064899ddefc676bf6e9b63b424425e4b7311b6db859f74580e397a609b1`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.46%.
- Marked-pixel bounds: (51,43)–(201,212); span 151 × 170 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.46%。
- 痕迹范围：(51,43)–(201,212)；跨度151 × 170 px；痕迹矩形近方形。
