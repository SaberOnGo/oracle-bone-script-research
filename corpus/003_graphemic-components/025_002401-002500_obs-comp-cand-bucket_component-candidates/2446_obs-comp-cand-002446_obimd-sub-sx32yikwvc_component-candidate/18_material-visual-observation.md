# Material Visual Observation / obs-comp-cand-002446 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002446`
- External reference / 外部参照: `obimd-sub-sx32yikwvc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020618_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/sinjn961eq/sx32yikwvc/sx32yikwvc.png`
- Checksum / 校验和:
  `73633dc553fc60f51257827902c6db751395416ca16185a52bd3ec5464f3ef5b`
...
- Marked-pixel bounds: (83,47)–(166,199); span 84 × 153 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.81%。
- 痕迹范围：(83,47)–(166,199)；跨度84 × 153 px；痕迹矩形高于宽。
