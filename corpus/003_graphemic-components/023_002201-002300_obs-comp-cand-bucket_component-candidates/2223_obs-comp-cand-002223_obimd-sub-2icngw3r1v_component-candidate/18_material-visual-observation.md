# Material Visual Observation / obs-comp-cand-002223 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002223`
- External reference / 外部参照: `obimd-sub-2icngw3r1v`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020036_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/m74006xplh/2icngw3r1v/2icngw3r1v.png`
- Checksum / 校验和:
  `2df72bd9646edf99bd6d3fdcabddb2e4d19c593d864bc5e601cd3e4c12209803`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.44%.
- Marked-pixel bounds: (77,28)–(172,216); span 96 × 189 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.44%。
- 痕迹范围：(77,28)–(172,216)；跨度96 × 189 px；痕迹矩形高于宽。
