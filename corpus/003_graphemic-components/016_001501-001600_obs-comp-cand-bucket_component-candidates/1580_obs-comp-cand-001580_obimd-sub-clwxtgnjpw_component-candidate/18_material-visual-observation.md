# Material Visual Observation / obs-comp-cand-001580 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001580`
- External reference / 外部参照: `obimd-sub-clwxtgnjpw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017161_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/clwxtgnjpw/clwxtgnjpw/clwxtgnjpw.png`
- Checksum / 校验和:
  `189582d8a95d2095d9de183cead981ff447d5cd497612776cdcd3650148c6a9a`
...
- Marked-pixel bounds: (59,42)–(189,208); span 131 × 167 px; the marked
...
- 痕迹范围：(59,42)–(189,208)；跨度131 × 167 px；痕迹矩形高于宽。
