# Material Visual Observation / obs-comp-cand-002658 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002658`
- External reference / 外部参照: `obimd-sub-vf7lmnbqi8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021234_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vf7lmnbqi8/vf7lmnbqi8/vf7lmnbqi8.png`
- Checksum / 校验和:
  `f234d24d9877e0a03841c339f82ba926e11bb57b3581fd643226d5ee599441af`
...
- Marked-pixel bounds: (87,22)–(156,227); span 70 × 206 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.56%。
- 痕迹范围：(87,22)–(156,227)；跨度70 × 206 px；痕迹矩形高于宽。
