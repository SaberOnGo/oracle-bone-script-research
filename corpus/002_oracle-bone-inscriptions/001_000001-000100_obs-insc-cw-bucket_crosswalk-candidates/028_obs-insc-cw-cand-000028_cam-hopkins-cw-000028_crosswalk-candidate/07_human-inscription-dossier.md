...
Project ID: `obs-insc-cw-cand-000028`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000028`
...
- Yingguo / 英国所藏: `y164` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `130` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `674` in source row; primary catalog entry pending
- Heji / 合集: `40383` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000028`
