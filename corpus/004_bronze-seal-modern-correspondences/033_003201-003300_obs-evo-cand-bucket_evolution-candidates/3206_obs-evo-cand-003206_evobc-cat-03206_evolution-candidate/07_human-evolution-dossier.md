...
- External category reference: `evobc-cat-03206`
- Source category ID: `03206`
- Source label for human review: `我`
- Source codepoints: `U+6211`
- Image reference count in source metadata: `331`
...
- era `0`
  token: `OBC`
  image references: 122
- era `1`
  token: `BI`
  image references: 107
- era `2`
  token: `SS`
  image references: 3
- era `3`
...
- `obs-evo-cand-003206-route-category-staging`
...
- `obs-evo-cand-003206-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003206-route-evolution-graph`
