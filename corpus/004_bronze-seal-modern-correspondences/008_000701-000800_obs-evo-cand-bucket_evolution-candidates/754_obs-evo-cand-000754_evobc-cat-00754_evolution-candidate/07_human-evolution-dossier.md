...
- Project ID: `obs-evo-cand-000754`
- EVOBC category candidate ID: `evobc-evo-cat-00754`
- External category reference: `evobc-cat-00754`
- Source category ID: `00754`
- Source label for human review: `价`
- Source codepoints: `U+4EF7`
...
- `obs-evo-cand-000754-route-category-staging`
...
- `obs-evo-cand-000754-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000754-route-evolution-graph`
