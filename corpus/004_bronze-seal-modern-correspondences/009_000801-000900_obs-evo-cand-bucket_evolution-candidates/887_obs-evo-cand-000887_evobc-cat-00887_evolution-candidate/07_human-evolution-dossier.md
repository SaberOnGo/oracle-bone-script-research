...
- External category reference: `evobc-cat-00887`
- Source category ID: `00887`
- Source label for human review: `俔`
...
- `obs-evo-cand-000887-route-category-staging`
...
- `obs-evo-cand-000887-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000887-route-evolution-graph`
