# obs-char-000023 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000023`
- primary external id: `hust-obc-cat-0028`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/023_obs-char-000023_hust-obc-cat-0028_orac
  le-character/03_visual-assets/001_asset-000028_hust-obc-cat-0028_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0028/G_0028_乙4568合14959賓組.png`
- asset id: `asset-000028`
...
- source category: `0028`
- validation class: `22`
- source image route: `HUST-OBC/deciphered/0028/G_0028_乙4568合14959賓組.png`
- asset id: `asset-000028`
...
- English observation: `The dark form combines a pointed upper outline,
  several horizontal cross strokes, and multiple short descending strokes.`
- 中文观察: `深色形体上方呈尖顶轮廓，中部有数条横向交叉笔画，下方有多条短向下笔画。`
...
- dataset label text: `㐒`
- dataset label codepoints: `U+3412`
...
- filename catalog route clues: `Heji-like filename clue: 合14959
  (G_0028_乙4568合14959賓組.png)`
...
- Which source records identify obs-char-000023 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000023？
