# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012828
...
- EVOBC candidate category: `evobc-evo-cat-12828`.
- Source label for search only: `𪧫`.
- Source codepoints for search only: `U+2A9EB`.
