...
Project ID: `obs-evo-cand-006821`
...
- Project ID: `obs-evo-cand-006821`
- EVOBC category candidate ID: `evobc-evo-cat-06821`
- External category reference: `evobc-cat-06821`
- Source category ID: `06821`
- Source label for human review: `罱`
- Source codepoints: `U+7F71`
...
- `obs-evo-cand-006821-route-category-staging`
...
- `obs-evo-cand-006821-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006821-route-evolution-graph`
