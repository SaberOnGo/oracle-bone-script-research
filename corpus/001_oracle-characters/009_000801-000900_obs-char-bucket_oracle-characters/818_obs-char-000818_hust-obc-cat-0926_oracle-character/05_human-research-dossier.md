# obs-char-000818 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000818`
- primary external id: `hust-obc-cat-0926`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/818_obs-char-000818_hust-obc-cat-0926_orac
  le-character/03_visual-assets/001_asset-000823_hust-obc-cat-0926_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0926/G_0926_乙749合555.png`
- asset id: `asset-000823`
...
- source category: `0926`
- validation class: `817`
- source image route: `HUST-OBC/deciphered/0926/G_0926_乙749合555.png`
- asset id: `asset-000823`
...
- English observation: `A long curving stem branches toward the right and
  carries shorter side strokes on the left; the lower branch extends as a
  thin diagonal.`
- 中文观察: `一条弯曲长干向右分枝，左侧带有较短侧笔；下方分枝以细长斜笔延伸。`
...
- dataset label text: `㞔`
- dataset label codepoints: `U+3794`
...
- filename catalog route clues: `Heji-like filename clue: 合555
  (G_0926_乙749合555.png)`
...
- Which source records identify obs-char-000818 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000818？
