...
Project ID: `obs-evo-cand-004677`
...
- Project ID: `obs-evo-cand-004677`
- EVOBC category candidate ID: `evobc-evo-cat-04677`
- External category reference: `evobc-cat-04677`
- Source category ID: `04677`
- Source label for human review: `消`
- Source codepoints: `U+6D88`
...
- `obs-evo-cand-004677-route-category-staging`
...
- `obs-evo-cand-004677-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004677-route-evolution-graph`
