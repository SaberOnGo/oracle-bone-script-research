...
- Project ID: `obs-evo-cand-001600`
- EVOBC category candidate ID: `evobc-evo-cat-01600`
- External category reference: `evobc-cat-01600`
- Source category ID: `01600`
- Source label for human review: `唉`
- Source codepoints: `U+5509`
...
- `obs-evo-cand-001600-route-category-staging`
...
- `obs-evo-cand-001600-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001600-route-evolution-graph`
