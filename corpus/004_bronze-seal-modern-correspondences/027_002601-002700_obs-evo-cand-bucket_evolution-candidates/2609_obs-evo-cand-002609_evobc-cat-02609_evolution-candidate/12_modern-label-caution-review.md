# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002609
...
- EVOBC candidate category: `evobc-evo-cat-02609`.
- Source label for search only: `巛`.
- Source codepoints for search only: `U+5DDB`.
