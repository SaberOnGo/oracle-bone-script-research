# Material Visual Observation / obs-comp-cand-000942 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000942`
- External reference / 外部参照: `obimd-sub-whid4atneq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014025_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4jtkq6w8f6/whid4atneq/whid4atneq.png`
- Checksum / 校验和:
  `529b4b1344ffce50786f0b4099f921b43c08f5d63406383706667657634de251`
...
- Marked-pixel bounds: (72,35)–(200,217); span 129 × 183 px; the marked
...
- 痕迹范围：(72,35)–(200,217)；跨度129 × 183 px；痕迹矩形高于宽。
