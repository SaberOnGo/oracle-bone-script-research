# Material Visual Observation / obs-comp-cand-002209 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002209`
- External reference / 外部参照: `obimd-sub-2hdoxmv8n8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019993_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2hdoxmv8n8/2hdoxmv8n8/2hdoxmv8n8.png`
- Checksum / 校验和:
  `4c1217f0a12127ab6bbfda73c30b858c9e5c2dbce5b3ae9807f8c1e075ce1920`
...
- Marked-pixel bounds: (71,57)–(178,188); span 108 × 132 px; the marked
...
- 痕迹范围：(71,57)–(178,188)；跨度108 × 132 px；痕迹矩形高于宽。
