# Material Visual Observation / obs-comp-cand-001909 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001909`
- External reference / 外部参照: `obimd-sub-umabbd0jwi`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018319_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/umabbd0jwi/umabbd0jwi/umabbd0jwi.png`
- Checksum / 校验和:
  `c5432b0fa8c41b54f902de674634223536199f205fb33c5bf7047150a22fb7e5`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.63%.
- Marked-pixel bounds: (62,26)–(194,223); span 133 × 198 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.63%。
- 痕迹范围：(62,26)–(194,223)；跨度133 × 198 px；痕迹矩形高于宽。
