...
- External category reference: `evobc-cat-12402`
- Source category ID: `12402`
- Source label for human review: `𨙻`
- Source codepoints: `U+2867B`
...
- `obs-evo-cand-012402-route-category-staging`
...
- `obs-evo-cand-012402-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012402-route-evolution-graph`
