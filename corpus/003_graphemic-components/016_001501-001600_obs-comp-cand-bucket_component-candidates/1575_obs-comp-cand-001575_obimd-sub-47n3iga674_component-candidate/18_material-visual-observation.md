# Material Visual Observation / obs-comp-cand-001575 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001575`
- External reference / 外部参照: `obimd-sub-47n3iga674`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017156_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ggmxiphq64/47n3iga674/47n3iga674.png`
- Checksum / 校验和:
  `d8ad4c5deafa217a3723e2042573bdab996be5715798bec76f8373e665b359ac`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.79%.
- Marked-pixel bounds: (70,34)–(179,215); span 110 × 182 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.79%。
- 痕迹范围：(70,34)–(179,215)；跨度110 × 182 px；痕迹矩形高于宽。
