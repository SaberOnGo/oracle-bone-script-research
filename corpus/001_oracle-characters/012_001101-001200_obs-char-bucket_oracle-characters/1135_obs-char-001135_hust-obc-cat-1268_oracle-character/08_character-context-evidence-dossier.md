...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1268`
...
- Source image / 来源图: `G_1268_乙12合21021𠂤組.png`
- Image / 图像: `001_asset-001140_hust-obc-cat-1268_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合21021
...
- target node: `obimd-main-cand-002631`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Matched OBIMD main UIDs / OBIMD 主字 UID: `lgmn04qz1f`
...
- Source label text / 来源标签文字: `㣪`
- Source label codepoint / 来源标签 codepoint: `U+38EA`
