# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008768
...
- EVOBC candidate category: `evobc-evo-cat-08768`.
- Source label for search only: `蹭`.
- Source codepoints for search only: `U+8E6D`.
