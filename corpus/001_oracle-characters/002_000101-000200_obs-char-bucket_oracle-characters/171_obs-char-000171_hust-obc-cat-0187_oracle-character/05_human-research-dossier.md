# obs-char-000171 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/171_obs-char-000171_hust-obc-cat-0187_orac
  le-character/03_visual-assets/001_asset-000176_hust-obc-cat-0187_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0187/G_0187_乙2007合140賓組.png`
- asset id: `asset-000176`
...
- source category: `0187`
- validation class: `170`
- source image route: `HUST-OBC/deciphered/0187/G_0187_乙2007合140賓組.png`
- asset id: `asset-000176`
...
- English observation: `The image has a three-pronged upper form, a long
  curved descending stroke, and a short angular projection near the lower
  left.`
...
- dataset label text: `㒱`
- dataset label codepoints: `U+34B1`
...
- filename catalog route clues: `Heji-like filename clue: 合140
  (G_0187_乙2007合140賓組.png)`
...
- Which source records identify obs-char-000171 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000171？
