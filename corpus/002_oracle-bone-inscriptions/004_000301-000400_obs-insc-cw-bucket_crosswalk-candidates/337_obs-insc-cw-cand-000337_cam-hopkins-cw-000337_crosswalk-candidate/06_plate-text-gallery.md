...
Project ID: `obs-insc-cw-cand-000337`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000337`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000337` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2011` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `512` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `8` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `41048` [route_present_image_or_text_not_collected]
