# Material Visual Observation / obs-comp-cand-002554 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002554`
- External reference / 外部参照: `obimd-sub-wi7jemi7yd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021086_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wi7jemi7yd/wi7jemi7yd/wi7jemi7yd.png`
- Checksum / 校验和:
  `7ec5424d4a186c6927111e8278724ebd14008474ffbb1eee9c26060679ec4822`
...
- Marked-pixel bounds: (78,53)–(171,191); span 94 × 139 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.40%。
- 痕迹范围：(78,53)–(171,191)；跨度94 × 139 px；痕迹矩形高于宽。
