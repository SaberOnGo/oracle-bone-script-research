# obs-char-000050 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/050_obs-char-000050_hust-obc-cat-0058_orac
  le-character/03_visual-assets/001_asset-000055_hust-obc-cat-0058_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0058/G_0058_乙3119(甲).png`
- asset id: `asset-000055`
...
- source category: `0058`
- validation class: `49`
- source image route: `HUST-OBC/deciphered/0058/G_0058_乙3119(甲).png`
- asset id: `asset-000055`
...
- English observation: `The tiny gray image has a short top bar, a central
  upright stroke, and a small angular projection to the side.`
- 中文观察: `微小灰度图像有短上横画、中央竖向笔画和侧面的折角伸出。`
...
- dataset label text: `㐰`
- dataset label codepoints: `U+3430`
...
- Which source records identify obs-char-000050 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000050？
