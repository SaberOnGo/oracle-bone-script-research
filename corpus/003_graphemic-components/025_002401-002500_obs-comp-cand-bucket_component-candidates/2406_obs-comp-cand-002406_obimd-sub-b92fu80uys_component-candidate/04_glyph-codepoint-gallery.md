# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002406
...
| --- | --- | --- | --- |
| `obimd-glyph-link-036836` | 󽮐 | `U+FDB90` | `reviewed_metadata_only` |
| `obimd-glyph-link-036837` | 󽮑 | `U+FDB91` | `reviewed_metadata_only` |
| `obimd-glyph-link-036838` | 󽮒 | `U+FDB92` | `reviewed_metadata_only` |
| `obimd-glyph-link-036839` | 󽮓 | `U+FDB93` | `reviewed_metadata_only` |
| `obimd-glyph-link-036840` | 󽮔 | `U+FDB94` | `reviewed_metadata_only` |
