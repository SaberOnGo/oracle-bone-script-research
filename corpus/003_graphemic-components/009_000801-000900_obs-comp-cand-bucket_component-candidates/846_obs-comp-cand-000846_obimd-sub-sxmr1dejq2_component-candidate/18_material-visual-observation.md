# Material Visual Observation / obs-comp-cand-000846 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000846`
- External reference / 外部参照: `obimd-sub-sxmr1dejq2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013717_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/sxmr1dejq2/sxmr1dejq2/sxmr1dejq2.png`
- Checksum / 校验和:
  `14ae8c67df81e0c0691e67ec471a5f090c4ee95b5a9d5e5c6cace3e0b6d55357`
...
- Marked-pixel bounds: (82,20)–(163,227); span 82 × 208 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.84%。
- 痕迹范围：(82,20)–(163,227)；跨度82 × 208 px；痕迹矩形高于宽。
