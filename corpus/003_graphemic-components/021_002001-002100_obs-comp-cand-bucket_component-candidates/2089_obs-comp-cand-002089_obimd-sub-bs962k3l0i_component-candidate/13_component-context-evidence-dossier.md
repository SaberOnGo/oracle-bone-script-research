# obs-comp-cand-002089 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002089`
- 首选外部 ID: `obimd-sub-bs962k3l0i`
- OBIMD subcharacter UID: `bs962k3l0i`
- OBIMD main character UID: `bs962k3l0i`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+91C6;U+FC06C; U+FC06D; 另有 2 项
