...
- External category reference: `evobc-cat-02245`
- Source category ID: `02245`
- Source label for human review: `媱`
- Source codepoints: `U+5AB1`
...
- `obs-evo-cand-002245-route-category-staging`
...
- `obs-evo-cand-002245-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002245-route-evolution-graph`
