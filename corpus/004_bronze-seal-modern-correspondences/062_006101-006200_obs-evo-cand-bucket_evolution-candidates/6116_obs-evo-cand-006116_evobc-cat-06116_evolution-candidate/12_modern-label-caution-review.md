# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006116
...
- EVOBC candidate category: `evobc-evo-cat-06116`.
- Source label for search only: `稻`.
- Source codepoints for search only: `U+7A3B`.
