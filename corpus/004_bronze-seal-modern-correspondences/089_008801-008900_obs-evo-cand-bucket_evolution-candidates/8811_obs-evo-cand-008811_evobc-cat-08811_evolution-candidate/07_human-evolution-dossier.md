...
- External category reference: `evobc-cat-08811`
- Source category ID: `08811`
- Source label for human review: `軭`
- Source codepoints: `U+8EED`
...
- `obs-evo-cand-008811-route-category-staging`
...
- `obs-evo-cand-008811-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008811-route-evolution-graph`
