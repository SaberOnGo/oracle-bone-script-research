# obs-unk-003977 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003977`
- primary external id: `hust-obc-und-L-003977`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/077_obs-unk-003977_h
  ust-obc-und-L-003977_oracle-character-candidate/03_visual-assets/001_asset
  -005570_hust-obc-und-L-003977_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3977/L_？_8413.jpg`
- asset id: `asset-005570`
...
- source class: `HUST-OBC/undeciphered/L/3977/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3977/L_？_8413.jpg`
- asset id: `asset-005570`
...
- English observation: Two upper traces converge above a broad lower bar, with a
  short central trace passing through it.
- 中文观察：两条上部痕迹在较宽下部横痕上方汇合，短中央痕迹穿过横痕。
...
- Which source records identify obs-unk-003977 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003977？
