# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-002032
...
- candidate_component_id: `obs-comp-cand-002032`
- primary_external_ref_id: `obimd-sub-4s3tpt5d8v`
- source_subcharacter_uid: `4s3tpt5d8v`
- source_main_character_uid: `4s3tpt5d8v`
- main_character_external_ref_id: `obimd-main-4s3tpt5d8v`
...
- glyph_codepoint_uplus_sample: `U+B8A70;U+FBB61, U+FBB62, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-019359` | `001_asset-019359_img.png` | `4a2d7bad217312aa1762ddff13287a36ebd84e0458f661a823fedbcdf1a4629c` |
