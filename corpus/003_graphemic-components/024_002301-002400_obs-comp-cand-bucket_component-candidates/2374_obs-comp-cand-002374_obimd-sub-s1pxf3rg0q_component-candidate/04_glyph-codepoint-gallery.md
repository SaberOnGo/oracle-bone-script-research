# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002374
...
| --- | --- | --- | --- |
| `obimd-glyph-link-036613` | 򧇞󽧟 | `U+A71DE;U+FD9DF` | `reviewed_metadata_only` |
| `obimd-glyph-link-036614` | 󽧠 | `U+FD9E0` | `reviewed_metadata_only` |
| `obimd-glyph-link-036615` | 󽧡 | `U+FD9E1` | `reviewed_metadata_only` |
| `obimd-glyph-link-036616` | 󽧢 | `U+FD9E2` | `reviewed_metadata_only` |
