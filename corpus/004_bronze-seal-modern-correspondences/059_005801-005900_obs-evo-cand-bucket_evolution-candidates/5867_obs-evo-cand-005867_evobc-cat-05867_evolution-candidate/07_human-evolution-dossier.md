...
- Project ID: `obs-evo-cand-005867`
- EVOBC category candidate ID: `evobc-evo-cat-05867`
- External category reference: `evobc-cat-05867`
- Source category ID: `05867`
- Source label for human review: `矆`
- Source codepoints: `U+77C6`
...
- `obs-evo-cand-005867-route-category-staging`
...
- `obs-evo-cand-005867-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005867-route-evolution-graph`
