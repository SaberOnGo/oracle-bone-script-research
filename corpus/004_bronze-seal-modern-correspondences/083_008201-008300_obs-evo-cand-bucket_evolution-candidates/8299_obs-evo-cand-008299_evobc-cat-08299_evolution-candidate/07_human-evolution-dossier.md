...
Project ID: `obs-evo-cand-008299`
...
- Project ID: `obs-evo-cand-008299`
- EVOBC category candidate ID: `evobc-evo-cat-08299`
- External category reference: `evobc-cat-08299`
- Source category ID: `08299`
- Source label for human review: `諼`
- Source codepoints: `U+8AFC`
...
- `obs-evo-cand-008299-route-category-staging`
...
- `obs-evo-cand-008299-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008299-route-evolution-graph`
