...
- Yingguo / 英国所藏: `y454` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `59` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `488` in source row; primary catalog entry pending
