# obs-char-001413 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001413`
- primary external id: `hust-obc-cat-1582`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1413_obs-char-001413_hust-obc-cat-1582_ora
  cle-character/03_visual-assets/001_asset-001418_hust-obc-cat-1582_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1582/G_1582_乙1032合11892.png`
- asset id: `asset-001418`
...
- source category: `1582`
- validation class: `1412`
- source image route: `HUST-OBC/deciphered/1582/G_1582_乙1032合11892.png`
- asset id: `asset-001418`
...
- English observation: `Three stacked angular horizontal bands are joined by
  short central strokes.`
- 中文观察: `三个叠置角状水平带由短中央笔画连接。`
...
- dataset label text: `㨤`
- dataset label codepoints: `U+3A24`
...
- filename catalog route clues: `Heji-like filename clue: 合11892
  (G_1582_乙1032合11892.png)`
...
- Which source records identify obs-char-001413 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001413？
