# obs-char-000582 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/582_obs-char-000582_hust-obc-cat-0660_orac
  le-character/03_visual-assets/001_asset-000587_hust-obc-cat-0660_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0660/G_0660_乙4548合14295無名組.png`
- asset id: `asset-000587`
...
- source category: `0660`
- validation class: `581`
- source image route: `HUST-OBC/deciphered/0660/G_0660_乙4548合14295無名組.png`
- asset id: `asset-000587`
...
- English observation: `A narrow central vertical passes through a small
  crossed upper loop and divides below into paired curved branches with
  pointed ends.`
- 中文观察: `狭窄中央竖笔穿过小型交叉上环，下部分成一对带尖端的弯曲枝笔。`
...
- dataset label text: `㚊`
- dataset label codepoints: `U+368A`
...
- Which source records identify obs-char-000582 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000582？
