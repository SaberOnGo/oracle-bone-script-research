# Material Visual Observation / obs-comp-cand-002339 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002339`
- External reference / 外部参照: `obimd-sub-e097ctjxvg`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020358_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/e097ctjxvg/e097ctjxvg/e097ctjxvg.png`
- Checksum / 校验和:
  `32de81c6651372e693056fb8bac2587c0ff809158e5905b36ae4d83daa8165d7`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.59%.
- Marked-pixel bounds: (93,38)–(169,208); span 77 × 171 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.59%。
- 痕迹范围：(93,38)–(169,208)；跨度77 × 171 px；痕迹矩形高于宽。
