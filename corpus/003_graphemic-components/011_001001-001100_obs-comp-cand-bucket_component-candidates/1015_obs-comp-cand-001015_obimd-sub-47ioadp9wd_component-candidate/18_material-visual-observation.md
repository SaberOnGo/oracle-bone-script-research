# Material Visual Observation / obs-comp-cand-001015 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001015`
- External reference / 外部参照: `obimd-sub-47ioadp9wd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014478_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/47ioadp9wd/47ioadp9wd/174hzkbpms.png`
- Checksum / 校验和:
  `a930a0ae0603e2ca72509473f026941e8ccbb3d7f092aad998bf96a423dbac81`
...
- Marked-pixel bounds: (59,78)–(190,171); span 132 × 94 px; the marked rectangle
  is wider than tall.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.54%。
- 痕迹范围：(59,78)–(190,171)；跨度132 × 94 px；痕迹矩形宽于高。
