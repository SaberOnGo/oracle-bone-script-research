# obs-char-000248 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000248`
- primary external id: `hust-obc-cat-0276`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/248_obs-char-000248_hust-obc-cat-0276_orac
  le-character/03_visual-assets/001_asset-000253_hust-obc-cat-0276_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0276/L_0276_9332.jpg`
- asset id: `asset-000253`
...
- source category: `0276`
- validation class: `247`
- source image route: `HUST-OBC/deciphered/0276/L_0276_9332.jpg`
- asset id: `asset-000253`
...
- English observation: `The low-contrast gray image is a compact cluster of
  crossing angular strokes; fine terminals are difficult to separate at this
  size.`
- 中文观察: `低对比度灰度图像呈交叉折角笔画的紧凑聚集；受尺寸影响，细小末端难以分开。`
...
- dataset label text: `㔊`
- dataset label codepoints: `U+350A`
...
- Which source records identify obs-char-000248 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000248？
