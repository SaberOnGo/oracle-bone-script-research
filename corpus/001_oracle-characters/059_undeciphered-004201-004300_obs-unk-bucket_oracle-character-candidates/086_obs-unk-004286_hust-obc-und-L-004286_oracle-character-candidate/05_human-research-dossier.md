# obs-unk-004286 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004286`
- primary external id: `hust-obc-und-L-004286`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/086_obs-unk-004286_h
  ust-obc-und-L-004286_oracle-character-candidate/03_visual-assets/001_asset
  -005879_hust-obc-und-L-004286_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4286/L_？_9464.jpg`
- asset id: `asset-005879`
...
- source class: `HUST-OBC/undeciphered/L/4286/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4286/L_？_9464.jpg`
- asset id: `asset-005879`
...
- English observation: `Upper curve, central descent, side traces visible.`
- 中文观察: `上部弧痕、中央下行线和侧向痕迹可见。`
...
- Which source records identify obs-unk-004286 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004286？
