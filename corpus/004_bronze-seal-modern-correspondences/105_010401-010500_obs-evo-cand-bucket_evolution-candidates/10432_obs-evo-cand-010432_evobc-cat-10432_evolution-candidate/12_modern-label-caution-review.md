# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010432
...
- EVOBC candidate category: `evobc-evo-cat-10432`.
- Source label for search only: `鰝`.
- Source codepoints for search only: `U+9C1D`.
