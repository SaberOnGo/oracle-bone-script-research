# obs-evo-cand-012610 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-012610`
- EVOBC category candidate ID: `evobc-evo-cat-12610`
- External category ref: `evobc-cat-12610`
- Source label: `𩒨`
- Source codepoints: `U+294A8`
- Image reference count: `165`
- Era token counts: `BI:161;WSC:4`
- Source token counts: `Book:112;Web:53`

## Observed Code Rows / 观察到的代码行

- era 1 / BI: 161 image references
- era 4 / WSC: 4 image references
- source 1 / Web:105952;說文Web:58: 53 image references
- source 3 / Book:21681: 108 image references
