...
Project ID: `obs-evo-cand-003283`
...
- Project ID: `obs-evo-cand-003283`
- EVOBC category candidate ID: `evobc-evo-cat-03283`
- External category reference: `evobc-cat-03283`
- Source category ID: `03283`
- Source label for human review: `折`
- Source codepoints: `U+6298`
...
- `obs-evo-cand-003283-route-category-staging`
...
- `obs-evo-cand-003283-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003283-route-evolution-graph`
