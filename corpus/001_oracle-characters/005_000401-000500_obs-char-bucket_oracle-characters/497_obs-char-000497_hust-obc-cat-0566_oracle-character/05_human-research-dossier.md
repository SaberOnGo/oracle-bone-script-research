# obs-char-000497 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/497_obs-char-000497_hust-obc-cat-0566_orac
  le-character/03_visual-assets/001_asset-000502_hust-obc-cat-0566_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0566/G_0566_後1.2.16(甲).png`
- asset id: `asset-000502`
...
- source category: `0566`
- validation class: `496`
- source image route: `HUST-OBC/deciphered/0566/G_0566_後1.2.16(甲).png`
- asset id: `asset-000502`
...
- English observation: `A bold central vertical trunk divides into several
  long upward branches on both sides and narrows into a rounded descending
  end.`
...
- dataset label text: `㘬`
- dataset label codepoints: `U+362C`
...
- Which source records identify obs-char-000497 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000497？
