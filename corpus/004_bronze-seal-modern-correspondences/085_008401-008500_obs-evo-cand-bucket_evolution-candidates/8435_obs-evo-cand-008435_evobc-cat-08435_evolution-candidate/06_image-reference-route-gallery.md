...
- `obs-evo-cand-008435-route-category-staging`
...
- `obs-evo-cand-008435-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008435-route-evolution-graph`
