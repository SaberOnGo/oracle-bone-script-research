...
- Source page section: `Period I Group 8` /
  `第 I 期第 8 组`
- Source section key: `period-i-group-8`
...
- Yingguo / 英国所藏: `y757` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `30` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `567` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000138`
