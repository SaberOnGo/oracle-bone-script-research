...
Project ID: `obs-insc-cw-cand-000257`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000257`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000257` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y1715` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `232` [route_present_image_or_text_not_collected]
