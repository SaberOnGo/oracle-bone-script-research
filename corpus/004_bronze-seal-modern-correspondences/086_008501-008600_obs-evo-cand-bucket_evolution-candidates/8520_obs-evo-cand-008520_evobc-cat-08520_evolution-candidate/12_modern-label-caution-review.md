# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008520
...
- EVOBC candidate category: `evobc-evo-cat-08520`.
- Source label for search only: `貊`.
- Source codepoints for search only: `U+8C8A`.
