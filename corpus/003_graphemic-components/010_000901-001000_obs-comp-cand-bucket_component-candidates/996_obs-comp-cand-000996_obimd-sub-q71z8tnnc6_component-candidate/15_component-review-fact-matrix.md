# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000996
...
| Glyph or codepoint route / 字形或码位路线 | 64 OBIMD route rows; examples U+4EA5;U+F5A62; U+F5A63; 另有 62 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 64 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
