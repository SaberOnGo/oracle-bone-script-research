...
- Project ID: `obs-evo-cand-005810`
- EVOBC category candidate ID: `evobc-evo-cat-05810`
- External category reference: `evobc-cat-05810`
- Source category ID: `05810`
- Source label for human review: `眵`
- Source codepoints: `U+7735`
...
- `obs-evo-cand-005810-route-category-staging`
...
- `obs-evo-cand-005810-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005810-route-evolution-graph`
