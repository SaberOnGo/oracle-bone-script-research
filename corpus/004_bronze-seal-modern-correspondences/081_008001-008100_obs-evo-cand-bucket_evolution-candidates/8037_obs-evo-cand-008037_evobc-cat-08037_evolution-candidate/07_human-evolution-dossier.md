...
- External category reference: `evobc-cat-08037`
- Source category ID: `08037`
- Source label for human review: `襞`
...
- `obs-evo-cand-008037-route-category-staging`
...
- `obs-evo-cand-008037-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008037-route-evolution-graph`
