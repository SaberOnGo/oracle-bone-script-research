# obs-char-000782 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000782`
- primary external id: `hust-obc-cat-0886`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/782_obs-char-000782_hust-obc-cat-0886_orac
  le-character/03_visual-assets/001_asset-000787_hust-obc-cat-0886_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0886/G_0886_粹1276(甲).png`
- asset id: `asset-000787`
...
- source category: `0886`
- validation class: `781`
- source image route: `HUST-OBC/deciphered/0886/G_0886_粹1276(甲).png`
- asset id: `asset-000787`
...
- English observation: `Two adjacent forms stand together: the left is a
  dense branching cluster, while the right has a pointed upper frame, a
  rounded middle opening, and a long curved lower tail.`
- 中文观察: `两个相邻形体并列：左侧为浓重分枝笔群，右侧有尖顶上框、圆弯中部空隙和长弯下尾。`
...
- dataset label text: `㝬`
- dataset label codepoints: `U+376C`
...
- OBIMD candidate ids / OBIMD 候选 ID: `obimd-main-cand-000981`
- OBIMD external refs / OBIMD 外部引用: `obimd-main-gxkrzcoj69`
- OBIMD transcription field / OBIMD 转写字段: `㝬`
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00075`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00075`
- EvoBC image reference count / EvoBC 图像引用数: `69`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00075`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/075_obs-evo-can
  d-000075_evobc-cat-00075_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/075_obs-evo-cand-000075_evobc-cat-00075_evolu
...
- matched OBIMD main UIDs: `gxkrzcoj69`
...
- Which source records identify obs-char-000782 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000782？
