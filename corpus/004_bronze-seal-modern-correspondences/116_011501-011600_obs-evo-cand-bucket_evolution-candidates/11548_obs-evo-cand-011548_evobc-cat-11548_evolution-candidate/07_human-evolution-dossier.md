...
- External category reference: `evobc-cat-11548`
- Source category ID: `11548`
- Source label for human review: `𤂗`
...
- `obs-evo-cand-011548-route-category-staging`
...
- `obs-evo-cand-011548-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011548-route-evolution-graph`
