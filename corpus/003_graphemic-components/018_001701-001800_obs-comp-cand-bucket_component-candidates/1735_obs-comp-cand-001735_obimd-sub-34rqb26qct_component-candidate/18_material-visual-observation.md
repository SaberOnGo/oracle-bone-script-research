# Material Visual Observation / obs-comp-cand-001735 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001735`
- External reference / 外部参照: `obimd-sub-34rqb26qct`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017931_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/l7cyvm7kbt/34rqb26qct/34rqb26qct.png`
- Checksum / 校验和:
  `2cd5f43d177a626daec41828c6b1ed7cd490e3e5be73d6404457c4f952e5f629`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 22.39%.
- Marked-pixel bounds: (66,64)–(187,181); span 122 × 118 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占22.39%。
- 痕迹范围：(66,64)–(187,181)；跨度122 × 118 px；痕迹矩形近方形。
