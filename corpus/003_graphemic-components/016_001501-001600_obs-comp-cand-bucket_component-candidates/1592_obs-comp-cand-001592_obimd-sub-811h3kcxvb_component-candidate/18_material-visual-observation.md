# Material Visual Observation / obs-comp-cand-001592 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001592`
- External reference / 外部参照: `obimd-sub-811h3kcxvb`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017268_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/811h3kcxvb/811h3kcxvb/811h3kcxvb.png`
- Checksum / 校验和:
  `733ef7c79259eb8012cbc19a8595fce5a75c00d12d071bff8063e469cf904e26`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.15%.
- Marked-pixel bounds: (71,24)–(180,222); span 110 × 199 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.15%。
- 痕迹范围：(71,24)–(180,222)；跨度110 × 199 px；痕迹矩形高于宽。
