# Material Visual Observation / obs-comp-cand-000442 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000442`
- External reference / 外部参照: `obimd-sub-2nmkx2vinv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012365_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/nqghhf5br6/2nmkx2vinv/2nmkx2vinv.png`
- Checksum / 校验和:
  `4e3f22a56b3562899d9386fa5dac488c7f5576a7fdc92157507d56543b6c4453`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.80%.
- Marked-pixel bounds: (62,28)–(187,224); span 126 × 197 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.80%。
- 痕迹范围：(62,28)–(187,224)；跨度126 × 197 px；痕迹矩形高于宽。
