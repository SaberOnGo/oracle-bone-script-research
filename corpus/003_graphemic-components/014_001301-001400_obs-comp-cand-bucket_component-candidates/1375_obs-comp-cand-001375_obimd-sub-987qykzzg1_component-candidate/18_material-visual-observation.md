# Material Visual Observation / obs-comp-cand-001375 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001375`
- External reference / 外部参照: `obimd-sub-987qykzzg1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015794_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/73ru6libmk/987qykzzg1/987qykzzg1.png`
- Checksum / 校验和:
  `9bbd727becde9eb39126a4702ac3957a4a7c32501fa5d60f0e95b78bb27dc5d2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.37%.
- Marked-pixel bounds: (71,24)–(192,227); span 122 × 204 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.37%。
- 痕迹范围：(71,24)–(192,227)；跨度122 × 204 px；痕迹矩形高于宽。
