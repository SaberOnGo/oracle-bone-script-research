# obs-unk-002712 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002712`
- primary external id: `hust-obc-und-L-002712`
...
- local review image route: `corpus/001_oracle-characters/044_undeciphered-002
  701-002800_obs-unk-bucket_oracle-character-candidates/012_obs-unk-002712_h
  ust-obc-und-L-002712_oracle-character-candidate/03_visual-assets/001_asset
  -004305_hust-obc-und-L-002712_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2712/L_？_4328.jpg`
- asset id: `asset-004305`
...
- source class: `HUST-OBC/undeciphered/L/2712/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2712/L_？_4328.jpg`
- asset id: `asset-004305`
...
- Which source records identify obs-unk-002712 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002712？
