...
- External category reference: `evobc-cat-07569`
- Source category ID: `07569`
- Source label for human review: `蔶`
...
- `obs-evo-cand-007569-route-category-staging`
...
- `obs-evo-cand-007569-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007569-route-evolution-graph`
