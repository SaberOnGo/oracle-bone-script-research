# obs-char-000199 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000199`
- primary external id: `hust-obc-cat-0222`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/199_obs-char-000199_hust-obc-cat-0222_orac
  le-character/03_visual-assets/001_asset-000204_hust-obc-cat-0222_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0222/G_0222_戩6.8(甲).png`
- asset id: `asset-000204`
...
- source category: `0222`
- validation class: `198`
- source image route: `HUST-OBC/deciphered/0222/G_0222_戩6.8(甲).png`
- asset id: `asset-000204`
...
- English observation: `The image has a short upper horizontal bar, a
  rounded middle enclosure, a small lower loop, and upright side strokes.`
- 中文观察: `图像上方有短横笔，中部有圆弧围合，下方有小环状形，两侧有竖向笔画。`
...
- dataset label text: `㓔`
- dataset label codepoints: `U+34D4`
...
- Which source records identify obs-char-000199 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000199？
