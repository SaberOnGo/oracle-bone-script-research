...
Project ID: `obs-evo-cand-001740`
...
- Project ID: `obs-evo-cand-001740`
- EVOBC category candidate ID: `evobc-evo-cat-01740`
- External category reference: `evobc-cat-01740`
- Source category ID: `01740`
- Source label for human review: `嚨`
- Source codepoints: `U+56A8`
...
- `obs-evo-cand-001740-route-category-staging`
...
- `obs-evo-cand-001740-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001740-route-evolution-graph`
