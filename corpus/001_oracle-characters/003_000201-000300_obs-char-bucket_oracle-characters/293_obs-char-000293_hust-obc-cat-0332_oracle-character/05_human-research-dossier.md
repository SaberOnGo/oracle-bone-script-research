# obs-char-000293 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000293`
- primary external id: `hust-obc-cat-0332`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/293_obs-char-000293_hust-obc-cat-0332_orac
  le-character/03_visual-assets/001_asset-000298_hust-obc-cat-0332_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0332/G_0332_乙2461合9502賓組.png`
- asset id: `asset-000298`
...
- source category: `0332`
- validation class: `292`
- source image route: `HUST-OBC/deciphered/0332/G_0332_乙2461合9502賓組.png`
- asset id: `asset-000298`
...
- English observation: `The image has a large curved enclosing stroke on the
  left and a separate rounded lower form on the right, joined by a short
  horizontal mark.`
- 中文观察: `图像左侧有大型弧形包围笔画，右侧有分离的圆弧下部形体，两者由短横向痕迹相接。`
...
- dataset label text: `㕂`
- dataset label codepoints: `U+3542`
...
- filename catalog route clues: `Heji-like filename clue: 合9502
  (G_0332_乙2461合9502賓組.png)`
...
- Which source records identify obs-char-000293 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000293？
