...
- Project ID: `obs-evo-cand-004377`
- EVOBC category candidate ID: `evobc-evo-cat-04377`
- External category reference: `evobc-cat-04377`
- Source category ID: `04377`
- Source label for human review: `歖`
- Source codepoints: `U+6B56`
...
- `obs-evo-cand-004377-route-category-staging`
...
- `obs-evo-cand-004377-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004377-route-evolution-graph`
