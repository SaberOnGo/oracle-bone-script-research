# Material Visual Observation / obs-comp-cand-000660 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000660`
- External reference / 外部参照: `obimd-sub-p8shoneevj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013223_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/p8shoneevj/p8shoneevj/p8shoneevj.png`
- Checksum / 校验和:
  `9b20acfc878047cead4e6440fd1bc02437a8e476f4af5cf780bbd0670f69e2be`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.23%.
- Marked-pixel bounds: (82,31)–(167,223); span 86 × 193 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.23%。
- 痕迹范围：(82,31)–(167,223)；跨度86 × 193 px；痕迹矩形高于宽。
