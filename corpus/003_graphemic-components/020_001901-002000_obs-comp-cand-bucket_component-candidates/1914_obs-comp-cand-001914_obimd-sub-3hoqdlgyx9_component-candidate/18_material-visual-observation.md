# Material Visual Observation / obs-comp-cand-001914 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001914`
- External reference / 外部参照: `obimd-sub-3hoqdlgyx9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018324_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wf3aejbrt3/3hoqdlgyx9/3hoqdlgyx9.png`
- Checksum / 校验和:
  `0f2c136e160d545f71bea8293d70224d716c9c869312330bacd51870fc630dda`
...
- Marked-pixel bounds: (97,35)–(152,209); span 56 × 175 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.15%。
- 痕迹范围：(97,35)–(152,209)；跨度56 × 175 px；痕迹矩形高于宽。
