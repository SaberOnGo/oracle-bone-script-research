# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004392
...
- EVOBC candidate category: `evobc-evo-cat-04392`.
- Source label for search only: `歬`.
- Source codepoints for search only: `U+6B6C`.
