# Material Visual Observation / obs-comp-cand-000099 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000099`
- External reference / 外部参照: `obimd-sub-4wg9twxah6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011511_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2kvlcqk9xy/4wg9twxah6/4wg9twxah6.png`
- Checksum / 校验和:
  `80974ce554299b82519aefe9eb16dd4460502ecd0e6496db6f55a00684d0ac4c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.55%.
- Marked-pixel bounds: (37,27)–(212,222); span 176 × 196 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.55%。
- 痕迹范围：(37,27)–(212,222)；跨度176 × 196 px；痕迹矩形近方形。
