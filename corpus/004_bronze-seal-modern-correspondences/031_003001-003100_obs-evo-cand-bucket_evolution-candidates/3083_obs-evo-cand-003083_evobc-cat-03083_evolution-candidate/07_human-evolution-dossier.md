...
- External category reference: `evobc-cat-03083`
- Source category ID: `03083`
- Source label for human review: `愓`
- Source codepoints: `U+6113`
...
- `obs-evo-cand-003083-route-category-staging`
...
- `obs-evo-cand-003083-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003083-route-evolution-graph`
