...
Project ID: `obs-evo-cand-008025`
...
- Project ID: `obs-evo-cand-008025`
- EVOBC category candidate ID: `evobc-evo-cat-08025`
- External category reference: `evobc-cat-08025`
- Source category ID: `08025`
- Source label for human review: `襁`
- Source codepoints: `U+8941`
...
- `obs-evo-cand-008025-route-category-staging`
...
- `obs-evo-cand-008025-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008025-route-evolution-graph`
