# obs-char-001566 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1566_obs-char-001566_hust-obc-cat-1758_ora
  cle-character/03_visual-assets/001_asset-001571_hust-obc-cat-1758_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1758/X_1758_214_1.png`
- asset id: `asset-001571`
...
- source category: `1758`
- validation class: `1565`
- source image route: `HUST-OBC/deciphered/1758/X_1758_214_1.png`
- asset id: `asset-001571`
...
- English observation: `Several forked marks surround a central stem with
  two small rounded openings.`
...
- dataset label text: `㫔`
- dataset label codepoints: `U+3AD4`
...
- Which source records identify obs-char-001566 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001566？
