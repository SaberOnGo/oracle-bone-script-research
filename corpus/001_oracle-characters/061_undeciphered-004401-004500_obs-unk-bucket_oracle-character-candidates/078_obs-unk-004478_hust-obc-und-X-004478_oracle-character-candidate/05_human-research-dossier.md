# obs-unk-004478 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/078_obs-unk-004478_h
  ust-obc-und-X-004478_oracle-character-candidate/03_visual-assets/001_asset
  -006071_hust-obc-und-X-004478_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/34/X_？_8212_1.png`
- asset id: `asset-006071`
...
- source class: `HUST-OBC/undeciphered/X/34/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/34/X_？_8212_1.png`
- asset id: `asset-006071`
...
- English observation: Three horizontal strokes are joined by slanted supports
  around open triangular spaces.
- 中文观察: 三条横痕由斜向支痕连接，围出开放三角空间。
...
- Which source records identify obs-unk-004478 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004478？
