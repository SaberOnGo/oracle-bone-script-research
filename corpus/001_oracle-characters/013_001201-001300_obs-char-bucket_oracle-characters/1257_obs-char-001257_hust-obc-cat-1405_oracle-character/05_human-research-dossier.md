# obs-char-001257 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001257`
- primary external id: `hust-obc-cat-1405`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1257_obs-char-001257_hust-obc-cat-1405_ora
  cle-character/03_visual-assets/001_asset-001262_hust-obc-cat-1405_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1405/L_1405_7181.jpg`
- asset id: `asset-001262`
...
- source category: `1405`
- validation class: `1256`
- source image route: `HUST-OBC/deciphered/1405/L_1405_7181.jpg`
- asset id: `asset-001262`
...
- English observation: `A narrow angular form has a short upper cross-stroke
  and two descending strokes leaving an open middle.`
- 中文观察: `狭长折角形体有短上部横笔，两条下行笔画之间形成开放中部。`
...
- dataset label text: `㥳`
- dataset label codepoints: `U+3973`
...
- Which source records identify obs-char-001257 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001257？
