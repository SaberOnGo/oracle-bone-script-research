...
- Project ID: `obs-evo-cand-006983`
- EVOBC category candidate ID: `evobc-evo-cat-06983`
- External category reference: `evobc-cat-06983`
- Source category ID: `06983`
- Source label for human review: `肓`
- Source codepoints: `U+8093`
...
- `obs-evo-cand-006983-route-category-staging`
...
- `obs-evo-cand-006983-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006983-route-evolution-graph`
