...
Project ID: `obs-evo-cand-002627`
...
- Project ID: `obs-evo-cand-002627`
- EVOBC category candidate ID: `evobc-evo-cat-02627`
- External category reference: `evobc-cat-02627`
- Source category ID: `02627`
- Source label for human review: `巴`
- Source codepoints: `U+5DF4`
...
- `obs-evo-cand-002627-route-category-staging`
...
- `obs-evo-cand-002627-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002627-route-evolution-graph`
