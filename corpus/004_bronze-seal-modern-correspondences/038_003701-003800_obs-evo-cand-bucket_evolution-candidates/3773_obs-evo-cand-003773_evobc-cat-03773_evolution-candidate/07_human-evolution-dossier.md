...
Project ID: `obs-evo-cand-003773`
...
- Project ID: `obs-evo-cand-003773`
- EVOBC category candidate ID: `evobc-evo-cat-03773`
- External category reference: `evobc-cat-03773`
- Source category ID: `03773`
- Source label for human review: `暊`
- Source codepoints: `U+668A`
...
- `obs-evo-cand-003773-route-category-staging`
...
- `obs-evo-cand-003773-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003773-route-evolution-graph`
