...
Project ID: `obs-evo-cand-002521`
...
- Project ID: `obs-evo-cand-002521`
- EVOBC category candidate ID: `evobc-evo-cat-02521`
- External category reference: `evobc-cat-02521`
- Source category ID: `02521`
- Source label for human review: `屬`
- Source codepoints: `U+5C6C`
...
- `obs-evo-cand-002521-route-category-staging`
...
- `obs-evo-cand-002521-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002521-route-evolution-graph`
