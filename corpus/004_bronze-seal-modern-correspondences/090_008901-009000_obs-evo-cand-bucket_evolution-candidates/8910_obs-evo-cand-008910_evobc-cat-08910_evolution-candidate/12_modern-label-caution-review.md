# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008910
...
- EVOBC candidate category: `evobc-evo-cat-08910`.
- Source label for search only: `辟`.
- Source codepoints for search only: `U+8F9F`.
