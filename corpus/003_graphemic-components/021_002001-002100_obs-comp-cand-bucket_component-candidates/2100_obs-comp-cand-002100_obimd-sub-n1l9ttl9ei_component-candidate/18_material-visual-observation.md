# Material Visual Observation / obs-comp-cand-002100 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002100`
- External reference / 外部参照: `obimd-sub-n1l9ttl9ei`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019546_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/n1l9ttl9ei/n1l9ttl9ei/n1l9ttl9ei.png`
- Checksum / 校验和:
  `43122ba41b4c37c7cdccf037d08e6df3770b254c4243e3647402080db7cb903e`
...
- Marked-pixel bounds: (80,26)–(172,221); span 93 × 196 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.15%。
- 痕迹范围：(80,26)–(172,221)；跨度93 × 196 px；痕迹矩形高于宽。
