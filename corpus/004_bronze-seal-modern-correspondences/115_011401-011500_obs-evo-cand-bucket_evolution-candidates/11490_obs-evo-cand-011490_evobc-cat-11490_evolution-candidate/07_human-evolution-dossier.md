...
- External category reference: `evobc-cat-11490`
- Source category ID: `11490`
- Source label for human review: `𣪕`
- Source codepoints: `U+23A95`
- Image reference count in source metadata: `32`
...
- `obs-evo-cand-011490-route-category-staging`
...
- `obs-evo-cand-011490-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011490-route-evolution-graph`
