# Material Visual Observation / obs-comp-cand-002127 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002127`
- External reference / 外部参照: `obimd-sub-1rzrhj2j4j`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019684_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1rzrhj2j4j/1rzrhj2j4j/1rzrhj2j4j.png`
- Checksum / 校验和:
  `0d7eea10b28e49f2f3a81bc115d257b40a2ee7d21d0536adaaf91d2b6384a002`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.75%.
- Marked-pixel bounds: (50,21)–(181,225); span 132 × 205 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.75%。
- 痕迹范围：(50,21)–(181,225)；跨度132 × 205 px；痕迹矩形高于宽。
