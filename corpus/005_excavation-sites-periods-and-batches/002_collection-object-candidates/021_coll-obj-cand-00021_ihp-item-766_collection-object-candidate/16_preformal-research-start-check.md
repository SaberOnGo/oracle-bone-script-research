# Preformal Research Start Check / 正式研究开始前开包核查: coll-obj-cand-00021
...
| --- | --- | --- |
| 1 | `02_collection-source-index.csv` | `766` |
...
| 6 | `18_live-source-evidence-review.md` | source text, image hashes, rights |
...
- Which source description, overlay, or image route still needs an independent
  check?
...
- 不确认卜辞身份或释文
- 不接受释读、构件归属或断代结论
- candidate_collection_object_id: `ihp-mus-obj-00021`
