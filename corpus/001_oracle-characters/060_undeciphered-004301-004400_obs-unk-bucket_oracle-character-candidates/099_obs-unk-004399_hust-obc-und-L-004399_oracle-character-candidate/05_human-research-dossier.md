# obs-unk-004399 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004399`
- primary external id: `hust-obc-und-L-004399`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/099_obs-unk-004399_h
  ust-obc-und-L-004399_oracle-character-candidate/03_visual-assets/001_asset
  -005992_hust-obc-und-L-004399_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4399/L_？_9798.jpg`
- asset id: `asset-005992`
...
- source class: `HUST-OBC/undeciphered/L/4399/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4399/L_？_9798.jpg`
- asset id: `asset-005992`
...
- English observation: `A dense upper cluster surrounds a longer central trace;`
  `a darker angular area appears at the lower right.`
- 中文观察: `上部密集痕迹围绕较长中央痕，右下有较深斜角区域。`
...
- Which source records identify obs-unk-004399 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004399？
