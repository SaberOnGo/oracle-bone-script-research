...
- External category reference: `evobc-cat-02072`
- Source category ID: `02072`
- Source label for human review: `妇`
...
- `obs-evo-cand-002072-route-category-staging`
...
- `obs-evo-cand-002072-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002072-route-evolution-graph`
