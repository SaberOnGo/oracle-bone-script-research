# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013713
...
- EVOBC candidate category: `evobc-evo-cat-13713`.
- Source label for search only: `琢`.
- Source codepoints for search only: `U+FA4A`.
