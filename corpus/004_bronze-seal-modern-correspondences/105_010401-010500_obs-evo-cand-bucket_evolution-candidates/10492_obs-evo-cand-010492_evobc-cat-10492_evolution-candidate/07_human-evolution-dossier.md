...
Project ID: `obs-evo-cand-010492`
...
- Project ID: `obs-evo-cand-010492`
- EVOBC category candidate ID: `evobc-evo-cat-10492`
- External category reference: `evobc-cat-10492`
- Source category ID: `10492`
- Source label for human review: `鴟`
- Source codepoints: `U+9D1F`
...
- `obs-evo-cand-010492-route-category-staging`
...
- `obs-evo-cand-010492-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010492-route-evolution-graph`
