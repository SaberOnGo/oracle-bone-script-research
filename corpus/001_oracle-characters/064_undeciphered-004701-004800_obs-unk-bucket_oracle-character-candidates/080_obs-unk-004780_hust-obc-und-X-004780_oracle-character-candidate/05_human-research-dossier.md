# obs-unk-004780 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004780`
- primary external id: `hust-obc-und-X-004780`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/080_obs-unk-004780_h
  ust-obc-und-X-004780_oracle-character-candidate/03_visual-assets/001_asset
  -006373_hust-obc-und-X-004780_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/336/X_？_7320_1.png`
- asset id: `asset-006373`
...
- source class: `HUST-OBC/undeciphered/X/336/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/336/X_？_7320_1.png`
- asset id: `asset-006373`
...
- English observation: `distinct left, central, and right groups`
- 中文观察: `分立的左侧、中央和右侧结构`
...
- Which source records identify obs-unk-004780 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004780？
