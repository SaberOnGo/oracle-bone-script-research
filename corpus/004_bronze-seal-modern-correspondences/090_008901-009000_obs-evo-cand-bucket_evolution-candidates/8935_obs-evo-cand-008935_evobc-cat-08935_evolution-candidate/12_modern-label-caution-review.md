# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008935
...
- EVOBC candidate category: `evobc-evo-cat-08935`.
- Source label for search only: `迁`.
- Source codepoints for search only: `U+8FC1`.
