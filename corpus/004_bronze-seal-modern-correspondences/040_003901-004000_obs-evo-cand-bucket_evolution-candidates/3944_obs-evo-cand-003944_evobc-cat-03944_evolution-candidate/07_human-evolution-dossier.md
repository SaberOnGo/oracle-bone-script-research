...
Project ID: `obs-evo-cand-003944`
...
- Project ID: `obs-evo-cand-003944`
- EVOBC category candidate ID: `evobc-evo-cat-03944`
- External category reference: `evobc-cat-03944`
- Source category ID: `03944`
- Source label for human review: `柀`
- Source codepoints: `U+67C0`
...
- `obs-evo-cand-003944-route-category-staging`
...
- `obs-evo-cand-003944-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003944-route-evolution-graph`
