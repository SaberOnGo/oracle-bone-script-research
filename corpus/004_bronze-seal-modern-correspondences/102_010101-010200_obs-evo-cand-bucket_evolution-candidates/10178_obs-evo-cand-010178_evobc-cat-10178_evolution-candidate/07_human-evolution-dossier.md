...
- External category reference: `evobc-cat-10178`
- Source category ID: `10178`
...
- `obs-evo-cand-010178-route-category-staging`
...
- `obs-evo-cand-010178-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010178-route-evolution-graph`
