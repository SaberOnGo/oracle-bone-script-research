...
- External category reference: `evobc-cat-10533`
- Source category ID: `10533`
- Source label for human review: `鶪`
- Source codepoints: `U+9DAA`
...
- `obs-evo-cand-010533-route-category-staging`
...
- `obs-evo-cand-010533-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010533-route-evolution-graph`
