# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000268
...
- EVOBC candidate category: `evobc-evo-cat-00268`.
- Source label for search only: `㿋`.
- Source codepoints for search only: `U+3FCB`.
