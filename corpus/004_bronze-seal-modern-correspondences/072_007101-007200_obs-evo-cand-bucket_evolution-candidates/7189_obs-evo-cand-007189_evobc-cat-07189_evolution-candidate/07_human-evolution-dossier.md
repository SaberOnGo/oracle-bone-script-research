...
- External category reference: `evobc-cat-07189`
- Source category ID: `07189`
- Source label for human review: `舉`
- Source codepoints: `U+8209`
...
- `obs-evo-cand-007189-route-category-staging`
...
- `obs-evo-cand-007189-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007189-route-evolution-graph`
