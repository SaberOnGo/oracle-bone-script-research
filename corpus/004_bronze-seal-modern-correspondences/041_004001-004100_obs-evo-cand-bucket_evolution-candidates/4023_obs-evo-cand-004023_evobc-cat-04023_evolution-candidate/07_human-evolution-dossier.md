...
- External category reference: `evobc-cat-04023`
- Source category ID: `04023`
- Source label: `桌`
...
- `obs-evo-cand-004023-route-category-staging`
...
- `obs-evo-cand-004023-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004023-route-evolution-graph`
