# obs-comp-cand-000403 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000403`
- 首选外部 ID: `obimd-sub-qj5ls1wkvt`
- OBIMD subcharacter UID: `qj5ls1wkvt`
- OBIMD main character UID: `qj5ls1wkvt`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+C2276;U+F2590; U+F2591; 另有 1 项
