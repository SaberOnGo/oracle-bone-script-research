# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006711
...
- EVOBC candidate category: `evobc-evo-cat-06711`.
- Source label for search only: `纍`.
- Source codepoints for search only: `U+7E8D`.
