...
- External category reference: `evobc-cat-06039`
- Source category ID: `06039`
- Source label for human review: `禳`
...
- `obs-evo-cand-006039-route-category-staging`
...
- `obs-evo-cand-006039-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006039-route-evolution-graph`
