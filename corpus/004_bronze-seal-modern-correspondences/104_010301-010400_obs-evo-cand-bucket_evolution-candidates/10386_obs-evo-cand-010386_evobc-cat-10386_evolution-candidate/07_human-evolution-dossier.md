...
- Project ID: `obs-evo-cand-010386`
- EVOBC category candidate ID: `evobc-evo-cat-10386`
- External category reference: `evobc-cat-10386`
- Source category ID: `10386`
- Source label for human review: `鮊`
- Source codepoints: `U+9B8A`
...
- `obs-evo-cand-010386-route-category-staging`
...
- `obs-evo-cand-010386-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010386-route-evolution-graph`
