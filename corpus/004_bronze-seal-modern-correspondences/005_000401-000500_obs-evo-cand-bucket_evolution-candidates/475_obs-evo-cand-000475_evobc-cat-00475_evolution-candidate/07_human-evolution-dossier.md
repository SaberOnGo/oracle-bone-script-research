...
- External category reference: `evobc-cat-00475`
- Source category ID: `00475`
- Source label for human review: `䢦`
- Source codepoints: `U+48A6`
...
- `obs-evo-cand-000475-route-category-staging`
...
- `obs-evo-cand-000475-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000475-route-evolution-graph`
