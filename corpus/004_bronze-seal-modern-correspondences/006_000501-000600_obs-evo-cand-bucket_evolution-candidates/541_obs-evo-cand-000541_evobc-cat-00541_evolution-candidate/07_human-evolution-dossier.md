...
Project ID: `obs-evo-cand-000541`
...
- Project ID: `obs-evo-cand-000541`
- EVOBC category candidate ID: `evobc-evo-cat-00541`
- External category reference: `evobc-cat-00541`
- Source category ID: `00541`
- Source label for human review: `䩪`
- Source codepoints: `U+4A6A`
...
- `obs-evo-cand-000541-route-category-staging`
...
- `obs-evo-cand-000541-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000541-route-evolution-graph`
