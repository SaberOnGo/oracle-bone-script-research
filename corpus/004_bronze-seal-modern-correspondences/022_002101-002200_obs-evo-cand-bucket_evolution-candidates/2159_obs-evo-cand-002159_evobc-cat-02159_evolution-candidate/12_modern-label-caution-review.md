# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002159
...
- EVOBC candidate category: `evobc-evo-cat-02159`.
- Source label for search only: `娋`.
- Source codepoints for search only: `U+5A0B`.
