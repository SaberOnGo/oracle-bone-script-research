# obs-char-000552 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/552_obs-char-000552_hust-obc-cat-0626_orac
  le-character/03_visual-assets/001_asset-000557_hust-obc-cat-0626_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0626/G_0626_乙1124合21948子組.png`
- asset id: `asset-000557`
...
- source category: `0626`
- validation class: `551`
- source image route: `HUST-OBC/deciphered/0626/G_0626_乙1124合21948子組.png`
- asset id: `asset-000557`
...
- English observation: `A rounded arch contains two horizontal bars and two
  long internal vertical strokes, while several thin rays fan upward from
  the top.`
- 中文观察: `圆拱内有两条横栏和两条长内竖笔，数条细短射线从顶部向上扇形展开。`
...
- dataset label text: `㙨`
- dataset label codepoints: `U+3668`
...
- filename catalog route clues: `Heji-like filename clue: 合21948
  (G_0626_乙1124合21948子組.png)`
...
- Which source records identify obs-char-000552 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000552？
