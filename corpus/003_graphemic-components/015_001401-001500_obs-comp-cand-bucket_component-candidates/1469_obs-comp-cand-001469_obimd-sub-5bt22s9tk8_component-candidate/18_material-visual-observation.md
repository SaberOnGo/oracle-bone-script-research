# Material Visual Observation / obs-comp-cand-001469 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001469`
- External reference / 外部参照: `obimd-sub-5bt22s9tk8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016046_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ake9481rl7/5bt22s9tk8/5bt22s9tk8.png`
- Checksum / 校验和:
  `7274e454229c3cb33275ea13c9fa9ee071ca90aba48f2f786739ff58e5a44dc1`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.65%.
- Marked-pixel bounds: (56,26)–(190,211); span 135 × 186 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.65%。
- 痕迹范围：(56,26)–(190,211)；跨度135 × 186 px；痕迹矩形高于宽。
