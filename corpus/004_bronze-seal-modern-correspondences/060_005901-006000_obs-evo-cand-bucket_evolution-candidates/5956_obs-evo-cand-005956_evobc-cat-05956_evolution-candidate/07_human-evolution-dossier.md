...
- External category reference: `evobc-cat-05956`
- Source category ID: `05956`
- Source label for human review: `礙`
- Source codepoints: `U+7919`
...
- `obs-evo-cand-005956-route-category-staging`
...
- `obs-evo-cand-005956-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005956-route-evolution-graph`
