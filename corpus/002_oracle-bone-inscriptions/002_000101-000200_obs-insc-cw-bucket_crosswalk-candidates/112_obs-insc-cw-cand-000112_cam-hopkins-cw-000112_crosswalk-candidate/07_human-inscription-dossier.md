...
Project ID: `obs-insc-cw-cand-000112`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000112`
...
- Yingguo / 英国所藏: `y614` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `246` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `412` in source row; primary catalog entry pending
- Heji / 合集: `39927` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000112`
