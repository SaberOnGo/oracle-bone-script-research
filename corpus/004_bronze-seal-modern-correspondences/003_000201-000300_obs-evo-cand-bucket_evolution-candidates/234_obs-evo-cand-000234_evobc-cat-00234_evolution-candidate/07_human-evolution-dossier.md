...
- External category reference: `evobc-cat-00234`
- Source category ID: `00234`
- Source label for human review: `㺇`
- Source codepoints: `U+3E87`
...
- `obs-evo-cand-000234-route-category-staging`
...
- `obs-evo-cand-000234-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000234-route-evolution-graph`
