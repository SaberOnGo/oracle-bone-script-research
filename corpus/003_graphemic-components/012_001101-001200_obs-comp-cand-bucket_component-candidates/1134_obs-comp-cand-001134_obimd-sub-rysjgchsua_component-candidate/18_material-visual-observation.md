# Material Visual Observation / obs-comp-cand-001134 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001134`
- External reference / 外部参照: `obimd-sub-rysjgchsua`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015088_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rysjgchsua/rysjgchsua/rysjgchsua.png`
- Checksum / 校验和:
  `b496301a1753cd5ae3cf2ee95b92f1d2ce832da8503185cf62d9afcc00b5a8c4`
...
- Marked-pixel bounds: (69,37)–(180,218); span 112 × 182 px; the marked
...
- 痕迹范围：(69,37)–(180,218)；跨度112 × 182 px；痕迹矩形高于宽。
