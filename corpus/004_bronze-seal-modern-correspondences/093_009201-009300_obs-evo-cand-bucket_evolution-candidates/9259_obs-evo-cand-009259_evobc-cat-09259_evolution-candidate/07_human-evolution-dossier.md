...
- External category reference: `evobc-cat-09259`
- Source category ID: `09259`
- Source label: `酸`
...
- `obs-evo-cand-009259-route-category-staging`
...
- `obs-evo-cand-009259-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009259-route-evolution-graph`
