# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013568
...
- EVOBC candidate category: `evobc-evo-cat-13568`.
- Source label for search only: `𭱝`.
- Source codepoints for search only: `U+2DC5D`.
