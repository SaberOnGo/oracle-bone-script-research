...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0613`
...
- Source image / 来源图: `G_0613_存2225(甲).png`
- Image / 图像: `001_asset-000544_hust-obc-cat-0613_glyph.png`
...
- target node: `evobc-evo-cat-00041`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/041_obs-evo-cand-000041_evobc-cat-00041_evoluti
...
- Source label text / 来源标签文字: `㙛`
- Source label codepoint / 来源标签 codepoint: `U+365B`
