...
- External category reference: `evobc-cat-03263`
- Source category ID: `03263`
- Source label for human review: `扱`
- Source codepoints: `U+6271`
...
- `obs-evo-cand-003263-route-category-staging`
...
- `obs-evo-cand-003263-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003263-route-evolution-graph`
