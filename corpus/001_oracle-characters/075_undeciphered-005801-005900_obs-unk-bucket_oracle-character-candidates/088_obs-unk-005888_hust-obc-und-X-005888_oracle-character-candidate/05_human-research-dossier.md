# obs-unk-005888 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005888`
- primary external id: `hust-obc-und-X-005888`
...
- local review image route: `corpus/001_oracle-characters/075_undeciphered-005
  801-005900_obs-unk-bucket_oracle-character-candidates/088_obs-unk-005888_h
  ust-obc-und-X-005888_oracle-character-candidate/03_visual-assets/001_asset
  -007480_hust-obc-und-X-005888_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1444/X_？_2339_1.png`
- asset id: `asset-007480`
...
- source class: `HUST-OBC/undeciphered/X/1444/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1444/X_？_2339_1.png`
- asset id: `asset-007480`
...
- Which source records identify obs-unk-005888 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005888？
