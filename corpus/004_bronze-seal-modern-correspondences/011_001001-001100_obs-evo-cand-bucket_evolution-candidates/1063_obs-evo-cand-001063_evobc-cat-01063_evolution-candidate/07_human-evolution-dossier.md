...
- External category reference: `evobc-cat-01063`
- Source category ID: `01063`
- Source label for human review: `儿`
...
- `obs-evo-cand-001063-route-category-staging`
...
- `obs-evo-cand-001063-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001063-route-evolution-graph`
