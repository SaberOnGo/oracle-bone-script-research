...
Project ID: `obs-evo-cand-008822`
...
- Project ID: `obs-evo-cand-008822`
- EVOBC category candidate ID: `evobc-evo-cat-08822`
- External category reference: `evobc-cat-08822`
- Source category ID: `08822`
- Source label for human review: `軾`
- Source codepoints: `U+8EFE`
...
- `obs-evo-cand-008822-route-category-staging`
...
- `obs-evo-cand-008822-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008822-route-evolution-graph`
