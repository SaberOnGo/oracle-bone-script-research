...
Project ID: `obs-evo-cand-009232`
...
- Project ID: `obs-evo-cand-009232`
- EVOBC category candidate ID: `evobc-evo-cat-09232`
- External category reference: `evobc-cat-09232`
- Source category ID: `09232`
- Source label for human review: `酆`
- Source codepoints: `U+9146`
...
- `obs-evo-cand-009232-route-category-staging`
...
- `obs-evo-cand-009232-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009232-route-evolution-graph`
