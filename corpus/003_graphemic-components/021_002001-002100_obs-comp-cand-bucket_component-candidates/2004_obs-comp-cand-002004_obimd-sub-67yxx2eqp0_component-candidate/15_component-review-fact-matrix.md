# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002004
...
| Glyph or codepoint route / 字形或码位路线 | 61 OBIMD route rows; examples U+64D2;U+79BD;U+A59C6;U+FB81C; U+FB81D; 另有 59 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 61 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
