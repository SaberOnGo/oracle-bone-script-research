# obs-char-001572 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1572_obs-char-001572_hust-obc-cat-1764_ora
  cle-character/03_visual-assets/001_asset-001577_hust-obc-cat-1764_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1764/L_1764_8189.jpg`
- asset id: `asset-001577`
...
- source category: `1764`
- validation class: `1571`
- source image route: `HUST-OBC/deciphered/1764/L_1764_8189.jpg`
- asset id: `asset-001577`
...
- English observation: `A faint small cluster preserves a central crossing
  with short parallel strokes.`
- 中文观察: `浅淡小型笔画群保留中央交叉和短平行笔画。`
...
- dataset label text: `㫚`
- dataset label codepoints: `U+3ADA`
...
- Which source records identify obs-char-001572 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001572？
