# obs-char-000324 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/324_obs-char-000324_hust-obc-cat-0366_orac
  le-character/03_visual-assets/001_asset-000329_hust-obc-cat-0366_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0366/G_0366_京津305合9433賓組.png`
- asset id: `asset-000329`
...
- source category: `0366`
- validation class: `323`
- source image route: `HUST-OBC/deciphered/0366/G_0366_京津305合9433賓組.png`
- asset id: `asset-000329`
...
- English observation: `A central upright form is flanked by a small left
  detached enclosure and curved branching strokes on the right.`
- 中文观察: `图像中部为直立形体，左侧有分离的小型闭合轮廓，右侧有弧形分叉笔画。`
...
- dataset label text: `㕤`
- dataset label codepoints: `U+3564`
...
- filename catalog route clues: `Heji-like filename clue: 合9433
  (G_0366_京津305合9433賓組.png)`
...
- Which source records identify obs-char-000324 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000324？
