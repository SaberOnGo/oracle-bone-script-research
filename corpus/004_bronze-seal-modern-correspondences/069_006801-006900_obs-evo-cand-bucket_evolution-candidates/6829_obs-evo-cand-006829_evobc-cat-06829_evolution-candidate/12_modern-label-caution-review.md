# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006829
...
- EVOBC candidate category: `evobc-evo-cat-06829`.
- Source label for search only: `罽`.
- Source codepoints for search only: `U+7F7D`.
