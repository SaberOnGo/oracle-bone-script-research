...
- External category reference: `evobc-cat-10799`
- Source category ID: `10799`
- Source label for human review: `𠉲`
- Source codepoints: `U+20272`
...
- `obs-evo-cand-010799-route-category-staging`
...
- `obs-evo-cand-010799-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010799-route-evolution-graph`
