# Material Visual Observation / obs-comp-cand-002506 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002506`
- External reference / 外部参照: `obimd-sub-fd6c02qezd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020781_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fd6c02qezd/fd6c02qezd/fd6c02qezd.png`
- Checksum / 校验和:
  `82877b3c911e802979ec1300502ef2aadce43e41000229f77bc458d70c22e282`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.97%.
- Marked-pixel bounds: (83,40)–(167,216); span 85 × 177 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.97%。
- 痕迹范围：(83,40)–(167,216)；跨度85 × 177 px；痕迹矩形高于宽。
