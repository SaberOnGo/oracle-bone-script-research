...
- External category reference: `evobc-cat-00152`
- Source category ID: `00152`
- Source label for human review: `㪵`
...
- `obs-evo-cand-000152-route-category-staging`
...
- `obs-evo-cand-000152-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000152-route-evolution-graph`
