...
- External category reference: `evobc-cat-13084`
- Source category ID: `13084`
- Source label for human review: `𫲸`
- Source codepoints: `U+2BCB8`
...
- `obs-evo-cand-013084-route-category-staging`
...
- `obs-evo-cand-013084-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013084-route-evolution-graph`
