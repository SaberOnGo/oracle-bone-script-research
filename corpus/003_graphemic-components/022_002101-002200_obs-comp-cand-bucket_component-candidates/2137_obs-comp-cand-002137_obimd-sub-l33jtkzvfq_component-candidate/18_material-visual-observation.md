# Material Visual Observation / obs-comp-cand-002137 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002137`
- External reference / 外部参照: `obimd-sub-l33jtkzvfq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019694_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3drbkkpjwi/l33jtkzvfq/l33jtkzvfq.png`
- Checksum / 校验和:
  `485564e96b875502eb03bb3170d7904529f24f2e57d5543c5d326523bd8ed0a8`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.29%.
- Marked-pixel bounds: (78,45)–(171,198); span 94 × 154 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.29%。
- 痕迹范围：(78,45)–(171,198)；跨度94 × 154 px；痕迹矩形高于宽。
