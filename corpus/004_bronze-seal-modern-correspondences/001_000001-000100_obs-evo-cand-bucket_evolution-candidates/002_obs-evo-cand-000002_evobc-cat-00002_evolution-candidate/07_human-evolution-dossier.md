...
- External category reference: `evobc-cat-00002`
- Source category ID: `00002`
- Source label for human review: `㐉`
- Source codepoints: `U+3409`
...
- `obs-evo-cand-000002-route-category-staging`
...
- `obs-evo-cand-000002-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000002-route-evolution-graph`
