# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001022
...
| --- | --- | --- | --- |
| `obimd-glyph-link-014812` | 󼺑 | `U+FCE91` | `reviewed_metadata_only` |
| `obimd-glyph-link-014813` | 󼺒 | `U+FCE92` | `reviewed_metadata_only` |
