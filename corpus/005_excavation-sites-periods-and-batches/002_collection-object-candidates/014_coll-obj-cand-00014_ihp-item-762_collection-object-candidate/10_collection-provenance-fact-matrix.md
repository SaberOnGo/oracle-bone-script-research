# Collection Provenance Fact Matrix / 馆藏来源事实矩阵: coll-obj-cand-00014
...
- Use `18_live-source-evidence-review.md` for the page description, hash,
  private visual observation, and no-transcription boundary.
...
| Catalog or accession route / 著录或登记路线 | 762; source-page route only | 02_collection-source-index.csv; 06_human-collection-dossier.md |
| Image or visual route / 图像或视觉路线 | private object image; rights review remains required | 03_visual-asset-index.csv; 04_visual-gallery.md; 18_live-source-evidence-review.md |
| Findspot or provenience / 出土地或来源地 | source-reported Pit 3:H05 and Anyang; independent review pending | 06_human-collection-dossier.md; 08_collection-provenance-evidence-dossier.md |
...
- candidate_collection_object_id: `ihp-mus-obj-00014`
