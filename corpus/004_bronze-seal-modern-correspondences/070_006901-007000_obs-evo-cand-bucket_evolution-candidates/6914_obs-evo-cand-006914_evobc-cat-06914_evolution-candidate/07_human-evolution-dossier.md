...
- External category reference: `evobc-cat-06914`
- Source category ID: `06914`
- Source label for human review: `耊`
- Source codepoints: `U+800A`
...
- `obs-evo-cand-006914-route-category-staging`
...
- `obs-evo-cand-006914-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006914-route-evolution-graph`
