...
Project ID: `obs-insc-cw-cand-000122`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000122`
...
- Source page section: `Period I Group 6` /
  `第 I 期第 6 组`
- Source section key: `period-i-group-6`
- Section declared count: `48`
- Section observed row count: `48`
...
- Yingguo / 英国所藏: `y657` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `110` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `498` in source row; primary catalog entry pending
- Heji / 合集: `39952` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000122`
