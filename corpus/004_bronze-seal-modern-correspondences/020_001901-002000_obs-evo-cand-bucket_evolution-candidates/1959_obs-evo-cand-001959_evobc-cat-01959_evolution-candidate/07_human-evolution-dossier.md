...
- External category reference: `evobc-cat-01959`
- Source category ID: `01959`
- Source label for human review: `壓`
- Source codepoints: `U+58D3`
...
- `obs-evo-cand-001959-route-category-staging`
...
- `obs-evo-cand-001959-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001959-route-evolution-graph`
