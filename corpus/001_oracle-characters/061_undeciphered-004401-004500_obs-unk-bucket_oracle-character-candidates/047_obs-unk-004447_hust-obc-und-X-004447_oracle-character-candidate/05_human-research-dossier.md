# obs-unk-004447 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004447`
- primary external id: `hust-obc-und-X-004447`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/047_obs-unk-004447_h
  ust-obc-und-X-004447_oracle-character-candidate/03_visual-assets/001_asset
  -006040_hust-obc-und-X-004447_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/3/X_？_7202_1.png`
- asset id: `asset-006040`
...
- source class: `HUST-OBC/undeciphered/X/3/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/3/X_？_7202_1.png`
- asset id: `asset-006040`
...
- English observation: `An upper open curve contains a small inner mark`
  `above lower branches.`
- 中文观察: `上部开放弧线含小内部痕迹，位于下部分支之上。`
...
- Which source records identify obs-unk-004447 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004447？
