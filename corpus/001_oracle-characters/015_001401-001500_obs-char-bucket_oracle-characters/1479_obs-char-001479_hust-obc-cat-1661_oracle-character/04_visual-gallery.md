...
- Local image / 本地图像:
  `03_visual-assets/001_asset-001484_hust-obc-cat-1661_glyph.png`
- Local metadata / 本地 metadata:
  `03_visual-assets/001_asset-001484_hust-obc-cat-1661_glyph.yaml`
- Source image path / 来源图像路径:
  `HUST-OBC/deciphered/1661/G_1661_乙6698合10184賓組.png`
