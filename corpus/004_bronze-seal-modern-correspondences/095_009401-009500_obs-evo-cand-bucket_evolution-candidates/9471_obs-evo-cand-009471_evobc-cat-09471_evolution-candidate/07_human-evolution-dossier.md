...
- External category reference: `evobc-cat-09471`
- Source category ID: `09471`
- Source label for human review: `鎆`
...
- `obs-evo-cand-009471-route-category-staging`
...
- `obs-evo-cand-009471-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009471-route-evolution-graph`
