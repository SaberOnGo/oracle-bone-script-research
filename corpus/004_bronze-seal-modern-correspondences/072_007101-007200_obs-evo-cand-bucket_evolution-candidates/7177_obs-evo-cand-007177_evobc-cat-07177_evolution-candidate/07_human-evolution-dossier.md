...
Project ID: `obs-evo-cand-007177`
...
- Project ID: `obs-evo-cand-007177`
- EVOBC category candidate ID: `evobc-evo-cat-07177`
- External category reference: `evobc-cat-07177`
- Source category ID: `07177`
- Source label for human review: `臽`
- Source codepoints: `U+81FD`
...
- `obs-evo-cand-007177-route-category-staging`
...
- `obs-evo-cand-007177-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007177-route-evolution-graph`
