...
Project ID: `obs-evo-cand-010982`
...
- Project ID: `obs-evo-cand-010982`
- EVOBC category candidate ID: `evobc-evo-cat-10982`
- External category reference: `evobc-cat-10982`
- Source category ID: `10982`
- Source label for human review: `𡊍`
- Source codepoints: `U+2128D`
...
- `obs-evo-cand-010982-route-category-staging`
...
- `obs-evo-cand-010982-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010982-route-evolution-graph`
