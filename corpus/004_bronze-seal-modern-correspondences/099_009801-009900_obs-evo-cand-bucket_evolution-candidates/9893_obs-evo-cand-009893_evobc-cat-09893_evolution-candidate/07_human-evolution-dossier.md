...
Project ID: `obs-evo-cand-009893`
...
- Project ID: `obs-evo-cand-009893`
- EVOBC category candidate ID: `evobc-evo-cat-09893`
- External category reference: `evobc-cat-09893`
- Source category ID: `09893`
- Source label for human review: `靪`
- Source codepoints: `U+976A`
...
- `obs-evo-cand-009893-route-category-staging`
...
- `obs-evo-cand-009893-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009893-route-evolution-graph`
