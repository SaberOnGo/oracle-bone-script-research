# Material Visual Observation / obs-comp-cand-001977 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001977`
- External reference / 外部参照: `obimd-sub-dhqar7cnn9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018969_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dhqar7cnn9/dhqar7cnn9/dhqar7cnn9.png`
- Checksum / 校验和:
  `db596be7e035cced7e654740a887f0261ff0a887cf5af62ce993d2a26a9d1935`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.09%.
- Marked-pixel bounds: (36,63)–(202,201); span 167 × 139 px; the marked
  rectangle is wider than tall.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.09%。
- 痕迹范围：(36,63)–(202,201)；跨度167 × 139 px；痕迹矩形宽于高。
