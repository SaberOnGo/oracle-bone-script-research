# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002191
...
- EVOBC candidate category: `evobc-evo-cat-02191`.
- Source label for search only: `婌`.
- Source codepoints for search only: `U+5A4C`.
