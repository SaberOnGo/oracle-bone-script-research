# Material Visual Observation / obs-comp-cand-002603 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002603`
- External reference / 外部参照: `obimd-sub-rc4d2ysdn3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021142_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rc4d2ysdn3/rc4d2ysdn3/rc4d2ysdn3.png`
- Checksum / 校验和:
  `956fa67403d586840d6b9e3cdb80908b4dea088ef21dc6e6dc72fe6b8d5defbc`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.01%.
- Marked-pixel bounds: (65,18)–(190,228); span 126 × 211 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.01%。
- 痕迹范围：(65,18)–(190,228)；跨度126 × 211 px；痕迹矩形高于宽。
