...
- External category reference: `evobc-cat-11501`
- Source category ID: `11501`
- Source label for human review: `𣬚`
...
- `obs-evo-cand-011501-route-category-staging`
...
- `obs-evo-cand-011501-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011501-route-evolution-graph`
