# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012738
...
- EVOBC candidate category: `evobc-evo-cat-12738`.
- Source label for search only: `𪈽`.
- Source codepoints for search only: `U+2A23D`.
