...
- `obs-evo-cand-000513-route-category-staging`
...
- `obs-evo-cand-000513-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000513-route-evolution-graph`
