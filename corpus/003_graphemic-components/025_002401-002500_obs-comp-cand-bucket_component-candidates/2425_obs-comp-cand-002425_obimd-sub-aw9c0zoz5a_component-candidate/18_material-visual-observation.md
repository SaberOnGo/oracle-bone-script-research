# Material Visual Observation / obs-comp-cand-002425 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002425`
- External reference / 外部参照: `obimd-sub-aw9c0zoz5a`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020496_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jpxofd3gmu/aw9c0zoz5a/aw9c0zoz5a.png`
- Checksum / 校验和:
  `bdf10441469816ed928d2fd9a1afaffa71acfa305c84e989f73afc4f8d9ecf64`
...
- Marked-pixel bounds: (76,22)–(173,229); span 98 × 208 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.80%。
- 痕迹范围：(76,22)–(173,229)；跨度98 × 208 px；痕迹矩形高于宽。
