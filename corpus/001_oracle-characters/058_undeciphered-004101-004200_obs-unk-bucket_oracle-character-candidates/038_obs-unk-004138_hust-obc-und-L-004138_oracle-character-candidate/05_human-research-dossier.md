# obs-unk-004138 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/038_obs-unk-004138_h
  ust-obc-und-L-004138_oracle-character-candidate/03_visual-assets/001_asset
  -005731_hust-obc-und-L-004138_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4138/L_？_8941.jpg`
- asset id: `asset-005731`
...
- source class: `HUST-OBC/undeciphered/L/4138/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4138/L_？_8941.jpg`
- asset id: `asset-005731`
...
- English observation: An upper rounded mark sits above a horizontal trace;
  a narrow trace descends below.
- 中文观察：上部圆弧状痕迹位于横向痕迹上方；窄痕迹向下延伸。
...
- Which source records identify obs-unk-004138 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004138？
