...
- Local image / 本地图像:
  `03_visual-assets/001_asset-001172_hust-obc-cat-1307_glyph.png`
- Local metadata / 本地 metadata:
  `03_visual-assets/001_asset-001172_hust-obc-cat-1307_glyph.yaml`
- Source image path / 来源图像路径:
  `HUST-OBC/deciphered/1307/G_1307_續1.14.3合1590賓組.png`
