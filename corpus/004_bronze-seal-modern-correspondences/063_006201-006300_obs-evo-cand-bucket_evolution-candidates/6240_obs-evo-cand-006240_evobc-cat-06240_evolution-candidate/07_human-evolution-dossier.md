...
Project ID: `obs-evo-cand-006240`
...
- Project ID: `obs-evo-cand-006240`
- EVOBC category candidate ID: `evobc-evo-cat-06240`
- External category reference: `evobc-cat-06240`
- Source category ID: `06240`
- Source label for human review: `笪`
- Source codepoints: `U+7B2A`
...
- `obs-evo-cand-006240-route-category-staging`
...
- `obs-evo-cand-006240-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006240-route-evolution-graph`
