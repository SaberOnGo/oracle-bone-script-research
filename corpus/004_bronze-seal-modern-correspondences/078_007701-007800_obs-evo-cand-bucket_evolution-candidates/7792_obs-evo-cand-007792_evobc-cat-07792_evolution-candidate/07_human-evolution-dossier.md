...
- Project ID: `obs-evo-cand-007792`
- EVOBC category candidate ID: `evobc-evo-cat-07792`
- External category reference: `evobc-cat-07792`
- Source category ID: `07792`
- Source label for human review: `蜮`
- Source codepoints: `U+872E`
...
- `obs-evo-cand-007792-route-category-staging`
...
- `obs-evo-cand-007792-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007792-route-evolution-graph`
