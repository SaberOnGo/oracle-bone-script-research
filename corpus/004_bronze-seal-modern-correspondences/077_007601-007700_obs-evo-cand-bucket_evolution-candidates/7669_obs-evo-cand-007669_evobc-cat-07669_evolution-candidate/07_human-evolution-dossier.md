...
- Project ID: `obs-evo-cand-007669`
- EVOBC category candidate ID: `evobc-evo-cat-07669`
- External category reference: `evobc-cat-07669`
- Source category ID: `07669`
- Source label for human review: `蘚`
- Source codepoints: `U+861A`
...
- `obs-evo-cand-007669-route-category-staging`
...
- `obs-evo-cand-007669-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007669-route-evolution-graph`
