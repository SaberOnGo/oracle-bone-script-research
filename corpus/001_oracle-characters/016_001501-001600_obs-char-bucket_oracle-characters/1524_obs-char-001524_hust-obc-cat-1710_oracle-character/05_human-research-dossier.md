# obs-char-001524 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1524_obs-char-001524_hust-obc-cat-1710_ora
  cle-character/03_visual-assets/001_asset-001529_hust-obc-cat-1710_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1710/G_1710_京津4499(甲).png`
- asset id: `asset-001529`
...
- source category: `1710`
- validation class: `1523`
- source image route: `HUST-OBC/deciphered/1710/G_1710_京津4499(甲).png`
- asset id: `asset-001529`
...
- dataset label text: `㪤`
- dataset label codepoints: `U+3AA4`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00151`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00151`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00151`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/151_obs-evo-can
  d-000151_evobc-cat-00151_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/151_obs-evo-cand-000151_evobc-cat-00151_evolu
...
- Which source records identify obs-char-001524 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001524？
