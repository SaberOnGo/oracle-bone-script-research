# Material Visual Observation / obs-comp-cand-001544 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001544`
- External reference / 外部参照: `obimd-sub-xrcbuiyv4q`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016958_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8t2hy7hbrc/xrcbuiyv4q/xrcbuiyv4q.png`
- Checksum / 校验和:
  `2664983f3c3ff408aa9e444f39fb1d6cff09e221de2343b1690759a3ea8e6ed8`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.66%.
- Marked-pixel bounds: (85,31)–(171,223); span 87 × 193 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.66%。
- 痕迹范围：(85,31)–(171,223)；跨度87 × 193 px；痕迹矩形高于宽。
