...
- Project ID: `obs-evo-cand-010175`
- EVOBC category candidate ID: `evobc-evo-cat-10175`
- External category reference: `evobc-cat-10175`
- Source category ID: `10175`
- Source label for human review: `駃`
- Source codepoints: `U+99C3`
...
- `obs-evo-cand-010175-route-category-staging`
...
- `obs-evo-cand-010175-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010175-route-evolution-graph`
