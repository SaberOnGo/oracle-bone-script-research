...
- External category reference: `evobc-cat-07521`
- Source category ID: `07521`
- Source label for human review: `蓇`
...
- `obs-evo-cand-007521-route-category-staging`
...
- `obs-evo-cand-007521-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007521-route-evolution-graph`
