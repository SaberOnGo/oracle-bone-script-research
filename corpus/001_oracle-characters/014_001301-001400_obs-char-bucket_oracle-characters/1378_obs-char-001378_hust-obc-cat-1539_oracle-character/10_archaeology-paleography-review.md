# obs-char-001378 Archaeology Paleography Review

# obs-char-001378 考古文字复核档案
...
- first local image: `001_asset-001383_hust-obc-cat-1539_glyph.png`
- first source image: `G_1539_續3.30.7(甲).png`
...
- source label text: `㧹`
- source label codepoints: `U+39F9`
