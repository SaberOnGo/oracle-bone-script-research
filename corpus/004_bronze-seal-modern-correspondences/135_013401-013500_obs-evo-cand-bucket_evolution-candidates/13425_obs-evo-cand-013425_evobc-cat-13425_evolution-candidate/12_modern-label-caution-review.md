# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013425
...
- EVOBC candidate category: `evobc-evo-cat-13425`.
- Source label for search only: `𬰪`.
- Source codepoints for search only: `U+2CC2A`.
