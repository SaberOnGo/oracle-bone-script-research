...
- `obs-evo-cand-007739-route-category-staging`
...
- `obs-evo-cand-007739-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007739-route-evolution-graph`
