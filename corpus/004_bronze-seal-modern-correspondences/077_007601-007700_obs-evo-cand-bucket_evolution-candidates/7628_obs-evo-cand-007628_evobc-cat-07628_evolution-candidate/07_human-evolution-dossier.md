...
Project ID: `obs-evo-cand-007628`
...
- Project ID: `obs-evo-cand-007628`
- EVOBC category candidate ID: `evobc-evo-cat-07628`
- External category reference: `evobc-cat-07628`
- Source category ID: `07628`
- Source label for human review: `薻`
- Source codepoints: `U+85BB`
...
- `obs-evo-cand-007628-route-category-staging`
...
- `obs-evo-cand-007628-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007628-route-evolution-graph`
