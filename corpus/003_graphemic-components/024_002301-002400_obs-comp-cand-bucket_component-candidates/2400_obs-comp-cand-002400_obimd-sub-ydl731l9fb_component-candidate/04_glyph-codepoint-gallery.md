# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002400
...
| --- | --- | --- | --- |
| `obimd-glyph-link-036815` | 󽭣 | `U+FDB63` | `reviewed_metadata_only` |
| `obimd-glyph-link-036816` | 󽭤 | `U+FDB64` | `reviewed_metadata_only` |
