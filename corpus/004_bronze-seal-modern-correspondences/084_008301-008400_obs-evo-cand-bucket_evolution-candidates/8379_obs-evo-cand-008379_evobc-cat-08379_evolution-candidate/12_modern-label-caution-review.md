# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008379
...
- EVOBC candidate category: `evobc-evo-cat-08379`.
- Source label for search only: `譻`.
- Source codepoints for search only: `U+8B7B`.
