# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002490
...
- EVOBC candidate category: `evobc-evo-cat-02490`.
- Source label for search only: `尻`.
- Source codepoints for search only: `U+5C3B`.
