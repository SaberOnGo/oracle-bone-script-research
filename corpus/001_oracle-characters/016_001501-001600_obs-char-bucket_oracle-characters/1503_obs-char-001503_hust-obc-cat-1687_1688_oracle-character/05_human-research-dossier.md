# obs-char-001503 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001503`
- primary external id: `hust-obc-cat-1687_1688`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1503_obs-char-001503_hust-obc-cat-1687_168
  8_oracle-character/03_visual-assets/001_asset-001508_hust-obc-cat-1687_168
  8_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1687_1688/1687/G_1687_前3.31.2合5
  825賓組.png`
- asset id: `asset-001508`
...
- source category: `1687_1688`
- validation class: `1502`
- source image route: `HUST-OBC/deciphered/1687_1688/1687/G_1687_前3.31.2合5825賓
  組.png`
- asset id: `asset-001508`
...
- English observation: `A narrow glyph is formed by two close parallel
  strokes with a small forked upper end.`
- 中文观察: `狭长字形由两条相近平行笔画和小型分叉上端构成。`
...
- dataset label text: `㪍㪎`
- dataset label codepoints: `U+3A8D;U+3A8E`
...
- graph edge count: `2`
- codepoint routes: `U+3A8D;U+3A8E`
...
- filename catalog route clues: `Heji-like filename clue: 合5825
  (G_1687_前3.31.2合5825賓組.png)`
...
- Which source records identify obs-char-001503 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001503？
