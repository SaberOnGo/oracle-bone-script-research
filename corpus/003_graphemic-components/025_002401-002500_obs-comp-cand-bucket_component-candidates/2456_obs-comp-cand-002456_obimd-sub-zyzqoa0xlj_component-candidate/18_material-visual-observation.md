# Material Visual Observation / obs-comp-cand-002456 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002456`
- External reference / 外部参照: `obimd-sub-zyzqoa0xlj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020641_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zyzqoa0xlj/zyzqoa0xlj/zyzqoa0xlj.png`
- Checksum / 校验和:
  `ec5950c4e3786de0cf2ce577184885bfd4f4be3575e09f85a0b0865538574065`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.32%.
- Marked-pixel bounds: (38,43)–(212,218); span 175 × 176 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.32%。
- 痕迹范围：(38,43)–(212,218)；跨度175 × 176 px；痕迹矩形近方形。
