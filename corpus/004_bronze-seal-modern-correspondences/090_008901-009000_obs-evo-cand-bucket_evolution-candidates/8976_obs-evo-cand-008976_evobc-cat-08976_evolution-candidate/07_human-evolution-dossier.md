...
- External category reference: `evobc-cat-08976`
- Source category ID: `08976`
- Source label for human review: `追`
...
- `obs-evo-cand-008976-route-category-staging`
...
- `obs-evo-cand-008976-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008976-route-evolution-graph`
