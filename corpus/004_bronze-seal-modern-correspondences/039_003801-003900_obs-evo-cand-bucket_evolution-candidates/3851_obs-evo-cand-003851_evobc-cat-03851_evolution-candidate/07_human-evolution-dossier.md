...
Project ID: `obs-evo-cand-003851`
...
- Project ID: `obs-evo-cand-003851`
- EVOBC category candidate ID: `evobc-evo-cat-03851`
- External category reference: `evobc-cat-03851`
- Source category ID: `03851`
- Source label for human review: `札`
- Source codepoints: `U+672D`
...
- `obs-evo-cand-003851-route-category-staging`
...
- `obs-evo-cand-003851-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003851-route-evolution-graph`
