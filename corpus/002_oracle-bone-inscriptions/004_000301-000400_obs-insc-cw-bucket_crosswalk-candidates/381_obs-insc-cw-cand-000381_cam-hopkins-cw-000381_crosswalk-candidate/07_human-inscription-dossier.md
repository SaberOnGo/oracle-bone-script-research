...
- Yingguo / 英国所藏: `y2134` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `466` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `39` in source row; primary catalog entry pending
