# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008853
...
- EVOBC candidate category: `evobc-evo-cat-08853`.
- Source label for search only: `輯`.
- Source codepoints for search only: `U+8F2F`.
