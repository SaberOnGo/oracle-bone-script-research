# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008154
...
- EVOBC candidate category: `evobc-evo-cat-08154`.
- Source label for search only: `設`.
- Source codepoints for search only: `U+8A2D`.
