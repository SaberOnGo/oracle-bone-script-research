# Material Visual Observation / obs-comp-cand-000231 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000231`
- External reference / 外部参照: `obimd-sub-2i3zpwl5a9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011878_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2i3zpwl5a9/2i3zpwl5a9/2i3zpwl5a9.png`
- Checksum / 校验和:
  `116e87844426c80737f18109759a4d75643196fcc14cf9333d39250bac68bfd4`
...
- Marked-pixel bounds: (70,38)–(179,211); span 110 × 174 px; the marked
...
- 痕迹范围：(70,38)–(179,211)；跨度110 × 174 px；痕迹矩形高于宽。
