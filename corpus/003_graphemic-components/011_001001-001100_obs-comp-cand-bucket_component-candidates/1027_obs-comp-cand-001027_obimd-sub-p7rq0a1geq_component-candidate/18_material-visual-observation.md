# Material Visual Observation / obs-comp-cand-001027 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001027`
- External reference / 外部参照: `obimd-sub-p7rq0a1geq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014520_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/p7rq0a1geq/p7rq0a1geq/p7rq0a1geq.png`
- Checksum / 校验和:
  `773c5624551294d18e8aff2ad57560c93d7e623d7086c3ad5a2f463579ba12c7`
...
- Marked-pixel bounds: (81,29)–(179,222); span 99 × 194 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.44%。
- 痕迹范围：(81,29)–(179,222)；跨度99 × 194 px；痕迹矩形高于宽。
