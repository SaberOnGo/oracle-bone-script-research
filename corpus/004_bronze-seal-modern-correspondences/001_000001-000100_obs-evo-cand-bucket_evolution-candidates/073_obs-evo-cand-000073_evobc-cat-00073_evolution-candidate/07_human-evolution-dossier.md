...
- Project ID: `obs-evo-cand-000073`
- EVOBC category candidate ID: `evobc-evo-cat-00073`
- External category reference: `evobc-cat-00073`
- Source category ID: `00073`
- Source label for human review: `㝩`
- Source codepoints: `U+3769`
...
- `obs-evo-cand-000073-route-category-staging`
...
- `obs-evo-cand-000073-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000073-route-evolution-graph`
