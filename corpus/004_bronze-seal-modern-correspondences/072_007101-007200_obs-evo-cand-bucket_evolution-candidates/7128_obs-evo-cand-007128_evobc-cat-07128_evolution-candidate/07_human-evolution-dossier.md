...
Project ID: `obs-evo-cand-007128`
...
- Project ID: `obs-evo-cand-007128`
- EVOBC category candidate ID: `evobc-evo-cat-07128`
- External category reference: `evobc-cat-07128`
- Source category ID: `07128`
- Source label for human review: `膞`
- Source codepoints: `U+819E`
...
- `obs-evo-cand-007128-route-category-staging`
...
- `obs-evo-cand-007128-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007128-route-evolution-graph`
