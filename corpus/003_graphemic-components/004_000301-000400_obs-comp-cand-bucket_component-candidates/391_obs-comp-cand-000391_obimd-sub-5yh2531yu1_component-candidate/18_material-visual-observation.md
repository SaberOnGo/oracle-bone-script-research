# Material Visual Observation / obs-comp-cand-000391 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000391`
- External reference / 外部参照: `obimd-sub-5yh2531yu1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012314_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kn438rbkpd/5yh2531yu1/5yh2531yu1.png`
- Checksum / 校验和:
  `2d3f491d294fd05a43aa49be0dd029ca5a20c97a731017d18d030c09a3ee193f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.45%.
- Marked-pixel bounds: (80,21)–(169,227); span 90 × 207 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.45%。
- 痕迹范围：(80,21)–(169,227)；跨度90 × 207 px；痕迹矩形高于宽。
