...
- External category reference: `evobc-cat-10341`
- Source category ID: `10341`
- Source label for human review: `鬭`
- Source codepoints: `U+9B2D`
...
- `obs-evo-cand-010341-route-category-staging`
...
- `obs-evo-cand-010341-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010341-route-evolution-graph`
