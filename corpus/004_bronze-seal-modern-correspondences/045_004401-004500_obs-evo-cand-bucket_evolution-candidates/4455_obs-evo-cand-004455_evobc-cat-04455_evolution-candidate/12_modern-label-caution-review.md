# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004455
...
- EVOBC candidate category: `evobc-evo-cat-04455`.
- Source label for search only: `毛`.
- Source codepoints for search only: `U+6BDB`.
