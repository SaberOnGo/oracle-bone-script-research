...
- `corpus/001_oracle-characters/017_undeciphered-000001-000100_obs-unk-bucket_oracle-character-candidates/000_hust-obc-undeciphered-candidate-bucket-manifest.csv`: first 100 HUST-OBC undeciphered candidate packet manifest. The packet files preserve source class paths and image counts only; no raw images are committed.
...
- `corpus/001_oracle-characters/017_undeciphered-000001-000100_obs-unk-bucket_oracle-character-candidates/000_hust-obc-undeciphered-candidate-bucket-manifest.csv`：前 100 个 HUST-OBC 未释读候选资料包 manifest。packet 文件只保留来源类别路径和图像数量，不提交原始图片。
