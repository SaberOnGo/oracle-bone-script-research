...
- Review log draft ID / 复核日志草稿 ID: `codepoint-crosswalk-review-log-draft-006`
- Codepoint review task ID / codepoint 复核任务 ID: `codepoint-crosswalk-review-006`
...
- Crosswalk candidate ID / 交叉候选 ID: `hust-obimd-evobc-xwalk-000621`
- Suggested oracle character ID / 建议甲骨单字 ID: `obs-char-000621`
- Promotion queue ID / 提升队列 ID: `hust-obc-obs-char-promo-000621`
...
- HUST external ref / HUST 外部引用: `hust-obc-cat-0706`
- HUST label codepoints / HUST 标签 codepoint: `U+36B8`
- OBIMD main candidates / OBIMD 主字候选: `obimd-main-cand-001412`
- EVOBC category candidates / EVOBC 类别候选: `evobc-evo-cat-00049`
...
- `corpus/001_oracle-characters/007_000601-000700_obs-char-bucket_oracle-characters/001_hust-obc-candidate-packet-manifest.csv`
- `corpus/001_oracle-characters/007_000601-000700_obs-char-bucket_oracle-characters/621_obs-char-000621_hust-obc-cat-0706_oracle-character/01_candidate-character-packet.json`
...
- Route availability ID: `codepoint-route-availability-006`
...
- Review task ID: `codepoint-crosswalk-review-006`
- Crosswalk candidate ID: `hust-obimd-evobc-xwalk-000621`
- Suggested oracle character ID: `obs-char-000621`
- HUST candidate packet ID: `hust-obc-candidate-packet-000621`
...
- OBIMD row count: `1`
- OBIMD source UIDs: `1mkqz99m8b`
- OBIMD review statuses: `obimd-main-cand-001412=reviewed_metadata_only`
- OBIMD rights statuses: `obimd-main-cand-001412=licensed_for_repository`
- EVOBC row count: `1`
- EVOBC source category IDs: `00049`
- EVOBC has bronze refs: `true`
- EVOBC has seal refs: `false`
- EVOBC review statuses: `evobc-evo-cat-00049=reviewed_metadata_only`
- EVOBC rights statuses: `evobc-evo-cat-00049=source_marked_risk_noted`
...
- Does `hust-obimd-evobc-xwalk-000621` remain unpromoted and undeciphered?
