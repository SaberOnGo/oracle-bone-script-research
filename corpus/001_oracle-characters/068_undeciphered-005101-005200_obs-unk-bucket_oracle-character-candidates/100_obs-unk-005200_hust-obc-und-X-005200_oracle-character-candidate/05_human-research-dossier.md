# obs-unk-005200 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/068_undeciphered-005
  101-005200_obs-unk-bucket_oracle-character-candidates/100_obs-unk-005200_h
  ust-obc-und-X-005200_oracle-character-candidate/03_visual-assets/001_asset
  -006793_hust-obc-und-X-005200_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/756/X_？_7720_1.png`
- asset id: `asset-006793`
...
- source class: `HUST-OBC/undeciphered/X/756/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/756/X_？_7720_1.png`
- asset id: `asset-006793`
...
- Which source records identify obs-unk-005200 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005200？
