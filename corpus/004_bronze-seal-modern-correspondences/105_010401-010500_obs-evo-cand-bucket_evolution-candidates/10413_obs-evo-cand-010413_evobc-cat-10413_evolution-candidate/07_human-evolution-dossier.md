...
Project ID: `obs-evo-cand-010413`
...
- Project ID: `obs-evo-cand-010413`
- EVOBC category candidate ID: `evobc-evo-cat-10413`
- External category reference: `evobc-cat-10413`
- Source category ID: `10413`
- Source label for human review: `鯕`
- Source codepoints: `U+9BD5`
...
- `obs-evo-cand-010413-route-category-staging`
...
- `obs-evo-cand-010413-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010413-route-evolution-graph`
