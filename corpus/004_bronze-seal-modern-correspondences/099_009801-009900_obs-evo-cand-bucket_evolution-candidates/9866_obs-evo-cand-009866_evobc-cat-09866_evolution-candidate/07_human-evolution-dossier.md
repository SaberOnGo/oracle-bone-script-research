...
- Project ID: `obs-evo-cand-009866`
- EVOBC category candidate ID: `evobc-evo-cat-09866`
- External category reference: `evobc-cat-09866`
- Source category ID: `09866`
- Source label for human review: `霢`
- Source codepoints: `U+9722`
...
- `obs-evo-cand-009866-route-category-staging`
...
- `obs-evo-cand-009866-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009866-route-evolution-graph`
