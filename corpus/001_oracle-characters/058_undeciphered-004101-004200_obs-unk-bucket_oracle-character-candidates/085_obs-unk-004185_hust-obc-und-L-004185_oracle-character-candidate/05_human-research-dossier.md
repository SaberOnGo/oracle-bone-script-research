# obs-unk-004185 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/085_obs-unk-004185_h
  ust-obc-und-L-004185_oracle-character-candidate/03_visual-assets/001_asset
  -005778_hust-obc-und-L-004185_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4185/L_？_9085.jpg`
- asset id: `asset-005778`
...
- source class: `HUST-OBC/undeciphered/L/4185/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4185/L_？_9085.jpg`
- asset id: `asset-005778`
...
- English observation: `Upper forked strokes and a vertical mark; two lower
strokes diverge.`
- 中文观察: `上部分叉笔画和中央纵向痕迹可见；下部有两条分开的
笔画。`
...
- Which source records identify obs-unk-004185 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004185？
