# Material Visual Observation / obs-comp-cand-001785 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001785`
- External reference / 外部参照: `obimd-sub-7l5l1f4dh8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018006_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7l5l1f4dh8/7l5l1f4dh8/7l5l1f4dh8.png`
- Checksum / 校验和:
  `ef0c95b5428a52d7c6f72e7d0d5c81d2b8c1d2c85236e77e43f7588de580abe7`
...
- Marked-pixel bounds: (82,34)–(168,202); span 87 × 169 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.49%。
- 痕迹范围：(82,34)–(168,202)；跨度87 × 169 px；痕迹矩形高于宽。
