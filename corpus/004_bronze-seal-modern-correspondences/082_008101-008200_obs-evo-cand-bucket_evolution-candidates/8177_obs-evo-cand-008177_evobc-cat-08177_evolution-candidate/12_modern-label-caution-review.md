# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008177
...
- EVOBC candidate category: `evobc-evo-cat-08177`.
- Source label for search only: `詓`.
- Source codepoints for search only: `U+8A53`.
