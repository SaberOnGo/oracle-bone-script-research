# obs-unk-004170 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/070_obs-unk-004170_h
  ust-obc-und-L-004170_oracle-character-candidate/03_visual-assets/001_asset
  -005763_hust-obc-und-L-004170_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4170/L_？_9036.jpg`
- asset id: `asset-005763`
...
- source class: `HUST-OBC/undeciphered/L/4170/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4170/L_？_9036.jpg`
- asset id: `asset-005763`
...
- English observation: A vertical chain of small loops stands beside a long
  upright stroke.
- 中文观察: 一列小环状痕迹旁有一条较长直立笔画。
...
- Which source records identify obs-unk-004170 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004170？
