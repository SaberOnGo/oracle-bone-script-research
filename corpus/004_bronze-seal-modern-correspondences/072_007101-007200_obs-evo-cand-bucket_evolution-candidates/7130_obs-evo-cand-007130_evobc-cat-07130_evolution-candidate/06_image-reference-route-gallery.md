...
- `obs-evo-cand-007130-route-category-staging`
...
- `obs-evo-cand-007130-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007130-route-evolution-graph`
