# obs-unk-004621 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004621`
- primary external id: `hust-obc-und-X-004621`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/021_obs-unk-004621_h
  ust-obc-und-X-004621_oracle-character-candidate/03_visual-assets/001_asset
  -006214_hust-obc-und-X-004621_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/177/X_？_8352_1.png`
- asset id: `asset-006214`
...
- source class: `HUST-OBC/undeciphered/X/177/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/177/X_？_8352_1.png`
- asset id: `asset-006214`
...
- English observation: `central crossbar, upper curves, lower opening`
- 中文观察: `中央横痕、上部弯曲痕和下部开口已记录。`
...
- Which source records identify obs-unk-004621 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004621？
