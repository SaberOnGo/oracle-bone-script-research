# Material Visual Observation / obs-comp-cand-000911 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000911`
- External reference / 外部参照: `obimd-sub-7p7pi5fxkj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013983_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7p7pi5fxkj/7p7pi5fxkj/7p7pi5fxkj.png`
- Checksum / 校验和:
  `5b4542dbb5336f1a17808f4e0ded85f80fdc58e52cc460d7e8080ecd92ec5bfe`
...
- Marked-pixel bounds: (67,27)–(181,225); span 115 × 199 px; the marked
...
- 痕迹范围：(67,27)–(181,225)；跨度115 × 199 px；痕迹矩形高于宽。
