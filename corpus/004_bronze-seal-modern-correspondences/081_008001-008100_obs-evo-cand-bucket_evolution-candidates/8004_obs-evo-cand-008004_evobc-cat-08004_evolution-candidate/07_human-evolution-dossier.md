...
- External category reference: `evobc-cat-08004`
- Source category ID: `08004`
- Source label for human review: `褍`
...
- `obs-evo-cand-008004-route-category-staging`
...
- `obs-evo-cand-008004-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008004-route-evolution-graph`
