# obs-unk-004107 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004107`
- primary external id: `hust-obc-und-L-004107`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/007_obs-unk-004107_h
  ust-obc-und-L-004107_oracle-character-candidate/03_visual-assets/001_asset
  -005700_hust-obc-und-L-004107_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4107/L_？_8843.jpg`
- asset id: `asset-005700`
...
- source class: `HUST-OBC/undeciphered/L/4107/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4107/L_？_8843.jpg`
- asset id: `asset-005700`
...
- English observation: A compact rounded upper form sits above a narrow
  spine; lower strokes curve outward and a right tail descends.
- 中文观察：上部为紧凑圆弧形态，下接窄主干；下部外弯，右侧有下伸尾笔。
...
- Which source records identify obs-unk-004107 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004107？
