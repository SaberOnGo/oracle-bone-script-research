# Material Visual Observation / obs-comp-cand-001874 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001874`
- External reference / 外部参照: `obimd-sub-70z2ecqnoc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018253_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lfox6x1ojm/70z2ecqnoc/70z2ecqnoc.png`
- Checksum / 校验和:
  `b228aea5909476206a0f39ee201e917780c2df18b01b7587fde82da892cdac02`
...
- Marked-pixel bounds: (42,24)–(220,224); span 179 × 201 px; the marked
...
- 痕迹范围：(42,24)–(220,224)；跨度179 × 201 px；痕迹矩形近方形。
