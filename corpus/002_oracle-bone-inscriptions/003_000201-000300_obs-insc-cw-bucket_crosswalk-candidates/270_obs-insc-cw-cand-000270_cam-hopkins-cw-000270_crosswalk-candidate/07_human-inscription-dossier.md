...
- Yingguo / 英国所藏: `y1813` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `247` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `739` in source row; primary catalog entry pending
- Heji / 合集: `40825` in source row; primary catalog entry pending
