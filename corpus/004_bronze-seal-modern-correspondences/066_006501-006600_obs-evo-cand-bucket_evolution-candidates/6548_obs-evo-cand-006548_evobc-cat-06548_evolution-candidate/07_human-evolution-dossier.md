...
- Project ID: `obs-evo-cand-006548`
- EVOBC category candidate ID: `evobc-evo-cat-06548`
- External category reference: `evobc-cat-06548`
- Source category ID: `06548`
- Source label for human review: `綠`
- Source codepoints: `U+7DA0`
...
- `obs-evo-cand-006548-route-category-staging`
...
- `obs-evo-cand-006548-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006548-route-evolution-graph`
