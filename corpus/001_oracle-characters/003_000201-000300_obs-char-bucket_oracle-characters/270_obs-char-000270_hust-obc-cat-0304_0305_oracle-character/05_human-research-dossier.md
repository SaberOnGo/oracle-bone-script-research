# obs-char-000270 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/270_obs-char-000270_hust-obc-cat-0304_0305
  _oracle-character/03_visual-assets/001_asset-000275_hust-obc-cat-0304_0305
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0304_0305/0304/G_0304_甲骨文.png`
- asset id: `asset-000275`
...
- source category: `0304_0305`
- validation class: `269`
- source image route: `HUST-OBC/deciphered/0304_0305/0304/G_0304_甲骨文.png`
- asset id: `asset-000275`
...
- English observation: `The narrow image shows a long upright stroke, a
  short side branch near the top, and a small curved terminal at the lower
  end.`
- 中文观察: `狭长图像有长竖向笔画，上部附近有短侧分支，下端有小型弯曲收笔。`
...
- dataset label text: `㔦㔧`
- dataset label codepoints: `U+3526;U+3527`
...
- Which source records identify obs-char-000270 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000270？
