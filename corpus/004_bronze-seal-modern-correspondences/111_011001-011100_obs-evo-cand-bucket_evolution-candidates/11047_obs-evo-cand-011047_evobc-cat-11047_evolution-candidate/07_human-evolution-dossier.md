...
- Project ID: `obs-evo-cand-011047`
- EVOBC category candidate ID: `evobc-evo-cat-11047`
- External category reference: `evobc-cat-11047`
- Source category ID: `11047`
- Source label for human review: `𡡊`
- Source codepoints: `U+2184A`
...
- `obs-evo-cand-011047-route-category-staging`
...
- `obs-evo-cand-011047-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011047-route-evolution-graph`
