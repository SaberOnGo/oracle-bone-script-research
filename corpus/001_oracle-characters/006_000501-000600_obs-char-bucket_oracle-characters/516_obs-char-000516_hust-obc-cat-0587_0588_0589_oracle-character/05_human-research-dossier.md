# obs-char-000516 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000516`
- primary external id: `hust-obc-cat-0587_0588_0589`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/516_obs-char-000516_hust-obc-cat-0587_0588
  _0589_oracle-character/03_visual-assets/001_asset-000521_hust-obc-cat-0587
  _0588_0589_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0587_0588_0589/0587/G_0587_前7.3
  3.1(甲).png`
- asset id: `asset-000521`
...
- source category: `0587_0588_0589`
- validation class: `515`
- source image route: `HUST-OBC/deciphered/0587_0588_0589/0587/G_0587_前7.33.1(
  甲).png`
- asset id: `asset-000521`
...
- English observation: `A curved central stem has one long upper-left branch
  and two long diverging lower strokes, with two detached short marks inside
  the right side.`
- 中文观察: `弯曲中央干带一条长左上分支和两条分向下部的长笔，右侧内部另有两处分离短痕。`
...
- dataset label text: `㙁㙂㙃`
- dataset label codepoints: `U+3641;U+3642;U+3643`
...
- graph edge count: `2`
- codepoint routes: `U+3641;U+3642;U+3643`
...
- Which source records identify obs-char-000516 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000516？
