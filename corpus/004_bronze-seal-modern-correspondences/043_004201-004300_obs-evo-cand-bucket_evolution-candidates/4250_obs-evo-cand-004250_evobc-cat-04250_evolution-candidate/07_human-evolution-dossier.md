...
Project ID: `obs-evo-cand-004250`
...
- Project ID: `obs-evo-cand-004250`
- EVOBC category candidate ID: `evobc-evo-cat-04250`
- External category reference: `evobc-cat-04250`
- Source category ID: `04250`
- Source label for human review: `樲`
- Source codepoints: `U+6A32`
...
- `obs-evo-cand-004250-route-category-staging`
...
- `obs-evo-cand-004250-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004250-route-evolution-graph`
