...
- `obs-evo-cand-012896-route-category-staging`
...
- `obs-evo-cand-012896-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012896-route-evolution-graph`
