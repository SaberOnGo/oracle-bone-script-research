...
- External category reference: `evobc-cat-11919`
- Source category ID: `11919`
- Source label: `𥹴`
...
- `obs-evo-cand-011919-route-category-staging`
...
- `obs-evo-cand-011919-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-011919-route-evolution-graph`
