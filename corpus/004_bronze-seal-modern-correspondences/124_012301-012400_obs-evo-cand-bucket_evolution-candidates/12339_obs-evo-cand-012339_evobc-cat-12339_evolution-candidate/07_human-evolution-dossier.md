...
- External category reference: `evobc-cat-12339`
- Source category ID: `12339`
- Source label for human review: `𨑒`
- Source codepoints: `U+28452`
- Image reference count in source metadata: `16`
...
- `obs-evo-cand-012339-route-category-staging`
...
- `obs-evo-cand-012339-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012339-route-evolution-graph`
