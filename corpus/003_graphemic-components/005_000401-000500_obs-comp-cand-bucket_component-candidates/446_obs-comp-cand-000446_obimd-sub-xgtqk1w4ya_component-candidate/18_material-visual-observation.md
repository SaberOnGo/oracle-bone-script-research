# Material Visual Observation / obs-comp-cand-000446 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000446`
- External reference / 外部参照: `obimd-sub-xgtqk1w4ya`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012369_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xgtqk1w4ya/xgtqk1w4ya/xgtqk1w4ya.png`
- Checksum / 校验和:
  `5332f7646428ee689cff724cf9b3a819655690bf4d47a7cef32bf42e89fdc4ab`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.08%.
- Marked-pixel bounds: (77,16)–(170,232); span 94 × 217 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.08%。
- 痕迹范围：(77,16)–(170,232)；跨度94 × 217 px；痕迹矩形高于宽。
