...
- Project ID: `obs-evo-cand-012254`
- EVOBC category candidate ID: `evobc-evo-cat-12254`
- External category reference: `evobc-cat-12254`
- Source category ID: `12254`
- Source label for human review: `𧬳`
- Source codepoints: `U+27B33`
...
- `obs-evo-cand-012254-route-category-staging`
...
- `obs-evo-cand-012254-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012254-route-evolution-graph`
