...
- Project ID / 项目 ID: `obs-char-001284`
- Primary external ID / 首选外部 ID: `hust-obc-cat-1436`
...
- Source image / 来源图: `G_1436_合28319(甲).png`
- Image / 图像: `001_asset-001289_hust-obc-cat-1436_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合28319
  (G_1436_合28319(甲).png)`
...
- Source label text / 来源标签文字: `㦒`
- Source label codepoint / 来源标签 codepoint: `U+3992`
