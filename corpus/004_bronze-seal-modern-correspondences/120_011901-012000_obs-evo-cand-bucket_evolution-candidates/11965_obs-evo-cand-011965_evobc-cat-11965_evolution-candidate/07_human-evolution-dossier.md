...
- External category reference: `evobc-cat-11965`
- Source category ID: `11965`
- Source label for human review: `𦃼`
...
- `obs-evo-cand-011965-route-category-staging`
...
- `obs-evo-cand-011965-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011965-route-evolution-graph`
