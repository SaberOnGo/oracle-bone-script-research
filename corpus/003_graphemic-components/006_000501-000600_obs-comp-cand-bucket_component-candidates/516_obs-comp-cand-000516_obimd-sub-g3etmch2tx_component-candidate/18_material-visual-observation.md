# Material Visual Observation / obs-comp-cand-000516 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000516`
- External reference / 外部参照: `obimd-sub-g3etmch2tx`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012751_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/g3etmch2tx/g3etmch2tx/g3etmch2tx.png`
- Checksum / 校验和:
  `c37db004286c6abb53f34007c24b7b1e03d835296ac778fafcd86347f2b35432`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.41%.
- Marked-pixel bounds: (71,28)–(178,216); span 108 × 189 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.41%。
- 痕迹范围：(71,28)–(178,216)；跨度108 × 189 px；痕迹矩形高于宽。
