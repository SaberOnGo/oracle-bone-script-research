...
- External category reference: `evobc-cat-05850`
- Source category ID: `05850`
- Source label for human review: `瞗`
...
- `obs-evo-cand-005850-route-category-staging`
...
- `obs-evo-cand-005850-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005850-route-evolution-graph`
