# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000993
...
| --- | --- | --- | --- |
| `obimd-glyph-link-014384` | 𪪶󵨲 | `U+2AAB6;U+F5A32` | `reviewed_metadata_only` |
| `obimd-glyph-link-014385` | 󵨳 | `U+F5A33` | `reviewed_metadata_only` |
