# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006516
...
- EVOBC candidate category: `evobc-evo-cat-06516`.
- Source label for search only: `給`.
- Source codepoints for search only: `U+7D66`.
