# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008256
...
- EVOBC candidate category: `evobc-evo-cat-08256`.
- Source label for search only: `調`.
- Source codepoints for search only: `U+8ABF`.
