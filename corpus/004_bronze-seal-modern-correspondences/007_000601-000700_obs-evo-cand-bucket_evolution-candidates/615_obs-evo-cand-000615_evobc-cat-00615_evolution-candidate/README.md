# obs-evo-cand-000615 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-00615`
- Source label: `丏`
- Source codepoints: `U+4E0F`
- Image reference count: `36`
- Era token counts: `BI:9;OBC:12;WSC:15`
- Source token counts: `Book:30;Web:6`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 12 image references
