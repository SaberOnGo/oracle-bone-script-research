...
Project ID: `obs-evo-cand-010311`
...
- Project ID: `obs-evo-cand-010311`
- EVOBC category candidate ID: `evobc-evo-cat-10311`
- External category reference: `evobc-cat-10311`
- Source category ID: `10311`
- Source label for human review: `髡`
- Source codepoints: `U+9AE1`
...
- `obs-evo-cand-010311-route-category-staging`
...
- `obs-evo-cand-010311-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010311-route-evolution-graph`
