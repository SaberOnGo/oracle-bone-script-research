# obs-char-000202 Archaeology Paleography Review

# obs-char-000202 考古文字复核档案
...
- first local image: `001_asset-000207_hust-obc-cat-0225_glyph.png`
- first source image: `G_0225_上(2).從(甲).9(楚).png`
