# obs-unk-004778 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004778`
- primary external id: `hust-obc-und-X-004778`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/078_obs-unk-004778_h
  ust-obc-und-X-004778_oracle-character-candidate/03_visual-assets/001_asset
  -006371_hust-obc-und-X-004778_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/334/X_？_7318_1.png`
- asset id: `asset-006371`
...
- source class: `HUST-OBC/undeciphered/X/334/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/334/X_？_7318_1.png`
- asset id: `asset-006371`
...
- English observation: `rectangular enclosure and long side branches`
- 中文观察: `矩形围合结构和两侧长分支`
...
- Which source records identify obs-unk-004778 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004778？
