...
- External category reference: `evobc-cat-02083`
- Source category ID: `02083`
- Source label for human review: `妘`
- Source codepoints: `U+5998`
...
- `obs-evo-cand-002083-route-category-staging`
...
- `obs-evo-cand-002083-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002083-route-evolution-graph`
