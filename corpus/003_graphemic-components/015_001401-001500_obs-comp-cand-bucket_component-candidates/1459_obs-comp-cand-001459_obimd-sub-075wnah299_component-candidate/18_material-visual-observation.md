# Material Visual Observation / obs-comp-cand-001459 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001459`
- External reference / 外部参照: `obimd-sub-075wnah299`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016036_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/075wnah299/075wnah299/075wnah299.png`
- Checksum / 校验和:
  `eccb34553aa9728ccefa297a6d85354131a1e360899e1cdd8df876362b15ccb1`
...
- Marked-pixel bounds: (73,36)–(171,222); span 99 × 187 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.91%。
- 痕迹范围：(73,36)–(171,222)；跨度99 × 187 px；痕迹矩形高于宽。
