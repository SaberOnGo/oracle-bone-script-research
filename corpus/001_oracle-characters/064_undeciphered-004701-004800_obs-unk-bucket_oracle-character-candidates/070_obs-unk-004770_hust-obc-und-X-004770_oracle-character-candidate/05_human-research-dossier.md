# obs-unk-004770 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004770`
- primary external id: `hust-obc-und-X-004770`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/070_obs-unk-004770_h
  ust-obc-und-X-004770_oracle-character-candidate/03_visual-assets/001_asset
  -006363_hust-obc-und-X-004770_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/326/X_？_7113_1.png`
- asset id: `asset-006363`
...
- source class: `HUST-OBC/undeciphered/X/326/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/326/X_？_7113_1.png`
- asset id: `asset-006363`
...
- English observation: `sloping upper group, lower enclosure, and long curve`
- 中文观察: `上部斜向结构、下部围合结构和长曲线`
...
- Which source records identify obs-unk-004770 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004770？
