...
Project ID: `obs-evo-cand-002082`
...
- Project ID: `obs-evo-cand-002082`
- EVOBC category candidate ID: `evobc-evo-cat-02082`
- External category reference: `evobc-cat-02082`
- Source category ID: `02082`
- Source label for human review: `妗`
- Source codepoints: `U+5997`
...
- `obs-evo-cand-002082-route-category-staging`
...
- `obs-evo-cand-002082-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002082-route-evolution-graph`
