# Material Visual Observation / obs-comp-cand-001648 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001648`
- External reference / 外部参照: `obimd-sub-pjmzvla929`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017324_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qg6bx6xlgq/pjmzvla929/pjmzvla929.png`
- Checksum / 校验和:
  `7fd591b663fd5c9462f975daeda29ecba0d050b4e6f0f0545f171917336210cf`
...
- Marked-pixel bounds: (72,32)–(170,215); span 99 × 184 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.11%。
- 痕迹范围：(72,32)–(170,215)；跨度99 × 184 px；痕迹矩形高于宽。
