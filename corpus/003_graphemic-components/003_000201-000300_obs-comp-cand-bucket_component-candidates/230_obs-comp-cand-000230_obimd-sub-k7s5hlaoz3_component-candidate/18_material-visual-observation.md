# Material Visual Observation / obs-comp-cand-000230 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000230`
- External reference / 外部参照: `obimd-sub-k7s5hlaoz3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011877_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/k7s5hlaoz3/k7s5hlaoz3/k7s5hlaoz3.png`
- Checksum / 校验和:
  `b0d9d1b7a6a3670b9c5bc371d09cbb5e3d913515095384a0251302ca7d4dca9a`
...
- Marked-pixel bounds: (60,49)–(189,202); span 130 × 154 px; the marked
...
- 痕迹范围：(60,49)–(189,202)；跨度130 × 154 px；痕迹矩形近方形。
