# Material Visual Observation / obs-comp-cand-001984 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001984`
- External reference / 外部参照: `obimd-sub-qe26dg343r`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018976_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qe26dg343r/qe26dg343r/qe26dg343r.png`
- Checksum / 校验和:
  `dde0ffe341f3a1d0f0c89399beb1ab7978e7545844d5abef8e7a47bc458458d3`
...
- Marked-pixel bounds: (87,17)–(171,230); span 85 × 214 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.86%。
- 痕迹范围：(87,17)–(171,230)；跨度85 × 214 px；痕迹矩形高于宽。
