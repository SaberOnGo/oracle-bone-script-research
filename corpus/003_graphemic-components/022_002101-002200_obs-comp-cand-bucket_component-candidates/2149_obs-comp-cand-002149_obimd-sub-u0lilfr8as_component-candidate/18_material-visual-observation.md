# Material Visual Observation / obs-comp-cand-002149 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002149`
- External reference / 外部参照: `obimd-sub-u0lilfr8as`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019737_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/k0pxsd02si/u0lilfr8as/0ppqfw5fp9.png`
- Checksum / 校验和:
  `a2e69224add11acb18c60a0ec08fefa9ddf5827c445c270a86ea0ba8058efcda`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.11%.
- Marked-pixel bounds: (68,30)–(181,214); span 114 × 185 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.11%。
- 痕迹范围：(68,30)–(181,214)；跨度114 × 185 px；痕迹矩形高于宽。
