# Material Visual Observation / obs-comp-cand-001458 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001458`
- External reference / 外部参照: `obimd-sub-18opggwt60`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016035_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/acx6uyop18/18opggwt60/18opggwt60.png`
- Checksum / 校验和:
  `e9461059053e6de697e222d74c1931bf5830b2b574141017085f18015840f9a2`
...
- Marked-pixel bounds: (69,49)–(180,194); span 112 × 146 px; the marked
...
- 痕迹范围：(69,49)–(180,194)；跨度112 × 146 px；痕迹矩形高于宽。
