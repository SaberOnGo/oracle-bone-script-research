# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013253
...
- EVOBC candidate category: `evobc-evo-cat-13253`.
- Source label for search only: `𬏿`.
- Source codepoints for search only: `U+2C3FF`.
