...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0555`
...
- Source image / 来源图: `H_0555_611FC_0.png`
- Image / 图像: `001_asset-000495_hust-obc-cat-0555_glyph.png`
...
- target node: `obimd-main-cand-003565`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Source label text / 来源标签文字: `㘡`
- Source label codepoint / 来源标签 codepoint: `U+3621`
