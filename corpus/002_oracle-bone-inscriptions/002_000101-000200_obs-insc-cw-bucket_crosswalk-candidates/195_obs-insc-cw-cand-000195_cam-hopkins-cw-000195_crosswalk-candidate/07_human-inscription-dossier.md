...
- Yingguo / 英国所藏: `y1173` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `37` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `624` in source row; primary catalog entry pending
- Heji / 合集: `40435` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000195`
