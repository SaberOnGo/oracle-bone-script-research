...
Project ID: `obs-evo-cand-002736`
...
- Project ID: `obs-evo-cand-002736`
- EVOBC category candidate ID: `evobc-evo-cat-02736`
- External category reference: `evobc-cat-02736`
- Source category ID: `02736`
- Source label for human review: `庮`
- Source codepoints: `U+5EAE`
...
- `obs-evo-cand-002736-route-category-staging`
...
- `obs-evo-cand-002736-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002736-route-evolution-graph`
