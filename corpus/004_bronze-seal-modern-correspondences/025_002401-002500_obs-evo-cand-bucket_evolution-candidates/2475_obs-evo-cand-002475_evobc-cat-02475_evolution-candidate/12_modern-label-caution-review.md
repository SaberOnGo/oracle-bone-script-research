# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002475
...
- EVOBC candidate category: `evobc-evo-cat-02475`.
- Source label for search only: `尝`.
- Source codepoints for search only: `U+5C1D`.
