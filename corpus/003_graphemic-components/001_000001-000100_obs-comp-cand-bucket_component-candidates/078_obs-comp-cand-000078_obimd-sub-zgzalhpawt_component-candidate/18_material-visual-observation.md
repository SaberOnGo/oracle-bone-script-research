# Material Visual Observation / obs-comp-cand-000078 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000078`
- External reference / 外部参照: `obimd-sub-zgzalhpawt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011490_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/t4tioxlhov/zgzalhpawt/zgzalhpawt.png`
- Checksum / 校验和:
  `9340c73b6d287874fd06fce9369aff92f4d8b72937d82d8e22ad6cb664c8493c`
...
- Marked-pixel bounds: (79,20)–(170,231); span 92 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.95%。
- 痕迹范围：(79,20)–(170,231)；跨度92 × 212 px；痕迹矩形高于宽。
