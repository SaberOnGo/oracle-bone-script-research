...
- External category reference: `evobc-cat-11475`
- Source category ID: `11475`
- Source label for human review: `𣤶`
...
- `obs-evo-cand-011475-route-category-staging`
...
- `obs-evo-cand-011475-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011475-route-evolution-graph`
