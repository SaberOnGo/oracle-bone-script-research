# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001045
...
| Glyph or codepoint route / 字形或码位路线 | 4 OBIMD route rows; examples U+5C65;U+F5F3A; U+F5F3B; 另有 2 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
