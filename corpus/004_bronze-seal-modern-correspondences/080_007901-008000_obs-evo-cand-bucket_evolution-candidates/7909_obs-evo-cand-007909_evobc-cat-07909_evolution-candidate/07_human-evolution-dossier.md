...
- External category reference: `evobc-cat-07909`
- Source category ID: `07909`
- Source label for human review: `街`
- Source codepoints: `U+8857`
...
- `obs-evo-cand-007909-route-category-staging`
...
- `obs-evo-cand-007909-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007909-route-evolution-graph`
