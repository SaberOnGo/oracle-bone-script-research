# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-002262
...
- glyph_codepoint_uplus_sample: `U+FCFD6, U+FCFD7, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-020075` | `001_asset-020075_img.png` | `9380d3e89f9b83c1662600261380d34bd8858bde5d1f1103603c901f6bd9a098` |
