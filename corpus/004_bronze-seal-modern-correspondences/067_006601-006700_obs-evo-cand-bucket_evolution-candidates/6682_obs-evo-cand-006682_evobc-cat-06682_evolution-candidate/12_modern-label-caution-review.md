# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006682
...
- EVOBC candidate category: `evobc-evo-cat-06682`.
- Source label for search only: `繟`.
- Source codepoints for search only: `U+7E5F`.
