# Material Visual Observation / obs-comp-cand-001572 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001572`
- External reference / 外部参照: `obimd-sub-phjj09b89l`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017119_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/phjj09b89l/phjj09b89l/2frnr5pp2z.png`
- Checksum / 校验和:
  `7f835190ffb6e4562241de18a3d656b768359200e73d254f40b6f37a54db3feb`
...
- Marked-pixel bounds: (77,40)–(172,204); span 96 × 165 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.27%。
- 痕迹范围：(77,40)–(172,204)；跨度96 × 165 px；痕迹矩形高于宽。
