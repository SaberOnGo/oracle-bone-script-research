# Material Visual Observation / obs-comp-cand-002319 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002319`
- External reference / 外部参照: `obimd-sub-q66wswcsev`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020338_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/q66wswcsev/q66wswcsev/q66wswcsev.png`
- Checksum / 校验和:
  `401fb9bbb1a7547b97bcb9dc1397aa9af694965ae8778e587ce06ecde7a15ff1`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.81%.
- Marked-pixel bounds: (67,23)–(210,229); span 144 × 207 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.81%。
- 痕迹范围：(67,23)–(210,229)；跨度144 × 207 px；痕迹矩形高于宽。
