...
- External category reference: `evobc-cat-08385`
- Source category ID: `08385`
- Source label for human review: `讇`
- Source codepoints: `U+8B87`
...
- `obs-evo-cand-008385-route-category-staging`
...
- `obs-evo-cand-008385-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008385-route-evolution-graph`
