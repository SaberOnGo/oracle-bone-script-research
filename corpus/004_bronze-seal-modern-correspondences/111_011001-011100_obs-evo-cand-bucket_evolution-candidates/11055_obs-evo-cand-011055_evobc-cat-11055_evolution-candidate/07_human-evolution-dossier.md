...
Project ID: `obs-evo-cand-011055`
...
- Project ID: `obs-evo-cand-011055`
- EVOBC category candidate ID: `evobc-evo-cat-11055`
- External category reference: `evobc-cat-11055`
- Source category ID: `11055`
- Source label for human review: `𡤸`
- Source codepoints: `U+21938`
...
- `obs-evo-cand-011055-route-category-staging`
...
- `obs-evo-cand-011055-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011055-route-evolution-graph`
