...
- External category reference: `evobc-cat-09411`
- Source category ID: `09411`
- Source label for human review: `鋗`
...
- `obs-evo-cand-009411-route-category-staging`
...
- `obs-evo-cand-009411-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009411-route-evolution-graph`
