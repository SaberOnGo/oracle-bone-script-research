...
- External category reference: `evobc-cat-11148`
- Source category ID: `11148`
- Source label for human review: `𢆶`
...
- `obs-evo-cand-011148-route-category-staging`
...
- `obs-evo-cand-011148-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011148-route-evolution-graph`
