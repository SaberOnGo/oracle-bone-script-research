...
- External category reference: `evobc-cat-01368`
- Source category ID: `01368`
- Source label for human review: `卉`
...
- `obs-evo-cand-001368-route-category-staging`
...
- `obs-evo-cand-001368-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001368-route-evolution-graph`
