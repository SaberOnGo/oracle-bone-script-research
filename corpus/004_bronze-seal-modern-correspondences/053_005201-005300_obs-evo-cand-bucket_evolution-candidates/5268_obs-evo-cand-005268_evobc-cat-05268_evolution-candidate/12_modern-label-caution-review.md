# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-005268
...
- EVOBC candidate category: `evobc-evo-cat-05268`.
- Source label for search only: `狛`.
- Source codepoints for search only: `U+72DB`.
