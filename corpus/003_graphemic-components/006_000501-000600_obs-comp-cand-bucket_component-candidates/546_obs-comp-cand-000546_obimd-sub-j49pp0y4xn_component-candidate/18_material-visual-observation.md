# Material Visual Observation / obs-comp-cand-000546 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000546`
- External reference / 外部参照: `obimd-sub-j49pp0y4xn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012780_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/446qjw4xgi/j49pp0y4xn/j49pp0y4xn.png`
- Checksum / 校验和:
  `5ef89fb362f3ca99fe4b92f817fd9735ca8cf32a3c60223e3f587dcd7c967b6d`
...
- Marked-pixel bounds: (96,10)–(155,239); span 60 × 230 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.28%。
- 痕迹范围：(96,10)–(155,239)；跨度60 × 230 px；痕迹矩形高于宽。
