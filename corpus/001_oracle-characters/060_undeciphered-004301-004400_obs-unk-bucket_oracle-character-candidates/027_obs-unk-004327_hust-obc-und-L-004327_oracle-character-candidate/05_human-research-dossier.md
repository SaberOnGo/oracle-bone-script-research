# obs-unk-004327 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/027_obs-unk-004327_h
  ust-obc-und-L-004327_oracle-character-candidate/03_visual-assets/001_asset
  -005920_hust-obc-und-L-004327_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4327/L_？_956.jpg`
- asset id: `asset-005920`
...
- source class: `HUST-OBC/undeciphered/L/4327/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4327/L_？_956.jpg`
- asset id: `asset-005920`
...
- English observation: `Two long curved traces and a narrow gap recorded.`
- 中文观察: `已记录两条长弯痕及其间的窄空隙。`
...
- Which source records identify obs-unk-004327 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004327？
