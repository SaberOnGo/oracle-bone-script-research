...
- External category reference: `evobc-cat-02344`
- Source category ID: `02344`
- Source label for human review: `孰`
- Source codepoints: `U+5B70`
- Image reference count in source metadata: `59`
...
- `obs-evo-cand-002344-route-category-staging`
...
- `obs-evo-cand-002344-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002344-route-evolution-graph`
