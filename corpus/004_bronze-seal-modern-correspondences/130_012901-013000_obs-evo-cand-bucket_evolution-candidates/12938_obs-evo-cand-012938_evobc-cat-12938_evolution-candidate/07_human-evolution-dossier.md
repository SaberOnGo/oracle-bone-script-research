...
- External category reference: `evobc-cat-12938`
- Source category ID: `12938`
- Source label for human review: `𫐡`
...
- `obs-evo-cand-012938-route-category-staging`
...
- `obs-evo-cand-012938-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012938-route-evolution-graph`
