# obs-unk-004619 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/019_obs-unk-004619_h
  ust-obc-und-X-004619_oracle-character-candidate/03_visual-assets/001_asset
  -006212_hust-obc-und-X-004619_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/175/X_？_8350_1.png`
- asset id: `asset-006212`
...
- source class: `HUST-OBC/undeciphered/X/175/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/175/X_？_8350_1.png`
- asset id: `asset-006212`
...
- English observation: `thresholded dark field; boundaries uncertain`
- 中文观察: `高反差深色区域已记录，单个痕迹边界待复核。`
...
- Which source records identify obs-unk-004619 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004619？
