# Material Visual Observation / obs-comp-cand-000604 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000604`
- External reference / 外部参照: `obimd-sub-pjyj6rvuj6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013137_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/pjyj6rvuj6/pjyj6rvuj6/pjyj6rvuj6.png`
- Checksum / 校验和:
  `a61e4fab4a5a8d80a35da30170f80922afb7ea0248bd6e4bafcde5ca7fcf76c8`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.22%.
- Marked-pixel bounds: (62,15)–(188,234); span 127 × 220 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.22%。
- 痕迹范围：(62,15)–(188,234)；跨度127 × 220 px；痕迹矩形高于宽。
