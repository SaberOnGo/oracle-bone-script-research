# Material Visual Observation / obs-comp-cand-001689 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001689`
- External reference / 外部参照: `obimd-sub-adxcinr4w0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017605_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kk9zxal8u7/adxcinr4w0/adxcinr4w0.png`
- Checksum / 校验和:
  `987caf9d60cb9cf5ff9d9a375c8e7d8d6af5175e03233dd4999731f75bb2332c`
...
- Marked-pixel bounds: (67,54)–(179,190); span 113 × 137 px; the marked
...
- 痕迹范围：(67,54)–(179,190)；跨度113 × 137 px；痕迹矩形高于宽。
