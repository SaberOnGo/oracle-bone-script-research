# obs-comp-cand-002695 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002695`
- 首选外部 ID: `obimd-sub-vpkyna241n`
- OBIMD subcharacter UID: `vpkyna241n`
- OBIMD main character UID: `vpkyna241n`
- 来源 ID: `src-obimd`
...
- codepoint 示例: U+FF345; U+FF346; 另有 11 项
