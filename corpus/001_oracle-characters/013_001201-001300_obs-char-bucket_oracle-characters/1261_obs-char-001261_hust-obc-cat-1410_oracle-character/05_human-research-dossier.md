# obs-char-001261 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001261`
- primary external id: `hust-obc-cat-1410`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1261_obs-char-001261_hust-obc-cat-1410_ora
  cle-character/03_visual-assets/001_asset-001266_hust-obc-cat-1410_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1410/L_1410_5348.jpg`
- asset id: `asset-001266`
...
- source category: `1410`
- validation class: `1260`
- source image route: `HUST-OBC/deciphered/1410/L_1410_5348.jpg`
- asset id: `asset-001266`
...
- English observation: `A small faint cluster has a rounded upper loop, two
  descending strokes, and a short detached right mark.`
- 中文观察: `小型较淡笔画群有圆拱上部环形、两条下行笔画和一条短分离右侧标记。`
...
- dataset label text: `㥸`
- dataset label codepoints: `U+3978`
...
- Which source records identify obs-char-001261 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001261？
