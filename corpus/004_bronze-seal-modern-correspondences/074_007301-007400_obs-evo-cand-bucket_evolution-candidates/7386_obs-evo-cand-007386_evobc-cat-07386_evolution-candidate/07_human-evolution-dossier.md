...
Project ID: `obs-evo-cand-007386`
...
- Project ID: `obs-evo-cand-007386`
- EVOBC category candidate ID: `evobc-evo-cat-07386`
- External category reference: `evobc-cat-07386`
- Source category ID: `07386`
- Source label for human review: `莤`
- Source codepoints: `U+83A4`
...
- `obs-evo-cand-007386-route-category-staging`
...
- `obs-evo-cand-007386-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007386-route-evolution-graph`
