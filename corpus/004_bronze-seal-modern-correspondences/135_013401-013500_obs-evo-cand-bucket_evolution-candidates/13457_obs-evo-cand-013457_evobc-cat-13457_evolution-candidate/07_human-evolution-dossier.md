...
Project ID: `obs-evo-cand-013457`
...
- Project ID: `obs-evo-cand-013457`
- EVOBC category candidate ID: `evobc-evo-cat-13457`
- External category reference: `evobc-cat-13457`
- Source category ID: `13457`
- Source label for human review: `𬹬`
- Source codepoints: `U+2CE6C`
- Image reference count in source metadata: `7`
...
- `obs-evo-cand-013457-route-category-staging`
...
- `obs-evo-cand-013457-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013457-route-evolution-graph`
