# Material Visual Observation / obs-comp-cand-001241 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001241`
- External reference / 外部参照: `obimd-sub-nmwisatji2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015479_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cdwgyw3kul/nmwisatji2/nmwisatji2.png`
- Checksum / 校验和:
  `1c325d8324292112ca043324bb59e29f047ca97a88664c8ec6460b32cd963880`
...
- Marked-pixel bounds: (62,38)–(187,212); span 126 × 175 px; the marked
...
- 痕迹范围：(62,38)–(187,212)；跨度126 × 175 px；痕迹矩形高于宽。
