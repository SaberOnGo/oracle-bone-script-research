...
Project ID: `obs-evo-cand-005588`
...
- Project ID: `obs-evo-cand-005588`
- EVOBC category candidate ID: `evobc-evo-cat-05588`
- External category reference: `evobc-cat-05588`
- Source category ID: `05588`
- Source label for human review: `畹`
- Source codepoints: `U+7579`
...
- `obs-evo-cand-005588-route-category-staging`
...
- `obs-evo-cand-005588-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005588-route-evolution-graph`
