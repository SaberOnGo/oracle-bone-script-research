# obs-comp-cand-000830 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000830`
- 首选外部 ID: `obimd-sub-tavwtgnfdp`
- OBIMD subcharacter UID: `tavwtgnfdp`
- OBIMD main character UID: `tavwtgnfdp`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+F4AD8; U+F4AD9; 另有 1 项
