# obs-unk-004203 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/003_obs-unk-004203_h
  ust-obc-und-L-004203_oracle-character-candidate/03_visual-assets/001_asset
  -005796_hust-obc-und-L-004203_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4203/L_？_9154.jpg`
- asset id: `asset-005796`
...
- source class: `HUST-OBC/undeciphered/L/4203/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4203/L_？_9154.jpg`
- asset id: `asset-005796`
...
- English observation: `Upper bars, narrow right trace, and long curve visible.`
- 中文观察: `上部横笔画、右侧窄痕迹和长弧形笔画可见。`
...
- Which source records identify obs-unk-004203 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004203？
