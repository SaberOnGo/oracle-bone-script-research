...
- External category reference: `evobc-cat-02735`
- Source category ID: `02735`
- Source label for human review: `庭`
...
- `obs-evo-cand-002735-route-category-staging`
...
- `obs-evo-cand-002735-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002735-route-evolution-graph`
