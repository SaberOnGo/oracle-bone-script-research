# Material Visual Observation / obs-comp-cand-000046 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000046`
- External reference / 外部参照: `obimd-sub-toxyvoa89s`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011412_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ptr3rfuph8/toxyvoa89s/toxyvoa89s.png`
- Checksum / 校验和:
  `fbb83a3f3c5389c9cf486811f04de98da145ff69184e8b967d77e3d373b61f1a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.64%.
- Marked-pixel bounds: (65,17)–(187,231); span 123 × 215 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.64%。
- 痕迹范围：(65,17)–(187,231)；跨度123 × 215 px；痕迹矩形高于宽。
