# obs-unk-002797 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002797`
- primary external id: `hust-obc-und-L-002797`
...
- local review image route: `corpus/001_oracle-characters/044_undeciphered-002
  701-002800_obs-unk-bucket_oracle-character-candidates/097_obs-unk-002797_h
  ust-obc-und-L-002797_oracle-character-candidate/03_visual-assets/001_asset
  -004390_hust-obc-und-L-002797_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2797/L_？_4624.jpg`
- asset id: `asset-004390`
...
- source class: `HUST-OBC/undeciphered/L/2797/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2797/L_？_4624.jpg`
- asset id: `asset-004390`
...
- Which source records identify obs-unk-002797 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002797？
