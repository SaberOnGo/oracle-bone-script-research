...
Project ID: `obs-evo-cand-001288`
...
- Project ID: `obs-evo-cand-001288`
- EVOBC category candidate ID: `evobc-evo-cat-01288`
- External category reference: `evobc-cat-01288`
- Source category ID: `01288`
- Source label for human review: `勉`
- Source codepoints: `U+52C9`
...
- `obs-evo-cand-001288-route-category-staging`
...
- `obs-evo-cand-001288-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001288-route-evolution-graph`
