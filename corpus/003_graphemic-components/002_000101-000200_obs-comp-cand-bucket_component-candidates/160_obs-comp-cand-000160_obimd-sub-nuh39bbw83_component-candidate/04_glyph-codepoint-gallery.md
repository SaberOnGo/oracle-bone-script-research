# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000160
...
| --- | --- | --- | --- |
| `obimd-glyph-link-002111` | 󰺶 | `U+F0EB6` | `reviewed_metadata_only` |
| `obimd-glyph-link-002112` | 󰺷 | `U+F0EB7` | `reviewed_metadata_only` |
