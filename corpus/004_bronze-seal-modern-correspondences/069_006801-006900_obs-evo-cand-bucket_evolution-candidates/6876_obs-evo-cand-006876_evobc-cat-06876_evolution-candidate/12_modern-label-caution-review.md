# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006876
...
- EVOBC candidate category: `evobc-evo-cat-06876`.
- Source label for search only: `翊`.
- Source codepoints for search only: `U+7FCA`.
