# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008165
...
- EVOBC candidate category: `evobc-evo-cat-08165`.
- Source label for search only: `詁`.
- Source codepoints for search only: `U+8A41`.
