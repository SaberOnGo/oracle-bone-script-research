# Material Visual Observation / obs-comp-cand-000429 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000429`
- External reference / 外部参照: `obimd-sub-2eur35esrm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012352_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/utkbozj9sh/2eur35esrm/2eur35esrm.png`
- Checksum / 校验和:
  `2f1734f2602c95c168281080286350d38cde1207ac8b57d4cd0ee4a7fb623a08`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.07%.
- Marked-pixel bounds: (43,37)–(199,214); span 157 × 178 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.07%。
- 痕迹范围：(43,37)–(199,214)；跨度157 × 178 px；痕迹矩形近方形。
