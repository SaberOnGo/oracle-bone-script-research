...
Project ID: `obs-evo-cand-011425`
...
- Project ID: `obs-evo-cand-011425`
- EVOBC category candidate ID: `evobc-evo-cat-11425`
- External category reference: `evobc-cat-11425`
- Source category ID: `11425`
- Source label for human review: `𣏟`
- Source codepoints: `U+233DF`
...
- `obs-evo-cand-011425-route-category-staging`
...
- `obs-evo-cand-011425-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011425-route-evolution-graph`
