...
Project ID: `obs-evo-cand-002731`
...
- Project ID: `obs-evo-cand-002731`
- EVOBC category candidate ID: `evobc-evo-cat-02731`
- External category reference: `evobc-cat-02731`
- Source category ID: `02731`
- Source label for human review: `庥`
- Source codepoints: `U+5EA5`
...
- `obs-evo-cand-002731-route-category-staging`
...
- `obs-evo-cand-002731-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002731-route-evolution-graph`
