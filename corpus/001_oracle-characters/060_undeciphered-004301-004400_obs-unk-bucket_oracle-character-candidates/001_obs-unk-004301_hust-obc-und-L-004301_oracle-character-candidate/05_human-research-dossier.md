# obs-unk-004301 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004301`
- primary external id: `hust-obc-und-L-004301`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/001_obs-unk-004301_h
  ust-obc-und-L-004301_oracle-character-candidate/03_visual-assets/001_asset
  -005894_hust-obc-und-L-004301_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4301/L_？_9495.jpg`
- asset id: `asset-005894`
...
- source class: `HUST-OBC/undeciphered/L/4301/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4301/L_？_9495.jpg`
- asset id: `asset-005894`
...
- English observation: `Upper curves, central descent, lower loop visible.`
- 中文观察: `上部弯痕、中央下行线和下部环状轮廓可见。`
...
- Which source records identify obs-unk-004301 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004301？
