...
- External category reference: `evobc-cat-11041`
- Source category ID: `11041`
- Source label for human review: `𡞃`
- Source codepoints: `U+21783`
...
- `obs-evo-cand-011041-route-category-staging`
...
- `obs-evo-cand-011041-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011041-route-evolution-graph`
