...
- External category reference: `evobc-cat-03765`
- Source category ID: `03765`
...
- `obs-evo-cand-003765-route-category-staging`
...
- `obs-evo-cand-003765-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003765-route-evolution-graph`
