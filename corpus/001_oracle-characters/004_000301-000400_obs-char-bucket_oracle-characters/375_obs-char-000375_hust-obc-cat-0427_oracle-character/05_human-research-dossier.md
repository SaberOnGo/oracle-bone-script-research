# obs-char-000375 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000375`
- primary external id: `hust-obc-cat-0427`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/375_obs-char-000375_hust-obc-cat-0427_orac
  le-character/03_visual-assets/001_asset-000380_hust-obc-cat-0427_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0427/G_0427_乙2494合3216賓組.png`
- asset id: `asset-000380`
...
- source category: `0427`
- validation class: `374`
- source image route: `HUST-OBC/deciphered/0427/G_0427_乙2494合3216賓組.png`
- asset id: `asset-000380`
...
- English observation: `A pointed upper fork opens into two long descending
  strokes with a narrow central line.`
- 中文观察: `尖状上部分叉向下展开为两条长下行笔画，中间有一条狭长笔画。`
...
- dataset label text: `㖡`
- dataset label codepoints: `U+35A1`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/034_obs-evo-can
  d-000034_evobc-cat-00034_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/034_obs-evo-cand-000034_evobc-cat-00034_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合3216
...
- Which source records identify obs-char-000375 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000375？
