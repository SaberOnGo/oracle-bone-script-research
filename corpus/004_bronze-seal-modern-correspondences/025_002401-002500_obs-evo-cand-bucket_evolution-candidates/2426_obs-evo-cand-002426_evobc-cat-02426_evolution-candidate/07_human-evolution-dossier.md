...
- External category reference: `evobc-cat-02426`
- Source category ID: `02426`
- Source label for human review: `寜`
...
- `obs-evo-cand-002426-route-category-staging`
...
- `obs-evo-cand-002426-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002426-route-evolution-graph`
