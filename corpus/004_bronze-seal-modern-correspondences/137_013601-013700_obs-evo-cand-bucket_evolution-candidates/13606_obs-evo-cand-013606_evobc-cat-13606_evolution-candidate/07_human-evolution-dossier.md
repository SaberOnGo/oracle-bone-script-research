...
Project ID: `obs-evo-cand-013606`
...
- Project ID: `obs-evo-cand-013606`
- EVOBC category candidate ID: `evobc-evo-cat-13606`
- External category reference: `evobc-cat-13606`
- Source category ID: `13606`
- Source label for human review: `𮆫`
- Source codepoints: `U+2E1AB`
...
- `obs-evo-cand-013606-route-category-staging`
...
- `obs-evo-cand-013606-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013606-route-evolution-graph`
