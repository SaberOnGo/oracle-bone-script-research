...
- Project ID: `obs-evo-cand-010018`
- EVOBC category candidate ID: `evobc-evo-cat-10018`
- External category reference: `evobc-cat-10018`
- Source category ID: `10018`
- Source label for human review: `顒`
- Source codepoints: `U+9852`
...
- `obs-evo-cand-010018-route-category-staging`
...
- `obs-evo-cand-010018-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010018-route-evolution-graph`
