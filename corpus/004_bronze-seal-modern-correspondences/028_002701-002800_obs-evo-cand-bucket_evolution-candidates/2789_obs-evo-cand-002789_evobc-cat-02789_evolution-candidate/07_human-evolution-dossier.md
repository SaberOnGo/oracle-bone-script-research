...
- External category reference: `evobc-cat-02789`
- Source category ID: `02789`
- Source label for human review: `弋`
...
- `obs-evo-cand-002789-route-category-staging`
...
- `obs-evo-cand-002789-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002789-route-evolution-graph`
