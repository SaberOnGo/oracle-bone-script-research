# obs-unk-004857 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004857`
- primary external id: `hust-obc-und-X-004857`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/057_obs-unk-004857_h
  ust-obc-und-X-004857_oracle-character-candidate/03_visual-assets/001_asset
  -006450_hust-obc-und-X-004857_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/413/X_？_7398_1.png`
- asset id: `asset-006450`
...
- source class: `HUST-OBC/undeciphered/X/413/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/413/X_？_7398_1.png`
- asset id: `asset-006450`
...
- English observation: `curved path with lower paired openings`
- 中文观察: `曲线笔路和下部成对开口`
...
- Which source records identify obs-unk-004857 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004857？
