# Material Visual Observation / obs-comp-cand-001622 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001622`
- External reference / 外部参照: `obimd-sub-5fsjukjyjt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017298_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5fsjukjyjt/5fsjukjyjt/5fsjukjyjt.png`
- Checksum / 校验和:
  `746cd83d65d0f604aba1ec590bfd936bcf40c17fb6e4c9c160e5e2691b68fd71`
...
- Marked-pixel bounds: (69,32)–(168,219); span 100 × 188 px; the marked
...
- 痕迹范围：(69,32)–(168,219)；跨度100 × 188 px；痕迹矩形高于宽。
