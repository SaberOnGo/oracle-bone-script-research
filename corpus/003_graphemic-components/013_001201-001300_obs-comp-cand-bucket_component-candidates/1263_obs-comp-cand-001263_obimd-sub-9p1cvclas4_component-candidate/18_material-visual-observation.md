# Material Visual Observation / obs-comp-cand-001263 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001263`
- External reference / 外部参照: `obimd-sub-9p1cvclas4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015501_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9p1cvclas4/9p1cvclas4/9p1cvclas4.png`
- Checksum / 校验和:
  `527d7da2133c062409a918f7696fda14f0ae884ee22e43e1702a7b22644c0506`
...
- Marked-pixel bounds: (71,47)–(178,211); span 108 × 165 px; the marked
...
- 痕迹范围：(71,47)–(178,211)；跨度108 × 165 px；痕迹矩形高于宽。
