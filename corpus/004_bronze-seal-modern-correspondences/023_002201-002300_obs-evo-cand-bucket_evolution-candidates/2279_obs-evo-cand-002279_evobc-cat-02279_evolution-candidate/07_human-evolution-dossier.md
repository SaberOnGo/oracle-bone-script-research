...
Project ID: `obs-evo-cand-002279`
...
- Project ID: `obs-evo-cand-002279`
- EVOBC category candidate ID: `evobc-evo-cat-02279`
- External category reference: `evobc-cat-02279`
- Source category ID: `02279`
- Source label for human review: `嫳`
- Source codepoints: `U+5AF3`
...
- `obs-evo-cand-002279-route-category-staging`
...
- `obs-evo-cand-002279-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002279-route-evolution-graph`
