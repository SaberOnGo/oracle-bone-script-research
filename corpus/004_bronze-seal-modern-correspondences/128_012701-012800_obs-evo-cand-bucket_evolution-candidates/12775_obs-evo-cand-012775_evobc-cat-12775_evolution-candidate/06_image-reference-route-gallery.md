...
- `obs-evo-cand-012775-route-category-staging`
...
- `obs-evo-cand-012775-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012775-route-evolution-graph`
