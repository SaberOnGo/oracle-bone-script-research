# Material Visual Observation / obs-comp-cand-000100 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000100`
- External reference / 外部参照: `obimd-sub-t1r1jjd8v1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011512_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/t1r1jjd8v1/t1r1jjd8v1/t1r1jjd8v1.png`
- Checksum / 校验和:
  `18e24f151a1c0fb8e3cc1a0ebc5b2adee00abec74a0a74f392384e2f239c28cf`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 14.31%.
- Marked-pixel bounds: (35,40)–(214,215); span 180 × 176 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占14.31%。
- 痕迹范围：(35,40)–(214,215)；跨度180 × 176 px；痕迹矩形近方形。
