...
- External category reference: `evobc-cat-02035`
- Source category ID: `02035`
- Source label for human review: `奎`
...
- `obs-evo-cand-002035-route-category-staging`
...
- `obs-evo-cand-002035-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002035-route-evolution-graph`
