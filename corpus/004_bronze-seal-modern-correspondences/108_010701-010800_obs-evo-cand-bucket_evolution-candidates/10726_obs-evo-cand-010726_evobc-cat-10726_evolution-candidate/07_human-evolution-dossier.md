...
- Project ID: `obs-evo-cand-010726`
- EVOBC category candidate ID: `evobc-evo-cat-10726`
- External category reference: `evobc-cat-10726`
- Source category ID: `10726`
- Source label for human review: `齤`
- Source codepoints: `U+9F64`
...
- `obs-evo-cand-010726-route-category-staging`
...
- `obs-evo-cand-010726-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010726-route-evolution-graph`
