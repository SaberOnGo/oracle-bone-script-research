# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000920
...
- EVOBC candidate category: `evobc-evo-cat-00920`.
- Source label for search only: `倌`.
- Source codepoints for search only: `U+500C`.
