...
Project ID: `obs-evo-cand-011716`
...
- Project ID: `obs-evo-cand-011716`
- EVOBC category candidate ID: `evobc-evo-cat-11716`
- External category reference: `evobc-cat-11716`
- Source category ID: `11716`
- Source label for human review: `𤸾`
- Source codepoints: `U+24E3E`
...
- `obs-evo-cand-011716-route-category-staging`
...
- `obs-evo-cand-011716-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011716-route-evolution-graph`
