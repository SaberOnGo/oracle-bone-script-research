# obs-char-000736 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/736_obs-char-000736_hust-obc-cat-0838_orac
  le-character/03_visual-assets/001_asset-000741_hust-obc-cat-0838_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0838/G_0838_摭續120合32960歷組.png`
- asset id: `asset-000741`
...
- source category: `0838`
- validation class: `735`
- source image route: `HUST-OBC/deciphered/0838/G_0838_摭續120合32960歷組.png`
- asset id: `asset-000741`
...
- English observation: `Several narrow crossing uprights and diagonals form
  a tall open cluster, with a forked lower junction at left and a pointed
  arrow-like upper end at right.`
- 中文观察: `数条狭长竖笔和斜笔交叉成高长开放笔群，左下接点分叉，右上端呈尖箭状。`
...
- dataset label text: `㜼`
- dataset label codepoints: `U+373C`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/064_obs-evo-can
  d-000064_evobc-cat-00064_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/064_obs-evo-cand-000064_evobc-cat-00064_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合32960
...
- Which source records identify obs-char-000736 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000736？
