# Archaeological Context Review / 考古语境复核: coll-obj-cand-00054
...
| --- | --- | --- |
| Institution | `Online Collections` | `02_collection-source-index.csv` |
| Catalog or accession | `49-14-7A` | `02_collection-source-index.csv` |
| Source item | `49-14-7A` | `01_collection-object-packet.json` |
| Catalog description | `Oracle Bone` | `01_collection-object-packet.json` |
| Image route | `no_committed_visual_asset` | `03_visual-asset-index.csv` |
| Findspot or provenience | `Anyang` | `08_collection-provenance-evidence-dossier.md` |
| Period or date | `Shang Dynasty` | `08_collection-provenance-evidence-dossier.md` |
...
- candidate_collection_object_id: `penn-mus-obj-00001`
