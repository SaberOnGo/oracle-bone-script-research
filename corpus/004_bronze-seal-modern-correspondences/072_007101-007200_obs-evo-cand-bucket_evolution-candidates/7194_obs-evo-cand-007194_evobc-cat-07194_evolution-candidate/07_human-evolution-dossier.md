...
- External category reference: `evobc-cat-07194`
- Source category ID: `07194`
- Source label for human review: `舓`
...
- `obs-evo-cand-007194-route-category-staging`
...
- `obs-evo-cand-007194-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007194-route-evolution-graph`
