# obs-char-000657 Archaeology Paleography Review

# obs-char-000657 考古文字复核档案
...
- first local image: `001_asset-000662_hust-obc-cat-0745_glyph.png`
- first source image: `G_0745_乙5162(甲).png`
...
- source label text: `㛟`
- source label codepoints: `U+36DF`
