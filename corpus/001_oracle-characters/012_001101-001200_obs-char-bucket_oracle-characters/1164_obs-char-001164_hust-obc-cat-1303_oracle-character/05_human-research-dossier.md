# obs-char-001164 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001164`
- primary external id: `hust-obc-cat-1303`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1164_obs-char-001164_hust-obc-cat-1303_ora
  cle-character/03_visual-assets/001_asset-001169_hust-obc-cat-1303_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1303/G_1303_後2.6.2(甲).png`
- asset id: `asset-001169`
...
- source category: `1303`
- validation class: `1163`
- source image route: `HUST-OBC/deciphered/1303/G_1303_後2.6.2(甲).png`
- asset id: `asset-001169`
...
- English observation: `Two angular masses are linked by a central crossing,
  with a pointed left projection and a rounded right enclosure.`
- 中文观察: `两个折角块面由中央交叉相连，左侧有尖状外伸，右侧有圆弧形框廓。`
...
- dataset label text: `㤍`
- dataset label codepoints: `U+390D`
...
- Which source records identify obs-char-001164 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001164？
