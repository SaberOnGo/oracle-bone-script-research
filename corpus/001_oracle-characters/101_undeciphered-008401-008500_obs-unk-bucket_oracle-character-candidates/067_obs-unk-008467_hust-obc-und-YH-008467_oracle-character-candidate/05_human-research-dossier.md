# obs-unk-008467 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008467`
- primary external id: `hust-obc-und-YH-008467`
...
- local review image route: `corpus/001_oracle-characters/101_undeciphered-008
  401-008500_obs-unk-bucket_oracle-character-candidates/067_obs-unk-008467_h
  ust-obc-und-YH-008467_oracle-character-candidate/03_visual-assets/001_asse
  t-010058_hust-obc-und-YH-008467_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60B32/H_？_60B32_0.png`
- asset id: `asset-010058`
...
- source class: `HUST-OBC/undeciphered/Y+H/60B32/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60B32/H_？_60B32_0.png`
- asset id: `asset-010058`
...
- Which source records identify obs-unk-008467 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008467？
