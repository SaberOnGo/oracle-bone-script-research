...
- Project ID: `obs-evo-cand-008043`
- EVOBC category candidate ID: `evobc-evo-cat-08043`
- External category reference: `evobc-cat-08043`
- Source category ID: `08043`
- Source label for human review: `襭`
- Source codepoints: `U+896D`
...
- `obs-evo-cand-008043-route-category-staging`
...
- `obs-evo-cand-008043-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008043-route-evolution-graph`
