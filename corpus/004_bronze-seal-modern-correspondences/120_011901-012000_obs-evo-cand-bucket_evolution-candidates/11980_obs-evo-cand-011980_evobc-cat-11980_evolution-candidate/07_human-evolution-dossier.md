...
- Project ID: `obs-evo-cand-011980`
- EVOBC category candidate ID: `evobc-evo-cat-11980`
- External category reference: `evobc-cat-11980`
- Source category ID: `11980`
- Source label for human review: `𦆄`
- Source codepoints: `U+26184`
...
- `obs-evo-cand-011980-route-category-staging`
...
- `obs-evo-cand-011980-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011980-route-evolution-graph`
