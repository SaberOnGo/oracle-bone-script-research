...
- Yingguo / 英国所藏: `y2556` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `371` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `532` in source row; primary catalog entry pending
- Heji / 合集: `41763` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000549`
