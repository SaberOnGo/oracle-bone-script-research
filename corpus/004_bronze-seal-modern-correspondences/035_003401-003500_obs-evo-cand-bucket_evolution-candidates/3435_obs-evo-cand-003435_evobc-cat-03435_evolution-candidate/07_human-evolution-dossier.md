...
- External category reference: `evobc-cat-03435`
- Source category ID: `03435`
- Source label for human review: `揣`
- Source codepoints: `U+63E3`
...
- `obs-evo-cand-003435-route-category-staging`
...
- `obs-evo-cand-003435-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003435-route-evolution-graph`
