...
Project ID: `obs-evo-cand-012827`
...
- Project ID: `obs-evo-cand-012827`
- EVOBC category candidate ID: `evobc-evo-cat-12827`
- External category reference: `evobc-cat-12827`
- Source category ID: `12827`
- Source label for human review: `𪧧`
- Source codepoints: `U+2A9E7`
...
- `obs-evo-cand-012827-route-category-staging`
...
- `obs-evo-cand-012827-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012827-route-evolution-graph`
