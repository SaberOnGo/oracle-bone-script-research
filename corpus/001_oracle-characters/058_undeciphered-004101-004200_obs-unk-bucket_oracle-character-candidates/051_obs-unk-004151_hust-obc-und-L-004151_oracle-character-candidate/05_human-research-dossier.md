# obs-unk-004151 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004151`
- primary external id: `hust-obc-und-L-004151`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/051_obs-unk-004151_h
  ust-obc-und-L-004151_oracle-character-candidate/03_visual-assets/001_asset
  -005744_hust-obc-und-L-004151_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4151/L_？_8990.jpg`
- asset id: `asset-005744`
...
- source class: `HUST-OBC/undeciphered/L/4151/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4151/L_？_8990.jpg`
- asset id: `asset-005744`
...
- English observation: A tall left trace rises above a broad lower outline
  containing small dark marks.
- 中文观察：较高左侧痕迹位于带小深色痕迹的下部宽轮廓上方。
...
- Which source records identify obs-unk-004151 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004151？
