# obs-unk-002179 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002179`
- primary external id: `hust-obc-und-L-002179`
...
- local review image route: `corpus/001_oracle-characters/038_undeciphered-002
  101-002200_obs-unk-bucket_oracle-character-candidates/079_obs-unk-002179_h
  ust-obc-und-L-002179_oracle-character-candidate/03_visual-assets/001_asset
  -003772_hust-obc-und-L-002179_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2179/L_？_2557.jpg`
- asset id: `asset-003772`
...
- source class: `HUST-OBC/undeciphered/L/2179/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2179/L_？_2557.jpg`
- asset id: `asset-003772`
...
- Which source records identify obs-unk-002179 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002179？
