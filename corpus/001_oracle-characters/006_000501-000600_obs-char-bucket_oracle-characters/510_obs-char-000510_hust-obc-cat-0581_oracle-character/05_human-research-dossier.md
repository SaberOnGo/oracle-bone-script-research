# obs-char-000510 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000510`
- primary external id: `hust-obc-cat-0581`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/510_obs-char-000510_hust-obc-cat-0581_orac
  le-character/03_visual-assets/001_asset-000515_hust-obc-cat-0581_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0581/G_0581_前4.52.3(甲).png`
- asset id: `asset-000515`
...
- source category: `0581`
- validation class: `509`
- source image route: `HUST-OBC/deciphered/0581/G_0581_前4.52.3(甲).png`
- asset id: `asset-000515`
...
- dataset label text: `㘻`
- dataset label codepoints: `U+363B`
...
- Which source records identify obs-char-000510 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000510？
