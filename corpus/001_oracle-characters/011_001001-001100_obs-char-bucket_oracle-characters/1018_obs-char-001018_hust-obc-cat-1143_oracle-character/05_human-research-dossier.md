# obs-char-001018 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001018`
- primary external id: `hust-obc-cat-1143`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1018_obs-char-001018_hust-obc-cat-1143_ora
  cle-character/03_visual-assets/001_asset-001023_hust-obc-cat-1143_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1143/H_1143_605E8_0.png`
- asset id: `asset-001023`
...
- source category: `1143`
- validation class: `1017`
- source image route: `HUST-OBC/deciphered/1143/H_1143_605E8_0.png`
- asset id: `asset-001023`
...
- English observation: `A broad low horizontal form contains a dark interior
  division and is paired with a long curved upright stroke on the right.`
- 中文观察: `宽大的低位横向形体含深色内部隔笔，右侧与一条长弯曲直立笔并置。`
...
- dataset label text: `㡭`
- dataset label codepoints: `U+386D`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00092`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00092`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00092`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/092_obs-evo-can
  d-000092_evobc-cat-00092_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/092_obs-evo-cand-000092_evobc-cat-00092_evolu
...
- filename catalog route clues: `catalog-like filename clue: H_1143
  (H_1143_605E8_0.png)`
...
- Which source records identify obs-char-001018 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001018？
