# obs-char-001558 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001558`
- primary external id: `hust-obc-cat-1749`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1558_obs-char-001558_hust-obc-cat-1749_ora
  cle-character/03_visual-assets/001_asset-001563_hust-obc-cat-1749_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1749/G_1749_後2.18.8(甲).png`
- asset id: `asset-001563`
...
- source category: `1749`
- validation class: `1557`
- source image route: `HUST-OBC/deciphered/1749/G_1749_後2.18.8(甲).png`
- asset id: `asset-001563`
...
- English observation: `A dense branching cluster has several upright
  strokes and a short horizontal foot.`
...
- dataset label text: `㫋`
- dataset label codepoints: `U+3ACB`
...
- Which source records identify obs-char-001558 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001558？
