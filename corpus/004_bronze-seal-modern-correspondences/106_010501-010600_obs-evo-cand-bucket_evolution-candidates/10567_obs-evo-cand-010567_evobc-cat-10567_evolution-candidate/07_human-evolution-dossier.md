...
Project ID: `obs-evo-cand-010567`
...
- Project ID: `obs-evo-cand-010567`
- EVOBC category candidate ID: `evobc-evo-cat-10567`
- External category reference: `evobc-cat-10567`
- Source category ID: `10567`
- Source label for human review: `鷹`
- Source codepoints: `U+9DF9`
...
- `obs-evo-cand-010567-route-category-staging`
...
- `obs-evo-cand-010567-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010567-route-evolution-graph`
