...
Project ID: `obs-evo-cand-005323`
...
- Project ID: `obs-evo-cand-005323`
- EVOBC category candidate ID: `evobc-evo-cat-05323`
- External category reference: `evobc-cat-05323`
- Source category ID: `05323`
- Source label for human review: `獢`
- Source codepoints: `U+7362`
...
- `obs-evo-cand-005323-route-category-staging`
...
- `obs-evo-cand-005323-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005323-route-evolution-graph`
