...
- Project ID: `obs-evo-cand-002325`
- EVOBC category candidate ID: `evobc-evo-cat-02325`
- External category reference: `evobc-cat-02325`
- Source category ID: `02325`
- Source label for human review: `孑`
- Source codepoints: `U+5B51`
...
- `obs-evo-cand-002325-route-category-staging`
...
- `obs-evo-cand-002325-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002325-route-evolution-graph`
