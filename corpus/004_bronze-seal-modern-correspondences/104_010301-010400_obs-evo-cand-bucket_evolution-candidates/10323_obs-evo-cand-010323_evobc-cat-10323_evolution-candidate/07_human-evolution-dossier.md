...
- External category reference: `evobc-cat-10323`
- Source category ID: `10323`
- Source label for human review: `鬀`
- Source codepoints: `U+9B00`
...
- `obs-evo-cand-010323-route-category-staging`
...
- `obs-evo-cand-010323-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010323-route-evolution-graph`
