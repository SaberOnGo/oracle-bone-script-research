...
- `obs-evo-cand-013304-route-category-staging`
...
- `obs-evo-cand-013304-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013304-route-evolution-graph`
