...
- `obs-evo-cand-001955-route-category-staging`
...
- `obs-evo-cand-001955-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001955-route-evolution-graph`
