...
Project ID: `obs-insc-cw-cand-000278`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000278`
...
- Source page section: `Shih tsu` /
  `祖先子组（原页标签）`
- Source section key: `period-I-shih-tsu`
- Section declared count: `21`
...
- Yingguo / 英国所藏: `y1857` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `558` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `356` in source row; primary catalog entry pending
- Heji / 合集: `40459` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000278`
