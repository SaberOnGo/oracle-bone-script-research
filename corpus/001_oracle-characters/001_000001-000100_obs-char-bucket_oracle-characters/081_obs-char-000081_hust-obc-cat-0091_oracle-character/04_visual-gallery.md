# obs-char-000081 Visual Gallery / obs-char-000081 图像资料页
...
- Project ID / 项目 ID: `obs-char-000081`
- Primary external reference / 首选外部参考: `hust-obc-cat-0091`
...
## obs-char-000081-visual-source-001 / 图像条目

![obs-char-000081 glyph candidate](03_visual-assets/001_asset-000086_hust-obc-cat-0091_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000086_hust-obc-cat-0091_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000086_hust-obc-cat-0091_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/0091/G_0091_甲骨文.png`
