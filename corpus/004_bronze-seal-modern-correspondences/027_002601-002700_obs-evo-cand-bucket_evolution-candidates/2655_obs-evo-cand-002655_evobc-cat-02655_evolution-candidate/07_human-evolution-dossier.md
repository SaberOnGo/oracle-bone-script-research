...
Project ID: `obs-evo-cand-002655`
...
- Project ID: `obs-evo-cand-002655`
- EVOBC category candidate ID: `evobc-evo-cat-02655`
- External category reference: `evobc-cat-02655`
- Source category ID: `02655`
- Source label for human review: `帤`
- Source codepoints: `U+5E24`
...
- `obs-evo-cand-002655-route-category-staging`
...
- `obs-evo-cand-002655-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002655-route-evolution-graph`
