# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000720
...
| --- | --- | --- | --- |
| `obimd-glyph-link-010475` | 󴆻 | `U+F41BB` | `reviewed_metadata_only` |
| `obimd-glyph-link-010476` | 󴆼 | `U+F41BC` | `reviewed_metadata_only` |
| `obimd-glyph-link-010477` | 󴆽 | `U+F41BD` | `reviewed_metadata_only` |
