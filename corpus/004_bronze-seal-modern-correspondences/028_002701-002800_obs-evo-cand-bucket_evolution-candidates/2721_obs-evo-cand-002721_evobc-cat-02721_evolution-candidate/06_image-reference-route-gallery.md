...
- `obs-evo-cand-002721-route-category-staging`
...
- `obs-evo-cand-002721-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002721-route-evolution-graph`
