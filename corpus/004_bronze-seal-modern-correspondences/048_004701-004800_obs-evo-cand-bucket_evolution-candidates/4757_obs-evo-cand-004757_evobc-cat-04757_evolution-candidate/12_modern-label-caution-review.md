# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004757
...
- EVOBC candidate category: `evobc-evo-cat-04757`.
- Source label for search only: `渝`.
- Source codepoints for search only: `U+6E1D`.
