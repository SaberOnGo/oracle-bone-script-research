...
- `obs-evo-cand-003905-route-category-staging`
...
- `obs-evo-cand-003905-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003905-route-evolution-graph`
