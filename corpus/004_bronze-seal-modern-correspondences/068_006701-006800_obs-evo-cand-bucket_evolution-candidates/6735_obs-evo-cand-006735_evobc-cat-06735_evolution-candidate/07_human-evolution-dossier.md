...
- External category reference: `evobc-cat-06735`
- Source category ID: `06735`
- Source label for human review: `纺`
- Source codepoints: `U+7EBA`
...
- `obs-evo-cand-006735-route-category-staging`
...
- `obs-evo-cand-006735-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006735-route-evolution-graph`
