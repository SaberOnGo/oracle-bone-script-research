...
- External category reference: `evobc-cat-03994`
- Source category ID: `03994`
- Source label for human review: `栙`
- Source codepoints: `U+6819`
...
- `obs-evo-cand-003994-route-category-staging`
...
- `obs-evo-cand-003994-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003994-route-evolution-graph`
