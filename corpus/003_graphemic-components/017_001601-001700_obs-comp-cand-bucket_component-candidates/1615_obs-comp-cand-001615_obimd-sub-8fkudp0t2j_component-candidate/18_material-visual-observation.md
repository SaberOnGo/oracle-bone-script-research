# Material Visual Observation / obs-comp-cand-001615 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001615`
- External reference / 外部参照: `obimd-sub-8fkudp0t2j`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017291_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8fkudp0t2j/8fkudp0t2j/8fkudp0t2j.png`
- Checksum / 校验和:
  `c7cd987c82fa76909bec045878c9f3a84c7c40c3ea1710f422ae089017feed17`
...
- Marked-pixel bounds: (89,17)–(163,231); span 75 × 215 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.77%。
- 痕迹范围：(89,17)–(163,231)；跨度75 × 215 px；痕迹矩形高于宽。
