...
- External category reference: `evobc-cat-00992`
- Source category ID: `00992`
- Source label for human review: `傭`
- Source codepoints: `U+50AD`
...
- `obs-evo-cand-000992-route-category-staging`
...
- `obs-evo-cand-000992-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000992-route-evolution-graph`
