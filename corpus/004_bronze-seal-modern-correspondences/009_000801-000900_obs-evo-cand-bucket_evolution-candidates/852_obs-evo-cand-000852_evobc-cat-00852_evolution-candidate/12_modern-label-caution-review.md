# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000852
...
- EVOBC candidate category: `evobc-evo-cat-00852`.
- Source label for search only: `侚`.
- Source codepoints for search only: `U+4F9A`.
