...
Project ID: `obs-evo-cand-001700`
...
- Project ID: `obs-evo-cand-001700`
- EVOBC category candidate ID: `evobc-evo-cat-01700`
- External category reference: `evobc-cat-01700`
- Source category ID: `01700`
- Source label for human review: `嘗`
- Source codepoints: `U+5617`
...
- `obs-evo-cand-001700-route-category-staging`
...
- `obs-evo-cand-001700-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001700-route-evolution-graph`
