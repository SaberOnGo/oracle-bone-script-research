# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006485
...
- EVOBC candidate category: `evobc-evo-cat-06485`.
- Source label for search only: `紼`.
- Source codepoints for search only: `U+7D3C`.
