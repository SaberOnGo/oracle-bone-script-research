...
Project ID: `obs-evo-cand-000640`
...
- Project ID: `obs-evo-cand-000640`
- EVOBC category candidate ID: `evobc-evo-cat-00640`
- External category reference: `evobc-cat-00640`
- Source category ID: `00640`
- Source label for human review: `串`
- Source codepoints: `U+4E32`
...
- `obs-evo-cand-000640-route-category-staging`
...
- `obs-evo-cand-000640-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000640-route-evolution-graph`
