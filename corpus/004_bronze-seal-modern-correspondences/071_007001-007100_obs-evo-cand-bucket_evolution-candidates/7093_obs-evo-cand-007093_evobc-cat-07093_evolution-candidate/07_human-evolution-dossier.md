...
- Project ID: `obs-evo-cand-007093`
- EVOBC category candidate ID: `evobc-evo-cat-07093`
- External category reference: `evobc-cat-07093`
- Source category ID: `07093`
- Source label for human review: `腐`
- Source codepoints: `U+8150`
...
- `obs-evo-cand-007093-route-category-staging`
...
- `obs-evo-cand-007093-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007093-route-evolution-graph`
