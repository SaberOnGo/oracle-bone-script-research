# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002471
...
| --- | --- | --- | --- |
| `obimd-glyph-link-038049` | 󾅵 | `U+FE175` | `reviewed_metadata_only` |
| `obimd-glyph-link-038050` | 󾅶 | `U+FE176` | `reviewed_metadata_only` |
