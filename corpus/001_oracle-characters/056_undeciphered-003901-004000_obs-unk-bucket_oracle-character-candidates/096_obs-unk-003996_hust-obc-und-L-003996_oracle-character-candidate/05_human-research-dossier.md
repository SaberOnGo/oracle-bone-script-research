# obs-unk-003996 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003996`
- primary external id: `hust-obc-und-L-003996`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/096_obs-unk-003996_h
  ust-obc-und-L-003996_oracle-character-candidate/03_visual-assets/001_asset
  -005589_hust-obc-und-L-003996_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3996/L_？_8455.jpg`
- asset id: `asset-005589`
...
- source class: `HUST-OBC/undeciphered/L/3996/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3996/L_？_8455.jpg`
- asset id: `asset-005589`
...
- English observation: A narrow upper trace has a short side branch; fine
  strokes descend beneath it and the lower edge is faint.
- 中文观察：上部窄痕迹带有短侧向分支；细痕迹向下延伸，下缘较淡。
...
- Which source records identify obs-unk-003996 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003996？
