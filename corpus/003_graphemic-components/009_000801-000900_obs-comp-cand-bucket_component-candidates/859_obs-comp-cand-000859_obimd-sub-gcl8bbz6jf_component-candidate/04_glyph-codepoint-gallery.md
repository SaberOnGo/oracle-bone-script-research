# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000859
...
| --- | --- | --- | --- |
| `obimd-glyph-link-012447` | 󴷨 | `U+F4DE8` | `reviewed_metadata_only` |
| `obimd-glyph-link-012448` | 󴷩 | `U+F4DE9` | `reviewed_metadata_only` |
| `obimd-glyph-link-012449` | 󴷪 | `U+F4DEA` | `reviewed_metadata_only` |
