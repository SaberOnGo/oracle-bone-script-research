...
- `obs-evo-cand-006568-route-category-staging`
...
- `obs-evo-cand-006568-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006568-route-evolution-graph`
