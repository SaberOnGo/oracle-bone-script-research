...
- External category reference: `evobc-cat-10600`
- Source category ID: `10600`
- Source label for human review: `麂`
...
- `obs-evo-cand-010600-route-category-staging`
...
- `obs-evo-cand-010600-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010600-route-evolution-graph`
