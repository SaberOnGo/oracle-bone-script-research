# Material Visual Observation / obs-comp-cand-001305 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001305`
- External reference / 外部参照: `obimd-sub-lcxtisdp6y`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015642_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lcxtisdp6y/lcxtisdp6y/lcxtisdp6y.png`
- Checksum / 校验和:
  `a5c376e3342fec3a32f0d4602cc81c0feef4a37580b775085e4cd17441bcaf4a`
...
- Marked-pixel bounds: (84,33)–(164,218); span 81 × 186 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.80%。
- 痕迹范围：(84,33)–(164,218)；跨度81 × 186 px；痕迹矩形高于宽。
