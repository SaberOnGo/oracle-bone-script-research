# obs-unk-005172 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/068_undeciphered-005
  101-005200_obs-unk-bucket_oracle-character-candidates/072_obs-unk-005172_h
  ust-obc-und-X-005172_oracle-character-candidate/03_visual-assets/001_asset
  -006765_hust-obc-und-X-005172_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/728/X_？_7694_1.png`
- asset id: `asset-006765`
...
- source class: `HUST-OBC/undeciphered/X/728/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/728/X_？_7694_1.png`
- asset id: `asset-006765`
...
- Which source records identify obs-unk-005172 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005172？
