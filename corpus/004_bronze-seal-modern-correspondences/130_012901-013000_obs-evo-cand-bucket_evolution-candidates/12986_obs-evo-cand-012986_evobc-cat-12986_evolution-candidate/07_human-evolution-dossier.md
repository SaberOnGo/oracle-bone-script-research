...
- Project ID: `obs-evo-cand-012986`
- EVOBC category candidate ID: `evobc-evo-cat-12986`
- External category reference: `evobc-cat-12986`
- Source category ID: `12986`
- Source label for human review: `𫞤`
- Source codepoints: `U+2B7A4`
...
- `obs-evo-cand-012986-route-category-staging`
...
- `obs-evo-cand-012986-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012986-route-evolution-graph`
