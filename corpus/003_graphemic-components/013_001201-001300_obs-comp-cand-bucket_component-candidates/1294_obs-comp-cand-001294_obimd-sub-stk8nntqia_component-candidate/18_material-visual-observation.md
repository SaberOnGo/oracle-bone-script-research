# Material Visual Observation / obs-comp-cand-001294 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001294`
- External reference / 外部参照: `obimd-sub-stk8nntqia`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015579_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h8exoqnpru/stk8nntqia/0rdl6fpa7a.png`
- Checksum / 校验和:
  `246e796d4d5aa93f4645f1632a133166f3f97d34ec65136c827abb3aa1464a8f`
...
- Marked-pixel bounds: (89,33)–(160,220); span 72 × 188 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.06%。
- 痕迹范围：(89,33)–(160,220)；跨度72 × 188 px；痕迹矩形高于宽。
