...
Project ID: `obs-evo-cand-001647`
...
- Project ID: `obs-evo-cand-001647`
- EVOBC category candidate ID: `evobc-evo-cat-01647`
- External category reference: `evobc-cat-01647`
- Source category ID: `01647`
- Source label for human review: `喘`
- Source codepoints: `U+5598`
...
- `obs-evo-cand-001647-route-category-staging`
...
- `obs-evo-cand-001647-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001647-route-evolution-graph`
