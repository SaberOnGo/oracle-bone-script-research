# obs-char-000947 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000947`
- primary external id: `hust-obc-cat-1064`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/947_obs-char-000947_hust-obc-cat-1064_orac
  le-character/03_visual-assets/001_asset-000952_hust-obc-cat-1064_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1064/G_1064_存下731(甲).png`
- asset id: `asset-000952`
...
- source category: `1064`
- validation class: `946`
- source image route: `HUST-OBC/deciphered/1064/G_1064_存下731(甲).png`
- asset id: `asset-000952`
...
- English observation: `A rectangular central loop sits between an upper
  angled mark and a long right curve with two short cross-strokes.`
- 中文观察: `矩形中央环状轮廓位于上部斜向痕迹和长右弯笔之间，右侧带两条短横笔。`
...
- dataset label text: `㠞`
- dataset label codepoints: `U+381E`
...
- Which source records identify obs-char-000947 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000947？
