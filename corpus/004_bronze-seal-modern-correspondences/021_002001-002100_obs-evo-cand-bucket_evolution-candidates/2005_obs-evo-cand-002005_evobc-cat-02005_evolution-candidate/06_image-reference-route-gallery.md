...
- `obs-evo-cand-002005-route-category-staging`
...
- `obs-evo-cand-002005-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002005-route-evolution-graph`
