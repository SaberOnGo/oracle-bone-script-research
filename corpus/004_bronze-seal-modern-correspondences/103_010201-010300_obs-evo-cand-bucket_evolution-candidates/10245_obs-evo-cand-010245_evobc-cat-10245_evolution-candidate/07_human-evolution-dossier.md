...
- Project ID: `obs-evo-cand-010245`
- EVOBC category candidate ID: `evobc-evo-cat-10245`
- External category reference: `evobc-cat-10245`
- Source category ID: `10245`
- Source label for human review: `驃`
- Source codepoints: `U+9A43`
...
- `obs-evo-cand-010245-route-category-staging`
...
- `obs-evo-cand-010245-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010245-route-evolution-graph`
