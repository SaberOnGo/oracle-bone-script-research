...
Project ID: `obs-evo-cand-003790`
...
- Project ID: `obs-evo-cand-003790`
- EVOBC category candidate ID: `evobc-evo-cat-03790`
- External category reference: `evobc-cat-03790`
- Source category ID: `03790`
- Source label for human review: `暺`
- Source codepoints: `U+66BA`
...
- `obs-evo-cand-003790-route-category-staging`
...
- `obs-evo-cand-003790-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003790-route-evolution-graph`
