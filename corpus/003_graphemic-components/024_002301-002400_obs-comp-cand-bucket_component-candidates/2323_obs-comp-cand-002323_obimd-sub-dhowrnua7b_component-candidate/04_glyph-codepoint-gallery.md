# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002323
...
| --- | --- | --- | --- |
| `obimd-glyph-link-035811` | 󽕍 | `U+FD54D` | `reviewed_metadata_only` |
| `obimd-glyph-link-035812` | 󽕎 | `U+FD54E` | `reviewed_metadata_only` |
| `obimd-glyph-link-035813` | 󽕏 | `U+FD54F` | `reviewed_metadata_only` |
| `obimd-glyph-link-035814` | 󽕐 | `U+FD550` | `reviewed_metadata_only` |
| `obimd-glyph-link-035815` | 󽕑 | `U+FD551` | `reviewed_metadata_only` |
