# obs-char-000397 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000397`
- primary external id: `hust-obc-cat-0450`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/397_obs-char-000397_hust-obc-cat-0450_orac
  le-character/03_visual-assets/001_asset-000402_hust-obc-cat-0450_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0450/G_0450_乙2586反合2742反.png`
- asset id: `asset-000402`
...
- source category: `0450`
- validation class: `396`
- source image route: `HUST-OBC/deciphered/0450/G_0450_乙2586反合2742反.png`
- asset id: `asset-000402`
...
- English observation: `A narrow vertical trace passes through a small upper
  loop and continues into a long angular lower stroke.`
- 中文观察: `狭窄竖向痕迹穿过小型上部环形轮廓，并继续连接长折角下部笔画。`
...
- dataset label text: `㖸`
- dataset label codepoints: `U+35B8`
...
- filename catalog route clues: `Heji-like filename clue: 合2742
  (G_0450_乙2586反合2742反.png)`
...
- Which source records identify obs-char-000397 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000397？
