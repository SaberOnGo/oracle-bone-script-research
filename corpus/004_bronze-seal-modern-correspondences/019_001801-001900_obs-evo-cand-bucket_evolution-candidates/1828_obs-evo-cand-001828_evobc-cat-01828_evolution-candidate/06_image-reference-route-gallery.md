...
- `obs-evo-cand-001828-route-category-staging`
...
- `obs-evo-cand-001828-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001828-route-evolution-graph`
