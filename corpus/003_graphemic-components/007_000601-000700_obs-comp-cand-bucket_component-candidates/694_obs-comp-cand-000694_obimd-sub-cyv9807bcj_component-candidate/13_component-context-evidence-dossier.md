# obs-comp-cand-000694 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000694`
- 首选外部 ID: `obimd-sub-cyv9807bcj`
- OBIMD subcharacter UID: `cyv9807bcj`
- OBIMD main character UID: `cyv9807bcj`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+745F;U+F3F65; U+F3F66; 另有 3 项
