# obs-evo-cand-008533 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-08533`
- Source label: `貝`
- Source codepoints: `U+8C9D`
- Image reference count: `183`
- Era token counts: `BI:104;CS:1;OBC:52;SS:2;WSC:24`
- Source token counts: `Book:75;Web:108`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 52 image references
- era 1 / BI: 104 image references
