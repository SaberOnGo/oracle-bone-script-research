# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002479
...
| --- | --- | --- | --- |
| `obimd-glyph-link-038199` | 󾉀 | `U+FE240` | `reviewed_metadata_only` |
| `obimd-glyph-link-038200` | 󾉁 | `U+FE241` | `reviewed_metadata_only` |
| `obimd-glyph-link-038201` | 󾉂 | `U+FE242` | `reviewed_metadata_only` |
