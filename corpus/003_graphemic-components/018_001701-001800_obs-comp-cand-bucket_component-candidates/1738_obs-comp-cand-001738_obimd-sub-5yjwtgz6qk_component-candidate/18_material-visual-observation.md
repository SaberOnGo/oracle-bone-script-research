# Material Visual Observation / obs-comp-cand-001738 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001738`
- External reference / 外部参照: `obimd-sub-5yjwtgz6qk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017939_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/iuzkqe17tf/5yjwtgz6qk/5yjwtgz6qk.png`
- Checksum / 校验和:
  `7f886fa7b08a7dfed0fdd5cd8c49d8b287b43ee0954ab4ccd673212ef1d1a05e`
...
- Marked-pixel bounds: (78,38)–(171,213); span 94 × 176 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.77%。
- 痕迹范围：(78,38)–(171,213)；跨度94 × 176 px；痕迹矩形高于宽。
