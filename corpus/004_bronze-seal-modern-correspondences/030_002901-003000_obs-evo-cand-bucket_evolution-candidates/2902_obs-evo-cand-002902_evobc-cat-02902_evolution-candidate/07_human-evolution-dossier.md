...
Project ID: `obs-evo-cand-002902`
...
- Project ID: `obs-evo-cand-002902`
- EVOBC category candidate ID: `evobc-evo-cat-02902`
- External category reference: `evobc-cat-02902`
- Source category ID: `02902`
- Source label for human review: `忒`
- Source codepoints: `U+5FD2`
...
- `obs-evo-cand-002902-route-category-staging`
...
- `obs-evo-cand-002902-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002902-route-evolution-graph`
