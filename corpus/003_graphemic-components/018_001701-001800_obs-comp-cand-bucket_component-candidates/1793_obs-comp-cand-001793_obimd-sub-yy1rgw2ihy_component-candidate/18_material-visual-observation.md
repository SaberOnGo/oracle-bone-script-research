# Material Visual Observation / obs-comp-cand-001793 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001793`
- External reference / 外部参照: `obimd-sub-yy1rgw2ihy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018014_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fcooblbqyz/yy1rgw2ihy/yy1rgw2ihy.png`
- Checksum / 校验和:
  `019aec4a2b1e6ca9098144f7303a01fb8edf912bc6cf041925ca217b3094eee3`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.30%.
- Marked-pixel bounds: (57,41)–(206,214); span 150 × 174 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.30%。
- 痕迹范围：(57,41)–(206,214)；跨度150 × 174 px；痕迹矩形近方形。
