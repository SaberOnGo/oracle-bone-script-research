...
Project ID: `obs-evo-cand-012053`
...
- Project ID: `obs-evo-cand-012053`
- EVOBC category candidate ID: `evobc-evo-cat-12053`
- External category reference: `evobc-cat-12053`
- Source category ID: `12053`
- Source label for human review: `𦞀`
- Source codepoints: `U+26780`
...
- `obs-evo-cand-012053-route-category-staging`
...
- `obs-evo-cand-012053-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012053-route-evolution-graph`
