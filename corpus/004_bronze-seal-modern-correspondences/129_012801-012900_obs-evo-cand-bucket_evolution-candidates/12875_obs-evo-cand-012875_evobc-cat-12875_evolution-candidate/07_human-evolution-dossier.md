...
- External category reference: `evobc-cat-12875`
- Source category ID: `12875`
- Source label for human review: `𪵒`
- Source codepoints: `U+2AD52`
...
- `obs-evo-cand-012875-route-category-staging`
...
- `obs-evo-cand-012875-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012875-route-evolution-graph`
