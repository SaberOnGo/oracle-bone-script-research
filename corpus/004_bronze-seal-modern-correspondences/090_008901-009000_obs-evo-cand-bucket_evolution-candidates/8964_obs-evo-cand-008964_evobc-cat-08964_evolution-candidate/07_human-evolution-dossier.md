...
- External category reference: `evobc-cat-08964`
- Source category ID: `08964`
- Source label for human review: `迬`
- Source codepoints: `U+8FEC`
...
- `obs-evo-cand-008964-route-category-staging`
...
- `obs-evo-cand-008964-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008964-route-evolution-graph`
