...
- External category reference: `evobc-cat-00321`
- Source category ID: `00321`
- Source label for human review: `䋖`
- Source codepoints: `U+42D6`
...
- `obs-evo-cand-000321-route-category-staging`
...
- `obs-evo-cand-000321-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000321-route-evolution-graph`
