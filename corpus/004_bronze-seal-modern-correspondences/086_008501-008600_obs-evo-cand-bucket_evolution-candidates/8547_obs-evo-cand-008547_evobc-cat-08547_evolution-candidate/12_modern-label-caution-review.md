# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008547
...
- EVOBC candidate category: `evobc-evo-cat-08547`.
- Source label for search only: `貯`.
- Source codepoints for search only: `U+8CAF`.
