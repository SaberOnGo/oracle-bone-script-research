...
Project ID: `obs-evo-cand-005088`
...
- Project ID: `obs-evo-cand-005088`
- EVOBC category candidate ID: `evobc-evo-cat-05088`
- External category reference: `evobc-cat-05088`
- Source category ID: `05088`
- Source label for human review: `焛`
- Source codepoints: `U+711B`
...
- `obs-evo-cand-005088-route-category-staging`
...
- `obs-evo-cand-005088-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005088-route-evolution-graph`
