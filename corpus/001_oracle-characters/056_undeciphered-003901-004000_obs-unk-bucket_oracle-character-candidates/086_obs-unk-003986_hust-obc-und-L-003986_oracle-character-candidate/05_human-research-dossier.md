# obs-unk-003986 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/086_obs-unk-003986_h
  ust-obc-und-L-003986_oracle-character-candidate/03_visual-assets/001_asset
  -005579_hust-obc-und-L-003986_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3986/L_？_8440.jpg`
- asset id: `asset-005579`
...
- source class: `HUST-OBC/undeciphered/L/3986/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3986/L_？_8440.jpg`
- asset id: `asset-005579`
...
- English observation: The upper area has small upright branches; a central
  descending mark meets several lower curved strokes.
- 中文观察：上部有小型直立分支；中部下行痕迹与下方数条弯曲痕迹相接。
...
- Which source records identify obs-unk-003986 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003986？
