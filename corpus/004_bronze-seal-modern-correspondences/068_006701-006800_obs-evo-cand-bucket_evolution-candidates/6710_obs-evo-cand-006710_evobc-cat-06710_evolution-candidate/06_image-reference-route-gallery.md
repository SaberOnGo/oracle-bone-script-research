...
- `obs-evo-cand-006710-route-category-staging`
...
- `obs-evo-cand-006710-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006710-route-evolution-graph`
