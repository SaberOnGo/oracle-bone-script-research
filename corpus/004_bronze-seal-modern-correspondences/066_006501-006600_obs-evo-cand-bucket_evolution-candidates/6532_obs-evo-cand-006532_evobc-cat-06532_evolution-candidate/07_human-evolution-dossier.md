...
- Project ID: `obs-evo-cand-006532`
- EVOBC category candidate ID: `evobc-evo-cat-06532`
- External category reference: `evobc-cat-06532`
- Source category ID: `06532`
- Source label for human review: `綀`
- Source codepoints: `U+7D80`
...
- `obs-evo-cand-006532-route-category-staging`
...
- `obs-evo-cand-006532-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006532-route-evolution-graph`
