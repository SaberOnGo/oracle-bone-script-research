...
- External category reference: `evobc-cat-00288`
- Source category ID: `00288`
- Source label for human review: `䅆`
- Source codepoints: `U+4146`
...
- `obs-evo-cand-000288-route-category-staging`
...
- `obs-evo-cand-000288-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000288-route-evolution-graph`
