...
Project ID: `obs-evo-cand-009380`
...
- Project ID: `obs-evo-cand-009380`
- EVOBC category candidate ID: `evobc-evo-cat-09380`
- External category reference: `evobc-cat-09380`
- Source category ID: `09380`
- Source label for human review: `銄`
- Source codepoints: `U+9284`
...
- `obs-evo-cand-009380-route-category-staging`
...
- `obs-evo-cand-009380-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009380-route-evolution-graph`
