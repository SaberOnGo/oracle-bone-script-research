...
Project ID: `obs-evo-cand-004374`
...
- Project ID: `obs-evo-cand-004374`
- EVOBC category candidate ID: `evobc-evo-cat-04374`
- External category reference: `evobc-cat-04374`
- Source category ID: `04374`
- Source label for human review: `歑`
- Source codepoints: `U+6B51`
...
- `obs-evo-cand-004374-route-category-staging`
...
- `obs-evo-cand-004374-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004374-route-evolution-graph`
