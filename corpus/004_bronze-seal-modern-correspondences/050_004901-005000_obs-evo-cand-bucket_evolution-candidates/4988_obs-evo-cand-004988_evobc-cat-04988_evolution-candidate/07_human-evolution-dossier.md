...
- Project ID: `obs-evo-cand-004988`
- EVOBC category candidate ID: `evobc-evo-cat-04988`
- External category reference: `evobc-cat-04988`
- Source category ID: `04988`
- Source label for human review: `瀗`
- Source codepoints: `U+7017`
...
- `obs-evo-cand-004988-route-category-staging`
...
- `obs-evo-cand-004988-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004988-route-evolution-graph`
