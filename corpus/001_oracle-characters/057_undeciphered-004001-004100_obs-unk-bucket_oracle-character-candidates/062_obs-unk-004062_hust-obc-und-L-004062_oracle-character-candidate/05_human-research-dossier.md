# obs-unk-004062 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004062`
- primary external id: `hust-obc-und-L-004062`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/062_obs-unk-004062_h
  ust-obc-und-L-004062_oracle-character-candidate/03_visual-assets/001_asset
  -005655_hust-obc-und-L-004062_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4062/L_？_8695.jpg`
- asset id: `asset-005655`
...
- source class: `HUST-OBC/undeciphered/L/4062/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4062/L_？_8695.jpg`
- asset id: `asset-005655`
...
- English observation: Several short upward traces stand above a broad lower
  rounded or rectangular contour. Dark interior bands are visible within the
  lower area. The upper-to-lower connections remain uncertain.
- 中文观察：宽大的下部圆弧或矩形轮廓上方有数条短的向上痕迹。下部内部可见
  较深的带状痕迹。上下区域的连接关系仍待核查。
...
- Which source records identify obs-unk-004062 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004062？
