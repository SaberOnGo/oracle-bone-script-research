...
- `obs-evo-cand-009440-route-category-staging`
...
- `obs-evo-cand-009440-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009440-route-evolution-graph`
