# Material Visual Observation / obs-comp-cand-002657 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002657`
- External reference / 外部参照: `obimd-sub-xkmcvrx1mq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021233_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xkmcvrx1mq/xkmcvrx1mq/xkmcvrx1mq.png`
- Checksum / 校验和:
  `750ef859921c37328c61dba03e565f695eacb122939dae207402c9a80b51a3e9`
...
- Marked-pixel bounds: (43,28)–(216,217); span 174 × 190 px; the marked
...
- 痕迹范围：(43,28)–(216,217)；跨度174 × 190 px；痕迹矩形近方形。
