# obs-unk-001709 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-001709`
- primary external id: `hust-obc-und-L-001709`
...
- local review image route: `corpus/001_oracle-characters/034_undeciphered-001
  701-001800_obs-unk-bucket_oracle-character-candidates/009_obs-unk-001709_h
  ust-obc-und-L-001709_oracle-character-candidate/03_visual-assets/001_asset
  -003302_hust-obc-und-L-001709_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/1709/L_？_1470.jpg`
- asset id: `asset-003302`
...
- source class: `HUST-OBC/undeciphered/L/1709/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/1709/L_？_1470.jpg`
- asset id: `asset-003302`
...
- Which source records identify obs-unk-001709 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-001709？
