# Human Research Readiness Review / 人类研究准备度复核: coll-obj-cand-00058
...
| --- | --- | --- |
| Catalog source | `OA+.165` | `02_collection-source-index.csv` |
| Visual evidence | `no_committed_visual_asset` | `04_visual-gallery.md` |
| Findspot route | `China` | `08_collection-provenance-evidence-dossier.md` |
