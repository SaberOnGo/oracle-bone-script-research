# Material Visual Observation / obs-comp-cand-001035 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001035`
- External reference / 外部参照: `obimd-sub-urmkru9gei`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014528_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fbmole6hwm/urmkru9gei/urmkru9gei.png`
- Checksum / 校验和:
  `252871f9b403c0b081a7952a737cf1c781000732fe563f34481e4e354f7e063a`
...
- Marked-pixel bounds: (82,19)–(166,229); span 85 × 211 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.10%。
- 痕迹范围：(82,19)–(166,229)；跨度85 × 211 px；痕迹矩形高于宽。
