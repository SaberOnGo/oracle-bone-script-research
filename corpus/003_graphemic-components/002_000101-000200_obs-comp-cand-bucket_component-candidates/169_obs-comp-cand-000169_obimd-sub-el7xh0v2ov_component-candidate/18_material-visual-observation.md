# Material Visual Observation / obs-comp-cand-000169 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000169`
- External reference / 外部参照: `obimd-sub-el7xh0v2ov`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011581_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/el7xh0v2ov/el7xh0v2ov/el7xh0v2ov.png`
- Checksum / 校验和:
  `d3147d1943a8f8f237d24a81fe88a20854e1c5e1b92b1ce99f8d3245e0f03af6`
...
- Marked-pixel bounds: (80,19)–(168,230); span 89 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.67%。
- 痕迹范围：(80,19)–(168,230)；跨度89 × 212 px；痕迹矩形高于宽。
