...
- Project ID: `obs-evo-cand-000711`
- EVOBC category candidate ID: `evobc-evo-cat-00711`
- External category reference: `evobc-cat-00711`
- Source category ID: `00711`
- Source label for human review: `亲`
- Source codepoints: `U+4EB2`
...
- `obs-evo-cand-000711-route-category-staging`
...
- `obs-evo-cand-000711-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000711-route-evolution-graph`
