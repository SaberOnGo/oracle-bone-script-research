...
- External category reference: `evobc-cat-00734`
- Source category ID: `00734`
- Source label for human review: `仕`
...
- `obs-evo-cand-000734-route-category-staging`
...
- `obs-evo-cand-000734-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000734-route-evolution-graph`
