...
- External category reference: `evobc-cat-12364`
- Source category ID: `12364`
- Source label for human review: `𨓁`
...
- `obs-evo-cand-012364-route-category-staging`
...
- `obs-evo-cand-012364-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012364-route-evolution-graph`
