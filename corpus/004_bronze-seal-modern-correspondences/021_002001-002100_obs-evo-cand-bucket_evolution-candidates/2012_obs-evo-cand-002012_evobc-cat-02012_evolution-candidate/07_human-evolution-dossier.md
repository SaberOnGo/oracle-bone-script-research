...
Project ID: `obs-evo-cand-002012`
...
- Project ID: `obs-evo-cand-002012`
- EVOBC category candidate ID: `evobc-evo-cat-02012`
- External category reference: `evobc-cat-02012`
- Source category ID: `02012`
- Source label for human review: `夫`
- Source codepoints: `U+592B`
- Image reference count in source metadata: `279`
...
- `obs-evo-cand-002012-route-category-staging`
...
- `obs-evo-cand-002012-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002012-route-evolution-graph`
