# Material Visual Observation / obs-comp-cand-000802 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000802`
- External reference / 外部参照: `obimd-sub-cawhttc4j5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013599_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cawhttc4j5/cawhttc4j5/cawhttc4j5.png`
- Checksum / 校验和:
  `d60f800b69ed984bb1270fecffdfcdf5ad6cc7fece2ac9e8f31022b44a77c06a`
...
- Marked-pixel bounds: (64,33)–(185,219); span 122 × 187 px; the marked
...
- 痕迹范围：(64,33)–(185,219)；跨度122 × 187 px；痕迹矩形高于宽。
