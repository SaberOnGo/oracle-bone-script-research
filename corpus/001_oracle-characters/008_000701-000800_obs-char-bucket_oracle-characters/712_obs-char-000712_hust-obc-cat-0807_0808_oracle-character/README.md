# obs-char-000712 Local Object Materials / obs-char-000712 本地对象资料
...
- Project ID / 项目 ID: `obs-char-000712`
- Primary external reference / 首选外部参考: `hust-obc-cat-0807_0808`
- Source / 来源: `src-hust-obc`
- Packet record type / 资料包类型: `oracle_character_candidate_packet`
- Directory / 目录: `corpus/001_oracle-characters/008_000701-000800_obs-char-bucke
  t_oracle-characters/712_obs-char-000712_hust-obc-cat-0807_0808_oracle-characte
  r`
...
- Committed glyph image / 已提交字形图像:
  03_visual-assets/001_asset-000717_hust-obc-cat-0807_0808_glyph.png
