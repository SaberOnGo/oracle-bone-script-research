...
- External category reference: `evobc-cat-00283`
- Source category ID: `00283`
- Source label for human review: `䃺`
- Source codepoints: `U+40FA`
...
- `obs-evo-cand-000283-route-category-staging`
...
- `obs-evo-cand-000283-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000283-route-evolution-graph`
