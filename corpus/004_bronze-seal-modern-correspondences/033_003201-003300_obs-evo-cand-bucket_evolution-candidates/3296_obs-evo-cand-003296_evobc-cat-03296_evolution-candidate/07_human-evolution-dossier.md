...
- External category reference: `evobc-cat-03296`
- Source category ID: `03296`
- Source label for human review: `抱`
- Source codepoints: `U+62B1`
...
- `obs-evo-cand-003296-route-category-staging`
...
- `obs-evo-cand-003296-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003296-route-evolution-graph`
