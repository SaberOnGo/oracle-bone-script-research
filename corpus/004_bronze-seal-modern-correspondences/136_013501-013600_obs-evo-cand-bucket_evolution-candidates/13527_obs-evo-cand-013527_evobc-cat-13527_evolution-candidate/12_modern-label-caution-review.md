# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013527
...
- EVOBC candidate category: `evobc-evo-cat-13527`.
- Source label for search only: `𭝼`.
- Source codepoints for search only: `U+2D77C`.
