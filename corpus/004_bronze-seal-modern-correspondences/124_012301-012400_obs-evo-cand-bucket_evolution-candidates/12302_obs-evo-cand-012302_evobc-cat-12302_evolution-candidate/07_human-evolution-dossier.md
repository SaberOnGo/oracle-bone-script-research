...
- External category reference: `evobc-cat-12302`
- Source category ID: `12302`
- Source label for human review: `𧻿`
...
- `obs-evo-cand-012302-route-category-staging`
...
- `obs-evo-cand-012302-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012302-route-evolution-graph`
