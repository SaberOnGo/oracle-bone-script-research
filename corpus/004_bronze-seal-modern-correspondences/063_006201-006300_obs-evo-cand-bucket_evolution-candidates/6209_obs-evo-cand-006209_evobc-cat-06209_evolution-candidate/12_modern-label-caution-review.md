# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006209
...
- EVOBC candidate category: `evobc-evo-cat-06209`.
- Source label for search only: `竪`.
- Source codepoints for search only: `U+7AEA`.
