...
- Project ID: `obs-evo-cand-012131`
- EVOBC category candidate ID: `evobc-evo-cat-12131`
- External category reference: `evobc-cat-12131`
- Source category ID: `12131`
- Source label for human review: `𧁘`
- Source codepoints: `U+27058`
...
- `obs-evo-cand-012131-route-category-staging`
...
- `obs-evo-cand-012131-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012131-route-evolution-graph`
