...
- Project ID: `obs-evo-cand-008302`
- EVOBC category candidate ID: `evobc-evo-cat-08302`
- External category reference: `evobc-cat-08302`
- Source category ID: `08302`
- Source label for human review: `謀`
- Source codepoints: `U+8B00`
...
- `obs-evo-cand-008302-route-category-staging`
...
- `obs-evo-cand-008302-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008302-route-evolution-graph`
