# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001893
...
| Glyph or codepoint route / 字形或码位路线 | 32 OBIMD route rows; examples U+AE783;U+FACF3; U+FACF4; 另有 30 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 32 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
