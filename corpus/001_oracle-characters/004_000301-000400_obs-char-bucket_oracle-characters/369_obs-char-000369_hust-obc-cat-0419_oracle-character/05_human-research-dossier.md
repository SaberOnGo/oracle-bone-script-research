# obs-char-000369 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/369_obs-char-000369_hust-obc-cat-0419_orac
  le-character/03_visual-assets/001_asset-000374_hust-obc-cat-0419_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0419/G_0419_乙4072反合376反賓組.png`
- asset id: `asset-000374`
...
- source category: `0419`
- validation class: `368`
- source image route: `HUST-OBC/deciphered/0419/G_0419_乙4072反合376反賓組.png`
- asset id: `asset-000374`
...
- English observation: `A curved leaf-like upper contour is joined to a thin
  stem with short side strokes and a pointed lower extension.`
- 中文观察: `弧形叶状上部轮廓连接纤细主干，两侧有短笔画，下方有尖状延伸。`
...
- dataset label text: `㖙`
- dataset label codepoints: `U+3599`
...
- Which source records identify obs-char-000369 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000369？
