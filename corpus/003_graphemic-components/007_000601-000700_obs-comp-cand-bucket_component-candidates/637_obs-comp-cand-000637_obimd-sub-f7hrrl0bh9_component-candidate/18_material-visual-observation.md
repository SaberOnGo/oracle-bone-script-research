# Material Visual Observation / obs-comp-cand-000637 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000637`
- External reference / 外部参照: `obimd-sub-f7hrrl0bh9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013200_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/f7hrrl0bh9/f7hrrl0bh9/f7hrrl0bh9.png`
- Checksum / 校验和:
  `ada8799c0982b8882bb45c570c8ed119cb5b7b7ad852ae9009fdeda5364d2e4f`
...
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.73%。
