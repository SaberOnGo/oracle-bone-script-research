...
- `obs-evo-cand-002993-route-category-staging`
...
- `obs-evo-cand-002993-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002993-route-evolution-graph`
