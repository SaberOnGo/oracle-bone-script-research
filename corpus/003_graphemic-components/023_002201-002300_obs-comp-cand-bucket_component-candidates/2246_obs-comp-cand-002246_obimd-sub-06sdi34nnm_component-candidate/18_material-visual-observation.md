# Material Visual Observation / obs-comp-cand-002246 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002246`
- External reference / 外部参照: `obimd-sub-06sdi34nnm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020059_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/06sdi34nnm/06sdi34nnm/06sdi34nnm.png`
- Checksum / 校验和:
  `0f78ed826cf45a63666cc35c3cb33ec88289e603aafbc531a6946fc2a6d2f55c`
...
- Marked-pixel bounds: (39,26)–(218,223); span 180 × 198 px; the marked
...
- 痕迹范围：(39,26)–(218,223)；跨度180 × 198 px；痕迹矩形近方形。
