# obs-char-001135 Visual Gallery / obs-char-001135 图像资料页
...
- Project ID / 项目 ID: `obs-char-001135`
- Primary external reference / 首选外部参考: `hust-obc-cat-1268`
...
## obs-char-001135-visual-source-001 / 图像条目

![obs-char-001135 glyph candidate](03_visual-assets/001_asset-001140_hust-obc-cat-1268_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-001140_hust-obc-cat-1268_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-001140_hust-obc-cat-1268_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/1268/G_1268_乙12合21021𠂤組.png`
