...
- External category reference: `evobc-cat-07845`
- Source category ID: `07845`
- Source label for human review: `蟄`
...
- `obs-evo-cand-007845-route-category-staging`
...
- `obs-evo-cand-007845-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007845-route-evolution-graph`
