# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010286
...
- EVOBC candidate category: `evobc-evo-cat-10286`.
- Source label for search only: `骚`.
- Source codepoints for search only: `U+9A9A`.
