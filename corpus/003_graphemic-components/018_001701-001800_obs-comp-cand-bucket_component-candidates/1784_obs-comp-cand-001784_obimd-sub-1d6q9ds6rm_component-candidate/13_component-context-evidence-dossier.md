# obs-comp-cand-001784 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001784`
- 首选外部 ID: `obimd-sub-1d6q9ds6rm`
- OBIMD subcharacter UID: `1d6q9ds6rm`
- OBIMD main character UID: `1d6q9ds6rm`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+A9952;U+A99B3;U+FA410; U+FA411; 另有 3 项
