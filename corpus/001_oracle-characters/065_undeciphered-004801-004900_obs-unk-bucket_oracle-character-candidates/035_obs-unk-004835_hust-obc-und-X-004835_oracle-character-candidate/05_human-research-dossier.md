# obs-unk-004835 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004835`
- primary external id: `hust-obc-und-X-004835`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/035_obs-unk-004835_h
  ust-obc-und-X-004835_oracle-character-candidate/03_visual-assets/001_asset
  -006428_hust-obc-und-X-004835_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/391/X_？_7374_1.png`
- asset id: `asset-006428`
...
- source class: `HUST-OBC/undeciphered/X/391/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/391/X_？_7374_1.png`
- asset id: `asset-006428`
- source image count: `12`
...
- English observation: `branched left group and right loop with lower opening`
- 中文观察: `左侧分支结构、右侧环状结构和下部开口`
...
- Which source records identify obs-unk-004835 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004835？
