...
- External category reference: `evobc-cat-01767`
- Source category ID: `01767`
- Source label for human review: `囷`
- Source codepoints: `U+56F7`
...
- `obs-evo-cand-001767-route-category-staging`
...
- `obs-evo-cand-001767-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001767-route-evolution-graph`
