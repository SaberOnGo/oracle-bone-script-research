...
Project ID: `obs-evo-cand-006493`
...
- Project ID: `obs-evo-cand-006493`
- EVOBC category candidate ID: `evobc-evo-cat-06493`
- External category reference: `evobc-cat-06493`
- Source category ID: `06493`
- Source label for human review: `絆`
- Source codepoints: `U+7D46`
...
- `obs-evo-cand-006493-route-category-staging`
...
- `obs-evo-cand-006493-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006493-route-evolution-graph`
