# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006351
...
- EVOBC candidate category: `evobc-evo-cat-06351`.
- Source label for search only: `簟`.
- Source codepoints for search only: `U+7C1F`.
