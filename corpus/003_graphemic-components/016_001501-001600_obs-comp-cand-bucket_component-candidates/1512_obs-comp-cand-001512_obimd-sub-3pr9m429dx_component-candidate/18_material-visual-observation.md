# Material Visual Observation / obs-comp-cand-001512 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001512`
- External reference / 外部参照: `obimd-sub-3pr9m429dx`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016475_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/w4frb60x9v/3pr9m429dx/3pr9m429dx.png`
- Checksum / 校验和:
  `95aa567c92ed596b42bf0a32741fc2b6a93ca599b32e1c8757d20b22030ea8b6`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.50%.
- Marked-pixel bounds: (81,41)–(168,204); span 88 × 164 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.50%。
- 痕迹范围：(81,41)–(168,204)；跨度88 × 164 px；痕迹矩形高于宽。
