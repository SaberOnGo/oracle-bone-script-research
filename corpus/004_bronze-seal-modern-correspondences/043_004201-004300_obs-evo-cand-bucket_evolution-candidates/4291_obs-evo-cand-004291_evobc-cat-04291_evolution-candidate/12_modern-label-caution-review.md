# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004291
...
- EVOBC candidate category: `evobc-evo-cat-04291`.
- Source label for search only: `檜`.
- Source codepoints for search only: `U+6A9C`.
