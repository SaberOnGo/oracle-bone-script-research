...
- `obs-evo-cand-011060-route-category-staging`
...
- `obs-evo-cand-011060-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011060-route-evolution-graph`
