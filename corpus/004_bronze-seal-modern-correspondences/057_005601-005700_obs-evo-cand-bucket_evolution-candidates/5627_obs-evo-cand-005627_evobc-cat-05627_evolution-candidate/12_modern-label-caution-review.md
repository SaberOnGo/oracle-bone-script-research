# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-005627
...
- EVOBC candidate category: `evobc-evo-cat-05627`.
- Source label for search only: `疽`.
- Source codepoints for search only: `U+75BD`.
