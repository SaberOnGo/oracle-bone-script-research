# Material Visual Observation / obs-comp-cand-002306 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002306`
- External reference / 外部参照: `obimd-sub-4kwdakepca`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020325_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/s65fsavh28/4kwdakepca/4kwdakepca.png`
- Checksum / 校验和:
  `f9392ea29622b7133ec342845db7054dd68f361c299532ea95752cb61cdcd662`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.15%.
- Marked-pixel bounds: (86,14)–(159,232); span 74 × 219 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.15%。
- 痕迹范围：(86,14)–(159,232)；跨度74 × 219 px；痕迹矩形高于宽。
