...
- External category reference: `evobc-cat-08378`
- Source category ID: `08378`
- Source label for human review: `譺`
...
- `obs-evo-cand-008378-route-category-staging`
...
- `obs-evo-cand-008378-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008378-route-evolution-graph`
