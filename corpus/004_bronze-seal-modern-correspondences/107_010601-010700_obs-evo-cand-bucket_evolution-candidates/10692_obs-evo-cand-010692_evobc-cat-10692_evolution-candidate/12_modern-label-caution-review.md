# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010692
...
- EVOBC candidate category: `evobc-evo-cat-10692`.
- Source label for search only: `鼛`.
- Source codepoints for search only: `U+9F1B`.
