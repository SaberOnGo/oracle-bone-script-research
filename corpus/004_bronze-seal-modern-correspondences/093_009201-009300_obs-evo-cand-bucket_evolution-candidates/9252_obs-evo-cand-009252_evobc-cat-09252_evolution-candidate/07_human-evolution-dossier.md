...
Project ID: `obs-evo-cand-009252`
...
- Project ID: `obs-evo-cand-009252`
- EVOBC category candidate ID: `evobc-evo-cat-09252`
- External category reference: `evobc-cat-09252`
- Source category ID: `09252`
- Source label for human review: `酬`
- Source codepoints: `U+916C`
...
- `obs-evo-cand-009252-route-category-staging`
...
- `obs-evo-cand-009252-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009252-route-evolution-graph`
