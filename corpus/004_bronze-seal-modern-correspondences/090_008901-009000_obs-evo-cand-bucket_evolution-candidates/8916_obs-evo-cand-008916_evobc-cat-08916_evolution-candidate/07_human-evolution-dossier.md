...
- External category reference: `evobc-cat-08916`
- Source category ID: `08916`
- Source label for human review: `辧`
- Source codepoints: `U+8FA7`
...
- `obs-evo-cand-008916-route-category-staging`
...
- `obs-evo-cand-008916-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008916-route-evolution-graph`
