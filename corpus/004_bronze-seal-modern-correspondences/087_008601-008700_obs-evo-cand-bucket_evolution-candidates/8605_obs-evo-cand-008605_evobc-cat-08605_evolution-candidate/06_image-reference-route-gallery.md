...
- `obs-evo-cand-008605-route-category-staging`
...
- `obs-evo-cand-008605-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008605-route-evolution-graph`
