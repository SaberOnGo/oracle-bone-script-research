# Material Visual Observation / obs-comp-cand-000774 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000774`
- External reference / 外部参照: `obimd-sub-gu3h3yqtk3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013537_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gu3h3yqtk3/gu3h3yqtk3/gu3h3yqtk3.png`
- Checksum / 校验和:
  `8697e4af7cfd09106eb7c13fbb028fc4016b7c26f2414145ff7385698f0f0d66`
...
- Marked-pixel bounds: (86,23)–(163,224); span 78 × 202 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.51%。
- 痕迹范围：(86,23)–(163,224)；跨度78 × 202 px；痕迹矩形高于宽。
