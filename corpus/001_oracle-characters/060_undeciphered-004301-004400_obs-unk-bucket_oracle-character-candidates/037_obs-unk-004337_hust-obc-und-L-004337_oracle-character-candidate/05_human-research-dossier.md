# obs-unk-004337 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/037_obs-unk-004337_h
  ust-obc-und-L-004337_oracle-character-candidate/03_visual-assets/001_asset
  -005930_hust-obc-und-L-004337_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4337/L_？_9592.jpg`
- asset id: `asset-005930`
...
- source class: `HUST-OBC/undeciphered/L/4337/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4337/L_？_9592.jpg`
- asset id: `asset-005930`
...
- English observation: `Upper angular cluster and lower descending traces
  recorded.`
- 中文观察: `已记录上部角状痕迹组和下部下伸痕迹。`
...
- Which source records identify obs-unk-004337 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004337？
