# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-002000
...
- candidate_component_id: `obs-comp-cand-002000`
- primary_external_ref_id: `obimd-sub-xllb905eed`
- source_subcharacter_uid: `xllb905eed`
- source_main_character_uid: `xllb905eed`
- main_character_external_ref_id: `obimd-main-xllb905eed`
...
- glyph_codepoint_uplus_sample: `U+FB7DF, U+FB7E0`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-019220` | `001_asset-019220_img.png` | `c687223c36c7f08666b5163c6112daafe9a4520ad586c54570c957714b11c423` |
