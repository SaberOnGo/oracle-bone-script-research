# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-000579
...
- candidate_component_id: `obs-comp-cand-000579`
- primary_external_ref_id: `obimd-sub-hbltymdyef`
- source_subcharacter_uid: `hbltymdyef`
- source_main_character_uid: `hbltymdyef`
- main_character_external_ref_id: `obimd-main-hbltymdyef`
...
- glyph_codepoint_uplus_sample: `U+89D2;U+F379A, U+F379B, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-013107` | `001_asset-013107_img.png` | `7ee4915c9a8320e4662c1a71406cb681c430c1510330855e96ebf8e60019802c` |
