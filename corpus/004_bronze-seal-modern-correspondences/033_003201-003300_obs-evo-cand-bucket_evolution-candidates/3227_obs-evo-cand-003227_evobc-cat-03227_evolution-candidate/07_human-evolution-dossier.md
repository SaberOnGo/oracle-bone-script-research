...
- External category reference: `evobc-cat-03227`
- Source category ID: `03227`
- Source label for human review: `戴`
- Source codepoints: `U+6234`
...
- `obs-evo-cand-003227-route-category-staging`
...
- `obs-evo-cand-003227-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003227-route-evolution-graph`
