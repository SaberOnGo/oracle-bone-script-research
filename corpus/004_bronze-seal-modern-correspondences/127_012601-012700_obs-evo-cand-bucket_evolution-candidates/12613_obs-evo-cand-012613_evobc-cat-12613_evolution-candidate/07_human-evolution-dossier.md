...
- External category reference: `evobc-cat-12613`
- Source category ID: `12613`
- Source label for human review: `𩓕`
- Source codepoints: `U+294D5`
...
- `obs-evo-cand-012613-route-category-staging`
...
- `obs-evo-cand-012613-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012613-route-evolution-graph`
