# obs-unk-006219 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/079_undeciphered-006
  201-006300_obs-unk-bucket_oracle-character-candidates/019_obs-unk-006219_h
  ust-obc-und-X-006219_oracle-character-candidate/03_visual-assets/001_asset
  -007811_hust-obc-und-X-006219_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1775/X_？_4507_1.png`
- asset id: `asset-007811`
...
- source class: `HUST-OBC/undeciphered/X/1775/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1775/X_？_4507_1.png`
- asset id: `asset-007811`
...
- Which source records identify obs-unk-006219 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006219？
