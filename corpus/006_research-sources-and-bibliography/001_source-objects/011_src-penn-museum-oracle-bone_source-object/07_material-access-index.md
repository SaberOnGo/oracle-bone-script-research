# src-penn-museum-oracle-bone Material Access Index
...
- Target records / 目标记录: asset_metadata; asset_metadata;
  excavation_or_collection_context; excavation_or_collection_context
- Metadata profile count / 元数据概况数: 4
- Profile metrics / 概况指标: current_location; object_number; period; provenience
