...
Project ID: `obs-evo-cand-001162`
...
- Project ID: `obs-evo-cand-001162`
- EVOBC category candidate ID: `evobc-evo-cat-01162`
- External category reference: `evobc-cat-01162`
- Source category ID: `01162`
- Source label for human review: `処`
- Source codepoints: `U+51E6`
...
- `obs-evo-cand-001162-route-category-staging`
...
- `obs-evo-cand-001162-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001162-route-evolution-graph`
