# Material Visual Observation / obs-comp-cand-000079 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000079`
- External reference / 外部参照: `obimd-sub-yeq3s8m3p2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011491_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/t4tioxlhov/yeq3s8m3p2/yeq3s8m3p2.png`
- Checksum / 校验和:
  `87afff8872cf9ca53f313a7a2d764f43534974f82b78bac64d5a45ff63658501`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.09%.
- Marked-pixel bounds: (88,14)–(161,233); span 74 × 220 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.09%。
- 痕迹范围：(88,14)–(161,233)；跨度74 × 220 px；痕迹矩形高于宽。
