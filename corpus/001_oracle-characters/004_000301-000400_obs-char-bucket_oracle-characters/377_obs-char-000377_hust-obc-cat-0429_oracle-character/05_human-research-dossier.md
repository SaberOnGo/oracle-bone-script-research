# obs-char-000377 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/377_obs-char-000377_hust-obc-cat-0429_orac
  le-character/03_visual-assets/001_asset-000382_hust-obc-cat-0429_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0429/G_0429_乙1538合22055.png`
- asset id: `asset-000382`
...
- source category: `0429`
- validation class: `376`
- source image route: `HUST-OBC/deciphered/0429/G_0429_乙1538合22055.png`
- asset id: `asset-000382`
...
- English observation: `A short upper horizontal bar sits above a central
  stem, side branches, and an open angular lower form.`
- 中文观察: `短上横笔画位于中央主干、侧向分支和开放折角下部形体之上。`
...
- dataset label text: `㖣`
- dataset label codepoints: `U+35A3`
...
- filename catalog route clues: `Heji-like filename clue: 合22055
  (G_0429_乙1538合22055.png)`
...
- Which source records identify obs-char-000377 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000377？
