...
- External category reference: `evobc-cat-09265`
- Source category ID: `09265`
- Source label for human review: `醇`
- Source codepoints: `U+9187`
...
- `obs-evo-cand-009265-route-category-staging`
...
- `obs-evo-cand-009265-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009265-route-evolution-graph`
