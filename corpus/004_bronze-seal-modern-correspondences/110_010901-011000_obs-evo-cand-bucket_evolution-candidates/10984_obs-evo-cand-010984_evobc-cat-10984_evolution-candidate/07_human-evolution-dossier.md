...
- Project ID: `obs-evo-cand-010984`
- EVOBC category candidate ID: `evobc-evo-cat-10984`
- External category reference: `evobc-cat-10984`
- Source category ID: `10984`
- Source label for human review: `𡊭`
- Source codepoints: `U+212AD`
...
- `obs-evo-cand-010984-route-category-staging`
...
- `obs-evo-cand-010984-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010984-route-evolution-graph`
