# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003033
...
- EVOBC candidate category: `evobc-evo-cat-03033`.
- Source label for search only: `悽`.
- Source codepoints for search only: `U+60BD`.
