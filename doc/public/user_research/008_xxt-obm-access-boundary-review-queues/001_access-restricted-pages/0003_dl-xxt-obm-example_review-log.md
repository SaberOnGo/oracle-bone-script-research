...
- Review log draft ID / 复核日志草稿 ID: `xxt-obm-access-review-log-draft-0003`
- Follow-up review task ID / 后续复核任务 ID: `xxt-obm-followup-review-0003`
...
- Targeted download ID / 目标下载 ID: `dl-xxt-obm-example`
- Targeted URL / 目标 URL: `https://xiaoxue.iis.sinica.edu.tw/obm/Home/Example`
...
- `review_access_boundary_before_manual_followup`
  - English: Review the access boundary before any manual follow-up.
  - 简体中文：在任何人工后续操作前先复核访问边界。
