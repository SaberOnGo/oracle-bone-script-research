# obs-unk-004792 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004792`
- primary external id: `hust-obc-und-X-004792`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/092_obs-unk-004792_h
  ust-obc-und-X-004792_oracle-character-candidate/03_visual-assets/001_asset
  -006385_hust-obc-und-X-004792_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/348/X_？_7331_1.png`
- asset id: `asset-006385`
...
- source class: `HUST-OBC/undeciphered/X/348/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/348/X_？_7331_1.png`
- asset id: `asset-006385`
...
- English observation: `upper projections, lower openings, and pointed terminal`
- 中文观察: `上部突笔、下部开口和尖状末端`
...
- Which source records identify obs-unk-004792 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004792？
