...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1502`
...
- Source image / 来源图: `G_1502_乙6277合7075賓組.png`
- Image / 图像: `001_asset-001350_hust-obc-cat-1502_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合7075
...
- target node: `evobc-evo-cat-00143`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/143_obs-evo-cand-000143_evobc-cat-00143_evoluti
...
- Source label text / 来源标签文字: `㧔`
- Source label codepoint / 来源标签 codepoint: `U+39D4`
