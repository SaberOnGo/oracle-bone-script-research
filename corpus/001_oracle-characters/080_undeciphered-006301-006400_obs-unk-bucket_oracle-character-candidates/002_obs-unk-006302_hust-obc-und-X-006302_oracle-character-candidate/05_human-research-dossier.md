# obs-unk-006302 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/080_undeciphered-006
  301-006400_obs-unk-bucket_oracle-character-candidates/002_obs-unk-006302_h
  ust-obc-und-X-006302_oracle-character-candidate/03_visual-assets/001_asset
  -007893_hust-obc-und-X-006302_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1858/X_？_5084_1.png`
- asset id: `asset-007893`
...
- source class: `HUST-OBC/undeciphered/X/1858/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1858/X_？_5084_1.png`
- asset id: `asset-007893`
...
- Which source records identify obs-unk-006302 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006302？
