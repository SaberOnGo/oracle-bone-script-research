...
- Project ID: `obs-evo-cand-010941`
- EVOBC category candidate ID: `evobc-evo-cat-10941`
- External category reference: `evobc-cat-10941`
- Source category ID: `10941`
- Source label for human review: `𠳙`
- Source codepoints: `U+20CD9`
...
- `obs-evo-cand-010941-route-category-staging`
...
- `obs-evo-cand-010941-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010941-route-evolution-graph`
