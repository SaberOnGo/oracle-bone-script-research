...
Project ID: `obs-evo-cand-002173`
...
- Project ID: `obs-evo-cand-002173`
- EVOBC category candidate ID: `evobc-evo-cat-02173`
- External category reference: `evobc-cat-02173`
- Source category ID: `02173`
- Source label for human review: `娠`
- Source codepoints: `U+5A20`
...
- `obs-evo-cand-002173-route-category-staging`
...
- `obs-evo-cand-002173-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002173-route-evolution-graph`
