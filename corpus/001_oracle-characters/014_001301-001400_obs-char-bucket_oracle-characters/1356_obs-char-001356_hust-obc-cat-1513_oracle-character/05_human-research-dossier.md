# obs-char-001356 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001356`
- primary external id: `hust-obc-cat-1513`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1356_obs-char-001356_hust-obc-cat-1513_ora
  cle-character/03_visual-assets/001_asset-001361_hust-obc-cat-1513_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1513/G_1513_甲骨文0.png`
- asset id: `asset-001361`
...
- source category: `1513`
- validation class: `1355`
- source image route: `HUST-OBC/deciphered/1513/G_1513_甲骨文0.png`
- asset id: `asset-001361`
...
- English observation: `A composite image combines a dark left upright
  cluster with a separate peaked right branching form.`
- 中文观察: `组合图像结合深色左侧直立笔画群和分离的右侧尖顶分枝形体。`
...
- dataset label text: `㧟`
- dataset label codepoints: `U+39DF`
...
- Which source records identify obs-char-001356 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001356？
