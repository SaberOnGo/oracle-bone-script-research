# Material Visual Observation / obs-comp-cand-002430 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002430`
- External reference / 外部参照: `obimd-sub-5p369je4ms`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020602_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7sys4laq6v/5p369je4ms/5p369je4ms.png`
- Checksum / 校验和:
  `8b6a35c22a85c725c3e59746183a0efebbaaa3dcf1120f6930c437e641f98eac`
...
- Marked-pixel bounds: (70,18)–(183,229); span 114 × 212 px; the marked
...
- 痕迹范围：(70,18)–(183,229)；跨度114 × 212 px；痕迹矩形高于宽。
