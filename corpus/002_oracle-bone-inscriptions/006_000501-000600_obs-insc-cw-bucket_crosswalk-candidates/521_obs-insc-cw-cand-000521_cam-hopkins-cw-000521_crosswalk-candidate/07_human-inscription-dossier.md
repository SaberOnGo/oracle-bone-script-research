...
- Yingguo / 英国所藏: `y2509` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `361` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `551` in source row; primary catalog entry pending
