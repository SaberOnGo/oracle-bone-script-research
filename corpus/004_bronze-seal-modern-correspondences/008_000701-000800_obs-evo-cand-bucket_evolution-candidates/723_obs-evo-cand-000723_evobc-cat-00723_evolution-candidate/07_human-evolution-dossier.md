...
Project ID: `obs-evo-cand-000723`
...
- Project ID: `obs-evo-cand-000723`
- EVOBC category candidate ID: `evobc-evo-cat-00723`
- External category reference: `evobc-cat-00723`
- Source category ID: `00723`
- Source label for human review: `仅`
- Source codepoints: `U+4EC5`
...
- `obs-evo-cand-000723-route-category-staging`
...
- `obs-evo-cand-000723-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000723-route-evolution-graph`
