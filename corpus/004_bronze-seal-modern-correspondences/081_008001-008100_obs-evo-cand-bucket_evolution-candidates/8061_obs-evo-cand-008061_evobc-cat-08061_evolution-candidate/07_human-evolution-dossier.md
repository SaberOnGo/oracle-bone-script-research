...
- External category reference: `evobc-cat-08061`
- Source category ID: `08061`
- Source label for human review: `覘`
- Source codepoints: `U+8998`
...
- `obs-evo-cand-008061-route-category-staging`
...
- `obs-evo-cand-008061-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008061-route-evolution-graph`
