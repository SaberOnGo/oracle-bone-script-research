# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006807
...
- EVOBC candidate category: `evobc-evo-cat-06807`.
- Source label for search only: `罟`.
- Source codepoints for search only: `U+7F5F`.
