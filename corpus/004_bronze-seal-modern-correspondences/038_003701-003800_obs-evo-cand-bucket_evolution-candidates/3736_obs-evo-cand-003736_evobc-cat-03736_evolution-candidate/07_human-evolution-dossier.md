...
- External category reference: `evobc-cat-03736`
- Source category ID: `03736`
- Source label for human review: `晆`
...
- `obs-evo-cand-003736-route-category-staging`
...
- `obs-evo-cand-003736-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003736-route-evolution-graph`
