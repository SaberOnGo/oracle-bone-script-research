...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0953`
...
- Source image / 来源图: `G_0953_乙2121合11479.png`
- Image / 图像: `001_asset-000849_hust-obc-cat-0953_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合11479
...
- target node: `evobc-evo-cat-00085`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/085_obs-evo-cand-000085_evobc-cat-00085_evoluti
...
- Source label text / 来源标签文字: `㞯`
- Source label codepoint / 来源标签 codepoint: `U+37AF`
