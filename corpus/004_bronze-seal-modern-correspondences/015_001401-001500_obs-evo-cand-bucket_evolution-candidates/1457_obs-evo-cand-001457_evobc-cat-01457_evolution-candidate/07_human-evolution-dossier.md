...
Project ID: `obs-evo-cand-001457`
...
- Project ID: `obs-evo-cand-001457`
- EVOBC category candidate ID: `evobc-evo-cat-01457`
- External category reference: `evobc-cat-01457`
- Source category ID: `01457`
- Source label for human review: `叓`
- Source codepoints: `U+53D3`
...
- `obs-evo-cand-001457-route-category-staging`
...
- `obs-evo-cand-001457-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001457-route-evolution-graph`
