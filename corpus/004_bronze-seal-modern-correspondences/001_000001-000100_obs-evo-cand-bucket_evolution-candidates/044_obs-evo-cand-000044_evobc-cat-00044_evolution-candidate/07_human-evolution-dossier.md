...
Project ID: `obs-evo-cand-000044`
...
- Project ID: `obs-evo-cand-000044`
- EVOBC category candidate ID: `evobc-evo-cat-00044`
- External category reference: `evobc-cat-00044`
- Source category ID: `00044`
- Source label for human review: `㚔`
- Source codepoints: `U+3694`
...
- `obs-evo-cand-000044-route-category-staging`
...
- `obs-evo-cand-000044-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000044-route-evolution-graph`
