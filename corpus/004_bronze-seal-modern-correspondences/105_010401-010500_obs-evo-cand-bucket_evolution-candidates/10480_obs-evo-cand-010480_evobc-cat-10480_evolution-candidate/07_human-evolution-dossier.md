...
- External category reference: `evobc-cat-10480`
- Source category ID: `10480`
- Source label: `鴅`
...
- `obs-evo-cand-010480-route-category-staging`
...
- `obs-evo-cand-010480-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010480-route-evolution-graph`
