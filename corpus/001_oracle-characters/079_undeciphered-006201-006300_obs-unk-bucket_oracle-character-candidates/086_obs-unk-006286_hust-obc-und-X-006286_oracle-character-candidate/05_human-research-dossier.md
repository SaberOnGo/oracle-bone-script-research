# obs-unk-006286 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006286`
- primary external id: `hust-obc-und-X-006286`
...
- local review image route: `corpus/001_oracle-characters/079_undeciphered-006
  201-006300_obs-unk-bucket_oracle-character-candidates/086_obs-unk-006286_h
  ust-obc-und-X-006286_oracle-character-candidate/03_visual-assets/001_asset
  -007878_hust-obc-und-X-006286_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1842/X_？_4812_1.png`
- asset id: `asset-007878`
...
- source class: `HUST-OBC/undeciphered/X/1842/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1842/X_？_4812_1.png`
- asset id: `asset-007878`
...
- Which source records identify obs-unk-006286 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006286？
