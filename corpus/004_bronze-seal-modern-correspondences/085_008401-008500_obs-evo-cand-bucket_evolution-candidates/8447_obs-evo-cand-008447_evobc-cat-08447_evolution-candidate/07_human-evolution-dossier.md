...
- External category reference: `evobc-cat-08447`
- Source category ID: `08447`
- Source label for human review: `调`
...
- `obs-evo-cand-008447-route-category-staging`
...
- `obs-evo-cand-008447-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008447-route-evolution-graph`
