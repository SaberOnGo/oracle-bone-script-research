...
- `obs-evo-cand-006429-route-category-staging`
...
- `obs-evo-cand-006429-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006429-route-evolution-graph`
