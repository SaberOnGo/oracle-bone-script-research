# obs-unk-004801 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/001_obs-unk-004801_h
  ust-obc-und-X-004801_oracle-character-candidate/03_visual-assets/001_asset
  -006394_hust-obc-und-X-004801_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/357/X_？_7340_1.png`
- asset id: `asset-006394`
...
- source class: `HUST-OBC/undeciphered/X/357/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/357/X_？_7340_1.png`
- asset id: `asset-006394`
...
- English observation: `central branching group with upper and lower openings`
- 中文观察: `带上下开口的中央分支结构`
...
- Which source records identify obs-unk-004801 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004801？
