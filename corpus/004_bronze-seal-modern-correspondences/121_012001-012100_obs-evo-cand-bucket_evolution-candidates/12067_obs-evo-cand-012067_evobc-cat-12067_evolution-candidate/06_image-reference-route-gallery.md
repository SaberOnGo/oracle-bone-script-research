...
- `obs-evo-cand-012067-route-category-staging`
...
- `obs-evo-cand-012067-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012067-route-evolution-graph`
