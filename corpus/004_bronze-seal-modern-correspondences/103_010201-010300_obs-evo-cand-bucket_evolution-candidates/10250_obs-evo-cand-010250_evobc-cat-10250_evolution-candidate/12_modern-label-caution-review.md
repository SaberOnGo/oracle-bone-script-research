# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010250
...
- EVOBC candidate category: `evobc-evo-cat-10250`.
- Source label for search only: `驑`.
- Source codepoints for search only: `U+9A51`.
