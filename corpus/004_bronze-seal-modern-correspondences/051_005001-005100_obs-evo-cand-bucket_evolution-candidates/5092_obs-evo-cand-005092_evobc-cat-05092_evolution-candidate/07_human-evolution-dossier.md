...
Project ID: `obs-evo-cand-005092`
...
- Project ID: `obs-evo-cand-005092`
- EVOBC category candidate ID: `evobc-evo-cat-05092`
- External category reference: `evobc-cat-05092`
- Source category ID: `05092`
- Source label for human review: `無`
- Source codepoints: `U+7121`
- Image reference count in source metadata: `288`
...
- `obs-evo-cand-005092-route-category-staging`
...
- `obs-evo-cand-005092-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005092-route-evolution-graph`
