# obs-comp-cand-001619 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001619`
- 首选外部 ID: `obimd-sub-hxwcv9yfyk`
- OBIMD subcharacter UID: `hxwcv9yfyk`
- OBIMD main character UID: `hxwcv9yfyk`
- 来源 ID: `src-obimd`
