# obs-char-001461 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1461_obs-char-001461_hust-obc-cat-1638_ora
  cle-character/03_visual-assets/001_asset-001466_hust-obc-cat-1638_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1638/G_1638_乙5405合22099子組.png`
- asset id: `asset-001466`
...
- source category: `1638`
- validation class: `1460`
- source image route: `HUST-OBC/deciphered/1638/G_1638_乙5405合22099子組.png`
- asset id: `asset-001466`
...
- English observation: `A compact upper cluster leads into a narrow stem
  with several lower branches.`
- 中文观察: `紧凑上部笔画群连接狭长竖干，下面有数条分枝。`
...
- dataset label text: `㩜`
- dataset label codepoints: `U+3A5C`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/144_obs-evo-can
  d-000144_evobc-cat-00144_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/144_obs-evo-cand-000144_evobc-cat-00144_evolu
...
- Which source records identify obs-char-001461 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001461？
