# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004544
...
- EVOBC candidate category: `evobc-evo-cat-04544`.
- Source label for search only: `沚`.
- Source codepoints for search only: `U+6C9A`.
