...
- External category reference: `evobc-cat-13394`
- Source category ID: `13394`
- Source label for human review: `𬪵`
...
- `obs-evo-cand-013394-route-category-staging`
...
- `obs-evo-cand-013394-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013394-route-evolution-graph`
