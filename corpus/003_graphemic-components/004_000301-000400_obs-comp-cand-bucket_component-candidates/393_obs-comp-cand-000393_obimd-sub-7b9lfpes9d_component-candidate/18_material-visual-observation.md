# Material Visual Observation / obs-comp-cand-000393 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000393`
- External reference / 外部参照: `obimd-sub-7b9lfpes9d`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012316_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7b9lfpes9d/7b9lfpes9d/7b9lfpes9d.png`
- Checksum / 校验和:
  `19ea79710d0c16106dd9dbd0bae0d547b7b5361b5898c3a6c042b85955c79766`
...
- Marked-pixel bounds: (78,30)–(171,220); span 94 × 191 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.75%。
- 痕迹范围：(78,30)–(171,220)；跨度94 × 191 px；痕迹矩形高于宽。
