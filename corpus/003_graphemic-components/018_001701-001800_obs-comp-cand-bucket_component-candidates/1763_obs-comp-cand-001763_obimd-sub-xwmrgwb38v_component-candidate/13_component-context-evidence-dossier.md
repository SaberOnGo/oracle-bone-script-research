# obs-comp-cand-001763 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001763`
- 首选外部 ID: `obimd-sub-xwmrgwb38v`
- OBIMD subcharacter UID: `xwmrgwb38v`
- OBIMD main character UID: `xwmrgwb38v`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+5321;U+A521E;U+FA2D3; U+FA2D4; 另有 3 项
