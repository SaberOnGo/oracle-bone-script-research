# obs-char-001247 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001247`
- primary external id: `hust-obc-cat-1395`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1247_obs-char-001247_hust-obc-cat-1395_ora
  cle-character/03_visual-assets/001_asset-001252_hust-obc-cat-1395_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1395/G_1395_乙6263合3458賓組.png`
- asset id: `asset-001252`
...
- source category: `1395`
- validation class: `1246`
- source image route: `HUST-OBC/deciphered/1395/G_1395_乙6263合3458賓組.png`
- asset id: `asset-001252`
...
- English observation: `Two long narrow strokes cross near the upper middle
  and continue into a thin curved lower stroke.`
- 中文观察: `两条狭长笔画在上部中段附近交叉，并继续为一条细长弯曲下行笔画。`
...
- dataset label text: `㥩`
- dataset label codepoints: `U+3969`
...
- filename catalog route clues: `Heji-like filename clue: 合3458
  (G_1395_乙6263合3458賓組.png)`
...
- Which source records identify obs-char-001247 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001247？
