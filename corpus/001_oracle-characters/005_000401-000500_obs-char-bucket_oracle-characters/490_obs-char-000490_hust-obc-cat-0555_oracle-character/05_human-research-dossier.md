# obs-char-000490 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000490`
- primary external id: `hust-obc-cat-0555`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/490_obs-char-000490_hust-obc-cat-0555_orac
  le-character/03_visual-assets/001_asset-000495_hust-obc-cat-0555_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0555/H_0555_611FC_0.png`
- asset id: `asset-000495`
...
- source category: `0555`
- validation class: `489`
- source image route: `HUST-OBC/deciphered/0555/H_0555_611FC_0.png`
- asset id: `asset-000495`
...
- English observation: `A large pointed arch encloses three separated inner
  groups: a small lower-left box, a curved central stem, and a long right
  vertical crossed by short bars.`
- 中文观察: `大型尖拱形包围三组分离内形：左下小框、中央弯曲主干，以及被短横穿过的右侧长竖。`
...
- dataset label text: `㘡`
- dataset label codepoints: `U+3621`
...
- OBIMD candidate ids / OBIMD 候选 ID: `obimd-main-cand-003565`
- OBIMD external refs / OBIMD 外部引用: `obimd-main-mfe79ij88l`
- OBIMD transcription field / OBIMD 转写字段: `㘡|上甲`
...
- matched OBIMD main UIDs: `mfe79ij88l`
...
- filename catalog route clues: `catalog-like filename clue: H_0555
  (H_0555_611FC_0.png)`
...
- Which source records identify obs-char-000490 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000490？
