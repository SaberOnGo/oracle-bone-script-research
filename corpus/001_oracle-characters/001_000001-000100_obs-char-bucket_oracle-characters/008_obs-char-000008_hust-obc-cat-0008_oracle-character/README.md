...
- Directory / 目录: `corpus/001_oracle-characters/001_000001-000100_obs-char-bucket_oracle-characters/008_obs-char-000008_hust-obc-cat-0008_oracle-character`

## Visual Material Status / 图像资料状态

- Status / 状态: `committed_review_image_derivative`
- Source image reference rows / 来源图像路径引用行数: `1`
- Committed glyph image / 已提交字形图片: 03_visual-assets/001_asset-000013_hust-obc-cat-0008_glyph.png
