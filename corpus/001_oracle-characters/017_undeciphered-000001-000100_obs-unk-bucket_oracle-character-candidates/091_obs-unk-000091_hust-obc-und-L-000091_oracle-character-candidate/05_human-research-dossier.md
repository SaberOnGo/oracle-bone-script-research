# obs-unk-000091 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000091`
- primary external id: `hust-obc-und-L-000091`
...
- local review image route: `corpus/001_oracle-characters/017_undeciphered-000
  001-000100_obs-unk-bucket_oracle-character-candidates/091_obs-unk-000091_h
  ust-obc-und-L-000091_oracle-character-candidate/03_visual-assets/001_asset
  -001684_hust-obc-und-L-000091_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/91/L_？_10274.jpg`
- asset id: `asset-001684`
...
- source class: `HUST-OBC/undeciphered/L/91/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/91/L_？_10274.jpg`
- asset id: `asset-001684`
...
- Which source records identify obs-unk-000091 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000091？
