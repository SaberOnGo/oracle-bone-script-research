...
- External category reference: `evobc-cat-10274`
- Source category ID: `10274`
- Source label: `驴`
...
- `obs-evo-cand-010274-route-category-staging`
...
- `obs-evo-cand-010274-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-010274-route-evolution-graph`
