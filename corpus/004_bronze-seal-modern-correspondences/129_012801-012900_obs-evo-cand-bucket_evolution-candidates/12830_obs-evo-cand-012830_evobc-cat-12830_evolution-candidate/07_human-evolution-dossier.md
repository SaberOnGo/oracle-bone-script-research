...
- External category reference: `evobc-cat-12830`
- Source category ID: `12830`
- Source label for human review: `𪧹`
- Source codepoints: `U+2A9F9`
...
- `obs-evo-cand-012830-route-category-staging`
...
- `obs-evo-cand-012830-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012830-route-evolution-graph`
