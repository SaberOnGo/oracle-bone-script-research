...
- External category reference: `evobc-cat-10415`
- Source category ID: `10415`
- Source label for human review: `鯛`
- Source codepoints: `U+9BDB`
...
- `obs-evo-cand-010415-route-category-staging`
...
- `obs-evo-cand-010415-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010415-route-evolution-graph`
