# obs-unk-004604 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004604`
- primary external id: `hust-obc-und-X-004604`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/004_obs-unk-004604_h
  ust-obc-und-X-004604_oracle-character-candidate/03_visual-assets/001_asset
  -006197_hust-obc-und-X-004604_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/160/X_？_8336_1.png`
- asset id: `asset-006197`
...
- source class: `HUST-OBC/undeciphered/X/160/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/160/X_？_8336_1.png`
- asset id: `asset-006197`
...
- English observation: `Cross trace, left upright, forked prongs, and`
  `lower point recorded.`
- 中文观察: `已记录横痕、左侧直立痕、分叉末端和下部尖端。`
...
- Which source records identify obs-unk-004604 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004604？
