...
- External category reference: `evobc-cat-07007`
- Source category ID: `07007`
- Source label: `肴`
...
- `obs-evo-cand-007007-route-category-staging`
...
- `obs-evo-cand-007007-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007007-route-evolution-graph`
