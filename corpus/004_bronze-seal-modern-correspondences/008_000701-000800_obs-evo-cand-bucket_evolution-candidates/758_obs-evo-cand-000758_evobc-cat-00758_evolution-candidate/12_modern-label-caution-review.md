# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000758
...
- EVOBC candidate category: `evobc-evo-cat-00758`.
- Source label for search only: `仿`.
- Source codepoints for search only: `U+4EFF`.
