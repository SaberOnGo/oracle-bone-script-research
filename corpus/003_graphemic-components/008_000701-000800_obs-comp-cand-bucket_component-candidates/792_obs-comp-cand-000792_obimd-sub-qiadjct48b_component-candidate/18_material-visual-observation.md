# Material Visual Observation / obs-comp-cand-000792 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000792`
- External reference / 外部参照: `obimd-sub-qiadjct48b`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013591_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6p9s6p6wyb/qiadjct48b/qiadjct48b.png`
- Checksum / 校验和:
  `6943674d1f4e66d457843ba81d215d8e0811c27db53e8b3bf8b88fe715ef8d71`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.82%.
- Marked-pixel bounds: (78,25)–(171,226); span 94 × 202 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.82%。
- 痕迹范围：(78,25)–(171,226)；跨度94 × 202 px；痕迹矩形高于宽。
