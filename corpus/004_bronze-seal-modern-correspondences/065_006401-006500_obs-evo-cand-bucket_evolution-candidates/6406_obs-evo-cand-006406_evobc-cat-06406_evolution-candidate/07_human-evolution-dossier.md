...
Project ID: `obs-evo-cand-006406`
...
- Project ID: `obs-evo-cand-006406`
- EVOBC category candidate ID: `evobc-evo-cat-06406`
- External category reference: `evobc-cat-06406`
- Source category ID: `06406`
- Source label for human review: `粯`
- Source codepoints: `U+7CAF`
...
- `obs-evo-cand-006406-route-category-staging`
...
- `obs-evo-cand-006406-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006406-route-evolution-graph`
