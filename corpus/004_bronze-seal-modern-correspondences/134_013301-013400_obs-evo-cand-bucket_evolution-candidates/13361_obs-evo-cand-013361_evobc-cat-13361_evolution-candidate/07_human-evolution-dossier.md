...
- External category reference: `evobc-cat-13361`
- Source category ID: `13361`
- Source label for human review: `𬧱`
...
- `obs-evo-cand-013361-route-category-staging`
...
- `obs-evo-cand-013361-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013361-route-evolution-graph`
