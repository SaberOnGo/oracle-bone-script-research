# obs-char-000716 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/716_obs-char-000716_hust-obc-cat-0813_orac
  le-character/03_visual-assets/001_asset-000721_hust-obc-cat-0813_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0813/X_0813_2313_1.png`
- asset id: `asset-000721`
...
- source category: `0813`
- validation class: `715`
- source image route: `HUST-OBC/deciphered/0813/X_0813_2313_1.png`
- asset id: `asset-000721`
...
- English observation: `Two tall thin stems carry upper side loops,
  crossbars, and short diagonal branches, and stand above a broad rounded
  lower basin with high side ends.`
- 中文观察: `两条高细干带上部侧环、横栏和短斜枝，立于两端高起的宽圆弯下槽上方。`
...
- dataset label text: `㜣`
- dataset label codepoints: `U+3723`
...
- Which source records identify obs-char-000716 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000716？
