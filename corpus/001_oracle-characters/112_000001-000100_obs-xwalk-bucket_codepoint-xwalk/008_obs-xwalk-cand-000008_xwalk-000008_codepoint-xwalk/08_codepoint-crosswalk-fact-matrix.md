# obs-xwalk-cand-000008 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+2EBC` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-0008` | not reading |
