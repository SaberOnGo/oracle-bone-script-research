# obs-evo-cand-005771 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-05771`
- Source label: `目`
- Source codepoints: `U+76EE`
- Image reference count: `124`
- Era token counts: `BI:9;CS:1;OBC:73;SAC:1;SS:3;WSC:37`
- Source token counts: `Book:54;Web:70`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 73 image references
- era 1 / BI: 9 image references
