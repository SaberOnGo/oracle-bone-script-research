# obs-char-001379 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001379`
- primary external id: `hust-obc-cat-1540`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1379_obs-char-001379_hust-obc-cat-1540_ora
  cle-character/03_visual-assets/001_asset-001384_hust-obc-cat-1540_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1540/G_1540_前5.42.5合14855.png`
- asset id: `asset-001384`
...
- source category: `1540`
- validation class: `1378`
- source image route: `HUST-OBC/deciphered/1540/G_1540_前5.42.5合14855.png`
- asset id: `asset-001384`
...
- English observation: `A striped left stem stands beside a tall right form
  with a rounded upper enclosure.`
- 中文观察: `带有重复短笔的左竖干旁有高大的右侧形体及圆拱上框。`
...
- dataset label text: `㧺`
- dataset label codepoints: `U+39FA`
...
- filename catalog route clues: `Heji-like filename clue: 合14855
  (G_1540_前5.42.5合14855.png)`
...
- Which source records identify obs-char-001379 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001379？
