...
- External category reference: `evobc-cat-03733`
- Source category ID: `03733`
- Source label for human review: `時`
- Source codepoints: `U+6642`
...
- `obs-evo-cand-003733-route-category-staging`
...
- `obs-evo-cand-003733-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003733-route-evolution-graph`
