...
- External category reference: `evobc-cat-07058`
- Source category ID: `07058`
- Source label for human review: `脊`
- Source codepoints: `U+810A`
...
- `obs-evo-cand-007058-route-category-staging`
...
- `obs-evo-cand-007058-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007058-route-evolution-graph`
