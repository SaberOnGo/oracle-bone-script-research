...
- External category reference: `evobc-cat-03068`
- Source category ID: `03068`
- Source label for human review: `惶`
...
- `obs-evo-cand-003068-route-category-staging`
...
- `obs-evo-cand-003068-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003068-route-evolution-graph`
