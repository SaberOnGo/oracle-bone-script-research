# obs-unk-004849 Local Object Materials / obs-unk-004849 本地对象资料
...
- Local review image / 本地复核图像: `03_visual-assets/001_asset-006442_hust-obc-und-X-004849_glyph.jpg`

## Object Summary / 对象摘要

- Project ID / 项目 ID: `obs-unk-004849`
- Primary external reference / 首选外部参考: `hust-obc-und-X-004849`
- Source group / 来源分组: `X` (New Compilation of Oracle Bone Scripts)
- Source class path / 来源分类路径: `HUST-OBC/undeciphered/X/405/`
- Source image path / 来源图像路径: `HUST-OBC/undeciphered/X/405/X_？_7390_1.png`
- Asset ID / 资产 ID: `asset-006442`
