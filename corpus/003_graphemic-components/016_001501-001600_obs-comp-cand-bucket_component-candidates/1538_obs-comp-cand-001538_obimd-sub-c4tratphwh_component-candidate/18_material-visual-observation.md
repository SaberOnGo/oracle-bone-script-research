# Material Visual Observation / obs-comp-cand-001538 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001538`
- External reference / 外部参照: `obimd-sub-c4tratphwh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016952_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/057g0jgjld/c4tratphwh/c4tratphwh.png`
- Checksum / 校验和:
  `28a7f0ef7a8e15c4975de46c238a452be5cff3b0b43240cd100184ab0c038fcf`
...
- Marked-pixel bounds: (78,36)–(171,207); span 94 × 172 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.83%。
- 痕迹范围：(78,36)–(171,207)；跨度94 × 172 px；痕迹矩形高于宽。
