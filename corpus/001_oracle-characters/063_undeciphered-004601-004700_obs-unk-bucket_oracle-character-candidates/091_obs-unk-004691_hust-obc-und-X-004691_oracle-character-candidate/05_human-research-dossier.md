# obs-unk-004691 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004691`
- primary external id: `hust-obc-und-X-004691`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/091_obs-unk-004691_h
  ust-obc-und-X-004691_oracle-character-candidate/03_visual-assets/001_asset
  -006284_hust-obc-und-X-004691_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/247/X_？_7225_1.png`
- asset id: `asset-006284`
...
- source class: `HUST-OBC/undeciphered/X/247/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/247/X_？_7225_1.png`
- asset id: `asset-006284`
...
- English observation: `upper opening with detached left fragments`
- 中文观察: `带左侧分离残片和上部开口的笔画组`
...
- Which source records identify obs-unk-004691 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004691？
