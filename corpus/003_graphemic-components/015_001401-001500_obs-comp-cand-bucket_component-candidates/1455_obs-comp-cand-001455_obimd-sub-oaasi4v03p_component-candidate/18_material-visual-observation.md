# Material Visual Observation / obs-comp-cand-001455 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001455`
- External reference / 外部参照: `obimd-sub-oaasi4v03p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016032_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/acx6uyop18/oaasi4v03p/oaasi4v03p.png`
- Checksum / 校验和:
  `2e865cc9f4ac83cab2683ace87a366a736add866b55f78d4069164378237a60b`
...
- Marked-pixel bounds: (51,27)–(200,220); span 150 × 194 px; the marked
...
- 痕迹范围：(51,27)–(200,220)；跨度150 × 194 px；痕迹矩形高于宽。
