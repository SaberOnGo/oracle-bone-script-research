# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001148
...
| --- | --- | --- | --- |
| `obimd-glyph-link-017280` | 󶨕 | `U+F6A15` | `reviewed_metadata_only` |
| `obimd-glyph-link-017281` | 󶨖 | `U+F6A16` | `reviewed_metadata_only` |
| `obimd-glyph-link-017282` | 󶨗 | `U+F6A17` | `reviewed_metadata_only` |
