...
- External category reference: `evobc-cat-11269`
- Source category ID: `11269`
- Source label for human review: `𢡑`
- Source codepoints: `U+22851`
...
- `obs-evo-cand-011269-route-category-staging`
...
- `obs-evo-cand-011269-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011269-route-evolution-graph`
