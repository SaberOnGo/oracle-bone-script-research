...
- External category reference: `evobc-cat-12011`
- Source category ID: `12011`
- Source label for human review: `𦏺`
- Source codepoints: `U+263FA`
...
- `obs-evo-cand-012011-route-category-staging`
...
- `obs-evo-cand-012011-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012011-route-evolution-graph`
