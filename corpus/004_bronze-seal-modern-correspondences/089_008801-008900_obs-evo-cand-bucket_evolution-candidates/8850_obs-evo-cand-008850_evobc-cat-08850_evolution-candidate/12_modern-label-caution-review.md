# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008850
...
- EVOBC candidate category: `evobc-evo-cat-08850`.
- Source label for search only: `輪`.
- Source codepoints for search only: `U+8F2A`.
