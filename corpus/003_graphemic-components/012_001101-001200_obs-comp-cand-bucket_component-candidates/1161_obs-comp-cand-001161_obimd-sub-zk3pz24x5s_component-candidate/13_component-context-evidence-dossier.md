# obs-comp-cand-001161 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001161`
- 首选外部 ID: `obimd-sub-zk3pz24x5s`
- OBIMD subcharacter UID: `zk3pz24x5s`
- OBIMD main character UID: `zk3pz24x5s`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+F6B25; U+F6B26; 另有 2 项
