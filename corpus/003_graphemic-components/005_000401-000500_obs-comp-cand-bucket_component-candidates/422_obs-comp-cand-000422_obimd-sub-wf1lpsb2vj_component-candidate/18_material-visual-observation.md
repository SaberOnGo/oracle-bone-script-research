# Material Visual Observation / obs-comp-cand-000422 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000422`
- External reference / 外部参照: `obimd-sub-wf1lpsb2vj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012345_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wf1lpsb2vj/wf1lpsb2vj/wf1lpsb2vj.png`
- Checksum / 校验和:
  `0d46d16cc731639fddb9c96c33f5e466c3b1d5f5412790c6c59857d7108bb6dd`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.50%.
- Marked-pixel bounds: (84,17)–(165,228); span 82 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.50%。
- 痕迹范围：(84,17)–(165,228)；跨度82 × 212 px；痕迹矩形高于宽。
