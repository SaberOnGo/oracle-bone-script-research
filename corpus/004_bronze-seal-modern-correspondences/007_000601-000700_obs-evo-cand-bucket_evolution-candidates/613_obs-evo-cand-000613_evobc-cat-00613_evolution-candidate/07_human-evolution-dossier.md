...
- External category reference: `evobc-cat-00613`
- Source category ID: `00613`
- Source label for human review: `不`
- Source codepoints: `U+4E0D`
- Image reference count in source metadata: `824`
...
- era `0`
  token: `OBC`
  image references: 106
- era `1`
  token: `BI`
  image references: 144
- era `2`
  token: `SS`
  image references: 2
- era `3`
...
- `obs-evo-cand-000613-route-category-staging`
...
- `obs-evo-cand-000613-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000613-route-evolution-graph`
