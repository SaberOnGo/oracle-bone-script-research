# Material Visual Observation / obs-comp-cand-001216 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001216`
- External reference / 外部参照: `obimd-sub-z4bhaqrpt0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015447_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/z4bhaqrpt0/z4bhaqrpt0/z4bhaqrpt0.png`
- Checksum / 校验和:
  `36a291d56846a928f0cd87e408007b5b2bb7fd496985f16755f4cefc99fcda11`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.80%.
- Marked-pixel bounds: (59,55)–(190,193); span 132 × 139 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.80%。
- 痕迹范围：(59,55)–(190,193)；跨度132 × 139 px；痕迹矩形近方形。
