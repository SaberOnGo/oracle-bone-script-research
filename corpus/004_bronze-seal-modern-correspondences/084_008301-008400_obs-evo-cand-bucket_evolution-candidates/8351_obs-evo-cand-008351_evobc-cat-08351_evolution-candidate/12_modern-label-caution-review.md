# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008351
...
- EVOBC candidate category: `evobc-evo-cat-08351`.
- Source label for search only: `譋`.
- Source codepoints for search only: `U+8B4B`.
