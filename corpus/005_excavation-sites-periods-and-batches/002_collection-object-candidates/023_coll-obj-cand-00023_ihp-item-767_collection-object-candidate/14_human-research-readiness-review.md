# Human Research Readiness Review / 人类研究准备度复核: coll-obj-cand-00023
...
| --- | --- | --- |
| Catalog source | `767` | `02_collection-source-index.csv` |
...
| Live source page | source description and images checked; rights unresolved | `18_live-source-evidence-review.md` |
...
- Which source description, overlay, or image route requires independent
  checking?
- 哪个著录页或登记号记录能支持对象标签？
