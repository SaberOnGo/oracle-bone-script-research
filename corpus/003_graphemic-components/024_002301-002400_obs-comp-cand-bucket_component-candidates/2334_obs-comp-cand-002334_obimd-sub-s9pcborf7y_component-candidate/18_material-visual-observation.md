# Material Visual Observation / obs-comp-cand-002334 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002334`
- External reference / 外部参照: `obimd-sub-s9pcborf7y`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020353_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/s9pcborf7y/s9pcborf7y/s9pcborf7y.png`
- Checksum / 校验和:
  `afdb875f4dca9e190cf1c80be0e043ef90e178d40bc23ff0c04ac88d85826dd0`
...
- Marked-pixel bounds: (61,46)–(182,199); span 122 × 154 px; the marked
...
- 痕迹范围：(61,46)–(182,199)；跨度122 × 154 px；痕迹矩形高于宽。
