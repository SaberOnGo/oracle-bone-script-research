# Material Visual Observation / obs-comp-cand-001162 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001162`
- External reference / 外部参照: `obimd-sub-wxpi4rjz2p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015352_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wxpi4rjz2p/wxpi4rjz2p/wxpi4rjz2p.png`
- Checksum / 校验和:
  `e090179528e41611fc49d791706a2ccc2f8e12c6608041695dbdbeccb0290a7d`
...
- Marked-pixel bounds: (70,38)–(180,215); span 111 × 178 px; the marked
...
- 痕迹范围：(70,38)–(180,215)；跨度111 × 178 px；痕迹矩形高于宽。
