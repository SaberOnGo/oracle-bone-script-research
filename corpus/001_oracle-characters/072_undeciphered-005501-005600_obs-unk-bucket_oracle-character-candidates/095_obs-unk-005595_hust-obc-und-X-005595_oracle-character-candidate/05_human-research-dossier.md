# obs-unk-005595 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005595`
- primary external id: `hust-obc-und-X-005595`
...
- local review image route: `corpus/001_oracle-characters/072_undeciphered-005
  501-005600_obs-unk-bucket_oracle-character-candidates/095_obs-unk-005595_h
  ust-obc-und-X-005595_oracle-character-candidate/03_visual-assets/001_asset
  -007188_hust-obc-und-X-005595_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1151/X_？_8104_1.png`
- asset id: `asset-007188`
...
- source class: `HUST-OBC/undeciphered/X/1151/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1151/X_？_8104_1.png`
- asset id: `asset-007188`
...
- Which source records identify obs-unk-005595 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005595？
