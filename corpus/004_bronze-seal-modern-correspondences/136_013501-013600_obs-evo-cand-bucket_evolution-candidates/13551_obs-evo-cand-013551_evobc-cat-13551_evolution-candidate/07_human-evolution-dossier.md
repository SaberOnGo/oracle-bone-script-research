...
- External category reference: `evobc-cat-13551`
- Source category ID: `13551`
- Source label for human review: `𭨳`
- Source codepoints: `U+2DA33`
...
- `obs-evo-cand-013551-route-category-staging`
...
- `obs-evo-cand-013551-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013551-route-evolution-graph`
