# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008387
...
- EVOBC candidate category: `evobc-evo-cat-08387`.
- Source label for search only: `變`.
- Source codepoints for search only: `U+8B8A`.
