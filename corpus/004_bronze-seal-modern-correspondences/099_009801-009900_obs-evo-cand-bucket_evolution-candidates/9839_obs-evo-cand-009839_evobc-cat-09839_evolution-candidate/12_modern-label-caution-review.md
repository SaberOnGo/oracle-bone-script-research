# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-009839
...
- EVOBC candidate category: `evobc-evo-cat-09839`.
- Source label for search only: `雲`.
- Source codepoints for search only: `U+96F2`.
