# obs-unk-004578 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004578`
- primary external id: `hust-obc-und-X-004578`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/078_obs-unk-004578_h
  ust-obc-und-X-004578_oracle-character-candidate/03_visual-assets/001_asset
  -006171_hust-obc-und-X-004578_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/134/X_？_8313_1.png`
- asset id: `asset-006171`
...
- source class: `HUST-OBC/undeciphered/X/134/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/134/X_？_8313_1.png`
- asset id: `asset-006171`
...
- English observation: `Crossing strokes, open enclosure, and two hangers`
  `recorded.`
- 中文观察: `已记录交叉痕迹、开放轮廓和两条悬垂痕。`
...
- Which source records identify obs-unk-004578 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004578？
