...
- External category reference: `evobc-cat-08531`
- Source category ID: `08531`
- Source label for human review: `貛`
- Source codepoints: `U+8C9B`
...
- `obs-evo-cand-008531-route-category-staging`
...
- `obs-evo-cand-008531-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008531-route-evolution-graph`
