# obs-char-000969 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000969`
- primary external id: `hust-obc-cat-1089`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/969_obs-char-000969_hust-obc-cat-1089_orac
  le-character/03_visual-assets/001_asset-000974_hust-obc-cat-1089_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1089/G_1089_京津2122合3457賓組.png`
- asset id: `asset-000974`
...
- source category: `1089`
- validation class: `968`
- source image route: `HUST-OBC/deciphered/1089/G_1089_京津2122合3457賓組.png`
- asset id: `asset-000974`
...
- English observation: `A small rectangular grid at upper left is
  accompanied by a long right-hand curve and a lower side branch.`
- 中文观察: `左上小型矩形格状笔旁有右侧长弯笔和下部侧分枝。`
...
- dataset label text: `㠷`
- dataset label codepoints: `U+3837`
...
- filename catalog route clues: `Heji-like filename clue: 合3457
  (G_1089_京津2122合3457賓組.png)`
...
- Which source records identify obs-char-000969 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000969？
