# Material Visual Observation / obs-comp-cand-002572 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002572`
- External reference / 外部参照: `obimd-sub-a5ajz0rgrm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021104_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/a5ajz0rgrm/a5ajz0rgrm/a5ajz0rgrm.png`
- Checksum / 校验和:
  `8d5620c776b000700db6a0abb2e6a678248c9b71183f6812b536443d46721100`
...
- Marked-pixel bounds: (60,57)–(189,177); span 130 × 121 px; the marked
...
- 痕迹范围：(60,57)–(189,177)；跨度130 × 121 px；痕迹矩形近方形。
