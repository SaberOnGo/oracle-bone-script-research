# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006429
...
- EVOBC candidate category: `evobc-evo-cat-06429`.
- Source label for search only: `糟`.
- Source codepoints for search only: `U+7CDF`.
