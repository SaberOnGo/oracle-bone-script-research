...
- Project ID: `obs-evo-cand-003360`
- EVOBC category candidate ID: `evobc-evo-cat-03360`
- External category reference: `evobc-cat-03360`
- Source category ID: `03360`
- Source label for human review: `挾`
- Source codepoints: `U+633E`
...
- `obs-evo-cand-003360-route-category-staging`
...
- `obs-evo-cand-003360-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003360-route-evolution-graph`
