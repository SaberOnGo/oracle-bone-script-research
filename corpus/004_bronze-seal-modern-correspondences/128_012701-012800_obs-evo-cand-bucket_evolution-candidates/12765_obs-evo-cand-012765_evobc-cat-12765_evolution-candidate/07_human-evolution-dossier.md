...
- External category reference: `evobc-cat-12765`
- Source category ID: `12765`
- Source label for human review: `𪓐`
- Source codepoints: `U+2A4D0`
...
- `obs-evo-cand-012765-route-category-staging`
...
- `obs-evo-cand-012765-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012765-route-evolution-graph`
