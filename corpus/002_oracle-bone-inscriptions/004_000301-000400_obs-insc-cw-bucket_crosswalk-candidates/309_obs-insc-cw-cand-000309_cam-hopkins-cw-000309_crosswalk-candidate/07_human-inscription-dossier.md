...
- Yingguo / 英国所藏: `y1961` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `422` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `121` in source row; primary catalog entry pending
- Heji / 合集: `40986` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000309`
