# obs-unk-009390 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-009390`
- primary external id: `hust-obc-und-YH-009390`
...
- local review image route: `corpus/001_oracle-characters/110_undeciphered-009
  301-009400_obs-unk-bucket_oracle-character-candidates/090_obs-unk-009390_h
  ust-obc-und-YH-009390_oracle-character-candidate/03_visual-assets/001_asse
  t-010981_hust-obc-und-YH-009390_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/618A5/Y_？_618A5.jpg`
- asset id: `asset-010981`
...
- source class: `HUST-OBC/undeciphered/Y+H/618A5/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/618A5/Y_？_618A5.jpg`
- asset id: `asset-010981`
...
- Which source records identify obs-unk-009390 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009390？
