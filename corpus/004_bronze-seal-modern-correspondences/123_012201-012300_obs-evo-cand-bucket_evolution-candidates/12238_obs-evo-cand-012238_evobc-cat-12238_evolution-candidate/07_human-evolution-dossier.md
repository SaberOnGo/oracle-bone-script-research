...
- External category reference: `evobc-cat-12238`
- Source category ID: `12238`
- Source label for human review: `𧪒`
- Source codepoints: `U+27A92`
...
- `obs-evo-cand-012238-route-category-staging`
...
- `obs-evo-cand-012238-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012238-route-evolution-graph`
