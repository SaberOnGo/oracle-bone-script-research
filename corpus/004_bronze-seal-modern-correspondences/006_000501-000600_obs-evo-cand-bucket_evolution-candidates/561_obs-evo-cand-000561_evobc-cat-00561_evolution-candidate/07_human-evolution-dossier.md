...
Project ID: `obs-evo-cand-000561`
...
- Project ID: `obs-evo-cand-000561`
- EVOBC category candidate ID: `evobc-evo-cat-00561`
- External category reference: `evobc-cat-00561`
- Source category ID: `00561`
- Source label for human review: `䮘`
- Source codepoints: `U+4B98`
...
- `obs-evo-cand-000561-route-category-staging`
...
- `obs-evo-cand-000561-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000561-route-evolution-graph`
