...
- External category reference: `evobc-cat-11308`
- Source category ID: `11308`
- Source label for human review: `𢮬`
...
- `obs-evo-cand-011308-route-category-staging`
...
- `obs-evo-cand-011308-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011308-route-evolution-graph`
