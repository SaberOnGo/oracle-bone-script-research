...
Project ID: `obs-insc-cw-cand-000211`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000211`
...
- Yingguo / 英国所藏: `y1239` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `77` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `515` in source row; primary catalog entry pending
- Heji / 合集: `40447` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000211`
