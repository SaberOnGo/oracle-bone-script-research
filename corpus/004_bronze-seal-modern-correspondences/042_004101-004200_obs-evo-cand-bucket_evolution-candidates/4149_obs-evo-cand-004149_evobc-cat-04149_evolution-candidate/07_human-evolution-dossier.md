...
- Project ID: `obs-evo-cand-004149`
- EVOBC category candidate ID: `evobc-evo-cat-04149`
- External category reference: `evobc-cat-04149`
- Source category ID: `04149`
- Source label for human review: `楔`
- Source codepoints: `U+6954`
...
- `obs-evo-cand-004149-route-category-staging`
...
- `obs-evo-cand-004149-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004149-route-evolution-graph`
