...
- External category reference: `evobc-cat-02980`
- Source category ID: `02980`
- Source label for human review: `恤`
- Source codepoints: `U+6064`
...
- `obs-evo-cand-002980-route-category-staging`
...
- `obs-evo-cand-002980-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002980-route-evolution-graph`
