# obs-comp-cand-001137 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001137`
- 首选外部 ID: `obimd-sub-usqcyemfku`
- OBIMD subcharacter UID: `usqcyemfku`
- OBIMD main character UID: `usqcyemfku`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+9769;U+F6867; U+F6868; 另有 2 项
