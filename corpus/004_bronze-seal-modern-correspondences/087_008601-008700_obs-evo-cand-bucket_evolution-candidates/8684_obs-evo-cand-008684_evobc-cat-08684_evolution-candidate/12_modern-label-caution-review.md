# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008684
...
- EVOBC candidate category: `evobc-evo-cat-08684`.
- Source label for search only: `趜`.
- Source codepoints for search only: `U+8D9C`.
