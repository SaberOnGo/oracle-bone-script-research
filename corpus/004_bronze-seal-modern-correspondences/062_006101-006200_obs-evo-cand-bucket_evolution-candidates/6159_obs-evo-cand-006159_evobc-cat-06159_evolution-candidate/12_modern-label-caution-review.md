# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006159
...
- EVOBC candidate category: `evobc-evo-cat-06159`.
- Source label for search only: `窋`.
- Source codepoints for search only: `U+7A8B`.
