...
Project ID: `obs-evo-cand-009013`
...
- Project ID: `obs-evo-cand-009013`
- EVOBC category candidate ID: `evobc-evo-cat-09013`
- External category reference: `evobc-cat-09013`
- Source category ID: `09013`
- Source label for human review: `逴`
- Source codepoints: `U+9034`
...
- `obs-evo-cand-009013-route-category-staging`
...
- `obs-evo-cand-009013-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009013-route-evolution-graph`
