...
Project ID: `obs-evo-cand-007008`
...
- Project ID: `obs-evo-cand-007008`
- EVOBC category candidate ID: `evobc-evo-cat-07008`
- External category reference: `evobc-cat-07008`
- Source category ID: `07008`
- Source label for human review: `肵`
- Source codepoints: `U+80B5`
...
- `obs-evo-cand-007008-route-category-staging`
...
- `obs-evo-cand-007008-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007008-route-evolution-graph`
