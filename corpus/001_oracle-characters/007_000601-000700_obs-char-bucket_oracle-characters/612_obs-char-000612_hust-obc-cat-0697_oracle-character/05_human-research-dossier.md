# obs-char-000612 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/612_obs-char-000612_hust-obc-cat-0697_orac
  le-character/03_visual-assets/001_asset-000617_hust-obc-cat-0697_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0697/G_0697_後1.11.2合24474出組.png
  `
- asset id: `asset-000617`
...
- source category: `0697`
- validation class: `611`
- source image route: `HUST-OBC/deciphered/0697/G_0697_後1.11.2合24474出組.png`
- asset id: `asset-000617`
...
- English observation: `A dense narrow vertical figure combines a forked or
  looped top, multiple central crossings, and a long curved lower sweep.`
- 中文观察: `密集狭长竖形结合叉状或环状顶部、多处中央交叉和长弯下扫笔。`
...
- dataset label text: `㚯`
- dataset label codepoints: `U+36AF`
...
- filename catalog route clues: `Heji-like filename clue: 合24474
  (G_0697_後1.11.2合24474出組.png)`
...
- Which source records identify obs-char-000612 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000612？
