# Material Visual Observation / obs-comp-cand-000013 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000013`
- External reference / 外部参照: `obimd-sub-0wfbo7ml5k`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011078_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0wfbo7ml5k/0wfbo7ml5k/0wfbo7ml5k.png`
- Checksum / 校验和:
  `c2c05e7fb15017d8efd88bb8022ee76cfc935af2eea4c8b48a633f582d509f70`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.19%.
- Marked-pixel bounds: (88,27)–(161,223); span 74 × 197 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.19%。
- 痕迹范围：(88,27)–(161,223)；跨度74 × 197 px；痕迹矩形高于宽。
