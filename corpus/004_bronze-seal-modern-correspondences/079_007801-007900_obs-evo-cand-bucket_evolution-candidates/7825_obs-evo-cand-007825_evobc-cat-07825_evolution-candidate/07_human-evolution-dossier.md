...
Project ID: `obs-evo-cand-007825`
...
- Project ID: `obs-evo-cand-007825`
- EVOBC category candidate ID: `evobc-evo-cat-07825`
- External category reference: `evobc-cat-07825`
- Source category ID: `07825`
- Source label for human review: `螌`
- Source codepoints: `U+878C`
...
- `obs-evo-cand-007825-route-category-staging`
...
- `obs-evo-cand-007825-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007825-route-evolution-graph`
