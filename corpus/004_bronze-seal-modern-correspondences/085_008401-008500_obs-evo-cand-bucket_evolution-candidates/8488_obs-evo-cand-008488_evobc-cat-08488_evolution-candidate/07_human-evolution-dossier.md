...
- External category reference: `evobc-cat-08488`
- Source category ID: `08488`
- Source label for human review: `豛`
...
- `obs-evo-cand-008488-route-category-staging`
...
- `obs-evo-cand-008488-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008488-route-evolution-graph`
