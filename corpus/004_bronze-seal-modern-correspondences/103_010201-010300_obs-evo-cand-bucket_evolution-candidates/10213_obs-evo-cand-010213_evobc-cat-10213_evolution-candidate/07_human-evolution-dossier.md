...
- External category reference: `evobc-cat-10213`
- Source category ID: `10213`
- Source label for human review: `騊`
...
- `obs-evo-cand-010213-route-category-staging`
...
- `obs-evo-cand-010213-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010213-route-evolution-graph`
