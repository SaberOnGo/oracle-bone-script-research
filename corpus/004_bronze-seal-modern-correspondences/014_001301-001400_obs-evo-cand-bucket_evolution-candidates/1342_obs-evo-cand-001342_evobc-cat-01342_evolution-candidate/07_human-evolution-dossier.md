...
- External category reference: `evobc-cat-01342`
- Source category ID: `01342`
- Source label for human review: `匠`
...
- `obs-evo-cand-001342-route-category-staging`
...
- `obs-evo-cand-001342-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001342-route-evolution-graph`
