...
- External category reference: `evobc-cat-05339`
- Source category ID: `05339`
- Source label for human review: `玄`
- Source codepoints: `U+7384`
- Image reference count in source metadata: `110`
...
- `obs-evo-cand-005339-route-category-staging`
...
- `obs-evo-cand-005339-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005339-route-evolution-graph`
