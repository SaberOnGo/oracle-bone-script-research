# obs-unk-004617 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/017_obs-unk-004617_h
  ust-obc-und-X-004617_oracle-character-candidate/03_visual-assets/001_asset
  -006210_hust-obc-und-X-004617_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/173/X_？_8348_1.png`
- asset id: `asset-006210`
...
- source class: `HUST-OBC/undeciphered/X/173/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/173/X_？_8348_1.png`
- asset id: `asset-006210`
...
- English observation: `left loop with stem and separate right trace`
- 中文观察: `左侧环状形体、下伸竖痕和右侧分离痕已记录。`
...
- Which source records identify obs-unk-004617 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004617？
