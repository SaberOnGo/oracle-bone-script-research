# obs-char-000534 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000534`
- primary external id: `hust-obc-cat-0608`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/534_obs-char-000534_hust-obc-cat-0608_orac
  le-character/03_visual-assets/001_asset-000539_hust-obc-cat-0608_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0608/G_0608_戩4.15(甲).png`
- asset id: `asset-000539`
...
- source category: `0608`
- validation class: `533`
- source image route: `HUST-OBC/deciphered/0608/G_0608_戩4.15(甲).png`
- asset id: `asset-000539`
...
- English observation: `Two thin separated angular line groups form a short
  sloping upper corner and a larger open lower three-sided outline.`
- 中文观察: `两个纤细分离折线群分别形成短斜上角和较大的下部三边开口轮廓。`
...
- dataset label text: `㙖`
- dataset label codepoints: `U+3656`
...
- Which source records identify obs-char-000534 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000534？
