...
Project ID: `obs-evo-cand-000846`
...
- Project ID: `obs-evo-cand-000846`
- EVOBC category candidate ID: `evobc-evo-cat-00846`
- External category reference: `evobc-cat-00846`
- Source category ID: `00846`
- Source label for human review: `侔`
- Source codepoints: `U+4F94`
...
- `obs-evo-cand-000846-route-category-staging`
...
- `obs-evo-cand-000846-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000846-route-evolution-graph`
