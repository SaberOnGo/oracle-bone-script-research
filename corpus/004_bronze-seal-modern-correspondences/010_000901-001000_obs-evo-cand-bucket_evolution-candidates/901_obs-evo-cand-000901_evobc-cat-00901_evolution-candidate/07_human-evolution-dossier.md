...
Project ID: `obs-evo-cand-000901`
...
- Project ID: `obs-evo-cand-000901`
- EVOBC category candidate ID: `evobc-evo-cat-00901`
- External category reference: `evobc-cat-00901`
- Source category ID: `00901`
- Source label for human review: `俨`
- Source codepoints: `U+4FE8`
...
- `obs-evo-cand-000901-route-category-staging`
...
- `obs-evo-cand-000901-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000901-route-evolution-graph`
