...
- External category reference: `evobc-cat-00562`
- Source category ID: `00562`
- Source label for human review: `䮙`
- Source codepoints: `U+4B99`
...
- `obs-evo-cand-000562-route-category-staging`
...
- `obs-evo-cand-000562-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000562-route-evolution-graph`
