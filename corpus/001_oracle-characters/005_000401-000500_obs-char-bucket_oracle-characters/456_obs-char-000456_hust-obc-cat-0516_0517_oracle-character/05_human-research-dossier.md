# obs-char-000456 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/456_obs-char-000456_hust-obc-cat-0516_0517
  _oracle-character/03_visual-assets/001_asset-000461_hust-obc-cat-0516_0517
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0516_0517/0516/G_0516_京津2676(甲)
  .png`
- asset id: `asset-000461`
...
- source category: `0516_0517`
- validation class: `455`
- source image route: `HUST-OBC/deciphered/0516_0517/0516/G_0516_京津2676(甲).png
  `
- asset id: `asset-000461`
...
- English observation: `A triangular upper outline sits above a rectangular
  lower enclosure at left; a separate long curved vertical stroke descends
  along the right side.`
- 中文观察: `左侧三角形上轮廓位于矩形下部围框之上，右侧另有一条分离的长弯曲竖笔下垂。`
...
- dataset label text: `㗺㗻`
- dataset label codepoints: `U+35FA;U+35FB`
...
- Which source records identify obs-char-000456 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000456？
