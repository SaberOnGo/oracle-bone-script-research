...
- External category reference: `evobc-cat-06470`
- Source category ID: `06470`
- Source label for human review: `紧`
...
- `obs-evo-cand-006470-route-category-staging`
...
- `obs-evo-cand-006470-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006470-route-evolution-graph`
