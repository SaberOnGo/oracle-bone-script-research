...
Project ID: `obs-evo-cand-009778`
...
- Project ID: `obs-evo-cand-009778`
- EVOBC category candidate ID: `evobc-evo-cat-09778`
- External category reference: `evobc-cat-09778`
- Source category ID: `09778`
- Source label for human review: `隙`
- Source codepoints: `U+9699`
...
- `obs-evo-cand-009778-route-category-staging`
...
- `obs-evo-cand-009778-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009778-route-evolution-graph`
