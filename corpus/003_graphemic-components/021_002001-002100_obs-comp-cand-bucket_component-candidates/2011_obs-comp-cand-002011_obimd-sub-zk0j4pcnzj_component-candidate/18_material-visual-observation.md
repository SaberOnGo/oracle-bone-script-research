# Material Visual Observation / obs-comp-cand-002011 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002011`
- External reference / 外部参照: `obimd-sub-zk0j4pcnzj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019338_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zk0j4pcnzj/zk0j4pcnzj/zk0j4pcnzj.png`
- Checksum / 校验和:
  `66dcee6bcc94971cdc1b9ea8bb6e58cc31ecd543e8754b50f227a2e3d0ff28a5`
...
- Marked-pixel bounds: (81,12)–(159,237); span 79 × 226 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.86%。
- 痕迹范围：(81,12)–(159,237)；跨度79 × 226 px；痕迹矩形高于宽。
