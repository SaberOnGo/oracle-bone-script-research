# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003691
...
- EVOBC candidate category: `evobc-evo-cat-03691`.
- Source label for search only: `旰`.
- Source codepoints for search only: `U+65F0`.
