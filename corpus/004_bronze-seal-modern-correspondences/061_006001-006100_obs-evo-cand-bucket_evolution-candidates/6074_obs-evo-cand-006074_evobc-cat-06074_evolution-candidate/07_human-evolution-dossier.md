...
- External category reference: `evobc-cat-06074`
- Source category ID: `06074`
- Source label for human review: `秨`
...
- `obs-evo-cand-006074-route-category-staging`
...
- `obs-evo-cand-006074-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006074-route-evolution-graph`
