...
- External category reference: `evobc-cat-09551`
- Source category ID: `09551`
- Source label for human review: `鑣`
...
- `obs-evo-cand-009551-route-category-staging`
...
- `obs-evo-cand-009551-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009551-route-evolution-graph`
