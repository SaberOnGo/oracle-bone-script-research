...
- External category reference: `evobc-cat-07492`
- Source category ID: `07492`
- Source label for human review: `蒂`
...
- `obs-evo-cand-007492-route-category-staging`
...
- `obs-evo-cand-007492-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007492-route-evolution-graph`
