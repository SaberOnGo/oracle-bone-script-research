...
- Project ID / 项目 ID: `obs-char-001556`
- Primary external ID / 首选外部 ID: `hust-obc-cat-1747`
...
- Source image / 来源图: `G_1747_合20281(甲).png`
- Image / 图像: `001_asset-001561_hust-obc-cat-1747_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合20281
  (G_1747_合20281(甲).png)`
...
- Source label text / 来源标签文字: `㫉`
- Source label codepoint / 来源标签 codepoint: `U+3AC9`
