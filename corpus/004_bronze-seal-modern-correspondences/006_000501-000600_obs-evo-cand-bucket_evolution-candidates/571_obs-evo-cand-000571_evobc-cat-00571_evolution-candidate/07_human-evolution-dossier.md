...
- External category reference: `evobc-cat-00571`
- Source category ID: `00571`
- Source label: `䯩`
...
- `obs-evo-cand-000571-route-category-staging`
...
- `obs-evo-cand-000571-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000571-route-evolution-graph`
