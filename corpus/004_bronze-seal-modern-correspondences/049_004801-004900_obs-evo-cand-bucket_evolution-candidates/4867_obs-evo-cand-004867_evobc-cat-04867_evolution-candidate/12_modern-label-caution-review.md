# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004867
...
- EVOBC candidate category: `evobc-evo-cat-04867`.
- Source label for search only: `漏`.
- Source codepoints for search only: `U+6F0F`.
