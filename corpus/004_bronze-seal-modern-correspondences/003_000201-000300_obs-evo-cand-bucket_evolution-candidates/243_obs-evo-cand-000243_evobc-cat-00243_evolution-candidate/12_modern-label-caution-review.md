# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000243
...
- EVOBC candidate category: `evobc-evo-cat-00243`.
- Source label for search only: `㼌`.
- Source codepoints for search only: `U+3F0C`.
