...
- `obs-evo-cand-006818-route-category-staging`
...
- `obs-evo-cand-006818-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006818-route-evolution-graph`
