# Material Visual Observation / obs-comp-cand-000494 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000494`
- External reference / 外部参照: `obimd-sub-4nvomvnfj0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012730_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4nvomvnfj0/4nvomvnfj0/4nvomvnfj0.png`
- Checksum / 校验和:
  `22dbdae44109fedcded7df4d18e683baa8c1be6299eab5efbc5831e3720877e9`
...
- Marked-pixel bounds: (83,21)–(166,230); span 84 × 210 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.95%。
- 痕迹范围：(83,21)–(166,230)；跨度84 × 210 px；痕迹矩形高于宽。
