...
Project ID: `obs-evo-cand-009882`
...
- Project ID: `obs-evo-cand-009882`
- EVOBC category candidate ID: `evobc-evo-cat-09882`
- External category reference: `evobc-cat-09882`
- Source category ID: `09882`
- Source label for human review: `靖`
- Source codepoints: `U+9756`
...
- `obs-evo-cand-009882-route-category-staging`
...
- `obs-evo-cand-009882-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009882-route-evolution-graph`
