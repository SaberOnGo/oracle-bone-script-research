# obs-char-001066 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1066_obs-char-001066_hust-obc-cat-1193_ora
  cle-character/03_visual-assets/001_asset-001071_hust-obc-cat-1193_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1193/Y_1193_609A4.jpg`
- asset id: `asset-001071`
...
- source category: `1193`
- validation class: `1065`
- source image route: `HUST-OBC/deciphered/1193/Y_1193_609A4.jpg`
- asset id: `asset-001071`
...
- English observation: `A very bold left form has a rounded upper enclosure
  and several long lower curves, beside a separate angular branching form on
  the right.`
...
- dataset label text: `㢟`
- dataset label codepoints: `U+389F`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00099`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00099`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00099`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/099_obs-evo-can
  d-000099_evobc-cat-00099_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/099_obs-evo-cand-000099_evobc-cat-00099_evolu
...
- Which source records identify obs-char-001066 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001066？
