# obs-unk-004793 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/093_obs-unk-004793_h
  ust-obc-und-X-004793_oracle-character-candidate/03_visual-assets/001_asset
  -006386_hust-obc-und-X-004793_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/349/X_？_7116_1.png`
- asset id: `asset-006386`
...
- source class: `HUST-OBC/undeciphered/X/349/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/349/X_？_7116_1.png`
- asset id: `asset-006386`
...
- English observation: `upper triangular opening and separate lower groups`
- 中文观察: `上部三角开口和分离的下部结构`
...
- Which source records identify obs-unk-004793 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004793？
