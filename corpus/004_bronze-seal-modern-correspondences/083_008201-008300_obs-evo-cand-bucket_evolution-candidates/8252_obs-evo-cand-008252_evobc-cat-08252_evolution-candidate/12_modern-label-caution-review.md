# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008252
...
- EVOBC candidate category: `evobc-evo-cat-08252`.
- Source label for search only: `誻`.
- Source codepoints for search only: `U+8ABB`.
