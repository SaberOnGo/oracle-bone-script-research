# Material Visual Observation / obs-comp-cand-001327 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001327`
- External reference / 外部参照: `obimd-sub-zhdr0vtntz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015664_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zhdr0vtntz/zhdr0vtntz/zhdr0vtntz.png`
- Checksum / 校验和:
  `745e041b790ff391e0c0010493036b23367e2461ef01b9762fb342bd2c41fab5`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.05%.
- Marked-pixel bounds: (91,33)–(158,222); span 68 × 190 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.05%。
- 痕迹范围：(91,33)–(158,222)；跨度68 × 190 px；痕迹矩形高于宽。
