# Material Visual Observation / obs-comp-cand-000036 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000036`
- External reference / 外部参照: `obimd-sub-egsgsijlte`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011293_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/egsgsijlte/egsgsijlte/egsgsijlte.png`
- Checksum / 校验和:
  `c8f31cbc834c98612da0997561b9caf6ed51ef6d9d042b4e21af5be6e7912dee`
...
- Marked-pixel bounds: (85,21)–(164,226); span 80 × 206 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.44%。
- 痕迹范围：(85,21)–(164,226)；跨度80 × 206 px；痕迹矩形高于宽。
