# obs-char-000387 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/387_obs-char-000387_hust-obc-cat-0439_orac
  le-character/03_visual-assets/001_asset-000392_hust-obc-cat-0439_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0439/H_0439_616FA_0.png`
- asset id: `asset-000392`
...
- source category: `0439`
- validation class: `386`
- source image route: `HUST-OBC/deciphered/0439/H_0439_616FA_0.png`
- asset id: `asset-000392`
...
- English observation: `The image contains two separated dark forms: a
  branching angular form at left and a U-shaped upper contour with a long
  stem at right.`
...
- dataset label text: `㖭`
- dataset label codepoints: `U+35AD`
...
- filename catalog route clues: `catalog-like filename clue: H_0439
  (H_0439_616FA_0.png)`
...
- Which source records identify obs-char-000387 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000387？
