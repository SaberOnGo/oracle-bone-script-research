...
- External category reference: `evobc-cat-08530`
- Source category ID: `08530`
- Source label for human review: `貚`
...
- `obs-evo-cand-008530-route-category-staging`
...
- `obs-evo-cand-008530-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008530-route-evolution-graph`
