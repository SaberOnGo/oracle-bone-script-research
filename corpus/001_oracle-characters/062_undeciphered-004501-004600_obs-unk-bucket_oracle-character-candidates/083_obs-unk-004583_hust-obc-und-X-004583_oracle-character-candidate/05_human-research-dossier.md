# obs-unk-004583 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004583`
- primary external id: `hust-obc-und-X-004583`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/083_obs-unk-004583_h
  ust-obc-und-X-004583_oracle-character-candidate/03_visual-assets/001_asset
  -006176_hust-obc-und-X-004583_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/139/X_？_8317_1.png`
- asset id: `asset-006176`
...
- source class: `HUST-OBC/undeciphered/X/139/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/139/X_？_8317_1.png`
- asset id: `asset-006176`
...
- English observation: `Upper enclosure, central stroke, lower slopes, and`
  `missing image recorded.`
- 中文观察: `已记录上部轮廓、中央痕、下部斜边和缺失图像。`
...
- Which source records identify obs-unk-004583 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004583？
