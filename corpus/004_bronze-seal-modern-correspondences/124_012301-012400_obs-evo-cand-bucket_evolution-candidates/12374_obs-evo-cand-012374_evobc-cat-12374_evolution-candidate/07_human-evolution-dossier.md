...
- Project ID: `obs-evo-cand-012374`
- EVOBC category candidate ID: `evobc-evo-cat-12374`
- External category reference: `evobc-cat-12374`
- Source category ID: `12374`
- Source label for human review: `𨕘`
- Source codepoints: `U+28558`
...
- `obs-evo-cand-012374-route-category-staging`
...
- `obs-evo-cand-012374-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012374-route-evolution-graph`
