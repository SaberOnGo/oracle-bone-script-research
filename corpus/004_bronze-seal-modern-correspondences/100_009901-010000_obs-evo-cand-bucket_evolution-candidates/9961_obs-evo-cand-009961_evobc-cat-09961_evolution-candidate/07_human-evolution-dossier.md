...
- External category reference: `evobc-cat-09961`
- Source category ID: `09961`
- Source label for human review: `音`
...
- `obs-evo-cand-009961-route-category-staging`
...
- `obs-evo-cand-009961-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009961-route-evolution-graph`
