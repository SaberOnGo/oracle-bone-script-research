# obs-evo-cand-006124 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-006124`
- EVOBC category candidate ID: `evobc-evo-cat-06124`
- External category ref: `evobc-cat-06124`
- Source label for human review: `穆`
- Source codepoints: `U+7A46`
- Image reference count: `122`
- Era token counts: `BI:39;CS:1;OBC:35;SAC:13;SS:2;WSC:32`
- Source token counts: `Book:57;Web:65`
