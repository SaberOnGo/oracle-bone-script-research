...
Project ID: `obs-evo-cand-005681`
...
- Project ID: `obs-evo-cand-005681`
- EVOBC category candidate ID: `evobc-evo-cat-05681`
- External category reference: `evobc-cat-05681`
- Source category ID: `05681`
- Source label for human review: `瘳`
- Source codepoints: `U+7633`
...
- `obs-evo-cand-005681-route-category-staging`
...
- `obs-evo-cand-005681-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005681-route-evolution-graph`
