...
Project ID: `obs-evo-cand-008068`
...
- Project ID: `obs-evo-cand-008068`
- EVOBC category candidate ID: `evobc-evo-cat-08068`
- External category reference: `evobc-cat-08068`
- Source category ID: `08068`
- Source label for human review: `覣`
- Source codepoints: `U+89A3`
...
- `obs-evo-cand-008068-route-category-staging`
...
- `obs-evo-cand-008068-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008068-route-evolution-graph`
