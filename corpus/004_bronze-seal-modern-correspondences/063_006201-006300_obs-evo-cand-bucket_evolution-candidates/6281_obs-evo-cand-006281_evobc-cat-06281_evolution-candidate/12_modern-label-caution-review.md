# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006281
...
- EVOBC candidate category: `evobc-evo-cat-06281`.
- Source label for search only: `签`.
- Source codepoints for search only: `U+7B7E`.
