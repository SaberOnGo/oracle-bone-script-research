...
- External category reference: `evobc-cat-02839`
- Source category ID: `02839`
- Source label for human review: `彝`
- Source codepoints: `U+5F5D`
- Image reference count in source metadata: `634`
...
- `obs-evo-cand-002839-route-category-staging`
...
- `obs-evo-cand-002839-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002839-route-evolution-graph`
