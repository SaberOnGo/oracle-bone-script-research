# obs-char-000769 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000769`
- primary external id: `hust-obc-cat-0873`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/769_obs-char-000769_hust-obc-cat-0873_orac
  le-character/03_visual-assets/001_asset-000774_hust-obc-cat-0873_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0873/G_0873_後2.3.2合11323𠂤賓間.png
  `
- asset id: `asset-000774`
...
- source category: `0873`
- validation class: `768`
- source image route: `HUST-OBC/deciphered/0873/G_0873_後2.3.2合11323𠂤賓間.png`
- asset id: `asset-000774`
...
- dataset label text: `㝟`
- dataset label codepoints: `U+375F`
...
- filename catalog route clues: `Heji-like filename clue: 合11323
  (G_0873_後2.3.2合11323𠂤賓間.png)`
...
- Which source records identify obs-char-000769 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000769？
