# obs-char-000540 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000540`
- primary external id: `hust-obc-cat-0614`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/540_obs-char-000540_hust-obc-cat-0614_orac
  le-character/03_visual-assets/001_asset-000545_hust-obc-cat-0614_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0614/G_0614_乙4703(甲).png`
- asset id: `asset-000545`
...
- source category: `0614`
- validation class: `539`
- source image route: `HUST-OBC/deciphered/0614/G_0614_乙4703(甲).png`
- asset id: `asset-000545`
...
- English observation: `A narrow central stem forks at the top and carries
  several short alternating side branches before continuing into a long
  curved lower point.`
- 中文观察: `狭长中央干顶部叉开，沿两侧交替伸出数条短枝，下端延续为长弯尖笔。`
...
- dataset label text: `㙜`
- dataset label codepoints: `U+365C`
...
- Which source records identify obs-char-000540 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000540？
