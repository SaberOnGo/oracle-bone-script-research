...
Project ID: `obs-evo-cand-002478`
...
- Project ID: `obs-evo-cand-002478`
- EVOBC category candidate ID: `evobc-evo-cat-02478`
- External category reference: `evobc-cat-02478`
- Source category ID: `02478`
- Source label for human review: `尢`
- Source codepoints: `U+5C22`
...
- `obs-evo-cand-002478-route-category-staging`
...
- `obs-evo-cand-002478-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002478-route-evolution-graph`
