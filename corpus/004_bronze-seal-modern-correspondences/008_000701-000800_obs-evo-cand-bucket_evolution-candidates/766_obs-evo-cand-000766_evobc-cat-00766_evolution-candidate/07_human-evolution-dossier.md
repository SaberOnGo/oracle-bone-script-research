...
- External category reference: `evobc-cat-00766`
- Source category ID: `00766`
- Source label for human review: `伍`
- Source codepoints: `U+4F0D`
...
- `obs-evo-cand-000766-route-category-staging`
...
- `obs-evo-cand-000766-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000766-route-evolution-graph`
