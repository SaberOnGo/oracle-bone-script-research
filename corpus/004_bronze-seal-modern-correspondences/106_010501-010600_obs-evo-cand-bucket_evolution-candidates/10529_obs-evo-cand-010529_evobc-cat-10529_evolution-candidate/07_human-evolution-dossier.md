...
- External category reference: `evobc-cat-10529`
- Source category ID: `10529`
- Source label for human review: `鶡`
...
- `obs-evo-cand-010529-route-category-staging`
...
- `obs-evo-cand-010529-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010529-route-evolution-graph`
