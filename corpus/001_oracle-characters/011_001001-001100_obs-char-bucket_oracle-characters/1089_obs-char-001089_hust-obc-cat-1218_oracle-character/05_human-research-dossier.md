# obs-char-001089 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1089_obs-char-001089_hust-obc-cat-1218_ora
  cle-character/03_visual-assets/001_asset-001094_hust-obc-cat-1218_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1218/L_1218_11007.jpg`
- asset id: `asset-001094`
...
- source category: `1218`
- validation class: `1088`
- source image route: `HUST-OBC/deciphered/1218/L_1218_11007.jpg`
- asset id: `asset-001094`
...
- English observation: `The faint gray image shows a rounded upper loop
  above a pointed lower enclosed form; contrast is low.`
- 中文观察: `较淡灰色图像显示圆弧上部环笔位于尖状下部闭合形体之上；对比度较低。`
...
- dataset label text: `㢸`
- dataset label codepoints: `U+38B8`
...
- Which source records identify obs-char-001089 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001089？
