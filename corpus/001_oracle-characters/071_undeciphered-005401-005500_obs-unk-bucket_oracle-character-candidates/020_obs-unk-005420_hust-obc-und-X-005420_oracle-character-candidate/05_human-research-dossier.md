# obs-unk-005420 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/071_undeciphered-005
  401-005500_obs-unk-bucket_oracle-character-candidates/020_obs-unk-005420_h
  ust-obc-und-X-005420_oracle-character-candidate/03_visual-assets/001_asset
  -007013_hust-obc-und-X-005420_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/976/X_？_7940_1.png`
- asset id: `asset-007013`
...
- source class: `HUST-OBC/undeciphered/X/976/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/976/X_？_7940_1.png`
- asset id: `asset-007013`
...
- Which source records identify obs-unk-005420 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005420？
