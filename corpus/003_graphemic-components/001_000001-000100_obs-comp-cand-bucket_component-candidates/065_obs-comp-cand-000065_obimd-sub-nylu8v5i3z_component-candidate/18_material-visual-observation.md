# Material Visual Observation / obs-comp-cand-000065 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000065`
- External reference / 外部参照: `obimd-sub-nylu8v5i3z`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011478_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/crd6njmjax/nylu8v5i3z/nylu8v5i3z.png`
- Checksum / 校验和:
  `22aea81a8bc1a27341c071d37b73aec79bb41fba3e5ac21d09189f171407ce8d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.14%.
- Marked-pixel bounds: (61,60)–(189,189); span 129 × 130 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.14%。
- 痕迹范围：(61,60)–(189,189)；跨度129 × 130 px；痕迹矩形近方形。
