# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000174
...
- EVOBC candidate category: `evobc-evo-cat-00174`.
- Source label for search only: `㮛`.
- Source codepoints for search only: `U+3B9B`.
