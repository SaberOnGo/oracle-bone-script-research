# obs-char-000979 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000979`
- primary external id: `hust-obc-cat-1099`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/979_obs-char-000979_hust-obc-cat-1099_orac
  le-character/03_visual-assets/001_asset-000984_hust-obc-cat-1099_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1099/G_1099_甲骨文0.png`
- asset id: `asset-000984`
...
- source category: `1099`
- validation class: `978`
- source image route: `HUST-OBC/deciphered/1099/G_1099_甲骨文0.png`
- asset id: `asset-000984`
...
- English observation: `A small dense branching cluster combines a dark
  upper projection, a central crossing, and rounded lower marks.`
- 中文观察: `小型密集分枝笔群结合深色上伸笔、中央交叉和圆弧下部痕迹。`
...
- dataset label text: `㡁`
- dataset label codepoints: `U+3841`
...
- Which source records identify obs-char-000979 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000979？
