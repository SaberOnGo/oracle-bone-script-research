# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012749
...
- EVOBC candidate category: `evobc-evo-cat-12749`.
- Source label for search only: `𪍟`.
- Source codepoints for search only: `U+2A35F`.
