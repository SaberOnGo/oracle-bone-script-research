# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013519
...
- EVOBC candidate category: `evobc-evo-cat-13519`.
- Source label for search only: `𭚋`.
- Source codepoints for search only: `U+2D68B`.
