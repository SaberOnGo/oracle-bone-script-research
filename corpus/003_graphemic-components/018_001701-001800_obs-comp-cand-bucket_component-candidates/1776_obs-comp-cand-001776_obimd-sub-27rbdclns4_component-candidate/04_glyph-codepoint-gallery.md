# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001776
...
| --- | --- | --- | --- |
| `obimd-glyph-link-027182` | 󐃹󺍩 | `U+D00F9;U+FA369` | `reviewed_metadata_only` |
| `obimd-glyph-link-027183` | 󺍪 | `U+FA36A` | `reviewed_metadata_only` |
| `obimd-glyph-link-027184` | 󺍫 | `U+FA36B` | `reviewed_metadata_only` |
| `obimd-glyph-link-027185` | 󺍬 | `U+FA36C` | `reviewed_metadata_only` |
