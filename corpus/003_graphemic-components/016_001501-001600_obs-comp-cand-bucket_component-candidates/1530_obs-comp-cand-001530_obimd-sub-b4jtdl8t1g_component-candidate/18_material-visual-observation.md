# Material Visual Observation / obs-comp-cand-001530 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001530`
- External reference / 外部参照: `obimd-sub-b4jtdl8t1g`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016944_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/237k640lqx/b4jtdl8t1g/b4jtdl8t1g.png`
- Checksum / 校验和:
  `3d0aca4c034748d944c2eddcbb015afd82a76193a8ffd0df4428acd2c03f5322`
...
- Marked-pixel bounds: (89,33)–(160,214); span 72 × 182 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.74%。
- 痕迹范围：(89,33)–(160,214)；跨度72 × 182 px；痕迹矩形高于宽。
