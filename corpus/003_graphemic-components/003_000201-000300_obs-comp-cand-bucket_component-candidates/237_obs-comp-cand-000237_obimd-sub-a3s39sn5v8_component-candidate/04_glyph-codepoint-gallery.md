# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000237
...
| --- | --- | --- | --- |
| `obimd-glyph-link-003298` | 󱗉 | `U+F15C9` | `reviewed_metadata_only` |
| `obimd-glyph-link-003299` | 󱗊 | `U+F15CA` | `reviewed_metadata_only` |
| `obimd-glyph-link-003300` | 󱗋 | `U+F15CB` | `reviewed_metadata_only` |
| `obimd-glyph-link-003301` | 󱗌 | `U+F15CC` | `reviewed_metadata_only` |
