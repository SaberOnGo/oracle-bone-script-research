# obs-unk-004417 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/017_obs-unk-004417_h
  ust-obc-und-L-004417_oracle-character-candidate/03_visual-assets/001_asset
  -006010_hust-obc-und-L-004417_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4417/L_？_9889.jpg`
- asset id: `asset-006010`
...
- source class: `HUST-OBC/undeciphered/L/4417/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4417/L_？_9889.jpg`
- asset id: `asset-006010`
...
- English observation: `A tapered upper mark sits above a curved band`
  `and lower outline.`
- 中文观察: `上部变细痕迹位于弧形带和下部轮廓之上。`
...
- Which source records identify obs-unk-004417 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004417？
