# obs-unk-004773 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004773`
- primary external id: `hust-obc-und-X-004773`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/073_obs-unk-004773_h
  ust-obc-und-X-004773_oracle-character-candidate/03_visual-assets/001_asset
  -006366_hust-obc-und-X-004773_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/329/X_？_7313_1.png`
- asset id: `asset-006366`
...
- source class: `HUST-OBC/undeciphered/X/329/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/329/X_？_7313_1.png`
- asset id: `asset-006366`
...
- English observation: `separated upper groups with long lower curves`
- 中文观察: `分离的上部结构和下部长曲线`
...
- Which source records identify obs-unk-004773 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004773？
