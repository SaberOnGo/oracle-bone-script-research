...
Project ID: `obs-evo-cand-002618`
...
- Project ID: `obs-evo-cand-002618`
- EVOBC category candidate ID: `evobc-evo-cat-02618`
- External category reference: `evobc-cat-02618`
- Source category ID: `02618`
- Source label for human review: `左`
- Source codepoints: `U+5DE6`
- Image reference count in source metadata: `105`
...
- `obs-evo-cand-002618-route-category-staging`
...
- `obs-evo-cand-002618-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002618-route-evolution-graph`
