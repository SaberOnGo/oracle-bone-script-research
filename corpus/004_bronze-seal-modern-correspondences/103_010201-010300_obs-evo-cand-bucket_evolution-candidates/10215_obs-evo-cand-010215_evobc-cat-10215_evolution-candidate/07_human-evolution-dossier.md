...
- External category reference: `evobc-cat-10215`
- Source category ID: `10215`
- Source label for human review: `騍`
...
- `obs-evo-cand-010215-route-category-staging`
...
- `obs-evo-cand-010215-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010215-route-evolution-graph`
