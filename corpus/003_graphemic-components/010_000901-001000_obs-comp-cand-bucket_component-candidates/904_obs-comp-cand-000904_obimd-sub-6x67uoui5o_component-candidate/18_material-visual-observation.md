# Material Visual Observation / obs-comp-cand-000904 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000904`
- External reference / 外部参照: `obimd-sub-6x67uoui5o`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013976_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/947jc8d4sh/6x67uoui5o/6x67uoui5o.png`
- Checksum / 校验和:
  `000c074066306620230419b419577629ec428a9f282b9e5fed213e3b33280274`
...
- Marked-pixel bounds: (68,41)–(181,204); span 114 × 164 px; the marked
...
- 痕迹范围：(68,41)–(181,204)；跨度114 × 164 px；痕迹矩形高于宽。
