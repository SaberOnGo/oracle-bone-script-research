# Material Visual Observation / obs-comp-cand-001078 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001078`
- External reference / 外部参照: `obimd-sub-avzjpgqkym`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014775_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/avzjpgqkym/avzjpgqkym/avzjpgqkym.png`
- Checksum / 校验和:
  `96daca79e235a022945e46a8441493bbf802ced926c009d9717ab602b1d43b9a`
...
- Marked-pixel bounds: (88,31)–(161,223); span 74 × 193 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.28%。
- 痕迹范围：(88,31)–(161,223)；跨度74 × 193 px；痕迹矩形高于宽。
