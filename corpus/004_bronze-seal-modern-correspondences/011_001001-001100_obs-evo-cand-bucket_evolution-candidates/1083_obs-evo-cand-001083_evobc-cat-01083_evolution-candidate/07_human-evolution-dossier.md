...
- External category reference: `evobc-cat-01083`
- Source category ID: `01083`
- Source label for human review: `兜`
...
- `obs-evo-cand-001083-route-category-staging`
...
- `obs-evo-cand-001083-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001083-route-evolution-graph`
