...
- External category reference: `evobc-cat-06213`
- Source category ID: `06213`
- Source label for human review: `端`
...
- `obs-evo-cand-006213-route-category-staging`
...
- `obs-evo-cand-006213-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006213-route-evolution-graph`
