...
- Project ID: `obs-evo-cand-013370`
- EVOBC category candidate ID: `evobc-evo-cat-13370`
- External category reference: `evobc-cat-13370`
- Source category ID: `13370`
- Source label for human review: `𬩠`
- Source codepoints: `U+2CA60`
...
- `obs-evo-cand-013370-route-category-staging`
...
- `obs-evo-cand-013370-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013370-route-evolution-graph`
