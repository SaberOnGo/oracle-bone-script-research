# obs-unk-004379 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004379`
- primary external id: `hust-obc-und-L-004379`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/079_obs-unk-004379_h
  ust-obc-und-L-004379_oracle-character-candidate/03_visual-assets/001_asset
  -005972_hust-obc-und-L-004379_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4379/L_？_9730.jpg`
- asset id: `asset-005972`
...
- source class: `HUST-OBC/undeciphered/L/4379/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4379/L_？_9730.jpg`
- asset id: `asset-005972`
...
- English observation: `A tall central axis and spreading side traces`
  `are visible; a small lower opening has pointed strokes beneath it.`
- 中文观察: `中央有纵向主痕，两侧痕迹外张，下部小空隙下有尖出笔痕。`
...
- Which source records identify obs-unk-004379 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004379？
