# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010427
...
- EVOBC candidate category: `evobc-evo-cat-10427`.
- Source label for search only: `鰋`.
- Source codepoints for search only: `U+9C0B`.
