# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004369
...
- EVOBC candidate category: `evobc-evo-cat-04369`.
- Source label for search only: `歌`.
- Source codepoints for search only: `U+6B4C`.
