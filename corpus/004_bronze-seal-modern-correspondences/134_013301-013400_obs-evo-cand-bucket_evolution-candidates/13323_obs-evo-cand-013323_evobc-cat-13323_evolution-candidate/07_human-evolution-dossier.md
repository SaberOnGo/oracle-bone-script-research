...
- External category reference: `evobc-cat-13323`
- Source category ID: `13323`
- Source label for human review: `𬡧`
- Source codepoints: `U+2C867`
...
- `obs-evo-cand-013323-route-category-staging`
...
- `obs-evo-cand-013323-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013323-route-evolution-graph`
