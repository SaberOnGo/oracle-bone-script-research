# Material Visual Observation / obs-comp-cand-001493 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001493`
- External reference / 外部参照: `obimd-sub-s51rj1pdre`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016104_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cutrxw7e48/s51rj1pdre/s51rj1pdre.png`
- Checksum / 校验和:
  `dec692841ff03fc50bca8d2aa38fdc8da85a617e951afb1406ac4e63c97c23a3`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.68%.
- Marked-pixel bounds: (65,37)–(184,209); span 120 × 173 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.68%。
- 痕迹范围：(65,37)–(184,209)；跨度120 × 173 px；痕迹矩形高于宽。
