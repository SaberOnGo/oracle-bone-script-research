# Material Visual Observation / obs-comp-cand-001378 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001378`
- External reference / 外部参照: `obimd-sub-2x1nxm17qq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015797_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/c7qvt9bwt5/2x1nxm17qq/2x1nxm17qq.png`
- Checksum / 校验和:
  `1222e045e01651f60d3bedb967514c0b8060b2bfd2d5d58afdc0ed704774cfd4`
...
- Marked-pixel bounds: (78,21)–(175,226); span 98 × 206 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.50%。
- 痕迹范围：(78,21)–(175,226)；跨度98 × 206 px；痕迹矩形高于宽。
