# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006744
...
- EVOBC candidate category: `evobc-evo-cat-06744`.
- Source label for search only: `绍`.
- Source codepoints for search only: `U+7ECD`.
