# Material Visual Observation / obs-comp-cand-002113 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002113`
- External reference / 外部参照: `obimd-sub-mbvaikkj2d`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019611_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hftl4m18q0/mbvaikkj2d/mbvaikkj2d.png`
- Checksum / 校验和:
  `e44817f1b10b1107c5963ed39093b9f484114f2f1a9044c9a743d2b68c4de93f`
...
- Marked-pixel bounds: (64,39)–(185,219); span 122 × 181 px; the marked
...
- 痕迹范围：(64,39)–(185,219)；跨度122 × 181 px；痕迹矩形高于宽。
