# obs-char-001519 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1519_obs-char-001519_hust-obc-cat-1704_ora
  cle-character/03_visual-assets/001_asset-001524_hust-obc-cat-1704_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1704/X_1704_489_1.png`
- asset id: `asset-001524`
...
- source category: `1704`
- validation class: `1518`
- source image route: `HUST-OBC/deciphered/1704/X_1704_489_1.png`
- asset id: `asset-001524`
...
- English observation: `A large composite pairs a four-way upper cross with
  a broad rounded lower enclosure.`
...
- dataset label text: `㪞`
- dataset label codepoints: `U+3A9E`
...
- Which source records identify obs-char-001519 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001519？
