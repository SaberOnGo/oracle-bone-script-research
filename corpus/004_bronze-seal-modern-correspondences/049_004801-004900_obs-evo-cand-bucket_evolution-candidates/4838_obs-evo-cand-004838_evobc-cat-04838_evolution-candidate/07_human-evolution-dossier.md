...
- External category reference: `evobc-cat-04838`
- Source category ID: `04838`
...
- `obs-evo-cand-004838-route-category-staging`
...
- `obs-evo-cand-004838-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004838-route-evolution-graph`
