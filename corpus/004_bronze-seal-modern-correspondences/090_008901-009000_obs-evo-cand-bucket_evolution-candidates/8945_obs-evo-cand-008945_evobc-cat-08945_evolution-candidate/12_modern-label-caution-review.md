# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008945
...
- EVOBC candidate category: `evobc-evo-cat-08945`.
- Source label for search only: `迏`.
- Source codepoints for search only: `U+8FCF`.
