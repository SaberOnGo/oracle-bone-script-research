# obs-unk-004639 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/039_obs-unk-004639_h
  ust-obc-und-X-004639_oracle-character-candidate/03_visual-assets/001_asset
  -006232_hust-obc-und-X-004639_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/195/X_？_8368_1.png`
- asset id: `asset-006232`
...
- source class: `HUST-OBC/undeciphered/X/195/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/195/X_？_8368_1.png`
- asset id: `asset-006232`
...
- English observation: `separated upper arch and lower U-like curved forms`
- 中文观察: `上下分离的拱形与 U 状弧形笔画`
...
- Which source records identify obs-unk-004639 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004639？
