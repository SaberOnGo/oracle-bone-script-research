...
- External category reference: `evobc-cat-12257`
- Source category ID: `12257`
- Source label for human review: `𧭦`
- Source codepoints: `U+27B66`
...
- `obs-evo-cand-012257-route-category-staging`
...
- `obs-evo-cand-012257-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012257-route-evolution-graph`
