# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-000087
...
- candidate_component_id: `obs-comp-cand-000087`
- primary_external_ref_id: `obimd-sub-aawiifil1h`
- source_subcharacter_uid: `aawiifil1h`
- source_main_character_uid: `aawiifil1h`
- main_character_external_ref_id: `obimd-main-aawiifil1h`
...
- glyph_codepoint_uplus_sample: `U+F08A5, U+F08A6, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-011499` | `001_asset-011499_img.png` | `bc7c9785d367fbfae2e97904250ff27c580311eaed04dc699e35b82c8f32a6c4` |
