# obs-unk-005077 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005077`
- primary external id: `hust-obc-und-X-005077`
...
- local review image route: `corpus/001_oracle-characters/067_undeciphered-005
  001-005100_obs-unk-bucket_oracle-character-candidates/077_obs-unk-005077_h
  ust-obc-und-X-005077_oracle-character-candidate/03_visual-assets/001_asset
  -006670_hust-obc-und-X-005077_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/633/X_？_7604_1.png`
- asset id: `asset-006670`
...
- source class: `HUST-OBC/undeciphered/X/633/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/633/X_？_7604_1.png`
- asset id: `asset-006670`
...
- Which source records identify obs-unk-005077 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005077？
