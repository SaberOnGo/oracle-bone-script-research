# obs-char-000593 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000593`
- primary external id: `hust-obc-cat-0675`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/593_obs-char-000593_hust-obc-cat-0675_orac
  le-character/03_visual-assets/001_asset-000598_hust-obc-cat-0675_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0675/H_0675_60D6D_0.png`
- asset id: `asset-000598`
...
- source category: `0675`
- validation class: `592`
- source image route: `HUST-OBC/deciphered/0675/H_0675_60D6D_0.png`
- asset id: `asset-000598`
...
- English observation: `The large low-resolution image shows a left
  horizontal frame with a hanging squared loop and tall upper vertical, plus
  two detached bent stroke groups at right.`
- 中文观察: `大型低分辨率图像显示左侧横框、悬垂方环和高上竖，右侧另有两组分离弯折笔。`
...
- dataset label text: `㚙`
- dataset label codepoints: `U+3699`
...
- filename catalog route clues: `catalog-like filename clue: H_0675
  (H_0675_60D6D_0.png)`
...
- Which source records identify obs-char-000593 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000593？
