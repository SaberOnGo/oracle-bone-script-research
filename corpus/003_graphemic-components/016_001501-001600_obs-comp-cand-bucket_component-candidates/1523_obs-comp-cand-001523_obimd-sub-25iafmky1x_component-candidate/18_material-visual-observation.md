# Material Visual Observation / obs-comp-cand-001523 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001523`
- External reference / 外部参照: `obimd-sub-25iafmky1x`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016486_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/25iafmky1x/25iafmky1x/25iafmky1x.png`
- Checksum / 校验和:
  `6de1cdd31a235cd3c062be50f591363596f32b24805fd7b9c4333c7f9924eec5`
...
- Marked-pixel bounds: (85,32)–(163,210); span 79 × 179 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.84%。
- 痕迹范围：(85,32)–(163,210)；跨度79 × 179 px；痕迹矩形高于宽。
