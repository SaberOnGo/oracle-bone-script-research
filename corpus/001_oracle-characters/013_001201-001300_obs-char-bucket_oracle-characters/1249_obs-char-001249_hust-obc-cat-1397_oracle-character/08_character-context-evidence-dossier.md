...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1397`
...
- Source image / 来源图: `G_1397_乙3188合939賓組.png`
- Image / 图像: `001_asset-001254_hust-obc-cat-1397_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合939
...
- target node: `evobc-evo-cat-00130`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/130_obs-evo-cand-000130_evobc-cat-00130_evoluti
...
- Source label text / 来源标签文字: `㥫`
- Source label codepoint / 来源标签 codepoint: `U+396B`
