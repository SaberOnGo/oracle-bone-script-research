...
- External category reference: `evobc-cat-11535`
- Source category ID: `11535`
- Source label: `𣼴`
...
- `obs-evo-cand-011535-route-category-staging`
...
- `obs-evo-cand-011535-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011535-route-evolution-graph`
