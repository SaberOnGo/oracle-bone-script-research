...
- `obs-evo-cand-007946-route-category-staging`
...
- `obs-evo-cand-007946-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007946-route-evolution-graph`
