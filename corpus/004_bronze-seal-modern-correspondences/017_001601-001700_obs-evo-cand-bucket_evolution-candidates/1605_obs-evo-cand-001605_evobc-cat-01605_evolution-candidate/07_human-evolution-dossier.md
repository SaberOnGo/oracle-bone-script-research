...
- External category reference: `evobc-cat-01605`
- Source category ID: `01605`
- Source label for human review: `唤`
- Source codepoints: `U+5524`
...
- `obs-evo-cand-001605-route-category-staging`
...
- `obs-evo-cand-001605-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001605-route-evolution-graph`
