...
- External category reference: `evobc-cat-07879`
- Source category ID: `07879`
...
- `obs-evo-cand-007879-route-category-staging`
...
- `obs-evo-cand-007879-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007879-route-evolution-graph`
