...
- External category reference: `evobc-cat-03701`
- Source category ID: `03701`
- Source label for human review: `昃`
- Source codepoints: `U+6603`
- Image reference count in source metadata: `111`
...
- `obs-evo-cand-003701-route-category-staging`
...
- `obs-evo-cand-003701-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003701-route-evolution-graph`
