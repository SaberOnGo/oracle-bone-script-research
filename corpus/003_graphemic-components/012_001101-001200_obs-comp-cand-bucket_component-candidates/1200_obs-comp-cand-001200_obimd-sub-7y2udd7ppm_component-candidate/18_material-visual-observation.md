# Material Visual Observation / obs-comp-cand-001200 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001200`
- External reference / 外部参照: `obimd-sub-7y2udd7ppm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015431_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7y2udd7ppm/7y2udd7ppm/7y2udd7ppm.png`
- Checksum / 校验和:
  `0be38dc21b9bffe44b16f9d5d557ec5630e5128936df07a304f5fec4a2506a78`
...
- Marked-pixel bounds: (64,34)–(184,220); span 121 × 187 px; the marked
...
- 痕迹范围：(64,34)–(184,220)；跨度121 × 187 px；痕迹矩形高于宽。
