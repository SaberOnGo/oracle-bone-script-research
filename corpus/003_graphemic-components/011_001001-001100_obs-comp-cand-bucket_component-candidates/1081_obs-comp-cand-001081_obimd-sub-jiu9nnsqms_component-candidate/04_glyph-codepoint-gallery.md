# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001081
...
| --- | --- | --- | --- |
| `obimd-glyph-link-016034` | 򿽂󶍉 | `U+BFF42;U+F6349` | `reviewed_metadata_only` |
| `obimd-glyph-link-016035` | 󶍊 | `U+F634A` | `reviewed_metadata_only` |
| `obimd-glyph-link-016036` | 󶍋 | `U+F634B` | `reviewed_metadata_only` |
| `obimd-glyph-link-016037` | 󶍌 | `U+F634C` | `reviewed_metadata_only` |
| `obimd-glyph-link-016038` | 󶍍 | `U+F634D` | `reviewed_metadata_only` |
