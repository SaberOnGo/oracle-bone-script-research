...
- External category reference: `evobc-cat-10695`
- Source category ID: `10695`
- Source label for human review: `鼢`
...
- `obs-evo-cand-010695-route-category-staging`
...
- `obs-evo-cand-010695-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010695-route-evolution-graph`
