...
Project ID: `obs-evo-cand-008598`
...
- Project ID: `obs-evo-cand-008598`
- EVOBC category candidate ID: `evobc-evo-cat-08598`
- External category reference: `evobc-cat-08598`
- Source category ID: `08598`
- Source label for human review: `賻`
- Source codepoints: `U+8CFB`
...
- `obs-evo-cand-008598-route-category-staging`
...
- `obs-evo-cand-008598-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008598-route-evolution-graph`
