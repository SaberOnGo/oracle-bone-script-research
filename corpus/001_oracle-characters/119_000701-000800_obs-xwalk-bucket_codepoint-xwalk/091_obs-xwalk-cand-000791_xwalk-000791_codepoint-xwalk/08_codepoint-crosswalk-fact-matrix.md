...
|---|---|---|
| Source Codepoint Route | `U+3775` | not identity |
| HUST candidate route | `hust-obc-cat-0895` | not reading |
| OBIMD route | `obimd-main-cand-000853` | not component |
| EVOBC route | `evobc-evo-cat-00078` | not evolution |
