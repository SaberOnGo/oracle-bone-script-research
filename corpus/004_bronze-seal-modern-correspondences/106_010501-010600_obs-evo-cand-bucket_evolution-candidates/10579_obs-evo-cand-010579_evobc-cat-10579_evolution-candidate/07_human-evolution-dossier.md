...
Project ID: `obs-evo-cand-010579`
...
- Project ID: `obs-evo-cand-010579`
- EVOBC category candidate ID: `evobc-evo-cat-10579`
- External category reference: `evobc-cat-10579`
- Source category ID: `10579`
- Source label for human review: `鸙`
- Source codepoints: `U+9E19`
...
- `obs-evo-cand-010579-route-category-staging`
...
- `obs-evo-cand-010579-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010579-route-evolution-graph`
