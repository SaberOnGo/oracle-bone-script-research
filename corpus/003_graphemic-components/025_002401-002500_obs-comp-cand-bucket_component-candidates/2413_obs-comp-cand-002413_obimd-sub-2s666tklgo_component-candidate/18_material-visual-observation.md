# Material Visual Observation / obs-comp-cand-002413 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002413`
- External reference / 外部参照: `obimd-sub-2s666tklgo`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020484_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2s666tklgo/2s666tklgo/2s666tklgo.png`
- Checksum / 校验和:
  `c61bb4e82b59134b2656374d2fb5e8453d21d05a42a33eb669db5db9debdea06`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.91%.
- Marked-pixel bounds: (68,56)–(178,197); span 111 × 142 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.91%。
- 痕迹范围：(68,56)–(178,197)；跨度111 × 142 px；痕迹矩形高于宽。
