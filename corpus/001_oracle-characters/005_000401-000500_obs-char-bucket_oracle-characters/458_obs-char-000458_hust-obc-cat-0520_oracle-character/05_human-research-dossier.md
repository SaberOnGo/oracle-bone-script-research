# obs-char-000458 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/458_obs-char-000458_hust-obc-cat-0520_orac
  le-character/03_visual-assets/001_asset-000463_hust-obc-cat-0520_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0520/G_0520_前6.67.7(甲).png`
- asset id: `asset-000463`
...
- source category: `0520`
- validation class: `457`
- source image route: `HUST-OBC/deciphered/0520/G_0520_前6.67.7(甲).png`
- asset id: `asset-000463`
...
- English observation: `A compact boxed and crossed cluster occupies the top
  of a narrow upright form, above two long parallel curved strokes and a
  shorter inner line.`
- 中文观察: `紧凑框状交叉笔画群位于狭长直立形体顶部，下方有两条长平行弯笔和一条较短内线。`
...
- dataset label text: `㗾`
- dataset label codepoints: `U+35FE`
...
- Which source records identify obs-char-000458 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000458？
