...
- External category reference: `evobc-cat-03621`
- Source category ID: `03621`
- Source label for human review: `斃`
- Source codepoints: `U+6583`
...
- `obs-evo-cand-003621-route-category-staging`
...
- `obs-evo-cand-003621-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003621-route-evolution-graph`
