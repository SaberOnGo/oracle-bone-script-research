...
- External category reference: `evobc-cat-13579`
- Source category ID: `13579`
- Source label for human review: `𭸛`
...
- `obs-evo-cand-013579-route-category-staging`
...
- `obs-evo-cand-013579-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013579-route-evolution-graph`
