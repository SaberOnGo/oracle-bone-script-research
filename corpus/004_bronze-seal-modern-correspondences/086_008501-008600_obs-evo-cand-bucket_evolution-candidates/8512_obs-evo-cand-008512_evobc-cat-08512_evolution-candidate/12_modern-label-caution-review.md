# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008512
...
- EVOBC candidate category: `evobc-evo-cat-08512`.
- Source label for search only: `豻`.
- Source codepoints for search only: `U+8C7B`.
