# Material Visual Observation / obs-comp-cand-000127 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000127`
- External reference / 外部参照: `obimd-sub-091cuen244`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011539_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/08fa78pdp8/091cuen244/091cuen244.png`
- Checksum / 校验和:
  `dc2fa0643c514236c34185af1701f29dd7d3fbbf3b88f07ee218750ba883c828`
...
- Marked-pixel bounds: (64,21)–(183,228); span 120 × 208 px; the marked
...
- 痕迹范围：(64,21)–(183,228)；跨度120 × 208 px；痕迹矩形高于宽。
