...
Project ID: `obs-evo-cand-008810`
...
- Project ID: `obs-evo-cand-008810`
- EVOBC category candidate ID: `evobc-evo-cat-08810`
- External category reference: `evobc-cat-08810`
- Source category ID: `08810`
- Source label for human review: `軫`
- Source codepoints: `U+8EEB`
...
- `obs-evo-cand-008810-route-category-staging`
...
- `obs-evo-cand-008810-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008810-route-evolution-graph`
