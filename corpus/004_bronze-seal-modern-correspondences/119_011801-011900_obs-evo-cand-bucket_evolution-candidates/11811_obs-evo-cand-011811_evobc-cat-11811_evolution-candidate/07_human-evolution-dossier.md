...
- External category reference: `evobc-cat-11811`
- Source category ID: `11811`
- Source label for human review: `𥘚`
...
- `obs-evo-cand-011811-route-category-staging`
...
- `obs-evo-cand-011811-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011811-route-evolution-graph`
