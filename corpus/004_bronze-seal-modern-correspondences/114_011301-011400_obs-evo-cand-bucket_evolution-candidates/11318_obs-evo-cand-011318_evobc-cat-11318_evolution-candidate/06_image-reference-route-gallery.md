...
- `obs-evo-cand-011318-route-category-staging`
...
- `obs-evo-cand-011318-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011318-route-evolution-graph`
