...
- External category reference: `evobc-cat-00796`
- Source category ID: `00796`
- Source label for human review: `佊`
...
- `obs-evo-cand-000796-route-category-staging`
...
- `obs-evo-cand-000796-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000796-route-evolution-graph`
