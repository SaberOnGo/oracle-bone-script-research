...
- External category reference: `evobc-cat-09956`
- Source category ID: `09956`
- Source label for human review: `韤`
...
- `obs-evo-cand-009956-route-category-staging`
...
- `obs-evo-cand-009956-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009956-route-evolution-graph`
