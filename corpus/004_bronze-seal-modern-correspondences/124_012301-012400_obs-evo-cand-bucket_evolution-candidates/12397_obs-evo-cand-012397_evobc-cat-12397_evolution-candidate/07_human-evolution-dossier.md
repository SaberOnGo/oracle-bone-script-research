...
- External category reference: `evobc-cat-12397`
- Source category ID: `12397`
- Source label for human review: `𨙭`
...
- `obs-evo-cand-012397-route-category-staging`
...
- `obs-evo-cand-012397-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012397-route-evolution-graph`
