...
- External category reference: `evobc-cat-06650`
- Source category ID: `06650`
- Source label for human review: `縵`
- Source codepoints: `U+7E35`
...
- `obs-evo-cand-006650-route-category-staging`
...
- `obs-evo-cand-006650-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006650-route-evolution-graph`
