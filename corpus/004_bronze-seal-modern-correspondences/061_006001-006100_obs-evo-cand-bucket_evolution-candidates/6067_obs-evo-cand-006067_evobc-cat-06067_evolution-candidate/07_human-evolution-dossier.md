...
- External category reference: `evobc-cat-06067`
- Source category ID: `06067`
- Source label for human review: `秜`
- Source codepoints: `U+79DC`
- Image reference count in source metadata: `27`
...
- `obs-evo-cand-006067-route-category-staging`
...
- `obs-evo-cand-006067-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006067-route-evolution-graph`
