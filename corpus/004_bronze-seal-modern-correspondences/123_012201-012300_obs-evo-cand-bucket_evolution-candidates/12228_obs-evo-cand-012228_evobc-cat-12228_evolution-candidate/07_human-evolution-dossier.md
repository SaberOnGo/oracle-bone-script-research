...
Project ID: `obs-evo-cand-012228`
...
- Project ID: `obs-evo-cand-012228`
- EVOBC category candidate ID: `evobc-evo-cat-12228`
- External category reference: `evobc-cat-12228`
- Source category ID: `12228`
- Source label for human review: `𧦿`
- Source codepoints: `U+279BF`
...
- `obs-evo-cand-012228-route-category-staging`
...
- `obs-evo-cand-012228-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012228-route-evolution-graph`
