# obs-unk-004995 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/095_obs-unk-004995_h
  ust-obc-und-X-004995_oracle-character-candidate/03_visual-assets/001_asset
  -006588_hust-obc-und-X-004995_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/551/X_？_7530_1.png`
- asset id: `asset-006588`
...
- source class: `HUST-OBC/undeciphered/X/551/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/551/X_？_7530_1.png`
- asset id: `asset-006588`
...
- Which source records identify obs-unk-004995 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004995？
