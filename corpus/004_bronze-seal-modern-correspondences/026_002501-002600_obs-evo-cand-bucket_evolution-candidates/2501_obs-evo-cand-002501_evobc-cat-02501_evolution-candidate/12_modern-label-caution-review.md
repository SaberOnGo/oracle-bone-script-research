# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002501
...
- EVOBC candidate category: `evobc-evo-cat-02501`.
- Source label for search only: `屋`.
- Source codepoints for search only: `U+5C4B`.
