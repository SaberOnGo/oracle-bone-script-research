...
Project ID: `obs-evo-cand-011120`
...
- Project ID: `obs-evo-cand-011120`
- EVOBC category candidate ID: `evobc-evo-cat-11120`
- External category reference: `evobc-cat-11120`
- Source category ID: `11120`
- Source label for human review: `𡺩`
- Source codepoints: `U+21EA9`
...
- `obs-evo-cand-011120-route-category-staging`
...
- `obs-evo-cand-011120-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011120-route-evolution-graph`
