# Material Visual Observation / obs-comp-cand-002716 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002716`
- External reference / 外部参照: `obimd-sub-ilkg1bbhki`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021292_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ilkg1bbhki/ilkg1bbhki/ilkg1bbhki.png`
- Checksum / 校验和:
  `64dec59fb8e94e05a713e7133305cbe74636e6c67b85d03049cd1854cceff507`
...
- Marked-pixel bounds: (80,9)–(168,240); span 89 × 232 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.64%。
- 痕迹范围：(80,9)–(168,240)；跨度89 × 232 px；痕迹矩形高于宽。
