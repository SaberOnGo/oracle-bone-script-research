...
Project ID: `obs-evo-cand-010302`
...
- Project ID: `obs-evo-cand-010302`
- EVOBC category candidate ID: `evobc-evo-cat-10302`
- External category reference: `evobc-cat-10302`
- Source category ID: `10302`
- Source label for human review: `髏`
- Source codepoints: `U+9ACF`
...
- `obs-evo-cand-010302-route-category-staging`
...
- `obs-evo-cand-010302-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010302-route-evolution-graph`
