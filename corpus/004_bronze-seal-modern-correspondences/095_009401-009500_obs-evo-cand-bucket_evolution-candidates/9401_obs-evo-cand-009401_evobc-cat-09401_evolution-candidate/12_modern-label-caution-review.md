# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-009401
...
- EVOBC candidate category: `evobc-evo-cat-09401`.
- Source label for search only: `銽`.
- Source codepoints for search only: `U+92BD`.
