# obs-char-000699 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/699_obs-char-000699_hust-obc-cat-0793_orac
  le-character/03_visual-assets/001_asset-000704_hust-obc-cat-0793_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0793/G_0793_甲573(甲).png`
- asset id: `asset-000704`
...
- source category: `0793`
- validation class: `698`
- source image route: `HUST-OBC/deciphered/0793/G_0793_甲573(甲).png`
- asset id: `asset-000704`
...
- English observation: `A single narrow vertical cluster combines a crossed
  or looped angular top, several overlapping middle branches, and a long
  wavering lower continuation.`
...
- dataset label text: `㜏`
- dataset label codepoints: `U+370F`
...
- Which source records identify obs-char-000699 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000699？
