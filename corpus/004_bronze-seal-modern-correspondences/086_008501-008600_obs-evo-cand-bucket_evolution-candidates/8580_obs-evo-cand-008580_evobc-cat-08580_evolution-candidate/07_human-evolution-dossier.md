...
- External category reference: `evobc-cat-08580`
- Source category ID: `08580`
- Source label for human review: `賡`
- Source codepoints: `U+8CE1`
...
- `obs-evo-cand-008580-route-category-staging`
...
- `obs-evo-cand-008580-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008580-route-evolution-graph`
