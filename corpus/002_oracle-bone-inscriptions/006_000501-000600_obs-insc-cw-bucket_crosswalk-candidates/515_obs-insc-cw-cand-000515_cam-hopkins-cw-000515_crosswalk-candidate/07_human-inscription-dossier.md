...
Project ID: `obs-insc-cw-cand-000515`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000515`
...
- Source page section: `Period V Group 1` /
  `第 V 期第 1 组`
- Source section key: `period-v-group-1`
...
- Yingguo / 英国所藏: `y2502` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `355` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `550` in source row; primary catalog entry pending
- Heji / 合集: `40921` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000515`
