...
- External category reference: `evobc-cat-13556`
- Source category ID: `13556`
- Source label for human review: `𭫼`
...
- `obs-evo-cand-013556-route-category-staging`
...
- `obs-evo-cand-013556-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013556-route-evolution-graph`
