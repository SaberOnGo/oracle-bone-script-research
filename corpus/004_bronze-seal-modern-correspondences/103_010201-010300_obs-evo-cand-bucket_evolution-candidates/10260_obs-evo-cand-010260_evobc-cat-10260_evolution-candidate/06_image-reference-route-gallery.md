...
- `obs-evo-cand-010260-route-category-staging`
...
- `obs-evo-cand-010260-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010260-route-evolution-graph`
