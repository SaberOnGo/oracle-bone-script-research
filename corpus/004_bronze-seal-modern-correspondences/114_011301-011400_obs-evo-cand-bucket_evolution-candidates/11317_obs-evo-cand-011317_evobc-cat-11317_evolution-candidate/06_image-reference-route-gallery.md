...
- `obs-evo-cand-011317-route-category-staging`
...
- `obs-evo-cand-011317-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011317-route-evolution-graph`
