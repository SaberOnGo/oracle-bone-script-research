...
Project ID: `obs-evo-cand-007913`
...
- Project ID: `obs-evo-cand-007913`
- EVOBC category candidate ID: `evobc-evo-cat-07913`
- External category reference: `evobc-cat-07913`
- Source category ID: `07913`
- Source label for human review: `衞`
- Source codepoints: `U+885E`
...
- `obs-evo-cand-007913-route-category-staging`
...
- `obs-evo-cand-007913-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007913-route-evolution-graph`
