...
- Open `18_live-source-evidence-review.md` and compare the page description,
  snapshot hashes, and image-route access result.
...
- Visual access: `external_route_access_not_verified`
