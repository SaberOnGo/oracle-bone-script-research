...
- `obs-evo-cand-004584-route-category-staging`
...
- `obs-evo-cand-004584-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004584-route-evolution-graph`
