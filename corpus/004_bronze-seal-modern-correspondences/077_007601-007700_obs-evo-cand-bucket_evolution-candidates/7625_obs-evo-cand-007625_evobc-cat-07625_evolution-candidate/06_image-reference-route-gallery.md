...
- `obs-evo-cand-007625-route-category-staging`
...
- `obs-evo-cand-007625-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007625-route-evolution-graph`
