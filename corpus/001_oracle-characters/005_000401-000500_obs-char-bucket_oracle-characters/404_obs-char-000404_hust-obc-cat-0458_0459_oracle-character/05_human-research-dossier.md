# obs-char-000404 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/404_obs-char-000404_hust-obc-cat-0458_0459
  _oracle-character/03_visual-assets/001_asset-000409_hust-obc-cat-0458_0459
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0458_0459/0458/H_0458_602BE_0.p
  ng`
- asset id: `asset-000409`
...
- source category: `0458_0459`
- validation class: `403`
- source image route: `HUST-OBC/deciphered/0458_0459/0458/H_0458_602BE_0.png`
- asset id: `asset-000409`
...
- English observation: `Two separated tall forms are visible: a crossed
  loop-and-angle form at left and a vertical form with two angular side
  bends at right.`
...
- dataset label text: `㗀㗁`
- dataset label codepoints: `U+35C0;U+35C1`
...
- filename catalog route clues: `catalog-like filename clue: H_0458
  (H_0458_602BE_0.png)`
...
- Which source records identify obs-char-000404 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000404？
