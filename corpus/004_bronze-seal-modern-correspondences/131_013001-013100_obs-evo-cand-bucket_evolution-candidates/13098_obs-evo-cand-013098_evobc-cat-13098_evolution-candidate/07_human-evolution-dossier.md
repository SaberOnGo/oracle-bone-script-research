...
- External category reference: `evobc-cat-13098`
- Source category ID: `13098`
- Source label for human review: `𫳦`
- Source codepoints: `U+2BCE6`
...
- `obs-evo-cand-013098-route-category-staging`
...
- `obs-evo-cand-013098-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013098-route-evolution-graph`
