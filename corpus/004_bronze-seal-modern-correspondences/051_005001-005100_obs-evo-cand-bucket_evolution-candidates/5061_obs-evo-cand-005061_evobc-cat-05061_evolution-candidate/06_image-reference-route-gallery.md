...
- `obs-evo-cand-005061-route-category-staging`
...
- `obs-evo-cand-005061-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005061-route-evolution-graph`
