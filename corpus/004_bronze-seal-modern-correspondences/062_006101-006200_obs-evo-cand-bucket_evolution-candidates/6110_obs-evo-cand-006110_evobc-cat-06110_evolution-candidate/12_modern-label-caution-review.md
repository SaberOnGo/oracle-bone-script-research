# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006110
...
- EVOBC candidate category: `evobc-evo-cat-06110`.
- Source label for search only: `稱`.
- Source codepoints for search only: `U+7A31`.
