# obs-char-000372 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000372`
- primary external id: `hust-obc-cat-0423`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/372_obs-char-000372_hust-obc-cat-0423_orac
  le-character/03_visual-assets/001_asset-000377_hust-obc-cat-0423_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0423/G_0423_乙2040合816賓組.png`
- asset id: `asset-000377`
...
- source category: `0423`
- validation class: `371`
- source image route: `HUST-OBC/deciphered/0423/G_0423_乙2040合816賓組.png`
- asset id: `asset-000377`
...
- English observation: `A broad lower enclosure is topped by a short
  horizontal stroke and a separate long upper mark.`
- 中文观察: `宽大的下部闭合轮廓上方有短横笔画，另有一条较长上部痕迹。`
...
- dataset label text: `㖝`
- dataset label codepoints: `U+359D`
...
- filename catalog route clues: `Heji-like filename clue: 合816
  (G_0423_乙2040合816賓組.png)`
...
- Which source records identify obs-char-000372 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000372？
