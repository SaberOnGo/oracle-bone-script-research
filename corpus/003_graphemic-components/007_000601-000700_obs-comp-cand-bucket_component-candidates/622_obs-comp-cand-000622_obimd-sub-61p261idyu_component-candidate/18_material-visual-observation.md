# Material Visual Observation / obs-comp-cand-000622 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000622`
- External reference / 外部参照: `obimd-sub-61p261idyu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013185_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/61p261idyu/61p261idyu/61p261idyu.png`
- Checksum / 校验和:
  `4f4b697acbe30344c3198c12cd2aaba98054ec4e1272a424b9e7d2ffff588099`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.59%.
- Marked-pixel bounds: (80,18)–(172,232); span 93 × 215 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.59%。
- 痕迹范围：(80,18)–(172,232)；跨度93 × 215 px；痕迹矩形高于宽。
