...
- External category reference: `evobc-cat-12855`
- Source category ID: `12855`
- Source label for human review: `𪭏`
- Source codepoints: `U+2AB4F`
...
- `obs-evo-cand-012855-route-category-staging`
...
- `obs-evo-cand-012855-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012855-route-evolution-graph`
