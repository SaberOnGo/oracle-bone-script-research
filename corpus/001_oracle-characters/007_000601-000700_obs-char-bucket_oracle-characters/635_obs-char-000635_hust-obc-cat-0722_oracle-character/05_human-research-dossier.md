# obs-char-000635 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000635`
- primary external id: `hust-obc-cat-0722`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/635_obs-char-000635_hust-obc-cat-0722_orac
  le-character/03_visual-assets/001_asset-000640_hust-obc-cat-0722_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0722/G_0722_前8.6.1合21050𠂤組.png`
- asset id: `asset-000640`
...
- source category: `0722`
- validation class: `634`
- source image route: `HUST-OBC/deciphered/0722/G_0722_前8.6.1合21050𠂤組.png`
- asset id: `asset-000640`
...
- English observation: `The faint thin form begins with an angular hooked
  top, divides into two short middle branches, and continues as one long
  slightly slanting lower stroke.`
- 中文观察: `淡弱纤细形起于折角钩顶，中部分成两条短枝，并延续为一条长而略斜的下笔。`
...
- dataset label text: `㛈`
- dataset label codepoints: `U+36C8`
...
- filename catalog route clues: `Heji-like filename clue: 合21050
  (G_0722_前8.6.1合21050𠂤組.png)`
...
- Which source records identify obs-char-000635 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000635？
