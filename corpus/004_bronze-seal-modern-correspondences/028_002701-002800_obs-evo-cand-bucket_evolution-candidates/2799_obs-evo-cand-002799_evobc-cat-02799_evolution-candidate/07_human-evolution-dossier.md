...
Project ID: `obs-evo-cand-002799`
...
- Project ID: `obs-evo-cand-002799`
- EVOBC category candidate ID: `evobc-evo-cat-02799`
- External category reference: `evobc-cat-02799`
- Source category ID: `02799`
- Source label for human review: `弜`
- Source codepoints: `U+5F1C`
- Image reference count in source metadata: `127`
...
- `obs-evo-cand-002799-route-category-staging`
...
- `obs-evo-cand-002799-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002799-route-evolution-graph`
