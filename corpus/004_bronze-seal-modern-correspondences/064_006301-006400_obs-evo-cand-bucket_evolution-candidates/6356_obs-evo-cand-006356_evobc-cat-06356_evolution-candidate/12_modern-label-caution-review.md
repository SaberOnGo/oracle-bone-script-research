# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006356
...
- EVOBC candidate category: `evobc-evo-cat-06356`.
- Source label for search only: `簪`.
- Source codepoints for search only: `U+7C2A`.
