...
- Project ID / 项目 ID: `obs-char-001122`
- Primary external ID / 首选外部 ID: `hust-obc-cat-1253`
...
- Source image / 来源图: `G_1253_乙3415反合12939反賓組.png`
- Image / 图像: `001_asset-001127_hust-obc-cat-1253_glyph.png`
...
- 当前图边数: `3`
- 图边类型: CHARACTER_HAS_HUST_OBC_CODEPOINT_LOOKUP_ROUTE;
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合12939
  (G_1253_乙3415反合12939反賓組.png)`
...
- target node: `obimd-main-cand-002593`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- OBIMD candidate ids / OBIMD 候选 ID: `obimd-main-cand-002593`
- OBIMD external refs / OBIMD 外部引用: `obimd-main-swd7pw3btv`
- OBIMD transcription field / OBIMD 转写字段: `㣛|䢔`
- EvoBC evolution category ids / EvoBC 演化类别 ID: `none`
- EvoBC external refs / EvoBC 外部引用: `none`
- EvoBC image references / EvoBC 图像引用数: `0`
...
- Human review files / 人类复核文件: 待查：需核对 EvoBC 对象目录
...
- Matched OBIMD main UIDs / OBIMD 主字 UID: `swd7pw3btv`
...
- Source label text / 来源标签文字: `㣛`
- Source label codepoint / 来源标签 codepoint: `U+38DB`
- Cross-source status / 跨来源状态: matched_obimd_by_codepoint
