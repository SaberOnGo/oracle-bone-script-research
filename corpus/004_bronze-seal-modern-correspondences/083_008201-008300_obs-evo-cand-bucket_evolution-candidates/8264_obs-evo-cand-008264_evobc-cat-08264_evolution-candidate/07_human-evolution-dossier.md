...
- External category reference: `evobc-cat-08264`
- Source category ID: `08264`
- Source label for human review: `諉`
...
- `obs-evo-cand-008264-route-category-staging`
...
- `obs-evo-cand-008264-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008264-route-evolution-graph`
