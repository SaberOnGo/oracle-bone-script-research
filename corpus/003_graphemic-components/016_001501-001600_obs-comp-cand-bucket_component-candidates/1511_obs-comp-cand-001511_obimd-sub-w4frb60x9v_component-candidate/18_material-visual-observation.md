# Material Visual Observation / obs-comp-cand-001511 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001511`
- External reference / 外部参照: `obimd-sub-w4frb60x9v`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016474_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/w4frb60x9v/w4frb60x9v/w4frb60x9v.png`
- Checksum / 校验和:
  `df5688e256f7a790614966e795bf5b54659e42524c0635ce4d37acb8db3d5344`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.58%.
- Marked-pixel bounds: (75,37)–(182,216); span 108 × 180 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.58%。
- 痕迹范围：(75,37)–(182,216)；跨度108 × 180 px；痕迹矩形高于宽。
