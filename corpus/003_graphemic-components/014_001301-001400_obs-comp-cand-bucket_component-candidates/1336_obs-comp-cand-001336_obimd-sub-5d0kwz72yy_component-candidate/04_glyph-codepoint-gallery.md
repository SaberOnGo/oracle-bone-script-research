# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001336
...
| --- | --- | --- | --- |
| `obimd-glyph-link-019930` | 󷦇 | `U+F7987` | `reviewed_metadata_only` |
| `obimd-glyph-link-019931` | 󷦈 | `U+F7988` | `reviewed_metadata_only` |
