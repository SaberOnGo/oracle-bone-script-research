# Material Visual Observation / obs-comp-cand-001337 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001337`
- External reference / 外部参照: `obimd-sub-0avi2tcy0g`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015674_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0avi2tcy0g/0avi2tcy0g/033rqi8ht0.png`
- Checksum / 校验和:
  `f2344952a73417f7bed31b1b956472c934b8f6424d705f96a0c55cdf3e29cb40`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.82%.
- Marked-pixel bounds: (94,46)–(155,203); span 62 × 158 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.82%。
- 痕迹范围：(94,46)–(155,203)；跨度62 × 158 px；痕迹矩形高于宽。
