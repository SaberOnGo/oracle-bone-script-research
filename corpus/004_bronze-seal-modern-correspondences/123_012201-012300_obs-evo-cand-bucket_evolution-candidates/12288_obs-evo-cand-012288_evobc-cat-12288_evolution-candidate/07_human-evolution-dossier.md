...
- External category reference: `evobc-cat-12288`
- Source category ID: `12288`
- Source label for human review: `𧸌`
- Source codepoints: `U+27E0C`
...
- `obs-evo-cand-012288-route-category-staging`
...
- `obs-evo-cand-012288-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012288-route-evolution-graph`
