...
- External category reference: `evobc-cat-07666`
- Source category ID: `07666`
- Source label for human review: `蘌`
- Source codepoints: `U+860C`
...
- `obs-evo-cand-007666-route-category-staging`
...
- `obs-evo-cand-007666-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007666-route-evolution-graph`
