# obs-char-001444 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1444_obs-char-001444_hust-obc-cat-1618_161
  9_oracle-character/03_visual-assets/001_asset-001449_hust-obc-cat-1618_161
  9_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1618_1619/1618/G_1618_寧滬1.500(甲
  ).png`
- asset id: `asset-001449`
...
- source category: `1618_1619`
- validation class: `1443`
- source image route: `HUST-OBC/deciphered/1618_1619/1618/G_1618_寧滬1.500(甲).pn
  g`
- asset id: `asset-001449`
...
- English observation: `A central stem has short upper branches and a
  pointed lower taper.`
- 中文观察: `中央竖干有短上部分枝和尖状下部收束。`
...
- dataset label text: `㩈㩉`
- dataset label codepoints: `U+3A48;U+3A49`
...
- graph edge count: `2`
- codepoint routes: `U+3A48;U+3A49`
...
- Which source records identify obs-char-001444 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001444？
