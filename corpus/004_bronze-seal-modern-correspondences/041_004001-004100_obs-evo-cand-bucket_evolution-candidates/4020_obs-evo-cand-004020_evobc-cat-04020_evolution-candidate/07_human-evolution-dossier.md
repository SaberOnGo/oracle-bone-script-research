...
Project ID: `obs-evo-cand-004020`
...
- Project ID: `obs-evo-cand-004020`
- EVOBC category candidate ID: `evobc-evo-cat-04020`
- External category reference: `evobc-cat-04020`
- Source category ID: `04020`
- Source label for human review: `案`
- Source codepoints: `U+6848`
...
- `obs-evo-cand-004020-route-category-staging`
...
- `obs-evo-cand-004020-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004020-route-evolution-graph`
