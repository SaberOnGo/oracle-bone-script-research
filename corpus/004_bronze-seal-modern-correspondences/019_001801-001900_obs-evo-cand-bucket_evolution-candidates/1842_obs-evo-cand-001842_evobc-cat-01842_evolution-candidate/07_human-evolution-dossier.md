...
- External category reference: `evobc-cat-01842`
- Source category ID: `01842`
- Source label for human review: `垂`
...
- `obs-evo-cand-001842-route-category-staging`
...
- `obs-evo-cand-001842-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001842-route-evolution-graph`
