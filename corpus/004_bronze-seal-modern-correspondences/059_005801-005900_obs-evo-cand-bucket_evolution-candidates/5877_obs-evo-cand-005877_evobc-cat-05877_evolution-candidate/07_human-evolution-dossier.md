...
Project ID: `obs-evo-cand-005877`
...
- Project ID: `obs-evo-cand-005877`
- EVOBC category candidate ID: `evobc-evo-cat-05877`
- External category reference: `evobc-cat-05877`
- Source category ID: `05877`
- Source label for human review: `矠`
- Source codepoints: `U+77E0`
...
- `obs-evo-cand-005877-route-category-staging`
...
- `obs-evo-cand-005877-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005877-route-evolution-graph`
