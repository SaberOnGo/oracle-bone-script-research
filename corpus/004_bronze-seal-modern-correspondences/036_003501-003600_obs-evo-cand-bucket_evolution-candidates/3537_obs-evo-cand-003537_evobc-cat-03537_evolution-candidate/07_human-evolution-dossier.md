...
- External category reference: `evobc-cat-03537`
- Source category ID: `03537`
- Source label for human review: `擸`
- Source codepoints: `U+64F8`
...
- `obs-evo-cand-003537-route-category-staging`
...
- `obs-evo-cand-003537-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003537-route-evolution-graph`
