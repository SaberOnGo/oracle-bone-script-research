...
- External category reference: `evobc-cat-11321`
- Source category ID: `11321`
- Source label for human review: `𢹾`
...
- `obs-evo-cand-011321-route-category-staging`
...
- `obs-evo-cand-011321-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011321-route-evolution-graph`
