...
- External category reference: `evobc-cat-06084`
- Source category ID: `06084`
- Source label for human review: `秸`
...
- `obs-evo-cand-006084-route-category-staging`
...
- `obs-evo-cand-006084-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006084-route-evolution-graph`
