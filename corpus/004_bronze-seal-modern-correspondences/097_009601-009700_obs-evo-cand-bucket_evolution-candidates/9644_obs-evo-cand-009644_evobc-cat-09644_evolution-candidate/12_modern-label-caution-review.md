# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-009644
...
- EVOBC candidate category: `evobc-evo-cat-09644`.
- Source label for search only: `閽`.
- Source codepoints for search only: `U+95BD`.
