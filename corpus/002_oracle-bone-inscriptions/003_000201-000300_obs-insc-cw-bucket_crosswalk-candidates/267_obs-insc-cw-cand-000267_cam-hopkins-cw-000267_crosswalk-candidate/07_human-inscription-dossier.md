...
- Yingguo / 英国所藏: `y1779` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `548` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `727` in source row; primary catalog entry pending
- Heji / 合集: `40820` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000267`
