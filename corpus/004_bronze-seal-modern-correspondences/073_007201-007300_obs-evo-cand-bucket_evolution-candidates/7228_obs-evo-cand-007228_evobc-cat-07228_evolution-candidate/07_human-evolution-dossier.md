...
- External category reference: `evobc-cat-07228`
- Source category ID: `07228`
- Source label for human review: `芀`
...
- `obs-evo-cand-007228-route-category-staging`
...
- `obs-evo-cand-007228-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007228-route-evolution-graph`
