# obs-char-000306 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/306_obs-char-000306_hust-obc-cat-0346_orac
  le-character/03_visual-assets/001_asset-000311_hust-obc-cat-0346_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0346/G_0346_京津4461合29350.png`
- asset id: `asset-000311`
...
- source category: `0346`
- validation class: `305`
- source image route: `HUST-OBC/deciphered/0346/G_0346_京津4461合29350.png`
- asset id: `asset-000311`
...
- English observation: `The dark image shows a compact angular upper
  cluster, a descending diagonal stroke, and curved lower strokes extending
  to both sides.`
- 中文观察: `深色图像上部为紧凑折角笔画群，中部有下行斜笔画，下方弧形笔画向两侧伸展。`
...
- dataset label text: `㕐`
- dataset label codepoints: `U+3550`
...
- filename catalog route clues: `Heji-like filename clue: 合29350
  (G_0346_京津4461合29350.png)`
...
- Which source records identify obs-char-000306 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000306？
