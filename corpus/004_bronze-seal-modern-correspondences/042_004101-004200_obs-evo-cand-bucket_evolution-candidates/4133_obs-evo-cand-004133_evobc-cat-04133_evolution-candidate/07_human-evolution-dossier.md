...
Project ID: `obs-evo-cand-004133`
...
- Project ID: `obs-evo-cand-004133`
- EVOBC category candidate ID: `evobc-evo-cat-04133`
- External category reference: `evobc-cat-04133`
- Source category ID: `04133`
- Source label for human review: `椶`
- Source codepoints: `U+6936`
...
- `obs-evo-cand-004133-route-category-staging`
...
- `obs-evo-cand-004133-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004133-route-evolution-graph`
