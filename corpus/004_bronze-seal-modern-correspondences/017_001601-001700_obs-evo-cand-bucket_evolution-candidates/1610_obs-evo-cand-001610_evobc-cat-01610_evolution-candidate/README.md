# obs-evo-cand-001610 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-001610`
- EVOBC category candidate ID: `evobc-evo-cat-01610`
- External category ref: `evobc-cat-01610`
- Source label: `唯`
- Source codepoints: `U+552F`
- Image reference count: `194`
- Era token counts: `BI:83;CS:1;OBC:64;SAC:10;SS:2;WSC:34`
- Source token counts: `Book:98;Web:96`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 64 image references
- era 1 / BI: 83 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 10 image references
- era 4 / WSC: 34 image references
- era 5 / CS: 1 image references
- source 0 / Web:1633: 1 image references
- source 1 / Web:105952;說文Web:58: 73 image references
...
- source 7 / Book:9676: 19 image references
