# obs-char-001563 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1563_obs-char-001563_hust-obc-cat-1754_ora
  cle-character/03_visual-assets/001_asset-001568_hust-obc-cat-1754_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1754/X_1754_5946_1.png`
- asset id: `asset-001568`
...
- source category: `1754`
- validation class: `1562`
- source image route: `HUST-OBC/deciphered/1754/X_1754_5946_1.png`
- asset id: `asset-001568`
...
- English observation: `A heavily degraded image preserves two dark
  irregular clusters with only partial contours visible.`
- 中文观察: `严重退化图像保留两个深色不规则笔画群，仅能看见部分轮廓。`
...
- dataset label text: `㫐`
- dataset label codepoints: `U+3AD0`
...
- Which source records identify obs-char-001563 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001563？
