...
- Project ID: `obs-evo-cand-010498`
- EVOBC category candidate ID: `evobc-evo-cat-10498`
- External category reference: `evobc-cat-10498`
- Source category ID: `10498`
- Source label for human review: `鴨`
- Source codepoints: `U+9D28`
...
- `obs-evo-cand-010498-route-category-staging`
...
- `obs-evo-cand-010498-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010498-route-evolution-graph`
