# Material Visual Observation / obs-comp-cand-001448 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001448`
- External reference / 外部参照: `obimd-sub-51p2xxpvps`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016025_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/51p2xxpvps/51p2xxpvps/51p2xxpvps.png`
- Checksum / 校验和:
  `4ea4df18f10e4345c8541fb141e915e6a5e47445c3874ff381881787366aabc7`
...
- Marked-pixel bounds: (63,27)–(189,220); span 127 × 194 px; the marked
...
- 痕迹范围：(63,27)–(189,220)；跨度127 × 194 px；痕迹矩形高于宽。
