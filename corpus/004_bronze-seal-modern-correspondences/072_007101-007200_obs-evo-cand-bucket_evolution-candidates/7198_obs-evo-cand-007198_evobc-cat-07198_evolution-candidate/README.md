# obs-evo-cand-007198 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-07198`
- Source label: `舞`
- Source codepoints: `U+821E`
- Image reference count: `139`
- Era token counts: `BI:8;CS:2;OBC:123;SAC:1;SS:3;WSC:2`
- Source token counts: `Book:46;Web:93`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 123 image references
- era 1 / BI: 8 image references
- era 2 / SS: 3 image references
- era 3 / SAC: 1 image references
- era 4 / WSC: 2 image references
- era 5 / CS: 2 image references
- source 0 / Web:1633: 14 image references
- source 1 / Web:105952;說文Web:58: 33 image references
- source 2 / Book:17600: 30 image references
- source 3 / Book:21681: 3 image references
- source 4 / Book:9131: 1 image references
