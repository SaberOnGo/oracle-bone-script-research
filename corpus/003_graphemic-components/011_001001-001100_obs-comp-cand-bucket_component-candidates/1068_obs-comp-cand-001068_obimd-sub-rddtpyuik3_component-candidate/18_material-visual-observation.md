# Material Visual Observation / obs-comp-cand-001068 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001068`
- External reference / 外部参照: `obimd-sub-rddtpyuik3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014618_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rddtpyuik3/rddtpyuik3/rddtpyuik3.png`
- Checksum / 校验和:
  `d2f3b49b059502973f3aab24dc12bf49240cae707f2bac3c9ccf99783fe9152f`
...
- Marked-pixel bounds: (67,50)–(182,202); span 116 × 153 px; the marked
...
- 痕迹范围：(67,50)–(182,202)；跨度116 × 153 px；痕迹矩形高于宽。
