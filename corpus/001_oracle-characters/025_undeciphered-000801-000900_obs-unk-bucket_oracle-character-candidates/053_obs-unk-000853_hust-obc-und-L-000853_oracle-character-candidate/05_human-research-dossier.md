# obs-unk-000853 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000853`
- primary external id: `hust-obc-und-L-000853`
...
- local review image route: `corpus/001_oracle-characters/025_undeciphered-000
  801-000900_obs-unk-bucket_oracle-character-candidates/053_obs-unk-000853_h
  ust-obc-und-L-000853_oracle-character-candidate/03_visual-assets/001_asset
  -002446_hust-obc-und-L-000853_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/853/L_？_1246.jpg`
- asset id: `asset-002446`
...
- source class: `HUST-OBC/undeciphered/L/853/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/853/L_？_1246.jpg`
- asset id: `asset-002446`
...
- Which source records identify obs-unk-000853 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000853？
