# Material Visual Observation / obs-comp-cand-002587 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002587`
- External reference / 外部参照: `obimd-sub-t4fsvfyfie`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021126_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/t4fsvfyfie/t4fsvfyfie/t4fsvfyfie.png`
- Checksum / 校验和:
  `8491153d8f30a72a04cf90824b5dc6420fd10574d62925e2dd6806b9a9884b33`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.25%.
- Marked-pixel bounds: (87,27)–(190,223); span 104 × 197 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.25%。
- 痕迹范围：(87,27)–(190,223)；跨度104 × 197 px；痕迹矩形高于宽。
