...
Project ID: `obs-evo-cand-007612`
...
- Project ID: `obs-evo-cand-007612`
- EVOBC category candidate ID: `evobc-evo-cat-07612`
- External category reference: `evobc-cat-07612`
- Source category ID: `07612`
- Source label for human review: `薙`
- Source codepoints: `U+8599`
...
- `obs-evo-cand-007612-route-category-staging`
...
- `obs-evo-cand-007612-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007612-route-evolution-graph`
