# obs-unk-004342 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/042_obs-unk-004342_h
  ust-obc-und-L-004342_oracle-character-candidate/03_visual-assets/001_asset
  -005935_hust-obc-und-L-004342_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4342/L_？_9607.jpg`
- asset id: `asset-005935`
...
- source class: `HUST-OBC/undeciphered/L/4342/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4342/L_？_9607.jpg`
- asset id: `asset-005935`
...
- English observation: `Separated upper marks and lower angular traces`
  `recorded.`
- 中文观察: `已记录分开的上部痕迹和下部角状痕。`
...
- Which source records identify obs-unk-004342 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004342？
