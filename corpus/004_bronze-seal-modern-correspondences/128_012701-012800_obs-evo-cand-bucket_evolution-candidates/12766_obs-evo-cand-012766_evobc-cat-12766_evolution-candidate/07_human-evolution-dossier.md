...
- External category reference: `evobc-cat-12766`
- Source category ID: `12766`
- Source label for human review: `𪓜`
- Source codepoints: `U+2A4DC`
...
- `obs-evo-cand-012766-route-category-staging`
...
- `obs-evo-cand-012766-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012766-route-evolution-graph`
