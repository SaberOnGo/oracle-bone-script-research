...
- External category reference: `evobc-cat-03354`
- Source category ID: `03354`
- Source label for human review: `振`
...
- `obs-evo-cand-003354-route-category-staging`
...
- `obs-evo-cand-003354-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003354-route-evolution-graph`
