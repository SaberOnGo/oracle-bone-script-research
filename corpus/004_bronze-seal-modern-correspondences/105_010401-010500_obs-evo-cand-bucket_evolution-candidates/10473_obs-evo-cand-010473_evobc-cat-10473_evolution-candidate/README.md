# obs-evo-cand-010473 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-10473`
- Source label: `鳯`
- Source codepoints: `U+9CEF`
- Image reference count: `102`
- Era token counts: `OBC:102`
- Source token counts: `Book:102`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 102 image references
- source 7 / Book:9676: 102 image references
