...
- `obs-evo-cand-012444-route-category-staging`
...
- `obs-evo-cand-012444-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012444-route-evolution-graph`
