# obs-unk-004522 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/022_obs-unk-004522_h
  ust-obc-und-X-004522_oracle-character-candidate/03_visual-assets/001_asset
  -006115_hust-obc-und-X-004522_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/78/X_？_8262_1.png`
- asset id: `asset-006115`
...
- source class: `HUST-OBC/undeciphered/X/78/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/78/X_？_8262_1.png`
- asset id: `asset-006115`
...
- English observation: `The winding trace, upper segment, left projection, and
  central crossing are directly recorded.`
- 中文观察: `已直接记录曲折痕、上部痕、左侧外伸和中央交会。`
...
- Which source records identify obs-unk-004522 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004522？
