...
- `obs-evo-cand-004994-route-category-staging`
...
- `obs-evo-cand-004994-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004994-route-evolution-graph`
