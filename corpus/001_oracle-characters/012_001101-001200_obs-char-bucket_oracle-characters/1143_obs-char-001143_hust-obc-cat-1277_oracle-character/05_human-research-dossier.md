# obs-char-001143 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001143`
- primary external id: `hust-obc-cat-1277`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1143_obs-char-001143_hust-obc-cat-1277_ora
  cle-character/03_visual-assets/001_asset-001148_hust-obc-cat-1277_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1277/G_1277_甲骨文.png`
- asset id: `asset-001148`
...
- source category: `1277`
- validation class: `1142`
- source image route: `HUST-OBC/deciphered/1277/G_1277_甲骨文.png`
- asset id: `asset-001148`
...
- English observation: `Two narrow opposing curved outlines stand side by
  side, each with a pointed upper end and an open interior.`
- 中文观察: `两个狭长而相对的弯曲轮廓并列，各自有尖状上端和开放内部。`
...
- dataset label text: `㣳`
- dataset label codepoints: `U+38F3`
...
- Which source records identify obs-char-001143 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001143？
