...
- External category reference: `evobc-cat-08228`
- Source category ID: `08228`
- Source label for human review: `誕`
- Source codepoints: `U+8A95`
...
- `obs-evo-cand-008228-route-category-staging`
...
- `obs-evo-cand-008228-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008228-route-evolution-graph`
