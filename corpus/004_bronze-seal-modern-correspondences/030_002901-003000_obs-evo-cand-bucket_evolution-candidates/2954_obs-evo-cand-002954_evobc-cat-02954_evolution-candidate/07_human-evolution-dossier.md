...
Project ID: `obs-evo-cand-002954`
...
- Project ID: `obs-evo-cand-002954`
- EVOBC category candidate ID: `evobc-evo-cat-02954`
- External category reference: `evobc-cat-02954`
- Source category ID: `02954`
- Source label for human review: `怯`
- Source codepoints: `U+602F`
...
- `obs-evo-cand-002954-route-category-staging`
...
- `obs-evo-cand-002954-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002954-route-evolution-graph`
