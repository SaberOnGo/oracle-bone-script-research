...
- External category reference: `evobc-cat-11599`
- Source category ID: `11599`
- Source label for human review: `𤚞`
...
- `obs-evo-cand-011599-route-category-staging`
...
- `obs-evo-cand-011599-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011599-route-evolution-graph`
