...
Project ID: `obs-evo-cand-003445`
...
- Project ID: `obs-evo-cand-003445`
- EVOBC category candidate ID: `evobc-evo-cat-03445`
- External category reference: `evobc-cat-03445`
- Source category ID: `03445`
- Source label for human review: `搈`
- Source codepoints: `U+6408`
...
- `obs-evo-cand-003445-route-category-staging`
...
- `obs-evo-cand-003445-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003445-route-evolution-graph`
