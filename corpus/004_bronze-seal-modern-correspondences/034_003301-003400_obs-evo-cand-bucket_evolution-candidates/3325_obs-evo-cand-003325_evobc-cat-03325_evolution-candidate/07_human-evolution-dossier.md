...
- Project ID: `obs-evo-cand-003325`
- EVOBC category candidate ID: `evobc-evo-cat-03325`
- External category reference: `evobc-cat-03325`
- Source category ID: `03325`
- Source label for human review: `拨`
- Source codepoints: `U+62E8`
...
- `obs-evo-cand-003325-route-category-staging`
...
- `obs-evo-cand-003325-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003325-route-evolution-graph`
