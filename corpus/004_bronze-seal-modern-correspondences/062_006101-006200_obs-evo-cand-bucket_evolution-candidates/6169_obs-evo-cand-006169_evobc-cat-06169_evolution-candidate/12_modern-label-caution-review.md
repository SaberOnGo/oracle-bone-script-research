# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006169
...
- EVOBC candidate category: `evobc-evo-cat-06169`.
- Source label for search only: `窜`.
- Source codepoints for search only: `U+7A9C`.
