# obs-unk-004196 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/096_obs-unk-004196_h
  ust-obc-und-L-004196_oracle-character-candidate/03_visual-assets/001_asset
  -005789_hust-obc-und-L-004196_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4196/L_？_9135.jpg`
- asset id: `asset-005789`
...
- source class: `HUST-OBC/undeciphered/L/4196/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4196/L_？_9135.jpg`
- asset id: `asset-005789`
...
- English observation: `Upper band, central trace, and curved strokes visible.`
- 中文观察: `上部笔画、中央痕迹和两侧弯曲笔画可见。`
...
- Which source records identify obs-unk-004196 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004196？
