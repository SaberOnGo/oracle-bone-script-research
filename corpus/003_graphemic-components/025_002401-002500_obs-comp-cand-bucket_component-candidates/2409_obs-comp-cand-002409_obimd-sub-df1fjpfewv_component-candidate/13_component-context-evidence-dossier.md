# obs-comp-cand-002409 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002409`
- 首选外部 ID: `obimd-sub-df1fjpfewv`
- OBIMD subcharacter UID: `df1fjpfewv`
- OBIMD main character UID: `df1fjpfewv`
- 来源 ID: `src-obimd`
