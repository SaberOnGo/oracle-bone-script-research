# Material Visual Observation / obs-comp-cand-002142 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002142`
- External reference / 外部参照: `obimd-sub-x87fwn0rnj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019730_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6ewkk2w7r1/x87fwn0rnj/x87fwn0rnj.png`
- Checksum / 校验和:
  `9d149a53e26598d214182f14135b131deafc22dc402b65efc795fb1a4735d4f3`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.73%.
- Marked-pixel bounds: (86,26)–(163,217); span 78 × 192 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.73%。
- 痕迹范围：(86,26)–(163,217)；跨度78 × 192 px；痕迹矩形高于宽。
