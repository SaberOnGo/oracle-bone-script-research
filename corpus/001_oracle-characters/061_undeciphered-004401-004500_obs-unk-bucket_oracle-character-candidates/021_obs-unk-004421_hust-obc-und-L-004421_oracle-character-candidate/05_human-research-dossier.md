# obs-unk-004421 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/021_obs-unk-004421_h
  ust-obc-und-L-004421_oracle-character-candidate/03_visual-assets/001_asset
  -006014_hust-obc-und-L-004421_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4421/L_？_9898.jpg`
- asset id: `asset-006014`
...
- source class: `HUST-OBC/undeciphered/L/4421/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4421/L_？_9898.jpg`
- asset id: `asset-006014`
...
- English observation: `Tall side traces frame a narrow center`
  `and lower open mark.`
- 中文观察: `高侧痕迹围住狭窄中央和下部开放痕迹。`
...
- Which source records identify obs-unk-004421 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004421？
