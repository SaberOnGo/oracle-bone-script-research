...
Project ID: `obs-evo-cand-003421`
...
- Project ID: `obs-evo-cand-003421`
- EVOBC category candidate ID: `evobc-evo-cat-03421`
- External category reference: `evobc-cat-03421`
- Source category ID: `03421`
- Source label for human review: `揄`
- Source codepoints: `U+63C4`
...
- `obs-evo-cand-003421-route-category-staging`
...
- `obs-evo-cand-003421-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003421-route-evolution-graph`
