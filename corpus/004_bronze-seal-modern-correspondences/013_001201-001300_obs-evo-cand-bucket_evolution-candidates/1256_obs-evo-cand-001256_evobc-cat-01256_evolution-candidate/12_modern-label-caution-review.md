# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001256
...
- EVOBC candidate category: `evobc-evo-cat-01256`.
- Source label for search only: `劌`.
- Source codepoints for search only: `U+528C`.
