...
- `obs-evo-cand-005843-route-category-staging`
...
- `obs-evo-cand-005843-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005843-route-evolution-graph`
