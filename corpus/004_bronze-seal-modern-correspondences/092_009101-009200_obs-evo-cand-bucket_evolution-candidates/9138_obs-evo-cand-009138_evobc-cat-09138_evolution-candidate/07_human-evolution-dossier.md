...
- External category reference: `evobc-cat-09138`
- Source category ID: `09138`
- Source label for human review: `郔`
- Source codepoints: `U+90D4`
...
- `obs-evo-cand-009138-route-category-staging`
...
- `obs-evo-cand-009138-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009138-route-evolution-graph`
