...
- `obs-evo-cand-001277-route-category-staging`
...
- `obs-evo-cand-001277-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001277-route-evolution-graph`
