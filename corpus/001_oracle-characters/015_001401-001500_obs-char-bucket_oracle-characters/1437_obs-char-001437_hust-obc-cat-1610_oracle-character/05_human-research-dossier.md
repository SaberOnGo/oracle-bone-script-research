# obs-char-001437 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1437_obs-char-001437_hust-obc-cat-1610_ora
  cle-character/03_visual-assets/001_asset-001442_hust-obc-cat-1610_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1610/H_1610_6091C_0.png`
- asset id: `asset-001442`
...
- source category: `1610`
- validation class: `1436`
- source image route: `HUST-OBC/deciphered/1610/H_1610_6091C_0.png`
- asset id: `asset-001442`
...
- English observation: `A large left composite has crossing branches beside
  a separate right form.`
...
- dataset label text: `㩀`
- dataset label codepoints: `U+3A40`
...
- filename catalog route clues: `catalog-like filename clue: H_1610
  (H_1610_6091C_0.png)`
...
- Which source records identify obs-char-001437 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001437？
