# obs-char-001094 Visual Gallery / obs-char-001094 图像资料页
...
- Project ID / 项目 ID: `obs-char-001094`
- Primary external reference / 首选外部参考: `hust-obc-cat-1223`
...
## obs-char-001094-visual-source-001 / 图像条目

![obs-char-001094 glyph candidate](03_visual-assets/001_asset-001099_hust-obc-cat-1223_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-001099_hust-obc-cat-1223_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-001099_hust-obc-cat-1223_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/1223/G_1223_甲骨文.png`
