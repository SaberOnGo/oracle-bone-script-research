...
- External category reference: `evobc-cat-03779`
- Source category ID: `03779`
- Source label: `暗`
...
- `obs-evo-cand-003779-route-category-staging`
...
- `obs-evo-cand-003779-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003779-route-evolution-graph`
