...
- Project ID / 项目 ID: `obs-char-000852`
- Primary external ID / 首选外部 ID: `hust-obc-cat-0961`
...
- Source image / 来源图: `G_0961_京津4410合31923無名組.png`
- Image / 图像: `001_asset-000857_hust-obc-cat-0961_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合31923
  (G_0961_京津4410合31923無名組.png)`
...
- target node: `obimd-main-cand-001869`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- target node: `evobc-evo-cat-00086`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- OBIMD candidate ids / OBIMD 候选 ID: `obimd-main-cand-001869`
- OBIMD external refs / OBIMD 外部引用: `obimd-main-hcsv6oxj1l`
- OBIMD transcription field / OBIMD 转写字段: `򧤶|㞷`
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00086`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00086`
- EvoBC image references / EvoBC 图像引用数: `51`
...
- Matched candidate folders / 匹配候选目录: `evobc-evo-cat-00086`
- Human review files / 人类复核文件:
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/086_obs-evo-cand-000086_evobc-cat-00086_evoluti
...
- Matched OBIMD main UIDs / OBIMD 主字 UID: `hcsv6oxj1l`
- Component human files / 构件人类档案:
  corpus/003_graphemic-components/013_001201-001300_obs-comp-cand-bucket_compo
  nent-candidates/1296_obs-comp-cand-001296_obimd-sub-hcsv6oxj1l_component-can
  didate/README.md
  corpus/003_graphemic-components/013_001201-001300_obs-comp-cand-bucket_compo
  nent-candidates/1296_obs-comp-cand-001296_obimd-sub-hcsv6oxj1l_component-can
...
- Source label text / 来源标签文字: `㞷`
- Source label codepoint / 来源标签 codepoint: `U+37B7`
