...
- `obs-evo-cand-012265-route-category-staging`
...
- `obs-evo-cand-012265-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012265-route-evolution-graph`
