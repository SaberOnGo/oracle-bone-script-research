# Material Visual Observation / obs-comp-cand-000476 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000476`
- External reference / 外部参照: `obimd-sub-1r0owtspdr`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012626_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1r0owtspdr/1r0owtspdr/1r0owtspdr.png`
- Checksum / 校验和:
  `8e55021ac94790fd38e583b08999716c8967a79954640e97507f677b4cbfe80e`
...
- Marked-pixel bounds: (78,21)–(171,228); span 94 × 208 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.09%。
- 痕迹范围：(78,21)–(171,228)；跨度94 × 208 px；痕迹矩形高于宽。
