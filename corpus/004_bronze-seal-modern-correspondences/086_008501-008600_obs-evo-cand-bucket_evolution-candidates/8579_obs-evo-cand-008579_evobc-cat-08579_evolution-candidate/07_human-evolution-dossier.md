...
- External category reference: `evobc-cat-08579`
- Source category ID: `08579`
- Source label for human review: `賞`
- Source codepoints: `U+8CDE`
...
- `obs-evo-cand-008579-route-category-staging`
...
- `obs-evo-cand-008579-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008579-route-evolution-graph`
