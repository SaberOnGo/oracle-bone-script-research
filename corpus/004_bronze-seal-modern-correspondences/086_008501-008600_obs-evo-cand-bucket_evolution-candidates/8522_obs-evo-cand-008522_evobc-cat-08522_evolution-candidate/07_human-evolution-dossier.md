...
- External category reference: `evobc-cat-08522`
- Source category ID: `08522`
- Source label for human review: `貍`
- Source codepoints: `U+8C8D`
...
- `obs-evo-cand-008522-route-category-staging`
...
- `obs-evo-cand-008522-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008522-route-evolution-graph`
