...
- External category reference: `evobc-cat-04398`
- Source category ID: `04398`
- Source label for human review: `歸`
...
- `obs-evo-cand-004398-route-category-staging`
...
- `obs-evo-cand-004398-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004398-route-evolution-graph`
