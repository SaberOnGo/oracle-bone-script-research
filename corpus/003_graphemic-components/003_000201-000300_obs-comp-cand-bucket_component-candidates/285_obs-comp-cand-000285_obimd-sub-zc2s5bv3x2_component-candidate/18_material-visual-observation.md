# Material Visual Observation / obs-comp-cand-000285 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000285`
- External reference / 外部参照: `obimd-sub-zc2s5bv3x2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011927_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zc2s5bv3x2/zc2s5bv3x2/zc2s5bv3x2.png`
- Checksum / 校验和:
  `e7ffddbff765917d814c2975041976b1c71aec24c25ce03fdb9669cb58403fbb`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 14.25%.
- Marked-pixel bounds: (46,15)–(203,238); span 158 × 224 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占14.25%。
- 痕迹范围：(46,15)–(203,238)；跨度158 × 224 px；痕迹矩形高于宽。
