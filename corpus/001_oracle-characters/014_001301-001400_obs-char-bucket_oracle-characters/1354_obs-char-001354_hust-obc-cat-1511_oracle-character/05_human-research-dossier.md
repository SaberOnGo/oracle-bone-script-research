# obs-char-001354 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001354`
- primary external id: `hust-obc-cat-1511`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1354_obs-char-001354_hust-obc-cat-1511_ora
  cle-character/03_visual-assets/001_asset-001359_hust-obc-cat-1511_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1511/G_1511_明2065(甲).png`
- asset id: `asset-001359`
...
- source category: `1511`
- validation class: `1353`
- source image route: `HUST-OBC/deciphered/1511/G_1511_明2065(甲).png`
- asset id: `asset-001359`
...
- English observation: `A broad upper triangular stroke leads into a long
  narrow stem and a low horizontal branching base.`
- 中文观察: `宽大的上部三角状笔画连接长而狭窄的笔干，下方有低位水平分枝底部。`
...
- dataset label text: `㧝`
- dataset label codepoints: `U+39DD`
...
- Which source records identify obs-char-001354 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001354？
