...
- External category reference: `evobc-cat-12946`
- Source category ID: `12946`
- Source label for human review: `𫑞`
- Source codepoints: `U+2B45E`
...
- `obs-evo-cand-012946-route-category-staging`
...
- `obs-evo-cand-012946-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012946-route-evolution-graph`
