# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-001932
...
- candidate_component_id: `obs-comp-cand-001932`
- primary_external_ref_id: `obimd-sub-un7wnrhutk`
- source_subcharacter_uid: `un7wnrhutk`
- source_main_character_uid: `un7wnrhutk`
- main_character_external_ref_id: `obimd-main-un7wnrhutk`
...
- glyph_codepoint_uplus_sample: `U+26A27;U+FB130, U+FB131, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-018718` | `001_asset-018718_img.png` | `010dd1ffc477df1c052033da5e86461c3d6427733b4d922bf962deee10ae4237` |
