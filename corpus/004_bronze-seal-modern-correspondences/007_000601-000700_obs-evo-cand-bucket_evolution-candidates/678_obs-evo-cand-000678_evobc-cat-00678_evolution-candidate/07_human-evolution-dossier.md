...
- External category reference: `evobc-cat-00678`
- Source category ID: `00678`
- Source label for human review: `亅`
...
- `obs-evo-cand-000678-route-category-staging`
...
- `obs-evo-cand-000678-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000678-route-evolution-graph`
