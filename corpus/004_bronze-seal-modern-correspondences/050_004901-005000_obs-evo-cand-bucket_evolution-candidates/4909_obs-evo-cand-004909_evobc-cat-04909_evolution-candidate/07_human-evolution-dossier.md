...
Project ID: `obs-evo-cand-004909`
...
- Project ID: `obs-evo-cand-004909`
- EVOBC category candidate ID: `evobc-evo-cat-04909`
- External category reference: `evobc-cat-04909`
- Source category ID: `04909`
- Source label for human review: `潧`
- Source codepoints: `U+6F67`
...
- `obs-evo-cand-004909-route-category-staging`
...
- `obs-evo-cand-004909-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004909-route-evolution-graph`
