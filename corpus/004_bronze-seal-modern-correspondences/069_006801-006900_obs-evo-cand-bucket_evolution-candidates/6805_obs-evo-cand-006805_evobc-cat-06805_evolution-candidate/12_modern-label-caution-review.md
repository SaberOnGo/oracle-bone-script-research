# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006805
...
- EVOBC candidate category: `evobc-evo-cat-06805`.
- Source label for search only: `罝`.
- Source codepoints for search only: `U+7F5D`.
