# obs-unk-004719 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004719`
- primary external id: `hust-obc-und-X-004719`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/019_obs-unk-004719_h
  ust-obc-und-X-004719_oracle-character-candidate/03_visual-assets/001_asset
  -006312_hust-obc-und-X-004719_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/275/X_？_7248_1.png`
- asset id: `asset-006312`
...
- source class: `HUST-OBC/undeciphered/X/275/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/275/X_？_7248_1.png`
- asset id: `asset-006312`
...
- English observation: `upper branching strokes with lower pale opening`
- 中文观察: `带下部浅色开口的上部分支笔画`
...
- Which source records identify obs-unk-004719 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004719？
