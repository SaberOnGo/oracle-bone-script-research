...
- Project ID: `obs-evo-cand-005015`
- EVOBC category candidate ID: `evobc-evo-cat-05015`
- External category reference: `evobc-cat-05015`
- Source category ID: `05015`
- Source label for human review: `灌`
- Source codepoints: `U+704C`
...
- `obs-evo-cand-005015-route-category-staging`
...
- `obs-evo-cand-005015-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005015-route-evolution-graph`
