...
- Yingguo / 英国所藏: `y2293` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `279` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `211` in source row; primary catalog entry pending
