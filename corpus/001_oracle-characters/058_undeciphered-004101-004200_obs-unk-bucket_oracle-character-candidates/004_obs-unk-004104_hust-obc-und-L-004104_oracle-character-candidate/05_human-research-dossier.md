# obs-unk-004104 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004104`
- primary external id: `hust-obc-und-L-004104`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/004_obs-unk-004104_h
  ust-obc-und-L-004104_oracle-character-candidate/03_visual-assets/001_asset
  -005697_hust-obc-und-L-004104_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4104/L_？_8824.jpg`
- asset id: `asset-005697`
...
- source class: `HUST-OBC/undeciphered/L/4104/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4104/L_？_8824.jpg`
- asset id: `asset-005697`
...
- English observation: A small angular or loop-like upper trace sits above a
  darker lower cluster. Jagged thin traces descend on the left, while a
  longer curved or upright trace runs on the right; their joins remain unclear.
- 中文观察：图像上方有一个小型折线或近环状痕迹，下方是较深的痕迹组。
...
- Which source records identify obs-unk-004104 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004104？
