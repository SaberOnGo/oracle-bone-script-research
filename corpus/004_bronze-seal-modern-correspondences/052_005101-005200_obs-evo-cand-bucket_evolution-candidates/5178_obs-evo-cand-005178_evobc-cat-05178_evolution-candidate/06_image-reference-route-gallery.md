...
- `obs-evo-cand-005178-route-category-staging`
...
- `obs-evo-cand-005178-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005178-route-evolution-graph`
