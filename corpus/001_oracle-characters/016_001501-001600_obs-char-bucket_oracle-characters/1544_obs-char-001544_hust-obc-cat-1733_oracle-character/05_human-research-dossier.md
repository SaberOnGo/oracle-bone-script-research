# obs-char-001544 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001544`
- primary external id: `hust-obc-cat-1733`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1544_obs-char-001544_hust-obc-cat-1733_ora
  cle-character/03_visual-assets/001_asset-001549_hust-obc-cat-1733_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1733/G_1733_乙6533(甲).png`
- asset id: `asset-001549`
...
- source category: `1733`
- validation class: `1543`
- source image route: `HUST-OBC/deciphered/1733/G_1733_乙6533(甲).png`
- asset id: `asset-001549`
...
- English observation: `A dense curved cluster has a central crossing and
  several sweeping side strokes.`
- 中文观察: `密集弧形笔画群有中央交叉和数条舒展侧部笔画。`
...
- dataset label text: `㪻`
- dataset label codepoints: `U+3ABB`
...
- Which source records identify obs-char-001544 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001544？
