...
- External category reference: `evobc-cat-04014`
- Source category ID: `04014`
- Source label: `桀`
...
- `obs-evo-cand-004014-route-category-staging`
...
- `obs-evo-cand-004014-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004014-route-evolution-graph`
