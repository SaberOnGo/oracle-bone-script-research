...
- External category reference: `evobc-cat-04154`
- Source category ID: `04154`
- Source label for human review: `楚`
- Source codepoints: `U+695A`
- Image reference count in source metadata: `207`
...
- `obs-evo-cand-004154-route-category-staging`
...
- `obs-evo-cand-004154-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004154-route-evolution-graph`
