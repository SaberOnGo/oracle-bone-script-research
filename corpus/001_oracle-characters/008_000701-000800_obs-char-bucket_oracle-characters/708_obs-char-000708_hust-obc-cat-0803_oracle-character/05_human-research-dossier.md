# obs-char-000708 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000708`
- primary external id: `hust-obc-cat-0803`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/708_obs-char-000708_hust-obc-cat-0803_orac
  le-character/03_visual-assets/001_asset-000713_hust-obc-cat-0803_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0803/G_0803_乙3380反合17301反.png`
- asset id: `asset-000713`
...
- source category: `0803`
- validation class: `707`
- source image route: `HUST-OBC/deciphered/0803/G_0803_乙3380反合17301反.png`
- asset id: `asset-000713`
...
- English observation: `A bold rounded lower outline forms a shallow basin
  crossed by a long upper bar, with one short detached horizontal inside and
  a small separate vertical mark at right.`
- 中文观察: `粗重圆弯下轮廓形成被长上横穿过的浅槽，内部有短分离横痕，右侧另有小竖痕。`
...
- dataset label text: `㜙`
- dataset label codepoints: `U+3719`
...
- filename catalog route clues: `Heji-like filename clue: 合17301
  (G_0803_乙3380反合17301反.png)`
...
- Which source records identify obs-char-000708 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000708？
