# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001683
...
- EVOBC candidate category: `evobc-evo-cat-01683`.
- Source label for search only: `嗼`.
- Source codepoints for search only: `U+55FC`.
