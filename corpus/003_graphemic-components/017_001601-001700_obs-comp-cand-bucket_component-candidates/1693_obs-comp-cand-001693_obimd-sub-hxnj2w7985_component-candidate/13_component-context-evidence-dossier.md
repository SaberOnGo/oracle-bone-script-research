# obs-comp-cand-001693 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001693`
- 首选外部 ID: `obimd-sub-hxnj2w7985`
- OBIMD subcharacter UID: `hxnj2w7985`
...
- glyph-codepoint 数: `9`
- codepoint 示例: U+A9A8D;U+F9D0A; U+F9D0B; 另有 7 项
