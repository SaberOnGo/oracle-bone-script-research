# obs-char-001008 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1008_obs-char-001008_hust-obc-cat-1132_ora
  cle-character/03_visual-assets/001_asset-001013_hust-obc-cat-1132_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1132/G_1132_前6.32.5合8315賓組.png`
- asset id: `asset-001013`
...
- source category: `1132`
- validation class: `1007`
- source image route: `HUST-OBC/deciphered/1132/G_1132_前6.32.5合8315賓組.png`
- asset id: `asset-001013`
...
- English observation: `A thin bent upper stroke turns into a long low
  curved stroke, with several short detached marks at the left.`
- 中文观察: `纤细弯折的上部笔转入一条低位长弯曲笔，左侧另有数条短分离笔。`
...
- dataset label text: `㡢`
- dataset label codepoints: `U+3862`
...
- filename catalog route clues: `Heji-like filename clue: 合8315
...
- Which source records identify obs-char-001008 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001008？
