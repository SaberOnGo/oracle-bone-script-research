# obs-evo-cand-005777 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-05777`
- Source label: `相`
- Source codepoints: `U+76F8`
- Image reference count: `148`
- Era token counts: `BI:16;CS:1;OBC:42;SAC:3;SS:2;WSC:84`
- Source token counts: `Book:54;Web:94`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 42 image references
- era 1 / BI: 16 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 3 image references
- era 4 / WSC: 84 image references
