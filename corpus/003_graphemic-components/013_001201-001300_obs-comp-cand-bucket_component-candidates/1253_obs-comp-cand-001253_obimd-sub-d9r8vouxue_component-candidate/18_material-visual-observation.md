# Material Visual Observation / obs-comp-cand-001253 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001253`
- External reference / 外部参照: `obimd-sub-d9r8vouxue`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015491_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/d9r8vouxue/d9r8vouxue/d9r8vouxue.png`
- Checksum / 校验和:
  `14f48400d5e616d1c8ab53378df4cf65a284c9f5e8b65f47f501eae23bf587b0`
...
- Marked-pixel bounds: (65,54)–(198,210); span 134 × 157 px; the marked
...
- 痕迹范围：(65,54)–(198,210)；跨度134 × 157 px；痕迹矩形近方形。
