...
- External category reference: `evobc-cat-04495`
- Source category ID: `04495`
- Source label for human review: `汕`
- Source codepoints: `U+6C55`
...
- `obs-evo-cand-004495-route-category-staging`
...
- `obs-evo-cand-004495-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004495-route-evolution-graph`
