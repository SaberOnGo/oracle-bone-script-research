...
- Project ID: `obs-evo-cand-012869`
- EVOBC category candidate ID: `evobc-evo-cat-12869`
- External category reference: `evobc-cat-12869`
- Source category ID: `12869`
- Source label for human review: `𪳐`
- Source codepoints: `U+2ACD0`
...
- `obs-evo-cand-012869-route-category-staging`
...
- `obs-evo-cand-012869-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012869-route-evolution-graph`
