# obs-unk-008178 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008178`
- primary external id: `hust-obc-und-YH-008178`
...
- local review image route: `corpus/001_oracle-characters/098_undeciphered-008
  101-008200_obs-unk-bucket_oracle-character-candidates/078_obs-unk-008178_h
  ust-obc-und-YH-008178_oracle-character-candidate/03_visual-assets/001_asse
  t-009769_hust-obc-und-YH-008178_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6084E/H_？_6084E_0.png`
- asset id: `asset-009769`
...
- source class: `HUST-OBC/undeciphered/Y+H/6084E/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6084E/H_？_6084E_0.png`
- asset id: `asset-009769`
...
- Which source records identify obs-unk-008178 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008178？
