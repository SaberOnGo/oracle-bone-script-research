...
- External category reference: `evobc-cat-10968`
- Source category ID: `10968`
- Source label for human review: `𡅸`
- Source codepoints: `U+21178`
...
- `obs-evo-cand-010968-route-category-staging`
...
- `obs-evo-cand-010968-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010968-route-evolution-graph`
