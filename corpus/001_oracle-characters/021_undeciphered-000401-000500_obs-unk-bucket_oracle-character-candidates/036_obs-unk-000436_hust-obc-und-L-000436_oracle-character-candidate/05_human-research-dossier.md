# obs-unk-000436 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000436`
- primary external id: `hust-obc-und-L-000436`
...
- local review image route: `corpus/001_oracle-characters/021_undeciphered-000
  401-000500_obs-unk-bucket_oracle-character-candidates/036_obs-unk-000436_h
  ust-obc-und-L-000436_oracle-character-candidate/03_visual-assets/001_asset
  -002029_hust-obc-und-L-000436_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/436/L_？_1137.jpg`
- asset id: `asset-002029`
...
- source class: `HUST-OBC/undeciphered/L/436/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/436/L_？_1137.jpg`
- asset id: `asset-002029`
...
- Which source records identify obs-unk-000436 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000436？
