...
- External category reference: `evobc-cat-06038`
- Source category ID: `06038`
- Source label for human review: `禱`
- Source codepoints: `U+79B1`
- Image reference count in source metadata: `123`
...
- `obs-evo-cand-006038-route-category-staging`
...
- `obs-evo-cand-006038-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006038-route-evolution-graph`
