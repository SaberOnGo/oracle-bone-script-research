# obs-char-000649 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/649_obs-char-000649_hust-obc-cat-0737_orac
  le-character/03_visual-assets/001_asset-000654_hust-obc-cat-0737_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0737/G_0737_甲2772(甲).png`
- asset id: `asset-000654`
...
- source category: `0737`
- validation class: `648`
- source image route: `HUST-OBC/deciphered/0737/G_0737_甲2772(甲).png`
- asset id: `asset-000654`
...
- English observation: `A tall narrow chain has two small round openings on
  separate upper stalks, a crossed middle oval, and several fine forked
  strands descending below.`
- 中文观察: `高狭竖链顶部两条分立细干各带小圆空隙，中部为交叉椭圆，下有数条细叉状垂线。`
...
- dataset label text: `㛗`
- dataset label codepoints: `U+36D7`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/054_obs-evo-can
  d-000054_evobc-cat-00054_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/054_obs-evo-cand-000054_evobc-cat-00054_evolu
...
- Which source records identify obs-char-000649 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000649？
