# Material Visual Observation / obs-comp-cand-001219 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001219`
- External reference / 外部参照: `obimd-sub-lxeowryqvn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015450_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/myoqtwlezn/lxeowryqvn/lxeowryqvn.png`
- Checksum / 校验和:
  `ff222b0f0d070ad0dd31e190b6a0923e51e0c4777c75950d0c69378f7aa90b0f`
...
- Marked-pixel bounds: (65,38)–(184,211); span 120 × 174 px; the marked
...
- 痕迹范围：(65,38)–(184,211)；跨度120 × 174 px；痕迹矩形高于宽。
