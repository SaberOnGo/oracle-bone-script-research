...
- External category reference: `evobc-cat-04303`
- Source category ID: `04303`
- Source label for human review: `檾`
...
- `obs-evo-cand-004303-route-category-staging`
...
- `obs-evo-cand-004303-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004303-route-evolution-graph`
