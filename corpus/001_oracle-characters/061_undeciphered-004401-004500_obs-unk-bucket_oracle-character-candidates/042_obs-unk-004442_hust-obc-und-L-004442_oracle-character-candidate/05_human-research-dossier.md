# obs-unk-004442 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004442`
- primary external id: `hust-obc-und-L-004442`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/042_obs-unk-004442_h
  ust-obc-und-L-004442_oracle-character-candidate/03_visual-assets/001_asset
  -006035_hust-obc-und-L-004442_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4442/L_？_9988.jpg`
- asset id: `asset-006035`
...
- source class: `HUST-OBC/undeciphered/L/4442/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4442/L_？_9988.jpg`
- asset id: `asset-006035`
...
- English observation: `Paired small upper marks sit beside a tall right`
  `trace and lower box.`
- 中文观察: `上部小痕迹紧邻右侧高痕和下部框状轮廓。`
...
- Which source records identify obs-unk-004442 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004442？
