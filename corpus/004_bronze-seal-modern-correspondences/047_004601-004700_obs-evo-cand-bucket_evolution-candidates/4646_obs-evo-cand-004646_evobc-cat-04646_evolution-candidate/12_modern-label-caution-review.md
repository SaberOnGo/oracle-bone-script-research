# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004646
...
- EVOBC candidate category: `evobc-evo-cat-04646`.
- Source label for search only: `洿`.
- Source codepoints for search only: `U+6D3F`.
