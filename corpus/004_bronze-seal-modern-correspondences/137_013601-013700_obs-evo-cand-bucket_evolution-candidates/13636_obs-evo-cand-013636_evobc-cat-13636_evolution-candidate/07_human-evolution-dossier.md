...
Project ID: `obs-evo-cand-013636`
...
- Project ID: `obs-evo-cand-013636`
- EVOBC category candidate ID: `evobc-evo-cat-13636`
- External category reference: `evobc-cat-13636`
- Source category ID: `13636`
- Source label for human review: `𮕨`
- Source codepoints: `U+2E568`
...
- `obs-evo-cand-013636-route-category-staging`
...
- `obs-evo-cand-013636-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013636-route-evolution-graph`
