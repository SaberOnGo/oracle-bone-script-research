...
- Project ID: `obs-evo-cand-012039`
- EVOBC category candidate ID: `evobc-evo-cat-12039`
- External category reference: `evobc-cat-12039`
- Source category ID: `12039`
- Source label for human review: `𦘱`
- Source codepoints: `U+26631`
- Image reference count in source metadata: `49`
...
- `obs-evo-cand-012039-route-category-staging`
...
- `obs-evo-cand-012039-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012039-route-evolution-graph`
