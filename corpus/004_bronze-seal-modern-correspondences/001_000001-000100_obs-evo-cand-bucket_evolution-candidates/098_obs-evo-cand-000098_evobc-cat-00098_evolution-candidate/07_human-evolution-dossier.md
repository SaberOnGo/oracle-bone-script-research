...
- Project ID: `obs-evo-cand-000098`
- EVOBC category candidate ID: `evobc-evo-cat-00098`
- External category reference: `evobc-cat-00098`
- Source category ID: `00098`
- Source label for human review: `㢈`
- Source codepoints: `U+3888`
...
- `obs-evo-cand-000098-route-category-staging`
...
- `obs-evo-cand-000098-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000098-route-evolution-graph`
