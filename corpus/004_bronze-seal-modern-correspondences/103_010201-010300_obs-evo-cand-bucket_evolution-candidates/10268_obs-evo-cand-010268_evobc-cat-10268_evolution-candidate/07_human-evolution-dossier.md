...
- External category reference: `evobc-cat-10268`
- Source category ID: `10268`
- Source label for human review: `驫`
...
- `obs-evo-cand-010268-route-category-staging`
...
- `obs-evo-cand-010268-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010268-route-evolution-graph`
