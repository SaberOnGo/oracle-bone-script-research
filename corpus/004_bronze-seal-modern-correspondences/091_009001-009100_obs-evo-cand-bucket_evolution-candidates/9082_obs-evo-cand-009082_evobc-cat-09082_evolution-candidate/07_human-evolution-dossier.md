...
- External category reference: `evobc-cat-09082`
- Source category ID: `09082`
- Source label for human review: `邏`
...
- `obs-evo-cand-009082-route-category-staging`
...
- `obs-evo-cand-009082-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009082-route-evolution-graph`
