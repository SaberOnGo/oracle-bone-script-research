...
Project ID: `obs-evo-cand-004492`
...
- Project ID: `obs-evo-cand-004492`
- EVOBC category candidate ID: `evobc-evo-cat-04492`
- External category reference: `evobc-cat-04492`
- Source category ID: `04492`
- Source label for human review: `汏`
- Source codepoints: `U+6C4F`
...
- `obs-evo-cand-004492-route-category-staging`
...
- `obs-evo-cand-004492-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004492-route-evolution-graph`
