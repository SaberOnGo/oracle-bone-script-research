# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008422
...
- EVOBC candidate category: `evobc-evo-cat-08422`.
- Source label for search only: `译`.
- Source codepoints for search only: `U+8BD1`.
