# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004317
...
- EVOBC candidate category: `evobc-evo-cat-04317`.
- Source label for search only: `櫟`.
- Source codepoints for search only: `U+6ADF`.
