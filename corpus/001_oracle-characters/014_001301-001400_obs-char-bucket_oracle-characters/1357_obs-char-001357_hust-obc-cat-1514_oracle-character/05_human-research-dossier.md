# obs-char-001357 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1357_obs-char-001357_hust-obc-cat-1514_ora
  cle-character/03_visual-assets/001_asset-001362_hust-obc-cat-1514_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1514/X_1514_6211_1.png`
- asset id: `asset-001362`
...
- source category: `1514`
- validation class: `1356`
- source image route: `HUST-OBC/deciphered/1514/X_1514_6211_1.png`
- asset id: `asset-001362`
...
- dataset label text: `㧠`
- dataset label codepoints: `U+39E0`
...
- Which source records identify obs-char-001357 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001357？
