...
- Project ID: `obs-evo-cand-010318`
- EVOBC category candidate ID: `evobc-evo-cat-10318`
- External category reference: `evobc-cat-10318`
- Source category ID: `10318`
- Source label for human review: `髴`
- Source codepoints: `U+9AF4`
...
- `obs-evo-cand-010318-route-category-staging`
...
- `obs-evo-cand-010318-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010318-route-evolution-graph`
