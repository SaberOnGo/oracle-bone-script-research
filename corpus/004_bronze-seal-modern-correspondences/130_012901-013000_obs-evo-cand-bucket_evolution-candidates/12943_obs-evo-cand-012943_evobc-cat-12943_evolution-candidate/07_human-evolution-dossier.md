...
- External category reference: `evobc-cat-12943`
- Source category ID: `12943`
- Source label for human review: `𫑍`
- Source codepoints: `U+2B44D`
...
- `obs-evo-cand-012943-route-category-staging`
...
- `obs-evo-cand-012943-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012943-route-evolution-graph`
