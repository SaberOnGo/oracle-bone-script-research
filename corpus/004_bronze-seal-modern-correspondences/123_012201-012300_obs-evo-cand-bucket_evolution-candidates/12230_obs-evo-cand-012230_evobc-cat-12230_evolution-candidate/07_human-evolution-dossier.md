...
- External category reference: `evobc-cat-12230`
- Source category ID: `12230`
- Source label for human review: `𧧩`
- Source codepoints: `U+279E9`
...
- `obs-evo-cand-012230-route-category-staging`
...
- `obs-evo-cand-012230-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012230-route-evolution-graph`
