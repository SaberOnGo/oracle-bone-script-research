# obs-char-001151 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001151`
- primary external id: `hust-obc-cat-1288`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1151_obs-char-001151_hust-obc-cat-1288_ora
  cle-character/03_visual-assets/001_asset-001156_hust-obc-cat-1288_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1288/G_1288_乙1336合22083午組.png`
- asset id: `asset-001156`
...
- source category: `1288`
- validation class: `1150`
- source image route: `HUST-OBC/deciphered/1288/G_1288_乙1336合22083午組.png`
- asset id: `asset-001156`
...
- English observation: `A narrow upright form has a short upper
  cross-stroke, a central descending line, and two unequal lower side
  strokes.`
...
- dataset label text: `㣾`
- dataset label codepoints: `U+38FE`
...
- filename catalog route clues: `Heji-like filename clue: 合22083
  (G_1288_乙1336合22083午組.png)`
...
- Which source records identify obs-char-001151 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001151？
