...
- Project ID: `obs-evo-cand-005534`
- EVOBC category candidate ID: `evobc-evo-cat-05534`
- External category reference: `evobc-cat-05534`
- Source category ID: `05534`
- Source label for human review: `甡`
- Source codepoints: `U+7521`
...
- `obs-evo-cand-005534-route-category-staging`
...
- `obs-evo-cand-005534-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005534-route-evolution-graph`
