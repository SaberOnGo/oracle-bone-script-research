...
Project ID: `obs-evo-cand-011260`
...
- Project ID: `obs-evo-cand-011260`
- EVOBC category candidate ID: `evobc-evo-cat-11260`
- External category reference: `evobc-cat-11260`
- Source category ID: `11260`
- Source label for human review: `𢟊`
- Source codepoints: `U+227CA`
...
- `obs-evo-cand-011260-route-category-staging`
...
- `obs-evo-cand-011260-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011260-route-evolution-graph`
