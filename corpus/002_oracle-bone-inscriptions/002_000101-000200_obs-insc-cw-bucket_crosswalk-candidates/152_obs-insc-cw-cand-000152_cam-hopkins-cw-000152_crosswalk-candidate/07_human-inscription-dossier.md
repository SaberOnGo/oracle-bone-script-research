...
- Yingguo / 英国所藏: `y840` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `158` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: 待查: missing Chalfant reference in source row
- Heji / 合集: `40161` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000152`
