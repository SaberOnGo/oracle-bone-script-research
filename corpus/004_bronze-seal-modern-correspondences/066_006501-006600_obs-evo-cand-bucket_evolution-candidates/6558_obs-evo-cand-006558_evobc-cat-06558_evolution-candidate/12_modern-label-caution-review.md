# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006558
...
- EVOBC candidate category: `evobc-evo-cat-06558`.
- Source label for search only: `綮`.
- Source codepoints for search only: `U+7DAE`.
