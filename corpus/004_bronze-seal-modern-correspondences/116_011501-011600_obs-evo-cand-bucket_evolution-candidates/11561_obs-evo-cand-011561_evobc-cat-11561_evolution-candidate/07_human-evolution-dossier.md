...
- External category reference: `evobc-cat-11561`
- Source category ID: `11561`
- Source label for human review: `𤉿`
...
- `obs-evo-cand-011561-route-category-staging`
...
- `obs-evo-cand-011561-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011561-route-evolution-graph`
