# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004789
...
- EVOBC candidate category: `evobc-evo-cat-04789`.
- Source label for search only: `湝`.
- Source codepoints for search only: `U+6E5D`.
