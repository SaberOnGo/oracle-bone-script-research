# Material Visual Observation / obs-comp-cand-000388 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000388`
- External reference / 外部参照: `obimd-sub-qznkllksil`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012311_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rnar1q86c5/qznkllksil/qznkllksil.png`
- Checksum / 校验和:
  `e16721afcf607ced23480bce943f78badabcbf89cd0a4e0fffa91e5d73cec366`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.69%.
- Marked-pixel bounds: (82,27)–(167,225); span 86 × 199 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.69%。
- 痕迹范围：(82,27)–(167,225)；跨度86 × 199 px；痕迹矩形高于宽。
