# obs-unk-004467 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004467`
- primary external id: `hust-obc-und-X-004467`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/067_obs-unk-004467_h
  ust-obc-und-X-004467_oracle-character-candidate/03_visual-assets/001_asset
  -006060_hust-obc-und-X-004467_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/23/X_？_8202_1.png`
- asset id: `asset-006060`
...
- source class: `HUST-OBC/undeciphered/X/23/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/23/X_？_8202_1.png`
- asset id: `asset-006060`
...
- English observation: Three separate dark vertical forms show uneven tops and
  small lower openings.
- 中文观察: 三组分离的深色竖向痕迹顶部不一，下部有小开口。
...
- Which source records identify obs-unk-004467 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004467？
