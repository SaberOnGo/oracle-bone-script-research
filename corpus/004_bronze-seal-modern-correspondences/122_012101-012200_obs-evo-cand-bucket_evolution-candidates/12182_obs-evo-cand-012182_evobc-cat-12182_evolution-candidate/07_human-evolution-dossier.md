...
- External category reference: `evobc-cat-12182`
- Source category ID: `12182`
- Source label for human review: `𧗙`
...
- `obs-evo-cand-012182-route-category-staging`
...
- `obs-evo-cand-012182-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012182-route-evolution-graph`
