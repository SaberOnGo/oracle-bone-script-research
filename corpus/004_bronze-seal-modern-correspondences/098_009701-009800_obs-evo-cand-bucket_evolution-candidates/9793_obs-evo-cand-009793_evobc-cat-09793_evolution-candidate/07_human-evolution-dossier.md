...
Project ID: `obs-evo-cand-009793`
...
- Project ID: `obs-evo-cand-009793`
- EVOBC category candidate ID: `evobc-evo-cat-09793`
- External category reference: `evobc-cat-09793`
- Source category ID: `09793`
- Source label for human review: `隸`
- Source codepoints: `U+96B8`
...
- `obs-evo-cand-009793-route-category-staging`
...
- `obs-evo-cand-009793-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009793-route-evolution-graph`
