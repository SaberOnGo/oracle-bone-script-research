# Material Visual Observation / obs-comp-cand-002286 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002286`
- External reference / 外部参照: `obimd-sub-5jcghtltbx`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020170_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5jcghtltbx/5jcghtltbx/5jcghtltbx.png`
- Checksum / 校验和:
  `01b4c1d75807acaa7fc67dc17e34fd8e76e42ee8ce88b828980760fc62842558`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.65%.
- Marked-pixel bounds: (52,24)–(206,225); span 155 × 202 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.65%。
- 痕迹范围：(52,24)–(206,225)；跨度155 × 202 px；痕迹矩形高于宽。
