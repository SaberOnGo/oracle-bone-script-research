# obs-unk-003989 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003989`
- primary external id: `hust-obc-und-L-003989`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/089_obs-unk-003989_h
  ust-obc-und-L-003989_oracle-character-candidate/03_visual-assets/001_asset
  -005582_hust-obc-und-L-003989_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3989/L_？_8444.jpg`
- asset id: `asset-005582`
...
- source class: `HUST-OBC/undeciphered/L/3989/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3989/L_？_8444.jpg`
- asset id: `asset-005582`
...
- English observation: A short upright cluster sits above a diagonal lower
  trace, with a small angled branch on the right.
- 中文观察：上部有短直立痕迹簇，下方有斜向痕迹，
  右侧带小型斜向分支。
...
- Which source records identify obs-unk-003989 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003989？
