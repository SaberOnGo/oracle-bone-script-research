# obs-char-000766 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000766`
- primary external id: `hust-obc-cat-0869`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/766_obs-char-000766_hust-obc-cat-0869_orac
  le-character/03_visual-assets/001_asset-000771_hust-obc-cat-0869_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0869/G_0869_後2.21.14(甲).png`
- asset id: `asset-000771`
...
- source category: `0869`
- validation class: `765`
- source image route: `HUST-OBC/deciphered/0869/G_0869_後2.21.14(甲).png`
- asset id: `asset-000771`
...
- English observation: `A small upper rectangular loop is flanked by
  detached short marks; below it, crossed diagonals fill a tall open frame
  above a broad curved basin and thin side extensions.`
- 中文观察: `小型上部矩形环两侧有分离短痕；其下交叉斜笔充满高长开放框，底部为宽弯槽并带细侧延笔。`
...
- dataset label text: `㝛`
- dataset label codepoints: `U+375B`
...
- Which source records identify obs-char-000766 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000766？
