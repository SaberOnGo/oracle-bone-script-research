# Material Visual Observation / obs-comp-cand-000349 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000349`
- External reference / 外部参照: `obimd-sub-qtpmmeo3aw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012273_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bcsv0dsf6i/qtpmmeo3aw/qtpmmeo3aw.png`
- Checksum / 校验和:
  `9927827f995943b14cb2387e9b1395529809efcffdcab8a8b0e8d008fea10926`
...
- Marked-pixel bounds: (71,33)–(178,216); span 108 × 184 px; the marked
...
- 痕迹范围：(71,33)–(178,216)；跨度108 × 184 px；痕迹矩形高于宽。
