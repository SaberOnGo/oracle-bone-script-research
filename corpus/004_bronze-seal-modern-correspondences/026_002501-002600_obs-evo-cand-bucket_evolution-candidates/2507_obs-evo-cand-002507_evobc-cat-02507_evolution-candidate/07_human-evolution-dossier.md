...
- External category reference: `evobc-cat-02507`
- Source category ID: `02507`
- Source label for human review: `屒`
- Source codepoints: `U+5C52`
...
- `obs-evo-cand-002507-route-category-staging`
...
- `obs-evo-cand-002507-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002507-route-evolution-graph`
