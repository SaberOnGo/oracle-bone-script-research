...
- Project ID: `obs-evo-cand-008245`
- EVOBC category candidate ID: `evobc-evo-cat-08245`
- External category reference: `evobc-cat-08245`
- Source category ID: `08245`
- Source label for human review: `說`
- Source codepoints: `U+8AAA`
...
- `obs-evo-cand-008245-route-category-staging`
...
- `obs-evo-cand-008245-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008245-route-evolution-graph`
