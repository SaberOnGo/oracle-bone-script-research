# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000167
...
| --- | --- | --- | --- |
| `obimd-glyph-link-002167` | 󰼕 | `U+F0F15` | `reviewed_metadata_only` |
| `obimd-glyph-link-002168` | 󰼖 | `U+F0F16` | `reviewed_metadata_only` |
