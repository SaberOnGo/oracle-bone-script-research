...
- External category reference: `evobc-cat-02373`
- Source category ID: `02373`
- Source label: `宗`
- Source codepoints: `U+5B97`
- Image reference count in source metadata: `258`
...
- `obs-evo-cand-002373-route-category-staging`
...
- `obs-evo-cand-002373-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002373-route-evolution-graph`
