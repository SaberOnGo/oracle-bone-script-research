# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006624
...
- EVOBC candidate category: `evobc-evo-cat-06624`.
- Source label for search only: `縊`.
- Source codepoints for search only: `U+7E0A`.
