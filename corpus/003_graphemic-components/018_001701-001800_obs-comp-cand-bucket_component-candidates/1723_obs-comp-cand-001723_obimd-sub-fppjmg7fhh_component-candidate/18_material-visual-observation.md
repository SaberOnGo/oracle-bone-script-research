# Material Visual Observation / obs-comp-cand-001723 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001723`
- External reference / 外部参照: `obimd-sub-fppjmg7fhh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017902_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fppjmg7fhh/fppjmg7fhh/fppjmg7fhh.png`
- Checksum / 校验和:
  `cf24e8f6da46f65a41e6e382bc342d2a088e46db19187c2d4fefb3415b8ccf89`
...
- Marked-pixel bounds: (62,37)–(175,215); span 114 × 179 px; the marked
...
- 痕迹范围：(62,37)–(175,215)；跨度114 × 179 px；痕迹矩形高于宽。
