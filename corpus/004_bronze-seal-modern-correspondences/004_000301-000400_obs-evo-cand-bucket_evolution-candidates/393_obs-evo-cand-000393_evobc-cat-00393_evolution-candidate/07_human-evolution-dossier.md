...
- Project ID: `obs-evo-cand-000393`
- EVOBC category candidate ID: `evobc-evo-cat-00393`
- External category reference: `evobc-cat-00393`
- Source category ID: `00393`
- Source label for human review: `䕺`
- Source codepoints: `U+457A`
...
- `obs-evo-cand-000393-route-category-staging`
...
- `obs-evo-cand-000393-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000393-route-evolution-graph`
