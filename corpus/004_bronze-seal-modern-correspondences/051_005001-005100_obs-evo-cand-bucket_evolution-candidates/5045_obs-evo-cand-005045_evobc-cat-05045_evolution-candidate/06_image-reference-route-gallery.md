...
- `obs-evo-cand-005045-route-category-staging`
...
- `obs-evo-cand-005045-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005045-route-evolution-graph`
