...
- Project ID: `obs-evo-cand-002242`
- EVOBC category candidate ID: `evobc-evo-cat-02242`
- External category reference: `evobc-cat-02242`
- Source category ID: `02242`
- Source label for human review: `媮`
- Source codepoints: `U+5AAE`
...
- `obs-evo-cand-002242-route-category-staging`
...
- `obs-evo-cand-002242-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002242-route-evolution-graph`
