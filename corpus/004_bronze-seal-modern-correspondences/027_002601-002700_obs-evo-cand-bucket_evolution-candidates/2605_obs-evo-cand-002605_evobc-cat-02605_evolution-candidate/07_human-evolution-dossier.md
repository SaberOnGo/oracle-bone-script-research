...
- Project ID: `obs-evo-cand-002605`
- EVOBC category candidate ID: `evobc-evo-cat-02605`
- External category reference: `evobc-cat-02605`
- Source category ID: `02605`
- Source label for human review: `巂`
- Source codepoints: `U+5DC2`
...
- `obs-evo-cand-002605-route-category-staging`
...
- `obs-evo-cand-002605-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002605-route-evolution-graph`
