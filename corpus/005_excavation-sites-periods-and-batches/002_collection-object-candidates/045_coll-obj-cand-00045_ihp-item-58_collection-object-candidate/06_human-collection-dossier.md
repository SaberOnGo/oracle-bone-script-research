# Human Collection Object Dossier / 馆藏对象研究档案: coll-obj-cand-00045
...
- project_id: `coll-obj-cand-00045`
- candidate_collection_object_id: `ihp-mus-obj-00045`
- source_collection_item_id: `58`
...
| `source_collection_item_id` | `58` |
| `object_title_en` | `Inscribed Plastron Fragment I 0566` |
| `catalog_reference_text` | `I 0566` |
| `object_page_url` | `https://museum.sinica.edu.tw/en/collection/32/item/58/` |
| `thumbnail_url` | `https://museum.sinica.edu.tw/_upload/image/collection_item/thumbnail/dc1167119555.jpg` |
