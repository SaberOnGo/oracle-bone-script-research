...
Project ID: `obs-evo-cand-004786`
...
- Project ID: `obs-evo-cand-004786`
- EVOBC category candidate ID: `evobc-evo-cat-04786`
- External category reference: `evobc-cat-04786`
- Source category ID: `04786`
- Source label for human review: `湖`
- Source codepoints: `U+6E56`
...
- `obs-evo-cand-004786-route-category-staging`
...
- `obs-evo-cand-004786-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004786-route-evolution-graph`
