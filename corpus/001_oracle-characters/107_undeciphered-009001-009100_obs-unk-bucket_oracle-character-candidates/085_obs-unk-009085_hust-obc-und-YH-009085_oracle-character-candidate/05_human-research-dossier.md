# obs-unk-009085 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/107_undeciphered-009
  001-009100_obs-unk-bucket_oracle-character-candidates/085_obs-unk-009085_h
  ust-obc-und-YH-009085_oracle-character-candidate/03_visual-assets/001_asse
  t-010676_hust-obc-und-YH-009085_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/611AE/H_？_611AE_0.png`
- asset id: `asset-010676`
...
- source class: `HUST-OBC/undeciphered/Y+H/611AE/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/611AE/H_？_611AE_0.png`
- asset id: `asset-010676`
...
- Which source records identify obs-unk-009085 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009085？
