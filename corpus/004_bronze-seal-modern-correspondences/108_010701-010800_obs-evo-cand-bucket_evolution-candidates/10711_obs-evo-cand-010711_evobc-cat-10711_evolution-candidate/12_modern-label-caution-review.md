# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010711
...
- EVOBC candidate category: `evobc-evo-cat-10711`.
- Source label for search only: `齋`.
- Source codepoints for search only: `U+9F4B`.
