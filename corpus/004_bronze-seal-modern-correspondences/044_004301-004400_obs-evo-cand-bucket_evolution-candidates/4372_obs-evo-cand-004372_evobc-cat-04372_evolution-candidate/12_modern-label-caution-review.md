# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004372
...
- EVOBC candidate category: `evobc-evo-cat-04372`.
- Source label for search only: `歏`.
- Source codepoints for search only: `U+6B4F`.
