...
- Project ID: `obs-evo-cand-011376`
- EVOBC category candidate ID: `evobc-evo-cat-11376`
- External category reference: `evobc-cat-11376`
- Source category ID: `11376`
- Source label for human review: `𣂚`
- Source codepoints: `U+2309A`
...
- `obs-evo-cand-011376-route-category-staging`
...
- `obs-evo-cand-011376-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011376-route-evolution-graph`
