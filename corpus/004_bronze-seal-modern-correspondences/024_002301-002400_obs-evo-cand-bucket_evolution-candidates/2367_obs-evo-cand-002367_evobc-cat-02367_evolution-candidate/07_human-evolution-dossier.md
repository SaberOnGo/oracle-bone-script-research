...
- External category reference: `evobc-cat-02367`
- Source category ID: `02367`
- Source label for human review: `宏`
...
- `obs-evo-cand-002367-route-category-staging`
...
- `obs-evo-cand-002367-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002367-route-evolution-graph`
