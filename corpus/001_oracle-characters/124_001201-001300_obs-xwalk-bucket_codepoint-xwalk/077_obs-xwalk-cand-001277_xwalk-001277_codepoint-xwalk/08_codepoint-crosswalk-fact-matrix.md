# obs-xwalk-cand-001277 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+398A` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-1428` | not reading |
