# obs-unk-005609 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/073_undeciphered-005
  601-005700_obs-unk-bucket_oracle-character-candidates/009_obs-unk-005609_h
  ust-obc-und-X-005609_oracle-character-candidate/03_visual-assets/001_asset
  -007202_hust-obc-und-X-005609_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1165/X_？_8120_1.png`
- asset id: `asset-007202`
...
- source class: `HUST-OBC/undeciphered/X/1165/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1165/X_？_8120_1.png`
- asset id: `asset-007202`
...
- Which source records identify obs-unk-005609 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005609？
