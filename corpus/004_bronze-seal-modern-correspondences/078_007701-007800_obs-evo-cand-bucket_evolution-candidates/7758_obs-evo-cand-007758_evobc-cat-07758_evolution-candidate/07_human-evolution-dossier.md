...
- External category reference: `evobc-cat-07758`
- Source category ID: `07758`
- Source label for human review: `蛭`
- Source codepoints: `U+86ED`
...
- `obs-evo-cand-007758-route-category-staging`
...
- `obs-evo-cand-007758-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007758-route-evolution-graph`
