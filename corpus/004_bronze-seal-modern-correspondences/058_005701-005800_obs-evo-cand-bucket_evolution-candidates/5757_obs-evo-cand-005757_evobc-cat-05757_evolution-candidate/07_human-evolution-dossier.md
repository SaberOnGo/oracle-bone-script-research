...
- External category reference: `evobc-cat-05757`
- Source category ID: `05757`
- Source label for human review: `盞`
- Source codepoints: `U+76DE`
...
- `obs-evo-cand-005757-route-category-staging`
...
- `obs-evo-cand-005757-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005757-route-evolution-graph`
