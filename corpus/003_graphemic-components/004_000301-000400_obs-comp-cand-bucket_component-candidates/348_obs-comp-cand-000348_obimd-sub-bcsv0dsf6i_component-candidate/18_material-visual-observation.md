# Material Visual Observation / obs-comp-cand-000348 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000348`
- External reference / 外部参照: `obimd-sub-bcsv0dsf6i`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012272_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bcsv0dsf6i/bcsv0dsf6i/bcsv0dsf6i.png`
- Checksum / 校验和:
  `a3f98e5235ca0c7b765912cbfcf0f966878bf04753703d9a60ffd2b1352fe263`
...
- Marked-pixel bounds: (60,31)–(189,218); span 130 × 188 px; the marked
...
- 痕迹范围：(60,31)–(189,218)；跨度130 × 188 px；痕迹矩形高于宽。
