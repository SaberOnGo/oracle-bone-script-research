# Material Visual Observation / obs-comp-cand-001161 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001161`
- External reference / 外部参照: `obimd-sub-zk3pz24x5s`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015351_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zk3pz24x5s/zk3pz24x5s/zk3pz24x5s.png`
- Checksum / 校验和:
  `f2ebb806c9f0a34242cffd834068b0e57d58e68002f4e89ec4658851a2141ef8`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.77%.
- Marked-pixel bounds: (53,46)–(196,208); span 144 × 163 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.77%。
- 痕迹范围：(53,46)–(196,208)；跨度144 × 163 px；痕迹矩形近方形。
