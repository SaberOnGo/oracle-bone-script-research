...
- External category reference: `evobc-cat-11668`
- Source category ID: `11668`
- Source label for human review: `𤲝`
...
- `obs-evo-cand-011668-route-category-staging`
...
- `obs-evo-cand-011668-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011668-route-evolution-graph`
