# Material Visual Observation / obs-comp-cand-000489 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000489`
- External reference / 外部参照: `obimd-sub-3xbmgmm4j0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012725_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3xbmgmm4j0/3xbmgmm4j0/3xbmgmm4j0.png`
- Checksum / 校验和:
  `fbb44ad7bbeef2eb6137b83b402aec063add3337560fe03ba4bd32a28aae03dd`
...
- Marked-pixel bounds: (76,31)–(173,217); span 98 × 187 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.02%。
- 痕迹范围：(76,31)–(173,217)；跨度98 × 187 px；痕迹矩形高于宽。
