...
- External category reference: `evobc-cat-11156`
- Source category ID: `11156`
- Source label for human review: `𢉅`
...
- `obs-evo-cand-011156-route-category-staging`
...
- `obs-evo-cand-011156-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011156-route-evolution-graph`
