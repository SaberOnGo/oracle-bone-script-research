...
- Project ID: `obs-evo-cand-003173`
- EVOBC category candidate ID: `evobc-evo-cat-03173`
- External category reference: `evobc-cat-03173`
- Source category ID: `03173`
- Source label for human review: `懈`
- Source codepoints: `U+61C8`
...
- `obs-evo-cand-003173-route-category-staging`
...
- `obs-evo-cand-003173-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003173-route-evolution-graph`
