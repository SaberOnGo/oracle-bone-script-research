# Material Visual Observation / obs-comp-cand-001529 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001529`
- External reference / 外部参照: `obimd-sub-237k640lqx`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016943_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/237k640lqx/237k640lqx/237k640lqx.png`
- Checksum / 校验和:
  `a4b14a822bb7b681f2068f401cac59b7dd3c9c3729bc7c502923e33fd01d7fc4`
...
- Marked-pixel bounds: (86,20)–(171,227); span 86 × 208 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.44%。
- 痕迹范围：(86,20)–(171,227)；跨度86 × 208 px；痕迹矩形高于宽。
