...
- External category reference: `evobc-cat-07257`
- Source category ID: `07257`
- Source label for human review: `芬`
...
- `obs-evo-cand-007257-route-category-staging`
...
- `obs-evo-cand-007257-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007257-route-evolution-graph`
