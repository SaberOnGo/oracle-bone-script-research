...
- Project ID: `obs-evo-cand-013359`
- EVOBC category candidate ID: `evobc-evo-cat-13359`
- External category reference: `evobc-cat-13359`
- Source category ID: `13359`
- Source label for human review: `𬦘`
- Source codepoints: `U+2C998`
...
- `obs-evo-cand-013359-route-category-staging`
...
- `obs-evo-cand-013359-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013359-route-evolution-graph`
