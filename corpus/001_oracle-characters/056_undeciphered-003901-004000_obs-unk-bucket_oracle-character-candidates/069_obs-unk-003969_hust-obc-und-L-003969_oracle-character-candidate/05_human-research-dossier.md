# obs-unk-003969 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003969`
- primary external id: `hust-obc-und-L-003969`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/069_obs-unk-003969_h
  ust-obc-und-L-003969_oracle-character-candidate/03_visual-assets/001_asset
  -005562_hust-obc-und-L-003969_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3969/L_？_8385.jpg`
- asset id: `asset-005562`
...
- source class: `HUST-OBC/undeciphered/L/3969/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3969/L_？_8385.jpg`
- asset id: `asset-005562`
...
- English observation: Dense short upper traces feed a longer central stroke;
  curved and narrow marks extend at the lower sides.
- 中文观察：密集短上部痕迹连向较长中央痕迹，下部两侧有弧痕和窄痕延伸。
...
- Which source records identify obs-unk-003969 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003969？
