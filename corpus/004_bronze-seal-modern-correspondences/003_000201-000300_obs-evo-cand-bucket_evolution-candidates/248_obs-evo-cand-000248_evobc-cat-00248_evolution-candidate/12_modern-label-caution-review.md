# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000248
...
- EVOBC candidate category: `evobc-evo-cat-00248`.
- Source label for search only: `㽯`.
- Source codepoints for search only: `U+3F6F`.
