...
- Project ID: `obs-evo-cand-009112`
- EVOBC category candidate ID: `evobc-evo-cat-09112`
- External category reference: `evobc-cat-09112`
- Source category ID: `09112`
- Source label for human review: `邲`
- Source codepoints: `U+90B2`
...
- `obs-evo-cand-009112-route-category-staging`
...
- `obs-evo-cand-009112-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009112-route-evolution-graph`
