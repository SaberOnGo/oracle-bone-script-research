# obs-unk-004407 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004407`
- primary external id: `hust-obc-und-L-004407`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/007_obs-unk-004407_h
  ust-obc-und-L-004407_oracle-character-candidate/03_visual-assets/001_asset
  -006000_hust-obc-und-L-004407_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4407/L_？_9837.jpg`
- asset id: `asset-006000`
...
- source class: `HUST-OBC/undeciphered/L/4407/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4407/L_？_9837.jpg`
- asset id: `asset-006000`
...
- English observation: `A broad upper outline has side traces descending toward`
  `an open lower center.`
- 中文观察: `上部宽轮廓两侧有下伸痕迹，下部中央保持开放。`
...
- Which source records identify obs-unk-004407 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004407？
