# obs-unk-004004 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/004_obs-unk-004004_h
  ust-obc-und-L-004004_oracle-character-candidate/03_visual-assets/001_asset
  -005597_hust-obc-und-L-004004_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4004/L_？_8494.jpg`
- asset id: `asset-005597`
...
- source class: `HUST-OBC/undeciphered/L/4004/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4004/L_？_8494.jpg`
- asset id: `asset-005597`
...
- English observation: Two pointed upper traces rise above a rectangular lower
  enclosure; the lower edge is cropped.
- 中文观察：两条尖状上部痕迹位于矩形下部围合轮廓之上，下缘被裁切。
...
- Which source records identify obs-unk-004004 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004004？
