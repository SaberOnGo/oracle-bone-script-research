...
- Project ID: `obs-evo-cand-004192`
- EVOBC category candidate ID: `evobc-evo-cat-04192`
- External category reference: `evobc-cat-04192`
- Source category ID: `04192`
- Source label for human review: `榷`
- Source codepoints: `U+69B7`
...
- `obs-evo-cand-004192-route-category-staging`
...
- `obs-evo-cand-004192-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004192-route-evolution-graph`
