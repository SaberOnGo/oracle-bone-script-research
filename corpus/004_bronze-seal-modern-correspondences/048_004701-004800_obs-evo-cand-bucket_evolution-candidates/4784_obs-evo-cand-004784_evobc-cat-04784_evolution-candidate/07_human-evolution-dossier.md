...
- External category reference: `evobc-cat-04784`
- Source category ID: `04784`
- Source label for human review: `湒`
- Source codepoints: `U+6E52`
...
- `obs-evo-cand-004784-route-category-staging`
...
- `obs-evo-cand-004784-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004784-route-evolution-graph`
