...
- External category reference: `evobc-cat-01789`
- Source category ID: `01789`
- Source label: `圣`
...
- `obs-evo-cand-001789-route-category-staging`
...
- `obs-evo-cand-001789-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001789-route-evolution-graph`
