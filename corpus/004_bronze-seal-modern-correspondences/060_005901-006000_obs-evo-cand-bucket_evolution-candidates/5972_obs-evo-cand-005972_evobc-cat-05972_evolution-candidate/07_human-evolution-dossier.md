...
- Project ID: `obs-evo-cand-005972`
- EVOBC category candidate ID: `evobc-evo-cat-05972`
- External category reference: `evobc-cat-05972`
- Source category ID: `05972`
- Source label for human review: `祅`
- Source codepoints: `U+7945`
...
- `obs-evo-cand-005972-route-category-staging`
...
- `obs-evo-cand-005972-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005972-route-evolution-graph`
