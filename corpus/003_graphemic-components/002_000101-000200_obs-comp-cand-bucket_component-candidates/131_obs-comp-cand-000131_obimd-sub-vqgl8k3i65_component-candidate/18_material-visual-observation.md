# Material Visual Observation / obs-comp-cand-000131 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000131`
- External reference / 外部参照: `obimd-sub-vqgl8k3i65`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011543_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/yvbokzhzmz/vqgl8k3i65/vqgl8k3i65.png`
- Checksum / 校验和:
  `28e817557398ecf81e84221611dda87ca4cbfa5e43c787d0b99e3442c1369917`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.60%.
- Marked-pixel bounds: (74,45)–(175,204); span 102 × 160 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.60%。
- 痕迹范围：(74,45)–(175,204)；跨度102 × 160 px；痕迹矩形高于宽。
