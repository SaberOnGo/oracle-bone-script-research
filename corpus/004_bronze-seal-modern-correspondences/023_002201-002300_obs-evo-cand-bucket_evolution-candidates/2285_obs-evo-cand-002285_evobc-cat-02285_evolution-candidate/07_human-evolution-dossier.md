...
- External category reference: `evobc-cat-02285`
- Source category ID: `02285`
- Source label for human review: `嫺`
- Source codepoints: `U+5AFA`
...
- `obs-evo-cand-002285-route-category-staging`
...
- `obs-evo-cand-002285-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002285-route-evolution-graph`
