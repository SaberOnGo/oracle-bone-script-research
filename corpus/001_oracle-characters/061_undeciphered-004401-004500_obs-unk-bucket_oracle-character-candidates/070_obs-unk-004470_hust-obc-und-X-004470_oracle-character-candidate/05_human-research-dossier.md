# obs-unk-004470 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004470`
- primary external id: `hust-obc-und-X-004470`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/070_obs-unk-004470_h
  ust-obc-und-X-004470_oracle-character-candidate/03_visual-assets/001_asset
  -006063_hust-obc-und-X-004470_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/26/X_？_8204_1.png`
- asset id: `asset-006063`
...
- source class: `HUST-OBC/undeciphered/X/26/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/26/X_？_8204_1.png`
- asset id: `asset-006063`
...
- English observation: Two separated mark groups show a rounded opening,
  protrusions, and a small isolated lower dot.
- 中文观察: 两组分离痕迹有圆弧开口、侧突和下部孤立小点。
...
- Which source records identify obs-unk-004470 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004470？
