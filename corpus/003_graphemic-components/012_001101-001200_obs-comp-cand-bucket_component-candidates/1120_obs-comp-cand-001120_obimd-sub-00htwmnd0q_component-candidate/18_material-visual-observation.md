# Material Visual Observation / obs-comp-cand-001120 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001120`
- External reference / 外部参照: `obimd-sub-00htwmnd0q`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015061_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/krhtv9twvr/00htwmnd0q/00htwmnd0q.png`
- Checksum / 校验和:
  `eca98031dbc7523d5a811c51bb4389a81665eb130dfeabcd387fea963dfe617a`
...
- Marked-pixel bounds: (83,40)–(166,211); span 84 × 172 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.42%。
- 痕迹范围：(83,40)–(166,211)；跨度84 × 172 px；痕迹矩形高于宽。
