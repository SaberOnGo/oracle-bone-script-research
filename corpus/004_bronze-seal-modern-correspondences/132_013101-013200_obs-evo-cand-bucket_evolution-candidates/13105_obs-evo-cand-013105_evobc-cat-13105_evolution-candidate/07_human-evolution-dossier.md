...
- Project ID: `obs-evo-cand-013105`
- EVOBC category candidate ID: `evobc-evo-cat-13105`
- External category reference: `evobc-cat-13105`
- Source category ID: `13105`
- Source label for human review: `𫴏`
- Source codepoints: `U+2BD0F`
...
- `obs-evo-cand-013105-route-category-staging`
...
- `obs-evo-cand-013105-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013105-route-evolution-graph`
