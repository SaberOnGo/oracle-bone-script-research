# obs-char-001051 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1051_obs-char-001051_hust-obc-cat-1178_ora
  cle-character/03_visual-assets/001_asset-001056_hust-obc-cat-1178_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1178/H_1178_603BD_0.png`
- asset id: `asset-001056`
...
- source category: `1178`
- validation class: `1050`
- source image route: `HUST-OBC/deciphered/1178/H_1178_603BD_0.png`
- asset id: `asset-001056`
...
- English observation: `A large rounded lower enclosure supports a pointed
  upper outline, a central horizontal bar, and several lower branching
  strokes.`
...
- dataset label text: `㢐`
- dataset label codepoints: `U+3890`
...
- filename catalog route clues: `catalog-like filename clue: H_1178
  (H_1178_603BD_0.png)`
...
- Which source records identify obs-char-001051 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001051？
