# Material Visual Observation / obs-comp-cand-002141 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002141`
- External reference / 外部参照: `obimd-sub-ggx4xm03nr`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019729_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6ewkk2w7r1/ggx4xm03nr/ggx4xm03nr.png`
- Checksum / 校验和:
  `6ad5606afd953b47096d803d5d038da3ba33f5bfe541ea13301d78b832e60c5f`
...
- Marked-pixel bounds: (84,37)–(165,208); span 82 × 172 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.79%。
- 痕迹范围：(84,37)–(165,208)；跨度82 × 172 px；痕迹矩形高于宽。
