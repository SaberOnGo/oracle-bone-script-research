# Material Visual Observation / obs-comp-cand-001370 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001370`
- External reference / 外部参照: `obimd-sub-f5d3yn2so6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015789_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/f5d3yn2so6/f5d3yn2so6/f5d3yn2so6.png`
- Checksum / 校验和:
  `4475d747678a565079e58d01cde4c5e953a5ec51ad1023999d63588f8fe252a4`
...
- Marked-pixel bounds: (78,31)–(166,222); span 89 × 192 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.83%。
- 痕迹范围：(78,31)–(166,222)；跨度89 × 192 px；痕迹矩形高于宽。
