# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004586
...
- EVOBC candidate category: `evobc-evo-cat-04586`.
- Source label for search only: `泜`.
- Source codepoints for search only: `U+6CDC`.
