# obs-char-000517 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/517_obs-char-000517_hust-obc-cat-0590_orac
  le-character/03_visual-assets/001_asset-000522_hust-obc-cat-0590_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0590/G_0590_後2.35.7(甲).png`
- asset id: `asset-000522`
...
- source category: `0590`
- validation class: `516`
- source image route: `HUST-OBC/deciphered/0590/G_0590_後2.35.7(甲).png`
- asset id: `asset-000522`
...
- English observation: `A narrow angular upper loop continues into a long
  curved outer stroke, enclosing three detached short vertical marks at
  different heights.`
- 中文观察: `狭窄折角上环延续为长弯曲外笔，内部在不同高度有三条分离短竖痕。`
...
- dataset label text: `㙄`
- dataset label codepoints: `U+3644`
...
- Which source records identify obs-char-000517 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000517？
