...
- External category reference: `evobc-cat-08596`
- Source category ID: `08596`
- Source label for human review: `賹`
- Source codepoints: `U+8CF9`
...
- `obs-evo-cand-008596-route-category-staging`
...
- `obs-evo-cand-008596-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008596-route-evolution-graph`
