# Material Visual Observation / obs-comp-cand-000170 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000170`
- External reference / 外部参照: `obimd-sub-hed7mevt31`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011582_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hed7mevt31/hed7mevt31/hed7mevt31.png`
- Checksum / 校验和:
  `2e3d7e8509367f8bf7113d42c4725406b02e26670a4d2eefd2bfece4c17c3cdc`
...
- Marked-pixel bounds: (77,30)–(172,215); span 96 × 186 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.21%。
- 痕迹范围：(77,30)–(172,215)；跨度96 × 186 px；痕迹矩形高于宽。
