# obs-unk-004408 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004408`
- primary external id: `hust-obc-und-L-004408`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/008_obs-unk-004408_h
  ust-obc-und-L-004408_oracle-character-candidate/03_visual-assets/001_asset
  -006001_hust-obc-und-L-004408_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4408/L_？_9838.jpg`
- asset id: `asset-006001`
...
- source class: `HUST-OBC/undeciphered/L/4408/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4408/L_？_9838.jpg`
- asset id: `asset-006001`
...
- English observation: `A rounded vertical enclosure surrounds a central trace`
  `with a small pointed base.`
- 中文观察: `纵向圆弧包围中央痕迹，下部收窄为小尖底。`
...
- Which source records identify obs-unk-004408 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004408？
