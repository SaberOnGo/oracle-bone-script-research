...
- Project ID: `obs-evo-cand-011527`
- EVOBC category candidate ID: `evobc-evo-cat-11527`
- External category reference: `evobc-cat-11527`
- Source category ID: `11527`
- Source label for human review: `𣹐`
- Source codepoints: `U+23E50`
...
- `obs-evo-cand-011527-route-category-staging`
...
- `obs-evo-cand-011527-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011527-route-evolution-graph`
