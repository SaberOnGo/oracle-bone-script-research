...
Project ID: `obs-evo-cand-009914`
...
- Project ID: `obs-evo-cand-009914`
- EVOBC category candidate ID: `evobc-evo-cat-09914`
- External category reference: `evobc-cat-09914`
- Source category ID: `09914`
- Source label for human review: `鞖`
- Source codepoints: `U+9796`
...
- `obs-evo-cand-009914-route-category-staging`
...
- `obs-evo-cand-009914-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009914-route-evolution-graph`
