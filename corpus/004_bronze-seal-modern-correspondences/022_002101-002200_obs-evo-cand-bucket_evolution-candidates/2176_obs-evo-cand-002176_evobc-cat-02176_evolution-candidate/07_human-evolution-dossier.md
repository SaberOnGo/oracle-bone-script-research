...
- External category reference: `evobc-cat-02176`
- Source category ID: `02176`
- Source label: `娥`
...
- `obs-evo-cand-002176-route-category-staging`
...
- `obs-evo-cand-002176-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-002176-route-evolution-graph`
