...
Project ID: `obs-evo-cand-012520`
...
- Project ID: `obs-evo-cand-012520`
- EVOBC category candidate ID: `evobc-evo-cat-12520`
- External category reference: `evobc-cat-12520`
- Source category ID: `12520`
- Source label for human review: `𨹝`
- Source codepoints: `U+28E5D`
...
- `obs-evo-cand-012520-route-category-staging`
...
- `obs-evo-cand-012520-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012520-route-evolution-graph`
