...
- External category reference: `evobc-cat-07749`
- Source category ID: `07749`
- Source label for human review: `蛙`
- Source codepoints: `U+86D9`
...
- `obs-evo-cand-007749-route-category-staging`
...
- `obs-evo-cand-007749-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007749-route-evolution-graph`
