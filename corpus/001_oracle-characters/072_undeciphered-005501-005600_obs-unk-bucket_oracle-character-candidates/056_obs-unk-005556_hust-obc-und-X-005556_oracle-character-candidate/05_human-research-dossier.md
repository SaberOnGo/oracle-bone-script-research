# obs-unk-005556 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005556`
- primary external id: `hust-obc-und-X-005556`
...
- local review image route: `corpus/001_oracle-characters/072_undeciphered-005
  501-005600_obs-unk-bucket_oracle-character-candidates/056_obs-unk-005556_h
  ust-obc-und-X-005556_oracle-character-candidate/03_visual-assets/001_asset
  -007149_hust-obc-und-X-005556_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1112/X_？_8070_1.png`
- asset id: `asset-007149`
...
- source class: `HUST-OBC/undeciphered/X/1112/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1112/X_？_8070_1.png`
- asset id: `asset-007149`
...
- Which source records identify obs-unk-005556 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005556？
