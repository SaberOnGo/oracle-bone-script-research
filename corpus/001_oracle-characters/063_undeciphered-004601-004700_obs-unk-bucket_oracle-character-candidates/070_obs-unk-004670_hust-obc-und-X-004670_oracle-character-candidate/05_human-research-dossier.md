# obs-unk-004670 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/070_obs-unk-004670_h
  ust-obc-und-X-004670_oracle-character-candidate/03_visual-assets/001_asset
  -006263_hust-obc-und-X-004670_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/226/X_？_8395_1.png`
- asset id: `asset-006263`
...
- source class: `HUST-OBC/undeciphered/X/226/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/226/X_？_8395_1.png`
- asset id: `asset-006263`
...
- English observation: `three stacked bars with lower U-like curve`
- 中文观察: `三条叠置横笔画与下部 U 状弧线`
...
- Which source records identify obs-unk-004670 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004670？
