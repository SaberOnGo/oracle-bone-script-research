...
- External category reference: `evobc-cat-01413`
- Source category ID: `01413`
...
- `obs-evo-cand-001413-route-category-staging`
...
- `obs-evo-cand-001413-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001413-route-evolution-graph`
