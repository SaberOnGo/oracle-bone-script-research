...
- External category reference: `evobc-cat-00834`
- Source category ID: `00834`
- Source label for human review: `侄`
...
- `obs-evo-cand-000834-route-category-staging`
...
- `obs-evo-cand-000834-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000834-route-evolution-graph`
