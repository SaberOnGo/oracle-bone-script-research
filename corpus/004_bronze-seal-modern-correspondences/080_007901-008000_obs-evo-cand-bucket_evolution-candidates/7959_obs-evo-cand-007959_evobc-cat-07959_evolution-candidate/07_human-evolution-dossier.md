...
- External category reference: `evobc-cat-07959`
- Source category ID: `07959`
- Source label for human review: `袮`
- Source codepoints: `U+88AE`
...
- `obs-evo-cand-007959-route-category-staging`
...
- `obs-evo-cand-007959-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007959-route-evolution-graph`
