...
- External category reference: `evobc-cat-01757`
- Source category ID: `01757`
- Source label for human review: `囟`
- Source codepoints: `U+56DF`
...
- `obs-evo-cand-001757-route-category-staging`
...
- `obs-evo-cand-001757-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001757-route-evolution-graph`
