# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010343
...
- EVOBC candidate category: `evobc-evo-cat-10343`.
- Source label for search only: `鬯`.
- Source codepoints for search only: `U+9B2F`.
