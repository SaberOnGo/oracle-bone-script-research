...
Project ID: `obs-evo-cand-012504`
...
- Project ID: `obs-evo-cand-012504`
- EVOBC category candidate ID: `evobc-evo-cat-12504`
- External category reference: `evobc-cat-12504`
- Source category ID: `12504`
- Source label for human review: `𨳪`
- Source codepoints: `U+28CEA`
...
- `obs-evo-cand-012504-route-category-staging`
...
- `obs-evo-cand-012504-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012504-route-evolution-graph`
