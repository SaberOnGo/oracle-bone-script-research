# obs-unk-002735 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002735`
- primary external id: `hust-obc-und-L-002735`
...
- local review image route: `corpus/001_oracle-characters/044_undeciphered-002
  701-002800_obs-unk-bucket_oracle-character-candidates/035_obs-unk-002735_h
  ust-obc-und-L-002735_oracle-character-candidate/03_visual-assets/001_asset
  -004328_hust-obc-und-L-002735_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2735/L_？_4421.jpg`
- asset id: `asset-004328`
...
- source class: `HUST-OBC/undeciphered/L/2735/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2735/L_？_4421.jpg`
- asset id: `asset-004328`
...
- Which source records identify obs-unk-002735 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002735？
