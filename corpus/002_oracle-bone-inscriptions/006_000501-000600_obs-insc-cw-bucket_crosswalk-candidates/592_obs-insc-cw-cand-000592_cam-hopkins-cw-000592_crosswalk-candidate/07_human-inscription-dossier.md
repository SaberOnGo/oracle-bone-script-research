...
Project ID: `obs-insc-cw-cand-000592`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000592`
...
- Yingguo / 英国所藏: `y2641` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `610` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `517` in source row; primary catalog entry pending
- Heji / 合集: `41953` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000592`
