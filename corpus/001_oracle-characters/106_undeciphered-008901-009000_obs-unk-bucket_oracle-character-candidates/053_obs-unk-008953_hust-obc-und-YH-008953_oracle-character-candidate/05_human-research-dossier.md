# obs-unk-008953 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008953`
- primary external id: `hust-obc-und-YH-008953`
...
- local review image route: `corpus/001_oracle-characters/106_undeciphered-008
  901-009000_obs-unk-bucket_oracle-character-candidates/053_obs-unk-008953_h
  ust-obc-und-YH-008953_oracle-character-candidate/03_visual-assets/001_asse
  t-010544_hust-obc-und-YH-008953_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60FAE/Y_？_60FAE.jpg`
- asset id: `asset-010544`
...
- source class: `HUST-OBC/undeciphered/Y+H/60FAE/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60FAE/Y_？_60FAE.jpg`
- asset id: `asset-010544`
...
- Which source records identify obs-unk-008953 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008953？
