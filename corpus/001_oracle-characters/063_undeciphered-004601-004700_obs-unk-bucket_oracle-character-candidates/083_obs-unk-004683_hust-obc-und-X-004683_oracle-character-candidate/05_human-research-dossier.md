# obs-unk-004683 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/083_obs-unk-004683_h
  ust-obc-und-X-004683_oracle-character-candidate/03_visual-assets/001_asset
  -006276_hust-obc-und-X-004683_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/239/X_？_8407_1.png`
- asset id: `asset-006276`
...
- source class: `HUST-OBC/undeciphered/X/239/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/239/X_？_8407_1.png`
- asset id: `asset-006276`
...
- English observation: `upper crossing with openings and lower branch`
- 中文观察: `带开口和下部分支的上部交叉笔画`
...
- Which source records identify obs-unk-004683 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004683？
