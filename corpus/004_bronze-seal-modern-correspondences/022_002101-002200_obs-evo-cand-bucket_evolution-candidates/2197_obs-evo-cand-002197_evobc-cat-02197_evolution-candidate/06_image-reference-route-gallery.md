...
- `obs-evo-cand-002197-route-category-staging`
...
- `obs-evo-cand-002197-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002197-route-evolution-graph`
