...
Project ID: `obs-evo-cand-007839`
...
- Project ID: `obs-evo-cand-007839`
- EVOBC category candidate ID: `evobc-evo-cat-07839`
- External category reference: `evobc-cat-07839`
- Source category ID: `07839`
- Source label for human review: `螹`
- Source codepoints: `U+87B9`
...
- `obs-evo-cand-007839-route-category-staging`
...
- `obs-evo-cand-007839-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007839-route-evolution-graph`
