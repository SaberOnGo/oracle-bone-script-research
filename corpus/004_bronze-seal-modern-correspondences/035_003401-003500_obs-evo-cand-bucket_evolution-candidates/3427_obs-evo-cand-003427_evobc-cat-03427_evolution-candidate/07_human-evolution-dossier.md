...
Project ID: `obs-evo-cand-003427`
...
- Project ID: `obs-evo-cand-003427`
- EVOBC category candidate ID: `evobc-evo-cat-03427`
- External category reference: `evobc-cat-03427`
- Source category ID: `03427`
- Source label for human review: `揗`
- Source codepoints: `U+63D7`
...
- `obs-evo-cand-003427-route-category-staging`
...
- `obs-evo-cand-003427-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003427-route-evolution-graph`
