...
- External category reference: `evobc-cat-12690`
- Source category ID: `12690`
- Source label for human review: `𩱫`
- Source codepoints: `U+29C6B`
...
- `obs-evo-cand-012690-route-category-staging`
...
- `obs-evo-cand-012690-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012690-route-evolution-graph`
