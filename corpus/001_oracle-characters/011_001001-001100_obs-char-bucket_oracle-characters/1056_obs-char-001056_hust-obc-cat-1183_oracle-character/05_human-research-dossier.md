# obs-char-001056 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1056_obs-char-001056_hust-obc-cat-1183_ora
  cle-character/03_visual-assets/001_asset-001061_hust-obc-cat-1183_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1183/G_1183_前4.17.5(甲).png`
- asset id: `asset-001061`
...
- source category: `1183`
- validation class: `1055`
- source image route: `HUST-OBC/deciphered/1183/G_1183_前4.17.5(甲).png`
- asset id: `asset-001061`
...
- English observation: `A compact form has a pointed upper outline, a dark
  horizontal central band with interior marks, and two lower forked
  strokes.`
...
- dataset label text: `㢕`
- dataset label codepoints: `U+3895`
...
- Which source records identify obs-char-001056 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001056？
