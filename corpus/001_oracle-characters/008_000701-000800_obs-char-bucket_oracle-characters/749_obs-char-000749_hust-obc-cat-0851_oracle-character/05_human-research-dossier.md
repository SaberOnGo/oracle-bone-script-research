# obs-char-000749 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/749_obs-char-000749_hust-obc-cat-0851_orac
  le-character/03_visual-assets/001_asset-000754_hust-obc-cat-0851_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0851/H_0851_604AD_0.png`
- asset id: `asset-000754`
...
- source category: `0851`
- validation class: `748`
- source image route: `HUST-OBC/deciphered/0851/H_0851_604AD_0.png`
- asset id: `asset-000754`
...
- English observation: `A large upper oval loop contains a short vertical
  mark and joins a central junction with two side branches; long lower
  strokes descend straight at left and curve at right.`
...
- dataset label text: `㝉`
- dataset label codepoints: `U+3749`
...
- filename catalog route clues: `catalog-like filename clue: H_0851
  (H_0851_604AD_0.png)`
...
- Which source records identify obs-char-000749 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000749？
