# Material Visual Observation / obs-comp-cand-001108 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001108`
- External reference / 外部参照: `obimd-sub-a8yk8tkxc4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015049_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/a8yk8tkxc4/a8yk8tkxc4/a8yk8tkxc4.png`
- Checksum / 校验和:
  `6abe6b684e566206435d6e1ae692e04b63a573c79a11a3d9e8d3c163aab4c0d3`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.27%.
- Marked-pixel bounds: (89,24)–(178,227); span 90 × 204 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.27%。
- 痕迹范围：(89,24)–(178,227)；跨度90 × 204 px；痕迹矩形高于宽。
