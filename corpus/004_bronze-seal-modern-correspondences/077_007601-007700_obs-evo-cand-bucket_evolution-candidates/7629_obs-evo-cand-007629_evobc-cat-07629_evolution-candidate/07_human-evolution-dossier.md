...
- External category reference: `evobc-cat-07629`
- Source category ID: `07629`
- Source label for human review: `薽`
- Source codepoints: `U+85BD`
...
- `obs-evo-cand-007629-route-category-staging`
...
- `obs-evo-cand-007629-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007629-route-evolution-graph`
