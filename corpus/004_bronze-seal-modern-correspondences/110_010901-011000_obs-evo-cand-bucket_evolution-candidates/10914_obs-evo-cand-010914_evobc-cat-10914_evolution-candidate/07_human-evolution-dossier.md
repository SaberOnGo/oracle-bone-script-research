...
- Project ID: `obs-evo-cand-010914`
- EVOBC category candidate ID: `evobc-evo-cat-10914`
- External category reference: `evobc-cat-10914`
- Source category ID: `10914`
- Source label for human review: `𠫩`
- Source codepoints: `U+20AE9`
...
- `obs-evo-cand-010914-route-category-staging`
...
- `obs-evo-cand-010914-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010914-route-evolution-graph`
