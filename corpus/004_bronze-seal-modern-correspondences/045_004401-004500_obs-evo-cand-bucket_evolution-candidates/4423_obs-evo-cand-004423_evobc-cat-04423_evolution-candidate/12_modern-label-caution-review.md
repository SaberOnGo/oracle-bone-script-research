# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004423
...
- EVOBC candidate category: `evobc-evo-cat-04423`.
- Source label for search only: `殯`.
- Source codepoints for search only: `U+6BAF`.
