# obs-char-000589 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000589`
- primary external id: `hust-obc-cat-0668`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/589_obs-char-000589_hust-obc-cat-0668_orac
  le-character/03_visual-assets/001_asset-000594_hust-obc-cat-0668_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0668/G_0668_京都2033合28953無名組.png
  `
- asset id: `asset-000594`
...
- source category: `0668`
- validation class: `588`
- source image route: `HUST-OBC/deciphered/0668/G_0668_京都2033合28953無名組.png`
- asset id: `asset-000594`
...
- English observation: `A tall central form has a small pointed upper loop
  and several forked side branches; two detached curved or angular marks
  stand to the left.`
...
- dataset label text: `㚒`
- dataset label codepoints: `U+3692`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/043_obs-evo-can
  d-000043_evobc-cat-00043_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/043_obs-evo-cand-000043_evobc-cat-00043_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合28953
...
- Which source records identify obs-char-000589 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000589？
