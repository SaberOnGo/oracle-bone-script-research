...
- External category reference: `evobc-cat-09810`
- Source category ID: `09810`
- Source label for human review: `雊`
...
- `obs-evo-cand-009810-route-category-staging`
...
- `obs-evo-cand-009810-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009810-route-evolution-graph`
