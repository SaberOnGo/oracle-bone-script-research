...
Project ID: `obs-insc-cw-cand-000471`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000471`
...
- Source page section: `Period III Group 18` /
  `第 III 期第 18 组`
- Source section key: `period-iii-group-18`
...
- Yingguo / 英国所藏: `y2375` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `297` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `186` in source row; primary catalog entry pending
...
- Group and batch / 组类与批次: group `18`; batch or pit context pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000471`
