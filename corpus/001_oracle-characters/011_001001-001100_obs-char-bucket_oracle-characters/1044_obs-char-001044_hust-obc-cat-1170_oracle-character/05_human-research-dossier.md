# obs-char-001044 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001044`
- primary external id: `hust-obc-cat-1170`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1044_obs-char-001044_hust-obc-cat-1170_ora
  cle-character/03_visual-assets/001_asset-001049_hust-obc-cat-1170_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1170/G_1170_甲骨文0.png`
- asset id: `asset-001049`
...
- source category: `1170`
- validation class: `1043`
- source image route: `HUST-OBC/deciphered/1170/G_1170_甲骨文0.png`
- asset id: `asset-001049`
...
- English observation: `Two dense upright marks are visible: a left vertical
  cluster with short cross-strokes and a right curved branching cluster.`
- 中文观察: `可见两个密集直立笔形：左侧为带短横笔的竖向笔群，右侧为弯曲分枝笔群。`
...
- dataset label text: `㢈`
- dataset label codepoints: `U+3888`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00098`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00098`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00098`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/098_obs-evo-can
  d-000098_evobc-cat-00098_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/098_obs-evo-cand-000098_evobc-cat-00098_evolu
...
- Which source records identify obs-char-001044 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001044？
