# Material Visual Observation / obs-comp-cand-000882 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000882`
- External reference / 外部参照: `obimd-sub-csu2xt8lpm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013954_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/o6m37o3l7o/csu2xt8lpm/csu2xt8lpm.png`
- Checksum / 校验和:
  `17ab2f5cba08981431753638a13f86ac6b34dff399cd74298bfd357d39d97497`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.69%.
- Marked-pixel bounds: (36,35)–(216,222); span 181 × 188 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.69%。
- 痕迹范围：(36,35)–(216,222)；跨度181 × 188 px；痕迹矩形近方形。
