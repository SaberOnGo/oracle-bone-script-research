...
- External category reference: `evobc-cat-06424`
- Source category ID: `06424`
- Source label for human review: `糖`
- Source codepoints: `U+7CD6`
...
- `obs-evo-cand-006424-route-category-staging`
...
- `obs-evo-cand-006424-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006424-route-evolution-graph`
