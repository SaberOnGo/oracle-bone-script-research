# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006483
...
- EVOBC candidate category: `evobc-evo-cat-06483`.
- Source label for search only: `紺`.
- Source codepoints for search only: `U+7D3A`.
