...
- `obs-evo-cand-011250-route-category-staging`
...
- `obs-evo-cand-011250-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011250-route-evolution-graph`
