# Material Visual Observation / obs-comp-cand-001838 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001838`
- External reference / 外部参照: `obimd-sub-c0faqbhtbr`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018199_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lp8x647qo2/c0faqbhtbr/c0faqbhtbr.png`
- Checksum / 校验和:
  `e8827ba716014b2c1c6f7be89bcb09bbea4d3cf889217e6ca7c2b0f9c293b5b8`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.21%.
- Marked-pixel bounds: (66,62)–(193,203); span 128 × 142 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.21%。
- 痕迹范围：(66,62)–(193,203)；跨度128 × 142 px；痕迹矩形近方形。
