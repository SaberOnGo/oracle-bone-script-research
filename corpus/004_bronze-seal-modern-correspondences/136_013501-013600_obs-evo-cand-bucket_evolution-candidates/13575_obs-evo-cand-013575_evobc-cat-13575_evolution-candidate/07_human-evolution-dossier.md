...
Project ID: `obs-evo-cand-013575`
...
- Project ID: `obs-evo-cand-013575`
- EVOBC category candidate ID: `evobc-evo-cat-13575`
- External category reference: `evobc-cat-13575`
- Source category ID: `13575`
- Source label for human review: `𭶞`
- Source codepoints: `U+2DD9E`
...
- `obs-evo-cand-013575-route-category-staging`
...
- `obs-evo-cand-013575-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013575-route-evolution-graph`
