...
- External category reference: `evobc-cat-13486`
- Source category ID: `13486`
...
- `obs-evo-cand-013486-route-category-staging`
...
- `obs-evo-cand-013486-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013486-route-evolution-graph`
