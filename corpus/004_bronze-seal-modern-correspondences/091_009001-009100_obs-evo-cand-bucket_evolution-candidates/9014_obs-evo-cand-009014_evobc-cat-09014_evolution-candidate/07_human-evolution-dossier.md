...
- External category reference: `evobc-cat-09014`
- Source category ID: `09014`
- Source label for human review: `逵`
...
- `obs-evo-cand-009014-route-category-staging`
...
- `obs-evo-cand-009014-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009014-route-evolution-graph`
