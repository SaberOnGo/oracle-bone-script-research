...
- Project ID: `obs-evo-cand-012512`
- EVOBC category candidate ID: `evobc-evo-cat-12512`
- External category reference: `evobc-cat-12512`
- Source category ID: `12512`
- Source label for human review: `𨷻`
- Source codepoints: `U+28DFB`
...
- `obs-evo-cand-012512-route-category-staging`
...
- `obs-evo-cand-012512-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012512-route-evolution-graph`
