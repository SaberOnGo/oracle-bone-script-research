# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002235
...
- EVOBC candidate category: `evobc-evo-cat-02235`.
- Source label for search only: `媟`.
- Source codepoints for search only: `U+5A9F`.
