# Material Visual Observation / obs-comp-cand-002644 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002644`
- External reference / 外部参照: `obimd-sub-gfha154t8w`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021193_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gfha154t8w/gfha154t8w/gfha154t8w.png`
- Checksum / 校验和:
  `3f70cc0bc87629263a2f3f61bb938ab3f2beaa07002e5b1ff56b99872562c8db`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.62%.
- Marked-pixel bounds: (93,21)–(159,226); span 67 × 206 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.62%。
- 痕迹范围：(93,21)–(159,226)；跨度67 × 206 px；痕迹矩形高于宽。
