# Archaeological Context Review / 考古语境复核: coll-obj-cand-00017
...
| Catalog or accession | `R044643`; joined label needs independent catalog check | `02_collection-source-index.csv`; `18_live-source-evidence-review.md` |
| Source item | `779` | `01_collection-object-packet.json` |
| Catalog description | `I 4718` | `01_collection-object-packet.json` |
...
| Findspot or provenience | source-reported Pit YH127 and Anyang; independent check pending | `08_collection-provenance-evidence-dossier.md` |
...
- candidate_collection_object_id: `ihp-mus-obj-00017`
