...
Project ID: `obs-evo-cand-001206`
...
- Project ID: `obs-evo-cand-001206`
- EVOBC category candidate ID: `evobc-evo-cat-01206`
- External category reference: `evobc-cat-01206`
- Source category ID: `01206`
- Source label for human review: `刳`
- Source codepoints: `U+5233`
...
- `obs-evo-cand-001206-route-category-staging`
...
- `obs-evo-cand-001206-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001206-route-evolution-graph`
