...
- External category reference: `evobc-cat-13252`
- Source category ID: `13252`
- Source label for human review: `𬏪`
...
- `obs-evo-cand-013252-route-category-staging`
...
- `obs-evo-cand-013252-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013252-route-evolution-graph`
