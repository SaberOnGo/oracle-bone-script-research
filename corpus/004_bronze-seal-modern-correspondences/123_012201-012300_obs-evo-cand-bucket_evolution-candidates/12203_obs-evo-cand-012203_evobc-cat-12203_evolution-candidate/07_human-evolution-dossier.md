...
Project ID: `obs-evo-cand-012203`
...
- Project ID: `obs-evo-cand-012203`
- EVOBC category candidate ID: `evobc-evo-cat-12203`
- External category reference: `evobc-cat-12203`
- Source category ID: `12203`
- Source label for human review: `𧟃`
- Source codepoints: `U+277C3`
- Image reference count in source metadata: `29`
...
- `obs-evo-cand-012203-route-category-staging`
...
- `obs-evo-cand-012203-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012203-route-evolution-graph`
