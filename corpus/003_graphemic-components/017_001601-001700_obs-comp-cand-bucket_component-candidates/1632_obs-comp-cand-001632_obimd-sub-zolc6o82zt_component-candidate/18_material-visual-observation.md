# Material Visual Observation / obs-comp-cand-001632 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001632`
- External reference / 外部参照: `obimd-sub-zolc6o82zt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017308_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zolc6o82zt/zolc6o82zt/zolc6o82zt.png`
- Checksum / 校验和:
  `57617352a02254e014eab98828fdcb2005262ef20b018305670784305ea71611`
...
- Marked-pixel bounds: (77,39)–(172,205); span 96 × 167 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.32%。
- 痕迹范围：(77,39)–(172,205)；跨度96 × 167 px；痕迹矩形高于宽。
