# Material Visual Observation / obs-comp-cand-001111 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001111`
- External reference / 外部参照: `obimd-sub-ketncivolx`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015052_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ketncivolx/ketncivolx/ketncivolx.png`
- Checksum / 校验和:
  `1b76ff9f824fe07eed61c12b078f55fef60d20c5cfd7bfad2810cca723a003cb`
...
- Marked-pixel bounds: (90,26)–(176,220); span 87 × 195 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.28%。
- 痕迹范围：(90,26)–(176,220)；跨度87 × 195 px；痕迹矩形高于宽。
