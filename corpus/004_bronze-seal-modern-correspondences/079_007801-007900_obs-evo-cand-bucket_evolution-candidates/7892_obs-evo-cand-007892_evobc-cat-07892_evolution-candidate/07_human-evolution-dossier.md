...
Project ID: `obs-evo-cand-007892`
...
- Project ID: `obs-evo-cand-007892`
- EVOBC category candidate ID: `evobc-evo-cat-07892`
- External category reference: `evobc-cat-07892`
- Source category ID: `07892`
- Source label for human review: `蠹`
- Source codepoints: `U+8839`
...
- `obs-evo-cand-007892-route-category-staging`
...
- `obs-evo-cand-007892-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007892-route-evolution-graph`
