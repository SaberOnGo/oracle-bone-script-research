...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0847`
...
- Source image / 来源图: `H_0847_60A9A_0.png`
- Image / 图像: `001_asset-000750_hust-obc-cat-0847_glyph.png`
...
- target node: `evobc-evo-cat-00066`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC image references / EvoBC 图像引用数: `55`
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/066_obs-evo-cand-000066_evobc-cat-00066_evoluti
...
- Source label text / 来源标签文字: `㝅`
- Source label codepoint / 来源标签 codepoint: `U+3745`
