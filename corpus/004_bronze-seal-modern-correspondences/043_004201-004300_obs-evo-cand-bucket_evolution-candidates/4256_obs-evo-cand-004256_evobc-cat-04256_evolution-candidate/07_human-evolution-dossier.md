...
- Project ID: `obs-evo-cand-004256`
- EVOBC category candidate ID: `evobc-evo-cat-04256`
- External category reference: `evobc-cat-04256`
- Source category ID: `04256`
- Source label for human review: `樻`
- Source codepoints: `U+6A3B`
...
- `obs-evo-cand-004256-route-category-staging`
...
- `obs-evo-cand-004256-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004256-route-evolution-graph`
