# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008388
...
- EVOBC candidate category: `evobc-evo-cat-08388`.
- Source label for search only: `讋`.
- Source codepoints for search only: `U+8B8B`.
