...
- External category reference: `evobc-cat-01645`
- Source category ID: `01645`
- Source label for human review: `喔`
- Source codepoints: `U+5594`
...
- `obs-evo-cand-001645-route-category-staging`
...
- `obs-evo-cand-001645-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001645-route-evolution-graph`
