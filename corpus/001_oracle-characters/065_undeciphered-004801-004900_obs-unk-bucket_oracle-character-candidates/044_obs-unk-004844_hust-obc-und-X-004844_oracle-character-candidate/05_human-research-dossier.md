# obs-unk-004844 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/044_obs-unk-004844_h
  ust-obc-und-X-004844_oracle-character-candidate/03_visual-assets/001_asset
  -006437_hust-obc-und-X-004844_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/400/X_？_7386_1.png`
- asset id: `asset-006437`
...
- source class: `HUST-OBC/undeciphered/X/400/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/400/X_？_7386_1.png`
- asset id: `asset-006437`
...
- English observation: `separated upper and lower outlines with openings`
- 中文观察: `带开口的分离上下围合结构`
...
- Which source records identify obs-unk-004844 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004844？
