...
- External category reference: `evobc-cat-12310`
- Source category ID: `12310`
- Source label for human review: `𧾩`
- Source codepoints: `U+27FA9`
...
- `obs-evo-cand-012310-route-category-staging`
...
- `obs-evo-cand-012310-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012310-route-evolution-graph`
