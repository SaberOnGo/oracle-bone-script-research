# Material Visual Observation / obs-comp-cand-001790 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001790`
- External reference / 外部参照: `obimd-sub-fcooblbqyz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018011_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fcooblbqyz/fcooblbqyz/fcooblbqyz.png`
- Checksum / 校验和:
  `1c6e22fb5980821e73140f9602e70f98ff28e6b4d4f225ddf2046a0227677bd1`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.31%.
- Marked-pixel bounds: (78,19)–(171,224); span 94 × 206 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.31%。
- 痕迹范围：(78,19)–(171,224)；跨度94 × 206 px；痕迹矩形高于宽。
