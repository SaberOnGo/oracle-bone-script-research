...
- External category reference: `evobc-cat-00663`
- Source category ID: `00663`
- Source label for human review: `乔`
- Source codepoints: `U+4E54`
...
- `obs-evo-cand-000663-route-category-staging`
...
- `obs-evo-cand-000663-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000663-route-evolution-graph`
