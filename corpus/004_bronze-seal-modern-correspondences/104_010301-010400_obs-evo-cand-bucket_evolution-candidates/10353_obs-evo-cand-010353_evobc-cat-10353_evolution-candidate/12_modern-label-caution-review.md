# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010353
...
- EVOBC candidate category: `evobc-evo-cat-10353`.
- Source label for search only: `鬻`.
- Source codepoints for search only: `U+9B3B`.
