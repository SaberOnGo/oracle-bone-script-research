...
- External category reference: `evobc-cat-13451`
- Source category ID: `13451`
- Source label for human review: `𬹚`
- Source codepoints: `U+2CE5A`
...
- `obs-evo-cand-013451-route-category-staging`
...
- `obs-evo-cand-013451-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013451-route-evolution-graph`
