...
- `obs-evo-cand-007334-route-category-staging`
...
- `obs-evo-cand-007334-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007334-route-evolution-graph`
