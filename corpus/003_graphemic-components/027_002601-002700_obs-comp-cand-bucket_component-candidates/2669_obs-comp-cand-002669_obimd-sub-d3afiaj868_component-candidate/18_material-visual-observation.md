# Material Visual Observation / obs-comp-cand-002669 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002669`
- External reference / 外部参照: `obimd-sub-d3afiaj868`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021245_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/d3afiaj868/d3afiaj868/d3afiaj868.png`
- Checksum / 校验和:
  `debacbc9f5e45c5949908dd39f07238451b97d3bb9ed30438e84b72d226d32ff`
...
- Marked-pixel bounds: (94,17)–(163,233); span 70 × 217 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.63%。
- 痕迹范围：(94,17)–(163,233)；跨度70 × 217 px；痕迹矩形高于宽。
