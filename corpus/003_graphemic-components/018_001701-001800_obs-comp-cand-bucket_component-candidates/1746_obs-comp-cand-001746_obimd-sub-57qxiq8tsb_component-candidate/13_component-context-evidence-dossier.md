# obs-comp-cand-001746 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001746`
- 首选外部 ID: `obimd-sub-57qxiq8tsb`
- OBIMD subcharacter UID: `57qxiq8tsb`
- OBIMD main character UID: `57qxiq8tsb`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `7`
- codepoint 示例: U+FA1B8; U+FA1B9; 另有 5 项
