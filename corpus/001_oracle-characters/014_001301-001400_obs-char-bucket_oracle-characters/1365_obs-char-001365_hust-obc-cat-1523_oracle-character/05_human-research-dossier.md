# obs-char-001365 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001365`
- primary external id: `hust-obc-cat-1523`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1365_obs-char-001365_hust-obc-cat-1523_ora
  cle-character/03_visual-assets/001_asset-001370_hust-obc-cat-1523_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1523/G_1523_屯2273(甲).png`
- asset id: `asset-001370`
...
- source category: `1523`
- validation class: `1364`
- source image route: `HUST-OBC/deciphered/1523/G_1523_屯2273(甲).png`
- asset id: `asset-001370`
...
- English observation: `A stacked form has a trapezoidal cap and several
  small rectangular cells.`
- 中文观察: `叠置形体有梯形上盖和数个小矩形格。`
...
- dataset label text: `㧩`
- dataset label codepoints: `U+39E9`
...
- Which source records identify obs-char-001365 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001365？
