# Material Visual Observation / obs-comp-cand-001390 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001390`
- External reference / 外部参照: `obimd-sub-ff8rp0nh6u`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015809_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ff8rp0nh6u/ff8rp0nh6u/ff8rp0nh6u.png`
- Checksum / 校验和:
  `5be72fa147e401c084cfac42eb416ae33971a39f39b0889f84f8c73ae75ba392`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.82%.
- Marked-pixel bounds: (60,34)–(197,215); span 138 × 182 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.82%。
- 痕迹范围：(60,34)–(197,215)；跨度138 × 182 px；痕迹矩形高于宽。
