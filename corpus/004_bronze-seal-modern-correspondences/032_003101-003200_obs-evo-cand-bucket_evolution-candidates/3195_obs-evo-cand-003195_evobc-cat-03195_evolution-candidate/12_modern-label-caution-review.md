# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003195
...
- EVOBC candidate category: `evobc-evo-cat-03195`.
- Source label for search only: `懿`.
- Source codepoints for search only: `U+61FF`.
