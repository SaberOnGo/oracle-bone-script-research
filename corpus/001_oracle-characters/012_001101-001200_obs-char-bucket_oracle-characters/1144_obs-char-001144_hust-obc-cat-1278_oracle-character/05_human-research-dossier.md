# obs-char-001144 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001144`
- primary external id: `hust-obc-cat-1278`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1144_obs-char-001144_hust-obc-cat-1278_ora
  cle-character/03_visual-assets/001_asset-001149_hust-obc-cat-1278_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1278/G_1278_後2.38.8合34621歷組.png
  `
- asset id: `asset-001149`
...
- source category: `1278`
- validation class: `1143`
- source image route: `HUST-OBC/deciphered/1278/G_1278_後2.38.8合34621歷組.png`
- asset id: `asset-001149`
...
- English observation: `A broad shallow upper arc spans several long
  descending strokes, with a short outer stroke at the right.`
- 中文观察: `宽大的浅弧形上部横跨数条长下行笔，右侧有短外侧笔。`
...
- dataset label text: `㣴`
- dataset label codepoints: `U+38F4`
...
- filename catalog route clues: `Heji-like filename clue: 合34621
  (G_1278_後2.38.8合34621歷組.png)`
...
- Which source records identify obs-char-001144 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001144？
