# obs-unk-007780 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-007780`
- primary external id: `hust-obc-und-YH-007780`
...
- local review image route: `corpus/001_oracle-characters/094_undeciphered-007
  701-007800_obs-unk-bucket_oracle-character-candidates/080_obs-unk-007780_h
  ust-obc-und-YH-007780_oracle-character-candidate/03_visual-assets/001_asse
  t-009371_hust-obc-und-YH-007780_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6033D/Y_？_6033D.jpg`
- asset id: `asset-009371`
...
- source class: `HUST-OBC/undeciphered/Y+H/6033D/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6033D/Y_？_6033D.jpg`
- asset id: `asset-009371`
...
- Which source records identify obs-unk-007780 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007780？
