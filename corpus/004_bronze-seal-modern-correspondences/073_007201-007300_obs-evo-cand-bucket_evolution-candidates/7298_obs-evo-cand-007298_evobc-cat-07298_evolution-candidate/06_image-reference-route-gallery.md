...
- `obs-evo-cand-007298-route-category-staging`
...
- `obs-evo-cand-007298-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007298-route-evolution-graph`
