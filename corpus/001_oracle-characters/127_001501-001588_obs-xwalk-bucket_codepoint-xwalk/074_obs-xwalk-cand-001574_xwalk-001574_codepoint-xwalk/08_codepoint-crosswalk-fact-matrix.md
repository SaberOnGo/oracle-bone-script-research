# obs-xwalk-cand-001574 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+3ADC` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-1766` | not reading |
