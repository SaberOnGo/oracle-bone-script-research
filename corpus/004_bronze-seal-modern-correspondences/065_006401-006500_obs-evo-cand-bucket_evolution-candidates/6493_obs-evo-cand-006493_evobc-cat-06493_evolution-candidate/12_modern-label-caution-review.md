# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006493
...
- EVOBC candidate category: `evobc-evo-cat-06493`.
- Source label for search only: `絆`.
- Source codepoints for search only: `U+7D46`.
