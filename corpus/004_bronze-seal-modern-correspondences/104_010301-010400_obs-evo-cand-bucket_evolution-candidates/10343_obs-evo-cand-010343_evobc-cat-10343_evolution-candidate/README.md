# obs-evo-cand-010343 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-010343`
- EVOBC category candidate ID: `evobc-evo-cat-10343`
- External category ref: `evobc-cat-10343`
- Source label: `鬯`
- Source codepoints: `U+9B2F`
- Image reference count: `160`
- Era token counts: `BI:40;CS:1;OBC:113;SAC:2;SS:2;WSC:2`
- Source token counts: `Book:90;Web:70`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 113 image references
