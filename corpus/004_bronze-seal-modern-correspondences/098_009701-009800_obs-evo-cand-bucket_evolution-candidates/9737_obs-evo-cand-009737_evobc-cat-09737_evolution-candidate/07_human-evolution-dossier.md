...
Project ID: `obs-evo-cand-009737`
...
- Project ID: `obs-evo-cand-009737`
- EVOBC category candidate ID: `evobc-evo-cat-09737`
- External category reference: `evobc-cat-09737`
- Source category ID: `09737`
- Source label for human review: `院`
- Source codepoints: `U+9662`
...
- `obs-evo-cand-009737-route-category-staging`
...
- `obs-evo-cand-009737-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009737-route-evolution-graph`
