...
- External category reference: `evobc-cat-08623`
- Source category ID: `08623`
- Source label for human review: `贪`
...
- `obs-evo-cand-008623-route-category-staging`
...
- `obs-evo-cand-008623-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008623-route-evolution-graph`
