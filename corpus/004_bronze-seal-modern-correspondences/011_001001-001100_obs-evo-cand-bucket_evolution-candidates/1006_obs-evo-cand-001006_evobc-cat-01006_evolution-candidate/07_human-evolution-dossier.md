...
- External category reference: `evobc-cat-01006`
- Source category ID: `01006`
- Source label for human review: `僉`
- Source codepoints: `U+50C9`
...
- `obs-evo-cand-001006-route-category-staging`
...
- `obs-evo-cand-001006-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001006-route-evolution-graph`
