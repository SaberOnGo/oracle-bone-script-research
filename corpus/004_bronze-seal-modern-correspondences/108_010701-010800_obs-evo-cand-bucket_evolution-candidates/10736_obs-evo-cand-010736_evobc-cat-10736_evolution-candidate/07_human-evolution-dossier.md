...
- External category reference: `evobc-cat-10736`
- Source category ID: `10736`
- Source label for human review: `齲`
- Source codepoints: `U+9F72`
...
- `obs-evo-cand-010736-route-category-staging`
...
- `obs-evo-cand-010736-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010736-route-evolution-graph`
