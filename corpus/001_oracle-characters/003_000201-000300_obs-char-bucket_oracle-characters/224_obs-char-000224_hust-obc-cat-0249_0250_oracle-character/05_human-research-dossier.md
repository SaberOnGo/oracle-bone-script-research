# obs-char-000224 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/224_obs-char-000224_hust-obc-cat-0249_0250
  _oracle-character/03_visual-assets/001_asset-000229_hust-obc-cat-0249_0250
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0249_0250/0249/G_0249_京津4046合27
  338何組.png`
- asset id: `asset-000229`
...
- source category: `0249_0250`
- validation class: `223`
- source image route: `HUST-OBC/deciphered/0249_0250/0249/G_0249_京津4046合27338何
  組.png`
- asset id: `asset-000229`
...
- English observation: `The image has three parallel curved descending
  strokes with short pointed projections near their lower ends.`
- 中文观察: `图像有三道相互平行的弯曲下行笔，下端附近带短尖状伸出笔。`
...
- dataset label text: `㓯㓰`
- dataset label codepoints: `U+34EF;U+34F0`
...
- filename catalog route clues: `Heji-like filename clue: 合27338
  (G_0249_京津4046合27338何組.png)`
...
- Which source records identify obs-char-000224 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000224？
