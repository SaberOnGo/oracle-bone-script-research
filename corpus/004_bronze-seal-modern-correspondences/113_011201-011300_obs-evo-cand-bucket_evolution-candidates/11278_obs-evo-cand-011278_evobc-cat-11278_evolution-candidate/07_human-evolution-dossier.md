...
- Project ID: `obs-evo-cand-011278`
- EVOBC category candidate ID: `evobc-evo-cat-11278`
- External category reference: `evobc-cat-11278`
- Source category ID: `11278`
- Source label for human review: `𢤲`
- Source codepoints: `U+22932`
...
- `obs-evo-cand-011278-route-category-staging`
...
- `obs-evo-cand-011278-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011278-route-evolution-graph`
