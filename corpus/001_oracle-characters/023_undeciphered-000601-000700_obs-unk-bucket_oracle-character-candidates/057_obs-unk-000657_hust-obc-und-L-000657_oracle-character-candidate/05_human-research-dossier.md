# obs-unk-000657 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/023_undeciphered-000
  601-000700_obs-unk-bucket_oracle-character-candidates/057_obs-unk-000657_h
  ust-obc-und-L-000657_oracle-character-candidate/03_visual-assets/001_asset
  -002250_hust-obc-und-L-000657_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/657/L_？_1197.jpg`
- asset id: `asset-002250`
...
- source class: `HUST-OBC/undeciphered/L/657/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/657/L_？_1197.jpg`
- asset id: `asset-002250`
...
- Which source records identify obs-unk-000657 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000657？
