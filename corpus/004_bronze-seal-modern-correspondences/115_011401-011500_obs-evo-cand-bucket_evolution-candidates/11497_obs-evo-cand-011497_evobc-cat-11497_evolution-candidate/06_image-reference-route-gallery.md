...
- `obs-evo-cand-011497-route-category-staging`
...
- `obs-evo-cand-011497-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011497-route-evolution-graph`
