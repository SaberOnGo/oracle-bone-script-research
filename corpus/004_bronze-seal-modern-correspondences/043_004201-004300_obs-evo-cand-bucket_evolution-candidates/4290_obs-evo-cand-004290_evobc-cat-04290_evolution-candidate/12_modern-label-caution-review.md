# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004290
...
- EVOBC candidate category: `evobc-evo-cat-04290`.
- Source label for search only: `檗`.
- Source codepoints for search only: `U+6A97`.
