...
- External category reference: `evobc-cat-00071`
- Source category ID: `00071`
- Source label for human review: `㝣`
- Source codepoints: `U+3763`
...
- `obs-evo-cand-000071-route-category-staging`
...
- `obs-evo-cand-000071-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000071-route-evolution-graph`
