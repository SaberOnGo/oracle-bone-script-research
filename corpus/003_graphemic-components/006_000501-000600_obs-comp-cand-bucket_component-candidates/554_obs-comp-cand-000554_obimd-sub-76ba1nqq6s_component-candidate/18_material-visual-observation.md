# Material Visual Observation / obs-comp-cand-000554 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000554`
- External reference / 外部参照: `obimd-sub-76ba1nqq6s`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012806_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/76ba1nqq6s/76ba1nqq6s/76ba1nqq6s.png`
- Checksum / 校验和:
  `0b6b42f837ae1e56e5d7c4ca7a231d930a7728d999b29a25801a913c88514f36`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.07%.
- Marked-pixel bounds: (83,15)–(166,234); span 84 × 220 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.07%。
- 痕迹范围：(83,15)–(166,234)；跨度84 × 220 px；痕迹矩形高于宽。
