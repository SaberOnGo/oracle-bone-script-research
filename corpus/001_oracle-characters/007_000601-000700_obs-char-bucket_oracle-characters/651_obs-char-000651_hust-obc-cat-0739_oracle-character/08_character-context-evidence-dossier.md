...
- Project ID / 项目 ID: `obs-char-000651`
- Primary external ID / 首选外部 ID: `hust-obc-cat-0739`
...
- Source image / 来源图: `H_0739_60C67_0.png`
- Image / 图像: `001_asset-000656_hust-obc-cat-0739_glyph.png`
...
- target node: `evobc-evo-cat-00055`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00055`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00055`
...
- Matched candidate folders / 匹配候选目录: `evobc-evo-cat-00055`
- Human review files / 人类复核文件:
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/055_obs-evo-cand-000055_evobc-cat-00055_evoluti
...
- Source label text / 来源标签文字: `㛙`
- Source label codepoint / 来源标签 codepoint: `U+36D9`
