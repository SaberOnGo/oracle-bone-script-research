# obs-char-001251 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1251_obs-char-001251_hust-obc-cat-1399_ora
  cle-character/03_visual-assets/001_asset-001256_hust-obc-cat-1399_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1399/X_1399_2729_1.png`
- asset id: `asset-001256`
...
- source category: `1399`
- validation class: `1250`
- source image route: `HUST-OBC/deciphered/1399/X_1399_2729_1.png`
- asset id: `asset-001256`
...
- English observation: `A large dark form has a broad curved upper bar, a
  central stem, and paired lower branches ending in a point.`
...
- dataset label text: `㥭`
- dataset label codepoints: `U+396D`
...
- Which source records identify obs-char-001251 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001251？
