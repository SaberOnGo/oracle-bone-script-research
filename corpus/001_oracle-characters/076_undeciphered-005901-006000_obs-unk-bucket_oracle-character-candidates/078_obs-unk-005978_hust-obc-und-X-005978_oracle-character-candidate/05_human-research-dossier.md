# obs-unk-005978 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005978`
- primary external id: `hust-obc-und-X-005978`
...
- local review image route: `corpus/001_oracle-characters/076_undeciphered-005
  901-006000_obs-unk-bucket_oracle-character-candidates/078_obs-unk-005978_h
  ust-obc-und-X-005978_oracle-character-candidate/03_visual-assets/001_asset
  -007570_hust-obc-und-X-005978_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1534/X_？_2948_1.png`
- asset id: `asset-007570`
...
- source class: `HUST-OBC/undeciphered/X/1534/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1534/X_？_2948_1.png`
- asset id: `asset-007570`
...
- Which source records identify obs-unk-005978 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005978？
