# Material Visual Observation / obs-comp-cand-002179 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002179`
- External reference / 外部参照: `obimd-sub-hk9f0607uj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019880_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hk9f0607uj/hk9f0607uj/hk9f0607uj.png`
- Checksum / 校验和:
  `3ddfe83ba672a5556bf7f92a537da934729b59f07f7db611542f4a3bc0a6cae6`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.92%.
- Marked-pixel bounds: (70,36)–(186,215); span 117 × 180 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.92%。
- 痕迹范围：(70,36)–(186,215)；跨度117 × 180 px；痕迹矩形高于宽。
