# Material Visual Observation / obs-comp-cand-001328 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001328`
- External reference / 外部参照: `obimd-sub-cpr9kqrk9x`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015665_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cpr9kqrk9x/cpr9kqrk9x/cpr9kqrk9x.png`
- Checksum / 校验和:
  `3d04e83ecbeb0eca634dc3820531626e2a0ad6394bd0716cd5fb418403cb93db`
...
- Marked-pixel bounds: (63,26)–(176,221); span 114 × 196 px; the marked
...
- 痕迹范围：(63,26)–(176,221)；跨度114 × 196 px；痕迹矩形高于宽。
