# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010723
...
- EVOBC candidate category: `evobc-evo-cat-10723`.
- Source label for search only: `齝`.
- Source codepoints for search only: `U+9F5D`.
