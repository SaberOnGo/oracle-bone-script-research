...
- `obs-evo-cand-012644-route-category-staging`
...
- `obs-evo-cand-012644-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012644-route-evolution-graph`
