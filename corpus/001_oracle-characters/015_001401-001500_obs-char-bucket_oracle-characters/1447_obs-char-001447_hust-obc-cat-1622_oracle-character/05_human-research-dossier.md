# obs-char-001447 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001447`
- primary external id: `hust-obc-cat-1622`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1447_obs-char-001447_hust-obc-cat-1622_ora
  cle-character/03_visual-assets/001_asset-001452_hust-obc-cat-1622_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1622/G_1622_乙1101合152賓組.png`
- asset id: `asset-001452`
...
- source category: `1622`
- validation class: `1446`
- source image route: `HUST-OBC/deciphered/1622/G_1622_乙1101合152賓組.png`
- asset id: `asset-001452`
...
- English observation: `A closed oval enclosure contains two crossing
  diagonal strokes.`
- 中文观察: `封闭椭圆框形内部有两条交叉斜笔。`
...
- dataset label text: `㩌`
- dataset label codepoints: `U+3A4C`
...
- filename catalog route clues: `Heji-like filename clue: 合152
...
- Which source records identify obs-char-001447 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001447？
