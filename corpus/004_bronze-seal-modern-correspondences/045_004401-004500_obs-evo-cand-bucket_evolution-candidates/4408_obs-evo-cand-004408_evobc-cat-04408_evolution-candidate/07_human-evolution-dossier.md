...
Project ID: `obs-evo-cand-004408`
...
- Project ID: `obs-evo-cand-004408`
- EVOBC category candidate ID: `evobc-evo-cat-04408`
- External category reference: `evobc-cat-04408`
- Source category ID: `04408`
- Source label for human review: `殆`
- Source codepoints: `U+6B86`
...
- `obs-evo-cand-004408-route-category-staging`
...
- `obs-evo-cand-004408-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004408-route-evolution-graph`
