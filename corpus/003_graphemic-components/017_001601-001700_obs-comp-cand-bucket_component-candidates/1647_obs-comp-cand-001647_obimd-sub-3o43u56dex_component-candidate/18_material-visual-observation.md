# Material Visual Observation / obs-comp-cand-001647 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001647`
- External reference / 外部参照: `obimd-sub-3o43u56dex`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017323_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bi8t9sxwtl/3o43u56dex/3o43u56dex.png`
- Checksum / 校验和:
  `5fbcb562a129475aa46ff6837ebfadd213dcb7e9782310463039a6bc7b52413c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.32%.
- Marked-pixel bounds: (63,23)–(200,221); span 138 × 199 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.32%。
- 痕迹范围：(63,23)–(200,221)；跨度138 × 199 px；痕迹矩形高于宽。
