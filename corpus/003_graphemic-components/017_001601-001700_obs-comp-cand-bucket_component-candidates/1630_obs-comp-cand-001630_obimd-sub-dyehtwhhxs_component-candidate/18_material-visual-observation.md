# Material Visual Observation / obs-comp-cand-001630 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001630`
- External reference / 外部参照: `obimd-sub-dyehtwhhxs`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017306_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7e0bc7s6s0/dyehtwhhxs/dyehtwhhxs.png`
- Checksum / 校验和:
  `47a989ba156d2647ac6f27c4ba66b015c2d666730d971b4bb08744b84c8a1a2f`
...
- Marked-pixel bounds: (62,30)–(198,210); span 137 × 181 px; the marked
...
- 痕迹范围：(62,30)–(198,210)；跨度137 × 181 px；痕迹矩形高于宽。
