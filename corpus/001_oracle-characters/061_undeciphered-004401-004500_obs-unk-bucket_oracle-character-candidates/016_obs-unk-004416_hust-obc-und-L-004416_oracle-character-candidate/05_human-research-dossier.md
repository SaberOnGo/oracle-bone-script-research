# obs-unk-004416 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004416`
- primary external id: `hust-obc-und-L-004416`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/016_obs-unk-004416_h
  ust-obc-und-L-004416_oracle-character-candidate/03_visual-assets/001_asset
  -006009_hust-obc-und-L-004416_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4416/L_？_9871.jpg`
- asset id: `asset-006009`
...
- source class: `HUST-OBC/undeciphered/L/4416/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4416/L_？_9871.jpg`
- asset id: `asset-006009`
...
- English observation: `A tall looped trace stands beside short left marks`
  `and a lower zigzag.`
- 中文观察: `高而带环的痕迹旁有左侧短痕和下部曲折痕迹。`
...
- Which source records identify obs-unk-004416 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004416？
