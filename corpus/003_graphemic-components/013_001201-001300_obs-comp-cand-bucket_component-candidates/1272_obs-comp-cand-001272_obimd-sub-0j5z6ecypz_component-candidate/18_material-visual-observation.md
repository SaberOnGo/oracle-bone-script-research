# Material Visual Observation / obs-comp-cand-001272 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001272`
- External reference / 外部参照: `obimd-sub-0j5z6ecypz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015510_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/frmptf4le7/0j5z6ecypz/0j5z6ecypz.png`
- Checksum / 校验和:
  `8a5647acc686f982b7c61872262ca84f7b9976ac33a7d05c0ccb0b8f10b9ece1`
...
- Marked-pixel bounds: (76,50)–(176,207); span 101 × 158 px; the marked
...
- 痕迹范围：(76,50)–(176,207)；跨度101 × 158 px；痕迹矩形高于宽。
