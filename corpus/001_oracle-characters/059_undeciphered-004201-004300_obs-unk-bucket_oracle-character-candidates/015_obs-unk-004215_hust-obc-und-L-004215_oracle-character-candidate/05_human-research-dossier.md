# obs-unk-004215 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004215`
- primary external id: `hust-obc-und-L-004215`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/015_obs-unk-004215_h
  ust-obc-und-L-004215_oracle-character-candidate/03_visual-assets/001_asset
  -005808_hust-obc-und-L-004215_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4215/L_？_9194.jpg`
- asset id: `asset-005808`
...
- source class: `HUST-OBC/undeciphered/L/4215/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4215/L_？_9194.jpg`
- asset id: `asset-005808`
...
- English observation: `Tall stroke cluster and crossing diagonals visible.`
- 中文观察: `高而不规则的笔画簇及交叉斜笔画可见。`
...
- Which source records identify obs-unk-004215 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004215？
