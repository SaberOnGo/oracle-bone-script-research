# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000379
...
- EVOBC candidate category: `evobc-evo-cat-00379`.
- Source label for search only: `䒾`.
- Source codepoints for search only: `U+44BE`.
