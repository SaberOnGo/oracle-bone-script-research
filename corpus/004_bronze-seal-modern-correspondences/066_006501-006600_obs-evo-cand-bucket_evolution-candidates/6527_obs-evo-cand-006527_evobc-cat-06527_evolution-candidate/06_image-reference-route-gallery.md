...
- `obs-evo-cand-006527-route-category-staging`
...
- `obs-evo-cand-006527-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006527-route-evolution-graph`
