# obs-evo-cand-008121 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-008121`
- EVOBC category candidate ID: `evobc-evo-cat-08121`
- External category ref: `evobc-cat-08121`
- Source label: `言`
- Source codepoints: `U+8A00`
- Image reference count: `279`
- Era token counts: `BI:13;CS:1;OBC:74;SAC:5;SS:2;WSC:184`
- Source token counts: `Book:72;Web:207`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 74 image references
- era 1 / BI: 13 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 5 image references
- era 4 / WSC: 184 image references
- era 5 / CS: 1 image references
- source 0 / Web:1633: 1 image references
- source 1 / Web:105952;說文Web:58: 183 image references
- source 2 / Book:17600: 28 image references
- source 3 / Book:21681: 5 image references
