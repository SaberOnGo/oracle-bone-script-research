...
- Review log draft ID / 复核日志草稿 ID: `codepoint-crosswalk-review-log-draft-003`
- Codepoint review task ID / codepoint 复核任务 ID: `codepoint-crosswalk-review-003`
...
- Crosswalk candidate ID / 交叉候选 ID: `hust-obimd-evobc-xwalk-000209`
- Suggested oracle character ID / 建议甲骨单字 ID: `obs-char-000209`
- Promotion queue ID / 提升队列 ID: `hust-obc-obs-char-promo-000209`
...
- HUST external ref / HUST 外部引用: `hust-obc-cat-0232`
- HUST label codepoints / HUST 标签 codepoint: `U+34DE`
- OBIMD main candidates / OBIMD 主字候选: `obimd-main-cand-003002`
- EVOBC category candidates / EVOBC 类别候选: `evobc-evo-cat-00021`
...
- `corpus/001_oracle-characters/003_000201-000300_obs-char-bucket_oracle-characters/001_hust-obc-candidate-packet-manifest.csv`
- `corpus/001_oracle-characters/003_000201-000300_obs-char-bucket_oracle-characters/209_obs-char-000209_hust-obc-cat-0232_oracle-character/01_candidate-character-packet.json`
...
- Route availability ID: `codepoint-route-availability-003`
...
- Review task ID: `codepoint-crosswalk-review-003`
- Crosswalk candidate ID: `hust-obimd-evobc-xwalk-000209`
- Suggested oracle character ID: `obs-char-000209`
- HUST candidate packet ID: `hust-obc-candidate-packet-000209`
...
- OBIMD row count: `1`
- OBIMD source UIDs: `nzqdb3i249`
- OBIMD review statuses: `obimd-main-cand-003002=reviewed_metadata_only`
- OBIMD rights statuses: `obimd-main-cand-003002=licensed_for_repository`
- EVOBC row count: `1`
- EVOBC source category IDs: `00021`
- EVOBC has bronze refs: `true`
- EVOBC has seal refs: `false`
- EVOBC review statuses: `evobc-evo-cat-00021=reviewed_metadata_only`
- EVOBC rights statuses: `evobc-evo-cat-00021=source_marked_risk_noted`
...
- Does `hust-obimd-evobc-xwalk-000209` remain unpromoted and undeciphered?
