...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1386`
...
- Source image / 来源图: `G_1386_佚644(甲).png`
- Image / 图像: `001_asset-001244_hust-obc-cat-1386_glyph.png`
...
- target node: `evobc-evo-cat-00129`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/129_obs-evo-cand-000129_evobc-cat-00129_evoluti
...
- Source label text / 来源标签文字: `㥠`
- Source label codepoint / 来源标签 codepoint: `U+3960`
