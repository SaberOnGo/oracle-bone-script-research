# obs-char-001392 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001392`
- primary external id: `hust-obc-cat-1557`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1392_obs-char-001392_hust-obc-cat-1557_ora
  cle-character/03_visual-assets/001_asset-001397_hust-obc-cat-1557_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1557/G_1557_甲骨文0.png`
- asset id: `asset-001397`
...
- source category: `1557`
- validation class: `1391`
- source image route: `HUST-OBC/deciphered/1557/G_1557_甲骨文0.png`
- asset id: `asset-001397`
...
- English observation: `Two separated branching forms combine open left
  prongs with a long right curve.`
- 中文观察: `两个分离分枝形体组合为开放左分叉和长右弧线。`
...
- dataset label text: `㨋`
- dataset label codepoints: `U+3A0B`
...
- Which source records identify obs-char-001392 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001392？
