# Material Visual Observation / obs-comp-cand-001425 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001425`
- External reference / 外部参照: `obimd-sub-n9qxfnupux`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016002_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/n9qxfnupux/n9qxfnupux/n9qxfnupux.png`
- Checksum / 校验和:
  `0d06885218fe5b234d92958ae4e25bc4a85a86e8ee8fdade7aae1569eda261b6`
...
- Marked-pixel bounds: (81,32)–(167,214); span 87 × 183 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.24%。
- 痕迹范围：(81,32)–(167,214)；跨度87 × 183 px；痕迹矩形高于宽。
