...
Project ID: `obs-evo-cand-004263`
...
- Project ID: `obs-evo-cand-004263`
- EVOBC category candidate ID: `evobc-evo-cat-04263`
- External category reference: `evobc-cat-04263`
- Source category ID: `04263`
- Source label for human review: `橎`
- Source codepoints: `U+6A4E`
...
- `obs-evo-cand-004263-route-category-staging`
...
- `obs-evo-cand-004263-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004263-route-evolution-graph`
