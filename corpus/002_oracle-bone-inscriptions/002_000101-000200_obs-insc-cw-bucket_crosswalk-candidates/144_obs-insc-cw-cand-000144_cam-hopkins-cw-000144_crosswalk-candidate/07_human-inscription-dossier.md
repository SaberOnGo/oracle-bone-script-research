...
Project ID: `obs-insc-cw-cand-000144`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000144`
...
- Period label: `I`
- Classification group: `9`
- Declared group count: `11`
...
- Source page section: `Period I Group 9` /
  `第 I 期第 9 组`
- Source section key: `period-i-group-9`
- Section declared count: `11`
- Section observed row count: `11`
...
- Yingguo / 英国所藏: `y803` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `27` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `372` in source row; primary catalog entry pending
- Heji / 合集: `40094` in source row; primary catalog entry pending
...
- Group and batch / 组类与批次: group `9`; batch or pit context pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000144`
