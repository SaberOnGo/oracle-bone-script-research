# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002587
...
- EVOBC candidate category: `evobc-evo-cat-02587`.
- Source label for search only: `嵯`.
- Source codepoints for search only: `U+5D6F`.
