...
- Project ID: `obs-evo-cand-007922`
- EVOBC category candidate ID: `evobc-evo-cat-07922`
- External category reference: `evobc-cat-07922`
- Source category ID: `07922`
- Source label for human review: `表`
- Source codepoints: `U+8868`
...
- `obs-evo-cand-007922-route-category-staging`
...
- `obs-evo-cand-007922-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007922-route-evolution-graph`
