# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010262
...
- EVOBC candidate category: `evobc-evo-cat-10262`.
- Source label for search only: `驢`.
- Source codepoints for search only: `U+9A62`.
