# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000543
...
- EVOBC candidate category: `evobc-evo-cat-00543`.
- Source label for search only: `䪛`.
- Source codepoints for search only: `U+4A9B`.
