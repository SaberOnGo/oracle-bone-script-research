# obs-char-000911 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/911_obs-char-000911_hust-obc-cat-1026_orac
  le-character/03_visual-assets/001_asset-000916_hust-obc-cat-1026_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1026/G_1026_京津2300合10195賓組.png`
- asset id: `asset-000916`
...
- source category: `1026`
- validation class: `910`
- source image route: `HUST-OBC/deciphered/1026/G_1026_京津2300合10195賓組.png`
- asset id: `asset-000916`
...
- English observation: `A slender vertical form contains a top crossbar,
  paired side branches, a central crossing, and a lower enclosed loop.`
...
- dataset label text: `㟸`
- dataset label codepoints: `U+37F8`
...
- filename catalog route clues: `Heji-like filename clue: 合10195
...
- Which source records identify obs-char-000911 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000911？
