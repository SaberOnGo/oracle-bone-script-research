...
- Project ID: `obs-evo-cand-012044`
- EVOBC category candidate ID: `evobc-evo-cat-12044`
- External category reference: `evobc-cat-12044`
- Source category ID: `12044`
- Source label for human review: `𦚐`
- Source codepoints: `U+26690`
...
- `obs-evo-cand-012044-route-category-staging`
...
- `obs-evo-cand-012044-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012044-route-evolution-graph`
