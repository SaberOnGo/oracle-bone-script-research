# Material Visual Observation / obs-comp-cand-002136 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002136`
- External reference / 外部参照: `obimd-sub-7jroaqd3q5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019693_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3drbkkpjwi/7jroaqd3q5/7jroaqd3q5.png`
- Checksum / 校验和:
  `a56d5cd44868f658213e4f03e80d506d9930cd89d6da206560398d5b2a5e2560`
...
- Marked-pixel bounds: (100,34)–(149,209); span 50 × 176 px; the marked
...
- 痕迹范围：(100,34)–(149,209)；跨度50 × 176 px；痕迹矩形高于宽。
