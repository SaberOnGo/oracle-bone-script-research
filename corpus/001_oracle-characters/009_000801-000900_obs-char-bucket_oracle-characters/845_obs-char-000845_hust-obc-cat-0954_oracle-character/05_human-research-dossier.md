# obs-char-000845 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/845_obs-char-000845_hust-obc-cat-0954_orac
  le-character/03_visual-assets/001_asset-000850_hust-obc-cat-0954_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0954/G_0954_中大36.png`
- asset id: `asset-000850`
...
- source category: `0954`
- validation class: `844`
- source image route: `HUST-OBC/deciphered/0954/G_0954_中大36.png`
- asset id: `asset-000850`
...
- English observation: `A long curved stroke at left is separated from a
  right branching form with an angular top and a lower rounded loop.`
- 中文观察: `左侧长弯曲笔与右侧分枝形体分离，右形上部有折角，下部有圆弧环状痕迹。`
...
- dataset label text: `㞰`
- dataset label codepoints: `U+37B0`
...
- Which source records identify obs-char-000845 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000845？
