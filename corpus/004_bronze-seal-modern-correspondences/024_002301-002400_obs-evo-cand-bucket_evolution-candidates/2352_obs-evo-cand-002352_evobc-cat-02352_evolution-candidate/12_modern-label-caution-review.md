# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002352
...
- EVOBC candidate category: `evobc-evo-cat-02352`.
- Source label for search only: `孽`.
- Source codepoints for search only: `U+5B7D`.
