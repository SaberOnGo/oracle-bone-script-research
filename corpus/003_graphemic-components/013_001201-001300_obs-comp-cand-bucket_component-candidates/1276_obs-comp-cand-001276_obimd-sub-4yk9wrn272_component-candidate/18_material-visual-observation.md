# Material Visual Observation / obs-comp-cand-001276 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001276`
- External reference / 外部参照: `obimd-sub-4yk9wrn272`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015514_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4yk9wrn272/4yk9wrn272/1nknmejdxq.png`
- Checksum / 校验和:
  `dce5630cf3fc7a716e279386188c6bdb2b118b0d33389da6363e25f95e7b42da`
...
- Marked-pixel bounds: (62,47)–(187,201); span 126 × 155 px; the marked
...
- 痕迹范围：(62,47)–(187,201)；跨度126 × 155 px；痕迹矩形高于宽。
