# Material Visual Observation / obs-comp-cand-000144 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000144`
- External reference / 外部参照: `obimd-sub-7nuzvu1uoz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011556_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7nuzvu1uoz/7nuzvu1uoz/7nuzvu1uoz.png`
- Checksum / 校验和:
  `fceca6f55690c423238a8f60d14be52471df6ff6b97cace1b09502c06ebad296`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.06%.
- Marked-pixel bounds: (72,40)–(177,209); span 106 × 170 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.06%。
- 痕迹范围：(72,40)–(177,209)；跨度106 × 170 px；痕迹矩形高于宽。
