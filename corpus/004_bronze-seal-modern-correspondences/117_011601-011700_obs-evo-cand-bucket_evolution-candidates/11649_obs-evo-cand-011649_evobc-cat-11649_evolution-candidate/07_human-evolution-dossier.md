...
- Project ID: `obs-evo-cand-011649`
- EVOBC category candidate ID: `evobc-evo-cat-11649`
- External category reference: `evobc-cat-11649`
- Source category ID: `11649`
- Source label for human review: `𤩀`
- Source codepoints: `U+24A40`
...
- `obs-evo-cand-011649-route-category-staging`
...
- `obs-evo-cand-011649-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011649-route-evolution-graph`
