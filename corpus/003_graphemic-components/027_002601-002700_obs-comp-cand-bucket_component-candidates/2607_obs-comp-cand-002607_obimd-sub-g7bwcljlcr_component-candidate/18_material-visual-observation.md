# Material Visual Observation / obs-comp-cand-002607 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002607`
- External reference / 外部参照: `obimd-sub-g7bwcljlcr`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021146_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/g7bwcljlcr/g7bwcljlcr/g7bwcljlcr.png`
- Checksum / 校验和:
  `eef2b168c689dadd5e91150f279d6b84b5a9dd020490c6d397b2e0f0f7fb9c82`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.58%.
- Marked-pixel bounds: (65,16)–(191,233); span 127 × 218 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.58%。
- 痕迹范围：(65,16)–(191,233)；跨度127 × 218 px；痕迹矩形高于宽。
