...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0231`
...
- Source image / 来源图: `G_0231_京都334A合6001賓組.png`
- Image / 图像: `001_asset-000213_hust-obc-cat-0231_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合6001
...
- target node: `evobc-evo-cat-00020`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC image references / EvoBC 图像引用数: `23`
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/020_obs-evo-cand-000020_evobc-cat-00020_evoluti
...
- Source label text / 来源标签文字: `㓝`
- Source label codepoint / 来源标签 codepoint: `U+34DD`
