...
- External category reference: `evobc-cat-02394`
- Source category ID: `02394`
- Source label for human review: `宰`
- Source codepoints: `U+5BB0`
- Image reference count in source metadata: `149`
...
- `obs-evo-cand-002394-route-category-staging`
...
- `obs-evo-cand-002394-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002394-route-evolution-graph`
