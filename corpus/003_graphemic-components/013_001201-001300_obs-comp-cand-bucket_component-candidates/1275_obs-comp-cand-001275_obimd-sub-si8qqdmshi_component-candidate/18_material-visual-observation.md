# Material Visual Observation / obs-comp-cand-001275 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001275`
- External reference / 外部参照: `obimd-sub-si8qqdmshi`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015513_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/si8qqdmshi/si8qqdmshi/si8qqdmshi.png`
- Checksum / 校验和:
  `a4c78cf2e4b4fccf1c5d07a0dc51df2f54b1653dd8b79013374a15d5a6ff1ff0`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.98%.
- Marked-pixel bounds: (71,48)–(178,196); span 108 × 149 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.98%。
- 痕迹范围：(71,48)–(178,196)；跨度108 × 149 px；痕迹矩形高于宽。
