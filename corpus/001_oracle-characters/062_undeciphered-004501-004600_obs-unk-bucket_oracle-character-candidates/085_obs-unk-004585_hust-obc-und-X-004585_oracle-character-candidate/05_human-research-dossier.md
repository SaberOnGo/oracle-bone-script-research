# obs-unk-004585 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/085_obs-unk-004585_h
  ust-obc-und-X-004585_oracle-character-candidate/03_visual-assets/001_asset
  -006178_hust-obc-und-X-004585_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/141/X_？_8319_1.png`
- asset id: `asset-006178`
...
- source class: `HUST-OBC/undeciphered/X/141/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/141/X_？_8319_1.png`
- asset id: `asset-006178`
...
- English observation: `Upper branches, central divider, lower enclosure,`
  `and tip recorded.`
- 中文观察: `已记录上部分叉、中央分隔、下部轮廓和尖端。`
...
- Which source records identify obs-unk-004585 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004585？
