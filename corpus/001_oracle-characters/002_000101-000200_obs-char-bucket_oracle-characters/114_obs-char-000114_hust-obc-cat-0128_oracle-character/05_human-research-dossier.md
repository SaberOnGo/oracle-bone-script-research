# obs-char-000114 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000114`
- primary external id: `hust-obc-cat-0128`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/114_obs-char-000114_hust-obc-cat-0128_orac
  le-character/03_visual-assets/001_asset-000119_hust-obc-cat-0128_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0128/G_0128_掇2.66.png`
- asset id: `asset-000119`
...
- source category: `0128`
- validation class: `113`
- source image route: `HUST-OBC/deciphered/0128/G_0128_掇2.66.png`
- asset id: `asset-000119`
...
- English observation: `The light image has a small diamond-like central
  enclosure, short upper strokes, and two curved lower extensions that
  remain open at the sides.`
- 中文观察: `浅色图像中部有小型菱状围合，上方有短笔，下方伸出两道侧面开放的弯曲笔画。`
...
- dataset label text: `㑶`
- dataset label codepoints: `U+3476`
...
- Which source records identify obs-char-000114 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000114？
