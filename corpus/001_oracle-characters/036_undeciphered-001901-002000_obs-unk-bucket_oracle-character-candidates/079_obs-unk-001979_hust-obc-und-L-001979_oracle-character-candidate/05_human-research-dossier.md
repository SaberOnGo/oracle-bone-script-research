# obs-unk-001979 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-001979`
- primary external id: `hust-obc-und-L-001979`
...
- local review image route: `corpus/001_oracle-characters/036_undeciphered-001
  901-002000_obs-unk-bucket_oracle-character-candidates/079_obs-unk-001979_h
  ust-obc-und-L-001979_oracle-character-candidate/03_visual-assets/001_asset
  -003572_hust-obc-und-L-001979_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/1979/L_？_1829.jpg`
- asset id: `asset-003572`
...
- source class: `HUST-OBC/undeciphered/L/1979/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/1979/L_？_1829.jpg`
- asset id: `asset-003572`
...
- Which source records identify obs-unk-001979 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-001979？
