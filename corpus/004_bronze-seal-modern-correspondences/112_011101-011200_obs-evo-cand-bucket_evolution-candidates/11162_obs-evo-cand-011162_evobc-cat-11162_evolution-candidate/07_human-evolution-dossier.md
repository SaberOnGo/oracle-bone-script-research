...
- Project ID: `obs-evo-cand-011162`
- EVOBC category candidate ID: `evobc-evo-cat-11162`
- External category reference: `evobc-cat-11162`
- Source category ID: `11162`
- Source label for human review: `𢌫`
- Source codepoints: `U+2232B`
...
- `obs-evo-cand-011162-route-category-staging`
...
- `obs-evo-cand-011162-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011162-route-evolution-graph`
