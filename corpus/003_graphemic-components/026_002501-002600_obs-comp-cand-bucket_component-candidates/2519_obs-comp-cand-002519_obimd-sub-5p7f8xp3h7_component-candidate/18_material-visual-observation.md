# Material Visual Observation / obs-comp-cand-002519 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002519`
- External reference / 外部参照: `obimd-sub-5p7f8xp3h7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020899_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0uhj5zj3ce/5p7f8xp3h7/5p7f8xp3h7.png`
- Checksum / 校验和:
  `1fb4580687f684e1839d76d2cb84effb096ee9df84c5dbf37e5566da3fb86c23`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.55%.
- Marked-pixel bounds: (78,56)–(171,188); span 94 × 133 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.55%。
- 痕迹范围：(78,56)–(171,188)；跨度94 × 133 px；痕迹矩形高于宽。
