...
- `obs-evo-cand-009458-route-category-staging`
...
- `obs-evo-cand-009458-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009458-route-evolution-graph`
