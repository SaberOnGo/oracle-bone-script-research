...
Project ID: `obs-evo-cand-008905`
...
- Project ID: `obs-evo-cand-008905`
- EVOBC category candidate ID: `evobc-evo-cat-08905`
- External category reference: `evobc-cat-08905`
- Source category ID: `08905`
- Source label for human review: `辙`
- Source codepoints: `U+8F99`
...
- `obs-evo-cand-008905-route-category-staging`
...
- `obs-evo-cand-008905-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008905-route-evolution-graph`
