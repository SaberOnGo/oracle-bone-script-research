# obs-unk-004162 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004162`
- primary external id: `hust-obc-und-L-004162`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/062_obs-unk-004162_h
  ust-obc-und-L-004162_oracle-character-candidate/03_visual-assets/001_asset
  -005755_hust-obc-und-L-004162_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4162/L_？_9019.jpg`
- asset id: `asset-005755`
...
- source class: `HUST-OBC/undeciphered/L/4162/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4162/L_？_9019.jpg`
- asset id: `asset-005755`
...
- English observation: A pointed upper outline has an inner edge and a long
  descending stroke.
- 中文观察: 上部尖角轮廓有内侧边线，并向下伸出长笔画。
...
- Which source records identify obs-unk-004162 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004162？
