# Material Visual Observation / obs-comp-cand-000990 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000990`
- External reference / 外部参照: `obimd-sub-fe4f66jdz0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014360_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tp2kuz956n/fe4f66jdz0/fe4f66jdz0.png`
- Checksum / 校验和:
  `a1a84ddb856dabfcbbdb46f91d16a1773b001a713af49967f65046e08820d0e1`
...
- Marked-pixel bounds: (82,42)–(167,207); span 86 × 166 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.72%。
- 痕迹范围：(82,42)–(167,207)；跨度86 × 166 px；痕迹矩形高于宽。
