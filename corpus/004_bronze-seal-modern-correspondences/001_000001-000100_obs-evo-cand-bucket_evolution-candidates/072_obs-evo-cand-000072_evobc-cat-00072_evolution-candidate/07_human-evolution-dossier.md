...
Project ID: `obs-evo-cand-000072`
...
- Project ID: `obs-evo-cand-000072`
- EVOBC category candidate ID: `evobc-evo-cat-00072`
- External category reference: `evobc-cat-00072`
- Source category ID: `00072`
- Source label for human review: `㝨`
- Source codepoints: `U+3768`
...
- `obs-evo-cand-000072-route-category-staging`
...
- `obs-evo-cand-000072-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000072-route-evolution-graph`
