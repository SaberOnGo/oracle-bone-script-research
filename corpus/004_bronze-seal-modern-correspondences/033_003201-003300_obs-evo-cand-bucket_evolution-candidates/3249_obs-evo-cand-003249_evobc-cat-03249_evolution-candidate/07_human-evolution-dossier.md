...
- External category reference: `evobc-cat-03249`
- Source category ID: `03249`
...
- `obs-evo-cand-003249-route-category-staging`
...
- `obs-evo-cand-003249-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003249-route-evolution-graph`
