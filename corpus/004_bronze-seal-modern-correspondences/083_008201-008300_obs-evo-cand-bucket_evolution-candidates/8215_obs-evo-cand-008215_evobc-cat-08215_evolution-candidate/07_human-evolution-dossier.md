...
Project ID: `obs-evo-cand-008215`
...
- Project ID: `obs-evo-cand-008215`
- EVOBC category candidate ID: `evobc-evo-cat-08215`
- External category reference: `evobc-cat-08215`
- Source category ID: `08215`
- Source label for human review: `誄`
- Source codepoints: `U+8A84`
...
- `obs-evo-cand-008215-route-category-staging`
...
- `obs-evo-cand-008215-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008215-route-evolution-graph`
