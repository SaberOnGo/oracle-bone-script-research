# obs-char-001533 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1533_obs-char-001533_hust-obc-cat-1719_ora
  cle-character/03_visual-assets/001_asset-001538_hust-obc-cat-1719_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1719/G_1719_鐵38.4(甲).png`
- asset id: `asset-001538`
...
- source category: `1719`
- validation class: `1532`
- source image route: `HUST-OBC/deciphered/1719/G_1719_鐵38.4(甲).png`
- asset id: `asset-001538`
...
- English observation: `A bowl-like upper contour sits above a short central
  stem and curved side marks.`
- 中文观察: `盆状上部轮廓位于短中央竖干和弧形侧部标记之上。`
...
- dataset label text: `㪭`
- dataset label codepoints: `U+3AAD`
...
- Which source records identify obs-char-001533 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001533？
