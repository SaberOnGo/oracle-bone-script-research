...
Project ID: `obs-evo-cand-013596`
...
- Project ID: `obs-evo-cand-013596`
- EVOBC category candidate ID: `evobc-evo-cat-13596`
- External category reference: `evobc-cat-13596`
- Source category ID: `13596`
- Source label for human review: `𭿔`
- Source codepoints: `U+2DFD4`
...
- `obs-evo-cand-013596-route-category-staging`
...
- `obs-evo-cand-013596-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013596-route-evolution-graph`
