# obs-char-000925 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/925_obs-char-000925_hust-obc-cat-1042_orac
  le-character/03_visual-assets/001_asset-000930_hust-obc-cat-1042_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1042/G_1042_乙2510合13936歷組.png`
- asset id: `asset-000930`
...
- source category: `1042`
- validation class: `924`
- source image route: `HUST-OBC/deciphered/1042/G_1042_乙2510合13936歷組.png`
- asset id: `asset-000930`
...
- English observation: `A pointed central stem descends between two rounded
  side forms and continues into several long lower branches.`
- 中文观察: `尖形中央笔干在两个圆弧侧形之间下行，并延续为数条长下部分枝。`
...
- dataset label text: `㠈`
- dataset label codepoints: `U+3808`
...
- filename catalog route clues: `Heji-like filename clue: 合13936
...
- Which source records identify obs-char-000925 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000925？
