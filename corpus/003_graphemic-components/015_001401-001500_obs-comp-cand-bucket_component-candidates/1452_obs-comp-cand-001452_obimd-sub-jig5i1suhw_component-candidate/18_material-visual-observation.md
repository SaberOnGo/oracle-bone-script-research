# Material Visual Observation / obs-comp-cand-001452 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001452`
- External reference / 外部参照: `obimd-sub-jig5i1suhw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016029_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zi2pxt9kk6/jig5i1suhw/jig5i1suhw.png`
- Checksum / 校验和:
  `b9752c3eaf87da68a3d8e2310d4119ca8bfc96ad1a433895d25d0806ae21ccc6`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.28%.
- Marked-pixel bounds: (74,22)–(183,229); span 110 × 208 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.28%。
- 痕迹范围：(74,22)–(183,229)；跨度110 × 208 px；痕迹矩形高于宽。
