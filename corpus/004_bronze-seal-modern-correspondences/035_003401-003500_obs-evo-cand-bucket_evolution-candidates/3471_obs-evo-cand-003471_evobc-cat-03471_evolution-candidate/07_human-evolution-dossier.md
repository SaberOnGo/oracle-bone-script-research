...
Project ID: `obs-evo-cand-003471`
...
- Project ID: `obs-evo-cand-003471`
- EVOBC category candidate ID: `evobc-evo-cat-03471`
- External category reference: `evobc-cat-03471`
- Source category ID: `03471`
- Source label for human review: `摎`
- Source codepoints: `U+644E`
...
- `obs-evo-cand-003471-route-category-staging`
...
- `obs-evo-cand-003471-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003471-route-evolution-graph`
