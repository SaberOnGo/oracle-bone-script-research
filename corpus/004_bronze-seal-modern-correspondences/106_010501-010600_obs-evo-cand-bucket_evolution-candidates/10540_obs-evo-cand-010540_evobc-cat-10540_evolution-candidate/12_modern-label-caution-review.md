# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010540
...
- EVOBC candidate category: `evobc-evo-cat-10540`.
- Source label for search only: `鶻`.
- Source codepoints for search only: `U+9DBB`.
