# obs-unk-003499 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/051_undeciphered-003
  401-003500_obs-unk-bucket_oracle-character-candidates/099_obs-unk-003499_h
  ust-obc-und-L-003499_oracle-character-candidate/03_visual-assets/001_asset
  -005092_hust-obc-und-L-003499_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3499/L_？_6847.jpg`
- asset id: `asset-005092`
...
- source class: `HUST-OBC/undeciphered/L/3499/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3499/L_？_6847.jpg`
- asset id: `asset-005092`
...
- Which source records identify obs-unk-003499 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003499？
