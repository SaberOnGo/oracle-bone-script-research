...
- Project ID: `obs-evo-cand-003286`
- EVOBC category candidate ID: `evobc-evo-cat-03286`
- External category reference: `evobc-cat-03286`
- Source category ID: `03286`
- Source label for human review: `护`
- Source codepoints: `U+62A4`
...
- `obs-evo-cand-003286-route-category-staging`
...
- `obs-evo-cand-003286-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003286-route-evolution-graph`
