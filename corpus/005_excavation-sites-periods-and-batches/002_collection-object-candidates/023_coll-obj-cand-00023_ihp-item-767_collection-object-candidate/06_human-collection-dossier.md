# Human Collection Object Dossier / 馆藏对象研究档案: coll-obj-cand-00023
...
- project_id: `coll-obj-cand-00023`
- candidate_collection_object_id: `ihp-mus-obj-00023`
- source_collection_item_id: `767`
...
| `source_collection_item_id` | `767` |
| `object_title_en` | `​​​​Inscribed Plastron Fragment Chia 0984` |
| `catalog_reference_text` | `Chia 0984` |
| `object_page_url` | `https://museum.sinica.edu.tw/en/collection/32/item/767/` |
| `thumbnail_url` | `https://museum.sinica.edu.tw/_upload/image/collection_item/thumbnail/4655f6897a47acc5.jpg` |
...
- visual_access: `local_private_visual_inspection_only`

The official pages and three image routes were checked on 2026-08-14. The
local images are ignored and rights remain metadata-only; no public visual
derivative is claimed.

2026-08-14 已核对官方页面和三条图像路线。图像保存在忽略区，权利仍为
metadata-only；不主张任何公开视觉派生物。
...
- live_source_review: `source_description_checked_2026-08-14`
