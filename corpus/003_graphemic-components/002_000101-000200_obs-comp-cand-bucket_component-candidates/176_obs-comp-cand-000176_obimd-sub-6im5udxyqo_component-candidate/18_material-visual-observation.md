# Material Visual Observation / obs-comp-cand-000176 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000176`
- External reference / 外部参照: `obimd-sub-6im5udxyqo`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011588_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4n6v7cj6m9/6im5udxyqo/6im5udxyqo.png`
- Checksum / 校验和:
  `5dee6a6c672aabc11293bcd3c105f7479b9ea357412281f414222e13d453f829`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.62%.
- Marked-pixel bounds: (60,18)–(189,230); span 130 × 213 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.62%。
- 痕迹范围：(60,18)–(189,230)；跨度130 × 213 px；痕迹矩形高于宽。
