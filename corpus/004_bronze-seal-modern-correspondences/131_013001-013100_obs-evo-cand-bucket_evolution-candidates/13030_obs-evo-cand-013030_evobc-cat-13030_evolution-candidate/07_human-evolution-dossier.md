...
- External category reference: `evobc-cat-13030`
- Source category ID: `13030`
- Source label for human review: `𫧖`
...
- `obs-evo-cand-013030-route-category-staging`
...
- `obs-evo-cand-013030-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013030-route-evolution-graph`
