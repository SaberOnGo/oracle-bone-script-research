# Material Visual Observation / obs-comp-cand-000041 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000041`
- External reference / 外部参照: `obimd-sub-owcp73s8go`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011298_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/owcp73s8go/owcp73s8go/owcp73s8go.png`
- Checksum / 校验和:
  `b9143360c46f8a64923916eb39d98e526fcffef7828736c0cc65641377eb1156`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.86%.
- Marked-pixel bounds: (65,28)–(184,224); span 120 × 197 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.86%。
- 痕迹范围：(65,28)–(184,224)；跨度120 × 197 px；痕迹矩形高于宽。
