# obs-char-000883 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000883`
- primary external id: `hust-obc-cat-0995`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/883_obs-char-000883_hust-obc-cat-0995_orac
  le-character/03_visual-assets/001_asset-000888_hust-obc-cat-0995_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0995/G_0995_乙29合20768𠂤組.png`
- asset id: `asset-000888`
...
- source category: `0995`
- validation class: `882`
- source image route: `HUST-OBC/deciphered/0995/G_0995_乙29合20768𠂤組.png`
- asset id: `asset-000888`
...
- English observation: `A narrow cluster is framed by two curving outer
  strokes and contains a central loop with short branching strokes.`
- 中文观察: `狭长笔群由两条弯曲外笔围合，中央有环状痕迹和短分枝笔。`
...
- dataset label text: `㟙`
- dataset label codepoints: `U+37D9`
...
- filename catalog route clues: `Heji-like filename clue: 合20768
  (G_0995_乙29合20768𠂤組.png)`
...
- Which source records identify obs-char-000883 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000883？
