# obs-char-000040 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000040`
- primary external id: `hust-obc-cat-0046`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/040_obs-char-000040_hust-obc-cat-0046_orac
  le-character/03_visual-assets/001_asset-000045_hust-obc-cat-0046_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0046/G_0046_前1.5.7合35532黃組.png`
- asset id: `asset-000045`
...
- source category: `0046`
- validation class: `39`
- source image route: `HUST-OBC/deciphered/0046/G_0046_前1.5.7合35532黃組.png`
- asset id: `asset-000045`
...
- English observation: `The small image shows an upper open angular cluster
  and a separate lower cluster of crossing strokes.`
- 中文观察: `小型图像上方有开放折角痕迹，下方另有交叉笔画组成的分离形体。`
...
- dataset label text: `㐤`
- dataset label codepoints: `U+3424`
...
- filename catalog route clues: `Heji-like filename clue: 合35532
  (G_0046_前1.5.7合35532黃組.png)`
...
- Which source records identify obs-char-000040 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000040？
