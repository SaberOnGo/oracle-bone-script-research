...
- External category reference: `evobc-cat-10663`
- Source category ID: `10663`
- Source label for human review: `黴`
...
- `obs-evo-cand-010663-route-category-staging`
...
- `obs-evo-cand-010663-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010663-route-evolution-graph`
