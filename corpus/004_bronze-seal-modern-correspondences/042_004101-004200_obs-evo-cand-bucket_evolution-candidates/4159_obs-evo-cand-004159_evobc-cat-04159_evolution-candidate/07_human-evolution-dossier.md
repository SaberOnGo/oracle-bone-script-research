...
- External category reference: `evobc-cat-04159`
- Source category ID: `04159`
- Source label for human review: `楣`
...
- `obs-evo-cand-004159-route-category-staging`
...
- `obs-evo-cand-004159-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004159-route-evolution-graph`
