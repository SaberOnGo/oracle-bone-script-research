...
- External category reference: `evobc-cat-12181`
- Source category ID: `12181`
- Source label for human review: `𧖽`
- Source codepoints: `U+275BD`
...
- `obs-evo-cand-012181-route-category-staging`
...
- `obs-evo-cand-012181-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012181-route-evolution-graph`
