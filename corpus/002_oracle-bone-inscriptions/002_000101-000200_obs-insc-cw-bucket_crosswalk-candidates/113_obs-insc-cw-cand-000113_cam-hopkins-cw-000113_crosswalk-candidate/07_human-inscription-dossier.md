...
- Yingguo / 英国所藏: `y616` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `157` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `613` in source row; primary catalog entry pending
- Heji / 合集: `39934` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000113`
