...
Project ID: `obs-evo-cand-005385`
...
- Project ID: `obs-evo-cand-005385`
- EVOBC category candidate ID: `evobc-evo-cat-05385`
- External category reference: `evobc-cat-05385`
- Source category ID: `05385`
- Source label for human review: `珣`
- Source codepoints: `U+73E3`
...
- `obs-evo-cand-005385-route-category-staging`
...
- `obs-evo-cand-005385-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005385-route-evolution-graph`
