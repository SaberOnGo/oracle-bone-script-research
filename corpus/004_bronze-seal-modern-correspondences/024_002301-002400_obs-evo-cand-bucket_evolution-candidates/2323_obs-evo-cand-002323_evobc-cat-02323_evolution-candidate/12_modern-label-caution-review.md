# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002323
...
- EVOBC candidate category: `evobc-evo-cat-02323`.
- Source label for search only: `孎`.
- Source codepoints for search only: `U+5B4E`.
