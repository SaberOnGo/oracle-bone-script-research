...
- External category reference: `evobc-cat-07354`
- Source category ID: `07354`
- Source label for human review: `荔`
- Source codepoints: `U+8354`
...
- `obs-evo-cand-007354-route-category-staging`
...
- `obs-evo-cand-007354-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007354-route-evolution-graph`
