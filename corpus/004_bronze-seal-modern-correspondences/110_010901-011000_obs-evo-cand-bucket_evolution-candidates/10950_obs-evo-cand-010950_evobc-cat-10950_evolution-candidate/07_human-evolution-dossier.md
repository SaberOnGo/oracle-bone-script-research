...
- External category reference: `evobc-cat-10950`
- Source category ID: `10950`
- Source label for human review: `𠸎`
- Source codepoints: `U+20E0E`
...
- `obs-evo-cand-010950-route-category-staging`
...
- `obs-evo-cand-010950-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010950-route-evolution-graph`
