...
- Project ID / 项目 ID: `obs-char-000486`
- Primary external ID / 首选外部 ID: `hust-obc-cat-0551`
...
- Source image / 来源图: `G_0551_乙21(甲).png`
- Image / 图像: `001_asset-000491_hust-obc-cat-0551_glyph.png`
...
- target node: `obimd-main-cand-002432`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- target node: `evobc-evo-cat-00038`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- OBIMD candidate ids / OBIMD 候选 ID: `obimd-main-cand-002432`
- OBIMD external refs / OBIMD 外部引用: `obimd-main-a8vnbz5v1s`
- OBIMD transcription field / OBIMD 转写字段: `㘝`
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00038`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00038`
- EvoBC image references / EvoBC 图像引用数: `29`
...
- Matched candidate folders / 匹配候选目录: `evobc-evo-cat-00038`
- Human review files / 人类复核文件:
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/038_obs-evo-cand-000038_evobc-cat-00038_evoluti
...
- Matched OBIMD main UIDs / OBIMD 主字 UID: `a8vnbz5v1s`
...
- Source label text / 来源标签文字: `㘝`
- Source label codepoint / 来源标签 codepoint: `U+361D`
