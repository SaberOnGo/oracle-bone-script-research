...
- External category reference: `evobc-cat-09872`
- Source category ID: `09872`
- Source label for human review: `露`
...
- `obs-evo-cand-009872-route-category-staging`
...
- `obs-evo-cand-009872-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009872-route-evolution-graph`
