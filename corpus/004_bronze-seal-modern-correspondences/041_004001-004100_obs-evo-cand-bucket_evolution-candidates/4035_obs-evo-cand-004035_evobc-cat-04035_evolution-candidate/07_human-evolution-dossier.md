...
- External category reference: `evobc-cat-04035`
- Source category ID: `04035`
- Source label for human review: `桯`
...
- `obs-evo-cand-004035-route-category-staging`
...
- `obs-evo-cand-004035-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004035-route-evolution-graph`
