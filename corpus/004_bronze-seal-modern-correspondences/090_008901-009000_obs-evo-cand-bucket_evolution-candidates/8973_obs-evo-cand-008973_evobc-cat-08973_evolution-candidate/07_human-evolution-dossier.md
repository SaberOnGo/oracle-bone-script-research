...
- External category reference: `evobc-cat-08973`
- Source category ID: `08973`
- Source label for human review: `迹`
- Source codepoints: `U+8FF9`
...
- `obs-evo-cand-008973-route-category-staging`
...
- `obs-evo-cand-008973-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008973-route-evolution-graph`
