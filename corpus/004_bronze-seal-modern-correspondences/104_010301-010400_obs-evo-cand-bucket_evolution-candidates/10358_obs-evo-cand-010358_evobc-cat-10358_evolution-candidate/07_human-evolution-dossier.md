...
Project ID: `obs-evo-cand-010358`
...
- Project ID: `obs-evo-cand-010358`
- EVOBC category candidate ID: `evobc-evo-cat-10358`
- External category reference: `evobc-cat-10358`
- Source category ID: `10358`
- Source label for human review: `魂`
- Source codepoints: `U+9B42`
...
- `obs-evo-cand-010358-route-category-staging`
...
- `obs-evo-cand-010358-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010358-route-evolution-graph`
