# Material Visual Observation / obs-comp-cand-000933 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000933`
- External reference / 外部参照: `obimd-sub-a73fq76370`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014016_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/a73fq76370/a73fq76370/a73fq76370.png`
- Checksum / 校验和:
  `1582ebfdccfae57044effd866e87b9f6f5105486922ecc9aff9342bd56267fec`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.81%.
- Marked-pixel bounds: (58,49)–(191,202); span 134 × 154 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.81%。
- 痕迹范围：(58,49)–(191,202)；跨度134 × 154 px；痕迹矩形近方形。
