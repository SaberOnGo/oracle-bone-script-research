...
- External category reference: `evobc-cat-06062`
- Source category ID: `06062`
- Source label for human review: `秔`
- Source codepoints: `U+79D4`
...
- `obs-evo-cand-006062-route-category-staging`
...
- `obs-evo-cand-006062-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006062-route-evolution-graph`
