# Material Visual Observation / obs-comp-cand-000528 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000528`
- External reference / 外部参照: `obimd-sub-0ln5rvbsug`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012762_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0ln5rvbsug/0ln5rvbsug/0ln5rvbsug.png`
- Checksum / 校验和:
  `f86a10e2af770d96bebc9ce9d0125a07dedffd6191c75d4e8a33c539710928ea`
...
- Marked-pixel bounds: (71,38)–(178,222); span 108 × 185 px; the marked
...
- 痕迹范围：(71,38)–(178,222)；跨度108 × 185 px；痕迹矩形高于宽。
