# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001548
...
| --- | --- | --- | --- |
| `obimd-glyph-link-024022` | 򻖗󹂯 | `U+BB597;U+F90AF` | `reviewed_metadata_only` |
| `obimd-glyph-link-024023` | 󹂰 | `U+F90B0` | `reviewed_metadata_only` |
| `obimd-glyph-link-024024` | 󹂱 | `U+F90B1` | `reviewed_metadata_only` |
