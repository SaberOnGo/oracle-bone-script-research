...
- External category reference: `evobc-cat-12330`
- Source category ID: `12330`
- Source label for human review: `𨌴`
- Source codepoints: `U+28334`
...
- `obs-evo-cand-012330-route-category-staging`
...
- `obs-evo-cand-012330-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012330-route-evolution-graph`
