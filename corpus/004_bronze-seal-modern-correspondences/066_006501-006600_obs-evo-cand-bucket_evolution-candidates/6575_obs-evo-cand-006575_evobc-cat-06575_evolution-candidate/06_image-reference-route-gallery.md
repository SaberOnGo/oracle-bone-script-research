...
- `obs-evo-cand-006575-route-category-staging`
...
- `obs-evo-cand-006575-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006575-route-evolution-graph`
