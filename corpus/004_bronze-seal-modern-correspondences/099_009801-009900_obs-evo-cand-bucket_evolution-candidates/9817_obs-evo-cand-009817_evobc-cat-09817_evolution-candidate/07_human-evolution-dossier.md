...
- External category reference: `evobc-cat-09817`
- Source category ID: `09817`
- Source label for human review: `雔`
...
- `obs-evo-cand-009817-route-category-staging`
...
- `obs-evo-cand-009817-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009817-route-evolution-graph`
