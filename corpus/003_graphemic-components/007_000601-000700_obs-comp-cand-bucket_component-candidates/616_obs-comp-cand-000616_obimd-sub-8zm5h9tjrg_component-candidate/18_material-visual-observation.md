# Material Visual Observation / obs-comp-cand-000616 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000616`
- External reference / 外部参照: `obimd-sub-8zm5h9tjrg`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013179_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zapprwvtx9/8zm5h9tjrg/8zm5h9tjrg.png`
- Checksum / 校验和:
  `4c26ce5929cb4c6a192b94f0fe9a457291c8ebbb6bfc279cb51ec3bb2e682123`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.34%.
- Marked-pixel bounds: (77,23)–(196,227); span 120 × 205 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.34%。
- 痕迹范围：(77,23)–(196,227)；跨度120 × 205 px；痕迹矩形高于宽。
