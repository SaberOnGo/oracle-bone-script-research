# obs-unk-004181 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/081_obs-unk-004181_h
  ust-obc-und-L-004181_oracle-character-candidate/03_visual-assets/001_asset
  -005774_hust-obc-und-L-004181_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4181/L_？_9059.jpg`
- asset id: `asset-005774`
...
- source class: `HUST-OBC/undeciphered/L/4181/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4181/L_？_9059.jpg`
- asset id: `asset-005774`
...
- English observation: A left enclosure stands beside a right branching
  stroke group.
- 中文观察: 左侧包围轮廓旁有右侧分支笔画组。
...
- Which source records identify obs-unk-004181 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004181？
