...
- `obs-evo-cand-012837-route-category-staging`
...
- `obs-evo-cand-012837-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012837-route-evolution-graph`
