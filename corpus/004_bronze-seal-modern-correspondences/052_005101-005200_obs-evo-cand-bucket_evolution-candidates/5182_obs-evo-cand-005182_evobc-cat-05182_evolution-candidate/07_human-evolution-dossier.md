...
Project ID: `obs-evo-cand-005182`
...
- Project ID: `obs-evo-cand-005182`
- EVOBC category candidate ID: `evobc-evo-cat-05182`
- External category reference: `evobc-cat-05182`
- Source category ID: `05182`
- Source label for human review: `爰`
- Source codepoints: `U+7230`
...
- `obs-evo-cand-005182-route-category-staging`
...
- `obs-evo-cand-005182-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005182-route-evolution-graph`
