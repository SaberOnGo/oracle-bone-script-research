# Material Visual Observation / obs-comp-cand-000184 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000184`
- External reference / 外部参照: `obimd-sub-vlrevyerla`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011596_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/j904v6fm79/vlrevyerla/vlrevyerla.png`
- Checksum / 校验和:
  `65e61115bb4ceae55a22af91f01bf0917b04a8327ff276c0ab274f7798fe3996`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.90%.
- Marked-pixel bounds: (86,18)–(163,231); span 78 × 214 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.90%。
- 痕迹范围：(86,18)–(163,231)；跨度78 × 214 px；痕迹矩形高于宽。
