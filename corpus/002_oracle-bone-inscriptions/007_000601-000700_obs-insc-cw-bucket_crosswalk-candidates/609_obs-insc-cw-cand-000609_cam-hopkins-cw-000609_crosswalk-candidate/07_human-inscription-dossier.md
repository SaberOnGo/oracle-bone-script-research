...
Project ID: `obs-insc-cw-cand-000609`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000609`
...
- Source page section: `Unclassified` /
  `未分类（原页标签）`
- Source section key: `unclassified`
...
- Yingguo / 英国所藏: `ybu01` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: 待查: missing CUL reference in source row
- Chalfant / Chalfant 著录: `596` in source row; primary catalog entry pending
...
- Findspot / 出土地: 待查: excavation or findspot evidence for the physical
  object
- Period / 时期: `unclassified` from source metadata; not a new dating
- Group and batch / 组类与批次: group `unclassified`; batch or pit context
  pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000609`
