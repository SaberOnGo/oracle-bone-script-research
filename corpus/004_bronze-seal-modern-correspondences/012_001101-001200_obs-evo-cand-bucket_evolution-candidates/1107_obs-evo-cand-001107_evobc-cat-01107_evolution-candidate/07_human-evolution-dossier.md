...
- External category reference: `evobc-cat-01107`
- Source category ID: `01107`
- Source label for human review: `冂`
...
- `obs-evo-cand-001107-route-category-staging`
...
- `obs-evo-cand-001107-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001107-route-evolution-graph`
