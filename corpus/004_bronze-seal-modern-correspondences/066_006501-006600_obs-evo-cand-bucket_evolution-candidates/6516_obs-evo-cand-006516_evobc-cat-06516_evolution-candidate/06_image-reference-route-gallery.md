...
- `obs-evo-cand-006516-route-category-staging`
...
- `obs-evo-cand-006516-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006516-route-evolution-graph`
