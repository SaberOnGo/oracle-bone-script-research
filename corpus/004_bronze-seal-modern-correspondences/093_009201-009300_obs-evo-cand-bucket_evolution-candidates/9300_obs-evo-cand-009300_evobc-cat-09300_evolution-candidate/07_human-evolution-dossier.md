...
- External category reference: `evobc-cat-09300`
- Source category ID: `09300`
- Source label for human review: `重`
- Source codepoints: `U+91CD`
- Image reference count in source metadata: `90`
...
- `obs-evo-cand-009300-route-category-staging`
...
- `obs-evo-cand-009300-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009300-route-evolution-graph`
