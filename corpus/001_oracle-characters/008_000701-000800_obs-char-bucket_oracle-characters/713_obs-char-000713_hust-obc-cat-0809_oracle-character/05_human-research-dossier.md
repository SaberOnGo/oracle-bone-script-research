# obs-char-000713 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000713`
- primary external id: `hust-obc-cat-0809`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/713_obs-char-000713_hust-obc-cat-0809_orac
  le-character/03_visual-assets/001_asset-000718_hust-obc-cat-0809_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0809/G_0809_乙7357(甲).png`
- asset id: `asset-000718`
...
- source category: `0809`
- validation class: `712`
- source image route: `HUST-OBC/deciphered/0809/G_0809_乙7357(甲).png`
- asset id: `asset-000718`
...
- English observation: `A thin irregular cluster centers on a horizontal
  rectangular frame, with a curved upper stroke, a looped left branch, and
  long crossing diagonals descending below.`
- 中文观察: `纤细不规则笔群以横向矩形框为中心，带弯上笔、环状左枝和向下延伸的长交叉斜笔。`
...
- dataset label text: `㜟`
- dataset label codepoints: `U+371F`
...
- Which source records identify obs-char-000713 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000713？
