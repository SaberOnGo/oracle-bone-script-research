...
- External category reference: `evobc-cat-09657`
- Source category ID: `09657`
- Source label for human review: `闓`
...
- `obs-evo-cand-009657-route-category-staging`
...
- `obs-evo-cand-009657-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009657-route-evolution-graph`
