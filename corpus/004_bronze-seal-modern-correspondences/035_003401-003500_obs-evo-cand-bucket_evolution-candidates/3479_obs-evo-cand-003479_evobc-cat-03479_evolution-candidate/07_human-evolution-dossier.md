...
Project ID: `obs-evo-cand-003479`
...
- Project ID: `obs-evo-cand-003479`
- EVOBC category candidate ID: `evobc-evo-cat-03479`
- External category reference: `evobc-cat-03479`
- Source category ID: `03479`
- Source label for human review: `摩`
- Source codepoints: `U+6469`
...
- `obs-evo-cand-003479-route-category-staging`
...
- `obs-evo-cand-003479-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003479-route-evolution-graph`
