# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008714
...
- EVOBC candidate category: `evobc-evo-cat-08714`.
- Source label for search only: `跛`.
- Source codepoints for search only: `U+8DDB`.
