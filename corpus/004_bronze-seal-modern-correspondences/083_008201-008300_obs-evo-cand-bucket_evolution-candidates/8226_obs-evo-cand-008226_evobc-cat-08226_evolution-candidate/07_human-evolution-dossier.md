...
- External category reference: `evobc-cat-08226`
- Source category ID: `08226`
- Source label for human review: `誒`
- Source codepoints: `U+8A92`
...
- `obs-evo-cand-008226-route-category-staging`
...
- `obs-evo-cand-008226-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008226-route-evolution-graph`
