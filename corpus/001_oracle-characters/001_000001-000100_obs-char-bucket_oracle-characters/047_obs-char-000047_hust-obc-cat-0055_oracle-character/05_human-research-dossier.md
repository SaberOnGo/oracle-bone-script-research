# obs-char-000047 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/047_obs-char-000047_hust-obc-cat-0055_orac
  le-character/03_visual-assets/001_asset-000052_hust-obc-cat-0055_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0055/H_0055_60CB6_0.png`
- asset id: `asset-000052`
...
- source category: `0055`
- validation class: `46`
- source image route: `HUST-OBC/deciphered/0055/H_0055_60CB6_0.png`
- asset id: `asset-000052`
...
- dataset label text: `㐭`
- dataset label codepoints: `U+342D`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/005_obs-evo-can
  d-000005_evobc-cat-00005_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/005_obs-evo-cand-000005_evobc-cat-00005_evolu
...
- matched OBIMD main UIDs: `dxvqlu3dcd`
...
- filename catalog route clues: `catalog-like filename clue: H_0055
  (H_0055_60CB6_0.png)`
...
- Which source records identify obs-char-000047 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000047？
