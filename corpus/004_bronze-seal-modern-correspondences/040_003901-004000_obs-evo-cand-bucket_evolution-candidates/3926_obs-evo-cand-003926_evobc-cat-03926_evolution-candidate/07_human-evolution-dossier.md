...
- Project ID: `obs-evo-cand-003926`
- EVOBC category candidate ID: `evobc-evo-cat-03926`
- External category reference: `evobc-cat-03926`
- Source category ID: `03926`
- Source label for human review: `林`
- Source codepoints: `U+6797`
- Image reference count in source metadata: `83`
...
- `obs-evo-cand-003926-route-category-staging`
...
- `obs-evo-cand-003926-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003926-route-evolution-graph`
