...
- External category reference: `evobc-cat-05198`
- Source category ID: `05198`
- Source label for human review: `牑`
...
- `obs-evo-cand-005198-route-category-staging`
...
- `obs-evo-cand-005198-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005198-route-evolution-graph`
