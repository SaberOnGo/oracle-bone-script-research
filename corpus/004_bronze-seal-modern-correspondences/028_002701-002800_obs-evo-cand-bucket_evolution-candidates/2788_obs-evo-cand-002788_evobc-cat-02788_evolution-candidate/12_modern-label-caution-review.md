# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002788
...
- EVOBC candidate category: `evobc-evo-cat-02788`.
- Source label for search only: `弊`.
- Source codepoints for search only: `U+5F0A`.
