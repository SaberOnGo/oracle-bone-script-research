# Material Visual Observation / obs-comp-cand-001965 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001965`
- External reference / 外部参照: `obimd-sub-kf0yhslq5t`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018882_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h3nw474wwr/kf0yhslq5t/kf0yhslq5t.png`
- Checksum / 校验和:
  `cd237df54392afdaba9413bdc13d41abb4ca69bc7f6ce5bba51d191ef60e9e1a`
...
- Marked-pixel bounds: (80,20)–(170,228); span 91 × 209 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.90%。
- 痕迹范围：(80,20)–(170,228)；跨度91 × 209 px；痕迹矩形高于宽。
