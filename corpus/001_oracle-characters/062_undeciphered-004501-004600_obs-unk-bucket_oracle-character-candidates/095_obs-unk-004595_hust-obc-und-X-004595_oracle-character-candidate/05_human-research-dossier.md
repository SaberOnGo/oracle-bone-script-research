# obs-unk-004595 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/095_obs-unk-004595_h
  ust-obc-und-X-004595_oracle-character-candidate/03_visual-assets/001_asset
  -006188_hust-obc-und-X-004595_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/151/X_？_8328_1.png`
- asset id: `asset-006188`
...
- source class: `HUST-OBC/undeciphered/X/151/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/151/X_？_8328_1.png`
- asset id: `asset-006188`
...
- English observation: `Cross trace, central vertical, separate right curve,`
  `and hook recorded.`
- 中文观察: `已记录交叉横痕、中央竖痕、右侧分离弧痕和钩端。`
...
- Which source records identify obs-unk-004595 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004595？
