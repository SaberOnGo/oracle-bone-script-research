# Material Visual Observation / obs-comp-cand-002593 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002593`
- External reference / 外部参照: `obimd-sub-hi677d7dut`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021132_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1md1xx6bfm/hi677d7dut/hi677d7dut.png`
- Checksum / 校验和:
  `b53a4f61a8ef09e820f0f046ef67e7b6f7482c77a9e70d8fb715668713d48898`
...
- Marked-pixel bounds: (89,21)–(160,222); span 72 × 202 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.93%。
- 痕迹范围：(89,21)–(160,222)；跨度72 × 202 px；痕迹矩形高于宽。
