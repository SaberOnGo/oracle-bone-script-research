...
- External category reference: `evobc-cat-12296`
- Source category ID: `12296`
- Source label for human review: `𧻀`
- Source codepoints: `U+27EC0`
...
- `obs-evo-cand-012296-route-category-staging`
...
- `obs-evo-cand-012296-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012296-route-evolution-graph`
