# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006837
...
- EVOBC candidate category: `evobc-evo-cat-06837`.
- Source label for search only: `羋`.
- Source codepoints for search only: `U+7F8B`.
