...
Project ID: `obs-evo-cand-012914`
...
- Project ID: `obs-evo-cand-012914`
- EVOBC category candidate ID: `evobc-evo-cat-12914`
- External category reference: `evobc-cat-12914`
- Source category ID: `12914`
- Source label for human review: `𫄊`
- Source codepoints: `U+2B10A`
...
- `obs-evo-cand-012914-route-category-staging`
...
- `obs-evo-cand-012914-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012914-route-evolution-graph`
