...
Project ID: `obs-evo-cand-013582`
...
- Project ID: `obs-evo-cand-013582`
- EVOBC category candidate ID: `evobc-evo-cat-13582`
- External category reference: `evobc-cat-13582`
- Source category ID: `13582`
- Source label for human review: `𭺟`
- Source codepoints: `U+2DE9F`
...
- `obs-evo-cand-013582-route-category-staging`
...
- `obs-evo-cand-013582-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013582-route-evolution-graph`
