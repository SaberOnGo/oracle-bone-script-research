...
- External category reference: `evobc-cat-00310`
- Source category ID: `00310`
- Source label for human review: `䊑`
- Source codepoints: `U+4291`
...
- `obs-evo-cand-000310-route-category-staging`
...
- `obs-evo-cand-000310-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000310-route-evolution-graph`
