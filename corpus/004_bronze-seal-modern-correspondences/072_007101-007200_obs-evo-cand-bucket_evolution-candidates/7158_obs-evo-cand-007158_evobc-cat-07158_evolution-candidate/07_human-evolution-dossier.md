...
- External category reference: `evobc-cat-07158`
- Source category ID: `07158`
- Source label for human review: `臣`
- Source codepoints: `U+81E3`
- Image reference count in source metadata: `329`
...
- `obs-evo-cand-007158-route-category-staging`
...
- `obs-evo-cand-007158-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007158-route-evolution-graph`
