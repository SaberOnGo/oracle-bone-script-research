...
Project ID: `obs-evo-cand-000745`
...
- Project ID: `obs-evo-cand-000745`
- EVOBC category candidate ID: `evobc-evo-cat-00745`
- External category reference: `evobc-cat-00745`
- Source category ID: `00745`
- Source label for human review: `代`
- Source codepoints: `U+4EE3`
...
- `obs-evo-cand-000745-route-category-staging`
...
- `obs-evo-cand-000745-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000745-route-evolution-graph`
