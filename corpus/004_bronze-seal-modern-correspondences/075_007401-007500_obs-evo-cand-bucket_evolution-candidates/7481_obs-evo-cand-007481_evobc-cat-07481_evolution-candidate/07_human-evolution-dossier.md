...
Project ID: `obs-evo-cand-007481`
...
- Project ID: `obs-evo-cand-007481`
- EVOBC category candidate ID: `evobc-evo-cat-07481`
- External category reference: `evobc-cat-07481`
- Source category ID: `07481`
- Source label for human review: `葭`
- Source codepoints: `U+846D`
...
- `obs-evo-cand-007481-route-category-staging`
...
- `obs-evo-cand-007481-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007481-route-evolution-graph`
