...
- External category reference: `evobc-cat-01498`
- Source category ID: `01498`
- Source label for human review: `名`
...
- `obs-evo-cand-001498-route-category-staging`
...
- `obs-evo-cand-001498-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001498-route-evolution-graph`
