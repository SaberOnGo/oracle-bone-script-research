...
- External category reference: `evobc-cat-08200`
- Source category ID: `08200`
- Source label for human review: `話`
- Source codepoints: `U+8A71`
...
- `obs-evo-cand-008200-route-category-staging`
...
- `obs-evo-cand-008200-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008200-route-evolution-graph`
