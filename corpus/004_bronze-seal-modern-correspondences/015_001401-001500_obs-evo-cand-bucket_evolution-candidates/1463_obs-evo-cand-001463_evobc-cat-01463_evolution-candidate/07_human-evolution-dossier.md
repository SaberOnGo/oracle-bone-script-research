...
- External category reference: `evobc-cat-01463`
- Source category ID: `01463`
- Source label for human review: `叙`
- Source codepoints: `U+53D9`
...
- `obs-evo-cand-001463-route-category-staging`
...
- `obs-evo-cand-001463-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001463-route-evolution-graph`
