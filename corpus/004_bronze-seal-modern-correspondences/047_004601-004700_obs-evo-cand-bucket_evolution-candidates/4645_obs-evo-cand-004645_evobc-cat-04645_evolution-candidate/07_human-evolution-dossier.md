...
- Project ID: `obs-evo-cand-004645`
- EVOBC category candidate ID: `evobc-evo-cat-04645`
- External category reference: `evobc-cat-04645`
- Source category ID: `04645`
- Source label for human review: `派`
- Source codepoints: `U+6D3E`
...
- `obs-evo-cand-004645-route-category-staging`
...
- `obs-evo-cand-004645-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004645-route-evolution-graph`
