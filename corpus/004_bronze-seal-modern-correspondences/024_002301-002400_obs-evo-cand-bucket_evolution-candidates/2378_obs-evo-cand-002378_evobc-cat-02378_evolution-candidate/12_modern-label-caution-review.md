# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002378
...
- EVOBC candidate category: `evobc-evo-cat-02378`.
- Source label for search only: `宜`.
- Source codepoints for search only: `U+5B9C`.
