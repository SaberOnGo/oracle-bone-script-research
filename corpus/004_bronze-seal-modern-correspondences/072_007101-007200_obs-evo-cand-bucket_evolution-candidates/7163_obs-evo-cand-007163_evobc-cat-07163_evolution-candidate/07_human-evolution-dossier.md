...
- External category reference: `evobc-cat-07163`
- Source category ID: `07163`
- Source label for human review: `臨`
- Source codepoints: `U+81E8`
...
- `obs-evo-cand-007163-route-category-staging`
...
- `obs-evo-cand-007163-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007163-route-evolution-graph`
