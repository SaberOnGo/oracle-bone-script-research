# obs-unk-004567 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004567`
- primary external id: `hust-obc-und-X-004567`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/067_obs-unk-004567_h
  ust-obc-und-X-004567_oracle-character-candidate/03_visual-assets/001_asset
  -006160_hust-obc-und-X-004567_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/123/X_？_8303_1.png`
- asset id: `asset-006160`
...
- source class: `HUST-OBC/undeciphered/X/123/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/123/X_？_8303_1.png`
- asset id: `asset-006160`
...
- English observation: `Upper bar, middle band, and lower loop recorded.`
- 中文观察: `已记录上部横痕、中部横带和下部环痕。`
...
- Which source records identify obs-unk-004567 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004567？
