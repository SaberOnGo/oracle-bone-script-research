...
- Project ID: `obs-evo-cand-011582`
- EVOBC category candidate ID: `evobc-evo-cat-11582`
- External category reference: `evobc-cat-11582`
- Source category ID: `11582`
- Source label for human review: `𤔌`
- Source codepoints: `U+2450C`
...
- `obs-evo-cand-011582-route-category-staging`
...
- `obs-evo-cand-011582-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011582-route-evolution-graph`
