...
- External category reference: `evobc-cat-05968`
- Source category ID: `05968`
- Source label for human review: `社`
- Source codepoints: `U+793E`
...
- `obs-evo-cand-005968-route-category-staging`
...
- `obs-evo-cand-005968-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005968-route-evolution-graph`
