...
- External category reference: `evobc-cat-05301`
- Source category ID: `05301`
- Source label for human review: `猪`
...
- `obs-evo-cand-005301-route-category-staging`
...
- `obs-evo-cand-005301-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005301-route-evolution-graph`
