...
- External category reference: `evobc-cat-10749`
- Source category ID: `10749`
- Source label for human review: `龔`
...
- `obs-evo-cand-010749-route-category-staging`
...
- `obs-evo-cand-010749-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010749-route-evolution-graph`
