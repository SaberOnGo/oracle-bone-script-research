# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002634
...
| --- | --- | --- | --- |
| `obimd-glyph-link-039963` | 󿭗 | `U+FFB57` | `reviewed_metadata_only` |
| `obimd-glyph-link-039964` | 󾵻 | `U+FED7B` | `reviewed_metadata_only` |
