...
- External category reference: `evobc-cat-02546`
- Source category ID: `02546`
- Source label for human review: `岱`
...
- `obs-evo-cand-002546-route-category-staging`
...
- `obs-evo-cand-002546-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002546-route-evolution-graph`
