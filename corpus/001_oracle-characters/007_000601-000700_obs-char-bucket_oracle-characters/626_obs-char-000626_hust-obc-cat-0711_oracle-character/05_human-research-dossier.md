# obs-char-000626 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000626`
- primary external id: `hust-obc-cat-0711`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/626_obs-char-000626_hust-obc-cat-0711_orac
  le-character/03_visual-assets/001_asset-000631_hust-obc-cat-0711_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0711/G_0711_甲骨文.png`
- asset id: `asset-000631`
...
- source category: `0711`
- validation class: `625`
- source image route: `HUST-OBC/deciphered/0711/G_0711_甲骨文.png`
- asset id: `asset-000631`
...
- English observation: `Two upright stems are joined by a long middle bar;
  the left carries paired short side bars, while the right has a forked top
  and broad bottom foot.`
- 中文观察: `两条直立干由长中横栏连接；左干带成对短侧栏，右干有叉顶和宽底脚。`
...
- dataset label text: `㚽`
- dataset label codepoints: `U+36BD`
...
- Which source records identify obs-char-000626 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000626？
