# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002651
...
- EVOBC candidate category: `evobc-evo-cat-02651`.
- Source label for search only: `帚`.
- Source codepoints for search only: `U+5E1A`.
