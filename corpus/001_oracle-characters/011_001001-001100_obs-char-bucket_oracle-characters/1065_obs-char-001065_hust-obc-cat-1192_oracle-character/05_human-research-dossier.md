# obs-char-001065 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001065`
- primary external id: `hust-obc-cat-1192`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1065_obs-char-001065_hust-obc-cat-1192_ora
  cle-character/03_visual-assets/001_asset-001070_hust-obc-cat-1192_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1192/G_1192_乙3394(甲).png`
- asset id: `asset-001070`
...
- source category: `1192`
- validation class: `1064`
- source image route: `HUST-OBC/deciphered/1192/G_1192_乙3394(甲).png`
- asset id: `asset-001070`
...
- English observation: `A long curved upright has a short left branch, a
  hooked upper-right turn, and two thin lower strokes.`
- 中文观察: `长弯曲直立笔有左侧短分枝、右上钩状转笔和两条纤细下部笔。`
...
- dataset label text: `㢞`
- dataset label codepoints: `U+389E`
...
- Which source records identify obs-char-001065 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001065？
