...
Project ID: `obs-insc-cw-cand-000483`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000483`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000483` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2400` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `299` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `365` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `41474` [route_present_image_or_text_not_collected]
