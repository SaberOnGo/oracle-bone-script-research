# Material Visual Observation / obs-comp-cand-001062 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001062`
- External reference / 外部参照: `obimd-sub-hvm3m8ypgu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014612_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hvm3m8ypgu/hvm3m8ypgu/hvm3m8ypgu.png`
- Checksum / 校验和:
  `a2a5ff22328641ce2f5ddf2d690a5393c5c3a2769662710b3278dcab3e458ba5`
...
- Marked-pixel bounds: (62,57)–(187,197); span 126 × 141 px; the marked
...
- 痕迹范围：(62,57)–(187,197)；跨度126 × 141 px；痕迹矩形近方形。
