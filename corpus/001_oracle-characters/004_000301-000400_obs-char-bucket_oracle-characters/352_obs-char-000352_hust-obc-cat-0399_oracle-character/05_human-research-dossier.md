# obs-char-000352 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000352`
- primary external id: `hust-obc-cat-0399`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/352_obs-char-000352_hust-obc-cat-0399_orac
  le-character/03_visual-assets/001_asset-000357_hust-obc-cat-0399_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0399/G_0399_乙360合22027子組.png`
- asset id: `asset-000357`
...
- source category: `0399`
- validation class: `351`
- source image route: `HUST-OBC/deciphered/0399/G_0399_乙360合22027子組.png`
- asset id: `asset-000357`
...
- English observation: `Three separated upright forms are visible, with
  short horizontal or branching marks near their upper and lower sections.`
- 中文观察: `图像可见三个分离的直立形体，上下部附近有短横或分叉痕迹。`
...
- dataset label text: `㖅`
- dataset label codepoints: `U+3585`
...
- filename catalog route clues: `Heji-like filename clue: 合22027
  (G_0399_乙360合22027子組.png)`
...
- Which source records identify obs-char-000352 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000352？
