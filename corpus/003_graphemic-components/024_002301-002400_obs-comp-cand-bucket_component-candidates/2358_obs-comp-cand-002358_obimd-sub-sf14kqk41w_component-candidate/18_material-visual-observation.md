# Material Visual Observation / obs-comp-cand-002358 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002358`
- External reference / 外部参照: `obimd-sub-sf14kqk41w`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020429_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rp1zjtuksu/sf14kqk41w/sf14kqk41w.png`
- Checksum / 校验和:
  `66ca9063c041b869dc20c1e4834230129c843b16cc58bd5b72b44fd5d549a20b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.46%.
- Marked-pixel bounds: (73,43)–(175,211); span 103 × 169 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.46%。
- 痕迹范围：(73,43)–(175,211)；跨度103 × 169 px；痕迹矩形高于宽。
