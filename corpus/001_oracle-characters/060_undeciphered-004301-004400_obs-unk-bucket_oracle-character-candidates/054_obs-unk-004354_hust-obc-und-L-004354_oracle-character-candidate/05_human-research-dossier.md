# obs-unk-004354 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004354`
- primary external id: `hust-obc-und-L-004354`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/054_obs-unk-004354_h
  ust-obc-und-L-004354_oracle-character-candidate/03_visual-assets/001_asset
  -005947_hust-obc-und-L-004354_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4354/L_？_9652.jpg`
- asset id: `asset-005947`
...
- source class: `HUST-OBC/undeciphered/L/4354/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4354/L_？_9652.jpg`
- asset id: `asset-005947`
...
- English observation: `Side curves, central vertical mark, and lower bar`
  `recorded.`
- 中文观察: `已记录两侧弧痕、中央纵痕和下部横痕。`
...
- Which source records identify obs-unk-004354 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004354？
