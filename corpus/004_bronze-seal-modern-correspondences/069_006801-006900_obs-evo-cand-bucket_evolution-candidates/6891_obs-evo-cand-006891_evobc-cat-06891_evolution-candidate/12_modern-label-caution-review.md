# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006891
...
- EVOBC candidate category: `evobc-evo-cat-06891`.
- Source label for search only: `翦`.
- Source codepoints for search only: `U+7FE6`.
