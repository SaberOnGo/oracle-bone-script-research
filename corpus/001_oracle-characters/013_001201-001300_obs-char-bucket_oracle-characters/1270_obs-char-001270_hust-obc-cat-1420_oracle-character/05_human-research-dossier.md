# obs-char-001270 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1270_obs-char-001270_hust-obc-cat-1420_ora
  cle-character/03_visual-assets/001_asset-001275_hust-obc-cat-1420_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1420/G_1420_乙7978反合6657反賓組.png`
- asset id: `asset-001275`
...
- source category: `1420`
- validation class: `1269`
- source image route: `HUST-OBC/deciphered/1420/G_1420_乙7978反合6657反賓組.png`
- asset id: `asset-001275`
...
- English observation: `A broad rounded rectangular enclosure rests on two
  short supports above a long horizontal baseline.`
...
- dataset label text: `㦂`
- dataset label codepoints: `U+3982`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/134_obs-evo-can
  d-000134_evobc-cat-00134_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/134_obs-evo-cand-000134_evobc-cat-00134_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合6657
...
- Which source records identify obs-char-001270 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001270？
