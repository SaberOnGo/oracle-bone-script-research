...
- External category reference: `evobc-cat-12314`
- Source category ID: `12314`
- Source label for human review: `𨀥`
- Source codepoints: `U+28025`
...
- `obs-evo-cand-012314-route-category-staging`
...
- `obs-evo-cand-012314-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012314-route-evolution-graph`
