...
- Project ID: `obs-evo-cand-007094`
- EVOBC category candidate ID: `evobc-evo-cat-07094`
- External category reference: `evobc-cat-07094`
- Source category ID: `07094`
- Source label for human review: `腒`
- Source codepoints: `U+8152`
...
- `obs-evo-cand-007094-route-category-staging`
...
- `obs-evo-cand-007094-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007094-route-evolution-graph`
