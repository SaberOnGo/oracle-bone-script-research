# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006293
...
- EVOBC candidate category: `evobc-evo-cat-06293`.
- Source label for search only: `算`.
- Source codepoints for search only: `U+7B97`.
