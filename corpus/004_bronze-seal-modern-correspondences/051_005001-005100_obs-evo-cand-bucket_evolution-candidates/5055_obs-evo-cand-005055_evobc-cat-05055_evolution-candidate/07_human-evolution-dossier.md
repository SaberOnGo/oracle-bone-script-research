...
- External category reference: `evobc-cat-05055`
- Source category ID: `05055`
- Source label for human review: `炱`
- Source codepoints: `U+70B1`
...
- `obs-evo-cand-005055-route-category-staging`
...
- `obs-evo-cand-005055-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005055-route-evolution-graph`
