# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008657
...
- EVOBC candidate category: `evobc-evo-cat-08657`.
- Source label for search only: `赫`.
- Source codepoints for search only: `U+8D6B`.
