...
Project ID: `obs-evo-cand-006731`
...
- Project ID: `obs-evo-cand-006731`
- EVOBC category candidate ID: `evobc-evo-cat-06731`
- External category reference: `evobc-cat-06731`
- Source category ID: `06731`
- Source label for human review: `纵`
- Source codepoints: `U+7EB5`
...
- `obs-evo-cand-006731-route-category-staging`
...
- `obs-evo-cand-006731-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006731-route-evolution-graph`
