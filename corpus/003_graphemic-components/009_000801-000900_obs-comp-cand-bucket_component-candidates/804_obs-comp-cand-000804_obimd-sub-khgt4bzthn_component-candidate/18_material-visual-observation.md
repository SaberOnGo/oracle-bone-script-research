# Material Visual Observation / obs-comp-cand-000804 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000804`
- External reference / 外部参照: `obimd-sub-khgt4bzthn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013601_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cawhttc4j5/khgt4bzthn/khgt4bzthn.png`
- Checksum / 校验和:
  `fdd19670a6e311784aa94c42ff187d82aec6bc9c73282cff5c3b1491c4396ce6`
...
- Marked-pixel bounds: (67,30)–(182,222); span 116 × 193 px; the marked
...
- 痕迹范围：(67,30)–(182,222)；跨度116 × 193 px；痕迹矩形高于宽。
