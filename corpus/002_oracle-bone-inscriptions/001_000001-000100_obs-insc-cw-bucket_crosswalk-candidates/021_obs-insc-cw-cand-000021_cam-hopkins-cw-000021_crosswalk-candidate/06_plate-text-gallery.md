...
Project ID: `obs-insc-cw-cand-000021`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000021`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000021` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y125` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `146` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `548` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `40384` [route_present_image_or_text_not_collected]
