# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002258
...
| --- | --- | --- | --- |
| `obimd-glyph-link-034895` | 󼾊 | `U+FCF8A` | `reviewed_metadata_only` |
| `obimd-glyph-link-034896` | 󼾋 | `U+FCF8B` | `reviewed_metadata_only` |
| `obimd-glyph-link-034897` | 󼾌 | `U+FCF8C` | `reviewed_metadata_only` |
