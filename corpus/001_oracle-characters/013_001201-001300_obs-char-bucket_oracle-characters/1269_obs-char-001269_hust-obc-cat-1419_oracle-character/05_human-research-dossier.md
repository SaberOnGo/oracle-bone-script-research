# obs-char-001269 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001269`
- primary external id: `hust-obc-cat-1419`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1269_obs-char-001269_hust-obc-cat-1419_ora
  cle-character/03_visual-assets/001_asset-001274_hust-obc-cat-1419_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1419/G_1419_佚113合24471出組.png`
- asset id: `asset-001274`
...
- source category: `1419`
- validation class: `1268`
- source image route: `HUST-OBC/deciphered/1419/G_1419_佚113合24471出組.png`
- asset id: `asset-001274`
...
- English observation: `A narrow pale form has two long outer curves that
  converge toward a small U-shaped lower enclosure.`
- 中文观察: `狭长浅色形体有两条长外侧弧线，向下汇聚至小型 U 形下部框形。`
...
- dataset label text: `㦁`
- dataset label codepoints: `U+3981`
...
- filename catalog route clues: `Heji-like filename clue: 合24471
  (G_1419_佚113合24471出組.png)`
...
- Which source records identify obs-char-001269 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001269？
