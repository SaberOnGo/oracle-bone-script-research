# obs-unk-004821 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004821`
- primary external id: `hust-obc-und-X-004821`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/021_obs-unk-004821_h
  ust-obc-und-X-004821_oracle-character-candidate/03_visual-assets/001_asset
  -006414_hust-obc-und-X-004821_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/377/X_？_7361_1.png`
- asset id: `asset-006414`
...
- source class: `HUST-OBC/undeciphered/X/377/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/377/X_？_7361_1.png`
- asset id: `asset-006414`
...
- English observation: `upper curved opening and lower paired openings`
- 中文观察: `上部曲线开口和下部成对开口`
...
- Which source records identify obs-unk-004821 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004821？
