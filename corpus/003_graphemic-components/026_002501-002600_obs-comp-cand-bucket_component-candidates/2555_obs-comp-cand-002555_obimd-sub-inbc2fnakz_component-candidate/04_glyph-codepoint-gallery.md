# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002555
...
| --- | --- | --- | --- |
| `obimd-glyph-link-039226` | 󾠑 | `U+FE811` | `reviewed_metadata_only` |
| `obimd-glyph-link-039227` | 󾠒 | `U+FE812` | `reviewed_metadata_only` |
