# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006545
...
- EVOBC candidate category: `evobc-evo-cat-06545`.
- Source label for search only: `綜`.
- Source codepoints for search only: `U+7D9C`.
