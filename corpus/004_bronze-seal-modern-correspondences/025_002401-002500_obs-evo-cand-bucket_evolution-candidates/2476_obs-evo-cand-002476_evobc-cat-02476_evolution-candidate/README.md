# obs-evo-cand-002476 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-02476`
- Source label: `尞`
- Source codepoints: `U+5C1E`
- Image reference count: `118`
- Era token counts: `BI:2;OBC:115;SS:1`
- Source token counts: `Book:66;Web:52`
