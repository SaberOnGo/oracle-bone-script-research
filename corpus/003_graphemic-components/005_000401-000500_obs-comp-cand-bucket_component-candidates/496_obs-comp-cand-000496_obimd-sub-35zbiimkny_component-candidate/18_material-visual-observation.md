# Material Visual Observation / obs-comp-cand-000496 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000496`
- External reference / 外部参照: `obimd-sub-35zbiimkny`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012732_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ecbetcendb/35zbiimkny/35zbiimkny.png`
- Checksum / 校验和:
  `5c866bf50bf512db56f8083a61506ada929264c9877586c9718495600053788b`
...
- Marked-pixel bounds: (80,19)–(169,231); span 90 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.03%。
- 痕迹范围：(80,19)–(169,231)；跨度90 × 213 px；痕迹矩形高于宽。
