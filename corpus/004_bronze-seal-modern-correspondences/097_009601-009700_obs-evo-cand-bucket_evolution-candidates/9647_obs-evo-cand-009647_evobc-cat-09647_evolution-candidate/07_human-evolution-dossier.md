...
- Project ID: `obs-evo-cand-009647`
- EVOBC category candidate ID: `evobc-evo-cat-09647`
- External category reference: `evobc-cat-09647`
- Source category ID: `09647`
- Source label for human review: `闅`
- Source codepoints: `U+95C5`
...
- `obs-evo-cand-009647-route-category-staging`
...
- `obs-evo-cand-009647-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009647-route-evolution-graph`
