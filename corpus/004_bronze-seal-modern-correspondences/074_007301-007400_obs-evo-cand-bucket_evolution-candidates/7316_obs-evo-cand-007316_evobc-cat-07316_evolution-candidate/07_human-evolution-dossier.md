...
- Project ID: `obs-evo-cand-007316`
- EVOBC category candidate ID: `evobc-evo-cat-07316`
- External category reference: `evobc-cat-07316`
- Source category ID: `07316`
- Source label for human review: `茢`
- Source codepoints: `U+8322`
...
- `obs-evo-cand-007316-route-category-staging`
...
- `obs-evo-cand-007316-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007316-route-evolution-graph`
