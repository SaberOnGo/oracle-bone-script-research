...
- External category reference: `evobc-cat-04564`
- Source category ID: `04564`
- Source label for human review: `沽`
- Source codepoints: `U+6CBD`
...
- `obs-evo-cand-004564-route-category-staging`
...
- `obs-evo-cand-004564-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004564-route-evolution-graph`
