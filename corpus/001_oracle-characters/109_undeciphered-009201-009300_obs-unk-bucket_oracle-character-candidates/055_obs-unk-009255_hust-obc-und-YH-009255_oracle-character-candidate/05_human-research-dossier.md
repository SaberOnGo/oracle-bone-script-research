# obs-unk-009255 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/109_undeciphered-009
  201-009300_obs-unk-bucket_oracle-character-candidates/055_obs-unk-009255_h
  ust-obc-und-YH-009255_oracle-character-candidate/03_visual-assets/001_asse
  t-010846_hust-obc-und-YH-009255_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6142C/H_？_6142C_0.png`
- asset id: `asset-010846`
...
- source class: `HUST-OBC/undeciphered/Y+H/6142C/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6142C/H_？_6142C_0.png`
- asset id: `asset-010846`
...
- Which source records identify obs-unk-009255 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009255？
