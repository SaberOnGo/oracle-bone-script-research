...
- External category reference: `evobc-cat-01330`
- Source category ID: `01330`
- Source label for human review: `匋`
- Source codepoints: `U+530B`
- Image reference count in source metadata: `60`
...
- `obs-evo-cand-001330-route-category-staging`
...
- `obs-evo-cand-001330-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001330-route-evolution-graph`
