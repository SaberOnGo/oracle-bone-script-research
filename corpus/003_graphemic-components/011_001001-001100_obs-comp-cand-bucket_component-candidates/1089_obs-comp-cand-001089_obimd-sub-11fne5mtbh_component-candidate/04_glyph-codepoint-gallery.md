# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001089
...
| --- | --- | --- | --- |
| `obimd-glyph-link-016233` | 󶑕 | `U+F6455` | `reviewed_metadata_only` |
| `obimd-glyph-link-016234` | 󶑖 | `U+F6456` | `reviewed_metadata_only` |
| `obimd-glyph-link-016235` | 󶑗 | `U+F6457` | `reviewed_metadata_only` |
| `obimd-glyph-link-016236` | 󶑙 | `U+F6459` | `reviewed_metadata_only` |
