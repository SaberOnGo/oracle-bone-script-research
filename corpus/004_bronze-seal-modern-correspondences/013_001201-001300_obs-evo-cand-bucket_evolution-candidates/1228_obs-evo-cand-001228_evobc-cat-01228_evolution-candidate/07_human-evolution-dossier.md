...
Project ID: `obs-evo-cand-001228`
...
- Project ID: `obs-evo-cand-001228`
- EVOBC category candidate ID: `evobc-evo-cat-01228`
- External category reference: `evobc-cat-01228`
- Source category ID: `01228`
- Source label for human review: `剛`
- Source codepoints: `U+525B`
...
- `obs-evo-cand-001228-route-category-staging`
...
- `obs-evo-cand-001228-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001228-route-evolution-graph`
