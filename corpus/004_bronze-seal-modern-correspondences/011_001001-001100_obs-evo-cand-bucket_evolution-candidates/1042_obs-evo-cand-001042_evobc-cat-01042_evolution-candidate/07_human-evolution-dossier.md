...
Project ID: `obs-evo-cand-001042`
...
- Project ID: `obs-evo-cand-001042`
- EVOBC category candidate ID: `evobc-evo-cat-01042`
- External category reference: `evobc-cat-01042`
- Source category ID: `01042`
- Source label for human review: `儉`
- Source codepoints: `U+5109`
...
- `obs-evo-cand-001042-route-category-staging`
...
- `obs-evo-cand-001042-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001042-route-evolution-graph`
