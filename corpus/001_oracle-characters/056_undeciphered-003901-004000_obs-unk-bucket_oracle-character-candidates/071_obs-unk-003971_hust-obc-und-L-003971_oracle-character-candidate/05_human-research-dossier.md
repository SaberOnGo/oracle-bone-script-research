# obs-unk-003971 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/071_obs-unk-003971_h
  ust-obc-und-L-003971_oracle-character-candidate/03_visual-assets/001_asset
  -005564_hust-obc-und-L-003971_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3971/L_？_8390.jpg`
- asset id: `asset-005564`
...
- source class: `HUST-OBC/undeciphered/L/3971/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3971/L_？_8390.jpg`
- asset id: `asset-005564`
...
- English observation: A small upper enclosure is followed by descending curved
  and diagonal traces, with a short separate mark at the left.
- 中文观察：小上部围合轮廓下方有弧向和斜向下行痕迹，左侧有短分开痕迹。
...
- Which source records identify obs-unk-003971 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003971？
