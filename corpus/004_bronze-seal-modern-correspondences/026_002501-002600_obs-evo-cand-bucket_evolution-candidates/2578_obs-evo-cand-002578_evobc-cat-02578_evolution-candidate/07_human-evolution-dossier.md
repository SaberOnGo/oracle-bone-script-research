...
- External category reference: `evobc-cat-02578`
- Source category ID: `02578`
- Source label for human review: `嵏`
...
- `obs-evo-cand-002578-route-category-staging`
...
- `obs-evo-cand-002578-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002578-route-evolution-graph`
