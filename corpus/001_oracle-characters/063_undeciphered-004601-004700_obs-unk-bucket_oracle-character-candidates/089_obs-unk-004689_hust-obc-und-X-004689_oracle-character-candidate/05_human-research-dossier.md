# obs-unk-004689 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004689`
- primary external id: `hust-obc-und-X-004689`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/089_obs-unk-004689_h
  ust-obc-und-X-004689_oracle-character-candidate/03_visual-assets/001_asset
  -006282_hust-obc-und-X-004689_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/245/X_？_8413_1.png`
- asset id: `asset-006282`
...
- source class: `HUST-OBC/undeciphered/X/245/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/245/X_？_8413_1.png`
- asset id: `asset-006282`
...
- English observation: `curved band with detached triangular lower mark`
- 中文观察: `带分离下部三角痕迹的弯曲笔画带`
...
- Which source records identify obs-unk-004689 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004689？
