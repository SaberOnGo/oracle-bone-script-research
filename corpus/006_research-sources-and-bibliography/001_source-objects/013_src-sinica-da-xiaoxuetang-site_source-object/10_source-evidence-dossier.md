...
- Source URL / 来源链接: https://sinica.digitalarchives.tw/site_6071.html
...
### Route 001
- Download ID / 下载 ID: dl-sinica-da-xiaoxuetang-site
- Artifact kind / 资料类型: institutional_portal_page
...
### Route 001
- Field map ID / 字段映射 ID: field-map-000052
- Source level / 来源层级: portal_description
- Source field or unit / 来源字段或单位: 字形涵蓋甲骨文;金文;戰國文字;小篆;楷書
- Source meaning / 来源含义: Digital Archives profile statement on Xiaoxuetang glyph
  coverage
- Target record type / 目标记录类型: source_reference
- Target project field / 目标字段: source_scope; script_coverage
- Import action / 导入动作: Use as portal-level evidence for selecting Xiaoxuetang
  as a cross-script comparison backbone
- Rights boundary / 权利边界: Portal text is not a formal row-level glyph import
- Evidence download ID / 证据下载 ID: dl-sinica-da-xiaoxuetang-site
- Review status / 复核状态: reviewed_metadata_only

## Metadata Profile Evidence / 元数据概况证据

### Route 001
- Profile ID / 概况 ID: metadata-profile-000044
- Evidence download ID / 证据下载 ID: dl-sinica-da-xiaoxuetang-site
- Metadata file / 元数据文件: site_6071.html
- Profile metric / 概况指标: xiaoxuetang_glyph_total_over
- Profile value / 概况值: 180000
- Profile unit / 概况单位: glyph_records
- Import relevance / 导入相关性: Records official portal statement that Xiaoxuetang
  covers over 180000 glyph records across scripts
- Caution / 提醒: Portal-level count is source-context evidence only
- Review status / 复核状态: reviewed_metadata_only

### Route 002
- Profile ID / 概况 ID: metadata-profile-000045
- Evidence download ID / 证据下载 ID: dl-sinica-da-xiaoxuetang-site
- Metadata file / 元数据文件: site_6071.html
- Profile metric / 概况指标: xiaoxuetang_phonology_total_over
- Profile value / 概况值: 1000000
- Profile unit / 概况单位: phonology_records
- Import relevance / 导入相关性: Records official portal statement that Xiaoxuetang
  covers over 1000000 phonology records
- Caution / 提醒: Phonology scope helps future cross-disciplinary design but is
  not oracle-character import
- Review status / 复核状态: reviewed_metadata_only

### Route 003
- Profile ID / 概况 ID: metadata-profile-000046
- Evidence download ID / 证据下载 ID: dl-sinica-da-xiaoxuetang-site
- Metadata file / 元数据文件: site_6071.html
- Profile metric / 概况指标: xiaoxuetang_dictionary_index_total_over
- Profile value / 概况值: 250000
- Profile unit / 概况单位: dictionary_index_records
- Import relevance / 导入相关性: Records official portal statement that Xiaoxuetang
  covers over 250000 dictionary-index records
- Caution / 提醒: Dictionary-index scope is source-context evidence only
- Review status / 复核状态: reviewed_metadata_only
