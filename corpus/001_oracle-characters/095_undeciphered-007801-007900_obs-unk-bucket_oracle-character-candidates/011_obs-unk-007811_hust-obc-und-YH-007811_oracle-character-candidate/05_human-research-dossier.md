# obs-unk-007811 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-007811`
- primary external id: `hust-obc-und-YH-007811`
...
- local review image route: `corpus/001_oracle-characters/095_undeciphered-007
  801-007900_obs-unk-bucket_oracle-character-candidates/011_obs-unk-007811_h
  ust-obc-und-YH-007811_oracle-character-candidate/03_visual-assets/001_asse
  t-009402_hust-obc-und-YH-007811_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/603B1/Y_？_603B1.jpg`
- asset id: `asset-009402`
...
- source class: `HUST-OBC/undeciphered/Y+H/603B1/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/603B1/Y_？_603B1.jpg`
- asset id: `asset-009402`
...
- Which source records identify obs-unk-007811 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007811？
