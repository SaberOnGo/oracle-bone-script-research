# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001597
...
- EVOBC candidate category: `evobc-evo-cat-01597`.
- Source label for search only: `哿`.
- Source codepoints for search only: `U+54FF`.
