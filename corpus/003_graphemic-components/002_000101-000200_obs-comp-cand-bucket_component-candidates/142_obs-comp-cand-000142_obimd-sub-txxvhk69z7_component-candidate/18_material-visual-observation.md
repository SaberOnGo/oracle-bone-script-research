# Material Visual Observation / obs-comp-cand-000142 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000142`
- External reference / 外部参照: `obimd-sub-txxvhk69z7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011554_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/yfnx5cwgq6/txxvhk69z7/txxvhk69z7.png`
- Checksum / 校验和:
  `8bbe05d925f60ac99c7316fe3eea612b76378860a2e5b88beea86cbf4da34609`
...
- Marked-pixel bounds: (48,32)–(201,215); span 154 × 184 px; the marked
...
- 痕迹范围：(48,32)–(201,215)；跨度154 × 184 px；痕迹矩形近方形。
