# Material Visual Observation / obs-comp-cand-001267 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001267`
- External reference / 外部参照: `obimd-sub-frmptf4le7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015505_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/frmptf4le7/frmptf4le7/frmptf4le7.png`
- Checksum / 校验和:
  `32c1227db84f9c7e5d07dd8db07442697e4bbe5ebf4b7ba9481130767f44088b`
...
- Marked-pixel bounds: (69,39)–(186,207); span 118 × 169 px; the marked
...
- 痕迹范围：(69,39)–(186,207)；跨度118 × 169 px；痕迹矩形高于宽。
