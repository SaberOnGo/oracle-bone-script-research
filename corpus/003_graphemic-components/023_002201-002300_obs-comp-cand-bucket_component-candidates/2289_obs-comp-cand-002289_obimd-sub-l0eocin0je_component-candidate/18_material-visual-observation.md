# Material Visual Observation / obs-comp-cand-002289 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002289`
- External reference / 外部参照: `obimd-sub-l0eocin0je`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020286_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4lgdy5a4ta/l0eocin0je/l0eocin0je.png`
- Checksum / 校验和:
  `b7c61aff367f022468261f5f88ae20755aaa46e16c8785eeaade7f64f836e8ca`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.90%.
- Marked-pixel bounds: (73,23)–(181,224); span 109 × 202 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.90%。
- 痕迹范围：(73,23)–(181,224)；跨度109 × 202 px；痕迹矩形高于宽。
