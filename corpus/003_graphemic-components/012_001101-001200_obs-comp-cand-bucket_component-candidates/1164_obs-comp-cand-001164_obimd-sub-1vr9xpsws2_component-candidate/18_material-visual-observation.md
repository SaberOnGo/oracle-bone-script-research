# Material Visual Observation / obs-comp-cand-001164 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001164`
- External reference / 外部参照: `obimd-sub-1vr9xpsws2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015354_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1vr9xpsws2/1vr9xpsws2/1vr9xpsws2.png`
- Checksum / 校验和:
  `54dc5ffca7acb90d26ae99914ee469ea46e6b7ea75185040a758e1f114a22004`
...
- Marked-pixel bounds: (77,38)–(172,211); span 96 × 174 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.85%。
- 痕迹范围：(77,38)–(172,211)；跨度96 × 174 px；痕迹矩形高于宽。
