# obs-unk-004425 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004425`
- primary external id: `hust-obc-und-L-004425`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/025_obs-unk-004425_h
  ust-obc-und-L-004425_oracle-character-candidate/03_visual-assets/001_asset
  -006018_hust-obc-und-L-004425_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4425/L_？_9924.jpg`
- asset id: `asset-006018`
...
- source class: `HUST-OBC/undeciphered/L/4425/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4425/L_？_9924.jpg`
- asset id: `asset-006018`
...
- English observation: `Crossing upper traces descend toward`
  `a darker lower junction.`
- 中文观察: `上部交叉痕迹向下延至较深的下部连接处。`
...
- Which source records identify obs-unk-004425 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004425？
