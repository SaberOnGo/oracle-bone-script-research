# Material Visual Observation / obs-comp-cand-001772 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001772`
- External reference / 外部参照: `obimd-sub-8sbbzthl9w`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017973_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8sbbzthl9w/8sbbzthl9w/8sbbzthl9w.png`
- Checksum / 校验和:
  `532d2c9a8eecaee1034e12326c9110f6ef0850a7c3da81fdf3fda31b51c31acb`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.84%.
- Marked-pixel bounds: (75,34)–(171,204); span 97 × 171 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.84%。
- 痕迹范围：(75,34)–(171,204)；跨度97 × 171 px；痕迹矩形高于宽。
