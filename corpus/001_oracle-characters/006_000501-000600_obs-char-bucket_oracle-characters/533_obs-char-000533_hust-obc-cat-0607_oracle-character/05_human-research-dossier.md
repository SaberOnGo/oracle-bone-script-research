# obs-char-000533 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/533_obs-char-000533_hust-obc-cat-0607_orac
  le-character/03_visual-assets/001_asset-000538_hust-obc-cat-0607_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0607/G_0607_乙1519合21987子組.png`
- asset id: `asset-000538`
...
- source category: `0607`
- validation class: `532`
- source image route: `HUST-OBC/deciphered/0607/G_0607_乙1519合21987子組.png`
- asset id: `asset-000538`
...
- English observation: `A capped central vertical crosses a horizontal bar
  with short downward strokes near both ends; a small detached mark stands
  to the right.`
...
- dataset label text: `㙕`
- dataset label codepoints: `U+3655`
...
- Which source records identify obs-char-000533 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000533？
