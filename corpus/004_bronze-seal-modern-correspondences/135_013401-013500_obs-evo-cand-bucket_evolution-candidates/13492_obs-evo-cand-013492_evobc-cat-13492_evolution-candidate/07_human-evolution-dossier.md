...
Project ID: `obs-evo-cand-013492`
...
- Project ID: `obs-evo-cand-013492`
- EVOBC category candidate ID: `evobc-evo-cat-13492`
- External category reference: `evobc-cat-13492`
- Source category ID: `13492`
- Source label for human review: `𭊇`
- Source codepoints: `U+2D287`
...
- `obs-evo-cand-013492-route-category-staging`
...
- `obs-evo-cand-013492-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013492-route-evolution-graph`
