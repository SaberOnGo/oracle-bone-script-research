...
Project ID: `obs-evo-cand-005722`
...
- Project ID: `obs-evo-cand-005722`
- EVOBC category candidate ID: `evobc-evo-cat-05722`
- External category reference: `evobc-cat-05722`
- Source category ID: `05722`
- Source label for human review: `皋`
- Source codepoints: `U+768B`
...
- `obs-evo-cand-005722-route-category-staging`
...
- `obs-evo-cand-005722-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005722-route-evolution-graph`
