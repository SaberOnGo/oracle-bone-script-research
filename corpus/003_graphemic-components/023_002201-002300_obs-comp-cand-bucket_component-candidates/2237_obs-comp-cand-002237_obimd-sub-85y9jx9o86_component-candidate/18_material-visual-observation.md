# Material Visual Observation / obs-comp-cand-002237 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002237`
- External reference / 外部参照: `obimd-sub-85y9jx9o86`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020050_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/85y9jx9o86/85y9jx9o86/85y9jx9o86.png`
- Checksum / 校验和:
  `4abcbf3eeef42ca72546d8837d2b193069d3a8b5629d5cd5cb80d8605cacac45`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.57%.
- Marked-pixel bounds: (50,24)–(202,218); span 153 × 195 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.57%。
- 痕迹范围：(50,24)–(202,218)；跨度153 × 195 px；痕迹矩形高于宽。
