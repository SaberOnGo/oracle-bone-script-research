# Material Visual Observation / obs-unk-002657
...
- English observation: A dense upright cluster combines crossing diagonal and
  vertical strokes. The central joins are dark, and several short ends point
  irregularly along both sides.
- 中文观察：紧密的竖向笔痕群由交叉的斜向和纵向笔痕组成。中央连接较深，
  两侧不规则地伸出数个短笔痕末端。
