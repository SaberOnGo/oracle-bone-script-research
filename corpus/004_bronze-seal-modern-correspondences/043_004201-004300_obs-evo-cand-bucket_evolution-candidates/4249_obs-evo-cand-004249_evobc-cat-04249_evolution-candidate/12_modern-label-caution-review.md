# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004249
...
- EVOBC candidate category: `evobc-evo-cat-04249`.
- Source label for search only: `横`.
- Source codepoints for search only: `U+6A2A`.
