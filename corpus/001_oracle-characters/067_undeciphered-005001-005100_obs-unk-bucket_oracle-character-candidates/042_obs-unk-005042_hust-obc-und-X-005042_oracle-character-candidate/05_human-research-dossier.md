# obs-unk-005042 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/067_undeciphered-005
  001-005100_obs-unk-bucket_oracle-character-candidates/042_obs-unk-005042_h
  ust-obc-und-X-005042_oracle-character-candidate/03_visual-assets/001_asset
  -006635_hust-obc-und-X-005042_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/598/X_？_7572_1.png`
- asset id: `asset-006635`
...
- source class: `HUST-OBC/undeciphered/X/598/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/598/X_？_7572_1.png`
- asset id: `asset-006635`
...
- Which source records identify obs-unk-005042 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005042？
