# Material Visual Observation / obs-comp-cand-002093 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002093`
- External reference / 外部参照: `obimd-sub-ktmu5fowob`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019539_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ktmu5fowob/ktmu5fowob/ktmu5fowob.png`
- Checksum / 校验和:
  `e47f97d0238d25525b4e27fdc36ed4425b0612cc514609772278c7f99334c44f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.00%.
- Marked-pixel bounds: (56,21)–(200,229); span 145 × 209 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.00%。
- 痕迹范围：(56,21)–(200,229)；跨度145 × 209 px；痕迹矩形高于宽。
