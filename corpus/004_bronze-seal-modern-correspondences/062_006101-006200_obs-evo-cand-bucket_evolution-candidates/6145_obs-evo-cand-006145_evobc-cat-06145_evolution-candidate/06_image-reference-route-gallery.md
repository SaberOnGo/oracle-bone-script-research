...
- `obs-evo-cand-006145-route-category-staging`
...
- `obs-evo-cand-006145-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006145-route-evolution-graph`
