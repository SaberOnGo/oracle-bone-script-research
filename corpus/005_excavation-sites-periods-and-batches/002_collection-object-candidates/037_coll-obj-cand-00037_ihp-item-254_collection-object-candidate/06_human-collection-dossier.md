# Human Collection Object Dossier / 馆藏对象研究档案: coll-obj-cand-00037
...
- project_id: `coll-obj-cand-00037`
- candidate_collection_object_id: `ihp-mus-obj-00037`
- source_collection_item_id: `254`
...
| `source_collection_item_id` | `254` |
| `object_title_en` | `Inscribed Plastron Ping 0368` |
| `catalog_reference_text` | `Ping 0368` |
| `object_page_url` | `https://museum.sinica.edu.tw/en/collection/32/item/254/` |
| `thumbnail_url` | `https://museum.sinica.edu.tw/_upload/image/collection_item/thumbnail/dc1258946374.jpg` |
