# Material Visual Observation / obs-comp-cand-001287 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001287`
- External reference / 外部参照: `obimd-sub-5pmt3mrlzy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015572_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/b9q6ewwhki/5pmt3mrlzy/5pmt3mrlzy.png`
- Checksum / 校验和:
  `3c76c34bcc5100fa6a356530dad44c8f9fc2d0726ad4466a785d19dce601635d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.64%.
- Marked-pixel bounds: (90,34)–(159,217); span 70 × 184 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.64%。
- 痕迹范围：(90,34)–(159,217)；跨度70 × 184 px；痕迹矩形高于宽。
