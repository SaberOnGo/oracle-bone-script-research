# obs-char-000076 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000076`
- primary external id: `hust-obc-cat-0086`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/076_obs-char-000076_hust-obc-cat-0086_orac
  le-character/03_visual-assets/001_asset-000081_hust-obc-cat-0086_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0086/G_0086_前6.2.3(甲).png`
- asset id: `asset-000081`
...
- source category: `0086`
- validation class: `75`
- source image route: `HUST-OBC/deciphered/0086/G_0086_前6.2.3(甲).png`
- asset id: `asset-000081`
...
- English observation: `The image contains three separated, roughly parallel
  horizontal strokes with uneven thickness.`
- 中文观察: `图像含三条分离且大致平行的横向笔画，粗细并不均匀。`
...
- dataset label text: `㑌`
- dataset label codepoints: `U+344C`
...
- Which source records identify obs-char-000076 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000076？
