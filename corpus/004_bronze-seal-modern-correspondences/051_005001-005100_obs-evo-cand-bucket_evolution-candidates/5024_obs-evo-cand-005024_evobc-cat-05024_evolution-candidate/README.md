# obs-evo-cand-005024 / EVOBC evolution-category candidate
...
- EVOBC category candidate ID: `evobc-evo-cat-05024`
- External category ref: `evobc-cat-05024`
- Source label for human review: `火`
- Source codepoints: `U+706B`
- Image reference count: `93`
- Era token counts: `BI:1;CS:1;OBC:66;SS:2;WSC:23`
- Source token counts: `Book:40;Web:53`
