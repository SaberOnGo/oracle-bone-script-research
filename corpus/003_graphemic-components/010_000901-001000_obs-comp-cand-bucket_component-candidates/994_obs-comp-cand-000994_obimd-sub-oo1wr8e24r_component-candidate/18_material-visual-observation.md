# Material Visual Observation / obs-comp-cand-000994 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000994`
- External reference / 外部参照: `obimd-sub-oo1wr8e24r`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014364_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/oo1wr8e24r/oo1wr8e24r/oo1wr8e24r.png`
- Checksum / 校验和:
  `e8ae0c142e288d86e2ce9a3554f8522886706bf94e8fcf4e75109c8ae551ccd1`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.52%.
- Marked-pixel bounds: (48,13)–(200,235); span 153 × 223 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.52%。
- 痕迹范围：(48,13)–(200,235)；跨度153 × 223 px；痕迹矩形高于宽。
