# obs-unk-006483 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/081_undeciphered-006
  401-006500_obs-unk-bucket_oracle-character-candidates/083_obs-unk-006483_h
  ust-obc-und-X-006483_oracle-character-candidate/03_visual-assets/001_asset
  -008074_hust-obc-und-X-006483_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2039/X_？_5688_1.png`
- asset id: `asset-008074`
...
- source class: `HUST-OBC/undeciphered/X/2039/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2039/X_？_5688_1.png`
- asset id: `asset-008074`
...
- Which source records identify obs-unk-006483 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006483？
