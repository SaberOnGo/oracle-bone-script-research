# obs-unk-004622 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/022_obs-unk-004622_h
  ust-obc-und-X-004622_oracle-character-candidate/03_visual-assets/001_asset
  -006215_hust-obc-und-X-004622_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/178/X_？_8353_1.png`
- asset id: `asset-006215`
...
- source class: `HUST-OBC/undeciphered/X/178/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/178/X_？_8353_1.png`
- asset id: `asset-006215`
...
- English observation: `horizontal body, uprights, lower opening`
- 中文观察: `横向形体、两端竖痕和下部开口已记录。`
...
- Which source records identify obs-unk-004622 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004622？
