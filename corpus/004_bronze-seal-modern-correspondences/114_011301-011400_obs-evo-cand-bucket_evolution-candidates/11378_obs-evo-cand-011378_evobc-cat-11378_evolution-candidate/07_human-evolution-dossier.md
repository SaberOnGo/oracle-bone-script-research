...
- External category reference: `evobc-cat-11378`
- Source category ID: `11378`
- Source label for human review: `𣂰`
- Source codepoints: `U+230B0`
...
- `obs-evo-cand-011378-route-category-staging`
...
- `obs-evo-cand-011378-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011378-route-evolution-graph`
