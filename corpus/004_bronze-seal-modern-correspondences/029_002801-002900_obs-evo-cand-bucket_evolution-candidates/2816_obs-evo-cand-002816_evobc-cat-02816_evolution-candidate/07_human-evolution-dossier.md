...
Project ID: `obs-evo-cand-002816`
...
- Project ID: `obs-evo-cand-002816`
- EVOBC category candidate ID: `evobc-evo-cat-02816`
- External category reference: `evobc-cat-02816`
- Source category ID: `02816`
- Source label for human review: `弸`
- Source codepoints: `U+5F38`
...
- `obs-evo-cand-002816-route-category-staging`
...
- `obs-evo-cand-002816-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002816-route-evolution-graph`
