...
- Project ID: `obs-evo-cand-010425`
- EVOBC category candidate ID: `evobc-evo-cat-10425`
- External category reference: `evobc-cat-10425`
- Source category ID: `10425`
- Source label for human review: `鰅`
- Source codepoints: `U+9C05`
...
- `obs-evo-cand-010425-route-category-staging`
...
- `obs-evo-cand-010425-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010425-route-evolution-graph`
