# obs-unk-004143 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/043_obs-unk-004143_h
  ust-obc-und-L-004143_oracle-character-candidate/03_visual-assets/001_asset
  -005736_hust-obc-und-L-004143_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4143/L_？_8965.jpg`
- asset id: `asset-005736`
...
- source class: `HUST-OBC/undeciphered/L/4143/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4143/L_？_8965.jpg`
- asset id: `asset-005736`
...
- English observation: An open upper angular outline and horizontal trace
  sit above a lower angled cluster.
- 中文观察：开放的上部折角轮廓和横向痕迹位于下部折角痕迹簇上方。
...
- Which source records identify obs-unk-004143 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004143？
