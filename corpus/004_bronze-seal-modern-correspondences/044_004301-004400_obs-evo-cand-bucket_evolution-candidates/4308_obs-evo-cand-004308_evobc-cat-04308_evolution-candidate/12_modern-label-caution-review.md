# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004308
...
- EVOBC candidate category: `evobc-evo-cat-04308`.
- Source label for search only: `櫌`.
- Source codepoints for search only: `U+6ACC`.
