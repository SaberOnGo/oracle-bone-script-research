# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010684
...
- EVOBC candidate category: `evobc-evo-cat-10684`.
- Source label for search only: `鼏`.
- Source codepoints for search only: `U+9F0F`.
