...
Project ID: `obs-evo-cand-000519`
...
- Project ID: `obs-evo-cand-000519`
- EVOBC category candidate ID: `evobc-evo-cat-00519`
- External category reference: `evobc-cat-00519`
- Source category ID: `00519`
- Source label for human review: `䦮`
- Source codepoints: `U+49AE`
...
- `obs-evo-cand-000519-route-category-staging`
...
- `obs-evo-cand-000519-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000519-route-evolution-graph`
