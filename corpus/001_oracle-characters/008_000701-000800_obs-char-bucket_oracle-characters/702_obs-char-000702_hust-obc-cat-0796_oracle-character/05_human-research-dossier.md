# obs-char-000702 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000702`
- primary external id: `hust-obc-cat-0796`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/702_obs-char-000702_hust-obc-cat-0796_orac
  le-character/03_visual-assets/001_asset-000707_hust-obc-cat-0796_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0796/G_0796_前5.17.3(甲).png`
- asset id: `asset-000707`
...
- source category: `0796`
- validation class: `701`
- source image route: `HUST-OBC/deciphered/0796/G_0796_前5.17.3(甲).png`
- asset id: `asset-000707`
...
- English observation: `A detached short top bar stands above a long hooked
  left stroke and small central oval, while a tall pointed right form
  divides into angular lower branches.`
- 中文观察: `分离短顶横位于长钩曲左笔和小中央椭圆上方，右侧高尖形分成折角下枝。`
...
- dataset label text: `㜒`
- dataset label codepoints: `U+3712`
...
- Which source records identify obs-char-000702 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000702？
