...
- External category reference: `evobc-cat-03849`
- Source category ID: `03849`
- Source label for human review: `末`
- Source codepoints: `U+672B`
...
- `obs-evo-cand-003849-route-category-staging`
...
- `obs-evo-cand-003849-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003849-route-evolution-graph`
