# obs-unk-005493 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/071_undeciphered-005
  401-005500_obs-unk-bucket_oracle-character-candidates/093_obs-unk-005493_h
  ust-obc-und-X-005493_oracle-character-candidate/03_visual-assets/001_asset
  -007086_hust-obc-und-X-005493_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1049/X_？_8009_1.png`
- asset id: `asset-007086`
...
- source class: `HUST-OBC/undeciphered/X/1049/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1049/X_？_8009_1.png`
- asset id: `asset-007086`
...
- Which source records identify obs-unk-005493 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005493？
