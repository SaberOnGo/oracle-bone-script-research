# Material Visual Observation / obs-comp-cand-001761 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001761`
- External reference / 外部参照: `obimd-sub-oho66symg6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017962_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/oho66symg6/oho66symg6/oho66symg6.png`
- Checksum / 校验和:
  `6ea6bc029db43b940b2f73d0e2e4ac4dd16f8a1a53a0ca3986a2d7d22f75872b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.48%.
- Marked-pixel bounds: (82,36)–(164,213); span 83 × 178 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.48%。
- 痕迹范围：(82,36)–(164,213)；跨度83 × 178 px；痕迹矩形高于宽。
