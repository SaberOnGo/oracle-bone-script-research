...
- 项目 ID: `obs-char-001462`
- 首选外部 ID: `hust-obc-cat-1639_1640_1641`
- 来源 ID: `src-hust-obc`
...
- 来源图像路线数: `1`
- 本地复核图像数: `1`
- 首个来源图像名: `G_1639_前2.9.6(甲).png`
- 首个本地图像名: `001_asset-001467_hust-obc-cat-1639_1640_1641_glyph.png`
...
- 来源标签文字: `㩝㩞㩟`
- 来源标签 codepoint: `U+3A5D;U+3A5E;U+3A5F`
