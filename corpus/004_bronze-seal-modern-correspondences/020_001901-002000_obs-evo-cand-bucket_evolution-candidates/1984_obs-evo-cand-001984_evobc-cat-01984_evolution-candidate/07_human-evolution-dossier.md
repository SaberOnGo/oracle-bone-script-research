...
- External category reference: `evobc-cat-01984`
- Source category ID: `01984`
- Source label for human review: `夃`
- Source codepoints: `U+5903`
...
- `obs-evo-cand-001984-route-category-staging`
...
- `obs-evo-cand-001984-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001984-route-evolution-graph`
