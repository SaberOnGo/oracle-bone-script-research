# obs-unk-004303 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004303`
- primary external id: `hust-obc-und-L-004303`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/003_obs-unk-004303_h
  ust-obc-und-L-004303_oracle-character-candidate/03_visual-assets/001_asset
  -005896_hust-obc-und-L-004303_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4303/L_？_9498.jpg`
- asset id: `asset-005896`
...
- source class: `HUST-OBC/undeciphered/L/4303/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4303/L_？_9498.jpg`
- asset id: `asset-005896`
...
- English observation: `Committed derivative is blank; no glyph trace visible.`
- 中文观察: `已提交派生件为空白，未见字形痕迹。`
...
- Which source records identify obs-unk-004303 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004303？
