...
- Project ID: `obs-evo-cand-001638`
- EVOBC category candidate ID: `evobc-evo-cat-01638`
- External category reference: `evobc-cat-01638`
- Source category ID: `01638`
- Source label for human review: `喁`
- Source codepoints: `U+5581`
...
- `obs-evo-cand-001638-route-category-staging`
...
- `obs-evo-cand-001638-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001638-route-evolution-graph`
