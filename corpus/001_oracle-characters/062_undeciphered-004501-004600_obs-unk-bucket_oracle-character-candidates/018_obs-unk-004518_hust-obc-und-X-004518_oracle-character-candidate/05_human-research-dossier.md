# obs-unk-004518 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004518`
- primary external id: `hust-obc-und-X-004518`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/018_obs-unk-004518_h
  ust-obc-und-X-004518_oracle-character-candidate/03_visual-assets/001_asset
  -006111_hust-obc-und-X-004518_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/74/X_？_8258_1.png`
- asset id: `asset-006111`
...
- source class: `HUST-OBC/undeciphered/X/74/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/74/X_？_8258_1.png`
- asset id: `asset-006111`
...
- English observation: `The single long curved trace, middle bend, and tapered
  lower end are directly recorded.`
- 中文观察: `已直接记录单条长弧痕、中部弯折和变细的下端。`
...
- Which source records identify obs-unk-004518 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004518？
