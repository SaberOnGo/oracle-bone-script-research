...
- Project ID: `obs-evo-cand-004389`
- EVOBC category candidate ID: `evobc-evo-cat-04389`
- External category reference: `evobc-cat-04389`
- Source category ID: `04389`
- Source label for human review: `武`
- Source codepoints: `U+6B66`
- Image reference count in source metadata: `222`
...
- `obs-evo-cand-004389-route-category-staging`
...
- `obs-evo-cand-004389-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004389-route-evolution-graph`
