...
- External category reference: `evobc-cat-03942`
- Source category ID: `03942`
- Source label for human review: `枻`
- Source codepoints: `U+67BB`
...
- `obs-evo-cand-003942-route-category-staging`
...
- `obs-evo-cand-003942-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003942-route-evolution-graph`
