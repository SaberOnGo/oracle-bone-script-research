# Material Visual Observation / obs-comp-cand-001825 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001825`
- External reference / 外部参照: `obimd-sub-2j01ng0nts`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018151_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/sywfwn7sg1/2j01ng0nts/2j01ng0nts.png`
- Checksum / 校验和:
  `e63630cb7c9b6207991d7bc367e99ce728a6933350ad465e852256f96f5a80f9`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.91%.
- Marked-pixel bounds: (61,45)–(192,202); span 132 × 158 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.91%。
- 痕迹范围：(61,45)–(192,202)；跨度132 × 158 px；痕迹矩形近方形。
