...
Project ID: `obs-evo-cand-006154`
...
- Project ID: `obs-evo-cand-006154`
- EVOBC category candidate ID: `evobc-evo-cat-06154`
- External category reference: `evobc-cat-06154`
- Source category ID: `06154`
- Source label for human review: `窃`
- Source codepoints: `U+7A83`
...
- `obs-evo-cand-006154-route-category-staging`
...
- `obs-evo-cand-006154-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006154-route-evolution-graph`
