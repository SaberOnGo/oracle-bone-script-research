# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001244
...
| --- | --- | --- | --- |
| `obimd-glyph-link-018661` | 򳂊󷊈 | `U+B308A;U+F7288` | `reviewed_metadata_only` |
| `obimd-glyph-link-018662` | 󷊉 | `U+F7289` | `reviewed_metadata_only` |
| `obimd-glyph-link-018663` | 󷊊 | `U+F728A` | `reviewed_metadata_only` |
| `obimd-glyph-link-018664` | 󷊋 | `U+F728B` | `reviewed_metadata_only` |
