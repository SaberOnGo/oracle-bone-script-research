...
Project ID: `obs-evo-cand-001641`
...
- Project ID: `obs-evo-cand-001641`
- EVOBC category candidate ID: `evobc-evo-cat-01641`
- External category reference: `evobc-cat-01641`
- Source category ID: `01641`
- Source label for human review: `喈`
- Source codepoints: `U+5588`
...
- `obs-evo-cand-001641-route-category-staging`
...
- `obs-evo-cand-001641-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001641-route-evolution-graph`
