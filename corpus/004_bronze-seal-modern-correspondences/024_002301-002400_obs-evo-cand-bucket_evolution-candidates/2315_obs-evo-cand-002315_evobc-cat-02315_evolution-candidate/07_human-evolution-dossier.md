...
- Project ID: `obs-evo-cand-002315`
- EVOBC category candidate ID: `evobc-evo-cat-02315`
- External category reference: `evobc-cat-02315`
- Source category ID: `02315`
- Source label for human review: `嬽`
- Source codepoints: `U+5B3D`
...
- `obs-evo-cand-002315-route-category-staging`
...
- `obs-evo-cand-002315-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002315-route-evolution-graph`
