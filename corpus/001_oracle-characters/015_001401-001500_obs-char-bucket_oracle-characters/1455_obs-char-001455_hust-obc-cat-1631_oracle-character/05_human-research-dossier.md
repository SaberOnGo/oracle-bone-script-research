# obs-char-001455 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001455`
- primary external id: `hust-obc-cat-1631`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1455_obs-char-001455_hust-obc-cat-1631_ora
  cle-character/03_visual-assets/001_asset-001460_hust-obc-cat-1631_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1631/X_1631_5285_1.png`
- asset id: `asset-001460`
...
- source category: `1631`
- validation class: `1454`
- source image route: `HUST-OBC/deciphered/1631/X_1631_5285_1.png`
- asset id: `asset-001460`
...
- English observation: `A large dense composite has a peaked upper stem,
  inner openings, and branches.`
- 中文观察: `大型密集组合形体有尖拱上部竖干、内部空隙和分枝。`
...
- dataset label text: `㩕`
- dataset label codepoints: `U+3A55`
...
- Which source records identify obs-char-001455 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001455？
