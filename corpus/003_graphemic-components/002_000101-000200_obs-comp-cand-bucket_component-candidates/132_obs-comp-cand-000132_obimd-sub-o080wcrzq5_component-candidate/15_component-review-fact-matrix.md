# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000132
...
| Glyph or codepoint route / 字形或码位路线 | 7 OBIMD route rows; examples U+5DDE;U+F0C4B; U+F0C4C; 另有 5 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
