...
- External category reference: `evobc-cat-01788`
- Source category ID: `01788`
- Source label for human review: `土`
- Source codepoints: `U+571F`
- Image reference count in source metadata: `253`
...
- `obs-evo-cand-001788-route-category-staging`
...
- `obs-evo-cand-001788-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001788-route-evolution-graph`
