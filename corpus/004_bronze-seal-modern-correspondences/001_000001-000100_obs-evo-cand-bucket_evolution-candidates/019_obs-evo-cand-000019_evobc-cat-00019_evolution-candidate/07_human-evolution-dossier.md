...
- External category reference: `evobc-cat-00019`
- Source category ID: `00019`
- Source label for human review: `㓜`
...
- `obs-evo-cand-000019-route-category-staging`
...
- `obs-evo-cand-000019-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000019-route-evolution-graph`
