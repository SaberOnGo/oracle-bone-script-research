...
- Project ID: `obs-evo-cand-003430`
- EVOBC category candidate ID: `evobc-evo-cat-03430`
- External category reference: `evobc-cat-03430`
- Source category ID: `03430`
- Source label for human review: `換`
- Source codepoints: `U+63DB`
...
- `obs-evo-cand-003430-route-category-staging`
...
- `obs-evo-cand-003430-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003430-route-evolution-graph`
