...
- Project ID: `obs-evo-cand-002740`
- EVOBC category candidate ID: `evobc-evo-cat-02740`
- External category reference: `evobc-cat-02740`
- Source category ID: `02740`
- Source label for human review: `庴`
- Source codepoints: `U+5EB4`
...
- `obs-evo-cand-002740-route-category-staging`
...
- `obs-evo-cand-002740-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002740-route-evolution-graph`
