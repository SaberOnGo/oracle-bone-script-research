# Material Visual Observation / obs-comp-cand-001608 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001608`
- External reference / 外部参照: `obimd-sub-kei9slmf3p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017284_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kei9slmf3p/kei9slmf3p/kei9slmf3p.png`
- Checksum / 校验和:
  `106ef4c05c3434ce42e2a4a3d5c331e3b180bf0279db1e465755fad47f183230`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.54%.
- Marked-pixel bounds: (80,30)–(169,218); span 90 × 189 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.54%。
- 痕迹范围：(80,30)–(169,218)；跨度90 × 189 px；痕迹矩形高于宽。
