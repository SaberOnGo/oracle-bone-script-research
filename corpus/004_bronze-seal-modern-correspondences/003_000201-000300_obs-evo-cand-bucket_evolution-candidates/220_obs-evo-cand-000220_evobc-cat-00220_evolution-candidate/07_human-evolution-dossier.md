...
- External category reference: `evobc-cat-00220`
- Source category ID: `00220`
- Source label for human review: `㶎`
- Source codepoints: `U+3D8E`
...
- `obs-evo-cand-000220-route-category-staging`
...
- `obs-evo-cand-000220-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000220-route-evolution-graph`
