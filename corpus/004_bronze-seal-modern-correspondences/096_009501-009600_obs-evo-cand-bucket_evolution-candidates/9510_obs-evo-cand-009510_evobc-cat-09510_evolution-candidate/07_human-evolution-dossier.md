...
- External category reference: `evobc-cat-09510`
- Source category ID: `09510`
- Source label for human review: `鏦`
...
- `obs-evo-cand-009510-route-category-staging`
...
- `obs-evo-cand-009510-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009510-route-evolution-graph`
