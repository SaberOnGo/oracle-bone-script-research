# Material Visual Observation / obs-comp-cand-001616 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001616`
- External reference / 外部参照: `obimd-sub-ywtdw3ws46`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017292_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ywtdw3ws46/ywtdw3ws46/ywtdw3ws46.png`
- Checksum / 校验和:
  `ec926df5433c348d7a5fc0177b86baa576acf91458aad5ed50cc86e9771b6539`
...
- Marked-pixel bounds: (80,34)–(169,211); span 90 × 178 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.02%。
- 痕迹范围：(80,34)–(169,211)；跨度90 × 178 px；痕迹矩形高于宽。
