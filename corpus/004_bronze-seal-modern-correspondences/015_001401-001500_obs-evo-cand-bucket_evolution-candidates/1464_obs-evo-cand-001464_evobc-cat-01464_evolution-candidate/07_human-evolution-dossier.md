...
- External category reference: `evobc-cat-01464`
- Source category ID: `01464`
- Source label for human review: `叚`
- Source codepoints: `U+53DA`
...
- `obs-evo-cand-001464-route-category-staging`
...
- `obs-evo-cand-001464-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001464-route-evolution-graph`
