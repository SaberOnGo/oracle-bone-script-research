# obs-comp-cand-000121 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000121`
- 首选外部 ID: `obimd-sub-iho3azmdgu`
- OBIMD subcharacter UID: `iho3azmdgu`
- OBIMD main character UID: `iho3azmdgu`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `8`
- codepoint 示例: U+5EB6;U+F0B64; U+F0B65; 另有 6 项
