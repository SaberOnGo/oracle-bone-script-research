...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1193`
...
- Source image / 来源图: `Y_1193_609A4.jpg`
- Image / 图像: `001_asset-001071_hust-obc-cat-1193_glyph.png`
...
- target node: `evobc-evo-cat-00099`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/099_obs-evo-cand-000099_evobc-cat-00099_evoluti
...
- Source label text / 来源标签文字: `㢟`
- Source label codepoint / 来源标签 codepoint: `U+389F`
