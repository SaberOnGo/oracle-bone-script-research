# obs-unk-005171 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/068_undeciphered-005
  101-005200_obs-unk-bucket_oracle-character-candidates/071_obs-unk-005171_h
  ust-obc-und-X-005171_oracle-character-candidate/03_visual-assets/001_asset
  -006764_hust-obc-und-X-005171_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/727/X_？_7693_1.png`
- asset id: `asset-006764`
...
- source class: `HUST-OBC/undeciphered/X/727/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/727/X_？_7693_1.png`
- asset id: `asset-006764`
...
- Which source records identify obs-unk-005171 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005171？
