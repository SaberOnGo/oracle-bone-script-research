# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013129
...
- EVOBC candidate category: `evobc-evo-cat-13129`.
- Source label for search only: `𫸝`.
- Source codepoints for search only: `U+2BE1D`.
