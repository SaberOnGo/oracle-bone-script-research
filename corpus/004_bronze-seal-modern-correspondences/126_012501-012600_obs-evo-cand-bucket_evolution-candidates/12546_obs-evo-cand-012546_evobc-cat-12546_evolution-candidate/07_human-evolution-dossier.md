...
- External category reference: `evobc-cat-12546`
- Source category ID: `12546`
- Source label for human review: `𩁂`
...
- `obs-evo-cand-012546-route-category-staging`
...
- `obs-evo-cand-012546-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012546-route-evolution-graph`
