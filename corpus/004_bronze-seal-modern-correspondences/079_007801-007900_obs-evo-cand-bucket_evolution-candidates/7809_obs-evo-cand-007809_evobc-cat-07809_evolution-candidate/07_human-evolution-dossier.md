...
Project ID: `obs-evo-cand-007809`
...
- Project ID: `obs-evo-cand-007809`
- EVOBC category candidate ID: `evobc-evo-cat-07809`
- External category reference: `evobc-cat-07809`
- Source category ID: `07809`
- Source label for human review: `蝘`
- Source codepoints: `U+8758`
...
- `obs-evo-cand-007809-route-category-staging`
...
- `obs-evo-cand-007809-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007809-route-evolution-graph`
