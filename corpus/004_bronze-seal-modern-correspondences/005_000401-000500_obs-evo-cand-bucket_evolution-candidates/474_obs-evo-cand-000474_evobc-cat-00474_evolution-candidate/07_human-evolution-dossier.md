...
- External category reference: `evobc-cat-00474`
- Source category ID: `00474`
- Source label for human review: `䢖`
...
- `obs-evo-cand-000474-route-category-staging`
...
- `obs-evo-cand-000474-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000474-route-evolution-graph`
