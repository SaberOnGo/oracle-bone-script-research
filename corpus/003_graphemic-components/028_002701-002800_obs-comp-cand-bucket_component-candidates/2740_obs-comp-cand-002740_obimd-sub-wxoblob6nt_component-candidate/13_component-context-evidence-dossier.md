# obs-comp-cand-002740 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002740`
- 首选外部 ID: `obimd-sub-wxoblob6nt`
- OBIMD subcharacter UID: `wxoblob6nt`
- OBIMD main character UID: `wxoblob6nt`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `7`
- codepoint 示例: U+FF761; U+FF762; 另有 5 项
