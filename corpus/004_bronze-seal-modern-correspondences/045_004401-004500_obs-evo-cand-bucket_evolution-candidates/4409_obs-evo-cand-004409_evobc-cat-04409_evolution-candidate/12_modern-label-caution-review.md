# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004409
...
- EVOBC candidate category: `evobc-evo-cat-04409`.
- Source label for search only: `殊`.
- Source codepoints for search only: `U+6B8A`.
