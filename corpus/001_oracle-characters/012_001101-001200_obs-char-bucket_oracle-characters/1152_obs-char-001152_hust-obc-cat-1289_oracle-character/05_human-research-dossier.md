# obs-char-001152 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001152`
- primary external id: `hust-obc-cat-1289`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1152_obs-char-001152_hust-obc-cat-1289_ora
  cle-character/03_visual-assets/001_asset-001157_hust-obc-cat-1289_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1289/H_1289_60F1C_0.png`
- asset id: `asset-001157`
...
- source category: `1289`
- validation class: `1151`
- source image route: `HUST-OBC/deciphered/1289/H_1289_60F1C_0.png`
- asset id: `asset-001157`
...
- English observation: `A large angular cluster has a central upright,
  projecting side strokes, and a broad lower horizontal base.`
- 中文观察: `大型折角笔群有中央直立笔、向两侧外伸的笔画和宽大的下部横向底笔。`
...
- dataset label text: `㣿`
- dataset label codepoints: `U+38FF`
...
- filename catalog route clues: `catalog-like filename clue: H_1289
  (H_1289_60F1C_0.png)`
...
- Which source records identify obs-char-001152 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001152？
