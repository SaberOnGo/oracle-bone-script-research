# Material Visual Observation / obs-comp-cand-001495 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001495`
- External reference / 外部参照: `obimd-sub-8ggcq3obcu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016106_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8ggcq3obcu/8ggcq3obcu/8ggcq3obcu.png`
- Checksum / 校验和:
  `50dbeb3f0cf0c0deb832aaecc78ee51920911dd4503c9c1180dde2c613e6d00f`
...
- Marked-pixel bounds: (69,33)–(200,210); span 132 × 178 px; the marked
...
- 痕迹范围：(69,33)–(200,210)；跨度132 × 178 px；痕迹矩形高于宽。
