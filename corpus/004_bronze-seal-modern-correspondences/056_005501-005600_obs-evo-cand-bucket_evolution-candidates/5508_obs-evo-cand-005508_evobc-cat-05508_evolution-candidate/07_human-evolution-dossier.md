...
- External category reference: `evobc-cat-05508`
- Source category ID: `05508`
- Source label for human review: `瓨`
...
- `obs-evo-cand-005508-route-category-staging`
...
- `obs-evo-cand-005508-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005508-route-evolution-graph`
