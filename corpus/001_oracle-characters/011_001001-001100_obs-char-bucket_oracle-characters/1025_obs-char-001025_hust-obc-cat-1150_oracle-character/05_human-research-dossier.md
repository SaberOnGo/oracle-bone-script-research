# obs-char-001025 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1025_obs-char-001025_hust-obc-cat-1150_ora
  cle-character/03_visual-assets/001_asset-001030_hust-obc-cat-1150_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1150/G_1150_京津1339(甲).png`
- asset id: `asset-001030`
...
- source category: `1150`
- validation class: `1024`
- source image route: `HUST-OBC/deciphered/1150/G_1150_京津1339(甲).png`
- asset id: `asset-001030`
...
- English observation: `A small horizontal rectangular enclosure sits above
  a pointed branching lower form with two detached descending strokes.`
- 中文观察: `小型横向矩形闭合轮廓位于尖状分枝下部形体之上，下方有两条分离下行笔。`
...
- dataset label text: `㡴`
- dataset label codepoints: `U+3874`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00094`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00094`
- EvoBC image reference count / EvoBC 图像引用数: `17`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00094`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/094_obs-evo-can
  d-000094_evobc-cat-00094_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/094_obs-evo-cand-000094_evobc-cat-00094_evolu
...
- Which source records identify obs-char-001025 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001025？
