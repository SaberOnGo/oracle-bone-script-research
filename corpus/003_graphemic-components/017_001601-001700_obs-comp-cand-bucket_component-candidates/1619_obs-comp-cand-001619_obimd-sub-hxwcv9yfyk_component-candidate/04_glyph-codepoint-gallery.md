# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001619
...
| --- | --- | --- | --- |
| `obimd-glyph-link-025160` | 󹛛 | `U+F96DB` | `reviewed_metadata_only` |
| `obimd-glyph-link-025161` | 󹛜 | `U+F96DC` | `reviewed_metadata_only` |
