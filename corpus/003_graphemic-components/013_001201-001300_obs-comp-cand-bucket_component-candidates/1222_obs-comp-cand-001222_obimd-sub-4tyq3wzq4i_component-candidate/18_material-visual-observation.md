# Material Visual Observation / obs-comp-cand-001222 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001222`
- External reference / 外部参照: `obimd-sub-4tyq3wzq4i`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015453_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4tyq3wzq4i/4tyq3wzq4i/2xqxkveekp.png`
- Checksum / 校验和:
  `46dcab0f364f7da4d5d7b0112b86fbcd993dd491a5419874af5e31036b01d5ae`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.88%.
- Marked-pixel bounds: (83,19)–(166,230); span 84 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.88%。
- 痕迹范围：(83,19)–(166,230)；跨度84 × 212 px；痕迹矩形高于宽。
