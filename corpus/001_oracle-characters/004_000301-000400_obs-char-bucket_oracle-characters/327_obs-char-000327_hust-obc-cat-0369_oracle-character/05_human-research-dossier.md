# obs-char-000327 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/327_obs-char-000327_hust-obc-cat-0369_orac
  le-character/03_visual-assets/001_asset-000332_hust-obc-cat-0369_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0369/G_0369_乙124合21306𠂤組.png`
- asset id: `asset-000332`
...
- source category: `0369`
- validation class: `326`
- source image route: `HUST-OBC/deciphered/0369/G_0369_乙124合21306𠂤組.png`
- asset id: `asset-000332`
...
- English observation: `The image shows upper branching strokes, two rounded
  lower loops, and a central vertical stem.`
- 中文观察: `图像上部有分叉笔画，下方有两个圆弧环状形体，中部为直立主干。`
...
- dataset label text: `㕧`
- dataset label codepoints: `U+3567`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/030_obs-evo-can
  d-000030_evobc-cat-00030_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/030_obs-evo-cand-000030_evobc-cat-00030_evolu
...
- Which source records identify obs-char-000327 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000327？
