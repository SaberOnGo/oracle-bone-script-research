...
Project ID: `obs-evo-cand-000596`
...
- Project ID: `obs-evo-cand-000596`
- EVOBC category candidate ID: `evobc-evo-cat-00596`
- External category reference: `evobc-cat-00596`
- Source category ID: `00596`
- Source label for human review: `䶅`
- Source codepoints: `U+4D85`
...
- `obs-evo-cand-000596-route-category-staging`
...
- `obs-evo-cand-000596-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000596-route-evolution-graph`
