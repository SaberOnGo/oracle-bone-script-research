...
Project ID: `obs-evo-cand-010122`
...
- Project ID: `obs-evo-cand-010122`
- EVOBC category candidate ID: `evobc-evo-cat-10122`
- External category reference: `evobc-cat-10122`
- Source category ID: `10122`
- Source label for human review: `餳`
- Source codepoints: `U+9933`
...
- `obs-evo-cand-010122-route-category-staging`
...
- `obs-evo-cand-010122-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010122-route-evolution-graph`
