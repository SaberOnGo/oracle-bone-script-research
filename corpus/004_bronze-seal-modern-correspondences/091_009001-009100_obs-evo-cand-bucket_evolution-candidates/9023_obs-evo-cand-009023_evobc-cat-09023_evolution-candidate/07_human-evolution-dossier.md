...
- External category reference: `evobc-cat-09023`
- Source category ID: `09023`
- Source label for human review: `遄`
- Source codepoints: `U+9044`
...
- `obs-evo-cand-009023-route-category-staging`
...
- `obs-evo-cand-009023-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009023-route-evolution-graph`
