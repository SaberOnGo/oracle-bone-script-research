...
- External category reference: `evobc-cat-08413`
- Source category ID: `08413`
- Source label for human review: `访`
...
- `obs-evo-cand-008413-route-category-staging`
...
- `obs-evo-cand-008413-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008413-route-evolution-graph`
