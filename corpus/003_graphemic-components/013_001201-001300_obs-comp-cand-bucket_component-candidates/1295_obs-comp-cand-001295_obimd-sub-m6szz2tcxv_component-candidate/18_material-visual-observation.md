# Material Visual Observation / obs-comp-cand-001295 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001295`
- External reference / 外部参照: `obimd-sub-m6szz2tcxv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015632_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/m6szz2tcxv/m6szz2tcxv/m6szz2tcxv.png`
- Checksum / 校验和:
  `6212825acb4fccfbbd65fd69bfff511ab03f0c59e4c1f04036ce40fbc44ed29d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.60%.
- Marked-pixel bounds: (76,17)–(183,231); span 108 × 215 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.60%。
- 痕迹范围：(76,17)–(183,231)；跨度108 × 215 px；痕迹矩形高于宽。
