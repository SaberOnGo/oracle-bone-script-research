# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004614
...
- EVOBC candidate category: `evobc-evo-cat-04614`.
- Source label for search only: `洌`.
- Source codepoints for search only: `U+6D0C`.
