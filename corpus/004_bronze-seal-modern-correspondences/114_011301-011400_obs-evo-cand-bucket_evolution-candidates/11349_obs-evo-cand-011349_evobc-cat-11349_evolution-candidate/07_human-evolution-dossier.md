...
- External category reference: `evobc-cat-11349`
- Source category ID: `11349`
- Source label for human review: `𢾝`
...
- `obs-evo-cand-011349-route-category-staging`
...
- `obs-evo-cand-011349-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011349-route-evolution-graph`
