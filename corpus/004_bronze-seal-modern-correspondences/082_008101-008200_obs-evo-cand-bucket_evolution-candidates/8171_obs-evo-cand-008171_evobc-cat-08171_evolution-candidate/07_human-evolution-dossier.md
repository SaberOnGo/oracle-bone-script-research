...
- Project ID: `obs-evo-cand-008171`
- EVOBC category candidate ID: `evobc-evo-cat-08171`
- External category reference: `evobc-cat-08171`
- Source category ID: `08171`
- Source label for human review: `詋`
- Source codepoints: `U+8A4B`
...
- `obs-evo-cand-008171-route-category-staging`
...
- `obs-evo-cand-008171-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008171-route-evolution-graph`
