# Material Visual Observation / obs-comp-cand-002368 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002368`
- External reference / 外部参照: `obimd-sub-7grlc2aopw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020439_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7grlc2aopw/7grlc2aopw/7grlc2aopw.png`
- Checksum / 校验和:
  `3fbc0a90d1c0e01301380b88a319494385bd810cf27f64b062bec7633a57a9d3`
...
- Marked-pixel bounds: (92,32)–(157,216); span 66 × 185 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.06%。
- 痕迹范围：(92,32)–(157,216)；跨度66 × 185 px；痕迹矩形高于宽。
