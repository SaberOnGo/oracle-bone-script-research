# obs-char-000277 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000277`
- primary external id: `hust-obc-cat-0312_0313`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/277_obs-char-000277_hust-obc-cat-0312_0313
  _oracle-character/03_visual-assets/001_asset-000282_hust-obc-cat-0312_0313
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0312_0313/0312/G_0312_前4.28.7(甲
  ).png`
- asset id: `asset-000282`
...
- source category: `0312_0313`
- validation class: `276`
- source image route: `HUST-OBC/deciphered/0312_0313/0312/G_0312_前4.28.7(甲).pn
  g`
- asset id: `asset-000282`
...
- English observation: `The image shows a rounded upper outline with
  interior marks, followed by a long narrow lower stem crossed by short
  diagonal strokes.`
- 中文观察: `图像上部有带内部痕迹的圆弧轮廓，下方接长而狭窄的笔干，并有短斜向交叉笔画。`
...
- dataset label text: `㔮㔯`
- dataset label codepoints: `U+352E;U+352F`
...
- graph edge count: `2`
- codepoint routes: `U+352E;U+352F`
...
- Which source records identify obs-char-000277 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000277？
