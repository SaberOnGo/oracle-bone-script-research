# obs-char-000811 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/811_obs-char-000811_hust-obc-cat-0919_orac
  le-character/03_visual-assets/001_asset-000816_hust-obc-cat-0919_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0919/G_0919_京津1266合6476賓組.png`
- asset id: `asset-000816`
...
- source category: `0919`
- validation class: `810`
- source image route: `HUST-OBC/deciphered/0919/G_0919_京津1266合6476賓組.png`
- asset id: `asset-000816`
...
- English observation: `Two separated thin curved strokes lean inward and
  taper to pointed ends; their upper tips remain visibly detached.`
- 中文观察: `两条分离的细弯对笔向中间靠拢，各自收尖，上端明显没有连接。`
...
- dataset label text: `㞍`
- dataset label codepoints: `U+378D`
...
- filename catalog route clues: `Heji-like filename clue: 合6476
  (G_0919_京津1266合6476賓組.png)`
...
- Which source records identify obs-char-000811 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000811？
