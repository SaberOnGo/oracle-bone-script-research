...
- External category reference: `evobc-cat-12232`
- Source category ID: `12232`
- Source label: `𧨚`
...
- `obs-evo-cand-012232-route-category-staging`
...
- `obs-evo-cand-012232-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012232-route-evolution-graph`
