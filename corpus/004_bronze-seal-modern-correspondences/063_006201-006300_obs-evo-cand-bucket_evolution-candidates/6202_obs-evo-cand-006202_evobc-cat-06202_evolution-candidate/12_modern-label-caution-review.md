# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006202
...
- EVOBC candidate category: `evobc-evo-cat-06202`.
- Source label for search only: `竟`.
- Source codepoints for search only: `U+7ADF`.
