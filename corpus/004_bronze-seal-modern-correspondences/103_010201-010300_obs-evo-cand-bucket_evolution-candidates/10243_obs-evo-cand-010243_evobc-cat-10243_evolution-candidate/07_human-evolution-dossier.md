...
- Project ID: `obs-evo-cand-010243`
- EVOBC category candidate ID: `evobc-evo-cat-10243`
- External category reference: `evobc-cat-10243`
- Source category ID: `10243`
- Source label for human review: `驁`
- Source codepoints: `U+9A41`
...
- `obs-evo-cand-010243-route-category-staging`
...
- `obs-evo-cand-010243-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010243-route-evolution-graph`
