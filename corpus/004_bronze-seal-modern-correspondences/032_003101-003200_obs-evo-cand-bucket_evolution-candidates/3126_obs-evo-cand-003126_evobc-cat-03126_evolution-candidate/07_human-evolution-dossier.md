...
- External category reference: `evobc-cat-03126`
- Source category ID: `03126`
- Source label for human review: `慬`
- Source codepoints: `U+616C`
...
- `obs-evo-cand-003126-route-category-staging`
...
- `obs-evo-cand-003126-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003126-route-evolution-graph`
