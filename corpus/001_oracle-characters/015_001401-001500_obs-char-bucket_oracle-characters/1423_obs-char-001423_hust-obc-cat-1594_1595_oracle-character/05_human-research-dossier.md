# obs-char-001423 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1423_obs-char-001423_hust-obc-cat-1594_159
  5_oracle-character/03_visual-assets/001_asset-001428_hust-obc-cat-1594_159
  5_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1594_1595/1594/G_1594_乙2482合775
  賓組.png`
- asset id: `asset-001428`
...
- source category: `1594_1595`
- validation class: `1422`
- source image route: `HUST-OBC/deciphered/1594_1595/1594/G_1594_乙2482合775賓組.p
  ng`
- asset id: `asset-001428`
...
- English observation: `A tall composite has an upper frame, inner
  verticals, and a long right curve.`
...
- dataset label text: `㨰㨱`
- dataset label codepoints: `U+3A30;U+3A31`
...
- graph edge count: `2`
- codepoint routes: `U+3A30;U+3A31`
...
- filename catalog route clues: `Heji-like filename clue: 合775
...
- Which source records identify obs-char-001423 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001423？
