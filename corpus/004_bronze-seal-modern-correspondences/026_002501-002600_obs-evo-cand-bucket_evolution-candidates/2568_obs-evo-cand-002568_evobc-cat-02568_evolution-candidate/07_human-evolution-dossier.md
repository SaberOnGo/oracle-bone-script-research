...
- External category reference: `evobc-cat-02568`
- Source category ID: `02568`
- Source label for human review: `崝`
- Source codepoints: `U+5D1D`
...
- `obs-evo-cand-002568-route-category-staging`
...
- `obs-evo-cand-002568-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002568-route-evolution-graph`
