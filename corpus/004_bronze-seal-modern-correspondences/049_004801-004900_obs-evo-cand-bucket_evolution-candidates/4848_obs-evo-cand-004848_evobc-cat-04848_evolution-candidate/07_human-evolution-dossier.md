...
- External category reference: `evobc-cat-04848`
- Source category ID: `04848`
- Source label for human review: `滥`
...
- `obs-evo-cand-004848-route-category-staging`
...
- `obs-evo-cand-004848-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004848-route-evolution-graph`
