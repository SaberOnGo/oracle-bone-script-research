...
Project ID: `obs-evo-cand-007286`
...
- Project ID: `obs-evo-cand-007286`
- EVOBC category candidate ID: `evobc-evo-cat-07286`
- External category reference: `evobc-cat-07286`
- Source category ID: `07286`
- Source label for human review: `若`
- Source codepoints: `U+82E5`
- Image reference count in source metadata: `216`
...
- `obs-evo-cand-007286-route-category-staging`
...
- `obs-evo-cand-007286-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007286-route-evolution-graph`
