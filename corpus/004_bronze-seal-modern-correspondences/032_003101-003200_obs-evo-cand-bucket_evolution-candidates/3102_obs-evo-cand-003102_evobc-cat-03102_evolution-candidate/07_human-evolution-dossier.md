...
Project ID: `obs-evo-cand-003102`
...
- Project ID: `obs-evo-cand-003102`
- EVOBC category candidate ID: `evobc-evo-cat-03102`
- External category reference: `evobc-cat-03102`
- Source category ID: `03102`
- Source label for human review: `慁`
- Source codepoints: `U+6141`
...
- `obs-evo-cand-003102-route-category-staging`
...
- `obs-evo-cand-003102-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003102-route-evolution-graph`
