...
- External category reference: `evobc-cat-06201`
- Source category ID: `06201`
- Source label for human review: `竞`
...
- `obs-evo-cand-006201-route-category-staging`
...
- `obs-evo-cand-006201-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006201-route-evolution-graph`
