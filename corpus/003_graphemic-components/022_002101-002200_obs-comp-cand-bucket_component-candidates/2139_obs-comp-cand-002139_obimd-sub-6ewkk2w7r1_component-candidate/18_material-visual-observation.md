# Material Visual Observation / obs-comp-cand-002139 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002139`
- External reference / 外部参照: `obimd-sub-6ewkk2w7r1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019696_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6ewkk2w7r1/6ewkk2w7r1/2zrgcypexj.png`
- Checksum / 校验和:
  `131406dc270f4f5b8cc58f53b0426b09e18c6d79e0bcf97e241a4b120634bd5e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.32%.
- Marked-pixel bounds: (83,32)–(166,215); span 84 × 184 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.32%。
- 痕迹范围：(83,32)–(166,215)；跨度84 × 184 px；痕迹矩形高于宽。
