...
- External category reference: `evobc-cat-03864`
- Source category ID: `03864`
- Source label: `杀`
...
- `obs-evo-cand-003864-route-category-staging`
...
- `obs-evo-cand-003864-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003864-route-evolution-graph`
