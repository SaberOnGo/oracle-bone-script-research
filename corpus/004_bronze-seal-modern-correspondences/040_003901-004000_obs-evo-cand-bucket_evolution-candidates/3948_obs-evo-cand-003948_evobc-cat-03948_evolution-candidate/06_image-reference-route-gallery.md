...
- `obs-evo-cand-003948-route-category-staging`
...
- `obs-evo-cand-003948-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003948-route-evolution-graph`
