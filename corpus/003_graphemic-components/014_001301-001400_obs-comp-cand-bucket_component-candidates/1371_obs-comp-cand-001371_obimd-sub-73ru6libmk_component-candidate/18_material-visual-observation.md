# Material Visual Observation / obs-comp-cand-001371 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001371`
- External reference / 外部参照: `obimd-sub-73ru6libmk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015790_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/73ru6libmk/73ru6libmk/73ru6libmk.png`
- Checksum / 校验和:
  `defc3b165869616faaf5ff41ce25bba60090fbe043811ebfdbf7b421a5835a7b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.68%.
- Marked-pixel bounds: (68,20)–(190,225); span 123 × 206 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.68%。
- 痕迹范围：(68,20)–(190,225)；跨度123 × 206 px；痕迹矩形高于宽。
