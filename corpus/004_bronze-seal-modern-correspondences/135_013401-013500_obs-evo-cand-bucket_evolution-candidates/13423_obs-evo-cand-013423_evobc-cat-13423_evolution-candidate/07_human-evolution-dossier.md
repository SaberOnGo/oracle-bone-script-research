...
- External category reference: `evobc-cat-13423`
- Source category ID: `13423`
- Source label for human review: `𬰄`
...
- `obs-evo-cand-013423-route-category-staging`
...
- `obs-evo-cand-013423-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013423-route-evolution-graph`
