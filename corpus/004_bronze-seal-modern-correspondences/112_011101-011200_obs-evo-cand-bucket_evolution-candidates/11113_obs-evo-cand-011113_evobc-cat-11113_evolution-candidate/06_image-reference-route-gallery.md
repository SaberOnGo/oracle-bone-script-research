...
- `obs-evo-cand-011113-route-category-staging`
...
- `obs-evo-cand-011113-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011113-route-evolution-graph`
