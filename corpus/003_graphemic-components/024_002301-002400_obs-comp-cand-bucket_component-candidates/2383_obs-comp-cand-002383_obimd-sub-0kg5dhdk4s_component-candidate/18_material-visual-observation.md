# Material Visual Observation / obs-comp-cand-002383 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002383`
- External reference / 外部参照: `obimd-sub-0kg5dhdk4s`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020454_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0kg5dhdk4s/0kg5dhdk4s/0kg5dhdk4s.png`
- Checksum / 校验和:
  `38a927faf9595f8616333cc23bdf232ca155a26e14f6f803a46e5a26dd5090f2`
...
- Marked-pixel bounds: (89,16)–(158,232); span 70 × 217 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.36%。
- 痕迹范围：(89,16)–(158,232)；跨度70 × 217 px；痕迹矩形高于宽。
