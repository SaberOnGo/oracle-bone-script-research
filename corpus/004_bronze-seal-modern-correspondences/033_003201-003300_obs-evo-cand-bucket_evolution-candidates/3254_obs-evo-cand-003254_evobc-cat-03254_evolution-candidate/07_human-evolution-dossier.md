...
- External category reference: `evobc-cat-03254`
- Source category ID: `03254`
- Source label for human review: `扞`
...
- `obs-evo-cand-003254-route-category-staging`
...
- `obs-evo-cand-003254-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003254-route-evolution-graph`
