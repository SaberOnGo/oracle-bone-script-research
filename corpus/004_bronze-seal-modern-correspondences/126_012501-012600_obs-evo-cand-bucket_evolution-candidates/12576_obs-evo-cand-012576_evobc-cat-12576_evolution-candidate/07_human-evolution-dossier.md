...
Project ID: `obs-evo-cand-012576`
...
- Project ID: `obs-evo-cand-012576`
- EVOBC category candidate ID: `evobc-evo-cat-12576`
- External category reference: `evobc-cat-12576`
- Source category ID: `12576`
- Source label for human review: `𩋚`
- Source codepoints: `U+292DA`
...
- `obs-evo-cand-012576-route-category-staging`
...
- `obs-evo-cand-012576-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012576-route-evolution-graph`
