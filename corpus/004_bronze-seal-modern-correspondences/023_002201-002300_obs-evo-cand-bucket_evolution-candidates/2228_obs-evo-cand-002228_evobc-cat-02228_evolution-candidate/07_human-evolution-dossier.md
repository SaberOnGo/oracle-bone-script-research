...
Project ID: `obs-evo-cand-002228`
...
- Project ID: `obs-evo-cand-002228`
- EVOBC category candidate ID: `evobc-evo-cat-02228`
- External category reference: `evobc-cat-02228`
- Source category ID: `02228`
- Source label for human review: `媑`
- Source codepoints: `U+5A91`
...
- `obs-evo-cand-002228-route-category-staging`
...
- `obs-evo-cand-002228-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002228-route-evolution-graph`
