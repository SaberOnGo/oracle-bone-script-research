...
- External category reference: `evobc-cat-02632`
- Source category ID: `02632`
- Source label for human review: `巽`
- Source codepoints: `U+5DFD`
...
- `obs-evo-cand-002632-route-category-staging`
...
- `obs-evo-cand-002632-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002632-route-evolution-graph`
