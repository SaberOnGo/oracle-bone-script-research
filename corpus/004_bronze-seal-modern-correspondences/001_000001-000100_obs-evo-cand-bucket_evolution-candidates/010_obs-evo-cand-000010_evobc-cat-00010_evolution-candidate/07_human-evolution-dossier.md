...
Project ID: `obs-evo-cand-000010`
...
- Project ID: `obs-evo-cand-000010`
- EVOBC category candidate ID: `evobc-evo-cat-00010`
- External category reference: `evobc-cat-00010`
- Source category ID: `00010`
- Source label for human review: `㑞`
- Source codepoints: `U+345E`
...
- `obs-evo-cand-000010-route-category-staging`
...
- `obs-evo-cand-000010-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000010-route-evolution-graph`
