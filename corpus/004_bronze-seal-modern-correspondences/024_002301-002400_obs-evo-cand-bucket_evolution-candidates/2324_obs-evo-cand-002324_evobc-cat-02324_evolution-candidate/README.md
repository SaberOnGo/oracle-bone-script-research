# obs-evo-cand-002324 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-02324`
- Source label: `子`
- Source codepoints: `U+5B50`
- Image reference count: `640`
- Era token counts: `BI:122;CS:2;OBC:243;SAC:46;SS:2;WSC:225`
- Source token counts: `Book:247;Web:393`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 243 image references
- era 1 / BI: 122 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 46 image references
- era 4 / WSC: 225 image references
- era 5 / CS: 2 image references
- source 0 / Web:1633: 3 image references
- source 1 / Web:105952;說文Web:58: 321 image references
- source 2 / Book:17600: 84 image references
- source 3 / Book:21681: 63 image references
- source 4 / Book:9131: 46 image references
