# Material Visual Observation / obs-comp-cand-002034 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002034`
- External reference / 外部参照: `obimd-sub-pp2w04l9tf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019361_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/pp2w04l9tf/pp2w04l9tf/pp2w04l9tf.png`
- Checksum / 校验和:
  `1b776b8af8dc35c7ee5d8855d6954d5ffc54acee398e250bfb9649a531ff7b50`
...
- Marked-pixel bounds: (83,23)–(166,228); span 84 × 206 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.97%。
- 痕迹范围：(83,23)–(166,228)；跨度84 × 206 px；痕迹矩形高于宽。
