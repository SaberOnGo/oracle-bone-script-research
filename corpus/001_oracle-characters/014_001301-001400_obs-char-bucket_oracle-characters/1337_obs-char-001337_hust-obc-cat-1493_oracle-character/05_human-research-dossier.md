# obs-char-001337 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001337`
- primary external id: `hust-obc-cat-1493`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1337_obs-char-001337_hust-obc-cat-1493_ora
  cle-character/03_visual-assets/001_asset-001342_hust-obc-cat-1493_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1493/H_1493_6088C_0.png`
- asset id: `asset-001342`
...
- source category: `1493`
- validation class: `1336`
- source image route: `HUST-OBC/deciphered/1493/H_1493_6088C_0.png`
- asset id: `asset-001342`
...
- English observation: `A tall composite form has a long left stem, a
  central fork, and a broad angular right enclosure.`
- 中文观察: `高直组合形体有长左侧笔干、中央叉形和宽大的右侧折角框形。`
...
- dataset label text: `㧋`
- dataset label codepoints: `U+39CB`
...
- filename catalog route clues: `catalog-like filename clue: H_1493
  (H_1493_6088C_0.png)`
...
- Which source records identify obs-char-001337 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001337？
