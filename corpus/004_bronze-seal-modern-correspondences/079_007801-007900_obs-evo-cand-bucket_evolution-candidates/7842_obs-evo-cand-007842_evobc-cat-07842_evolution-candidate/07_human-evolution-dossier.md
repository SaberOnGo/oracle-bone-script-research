...
Project ID: `obs-evo-cand-007842`
...
- Project ID: `obs-evo-cand-007842`
- EVOBC category candidate ID: `evobc-evo-cat-07842`
- External category reference: `evobc-cat-07842`
- Source category ID: `07842`
- Source label for human review: `螽`
- Source codepoints: `U+87BD`
...
- `obs-evo-cand-007842-route-category-staging`
...
- `obs-evo-cand-007842-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007842-route-evolution-graph`
