# Material Visual Observation / obs-comp-cand-000469 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000469`
- External reference / 外部参照: `obimd-sub-5yv8bp6pym`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012621_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0k2px01a8e/5yv8bp6pym/5yv8bp6pym.png`
- Checksum / 校验和:
  `d90f1761f527b209814635202249b4c38b515aed01cce06267f2932d443112ac`
...
- Marked-pixel bounds: (80,28)–(169,224); span 90 × 197 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.78%。
- 痕迹范围：(80,28)–(169,224)；跨度90 × 197 px；痕迹矩形高于宽。
