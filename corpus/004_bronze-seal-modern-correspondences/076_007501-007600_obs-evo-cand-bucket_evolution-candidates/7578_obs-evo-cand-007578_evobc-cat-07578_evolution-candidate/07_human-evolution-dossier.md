...
- Project ID: `obs-evo-cand-007578`
- EVOBC category candidate ID: `evobc-evo-cat-07578`
- External category reference: `evobc-cat-07578`
- Source category ID: `07578`
- Source label for human review: `蕈`
- Source codepoints: `U+8548`
...
- `obs-evo-cand-007578-route-category-staging`
...
- `obs-evo-cand-007578-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007578-route-evolution-graph`
