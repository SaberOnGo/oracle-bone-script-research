# Material Visual Observation / obs-comp-cand-001985 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001985`
- External reference / 外部参照: `obimd-sub-i6zf7aufya`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018977_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qe26dg343r/i6zf7aufya/i6zf7aufya.png`
- Checksum / 校验和:
  `ac3869ae25cf6ab5a1e44f8c239fe023158414d2b1bb6703dcd99a3901be543a`
...
- Marked-pixel bounds: (83,32)–(160,214); span 78 × 183 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.28%。
- 痕迹范围：(83,32)–(160,214)；跨度78 × 183 px；痕迹矩形高于宽。
