# Material Visual Observation / obs-comp-cand-000703 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000703`
- External reference / 外部参照: `obimd-sub-i3lktxnh52`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013343_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/i3lktxnh52/i3lktxnh52/i3lktxnh52.png`
- Checksum / 校验和:
  `db2f409ec7e19b678d118663ab0882433a6e8b0fad864c3cd8ae4338767fb641`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.15%.
- Marked-pixel bounds: (91,20)–(156,227); span 66 × 208 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.15%。
- 痕迹范围：(91,20)–(156,227)；跨度66 × 208 px；痕迹矩形高于宽。
