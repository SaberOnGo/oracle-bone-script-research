...
- `obs-evo-cand-010911-route-category-staging`
...
- `obs-evo-cand-010911-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010911-route-evolution-graph`
