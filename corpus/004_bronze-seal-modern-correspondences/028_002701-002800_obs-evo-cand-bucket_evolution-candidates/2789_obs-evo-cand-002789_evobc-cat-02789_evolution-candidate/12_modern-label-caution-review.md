# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002789
...
- EVOBC candidate category: `evobc-evo-cat-02789`.
- Source label for search only: `弋`.
- Source codepoints for search only: `U+5F0B`.
