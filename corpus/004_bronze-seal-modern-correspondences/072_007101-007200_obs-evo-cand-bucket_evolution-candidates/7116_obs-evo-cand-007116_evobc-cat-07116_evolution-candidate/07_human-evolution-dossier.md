...
Project ID: `obs-evo-cand-007116`
...
- Project ID: `obs-evo-cand-007116`
- EVOBC category candidate ID: `evobc-evo-cat-07116`
- External category reference: `evobc-cat-07116`
- Source category ID: `07116`
- Source label for human review: `膂`
- Source codepoints: `U+8182`
...
- `obs-evo-cand-007116-route-category-staging`
...
- `obs-evo-cand-007116-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007116-route-evolution-graph`
