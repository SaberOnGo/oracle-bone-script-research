# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000099
...
| --- | --- | --- | --- |
| `obimd-glyph-link-001521` | 炈󰥬 | `U+7088;U+F096C` | `reviewed_metadata_only` |
| `obimd-glyph-link-001522` | 󰥭 | `U+F096D` | `reviewed_metadata_only` |
