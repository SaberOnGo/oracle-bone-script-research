# obs-unk-004285 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/085_obs-unk-004285_h
  ust-obc-und-L-004285_oracle-character-candidate/03_visual-assets/001_asset
  -005878_hust-obc-und-L-004285_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4285/L_？_9463.jpg`
- asset id: `asset-005878`
...
- source class: `HUST-OBC/undeciphered/L/4285/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4285/L_？_9463.jpg`
- asset id: `asset-005878`
...
- English observation: `Upper bar, rounded outline, right curves visible.`
- 中文观察: `上部横痕、圆弧轮廓和右侧弯曲痕迹可见。`
...
- Which source records identify obs-unk-004285 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004285？
