# obs-char-000554 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000554`
- primary external id: `hust-obc-cat-0628`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/554_obs-char-000554_hust-obc-cat-0628_orac
  le-character/03_visual-assets/001_asset-000559_hust-obc-cat-0628_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0628/H_0628_60B45_0.png`
- asset id: `asset-000559`
...
- source category: `0628`
- validation class: `553`
- source image route: `HUST-OBC/deciphered/0628/H_0628_60B45_0.png`
- asset id: `asset-000559`
...
- English observation: `A large pointed outer arch with long side strokes
  encloses a broad curved central hook and a small squared loop near the
  lower left.`
- 中文观察: `带长侧笔的大型尖顶外拱包围宽弯中央钩形和左下附近的小型方环。`
...
- dataset label text: `㙪`
- dataset label codepoints: `U+366A`
...
- filename catalog route clues: `catalog-like filename clue: H_0628
  (H_0628_60B45_0.png)`
...
- Which source records identify obs-char-000554 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000554？
