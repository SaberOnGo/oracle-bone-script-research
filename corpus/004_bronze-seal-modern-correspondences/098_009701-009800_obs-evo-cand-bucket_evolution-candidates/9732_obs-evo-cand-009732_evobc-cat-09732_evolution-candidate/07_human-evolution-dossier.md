...
Project ID: `obs-evo-cand-009732`
...
- Project ID: `obs-evo-cand-009732`
- EVOBC category candidate ID: `evobc-evo-cat-09732`
- External category reference: `evobc-cat-09732`
- Source category ID: `09732`
- Source label for human review: `陛`
- Source codepoints: `U+965B`
...
- `obs-evo-cand-009732-route-category-staging`
...
- `obs-evo-cand-009732-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009732-route-evolution-graph`
