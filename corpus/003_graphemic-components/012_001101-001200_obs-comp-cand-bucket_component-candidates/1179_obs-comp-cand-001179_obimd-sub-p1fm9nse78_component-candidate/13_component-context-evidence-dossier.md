# obs-comp-cand-001179 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001179`
- 首选外部 ID: `obimd-sub-p1fm9nse78`
- OBIMD subcharacter UID: `p1fm9nse78`
- OBIMD main character UID: `p1fm9nse78`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+5171;U+F6C7B; U+F6C7C
