...
- External category reference: `evobc-cat-06032`
- Source category ID: `06032`
- Source label for human review: `禧`
...
- `obs-evo-cand-006032-route-category-staging`
...
- `obs-evo-cand-006032-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006032-route-evolution-graph`
