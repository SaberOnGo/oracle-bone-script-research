# obs-char-000344 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000344`
- primary external id: `hust-obc-cat-0389`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/344_obs-char-000344_hust-obc-cat-0389_orac
  le-character/03_visual-assets/001_asset-000349_hust-obc-cat-0389_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0389/G_0389_甲骨文0.png`
- asset id: `asset-000349`
...
- source category: `0389`
- validation class: `343`
- source image route: `HUST-OBC/deciphered/0389/G_0389_甲骨文0.png`
- asset id: `asset-000349`
...
- English observation: `A broad rounded upper enclosure sits above three
  branching lower strokes with short side projections.`
- 中文观察: `宽大的圆弧上部闭合轮廓下方有三道分叉笔画，并带有短侧向伸出。`
...
- dataset label text: `㕻`
- dataset label codepoints: `U+357B`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00032`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00032`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00032`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/032_obs-evo-can
  d-000032_evobc-cat-00032_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/032_obs-evo-cand-000032_evobc-cat-00032_evolu
...
- Which source records identify obs-char-000344 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000344？
