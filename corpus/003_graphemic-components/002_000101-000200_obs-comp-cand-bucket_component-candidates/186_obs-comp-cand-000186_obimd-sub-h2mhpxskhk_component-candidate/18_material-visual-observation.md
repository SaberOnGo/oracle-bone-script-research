# Material Visual Observation / obs-comp-cand-000186 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000186`
- External reference / 外部参照: `obimd-sub-h2mhpxskhk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011598_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h2mhpxskhk/h2mhpxskhk/0w9lg11bab.png`
- Checksum / 校验和:
  `3e28af14f1181c0983918736ea3c80c4ef31715946dfeab4f01da0e6d97b81bb`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.01%.
- Marked-pixel bounds: (71,40)–(178,209); span 108 × 170 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.01%。
- 痕迹范围：(71,40)–(178,209)；跨度108 × 170 px；痕迹矩形高于宽。
