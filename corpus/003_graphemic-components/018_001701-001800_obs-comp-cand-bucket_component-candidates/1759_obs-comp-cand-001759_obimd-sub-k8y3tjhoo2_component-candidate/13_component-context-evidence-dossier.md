# obs-comp-cand-001759 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001759`
- 首选外部 ID: `obimd-sub-k8y3tjhoo2`
- OBIMD subcharacter UID: `k8y3tjhoo2`
- OBIMD main character UID: `cr5nhxdhbt`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+FA280; U+FA281; 另有 3 项
