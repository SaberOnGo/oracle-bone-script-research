...
- External category reference: `evobc-cat-03607`
- Source category ID: `03607`
- Source label for human review: `整`
- Source codepoints: `U+6574`
...
- `obs-evo-cand-003607-route-category-staging`
...
- `obs-evo-cand-003607-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003607-route-evolution-graph`
