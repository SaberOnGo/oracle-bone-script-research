...
- Title / 题名: 殷商甲骨詞彙 / Yin-Shang Oracle-Bone Vocabulary
- Provider / 提供方: Academia Sinica Institute of Linguistics
- Source type / 来源类型: online_database
- Scope / 适用范围: Official Digital Archives collection profile for Yin-Shang
  oracle-bone vocabulary covering major oracle-bone inscription corpora and
  broad topical vocabulary scope.
...
- Question / 待查问题: Which access or download row has status download_error; which
...
- Question / 待查问题: Which package, manifest, and field-map rows can support
  research_topic; source_reference without becoming claims?
