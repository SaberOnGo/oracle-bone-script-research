# Material Visual Observation / obs-comp-cand-002426 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002426`
- External reference / 外部参照: `obimd-sub-f21ak2i89u`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020497_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jpxofd3gmu/f21ak2i89u/f21ak2i89u.png`
- Checksum / 校验和:
  `23b8f3ee0542ea1ca1c852606047949885a90472e5aa5f6776d891a1716e3997`
...
- Marked-pixel bounds: (86,29)–(163,220); span 78 × 192 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.72%。
- 痕迹范围：(86,29)–(163,220)；跨度78 × 192 px；痕迹矩形高于宽。
