# Material Visual Observation / obs-comp-cand-001332 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001332`
- External reference / 外部参照: `obimd-sub-mw9onrbyo4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015669_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/aq5aoy9xbp/mw9onrbyo4/mw9onrbyo4.png`
- Checksum / 校验和:
  `913621c6bcc81a60431ad99a7e0303c58cf031192a5d59c29596c8d0f6580c07`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.52%.
- Marked-pixel bounds: (91,31)–(158,222); span 68 × 192 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.52%。
- 痕迹范围：(91,31)–(158,222)；跨度68 × 192 px；痕迹矩形高于宽。
