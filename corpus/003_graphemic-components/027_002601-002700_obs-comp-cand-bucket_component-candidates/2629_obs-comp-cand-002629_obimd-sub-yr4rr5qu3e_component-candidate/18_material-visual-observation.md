# Material Visual Observation / obs-comp-cand-002629 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002629`
- External reference / 外部参照: `obimd-sub-yr4rr5qu3e`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021168_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/yr4rr5qu3e/yr4rr5qu3e/yr4rr5qu3e.png`
- Checksum / 校验和:
  `8aaa67336818ddfcf31bb81e671a9d64a39eb0ed095c90d7793040dd9eabd153`
...
- Marked-pixel bounds: (72,24)–(165,228); span 94 × 205 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.83%。
- 痕迹范围：(72,24)–(165,228)；跨度94 × 205 px；痕迹矩形高于宽。
