...
- Project ID: `obs-evo-cand-011206`
- EVOBC category candidate ID: `evobc-evo-cat-11206`
- External category reference: `evobc-cat-11206`
- Source category ID: `11206`
- Source label for human review: `𢓸`
- Source codepoints: `U+224F8`
...
- `obs-evo-cand-011206-route-category-staging`
...
- `obs-evo-cand-011206-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011206-route-evolution-graph`
