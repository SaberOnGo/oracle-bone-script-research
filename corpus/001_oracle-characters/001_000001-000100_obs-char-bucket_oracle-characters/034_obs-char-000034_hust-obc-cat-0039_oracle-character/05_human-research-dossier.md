# obs-char-000034 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000034`
- primary external id: `hust-obc-cat-0039`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/034_obs-char-000034_hust-obc-cat-0039_orac
  le-character/03_visual-assets/001_asset-000039_hust-obc-cat-0039_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0039/H_0039_612C6_0.png`
- asset id: `asset-000039`
...
- source category: `0039`
- validation class: `33`
- source image route: `HUST-OBC/deciphered/0039/H_0039_612C6_0.png`
- asset id: `asset-000039`
...
- English observation: `The large elongated outline contains an enclosed
  central mark, upper diverging strokes, and a long lower extension.`
- 中文观察: `大型长形外轮廓内部有闭合中部痕迹、上方分开的笔画和长向下延伸。`
...
- dataset label text: `㐝`
- dataset label codepoints: `U+341D`
...
- filename catalog route clues: `catalog-like filename clue: H_0039
  (H_0039_612C6_0.png)`
...
- Which source records identify obs-char-000034 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000034？
