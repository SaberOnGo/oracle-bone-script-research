# Material Visual Observation / obs-comp-cand-001141 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001141`
- External reference / 外部参照: `obimd-sub-vwahtur1cj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015095_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vwahtur1cj/vwahtur1cj/0tmf9tz3ge.png`
- Checksum / 校验和:
  `7565e1aa3104d581d70a49367ce2559504f277a6d0108e4e9269c8da58825e57`
...
- Marked-pixel bounds: (87,38)–(162,198); span 76 × 161 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.89%。
- 痕迹范围：(87,38)–(162,198)；跨度76 × 161 px；痕迹矩形高于宽。
