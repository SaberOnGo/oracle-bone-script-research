...
- External category reference: `evobc-cat-01814`
- Source category ID: `01814`
- Source label for human review: `坐`
- Source codepoints: `U+5750`
- Image reference count in source metadata: `75`
...
- `obs-evo-cand-001814-route-category-staging`
...
- `obs-evo-cand-001814-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001814-route-evolution-graph`
