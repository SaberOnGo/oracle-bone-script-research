...
- Yingguo / 英国所藏: `y1039` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `183` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `467` in source row; primary catalog entry pending
