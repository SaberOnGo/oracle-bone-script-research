...
Project ID: `obs-evo-cand-007199`
...
- Project ID: `obs-evo-cand-007199`
- EVOBC category candidate ID: `evobc-evo-cat-07199`
- External category reference: `evobc-cat-07199`
- Source category ID: `07199`
- Source label for human review: `舟`
- Source codepoints: `U+821F`
...
- `obs-evo-cand-007199-route-category-staging`
...
- `obs-evo-cand-007199-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007199-route-evolution-graph`
