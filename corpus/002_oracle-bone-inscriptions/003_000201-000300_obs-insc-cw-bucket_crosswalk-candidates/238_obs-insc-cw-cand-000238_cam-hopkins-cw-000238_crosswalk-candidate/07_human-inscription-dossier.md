...
- Yingguo / 英国所藏: `y1495` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `189` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `634` in source row; primary catalog entry pending
