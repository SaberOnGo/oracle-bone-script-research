...
- Project ID: `obs-evo-cand-008587`
- EVOBC category candidate ID: `evobc-evo-cat-08587`
- External category reference: `evobc-cat-08587`
- Source category ID: `08587`
- Source label for human review: `賫`
- Source codepoints: `U+8CEB`
...
- `obs-evo-cand-008587-route-category-staging`
...
- `obs-evo-cand-008587-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008587-route-evolution-graph`
