# Material Visual Observation / obs-comp-cand-001228 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001228`
- External reference / 外部参照: `obimd-sub-u7j8pvl5zq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015466_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/u7j8pvl5zq/u7j8pvl5zq/u7j8pvl5zq.png`
- Checksum / 校验和:
  `a67a4c4f5c4c144c7838991236c7fb439d8078adb18eefe381a53119a2c7be03`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.97%.
- Marked-pixel bounds: (62,50)–(187,198); span 126 × 149 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.97%。
- 痕迹范围：(62,50)–(187,198)；跨度126 × 149 px；痕迹矩形近方形。
