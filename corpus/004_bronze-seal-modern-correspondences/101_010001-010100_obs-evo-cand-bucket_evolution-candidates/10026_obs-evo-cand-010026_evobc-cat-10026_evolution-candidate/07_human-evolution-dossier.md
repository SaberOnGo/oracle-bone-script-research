...
- External category reference: `evobc-cat-10026`
- Source category ID: `10026`
- Source label for human review: `顜`
- Source codepoints: `U+985C`
...
- `obs-evo-cand-010026-route-category-staging`
...
- `obs-evo-cand-010026-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010026-route-evolution-graph`
