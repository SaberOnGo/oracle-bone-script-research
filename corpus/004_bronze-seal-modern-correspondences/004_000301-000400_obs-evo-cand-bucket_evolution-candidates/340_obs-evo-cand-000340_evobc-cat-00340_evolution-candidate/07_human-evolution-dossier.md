...
- Project ID: `obs-evo-cand-000340`
- EVOBC category candidate ID: `evobc-evo-cat-00340`
- External category reference: `evobc-cat-00340`
- Source category ID: `00340`
- Source label for human review: `䍃`
- Source codepoints: `U+4343`
...
- `obs-evo-cand-000340-route-category-staging`
...
- `obs-evo-cand-000340-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000340-route-evolution-graph`
