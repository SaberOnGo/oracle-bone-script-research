# obs-unk-005692 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005692`
- primary external id: `hust-obc-und-X-005692`
...
- local review image route: `corpus/001_oracle-characters/073_undeciphered-005
  601-005700_obs-unk-bucket_oracle-character-candidates/092_obs-unk-005692_h
  ust-obc-und-X-005692_oracle-character-candidate/03_visual-assets/001_asset
  -007285_hust-obc-und-X-005692_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1248/X_？_1156_1.png`
- asset id: `asset-007285`
...
- source class: `HUST-OBC/undeciphered/X/1248/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1248/X_？_1156_1.png`
- asset id: `asset-007285`
...
- Which source records identify obs-unk-005692 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005692？
