# obs-char-001430 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1430_obs-char-001430_hust-obc-cat-1602_ora
  cle-character/03_visual-assets/001_asset-001435_hust-obc-cat-1602_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1602/G_1602_前4.47.3合36836黃組.png
  `
- asset id: `asset-001435`
...
- source category: `1602`
- validation class: `1429`
- source image route: `HUST-OBC/deciphered/1602/G_1602_前4.47.3合36836黃組.png`
- asset id: `asset-001435`
...
- English observation: `A narrow central form has detached left marks, an
  upper loop, and lower branches.`
- 中文观察: `狭长中央形体有分离左侧笔画、上部环形和下部分枝。`
...
- dataset label text: `㨸`
- dataset label codepoints: `U+3A38`
...
- filename catalog route clues: `Heji-like filename clue: 合36836
  (G_1602_前4.47.3合36836黃組.png)`
...
- Which source records identify obs-char-001430 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001430？
