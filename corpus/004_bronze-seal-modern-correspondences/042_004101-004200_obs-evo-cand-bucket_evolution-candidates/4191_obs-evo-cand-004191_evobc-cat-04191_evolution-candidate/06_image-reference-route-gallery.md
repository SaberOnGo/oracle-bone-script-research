...
- `obs-evo-cand-004191-route-category-staging`
...
- `obs-evo-cand-004191-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004191-route-evolution-graph`
