...
- External category reference: `evobc-cat-06673`
- Source category ID: `06673`
- Source label for human review: `織`
- Source codepoints: `U+7E54`
...
- `obs-evo-cand-006673-route-category-staging`
...
- `obs-evo-cand-006673-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006673-route-evolution-graph`
