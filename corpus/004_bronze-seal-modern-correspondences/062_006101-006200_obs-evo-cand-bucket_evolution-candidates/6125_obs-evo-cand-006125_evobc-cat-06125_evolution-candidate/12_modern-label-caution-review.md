# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006125
...
- EVOBC candidate category: `evobc-evo-cat-06125`.
- Source label for search only: `穊`.
- Source codepoints for search only: `U+7A4A`.
