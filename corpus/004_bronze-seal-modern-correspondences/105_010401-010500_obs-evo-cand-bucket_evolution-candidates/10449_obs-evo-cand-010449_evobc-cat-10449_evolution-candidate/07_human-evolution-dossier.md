...
- External category reference: `evobc-cat-10449`
- Source category ID: `10449`
- Source label: `鱣`
...
- `obs-evo-cand-010449-route-category-staging`
...
- `obs-evo-cand-010449-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010449-route-evolution-graph`
