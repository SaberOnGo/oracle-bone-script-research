...
- `obs-evo-cand-003357-route-category-staging`
...
- `obs-evo-cand-003357-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003357-route-evolution-graph`
