# obs-char-001160 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001160`
- primary external id: `hust-obc-cat-1299`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1160_obs-char-001160_hust-obc-cat-1299_ora
  cle-character/03_visual-assets/001_asset-001165_hust-obc-cat-1299_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1299/G_1299_甲骨文0.png`
- asset id: `asset-001165`
...
- source category: `1299`
- validation class: `1159`
- source image route: `HUST-OBC/deciphered/1299/G_1299_甲骨文0.png`
- asset id: `asset-001165`
...
- English observation: `A narrow upright form has a short upper horizontal,
  a central vertical, and an open rounded lower loop.`
- 中文观察: `狭长直立形体有短上部横笔、中央竖笔和开放的下部圆弧环。`
...
- dataset label text: `㤉`
- dataset label codepoints: `U+3909`
...
- Which source records identify obs-char-001160 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001160？
