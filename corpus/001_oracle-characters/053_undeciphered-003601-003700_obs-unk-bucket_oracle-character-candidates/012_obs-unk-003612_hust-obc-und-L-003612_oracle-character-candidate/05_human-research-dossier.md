# obs-unk-003612 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003612`
- primary external id: `hust-obc-und-L-003612`
...
- local review image route: `corpus/001_oracle-characters/053_undeciphered-003
  601-003700_obs-unk-bucket_oracle-character-candidates/012_obs-unk-003612_h
  ust-obc-und-L-003612_oracle-character-candidate/03_visual-assets/001_asset
  -005205_hust-obc-und-L-003612_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3612/L_？_7295.jpg`
- asset id: `asset-005205`
...
- source class: `HUST-OBC/undeciphered/L/3612/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3612/L_？_7295.jpg`
- asset id: `asset-005205`
...
- Which source records identify obs-unk-003612 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003612？
