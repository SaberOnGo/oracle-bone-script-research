...
Project ID: `obs-evo-cand-013296`
...
- Project ID: `obs-evo-cand-013296`
- EVOBC category candidate ID: `evobc-evo-cat-13296`
- External category reference: `evobc-cat-13296`
- Source category ID: `13296`
- Source label for human review: `𬙣`
- Source codepoints: `U+2C663`
...
- `obs-evo-cand-013296-route-category-staging`
...
- `obs-evo-cand-013296-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013296-route-evolution-graph`
