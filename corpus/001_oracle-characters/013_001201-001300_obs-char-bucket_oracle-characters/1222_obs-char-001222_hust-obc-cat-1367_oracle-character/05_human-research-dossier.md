# obs-char-001222 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1222_obs-char-001222_hust-obc-cat-1367_ora
  cle-character/03_visual-assets/001_asset-001227_hust-obc-cat-1367_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1367/G_1367_乙5589合17192賓組.png`
- asset id: `asset-001227`
...
- source category: `1367`
- validation class: `1221`
- source image route: `HUST-OBC/deciphered/1367/G_1367_乙5589合17192賓組.png`
- asset id: `asset-001227`
...
- English observation: `A compact dense cluster combines several small
  loops, short right side strokes, and a lower rounded turn.`
...
- dataset label text: `㥍`
- dataset label codepoints: `U+394D`
...
- Which source records identify obs-char-001222 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001222？
