...
- External category reference: `evobc-cat-02960`
- Source category ID: `02960`
- Source label for human review: `总`
- Source codepoints: `U+603B`
...
- `obs-evo-cand-002960-route-category-staging`
...
- `obs-evo-cand-002960-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002960-route-evolution-graph`
