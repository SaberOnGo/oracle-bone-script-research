# Material Visual Observation / obs-comp-cand-000289 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000289`
- External reference / 外部参照: `obimd-sub-amw9e2zasz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011997_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rlx0knkq0v/amw9e2zasz/amw9e2zasz.png`
- Checksum / 校验和:
  `ca343b2a530cea0e709362b018bc19a93755ac02b450e04409da683e63ecb25c`
...
- Marked-pixel bounds: (76,22)–(173,225); span 98 × 204 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.39%。
- 痕迹范围：(76,22)–(173,225)；跨度98 × 204 px；痕迹矩形高于宽。
