# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004878
...
- EVOBC candidate category: `evobc-evo-cat-04878`.
- Source label for search only: `漬`.
- Source codepoints for search only: `U+6F2C`.
