...
- External category reference: `evobc-cat-03141`
- Source category ID: `03141`
- Source label for human review: `憂`
- Source codepoints: `U+6182`
...
- `obs-evo-cand-003141-route-category-staging`
...
- `obs-evo-cand-003141-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003141-route-evolution-graph`
