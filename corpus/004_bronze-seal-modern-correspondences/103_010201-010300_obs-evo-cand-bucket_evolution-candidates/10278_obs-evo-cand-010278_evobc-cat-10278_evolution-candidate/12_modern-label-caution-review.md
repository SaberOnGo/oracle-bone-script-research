# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010278
...
- EVOBC candidate category: `evobc-evo-cat-10278`.
- Source label for search only: `驽`.
- Source codepoints for search only: `U+9A7D`.
