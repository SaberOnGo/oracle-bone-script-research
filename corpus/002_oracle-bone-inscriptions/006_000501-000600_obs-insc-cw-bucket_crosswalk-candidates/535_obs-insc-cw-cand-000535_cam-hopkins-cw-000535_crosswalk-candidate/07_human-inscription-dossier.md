...
Project ID: `obs-insc-cw-cand-000535`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000535`
...
- Yingguo / 英国所藏: `y2532` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `346` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `458a` in source row; primary catalog entry
  pending
- Heji / 合集: `41770` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000535`
