# src-open-oracle Material Access Index / src-open-oracle 资料访问索引
...
| --- | --- | --- | --- |
| Source summary / 来源摘要 | `README.md` | present | source ID `src-open-oracle` |
...
| Package or file manifest routes / 来源包或文件清单路线 | `03_package-route-index.csv` | route_rows_present | 1 route row(s); kinds: lightweight_md_text |
| Field maps / 字段映射 | `04_field-map-route-index.csv` | not_present_in_current_registers | 0 row(s); target records: none |
| Downloaded metadata profiles / 已下载 metadata profile | `05_metadata-profile-route-index.csv` | profile_rows_present | 2 row(s); metrics: downloaded_readme_size_bytes;registered_project_links |
...
- Risk note / 风险提示: Useful for locating academic datasets and AI task strategies; underlying dataset rights and source chains must be reviewed separately.
