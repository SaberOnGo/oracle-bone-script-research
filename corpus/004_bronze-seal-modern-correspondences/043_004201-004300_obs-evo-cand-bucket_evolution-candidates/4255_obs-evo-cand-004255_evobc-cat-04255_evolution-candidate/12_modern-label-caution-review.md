# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004255
...
- EVOBC candidate category: `evobc-evo-cat-04255`.
- Source label for search only: `樺`.
- Source codepoints for search only: `U+6A3A`.
