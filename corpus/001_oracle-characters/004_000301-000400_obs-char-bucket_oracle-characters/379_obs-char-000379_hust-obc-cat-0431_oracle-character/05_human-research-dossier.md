# obs-char-000379 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/379_obs-char-000379_hust-obc-cat-0431_orac
  le-character/03_visual-assets/001_asset-000384_hust-obc-cat-0431_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0431/G_0431_乙1874合940賓組.png`
- asset id: `asset-000384`
...
- source category: `0431`
- validation class: `378`
- source image route: `HUST-OBC/deciphered/0431/G_0431_乙1874合940賓組.png`
- asset id: `asset-000384`
...
- English observation: `A small upper crossbar and central stem lead to side
  branches and two narrow lower strokes.`
- 中文观察: `小型上部横笔画和中央主干连接侧向分支及两条狭长下部笔画。`
...
- dataset label text: `㖥`
- dataset label codepoints: `U+35A5`
...
- filename catalog route clues: `Heji-like filename clue: 合940
  (G_0431_乙1874合940賓組.png)`
...
- Which source records identify obs-char-000379 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000379？
