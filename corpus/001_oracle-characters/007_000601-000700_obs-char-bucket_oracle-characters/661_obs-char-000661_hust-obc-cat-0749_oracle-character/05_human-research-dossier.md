# obs-char-000661 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000661`
- primary external id: `hust-obc-cat-0749`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/661_obs-char-000661_hust-obc-cat-0749_orac
  le-character/03_visual-assets/001_asset-000666_hust-obc-cat-0749_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0749/G_0749_京津4454合29403無名組.png
  `
- asset id: `asset-000666`
...
- source category: `0749`
- validation class: `660`
- source image route: `HUST-OBC/deciphered/0749/G_0749_京津4454合29403無名組.png`
- asset id: `asset-000666`
...
- English observation: `Two detached groups stand side by side: a left top
  cross above a bar with three narrow descents, and a tall right stem with
  an angled top and crossing middle branch.`
...
- dataset label text: `㛣`
- dataset label codepoints: `U+36E3`
...
- filename catalog route clues: `Heji-like filename clue: 合29403
...
- Which source records identify obs-char-000661 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000661？
