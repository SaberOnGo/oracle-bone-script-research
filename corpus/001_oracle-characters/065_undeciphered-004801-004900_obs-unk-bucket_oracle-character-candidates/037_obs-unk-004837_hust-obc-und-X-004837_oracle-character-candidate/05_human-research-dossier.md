# obs-unk-004837 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004837`
- primary external id: `hust-obc-und-X-004837`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/037_obs-unk-004837_h
  ust-obc-und-X-004837_oracle-character-candidate/03_visual-assets/001_asset
  -006430_hust-obc-und-X-004837_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/393/X_？_7120_1.png`
- asset id: `asset-006430`
...
- source class: `HUST-OBC/undeciphered/X/393/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/393/X_？_7120_1.png`
- asset id: `asset-006430`
...
- English observation: `upper bar, left branch, and lower crossing`
- 中文观察: `上部横向结构、左侧分支和下部交叉`
...
- Which source records identify obs-unk-004837 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004837？
