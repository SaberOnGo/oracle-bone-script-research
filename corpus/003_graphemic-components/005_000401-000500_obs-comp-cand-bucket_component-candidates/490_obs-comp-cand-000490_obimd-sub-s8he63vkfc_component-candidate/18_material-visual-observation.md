# Material Visual Observation / obs-comp-cand-000490 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000490`
- External reference / 外部参照: `obimd-sub-s8he63vkfc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012726_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3xbmgmm4j0/s8he63vkfc/s8he63vkfc.png`
- Checksum / 校验和:
  `07f3554f37d2fa3611f19a8d58e740dd666a7f8b67c29a4ce27ecf25ce706b17`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.96%.
- Marked-pixel bounds: (58,36)–(191,222); span 134 × 187 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.96%。
- 痕迹范围：(58,36)–(191,222)；跨度134 × 187 px；痕迹矩形高于宽。
