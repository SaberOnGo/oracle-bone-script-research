...
- External category reference: `evobc-cat-10631`
- Source category ID: `10631`
- Source label for human review: `麼`
...
- `obs-evo-cand-010631-route-category-staging`
...
- `obs-evo-cand-010631-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010631-route-evolution-graph`
