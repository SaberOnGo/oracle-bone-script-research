...
- External category reference: `evobc-cat-07920`
- Source category ID: `07920`
- Source label: `衦`
...
- `obs-evo-cand-007920-route-category-staging`
...
- `obs-evo-cand-007920-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007920-route-evolution-graph`
