# obs-unk-004423 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/023_obs-unk-004423_h
  ust-obc-und-L-004423_oracle-character-candidate/03_visual-assets/001_asset
  -006016_hust-obc-und-L-004423_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4423/L_？_9907.jpg`
- asset id: `asset-006016`
...
- source class: `HUST-OBC/undeciphered/L/4423/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4423/L_？_9907.jpg`
- asset id: `asset-006016`
...
- English observation: `A long curved trace sits above separate dots`
  `and a dark lower bar.`
- 中文观察: `长弯曲痕迹位于分离小点和下部深色横线之上。`
...
- Which source records identify obs-unk-004423 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004423？
