...
Project ID: `obs-evo-cand-002820`
...
- Project ID: `obs-evo-cand-002820`
- EVOBC category candidate ID: `evobc-evo-cat-02820`
- External category reference: `evobc-cat-02820`
- Source category ID: `02820`
- Source label for human review: `彀`
- Source codepoints: `U+5F40`
...
- `obs-evo-cand-002820-route-category-staging`
...
- `obs-evo-cand-002820-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002820-route-evolution-graph`
