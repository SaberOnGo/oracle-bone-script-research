...
- 本项目 ID：`obs-evo-cand-000717`
- EVOBC 候选类别 ID：`evobc-evo-cat-00717`
- 外部类别引用：`evobc-cat-00717`
- 来源类别 ID：`00717`
- 来源标签：`亻`
- 来源 codepoints：`U+4EBB`
- EVOBC 图像引用数量：`399`
...
- era `4`
  token: `WSC`
  image references: 364
- source `1`
  token: `Web:105952;說文Web:58`
  image references: 399

## 图像引用路线卡

- `obs-evo-cand-000717-route-category-staging`
...
- `obs-evo-cand-000717-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000717-route-evolution-graph`
