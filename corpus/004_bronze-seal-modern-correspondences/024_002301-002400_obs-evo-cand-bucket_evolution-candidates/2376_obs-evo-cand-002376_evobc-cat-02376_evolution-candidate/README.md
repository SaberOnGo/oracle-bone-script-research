# obs-evo-cand-002376 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-002376`
- EVOBC category candidate ID: `evobc-evo-cat-02376`
- External category ref: `evobc-cat-02376`
- Source label: `定`
- Source codepoints: `U+5B9A`
- Image reference count: `114`
- Era token counts: `BI:18;CS:1;OBC:30;SAC:8;SS:2;WSC:55`
- Source token counts: `Book:32;Web:82`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 30 image references
