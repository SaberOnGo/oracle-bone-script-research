# obs-char-001131 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1131_obs-char-001131_hust-obc-cat-1264_ora
  cle-character/03_visual-assets/001_asset-001136_hust-obc-cat-1264_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1264/G_1264_京都2226合31675.png`
- asset id: `asset-001136`
...
- source category: `1264`
- validation class: `1130`
- source image route: `HUST-OBC/deciphered/1264/G_1264_京都2226合31675.png`
- asset id: `asset-001136`
...
- English observation: `A narrow form has two long descending side strokes,
  a central crossing, and a rounded lower loop.`
- 中文观察: `狭长形体有两条长下行侧笔、中央交叉和圆弧下部环笔。`
...
- dataset label text: `㣦`
- dataset label codepoints: `U+38E6`
...
- filename catalog route clues: `Heji-like filename clue: 合31675
  (G_1264_京都2226合31675.png)`
...
- Which source records identify obs-char-001131 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001131？
