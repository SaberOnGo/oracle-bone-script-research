...
- External category reference: `evobc-cat-13058`
- Source category ID: `13058`
- Source label for human review: `𫭍`
- Source codepoints: `U+2BB4D`
...
- `obs-evo-cand-013058-route-category-staging`
...
- `obs-evo-cand-013058-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013058-route-evolution-graph`
