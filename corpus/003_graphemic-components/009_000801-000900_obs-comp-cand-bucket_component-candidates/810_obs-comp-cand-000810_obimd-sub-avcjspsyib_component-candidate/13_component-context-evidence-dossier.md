# obs-comp-cand-000810 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000810`
- 首选外部 ID: `obimd-sub-avcjspsyib`
- OBIMD subcharacter UID: `avcjspsyib`
- OBIMD main character UID: `avcjspsyib`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+3CBB;U+F4923; U+F4924
