...
- Review draft ID / 复核草稿 ID: `source-pipeline-missing-evidence-review-draft-005`
- Source summary ID / 来源汇总 ID: `source-pipeline-phase-action-missing-evidence-source-summary-005`
...
- source_package_file_ids: `pkg-file-000019`
