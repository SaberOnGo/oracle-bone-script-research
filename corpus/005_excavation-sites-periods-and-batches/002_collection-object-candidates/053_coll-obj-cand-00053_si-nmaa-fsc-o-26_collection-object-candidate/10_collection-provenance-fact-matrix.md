...
| Catalog or accession route | FSC-O-26; source-page route only | 02_collection-source-index.csv; 06_human-collection-dossier.md |
| Image or visual route | committed_public_domain_asset; open gallery before visual use | 03_visual-asset-index.csv; 04_visual-gallery.md |
| Findspot or provenience | China | 06_human-collection-dossier.md; 08_collection-provenance-evidence-dossier.md |
| Period or date | Shang dynasty, ca. 1600 - ca. 1050 BCE | 06_human-collection-dossier.md; 08_collection-provenance-evidence-dossier.md |
...
| Source and rights trail | src-smithsonian-nmaa-oracle-bone; rights public_domain_verified | 02_collection-source-index.csv; 09_collection-provenance-evidence-index.json |
