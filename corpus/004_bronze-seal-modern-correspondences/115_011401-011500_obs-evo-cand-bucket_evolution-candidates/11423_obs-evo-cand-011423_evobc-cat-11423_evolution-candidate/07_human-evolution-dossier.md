...
- External category reference: `evobc-cat-11423`
- Source category ID: `11423`
- Source label for human review: `𣎳`
...
- `obs-evo-cand-011423-route-category-staging`
...
- `obs-evo-cand-011423-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011423-route-evolution-graph`
