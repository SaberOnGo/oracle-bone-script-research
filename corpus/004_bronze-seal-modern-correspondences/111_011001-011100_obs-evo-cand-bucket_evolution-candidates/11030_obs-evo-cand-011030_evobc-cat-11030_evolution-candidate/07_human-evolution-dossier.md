...
- External category reference: `evobc-cat-11030`
- Source category ID: `11030`
- Source label for human review: `𡚱`
- Source codepoints: `U+216B1`
...
- `obs-evo-cand-011030-route-category-staging`
...
- `obs-evo-cand-011030-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011030-route-evolution-graph`
