...
Project ID: `obs-evo-cand-007323`
...
- Project ID: `obs-evo-cand-007323`
- EVOBC category candidate ID: `evobc-evo-cat-07323`
- External category reference: `evobc-cat-07323`
- Source category ID: `07323`
- Source label for human review: `茭`
- Source codepoints: `U+832D`
...
- `obs-evo-cand-007323-route-category-staging`
...
- `obs-evo-cand-007323-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007323-route-evolution-graph`
