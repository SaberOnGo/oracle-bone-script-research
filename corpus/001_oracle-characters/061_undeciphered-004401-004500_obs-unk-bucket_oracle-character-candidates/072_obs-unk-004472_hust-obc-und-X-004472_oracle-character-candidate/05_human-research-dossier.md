# obs-unk-004472 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/072_obs-unk-004472_h
  ust-obc-und-X-004472_oracle-character-candidate/03_visual-assets/001_asset
  -006065_hust-obc-und-X-004472_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/28/X_？_8206_1.png`
- asset id: `asset-006065`
...
- source class: `HUST-OBC/undeciphered/X/28/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/28/X_？_8206_1.png`
- asset id: `asset-006065`
...
- English observation: A narrow branching stem crosses diagonal traces and
  continues into a tapered curved lower stroke.
- 中文观察: 窄长分支痕迹与斜线交叉，并延伸为渐细下部弧线。
...
- Which source records identify obs-unk-004472 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004472？
