...
- External category reference: `evobc-cat-00753`
- Source category ID: `00753`
- Source label for human review: `件`
- Source codepoints: `U+4EF6`
...
- `obs-evo-cand-000753-route-category-staging`
...
- `obs-evo-cand-000753-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000753-route-evolution-graph`
