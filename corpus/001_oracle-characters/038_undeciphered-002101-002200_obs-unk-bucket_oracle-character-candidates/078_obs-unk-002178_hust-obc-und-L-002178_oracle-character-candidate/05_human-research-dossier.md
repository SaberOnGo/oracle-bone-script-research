# obs-unk-002178 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002178`
- primary external id: `hust-obc-und-L-002178`
...
- local review image route: `corpus/001_oracle-characters/038_undeciphered-002
  101-002200_obs-unk-bucket_oracle-character-candidates/078_obs-unk-002178_h
  ust-obc-und-L-002178_oracle-character-candidate/03_visual-assets/001_asset
  -003771_hust-obc-und-L-002178_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2178/L_？_2556.jpg`
- asset id: `asset-003771`
...
- source class: `HUST-OBC/undeciphered/L/2178/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2178/L_？_2556.jpg`
- asset id: `asset-003771`
...
- Which source records identify obs-unk-002178 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002178？
