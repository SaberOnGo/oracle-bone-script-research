# Material Visual Observation / obs-comp-cand-000848 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000848`
- External reference / 外部参照: `obimd-sub-jmlf3qvty5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013719_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jmlf3qvty5/jmlf3qvty5/jmlf3qvty5.png`
- Checksum / 校验和:
  `ea4d13e08fc3667d5103f15dcf7e92e01ba547d7b7b1abbff9f5d0ca5a9e1036`
...
- Marked-pixel bounds: (90,28)–(159,223); span 70 × 196 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.91%。
- 痕迹范围：(90,28)–(159,223)；跨度70 × 196 px；痕迹矩形高于宽。
