...
- External category reference: `evobc-cat-03305`
- Source category ID: `03305`
- Source label for human review: `拇`
...
- `obs-evo-cand-003305-route-category-staging`
...
- `obs-evo-cand-003305-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003305-route-evolution-graph`
