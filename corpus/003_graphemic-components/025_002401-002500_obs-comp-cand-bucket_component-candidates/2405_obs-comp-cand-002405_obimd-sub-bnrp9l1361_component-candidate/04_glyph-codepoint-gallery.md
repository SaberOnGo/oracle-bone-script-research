# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002405
...
| --- | --- | --- | --- |
| `obimd-glyph-link-036833` | 󽮃 | `U+FDB83` | `reviewed_metadata_only` |
| `obimd-glyph-link-036834` | 󽮄 | `U+FDB84` | `reviewed_metadata_only` |
| `obimd-glyph-link-036835` | 󽮅 | `U+FDB85` | `reviewed_metadata_only` |
