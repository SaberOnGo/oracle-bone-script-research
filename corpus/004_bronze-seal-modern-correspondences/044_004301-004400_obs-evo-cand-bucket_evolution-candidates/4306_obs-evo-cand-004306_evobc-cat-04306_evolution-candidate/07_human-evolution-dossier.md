...
- External category reference: `evobc-cat-04306`
- Source category ID: `04306`
- Source label for human review: `櫅`
- Source codepoints: `U+6AC5`
...
- `obs-evo-cand-004306-route-category-staging`
...
- `obs-evo-cand-004306-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004306-route-evolution-graph`
