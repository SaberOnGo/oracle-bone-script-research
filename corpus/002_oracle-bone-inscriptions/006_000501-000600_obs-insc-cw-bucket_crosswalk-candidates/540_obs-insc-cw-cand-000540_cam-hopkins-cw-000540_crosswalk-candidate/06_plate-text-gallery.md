...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000540` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2542` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `375` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `742` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `41802` [route_present_image_or_text_not_collected]
