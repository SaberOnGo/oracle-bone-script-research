...
- `obs-evo-cand-002175-route-category-staging`
...
- `obs-evo-cand-002175-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002175-route-evolution-graph`
