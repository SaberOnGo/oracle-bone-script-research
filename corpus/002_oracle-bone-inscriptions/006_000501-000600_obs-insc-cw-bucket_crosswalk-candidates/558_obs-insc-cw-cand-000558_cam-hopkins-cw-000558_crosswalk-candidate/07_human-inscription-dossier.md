...
Project ID: `obs-insc-cw-cand-000558`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000558`
...
- Source page section: `Period V Group 8` /
  `第 V 期第 8 组`
- Source section key: `period-v-group-8`
- Section declared count: `not stated`
- Section observed row count: `21`
- Count status: `source_section_has_no_declared_count`
...
- Yingguo / 英国所藏: `y2567` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `603` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `511` in source row; primary catalog entry pending
- Heji / 合集: `41866` in source row; primary catalog entry pending
...
- Findspot / 出土地: 待查: excavation or findspot evidence for the physical
  object
- Period / 时期: `V` from source metadata; not a new dating
- Group and batch / 组类与批次: group `8`; batch or pit context pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000558`
