...
Project ID: `obs-evo-cand-008352`
...
- Project ID: `obs-evo-cand-008352`
- EVOBC category candidate ID: `evobc-evo-cat-08352`
- External category reference: `evobc-cat-08352`
- Source category ID: `08352`
- Source label for human review: `譌`
- Source codepoints: `U+8B4C`
...
- `obs-evo-cand-008352-route-category-staging`
...
- `obs-evo-cand-008352-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008352-route-evolution-graph`
