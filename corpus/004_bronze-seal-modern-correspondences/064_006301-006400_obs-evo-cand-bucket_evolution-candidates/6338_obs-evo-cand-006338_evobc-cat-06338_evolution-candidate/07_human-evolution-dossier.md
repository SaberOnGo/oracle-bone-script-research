...
Project ID: `obs-evo-cand-006338`
...
- Project ID: `obs-evo-cand-006338`
- EVOBC category candidate ID: `evobc-evo-cat-06338`
- External category reference: `evobc-cat-06338`
- Source category ID: `06338`
- Source label for human review: `簀`
- Source codepoints: `U+7C00`
...
- `obs-evo-cand-006338-route-category-staging`
...
- `obs-evo-cand-006338-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006338-route-evolution-graph`
