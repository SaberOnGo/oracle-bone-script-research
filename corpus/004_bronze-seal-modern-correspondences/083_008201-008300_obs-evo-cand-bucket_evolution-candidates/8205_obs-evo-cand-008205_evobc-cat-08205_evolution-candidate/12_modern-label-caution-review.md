# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008205
...
- EVOBC candidate category: `evobc-evo-cat-08205`.
- Source label for search only: `詷`.
- Source codepoints for search only: `U+8A77`.
