...
- External category reference: `evobc-cat-13707`
- Source category ID: `13707`
- Source label for human review: `靈`
...
- `obs-evo-cand-013707-route-category-staging`
...
- `obs-evo-cand-013707-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013707-route-evolution-graph`
