...
Project ID: `obs-evo-cand-011132`
...
- Project ID: `obs-evo-cand-011132`
- EVOBC category candidate ID: `evobc-evo-cat-11132`
- External category reference: `evobc-cat-11132`
- Source category ID: `11132`
- Source label for human review: `𡿪`
- Source codepoints: `U+21FEA`
...
- `obs-evo-cand-011132-route-category-staging`
...
- `obs-evo-cand-011132-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011132-route-evolution-graph`
