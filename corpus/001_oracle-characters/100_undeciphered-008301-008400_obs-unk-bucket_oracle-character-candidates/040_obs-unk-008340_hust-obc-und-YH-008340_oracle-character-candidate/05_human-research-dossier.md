# obs-unk-008340 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008340`
- primary external id: `hust-obc-und-YH-008340`
...
- local review image route: `corpus/001_oracle-characters/100_undeciphered-008
  301-008400_obs-unk-bucket_oracle-character-candidates/040_obs-unk-008340_h
  ust-obc-und-YH-008340_oracle-character-candidate/03_visual-assets/001_asse
  t-009931_hust-obc-und-YH-008340_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/609F8/H_？_609F8_0.png`
- asset id: `asset-009931`
...
- source class: `HUST-OBC/undeciphered/Y+H/609F8/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/609F8/H_？_609F8_0.png`
- asset id: `asset-009931`
...
- Which source records identify obs-unk-008340 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008340？
