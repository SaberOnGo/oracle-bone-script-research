...
Project ID: `obs-evo-cand-001335`
...
- Project ID: `obs-evo-cand-001335`
- EVOBC category candidate ID: `evobc-evo-cat-01335`
- External category reference: `evobc-cat-01335`
- Source category ID: `01335`
- Source label for human review: `匕`
- Source codepoints: `U+5315`
...
- `obs-evo-cand-001335-route-category-staging`
...
- `obs-evo-cand-001335-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001335-route-evolution-graph`
