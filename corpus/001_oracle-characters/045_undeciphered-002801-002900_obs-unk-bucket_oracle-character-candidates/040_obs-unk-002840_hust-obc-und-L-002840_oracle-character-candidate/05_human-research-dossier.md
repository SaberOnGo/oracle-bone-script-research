# obs-unk-002840 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002840`
- primary external id: `hust-obc-und-L-002840`
...
- local review image route: `corpus/001_oracle-characters/045_undeciphered-002
  801-002900_obs-unk-bucket_oracle-character-candidates/040_obs-unk-002840_h
  ust-obc-und-L-002840_oracle-character-candidate/03_visual-assets/001_asset
  -004433_hust-obc-und-L-002840_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2840/L_？_4752.jpg`
- asset id: `asset-004433`
...
- source class: `HUST-OBC/undeciphered/L/2840/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2840/L_？_4752.jpg`
- asset id: `asset-004433`
...
- Which source records identify obs-unk-002840 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002840？
