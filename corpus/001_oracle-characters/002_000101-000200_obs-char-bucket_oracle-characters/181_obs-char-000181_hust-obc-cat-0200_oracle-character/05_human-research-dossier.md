# obs-char-000181 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000181`
- primary external id: `hust-obc-cat-0200`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/181_obs-char-000181_hust-obc-cat-0200_orac
  le-character/03_visual-assets/001_asset-000186_hust-obc-cat-0200_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0200/G_0200_京津2318合26877.png`
- asset id: `asset-000186`
...
- source category: `0200`
- validation class: `180`
- source image route: `HUST-OBC/deciphered/0200/G_0200_京津2318合26877.png`
- asset id: `asset-000186`
...
- English observation: `The image has two long curved descending strokes and
  a small rounded loop near the lower center.`
...
- dataset label text: `㒾`
- dataset label codepoints: `U+34BE`
...
- filename catalog route clues: `Heji-like filename clue: 合26877
...
- Which source records identify obs-char-000181 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000181？
