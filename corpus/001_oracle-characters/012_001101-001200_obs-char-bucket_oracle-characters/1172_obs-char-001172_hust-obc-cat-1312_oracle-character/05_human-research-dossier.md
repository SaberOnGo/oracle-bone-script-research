# obs-char-001172 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1172_obs-char-001172_hust-obc-cat-1312_ora
  cle-character/03_visual-assets/001_asset-001177_hust-obc-cat-1312_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1312/G_1312_前5.47.4合4649賓組.png`
- asset id: `asset-001177`
...
- source category: `1312`
- validation class: `1171`
- source image route: `HUST-OBC/deciphered/1312/G_1312_前5.47.4合4649賓組.png`
- asset id: `asset-001177`
...
- English observation: `A faint angular cluster has two upper points, a
  central crossing, and a short curved lower-right enclosure.`
...
- dataset label text: `㤖`
- dataset label codepoints: `U+3916`
...
- filename catalog route clues: `Heji-like filename clue: 合4649
...
- Which source records identify obs-char-001172 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001172？
