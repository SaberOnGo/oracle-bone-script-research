...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1751`
...
- Source image / 来源图: `X_1751_4706_1.png`
- Image / 图像: `001_asset-001565_hust-obc-cat-1751_glyph.png`
...
- target node: `evobc-evo-cat-00156`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/156_obs-evo-cand-000156_evobc-cat-00156_evoluti
...
- Source label text / 来源标签文字: `㫍`
- Source label codepoint / 来源标签 codepoint: `U+3ACD`
