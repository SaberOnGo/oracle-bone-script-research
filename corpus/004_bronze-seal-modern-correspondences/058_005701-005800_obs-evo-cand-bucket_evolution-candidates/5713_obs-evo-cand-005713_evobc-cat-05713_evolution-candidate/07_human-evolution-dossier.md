...
- External category reference: `evobc-cat-05713`
- Source category ID: `05713`
- Source label for human review: `白`
- Source codepoints: `U+767D`
- Image reference count in source metadata: `262`
...
- `obs-evo-cand-005713-route-category-staging`
...
- `obs-evo-cand-005713-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005713-route-evolution-graph`
