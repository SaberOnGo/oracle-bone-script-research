# Material Visual Observation / obs-comp-cand-000561 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000561`
- External reference / 外部参照: `obimd-sub-bey28jrhwu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012813_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bey28jrhwu/bey28jrhwu/bey28jrhwu.png`
- Checksum / 校验和:
  `a405ec75db300e000f7d77b6140b8a240cbb80181901534a2f6e023738c39863`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.73%.
- Marked-pixel bounds: (71,35)–(177,214); span 107 × 180 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.73%。
- 痕迹范围：(71,35)–(177,214)；跨度107 × 180 px；痕迹矩形高于宽。
