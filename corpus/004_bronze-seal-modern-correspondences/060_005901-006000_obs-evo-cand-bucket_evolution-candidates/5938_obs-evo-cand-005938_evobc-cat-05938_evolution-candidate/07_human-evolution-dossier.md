...
- External category reference: `evobc-cat-05938`
- Source category ID: `05938`
- Source label for human review: `磒`
- Source codepoints: `U+78D2`
...
- `obs-evo-cand-005938-route-category-staging`
...
- `obs-evo-cand-005938-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005938-route-evolution-graph`
