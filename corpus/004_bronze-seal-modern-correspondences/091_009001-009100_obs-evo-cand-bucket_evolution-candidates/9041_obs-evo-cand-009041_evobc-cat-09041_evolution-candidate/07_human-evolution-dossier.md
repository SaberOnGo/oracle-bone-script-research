...
Project ID: `obs-evo-cand-009041`
...
- Project ID: `obs-evo-cand-009041`
- EVOBC category candidate ID: `evobc-evo-cat-09041`
- External category reference: `evobc-cat-09041`
- Source category ID: `09041`
- Source label for human review: `遜`
- Source codepoints: `U+905C`
...
- `obs-evo-cand-009041-route-category-staging`
...
- `obs-evo-cand-009041-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009041-route-evolution-graph`
