# obs-char-001171 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001171`
- primary external id: `hust-obc-cat-1311`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1171_obs-char-001171_hust-obc-cat-1311_ora
  cle-character/03_visual-assets/001_asset-001176_hust-obc-cat-1311_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1311/G_1311_前5.13.6合10744.png`
- asset id: `asset-001176`
...
- source category: `1311`
- validation class: `1170`
- source image route: `HUST-OBC/deciphered/1311/G_1311_前5.13.6合10744.png`
- asset id: `asset-001176`
...
- English observation: `A narrow upright form has a forked upper crown,
  paired side strokes, and a long central descending stroke above a base.`
- 中文观察: `狭长直立形体有分叉冠状上部、成对侧笔和位于底笔上方的中央长下行笔。`
...
- dataset label text: `㤕`
- dataset label codepoints: `U+3915`
...
- filename catalog route clues: `Heji-like filename clue: 合10744
  (G_1311_前5.13.6合10744.png)`
...
- Which source records identify obs-char-001171 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001171？
