...
Project ID: `obs-evo-cand-006915`
...
- Project ID: `obs-evo-cand-006915`
- EVOBC category candidate ID: `evobc-evo-cat-06915`
- External category reference: `evobc-cat-06915`
- Source category ID: `06915`
- Source label for human review: `耋`
- Source codepoints: `U+800B`
...
- `obs-evo-cand-006915-route-category-staging`
...
- `obs-evo-cand-006915-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006915-route-evolution-graph`
