...
- External category reference: `evobc-cat-13223`
- Source category ID: `13223`
- Source label for human review: `𬈂`
- Source codepoints: `U+2C202`
...
- `obs-evo-cand-013223-route-category-staging`
...
- `obs-evo-cand-013223-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013223-route-evolution-graph`
