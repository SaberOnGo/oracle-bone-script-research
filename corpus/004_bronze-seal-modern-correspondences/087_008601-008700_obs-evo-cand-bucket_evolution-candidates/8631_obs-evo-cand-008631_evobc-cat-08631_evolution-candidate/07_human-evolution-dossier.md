...
- External category reference: `evobc-cat-08631`
- Source category ID: `08631`
- Source label for human review: `贵`
...
- `obs-evo-cand-008631-route-category-staging`
...
- `obs-evo-cand-008631-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008631-route-evolution-graph`
