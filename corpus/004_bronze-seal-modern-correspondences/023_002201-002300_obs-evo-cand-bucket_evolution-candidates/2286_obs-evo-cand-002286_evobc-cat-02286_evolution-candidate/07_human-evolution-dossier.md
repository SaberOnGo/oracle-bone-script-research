...
- External category reference: `evobc-cat-02286`
- Source category ID: `02286`
- Source label for human review: `嫼`
...
- `obs-evo-cand-002286-route-category-staging`
...
- `obs-evo-cand-002286-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002286-route-evolution-graph`
