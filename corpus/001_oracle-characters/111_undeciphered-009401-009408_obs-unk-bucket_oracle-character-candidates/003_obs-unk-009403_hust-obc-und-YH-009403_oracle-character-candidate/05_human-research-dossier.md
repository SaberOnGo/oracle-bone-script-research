# obs-unk-009403 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-009403`
- primary external id: `hust-obc-und-YH-009403`
...
- local review image route: `corpus/001_oracle-characters/111_undeciphered-009
  401-009408_obs-unk-bucket_oracle-character-candidates/003_obs-unk-009403_h
  ust-obc-und-YH-009403_oracle-character-candidate/03_visual-assets/001_asse
  t-010994_hust-obc-und-YH-009403_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/618EA/Y_？_618EA.jpg`
- asset id: `asset-010994`
...
- source class: `HUST-OBC/undeciphered/Y+H/618EA/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/618EA/Y_？_618EA.jpg`
- asset id: `asset-010994`
...
- Which source records identify obs-unk-009403 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009403？
