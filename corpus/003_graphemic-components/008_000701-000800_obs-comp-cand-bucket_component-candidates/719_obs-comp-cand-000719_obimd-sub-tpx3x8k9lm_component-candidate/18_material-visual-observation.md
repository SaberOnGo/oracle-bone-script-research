# Material Visual Observation / obs-comp-cand-000719 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000719`
- External reference / 外部参照: `obimd-sub-tpx3x8k9lm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013431_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tpx3x8k9lm/tpx3x8k9lm/tpx3x8k9lm.png`
- Checksum / 校验和:
  `8777afe62384916f97006105d5f1a8dd63a9ff4395afd9b364d7ee0b116e8665`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.20%.
- Marked-pixel bounds: (95,26)–(154,219); span 60 × 194 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.20%。
- 痕迹范围：(95,26)–(154,219)；跨度60 × 194 px；痕迹矩形高于宽。
