...
Project ID: `obs-insc-cw-cand-000485`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000485`
...
- Source page section: `Period IV Group 1` /
  `第 IV 期第 1 组`
- Source section key: `period-iv-group-1`
- Section declared count: `9`
- Section observed row count: `9`
...
- Yingguo / 英国所藏: `y2402` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `86` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `120` in source row; primary catalog entry pending
- Heji / 合集: `41458` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000485`
