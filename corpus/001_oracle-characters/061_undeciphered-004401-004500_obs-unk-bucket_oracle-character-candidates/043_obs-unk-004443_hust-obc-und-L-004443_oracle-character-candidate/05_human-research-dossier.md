# obs-unk-004443 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/043_obs-unk-004443_h
  ust-obc-und-L-004443_oracle-character-candidate/03_visual-assets/001_asset
  -006036_hust-obc-und-L-004443_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4443/L_？_9989.jpg`
- asset id: `asset-006036`
...
- source class: `HUST-OBC/undeciphered/L/4443/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4443/L_？_9989.jpg`
- asset id: `asset-006036`
...
- English observation: `Angular upper traces converge above a darker`
  `lower cluster.`
- 中文观察: `上部角状痕迹汇聚于较深的下部聚集处之上。`
...
- Which source records identify obs-unk-004443 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004443？
