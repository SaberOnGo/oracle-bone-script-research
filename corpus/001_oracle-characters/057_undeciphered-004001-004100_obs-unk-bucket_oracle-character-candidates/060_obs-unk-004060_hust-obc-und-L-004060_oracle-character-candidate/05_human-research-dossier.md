# obs-unk-004060 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004060`
- primary external id: `hust-obc-und-L-004060`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/060_obs-unk-004060_h
  ust-obc-und-L-004060_oracle-character-candidate/03_visual-assets/001_asset
  -005653_hust-obc-und-L-004060_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4060/L_？_8693.jpg`
- asset id: `asset-005653`
...
- source class: `HUST-OBC/undeciphered/L/4060/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4060/L_？_8693.jpg`
- asset id: `asset-005653`
...
- English observation: Paired branched traces flank a narrow central body. The
  central form descends into a dark pointed lower cluster, while side strokes
  remain partly separate in the crop. The lower joins need review.
...
- Which source records identify obs-unk-004060 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004060？
