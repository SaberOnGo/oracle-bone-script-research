# obs-char-000631 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/631_obs-char-000631_hust-obc-cat-0717_orac
  le-character/03_visual-assets/001_asset-000636_hust-obc-cat-0717_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0717/G_0717_甲骨文0.png`
- asset id: `asset-000636`
...
- source category: `0717`
- validation class: `630`
- source image route: `HUST-OBC/deciphered/0717/G_0717_甲骨文0.png`
- asset id: `asset-000636`
...
- English observation: `A broad upper rectangular outline is divided into
  smaller compartments and flanked by curled side strokes; two narrow legs
  descend from its rounded base.`
...
- dataset label text: `㛃`
- dataset label codepoints: `U+36C3`
...
- Which source records identify obs-char-000631 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000631？
