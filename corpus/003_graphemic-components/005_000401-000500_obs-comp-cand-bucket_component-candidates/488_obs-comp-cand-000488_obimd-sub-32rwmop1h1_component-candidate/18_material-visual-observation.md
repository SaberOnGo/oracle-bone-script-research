# Material Visual Observation / obs-comp-cand-000488 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000488`
- External reference / 外部参照: `obimd-sub-32rwmop1h1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012724_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/32rwmop1h1/32rwmop1h1/32rwmop1h1.png`
- Checksum / 校验和:
  `9a566dc61c3580598d5f1beca96895fbf05f8936e3060f79f91804fe547ffb6e`
...
- Marked-pixel bounds: (69,19)–(180,218); span 112 × 200 px; the marked
...
- 痕迹范围：(69,19)–(180,218)；跨度112 × 200 px；痕迹矩形高于宽。
