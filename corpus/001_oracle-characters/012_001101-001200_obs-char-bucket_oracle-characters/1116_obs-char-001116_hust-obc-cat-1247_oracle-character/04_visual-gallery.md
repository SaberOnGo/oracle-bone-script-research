# obs-char-001116 Visual Gallery / obs-char-001116 图像资料页
...
- Project ID / 项目 ID: `obs-char-001116`
- Primary external reference / 首选外部参考: `hust-obc-cat-1247`
...
## obs-char-001116-visual-source-001 / 图像条目

![obs-char-001116 glyph candidate](03_visual-assets/001_asset-001121_hust-obc-cat-1247_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-001121_hust-obc-cat-1247_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-001121_hust-obc-cat-1247_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/1247/G_1247_乙4502(甲).png`
