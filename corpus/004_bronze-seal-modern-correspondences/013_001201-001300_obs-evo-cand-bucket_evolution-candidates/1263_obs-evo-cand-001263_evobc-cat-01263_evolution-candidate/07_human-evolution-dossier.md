...
- External category reference: `evobc-cat-01263`
- Source category ID: `01263`
- Source label for human review: `劝`
...
- `obs-evo-cand-001263-route-category-staging`
...
- `obs-evo-cand-001263-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001263-route-evolution-graph`
