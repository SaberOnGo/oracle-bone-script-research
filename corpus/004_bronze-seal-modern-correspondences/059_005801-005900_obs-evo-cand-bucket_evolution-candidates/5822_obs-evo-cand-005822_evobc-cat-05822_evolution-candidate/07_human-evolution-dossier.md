...
Project ID: `obs-evo-cand-005822`
...
- Project ID: `obs-evo-cand-005822`
- EVOBC category candidate ID: `evobc-evo-cat-05822`
- External category reference: `evobc-cat-05822`
- Source category ID: `05822`
- Source label for human review: `睍`
- Source codepoints: `U+774D`
...
- `obs-evo-cand-005822-route-category-staging`
...
- `obs-evo-cand-005822-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005822-route-evolution-graph`
