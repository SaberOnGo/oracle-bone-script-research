...
- External category reference: `evobc-cat-09906`
- Source category ID: `09906`
- Source label for human review: `鞅`
...
- `obs-evo-cand-009906-route-category-staging`
...
- `obs-evo-cand-009906-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009906-route-evolution-graph`
