...
- Project ID: `obs-evo-cand-011875`
- EVOBC category candidate ID: `evobc-evo-cat-11875`
- External category reference: `evobc-cat-11875`
- Source category ID: `11875`
- Source label for human review: `𥬝`
- Source codepoints: `U+25B1D`
...
- `obs-evo-cand-011875-route-category-staging`
...
- `obs-evo-cand-011875-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011875-route-evolution-graph`
