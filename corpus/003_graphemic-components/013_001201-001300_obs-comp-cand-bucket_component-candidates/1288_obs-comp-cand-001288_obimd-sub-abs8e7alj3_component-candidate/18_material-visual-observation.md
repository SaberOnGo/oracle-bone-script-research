# Material Visual Observation / obs-comp-cand-001288 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001288`
- External reference / 外部参照: `obimd-sub-abs8e7alj3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015573_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/b9q6ewwhki/abs8e7alj3/abs8e7alj3.png`
- Checksum / 校验和:
  `93d25db8c3ebb8c39077d819d0cecc93fa111449ac72bf988ddf59e7c84aa4b4`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.78%.
- Marked-pixel bounds: (92,28)–(157,224); span 66 × 197 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.78%。
- 痕迹范围：(92,28)–(157,224)；跨度66 × 197 px；痕迹矩形高于宽。
