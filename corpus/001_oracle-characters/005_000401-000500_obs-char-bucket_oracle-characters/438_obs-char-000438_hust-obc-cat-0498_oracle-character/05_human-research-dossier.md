# obs-char-000438 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/438_obs-char-000438_hust-obc-cat-0498_orac
  le-character/03_visual-assets/001_asset-000443_hust-obc-cat-0498_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0498/G_0498_乙519(甲).png`
- asset id: `asset-000443`
...
- source category: `0498`
- validation class: `437`
- source image route: `HUST-OBC/deciphered/0498/G_0498_乙519(甲).png`
- asset id: `asset-000443`
...
- English observation: `A compact slanting cluster combines several small
  upper angular marks, a central crossing, and multiple narrow strokes
  descending from the lower edge.`
- 中文观察: `紧凑斜向笔画群由数个上部小折角、中央交叉和多条自下缘下垂的狭长笔画组成。`
...
- dataset label text: `㗨`
- dataset label codepoints: `U+35E8`
...
- Which source records identify obs-char-000438 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000438？
