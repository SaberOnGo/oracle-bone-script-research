...
- `obs-evo-cand-003346-route-category-staging`
...
- `obs-evo-cand-003346-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003346-route-evolution-graph`
