...
- Project ID: `obs-evo-cand-009222`
- EVOBC category candidate ID: `evobc-evo-cat-09222`
- External category reference: `evobc-cat-09222`
- Source category ID: `09222`
- Source label for human review: `鄶`
- Source codepoints: `U+9136`
...
- `obs-evo-cand-009222-route-category-staging`
...
- `obs-evo-cand-009222-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009222-route-evolution-graph`
