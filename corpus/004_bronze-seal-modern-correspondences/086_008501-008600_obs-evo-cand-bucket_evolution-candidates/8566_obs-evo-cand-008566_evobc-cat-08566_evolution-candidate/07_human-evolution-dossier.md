...
- External category reference: `evobc-cat-08566`
- Source category ID: `08566`
- Source label for human review: `賅`
- Source codepoints: `U+8CC5`
...
- `obs-evo-cand-008566-route-category-staging`
...
- `obs-evo-cand-008566-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008566-route-evolution-graph`
