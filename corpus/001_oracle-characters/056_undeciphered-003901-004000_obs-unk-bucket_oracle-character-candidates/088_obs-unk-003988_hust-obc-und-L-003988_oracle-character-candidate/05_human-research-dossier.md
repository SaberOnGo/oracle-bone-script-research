# obs-unk-003988 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003988`
- primary external id: `hust-obc-und-L-003988`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/088_obs-unk-003988_h
  ust-obc-und-L-003988_oracle-character-candidate/03_visual-assets/001_asset
  -005581_hust-obc-und-L-003988_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3988/L_？_8442.jpg`
- asset id: `asset-005581`
...
- source class: `HUST-OBC/undeciphered/L/3988/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3988/L_？_8442.jpg`
- asset id: `asset-005581`
...
- English observation: A broad upper trace carries short upright branches; a
  descending central mark continues toward several curved lower strokes.
- 中文观察：上部较宽痕迹带有短直立分支；中部下行痕迹继续延伸至数条弯曲痕迹。
...
- Which source records identify obs-unk-003988 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003988？
