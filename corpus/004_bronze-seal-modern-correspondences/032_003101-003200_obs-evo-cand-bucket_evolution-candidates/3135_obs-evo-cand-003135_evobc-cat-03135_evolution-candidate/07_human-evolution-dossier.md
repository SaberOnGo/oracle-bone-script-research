...
- External category reference: `evobc-cat-03135`
- Source category ID: `03135`
- Source label for human review: `慸`
- Source codepoints: `U+6178`
...
- `obs-evo-cand-003135-route-category-staging`
...
- `obs-evo-cand-003135-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003135-route-evolution-graph`
