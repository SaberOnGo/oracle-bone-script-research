...
- External category reference: `evobc-cat-00930`
- Source category ID: `00930`
- Source label for human review: `倞`
- Source codepoints: `U+501E`
...
- `obs-evo-cand-000930-route-category-staging`
...
- `obs-evo-cand-000930-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000930-route-evolution-graph`
