# obs-char-001336 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1336_obs-char-001336_hust-obc-cat-1492_ora
  cle-character/03_visual-assets/001_asset-001341_hust-obc-cat-1492_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1492/G_1492_甲骨文0.png`
- asset id: `asset-001341`
...
- source category: `1492`
- validation class: `1335`
- source image route: `HUST-OBC/deciphered/1492/G_1492_甲骨文0.png`
- asset id: `asset-001341`
...
- English observation: `A large composite form has detached left marks, a
  central peaked enclosure, and a rounded lower loop.`
...
- dataset label text: `㧊`
- dataset label codepoints: `U+39CA`
...
- Which source records identify obs-char-001336 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001336？
