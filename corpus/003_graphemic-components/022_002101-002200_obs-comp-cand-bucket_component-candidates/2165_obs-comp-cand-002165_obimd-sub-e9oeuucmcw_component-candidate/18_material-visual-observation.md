# Material Visual Observation / obs-comp-cand-002165 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002165`
- External reference / 外部参照: `obimd-sub-e9oeuucmcw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019866_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/u3lh7tekno/e9oeuucmcw/e9oeuucmcw.png`
- Checksum / 校验和:
  `158501fbd57e64921c7845f07dc9cc2c5dd758388b3be03eb8ea946255f14ef4`
...
- Marked-pixel bounds: (88,32)–(161,214); span 74 × 183 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.71%。
- 痕迹范围：(88,32)–(161,214)；跨度74 × 183 px；痕迹矩形高于宽。
