...
- External category reference: `evobc-cat-02968`
- Source category ID: `02968`
- Source label for human review: `恊`
- Source codepoints: `U+604A`
...
- `obs-evo-cand-002968-route-category-staging`
...
- `obs-evo-cand-002968-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002968-route-evolution-graph`
