...
- External category reference: `evobc-cat-03888`
- Source category ID: `03888`
- Source label for human review: `束`
- Source codepoints: `U+675F`
...
- `obs-evo-cand-003888-route-category-staging`
...
- `obs-evo-cand-003888-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003888-route-evolution-graph`
