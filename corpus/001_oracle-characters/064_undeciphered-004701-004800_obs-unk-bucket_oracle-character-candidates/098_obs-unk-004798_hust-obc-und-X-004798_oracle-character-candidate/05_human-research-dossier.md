# obs-unk-004798 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004798`
- primary external id: `hust-obc-und-X-004798`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/098_obs-unk-004798_h
  ust-obc-und-X-004798_oracle-character-candidate/03_visual-assets/001_asset
  -006391_hust-obc-und-X-004798_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/354/X_？_7337_1.png`
- asset id: `asset-006391`
...
- source class: `HUST-OBC/undeciphered/X/354/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/354/X_？_7337_1.png`
- asset id: `asset-006391`
...
- English observation: `upper openings, lower U-shaped group, and right stroke`
- 中文观察: `上部开口、下部 U 形结构和右侧笔画`
...
- Which source records identify obs-unk-004798 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004798？
