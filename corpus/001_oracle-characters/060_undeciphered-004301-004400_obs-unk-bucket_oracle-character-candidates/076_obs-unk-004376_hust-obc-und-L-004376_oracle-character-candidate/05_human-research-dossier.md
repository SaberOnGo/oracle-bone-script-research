# obs-unk-004376 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/076_obs-unk-004376_h
  ust-obc-und-L-004376_oracle-character-candidate/03_visual-assets/001_asset
  -005969_hust-obc-und-L-004376_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4376/L_？_9714.jpg`
- asset id: `asset-005969`
...
- source class: `HUST-OBC/undeciphered/L/4376/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4376/L_？_9714.jpg`
- asset id: `asset-005969`
...
- English observation: `Dense central cluster, upper branches, and terminals`
  `recorded.`
- 中文观察: `已记录中央密集痕簇、上部分支和下部末端。`
...
- Which source records identify obs-unk-004376 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004376？
