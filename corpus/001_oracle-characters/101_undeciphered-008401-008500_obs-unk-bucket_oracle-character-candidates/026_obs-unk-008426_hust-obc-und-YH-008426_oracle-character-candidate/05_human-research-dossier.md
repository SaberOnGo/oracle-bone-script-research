# obs-unk-008426 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/101_undeciphered-008
  401-008500_obs-unk-bucket_oracle-character-candidates/026_obs-unk-008426_h
  ust-obc-und-YH-008426_oracle-character-candidate/03_visual-assets/001_asse
  t-010017_hust-obc-und-YH-008426_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60AD1/H_？_60AD1_0.png`
- asset id: `asset-010017`
...
- source class: `HUST-OBC/undeciphered/Y+H/60AD1/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60AD1/H_？_60AD1_0.png`
- asset id: `asset-010017`
...
- Which source records identify obs-unk-008426 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008426？
