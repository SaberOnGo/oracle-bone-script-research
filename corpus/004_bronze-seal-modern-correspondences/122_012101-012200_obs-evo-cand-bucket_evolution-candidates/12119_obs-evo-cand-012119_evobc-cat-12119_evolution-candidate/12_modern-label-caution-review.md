# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012119
...
- EVOBC candidate category: `evobc-evo-cat-12119`.
- Source label for search only: `𦼺`.
- Source codepoints for search only: `U+26F3A`.
