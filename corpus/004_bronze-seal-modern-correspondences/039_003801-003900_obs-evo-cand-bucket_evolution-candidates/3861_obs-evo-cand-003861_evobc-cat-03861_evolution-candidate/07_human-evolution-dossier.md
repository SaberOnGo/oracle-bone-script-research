...
Project ID: `obs-evo-cand-003861`
...
- Project ID: `obs-evo-cand-003861`
- EVOBC category candidate ID: `evobc-evo-cat-03861`
- External category reference: `evobc-cat-03861`
- Source category ID: `03861`
- Source label for human review: `朽`
- Source codepoints: `U+673D`
...
- `obs-evo-cand-003861-route-category-staging`
...
- `obs-evo-cand-003861-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003861-route-evolution-graph`
