...
- Yingguo / 英国所藏: `y2518` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `554` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `740` in source row; primary catalog entry pending
- Heji / 合集: `41741` in source row; primary catalog entry pending
