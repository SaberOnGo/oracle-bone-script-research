...
- Project ID: `obs-evo-cand-004948`
- EVOBC category candidate ID: `evobc-evo-cat-04948`
- External category reference: `evobc-cat-04948`
- Source category ID: `04948`
- Source label for human review: `澳`
- Source codepoints: `U+6FB3`
...
- `obs-evo-cand-004948-route-category-staging`
...
- `obs-evo-cand-004948-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004948-route-evolution-graph`
