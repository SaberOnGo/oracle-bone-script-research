...
- Project ID: `obs-evo-cand-006717`
- EVOBC category candidate ID: `evobc-evo-cat-06717`
- External category reference: `evobc-cat-06717`
- Source category ID: `06717`
- Source label for human review: `纖`
- Source codepoints: `U+7E96`
...
- `obs-evo-cand-006717-route-category-staging`
...
- `obs-evo-cand-006717-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006717-route-evolution-graph`
