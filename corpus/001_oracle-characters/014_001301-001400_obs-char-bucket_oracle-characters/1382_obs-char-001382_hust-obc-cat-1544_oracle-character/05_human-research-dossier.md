# obs-char-001382 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001382`
- primary external id: `hust-obc-cat-1544`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1382_obs-char-001382_hust-obc-cat-1544_ora
  cle-character/03_visual-assets/001_asset-001387_hust-obc-cat-1544_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1544/G_1544_乙163合21016𠂤組.png`
- asset id: `asset-001387`
...
- source category: `1544`
- validation class: `1381`
- source image route: `HUST-OBC/deciphered/1544/G_1544_乙163合21016𠂤組.png`
- asset id: `asset-001387`
...
- English observation: `A narrow branching form has an angular top, side
  strokes, and a pointed lower end.`
- 中文观察: `狭长分枝形体有角状顶部、侧部笔画和尖状下端。`
...
- dataset label text: `㧾`
- dataset label codepoints: `U+39FE`
...
- Which source records identify obs-char-001382 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001382？
