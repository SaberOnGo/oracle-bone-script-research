...
- External category reference: `evobc-cat-05928`
- Source category ID: `05928`
- Source label for human review: `碧`
- Source codepoints: `U+78A7`
...
- `obs-evo-cand-005928-route-category-staging`
...
- `obs-evo-cand-005928-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005928-route-evolution-graph`
