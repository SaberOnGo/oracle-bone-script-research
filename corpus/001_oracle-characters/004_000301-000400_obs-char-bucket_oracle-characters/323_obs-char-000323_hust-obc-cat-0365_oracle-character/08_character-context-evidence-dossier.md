...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0365`
...
- Source image / 来源图: `G_0365_乙1671合21207𠂤歷間.png`
- Image / 图像: `001_asset-000328_hust-obc-cat-0365_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合21207
...
- target node: `evobc-evo-cat-00029`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/029_obs-evo-cand-000029_evobc-cat-00029_evoluti
...
- Source label text / 来源标签文字: `㕣`
- Source label codepoint / 来源标签 codepoint: `U+3563`
