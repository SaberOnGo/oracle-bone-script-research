# Material Visual Observation / obs-comp-cand-002015 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002015`
- External reference / 外部参照: `obimd-sub-tbecf7rhkr`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019342_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tbecf7rhkr/tbecf7rhkr/tbecf7rhkr.png`
- Checksum / 校验和:
  `71df9bb0469bcb29944226676c6136cf1c0a508fce1392d163eca7c4c325af60`
...
- Marked-pixel bounds: (85,24)–(164,225); span 80 × 202 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.93%。
- 痕迹范围：(85,24)–(164,225)；跨度80 × 202 px；痕迹矩形高于宽。
