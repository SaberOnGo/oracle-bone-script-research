# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008163
...
- EVOBC candidate category: `evobc-evo-cat-08163`.
- Source label for search only: `訾`.
- Source codepoints for search only: `U+8A3E`.
