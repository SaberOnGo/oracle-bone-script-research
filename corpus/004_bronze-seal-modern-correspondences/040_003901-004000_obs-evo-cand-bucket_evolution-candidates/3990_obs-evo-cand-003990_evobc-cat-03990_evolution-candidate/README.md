# obs-evo-cand-003990 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-003990`
- EVOBC category candidate ID: `evobc-evo-cat-03990`
- External category ref: `evobc-cat-03990`
- Source label: `栕`
- Source codepoints: `U+6815`
- Image reference count: `32`
- Era token counts: `OBC:32`
- Source token counts: `Book:3;Web:29`
