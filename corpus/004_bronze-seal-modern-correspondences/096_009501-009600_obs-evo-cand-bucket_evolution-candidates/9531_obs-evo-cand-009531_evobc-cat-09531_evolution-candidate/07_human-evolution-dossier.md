...
- External category reference: `evobc-cat-09531`
- Source category ID: `09531`
- Source label for human review: `鐜`
- Source codepoints: `U+941C`
...
- `obs-evo-cand-009531-route-category-staging`
...
- `obs-evo-cand-009531-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009531-route-evolution-graph`
