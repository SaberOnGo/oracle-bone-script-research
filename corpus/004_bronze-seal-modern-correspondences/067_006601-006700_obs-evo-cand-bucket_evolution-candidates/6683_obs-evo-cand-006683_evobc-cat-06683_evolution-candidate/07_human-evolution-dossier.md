...
- External category reference: `evobc-cat-06683`
- Source category ID: `06683`
- Source label for human review: `繠`
...
- `obs-evo-cand-006683-route-category-staging`
...
- `obs-evo-cand-006683-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006683-route-evolution-graph`
