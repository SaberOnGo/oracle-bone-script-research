...
- Project ID: `obs-evo-cand-005654`
- EVOBC category candidate ID: `evobc-evo-cat-05654`
- External category reference: `evobc-cat-05654`
- Source category ID: `05654`
- Source label for human review: `痳`
- Source codepoints: `U+75F3`
...
- `obs-evo-cand-005654-route-category-staging`
...
- `obs-evo-cand-005654-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005654-route-evolution-graph`
