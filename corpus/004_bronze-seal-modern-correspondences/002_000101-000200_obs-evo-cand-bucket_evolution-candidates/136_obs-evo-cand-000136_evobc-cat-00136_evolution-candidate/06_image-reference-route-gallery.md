...
- `obs-evo-cand-000136-route-category-staging`
...
- `obs-evo-cand-000136-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000136-route-evolution-graph`
