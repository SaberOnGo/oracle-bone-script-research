...
- Project ID: `obs-evo-cand-007778`
- EVOBC category candidate ID: `evobc-evo-cat-07778`
- External category reference: `evobc-cat-07778`
- Source category ID: `07778`
- Source label for human review: `蜕`
- Source codepoints: `U+8715`
...
- `obs-evo-cand-007778-route-category-staging`
...
- `obs-evo-cand-007778-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007778-route-evolution-graph`
