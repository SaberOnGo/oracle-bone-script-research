# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010439
...
- EVOBC candidate category: `evobc-evo-cat-10439`.
- Source label for search only: `鰻`.
- Source codepoints for search only: `U+9C3B`.
