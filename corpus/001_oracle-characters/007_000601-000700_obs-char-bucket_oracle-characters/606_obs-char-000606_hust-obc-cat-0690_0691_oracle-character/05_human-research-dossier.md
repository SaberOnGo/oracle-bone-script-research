# obs-char-000606 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/606_obs-char-000606_hust-obc-cat-0690_0691
  _oracle-character/03_visual-assets/001_asset-000611_hust-obc-cat-0690_0691
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0690_0691/0690/G_0690_甲骨文0.png`
- asset id: `asset-000611`
...
- source category: `0690_0691`
- validation class: `605`
- source image route: `HUST-OBC/deciphered/0690_0691/0690/G_0690_甲骨文0.png`
- asset id: `asset-000611`
...
- English observation: `A tall vertical stem joins broad top and bottom
  bars, while a narrow bowed loop opens to the right from the upper half.`
- 中文观察: `高长竖干连接宽顶栏和底栏，上半部向右张开一个狭窄弓形环。`
...
- dataset label text: `㚨㚩`
- dataset label codepoints: `U+36A8;U+36A9`
...
- graph edge count: `2`
- codepoint routes: `U+36A8;U+36A9`
...
- Which source records identify obs-char-000606 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000606？
