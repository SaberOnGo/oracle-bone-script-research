# obs-char-001012 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001012`
- primary external id: `hust-obc-cat-1137`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1012_obs-char-001012_hust-obc-cat-1137_ora
  cle-character/03_visual-assets/001_asset-001017_hust-obc-cat-1137_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1137/G_1137_京津3085合20308𠂤組.png`
- asset id: `asset-001017`
...
- source category: `1137`
- validation class: `1011`
- source image route: `HUST-OBC/deciphered/1137/G_1137_京津3085合20308𠂤組.png`
- asset id: `asset-001017`
...
- English observation: `A hooked upper stroke with a short left branch
  stands above a small rectangular lower enclosure.`
- 中文观察: `带左侧短分枝的钩状上部笔位于小型矩形下部闭合轮廓之上。`
...
- dataset label text: `㡧`
- dataset label codepoints: `U+3867`
...
- filename catalog route clues: `Heji-like filename clue: 合20308
...
- Which source records identify obs-char-001012 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001012？
