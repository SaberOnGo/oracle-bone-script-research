# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001018
...
- EVOBC candidate category: `evobc-evo-cat-01018`.
- Source label for search only: `僛`.
- Source codepoints for search only: `U+50DB`.
