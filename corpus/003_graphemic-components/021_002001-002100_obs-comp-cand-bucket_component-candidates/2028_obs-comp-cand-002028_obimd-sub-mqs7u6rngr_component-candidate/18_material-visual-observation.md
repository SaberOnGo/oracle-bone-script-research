# Material Visual Observation / obs-comp-cand-002028 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002028`
- External reference / 外部参照: `obimd-sub-mqs7u6rngr`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019355_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/mqs7u6rngr/mqs7u6rngr/mqs7u6rngr.png`
- Checksum / 校验和:
  `07c39be1d71860fc7d28d6067b57c3221a3742753ce86a2ed7868d358a23bf86`
...
- Marked-pixel bounds: (77,43)–(172,210); span 96 × 168 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.26%。
- 痕迹范围：(77,43)–(172,210)；跨度96 × 168 px；痕迹矩形高于宽。
