...
- External category reference: `evobc-cat-03752`
- Source category ID: `03752`
- Source label for human review: `晦`
- Source codepoints: `U+6666`
...
- `obs-evo-cand-003752-route-category-staging`
...
- `obs-evo-cand-003752-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003752-route-evolution-graph`
