...
- External category reference: `evobc-cat-04056`
- Source category ID: `04056`
- Source label for human review: `梐`
- Source codepoints: `U+6890`
...
- `obs-evo-cand-004056-route-category-staging`
...
- `obs-evo-cand-004056-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004056-route-evolution-graph`
