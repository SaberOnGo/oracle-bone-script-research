...
- External category reference: `evobc-cat-06961`
- Source category ID: `06961`
- Source label for human review: `聵`
...
- `obs-evo-cand-006961-route-category-staging`
...
- `obs-evo-cand-006961-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006961-route-evolution-graph`
