...
- Project ID: `obs-evo-cand-000579`
- EVOBC category candidate ID: `evobc-evo-cat-00579`
- External category reference: `evobc-cat-00579`
- Source category ID: `00579`
- Source label for human review: `䱷`
- Source codepoints: `U+4C77`
...
- `obs-evo-cand-000579-route-category-staging`
...
- `obs-evo-cand-000579-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000579-route-evolution-graph`
