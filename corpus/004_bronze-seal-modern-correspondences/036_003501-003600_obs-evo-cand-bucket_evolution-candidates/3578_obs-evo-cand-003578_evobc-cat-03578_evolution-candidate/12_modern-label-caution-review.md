# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003578
...
- EVOBC candidate category: `evobc-evo-cat-03578`.
- Source label for search only: `敌`.
- Source codepoints for search only: `U+654C`.
