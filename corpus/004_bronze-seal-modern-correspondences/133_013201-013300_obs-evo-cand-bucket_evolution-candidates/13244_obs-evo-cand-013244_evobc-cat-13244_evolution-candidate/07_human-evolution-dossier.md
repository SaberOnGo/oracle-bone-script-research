...
- External category reference: `evobc-cat-13244`
- Source category ID: `13244`
- Source label for human review: `𬍊`
...
- `obs-evo-cand-013244-route-category-staging`
...
- `obs-evo-cand-013244-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013244-route-evolution-graph`
