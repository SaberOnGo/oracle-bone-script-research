# obs-char-000852 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000852`
- primary external id: `hust-obc-cat-0961`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/852_obs-char-000852_hust-obc-cat-0961_orac
  le-character/03_visual-assets/001_asset-000857_hust-obc-cat-0961_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0961/G_0961_京津4410合31923無名組.png
  `
- asset id: `asset-000857`
...
- source category: `0961`
- validation class: `851`
- source image route: `HUST-OBC/deciphered/0961/G_0961_京津4410合31923無名組.png`
- asset id: `asset-000857`
...
- English observation: `A small rounded rectangular loop is surrounded by
  detached short marks on both sides and above.`
- 中文观察: `小型圆弧矩形环状痕迹周围，上方及左右两侧散置分离短笔。`
...
- dataset label text: `㞷`
- dataset label codepoints: `U+37B7`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/086_obs-evo-can
  d-000086_evobc-cat-00086_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/086_obs-evo-cand-000086_evobc-cat-00086_evolu
...
- matched OBIMD main UIDs: `hcsv6oxj1l`
...
- filename catalog route clues: `Heji-like filename clue: 合31923
