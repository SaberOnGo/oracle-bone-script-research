...
- External category reference: `evobc-cat-05558`
- Source category ID: `05558`
- Source label: `畅`
...
- `obs-evo-cand-005558-route-category-staging`
...
- `obs-evo-cand-005558-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005558-route-evolution-graph`
