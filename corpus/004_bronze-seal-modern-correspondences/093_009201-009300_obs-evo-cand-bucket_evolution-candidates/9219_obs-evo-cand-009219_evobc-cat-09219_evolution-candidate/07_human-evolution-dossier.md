...
Project ID: `obs-evo-cand-009219`
...
- Project ID: `obs-evo-cand-009219`
- EVOBC category candidate ID: `evobc-evo-cat-09219`
- External category reference: `evobc-cat-09219`
- Source category ID: `09219`
- Source label for human review: `鄳`
- Source codepoints: `U+9133`
...
- `obs-evo-cand-009219-route-category-staging`
...
- `obs-evo-cand-009219-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009219-route-evolution-graph`
