...
- External category reference: `evobc-cat-13269`
- Source category ID: `13269`
- Source label for human review: `𬒾`
...
- `obs-evo-cand-013269-route-category-staging`
...
- `obs-evo-cand-013269-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013269-route-evolution-graph`
