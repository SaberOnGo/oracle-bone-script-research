# obs-char-000097 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000097`
- primary external id: `hust-obc-cat-0108`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/097_obs-char-000097_hust-obc-cat-0108_orac
  le-character/03_visual-assets/001_asset-000102_hust-obc-cat-0108_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0108/G_0108_乙6945合17257.png`
- asset id: `asset-000102`
...
- source category: `0108`
- validation class: `96`
- source image route: `HUST-OBC/deciphered/0108/G_0108_乙6945合17257.png`
- asset id: `asset-000102`
...
- English observation: `The small image has three separated upper marks, a
  long middle stroke, and a thin descending stroke below the center.`
- 中文观察: `小型图像上方有三道分离短笔，中部有长横笔，中央下方有细长下行笔。`
...
- dataset label text: `㑢`
- dataset label codepoints: `U+3462`
...
- filename catalog route clues: `Heji-like filename clue: 合17257
  (G_0108_乙6945合17257.png)`
...
- Which source records identify obs-char-000097 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000097？
