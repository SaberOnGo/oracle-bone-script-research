# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008943
...
- EVOBC candidate category: `evobc-evo-cat-08943`.
- Source label for search only: `迋`.
- Source codepoints for search only: `U+8FCB`.
