# Material Visual Observation / obs-comp-cand-001607 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001607`
- External reference / 外部参照: `obimd-sub-axnfyyroo8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017283_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/axnfyyroo8/axnfyyroo8/axnfyyroo8.png`
- Checksum / 校验和:
  `9ca4a4adfa8aede7c1474c88a1dfbd5aa135865742b6e5ba3bf363da5d8c3587`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.88%.
- Marked-pixel bounds: (49,20)–(198,230); span 150 × 211 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.88%。
- 痕迹范围：(49,20)–(198,230)；跨度150 × 211 px；痕迹矩形高于宽。
