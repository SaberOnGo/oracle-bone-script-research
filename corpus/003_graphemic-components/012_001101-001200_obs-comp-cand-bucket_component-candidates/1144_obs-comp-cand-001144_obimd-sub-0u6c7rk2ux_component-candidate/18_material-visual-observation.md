# Material Visual Observation / obs-comp-cand-001144 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001144`
- External reference / 外部参照: `obimd-sub-0u6c7rk2ux`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015231_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0u6c7rk2ux/0u6c7rk2ux/0chgltfnx1.png`
- Checksum / 校验和:
  `50e079742a257d0936ed4242f7b839ad3a61da47586f465c38e1138c58fca84a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.51%.
- Marked-pixel bounds: (89,42)–(160,196); span 72 × 155 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.51%。
- 痕迹范围：(89,42)–(160,196)；跨度72 × 155 px；痕迹矩形高于宽。
