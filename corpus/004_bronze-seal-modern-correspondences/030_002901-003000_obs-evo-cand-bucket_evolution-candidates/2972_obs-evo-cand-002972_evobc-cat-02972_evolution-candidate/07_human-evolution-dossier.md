...
Project ID: `obs-evo-cand-002972`
...
- Project ID: `obs-evo-cand-002972`
- EVOBC category candidate ID: `evobc-evo-cat-02972`
- External category reference: `evobc-cat-02972`
- Source category ID: `02972`
- Source label for human review: `恒`
- Source codepoints: `U+6052`
- Image reference count in source metadata: `34`
...
- `obs-evo-cand-002972-route-category-staging`
...
- `obs-evo-cand-002972-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002972-route-evolution-graph`
