# obs-char-001585 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001585`
- primary external id: `hust-obc-cat-1777`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1585_obs-char-001585_hust-obc-cat-1777_ora
  cle-character/03_visual-assets/001_asset-001590_hust-obc-cat-1777_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1777/L_1777_13803.jpg`
- asset id: `asset-001590`
...
- source category: `1777`
- validation class: `1584`
- source image route: `HUST-OBC/deciphered/1777/L_1777_13803.jpg`
- asset id: `asset-001590`
...
- English observation: `A low-resolution gray image shows a narrow branching
  cluster and a small rounded mark.`
- 中文观察: `低清灰度图像显示狭长分枝笔画群和小型圆折标记。`
...
- dataset label text: `㫧`
- dataset label codepoints: `U+3AE7`
...
- Which source records identify obs-char-001585 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001585？
