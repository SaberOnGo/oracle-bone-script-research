...
- Project ID: `obs-evo-cand-004558`
- EVOBC category candidate ID: `evobc-evo-cat-04558`
- External category reference: `evobc-cat-04558`
- Source category ID: `04558`
- Source label for human review: `沴`
- Source codepoints: `U+6CB4`
...
- `obs-evo-cand-004558-route-category-staging`
...
- `obs-evo-cand-004558-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004558-route-evolution-graph`
