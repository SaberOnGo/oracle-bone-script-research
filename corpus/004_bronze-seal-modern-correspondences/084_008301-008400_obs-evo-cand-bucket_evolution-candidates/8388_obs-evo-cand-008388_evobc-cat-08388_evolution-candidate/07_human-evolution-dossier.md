...
- External category reference: `evobc-cat-08388`
- Source category ID: `08388`
- Source label for human review: `讋`
...
- `obs-evo-cand-008388-route-category-staging`
...
- `obs-evo-cand-008388-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008388-route-evolution-graph`
