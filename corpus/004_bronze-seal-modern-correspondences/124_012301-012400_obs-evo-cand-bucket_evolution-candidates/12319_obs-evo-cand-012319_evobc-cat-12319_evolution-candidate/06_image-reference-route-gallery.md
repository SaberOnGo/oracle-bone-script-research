...
- `obs-evo-cand-012319-route-category-staging`
...
- `obs-evo-cand-012319-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012319-route-evolution-graph`
