...
Project ID: `obs-evo-cand-001061`
...
- Project ID: `obs-evo-cand-001061`
- EVOBC category candidate ID: `evobc-evo-cat-01061`
- External category reference: `evobc-cat-01061`
- Source category ID: `01061`
- Source label for human review: `儼`
- Source codepoints: `U+513C`
...
- `obs-evo-cand-001061-route-category-staging`
...
- `obs-evo-cand-001061-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001061-route-evolution-graph`
