...
Project ID: `obs-evo-cand-007024`
...
- Project ID: `obs-evo-cand-007024`
- EVOBC category candidate ID: `evobc-evo-cat-07024`
- External category reference: `evobc-cat-07024`
- Source category ID: `07024`
- Source label for human review: `胏`
- Source codepoints: `U+80CF`
...
- `obs-evo-cand-007024-route-category-staging`
...
- `obs-evo-cand-007024-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007024-route-evolution-graph`
