# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-001324
...
- candidate_component_id: `obs-comp-cand-001324`
- primary_external_ref_id: `obimd-sub-fdrn24mm3c`
- source_subcharacter_uid: `fdrn24mm3c`
- source_main_character_uid: `n2eg801rgy`
- main_character_external_ref_id: `obimd-main-n2eg801rgy`
...
- glyph_codepoint_uplus_sample: `U+F78A5, U+F78A6, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-015661` | `001_asset-015661_img.png` | `ad800ed22aded8d0bed2bbb1797b7100b29c810407e326739ddc907e0d754a0a` |
