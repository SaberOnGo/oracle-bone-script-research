...
- External category reference: `evobc-cat-11106`
- Source category ID: `11106`
- Source label for human review: `𡴍`
...
- `obs-evo-cand-011106-route-category-staging`
...
- `obs-evo-cand-011106-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011106-route-evolution-graph`
