...
- External category reference: `evobc-cat-05857`
- Source category ID: `05857`
- Source label for human review: `瞦`
...
- `obs-evo-cand-005857-route-category-staging`
...
- `obs-evo-cand-005857-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005857-route-evolution-graph`
