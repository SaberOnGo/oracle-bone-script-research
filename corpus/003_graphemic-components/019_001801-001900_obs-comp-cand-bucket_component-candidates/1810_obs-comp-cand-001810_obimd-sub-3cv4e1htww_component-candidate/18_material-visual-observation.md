# Material Visual Observation / obs-comp-cand-001810 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001810`
- External reference / 外部参照: `obimd-sub-3cv4e1htww`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018031_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3cv4e1htww/3cv4e1htww/3cv4e1htww.png`
- Checksum / 校验和:
  `3f14930126bbba8a9019dc4d55bf492969b68208c103fa3016141b5f0333dc0e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.06%.
- Marked-pixel bounds: (42,19)–(185,227); span 144 × 209 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.06%。
- 痕迹范围：(42,19)–(185,227)；跨度144 × 209 px；痕迹矩形高于宽。
