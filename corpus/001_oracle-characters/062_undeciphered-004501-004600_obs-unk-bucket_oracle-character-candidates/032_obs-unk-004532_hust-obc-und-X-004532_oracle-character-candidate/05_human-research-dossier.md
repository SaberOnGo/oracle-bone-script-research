# obs-unk-004532 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004532`
- primary external id: `hust-obc-und-X-004532`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/032_obs-unk-004532_h
  ust-obc-und-X-004532_oracle-character-candidate/03_visual-assets/001_asset
  -006125_hust-obc-und-X-004532_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/88/X_？_8272_1.png`
- asset id: `asset-006125`
...
- source class: `HUST-OBC/undeciphered/X/88/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/88/X_？_8272_1.png`
- asset id: `asset-006125`
...
- English observation: `Bowl-like outline, inner curve, and stem recorded.`
- 中文观察: `已记录碗状轮廓、内部弯痕和中央长痕迹。`
...
- Which source records identify obs-unk-004532 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004532？
