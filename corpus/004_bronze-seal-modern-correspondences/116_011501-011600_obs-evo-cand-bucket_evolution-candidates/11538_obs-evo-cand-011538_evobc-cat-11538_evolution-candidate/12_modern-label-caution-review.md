# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-011538
...
- EVOBC candidate category: `evobc-evo-cat-11538`.
- Source label for search only: `𣽭`.
- Source codepoints for search only: `U+23F6D`.
