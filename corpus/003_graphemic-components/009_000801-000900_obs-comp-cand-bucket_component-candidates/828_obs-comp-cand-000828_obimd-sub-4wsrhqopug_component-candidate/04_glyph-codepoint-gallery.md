# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000828
...
| --- | --- | --- | --- |
| `obimd-glyph-link-011864` | 󴪧 | `U+F4AA7` | `reviewed_metadata_only` |
| `obimd-glyph-link-011865` | 󴪨 | `U+F4AA8` | `reviewed_metadata_only` |
