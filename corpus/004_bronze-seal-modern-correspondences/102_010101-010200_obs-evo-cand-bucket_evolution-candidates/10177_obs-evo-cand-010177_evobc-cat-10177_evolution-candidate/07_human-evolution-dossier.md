...
- Project ID: `obs-evo-cand-010177`
- EVOBC category candidate ID: `evobc-evo-cat-10177`
- External category reference: `evobc-cat-10177`
- Source category ID: `10177`
- Source label for human review: `駉`
- Source codepoints: `U+99C9`
...
- `obs-evo-cand-010177-route-category-staging`
...
- `obs-evo-cand-010177-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010177-route-evolution-graph`
