# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008404
...
- EVOBC candidate category: `evobc-evo-cat-08404`.
- Source label for search only: `训`.
- Source codepoints for search only: `U+8BAD`.
