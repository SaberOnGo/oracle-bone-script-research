# obs-char-000602 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000602`
- primary external id: `hust-obc-cat-0686`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/602_obs-char-000602_hust-obc-cat-0686_orac
  le-character/03_visual-assets/001_asset-000607_hust-obc-cat-0686_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0686/X_0686_4935_1.png`
- asset id: `asset-000607`
...
- source category: `0686`
- validation class: `601`
- source image route: `HUST-OBC/deciphered/0686/X_0686_4935_1.png`
- asset id: `asset-000607`
...
- English observation: `A tall upper framework with horizontal and vertical
  bars stands above a large pointed lower outline containing several
  detached dark marks.`
- 中文观察: `带横竖栏的高长上部框架位于大型尖底下部轮廓之上，轮廓内有数处深色分离痕。`
...
- dataset label text: `㚤`
- dataset label codepoints: `U+36A4`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00046`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00046`
- EvoBC image reference count / EvoBC 图像引用数: `12`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00046`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/046_obs-evo-can
  d-000046_evobc-cat-00046_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/046_obs-evo-cand-000046_evobc-cat-00046_evolu
...
- Which source records identify obs-char-000602 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000602？
