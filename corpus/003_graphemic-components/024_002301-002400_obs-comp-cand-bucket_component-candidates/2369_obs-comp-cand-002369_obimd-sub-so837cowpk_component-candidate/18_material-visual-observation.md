# Material Visual Observation / obs-comp-cand-002369 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002369`
- External reference / 外部参照: `obimd-sub-so837cowpk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020440_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7grlc2aopw/so837cowpk/so837cowpk.png`
- Checksum / 校验和:
  `39cdb8989cc7bf8a8024c0aff94123bdcfd670dec34339ee8c0c71571d8ad150`
...
- Marked-pixel bounds: (86,41)–(163,206); span 78 × 166 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.12%。
- 痕迹范围：(86,41)–(163,206)；跨度78 × 166 px；痕迹矩形高于宽。
