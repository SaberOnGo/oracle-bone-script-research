...
- External category reference: `evobc-cat-04143`
- Source category ID: `04143`
- Source label: `楈`
...
- `obs-evo-cand-004143-route-category-staging`
...
- `obs-evo-cand-004143-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004143-route-evolution-graph`
