# obs-unk-004817 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/017_obs-unk-004817_h
  ust-obc-und-X-004817_oracle-character-candidate/03_visual-assets/001_asset
  -006410_hust-obc-und-X-004817_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/373/X_？_7357_1.png`
- asset id: `asset-006410`
...
- source class: `HUST-OBC/undeciphered/X/373/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/373/X_？_7357_1.png`
- asset id: `asset-006410`
...
- English observation: `central axis, detached marks, and lower curved openings`
- 中文观察: `中部轴线、分离标记和下部曲线开口`
...
- Which source records identify obs-unk-004817 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004817？
