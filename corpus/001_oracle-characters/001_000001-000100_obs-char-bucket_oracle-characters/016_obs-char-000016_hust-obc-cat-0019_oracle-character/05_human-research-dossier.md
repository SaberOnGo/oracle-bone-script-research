# obs-char-000016 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/016_obs-char-000016_hust-obc-cat-0019_orac
  le-character/03_visual-assets/001_asset-000021_hust-obc-cat-0019_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0019/L_0019_7025.jpg`
- asset id: `asset-000021`
...
- source category: `0019`
- validation class: `15`
- source image route: `HUST-OBC/deciphered/0019/L_0019_7025.jpg`
- asset id: `asset-000021`
...
- English observation: `The low-contrast gray image shows two small
  neighboring forms with rounded outer edges and central crossing marks.`
- 中文观察: `灰度较浅的图像显示两个相邻小形体，外缘呈圆弧状，中部有交叉痕迹。`
...
- dataset label text: `㐉`
- dataset label codepoints: `U+3409`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/002_obs-evo-can
  d-000002_evobc-cat-00002_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/002_obs-evo-cand-000002_evobc-cat-00002_evolu
...
- Which source records identify obs-char-000016 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000016？
