# obs-unk-003757 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003757`
- primary external id: `hust-obc-und-L-003757`
...
- local review image route: `corpus/001_oracle-characters/054_undeciphered-003
  701-003800_obs-unk-bucket_oracle-character-candidates/057_obs-unk-003757_h
  ust-obc-und-L-003757_oracle-character-candidate/03_visual-assets/001_asset
  -005350_hust-obc-und-L-003757_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3757/L_？_7743.jpg`
- asset id: `asset-005350`
...
- source class: `HUST-OBC/undeciphered/L/3757/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3757/L_？_7743.jpg`
- asset id: `asset-005350`
...
- Which source records identify obs-unk-003757 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003757？
