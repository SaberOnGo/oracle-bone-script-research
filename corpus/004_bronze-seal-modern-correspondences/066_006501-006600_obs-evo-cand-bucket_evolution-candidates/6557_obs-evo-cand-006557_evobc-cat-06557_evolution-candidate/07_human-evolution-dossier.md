...
- Project ID: `obs-evo-cand-006557`
- EVOBC category candidate ID: `evobc-evo-cat-06557`
- External category reference: `evobc-cat-06557`
- Source category ID: `06557`
- Source label for human review: `維`
- Source codepoints: `U+7DAD`
...
- `obs-evo-cand-006557-route-category-staging`
...
- `obs-evo-cand-006557-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006557-route-evolution-graph`
