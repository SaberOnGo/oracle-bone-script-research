# Material Visual Observation / obs-comp-cand-000437 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000437`
- External reference / 外部参照: `obimd-sub-18jj79so8p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012360_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/18jj79so8p/18jj79so8p/18jj79so8p.png`
- Checksum / 校验和:
  `8fd90e570bd5cddeade4028e75ee45bc9ae5b61f1177270233310f4ee957afc8`
...
- Marked-pixel bounds: (47,13)–(202,233); span 156 × 221 px; the marked
...
- 痕迹范围：(47,13)–(202,233)；跨度156 × 221 px；痕迹矩形高于宽。
