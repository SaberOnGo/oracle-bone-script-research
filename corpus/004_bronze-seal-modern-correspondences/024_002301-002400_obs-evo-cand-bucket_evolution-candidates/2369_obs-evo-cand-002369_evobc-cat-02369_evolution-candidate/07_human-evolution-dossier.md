...
- External category reference: `evobc-cat-02369`
- Source category ID: `02369`
- Source label for human review: `宓`
- Source codepoints: `U+5B93`
...
- `obs-evo-cand-002369-route-category-staging`
...
- `obs-evo-cand-002369-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002369-route-evolution-graph`
