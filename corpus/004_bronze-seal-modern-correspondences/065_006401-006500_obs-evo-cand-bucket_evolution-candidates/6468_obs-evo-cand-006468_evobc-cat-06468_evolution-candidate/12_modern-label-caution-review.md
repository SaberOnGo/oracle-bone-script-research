# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006468
...
- EVOBC candidate category: `evobc-evo-cat-06468`.
- Source label for search only: `索`.
- Source codepoints for search only: `U+7D22`.
