...
- External category reference: `evobc-cat-08106`
- Source category ID: `08106`
- Source label for human review: `触`
...
- `obs-evo-cand-008106-route-category-staging`
...
- `obs-evo-cand-008106-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008106-route-evolution-graph`
