# obs-comp-cand-001145 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001145`
- 首选外部 ID: `obimd-sub-tpy5799qxk`
- OBIMD subcharacter UID: `tpy5799qxk`
- OBIMD main character UID: `tpy5799qxk`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+8098;U+F69CF; U+F69D0; 另有 3 项
