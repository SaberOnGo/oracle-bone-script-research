...
- External category reference: `evobc-cat-10060`
- Source category ID: `10060`
- Source label for human review: `题`
- Source codepoints: `U+9898`
...
- `obs-evo-cand-010060-route-category-staging`
...
- `obs-evo-cand-010060-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010060-route-evolution-graph`
