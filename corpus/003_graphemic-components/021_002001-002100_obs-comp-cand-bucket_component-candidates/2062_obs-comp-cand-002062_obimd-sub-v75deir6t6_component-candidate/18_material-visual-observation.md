# Material Visual Observation / obs-comp-cand-002062 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002062`
- External reference / 外部参照: `obimd-sub-v75deir6t6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019449_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zr3h63w2fy/v75deir6t6/v75deir6t6.png`
- Checksum / 校验和:
  `568ff9865664e13414f39d95b63425ecfcf525f41cfea345fd4df93e53d29bb8`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.31%.
- Marked-pixel bounds: (51,20)–(205,230); span 155 × 211 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.31%。
- 痕迹范围：(51,20)–(205,230)；跨度155 × 211 px；痕迹矩形高于宽。
