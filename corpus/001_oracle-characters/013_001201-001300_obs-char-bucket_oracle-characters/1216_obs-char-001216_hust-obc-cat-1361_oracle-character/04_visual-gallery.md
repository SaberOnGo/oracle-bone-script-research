# obs-char-001216 Visual Gallery / obs-char-001216 图像资料页
...
- Project ID / 项目 ID: `obs-char-001216`
- Primary external reference / 首选外部参考: `hust-obc-cat-1361`
...
## obs-char-001216-visual-source-001 / 图像条目

![obs-char-001216 glyph candidate](03_visual-assets/001_asset-001221_hust-obc-cat-1361_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-001221_hust-obc-cat-1361_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-001221_hust-obc-cat-1361_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/1361/X_1361_245_1.png`
