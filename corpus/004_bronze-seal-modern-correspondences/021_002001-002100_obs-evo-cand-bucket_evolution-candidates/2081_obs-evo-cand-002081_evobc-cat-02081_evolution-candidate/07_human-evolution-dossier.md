...
- External category reference: `evobc-cat-02081`
- Source category ID: `02081`
- Source label for human review: `妖`
...
- `obs-evo-cand-002081-route-category-staging`
...
- `obs-evo-cand-002081-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002081-route-evolution-graph`
