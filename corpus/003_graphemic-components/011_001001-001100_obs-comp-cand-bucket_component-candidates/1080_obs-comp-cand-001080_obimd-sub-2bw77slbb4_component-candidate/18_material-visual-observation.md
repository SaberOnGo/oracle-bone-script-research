# Material Visual Observation / obs-comp-cand-001080 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001080`
- External reference / 外部参照: `obimd-sub-2bw77slbb4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014777_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2bw77slbb4/2bw77slbb4/2bw77slbb4.png`
- Checksum / 校验和:
  `ee9a1d9d5e9e7b17cfffe1e8ba95d4d7f2509d018010cb52fc3ffdc7915625de`
...
- Marked-pixel bounds: (70,38)–(179,216); span 110 × 179 px; the marked
...
- 痕迹范围：(70,38)–(179,216)；跨度110 × 179 px；痕迹矩形高于宽。
