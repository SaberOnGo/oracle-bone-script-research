...
- External category reference: `evobc-cat-04971`
- Source category ID: `04971`
- Source label for human review: `濩`
- Source codepoints: `U+6FE9`
...
- `obs-evo-cand-004971-route-category-staging`
...
- `obs-evo-cand-004971-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004971-route-evolution-graph`
