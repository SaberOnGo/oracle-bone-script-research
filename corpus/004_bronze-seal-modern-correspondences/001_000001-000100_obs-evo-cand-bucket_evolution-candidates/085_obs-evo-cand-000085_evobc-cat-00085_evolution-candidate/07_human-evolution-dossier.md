...
- External category reference: `evobc-cat-00085`
- Source category ID: `00085`
- Source label for human review: `㞯`
...
- `obs-evo-cand-000085-route-category-staging`
...
- `obs-evo-cand-000085-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000085-route-evolution-graph`
