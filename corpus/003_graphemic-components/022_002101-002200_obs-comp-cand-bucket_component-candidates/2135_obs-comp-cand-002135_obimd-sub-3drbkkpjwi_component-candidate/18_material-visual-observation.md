# Material Visual Observation / obs-comp-cand-002135 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002135`
- External reference / 外部参照: `obimd-sub-3drbkkpjwi`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019692_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3drbkkpjwi/3drbkkpjwi/3drbkkpjwi.png`
- Checksum / 校验和:
  `ffffe3aa33b4ad61a60bce042bd56c9916febaa331d32c9fc0fea95e47b25ad9`
...
- Marked-pixel bounds: (89,35)–(160,207); span 72 × 173 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.98%。
- 痕迹范围：(89,35)–(160,207)；跨度72 × 173 px；痕迹矩形高于宽。
