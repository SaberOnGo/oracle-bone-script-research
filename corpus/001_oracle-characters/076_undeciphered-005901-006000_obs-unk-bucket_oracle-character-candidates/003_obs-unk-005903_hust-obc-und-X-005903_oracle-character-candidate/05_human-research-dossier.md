# obs-unk-005903 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/076_undeciphered-005
  901-006000_obs-unk-bucket_oracle-character-candidates/003_obs-unk-005903_h
  ust-obc-und-X-005903_oracle-character-candidate/03_visual-assets/001_asset
  -007495_hust-obc-und-X-005903_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1459/X_？_2438_1.png`
- asset id: `asset-007495`
...
- source class: `HUST-OBC/undeciphered/X/1459/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1459/X_？_2438_1.png`
...
- Which source records identify obs-unk-005903 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005903？
