# Material Visual Observation / obs-comp-cand-002706 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002706`
- External reference / 外部参照: `obimd-sub-8vs5o45xc7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021282_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8vs5o45xc7/8vs5o45xc7/8vs5o45xc7.png`
- Checksum / 校验和:
  `62353d345fc14d567f6a097ea7d5618b5132a2b9f84f7f9e9d9b19169299ff7c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.05%.
- Marked-pixel bounds: (94,17)–(158,234); span 65 × 218 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.05%。
- 痕迹范围：(94,17)–(158,234)；跨度65 × 218 px；痕迹矩形高于宽。
