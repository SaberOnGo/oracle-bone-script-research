...
Project ID: `obs-insc-cw-cand-000495`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000495`
...
- Source page section: `Period IV Group 5` /
  `第 IV 期第 5 组`
- Source section key: `period-iv-group-5`
...
- Yingguo / 英国所藏: `y2423` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `576` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `392` in source row; primary catalog entry pending
- Heji / 合集: `41526` in source row; primary catalog entry pending
...
- Group and batch / 组类与批次: group `5`; batch or pit context pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000495`
