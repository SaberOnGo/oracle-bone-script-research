# Material Visual Observation / obs-comp-cand-001582 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001582`
- External reference / 外部参照: `obimd-sub-16p070gidp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017163_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/16p070gidp/16p070gidp/16p070gidp.png`
- Checksum / 校验和:
  `00d3993b3fda9ca0f4562d46388857da0a0c2ccc6aa961225abe492aae4c6722`
...
- Marked-pixel bounds: (70,41)–(179,205); span 110 × 165 px; the marked
...
- 痕迹范围：(70,41)–(179,205)；跨度110 × 165 px；痕迹矩形高于宽。
