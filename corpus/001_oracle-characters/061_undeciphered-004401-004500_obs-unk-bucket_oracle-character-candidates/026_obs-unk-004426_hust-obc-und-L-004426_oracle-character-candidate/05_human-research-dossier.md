# obs-unk-004426 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004426`
- primary external id: `hust-obc-und-L-004426`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/026_obs-unk-004426_h
  ust-obc-und-L-004426_oracle-character-candidate/03_visual-assets/001_asset
  -006019_hust-obc-und-L-004426_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4426/L_？_9925.jpg`
- asset id: `asset-006019`
...
- source class: `HUST-OBC/undeciphered/L/4426/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4426/L_？_9925.jpg`
- asset id: `asset-006019`
...
- English observation: `A tall curved trace meets a rounded lower open mark.`
- 中文观察: `高弯曲痕迹与下部圆弧开放痕迹相接。`
...
- Which source records identify obs-unk-004426 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004426？
