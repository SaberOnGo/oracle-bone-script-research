...
- Project ID / 项目 ID: `obs-char-000202`
- Primary external ID / 首选外部 ID: `hust-obc-cat-0225`
...
- Source image / 来源图: `G_0225_上(2).從(甲).9(楚).png`
- Image / 图像: `001_asset-000207_hust-obc-cat-0225_glyph.png`
...
- Source label text / 来源标签文字: `㓗`
- Source label codepoint / 来源标签 codepoint: `U+34D7`
