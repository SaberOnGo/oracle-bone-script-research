# obs-char-000618 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/618_obs-char-000618_hust-obc-cat-0703_orac
  le-character/03_visual-assets/001_asset-000623_hust-obc-cat-0703_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0703/G_0703_乙346合20875.png`
- asset id: `asset-000623`
...
- source category: `0703`
- validation class: `617`
- source image route: `HUST-OBC/deciphered/0703/G_0703_乙346合20875.png`
- asset id: `asset-000623`
...
- English observation: `Two adjoining outlined upper lobes, one angular and
  one rounded, narrow into paired lower stems that meet a short dark base.`
...
- dataset label text: `㚵`
- dataset label codepoints: `U+36B5`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/048_obs-evo-can
  d-000048_evobc-cat-00048_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/048_obs-evo-cand-000048_evobc-cat-00048_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合20875
...
- Which source records identify obs-char-000618 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000618？
