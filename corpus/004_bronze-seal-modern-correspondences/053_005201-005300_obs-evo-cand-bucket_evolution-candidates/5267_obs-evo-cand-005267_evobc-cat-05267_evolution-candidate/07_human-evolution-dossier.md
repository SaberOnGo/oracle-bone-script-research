...
- External category reference: `evobc-cat-05267`
- Source category ID: `05267`
- Source label for human review: `狙`
...
- `obs-evo-cand-005267-route-category-staging`
...
- `obs-evo-cand-005267-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005267-route-evolution-graph`
