...
Project ID: `obs-evo-cand-007391`
...
- Project ID: `obs-evo-cand-007391`
- EVOBC category candidate ID: `evobc-evo-cat-07391`
- External category reference: `evobc-cat-07391`
- Source category ID: `07391`
- Source label for human review: `莩`
- Source codepoints: `U+83A9`
...
- `obs-evo-cand-007391-route-category-staging`
...
- `obs-evo-cand-007391-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007391-route-evolution-graph`
