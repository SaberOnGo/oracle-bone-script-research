...
- External category reference: `evobc-cat-07561`
- Source category ID: `07561`
- Source label for human review: `蔥`
- Source codepoints: `U+8525`
...
- `obs-evo-cand-007561-route-category-staging`
...
- `obs-evo-cand-007561-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007561-route-evolution-graph`
