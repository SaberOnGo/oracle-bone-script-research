...
- External category reference: `evobc-cat-06075`
- Source category ID: `06075`
- Source label for human review: `秩`
- Source codepoints: `U+79E9`
...
- `obs-evo-cand-006075-route-category-staging`
...
- `obs-evo-cand-006075-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006075-route-evolution-graph`
