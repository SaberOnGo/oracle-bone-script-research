...
Project ID: `obs-evo-cand-012967`
...
- Project ID: `obs-evo-cand-012967`
- EVOBC category candidate ID: `evobc-evo-cat-12967`
- External category reference: `evobc-cat-12967`
- Source category ID: `12967`
- Source label for human review: `𫕊`
- Source codepoints: `U+2B54A`
...
- `obs-evo-cand-012967-route-category-staging`
...
- `obs-evo-cand-012967-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012967-route-evolution-graph`
