# obs-unk-004673 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004673`
- primary external id: `hust-obc-und-X-004673`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/073_obs-unk-004673_h
  ust-obc-und-X-004673_oracle-character-candidate/03_visual-assets/001_asset
  -006266_hust-obc-und-X-004673_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/229/X_？_8398_1.png`
- asset id: `asset-006266`
...
- source class: `HUST-OBC/undeciphered/X/229/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/229/X_？_8398_1.png`
- asset id: `asset-006266`
...
- English observation: `dense thresholded image with broken central band`
- 中文观察: `阈值化密集图像与断续中央带`
...
- Which source records identify obs-unk-004673 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004673？
