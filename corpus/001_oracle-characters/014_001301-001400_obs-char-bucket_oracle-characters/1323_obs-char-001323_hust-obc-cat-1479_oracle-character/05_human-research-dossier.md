# obs-char-001323 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001323`
- primary external id: `hust-obc-cat-1479`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1323_obs-char-001323_hust-obc-cat-1479_ora
  cle-character/03_visual-assets/001_asset-001328_hust-obc-cat-1479_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1479/G_1479_坊間3.45(甲).png`
- asset id: `asset-001328`
...
- source category: `1479`
- validation class: `1322`
- source image route: `HUST-OBC/deciphered/1479/G_1479_坊間3.45(甲).png`
- asset id: `asset-001328`
...
- English observation: `A compact dark cluster has an upper crossing, a
  rounded central enclosure, and a short pointed lower end.`
- 中文观察: `紧凑深色笔画群有上部交叉笔、中央圆拱框形和短尖状下端。`
...
- dataset label text: `㦽`
- dataset label codepoints: `U+39BD`
...
- Which source records identify obs-char-001323 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001323？
