# obs-char-001392 Archaeology Paleography Review

# obs-char-001392 考古文字复核档案
...
- first local image: `001_asset-001397_hust-obc-cat-1557_glyph.png`
- first source image: `G_1557_甲骨文0.png`
...
- source label text: `㨋`
- source label codepoints: `U+3A0B`
