...
- External category reference: `evobc-cat-06634`
- Source category ID: `06634`
- Source label for human review: `縛`
...
- `obs-evo-cand-006634-route-category-staging`
...
- `obs-evo-cand-006634-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006634-route-evolution-graph`
