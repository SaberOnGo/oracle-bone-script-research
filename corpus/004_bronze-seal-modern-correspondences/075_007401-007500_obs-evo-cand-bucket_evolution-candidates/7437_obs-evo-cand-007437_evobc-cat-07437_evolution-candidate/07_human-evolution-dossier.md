...
- External category reference: `evobc-cat-07437`
- Source category ID: `07437`
- Source label for human review: `萇`
- Source codepoints: `U+8407`
...
- `obs-evo-cand-007437-route-category-staging`
...
- `obs-evo-cand-007437-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007437-route-evolution-graph`
