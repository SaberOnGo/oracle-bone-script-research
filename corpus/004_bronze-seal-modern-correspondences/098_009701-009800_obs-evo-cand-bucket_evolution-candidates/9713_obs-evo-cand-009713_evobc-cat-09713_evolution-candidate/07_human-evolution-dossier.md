...
Project ID: `obs-evo-cand-009713`
...
- Project ID: `obs-evo-cand-009713`
- EVOBC category candidate ID: `evobc-evo-cat-09713`
- External category reference: `evobc-cat-09713`
- Source category ID: `09713`
- Source label for human review: `阻`
- Source codepoints: `U+963B`
...
- `obs-evo-cand-009713-route-category-staging`
...
- `obs-evo-cand-009713-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009713-route-evolution-graph`
