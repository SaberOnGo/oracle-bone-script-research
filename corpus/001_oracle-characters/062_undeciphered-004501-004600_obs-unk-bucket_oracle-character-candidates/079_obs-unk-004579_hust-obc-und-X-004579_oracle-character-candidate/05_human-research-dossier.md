# obs-unk-004579 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/079_obs-unk-004579_h
  ust-obc-und-X-004579_oracle-character-candidate/03_visual-assets/001_asset
  -006172_hust-obc-und-X-004579_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/135/X_？_8314_1.png`
- asset id: `asset-006172`
...
- source class: `HUST-OBC/undeciphered/X/135/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/135/X_？_8314_1.png`
- asset id: `asset-006172`
...
- English observation: `Two openings, uneven projections, and split feet`
  `recorded.`
- 中文观察: `已记录两个开口、高低不等的突出部分和分开的足端。`
...
- Which source records identify obs-unk-004579 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004579？
