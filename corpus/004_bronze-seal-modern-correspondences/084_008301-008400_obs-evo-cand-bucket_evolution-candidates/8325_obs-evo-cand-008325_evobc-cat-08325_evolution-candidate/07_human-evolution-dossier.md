...
- Project ID: `obs-evo-cand-008325`
- EVOBC category candidate ID: `evobc-evo-cat-08325`
- External category reference: `evobc-cat-08325`
- Source category ID: `08325`
- Source label for human review: `謣`
- Source codepoints: `U+8B23`
...
- `obs-evo-cand-008325-route-category-staging`
...
- `obs-evo-cand-008325-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008325-route-evolution-graph`
