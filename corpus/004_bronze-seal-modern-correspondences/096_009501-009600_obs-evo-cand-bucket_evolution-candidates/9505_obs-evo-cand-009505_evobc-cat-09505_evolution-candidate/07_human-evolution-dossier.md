...
Project ID: `obs-evo-cand-009505`
...
- Project ID: `obs-evo-cand-009505`
- EVOBC category candidate ID: `evobc-evo-cat-09505`
- External category reference: `evobc-cat-09505`
- Source category ID: `09505`
- Source label for human review: `鏟`
- Source codepoints: `U+93DF`
...
- `obs-evo-cand-009505-route-category-staging`
...
- `obs-evo-cand-009505-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009505-route-evolution-graph`
