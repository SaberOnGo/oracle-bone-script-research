# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001002
...
| Glyph or codepoint route / 字形或码位路线 | 7 OBIMD route rows; examples U+F5B1B; U+F5B1C; 另有 5 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
