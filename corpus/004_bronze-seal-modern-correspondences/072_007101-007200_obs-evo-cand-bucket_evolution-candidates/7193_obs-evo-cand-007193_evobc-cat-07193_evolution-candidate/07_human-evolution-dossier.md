...
Project ID: `obs-evo-cand-007193`
...
- Project ID: `obs-evo-cand-007193`
- EVOBC category candidate ID: `evobc-evo-cat-07193`
- External category reference: `evobc-cat-07193`
- Source category ID: `07193`
- Source label for human review: `舒`
- Source codepoints: `U+8212`
...
- `obs-evo-cand-007193-route-category-staging`
...
- `obs-evo-cand-007193-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007193-route-evolution-graph`
