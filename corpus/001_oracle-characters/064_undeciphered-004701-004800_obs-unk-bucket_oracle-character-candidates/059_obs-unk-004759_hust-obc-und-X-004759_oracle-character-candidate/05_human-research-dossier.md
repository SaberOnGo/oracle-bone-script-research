# obs-unk-004759 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/059_obs-unk-004759_h
  ust-obc-und-X-004759_oracle-character-candidate/03_visual-assets/001_asset
  -006352_hust-obc-und-X-004759_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/315/X_？_7111_1.png`
- asset id: `asset-006352`
...
- source class: `HUST-OBC/undeciphered/X/315/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/315/X_？_7111_1.png`
- asset id: `asset-006352`
...
- English observation: `stacked upper curves and long right terminal`
- 中文观察: `上部叠置曲线和右侧细长末端`
...
- Which source records identify obs-unk-004759 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004759？
