# obs-comp-cand-001479 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001479`
- 首选外部 ID: `obimd-sub-yryie6nnns`
- OBIMD subcharacter UID: `yryie6nnns`
- OBIMD main character UID: `bsmx94pct9`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+BA202;U+F87AC; U+F87AD
