...
- External category reference: `evobc-cat-09461`
- Source category ID: `09461`
- Source label for human review: `鍪`
...
- `obs-evo-cand-009461-route-category-staging`
...
- `obs-evo-cand-009461-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009461-route-evolution-graph`
