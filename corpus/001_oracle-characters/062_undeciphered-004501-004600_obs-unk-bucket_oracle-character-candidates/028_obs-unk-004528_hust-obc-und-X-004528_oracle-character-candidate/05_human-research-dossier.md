# obs-unk-004528 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004528`
- primary external id: `hust-obc-und-X-004528`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/028_obs-unk-004528_h
  ust-obc-und-X-004528_oracle-character-candidate/03_visual-assets/001_asset
  -006121_hust-obc-und-X-004528_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/84/X_？_8268_1.png`
- asset id: `asset-006121`
...
- source class: `HUST-OBC/undeciphered/X/84/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/84/X_？_8268_1.png`
- asset id: `asset-006121`
...
- English observation: `Open outline, forked mark, and side groups recorded.`
- 中文观察: `已记录中央开口轮廓、上方分叉痕迹和左右分组。`
...
- Which source records identify obs-unk-004528 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004528？
