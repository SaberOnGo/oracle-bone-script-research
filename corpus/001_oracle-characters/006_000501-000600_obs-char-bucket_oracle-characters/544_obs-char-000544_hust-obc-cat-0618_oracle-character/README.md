...
- Directory / 目录: `corpus/001_oracle-characters/006_000501-000600_obs-char-bucket_oracle-characters/544_obs-char-000544_hust-obc-cat-0618_oracle-character`

## Visual Material Status / 图像资料状态

- Status / 状态: `committed_review_image_derivative`
- Source image reference rows / 来源图像路径引用行数: `1`
- Committed glyph image / 已提交字形图像: 03_visual-assets/001_asset-000549_hust-obc-cat-0618_glyph.png
