...
Project ID: `obs-evo-cand-000171`
...
- Project ID: `obs-evo-cand-000171`
- EVOBC category candidate ID: `evobc-evo-cat-00171`
- External category reference: `evobc-cat-00171`
- Source category ID: `00171`
- Source label for human review: `㮓`
- Source codepoints: `U+3B93`
...
- `obs-evo-cand-000171-route-category-staging`
...
- `obs-evo-cand-000171-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000171-route-evolution-graph`
