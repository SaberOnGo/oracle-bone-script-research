...
Project ID: `obs-evo-cand-013387`
...
- Project ID: `obs-evo-cand-013387`
- EVOBC category candidate ID: `evobc-evo-cat-13387`
- External category reference: `evobc-cat-13387`
- Source category ID: `13387`
- Source label for human review: `𬪖`
- Source codepoints: `U+2CA96`
...
- `obs-evo-cand-013387-route-category-staging`
...
- `obs-evo-cand-013387-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013387-route-evolution-graph`
