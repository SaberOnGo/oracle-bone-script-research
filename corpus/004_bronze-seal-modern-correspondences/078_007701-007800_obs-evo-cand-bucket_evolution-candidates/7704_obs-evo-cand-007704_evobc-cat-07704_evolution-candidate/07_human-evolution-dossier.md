...
- Project ID: `obs-evo-cand-007704`
- EVOBC category candidate ID: `evobc-evo-cat-07704`
- External category reference: `evobc-cat-07704`
- Source category ID: `07704`
- Source label for human review: `虜`
- Source codepoints: `U+865C`
...
- `obs-evo-cand-007704-route-category-staging`
...
- `obs-evo-cand-007704-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007704-route-evolution-graph`
