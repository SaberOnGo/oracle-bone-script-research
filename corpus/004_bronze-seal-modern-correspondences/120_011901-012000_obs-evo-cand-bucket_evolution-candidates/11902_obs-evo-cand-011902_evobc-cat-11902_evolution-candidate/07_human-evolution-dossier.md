...
Project ID: `obs-evo-cand-011902`
...
- Project ID: `obs-evo-cand-011902`
- EVOBC category candidate ID: `evobc-evo-cat-11902`
- External category reference: `evobc-cat-11902`
- Source category ID: `11902`
- Source label for human review: `𥳰`
- Source codepoints: `U+25CF0`
...
- `obs-evo-cand-011902-route-category-staging`
...
- `obs-evo-cand-011902-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011902-route-evolution-graph`
