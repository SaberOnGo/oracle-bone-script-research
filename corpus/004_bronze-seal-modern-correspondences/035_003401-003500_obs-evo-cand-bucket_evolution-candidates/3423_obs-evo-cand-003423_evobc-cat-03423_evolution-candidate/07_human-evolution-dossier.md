...
Project ID: `obs-evo-cand-003423`
...
- Project ID: `obs-evo-cand-003423`
- EVOBC category candidate ID: `evobc-evo-cat-03423`
- External category reference: `evobc-cat-03423`
- Source category ID: `03423`
- Source label for human review: `揌`
- Source codepoints: `U+63CC`
...
- `obs-evo-cand-003423-route-category-staging`
...
- `obs-evo-cand-003423-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003423-route-evolution-graph`
