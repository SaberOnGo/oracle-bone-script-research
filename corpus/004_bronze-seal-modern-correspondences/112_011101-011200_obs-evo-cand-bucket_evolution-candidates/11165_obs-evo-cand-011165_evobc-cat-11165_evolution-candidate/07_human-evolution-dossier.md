...
- External category reference: `evobc-cat-11165`
- Source category ID: `11165`
- Source label for human review: `𢍁`
...
- `obs-evo-cand-011165-route-category-staging`
...
- `obs-evo-cand-011165-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011165-route-evolution-graph`
