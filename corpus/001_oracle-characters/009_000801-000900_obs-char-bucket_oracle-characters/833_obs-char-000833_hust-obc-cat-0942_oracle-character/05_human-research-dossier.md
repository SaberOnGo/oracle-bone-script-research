# obs-char-000833 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/833_obs-char-000833_hust-obc-cat-0942_orac
  le-character/03_visual-assets/001_asset-000838_hust-obc-cat-0942_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0942/L_0942_360.jpg`
- asset id: `asset-000838`
...
- source category: `0942`
- validation class: `832`
- source image route: `HUST-OBC/deciphered/0942/L_0942_360.jpg`
- asset id: `asset-000838`
...
- English observation: `Several short curved and upright marks surround a
  small central dark mark; the image is small and fine connections are
  unresolved.`
- 中文观察: `数条短弯曲和直立笔围绕中央小型深色痕迹分布；图像较小，细连接尚未辨明。`
...
- dataset label text: `㞤`
- dataset label codepoints: `U+37A4`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00084`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00084`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00084`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/084_obs-evo-can
  d-000084_evobc-cat-00084_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/084_obs-evo-cand-000084_evobc-cat-00084_evolu
...
- Which source records identify obs-char-000833 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000833？
