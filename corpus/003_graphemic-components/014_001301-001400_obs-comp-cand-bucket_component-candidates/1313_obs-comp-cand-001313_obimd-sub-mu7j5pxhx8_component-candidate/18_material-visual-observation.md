# Material Visual Observation / obs-comp-cand-001313 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001313`
- External reference / 外部参照: `obimd-sub-mu7j5pxhx8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015650_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/d0hauaf16v/mu7j5pxhx8/mu7j5pxhx8.png`
- Checksum / 校验和:
  `e795d2b12cb018ce36eb826b003306f33cbd56f47ae0a9c378ec5ba629e7adf3`
...
- Marked-pixel bounds: (64,35)–(183,224); span 120 × 190 px; the marked
...
- 痕迹范围：(64,35)–(183,224)；跨度120 × 190 px；痕迹矩形高于宽。
