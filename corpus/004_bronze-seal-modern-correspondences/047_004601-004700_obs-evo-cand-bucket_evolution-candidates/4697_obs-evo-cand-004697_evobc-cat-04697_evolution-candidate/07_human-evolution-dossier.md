...
- External category reference: `evobc-cat-04697`
- Source category ID: `04697`
- Source label for human review: `涶`
...
- `obs-evo-cand-004697-route-category-staging`
...
- `obs-evo-cand-004697-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004697-route-evolution-graph`
