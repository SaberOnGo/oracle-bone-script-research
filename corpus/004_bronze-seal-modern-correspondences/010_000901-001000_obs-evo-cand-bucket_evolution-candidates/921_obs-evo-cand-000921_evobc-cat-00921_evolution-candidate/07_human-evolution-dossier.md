...
- External category reference: `evobc-cat-00921`
- Source category ID: `00921`
- Source label for human review: `倍`
...
- `obs-evo-cand-000921-route-category-staging`
...
- `obs-evo-cand-000921-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000921-route-evolution-graph`
