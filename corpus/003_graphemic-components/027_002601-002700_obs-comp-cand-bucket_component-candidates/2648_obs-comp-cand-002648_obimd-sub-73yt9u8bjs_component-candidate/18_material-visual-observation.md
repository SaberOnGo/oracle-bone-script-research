# Material Visual Observation / obs-comp-cand-002648 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002648`
- External reference / 外部参照: `obimd-sub-73yt9u8bjs`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021197_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lcolftissc/73yt9u8bjs/73yt9u8bjs.png`
- Checksum / 校验和:
  `c824a66cceb6f9862db2e2a0d56680f829dcb90c79a204b755766472a2213d5b`
...
- Marked-pixel bounds: (56,47)–(194,215); span 139 × 169 px; the marked
...
- 痕迹范围：(56,47)–(194,215)；跨度139 × 169 px；痕迹矩形高于宽。
