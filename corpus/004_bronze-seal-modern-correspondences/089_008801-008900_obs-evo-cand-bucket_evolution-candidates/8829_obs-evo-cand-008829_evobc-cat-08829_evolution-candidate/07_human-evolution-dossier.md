...
- External category reference: `evobc-cat-08829`
- Source category ID: `08829`
- Source label for human review: `輇`
- Source codepoints: `U+8F07`
...
- `obs-evo-cand-008829-route-category-staging`
...
- `obs-evo-cand-008829-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008829-route-evolution-graph`
