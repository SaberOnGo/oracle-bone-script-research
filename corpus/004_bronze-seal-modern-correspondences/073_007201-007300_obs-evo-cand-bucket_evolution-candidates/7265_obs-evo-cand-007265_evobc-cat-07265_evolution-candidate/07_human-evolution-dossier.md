...
- External category reference: `evobc-cat-07265`
- Source category ID: `07265`
- Source label for human review: `芹`
...
- `obs-evo-cand-007265-route-category-staging`
...
- `obs-evo-cand-007265-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007265-route-evolution-graph`
