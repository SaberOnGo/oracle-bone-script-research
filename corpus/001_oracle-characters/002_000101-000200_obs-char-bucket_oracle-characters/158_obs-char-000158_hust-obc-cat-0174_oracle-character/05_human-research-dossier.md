# obs-char-000158 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/158_obs-char-000158_hust-obc-cat-0174_orac
  le-character/03_visual-assets/001_asset-000163_hust-obc-cat-0174_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0174/G_0174_摭續149合27991無名組.png`
- asset id: `asset-000163`
...
- source category: `0174`
- validation class: `157`
- source image route: `HUST-OBC/deciphered/0174/G_0174_摭續149合27991無名組.png`
- asset id: `asset-000163`
...
- English observation: `The image combines a long curved stroke on the left
  with stacked angular bands above a rounded lower loop on the right.`
- 中文观察: `图像左侧有长弯曲笔，右侧上方为叠置折角横带，下方接圆弧环状形。`
...
- dataset label text: `㒤`
- dataset label codepoints: `U+34A4`
...
- filename catalog route clues: `Heji-like filename clue: 合27991
...
- Which source records identify obs-char-000158 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000158？
