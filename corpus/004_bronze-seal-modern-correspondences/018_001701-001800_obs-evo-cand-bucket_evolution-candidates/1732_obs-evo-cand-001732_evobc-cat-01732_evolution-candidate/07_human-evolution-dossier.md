...
Project ID: `obs-evo-cand-001732`
...
- Project ID: `obs-evo-cand-001732`
- EVOBC category candidate ID: `evobc-evo-cat-01732`
- External category reference: `evobc-cat-01732`
- Source category ID: `01732`
- Source label for human review: `嚌`
- Source codepoints: `U+568C`
...
- `obs-evo-cand-001732-route-category-staging`
...
- `obs-evo-cand-001732-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001732-route-evolution-graph`
