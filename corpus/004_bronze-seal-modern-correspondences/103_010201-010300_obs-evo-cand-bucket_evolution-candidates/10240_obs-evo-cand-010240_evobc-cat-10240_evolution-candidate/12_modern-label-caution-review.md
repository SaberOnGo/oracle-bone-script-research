# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010240
...
- EVOBC candidate category: `evobc-evo-cat-10240`.
- Source label for search only: `騺`.
- Source codepoints for search only: `U+9A3A`.
