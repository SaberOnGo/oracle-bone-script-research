...
- External category reference: `evobc-cat-00936`
- Source category ID: `00936`
- Source label for human review: `倨`
- Source codepoints: `U+5028`
...
- `obs-evo-cand-000936-route-category-staging`
...
- `obs-evo-cand-000936-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000936-route-evolution-graph`
