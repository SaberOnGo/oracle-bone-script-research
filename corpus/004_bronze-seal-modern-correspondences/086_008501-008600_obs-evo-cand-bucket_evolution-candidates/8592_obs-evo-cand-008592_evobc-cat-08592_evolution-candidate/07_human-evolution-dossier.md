...
- External category reference: `evobc-cat-08592`
- Source category ID: `08592`
- Source label: `賴`
...
- `obs-evo-cand-008592-route-category-staging`
...
- `obs-evo-cand-008592-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008592-route-evolution-graph`
