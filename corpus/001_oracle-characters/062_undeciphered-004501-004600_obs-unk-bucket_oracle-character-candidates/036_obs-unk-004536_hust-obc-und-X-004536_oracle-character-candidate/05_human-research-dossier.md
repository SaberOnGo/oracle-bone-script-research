# obs-unk-004536 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004536`
- primary external id: `hust-obc-und-X-004536`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/036_obs-unk-004536_h
  ust-obc-und-X-004536_oracle-character-candidate/03_visual-assets/001_asset
  -006129_hust-obc-und-X-004536_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/92/X_？_8275_1.png`
- asset id: `asset-006129`
...
- source class: `HUST-OBC/undeciphered/X/92/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/92/X_？_8275_1.png`
- asset id: `asset-006129`
...
- English observation: `Upper frame, inner traces, and lower turn recorded.`
- 中文观察: `已记录上部框、内部痕迹和下部转折。`
...
- Which source records identify obs-unk-004536 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004536？
