# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002264
...
| Glyph or codepoint route / 字形或码位路线 | 29 OBIMD route rows; examples U+8F9B;U+FD00E; U+FD00F; 另有 27 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 29 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
