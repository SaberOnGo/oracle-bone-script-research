# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006849
...
- EVOBC candidate category: `evobc-evo-cat-06849`.
- Source label for search only: `羝`.
- Source codepoints for search only: `U+7F9D`.
