...
- External category reference: `evobc-cat-06868`
- Source category ID: `06868`
- Source label for human review: `羼`
...
- `obs-evo-cand-006868-route-category-staging`
...
- `obs-evo-cand-006868-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006868-route-evolution-graph`
