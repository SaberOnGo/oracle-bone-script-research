# obs-unk-005394 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/070_undeciphered-005
  301-005400_obs-unk-bucket_oracle-character-candidates/094_obs-unk-005394_h
  ust-obc-und-X-005394_oracle-character-candidate/03_visual-assets/001_asset
  -006987_hust-obc-und-X-005394_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/950/X_？_7911_1.png`
- asset id: `asset-006987`
...
- source class: `HUST-OBC/undeciphered/X/950/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/950/X_？_7911_1.png`
- asset id: `asset-006987`
...
- Which source records identify obs-unk-005394 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005394？
