...
Project ID: `obs-evo-cand-003456`
...
- Project ID: `obs-evo-cand-003456`
- EVOBC category candidate ID: `evobc-evo-cat-03456`
- External category reference: `evobc-cat-03456`
- Source category ID: `03456`
- Source label for human review: `搢`
- Source codepoints: `U+6422`
...
- `obs-evo-cand-003456-route-category-staging`
...
- `obs-evo-cand-003456-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003456-route-evolution-graph`
