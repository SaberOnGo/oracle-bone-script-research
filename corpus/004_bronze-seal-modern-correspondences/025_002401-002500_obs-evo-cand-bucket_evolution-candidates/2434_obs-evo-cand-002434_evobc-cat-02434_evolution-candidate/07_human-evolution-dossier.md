...
Project ID: `obs-evo-cand-002434`
...
- Project ID: `obs-evo-cand-002434`
- EVOBC category candidate ID: `evobc-evo-cat-02434`
- External category reference: `evobc-cat-02434`
- Source category ID: `02434`
- Source label for human review: `寤`
- Source codepoints: `U+5BE4`
...
- `obs-evo-cand-002434-route-category-staging`
...
- `obs-evo-cand-002434-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002434-route-evolution-graph`
