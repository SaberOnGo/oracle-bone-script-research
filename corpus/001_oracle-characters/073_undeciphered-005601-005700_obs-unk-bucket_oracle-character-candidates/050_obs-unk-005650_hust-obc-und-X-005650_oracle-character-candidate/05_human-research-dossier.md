# obs-unk-005650 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/073_undeciphered-005
  601-005700_obs-unk-bucket_oracle-character-candidates/050_obs-unk-005650_h
  ust-obc-und-X-005650_oracle-character-candidate/03_visual-assets/001_asset
  -007243_hust-obc-und-X-005650_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1206/X_？_8161_1.png`
- asset id: `asset-007243`
...
- source class: `HUST-OBC/undeciphered/X/1206/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1206/X_？_8161_1.png`
- asset id: `asset-007243`
...
- Which source records identify obs-unk-005650 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005650？
