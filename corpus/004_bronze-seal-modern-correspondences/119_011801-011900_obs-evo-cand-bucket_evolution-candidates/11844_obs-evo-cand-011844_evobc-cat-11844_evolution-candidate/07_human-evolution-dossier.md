...
- External category reference: `evobc-cat-11844`
- Source category ID: `11844`
- Source label for human review: `𥣫`
...
- `obs-evo-cand-011844-route-category-staging`
...
- `obs-evo-cand-011844-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011844-route-evolution-graph`
