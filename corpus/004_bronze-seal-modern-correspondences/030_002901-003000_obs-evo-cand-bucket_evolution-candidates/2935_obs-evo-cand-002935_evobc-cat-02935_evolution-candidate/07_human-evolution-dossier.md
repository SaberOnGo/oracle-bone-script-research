...
- External category reference: `evobc-cat-02935`
- Source category ID: `02935`
- Source label for human review: `怕`
...
- `obs-evo-cand-002935-route-category-staging`
...
- `obs-evo-cand-002935-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002935-route-evolution-graph`
