...
- External category reference: `evobc-cat-13021`
- Source category ID: `13021`
- Source label for human review: `𫦨`
- Source codepoints: `U+2B9A8`
...
- `obs-evo-cand-013021-route-category-staging`
...
- `obs-evo-cand-013021-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013021-route-evolution-graph`
