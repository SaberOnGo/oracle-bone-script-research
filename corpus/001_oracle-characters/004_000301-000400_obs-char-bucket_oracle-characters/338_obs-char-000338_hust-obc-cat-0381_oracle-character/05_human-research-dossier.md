# obs-char-000338 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000338`
- primary external id: `hust-obc-cat-0381`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/338_obs-char-000338_hust-obc-cat-0381_orac
  le-character/03_visual-assets/001_asset-000343_hust-obc-cat-0381_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0381/G_0381_甲骨文.png`
- asset id: `asset-000343`
...
- source category: `0381`
- validation class: `337`
- source image route: `HUST-OBC/deciphered/0381/G_0381_甲骨文.png`
- asset id: `asset-000343`
...
- English observation: `The rectangular outer frame contains branching
  central strokes and a short lower diagonal mark.`
- 中文观察: `方形外框内部有中部的分叉笔画和下方短斜向痕迹。`
...
- dataset label text: `㕳`
- dataset label codepoints: `U+3573`
...
- Which source records identify obs-char-000338 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000338？
