# obs-char-000443 Archaeology Paleography Review

# obs-char-000443 考古文字复核档案
...
- first local image: `001_asset-000448_hust-obc-cat-0503_glyph.png`
- first source image: `G_0503_乙424(甲).png`
...
- source label text: `㗭`
- source label codepoints: `U+35ED`
