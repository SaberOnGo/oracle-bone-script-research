# obs-unk-004149 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/049_obs-unk-004149_h
  ust-obc-und-L-004149_oracle-character-candidate/03_visual-assets/001_asset
  -005742_hust-obc-und-L-004149_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4149/L_？_8985.jpg`
- asset id: `asset-005742`
...
- source class: `HUST-OBC/undeciphered/L/4149/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4149/L_？_8985.jpg`
- asset id: `asset-005742`
...
- English observation: A tall curved right trace with inner marks stands
  beside an angular left outline.
- 中文观察：带内部痕迹的右侧高弯曲痕迹旁有左侧折角轮廓。
...
- Which source records identify obs-unk-004149 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004149？
