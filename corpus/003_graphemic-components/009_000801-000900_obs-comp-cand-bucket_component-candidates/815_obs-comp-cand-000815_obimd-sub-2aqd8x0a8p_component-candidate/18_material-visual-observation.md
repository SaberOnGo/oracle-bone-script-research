# Material Visual Observation / obs-comp-cand-000815 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000815`
- External reference / 外部参照: `obimd-sub-2aqd8x0a8p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013686_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2aqd8x0a8p/2aqd8x0a8p/2aqd8x0a8p.png`
- Checksum / 校验和:
  `afffb4ea625a28ed645cda114d41450c056a761f6a32ab456ab1e37c2d4a5ac1`
...
- Marked-pixel bounds: (75,39)–(174,213); span 100 × 175 px; the marked
...
- 痕迹范围：(75,39)–(174,213)；跨度100 × 175 px；痕迹矩形高于宽。
