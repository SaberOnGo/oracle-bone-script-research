# obs-unk-006207 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/079_undeciphered-006
  201-006300_obs-unk-bucket_oracle-character-candidates/007_obs-unk-006207_h
  ust-obc-und-X-006207_oracle-character-candidate/03_visual-assets/001_asset
  -007799_hust-obc-und-X-006207_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1763/X_？_4407_1.png`
- asset id: `asset-007799`
...
- source class: `HUST-OBC/undeciphered/X/1763/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1763/X_？_4407_1.png`
- asset id: `asset-007799`
...
- Which source records identify obs-unk-006207 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006207？
