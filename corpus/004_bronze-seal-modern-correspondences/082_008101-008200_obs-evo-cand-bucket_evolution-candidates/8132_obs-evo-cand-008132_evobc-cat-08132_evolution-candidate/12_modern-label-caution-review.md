# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008132
...
- EVOBC candidate category: `evobc-evo-cat-08132`.
- Source label for search only: `訏`.
- Source codepoints for search only: `U+8A0F`.
