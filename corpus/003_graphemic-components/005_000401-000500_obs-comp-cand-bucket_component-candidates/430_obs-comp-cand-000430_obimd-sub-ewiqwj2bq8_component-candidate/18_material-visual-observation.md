# Material Visual Observation / obs-comp-cand-000430 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000430`
- External reference / 外部参照: `obimd-sub-ewiqwj2bq8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012353_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ewiqwj2bq8/ewiqwj2bq8/ewiqwj2bq8.png`
- Checksum / 校验和:
  `9ceaae1326137a1ebbf7f4794df63f45ca44c9ee96c2edba8305950f46d517df`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.27%.
- Marked-pixel bounds: (73,33)–(176,216); span 104 × 184 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.27%。
- 痕迹范围：(73,33)–(176,216)；跨度104 × 184 px；痕迹矩形高于宽。
