# Material Visual Observation / obs-comp-cand-000737 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000737`
- External reference / 外部参照: `obimd-sub-epvptolw9r`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013464_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/epvptolw9r/epvptolw9r/epvptolw9r.png`
- Checksum / 校验和:
  `eb2d1c05538a70ad937682e3ddf06a1ea643048a1f2ac0f55d4714886144383c`
...
- Marked-pixel bounds: (64,25)–(186,222); span 123 × 198 px; the marked
...
- 痕迹范围：(64,25)–(186,222)；跨度123 × 198 px；痕迹矩形高于宽。
