# Material Visual Observation / obs-comp-cand-001416 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001416`
- External reference / 外部参照: `obimd-sub-u6m9r0fiud`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015835_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fkhhsjy5jk/u6m9r0fiud/u6m9r0fiud.png`
- Checksum / 校验和:
  `c8a1ca809c88801350aeae2c510968613272a041d6a7b05f01ce9e524c62b8f6`
...
- Marked-pixel bounds: (67,31)–(181,215); span 115 × 185 px; the marked
...
- 痕迹范围：(67,31)–(181,215)；跨度115 × 185 px；痕迹矩形高于宽。
