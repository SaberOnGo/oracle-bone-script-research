...
- External category reference: `evobc-cat-03693`
- Source category ID: `03693`
- Source label for human review: `旲`
- Source codepoints: `U+65F2`
...
- `obs-evo-cand-003693-route-category-staging`
...
- `obs-evo-cand-003693-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003693-route-evolution-graph`
