# obs-unk-005407 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005407`
- primary external id: `hust-obc-und-X-005407`
...
- local review image route: `corpus/001_oracle-characters/071_undeciphered-005
  401-005500_obs-unk-bucket_oracle-character-candidates/007_obs-unk-005407_h
  ust-obc-und-X-005407_oracle-character-candidate/03_visual-assets/001_asset
  -007000_hust-obc-und-X-005407_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/963/X_？_7928_1.png`
- asset id: `asset-007000`
...
- source class: `HUST-OBC/undeciphered/X/963/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/963/X_？_7928_1.png`
- asset id: `asset-007000`
...
- Which source records identify obs-unk-005407 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005407？
