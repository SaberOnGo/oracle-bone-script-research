# Material Visual Observation / obs-comp-cand-000181 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000181`
- External reference / 外部参照: `obimd-sub-ni47ygpurm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011593_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3wku1ohk1p/ni47ygpurm/ni47ygpurm.png`
- Checksum / 校验和:
  `deb646d9212f7f6d8429604fe548c63b856b1065197ca416c2d6beea2e7350bd`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.02%.
- Marked-pixel bounds: (66,38)–(183,211); span 118 × 174 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.02%。
- 痕迹范围：(66,38)–(183,211)；跨度118 × 174 px；痕迹矩形高于宽。
