# Material Visual Observation / obs-comp-cand-000706 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000706`
- External reference / 外部参照: `obimd-sub-8zkptgx6l0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013382_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1yymlqlzl6/8zkptgx6l0/8zkptgx6l0.png`
- Checksum / 校验和:
  `072153745df2b0fc24a989099323c35e85a916d675b42c47945b83900e2423ca`
...
- Marked-pixel bounds: (98,30)–(151,220); span 54 × 191 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.69%。
- 痕迹范围：(98,30)–(151,220)；跨度54 × 191 px；痕迹矩形高于宽。
