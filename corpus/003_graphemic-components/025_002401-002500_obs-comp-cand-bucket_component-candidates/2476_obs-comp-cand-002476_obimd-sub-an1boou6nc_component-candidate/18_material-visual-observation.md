# Material Visual Observation / obs-comp-cand-002476 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002476`
- External reference / 外部参照: `obimd-sub-an1boou6nc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020661_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/an1boou6nc/an1boou6nc/an1boou6nc.png`
- Checksum / 校验和:
  `c463f55ce18c1f839783c92831e495d4d8e8a206e2491f0902ac6541924096d9`
...
- Marked-pixel bounds: (55,15)–(196,224); span 142 × 210 px; the marked
...
- 痕迹范围：(55,15)–(196,224)；跨度142 × 210 px；痕迹矩形高于宽。
