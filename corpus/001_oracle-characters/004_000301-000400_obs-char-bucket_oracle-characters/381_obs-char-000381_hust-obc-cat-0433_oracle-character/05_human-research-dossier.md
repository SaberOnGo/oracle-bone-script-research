# obs-char-000381 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000381`
- primary external id: `hust-obc-cat-0433`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/381_obs-char-000381_hust-obc-cat-0433_orac
  le-character/03_visual-assets/001_asset-000386_hust-obc-cat-0433_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0433/G_0433_後2.4.13(甲).png`
- asset id: `asset-000386`
...
- source category: `0433`
- validation class: `380`
- source image route: `HUST-OBC/deciphered/0433/G_0433_後2.4.13(甲).png`
- asset id: `asset-000386`
...
- English observation: `A central vertical stroke meets a short
  cross-stroke, a long right branch, and two diverging lower strokes beneath
  paired upper tips.`
- 中文观察: `中央竖笔画与短横笔画和长右向分支相接，上方有成对尖端，下方有两条分行笔画。`
...
- dataset label text: `㖧`
- dataset label codepoints: `U+35A7`
...
- Which source records identify obs-char-000381 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000381？
