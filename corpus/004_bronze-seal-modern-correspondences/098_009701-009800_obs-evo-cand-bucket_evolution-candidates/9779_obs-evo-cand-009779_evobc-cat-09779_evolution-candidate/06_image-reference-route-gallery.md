...
- `obs-evo-cand-009779-route-category-staging`
...
- `obs-evo-cand-009779-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009779-route-evolution-graph`
