...
- External category reference: `evobc-cat-10697`
- Source category ID: `10697`
- Source label for human review: `鼪`
- Source codepoints: `U+9F2A`
...
- `obs-evo-cand-010697-route-category-staging`
...
- `obs-evo-cand-010697-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010697-route-evolution-graph`
