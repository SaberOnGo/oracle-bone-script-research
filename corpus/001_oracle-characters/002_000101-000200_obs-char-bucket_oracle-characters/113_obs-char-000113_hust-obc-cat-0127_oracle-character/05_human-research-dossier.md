# obs-char-000113 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/113_obs-char-000113_hust-obc-cat-0127_orac
  le-character/03_visual-assets/001_asset-000118_hust-obc-cat-0127_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0127/G_0127_乙3334合10302賓組.png`
- asset id: `asset-000118`
...
- source category: `0127`
- validation class: `112`
- source image route: `HUST-OBC/deciphered/0127/G_0127_乙3334合10302賓組.png`
- asset id: `asset-000118`
...
- English observation: `The compact image has a pointed upper junction,
  sloping outer strokes, and an enclosed inner arch above two narrow lower
  extensions.`
...
- dataset label text: `㑵`
- dataset label codepoints: `U+3475`
...
- filename catalog route clues: `Heji-like filename clue: 合10302
  (G_0127_乙3334合10302賓組.png)`
...
- Which source records identify obs-char-000113 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000113？
