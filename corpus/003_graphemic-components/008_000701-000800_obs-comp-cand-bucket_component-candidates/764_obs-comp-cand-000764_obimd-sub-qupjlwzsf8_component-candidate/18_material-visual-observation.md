# Material Visual Observation / obs-comp-cand-000764 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000764`
- External reference / 外部参照: `obimd-sub-qupjlwzsf8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013527_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ohovbcjeax/qupjlwzsf8/qupjlwzsf8.png`
- Checksum / 校验和:
  `f8e35f8aec809507ac160bf1f7d28fa4580074f56e8a05350c395a95beec0e5f`
...
- Marked-pixel bounds: (76,16)–(173,232); span 98 × 217 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.73%。
- 痕迹范围：(76,16)–(173,232)；跨度98 × 217 px；痕迹矩形高于宽。
