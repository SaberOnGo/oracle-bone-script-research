...
- External category reference: `evobc-cat-00132`
- Source category ID: `00132`
- Source label: `㥶`
...
- `obs-evo-cand-000132-route-category-staging`
...
- `obs-evo-cand-000132-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000132-route-evolution-graph`
