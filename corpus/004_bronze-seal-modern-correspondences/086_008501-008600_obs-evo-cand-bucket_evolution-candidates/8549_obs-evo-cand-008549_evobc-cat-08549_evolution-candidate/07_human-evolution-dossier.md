...
- External category reference: `evobc-cat-08549`
- Source category ID: `08549`
- Source label for human review: `貱`
...
- `obs-evo-cand-008549-route-category-staging`
...
- `obs-evo-cand-008549-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008549-route-evolution-graph`
