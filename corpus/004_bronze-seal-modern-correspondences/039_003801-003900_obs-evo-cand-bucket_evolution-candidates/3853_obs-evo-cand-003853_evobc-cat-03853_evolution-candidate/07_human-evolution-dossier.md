...
- External category reference: `evobc-cat-03853`
- Source category ID: `03853`
- Source label for human review: `术`
- Source codepoints: `U+672F`
...
- `obs-evo-cand-003853-route-category-staging`
...
- `obs-evo-cand-003853-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003853-route-evolution-graph`
