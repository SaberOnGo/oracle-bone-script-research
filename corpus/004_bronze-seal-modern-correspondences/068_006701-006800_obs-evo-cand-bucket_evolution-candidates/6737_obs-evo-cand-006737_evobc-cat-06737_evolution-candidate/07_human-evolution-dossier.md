...
- External category reference: `evobc-cat-06737`
- Source category ID: `06737`
- Source label for human review: `线`
- Source codepoints: `U+7EBF`
...
- `obs-evo-cand-006737-route-category-staging`
...
- `obs-evo-cand-006737-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006737-route-evolution-graph`
