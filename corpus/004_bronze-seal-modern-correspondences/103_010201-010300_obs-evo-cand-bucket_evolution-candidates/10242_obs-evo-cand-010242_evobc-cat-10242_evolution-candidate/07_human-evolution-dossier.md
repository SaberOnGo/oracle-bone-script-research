...
- External category reference: `evobc-cat-10242`
- Source category ID: `10242`
- Source label for human review: `驀`
- Source codepoints: `U+9A40`
...
- `obs-evo-cand-010242-route-category-staging`
...
- `obs-evo-cand-010242-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010242-route-evolution-graph`
