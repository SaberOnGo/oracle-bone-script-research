# obs-char-000844 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000844`
- primary external id: `hust-obc-cat-0953`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/844_obs-char-000844_hust-obc-cat-0953_orac
  le-character/03_visual-assets/001_asset-000849_hust-obc-cat-0953_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0953/G_0953_乙2121合11479.png`
- asset id: `asset-000849`
...
- source category: `0953`
- validation class: `843`
- source image route: `HUST-OBC/deciphered/0953/G_0953_乙2121合11479.png`
- asset id: `asset-000849`
...
- English observation: `A dense narrow arrangement has two bowed outer
  strokes and multiple vertical or diagonal inner strokes; the lower ends
  remain separate.`
- 中文观察: `密集狭长笔组有两条弯曲外笔和多条竖向或斜向内笔；下端保持分离。`
...
- dataset label text: `㞯`
- dataset label codepoints: `U+37AF`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00085`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00085`
- EvoBC image reference count / EvoBC 图像引用数: `2`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00085`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/085_obs-evo-can
  d-000085_evobc-cat-00085_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/085_obs-evo-cand-000085_evobc-cat-00085_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合11479
  (G_0953_乙2121合11479.png)`
...
- Which source records identify obs-char-000844 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000844？
