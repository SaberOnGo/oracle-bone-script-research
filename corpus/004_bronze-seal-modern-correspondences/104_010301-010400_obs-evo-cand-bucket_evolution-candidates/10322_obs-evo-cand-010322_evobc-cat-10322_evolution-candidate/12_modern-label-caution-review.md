# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010322
...
- EVOBC candidate category: `evobc-evo-cat-10322`.
- Source label for search only: `髽`.
- Source codepoints for search only: `U+9AFD`.
