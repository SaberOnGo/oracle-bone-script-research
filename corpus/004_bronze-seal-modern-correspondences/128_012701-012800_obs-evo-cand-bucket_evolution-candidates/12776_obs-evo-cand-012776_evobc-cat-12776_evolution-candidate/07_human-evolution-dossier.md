...
- External category reference: `evobc-cat-12776`
- Source category ID: `12776`
- Source label for human review: `𪔿`
- Source codepoints: `U+2A53F`
...
- `obs-evo-cand-012776-route-category-staging`
...
- `obs-evo-cand-012776-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012776-route-evolution-graph`
