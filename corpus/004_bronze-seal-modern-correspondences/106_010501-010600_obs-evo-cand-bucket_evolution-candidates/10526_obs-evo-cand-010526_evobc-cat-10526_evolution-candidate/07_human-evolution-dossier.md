...
Project ID: `obs-evo-cand-010526`
...
- Project ID: `obs-evo-cand-010526`
- EVOBC category candidate ID: `evobc-evo-cat-10526`
- External category reference: `evobc-cat-10526`
- Source category ID: `10526`
- Source label for human review: `鶓`
- Source codepoints: `U+9D93`
...
- `obs-evo-cand-010526-route-category-staging`
...
- `obs-evo-cand-010526-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010526-route-evolution-graph`
