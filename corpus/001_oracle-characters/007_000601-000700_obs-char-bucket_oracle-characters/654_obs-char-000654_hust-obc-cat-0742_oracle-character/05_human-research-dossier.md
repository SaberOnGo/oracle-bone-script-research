# obs-char-000654 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000654`
- primary external id: `hust-obc-cat-0742`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/654_obs-char-000654_hust-obc-cat-0742_orac
  le-character/03_visual-assets/001_asset-000659_hust-obc-cat-0742_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0742/G_0742_乙192合20072𠂤組.png`
- asset id: `asset-000659`
...
- source category: `0742`
- validation class: `653`
- source image route: `HUST-OBC/deciphered/0742/G_0742_乙192合20072𠂤組.png`
- asset id: `asset-000659`
...
- English observation: `The faint image shows several separated slender
  descending strokes: a long wavering left line, a short central hook, and a
  tall right line with an angular side branch.`
- 中文观察: `淡弱图像显示数条分离纤细下行笔：长波折左线、短中央钩和带折角侧枝的高右线。`
...
- dataset label text: `㛜`
- dataset label codepoints: `U+36DC`
...
- filename catalog route clues: `Heji-like filename clue: 合20072
  (G_0742_乙192合20072𠂤組.png)`
...
- Which source records identify obs-char-000654 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000654？
