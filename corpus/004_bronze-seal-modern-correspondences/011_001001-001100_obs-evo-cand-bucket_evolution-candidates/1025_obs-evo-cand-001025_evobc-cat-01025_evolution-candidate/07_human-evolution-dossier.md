...
Project ID: `obs-evo-cand-001025`
...
- Project ID: `obs-evo-cand-001025`
- EVOBC category candidate ID: `evobc-evo-cat-01025`
- External category reference: `evobc-cat-01025`
- Source category ID: `01025`
- Source label for human review: `僩`
- Source codepoints: `U+50E9`
...
- `obs-evo-cand-001025-route-category-staging`
...
- `obs-evo-cand-001025-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001025-route-evolution-graph`
