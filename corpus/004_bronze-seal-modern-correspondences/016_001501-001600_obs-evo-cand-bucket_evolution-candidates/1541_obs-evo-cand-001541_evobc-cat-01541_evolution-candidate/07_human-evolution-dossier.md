...
- External category reference: `evobc-cat-01541`
- Source category ID: `01541`
- Source label for human review: `呭`
...
- `obs-evo-cand-001541-route-category-staging`
...
- `obs-evo-cand-001541-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001541-route-evolution-graph`
