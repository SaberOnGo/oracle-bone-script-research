# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008464
...
- EVOBC candidate category: `evobc-evo-cat-08464`.
- Source label for search only: `谭`.
- Source codepoints for search only: `U+8C2D`.
