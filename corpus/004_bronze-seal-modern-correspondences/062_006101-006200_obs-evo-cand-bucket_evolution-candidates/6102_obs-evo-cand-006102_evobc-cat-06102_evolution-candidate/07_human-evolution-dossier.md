...
- External category reference: `evobc-cat-06102`
- Source category ID: `06102`
- Source label for human review: `稛`
- Source codepoints: `U+7A1B`
...
- `obs-evo-cand-006102-route-category-staging`
...
- `obs-evo-cand-006102-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006102-route-evolution-graph`
