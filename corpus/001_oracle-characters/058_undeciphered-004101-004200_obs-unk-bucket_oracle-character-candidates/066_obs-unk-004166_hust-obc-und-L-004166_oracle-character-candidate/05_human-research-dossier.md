# obs-unk-004166 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004166`
- primary external id: `hust-obc-und-L-004166`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/066_obs-unk-004166_h
  ust-obc-und-L-004166_oracle-character-candidate/03_visual-assets/001_asset
  -005759_hust-obc-und-L-004166_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4166/L_？_9029.jpg`
- asset id: `asset-005759`
...
- source class: `HUST-OBC/undeciphered/L/4166/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4166/L_？_9029.jpg`
- asset id: `asset-005759`
...
- English observation: A compact upper outline descends into a narrow zigzag
  group.
- 中文观察: 紧凑的上部轮廓向下连接一组窄折线痕迹。
...
- Which source records identify obs-unk-004166 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004166？
