...
- External category reference: `evobc-cat-03689`
- Source category ID: `03689`
- Source label for human review: `旬`
- Source codepoints: `U+65EC`
- Image reference count in source metadata: `174`
...
- `obs-evo-cand-003689-route-category-staging`
...
- `obs-evo-cand-003689-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003689-route-evolution-graph`
