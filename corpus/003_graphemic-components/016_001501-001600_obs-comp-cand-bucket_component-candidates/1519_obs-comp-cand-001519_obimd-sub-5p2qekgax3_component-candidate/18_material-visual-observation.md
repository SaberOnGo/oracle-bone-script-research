# Material Visual Observation / obs-comp-cand-001519 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001519`
- External reference / 外部参照: `obimd-sub-5p2qekgax3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016482_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5p2qekgax3/5p2qekgax3/5p2qekgax3.png`
- Checksum / 校验和:
  `6623397618caeba824bf9c384196cca16cf4178ae906785f39e8ccb9af720f44`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.38%.
- Marked-pixel bounds: (59,46)–(189,195); span 131 × 150 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.38%。
- 痕迹范围：(59,46)–(189,195)；跨度131 × 150 px；痕迹矩形近方形。
