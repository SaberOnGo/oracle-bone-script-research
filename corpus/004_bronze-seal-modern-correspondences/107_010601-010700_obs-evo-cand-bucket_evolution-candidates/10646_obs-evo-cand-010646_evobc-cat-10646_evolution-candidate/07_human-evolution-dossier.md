...
- External category reference: `evobc-cat-10646`
- Source category ID: `10646`
- Source label for human review: `黚`
- Source codepoints: `U+9EDA`
...
- `obs-evo-cand-010646-route-category-staging`
...
- `obs-evo-cand-010646-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010646-route-evolution-graph`
