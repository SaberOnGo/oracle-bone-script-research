...
Project ID: `obs-evo-cand-012975`
...
- Project ID: `obs-evo-cand-012975`
- EVOBC category candidate ID: `evobc-evo-cat-12975`
- External category reference: `evobc-cat-12975`
- Source category ID: `12975`
- Source label for human review: `𫙉`
- Source codepoints: `U+2B649`
...
- `obs-evo-cand-012975-route-category-staging`
...
- `obs-evo-cand-012975-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012975-route-evolution-graph`
