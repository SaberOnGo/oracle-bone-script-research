# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006592
...
- EVOBC candidate category: `evobc-evo-cat-06592`.
- Source label for search only: `緛`.
- Source codepoints for search only: `U+7DDB`.
