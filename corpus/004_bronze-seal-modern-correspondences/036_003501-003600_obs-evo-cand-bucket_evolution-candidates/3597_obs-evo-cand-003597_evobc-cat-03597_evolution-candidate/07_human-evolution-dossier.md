...
- External category reference: `evobc-cat-03597`
- Source category ID: `03597`
- Source label for human review: `敤`
...
- `obs-evo-cand-003597-route-category-staging`
...
- `obs-evo-cand-003597-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003597-route-evolution-graph`
