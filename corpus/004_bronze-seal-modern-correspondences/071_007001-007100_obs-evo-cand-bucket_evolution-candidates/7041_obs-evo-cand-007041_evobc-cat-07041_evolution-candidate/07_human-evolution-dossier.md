...
- External category reference: `evobc-cat-07041`
- Source category ID: `07041`
- Source label for human review: `胳`
- Source codepoints: `U+80F3`
...
- `obs-evo-cand-007041-route-category-staging`
...
- `obs-evo-cand-007041-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007041-route-evolution-graph`
