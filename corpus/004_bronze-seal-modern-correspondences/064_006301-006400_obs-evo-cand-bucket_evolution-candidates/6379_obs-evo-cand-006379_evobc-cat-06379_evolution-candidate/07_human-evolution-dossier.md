...
Project ID: `obs-evo-cand-006379`
...
- Project ID: `obs-evo-cand-006379`
- EVOBC category candidate ID: `evobc-evo-cat-06379`
- External category reference: `evobc-cat-06379`
- Source category ID: `06379`
- Source label for human review: `籣`
- Source codepoints: `U+7C63`
...
- `obs-evo-cand-006379-route-category-staging`
...
- `obs-evo-cand-006379-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006379-route-evolution-graph`
