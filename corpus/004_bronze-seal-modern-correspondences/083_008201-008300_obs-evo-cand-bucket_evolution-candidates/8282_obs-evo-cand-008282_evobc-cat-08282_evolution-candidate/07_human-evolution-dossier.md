...
Project ID: `obs-evo-cand-008282`
...
- Project ID: `obs-evo-cand-008282`
- EVOBC category candidate ID: `evobc-evo-cat-08282`
- External category reference: `evobc-cat-08282`
- Source category ID: `08282`
- Source label for human review: `諦`
- Source codepoints: `U+8AE6`
...
- `obs-evo-cand-008282-route-category-staging`
...
- `obs-evo-cand-008282-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008282-route-evolution-graph`
