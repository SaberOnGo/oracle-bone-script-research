...
Project ID: `obs-evo-cand-013277`
...
- Project ID: `obs-evo-cand-013277`
- EVOBC category candidate ID: `evobc-evo-cat-13277`
- External category reference: `evobc-cat-13277`
- Source category ID: `13277`
- Source label for human review: `𬔆`
- Source codepoints: `U+2C506`
...
- `obs-evo-cand-013277-route-category-staging`
...
- `obs-evo-cand-013277-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013277-route-evolution-graph`
