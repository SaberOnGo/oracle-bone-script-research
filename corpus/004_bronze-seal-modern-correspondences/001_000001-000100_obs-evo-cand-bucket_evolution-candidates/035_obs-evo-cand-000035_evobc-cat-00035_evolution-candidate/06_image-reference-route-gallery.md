...
- `obs-evo-cand-000035-route-category-staging`
...
- `obs-evo-cand-000035-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000035-route-evolution-graph`
