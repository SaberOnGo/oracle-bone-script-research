# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000912
...
- EVOBC candidate category: `evobc-evo-cat-00912`.
- Source label for search only: `俾`.
- Source codepoints for search only: `U+4FFE`.
