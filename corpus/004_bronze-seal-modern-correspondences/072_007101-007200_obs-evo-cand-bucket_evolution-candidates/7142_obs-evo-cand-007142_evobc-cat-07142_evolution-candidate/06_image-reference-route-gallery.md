...
- `obs-evo-cand-007142-route-category-staging`
...
- `obs-evo-cand-007142-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007142-route-evolution-graph`
