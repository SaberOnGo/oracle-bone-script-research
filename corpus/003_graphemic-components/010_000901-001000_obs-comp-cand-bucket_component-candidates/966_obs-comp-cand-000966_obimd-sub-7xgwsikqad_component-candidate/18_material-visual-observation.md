# Material Visual Observation / obs-comp-cand-000966 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000966`
- External reference / 外部参照: `obimd-sub-7xgwsikqad`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014049_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7xgwsikqad/7xgwsikqad/7xgwsikqad.png`
- Checksum / 校验和:
  `7a4a5e4fb2976212ec7949167be35e6449f78d431044e78deb98e3f1a059c317`
...
- Marked-pixel bounds: (63,39)–(186,214); span 124 × 176 px; the marked
...
- 痕迹范围：(63,39)–(186,214)；跨度124 × 176 px；痕迹矩形高于宽。
