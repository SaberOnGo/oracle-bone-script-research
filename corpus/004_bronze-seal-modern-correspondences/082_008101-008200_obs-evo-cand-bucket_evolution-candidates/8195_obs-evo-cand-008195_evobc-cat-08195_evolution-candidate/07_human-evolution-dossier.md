...
Project ID: `obs-evo-cand-008195`
...
- Project ID: `obs-evo-cand-008195`
- EVOBC category candidate ID: `evobc-evo-cat-08195`
- External category reference: `evobc-cat-08195`
- Source category ID: `08195`
- Source label for human review: `詬`
- Source codepoints: `U+8A6C`
...
- `obs-evo-cand-008195-route-category-staging`
...
- `obs-evo-cand-008195-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008195-route-evolution-graph`
