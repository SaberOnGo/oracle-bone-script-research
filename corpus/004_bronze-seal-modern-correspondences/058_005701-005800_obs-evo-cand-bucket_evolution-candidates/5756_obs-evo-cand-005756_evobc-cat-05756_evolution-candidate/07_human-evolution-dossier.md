...
- Project ID: `obs-evo-cand-005756`
- EVOBC category candidate ID: `evobc-evo-cat-05756`
- External category reference: `evobc-cat-05756`
- Source category ID: `05756`
- Source label for human review: `盜`
- Source codepoints: `U+76DC`
...
- `obs-evo-cand-005756-route-category-staging`
...
- `obs-evo-cand-005756-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005756-route-evolution-graph`
