...
- External category reference: `evobc-cat-11507`
- Source category ID: `11507`
- Source label: `𣮨`
...
- `obs-evo-cand-011507-route-category-staging`
...
- `obs-evo-cand-011507-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011507-route-evolution-graph`
