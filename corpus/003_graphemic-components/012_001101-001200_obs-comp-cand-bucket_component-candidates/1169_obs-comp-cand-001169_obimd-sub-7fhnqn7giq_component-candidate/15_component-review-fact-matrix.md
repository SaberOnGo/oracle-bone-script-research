# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001169
...
| Glyph or codepoint route / 字形或码位路线 | 36 OBIMD route rows; examples U+2BA41;U+F6B7A; U+F6B7B; 另有 34 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
