...
- Project ID: `obs-evo-cand-004147`
- EVOBC category candidate ID: `evobc-evo-cat-04147`
- External category reference: `evobc-cat-04147`
- Source category ID: `04147`
- Source label for human review: `楑`
- Source codepoints: `U+6951`
...
- `obs-evo-cand-004147-route-category-staging`
...
- `obs-evo-cand-004147-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004147-route-evolution-graph`
