...
- External category reference: `evobc-cat-12590`
- Source category ID: `12590`
- Source label for human review: `𩎨`
- Source codepoints: `U+293A8`
...
- `obs-evo-cand-012590-route-category-staging`
...
- `obs-evo-cand-012590-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012590-route-evolution-graph`
