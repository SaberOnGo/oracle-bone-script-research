...
- Project ID: `obs-evo-cand-012484`
- EVOBC category candidate ID: `evobc-evo-cat-12484`
- External category reference: `evobc-cat-12484`
- Source category ID: `12484`
- Source label for human review: `𨨣`
- Source codepoints: `U+28A23`
...
- `obs-evo-cand-012484-route-category-staging`
...
- `obs-evo-cand-012484-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012484-route-evolution-graph`
