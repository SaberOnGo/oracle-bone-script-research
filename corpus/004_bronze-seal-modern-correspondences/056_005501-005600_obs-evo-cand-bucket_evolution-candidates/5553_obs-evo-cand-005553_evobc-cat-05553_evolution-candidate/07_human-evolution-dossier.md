...
Project ID: `obs-evo-cand-005553`
...
- Project ID: `obs-evo-cand-005553`
- EVOBC category candidate ID: `evobc-evo-cat-05553`
- External category reference: `evobc-cat-05553`
- Source category ID: `05553`
- Source label for human review: `画`
- Source codepoints: `U+753B`
...
- `obs-evo-cand-005553-route-category-staging`
...
- `obs-evo-cand-005553-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005553-route-evolution-graph`
