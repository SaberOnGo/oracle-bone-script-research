...
- External category reference: `evobc-cat-00499`
- Source category ID: `00499`
- Source label for human review: `䣜`
- Source codepoints: `U+48DC`
...
- `obs-evo-cand-000499-route-category-staging`
...
- `obs-evo-cand-000499-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000499-route-evolution-graph`
