...
Project ID: `obs-evo-cand-013169`
...
- Project ID: `obs-evo-cand-013169`
- EVOBC category candidate ID: `evobc-evo-cat-13169`
- External category reference: `evobc-cat-13169`
- Source category ID: `13169`
- Source label for human review: `𫾰`
- Source codepoints: `U+2BFB0`
...
- `obs-evo-cand-013169-route-category-staging`
...
- `obs-evo-cand-013169-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013169-route-evolution-graph`
