...
- External category reference: `evobc-cat-02716`
- Source category ID: `02716`
- Source label for human review: `庐`
- Source codepoints: `U+5E90`
...
- `obs-evo-cand-002716-route-category-staging`
...
- `obs-evo-cand-002716-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002716-route-evolution-graph`
