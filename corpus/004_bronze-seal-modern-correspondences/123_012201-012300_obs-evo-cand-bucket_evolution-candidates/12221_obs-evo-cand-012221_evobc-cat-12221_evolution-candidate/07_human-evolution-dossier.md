...
- External category reference: `evobc-cat-12221`
- Source category ID: `12221`
- Source label for human review: `𧥺`
...
- `obs-evo-cand-012221-route-category-staging`
...
- `obs-evo-cand-012221-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012221-route-evolution-graph`
