# Material Visual Observation / obs-comp-cand-000820 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000820`
- External reference / 外部参照: `obimd-sub-102j9ekm32`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013691_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2ekj7pe4h8/102j9ekm32/102j9ekm32.png`
- Checksum / 校验和:
  `efb05f8fe4fdfd861ce89acd5dfa5ad6c7b59663dc5ee1d183bb6b58631a85b2`
...
- Marked-pixel bounds: (87,33)–(162,222); span 76 × 190 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.33%。
- 痕迹范围：(87,33)–(162,222)；跨度76 × 190 px；痕迹矩形高于宽。
