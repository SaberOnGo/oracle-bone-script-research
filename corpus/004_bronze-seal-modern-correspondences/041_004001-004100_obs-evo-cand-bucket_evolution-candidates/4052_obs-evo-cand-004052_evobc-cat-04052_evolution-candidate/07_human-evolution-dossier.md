...
Project ID: `obs-evo-cand-004052`
...
- Project ID: `obs-evo-cand-004052`
- EVOBC category candidate ID: `evobc-evo-cat-04052`
- External category reference: `evobc-cat-04052`
- Source category ID: `04052`
- Source label for human review: `梊`
- Source codepoints: `U+688A`
...
- `obs-evo-cand-004052-route-category-staging`
...
- `obs-evo-cand-004052-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004052-route-evolution-graph`
