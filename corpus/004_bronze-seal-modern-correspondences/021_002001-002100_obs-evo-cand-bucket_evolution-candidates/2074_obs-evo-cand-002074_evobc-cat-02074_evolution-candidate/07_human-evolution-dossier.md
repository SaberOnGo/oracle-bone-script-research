...
- External category reference: `evobc-cat-02074`
- Source category ID: `02074`
- Source label for human review: `妊`
- Source codepoints: `U+598A`
...
- `obs-evo-cand-002074-route-category-staging`
...
- `obs-evo-cand-002074-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002074-route-evolution-graph`
