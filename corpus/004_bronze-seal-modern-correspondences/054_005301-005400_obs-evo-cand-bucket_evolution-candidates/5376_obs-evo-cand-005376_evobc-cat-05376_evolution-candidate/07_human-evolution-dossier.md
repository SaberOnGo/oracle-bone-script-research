...
- External category reference: `evobc-cat-05376`
- Source category ID: `05376`
- Source label for human review: `珑`
...
- `obs-evo-cand-005376-route-category-staging`
...
- `obs-evo-cand-005376-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005376-route-evolution-graph`
