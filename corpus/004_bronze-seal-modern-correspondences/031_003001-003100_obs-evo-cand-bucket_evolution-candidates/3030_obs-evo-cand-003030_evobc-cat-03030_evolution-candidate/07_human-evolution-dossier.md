...
- External category reference: `evobc-cat-03030`
- Source category ID: `03030`
- Source label for human review: `悸`
...
- `obs-evo-cand-003030-route-category-staging`
...
- `obs-evo-cand-003030-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003030-route-evolution-graph`
