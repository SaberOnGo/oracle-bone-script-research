# obs-char-001208 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1208_obs-char-001208_hust-obc-cat-1353_ora
  cle-character/03_visual-assets/001_asset-001213_hust-obc-cat-1353_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1353/G_1353_乙1984反合902反賓組.png`
- asset id: `asset-001213`
...
- source category: `1353`
- validation class: `1207`
- source image route: `HUST-OBC/deciphered/1353/G_1353_乙1984反合902反賓組.png`
- asset id: `asset-001213`
...
- dataset label text: `㤿`
- dataset label codepoints: `U+393F`
...
- Which source records identify obs-char-001208 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001208？
