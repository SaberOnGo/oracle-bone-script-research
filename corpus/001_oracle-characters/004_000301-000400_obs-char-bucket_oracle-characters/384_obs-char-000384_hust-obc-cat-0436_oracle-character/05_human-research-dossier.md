# obs-char-000384 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/384_obs-char-000384_hust-obc-cat-0436_orac
  le-character/03_visual-assets/001_asset-000389_hust-obc-cat-0436_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0436/G_0436_合17027賓組.png`
- asset id: `asset-000389`
...
- source category: `0436`
- validation class: `383`
- source image route: `HUST-OBC/deciphered/0436/G_0436_合17027賓組.png`
- asset id: `asset-000389`
...
- dataset label text: `㖪`
- dataset label codepoints: `U+35AA`
...
- filename catalog route clues: `Heji-like filename clue: 合17027
  (G_0436_合17027賓組.png)`
...
- Which source records identify obs-char-000384 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000384？
