...
Project ID: `obs-evo-cand-008448`
...
- Project ID: `obs-evo-cand-008448`
- EVOBC category candidate ID: `evobc-evo-cat-08448`
- External category reference: `evobc-cat-08448`
- Source category ID: `08448`
- Source label for human review: `谅`
- Source codepoints: `U+8C05`
...
- `obs-evo-cand-008448-route-category-staging`
...
- `obs-evo-cand-008448-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008448-route-evolution-graph`
