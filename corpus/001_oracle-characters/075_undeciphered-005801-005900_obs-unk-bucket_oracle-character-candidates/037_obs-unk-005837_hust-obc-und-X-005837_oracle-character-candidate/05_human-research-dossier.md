# obs-unk-005837 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005837`
- primary external id: `hust-obc-und-X-005837`
...
- local review image route: `corpus/001_oracle-characters/075_undeciphered-005
  801-005900_obs-unk-bucket_oracle-character-candidates/037_obs-unk-005837_h
  ust-obc-und-X-005837_oracle-character-candidate/03_visual-assets/001_asset
  -007429_hust-obc-und-X-005837_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1393/X_？_1980_1.png`
- asset id: `asset-007429`
...
- source class: `HUST-OBC/undeciphered/X/1393/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1393/X_？_1980_1.png`
- asset id: `asset-007429`
...
- Which source records identify obs-unk-005837 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005837？
