...
- External category reference: `evobc-cat-10339`
- Source category ID: `10339`
- Source label for human review: `鬨`
- Source codepoints: `U+9B28`
...
- `obs-evo-cand-010339-route-category-staging`
...
- `obs-evo-cand-010339-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010339-route-evolution-graph`
