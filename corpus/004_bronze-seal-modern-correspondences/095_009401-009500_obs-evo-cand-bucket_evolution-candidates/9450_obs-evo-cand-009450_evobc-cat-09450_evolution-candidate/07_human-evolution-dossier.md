...
- External category reference: `evobc-cat-09450`
- Source category ID: `09450`
- Source label for human review: `鍉`
- Source codepoints: `U+9349`
...
- `obs-evo-cand-009450-route-category-staging`
...
- `obs-evo-cand-009450-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009450-route-evolution-graph`
