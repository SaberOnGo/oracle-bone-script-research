# obs-unk-004598 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/098_obs-unk-004598_h
  ust-obc-und-X-004598_oracle-character-candidate/03_visual-assets/001_asset
  -006191_hust-obc-und-X-004598_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/154/X_？_8331_1.png`
- asset id: `asset-006191`
...
- source class: `HUST-OBC/undeciphered/X/154/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/154/X_？_8331_1.png`
- asset id: `asset-006191`
...
- English observation: `Irregular outer contour, interior opening, and`
  `lower hook recorded.`
- 中文观察: `已记录不规则外轮廓、内部开口和下部钩痕。`
...
- Which source records identify obs-unk-004598 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004598？
