# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006828
...
- EVOBC candidate category: `evobc-evo-cat-06828`.
- Source label for search only: `罻`.
- Source codepoints for search only: `U+7F7B`.
