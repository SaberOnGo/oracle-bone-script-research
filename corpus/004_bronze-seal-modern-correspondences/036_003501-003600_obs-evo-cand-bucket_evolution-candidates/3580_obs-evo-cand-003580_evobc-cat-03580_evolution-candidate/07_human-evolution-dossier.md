...
- External category reference: `evobc-cat-03580`
- Source category ID: `03580`
- Source label for human review: `敐`
- Source codepoints: `U+6550`
...
- `obs-evo-cand-003580-route-category-staging`
...
- `obs-evo-cand-003580-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003580-route-evolution-graph`
