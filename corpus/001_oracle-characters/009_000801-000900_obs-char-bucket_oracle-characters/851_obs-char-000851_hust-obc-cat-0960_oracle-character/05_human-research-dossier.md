# obs-char-000851 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000851`
- primary external id: `hust-obc-cat-0960`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/851_obs-char-000851_hust-obc-cat-0960_orac
  le-character/03_visual-assets/001_asset-000856_hust-obc-cat-0960_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0960/G_0960_乙4518合9774賓組.png`
- asset id: `asset-000856`
...
- source category: `0960`
- validation class: `850`
- source image route: `HUST-OBC/deciphered/0960/G_0960_乙4518合9774賓組.png`
- asset id: `asset-000856`
...
- English observation: `A dense rounded outer form contains a central
  enclosed opening and curved internal strokes; short detached marks lie at
  the lower left.`
- 中文观察: `密集圆弧外形内有中央闭合开口和弯曲内笔；左下方有分离的短笔痕迹。`
...
- dataset label text: `㞶`
- dataset label codepoints: `U+37B6`
...
- filename catalog route clues: `Heji-like filename clue: 合9774
  (G_0960_乙4518合9774賓組.png)`
...
- Which source records identify obs-char-000851 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000851？
