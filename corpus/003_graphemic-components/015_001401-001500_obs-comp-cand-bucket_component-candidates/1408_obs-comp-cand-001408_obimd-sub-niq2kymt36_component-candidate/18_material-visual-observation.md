# Material Visual Observation / obs-comp-cand-001408 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001408`
- External reference / 外部参照: `obimd-sub-niq2kymt36`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015827_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/v34viqk9rx/niq2kymt36/niq2kymt36.png`
- Checksum / 校验和:
  `c9e397bc41181f0a08cb1322e5b12713555b37287724ebb653db568b63423b3c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 15.79%.
- Marked-pixel bounds: (51,25)–(192,218); span 142 × 194 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占15.79%。
- 痕迹范围：(51,25)–(192,218)；跨度142 × 194 px；痕迹矩形高于宽。
