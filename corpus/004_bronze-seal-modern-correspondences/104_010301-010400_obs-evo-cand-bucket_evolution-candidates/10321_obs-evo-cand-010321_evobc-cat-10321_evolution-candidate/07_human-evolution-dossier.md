...
- External category reference: `evobc-cat-10321`
- Source category ID: `10321`
- Source label for human review: `髻`
- Source codepoints: `U+9AFB`
...
- `obs-evo-cand-010321-route-category-staging`
...
- `obs-evo-cand-010321-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010321-route-evolution-graph`
