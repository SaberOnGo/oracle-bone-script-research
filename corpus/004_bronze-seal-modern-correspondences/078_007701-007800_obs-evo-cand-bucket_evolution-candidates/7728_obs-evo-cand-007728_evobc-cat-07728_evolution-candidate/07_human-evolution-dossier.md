...
- Project ID: `obs-evo-cand-007728`
- EVOBC category candidate ID: `evobc-evo-cat-07728`
- External category reference: `evobc-cat-07728`
- Source category ID: `07728`
- Source label for human review: `蚓`
- Source codepoints: `U+8693`
...
- `obs-evo-cand-007728-route-category-staging`
...
- `obs-evo-cand-007728-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007728-route-evolution-graph`
