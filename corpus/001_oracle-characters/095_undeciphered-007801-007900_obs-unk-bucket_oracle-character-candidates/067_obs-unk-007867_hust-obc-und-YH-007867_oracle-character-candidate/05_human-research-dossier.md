# obs-unk-007867 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-007867`
- primary external id: `hust-obc-und-YH-007867`
...
- local review image route: `corpus/001_oracle-characters/095_undeciphered-007
  801-007900_obs-unk-bucket_oracle-character-candidates/067_obs-unk-007867_h
  ust-obc-und-YH-007867_oracle-character-candidate/03_visual-assets/001_asse
  t-009458_hust-obc-und-YH-007867_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6044B/H_？_6044B_0.png`
- asset id: `asset-009458`
...
- source class: `HUST-OBC/undeciphered/Y+H/6044B/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6044B/H_？_6044B_0.png`
- asset id: `asset-009458`
...
- Which source records identify obs-unk-007867 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007867？
