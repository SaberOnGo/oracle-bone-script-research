...
- External category reference: `evobc-cat-06150`
- Source category ID: `06150`
- Source label for human review: `穼`
- Source codepoints: `U+7A7C`
...
- `obs-evo-cand-006150-route-category-staging`
...
- `obs-evo-cand-006150-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006150-route-evolution-graph`
