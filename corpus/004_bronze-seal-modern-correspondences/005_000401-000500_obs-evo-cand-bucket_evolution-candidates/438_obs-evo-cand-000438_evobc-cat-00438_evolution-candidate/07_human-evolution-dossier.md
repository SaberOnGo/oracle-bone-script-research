...
- External category reference: `evobc-cat-00438`
- Source category ID: `00438`
- Source label for human review: `䜢`
...
- `obs-evo-cand-000438-route-category-staging`
...
- `obs-evo-cand-000438-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000438-route-evolution-graph`
