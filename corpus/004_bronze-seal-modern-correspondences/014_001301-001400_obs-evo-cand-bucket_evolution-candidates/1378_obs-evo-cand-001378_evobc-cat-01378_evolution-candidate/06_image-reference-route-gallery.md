...
- `obs-evo-cand-001378-route-category-staging`
...
- `obs-evo-cand-001378-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001378-route-evolution-graph`
