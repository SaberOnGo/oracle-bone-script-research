...
Project ID: `obs-insc-cw-cand-000136`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000136`
...
- Source page section: `Period I Group 7` /
  `第 I 期第 7 组`
- Source section key: `period-i-group-7`
...
- Yingguo / 英国所藏: `y732` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `131` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `402` in source row; primary catalog entry pending
- Heji / 合集: `39527` in source row; primary catalog entry pending
...
- Group and batch / 组类与批次: group `7`; batch or pit context pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000136`
