...
- External category reference: `evobc-cat-05071`
- Source category ID: `05071`
- Source label for human review: `烜`
...
- `obs-evo-cand-005071-route-category-staging`
...
- `obs-evo-cand-005071-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005071-route-evolution-graph`
