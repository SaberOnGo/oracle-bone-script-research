...
- External category reference: `evobc-cat-01018`
- Source category ID: `01018`
- Source label for human review: `僛`
...
- `obs-evo-cand-001018-route-category-staging`
...
- `obs-evo-cand-001018-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001018-route-evolution-graph`
