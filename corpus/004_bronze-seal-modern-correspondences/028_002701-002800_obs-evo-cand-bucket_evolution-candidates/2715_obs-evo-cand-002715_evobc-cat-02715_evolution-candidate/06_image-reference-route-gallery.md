...
- `obs-evo-cand-002715-route-category-staging`
...
- `obs-evo-cand-002715-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002715-route-evolution-graph`
