# obs-unk-006687 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/083_undeciphered-006
  601-006700_obs-unk-bucket_oracle-character-candidates/087_obs-unk-006687_h
  ust-obc-und-X-006687_oracle-character-candidate/03_visual-assets/001_asset
  -008278_hust-obc-und-X-006687_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2243/X_？_864_1.png`
- asset id: `asset-008278`
...
- source class: `HUST-OBC/undeciphered/X/2243/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2243/X_？_864_1.png`
- asset id: `asset-008278`
...
- Which source records identify obs-unk-006687 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006687？
