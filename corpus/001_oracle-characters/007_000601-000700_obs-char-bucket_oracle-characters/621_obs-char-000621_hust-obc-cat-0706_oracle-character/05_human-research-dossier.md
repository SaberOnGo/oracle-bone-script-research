# obs-char-000621 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000621`
- primary external id: `hust-obc-cat-0706`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/621_obs-char-000621_hust-obc-cat-0706_orac
  le-character/03_visual-assets/001_asset-000626_hust-obc-cat-0706_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0706/G_0706_乙1904合1351.png`
- asset id: `asset-000626`
...
- source category: `0706`
- validation class: `620`
- source image route: `HUST-OBC/deciphered/0706/G_0706_乙1904合1351.png`
- asset id: `asset-000626`
...
- English observation: `A tall right vertical is crossed by two short
  horizontal bars and an upper-left diagonal branch; a detached small
  rectangular loop sits at lower left.`
- 中文观察: `右侧高长竖笔被两条短横栏穿过，并带左上斜枝；左下另有分离小矩形环。`
...
- dataset label text: `㚸`
- dataset label codepoints: `U+36B8`
...
- OBIMD candidate ids / OBIMD 候选 ID: `obimd-main-cand-001412`
- OBIMD external refs / OBIMD 外部引用: `obimd-main-1mkqz99m8b`
- OBIMD transcription field / OBIMD 转写字段: `㚸|𭑧`
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00049`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00049`
- EvoBC image reference count / EvoBC 图像引用数: `88`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00049`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/049_obs-evo-can
  d-000049_evobc-cat-00049_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/049_obs-evo-cand-000049_evobc-cat-00049_evolu
...
- matched OBIMD main UIDs: `1mkqz99m8b`
- object-local component human files / 对象内构件人类档案: `none`
...
- filename catalog route clues: `Heji-like filename clue: 合1351
  (G_0706_乙1904合1351.png)`
...
- Which source records identify obs-char-000621 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000621？
