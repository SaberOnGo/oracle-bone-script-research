# Material Visual Observation / obs-comp-cand-001742 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001742`
- External reference / 外部参照: `obimd-sub-fybnj2savm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017943_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fybnj2savm/fybnj2savm/fybnj2savm.png`
- Checksum / 校验和:
  `ca518f344842ee328e8cb01025f6813b0d3c109b6f931c3c5d70e343ceaf2aa0`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.42%.
- Marked-pixel bounds: (78,21)–(171,225); span 94 × 205 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.42%。
- 痕迹范围：(78,21)–(171,225)；跨度94 × 205 px；痕迹矩形高于宽。
