...
Project ID: `obs-evo-cand-000829`
...
- Project ID: `obs-evo-cand-000829`
- EVOBC category candidate ID: `evobc-evo-cat-00829`
- External category reference: `evobc-cat-00829`
- Source category ID: `00829`
- Source label for human review: `佾`
- Source codepoints: `U+4F7E`
...
- `obs-evo-cand-000829-route-category-staging`
...
- `obs-evo-cand-000829-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000829-route-evolution-graph`
