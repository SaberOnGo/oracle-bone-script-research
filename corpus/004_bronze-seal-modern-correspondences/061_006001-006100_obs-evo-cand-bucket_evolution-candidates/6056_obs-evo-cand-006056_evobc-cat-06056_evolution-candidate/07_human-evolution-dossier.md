...
- External category reference: `evobc-cat-06056`
- Source category ID: `06056`
- Source label for human review: `秊`
- Source codepoints: `U+79CA`
...
- `obs-evo-cand-006056-route-category-staging`
...
- `obs-evo-cand-006056-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006056-route-evolution-graph`
