...
Project ID: `obs-evo-cand-009051`
...
- Project ID: `obs-evo-cand-009051`
- EVOBC category candidate ID: `evobc-evo-cat-09051`
- External category reference: `evobc-cat-09051`
- Source category ID: `09051`
- Source label for human review: `適`
- Source codepoints: `U+9069`
...
- `obs-evo-cand-009051-route-category-staging`
...
- `obs-evo-cand-009051-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009051-route-evolution-graph`
