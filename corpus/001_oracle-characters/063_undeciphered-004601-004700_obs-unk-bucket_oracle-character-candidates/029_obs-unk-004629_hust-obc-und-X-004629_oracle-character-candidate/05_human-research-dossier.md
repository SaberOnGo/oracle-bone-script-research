# obs-unk-004629 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/029_obs-unk-004629_h
  ust-obc-und-X-004629_oracle-character-candidate/03_visual-assets/001_asset
  -006222_hust-obc-und-X-004629_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/185/X_？_8359_1.png`
- asset id: `asset-006222`
...
- source class: `HUST-OBC/undeciphered/X/185/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/185/X_？_8359_1.png`
- asset id: `asset-006222`
...
- English observation: `broad rounded outline with pale interior`
- 中文观察: `宽大圆弧轮廓和内部浅色空间已记录。`
...
- Which source records identify obs-unk-004629 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004629？
