...
- External category reference: `evobc-cat-10156`
- Source category ID: `10156`
- Source label for human review: `香`
...
- `obs-evo-cand-010156-route-category-staging`
...
- `obs-evo-cand-010156-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010156-route-evolution-graph`
