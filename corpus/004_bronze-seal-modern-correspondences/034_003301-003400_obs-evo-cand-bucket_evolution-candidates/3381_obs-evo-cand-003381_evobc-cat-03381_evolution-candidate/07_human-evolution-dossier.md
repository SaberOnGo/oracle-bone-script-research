...
- External category reference: `evobc-cat-03381`
- Source category ID: `03381`
- Source label for human review: `捭`
...
- `obs-evo-cand-003381-route-category-staging`
...
- `obs-evo-cand-003381-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003381-route-evolution-graph`
