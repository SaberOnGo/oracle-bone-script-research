...
- External category reference: `evobc-cat-11254`
- Source category ID: `11254`
- Source label for human review: `𢝫`
- Source codepoints: `U+2276B`
...
- `obs-evo-cand-011254-route-category-staging`
...
- `obs-evo-cand-011254-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011254-route-evolution-graph`
