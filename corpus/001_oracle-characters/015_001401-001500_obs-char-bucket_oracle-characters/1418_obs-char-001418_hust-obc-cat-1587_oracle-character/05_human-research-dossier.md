# obs-char-001418 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1418_obs-char-001418_hust-obc-cat-1587_ora
  cle-character/03_visual-assets/001_asset-001423_hust-obc-cat-1587_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1587/X_1587_4169_1.png`
- asset id: `asset-001423`
...
- source category: `1587`
- validation class: `1417`
- source image route: `HUST-OBC/deciphered/1587/X_1587_4169_1.png`
- asset id: `asset-001423`
...
- English observation: `A large oval enclosure contains a small inner form
  above a long branching stem.`
...
- dataset label text: `㨩`
- dataset label codepoints: `U+3A29`
...
- Which source records identify obs-char-001418 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001418？
