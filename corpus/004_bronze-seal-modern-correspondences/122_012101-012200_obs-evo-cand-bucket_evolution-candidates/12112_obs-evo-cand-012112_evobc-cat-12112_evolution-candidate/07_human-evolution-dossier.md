...
Project ID: `obs-evo-cand-012112`
...
- Project ID: `obs-evo-cand-012112`
- EVOBC category candidate ID: `evobc-evo-cat-12112`
- External category reference: `evobc-cat-12112`
- Source category ID: `12112`
- Source label for human review: `𦵹`
- Source codepoints: `U+26D79`
...
- `obs-evo-cand-012112-route-category-staging`
...
- `obs-evo-cand-012112-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012112-route-evolution-graph`
