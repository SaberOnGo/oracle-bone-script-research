...
- External category reference: `evobc-cat-07133`
- Source category ID: `07133`
- Source label for human review: `膬`
...
- `obs-evo-cand-007133-route-category-staging`
...
- `obs-evo-cand-007133-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007133-route-evolution-graph`
