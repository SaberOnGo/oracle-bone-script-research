# obs-char-000875 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000875`
- primary external id: `hust-obc-cat-0987`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/875_obs-char-000875_hust-obc-cat-0987_orac
  le-character/03_visual-assets/001_asset-000880_hust-obc-cat-0987_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0987/L_0987_12142.jpg`
- asset id: `asset-000880`
...
- source category: `0987`
- validation class: `874`
- source image route: `HUST-OBC/deciphered/0987/L_0987_12142.jpg`
- asset id: `asset-000880`
...
- English observation: `The tiny gray image contains dense overlapping
  diagonal strokes in a compact cluster; fine joins and orientation are
  unclear.`
- 中文观察: `微小灰度图像含紧凑密集的重叠斜笔；细连接和具体方向难以辨认。`
...
- dataset label text: `㟑`
- dataset label codepoints: `U+37D1`
...
- Which source records identify obs-char-000875 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000875？
