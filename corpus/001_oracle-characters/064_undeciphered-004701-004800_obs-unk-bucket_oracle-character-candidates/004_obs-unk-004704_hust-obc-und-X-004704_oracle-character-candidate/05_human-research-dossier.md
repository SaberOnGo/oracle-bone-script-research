# obs-unk-004704 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/004_obs-unk-004704_h
  ust-obc-und-X-004704_oracle-character-candidate/03_visual-assets/001_asset
  -006297_hust-obc-und-X-004704_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/260/X_？_7106_1.png`
- asset id: `asset-006297`
...
- source class: `HUST-OBC/undeciphered/X/260/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/260/X_？_7106_1.png`
- asset id: `asset-006297`
...
- English observation: `rounded upper opening with unequal lower strokes`
- 中文观察: `带不等长下部笔画的圆钝上部开口`
...
- Which source records identify obs-unk-004704 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004704？
