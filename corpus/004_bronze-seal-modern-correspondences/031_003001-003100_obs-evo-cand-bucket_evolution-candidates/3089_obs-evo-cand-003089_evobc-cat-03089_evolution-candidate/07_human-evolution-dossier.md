...
Project ID: `obs-evo-cand-003089`
...
- Project ID: `obs-evo-cand-003089`
- EVOBC category candidate ID: `evobc-evo-cat-03089`
- External category reference: `evobc-cat-03089`
- Source category ID: `03089`
- Source label for human review: `愠`
- Source codepoints: `U+6120`
...
- `obs-evo-cand-003089-route-category-staging`
...
- `obs-evo-cand-003089-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003089-route-evolution-graph`
