...
- Project ID: `obs-evo-cand-001231`
- EVOBC category candidate ID: `evobc-evo-cat-01231`
- External category reference: `evobc-cat-01231`
- Source category ID: `01231`
- Source label for human review: `剞`
- Source codepoints: `U+525E`
...
- `obs-evo-cand-001231-route-category-staging`
...
- `obs-evo-cand-001231-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001231-route-evolution-graph`
