...
- External category reference: `evobc-cat-12599`
- Source category ID: `12599`
...
- `obs-evo-cand-012599-route-category-staging`
...
- `obs-evo-cand-012599-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012599-route-evolution-graph`
