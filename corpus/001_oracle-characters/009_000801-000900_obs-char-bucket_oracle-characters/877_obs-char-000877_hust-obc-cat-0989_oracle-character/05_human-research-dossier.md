# obs-char-000877 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000877`
- primary external id: `hust-obc-cat-0989`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/877_obs-char-000877_hust-obc-cat-0989_orac
  le-character/03_visual-assets/001_asset-000882_hust-obc-cat-0989_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0989/G_0989_前2.5.7合37514黃組.png`
- asset id: `asset-000882`
...
- source category: `0989`
- validation class: `876`
- source image route: `HUST-OBC/deciphered/0989/G_0989_前2.5.7合37514黃組.png`
- asset id: `asset-000882`
...
- English observation: `Two long outer curves enclose a central elongated
  loop crossed by thin strokes; an upper diagonal extends from the
  junction.`
...
- dataset label text: `㟓`
- dataset label codepoints: `U+37D3`
...
- filename catalog route clues: `Heji-like filename clue: 合37514
  (G_0989_前2.5.7合37514黃組.png)`
...
- Which source records identify obs-char-000877 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000877？
