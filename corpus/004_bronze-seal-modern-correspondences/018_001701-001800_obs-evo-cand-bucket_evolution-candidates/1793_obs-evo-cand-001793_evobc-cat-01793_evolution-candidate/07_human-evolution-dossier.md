...
- External category reference: `evobc-cat-01793`
- Source category ID: `01793`
- Source label for human review: `圭`
- Source codepoints: `U+572D`
...
- `obs-evo-cand-001793-route-category-staging`
...
- `obs-evo-cand-001793-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001793-route-evolution-graph`
