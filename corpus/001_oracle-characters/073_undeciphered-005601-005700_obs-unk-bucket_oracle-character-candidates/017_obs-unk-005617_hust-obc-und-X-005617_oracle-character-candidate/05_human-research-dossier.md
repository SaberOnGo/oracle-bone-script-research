# obs-unk-005617 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/073_undeciphered-005
  601-005700_obs-unk-bucket_oracle-character-candidates/017_obs-unk-005617_h
  ust-obc-und-X-005617_oracle-character-candidate/03_visual-assets/001_asset
  -007210_hust-obc-und-X-005617_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1173/X_？_8128_1.png`
- asset id: `asset-007210`
...
- source class: `HUST-OBC/undeciphered/X/1173/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1173/X_？_8128_1.png`
- asset id: `asset-007210`
...
- Which source records identify obs-unk-005617 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005617？
