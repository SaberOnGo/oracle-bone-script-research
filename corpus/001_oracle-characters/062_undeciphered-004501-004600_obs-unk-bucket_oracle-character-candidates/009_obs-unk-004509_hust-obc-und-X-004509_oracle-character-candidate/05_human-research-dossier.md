# obs-unk-004509 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004509`
- primary external id: `hust-obc-und-X-004509`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/009_obs-unk-004509_h
  ust-obc-und-X-004509_oracle-character-candidate/03_visual-assets/001_asset
  -006102_hust-obc-und-X-004509_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/65/X_？_8250_1.png`
- asset id: `asset-006102`
...
- source class: `HUST-OBC/undeciphered/X/65/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/65/X_？_8250_1.png`
- asset id: `asset-006102`
...
- English observation: `The two side-by-side forms, upper projections, open
  interiors, and image-count discrepancy are directly recorded.`
- 中文观察: `已直接记录左右两个形态、上部外伸痕、内部空白和图像数量差异。`
...
- Which source records identify obs-unk-004509 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004509？
