...
- External category reference: `evobc-cat-03506`
- Source category ID: `03506`
- Source label for human review: `播`
- Source codepoints: `U+64AD`
...
- `obs-evo-cand-003506-route-category-staging`
...
- `obs-evo-cand-003506-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003506-route-evolution-graph`
