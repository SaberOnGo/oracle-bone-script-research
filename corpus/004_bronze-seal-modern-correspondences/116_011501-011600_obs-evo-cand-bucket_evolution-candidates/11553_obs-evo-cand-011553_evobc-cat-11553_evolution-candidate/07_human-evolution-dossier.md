...
- External category reference: `evobc-cat-11553`
- Source category ID: `11553`
- Source label for human review: `𤅋`
- Source codepoints: `U+2414B`
...
- `obs-evo-cand-011553-route-category-staging`
...
- `obs-evo-cand-011553-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011553-route-evolution-graph`
