...
Project ID: `obs-evo-cand-013061`
...
- Project ID: `obs-evo-cand-013061`
- EVOBC category candidate ID: `evobc-evo-cat-13061`
- External category reference: `evobc-cat-13061`
- Source category ID: `13061`
- Source label for human review: `𫭠`
- Source codepoints: `U+2BB60`
...
- `obs-evo-cand-013061-route-category-staging`
...
- `obs-evo-cand-013061-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013061-route-evolution-graph`
