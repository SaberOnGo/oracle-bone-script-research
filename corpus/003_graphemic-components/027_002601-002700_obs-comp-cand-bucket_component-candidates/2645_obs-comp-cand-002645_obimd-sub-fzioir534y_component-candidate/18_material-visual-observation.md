# Material Visual Observation / obs-comp-cand-002645 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002645`
- External reference / 外部参照: `obimd-sub-fzioir534y`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021194_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fzioir534y/fzioir534y/fzioir534y.png`
- Checksum / 校验和:
  `bd0e08406fcb60151f74966c97688ec2116cedd21177a01f4840a182056b4bfe`
...
- Marked-pixel bounds: (94,18)–(163,229); span 70 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.67%。
- 痕迹范围：(94,18)–(163,229)；跨度70 × 212 px；痕迹矩形高于宽。
