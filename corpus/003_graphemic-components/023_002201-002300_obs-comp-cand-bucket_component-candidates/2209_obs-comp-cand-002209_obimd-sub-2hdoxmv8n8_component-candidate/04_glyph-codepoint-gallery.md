# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002209
...
| --- | --- | --- | --- |
| `obimd-glyph-link-034338` | 򤉱󼭨 | `U+A4271;U+FCB68` | `reviewed_metadata_only` |
| `obimd-glyph-link-034339` | 󼭩 | `U+FCB69` | `reviewed_metadata_only` |
