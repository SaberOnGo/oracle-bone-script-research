# Material Visual Observation / obs-comp-cand-002704 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002704`
- External reference / 外部参照: `obimd-sub-onvfob000r`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021280_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/onvfob000r/onvfob000r/onvfob000r.png`
- Checksum / 校验和:
  `f5375f6c28e1f71c95f17e054b751717b3471d572889ab3ee6f79edf7d6d2f06`
...
- Marked-pixel bounds: (92,18)–(153,228); span 62 × 211 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.40%。
- 痕迹范围：(92,18)–(153,228)；跨度62 × 211 px；痕迹矩形高于宽。
