...
- `obs-evo-cand-008597-route-category-staging`
...
- `obs-evo-cand-008597-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008597-route-evolution-graph`
