# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001361
...
| --- | --- | --- | --- |
| `obimd-glyph-link-020276` | 󷯍 | `U+F7BCD` | `reviewed_metadata_only` |
| `obimd-glyph-link-020277` | 󷯎 | `U+F7BCE` | `reviewed_metadata_only` |
