# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-005481
...
- EVOBC candidate category: `evobc-evo-cat-05481`.
- Source label for search only: `璫`.
- Source codepoints for search only: `U+74AB`.
