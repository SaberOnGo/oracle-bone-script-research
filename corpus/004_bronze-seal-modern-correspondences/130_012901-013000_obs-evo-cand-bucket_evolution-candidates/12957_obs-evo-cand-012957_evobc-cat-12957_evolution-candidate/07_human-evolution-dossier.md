...
- External category reference: `evobc-cat-12957`
- Source category ID: `12957`
- Source label for human review: `𫒊`
- Source codepoints: `U+2B48A`
...
- `obs-evo-cand-012957-route-category-staging`
...
- `obs-evo-cand-012957-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012957-route-evolution-graph`
