# obs-evo-cand-011856 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-011856`
- EVOBC category candidate ID: `evobc-evo-cat-11856`
- External category ref: `evobc-cat-11856`
- Source label: `𥨫`
- Source codepoints: `U+25A2B`
- Image reference count: `17`
- Era token counts: `BI:2;WSC:15`
- Source token counts: `Book:17`
