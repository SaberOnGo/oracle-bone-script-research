# obs-unk-004057 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004057`
- primary external id: `hust-obc-und-L-004057`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/057_obs-unk-004057_h
  ust-obc-und-L-004057_oracle-character-candidate/03_visual-assets/001_asset
  -005650_hust-obc-und-L-004057_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4057/L_？_8690.jpg`
- asset id: `asset-005650`
...
- source class: `HUST-OBC/undeciphered/L/4057/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4057/L_？_8690.jpg`
- asset id: `asset-005650`
...
- English observation: Several short prong-like traces rise at the top. A
  narrow central trace descends into a compact lower rectangular or bowl-like
  contour. The upper joins and the dark lower boundary remain uncertain.
...
- Which source records identify obs-unk-004057 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004057？
