...
- External category reference: `evobc-cat-12031`
- Source category ID: `12031`
- Source label for human review: `𦕓`
- Source codepoints: `U+26553`
...
- `obs-evo-cand-012031-route-category-staging`
...
- `obs-evo-cand-012031-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012031-route-evolution-graph`
