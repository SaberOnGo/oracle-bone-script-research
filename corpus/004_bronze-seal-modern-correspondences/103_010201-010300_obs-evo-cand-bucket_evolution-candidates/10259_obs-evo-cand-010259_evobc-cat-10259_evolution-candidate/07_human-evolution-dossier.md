...
Project ID: `obs-evo-cand-010259`
...
- Project ID: `obs-evo-cand-010259`
- EVOBC category candidate ID: `evobc-evo-cat-10259`
- External category reference: `evobc-cat-10259`
- Source category ID: `10259`
- Source label for human review: `驛`
- Source codepoints: `U+9A5B`
...
- `obs-evo-cand-010259-route-category-staging`
...
- `obs-evo-cand-010259-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010259-route-evolution-graph`
