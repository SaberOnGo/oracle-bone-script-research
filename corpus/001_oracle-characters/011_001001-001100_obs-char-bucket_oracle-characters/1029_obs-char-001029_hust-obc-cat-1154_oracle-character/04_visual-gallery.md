# obs-char-001029 Visual Gallery / obs-char-001029 图像资料页
...
- Primary external reference / 首选外部参考: `hust-obc-cat-1154`
...
## obs-char-001029-visual-source-001 / 图像条目

![obs-char-001029 glyph candidate](03_visual-assets/001_asset-001034_hust-obc-cat-1154_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-001034_hust-obc-cat-1154_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-001034_hust-obc-cat-1154_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/1154/G_1154_前7.35.2(甲).png`
