...
- External category reference: `evobc-cat-11252`
- Source category ID: `11252`
- Source label for human review: `𢝖`
- Source codepoints: `U+22756`
...
- `obs-evo-cand-011252-route-category-staging`
...
- `obs-evo-cand-011252-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011252-route-evolution-graph`
