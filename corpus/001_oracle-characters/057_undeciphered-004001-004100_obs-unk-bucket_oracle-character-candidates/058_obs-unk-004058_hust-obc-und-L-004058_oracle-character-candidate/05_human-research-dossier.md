# obs-unk-004058 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004058`
- primary external id: `hust-obc-und-L-004058`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/058_obs-unk-004058_h
  ust-obc-und-L-004058_oracle-character-candidate/03_visual-assets/001_asset
  -005651_hust-obc-und-L-004058_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4058/L_？_8691.jpg`
- asset id: `asset-005651`
...
- source class: `HUST-OBC/undeciphered/L/4058/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4058/L_？_8691.jpg`
- asset id: `asset-005651`
...
- English observation: A star-like crossing of short traces appears near the
  upper center. Slanting traces descend toward a broad lower rectangular or
  trapezoid-like contour. The crop does not resolve the outer joins.
...
- Which source records identify obs-unk-004058 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004058？
