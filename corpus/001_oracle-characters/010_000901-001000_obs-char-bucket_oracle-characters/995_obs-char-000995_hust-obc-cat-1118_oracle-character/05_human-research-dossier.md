# obs-char-000995 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000995`
- primary external id: `hust-obc-cat-1118`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/995_obs-char-000995_hust-obc-cat-1118_orac
  le-character/03_visual-assets/001_asset-001000_hust-obc-cat-1118_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1118/G_1118_乙5399合22046.png`
- asset id: `asset-001000`
...
- source category: `1118`
- validation class: `994`
- source image route: `HUST-OBC/deciphered/1118/G_1118_乙5399合22046.png`
- asset id: `asset-001000`
...
- English observation: `A pointed oval enclosure is divided by a horizontal
  stroke and a central lower stem.`
- 中文观察: `尖形椭圆状闭合轮廓由横笔和中央下部笔干分隔。`
...
- dataset label text: `㡔`
- dataset label codepoints: `U+3854`
...
- filename catalog route clues: `Heji-like filename clue: 合22046
  (G_1118_乙5399合22046.png)`
...
- Which source records identify obs-char-000995 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000995？
