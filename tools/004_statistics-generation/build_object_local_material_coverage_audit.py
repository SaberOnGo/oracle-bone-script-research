...
OBJECT_SPECS = [
    ...
    ObjectSpec(
        ...
        ("README.md", "04_human-review-sheet.md", "06_plate-text-gallery.md"),
        ("01_candidate-inscription-crosswalk-packet.json", "02_crosswalk-source-index.csv", "03_catalog-reference-index.csv", "05_plate-text-route-index.csv"),
        (),
    ...
    ObjectSpec(
        ...
        ("README.md", "04_visual-gallery.md", "05_human-review-sheet.md"),
        ("01_collection-object-packet.json", "02_collection-source-index.csv", "03_visual-asset-index.csv"),
        (),
