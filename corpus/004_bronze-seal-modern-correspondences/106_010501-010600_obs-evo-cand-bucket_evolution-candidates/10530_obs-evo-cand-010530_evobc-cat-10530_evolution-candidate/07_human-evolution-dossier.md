...
- Project ID: `obs-evo-cand-010530`
- EVOBC category candidate ID: `evobc-evo-cat-10530`
- External category reference: `evobc-cat-10530`
- Source category ID: `10530`
- Source label for human review: `鶤`
- Source codepoints: `U+9DA4`
...
- `obs-evo-cand-010530-route-category-staging`
...
- `obs-evo-cand-010530-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010530-route-evolution-graph`
