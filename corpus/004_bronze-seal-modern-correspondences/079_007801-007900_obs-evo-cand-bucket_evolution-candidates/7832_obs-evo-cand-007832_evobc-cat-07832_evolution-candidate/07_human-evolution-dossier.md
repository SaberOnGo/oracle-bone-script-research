...
- External category reference: `evobc-cat-07832`
- Source category ID: `07832`
- Source label for human review: `螣`
- Source codepoints: `U+87A3`
...
- `obs-evo-cand-007832-route-category-staging`
...
- `obs-evo-cand-007832-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007832-route-evolution-graph`
