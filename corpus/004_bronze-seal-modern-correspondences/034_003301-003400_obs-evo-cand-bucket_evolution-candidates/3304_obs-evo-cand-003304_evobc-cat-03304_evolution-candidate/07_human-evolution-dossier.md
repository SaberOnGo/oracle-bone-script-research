...
- External category reference: `evobc-cat-03304`
- Source category ID: `03304`
- Source label: `担`
...
- `obs-evo-cand-003304-route-category-staging`
...
- `obs-evo-cand-003304-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003304-route-evolution-graph`
