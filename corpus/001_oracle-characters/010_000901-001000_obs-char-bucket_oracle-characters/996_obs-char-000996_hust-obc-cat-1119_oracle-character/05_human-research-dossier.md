# obs-char-000996 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/996_obs-char-000996_hust-obc-cat-1119_orac
  le-character/03_visual-assets/001_asset-001001_hust-obc-cat-1119_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1119/G_1119_乙6280合9234.png`
- asset id: `asset-001001`
...
- source category: `1119`
- validation class: `995`
- source image route: `HUST-OBC/deciphered/1119/G_1119_乙6280合9234.png`
- asset id: `asset-001001`
...
- English observation: `A rounded lower enclosure with an upper crossbar
  contains two long descending inner branches.`
- 中文观察: `带上部横笔的圆弧下部闭合轮廓含两条长下行内部笔。`
...
- dataset label text: `㡕`
- dataset label codepoints: `U+3855`
...
- filename catalog route clues: `Heji-like filename clue: 合9234
...
- Which source records identify obs-char-000996 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000996？
