# obs-unk-004568 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/068_obs-unk-004568_h
  ust-obc-und-X-004568_oracle-character-candidate/03_visual-assets/001_asset
  -006161_hust-obc-und-X-004568_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/124/X_？_8304_1.png`
- asset id: `asset-006161`
...
- source class: `HUST-OBC/undeciphered/X/124/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/124/X_？_8304_1.png`
- asset id: `asset-006161`
...
- English observation: `Upper enclosure, openings, and lower slants noted.`
- 中文观察: `已记录上部轮廓、开口和下部斜痕。`
...
- Which source records identify obs-unk-004568 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004568？
