...
- External category reference: `evobc-cat-11627`
- Source category ID: `11627`
- Source label for human review: `𤠴`
...
- `obs-evo-cand-011627-route-category-staging`
...
- `obs-evo-cand-011627-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011627-route-evolution-graph`
