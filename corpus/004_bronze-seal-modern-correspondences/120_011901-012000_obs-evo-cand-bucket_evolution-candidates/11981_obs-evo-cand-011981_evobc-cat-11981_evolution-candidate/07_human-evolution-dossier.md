...
- Project ID: `obs-evo-cand-011981`
- EVOBC category candidate ID: `evobc-evo-cat-11981`
- External category reference: `evobc-cat-11981`
- Source category ID: `11981`
- Source label for human review: `𦆍`
- Source codepoints: `U+2618D`
...
- `obs-evo-cand-011981-route-category-staging`
...
- `obs-evo-cand-011981-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011981-route-evolution-graph`
