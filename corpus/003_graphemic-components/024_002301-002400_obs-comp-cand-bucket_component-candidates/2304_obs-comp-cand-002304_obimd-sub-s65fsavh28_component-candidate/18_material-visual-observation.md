# Material Visual Observation / obs-comp-cand-002304 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002304`
- External reference / 外部参照: `obimd-sub-s65fsavh28`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020323_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/s65fsavh28/s65fsavh28/s65fsavh28.png`
- Checksum / 校验和:
  `df36ff6b77cf4bb264d74bbe0496d0e04a1af51db1a8829902edcd967681a41d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.31%.
- Marked-pixel bounds: (97,27)–(152,218); span 56 × 192 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.31%。
- 痕迹范围：(97,27)–(152,218)；跨度56 × 192 px；痕迹矩形高于宽。
