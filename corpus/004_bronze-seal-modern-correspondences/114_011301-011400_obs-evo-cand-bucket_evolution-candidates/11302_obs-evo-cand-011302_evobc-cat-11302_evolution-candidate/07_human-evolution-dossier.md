...
- External category reference: `evobc-cat-11302`
- Source category ID: `11302`
- Source label for human review: `𢬈`
- Source codepoints: `U+22B08`
...
- `obs-evo-cand-011302-route-category-staging`
...
- `obs-evo-cand-011302-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011302-route-evolution-graph`
