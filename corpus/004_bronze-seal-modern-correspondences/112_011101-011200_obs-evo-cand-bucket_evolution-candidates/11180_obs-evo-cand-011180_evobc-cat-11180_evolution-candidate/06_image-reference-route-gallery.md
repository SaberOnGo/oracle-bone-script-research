...
- `obs-evo-cand-011180-route-category-staging`
...
- `obs-evo-cand-011180-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011180-route-evolution-graph`
