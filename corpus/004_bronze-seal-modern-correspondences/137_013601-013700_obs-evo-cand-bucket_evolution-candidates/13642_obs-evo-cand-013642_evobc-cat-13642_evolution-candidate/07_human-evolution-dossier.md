...
- External category reference: `evobc-cat-13642`
- Source category ID: `13642`
- Source label for human review: `𮘿`
- Source codepoints: `U+2E63F`
...
- `obs-evo-cand-013642-route-category-staging`
...
- `obs-evo-cand-013642-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013642-route-evolution-graph`
