# Material Visual Observation / obs-comp-cand-001343 实物图像观察
...
- External reference / 外部参照: `obimd-sub-03lz1oza4v`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015726_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/f9f0lfjetk/03lz1oza4v/03lz1oza4v.png`
- Checksum / 校验和:
  `481f6c2e0ca3e4a24a3494f15bb1cc805aa0a0759b26606d7001c81558154418`
...
- Marked-pixel bounds: (59,35)–(171,210); span 113 × 176 px; the marked
...
- 痕迹范围：(59,35)–(171,210)；跨度113 × 176 px；痕迹矩形高于宽。
