# obs-comp-cand-002238 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002238`
- 首选外部 ID: `obimd-sub-2dvxzc8jrd`
- OBIMD subcharacter UID: `2dvxzc8jrd`
- OBIMD main character UID: `2dvxzc8jrd`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `6`
- codepoint 示例: U+B0979;U+FCDD5; U+FCDD6; 另有 4 项
