# obs-char-000364 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000364`
- primary external id: `hust-obc-cat-0414`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/364_obs-char-000364_hust-obc-cat-0414_orac
  le-character/03_visual-assets/001_asset-000369_hust-obc-cat-0414_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0414/G_0414_乙2144合14128賓組.png`
- asset id: `asset-000369`
...
- source category: `0414`
- validation class: `363`
- source image route: `HUST-OBC/deciphered/0414/G_0414_乙2144合14128賓組.png`
- asset id: `asset-000369`
...
- English observation: `A compact rounded upper outline surrounds a central
  rectangular area, with side loops and a lower stem.`
- 中文观察: `紧凑的圆弧上部轮廓围出中央矩形区域，两侧有环状痕迹并连接下部主干。`
...
- dataset label text: `㖔`
- dataset label codepoints: `U+3594`
...
- filename catalog route clues: `Heji-like filename clue: 合14128
  (G_0414_乙2144合14128賓組.png)`
...
- Which source records identify obs-char-000364 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000364？
