...
- External category reference: `evobc-cat-08694`
- Source category ID: `08694`
- Source label for human review: `趫`
...
- `obs-evo-cand-008694-route-category-staging`
...
- `obs-evo-cand-008694-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008694-route-evolution-graph`
