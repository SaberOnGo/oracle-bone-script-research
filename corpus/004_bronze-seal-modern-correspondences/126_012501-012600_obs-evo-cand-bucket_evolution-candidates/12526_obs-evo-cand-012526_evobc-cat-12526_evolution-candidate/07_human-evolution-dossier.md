...
- External category reference: `evobc-cat-12526`
- Source category ID: `12526`
- Source label for human review: `𨼟`
...
- `obs-evo-cand-012526-route-category-staging`
...
- `obs-evo-cand-012526-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012526-route-evolution-graph`
