# obs-unk-004335 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004335`
- primary external id: `hust-obc-und-L-004335`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/035_obs-unk-004335_h
  ust-obc-und-L-004335_oracle-character-candidate/03_visual-assets/001_asset
  -005928_hust-obc-und-L-004335_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4335/L_？_9577.jpg`
- asset id: `asset-005928`
...
- source class: `HUST-OBC/undeciphered/L/4335/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4335/L_？_9577.jpg`
- asset id: `asset-005928`
...
- English observation: `Outer curves and central compact trace recorded.`
- 中文观察: `已记录外侧弯痕和中央紧密痕迹。`
...
- Which source records identify obs-unk-004335 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004335？
