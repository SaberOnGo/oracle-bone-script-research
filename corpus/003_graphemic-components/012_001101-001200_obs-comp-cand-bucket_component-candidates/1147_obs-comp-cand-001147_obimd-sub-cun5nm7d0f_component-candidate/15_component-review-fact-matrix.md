# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001147
...
| Glyph or codepoint route / 字形或码位路线 | 13 OBIMD route rows; examples U+53B7;U+80B1;U+F6A06; U+F6A07; 另有 11 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 13 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
