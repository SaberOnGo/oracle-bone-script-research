# obs-unk-004589 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004589`
- primary external id: `hust-obc-und-X-004589`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/089_obs-unk-004589_h
  ust-obc-und-X-004589_oracle-character-candidate/03_visual-assets/001_asset
  -006182_hust-obc-und-X-004589_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/145/X_？_8323_1.png`
- asset id: `asset-006182`
...
- source class: `HUST-OBC/undeciphered/X/145/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/145/X_？_8323_1.png`
- asset id: `asset-006182`
...
- English observation: `Upper marks, oval opening, lower curve, and point`
  `recorded.`
- 中文观察: `已记录上部痕迹、椭圆开口、下部弯曲和尖端。`
...
- Which source records identify obs-unk-004589 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004589？
