# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010710
...
- EVOBC candidate category: `evobc-evo-cat-10710`.
- Source label for search only: `齊`.
- Source codepoints for search only: `U+9F4A`.
