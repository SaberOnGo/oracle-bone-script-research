# obs-char-000275 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/275_obs-char-000275_hust-obc-cat-0310_orac
  le-character/03_visual-assets/001_asset-000280_hust-obc-cat-0310_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0310/G_0310_乙154合20761.png`
- asset id: `asset-000280`
...
- source category: `0310`
- validation class: `274`
- source image route: `HUST-OBC/deciphered/0310/G_0310_乙154合20761.png`
- asset id: `asset-000280`
...
- English observation: `The small image shows a compact dark upper cluster
  with short angled marks and a long slender stroke descending along the
  right.`
...
- dataset label text: `㔬`
- dataset label codepoints: `U+352C`
...
- filename catalog route clues: `Heji-like filename clue: 合20761
...
- Which source records identify obs-char-000275 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000275？
