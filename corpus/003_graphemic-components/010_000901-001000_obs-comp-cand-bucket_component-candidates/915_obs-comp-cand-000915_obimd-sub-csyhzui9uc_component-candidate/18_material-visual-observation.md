# Material Visual Observation / obs-comp-cand-000915 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000915`
- External reference / 外部参照: `obimd-sub-csyhzui9uc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013998_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/csyhzui9uc/csyhzui9uc/csyhzui9uc.png`
- Checksum / 校验和:
  `ee149bbb55d81c936722e77b7b9f716da19e0249002d64223f40446c4d038848`
...
- Marked-pixel bounds: (84,31)–(165,220); span 82 × 190 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.96%。
- 痕迹范围：(84,31)–(165,220)；跨度82 × 190 px；痕迹矩形高于宽。
