...
Project ID: `obs-evo-cand-000924`
...
- Project ID: `obs-evo-cand-000924`
- EVOBC category candidate ID: `evobc-evo-cat-00924`
- External category reference: `evobc-cat-00924`
- Source category ID: `00924`
- Source label for human review: `倓`
- Source codepoints: `U+5013`
...
- `obs-evo-cand-000924-route-category-staging`
...
- `obs-evo-cand-000924-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000924-route-evolution-graph`
