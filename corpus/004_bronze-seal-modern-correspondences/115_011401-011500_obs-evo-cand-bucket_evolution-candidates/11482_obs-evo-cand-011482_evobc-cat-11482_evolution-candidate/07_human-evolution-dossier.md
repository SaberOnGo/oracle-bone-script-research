...
- External category reference: `evobc-cat-11482`
- Source category ID: `11482`
- Source label for human review: `𣧂`
- Source codepoints: `U+239C2`
...
- `obs-evo-cand-011482-route-category-staging`
...
- `obs-evo-cand-011482-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011482-route-evolution-graph`
