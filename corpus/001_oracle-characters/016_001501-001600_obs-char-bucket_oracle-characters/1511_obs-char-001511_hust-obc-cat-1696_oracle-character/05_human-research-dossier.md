# obs-char-001511 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001511`
- primary external id: `hust-obc-cat-1696`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1511_obs-char-001511_hust-obc-cat-1696_ora
  cle-character/03_visual-assets/001_asset-001516_hust-obc-cat-1696_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1696/G_1696_乙1704合22100.png`
- asset id: `asset-001516`
...
- source category: `1696`
- validation class: `1510`
- source image route: `HUST-OBC/deciphered/1696/G_1696_乙1704合22100.png`
- asset id: `asset-001516`
...
- English observation: `A narrow branching form has a forked top, a central
  zigzag, and a long diagonal right stroke.`
- 中文观察: `狭长分枝形体有分叉上端、中央曲折和右侧长斜笔。`
...
- dataset label text: `㪖`
- dataset label codepoints: `U+3A96`
...
- filename catalog route clues: `Heji-like filename clue: 合22100
...
- Which source records identify obs-char-001511 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001511？
