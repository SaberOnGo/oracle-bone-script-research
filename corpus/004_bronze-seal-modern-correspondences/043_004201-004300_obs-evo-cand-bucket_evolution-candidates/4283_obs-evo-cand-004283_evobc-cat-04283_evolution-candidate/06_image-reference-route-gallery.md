...
- `obs-evo-cand-004283-route-category-staging`
...
- `obs-evo-cand-004283-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004283-route-evolution-graph`
