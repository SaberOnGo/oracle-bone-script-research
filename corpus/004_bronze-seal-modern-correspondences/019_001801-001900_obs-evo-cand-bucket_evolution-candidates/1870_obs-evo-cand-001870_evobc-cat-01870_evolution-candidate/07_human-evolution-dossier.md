...
- External category reference: `evobc-cat-01870`
- Source category ID: `01870`
...
- `obs-evo-cand-001870-route-category-staging`
...
- `obs-evo-cand-001870-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001870-route-evolution-graph`
