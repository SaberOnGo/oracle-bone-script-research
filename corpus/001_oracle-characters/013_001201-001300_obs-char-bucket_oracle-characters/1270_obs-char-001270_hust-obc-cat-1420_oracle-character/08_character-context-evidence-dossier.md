...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1420`
...
- Source image / 来源图: `G_1420_乙7978反合6657反賓組.png`
- Image / 图像: `001_asset-001275_hust-obc-cat-1420_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合6657
  (G_1420_乙7978反合6657反賓組.png)`
...
- target node: `evobc-evo-cat-00134`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00134`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00134`
...
- Matched candidate folders / 匹配候选目录: `evobc-evo-cat-00134`
- Human review files / 人类复核文件:
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/134_obs-evo-cand-000134_evobc-cat-00134_evoluti
...
- Source label text / 来源标签文字: `㦂`
- Source label codepoint / 来源标签 codepoint: `U+3982`
