...
- Project ID: `obs-evo-cand-010952`
- EVOBC category candidate ID: `evobc-evo-cat-10952`
- External category reference: `evobc-cat-10952`
- Source category ID: `10952`
- Source label for human review: `𠸲`
- Source codepoints: `U+20E32`
...
- `obs-evo-cand-010952-route-category-staging`
...
- `obs-evo-cand-010952-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010952-route-evolution-graph`
