...
- Project ID: `obs-evo-cand-008736`
- EVOBC category candidate ID: `evobc-evo-cat-08736`
- External category reference: `evobc-cat-08736`
- Source category ID: `08736`
- Source label for human review: `踦`
- Source codepoints: `U+8E26`
...
- `obs-evo-cand-008736-route-category-staging`
...
- `obs-evo-cand-008736-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008736-route-evolution-graph`
