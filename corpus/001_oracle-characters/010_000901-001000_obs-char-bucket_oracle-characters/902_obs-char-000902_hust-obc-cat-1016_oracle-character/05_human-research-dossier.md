# obs-char-000902 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/902_obs-char-000902_hust-obc-cat-1016_orac
  le-character/03_visual-assets/001_asset-000907_hust-obc-cat-1016_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1016/X_1016_4701_1.png`
- asset id: `asset-000907`
...
- source category: `1016`
- validation class: `901`
- source image route: `HUST-OBC/deciphered/1016/X_1016_4701_1.png`
- asset id: `asset-000907`
...
- English observation: `A tall pointed enclosed form sits above a small
  rounded loop and a broad lower zigzag cluster; short side marks are
  detached.`
- 中文观察: `高长尖形闭合轮廓下方接小型圆弧环和宽大下部曲折笔群；两侧短痕迹相互分离。`
...
- dataset label text: `㟮`
- dataset label codepoints: `U+37EE`
...
- Which source records identify obs-char-000902 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000902？
