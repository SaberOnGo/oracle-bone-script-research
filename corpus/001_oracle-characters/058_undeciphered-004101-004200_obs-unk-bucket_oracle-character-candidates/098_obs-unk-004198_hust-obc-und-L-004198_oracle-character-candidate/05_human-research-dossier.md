# obs-unk-004198 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/098_obs-unk-004198_h
  ust-obc-und-L-004198_oracle-character-candidate/03_visual-assets/001_asset
  -005791_hust-obc-und-L-004198_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4198/L_？_9140.jpg`
- asset id: `asset-005791`
...
- source class: `HUST-OBC/undeciphered/L/4198/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4198/L_？_9140.jpg`
- asset id: `asset-005791`
...
- English observation: `Upper mark, middle curve, and lower diagonals visible.`
- 中文观察: `上部痕迹、中部弧形和下部斜笔画可见。`
...
- Which source records identify obs-unk-004198 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004198？
