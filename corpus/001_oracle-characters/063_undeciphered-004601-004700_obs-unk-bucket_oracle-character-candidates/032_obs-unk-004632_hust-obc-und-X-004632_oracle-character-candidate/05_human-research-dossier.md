# obs-unk-004632 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004632`
- primary external id: `hust-obc-und-X-004632`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/032_obs-unk-004632_h
  ust-obc-und-X-004632_oracle-character-candidate/03_visual-assets/001_asset
  -006225_hust-obc-und-X-004632_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/188/X_？_8362_1.png`
- asset id: `asset-006225`
...
- source class: `HUST-OBC/undeciphered/X/188/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/188/X_？_8362_1.png`
- asset id: `asset-006225`
...
- English observation: `upper rectangle, lower trace, tall right terminal`
- 中文观察: `上部小框、下部横痕和右侧高末端已记录。`
...
- Which source records identify obs-unk-004632 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004632？
