# obs-char-001509 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001509`
- primary external id: `hust-obc-cat-1694`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1509_obs-char-001509_hust-obc-cat-1694_ora
  cle-character/03_visual-assets/001_asset-001514_hust-obc-cat-1694_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1694/G_1694_戩45.11(甲).png`
- asset id: `asset-001514`
...
- source category: `1694`
- validation class: `1508`
- source image route: `HUST-OBC/deciphered/1694/G_1694_戩45.11(甲).png`
- asset id: `asset-001514`
...
- English observation: `Sparse separated strokes form two open curved
  contours with no closed interior.`
- 中文观察: `稀疏分离笔画形成两个开放弧形轮廓，内部没有闭合空间。`
...
- dataset label text: `㪔`
- dataset label codepoints: `U+3A94`
...
- EvoBC image reference count / EvoBC 图像引用数: `21`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/148_obs-evo-can
  d-000148_evobc-cat-00148_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/148_obs-evo-cand-000148_evobc-cat-00148_evolu
...
- Which source records identify obs-char-001509 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001509？
