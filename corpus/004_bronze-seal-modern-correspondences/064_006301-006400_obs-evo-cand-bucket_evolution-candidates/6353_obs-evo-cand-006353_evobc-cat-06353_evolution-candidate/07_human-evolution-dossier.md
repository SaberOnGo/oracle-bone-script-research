...
- External category reference: `evobc-cat-06353`
- Source category ID: `06353`
- Source label for human review: `簡`
- Source codepoints: `U+7C21`
...
- `obs-evo-cand-006353-route-category-staging`
...
- `obs-evo-cand-006353-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006353-route-evolution-graph`
