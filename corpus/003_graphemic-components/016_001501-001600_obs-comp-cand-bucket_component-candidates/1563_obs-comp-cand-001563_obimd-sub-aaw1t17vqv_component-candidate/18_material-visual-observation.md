# Material Visual Observation / obs-comp-cand-001563 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001563`
- External reference / 外部参照: `obimd-sub-aaw1t17vqv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017110_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/aaw1t17vqv/aaw1t17vqv/aaw1t17vqv.png`
- Checksum / 校验和:
  `ceea092107adba9fc8afc099cb6634c9f510189bb7489ab9fd26b61366010dfa`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.97%.
- Marked-pixel bounds: (83,18)–(167,228); span 85 × 211 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.97%。
- 痕迹范围：(83,18)–(167,228)；跨度85 × 211 px；痕迹矩形高于宽。
