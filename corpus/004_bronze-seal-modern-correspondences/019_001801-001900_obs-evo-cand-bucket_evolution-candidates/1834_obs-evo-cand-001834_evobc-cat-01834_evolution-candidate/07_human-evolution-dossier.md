...
Project ID: `obs-evo-cand-001834`
...
- Project ID: `obs-evo-cand-001834`
- EVOBC category candidate ID: `evobc-evo-cat-01834`
- External category reference: `evobc-cat-01834`
- Source category ID: `01834`
- Source label for human review: `坴`
- Source codepoints: `U+5774`
...
- `obs-evo-cand-001834-route-category-staging`
...
- `obs-evo-cand-001834-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001834-route-evolution-graph`
