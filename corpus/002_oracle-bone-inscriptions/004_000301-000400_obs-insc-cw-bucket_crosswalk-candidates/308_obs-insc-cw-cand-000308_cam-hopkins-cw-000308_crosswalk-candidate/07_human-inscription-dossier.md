...
- Yingguo / 英国所藏: `y1958` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `429` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `414` in source row; primary catalog entry pending
- Heji / 合集: `40977` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000308`
