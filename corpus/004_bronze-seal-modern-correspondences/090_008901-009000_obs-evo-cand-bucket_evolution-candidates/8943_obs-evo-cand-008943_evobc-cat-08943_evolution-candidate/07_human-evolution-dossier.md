...
- External category reference: `evobc-cat-08943`
- Source category ID: `08943`
- Source label: `迋`
...
- `obs-evo-cand-008943-route-category-staging`
...
- `obs-evo-cand-008943-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008943-route-evolution-graph`
