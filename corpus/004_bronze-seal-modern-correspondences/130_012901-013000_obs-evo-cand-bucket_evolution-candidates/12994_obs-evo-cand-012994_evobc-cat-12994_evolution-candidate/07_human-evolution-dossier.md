...
- External category reference: `evobc-cat-12994`
- Source category ID: `12994`
- Source label for human review: `𫡡`
...
- `obs-evo-cand-012994-route-category-staging`
...
- `obs-evo-cand-012994-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012994-route-evolution-graph`
