...
- External category reference: `evobc-cat-07449`
- Source category ID: `07449`
- Source label for human review: `萩`
- Source codepoints: `U+8429`
...
- `obs-evo-cand-007449-route-category-staging`
...
- `obs-evo-cand-007449-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007449-route-evolution-graph`
