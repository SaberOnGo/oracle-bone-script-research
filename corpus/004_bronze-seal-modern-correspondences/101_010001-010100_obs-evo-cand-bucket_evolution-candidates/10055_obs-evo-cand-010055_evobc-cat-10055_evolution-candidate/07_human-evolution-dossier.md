...
- External category reference: `evobc-cat-10055`
- Source category ID: `10055`
- Source label for human review: `颊`
- Source codepoints: `U+988A`
...
- `obs-evo-cand-010055-route-category-staging`
...
- `obs-evo-cand-010055-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010055-route-evolution-graph`
