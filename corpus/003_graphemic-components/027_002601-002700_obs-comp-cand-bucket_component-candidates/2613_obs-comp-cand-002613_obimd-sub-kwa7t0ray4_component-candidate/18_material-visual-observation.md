# Material Visual Observation / obs-comp-cand-002613 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002613`
- External reference / 外部参照: `obimd-sub-kwa7t0ray4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021152_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kwa7t0ray4/kwa7t0ray4/kwa7t0ray4.png`
- Checksum / 校验和:
  `6067bc207a206eed9e049b5c7e0e8419a83d995b47d8efa04b78614649bf551f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.03%.
- Marked-pixel bounds: (83,23)–(180,224); span 98 × 202 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.03%。
- 痕迹范围：(83,23)–(180,224)；跨度98 × 202 px；痕迹矩形高于宽。
