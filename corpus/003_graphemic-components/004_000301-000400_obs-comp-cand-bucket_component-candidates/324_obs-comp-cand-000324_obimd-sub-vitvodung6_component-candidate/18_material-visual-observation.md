# Material Visual Observation / obs-comp-cand-000324 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000324`
- External reference / 外部参照: `obimd-sub-vitvodung6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012250_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vitvodung6/vitvodung6/vitvodung6.png`
- Checksum / 校验和:
  `b628a60baf8227a63277efc1b2f7d09b389dcf0247acf1a1310ea8eb9b0ff6bc`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.35%.
- Marked-pixel bounds: (78,35)–(171,214); span 94 × 180 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.35%。
- 痕迹范围：(78,35)–(171,214)；跨度94 × 180 px；痕迹矩形高于宽。
