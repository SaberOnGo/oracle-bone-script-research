...
- Project ID: `obs-evo-cand-003771`
- EVOBC category candidate ID: `evobc-evo-cat-03771`
- External category reference: `evobc-cat-03771`
- Source category ID: `03771`
- Source label for human review: `暈`
- Source codepoints: `U+6688`
...
- `obs-evo-cand-003771-route-category-staging`
...
- `obs-evo-cand-003771-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003771-route-evolution-graph`
