# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-009441
...
- EVOBC candidate category: `evobc-evo-cat-09441`.
- Source label for search only: `錪`.
- Source codepoints for search only: `U+932A`.
