...
- Project ID: `obs-evo-cand-005528`
- EVOBC category candidate ID: `evobc-evo-cat-05528`
- External category reference: `evobc-cat-05528`
- Source category ID: `05528`
- Source label for human review: `甗`
- Source codepoints: `U+7517`
- Image reference count in source metadata: `74`
...
- `obs-evo-cand-005528-route-category-staging`
...
- `obs-evo-cand-005528-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005528-route-evolution-graph`
