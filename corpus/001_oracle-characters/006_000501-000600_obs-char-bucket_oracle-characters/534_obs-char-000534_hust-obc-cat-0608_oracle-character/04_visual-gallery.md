# obs-char-000534 Visual Gallery / obs-char-000534 图像资料页
...
- Project ID / 项目 ID: `obs-char-000534`
- Primary external reference / 首选外部参考: `hust-obc-cat-0608`
...
## obs-char-000534-visual-source-001 / 图像条目

![obs-char-000534 glyph candidate](03_visual-assets/001_asset-000539_hust-obc-cat-0608_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000539_hust-obc-cat-0608_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000539_hust-obc-cat-0608_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/0608/G_0608_戩4.15(甲).png`
