...
- Project ID: `obs-evo-cand-006538`
- EVOBC category candidate ID: `evobc-evo-cat-06538`
- External category reference: `evobc-cat-06538`
- Source category ID: `06538`
- Source label for human review: `綉`
- Source codepoints: `U+7D89`
...
- `obs-evo-cand-006538-route-category-staging`
...
- `obs-evo-cand-006538-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006538-route-evolution-graph`
