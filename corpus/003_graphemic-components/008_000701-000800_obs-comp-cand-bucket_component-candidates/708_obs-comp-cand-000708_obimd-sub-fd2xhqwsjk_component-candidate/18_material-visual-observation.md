# Material Visual Observation / obs-comp-cand-000708 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000708`
- External reference / 外部参照: `obimd-sub-fd2xhqwsjk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013384_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fd2xhqwsjk/fd2xhqwsjk/0mi6v4bgxd.png`
- Checksum / 校验和:
  `8c0042bf4f46e4907a2ced1895a6c59f079ab030de1bcbf24ebd8e5ea87946cb`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.42%.
- Marked-pixel bounds: (80,35)–(168,214); span 89 × 180 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.42%。
- 痕迹范围：(80,35)–(168,214)；跨度89 × 180 px；痕迹矩形高于宽。
