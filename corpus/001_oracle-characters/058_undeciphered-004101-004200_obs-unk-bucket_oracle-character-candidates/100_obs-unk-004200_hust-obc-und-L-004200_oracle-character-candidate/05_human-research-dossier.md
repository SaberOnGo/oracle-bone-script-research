# obs-unk-004200 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/100_obs-unk-004200_h
  ust-obc-und-L-004200_oracle-character-candidate/03_visual-assets/001_asset
  -005793_hust-obc-und-L-004200_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4200/L_？_9147.jpg`
- asset id: `asset-005793`
...
- source class: `HUST-OBC/undeciphered/L/4200/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4200/L_？_9147.jpg`
- asset id: `asset-005793`
...
- English observation: `Upper loop, inner trace, and thin lower stroke visible.`
- 中文观察: `上部圆弧、内部痕迹和下部细笔画可见。`
...
- Which source records identify obs-unk-004200 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004200？
