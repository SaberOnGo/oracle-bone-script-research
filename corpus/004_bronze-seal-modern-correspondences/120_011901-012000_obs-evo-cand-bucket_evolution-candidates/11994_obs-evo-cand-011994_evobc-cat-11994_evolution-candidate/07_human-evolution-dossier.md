...
- External category reference: `evobc-cat-11994`
- Source category ID: `11994`
- Source label for human review: `𦊾`
- Source codepoints: `U+262BE`
...
- `obs-evo-cand-011994-route-category-staging`
...
- `obs-evo-cand-011994-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011994-route-evolution-graph`
