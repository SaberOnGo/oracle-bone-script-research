# obs-char-001255 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1255_obs-char-001255_hust-obc-cat-1403_ora
  cle-character/03_visual-assets/001_asset-001260_hust-obc-cat-1403_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1403/G_1403_甲骨文.png`
- asset id: `asset-001260`
...
- source category: `1403`
- validation class: `1254`
- source image route: `HUST-OBC/deciphered/1403/G_1403_甲骨文.png`
- asset id: `asset-001260`
...
- English observation: `A dense symmetrical form has pointed upper branches,
  a central vertical, side projections, and a pointed lower end.`
- 中文观察: `密集近对称形体有尖状上部分枝、中央竖笔、两侧外伸笔画和尖状下端。`
...
- dataset label text: `㥱`
- dataset label codepoints: `U+3971`
...
- Which source records identify obs-char-001255 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001255？
