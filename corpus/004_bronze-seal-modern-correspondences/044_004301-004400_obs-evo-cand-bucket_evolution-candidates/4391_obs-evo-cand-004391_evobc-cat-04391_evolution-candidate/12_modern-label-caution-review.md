# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004391
...
- EVOBC candidate category: `evobc-evo-cat-04391`.
- Source label for search only: `歫`.
- Source codepoints for search only: `U+6B6B`.
