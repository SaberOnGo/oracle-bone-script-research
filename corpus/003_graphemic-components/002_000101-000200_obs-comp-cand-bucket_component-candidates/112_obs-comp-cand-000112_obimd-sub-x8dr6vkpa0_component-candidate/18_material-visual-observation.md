# Material Visual Observation / obs-comp-cand-000112 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000112`
- External reference / 外部参照: `obimd-sub-x8dr6vkpa0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011524_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/x8dr6vkpa0/x8dr6vkpa0/x8dr6vkpa0.png`
- Checksum / 校验和:
  `37125552090b20cd5b398189cfb9e7dca67e2c7c2177cfc14899a296b0d20557`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 15.28%.
- Marked-pixel bounds: (65,19)–(201,233); span 137 × 215 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占15.28%。
- 痕迹范围：(65,19)–(201,233)；跨度137 × 215 px；痕迹矩形高于宽。
