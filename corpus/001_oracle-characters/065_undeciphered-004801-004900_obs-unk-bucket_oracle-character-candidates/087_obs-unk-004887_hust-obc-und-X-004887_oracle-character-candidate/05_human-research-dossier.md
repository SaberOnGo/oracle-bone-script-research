# obs-unk-004887 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004887`
- primary external id: `hust-obc-und-X-004887`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/087_obs-unk-004887_h
  ust-obc-und-X-004887_oracle-character-candidate/03_visual-assets/001_asset
  -006480_hust-obc-und-X-004887_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/443/X_？_7425_1.png`
- asset id: `asset-006480`
...
- source class: `HUST-OBC/undeciphered/X/443/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/443/X_？_7425_1.png`
- asset id: `asset-006480`
...
- English observation: `wide upper enclosure and separated lower group`
- 中文观察: `宽大上部外框和分开的下部结构`
...
- Which source records identify obs-unk-004887 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004887？
