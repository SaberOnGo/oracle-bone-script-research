# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013536
...
- EVOBC candidate category: `evobc-evo-cat-13536`.
- Source label for search only: `𭣽`.
- Source codepoints for search only: `U+2D8FD`.
