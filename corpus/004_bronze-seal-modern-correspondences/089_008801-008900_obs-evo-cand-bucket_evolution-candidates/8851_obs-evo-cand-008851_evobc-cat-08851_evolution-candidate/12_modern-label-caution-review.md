# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008851
...
- EVOBC candidate category: `evobc-evo-cat-08851`.
- Source label for search only: `輬`.
- Source codepoints for search only: `U+8F2C`.
