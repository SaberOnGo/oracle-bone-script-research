...
- External category reference: `evobc-cat-03066`
- Source category ID: `03066`
- Source label for human review: `想`
...
- `obs-evo-cand-003066-route-category-staging`
...
- `obs-evo-cand-003066-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003066-route-evolution-graph`
