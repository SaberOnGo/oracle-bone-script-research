...
Project ID: `obs-evo-cand-001470`
...
- Project ID: `obs-evo-cand-001470`
- EVOBC category candidate ID: `evobc-evo-cat-01470`
- External category reference: `evobc-cat-01470`
- Source category ID: `01470`
- Source label for human review: `口`
- Source codepoints: `U+53E3`
...
- `obs-evo-cand-001470-route-category-staging`
...
- `obs-evo-cand-001470-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001470-route-evolution-graph`
