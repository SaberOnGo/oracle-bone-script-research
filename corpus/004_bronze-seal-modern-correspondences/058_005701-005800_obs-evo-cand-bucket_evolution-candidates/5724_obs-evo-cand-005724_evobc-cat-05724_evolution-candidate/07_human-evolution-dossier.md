...
Project ID: `obs-evo-cand-005724`
...
- Project ID: `obs-evo-cand-005724`
- EVOBC category candidate ID: `evobc-evo-cat-05724`
- External category reference: `evobc-cat-05724`
- Source category ID: `05724`
- Source label for human review: `皕`
- Source codepoints: `U+7695`
...
- `obs-evo-cand-005724-route-category-staging`
...
- `obs-evo-cand-005724-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005724-route-evolution-graph`
