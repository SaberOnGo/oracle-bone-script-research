# Material Visual Observation / obs-comp-cand-001584 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001584`
- External reference / 外部参照: `obimd-sub-j4twkehhui`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017165_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/u878nsmv98/j4twkehhui/j4twkehhui.png`
- Checksum / 校验和:
  `ac5d5d72a30cef5e6e190e21c2b18bd6425c72092acdb6d3e05785c23fe61778`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.79%.
- Marked-pixel bounds: (57,35)–(208,216); span 152 × 182 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.79%。
- 痕迹范围：(57,35)–(208,216)；跨度152 × 182 px；痕迹矩形近方形。
