...
- Project ID: `obs-evo-cand-012665`
- EVOBC category candidate ID: `evobc-evo-cat-12665`
- External category reference: `evobc-cat-12665`
- Source category ID: `12665`
- Source label for human review: `𩦧`
- Source codepoints: `U+299A7`
...
- `obs-evo-cand-012665-route-category-staging`
...
- `obs-evo-cand-012665-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012665-route-evolution-graph`
