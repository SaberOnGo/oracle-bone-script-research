...
- External category reference: `evobc-cat-09750`
- Source category ID: `09750`
- Source label for human review: `陴`
- Source codepoints: `U+9674`
...
- `obs-evo-cand-009750-route-category-staging`
...
- `obs-evo-cand-009750-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009750-route-evolution-graph`
