# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010731
...
- EVOBC candidate category: `evobc-evo-cat-10731`.
- Source label for search only: `齭`.
- Source codepoints for search only: `U+9F6D`.
