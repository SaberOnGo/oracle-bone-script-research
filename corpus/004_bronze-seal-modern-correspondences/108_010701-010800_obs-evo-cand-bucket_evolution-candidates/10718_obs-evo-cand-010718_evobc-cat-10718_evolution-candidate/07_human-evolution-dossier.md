...
- External category reference: `evobc-cat-10718`
- Source category ID: `10718`
- Source label: `齔`
...
- `obs-evo-cand-010718-route-category-staging`
...
- `obs-evo-cand-010718-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010718-route-evolution-graph`
