...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1359`
...
- Source image / 来源图: `G_1359_京津1630合17482.png`
- Image / 图像: `001_asset-001219_hust-obc-cat-1359_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合17482
  (G_1359_京津1630合17482.png)`
...
- target node: `evobc-evo-cat-00123`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00123`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00123`
- EvoBC image references / EvoBC 图像引用数: `6`
...
- Matched candidate folders / 匹配候选目录: `evobc-evo-cat-00123`
- Human review files / 人类复核文件:
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/123_obs-evo-cand-000123_evobc-cat-00123_evoluti
...
- Source label text / 来源标签文字: `㥅`
- Source label codepoint / 来源标签 codepoint: `U+3945`
