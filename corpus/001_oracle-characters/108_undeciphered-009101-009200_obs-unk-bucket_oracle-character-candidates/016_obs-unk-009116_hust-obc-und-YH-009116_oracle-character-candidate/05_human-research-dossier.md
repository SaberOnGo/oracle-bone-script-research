# obs-unk-009116 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/108_undeciphered-009
  101-009200_obs-unk-bucket_oracle-character-candidates/016_obs-unk-009116_h
  ust-obc-und-YH-009116_oracle-character-candidate/03_visual-assets/001_asse
  t-010707_hust-obc-und-YH-009116_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/611F1/H_？_611F1_0.png`
- asset id: `asset-010707`
...
- source class: `HUST-OBC/undeciphered/Y+H/611F1/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/611F1/H_？_611F1_0.png`
- asset id: `asset-010707`
...
- Which source records identify obs-unk-009116 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009116？
