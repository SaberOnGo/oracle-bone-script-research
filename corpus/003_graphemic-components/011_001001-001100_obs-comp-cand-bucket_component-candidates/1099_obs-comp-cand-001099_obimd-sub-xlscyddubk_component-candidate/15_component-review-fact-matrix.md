# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001099
...
| Glyph or codepoint route / 字形或码位路线 | 116 OBIMD route rows; examples U+5409;U+F650E; U+F650F; 另有 114 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 116 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
