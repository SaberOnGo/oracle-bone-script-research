...
Project ID: `obs-evo-cand-008038`
...
- Project ID: `obs-evo-cand-008038`
- EVOBC category candidate ID: `evobc-evo-cat-08038`
- External category reference: `evobc-cat-08038`
- Source category ID: `08038`
- Source label for human review: `襡`
- Source codepoints: `U+8961`
...
- `obs-evo-cand-008038-route-category-staging`
...
- `obs-evo-cand-008038-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008038-route-evolution-graph`
