...
- External category reference: `evobc-cat-10528`
- Source category ID: `10528`
- Source label for human review: `鶠`
- Source codepoints: `U+9DA0`
...
- `obs-evo-cand-010528-route-category-staging`
...
- `obs-evo-cand-010528-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010528-route-evolution-graph`
