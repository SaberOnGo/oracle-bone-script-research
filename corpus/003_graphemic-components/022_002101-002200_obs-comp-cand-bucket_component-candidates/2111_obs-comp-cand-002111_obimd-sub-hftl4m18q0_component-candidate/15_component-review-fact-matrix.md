# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002111
...
| Glyph or codepoint route / 字形或码位路线 | 48 OBIMD route rows; examples U+738B;U+FC2A4; U+FC2A5; 另有 46 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 48 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
