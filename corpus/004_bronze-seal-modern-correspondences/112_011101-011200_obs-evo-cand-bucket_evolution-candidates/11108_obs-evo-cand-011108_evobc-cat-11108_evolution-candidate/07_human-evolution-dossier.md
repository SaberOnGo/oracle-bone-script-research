...
- External category reference: `evobc-cat-11108`
- Source category ID: `11108`
- Source label for human review: `𡴞`
...
- `obs-evo-cand-011108-route-category-staging`
...
- `obs-evo-cand-011108-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011108-route-evolution-graph`
