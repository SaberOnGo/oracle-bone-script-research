# obs-char-000220 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/220_obs-char-000220_hust-obc-cat-0244_orac
  le-character/03_visual-assets/001_asset-000225_hust-obc-cat-0244_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0244/X_0244_2127_1.png`
- asset id: `asset-000225`
...
- source category: `0244`
- validation class: `219`
- source image route: `HUST-OBC/deciphered/0244/X_0244_2127_1.png`
- asset id: `asset-000225`
...
- English observation: `The large image contains two separated angular forms
  with long descending strokes, branching lower ends, and a curved opening
  on the right.`
- 中文观察: `大幅图像含左右分离的两处折角形，带长下行笔、下部分支和右侧弯曲开口。`
...
- dataset label text: `㓪`
- dataset label codepoints: `U+34EA`
...
- Which source records identify obs-char-000220 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000220？
