...
Project ID: `obs-evo-cand-010651`
...
- Project ID: `obs-evo-cand-010651`
- EVOBC category candidate ID: `evobc-evo-cat-10651`
- External category reference: `evobc-cat-10651`
- Source category ID: `10651`
- Source label for human review: `黟`
- Source codepoints: `U+9EDF`
...
- `obs-evo-cand-010651-route-category-staging`
...
- `obs-evo-cand-010651-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010651-route-evolution-graph`
