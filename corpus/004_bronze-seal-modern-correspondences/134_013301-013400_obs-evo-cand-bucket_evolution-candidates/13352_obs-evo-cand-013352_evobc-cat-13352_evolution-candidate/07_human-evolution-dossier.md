...
- External category reference: `evobc-cat-13352`
- Source category ID: `13352`
- Source label for human review: `𬥒`
- Source codepoints: `U+2C952`
...
- `obs-evo-cand-013352-route-category-staging`
...
- `obs-evo-cand-013352-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013352-route-evolution-graph`
