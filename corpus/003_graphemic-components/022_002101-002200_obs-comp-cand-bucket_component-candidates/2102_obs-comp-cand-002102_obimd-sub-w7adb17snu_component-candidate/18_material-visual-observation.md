# Material Visual Observation / obs-comp-cand-002102 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002102`
- External reference / 外部参照: `obimd-sub-w7adb17snu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019553_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/w7adb17snu/w7adb17snu/w7adb17snu.png`
- Checksum / 校验和:
  `8d75023c9ff66966358e9aebc601c169f5b98ad1f43d903fde38a0fb9d21c86d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.01%.
- Marked-pixel bounds: (86,19)–(166,230); span 81 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.01%。
- 痕迹范围：(86,19)–(166,230)；跨度81 × 212 px；痕迹矩形高于宽。
