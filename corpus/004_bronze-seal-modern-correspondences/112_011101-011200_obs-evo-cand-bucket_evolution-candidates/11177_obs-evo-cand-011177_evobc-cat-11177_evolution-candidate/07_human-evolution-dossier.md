...
- Project ID: `obs-evo-cand-011177`
- EVOBC category candidate ID: `evobc-evo-cat-11177`
- External category reference: `evobc-cat-11177`
- Source category ID: `11177`
- Source label for human review: `𢎓`
- Source codepoints: `U+22393`
...
- `obs-evo-cand-011177-route-category-staging`
...
- `obs-evo-cand-011177-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011177-route-evolution-graph`
