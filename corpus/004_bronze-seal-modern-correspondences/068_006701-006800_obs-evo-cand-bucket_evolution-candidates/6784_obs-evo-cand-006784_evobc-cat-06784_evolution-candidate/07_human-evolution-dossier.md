...
- External category reference: `evobc-cat-06784`
- Source category ID: `06784`
- Source label for human review: `缺`
...
- `obs-evo-cand-006784-route-category-staging`
...
- `obs-evo-cand-006784-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006784-route-evolution-graph`
