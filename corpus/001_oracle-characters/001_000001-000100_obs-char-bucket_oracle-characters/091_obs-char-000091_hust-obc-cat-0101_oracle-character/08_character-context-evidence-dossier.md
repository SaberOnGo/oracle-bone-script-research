...
- Project ID / 项目 ID: `obs-char-000091`
- Primary external ID / 首选外部 ID: `hust-obc-cat-0101`
...
- Source image / 来源图: `G_0101_後1.1.2(甲).png`
- Image / 图像: `001_asset-000096_hust-obc-cat-0101_glyph.png`
...
- Source label text / 来源标签文字: `㑛`
- Source label codepoint / 来源标签 codepoint: `U+345B`
