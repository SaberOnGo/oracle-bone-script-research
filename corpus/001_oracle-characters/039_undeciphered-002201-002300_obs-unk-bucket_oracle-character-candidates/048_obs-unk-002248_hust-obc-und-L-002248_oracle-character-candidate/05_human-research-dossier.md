# obs-unk-002248 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/039_undeciphered-002
  201-002300_obs-unk-bucket_oracle-character-candidates/048_obs-unk-002248_h
  ust-obc-und-L-002248_oracle-character-candidate/03_visual-assets/001_asset
  -003841_hust-obc-und-L-002248_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2248/L_？_2819.jpg`
- asset id: `asset-003841`
...
- source class: `HUST-OBC/undeciphered/L/2248/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2248/L_？_2819.jpg`
- asset id: `asset-003841`
...
- Which source records identify obs-unk-002248 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002248？
