# obs-unk-004775 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004775`
- primary external id: `hust-obc-und-X-004775`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/075_obs-unk-004775_h
  ust-obc-und-X-004775_oracle-character-candidate/03_visual-assets/001_asset
  -006368_hust-obc-und-X-004775_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/331/X_？_7315_1.png`
- asset id: `asset-006368`
...
- source class: `HUST-OBC/undeciphered/X/331/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/331/X_？_7315_1.png`
- asset id: `asset-006368`
...
- English observation: `three pale openings and separate lower-left group`
- 中文观察: `三个浅色开口和分离的左下结构`
...
- Which source records identify obs-unk-004775 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004775？
