...
def build_readiness_rows(root: Path) -> list[dict[str, str]]:
    ...
    rows = [
        ...
        make_row(
            ...
            "corpus/006_research-sources-and-bibliography/000_source-registers/001_all-sources-index.csv",
            SOURCE_PIPELINE_PHASE_ACTION_MISSING_EVIDENCE_REVIEW_OUTCOME_WAVE_HANDOFF_ASSIGNMENT_OUTCOME_SOURCE_HANDOFF_CHECKLIST,
            "open_source_pipeline_phase_action_missing_evidence_review_outcome_wave_handoff_assignment_outcome_source_handoff_checklist_then_record_human_gated_source_outcomes",
        ),
        make_row(
            "core-ready-009",
