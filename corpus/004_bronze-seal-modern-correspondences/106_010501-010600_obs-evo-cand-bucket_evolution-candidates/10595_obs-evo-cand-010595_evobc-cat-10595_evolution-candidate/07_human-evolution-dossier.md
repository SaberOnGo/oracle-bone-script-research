...
- External category reference: `evobc-cat-10595`
- Source category ID: `10595`
- Source label for human review: `鹺`
...
- `obs-evo-cand-010595-route-category-staging`
...
- `obs-evo-cand-010595-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010595-route-evolution-graph`
