# obs-char-000057 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/057_obs-char-000057_hust-obc-cat-0066_orac
  le-character/03_visual-assets/001_asset-000062_hust-obc-cat-0066_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0066/X_0066_1090_1.png`
- asset id: `asset-000062`
...
- source category: `0066`
- validation class: `56`
- source image route: `HUST-OBC/deciphered/0066/X_0066_1090_1.png`
- asset id: `asset-000062`
...
- English observation: `The large enclosed form has a broad upper frame,
  side loop-like marks, a central horizontal stroke, and a rounded lower
  bowl.`
...
- dataset label text: `㐸`
- dataset label codepoints: `U+3438`
...
- OBIMD candidate ids / OBIMD 候选 ID: `obimd-main-cand-001148`
- OBIMD external refs / OBIMD 外部引用: `obimd-main-vnscljivvy`
- OBIMD transcription field / OBIMD 转写字段: `㐸`
...
- matched OBIMD main UIDs: `vnscljivvy`
...
- Which source records identify obs-char-000057 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000057？
