# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001694
...
| --- | --- | --- | --- |
| `obimd-glyph-link-026171` | 󀝽󹴙 | `U+C077D;U+F9D19` | `reviewed_metadata_only` |
| `obimd-glyph-link-026172` | 󹴚 | `U+F9D1A` | `reviewed_metadata_only` |
| `obimd-glyph-link-026173` | 󹴛 | `U+F9D1B` | `reviewed_metadata_only` |
