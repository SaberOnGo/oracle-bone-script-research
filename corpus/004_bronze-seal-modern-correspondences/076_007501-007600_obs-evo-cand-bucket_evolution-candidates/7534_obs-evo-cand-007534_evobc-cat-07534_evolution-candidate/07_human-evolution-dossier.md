...
- External category reference: `evobc-cat-07534`
- Source category ID: `07534`
- Source label for human review: `蓮`
- Source codepoints: `U+84EE`
...
- `obs-evo-cand-007534-route-category-staging`
...
- `obs-evo-cand-007534-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007534-route-evolution-graph`
