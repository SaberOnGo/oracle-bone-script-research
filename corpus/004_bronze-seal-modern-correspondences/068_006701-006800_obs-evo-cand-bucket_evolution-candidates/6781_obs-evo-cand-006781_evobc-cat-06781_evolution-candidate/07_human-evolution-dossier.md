...
- External category reference: `evobc-cat-06781`
- Source category ID: `06781`
- Source label for human review: `缩`
- Source codepoints: `U+7F29`
...
- `obs-evo-cand-006781-route-category-staging`
...
- `obs-evo-cand-006781-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006781-route-evolution-graph`
