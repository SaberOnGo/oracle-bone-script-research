# obs-char-001335 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1335_obs-char-001335_hust-obc-cat-1491_ora
  cle-character/03_visual-assets/001_asset-001340_hust-obc-cat-1491_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1491/L_1491_2578.jpg`
- asset id: `asset-001340`
...
- source category: `1491`
- validation class: `1334`
- source image route: `HUST-OBC/deciphered/1491/L_1491_2578.jpg`
- asset id: `asset-001340`
...
- English observation: `A small low-contrast cluster contains repeated
  upright strokes and a compact lower body with indistinct edges.`
...
- dataset label text: `㧉`
- dataset label codepoints: `U+39C9`
...
- Which source records identify obs-char-001335 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001335？
