# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004546
...
- EVOBC candidate category: `evobc-evo-cat-04546`.
- Source label for search only: `沝`.
- Source codepoints for search only: `U+6C9D`.
