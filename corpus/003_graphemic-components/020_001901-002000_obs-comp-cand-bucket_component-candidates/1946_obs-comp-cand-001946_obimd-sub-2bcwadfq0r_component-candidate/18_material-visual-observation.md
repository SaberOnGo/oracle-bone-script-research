# Material Visual Observation / obs-comp-cand-001946 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001946`
- External reference / 外部参照: `obimd-sub-2bcwadfq0r`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018756_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2bcwadfq0r/2bcwadfq0r/2bcwadfq0r.png`
- Checksum / 校验和:
  `7f5d91e6ada063fa1b7ef8dfb3422c32b55e94515e9e83f10e743110449734d2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.75%.
- Marked-pixel bounds: (60,15)–(195,235); span 136 × 221 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.75%。
- 痕迹范围：(60,15)–(195,235)；跨度136 × 221 px；痕迹矩形高于宽。
