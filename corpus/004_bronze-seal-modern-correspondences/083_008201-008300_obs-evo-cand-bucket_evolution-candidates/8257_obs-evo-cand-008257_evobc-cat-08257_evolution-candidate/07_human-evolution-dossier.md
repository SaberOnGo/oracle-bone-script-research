...
- External category reference: `evobc-cat-08257`
- Source category ID: `08257`
- Source label for human review: `諀`
...
- `obs-evo-cand-008257-route-category-staging`
...
- `obs-evo-cand-008257-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008257-route-evolution-graph`
