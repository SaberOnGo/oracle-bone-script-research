...
- External category reference: `evobc-cat-01864`
- Source category ID: `01864`
- Source label for human review: `垫`
...
- `obs-evo-cand-001864-route-category-staging`
...
- `obs-evo-cand-001864-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001864-route-evolution-graph`
