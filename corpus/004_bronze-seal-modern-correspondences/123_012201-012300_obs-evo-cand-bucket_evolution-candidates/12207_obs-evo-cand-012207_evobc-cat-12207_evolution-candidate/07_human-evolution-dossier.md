...
- External category reference: `evobc-cat-12207`
- Source category ID: `12207`
- Source label for human review: `𧠟`
- Source codepoints: `U+2781F`
...
- `obs-evo-cand-012207-route-category-staging`
...
- `obs-evo-cand-012207-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012207-route-evolution-graph`
