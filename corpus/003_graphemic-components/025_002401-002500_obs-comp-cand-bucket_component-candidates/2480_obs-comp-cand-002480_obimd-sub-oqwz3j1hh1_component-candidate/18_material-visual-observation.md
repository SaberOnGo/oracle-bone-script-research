# Material Visual Observation / obs-comp-cand-002480 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002480`
- External reference / 外部参照: `obimd-sub-oqwz3j1hh1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020665_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/oqwz3j1hh1/oqwz3j1hh1/86lz6gw7mq.png`
- Checksum / 校验和:
  `53bcab82155599aa4c6dccb3826f07400f946432fbf4b68cda843c10801508c7`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.18%.
- Marked-pixel bounds: (61,55)–(188,226); span 128 × 172 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.18%。
- 痕迹范围：(61,55)–(188,226)；跨度128 × 172 px；痕迹矩形高于宽。
