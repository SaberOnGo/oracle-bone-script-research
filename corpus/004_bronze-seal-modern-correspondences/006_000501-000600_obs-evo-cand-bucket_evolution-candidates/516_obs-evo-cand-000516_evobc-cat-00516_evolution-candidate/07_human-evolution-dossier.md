...
- External category reference: `evobc-cat-00516`
- Source category ID: `00516`
- Source label for human review: `䦑`
- Source codepoints: `U+4991`
...
- `obs-evo-cand-000516-route-category-staging`
...
- `obs-evo-cand-000516-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000516-route-evolution-graph`
