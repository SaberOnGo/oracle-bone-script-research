# obs-unk-006461 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006461`
- primary external id: `hust-obc-und-X-006461`
...
- local review image route: `corpus/001_oracle-characters/081_undeciphered-006
  401-006500_obs-unk-bucket_oracle-character-candidates/061_obs-unk-006461_h
  ust-obc-und-X-006461_oracle-character-candidate/03_visual-assets/001_asset
  -008052_hust-obc-und-X-006461_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2017/X_？_5661_1.png`
- asset id: `asset-008052`
...
- source class: `HUST-OBC/undeciphered/X/2017/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2017/X_？_5661_1.png`
- asset id: `asset-008052`
...
- Which source records identify obs-unk-006461 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006461？
