...
- `obs-evo-cand-006793-route-category-staging`
...
- `obs-evo-cand-006793-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006793-route-evolution-graph`
