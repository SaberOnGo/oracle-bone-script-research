...
- External category reference: `evobc-cat-10702`
- Source category ID: `10702`
- Source label for human review: `鼷`
- Source codepoints: `U+9F37`
...
- `obs-evo-cand-010702-route-category-staging`
...
- `obs-evo-cand-010702-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010702-route-evolution-graph`
