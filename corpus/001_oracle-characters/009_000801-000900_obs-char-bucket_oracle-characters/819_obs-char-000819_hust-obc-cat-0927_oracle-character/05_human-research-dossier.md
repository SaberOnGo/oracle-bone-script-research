# obs-char-000819 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000819`
- primary external id: `hust-obc-cat-0927`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/819_obs-char-000819_hust-obc-cat-0927_orac
  le-character/03_visual-assets/001_asset-000824_hust-obc-cat-0927_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0927/G_0927_前5.40.3(甲).png`
- asset id: `asset-000824`
...
- source category: `0927`
- validation class: `818`
- source image route: `HUST-OBC/deciphered/0927/G_0927_前5.40.3(甲).png`
- asset id: `asset-000824`
...
- English observation: `A diagonal stem runs from upper left to lower right
  with short side strokes at several levels and pointed ends.`
- 中文观察: `一条斜向笔干并从上左延向下右，不同高度处分出短侧笔，多处收为尖端。`
...
- dataset label text: `㞕`
- dataset label codepoints: `U+3795`
...
- Which source records identify obs-char-000819 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000819？
