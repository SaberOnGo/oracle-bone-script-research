...
- External category reference: `evobc-cat-09356`
- Source category ID: `09356`
- Source label for human review: `鉊`
...
- `obs-evo-cand-009356-route-category-staging`
...
- `obs-evo-cand-009356-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009356-route-evolution-graph`
