# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001329
...
| --- | --- | --- | --- |
| `obimd-glyph-link-019819` | 򲤝󷣬 | `U+B291D;U+F78EC` | `reviewed_metadata_only` |
| `obimd-glyph-link-019820` | 󷣭 | `U+F78ED` | `reviewed_metadata_only` |
