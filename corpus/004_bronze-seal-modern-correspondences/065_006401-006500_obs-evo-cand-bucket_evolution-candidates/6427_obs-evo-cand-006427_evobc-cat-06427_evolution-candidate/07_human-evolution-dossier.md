...
Project ID: `obs-evo-cand-006427`
...
- Project ID: `obs-evo-cand-006427`
- EVOBC category candidate ID: `evobc-evo-cat-06427`
- External category reference: `evobc-cat-06427`
- Source category ID: `06427`
- Source label for human review: `糝`
- Source codepoints: `U+7CDD`
...
- `obs-evo-cand-006427-route-category-staging`
...
- `obs-evo-cand-006427-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006427-route-evolution-graph`
