...
- External category reference: `evobc-cat-05816`
- Source category ID: `05816`
- Source label for human review: `眽`
...
- `obs-evo-cand-005816-route-category-staging`
...
- `obs-evo-cand-005816-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005816-route-evolution-graph`
