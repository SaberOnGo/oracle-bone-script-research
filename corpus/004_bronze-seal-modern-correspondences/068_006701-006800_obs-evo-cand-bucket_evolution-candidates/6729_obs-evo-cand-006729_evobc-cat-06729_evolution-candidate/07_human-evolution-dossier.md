...
Project ID: `obs-evo-cand-006729`
...
- Project ID: `obs-evo-cand-006729`
- EVOBC category candidate ID: `evobc-evo-cat-06729`
- External category reference: `evobc-cat-06729`
- Source category ID: `06729`
- Source label for human review: `纲`
- Source codepoints: `U+7EB2`
...
- `obs-evo-cand-006729-route-category-staging`
...
- `obs-evo-cand-006729-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006729-route-evolution-graph`
