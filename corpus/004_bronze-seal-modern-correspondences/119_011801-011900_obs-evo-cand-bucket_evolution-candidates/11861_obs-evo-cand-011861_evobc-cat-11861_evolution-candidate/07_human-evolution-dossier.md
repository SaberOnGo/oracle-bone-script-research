...
- External category reference: `evobc-cat-11861`
- Source category ID: `11861`
- Source label for human review: `𥩻`
- Source codepoints: `U+25A7B`
...
- `obs-evo-cand-011861-route-category-staging`
...
- `obs-evo-cand-011861-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011861-route-evolution-graph`
