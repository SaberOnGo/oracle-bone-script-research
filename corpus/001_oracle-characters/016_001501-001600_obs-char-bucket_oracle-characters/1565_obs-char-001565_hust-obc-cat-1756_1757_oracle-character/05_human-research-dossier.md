# obs-char-001565 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001565`
- primary external id: `hust-obc-cat-1756_1757`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1565_obs-char-001565_hust-obc-cat-1756_175
  7_oracle-character/03_visual-assets/001_asset-001570_hust-obc-cat-1756_175
  7_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1756_1757/1756/G_1756_後2.6.14(甲
  ).png`
- asset id: `asset-001570`
...
- source category: `1756_1757`
- validation class: `1564`
- source image route: `HUST-OBC/deciphered/1756_1757/1756/G_1756_後2.6.14(甲).pn
  g`
- asset id: `asset-001570`
...
- English observation: `Two adjacent forms show a segmented rounded loop on
  the left and a smaller curved form on the right.`
- 中文观察: `两个相邻形体左侧有分段圆折环，右侧有较小弧形形体。`
...
- dataset label text: `㫒㫓`
- dataset label codepoints: `U+3AD2;U+3AD3`
...
- graph edge count: `2`
- codepoint routes: `U+3AD2;U+3AD3`
...
- Which source records identify obs-char-001565 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001565？
