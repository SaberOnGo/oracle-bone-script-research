# Material Visual Observation / obs-comp-cand-001362 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001362`
- External reference / 外部参照: `obimd-sub-0bcpbg0geh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015781_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0bcpbg0geh/0bcpbg0geh/0bcpbg0geh.png`
- Checksum / 校验和:
  `3ffffa3969c50092f950f3afbefa1a60b59f311ef2dad6704230ffa3728e3f05`
...
- Marked-pixel bounds: (57,23)–(197,227); span 141 × 205 px; the marked
...
- 痕迹范围：(57,23)–(197,227)；跨度141 × 205 px；痕迹矩形高于宽。
