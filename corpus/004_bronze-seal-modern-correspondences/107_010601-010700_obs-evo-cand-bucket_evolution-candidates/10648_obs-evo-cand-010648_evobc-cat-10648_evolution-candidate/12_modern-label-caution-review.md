# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010648
...
- EVOBC candidate category: `evobc-evo-cat-10648`.
- Source label for search only: `黜`.
- Source codepoints for search only: `U+9EDC`.
