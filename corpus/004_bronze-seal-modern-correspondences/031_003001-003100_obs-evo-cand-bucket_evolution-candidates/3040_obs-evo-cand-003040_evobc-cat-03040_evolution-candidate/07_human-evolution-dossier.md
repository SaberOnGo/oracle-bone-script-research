...
- External category reference: `evobc-cat-03040`
- Source category ID: `03040`
- Source label for human review: `惇`
- Source codepoints: `U+60C7`
...
- `obs-evo-cand-003040-route-category-staging`
...
- `obs-evo-cand-003040-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003040-route-evolution-graph`
