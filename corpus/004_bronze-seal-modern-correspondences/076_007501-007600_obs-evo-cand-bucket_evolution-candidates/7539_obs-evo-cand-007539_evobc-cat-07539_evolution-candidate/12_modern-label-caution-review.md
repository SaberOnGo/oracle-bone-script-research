# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-007539
...
- EVOBC candidate category: `evobc-evo-cat-07539`.
- Source label for search only: `蓶`.
- Source codepoints for search only: `U+84F6`.
