# obs-xwalk-cand-000875 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+37D1` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-0987` | not reading |
