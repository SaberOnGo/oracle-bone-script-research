...
- Project ID: `obs-evo-cand-006048`
- EVOBC category candidate ID: `evobc-evo-cat-06048`
- External category reference: `evobc-cat-06048`
- Source category ID: `06048`
- Source label for human review: `禿`
- Source codepoints: `U+79BF`
...
- `obs-evo-cand-006048-route-category-staging`
...
- `obs-evo-cand-006048-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006048-route-evolution-graph`
