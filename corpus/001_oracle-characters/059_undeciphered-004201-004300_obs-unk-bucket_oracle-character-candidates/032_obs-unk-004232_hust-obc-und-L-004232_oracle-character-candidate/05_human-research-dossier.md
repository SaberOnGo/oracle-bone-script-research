# obs-unk-004232 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004232`
- primary external id: `hust-obc-und-L-004232`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/032_obs-unk-004232_h
  ust-obc-und-L-004232_oracle-character-candidate/03_visual-assets/001_asset
  -005825_hust-obc-und-L-004232_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4232/L_？_9294.jpg`
- asset id: `asset-005825`
...
- source class: `HUST-OBC/undeciphered/L/4232/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4232/L_？_9294.jpg`
- asset id: `asset-005825`
...
- English observation: `Left outline, rounded trace, lower diagonal visible.`
- 中文观察: `左侧轮廓、右侧圆弧痕迹和下部斜笔画可见。`
...
- Which source records identify obs-unk-004232 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004232？
