...
- External category reference: `evobc-cat-10261`
- Source category ID: `10261`
- Source label for human review: `驠`
- Source codepoints: `U+9A60`
...
- `obs-evo-cand-010261-route-category-staging`
...
- `obs-evo-cand-010261-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010261-route-evolution-graph`
