...
Project ID: `obs-evo-cand-001120`
...
- Project ID: `obs-evo-cand-001120`
- EVOBC category candidate ID: `evobc-evo-cat-01120`
- External category reference: `evobc-cat-01120`
- Source category ID: `01120`
- Source label for human review: `冕`
- Source codepoints: `U+5195`
...
- `obs-evo-cand-001120-route-category-staging`
...
- `obs-evo-cand-001120-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001120-route-evolution-graph`
