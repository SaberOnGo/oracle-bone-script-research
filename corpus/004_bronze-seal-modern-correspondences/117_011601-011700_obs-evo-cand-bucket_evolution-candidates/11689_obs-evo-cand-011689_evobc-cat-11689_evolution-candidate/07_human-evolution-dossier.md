...
- External category reference: `evobc-cat-11689`
- Source category ID: `11689`
- Source label: `𤶀`
...
- `obs-evo-cand-011689-route-category-staging`
...
- `obs-evo-cand-011689-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011689-route-evolution-graph`
