# obs-char-000978 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000978`
- primary external id: `hust-obc-cat-1098`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/978_obs-char-000978_hust-obc-cat-1098_orac
  le-character/03_visual-assets/001_asset-000983_hust-obc-cat-1098_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1098/G_1098_甲骨文0.png`
- asset id: `asset-000983`
...
- source category: `1098`
- validation class: `977`
- source image route: `HUST-OBC/deciphered/1098/G_1098_甲骨文0.png`
- asset id: `asset-000983`
...
- English observation: `A broad rounded enclosure contains a horizontal
  interior band, with a right outer curve and a lower stem.`
- 中文观察: `宽大圆弧闭合轮廓含内部横向带状笔，右侧有外弯笔，下方接笔干。`
...
- dataset label text: `㡀`
- dataset label codepoints: `U+3840`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00091`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00091`
- EvoBC image reference count / EvoBC 图像引用数: `11`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00091`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/091_obs-evo-can
  d-000091_evobc-cat-00091_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/091_obs-evo-cand-000091_evobc-cat-00091_evolu
...
- Which source records identify obs-char-000978 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000978？
