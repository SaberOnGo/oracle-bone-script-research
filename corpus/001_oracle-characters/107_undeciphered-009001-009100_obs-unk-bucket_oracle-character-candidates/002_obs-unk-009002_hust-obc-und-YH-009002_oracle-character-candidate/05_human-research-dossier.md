# obs-unk-009002 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-009002`
- primary external id: `hust-obc-und-YH-009002`
...
- local review image route: `corpus/001_oracle-characters/107_undeciphered-009
  001-009100_obs-unk-bucket_oracle-character-candidates/002_obs-unk-009002_h
  ust-obc-und-YH-009002_oracle-character-candidate/03_visual-assets/001_asse
  t-010593_hust-obc-und-YH-009002_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6103E/Y_？_6103E.jpg`
- asset id: `asset-010593`
...
- source class: `HUST-OBC/undeciphered/Y+H/6103E/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6103E/Y_？_6103E.jpg`
- asset id: `asset-010593`
...
- Which source records identify obs-unk-009002 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009002？
