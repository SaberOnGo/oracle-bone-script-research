...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0502`
...
- Source image / 来源图: `H_0502_60284_0.png`
- Image / 图像: `001_asset-000447_hust-obc-cat-0502_glyph.png`
...
- target node: `evobc-evo-cat-00037`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/037_obs-evo-cand-000037_evobc-cat-00037_evoluti
...
- Source label text / 来源标签文字: `㗬`
- Source label codepoint / 来源标签 codepoint: `U+35EC`
