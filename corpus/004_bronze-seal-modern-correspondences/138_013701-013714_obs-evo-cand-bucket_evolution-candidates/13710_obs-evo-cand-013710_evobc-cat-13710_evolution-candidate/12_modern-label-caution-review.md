# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013710
...
- EVOBC candidate category: `evobc-evo-cat-13710`.
- Source label for search only: `廓`.
- Source codepoints for search only: `U+FA0B`.
