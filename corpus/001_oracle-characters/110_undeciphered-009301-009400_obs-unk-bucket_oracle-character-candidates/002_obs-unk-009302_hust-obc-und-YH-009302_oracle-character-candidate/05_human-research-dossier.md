# obs-unk-009302 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-009302`
- primary external id: `hust-obc-und-YH-009302`
...
- local review image route: `corpus/001_oracle-characters/110_undeciphered-009
  301-009400_obs-unk-bucket_oracle-character-candidates/002_obs-unk-009302_h
  ust-obc-und-YH-009302_oracle-character-candidate/03_visual-assets/001_asse
  t-010893_hust-obc-und-YH-009302_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6161A/H_？_6161A_0.png`
- asset id: `asset-010893`
...
- source class: `HUST-OBC/undeciphered/Y+H/6161A/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6161A/H_？_6161A_0.png`
- asset id: `asset-010893`
...
- Which source records identify obs-unk-009302 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009302？
