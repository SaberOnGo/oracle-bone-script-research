# Material Visual Observation / obs-comp-cand-001856 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001856`
- External reference / 外部参照: `obimd-sub-reqn09rgft`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018235_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/reqn09rgft/reqn09rgft/reqn09rgft.png`
- Checksum / 校验和:
  `f69c475bc07503dee1155e862be1468318f0b935ad39ee450ab08424b4be4dab`
...
- Marked-pixel bounds: (79,22)–(177,225); span 99 × 204 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.15%。
- 痕迹范围：(79,22)–(177,225)；跨度99 × 204 px；痕迹矩形高于宽。
