...
- External category reference: `evobc-cat-11873`
- Source category ID: `11873`
- Source label for human review: `𥬄`
...
- `obs-evo-cand-011873-route-category-staging`
...
- `obs-evo-cand-011873-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011873-route-evolution-graph`
