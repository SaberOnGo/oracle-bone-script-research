# Material Visual Observation / obs-comp-cand-001442 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001442`
- External reference / 外部参照: `obimd-sub-o3uagweguf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016019_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/o3uagweguf/o3uagweguf/o3uagweguf.png`
- Checksum / 校验和:
  `3c09b384b3a50bf1a90ff00cd0a0468cfd95e04f49b920ee08cbe420436fd245`
...
- Marked-pixel bounds: (83,26)–(166,220); span 84 × 195 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.63%。
- 痕迹范围：(83,26)–(166,220)；跨度84 × 195 px；痕迹矩形高于宽。
