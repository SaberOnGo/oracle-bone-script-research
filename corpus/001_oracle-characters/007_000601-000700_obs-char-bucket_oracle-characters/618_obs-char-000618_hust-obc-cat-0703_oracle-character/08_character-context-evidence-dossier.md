...
- Project ID / 项目 ID: `obs-char-000618`
- Primary external ID / 首选外部 ID: `hust-obc-cat-0703`
...
- Source image / 来源图: `G_0703_乙346合20875.png`
- Image / 图像: `001_asset-000623_hust-obc-cat-0703_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合20875
  (G_0703_乙346合20875.png)`
...
- target node: `evobc-evo-cat-00048`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00048`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00048`
- EvoBC image references / EvoBC 图像引用数: `25`
...
- Matched candidate folders / 匹配候选目录: `evobc-evo-cat-00048`
- Human review files / 人类复核文件:
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/048_obs-evo-cand-000048_evobc-cat-00048_evoluti
...
- Matched OBIMD main UIDs / OBIMD 主字 UID: `none`
...
- Source label text / 来源标签文字: `㚵`
- Source label codepoint / 来源标签 codepoint: `U+36B5`
- Cross-source status / 跨来源状态: matched_evobc_by_codepoint
