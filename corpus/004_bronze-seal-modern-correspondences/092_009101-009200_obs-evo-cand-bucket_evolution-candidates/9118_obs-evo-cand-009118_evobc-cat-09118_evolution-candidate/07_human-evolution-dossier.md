...
- External category reference: `evobc-cat-09118`
- Source category ID: `09118`
- Source label for human review: `邺`
- Source codepoints: `U+90BA`
...
- `obs-evo-cand-009118-route-category-staging`
...
- `obs-evo-cand-009118-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009118-route-evolution-graph`
