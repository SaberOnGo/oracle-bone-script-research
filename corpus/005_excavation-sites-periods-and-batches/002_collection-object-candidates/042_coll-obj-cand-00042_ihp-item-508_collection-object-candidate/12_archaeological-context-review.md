# Archaeological Context Review / 考古语境复核: coll-obj-cand-00042
...
The live page, source description, and private visual route are recorded in
...
| Source item | `508` | `01_collection-object-packet.json` |
| Catalog description | `I 0867` | `01_collection-object-packet.json` |
