# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000988
...
| --- | --- | --- | --- |
| `obimd-glyph-link-014310` | 󵧍 | `U+F59CD` | `reviewed_metadata_only` |
| `obimd-glyph-link-014311` | 󵧎 | `U+F59CE` | `reviewed_metadata_only` |
