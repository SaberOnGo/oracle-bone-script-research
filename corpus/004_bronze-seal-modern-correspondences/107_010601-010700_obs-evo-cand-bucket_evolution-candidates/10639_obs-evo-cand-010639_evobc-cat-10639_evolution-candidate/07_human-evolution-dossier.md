...
Project ID: `obs-evo-cand-010639`
...
- Project ID: `obs-evo-cand-010639`
- EVOBC category candidate ID: `evobc-evo-cat-10639`
- External category reference: `evobc-cat-10639`
- Source category ID: `10639`
- Source label for human review: `黎`
- Source codepoints: `U+9ECE`
...
- `obs-evo-cand-010639-route-category-staging`
...
- `obs-evo-cand-010639-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010639-route-evolution-graph`
