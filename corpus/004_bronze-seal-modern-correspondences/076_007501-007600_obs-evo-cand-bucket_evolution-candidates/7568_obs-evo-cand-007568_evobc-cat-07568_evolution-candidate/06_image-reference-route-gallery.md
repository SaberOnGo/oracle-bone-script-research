...
- `obs-evo-cand-007568-route-category-staging`
...
- `obs-evo-cand-007568-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007568-route-evolution-graph`
