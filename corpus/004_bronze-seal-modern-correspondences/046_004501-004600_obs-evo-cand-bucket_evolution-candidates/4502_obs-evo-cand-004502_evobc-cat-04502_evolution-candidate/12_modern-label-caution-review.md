# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004502
...
- EVOBC candidate category: `evobc-evo-cat-04502`.
- Source label for search only: `江`.
- Source codepoints for search only: `U+6C5F`.
