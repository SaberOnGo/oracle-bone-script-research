...
Project ID: `obs-evo-cand-013040`
...
- Project ID: `obs-evo-cand-013040`
- EVOBC category candidate ID: `evobc-evo-cat-13040`
- External category reference: `evobc-cat-13040`
- Source category ID: `13040`
- Source label for human review: `𫨏`
- Source codepoints: `U+2BA0F`
...
- `obs-evo-cand-013040-route-category-staging`
...
- `obs-evo-cand-013040-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013040-route-evolution-graph`
