...
- External category reference: `evobc-cat-10801`
- Source category ID: `10801`
- Source label for human review: `𠊈`
- Source codepoints: `U+20288`
- Image reference count in source metadata: `5`
...
- `obs-evo-cand-010801-route-category-staging`
...
- `obs-evo-cand-010801-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010801-route-evolution-graph`
