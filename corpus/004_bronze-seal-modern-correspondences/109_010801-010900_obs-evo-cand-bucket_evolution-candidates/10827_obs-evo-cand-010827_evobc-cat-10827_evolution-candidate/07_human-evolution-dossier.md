...
- External category reference: `evobc-cat-10827`
- Source category ID: `10827`
- Source label for human review: `𠑮`
- Source codepoints: `U+2046E`
...
- `obs-evo-cand-010827-route-category-staging`
...
- `obs-evo-cand-010827-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010827-route-evolution-graph`
