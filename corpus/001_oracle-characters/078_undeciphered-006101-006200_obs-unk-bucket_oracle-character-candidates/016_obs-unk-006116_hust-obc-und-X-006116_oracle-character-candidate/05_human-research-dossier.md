# obs-unk-006116 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/078_undeciphered-006
  101-006200_obs-unk-bucket_oracle-character-candidates/016_obs-unk-006116_h
  ust-obc-und-X-006116_oracle-character-candidate/03_visual-assets/001_asset
  -007708_hust-obc-und-X-006116_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1672/X_？_3633_1.png`
- asset id: `asset-007708`
...
- source class: `HUST-OBC/undeciphered/X/1672/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1672/X_？_3633_1.png`
- asset id: `asset-007708`
...
- Which source records identify obs-unk-006116 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006116？
