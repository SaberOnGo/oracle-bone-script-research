...
- External category reference: `evobc-cat-05068`
- Source category ID: `05068`
- Source label for human review: `烘`
- Source codepoints: `U+70D8`
...
- `obs-evo-cand-005068-route-category-staging`
...
- `obs-evo-cand-005068-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005068-route-evolution-graph`
