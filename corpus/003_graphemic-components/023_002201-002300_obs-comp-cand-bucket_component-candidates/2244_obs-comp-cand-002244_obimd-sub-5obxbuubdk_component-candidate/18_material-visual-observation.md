# Material Visual Observation / obs-comp-cand-002244 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002244`
- External reference / 外部参照: `obimd-sub-5obxbuubdk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020057_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5obxbuubdk/5obxbuubdk/5obxbuubdk.png`
- Checksum / 校验和:
  `20d9f9b5eb20474fa39daabba5c88958f224bc1ffee5dd6f34c277ee8982bdbe`
...
- Marked-pixel bounds: (79,23)–(172,220); span 94 × 198 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.23%。
- 痕迹范围：(79,23)–(172,220)；跨度94 × 198 px；痕迹矩形高于宽。
