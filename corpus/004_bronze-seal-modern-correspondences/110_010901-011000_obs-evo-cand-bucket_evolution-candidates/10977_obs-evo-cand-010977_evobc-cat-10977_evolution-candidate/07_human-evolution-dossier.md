...
- Project ID: `obs-evo-cand-010977`
- EVOBC category candidate ID: `evobc-evo-cat-10977`
- External category reference: `evobc-cat-10977`
- Source category ID: `10977`
- Source label for human review: `𡉕`
- Source codepoints: `U+21255`
...
- `obs-evo-cand-010977-route-category-staging`
...
- `obs-evo-cand-010977-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010977-route-evolution-graph`
