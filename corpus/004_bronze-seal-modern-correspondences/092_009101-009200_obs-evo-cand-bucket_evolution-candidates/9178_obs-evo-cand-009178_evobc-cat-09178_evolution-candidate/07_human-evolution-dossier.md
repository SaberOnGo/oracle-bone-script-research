...
Project ID: `obs-evo-cand-009178`
...
- Project ID: `obs-evo-cand-009178`
- EVOBC category candidate ID: `evobc-evo-cat-09178`
- External category reference: `evobc-cat-09178`
- Source category ID: `09178`
- Source label for human review: `鄆`
- Source codepoints: `U+9106`
...
- `obs-evo-cand-009178-route-category-staging`
...
- `obs-evo-cand-009178-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009178-route-evolution-graph`
