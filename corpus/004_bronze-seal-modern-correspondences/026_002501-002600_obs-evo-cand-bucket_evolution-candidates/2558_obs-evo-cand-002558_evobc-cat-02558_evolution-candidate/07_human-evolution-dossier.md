...
Project ID: `obs-evo-cand-002558`
...
- Project ID: `obs-evo-cand-002558`
- EVOBC category candidate ID: `evobc-evo-cat-02558`
- External category reference: `evobc-cat-02558`
- Source category ID: `02558`
- Source label for human review: `峻`
- Source codepoints: `U+5CFB`
...
- `obs-evo-cand-002558-route-category-staging`
...
- `obs-evo-cand-002558-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002558-route-evolution-graph`
