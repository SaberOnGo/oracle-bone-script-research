# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004467
...
- EVOBC candidate category: `evobc-evo-cat-04467`.
- Source label for search only: `氍`.
- Source codepoints for search only: `U+6C0D`.
