# obs-char-000180 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000180`
- primary external id: `hust-obc-cat-0199`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/180_obs-char-000180_hust-obc-cat-0199_orac
  le-character/03_visual-assets/001_asset-000185_hust-obc-cat-0199_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0199/G_0199_乙130合20925𠂤組.png`
- asset id: `asset-000185`
...
- source category: `0199`
- validation class: `179`
- source image route: `HUST-OBC/deciphered/0199/G_0199_乙130合20925𠂤組.png`
- asset id: `asset-000185`
...
- English observation: `The image contains two separate short curved
  vertical strokes with uneven thickness and tapering ends.`
...
- dataset label text: `㒽`
- dataset label codepoints: `U+34BD`
...
- filename catalog route clues: `Heji-like filename clue: 合20925
...
- Which source records identify obs-char-000180 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000180？
