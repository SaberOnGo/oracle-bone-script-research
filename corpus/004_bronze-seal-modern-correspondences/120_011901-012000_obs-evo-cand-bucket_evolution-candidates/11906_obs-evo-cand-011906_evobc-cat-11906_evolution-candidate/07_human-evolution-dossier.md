...
Project ID: `obs-evo-cand-011906`
...
- Project ID: `obs-evo-cand-011906`
- EVOBC category candidate ID: `evobc-evo-cat-11906`
- External category reference: `evobc-cat-11906`
- Source category ID: `11906`
- Source label for human review: `𥵗`
- Source codepoints: `U+25D57`
...
- `obs-evo-cand-011906-route-category-staging`
...
- `obs-evo-cand-011906-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011906-route-evolution-graph`
