...
- Project ID: `obs-evo-cand-006099`
- EVOBC category candidate ID: `evobc-evo-cat-06099`
- External category reference: `evobc-cat-06099`
- Source category ID: `06099`
- Source label for human review: `稘`
- Source codepoints: `U+7A18`
...
- `obs-evo-cand-006099-route-category-staging`
...
- `obs-evo-cand-006099-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006099-route-evolution-graph`
