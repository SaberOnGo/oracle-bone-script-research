# Material Visual Observation / obs-comp-cand-002337 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002337`
- External reference / 外部参照: `obimd-sub-crck62eltz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020356_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/crck62eltz/crck62eltz/crck62eltz.png`
- Checksum / 校验和:
  `5e3758de3966cc5cbeb505595cf29ecf023f55a9d9b0b9b2dde6baee54f8bc4a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.72%.
- Marked-pixel bounds: (83,25)–(171,220); span 89 × 196 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.72%。
- 痕迹范围：(83,25)–(171,220)；跨度89 × 196 px；痕迹矩形高于宽。
