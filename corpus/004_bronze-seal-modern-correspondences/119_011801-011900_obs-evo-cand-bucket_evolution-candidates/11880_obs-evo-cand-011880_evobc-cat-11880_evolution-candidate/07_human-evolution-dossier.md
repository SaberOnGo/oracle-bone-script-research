...
- External category reference: `evobc-cat-11880`
- Source category ID: `11880`
- Source label for human review: `𥮉`
- Source codepoints: `U+25B89`
...
- `obs-evo-cand-011880-route-category-staging`
...
- `obs-evo-cand-011880-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011880-route-evolution-graph`
