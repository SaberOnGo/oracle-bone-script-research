...
- External category reference: `evobc-cat-07823`
- Source category ID: `07823`
- Source label for human review: `蝸`
- Source codepoints: `U+8778`
...
- `obs-evo-cand-007823-route-category-staging`
...
- `obs-evo-cand-007823-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007823-route-evolution-graph`
