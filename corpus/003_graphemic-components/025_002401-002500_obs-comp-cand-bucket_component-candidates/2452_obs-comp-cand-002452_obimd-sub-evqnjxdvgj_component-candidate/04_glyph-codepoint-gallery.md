# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002452
...
| --- | --- | --- | --- |
| `obimd-glyph-link-037646` | 󽾜 | `U+FDF9C` | `reviewed_metadata_only` |
| `obimd-glyph-link-037647` | 󽾝 | `U+FDF9D` | `reviewed_metadata_only` |
| `obimd-glyph-link-037648` | 󽾞 | `U+FDF9E` | `reviewed_metadata_only` |
