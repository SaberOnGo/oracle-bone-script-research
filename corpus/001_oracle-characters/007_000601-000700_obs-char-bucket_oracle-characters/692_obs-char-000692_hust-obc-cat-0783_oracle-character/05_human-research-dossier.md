# obs-char-000692 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000692`
- primary external id: `hust-obc-cat-0783`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/692_obs-char-000692_hust-obc-cat-0783_orac
  le-character/03_visual-assets/001_asset-000697_hust-obc-cat-0783_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0783/G_0783_乙6684合8591賓組.png`
- asset id: `asset-000697`
...
- source category: `0783`
- validation class: `691`
- source image route: `HUST-OBC/deciphered/0783/G_0783_乙6684合8591賓組.png`
- asset id: `asset-000697`
...
- English observation: `A rounded upper outline contains a short horizontal
  mark and rests above a narrow base, from which one long thin stroke curves
  downward to the right.`
- 中文观察: `圆弯上轮廓内含短横痕并位于狭底线上方，一条长细笔从底部向右下弯曲。`
...
- dataset label text: `㜅`
- dataset label codepoints: `U+3705`
...
- filename catalog route clues: `Heji-like filename clue: 合8591
  (G_0783_乙6684合8591賓組.png)`
...
- Which source records identify obs-char-000692 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000692？
