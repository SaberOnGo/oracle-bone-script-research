...
Project ID: `obs-evo-cand-008143`
...
- Project ID: `obs-evo-cand-008143`
- EVOBC category candidate ID: `evobc-evo-cat-08143`
- External category reference: `evobc-cat-08143`
- Source category ID: `08143`
- Source label for human review: `訞`
- Source codepoints: `U+8A1E`
...
- `obs-evo-cand-008143-route-category-staging`
...
- `obs-evo-cand-008143-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008143-route-evolution-graph`
