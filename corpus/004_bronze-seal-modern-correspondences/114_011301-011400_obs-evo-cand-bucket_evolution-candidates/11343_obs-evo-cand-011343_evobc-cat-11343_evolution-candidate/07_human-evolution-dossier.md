...
- External category reference: `evobc-cat-11343`
- Source category ID: `11343`
- Source label for human review: `𢽟`
...
- `obs-evo-cand-011343-route-category-staging`
...
- `obs-evo-cand-011343-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011343-route-evolution-graph`
