...
- External category reference: `evobc-cat-04726`
- Source category ID: `04726`
- Source label for human review: `淤`
...
- `obs-evo-cand-004726-route-category-staging`
...
- `obs-evo-cand-004726-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004726-route-evolution-graph`
