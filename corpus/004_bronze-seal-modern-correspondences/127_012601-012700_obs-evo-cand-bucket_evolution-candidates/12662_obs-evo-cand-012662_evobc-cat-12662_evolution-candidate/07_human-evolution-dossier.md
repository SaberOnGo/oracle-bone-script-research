...
- Project ID: `obs-evo-cand-012662`
- EVOBC category candidate ID: `evobc-evo-cat-12662`
- External category reference: `evobc-cat-12662`
- Source category ID: `12662`
- Source label for human review: `𩦋`
- Source codepoints: `U+2998B`
...
- `obs-evo-cand-012662-route-category-staging`
...
- `obs-evo-cand-012662-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012662-route-evolution-graph`
