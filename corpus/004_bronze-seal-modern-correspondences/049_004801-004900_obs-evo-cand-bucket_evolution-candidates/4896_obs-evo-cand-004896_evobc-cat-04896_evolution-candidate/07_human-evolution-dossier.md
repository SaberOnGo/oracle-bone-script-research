...
- External category reference: `evobc-cat-04896`
- Source category ID: `04896`
- Source label for human review: `潔`
...
- `obs-evo-cand-004896-route-category-staging`
...
- `obs-evo-cand-004896-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004896-route-evolution-graph`
