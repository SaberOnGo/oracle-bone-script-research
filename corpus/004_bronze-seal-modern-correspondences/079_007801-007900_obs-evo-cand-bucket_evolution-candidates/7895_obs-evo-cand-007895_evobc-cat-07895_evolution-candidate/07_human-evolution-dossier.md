...
- External category reference: `evobc-cat-07895`
- Source category ID: `07895`
- Source label for human review: `血`
- Source codepoints: `U+8840`
- Image reference count in source metadata: `109`
...
- `obs-evo-cand-007895-route-category-staging`
...
- `obs-evo-cand-007895-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007895-route-evolution-graph`
