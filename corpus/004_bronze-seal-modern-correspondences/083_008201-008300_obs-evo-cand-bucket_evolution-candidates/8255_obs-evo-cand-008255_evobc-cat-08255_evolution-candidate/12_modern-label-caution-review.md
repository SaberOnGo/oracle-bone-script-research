# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008255
...
- EVOBC candidate category: `evobc-evo-cat-08255`.
- Source label for search only: `誾`.
- Source codepoints for search only: `U+8ABE`.
