...
- External category reference: `evobc-cat-12806`
- Source category ID: `12806`
- Source label for human review: `𪠖`
- Source codepoints: `U+2A816`
...
- `obs-evo-cand-012806-route-category-staging`
...
- `obs-evo-cand-012806-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012806-route-evolution-graph`
