...
- Project ID: `obs-evo-cand-009512`
- EVOBC category candidate ID: `evobc-evo-cat-09512`
- External category reference: `evobc-cat-09512`
- Source category ID: `09512`
- Source label for human review: `鏶`
- Source codepoints: `U+93F6`
...
- `obs-evo-cand-009512-route-category-staging`
...
- `obs-evo-cand-009512-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009512-route-evolution-graph`
