...
- External category reference: `evobc-cat-08501`
- Source category ID: `08501`
- Source label for human review: `豬`
...
- `obs-evo-cand-008501-route-category-staging`
...
- `obs-evo-cand-008501-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008501-route-evolution-graph`
