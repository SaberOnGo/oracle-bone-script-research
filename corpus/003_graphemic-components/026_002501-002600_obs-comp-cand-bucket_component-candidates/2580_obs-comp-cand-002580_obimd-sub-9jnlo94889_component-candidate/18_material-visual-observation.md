# Material Visual Observation / obs-comp-cand-002580 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002580`
- External reference / 外部参照: `obimd-sub-9jnlo94889`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021112_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9jnlo94889/9jnlo94889/79h7onotqx.png`
- Checksum / 校验和:
  `4b4643d1b07f3b196021c4586f1edeb0aa2391eb5f7736aaf122863407f00800`
...
- Marked-pixel bounds: (81,35)–(168,208); span 88 × 174 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.45%。
- 痕迹范围：(81,35)–(168,208)；跨度88 × 174 px；痕迹矩形高于宽。
