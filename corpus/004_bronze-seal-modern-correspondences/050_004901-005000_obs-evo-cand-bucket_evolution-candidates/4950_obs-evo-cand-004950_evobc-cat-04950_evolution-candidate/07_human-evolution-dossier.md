...
Project ID: `obs-evo-cand-004950`
...
- Project ID: `obs-evo-cand-004950`
- EVOBC category candidate ID: `evobc-evo-cat-04950`
- External category reference: `evobc-cat-04950`
- Source category ID: `04950`
- Source label for human review: `澹`
- Source codepoints: `U+6FB9`
...
- `obs-evo-cand-004950-route-category-staging`
...
- `obs-evo-cand-004950-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004950-route-evolution-graph`
