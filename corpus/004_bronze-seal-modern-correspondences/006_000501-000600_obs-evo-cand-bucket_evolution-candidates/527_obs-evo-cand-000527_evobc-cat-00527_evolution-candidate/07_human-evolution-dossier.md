...
- Project ID: `obs-evo-cand-000527`
- EVOBC category candidate ID: `evobc-evo-cat-00527`
- External category reference: `evobc-cat-00527`
- Source category ID: `00527`
- Source label for human review: `䧕`
- Source codepoints: `U+49D5`
...
- `obs-evo-cand-000527-route-category-staging`
...
- `obs-evo-cand-000527-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000527-route-evolution-graph`
