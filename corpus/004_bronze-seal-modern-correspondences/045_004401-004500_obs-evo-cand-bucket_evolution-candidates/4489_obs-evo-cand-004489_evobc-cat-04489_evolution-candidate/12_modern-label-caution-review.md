# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004489
...
- EVOBC candidate category: `evobc-evo-cat-04489`.
- Source label for search only: `汋`.
- Source codepoints for search only: `U+6C4B`.
