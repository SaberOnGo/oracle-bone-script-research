# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000835
...
| Glyph or codepoint route / 字形或码位路线 | 13 OBIMD route rows; examples U+5DF4;U+F4B0C; U+F4B0D; 另有 11 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
