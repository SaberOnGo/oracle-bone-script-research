...
- External category reference: `evobc-cat-05763`
- Source category ID: `05763`
- Source label for human review: `盥`
...
- `obs-evo-cand-005763-route-category-staging`
...
- `obs-evo-cand-005763-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005763-route-evolution-graph`
