...
- External category reference: `evobc-cat-06186`
- Source category ID: `06186`
- Source label for human review: `窻`
- Source codepoints: `U+7ABB`
...
- `obs-evo-cand-006186-route-category-staging`
...
- `obs-evo-cand-006186-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006186-route-evolution-graph`
