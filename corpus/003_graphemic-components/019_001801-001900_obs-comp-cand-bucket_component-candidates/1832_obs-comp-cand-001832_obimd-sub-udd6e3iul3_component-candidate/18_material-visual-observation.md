# Material Visual Observation / obs-comp-cand-001832 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001832`
- External reference / 外部参照: `obimd-sub-udd6e3iul3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018158_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7h3wu2xyyf/udd6e3iul3/udd6e3iul3.png`
- Checksum / 校验和:
  `81b59ad04f338119424c9cf6903cbe93490e7346c64d763cbe4193ff3b442192`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.17%.
- Marked-pixel bounds: (70,26)–(182,226); span 113 × 201 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.17%。
- 痕迹范围：(70,26)–(182,226)；跨度113 × 201 px；痕迹矩形高于宽。
