...
Project ID: `obs-evo-cand-001003`
...
- Project ID: `obs-evo-cand-001003`
- EVOBC category candidate ID: `evobc-evo-cat-01003`
- External category reference: `evobc-cat-01003`
- Source category ID: `01003`
- Source label for human review: `僂`
- Source codepoints: `U+50C2`
...
- `obs-evo-cand-001003-route-category-staging`
...
- `obs-evo-cand-001003-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001003-route-evolution-graph`
