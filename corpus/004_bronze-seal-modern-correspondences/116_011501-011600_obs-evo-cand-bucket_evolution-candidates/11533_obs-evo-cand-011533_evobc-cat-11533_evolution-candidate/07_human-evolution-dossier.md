...
- External category reference: `evobc-cat-11533`
- Source category ID: `11533`
- Source label for human review: `𣻑`
- Source codepoints: `U+23ED1`
...
- `obs-evo-cand-011533-route-category-staging`
...
- `obs-evo-cand-011533-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011533-route-evolution-graph`
