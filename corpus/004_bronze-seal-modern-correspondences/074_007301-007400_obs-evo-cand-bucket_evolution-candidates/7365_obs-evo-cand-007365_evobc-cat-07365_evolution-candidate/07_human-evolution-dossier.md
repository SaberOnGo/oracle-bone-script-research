...
Project ID: `obs-evo-cand-007365`
...
- Project ID: `obs-evo-cand-007365`
- EVOBC category candidate ID: `evobc-evo-cat-07365`
- External category reference: `evobc-cat-07365`
- Source category ID: `07365`
- Source label for human review: `荹`
- Source codepoints: `U+8379`
...
- `obs-evo-cand-007365-route-category-staging`
...
- `obs-evo-cand-007365-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007365-route-evolution-graph`
