...
- Project ID: `obs-evo-cand-000167`
- EVOBC category candidate ID: `evobc-evo-cat-00167`
- External category reference: `evobc-cat-00167`
- Source category ID: `00167`
- Source label for human review: `㭩`
- Source codepoints: `U+3B69`
...
- `obs-evo-cand-000167-route-category-staging`
...
- `obs-evo-cand-000167-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000167-route-evolution-graph`
