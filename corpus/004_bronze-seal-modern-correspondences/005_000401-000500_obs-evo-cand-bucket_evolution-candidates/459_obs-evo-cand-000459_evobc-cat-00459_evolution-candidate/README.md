# obs-evo-cand-000459 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-000459`
- EVOBC category candidate ID: `evobc-evo-cat-00459`
- External category ref: `evobc-cat-00459`
- Source label: `䟴`
- Source codepoints: `U+47F4`
- Image reference count: `15`
- Era token counts: `OBC:15`
- Source token counts: `Book:15`
