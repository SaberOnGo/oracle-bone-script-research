...
- External category reference: `evobc-cat-01329`
- Source category ID: `01329`
- Source label for human review: `匊`
- Source codepoints: `U+530A`
...
- `obs-evo-cand-001329-route-category-staging`
...
- `obs-evo-cand-001329-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001329-route-evolution-graph`
