# obs-char-000682 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000682`
- primary external id: `hust-obc-cat-0773`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/682_obs-char-000682_hust-obc-cat-0773_orac
  le-character/03_visual-assets/001_asset-000687_hust-obc-cat-0773_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0773/G_0773_乙3400合1285賓組.png`
- asset id: `asset-000687`
...
- source category: `0773`
- validation class: `681`
- source image route: `HUST-OBC/deciphered/0773/G_0773_乙3400合1285賓組.png`
- asset id: `asset-000687`
...
- English observation: `A single bold rounded rectangular outer outline
  encloses a broad white field crossed by one thick horizontal inner bar,
  with slightly uneven corners.`
- 中文观察: `单个粗重圆角矩形外框围住宽白区域，内部有一条粗横栏，边角略不齐。`
...
- dataset label text: `㛻`
- dataset label codepoints: `U+36FB`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00059`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00059`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00059`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/059_obs-evo-can
  d-000059_evobc-cat-00059_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/059_obs-evo-cand-000059_evobc-cat-00059_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合1285
  (G_0773_乙3400合1285賓組.png)`
...
- Which source records identify obs-char-000682 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000682？
