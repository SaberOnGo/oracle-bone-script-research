...
- External category reference: `evobc-cat-07932`
- Source category ID: `07932`
- Source label for human review: `衹`
- Source codepoints: `U+8879`
...
- `obs-evo-cand-007932-route-category-staging`
...
- `obs-evo-cand-007932-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007932-route-evolution-graph`
