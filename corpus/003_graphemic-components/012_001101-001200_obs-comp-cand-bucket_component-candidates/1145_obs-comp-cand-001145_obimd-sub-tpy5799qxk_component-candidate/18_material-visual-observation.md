# Material Visual Observation / obs-comp-cand-001145 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001145`
- External reference / 外部参照: `obimd-sub-tpy5799qxk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015280_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tpy5799qxk/tpy5799qxk/tpy5799qxk.png`
- Checksum / 校验和:
  `59593f5c4854d5c6bd8952964005253b1ec8b923bcc46ce370c3368d064c4d15`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.25%.
- Marked-pixel bounds: (91,35)–(158,218); span 68 × 184 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.25%。
- 痕迹范围：(91,35)–(158,218)；跨度68 × 184 px；痕迹矩形高于宽。
