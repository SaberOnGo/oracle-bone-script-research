...
Project ID: `obs-insc-cw-cand-000537`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000537`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000537` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2538` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `342` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `448` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `41761` [route_present_image_or_text_not_collected]
