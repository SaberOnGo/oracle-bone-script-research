# Material Visual Observation / obs-comp-cand-001845 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001845`
- External reference / 外部参照: `obimd-sub-rwa19b0e5y`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018206_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0n73hvtfpr/rwa19b0e5y/rwa19b0e5y.png`
- Checksum / 校验和:
  `090721717603f7fce46c9418367c366eb45ccda3324659adc39724afcd6028c7`
...
- Marked-pixel bounds: (65,50)–(196,207); span 132 × 158 px; the marked
...
- 痕迹范围：(65,50)–(196,207)；跨度132 × 158 px；痕迹矩形近方形。
