# Material Visual Observation / obs-comp-cand-001399 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001399`
- External reference / 外部参照: `obimd-sub-fwbkzsc3sd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015818_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/k2sr7n4ffj/fwbkzsc3sd/fwbkzsc3sd.png`
- Checksum / 校验和:
  `0232504d8be4ac41ed0dd46d8ab81bad0a108d81695b8a8e06904d9430b29810`
...
- Marked-pixel bounds: (68,48)–(181,195); span 114 × 148 px; the marked
...
- 痕迹范围：(68,48)–(181,195)；跨度114 × 148 px；痕迹矩形高于宽。
