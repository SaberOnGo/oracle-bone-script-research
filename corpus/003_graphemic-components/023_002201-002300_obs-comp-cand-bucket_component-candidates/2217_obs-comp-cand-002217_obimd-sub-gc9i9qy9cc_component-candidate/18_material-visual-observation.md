# Material Visual Observation / obs-comp-cand-002217 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002217`
- External reference / 外部参照: `obimd-sub-gc9i9qy9cc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020001_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gc9i9qy9cc/gc9i9qy9cc/gc9i9qy9cc.png`
- Checksum / 校验和:
  `423c41b7cdc00678a690382771be917f67ea35f69f65702ec7f54edfc59f9f6f`
...
- Marked-pixel bounds: (74,37)–(175,207); span 102 × 171 px; the marked
...
- 痕迹范围：(74,37)–(175,207)；跨度102 × 171 px；痕迹矩形高于宽。
