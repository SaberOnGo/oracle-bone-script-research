# obs-comp-cand-001086 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001086`
- 首选外部 ID: `obimd-sub-f1uojpw9ej`
- OBIMD subcharacter UID: `f1uojpw9ej`
- OBIMD main character UID: `f1uojpw9ej`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `8`
- codepoint 示例: U+7518;U+F63CD; U+F63CE; 另有 6 项
