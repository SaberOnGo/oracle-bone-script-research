# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000557
...
- EVOBC candidate category: `evobc-evo-cat-00557`.
- Source label for search only: `䭫`.
- Source codepoints for search only: `U+4B6B`.
