...
Project ID: `obs-evo-cand-004962`
...
- Project ID: `obs-evo-cand-004962`
- EVOBC category candidate ID: `evobc-evo-cat-04962`
- External category reference: `evobc-cat-04962`
- Source category ID: `04962`
- Source label for human review: `濘`
- Source codepoints: `U+6FD8`
...
- `obs-evo-cand-004962-route-category-staging`
...
- `obs-evo-cand-004962-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004962-route-evolution-graph`
