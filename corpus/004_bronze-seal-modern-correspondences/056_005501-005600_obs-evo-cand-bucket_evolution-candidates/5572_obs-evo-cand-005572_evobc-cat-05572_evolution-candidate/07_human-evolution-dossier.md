...
- External category reference: `evobc-cat-05572`
- Source category ID: `05572`
- Source label for human review: `畝`
- Source codepoints: `U+755D`
...
- `obs-evo-cand-005572-route-category-staging`
...
- `obs-evo-cand-005572-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005572-route-evolution-graph`
