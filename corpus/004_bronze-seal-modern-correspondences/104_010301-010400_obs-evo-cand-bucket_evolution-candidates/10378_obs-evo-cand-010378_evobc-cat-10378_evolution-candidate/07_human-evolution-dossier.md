...
- External category reference: `evobc-cat-10378`
- Source category ID: `10378`
- Source label for human review: `魵`
...
- `obs-evo-cand-010378-route-category-staging`
...
- `obs-evo-cand-010378-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010378-route-evolution-graph`
