...
- External category reference: `evobc-cat-11333`
- Source category ID: `11333`
- Source label for human review: `𢼗`
- Source codepoints: `U+22F17`
...
- `obs-evo-cand-011333-route-category-staging`
...
- `obs-evo-cand-011333-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011333-route-evolution-graph`
