# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001745
...
| --- | --- | --- | --- |
| `obimd-glyph-link-026958` | 󺆳 | `U+FA1B3` | `reviewed_metadata_only` |
| `obimd-glyph-link-026959` | 󺆴 | `U+FA1B4` | `reviewed_metadata_only` |
| `obimd-glyph-link-026960` | 󺆵 | `U+FA1B5` | `reviewed_metadata_only` |
