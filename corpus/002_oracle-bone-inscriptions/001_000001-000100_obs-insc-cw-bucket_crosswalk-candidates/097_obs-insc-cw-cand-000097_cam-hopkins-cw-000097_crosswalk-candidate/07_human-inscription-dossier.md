...
Project ID: `obs-insc-cw-cand-000097`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000097`
...
- Yingguo / 英国所藏: `y569` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `107` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `665` in source row; primary catalog entry pending
- Heji / 合集: `39878` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000097`
