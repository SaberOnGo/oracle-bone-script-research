...
- Project ID: `obs-evo-cand-002497`
- EVOBC category candidate ID: `evobc-evo-cat-02497`
- External category reference: `evobc-cat-02497`
- Source category ID: `02497`
- Source label for human review: `居`
- Source codepoints: `U+5C45`
...
- `obs-evo-cand-002497-route-category-staging`
...
- `obs-evo-cand-002497-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002497-route-evolution-graph`
