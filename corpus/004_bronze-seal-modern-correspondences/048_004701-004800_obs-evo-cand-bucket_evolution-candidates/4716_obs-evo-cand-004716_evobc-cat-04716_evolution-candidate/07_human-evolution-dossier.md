...
- External category reference: `evobc-cat-04716`
- Source category ID: `04716`
- Source label for human review: `淒`
...
- `obs-evo-cand-004716-route-category-staging`
...
- `obs-evo-cand-004716-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004716-route-evolution-graph`
