...
- External category reference: `evobc-cat-06655`
- Source category ID: `06655`
- Source label for human review: `縻`
...
- `obs-evo-cand-006655-route-category-staging`
...
- `obs-evo-cand-006655-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006655-route-evolution-graph`
