...
- Project ID: `obs-evo-cand-001203`
- EVOBC category candidate ID: `evobc-evo-cat-01203`
- External category reference: `evobc-cat-01203`
- Source category ID: `01203`
- Source label for human review: `到`
- Source codepoints: `U+5230`
...
- `obs-evo-cand-001203-route-category-staging`
...
- `obs-evo-cand-001203-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001203-route-evolution-graph`
