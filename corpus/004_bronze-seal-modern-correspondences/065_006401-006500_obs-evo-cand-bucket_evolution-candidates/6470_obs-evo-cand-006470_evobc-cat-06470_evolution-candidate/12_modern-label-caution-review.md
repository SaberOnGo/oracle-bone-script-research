# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006470
...
- EVOBC candidate category: `evobc-evo-cat-06470`.
- Source label for search only: `紧`.
- Source codepoints for search only: `U+7D27`.
