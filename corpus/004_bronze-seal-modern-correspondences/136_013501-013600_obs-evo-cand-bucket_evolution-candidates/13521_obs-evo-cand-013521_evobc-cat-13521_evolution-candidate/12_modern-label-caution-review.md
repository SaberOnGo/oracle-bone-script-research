# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013521
...
- EVOBC candidate category: `evobc-evo-cat-13521`.
- Source label for search only: `𭚵`.
- Source codepoints for search only: `U+2D6B5`.
