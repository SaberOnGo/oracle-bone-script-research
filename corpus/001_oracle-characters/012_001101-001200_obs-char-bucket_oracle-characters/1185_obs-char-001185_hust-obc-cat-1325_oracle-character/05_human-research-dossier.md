# obs-char-001185 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1185_obs-char-001185_hust-obc-cat-1325_ora
  cle-character/03_visual-assets/001_asset-001190_hust-obc-cat-1325_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1325/G_1325_乙1937合14207賓組.png`
- asset id: `asset-001190`
...
- source category: `1325`
- validation class: `1184`
- source image route: `HUST-OBC/deciphered/1325/G_1325_乙1937合14207賓組.png`
- asset id: `asset-001190`
...
- English observation: `A broad upper bar joins a central upright and three
  long hanging strokes with short side branches.`
- 中文观察: `宽大的上部横笔连接中央直立笔和三条带短侧枝的长下垂笔。`
...
- dataset label text: `㤣`
- dataset label codepoints: `U+3923`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00116`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00116`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00116`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/116_obs-evo-can
  d-000116_evobc-cat-00116_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/116_obs-evo-cand-000116_evobc-cat-00116_evolu
...
- Which source records identify obs-char-001185 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001185？
