...
Project ID: `obs-evo-cand-010707`
...
- Project ID: `obs-evo-cand-010707`
- EVOBC category candidate ID: `evobc-evo-cat-10707`
- External category reference: `evobc-cat-10707`
- Source category ID: `10707`
- Source label for human review: `齂`
- Source codepoints: `U+9F42`
...
- `obs-evo-cand-010707-route-category-staging`
...
- `obs-evo-cand-010707-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010707-route-evolution-graph`
