...
Project ID: `obs-evo-cand-013218`
...
- Project ID: `obs-evo-cand-013218`
- EVOBC category candidate ID: `evobc-evo-cat-13218`
- External category reference: `evobc-cat-13218`
- Source category ID: `13218`
- Source label for human review: `𬆱`
- Source codepoints: `U+2C1B1`
...
- `obs-evo-cand-013218-route-category-staging`
...
- `obs-evo-cand-013218-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013218-route-evolution-graph`
