...
- `obs-evo-cand-002490-route-category-staging`
...
- `obs-evo-cand-002490-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002490-route-evolution-graph`
