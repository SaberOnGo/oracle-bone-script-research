# obs-unk-004233 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004233`
- primary external id: `hust-obc-und-L-004233`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/033_obs-unk-004233_h
  ust-obc-und-L-004233_oracle-character-candidate/03_visual-assets/001_asset
  -005826_hust-obc-und-L-004233_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4233/L_？_9295.jpg`
- asset id: `asset-005826`
...
- source class: `HUST-OBC/undeciphered/L/4233/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4233/L_？_9295.jpg`
- asset id: `asset-005826`
...
- English observation: `Upper cluster, right trace, crossings visible.`
- 中文观察: `上部痕迹簇、右侧下伸痕迹和交叉笔画可见。`
...
- Which source records identify obs-unk-004233 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004233？
