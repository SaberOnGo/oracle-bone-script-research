...
Project ID: `obs-evo-cand-008970`
...
- Project ID: `obs-evo-cand-008970`
- EVOBC category candidate ID: `evobc-evo-cat-08970`
- External category reference: `evobc-cat-08970`
- Source category ID: `08970`
- Source label for human review: `迵`
- Source codepoints: `U+8FF5`
...
- `obs-evo-cand-008970-route-category-staging`
...
- `obs-evo-cand-008970-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008970-route-evolution-graph`
