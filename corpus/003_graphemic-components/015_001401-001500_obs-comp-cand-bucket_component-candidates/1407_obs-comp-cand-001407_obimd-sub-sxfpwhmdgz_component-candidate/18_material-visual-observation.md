# Material Visual Observation / obs-comp-cand-001407 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001407`
- External reference / 外部参照: `obimd-sub-sxfpwhmdgz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015826_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/v34viqk9rx/sxfpwhmdgz/sxfpwhmdgz.png`
- Checksum / 校验和:
  `9da8898a96fbe86a7bbb9a4787dfddf2947e0af3e6402030d258fc47326ad2ef`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 14.32%.
- Marked-pixel bounds: (63,22)–(195,225); span 133 × 204 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占14.32%。
- 痕迹范围：(63,22)–(195,225)；跨度133 × 204 px；痕迹矩形高于宽。
