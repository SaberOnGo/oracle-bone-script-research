# obs-evo-cand-006481 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-006481`
- EVOBC category candidate ID: `evobc-evo-cat-06481`
- External category ref: `evobc-cat-06481`
- Source label: `紷`
- Source codepoints: `U+7D37`
- Image reference count: `22`
- Era token counts: `BI:1;OBC:21`
- Source token counts: `Book:14;Web:8`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 21 image references
