...
- `obs-evo-cand-001508-route-category-staging`
...
- `obs-evo-cand-001508-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001508-route-evolution-graph`
