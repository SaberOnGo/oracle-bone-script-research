# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001024
...
| Glyph or codepoint route / 字形或码位路线 | 12 OBIMD route rows; examples U+BD834;U+F5CBD; U+F5CBE; 另有 10 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 12 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
