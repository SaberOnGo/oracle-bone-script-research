...
- External category reference: `evobc-cat-07092`
- Source category ID: `07092`
- Source label for human review: `腏`
- Source codepoints: `U+814F`
...
- `obs-evo-cand-007092-route-category-staging`
...
- `obs-evo-cand-007092-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007092-route-evolution-graph`
