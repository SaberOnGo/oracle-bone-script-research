# obs-char-001352 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1352_obs-char-001352_hust-obc-cat-1509_ora
  cle-character/03_visual-assets/001_asset-001357_hust-obc-cat-1509_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1509/G_1509_乙12合21021𠂤組.png`
- asset id: `asset-001357`
...
- source category: `1509`
- validation class: `1351`
- source image route: `HUST-OBC/deciphered/1509/G_1509_乙12合21021𠂤組.png`
- asset id: `asset-001357`
...
- English observation: `A narrow branching form has an upper fork, a central
  diagonal, and a pointed lower crossing.`
- 中文观察: `狭长分枝形体有上部叉形、中央斜笔和尖状下部交叉笔。`
...
- dataset label text: `㧛`
- dataset label codepoints: `U+39DB`
...
- Which source records identify obs-char-001352 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001352？
