# obs-unk-003863 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003863`
- primary external id: `hust-obc-und-L-003863`
...
- local review image route: `corpus/001_oracle-characters/055_undeciphered-003
  801-003900_obs-unk-bucket_oracle-character-candidates/063_obs-unk-003863_h
  ust-obc-und-L-003863_oracle-character-candidate/03_visual-assets/001_asset
  -005456_hust-obc-und-L-003863_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3863/L_？_8101.jpg`
- asset id: `asset-005456`
...
- source class: `HUST-OBC/undeciphered/L/3863/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3863/L_？_8101.jpg`
- asset id: `asset-005456`
...
- Which source records identify obs-unk-003863 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003863？
