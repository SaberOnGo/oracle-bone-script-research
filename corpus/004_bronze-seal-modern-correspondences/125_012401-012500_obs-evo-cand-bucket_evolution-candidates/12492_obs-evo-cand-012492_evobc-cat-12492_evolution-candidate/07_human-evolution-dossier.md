...
Project ID: `obs-evo-cand-012492`
...
- Project ID: `obs-evo-cand-012492`
- EVOBC category candidate ID: `evobc-evo-cat-12492`
- External category reference: `evobc-cat-12492`
- Source category ID: `12492`
- Source label for human review: `𨬗`
- Source codepoints: `U+28B17`
...
- `obs-evo-cand-012492-route-category-staging`
...
- `obs-evo-cand-012492-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012492-route-evolution-graph`
