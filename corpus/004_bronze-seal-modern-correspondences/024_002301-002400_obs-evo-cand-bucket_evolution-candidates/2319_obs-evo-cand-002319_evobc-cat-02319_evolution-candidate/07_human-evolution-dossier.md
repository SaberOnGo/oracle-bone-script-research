...
- External category reference: `evobc-cat-02319`
- Source category ID: `02319`
- Source label for human review: `孃`
- Source codepoints: `U+5B43`
...
- `obs-evo-cand-002319-route-category-staging`
...
- `obs-evo-cand-002319-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002319-route-evolution-graph`
