# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002270
...
| --- | --- | --- | --- |
| `obimd-glyph-link-035116` | 童󽬛 | `U+7AE5;U+FDB1B` | `reviewed_metadata_only` |
| `obimd-glyph-link-035117` | 󽃤 | `U+FD0E4` | `reviewed_metadata_only` |
| `obimd-glyph-link-035118` | 󽃥 | `U+FD0E5` | `reviewed_metadata_only` |
