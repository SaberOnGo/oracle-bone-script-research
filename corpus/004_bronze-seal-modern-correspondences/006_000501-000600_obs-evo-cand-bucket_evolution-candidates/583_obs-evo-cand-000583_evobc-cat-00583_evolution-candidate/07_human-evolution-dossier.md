...
- External category reference: `evobc-cat-00583`
- Source category ID: `00583`
- Source label for human review: `䳕`
...
- `obs-evo-cand-000583-route-category-staging`
...
- `obs-evo-cand-000583-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000583-route-evolution-graph`
