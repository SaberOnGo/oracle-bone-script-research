# obs-unk-008576 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008576`
- primary external id: `hust-obc-und-YH-008576`
...
- local review image route: `corpus/001_oracle-characters/102_undeciphered-008
  501-008600_obs-unk-bucket_oracle-character-candidates/076_obs-unk-008576_h
  ust-obc-und-YH-008576_oracle-character-candidate/03_visual-assets/001_asse
  t-010167_hust-obc-und-YH-008576_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60C17/H_？_60C17_0.png`
- asset id: `asset-010167`
...
- source class: `HUST-OBC/undeciphered/Y+H/60C17/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60C17/H_？_60C17_0.png`
- asset id: `asset-010167`
...
- Which source records identify obs-unk-008576 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008576？
