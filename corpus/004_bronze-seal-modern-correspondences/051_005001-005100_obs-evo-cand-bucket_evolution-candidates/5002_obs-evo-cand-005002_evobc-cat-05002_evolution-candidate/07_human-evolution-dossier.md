...
Project ID: `obs-evo-cand-005002`
...
- Project ID: `obs-evo-cand-005002`
- EVOBC category candidate ID: `evobc-evo-cat-05002`
- External category reference: `evobc-cat-05002`
- Source category ID: `05002`
- Source label for human review: `瀵`
- Source codepoints: `U+7035`
...
- `obs-evo-cand-005002-route-category-staging`
...
- `obs-evo-cand-005002-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005002-route-evolution-graph`
