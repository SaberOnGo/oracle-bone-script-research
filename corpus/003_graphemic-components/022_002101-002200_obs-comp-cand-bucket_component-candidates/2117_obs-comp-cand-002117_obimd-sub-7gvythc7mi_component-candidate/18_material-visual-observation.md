# Material Visual Observation / obs-comp-cand-002117 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002117`
- External reference / 外部参照: `obimd-sub-7gvythc7mi`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019615_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7gvythc7mi/7gvythc7mi/05a6mqg8we.png`
- Checksum / 校验和:
  `5473fce831f5bb7f9e6bf3a6edc1922974be60a01797828245ce93fc9aff6772`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.83%.
- Marked-pixel bounds: (81,37)–(168,208); span 88 × 172 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.83%。
- 痕迹范围：(81,37)–(168,208)；跨度88 × 172 px；痕迹矩形高于宽。
