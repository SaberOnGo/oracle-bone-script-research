...
- `obs-evo-cand-004826-route-category-staging`
...
- `obs-evo-cand-004826-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004826-route-evolution-graph`
