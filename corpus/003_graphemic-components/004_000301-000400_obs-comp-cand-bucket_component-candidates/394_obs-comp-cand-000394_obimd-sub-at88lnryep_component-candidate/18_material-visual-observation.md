# Material Visual Observation / obs-comp-cand-000394 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000394`
- External reference / 外部参照: `obimd-sub-at88lnryep`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012317_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/at88lnryep/at88lnryep/at88lnryep.png`
- Checksum / 校验和:
  `4837ed993dec8b4e309dfaa76d06bc8bb208b0cd935ce6590bcb3eafbaa89270`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.13%.
- Marked-pixel bounds: (78,18)–(171,229); span 94 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.13%。
- 痕迹范围：(78,18)–(171,229)；跨度94 × 212 px；痕迹矩形高于宽。
