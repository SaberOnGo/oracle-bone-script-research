# Material Visual Observation / obs-comp-cand-001830 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001830`
- External reference / 外部参照: `obimd-sub-vn2dp9qjuy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018156_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7h3wu2xyyf/vn2dp9qjuy/vn2dp9qjuy.png`
- Checksum / 校验和:
  `9f02f1a62bc7cfbc2edf37cab5869b5b9ff912405ebf9c1018f3c78ecb6dd6f2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.27%.
- Marked-pixel bounds: (43,28)–(194,219); span 152 × 192 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.27%。
- 痕迹范围：(43,28)–(194,219)；跨度152 × 192 px；痕迹矩形高于宽。
