# obs-unk-004744 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/044_obs-unk-004744_h
  ust-obc-und-X-004744_oracle-character-candidate/03_visual-assets/001_asset
  -006337_hust-obc-und-X-004744_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/300/X_？_7286_1.png`
- asset id: `asset-006337`
...
- source class: `HUST-OBC/undeciphered/X/300/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/300/X_？_7286_1.png`
- asset id: `asset-006337`
...
- English observation: `vertical stem with multiple horizontal branches`
- 中文观察: `带多条横向分支的竖向主体`
...
- Which source records identify obs-unk-004744 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004744？
