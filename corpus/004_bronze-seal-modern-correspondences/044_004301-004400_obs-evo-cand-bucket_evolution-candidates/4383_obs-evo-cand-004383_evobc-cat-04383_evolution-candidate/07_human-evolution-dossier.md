...
Project ID: `obs-evo-cand-004383`
...
- Project ID: `obs-evo-cand-004383`
- EVOBC category candidate ID: `evobc-evo-cat-04383`
- External category reference: `evobc-cat-04383`
- Source category ID: `04383`
- Source label for human review: `歠`
- Source codepoints: `U+6B60`
...
- `obs-evo-cand-004383-route-category-staging`
...
- `obs-evo-cand-004383-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004383-route-evolution-graph`
