# obs-unk-004499 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004499`
- primary external id: `hust-obc-und-X-004499`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/099_obs-unk-004499_h
  ust-obc-und-X-004499_oracle-character-candidate/03_visual-assets/001_asset
  -006092_hust-obc-und-X-004499_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/55/X_？_8240_1.png`
- asset id: `asset-006092`
...
- source class: `HUST-OBC/undeciphered/X/55/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/55/X_？_8240_1.png`
- asset id: `asset-006092`
...
- English observation: `The two long near-vertical traces, tapered ends, and
  visible separation are directly recorded.`
- 中文观察: `已直接记录两条长竖向痕迹、变细末端和可见分离状态。`
...
- Which source records identify obs-unk-004499 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004499？
