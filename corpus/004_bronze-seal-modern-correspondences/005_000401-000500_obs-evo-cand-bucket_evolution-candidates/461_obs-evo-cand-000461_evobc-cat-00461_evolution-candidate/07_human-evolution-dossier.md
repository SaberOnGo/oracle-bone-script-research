...
Project ID: `obs-evo-cand-000461`
...
- Project ID: `obs-evo-cand-000461`
- EVOBC category candidate ID: `evobc-evo-cat-00461`
- External category reference: `evobc-cat-00461`
- Source category ID: `00461`
- Source label for human review: `䠟`
- Source codepoints: `U+481F`
...
- `obs-evo-cand-000461-route-category-staging`
...
- `obs-evo-cand-000461-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000461-route-evolution-graph`
