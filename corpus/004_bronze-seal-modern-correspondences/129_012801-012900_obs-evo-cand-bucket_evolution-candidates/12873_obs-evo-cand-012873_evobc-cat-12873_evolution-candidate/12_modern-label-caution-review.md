# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012873
...
- EVOBC candidate category: `evobc-evo-cat-12873`.
- Source label for search only: `𪴪`.
- Source codepoints for search only: `U+2AD2A`.
