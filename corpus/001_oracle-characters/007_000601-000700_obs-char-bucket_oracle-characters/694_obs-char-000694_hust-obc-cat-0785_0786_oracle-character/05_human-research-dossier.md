# obs-char-000694 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000694`
- primary external id: `hust-obc-cat-0785_0786`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/694_obs-char-000694_hust-obc-cat-0785_0786
  _oracle-character/03_visual-assets/001_asset-000699_hust-obc-cat-0785_0786
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0785_0786/0785/G_0785_七W9.png`
- asset id: `asset-000699`
...
- source category: `0785_0786`
- validation class: `693`
- source image route: `HUST-OBC/deciphered/0785_0786/0785/G_0785_七W9.png`
- asset id: `asset-000699`
...
- English observation: `Two detached vertical groups stand side by side: a
  crossed star-like mark above a small rectangle at left, and a tall angular
  zigzag with crossed lower strokes at right.`
- 中文观察: `两个分离竖向笔群并列：左侧交叉星状痕位于小矩形上方，右侧为带交叉下笔的高折线。`
...
- dataset label text: `㜇㜈`
- dataset label codepoints: `U+3707;U+3708`
...
- graph edge count: `2`
- codepoint routes: `U+3707;U+3708`
...
- Which source records identify obs-char-000694 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000694？
