...
- `obs-evo-cand-003324-route-category-staging`
...
- `obs-evo-cand-003324-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003324-route-evolution-graph`
