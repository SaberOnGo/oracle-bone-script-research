...
Project ID: `obs-evo-cand-000251`
...
- Project ID: `obs-evo-cand-000251`
- EVOBC category candidate ID: `evobc-evo-cat-00251`
- External category reference: `evobc-cat-00251`
- Source category ID: `00251`
- Source label for human review: `㽴`
- Source codepoints: `U+3F74`
...
- `obs-evo-cand-000251-route-category-staging`
...
- `obs-evo-cand-000251-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000251-route-evolution-graph`
