...
- Project ID: `obs-evo-cand-009808`
- EVOBC category candidate ID: `evobc-evo-cat-09808`
- External category reference: `evobc-cat-09808`
- Source category ID: `09808`
- Source label for human review: `雈`
- Source codepoints: `U+96C8`
...
- `obs-evo-cand-009808-route-category-staging`
...
- `obs-evo-cand-009808-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009808-route-evolution-graph`
