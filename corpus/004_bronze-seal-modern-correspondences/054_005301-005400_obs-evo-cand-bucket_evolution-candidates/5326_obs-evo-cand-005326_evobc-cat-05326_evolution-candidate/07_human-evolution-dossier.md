...
- External category reference: `evobc-cat-05326`
- Source category ID: `05326`
- Source label for human review: `獪`
- Source codepoints: `U+736A`
...
- `obs-evo-cand-005326-route-category-staging`
...
- `obs-evo-cand-005326-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005326-route-evolution-graph`
