...
- `obs-evo-cand-003557-route-category-staging`
...
- `obs-evo-cand-003557-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003557-route-evolution-graph`
