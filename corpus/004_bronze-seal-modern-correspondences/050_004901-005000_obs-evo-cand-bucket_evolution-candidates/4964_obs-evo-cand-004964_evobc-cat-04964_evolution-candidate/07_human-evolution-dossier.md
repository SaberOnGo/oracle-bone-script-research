...
- External category reference: `evobc-cat-04964`
- Source category ID: `04964`
- Source label for human review: `濞`
- Source codepoints: `U+6FDE`
...
- `obs-evo-cand-004964-route-category-staging`
...
- `obs-evo-cand-004964-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004964-route-evolution-graph`
