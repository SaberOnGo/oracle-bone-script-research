# obs-char-000386 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/386_obs-char-000386_hust-obc-cat-0438_orac
  le-character/03_visual-assets/001_asset-000391_hust-obc-cat-0438_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0438/G_0438_佚792合24244出組.png`
- asset id: `asset-000391`
...
- source category: `0438`
- validation class: `385`
- source image route: `HUST-OBC/deciphered/0438/G_0438_佚792合24244出組.png`
- asset id: `asset-000391`
...
- English observation: `A central pointed enclosure is flanked by long
  descending strokes and topped by a narrow fork.`
- 中文观察: `中央尖状闭合轮廓两侧有长下行笔画，上方接狭窄分叉。`
...
- dataset label text: `㖬`
- dataset label codepoints: `U+35AC`
...
- filename catalog route clues: `Heji-like filename clue: 合24244
  (G_0438_佚792合24244出組.png)`
...
- Which source records identify obs-char-000386 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000386？
