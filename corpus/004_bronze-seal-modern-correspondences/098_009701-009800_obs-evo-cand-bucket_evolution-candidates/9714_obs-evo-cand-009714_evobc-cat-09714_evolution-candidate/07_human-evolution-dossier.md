...
- External category reference: `evobc-cat-09714`
- Source category ID: `09714`
- Source label for human review: `阼`
- Source codepoints: `U+963C`
...
- `obs-evo-cand-009714-route-category-staging`
...
- `obs-evo-cand-009714-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009714-route-evolution-graph`
