...
- External category reference: `evobc-cat-08569`
- Source category ID: `08569`
- Source label for human review: `賊`
- Source codepoints: `U+8CCA`
...
- `obs-evo-cand-008569-route-category-staging`
...
- `obs-evo-cand-008569-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008569-route-evolution-graph`
