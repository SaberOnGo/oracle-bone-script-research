# obs-char-000672 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000672`
- primary external id: `hust-obc-cat-0763`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/672_obs-char-000672_hust-obc-cat-0763_orac
  le-character/03_visual-assets/001_asset-000677_hust-obc-cat-0763_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0763/G_0763_乙4603合22073何組.png`
- asset id: `asset-000677`
...
- source category: `0763`
- validation class: `671`
- source image route: `HUST-OBC/deciphered/0763/G_0763_乙4603合22073何組.png`
- asset id: `asset-000677`
...
- English observation: `A tall thin irregular form has two stacked angular
  openings or bars near the upper right, a bowed left side, and several
  narrow crossing or forked lower strokes.`
...
- dataset label text: `㛱`
- dataset label codepoints: `U+36F1`
...
- filename catalog route clues: `Heji-like filename clue: 合22073
  (G_0763_乙4603合22073何組.png)`
...
- Which source records identify obs-char-000672 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000672？
