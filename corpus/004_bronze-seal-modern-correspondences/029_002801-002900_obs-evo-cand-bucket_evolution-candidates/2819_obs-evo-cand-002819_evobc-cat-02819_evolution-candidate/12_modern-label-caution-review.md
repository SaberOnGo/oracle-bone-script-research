# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002819
...
- EVOBC candidate category: `evobc-evo-cat-02819`.
- Source label for search only: `弼`.
- Source codepoints for search only: `U+5F3C`.
