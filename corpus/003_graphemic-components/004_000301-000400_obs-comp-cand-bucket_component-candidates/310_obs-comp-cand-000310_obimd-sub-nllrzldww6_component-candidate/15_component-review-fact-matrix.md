# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000310
...
| Glyph or codepoint route / 字形或码位路线 | 66 OBIMD route rows; examples U+725D;U+F1C96; U+F1C97; 另有 64 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 66 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
