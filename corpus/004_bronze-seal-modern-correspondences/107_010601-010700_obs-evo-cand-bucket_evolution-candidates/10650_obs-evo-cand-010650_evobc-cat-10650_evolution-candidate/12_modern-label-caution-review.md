# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010650
...
- EVOBC candidate category: `evobc-evo-cat-10650`.
- Source label for search only: `點`.
- Source codepoints for search only: `U+9EDE`.
