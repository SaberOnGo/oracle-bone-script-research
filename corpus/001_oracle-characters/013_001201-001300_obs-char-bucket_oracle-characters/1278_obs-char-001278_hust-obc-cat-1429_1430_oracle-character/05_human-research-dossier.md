# obs-char-001278 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001278`
- primary external id: `hust-obc-cat-1429_1430`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1278_obs-char-001278_hust-obc-cat-1429_143
  0_oracle-character/03_visual-assets/001_asset-001283_hust-obc-cat-1429_143
  0_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1429_1430/1429/G_1429_寧滬2.145(甲
  ).png`
- asset id: `asset-001283`
...
- source category: `1429_1430`
- validation class: `1277`
- source image route: `HUST-OBC/deciphered/1429_1430/1429/G_1429_寧滬2.145(甲).pn
  g`
- asset id: `asset-001283`
...
- English observation: `A composite image has an upper peaked enclosure, a
  central stem, and a lower angular enclosure with short marks.`
- 中文观察: `组合图像有上部尖顶框形、中央笔干和带短笔画的下部折角框形。`
...
- dataset label text: `㦋㦌`
- dataset label codepoints: `U+398B;U+398C`
...
- graph edge count: `2`
- codepoint routes: `U+398B;U+398C`
...
- Which source records identify obs-char-001278 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001278？
