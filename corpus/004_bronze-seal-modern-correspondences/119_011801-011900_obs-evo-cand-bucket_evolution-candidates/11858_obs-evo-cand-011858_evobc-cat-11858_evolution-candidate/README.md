# obs-evo-cand-011858 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-011858`
- EVOBC category candidate ID: `evobc-evo-cat-11858`
- External category ref: `evobc-cat-11858`
- Source label: `𥩮`
- Source codepoints: `U+25A6E`
- Image reference count: `11`
- Era token counts: `BI:1;OBC:10`
- Source token counts: `Book:11`
