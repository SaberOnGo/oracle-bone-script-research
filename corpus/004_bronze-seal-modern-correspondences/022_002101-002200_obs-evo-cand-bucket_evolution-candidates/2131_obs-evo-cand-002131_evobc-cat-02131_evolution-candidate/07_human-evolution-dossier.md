...
- External category reference: `evobc-cat-02131`
- Source category ID: `02131`
- Source label: `姞`
...
- `obs-evo-cand-002131-route-category-staging`
...
- `obs-evo-cand-002131-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002131-route-evolution-graph`
