...
- External category reference: `evobc-cat-01516`
- Source category ID: `01516`
- Source label for human review: `吮`
- Source codepoints: `U+542E`
...
- `obs-evo-cand-001516-route-category-staging`
...
- `obs-evo-cand-001516-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001516-route-evolution-graph`
