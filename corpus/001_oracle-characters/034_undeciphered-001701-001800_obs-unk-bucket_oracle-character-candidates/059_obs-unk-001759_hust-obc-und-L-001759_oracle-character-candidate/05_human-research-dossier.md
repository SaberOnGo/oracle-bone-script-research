# obs-unk-001759 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-001759`
- primary external id: `hust-obc-und-L-001759`
...
- local review image route: `corpus/001_oracle-characters/034_undeciphered-001
  701-001800_obs-unk-bucket_oracle-character-candidates/059_obs-unk-001759_h
  ust-obc-und-L-001759_oracle-character-candidate/03_visual-assets/001_asset
  -003352_hust-obc-und-L-001759_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/1759/L_？_1482.jpg`
- asset id: `asset-003352`
...
- source class: `HUST-OBC/undeciphered/L/1759/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/1759/L_？_1482.jpg`
- asset id: `asset-003352`
...
- Which source records identify obs-unk-001759 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-001759？
