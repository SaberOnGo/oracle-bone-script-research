...
- External category reference: `evobc-cat-08135`
- Source category ID: `08135`
- Source label for human review: `訒`
- Source codepoints: `U+8A12`
...
- `obs-evo-cand-008135-route-category-staging`
...
- `obs-evo-cand-008135-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008135-route-evolution-graph`
