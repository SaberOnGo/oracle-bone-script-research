# obs-char-000128 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000128`
- primary external id: `hust-obc-cat-0142`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/128_obs-char-000128_hust-obc-cat-0142_orac
  le-character/03_visual-assets/001_asset-000133_hust-obc-cat-0142_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0142/L_0142_6000.jpg`
- asset id: `asset-000133`
...
- source category: `0142`
- validation class: `127`
- source image route: `HUST-OBC/deciphered/0142/L_0142_6000.jpg`
- asset id: `asset-000133`
...
- English observation: `The low-resolution gray image has a compact crossing
  mark on the left and a curved descending stroke on the right.`
- 中文观察: `低分辨率灰度图像左侧有紧凑交叉痕迹，右侧有弯曲向下的笔画。`
...
- dataset label text: `㒄`
- dataset label codepoints: `U+3484`
...
- Which source records identify obs-char-000128 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000128？
