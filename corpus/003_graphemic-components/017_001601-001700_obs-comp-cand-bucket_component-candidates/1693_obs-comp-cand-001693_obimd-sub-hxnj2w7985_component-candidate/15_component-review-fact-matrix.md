# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001693
...
| Glyph or codepoint route / 字形或码位路线 | 9 OBIMD route rows; examples U+A9A8D;U+F9D0A; U+F9D0B; 另有 7 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
