# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008832
...
- EVOBC candidate category: `evobc-evo-cat-08832`.
- Source label for search only: `輍`.
- Source codepoints for search only: `U+8F0D`.
