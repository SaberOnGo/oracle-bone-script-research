...
- External category reference: `evobc-cat-07465`
- Source category ID: `07465`
- Source label for human review: `葎`
- Source codepoints: `U+844E`
...
- `obs-evo-cand-007465-route-category-staging`
...
- `obs-evo-cand-007465-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007465-route-evolution-graph`
