...
- External category reference: `evobc-cat-01014`
- Source category ID: `01014`
- Source label for human review: `僔`
...
- `obs-evo-cand-001014-route-category-staging`
...
- `obs-evo-cand-001014-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001014-route-evolution-graph`
