...
Project ID: `obs-evo-cand-007943`
...
- Project ID: `obs-evo-cand-007943`
- EVOBC category candidate ID: `evobc-evo-cat-07943`
- External category reference: `evobc-cat-07943`
- Source category ID: `07943`
- Source label for human review: `袒`
- Source codepoints: `U+8892`
...
- `obs-evo-cand-007943-route-category-staging`
...
- `obs-evo-cand-007943-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007943-route-evolution-graph`
