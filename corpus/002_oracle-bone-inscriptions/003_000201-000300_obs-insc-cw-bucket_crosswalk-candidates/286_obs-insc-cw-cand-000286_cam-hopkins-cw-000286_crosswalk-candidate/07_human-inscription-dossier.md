...
- Yingguo / 英国所藏: `y1912` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `550` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `657` in source row; primary catalog entry pending
- Heji / 合集: `41329` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000286`
