# obs-unk-000030 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000030`
- primary external id: `hust-obc-und-L-000030`
...
- local review image route: `corpus/001_oracle-characters/017_undeciphered-000
  001-000100_obs-unk-bucket_oracle-character-candidates/030_obs-unk-000030_h
  ust-obc-und-L-000030_oracle-character-candidate/03_visual-assets/001_asset
  -001623_hust-obc-und-L-000030_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/30/L_？_10106.jpg`
- asset id: `asset-001623`
...
- source class: `HUST-OBC/undeciphered/L/30/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/30/L_？_10106.jpg`
- asset id: `asset-001623`
...
- Which source records identify obs-unk-000030 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000030？
