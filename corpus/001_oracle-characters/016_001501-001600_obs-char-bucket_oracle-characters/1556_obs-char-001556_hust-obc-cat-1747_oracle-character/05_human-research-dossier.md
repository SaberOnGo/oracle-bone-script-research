# obs-char-001556 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001556`
- primary external id: `hust-obc-cat-1747`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1556_obs-char-001556_hust-obc-cat-1747_ora
  cle-character/03_visual-assets/001_asset-001561_hust-obc-cat-1747_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1747/G_1747_合20281(甲).png`
- asset id: `asset-001561`
...
- source category: `1747`
- validation class: `1555`
- source image route: `HUST-OBC/deciphered/1747/G_1747_合20281(甲).png`
- asset id: `asset-001561`
...
- English observation: `Several small angular enclosures are arranged around
  a long descending diagonal.`
...
- dataset label text: `㫉`
- dataset label codepoints: `U+3AC9`
...
- filename catalog route clues: `Heji-like filename clue: 合20281
  (G_1747_合20281(甲).png)`
...
- Which source records identify obs-char-001556 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001556？
