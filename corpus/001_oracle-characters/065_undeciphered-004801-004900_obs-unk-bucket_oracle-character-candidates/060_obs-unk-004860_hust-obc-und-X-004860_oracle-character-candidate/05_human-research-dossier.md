# obs-unk-004860 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/060_obs-unk-004860_h
  ust-obc-und-X-004860_oracle-character-candidate/03_visual-assets/001_asset
  -006453_hust-obc-und-X-004860_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/416/X_？_7400_1.png`
- asset id: `asset-006453`
...
- source class: `HUST-OBC/undeciphered/X/416/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/416/X_？_7400_1.png`
- asset id: `asset-006453`
...
- English observation: `four separated groups with pale openings`
- 中文观察: `四个分离结构和浅色开口`
...
- Which source records identify obs-unk-004860 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004860？
