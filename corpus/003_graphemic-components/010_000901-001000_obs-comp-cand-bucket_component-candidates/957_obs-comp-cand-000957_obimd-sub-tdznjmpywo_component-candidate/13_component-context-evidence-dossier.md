# obs-comp-cand-000957 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000957`
- 首选外部 ID: `obimd-sub-tdznjmpywo`
- OBIMD subcharacter UID: `tdznjmpywo`
- OBIMD main character UID: `tdznjmpywo`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+59EA;U+F55E0; U+F55E1; 另有 3 项
