# Material Visual Observation / obs-comp-cand-000659 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000659`
- External reference / 外部参照: `obimd-sub-c13j4nmoij`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013222_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/c13j4nmoij/c13j4nmoij/c13j4nmoij.png`
- Checksum / 校验和:
  `b73a30490e7ac2318c6044e0f1b6b46f57bc80bc24078d232fdb74ce8da4c6e8`
...
- Marked-pixel bounds: (76,35)–(173,215); span 98 × 181 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.55%。
- 痕迹范围：(76,35)–(173,215)；跨度98 × 181 px；痕迹矩形高于宽。
