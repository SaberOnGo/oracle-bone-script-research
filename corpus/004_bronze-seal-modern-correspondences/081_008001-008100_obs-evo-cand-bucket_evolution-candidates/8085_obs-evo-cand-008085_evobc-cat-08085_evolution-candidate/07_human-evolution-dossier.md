...
Project ID: `obs-evo-cand-008085`
...
- Project ID: `obs-evo-cand-008085`
- EVOBC category candidate ID: `evobc-evo-cat-08085`
- External category reference: `evobc-cat-08085`
- Source category ID: `08085`
- Source label for human review: `观`
- Source codepoints: `U+89C2`
...
- `obs-evo-cand-008085-route-category-staging`
...
- `obs-evo-cand-008085-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008085-route-evolution-graph`
