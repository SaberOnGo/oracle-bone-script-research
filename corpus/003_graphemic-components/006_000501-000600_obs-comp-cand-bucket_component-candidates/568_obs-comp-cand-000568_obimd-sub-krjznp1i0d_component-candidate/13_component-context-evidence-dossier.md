# obs-comp-cand-000568 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000568`
- 首选外部 ID: `obimd-sub-krjznp1i0d`
- OBIMD subcharacter UID: `krjznp1i0d`
- OBIMD main character UID: `krjznp1i0d`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+F34FD; U+F34FE; 另有 2 项
