...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1490`
...
- Source image / 来源图: `G_1490_合28190(甲).png`
- Image / 图像: `001_asset-001339_hust-obc-cat-1490_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合28190
  (G_1490_合28190(甲).png)`
...
- Source label text / 来源标签文字: `㧈`
- Source label codepoint / 来源标签 codepoint: `U+39C8`
