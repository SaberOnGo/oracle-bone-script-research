# obs-unk-004009 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004009`
- primary external id: `hust-obc-und-L-004009`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/009_obs-unk-004009_h
  ust-obc-und-L-004009_oracle-character-candidate/03_visual-assets/001_asset
  -005602_hust-obc-und-L-004009_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4009/L_？_850.jpg`
- asset id: `asset-005602`
...
- source class: `HUST-OBC/undeciphered/L/4009/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4009/L_？_850.jpg`
- asset id: `asset-005602`
...
- English observation: An angular enclosing outline surrounds several central
  branching traces; the lower opening is tightly cropped.
- 中文观察：角状围合轮廓包围数条中部的分支痕迹，下部开口裁切较紧。
...
- Which source records identify obs-unk-004009 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004009？
