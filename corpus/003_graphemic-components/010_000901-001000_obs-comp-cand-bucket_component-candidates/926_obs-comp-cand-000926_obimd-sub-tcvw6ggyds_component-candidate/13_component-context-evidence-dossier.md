# obs-comp-cand-000926 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000926`
- 首选外部 ID: `obimd-sub-tcvw6ggyds`
- OBIMD subcharacter UID: `tcvw6ggyds`
- OBIMD main character UID: `tcvw6ggyds`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+654F;U+A6E30;U+F5314; U+F5315; 另有 1 项
