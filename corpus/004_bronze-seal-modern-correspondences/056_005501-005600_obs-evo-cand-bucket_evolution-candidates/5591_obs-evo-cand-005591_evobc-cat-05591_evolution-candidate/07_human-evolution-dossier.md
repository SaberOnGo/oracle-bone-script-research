...
- External category reference: `evobc-cat-05591`
- Source category ID: `05591`
- Source label for human review: `畾`
...
- `obs-evo-cand-005591-route-category-staging`
...
- `obs-evo-cand-005591-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005591-route-evolution-graph`
