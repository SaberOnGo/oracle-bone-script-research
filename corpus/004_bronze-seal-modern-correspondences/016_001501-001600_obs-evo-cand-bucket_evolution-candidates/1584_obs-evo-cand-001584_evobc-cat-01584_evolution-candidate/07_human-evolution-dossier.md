...
- External category reference: `evobc-cat-01584`
- Source category ID: `01584`
- Source label for human review: `哖`
- Source codepoints: `U+54D6`
...
- `obs-evo-cand-001584-route-category-staging`
...
- `obs-evo-cand-001584-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001584-route-evolution-graph`
