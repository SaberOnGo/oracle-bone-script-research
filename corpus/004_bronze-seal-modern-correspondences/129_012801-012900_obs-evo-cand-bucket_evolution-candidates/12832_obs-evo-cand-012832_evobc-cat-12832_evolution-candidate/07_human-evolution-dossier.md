...
- External category reference: `evobc-cat-12832`
- Source category ID: `12832`
- Source label for human review: `𪨓`
- Source codepoints: `U+2AA13`
...
- `obs-evo-cand-012832-route-category-staging`
...
- `obs-evo-cand-012832-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012832-route-evolution-graph`
