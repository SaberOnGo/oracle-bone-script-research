...
- External category reference: `evobc-cat-06078`
- Source category ID: `06078`
- Source label for human review: `秬`
- Source codepoints: `U+79EC`
...
- `obs-evo-cand-006078-route-category-staging`
...
- `obs-evo-cand-006078-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006078-route-evolution-graph`
