# Material Visual Observation / obs-comp-cand-002707 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002707`
- External reference / 外部参照: `obimd-sub-f7v4x0bn28`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021283_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/f7v4x0bn28/f7v4x0bn28/f7v4x0bn28.png`
- Checksum / 校验和:
  `4250e69a27f14740261cbc8e37d9182d9f06f5a8a0bc83f8a2dcae36ca1224b2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.67%.
- Marked-pixel bounds: (97,19)–(155,230); span 59 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.67%。
- 痕迹范围：(97,19)–(155,230)；跨度59 × 212 px；痕迹矩形高于宽。
