...
- External category reference: `evobc-cat-11342`
- Source category ID: `11342`
- Source label: `𢽞`
...
- `obs-evo-cand-011342-route-category-staging`
...
- `obs-evo-cand-011342-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-011342-route-evolution-graph`
