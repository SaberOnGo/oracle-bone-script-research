...
- External category reference: `evobc-cat-04000`
- Source category ID: `04000`
- Source label for human review: `栠`
...
- `obs-evo-cand-004000-route-category-staging`
...
- `obs-evo-cand-004000-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004000-route-evolution-graph`
