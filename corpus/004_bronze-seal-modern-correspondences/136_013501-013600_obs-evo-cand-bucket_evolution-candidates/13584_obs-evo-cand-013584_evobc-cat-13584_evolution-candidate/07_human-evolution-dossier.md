...
- External category reference: `evobc-cat-13584`
- Source category ID: `13584`
- Source label for human review: `𭻄`
- Source codepoints: `U+2DEC4`
...
- `obs-evo-cand-013584-route-category-staging`
...
- `obs-evo-cand-013584-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013584-route-evolution-graph`
