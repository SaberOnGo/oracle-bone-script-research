# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010326
...
- EVOBC candidate category: `evobc-evo-cat-10326`.
- Source label for search only: `鬊`.
- Source codepoints for search only: `U+9B0A`.
