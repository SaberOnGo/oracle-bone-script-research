# obs-char-000081 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/081_obs-char-000081_hust-obc-cat-0091_orac
  le-character/03_visual-assets/001_asset-000086_hust-obc-cat-0091_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0091/G_0091_甲骨文.png`
- asset id: `asset-000086`
...
- source category: `0091`
- validation class: `80`
- source image route: `HUST-OBC/deciphered/0091/G_0091_甲骨文.png`
- asset id: `asset-000086`
...
- English observation: `The narrow image has a rounded upper contour, a
  short central horizontal stroke, and several angular marks descending
  below it.`
...
- dataset label text: `㑑`
- dataset label codepoints: `U+3451`
...
- Which source records identify obs-char-000081 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000081？
