...
Project ID: `obs-evo-cand-004815`
...
- Project ID: `obs-evo-cand-004815`
- EVOBC category candidate ID: `evobc-evo-cat-04815`
- External category reference: `evobc-cat-04815`
- Source category ID: `04815`
- Source label for human review: `溤`
- Source codepoints: `U+6EA4`
...
- `obs-evo-cand-004815-route-category-staging`
...
- `obs-evo-cand-004815-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004815-route-evolution-graph`
