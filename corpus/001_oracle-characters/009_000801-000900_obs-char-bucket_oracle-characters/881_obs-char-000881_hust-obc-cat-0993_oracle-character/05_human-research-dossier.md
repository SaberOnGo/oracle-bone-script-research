# obs-char-000881 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/881_obs-char-000881_hust-obc-cat-0993_orac
  le-character/03_visual-assets/001_asset-000886_hust-obc-cat-0993_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0993/H_0993_61224_0.png`
- asset id: `asset-000886`
...
- source category: `0993`
- validation class: `880`
- source image route: `HUST-OBC/deciphered/0993/H_0993_61224_0.png`
- asset id: `asset-000886`
...
- English observation: `A complex bold form has separate curved outer
  strokes, an upper central branch, a middle crossing, and rounded lower
  loops.`
...
- dataset label text: `㟗`
- dataset label codepoints: `U+37D7`
...
- filename catalog route clues: `catalog-like filename clue: H_0993
  (H_0993_61224_0.png)`
...
- Which source records identify obs-char-000881 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000881？
