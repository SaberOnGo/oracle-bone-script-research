# Material Visual Observation / obs-comp-cand-000540 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000540`
- External reference / 外部参照: `obimd-sub-dfe38kc2ai`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012774_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dfe38kc2ai/dfe38kc2ai/dfe38kc2ai.png`
- Checksum / 校验和:
  `f862e7701fc8b05343ee267e61c6581ca141bcc30a9188188cfff0fa47dbb921`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.14%.
- Marked-pixel bounds: (78,26)–(170,226); span 93 × 201 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.14%。
- 痕迹范围：(78,26)–(170,226)；跨度93 × 201 px；痕迹矩形高于宽。
