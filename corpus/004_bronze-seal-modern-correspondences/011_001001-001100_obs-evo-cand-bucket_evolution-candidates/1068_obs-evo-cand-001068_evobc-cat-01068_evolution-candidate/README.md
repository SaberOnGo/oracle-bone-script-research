# obs-evo-cand-001068 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-001068`
- EVOBC category candidate ID: `evobc-evo-cat-01068`
- External category ref: `evobc-cat-01068`
- Source label: `兄`
- Source codepoints: `U+5144`
- Image reference count: `201`
- Era token counts: `BI:47;CS:1;OBC:97;SAC:14;SS:2;WSC:40`
- Source token counts: `Book:80;Web:121`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 97 image references
- era 1 / BI: 47 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 14 image references
...
- source 3 / Book:21681: 15 image references
- source 4 / Book:9131: 14 image references
