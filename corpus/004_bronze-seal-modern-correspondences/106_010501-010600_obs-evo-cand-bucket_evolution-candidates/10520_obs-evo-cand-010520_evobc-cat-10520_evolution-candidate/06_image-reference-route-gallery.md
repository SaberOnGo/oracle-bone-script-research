...
- `obs-evo-cand-010520-route-category-staging`
...
- `obs-evo-cand-010520-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010520-route-evolution-graph`
