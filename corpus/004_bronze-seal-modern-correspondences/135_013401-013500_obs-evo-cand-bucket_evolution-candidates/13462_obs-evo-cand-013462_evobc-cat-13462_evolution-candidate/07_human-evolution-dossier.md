...
- External category reference: `evobc-cat-13462`
- Source category ID: `13462`
- Source label for human review: `𬼵`
- Source codepoints: `U+2CF35`
...
- `obs-evo-cand-013462-route-category-staging`
...
- `obs-evo-cand-013462-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013462-route-evolution-graph`
