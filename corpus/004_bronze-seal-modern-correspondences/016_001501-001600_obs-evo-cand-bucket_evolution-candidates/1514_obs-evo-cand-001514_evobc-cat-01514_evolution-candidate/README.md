# obs-evo-cand-001514 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-01514`
- Source label for human review: `含`
- Source codepoints: `U+542B`
- Image reference count: `44`
- Era token counts: `BI:24;CS:1;SS:2;WSC:17`
- Source token counts: `Book:2;Web:42`
