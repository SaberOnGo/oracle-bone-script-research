# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002778
...
- EVOBC candidate category: `evobc-evo-cat-02778`.
- Source label for search only: `建`.
- Source codepoints for search only: `U+5EFA`.
