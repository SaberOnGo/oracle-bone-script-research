...
- External category reference: `evobc-cat-07063`
- Source category ID: `07063`
- Source label for human review: `脙`
- Source codepoints: `U+8119`
...
- `obs-evo-cand-007063-route-category-staging`
...
- `obs-evo-cand-007063-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007063-route-evolution-graph`
