# obs-char-001206 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001206`
- primary external id: `hust-obc-cat-1351`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1206_obs-char-001206_hust-obc-cat-1351_ora
  cle-character/03_visual-assets/001_asset-001211_hust-obc-cat-1351_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1351/G_1351_存下495合18409賓組.png`
- asset id: `asset-001211`
...
- source category: `1351`
- validation class: `1205`
- source image route: `HUST-OBC/deciphered/1351/G_1351_存下495合18409賓組.png`
- asset id: `asset-001211`
...
- English observation: `Three adjacent upright forms combine upper branches,
  a central rounded loop, and a hooked lower stroke.`
- 中文观察: `三个相邻直立形体结合上部分枝、中央圆弧环和下部钩笔。`
...
- dataset label text: `㤽`
- dataset label codepoints: `U+393D`
...
- filename catalog route clues: `Heji-like filename clue: 合18409
...
- Which source records identify obs-char-001206 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001206？
