# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008858
...
- EVOBC candidate category: `evobc-evo-cat-08858`.
- Source label for search only: `輼`.
- Source codepoints for search only: `U+8F3C`.
