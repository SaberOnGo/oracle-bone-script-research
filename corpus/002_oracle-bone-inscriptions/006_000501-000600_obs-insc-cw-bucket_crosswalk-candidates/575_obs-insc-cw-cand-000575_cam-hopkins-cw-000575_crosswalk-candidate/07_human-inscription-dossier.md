...
Project ID: `obs-insc-cw-cand-000575`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000575`
...
- Source page section: `Period V Group 17` /
  `第 V 期第 17 组`
- Source section key: `period-v-group-17`
- Section declared count: `2`
- Section observed row count: `2`
...
- Yingguo / 英国所藏: `y2605` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `356` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `455` in source row; primary catalog entry pending
- Heji / 合集: `41840` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000575`
