# obs-char-000255 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/255_obs-char-000255_hust-obc-cat-0285_orac
  le-character/03_visual-assets/001_asset-000260_hust-obc-cat-0285_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0285/G_0285_乙6664合11497賓組.png`
- asset id: `asset-000260`
...
- source category: `0285`
- validation class: `254`
- source image route: `HUST-OBC/deciphered/0285/G_0285_乙6664合11497賓組.png`
- asset id: `asset-000260`
...
- English observation: `A long central vertical stroke separates two rounded
  side forms; the left and right forms are similar in size but not identical
  in contour.`
...
- dataset label text: `㔓`
- dataset label codepoints: `U+3513`
...
- Which source records identify obs-char-000255 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000255？
