# obs-char-000138 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/138_obs-char-000138_hust-obc-cat-0153_orac
  le-character/03_visual-assets/001_asset-000143_hust-obc-cat-0153_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0153/G_0153_佚644(甲).png`
- asset id: `asset-000143`
...
- source category: `0153`
- validation class: `137`
- source image route: `HUST-OBC/deciphered/0153/G_0153_佚644(甲).png`
- asset id: `asset-000143`
...
- English observation: `The tall image has a central descending stroke with
  two long curved side strokes and a short diagonal projection near the
  middle.`
...
- dataset label text: `㒏`
- dataset label codepoints: `U+348F`
...
- Which source records identify obs-char-000138 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000138？
