# obs-char-000019 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000019`
- primary external id: `hust-obc-cat-0022`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/019_obs-char-000019_hust-obc-cat-0022_orac
  le-character/03_visual-assets/001_asset-000024_hust-obc-cat-0022_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0022/L_0022_4305.jpg`
- asset id: `asset-000024`
...
- source category: `0022`
- validation class: `18`
- source image route: `HUST-OBC/deciphered/0022/L_0022_4305.jpg`
- asset id: `asset-000024`
...
- English observation: `The small gray image shows a rounded upper mark, a
  short horizontal stroke, and two diverging lower strokes; contrast needs
  recheck.`
- 中文观察: `小型灰度图像上部有圆弧痕迹，中部有短横画，下方有两条分开的笔画；对比度仍需复核。`
...
- dataset label text: `㐌`
- dataset label codepoints: `U+340C`
...
- Which source records identify obs-char-000019 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000019？
