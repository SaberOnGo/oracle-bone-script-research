# Material Visual Observation / obs-comp-cand-001449 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001449`
- External reference / 外部参照: `obimd-sub-3vet9ug0bh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016026_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/51p2xxpvps/3vet9ug0bh/3vet9ug0bh.png`
- Checksum / 校验和:
  `9e08bb8af64e1804eb9b382be5189cd2a32e2aac4cba5cc6272429bf6128b7ad`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.83%.
- Marked-pixel bounds: (72,37)–(199,212); span 128 × 176 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.83%。
- 痕迹范围：(72,37)–(199,212)；跨度128 × 176 px；痕迹矩形高于宽。
