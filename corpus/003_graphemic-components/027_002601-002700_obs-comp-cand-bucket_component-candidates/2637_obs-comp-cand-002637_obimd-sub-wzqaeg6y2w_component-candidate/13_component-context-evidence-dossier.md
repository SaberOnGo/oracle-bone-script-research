# obs-comp-cand-002637 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002637`
- 首选外部 ID: `obimd-sub-wzqaeg6y2w`
- OBIMD subcharacter UID: `wzqaeg6y2w`
- OBIMD main character UID: `wzqaeg6y2w`
- 来源 ID: `src-obimd`
...
- codepoint 示例: U+FEDCE; U+FEDCF; 另有 11 项
