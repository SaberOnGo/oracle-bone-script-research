...
- External category reference: `evobc-cat-11912`
- Source category ID: `11912`
- Source label for human review: `𥷬`
...
- `obs-evo-cand-011912-route-category-staging`
...
- `obs-evo-cand-011912-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011912-route-evolution-graph`
