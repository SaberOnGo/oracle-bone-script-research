# Material Visual Observation / obs-comp-cand-000360 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000360`
- External reference / 外部参照: `obimd-sub-h9hoshfwwj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012283_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h9hoshfwwj/h9hoshfwwj/h9hoshfwwj.png`
- Checksum / 校验和:
  `bc934abafe08c8574bc3231a117490fd9e827a3865e258430270c1246d7f1879`
...
- Marked-pixel bounds: (81,18)–(173,231); span 93 × 214 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.59%。
- 痕迹范围：(81,18)–(173,231)；跨度93 × 214 px；痕迹矩形高于宽。
