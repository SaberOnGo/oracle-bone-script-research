# obs-unk-004328 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004328`
- primary external id: `hust-obc-und-L-004328`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/028_obs-unk-004328_h
  ust-obc-und-L-004328_oracle-character-candidate/03_visual-assets/001_asset
  -005921_hust-obc-und-L-004328_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4328/L_？_9560.jpg`
- asset id: `asset-005921`
...
- source class: `HUST-OBC/undeciphered/L/4328/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4328/L_？_9560.jpg`
- asset id: `asset-005921`
...
- English observation: `Central dark shape, horizontal trace, and taper
  recorded.`
- 中文观察: `已记录中央深色形状、横向痕迹和渐细下痕。`
...
- Which source records identify obs-unk-004328 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004328？
