...
Project ID: `obs-evo-cand-012072`
...
- Project ID: `obs-evo-cand-012072`
- EVOBC category candidate ID: `evobc-evo-cat-12072`
- External category reference: `evobc-cat-12072`
- Source category ID: `12072`
- Source label for human review: `𦤺`
- Source codepoints: `U+2693A`
...
- `obs-evo-cand-012072-route-category-staging`
...
- `obs-evo-cand-012072-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012072-route-evolution-graph`
