...
- Yingguo / 英国所藏: `y2583` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `411` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `476` in source row; primary catalog entry pending
