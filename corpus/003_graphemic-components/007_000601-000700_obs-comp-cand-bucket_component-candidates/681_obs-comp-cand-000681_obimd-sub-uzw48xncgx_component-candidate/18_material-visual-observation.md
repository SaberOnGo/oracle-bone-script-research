# Material Visual Observation / obs-comp-cand-000681 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000681`
- External reference / 外部参照: `obimd-sub-uzw48xncgx`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013280_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/uzw48xncgx/uzw48xncgx/uzw48xncgx.png`
- Checksum / 校验和:
  `e208d9df616f8837b60e37bfc5da3f431d8cc6c2b508fa8bd97c7bdbdec09421`
...
- Marked-pixel bounds: (87,24)–(167,233); span 81 × 210 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.48%。
- 痕迹范围：(87,24)–(167,233)；跨度81 × 210 px；痕迹矩形高于宽。
