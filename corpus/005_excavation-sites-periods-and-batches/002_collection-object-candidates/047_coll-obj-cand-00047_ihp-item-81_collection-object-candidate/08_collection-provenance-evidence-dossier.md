# Collection Provenance Evidence Dossier / 馆藏来源证据档案: coll-obj-cand-00047
...
| source_row_id | `47` |
| object_page_url | `https://museum.sinica.edu.tw/en/collection/32/item/81/` |
...
| asset_id | `` |
| asset_path | `` |
| thumbnail_url | `https://museum.sinica.edu.tw/_upload/image/collection_item/thumbnail/dc1169447548.jpg` |
| source_image_url | `` |
...
| `source_collection_item_id` | `81` |
| `object_title_en` | `Inscribed Plastron I 5241` |
| `catalog_reference_text` | `I 5241` |
| `accession_number` | `` |
| `historical_period` | `` |
| `object_date` | `` |
| `provenience` | `` |
