# obs-char-001155 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001155`
- primary external id: `hust-obc-cat-1294`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1155_obs-char-001155_hust-obc-cat-1294_ora
  cle-character/03_visual-assets/001_asset-001160_hust-obc-cat-1294_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1294/G_1294_前4.11.2合4899賓組.png`
- asset id: `asset-001160`
...
- source category: `1294`
- validation class: `1154`
- source image route: `HUST-OBC/deciphered/1294/G_1294_前4.11.2合4899賓組.png`
- asset id: `asset-001160`
...
- English observation: `Two faint slender curves descend together, with a
  small hooked turn near the lower end.`
- 中文观察: `两条较淡的狭长弯笔并行下行，下端附近有小型钩转。`
...
- dataset label text: `㤄`
- dataset label codepoints: `U+3904`
...
- filename catalog route clues: `Heji-like filename clue: 合4899
  (G_1294_前4.11.2合4899賓組.png)`
...
- Which source records identify obs-char-001155 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001155？
