...
- External category reference: `evobc-cat-04681`
- Source category ID: `04681`
- Source label for human review: `涑`
...
- `obs-evo-cand-004681-route-category-staging`
...
- `obs-evo-cand-004681-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004681-route-evolution-graph`
