...
Project ID: `obs-evo-cand-002371`
...
- Project ID: `obs-evo-cand-002371`
- EVOBC category candidate ID: `evobc-evo-cat-02371`
- External category reference: `evobc-cat-02371`
- Source category ID: `02371`
- Source label for human review: `宕`
- Source codepoints: `U+5B95`
...
- `obs-evo-cand-002371-route-category-staging`
...
- `obs-evo-cand-002371-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002371-route-evolution-graph`
