# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008353
...
- EVOBC candidate category: `evobc-evo-cat-08353`.
- Source label for search only: `譍`.
- Source codepoints for search only: `U+8B4D`.
