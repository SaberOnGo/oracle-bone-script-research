# obs-unk-004834 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004834`
- primary external id: `hust-obc-und-X-004834`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/034_obs-unk-004834_h
  ust-obc-und-X-004834_oracle-character-candidate/03_visual-assets/001_asset
  -006427_hust-obc-und-X-004834_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/390/X_？_7373_1.png`
- asset id: `asset-006427`
...
- source class: `HUST-OBC/undeciphered/X/390/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/390/X_？_7373_1.png`
- asset id: `asset-006427`
...
- English observation: `upper pale opening and separate lower outline`
- 中文观察: `上部浅色开口和分离的下部围合`
...
- Which source records identify obs-unk-004834 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004834？
