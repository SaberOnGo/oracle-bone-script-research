# obs-comp-cand-001810 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001810`
- 首选外部 ID: `obimd-sub-3cv4e1htww`
- OBIMD subcharacter UID: `3cv4e1htww`
- OBIMD main character UID: `3cv4e1htww`
- 来源 ID: `src-obimd`
