...
- External category reference: `evobc-cat-07022`
- Source category ID: `07022`
- Source label: `背`
...
- `obs-evo-cand-007022-route-category-staging`
...
- `obs-evo-cand-007022-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007022-route-evolution-graph`
