...
- Project ID: `obs-evo-cand-008682`
- EVOBC category candidate ID: `evobc-evo-cat-08682`
- External category reference: `evobc-cat-08682`
- Source category ID: `08682`
- Source label for human review: `趙`
- Source codepoints: `U+8D99`
...
- `obs-evo-cand-008682-route-category-staging`
...
- `obs-evo-cand-008682-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008682-route-evolution-graph`
