...
- External category reference: `evobc-cat-12344`
- Source category ID: `12344`
- Source label for human review: `𨑬`
...
- `obs-evo-cand-012344-route-category-staging`
...
- `obs-evo-cand-012344-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012344-route-evolution-graph`
