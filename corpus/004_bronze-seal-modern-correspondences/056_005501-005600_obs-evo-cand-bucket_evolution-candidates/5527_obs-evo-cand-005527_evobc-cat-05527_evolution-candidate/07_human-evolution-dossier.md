...
- External category reference: `evobc-cat-05527`
- Source category ID: `05527`
- Source label for human review: `甕`
- Source codepoints: `U+7515`
...
- `obs-evo-cand-005527-route-category-staging`
...
- `obs-evo-cand-005527-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005527-route-evolution-graph`
