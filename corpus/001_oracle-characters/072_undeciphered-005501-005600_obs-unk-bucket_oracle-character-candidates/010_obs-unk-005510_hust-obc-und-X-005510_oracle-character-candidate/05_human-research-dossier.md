# obs-unk-005510 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005510`
- primary external id: `hust-obc-und-X-005510`
...
- local review image route: `corpus/001_oracle-characters/072_undeciphered-005
  501-005600_obs-unk-bucket_oracle-character-candidates/010_obs-unk-005510_h
  ust-obc-und-X-005510_oracle-character-candidate/03_visual-assets/001_asset
  -007103_hust-obc-und-X-005510_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1066/X_？_8028_1.png`
- asset id: `asset-007103`
...
- source class: `HUST-OBC/undeciphered/X/1066/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1066/X_？_8028_1.png`
- asset id: `asset-007103`
...
- Which source records identify obs-unk-005510 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005510？
