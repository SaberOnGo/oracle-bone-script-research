...
- External category reference: `evobc-cat-04734`
- Source category ID: `04734`
- Source label for human review: `淮`
- Source codepoints: `U+6DEE`
...
- `obs-evo-cand-004734-route-category-staging`
...
- `obs-evo-cand-004734-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004734-route-evolution-graph`
