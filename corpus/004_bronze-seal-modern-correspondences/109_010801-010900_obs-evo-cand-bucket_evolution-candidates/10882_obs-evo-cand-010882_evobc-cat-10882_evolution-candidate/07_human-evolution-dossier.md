...
- Project ID: `obs-evo-cand-010882`
- EVOBC category candidate ID: `evobc-evo-cat-10882`
- External category reference: `evobc-cat-10882`
- Source category ID: `10882`
- Source label for human review: `𠦪`
- Source codepoints: `U+209AA`
- Image reference count in source metadata: `160`
...
- `obs-evo-cand-010882-route-category-staging`
...
- `obs-evo-cand-010882-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010882-route-evolution-graph`
