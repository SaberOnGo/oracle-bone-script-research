...
- Project ID: `obs-evo-cand-010041`
- EVOBC category candidate ID: `evobc-evo-cat-10041`
- External category reference: `evobc-cat-10041`
- Source category ID: `10041`
- Source label for human review: `页`
- Source codepoints: `U+9875`
...
- `obs-evo-cand-010041-route-category-staging`
...
- `obs-evo-cand-010041-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010041-route-evolution-graph`
