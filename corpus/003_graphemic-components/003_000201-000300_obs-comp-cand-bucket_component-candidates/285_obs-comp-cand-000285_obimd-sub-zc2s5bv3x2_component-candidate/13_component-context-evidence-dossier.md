# obs-comp-cand-000285 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000285`
- 首选外部 ID: `obimd-sub-zc2s5bv3x2`
- OBIMD subcharacter UID: `zc2s5bv3x2`
- OBIMD main character UID: `zc2s5bv3x2`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+BBD12;U+F19A2; U+F19A3
