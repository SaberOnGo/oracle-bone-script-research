...
- External category reference: `evobc-cat-10142`
- Source category ID: `10142`
- Source label for human review: `饡`
- Source codepoints: `U+9961`
...
- `obs-evo-cand-010142-route-category-staging`
...
- `obs-evo-cand-010142-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010142-route-evolution-graph`
