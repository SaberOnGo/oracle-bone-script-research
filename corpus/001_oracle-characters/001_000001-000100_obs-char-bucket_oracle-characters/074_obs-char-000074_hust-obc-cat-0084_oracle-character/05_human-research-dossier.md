# obs-char-000074 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/074_obs-char-000074_hust-obc-cat-0084_orac
  le-character/03_visual-assets/001_asset-000079_hust-obc-cat-0084_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0084/G_0084_後2.9.1(甲).png`
- asset id: `asset-000079`
...
- source category: `0084`
- validation class: `73`
- source image route: `HUST-OBC/deciphered/0084/G_0084_後2.9.1(甲).png`
- asset id: `asset-000079`
...
- English observation: `The small image consists of a horizontal stroke
  crossed by a longer vertical stroke.`
...
- dataset label text: `㑊`
- dataset label codepoints: `U+344A`
...
- Which source records identify obs-char-000074 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000074？
