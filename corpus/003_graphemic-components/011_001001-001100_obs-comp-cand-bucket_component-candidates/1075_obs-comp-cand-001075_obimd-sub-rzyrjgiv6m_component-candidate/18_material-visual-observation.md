# Material Visual Observation / obs-comp-cand-001075 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001075`
- External reference / 外部参照: `obimd-sub-rzyrjgiv6m`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014625_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rzyrjgiv6m/rzyrjgiv6m/rzyrjgiv6m.png`
- Checksum / 校验和:
  `7f0bdb2652cdceecf4a02c1c7089be66215d4706c3b0e6074ebf99ee175c68af`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.72%.
- Marked-pixel bounds: (90,18)–(166,231); span 77 × 214 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.72%。
- 痕迹范围：(90,18)–(166,231)；跨度77 × 214 px；痕迹矩形高于宽。
