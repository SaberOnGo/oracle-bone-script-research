# obs-unk-002697 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/043_undeciphered-002
  601-002700_obs-unk-bucket_oracle-character-candidates/097_obs-unk-002697_h
  ust-obc-und-L-002697_oracle-character-candidate/03_visual-assets/001_asset
  -004290_hust-obc-und-L-002697_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2697/L_？_4266.jpg`
- asset id: `asset-004290`
...
- source class: `HUST-OBC/undeciphered/L/2697/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2697/L_？_4266.jpg`
- asset id: `asset-004290`
...
- Which source records identify obs-unk-002697 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002697？
