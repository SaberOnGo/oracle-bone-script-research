# Material Visual Observation / obs-comp-cand-002620 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002620`
- External reference / 外部参照: `obimd-sub-3ojubvieb2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021159_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3ojubvieb2/3ojubvieb2/3ojubvieb2.png`
- Checksum / 校验和:
  `b27d318d62cf17a33409d938ca488ba082c67bf43ea4733539018d12cd1151a3`
...
- Marked-pixel bounds: (88,11)–(168,239); span 81 × 229 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.73%。
- 痕迹范围：(88,11)–(168,239)；跨度81 × 229 px；痕迹矩形高于宽。
