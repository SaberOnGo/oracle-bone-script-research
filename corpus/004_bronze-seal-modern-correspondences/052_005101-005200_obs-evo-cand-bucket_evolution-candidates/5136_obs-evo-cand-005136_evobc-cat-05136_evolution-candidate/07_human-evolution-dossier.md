...
Project ID: `obs-evo-cand-005136`
...
- Project ID: `obs-evo-cand-005136`
- EVOBC category candidate ID: `evobc-evo-cat-05136`
- External category reference: `evobc-cat-05136`
- Source category ID: `05136`
- Source label for human review: `熮`
- Source codepoints: `U+71AE`
...
- `obs-evo-cand-005136-route-category-staging`
...
- `obs-evo-cand-005136-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005136-route-evolution-graph`
