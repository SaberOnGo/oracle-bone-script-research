...
Project ID: `obs-evo-cand-009831`
...
- Project ID: `obs-evo-cand-009831`
- EVOBC category candidate ID: `evobc-evo-cat-09831`
- External category reference: `evobc-cat-09831`
- Source category ID: `09831`
- Source label for human review: `難`
- Source codepoints: `U+96E3`
...
- `obs-evo-cand-009831-route-category-staging`
...
- `obs-evo-cand-009831-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009831-route-evolution-graph`
