...
- Evidence collection note draft ID / 证据收集记录草稿 ID: `graph-source-evidence-note-draft-001`
- Evidence collection task ID / 证据收集任务 ID: `graph-source-evidence-task-007`
- Cross-review result ID / 交叉复核结果 ID: `graph-source-cross-review-result-001`
...
- Expected output path from task queue / 任务队列预期输出路径: `doc/public/user_research/003_evidence-collection-tasks/hust-obc/graph-source-evidence-task-007_counter-source-lookup_collection-note.md`
