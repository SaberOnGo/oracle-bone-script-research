...
- External category reference: `evobc-cat-02167`
- Source category ID: `02167`
- Source label for human review: `娙`
- Source codepoints: `U+5A19`
...
- `obs-evo-cand-002167-route-category-staging`
...
- `obs-evo-cand-002167-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002167-route-evolution-graph`
