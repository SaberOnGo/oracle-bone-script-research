...
- External category reference: `evobc-cat-10765`
- Source category ID: `10765`
- Source label for human review: `𠀬`
- Source codepoints: `U+2002C`
...
- `obs-evo-cand-010765-route-category-staging`
...
- `obs-evo-cand-010765-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010765-route-evolution-graph`
