# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010651
...
- EVOBC candidate category: `evobc-evo-cat-10651`.
- Source label for search only: `黟`.
- Source codepoints for search only: `U+9EDF`.
