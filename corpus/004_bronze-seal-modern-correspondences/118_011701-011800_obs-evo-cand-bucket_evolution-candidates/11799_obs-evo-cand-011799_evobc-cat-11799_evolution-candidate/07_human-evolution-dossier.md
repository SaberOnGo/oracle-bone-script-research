...
- External category reference: `evobc-cat-11799`
- Source category ID: `11799`
- Source label for human review: `𥐿`
...
- `obs-evo-cand-011799-route-category-staging`
...
- `obs-evo-cand-011799-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011799-route-evolution-graph`
