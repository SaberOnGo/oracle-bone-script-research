# obs-char-001344 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001344`
- primary external id: `hust-obc-cat-1501`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1344_obs-char-001344_hust-obc-cat-1501_ora
  cle-character/03_visual-assets/001_asset-001349_hust-obc-cat-1501_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1501/H_1501_606A3_0.png`
- asset id: `asset-001349`
...
- source category: `1501`
- validation class: `1343`
- source image route: `HUST-OBC/deciphered/1501/H_1501_606A3_0.png`
- asset id: `asset-001349`
...
- English observation: `A large dense composite has repeated left triangular
  marks, a central crossing, and several right-side branches.`
- 中文观察: `大型密集组合形体有重复的左侧三角状标记、中央交叉笔和数条右侧分枝。`
...
- dataset label text: `㧓`
- dataset label codepoints: `U+39D3`
...
- filename catalog route clues: `catalog-like filename clue: H_1501
  (H_1501_606A3_0.png)`
...
- Which source records identify obs-char-001344 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001344？
