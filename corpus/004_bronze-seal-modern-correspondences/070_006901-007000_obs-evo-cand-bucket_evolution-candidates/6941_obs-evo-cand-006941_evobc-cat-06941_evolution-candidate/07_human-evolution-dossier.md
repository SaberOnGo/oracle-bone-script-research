...
- External category reference: `evobc-cat-06941`
- Source category ID: `06941`
- Source label for human review: `聊`
- Source codepoints: `U+804A`
...
- `obs-evo-cand-006941-route-category-staging`
...
- `obs-evo-cand-006941-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006941-route-evolution-graph`
