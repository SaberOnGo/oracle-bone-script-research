# obs-char-000429 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000429`
- primary external id: `hust-obc-cat-0487`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/429_obs-char-000429_hust-obc-cat-0487_orac
  le-character/03_visual-assets/001_asset-000434_hust-obc-cat-0487_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0487/G_0487_合14070(甲).png`
- asset id: `asset-000434`
...
- source category: `0487`
- validation class: `428`
- source image route: `HUST-OBC/deciphered/0487/G_0487_合14070(甲).png`
- asset id: `asset-000434`
...
- English observation: `Several closely spaced narrow forms overlap
  visually; crossed upper strokes and multiple descending angled lines are
  visible, but boundaries are unclear.`
- 中文观察: `数个狭长形体间距很近并在视觉上重叠；可见上部交叉和多条下行斜线，边界不清。`
...
- dataset label text: `㗝`
- dataset label codepoints: `U+35DD`
...
- filename catalog route clues: `Heji-like filename clue: 合14070
  (G_0487_合14070(甲).png)`
...
- Which source records identify obs-char-000429 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000429？
