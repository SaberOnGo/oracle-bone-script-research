# obs-unk-004852 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004852`
- primary external id: `hust-obc-und-X-004852`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/052_obs-unk-004852_h
  ust-obc-und-X-004852_oracle-character-candidate/03_visual-assets/001_asset
  -006445_hust-obc-und-X-004852_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/408/X_？_7393_1.png`
- asset id: `asset-006445`
...
- source class: `HUST-OBC/undeciphered/X/408/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/408/X_？_7393_1.png`
- asset id: `asset-006445`
...
- English observation: `upper openings, central diagonal, and lower stroke`
- 中文观察: `上部开口、中部斜笔和下部横笔`
...
- Which source records identify obs-unk-004852 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004852？
