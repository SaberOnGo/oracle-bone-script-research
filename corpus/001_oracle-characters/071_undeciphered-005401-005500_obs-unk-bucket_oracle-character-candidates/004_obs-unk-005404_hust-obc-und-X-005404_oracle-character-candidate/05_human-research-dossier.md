# obs-unk-005404 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005404`
- primary external id: `hust-obc-und-X-005404`
...
- local review image route: `corpus/001_oracle-characters/071_undeciphered-005
  401-005500_obs-unk-bucket_oracle-character-candidates/004_obs-unk-005404_h
  ust-obc-und-X-005404_oracle-character-candidate/03_visual-assets/001_asset
  -006997_hust-obc-und-X-005404_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/960/X_？_7924_1.png`
- asset id: `asset-006997`
...
- source class: `HUST-OBC/undeciphered/X/960/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/960/X_？_7924_1.png`
- asset id: `asset-006997`
...
- Which source records identify obs-unk-005404 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005404？
