# Material Visual Observation / obs-comp-cand-002385 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002385`
- External reference / 外部参照: `obimd-sub-t2lqza150m`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020456_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ptserhps1f/t2lqza150m/t2lqza150m.png`
- Checksum / 校验和:
  `0d2d5850e7bbde5077d785e03e1b193afb76985d58608b695a859d9519adeefa`
...
- Marked-pixel bounds: (83,27)–(165,218); span 83 × 192 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.77%。
- 痕迹范围：(83,27)–(165,218)；跨度83 × 192 px；痕迹矩形高于宽。
