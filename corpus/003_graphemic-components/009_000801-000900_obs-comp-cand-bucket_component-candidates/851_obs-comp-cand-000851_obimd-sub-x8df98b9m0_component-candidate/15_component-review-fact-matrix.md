# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000851
...
| Glyph or codepoint route / 字形或码位路线 | 4 OBIMD route rows; examples U+F4C8D; U+F4C8E; 另有 2 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
