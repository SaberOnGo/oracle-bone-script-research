...
Project ID: `obs-evo-cand-002746`
...
- Project ID: `obs-evo-cand-002746`
- EVOBC category candidate ID: `evobc-evo-cat-02746`
- External category reference: `evobc-cat-02746`
- Source category ID: `02746`
- Source label for human review: `廂`
- Source codepoints: `U+5EC2`
...
- `obs-evo-cand-002746-route-category-staging`
...
- `obs-evo-cand-002746-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002746-route-evolution-graph`
