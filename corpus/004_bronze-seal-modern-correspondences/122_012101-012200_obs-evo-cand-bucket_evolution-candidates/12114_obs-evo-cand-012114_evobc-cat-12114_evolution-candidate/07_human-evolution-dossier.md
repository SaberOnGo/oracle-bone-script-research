...
- External category reference: `evobc-cat-12114`
- Source category ID: `12114`
- Source label for human review: `𦸉`
- Source codepoints: `U+26E09`
...
- `obs-evo-cand-012114-route-category-staging`
...
- `obs-evo-cand-012114-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012114-route-evolution-graph`
