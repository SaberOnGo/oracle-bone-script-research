# obs-evo-cand-004678 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-04678`
- Source label: `涉`
- Source codepoints: `U+6D89`
- Image reference count: `147`
- Era token counts: `BI:17;CS:1;OBC:105;SAC:1;SS:4;WSC:19`
- Source token counts: `Book:69;Web:78`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 105 image references
