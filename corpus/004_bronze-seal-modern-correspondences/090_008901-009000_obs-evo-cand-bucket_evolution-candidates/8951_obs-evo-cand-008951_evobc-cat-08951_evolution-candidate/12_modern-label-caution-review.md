# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008951
...
- EVOBC candidate category: `evobc-evo-cat-08951`.
- Source label for search only: `进`.
- Source codepoints for search only: `U+8FDB`.
