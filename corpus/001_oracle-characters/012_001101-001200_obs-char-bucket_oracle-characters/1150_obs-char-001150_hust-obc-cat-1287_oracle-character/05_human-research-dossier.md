# obs-char-001150 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001150`
- primary external id: `hust-obc-cat-1287`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1150_obs-char-001150_hust-obc-cat-1287_ora
  cle-character/03_visual-assets/001_asset-001155_hust-obc-cat-1287_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1287/G_1287_佚234(甲).png`
- asset id: `asset-001155`
...
- source category: `1287`
- validation class: `1149`
- source image route: `HUST-OBC/deciphered/1287/G_1287_佚234(甲).png`
- asset id: `asset-001155`
...
- English observation: `A compact upright cluster combines a pointed upper
  projection, a central vertical, several small enclosed side marks, and a
  lower curve.`
- 中文观察: `紧凑的直立笔群结合尖状上部外伸、中央竖笔、数个小型侧部闭合痕迹和下部弯笔。`
...
- dataset label text: `㣽`
- dataset label codepoints: `U+38FD`
...
- Which source records identify obs-char-001150 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001150？
