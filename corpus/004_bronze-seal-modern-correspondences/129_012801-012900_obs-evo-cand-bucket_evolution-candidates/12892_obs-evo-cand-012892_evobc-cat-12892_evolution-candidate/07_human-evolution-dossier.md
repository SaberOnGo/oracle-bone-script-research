...
Project ID: `obs-evo-cand-012892`
...
- Project ID: `obs-evo-cand-012892`
- EVOBC category candidate ID: `evobc-evo-cat-12892`
- External category reference: `evobc-cat-12892`
- Source category ID: `12892`
- Source label for human review: `𪼏`
- Source codepoints: `U+2AF0F`
...
- `obs-evo-cand-012892-route-category-staging`
...
- `obs-evo-cand-012892-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012892-route-evolution-graph`
