# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006804
...
- EVOBC candidate category: `evobc-evo-cat-06804`.
- Source label for search only: `罜`.
- Source codepoints for search only: `U+7F5C`.
