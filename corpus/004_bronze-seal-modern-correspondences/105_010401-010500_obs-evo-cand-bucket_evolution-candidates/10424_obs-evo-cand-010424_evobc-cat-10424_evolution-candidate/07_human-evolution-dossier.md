...
- External category reference: `evobc-cat-10424`
- Source category ID: `10424`
- Source label for human review: `鰂`
...
- `obs-evo-cand-010424-route-category-staging`
...
- `obs-evo-cand-010424-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010424-route-evolution-graph`
