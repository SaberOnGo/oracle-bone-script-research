# obs-unk-004605 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/005_obs-unk-004605_h
  ust-obc-und-X-004605_oracle-character-candidate/03_visual-assets/001_asset
  -006198_hust-obc-und-X-004605_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/161/X_？_8337_1.png`
- asset id: `asset-006198`
...
- source class: `HUST-OBC/undeciphered/X/161/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/161/X_？_8337_1.png`
- asset id: `asset-006198`
...
- English observation: `central curved trace, upper detached marks, lower split`
- 中文观察: `中央弯曲痕迹、上方分离痕迹和下部分叉已记录。`
...
- Which source records identify obs-unk-004605 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004605？
