# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004563
...
- EVOBC candidate category: `evobc-evo-cat-04563`.
- Source label for search only: `沼`.
- Source codepoints for search only: `U+6CBC`.
