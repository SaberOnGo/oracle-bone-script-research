# Material Visual Observation / obs-comp-cand-000722 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000722`
- External reference / 外部参照: `obimd-sub-bjuu7rps2w`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013449_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bjuu7rps2w/bjuu7rps2w/bjuu7rps2w.png`
- Checksum / 校验和:
  `0ee9235668f1b2242e9ba830b21e62032848c39b2fcd5817ca963c94ee99725e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.48%.
- Marked-pixel bounds: (87,29)–(162,221); span 76 × 193 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.48%。
- 痕迹范围：(87,29)–(162,221)；跨度76 × 193 px；痕迹矩形高于宽。
