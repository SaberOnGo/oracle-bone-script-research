# Material Visual Observation / obs-comp-cand-001536 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001536`
- External reference / 外部参照: `obimd-sub-nwi5rk9lkb`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016950_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/nwi5rk9lkb/nwi5rk9lkb/nwi5rk9lkb.png`
- Checksum / 校验和:
  `de1f80892b9799f67b62ae7836bacebf0f388baa46bb0b5f9f0413efac461e2c`
...
- Marked-pixel bounds: (83,36)–(162,215); span 80 × 180 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.28%。
- 痕迹范围：(83,36)–(162,215)；跨度80 × 180 px；痕迹矩形高于宽。
