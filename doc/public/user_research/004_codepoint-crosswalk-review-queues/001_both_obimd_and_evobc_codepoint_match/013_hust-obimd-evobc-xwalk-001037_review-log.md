...
- Review log draft ID / 复核日志草稿 ID: `codepoint-crosswalk-review-log-draft-013`
- Codepoint review task ID / codepoint 复核任务 ID: `codepoint-crosswalk-review-013`
...
- Crosswalk candidate ID / 交叉候选 ID: `hust-obimd-evobc-xwalk-001037`
- Suggested oracle character ID / 建议甲骨单字 ID: `obs-char-001037`
- Promotion queue ID / 提升队列 ID: `hust-obc-obs-char-promo-001037`
...
- HUST external ref / HUST 外部引用: `hust-obc-cat-1162`
- HUST label codepoints / HUST 标签 codepoint: `U+3880`
- OBIMD main candidates / OBIMD 主字候选: `obimd-main-cand-002325`
- EVOBC category candidates / EVOBC 类别候选: `evobc-evo-cat-00097`
- EVOBC image reference count / EVOBC 图像引用数: `22`
...
- `corpus/001_oracle-characters/011_001001-001100_obs-char-bucket_oracle-characters/001_hust-obc-candidate-packet-manifest.csv`
- `corpus/001_oracle-characters/011_001001-001100_obs-char-bucket_oracle-characters/1037_obs-char-001037_hust-obc-cat-1162_oracle-character/01_candidate-character-packet.json`
...
- Route availability ID: `codepoint-route-availability-013`
...
- Review task ID: `codepoint-crosswalk-review-013`
- Crosswalk candidate ID: `hust-obimd-evobc-xwalk-001037`
- Suggested oracle character ID: `obs-char-001037`
- HUST candidate packet ID: `hust-obc-candidate-packet-001037`
...
- OBIMD row count: `1`
- OBIMD source UIDs: `i9rq6029zl`
- OBIMD review statuses: `obimd-main-cand-002325=reviewed_metadata_only`
- OBIMD rights statuses: `obimd-main-cand-002325=licensed_for_repository`
- EVOBC row count: `1`
- EVOBC source category IDs: `00097`
- EVOBC has bronze refs: `false`
- EVOBC has seal refs: `false`
- EVOBC review statuses: `evobc-evo-cat-00097=reviewed_metadata_only`
- EVOBC rights statuses: `evobc-evo-cat-00097=source_marked_risk_noted`
...
- Does `hust-obimd-evobc-xwalk-001037` remain unpromoted and undeciphered?
