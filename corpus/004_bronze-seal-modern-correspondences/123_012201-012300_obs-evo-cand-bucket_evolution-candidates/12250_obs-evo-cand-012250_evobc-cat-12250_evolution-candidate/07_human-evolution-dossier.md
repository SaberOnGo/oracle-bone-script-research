...
- External category reference: `evobc-cat-12250`
- Source category ID: `12250`
- Source label for human review: `𧬜`
...
- `obs-evo-cand-012250-route-category-staging`
...
- `obs-evo-cand-012250-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012250-route-evolution-graph`
