...
Project ID: `obs-evo-cand-009466`
...
- Project ID: `obs-evo-cand-009466`
- EVOBC category candidate ID: `evobc-evo-cat-09466`
- External category reference: `evobc-cat-09466`
- Source category ID: `09466`
- Source label for human review: `鍴`
- Source codepoints: `U+9374`
...
- `obs-evo-cand-009466-route-category-staging`
...
- `obs-evo-cand-009466-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009466-route-evolution-graph`
