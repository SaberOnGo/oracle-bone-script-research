# obs-char-000001 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000001`
- primary external id: `hust-obc-cat-0001`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/001_obs-char-000001_hust-obc-cat-0001_orac
  le-character/03_visual-assets/001_asset-000006_hust-obc-cat-0001_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0001/G_0001_後2.36.5合33075𠂤歷間.pn
  g`
- asset id: `asset-000006`
...
- validation class: `0`
- source image route: `HUST-OBC/deciphered/0001/G_0001_後2.36.5合33075𠂤歷間.png`
- asset id: `asset-000006`
...
- English observation: `The narrow upright image shows a closed outer
  contour with diagonal and angular interior strokes.`
- 中文观察: `本图像呈狭长直立形，外侧有闭合轮廓，内部可见斜向和折角刻划。`
...
- dataset label text: `⺀`
- dataset label codepoints: `U+2E80`
...
- filename catalog route clues: `Heji-like filename clue: 合33075
  (G_0001_後2.36.5合33075𠂤歷間.png)`
...
- Which source records identify obs-char-000001 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000001？
