# obs-char-000208 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000208`
- primary external id: `hust-obc-cat-0231`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/208_obs-char-000208_hust-obc-cat-0231_orac
  le-character/03_visual-assets/001_asset-000213_hust-obc-cat-0231_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0231/G_0231_京都334A合6001賓組.png`
- asset id: `asset-000213`
...
- source category: `0231`
- validation class: `207`
- source image route: `HUST-OBC/deciphered/0231/G_0231_京都334A合6001賓組.png`
- asset id: `asset-000213`
...
- English observation: `The image has a long central vertical stroke, short
  branching marks on the left, and several small cross strokes along the
  right.`
- 中文观察: `图像中部有长竖主笔，左侧有短分支，右侧沿线分布数道小交叉笔。`
...
- dataset label text: `㓝`
- dataset label codepoints: `U+34DD`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00020`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00020`
- EvoBC image reference count / EvoBC 图像引用数: `23`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00020`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/020_obs-evo-can
  d-000020_evobc-cat-00020_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/020_obs-evo-cand-000020_evobc-cat-00020_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合6001
  (G_0231_京都334A合6001賓組.png)`
...
- Which source records identify obs-char-000208 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000208？
