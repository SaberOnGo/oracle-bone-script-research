# obs-unk-004490 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/090_obs-unk-004490_h
  ust-obc-und-X-004490_oracle-character-candidate/03_visual-assets/001_asset
  -006083_hust-obc-und-X-004490_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/46/X_？_8228_1.png`
- asset id: `asset-006083`
...
- source class: `HUST-OBC/undeciphered/X/46/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/46/X_？_8228_1.png`
- asset id: `asset-006083`
...
- English observation: `The tall arch, inner pointed stroke, lower opening,
  short left extension, and right descending trace are directly recorded.`
- 中文观察: `已直接记录高大弧形、内部尖出痕迹、下部开口、左侧短伸痕和右侧下垂痕。`
...
- Which source records identify obs-unk-004490 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004490？
