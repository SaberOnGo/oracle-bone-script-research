...
- External category reference: `evobc-cat-05596`
- Source category ID: `05596`
- Source label for human review: `疄`
- Source codepoints: `U+7584`
...
- `obs-evo-cand-005596-route-category-staging`
...
- `obs-evo-cand-005596-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005596-route-evolution-graph`
