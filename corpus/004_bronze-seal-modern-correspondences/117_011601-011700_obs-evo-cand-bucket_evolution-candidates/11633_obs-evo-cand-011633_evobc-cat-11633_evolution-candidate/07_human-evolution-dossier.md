...
Project ID: `obs-evo-cand-011633`
...
- Project ID: `obs-evo-cand-011633`
- EVOBC category candidate ID: `evobc-evo-cat-11633`
- External category reference: `evobc-cat-11633`
- Source category ID: `11633`
- Source label for human review: `𤣚`
- Source codepoints: `U+248DA`
...
- `obs-evo-cand-011633-route-category-staging`
...
- `obs-evo-cand-011633-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011633-route-evolution-graph`
