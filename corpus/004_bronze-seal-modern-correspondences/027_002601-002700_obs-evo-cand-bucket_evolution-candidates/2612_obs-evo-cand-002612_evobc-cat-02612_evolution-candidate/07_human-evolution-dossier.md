...
Project ID: `obs-evo-cand-002612`
...
- Project ID: `obs-evo-cand-002612`
- EVOBC category candidate ID: `evobc-evo-cat-02612`
- External category reference: `evobc-cat-02612`
- Source category ID: `02612`
- Source label for human review: `巟`
- Source codepoints: `U+5DDF`
...
- `obs-evo-cand-002612-route-category-staging`
...
- `obs-evo-cand-002612-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002612-route-evolution-graph`
