# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-005162
...
- EVOBC candidate category: `evobc-evo-cat-05162`.
- Source label for search only: `燿`.
- Source codepoints for search only: `U+71FF`.
