...
Project ID: `obs-evo-cand-005249`
...
- Project ID: `obs-evo-cand-005249`
- EVOBC category candidate ID: `evobc-evo-cat-05249`
- External category reference: `evobc-cat-05249`
- Source category ID: `05249`
- Source label for human review: `犯`
- Source codepoints: `U+72AF`
...
- `obs-evo-cand-005249-route-category-staging`
...
- `obs-evo-cand-005249-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005249-route-evolution-graph`
