# obs-comp-cand-002643 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002643`
- 首选外部 ID: `obimd-sub-ymikxh8lgo`
- OBIMD subcharacter UID: `ymikxh8lgo`
- OBIMD main character UID: `ymikxh8lgo`
- 来源 ID: `src-obimd`
...
- codepoint 示例: U+FEE57; U+FEE58; 另有 53 项
