...
- `obs-evo-cand-001595-route-category-staging`
...
- `obs-evo-cand-001595-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001595-route-evolution-graph`
