# Material Visual Observation / obs-comp-cand-001864 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001864`
- External reference / 外部参照: `obimd-sub-6v2cp9c21c`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018243_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/akwyl4gzy2/6v2cp9c21c/6v2cp9c21c.png`
- Checksum / 校验和:
  `93ab3ee58dfd035d1c03733b8962079837b7b1a111c167c3e2a247e211a01e0b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.53%.
- Marked-pixel bounds: (75,37)–(174,207); span 100 × 171 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.53%。
- 痕迹范围：(75,37)–(174,207)；跨度100 × 171 px；痕迹矩形高于宽。
