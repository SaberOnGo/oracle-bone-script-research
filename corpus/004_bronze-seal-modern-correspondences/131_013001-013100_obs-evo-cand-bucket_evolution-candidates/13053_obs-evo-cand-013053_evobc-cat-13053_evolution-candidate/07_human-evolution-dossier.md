...
Project ID: `obs-evo-cand-013053`
...
- Project ID: `obs-evo-cand-013053`
- EVOBC category candidate ID: `evobc-evo-cat-13053`
- External category reference: `evobc-cat-13053`
- Source category ID: `13053`
- Source label for human review: `𫪚`
- Source codepoints: `U+2BA9A`
...
- `obs-evo-cand-013053-route-category-staging`
...
- `obs-evo-cand-013053-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013053-route-evolution-graph`
