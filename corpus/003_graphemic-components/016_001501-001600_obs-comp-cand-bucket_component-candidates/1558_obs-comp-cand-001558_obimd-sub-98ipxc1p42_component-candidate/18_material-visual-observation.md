# Material Visual Observation / obs-comp-cand-001558 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001558`
- External reference / 外部参照: `obimd-sub-98ipxc1p42`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017105_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/98ipxc1p42/98ipxc1p42/98ipxc1p42.png`
- Checksum / 校验和:
  `2424fb0b129ef6e0eb76daf26a76e1ca875bde6c8b956810b7b32a63b38751d7`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.39%.
- Marked-pixel bounds: (62,30)–(189,215); span 128 × 186 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.39%。
- 痕迹范围：(62,30)–(189,215)；跨度128 × 186 px；痕迹矩形高于宽。
