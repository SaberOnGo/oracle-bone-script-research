# obs-comp-cand-002592 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002592`
- 首选外部 ID: `obimd-sub-yns30oi0mq`
- OBIMD subcharacter UID: `yns30oi0mq`
- OBIMD main character UID: `uu47abw0dl`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+FEAEB; U+FEAEC; 另有 2 项
