...
Project ID: `obs-evo-cand-012424`
...
- Project ID: `obs-evo-cand-012424`
- EVOBC category candidate ID: `evobc-evo-cat-12424`
- External category reference: `evobc-cat-12424`
- Source category ID: `12424`
- Source label for human review: `𨛏`
- Source codepoints: `U+286CF`
...
- `obs-evo-cand-012424-route-category-staging`
...
- `obs-evo-cand-012424-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012424-route-evolution-graph`
