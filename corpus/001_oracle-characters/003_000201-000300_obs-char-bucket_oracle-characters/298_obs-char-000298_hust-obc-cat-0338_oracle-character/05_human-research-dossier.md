# obs-char-000298 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000298`
- primary external id: `hust-obc-cat-0338`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/298_obs-char-000298_hust-obc-cat-0338_orac
  le-character/03_visual-assets/001_asset-000303_hust-obc-cat-0338_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0338/G_0338_七P108合41067.png`
- asset id: `asset-000303`
...
- source category: `0338`
- validation class: `297`
- source image route: `HUST-OBC/deciphered/0338/G_0338_七P108合41067.png`
- asset id: `asset-000303`
...
- English observation: `The narrow image contains several branching upright
  strokes and a lower rounded enclosure with a short horizontal interior
  mark.`
- 中文观察: `狭长图像含数道分支直立笔画，下部有带短内横画的圆弧闭合轮廓。`
...
- dataset label text: `㕈`
- dataset label codepoints: `U+3548`
...
- filename catalog route clues: `Heji-like filename clue: 合41067
  (G_0338_七P108合41067.png)`
...
- Which source records identify obs-char-000298 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000298？
