# Material Visual Observation / obs-comp-cand-002515 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002515`
- External reference / 外部参照: `obimd-sub-905tkjc9ui`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020839_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/905tkjc9ui/905tkjc9ui/905tkjc9ui.png`
- Checksum / 校验和:
  `acd162362214f1a3f9d57984287a8a23e400a6d349d839a5c547eb452e68a060`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.61%.
- Marked-pixel bounds: (95,41)–(153,206); span 59 × 166 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.61%。
- 痕迹范围：(95,41)–(153,206)；跨度59 × 166 px；痕迹矩形高于宽。
