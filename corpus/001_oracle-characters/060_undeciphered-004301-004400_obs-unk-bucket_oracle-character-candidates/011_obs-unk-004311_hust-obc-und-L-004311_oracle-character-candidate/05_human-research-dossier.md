# obs-unk-004311 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004311`
- primary external id: `hust-obc-und-L-004311`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/011_obs-unk-004311_h
  ust-obc-und-L-004311_oracle-character-candidate/03_visual-assets/001_asset
  -005904_hust-obc-und-L-004311_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4311/L_？_9507.jpg`
- asset id: `asset-005904`
...
- source class: `HUST-OBC/undeciphered/L/4311/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4311/L_？_9507.jpg`
- asset id: `asset-005904`
...
- English observation: `Upper loop, long diagonal, lower fan visible.`
- 中文观察: `上部小环、长斜痕和下部扇状痕迹可见。`
...
- Which source records identify obs-unk-004311 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004311？
