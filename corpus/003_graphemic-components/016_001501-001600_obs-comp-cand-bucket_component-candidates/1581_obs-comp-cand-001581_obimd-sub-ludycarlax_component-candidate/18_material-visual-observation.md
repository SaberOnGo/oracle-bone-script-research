# Material Visual Observation / obs-comp-cand-001581 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001581`
- External reference / 外部参照: `obimd-sub-ludycarlax`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017162_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/clwxtgnjpw/ludycarlax/ludycarlax.png`
- Checksum / 校验和:
  `a5a11bee35cbc7abf8c40059aa83954f8448794adf41f561d69d4e54a3dc53f3`
...
- Marked-pixel bounds: (70,39)–(179,210); span 110 × 172 px; the marked
...
- 痕迹范围：(70,39)–(179,210)；跨度110 × 172 px；痕迹矩形高于宽。
