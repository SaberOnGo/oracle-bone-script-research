...
- External category reference: `evobc-cat-13362`
- Source category ID: `13362`
- Source label for human review: `𬧿`
- Source codepoints: `U+2C9FF`
...
- `obs-evo-cand-013362-route-category-staging`
...
- `obs-evo-cand-013362-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013362-route-evolution-graph`
