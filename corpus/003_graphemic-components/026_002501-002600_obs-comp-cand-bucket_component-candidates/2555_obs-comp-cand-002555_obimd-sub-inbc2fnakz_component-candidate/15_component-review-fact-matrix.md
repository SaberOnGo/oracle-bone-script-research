# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002555
...
| Glyph or codepoint route / 字形或码位路线 | 2 OBIMD route rows; examples U+FE811; U+FE812 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
