# obs-char-000834 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000834`
- primary external id: `hust-obc-cat-0943`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/834_obs-char-000834_hust-obc-cat-0943_orac
  le-character/03_visual-assets/001_asset-000839_hust-obc-cat-0943_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0943/G_0943_甲骨文.png`
- asset id: `asset-000839`
...
- source category: `0943`
- validation class: `833`
- source image route: `HUST-OBC/deciphered/0943/G_0943_甲骨文.png`
- asset id: `asset-000839`
...
- English observation: `A shallow rounded enclosure at bottom has curved and
  upright strokes rising above it, with detached short marks near the top.`
- 中文观察: `底部浅圆弧闭合轮廓上方伸出弯曲和直立笔，顶部附近另有分离的短笔痕迹。`
...
- dataset label text: `㞥`
- dataset label codepoints: `U+37A5`
...
- Which source records identify obs-char-000834 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000834？
