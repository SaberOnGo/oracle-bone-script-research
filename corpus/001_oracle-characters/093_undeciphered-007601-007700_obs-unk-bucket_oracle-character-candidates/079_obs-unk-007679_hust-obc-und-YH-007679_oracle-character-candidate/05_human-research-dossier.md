# obs-unk-007679 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-007679`
- primary external id: `hust-obc-und-YH-007679`
...
- local review image route: `corpus/001_oracle-characters/093_undeciphered-007
  601-007700_obs-unk-bucket_oracle-character-candidates/079_obs-unk-007679_h
  ust-obc-und-YH-007679_oracle-character-candidate/03_visual-assets/001_asse
  t-009270_hust-obc-und-YH-007679_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6023E/H_？_6023E_0.png`
- asset id: `asset-009270`
...
- source class: `HUST-OBC/undeciphered/Y+H/6023E/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6023E/H_？_6023E_0.png`
- asset id: `asset-009270`
...
- Which source records identify obs-unk-007679 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007679？
