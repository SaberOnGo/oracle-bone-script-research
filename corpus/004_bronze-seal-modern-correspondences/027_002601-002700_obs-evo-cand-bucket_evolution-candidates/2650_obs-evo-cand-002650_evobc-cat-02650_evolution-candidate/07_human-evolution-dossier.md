...
- External category reference: `evobc-cat-02650`
- Source category ID: `02650`
- Source label for human review: `帙`
...
- `obs-evo-cand-002650-route-category-staging`
...
- `obs-evo-cand-002650-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002650-route-evolution-graph`
