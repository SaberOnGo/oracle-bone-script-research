# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002641
...
- EVOBC candidate category: `evobc-evo-cat-02641`.
- Source label for search only: `帊`.
- Source codepoints for search only: `U+5E0A`.
