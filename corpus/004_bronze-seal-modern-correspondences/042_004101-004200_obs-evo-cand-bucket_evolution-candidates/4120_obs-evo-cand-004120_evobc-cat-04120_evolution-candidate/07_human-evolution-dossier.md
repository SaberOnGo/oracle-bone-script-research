...
Project ID: `obs-evo-cand-004120`
...
- Project ID: `obs-evo-cand-004120`
- EVOBC category candidate ID: `evobc-evo-cat-04120`
- External category reference: `evobc-cat-04120`
- Source category ID: `04120`
- Source label for human review: `椌`
- Source codepoints: `U+690C`
...
- `obs-evo-cand-004120-route-category-staging`
...
- `obs-evo-cand-004120-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004120-route-evolution-graph`
