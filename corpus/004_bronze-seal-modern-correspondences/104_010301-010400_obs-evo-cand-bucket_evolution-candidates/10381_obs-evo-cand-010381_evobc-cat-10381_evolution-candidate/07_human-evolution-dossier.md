...
- External category reference: `evobc-cat-10381`
- Source category ID: `10381`
- Source label for human review: `魿`
- Source codepoints: `U+9B7F`
...
- `obs-evo-cand-010381-route-category-staging`
...
- `obs-evo-cand-010381-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010381-route-evolution-graph`
