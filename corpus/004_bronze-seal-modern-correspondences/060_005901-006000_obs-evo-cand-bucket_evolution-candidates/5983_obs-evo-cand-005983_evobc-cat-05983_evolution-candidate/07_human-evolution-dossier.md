...
- External category reference: `evobc-cat-05983`
- Source category ID: `05983`
- Source label for human review: `祕`
...
- `obs-evo-cand-005983-route-category-staging`
...
- `obs-evo-cand-005983-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005983-route-evolution-graph`
