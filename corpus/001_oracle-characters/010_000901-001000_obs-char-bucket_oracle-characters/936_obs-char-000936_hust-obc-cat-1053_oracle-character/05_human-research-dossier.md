# obs-char-000936 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/936_obs-char-000936_hust-obc-cat-1053_orac
  le-character/03_visual-assets/001_asset-000941_hust-obc-cat-1053_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1053/G_1053_甲58(甲).png`
- asset id: `asset-000941`
...
- source category: `1053`
- validation class: `935`
- source image route: `HUST-OBC/deciphered/1053/G_1053_甲58(甲).png`
- asset id: `asset-000941`
...
- English observation: `A very small thin form has two short angled upper
  marks and a lower forked stem; image detail is limited.`
...
- dataset label text: `㠓`
- dataset label codepoints: `U+3813`
...
- Which source records identify obs-char-000936 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000936？
