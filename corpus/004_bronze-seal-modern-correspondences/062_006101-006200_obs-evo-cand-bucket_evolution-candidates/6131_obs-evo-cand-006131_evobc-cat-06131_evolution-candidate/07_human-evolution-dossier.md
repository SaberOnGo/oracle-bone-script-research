...
Project ID: `obs-evo-cand-006131`
...
- Project ID: `obs-evo-cand-006131`
- EVOBC category candidate ID: `evobc-evo-cat-06131`
- External category reference: `evobc-cat-06131`
- Source category ID: `06131`
- Source label for human review: `穗`
- Source codepoints: `U+7A57`
...
- `obs-evo-cand-006131-route-category-staging`
...
- `obs-evo-cand-006131-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006131-route-evolution-graph`
