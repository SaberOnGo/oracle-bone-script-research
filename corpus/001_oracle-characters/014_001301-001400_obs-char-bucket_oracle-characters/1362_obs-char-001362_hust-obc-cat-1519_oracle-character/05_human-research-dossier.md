# obs-char-001362 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1362_obs-char-001362_hust-obc-cat-1519_ora
  cle-character/03_visual-assets/001_asset-001367_hust-obc-cat-1519_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1519/G_1519_乙4821合201賓組.png`
- asset id: `asset-001367`
...
- source category: `1519`
- validation class: `1361`
- source image route: `HUST-OBC/deciphered/1519/G_1519_乙4821合201賓組.png`
- asset id: `asset-001367`
...
- English observation: `A narrow form has an upper rectangular enclosure and
  a long lower stroke.`
- 中文观察: `狭长形体有上部矩形框形和长下部笔画。`
...
- dataset label text: `㧥`
- dataset label codepoints: `U+39E5`
...
- filename catalog route clues: `Heji-like filename clue: 合201
  (G_1519_乙4821合201賓組.png)`
...
- Which source records identify obs-char-001362 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001362？
