# Material Visual Observation / obs-comp-cand-000685 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000685`
- External reference / 外部参照: `obimd-sub-hxbszp3ept`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013284_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hxbszp3ept/hxbszp3ept/hxbszp3ept.png`
- Checksum / 校验和:
  `b89c951f2524be6e11692cf516003e5444d1d467b3cde3157cfdbc8528249553`
...
- Marked-pixel bounds: (40,28)–(199,224); span 160 × 197 px; the marked
...
- 痕迹范围：(40,28)–(199,224)；跨度160 × 197 px；痕迹矩形高于宽。
