...
- Project ID: `obs-evo-cand-012497`
- EVOBC category candidate ID: `evobc-evo-cat-12497`
- External category reference: `evobc-cat-12497`
- Source category ID: `12497`
- Source label for human review: `𨯙`
- Source codepoints: `U+28BD9`
...
- `obs-evo-cand-012497-route-category-staging`
...
- `obs-evo-cand-012497-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012497-route-evolution-graph`
