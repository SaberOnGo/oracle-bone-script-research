# Material Visual Observation / obs-comp-cand-000198 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000198`
- External reference / 外部参照: `obimd-sub-1mu6nprj45`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011759_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1mu6nprj45/1mu6nprj45/1mu6nprj45.png`
- Checksum / 校验和:
  `6ab73c4a2b7285c135838df4156bd5e771e62f8e97d172518560f571f080d510`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.36%.
- Marked-pixel bounds: (80,21)–(169,228); span 90 × 208 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.36%。
- 痕迹范围：(80,21)–(169,228)；跨度90 × 208 px；痕迹矩形高于宽。
