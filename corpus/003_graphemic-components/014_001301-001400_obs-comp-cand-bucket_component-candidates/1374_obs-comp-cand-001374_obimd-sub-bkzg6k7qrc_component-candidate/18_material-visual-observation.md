# Material Visual Observation / obs-comp-cand-001374 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001374`
- External reference / 外部参照: `obimd-sub-bkzg6k7qrc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015793_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/73ru6libmk/bkzg6k7qrc/bkzg6k7qrc.png`
- Checksum / 校验和:
  `2233cf2260f062e745ff477a1efa8556db3d6b4feaf56cd7ff1e615791fa3651`
...
- Marked-pixel bounds: (86,38)–(163,206); span 78 × 169 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.36%。
- 痕迹范围：(86,38)–(163,206)；跨度78 × 169 px；痕迹矩形高于宽。
