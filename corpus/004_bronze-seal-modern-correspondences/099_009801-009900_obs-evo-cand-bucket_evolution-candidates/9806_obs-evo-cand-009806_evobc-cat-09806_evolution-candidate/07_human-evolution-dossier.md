...
Project ID: `obs-evo-cand-009806`
...
- Project ID: `obs-evo-cand-009806`
- EVOBC category candidate ID: `evobc-evo-cat-09806`
- External category reference: `evobc-cat-09806`
- Source category ID: `09806`
- Source label for human review: `集`
- Source codepoints: `U+96C6`
...
- `obs-evo-cand-009806-route-category-staging`
...
- `obs-evo-cand-009806-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009806-route-evolution-graph`
