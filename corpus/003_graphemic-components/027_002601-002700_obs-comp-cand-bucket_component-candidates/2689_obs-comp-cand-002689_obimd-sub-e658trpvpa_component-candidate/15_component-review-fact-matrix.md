# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002689
...
| Glyph or codepoint route / 字形或码位路线 | 9 OBIMD route rows; examples U+FF284; U+FF285; 另有 7 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
