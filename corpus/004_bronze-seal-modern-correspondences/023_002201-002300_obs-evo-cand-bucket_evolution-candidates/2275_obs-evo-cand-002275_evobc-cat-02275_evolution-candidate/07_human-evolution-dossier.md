...
- External category reference: `evobc-cat-02275`
- Source category ID: `02275`
- Source label for human review: `嫪`
...
- `obs-evo-cand-002275-route-category-staging`
...
- `obs-evo-cand-002275-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002275-route-evolution-graph`
