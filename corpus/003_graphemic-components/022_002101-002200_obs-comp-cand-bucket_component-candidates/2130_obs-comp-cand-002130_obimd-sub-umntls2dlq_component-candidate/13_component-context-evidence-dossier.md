# obs-comp-cand-002130 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002130`
- 首选外部 ID: `obimd-sub-umntls2dlq`
- OBIMD subcharacter UID: `umntls2dlq`
- OBIMD main character UID: `umntls2dlq`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+FC4B9; U+FC4BA; 另有 1 项
