...
- Project ID: `obs-evo-cand-002484`
- EVOBC category candidate ID: `evobc-evo-cat-02484`
- External category reference: `evobc-cat-02484`
- Source category ID: `02484`
- Source label for human review: `就`
- Source codepoints: `U+5C31`
...
- `obs-evo-cand-002484-route-category-staging`
...
- `obs-evo-cand-002484-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002484-route-evolution-graph`
