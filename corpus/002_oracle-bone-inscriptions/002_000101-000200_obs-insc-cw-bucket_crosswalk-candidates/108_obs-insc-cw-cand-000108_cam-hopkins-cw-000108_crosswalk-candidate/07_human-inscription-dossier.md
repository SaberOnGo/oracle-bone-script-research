...
- Yingguo / 英国所藏: `y608` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `52` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `521` in source row; primary catalog entry pending
- Heji / 合集: `39514` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000108`
