# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002233
...
- EVOBC candidate category: `evobc-evo-cat-02233`.
- Source label for search only: `媛`.
- Source codepoints for search only: `U+5A9B`.
