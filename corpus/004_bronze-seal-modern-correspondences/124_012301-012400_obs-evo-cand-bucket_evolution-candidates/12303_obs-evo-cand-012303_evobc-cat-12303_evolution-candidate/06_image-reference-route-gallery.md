...
- `obs-evo-cand-012303-route-category-staging`
...
- `obs-evo-cand-012303-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012303-route-evolution-graph`
