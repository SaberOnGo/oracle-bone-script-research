...
Project ID: `obs-evo-cand-009251`
...
- Project ID: `obs-evo-cand-009251`
- EVOBC category candidate ID: `evobc-evo-cat-09251`
- External category reference: `evobc-cat-09251`
- Source category ID: `09251`
- Source label for human review: `酪`
- Source codepoints: `U+916A`
...
- `obs-evo-cand-009251-route-category-staging`
...
- `obs-evo-cand-009251-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009251-route-evolution-graph`
