...
- External category reference: `evobc-cat-02187`
- Source category ID: `02187`
- Source label for human review: `娿`
- Source codepoints: `U+5A3F`
...
- `obs-evo-cand-002187-route-category-staging`
...
- `obs-evo-cand-002187-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002187-route-evolution-graph`
