...
- External category reference: `evobc-cat-02054`
- Source category ID: `02054`
- Source label for human review: `奭`
- Source codepoints: `U+596D`
...
- `obs-evo-cand-002054-route-category-staging`
...
- `obs-evo-cand-002054-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002054-route-evolution-graph`
