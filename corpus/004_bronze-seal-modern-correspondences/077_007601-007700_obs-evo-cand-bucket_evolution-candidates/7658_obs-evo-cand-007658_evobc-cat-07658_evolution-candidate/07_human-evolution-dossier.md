...
- External category reference: `evobc-cat-07658`
- Source category ID: `07658`
- Source label for human review: `藻`
...
- `obs-evo-cand-007658-route-category-staging`
...
- `obs-evo-cand-007658-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007658-route-evolution-graph`
