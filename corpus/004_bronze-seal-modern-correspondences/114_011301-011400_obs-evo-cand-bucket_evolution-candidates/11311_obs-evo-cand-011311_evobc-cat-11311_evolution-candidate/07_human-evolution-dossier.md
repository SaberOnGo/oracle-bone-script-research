...
Project ID: `obs-evo-cand-011311`
...
- Project ID: `obs-evo-cand-011311`
- EVOBC category candidate ID: `evobc-evo-cat-11311`
- External category reference: `evobc-cat-11311`
- Source category ID: `11311`
- Source label for human review: `𢯹`
- Source codepoints: `U+22BF9`
...
- `obs-evo-cand-011311-route-category-staging`
...
- `obs-evo-cand-011311-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011311-route-evolution-graph`
