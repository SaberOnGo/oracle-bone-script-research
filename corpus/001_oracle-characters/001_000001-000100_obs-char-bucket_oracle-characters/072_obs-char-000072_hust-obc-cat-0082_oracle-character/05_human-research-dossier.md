# obs-char-000072 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/072_obs-char-000072_hust-obc-cat-0082_orac
  le-character/03_visual-assets/001_asset-000077_hust-obc-cat-0082_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0082/G_0082_乙7795合6834賓組.png`
- asset id: `asset-000077`
...
- source category: `0082`
- validation class: `71`
- source image route: `HUST-OBC/deciphered/0082/G_0082_乙7795合6834賓組.png`
- asset id: `asset-000077`
...
- English observation: `The small image shows a rounded rectangular
  enclosure with a continuous dark outer stroke.`
- 中文观察: `小型图像呈圆角长方形闭合框，外缘为连续深色笔画。`
...
- dataset label text: `㑈`
- dataset label codepoints: `U+3448`
...
- Which source records identify obs-char-000072 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000072？
