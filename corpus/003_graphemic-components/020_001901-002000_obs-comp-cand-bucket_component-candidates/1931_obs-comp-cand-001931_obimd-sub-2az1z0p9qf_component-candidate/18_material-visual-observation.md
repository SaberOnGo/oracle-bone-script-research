# Material Visual Observation / obs-comp-cand-001931 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001931`
- External reference / 外部参照: `obimd-sub-2az1z0p9qf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018717_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/52a130pcmy/2az1z0p9qf/2az1z0p9qf.png`
- Checksum / 校验和:
  `4be1f9595fd39668cc2213f499a1316f3d1aed8773787ffd36046c4c27b86bd0`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.77%.
- Marked-pixel bounds: (82,21)–(166,228); span 85 × 208 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.77%。
- 痕迹范围：(82,21)–(166,228)；跨度85 × 208 px；痕迹矩形高于宽。
