# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006791
...
- EVOBC candidate category: `evobc-evo-cat-06791`.
- Source label for search only: `罊`.
- Source codepoints for search only: `U+7F4A`.
