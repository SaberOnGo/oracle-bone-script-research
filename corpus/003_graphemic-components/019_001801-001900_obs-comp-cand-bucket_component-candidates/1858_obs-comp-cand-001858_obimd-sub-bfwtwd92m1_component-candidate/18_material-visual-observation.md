# Material Visual Observation / obs-comp-cand-001858 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001858`
- External reference / 外部参照: `obimd-sub-bfwtwd92m1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018237_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bfwtwd92m1/bfwtwd92m1/bfwtwd92m1.png`
- Checksum / 校验和:
  `73ed551a54632d4b0cf3f5e503b5a80a9aff42f11a178fd52b0b9dfcc69983cc`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.08%.
- Marked-pixel bounds: (39,34)–(212,218); span 174 × 185 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.08%。
- 痕迹范围：(39,34)–(212,218)；跨度174 × 185 px；痕迹矩形近方形。
