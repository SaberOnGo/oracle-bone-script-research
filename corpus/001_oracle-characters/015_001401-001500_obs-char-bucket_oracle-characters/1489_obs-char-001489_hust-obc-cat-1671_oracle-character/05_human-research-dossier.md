# obs-char-001489 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001489`
- primary external id: `hust-obc-cat-1671`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1489_obs-char-001489_hust-obc-cat-1671_ora
  cle-character/03_visual-assets/001_asset-001494_hust-obc-cat-1671_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1671/G_1671_前2.18.6合8189賓組.png`
- asset id: `asset-001494`
...
- source category: `1671`
- validation class: `1488`
- source image route: `HUST-OBC/deciphered/1671/G_1671_前2.18.6合8189賓組.png`
- asset id: `asset-001494`
...
- English observation: `A small upper loop leads to a compact middle
  enclosure and long stem.`
- 中文观察: `小型上部环形连接紧凑中部框形和长竖干。`
...
- dataset label text: `㩽`
- dataset label codepoints: `U+3A7D`
...
- filename catalog route clues: `Heji-like filename clue: 合8189
...
- Which source records identify obs-char-001489 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001489？
