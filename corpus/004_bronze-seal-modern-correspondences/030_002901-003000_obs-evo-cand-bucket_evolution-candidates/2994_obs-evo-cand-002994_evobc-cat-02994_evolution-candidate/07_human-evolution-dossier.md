...
Project ID: `obs-evo-cand-002994`
...
- Project ID: `obs-evo-cand-002994`
- EVOBC category candidate ID: `evobc-evo-cat-02994`
- External category reference: `evobc-cat-02994`
- Source category ID: `02994`
- Source label for human review: `恷`
- Source codepoints: `U+6077`
...
- `obs-evo-cand-002994-route-category-staging`
...
- `obs-evo-cand-002994-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002994-route-evolution-graph`
