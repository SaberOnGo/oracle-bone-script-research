...
- External category reference: `evobc-cat-10391`
- Source category ID: `10391`
- Source label for human review: `鮑`
- Source codepoints: `U+9B91`
...
- `obs-evo-cand-010391-route-category-staging`
...
- `obs-evo-cand-010391-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010391-route-evolution-graph`
