...
Project ID: `obs-evo-cand-001305`
...
- Project ID: `obs-evo-cand-001305`
- EVOBC category candidate ID: `evobc-evo-cat-01305`
- External category reference: `evobc-cat-01305`
- Source category ID: `01305`
- Source label for human review: `勤`
- Source codepoints: `U+52E4`
...
- `obs-evo-cand-001305-route-category-staging`
...
- `obs-evo-cand-001305-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001305-route-evolution-graph`
