...
- External category reference: `evobc-cat-06933`
- Source category ID: `06933`
- Source label for human review: `耼`
...
- `obs-evo-cand-006933-route-category-staging`
...
- `obs-evo-cand-006933-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006933-route-evolution-graph`
