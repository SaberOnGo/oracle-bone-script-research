# obs-evo-cand-002652 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-002652`
- EVOBC category candidate ID: `evobc-evo-cat-02652`
- External category ref: `evobc-cat-02652`
- Source label: `帛`
- Source codepoints: `U+5E1B`
- Image reference count: `71`
- Era token counts: `BI:17;OBC:29;SAC:2;SS:1;WSC:22`
- Source token counts: `Book:24;Web:47`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 29 image references
...
- source 1 / Web:105952;說文Web:58: 24 image references
