...
- External category reference: `evobc-cat-09024`
- Source category ID: `09024`
- Source label for human review: `遇`
- Source codepoints: `U+9047`
...
- `obs-evo-cand-009024-route-category-staging`
...
- `obs-evo-cand-009024-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009024-route-evolution-graph`
