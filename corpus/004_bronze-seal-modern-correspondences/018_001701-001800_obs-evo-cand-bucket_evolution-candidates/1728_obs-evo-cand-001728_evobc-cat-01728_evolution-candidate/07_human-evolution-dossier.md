...
- External category reference: `evobc-cat-01728`
- Source category ID: `01728`
...
- `obs-evo-cand-001728-route-category-staging`
...
- `obs-evo-cand-001728-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001728-route-evolution-graph`
