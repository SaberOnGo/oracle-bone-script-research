...
Project ID: `obs-evo-cand-012852`
...
- Project ID: `obs-evo-cand-012852`
- EVOBC category candidate ID: `evobc-evo-cat-12852`
- External category reference: `evobc-cat-12852`
- Source category ID: `12852`
- Source label for human review: `𪬹`
- Source codepoints: `U+2AB39`
...
- `obs-evo-cand-012852-route-category-staging`
...
- `obs-evo-cand-012852-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012852-route-evolution-graph`
