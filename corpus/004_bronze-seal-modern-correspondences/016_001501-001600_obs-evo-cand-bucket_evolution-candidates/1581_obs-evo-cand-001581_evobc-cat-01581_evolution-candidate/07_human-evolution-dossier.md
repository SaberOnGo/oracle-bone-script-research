...
- External category reference: `evobc-cat-01581`
- Source category ID: `01581`
- Source label for human review: `哇`
- Source codepoints: `U+54C7`
...
- `obs-evo-cand-001581-route-category-staging`
...
- `obs-evo-cand-001581-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001581-route-evolution-graph`
