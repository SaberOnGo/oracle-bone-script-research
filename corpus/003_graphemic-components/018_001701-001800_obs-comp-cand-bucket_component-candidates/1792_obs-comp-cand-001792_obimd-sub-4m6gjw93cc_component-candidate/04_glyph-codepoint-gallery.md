# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001792
...
| --- | --- | --- | --- |
| `obimd-glyph-link-027409` | 󺓙 | `U+FA4D9` | `reviewed_metadata_only` |
| `obimd-glyph-link-027410` | 󺓚 | `U+FA4DA` | `reviewed_metadata_only` |
