# obs-char-000201 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/201_obs-char-000201_hust-obc-cat-0224_orac
  le-character/03_visual-assets/001_asset-000206_hust-obc-cat-0224_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0224/G_0224_甲骨文0.png`
- asset id: `asset-000206`
...
- source category: `0224`
- validation class: `200`
- source image route: `HUST-OBC/deciphered/0224/G_0224_甲骨文0.png`
- asset id: `asset-000206`
...
- English observation: `The image has a broad angular upper form, a long
  descending stroke on the right, and a pointed lower-left projection.`
- 中文观察: `图像上方有宽折角形，右侧有长下行笔，左下方有尖状伸出笔。`
...
- dataset label text: `㓖`
- dataset label codepoints: `U+34D6`
...
- Which source records identify obs-char-000201 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000201？
