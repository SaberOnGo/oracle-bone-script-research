...
- External category reference: `evobc-cat-01596`
- Source category ID: `01596`
- Source label for human review: `哽`
...
- `obs-evo-cand-001596-route-category-staging`
...
- `obs-evo-cand-001596-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001596-route-evolution-graph`
