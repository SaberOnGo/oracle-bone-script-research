# obs-char-000115 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000115`
- primary external id: `hust-obc-cat-0129`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/115_obs-char-000115_hust-obc-cat-0129_orac
  le-character/03_visual-assets/001_asset-000120_hust-obc-cat-0129_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0129/G_0129_乙7795(甲).png`
- asset id: `asset-000120`
...
- source category: `0129`
- validation class: `114`
- source image route: `HUST-OBC/deciphered/0129/G_0129_乙7795(甲).png`
- asset id: `asset-000120`
...
- English observation: `The tall image has a broad upper horizontal stroke,
  a descending central stroke, and a long curved stroke running down the
  right side.`
- 中文观察: `高形图像上方有宽横笔，中部向下有主笔，右侧沿下方延伸一条长弯曲笔。`
...
- dataset label text: `㑷`
- dataset label codepoints: `U+3477`
...
- Which source records identify obs-char-000115 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000115？
