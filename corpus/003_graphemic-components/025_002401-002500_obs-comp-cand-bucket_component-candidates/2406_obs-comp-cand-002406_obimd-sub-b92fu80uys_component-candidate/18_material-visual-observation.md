# Material Visual Observation / obs-comp-cand-002406 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002406`
- External reference / 外部参照: `obimd-sub-b92fu80uys`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020477_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/b92fu80uys/b92fu80uys/b92fu80uys.png`
- Checksum / 校验和:
  `189e387253ca482b8016684732638e57fe00fda9ad8b0632c1e73c40eff66aa1`
...
- Marked-pixel bounds: (76,44)–(173,207); span 98 × 164 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.12%。
- 痕迹范围：(76,44)–(173,207)；跨度98 × 164 px；痕迹矩形高于宽。
