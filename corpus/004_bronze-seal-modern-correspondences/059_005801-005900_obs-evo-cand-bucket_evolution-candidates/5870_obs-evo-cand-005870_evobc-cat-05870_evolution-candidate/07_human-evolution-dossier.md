...
- External category reference: `evobc-cat-05870`
- Source category ID: `05870`
- Source label for human review: `矏`
...
- `obs-evo-cand-005870-route-category-staging`
...
- `obs-evo-cand-005870-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005870-route-evolution-graph`
