# obs-char-001140 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001140`
- primary external id: `hust-obc-cat-1274`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1140_obs-char-001140_hust-obc-cat-1274_ora
  cle-character/03_visual-assets/001_asset-001145_hust-obc-cat-1274_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1274/G_1274_京津4359合30525.png`
- asset id: `asset-001145`
...
- source category: `1274`
- validation class: `1139`
- source image route: `HUST-OBC/deciphered/1274/G_1274_京津4359合30525.png`
- asset id: `asset-001145`
...
- English observation: `A narrow upright form has a central crossing, two
  short upper branches, and a long lower descending stroke.`
...
- dataset label text: `㣰`
- dataset label codepoints: `U+38F0`
...
- filename catalog route clues: `Heji-like filename clue: 合30525
...
- Which source records identify obs-char-001140 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001140？
