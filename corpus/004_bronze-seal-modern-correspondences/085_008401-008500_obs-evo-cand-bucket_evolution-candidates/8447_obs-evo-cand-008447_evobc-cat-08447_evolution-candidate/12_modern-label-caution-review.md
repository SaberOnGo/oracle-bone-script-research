# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008447
...
- EVOBC candidate category: `evobc-evo-cat-08447`.
- Source label for search only: `调`.
- Source codepoints for search only: `U+8C03`.
