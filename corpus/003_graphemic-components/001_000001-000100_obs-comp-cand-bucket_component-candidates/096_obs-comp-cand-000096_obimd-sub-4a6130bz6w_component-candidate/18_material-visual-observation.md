# Material Visual Observation / obs-comp-cand-000096 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000096`
- External reference / 外部参照: `obimd-sub-4a6130bz6w`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011508_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4a6130bz6w/4a6130bz6w/4a6130bz6w.png`
- Checksum / 校验和:
  `0344eec8fb987eee686622f37ad65d8098c1af9ef2336bdb09b4ece9fadb3f88`
...
- Marked-pixel bounds: (70,29)–(179,208); span 110 × 180 px; the marked
...
- 痕迹范围：(70,29)–(179,208)；跨度110 × 180 px；痕迹矩形高于宽。
