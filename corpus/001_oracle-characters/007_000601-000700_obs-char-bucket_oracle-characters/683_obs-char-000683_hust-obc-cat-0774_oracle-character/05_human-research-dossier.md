# obs-char-000683 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/683_obs-char-000683_hust-obc-cat-0774_orac
  le-character/03_visual-assets/001_asset-000688_hust-obc-cat-0774_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0774/G_0774_京津4036合27308無名組.png
  `
- asset id: `asset-000688`
...
- source category: `0774`
- validation class: `682`
- source image route: `HUST-OBC/deciphered/0774/G_0774_京津4036合27308無名組.png`
- asset id: `asset-000688`
...
- English observation: `Two detached rounded rectangular outlines are
  stacked vertically; the larger upper one contains a short horizontal bar,
  while the smaller lower one is open and empty inside.`
...
- dataset label text: `㛼`
- dataset label codepoints: `U+36FC`
...
- filename catalog route clues: `Heji-like filename clue: 合27308
...
- Which source records identify obs-char-000683 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000683？
