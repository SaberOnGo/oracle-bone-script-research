# obs-unk-004465 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004465`
- primary external id: `hust-obc-und-X-004465`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/065_obs-unk-004465_h
  ust-obc-und-X-004465_oracle-character-candidate/03_visual-assets/001_asset
  -006058_hust-obc-und-X-004465_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/21/X_？_8200_1.png`
- asset id: `asset-006058`
...
- source class: `HUST-OBC/undeciphered/X/21/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/21/X_？_8200_1.png`
- asset id: `asset-006058`
...
- English observation: A broad upper bar with small openings leads to a narrow
  stem and split lower side traces.
- 中文观察: 宽上横线含小开口，下接窄长中部和分开的下部侧痕。
...
- Which source records identify obs-unk-004465 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004465？
