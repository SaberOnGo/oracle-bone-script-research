# obs-unk-007741 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/094_undeciphered-007
  701-007800_obs-unk-bucket_oracle-character-candidates/041_obs-unk-007741_h
  ust-obc-und-YH-007741_oracle-character-candidate/03_visual-assets/001_asse
  t-009332_hust-obc-und-YH-007741_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/602CD/H_？_602CD_0.png`
- asset id: `asset-009332`
...
- source class: `HUST-OBC/undeciphered/Y+H/602CD/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/602CD/H_？_602CD_0.png`
- asset id: `asset-009332`
...
- Which source records identify obs-unk-007741 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007741？
