# Material Visual Observation / obs-comp-cand-000892 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000892`
- External reference / 外部参照: `obimd-sub-rrua1697nb`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013964_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rrua1697nb/rrua1697nb/rrua1697nb.png`
- Checksum / 校验和:
  `486389f7e6c4f96ef29eae95d0ed137cdfda208b978f2ef5673ced953c4a4427`
...
- Marked-pixel bounds: (75,30)–(174,221); span 100 × 192 px; the marked
...
- 痕迹范围：(75,30)–(174,221)；跨度100 × 192 px；痕迹矩形高于宽。
