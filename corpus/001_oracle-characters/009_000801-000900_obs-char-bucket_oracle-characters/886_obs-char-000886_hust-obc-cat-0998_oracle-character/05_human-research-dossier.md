# obs-char-000886 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/886_obs-char-000886_hust-obc-cat-0998_orac
  le-character/03_visual-assets/001_asset-000891_hust-obc-cat-0998_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0998/G_0998_前2.28.4(甲).png`
- asset id: `asset-000891`
...
- source category: `0998`
- validation class: `885`
- source image route: `HUST-OBC/deciphered/0998/G_0998_前2.28.4(甲).png`
- asset id: `asset-000891`
...
- English observation: `A curved upright at left stands beside an angular
  open mark and a rounded enclosed form at right with a short upper
  projection.`
- 中文观察: `左侧弯曲直立笔旁有折角开口痕迹，右侧有带短上伸笔的圆弧闭合形体。`
...
- dataset label text: `㟜`
- dataset label codepoints: `U+37DC`
...
- Which source records identify obs-char-000886 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000886？
