...
- External category reference: `evobc-cat-08744`
- Source category ID: `08744`
- Source label for human review: `踸`
...
- `obs-evo-cand-008744-route-category-staging`
...
- `obs-evo-cand-008744-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008744-route-evolution-graph`
