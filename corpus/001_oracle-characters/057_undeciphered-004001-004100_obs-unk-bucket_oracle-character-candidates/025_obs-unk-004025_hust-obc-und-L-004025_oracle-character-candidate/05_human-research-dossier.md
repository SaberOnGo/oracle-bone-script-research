# obs-unk-004025 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004025`
- primary external id: `hust-obc-und-L-004025`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/025_obs-unk-004025_h
  ust-obc-und-L-004025_oracle-character-candidate/03_visual-assets/001_asset
  -005618_hust-obc-und-L-004025_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4025/L_？_8597.jpg`
- asset id: `asset-005618`
...
- source class: `HUST-OBC/undeciphered/L/4025/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4025/L_？_8597.jpg`
- asset id: `asset-005618`
...
- English observation: A tall narrow contour runs along the right side. Near
  the lower left is a compact loop-like area crossed by horizontal traces,
  with a small separate mark above. The crop leaves the relation uncertain.
- 中文观察：右侧有高而窄的轮廓；左下方有紧凑的环状区域，其中横过数条痕迹，
    上方另有小型分离痕。图像未明确这些痕迹的关系。
...
- Which source records identify obs-unk-004025 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004025？
