# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010514
...
- EVOBC candidate category: `evobc-evo-cat-10514`.
- Source label for search only: `鵜`.
- Source codepoints for search only: `U+9D5C`.
