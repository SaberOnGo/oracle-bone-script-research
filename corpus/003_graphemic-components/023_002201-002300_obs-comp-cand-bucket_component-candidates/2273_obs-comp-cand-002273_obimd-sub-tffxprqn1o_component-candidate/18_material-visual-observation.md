# Material Visual Observation / obs-comp-cand-002273 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002273`
- External reference / 外部参照: `obimd-sub-tffxprqn1o`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020157_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tffxprqn1o/tffxprqn1o/tffxprqn1o.png`
- Checksum / 校验和:
  `5cef00df5a363f3c4eb70c05e3027b8d7899f20f6cb06c41423da62be5adea83`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.93%.
- Marked-pixel bounds: (58,19)–(204,228); span 147 × 210 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.93%。
- 痕迹范围：(58,19)–(204,228)；跨度147 × 210 px；痕迹矩形高于宽。
