...
- `obs-evo-cand-002675-route-category-staging`
...
- `obs-evo-cand-002675-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002675-route-evolution-graph`
