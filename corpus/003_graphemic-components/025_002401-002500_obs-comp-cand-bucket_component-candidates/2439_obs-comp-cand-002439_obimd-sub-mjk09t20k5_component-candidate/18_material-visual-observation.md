# Material Visual Observation / obs-comp-cand-002439 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002439`
- External reference / 外部参照: `obimd-sub-mjk09t20k5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020611_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kam577w6oq/mjk09t20k5/mjk09t20k5.png`
- Checksum / 校验和:
  `3ce6477aef804406b6fe2b35ce7b2201219a157a4b7ffdb0e27820a456dd27c7`
...
- Marked-pixel bounds: (87,28)–(162,216); span 76 × 189 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.56%。
- 痕迹范围：(87,28)–(162,216)；跨度76 × 189 px；痕迹矩形高于宽。
