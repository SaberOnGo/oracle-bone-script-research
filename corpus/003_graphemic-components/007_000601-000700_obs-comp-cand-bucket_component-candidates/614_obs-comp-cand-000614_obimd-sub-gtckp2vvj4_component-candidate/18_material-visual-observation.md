# Material Visual Observation / obs-comp-cand-000614 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000614`
- External reference / 外部参照: `obimd-sub-gtckp2vvj4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013177_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gtckp2vvj4/gtckp2vvj4/gtckp2vvj4.png`
- Checksum / 校验和:
  `c4594d0e0ce4e9a0c01c02292a780a653087d22df3dd2812735529fa2fe61a8d`
...
- Marked-pixel bounds: (87,19)–(164,231); span 78 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.30%。
- 痕迹范围：(87,19)–(164,231)；跨度78 × 213 px；痕迹矩形高于宽。
