...
- Project ID: `obs-evo-cand-008319`
- EVOBC category candidate ID: `evobc-evo-cat-08319`
- External category reference: `evobc-cat-08319`
- Source category ID: `08319`
- Source label for human review: `講`
- Source codepoints: `U+8B1B`
...
- `obs-evo-cand-008319-route-category-staging`
...
- `obs-evo-cand-008319-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008319-route-evolution-graph`
