# obs-unk-004918 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/018_obs-unk-004918_h
  ust-obc-und-X-004918_oracle-character-candidate/03_visual-assets/001_asset
  -006511_hust-obc-und-X-004918_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/474/X_？_7459_1.png`
- asset id: `asset-006511`
...
- An upper branched group is separated from a lower two-opening outline.
...
- source class: `HUST-OBC/undeciphered/X/474/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/474/X_？_7459_1.png`
- asset id: `asset-006511`
...
- Which source records identify obs-unk-004918 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004918？
