# obs-unk-005933 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005933`
- primary external id: `hust-obc-und-X-005933`
...
- local review image route: `corpus/001_oracle-characters/076_undeciphered-005
  901-006000_obs-unk-bucket_oracle-character-candidates/033_obs-unk-005933_h
  ust-obc-und-X-005933_oracle-character-candidate/03_visual-assets/001_asset
  -007525_hust-obc-und-X-005933_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1489/X_？_262_1.png`
- asset id: `asset-007525`
...
- source class: `HUST-OBC/undeciphered/X/1489/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1489/X_？_262_1.png`
- asset id: `asset-007525`
...
- Which source records identify obs-unk-005933 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005933？
