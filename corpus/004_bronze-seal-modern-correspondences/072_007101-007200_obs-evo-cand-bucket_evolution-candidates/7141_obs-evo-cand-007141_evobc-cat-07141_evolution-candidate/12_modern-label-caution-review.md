# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-007141
...
- EVOBC candidate category: `evobc-evo-cat-07141`.
- Source label for search only: `膽`.
- Source codepoints for search only: `U+81BD`.
