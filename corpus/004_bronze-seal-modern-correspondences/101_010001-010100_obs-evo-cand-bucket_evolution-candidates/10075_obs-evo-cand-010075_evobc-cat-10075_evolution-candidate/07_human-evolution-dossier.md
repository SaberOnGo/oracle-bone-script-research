...
- Project ID: `obs-evo-cand-010075`
- EVOBC category candidate ID: `evobc-evo-cat-10075`
- External category reference: `evobc-cat-10075`
- Source category ID: `10075`
- Source label for human review: `飄`
- Source codepoints: `U+98C4`
...
- `obs-evo-cand-010075-route-category-staging`
...
- `obs-evo-cand-010075-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010075-route-evolution-graph`
