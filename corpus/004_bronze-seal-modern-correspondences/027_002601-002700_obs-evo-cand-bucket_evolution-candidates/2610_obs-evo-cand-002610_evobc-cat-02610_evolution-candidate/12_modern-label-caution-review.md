# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002610
...
- EVOBC candidate category: `evobc-evo-cat-02610`.
- Source label for search only: `川`.
- Source codepoints for search only: `U+5DDD`.
