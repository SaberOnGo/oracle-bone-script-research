# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008908
...
- EVOBC candidate category: `evobc-evo-cat-08908`.
- Source label for search only: `辝`.
- Source codepoints for search only: `U+8F9D`.
