# Material Visual Observation / obs-comp-cand-002247 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002247`
- External reference / 外部参照: `obimd-sub-65i2zmqjqy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020060_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/65i2zmqjqy/65i2zmqjqy/65i2zmqjqy.png`
- Checksum / 校验和:
  `018ad149895475c8704ccbd6a2d2fce5454930696ab7b069c29981633eb40773`
...
- Marked-pixel bounds: (93,13)–(152,234); span 60 × 222 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.84%。
- 痕迹范围：(93,13)–(152,234)；跨度60 × 222 px；痕迹矩形高于宽。
