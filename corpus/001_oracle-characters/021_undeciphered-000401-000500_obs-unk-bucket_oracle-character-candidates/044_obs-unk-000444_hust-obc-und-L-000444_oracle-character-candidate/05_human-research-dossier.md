# obs-unk-000444 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000444`
- primary external id: `hust-obc-und-L-000444`
...
- local review image route: `corpus/001_oracle-characters/021_undeciphered-000
  401-000500_obs-unk-bucket_oracle-character-candidates/044_obs-unk-000444_h
  ust-obc-und-L-000444_oracle-character-candidate/03_visual-assets/001_asset
  -002037_hust-obc-und-L-000444_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/444/L_？_11383.jpg`
- asset id: `asset-002037`
...
- source class: `HUST-OBC/undeciphered/L/444/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/444/L_？_11383.jpg`
- asset id: `asset-002037`
...
- Which source records identify obs-unk-000444 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000444？
