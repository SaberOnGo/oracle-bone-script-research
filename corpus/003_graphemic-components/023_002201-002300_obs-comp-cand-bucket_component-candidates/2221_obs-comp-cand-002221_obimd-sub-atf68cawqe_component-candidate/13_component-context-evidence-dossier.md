# obs-comp-cand-002221 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002221`
- 首选外部 ID: `obimd-sub-atf68cawqe`
- OBIMD subcharacter UID: `atf68cawqe`
- OBIMD main character UID: `atf68cawqe`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `7`
- codepoint 示例: U+FCC7D; U+FCC7E; 另有 5 项
