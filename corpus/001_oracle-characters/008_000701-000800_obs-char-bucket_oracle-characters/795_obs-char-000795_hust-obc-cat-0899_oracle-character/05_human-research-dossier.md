# obs-char-000795 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000795`
- primary external id: `hust-obc-cat-0899`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/795_obs-char-000795_hust-obc-cat-0899_orac
  le-character/03_visual-assets/001_asset-000800_hust-obc-cat-0899_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0899/G_0899_乙2998.png`
- asset id: `asset-000800`
...
- source category: `0899`
- validation class: `794`
- source image route: `HUST-OBC/deciphered/0899/G_0899_乙2998.png`
- asset id: `asset-000800`
...
- English observation: `A short upright crosses a broad upper horizontal
  bar; below it, two angled strokes join into a small forked open basin.`
- 中文观察: `短竖笔穿过上部宽横；其下两条斜笔汇合为小型分叉开放浅槽。`
...
- dataset label text: `㝹`
- dataset label codepoints: `U+3779`
...
- Which source records identify obs-char-000795 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000795？
