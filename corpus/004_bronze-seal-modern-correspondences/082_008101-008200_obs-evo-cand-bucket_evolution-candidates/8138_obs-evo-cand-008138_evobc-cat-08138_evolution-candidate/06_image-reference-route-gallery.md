...
- `obs-evo-cand-008138-route-category-staging`
...
- `obs-evo-cand-008138-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008138-route-evolution-graph`
