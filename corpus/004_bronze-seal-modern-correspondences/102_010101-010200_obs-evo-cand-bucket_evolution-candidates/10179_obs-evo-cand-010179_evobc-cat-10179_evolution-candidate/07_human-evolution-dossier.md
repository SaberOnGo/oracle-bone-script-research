...
- External category reference: `evobc-cat-10179`
- Source category ID: `10179`
- Source label for human review: `駋`
...
- `obs-evo-cand-010179-route-category-staging`
...
- `obs-evo-cand-010179-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010179-route-evolution-graph`
