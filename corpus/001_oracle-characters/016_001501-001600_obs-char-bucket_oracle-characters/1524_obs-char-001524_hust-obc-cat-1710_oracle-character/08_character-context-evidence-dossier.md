...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1710`
...
- Source image / 来源图: `G_1710_京津4499(甲).png`
- Image / 图像: `001_asset-001529_hust-obc-cat-1710_glyph.png`
...
- target node: `evobc-evo-cat-00151`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/151_obs-evo-cand-000151_evobc-cat-00151_evoluti
...
- Source label text / 来源标签文字: `㪤`
- Source label codepoint / 来源标签 codepoint: `U+3AA4`
