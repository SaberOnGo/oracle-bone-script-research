...
- Project ID: `obs-evo-cand-011301`
- EVOBC category candidate ID: `evobc-evo-cat-11301`
- External category reference: `evobc-cat-11301`
- Source category ID: `11301`
- Source label for human review: `𢫺`
- Source codepoints: `U+22AFA`
...
- `obs-evo-cand-011301-route-category-staging`
...
- `obs-evo-cand-011301-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011301-route-evolution-graph`
