...
- External category reference: `evobc-cat-04987`
- Source category ID: `04987`
- Source label for human review: `瀕`
...
- `obs-evo-cand-004987-route-category-staging`
...
- `obs-evo-cand-004987-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004987-route-evolution-graph`
