# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010520
...
- EVOBC candidate category: `evobc-evo-cat-10520`.
- Source label for search only: `鵻`.
- Source codepoints for search only: `U+9D7B`.
