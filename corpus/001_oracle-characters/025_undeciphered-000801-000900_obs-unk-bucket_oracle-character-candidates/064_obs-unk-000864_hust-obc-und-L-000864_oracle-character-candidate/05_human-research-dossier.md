# obs-unk-000864 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000864`
- primary external id: `hust-obc-und-L-000864`
...
- local review image route: `corpus/001_oracle-characters/025_undeciphered-000
  801-000900_obs-unk-bucket_oracle-character-candidates/064_obs-unk-000864_h
  ust-obc-und-L-000864_oracle-character-candidate/03_visual-assets/001_asset
  -002457_hust-obc-und-L-000864_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/864/L_？_12471.jpg`
- asset id: `asset-002457`
...
- source class: `HUST-OBC/undeciphered/L/864/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/864/L_？_12471.jpg`
- asset id: `asset-002457`
...
- Which source records identify obs-unk-000864 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000864？
