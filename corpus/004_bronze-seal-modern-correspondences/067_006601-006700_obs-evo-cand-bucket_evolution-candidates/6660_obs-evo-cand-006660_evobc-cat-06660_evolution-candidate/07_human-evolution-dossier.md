...
- External category reference: `evobc-cat-06660`
- Source category ID: `06660`
- Source label for human review: `繀`
...
- `obs-evo-cand-006660-route-category-staging`
...
- `obs-evo-cand-006660-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006660-route-evolution-graph`
