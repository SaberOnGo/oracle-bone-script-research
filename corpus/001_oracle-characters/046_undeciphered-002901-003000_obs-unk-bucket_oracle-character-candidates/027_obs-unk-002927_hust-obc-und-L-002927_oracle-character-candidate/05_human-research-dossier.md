# obs-unk-002927 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002927`
- primary external id: `hust-obc-und-L-002927`
...
- local review image route: `corpus/001_oracle-characters/046_undeciphered-002
  901-003000_obs-unk-bucket_oracle-character-candidates/027_obs-unk-002927_h
  ust-obc-und-L-002927_oracle-character-candidate/03_visual-assets/001_asset
  -004520_hust-obc-und-L-002927_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2927/L_？_5052.jpg`
- asset id: `asset-004520`
...
- source class: `HUST-OBC/undeciphered/L/2927/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2927/L_？_5052.jpg`
- asset id: `asset-004520`
...
- Which source records identify obs-unk-002927 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002927？
