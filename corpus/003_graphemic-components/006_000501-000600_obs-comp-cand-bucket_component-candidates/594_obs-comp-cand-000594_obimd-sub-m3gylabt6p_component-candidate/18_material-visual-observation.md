# Material Visual Observation / obs-comp-cand-000594 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000594`
- External reference / 外部参照: `obimd-sub-m3gylabt6p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013122_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/m3gylabt6p/m3gylabt6p/m3gylabt6p.png`
- Checksum / 校验和:
  `795eecc86ea60fdcde014fb1886c68fc7563a9b4ae62f4fbd7eb6b7802920107`
...
- Marked-pixel bounds: (48,23)–(201,226); span 154 × 204 px; the marked
...
- 痕迹范围：(48,23)–(201,226)；跨度154 × 204 px；痕迹矩形高于宽。
