...
- External category reference: `evobc-cat-01884`
- Source category ID: `01884`
- Source label for human review: `埵`
- Source codepoints: `U+57F5`
...
- `obs-evo-cand-001884-route-category-staging`
...
- `obs-evo-cand-001884-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001884-route-evolution-graph`
