# obs-comp-cand-002611 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002611`
- 首选外部 ID: `obimd-sub-axc0e0c7le`
- OBIMD subcharacter UID: `axc0e0c7le`
- OBIMD main character UID: `axc0e0c7le`
- 来源 ID: `src-obimd`
