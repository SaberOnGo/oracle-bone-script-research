# obs-unk-004643 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004643`
- primary external id: `hust-obc-und-X-004643`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/043_obs-unk-004643_h
  ust-obc-und-X-004643_oracle-character-candidate/03_visual-assets/001_asset
  -006236_hust-obc-und-X-004643_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/199/X_？_8372_1.png`
- asset id: `asset-006236`
...
- source class: `HUST-OBC/undeciphered/X/199/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/199/X_？_8372_1.png`
- asset id: `asset-006236`
...
- English observation: `dark irregular cluster with two pale openings`
- 中文观察: `带两个浅色开口的不规则深色聚集`
...
- Which source records identify obs-unk-004643 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004643？
