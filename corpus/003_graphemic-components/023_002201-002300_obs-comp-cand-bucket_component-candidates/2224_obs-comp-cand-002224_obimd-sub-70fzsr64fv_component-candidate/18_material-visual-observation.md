# Material Visual Observation / obs-comp-cand-002224 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002224`
- External reference / 外部参照: `obimd-sub-70fzsr64fv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020037_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/m74006xplh/70fzsr64fv/70fzsr64fv.png`
- Checksum / 校验和:
  `bdd038de4ce45b9449a24ea122b7295fb02cea0ea9529f761d24727f9dbd8298`
...
- Marked-pixel bounds: (77,42)–(165,203); span 89 × 162 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.25%。
- 痕迹范围：(77,42)–(165,203)；跨度89 × 162 px；痕迹矩形高于宽。
