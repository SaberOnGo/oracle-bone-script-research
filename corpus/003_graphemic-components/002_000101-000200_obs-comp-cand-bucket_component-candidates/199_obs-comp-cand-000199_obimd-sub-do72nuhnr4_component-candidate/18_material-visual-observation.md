# Material Visual Observation / obs-comp-cand-000199 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000199`
- External reference / 外部参照: `obimd-sub-do72nuhnr4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011760_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/do72nuhnr4/do72nuhnr4/do72nuhnr4.png`
- Checksum / 校验和:
  `e49a07bdc3f1369b64d92c9c0d774c3b2a628ba92ee03cce575fc35fdd8f2b83`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.77%.
- Marked-pixel bounds: (33,45)–(215,207); span 183 × 163 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.77%。
- 痕迹范围：(33,45)–(215,207)；跨度183 × 163 px；痕迹矩形近方形。
