# obs-char-000195 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000195`
- primary external id: `hust-obc-cat-0217`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/195_obs-char-000195_hust-obc-cat-0217_orac
  le-character/03_visual-assets/001_asset-000200_hust-obc-cat-0217_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0217/X_0217_3693_1.png`
- asset id: `asset-000200`
...
- source category: `0217`
- validation class: `194`
- source image route: `HUST-OBC/deciphered/0217/X_0217_3693_1.png`
- asset id: `asset-000200`
...
- English observation: `The large image has a rounded outer frame, an inner
  loop and horizontal band, and long side strokes continuing below the lower
  edge.`
- 中文观察: `大幅图像有圆弧外框，内部含环状形和横带，下缘两侧有长笔继续向下。`
...
- dataset label text: `㓏`
- dataset label codepoints: `U+34CF`
...
- Which source records identify obs-char-000195 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000195？
