# obs-char-000557 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000557`
- primary external id: `hust-obc-cat-0632`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/557_obs-char-000557_hust-obc-cat-0632_orac
  le-character/03_visual-assets/001_asset-000562_hust-obc-cat-0632_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0632/G_0632_京津3176合24376出組.png`
- asset id: `asset-000562`
...
- source category: `0632`
- validation class: `556`
- source image route: `HUST-OBC/deciphered/0632/G_0632_京津3176合24376出組.png`
- asset id: `asset-000562`
...
- English observation: `A compact upper loop is divided by a vertical and
  crossed by diagonal top strokes; a linked lower rectangular frame contains
  a horizontal divider.`
- 中文观察: `紧凑上环被竖笔分隔并由斜顶笔穿过，相连下部矩形框内有一条横向分隔。`
...
- dataset label text: `㙮`
- dataset label codepoints: `U+366E`
...
- filename catalog route clues: `Heji-like filename clue: 合24376
  (G_0632_京津3176合24376出組.png)`
...
- Which source records identify obs-char-000557 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000557？
