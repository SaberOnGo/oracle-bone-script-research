...
Project ID: `obs-evo-cand-008593`
...
- Project ID: `obs-evo-cand-008593`
- EVOBC category candidate ID: `evobc-evo-cat-08593`
- External category reference: `evobc-cat-08593`
- Source category ID: `08593`
- Source label for human review: `賵`
- Source codepoints: `U+8CF5`
...
- `obs-evo-cand-008593-route-category-staging`
...
- `obs-evo-cand-008593-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008593-route-evolution-graph`
