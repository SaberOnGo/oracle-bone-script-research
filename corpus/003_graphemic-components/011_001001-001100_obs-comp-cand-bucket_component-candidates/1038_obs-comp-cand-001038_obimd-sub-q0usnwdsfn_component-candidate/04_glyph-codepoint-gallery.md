# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001038
...
| --- | --- | --- | --- |
| `obimd-glyph-link-015154` | 󵹍 | `U+F5E4D` | `reviewed_metadata_only` |
| `obimd-glyph-link-015155` | 󵹎 | `U+F5E4E` | `reviewed_metadata_only` |
| `obimd-glyph-link-015156` | 󵹏 | `U+F5E4F` | `reviewed_metadata_only` |
