# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001139
...
| --- | --- | --- | --- |
| `obimd-glyph-link-016962` | 󶢝 | `U+F689D` | `reviewed_metadata_only` |
| `obimd-glyph-link-016963` | 󶢞 | `U+F689E` | `reviewed_metadata_only` |
