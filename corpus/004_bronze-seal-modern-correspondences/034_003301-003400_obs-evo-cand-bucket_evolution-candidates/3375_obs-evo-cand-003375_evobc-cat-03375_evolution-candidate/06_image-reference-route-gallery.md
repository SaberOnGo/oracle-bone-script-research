...
- `obs-evo-cand-003375-route-category-staging`
...
- `obs-evo-cand-003375-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003375-route-evolution-graph`
