# obs-char-000160 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/160_obs-char-000160_hust-obc-cat-0176_orac
  le-character/03_visual-assets/001_asset-000165_hust-obc-cat-0176_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0176/G_0176_佚728合8383賓組.png`
- asset id: `asset-000165`
...
- source category: `0176`
- validation class: `159`
- source image route: `HUST-OBC/deciphered/0176/G_0176_佚728合8383賓組.png`
- asset id: `asset-000165`
...
- English observation: `The image is a dense central knot of crossing and
  looping strokes, with longer side strokes extending above and below it.`
...
- dataset label text: `㒦`
- dataset label codepoints: `U+34A6`
...
- filename catalog route clues: `Heji-like filename clue: 合8383
...
- Which source records identify obs-char-000160 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000160？
