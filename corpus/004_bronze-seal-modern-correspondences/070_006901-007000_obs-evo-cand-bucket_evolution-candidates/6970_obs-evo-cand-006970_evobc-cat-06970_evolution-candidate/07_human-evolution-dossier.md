...
- External category reference: `evobc-cat-06970`
- Source category ID: `06970`
- Source label: `肃`
...
- `obs-evo-cand-006970-route-category-staging`
...
- `obs-evo-cand-006970-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006970-route-evolution-graph`
