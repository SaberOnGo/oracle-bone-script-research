# obs-char-001558 Visual Gallery / obs-char-001558 图像资料页
...
- Primary external reference / 首选外部参考: `hust-obc-cat-1749`
...
## obs-char-001558-visual-source-001 / 图像条目

![obs-char-001558 glyph candidate](03_visual-assets/001_asset-001563_hust-obc-cat-1749_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-001563_hust-obc-cat-1749_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-001563_hust-obc-cat-1749_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/1749/G_1749_後2.18.8(甲).png`
