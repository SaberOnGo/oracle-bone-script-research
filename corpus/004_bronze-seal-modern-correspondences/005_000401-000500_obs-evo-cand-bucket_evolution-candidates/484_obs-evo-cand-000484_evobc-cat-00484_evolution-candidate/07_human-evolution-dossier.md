...
- Project ID: `obs-evo-cand-000484`
- EVOBC category candidate ID: `evobc-evo-cat-00484`
- External category reference: `evobc-cat-00484`
- Source category ID: `00484`
- Source label for human review: `䢼`
- Source codepoints: `U+48BC`
...
- `obs-evo-cand-000484-route-category-staging`
...
- `obs-evo-cand-000484-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000484-route-evolution-graph`
