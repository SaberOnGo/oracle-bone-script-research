# obs-unk-004428 Local Object Materials / obs-unk-004428 本地对象资料
...
- Local review image / 本地复核图像: `03_visual-assets/001_asset-006021_hust-obc-und-L-004428_glyph.jpg`

## Object Summary / 对象摘要

- Project ID / 项目 ID: `obs-unk-004428`
- Primary external reference / 首选外部参考: `hust-obc-und-L-004428`
- Source group / 来源分组: `L` (Oracle Bone Script: Six Digit Numerical Code)
- Source class path / 来源分类路径: `HUST-OBC/undeciphered/L/4428/`
- Source image path / 来源图像路径: `HUST-OBC/undeciphered/L/4428/L_？_9927.jpg`
- Asset ID / 资产 ID: `asset-006021`
