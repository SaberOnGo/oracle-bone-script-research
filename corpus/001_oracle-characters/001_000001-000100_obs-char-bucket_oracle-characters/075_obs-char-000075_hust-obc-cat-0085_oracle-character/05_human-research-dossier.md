# obs-char-000075 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000075`
- primary external id: `hust-obc-cat-0085`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/075_obs-char-000075_hust-obc-cat-0085_orac
  le-character/03_visual-assets/001_asset-000080_hust-obc-cat-0085_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0085/G_0085_京都2158合31025.png`
- asset id: `asset-000080`
...
- source category: `0085`
- validation class: `74`
- source image route: `HUST-OBC/deciphered/0085/G_0085_京都2158合31025.png`
- asset id: `asset-000080`
...
- English observation: `The thin image shows a short upper bar, a diagonal
  descending stroke, and a second short lower branch.`
- 中文观察: `纤细图像上方有短横画，下方有斜向下行笔画和第二条短分支。`
...
- dataset label text: `㑋`
- dataset label codepoints: `U+344B`
...
- filename catalog route clues: `Heji-like filename clue: 合31025
...
- Which source records identify obs-char-000075 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000075？
