# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006531
...
- EVOBC candidate category: `evobc-evo-cat-06531`.
- Source label for search only: `絿`.
- Source codepoints for search only: `U+7D7F`.
