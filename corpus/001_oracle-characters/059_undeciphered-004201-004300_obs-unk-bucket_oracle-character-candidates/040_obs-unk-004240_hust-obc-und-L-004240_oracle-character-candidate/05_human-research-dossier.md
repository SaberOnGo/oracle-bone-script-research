# obs-unk-004240 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/040_obs-unk-004240_h
  ust-obc-und-L-004240_oracle-character-candidate/03_visual-assets/001_asset
  -005833_hust-obc-und-L-004240_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4240/L_？_9327.jpg`
- asset id: `asset-005833`
...
- source class: `HUST-OBC/undeciphered/L/4240/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4240/L_？_9327.jpg`
- asset id: `asset-005833`
...
- English observation: `Central crossing, upper strokes, lower curve visible.`
- 中文观察: `中央交叉痕迹、上部笔画和下部弯曲笔画可见。`
...
- Which source records identify obs-unk-004240 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004240？
