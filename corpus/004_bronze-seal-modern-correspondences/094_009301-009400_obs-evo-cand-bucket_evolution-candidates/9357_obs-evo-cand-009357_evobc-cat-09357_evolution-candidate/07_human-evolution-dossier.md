...
Project ID: `obs-evo-cand-009357`
...
- Project ID: `obs-evo-cand-009357`
- EVOBC category candidate ID: `evobc-evo-cat-09357`
- External category reference: `evobc-cat-09357`
- Source category ID: `09357`
- Source label for human review: `鉏`
- Source codepoints: `U+924F`
...
- `obs-evo-cand-009357-route-category-staging`
...
- `obs-evo-cand-009357-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009357-route-evolution-graph`
