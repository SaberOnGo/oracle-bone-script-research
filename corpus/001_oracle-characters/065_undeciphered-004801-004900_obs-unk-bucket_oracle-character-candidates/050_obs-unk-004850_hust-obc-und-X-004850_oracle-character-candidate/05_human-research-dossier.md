# obs-unk-004850 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/050_obs-unk-004850_h
  ust-obc-und-X-004850_oracle-character-candidate/03_visual-assets/001_asset
  -006443_hust-obc-und-X-004850_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/406/X_？_7391_1.png`
- asset id: `asset-006443`
...
- source class: `HUST-OBC/undeciphered/X/406/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/406/X_？_7391_1.png`
- asset id: `asset-006443`
...
- English observation: `separated groups with lower opening and pointed end`
- 中文观察: `分离结构、下部开口和下部尖端`
...
- Which source records identify obs-unk-004850 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004850？
