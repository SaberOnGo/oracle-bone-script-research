# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006213
...
- EVOBC candidate category: `evobc-evo-cat-06213`.
- Source label for search only: `端`.
- Source codepoints for search only: `U+7AEF`.
