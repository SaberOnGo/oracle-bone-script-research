# Material Visual Observation / obs-comp-cand-001720 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001720`
- External reference / 外部参照: `obimd-sub-fyihpr2f02`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017899_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fyihpr2f02/fyihpr2f02/fyihpr2f02.png`
- Checksum / 校验和:
  `123e39ee7d811a9fa2ed38898992d9d20456cc3c368e4478e49c7bfb1695a042`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.03%.
- Marked-pixel bounds: (68,18)–(186,228); span 119 × 211 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.03%。
- 痕迹范围：(68,18)–(186,228)；跨度119 × 211 px；痕迹矩形高于宽。
