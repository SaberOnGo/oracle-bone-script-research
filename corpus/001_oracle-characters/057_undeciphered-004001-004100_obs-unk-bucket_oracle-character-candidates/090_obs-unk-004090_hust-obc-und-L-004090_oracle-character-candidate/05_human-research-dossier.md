# obs-unk-004090 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004090`
- primary external id: `hust-obc-und-L-004090`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/090_obs-unk-004090_h
  ust-obc-und-L-004090_oracle-character-candidate/03_visual-assets/001_asset
  -005683_hust-obc-und-L-004090_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4090/L_？_8789.jpg`
- asset id: `asset-005683`
...
- source class: `HUST-OBC/undeciphered/L/4090/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4090/L_？_8789.jpg`
- asset id: `asset-005683`
...
- English observation: A thin upright trace stands at the left of a broader
  angular form. Near the right side is a small enclosed or hooked outline;
  several lower strokes extend downward, but their endpoints are faint.
- 中文观察：图像左侧可见一条细长的竖向痕迹，右侧是较宽的折线形体。
...
- Which source records identify obs-unk-004090 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004090？
