...
- External category reference: `evobc-cat-00334`
- Source category ID: `00334`
- Source label for human review: `䌏`
...
- `obs-evo-cand-000334-route-category-staging`
...
- `obs-evo-cand-000334-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000334-route-evolution-graph`
