# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002119
...
| --- | --- | --- | --- |
| `obimd-glyph-link-032891` | 󼎐 | `U+FC390` | `reviewed_metadata_only` |
| `obimd-glyph-link-032892` | 󼎑 | `U+FC391` | `reviewed_metadata_only` |
