...
Project ID: `obs-evo-cand-013638`
...
- Project ID: `obs-evo-cand-013638`
- EVOBC category candidate ID: `evobc-evo-cat-13638`
- External category reference: `evobc-cat-13638`
- Source category ID: `13638`
- Source label for human review: `𮗑`
- Source codepoints: `U+2E5D1`
...
- `obs-evo-cand-013638-route-category-staging`
...
- `obs-evo-cand-013638-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013638-route-evolution-graph`
