# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010490
...
- EVOBC candidate category: `evobc-evo-cat-10490`.
- Source label for search only: `鴝`.
- Source codepoints for search only: `U+9D1D`.
