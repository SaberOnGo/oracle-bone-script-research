...
- External category reference: `evobc-cat-04266`
- Source category ID: `04266`
- Source label for human review: `橘`
- Source codepoints: `U+6A58`
...
- `obs-evo-cand-004266-route-category-staging`
...
- `obs-evo-cand-004266-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004266-route-evolution-graph`
