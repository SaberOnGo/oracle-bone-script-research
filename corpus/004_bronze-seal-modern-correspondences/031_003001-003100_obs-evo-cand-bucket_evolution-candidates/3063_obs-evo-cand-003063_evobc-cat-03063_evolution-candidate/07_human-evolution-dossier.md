...
Project ID: `obs-evo-cand-003063`
...
- Project ID: `obs-evo-cand-003063`
- EVOBC category candidate ID: `evobc-evo-cat-03063`
- External category reference: `evobc-cat-03063`
- Source category ID: `03063`
- Source label for human review: `惭`
- Source codepoints: `U+60ED`
...
- `obs-evo-cand-003063-route-category-staging`
...
- `obs-evo-cand-003063-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003063-route-evolution-graph`
