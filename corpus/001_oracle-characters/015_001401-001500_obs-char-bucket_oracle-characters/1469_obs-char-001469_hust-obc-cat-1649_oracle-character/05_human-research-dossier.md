# obs-char-001469 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1469_obs-char-001469_hust-obc-cat-1649_ora
  cle-character/03_visual-assets/001_asset-001474_hust-obc-cat-1649_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1649/G_1649_京津1345.png`
- asset id: `asset-001474`
...
- source category: `1649`
- validation class: `1468`
- source image route: `HUST-OBC/deciphered/1649/G_1649_京津1345.png`
- asset id: `asset-001474`
...
- English observation: `A small upper loop leads to a narrow stem with a
...
- dataset label text: `㩧`
- dataset label codepoints: `U+3A67`
...
- Which source records identify obs-char-001469 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001469？
