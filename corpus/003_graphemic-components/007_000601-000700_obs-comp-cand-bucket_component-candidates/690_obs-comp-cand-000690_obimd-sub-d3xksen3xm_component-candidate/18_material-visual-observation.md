# Material Visual Observation / obs-comp-cand-000690 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000690`
- External reference / 外部参照: `obimd-sub-d3xksen3xm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013289_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/i1qbimwfk6/d3xksen3xm/d3xksen3xm.png`
- Checksum / 校验和:
  `d3524aaa7f331df38d178a07cc2fc65d2e1dde5cd388c22391fff2eb6e83ade2`
...
- Marked-pixel bounds: (63,32)–(186,220); span 124 × 189 px; the marked
...
- 痕迹范围：(63,32)–(186,220)；跨度124 × 189 px；痕迹矩形高于宽。
