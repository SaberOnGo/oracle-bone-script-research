# obs-unk-004674 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004674`
- primary external id: `hust-obc-und-X-004674`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/074_obs-unk-004674_h
  ust-obc-und-X-004674_oracle-character-candidate/03_visual-assets/001_asset
  -006267_hust-obc-und-X-004674_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/230/X_？_8399_1.png`
- asset id: `asset-006267`
...
- source class: `HUST-OBC/undeciphered/X/230/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/230/X_？_8399_1.png`
- asset id: `asset-006267`
...
- English observation: `black field with broken pale central band`
- 中文观察: `黑色密集区域与断续中央浅色带`
...
- Which source records identify obs-unk-004674 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004674？
