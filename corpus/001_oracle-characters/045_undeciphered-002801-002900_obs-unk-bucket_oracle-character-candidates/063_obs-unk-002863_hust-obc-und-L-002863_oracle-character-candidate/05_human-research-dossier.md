# obs-unk-002863 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/045_undeciphered-002
  801-002900_obs-unk-bucket_oracle-character-candidates/063_obs-unk-002863_h
  ust-obc-und-L-002863_oracle-character-candidate/03_visual-assets/001_asset
  -004456_hust-obc-und-L-002863_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2863/L_？_4838.jpg`
- asset id: `asset-004456`
...
- source class: `HUST-OBC/undeciphered/L/2863/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2863/L_？_4838.jpg`
- asset id: `asset-004456`
...
- Which source records identify obs-unk-002863 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002863？
