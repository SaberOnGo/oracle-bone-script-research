# obs-char-001451 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001451`
- primary external id: `hust-obc-cat-1627`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1451_obs-char-001451_hust-obc-cat-1627_ora
  cle-character/03_visual-assets/001_asset-001456_hust-obc-cat-1627_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1627/G_1627_乙44合20757𠂤組.png`
- asset id: `asset-001456`
...
- source category: `1627`
- validation class: `1450`
- source image route: `HUST-OBC/deciphered/1627/G_1627_乙44合20757𠂤組.png`
- asset id: `asset-001456`
...
- English observation: `A small upper loop leads into a narrow zigzagging
  lower stem and a dot.`
- 中文观察: `小型上部环形连接狭长曲折下部竖干及一点状笔画。`
...
- dataset label text: `㩑`
- dataset label codepoints: `U+3A51`
...
- filename catalog route clues: `Heji-like filename clue: 合20757
  (G_1627_乙44合20757𠂤組.png)`
...
- Which source records identify obs-char-001451 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001451？
