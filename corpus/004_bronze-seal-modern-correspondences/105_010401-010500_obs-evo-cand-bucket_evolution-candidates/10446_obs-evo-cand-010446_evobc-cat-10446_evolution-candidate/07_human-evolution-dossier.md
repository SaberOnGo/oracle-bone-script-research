...
- Project ID: `obs-evo-cand-010446`
- EVOBC category candidate ID: `evobc-evo-cat-10446`
- External category reference: `evobc-cat-10446`
- Source category ID: `10446`
- Source label for human review: `鱖`
- Source codepoints: `U+9C56`
...
- `obs-evo-cand-010446-route-category-staging`
...
- `obs-evo-cand-010446-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010446-route-evolution-graph`
