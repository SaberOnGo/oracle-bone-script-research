...
- External category reference: `evobc-cat-06347`
- Source category ID: `06347`
- Source label for human review: `簙`
- Source codepoints: `U+7C19`
...
- `obs-evo-cand-006347-route-category-staging`
...
- `obs-evo-cand-006347-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006347-route-evolution-graph`
