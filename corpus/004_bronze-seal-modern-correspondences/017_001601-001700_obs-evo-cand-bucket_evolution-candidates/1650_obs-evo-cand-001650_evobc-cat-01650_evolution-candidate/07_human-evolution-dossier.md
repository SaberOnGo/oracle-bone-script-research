...
Project ID: `obs-evo-cand-001650`
...
- Project ID: `obs-evo-cand-001650`
- EVOBC category candidate ID: `evobc-evo-cat-01650`
- External category reference: `evobc-cat-01650`
- Source category ID: `01650`
- Source label for human review: `喜`
- Source codepoints: `U+559C`
...
- `obs-evo-cand-001650-route-category-staging`
...
- `obs-evo-cand-001650-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001650-route-evolution-graph`
