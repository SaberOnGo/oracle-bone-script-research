# obs-evo-cand-011183 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-11183`
- Source label: `𢐍`
- Source codepoints: `U+2240D`
- Image reference count: `73`
- Era token counts: `BI:73`
- Source token counts: `Book:73`

## Observed Code Rows / 观察到的代码行

- era 1 / BI: 73 image references
- source 3 / Book:21681: 73 image references
