...
- Project ID: `obs-evo-cand-012333`
- EVOBC category candidate ID: `evobc-evo-cat-12333`
- External category reference: `evobc-cat-12333`
- Source category ID: `12333`
- Source label for human review: `𨍚`
- Source codepoints: `U+2835A`
...
- `obs-evo-cand-012333-route-category-staging`
...
- `obs-evo-cand-012333-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012333-route-evolution-graph`
