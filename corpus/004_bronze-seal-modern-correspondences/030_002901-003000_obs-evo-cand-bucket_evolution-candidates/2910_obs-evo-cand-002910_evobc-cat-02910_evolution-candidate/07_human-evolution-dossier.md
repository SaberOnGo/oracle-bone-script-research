...
- External category reference: `evobc-cat-02910`
- Source category ID: `02910`
- Source label for human review: `忠`
...
- `obs-evo-cand-002910-route-category-staging`
...
- `obs-evo-cand-002910-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002910-route-evolution-graph`
