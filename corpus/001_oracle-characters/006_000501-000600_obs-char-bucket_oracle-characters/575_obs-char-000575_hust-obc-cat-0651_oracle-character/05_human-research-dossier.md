# obs-char-000575 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/575_obs-char-000575_hust-obc-cat-0651_orac
  le-character/03_visual-assets/001_asset-000580_hust-obc-cat-0651_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0651/G_0651_甲骨文0.png`
- asset id: `asset-000580`
...
- source category: `0651`
- validation class: `574`
- source image route: `HUST-OBC/deciphered/0651/G_0651_甲骨文0.png`
- asset id: `asset-000580`
...
- English observation: `Two long upper strokes descend separately, cross
  near the middle, and meet again in a pointed lower loop with a short
  hooked extension at left.`
- 中文观察: `两条长上笔分开下行，在中部附近交叉后再次汇成尖形下环，左侧带短钩延伸。`
...
- dataset label text: `㚁`
- dataset label codepoints: `U+3681`
...
- Which source records identify obs-char-000575 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000575？
