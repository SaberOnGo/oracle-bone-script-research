# obs-unk-004631 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004631`
- primary external id: `hust-obc-und-X-004631`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/031_obs-unk-004631_h
  ust-obc-und-X-004631_oracle-character-candidate/03_visual-assets/001_asset
  -006224_hust-obc-und-X-004631_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/187/X_？_8361_1.png`
- asset id: `asset-006224`
...
- source class: `HUST-OBC/undeciphered/X/187/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/187/X_？_8361_1.png`
- asset id: `asset-006224`
...
- English observation: `open outer contour and separate inner loop`
- 中文观察: `开放外围轮廓和分离内部小环已记录。`
...
- Which source records identify obs-unk-004631 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004631？
