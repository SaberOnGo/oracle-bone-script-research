# obs-unk-005514 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/072_undeciphered-005
  501-005600_obs-unk-bucket_oracle-character-candidates/014_obs-unk-005514_h
  ust-obc-und-X-005514_oracle-character-candidate/03_visual-assets/001_asset
  -007107_hust-obc-und-X-005514_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1070/X_？_7182_1.png`
- asset id: `asset-007107`
...
- source class: `HUST-OBC/undeciphered/X/1070/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1070/X_？_7182_1.png`
- asset id: `asset-007107`
...
- Which source records identify obs-unk-005514 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005514？
