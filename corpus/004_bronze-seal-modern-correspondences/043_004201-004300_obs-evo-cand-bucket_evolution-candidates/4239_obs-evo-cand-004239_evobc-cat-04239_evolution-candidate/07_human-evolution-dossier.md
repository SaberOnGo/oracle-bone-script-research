...
Project ID: `obs-evo-cand-004239`
...
- Project ID: `obs-evo-cand-004239`
- EVOBC category candidate ID: `evobc-evo-cat-04239`
- External category reference: `evobc-cat-04239`
- Source category ID: `04239`
- Source label for human review: `樘`
- Source codepoints: `U+6A18`
...
- `obs-evo-cand-004239-route-category-staging`
...
- `obs-evo-cand-004239-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004239-route-evolution-graph`
