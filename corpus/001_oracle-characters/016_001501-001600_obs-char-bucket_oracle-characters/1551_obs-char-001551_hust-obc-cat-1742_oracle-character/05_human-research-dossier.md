# obs-char-001551 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1551_obs-char-001551_hust-obc-cat-1742_ora
  cle-character/03_visual-assets/001_asset-001556_hust-obc-cat-1742_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1742/G_1742_前5.10.1(甲).png`
- asset id: `asset-001556`
...
- source category: `1742`
- validation class: `1550`
- source image route: `HUST-OBC/deciphered/1742/G_1742_前5.10.1(甲).png`
- asset id: `asset-001556`
...
- dataset label text: `㫄`
- dataset label codepoints: `U+3AC4`
...
- Which source records identify obs-char-001551 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001551？
