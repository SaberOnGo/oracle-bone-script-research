...
- External category reference: `evobc-cat-11851`
- Source category ID: `11851`
- Source label for human review: `𥧓`
...
- `obs-evo-cand-011851-route-category-staging`
...
- `obs-evo-cand-011851-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011851-route-evolution-graph`
