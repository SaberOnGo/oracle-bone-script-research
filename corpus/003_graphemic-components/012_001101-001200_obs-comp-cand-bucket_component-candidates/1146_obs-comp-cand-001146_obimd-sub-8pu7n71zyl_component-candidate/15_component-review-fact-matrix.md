# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001146
...
| Glyph or codepoint route / 字形或码位路线 | 44 OBIMD route rows; examples U+4E5D;U+F6858; U+F69D9; 另有 42 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 44 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
