...
- Project ID: `obs-evo-cand-000289`
- EVOBC category candidate ID: `evobc-evo-cat-00289`
- External category reference: `evobc-cat-00289`
- Source category ID: `00289`
- Source label for human review: `䅌`
- Source codepoints: `U+414C`
...
- `obs-evo-cand-000289-route-category-staging`
...
- `obs-evo-cand-000289-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000289-route-evolution-graph`
