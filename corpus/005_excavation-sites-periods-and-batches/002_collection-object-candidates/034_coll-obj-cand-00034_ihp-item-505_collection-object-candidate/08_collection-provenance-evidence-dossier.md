# Collection Provenance Evidence Dossier / 馆藏来源证据档案: coll-obj-cand-00034
...
| source_row_id | `34` |
| object_page_url | `https://museum.sinica.edu.tw/en/collection/32/item/505/` |
...
| asset_id | `` |
| asset_path | `` |
| thumbnail_url | `https://museum.sinica.edu.tw/_upload/image/collection_item/thumbnail/37959e83d091c954.jpg` |
| source_image_url | `` |
...
| `source_collection_item_id` | `505` |
| `object_title_en` | `Inscribed Plastron Ping 0063` |
| `catalog_reference_text` | `Ping 0063` |
| `accession_number` | `` |
| `historical_period` | `` |
| `object_date` | `` |
| `provenience` | `` |
