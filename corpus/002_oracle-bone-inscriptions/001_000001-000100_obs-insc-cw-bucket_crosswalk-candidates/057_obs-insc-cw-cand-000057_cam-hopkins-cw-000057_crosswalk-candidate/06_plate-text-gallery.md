...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000057` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y374` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `79` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `411` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `39782` [route_present_image_or_text_not_collected]
