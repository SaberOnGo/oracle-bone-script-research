# Material Visual Observation / obs-comp-cand-001319 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001319`
- External reference / 外部参照: `obimd-sub-wlek2bmyny`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015656_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4y18ww0a1m/wlek2bmyny/wlek2bmyny.png`
- Checksum / 校验和:
  `370aa79da01d89b3b56bd3b545a6a28b85484bb3e5384c9369cd119e372511b2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.90%.
- Marked-pixel bounds: (84,26)–(165,225); span 82 × 200 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.90%。
- 痕迹范围：(84,26)–(165,225)；跨度82 × 200 px；痕迹矩形高于宽。
