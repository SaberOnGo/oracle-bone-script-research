# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006233
...
- EVOBC candidate category: `evobc-evo-cat-06233`.
- Source label for search only: `笞`.
- Source codepoints for search only: `U+7B1E`.
