# obs-unk-004175 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004175`
- primary external id: `hust-obc-und-L-004175`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/075_obs-unk-004175_h
  ust-obc-und-L-004175_oracle-character-candidate/03_visual-assets/001_asset
  -005768_hust-obc-und-L-004175_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4175/L_？_9043.jpg`
- asset id: `asset-005768`
...
- source class: `HUST-OBC/undeciphered/L/4175/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4175/L_？_9043.jpg`
- asset id: `asset-005768`
...
- English observation: A central long stroke stands beside left branches and a
  right squared outline.
- 中文观察: 中央长笔画旁有左侧分支和右侧方框状轮廓。
...
- Which source records identify obs-unk-004175 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004175？
