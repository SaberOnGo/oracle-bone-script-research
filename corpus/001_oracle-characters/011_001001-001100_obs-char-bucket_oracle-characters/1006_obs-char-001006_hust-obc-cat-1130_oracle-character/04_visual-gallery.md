# obs-char-001006 Visual Gallery / obs-char-001006 图像资料页
...
- Project ID / 项目 ID: `obs-char-001006`
- Primary external reference / 首选外部参考: `hust-obc-cat-1130`
...
## obs-char-001006-visual-source-001 / 图像条目

![obs-char-001006 glyph candidate](03_visual-assets/001_asset-001011_hust-obc-cat-1130_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-001011_hust-obc-cat-1130_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-001011_hust-obc-cat-1130_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/1130/G_1130_前2.37.8(甲).png`
