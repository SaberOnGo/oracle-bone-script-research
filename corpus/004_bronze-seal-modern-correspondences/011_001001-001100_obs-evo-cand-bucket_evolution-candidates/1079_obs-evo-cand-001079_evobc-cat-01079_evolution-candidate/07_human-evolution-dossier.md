...
- Project ID: `obs-evo-cand-001079`
- EVOBC category candidate ID: `evobc-evo-cat-01079`
- External category reference: `evobc-cat-01079`
- Source category ID: `01079`
- Source label for human review: `兓`
- Source codepoints: `U+5153`
...
- `obs-evo-cand-001079-route-category-staging`
...
- `obs-evo-cand-001079-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001079-route-evolution-graph`
