# Material Visual Observation / obs-comp-cand-001250 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001250`
- External reference / 外部参照: `obimd-sub-2rptsk0t7g`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015488_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2rptsk0t7g/2rptsk0t7g/2rptsk0t7g.png`
- Checksum / 校验和:
  `ccfde549274ae6dadd7b587374670426df5b4057f5c2dd9938cd4faaf8ed4c07`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.82%.
- Marked-pixel bounds: (58,26)–(204,224); span 147 × 199 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.82%。
- 痕迹范围：(58,26)–(204,224)；跨度147 × 199 px；痕迹矩形高于宽。
