...
- `obs-evo-cand-009263-route-category-staging`
...
- `obs-evo-cand-009263-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009263-route-evolution-graph`
