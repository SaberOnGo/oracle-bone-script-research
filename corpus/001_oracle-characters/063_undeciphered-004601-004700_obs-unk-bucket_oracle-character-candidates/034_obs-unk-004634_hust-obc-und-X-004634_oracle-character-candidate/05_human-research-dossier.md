# obs-unk-004634 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004634`
- primary external id: `hust-obc-und-X-004634`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/034_obs-unk-004634_h
  ust-obc-und-X-004634_oracle-character-candidate/03_visual-assets/001_asset
  -006227_hust-obc-und-X-004634_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/190/X_？_8364_1.png`
- asset id: `asset-006227`
...
- source class: `HUST-OBC/undeciphered/X/190/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/190/X_？_8364_1.png`
- asset id: `asset-006227`
...
- English observation: `large loop joined to a smaller right loop`
- 中文观察: `左侧大环和右侧小环的相接轮廓已记录。`
...
- Which source records identify obs-unk-004634 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004634？
