# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001135
...
- EVOBC candidate category: `evobc-evo-cat-01135`.
- Source label for search only: `冬`.
- Source codepoints for search only: `U+51AC`.
