# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006659
...
- EVOBC candidate category: `evobc-evo-cat-06659`.
- Source label for search only: `縿`.
- Source codepoints for search only: `U+7E3F`.
