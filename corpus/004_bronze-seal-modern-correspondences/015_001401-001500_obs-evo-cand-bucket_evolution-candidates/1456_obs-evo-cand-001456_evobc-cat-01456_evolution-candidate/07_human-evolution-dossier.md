...
Project ID: `obs-evo-cand-001456`
...
- Project ID: `obs-evo-cand-001456`
- EVOBC category candidate ID: `evobc-evo-cat-01456`
- External category reference: `evobc-cat-01456`
- Source category ID: `01456`
- Source label for human review: `叒`
- Source codepoints: `U+53D2`
...
- `obs-evo-cand-001456-route-category-staging`
...
- `obs-evo-cand-001456-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001456-route-evolution-graph`
