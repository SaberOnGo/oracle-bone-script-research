# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004279
...
- EVOBC candidate category: `evobc-evo-cat-04279`.
- Source label for search only: `橿`.
- Source codepoints for search only: `U+6A7F`.
