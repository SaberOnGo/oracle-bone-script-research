...
Project ID: `obs-evo-cand-006410`
...
- Project ID: `obs-evo-cand-006410`
- EVOBC category candidate ID: `evobc-evo-cat-06410`
- External category reference: `evobc-cat-06410`
- Source category ID: `06410`
- Source label for human review: `粹`
- Source codepoints: `U+7CB9`
...
- `obs-evo-cand-006410-route-category-staging`
...
- `obs-evo-cand-006410-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006410-route-evolution-graph`
