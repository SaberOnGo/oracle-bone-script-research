...
- External category reference: `evobc-cat-03208`
- Source category ID: `03208`
- Source label for human review: `戓`
- Source codepoints: `U+6213`
...
- `obs-evo-cand-003208-route-category-staging`
...
- `obs-evo-cand-003208-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003208-route-evolution-graph`
