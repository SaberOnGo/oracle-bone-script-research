# obs-unk-004935 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/035_obs-unk-004935_h
  ust-obc-und-X-004935_oracle-character-candidate/03_visual-assets/001_asset
  -006528_hust-obc-und-X-004935_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/491/X_？_7475_1.png`
- asset id: `asset-006528`
...
- A broad left descent overlaps a central upright and right branch.
- The single source view is present locally.
- 直接记录：`14_material-visual-observation.md`
- 左侧宽大下行笔画与中央直立笔画和右侧分枝重叠。
- 单一来源视图已在本地保存。
...
- source class: `HUST-OBC/undeciphered/X/491/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/491/X_？_7475_1.png`
- asset id: `asset-006528`
...
- Which source records identify obs-unk-004935 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004935？
