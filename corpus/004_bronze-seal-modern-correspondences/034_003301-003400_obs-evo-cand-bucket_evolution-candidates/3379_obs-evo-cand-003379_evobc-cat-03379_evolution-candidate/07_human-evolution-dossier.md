...
- External category reference: `evobc-cat-03379`
- Source category ID: `03379`
- Source label for human review: `捨`
- Source codepoints: `U+6368`
...
- `obs-evo-cand-003379-route-category-staging`
...
- `obs-evo-cand-003379-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003379-route-evolution-graph`
