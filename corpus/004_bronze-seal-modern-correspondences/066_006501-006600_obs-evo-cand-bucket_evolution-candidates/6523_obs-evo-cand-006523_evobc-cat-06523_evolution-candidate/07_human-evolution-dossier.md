...
- External category reference: `evobc-cat-06523`
- Source category ID: `06523`
- Source label for human review: `統`
- Source codepoints: `U+7D71`
...
- `obs-evo-cand-006523-route-category-staging`
...
- `obs-evo-cand-006523-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006523-route-evolution-graph`
