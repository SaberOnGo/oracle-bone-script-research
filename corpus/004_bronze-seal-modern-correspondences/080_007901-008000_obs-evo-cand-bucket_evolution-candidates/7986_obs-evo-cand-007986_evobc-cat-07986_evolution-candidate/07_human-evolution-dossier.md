...
- External category reference: `evobc-cat-07986`
- Source category ID: `07986`
- Source label for human review: `裯`
- Source codepoints: `U+88EF`
...
- `obs-evo-cand-007986-route-category-staging`
...
- `obs-evo-cand-007986-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007986-route-evolution-graph`
