...
- External category reference: `evobc-cat-13349`
- Source category ID: `13349`
- Source label for human review: `𬤾`
...
- `obs-evo-cand-013349-route-category-staging`
...
- `obs-evo-cand-013349-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013349-route-evolution-graph`
