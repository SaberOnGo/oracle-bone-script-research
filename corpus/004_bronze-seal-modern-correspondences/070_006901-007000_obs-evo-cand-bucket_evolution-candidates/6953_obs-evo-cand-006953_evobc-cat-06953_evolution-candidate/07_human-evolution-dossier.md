...
- Project ID: `obs-evo-cand-006953`
- EVOBC category candidate ID: `evobc-evo-cat-06953`
- External category reference: `evobc-cat-06953`
- Source category ID: `06953`
- Source label for human review: `聥`
- Source codepoints: `U+8065`
...
- `obs-evo-cand-006953-route-category-staging`
...
- `obs-evo-cand-006953-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006953-route-evolution-graph`
