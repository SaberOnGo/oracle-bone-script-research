...
- External category reference: `evobc-cat-02959`
- Source category ID: `02959`
- Source label for human review: `怵`
- Source codepoints: `U+6035`
...
- `obs-evo-cand-002959-route-category-staging`
...
- `obs-evo-cand-002959-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002959-route-evolution-graph`
