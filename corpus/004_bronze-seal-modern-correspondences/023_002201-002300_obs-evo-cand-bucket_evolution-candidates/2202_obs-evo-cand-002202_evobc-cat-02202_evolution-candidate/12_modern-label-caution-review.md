# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002202
...
- EVOBC candidate category: `evobc-evo-cat-02202`.
- Source label for search only: `婟`.
- Source codepoints for search only: `U+5A5F`.
