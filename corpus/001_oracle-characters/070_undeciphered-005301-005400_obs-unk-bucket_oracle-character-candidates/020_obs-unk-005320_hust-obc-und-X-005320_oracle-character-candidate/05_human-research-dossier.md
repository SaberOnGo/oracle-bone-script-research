# obs-unk-005320 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005320`
- primary external id: `hust-obc-und-X-005320`
...
- local review image route: `corpus/001_oracle-characters/070_undeciphered-005
  301-005400_obs-unk-bucket_oracle-character-candidates/020_obs-unk-005320_h
  ust-obc-und-X-005320_oracle-character-candidate/03_visual-assets/001_asset
  -006913_hust-obc-und-X-005320_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/876/X_？_7842_1.png`
- asset id: `asset-006913`
...
- source class: `HUST-OBC/undeciphered/X/876/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/876/X_？_7842_1.png`
- asset id: `asset-006913`
...
- Which source records identify obs-unk-005320 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005320？
