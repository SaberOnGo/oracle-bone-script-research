...
- Project ID: `obs-evo-cand-007530`
- EVOBC category candidate ID: `evobc-evo-cat-07530`
- External category reference: `evobc-cat-07530`
- Source category ID: `07530`
- Source label for human review: `蓝`
- Source codepoints: `U+84DD`
...
- `obs-evo-cand-007530-route-category-staging`
...
- `obs-evo-cand-007530-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007530-route-evolution-graph`
