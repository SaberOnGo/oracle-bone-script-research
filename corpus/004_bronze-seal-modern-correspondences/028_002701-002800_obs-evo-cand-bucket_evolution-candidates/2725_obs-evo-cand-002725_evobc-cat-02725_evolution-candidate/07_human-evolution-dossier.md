...
- External category reference: `evobc-cat-02725`
- Source category ID: `02725`
- Source label for human review: `府`
- Source codepoints: `U+5E9C`
...
- `obs-evo-cand-002725-route-category-staging`
...
- `obs-evo-cand-002725-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002725-route-evolution-graph`
