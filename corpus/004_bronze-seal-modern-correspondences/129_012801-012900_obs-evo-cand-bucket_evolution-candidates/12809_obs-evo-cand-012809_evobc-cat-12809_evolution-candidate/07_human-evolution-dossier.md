...
- Project ID: `obs-evo-cand-012809`
- EVOBC category candidate ID: `evobc-evo-cat-12809`
- External category reference: `evobc-cat-12809`
- Source category ID: `12809`
- Source label for human review: `𪠴`
- Source codepoints: `U+2A834`
...
- `obs-evo-cand-012809-route-category-staging`
...
- `obs-evo-cand-012809-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012809-route-evolution-graph`
