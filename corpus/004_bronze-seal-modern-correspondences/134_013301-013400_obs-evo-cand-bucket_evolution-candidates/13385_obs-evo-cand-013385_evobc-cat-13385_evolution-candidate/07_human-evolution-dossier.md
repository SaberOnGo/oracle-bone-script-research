...
Project ID: `obs-evo-cand-013385`
...
- Project ID: `obs-evo-cand-013385`
- EVOBC category candidate ID: `evobc-evo-cat-13385`
- External category reference: `evobc-cat-13385`
- Source category ID: `13385`
- Source label for human review: `𬪓`
- Source codepoints: `U+2CA93`
...
- `obs-evo-cand-013385-route-category-staging`
...
- `obs-evo-cand-013385-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013385-route-evolution-graph`
