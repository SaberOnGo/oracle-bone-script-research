# obs-unk-003967 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/067_obs-unk-003967_h
  ust-obc-und-L-003967_oracle-character-candidate/03_visual-assets/001_asset
  -005560_hust-obc-und-L-003967_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3967/L_？_838.jpg`
- asset id: `asset-005560`
...
- source class: `HUST-OBC/undeciphered/L/3967/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3967/L_？_838.jpg`
- asset id: `asset-005560`
...
- English observation: A broad upper outline has a short inner trace, with thin
  curved or vertical traces descending below it.
- 中文观察：较宽上部轮廓内有短痕，下方有较细弧向或竖向痕迹下行。
...
- Which source records identify obs-unk-003967 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003967？
