...
Project ID: `obs-evo-cand-009974`
...
- Project ID: `obs-evo-cand-009974`
- EVOBC category candidate ID: `evobc-evo-cat-09974`
- External category reference: `evobc-cat-09974`
- Source category ID: `09974`
- Source label for human review: `頊`
- Source codepoints: `U+980A`
...
- `obs-evo-cand-009974-route-category-staging`
...
- `obs-evo-cand-009974-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009974-route-evolution-graph`
