# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000881
...
| --- | --- | --- | --- |
| `obimd-glyph-link-012709` | 򮛼 | `U+AE6FC` | `reviewed_metadata_only` |
| `obimd-glyph-link-012710` | 󴽓 | `U+F4F53` | `reviewed_metadata_only` |
| `obimd-glyph-link-012711` | 󴽔 | `U+F4F54` | `reviewed_metadata_only` |
| `obimd-glyph-link-012712` | 󴽕 | `U+F4F55` | `reviewed_metadata_only` |
