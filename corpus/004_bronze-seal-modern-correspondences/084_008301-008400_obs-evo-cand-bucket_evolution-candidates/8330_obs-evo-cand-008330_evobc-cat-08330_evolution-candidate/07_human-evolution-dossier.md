...
- External category reference: `evobc-cat-08330`
- Source category ID: `08330`
- Source label for human review: `謬`
- Source codepoints: `U+8B2C`
...
- `obs-evo-cand-008330-route-category-staging`
...
- `obs-evo-cand-008330-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008330-route-evolution-graph`
