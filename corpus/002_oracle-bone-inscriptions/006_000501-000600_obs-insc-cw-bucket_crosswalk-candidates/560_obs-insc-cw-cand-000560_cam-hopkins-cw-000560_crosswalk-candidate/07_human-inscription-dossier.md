...
Project ID: `obs-insc-cw-cand-000560`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000560`
...
- Yingguo / 英国所藏: `y2572` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `408` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `505` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000560`
