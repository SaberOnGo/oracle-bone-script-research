...
- External category reference: `evobc-cat-00537`
- Source category ID: `00537`
- Source label for human review: `䩉`
- Source codepoints: `U+4A49`
...
- `obs-evo-cand-000537-route-category-staging`
...
- `obs-evo-cand-000537-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000537-route-evolution-graph`
