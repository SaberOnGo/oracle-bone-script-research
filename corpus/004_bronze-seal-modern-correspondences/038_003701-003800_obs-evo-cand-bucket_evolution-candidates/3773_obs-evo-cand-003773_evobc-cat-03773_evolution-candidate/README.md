# obs-evo-cand-003773 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-03773`
- Source label for human review: `暊`
- Source codepoints: `U+668A`
- Image reference count: `118`
- Era token counts: `BI:9;OBC:26;WSC:83`
- Source token counts: `Web:118`
