# Material Visual Observation / obs-comp-cand-001666 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001666`
- External reference / 外部参照: `obimd-sub-k9ucte506p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017342_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/efgs491edx/k9ucte506p/k9ucte506p.png`
- Checksum / 校验和:
  `8caae30db4c8092dfa70795071401a39e2a49666b724fadc59e7889d4f0503f0`
...
- Marked-pixel bounds: (72,50)–(177,195); span 106 × 146 px; the marked
...
- 痕迹范围：(72,50)–(177,195)；跨度106 × 146 px；痕迹矩形高于宽。
