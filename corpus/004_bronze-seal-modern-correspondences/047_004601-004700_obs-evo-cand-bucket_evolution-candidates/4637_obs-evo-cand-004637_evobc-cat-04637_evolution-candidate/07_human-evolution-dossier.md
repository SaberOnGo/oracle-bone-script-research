...
Project ID: `obs-evo-cand-004637`
...
- Project ID: `obs-evo-cand-004637`
- EVOBC category candidate ID: `evobc-evo-cat-04637`
- External category reference: `evobc-cat-04637`
- Source category ID: `04637`
- Source label for human review: `洱`
- Source codepoints: `U+6D31`
...
- `obs-evo-cand-004637-route-category-staging`
...
- `obs-evo-cand-004637-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004637-route-evolution-graph`
