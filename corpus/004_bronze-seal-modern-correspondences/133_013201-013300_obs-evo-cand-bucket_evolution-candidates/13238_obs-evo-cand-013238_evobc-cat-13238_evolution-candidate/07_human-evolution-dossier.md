...
Project ID: `obs-evo-cand-013238`
...
- Project ID: `obs-evo-cand-013238`
- EVOBC category candidate ID: `evobc-evo-cat-13238`
- External category reference: `evobc-cat-13238`
- Source category ID: `13238`
- Source label for human review: `𬌢`
- Source codepoints: `U+2C322`
...
- `obs-evo-cand-013238-route-category-staging`
...
- `obs-evo-cand-013238-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013238-route-evolution-graph`
