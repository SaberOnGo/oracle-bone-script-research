...
- External category reference: `evobc-cat-06333`
- Source category ID: `06333`
- Source label for human review: `篷`
- Source codepoints: `U+7BF7`
...
- `obs-evo-cand-006333-route-category-staging`
...
- `obs-evo-cand-006333-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006333-route-evolution-graph`
