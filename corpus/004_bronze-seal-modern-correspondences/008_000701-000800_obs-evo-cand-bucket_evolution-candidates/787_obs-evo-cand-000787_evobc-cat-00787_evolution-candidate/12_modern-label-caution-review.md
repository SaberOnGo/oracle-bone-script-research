# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000787
...
- EVOBC candidate category: `evobc-evo-cat-00787`.
- Source label for search only: `伺`.
- Source codepoints for search only: `U+4F3A`.
