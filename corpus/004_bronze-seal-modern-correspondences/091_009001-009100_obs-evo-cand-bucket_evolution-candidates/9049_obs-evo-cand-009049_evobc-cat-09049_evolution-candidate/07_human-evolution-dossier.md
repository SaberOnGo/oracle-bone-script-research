...
- Project ID: `obs-evo-cand-009049`
- EVOBC category candidate ID: `evobc-evo-cat-09049`
- External category reference: `evobc-cat-09049`
- Source category ID: `09049`
- Source label for human review: `遥`
- Source codepoints: `U+9065`
...
- `obs-evo-cand-009049-route-category-staging`
...
- `obs-evo-cand-009049-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009049-route-evolution-graph`
