# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006367
...
- EVOBC candidate category: `evobc-evo-cat-06367`.
- Source label for search only: `籋`.
- Source codepoints for search only: `U+7C4B`.
