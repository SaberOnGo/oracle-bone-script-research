...
- `obs-evo-cand-010638-route-category-staging`
...
- `obs-evo-cand-010638-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010638-route-evolution-graph`
