...
- External category reference: `evobc-cat-00362`
- Source category ID: `00362`
- Source label for human review: `䐘`
- Source codepoints: `U+4418`
...
- `obs-evo-cand-000362-route-category-staging`
...
- `obs-evo-cand-000362-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000362-route-evolution-graph`
