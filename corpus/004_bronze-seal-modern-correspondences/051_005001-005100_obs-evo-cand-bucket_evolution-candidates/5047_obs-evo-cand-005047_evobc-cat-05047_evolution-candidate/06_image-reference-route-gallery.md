...
- `obs-evo-cand-005047-route-category-staging`
...
- `obs-evo-cand-005047-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005047-route-evolution-graph`
