...
- Yingguo / 英国所藏: `ybu03` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: 待查: missing CUL reference in source row
- Chalfant / Chalfant 著录: `649` in source row; primary catalog entry pending
