# obs-unk-004003 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/003_obs-unk-004003_h
  ust-obc-und-L-004003_oracle-character-candidate/03_visual-assets/001_asset
  -005596_hust-obc-und-L-004003_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4003/L_？_8493.jpg`
- asset id: `asset-005596`
...
- source class: `HUST-OBC/undeciphered/L/4003/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4003/L_？_8493.jpg`
- asset id: `asset-005596`
...
- English observation: A rounded upper bar sits above two descending curved
  traces; the lower ends are open in the tight crop.
- 中文观察：上部有圆弧状横向痕迹，下方有两条弯曲下行痕迹，下端呈开放状。
...
- Which source records identify obs-unk-004003 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004003？
