# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002839
...
- EVOBC candidate category: `evobc-evo-cat-02839`.
- Source label for search only: `彝`.
- Source codepoints for search only: `U+5F5D`.
