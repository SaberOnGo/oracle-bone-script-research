...
- External category reference: `evobc-cat-13121`
- Source category ID: `13121`
- Source label for human review: `𫷘`
...
- `obs-evo-cand-013121-route-category-staging`
...
- `obs-evo-cand-013121-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013121-route-evolution-graph`
