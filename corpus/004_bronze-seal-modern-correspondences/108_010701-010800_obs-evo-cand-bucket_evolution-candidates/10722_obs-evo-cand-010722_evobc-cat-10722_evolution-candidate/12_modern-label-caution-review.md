# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010722
...
- EVOBC candidate category: `evobc-evo-cat-10722`.
- Source label for search only: `齜`.
- Source codepoints for search only: `U+9F5C`.
