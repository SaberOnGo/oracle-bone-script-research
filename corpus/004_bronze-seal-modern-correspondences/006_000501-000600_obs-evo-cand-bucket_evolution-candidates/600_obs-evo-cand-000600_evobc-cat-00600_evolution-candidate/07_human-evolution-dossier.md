...
- External category reference: `evobc-cat-00600`
- Source category ID: `00600`
- Source label for human review: `䶰`
- Source codepoints: `U+4DB0`
...
- `obs-evo-cand-000600-route-category-staging`
...
- `obs-evo-cand-000600-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000600-route-evolution-graph`
