# Material Visual Observation / obs-comp-cand-000024 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000024`
- External reference / 外部参照: `obimd-sub-q0zk6lmad8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011176_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vbkc7p8qc9/q0zk6lmad8/q0zk6lmad8.png`
- Checksum / 校验和:
  `f205986f7bf10974546dad9929507fa721c015e8ee16e7c5d249980c6ae56335`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.21%.
- Marked-pixel bounds: (85,18)–(164,231); span 80 × 214 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.21%。
- 痕迹范围：(85,18)–(164,231)；跨度80 × 214 px；痕迹矩形高于宽。
