# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008533
...
- EVOBC candidate category: `evobc-evo-cat-08533`.
- Source label for search only: `貝`.
- Source codepoints for search only: `U+8C9D`.
