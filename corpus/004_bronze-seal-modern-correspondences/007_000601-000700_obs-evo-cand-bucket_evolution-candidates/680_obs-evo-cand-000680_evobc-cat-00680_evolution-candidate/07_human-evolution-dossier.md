...
- Project ID: `obs-evo-cand-000680`
- EVOBC category candidate ID: `evobc-evo-cat-00680`
- External category reference: `evobc-cat-00680`
- Source category ID: `00680`
- Source label for human review: `予`
- Source codepoints: `U+4E88`
...
- `obs-evo-cand-000680-route-category-staging`
...
- `obs-evo-cand-000680-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000680-route-evolution-graph`
