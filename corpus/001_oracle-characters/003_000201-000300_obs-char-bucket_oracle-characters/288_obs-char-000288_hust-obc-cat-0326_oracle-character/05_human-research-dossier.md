# obs-char-000288 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000288`
- primary external id: `hust-obc-cat-0326`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/288_obs-char-000288_hust-obc-cat-0326_orac
  le-character/03_visual-assets/001_asset-000293_hust-obc-cat-0326_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0326/G_0326_乙12合21021𠂤組.png`
- asset id: `asset-000293`
...
- source category: `0326`
- validation class: `287`
- source image route: `HUST-OBC/deciphered/0326/G_0326_乙12合21021𠂤組.png`
- asset id: `asset-000293`
...
- English observation: `The image has a broad rounded outer contour with a
  pointed upper tip and a short diagonal interior mark; a small side stroke
  is also visible.`
...
- dataset label text: `㔼`
- dataset label codepoints: `U+353C`
...
- Which source records identify obs-char-000288 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000288？
