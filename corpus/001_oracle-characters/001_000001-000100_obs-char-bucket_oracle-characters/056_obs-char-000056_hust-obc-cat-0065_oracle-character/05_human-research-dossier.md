# obs-char-000056 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000056`
- primary external id: `hust-obc-cat-0065`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/056_obs-char-000056_hust-obc-cat-0065_orac
  le-character/03_visual-assets/001_asset-000061_hust-obc-cat-0065_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0065/G_0065_乙1781合21905子組.png`
- asset id: `asset-000061`
...
- source category: `0065`
- validation class: `55`
- source image route: `HUST-OBC/deciphered/0065/G_0065_乙1781合21905子組.png`
- asset id: `asset-000061`
...
- English observation: `Two neighboring dark forms are visible, each with an
  upright stroke, a curved lower turn, and a short upper projection.`
- 中文观察: `图像可见两个相邻深色形体，各有直立笔画、下部弯转和短上部伸出。`
...
- dataset label text: `㐷`
- dataset label codepoints: `U+3437`
...
- Which source records identify obs-char-000056 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000056？
