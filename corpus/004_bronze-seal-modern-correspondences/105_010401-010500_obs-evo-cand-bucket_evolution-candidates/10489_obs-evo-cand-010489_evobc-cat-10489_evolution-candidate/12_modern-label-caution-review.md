# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010489
...
- EVOBC candidate category: `evobc-evo-cat-10489`.
- Source label for search only: `鴜`.
- Source codepoints for search only: `U+9D1C`.
