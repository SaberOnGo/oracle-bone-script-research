...
- External category reference: `evobc-cat-08937`
- Source category ID: `08937`
- Source label for human review: `迄`
...
- `obs-evo-cand-008937-route-category-staging`
...
- `obs-evo-cand-008937-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008937-route-evolution-graph`
