# Material Visual Observation / obs-comp-cand-001310 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001310`
- External reference / 外部参照: `obimd-sub-d0hauaf16v`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015647_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/d0hauaf16v/d0hauaf16v/d0hauaf16v.png`
- Checksum / 校验和:
  `0b04d962c741a6bf65f031647a46a98f44dcb72e6d03514bac3752a82e663f08`
...
- Marked-pixel bounds: (83,28)–(160,221); span 78 × 194 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.63%。
- 痕迹范围：(83,28)–(160,221)；跨度78 × 194 px；痕迹矩形高于宽。
