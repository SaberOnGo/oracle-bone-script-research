# obs-unk-005228 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005228`
- primary external id: `hust-obc-und-X-005228`
...
- local review image route: `corpus/001_oracle-characters/069_undeciphered-005
  201-005300_obs-unk-bucket_oracle-character-candidates/028_obs-unk-005228_h
  ust-obc-und-X-005228_oracle-character-candidate/03_visual-assets/001_asset
  -006821_hust-obc-und-X-005228_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/784/X_？_7747_1.png`
- asset id: `asset-006821`
...
- source class: `HUST-OBC/undeciphered/X/784/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/784/X_？_7747_1.png`
- asset id: `asset-006821`
...
- Which source records identify obs-unk-005228 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005228？
