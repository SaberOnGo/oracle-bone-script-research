...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0856`
...
- Source image / 来源图: `X_0856_2856_1.png`
- Image / 图像: `001_asset-000759_hust-obc-cat-0856_glyph.png`
...
- target node: `evobc-evo-cat-00067`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00067`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00067`
...
- Matched candidate folders / 匹配候选目录: `evobc-evo-cat-00067`
- Human review files / 人类复核文件:
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/067_obs-evo-cand-000067_evobc-cat-00067_evoluti
...
- Source label text / 来源标签文字: `㝎`
- Source label codepoint / 来源标签 codepoint: `U+374E`
