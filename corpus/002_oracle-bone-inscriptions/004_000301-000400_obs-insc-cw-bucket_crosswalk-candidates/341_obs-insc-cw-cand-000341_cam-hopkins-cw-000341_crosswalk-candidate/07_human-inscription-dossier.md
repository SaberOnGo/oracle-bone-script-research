...
- Yingguo / 英国所藏: `y2016` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `516` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `92` in source row; primary catalog entry pending
