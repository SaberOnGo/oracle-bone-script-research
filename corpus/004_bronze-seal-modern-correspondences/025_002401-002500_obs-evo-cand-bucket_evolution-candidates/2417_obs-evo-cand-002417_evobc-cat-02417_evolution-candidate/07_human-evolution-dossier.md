...
- External category reference: `evobc-cat-02417`
- Source category ID: `02417`
- Source label for human review: `寐`
- Source codepoints: `U+5BD0`
...
- `obs-evo-cand-002417-route-category-staging`
...
- `obs-evo-cand-002417-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002417-route-evolution-graph`
