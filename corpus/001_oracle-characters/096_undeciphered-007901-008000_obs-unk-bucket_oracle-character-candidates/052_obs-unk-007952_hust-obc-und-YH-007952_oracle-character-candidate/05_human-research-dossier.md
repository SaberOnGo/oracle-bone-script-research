# obs-unk-007952 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-007952`
- primary external id: `hust-obc-und-YH-007952`
...
- local review image route: `corpus/001_oracle-characters/096_undeciphered-007
  901-008000_obs-unk-bucket_oracle-character-candidates/052_obs-unk-007952_h
  ust-obc-und-YH-007952_oracle-character-candidate/03_visual-assets/001_asse
  t-009543_hust-obc-und-YH-007952_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6053F/H_？_6053F_0.png`
- asset id: `asset-009543`
...
- source class: `HUST-OBC/undeciphered/Y+H/6053F/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6053F/H_？_6053F_0.png`
- asset id: `asset-009543`
...
- Which source records identify obs-unk-007952 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007952？
