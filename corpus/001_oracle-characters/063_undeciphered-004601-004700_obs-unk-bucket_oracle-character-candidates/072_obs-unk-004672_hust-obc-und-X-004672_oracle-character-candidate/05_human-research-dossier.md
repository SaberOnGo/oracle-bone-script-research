# obs-unk-004672 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004672`
- primary external id: `hust-obc-und-X-004672`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/072_obs-unk-004672_h
  ust-obc-und-X-004672_oracle-character-candidate/03_visual-assets/001_asset
  -006265_hust-obc-und-X-004672_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/228/X_？_8397_1.png`
- asset id: `asset-006265`
...
- source class: `HUST-OBC/undeciphered/X/228/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/228/X_？_8397_1.png`
- asset id: `asset-006265`
...
- English observation: `separated strokes with two long lower legs`
- 中文观察: `带两条长下行笔画的分离笔画组`
...
- Which source records identify obs-unk-004672 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004672？
