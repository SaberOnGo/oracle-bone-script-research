...
- External category reference: `evobc-cat-02963`
- Source category ID: `02963`
- Source label for human review: `恁`
- Source codepoints: `U+6041`
...
- `obs-evo-cand-002963-route-category-staging`
...
- `obs-evo-cand-002963-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002963-route-evolution-graph`
