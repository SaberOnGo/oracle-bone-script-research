...
Project ID: `obs-evo-cand-004736`
...
- Project ID: `obs-evo-cand-004736`
- EVOBC category candidate ID: `evobc-evo-cat-04736`
- External category reference: `evobc-cat-04736`
- Source category ID: `04736`
- Source label for human review: `淰`
- Source codepoints: `U+6DF0`
...
- `obs-evo-cand-004736-route-category-staging`
...
- `obs-evo-cand-004736-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004736-route-evolution-graph`
