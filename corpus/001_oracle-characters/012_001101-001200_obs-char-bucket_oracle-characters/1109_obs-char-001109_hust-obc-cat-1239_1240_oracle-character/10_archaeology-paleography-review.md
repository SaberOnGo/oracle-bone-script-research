# obs-char-001109 Archaeology Paleography Review

# obs-char-001109 考古文字复核档案
...
- first local image: `001_asset-001114_hust-obc-cat-1239_1240_glyph.png`
- first source image: `G_1239_上(2).從(甲).16(楚).png`
