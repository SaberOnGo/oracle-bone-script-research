# Material Visual Observation / obs-comp-cand-000520 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000520`
- External reference / 外部参照: `obimd-sub-ev5rkbdabc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012755_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ev5rkbdabc/ev5rkbdabc/ev5rkbdabc.png`
- Checksum / 校验和:
  `1d2a590c796370802b0b8247cb067e89e489c0b89299cc01b0c5a28fc811d45a`
...
- Marked-pixel bounds: (51,49)–(198,200); span 148 × 152 px; the marked
...
- 痕迹范围：(51,49)–(198,200)；跨度148 × 152 px；痕迹矩形近方形。
