...
- `obs-evo-cand-000480-route-category-staging`
...
- `obs-evo-cand-000480-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000480-route-evolution-graph`
