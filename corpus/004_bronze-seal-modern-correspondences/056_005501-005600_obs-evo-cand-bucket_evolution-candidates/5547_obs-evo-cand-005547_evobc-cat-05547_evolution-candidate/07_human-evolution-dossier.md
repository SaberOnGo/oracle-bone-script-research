...
Project ID: `obs-evo-cand-005547`
...
- Project ID: `obs-evo-cand-005547`
- EVOBC category candidate ID: `evobc-evo-cat-05547`
- External category reference: `evobc-cat-05547`
- Source category ID: `05547`
- Source label for human review: `电`
- Source codepoints: `U+7535`
...
- `obs-evo-cand-005547-route-category-staging`
...
- `obs-evo-cand-005547-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005547-route-evolution-graph`
