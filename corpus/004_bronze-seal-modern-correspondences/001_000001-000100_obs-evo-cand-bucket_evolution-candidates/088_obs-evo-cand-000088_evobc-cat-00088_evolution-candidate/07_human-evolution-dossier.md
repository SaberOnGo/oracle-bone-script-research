...
Project ID: `obs-evo-cand-000088`
...
- Project ID: `obs-evo-cand-000088`
- EVOBC category candidate ID: `evobc-evo-cat-00088`
- External category reference: `evobc-cat-00088`
- Source category ID: `00088`
- Source label for human review: `㠭`
- Source codepoints: `U+382D`
...
- `obs-evo-cand-000088-route-category-staging`
...
- `obs-evo-cand-000088-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000088-route-evolution-graph`
