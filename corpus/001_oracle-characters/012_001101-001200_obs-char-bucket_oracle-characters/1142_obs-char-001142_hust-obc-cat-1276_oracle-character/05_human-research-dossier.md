# obs-char-001142 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001142`
- primary external id: `hust-obc-cat-1276`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1142_obs-char-001142_hust-obc-cat-1276_ora
  cle-character/03_visual-assets/001_asset-001147_hust-obc-cat-1276_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1276/G_1276_前8.5.3合21384子組.png`
- asset id: `asset-001147`
...
- source category: `1276`
- validation class: `1141`
- source image route: `HUST-OBC/deciphered/1276/G_1276_前8.5.3合21384子組.png`
- asset id: `asset-001147`
...
- English observation: `A compact rounded enclosure has a heavy upper and
  left contour, an open lower-right gap, and a short inner stroke.`
- 中文观察: `紧凑的圆弧形框廓有较重的上部和左侧轮廓，右下方留有开口，内部有短笔。`
...
- dataset label text: `㣲`
- dataset label codepoints: `U+38F2`
...
- filename catalog route clues: `Heji-like filename clue: 合21384
  (G_1276_前8.5.3合21384子組.png)`
...
- Which source records identify obs-char-001142 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001142？
