# obs-unk-008389 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/100_undeciphered-008
  301-008400_obs-unk-bucket_oracle-character-candidates/089_obs-unk-008389_h
  ust-obc-und-YH-008389_oracle-character-candidate/03_visual-assets/001_asse
  t-009980_hust-obc-und-YH-008389_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60A67/H_？_60A67_0.png`
- asset id: `asset-009980`
...
- source class: `HUST-OBC/undeciphered/Y+H/60A67/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60A67/H_？_60A67_0.png`
- asset id: `asset-009980`
...
- Which source records identify obs-unk-008389 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008389？
