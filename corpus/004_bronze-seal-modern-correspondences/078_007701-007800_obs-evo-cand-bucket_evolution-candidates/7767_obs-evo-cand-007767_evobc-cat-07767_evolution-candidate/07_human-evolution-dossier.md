...
- External category reference: `evobc-cat-07767`
- Source category ID: `07767`
- Source label for human review: `蛾`
...
- `obs-evo-cand-007767-route-category-staging`
...
- `obs-evo-cand-007767-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007767-route-evolution-graph`
