# obs-char-001348 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1348_obs-char-001348_hust-obc-cat-1505_ora
  cle-character/03_visual-assets/001_asset-001353_hust-obc-cat-1505_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1505/G_1505_京都1932合28231無名組.png
  `
- asset id: `asset-001353`
...
- source category: `1505`
- validation class: `1347`
- source image route: `HUST-OBC/deciphered/1505/G_1505_京都1932合28231無名組.png`
- asset id: `asset-001353`
...
- English observation: `Several detached left curves accompany a right
  pointed enclosure with inner divisions and a lower stem.`
- 中文观察: `数条分离的左侧弧线旁有右侧尖状框形，内部有分隔笔画并接下部笔干。`
...
- dataset label text: `㧗`
- dataset label codepoints: `U+39D7`
...
- filename catalog route clues: `Heji-like filename clue: 合28231
...
- Which source records identify obs-char-001348 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001348？
