# Material Visual Observation / obs-comp-cand-001892 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001892`
- External reference / 外部参照: `obimd-sub-cvd6s2s17g`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018271_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cvd6s2s17g/cvd6s2s17g/cvd6s2s17g.png`
- Checksum / 校验和:
  `063b76d9bc22442f89f2cacea56f036047240b1382b1d622162c792386484708`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.43%.
- Marked-pixel bounds: (53,29)–(209,222); span 157 × 194 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.43%。
- 痕迹范围：(53,29)–(209,222)；跨度157 × 194 px；痕迹矩形高于宽。
