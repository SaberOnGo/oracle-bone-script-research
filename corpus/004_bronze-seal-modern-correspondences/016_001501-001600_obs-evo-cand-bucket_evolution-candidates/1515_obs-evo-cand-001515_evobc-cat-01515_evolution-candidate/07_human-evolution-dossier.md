...
Project ID: `obs-evo-cand-001515`
...
- Project ID: `obs-evo-cand-001515`
- EVOBC category candidate ID: `evobc-evo-cat-01515`
- External category reference: `evobc-cat-01515`
- Source category ID: `01515`
- Source label for human review: `听`
- Source codepoints: `U+542C`
...
- `obs-evo-cand-001515-route-category-staging`
...
- `obs-evo-cand-001515-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001515-route-evolution-graph`
