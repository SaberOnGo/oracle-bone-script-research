...
- Project ID: `obs-evo-cand-011703`
- EVOBC category candidate ID: `evobc-evo-cat-11703`
- External category reference: `evobc-cat-11703`
- Source category ID: `11703`
- Source label for human review: `𤷄`
- Source codepoints: `U+24DC4`
...
- `obs-evo-cand-011703-route-category-staging`
...
- `obs-evo-cand-011703-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011703-route-evolution-graph`
