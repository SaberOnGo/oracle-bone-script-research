# Material Visual Observation / obs-comp-cand-000164 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000164`
- External reference / 外部参照: `obimd-sub-byf07kxb4z`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011576_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lxao6q3l56/byf07kxb4z/byf07kxb4z.png`
- Checksum / 校验和:
  `aad7de84e73d92d5d696b77579aab34d9956a08be3da9d9516a065aa911c21b9`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.09%.
- Marked-pixel bounds: (58,25)–(191,205); span 134 × 181 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.09%。
- 痕迹范围：(58,25)–(191,205)；跨度134 × 181 px；痕迹矩形高于宽。
