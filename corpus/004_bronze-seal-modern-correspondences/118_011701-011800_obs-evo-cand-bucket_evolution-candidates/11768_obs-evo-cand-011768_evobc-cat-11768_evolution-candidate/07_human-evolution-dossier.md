...
- External category reference: `evobc-cat-11768`
- Source category ID: `11768`
- Source label for human review: `𥃫`
...
- `obs-evo-cand-011768-route-category-staging`
...
- `obs-evo-cand-011768-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011768-route-evolution-graph`
