...
Project ID: `obs-insc-cw-cand-000143`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000143`
...
- Yingguo / 英国所藏: `y800` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `29` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `648` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000143`
