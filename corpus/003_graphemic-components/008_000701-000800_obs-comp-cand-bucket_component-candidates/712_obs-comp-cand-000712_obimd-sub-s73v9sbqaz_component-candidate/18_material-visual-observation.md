# Material Visual Observation / obs-comp-cand-000712 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000712`
- External reference / 外部参照: `obimd-sub-s73v9sbqaz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013424_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/s73v9sbqaz/s73v9sbqaz/s73v9sbqaz.png`
- Checksum / 校验和:
  `ffede18ac9777d29b9196aef3810c8e7ccaf270e9e08d566ea00328018badb76`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.80%.
- Marked-pixel bounds: (76,30)–(184,222); span 109 × 193 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.80%。
- 痕迹范围：(76,30)–(184,222)；跨度109 × 193 px；痕迹矩形高于宽。
