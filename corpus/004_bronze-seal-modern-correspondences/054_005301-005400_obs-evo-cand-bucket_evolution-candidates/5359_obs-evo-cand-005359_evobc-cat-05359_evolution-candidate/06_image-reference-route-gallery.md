...
- `obs-evo-cand-005359-route-category-staging`
...
- `obs-evo-cand-005359-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005359-route-evolution-graph`
