...
- Project ID: `obs-evo-cand-000192`
- EVOBC category candidate ID: `evobc-evo-cat-00192`
- External category reference: `evobc-cat-00192`
- Source category ID: `00192`
- Source label for human review: `㱕`
- Source codepoints: `U+3C55`
...
- `obs-evo-cand-000192-route-category-staging`
...
- `obs-evo-cand-000192-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000192-route-evolution-graph`
