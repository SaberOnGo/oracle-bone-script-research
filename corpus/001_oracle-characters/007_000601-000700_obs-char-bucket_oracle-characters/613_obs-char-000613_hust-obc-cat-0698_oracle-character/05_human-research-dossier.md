# obs-char-000613 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/613_obs-char-000613_hust-obc-cat-0698_orac
  le-character/03_visual-assets/001_asset-000618_hust-obc-cat-0698_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0698/X_0698_4938_1.png`
- asset id: `asset-000618`
...
- source category: `0698`
- validation class: `612`
- source image route: `HUST-OBC/deciphered/0698/X_0698_4938_1.png`
- asset id: `asset-000618`
...
- English observation: `Two detached upright rectangular loops stand above a
  large downward-pointing V-shaped outline with inward side strokes and a
  narrow central opening.`
- 中文观察: `两个分离直立矩形环位于大型向下尖 V 形轮廓之上，轮廓有内向侧笔和狭窄中央空隙。`
...
- dataset label text: `㚰`
- dataset label codepoints: `U+36B0`
...
- Which source records identify obs-char-000613 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000613？
