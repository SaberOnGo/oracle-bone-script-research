...
- External category reference: `evobc-cat-13515`
- Source category ID: `13515`
- Source label for human review: `𭗧`
- Source codepoints: `U+2D5E7`
...
- `obs-evo-cand-013515-route-category-staging`
...
- `obs-evo-cand-013515-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013515-route-evolution-graph`
