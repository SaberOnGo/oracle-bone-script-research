# obs-unk-005485 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005485`
- primary external id: `hust-obc-und-X-005485`
...
- local review image route: `corpus/001_oracle-characters/071_undeciphered-005
  401-005500_obs-unk-bucket_oracle-character-candidates/085_obs-unk-005485_h
  ust-obc-und-X-005485_oracle-character-candidate/03_visual-assets/001_asset
  -007078_hust-obc-und-X-005485_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1041/X_？_8002_1.png`
- asset id: `asset-007078`
...
- source class: `HUST-OBC/undeciphered/X/1041/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1041/X_？_8002_1.png`
- asset id: `asset-007078`
...
- Which source records identify obs-unk-005485 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005485？
