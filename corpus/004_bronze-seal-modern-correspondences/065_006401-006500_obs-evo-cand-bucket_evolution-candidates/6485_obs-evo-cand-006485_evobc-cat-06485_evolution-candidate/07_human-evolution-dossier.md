...
- External category reference: `evobc-cat-06485`
- Source category ID: `06485`
- Source label for human review: `紼`
- Source codepoints: `U+7D3C`
...
- `obs-evo-cand-006485-route-category-staging`
...
- `obs-evo-cand-006485-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006485-route-evolution-graph`
