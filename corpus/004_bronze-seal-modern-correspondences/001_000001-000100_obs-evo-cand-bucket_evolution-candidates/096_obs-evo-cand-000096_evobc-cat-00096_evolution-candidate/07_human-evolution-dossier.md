...
- External category reference: `evobc-cat-00096`
- Source category ID: `00096`
- Source label for human review: `㡿`
- Source codepoints: `U+387F`
...
- `obs-evo-cand-000096-route-category-staging`
...
- `obs-evo-cand-000096-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000096-route-evolution-graph`
