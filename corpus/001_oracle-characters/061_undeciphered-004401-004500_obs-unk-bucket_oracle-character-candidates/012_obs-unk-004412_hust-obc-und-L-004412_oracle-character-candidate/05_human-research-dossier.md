# obs-unk-004412 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/012_obs-unk-004412_h
  ust-obc-und-L-004412_oracle-character-candidate/03_visual-assets/001_asset
  -006005_hust-obc-und-L-004412_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4412/L_？_9867.jpg`
- asset id: `asset-006005`
...
- source class: `HUST-OBC/undeciphered/L/4412/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4412/L_？_9867.jpg`
- asset id: `asset-006005`
...
- English observation: `A broad upper-left curve descends toward a short`
  `lower terminal; a separate angular mark sits above.`
- 中文观察: `左上宽弧向下连接短末端，上部另有分离的斜角痕。`
...
- Which source records identify obs-unk-004412 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004412？
