# obs-char-001228 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001228`
- primary external id: `hust-obc-cat-1373`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1228_obs-char-001228_hust-obc-cat-1373_ora
  cle-character/03_visual-assets/001_asset-001233_hust-obc-cat-1373_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1373/G_1373_前7.43.2合13442賓組.png
  `
- asset id: `asset-001233`
...
- source category: `1373`
- validation class: `1227`
- source image route: `HUST-OBC/deciphered/1373/G_1373_前7.43.2合13442賓組.png`
- asset id: `asset-001233`
...
- English observation: `A broad arched form links two side clusters with a
  smaller inner arc below the top contour.`
- 中文观察: `宽大的拱形轮廓连接两侧笔群，上部轮廓下方有较小内部弧线。`
...
- dataset label text: `㥓`
- dataset label codepoints: `U+3953`
...
- filename catalog route clues: `Heji-like filename clue: 合13442
  (G_1373_前7.43.2合13442賓組.png)`
...
- Which source records identify obs-char-001228 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001228？
