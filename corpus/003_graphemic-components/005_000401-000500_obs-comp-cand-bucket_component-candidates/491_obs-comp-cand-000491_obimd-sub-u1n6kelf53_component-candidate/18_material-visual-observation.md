# Material Visual Observation / obs-comp-cand-000491 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000491`
- External reference / 外部参照: `obimd-sub-u1n6kelf53`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012727_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kfdhplatyr/u1n6kelf53/u1n6kelf53.png`
- Checksum / 校验和:
  `d8c87da1c8b2384ac878d748c310bd8757171bd3f4844c475615a956256c4e5b`
...
- Marked-pixel bounds: (67,28)–(181,217); span 115 × 190 px; the marked
...
- 痕迹范围：(67,28)–(181,217)；跨度115 × 190 px；痕迹矩形高于宽。
