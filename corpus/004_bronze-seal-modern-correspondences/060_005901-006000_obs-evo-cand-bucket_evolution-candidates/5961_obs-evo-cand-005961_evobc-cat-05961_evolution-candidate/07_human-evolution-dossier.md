...
- External category reference: `evobc-cat-05961`
- Source category ID: `05961`
- Source label for human review: `礪`
- Source codepoints: `U+792A`
...
- `obs-evo-cand-005961-route-category-staging`
...
- `obs-evo-cand-005961-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005961-route-evolution-graph`
