...
- Title / 题名: Penn Museum oracle bone object records
- Provider / 提供方: University of Pennsylvania Museum of Archaeology and
  Anthropology
- Source type / 来源类型: museum_collection
- Authority tier / 证据等级: university_museum_collection
- Scope / 适用范围: Official Penn Museum object record for oracle bone 49-14-7A with
  object number, Anyang provenience, Shang Dynasty period, material, dimensions,
  display location, and credit line.
