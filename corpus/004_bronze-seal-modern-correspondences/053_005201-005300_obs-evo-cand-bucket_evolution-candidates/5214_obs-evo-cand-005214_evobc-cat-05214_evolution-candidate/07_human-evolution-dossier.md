...
- External category reference: `evobc-cat-05214`
- Source category ID: `05214`
- Source label for human review: `牱`
...
- `obs-evo-cand-005214-route-category-staging`
...
- `obs-evo-cand-005214-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005214-route-evolution-graph`
