# Material Visual Observation / obs-comp-cand-002026 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002026`
- External reference / 外部参照: `obimd-sub-o8877rkdzj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019353_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/y1u4nexjl4/o8877rkdzj/o8877rkdzj.png`
- Checksum / 校验和:
  `30cb0ce0e63b850f4fded811acd0b7560ec3ed8b3162b5dc8c31eaecacbe6ddd`
...
- Marked-pixel bounds: (76,43)–(173,210); span 98 × 168 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.00%。
- 痕迹范围：(76,43)–(173,210)；跨度98 × 168 px；痕迹矩形高于宽。
