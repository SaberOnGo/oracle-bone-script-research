...
- External category reference: `evobc-cat-01489`
- Source category ID: `01489`
- Source label for human review: `吁`
...
- `obs-evo-cand-001489-route-category-staging`
...
- `obs-evo-cand-001489-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001489-route-evolution-graph`
