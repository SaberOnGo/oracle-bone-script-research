...
- External category reference: `evobc-cat-05099`
- Source category ID: `05099`
- Source label for human review: `然`
- Source codepoints: `U+7136`
...
- `obs-evo-cand-005099-route-category-staging`
...
- `obs-evo-cand-005099-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005099-route-evolution-graph`
