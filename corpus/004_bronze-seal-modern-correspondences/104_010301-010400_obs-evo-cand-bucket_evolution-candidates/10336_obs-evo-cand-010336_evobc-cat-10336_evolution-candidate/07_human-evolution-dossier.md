...
- External category reference: `evobc-cat-10336`
- Source category ID: `10336`
- Source label for human review: `鬣`
...
- `obs-evo-cand-010336-route-category-staging`
...
- `obs-evo-cand-010336-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010336-route-evolution-graph`
