...
Project ID: `obs-evo-cand-009566`
...
- Project ID: `obs-evo-cand-009566`
- EVOBC category candidate ID: `evobc-evo-cat-09566`
- External category reference: `evobc-cat-09566`
- Source category ID: `09566`
- Source label for human review: `钉`
- Source codepoints: `U+9489`
...
- `obs-evo-cand-009566-route-category-staging`
...
- `obs-evo-cand-009566-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009566-route-evolution-graph`
