...
- `obs-evo-cand-011618-route-category-staging`
...
- `obs-evo-cand-011618-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011618-route-evolution-graph`
