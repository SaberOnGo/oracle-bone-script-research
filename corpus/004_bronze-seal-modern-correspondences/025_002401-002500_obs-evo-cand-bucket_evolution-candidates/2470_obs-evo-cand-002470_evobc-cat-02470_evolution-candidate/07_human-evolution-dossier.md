...
- External category reference: `evobc-cat-02470`
- Source category ID: `02470`
- Source label for human review: `尒`
- Source codepoints: `U+5C12`
...
- `obs-evo-cand-002470-route-category-staging`
...
- `obs-evo-cand-002470-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002470-route-evolution-graph`
