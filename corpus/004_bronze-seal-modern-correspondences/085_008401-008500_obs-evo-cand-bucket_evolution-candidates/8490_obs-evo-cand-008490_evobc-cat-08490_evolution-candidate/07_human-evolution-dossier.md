...
Project ID: `obs-evo-cand-008490`
...
- Project ID: `obs-evo-cand-008490`
- EVOBC category candidate ID: `evobc-evo-cat-08490`
- External category reference: `evobc-cat-08490`
- Source category ID: `08490`
- Source label for human review: `豝`
- Source codepoints: `U+8C5D`
...
- `obs-evo-cand-008490-route-category-staging`
...
- `obs-evo-cand-008490-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008490-route-evolution-graph`
