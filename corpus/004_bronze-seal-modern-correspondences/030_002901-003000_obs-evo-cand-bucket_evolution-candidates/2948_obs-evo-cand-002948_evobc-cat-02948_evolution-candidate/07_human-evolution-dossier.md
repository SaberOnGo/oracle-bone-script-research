...
- Project ID: `obs-evo-cand-002948`
- EVOBC category candidate ID: `evobc-evo-cat-02948`
- External category reference: `evobc-cat-02948`
- Source category ID: `02948`
- Source label for human review: `怨`
- Source codepoints: `U+6028`
...
- `obs-evo-cand-002948-route-category-staging`
...
- `obs-evo-cand-002948-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002948-route-evolution-graph`
