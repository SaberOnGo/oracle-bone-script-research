...
- External category reference: `evobc-cat-01898`
- Source category ID: `01898`
- Source label for human review: `堊`
- Source codepoints: `U+580A`
...
- `obs-evo-cand-001898-route-category-staging`
...
- `obs-evo-cand-001898-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001898-route-evolution-graph`
