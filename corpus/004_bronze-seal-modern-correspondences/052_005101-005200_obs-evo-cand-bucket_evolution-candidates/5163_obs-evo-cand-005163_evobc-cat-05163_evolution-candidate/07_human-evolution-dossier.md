...
Project ID: `obs-evo-cand-005163`
...
- Project ID: `obs-evo-cand-005163`
- EVOBC category candidate ID: `evobc-evo-cat-05163`
- External category reference: `evobc-cat-05163`
- Source category ID: `05163`
- Source label for human review: `爆`
- Source codepoints: `U+7206`
...
- `obs-evo-cand-005163-route-category-staging`
...
- `obs-evo-cand-005163-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005163-route-evolution-graph`
