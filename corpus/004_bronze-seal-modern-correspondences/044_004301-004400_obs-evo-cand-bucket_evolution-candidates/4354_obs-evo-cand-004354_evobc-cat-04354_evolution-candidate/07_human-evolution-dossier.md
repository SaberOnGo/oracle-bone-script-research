...
- External category reference: `evobc-cat-04354`
- Source category ID: `04354`
- Source label for human review: `欺`
- Source codepoints: `U+6B3A`
...
- `obs-evo-cand-004354-route-category-staging`
...
- `obs-evo-cand-004354-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004354-route-evolution-graph`
