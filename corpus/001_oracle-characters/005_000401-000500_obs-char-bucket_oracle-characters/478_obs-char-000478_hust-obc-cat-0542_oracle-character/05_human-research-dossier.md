# obs-char-000478 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000478`
- primary external id: `hust-obc-cat-0542`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/478_obs-char-000478_hust-obc-cat-0542_orac
  le-character/03_visual-assets/001_asset-000483_hust-obc-cat-0542_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0542/G_0542_陳132合8811賓組.png`
- asset id: `asset-000483`
...
- source category: `0542`
- validation class: `477`
- source image route: `HUST-OBC/deciphered/0542/G_0542_陳132合8811賓組.png`
- asset id: `asset-000483`
...
- English observation: `A narrow pointed outer outline surrounds a branching
  inner cluster; one long thin stroke descends separately below the left
  side of the cluster.`
...
- dataset label text: `㘔`
- dataset label codepoints: `U+3614`
...
- filename catalog route clues: `Heji-like filename clue: 合8811
  (G_0542_陳132合8811賓組.png)`
...
- Which source records identify obs-char-000478 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000478？
