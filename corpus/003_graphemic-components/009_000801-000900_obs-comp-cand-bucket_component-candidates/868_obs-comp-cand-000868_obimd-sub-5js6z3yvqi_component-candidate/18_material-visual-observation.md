# Material Visual Observation / obs-comp-cand-000868 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000868`
- External reference / 外部参照: `obimd-sub-5js6z3yvqi`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013865_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5js6z3yvqi/5js6z3yvqi/5js6z3yvqi.png`
- Checksum / 校验和:
  `daf3d3799aaa430048272641f16f3fd0004a2326ab1982090ee3707532c5b46c`
...
- Marked-pixel bounds: (63,39)–(186,212); span 124 × 174 px; the marked
...
- 痕迹范围：(63,39)–(186,212)；跨度124 × 174 px；痕迹矩形高于宽。
