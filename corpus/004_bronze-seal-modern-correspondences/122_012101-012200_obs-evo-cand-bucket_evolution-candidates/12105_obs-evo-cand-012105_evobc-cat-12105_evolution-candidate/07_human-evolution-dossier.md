...
Project ID: `obs-evo-cand-012105`
...
- Project ID: `obs-evo-cand-012105`
- EVOBC category candidate ID: `evobc-evo-cat-12105`
- External category reference: `evobc-cat-12105`
- Source category ID: `12105`
- Source label for human review: `𦳝`
- Source codepoints: `U+26CDD`
...
- `obs-evo-cand-012105-route-category-staging`
...
- `obs-evo-cand-012105-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012105-route-evolution-graph`
