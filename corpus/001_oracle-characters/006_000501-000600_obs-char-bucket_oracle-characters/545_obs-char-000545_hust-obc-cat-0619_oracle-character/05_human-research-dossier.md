# obs-char-000545 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/545_obs-char-000545_hust-obc-cat-0619_orac
  le-character/03_visual-assets/001_asset-000550_hust-obc-cat-0619_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0619/G_0619_京都2100(甲).png`
- asset id: `asset-000550`
...
- source category: `0619`
- validation class: `544`
- source image route: `HUST-OBC/deciphered/0619/G_0619_京都2100(甲).png`
- asset id: `asset-000550`
...
- English observation: `Three detached short vertical marks stand above a
  compact crossed angular cluster; a lower horizontal bar has four short
  descending strokes.`
...
- dataset label text: `㙡`
- dataset label codepoints: `U+3661`
...
- Which source records identify obs-char-000545 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000545？
