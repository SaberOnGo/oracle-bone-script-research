# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001871
...
| --- | --- | --- | --- |
| `obimd-glyph-link-028445` | 󺮹 | `U+FABB9` | `reviewed_metadata_only` |
| `obimd-glyph-link-028446` | 󺮺 | `U+FABBA` | `reviewed_metadata_only` |
