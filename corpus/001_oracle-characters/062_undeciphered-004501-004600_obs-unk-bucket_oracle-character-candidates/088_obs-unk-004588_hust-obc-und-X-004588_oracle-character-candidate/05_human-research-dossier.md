# obs-unk-004588 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004588`
- primary external id: `hust-obc-und-X-004588`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/088_obs-unk-004588_h
  ust-obc-und-X-004588_oracle-character-candidate/03_visual-assets/001_asset
  -006181_hust-obc-und-X-004588_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/144/X_？_8322_1.png`
- asset id: `asset-006181`
...
- source class: `HUST-OBC/undeciphered/X/144/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/144/X_？_8322_1.png`
- asset id: `asset-006181`
...
- English observation: `Several separated openings and thick right branch`
  `recorded.`
- 中文观察: `已记录多个分离开口和右侧粗重支痕。`
...
- Which source records identify obs-unk-004588 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004588？
