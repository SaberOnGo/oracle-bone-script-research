...
- `obs-evo-cand-010376-route-category-staging`
...
- `obs-evo-cand-010376-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010376-route-evolution-graph`
