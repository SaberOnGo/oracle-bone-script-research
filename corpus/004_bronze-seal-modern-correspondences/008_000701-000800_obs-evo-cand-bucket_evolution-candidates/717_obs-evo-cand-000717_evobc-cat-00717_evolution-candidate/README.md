# obs-evo-cand-000717 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-00717`
- Source label: `亻`
- Source codepoints: `U+4EBB`
- Image reference count: `399`
- Era token counts: `BI:34;SS:1;WSC:364`
- Source token counts: `Web:399`

## Observed Code Rows / 观察到的代码行

- era 1 / BI: 34 image references
- era 2 / SS: 1 image references
- era 4 / WSC: 364 image references
- source 1 / Web:105952;說文Web:58: 399 image references
