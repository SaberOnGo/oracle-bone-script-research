# obs-char-001107 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1107_obs-char-001107_hust-obc-cat-1237_ora
  cle-character/03_visual-assets/001_asset-001112_hust-obc-cat-1237_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1237/L_1237_11064.jpg`
- asset id: `asset-001112`
...
- source category: `1237`
- validation class: `1106`
- source image route: `HUST-OBC/deciphered/1237/L_1237_11064.jpg`
- asset id: `asset-001112`
...
- English observation: `A small faint gray cluster has a short upper
  cross-stroke, several vertical lines, and a compact lower enclosure;
...
- dataset label text: `㣋`
- dataset label codepoints: `U+38CB`
...
- Which source records identify obs-char-001107 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001107？
