# obs-char-000236 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/236_obs-char-000236_hust-obc-cat-0263_orac
  le-character/03_visual-assets/001_asset-000241_hust-obc-cat-0263_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0263/H_0263_60CA2_0.png`
- asset id: `asset-000241`
...
- source category: `0263`
- validation class: `235`
- source image route: `HUST-OBC/deciphered/0263/H_0263_60CA2_0.png`
- asset id: `asset-000241`
...
- English observation: `The large image has a thick bent outer frame, a
  smaller inner enclosure, and several branching strokes inside the
  enclosure.`
...
- dataset label text: `㓽`
- dataset label codepoints: `U+34FD`
...
- filename catalog route clues: `catalog-like filename clue: H_0263
  (H_0263_60CA2_0.png)`
...
- Which source records identify obs-char-000236 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000236？
