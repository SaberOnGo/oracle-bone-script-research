# obs-char-000780 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000780`
- primary external id: `hust-obc-cat-0884`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/780_obs-char-000780_hust-obc-cat-0884_orac
  le-character/03_visual-assets/001_asset-000785_hust-obc-cat-0884_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0884/G_0884_甲骨文0.png`
- asset id: `asset-000785`
...
- source category: `0884`
- validation class: `779`
- source image route: `HUST-OBC/deciphered/0884/G_0884_甲骨文0.png`
- asset id: `asset-000785`
...
- English observation: `A compact curved upper-left cluster joins a tall
  central stem with one right upper branch; several diagonals cross the stem
  and spread into a forked lower end.`
- 中文观察: `紧凑弯曲左上笔群连接带一条右上枝的高长中央干；数条斜笔穿过竖干并向下分叉展开。`
...
- dataset label text: `㝪`
- dataset label codepoints: `U+376A`
...
- OBIMD candidate ids / OBIMD 候选 ID: `obimd-main-cand-003071`
- OBIMD external refs / OBIMD 外部引用: `obimd-main-x9f7dp1d6n`
- OBIMD transcription field / OBIMD 转写字段: `㝪`
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00074`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00074`
- EvoBC image reference count / EvoBC 图像引用数: `31`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00074`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/074_obs-evo-can
  d-000074_evobc-cat-00074_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/074_obs-evo-cand-000074_evobc-cat-00074_evolu
...
- matched OBIMD main UIDs: `x9f7dp1d6n`
...
- Which source records identify obs-char-000780 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000780？
