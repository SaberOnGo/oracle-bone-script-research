# obs-evo-cand-003816 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-003816`
- EVOBC category candidate ID: `evobc-evo-cat-03816`
- External category ref: `evobc-cat-03816`
- Source label: `書`
- Source codepoints: `U+66F8`
- Image reference count: `74`
- Era token counts: `BI:38;CS:2;OBC:1;SAC:2;SS:1;WSC:30`
- Source token counts: `Book:37;Web:37`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 1 image references
