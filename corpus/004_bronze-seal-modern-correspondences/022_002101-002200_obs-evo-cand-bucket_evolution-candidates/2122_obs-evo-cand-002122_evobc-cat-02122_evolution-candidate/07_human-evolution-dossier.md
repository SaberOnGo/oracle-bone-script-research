...
- External category reference: `evobc-cat-02122`
- Source category ID: `02122`
- Source label for human review: `姓`
- Source codepoints: `U+59D3`
- Image reference count in source metadata: `57`
...
- `obs-evo-cand-002122-route-category-staging`
...
- `obs-evo-cand-002122-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002122-route-evolution-graph`
