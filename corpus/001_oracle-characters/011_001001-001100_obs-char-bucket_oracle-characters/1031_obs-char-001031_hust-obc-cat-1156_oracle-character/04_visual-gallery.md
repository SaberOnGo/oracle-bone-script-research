# obs-char-001031 Visual Gallery / obs-char-001031 图像资料页
...
- Project ID / 项目 ID: `obs-char-001031`
- Primary external reference / 首选外部参考: `hust-obc-cat-1156`
...
## obs-char-001031-visual-source-001 / 图像条目

![obs-char-001031 glyph candidate](03_visual-assets/001_asset-001036_hust-obc-cat-1156_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-001036_hust-obc-cat-1156_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-001036_hust-obc-cat-1156_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/1156/G_1156_乙1290(甲).png`
