...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1252`
...
- Source image / 来源图: `G_1252_乙6672合11498賓組.png`
- Image / 图像: `001_asset-001126_hust-obc-cat-1252_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合11498
...
- target node: `evobc-evo-cat-00108`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/108_obs-evo-cand-000108_evobc-cat-00108_evoluti
...
- Source label text / 来源标签文字: `㣚`
- Source label codepoint / 来源标签 codepoint: `U+38DA`
