# Material Visual Observation / obs-comp-cand-001686 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001686`
- External reference / 外部参照: `obimd-sub-pzuji4u0at`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017602_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/pzuji4u0at/pzuji4u0at/pzuji4u0at.png`
- Checksum / 校验和:
  `df238b2bce6c0e7ed0abc9a9f054b4d17e8f1f83db068fc2543befd181324e12`
...
- Marked-pixel bounds: (78,21)–(179,223); span 102 × 203 px; the marked
...
- 痕迹范围：(78,21)–(179,223)；跨度102 × 203 px；痕迹矩形高于宽。
