# obs-char-000515 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000515`
- primary external id: `hust-obc-cat-0586`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/515_obs-char-000515_hust-obc-cat-0586_orac
  le-character/03_visual-assets/001_asset-000520_hust-obc-cat-0586_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0586/G_0586_乙4293合136賓組.png`
- asset id: `asset-000520`
...
- source category: `0586`
- validation class: `514`
- source image route: `HUST-OBC/deciphered/0586/G_0586_乙4293合136賓組.png`
- asset id: `asset-000520`
...
- English observation: `The very faint image shows a thin central stem
  dividing into two long lower branches with several finer side offshoots;
  the upper tip is slightly curved.`
- 中文观察: `极淡图像显示纤细中央干分成两条长下枝，并带数条更细侧枝，上端略弯。`
...
- dataset label text: `㙀`
- dataset label codepoints: `U+3640`
...
- filename catalog route clues: `Heji-like filename clue: 合136
  (G_0586_乙4293合136賓組.png)`
...
- Which source records identify obs-char-000515 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000515？
