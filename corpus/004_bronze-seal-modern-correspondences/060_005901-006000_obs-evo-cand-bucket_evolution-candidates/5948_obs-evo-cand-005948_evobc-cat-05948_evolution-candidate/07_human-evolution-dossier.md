...
- External category reference: `evobc-cat-05948`
- Source category ID: `05948`
- Source label for human review: `磺`
...
- `obs-evo-cand-005948-route-category-staging`
...
- `obs-evo-cand-005948-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005948-route-evolution-graph`
