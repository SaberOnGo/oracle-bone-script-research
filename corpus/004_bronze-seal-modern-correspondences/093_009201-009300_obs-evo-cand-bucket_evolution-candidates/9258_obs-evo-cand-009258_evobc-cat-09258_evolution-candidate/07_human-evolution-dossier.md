...
- Project ID: `obs-evo-cand-009258`
- EVOBC category candidate ID: `evobc-evo-cat-09258`
- External category reference: `evobc-cat-09258`
- Source category ID: `09258`
- Source label for human review: `酷`
- Source codepoints: `U+9177`
...
- `obs-evo-cand-009258-route-category-staging`
...
- `obs-evo-cand-009258-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009258-route-evolution-graph`
