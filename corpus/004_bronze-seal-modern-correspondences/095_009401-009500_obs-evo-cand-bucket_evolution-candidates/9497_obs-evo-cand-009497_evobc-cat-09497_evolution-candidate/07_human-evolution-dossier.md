...
- Project ID: `obs-evo-cand-009497`
- EVOBC category candidate ID: `evobc-evo-cat-09497`
- External category reference: `evobc-cat-09497`
- Source category ID: `09497`
- Source label for human review: `鏏`
- Source codepoints: `U+93CF`
...
- `obs-evo-cand-009497-route-category-staging`
...
- `obs-evo-cand-009497-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009497-route-evolution-graph`
