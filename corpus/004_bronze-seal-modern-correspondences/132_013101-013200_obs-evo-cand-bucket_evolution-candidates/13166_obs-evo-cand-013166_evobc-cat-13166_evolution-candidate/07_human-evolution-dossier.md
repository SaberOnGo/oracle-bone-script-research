...
- Project ID: `obs-evo-cand-013166`
- EVOBC category candidate ID: `evobc-evo-cat-13166`
- External category reference: `evobc-cat-13166`
- Source category ID: `13166`
- Source label for human review: `𫽷`
- Source codepoints: `U+2BF77`
...
- `obs-evo-cand-013166-route-category-staging`
...
- `obs-evo-cand-013166-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013166-route-evolution-graph`
