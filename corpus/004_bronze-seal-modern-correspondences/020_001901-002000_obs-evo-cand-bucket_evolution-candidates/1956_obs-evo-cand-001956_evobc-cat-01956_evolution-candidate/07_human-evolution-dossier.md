...
- External category reference: `evobc-cat-01956`
- Source category ID: `01956`
- Source label for human review: `壐`
...
- `obs-evo-cand-001956-route-category-staging`
...
- `obs-evo-cand-001956-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001956-route-evolution-graph`
