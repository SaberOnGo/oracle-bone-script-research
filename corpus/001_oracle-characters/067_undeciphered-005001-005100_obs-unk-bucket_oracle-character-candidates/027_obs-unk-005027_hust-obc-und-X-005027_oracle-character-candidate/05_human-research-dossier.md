# obs-unk-005027 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/067_undeciphered-005
  001-005100_obs-unk-bucket_oracle-character-candidates/027_obs-unk-005027_h
  ust-obc-und-X-005027_oracle-character-candidate/03_visual-assets/001_asset
  -006620_hust-obc-und-X-005027_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/583/X_？_7558_1.png`
- asset id: `asset-006620`
...
- source class: `HUST-OBC/undeciphered/X/583/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/583/X_？_7558_1.png`
- asset id: `asset-006620`
...
- Which source records identify obs-unk-005027 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005027？
