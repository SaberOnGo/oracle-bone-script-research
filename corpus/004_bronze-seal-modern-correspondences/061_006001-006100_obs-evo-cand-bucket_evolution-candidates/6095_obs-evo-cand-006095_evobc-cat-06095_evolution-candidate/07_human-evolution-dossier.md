...
Project ID: `obs-evo-cand-006095`
...
- Project ID: `obs-evo-cand-006095`
- EVOBC category candidate ID: `evobc-evo-cat-06095`
- External category reference: `evobc-cat-06095`
- Source category ID: `06095`
- Source label for human review: `税`
- Source codepoints: `U+7A0E`
...
- `obs-evo-cand-006095-route-category-staging`
...
- `obs-evo-cand-006095-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006095-route-evolution-graph`
