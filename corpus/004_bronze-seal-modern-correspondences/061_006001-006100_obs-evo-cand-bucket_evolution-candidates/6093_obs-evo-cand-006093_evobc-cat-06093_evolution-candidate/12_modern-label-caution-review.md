# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006093
...
- EVOBC candidate category: `evobc-evo-cat-06093`.
- Source label for search only: `稌`.
- Source codepoints for search only: `U+7A0C`.
