# obs-char-001467 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001467`
- primary external id: `hust-obc-cat-1647`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1467_obs-char-001467_hust-obc-cat-1647_ora
  cle-character/03_visual-assets/001_asset-001472_hust-obc-cat-1647_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1647/G_1647_後1.23.1(甲).png`
- asset id: `asset-001472`
...
- source category: `1647`
- validation class: `1466`
- source image route: `HUST-OBC/deciphered/1647/G_1647_後1.23.1(甲).png`
- asset id: `asset-001472`
...
- English observation: `A closed oval enclosure contains several internal
  crossing divisions.`
- 中文观察: `封闭椭圆框形内部有数条交叉隔分笔画。`
...
- dataset label text: `㩥`
- dataset label codepoints: `U+3A65`
...
- Which source records identify obs-char-001467 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001467？
