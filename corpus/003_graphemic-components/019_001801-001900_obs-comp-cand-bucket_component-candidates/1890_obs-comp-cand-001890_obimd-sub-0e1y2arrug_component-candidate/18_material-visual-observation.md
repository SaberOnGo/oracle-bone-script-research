# Material Visual Observation / obs-comp-cand-001890 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001890`
- External reference / 外部参照: `obimd-sub-0e1y2arrug`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018269_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xclyxu4uku/0e1y2arrug/0e1y2arrug.png`
- Checksum / 校验和:
  `b30cea9724bc84af8346eb78e210cc0672347dda7bb80602562096cd226a32fa`
...
- Marked-pixel bounds: (75,17)–(178,235); span 104 × 219 px; the marked
...
- 痕迹范围：(75,17)–(178,235)；跨度104 × 219 px；痕迹矩形高于宽。
