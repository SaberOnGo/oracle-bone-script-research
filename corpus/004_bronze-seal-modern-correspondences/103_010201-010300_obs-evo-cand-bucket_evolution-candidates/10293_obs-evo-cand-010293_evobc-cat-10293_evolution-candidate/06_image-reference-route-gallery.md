...
- `obs-evo-cand-010293-route-category-staging`
...
- `obs-evo-cand-010293-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010293-route-evolution-graph`
