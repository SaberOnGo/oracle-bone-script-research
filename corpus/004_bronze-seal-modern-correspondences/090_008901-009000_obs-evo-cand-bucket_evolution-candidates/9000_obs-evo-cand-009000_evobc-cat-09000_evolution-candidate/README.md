# obs-evo-cand-009000 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-009000`
- EVOBC category candidate ID: `evobc-evo-cat-09000`
- External category ref: `evobc-cat-09000`
- Source label: `造`
- Source codepoints: `U+9020`
- Image reference count: `155`
- Era token counts: `BI:71;CS:1;SAC:29;SS:3;WSC:51`
- Source token counts: `Book:83;Web:72`

## Observed Code Rows / 观察到的代码行

- era 1 / BI: 71 image references
- era 2 / SS: 3 image references
- era 3 / SAC: 29 image references
- era 4 / WSC: 51 image references
- era 5 / CS: 1 image references
- source 1 / Web:105952;說文Web:58: 72 image references
- source 3 / Book:21681: 11 image references
- source 4 / Book:9131: 29 image references
- source 5 / Book:32794: 43 image references
