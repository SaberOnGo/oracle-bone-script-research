...
Project ID: `obs-evo-cand-007587`
...
- Project ID: `obs-evo-cand-007587`
- EVOBC category candidate ID: `evobc-evo-cat-07587`
- External category reference: `evobc-cat-07587`
- Source category ID: `07587`
- Source label for human review: `蕢`
- Source codepoints: `U+8562`
...
- `obs-evo-cand-007587-route-category-staging`
...
- `obs-evo-cand-007587-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007587-route-evolution-graph`
