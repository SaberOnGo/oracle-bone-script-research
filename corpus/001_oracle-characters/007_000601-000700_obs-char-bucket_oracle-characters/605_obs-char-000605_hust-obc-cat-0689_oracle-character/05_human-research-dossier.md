# obs-char-000605 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/605_obs-char-000605_hust-obc-cat-0689_orac
  le-character/03_visual-assets/001_asset-000610_hust-obc-cat-0689_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0689/L_0689_7973.jpg`
- asset id: `asset-000610`
...
- source category: `0689`
- validation class: `604`
- source image route: `HUST-OBC/deciphered/0689/L_0689_7973.jpg`
- asset id: `asset-000610`
...
- English observation: `The tiny faint image shows a compact zigzag cluster
  at left and several thin crossing or forked strokes at right; exact joins
  are difficult to resolve.`
- 中文观察: `微小淡弱图像显示左侧紧凑锯折笔群和右侧数条纤细交叉或叉状笔，具体接点难辨。`
...
- dataset label text: `㚧`
- dataset label codepoints: `U+36A7`
...
- Which source records identify obs-char-000605 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000605？
