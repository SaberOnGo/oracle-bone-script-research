...
- External category reference: `evobc-cat-13034`
- Source category ID: `13034`
- Source label for human review: `𫧩`
- Source codepoints: `U+2B9E9`
...
- `obs-evo-cand-013034-route-category-staging`
...
- `obs-evo-cand-013034-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013034-route-evolution-graph`
