...
- External category reference: `evobc-cat-05031`
- Source category ID: `05031`
- Source label for human review: `灺`
...
- `obs-evo-cand-005031-route-category-staging`
...
- `obs-evo-cand-005031-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005031-route-evolution-graph`
