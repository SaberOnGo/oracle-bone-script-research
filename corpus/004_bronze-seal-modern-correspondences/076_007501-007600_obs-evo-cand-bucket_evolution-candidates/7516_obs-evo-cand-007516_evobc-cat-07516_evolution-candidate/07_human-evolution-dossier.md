...
- External category reference: `evobc-cat-07516`
- Source category ID: `07516`
- Source label for human review: `蓀`
...
- `obs-evo-cand-007516-route-category-staging`
...
- `obs-evo-cand-007516-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007516-route-evolution-graph`
