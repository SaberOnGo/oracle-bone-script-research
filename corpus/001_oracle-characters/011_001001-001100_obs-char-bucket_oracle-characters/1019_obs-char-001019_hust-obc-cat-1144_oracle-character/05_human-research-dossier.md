# obs-char-001019 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1019_obs-char-001019_hust-obc-cat-1144_ora
  cle-character/03_visual-assets/001_asset-001024_hust-obc-cat-1144_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1144/G_1144_乙4057(甲).png`
- asset id: `asset-001024`
...
- source category: `1144`
- validation class: `1018`
- source image route: `HUST-OBC/deciphered/1144/G_1144_乙4057(甲).png`
- asset id: `asset-001024`
...
- English observation: `A low elongated enclosure has a pointed right
  extension, a thick left base, and a short branching stroke above.`
...
- dataset label text: `㡮`
- dataset label codepoints: `U+386E`
...
- Which source records identify obs-char-001019 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001019？
