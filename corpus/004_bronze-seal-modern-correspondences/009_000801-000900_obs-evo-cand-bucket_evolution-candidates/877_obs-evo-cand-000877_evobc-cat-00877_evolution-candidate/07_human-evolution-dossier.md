...
- External category reference: `evobc-cat-00877`
- Source category ID: `00877`
- Source label: `俇`
...
- `obs-evo-cand-000877-route-category-staging`
...
- `obs-evo-cand-000877-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000877-route-evolution-graph`
