# Material Visual Observation / obs-comp-cand-001060 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001060`
- External reference / 外部参照: `obimd-sub-m4ruun8m3a`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014610_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/m4ruun8m3a/m4ruun8m3a/m4ruun8m3a.png`
- Checksum / 校验和:
  `908a399998203373a159ed2cc591e379767467693a5e532ed48bbd06a14ec031`
...
- Marked-pixel bounds: (79,35)–(186,218); span 108 × 184 px; the marked
...
- 痕迹范围：(79,35)–(186,218)；跨度108 × 184 px；痕迹矩形高于宽。
