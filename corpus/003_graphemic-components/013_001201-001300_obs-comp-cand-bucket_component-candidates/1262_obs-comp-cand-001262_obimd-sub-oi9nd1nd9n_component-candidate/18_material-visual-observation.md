# Material Visual Observation / obs-comp-cand-001262 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001262`
- External reference / 外部参照: `obimd-sub-oi9nd1nd9n`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015500_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/oi9nd1nd9n/oi9nd1nd9n/oi9nd1nd9n.png`
- Checksum / 校验和:
  `400a3dccefafd0ab627ade3648c9ddabc64319b3fa29dc4dd31fbcbe25aef9f7`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.64%.
- Marked-pixel bounds: (53,50)–(199,206); span 147 × 157 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.64%。
- 痕迹范围：(53,50)–(199,206)；跨度147 × 157 px；痕迹矩形近方形。
