# Material Visual Observation / obs-comp-cand-001001 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001001`
- External reference / 外部参照: `obimd-sub-tn09sqkpui`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014439_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zsc0qawq79/tn09sqkpui/0uw21nd3cz.png`
- Checksum / 校验和:
  `562954008c77ceaf8e5f7fa8e1a41efddb3c95ea31b4f1997575b320caa687c3`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.77%.
- Marked-pixel bounds: (84,46)–(165,203); span 82 × 158 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.77%。
- 痕迹范围：(84,46)–(165,203)；跨度82 × 158 px；痕迹矩形高于宽。
