# obs-char-001497 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1497_obs-char-001497_hust-obc-cat-1679_ora
  cle-character/03_visual-assets/001_asset-001502_hust-obc-cat-1679_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1679/H_1679_609E6_0.png`
- asset id: `asset-001502`
...
- source category: `1679`
- validation class: `1496`
- source image route: `HUST-OBC/deciphered/1679/H_1679_609E6_0.png`
- asset id: `asset-001502`
...
- English observation: `A large composite has a broad upper bar, a long
  stem, and lower curves.`
...
- dataset label text: `㪅`
- dataset label codepoints: `U+3A85`
...
- filename catalog route clues: `catalog-like filename clue: H_1679
  (H_1679_609E6_0.png)`
...
- Which source records identify obs-char-001497 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001497？
