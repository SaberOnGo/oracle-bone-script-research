# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-011123
...
- EVOBC candidate category: `evobc-evo-cat-11123`.
- Source label for search only: `𡼝`.
- Source codepoints for search only: `U+21F1D`.
