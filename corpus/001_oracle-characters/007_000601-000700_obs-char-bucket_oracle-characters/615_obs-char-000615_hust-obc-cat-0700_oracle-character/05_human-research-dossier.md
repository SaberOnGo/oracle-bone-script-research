# obs-char-000615 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000615`
- primary external id: `hust-obc-cat-0700`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/615_obs-char-000615_hust-obc-cat-0700_orac
  le-character/03_visual-assets/001_asset-000620_hust-obc-cat-0700_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0700/G_0700_乙6690合22094午組.png`
- asset id: `asset-000620`
...
- source category: `0700`
- validation class: `614`
- source image route: `HUST-OBC/deciphered/0700/G_0700_乙6690合22094午組.png`
- asset id: `asset-000620`
...
- English observation: `A single thin vertical stem carries three short
  horizontal or diagonal cross-strokes at different heights and ends in a
  slight lower hook.`
- 中文观察: `单条纤细竖干在不同高度带三条短横笔或斜交笔，末端有轻微下钩。`
...
- dataset label text: `㚲`
- dataset label codepoints: `U+36B2`
...
- filename catalog route clues: `Heji-like filename clue: 合22094
  (G_0700_乙6690合22094午組.png)`
...
- Which source records identify obs-char-000615 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000615？
