# obs-char-001229 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1229_obs-char-001229_hust-obc-cat-1374_137
  5_oracle-character/03_visual-assets/001_asset-001234_hust-obc-cat-1374_137
  5_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1374_1375/1374/H_1374_60A0C_0.p
  ng`
- asset id: `asset-001234`
...
- source category: `1374_1375`
- validation class: `1228`
- source image route: `HUST-OBC/deciphered/1374_1375/1374/H_1374_60A0C_0.png`
- asset id: `asset-001234`
...
- English observation: `Two separated dark branching forms each have a
  central upright and short side projections.`
- 中文观察: `两个分离的深色分枝形体各自有中央直立笔和短侧部外伸笔。`
...
- dataset label text: `㥔㥕`
- dataset label codepoints: `U+3954;U+3955`
...
- filename catalog route clues: `catalog-like filename clue: H_1374
  (H_1374_60A0C_0.png)`
...
- Which source records identify obs-char-001229 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001229？
