# Evolution Review Fact Matrix / 字形演化复核事实矩阵: obs-evo-cand-005597
...
| Era and source-code route | 8 era/source rows; dataset labels are search aids only. | `03_era-source-code-index.csv` |
