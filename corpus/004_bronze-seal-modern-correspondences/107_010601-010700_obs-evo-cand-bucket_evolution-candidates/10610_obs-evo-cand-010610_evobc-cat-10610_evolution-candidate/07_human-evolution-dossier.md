...
- External category reference: `evobc-cat-10610`
- Source category ID: `10610`
- Source label for human review: `麔`
...
- `obs-evo-cand-010610-route-category-staging`
...
- `obs-evo-cand-010610-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010610-route-evolution-graph`
