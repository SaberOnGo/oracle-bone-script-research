# Material Visual Observation / obs-comp-cand-002705 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002705`
- External reference / 外部参照: `obimd-sub-txwb6uz3dl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021281_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/txwb6uz3dl/txwb6uz3dl/txwb6uz3dl.png`
- Checksum / 校验和:
  `73811870f6264ed62797156902ae511b5605aac6c7ad0e9f83119c1383aaa4cf`
...
- Marked-pixel bounds: (94,23)–(161,227); span 68 × 205 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.38%。
- 痕迹范围：(94,23)–(161,227)；跨度68 × 205 px；痕迹矩形高于宽。
