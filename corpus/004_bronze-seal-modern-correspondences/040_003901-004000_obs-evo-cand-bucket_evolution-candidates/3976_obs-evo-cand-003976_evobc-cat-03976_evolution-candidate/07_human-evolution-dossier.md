...
- External category reference: `evobc-cat-03976`
- Source category ID: `03976`
- Source label for human review: `柱`
- Source codepoints: `U+67F1`
...
- `obs-evo-cand-003976-route-category-staging`
...
- `obs-evo-cand-003976-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003976-route-evolution-graph`
