...
- `obs-evo-cand-012923-route-category-staging`
...
- `obs-evo-cand-012923-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012923-route-evolution-graph`
