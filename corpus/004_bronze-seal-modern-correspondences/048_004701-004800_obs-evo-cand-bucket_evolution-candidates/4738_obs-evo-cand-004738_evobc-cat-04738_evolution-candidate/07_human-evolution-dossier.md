...
- External category reference: `evobc-cat-04738`
- Source category ID: `04738`
- Source label for human review: `淲`
...
- `obs-evo-cand-004738-route-category-staging`
...
- `obs-evo-cand-004738-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004738-route-evolution-graph`
