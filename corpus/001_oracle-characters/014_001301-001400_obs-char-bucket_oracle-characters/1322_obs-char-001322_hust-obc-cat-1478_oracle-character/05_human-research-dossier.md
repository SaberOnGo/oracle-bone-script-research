# obs-char-001322 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001322`
- primary external id: `hust-obc-cat-1478`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1322_obs-char-001322_hust-obc-cat-1478_ora
  cle-character/03_visual-assets/001_asset-001327_hust-obc-cat-1478_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1478/G_1478_京津3135(甲).png`
- asset id: `asset-001327`
...
- source category: `1478`
- validation class: `1321`
- source image route: `HUST-OBC/deciphered/1478/G_1478_京津3135(甲).png`
- asset id: `asset-001327`
...
- English observation: `A composite form has tall left strokes and a right
  lower rectangular enclosure with upright divisions.`
- 中文观察: `组合形体有左侧高直笔画，右侧下部为带直立分隔的矩形框形。`
...
- dataset label text: `㦼`
- dataset label codepoints: `U+39BC`
...
- Which source records identify obs-char-001322 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001322？
