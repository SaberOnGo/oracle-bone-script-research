# src-metmuseum-oracle-bone Source Object / src-metmuseum-oracle-bone 来源对象
...
- Metadata profile route count / metadata profile 路线数: `6`

## Risk And Boundary / 风险与边界

English:
The Met API marks selected objects as public domain, but object metadata and image URLs can be revised and should retain object-level timestamps and source URLs.
