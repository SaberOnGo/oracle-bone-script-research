# Material Visual Observation / obs-comp-cand-001553 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001553`
- External reference / 外部参照: `obimd-sub-bu3h266vxh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016967_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bu3h266vxh/bu3h266vxh/bu3h266vxh.png`
- Checksum / 校验和:
  `f8198d2d143ccce68e68ad6ab239b60a630fa8bc500d7b35d6ae5a5bfe937402`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.42%.
- Marked-pixel bounds: (88,28)–(161,207); span 74 × 180 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.42%。
- 痕迹范围：(88,28)–(161,207)；跨度74 × 180 px；痕迹矩形高于宽。
