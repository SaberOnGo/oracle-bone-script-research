# obs-unk-003953 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003953`
- primary external id: `hust-obc-und-L-003953`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/053_obs-unk-003953_h
  ust-obc-und-L-003953_oracle-character-candidate/03_visual-assets/001_asset
  -005546_hust-obc-und-L-003953_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3953/L_？_8339.jpg`
- asset id: `asset-005546`
...
- source class: `HUST-OBC/undeciphered/L/3953/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3953/L_？_8339.jpg`
- asset id: `asset-005546`
...
- English observation: A narrow upright form has a short upper bar crossing a
  central trace, with short angular traces diverging below.
- 中文观察：较窄直立形体的上部有短横痕交叉中央痕迹，下部有短折线向两侧
  分开。
...
- Which source records identify obs-unk-003953 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003953？
