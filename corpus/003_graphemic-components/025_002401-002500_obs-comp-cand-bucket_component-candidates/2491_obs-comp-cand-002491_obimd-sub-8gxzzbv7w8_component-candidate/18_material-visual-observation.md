# Material Visual Observation / obs-comp-cand-002491 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002491`
- External reference / 外部参照: `obimd-sub-8gxzzbv7w8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020713_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8gxzzbv7w8/8gxzzbv7w8/8gxzzbv7w8.png`
- Checksum / 校验和:
  `9a230c01d3db5bd6bc2e5f84989b90b7aa965c6dd81175a9a044aa662a99b18a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.22%.
- Marked-pixel bounds: (48,75)–(204,163); span 157 × 89 px; the marked rectangle
  is wider than tall.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.22%。
- 痕迹范围：(48,75)–(204,163)；跨度157 × 89 px；痕迹矩形宽于高。
