# obs-unk-004712 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004712`
- primary external id: `hust-obc-und-X-004712`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/012_obs-unk-004712_h
  ust-obc-und-X-004712_oracle-character-candidate/03_visual-assets/001_asset
  -006305_hust-obc-und-X-004712_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/268/X_？_7242_1.png`
- asset id: `asset-006305`
...
- source class: `HUST-OBC/undeciphered/X/268/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/268/X_？_7242_1.png`
- asset id: `asset-006305`
...
- English observation: `branching junction with lower diagonal stroke`
- 中文观察: `带下部斜向笔画的分支连接处`
...
- Which source records identify obs-unk-004712 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004712？
