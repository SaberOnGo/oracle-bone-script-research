...
- External category reference: `evobc-cat-05567`
- Source category ID: `05567`
- Source label for human review: `畗`
- Source codepoints: `U+7557`
...
- `obs-evo-cand-005567-route-category-staging`
...
- `obs-evo-cand-005567-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005567-route-evolution-graph`
