# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002574
...
- EVOBC candidate category: `evobc-evo-cat-02574`.
- Source label for search only: `崵`.
- Source codepoints for search only: `U+5D35`.
