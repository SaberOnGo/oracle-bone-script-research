...
- External category reference: `evobc-cat-06819`
- Source category ID: `06819`
- Source label for human review: `罯`
- Source codepoints: `U+7F6F`
...
- `obs-evo-cand-006819-route-category-staging`
...
- `obs-evo-cand-006819-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006819-route-evolution-graph`
