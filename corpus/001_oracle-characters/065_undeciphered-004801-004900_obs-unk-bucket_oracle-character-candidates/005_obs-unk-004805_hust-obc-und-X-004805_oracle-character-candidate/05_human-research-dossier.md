# obs-unk-004805 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004805`
- primary external id: `hust-obc-und-X-004805`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/005_obs-unk-004805_h
  ust-obc-und-X-004805_oracle-character-candidate/03_visual-assets/001_asset
  -006398_hust-obc-und-X-004805_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/361/X_？_7344_1.png`
- asset id: `asset-006398`
...
- source class: `HUST-OBC/undeciphered/X/361/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/361/X_？_7344_1.png`
- asset id: `asset-006398`
...
- English observation: `separate left enclosure and right openings`
- 中文观察: `分离的左侧围合和右侧开口`
...
- Which source records identify obs-unk-004805 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004805？
