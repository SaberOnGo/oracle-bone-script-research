...
- `obs-evo-cand-005787-route-category-staging`
...
- `obs-evo-cand-005787-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005787-route-evolution-graph`
