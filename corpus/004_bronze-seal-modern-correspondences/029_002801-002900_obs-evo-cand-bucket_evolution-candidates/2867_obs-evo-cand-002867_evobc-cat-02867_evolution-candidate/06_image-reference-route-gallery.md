...
- `obs-evo-cand-002867-route-category-staging`
...
- `obs-evo-cand-002867-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002867-route-evolution-graph`
