# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006095
...
- EVOBC candidate category: `evobc-evo-cat-06095`.
- Source label for search only: `税`.
- Source codepoints for search only: `U+7A0E`.
