...
- Source page section: `Tzu tsu` /
  `子祖（原页标签）`
- Source section key: `period-I-tzu-tsu`
...
- Yingguo / 英国所藏: `y1915` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `545` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `556` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000289`
