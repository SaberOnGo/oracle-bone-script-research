# obs-char-001407 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001407`
- primary external id: `hust-obc-cat-1576`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1407_obs-char-001407_hust-obc-cat-1576_ora
  cle-character/03_visual-assets/001_asset-001412_hust-obc-cat-1576_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1576/G_1576_屯0873.png`
- asset id: `asset-001412`
...
- source category: `1576`
- validation class: `1406`
- source image route: `HUST-OBC/deciphered/1576/G_1576_屯0873.png`
- asset id: `asset-001412`
...
- English observation: `A chain of rounded left loops is paired with a
  pointed right enclosure.`
- 中文观察: `一串圆拱左侧环形与尖状右侧框形相邻。`
...
- dataset label text: `㨞`
- dataset label codepoints: `U+3A1E`
...
- Which source records identify obs-char-001407 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001407？
