# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008713
...
- EVOBC candidate category: `evobc-evo-cat-08713`.
- Source label for search only: `跚`.
- Source codepoints for search only: `U+8DDA`.
