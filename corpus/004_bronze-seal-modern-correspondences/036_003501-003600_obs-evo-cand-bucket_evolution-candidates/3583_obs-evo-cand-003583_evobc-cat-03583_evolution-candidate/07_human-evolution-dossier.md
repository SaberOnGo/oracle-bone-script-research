...
Project ID: `obs-evo-cand-003583`
...
- Project ID: `obs-evo-cand-003583`
- EVOBC category candidate ID: `evobc-evo-cat-03583`
- External category reference: `evobc-cat-03583`
- Source category ID: `03583`
- Source label for human review: `敓`
- Source codepoints: `U+6553`
- Image reference count in source metadata: `116`
...
- `obs-evo-cand-003583-route-category-staging`
...
- `obs-evo-cand-003583-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003583-route-evolution-graph`
