# obs-unk-004961 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004961`
- primary external id: `hust-obc-und-X-004961`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/061_obs-unk-004961_h
  ust-obc-und-X-004961_oracle-character-candidate/03_visual-assets/001_asset
  -006554_hust-obc-und-X-004961_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/517/X_？_7498_1.png`
- asset id: `asset-006554`
...
- A tall central form, upper fork, and lower branches are visible.
...
- source class: `HUST-OBC/undeciphered/X/517/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/517/X_？_7498_1.png`
- asset id: `asset-006554`
...
- Which source records identify obs-unk-004961 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004961？
