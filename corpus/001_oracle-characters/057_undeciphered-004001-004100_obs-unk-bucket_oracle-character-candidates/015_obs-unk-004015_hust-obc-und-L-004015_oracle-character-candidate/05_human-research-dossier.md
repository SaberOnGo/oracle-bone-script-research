# obs-unk-004015 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004015`
- primary external id: `hust-obc-und-L-004015`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/015_obs-unk-004015_h
  ust-obc-und-L-004015_oracle-character-candidate/03_visual-assets/001_asset
  -005608_hust-obc-und-L-004015_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4015/L_？_8541.jpg`
- asset id: `asset-005608`
...
- source class: `HUST-OBC/undeciphered/L/4015/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4015/L_？_8541.jpg`
- asset id: `asset-005608`
...
- English observation: Two tall roughly parallel traces descend through the
  image. A compact dark angular cluster sits near the upper left, with a small
  light opening; a separate upright contour is visible on the right.
- 中文观察：图中有两条大致平行的高向痕迹向下延伸；左上方有紧凑的深色折角状痕迹，其中可见小型留白；右侧
  另有独立的直立轮廓。
...
- Which source records identify obs-unk-004015 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004015？
