# obs-char-000215 Visual Gallery / obs-char-000215 图像资料页
...
- Project ID / 项目 ID: `obs-char-000215`
- Primary external reference / 首选外部参考: `hust-obc-cat-0239`
...
## obs-char-000215-visual-source-001 / 图像条目

![obs-char-000215 glyph candidate](03_visual-assets/001_asset-000220_hust-obc-cat-0239_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000220_hust-obc-cat-0239_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000220_hust-obc-cat-0239_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/0239/X_0239_2181_1.png`
