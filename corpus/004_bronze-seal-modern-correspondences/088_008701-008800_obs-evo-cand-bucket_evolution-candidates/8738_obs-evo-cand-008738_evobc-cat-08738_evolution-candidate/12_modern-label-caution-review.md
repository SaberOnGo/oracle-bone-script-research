# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008738
...
- EVOBC candidate category: `evobc-evo-cat-08738`.
- Source label for search only: `踪`.
- Source codepoints for search only: `U+8E2A`.
