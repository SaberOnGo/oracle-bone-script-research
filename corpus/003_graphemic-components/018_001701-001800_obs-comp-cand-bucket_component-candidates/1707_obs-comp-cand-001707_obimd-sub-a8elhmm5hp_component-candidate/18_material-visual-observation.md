# Material Visual Observation / obs-comp-cand-001707 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001707`
- External reference / 外部参照: `obimd-sub-a8elhmm5hp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017845_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/w4mg32kjp4/a8elhmm5hp/a8elhmm5hp.png`
- Checksum / 校验和:
  `9aafb84826d3b7867468ed8dac78a6ccea87ca9dac567aca236938a14e404f60`
...
- Marked-pixel bounds: (78,51)–(171,197); span 94 × 147 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.02%。
- 痕迹范围：(78,51)–(171,197)；跨度94 × 147 px；痕迹矩形高于宽。
