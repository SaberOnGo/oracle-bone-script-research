# Material Visual Observation / obs-comp-cand-000188 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000188`
- External reference / 外部参照: `obimd-sub-i62qjghqfq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011681_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h2mhpxskhk/i62qjghqfq/i62qjghqfq.png`
- Checksum / 校验和:
  `e1b44ef4e11a96276be93e5ea85a1de715822680cf03c4b0628301ed6a1df85a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.49%.
- Marked-pixel bounds: (74,31)–(175,228); span 102 × 198 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.49%。
- 痕迹范围：(74,31)–(175,228)；跨度102 × 198 px；痕迹矩形高于宽。
