...
- External category reference: `evobc-cat-05944`
- Source category ID: `05944`
- Source label for human review: `磧`
...
- `obs-evo-cand-005944-route-category-staging`
...
- `obs-evo-cand-005944-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005944-route-evolution-graph`
