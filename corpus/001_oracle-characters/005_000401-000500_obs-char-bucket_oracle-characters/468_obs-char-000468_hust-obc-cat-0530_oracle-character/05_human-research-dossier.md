# obs-char-000468 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000468`
- primary external id: `hust-obc-cat-0530`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/468_obs-char-000468_hust-obc-cat-0530_orac
  le-character/03_visual-assets/001_asset-000473_hust-obc-cat-0530_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0530/G_0530_前1.30.7合23432出組.png
  `
- asset id: `asset-000473`
...
- source category: `0530`
- validation class: `467`
- source image route: `HUST-OBC/deciphered/0530/G_0530_前1.30.7合23432出組.png`
- asset id: `asset-000473`
...
- English observation: `A pointed outer enclosure contains an upper
  transverse bar and several descending inner strokes, including a small
  open loop near the lower left.`
...
- dataset label text: `㘈`
- dataset label codepoints: `U+3608`
...
- filename catalog route clues: `Heji-like filename clue: 合23432
...
- Which source records identify obs-char-000468 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000468？
