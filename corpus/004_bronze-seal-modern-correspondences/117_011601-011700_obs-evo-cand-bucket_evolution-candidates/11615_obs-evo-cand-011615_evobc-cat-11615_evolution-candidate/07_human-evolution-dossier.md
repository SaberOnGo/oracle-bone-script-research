...
- External category reference: `evobc-cat-11615`
- Source category ID: `11615`
- Source label for human review: `𤞏`
- Source codepoints: `U+2478F`
...
- `obs-evo-cand-011615-route-category-staging`
...
- `obs-evo-cand-011615-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011615-route-evolution-graph`
