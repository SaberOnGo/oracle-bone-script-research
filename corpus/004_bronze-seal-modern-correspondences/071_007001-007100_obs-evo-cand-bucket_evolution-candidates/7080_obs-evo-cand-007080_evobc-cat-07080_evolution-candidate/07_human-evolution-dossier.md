...
- External category reference: `evobc-cat-07080`
- Source category ID: `07080`
- Source label for human review: `脱`
- Source codepoints: `U+8131`
...
- `obs-evo-cand-007080-route-category-staging`
...
- `obs-evo-cand-007080-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007080-route-evolution-graph`
