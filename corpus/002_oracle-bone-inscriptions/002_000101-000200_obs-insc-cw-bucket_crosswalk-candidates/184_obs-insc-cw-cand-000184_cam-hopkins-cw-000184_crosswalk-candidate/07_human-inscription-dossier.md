...
- Source page section: `Period I Group 15` /
  `第 I 期第 15 组`
- Source section key: `period-i-group-15`
...
- Yingguo / 英国所藏: `y1125` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `175` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `614` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000184`
