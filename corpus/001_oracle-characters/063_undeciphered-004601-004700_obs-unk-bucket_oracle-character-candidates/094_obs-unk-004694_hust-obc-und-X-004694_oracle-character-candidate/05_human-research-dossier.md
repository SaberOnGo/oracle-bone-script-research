# obs-unk-004694 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/094_obs-unk-004694_h
  ust-obc-und-X-004694_oracle-character-candidate/03_visual-assets/001_asset
  -006287_hust-obc-und-X-004694_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/250/X_？_8417_1.png`
- asset id: `asset-006287`
...
- source class: `HUST-OBC/undeciphered/X/250/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/250/X_？_8417_1.png`
- asset id: `asset-006287`
...
- English observation: `upper opening with branched lower mass`
- 中文观察: `带上部开口和下部分支区域的笔画组`
...
- Which source records identify obs-unk-004694 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004694？
