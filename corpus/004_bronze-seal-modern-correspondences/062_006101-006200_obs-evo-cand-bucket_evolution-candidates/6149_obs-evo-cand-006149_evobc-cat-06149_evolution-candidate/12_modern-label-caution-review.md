# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006149
...
- EVOBC candidate category: `evobc-evo-cat-06149`.
- Source label for search only: `空`.
- Source codepoints for search only: `U+7A7A`.
