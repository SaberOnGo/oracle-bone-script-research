...
Project ID: `obs-evo-cand-007785`
...
- Project ID: `obs-evo-cand-007785`
- EVOBC category candidate ID: `evobc-evo-cat-07785`
- External category reference: `evobc-cat-07785`
- Source category ID: `07785`
- Source label for human review: `蜢`
- Source codepoints: `U+8722`
...
- `obs-evo-cand-007785-route-category-staging`
...
- `obs-evo-cand-007785-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007785-route-evolution-graph`
