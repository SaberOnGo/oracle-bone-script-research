# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001226
...
| --- | --- | --- | --- |
| `obimd-glyph-link-018399` | 򦆛󷃱 | `U+A619B;U+F70F1` | `reviewed_metadata_only` |
| `obimd-glyph-link-018400` | 󷃲 | `U+F70F2` | `reviewed_metadata_only` |
| `obimd-glyph-link-018401` | 󷃳 | `U+F70F3` | `reviewed_metadata_only` |
