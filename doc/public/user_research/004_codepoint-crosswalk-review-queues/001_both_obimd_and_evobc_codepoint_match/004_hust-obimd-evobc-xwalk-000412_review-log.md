...
- Review log draft ID / 复核日志草稿 ID: `codepoint-crosswalk-review-log-draft-004`
- Codepoint review task ID / codepoint 复核任务 ID: `codepoint-crosswalk-review-004`
...
- Crosswalk candidate ID / 交叉候选 ID: `hust-obimd-evobc-xwalk-000412`
- Suggested oracle character ID / 建议甲骨单字 ID: `obs-char-000412`
- Promotion queue ID / 提升队列 ID: `hust-obc-obs-char-promo-000412`
...
- HUST external ref / HUST 外部引用: `hust-obc-cat-0468`
- HUST label codepoints / HUST 标签 codepoint: `U+35CA`
- OBIMD main candidates / OBIMD 主字候选: `obimd-main-cand-001642`
- EVOBC category candidates / EVOBC 类别候选: `evobc-evo-cat-00035`
...
- `corpus/001_oracle-characters/005_000401-000500_obs-char-bucket_oracle-characters/412_obs-char-000412_hust-obc-cat-0468_oracle-character/01_candidate-character-packet.json`
...
- Route availability ID: `codepoint-route-availability-004`
...
- Review task ID: `codepoint-crosswalk-review-004`
- Crosswalk candidate ID: `hust-obimd-evobc-xwalk-000412`
- Suggested oracle character ID: `obs-char-000412`
- HUST candidate packet ID: `hust-obc-candidate-packet-000412`
...
- OBIMD row count: `1`
- OBIMD source UIDs: `ytmsqjgowx`
- OBIMD review statuses: `obimd-main-cand-001642=reviewed_metadata_only`
- OBIMD rights statuses: `obimd-main-cand-001642=licensed_for_repository`
- EVOBC row count: `1`
- EVOBC source category IDs: `00035`
- EVOBC has bronze refs: `false`
- EVOBC has seal refs: `false`
- EVOBC review statuses: `evobc-evo-cat-00035=reviewed_metadata_only`
- EVOBC rights statuses: `evobc-evo-cat-00035=source_marked_risk_noted`
...
- Does `hust-obimd-evobc-xwalk-000412` remain unpromoted and undeciphered?
