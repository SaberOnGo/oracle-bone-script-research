# obs-unk-005588 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/072_undeciphered-005
  501-005600_obs-unk-bucket_oracle-character-candidates/088_obs-unk-005588_h
  ust-obc-und-X-005588_oracle-character-candidate/03_visual-assets/001_asset
  -007181_hust-obc-und-X-005588_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1144/X_？_8098_1.png`
- asset id: `asset-007181`
...
- source class: `HUST-OBC/undeciphered/X/1144/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1144/X_？_8098_1.png`
- asset id: `asset-007181`
...
- Which source records identify obs-unk-005588 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005588？
