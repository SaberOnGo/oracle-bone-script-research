# src-penn-museum-oracle-bone Material Access Index / src-penn-museum-oracle-bone 资料访问索引
...
| --- | --- | --- | --- |
| Source summary / 来源摘要 | `README.md` | present | source ID `src-penn-museum-oracle-bone` |
...
| Field maps / 字段映射 | `04_field-map-route-index.csv` | field_rows_present | 3 row(s); target records: asset_metadata;asset_metadata; excavation_or_collection_context;excavation_or_collection_context |
| Downloaded metadata profiles / 已下载 metadata profile | `05_metadata-profile-route-index.csv` | profile_rows_present | 4 row(s); metrics: current_location;object_number;period;provenience |
...
- Risk note / 风险提示: Official university museum object page; image and rights reuse require object-level review before raw asset import.
