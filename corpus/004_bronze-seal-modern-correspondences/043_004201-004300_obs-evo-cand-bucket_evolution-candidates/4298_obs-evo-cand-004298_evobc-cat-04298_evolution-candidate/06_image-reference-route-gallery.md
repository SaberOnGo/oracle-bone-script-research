...
- `obs-evo-cand-004298-route-category-staging`
...
- `obs-evo-cand-004298-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004298-route-evolution-graph`
