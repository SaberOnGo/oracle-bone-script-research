...
- External category reference: `evobc-cat-06839`
- Source category ID: `06839`
- Source label for human review: `羍`
...
- `obs-evo-cand-006839-route-category-staging`
...
- `obs-evo-cand-006839-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006839-route-evolution-graph`
