# obs-unk-005875 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/075_undeciphered-005
  801-005900_obs-unk-bucket_oracle-character-candidates/075_obs-unk-005875_h
  ust-obc-und-X-005875_oracle-character-candidate/03_visual-assets/001_asset
  -007467_hust-obc-und-X-005875_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1431/X_？_2214_1.png`
- asset id: `asset-007467`
...
- source class: `HUST-OBC/undeciphered/X/1431/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1431/X_？_2214_1.png`
- asset id: `asset-007467`
...
- Which source records identify obs-unk-005875 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005875？
