# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001170
...
- EVOBC candidate category: `evobc-evo-cat-01170`.
- Source label for search only: `出`.
- Source codepoints for search only: `U+51FA`.
