# obs-unk-004375 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/075_obs-unk-004375_h
  ust-obc-und-L-004375_oracle-character-candidate/03_visual-assets/001_asset
  -005968_hust-obc-und-L-004375_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4375/L_？_9713.jpg`
- asset id: `asset-005968`
...
- source class: `HUST-OBC/undeciphered/L/4375/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4375/L_？_9713.jpg`
- asset id: `asset-005968`
...
- English observation: `Left curve, upper point, and lower hooked trace`
  `recorded.`
- 中文观察: `已记录左侧弧痕、上部尖痕和下部钩状痕。`
...
- Which source records identify obs-unk-004375 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004375？
