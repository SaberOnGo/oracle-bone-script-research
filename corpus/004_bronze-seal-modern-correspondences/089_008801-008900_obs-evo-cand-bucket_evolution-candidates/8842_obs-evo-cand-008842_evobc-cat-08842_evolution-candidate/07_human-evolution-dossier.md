...
- External category reference: `evobc-cat-08842`
- Source category ID: `08842`
- Source label for human review: `輟`
- Source codepoints: `U+8F1F`
...
- `obs-evo-cand-008842-route-category-staging`
...
- `obs-evo-cand-008842-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008842-route-evolution-graph`
