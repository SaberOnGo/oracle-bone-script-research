...
Project ID: `obs-evo-cand-004425`
...
- Project ID: `obs-evo-cand-004425`
- EVOBC category candidate ID: `evobc-evo-cat-04425`
- External category reference: `evobc-cat-04425`
- Source category ID: `04425`
- Source label for human review: `殲`
- Source codepoints: `U+6BB2`
...
- `obs-evo-cand-004425-route-category-staging`
...
- `obs-evo-cand-004425-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004425-route-evolution-graph`
