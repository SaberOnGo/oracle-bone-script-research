...
- External category reference: `evobc-cat-02476`
- Source category ID: `02476`
- Source label for human review: `尞`
- Source codepoints: `U+5C1E`
...
- `obs-evo-cand-002476-route-category-staging`
...
- `obs-evo-cand-002476-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002476-route-evolution-graph`
