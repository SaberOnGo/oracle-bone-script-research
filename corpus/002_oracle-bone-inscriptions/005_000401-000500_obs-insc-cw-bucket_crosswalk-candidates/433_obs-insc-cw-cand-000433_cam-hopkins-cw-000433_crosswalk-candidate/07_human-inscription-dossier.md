...
- Yingguo / 英国所藏: `y2272` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `303` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `203` in source row; primary catalog entry pending
