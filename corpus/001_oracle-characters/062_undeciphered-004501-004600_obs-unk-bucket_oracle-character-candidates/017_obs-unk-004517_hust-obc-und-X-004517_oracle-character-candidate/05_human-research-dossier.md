# obs-unk-004517 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004517`
- primary external id: `hust-obc-und-X-004517`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/017_obs-unk-004517_h
  ust-obc-und-X-004517_oracle-character-candidate/03_visual-assets/001_asset
  -006110_hust-obc-und-X-004517_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/73/X_？_8257_1.png`
- asset id: `asset-006110`
...
- source class: `HUST-OBC/undeciphered/X/73/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/73/X_？_8257_1.png`
- asset id: `asset-006110`
...
- English observation: `The central stem, upper branches, side projections, and
  lower taper are directly recorded.`
- 中文观察: `已直接记录中央主痕、上部分支、侧向外伸和下端收窄。`
...
- Which source records identify obs-unk-004517 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004517？
