# obs-unk-004659 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/059_obs-unk-004659_h
  ust-obc-und-X-004659_oracle-character-candidate/03_visual-assets/001_asset
  -006252_hust-obc-und-X-004659_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/215/X_？_8386_1.png`
- asset id: `asset-006252`
...
- source class: `HUST-OBC/undeciphered/X/215/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/215/X_？_8386_1.png`
- asset id: `asset-006252`
...
- English observation: `shallow enclosure with long upper stroke`
- 中文观察: `带长上边缘的浅围合形体`
...
- Which source records identify obs-unk-004659 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004659？
