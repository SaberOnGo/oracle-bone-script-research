...
Project ID: `obs-insc-cw-cand-000588`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000588`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000588` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2637` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `398` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `520` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `41947` [route_present_image_or_text_not_collected]
