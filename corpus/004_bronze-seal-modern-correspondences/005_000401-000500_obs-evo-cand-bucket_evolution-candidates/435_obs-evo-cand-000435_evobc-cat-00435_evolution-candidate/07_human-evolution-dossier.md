...
- External category reference: `evobc-cat-00435`
- Source category ID: `00435`
- Source label for human review: `䜋`
- Source codepoints: `U+470B`
...
- `obs-evo-cand-000435-route-category-staging`
...
- `obs-evo-cand-000435-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000435-route-evolution-graph`
