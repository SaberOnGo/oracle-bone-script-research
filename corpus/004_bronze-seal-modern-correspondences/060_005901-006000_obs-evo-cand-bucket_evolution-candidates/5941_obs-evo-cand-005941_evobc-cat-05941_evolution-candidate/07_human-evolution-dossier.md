...
Project ID: `obs-evo-cand-005941`
...
- Project ID: `obs-evo-cand-005941`
- EVOBC category candidate ID: `evobc-evo-cat-05941`
- External category reference: `evobc-cat-05941`
- Source category ID: `05941`
- Source label for human review: `磗`
- Source codepoints: `U+78D7`
...
- `obs-evo-cand-005941-route-category-staging`
...
- `obs-evo-cand-005941-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005941-route-evolution-graph`
