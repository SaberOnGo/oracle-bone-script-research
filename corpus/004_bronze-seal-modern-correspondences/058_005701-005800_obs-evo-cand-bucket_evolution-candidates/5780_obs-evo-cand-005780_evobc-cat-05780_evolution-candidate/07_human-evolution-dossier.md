...
- Project ID: `obs-evo-cand-005780`
- EVOBC category candidate ID: `evobc-evo-cat-05780`
- External category reference: `evobc-cat-05780`
- Source category ID: `05780`
- Source label for human review: `盽`
- Source codepoints: `U+76FD`
...
- `obs-evo-cand-005780-route-category-staging`
...
- `obs-evo-cand-005780-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005780-route-evolution-graph`
