...
Project ID: `obs-evo-cand-004118`
...
- Project ID: `obs-evo-cand-004118`
- EVOBC category candidate ID: `evobc-evo-cat-04118`
- External category reference: `evobc-cat-04118`
- Source category ID: `04118`
- Source label for human review: `椆`
- Source codepoints: `U+6906`
...
- `obs-evo-cand-004118-route-category-staging`
...
- `obs-evo-cand-004118-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004118-route-evolution-graph`
