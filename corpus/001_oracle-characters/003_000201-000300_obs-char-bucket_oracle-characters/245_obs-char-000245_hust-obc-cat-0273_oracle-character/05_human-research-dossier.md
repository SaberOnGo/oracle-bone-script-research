# obs-char-000245 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000245`
- primary external id: `hust-obc-cat-0273`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/245_obs-char-000245_hust-obc-cat-0273_orac
  le-character/03_visual-assets/001_asset-000250_hust-obc-cat-0273_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0273/G_0273_佚194合32775歷組.png`
- asset id: `asset-000250`
...
- source category: `0273`
- validation class: `244`
- source image route: `HUST-OBC/deciphered/0273/G_0273_佚194合32775歷組.png`
- asset id: `asset-000250`
...
- English observation: `The small dark image is a thin irregular upright
  stroke with a visibly thickened, rounded terminal at the bottom.`
- 中文观察: `小幅深色图像呈纤细而不规则的直立笔画，下端有明显加粗的圆钝末端。`
...
- dataset label text: `㔇`
- dataset label codepoints: `U+3507`
...
- filename catalog route clues: `Heji-like filename clue: 合32775
  (G_0273_佚194合32775歷組.png)`
...
- Which source records identify obs-char-000245 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000245？
