# Material Visual Observation / obs-comp-cand-002649 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002649`
- External reference / 外部参照: `obimd-sub-jupncpuwyt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021198_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jupncpuwyt/jupncpuwyt/07p8m5f9om.png`
- Checksum / 校验和:
  `0b713f9b6c210badbe51708fb3400eb798d118c13a40cb36e0d1f1e9a1290b64`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 2.35%.
- Marked-pixel bounds: (81,23)–(168,229); span 88 × 207 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占2.35%。
- 痕迹范围：(81,23)–(168,229)；跨度88 × 207 px；痕迹矩形高于宽。
