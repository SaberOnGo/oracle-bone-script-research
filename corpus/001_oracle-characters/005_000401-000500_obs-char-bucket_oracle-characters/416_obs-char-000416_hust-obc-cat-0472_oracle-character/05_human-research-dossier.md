# obs-char-000416 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000416`
- primary external id: `hust-obc-cat-0472`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/416_obs-char-000416_hust-obc-cat-0472_orac
  le-character/03_visual-assets/001_asset-000421_hust-obc-cat-0472_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0472/G_0472_明2349合2803賓組.png`
- asset id: `asset-000421`
...
- source category: `0472`
- validation class: `415`
- source image route: `HUST-OBC/deciphered/0472/G_0472_明2349合2803賓組.png`
- asset id: `asset-000421`
...
- English observation: `A detached small square and forked mark at left
  stand beside a larger looped, crossed, and angular form at right.`
- 中文观察: `左侧分离的小方形和分叉痕迹与右侧较大的环曲、交叉、折角形体并列。`
...
- dataset label text: `㗎`
- dataset label codepoints: `U+35CE`
...
- filename catalog route clues: `Heji-like filename clue: 合2803
  (G_0472_明2349合2803賓組.png)`
...
- Which source records identify obs-char-000416 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000416？
