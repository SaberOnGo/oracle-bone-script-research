# Material Visual Observation / obs-comp-cand-000375 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000375`
- External reference / 外部参照: `obimd-sub-jstya23ki5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012298_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jstya23ki5/jstya23ki5/jstya23ki5.png`
- Checksum / 校验和:
  `007068dfe6a43494a662aca0aafe227d06fc1dfeeda0b05049264a9f96d2b1a2`
...
- Marked-pixel bounds: (57,29)–(192,218); span 136 × 190 px; the marked
...
- 痕迹范围：(57,29)–(192,218)；跨度136 × 190 px；痕迹矩形高于宽。
