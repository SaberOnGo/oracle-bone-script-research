# obs-unk-004274 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004274`
- primary external id: `hust-obc-und-L-004274`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/074_obs-unk-004274_h
  ust-obc-und-L-004274_oracle-character-candidate/03_visual-assets/001_asset
  -005867_hust-obc-und-L-004274_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4274/L_？_9439.jpg`
- asset id: `asset-005867`
...
- source class: `HUST-OBC/undeciphered/L/4274/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4274/L_？_9439.jpg`
- asset id: `asset-005867`
...
- English observation: `Diagonal band, central crossings, lower curve visible.`
- 中文观察: `斜向痕迹、中央交叉痕迹和下部弯曲痕迹可见。`
...
- Which source records identify obs-unk-004274 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004274？
