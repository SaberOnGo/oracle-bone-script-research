# Material Visual Observation / obs-comp-cand-001010 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001010`
- External reference / 外部参照: `obimd-sub-xnaggs7qe3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014473_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xnaggs7qe3/xnaggs7qe3/xnaggs7qe3.png`
- Checksum / 校验和:
  `23050045d9ded8686db0342f49261812c3cf0c4ae2d216099aa64fbc02ec7982`
...
- Marked-pixel bounds: (70,32)–(178,217); span 109 × 186 px; the marked
...
- 痕迹范围：(70,32)–(178,217)；跨度109 × 186 px；痕迹矩形高于宽。
