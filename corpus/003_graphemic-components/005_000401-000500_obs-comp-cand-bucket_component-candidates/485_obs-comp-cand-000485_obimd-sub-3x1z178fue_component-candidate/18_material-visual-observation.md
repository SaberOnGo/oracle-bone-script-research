# Material Visual Observation / obs-comp-cand-000485 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000485`
- External reference / 外部参照: `obimd-sub-3x1z178fue`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012721_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7kjgfmjunm/3x1z178fue/3x1z178fue.png`
- Checksum / 校验和:
  `ac455d7884204092d78be54790ceaed5c12e9ebe2c89f53a28a2565831edf1ef`
...
- Marked-pixel bounds: (91,11)–(176,240); span 86 × 230 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.12%。
- 痕迹范围：(91,11)–(176,240)；跨度86 × 230 px；痕迹矩形高于宽。
