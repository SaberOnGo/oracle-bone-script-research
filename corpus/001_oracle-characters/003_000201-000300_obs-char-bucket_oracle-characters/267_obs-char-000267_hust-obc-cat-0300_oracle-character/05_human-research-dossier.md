# obs-char-000267 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000267`
- primary external id: `hust-obc-cat-0300`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/267_obs-char-000267_hust-obc-cat-0300_orac
  le-character/03_visual-assets/001_asset-000272_hust-obc-cat-0300_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0300/G_0300_乙1296合21987子組.png`
- asset id: `asset-000272`
...
- source category: `0300`
- validation class: `266`
- source image route: `HUST-OBC/deciphered/0300/G_0300_乙1296合21987子組.png`
- asset id: `asset-000272`
...
- English observation: `The dark image contains several rounded upper lobes,
  a dense central knot, and a long irregular stroke descending toward the
  lower right.`
- 中文观察: `深色图像含数个圆弧上部形体、密集中央结点，并向右下延出长而不规则笔画。`
...
- dataset label text: `㔢`
- dataset label codepoints: `U+3522`
...
- filename catalog route clues: `Heji-like filename clue: 合21987
  (G_0300_乙1296合21987子組.png)`
...
- Which source records identify obs-char-000267 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000267？
