...
- Project ID: `obs-evo-cand-011929`
- EVOBC category candidate ID: `evobc-evo-cat-11929`
- External category reference: `evobc-cat-11929`
- Source category ID: `11929`
- Source label for human review: `𥾯`
- Source codepoints: `U+25FAF`
...
- `obs-evo-cand-011929-route-category-staging`
...
- `obs-evo-cand-011929-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011929-route-evolution-graph`
