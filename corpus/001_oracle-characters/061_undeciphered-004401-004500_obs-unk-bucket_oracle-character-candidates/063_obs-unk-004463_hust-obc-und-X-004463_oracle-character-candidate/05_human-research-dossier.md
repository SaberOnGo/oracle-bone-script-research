# obs-unk-004463 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004463`
- primary external id: `hust-obc-und-X-004463`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/063_obs-unk-004463_h
  ust-obc-und-X-004463_oracle-character-candidate/03_visual-assets/001_asset
  -006056_hust-obc-und-X-004463_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/19/X_？_8198_1.png`
- asset id: `asset-006056`
...
- source class: `HUST-OBC/undeciphered/X/19/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/19/X_？_8198_1.png`
- asset id: `asset-006056`
...
- English observation: Two uneven upper prongs lead into a narrow stem and a
  broad lower curve with a hooked interior trace.
- 中文观察: 两个高低不一的上部分叉连接窄长中部和带钩状内痕的下部弧线。
...
- Which source records identify obs-unk-004463 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004463？
