...
- External category reference: `evobc-cat-08553`
- Source category ID: `08553`
- Source label for human review: `貶`
- Source codepoints: `U+8CB6`
...
- `obs-evo-cand-008553-route-category-staging`
...
- `obs-evo-cand-008553-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008553-route-evolution-graph`
