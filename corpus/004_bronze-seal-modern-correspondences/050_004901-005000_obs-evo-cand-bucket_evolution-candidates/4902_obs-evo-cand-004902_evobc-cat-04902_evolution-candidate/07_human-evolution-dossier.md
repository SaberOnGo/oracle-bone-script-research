...
Project ID: `obs-evo-cand-004902`
...
- Project ID: `obs-evo-cand-004902`
- EVOBC category candidate ID: `evobc-evo-cat-04902`
- External category reference: `evobc-cat-04902`
- Source category ID: `04902`
- Source label for human review: `潝`
- Source codepoints: `U+6F5D`
...
- `obs-evo-cand-004902-route-category-staging`
...
- `obs-evo-cand-004902-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004902-route-evolution-graph`
