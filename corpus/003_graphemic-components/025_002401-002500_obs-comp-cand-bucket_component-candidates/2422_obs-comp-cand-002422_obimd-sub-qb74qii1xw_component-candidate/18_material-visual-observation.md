# Material Visual Observation / obs-comp-cand-002422 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002422`
- External reference / 外部参照: `obimd-sub-qb74qii1xw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020493_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jpxofd3gmu/qb74qii1xw/qb74qii1xw.png`
- Checksum / 校验和:
  `033ca7c4e90828a88527d951cd39a87139ca8e430be4744da55026cb36513457`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.28%.
- Marked-pixel bounds: (60,38)–(189,213); span 130 × 176 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.28%。
- 痕迹范围：(60,38)–(189,213)；跨度130 × 176 px；痕迹矩形高于宽。
