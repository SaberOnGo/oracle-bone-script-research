...
- Yingguo / 英国所藏: `y2373` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `573` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `351` in source row; primary catalog entry pending
- Heji / 合集: `41429` in source row; primary catalog entry pending
