...
- External category reference: `evobc-cat-07819`
- Source category ID: `07819`
- Source label for human review: `蝨`
...
- `obs-evo-cand-007819-route-category-staging`
...
- `obs-evo-cand-007819-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007819-route-evolution-graph`
