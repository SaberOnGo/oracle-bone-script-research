...
Project ID: `obs-evo-cand-012571`
...
- Project ID: `obs-evo-cand-012571`
- EVOBC category candidate ID: `evobc-evo-cat-12571`
- External category reference: `evobc-cat-12571`
- Source category ID: `12571`
- Source label for human review: `𩊊`
- Source codepoints: `U+2928A`
...
- `obs-evo-cand-012571-route-category-staging`
...
- `obs-evo-cand-012571-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012571-route-evolution-graph`
