# Material Visual Observation / obs-comp-cand-002437 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002437`
- External reference / 外部参照: `obimd-sub-b3fudy3nhc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020609_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/b3fudy3nhc/b3fudy3nhc/b3fudy3nhc.png`
- Checksum / 校验和:
  `50348e0ad01c9a4a0030af8217e9c6f3fdbc2c7b9d4d23bf6e383004f5087d98`
...
- Marked-pixel bounds: (85,19)–(166,231); span 82 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.58%。
- 痕迹范围：(85,19)–(166,231)；跨度82 × 213 px；痕迹矩形高于宽。
