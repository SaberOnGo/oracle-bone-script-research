# Collection Provenance Evidence Dossier / 馆藏来源证据档案: coll-obj-cand-00018
...
| source_row_id | `18` |
| object_page_url | `https://museum.sinica.edu.tw/en/collection/32/item/348/` |
...
The item page and large image were re-opened on 2026-08-14. Source description,
image checksum, 3D route, and visual boundary are recorded in
`18_live-source-evidence-review.md`; rights remain unresolved.

2026-08-14 重新打开对象页和大图。来源说明、图像校验和、3D 路线与视觉边界已记录在
...
| asset_id | `` |
| asset_path | `` |
| thumbnail_url | `https://museum.sinica.edu.tw/_upload/image/collection_item/thumbnail/915f68928c0f84a.jpg` |
| source_image_url | `` |
...
| `source_collection_item_id` | `348` |
| `object_title_en` | `Inscribed Animal Bone Fragment Chia 2336` |
| `catalog_reference_text` | `Chia 2336` |
| `accession_number` | `` |
| `historical_period` | `` |
| `object_date` | `` |
| `provenience` | `` |
