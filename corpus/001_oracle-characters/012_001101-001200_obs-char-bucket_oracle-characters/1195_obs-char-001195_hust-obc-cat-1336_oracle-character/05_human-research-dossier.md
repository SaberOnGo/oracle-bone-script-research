# obs-char-001195 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001195`
- primary external id: `hust-obc-cat-1336`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1195_obs-char-001195_hust-obc-cat-1336_ora
  cle-character/03_visual-assets/001_asset-001200_hust-obc-cat-1336_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1336/X_1336_220_1.png`
- asset id: `asset-001200`
...
- source category: `1336`
- validation class: `1194`
- source image route: `HUST-OBC/deciphered/1336/X_1336_220_1.png`
- asset id: `asset-001200`
...
- English observation: `A tall dark curved stroke surrounds a small rounded
  inner loop and continues into a long tapered lower line.`
- 中文观察: `高而深色的弯曲笔围绕小型圆弧内部环，并继续成为长而渐细的下部线。`
...
- dataset label text: `㤮`
- dataset label codepoints: `U+392E`
...
- Which source records identify obs-char-001195 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001195？
