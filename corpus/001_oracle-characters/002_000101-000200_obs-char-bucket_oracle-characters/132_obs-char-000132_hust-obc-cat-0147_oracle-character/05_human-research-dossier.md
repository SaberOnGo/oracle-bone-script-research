# obs-char-000132 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000132`
- primary external id: `hust-obc-cat-0147`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/132_obs-char-000132_hust-obc-cat-0147_orac
  le-character/03_visual-assets/001_asset-000137_hust-obc-cat-0147_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0147/G_0147_京津3298合23563出組.png`
- asset id: `asset-000137`
...
- source category: `0147`
- validation class: `131`
- source image route: `HUST-OBC/deciphered/0147/G_0147_京津3298合23563出組.png`
- asset id: `asset-000137`
...
- English observation: `The dark image has a thick central descending stroke
  with several short curved branches extending unevenly to both sides.`
...
- dataset label text: `㒉`
- dataset label codepoints: `U+3489`
...
- filename catalog route clues: `Heji-like filename clue: 合23563
...
- Which source records identify obs-char-000132 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000132？
