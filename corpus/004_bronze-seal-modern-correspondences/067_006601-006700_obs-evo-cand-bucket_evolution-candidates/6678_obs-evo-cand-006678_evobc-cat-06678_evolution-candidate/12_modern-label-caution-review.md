# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006678
...
- EVOBC candidate category: `evobc-evo-cat-06678`.
- Source label for search only: `繚`.
- Source codepoints for search only: `U+7E5A`.
