# Material Visual Observation / obs-comp-cand-002119 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002119`
- External reference / 外部参照: `obimd-sub-4iyooyk1dn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019676_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7gvythc7mi/4iyooyk1dn/4iyooyk1dn.png`
- Checksum / 校验和:
  `866af64ddd81696e5d194c9b81afd659277158aec2e1f81d39450fcc389a9710`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.61%.
- Marked-pixel bounds: (64,39)–(185,205); span 122 × 167 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.61%。
- 痕迹范围：(64,39)–(185,205)；跨度122 × 167 px；痕迹矩形高于宽。
