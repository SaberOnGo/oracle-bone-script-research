# Material Visual Observation / obs-comp-cand-001567 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001567`
- External reference / 外部参照: `obimd-sub-db5x2p7zwk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017114_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ex96ntmoie/db5x2p7zwk/db5x2p7zwk.png`
- Checksum / 校验和:
  `ad65871826a16df5039178af5dd5d40e28f57abc4414cf2087d6519559e9722c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.20%.
- Marked-pixel bounds: (50,83)–(199,160); span 150 × 78 px; the marked rectangle
  is wider than tall.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.20%。
- 痕迹范围：(50,83)–(199,160)；跨度150 × 78 px；痕迹矩形宽于高。
