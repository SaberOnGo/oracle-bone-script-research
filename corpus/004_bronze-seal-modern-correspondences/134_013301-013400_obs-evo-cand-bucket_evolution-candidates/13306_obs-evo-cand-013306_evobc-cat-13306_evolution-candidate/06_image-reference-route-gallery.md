...
- `obs-evo-cand-013306-route-category-staging`
...
- `obs-evo-cand-013306-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013306-route-evolution-graph`
