# Material Visual Observation / obs-comp-cand-001051 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001051`
- External reference / 外部参照: `obimd-sub-vqo5659li5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014601_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vqo5659li5/vqo5659li5/vqo5659li5.png`
- Checksum / 校验和:
  `530f6d35ea7d00a3133d5bd322b60f79feca2d6940abdd5cf763b624fc244b31`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.46%.
- Marked-pixel bounds: (97,19)–(170,231); span 74 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.46%。
- 痕迹范围：(97,19)–(170,231)；跨度74 × 213 px；痕迹矩形高于宽。
