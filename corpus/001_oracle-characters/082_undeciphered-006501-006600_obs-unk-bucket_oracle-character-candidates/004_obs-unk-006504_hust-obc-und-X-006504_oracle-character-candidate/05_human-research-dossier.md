# obs-unk-006504 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/082_undeciphered-006
  501-006600_obs-unk-bucket_oracle-character-candidates/004_obs-unk-006504_h
  ust-obc-und-X-006504_oracle-character-candidate/03_visual-assets/001_asset
  -008095_hust-obc-und-X-006504_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2060/X_？_5709_1.png`
- asset id: `asset-008095`
...
- source class: `HUST-OBC/undeciphered/X/2060/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2060/X_？_5709_1.png`
- asset id: `asset-008095`
...
- Which source records identify obs-unk-006504 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006504？
