...
- External category reference: `evobc-cat-10561`
- Source category ID: `10561`
- Source label for human review: `鷫`
- Source codepoints: `U+9DEB`
...
- `obs-evo-cand-010561-route-category-staging`
...
- `obs-evo-cand-010561-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010561-route-evolution-graph`
