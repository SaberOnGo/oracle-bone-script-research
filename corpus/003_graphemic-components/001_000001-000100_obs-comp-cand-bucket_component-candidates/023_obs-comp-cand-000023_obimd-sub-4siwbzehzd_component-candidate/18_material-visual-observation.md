# Material Visual Observation / obs-comp-cand-000023 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000023`
- External reference / 外部参照: `obimd-sub-4siwbzehzd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011175_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vbkc7p8qc9/4siwbzehzd/4siwbzehzd.png`
- Checksum / 校验和:
  `8532d52685f1f7168f4c5547fdaa1c16a150187b148dc394c2cca6ef487d732b`
...
- Marked-pixel bounds: (63,25)–(186,222); span 124 × 198 px; the marked
...
- 痕迹范围：(63,25)–(186,222)；跨度124 × 198 px；痕迹矩形高于宽。
