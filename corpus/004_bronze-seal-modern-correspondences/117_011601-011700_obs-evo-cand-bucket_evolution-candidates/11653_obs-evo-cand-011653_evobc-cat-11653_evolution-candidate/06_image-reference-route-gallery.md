...
- `obs-evo-cand-011653-route-category-staging`
...
- `obs-evo-cand-011653-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011653-route-evolution-graph`
