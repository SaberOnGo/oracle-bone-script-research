...
- External category reference: `evobc-cat-01348`
- Source category ID: `01348`
- Source label for human review: `匬`
- Source codepoints: `U+532C`
...
- `obs-evo-cand-001348-route-category-staging`
...
- `obs-evo-cand-001348-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001348-route-evolution-graph`
