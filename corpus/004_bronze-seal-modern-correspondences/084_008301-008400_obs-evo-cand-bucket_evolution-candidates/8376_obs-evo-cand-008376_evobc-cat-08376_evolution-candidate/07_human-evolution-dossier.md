...
Project ID: `obs-evo-cand-008376`
...
- Project ID: `obs-evo-cand-008376`
- EVOBC category candidate ID: `evobc-evo-cat-08376`
- External category reference: `evobc-cat-08376`
- Source category ID: `08376`
- Source label for human review: `護`
- Source codepoints: `U+8B77`
...
- `obs-evo-cand-008376-route-category-staging`
...
- `obs-evo-cand-008376-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008376-route-evolution-graph`
