...
Project ID: `obs-evo-cand-001445`
...
- Project ID: `obs-evo-cand-001445`
- EVOBC category candidate ID: `evobc-evo-cat-01445`
- External category reference: `evobc-cat-01445`
- Source category ID: `01445`
- Source label for human review: `县`
- Source codepoints: `U+53BF`
...
- `obs-evo-cand-001445-route-category-staging`
...
- `obs-evo-cand-001445-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001445-route-evolution-graph`
