# Material Visual Observation / obs-comp-cand-000475 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000475`
- External reference / 外部参照: `obimd-sub-fh8kl9f33j`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012625_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ah10xtkbxp/fh8kl9f33j/fh8kl9f33j.png`
- Checksum / 校验和:
  `3f94e7db39f72228c1f95f5b3406f22ec5f321195be6a330a4341a3edc4177c3`
...
- Marked-pixel bounds: (80,15)–(168,233); span 89 × 219 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.04%。
- 痕迹范围：(80,15)–(168,233)；跨度89 × 219 px；痕迹矩形高于宽。
