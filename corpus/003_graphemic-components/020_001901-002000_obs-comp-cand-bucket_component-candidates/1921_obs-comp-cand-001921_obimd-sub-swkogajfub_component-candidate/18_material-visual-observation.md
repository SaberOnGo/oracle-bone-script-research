# Material Visual Observation / obs-comp-cand-001921 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001921`
- External reference / 外部参照: `obimd-sub-swkogajfub`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018331_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/swkogajfub/swkogajfub/swkogajfub.png`
- Checksum / 校验和:
  `1bd742c811c160902549952433bf80550ef1f46ad350b7f52eec666ae5224da6`
...
- Marked-pixel bounds: (58,24)–(195,217); span 138 × 194 px; the marked
...
- 痕迹范围：(58,24)–(195,217)；跨度138 × 194 px；痕迹矩形高于宽。
