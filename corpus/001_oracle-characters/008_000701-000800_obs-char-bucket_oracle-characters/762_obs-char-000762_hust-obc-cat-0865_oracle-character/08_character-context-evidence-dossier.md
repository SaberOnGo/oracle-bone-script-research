...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0865`
...
- Source image / 来源图: `G_0865_前1.6.6合35584黃組.png`
- Image / 图像: `001_asset-000767_hust-obc-cat-0865_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合35584
...
- target node: `evobc-evo-cat-00069`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/069_obs-evo-cand-000069_evobc-cat-00069_evoluti
...
- Source label text / 来源标签文字: `㝗`
- Source label codepoint / 来源标签 codepoint: `U+3757`
