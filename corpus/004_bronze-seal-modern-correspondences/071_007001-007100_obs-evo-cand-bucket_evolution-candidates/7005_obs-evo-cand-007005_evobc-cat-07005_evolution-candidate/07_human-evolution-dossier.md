...
- External category reference: `evobc-cat-07005`
- Source category ID: `07005`
- Source label for human review: `肱`
- Source codepoints: `U+80B1`
...
- `obs-evo-cand-007005-route-category-staging`
...
- `obs-evo-cand-007005-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007005-route-evolution-graph`
