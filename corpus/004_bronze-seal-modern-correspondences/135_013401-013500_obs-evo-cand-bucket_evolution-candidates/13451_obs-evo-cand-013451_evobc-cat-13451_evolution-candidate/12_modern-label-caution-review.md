# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013451
...
- EVOBC candidate category: `evobc-evo-cat-13451`.
- Source label for search only: `𬹚`.
- Source codepoints for search only: `U+2CE5A`.
