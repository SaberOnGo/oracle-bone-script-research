# Material Visual Observation / obs-comp-cand-000168 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000168`
- External reference / 外部参照: `obimd-sub-3k23i3cwyt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011580_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3k23i3cwyt/3k23i3cwyt/3k23i3cwyt.png`
- Checksum / 校验和:
  `49293ac08ac19fbf307a9e05e456fa78989e170168021d64d409072b8ec7bb9a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.25%.
- Marked-pixel bounds: (66,21)–(183,226); span 118 × 206 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.25%。
- 痕迹范围：(66,21)–(183,226)；跨度118 × 206 px；痕迹矩形高于宽。
