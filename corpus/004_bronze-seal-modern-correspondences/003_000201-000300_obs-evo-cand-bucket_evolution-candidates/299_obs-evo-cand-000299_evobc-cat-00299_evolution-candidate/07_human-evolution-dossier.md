...
- External category reference: `evobc-cat-00299`
- Source category ID: `00299`
- Source label for human review: `䇒`
- Source codepoints: `U+41D2`
...
- `obs-evo-cand-000299-route-category-staging`
...
- `obs-evo-cand-000299-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000299-route-evolution-graph`
