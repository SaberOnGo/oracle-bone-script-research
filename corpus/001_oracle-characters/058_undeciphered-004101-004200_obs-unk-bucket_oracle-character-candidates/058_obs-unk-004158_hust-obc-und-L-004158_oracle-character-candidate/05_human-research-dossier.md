# obs-unk-004158 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004158`
- primary external id: `hust-obc-und-L-004158`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/058_obs-unk-004158_h
  ust-obc-und-L-004158_oracle-character-candidate/03_visual-assets/001_asset
  -005751_hust-obc-und-L-004158_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4158/L_？_9011.jpg`
- asset id: `asset-005751`
...
- source class: `HUST-OBC/undeciphered/L/4158/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4158/L_？_9011.jpg`
- asset id: `asset-005751`
...
- English observation: A narrow upper trace with side marks descends into
  two angled traces and a broad lower base.
- 中文观察：带侧痕的窄上部痕迹向下延至两条斜痕和宽下部基底。
...
- Which source records identify obs-unk-004158 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004158？
