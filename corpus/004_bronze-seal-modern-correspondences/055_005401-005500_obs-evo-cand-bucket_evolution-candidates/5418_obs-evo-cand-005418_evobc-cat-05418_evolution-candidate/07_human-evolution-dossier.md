...
- External category reference: `evobc-cat-05418`
- Source category ID: `05418`
- Source label for human review: `琮`
- Source codepoints: `U+742E`
...
- `obs-evo-cand-005418-route-category-staging`
...
- `obs-evo-cand-005418-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005418-route-evolution-graph`
