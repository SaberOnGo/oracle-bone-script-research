...
Project ID: `obs-evo-cand-004001`
...
- Project ID: `obs-evo-cand-004001`
- EVOBC category candidate ID: `evobc-evo-cat-04001`
- External category reference: `evobc-cat-04001`
- Source category ID: `04001`
- Source label for human review: `校`
- Source codepoints: `U+6821`
...
- `obs-evo-cand-004001-route-category-staging`
...
- `obs-evo-cand-004001-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004001-route-evolution-graph`
