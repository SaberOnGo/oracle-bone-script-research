...
Project ID: `obs-evo-cand-003220`
...
- Project ID: `obs-evo-cand-003220`
- EVOBC category candidate ID: `evobc-evo-cat-03220`
- External category reference: `evobc-cat-03220`
- Source category ID: `03220`
- Source label for human review: `戣`
- Source codepoints: `U+6223`
...
- `obs-evo-cand-003220-route-category-staging`
...
- `obs-evo-cand-003220-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003220-route-evolution-graph`
