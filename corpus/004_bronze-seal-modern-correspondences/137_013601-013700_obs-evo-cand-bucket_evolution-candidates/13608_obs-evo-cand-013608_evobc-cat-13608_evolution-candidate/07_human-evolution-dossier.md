...
- External category reference: `evobc-cat-13608`
- Source category ID: `13608`
- Source label for human review: `𮆱`
...
- `obs-evo-cand-013608-route-category-staging`
...
- `obs-evo-cand-013608-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013608-route-evolution-graph`
