...
- Project ID: `obs-evo-cand-003969`
- EVOBC category candidate ID: `evobc-evo-cat-03969`
- External category reference: `evobc-cat-03969`
- Source category ID: `03969`
- Source label for human review: `柩`
- Source codepoints: `U+67E9`
...
- `obs-evo-cand-003969-route-category-staging`
...
- `obs-evo-cand-003969-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003969-route-evolution-graph`
