...
- External category reference: `evobc-cat-05687`
- Source category ID: `05687`
- Source label for human review: `療`
...
- `obs-evo-cand-005687-route-category-staging`
...
- `obs-evo-cand-005687-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005687-route-evolution-graph`
