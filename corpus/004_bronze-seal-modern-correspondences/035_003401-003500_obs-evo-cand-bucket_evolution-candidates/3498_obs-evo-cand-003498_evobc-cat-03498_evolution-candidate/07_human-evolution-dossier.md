...
- Project ID: `obs-evo-cand-003498`
- EVOBC category candidate ID: `evobc-evo-cat-03498`
- External category reference: `evobc-cat-03498`
- Source category ID: `03498`
- Source label for human review: `撝`
- Source codepoints: `U+649D`
...
- `obs-evo-cand-003498-route-category-staging`
...
- `obs-evo-cand-003498-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003498-route-evolution-graph`
