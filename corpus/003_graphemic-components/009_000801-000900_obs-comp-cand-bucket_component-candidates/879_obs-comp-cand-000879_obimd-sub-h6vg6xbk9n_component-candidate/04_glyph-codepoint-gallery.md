# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000879
...
| --- | --- | --- | --- |
| `obimd-glyph-link-012699` | 󴼾 | `U+F4F3E` | `reviewed_metadata_only` |
| `obimd-glyph-link-012700` | 󴼿 | `U+F4F3F` | `reviewed_metadata_only` |
| `obimd-glyph-link-012701` | 󴽀 | `U+F4F40` | `reviewed_metadata_only` |
