# obs-char-001291 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1291_obs-char-001291_hust-obc-cat-1443_ora
  cle-character/03_visual-assets/001_asset-001296_hust-obc-cat-1443_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1443/L_1443_10349.jpg`
- asset id: `asset-001296`
...
- source category: `1443`
- validation class: `1290`
- source image route: `HUST-OBC/deciphered/1443/L_1443_10349.jpg`
- asset id: `asset-001296`
...
- English observation: `A small dense form has a broad upper crossing,
  several short vertical divisions, and a compact lower body.`
- 中文观察: `小型密集形体有宽大的上部交叉笔、数条短竖向分隔和紧凑下部主体。`
...
- dataset label text: `㦙`
- dataset label codepoints: `U+3999`
...
- Which source records identify obs-char-001291 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001291？
