# Material Visual Observation / obs-comp-cand-000829 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000829`
- External reference / 外部参照: `obimd-sub-9xlu134oo9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013700_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9xlu134oo9/9xlu134oo9/9xlu134oo9.png`
- Checksum / 校验和:
  `fa6dfe20764f424c331feb6c164750e6b418262f449f0731900e2e2a892251c0`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.56%.
- Marked-pixel bounds: (93,34)–(160,213); span 68 × 180 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.56%。
- 痕迹范围：(93,34)–(160,213)；跨度68 × 180 px；痕迹矩形高于宽。
