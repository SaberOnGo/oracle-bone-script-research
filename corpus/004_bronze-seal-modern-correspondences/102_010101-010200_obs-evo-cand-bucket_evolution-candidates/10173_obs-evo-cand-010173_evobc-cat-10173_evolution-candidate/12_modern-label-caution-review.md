# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010173
...
- EVOBC candidate category: `evobc-evo-cat-10173`.
- Source label for search only: `馽`.
- Source codepoints for search only: `U+99BD`.
