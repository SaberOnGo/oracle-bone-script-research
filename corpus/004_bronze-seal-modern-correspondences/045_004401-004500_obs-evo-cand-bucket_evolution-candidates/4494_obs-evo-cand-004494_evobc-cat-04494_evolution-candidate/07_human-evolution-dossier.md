...
Project ID: `obs-evo-cand-004494`
...
- Project ID: `obs-evo-cand-004494`
- EVOBC category candidate ID: `evobc-evo-cat-04494`
- External category reference: `evobc-cat-04494`
- Source category ID: `04494`
- Source label for human review: `汓`
- Source codepoints: `U+6C53`
...
- `obs-evo-cand-004494-route-category-staging`
...
- `obs-evo-cand-004494-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004494-route-evolution-graph`
