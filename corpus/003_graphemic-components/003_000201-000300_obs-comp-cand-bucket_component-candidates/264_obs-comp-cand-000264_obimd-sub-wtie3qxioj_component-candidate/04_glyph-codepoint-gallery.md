# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000264
...
| --- | --- | --- | --- |
| `obimd-glyph-link-003664` | 󿳭 | `U+FFCED` | `reviewed_metadata_only` |
| `obimd-glyph-link-003665` | 󱠘 | `U+F1818` | `reviewed_metadata_only` |
| `obimd-glyph-link-003666` | 󱠙 | `U+F1819` | `reviewed_metadata_only` |
