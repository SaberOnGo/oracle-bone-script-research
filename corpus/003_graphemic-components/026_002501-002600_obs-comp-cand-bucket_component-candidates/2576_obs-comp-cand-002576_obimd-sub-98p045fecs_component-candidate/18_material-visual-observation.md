# Material Visual Observation / obs-comp-cand-002576 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002576`
- External reference / 外部参照: `obimd-sub-98p045fecs`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021108_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/98p045fecs/98p045fecs/98p045fecs.png`
- Checksum / 校验和:
  `e58fe66ca13526dfeca59c415488a493ad42d5705f48997b3a5baefb2b8e52e2`
...
- Marked-pixel bounds: (79,18)–(169,228); span 91 × 211 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.30%。
- 痕迹范围：(79,18)–(169,228)；跨度91 × 211 px；痕迹矩形高于宽。
