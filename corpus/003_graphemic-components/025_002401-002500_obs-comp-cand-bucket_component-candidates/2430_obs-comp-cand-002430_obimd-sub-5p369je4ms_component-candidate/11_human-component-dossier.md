# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-002430
...
- glyph_codepoint_uplus_sample: `U+FDDF2, U+FDDF3, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-020602` | `001_asset-020602_img.png` | `8b6a35c22a85c725c3e59746183a0efebbaaa3dcf1120f6930c437e641f98eac` |
