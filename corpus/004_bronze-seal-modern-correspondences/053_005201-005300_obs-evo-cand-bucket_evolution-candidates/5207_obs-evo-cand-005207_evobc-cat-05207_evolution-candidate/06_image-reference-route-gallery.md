...
- `obs-evo-cand-005207-route-category-staging`
...
- `obs-evo-cand-005207-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005207-route-evolution-graph`
