# Material Visual Observation / obs-comp-cand-000180 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000180`
- External reference / 外部参照: `obimd-sub-ifwvlqtuf0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011592_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3wku1ohk1p/ifwvlqtuf0/ifwvlqtuf0.png`
- Checksum / 校验和:
  `dc7829d6b664f53e75b20520bca758ea1f110e99125ba49dc0f3e93919076f7e`
...
- Marked-pixel bounds: (71,32)–(178,217); span 108 × 186 px; the marked
...
- 痕迹范围：(71,32)–(178,217)；跨度108 × 186 px；痕迹矩形高于宽。
