...
- External category reference: `evobc-cat-12282`
- Source category ID: `12282`
- Source label for human review: `𧶌`
- Source codepoints: `U+27D8C`
...
- `obs-evo-cand-012282-route-category-staging`
...
- `obs-evo-cand-012282-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012282-route-evolution-graph`
