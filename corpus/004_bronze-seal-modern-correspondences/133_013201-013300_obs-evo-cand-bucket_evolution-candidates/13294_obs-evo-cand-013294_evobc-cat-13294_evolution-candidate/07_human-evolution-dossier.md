...
- Project ID: `obs-evo-cand-013294`
- EVOBC category candidate ID: `evobc-evo-cat-13294`
- External category reference: `evobc-cat-13294`
- Source category ID: `13294`
- Source label for human review: `𬙜`
- Source codepoints: `U+2C65C`
...
- `obs-evo-cand-013294-route-category-staging`
...
- `obs-evo-cand-013294-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013294-route-evolution-graph`
