...
- Yingguo / 英国所藏: `y2514` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `555` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `735` in source row; primary catalog entry pending
- Heji / 合集: `41739` in source row; primary catalog entry pending
