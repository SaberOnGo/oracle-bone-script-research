...
Project ID: `obs-evo-cand-009360`
...
- Project ID: `obs-evo-cand-009360`
- EVOBC category candidate ID: `evobc-evo-cat-09360`
- External category reference: `evobc-cat-09360`
- Source category ID: `09360`
- Source label for human review: `鉗`
- Source codepoints: `U+9257`
...
- `obs-evo-cand-009360-route-category-staging`
...
- `obs-evo-cand-009360-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009360-route-evolution-graph`
