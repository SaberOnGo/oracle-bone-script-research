# obs-char-000668 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/668_obs-char-000668_hust-obc-cat-0758_orac
  le-character/03_visual-assets/001_asset-000673_hust-obc-cat-0758_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0758/G_0758_乙4835反合914反賓組.png`
- asset id: `asset-000673`
...
- source category: `0758`
- validation class: `667`
- source image route: `HUST-OBC/deciphered/0758/G_0758_乙4835反合914反賓組.png`
- asset id: `asset-000673`
...
- dataset label text: `㛬`
- dataset label codepoints: `U+36EC`
...
- Which source records identify obs-char-000668 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000668？
