...
- Project ID: `obs-evo-cand-006019`
- EVOBC category candidate ID: `evobc-evo-cat-06019`
- External category reference: `evobc-cat-06019`
- Source category ID: `06019`
- Source label for human review: `福`
- Source codepoints: `U+798F`
- Image reference count in source metadata: `409`
...
- `obs-evo-cand-006019-route-category-staging`
...
- `obs-evo-cand-006019-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006019-route-evolution-graph`
