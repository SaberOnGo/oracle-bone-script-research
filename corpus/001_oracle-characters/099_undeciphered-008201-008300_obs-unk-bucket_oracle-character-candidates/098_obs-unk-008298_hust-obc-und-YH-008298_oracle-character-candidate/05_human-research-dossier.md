# obs-unk-008298 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008298`
- primary external id: `hust-obc-und-YH-008298`
...
- local review image route: `corpus/001_oracle-characters/099_undeciphered-008
  201-008300_obs-unk-bucket_oracle-character-candidates/098_obs-unk-008298_h
  ust-obc-und-YH-008298_oracle-character-candidate/03_visual-assets/001_asse
  t-009889_hust-obc-und-YH-008298_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/609AF/H_？_609AF_0.png`
- asset id: `asset-009889`
...
- source class: `HUST-OBC/undeciphered/Y+H/609AF/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/609AF/H_？_609AF_0.png`
- asset id: `asset-009889`
...
- Which source records identify obs-unk-008298 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008298？
