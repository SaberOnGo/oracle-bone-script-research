...
- Registered scope / 已登记范围: Official collection overview reporting over 1750
  oracle bones and 1495 inscribed pieces; includes provenance through Hu
  Houxuan/Yu Shengwu/Chen Mengjia and UNESCO Memory context.
- Source page / 来源页面: https://lib.tsinghua.edu.cn/en/info/1021/1442.htm
...
- Recorded access item / 已记录访问项: dl-tsinghua-oracle-bones-overview; downloaded;
  42876 bytes

## Usable Material Routes / 可用资料路径
- Package material / 来源包资料: dl-tsinghua-oracle-bones-overview.htm;
...
- Candidate transfer field / 候选转入字段: over 1750 oracle bones; 1495 inscribed
  pieces -> source_record -> source_scope_statistics
- Candidate transfer field / 候选转入字段: Hu Houxuan; Yu Shengwu; Chen Mengjia ->
  excavation_or_collection_context -> collection_provenance_note
