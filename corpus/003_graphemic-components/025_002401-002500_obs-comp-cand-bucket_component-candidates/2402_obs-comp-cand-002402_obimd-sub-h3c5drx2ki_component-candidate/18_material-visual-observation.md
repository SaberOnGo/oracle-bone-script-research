# Material Visual Observation / obs-comp-cand-002402 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002402`
- External reference / 外部参照: `obimd-sub-h3c5drx2ki`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020473_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h3c5drx2ki/h3c5drx2ki/h3c5drx2ki.png`
- Checksum / 校验和:
  `faf8f221c168d1547a679a01260fd99fc749ce6b29391330ac61ed7c86e73f37`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.58%.
- Marked-pixel bounds: (50,34)–(212,214); span 163 × 181 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.58%。
- 痕迹范围：(50,34)–(212,214)；跨度163 × 181 px；痕迹矩形近方形。
