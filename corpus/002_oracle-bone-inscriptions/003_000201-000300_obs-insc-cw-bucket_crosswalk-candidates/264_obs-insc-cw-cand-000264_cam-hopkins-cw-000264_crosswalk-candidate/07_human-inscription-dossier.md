...
- Yingguo / 英国所藏: `y1767` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `571` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `415` in source row; primary catalog entry pending
- Heji / 合集: `40830` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000264`
