...
Project ID: `obs-evo-cand-011002`
...
- Project ID: `obs-evo-cand-011002`
- EVOBC category candidate ID: `evobc-evo-cat-11002`
- External category reference: `evobc-cat-11002`
- Source category ID: `11002`
- Source label for human review: `𡐚`
- Source codepoints: `U+2141A`
...
- `obs-evo-cand-011002-route-category-staging`
...
- `obs-evo-cand-011002-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011002-route-evolution-graph`
