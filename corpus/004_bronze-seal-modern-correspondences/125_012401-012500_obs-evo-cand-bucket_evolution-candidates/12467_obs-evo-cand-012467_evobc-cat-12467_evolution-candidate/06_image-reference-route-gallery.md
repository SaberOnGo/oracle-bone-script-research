...
- `obs-evo-cand-012467-route-category-staging`
...
- `obs-evo-cand-012467-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012467-route-evolution-graph`
