# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002734
...
- EVOBC candidate category: `evobc-evo-cat-02734`.
- Source label for search only: `庫`.
- Source codepoints for search only: `U+5EAB`.
