# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006102
...
- Project ID: `obs-evo-cand-006102`.
- EVOBC candidate category: `evobc-evo-cat-06102`.
- Source label for search only: `稛`.
- Source codepoints for search only: `U+7A1B`.
