...
- External category reference: `evobc-cat-09477`
- Source category ID: `09477`
- Source label for human review: `鎕`
...
- `obs-evo-cand-009477-route-category-staging`
...
- `obs-evo-cand-009477-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009477-route-evolution-graph`
