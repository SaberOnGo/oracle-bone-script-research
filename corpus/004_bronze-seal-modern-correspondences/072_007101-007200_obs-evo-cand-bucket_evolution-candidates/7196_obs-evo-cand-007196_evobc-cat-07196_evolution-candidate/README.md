# obs-evo-cand-007196 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-007196`
- EVOBC category candidate ID: `evobc-evo-cat-07196`
- External category ref: `evobc-cat-07196`
- Source label: `舜`
- Source codepoints: `U+821C`
- Image reference count: `53`
- Era token counts: `SS:1;WSC:52`
- Source token counts: `Book:12;Web:41`
