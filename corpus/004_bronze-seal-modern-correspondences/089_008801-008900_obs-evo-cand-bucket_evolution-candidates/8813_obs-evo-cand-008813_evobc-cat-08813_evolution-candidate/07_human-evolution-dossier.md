...
Project ID: `obs-evo-cand-008813`
...
- Project ID: `obs-evo-cand-008813`
- EVOBC category candidate ID: `evobc-evo-cat-08813`
- External category reference: `evobc-cat-08813`
- Source category ID: `08813`
- Source label for human review: `軴`
- Source codepoints: `U+8EF4`
...
- `obs-evo-cand-008813-route-category-staging`
...
- `obs-evo-cand-008813-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008813-route-evolution-graph`
