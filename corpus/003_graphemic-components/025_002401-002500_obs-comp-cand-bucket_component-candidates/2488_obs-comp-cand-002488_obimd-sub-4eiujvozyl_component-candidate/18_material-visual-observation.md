# Material Visual Observation / obs-comp-cand-002488 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002488`
- External reference / 外部参照: `obimd-sub-4eiujvozyl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020708_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4eiujvozyl/4eiujvozyl/4eiujvozyl.png`
- Checksum / 校验和:
  `a36d66b7f6f2defc7adb702b1cf7aeb225a06a526ca56e9a84d79068958d2ef8`
...
- Marked-pixel bounds: (55,40)–(206,215); span 152 × 176 px; the marked
...
- 痕迹范围：(55,40)–(206,215)；跨度152 × 176 px；痕迹矩形近方形。
