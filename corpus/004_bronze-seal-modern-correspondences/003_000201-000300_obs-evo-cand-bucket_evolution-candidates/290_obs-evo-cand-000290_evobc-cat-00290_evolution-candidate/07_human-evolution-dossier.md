...
- External category reference: `evobc-cat-00290`
- Source category ID: `00290`
- Source label for human review: `䅘`
...
- `obs-evo-cand-000290-route-category-staging`
...
- `obs-evo-cand-000290-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000290-route-evolution-graph`
