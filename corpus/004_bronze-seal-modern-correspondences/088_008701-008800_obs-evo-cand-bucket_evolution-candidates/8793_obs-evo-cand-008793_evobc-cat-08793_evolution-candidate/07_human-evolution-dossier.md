...
- External category reference: `evobc-cat-08793`
- Source category ID: `08793`
...
- `obs-evo-cand-008793-route-category-staging`
...
- `obs-evo-cand-008793-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008793-route-evolution-graph`
