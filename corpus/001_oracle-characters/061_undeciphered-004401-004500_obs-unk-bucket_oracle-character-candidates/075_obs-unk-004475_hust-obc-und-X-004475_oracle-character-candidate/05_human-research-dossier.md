# obs-unk-004475 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004475`
- primary external id: `hust-obc-und-X-004475`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/075_obs-unk-004475_h
  ust-obc-und-X-004475_oracle-character-candidate/03_visual-assets/001_asset
  -006068_hust-obc-und-X-004475_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/31/X_？_8209_1.png`
- asset id: `asset-006068`
...
- source class: `HUST-OBC/undeciphered/X/31/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/31/X_？_8209_1.png`
- asset id: `asset-006068`
...
- English observation: Separated fragments include a hooked upper trace, a
  small central opening, and lower vertical forms.
- 中文观察: 分离片段含上部钩状痕迹、中部小开口和下部竖向痕迹。
...
- Which source records identify obs-unk-004475 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004475？
