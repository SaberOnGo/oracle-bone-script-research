# Material Visual Observation / obs-comp-cand-002692 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002692`
- External reference / 外部参照: `obimd-sub-f7v2h4cqc1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021268_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/f7v2h4cqc1/f7v2h4cqc1/f7v2h4cqc1.png`
- Checksum / 校验和:
  `be8a48873733f40076db46f8cfe8fe79a341b78aaefd290228ad67b8bd1861a0`
...
- Marked-pixel bounds: (92,19)–(154,229); span 63 × 211 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.87%。
- 痕迹范围：(92,19)–(154,229)；跨度63 × 211 px；痕迹矩形高于宽。
