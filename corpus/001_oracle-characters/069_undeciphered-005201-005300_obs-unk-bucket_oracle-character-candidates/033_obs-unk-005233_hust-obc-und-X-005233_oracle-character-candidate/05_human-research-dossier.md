# obs-unk-005233 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/069_undeciphered-005
  201-005300_obs-unk-bucket_oracle-character-candidates/033_obs-unk-005233_h
  ust-obc-und-X-005233_oracle-character-candidate/03_visual-assets/001_asset
  -006826_hust-obc-und-X-005233_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/789/X_？_7752_1.png`
- asset id: `asset-006826`
...
- source class: `HUST-OBC/undeciphered/X/789/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/789/X_？_7752_1.png`
- asset id: `asset-006826`
...
- Which source records identify obs-unk-005233 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005233？
