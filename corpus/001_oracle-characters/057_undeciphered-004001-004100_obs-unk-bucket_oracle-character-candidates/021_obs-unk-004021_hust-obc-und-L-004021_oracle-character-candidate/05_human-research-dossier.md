# obs-unk-004021 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004021`
- primary external id: `hust-obc-und-L-004021`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/021_obs-unk-004021_h
  ust-obc-und-L-004021_oracle-character-candidate/03_visual-assets/001_asset
  -005614_hust-obc-und-L-004021_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4021/L_？_8574.jpg`
- asset id: `asset-005614`
...
- source class: `HUST-OBC/undeciphered/L/4021/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4021/L_？_8574.jpg`
- asset id: `asset-005614`
...
- English observation: An angular upper trace crosses a short upright stroke.
  Below it is a compact lower cluster with two slanting side traces and a
  darker central area. The crop does not show the surrounding material.
- 中文观察：上部有折角状痕迹横过短直痕；下方是紧凑的痕迹组合，两侧各有斜向痕迹，
    中央较深。图像未显示周围材料。
...
- Which source records identify obs-unk-004021 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004021？
