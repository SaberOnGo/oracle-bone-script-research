# obs-char-000768 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000768`
- primary external id: `hust-obc-cat-0872`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/768_obs-char-000768_hust-obc-cat-0872_orac
  le-character/03_visual-assets/001_asset-000773_hust-obc-cat-0872_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0872/G_0872_甲骨文.png`
- asset id: `asset-000773`
...
- source category: `0872`
- validation class: `767`
- source image route: `HUST-OBC/deciphered/0872/G_0872_甲骨文.png`
- asset id: `asset-000773`
...
- English observation: `Two adjacent upright structures each carry two
  horizontal crossbars and short upper side marks; their lower stems end in
  spreading diagonal branches.`
- 中文观察: `两个相邻竖向结构各带两条横栏和上部短侧痕，下干末端均伸出外展斜枝。`
...
- dataset label text: `㝞`
- dataset label codepoints: `U+375E`
...
- Which source records identify obs-char-000768 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000768？
