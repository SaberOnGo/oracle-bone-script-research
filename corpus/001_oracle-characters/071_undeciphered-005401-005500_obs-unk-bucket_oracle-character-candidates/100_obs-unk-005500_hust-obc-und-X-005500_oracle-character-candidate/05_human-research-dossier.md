# obs-unk-005500 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005500`
- primary external id: `hust-obc-und-X-005500`
...
- local review image route: `corpus/001_oracle-characters/071_undeciphered-005
  401-005500_obs-unk-bucket_oracle-character-candidates/100_obs-unk-005500_h
  ust-obc-und-X-005500_oracle-character-candidate/03_visual-assets/001_asset
  -007093_hust-obc-und-X-005500_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1056/X_？_8018_1.png`
- asset id: `asset-007093`
...
- source class: `HUST-OBC/undeciphered/X/1056/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1056/X_？_8018_1.png`
- asset id: `asset-007093`
...
- Which source records identify obs-unk-005500 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005500？
