# obs-unk-004690 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004690`
- primary external id: `hust-obc-und-X-004690`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/090_obs-unk-004690_h
  ust-obc-und-X-004690_oracle-character-candidate/03_visual-assets/001_asset
  -006283_hust-obc-und-X-004690_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/246/X_？_8414_1.png`
- asset id: `asset-006283`
...
- source class: `HUST-OBC/undeciphered/X/246/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/246/X_？_8414_1.png`
- asset id: `asset-006283`
...
- English observation: `separated narrow strokes with right curve`
- 中文观察: `带右侧弯曲笔画的分离狭窄笔画组`
...
- Which source records identify obs-unk-004690 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004690？
