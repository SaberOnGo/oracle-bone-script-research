...
- External category reference: `evobc-cat-01328`
- Source category ID: `01328`
- Source label for human review: `匈`
...
- `obs-evo-cand-001328-route-category-staging`
...
- `obs-evo-cand-001328-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001328-route-evolution-graph`
