# obs-evo-cand-002878 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-002878`
- EVOBC category candidate ID: `evobc-evo-cat-02878`
- External category ref: `evobc-cat-02878`
- Source label: `御`
- Source codepoints: `U+5FA1`
- Image reference count: `466`
- Era token counts: `BI:90;CS:1;OBC:250;SAC:16;SS:3;WSC:106`
- Source token counts: `Book:175;Web:291`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 250 image references
- era 1 / BI: 90 image references
- era 2 / SS: 3 image references
- era 3 / SAC: 16 image references
- era 4 / WSC: 106 image references
- era 5 / CS: 1 image references
- source 0 / Web:1633: 8 image references
- source 1 / Web:105952;說文Web:58: 172 image references
- source 2 / Book:17600: 46 image references
- source 3 / Book:21681: 39 image references
- source 4 / Book:9131: 16 image references
- source 5 / Book:32794: 41 image references
- source 6 / Web:30645: 111 image references
- source 7 / Book:9676: 33 image references
