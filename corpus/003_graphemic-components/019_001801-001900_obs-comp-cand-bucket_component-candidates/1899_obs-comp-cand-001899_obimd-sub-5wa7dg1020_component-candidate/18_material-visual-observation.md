# Material Visual Observation / obs-comp-cand-001899 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001899`
- External reference / 外部参照: `obimd-sub-5wa7dg1020`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018309_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5wa7dg1020/5wa7dg1020/5wa7dg1020.png`
- Checksum / 校验和:
  `5141ae4638ee4ecafdab27f22a944afad02943ef92fb310817e8feb87584f811`
...
- Marked-pixel bounds: (62,18)–(178,230); span 117 × 213 px; the marked
...
- 痕迹范围：(62,18)–(178,230)；跨度117 × 213 px；痕迹矩形高于宽。
