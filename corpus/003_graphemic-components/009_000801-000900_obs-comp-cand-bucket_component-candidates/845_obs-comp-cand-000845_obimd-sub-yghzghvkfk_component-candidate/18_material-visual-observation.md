# Material Visual Observation / obs-comp-cand-000845 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000845`
- External reference / 外部参照: `obimd-sub-yghzghvkfk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013716_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xvt1om20u0/yghzghvkfk/yghzghvkfk.png`
- Checksum / 校验和:
  `b9fc3a97285a5302ddd17611512d777c080ec1991d0982e880cd189b7e62f688`
...
- Marked-pixel bounds: (70,19)–(152,229); span 83 × 211 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.72%。
- 痕迹范围：(70,19)–(152,229)；跨度83 × 211 px；痕迹矩形高于宽。
