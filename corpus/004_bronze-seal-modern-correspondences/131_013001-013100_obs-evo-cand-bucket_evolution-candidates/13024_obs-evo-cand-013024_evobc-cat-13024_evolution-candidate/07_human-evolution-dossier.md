...
- Project ID: `obs-evo-cand-013024`
- EVOBC category candidate ID: `evobc-evo-cat-13024`
- External category reference: `evobc-cat-13024`
- Source category ID: `13024`
- Source label for human review: `𫧀`
- Source codepoints: `U+2B9C0`
...
- `obs-evo-cand-013024-route-category-staging`
...
- `obs-evo-cand-013024-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013024-route-evolution-graph`
