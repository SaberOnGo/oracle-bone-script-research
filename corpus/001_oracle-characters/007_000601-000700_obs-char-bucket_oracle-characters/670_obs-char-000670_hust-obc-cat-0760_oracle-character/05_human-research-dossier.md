# obs-char-000670 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000670`
- primary external id: `hust-obc-cat-0760`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/670_obs-char-000670_hust-obc-cat-0760_orac
  le-character/03_visual-assets/001_asset-000675_hust-obc-cat-0760_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0760/G_0760_甲骨文.png`
- asset id: `asset-000675`
...
- source category: `0760`
- validation class: `669`
- source image route: `HUST-OBC/deciphered/0760/G_0760_甲骨文.png`
- asset id: `asset-000675`
...
- English observation: `Two long outward-curving side strokes enclose a
  broad open middle, where several short angular branches cross beneath a
  sharply bent upper-right stroke.`
- 中文观察: `两条长外弯侧笔围出宽开口中部，数条短折角枝在尖折右上笔下方交叉。`
...
- dataset label text: `㛮`
- dataset label codepoints: `U+36EE`
...
- Which source records identify obs-char-000670 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000670？
