...
- Project ID: `obs-evo-cand-010289`
- EVOBC category candidate ID: `evobc-evo-cat-10289`
- External category reference: `evobc-cat-10289`
- Source category ID: `10289`
- Source label for human review: `骫`
- Source codepoints: `U+9AAB`
...
- `obs-evo-cand-010289-route-category-staging`
...
- `obs-evo-cand-010289-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010289-route-evolution-graph`
