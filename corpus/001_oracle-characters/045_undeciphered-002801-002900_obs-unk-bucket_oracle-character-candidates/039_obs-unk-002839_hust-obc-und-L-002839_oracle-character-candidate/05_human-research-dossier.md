# obs-unk-002839 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002839`
- primary external id: `hust-obc-und-L-002839`
...
- local review image route: `corpus/001_oracle-characters/045_undeciphered-002
  801-002900_obs-unk-bucket_oracle-character-candidates/039_obs-unk-002839_h
  ust-obc-und-L-002839_oracle-character-candidate/03_visual-assets/001_asset
  -004432_hust-obc-und-L-002839_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2839/L_？_4751.jpg`
- asset id: `asset-004432`
...
- source class: `HUST-OBC/undeciphered/L/2839/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2839/L_？_4751.jpg`
- asset id: `asset-004432`
...
- Which source records identify obs-unk-002839 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002839？
