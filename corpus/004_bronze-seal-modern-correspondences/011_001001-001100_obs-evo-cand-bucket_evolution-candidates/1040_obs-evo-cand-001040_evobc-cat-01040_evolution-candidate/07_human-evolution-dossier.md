...
- External category reference: `evobc-cat-01040`
- Source category ID: `01040`
- Source label for human review: `儇`
...
- `obs-evo-cand-001040-route-category-staging`
...
- `obs-evo-cand-001040-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001040-route-evolution-graph`
