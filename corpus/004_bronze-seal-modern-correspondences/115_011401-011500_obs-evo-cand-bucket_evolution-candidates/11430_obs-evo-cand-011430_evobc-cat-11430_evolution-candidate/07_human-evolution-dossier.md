...
Project ID: `obs-evo-cand-011430`
...
- Project ID: `obs-evo-cand-011430`
- EVOBC category candidate ID: `evobc-evo-cat-11430`
- External category reference: `evobc-cat-11430`
- Source category ID: `11430`
- Source label for human review: `𣐇`
- Source codepoints: `U+23407`
...
- `obs-evo-cand-011430-route-category-staging`
...
- `obs-evo-cand-011430-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011430-route-evolution-graph`
