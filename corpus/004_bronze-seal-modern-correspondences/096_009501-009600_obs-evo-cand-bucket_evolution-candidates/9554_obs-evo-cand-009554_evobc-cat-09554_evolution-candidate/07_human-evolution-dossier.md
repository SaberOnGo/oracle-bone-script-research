...
Project ID: `obs-evo-cand-009554`
...
- Project ID: `obs-evo-cand-009554`
- EVOBC category candidate ID: `evobc-evo-cat-09554`
- External category reference: `evobc-cat-09554`
- Source category ID: `09554`
- Source label for human review: `鑯`
- Source codepoints: `U+946F`
...
- `obs-evo-cand-009554-route-category-staging`
...
- `obs-evo-cand-009554-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009554-route-evolution-graph`
