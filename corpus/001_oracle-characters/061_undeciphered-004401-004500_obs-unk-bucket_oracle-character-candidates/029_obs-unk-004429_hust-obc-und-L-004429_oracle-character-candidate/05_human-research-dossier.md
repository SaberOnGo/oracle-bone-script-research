# obs-unk-004429 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/029_obs-unk-004429_h
  ust-obc-und-L-004429_oracle-character-candidate/03_visual-assets/001_asset
  -006022_hust-obc-und-L-004429_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4429/L_？_9928.jpg`
- asset id: `asset-006022`
...
- source class: `HUST-OBC/undeciphered/L/4429/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4429/L_？_9928.jpg`
- asset id: `asset-006022`
...
- English observation: `An upper crossbar meets a central trace above`
  `a darker lower outline.`
- 中文观察: `上部横线与中央痕迹相交，位于较深的下部轮廓之上。`
...
- Which source records identify obs-unk-004429 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004429？
