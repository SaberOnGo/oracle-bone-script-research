# obs-char-000565 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/565_obs-char-000565_hust-obc-cat-0641_orac
  le-character/03_visual-assets/001_asset-000570_hust-obc-cat-0641_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0641/G_0641_續5.5.3(甲).png`
- asset id: `asset-000570`
...
- source category: `0641`
- validation class: `564`
- source image route: `HUST-OBC/deciphered/0641/G_0641_續5.5.3(甲).png`
- asset id: `asset-000570`
...
- English observation: `A small rectangular upper loop sits between two
  outward angular branches, from which two long slightly curving side
  strokes descend.`
...
- dataset label text: `㙷`
- dataset label codepoints: `U+3677`
...
- Which source records identify obs-char-000565 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000565？
