...
- External category reference: `evobc-cat-10324`
- Source category ID: `10324`
- Source label for human review: `鬄`
...
- `obs-evo-cand-010324-route-category-staging`
...
- `obs-evo-cand-010324-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010324-route-evolution-graph`
