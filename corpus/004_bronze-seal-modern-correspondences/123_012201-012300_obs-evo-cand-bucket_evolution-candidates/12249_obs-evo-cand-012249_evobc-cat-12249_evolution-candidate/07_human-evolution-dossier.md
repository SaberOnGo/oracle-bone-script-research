...
Project ID: `obs-evo-cand-012249`
...
- Project ID: `obs-evo-cand-012249`
- EVOBC category candidate ID: `evobc-evo-cat-12249`
- External category reference: `evobc-cat-12249`
- Source category ID: `12249`
- Source label for human review: `𧬁`
- Source codepoints: `U+27B01`
...
- `obs-evo-cand-012249-route-category-staging`
...
- `obs-evo-cand-012249-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012249-route-evolution-graph`
