...
Project ID: `obs-evo-cand-001859`
...
- Project ID: `obs-evo-cand-001859`
- EVOBC category candidate ID: `evobc-evo-cat-01859`
- External category reference: `evobc-cat-01859`
- Source category ID: `01859`
- Source label for human review: `垢`
- Source codepoints: `U+57A2`
...
- `obs-evo-cand-001859-route-category-staging`
...
- `obs-evo-cand-001859-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001859-route-evolution-graph`
