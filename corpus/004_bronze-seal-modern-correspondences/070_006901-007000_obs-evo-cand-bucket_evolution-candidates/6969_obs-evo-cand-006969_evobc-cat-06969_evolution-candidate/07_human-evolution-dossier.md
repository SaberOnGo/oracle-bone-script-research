...
- External category reference: `evobc-cat-06969`
- Source category ID: `06969`
- Source label for human review: `肁`
- Source codepoints: `U+8081`
...
- `obs-evo-cand-006969-route-category-staging`
...
- `obs-evo-cand-006969-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006969-route-evolution-graph`
