# Material Visual Observation / obs-comp-cand-001055 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001055`
- External reference / 外部参照: `obimd-sub-jcsf6ohzo1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014605_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jcsf6ohzo1/jcsf6ohzo1/jcsf6ohzo1.png`
- Checksum / 校验和:
  `39759c91d0dfe7ef18f3f8d2e71c0b6d92dc7f376bb7d004d09458f52fce14d6`
...
- Marked-pixel bounds: (83,18)–(146,228); span 64 × 211 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.52%。
- 痕迹范围：(83,18)–(146,228)；跨度64 × 211 px；痕迹矩形高于宽。
