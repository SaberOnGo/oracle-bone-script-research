# obs-char-001472 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001472`
- primary external id: `hust-obc-cat-1652_1653`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1472_obs-char-001472_hust-obc-cat-1652_165
  3_oracle-character/03_visual-assets/001_asset-001477_hust-obc-cat-1652_165
  3_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1652_1653/1652/G_1652_乙5161合142
  95無名組.png`
- asset id: `asset-001477`
...
- source category: `1652_1653`
- validation class: `1471`
- source image route: `HUST-OBC/deciphered/1652_1653/1652/G_1652_乙5161合14295無名
  組.png`
- asset id: `asset-001477`
...
- English observation: `A rounded upper enclosure leads into a long diagonal
  lower stem.`
- 中文观察: `圆拱上部框形连接长下部斜向竖干。`
...
- dataset label text: `㩪㩫`
- dataset label codepoints: `U+3A6A;U+3A6B`
...
- graph edge count: `2`
- codepoint routes: `U+3A6A;U+3A6B`
...
- filename catalog route clues: `Heji-like filename clue: 合14295
  (G_1652_乙5161合14295無名組.png)`
...
- Which source records identify obs-char-001472 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001472？
