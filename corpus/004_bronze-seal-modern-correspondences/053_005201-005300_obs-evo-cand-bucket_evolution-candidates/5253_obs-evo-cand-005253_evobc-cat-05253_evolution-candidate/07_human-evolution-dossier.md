...
- Project ID: `obs-evo-cand-005253`
- EVOBC category candidate ID: `evobc-evo-cat-05253`
- External category reference: `evobc-cat-05253`
- Source category ID: `05253`
- Source label for human review: `犺`
- Source codepoints: `U+72BA`
...
- `obs-evo-cand-005253-route-category-staging`
...
- `obs-evo-cand-005253-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005253-route-evolution-graph`
