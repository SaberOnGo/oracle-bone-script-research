...
- `obs-evo-cand-010789-route-category-staging`
...
- `obs-evo-cand-010789-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010789-route-evolution-graph`
