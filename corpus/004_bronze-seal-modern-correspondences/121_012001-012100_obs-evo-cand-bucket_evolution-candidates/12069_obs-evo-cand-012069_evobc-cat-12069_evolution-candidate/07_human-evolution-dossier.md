...
- External category reference: `evobc-cat-12069`
- Source category ID: `12069`
- Source label for human review: `𦤅`
...
- `obs-evo-cand-012069-route-category-staging`
...
- `obs-evo-cand-012069-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012069-route-evolution-graph`
