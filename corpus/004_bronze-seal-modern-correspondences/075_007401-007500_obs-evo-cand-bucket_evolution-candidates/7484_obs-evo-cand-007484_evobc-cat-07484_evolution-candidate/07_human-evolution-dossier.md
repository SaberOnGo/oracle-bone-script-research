...
- External category reference: `evobc-cat-07484`
- Source category ID: `07484`
- Source label for human review: `葴`
...
- `obs-evo-cand-007484-route-category-staging`
...
- `obs-evo-cand-007484-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007484-route-evolution-graph`
