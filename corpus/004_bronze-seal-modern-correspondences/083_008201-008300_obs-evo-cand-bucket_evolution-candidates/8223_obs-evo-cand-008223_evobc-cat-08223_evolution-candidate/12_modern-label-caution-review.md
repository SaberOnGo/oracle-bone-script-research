# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008223
...
- EVOBC candidate category: `evobc-evo-cat-08223`.
- Source label for search only: `誎`.
- Source codepoints for search only: `U+8A8E`.
