...
Project ID: `obs-evo-cand-007432`
...
- Project ID: `obs-evo-cand-007432`
- EVOBC category candidate ID: `evobc-evo-cat-07432`
- External category reference: `evobc-cat-07432`
- Source category ID: `07432`
- Source label for human review: `萁`
- Source codepoints: `U+8401`
...
- `obs-evo-cand-007432-route-category-staging`
...
- `obs-evo-cand-007432-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007432-route-evolution-graph`
