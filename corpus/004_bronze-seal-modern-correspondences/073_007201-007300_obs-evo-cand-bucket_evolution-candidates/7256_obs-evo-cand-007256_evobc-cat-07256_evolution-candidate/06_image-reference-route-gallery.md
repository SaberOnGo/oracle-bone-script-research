...
- `obs-evo-cand-007256-route-category-staging`
...
- `obs-evo-cand-007256-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007256-route-evolution-graph`
