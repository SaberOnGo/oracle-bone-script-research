# Material Visual Observation / obs-comp-cand-001195 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001195`
- External reference / 外部参照: `obimd-sub-wii7x103u0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015385_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5wxvkutef7/wii7x103u0/wii7x103u0.png`
- Checksum / 校验和:
  `c5091a3d70b0b230599b355dbc5bf55846886482159bf894665f8957aced6ff6`
...
- Marked-pixel bounds: (93,21)–(190,224); span 98 × 204 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.50%。
- 痕迹范围：(93,21)–(190,224)；跨度98 × 204 px；痕迹矩形高于宽。
