...
- External category reference: `evobc-cat-08751`
- Source category ID: `08751`
- Source label for human review: `蹈`
...
- `obs-evo-cand-008751-route-category-staging`
...
- `obs-evo-cand-008751-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008751-route-evolution-graph`
