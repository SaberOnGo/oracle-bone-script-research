# obs-evo-cand-000161 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-000161`
- EVOBC category candidate ID: `evobc-evo-cat-00161`
- External category ref: `evobc-cat-00161`
- Source label: `㬎`
- Source codepoints: `U+3B0E`
- Image reference count: `14`
- Era token counts: `SAC:4;WSC:10`
- Source token counts: `Book:14`
