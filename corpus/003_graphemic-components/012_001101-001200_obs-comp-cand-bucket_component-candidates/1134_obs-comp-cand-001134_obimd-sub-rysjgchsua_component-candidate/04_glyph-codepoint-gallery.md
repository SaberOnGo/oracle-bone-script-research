# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001134
...
| --- | --- | --- | --- |
| `obimd-glyph-link-016927` | 򩦛󶠘 | `U+A999B;U+F6818` | `reviewed_metadata_only` |
| `obimd-glyph-link-016928` | 󶠙 | `U+F6819` | `reviewed_metadata_only` |
