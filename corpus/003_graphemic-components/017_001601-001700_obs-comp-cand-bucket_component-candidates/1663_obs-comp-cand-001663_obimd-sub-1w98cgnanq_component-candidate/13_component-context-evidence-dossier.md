# obs-comp-cand-001663 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001663`
- 首选外部 ID: `obimd-sub-1w98cgnanq`
- OBIMD subcharacter UID: `1w98cgnanq`
- OBIMD main character UID: `1w98cgnanq`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+A9868;U+F9A2A; U+F9A2B
