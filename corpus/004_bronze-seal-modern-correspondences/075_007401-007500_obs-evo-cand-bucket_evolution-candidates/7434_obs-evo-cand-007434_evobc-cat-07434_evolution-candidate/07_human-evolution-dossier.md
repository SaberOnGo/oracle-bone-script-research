...
- External category reference: `evobc-cat-07434`
- Source category ID: `07434`
- Source label for human review: `萄`
- Source codepoints: `U+8404`
...
- `obs-evo-cand-007434-route-category-staging`
...
- `obs-evo-cand-007434-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007434-route-evolution-graph`
