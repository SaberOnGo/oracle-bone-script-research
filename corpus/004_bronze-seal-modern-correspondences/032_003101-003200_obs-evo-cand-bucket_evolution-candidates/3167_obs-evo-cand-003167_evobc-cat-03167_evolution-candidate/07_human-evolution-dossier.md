...
- External category reference: `evobc-cat-03167`
- Source category ID: `03167`
- Source label for human review: `憺`
...
- `obs-evo-cand-003167-route-category-staging`
...
- `obs-evo-cand-003167-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003167-route-evolution-graph`
