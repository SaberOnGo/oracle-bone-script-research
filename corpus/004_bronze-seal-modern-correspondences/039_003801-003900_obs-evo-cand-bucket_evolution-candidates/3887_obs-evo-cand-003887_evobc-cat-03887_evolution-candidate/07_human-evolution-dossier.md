...
Project ID: `obs-evo-cand-003887`
...
- Project ID: `obs-evo-cand-003887`
- EVOBC category candidate ID: `evobc-evo-cat-03887`
- External category reference: `evobc-cat-03887`
- Source category ID: `03887`
- Source label for human review: `杞`
- Source codepoints: `U+675E`
...
- `obs-evo-cand-003887-route-category-staging`
...
- `obs-evo-cand-003887-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003887-route-evolution-graph`
