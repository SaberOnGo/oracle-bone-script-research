...
Project ID: `obs-insc-cw-cand-000492`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000492`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000492` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2415` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `65` [route_present_image_or_text_not_collected]
