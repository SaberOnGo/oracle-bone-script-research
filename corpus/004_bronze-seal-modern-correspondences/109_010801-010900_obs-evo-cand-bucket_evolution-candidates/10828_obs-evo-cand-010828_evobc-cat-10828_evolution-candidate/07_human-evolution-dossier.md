...
- External category reference: `evobc-cat-10828`
- Source category ID: `10828`
- Source label for human review: `𠑹`
- Source codepoints: `U+20479`
- Image reference count in source metadata: `26`
...
- `obs-evo-cand-010828-route-category-staging`
...
- `obs-evo-cand-010828-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010828-route-evolution-graph`
