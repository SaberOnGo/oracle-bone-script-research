# obs-unk-004314 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/014_obs-unk-004314_h
  ust-obc-und-L-004314_oracle-character-candidate/03_visual-assets/001_asset
  -005907_hust-obc-und-L-004314_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4314/L_？_9511.jpg`
- asset id: `asset-005907`
...
- source class: `HUST-OBC/undeciphered/L/4314/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4314/L_？_9511.jpg`
- asset id: `asset-005907`
...
- English observation: `Tall crop has separated upper, middle, and
  lower marks; record is neutral.`
- 中文观察: `狭长裁切图的上中下痕迹已记录，记录保持中性。`
...
- Which source records identify obs-unk-004314 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004314？
