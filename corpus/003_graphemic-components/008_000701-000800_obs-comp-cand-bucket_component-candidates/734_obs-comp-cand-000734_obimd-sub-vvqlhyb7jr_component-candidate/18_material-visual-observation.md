# Material Visual Observation / obs-comp-cand-000734 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000734`
- External reference / 外部参照: `obimd-sub-vvqlhyb7jr`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013461_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vvqlhyb7jr/vvqlhyb7jr/vvqlhyb7jr.png`
- Checksum / 校验和:
  `99838f4515f2cd87bb98b58767c65f5af9389173ceb4e4d714557fa023e2c293`
...
- Marked-pixel bounds: (83,27)–(165,225); span 83 × 199 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.47%。
- 痕迹范围：(83,27)–(165,225)；跨度83 × 199 px；痕迹矩形高于宽。
