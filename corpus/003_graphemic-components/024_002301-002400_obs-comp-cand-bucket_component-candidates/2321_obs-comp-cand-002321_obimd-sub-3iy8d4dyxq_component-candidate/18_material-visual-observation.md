# Material Visual Observation / obs-comp-cand-002321 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002321`
- External reference / 外部参照: `obimd-sub-3iy8d4dyxq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020340_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3iy8d4dyxq/3iy8d4dyxq/3iy8d4dyxq.png`
- Checksum / 校验和:
  `1251f9f99f67ee55afe120306f463677f3e5d76675ddc7889f7c53c8d38b5021`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.76%.
- Marked-pixel bounds: (87,11)–(191,235); span 105 × 225 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.76%。
- 痕迹范围：(87,11)–(191,235)；跨度105 × 225 px；痕迹矩形高于宽。
