...
- Project ID: `obs-evo-cand-013615`
- EVOBC category candidate ID: `evobc-evo-cat-13615`
- External category reference: `evobc-cat-13615`
- Source category ID: `13615`
- Source label for human review: `𮊴`
- Source codepoints: `U+2E2B4`
...
- `obs-evo-cand-013615-route-category-staging`
...
- `obs-evo-cand-013615-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013615-route-evolution-graph`
