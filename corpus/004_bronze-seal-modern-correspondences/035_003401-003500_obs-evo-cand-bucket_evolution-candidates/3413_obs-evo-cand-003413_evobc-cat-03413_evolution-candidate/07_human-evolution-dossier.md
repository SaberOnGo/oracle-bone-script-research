...
Project ID: `obs-evo-cand-003413`
...
- Project ID: `obs-evo-cand-003413`
- EVOBC category candidate ID: `evobc-evo-cat-03413`
- External category reference: `evobc-cat-03413`
- Source category ID: `03413`
- Source label for human review: `控`
- Source codepoints: `U+63A7`
...
- `obs-evo-cand-003413-route-category-staging`
...
- `obs-evo-cand-003413-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003413-route-evolution-graph`
