# obs-char-001128 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001128`
- primary external id: `hust-obc-cat-1259`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1128_obs-char-001128_hust-obc-cat-1259_ora
  cle-character/03_visual-assets/001_asset-001133_hust-obc-cat-1259_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1259/G_1259_七S127合7006.png`
- asset id: `asset-001133`
...
- source category: `1259`
- validation class: `1127`
- source image route: `HUST-OBC/deciphered/1259/G_1259_七S127合7006.png`
- asset id: `asset-001133`
...
- English observation: `Three separated angular clusters are visible, with
  two upper forms and a smaller pointed lower form.`
- 中文观察: `可见三个分离的棱角笔群，其中有两个上部形体和一个较小的尖状下部形体。`
...
- dataset label text: `㣡`
- dataset label codepoints: `U+38E1`
...
- filename catalog route clues: `Heji-like filename clue: 合7006
  (G_1259_七S127合7006.png)`
...
- Which source records identify obs-char-001128 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001128？
