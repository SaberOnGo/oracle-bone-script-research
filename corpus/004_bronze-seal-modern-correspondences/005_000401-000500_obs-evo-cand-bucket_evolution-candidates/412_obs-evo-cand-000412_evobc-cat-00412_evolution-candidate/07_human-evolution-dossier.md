...
- Project ID: `obs-evo-cand-000412`
- EVOBC category candidate ID: `evobc-evo-cat-00412`
- External category reference: `evobc-cat-00412`
- Source category ID: `00412`
- Source label for human review: `䙚`
- Source codepoints: `U+465A`
...
- `obs-evo-cand-000412-route-category-staging`
...
- `obs-evo-cand-000412-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000412-route-evolution-graph`
