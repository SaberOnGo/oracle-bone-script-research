...
- External category reference: `evobc-cat-00945`
- Source category ID: `00945`
- Source label for human review: `倾`
- Source codepoints: `U+503E`
...
- `obs-evo-cand-000945-route-category-staging`
...
- `obs-evo-cand-000945-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000945-route-evolution-graph`
