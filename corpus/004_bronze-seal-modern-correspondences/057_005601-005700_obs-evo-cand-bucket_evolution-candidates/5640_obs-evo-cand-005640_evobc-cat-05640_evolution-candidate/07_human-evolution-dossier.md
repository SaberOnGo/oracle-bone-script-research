...
- External category reference: `evobc-cat-05640`
- Source category ID: `05640`
- Source label for human review: `痒`
- Source codepoints: `U+75D2`
...
- `obs-evo-cand-005640-route-category-staging`
...
- `obs-evo-cand-005640-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005640-route-evolution-graph`
