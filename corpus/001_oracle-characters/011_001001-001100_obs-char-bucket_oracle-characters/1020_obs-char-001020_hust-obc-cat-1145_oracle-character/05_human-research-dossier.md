# obs-char-001020 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001020`
- primary external id: `hust-obc-cat-1145`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1020_obs-char-001020_hust-obc-cat-1145_ora
  cle-character/03_visual-assets/001_asset-001025_hust-obc-cat-1145_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1145/G_1145_京津2082合3198.png`
- asset id: `asset-001025`
...
- source category: `1145`
- validation class: `1019`
- source image route: `HUST-OBC/deciphered/1145/G_1145_京津2082合3198.png`
- asset id: `asset-001025`
...
- English observation: `An angular upper branch bends over a small elongated
  lower loop, with a long descending stroke between them.`
- 中文观察: `棱角上部分枝弯折于小型狭长下部环笔之上，两者之间有长下行笔。`
...
- dataset label text: `㡯`
- dataset label codepoints: `U+386F`
...
- filename catalog route clues: `Heji-like filename clue: 合3198
  (G_1145_京津2082合3198.png)`
...
- Which source records identify obs-char-001020 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001020？
