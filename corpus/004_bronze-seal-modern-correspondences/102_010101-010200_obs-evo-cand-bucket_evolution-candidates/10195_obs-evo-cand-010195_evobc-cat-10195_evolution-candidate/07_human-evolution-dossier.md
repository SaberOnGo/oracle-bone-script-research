...
- External category reference: `evobc-cat-10195`
- Source category ID: `10195`
- Source label for human review: `駧`
- Source codepoints: `U+99E7`
...
- `obs-evo-cand-010195-route-category-staging`
...
- `obs-evo-cand-010195-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010195-route-evolution-graph`
