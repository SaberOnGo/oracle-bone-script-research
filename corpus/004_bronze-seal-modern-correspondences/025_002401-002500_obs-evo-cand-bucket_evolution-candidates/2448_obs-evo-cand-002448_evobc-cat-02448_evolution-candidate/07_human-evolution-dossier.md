...
- External category reference: `evobc-cat-02448`
- Source category ID: `02448`
- Source label for human review: `寸`
...
- `obs-evo-cand-002448-route-category-staging`
...
- `obs-evo-cand-002448-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002448-route-evolution-graph`
