...
Project ID: `obs-evo-cand-003459`
...
- Project ID: `obs-evo-cand-003459`
- EVOBC category candidate ID: `evobc-evo-cat-03459`
- External category reference: `evobc-cat-03459`
- Source category ID: `03459`
- Source label for human review: `搥`
- Source codepoints: `U+6425`
...
- `obs-evo-cand-003459-route-category-staging`
...
- `obs-evo-cand-003459-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003459-route-evolution-graph`
