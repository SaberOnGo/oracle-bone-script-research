...
- External category reference: `evobc-cat-02253`
- Source category ID: `02253`
- Source label for human review: `嫁`
- Source codepoints: `U+5AC1`
...
- `obs-evo-cand-002253-route-category-staging`
...
- `obs-evo-cand-002253-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002253-route-evolution-graph`
