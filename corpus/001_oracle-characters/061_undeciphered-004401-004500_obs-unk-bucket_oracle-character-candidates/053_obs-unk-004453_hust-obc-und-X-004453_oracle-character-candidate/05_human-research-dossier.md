# obs-unk-004453 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004453`
- primary external id: `hust-obc-und-X-004453`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/053_obs-unk-004453_h
  ust-obc-und-X-004453_oracle-character-candidate/03_visual-assets/001_asset
  -006046_hust-obc-und-X-004453_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/9/X_？_8188_1.png`
- asset id: `asset-006046`
...
- source class: `HUST-OBC/undeciphered/X/9/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/9/X_？_8188_1.png`
- asset id: `asset-006046`
...
- English observation: `A tall central junction spans a broad arch and`
  `lower crossing.`
- 中文观察: `高的中央连接处横跨宽弧形轮廓和下部交叉处。`
...
- Which source records identify obs-unk-004453 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004453？
