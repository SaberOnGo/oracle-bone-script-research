# Material Visual Observation / obs-comp-cand-001489 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001489`
- External reference / 外部参照: `obimd-sub-34yhwco17n`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016066_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/34yhwco17n/34yhwco17n/04albq47zi.png`
- Checksum / 校验和:
  `e581102c227346527f45ae24ef184e8f18a4b46a4a9825e7a0feed7dd1d9ffcd`
...
- Marked-pixel bounds: (80,38)–(168,211); span 89 × 174 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.09%。
- 痕迹范围：(80,38)–(168,211)；跨度89 × 174 px；痕迹矩形高于宽。
