# obs-char-000037 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/037_obs-char-000037_hust-obc-cat-0043_orac
  le-character/03_visual-assets/001_asset-000042_hust-obc-cat-0043_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0043/H_0043_6177A_0.png`
- asset id: `asset-000042`
...
- source category: `0043`
- validation class: `36`
- source image route: `HUST-OBC/deciphered/0043/H_0043_6177A_0.png`
- asset id: `asset-000042`
...
- English observation: `Two stacked forms are visible, each with a
  horizontal upper stroke, a right-side hooked descent, and a slanted lower
  edge.`
...
- dataset label text: `㐡`
- dataset label codepoints: `U+3421`
...
- filename catalog route clues: `catalog-like filename clue: H_0043
  (H_0043_6177A_0.png)`
...
- Which source records identify obs-char-000037 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000037？
