...
- Project ID: `obs-evo-cand-007118`
- EVOBC category candidate ID: `evobc-evo-cat-07118`
- External category reference: `evobc-cat-07118`
- Source category ID: `07118`
- Source label for human review: `膊`
- Source codepoints: `U+818A`
...
- `obs-evo-cand-007118-route-category-staging`
...
- `obs-evo-cand-007118-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007118-route-evolution-graph`
