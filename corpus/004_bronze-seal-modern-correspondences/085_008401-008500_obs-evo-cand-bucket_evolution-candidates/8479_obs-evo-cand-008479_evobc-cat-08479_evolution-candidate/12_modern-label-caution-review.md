# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008479
...
- EVOBC candidate category: `evobc-evo-cat-08479`.
- Source label for search only: `豊`.
- Source codepoints for search only: `U+8C4A`.
