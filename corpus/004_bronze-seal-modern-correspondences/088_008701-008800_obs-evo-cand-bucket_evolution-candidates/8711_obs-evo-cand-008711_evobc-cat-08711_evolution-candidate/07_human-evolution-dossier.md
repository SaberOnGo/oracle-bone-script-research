...
Project ID: `obs-evo-cand-008711`
...
- Project ID: `obs-evo-cand-008711`
- EVOBC category candidate ID: `evobc-evo-cat-08711`
- External category reference: `evobc-cat-08711`
- Source category ID: `08711`
- Source label for human review: `跔`
- Source codepoints: `U+8DD4`
...
- `obs-evo-cand-008711-route-category-staging`
...
- `obs-evo-cand-008711-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008711-route-evolution-graph`
