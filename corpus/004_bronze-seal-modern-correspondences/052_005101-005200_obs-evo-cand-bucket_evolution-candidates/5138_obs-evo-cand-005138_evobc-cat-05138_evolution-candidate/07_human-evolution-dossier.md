...
Project ID: `obs-evo-cand-005138`
...
- Project ID: `obs-evo-cand-005138`
- EVOBC category candidate ID: `evobc-evo-cat-05138`
- External category reference: `evobc-cat-05138`
- Source category ID: `05138`
- Source label for human review: `熱`
- Source codepoints: `U+71B1`
...
- `obs-evo-cand-005138-route-category-staging`
...
- `obs-evo-cand-005138-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005138-route-evolution-graph`
