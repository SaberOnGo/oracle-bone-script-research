...
- External category reference: `evobc-cat-03950`
- Source category ID: `03950`
- Source label for human review: `柉`
...
- `obs-evo-cand-003950-route-category-staging`
...
- `obs-evo-cand-003950-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003950-route-evolution-graph`
