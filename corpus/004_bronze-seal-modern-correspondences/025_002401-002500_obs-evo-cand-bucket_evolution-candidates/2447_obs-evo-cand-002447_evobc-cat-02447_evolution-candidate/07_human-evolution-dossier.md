...
- External category reference: `evobc-cat-02447`
- Source category ID: `02447`
- Source label for human review: `寷`
- Source codepoints: `U+5BF7`
...
- `obs-evo-cand-002447-route-category-staging`
...
- `obs-evo-cand-002447-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002447-route-evolution-graph`
