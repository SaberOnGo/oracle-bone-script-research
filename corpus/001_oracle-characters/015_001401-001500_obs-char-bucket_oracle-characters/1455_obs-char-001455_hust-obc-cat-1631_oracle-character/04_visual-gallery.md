# obs-char-001455 Visual Gallery / obs-char-001455 图像资料页
...
- Project ID / 项目 ID: `obs-char-001455`
- Primary external reference / 首选外部参考: `hust-obc-cat-1631`
...
## obs-char-001455-visual-source-001 / 图像条目

![obs-char-001455 glyph candidate](03_visual-assets/001_asset-001460_hust-obc-cat-1631_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-001460_hust-obc-cat-1631_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-001460_hust-obc-cat-1631_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/1631/X_1631_5285_1.png`
