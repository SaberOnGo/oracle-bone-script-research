...
- External category reference: `evobc-cat-00539`
- Source category ID: `00539`
- Source label for human review: `䩤`
- Source codepoints: `U+4A64`
...
- `obs-evo-cand-000539-route-category-staging`
...
- `obs-evo-cand-000539-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000539-route-evolution-graph`
