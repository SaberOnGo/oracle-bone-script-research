...
- External category reference: `evobc-cat-00048`
- Source category ID: `00048`
- Source label for human review: `㚵`
- Source codepoints: `U+36B5`
...
- `obs-evo-cand-000048-route-category-staging`
...
- `obs-evo-cand-000048-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000048-route-evolution-graph`
