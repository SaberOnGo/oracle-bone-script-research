# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-005946
...
- EVOBC candidate category: `evobc-evo-cat-05946`.
- Source label for search only: `磬`.
- Source codepoints for search only: `U+78EC`.
