...
Project ID: `obs-evo-cand-007775`
...
- Project ID: `obs-evo-cand-007775`
- EVOBC category candidate ID: `evobc-evo-cat-07775`
- External category reference: `evobc-cat-07775`
- Source category ID: `07775`
- Source label for human review: `蜎`
- Source codepoints: `U+870E`
...
- `obs-evo-cand-007775-route-category-staging`
...
- `obs-evo-cand-007775-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007775-route-evolution-graph`
