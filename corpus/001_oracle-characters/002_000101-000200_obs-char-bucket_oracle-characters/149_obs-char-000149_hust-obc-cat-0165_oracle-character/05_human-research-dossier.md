# obs-char-000149 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000149`
- primary external id: `hust-obc-cat-0165`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/149_obs-char-000149_hust-obc-cat-0165_orac
  le-character/03_visual-assets/001_asset-000154_hust-obc-cat-0165_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0165/G_0165_明422合21774子組.png`
- asset id: `asset-000154`
...
- source category: `0165`
- validation class: `148`
- source image route: `HUST-OBC/deciphered/0165/G_0165_明422合21774子組.png`
- asset id: `asset-000154`
...
- English observation: `The image combines a long curved stroke on the left
  with a compact upper enclosure and a narrow descending stroke on the
  right.`
- 中文观察: `图像左侧有长弯曲笔，右侧上方有紧凑围合形，并有窄下行笔向下延伸。`
...
- dataset label text: `㒛`
- dataset label codepoints: `U+349B`
...
- filename catalog route clues: `Heji-like filename clue: 合21774
  (G_0165_明422合21774子組.png)`
...
- Which source records identify obs-char-000149 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000149？
