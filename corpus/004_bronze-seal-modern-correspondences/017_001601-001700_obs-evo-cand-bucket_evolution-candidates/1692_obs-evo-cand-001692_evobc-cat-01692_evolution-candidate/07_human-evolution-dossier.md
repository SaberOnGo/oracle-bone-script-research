...
Project ID: `obs-evo-cand-001692`
...
- Project ID: `obs-evo-cand-001692`
- EVOBC category candidate ID: `evobc-evo-cat-01692`
- External category reference: `evobc-cat-01692`
- Source category ID: `01692`
- Source label for human review: `嘌`
- Source codepoints: `U+560C`
...
- `obs-evo-cand-001692-route-category-staging`
...
- `obs-evo-cand-001692-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001692-route-evolution-graph`
