# obs-comp-cand-001008 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001008`
- 首选外部 ID: `obimd-sub-sjo5wujrih`
- OBIMD subcharacter UID: `sjo5wujrih`
- OBIMD main character UID: `sjo5wujrih`
- 来源 ID: `src-obimd`
