# Material Visual Observation / obs-comp-cand-000770 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000770`
- External reference / 外部参照: `obimd-sub-ruzzbnlub4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013533_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lv32d9tz8g/ruzzbnlub4/ruzzbnlub4.png`
- Checksum / 校验和:
  `1a0903b210a6485a3648cd0064d8d0fece750c12b072bcdb53487a54a525d66a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.87%.
- Marked-pixel bounds: (83,20)–(166,230); span 84 × 211 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.87%。
- 痕迹范围：(83,20)–(166,230)；跨度84 × 211 px；痕迹矩形高于宽。
