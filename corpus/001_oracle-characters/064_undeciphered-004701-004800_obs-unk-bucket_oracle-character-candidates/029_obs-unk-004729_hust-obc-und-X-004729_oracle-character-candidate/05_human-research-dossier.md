# obs-unk-004729 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/029_obs-unk-004729_h
  ust-obc-und-X-004729_oracle-character-candidate/03_visual-assets/001_asset
  -006322_hust-obc-und-X-004729_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/285/X_？_7264_1.png`
- asset id: `asset-006322`
...
- source class: `HUST-OBC/undeciphered/X/285/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/285/X_？_7264_1.png`
- asset id: `asset-006322`
...
- English observation: `upper detached strokes with lower branches`
- 中文观察: `带下部分支的上部分离笔画组`
...
- Which source records identify obs-unk-004729 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004729？
