# obs-unk-002923 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002923`
- primary external id: `hust-obc-und-L-002923`
...
- local review image route: `corpus/001_oracle-characters/046_undeciphered-002
  901-003000_obs-unk-bucket_oracle-character-candidates/023_obs-unk-002923_h
  ust-obc-und-L-002923_oracle-character-candidate/03_visual-assets/001_asset
  -004516_hust-obc-und-L-002923_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2923/L_？_5046.jpg`
- asset id: `asset-004516`
...
- source class: `HUST-OBC/undeciphered/L/2923/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2923/L_？_5046.jpg`
- asset id: `asset-004516`
...
- Which source records identify obs-unk-002923 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002923？
