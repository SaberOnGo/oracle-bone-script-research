# obs-char-001535 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1535_obs-char-001535_hust-obc-cat-1721_ora
  cle-character/03_visual-assets/001_asset-001540_hust-obc-cat-1721_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1721/L_1721_1131.jpg`
- asset id: `asset-001540`
...
- source category: `1721`
- validation class: `1534`
- source image route: `HUST-OBC/deciphered/1721/L_1721_1131.jpg`
- asset id: `asset-001540`
...
- English observation: `A very faint small form preserves a central stroke
  with short branching side marks.`
- 中文观察: `极浅淡的小型形体保留中央笔画和短分枝侧部标记。`
...
- dataset label text: `㪯`
- dataset label codepoints: `U+3AAF`
...
- Which source records identify obs-char-001535 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001535？
