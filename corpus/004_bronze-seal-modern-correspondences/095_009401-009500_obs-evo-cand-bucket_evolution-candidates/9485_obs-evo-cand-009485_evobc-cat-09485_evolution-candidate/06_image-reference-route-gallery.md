...
- `obs-evo-cand-009485-route-category-staging`
...
- `obs-evo-cand-009485-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009485-route-evolution-graph`
