...
- External category reference: `evobc-cat-12702`
- Source category ID: `12702`
- Source label for human review: `𩷬`
- Source codepoints: `U+29DEC`
...
- `obs-evo-cand-012702-route-category-staging`
...
- `obs-evo-cand-012702-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012702-route-evolution-graph`
