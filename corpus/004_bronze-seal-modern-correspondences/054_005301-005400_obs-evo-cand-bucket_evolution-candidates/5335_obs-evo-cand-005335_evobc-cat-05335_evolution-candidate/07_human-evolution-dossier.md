...
- External category reference: `evobc-cat-05335`
- Source category ID: `05335`
- Source label for human review: `獺`
- Source codepoints: `U+737A`
...
- `obs-evo-cand-005335-route-category-staging`
...
- `obs-evo-cand-005335-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005335-route-evolution-graph`
