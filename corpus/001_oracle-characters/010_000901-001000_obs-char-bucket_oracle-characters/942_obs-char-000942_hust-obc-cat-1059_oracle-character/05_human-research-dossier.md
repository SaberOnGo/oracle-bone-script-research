# obs-char-000942 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/942_obs-char-000942_hust-obc-cat-1059_orac
  le-character/03_visual-assets/001_asset-000947_hust-obc-cat-1059_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1059/G_1059_後114.8(甲).png`
- asset id: `asset-000947`
...
- source category: `1059`
- validation class: `941`
- source image route: `HUST-OBC/deciphered/1059/G_1059_後114.8(甲).png`
- asset id: `asset-000947`
...
- English observation: `A dense form combines a left rectangular enclosure,
  a central crossing, and broad right branching strokes.`
...
- dataset label text: `㠙`
- dataset label codepoints: `U+3819`
...
- Which source records identify obs-char-000942 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000942？
