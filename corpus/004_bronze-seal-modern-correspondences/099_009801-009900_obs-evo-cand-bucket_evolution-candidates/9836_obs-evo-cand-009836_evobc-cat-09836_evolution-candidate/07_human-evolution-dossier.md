...
- External category reference: `evobc-cat-09836`
- Source category ID: `09836`
- Source label: `雪`
...
- `obs-evo-cand-009836-route-category-staging`
...
- `obs-evo-cand-009836-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-009836-route-evolution-graph`
