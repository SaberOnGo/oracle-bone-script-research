# Material Visual Observation / obs-comp-cand-000497 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000497`
- External reference / 外部参照: `obimd-sub-dhbxzk9tyc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012733_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dhbxzk9tyc/dhbxzk9tyc/dhbxzk9tyc.png`
- Checksum / 校验和:
  `56907652a5b4e342815957b1576f677d96770ba982cabcecb6e6b434a54e46e4`
...
- Marked-pixel bounds: (57,38)–(192,206); span 136 × 169 px; the marked
...
- 痕迹范围：(57,38)–(192,206)；跨度136 × 169 px；痕迹矩形高于宽。
