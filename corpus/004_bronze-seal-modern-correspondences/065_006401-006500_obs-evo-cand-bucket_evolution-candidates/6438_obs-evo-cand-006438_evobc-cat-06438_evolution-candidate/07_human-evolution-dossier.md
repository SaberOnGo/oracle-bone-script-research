...
- Project ID: `obs-evo-cand-006438`
- EVOBC category candidate ID: `evobc-evo-cat-06438`
- External category reference: `evobc-cat-06438`
- Source category ID: `06438`
- Source label for human review: `系`
- Source codepoints: `U+7CFB`
...
- `obs-evo-cand-006438-route-category-staging`
...
- `obs-evo-cand-006438-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006438-route-evolution-graph`
