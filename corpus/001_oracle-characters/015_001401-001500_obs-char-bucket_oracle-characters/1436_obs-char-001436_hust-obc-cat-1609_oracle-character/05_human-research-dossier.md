# obs-char-001436 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001436`
- primary external id: `hust-obc-cat-1609`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1436_obs-char-001436_hust-obc-cat-1609_ora
  cle-character/03_visual-assets/001_asset-001441_hust-obc-cat-1609_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1609/G_1609_乙1654合18271賓組.png`
- asset id: `asset-001441`
...
- source category: `1609`
- validation class: `1435`
- source image route: `HUST-OBC/deciphered/1609/G_1609_乙1654合18271賓組.png`
- asset id: `asset-001441`
...
- English observation: `A dense narrow cluster has side prongs, a central
  stem, and lower diagonals.`
...
- dataset label text: `㨿`
- dataset label codepoints: `U+3A3F`
...
- filename catalog route clues: `Heji-like filename clue: 合18271
  (G_1609_乙1654合18271賓組.png)`
...
- Which source records identify obs-char-001436 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001436？
