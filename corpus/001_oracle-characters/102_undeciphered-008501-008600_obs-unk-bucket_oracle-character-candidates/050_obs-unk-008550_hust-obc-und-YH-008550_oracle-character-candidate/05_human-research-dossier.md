# obs-unk-008550 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008550`
- primary external id: `hust-obc-und-YH-008550`
...
- local review image route: `corpus/001_oracle-characters/102_undeciphered-008
  501-008600_obs-unk-bucket_oracle-character-candidates/050_obs-unk-008550_h
  ust-obc-und-YH-008550_oracle-character-candidate/03_visual-assets/001_asse
  t-010141_hust-obc-und-YH-008550_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60BE3/H_？_60BE3_0.png`
- asset id: `asset-010141`
...
- source class: `HUST-OBC/undeciphered/Y+H/60BE3/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60BE3/H_？_60BE3_0.png`
- asset id: `asset-010141`
...
- Which source records identify obs-unk-008550 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008550？
