...
- External category reference: `evobc-cat-03035`
- Source category ID: `03035`
- Source label for human review: `惂`
- Source codepoints: `U+60C2`
...
- `obs-evo-cand-003035-route-category-staging`
...
- `obs-evo-cand-003035-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003035-route-evolution-graph`
