...
- Project ID: `obs-evo-cand-008505`
- EVOBC category candidate ID: `evobc-evo-cat-08505`
- External category reference: `evobc-cat-08505`
- Source category ID: `08505`
- Source label for human review: `豳`
- Source codepoints: `U+8C73`
...
- `obs-evo-cand-008505-route-category-staging`
...
- `obs-evo-cand-008505-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008505-route-evolution-graph`
