# Material Visual Observation / obs-comp-cand-000666 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000666`
- External reference / 外部参照: `obimd-sub-84umwz5kds`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013229_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/84umwz5kds/84umwz5kds/84umwz5kds.png`
- Checksum / 校验和:
  `3a76ab5624677acada4c8ed01eef1c29f05f0ce93e20b00328ba8155f00fddaa`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.61%.
- Marked-pixel bounds: (77,30)–(171,205); span 95 × 176 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.61%。
- 痕迹范围：(77,30)–(171,205)；跨度95 × 176 px；痕迹矩形高于宽。
