# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004643
...
- EVOBC candidate category: `evobc-evo-cat-04643`.
- Source label for search only: `洼`.
- Source codepoints for search only: `U+6D3C`.
