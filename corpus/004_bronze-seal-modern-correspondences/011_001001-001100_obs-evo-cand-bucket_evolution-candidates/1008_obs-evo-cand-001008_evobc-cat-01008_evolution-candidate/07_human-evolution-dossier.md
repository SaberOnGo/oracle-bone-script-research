...
Project ID: `obs-evo-cand-001008`
...
- Project ID: `obs-evo-cand-001008`
- EVOBC category candidate ID: `evobc-evo-cat-01008`
- External category reference: `evobc-cat-01008`
- Source category ID: `01008`
- Source label for human review: `僌`
- Source codepoints: `U+50CC`
...
- `obs-evo-cand-001008-route-category-staging`
...
- `obs-evo-cand-001008-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001008-route-evolution-graph`
