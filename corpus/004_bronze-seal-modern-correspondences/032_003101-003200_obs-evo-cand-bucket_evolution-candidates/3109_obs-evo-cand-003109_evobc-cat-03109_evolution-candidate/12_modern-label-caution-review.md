# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003109
...
- EVOBC candidate category: `evobc-evo-cat-03109`.
- Source label for search only: `態`.
- Source codepoints for search only: `U+614B`.
