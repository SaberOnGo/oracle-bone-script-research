...
- External category reference: `evobc-cat-10804`
- Source category ID: `10804`
- Source label for human review: `𠊱`
...
- `obs-evo-cand-010804-route-category-staging`
...
- `obs-evo-cand-010804-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010804-route-evolution-graph`
