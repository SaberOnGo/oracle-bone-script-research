...
- Project ID: `obs-evo-cand-007288`
- EVOBC category candidate ID: `evobc-evo-cat-07288`
- External category reference: `evobc-cat-07288`
- Source category ID: `07288`
- Source label for human review: `苫`
- Source codepoints: `U+82EB`
...
- `obs-evo-cand-007288-route-category-staging`
...
- `obs-evo-cand-007288-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007288-route-evolution-graph`
