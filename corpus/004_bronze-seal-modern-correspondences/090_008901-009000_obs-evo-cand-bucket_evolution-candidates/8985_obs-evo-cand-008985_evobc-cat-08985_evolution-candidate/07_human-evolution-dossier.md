...
- External category reference: `evobc-cat-08985`
- Source category ID: `08985`
...
- `obs-evo-cand-008985-route-category-staging`
...
- `obs-evo-cand-008985-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008985-route-evolution-graph`
