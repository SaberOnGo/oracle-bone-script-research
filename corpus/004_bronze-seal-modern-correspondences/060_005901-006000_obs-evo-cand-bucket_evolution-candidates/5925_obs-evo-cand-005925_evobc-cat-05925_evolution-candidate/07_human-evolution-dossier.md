...
- External category reference: `evobc-cat-05925`
- Source category ID: `05925`
- Source label for human review: `碝`
...
- `obs-evo-cand-005925-route-category-staging`
...
- `obs-evo-cand-005925-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005925-route-evolution-graph`
