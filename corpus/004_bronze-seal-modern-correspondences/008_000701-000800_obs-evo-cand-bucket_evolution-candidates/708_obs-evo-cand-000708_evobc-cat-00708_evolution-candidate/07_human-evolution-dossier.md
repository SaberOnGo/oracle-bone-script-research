...
- External category reference: `evobc-cat-00708`
- Source category ID: `00708`
- Source label for human review: `亭`
...
- `obs-evo-cand-000708-route-category-staging`
...
- `obs-evo-cand-000708-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000708-route-evolution-graph`
