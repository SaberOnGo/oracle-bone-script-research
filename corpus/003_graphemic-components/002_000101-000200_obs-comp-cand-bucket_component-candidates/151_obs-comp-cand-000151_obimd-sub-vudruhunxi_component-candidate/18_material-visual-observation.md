# Material Visual Observation / obs-comp-cand-000151 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000151`
- External reference / 外部参照: `obimd-sub-vudruhunxi`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011563_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vudruhunxi/vudruhunxi/vudruhunxi.png`
- Checksum / 校验和:
  `1c84b86efaaf411886e5e8e4153f4f3d2ed37b313382e3c875bb3f3652ea6b70`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.41%.
- Marked-pixel bounds: (63,28)–(208,218); span 146 × 191 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.41%。
- 痕迹范围：(63,28)–(208,218)；跨度146 × 191 px；痕迹矩形高于宽。
