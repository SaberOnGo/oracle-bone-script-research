...
- Project ID: `obs-evo-cand-004087`
- EVOBC category candidate ID: `evobc-evo-cat-04087`
- External category reference: `evobc-cat-04087`
- Source category ID: `04087`
- Source label for human review: `棆`
- Source codepoints: `U+68C6`
...
- `obs-evo-cand-004087-route-category-staging`
...
- `obs-evo-cand-004087-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004087-route-evolution-graph`
