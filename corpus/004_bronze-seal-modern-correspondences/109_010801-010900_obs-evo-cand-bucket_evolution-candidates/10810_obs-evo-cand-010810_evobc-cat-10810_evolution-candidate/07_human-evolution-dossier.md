...
- External category reference: `evobc-cat-10810`
- Source category ID: `10810`
- Source label for human review: `𠌷`
...
- `obs-evo-cand-010810-route-category-staging`
...
- `obs-evo-cand-010810-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010810-route-evolution-graph`
