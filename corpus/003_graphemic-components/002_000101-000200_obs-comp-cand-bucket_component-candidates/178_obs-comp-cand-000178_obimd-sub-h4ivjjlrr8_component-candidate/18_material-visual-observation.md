# Material Visual Observation / obs-comp-cand-000178 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000178`
- External reference / 外部参照: `obimd-sub-h4ivjjlrr8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011590_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h4ivjjlrr8/h4ivjjlrr8/h4ivjjlrr8.png`
- Checksum / 校验和:
  `a12fe8e974d84e586b9988c7c0bede44566175612a174073452beb6dc8380d94`
...
- Marked-pixel bounds: (87,17)–(162,236); span 76 × 220 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.45%。
- 痕迹范围：(87,17)–(162,236)；跨度76 × 220 px；痕迹矩形高于宽。
