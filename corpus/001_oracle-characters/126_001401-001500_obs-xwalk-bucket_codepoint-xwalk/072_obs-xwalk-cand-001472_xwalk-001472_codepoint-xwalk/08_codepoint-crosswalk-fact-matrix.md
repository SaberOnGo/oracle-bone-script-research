# obs-xwalk-cand-001472 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+3A6A;U+3A6B` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-1652_1653` | not reading |
