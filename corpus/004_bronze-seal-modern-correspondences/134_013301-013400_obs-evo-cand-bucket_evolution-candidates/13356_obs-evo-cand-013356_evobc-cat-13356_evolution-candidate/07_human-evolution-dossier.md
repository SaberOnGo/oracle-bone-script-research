...
- External category reference: `evobc-cat-13356`
- Source category ID: `13356`
- Source label for human review: `𬥦`
...
- `obs-evo-cand-013356-route-category-staging`
...
- `obs-evo-cand-013356-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013356-route-evolution-graph`
