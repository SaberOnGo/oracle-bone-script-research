# Material Visual Observation / obs-comp-cand-001494 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001494`
- External reference / 外部参照: `obimd-sub-ae9cjv8zji`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016105_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ae9cjv8zji/ae9cjv8zji/ae9cjv8zji.png`
- Checksum / 校验和:
  `0ef9640094519db7109f77c8a0081c18245b7f2ffbab38cffe0148730c307a08`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.68%.
- Marked-pixel bounds: (85,23)–(169,230); span 85 × 208 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.68%。
- 痕迹范围：(85,23)–(169,230)；跨度85 × 208 px；痕迹矩形高于宽。
