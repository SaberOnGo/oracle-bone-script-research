# Material Visual Observation / obs-comp-cand-001841 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001841`
- External reference / 外部参照: `obimd-sub-avm1k8vp5w`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018202_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gx21ndp7yy/avm1k8vp5w/avm1k8vp5w.png`
- Checksum / 校验和:
  `bddedd31e5de86f617a1bf82dc4a42bbf396b1f8cdec02345ab86e8f59b1a78c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.10%.
- Marked-pixel bounds: (63,34)–(186,218); span 124 × 185 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.10%。
- 痕迹范围：(63,34)–(186,218)；跨度124 × 185 px；痕迹矩形高于宽。
