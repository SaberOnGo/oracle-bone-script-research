# Material Visual Observation / obs-comp-cand-001915 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001915`
- External reference / 外部参照: `obimd-sub-drf1i3fmxo`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018325_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/drf1i3fmxo/drf1i3fmxo/drf1i3fmxo.png`
- Checksum / 校验和:
  `fa65100ec4598a1c8e40a52678ccc24460f0e8bae887e16e7a297f6398d98e9a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.97%.
- Marked-pixel bounds: (75,24)–(184,227); span 110 × 204 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.97%。
- 痕迹范围：(75,24)–(184,227)；跨度110 × 204 px；痕迹矩形高于宽。
