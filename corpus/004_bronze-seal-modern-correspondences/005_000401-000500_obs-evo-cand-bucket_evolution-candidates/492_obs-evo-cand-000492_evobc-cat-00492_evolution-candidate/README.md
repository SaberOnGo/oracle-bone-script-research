# obs-evo-cand-000492 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-000492`
- EVOBC category candidate ID: `evobc-evo-cat-00492`
- External category ref: `evobc-cat-00492`
- Source label: `䣊`
- Source codepoints: `U+48CA`
- Image reference count: `14`
- Era token counts: `WSC:14`
- Source token counts: `Book:2;Web:12`
