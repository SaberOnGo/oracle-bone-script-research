# obs-unk-002224 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002224`
- primary external id: `hust-obc-und-L-002224`
...
- local review image route: `corpus/001_oracle-characters/039_undeciphered-002
  201-002300_obs-unk-bucket_oracle-character-candidates/024_obs-unk-002224_h
  ust-obc-und-L-002224_oracle-character-candidate/03_visual-assets/001_asset
  -003817_hust-obc-und-L-002224_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2224/L_？_2723.jpg`
- asset id: `asset-003817`
...
- source class: `HUST-OBC/undeciphered/L/2224/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2224/L_？_2723.jpg`
- asset id: `asset-003817`
...
- Which source records identify obs-unk-002224 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002224？
