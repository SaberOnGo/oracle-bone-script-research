...
- External category reference: `evobc-cat-01374`
- Source category ID: `01374`
- Source label for human review: `卒`
...
- `obs-evo-cand-001374-route-category-staging`
...
- `obs-evo-cand-001374-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001374-route-evolution-graph`
