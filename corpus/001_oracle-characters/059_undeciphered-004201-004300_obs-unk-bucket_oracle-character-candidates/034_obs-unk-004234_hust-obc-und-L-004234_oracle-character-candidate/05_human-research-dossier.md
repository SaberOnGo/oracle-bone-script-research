# obs-unk-004234 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/034_obs-unk-004234_h
  ust-obc-und-L-004234_oracle-character-candidate/03_visual-assets/001_asset
  -005827_hust-obc-und-L-004234_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4234/L_？_9296.jpg`
- asset id: `asset-005827`
...
- source class: `HUST-OBC/undeciphered/L/4234/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4234/L_？_9296.jpg`
- asset id: `asset-005827`
...
- English observation: `Left rounded traces, central and right strokes visible.`
- 中文观察: `左侧圆弧痕迹、中央竖痕和右侧笔画可见。`
...
- Which source records identify obs-unk-004234 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004234？
