# obs-unk-004530 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004530`
- primary external id: `hust-obc-und-X-004530`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/030_obs-unk-004530_h
  ust-obc-und-X-004530_oracle-character-candidate/03_visual-assets/001_asset
  -006123_hust-obc-und-X-004530_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/86/X_？_8270_1.png`
- asset id: `asset-006123`
...
- source class: `HUST-OBC/undeciphered/X/86/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/86/X_？_8270_1.png`
- asset id: `asset-006123`
...
- English observation: `Outer outline, diagonal trace, and branch recorded.`
- 中文观察: `已记录外部轮廓、斜向痕迹和上部分支。`
...
- Which source records identify obs-unk-004530 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004530？
