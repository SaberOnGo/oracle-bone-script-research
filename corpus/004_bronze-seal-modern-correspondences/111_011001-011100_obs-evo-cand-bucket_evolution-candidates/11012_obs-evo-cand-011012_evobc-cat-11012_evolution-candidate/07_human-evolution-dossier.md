...
Project ID: `obs-evo-cand-011012`
...
- Project ID: `obs-evo-cand-011012`
- EVOBC category candidate ID: `evobc-evo-cat-11012`
- External category reference: `evobc-cat-11012`
- Source category ID: `11012`
- Source label for human review: `𡕉`
- Source codepoints: `U+21549`
...
- `obs-evo-cand-011012-route-category-staging`
...
- `obs-evo-cand-011012-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011012-route-evolution-graph`
