# obs-char-001398 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001398`
- primary external id: `hust-obc-cat-1564_1565`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1398_obs-char-001398_hust-obc-cat-1564_156
  5_oracle-character/03_visual-assets/001_asset-001403_hust-obc-cat-1564_156
  5_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1564_1565/1564/G_1564_乙1441合210
  24.png`
- asset id: `asset-001403`
...
- source category: `1564_1565`
- validation class: `1397`
- source image route: `HUST-OBC/deciphered/1564_1565/1564/G_1564_乙1441合21024.p
  ng`
- asset id: `asset-001403`
...
- English observation: `A broad upper frame is paired with two detached
  lower strokes marked by ticks.`
- 中文观察: `宽大上部框形与两条带短笔标记的分离下部笔画相邻。`
...
- dataset label text: `㨒㨓`
- dataset label codepoints: `U+3A12;U+3A13`
...
- graph edge count: `2`
- codepoint routes: `U+3A12;U+3A13`
...
- filename catalog route clues: `Heji-like filename clue: 合21024
  (G_1564_乙1441合21024.png)`
...
- Which source records identify obs-char-001398 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001398？
