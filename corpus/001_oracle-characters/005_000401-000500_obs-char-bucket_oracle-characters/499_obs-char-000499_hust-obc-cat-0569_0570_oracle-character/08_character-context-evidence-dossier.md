...
- 项目 ID: `obs-char-000499`
- 首选外部 ID: `hust-obc-cat-0569_0570`
- 来源 ID: `src-hust-obc`
...
- 来源图像路线数: `1`
- 本地复核图像数: `1`
- 首个来源图像名: `G_0569_前6.31.5(甲).png`
- 首个本地图像名: `001_asset-000504_hust-obc-cat-0569_0570_glyph.png`
