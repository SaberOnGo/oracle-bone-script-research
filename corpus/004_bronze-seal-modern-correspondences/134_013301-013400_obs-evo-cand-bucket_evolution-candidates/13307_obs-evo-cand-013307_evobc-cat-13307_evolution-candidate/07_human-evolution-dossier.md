...
Project ID: `obs-evo-cand-013307`
...
- Project ID: `obs-evo-cand-013307`
- EVOBC category candidate ID: `evobc-evo-cat-13307`
- External category reference: `evobc-cat-13307`
- Source category ID: `13307`
- Source label for human review: `𬛰`
- Source codepoints: `U+2C6F0`
...
- `obs-evo-cand-013307-route-category-staging`
...
- `obs-evo-cand-013307-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013307-route-evolution-graph`
