# obs-unk-003993 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003993`
- primary external id: `hust-obc-und-L-003993`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/093_obs-unk-003993_h
  ust-obc-und-L-003993_oracle-character-candidate/03_visual-assets/001_asset
  -005586_hust-obc-und-L-003993_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3993/L_？_8451.jpg`
- asset id: `asset-005586`
...
- source class: `HUST-OBC/undeciphered/L/3993/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3993/L_？_8451.jpg`
- asset id: `asset-005586`
...
- English observation: A curved upper trace slopes over a compact cluster of
  angled lower marks; the side edges are incomplete in the crop.
- 中文观察：上部弯曲痕迹斜向越过较紧凑的下部痕迹簇；侧边在图像中不完整。
...
- Which source records identify obs-unk-003993 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003993？
