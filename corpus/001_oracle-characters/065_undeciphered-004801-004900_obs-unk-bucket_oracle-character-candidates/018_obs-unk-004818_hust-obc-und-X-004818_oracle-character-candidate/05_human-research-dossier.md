# obs-unk-004818 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004818`
- primary external id: `hust-obc-und-X-004818`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/018_obs-unk-004818_h
  ust-obc-und-X-004818_oracle-character-candidate/03_visual-assets/001_asset
  -006411_hust-obc-und-X-004818_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/374/X_？_7358_1.png`
- asset id: `asset-006411`
...
- source class: `HUST-OBC/undeciphered/X/374/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/374/X_？_7358_1.png`
- asset id: `asset-006411`
...
- English observation: `central crossing and lower loop with pale opening`
- 中文观察: `中部交叉和带浅色开口的下部环状结构`
...
- Which source records identify obs-unk-004818 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004818？
