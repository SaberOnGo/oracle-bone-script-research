# obs-unk-004024 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/024_obs-unk-004024_h
  ust-obc-und-L-004024_oracle-character-candidate/03_visual-assets/001_asset
  -005617_hust-obc-und-L-004024_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4024/L_？_8577.jpg`
- asset id: `asset-005617`
...
- source class: `HUST-OBC/undeciphered/L/4024/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4024/L_？_8577.jpg`
- asset id: `asset-005617`
...
- English observation: A broad upper outline spans the image, with a small
  internal dark area. A long tapered trace descends from its lower center,
  while short side traces remain near the upper edges. The crop is small.
- 中文观察：较宽的上部轮廓横跨图像，内部有小型暗部；一条长而渐窄的痕迹从下部
    中央向下延伸，上缘附近还留有短侧痕。图像较小。
...
- Which source records identify obs-unk-004024 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004024？
