# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004635
...
- EVOBC candidate category: `evobc-evo-cat-04635`.
- Source label for search only: `洭`.
- Source codepoints for search only: `U+6D2D`.
