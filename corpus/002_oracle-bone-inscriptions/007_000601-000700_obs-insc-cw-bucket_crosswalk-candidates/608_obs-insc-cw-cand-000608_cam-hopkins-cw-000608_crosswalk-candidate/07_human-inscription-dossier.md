...
- Source page section: `Period V Group 20` /
  `第 V 期第 20 组`
- Source section key: `period-v-group-20`
...
- Yingguo / 英国所藏: `y2673` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `261` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `88` in source row; primary catalog entry pending
- Heji / 合集: `41835` in source row; primary catalog entry pending
