# obs-char-001239 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1239_obs-char-001239_hust-obc-cat-1386_ora
  cle-character/03_visual-assets/001_asset-001244_hust-obc-cat-1386_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1386/G_1386_佚644(甲).png`
- asset id: `asset-001244`
...
- source category: `1386`
- validation class: `1238`
- source image route: `HUST-OBC/deciphered/1386/G_1386_佚644(甲).png`
- asset id: `asset-001244`
...
- English observation: `A narrow pointed upright form has two long side
  branches and a short central lower stroke.`
...
- dataset label text: `㥠`
- dataset label codepoints: `U+3960`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00129`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00129`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00129`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/129_obs-evo-can
  d-000129_evobc-cat-00129_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/129_obs-evo-cand-000129_evobc-cat-00129_evolu
...
- Which source records identify obs-char-001239 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001239？
