...
- `obs-evo-cand-007469-route-category-staging`
...
- `obs-evo-cand-007469-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007469-route-evolution-graph`
