# Material Visual Observation / obs-comp-cand-002504 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002504`
- External reference / 外部参照: `obimd-sub-8so0r5rae8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020775_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zz00qbgu3m/8so0r5rae8/8so0r5rae8.png`
- Checksum / 校验和:
  `8de11f9added59a2c357fd45ad1363488bcbee39c4df66e2ab57ddb5724c51af`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.02%.
- Marked-pixel bounds: (54,93)–(196,148); span 143 × 56 px; the marked rectangle
  is wider than tall.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.02%。
- 痕迹范围：(54,93)–(196,148)；跨度143 × 56 px；痕迹矩形宽于高。
