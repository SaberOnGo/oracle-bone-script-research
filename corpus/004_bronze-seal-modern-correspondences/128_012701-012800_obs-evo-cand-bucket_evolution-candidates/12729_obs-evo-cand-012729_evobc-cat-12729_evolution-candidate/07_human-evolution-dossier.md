...
Project ID: `obs-evo-cand-012729`
...
- Project ID: `obs-evo-cand-012729`
- EVOBC category candidate ID: `evobc-evo-cat-12729`
- External category reference: `evobc-cat-12729`
- Source category ID: `12729`
- Source label for human review: `𪄛`
- Source codepoints: `U+2A11B`
...
- `obs-evo-cand-012729-route-category-staging`
...
- `obs-evo-cand-012729-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012729-route-evolution-graph`
