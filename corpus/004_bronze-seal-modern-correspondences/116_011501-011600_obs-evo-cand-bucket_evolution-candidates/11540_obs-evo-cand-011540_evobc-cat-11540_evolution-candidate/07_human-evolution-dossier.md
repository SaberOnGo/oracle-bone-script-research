...
- External category reference: `evobc-cat-11540`
- Source category ID: `11540`
- Source label for human review: `𣾓`
- Source codepoints: `U+23F93`
...
- `obs-evo-cand-011540-route-category-staging`
...
- `obs-evo-cand-011540-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011540-route-evolution-graph`
