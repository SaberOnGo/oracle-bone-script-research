...
- External category reference: `evobc-cat-08925`
- Source category ID: `08925`
- Source label for human review: `辱`
- Source codepoints: `U+8FB1`
...
- `obs-evo-cand-008925-route-category-staging`
...
- `obs-evo-cand-008925-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008925-route-evolution-graph`
