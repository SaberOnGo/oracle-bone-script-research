...
Project ID: `obs-evo-cand-008867`
...
- Project ID: `obs-evo-cand-008867`
- EVOBC category candidate ID: `evobc-evo-cat-08867`
- External category reference: `evobc-cat-08867`
- Source category ID: `08867`
- Source label for human review: `轈`
- Source codepoints: `U+8F48`
...
- `obs-evo-cand-008867-route-category-staging`
...
- `obs-evo-cand-008867-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008867-route-evolution-graph`
