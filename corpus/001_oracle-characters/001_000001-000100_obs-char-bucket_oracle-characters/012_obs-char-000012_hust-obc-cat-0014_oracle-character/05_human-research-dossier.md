# obs-char-000012 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/012_obs-char-000012_hust-obc-cat-0014_orac
  le-character/03_visual-assets/001_asset-000017_hust-obc-cat-0014_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0014/X_0014_5538_1.png`
- asset id: `asset-000017`
...
- source category: `0014`
- validation class: `11`
- source image route: `HUST-OBC/deciphered/0014/X_0014_5538_1.png`
- asset id: `asset-000017`
...
- English observation: `The image contains a broad left form and a separate
  right looped form, with detached marks near their upper and lower ends.`
- 中文观察: `图像含较宽的左侧形体和分离的右侧环状形体，上下端附近还可见分离痕迹。`
...
- dataset label text: `㐄`
- dataset label codepoints: `U+3404`
...
- Which source records identify obs-char-000012 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000012？
