...
Project ID: `obs-evo-cand-005404`
...
- Project ID: `obs-evo-cand-005404`
- EVOBC category candidate ID: `evobc-evo-cat-05404`
- External category reference: `evobc-cat-05404`
- Source category ID: `05404`
- Source label for human review: `琖`
- Source codepoints: `U+7416`
...
- `obs-evo-cand-005404-route-category-staging`
...
- `obs-evo-cand-005404-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005404-route-evolution-graph`
