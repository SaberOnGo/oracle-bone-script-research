# obs-char-000130 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000130`
- primary external id: `hust-obc-cat-0144`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/130_obs-char-000130_hust-obc-cat-0144_orac
  le-character/03_visual-assets/001_asset-000135_hust-obc-cat-0144_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0144/G_0144_京津2848合18983.png`
- asset id: `asset-000135`
...
- source category: `0144`
- validation class: `129`
- source image route: `HUST-OBC/deciphered/0144/G_0144_京津2848合18983.png`
- asset id: `asset-000135`
...
- English observation: `The narrow image has a long curved central stroke, a
  small upper branch, and a short horizontal crossing mark near the lower
  end.`
- 中文观察: `狭长图像有长弯曲主笔，上方有小分叉，下端附近有短横交叉痕迹。`
...
- dataset label text: `㒆`
- dataset label codepoints: `U+3486`
...
- filename catalog route clues: `Heji-like filename clue: 合18983
  (G_0144_京津2848合18983.png)`
...
- Which source records identify obs-char-000130 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000130？
