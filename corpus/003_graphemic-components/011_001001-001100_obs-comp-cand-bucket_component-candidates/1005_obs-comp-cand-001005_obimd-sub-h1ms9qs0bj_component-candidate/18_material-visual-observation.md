# Material Visual Observation / obs-comp-cand-001005 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001005`
- External reference / 外部参照: `obimd-sub-h1ms9qs0bj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014468_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jupa4d7mu6/h1ms9qs0bj/h1ms9qs0bj.png`
- Checksum / 校验和:
  `918f179b9643e200b026f334bc328bcb1f9bda92dec33c448c13a9e4500f0392`
...
- Marked-pixel bounds: (61,32)–(187,204); span 127 × 173 px; the marked
...
- 痕迹范围：(61,32)–(187,204)；跨度127 × 173 px；痕迹矩形高于宽。
