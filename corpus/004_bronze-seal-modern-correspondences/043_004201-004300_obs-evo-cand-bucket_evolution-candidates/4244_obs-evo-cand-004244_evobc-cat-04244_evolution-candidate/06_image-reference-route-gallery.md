...
- `obs-evo-cand-004244-route-category-staging`
...
- `obs-evo-cand-004244-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004244-route-evolution-graph`
