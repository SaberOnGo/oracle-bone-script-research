# obs-unk-004293 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/093_obs-unk-004293_h
  ust-obc-und-L-004293_oracle-character-candidate/03_visual-assets/001_asset
  -005886_hust-obc-und-L-004293_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4293/L_？_948.jpg`
- asset id: `asset-005886`
...
- source class: `HUST-OBC/undeciphered/L/4293/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4293/L_？_948.jpg`
- asset id: `asset-005886`
...
- English observation: `Curved traces, central crossing, uneven ends visible.`
- 中文观察: `弯曲痕迹、中央交叉和不均匀末端可见。`
...
- Which source records identify obs-unk-004293 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004293？
