# obs-evo-cand-002024 / EVOBC evolution-category candidate
...
- EVOBC category candidate ID: `evobc-evo-cat-02024`
- External category ref: `evobc-cat-02024`
- Source label: `夻`
- Source codepoints: `U+593B`
- Image reference count: `16`
- Era token counts: `BI:3;WSC:13`
- Source token counts: `Web:16`
