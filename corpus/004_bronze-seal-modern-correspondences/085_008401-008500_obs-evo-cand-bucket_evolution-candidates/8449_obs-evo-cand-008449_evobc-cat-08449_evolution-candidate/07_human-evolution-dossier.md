...
- External category reference: `evobc-cat-08449`
- Source category ID: `08449`
- Source label for human review: `谈`
...
- `obs-evo-cand-008449-route-category-staging`
...
- `obs-evo-cand-008449-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008449-route-evolution-graph`
