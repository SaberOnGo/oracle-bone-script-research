...
- `obs-evo-cand-011789-route-category-staging`
...
- `obs-evo-cand-011789-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011789-route-evolution-graph`
