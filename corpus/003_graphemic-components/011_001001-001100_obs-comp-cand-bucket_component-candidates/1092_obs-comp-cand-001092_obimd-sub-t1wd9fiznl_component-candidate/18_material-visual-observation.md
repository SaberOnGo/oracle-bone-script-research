# Material Visual Observation / obs-comp-cand-001092 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001092`
- External reference / 外部参照: `obimd-sub-t1wd9fiznl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014901_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/t1wd9fiznl/t1wd9fiznl/t1wd9fiznl.png`
- Checksum / 校验和:
  `57f16c6ddbf389f02ba4d8ba823d67b656aded12138374a7384f9fb343a06285`
...
- Marked-pixel bounds: (77,18)–(173,231); span 97 × 214 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.99%。
- 痕迹范围：(77,18)–(173,231)；跨度97 × 214 px；痕迹矩形高于宽。
