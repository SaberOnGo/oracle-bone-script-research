...
- External category reference: `evobc-cat-00891`
- Source category ID: `00891`
- Source label for human review: `俚`
...
- `obs-evo-cand-000891-route-category-staging`
...
- `obs-evo-cand-000891-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000891-route-evolution-graph`
