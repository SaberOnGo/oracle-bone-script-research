...
- Evidence level / 证据等级: museum_collection
- Registered scope / 已登记范围: Official museum object record for oracle-bone
  fragments with museum number, registration number, period, material,
  acquisition and department fields.
