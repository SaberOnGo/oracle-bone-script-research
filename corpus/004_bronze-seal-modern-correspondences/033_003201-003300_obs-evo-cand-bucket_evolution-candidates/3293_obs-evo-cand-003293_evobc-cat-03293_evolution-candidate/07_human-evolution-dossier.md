...
Project ID: `obs-evo-cand-003293`
...
- Project ID: `obs-evo-cand-003293`
- EVOBC category candidate ID: `evobc-evo-cat-03293`
- External category reference: `evobc-cat-03293`
- Source category ID: `03293`
- Source label for human review: `抭`
- Source codepoints: `U+62AD`
...
- `obs-evo-cand-003293-route-category-staging`
...
- `obs-evo-cand-003293-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003293-route-evolution-graph`
