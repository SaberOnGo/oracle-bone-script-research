...
Project ID: `obs-evo-cand-000840`
...
- Project ID: `obs-evo-cand-000840`
- EVOBC category candidate ID: `evobc-evo-cat-00840`
- External category reference: `evobc-cat-00840`
- Source category ID: `00840`
- Source label for human review: `侊`
- Source codepoints: `U+4F8A`
...
- `obs-evo-cand-000840-route-category-staging`
...
- `obs-evo-cand-000840-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000840-route-evolution-graph`
