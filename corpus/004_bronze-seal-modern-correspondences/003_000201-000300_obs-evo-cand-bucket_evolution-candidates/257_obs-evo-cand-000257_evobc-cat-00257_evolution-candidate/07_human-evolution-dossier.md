...
- Project ID: `obs-evo-cand-000257`
- EVOBC category candidate ID: `evobc-evo-cat-00257`
- External category reference: `evobc-cat-00257`
- Source category ID: `00257`
- Source label for human review: `㾏`
- Source codepoints: `U+3F8F`
...
- `obs-evo-cand-000257-route-category-staging`
...
- `obs-evo-cand-000257-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000257-route-evolution-graph`
