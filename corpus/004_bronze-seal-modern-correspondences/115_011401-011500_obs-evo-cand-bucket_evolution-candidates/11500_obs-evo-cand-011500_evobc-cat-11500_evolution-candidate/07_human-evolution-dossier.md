...
Project ID: `obs-evo-cand-011500`
...
- Project ID: `obs-evo-cand-011500`
- EVOBC category candidate ID: `evobc-evo-cat-11500`
- External category reference: `evobc-cat-11500`
- Source category ID: `11500`
- Source label for human review: `𣬕`
- Source codepoints: `U+23B15`
- Image reference count in source metadata: `30`
...
- `obs-evo-cand-011500-route-category-staging`
...
- `obs-evo-cand-011500-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011500-route-evolution-graph`
