...
- External category reference: `evobc-cat-03078`
- Source category ID: `03078`
- Source label for human review: `愊`
- Source codepoints: `U+610A`
...
- `obs-evo-cand-003078-route-category-staging`
...
- `obs-evo-cand-003078-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003078-route-evolution-graph`
