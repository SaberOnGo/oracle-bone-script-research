...
- External category reference: `evobc-cat-13588`
- Source category ID: `13588`
- Source label for human review: `𭼈`
- Source codepoints: `U+2DF08`
...
- `obs-evo-cand-013588-route-category-staging`
...
- `obs-evo-cand-013588-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013588-route-evolution-graph`
