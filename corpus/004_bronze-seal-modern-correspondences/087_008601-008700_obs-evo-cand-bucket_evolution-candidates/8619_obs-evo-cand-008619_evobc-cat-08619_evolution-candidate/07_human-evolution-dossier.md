...
- External category reference: `evobc-cat-08619`
- Source category ID: `08619`
- Source label for human review: `败`
- Source codepoints: `U+8D25`
...
- `obs-evo-cand-008619-route-category-staging`
...
- `obs-evo-cand-008619-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008619-route-evolution-graph`
