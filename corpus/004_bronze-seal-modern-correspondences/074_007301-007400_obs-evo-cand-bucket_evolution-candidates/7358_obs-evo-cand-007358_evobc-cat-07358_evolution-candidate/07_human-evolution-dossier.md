...
Project ID: `obs-evo-cand-007358`
...
- Project ID: `obs-evo-cand-007358`
- EVOBC category candidate ID: `evobc-evo-cat-07358`
- External category reference: `evobc-cat-07358`
- Source category ID: `07358`
- Source label for human review: `荫`
- Source codepoints: `U+836B`
...
- `obs-evo-cand-007358-route-category-staging`
...
- `obs-evo-cand-007358-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007358-route-evolution-graph`
