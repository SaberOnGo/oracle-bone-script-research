...
- External category reference: `evobc-cat-07560`
- Source category ID: `07560`
- Source label for human review: `蔤`
...
- `obs-evo-cand-007560-route-category-staging`
...
- `obs-evo-cand-007560-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007560-route-evolution-graph`
