# Material Visual Observation / obs-comp-cand-001694 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001694`
- External reference / 外部参照: `obimd-sub-gx8mkyjipz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017610_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3eorzalgl4/gx8mkyjipz/gx8mkyjipz.png`
- Checksum / 校验和:
  `2a7db336496614e1529169deac0f06a51abff962fdd5e8429b8f6ef06422df19`
...
- Marked-pixel bounds: (74,35)–(175,209); span 102 × 175 px; the marked
...
- 痕迹范围：(74,35)–(175,209)；跨度102 × 175 px；痕迹矩形高于宽。
