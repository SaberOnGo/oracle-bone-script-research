...
- External category reference: `evobc-cat-07908`
- Source category ID: `07908`
- Source label for human review: `衖`
...
- `obs-evo-cand-007908-route-category-staging`
...
- `obs-evo-cand-007908-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007908-route-evolution-graph`
