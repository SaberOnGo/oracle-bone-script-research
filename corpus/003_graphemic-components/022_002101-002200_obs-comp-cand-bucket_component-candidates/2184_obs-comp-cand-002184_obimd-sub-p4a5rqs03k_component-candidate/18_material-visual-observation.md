# Material Visual Observation / obs-comp-cand-002184 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002184`
- External reference / 外部参照: `obimd-sub-p4a5rqs03k`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019890_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/p4a5rqs03k/p4a5rqs03k/p4a5rqs03k.png`
- Checksum / 校验和:
  `f68bd18b2a291b169c7435ba005f5c344988b03f8c9130c213415afde85ff419`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.74%.
- Marked-pixel bounds: (88,29)–(162,214); span 75 × 186 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.74%。
- 痕迹范围：(88,29)–(162,214)；跨度75 × 186 px；痕迹矩形高于宽。
