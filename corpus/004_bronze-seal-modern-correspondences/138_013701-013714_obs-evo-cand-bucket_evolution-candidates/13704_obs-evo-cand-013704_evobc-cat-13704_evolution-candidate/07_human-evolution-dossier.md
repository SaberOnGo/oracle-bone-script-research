...
Project ID: `obs-evo-cand-013704`
...
- Project ID: `obs-evo-cand-013704`
- EVOBC category candidate ID: `evobc-evo-cat-13704`
- External category reference: `evobc-cat-13704`
- Source category ID: `13704`
- Source label for human review: `數`
- Source codepoints: `U+F969`
...
- `obs-evo-cand-013704-route-category-staging`
...
- `obs-evo-cand-013704-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013704-route-evolution-graph`
