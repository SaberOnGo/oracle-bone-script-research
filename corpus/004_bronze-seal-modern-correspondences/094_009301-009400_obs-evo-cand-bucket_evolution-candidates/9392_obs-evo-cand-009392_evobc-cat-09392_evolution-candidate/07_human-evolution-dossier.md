...
- External category reference: `evobc-cat-09392`
- Source category ID: `09392`
- Source label for human review: `銜`
...
- `obs-evo-cand-009392-route-category-staging`
...
- `obs-evo-cand-009392-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009392-route-evolution-graph`
