...
- External category reference: `evobc-cat-01791`
- Source category ID: `01791`
- Source label for human review: `在`
- Source codepoints: `U+5728`
...
- `obs-evo-cand-001791-route-category-staging`
...
- `obs-evo-cand-001791-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001791-route-evolution-graph`
