# obs-char-000176 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000176`
- primary external id: `hust-obc-cat-0193_0194`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/176_obs-char-000176_hust-obc-cat-0193_0194
  _oracle-character/03_visual-assets/001_asset-000181_hust-obc-cat-0193_0194
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0193_0194/0193/G_0193_乙764合1040
  7賓組.png`
- asset id: `asset-000181`
...
- source category: `0193_0194`
- validation class: `175`
- source image route: `HUST-OBC/deciphered/0193_0194/0193/G_0193_乙764合10407賓組.
  png`
- asset id: `asset-000181`
...
- English observation: `The image has a leaf-like upper cluster with several
  internal curved strokes and a thin pointed continuation below.`
- 中文观察: `图像上方有叶状笔群，内部含数道弯曲笔，下方接细而尖的延续笔。`
...
- dataset label text: `㒷㒸`
- dataset label codepoints: `U+34B7;U+34B8`
...
- graph edge count: `2`
- codepoint routes: `U+34B7;U+34B8`
...
- filename catalog route clues: `Heji-like filename clue: 合10407
  (G_0193_乙764合10407賓組.png)`
...
- Which source records identify obs-char-000176 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000176？
