...
- External category reference: `evobc-cat-13126`
- Source category ID: `13126`
- Source label for human review: `𫷽`
- Source codepoints: `U+2BDFD`
...
- `obs-evo-cand-013126-route-category-staging`
...
- `obs-evo-cand-013126-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013126-route-evolution-graph`
