# Material Visual Observation / obs-comp-cand-001497 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001497`
- External reference / 外部参照: `obimd-sub-j7dwqskzg0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016193_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/j7dwqskzg0/j7dwqskzg0/j7dwqskzg0.png`
- Checksum / 校验和:
  `ba07764b81162298205fe2472d56d6dd11f1a91101d9b2810d77ae9a11b35c95`
...
- Marked-pixel bounds: (79,26)–(177,215); span 99 × 190 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.84%。
- 痕迹范围：(79,26)–(177,215)；跨度99 × 190 px；痕迹矩形高于宽。
