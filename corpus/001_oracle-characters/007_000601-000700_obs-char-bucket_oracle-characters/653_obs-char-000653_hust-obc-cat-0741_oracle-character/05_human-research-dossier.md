# obs-char-000653 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000653`
- primary external id: `hust-obc-cat-0741`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/653_obs-char-000653_hust-obc-cat-0741_orac
  le-character/03_visual-assets/001_asset-000658_hust-obc-cat-0741_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0741/G_0741_摭續190合27742無名組.png`
- asset id: `asset-000658`
...
- source category: `0741`
- validation class: `652`
- source image route: `HUST-OBC/deciphered/0741/G_0741_摭續190合27742無名組.png`
- asset id: `asset-000658`
...
- English observation: `A single narrow dark vertical has a forked top, two
  small angular side openings or bends in its upper half, and a long thin
  lower continuation.`
- 中文观察: `单个狭深色竖形带叉顶，上半部有两个小折角侧空隙或弯折，并延续为细长下笔。`
...
- dataset label text: `㛛`
- dataset label codepoints: `U+36DB`
...
- filename catalog route clues: `Heji-like filename clue: 合27742
  (G_0741_摭續190合27742無名組.png)`
...
- Which source records identify obs-char-000653 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000653？
