# obs-unk-004316 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004316`
- primary external id: `hust-obc-und-L-004316`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/016_obs-unk-004316_h
  ust-obc-und-L-004316_oracle-character-candidate/03_visual-assets/001_asset
  -005909_hust-obc-und-L-004316_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4316/L_？_9518.jpg`
- asset id: `asset-005909`
...
- source class: `HUST-OBC/undeciphered/L/4316/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4316/L_？_9518.jpg`
- asset id: `asset-005909`
...
- English observation: `Compact angular dark cluster recorded;
  stroke boundaries remain pending.`
- 中文观察: `已记录紧密的角状深色痕迹簇，笔痕边界仍待复核。`
...
- Which source records identify obs-unk-004316 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004316？
