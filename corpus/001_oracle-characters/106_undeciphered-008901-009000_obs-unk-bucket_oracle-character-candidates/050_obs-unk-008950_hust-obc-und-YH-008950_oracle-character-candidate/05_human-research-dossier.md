# obs-unk-008950 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008950`
- primary external id: `hust-obc-und-YH-008950`
...
- local review image route: `corpus/001_oracle-characters/106_undeciphered-008
  901-009000_obs-unk-bucket_oracle-character-candidates/050_obs-unk-008950_h
  ust-obc-und-YH-008950_oracle-character-candidate/03_visual-assets/001_asse
  t-010541_hust-obc-und-YH-008950_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60FA5/H_？_60FA5_0.png`
- asset id: `asset-010541`
...
- source class: `HUST-OBC/undeciphered/Y+H/60FA5/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60FA5/H_？_60FA5_0.png`
- asset id: `asset-010541`
...
- Which source records identify obs-unk-008950 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008950？
