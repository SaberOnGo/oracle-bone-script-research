...
- External category reference: `evobc-cat-10966`
- Source category ID: `10966`
- Source label for human review: `𡄹`
- Source codepoints: `U+21139`
...
- `obs-evo-cand-010966-route-category-staging`
...
- `obs-evo-cand-010966-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010966-route-evolution-graph`
