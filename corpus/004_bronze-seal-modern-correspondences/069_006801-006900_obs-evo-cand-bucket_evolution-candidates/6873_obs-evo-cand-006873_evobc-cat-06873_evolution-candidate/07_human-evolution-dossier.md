...
- External category reference: `evobc-cat-06873`
- Source category ID: `06873`
- Source label for human review: `翅`
...
- `obs-evo-cand-006873-route-category-staging`
...
- `obs-evo-cand-006873-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006873-route-evolution-graph`
