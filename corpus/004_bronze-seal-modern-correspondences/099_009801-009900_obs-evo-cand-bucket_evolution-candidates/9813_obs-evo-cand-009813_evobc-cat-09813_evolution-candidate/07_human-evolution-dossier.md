...
- Project ID: `obs-evo-cand-009813`
- EVOBC category candidate ID: `evobc-evo-cat-09813`
- External category reference: `evobc-cat-09813`
- Source category ID: `09813`
- Source label for human review: `雍`
- Source codepoints: `U+96CD`
...
- `obs-evo-cand-009813-route-category-staging`
...
- `obs-evo-cand-009813-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009813-route-evolution-graph`
