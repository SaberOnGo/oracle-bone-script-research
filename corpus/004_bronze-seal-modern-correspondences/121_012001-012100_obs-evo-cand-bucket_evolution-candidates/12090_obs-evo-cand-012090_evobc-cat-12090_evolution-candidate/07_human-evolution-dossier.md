...
- External category reference: `evobc-cat-12090`
- Source category ID: `12090`
- Source label for human review: `𦬘`
- Source codepoints: `U+26B18`
...
- `obs-evo-cand-012090-route-category-staging`
...
- `obs-evo-cand-012090-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012090-route-evolution-graph`
