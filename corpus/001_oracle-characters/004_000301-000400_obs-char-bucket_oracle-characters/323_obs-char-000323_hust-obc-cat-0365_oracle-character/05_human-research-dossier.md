# obs-char-000323 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/323_obs-char-000323_hust-obc-cat-0365_orac
  le-character/03_visual-assets/001_asset-000328_hust-obc-cat-0365_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0365/G_0365_乙1671合21207𠂤歷間.png`
- asset id: `asset-000328`
...
- source category: `0365`
- validation class: `322`
- source image route: `HUST-OBC/deciphered/0365/G_0365_乙1671合21207𠂤歷間.png`
- asset id: `asset-000328`
...
- English observation: `The image has a central branching vertical stroke, a
  small oval enclosure, and a broad curved base with an irregular lower
  edge.`
...
- dataset label text: `㕣`
- dataset label codepoints: `U+3563`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00029`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00029`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00029`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/029_obs-evo-can
  d-000029_evobc-cat-00029_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/029_obs-evo-cand-000029_evobc-cat-00029_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合21207
  (G_0365_乙1671合21207𠂤歷間.png)`
...
- Which source records identify obs-char-000323 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000323？
