# obs-unk-004842 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004842`
- primary external id: `hust-obc-und-X-004842`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/042_obs-unk-004842_h
  ust-obc-und-X-004842_oracle-character-candidate/03_visual-assets/001_asset
  -006435_hust-obc-und-X-004842_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/398/X_？_7384_1.png`
- asset id: `asset-006435`
...
- source class: `HUST-OBC/undeciphered/X/398/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/398/X_？_7384_1.png`
- asset id: `asset-006435`
...
- English observation: `branching left group and rounded right opening`
- 中文观察: `左侧分支结构和右侧圆形开口`
...
- Which source records identify obs-unk-004842 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004842？
