...
Project ID: `obs-evo-cand-009144`
...
- Project ID: `obs-evo-cand-009144`
- EVOBC category candidate ID: `evobc-evo-cat-09144`
- External category reference: `evobc-cat-09144`
- Source category ID: `09144`
- Source label for human review: `郚`
- Source codepoints: `U+90DA`
...
- `obs-evo-cand-009144-route-category-staging`
...
- `obs-evo-cand-009144-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009144-route-evolution-graph`
