# obs-char-001545 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001545`
- primary external id: `hust-obc-cat-1734`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1545_obs-char-001545_hust-obc-cat-1734_ora
  cle-character/03_visual-assets/001_asset-001550_hust-obc-cat-1734_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1734/G_1734_合28387何組.png`
- asset id: `asset-001550`
...
- source category: `1734`
- validation class: `1544`
- source image route: `HUST-OBC/deciphered/1734/G_1734_合28387何組.png`
- asset id: `asset-001550`
...
- English observation: `A small dark mark combines short crossing diagonals
  around a central core.`
- 中文观察: `小型深色标记以中央核心结合数条短交叉斜笔。`
...
- dataset label text: `㪼`
- dataset label codepoints: `U+3ABC`
...
- filename catalog route clues: `Heji-like filename clue: 合28387
  (G_1734_合28387何組.png)`
...
- Which source records identify obs-char-001545 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001545？
