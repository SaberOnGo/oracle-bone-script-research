# obs-char-000543 Archaeology Paleography Review

# obs-char-000543 考古文字复核档案
...
- first local image: `001_asset-000548_hust-obc-cat-0617_glyph.png`
- first source image: `G_0617_京津2632(甲).png`
...
- source label text: `㙟`
- source label codepoints: `U+365F`
