# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002679
...
| --- | --- | --- | --- |
| `obimd-glyph-link-040784` | 󿬅 | `U+FFB05` | `reviewed_metadata_only` |
| `obimd-glyph-link-040785` | 󿇇 | `U+FF1C7` | `reviewed_metadata_only` |
