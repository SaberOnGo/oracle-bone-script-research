...
- Project ID: `obs-evo-cand-008327`
- EVOBC category candidate ID: `evobc-evo-cat-08327`
- External category reference: `evobc-cat-08327`
- Source category ID: `08327`
- Source label for human review: `謧`
- Source codepoints: `U+8B27`
...
- `obs-evo-cand-008327-route-category-staging`
...
- `obs-evo-cand-008327-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008327-route-evolution-graph`
