...
- External category reference: `evobc-cat-11164`
- Source category ID: `11164`
- Source label for human review: `𢌻`
...
- `obs-evo-cand-011164-route-category-staging`
...
- `obs-evo-cand-011164-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011164-route-evolution-graph`
