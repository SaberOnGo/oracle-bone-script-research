...
- Project ID: `obs-evo-cand-001020`
- EVOBC category candidate ID: `evobc-evo-cat-01020`
- External category reference: `evobc-cat-01020`
- Source category ID: `01020`
- Source label for human review: `僟`
- Source codepoints: `U+50DF`
...
- `obs-evo-cand-001020-route-category-staging`
...
- `obs-evo-cand-001020-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001020-route-evolution-graph`
