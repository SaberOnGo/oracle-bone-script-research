# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001864
...
| Glyph or codepoint route / 字形或码位路线 | 1 OBIMD route rows; examples U+FAB0A | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
