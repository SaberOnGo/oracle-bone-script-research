# obs-char-000389 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/389_obs-char-000389_hust-obc-cat-0441_orac
  le-character/03_visual-assets/001_asset-000394_hust-obc-cat-0441_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0441/H_0441_611B1_0.png`
- asset id: `asset-000394`
...
- source category: `0441`
- validation class: `388`
- source image route: `HUST-OBC/deciphered/0441/H_0441_611B1_0.png`
- asset id: `asset-000394`
...
- English observation: `Two separated forms are visible: an upper forked
  stem with side branches and a detached lower V-shaped loop.`
- 中文观察: `可见两个分离形体：上方为带侧向分支的分叉主干，下方为独立 V 状环形轮廓。`
...
- dataset label text: `㖯`
- dataset label codepoints: `U+35AF`
...
- filename catalog route clues: `catalog-like filename clue: H_0441
  (H_0441_611B1_0.png)`
...
- Which source records identify obs-char-000389 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000389？
