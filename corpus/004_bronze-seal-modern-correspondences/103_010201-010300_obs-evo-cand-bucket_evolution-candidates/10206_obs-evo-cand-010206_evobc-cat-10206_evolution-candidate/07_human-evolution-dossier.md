...
Project ID: `obs-evo-cand-010206`
...
- Project ID: `obs-evo-cand-010206`
- EVOBC category candidate ID: `evobc-evo-cat-10206`
- External category reference: `evobc-cat-10206`
- Source category ID: `10206`
- Source label for human review: `駽`
- Source codepoints: `U+99FD`
...
- `obs-evo-cand-010206-route-category-staging`
...
- `obs-evo-cand-010206-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010206-route-evolution-graph`
