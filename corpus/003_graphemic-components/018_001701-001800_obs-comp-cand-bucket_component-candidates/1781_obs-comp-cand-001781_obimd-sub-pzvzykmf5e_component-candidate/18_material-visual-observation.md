# Material Visual Observation / obs-comp-cand-001781 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001781`
- External reference / 外部参照: `obimd-sub-pzvzykmf5e`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018002_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/pzvzykmf5e/pzvzykmf5e/pzvzykmf5e.png`
- Checksum / 校验和:
  `bb7b85f527be0e24699e29dff92879427b108c5d6ecc3b9851269d787b8e2dab`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.20%.
- Marked-pixel bounds: (62,55)–(199,195); span 138 × 141 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.20%。
- 痕迹范围：(62,55)–(199,195)；跨度138 × 141 px；痕迹矩形近方形。
