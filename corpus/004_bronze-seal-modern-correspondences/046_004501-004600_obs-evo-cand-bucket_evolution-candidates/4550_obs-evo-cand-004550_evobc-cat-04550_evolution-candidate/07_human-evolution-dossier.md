...
Project ID: `obs-evo-cand-004550`
...
- Project ID: `obs-evo-cand-004550`
- EVOBC category candidate ID: `evobc-evo-cat-04550`
- External category reference: `evobc-cat-04550`
- Source category ID: `04550`
- Source label for human review: `沦`
- Source codepoints: `U+6CA6`
...
- `obs-evo-cand-004550-route-category-staging`
...
- `obs-evo-cand-004550-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004550-route-evolution-graph`
