...
- External category reference: `evobc-cat-07297`
- Source category ID: `07297`
- Source label for human review: `苽`
...
- `obs-evo-cand-007297-route-category-staging`
...
- `obs-evo-cand-007297-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007297-route-evolution-graph`
