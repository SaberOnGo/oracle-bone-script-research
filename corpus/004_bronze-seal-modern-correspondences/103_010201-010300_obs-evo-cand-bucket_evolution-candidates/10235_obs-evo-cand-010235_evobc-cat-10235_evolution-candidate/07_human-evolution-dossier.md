...
Project ID: `obs-evo-cand-010235`
...
- Project ID: `obs-evo-cand-010235`
- EVOBC category candidate ID: `evobc-evo-cat-10235`
- External category reference: `evobc-cat-10235`
- Source category ID: `10235`
- Source label for human review: `騰`
- Source codepoints: `U+9A30`
...
- `obs-evo-cand-010235-route-category-staging`
...
- `obs-evo-cand-010235-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010235-route-evolution-graph`
