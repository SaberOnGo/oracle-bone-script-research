...
- External category reference: `evobc-cat-01106`
- Source category ID: `01106`
- Source label for human review: `冀`
- Source codepoints: `U+5180`
...
- `obs-evo-cand-001106-route-category-staging`
...
- `obs-evo-cand-001106-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001106-route-evolution-graph`
