...
- `obs-evo-cand-004597-route-category-staging`
...
- `obs-evo-cand-004597-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004597-route-evolution-graph`
