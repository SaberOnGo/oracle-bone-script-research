# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013383
...
- EVOBC candidate category: `evobc-evo-cat-13383`.
- Source label for search only: `𬪌`.
- Source codepoints for search only: `U+2CA8C`.
