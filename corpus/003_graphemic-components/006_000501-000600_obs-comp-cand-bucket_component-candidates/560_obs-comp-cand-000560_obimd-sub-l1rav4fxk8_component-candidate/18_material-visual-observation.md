# Material Visual Observation / obs-comp-cand-000560 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000560`
- External reference / 外部参照: `obimd-sub-l1rav4fxk8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012812_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/l1rav4fxk8/l1rav4fxk8/l1rav4fxk8.png`
- Checksum / 校验和:
  `9669de7fcd9fd1b934d44623a0fe47a06cae64e9481e8f677f07f6652073aa37`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.40%.
- Marked-pixel bounds: (78,19)–(171,229); span 94 × 211 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.40%。
- 痕迹范围：(78,19)–(171,229)；跨度94 × 211 px；痕迹矩形高于宽。
