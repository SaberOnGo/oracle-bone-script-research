# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004400
...
- EVOBC candidate category: `evobc-evo-cat-04400`.
- Source label for search only: `歺`.
- Source codepoints for search only: `U+6B7A`.
