# obs-unk-000442 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/021_undeciphered-000
  401-000500_obs-unk-bucket_oracle-character-candidates/042_obs-unk-000442_h
  ust-obc-und-L-000442_oracle-character-candidate/03_visual-assets/001_asset
  -002035_hust-obc-und-L-000442_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/442/L_？_1138.jpg`
- asset id: `asset-002035`
...
- source class: `HUST-OBC/undeciphered/L/442/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/442/L_？_1138.jpg`
- asset id: `asset-002035`
...
- Which source records identify obs-unk-000442 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000442？
