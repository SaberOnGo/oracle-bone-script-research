...
- External category reference: `evobc-cat-07732`
- Source category ID: `07732`
- Source label for human review: `蚚`
...
- `obs-evo-cand-007732-route-category-staging`
...
- `obs-evo-cand-007732-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007732-route-evolution-graph`
