...
- External category reference: `evobc-cat-12708`
- Source category ID: `12708`
- Source label for human review: `𩼪`
- Source codepoints: `U+29F2A`
- Image reference count in source metadata: `10`
...
- `obs-evo-cand-012708-route-category-staging`
...
- `obs-evo-cand-012708-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012708-route-evolution-graph`
