# Material Visual Observation / obs-comp-cand-000664 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000664`
- External reference / 外部参照: `obimd-sub-pc30r8fiiw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013227_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/pc30r8fiiw/pc30r8fiiw/pc30r8fiiw.png`
- Checksum / 校验和:
  `c02b7ff998a9e30185650e86e4c47b20b14e174d84636935e360e6f9ea26f16f`
...
- Marked-pixel bounds: (80,26)–(169,225); span 90 × 200 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.66%。
- 痕迹范围：(80,26)–(169,225)；跨度90 × 200 px；痕迹矩形高于宽。
