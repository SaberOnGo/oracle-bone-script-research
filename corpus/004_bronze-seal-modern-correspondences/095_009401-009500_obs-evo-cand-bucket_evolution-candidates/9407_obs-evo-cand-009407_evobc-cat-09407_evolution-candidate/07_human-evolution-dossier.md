...
- External category reference: `evobc-cat-09407`
- Source category ID: `09407`
...
- `obs-evo-cand-009407-route-category-staging`
...
- `obs-evo-cand-009407-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009407-route-evolution-graph`
