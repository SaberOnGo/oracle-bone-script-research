# Material Visual Observation / obs-comp-cand-000470 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000470`
- External reference / 外部参照: `obimd-sub-90a3utk2wf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012622_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/90a3utk2wf/90a3utk2wf/90a3utk2wf.png`
- Checksum / 校验和:
  `78375e7036ada5c7dd6fba7d9309e94d0d3b380bed4f82a907edb478dc53de39`
...
- Marked-pixel bounds: (77,28)–(172,213); span 96 × 186 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.48%。
- 痕迹范围：(77,28)–(172,213)；跨度96 × 186 px；痕迹矩形高于宽。
