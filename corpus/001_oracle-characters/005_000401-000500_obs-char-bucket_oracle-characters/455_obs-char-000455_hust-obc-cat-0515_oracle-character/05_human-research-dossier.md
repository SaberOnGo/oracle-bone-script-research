# obs-char-000455 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000455`
- primary external id: `hust-obc-cat-0515`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/455_obs-char-000455_hust-obc-cat-0515_orac
  le-character/03_visual-assets/001_asset-000460_hust-obc-cat-0515_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0515/G_0515_京津4768合31217何組.png`
- asset id: `asset-000460`
...
- source category: `0515`
- validation class: `454`
- source image route: `HUST-OBC/deciphered/0515/G_0515_京津4768合31217何組.png`
- asset id: `asset-000460`
...
- English observation: `Two separated forms are visible: an oval-topped form
  on a forked curved stem at left, and a vertical looped form with a
  detached small diamond at right.`
- 中文观察: `可见两个分离形体：左侧椭圆顶部连接分叉弯曲主干，右侧竖向环曲并有分离的小菱形。`
...
- dataset label text: `㗹`
- dataset label codepoints: `U+35F9`
...
- filename catalog route clues: `Heji-like filename clue: 合31217
  (G_0515_京津4768合31217何組.png)`
...
- Which source records identify obs-char-000455 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000455？
