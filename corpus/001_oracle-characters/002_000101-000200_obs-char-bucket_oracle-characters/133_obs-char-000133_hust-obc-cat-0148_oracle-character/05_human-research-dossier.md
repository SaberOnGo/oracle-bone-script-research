# obs-char-000133 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/133_obs-char-000133_hust-obc-cat-0148_orac
  le-character/03_visual-assets/001_asset-000138_hust-obc-cat-0148_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0148/G_0148_京津4833合28055.png`
- asset id: `asset-000138`
...
- source category: `0148`
- validation class: `132`
- source image route: `HUST-OBC/deciphered/0148/G_0148_京津4833合28055.png`
- asset id: `asset-000138`
...
- English observation: `The image has a tall central vertical stroke, a
  short horizontal cross near the top, and separate curved strokes on both
  sides.`
...
- dataset label text: `㒊`
- dataset label codepoints: `U+348A`
...
- filename catalog route clues: `Heji-like filename clue: 合28055
  (G_0148_京津4833合28055.png)`
...
- Which source records identify obs-char-000133 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000133？
