...
- External category reference: `evobc-cat-06928`
- Source category ID: `06928`
- Source label for human review: `耳`
...
- `obs-evo-cand-006928-route-category-staging`
...
- `obs-evo-cand-006928-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006928-route-evolution-graph`
