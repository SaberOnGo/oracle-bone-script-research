...
Project ID: `obs-evo-cand-013209`
...
- Project ID: `obs-evo-cand-013209`
- EVOBC category candidate ID: `evobc-evo-cat-13209`
- External category reference: `evobc-cat-13209`
- Source category ID: `13209`
- Source label for human review: `𬆁`
- Source codepoints: `U+2C181`
...
- `obs-evo-cand-013209-route-category-staging`
...
- `obs-evo-cand-013209-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013209-route-evolution-graph`
