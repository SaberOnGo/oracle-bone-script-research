...
- External category reference: `evobc-cat-11141`
- Source category ID: `11141`
- Source label for human review: `𢃺`
- Source codepoints: `U+220FA`
...
- `obs-evo-cand-011141-route-category-staging`
...
- `obs-evo-cand-011141-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011141-route-evolution-graph`
