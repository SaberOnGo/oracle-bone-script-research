# Material Visual Observation / obs-comp-cand-001552 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001552`
- External reference / 外部参照: `obimd-sub-cdd4p6xm9e`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016966_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cdd4p6xm9e/cdd4p6xm9e/cdd4p6xm9e.png`
- Checksum / 校验和:
  `358dd6bfd15e1e7b67c7fdcad77c66538aa0e35cf5e492835ae0c0514922b14e`
...
- Marked-pixel bounds: (89,37)–(159,205); span 71 × 169 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.25%。
- 痕迹范围：(89,37)–(159,205)；跨度71 × 169 px；痕迹矩形高于宽。
