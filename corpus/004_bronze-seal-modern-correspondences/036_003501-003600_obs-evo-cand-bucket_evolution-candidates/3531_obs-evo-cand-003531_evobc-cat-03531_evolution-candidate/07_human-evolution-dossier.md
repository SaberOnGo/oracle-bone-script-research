...
- External category reference: `evobc-cat-03531`
- Source category ID: `03531`
- Source label: `擪`
...
- `obs-evo-cand-003531-route-category-staging`
...
- `obs-evo-cand-003531-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003531-route-evolution-graph`
