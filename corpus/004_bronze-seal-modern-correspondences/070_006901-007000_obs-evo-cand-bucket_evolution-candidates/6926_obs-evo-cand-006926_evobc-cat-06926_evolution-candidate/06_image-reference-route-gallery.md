...
- `obs-evo-cand-006926-route-category-staging`
...
- `obs-evo-cand-006926-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006926-route-evolution-graph`
