# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000544
...
- EVOBC candidate category: `evobc-evo-cat-00544`.
- Source label for search only: `䪜`.
- Source codepoints for search only: `U+4A9C`.
