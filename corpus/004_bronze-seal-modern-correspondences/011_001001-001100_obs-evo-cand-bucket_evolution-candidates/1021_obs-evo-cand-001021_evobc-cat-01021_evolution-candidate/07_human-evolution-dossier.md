...
Project ID: `obs-evo-cand-001021`
...
- Project ID: `obs-evo-cand-001021`
- EVOBC category candidate ID: `evobc-evo-cat-01021`
- External category reference: `evobc-cat-01021`
- Source category ID: `01021`
- Source label for human review: `僤`
- Source codepoints: `U+50E4`
...
- `obs-evo-cand-001021-route-category-staging`
...
- `obs-evo-cand-001021-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001021-route-evolution-graph`
