...
- `obs-evo-cand-009583-route-category-staging`
...
- `obs-evo-cand-009583-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009583-route-evolution-graph`
