# Material Visual Observation / obs-comp-cand-002617 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002617`
- External reference / 外部参照: `obimd-sub-rbfxjlia3f`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021156_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rbfxjlia3f/rbfxjlia3f/rbfxjlia3f.png`
- Checksum / 校验和:
  `ae5b9f3c94a4504c22db7dac7cf946650a3f86d33bbfdde4c0f9ce03587ccb33`
...
- Marked-pixel bounds: (85,19)–(159,233); span 75 × 215 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.09%。
- 痕迹范围：(85,19)–(159,233)；跨度75 × 215 px；痕迹矩形高于宽。
