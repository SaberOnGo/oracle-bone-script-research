# obs-unk-004043 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004043`
- primary external id: `hust-obc-und-L-004043`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/043_obs-unk-004043_h
  ust-obc-und-L-004043_oracle-character-candidate/03_visual-assets/001_asset
  -005636_hust-obc-und-L-004043_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4043/L_？_8637.jpg`
- asset id: `asset-005636`
...
- source class: `HUST-OBC/undeciphered/L/4043/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4043/L_？_8637.jpg`
- asset id: `asset-005636`
...
- English observation: The upper half contains two angular, closed-looking
  outlines with a narrow gap between them. Short diagonal traces descend
  toward a lower crossing or fork. The outer edges and joins are not fully
  clear in this crop.
...
- Which source records identify obs-unk-004043 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004043？
