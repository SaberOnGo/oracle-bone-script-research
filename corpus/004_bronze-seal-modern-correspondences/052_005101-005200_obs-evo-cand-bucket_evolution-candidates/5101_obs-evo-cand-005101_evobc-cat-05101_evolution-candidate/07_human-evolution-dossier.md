...
- External category reference: `evobc-cat-05101`
- Source category ID: `05101`
- Source label for human review: `煇`
- Source codepoints: `U+7147`
...
- `obs-evo-cand-005101-route-category-staging`
...
- `obs-evo-cand-005101-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005101-route-evolution-graph`
