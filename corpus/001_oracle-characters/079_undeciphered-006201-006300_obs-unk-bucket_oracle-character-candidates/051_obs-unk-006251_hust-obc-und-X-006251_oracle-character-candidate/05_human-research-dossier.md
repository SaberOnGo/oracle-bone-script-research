# obs-unk-006251 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006251`
- primary external id: `hust-obc-und-X-006251`
...
- local review image route: `corpus/001_oracle-characters/079_undeciphered-006
  201-006300_obs-unk-bucket_oracle-character-candidates/051_obs-unk-006251_h
  ust-obc-und-X-006251_oracle-character-candidate/03_visual-assets/001_asset
  -007843_hust-obc-und-X-006251_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1807/X_？_4662_1.png`
- asset id: `asset-007843`
...
- source class: `HUST-OBC/undeciphered/X/1807/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1807/X_？_4662_1.png`
- asset id: `asset-007843`
...
- Which source records identify obs-unk-006251 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006251？
