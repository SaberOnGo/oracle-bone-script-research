# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002717
...
| Glyph or codepoint route / 字形或码位路线 | 4 OBIMD route rows; examples U+FF541; U+FF542; 另有 2 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
