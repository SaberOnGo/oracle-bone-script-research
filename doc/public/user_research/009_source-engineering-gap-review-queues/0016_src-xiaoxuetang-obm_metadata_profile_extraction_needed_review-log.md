...
- Review log draft ID / 复核日志草稿 ID: `source-engineering-gap-review-log-draft-0016`
...
- Evidence snapshot ID / 证据快照 ID: `source-engineering-gap-evidence-snapshot-0016`
- Evidence status / 证据状态: `metadata_only_existing_records_snapshot`
- Source review status / 来源复核状态: `reviewed`
- Rights status / 权利状态: `metadata_only_until_verified`
- Download manifest IDs / 下载 manifest ID: `dl-xxt-obm-example;dl-xxt-obm-guide;dl-xxt-obm-appendix01;dl-xxt-obm-appendix02`
- Download log IDs / 下载日志 ID: `dl-xxt-obm-example;dl-xxt-obm-guide;dl-xxt-obm-appendix01;dl-xxt-obm-appendix02`
...
- package_file_ids: `pkg-file-000032;pkg-file-000033;pkg-file-000034;pkg-file-000035`
