# obs-comp-cand-002044 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002044`
- 首选外部 ID: `obimd-sub-gylityx9if`
- OBIMD subcharacter UID: `gylityx9if`
...
- codepoint 示例: U+FBC20; U+FBC21; 另有 21 项
