# obs-char-000657 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000657`
- primary external id: `hust-obc-cat-0745`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/657_obs-char-000657_hust-obc-cat-0745_orac
  le-character/03_visual-assets/001_asset-000662_hust-obc-cat-0745_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0745/G_0745_乙5162(甲).png`
- asset id: `asset-000662`
...
- source category: `0745`
- validation class: `656`
- source image route: `HUST-OBC/deciphered/0745/G_0745_乙5162(甲).png`
- asset id: `asset-000662`
...
- English observation: `A branching left stem contains a small square middle
  loop and a long pointed descent; a detached curved right stem carries
  short upper and lower branches.`
- 中文观察: `分枝左干含小方形中环和长尖下笔；分离弯曲右干带短上枝和下枝。`
...
- dataset label text: `㛟`
- dataset label codepoints: `U+36DF`
...
- Which source records identify obs-char-000657 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000657？
