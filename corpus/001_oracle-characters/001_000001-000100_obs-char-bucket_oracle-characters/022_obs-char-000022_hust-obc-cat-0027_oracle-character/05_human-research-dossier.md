# obs-char-000022 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000022`
- primary external id: `hust-obc-cat-0027`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/022_obs-char-000022_hust-obc-cat-0027_orac
  le-character/03_visual-assets/001_asset-000027_hust-obc-cat-0027_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0027/G_0027_前2.2.6合36416黃組.png`
- asset id: `asset-000027`
...
- source category: `0027`
- validation class: `21`
- source image route: `HUST-OBC/deciphered/0027/G_0027_前2.2.6合36416黃組.png`
- asset id: `asset-000027`
...
- English observation: `The compact image has two upright side strokes, a
  short upper cross stroke, and a rounded lower bowl crossed by a horizontal
  mark.`
- 中文观察: `紧凑图像含两条竖向侧笔画、上方短横画，以及被横痕穿过的下部圆弧框。`
...
- dataset label text: `㐑`
- dataset label codepoints: `U+3411`
...
- filename catalog route clues: `Heji-like filename clue: 合36416
  (G_0027_前2.2.6合36416黃組.png)`
...
- Which source records identify obs-char-000022 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000022？
