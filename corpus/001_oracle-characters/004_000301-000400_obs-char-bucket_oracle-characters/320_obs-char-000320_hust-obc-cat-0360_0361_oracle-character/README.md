# obs-char-000320 Local Object Materials / obs-char-000320 本地对象资料
...
- Project ID / 项目 ID: `obs-char-000320`
- Primary external reference / 首选外部参考: `hust-obc-cat-0360_0361`
- Source / 来源: `src-hust-obc`
- Packet record type / 资料包类型: `oracle_character_candidate_packet`
- Directory / 目录: `corpus/001_oracle-characters/004_000301-000400_obs-char-bucke
  t_oracle-characters/320_obs-char-000320_hust-obc-cat-0360_0361_oracle-characte
  r`
...
- Committed glyph image / 已提交字形图像:
  03_visual-assets/001_asset-000325_hust-obc-cat-0360_0361_glyph.png
