# Material Visual Observation / obs-comp-cand-002085 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002085`
- External reference / 外部参照: `obimd-sub-u7v6rlhp81`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019472_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/u7v6rlhp81/u7v6rlhp81/01mc8bd0do.png`
- Checksum / 校验和:
  `edf8f6f18be3e1a66f0e82eed92d629296d26a1cac2ffd0762710ce085ae81a1`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.84%.
- Marked-pixel bounds: (71,31)–(178,214); span 108 × 184 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.84%。
- 痕迹范围：(71,31)–(178,214)；跨度108 × 184 px；痕迹矩形高于宽。
