# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001755
...
| --- | --- | --- | --- |
| `obimd-glyph-link-027021` | 򧔚󺈾 | `U+A751A;U+FA23E` | `reviewed_metadata_only` |
| `obimd-glyph-link-027022` | 󺈿 | `U+FA23F` | `reviewed_metadata_only` |
