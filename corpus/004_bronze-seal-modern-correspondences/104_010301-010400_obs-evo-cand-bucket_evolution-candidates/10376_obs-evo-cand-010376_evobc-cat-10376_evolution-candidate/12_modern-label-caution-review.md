# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010376
...
- EVOBC candidate category: `evobc-evo-cat-10376`.
- Source label for search only: `魯`.
- Source codepoints for search only: `U+9B6F`.
