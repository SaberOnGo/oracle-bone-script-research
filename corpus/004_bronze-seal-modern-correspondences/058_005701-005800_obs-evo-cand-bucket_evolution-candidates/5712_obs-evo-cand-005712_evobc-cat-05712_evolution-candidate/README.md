# obs-evo-cand-005712 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-005712`
- EVOBC category candidate ID: `evobc-evo-cat-05712`
- External category ref: `evobc-cat-05712`
- Source label: `發`
- Source codepoints: `U+767C`
- Image reference count: `81`
- Era token counts: `BI:7;CS:1;OBC:37;SAC:5;SS:1;WSC:30`
- Source token counts: `Book:50;Web:31`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 37 image references
