# obs-unk-009336 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-009336`
- primary external id: `hust-obc-und-YH-009336`
...
- local review image route: `corpus/001_oracle-characters/110_undeciphered-009
  301-009400_obs-unk-bucket_oracle-character-candidates/036_obs-unk-009336_h
  ust-obc-und-YH-009336_oracle-character-candidate/03_visual-assets/001_asse
  t-010927_hust-obc-und-YH-009336_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/616C8/H_？_616C8_0.png`
- asset id: `asset-010927`
...
- source class: `HUST-OBC/undeciphered/Y+H/616C8/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/616C8/H_？_616C8_0.png`
- asset id: `asset-010927`
...
- Which source records identify obs-unk-009336 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009336？
