...
Project ID: `obs-evo-cand-004753`
...
- Project ID: `obs-evo-cand-004753`
- EVOBC category candidate ID: `evobc-evo-cat-04753`
- External category reference: `evobc-cat-04753`
- Source category ID: `04753`
- Source label for human review: `渙`
- Source codepoints: `U+6E19`
...
- `obs-evo-cand-004753-route-category-staging`
...
- `obs-evo-cand-004753-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004753-route-evolution-graph`
