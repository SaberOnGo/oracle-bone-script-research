# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000693
...
| --- | --- | --- | --- |
| `obimd-glyph-link-010031` | 󳽖 | `U+F3F56` | `reviewed_metadata_only` |
| `obimd-glyph-link-010032` | 󳽗 | `U+F3F57` | `reviewed_metadata_only` |
