# obs-unk-002781 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002781`
- primary external id: `hust-obc-und-L-002781`
...
- local review image route: `corpus/001_oracle-characters/044_undeciphered-002
  701-002800_obs-unk-bucket_oracle-character-candidates/081_obs-unk-002781_h
  ust-obc-und-L-002781_oracle-character-candidate/03_visual-assets/001_asset
  -004374_hust-obc-und-L-002781_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2781/L_？_4580.jpg`
- asset id: `asset-004374`
...
- source class: `HUST-OBC/undeciphered/L/2781/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2781/L_？_4580.jpg`
- asset id: `asset-004374`
...
- Which source records identify obs-unk-002781 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002781？
