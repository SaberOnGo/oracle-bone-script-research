...
Project ID: `obs-evo-cand-005259`
...
- Project ID: `obs-evo-cand-005259`
- EVOBC category candidate ID: `evobc-evo-cat-05259`
- External category reference: `evobc-cat-05259`
- Source category ID: `05259`
- Source label for human review: `狄`
- Source codepoints: `U+72C4`
...
- `obs-evo-cand-005259-route-category-staging`
...
- `obs-evo-cand-005259-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005259-route-evolution-graph`
