# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-007170
...
- EVOBC candidate category: `evobc-evo-cat-07170`.
- Source label for search only: `臱`.
- Source codepoints for search only: `U+81F1`.
