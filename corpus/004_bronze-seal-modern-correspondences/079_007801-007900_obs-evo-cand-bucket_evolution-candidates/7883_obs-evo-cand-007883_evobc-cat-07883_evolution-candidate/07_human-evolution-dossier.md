...
- External category reference: `evobc-cat-07883`
- Source category ID: `07883`
- Source label for human review: `蠢`
- Source codepoints: `U+8822`
...
- `obs-evo-cand-007883-route-category-staging`
...
- `obs-evo-cand-007883-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007883-route-evolution-graph`
