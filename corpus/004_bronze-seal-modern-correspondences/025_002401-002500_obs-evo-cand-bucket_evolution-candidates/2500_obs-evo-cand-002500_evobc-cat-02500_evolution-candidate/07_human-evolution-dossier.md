...
- External category reference: `evobc-cat-02500`
- Source category ID: `02500`
- Source label for human review: `届`
- Source codepoints: `U+5C4A`
...
- `obs-evo-cand-002500-route-category-staging`
...
- `obs-evo-cand-002500-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002500-route-evolution-graph`
