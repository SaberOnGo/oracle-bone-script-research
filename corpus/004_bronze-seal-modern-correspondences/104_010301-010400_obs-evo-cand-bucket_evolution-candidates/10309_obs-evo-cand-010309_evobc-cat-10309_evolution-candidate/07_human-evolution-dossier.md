...
- External category reference: `evobc-cat-10309`
- Source category ID: `10309`
- Source label for human review: `髙`
...
- `obs-evo-cand-010309-route-category-staging`
...
- `obs-evo-cand-010309-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010309-route-evolution-graph`
