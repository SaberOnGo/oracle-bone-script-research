# Material Visual Observation / obs-comp-cand-000223 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000223`
- External reference / 外部参照: `obimd-sub-35mlsnk38c`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011868_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/35mlsnk38c/35mlsnk38c/35mlsnk38c.png`
- Checksum / 校验和:
  `8bb3eec54d3806259a4e45b663699228f7b18300e0d0b5984ca14dba26253663`
...
- Marked-pixel bounds: (55,24)–(194,227); span 140 × 204 px; the marked
...
- 痕迹范围：(55,24)–(194,227)；跨度140 × 204 px；痕迹矩形高于宽。
