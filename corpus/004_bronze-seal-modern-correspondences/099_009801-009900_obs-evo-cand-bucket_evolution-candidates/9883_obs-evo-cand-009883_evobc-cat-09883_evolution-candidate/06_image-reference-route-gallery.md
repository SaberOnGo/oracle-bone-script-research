...
- `obs-evo-cand-009883-route-category-staging`
...
- `obs-evo-cand-009883-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009883-route-evolution-graph`
