# obs-char-000175 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/175_obs-char-000175_hust-obc-cat-0192_orac
  le-character/03_visual-assets/001_asset-000180_hust-obc-cat-0192_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0192/G_0192_京津1341合3399賓組.png`
- asset id: `asset-000180`
...
- source category: `0192`
- validation class: `174`
- source image route: `HUST-OBC/deciphered/0192/G_0192_京津1341合3399賓組.png`
- asset id: `asset-000180`
...
- English observation: `The image has a broad forked upper form, a narrow
  central descending stroke, and a small curved lower continuation.`
- 中文观察: `图像上方有宽分叉形，中部有窄下行主笔，下方接小段弯曲延续笔。`
...
- dataset label text: `㒶`
- dataset label codepoints: `U+34B6`
...
- filename catalog route clues: `Heji-like filename clue: 合3399
  (G_0192_京津1341合3399賓組.png)`
...
- Which source records identify obs-char-000175 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000175？
