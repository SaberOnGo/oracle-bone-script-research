# obs-char-000415 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000415`
- primary external id: `hust-obc-cat-0471`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/415_obs-char-000415_hust-obc-cat-0471_orac
  le-character/03_visual-assets/001_asset-000420_hust-obc-cat-0471_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0471/L_0471_12474.jpg`
- asset id: `asset-000420`
...
- source category: `0471`
- validation class: `414`
- source image route: `HUST-OBC/deciphered/0471/L_0471_12474.jpg`
- asset id: `asset-000420`
...
- English observation: `The small low-contrast image contains several
  separated marks, including an upper open rectangle, a crossed loop, and
  lower angled traces; contrast needs recheck.`
- 中文观察: `小幅低对比度图像含数个分离痕迹，包括上部开放矩形、交叉环形和下部折角痕迹；对比度需要复核。`
...
- dataset label text: `㗍`
- dataset label codepoints: `U+35CD`
...
- Which source records identify obs-char-000415 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000415？
