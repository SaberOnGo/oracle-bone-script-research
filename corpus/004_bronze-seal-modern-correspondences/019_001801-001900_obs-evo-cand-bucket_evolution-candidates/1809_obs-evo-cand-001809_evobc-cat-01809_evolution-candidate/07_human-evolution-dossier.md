...
- Project ID: `obs-evo-cand-001809`
- EVOBC category candidate ID: `evobc-evo-cat-01809`
- External category reference: `evobc-cat-01809`
- Source category ID: `01809`
- Source label for human review: `坉`
- Source codepoints: `U+5749`
...
- `obs-evo-cand-001809-route-category-staging`
...
- `obs-evo-cand-001809-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001809-route-evolution-graph`
