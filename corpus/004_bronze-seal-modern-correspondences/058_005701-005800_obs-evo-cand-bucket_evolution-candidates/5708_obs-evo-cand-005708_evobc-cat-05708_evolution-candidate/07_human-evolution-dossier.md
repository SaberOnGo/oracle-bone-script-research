...
- External category reference: `evobc-cat-05708`
- Source category ID: `05708`
- Source label for human review: `癶`
...
- `obs-evo-cand-005708-route-category-staging`
...
- `obs-evo-cand-005708-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005708-route-evolution-graph`
