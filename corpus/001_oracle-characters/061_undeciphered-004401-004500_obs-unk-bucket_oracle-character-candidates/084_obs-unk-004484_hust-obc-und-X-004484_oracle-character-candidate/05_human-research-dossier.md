# obs-unk-004484 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/084_obs-unk-004484_h
  ust-obc-und-X-004484_oracle-character-candidate/03_visual-assets/001_asset
  -006077_hust-obc-und-X-004484_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/40/X_？_8220_1.png`
- asset id: `asset-006077`
...
- source class: `HUST-OBC/undeciphered/X/40/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/40/X_？_8220_1.png`
- asset id: `asset-006077`
...
- English observation: Adjacent groups show a left framed opening and a right
  rounded opening above split lower traces.
- 中文观察: 相邻痕迹中左侧有框状开口，右侧圆弧开口下方有分叉痕迹。
...
- Which source records identify obs-unk-004484 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004484？
