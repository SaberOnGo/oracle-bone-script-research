# obs-char-000812 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000812`
- primary external id: `hust-obc-cat-0920`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/812_obs-char-000812_hust-obc-cat-0920_orac
  le-character/03_visual-assets/001_asset-000817_hust-obc-cat-0920_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0920/L_0920_1597.jpg`
- asset id: `asset-000817`
...
- source category: `0920`
- validation class: `811`
- source image route: `HUST-OBC/deciphered/0920/L_0920_1597.jpg`
- asset id: `asset-000817`
...
- English observation: `The tiny gray image shows several short dark
  diagonal marks in two loose groups; exact joins and orientation are
  unclear.`
- 中文观察: `微小灰度图像显示数条短小深色斜笔，分布在两个疏松笔群中；具体连接和方向难以判明。`
...
- dataset label text: `㞎`
- dataset label codepoints: `U+378E`
...
- Which source records identify obs-char-000812 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000812？
