# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008156
...
- EVOBC candidate category: `evobc-evo-cat-08156`.
- Source label for search only: `許`.
- Source codepoints for search only: `U+8A31`.
