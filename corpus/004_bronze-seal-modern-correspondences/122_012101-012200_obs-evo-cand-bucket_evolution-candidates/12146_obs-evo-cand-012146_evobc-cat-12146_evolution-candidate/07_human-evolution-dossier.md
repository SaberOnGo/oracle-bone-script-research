...
- External category reference: `evobc-cat-12146`
- Source category ID: `12146`
- Source label for human review: `𧈂`
...
- `obs-evo-cand-012146-route-category-staging`
...
- `obs-evo-cand-012146-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012146-route-evolution-graph`
