...
- External category reference: `evobc-cat-11717`
- Source category ID: `11717`
- Source label for human review: `𤹂`
- Source codepoints: `U+24E42`
...
- `obs-evo-cand-011717-route-category-staging`
...
- `obs-evo-cand-011717-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011717-route-evolution-graph`
