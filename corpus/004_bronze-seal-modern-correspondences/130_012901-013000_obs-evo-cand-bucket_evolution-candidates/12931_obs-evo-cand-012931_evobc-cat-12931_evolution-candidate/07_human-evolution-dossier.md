...
- External category reference: `evobc-cat-12931`
- Source category ID: `12931`
- Source label for human review: `𫌵`
...
- `obs-evo-cand-012931-route-category-staging`
...
- `obs-evo-cand-012931-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012931-route-evolution-graph`
