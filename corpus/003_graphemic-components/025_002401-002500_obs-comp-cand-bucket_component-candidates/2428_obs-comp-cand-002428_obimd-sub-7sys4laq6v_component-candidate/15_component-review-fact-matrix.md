# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002428
...
| Glyph or codepoint route / 字形或码位路线 | 53 OBIMD route rows; examples U+5E9A;U+FDD87; U+FDD88; 另有 51 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 53 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
