# obs-char-001488 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1488_obs-char-001488_hust-obc-cat-1670_ora
  cle-character/03_visual-assets/001_asset-001493_hust-obc-cat-1670_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1670/G_1670_前1.33.7合19987.png`
- asset id: `asset-001493`
...
- source category: `1670`
- validation class: `1487`
- source image route: `HUST-OBC/deciphered/1670/G_1670_前1.33.7合19987.png`
- asset id: `asset-001493`
...
- English observation: `A narrow curved stem has detached short marks and
  central branches.`
...
- dataset label text: `㩼`
- dataset label codepoints: `U+3A7C`
...
- filename catalog route clues: `Heji-like filename clue: 合19987
...
- Which source records identify obs-char-001488 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001488？
