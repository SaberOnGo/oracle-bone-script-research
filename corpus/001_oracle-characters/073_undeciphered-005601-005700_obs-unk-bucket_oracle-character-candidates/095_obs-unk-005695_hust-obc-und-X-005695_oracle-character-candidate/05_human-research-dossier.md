# obs-unk-005695 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/073_undeciphered-005
  601-005700_obs-unk-bucket_oracle-character-candidates/095_obs-unk-005695_h
  ust-obc-und-X-005695_oracle-character-candidate/03_visual-assets/001_asset
  -007288_hust-obc-und-X-005695_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1251/X_？_1161_1.png`
- asset id: `asset-007288`
...
- source class: `HUST-OBC/undeciphered/X/1251/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1251/X_？_1161_1.png`
- asset id: `asset-007288`
...
- Which source records identify obs-unk-005695 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005695？
