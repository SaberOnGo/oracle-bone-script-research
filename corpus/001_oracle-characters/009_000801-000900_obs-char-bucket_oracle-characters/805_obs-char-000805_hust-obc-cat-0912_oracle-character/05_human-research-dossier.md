# obs-char-000805 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000805`
- primary external id: `hust-obc-cat-0912`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/805_obs-char-000805_hust-obc-cat-0912_orac
  le-character/03_visual-assets/001_asset-000810_hust-obc-cat-0912_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0912/G_0912_乙276(甲).png`
- asset id: `asset-000810`
...
- source category: `0912`
- validation class: `804`
- source image route: `HUST-OBC/deciphered/0912/G_0912_乙276(甲).png`
- asset id: `asset-000810`
...
- English observation: `A narrow pointed form has a small upper loop, a long
  descending stem, and several short side branches that taper toward the
  bottom.`
- 中文观察: `狭长尖形上部有小环，中部为延伸的细竖干，下方有数条短侧枝并向下收尖。`
...
- dataset label text: `㞆`
- dataset label codepoints: `U+3786`
...
- Which source records identify obs-char-000805 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000805？
