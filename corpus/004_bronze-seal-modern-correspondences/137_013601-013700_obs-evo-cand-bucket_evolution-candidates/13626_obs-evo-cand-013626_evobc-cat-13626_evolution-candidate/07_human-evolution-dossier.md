...
Project ID: `obs-evo-cand-013626`
...
- Project ID: `obs-evo-cand-013626`
- EVOBC category candidate ID: `evobc-evo-cat-13626`
- External category reference: `evobc-cat-13626`
- Source category ID: `13626`
- Source label for human review: `𮏆`
- Source codepoints: `U+2E3C6`
...
- `obs-evo-cand-013626-route-category-staging`
...
- `obs-evo-cand-013626-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013626-route-evolution-graph`
