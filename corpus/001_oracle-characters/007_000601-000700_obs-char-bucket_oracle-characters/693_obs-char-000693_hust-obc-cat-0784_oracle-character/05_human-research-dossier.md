# obs-char-000693 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/693_obs-char-000693_hust-obc-cat-0784_orac
  le-character/03_visual-assets/001_asset-000698_hust-obc-cat-0784_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0784/G_0784_七B43合11496賓組.png`
- asset id: `asset-000698`
...
- source category: `0784`
- validation class: `692`
- source image route: `HUST-OBC/deciphered/0784/G_0784_七B43合11496賓組.png`
- asset id: `asset-000698`
...
- English observation: `A central Y-shaped upright rises from a long
  horizontal base, with a small detached rectangular loop positioned on each
  side at mid-height.`
...
- dataset label text: `㜆`
- dataset label codepoints: `U+3706`
...
- filename catalog route clues: `Heji-like filename clue: 合11496
...
- Which source records identify obs-char-000693 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000693？
