...
- External category reference: `evobc-cat-09983`
- Source category ID: `09983`
- Source label for human review: `頗`
- Source codepoints: `U+9817`
...
- `obs-evo-cand-009983-route-category-staging`
...
- `obs-evo-cand-009983-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009983-route-evolution-graph`
