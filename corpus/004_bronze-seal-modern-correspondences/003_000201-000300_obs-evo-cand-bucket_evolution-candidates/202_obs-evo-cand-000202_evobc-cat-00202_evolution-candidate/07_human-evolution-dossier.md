...
- External category reference: `evobc-cat-00202`
- Source category ID: `00202`
- Source label for human review: `㲻`
- Source codepoints: `U+3CBB`
...
- `obs-evo-cand-000202-route-category-staging`
...
- `obs-evo-cand-000202-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000202-route-evolution-graph`
