...
Project ID: `obs-evo-cand-001458`
...
- Project ID: `obs-evo-cand-001458`
- EVOBC category candidate ID: `evobc-evo-cat-01458`
- External category reference: `evobc-cat-01458`
- Source category ID: `01458`
- Source label for human review: `叔`
- Source codepoints: `U+53D4`
...
- `obs-evo-cand-001458-route-category-staging`
...
- `obs-evo-cand-001458-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001458-route-evolution-graph`
