...
- External category reference: `evobc-cat-02803`
- Source category ID: `02803`
- Source label for human review: `弥`
- Source codepoints: `U+5F25`
...
- `obs-evo-cand-002803-route-category-staging`
...
- `obs-evo-cand-002803-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002803-route-evolution-graph`
