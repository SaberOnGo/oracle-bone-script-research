...
- Project ID: `obs-evo-cand-006374`
- EVOBC category candidate ID: `evobc-evo-cat-06374`
- External category reference: `evobc-cat-06374`
- Source category ID: `06374`
- Source label for human review: `籗`
- Source codepoints: `U+7C57`
...
- `obs-evo-cand-006374-route-category-staging`
...
- `obs-evo-cand-006374-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006374-route-evolution-graph`
