# Material Visual Observation / obs-comp-cand-001900 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001900`
- External reference / 外部参照: `obimd-sub-c771nmkmb8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018310_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/c771nmkmb8/c771nmkmb8/c771nmkmb8.png`
- Checksum / 校验和:
  `2a2e56f3e38e84a1d087219a3474a05ba34e61b2c4dd5ff95e14bfbd614709c4`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.81%.
- Marked-pixel bounds: (58,22)–(185,227); span 128 × 206 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.81%。
- 痕迹范围：(58,22)–(185,227)；跨度128 × 206 px；痕迹矩形高于宽。
