# obs-evo-cand-009440 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-09440`
- Source label for human review: `錦`
- Source codepoints: `U+9326`
- Image reference count: `22`
- Era token counts: `SS:2;WSC:20`
- Source token counts: `Book:5;Web:17`
