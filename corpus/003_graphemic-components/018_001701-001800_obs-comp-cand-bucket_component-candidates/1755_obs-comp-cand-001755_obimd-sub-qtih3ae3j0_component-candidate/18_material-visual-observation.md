# Material Visual Observation / obs-comp-cand-001755 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001755`
- External reference / 外部参照: `obimd-sub-qtih3ae3j0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017956_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qtih3ae3j0/qtih3ae3j0/qtih3ae3j0.png`
- Checksum / 校验和:
  `cc24311dfa0bb9e5a95a4af8a0870ee1e709bee548b4c0b90d1addee6862b677`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.26%.
- Marked-pixel bounds: (71,33)–(200,217); span 130 × 185 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.26%。
- 痕迹范围：(71,33)–(200,217)；跨度130 × 185 px；痕迹矩形高于宽。
