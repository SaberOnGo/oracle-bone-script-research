# obs-char-000157 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000157`
- primary external id: `hust-obc-cat-0173`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/157_obs-char-000157_hust-obc-cat-0173_orac
  le-character/03_visual-assets/001_asset-000162_hust-obc-cat-0173_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0173/G_0173_甲骨文.png`
- asset id: `asset-000162`
...
- dataset label text: `㒣`
- dataset label codepoints: `U+34A3`
...
- Which source records identify obs-char-000157 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000157？
