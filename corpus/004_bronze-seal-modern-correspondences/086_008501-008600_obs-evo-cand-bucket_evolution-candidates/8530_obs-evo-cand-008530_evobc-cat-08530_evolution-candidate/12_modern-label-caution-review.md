# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008530
...
- EVOBC candidate category: `evobc-evo-cat-08530`.
- Source label for search only: `貚`.
- Source codepoints for search only: `U+8C9A`.
