# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013064
...
- EVOBC candidate category: `evobc-evo-cat-13064`.
- Source label for search only: `𫮯`.
- Source codepoints for search only: `U+2BBAF`.
