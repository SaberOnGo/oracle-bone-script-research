...
- External category reference: `evobc-cat-04704`
- Source category ID: `04704`
- Source label for human review: `涿`
- Source codepoints: `U+6DBF`
...
- `obs-evo-cand-004704-route-category-staging`
...
- `obs-evo-cand-004704-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004704-route-evolution-graph`
