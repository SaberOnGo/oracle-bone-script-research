# obs-unk-005406 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/071_undeciphered-005
  401-005500_obs-unk-bucket_oracle-character-candidates/006_obs-unk-005406_h
  ust-obc-und-X-005406_oracle-character-candidate/03_visual-assets/001_asset
  -006999_hust-obc-und-X-005406_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/962/X_？_7927_1.png`
- asset id: `asset-006999`
...
- source class: `HUST-OBC/undeciphered/X/962/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/962/X_？_7927_1.png`
- asset id: `asset-006999`
...
- Which source records identify obs-unk-005406 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005406？
