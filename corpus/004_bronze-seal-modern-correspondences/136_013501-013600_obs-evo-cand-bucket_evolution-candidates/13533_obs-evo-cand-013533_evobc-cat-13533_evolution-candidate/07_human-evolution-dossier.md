...
Project ID: `obs-evo-cand-013533`
...
- Project ID: `obs-evo-cand-013533`
- EVOBC category candidate ID: `evobc-evo-cat-13533`
- External category reference: `evobc-cat-13533`
- Source category ID: `13533`
- Source label for human review: `𭡕`
- Source codepoints: `U+2D855`
...
- `obs-evo-cand-013533-route-category-staging`
...
- `obs-evo-cand-013533-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013533-route-evolution-graph`
