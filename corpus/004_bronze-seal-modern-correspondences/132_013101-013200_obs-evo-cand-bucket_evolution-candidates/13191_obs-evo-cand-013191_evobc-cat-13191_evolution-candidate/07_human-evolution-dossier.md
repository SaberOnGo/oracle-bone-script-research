...
- External category reference: `evobc-cat-13191`
- Source category ID: `13191`
- Source label for human review: `𬀷`
...
- `obs-evo-cand-013191-route-category-staging`
...
- `obs-evo-cand-013191-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013191-route-evolution-graph`
