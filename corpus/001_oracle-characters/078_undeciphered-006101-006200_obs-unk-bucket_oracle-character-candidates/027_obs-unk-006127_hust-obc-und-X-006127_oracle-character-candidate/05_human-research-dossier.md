# obs-unk-006127 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/078_undeciphered-006
  101-006200_obs-unk-bucket_oracle-character-candidates/027_obs-unk-006127_h
  ust-obc-und-X-006127_oracle-character-candidate/03_visual-assets/001_asset
  -007719_hust-obc-und-X-006127_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1683/X_？_3746_1.png`
- asset id: `asset-007719`
...
- source class: `HUST-OBC/undeciphered/X/1683/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1683/X_？_3746_1.png`
- asset id: `asset-007719`
...
- Which source records identify obs-unk-006127 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006127？
