...
- External category reference: `evobc-cat-10523`
- Source category ID: `10523`
- Source label for human review: `鶃`
- Source codepoints: `U+9D83`
...
- `obs-evo-cand-010523-route-category-staging`
...
- `obs-evo-cand-010523-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010523-route-evolution-graph`
