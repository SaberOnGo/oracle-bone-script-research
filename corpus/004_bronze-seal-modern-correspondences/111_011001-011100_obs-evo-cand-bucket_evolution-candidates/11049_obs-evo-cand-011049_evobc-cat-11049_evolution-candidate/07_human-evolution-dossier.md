...
- External category reference: `evobc-cat-11049`
- Source category ID: `11049`
- Source label for human review: `𡣂`
- Source codepoints: `U+218C2`
...
- `obs-evo-cand-011049-route-category-staging`
...
- `obs-evo-cand-011049-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011049-route-evolution-graph`
