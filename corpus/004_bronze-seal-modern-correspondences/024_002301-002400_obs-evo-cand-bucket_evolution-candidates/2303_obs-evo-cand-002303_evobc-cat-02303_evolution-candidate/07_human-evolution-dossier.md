...
Project ID: `obs-evo-cand-002303`
...
- Project ID: `obs-evo-cand-002303`
- EVOBC category candidate ID: `evobc-evo-cat-02303`
- External category reference: `evobc-cat-02303`
- Source category ID: `02303`
- Source label for human review: `嬣`
- Source codepoints: `U+5B23`
...
- `obs-evo-cand-002303-route-category-staging`
...
- `obs-evo-cand-002303-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002303-route-evolution-graph`
