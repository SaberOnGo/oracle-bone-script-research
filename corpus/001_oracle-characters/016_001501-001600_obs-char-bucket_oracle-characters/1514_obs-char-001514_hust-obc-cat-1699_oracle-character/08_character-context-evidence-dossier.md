...
- Project ID / 项目 ID: `obs-char-001514`
- Primary external ID / 首选外部 ID: `hust-obc-cat-1699`
...
- Source image / 来源图: `G_1699_乙4736(甲).png`
- Image / 图像: `001_asset-001519_hust-obc-cat-1699_glyph.png`
...
- target node: `evobc-evo-cat-00149`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Source label text / 来源标签文字: `㪙`
- Source label codepoint / 来源标签 codepoint: `U+3A99`
