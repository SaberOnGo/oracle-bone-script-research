# obs-char-000808 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/808_obs-char-000808_hust-obc-cat-0915_orac
  le-character/03_visual-assets/001_asset-000813_hust-obc-cat-0915_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0915/G_0915_乙283合26137.png`
- asset id: `asset-000813`
...
- source category: `0915`
- validation class: `807`
- source image route: `HUST-OBC/deciphered/0915/G_0915_乙283合26137.png`
- asset id: `asset-000813`
...
- English observation: `Two slanted enclosed marks are stacked in the upper
  half, with a small open angular tail below; fine connections are difficult
  to resolve.`
- 中文观察: `上半部可见两个倾斜的闭合痕迹分层叠置，下方有小型开口折角尾；细连接难辨。`
...
- dataset label text: `㞉`
- dataset label codepoints: `U+3789`
...
- filename catalog route clues: `Heji-like filename clue: 合26137
  (G_0915_乙283合26137.png)`
...
- Which source records identify obs-char-000808 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000808？
