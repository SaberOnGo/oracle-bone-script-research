...
Project ID: `obs-evo-cand-004366`
...
- Project ID: `obs-evo-cand-004366`
- EVOBC category candidate ID: `evobc-evo-cat-04366`
- External category reference: `evobc-cat-04366`
- Source category ID: `04366`
- Source label for human review: `歉`
- Source codepoints: `U+6B49`
...
- `obs-evo-cand-004366-route-category-staging`
...
- `obs-evo-cand-004366-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004366-route-evolution-graph`
