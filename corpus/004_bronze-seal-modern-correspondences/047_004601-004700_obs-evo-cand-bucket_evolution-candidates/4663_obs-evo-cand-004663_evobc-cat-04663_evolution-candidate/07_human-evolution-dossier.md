...
Project ID: `obs-evo-cand-004663`
...
- Project ID: `obs-evo-cand-004663`
- EVOBC category candidate ID: `evobc-evo-cat-04663`
- External category reference: `evobc-cat-04663`
- Source category ID: `04663`
- Source label for human review: `浧`
- Source codepoints: `U+6D67`
...
- `obs-evo-cand-004663-route-category-staging`
...
- `obs-evo-cand-004663-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004663-route-evolution-graph`
