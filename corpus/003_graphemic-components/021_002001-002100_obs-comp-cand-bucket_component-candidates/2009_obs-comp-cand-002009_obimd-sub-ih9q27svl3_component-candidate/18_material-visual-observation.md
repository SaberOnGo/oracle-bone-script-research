# Material Visual Observation / obs-comp-cand-002009 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002009`
- External reference / 外部参照: `obimd-sub-ih9q27svl3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019289_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/l4lq5esn5g/ih9q27svl3/0yvhhhjjzb.png`
- Checksum / 校验和:
  `1ad1eef3c2bee741e60e40ab3bc346fc715ab51b0820472b9f5da7aa1f4eeea5`
...
- Marked-pixel bounds: (78,25)–(171,216); span 94 × 192 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.77%。
- 痕迹范围：(78,25)–(171,216)；跨度94 × 192 px；痕迹矩形高于宽。
