...
- External category reference: `evobc-cat-06938`
- Source category ID: `06938`
- Source label for human review: `聅`
- Source codepoints: `U+8045`
...
- `obs-evo-cand-006938-route-category-staging`
...
- `obs-evo-cand-006938-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006938-route-evolution-graph`
