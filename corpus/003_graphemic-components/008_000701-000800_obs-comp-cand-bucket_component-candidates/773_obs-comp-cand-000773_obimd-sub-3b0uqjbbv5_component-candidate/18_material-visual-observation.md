# Material Visual Observation / obs-comp-cand-000773 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000773`
- External reference / 外部参照: `obimd-sub-3b0uqjbbv5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013536_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3b0uqjbbv5/3b0uqjbbv5/3b0uqjbbv5.png`
- Checksum / 校验和:
  `7d8fe50510c15645af5921589099d62287900a51f22e60fd49bbf9e97a948a50`
...
- Marked-pixel bounds: (76,25)–(173,228); span 98 × 204 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.71%。
- 痕迹范围：(76,25)–(173,228)；跨度98 × 204 px；痕迹矩形高于宽。
