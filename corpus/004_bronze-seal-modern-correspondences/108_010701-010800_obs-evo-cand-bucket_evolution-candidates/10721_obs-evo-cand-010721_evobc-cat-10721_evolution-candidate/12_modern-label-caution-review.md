# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010721
...
- EVOBC candidate category: `evobc-evo-cat-10721`.
- Source label for search only: `齛`.
- Source codepoints for search only: `U+9F5B`.
