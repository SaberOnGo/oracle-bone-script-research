# Material Visual Observation / obs-comp-cand-001669 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001669`
- External reference / 外部参照: `obimd-sub-cixqnyxp9v`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017345_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cixqnyxp9v/cixqnyxp9v/03i22yzlrs.png`
- Checksum / 校验和:
  `9d556ff2a5c93eb511b0727ee747a2b75991b1210f1bd6d2cf47225970a59589`
...
- Marked-pixel bounds: (93,20)–(156,225); span 64 × 206 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.11%。
- 痕迹范围：(93,20)–(156,225)；跨度64 × 206 px；痕迹矩形高于宽。
