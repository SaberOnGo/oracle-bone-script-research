# Material Visual Observation / obs-comp-cand-002741 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002741`
- External reference / 外部参照: `obimd-sub-fp02cubifm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021357_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fp02cubifm/fp02cubifm/fp02cubifm.png`
- Checksum / 校验和:
  `19693a69a2c48f867706286b7d424280f67c001b7436c9d342ba6542d194c181`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.34%.
- Marked-pixel bounds: (50,29)–(205,212); span 156 × 184 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.34%。
- 痕迹范围：(50,29)–(205,212)；跨度156 × 184 px；痕迹矩形近方形。
