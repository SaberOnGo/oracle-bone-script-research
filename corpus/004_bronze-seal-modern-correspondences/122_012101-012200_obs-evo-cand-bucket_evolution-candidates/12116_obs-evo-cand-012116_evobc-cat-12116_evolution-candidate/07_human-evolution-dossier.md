...
- External category reference: `evobc-cat-12116`
- Source category ID: `12116`
- Source label for human review: `𦺴`
- Source codepoints: `U+26EB4`
...
- `obs-evo-cand-012116-route-category-staging`
...
- `obs-evo-cand-012116-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012116-route-evolution-graph`
