...
- External category reference: `evobc-cat-12972`
- Source category ID: `12972`
- Source label for human review: `𫗐`
- Source codepoints: `U+2B5D0`
...
- `obs-evo-cand-012972-route-category-staging`
...
- `obs-evo-cand-012972-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012972-route-evolution-graph`
