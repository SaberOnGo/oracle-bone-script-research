...
- Project ID / 项目 ID: `obs-char-001330`
- Primary external ID / 首选外部 ID: `hust-obc-cat-1486`
...
- Source image / 来源图: `G_1486_後2.42.8合30273無名組.png`
- Image / 图像: `001_asset-001335_hust-obc-cat-1486_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合30273
  (G_1486_後2.42.8合30273無名組.png)`
...
- Source label text / 来源标签文字: `㧄`
- Source label codepoint / 来源标签 codepoint: `U+39C4`
