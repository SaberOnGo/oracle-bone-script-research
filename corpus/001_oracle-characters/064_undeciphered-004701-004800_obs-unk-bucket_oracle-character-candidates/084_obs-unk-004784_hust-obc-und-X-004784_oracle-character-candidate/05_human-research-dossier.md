# obs-unk-004784 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004784`
- primary external id: `hust-obc-und-X-004784`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/084_obs-unk-004784_h
  ust-obc-und-X-004784_oracle-character-candidate/03_visual-assets/001_asset
  -006377_hust-obc-und-X-004784_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/340/X_？_7322_1.png`
- asset id: `asset-006377`
...
- source class: `HUST-OBC/undeciphered/X/340/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/340/X_？_7322_1.png`
- asset id: `asset-006377`
...
- English observation: `left opening and right bar with long strokes`
- 中文观察: `左侧开口、右侧横杆和两条长笔画`
...
- Which source records identify obs-unk-004784 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004784？
