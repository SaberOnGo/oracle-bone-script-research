...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1469`
...
- Source image / 来源图: `L_1469_6860.jpg`
- Image / 图像: `001_asset-001319_hust-obc-cat-1469_glyph.png`
...
- target node: `evobc-evo-cat-00138`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/138_obs-evo-cand-000138_evobc-cat-00138_evoluti
...
- Source label text / 来源标签文字: `㦳`
- Source label codepoint / 来源标签 codepoint: `U+39B3`
