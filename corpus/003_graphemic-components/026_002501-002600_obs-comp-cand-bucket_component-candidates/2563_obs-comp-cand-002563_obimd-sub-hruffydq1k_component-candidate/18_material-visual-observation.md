# Material Visual Observation / obs-comp-cand-002563 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002563`
- External reference / 外部参照: `obimd-sub-hruffydq1k`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021095_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hruffydq1k/hruffydq1k/hruffydq1k.png`
- Checksum / 校验和:
  `08e697e8302158c5294f5511100c7c5bcdbb98dd9cc6bc4e2e0a4f7100256379`
...
- Marked-pixel bounds: (64,38)–(189,208); span 126 × 171 px; the marked
...
- 痕迹范围：(64,38)–(189,208)；跨度126 × 171 px；痕迹矩形高于宽。
