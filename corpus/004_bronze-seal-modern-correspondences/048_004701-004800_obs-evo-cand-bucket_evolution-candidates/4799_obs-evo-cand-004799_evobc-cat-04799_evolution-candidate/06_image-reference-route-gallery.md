...
- `obs-evo-cand-004799-route-category-staging`
...
- `obs-evo-cand-004799-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004799-route-evolution-graph`
