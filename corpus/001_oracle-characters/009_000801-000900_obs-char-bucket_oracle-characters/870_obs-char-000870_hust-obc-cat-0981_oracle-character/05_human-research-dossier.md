# obs-char-000870 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000870`
- primary external id: `hust-obc-cat-0981`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/870_obs-char-000870_hust-obc-cat-0981_orac
  le-character/03_visual-assets/001_asset-000875_hust-obc-cat-0981_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0981/G_0981_前2.10.6合36531黃組.png
  `
- asset id: `asset-000875`
...
- source category: `0981`
- validation class: `869`
- source image route: `HUST-OBC/deciphered/0981/G_0981_前2.10.6合36531黃組.png`
- asset id: `asset-000875`
...
- English observation: `A dark branching cluster contains an open rounded
  middle and a curved lower extension; several tips remain distinct.`
- 中文观察: `深色分枝笔群中部有圆弧开口，下方有弯曲延伸；数个笔尖保持清楚分离。`
...
- dataset label text: `㟋`
- dataset label codepoints: `U+37CB`
...
- filename catalog route clues: `Heji-like filename clue: 合36531
  (G_0981_前2.10.6合36531黃組.png)`
...
- Which source records identify obs-char-000870 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000870？
