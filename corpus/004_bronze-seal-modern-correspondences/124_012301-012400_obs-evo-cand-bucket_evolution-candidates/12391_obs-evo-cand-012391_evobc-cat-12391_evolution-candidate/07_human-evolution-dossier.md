...
- Project ID: `obs-evo-cand-012391`
- EVOBC category candidate ID: `evobc-evo-cat-12391`
- External category reference: `evobc-cat-12391`
- Source category ID: `12391`
- Source label for human review: `𨘕`
- Source codepoints: `U+28615`
...
- `obs-evo-cand-012391-route-category-staging`
...
- `obs-evo-cand-012391-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012391-route-evolution-graph`
