...
- `obs-evo-cand-006224-route-category-staging`
...
- `obs-evo-cand-006224-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006224-route-evolution-graph`
