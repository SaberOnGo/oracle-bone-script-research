...
- External category reference: `evobc-cat-12262`
- Source category ID: `12262`
- Source label for human review: `𧮬`
...
- `obs-evo-cand-012262-route-category-staging`
...
- `obs-evo-cand-012262-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012262-route-evolution-graph`
