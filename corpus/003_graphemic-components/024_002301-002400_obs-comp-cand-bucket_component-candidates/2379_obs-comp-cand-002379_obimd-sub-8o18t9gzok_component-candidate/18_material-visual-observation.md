# Material Visual Observation / obs-comp-cand-002379 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002379`
- External reference / 外部参照: `obimd-sub-8o18t9gzok`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020450_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3lxxctblxe/8o18t9gzok/8o18t9gzok.png`
- Checksum / 校验和:
  `5b0aa5d6e6c1035554d56db4edbf141005a3c0f9e9e392be9a99327a3e4c1a39`
...
- Marked-pixel bounds: (80,31)–(172,217); span 93 × 187 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.04%。
- 痕迹范围：(80,31)–(172,217)；跨度93 × 187 px；痕迹矩形高于宽。
