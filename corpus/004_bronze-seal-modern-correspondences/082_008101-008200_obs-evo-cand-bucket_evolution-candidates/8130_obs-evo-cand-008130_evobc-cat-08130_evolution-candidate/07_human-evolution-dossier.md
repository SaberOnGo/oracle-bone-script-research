...
Project ID: `obs-evo-cand-008130`
...
- Project ID: `obs-evo-cand-008130`
- EVOBC category candidate ID: `evobc-evo-cat-08130`
- External category reference: `evobc-cat-08130`
- Source category ID: `08130`
- Source label for human review: `訌`
- Source codepoints: `U+8A0C`
...
- `obs-evo-cand-008130-route-category-staging`
...
- `obs-evo-cand-008130-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008130-route-evolution-graph`
