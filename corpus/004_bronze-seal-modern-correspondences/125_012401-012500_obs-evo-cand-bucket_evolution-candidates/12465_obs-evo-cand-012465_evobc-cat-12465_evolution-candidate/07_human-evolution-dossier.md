...
- External category reference: `evobc-cat-12465`
- Source category ID: `12465`
- Source label for human review: `𨟚`
- Source codepoints: `U+287DA`
...
- `obs-evo-cand-012465-route-category-staging`
...
- `obs-evo-cand-012465-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012465-route-evolution-graph`
