# obs-char-001465 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1465_obs-char-001465_hust-obc-cat-1645_ora
  cle-character/03_visual-assets/001_asset-001470_hust-obc-cat-1645_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1645/L_1645_3913.jpg`
- asset id: `asset-001470`
...
- source category: `1645`
- validation class: `1464`
- source image route: `HUST-OBC/deciphered/1645/L_1645_3913.jpg`
- asset id: `asset-001470`
...
- English observation: `A faint curved cluster is formed by several short
  parallel strokes.`
- 中文观察: `浅淡弧形笔画群由数条短平行笔画组成。`
...
- dataset label text: `㩣`
- dataset label codepoints: `U+3A63`
...
- Which source records identify obs-char-001465 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001465？
