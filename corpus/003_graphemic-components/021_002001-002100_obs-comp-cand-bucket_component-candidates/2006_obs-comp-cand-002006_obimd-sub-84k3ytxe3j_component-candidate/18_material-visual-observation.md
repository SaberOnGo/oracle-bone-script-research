# Material Visual Observation / obs-comp-cand-002006 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002006`
- External reference / 外部参照: `obimd-sub-84k3ytxe3j`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019286_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/67yxx2eqp0/84k3ytxe3j/84k3ytxe3j.png`
- Checksum / 校验和:
  `a25c9d5255628bca0e61c6e48a65a80bf56901b73b53a378d886f68f73893054`
...
- Marked-pixel bounds: (75,28)–(174,216); span 100 × 189 px; the marked
...
- 痕迹范围：(75,28)–(174,216)；跨度100 × 189 px；痕迹矩形高于宽。
