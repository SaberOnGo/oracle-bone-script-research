...
- Project ID: `obs-evo-cand-006462`
- EVOBC category candidate ID: `evobc-evo-cat-06462`
- External category reference: `evobc-cat-06462`
- Source category ID: `06462`
- Source label for human review: `紛`
- Source codepoints: `U+7D1B`
...
- `obs-evo-cand-006462-route-category-staging`
...
- `obs-evo-cand-006462-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006462-route-evolution-graph`
