...
- External category reference: `evobc-cat-05512`
- Source category ID: `05512`
- Source label for human review: `瓴`
...
- `obs-evo-cand-005512-route-category-staging`
...
- `obs-evo-cand-005512-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005512-route-evolution-graph`
