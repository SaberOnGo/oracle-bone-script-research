# obs-evo-cand-000810 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-00810`
- Source label: `作`
- Source codepoints: `U+4F5C`
- Image reference count: `101`
- Era token counts: `BI:13;CS:1;OBC:26;SS:2;WSC:59`
- Source token counts: `Book:48;Web:53`
