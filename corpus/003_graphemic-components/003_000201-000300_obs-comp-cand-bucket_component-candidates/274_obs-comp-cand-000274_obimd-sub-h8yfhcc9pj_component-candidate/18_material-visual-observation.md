# Material Visual Observation / obs-comp-cand-000274 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000274`
- External reference / 外部参照: `obimd-sub-h8yfhcc9pj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011918_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9tpoluos1q/h8yfhcc9pj/h8yfhcc9pj.png`
- Checksum / 校验和:
  `6c0a7a103b745bccbf4047175aef8a256cc67b935827006e9f8b71ac09acc0fe`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.08%.
- Marked-pixel bounds: (81,26)–(168,223); span 88 × 198 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.08%。
- 痕迹范围：(81,26)–(168,223)；跨度88 × 198 px；痕迹矩形高于宽。
