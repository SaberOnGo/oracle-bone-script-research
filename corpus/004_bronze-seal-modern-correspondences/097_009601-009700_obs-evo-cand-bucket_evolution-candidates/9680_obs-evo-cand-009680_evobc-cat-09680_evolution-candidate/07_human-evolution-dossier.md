...
- External category reference: `evobc-cat-09680`
- Source category ID: `09680`
- Source label for human review: `闺`
...
- `obs-evo-cand-009680-route-category-staging`
...
- `obs-evo-cand-009680-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009680-route-evolution-graph`
