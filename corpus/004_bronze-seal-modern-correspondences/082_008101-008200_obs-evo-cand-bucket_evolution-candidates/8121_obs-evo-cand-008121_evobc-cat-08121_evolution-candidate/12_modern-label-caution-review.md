# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008121
...
- EVOBC candidate category: `evobc-evo-cat-08121`.
- Source label for search only: `言`.
- Source codepoints for search only: `U+8A00`.
