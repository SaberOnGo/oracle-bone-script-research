...
- External category reference: `evobc-cat-13443`
- Source category ID: `13443`
- Source label for human review: `𬴼`
...
- `obs-evo-cand-013443-route-category-staging`
...
- `obs-evo-cand-013443-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013443-route-evolution-graph`
