# obs-comp-cand-002328 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002328`
- 首选外部 ID: `obimd-sub-kggb6goupa`
- OBIMD subcharacter UID: `kggb6goupa`
- OBIMD main character UID: `kggb6goupa`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `8`
- codepoint 示例: U+5E7D;U+FD579; U+FD57A; 另有 6 项
