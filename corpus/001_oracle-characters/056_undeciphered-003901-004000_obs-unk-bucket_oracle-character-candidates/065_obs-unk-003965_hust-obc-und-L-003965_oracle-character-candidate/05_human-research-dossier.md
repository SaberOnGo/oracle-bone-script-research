# obs-unk-003965 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/065_obs-unk-003965_h
  ust-obc-und-L-003965_oracle-character-candidate/03_visual-assets/001_asset
  -005558_hust-obc-und-L-003965_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3965/L_？_8372.jpg`
- asset id: `asset-005558`
...
- source class: `HUST-OBC/undeciphered/L/3965/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3965/L_？_8372.jpg`
- asset id: `asset-005558`
...
- English observation: A compact upper cluster sends several narrow strokes
  downward from a small middle junction.
- 中文观察：紧凑上部痕迹组从中部小交接处向下分出数条窄痕。
...
- Which source records identify obs-unk-003965 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003965？
