...
- External category reference: `evobc-cat-01015`
- Source category ID: `01015`
- Source label for human review: `僕`
- Source codepoints: `U+50D5`
- Image reference count in source metadata: `163`
...
- `obs-evo-cand-001015-route-category-staging`
...
- `obs-evo-cand-001015-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001015-route-evolution-graph`
