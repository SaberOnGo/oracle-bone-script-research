...
- External category reference: `evobc-cat-04452`
- Source category ID: `04452`
- Source label for human review: `毗`
- Source codepoints: `U+6BD7`
...
- `obs-evo-cand-004452-route-category-staging`
...
- `obs-evo-cand-004452-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004452-route-evolution-graph`
