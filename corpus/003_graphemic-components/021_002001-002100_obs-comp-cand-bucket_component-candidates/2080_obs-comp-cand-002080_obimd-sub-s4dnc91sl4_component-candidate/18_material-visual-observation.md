# Material Visual Observation / obs-comp-cand-002080 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002080`
- External reference / 外部参照: `obimd-sub-s4dnc91sl4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019467_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/s4dnc91sl4/s4dnc91sl4/s4dnc91sl4.png`
- Checksum / 校验和:
  `6152cd69c976d3b8eb04438bdacb9ae42265d5525532416f880220ce5fe89498`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.23%.
- Marked-pixel bounds: (48,21)–(212,230); span 165 × 210 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.23%。
- 痕迹范围：(48,21)–(212,230)；跨度165 × 210 px；痕迹矩形高于宽。
