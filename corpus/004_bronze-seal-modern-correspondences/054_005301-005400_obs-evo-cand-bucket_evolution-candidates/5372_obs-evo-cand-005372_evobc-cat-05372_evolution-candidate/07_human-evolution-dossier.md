...
Project ID: `obs-evo-cand-005372`
...
- Project ID: `obs-evo-cand-005372`
- EVOBC category candidate ID: `evobc-evo-cat-05372`
- External category reference: `evobc-cat-05372`
- Source category ID: `05372`
- Source label for human review: `珋`
- Source codepoints: `U+73CB`
...
- `obs-evo-cand-005372-route-category-staging`
...
- `obs-evo-cand-005372-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005372-route-evolution-graph`
