# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002008
...
| --- | --- | --- | --- |
| `obimd-glyph-link-030818` | 󻢏 | `U+FB88F` | `reviewed_metadata_only` |
| `obimd-glyph-link-030819` | 󻢐 | `U+FB890` | `reviewed_metadata_only` |
| `obimd-glyph-link-030820` | 󻢒 | `U+FB892` | `reviewed_metadata_only` |
