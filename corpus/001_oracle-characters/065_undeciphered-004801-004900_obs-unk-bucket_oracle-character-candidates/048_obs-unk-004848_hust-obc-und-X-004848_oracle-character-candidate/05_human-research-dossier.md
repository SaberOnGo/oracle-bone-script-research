# obs-unk-004848 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004848`
- primary external id: `hust-obc-und-X-004848`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/048_obs-unk-004848_h
  ust-obc-und-X-004848_oracle-character-candidate/03_visual-assets/001_asset
  -006441_hust-obc-und-X-004848_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/404/X_？_7121_1.png`
- asset id: `asset-006441`
...
- source class: `HUST-OBC/undeciphered/X/404/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/404/X_？_7121_1.png`
- asset id: `asset-006441`
...
- English observation: `rounded central connection and long right stroke`
- 中文观察: `中部圆曲连接和右侧长笔画`
...
- Which source records identify obs-unk-004848 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004848？
