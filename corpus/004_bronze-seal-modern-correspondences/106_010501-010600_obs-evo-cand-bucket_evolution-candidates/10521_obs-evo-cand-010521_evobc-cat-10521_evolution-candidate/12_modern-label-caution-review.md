# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010521
...
- EVOBC candidate category: `evobc-evo-cat-10521`.
- Source label for search only: `鵽`.
- Source codepoints for search only: `U+9D7D`.
