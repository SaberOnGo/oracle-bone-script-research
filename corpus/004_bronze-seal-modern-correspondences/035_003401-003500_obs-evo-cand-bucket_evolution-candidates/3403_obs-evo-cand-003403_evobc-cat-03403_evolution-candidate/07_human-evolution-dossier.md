...
- External category reference: `evobc-cat-03403`
- Source category ID: `03403`
- Source label for human review: `掓`
- Source codepoints: `U+6393`
...
- `obs-evo-cand-003403-route-category-staging`
...
- `obs-evo-cand-003403-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003403-route-evolution-graph`
