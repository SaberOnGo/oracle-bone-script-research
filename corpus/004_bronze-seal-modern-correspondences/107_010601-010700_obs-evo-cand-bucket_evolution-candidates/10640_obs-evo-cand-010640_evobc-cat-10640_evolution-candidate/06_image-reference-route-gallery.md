...
- `obs-evo-cand-010640-route-category-staging`
...
- `obs-evo-cand-010640-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010640-route-evolution-graph`
