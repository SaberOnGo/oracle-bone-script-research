# obs-char-000896 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/896_obs-char-000896_hust-obc-cat-1008_1009
  _oracle-character/03_visual-assets/001_asset-000901_hust-obc-cat-1008_1009
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1008_1009/1008/G_1008_乙959合1874
  1賓組.png`
- asset id: `asset-000901`
...
- source category: `1008_1009`
- validation class: `895`
- source image route: `HUST-OBC/deciphered/1008_1009/1008/G_1008_乙959合18741賓組.
  png`
- asset id: `asset-000901`
...
- English observation: `A large arch-like outer contour encloses a compact
  angular interior cluster with two central downward strokes.`
- 中文观察: `大型拱弧状外轮廓围合紧密折角内部笔群，中央有两条下行笔。`
...
- dataset label text: `㟦㟧`
- dataset label codepoints: `U+37E6;U+37E7`
...
- filename catalog route clues: `Heji-like filename clue: 合18741
  (G_1008_乙959合18741賓組.png)`
...
- Which source records identify obs-char-000896 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000896？
