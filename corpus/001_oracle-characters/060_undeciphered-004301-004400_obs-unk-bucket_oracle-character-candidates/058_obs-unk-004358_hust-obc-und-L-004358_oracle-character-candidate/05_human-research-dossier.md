# obs-unk-004358 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004358`
- primary external id: `hust-obc-und-L-004358`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/058_obs-unk-004358_h
  ust-obc-und-L-004358_oracle-character-candidate/03_visual-assets/001_asset
  -005951_hust-obc-und-L-004358_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4358/L_？_9662.jpg`
- asset id: `asset-005951`
...
- source class: `HUST-OBC/undeciphered/L/4358/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4358/L_？_9662.jpg`
- asset id: `asset-005951`
...
- English observation: `Central vertical traces, left curve, and right loop`
  `recorded.`
- 中文观察: `已记录中央纵痕、左侧弧痕和右侧环状痕。`
...
- Which source records identify obs-unk-004358 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004358？
