...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1668`
...
- Source image / 来源图: `G_1668_乙1424合21787.png`
- Image / 图像: `001_asset-001491_hust-obc-cat-1668_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合21787
...
- target node: `evobc-evo-cat-00145`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/145_obs-evo-cand-000145_evobc-cat-00145_evoluti
...
- Source label text / 来源标签文字: `㩺`
- Source label codepoint / 来源标签 codepoint: `U+3A7A`
