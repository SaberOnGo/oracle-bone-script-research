...
- External category reference: `evobc-cat-07854`
- Source category ID: `07854`
- Source label for human review: `蟜`
- Source codepoints: `U+87DC`
...
- `obs-evo-cand-007854-route-category-staging`
...
- `obs-evo-cand-007854-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007854-route-evolution-graph`
