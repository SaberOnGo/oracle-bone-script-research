# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006162
...
- EVOBC candidate category: `evobc-evo-cat-06162`.
- Source label for search only: `窑`.
- Source codepoints for search only: `U+7A91`.
