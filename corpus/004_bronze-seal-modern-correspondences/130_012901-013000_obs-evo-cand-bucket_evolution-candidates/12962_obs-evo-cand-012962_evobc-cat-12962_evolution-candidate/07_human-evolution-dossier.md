...
- External category reference: `evobc-cat-12962`
- Source category ID: `12962`
- Source label: `𫓞`
...
- `obs-evo-cand-012962-route-category-staging`
...
- `obs-evo-cand-012962-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012962-route-evolution-graph`
