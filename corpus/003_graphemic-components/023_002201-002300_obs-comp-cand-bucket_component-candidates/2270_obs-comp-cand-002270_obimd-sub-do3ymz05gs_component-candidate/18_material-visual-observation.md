# Material Visual Observation / obs-comp-cand-002270 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002270`
- External reference / 外部参照: `obimd-sub-do3ymz05gs`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020154_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/do3ymz05gs/do3ymz05gs/do3ymz05gs.png`
- Checksum / 校验和:
  `3b8bce73272ecff7bb23e96f4aa4252adaa0d95a2f679ea0839301cbc45820c5`
...
- Marked-pixel bounds: (85,25)–(163,216); span 79 × 192 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.67%。
- 痕迹范围：(85,25)–(163,216)；跨度79 × 192 px；痕迹矩形高于宽。
