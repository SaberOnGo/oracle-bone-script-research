...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0720`
...
- Source image / 来源图: `G_0720_上(2).從(甲).10(楚).png`
- Image / 图像: `001_asset-000638_hust-obc-cat-0720_glyph.png`
...
- Source label text / 来源标签文字: `㛆`
- Source label codepoint / 来源标签 codepoint: `U+36C6`
