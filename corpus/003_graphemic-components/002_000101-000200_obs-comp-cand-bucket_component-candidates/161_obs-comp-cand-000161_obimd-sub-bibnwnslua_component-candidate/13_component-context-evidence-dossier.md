# obs-comp-cand-000161 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000161`
- 首选外部 ID: `obimd-sub-bibnwnslua`
- OBIMD subcharacter UID: `bibnwnslua`
...
- glyph-codepoint 数: `6`
- codepoint 示例: U+F0EBA; U+F0EBB; 另有 4 项
