# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006224
...
- EVOBC candidate category: `evobc-evo-cat-06224`.
- Source label for search only: `笋`.
- Source codepoints for search only: `U+7B0B`.
