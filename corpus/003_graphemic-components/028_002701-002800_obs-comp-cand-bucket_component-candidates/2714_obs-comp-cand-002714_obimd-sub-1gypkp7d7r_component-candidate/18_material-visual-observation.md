# Material Visual Observation / obs-comp-cand-002714 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002714`
- External reference / 外部参照: `obimd-sub-1gypkp7d7r`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021290_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1gypkp7d7r/1gypkp7d7r/1gypkp7d7r.png`
- Checksum / 校验和:
  `94031f08adc20e2eaebcfbb0e4df01c85ccc2f7aef12ab1b6c67b087c8d997d5`
...
- Marked-pixel bounds: (66,38)–(194,217); span 129 × 180 px; the marked
...
- 痕迹范围：(66,38)–(194,217)；跨度129 × 180 px；痕迹矩形高于宽。
