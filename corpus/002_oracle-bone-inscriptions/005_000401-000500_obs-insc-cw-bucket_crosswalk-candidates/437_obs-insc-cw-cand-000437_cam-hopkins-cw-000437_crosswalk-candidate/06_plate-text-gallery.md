...
Project ID: `obs-insc-cw-cand-000437`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000437`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000437` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2283` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `337` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `209` [route_present_image_or_text_not_collected]
