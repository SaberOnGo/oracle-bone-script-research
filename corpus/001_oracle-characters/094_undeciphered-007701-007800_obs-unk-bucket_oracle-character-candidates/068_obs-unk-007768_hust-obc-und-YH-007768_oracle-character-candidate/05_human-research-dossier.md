# obs-unk-007768 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/094_undeciphered-007
  701-007800_obs-unk-bucket_oracle-character-candidates/068_obs-unk-007768_h
  ust-obc-und-YH-007768_oracle-character-candidate/03_visual-assets/001_asse
  t-009359_hust-obc-und-YH-007768_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/602FE/Y_？_602FE.jpg`
- asset id: `asset-009359`
...
- source class: `HUST-OBC/undeciphered/Y+H/602FE/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/602FE/Y_？_602FE.jpg`
- asset id: `asset-009359`
...
- Which source records identify obs-unk-007768 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007768？
