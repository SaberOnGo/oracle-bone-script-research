...
- External category reference: `evobc-cat-09825`
- Source category ID: `09825`
- Source label for human review: `雜`
...
- `obs-evo-cand-009825-route-category-staging`
...
- `obs-evo-cand-009825-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009825-route-evolution-graph`
