# obs-unk-003973 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/073_obs-unk-003973_h
  ust-obc-und-L-003973_oracle-character-candidate/03_visual-assets/001_asset
  -005566_hust-obc-und-L-003973_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3973/L_？_840.jpg`
- asset id: `asset-005566`
...
- source class: `HUST-OBC/undeciphered/L/3973/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3973/L_？_840.jpg`
- asset id: `asset-005566`
...
- English observation: Curved and vertical traces frame a narrow center, with a
  longer sweep toward the lower left.
- 中文观察：弧向和竖向痕迹围绕较窄中央区域，较长弧痕向左下方伸展。
...
- Which source records identify obs-unk-003973 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003973？
