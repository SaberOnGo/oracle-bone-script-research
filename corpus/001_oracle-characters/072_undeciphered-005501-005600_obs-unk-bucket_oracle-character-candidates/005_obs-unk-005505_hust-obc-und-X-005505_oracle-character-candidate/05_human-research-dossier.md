# obs-unk-005505 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005505`
- primary external id: `hust-obc-und-X-005505`
...
- local review image route: `corpus/001_oracle-characters/072_undeciphered-005
  501-005600_obs-unk-bucket_oracle-character-candidates/005_obs-unk-005505_h
  ust-obc-und-X-005505_oracle-character-candidate/03_visual-assets/001_asset
  -007098_hust-obc-und-X-005505_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1061/X_？_8023_1.png`
- asset id: `asset-007098`
...
- source class: `HUST-OBC/undeciphered/X/1061/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1061/X_？_8023_1.png`
- asset id: `asset-007098`
...
- Which source records identify obs-unk-005505 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005505？
