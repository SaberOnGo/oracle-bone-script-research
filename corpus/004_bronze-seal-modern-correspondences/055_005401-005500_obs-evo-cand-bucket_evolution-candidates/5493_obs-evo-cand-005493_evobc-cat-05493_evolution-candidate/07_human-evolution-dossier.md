...
Project ID: `obs-evo-cand-005493`
...
- Project ID: `obs-evo-cand-005493`
- EVOBC category candidate ID: `evobc-evo-cat-05493`
- External category reference: `evobc-cat-05493`
- Source category ID: `05493`
- Source label for human review: `瓊`
- Source codepoints: `U+74CA`
...
- `obs-evo-cand-005493-route-category-staging`
...
- `obs-evo-cand-005493-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005493-route-evolution-graph`
