...
- Project ID: `obs-evo-cand-010045`
- EVOBC category candidate ID: `evobc-evo-cat-10045`
- External category reference: `evobc-cat-10045`
- Source category ID: `10045`
- Source label for human review: `须`
- Source codepoints: `U+987B`
...
- `obs-evo-cand-010045-route-category-staging`
...
- `obs-evo-cand-010045-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010045-route-evolution-graph`
