...
- Project ID: `obs-evo-cand-007344`
- EVOBC category candidate ID: `evobc-evo-cat-07344`
- External category reference: `evobc-cat-07344`
- Source category ID: `07344`
- Source label for human review: `荊`
- Source codepoints: `U+834A`
...
- `obs-evo-cand-007344-route-category-staging`
...
- `obs-evo-cand-007344-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007344-route-evolution-graph`
