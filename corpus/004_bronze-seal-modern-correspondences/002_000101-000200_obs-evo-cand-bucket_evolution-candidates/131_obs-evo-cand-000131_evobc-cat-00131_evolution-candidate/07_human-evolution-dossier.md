...
- External category reference: `evobc-cat-00131`
- Source category ID: `00131`
- Source label for human review: `㥲`
- Source codepoints: `U+3972`
...
- `obs-evo-cand-000131-route-category-staging`
...
- `obs-evo-cand-000131-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000131-route-evolution-graph`
