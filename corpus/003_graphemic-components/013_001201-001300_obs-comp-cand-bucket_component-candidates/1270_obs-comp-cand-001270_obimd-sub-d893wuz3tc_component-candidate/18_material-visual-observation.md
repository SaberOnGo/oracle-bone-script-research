# Material Visual Observation / obs-comp-cand-001270 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001270`
- External reference / 外部参照: `obimd-sub-d893wuz3tc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015508_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/frmptf4le7/d893wuz3tc/d893wuz3tc.png`
- Checksum / 校验和:
  `62fdf773294ee27d81b96eb406d7232cdcee79c24d2bb909315d91af6b673e67`
...
- Marked-pixel bounds: (81,41)–(169,209); span 89 × 169 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.51%。
- 痕迹范围：(81,41)–(169,209)；跨度89 × 169 px；痕迹矩形高于宽。
