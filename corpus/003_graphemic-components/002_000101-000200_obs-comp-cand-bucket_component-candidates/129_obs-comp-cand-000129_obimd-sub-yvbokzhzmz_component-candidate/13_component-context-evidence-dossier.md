# obs-comp-cand-000129 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000129`
- 首选外部 ID: `obimd-sub-yvbokzhzmz`
- OBIMD subcharacter UID: `yvbokzhzmz`
- OBIMD main character UID: `yvbokzhzmz`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+5DDD;U+F0C2D; U+F0C2E; 另有 1 项
