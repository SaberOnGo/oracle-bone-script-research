# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001608
...
- EVOBC candidate category: `evobc-evo-cat-01608`.
- Source label for search only: `唬`.
- Source codepoints for search only: `U+552C`.
