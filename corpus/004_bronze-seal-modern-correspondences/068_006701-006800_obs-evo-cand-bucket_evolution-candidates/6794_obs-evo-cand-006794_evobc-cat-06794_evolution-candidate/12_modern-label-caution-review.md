# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006794
...
- EVOBC candidate category: `evobc-evo-cat-06794`.
- Source label for search only: `罏`.
- Source codepoints for search only: `U+7F4F`.
