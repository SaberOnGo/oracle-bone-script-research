# coll-obj-cand-00018 collection object candidate
...
`.working/ihp-348/` snapshots. A JPEG was fetched for private inspection only;
...
- `18_live-source-evidence-review.md`: official pages, source description,
  image and 3D routes, and concrete next checks.
