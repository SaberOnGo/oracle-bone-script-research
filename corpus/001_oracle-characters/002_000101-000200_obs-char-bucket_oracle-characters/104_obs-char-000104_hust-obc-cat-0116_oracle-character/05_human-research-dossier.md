# obs-char-000104 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000104`
- primary external id: `hust-obc-cat-0116`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/104_obs-char-000104_hust-obc-cat-0116_orac
  le-character/03_visual-assets/001_asset-000109_hust-obc-cat-0116_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0116/G_0116_甲540(甲).png`
- asset id: `asset-000109`
...
- source category: `0116`
- validation class: `103`
- source image route: `HUST-OBC/deciphered/0116/G_0116_甲540(甲).png`
- asset id: `asset-000109`
...
- English observation: `The image consists of two thick, nearly parallel
  horizontal strokes with a narrow open gap between them.`
- 中文观察: `图像由两道粗而近于平行的横笔构成，中间留有狭窄开放间隔。`
...
- dataset label text: `㑪`
- dataset label codepoints: `U+346A`
...
- Which source records identify obs-char-000104 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000104？
