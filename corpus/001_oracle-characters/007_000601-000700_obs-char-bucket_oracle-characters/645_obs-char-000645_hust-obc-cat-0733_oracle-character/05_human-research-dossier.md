# obs-char-000645 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000645`
- primary external id: `hust-obc-cat-0733`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/645_obs-char-000645_hust-obc-cat-0733_orac
  le-character/03_visual-assets/001_asset-000650_hust-obc-cat-0733_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0733/H_0733_601AD_0.png`
- asset id: `asset-000650`
...
- source category: `0733`
- validation class: `644`
- source image route: `HUST-OBC/deciphered/0733/H_0733_601AD_0.png`
- asset id: `asset-000650`
...
- English observation: `A dark irregular left outline is accompanied by
  several detached marks; a pointed triangular upper loop at right continues
  into a long winding stroke and lower hook.`
- 中文观察: `深色不规则左轮廓旁有数处分离痕；右侧尖三角上环延续为长曲折笔和下钩。`
...
- dataset label text: `㛓`
- dataset label codepoints: `U+36D3`
...
- filename catalog route clues: `catalog-like filename clue: H_0733
  (H_0733_601AD_0.png)`
...
- Which source records identify obs-char-000645 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000645？
