# obs-unk-004306 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004306`
- primary external id: `hust-obc-und-L-004306`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/006_obs-unk-004306_h
  ust-obc-und-L-004306_oracle-character-candidate/03_visual-assets/001_asset
  -005899_hust-obc-und-L-004306_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4306/L_？_9500.jpg`
- asset id: `asset-005899`
...
- source class: `HUST-OBC/undeciphered/L/4306/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4306/L_？_9500.jpg`
- asset id: `asset-005899`
...
- Which source records identify obs-unk-004306 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004306？
