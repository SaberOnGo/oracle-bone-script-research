...
- External category reference: `evobc-cat-06814`
- Source category ID: `06814`
- Source label for human review: `罩`
- Source codepoints: `U+7F69`
...
- `obs-evo-cand-006814-route-category-staging`
...
- `obs-evo-cand-006814-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006814-route-evolution-graph`
