...
- Project ID: `obs-evo-cand-013480`
- EVOBC category candidate ID: `evobc-evo-cat-13480`
- External category reference: `evobc-cat-13480`
- Source category ID: `13480`
- Source label for human review: `𭅔`
- Source codepoints: `U+2D154`
...
- `obs-evo-cand-013480-route-category-staging`
...
- `obs-evo-cand-013480-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013480-route-evolution-graph`
