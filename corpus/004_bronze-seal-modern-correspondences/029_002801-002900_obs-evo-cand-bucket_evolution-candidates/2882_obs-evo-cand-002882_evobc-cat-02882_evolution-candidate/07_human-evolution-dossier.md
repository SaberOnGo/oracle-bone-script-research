...
- External category reference: `evobc-cat-02882`
- Source category ID: `02882`
- Source label for human review: `復`
- Source codepoints: `U+5FA9`
- Image reference count in source metadata: `186`
...
- `obs-evo-cand-002882-route-category-staging`
...
- `obs-evo-cand-002882-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002882-route-evolution-graph`
