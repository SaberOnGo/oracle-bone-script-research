...
- External category reference: `evobc-cat-00740`
- Source category ID: `00740`
- Source label for human review: `仜`
- Source codepoints: `U+4EDC`
...
- `obs-evo-cand-000740-route-category-staging`
...
- `obs-evo-cand-000740-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000740-route-evolution-graph`
