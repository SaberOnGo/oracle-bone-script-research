...
- External category reference: `evobc-cat-07766`
- Source category ID: `07766`
- Source label for human review: `蛻`
...
- `obs-evo-cand-007766-route-category-staging`
...
- `obs-evo-cand-007766-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007766-route-evolution-graph`
