...
Project ID: `obs-evo-cand-012073`
...
- Project ID: `obs-evo-cand-012073`
- EVOBC category candidate ID: `evobc-evo-cat-12073`
- External category reference: `evobc-cat-12073`
- Source category ID: `12073`
- Source label for human review: `𦦁`
- Source codepoints: `U+26981`
...
- `obs-evo-cand-012073-route-category-staging`
...
- `obs-evo-cand-012073-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012073-route-evolution-graph`
