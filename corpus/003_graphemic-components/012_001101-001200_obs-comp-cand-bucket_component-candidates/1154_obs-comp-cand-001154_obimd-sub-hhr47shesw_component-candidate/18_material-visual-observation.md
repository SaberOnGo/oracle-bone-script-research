# Material Visual Observation / obs-comp-cand-001154 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001154`
- External reference / 外部参照: `obimd-sub-hhr47shesw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015344_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hhr47shesw/hhr47shesw/hhr47shesw.png`
- Checksum / 校验和:
  `352502a7490220240213fd987145ff4d2230739d3ee14f58eeb2808fa25aa1b6`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.62%.
- Marked-pixel bounds: (87,37)–(162,204); span 76 × 168 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.62%。
- 痕迹范围：(87,37)–(162,204)；跨度76 × 168 px；痕迹矩形高于宽。
