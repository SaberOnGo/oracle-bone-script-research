# Human Inscription Dossier / 人类卜辞资料夹

Project ID: `obs-insc-cw-cand-000312`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000312`
...
- Source page section: `Period II Group 1` /
  `第 II 期第 1 组`
- Source section key: `period-ii-group-1`
- Section declared count: `29`
- Section observed row count: `28`
- Count status: `declared_count_differs_from_observed_rows`
...
- Type: `cambridge_university_library`
  Value: `425`
  Status: `present_in_cambridge_hopkins_metadata`
  Review: `verify_against_primary_catalog_object_record_and_source_image`
- Type: `chalfant`
...
- Yingguo / 英国所藏: `y1966` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `425` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: 待查: missing Chalfant reference in source row
- Heji / 合集: `41083` in source row; primary catalog entry pending
...
- Findspot / 出土地: 待查: excavation or findspot evidence for the physical
  object
- Period / 时期: `II` from source metadata; not a new dating
- Group and batch / 组类与批次: group `1`; batch or pit context pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000312`
...
- Missing reference types: `chalfant`
