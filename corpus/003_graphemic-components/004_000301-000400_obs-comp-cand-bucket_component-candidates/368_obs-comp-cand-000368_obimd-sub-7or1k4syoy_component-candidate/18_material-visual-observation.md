# Material Visual Observation / obs-comp-cand-000368 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000368`
- External reference / 外部参照: `obimd-sub-7or1k4syoy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012291_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7or1k4syoy/7or1k4syoy/7or1k4syoy.png`
- Checksum / 校验和:
  `c5e8ef48d831af565255d9f920a0cdb573a3454b68d8b4ccc8654e9d59417369`
...
- Marked-pixel bounds: (55,54)–(194,194); span 140 × 141 px; the marked
...
- 痕迹范围：(55,54)–(194,194)；跨度140 × 141 px；痕迹矩形近方形。
