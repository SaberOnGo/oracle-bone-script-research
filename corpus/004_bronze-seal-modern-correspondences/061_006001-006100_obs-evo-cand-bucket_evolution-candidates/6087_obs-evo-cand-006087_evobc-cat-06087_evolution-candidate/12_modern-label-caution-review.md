# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006087
...
- EVOBC candidate category: `evobc-evo-cat-06087`.
- Source label for search only: `稀`.
- Source codepoints for search only: `U+7A00`.
