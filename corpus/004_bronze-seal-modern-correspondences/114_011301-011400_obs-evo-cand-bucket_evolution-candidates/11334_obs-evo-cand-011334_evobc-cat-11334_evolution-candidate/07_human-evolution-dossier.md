...
- External category reference: `evobc-cat-11334`
- Source category ID: `11334`
- Source label for human review: `𢼭`
- Source codepoints: `U+22F2D`
...
- `obs-evo-cand-011334-route-category-staging`
...
- `obs-evo-cand-011334-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011334-route-evolution-graph`
