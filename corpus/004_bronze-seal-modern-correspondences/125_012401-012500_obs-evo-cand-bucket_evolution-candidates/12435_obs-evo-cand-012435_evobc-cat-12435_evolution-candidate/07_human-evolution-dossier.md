...
Project ID: `obs-evo-cand-012435`
...
- Project ID: `obs-evo-cand-012435`
- EVOBC category candidate ID: `evobc-evo-cat-12435`
- External category reference: `evobc-cat-12435`
- Source category ID: `12435`
- Source label for human review: `𨛱`
- Source codepoints: `U+286F1`
...
- `obs-evo-cand-012435-route-category-staging`
...
- `obs-evo-cand-012435-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012435-route-evolution-graph`
