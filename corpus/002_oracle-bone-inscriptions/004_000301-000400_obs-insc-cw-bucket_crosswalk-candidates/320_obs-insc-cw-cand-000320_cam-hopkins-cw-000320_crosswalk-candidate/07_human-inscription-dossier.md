...
Project ID: `obs-insc-cw-cand-000320`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000320`
...
- Source page section: `Period II Group 2` /
  `第 II 期第 2 组`
- Source section key: `period-ii-group-2`
...
- Yingguo / 英国所藏: `y1978` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `437` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `413` in source row; primary catalog entry pending
- Heji / 合集: `41011` in source row; primary catalog entry pending
...
- Group and batch / 组类与批次: group `2`; batch or pit context pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000320`
