...
- External category reference: `evobc-cat-02757`
- Source category ID: `02757`
- Source label: `廔`
...
- `obs-evo-cand-002757-route-category-staging`
...
- `obs-evo-cand-002757-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002757-route-evolution-graph`
