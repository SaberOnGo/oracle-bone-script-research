# Material Visual Observation / obs-comp-cand-000035 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000035`
- External reference / 外部参照: `obimd-sub-auprttukg2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011292_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/auprttukg2/auprttukg2/auprttukg2.png`
- Checksum / 校验和:
  `1acc4ea6fc278c4f8466ef23b2a5577d73335c7fc22d96a3fbfdf1e36d6a3c50`
...
- Marked-pixel bounds: (66,26)–(180,225); span 115 × 200 px; the marked
...
- 痕迹范围：(66,26)–(180,225)；跨度115 × 200 px；痕迹矩形高于宽。
