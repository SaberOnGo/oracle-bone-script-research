# Material Visual Observation / obs-comp-cand-001007 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001007`
- External reference / 外部参照: `obimd-sub-7jjbgcqg1h`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014470_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7jjbgcqg1h/7jjbgcqg1h/7jjbgcqg1h.png`
- Checksum / 校验和:
  `415e99946c07c119ef32b5fb4ae470bc922a1972f4211749aca373c7329fc143`
...
- Marked-pixel bounds: (46,17)–(187,232); span 142 × 216 px; the marked
...
- 痕迹范围：(46,17)–(187,232)；跨度142 × 216 px；痕迹矩形高于宽。
