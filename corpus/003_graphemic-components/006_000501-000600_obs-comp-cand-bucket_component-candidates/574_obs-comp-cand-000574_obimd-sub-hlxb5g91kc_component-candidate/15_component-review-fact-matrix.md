# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000574
...
| Glyph or codepoint route / 字形或码位路线 | 277 OBIMD route rows; examples U+7FCC;U+7FFC;U+F3571; U+F3572; 另有 275 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 277 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
