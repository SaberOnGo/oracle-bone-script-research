...
- Project ID: `obs-evo-cand-010897`
- EVOBC category candidate ID: `evobc-evo-cat-10897`
- External category reference: `evobc-cat-10897`
- Source category ID: `10897`
- Source label for human review: `𠨵`
- Source codepoints: `U+20A35`
...
- `obs-evo-cand-010897-route-category-staging`
...
- `obs-evo-cand-010897-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010897-route-evolution-graph`
