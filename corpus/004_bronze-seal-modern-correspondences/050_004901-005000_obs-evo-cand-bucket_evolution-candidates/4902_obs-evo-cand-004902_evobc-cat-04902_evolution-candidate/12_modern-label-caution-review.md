# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004902
...
- EVOBC candidate category: `evobc-evo-cat-04902`.
- Source label for search only: `潝`.
- Source codepoints for search only: `U+6F5D`.
