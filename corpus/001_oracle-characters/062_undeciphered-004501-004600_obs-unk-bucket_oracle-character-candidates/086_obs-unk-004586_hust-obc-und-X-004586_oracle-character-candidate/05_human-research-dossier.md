# obs-unk-004586 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004586`
- primary external id: `hust-obc-und-X-004586`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/086_obs-unk-004586_h
  ust-obc-und-X-004586_oracle-character-candidate/03_visual-assets/001_asset
  -006179_hust-obc-und-X-004586_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/142/X_？_8320_1.png`
- asset id: `asset-006179`
...
- source class: `HUST-OBC/undeciphered/X/142/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/142/X_？_8320_1.png`
- asset id: `asset-006179`
...
- English observation: `Unequal upper branches, two lower openings, and`
  `right extension recorded.`
- 中文观察: `已记录上部不等分支、下部两个开口和右侧外伸。`
...
- Which source records identify obs-unk-004586 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004586？
