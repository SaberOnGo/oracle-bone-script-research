# Material Visual Observation / obs-comp-cand-000167 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000167`
- External reference / 外部参照: `obimd-sub-6xvu1px4mk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011579_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/l62kyktzq2/6xvu1px4mk/6xvu1px4mk.png`
- Checksum / 校验和:
  `d33a7622c47080d80e98f77410f821194428cbd455ebf044d5e8587bd7f9d6ef`
...
- Marked-pixel bounds: (47,43)–(202,207); span 156 × 165 px; the marked
...
- 痕迹范围：(47,43)–(202,207)；跨度156 × 165 px；痕迹矩形近方形。
