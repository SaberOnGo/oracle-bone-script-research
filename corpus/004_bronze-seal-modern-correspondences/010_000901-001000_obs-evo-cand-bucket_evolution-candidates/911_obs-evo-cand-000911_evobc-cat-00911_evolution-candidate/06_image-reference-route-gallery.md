...
- `obs-evo-cand-000911-route-category-staging`
...
- `obs-evo-cand-000911-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000911-route-evolution-graph`
