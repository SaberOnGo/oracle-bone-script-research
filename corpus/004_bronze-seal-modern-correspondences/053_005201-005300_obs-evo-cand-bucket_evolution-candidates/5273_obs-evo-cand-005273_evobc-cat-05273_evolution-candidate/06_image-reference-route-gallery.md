...
- `obs-evo-cand-005273-route-category-staging`
...
- `obs-evo-cand-005273-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005273-route-evolution-graph`
