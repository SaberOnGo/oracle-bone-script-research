# Material Visual Observation / obs-comp-cand-000710 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000710`
- External reference / 外部参照: `obimd-sub-7dsqpte737`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013422_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/d15m8dd17h/7dsqpte737/7dsqpte737.png`
- Checksum / 校验和:
  `c5489f6cd93caf304d99dac7a900e6ccf0bdcb262ccd7f6b7ee61180d8a756fe`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.39%.
- Marked-pixel bounds: (71,24)–(179,228); span 109 × 205 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.39%。
- 痕迹范围：(71,24)–(179,228)；跨度109 × 205 px；痕迹矩形高于宽。
