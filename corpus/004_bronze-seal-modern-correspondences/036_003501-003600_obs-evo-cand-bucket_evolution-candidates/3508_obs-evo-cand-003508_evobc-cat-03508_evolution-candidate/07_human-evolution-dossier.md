...
- External category reference: `evobc-cat-03508`
- Source category ID: `03508`
- Source label: `撰`
...
- `obs-evo-cand-003508-route-category-staging`
...
- `obs-evo-cand-003508-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003508-route-evolution-graph`
