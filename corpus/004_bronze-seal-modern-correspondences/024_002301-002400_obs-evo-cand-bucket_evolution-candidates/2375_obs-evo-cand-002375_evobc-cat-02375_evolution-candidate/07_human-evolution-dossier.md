...
- External category reference: `evobc-cat-02375`
- Source category ID: `02375`
- Source label for human review: `宙`
- Source codepoints: `U+5B99`
...
- `obs-evo-cand-002375-route-category-staging`
...
- `obs-evo-cand-002375-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002375-route-evolution-graph`
