...
- External category reference: `evobc-cat-11397`
- Source category ID: `11397`
- Source label for human review: `𣅌`
...
- `obs-evo-cand-011397-route-category-staging`
...
- `obs-evo-cand-011397-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011397-route-evolution-graph`
