...
- External category reference: `evobc-cat-12659`
- Source category ID: `12659`
- Source label for human review: `𩤲`
...
- `obs-evo-cand-012659-route-category-staging`
...
- `obs-evo-cand-012659-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012659-route-evolution-graph`
