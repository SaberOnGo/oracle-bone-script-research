# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000948
...
| --- | --- | --- | --- |
| `obimd-glyph-link-013624` | 򩂋󵓿 | `U+A908B;U+F54FF` | `reviewed_metadata_only` |
| `obimd-glyph-link-013625` | 󵔀 | `U+F5500` | `reviewed_metadata_only` |
| `obimd-glyph-link-013626` | 󵔁 | `U+F5501` | `reviewed_metadata_only` |
