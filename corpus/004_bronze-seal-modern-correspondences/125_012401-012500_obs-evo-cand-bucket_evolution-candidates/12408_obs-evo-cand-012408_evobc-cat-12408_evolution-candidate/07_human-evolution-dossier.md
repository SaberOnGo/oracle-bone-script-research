...
- External category reference: `evobc-cat-12408`
- Source category ID: `12408`
- Source label for human review: `𨚕`
...
- `obs-evo-cand-012408-route-category-staging`
...
- `obs-evo-cand-012408-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012408-route-evolution-graph`
