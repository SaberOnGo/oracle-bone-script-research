...
- External category reference: `evobc-cat-04071`
- Source category ID: `04071`
- Source label for human review: `梨`
- Source codepoints: `U+68A8`
...
- `obs-evo-cand-004071-route-category-staging`
...
- `obs-evo-cand-004071-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004071-route-evolution-graph`
