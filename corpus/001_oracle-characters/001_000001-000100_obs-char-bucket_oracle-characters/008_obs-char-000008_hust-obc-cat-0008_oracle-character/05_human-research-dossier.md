# obs-char-000008 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/008_obs-char-000008_hust-obc-cat-0008_orac
  le-character/03_visual-assets/001_asset-000013_hust-obc-cat-0008_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0008/H_0008_60BCB_0.png`
- asset id: `asset-000013`
...
- source category: `0008`
- validation class: `7`
- source image route: `HUST-OBC/deciphered/0008/H_0008_60BCB_0.png`
- asset id: `asset-000013`
...
- English observation: `The image shows a rectangular enclosure, diagonal
  interior strokes, and a small central enclosed mark.`
- 中文观察: `图像呈长方形外框，内部有斜向笔画，中部另有小型闭合痕迹。`
...
- dataset label text: `⺼`
- dataset label codepoints: `U+2EBC`
...
- filename catalog route clues: `catalog-like filename clue: H_0008
  (H_0008_60BCB_0.png)`
...
- Which source records identify obs-char-000008 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000008？
