# Material Visual Observation / obs-unk-002667
...
- Primary external reference / 首选外部参考:
  `hust-obc-und-L-002667`
- Committed image / 已提交图像:
  `03_visual-assets/001_asset-004260_hust-obc-und-L-002667_glyph.jpg`
- Opened derivative / 已打开派生件: the committed review image

## Direct Visual Record / 直接可见记录

- English observation: Two upper strokes branch from a central area. A
  descending central mark crosses a short horizontal stroke near the lower
  end.
- 中文观察：两条上部笔痕从中央区域分出。中央下行笔痕在下端附近交叉一
  条短横笔痕。
