...
Project ID: `obs-evo-cand-005011`
...
- Project ID: `obs-evo-cand-005011`
- EVOBC category candidate ID: `evobc-evo-cat-05011`
- External category reference: `evobc-cat-05011`
- Source category ID: `05011`
- Source label for human review: `灈`
- Source codepoints: `U+7048`
...
- `obs-evo-cand-005011-route-category-staging`
...
- `obs-evo-cand-005011-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005011-route-evolution-graph`
