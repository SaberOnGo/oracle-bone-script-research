...
- External category reference: `evobc-cat-09084`
- Source category ID: `09084`
- Source label for human review: `邑`
- Source codepoints: `U+9091`
...
- `obs-evo-cand-009084-route-category-staging`
...
- `obs-evo-cand-009084-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009084-route-evolution-graph`
