...
- External category reference: `evobc-cat-06817`
- Source category ID: `06817`
- Source label for human review: `罭`
- Source codepoints: `U+7F6D`
...
- `obs-evo-cand-006817-route-category-staging`
...
- `obs-evo-cand-006817-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006817-route-evolution-graph`
