# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-000140
...
- candidate_component_id: `obs-comp-cand-000140`
- primary_external_ref_id: `obimd-sub-gtadlgs1p2`
- source_subcharacter_uid: `gtadlgs1p2`
- source_main_character_uid: `shksxlt8ok`
- main_character_external_ref_id: `obimd-main-shksxlt8ok`
...
- glyph_codepoint_uplus_sample: `U+F0CC2, U+F0CC3, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-011552` | `001_asset-011552_img.png` | `5430a07669c3e707fbfa630819fe0b4627399b5e930350649d64c7b8f4f24551` |
