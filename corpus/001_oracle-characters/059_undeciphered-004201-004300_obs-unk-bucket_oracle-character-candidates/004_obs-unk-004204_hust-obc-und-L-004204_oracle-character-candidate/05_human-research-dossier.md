# obs-unk-004204 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/004_obs-unk-004204_h
  ust-obc-und-L-004204_oracle-character-candidate/03_visual-assets/001_asset
  -005797_hust-obc-und-L-004204_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4204/L_？_9156.jpg`
- asset id: `asset-005797`
...
- source class: `HUST-OBC/undeciphered/L/4204/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4204/L_？_9156.jpg`
- asset id: `asset-005797`
...
- English observation: `Outer outline, inner marks; upper crossings visible.`
- 中文观察: `圆弧外轮廓、内部痕迹和上部交叉处可见。`
...
- Which source records identify obs-unk-004204 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004204？
