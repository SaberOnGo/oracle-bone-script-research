...
- External category reference: `evobc-cat-09465`
- Source category ID: `09465`
- Source label: `鍱`
...
- `obs-evo-cand-009465-route-category-staging`
...
- `obs-evo-cand-009465-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009465-route-evolution-graph`
