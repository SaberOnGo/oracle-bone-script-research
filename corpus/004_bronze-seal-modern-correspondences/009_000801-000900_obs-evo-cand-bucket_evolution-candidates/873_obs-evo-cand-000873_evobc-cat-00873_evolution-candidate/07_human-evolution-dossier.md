...
- Project ID: `obs-evo-cand-000873`
- EVOBC category candidate ID: `evobc-evo-cat-00873`
- External category reference: `evobc-cat-00873`
- Source category ID: `00873`
- Source label for human review: `促`
- Source codepoints: `U+4FC3`
...
- `obs-evo-cand-000873-route-category-staging`
...
- `obs-evo-cand-000873-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000873-route-evolution-graph`
