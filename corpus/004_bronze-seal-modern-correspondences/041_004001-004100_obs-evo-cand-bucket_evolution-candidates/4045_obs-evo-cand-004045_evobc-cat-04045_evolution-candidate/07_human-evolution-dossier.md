...
- External category reference: `evobc-cat-04045`
- Source category ID: `04045`
- Source label for human review: `桿`
...
- `obs-evo-cand-004045-route-category-staging`
...
- `obs-evo-cand-004045-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004045-route-evolution-graph`
