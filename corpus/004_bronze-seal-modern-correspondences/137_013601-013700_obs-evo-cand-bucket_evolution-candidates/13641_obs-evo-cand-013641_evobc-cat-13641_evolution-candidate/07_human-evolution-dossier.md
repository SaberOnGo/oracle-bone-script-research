...
- External category reference: `evobc-cat-13641`
- Source category ID: `13641`
- Source label for human review: `𮘙`
- Source codepoints: `U+2E619`
...
- `obs-evo-cand-013641-route-category-staging`
...
- `obs-evo-cand-013641-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013641-route-evolution-graph`
