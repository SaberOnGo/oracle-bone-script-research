...
Project ID: `obs-evo-cand-012197`
...
- Project ID: `obs-evo-cand-012197`
- EVOBC category candidate ID: `evobc-evo-cat-12197`
- External category reference: `evobc-cat-12197`
- Source category ID: `12197`
- Source label for human review: `𧛚`
- Source codepoints: `U+276DA`
...
- `obs-evo-cand-012197-route-category-staging`
...
- `obs-evo-cand-012197-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012197-route-evolution-graph`
