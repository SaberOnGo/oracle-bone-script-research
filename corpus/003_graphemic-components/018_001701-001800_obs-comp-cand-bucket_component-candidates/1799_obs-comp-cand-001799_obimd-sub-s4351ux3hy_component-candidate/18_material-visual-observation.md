# Material Visual Observation / obs-comp-cand-001799 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001799`
- External reference / 外部参照: `obimd-sub-s4351ux3hy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018020_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hcj1lu3l9a/s4351ux3hy/s4351ux3hy.png`
- Checksum / 校验和:
  `4a03752aaa396afafd1b61c31948dac0b36f9256b626345a1e3f5749f37a436e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.50%.
- Marked-pixel bounds: (77,24)–(171,226); span 95 × 203 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.50%。
- 痕迹范围：(77,24)–(171,226)；跨度95 × 203 px；痕迹矩形高于宽。
