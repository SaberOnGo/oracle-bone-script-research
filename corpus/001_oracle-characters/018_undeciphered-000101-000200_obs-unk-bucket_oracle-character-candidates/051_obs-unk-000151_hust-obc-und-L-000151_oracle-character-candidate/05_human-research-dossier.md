# obs-unk-000151 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000151`
- primary external id: `hust-obc-und-L-000151`
...
- local review image route: `corpus/001_oracle-characters/018_undeciphered-000
  101-000200_obs-unk-bucket_oracle-character-candidates/051_obs-unk-000151_h
  ust-obc-und-L-000151_oracle-character-candidate/03_visual-assets/001_asset
  -001744_hust-obc-und-L-000151_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/151/L_？_1048.jpg`
- asset id: `asset-001744`
...
- source class: `HUST-OBC/undeciphered/L/151/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/151/L_？_1048.jpg`
- asset id: `asset-001744`
...
- Which source records identify obs-unk-000151 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000151？
