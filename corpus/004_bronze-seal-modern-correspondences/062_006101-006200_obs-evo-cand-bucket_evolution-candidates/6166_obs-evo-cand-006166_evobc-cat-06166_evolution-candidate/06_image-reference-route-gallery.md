...
- `obs-evo-cand-006166-route-category-staging`
...
- `obs-evo-cand-006166-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006166-route-evolution-graph`
