# obs-char-000469 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000469`
- primary external id: `hust-obc-cat-0531`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/469_obs-char-000469_hust-obc-cat-0531_orac
  le-character/03_visual-assets/001_asset-000474_hust-obc-cat-0531_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0531/G_0531_乙766合22072午組.png`
- asset id: `asset-000474`
...
- source category: `0531`
- validation class: `468`
- source image route: `HUST-OBC/deciphered/0531/G_0531_乙766合22072午組.png`
- asset id: `asset-000474`
...
- English observation: `A pointed outline open along the bottom surrounds a
  central top bar and one long vertical stroke, with a shorter parallel
  stroke beside it.`
- 中文观察: `底部开口的尖顶轮廓包围中央顶横和一条长竖笔，其旁另有一条较短平行笔画。`
...
- dataset label text: `㘉`
- dataset label codepoints: `U+3609`
...
- filename catalog route clues: `Heji-like filename clue: 合22072
  (G_0531_乙766合22072午組.png)`
...
- Which source records identify obs-char-000469 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000469？
