...
Project ID: `obs-evo-cand-008274`
...
- Project ID: `obs-evo-cand-008274`
- EVOBC category candidate ID: `evobc-evo-cat-08274`
- External category reference: `evobc-cat-08274`
- Source category ID: `08274`
- Source label for human review: `諛`
- Source codepoints: `U+8ADB`
...
- `obs-evo-cand-008274-route-category-staging`
...
- `obs-evo-cand-008274-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008274-route-evolution-graph`
