...
Project ID: `obs-evo-cand-003367`
...
- Project ID: `obs-evo-cand-003367`
- EVOBC category candidate ID: `evobc-evo-cat-03367`
- External category reference: `evobc-cat-03367`
- Source category ID: `03367`
- Source label for human review: `捋`
- Source codepoints: `U+634B`
...
- `obs-evo-cand-003367-route-category-staging`
...
- `obs-evo-cand-003367-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003367-route-evolution-graph`
