# obs-char-001587 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001587`
- primary external id: `hust-obc-cat-1779_1780`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1587_obs-char-001587_hust-obc-cat-1779_178
  0_oracle-character/03_visual-assets/001_asset-001592_hust-obc-cat-1779_178
  0_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1779_1780/1780/G_1780_京津2815.pn
  g`
- asset id: `asset-001592`
...
- source category: `1779_1780`
- validation class: `1586`
- source image route: `HUST-OBC/deciphered/1779_1780/1780/G_1780_京津2815.png`
- asset id: `asset-001592`
...
- English observation: `Two stacked forms show a small upper trapezoid
  enclosure and a separate lower diamond mark.`
- 中文观察: `两个上下叠置形体有上部小型梯形框和分离的下部菱形标记。`
...
- dataset label text: `㫩㫪`
- dataset label codepoints: `U+3AE9;U+3AEA`
...
- graph edge count: `2`
- codepoint routes: `U+3AE9;U+3AEA`
...
- Which source records identify obs-char-001587 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001587？
