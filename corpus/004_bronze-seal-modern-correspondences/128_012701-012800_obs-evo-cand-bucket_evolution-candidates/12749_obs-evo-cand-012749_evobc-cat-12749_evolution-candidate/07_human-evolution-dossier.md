...
Project ID: `obs-evo-cand-012749`
...
- Project ID: `obs-evo-cand-012749`
- EVOBC category candidate ID: `evobc-evo-cat-12749`
- External category reference: `evobc-cat-12749`
- Source category ID: `12749`
- Source label for human review: `𪍟`
- Source codepoints: `U+2A35F`
...
- `obs-evo-cand-012749-route-category-staging`
...
- `obs-evo-cand-012749-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012749-route-evolution-graph`
