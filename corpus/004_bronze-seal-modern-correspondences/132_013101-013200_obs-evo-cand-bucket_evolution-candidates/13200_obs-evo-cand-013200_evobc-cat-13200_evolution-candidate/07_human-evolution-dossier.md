...
- Project ID: `obs-evo-cand-013200`
- EVOBC category candidate ID: `evobc-evo-cat-13200`
- External category reference: `evobc-cat-13200`
- Source category ID: `13200`
- Source label for human review: `𬅒`
- Source codepoints: `U+2C152`
...
- `obs-evo-cand-013200-route-category-staging`
...
- `obs-evo-cand-013200-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013200-route-evolution-graph`
