...
- External category reference: `evobc-cat-10770`
- Source category ID: `10770`
- Source label for human review: `𠁵`
- Source codepoints: `U+20075`
...
- `obs-evo-cand-010770-route-category-staging`
...
- `obs-evo-cand-010770-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010770-route-evolution-graph`
