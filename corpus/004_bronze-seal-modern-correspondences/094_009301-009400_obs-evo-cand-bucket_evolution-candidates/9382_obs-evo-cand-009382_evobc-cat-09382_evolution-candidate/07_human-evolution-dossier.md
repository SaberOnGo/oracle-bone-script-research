...
Project ID: `obs-evo-cand-009382`
...
- Project ID: `obs-evo-cand-009382`
- EVOBC category candidate ID: `evobc-evo-cat-09382`
- External category reference: `evobc-cat-09382`
- Source category ID: `09382`
- Source label for human review: `銍`
- Source codepoints: `U+928D`
...
- `obs-evo-cand-009382-route-category-staging`
...
- `obs-evo-cand-009382-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009382-route-evolution-graph`
