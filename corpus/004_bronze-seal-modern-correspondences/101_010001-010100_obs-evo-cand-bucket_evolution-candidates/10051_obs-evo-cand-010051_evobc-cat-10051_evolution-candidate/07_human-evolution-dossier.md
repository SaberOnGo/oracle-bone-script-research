...
- External category reference: `evobc-cat-10051`
- Source category ID: `10051`
- Source label: `预`
...
- `obs-evo-cand-010051-route-category-staging`
...
- `obs-evo-cand-010051-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010051-route-evolution-graph`
