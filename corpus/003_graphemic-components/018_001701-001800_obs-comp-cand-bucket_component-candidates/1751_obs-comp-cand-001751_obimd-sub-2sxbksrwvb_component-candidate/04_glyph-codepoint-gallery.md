# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001751
...
| --- | --- | --- | --- |
| `obimd-glyph-link-026996` | 󺈌 | `U+FA20C` | `reviewed_metadata_only` |
| `obimd-glyph-link-026997` | 󺈍 | `U+FA20D` | `reviewed_metadata_only` |
| `obimd-glyph-link-026998` | 󺈎 | `U+FA20E` | `reviewed_metadata_only` |
| `obimd-glyph-link-026999` | 󺈏 | `U+FA20F` | `reviewed_metadata_only` |
