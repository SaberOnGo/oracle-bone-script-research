...
- External category reference: `evobc-cat-12215`
- Source category ID: `12215`
- Source label for human review: `𧣜`
- Source codepoints: `U+278DC`
...
- `obs-evo-cand-012215-route-category-staging`
...
- `obs-evo-cand-012215-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012215-route-evolution-graph`
