...
- External category reference: `evobc-cat-11356`
- Source category ID: `11356`
- Source label for human review: `𢿐`
...
- `obs-evo-cand-011356-route-category-staging`
...
- `obs-evo-cand-011356-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011356-route-evolution-graph`
