# Material Visual Observation / obs-comp-cand-002178 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002178`
- External reference / 外部参照: `obimd-sub-02vgag02gp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019879_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/e8qibnliym/02vgag02gp/02vgag02gp.png`
- Checksum / 校验和:
  `e77530ab72add52db839204ce38888957df5ff04e121b3ac2d359c6bd893c4bd`
...
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.23%。
