...
- Project ID: `obs-evo-cand-009285`
- EVOBC category candidate ID: `evobc-evo-cat-09285`
- External category reference: `evobc-cat-09285`
- Source category ID: `09285`
- Source label for human review: `醲`
- Source codepoints: `U+91B2`
...
- `obs-evo-cand-009285-route-category-staging`
...
- `obs-evo-cand-009285-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009285-route-evolution-graph`
