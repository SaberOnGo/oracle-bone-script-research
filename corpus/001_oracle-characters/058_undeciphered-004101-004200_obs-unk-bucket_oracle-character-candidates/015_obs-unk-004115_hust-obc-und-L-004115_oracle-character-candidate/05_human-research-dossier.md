# obs-unk-004115 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004115`
- primary external id: `hust-obc-und-L-004115`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/015_obs-unk-004115_h
  ust-obc-und-L-004115_oracle-character-candidate/03_visual-assets/001_asset
  -005708_hust-obc-und-L-004115_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4115/L_？_8856.jpg`
- asset id: `asset-005708`
...
- source class: `HUST-OBC/undeciphered/L/4115/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4115/L_？_8856.jpg`
- asset id: `asset-005708`
...
- English observation: The opened image shows tall angled strokes, a dense
  central cluster, and a rounded or horizontal lower base.
- 中文观察：已打开图像可见高斜向笔画、密集中部痕迹和圆弧或横向基部。
...
- Which source records identify obs-unk-004115 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004115？
