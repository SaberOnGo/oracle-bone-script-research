# Material Visual Observation / obs-comp-cand-000536 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000536`
- External reference / 外部参照: `obimd-sub-czkk81b52k`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012770_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/m32ngscsu1/czkk81b52k/czkk81b52k.png`
- Checksum / 校验和:
  `9bf3d2f00c0509e11932f8140732ebd80940693369f7c440e496c889046723c4`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.98%.
- Marked-pixel bounds: (56,69)–(193,187); span 138 × 119 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.98%。
- 痕迹范围：(56,69)–(193,187)；跨度138 × 119 px；痕迹矩形近方形。
