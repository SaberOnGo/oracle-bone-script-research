...
- External category reference: `evobc-cat-08420`
- Source category ID: `08420`
- Source label for human review: `词`
- Source codepoints: `U+8BCD`
...
- `obs-evo-cand-008420-route-category-staging`
...
- `obs-evo-cand-008420-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008420-route-evolution-graph`
