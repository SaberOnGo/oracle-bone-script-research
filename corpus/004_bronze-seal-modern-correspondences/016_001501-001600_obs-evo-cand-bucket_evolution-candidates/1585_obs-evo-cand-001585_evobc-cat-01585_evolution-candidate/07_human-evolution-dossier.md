...
- External category reference: `evobc-cat-01585`
- Source category ID: `01585`
- Source label for human review: `員`
...
- `obs-evo-cand-001585-route-category-staging`
...
- `obs-evo-cand-001585-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001585-route-evolution-graph`
