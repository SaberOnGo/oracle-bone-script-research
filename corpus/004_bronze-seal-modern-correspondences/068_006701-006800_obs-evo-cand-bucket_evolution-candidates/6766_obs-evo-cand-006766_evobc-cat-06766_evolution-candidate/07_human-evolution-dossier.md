...
Project ID: `obs-evo-cand-006766`
...
- Project ID: `obs-evo-cand-006766`
- EVOBC category candidate ID: `evobc-evo-cat-06766`
- External category reference: `evobc-cat-06766`
- Source category ID: `06766`
- Source label for human review: `绽`
- Source codepoints: `U+7EFD`
...
- `obs-evo-cand-006766-route-category-staging`
...
- `obs-evo-cand-006766-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006766-route-evolution-graph`
