# Material Visual Observation / obs-comp-cand-000379 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000379`
- External reference / 外部参照: `obimd-sub-96ixqidd0x`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012302_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fmv0hxp7i5/96ixqidd0x/96ixqidd0x.png`
- Checksum / 校验和:
  `2b153fab1a2666b770847113a7b4cdcd534a32bd0fdad346d7ca663c6e084eea`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.56%.
- Marked-pixel bounds: (77,24)–(172,226); span 96 × 203 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.56%。
- 痕迹范围：(77,24)–(172,226)；跨度96 × 203 px；痕迹矩形高于宽。
