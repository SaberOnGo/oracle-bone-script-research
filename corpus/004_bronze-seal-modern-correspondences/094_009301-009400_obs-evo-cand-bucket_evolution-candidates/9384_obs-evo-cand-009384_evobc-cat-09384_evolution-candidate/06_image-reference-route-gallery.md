...
- `obs-evo-cand-009384-route-category-staging`
...
- `obs-evo-cand-009384-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009384-route-evolution-graph`
