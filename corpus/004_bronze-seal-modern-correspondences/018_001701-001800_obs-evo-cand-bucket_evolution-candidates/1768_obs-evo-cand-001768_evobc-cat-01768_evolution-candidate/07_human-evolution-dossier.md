...
- Project ID: `obs-evo-cand-001768`
- EVOBC category candidate ID: `evobc-evo-cat-01768`
- External category reference: `evobc-cat-01768`
- Source category ID: `01768`
- Source label for human review: `囹`
- Source codepoints: `U+56F9`
...
- `obs-evo-cand-001768-route-category-staging`
...
- `obs-evo-cand-001768-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001768-route-evolution-graph`
