# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012802
...
- EVOBC candidate category: `evobc-evo-cat-12802`.
- Source label for search only: `𪠅`.
- Source codepoints for search only: `U+2A805`.
