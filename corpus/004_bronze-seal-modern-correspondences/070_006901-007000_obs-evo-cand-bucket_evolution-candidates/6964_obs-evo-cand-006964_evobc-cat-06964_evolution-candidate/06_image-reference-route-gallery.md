...
- `obs-evo-cand-006964-route-category-staging`
...
- `obs-evo-cand-006964-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006964-route-evolution-graph`
