...
- External category reference: `evobc-cat-04218`
- Source category ID: `04218`
- Source label for human review: `槩`
- Source codepoints: `U+69E9`
...
- `obs-evo-cand-004218-route-category-staging`
...
- `obs-evo-cand-004218-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004218-route-evolution-graph`
