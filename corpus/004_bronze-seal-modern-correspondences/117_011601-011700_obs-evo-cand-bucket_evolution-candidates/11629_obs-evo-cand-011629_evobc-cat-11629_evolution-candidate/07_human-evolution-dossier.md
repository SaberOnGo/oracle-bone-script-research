...
Project ID: `obs-evo-cand-011629`
...
- Project ID: `obs-evo-cand-011629`
- EVOBC category candidate ID: `evobc-evo-cat-11629`
- External category reference: `evobc-cat-11629`
- Source category ID: `11629`
- Source label for human review: `𤡕`
- Source codepoints: `U+24855`
...
- `obs-evo-cand-011629-route-category-staging`
...
- `obs-evo-cand-011629-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011629-route-evolution-graph`
