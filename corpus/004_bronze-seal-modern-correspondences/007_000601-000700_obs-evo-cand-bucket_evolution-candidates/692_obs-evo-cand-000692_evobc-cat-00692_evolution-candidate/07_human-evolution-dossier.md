...
Project ID: `obs-evo-cand-000692`
...
- Project ID: `obs-evo-cand-000692`
- EVOBC category candidate ID: `evobc-evo-cat-00692`
- External category reference: `evobc-cat-00692`
- Source category ID: `00692`
- Source label for human review: `亘`
- Source codepoints: `U+4E98`
- Image reference count in source metadata: `79`
...
- `obs-evo-cand-000692-route-category-staging`
...
- `obs-evo-cand-000692-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000692-route-evolution-graph`
