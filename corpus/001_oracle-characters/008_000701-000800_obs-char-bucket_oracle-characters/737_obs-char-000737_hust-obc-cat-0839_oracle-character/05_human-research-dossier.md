# obs-char-000737 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/737_obs-char-000737_hust-obc-cat-0839_orac
  le-character/03_visual-assets/001_asset-000742_hust-obc-cat-0839_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0839/G_0839_前2.19.5(甲).png`
- asset id: `asset-000742`
...
- source category: `0839`
- validation class: `736`
- source image route: `HUST-OBC/deciphered/0839/G_0839_前2.19.5(甲).png`
- asset id: `asset-000742`
...
- English observation: `Two dense bold forms stand close together: the left
  is a branching vertical silhouette, and the right curves around a large
  open loop with short upper projections.`
...
- dataset label text: `㜽`
- dataset label codepoints: `U+373D`
...
- Which source records identify obs-char-000737 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000737？
