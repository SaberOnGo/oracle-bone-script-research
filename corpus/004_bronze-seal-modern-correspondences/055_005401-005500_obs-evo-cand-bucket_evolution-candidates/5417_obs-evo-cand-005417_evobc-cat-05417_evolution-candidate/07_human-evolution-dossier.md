...
- Project ID: `obs-evo-cand-005417`
- EVOBC category candidate ID: `evobc-evo-cat-05417`
- External category reference: `evobc-cat-05417`
- Source category ID: `05417`
- Source label for human review: `琭`
- Source codepoints: `U+742D`
...
- `obs-evo-cand-005417-route-category-staging`
...
- `obs-evo-cand-005417-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005417-route-evolution-graph`
