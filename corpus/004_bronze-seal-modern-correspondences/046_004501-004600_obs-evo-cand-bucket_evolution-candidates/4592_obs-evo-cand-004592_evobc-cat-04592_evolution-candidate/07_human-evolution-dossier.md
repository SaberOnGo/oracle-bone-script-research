...
- External category reference: `evobc-cat-04592`
- Source category ID: `04592`
- Source label for human review: `泥`
...
- `obs-evo-cand-004592-route-category-staging`
...
- `obs-evo-cand-004592-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004592-route-evolution-graph`
