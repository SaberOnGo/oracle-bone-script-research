...
Project ID: `obs-evo-cand-010839`
...
- Project ID: `obs-evo-cand-010839`
- EVOBC category candidate ID: `evobc-evo-cat-10839`
- External category reference: `evobc-cat-10839`
- Source category ID: `10839`
- Source label for human review: `𠗪`
- Source codepoints: `U+205EA`
...
- `obs-evo-cand-010839-route-category-staging`
...
- `obs-evo-cand-010839-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010839-route-evolution-graph`
