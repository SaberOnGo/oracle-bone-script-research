...
- External category reference: `evobc-cat-02361`
- Source category ID: `02361`
- Source label for human review: `宇`
- Source codepoints: `U+5B87`
...
- `obs-evo-cand-002361-route-category-staging`
...
- `obs-evo-cand-002361-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002361-route-evolution-graph`
