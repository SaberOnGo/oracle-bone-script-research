# Material Visual Observation / obs-comp-cand-002017 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002017`
- External reference / 外部参照: `obimd-sub-3clrcpn9fw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019344_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tbecf7rhkr/3clrcpn9fw/3clrcpn9fw.png`
- Checksum / 校验和:
  `8458ba5d04701f45dd6e701e65b21f3a450f740de71eeb32d36eb13115c95b6c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.65%.
- Marked-pixel bounds: (91,21)–(158,227); span 68 × 207 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.65%。
- 痕迹范围：(91,21)–(158,227)；跨度68 × 207 px；痕迹矩形高于宽。
