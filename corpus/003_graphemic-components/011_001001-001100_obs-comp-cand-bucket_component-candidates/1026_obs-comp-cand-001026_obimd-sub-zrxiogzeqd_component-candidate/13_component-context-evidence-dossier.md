# obs-comp-cand-001026 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001026`
- 首选外部 ID: `obimd-sub-zrxiogzeqd`
- OBIMD subcharacter UID: `zrxiogzeqd`
...
- glyph-codepoint 数: `8`
- codepoint 示例: U+B4FF4;U+F5CEA; U+F5CEB; 另有 6 项
