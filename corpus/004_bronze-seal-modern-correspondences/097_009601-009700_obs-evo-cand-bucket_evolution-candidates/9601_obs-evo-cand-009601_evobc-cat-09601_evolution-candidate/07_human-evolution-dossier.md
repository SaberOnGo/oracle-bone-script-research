...
- Project ID: `obs-evo-cand-009601`
- EVOBC category candidate ID: `evobc-evo-cat-09601`
- External category reference: `evobc-cat-09601`
- Source category ID: `09601`
- Source label for human review: `锺`
- Source codepoints: `U+953A`
...
- `obs-evo-cand-009601-route-category-staging`
...
- `obs-evo-cand-009601-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009601-route-evolution-graph`
