...
- External category reference: `evobc-cat-06975`
- Source category ID: `06975`
- Source label for human review: `肈`
- Source codepoints: `U+8088`
- Image reference count in source metadata: `91`
...
- `obs-evo-cand-006975-route-category-staging`
...
- `obs-evo-cand-006975-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006975-route-evolution-graph`
