# obs-char-000765 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000765`
- primary external id: `hust-obc-cat-0868`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/765_obs-char-000765_hust-obc-cat-0868_orac
  le-character/03_visual-assets/001_asset-000770_hust-obc-cat-0868_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0868/X_0868_2908_1.png`
- asset id: `asset-000770`
...
- source category: `0868`
- validation class: `764`
- source image route: `HUST-OBC/deciphered/0868/X_0868_2908_1.png`
- asset id: `asset-000770`
...
- English observation: `Two tall bowed side strokes are joined by a middle
  horizontal; a short thick upright hangs near the center, and the long
  sides finish at different lower heights.`
- 中文观察: `两条高长弓曲侧笔由中部横笔连接；中央附近垂下一条粗短竖笔，两侧长笔在不同高度收尾。`
...
- dataset label text: `㝚`
- dataset label codepoints: `U+375A`
...
- Which source records identify obs-char-000765 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000765？
