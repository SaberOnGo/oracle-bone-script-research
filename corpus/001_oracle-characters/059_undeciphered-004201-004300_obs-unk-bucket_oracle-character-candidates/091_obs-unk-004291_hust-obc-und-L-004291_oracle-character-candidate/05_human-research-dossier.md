# obs-unk-004291 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004291`
- primary external id: `hust-obc-und-L-004291`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/091_obs-unk-004291_h
  ust-obc-und-L-004291_oracle-character-candidate/03_visual-assets/001_asset
  -005884_hust-obc-und-L-004291_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4291/L_？_9473.jpg`
- asset id: `asset-005884`
...
- source class: `HUST-OBC/undeciphered/L/4291/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4291/L_？_9473.jpg`
- asset id: `asset-005884`
...
- English observation: `Upright trace, left bar, right curve visible.`
- 中文观察: `竖向痕迹、左侧横痕和右侧弯痕可见。`
...
- Which source records identify obs-unk-004291 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004291？
