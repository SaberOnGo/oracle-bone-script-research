...
- External category reference: `evobc-cat-10551`
- Source category ID: `10551`
- Source label for human review: `鷕`
- Source codepoints: `U+9DD5`
...
- `obs-evo-cand-010551-route-category-staging`
...
- `obs-evo-cand-010551-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010551-route-evolution-graph`
