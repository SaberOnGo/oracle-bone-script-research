# obs-char-000286 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/286_obs-char-000286_hust-obc-cat-0324_orac
  le-character/03_visual-assets/001_asset-000291_hust-obc-cat-0324_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0324/G_0324_甲骨文.png`
- asset id: `asset-000291`
...
- source category: `0324`
- validation class: `285`
- source image route: `HUST-OBC/deciphered/0324/G_0324_甲骨文.png`
- asset id: `asset-000291`
...
- English observation: `The image shows a rounded U-like enclosure with
  upright side strokes, a low horizontal base, and a short horizontal mark
  inside.`
...
- dataset label text: `㔺`
- dataset label codepoints: `U+353A`
...
- Which source records identify obs-char-000286 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000286？
