# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001648
...
| --- | --- | --- | --- |
| `obimd-glyph-link-025534` | 󹤬 | `U+F992C` | `reviewed_metadata_only` |
| `obimd-glyph-link-025535` | 󹤭 | `U+F992D` | `reviewed_metadata_only` |
| `obimd-glyph-link-025536` | 󹤮 | `U+F992E` | `reviewed_metadata_only` |
