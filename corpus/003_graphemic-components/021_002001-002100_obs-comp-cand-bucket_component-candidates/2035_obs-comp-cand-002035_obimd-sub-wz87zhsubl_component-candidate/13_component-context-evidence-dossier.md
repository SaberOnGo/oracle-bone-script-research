# obs-comp-cand-002035 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002035`
- 首选外部 ID: `obimd-sub-wz87zhsubl`
- OBIMD subcharacter UID: `wz87zhsubl`
- OBIMD main character UID: `sqh9trpulp`
- 来源 ID: `src-obimd`
