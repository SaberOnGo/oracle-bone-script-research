...
- External category reference: `evobc-cat-06531`
- Source category ID: `06531`
- Source label: `絿`
...
- `obs-evo-cand-006531-route-category-staging`
...
- `obs-evo-cand-006531-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006531-route-evolution-graph`
