...
- External category reference: `evobc-cat-12046`
- Source category ID: `12046`
- Source label for human review: `𦚙`
...
- `obs-evo-cand-012046-route-category-staging`
...
- `obs-evo-cand-012046-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012046-route-evolution-graph`
