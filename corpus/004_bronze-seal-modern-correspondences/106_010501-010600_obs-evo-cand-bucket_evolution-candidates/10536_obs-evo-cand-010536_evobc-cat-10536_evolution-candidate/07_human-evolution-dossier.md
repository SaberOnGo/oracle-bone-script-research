...
Project ID: `obs-evo-cand-010536`
...
- Project ID: `obs-evo-cand-010536`
- EVOBC category candidate ID: `evobc-evo-cat-10536`
- External category reference: `evobc-cat-10536`
- Source category ID: `10536`
- Source label for human review: `鶱`
- Source codepoints: `U+9DB1`
...
- `obs-evo-cand-010536-route-category-staging`
...
- `obs-evo-cand-010536-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010536-route-evolution-graph`
