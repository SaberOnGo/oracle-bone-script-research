...
- Project ID: `obs-evo-cand-007362`
- EVOBC category candidate ID: `evobc-evo-cat-07362`
- External category reference: `evobc-cat-07362`
- Source category ID: `07362`
- Source label for human review: `荳`
- Source codepoints: `U+8373`
...
- `obs-evo-cand-007362-route-category-staging`
...
- `obs-evo-cand-007362-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007362-route-evolution-graph`
