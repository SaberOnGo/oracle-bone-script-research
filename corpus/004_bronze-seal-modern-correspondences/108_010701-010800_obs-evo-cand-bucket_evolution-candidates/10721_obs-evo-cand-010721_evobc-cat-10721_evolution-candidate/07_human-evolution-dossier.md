...
Project ID: `obs-evo-cand-010721`
...
- Project ID: `obs-evo-cand-010721`
- EVOBC category candidate ID: `evobc-evo-cat-10721`
- External category reference: `evobc-cat-10721`
- Source category ID: `10721`
- Source label for human review: `齛`
- Source codepoints: `U+9F5B`
...
- `obs-evo-cand-010721-route-category-staging`
...
- `obs-evo-cand-010721-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010721-route-evolution-graph`
