# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002490
...
| Glyph or codepoint route / 字形或码位路线 | 3 OBIMD route rows; examples U+4E00;U+FE316; U+FE317; 另有 1 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 3 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
