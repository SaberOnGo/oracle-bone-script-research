...
- Project ID: `obs-evo-cand-008752`
- EVOBC category candidate ID: `evobc-evo-cat-08752`
- External category reference: `evobc-cat-08752`
- Source category ID: `08752`
- Source label for human review: `蹉`
- Source codepoints: `U+8E49`
...
- `obs-evo-cand-008752-route-category-staging`
...
- `obs-evo-cand-008752-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008752-route-evolution-graph`
