# obs-char-001450 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001450`
- primary external id: `hust-obc-cat-1626`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1450_obs-char-001450_hust-obc-cat-1626_ora
  cle-character/03_visual-assets/001_asset-001455_hust-obc-cat-1626_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1626/G_1626_乙4743合14315賓組.png`
- asset id: `asset-001455`
...
- source category: `1626`
- validation class: `1449`
- source image route: `HUST-OBC/deciphered/1626/G_1626_乙4743合14315賓組.png`
- asset id: `asset-001455`
...
- English observation: `A rounded upper enclosure has side knobs and several
  lower prongs.`
- 中文观察: `圆拱上部框形有侧部突笔和数条下部分叉。`
...
- dataset label text: `㩐`
- dataset label codepoints: `U+3A50`
...
- filename catalog route clues: `Heji-like filename clue: 合14315
  (G_1626_乙4743合14315賓組.png)`
...
- Which source records identify obs-char-001450 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001450？
