...
- External category reference: `evobc-cat-03017`
- Source category ID: `03017`
- Source label for human review: `悠`
...
- `obs-evo-cand-003017-route-category-staging`
...
- `obs-evo-cand-003017-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003017-route-evolution-graph`
