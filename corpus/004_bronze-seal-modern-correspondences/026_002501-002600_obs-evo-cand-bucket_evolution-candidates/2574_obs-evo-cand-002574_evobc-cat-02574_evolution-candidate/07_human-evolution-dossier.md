...
- External category reference: `evobc-cat-02574`
- Source category ID: `02574`
- Source label for human review: `崵`
...
- `obs-evo-cand-002574-route-category-staging`
...
- `obs-evo-cand-002574-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002574-route-evolution-graph`
