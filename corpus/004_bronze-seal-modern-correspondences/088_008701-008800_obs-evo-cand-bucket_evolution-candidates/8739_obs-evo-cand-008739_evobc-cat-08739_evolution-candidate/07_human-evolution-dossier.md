...
Project ID: `obs-evo-cand-008739`
...
- Project ID: `obs-evo-cand-008739`
- EVOBC category candidate ID: `evobc-evo-cat-08739`
- External category reference: `evobc-cat-08739`
- Source category ID: `08739`
- Source label for human review: `踰`
- Source codepoints: `U+8E30`
...
- `obs-evo-cand-008739-route-category-staging`
...
- `obs-evo-cand-008739-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008739-route-evolution-graph`
