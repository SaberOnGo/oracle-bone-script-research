# obs-unk-003229 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003229`
- primary external id: `hust-obc-und-L-003229`
...
- local review image route: `corpus/001_oracle-characters/049_undeciphered-003
  201-003300_obs-unk-bucket_oracle-character-candidates/029_obs-unk-003229_h
  ust-obc-und-L-003229_oracle-character-candidate/03_visual-assets/001_asset
  -004822_hust-obc-und-L-003229_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3229/L_？_6078.jpg`
- asset id: `asset-004822`
...
- source class: `HUST-OBC/undeciphered/L/3229/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3229/L_？_6078.jpg`
- asset id: `asset-004822`
...
- Which source records identify obs-unk-003229 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003229？
