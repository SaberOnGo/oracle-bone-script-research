...
- Project ID: `obs-evo-cand-012505`
- EVOBC category candidate ID: `evobc-evo-cat-12505`
- External category reference: `evobc-cat-12505`
- Source category ID: `12505`
- Source label for human review: `𨳮`
- Source codepoints: `U+28CEE`
...
- `obs-evo-cand-012505-route-category-staging`
...
- `obs-evo-cand-012505-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012505-route-evolution-graph`
