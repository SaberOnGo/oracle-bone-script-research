...
- External category reference: `evobc-cat-02924`
- Source category ID: `02924`
- Source label for human review: `忼`
...
- `obs-evo-cand-002924-route-category-staging`
...
- `obs-evo-cand-002924-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002924-route-evolution-graph`
