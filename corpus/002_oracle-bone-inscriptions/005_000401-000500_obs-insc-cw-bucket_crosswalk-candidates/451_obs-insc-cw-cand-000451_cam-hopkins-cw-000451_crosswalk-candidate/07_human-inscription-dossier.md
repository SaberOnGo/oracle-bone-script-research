...
Project ID: `obs-insc-cw-cand-000451`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000451`
...
- Yingguo / 英国所藏: `y2321` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `329` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `371` in source row; primary catalog entry pending
- Heji / 合集: `41563` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000451`
