# obs-unk-004576 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/076_obs-unk-004576_h
  ust-obc-und-X-004576_oracle-character-candidate/03_visual-assets/001_asset
  -006169_hust-obc-und-X-004576_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/132/X_？_8311_1.png`
- asset id: `asset-006169`
...
- source class: `HUST-OBC/undeciphered/X/132/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/132/X_？_8311_1.png`
- asset id: `asset-006169`
...
- English observation: `Two uprights, separate upper mark, and curved branches`
  `recorded.`
- 中文观察: `已记录两条直立痕、上方分离痕和弯曲分支。`
...
- Which source records identify obs-unk-004576 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004576？
