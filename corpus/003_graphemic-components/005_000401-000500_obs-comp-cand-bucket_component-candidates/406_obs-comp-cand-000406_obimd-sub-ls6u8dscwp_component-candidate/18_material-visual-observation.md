# Material Visual Observation / obs-comp-cand-000406 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000406`
- External reference / 外部参照: `obimd-sub-ls6u8dscwp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012329_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ls6u8dscwp/ls6u8dscwp/ls6u8dscwp.png`
- Checksum / 校验和:
  `54b1824e61219175b087982c93e1d6b6f07b78f5cc4fa03e74cc782c80bbb60c`
...
- Marked-pixel bounds: (90,17)–(159,230); span 70 × 214 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.27%。
- 痕迹范围：(90,17)–(159,230)；跨度70 × 214 px；痕迹矩形高于宽。
