# obs-char-001224 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001224`
- primary external id: `hust-obc-cat-1369`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1224_obs-char-001224_hust-obc-cat-1369_ora
  cle-character/03_visual-assets/001_asset-001229_hust-obc-cat-1369_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1369/G_1369_京津3451合7909賓組.png`
- asset id: `asset-001229`
...
- source category: `1369`
- validation class: `1223`
- source image route: `HUST-OBC/deciphered/1369/G_1369_京津3451合7909賓組.png`
- asset id: `asset-001229`
...
- English observation: `A small upright form has an angular upper enclosure,
  a central vertical, and a triangular lower base.`
- 中文观察: `小型直立形体有折角上部框廓、中央竖笔和三角形下部底笔。`
...
- dataset label text: `㥏`
- dataset label codepoints: `U+394F`
...
- filename catalog route clues: `Heji-like filename clue: 合7909
  (G_1369_京津3451合7909賓組.png)`
...
- Which source records identify obs-char-001224 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001224？
