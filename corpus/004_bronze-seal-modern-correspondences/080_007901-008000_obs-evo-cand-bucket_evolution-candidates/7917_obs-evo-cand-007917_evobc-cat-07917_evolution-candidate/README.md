# obs-evo-cand-007917 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-007917`
- EVOBC category candidate ID: `evobc-evo-cat-07917`
- External category ref: `evobc-cat-07917`
- Source label: `衣`
- Source codepoints: `U+8863`
- Image reference count: `179`
- Era token counts: `BI:58;CS:1;OBC:65;SAC:3;SS:2;WSC:50`
- Source token counts: `Book:62;Web:117`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 65 image references
- era 1 / BI: 58 image references
...
- source 1 / Web:105952;說文Web:58: 94 image references
