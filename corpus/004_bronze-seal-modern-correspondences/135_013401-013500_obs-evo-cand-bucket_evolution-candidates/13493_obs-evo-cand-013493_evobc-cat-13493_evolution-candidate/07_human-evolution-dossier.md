...
- External category reference: `evobc-cat-13493`
- Source category ID: `13493`
- Source label for human review: `𭊲`
...
- `obs-evo-cand-013493-route-category-staging`
...
- `obs-evo-cand-013493-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013493-route-evolution-graph`
