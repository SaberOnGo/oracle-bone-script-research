# obs-char-000603 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000603`
- primary external id: `hust-obc-cat-0687`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/603_obs-char-000603_hust-obc-cat-0687_orac
  le-character/03_visual-assets/001_asset-000608_hust-obc-cat-0687_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0687/G_0687_甲骨文.png`
- asset id: `asset-000608`
...
- source category: `0687`
- validation class: `602`
- source image route: `HUST-OBC/deciphered/0687/G_0687_甲骨文.png`
- asset id: `asset-000608`
...
- English observation: `A small rounded shield-like outline has a double
  horizontal cap and two crossing diagonals inside its lower field.`
- 中文观察: `小型圆盾状轮廓带双重横向顶盖，下部区域内有两条交叉斜笔。`
...
- dataset label text: `㚥`
- dataset label codepoints: `U+36A5`
...
- Which source records identify obs-char-000603 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000603？
