...
- External category reference: `evobc-cat-09020`
- Source category ID: `09020`
- Source label for human review: `逿`
...
- `obs-evo-cand-009020-route-category-staging`
...
- `obs-evo-cand-009020-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009020-route-evolution-graph`
