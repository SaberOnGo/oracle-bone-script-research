# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008161
...
- EVOBC candidate category: `evobc-evo-cat-08161`.
- Source label for search only: `診`.
- Source codepoints for search only: `U+8A3A`.
