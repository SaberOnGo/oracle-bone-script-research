...
- Project ID: `obs-evo-cand-003528`
- EVOBC category candidate ID: `evobc-evo-cat-03528`
- External category reference: `evobc-cat-03528`
- Source category ID: `03528`
- Source label for human review: `擧`
- Source codepoints: `U+64E7`
...
- `obs-evo-cand-003528-route-category-staging`
...
- `obs-evo-cand-003528-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003528-route-evolution-graph`
