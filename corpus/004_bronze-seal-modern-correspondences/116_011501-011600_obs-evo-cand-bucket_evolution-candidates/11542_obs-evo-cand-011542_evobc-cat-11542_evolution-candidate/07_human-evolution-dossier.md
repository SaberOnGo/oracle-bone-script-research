...
- External category reference: `evobc-cat-11542`
- Source category ID: `11542`
- Source label for human review: `𣿒`
- Source codepoints: `U+23FD2`
...
- `obs-evo-cand-011542-route-category-staging`
...
- `obs-evo-cand-011542-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011542-route-evolution-graph`
