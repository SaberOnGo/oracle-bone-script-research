...
Project ID: `obs-evo-cand-000712`
...
- Project ID: `obs-evo-cand-000712`
- EVOBC category candidate ID: `evobc-evo-cat-00712`
- External category reference: `evobc-cat-00712`
- Source category ID: `00712`
- Source label for human review: `亳`
- Source codepoints: `U+4EB3`
- Image reference count in source metadata: `61`
...
- `obs-evo-cand-000712-route-category-staging`
...
- `obs-evo-cand-000712-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000712-route-evolution-graph`
