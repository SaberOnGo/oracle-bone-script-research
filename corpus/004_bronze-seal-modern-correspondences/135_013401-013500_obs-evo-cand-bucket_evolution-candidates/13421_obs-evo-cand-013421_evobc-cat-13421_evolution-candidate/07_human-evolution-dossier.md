...
- External category reference: `evobc-cat-13421`
- Source category ID: `13421`
- Source label for human review: `𬯦`
- Source codepoints: `U+2CBE6`
...
- `obs-evo-cand-013421-route-category-staging`
...
- `obs-evo-cand-013421-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013421-route-evolution-graph`
