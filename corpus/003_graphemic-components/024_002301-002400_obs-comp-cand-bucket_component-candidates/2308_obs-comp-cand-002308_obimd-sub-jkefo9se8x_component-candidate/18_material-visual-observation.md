# Material Visual Observation / obs-comp-cand-002308 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002308`
- External reference / 外部参照: `obimd-sub-jkefo9se8x`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020327_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/s65fsavh28/jkefo9se8x/jkefo9se8x.png`
- Checksum / 校验和:
  `1a806054709d15abfb31929c99b1c3d7457d3446720aa8daa487873d158881f1`
...
- Marked-pixel bounds: (77,27)–(171,218); span 95 × 192 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.90%。
- 痕迹范围：(77,27)–(171,218)；跨度95 × 192 px；痕迹矩形高于宽。
