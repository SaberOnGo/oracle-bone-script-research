# obs-char-000347 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/347_obs-char-000347_hust-obc-cat-0392_orac
  le-character/03_visual-assets/001_asset-000352_hust-obc-cat-0392_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0392/G_0392_乙6776(甲).png`
- asset id: `asset-000352`
...
- source category: `0392`
- validation class: `346`
- source image route: `HUST-OBC/deciphered/0392/G_0392_乙6776(甲).png`
- asset id: `asset-000352`
...
- dataset label text: `㕾`
- dataset label codepoints: `U+357E`
...
- Which source records identify obs-char-000347 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000347？
