# obs-char-000598 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/598_obs-char-000598_hust-obc-cat-0682_orac
  le-character/03_visual-assets/001_asset-000603_hust-obc-cat-0682_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0682/G_0682_前7.8.2(甲).png`
- asset id: `asset-000603`
...
- source category: `0682`
- validation class: `597`
- source image route: `HUST-OBC/deciphered/0682/G_0682_前7.8.2(甲).png`
- asset id: `asset-000603`
...
- English observation: `The very faint narrow image shows a slender wavering
  line with several sharp angular turns and short side strokes; fine joins
  are difficult to resolve.`
- 中文观察: `极淡狭长图像显示带数处尖折和短侧笔的纤细波折线，细部接点难以辨清。`
...
- dataset label text: `㚠`
- dataset label codepoints: `U+36A0`
...
- Which source records identify obs-char-000598 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000598？
