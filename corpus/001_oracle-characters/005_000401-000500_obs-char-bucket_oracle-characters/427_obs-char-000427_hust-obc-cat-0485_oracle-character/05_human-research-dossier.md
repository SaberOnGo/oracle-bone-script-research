# obs-char-000427 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000427`
- primary external id: `hust-obc-cat-0485`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/427_obs-char-000427_hust-obc-cat-0485_orac
  le-character/03_visual-assets/001_asset-000432_hust-obc-cat-0485_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0485/G_0485_京津2014合14064.png`
- asset id: `asset-000432`
...
- source category: `0485`
- validation class: `426`
- source image route: `HUST-OBC/deciphered/0485/G_0485_京津2014合14064.png`
- asset id: `asset-000432`
...
- English observation: `The small image contains two narrow upright forms;
  the left is tightly twisted, and the right has a central crossing and
  forked lower strokes.`
- 中文观察: `小图包含两个狭长直立形体：左侧紧密扭曲，右侧中央交叉且下部笔画分叉。`
...
- dataset label text: `㗛`
- dataset label codepoints: `U+35DB`
...
- filename catalog route clues: `Heji-like filename clue: 合14064
  (G_0485_京津2014合14064.png)`
...
- Which source records identify obs-char-000427 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000427？
