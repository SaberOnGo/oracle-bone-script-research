# obs-char-001404 Archaeology Paleography Review

# obs-char-001404 考古文字复核档案
...
- first local image: `001_asset-001409_hust-obc-cat-1573_glyph.png`
- first source image: `G_1573_前4.47.2合11010賓組.png`
...
- source label text: `㨛`
- source label codepoints: `U+3A1B`
