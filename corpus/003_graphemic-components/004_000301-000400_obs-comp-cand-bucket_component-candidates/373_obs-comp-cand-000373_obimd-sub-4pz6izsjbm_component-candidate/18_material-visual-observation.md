# Material Visual Observation / obs-comp-cand-000373 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000373`
- External reference / 外部参照: `obimd-sub-4pz6izsjbm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012296_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4pz6izsjbm/4pz6izsjbm/4pz6izsjbm.png`
- Checksum / 校验和:
  `77f621286847ee893de1b8d4402fde7e5fbef4a43f702fd5089a497bd805f893`
...
- Marked-pixel bounds: (61,26)–(188,219); span 128 × 194 px; the marked
...
- 痕迹范围：(61,26)–(188,219)；跨度128 × 194 px；痕迹矩形高于宽。
