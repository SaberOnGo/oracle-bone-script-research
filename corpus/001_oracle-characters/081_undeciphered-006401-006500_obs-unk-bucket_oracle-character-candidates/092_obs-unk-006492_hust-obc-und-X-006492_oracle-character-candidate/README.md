# obs-unk-006492 Local Object Materials / obs-unk-006492 本地对象资料
...
- Local review image / 本地复核图像: `03_visual-assets/001_asset-008083_hust-obc-und-X-006492_glyph.jpg`

## Object Summary / 对象摘要

- Project ID / 项目 ID: `obs-unk-006492`
- Primary external reference / 首选外部参考: `hust-obc-und-X-006492`
- Source group / 来源分组: `X` (New Compilation of Oracle Bone Scripts)
- Source class path / 来源分类路径: `HUST-OBC/undeciphered/X/2048/`
- Source image path / 来源图像路径: `HUST-OBC/undeciphered/X/2048/X_？_5698_1.png`
