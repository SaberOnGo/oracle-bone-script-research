...
- Project ID: `obs-evo-cand-012603`
- EVOBC category candidate ID: `evobc-evo-cat-12603`
- External category reference: `evobc-cat-12603`
- Source category ID: `12603`
- Source label for human review: `𩐟`
- Source codepoints: `U+2941F`
...
- `obs-evo-cand-012603-route-category-staging`
...
- `obs-evo-cand-012603-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012603-route-evolution-graph`
