# Material Visual Observation / obs-comp-cand-000785 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000785`
- External reference / 外部参照: `obimd-sub-6p9s6p6wyb`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013547_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6p9s6p6wyb/6p9s6p6wyb/0k83gzaooi.png`
- Checksum / 校验和:
  `2ac8172af5ccede585c71143d07449aba536ee9a792e44b48cbaa27cad80b455`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.98%.
- Marked-pixel bounds: (81,29)–(167,221); span 87 × 193 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.98%。
- 痕迹范围：(81,29)–(167,221)；跨度87 × 193 px；痕迹矩形高于宽。
