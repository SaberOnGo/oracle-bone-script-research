# obs-evo-cand-006462 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-06462`
- Source label: `紛`
- Source codepoints: `U+7D1B`
- Image reference count: `41`
- Era token counts: `SS:2;WSC:39`
- Source token counts: `Book:5;Web:36`
