...
- `obs-evo-cand-011715-route-category-staging`
...
- `obs-evo-cand-011715-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011715-route-evolution-graph`
