...
- External category reference: `evobc-cat-09991`
- Source category ID: `09991`
- Source label for human review: `頢`
...
- `obs-evo-cand-009991-route-category-staging`
...
- `obs-evo-cand-009991-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009991-route-evolution-graph`
