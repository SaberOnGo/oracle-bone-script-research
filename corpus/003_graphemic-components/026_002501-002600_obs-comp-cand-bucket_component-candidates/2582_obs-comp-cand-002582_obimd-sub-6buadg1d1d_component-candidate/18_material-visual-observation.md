# Material Visual Observation / obs-comp-cand-002582 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002582`
- External reference / 外部参照: `obimd-sub-6buadg1d1d`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021121_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6buadg1d1d/6buadg1d1d/6buadg1d1d.png`
- Checksum / 校验和:
  `f12ae05f5d08ea7fe8f8e8153cfcd0626c8979c29349682995048fe2599d54d6`
...
- Marked-pixel bounds: (86,14)–(164,235); span 79 × 222 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.85%。
- 痕迹范围：(86,14)–(164,235)；跨度79 × 222 px；痕迹矩形高于宽。
