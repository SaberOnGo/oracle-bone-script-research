...
- External category reference: `evobc-cat-06158`
- Source category ID: `06158`
- Source label for human review: `窊`
...
- `obs-evo-cand-006158-route-category-staging`
...
- `obs-evo-cand-006158-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006158-route-evolution-graph`
