...
Project ID: `obs-evo-cand-009246`
...
- Project ID: `obs-evo-cand-009246`
- EVOBC category candidate ID: `evobc-evo-cat-09246`
- External category reference: `evobc-cat-09246`
- Source category ID: `09246`
- Source label for human review: `酢`
- Source codepoints: `U+9162`
...
- `obs-evo-cand-009246-route-category-staging`
...
- `obs-evo-cand-009246-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009246-route-evolution-graph`
