# Material Visual Observation / obs-comp-cand-002468 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002468`
- External reference / 外部参照: `obimd-sub-v7qghw0r67`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020653_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/v7qghw0r67/v7qghw0r67/v7qghw0r67.png`
- Checksum / 校验和:
  `663b937b9faf01edcfe4a80a0792fa8834356f04a0b3ac55e77bb1496d1490b4`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.80%.
- Marked-pixel bounds: (44,28)–(208,217); span 165 × 190 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.80%。
- 痕迹范围：(44,28)–(208,217)；跨度165 × 190 px；痕迹矩形近方形。
