# obs-char-001355 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1355_obs-char-001355_hust-obc-cat-1512_ora
  cle-character/03_visual-assets/001_asset-001360_hust-obc-cat-1512_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1512/G_1512_乙3478合22092午組.png`
- asset id: `asset-001360`
...
- source category: `1512`
- validation class: `1354`
- source image route: `HUST-OBC/deciphered/1512/G_1512_乙3478合22092午組.png`
- asset id: `asset-001360`
...
- English observation: `A stacked form has a rounded upper enclosure, a
  central angular loop, and several pointed lower branches.`
...
- dataset label text: `㧞`
- dataset label codepoints: `U+39DE`
...
- filename catalog route clues: `Heji-like filename clue: 合22092
  (G_1512_乙3478合22092午組.png)`
...
- Which source records identify obs-char-001355 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001355？
