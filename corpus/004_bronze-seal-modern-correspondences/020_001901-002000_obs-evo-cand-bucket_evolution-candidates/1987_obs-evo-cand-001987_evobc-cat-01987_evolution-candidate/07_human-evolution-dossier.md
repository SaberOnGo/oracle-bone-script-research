...
Project ID: `obs-evo-cand-001987`
...
- Project ID: `obs-evo-cand-001987`
- EVOBC category candidate ID: `evobc-evo-cat-01987`
- External category reference: `evobc-cat-01987`
- Source category ID: `01987`
- Source label for human review: `夆`
- Source codepoints: `U+5906`
...
- `obs-evo-cand-001987-route-category-staging`
...
- `obs-evo-cand-001987-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001987-route-evolution-graph`
