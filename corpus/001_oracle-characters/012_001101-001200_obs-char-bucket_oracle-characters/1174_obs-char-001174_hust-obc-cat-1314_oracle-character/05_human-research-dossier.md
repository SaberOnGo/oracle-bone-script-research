# obs-char-001174 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1174_obs-char-001174_hust-obc-cat-1314_ora
  cle-character/03_visual-assets/001_asset-001179_hust-obc-cat-1314_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1314/H_1314_601F3_0.png`
- asset id: `asset-001179`
...
- source category: `1314`
- validation class: `1173`
- source image route: `HUST-OBC/deciphered/1314/H_1314_601F3_0.png`
- asset id: `asset-001179`
...
- English observation: `A large dark two-part form has an elongated left
  loop, a central crossing, and a broad right curve ending in a hook.`
- 中文观察: `大型深色两部分形体有狭长左侧环、中央交叉和以钩笔收尾的宽大右侧弯笔。`
...
- dataset label text: `㤘`
- dataset label codepoints: `U+3918`
...
- filename catalog route clues: `catalog-like filename clue: H_1314
  (H_1314_601F3_0.png)`
...
- Which source records identify obs-char-001174 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001174？
