...
Project ID: `obs-evo-cand-011390`
...
- Project ID: `obs-evo-cand-011390`
- EVOBC category candidate ID: `evobc-evo-cat-11390`
- External category reference: `evobc-cat-11390`
- Source category ID: `11390`
- Source label for human review: `𣄝`
- Source codepoints: `U+2311D`
...
- `obs-evo-cand-011390-route-category-staging`
...
- `obs-evo-cand-011390-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011390-route-evolution-graph`
