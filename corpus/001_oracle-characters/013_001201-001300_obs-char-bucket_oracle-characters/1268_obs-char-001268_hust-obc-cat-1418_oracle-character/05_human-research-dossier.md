# obs-char-001268 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001268`
- primary external id: `hust-obc-cat-1418`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1268_obs-char-001268_hust-obc-cat-1418_ora
  cle-character/03_visual-assets/001_asset-001273_hust-obc-cat-1418_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1418/L_1418_6758.jpg`
- asset id: `asset-001273`
...
- source category: `1418`
- validation class: `1267`
- source image route: `HUST-OBC/deciphered/1418/L_1418_6758.jpg`
- asset id: `asset-001273`
...
- English observation: `A small faint cluster has an upper oval mark, two
  pointed lower strokes, and short side projections.`
- 中文观察: `小型较淡笔画群有上部椭圆标记、两条尖状下行笔画和短侧向外伸笔画。`
...
- dataset label text: `㦀`
- dataset label codepoints: `U+3980`
...
- Which source records identify obs-char-001268 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001268？
