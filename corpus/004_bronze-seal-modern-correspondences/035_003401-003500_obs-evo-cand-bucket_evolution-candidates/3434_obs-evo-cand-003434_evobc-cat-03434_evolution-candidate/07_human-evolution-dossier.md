...
- External category reference: `evobc-cat-03434`
- Source category ID: `03434`
- Source label for human review: `握`
...
- `obs-evo-cand-003434-route-category-staging`
...
- `obs-evo-cand-003434-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003434-route-evolution-graph`
