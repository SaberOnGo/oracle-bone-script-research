...
- External category reference: `evobc-cat-04825`
- Source category ID: `04825`
- Source label for human review: `溷`
- Source codepoints: `U+6EB7`
...
- `obs-evo-cand-004825-route-category-staging`
...
- `obs-evo-cand-004825-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004825-route-evolution-graph`
