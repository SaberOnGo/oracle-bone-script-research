...
- `obs-evo-cand-004527-route-category-staging`
...
- `obs-evo-cand-004527-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004527-route-evolution-graph`
