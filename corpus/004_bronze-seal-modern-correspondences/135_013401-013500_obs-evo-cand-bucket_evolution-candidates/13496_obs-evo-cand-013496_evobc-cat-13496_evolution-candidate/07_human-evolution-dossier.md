...
- External category reference: `evobc-cat-13496`
- Source category ID: `13496`
- Source label for human review: `𭍪`
...
- `obs-evo-cand-013496-route-category-staging`
...
- `obs-evo-cand-013496-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013496-route-evolution-graph`
