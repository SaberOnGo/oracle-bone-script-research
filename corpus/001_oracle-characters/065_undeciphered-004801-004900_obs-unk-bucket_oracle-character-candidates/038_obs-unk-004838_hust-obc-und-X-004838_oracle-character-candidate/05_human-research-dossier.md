# obs-unk-004838 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004838`
- primary external id: `hust-obc-und-X-004838`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/038_obs-unk-004838_h
  ust-obc-und-X-004838_oracle-character-candidate/03_visual-assets/001_asset
  -006431_hust-obc-und-X-004838_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/394/X_？_7378_1.png`
- asset id: `asset-006431`
...
- source class: `HUST-OBC/undeciphered/X/394/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/394/X_？_7378_1.png`
- asset id: `asset-006431`
...
- English observation: `two separated vertical groups with broad tops`
- 中文观察: `两个分离的宽顶竖向结构`
...
- Which source records identify obs-unk-004838 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004838？
