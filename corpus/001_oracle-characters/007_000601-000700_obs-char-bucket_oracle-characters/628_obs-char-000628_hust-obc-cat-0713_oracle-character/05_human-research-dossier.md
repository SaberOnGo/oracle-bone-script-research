# obs-char-000628 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000628`
- primary external id: `hust-obc-cat-0713`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/628_obs-char-000628_hust-obc-cat-0713_orac
  le-character/03_visual-assets/001_asset-000633_hust-obc-cat-0713_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0713/G_0713_寧滬1.592合34400歷組.png
  `
- asset id: `asset-000633`
...
- source category: `0713`
- validation class: `627`
- source image route: `HUST-OBC/deciphered/0713/G_0713_寧滬1.592合34400歷組.png`
- asset id: `asset-000633`
...
- English observation: `A long central vertical with a short base supports a
  compact upper cluster of angular crossings, a small right loop, and short
  projections to the left.`
- 中文观察: `带短底的长中央竖笔支撑紧凑上部笔群，其中有折角交叉、小右环和左向短突。`
...
- dataset label text: `㚿`
- dataset label codepoints: `U+36BF`
...
- filename catalog route clues: `Heji-like filename clue: 合34400
  (G_0713_寧滬1.592合34400歷組.png)`
...
- Which source records identify obs-char-000628 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000628？
