...
- External category reference: `evobc-cat-01325`
- Source category ID: `01325`
- Source label for human review: `匃`
...
- `obs-evo-cand-001325-route-category-staging`
...
- `obs-evo-cand-001325-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001325-route-evolution-graph`
