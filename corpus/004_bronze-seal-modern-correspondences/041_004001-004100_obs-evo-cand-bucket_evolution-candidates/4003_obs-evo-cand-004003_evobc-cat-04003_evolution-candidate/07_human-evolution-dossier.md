...
- External category reference: `evobc-cat-04003`
- Source category ID: `04003`
- Source label for human review: `株`
...
- `obs-evo-cand-004003-route-category-staging`
...
- `obs-evo-cand-004003-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004003-route-evolution-graph`
