# obs-unk-004029 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/029_obs-unk-004029_h
  ust-obc-und-L-004029_oracle-character-candidate/03_visual-assets/001_asset
  -005622_hust-obc-und-L-004029_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4029/L_？_8604.jpg`
- asset id: `asset-005622`
...
- source class: `HUST-OBC/undeciphered/L/4029/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4029/L_？_8604.jpg`
- asset id: `asset-005622`
...
- English observation: A dark branched trace occupies the upper center. Below
  ...
  visually similar to a nearby candidate image, but no checksum or
  deduplication decision has been made.
- 中文观察：上部中央有深色分叉痕迹，下方有数条分离的圆弧或波曲横向痕迹。图像
    外观与邻近候选图像相似，但尚未完成 checksum 或去重判断。
...
- Which source records identify obs-unk-004029 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004029？
