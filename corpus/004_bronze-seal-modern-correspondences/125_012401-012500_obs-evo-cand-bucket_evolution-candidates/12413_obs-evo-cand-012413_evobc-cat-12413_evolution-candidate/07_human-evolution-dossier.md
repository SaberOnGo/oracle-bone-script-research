...
- External category reference: `evobc-cat-12413`
- Source category ID: `12413`
- Source label for human review: `𨚣`
- Source codepoints: `U+286A3`
...
- `obs-evo-cand-012413-route-category-staging`
...
- `obs-evo-cand-012413-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012413-route-evolution-graph`
