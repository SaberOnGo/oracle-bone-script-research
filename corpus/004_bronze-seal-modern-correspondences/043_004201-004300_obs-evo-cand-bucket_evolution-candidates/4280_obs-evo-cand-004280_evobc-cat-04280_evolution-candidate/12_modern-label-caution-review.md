# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004280
...
- EVOBC candidate category: `evobc-evo-cat-04280`.
- Source label for search only: `檀`.
- Source codepoints for search only: `U+6A80`.
