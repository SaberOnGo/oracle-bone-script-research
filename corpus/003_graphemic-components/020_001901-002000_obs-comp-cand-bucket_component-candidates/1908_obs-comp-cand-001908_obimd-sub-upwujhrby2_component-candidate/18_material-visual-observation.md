# Material Visual Observation / obs-comp-cand-001908 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001908`
- External reference / 外部参照: `obimd-sub-upwujhrby2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018318_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/upwujhrby2/upwujhrby2/upwujhrby2.png`
- Checksum / 校验和:
  `3fde14b125a5003a21d815dfddc260b441a96969e992cbec3cb7f1578e3a11aa`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.45%.
- Marked-pixel bounds: (37,27)–(208,218); span 172 × 192 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.45%。
- 痕迹范围：(37,27)–(208,218)；跨度172 × 192 px；痕迹矩形近方形。
