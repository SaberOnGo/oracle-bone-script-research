...
- External category reference: `evobc-cat-05962`
- Source category ID: `05962`
- Source label for human review: `礫`
- Source codepoints: `U+792B`
...
- `obs-evo-cand-005962-route-category-staging`
...
- `obs-evo-cand-005962-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005962-route-evolution-graph`
