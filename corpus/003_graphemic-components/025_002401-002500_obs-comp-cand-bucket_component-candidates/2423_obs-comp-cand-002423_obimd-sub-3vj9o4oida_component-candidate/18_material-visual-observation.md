# Material Visual Observation / obs-comp-cand-002423 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002423`
- External reference / 外部参照: `obimd-sub-3vj9o4oida`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020494_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jpxofd3gmu/3vj9o4oida/3vj9o4oida.png`
- Checksum / 校验和:
  `7fc7878cc7d6241c6825ff700dee32a2e9e7b6e55231593c63c3096f1dea4491`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.47%.
- Marked-pixel bounds: (65,49)–(184,195); span 120 × 147 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.47%。
- 痕迹范围：(65,49)–(184,195)；跨度120 × 147 px；痕迹矩形高于宽。
