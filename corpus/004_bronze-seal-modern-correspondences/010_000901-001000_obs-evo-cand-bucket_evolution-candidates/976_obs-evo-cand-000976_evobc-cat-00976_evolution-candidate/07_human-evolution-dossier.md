...
Project ID: `obs-evo-cand-000976`
...
- Project ID: `obs-evo-cand-000976`
- EVOBC category candidate ID: `evobc-evo-cat-00976`
- External category reference: `evobc-cat-00976`
- Source category ID: `00976`
- Source label for human review: `傆`
- Source codepoints: `U+5086`
...
- `obs-evo-cand-000976-route-category-staging`
...
- `obs-evo-cand-000976-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000976-route-evolution-graph`
