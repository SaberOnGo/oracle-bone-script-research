# Material Visual Observation / obs-comp-cand-001338 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001338`
- External reference / 外部参照: `obimd-sub-ar259dtulv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015721_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ar259dtulv/ar259dtulv/ar259dtulv.png`
- Checksum / 校验和:
  `c888622313a8d73eb4d2ee703fcf9175712ceabb301b10876ff48459d768f2c7`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.47%.
- Marked-pixel bounds: (87,41)–(162,204); span 76 × 164 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.47%。
- 痕迹范围：(87,41)–(162,204)；跨度76 × 164 px；痕迹矩形高于宽。
