# Material Visual Observation / obs-comp-cand-002711 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002711`
- External reference / 外部参照: `obimd-sub-d5n724qriv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021287_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/d5n724qriv/d5n724qriv/d5n724qriv.png`
- Checksum / 校验和:
  `80c033ba78140357f170201c4cd88f49cc71bbd3aefa622a466b5729def12a07`
...
- Marked-pixel bounds: (97,19)–(156,229); span 60 × 211 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.90%。
- 痕迹范围：(97,19)–(156,229)；跨度60 × 211 px；痕迹矩形高于宽。
