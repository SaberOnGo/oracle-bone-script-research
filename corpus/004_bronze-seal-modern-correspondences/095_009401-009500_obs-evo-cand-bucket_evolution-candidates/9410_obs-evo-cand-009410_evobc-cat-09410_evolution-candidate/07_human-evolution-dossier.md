...
- External category reference: `evobc-cat-09410`
- Source category ID: `09410`
- Source label for human review: `鋒`
...
- `obs-evo-cand-009410-route-category-staging`
...
- `obs-evo-cand-009410-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009410-route-evolution-graph`
