# obs-unk-000812 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000812`
- primary external id: `hust-obc-und-L-000812`
...
- local review image route: `corpus/001_oracle-characters/025_undeciphered-000
  801-000900_obs-unk-bucket_oracle-character-candidates/012_obs-unk-000812_h
  ust-obc-und-L-000812_oracle-character-candidate/03_visual-assets/001_asset
  -002405_hust-obc-und-L-000812_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/812/L_？_12362.jpg`
- asset id: `asset-002405`
...
- source class: `HUST-OBC/undeciphered/L/812/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/812/L_？_12362.jpg`
- asset id: `asset-002405`
...
- Which source records identify obs-unk-000812 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000812？
