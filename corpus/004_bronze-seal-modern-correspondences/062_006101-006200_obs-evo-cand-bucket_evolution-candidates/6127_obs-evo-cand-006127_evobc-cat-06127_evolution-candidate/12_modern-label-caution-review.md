# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006127
...
- EVOBC candidate category: `evobc-evo-cat-06127`.
- Source label for search only: `穌`.
- Source codepoints for search only: `U+7A4C`.
