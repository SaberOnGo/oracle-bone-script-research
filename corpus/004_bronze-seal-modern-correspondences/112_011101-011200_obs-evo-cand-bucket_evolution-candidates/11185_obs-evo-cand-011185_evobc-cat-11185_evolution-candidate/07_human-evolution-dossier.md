...
- Project ID: `obs-evo-cand-011185`
- EVOBC category candidate ID: `evobc-evo-cat-11185`
- External category reference: `evobc-cat-11185`
- Source category ID: `11185`
- Source label for human review: `𢐛`
- Source codepoints: `U+2241B`
...
- `obs-evo-cand-011185-route-category-staging`
...
- `obs-evo-cand-011185-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011185-route-evolution-graph`
