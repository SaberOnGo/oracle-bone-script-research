...
- External category reference: `evobc-cat-06453`
- Source category ID: `06453`
- Source label for human review: `紐`
- Source codepoints: `U+7D10`
...
- `obs-evo-cand-006453-route-category-staging`
...
- `obs-evo-cand-006453-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006453-route-evolution-graph`
