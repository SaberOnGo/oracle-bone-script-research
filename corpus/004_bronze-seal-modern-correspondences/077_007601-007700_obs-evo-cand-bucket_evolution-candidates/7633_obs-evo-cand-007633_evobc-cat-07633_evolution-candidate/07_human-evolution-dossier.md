...
- External category reference: `evobc-cat-07633`
- Source category ID: `07633`
- Source label for human review: `藃`
- Source codepoints: `U+85C3`
...
- `obs-evo-cand-007633-route-category-staging`
...
- `obs-evo-cand-007633-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007633-route-evolution-graph`
