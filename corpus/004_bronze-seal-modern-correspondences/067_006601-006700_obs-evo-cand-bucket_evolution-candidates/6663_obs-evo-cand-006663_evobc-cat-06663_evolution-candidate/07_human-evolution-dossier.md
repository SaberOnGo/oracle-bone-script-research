...
- External category reference: `evobc-cat-06663`
- Source category ID: `06663`
- Source label for human review: `繄`
- Source codepoints: `U+7E44`
...
- `obs-evo-cand-006663-route-category-staging`
...
- `obs-evo-cand-006663-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006663-route-evolution-graph`
