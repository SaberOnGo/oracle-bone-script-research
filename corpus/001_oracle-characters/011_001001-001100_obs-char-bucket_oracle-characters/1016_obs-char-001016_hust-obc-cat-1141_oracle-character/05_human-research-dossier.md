# obs-char-001016 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1016_obs-char-001016_hust-obc-cat-1141_ora
  cle-character/03_visual-assets/001_asset-001021_hust-obc-cat-1141_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1141/G_1141_前2.17.4合36844黃組.png
  `
- asset id: `asset-001021`
...
- source category: `1141`
- validation class: `1015`
- source image route: `HUST-OBC/deciphered/1141/G_1141_前2.17.4合36844黃組.png`
- asset id: `asset-001021`
...
- English observation: `Two separate marks are visible: a tall irregular
  branching form at left and a small oval enclosure with two interior marks
  at right.`
...
- dataset label text: `㡫`
- dataset label codepoints: `U+386B`
...
- filename catalog route clues: `Heji-like filename clue: 合36844
...
- Which source records identify obs-char-001016 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001016？
