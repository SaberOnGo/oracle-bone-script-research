...
- External category reference: `evobc-cat-00210`
- Source category ID: `00210`
- Source label: `㳿`
...
- `obs-evo-cand-000210-route-category-staging`
...
- `obs-evo-cand-000210-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000210-route-evolution-graph`
