...
- External category reference: `evobc-cat-08000`
- Source category ID: `08000`
- Source label for human review: `複`
- Source codepoints: `U+8907`
...
- `obs-evo-cand-008000-route-category-staging`
...
- `obs-evo-cand-008000-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008000-route-evolution-graph`
