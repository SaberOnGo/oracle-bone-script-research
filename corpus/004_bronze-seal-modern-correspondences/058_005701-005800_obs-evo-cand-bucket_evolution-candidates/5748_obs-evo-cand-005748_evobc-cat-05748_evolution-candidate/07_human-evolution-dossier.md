...
- External category reference: `evobc-cat-05748`
- Source category ID: `05748`
- Source label for human review: `盍`
- Source codepoints: `U+76CD`
...
- `obs-evo-cand-005748-route-category-staging`
...
- `obs-evo-cand-005748-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005748-route-evolution-graph`
