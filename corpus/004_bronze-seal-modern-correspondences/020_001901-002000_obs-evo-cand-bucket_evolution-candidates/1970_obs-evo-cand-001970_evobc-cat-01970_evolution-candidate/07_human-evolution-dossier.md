...
- External category reference: `evobc-cat-01970`
- Source category ID: `01970`
- Source label for human review: `壬`
- Source codepoints: `U+58EC`
...
- `obs-evo-cand-001970-route-category-staging`
...
- `obs-evo-cand-001970-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001970-route-evolution-graph`
