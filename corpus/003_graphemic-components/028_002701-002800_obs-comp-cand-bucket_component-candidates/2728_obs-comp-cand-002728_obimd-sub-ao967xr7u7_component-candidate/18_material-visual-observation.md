# Material Visual Observation / obs-comp-cand-002728 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002728`
- External reference / 外部参照: `obimd-sub-ao967xr7u7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021344_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ao967xr7u7/ao967xr7u7/ao967xr7u7.png`
- Checksum / 校验和:
  `ebf8b861e489b0cf2644fbd7b410527d60d7091649cd592597eb6318f2c61621`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.46%.
- Marked-pixel bounds: (81,25)–(174,228); span 94 × 204 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.46%。
- 痕迹范围：(81,25)–(174,228)；跨度94 × 204 px；痕迹矩形高于宽。
