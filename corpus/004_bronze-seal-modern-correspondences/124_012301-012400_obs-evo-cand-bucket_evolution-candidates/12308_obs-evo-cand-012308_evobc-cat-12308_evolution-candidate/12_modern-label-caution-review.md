# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012308
...
- EVOBC candidate category: `evobc-evo-cat-12308`.
- Source label for search only: `𧾚`.
- Source codepoints for search only: `U+27F9A`.
