...
- Project ID: `obs-evo-cand-001184`
- EVOBC category candidate ID: `evobc-evo-cat-01184`
- External category reference: `evobc-cat-01184`
- Source category ID: `01184`
- Source label for human review: `刎`
- Source codepoints: `U+520E`
...
- `obs-evo-cand-001184-route-category-staging`
...
- `obs-evo-cand-001184-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001184-route-evolution-graph`
