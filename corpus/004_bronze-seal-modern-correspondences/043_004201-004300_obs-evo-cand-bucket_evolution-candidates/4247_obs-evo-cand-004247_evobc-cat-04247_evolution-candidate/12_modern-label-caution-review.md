# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004247
...
- EVOBC candidate category: `evobc-evo-cat-04247`.
- Source label for search only: `樣`.
- Source codepoints for search only: `U+6A23`.
