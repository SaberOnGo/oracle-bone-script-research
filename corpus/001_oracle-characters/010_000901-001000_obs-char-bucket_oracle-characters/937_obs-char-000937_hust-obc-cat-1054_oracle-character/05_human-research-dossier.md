# obs-char-000937 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/937_obs-char-000937_hust-obc-cat-1054_orac
  le-character/03_visual-assets/001_asset-000942_hust-obc-cat-1054_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1054/G_1054_天52(甲).png`
- asset id: `asset-000942`
...
- source category: `1054`
- validation class: `936`
- source image route: `HUST-OBC/deciphered/1054/G_1054_天52(甲).png`
- asset id: `asset-000942`
...
- English observation: `A dense branching cluster combines a broad
  horizontal stroke, a lower diamond-like enclosure, and short upper and
  side projections.`
...
- dataset label text: `㠔`
- dataset label codepoints: `U+3814`
...
- Which source records identify obs-char-000937 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000937？
