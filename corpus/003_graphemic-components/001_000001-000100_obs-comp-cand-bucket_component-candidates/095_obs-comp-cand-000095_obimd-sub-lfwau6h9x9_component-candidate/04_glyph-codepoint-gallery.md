# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000095
...
| --- | --- | --- | --- |
| `obimd-glyph-link-001491` | 󰣽 | `U+F08FD` | `reviewed_metadata_only` |
| `obimd-glyph-link-001492` | 󰣾 | `U+F08FE` | `reviewed_metadata_only` |
