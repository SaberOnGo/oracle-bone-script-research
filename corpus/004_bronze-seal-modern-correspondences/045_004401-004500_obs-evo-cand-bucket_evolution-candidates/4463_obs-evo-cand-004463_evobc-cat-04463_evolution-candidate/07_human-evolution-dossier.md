...
Project ID: `obs-evo-cand-004463`
...
- Project ID: `obs-evo-cand-004463`
- EVOBC category candidate ID: `evobc-evo-cat-04463`
- External category reference: `evobc-cat-04463`
- Source category ID: `04463`
- Source label for human review: `氂`
- Source codepoints: `U+6C02`
...
- `obs-evo-cand-004463-route-category-staging`
...
- `obs-evo-cand-004463-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004463-route-evolution-graph`
