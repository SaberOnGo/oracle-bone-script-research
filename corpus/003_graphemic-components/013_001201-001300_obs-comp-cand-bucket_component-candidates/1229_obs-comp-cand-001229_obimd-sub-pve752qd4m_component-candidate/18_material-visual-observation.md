# Material Visual Observation / obs-comp-cand-001229 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001229`
- External reference / 外部参照: `obimd-sub-pve752qd4m`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015467_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/u7j8pvl5zq/pve752qd4m/pve752qd4m.png`
- Checksum / 校验和:
  `93219da83a11409002a335562c9b9fc9d1aac1f51592d305c207e3c341ca6921`
...
- Marked-pixel bounds: (93,20)–(156,228); span 64 × 209 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.36%。
- 痕迹范围：(93,20)–(156,228)；跨度64 × 209 px；痕迹矩形高于宽。
