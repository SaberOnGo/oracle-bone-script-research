...
- External category reference: `evobc-cat-06976`
- Source category ID: `06976`
- Source label for human review: `肉`
- Source codepoints: `U+8089`
...
- `obs-evo-cand-006976-route-category-staging`
...
- `obs-evo-cand-006976-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006976-route-evolution-graph`
