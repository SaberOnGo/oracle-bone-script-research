# Material Visual Observation / obs-comp-cand-001091 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001091`
- External reference / 外部参照: `obimd-sub-lnkxar9817`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014900_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/mrz7t6gxh0/lnkxar9817/lnkxar9817.png`
- Checksum / 校验和:
  `7ed6cfbd146fe5eeff33ad0a024a20313bedab5db1d0194462056979d5236963`
...
- Marked-pixel bounds: (78,32)–(171,208); span 94 × 177 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.38%。
- 痕迹范围：(78,32)–(171,208)；跨度94 × 177 px；痕迹矩形高于宽。
