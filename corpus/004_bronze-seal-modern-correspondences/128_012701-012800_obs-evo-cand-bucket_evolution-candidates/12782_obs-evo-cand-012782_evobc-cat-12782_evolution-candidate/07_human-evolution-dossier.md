...
- Project ID: `obs-evo-cand-012782`
- EVOBC category candidate ID: `evobc-evo-cat-12782`
- External category reference: `evobc-cat-12782`
- Source category ID: `12782`
- Source label for human review: `𪗇`
- Source codepoints: `U+2A5C7`
...
- `obs-evo-cand-012782-route-category-staging`
...
- `obs-evo-cand-012782-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012782-route-evolution-graph`
