...
- External category reference: `evobc-cat-01193`
- Source category ID: `01193`
- Source label for human review: `刜`
- Source codepoints: `U+521C`
...
- `obs-evo-cand-001193-route-category-staging`
...
- `obs-evo-cand-001193-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001193-route-evolution-graph`
