...
- External category reference: `evobc-cat-12720`
- Source category ID: `12720`
- Source label for human review: `𩿦`
- Source codepoints: `U+29FE6`
...
- `obs-evo-cand-012720-route-category-staging`
...
- `obs-evo-cand-012720-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012720-route-evolution-graph`
