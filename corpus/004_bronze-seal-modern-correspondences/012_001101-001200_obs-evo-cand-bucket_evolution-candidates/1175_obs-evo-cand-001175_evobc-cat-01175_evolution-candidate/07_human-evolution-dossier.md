...
- External category reference: `evobc-cat-01175`
- Source category ID: `01175`
- Source label for human review: `刂`
...
- `obs-evo-cand-001175-route-category-staging`
...
- `obs-evo-cand-001175-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001175-route-evolution-graph`
