# Material Visual Observation / obs-comp-cand-002391 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002391`
- External reference / 外部参照: `obimd-sub-z4n66lll14`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020462_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kbaaq0n44y/z4n66lll14/z4n66lll14.png`
- Checksum / 校验和:
  `6ddb13a02b157f1a5837d2f2cf8c14f8c20682771b7b9e29bcce0690b2ce9063`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.44%.
- Marked-pixel bounds: (99,12)–(158,236); span 60 × 225 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.44%。
- 痕迹范围：(99,12)–(158,236)；跨度60 × 225 px；痕迹矩形高于宽。
