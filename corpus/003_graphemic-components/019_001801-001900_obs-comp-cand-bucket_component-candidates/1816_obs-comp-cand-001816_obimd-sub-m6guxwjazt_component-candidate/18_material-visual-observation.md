# Material Visual Observation / obs-comp-cand-001816 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001816`
- External reference / 外部参照: `obimd-sub-m6guxwjazt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018037_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/m6guxwjazt/m6guxwjazt/m6guxwjazt.png`
- Checksum / 校验和:
  `01b85e04bea6e1b5fdbafe2b6106db03a57cc2da400694fb284d6ddd06433bb4`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.19%.
- Marked-pixel bounds: (59,37)–(205,201); span 147 × 165 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.19%。
- 痕迹范围：(59,37)–(205,201)；跨度147 × 165 px；痕迹矩形近方形。
