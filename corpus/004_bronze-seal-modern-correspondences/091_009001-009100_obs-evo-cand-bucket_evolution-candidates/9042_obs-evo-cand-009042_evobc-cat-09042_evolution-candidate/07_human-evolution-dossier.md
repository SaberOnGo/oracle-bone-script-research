...
- External category reference: `evobc-cat-09042`
- Source category ID: `09042`
- Source label for human review: `遝`
...
- `obs-evo-cand-009042-route-category-staging`
...
- `obs-evo-cand-009042-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009042-route-evolution-graph`
