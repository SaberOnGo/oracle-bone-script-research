...
- `obs-evo-cand-006282-route-category-staging`
...
- `obs-evo-cand-006282-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006282-route-evolution-graph`
