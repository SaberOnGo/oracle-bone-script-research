# obs-char-000493 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000493`
- primary external id: `hust-obc-cat-0558_0559_0560`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/493_obs-char-000493_hust-obc-cat-0558_0559
  _0560_oracle-character/03_visual-assets/001_asset-000498_hust-obc-cat-0558
  _0559_0560_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0558_0559_0560/0558/G_0558_甲骨文0
  .png`
- asset id: `asset-000498`
...
- source category: `0558_0559_0560`
- validation class: `492`
- source image route: `HUST-OBC/deciphered/0558_0559_0560/0558/G_0558_甲骨文0.png
  `
- asset id: `asset-000498`
...
- English observation: `A broad pointed arch encloses one central upright
  stroke with several short branches on its upper left and two diverging
  lower extensions.`
- 中文观察: `宽尖拱形包围一条中央直立笔画，其左上有数条短分支，下部延伸分向两侧。`
...
- dataset label text: `㘤㘥㘦`
- dataset label codepoints: `U+3624;U+3625;U+3626`
...
- graph edge count: `2`
- codepoint routes: `U+3624;U+3625;U+3626`
...
- Which source records identify obs-char-000493 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000493？
