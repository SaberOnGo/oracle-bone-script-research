# obs-char-000939 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000939`
- primary external id: `hust-obc-cat-1056`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/939_obs-char-000939_hust-obc-cat-1056_orac
  le-character/03_visual-assets/001_asset-000944_hust-obc-cat-1056_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1056/G_1056_前2.17.6(甲).png`
- asset id: `asset-000944`
...
- source category: `1056`
- validation class: `938`
- source image route: `HUST-OBC/deciphered/1056/G_1056_前2.17.6(甲).png`
- asset id: `asset-000944`
...
- English observation: `A small upper angular loop, a lower forked cluster,
  and a detached curved stroke form three visible parts.`
- 中文观察: `小型上部折角环、下部叉形笔群和分离弯笔构成三个可见部分。`
...
- dataset label text: `㠖`
- dataset label codepoints: `U+3816`
...
- Which source records identify obs-char-000939 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000939？
