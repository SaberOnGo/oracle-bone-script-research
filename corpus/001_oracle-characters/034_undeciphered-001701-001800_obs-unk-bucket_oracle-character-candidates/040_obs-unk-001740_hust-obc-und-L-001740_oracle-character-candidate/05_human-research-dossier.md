# obs-unk-001740 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-001740`
- primary external id: `hust-obc-und-L-001740`
...
- local review image route: `corpus/001_oracle-characters/034_undeciphered-001
  701-001800_obs-unk-bucket_oracle-character-candidates/040_obs-unk-001740_h
  ust-obc-und-L-001740_oracle-character-candidate/03_visual-assets/001_asset
  -003333_hust-obc-und-L-001740_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/1740/L_？_1477.jpg`
- asset id: `asset-003333`
...
- source class: `HUST-OBC/undeciphered/L/1740/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/1740/L_？_1477.jpg`
- asset id: `asset-003333`
...
- Which source records identify obs-unk-001740 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-001740？
