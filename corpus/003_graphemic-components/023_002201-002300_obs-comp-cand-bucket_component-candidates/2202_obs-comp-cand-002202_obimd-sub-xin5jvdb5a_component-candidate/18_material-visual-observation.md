# Material Visual Observation / obs-comp-cand-002202 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002202`
- External reference / 外部参照: `obimd-sub-xin5jvdb5a`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019908_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cvxsbiqy4g/xin5jvdb5a/xin5jvdb5a.png`
- Checksum / 校验和:
  `a6516a278aeaec2cb52e17ce473bfd2a4981a15965420111e84317c495212a44`
...
- Marked-pixel bounds: (79,32)–(170,212); span 92 × 181 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.07%。
- 痕迹范围：(79,32)–(170,212)；跨度92 × 181 px；痕迹矩形高于宽。
