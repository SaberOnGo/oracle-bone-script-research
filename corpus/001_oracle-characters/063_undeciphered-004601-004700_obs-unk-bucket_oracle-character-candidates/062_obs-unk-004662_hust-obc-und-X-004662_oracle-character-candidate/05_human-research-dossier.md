# obs-unk-004662 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/062_obs-unk-004662_h
  ust-obc-und-X-004662_oracle-character-candidate/03_visual-assets/001_asset
  -006255_hust-obc-und-X-004662_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/218/X_？_8389_1.png`
- asset id: `asset-006255`
...
- source class: `HUST-OBC/undeciphered/X/218/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/218/X_？_8389_1.png`
- asset id: `asset-006255`
...
- English observation: `irregular tall contour with inner strokes`
- 中文观察: `带内部笔画的不规则高轮廓`
...
- Which source records identify obs-unk-004662 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004662？
