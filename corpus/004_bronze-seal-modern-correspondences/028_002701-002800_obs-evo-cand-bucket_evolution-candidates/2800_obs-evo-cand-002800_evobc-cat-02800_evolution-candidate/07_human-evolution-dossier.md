...
- Project ID: `obs-evo-cand-002800`
- EVOBC category candidate ID: `evobc-evo-cat-02800`
- External category reference: `evobc-cat-02800`
- Source category ID: `02800`
- Source label for human review: `弞`
- Source codepoints: `U+5F1E`
...
- `obs-evo-cand-002800-route-category-staging`
...
- `obs-evo-cand-002800-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002800-route-evolution-graph`
