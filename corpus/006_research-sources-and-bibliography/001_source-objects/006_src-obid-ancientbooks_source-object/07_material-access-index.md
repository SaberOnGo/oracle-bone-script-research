# src-obid-ancientbooks Material Access Index / src-obid-ancientbooks 资料访问索引
...
| --- | --- | --- | --- |
| Source summary / 来源摘要 | `README.md` | present | source ID `src-obid-ancientbooks` |
...
| Field maps / 字段映射 | `04_field-map-route-index.csv` | field_rows_present | 2 row(s); target records: external_source_prefix;source_record |
...
- Risk note / 风险提示: Professional/editorial source but commercial platform; access and redistribution rights require visible caution.
