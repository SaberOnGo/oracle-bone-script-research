# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002850
...
- EVOBC candidate category: `evobc-evo-cat-02850`.
- Source label for search only: `彬`.
- Source codepoints for search only: `U+5F6C`.
