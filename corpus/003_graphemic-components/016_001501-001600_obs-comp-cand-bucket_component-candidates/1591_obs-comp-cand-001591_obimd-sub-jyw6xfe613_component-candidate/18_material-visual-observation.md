# Material Visual Observation / obs-comp-cand-001591 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001591`
- External reference / 外部参照: `obimd-sub-jyw6xfe613`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017267_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ctejf56of8/jyw6xfe613/jyw6xfe613.png`
- Checksum / 校验和:
  `c329208b74def8ae13c934ffb135127c3af86717f97294e88c0efc83959106c5`
...
- Marked-pixel bounds: (87,27)–(162,217); span 76 × 191 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.38%。
- 痕迹范围：(87,27)–(162,217)；跨度76 × 191 px；痕迹矩形高于宽。
