# obs-char-000212 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000212`
- primary external id: `hust-obc-cat-0235`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/212_obs-char-000212_hust-obc-cat-0235_orac
  le-character/03_visual-assets/001_asset-000217_hust-obc-cat-0235_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0235/G_0235_京都1094A合3651.png`
- asset id: `asset-000217`
...
- source category: `0235`
- validation class: `211`
- source image route: `HUST-OBC/deciphered/0235/G_0235_京都1094A合3651.png`
- asset id: `asset-000217`
...
- English observation: `The narrow image has a branching upper stem, several
  fine strokes gathered in the middle, and a curved lower-right
  continuation.`
- 中文观察: `狭长图像上方有分叉主笔，中部聚集数道细笔，下方右侧有弯曲延续笔。`
...
- dataset label text: `㓡`
- dataset label codepoints: `U+34E1`
...
- filename catalog route clues: `Heji-like filename clue: 合3651
...
- Which source records identify obs-char-000212 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000212？
