# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006009
...
- EVOBC candidate category: `evobc-evo-cat-06009`.
- Source label for search only: `祼`.
- Source codepoints for search only: `U+797C`.
