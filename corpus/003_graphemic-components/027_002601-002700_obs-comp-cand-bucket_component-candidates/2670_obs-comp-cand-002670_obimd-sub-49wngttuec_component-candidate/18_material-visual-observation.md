# Material Visual Observation / obs-comp-cand-002670 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002670`
- External reference / 外部参照: `obimd-sub-49wngttuec`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021246_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/49wngttuec/49wngttuec/49wngttuec.png`
- Checksum / 校验和:
  `84b4e7eb24e906da79762502f81d123a5eb3742b379bcd4dd4221e84da47124f`
...
- Marked-pixel bounds: (95,18)–(151,231); span 57 × 214 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.64%。
- 痕迹范围：(95,18)–(151,231)；跨度57 × 214 px；痕迹矩形高于宽。
