# Material Visual Observation / obs-comp-cand-001083 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001083`
- External reference / 外部参照: `obimd-sub-46aok4e9hb`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014780_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/46aok4e9hb/46aok4e9hb/46aok4e9hb.png`
- Checksum / 校验和:
  `37c876ab89304cf064a9c74014ab629e890b428fb7a3e781346dd5283412f95a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.05%.
- Marked-pixel bounds: (73,31)–(176,224); span 104 × 194 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.05%。
- 痕迹范围：(73,31)–(176,224)；跨度104 × 194 px；痕迹矩形高于宽。
