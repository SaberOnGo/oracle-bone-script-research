# obs-char-001034 Archaeology Paleography Review

# obs-char-001034 考古文字复核档案
...
- first local image: `001_asset-001039_hust-obc-cat-1159_glyph.png`
- first source image: `G_1159_前6.56.2(甲).png`
...
- source label text: `㡽`
- source label codepoints: `U+387D`
