...
- External category reference: `evobc-cat-12503`
- Source category ID: `12503`
- Source label for human review: `𨳟`
- Source codepoints: `U+28CDF`
- Image reference count in source metadata: `12`
...
- `obs-evo-cand-012503-route-category-staging`
...
- `obs-evo-cand-012503-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012503-route-evolution-graph`
