...
- `obs-evo-cand-007650-route-category-staging`
...
- `obs-evo-cand-007650-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007650-route-evolution-graph`
