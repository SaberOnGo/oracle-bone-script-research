# Material Visual Observation / obs-comp-cand-001330 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001330`
- External reference / 外部参照: `obimd-sub-k488tbxgjl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015667_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/k488tbxgjl/k488tbxgjl/k488tbxgjl.png`
- Checksum / 校验和:
  `6e58d53bf2ad3b161159983d9a3f7fb0bfb32f91f67395e5e25bff8cdfbe7a08`
...
- Marked-pixel bounds: (97,22)–(166,228); span 70 × 207 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.33%。
- 痕迹范围：(97,22)–(166,228)；跨度70 × 207 px；痕迹矩形高于宽。
