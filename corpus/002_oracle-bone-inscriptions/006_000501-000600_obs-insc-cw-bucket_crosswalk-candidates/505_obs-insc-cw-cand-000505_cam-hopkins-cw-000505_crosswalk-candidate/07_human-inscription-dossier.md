...
Project ID: `obs-insc-cw-cand-000505`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000505`
...
- Yingguo / 英国所藏: `y2462` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `292` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `183` in source row; primary catalog entry pending
- Heji / 合集: `41628` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000505`
