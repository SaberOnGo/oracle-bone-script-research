# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001588
...
| --- | --- | --- | --- |
| `obimd-glyph-link-024753` | 󹒎 | `U+F948E` | `reviewed_metadata_only` |
| `obimd-glyph-link-024754` | 󹒏 | `U+F948F` | `reviewed_metadata_only` |
