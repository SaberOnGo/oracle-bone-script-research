# obs-char-000215 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/215_obs-char-000215_hust-obc-cat-0239_orac
  le-character/03_visual-assets/001_asset-000220_hust-obc-cat-0239_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0239/X_0239_2181_1.png`
- asset id: `asset-000220`
...
- source category: `0239`
- validation class: `214`
- source image route: `HUST-OBC/deciphered/0239/X_0239_2181_1.png`
- asset id: `asset-000220`
...
- English observation: `The image has two long descending side strokes, a
  short fork near the upper middle, and several pointed projections along
  the lower edge.`
- 中文观察: `图像两侧有长下行笔，中上部有短分叉，下缘有数道尖状伸出笔。`
...
- dataset label text: `㓥`
- dataset label codepoints: `U+34E5`
...
- Which source records identify obs-char-000215 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000215？
