...
- External category reference: `evobc-cat-11380`
- Source category ID: `11380`
- Source label for human review: `𣃈`
...
- `obs-evo-cand-011380-route-category-staging`
...
- `obs-evo-cand-011380-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011380-route-evolution-graph`
