...
- Project ID: `obs-evo-cand-013418`
- EVOBC category candidate ID: `evobc-evo-cat-13418`
- External category reference: `evobc-cat-13418`
- Source category ID: `13418`
- Source label for human review: `𬯔`
- Source codepoints: `U+2CBD4`
...
- `obs-evo-cand-013418-route-category-staging`
...
- `obs-evo-cand-013418-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013418-route-evolution-graph`
