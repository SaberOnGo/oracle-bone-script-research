...
Project ID: `obs-evo-cand-007352`
...
- Project ID: `obs-evo-cand-007352`
- EVOBC category candidate ID: `evobc-evo-cat-07352`
- External category reference: `evobc-cat-07352`
- Source category ID: `07352`
- Source label for human review: `荒`
- Source codepoints: `U+8352`
...
- `obs-evo-cand-007352-route-category-staging`
...
- `obs-evo-cand-007352-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007352-route-evolution-graph`
