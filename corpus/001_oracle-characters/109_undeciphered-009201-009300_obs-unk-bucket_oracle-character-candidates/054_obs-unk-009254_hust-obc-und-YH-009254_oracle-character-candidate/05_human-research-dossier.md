# obs-unk-009254 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-009254`
- primary external id: `hust-obc-und-YH-009254`
...
- local review image route: `corpus/001_oracle-characters/109_undeciphered-009
  201-009300_obs-unk-bucket_oracle-character-candidates/054_obs-unk-009254_h
  ust-obc-und-YH-009254_oracle-character-candidate/03_visual-assets/001_asse
  t-010845_hust-obc-und-YH-009254_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6142B/H_？_6142B_0.png`
- asset id: `asset-010845`
...
- source class: `HUST-OBC/undeciphered/Y+H/6142B/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6142B/H_？_6142B_0.png`
- asset id: `asset-010845`
...
- Which source records identify obs-unk-009254 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009254？
