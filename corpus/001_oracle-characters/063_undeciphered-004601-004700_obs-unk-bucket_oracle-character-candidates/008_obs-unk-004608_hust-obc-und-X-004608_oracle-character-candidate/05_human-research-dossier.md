# obs-unk-004608 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/008_obs-unk-004608_h
  ust-obc-und-X-004608_oracle-character-candidate/03_visual-assets/001_asset
  -006201_hust-obc-und-X-004608_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/164/X_？_8340_1.png`
- asset id: `asset-006201`
...
- source class: `HUST-OBC/undeciphered/X/164/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/164/X_？_8340_1.png`
- asset id: `asset-006201`
...
- English observation: `lower frame, left upright, slanting branched trace`
- 中文观察: `下部框体、左侧竖痕和斜向分支已记录。`
...
- Which source records identify obs-unk-004608 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004608？
