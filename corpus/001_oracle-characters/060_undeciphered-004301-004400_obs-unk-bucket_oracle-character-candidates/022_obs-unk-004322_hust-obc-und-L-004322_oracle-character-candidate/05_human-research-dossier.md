# obs-unk-004322 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004322`
- primary external id: `hust-obc-und-L-004322`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/022_obs-unk-004322_h
  ust-obc-und-L-004322_oracle-character-candidate/03_visual-assets/001_asset
  -005915_hust-obc-und-L-004322_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4322/L_？_9555.jpg`
- asset id: `asset-005915`
...
- source class: `HUST-OBC/undeciphered/L/4322/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4322/L_？_9555.jpg`
- asset id: `asset-005915`
...
- English observation: `Rounded upper trace and three lower strokes
  recorded.`
- 中文观察: `已记录上部圆弧痕迹和三条下部痕迹。`
...
- Which source records identify obs-unk-004322 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004322？
