...
Project ID: `obs-evo-cand-011835`
...
- Project ID: `obs-evo-cand-011835`
- EVOBC category candidate ID: `evobc-evo-cat-11835`
- External category reference: `evobc-cat-11835`
- Source category ID: `11835`
- Source label for human review: `𥝹`
- Source codepoints: `U+25779`
...
- `obs-evo-cand-011835-route-category-staging`
...
- `obs-evo-cand-011835-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011835-route-evolution-graph`
