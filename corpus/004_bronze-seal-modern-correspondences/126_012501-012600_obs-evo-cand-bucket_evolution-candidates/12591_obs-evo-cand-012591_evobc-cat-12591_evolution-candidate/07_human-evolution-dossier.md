...
- External category reference: `evobc-cat-12591`
- Source category ID: `12591`
- Source label for human review: `𩎿`
...
- `obs-evo-cand-012591-route-category-staging`
...
- `obs-evo-cand-012591-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012591-route-evolution-graph`
