...
- External category reference: `evobc-cat-00641`
- Source category ID: `00641`
- Source label for human review: `临`
- Source codepoints: `U+4E34`
...
- `obs-evo-cand-000641-route-category-staging`
...
- `obs-evo-cand-000641-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000641-route-evolution-graph`
