# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008954
...
- EVOBC candidate category: `evobc-evo-cat-08954`.
- Source label for search only: `连`.
- Source codepoints for search only: `U+8FDE`.
