...
Project ID: `obs-evo-cand-000058`
...
- Project ID: `obs-evo-cand-000058`
- EVOBC category candidate ID: `evobc-evo-cat-00058`
- External category reference: `evobc-cat-00058`
- Source category ID: `00058`
- Source label for human review: `㛸`
- Source codepoints: `U+36F8`
...
- `obs-evo-cand-000058-route-category-staging`
...
- `obs-evo-cand-000058-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000058-route-evolution-graph`
