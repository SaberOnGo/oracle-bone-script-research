# obs-evo-cand-008906 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-008906`
- EVOBC category candidate ID: `evobc-evo-cat-08906`
- External category ref: `evobc-cat-08906`
- Source label: `辛`
- Source codepoints: `U+8F9B`
- Image reference count: `416`
- Era token counts: `BI:222;CS:2;OBC:100;SAC:8;SS:2;WSC:82`
- Source token counts: `Book:241;Web:175`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 100 image references
- era 1 / BI: 222 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 8 image references
- era 4 / WSC: 82 image references
- era 5 / CS: 2 image references
- source 0 / Web:1633: 1 image references
- source 1 / Web:105952;說文Web:58: 154 image references
- source 2 / Book:17600: 35 image references
- source 3 / Book:21681: 169 image references
- source 4 / Book:9131: 8 image references
- source 5 / Book:32794: 25 image references
