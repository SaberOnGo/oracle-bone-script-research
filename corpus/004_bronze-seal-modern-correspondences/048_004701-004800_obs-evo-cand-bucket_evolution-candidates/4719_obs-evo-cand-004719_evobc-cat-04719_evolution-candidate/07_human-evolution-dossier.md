...
- External category reference: `evobc-cat-04719`
- Source category ID: `04719`
- Source label for human review: `淙`
- Source codepoints: `U+6DD9`
...
- `obs-evo-cand-004719-route-category-staging`
...
- `obs-evo-cand-004719-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004719-route-evolution-graph`
