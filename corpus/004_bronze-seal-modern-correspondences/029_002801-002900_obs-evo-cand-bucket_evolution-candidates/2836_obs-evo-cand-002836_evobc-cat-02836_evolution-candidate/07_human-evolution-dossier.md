...
Project ID: `obs-evo-cand-002836`
...
- Project ID: `obs-evo-cand-002836`
- EVOBC category candidate ID: `evobc-evo-cat-02836`
- External category reference: `evobc-cat-02836`
- Source category ID: `02836`
- Source label for human review: `彗`
- Source codepoints: `U+5F57`
...
- `obs-evo-cand-002836-route-category-staging`
...
- `obs-evo-cand-002836-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002836-route-evolution-graph`
