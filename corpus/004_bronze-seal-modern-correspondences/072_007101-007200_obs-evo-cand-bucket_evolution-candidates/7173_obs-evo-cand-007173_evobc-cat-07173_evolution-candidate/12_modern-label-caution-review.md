# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-007173
...
- EVOBC candidate category: `evobc-evo-cat-07173`.
- Source label for search only: `臸`.
- Source codepoints for search only: `U+81F8`.
