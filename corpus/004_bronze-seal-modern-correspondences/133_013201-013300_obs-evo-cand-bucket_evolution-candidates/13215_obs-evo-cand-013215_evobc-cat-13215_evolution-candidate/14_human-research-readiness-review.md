# Human Research Readiness Review / 正式研究准备复核: obs-evo-cand-013215
...
- Source label for lookup only: `𬆤`.
- Source codepoints for lookup only: `U+2C1A4`.
- Era/source code rows to open: `6`.
