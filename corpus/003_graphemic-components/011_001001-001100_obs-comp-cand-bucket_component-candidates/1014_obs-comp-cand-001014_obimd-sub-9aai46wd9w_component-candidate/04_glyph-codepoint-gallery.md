# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001014
...
| --- | --- | --- | --- |
| `obimd-glyph-link-014720` | 渞󵰙 | `U+6E1E;U+F5C19` | `reviewed_metadata_only` |
| `obimd-glyph-link-014721` | 󵰚 | `U+F5C1A` | `reviewed_metadata_only` |
| `obimd-glyph-link-014722` | 󵰛 | `U+F5C1B` | `reviewed_metadata_only` |
| `obimd-glyph-link-014723` | 󵰜 | `U+F5C1C` | `reviewed_metadata_only` |
