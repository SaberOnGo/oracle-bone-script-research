# obs-unk-008773 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008773`
- primary external id: `hust-obc-und-YH-008773`
...
- local review image route: `corpus/001_oracle-characters/104_undeciphered-008
  701-008800_obs-unk-bucket_oracle-character-candidates/073_obs-unk-008773_h
  ust-obc-und-YH-008773_oracle-character-candidate/03_visual-assets/001_asse
  t-010364_hust-obc-und-YH-008773_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60DDD/H_？_60DDD_0.png`
- asset id: `asset-010364`
...
- source class: `HUST-OBC/undeciphered/Y+H/60DDD/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60DDD/H_？_60DDD_0.png`
- asset id: `asset-010364`
...
- Which source records identify obs-unk-008773 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008773？
