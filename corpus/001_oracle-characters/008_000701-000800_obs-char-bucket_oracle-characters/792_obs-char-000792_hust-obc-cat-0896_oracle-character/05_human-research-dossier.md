# obs-char-000792 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000792`
- primary external id: `hust-obc-cat-0896`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/792_obs-char-000792_hust-obc-cat-0896_orac
  le-character/03_visual-assets/001_asset-000797_hust-obc-cat-0896_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0896/G_0896_乙1054合6828.png`
- asset id: `asset-000797`
...
- source category: `0896`
- validation class: `791`
- source image route: `HUST-OBC/deciphered/0896/G_0896_乙1054合6828.png`
- asset id: `asset-000797`
...
- English observation: `A detached shallow rectangular loop sits above a
  narrow stem that forks near the top and ends in a long pointed lower
  branch.`
- 中文观察: `分离的浅矩形环位于上方；下方狭干近顶部分叉，并收为长尖下枝。`
...
- dataset label text: `㝶`
- dataset label codepoints: `U+3776`
...
- Which source records identify obs-char-000792 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000792？
