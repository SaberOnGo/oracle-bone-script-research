# obs-char-000934 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/934_obs-char-000934_hust-obc-cat-1051_orac
  le-character/03_visual-assets/001_asset-000939_hust-obc-cat-1051_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1051/G_1051_乙1983合903賓組.png`
- asset id: `asset-000939`
...
- source category: `1051`
- validation class: `933`
- source image route: `HUST-OBC/deciphered/1051/G_1051_乙1983合903賓組.png`
- asset id: `asset-000939`
...
- dataset label text: `㠑`
- dataset label codepoints: `U+3811`
...
- Which source records identify obs-char-000934 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000934？
