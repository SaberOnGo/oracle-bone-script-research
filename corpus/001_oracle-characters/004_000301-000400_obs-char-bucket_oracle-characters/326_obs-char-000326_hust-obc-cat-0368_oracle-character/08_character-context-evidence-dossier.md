...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0368`
...
- Source image / 来源图: `G_0368_乙1049合21729子組.png`
- Image / 图像: `001_asset-000331_hust-obc-cat-0368_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合21729
...
- target node: `obimd-main-cand-000891`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Matched OBIMD main UIDs / OBIMD 主字 UID: `x0w8luxhhs`
...
- Source label text / 来源标签文字: `㕦`
- Source label codepoint / 来源标签 codepoint: `U+3566`
