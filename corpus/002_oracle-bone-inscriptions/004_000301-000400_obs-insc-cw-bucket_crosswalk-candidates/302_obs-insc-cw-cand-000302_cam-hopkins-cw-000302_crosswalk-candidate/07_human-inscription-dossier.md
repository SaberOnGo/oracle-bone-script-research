...
Project ID: `obs-insc-cw-cand-000302`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000302`
...
- Yingguo / 英国所藏: `y1945` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `285` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `20` in source row; primary catalog entry pending
- Heji / 合集: `39626` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000302`
