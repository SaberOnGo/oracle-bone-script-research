# obs-char-000144 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/144_obs-char-000144_hust-obc-cat-0159_orac
  le-character/03_visual-assets/001_asset-000149_hust-obc-cat-0159_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0159/G_0159_甲骨文.png`
- asset id: `asset-000149`
...
- source category: `0159`
- validation class: `143`
- source image route: `HUST-OBC/deciphered/0159/G_0159_甲骨文.png`
- asset id: `asset-000149`
...
- English observation: `The image has a pointed upper mark, a banded
  diagonal form opening toward the lower left, and a thin curved stroke
  descending on the right.`
- 中文观察: `图像上方有尖状痕迹，左下方有带平行横痕的斜向开放形，右侧有细弯曲下行笔。`
...
- dataset label text: `㒕`
- dataset label codepoints: `U+3495`
...
- Which source records identify obs-char-000144 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000144？
