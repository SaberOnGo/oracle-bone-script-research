...
- Project ID: `obs-evo-cand-000359`
- EVOBC category candidate ID: `evobc-evo-cat-00359`
- External category reference: `evobc-cat-00359`
- Source category ID: `00359`
- Source label for human review: `䏽`
- Source codepoints: `U+43FD`
...
- `obs-evo-cand-000359-route-category-staging`
...
- `obs-evo-cand-000359-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000359-route-evolution-graph`
