# obs-unk-001985 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-001985`
- primary external id: `hust-obc-und-L-001985`
...
- local review image route: `corpus/001_oracle-characters/036_undeciphered-001
  901-002000_obs-unk-bucket_oracle-character-candidates/085_obs-unk-001985_h
  ust-obc-und-L-001985_oracle-character-candidate/03_visual-assets/001_asset
  -003578_hust-obc-und-L-001985_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/1985/L_？_1835.jpg`
- asset id: `asset-003578`
...
- source class: `HUST-OBC/undeciphered/L/1985/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/1985/L_？_1835.jpg`
- asset id: `asset-003578`
...
- Which source records identify obs-unk-001985 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-001985？
