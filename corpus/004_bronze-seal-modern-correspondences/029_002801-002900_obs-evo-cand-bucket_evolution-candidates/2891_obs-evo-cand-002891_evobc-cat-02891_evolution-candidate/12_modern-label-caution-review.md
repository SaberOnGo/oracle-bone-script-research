# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002891
...
- EVOBC candidate category: `evobc-evo-cat-02891`.
- Source label for search only: `徻`.
- Source codepoints for search only: `U+5FBB`.
