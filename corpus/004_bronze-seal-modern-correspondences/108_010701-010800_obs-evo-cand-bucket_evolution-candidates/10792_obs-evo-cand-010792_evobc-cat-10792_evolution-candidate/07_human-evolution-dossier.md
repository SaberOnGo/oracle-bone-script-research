...
- External category reference: `evobc-cat-10792`
- Source category ID: `10792`
- Source label for human review: `𠈄`
- Source codepoints: `U+20204`
...
- `obs-evo-cand-010792-route-category-staging`
...
- `obs-evo-cand-010792-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010792-route-evolution-graph`
