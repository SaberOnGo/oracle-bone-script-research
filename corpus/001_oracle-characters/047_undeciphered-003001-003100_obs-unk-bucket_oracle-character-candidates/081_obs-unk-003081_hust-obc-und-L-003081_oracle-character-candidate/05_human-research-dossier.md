# obs-unk-003081 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/047_undeciphered-003
  001-003100_obs-unk-bucket_oracle-character-candidates/081_obs-unk-003081_h
  ust-obc-und-L-003081_oracle-character-candidate/03_visual-assets/001_asset
  -004674_hust-obc-und-L-003081_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3081/L_？_5553.jpg`
- asset id: `asset-004674`
...
- source class: `HUST-OBC/undeciphered/L/3081/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3081/L_？_5553.jpg`
- asset id: `asset-004674`
...
- Which source records identify obs-unk-003081 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003081？
