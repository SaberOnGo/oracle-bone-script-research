# Material Visual Observation / obs-comp-cand-000971 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000971`
- External reference / 外部参照: `obimd-sub-j5cl5jcqdz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014228_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/j5cl5jcqdz/j5cl5jcqdz/j5cl5jcqdz.png`
- Checksum / 校验和:
  `a207b13ae591ca7b139417f3a1029143a0de11c22f9c89ab07a44d646e130531`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.70%.
- Marked-pixel bounds: (92,35)–(157,216); span 66 × 182 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.70%。
- 痕迹范围：(92,35)–(157,216)；跨度66 × 182 px；痕迹矩形高于宽。
