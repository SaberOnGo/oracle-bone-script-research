...
- `obs-evo-cand-009841-route-category-staging`
...
- `obs-evo-cand-009841-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009841-route-evolution-graph`
