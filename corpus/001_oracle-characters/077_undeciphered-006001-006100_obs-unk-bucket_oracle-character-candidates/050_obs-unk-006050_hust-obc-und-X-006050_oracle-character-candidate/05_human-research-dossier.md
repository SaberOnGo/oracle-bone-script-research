# obs-unk-006050 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/077_undeciphered-006
  001-006100_obs-unk-bucket_oracle-character-candidates/050_obs-unk-006050_h
  ust-obc-und-X-006050_oracle-character-candidate/03_visual-assets/001_asset
  -007642_hust-obc-und-X-006050_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1606/X_？_3379_1.png`
- asset id: `asset-007642`
...
- source class: `HUST-OBC/undeciphered/X/1606/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1606/X_？_3379_1.png`
- asset id: `asset-007642`
...
- Which source records identify obs-unk-006050 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006050？
