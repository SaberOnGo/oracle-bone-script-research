# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000082
...
| --- | --- | --- | --- |
| `obimd-glyph-link-001444` | 󰟬 | `U+F07EC` | `reviewed_metadata_only` |
| `obimd-glyph-link-001445` | 󰟭 | `U+F07ED` | `reviewed_metadata_only` |
| `obimd-glyph-link-001446` | 󰟮 | `U+F07EE` | `reviewed_metadata_only` |
| `obimd-glyph-link-001447` | 󰟯 | `U+F07EF` | `reviewed_metadata_only` |
