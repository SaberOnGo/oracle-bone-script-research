...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1381`
...
- Source image / 来源图: `X_1381_1238_1.png`
- Image / 图像: `001_asset-001239_hust-obc-cat-1381_glyph.png`
...
- target node: `evobc-evo-cat-00128`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/128_obs-evo-cand-000128_evobc-cat-00128_evoluti
...
- Source label text / 来源标签文字: `㥛`
- Source label codepoint / 来源标签 codepoint: `U+395B`
