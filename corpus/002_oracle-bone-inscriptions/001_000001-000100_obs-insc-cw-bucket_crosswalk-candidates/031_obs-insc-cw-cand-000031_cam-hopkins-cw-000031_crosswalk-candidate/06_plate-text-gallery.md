...
Project ID: `obs-insc-cw-cand-000031`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000031`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000031` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y184` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `75` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `642` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `39698` [route_present_image_or_text_not_collected]
