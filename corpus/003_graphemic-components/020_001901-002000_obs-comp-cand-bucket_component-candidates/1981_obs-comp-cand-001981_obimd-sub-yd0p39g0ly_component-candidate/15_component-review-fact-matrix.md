# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001981
...
| Glyph or codepoint route / 字形或码位路线 | 2 OBIMD route rows; examples U+C12C0;U+FB523; U+FB524 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
