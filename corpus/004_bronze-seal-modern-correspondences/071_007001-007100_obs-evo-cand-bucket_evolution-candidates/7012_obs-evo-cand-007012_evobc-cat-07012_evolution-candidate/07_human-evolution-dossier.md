...
- Project ID: `obs-evo-cand-007012`
- EVOBC category candidate ID: `evobc-evo-cat-07012`
- External category reference: `evobc-cat-07012`
- Source category ID: `07012`
- Source label for human review: `肿`
- Source codepoints: `U+80BF`
...
- `obs-evo-cand-007012-route-category-staging`
...
- `obs-evo-cand-007012-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007012-route-evolution-graph`
