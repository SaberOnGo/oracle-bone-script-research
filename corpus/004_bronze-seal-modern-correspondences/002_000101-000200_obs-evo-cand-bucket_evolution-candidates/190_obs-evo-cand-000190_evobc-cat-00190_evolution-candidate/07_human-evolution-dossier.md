...
- External category reference: `evobc-cat-00190`
- Source category ID: `00190`
- Source label for human review: `㱉`
- Source codepoints: `U+3C49`
...
- `obs-evo-cand-000190-route-category-staging`
...
- `obs-evo-cand-000190-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000190-route-evolution-graph`
