# obs-unk-005728 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/074_undeciphered-005
  701-005800_obs-unk-bucket_oracle-character-candidates/028_obs-unk-005728_h
  ust-obc-und-X-005728_oracle-character-candidate/03_visual-assets/001_asset
  -007320_hust-obc-und-X-005728_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1284/X_？_1286_1.png`
- asset id: `asset-007320`
...
- source class: `HUST-OBC/undeciphered/X/1284/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1284/X_？_1286_1.png`
- asset id: `asset-007320`
...
- Which source records identify obs-unk-005728 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005728？
