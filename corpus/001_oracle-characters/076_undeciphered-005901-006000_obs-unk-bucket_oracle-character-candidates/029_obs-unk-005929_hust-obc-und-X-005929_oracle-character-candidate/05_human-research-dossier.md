# obs-unk-005929 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005929`
- primary external id: `hust-obc-und-X-005929`
...
- local review image route: `corpus/001_oracle-characters/076_undeciphered-005
  901-006000_obs-unk-bucket_oracle-character-candidates/029_obs-unk-005929_h
  ust-obc-und-X-005929_oracle-character-candidate/03_visual-assets/001_asset
  -007521_hust-obc-und-X-005929_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1485/X_？_2589_1.png`
- asset id: `asset-007521`
...
- source class: `HUST-OBC/undeciphered/X/1485/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1485/X_？_2589_1.png`
- asset id: `asset-007521`
- source image count: `29`
...
- Which source records identify obs-unk-005929 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005929？
