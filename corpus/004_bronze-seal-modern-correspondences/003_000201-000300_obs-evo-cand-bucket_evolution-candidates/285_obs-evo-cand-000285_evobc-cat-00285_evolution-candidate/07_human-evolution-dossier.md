...
- External category reference: `evobc-cat-00285`
- Source category ID: `00285`
- Source label for human review: `䄀`
- Source codepoints: `U+4100`
...
- `obs-evo-cand-000285-route-category-staging`
...
- `obs-evo-cand-000285-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000285-route-evolution-graph`
