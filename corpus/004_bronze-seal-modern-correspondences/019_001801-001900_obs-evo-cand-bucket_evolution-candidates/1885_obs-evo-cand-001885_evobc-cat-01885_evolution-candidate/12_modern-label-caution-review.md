# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001885
...
- EVOBC candidate category: `evobc-evo-cat-01885`.
- Source label for search only: `埶`.
- Source codepoints for search only: `U+57F6`.
