...
Project ID: `obs-evo-cand-007603`
...
- Project ID: `obs-evo-cand-007603`
- EVOBC category candidate ID: `evobc-evo-cat-07603`
- External category reference: `evobc-cat-07603`
- Source category ID: `07603`
- Source label for human review: `薈`
- Source codepoints: `U+8588`
...
- `obs-evo-cand-007603-route-category-staging`
...
- `obs-evo-cand-007603-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007603-route-evolution-graph`
