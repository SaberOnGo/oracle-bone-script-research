...
- External category reference: `evobc-cat-05240`
- Source category ID: `05240`
- Source label for human review: `犝`
...
- `obs-evo-cand-005240-route-category-staging`
...
- `obs-evo-cand-005240-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005240-route-evolution-graph`
