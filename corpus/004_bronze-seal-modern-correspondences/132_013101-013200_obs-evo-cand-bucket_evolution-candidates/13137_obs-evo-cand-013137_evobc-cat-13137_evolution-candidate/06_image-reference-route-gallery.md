...
- `obs-evo-cand-013137-route-category-staging`
...
- `obs-evo-cand-013137-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013137-route-evolution-graph`
