...
Project ID: `obs-insc-cw-cand-000378`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000378`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000378` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2124` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `433` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `19` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `41173` [route_present_image_or_text_not_collected]
