...
- Project ID: `obs-evo-cand-000312`
- EVOBC category candidate ID: `evobc-evo-cat-00312`
- External category reference: `evobc-cat-00312`
- Source category ID: `00312`
- Source label for human review: `䊪`
- Source codepoints: `U+42AA`
...
- `obs-evo-cand-000312-route-category-staging`
...
- `obs-evo-cand-000312-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000312-route-evolution-graph`
