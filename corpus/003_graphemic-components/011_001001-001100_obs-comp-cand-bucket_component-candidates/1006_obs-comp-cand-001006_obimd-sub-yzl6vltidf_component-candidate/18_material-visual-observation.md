# Material Visual Observation / obs-comp-cand-001006 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001006`
- External reference / 外部参照: `obimd-sub-yzl6vltidf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014469_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/yzl6vltidf/yzl6vltidf/yzl6vltidf.png`
- Checksum / 校验和:
  `0e7465f763d1312a07966ea8ffe395bc6a575a15a5153c0787dc272c2d276aeb`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.17%.
- Marked-pixel bounds: (84,19)–(189,226); span 106 × 208 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.17%。
- 痕迹范围：(84,19)–(189,226)；跨度106 × 208 px；痕迹矩形高于宽。
