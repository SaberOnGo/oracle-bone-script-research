# obs-char-000300 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000300`
- primary external id: `hust-obc-cat-0340`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/300_obs-char-000300_hust-obc-cat-0340_orac
  le-character/03_visual-assets/001_asset-000305_hust-obc-cat-0340_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0340/L_0340_3801.jpg`
- asset id: `asset-000305`
...
- source category: `0340`
- validation class: `299`
- source image route: `HUST-OBC/deciphered/0340/L_0340_3801.jpg`
- asset id: `asset-000305`
...
- English observation: `The low-contrast gray image shows several short
  slanting marks at the left and a small rounded enclosure at the right;
  contrast needs recheck.`
- 中文观察: `低对比度灰色图像左侧有数道短斜向痕迹，右侧有小型圆弧闭合轮廓；对比度仍需复核。`
...
- dataset label text: `㕊`
- dataset label codepoints: `U+354A`
...
- Which source records identify obs-char-000300 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000300？
