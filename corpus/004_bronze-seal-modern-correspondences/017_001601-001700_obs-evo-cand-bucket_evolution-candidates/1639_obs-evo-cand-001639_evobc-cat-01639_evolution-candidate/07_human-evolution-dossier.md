...
Project ID: `obs-evo-cand-001639`
...
- Project ID: `obs-evo-cand-001639`
- EVOBC category candidate ID: `evobc-evo-cat-01639`
- External category reference: `evobc-cat-01639`
- Source category ID: `01639`
- Source label for human review: `善`
- Source codepoints: `U+5584`
- Image reference count in source metadata: `142`
...
- `obs-evo-cand-001639-route-category-staging`
...
- `obs-evo-cand-001639-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001639-route-evolution-graph`
