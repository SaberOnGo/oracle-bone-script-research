...
- External category reference: `evobc-cat-00338`
- Source category ID: `00338`
- Source label for human review: `䌡`
...
- `obs-evo-cand-000338-route-category-staging`
...
- `obs-evo-cand-000338-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000338-route-evolution-graph`
