...
- External category reference: `evobc-cat-06686`
- Source category ID: `06686`
- Source label for human review: `繣`
...
- `obs-evo-cand-006686-route-category-staging`
...
- `obs-evo-cand-006686-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006686-route-evolution-graph`
