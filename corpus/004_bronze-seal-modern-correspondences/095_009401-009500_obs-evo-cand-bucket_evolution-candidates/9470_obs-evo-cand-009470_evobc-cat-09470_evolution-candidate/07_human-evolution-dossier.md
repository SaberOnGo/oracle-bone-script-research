...
- External category reference: `evobc-cat-09470`
- Source category ID: `09470`
- Source label for human review: `鍾`
...
- `obs-evo-cand-009470-route-category-staging`
...
- `obs-evo-cand-009470-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009470-route-evolution-graph`
