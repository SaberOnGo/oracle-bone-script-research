...
- External category reference: `evobc-cat-00029`
- Source category ID: `00029`
- Source label for human review: `㕣`
- Source codepoints: `U+3563`
...
- `obs-evo-cand-000029-route-category-staging`
...
- `obs-evo-cand-000029-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000029-route-evolution-graph`
