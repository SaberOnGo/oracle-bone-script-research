...
- External category reference: `evobc-cat-05909`
- Source category ID: `05909`
- Source label for human review: `硠`
...
- `obs-evo-cand-005909-route-category-staging`
...
- `obs-evo-cand-005909-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005909-route-evolution-graph`
