# Material Visual Observation / obs-comp-cand-001488 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001488`
- External reference / 外部参照: `obimd-sub-1uxh6sccbd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016065_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1uxh6sccbd/1uxh6sccbd/1uxh6sccbd.png`
- Checksum / 校验和:
  `a3208ccc855d63502ade54331cee4b410a36f17b0a3294e29a015c2586dbd2fd`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.70%.
- Marked-pixel bounds: (60,17)–(195,228); span 136 × 212 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.70%。
- 痕迹范围：(60,17)–(195,228)；跨度136 × 212 px；痕迹矩形高于宽。
