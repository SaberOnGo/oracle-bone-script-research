...
Project ID: `obs-evo-cand-013435`
...
- Project ID: `obs-evo-cand-013435`
- EVOBC category candidate ID: `evobc-evo-cat-13435`
- External category reference: `evobc-cat-13435`
- Source category ID: `13435`
- Source label for human review: `𬲒`
- Source codepoints: `U+2CC92`
...
- `obs-evo-cand-013435-route-category-staging`
...
- `obs-evo-cand-013435-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013435-route-evolution-graph`
