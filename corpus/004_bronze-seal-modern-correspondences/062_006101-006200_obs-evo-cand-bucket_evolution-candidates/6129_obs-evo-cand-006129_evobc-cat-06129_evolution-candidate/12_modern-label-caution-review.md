# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006129
...
- EVOBC candidate category: `evobc-evo-cat-06129`.
- Source label for search only: `穎`.
- Source codepoints for search only: `U+7A4E`.
