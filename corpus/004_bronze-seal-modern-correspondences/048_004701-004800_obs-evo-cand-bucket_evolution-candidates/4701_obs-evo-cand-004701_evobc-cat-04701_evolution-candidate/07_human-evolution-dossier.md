...
- External category reference: `evobc-cat-04701`
- Source category ID: `04701`
- Source label for human review: `涻`
...
- `obs-evo-cand-004701-route-category-staging`
...
- `obs-evo-cand-004701-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004701-route-evolution-graph`
