...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1296`
...
- Source image / 来源图: `G_1296_燕412合8833賓組.png`
- Image / 图像: `001_asset-001162_hust-obc-cat-1296_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合8833
...
- target node: `evobc-evo-cat-00114`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/114_obs-evo-cand-000114_evobc-cat-00114_evoluti
...
- Source label text / 来源标签文字: `㤆`
- Source label codepoint / 来源标签 codepoint: `U+3906`
