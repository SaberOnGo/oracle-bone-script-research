# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000886
...
| Glyph or codepoint route / 字形或码位路线 | 19 OBIMD route rows; examples U+F4F7B; U+F4F7C; 另有 17 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
