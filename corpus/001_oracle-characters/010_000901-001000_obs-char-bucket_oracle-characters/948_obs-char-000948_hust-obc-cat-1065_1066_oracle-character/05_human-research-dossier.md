# obs-char-000948 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/948_obs-char-000948_hust-obc-cat-1065_1066
  _oracle-character/03_visual-assets/001_asset-000953_hust-obc-cat-1065_1066
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1065_1066/1065/G_1065_拾6.3(甲).p
  ng`
- asset id: `asset-000953`
...
- source category: `1065_1066`
- validation class: `947`
- source image route: `HUST-OBC/deciphered/1065_1066/1065/G_1065_拾6.3(甲).png`
- asset id: `asset-000953`
...
- English observation: `Two small rounded loops at the top connect to a
  central branching stem and a long right-side curve.`
- 中文观察: `顶部两个小型圆弧环连接中央分枝笔干和右侧长弯笔。`
...
- dataset label text: `㠟㠠`
- dataset label codepoints: `U+381F;U+3820`
...
- Which source records identify obs-char-000948 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000948？
