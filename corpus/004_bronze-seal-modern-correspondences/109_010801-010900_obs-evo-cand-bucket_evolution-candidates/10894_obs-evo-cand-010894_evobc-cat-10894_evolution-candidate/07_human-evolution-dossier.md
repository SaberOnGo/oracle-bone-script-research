...
- External category reference: `evobc-cat-10894`
- Source category ID: `10894`
- Source label for human review: `𠨎`
- Source codepoints: `U+20A0E`
...
- `obs-evo-cand-010894-route-category-staging`
...
- `obs-evo-cand-010894-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010894-route-evolution-graph`
