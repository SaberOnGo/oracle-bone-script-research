# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000968
...
| --- | --- | --- | --- |
| `obimd-glyph-link-013730` | 娠󵜈 | `U+5A20;U+F5708` | `reviewed_metadata_only` |
| `obimd-glyph-link-013731` | 󵜉 | `U+F5709` | `reviewed_metadata_only` |
