...
- Project ID: `obs-evo-cand-002701`
- EVOBC category candidate ID: `evobc-evo-cat-02701`
- External category reference: `evobc-cat-02701`
- Source category ID: `02701`
- Source label for human review: `幺`
- Source codepoints: `U+5E7A`
...
- `obs-evo-cand-002701-route-category-staging`
...
- `obs-evo-cand-002701-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002701-route-evolution-graph`
