# Material Visual Observation / obs-comp-cand-000743 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000743`
- External reference / 外部参照: `obimd-sub-wkxzwjhuod`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013498_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5n30uigzj6/wkxzwjhuod/wkxzwjhuod.png`
- Checksum / 校验和:
  `153ebf5e911b4eae9a6a60695c1bec7b583a253fc41edd4acb614a921f11c8b7`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.53%.
- Marked-pixel bounds: (91,27)–(158,224); span 68 × 198 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.53%。
- 痕迹范围：(91,27)–(158,224)；跨度68 × 198 px；痕迹矩形高于宽。
