...
- External category reference: `evobc-cat-05125`
- Source category ID: `05125`
- Source label for human review: `熏`
- Source codepoints: `U+718F`
...
- `obs-evo-cand-005125-route-category-staging`
...
- `obs-evo-cand-005125-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005125-route-evolution-graph`
