...
- External category reference: `evobc-cat-06856`
- Source category ID: `06856`
- Source label for human review: `羥`
...
- `obs-evo-cand-006856-route-category-staging`
...
- `obs-evo-cand-006856-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006856-route-evolution-graph`
