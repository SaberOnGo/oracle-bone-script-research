# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006132
...
- EVOBC candidate category: `evobc-evo-cat-06132`.
- Source label for search only: `穜`.
- Source codepoints for search only: `U+7A5C`.
