# Material Visual Observation / obs-comp-cand-002414 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002414`
- External reference / 外部参照: `obimd-sub-kjv0lvcezv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020485_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kjv0lvcezv/kjv0lvcezv/kjv0lvcezv.png`
- Checksum / 校验和:
  `a92ef7d227922b470196b94a183148f335b77e980f504f6d256f539d1bc85d8c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.65%.
- Marked-pixel bounds: (67,51)–(182,196); span 116 × 146 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.65%。
- 痕迹范围：(67,51)–(182,196)；跨度116 × 146 px；痕迹矩形高于宽。
