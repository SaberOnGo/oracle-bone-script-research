# Material Visual Observation / obs-comp-cand-000997 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000997`
- External reference / 外部参照: `obimd-sub-siyjqf2nk4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014430_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/q71z8tnnc6/siyjqf2nk4/4rgxkwos89.png`
- Checksum / 校验和:
  `1a9f5e048bff049ebd99884b21ff03c7125a2d61830ac949d8bfba3aca10447d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.09%.
- Marked-pixel bounds: (75,41)–(174,208); span 100 × 168 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.09%。
- 痕迹范围：(75,41)–(174,208)；跨度100 × 168 px；痕迹矩形高于宽。
