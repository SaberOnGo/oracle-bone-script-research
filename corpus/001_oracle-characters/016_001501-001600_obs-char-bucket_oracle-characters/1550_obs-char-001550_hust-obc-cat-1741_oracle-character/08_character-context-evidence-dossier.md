...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1741`
...
- Source image / 来源图: `X_1741_4717_2.png`
- Image / 图像: `001_asset-001555_hust-obc-cat-1741_glyph.png`
...
- target node: `obimd-main-cand-002692`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- target node: `evobc-evo-cat-00154`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC image references / EvoBC 图像引用数: `76`
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/154_obs-evo-cand-000154_evobc-cat-00154_evoluti
...
- Matched OBIMD main UIDs / OBIMD 主字 UID: `mm49eilaqb`
...
- Source label text / 来源标签文字: `㫃`
- Source label codepoint / 来源标签 codepoint: `U+3AC3`
