# obs-unk-004936 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/036_obs-unk-004936_h
  ust-obc-und-X-004936_oracle-character-candidate/03_visual-assets/001_asset
  -006529_hust-obc-und-X-004936_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/492/X_？_7476_1.png`
- asset id: `asset-006529`
...
- A four-direction junction has rounded and angular end openings.
...
- source class: `HUST-OBC/undeciphered/X/492/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/492/X_？_7476_1.png`
- asset id: `asset-006529`
...
- Which source records identify obs-unk-004936 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004936？
