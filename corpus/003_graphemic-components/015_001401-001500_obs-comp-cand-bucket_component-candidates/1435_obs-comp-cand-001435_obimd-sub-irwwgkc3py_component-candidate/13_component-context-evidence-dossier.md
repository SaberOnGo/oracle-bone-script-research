# obs-comp-cand-001435 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001435`
- 首选外部 ID: `obimd-sub-irwwgkc3py`
- OBIMD subcharacter UID: `irwwgkc3py`
- OBIMD main character UID: `irwwgkc3py`
- 来源 ID: `src-obimd`
