...
- Project ID: `obs-evo-cand-003240`
- EVOBC category candidate ID: `evobc-evo-cat-03240`
- External category reference: `evobc-cat-03240`
- Source category ID: `03240`
- Source label for human review: `扇`
- Source codepoints: `U+6247`
...
- `obs-evo-cand-003240-route-category-staging`
...
- `obs-evo-cand-003240-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003240-route-evolution-graph`
