# Material Visual Observation / obs-comp-cand-002064 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002064`
- External reference / 外部参照: `obimd-sub-nclwec7ns3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019451_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/nclwec7ns3/nclwec7ns3/nclwec7ns3.png`
- Checksum / 校验和:
  `aeff350eb30424ec4497218760b17fd5b809f34b789f52f3e6dc14c9f34f9df3`
...
- Marked-pixel bounds: (71,19)–(190,231); span 120 × 213 px; the marked
...
- 痕迹范围：(71,19)–(190,231)；跨度120 × 213 px；痕迹矩形高于宽。
