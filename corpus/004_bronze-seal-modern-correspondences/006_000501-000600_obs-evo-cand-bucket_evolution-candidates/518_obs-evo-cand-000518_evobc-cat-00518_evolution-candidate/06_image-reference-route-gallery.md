...
- `obs-evo-cand-000518-route-category-staging`
...
- `obs-evo-cand-000518-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000518-route-evolution-graph`
