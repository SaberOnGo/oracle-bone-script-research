# Material Visual Observation / obs-comp-cand-000110 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000110`
- External reference / 外部参照: `obimd-sub-ej7sjt0cju`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011522_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xjnn5c8ctk/ej7sjt0cju/ej7sjt0cju.png`
- Checksum / 校验和:
  `476dd2a65319f9f52907057cfd59b376bd368180f09bf147906387e5bc06b6d7`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.63%.
- Marked-pixel bounds: (67,22)–(182,215); span 116 × 194 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.63%。
- 痕迹范围：(67,22)–(182,215)；跨度116 × 194 px；痕迹矩形高于宽。
