...
- Project ID: `obs-evo-cand-005397`
- EVOBC category candidate ID: `evobc-evo-cat-05397`
- External category reference: `evobc-cat-05397`
- Source category ID: `05397`
- Source label for human review: `琀`
- Source codepoints: `U+7400`
...
- `obs-evo-cand-005397-route-category-staging`
...
- `obs-evo-cand-005397-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005397-route-evolution-graph`
