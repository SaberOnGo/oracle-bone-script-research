...
- External category reference: `evobc-cat-06409`
- Source category ID: `06409`
- Source label for human review: `粵`
- Source codepoints: `U+7CB5`
...
- `obs-evo-cand-006409-route-category-staging`
...
- `obs-evo-cand-006409-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006409-route-evolution-graph`
