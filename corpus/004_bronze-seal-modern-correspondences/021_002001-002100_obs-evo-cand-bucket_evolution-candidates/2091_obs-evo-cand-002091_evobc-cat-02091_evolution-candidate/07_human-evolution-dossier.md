...
- External category reference: `evobc-cat-02091`
- Source category ID: `02091`
- Source label for human review: `妣`
- Source codepoints: `U+59A3`
...
- `obs-evo-cand-002091-route-category-staging`
...
- `obs-evo-cand-002091-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002091-route-evolution-graph`
