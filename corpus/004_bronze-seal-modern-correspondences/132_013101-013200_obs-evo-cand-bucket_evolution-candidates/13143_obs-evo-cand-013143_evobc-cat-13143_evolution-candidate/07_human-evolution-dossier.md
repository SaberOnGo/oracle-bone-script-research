...
- External category reference: `evobc-cat-13143`
- Source category ID: `13143`
- Source label: `𫹫`
...
- `obs-evo-cand-013143-route-category-staging`
...
- `obs-evo-cand-013143-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013143-route-evolution-graph`
