# obs-char-000659 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/659_obs-char-000659_hust-obc-cat-0747_orac
  le-character/03_visual-assets/001_asset-000664_hust-obc-cat-0747_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0747/G_0747_乙7705合2274賓組.png`
- asset id: `asset-000664`
...
- source category: `0747`
- validation class: `658`
- source image route: `HUST-OBC/deciphered/0747/G_0747_乙7705合2274賓組.png`
- asset id: `asset-000664`
...
- English observation: `A left upper outline with several horizontal inner
  bars divides into pointed lower branches; a detached thin right vertical
  ends in two short diagonal strokes.`
...
- dataset label text: `㛡`
- dataset label codepoints: `U+36E1`
...
- filename catalog route clues: `Heji-like filename clue: 合2274
  (G_0747_乙7705合2274賓組.png)`
...
- Which source records identify obs-char-000659 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000659？
