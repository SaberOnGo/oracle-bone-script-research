...
- `obs-evo-cand-005477-route-category-staging`
...
- `obs-evo-cand-005477-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005477-route-evolution-graph`
