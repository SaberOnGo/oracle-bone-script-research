# obs-char-001062 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1062_obs-char-001062_hust-obc-cat-1189_ora
  cle-character/03_visual-assets/001_asset-001067_hust-obc-cat-1189_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1189/G_1189_乙3212合13505賓組.png`
- asset id: `asset-001067`
...
- source category: `1189`
- validation class: `1061`
- source image route: `HUST-OBC/deciphered/1189/G_1189_乙3212合13505賓組.png`
- asset id: `asset-001067`
...
- English observation: `Two adjacent narrow forms are visible, with
  branching upper strokes and separate long lower curves on the right.`
- 中文观察: `可见两个相邻的狭长形体，均有上部分枝笔，右侧另有分离的长下部弯笔。`
...
- dataset label text: `㢛`
- dataset label codepoints: `U+389B`
...
- filename catalog route clues: `Heji-like filename clue: 合13505
...
- Which source records identify obs-char-001062 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001062？
