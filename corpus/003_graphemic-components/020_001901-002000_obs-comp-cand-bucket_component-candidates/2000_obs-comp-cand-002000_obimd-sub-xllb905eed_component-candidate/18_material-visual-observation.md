# Material Visual Observation / obs-comp-cand-002000 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002000`
- External reference / 外部参照: `obimd-sub-xllb905eed`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019220_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xllb905eed/xllb905eed/xllb905eed.png`
- Checksum / 校验和:
  `c687223c36c7f08666b5163c6112daafe9a4520ad586c54570c957714b11c423`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.41%.
- Marked-pixel bounds: (57,31)–(197,214); span 141 × 184 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.41%。
- 痕迹范围：(57,31)–(197,214)；跨度141 × 184 px；痕迹矩形高于宽。
