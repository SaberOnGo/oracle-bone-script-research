# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000599
...
- EVOBC candidate category: `evobc-evo-cat-00599`.
- Source label for search only: `䶬`.
- Source codepoints for search only: `U+4DAC`.
