# obs-unk-005067 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/067_undeciphered-005
  001-005100_obs-unk-bucket_oracle-character-candidates/067_obs-unk-005067_h
  ust-obc-und-X-005067_oracle-character-candidate/03_visual-assets/001_asset
  -006660_hust-obc-und-X-005067_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/623/X_？_7595_1.png`
- asset id: `asset-006660`
...
- source class: `HUST-OBC/undeciphered/X/623/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/623/X_？_7595_1.png`
- asset id: `asset-006660`
...
- Which source records identify obs-unk-005067 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005067？
