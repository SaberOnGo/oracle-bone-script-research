...
- External category reference: `evobc-cat-00504`
- Source category ID: `00504`
- Source label for human review: `䣸`
- Source codepoints: `U+48F8`
...
- `obs-evo-cand-000504-route-category-staging`
...
- `obs-evo-cand-000504-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000504-route-evolution-graph`
