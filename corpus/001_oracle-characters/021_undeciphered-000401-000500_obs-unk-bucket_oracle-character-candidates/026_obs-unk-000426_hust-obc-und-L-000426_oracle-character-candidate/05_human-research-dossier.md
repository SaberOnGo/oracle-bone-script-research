# obs-unk-000426 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/021_undeciphered-000
  401-000500_obs-unk-bucket_oracle-character-candidates/026_obs-unk-000426_h
  ust-obc-und-L-000426_oracle-character-candidate/03_visual-assets/001_asset
  -002019_hust-obc-und-L-000426_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/426/L_？_1134.jpg`
- asset id: `asset-002019`
...
- source class: `HUST-OBC/undeciphered/L/426/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/426/L_？_1134.jpg`
- asset id: `asset-002019`
...
- Which source records identify obs-unk-000426 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000426？
