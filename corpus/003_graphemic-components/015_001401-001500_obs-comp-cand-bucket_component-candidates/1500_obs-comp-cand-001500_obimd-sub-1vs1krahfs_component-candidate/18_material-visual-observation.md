# Material Visual Observation / obs-comp-cand-001500 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001500`
- External reference / 外部参照: `obimd-sub-1vs1krahfs`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016245_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1vs1krahfs/1vs1krahfs/1vs1krahfs.png`
- Checksum / 校验和:
  `f2f29b48d654ad8f19bae35cb94785186bdd27871e041a617e78d8b11b77de16`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.91%.
- Marked-pixel bounds: (66,27)–(192,220); span 127 × 194 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.91%。
- 痕迹范围：(66,27)–(192,220)；跨度127 × 194 px；痕迹矩形高于宽。
