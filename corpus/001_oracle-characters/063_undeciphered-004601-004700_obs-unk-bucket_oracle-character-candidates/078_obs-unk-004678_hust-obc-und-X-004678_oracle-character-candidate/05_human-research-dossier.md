# obs-unk-004678 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/078_obs-unk-004678_h
  ust-obc-und-X-004678_oracle-character-candidate/03_visual-assets/001_asset
  -006271_hust-obc-und-X-004678_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/234/X_？_8403_1.png`
- asset id: `asset-006271`
...
- source class: `HUST-OBC/undeciphered/X/234/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/234/X_？_8403_1.png`
- asset id: `asset-006271`
...
- English observation: `leaning tall form with rounded opening and lower forks`
- 中文观察: `带圆钝开口和下部分叉的倾斜高形笔画`
...
- Which source records identify obs-unk-004678 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004678？
