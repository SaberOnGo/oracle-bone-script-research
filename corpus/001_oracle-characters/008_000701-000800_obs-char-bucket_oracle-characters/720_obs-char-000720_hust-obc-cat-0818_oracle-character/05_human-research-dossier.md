# obs-char-000720 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/720_obs-char-000720_hust-obc-cat-0818_orac
  le-character/03_visual-assets/001_asset-000725_hust-obc-cat-0818_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0818/H_0818_6009A_0.png`
- asset id: `asset-000725`
...
- source category: `0818`
- validation class: `719`
- source image route: `HUST-OBC/deciphered/0818/H_0818_6009A_0.png`
- asset id: `asset-000725`
...
- English observation: `Two detached bold upper loops occupy different
  heights; the lower-left loop continues into a branching angular junction
  and a long wavering vertical tail.`
...
- dataset label text: `㜨`
- dataset label codepoints: `U+3728`
...
- filename catalog route clues: `catalog-like filename clue: H_0818
  (H_0818_6009A_0.png)`
...
- Which source records identify obs-char-000720 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000720？
