# Material Visual Observation / obs-comp-cand-002205 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002205`
- External reference / 外部参照: `obimd-sub-71tuhk6cfy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019989_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/55qv0winah/71tuhk6cfy/71tuhk6cfy.png`
- Checksum / 校验和:
  `cc1cd0e14657e7b6e4c28e1b9eab2da769fbd37fc3f752b0e8a92396c850aaeb`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.43%.
- Marked-pixel bounds: (59,60)–(190,185); span 132 × 126 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.43%。
- 痕迹范围：(59,60)–(190,185)；跨度132 × 126 px；痕迹矩形近方形。
