# obs-unk-004623 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/023_obs-unk-004623_h
  ust-obc-und-X-004623_oracle-character-candidate/03_visual-assets/001_asset
  -006216_hust-obc-und-X-004623_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/179/X_？_8354_1.png`
- asset id: `asset-006216`
...
- source class: `HUST-OBC/undeciphered/X/179/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/179/X_？_8354_1.png`
- asset id: `asset-006216`
...
- English observation: `upper contour, diagonal trace, two openings`
- 中文观察: `上部轮廓、斜向痕和两个内部开口已记录。`
...
- Which source records identify obs-unk-004623 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004623？
