...
Project ID: `obs-evo-cand-005492`
...
- Project ID: `obs-evo-cand-005492`
- EVOBC category candidate ID: `evobc-evo-cat-05492`
- External category reference: `evobc-cat-05492`
- Source category ID: `05492`
- Source label for human review: `瓅`
- Source codepoints: `U+74C5`
...
- `obs-evo-cand-005492-route-category-staging`
...
- `obs-evo-cand-005492-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005492-route-evolution-graph`
