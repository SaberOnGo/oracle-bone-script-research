...
Project ID: `obs-insc-cw-cand-000374`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000374`
...
- Source page section: `Period II Group 17` /
  `第 II 期第 17 组`
- Source section key: `period-ii-group-17`
- Section declared count: `36`
- Section observed row count: `36`
...
- Yingguo / 英国所藏: `y2119` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `145` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `466` in source row; primary catalog entry pending
- Heji / 合集: `40363` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000374`
