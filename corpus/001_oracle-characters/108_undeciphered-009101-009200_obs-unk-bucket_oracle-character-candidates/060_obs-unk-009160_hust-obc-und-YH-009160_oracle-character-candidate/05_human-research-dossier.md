# obs-unk-009160 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/108_undeciphered-009
  101-009200_obs-unk-bucket_oracle-character-candidates/060_obs-unk-009160_h
  ust-obc-und-YH-009160_oracle-character-candidate/03_visual-assets/001_asse
  t-010751_hust-obc-und-YH-009160_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/612BC/H_？_612BC_0.png`
- asset id: `asset-010751`
...
- source class: `HUST-OBC/undeciphered/Y+H/612BC/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/612BC/H_？_612BC_0.png`
- asset id: `asset-010751`
...
- Which source records identify obs-unk-009160 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009160？
