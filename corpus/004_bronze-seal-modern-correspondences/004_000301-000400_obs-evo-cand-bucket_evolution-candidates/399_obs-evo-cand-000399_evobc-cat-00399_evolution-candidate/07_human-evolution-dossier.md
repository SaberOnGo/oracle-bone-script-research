...
- External category reference: `evobc-cat-00399`
- Source category ID: `00399`
- Source label for human review: `䖧`
- Source codepoints: `U+45A7`
...
- `obs-evo-cand-000399-route-category-staging`
...
- `obs-evo-cand-000399-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000399-route-evolution-graph`
