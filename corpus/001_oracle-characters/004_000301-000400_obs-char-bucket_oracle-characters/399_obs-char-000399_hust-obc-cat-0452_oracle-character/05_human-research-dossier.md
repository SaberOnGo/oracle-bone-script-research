# obs-char-000399 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/399_obs-char-000399_hust-obc-cat-0452_orac
  le-character/03_visual-assets/001_asset-000404_hust-obc-cat-0452_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0452/G_0452_寧滬1.94(甲).png`
- asset id: `asset-000404`
...
- source category: `0452`
- validation class: `398`
- source image route: `HUST-OBC/deciphered/0452/G_0452_寧滬1.94(甲).png`
- asset id: `asset-000404`
...
- English observation: `A thin central crossing is joined to an open pointed
  upper mark, a long right-side stroke, and irregular lower curves.`
- 中文观察: `纤细中央交叉连接开放尖状上部痕迹、长右侧笔画和不规则下部曲线。`
...
- dataset label text: `㖺`
- dataset label codepoints: `U+35BA`
...
- Which source records identify obs-char-000399 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000399？
