...
- External category reference: `evobc-cat-03967`
- Source category ID: `03967`
- Source label for human review: `柤`
...
- `obs-evo-cand-003967-route-category-staging`
...
- `obs-evo-cand-003967-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003967-route-evolution-graph`
