...
- Project ID: `obs-evo-cand-000859`
- EVOBC category candidate ID: `evobc-evo-cat-00859`
- External category reference: `evobc-cat-00859`
- Source category ID: `00859`
- Source label for human review: `侧`
- Source codepoints: `U+4FA7`
...
- `obs-evo-cand-000859-route-category-staging`
...
- `obs-evo-cand-000859-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000859-route-evolution-graph`
