...
- `obs-evo-cand-008696-route-category-staging`
...
- `obs-evo-cand-008696-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008696-route-evolution-graph`
