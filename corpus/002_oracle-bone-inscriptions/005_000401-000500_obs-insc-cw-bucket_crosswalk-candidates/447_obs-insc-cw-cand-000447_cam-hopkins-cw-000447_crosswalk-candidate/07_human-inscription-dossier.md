...
Project ID: `obs-insc-cw-cand-000447`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000447`
...
- Source page section: `Period III Group 10` /
  `第 III 期第 10 组`
- Source section key: `period-iii-group-10`
- Section declared count: `17`
- Section observed row count: `17`
...
- Yingguo / 英国所藏: `y2312` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `330` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `192` in source row; primary catalog entry pending
- Heji / 合集: `41366` in source row; primary catalog entry pending
...
- Findspot / 出土地: 待查: excavation or findspot evidence for the physical
  object
- Period / 时期: `III` from source metadata; not a new dating
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000447`
