# obs-evo-cand-001250 / EVOBC evolution-category candidate
...
- EVOBC category candidate ID: `evobc-evo-cat-01250`
- External category ref: `evobc-cat-01250`
- Source label: `劃`
- Source codepoints: `U+5283`
- Image reference count: `14`
- Era token counts: `SS:2;WSC:12`
- Source token counts: `Web:14`
