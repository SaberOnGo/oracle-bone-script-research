...
- Project ID: `obs-evo-cand-002250`
- EVOBC category candidate ID: `evobc-evo-cat-02250`
- External category reference: `evobc-cat-02250`
- Source category ID: `02250`
- Source label for human review: `媾`
- Source codepoints: `U+5ABE`
...
- `obs-evo-cand-002250-route-category-staging`
...
- `obs-evo-cand-002250-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002250-route-evolution-graph`
