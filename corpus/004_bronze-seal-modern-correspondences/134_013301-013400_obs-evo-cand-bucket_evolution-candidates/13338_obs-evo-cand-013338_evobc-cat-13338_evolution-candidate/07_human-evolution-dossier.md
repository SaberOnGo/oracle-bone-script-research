...
- External category reference: `evobc-cat-13338`
- Source category ID: `13338`
- Source label for human review: `𬢸`
- Source codepoints: `U+2C8B8`
...
- `obs-evo-cand-013338-route-category-staging`
...
- `obs-evo-cand-013338-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013338-route-evolution-graph`
