...
- External category reference: `evobc-cat-11714`
- Source category ID: `11714`
- Source label for human review: `𤸱`
- Source codepoints: `U+24E31`
...
- `obs-evo-cand-011714-route-category-staging`
...
- `obs-evo-cand-011714-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011714-route-evolution-graph`
