# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000588
...
- EVOBC candidate category: `evobc-evo-cat-00588`.
- Source label for search only: `䵬`.
- Source codepoints for search only: `U+4D6C`.
