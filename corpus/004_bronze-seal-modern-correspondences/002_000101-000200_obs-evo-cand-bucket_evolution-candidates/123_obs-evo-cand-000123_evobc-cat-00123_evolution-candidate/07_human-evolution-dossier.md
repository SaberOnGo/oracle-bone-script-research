...
- External category reference: `evobc-cat-00123`
- Source category ID: `00123`
- Source label for human review: `㥅`
- Source codepoints: `U+3945`
...
- `obs-evo-cand-000123-route-category-staging`
...
- `obs-evo-cand-000123-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000123-route-evolution-graph`
