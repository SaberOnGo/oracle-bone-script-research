...
- `obs-evo-cand-000208-route-category-staging`
...
- `obs-evo-cand-000208-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000208-route-evolution-graph`
