...
- `obs-evo-cand-003850-route-category-staging`
...
- `obs-evo-cand-003850-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003850-route-evolution-graph`
