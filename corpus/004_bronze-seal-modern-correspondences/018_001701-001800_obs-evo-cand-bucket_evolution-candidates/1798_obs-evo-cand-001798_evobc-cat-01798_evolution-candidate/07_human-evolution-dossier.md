...
- External category reference: `evobc-cat-01798`
- Source category ID: `01798`
- Source label for human review: `圷`
...
- `obs-evo-cand-001798-route-category-staging`
...
- `obs-evo-cand-001798-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001798-route-evolution-graph`
