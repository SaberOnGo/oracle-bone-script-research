...
- External category reference: `evobc-cat-07388`
- Source category ID: `07388`
...
- `obs-evo-cand-007388-route-category-staging`
...
- `obs-evo-cand-007388-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007388-route-evolution-graph`
