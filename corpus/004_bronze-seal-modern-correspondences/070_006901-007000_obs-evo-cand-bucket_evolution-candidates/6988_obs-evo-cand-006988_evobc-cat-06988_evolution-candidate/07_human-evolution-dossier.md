...
Project ID: `obs-evo-cand-006988`
...
- Project ID: `obs-evo-cand-006988`
- EVOBC category candidate ID: `evobc-evo-cat-06988`
- External category reference: `evobc-cat-06988`
- Source category ID: `06988`
- Source label for human review: `肝`
- Source codepoints: `U+809D`
...
- `obs-evo-cand-006988-route-category-staging`
...
- `obs-evo-cand-006988-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006988-route-evolution-graph`
