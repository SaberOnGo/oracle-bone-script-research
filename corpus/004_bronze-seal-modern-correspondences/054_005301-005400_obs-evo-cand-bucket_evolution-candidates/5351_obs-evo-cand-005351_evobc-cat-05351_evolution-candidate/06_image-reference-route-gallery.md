...
- `obs-evo-cand-005351-route-category-staging`
...
- `obs-evo-cand-005351-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005351-route-evolution-graph`
