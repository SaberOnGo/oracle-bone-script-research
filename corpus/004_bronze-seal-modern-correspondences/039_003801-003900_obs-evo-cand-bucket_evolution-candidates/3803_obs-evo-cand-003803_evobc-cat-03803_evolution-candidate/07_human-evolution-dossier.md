...
- External category reference: `evobc-cat-03803`
- Source category ID: `03803`
- Source label for human review: `曠`
- Source codepoints: `U+66E0`
...
- `obs-evo-cand-003803-route-category-staging`
...
- `obs-evo-cand-003803-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003803-route-evolution-graph`
