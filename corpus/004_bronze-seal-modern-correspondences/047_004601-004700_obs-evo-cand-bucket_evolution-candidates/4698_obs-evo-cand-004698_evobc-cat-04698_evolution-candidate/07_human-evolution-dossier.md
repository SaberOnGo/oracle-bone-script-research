...
- External category reference: `evobc-cat-04698`
- Source category ID: `04698`
- Source label: `涷`
...
- `obs-evo-cand-004698-route-category-staging`
...
- `obs-evo-cand-004698-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004698-route-evolution-graph`
