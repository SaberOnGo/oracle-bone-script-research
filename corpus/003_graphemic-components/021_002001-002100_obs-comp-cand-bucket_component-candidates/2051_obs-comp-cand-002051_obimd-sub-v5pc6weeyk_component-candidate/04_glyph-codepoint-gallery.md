# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002051
...
| --- | --- | --- | --- |
| `obimd-glyph-link-031555` | 󻳁 | `U+FBCC1` | `reviewed_metadata_only` |
| `obimd-glyph-link-031556` | 󻳂 | `U+FBCC2` | `reviewed_metadata_only` |
