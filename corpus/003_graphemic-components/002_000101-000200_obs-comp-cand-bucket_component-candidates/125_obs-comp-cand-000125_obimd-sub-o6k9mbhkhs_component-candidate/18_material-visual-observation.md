# Material Visual Observation / obs-comp-cand-000125 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000125`
- External reference / 外部参照: `obimd-sub-o6k9mbhkhs`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011537_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qmve1owxof/o6k9mbhkhs/o6k9mbhkhs.png`
- Checksum / 校验和:
  `1ca977b409f132d7a178f5bad0ed7ce309e3958feabd05c3707ad7963a32f69c`
...
- Marked-pixel bounds: (78,23)–(152,233); span 75 × 211 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.57%。
- 痕迹范围：(78,23)–(152,233)；跨度75 × 211 px；痕迹矩形高于宽。
