...
| Catalog or accession route | 49-14-7A; source-page route only | 02_collection-source-index.csv; 06_human-collection-dossier.md |
| Image or visual route | no_committed_visual_asset; open gallery before visual use | 03_visual-asset-index.csv; 04_visual-gallery.md |
| Findspot or provenience | Anyang | 06_human-collection-dossier.md; 08_collection-provenance-evidence-dossier.md |
| Period or date | Shang Dynasty | 06_human-collection-dossier.md; 08_collection-provenance-evidence-dossier.md |
...
| Source and rights trail | src-penn-museum-oracle-bone; rights metadata_only_until_verified | 02_collection-source-index.csv; 09_collection-provenance-evidence-index.json |
