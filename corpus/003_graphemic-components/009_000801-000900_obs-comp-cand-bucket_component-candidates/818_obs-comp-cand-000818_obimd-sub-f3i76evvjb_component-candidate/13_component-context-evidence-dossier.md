# obs-comp-cand-000818 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000818`
- 首选外部 ID: `obimd-sub-f3i76evvjb`
- OBIMD subcharacter UID: `f3i76evvjb`
- OBIMD main character UID: `f3i76evvjb`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+F49FB; U+F49FC; 另有 3 项
