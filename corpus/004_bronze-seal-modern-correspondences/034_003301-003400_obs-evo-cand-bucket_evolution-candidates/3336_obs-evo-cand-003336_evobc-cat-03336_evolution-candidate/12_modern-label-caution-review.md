# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003336
...
- EVOBC candidate category: `evobc-evo-cat-03336`.
- Source label for search only: `拿`.
- Source codepoints for search only: `U+62FF`.
