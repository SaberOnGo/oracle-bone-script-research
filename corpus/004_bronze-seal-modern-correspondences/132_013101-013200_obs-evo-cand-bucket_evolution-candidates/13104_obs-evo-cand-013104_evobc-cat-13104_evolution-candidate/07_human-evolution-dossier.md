...
- External category reference: `evobc-cat-13104`
- Source category ID: `13104`
- Source label for human review: `𫴈`
...
- `obs-evo-cand-013104-route-category-staging`
...
- `obs-evo-cand-013104-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013104-route-evolution-graph`
