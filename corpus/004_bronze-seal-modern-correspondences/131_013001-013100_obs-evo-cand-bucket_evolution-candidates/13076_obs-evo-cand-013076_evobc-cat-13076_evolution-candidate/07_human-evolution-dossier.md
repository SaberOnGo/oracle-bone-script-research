...
- Project ID: `obs-evo-cand-013076`
- EVOBC category candidate ID: `evobc-evo-cat-13076`
- External category reference: `evobc-cat-13076`
- Source category ID: `13076`
- Source label for human review: `𫱨`
- Source codepoints: `U+2BC68`
...
- `obs-evo-cand-013076-route-category-staging`
...
- `obs-evo-cand-013076-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013076-route-evolution-graph`
