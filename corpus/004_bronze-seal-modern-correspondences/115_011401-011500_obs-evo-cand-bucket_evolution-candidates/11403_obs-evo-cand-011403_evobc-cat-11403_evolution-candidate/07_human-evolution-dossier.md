...
Project ID: `obs-evo-cand-011403`
...
- Project ID: `obs-evo-cand-011403`
- EVOBC category candidate ID: `evobc-evo-cat-11403`
- External category reference: `evobc-cat-11403`
- Source category ID: `11403`
- Source label for human review: `𣇅`
- Source codepoints: `U+231C5`
...
- `obs-evo-cand-011403-route-category-staging`
...
- `obs-evo-cand-011403-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011403-route-evolution-graph`
