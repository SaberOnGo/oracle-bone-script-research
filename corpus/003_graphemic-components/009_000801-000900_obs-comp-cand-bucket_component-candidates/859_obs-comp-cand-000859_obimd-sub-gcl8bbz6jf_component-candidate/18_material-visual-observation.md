# Material Visual Observation / obs-comp-cand-000859 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000859`
- External reference / 外部参照: `obimd-sub-gcl8bbz6jf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013857_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gcl8bbz6jf/gcl8bbz6jf/gcl8bbz6jf.png`
- Checksum / 校验和:
  `9556fdbf2c26a7d72c455eba37b17c566cd574d2b8260f9f87ea0994c445bd85`
...
- Marked-pixel bounds: (79,23)–(192,225); span 114 × 203 px; the marked
...
- 痕迹范围：(79,23)–(192,225)；跨度114 × 203 px；痕迹矩形高于宽。
