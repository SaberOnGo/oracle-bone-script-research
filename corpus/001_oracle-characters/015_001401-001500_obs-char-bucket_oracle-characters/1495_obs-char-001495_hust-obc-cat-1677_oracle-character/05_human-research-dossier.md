# obs-char-001495 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1495_obs-char-001495_hust-obc-cat-1677_ora
  cle-character/03_visual-assets/001_asset-001500_hust-obc-cat-1677_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1677/G_1677_乙1405合1899賓組.png`
- asset id: `asset-001500`
...
- source category: `1677`
- validation class: `1494`
- source image route: `HUST-OBC/deciphered/1677/G_1677_乙1405合1899賓組.png`
- asset id: `asset-001500`
...
- English observation: `A tall slanted contour has an upper bar, a small
  loop, and a pointed end.`
...
- dataset label text: `㪃`
- dataset label codepoints: `U+3A83`
...
- filename catalog route clues: `Heji-like filename clue: 合1899
  (G_1677_乙1405合1899賓組.png)`
...
- Which source records identify obs-char-001495 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001495？
