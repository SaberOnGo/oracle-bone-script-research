...
- External category reference: `evobc-cat-10910`
- Source category ID: `10910`
- Source label for human review: `𠪳`
...
- `obs-evo-cand-010910-route-category-staging`
...
- `obs-evo-cand-010910-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010910-route-evolution-graph`
