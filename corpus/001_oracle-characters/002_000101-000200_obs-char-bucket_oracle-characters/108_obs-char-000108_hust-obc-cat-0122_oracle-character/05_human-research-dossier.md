# obs-char-000108 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000108`
- primary external id: `hust-obc-cat-0122`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/108_obs-char-000108_hust-obc-cat-0122_orac
  le-character/03_visual-assets/001_asset-000113_hust-obc-cat-0122_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0122/G_0122_乙3330反合17494反.png`
- asset id: `asset-000113`
...
- source category: `0122`
- validation class: `107`
- source image route: `HUST-OBC/deciphered/0122/G_0122_乙3330反合17494反.png`
- asset id: `asset-000113`
...
- English observation: `The compact image has a central vertical stroke
  crossed by a horizontal stroke, with short angled side projections.`
- 中文观察: `小型图像有中央竖笔与横笔交叉，两侧带有短而倾斜的伸出笔画。`
...
- dataset label text: `㑰`
- dataset label codepoints: `U+3470`
...
- filename catalog route clues: `Heji-like filename clue: 合17494
  (G_0122_乙3330反合17494反.png)`
...
- Which source records identify obs-char-000108 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000108？
