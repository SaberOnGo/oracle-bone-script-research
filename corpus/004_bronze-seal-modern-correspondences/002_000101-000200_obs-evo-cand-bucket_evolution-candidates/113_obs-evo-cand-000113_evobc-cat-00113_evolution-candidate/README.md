# obs-evo-cand-000113 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-00113`
- Source label: `㤅`
- Source codepoints: `U+3905`
- Image reference count: `26`
- Era token counts: `WSC:26`
- Source token counts: `Book:26`
