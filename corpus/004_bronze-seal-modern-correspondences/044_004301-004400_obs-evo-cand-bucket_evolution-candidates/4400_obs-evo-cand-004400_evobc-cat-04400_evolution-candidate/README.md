# obs-evo-cand-004400 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-04400`
- Source label for human review: `歺`
- Source codepoints: `U+6B7A`
- Image reference count: `51`
- Era token counts: `OBC:51`
