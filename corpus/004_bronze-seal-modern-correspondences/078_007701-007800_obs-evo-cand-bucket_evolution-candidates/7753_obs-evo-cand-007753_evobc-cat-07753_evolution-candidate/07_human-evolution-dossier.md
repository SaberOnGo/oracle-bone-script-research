...
Project ID: `obs-evo-cand-007753`
...
- Project ID: `obs-evo-cand-007753`
- EVOBC category candidate ID: `evobc-evo-cat-07753`
- External category reference: `evobc-cat-07753`
- Source category ID: `07753`
- Source label for human review: `蛢`
- Source codepoints: `U+86E2`
...
- `obs-evo-cand-007753-route-category-staging`
...
- `obs-evo-cand-007753-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007753-route-evolution-graph`
