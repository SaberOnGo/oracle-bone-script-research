...
Project ID: `obs-evo-cand-013184`
...
- Project ID: `obs-evo-cand-013184`
- EVOBC category candidate ID: `evobc-evo-cat-13184`
- External category reference: `evobc-cat-13184`
- Source category ID: `13184`
- Source label for human review: `𬀏`
- Source codepoints: `U+2C00F`
...
- `obs-evo-cand-013184-route-category-staging`
...
- `obs-evo-cand-013184-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013184-route-evolution-graph`
