# obs-xwalk-cand-001265 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+397C` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-1414` | not reading |
