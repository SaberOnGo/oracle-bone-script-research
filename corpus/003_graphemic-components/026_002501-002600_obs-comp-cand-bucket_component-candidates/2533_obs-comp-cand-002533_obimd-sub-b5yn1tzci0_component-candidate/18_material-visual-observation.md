# Material Visual Observation / obs-comp-cand-002533 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002533`
- External reference / 外部参照: `obimd-sub-b5yn1tzci0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021052_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/b5yn1tzci0/b5yn1tzci0/b5yn1tzci0.png`
- Checksum / 校验和:
  `7fa6abc66ab9920718bb271126ef47d3f2fbc7bf0001b713e71fbc903b9e7c6d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.29%.
- Marked-pixel bounds: (67,47)–(182,198); span 116 × 152 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.29%。
- 痕迹范围：(67,47)–(182,198)；跨度116 × 152 px；痕迹矩形高于宽。
