...
- External category reference: `evobc-cat-03419`
- Source category ID: `03419`
- Source label for human review: `揂`
...
- `obs-evo-cand-003419-route-category-staging`
...
- `obs-evo-cand-003419-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003419-route-evolution-graph`
