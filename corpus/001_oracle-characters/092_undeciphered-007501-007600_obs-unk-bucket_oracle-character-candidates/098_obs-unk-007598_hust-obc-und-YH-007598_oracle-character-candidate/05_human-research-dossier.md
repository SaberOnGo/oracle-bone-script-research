# obs-unk-007598 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-007598`
- primary external id: `hust-obc-und-YH-007598`
...
- local review image route: `corpus/001_oracle-characters/092_undeciphered-007
  501-007600_obs-unk-bucket_oracle-character-candidates/098_obs-unk-007598_h
  ust-obc-und-YH-007598_oracle-character-candidate/03_visual-assets/001_asse
  t-009189_hust-obc-und-YH-007598_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6010C/H_？_6010C_0.png`
- asset id: `asset-009189`
...
- source class: `HUST-OBC/undeciphered/Y+H/6010C/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6010C/H_？_6010C_0.png`
- asset id: `asset-009189`
...
- Which source records identify obs-unk-007598 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007598？
