...
- Project ID: `obs-evo-cand-012763`
- EVOBC category candidate ID: `evobc-evo-cat-12763`
- External category reference: `evobc-cat-12763`
- Source category ID: `12763`
- Source label for human review: `𪒻`
- Source codepoints: `U+2A4BB`
...
- `obs-evo-cand-012763-route-category-staging`
...
- `obs-evo-cand-012763-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012763-route-evolution-graph`
