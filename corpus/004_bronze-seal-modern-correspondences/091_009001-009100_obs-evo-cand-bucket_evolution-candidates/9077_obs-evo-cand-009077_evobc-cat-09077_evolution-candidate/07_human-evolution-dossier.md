...
- External category reference: `evobc-cat-09077`
- Source category ID: `09077`
- Source label for human review: `邊`
- Source codepoints: `U+908A`
...
- `obs-evo-cand-009077-route-category-staging`
...
- `obs-evo-cand-009077-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009077-route-evolution-graph`
