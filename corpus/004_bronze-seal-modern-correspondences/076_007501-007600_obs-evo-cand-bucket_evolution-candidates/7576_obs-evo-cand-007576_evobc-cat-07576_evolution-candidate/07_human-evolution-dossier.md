...
- External category reference: `evobc-cat-07576`
- Source category ID: `07576`
- Source label for human review: `蕅`
- Source codepoints: `U+8545`
...
- `obs-evo-cand-007576-route-category-staging`
...
- `obs-evo-cand-007576-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007576-route-evolution-graph`
