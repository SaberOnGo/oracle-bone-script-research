...
- `obs-evo-cand-009245-route-category-staging`
...
- `obs-evo-cand-009245-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009245-route-evolution-graph`
