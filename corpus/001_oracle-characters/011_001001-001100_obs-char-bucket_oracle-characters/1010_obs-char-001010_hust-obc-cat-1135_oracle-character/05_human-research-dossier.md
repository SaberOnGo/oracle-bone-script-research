# obs-char-001010 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001010`
- primary external id: `hust-obc-cat-1135`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1010_obs-char-001010_hust-obc-cat-1135_ora
  cle-character/03_visual-assets/001_asset-001015_hust-obc-cat-1135_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1135/G_1135_乙3853合3521賓組.png`
- asset id: `asset-001015`
...
- source category: `1135`
- validation class: `1009`
- source image route: `HUST-OBC/deciphered/1135/G_1135_乙3853合3521賓組.png`
- asset id: `asset-001015`
...
- English observation: `A narrow symmetrical contour has pointed upper
  branches, crossed central strokes, and a lower converging point.`
...
- dataset label text: `㡥`
- dataset label codepoints: `U+3865`
...
- filename catalog route clues: `Heji-like filename clue: 合3521
  (G_1135_乙3853合3521賓組.png)`
...
- Which source records identify obs-char-001010 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001010？
