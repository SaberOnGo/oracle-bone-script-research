# Material Visual Observation / obs-comp-cand-000066 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000066`
- External reference / 外部参照: `obimd-sub-1ttzl6vlzs`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011479_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1ttzl6vlzs/1ttzl6vlzs/1ttzl6vlzs.png`
- Checksum / 校验和:
  `9e032d51323f7e1caf23376cbf6d28ee1103bae13fd8194f5158241d367e07b2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.51%.
- Marked-pixel bounds: (85,21)–(163,226); span 79 × 206 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.51%。
- 痕迹范围：(85,21)–(163,226)；跨度79 × 206 px；痕迹矩形高于宽。
