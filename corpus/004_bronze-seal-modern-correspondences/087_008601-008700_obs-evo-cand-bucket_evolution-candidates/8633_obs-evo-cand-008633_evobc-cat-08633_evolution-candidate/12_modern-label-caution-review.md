# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008633
...
- EVOBC candidate category: `evobc-evo-cat-08633`.
- Source label for search only: `贸`.
- Source codepoints for search only: `U+8D38`.
