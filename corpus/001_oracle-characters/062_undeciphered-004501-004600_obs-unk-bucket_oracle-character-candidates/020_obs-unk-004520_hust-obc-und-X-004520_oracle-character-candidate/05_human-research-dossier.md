# obs-unk-004520 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004520`
- primary external id: `hust-obc-und-X-004520`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/020_obs-unk-004520_h
  ust-obc-und-X-004520_oracle-character-candidate/03_visual-assets/001_asset
  -006113_hust-obc-und-X-004520_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/76/X_？_8260_1.png`
- asset id: `asset-006113`
...
- source class: `HUST-OBC/undeciphered/X/76/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/76/X_？_8260_1.png`
- asset id: `asset-006113`
...
- English observation: `The separate left trace, central crossing, right upper
  extension, and lower taper are directly recorded.`
- 中文观察: `已直接记录左侧分离长痕、中部交叉、右侧上伸和下部收窄。`
...
- Which source records identify obs-unk-004520 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004520？
