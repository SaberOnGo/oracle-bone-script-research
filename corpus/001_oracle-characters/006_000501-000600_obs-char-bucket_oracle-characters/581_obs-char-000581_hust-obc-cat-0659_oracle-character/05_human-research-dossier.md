# obs-char-000581 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000581`
- primary external id: `hust-obc-cat-0659`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/581_obs-char-000581_hust-obc-cat-0659_orac
  le-character/03_visual-assets/001_asset-000586_hust-obc-cat-0659_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0659/G_0659_乙189合19772𠂤組.png`
- asset id: `asset-000586`
...
- source category: `0659`
- validation class: `580`
- source image route: `HUST-OBC/deciphered/0659/G_0659_乙189合19772𠂤組.png`
- asset id: `asset-000586`
...
- English observation: `A thin central zigzag stem is crossed by several
  long diagonals and short side branches, with a small hooked extension near
  the lower left.`
- 中文观察: `纤细中央锯折干被数条长斜笔和短侧枝穿过，左下附近有小型钩状延伸。`
...
- dataset label text: `㚉`
- dataset label codepoints: `U+3689`
...
- filename catalog route clues: `Heji-like filename clue: 合19772
...
- Which source records identify obs-char-000581 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000581？
