...
- External category reference: `evobc-cat-10923`
- Source category ID: `10923`
...
- `obs-evo-cand-010923-route-category-staging`
...
- `obs-evo-cand-010923-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010923-route-evolution-graph`
