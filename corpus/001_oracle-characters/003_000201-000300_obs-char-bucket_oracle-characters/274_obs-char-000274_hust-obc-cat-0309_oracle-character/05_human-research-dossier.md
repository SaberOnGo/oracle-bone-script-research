# obs-char-000274 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/274_obs-char-000274_hust-obc-cat-0309_orac
  le-character/03_visual-assets/001_asset-000279_hust-obc-cat-0309_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0309/X_0309_1369_1.png`
- asset id: `asset-000279`
...
- source category: `0309`
- validation class: `273`
- source image route: `HUST-OBC/deciphered/0309/X_0309_1369_1.png`
- asset id: `asset-000279`
...
- English observation: `The tall dark image has a narrow irregular upper
  cluster, a long central stem, a rectangular middle block, and a flaring
  lower terminal.`
- 中文观察: `高而深色的图像有狭长不规则上部簇，中部有长笔干和矩形块状形体，下部向外展开收笔。`
...
- dataset label text: `㔫`
- dataset label codepoints: `U+352B`
...
- Which source records identify obs-char-000274 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000274？
