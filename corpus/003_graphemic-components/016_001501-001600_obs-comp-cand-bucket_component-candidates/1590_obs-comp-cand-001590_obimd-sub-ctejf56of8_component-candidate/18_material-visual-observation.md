# Material Visual Observation / obs-comp-cand-001590 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001590`
- External reference / 外部参照: `obimd-sub-ctejf56of8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017215_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ctejf56of8/ctejf56of8/0yd86t8rn6.png`
- Checksum / 校验和:
  `9bc364b29f48f30cd9c92399f0753e4c511e3e020253a307f4b8247bae84879a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.81%.
- Marked-pixel bounds: (81,38)–(168,205); span 88 × 168 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.81%。
- 痕迹范围：(81,38)–(168,205)；跨度88 × 168 px；痕迹矩形高于宽。
