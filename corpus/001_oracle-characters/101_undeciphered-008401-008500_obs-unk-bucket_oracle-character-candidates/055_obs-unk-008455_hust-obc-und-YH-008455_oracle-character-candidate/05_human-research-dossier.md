# obs-unk-008455 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008455`
- primary external id: `hust-obc-und-YH-008455`
...
- local review image route: `corpus/001_oracle-characters/101_undeciphered-008
  401-008500_obs-unk-bucket_oracle-character-candidates/055_obs-unk-008455_h
  ust-obc-und-YH-008455_oracle-character-candidate/03_visual-assets/001_asse
  t-010046_hust-obc-und-YH-008455_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60B18/H_？_60B18_0.png`
- asset id: `asset-010046`
...
- source class: `HUST-OBC/undeciphered/Y+H/60B18/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60B18/H_？_60B18_0.png`
- asset id: `asset-010046`
...
- Which source records identify obs-unk-008455 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008455？
