# obs-char-001112 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1112_obs-char-001112_hust-obc-cat-1243_ora
  cle-character/03_visual-assets/001_asset-001117_hust-obc-cat-1243_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1243/G_1243_乙3947反合10755反.png`
- asset id: `asset-001117`
...
- source category: `1243`
- validation class: `1111`
- source image route: `HUST-OBC/deciphered/1243/G_1243_乙3947反合10755反.png`
- asset id: `asset-001117`
...
- English observation: `A narrow vertical lattice has several diagonal
  crossings within an outer contour and a pointed lower extension.`
...
- dataset label text: `㣑`
- dataset label codepoints: `U+38D1`
...
- filename catalog route clues: `Heji-like filename clue: 合10755
  (G_1243_乙3947反合10755反.png)`
...
- Which source records identify obs-char-001112 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001112？
