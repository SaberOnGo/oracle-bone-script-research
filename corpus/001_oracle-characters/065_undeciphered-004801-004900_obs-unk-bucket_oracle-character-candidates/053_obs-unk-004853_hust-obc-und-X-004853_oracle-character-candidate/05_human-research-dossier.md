# obs-unk-004853 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004853`
- primary external id: `hust-obc-und-X-004853`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/053_obs-unk-004853_h
  ust-obc-und-X-004853_oracle-character-candidate/03_visual-assets/001_asset
  -006446_hust-obc-und-X-004853_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/409/X_？_7394_1.png`
- asset id: `asset-006446`
...
- source class: `HUST-OBC/undeciphered/X/409/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/409/X_？_7394_1.png`
- asset id: `asset-006446`
...
- English observation: `upper pointed outline and lower pale opening`
- 中文观察: `上部尖状围合和下部浅色开口`
...
- Which source records identify obs-unk-004853 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004853？
