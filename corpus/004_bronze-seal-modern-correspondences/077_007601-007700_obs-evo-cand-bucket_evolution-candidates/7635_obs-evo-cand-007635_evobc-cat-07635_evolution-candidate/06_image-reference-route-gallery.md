...
- `obs-evo-cand-007635-route-category-staging`
...
- `obs-evo-cand-007635-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007635-route-evolution-graph`
