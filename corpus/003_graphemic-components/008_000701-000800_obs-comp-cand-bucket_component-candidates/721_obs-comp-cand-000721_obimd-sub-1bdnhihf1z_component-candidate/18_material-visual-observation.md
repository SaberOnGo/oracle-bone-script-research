# Material Visual Observation / obs-comp-cand-000721 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000721`
- External reference / 外部参照: `obimd-sub-1bdnhihf1z`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013433_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1bdnhihf1z/1bdnhihf1z/1bdnhihf1z.png`
- Checksum / 校验和:
  `30b232cea7b386195ac15cc2ac5656ff27991f38d74442f9d7a63dd746587e94`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.18%.
- Marked-pixel bounds: (90,27)–(159,225); span 70 × 199 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.18%。
- 痕迹范围：(90,27)–(159,225)；跨度70 × 199 px；痕迹矩形高于宽。
