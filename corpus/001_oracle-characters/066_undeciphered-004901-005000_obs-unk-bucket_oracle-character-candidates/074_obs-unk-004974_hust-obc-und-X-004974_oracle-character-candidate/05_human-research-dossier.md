# obs-unk-004974 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/074_obs-unk-004974_h
  ust-obc-und-X-004974_oracle-character-candidate/03_visual-assets/001_asset
  -006567_hust-obc-und-X-004974_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/530/X_？_7510_1.png`
- asset id: `asset-006567`
...
- Two separated curved forms and a long right tapering stroke are visible.
...
- source class: `HUST-OBC/undeciphered/X/530/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/530/X_？_7510_1.png`
- asset id: `asset-006567`
...
- Which source records identify obs-unk-004974 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004974？
