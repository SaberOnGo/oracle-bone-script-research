...
- External category reference: `evobc-cat-05955`
- Source category ID: `05955`
- Source label for human review: `礓`
...
- `obs-evo-cand-005955-route-category-staging`
...
- `obs-evo-cand-005955-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005955-route-evolution-graph`
