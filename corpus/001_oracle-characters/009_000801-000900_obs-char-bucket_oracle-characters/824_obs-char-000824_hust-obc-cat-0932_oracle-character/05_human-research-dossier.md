# obs-char-000824 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000824`
- primary external id: `hust-obc-cat-0932`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/824_obs-char-000824_hust-obc-cat-0932_orac
  le-character/03_visual-assets/001_asset-000829_hust-obc-cat-0932_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0932/G_0932_甲159(甲).png`
- asset id: `asset-000829`
...
- source category: `0932`
- validation class: `823`
- source image route: `HUST-OBC/deciphered/0932/G_0932_甲159(甲).png`
- asset id: `asset-000829`
...
- English observation: `An upper rectangular enclosure sits beside angular
  strokes; below, a long diagonal descends from a central crossing.`
- 中文观察: `上部矩形闭合轮廓旁有折角笔画；下方从中央交叉处延伸出一条长斜笔。`
...
- dataset label text: `㞚`
- dataset label codepoints: `U+379A`
...
- Which source records identify obs-char-000824 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000824？
