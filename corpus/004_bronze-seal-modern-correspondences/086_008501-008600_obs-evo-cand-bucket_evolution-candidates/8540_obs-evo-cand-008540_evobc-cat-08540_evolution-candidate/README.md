# obs-evo-cand-008540 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-08540`
- Source label: `貧`
- Source codepoints: `U+8CA7`
- Image reference count: `34`
- Era token counts: `CS:1;SS:3;WSC:30`
- Source token counts: `Book:9;Web:25`
