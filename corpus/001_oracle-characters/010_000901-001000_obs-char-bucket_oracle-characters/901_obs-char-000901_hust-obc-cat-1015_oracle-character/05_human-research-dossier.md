# obs-char-000901 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000901`
- primary external id: `hust-obc-cat-1015`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/901_obs-char-000901_hust-obc-cat-1015_orac
  le-character/03_visual-assets/001_asset-000906_hust-obc-cat-1015_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1015/G_1015_京津3870合30168.png`
- asset id: `asset-000906`
...
- source category: `1015`
- validation class: `900`
- source image route: `HUST-OBC/deciphered/1015/G_1015_京津3870合30168.png`
- asset id: `asset-000906`
...
- English observation: `A narrow vertical form has a pointed upper loop, a
  central diamond-like enclosure, detached side marks, and lower branching
  strokes.`
- 中文观察: `狭长竖向形体有尖形上部环状笔、中央菱形近似闭合轮廓、分离侧痕迹和下部分枝笔。`
...
- dataset label text: `㟭`
- dataset label codepoints: `U+37ED`
...
- filename catalog route clues: `Heji-like filename clue: 合30168
  (G_1015_京津3870合30168.png)`
...
- Which source records identify obs-char-000901 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000901？
