# obs-char-000828 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/828_obs-char-000828_hust-obc-cat-0936_orac
  le-character/03_visual-assets/001_asset-000833_hust-obc-cat-0936_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0936/Y_0936_61351.jpg`
- asset id: `asset-000833`
...
- source category: `0936`
- validation class: `827`
- source image route: `HUST-OBC/deciphered/0936/Y_0936_61351.jpg`
- asset id: `asset-000833`
...
- English observation: `A bold left structure has broad horizontal
  crossings, a central stem, and two long lower diagonals; a separate jagged
  stroke stands at right.`
- 中文观察: `左侧粗重形体有宽横交叉笔、中央笔干和两条下部长斜笔；右侧另有一条锯齿状分离笔。`
...
- dataset label text: `㞞`
- dataset label codepoints: `U+379E`
...
- Which source records identify obs-char-000828 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000828？
