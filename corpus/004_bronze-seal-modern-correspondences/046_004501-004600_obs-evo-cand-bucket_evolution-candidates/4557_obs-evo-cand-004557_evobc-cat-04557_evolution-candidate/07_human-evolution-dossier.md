...
Project ID: `obs-evo-cand-004557`
...
- Project ID: `obs-evo-cand-004557`
- EVOBC category candidate ID: `evobc-evo-cat-04557`
- External category reference: `evobc-cat-04557`
- Source category ID: `04557`
- Source label for human review: `河`
- Source codepoints: `U+6CB3`
- Image reference count in source metadata: `213`
...
- `obs-evo-cand-004557-route-category-staging`
...
- `obs-evo-cand-004557-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004557-route-evolution-graph`
