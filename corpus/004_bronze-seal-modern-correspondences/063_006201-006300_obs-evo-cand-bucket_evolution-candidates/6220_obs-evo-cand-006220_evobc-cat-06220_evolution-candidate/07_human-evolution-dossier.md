...
- External category reference: `evobc-cat-06220`
- Source category ID: `06220`
- Source label for human review: `竺`
- Source codepoints: `U+7AFA`
...
- `obs-evo-cand-006220-route-category-staging`
...
- `obs-evo-cand-006220-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006220-route-evolution-graph`
