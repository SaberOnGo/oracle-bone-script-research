# obs-evo-cand-002164 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-02164`
- Source label for human review: `娕`
- Source codepoints: `U+5A15`
- Image reference count: `61`
- Era token counts: `OBC:59;SS:1;WSC:1`
- Source token counts: `Book:5;Web:56`
