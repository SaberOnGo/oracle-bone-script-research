...
Project ID: `obs-evo-cand-005603`
...
- Project ID: `obs-evo-cand-005603`
- EVOBC category candidate ID: `evobc-evo-cat-05603`
- External category reference: `evobc-cat-05603`
- Source category ID: `05603`
- Source label for human review: `疐`
- Source codepoints: `U+7590`
...
- `obs-evo-cand-005603-route-category-staging`
...
- `obs-evo-cand-005603-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005603-route-evolution-graph`
