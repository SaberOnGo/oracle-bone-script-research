# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006567
...
- EVOBC candidate category: `evobc-evo-cat-06567`.
- Source label for search only: `綼`.
- Source codepoints for search only: `U+7DBC`.
