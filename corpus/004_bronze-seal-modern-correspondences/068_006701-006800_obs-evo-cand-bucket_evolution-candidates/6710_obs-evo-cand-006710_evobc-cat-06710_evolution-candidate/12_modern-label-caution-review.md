# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006710
...
- EVOBC candidate category: `evobc-evo-cat-06710`.
- Source label for search only: `續`.
- Source codepoints for search only: `U+7E8C`.
