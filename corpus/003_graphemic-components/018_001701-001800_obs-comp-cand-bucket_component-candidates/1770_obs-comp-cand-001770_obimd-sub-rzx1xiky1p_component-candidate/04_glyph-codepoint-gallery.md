# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001770
...
| --- | --- | --- | --- |
| `obimd-glyph-link-027120` | 󺌐 | `U+FA310` | `reviewed_metadata_only` |
| `obimd-glyph-link-027121` | 󺌑 | `U+FA311` | `reviewed_metadata_only` |
| `obimd-glyph-link-027122` | 󺌓 | `U+FA313` | `reviewed_metadata_only` |
