...
- External category reference: `evobc-cat-03614`
- Source category ID: `03614`
- Source label for human review: `敻`
...
- `obs-evo-cand-003614-route-category-staging`
...
- `obs-evo-cand-003614-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003614-route-evolution-graph`
