...
Project ID: `obs-evo-cand-011377`
...
- Project ID: `obs-evo-cand-011377`
- EVOBC category candidate ID: `evobc-evo-cat-11377`
- External category reference: `evobc-cat-11377`
- Source category ID: `11377`
- Source label for human review: `𣂛`
- Source codepoints: `U+2309B`
...
- `obs-evo-cand-011377-route-category-staging`
...
- `obs-evo-cand-011377-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011377-route-evolution-graph`
