...
- External category reference: `evobc-cat-01409`
- Source category ID: `01409`
- Source label for human review: `厀`
...
- `obs-evo-cand-001409-route-category-staging`
...
- `obs-evo-cand-001409-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001409-route-evolution-graph`
