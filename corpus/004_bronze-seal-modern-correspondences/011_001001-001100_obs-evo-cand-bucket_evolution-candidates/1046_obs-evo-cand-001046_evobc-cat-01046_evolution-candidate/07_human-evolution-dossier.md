...
- External category reference: `evobc-cat-01046`
- Source category ID: `01046`
- Source label for human review: `儔`
- Source codepoints: `U+5114`
...
- `obs-evo-cand-001046-route-category-staging`
...
- `obs-evo-cand-001046-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001046-route-evolution-graph`
