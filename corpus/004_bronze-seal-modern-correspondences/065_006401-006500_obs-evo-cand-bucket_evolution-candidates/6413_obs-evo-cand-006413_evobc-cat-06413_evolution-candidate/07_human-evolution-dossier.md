...
- External category reference: `evobc-cat-06413`
- Source category ID: `06413`
- Source label for human review: `粼`
- Source codepoints: `U+7CBC`
...
- `obs-evo-cand-006413-route-category-staging`
...
- `obs-evo-cand-006413-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006413-route-evolution-graph`
