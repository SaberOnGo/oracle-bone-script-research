...
- `obs-evo-cand-012536-route-category-staging`
...
- `obs-evo-cand-012536-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012536-route-evolution-graph`
