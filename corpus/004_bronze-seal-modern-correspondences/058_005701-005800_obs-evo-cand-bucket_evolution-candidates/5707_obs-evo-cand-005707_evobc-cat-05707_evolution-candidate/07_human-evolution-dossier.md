...
Project ID: `obs-evo-cand-005707`
...
- Project ID: `obs-evo-cand-005707`
- EVOBC category candidate ID: `evobc-evo-cat-05707`
- External category reference: `evobc-cat-05707`
- Source category ID: `05707`
- Source label for human review: `癲`
- Source codepoints: `U+7672`
...
- `obs-evo-cand-005707-route-category-staging`
...
- `obs-evo-cand-005707-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005707-route-evolution-graph`
