...
- `obs-evo-cand-011382-route-category-staging`
...
- `obs-evo-cand-011382-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011382-route-evolution-graph`
