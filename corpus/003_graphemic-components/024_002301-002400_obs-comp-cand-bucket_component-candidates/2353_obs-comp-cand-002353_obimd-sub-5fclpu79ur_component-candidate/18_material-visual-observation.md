# Material Visual Observation / obs-comp-cand-002353 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002353`
- External reference / 外部参照: `obimd-sub-5fclpu79ur`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020424_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3c5c90zv36/5fclpu79ur/5fclpu79ur.png`
- Checksum / 校验和:
  `d5c46ec10310ecd964c0b8a6db29d8ff56f1ac08f91bc370dcf01f66d4d5df3f`
...
- Marked-pixel bounds: (76,15)–(198,224); span 123 × 210 px; the marked
...
- 痕迹范围：(76,15)–(198,224)；跨度123 × 210 px；痕迹矩形高于宽。
