# obs-unk-006455 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/081_undeciphered-006
  401-006500_obs-unk-bucket_oracle-character-candidates/055_obs-unk-006455_h
  ust-obc-und-X-006455_oracle-character-candidate/03_visual-assets/001_asset
  -008046_hust-obc-und-X-006455_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2011/X_？_5651_1.png`
- asset id: `asset-008046`
...
- source class: `HUST-OBC/undeciphered/X/2011/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2011/X_？_5651_1.png`
- asset id: `asset-008046`
...
- Which source records identify obs-unk-006455 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006455？
