# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000304
...
| Glyph or codepoint route / 字形或码位路线 | 97 OBIMD route rows; examples U+725B;U+F1BAC; U+F1BAD; 另有 95 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 97 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
