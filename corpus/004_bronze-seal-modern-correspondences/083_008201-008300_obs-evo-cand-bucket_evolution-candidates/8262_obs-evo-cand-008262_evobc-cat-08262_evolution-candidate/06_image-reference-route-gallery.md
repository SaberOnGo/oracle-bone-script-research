...
- `obs-evo-cand-008262-route-category-staging`
...
- `obs-evo-cand-008262-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008262-route-evolution-graph`
