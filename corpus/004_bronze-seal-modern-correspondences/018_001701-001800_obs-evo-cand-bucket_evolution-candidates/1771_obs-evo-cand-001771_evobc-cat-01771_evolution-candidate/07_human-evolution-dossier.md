...
- External category reference: `evobc-cat-01771`
- Source category ID: `01771`
- Source label for human review: `图`
- Source codepoints: `U+56FE`
...
- `obs-evo-cand-001771-route-category-staging`
...
- `obs-evo-cand-001771-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001771-route-evolution-graph`
