# obs-unk-004347 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004347`
- primary external id: `hust-obc-und-L-004347`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/047_obs-unk-004347_h
  ust-obc-und-L-004347_oracle-character-candidate/03_visual-assets/001_asset
  -005940_hust-obc-und-L-004347_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4347/L_？_9626.jpg`
- asset id: `asset-005940`
...
- source class: `HUST-OBC/undeciphered/L/4347/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4347/L_？_9626.jpg`
- asset id: `asset-005940`
...
- English observation: `Overlapping traces, left extension, and bent lower`
  `trace recorded.`
- 中文观察: `已记录交叠痕迹、左侧外伸和下部弯折痕迹。`
...
- Which source records identify obs-unk-004347 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004347？
