# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008614
...
- EVOBC candidate category: `evobc-evo-cat-08614`.
- Source label for search only: `负`.
- Source codepoints for search only: `U+8D1F`.
