# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006241
...
- EVOBC candidate category: `evobc-evo-cat-06241`.
- Source label for search only: `笫`.
- Source codepoints for search only: `U+7B2B`.
