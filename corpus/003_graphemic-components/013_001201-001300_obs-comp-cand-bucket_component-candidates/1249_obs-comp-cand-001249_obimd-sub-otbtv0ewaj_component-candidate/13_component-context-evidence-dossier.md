# obs-comp-cand-001249 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001249`
- 首选外部 ID: `obimd-sub-otbtv0ewaj`
- OBIMD subcharacter UID: `otbtv0ewaj`
- OBIMD main character UID: `otbtv0ewaj`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+AAFCD;U+F72FF; U+F7300; 另有 2 项
