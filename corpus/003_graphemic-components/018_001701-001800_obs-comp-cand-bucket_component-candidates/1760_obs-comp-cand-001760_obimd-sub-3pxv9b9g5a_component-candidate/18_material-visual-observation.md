# Material Visual Observation / obs-comp-cand-001760 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001760`
- External reference / 外部参照: `obimd-sub-3pxv9b9g5a`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017961_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cr5nhxdhbt/3pxv9b9g5a/3pxv9b9g5a.png`
- Checksum / 校验和:
  `c8b9c69edd09a3f9fe7d96636d75cfa4c0779e251ab0d898cd3ccc6b88bd0714`
...
- Marked-pixel bounds: (91,31)–(158,215); span 68 × 185 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.93%。
- 痕迹范围：(91,31)–(158,215)；跨度68 × 185 px；痕迹矩形高于宽。
