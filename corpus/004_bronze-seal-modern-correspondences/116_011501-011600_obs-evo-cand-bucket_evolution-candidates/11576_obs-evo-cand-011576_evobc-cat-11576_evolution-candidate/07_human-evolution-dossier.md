...
Project ID: `obs-evo-cand-011576`
...
- Project ID: `obs-evo-cand-011576`
- EVOBC category candidate ID: `evobc-evo-cat-11576`
- External category reference: `evobc-cat-11576`
- Source category ID: `11576`
- Source label for human review: `𤏼`
- Source codepoints: `U+243FC`
...
- `obs-evo-cand-011576-route-category-staging`
...
- `obs-evo-cand-011576-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011576-route-evolution-graph`
