...
Project ID: `obs-evo-cand-008963`
...
- Project ID: `obs-evo-cand-008963`
- EVOBC category candidate ID: `evobc-evo-cat-08963`
- External category reference: `evobc-cat-08963`
- Source category ID: `08963`
- Source label for human review: `迫`
- Source codepoints: `U+8FEB`
...
- `obs-evo-cand-008963-route-category-staging`
...
- `obs-evo-cand-008963-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008963-route-evolution-graph`
