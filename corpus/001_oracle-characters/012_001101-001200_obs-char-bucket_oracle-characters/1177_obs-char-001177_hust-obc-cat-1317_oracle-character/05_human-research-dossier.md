# obs-char-001177 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1177_obs-char-001177_hust-obc-cat-1317_ora
  cle-character/03_visual-assets/001_asset-001182_hust-obc-cat-1317_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1317/G_1317_乙6370合1107賓組.png`
- asset id: `asset-001182`
...
- source category: `1317`
- validation class: `1176`
- source image route: `HUST-OBC/deciphered/1317/G_1317_乙6370合1107賓組.png`
- asset id: `asset-001182`
...
- English observation: `A narrow dense form has several pointed upper
  branches, two descending side strokes, and a long central line.`
- 中文观察: `狭长密集形体有数条尖状上部分枝、两条下行侧笔和中央长线。`
...
- dataset label text: `㤛`
- dataset label codepoints: `U+391B`
...
- filename catalog route clues: `Heji-like filename clue: 合1107
  (G_1317_乙6370合1107賓組.png)`
...
- Which source records identify obs-char-001177 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001177？
