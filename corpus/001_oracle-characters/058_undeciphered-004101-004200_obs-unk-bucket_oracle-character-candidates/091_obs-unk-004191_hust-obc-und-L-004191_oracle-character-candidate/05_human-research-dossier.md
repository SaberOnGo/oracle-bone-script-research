# obs-unk-004191 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004191`
- primary external id: `hust-obc-und-L-004191`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/091_obs-unk-004191_h
  ust-obc-und-L-004191_oracle-character-candidate/03_visual-assets/001_asset
  -005784_hust-obc-und-L-004191_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4191/L_？_9113.jpg`
- asset id: `asset-005784`
...
- source class: `HUST-OBC/undeciphered/L/4191/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4191/L_？_9113.jpg`
- asset id: `asset-005784`
...
- English observation: `Upper stroke and two shafts visible; angles differ.`
- 中文观察: `上部横笔画和两条直立笔画可见；两条笔画角度略有不同。`
...
- Which source records identify obs-unk-004191 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004191？
