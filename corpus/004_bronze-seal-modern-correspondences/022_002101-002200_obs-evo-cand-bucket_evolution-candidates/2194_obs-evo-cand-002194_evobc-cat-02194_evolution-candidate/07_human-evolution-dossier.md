...
- Project ID: `obs-evo-cand-002194`
- EVOBC category candidate ID: `evobc-evo-cat-02194`
- External category reference: `evobc-cat-02194`
- Source category ID: `02194`
- Source label for human review: `婐`
- Source codepoints: `U+5A50`
...
- `obs-evo-cand-002194-route-category-staging`
...
- `obs-evo-cand-002194-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002194-route-evolution-graph`
