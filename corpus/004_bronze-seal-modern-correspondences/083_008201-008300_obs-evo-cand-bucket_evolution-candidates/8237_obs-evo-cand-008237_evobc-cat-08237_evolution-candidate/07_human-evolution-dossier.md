...
Project ID: `obs-evo-cand-008237`
...
- Project ID: `obs-evo-cand-008237`
- EVOBC category candidate ID: `evobc-evo-cat-08237`
- External category reference: `evobc-cat-08237`
- Source category ID: `08237`
- Source label for human review: `誢`
- Source codepoints: `U+8AA2`
...
- `obs-evo-cand-008237-route-category-staging`
...
- `obs-evo-cand-008237-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008237-route-evolution-graph`
