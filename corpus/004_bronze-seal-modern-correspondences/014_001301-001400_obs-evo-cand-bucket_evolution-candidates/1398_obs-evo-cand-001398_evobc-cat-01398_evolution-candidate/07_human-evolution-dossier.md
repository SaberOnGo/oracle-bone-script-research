...
- External category reference: `evobc-cat-01398`
- Source category ID: `01398`
- Source label for human review: `危`
- Source codepoints: `U+5371`
...
- `obs-evo-cand-001398-route-category-staging`
...
- `obs-evo-cand-001398-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001398-route-evolution-graph`
