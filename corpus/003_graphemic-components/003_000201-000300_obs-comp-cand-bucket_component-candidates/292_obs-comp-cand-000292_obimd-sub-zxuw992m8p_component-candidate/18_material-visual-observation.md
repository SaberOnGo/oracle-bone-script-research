# Material Visual Observation / obs-comp-cand-000292 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000292`
- External reference / 外部参照: `obimd-sub-zxuw992m8p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012000_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zxuw992m8p/zxuw992m8p/zxuw992m8p.png`
- Checksum / 校验和:
  `bc0cf68023b6ad6e12e86f6a8157ce156a02aa6679b3dc0e829695f5aa825264`
...
- Marked-pixel bounds: (71,28)–(178,222); span 108 × 195 px; the marked
...
- 痕迹范围：(71,28)–(178,222)；跨度108 × 195 px；痕迹矩形高于宽。
