# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008139
...
- EVOBC candidate category: `evobc-evo-cat-08139`.
- Source label for search only: `託`.
- Source codepoints for search only: `U+8A17`.
