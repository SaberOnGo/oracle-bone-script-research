# obs-unk-004259 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004259`
- primary external id: `hust-obc-und-L-004259`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/059_obs-unk-004259_h
  ust-obc-und-L-004259_oracle-character-candidate/03_visual-assets/001_asset
  -005852_hust-obc-und-L-004259_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4259/L_？_9387.jpg`
- asset id: `asset-005852`
...
- source class: `HUST-OBC/undeciphered/L/4259/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4259/L_？_9387.jpg`
- asset id: `asset-005852`
...
- English observation: `Upper diagonal, lower enclosure, crossing mark visible.`
- 中文观察: `上部斜痕、下部围合轮廓和交叉痕迹可见。`
...
- Which source records identify obs-unk-004259 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004259？
