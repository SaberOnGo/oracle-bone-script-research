# obs-unk-004422 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004422`
- primary external id: `hust-obc-und-L-004422`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/022_obs-unk-004422_h
  ust-obc-und-L-004422_oracle-character-candidate/03_visual-assets/001_asset
  -006015_hust-obc-und-L-004422_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4422/L_？_9900.jpg`
- asset id: `asset-006015`
...
- source class: `HUST-OBC/undeciphered/L/4422/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4422/L_？_9900.jpg`
- asset id: `asset-006015`
...
- English observation: `Short upper strokes sit above dark middle marks`
  `and a lower band.`
- 中文观察: `上部短痕位于中部深痕和下部横带之上。`
...
- Which source records identify obs-unk-004422 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004422？
