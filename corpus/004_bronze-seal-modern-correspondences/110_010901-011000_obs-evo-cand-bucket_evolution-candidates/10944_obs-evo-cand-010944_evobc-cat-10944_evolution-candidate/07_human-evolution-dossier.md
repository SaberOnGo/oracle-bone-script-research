...
- External category reference: `evobc-cat-10944`
- Source category ID: `10944`
- Source label for human review: `𠵤`
...
- `obs-evo-cand-010944-route-category-staging`
...
- `obs-evo-cand-010944-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010944-route-evolution-graph`
