# obs-comp-cand-002476 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002476`
- 首选外部 ID: `obimd-sub-an1boou6nc`
- OBIMD subcharacter UID: `an1boou6nc`
- OBIMD main character UID: `an1boou6nc`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+A9858;U+FE1EF; U+FE1F0; 另有 3 项
