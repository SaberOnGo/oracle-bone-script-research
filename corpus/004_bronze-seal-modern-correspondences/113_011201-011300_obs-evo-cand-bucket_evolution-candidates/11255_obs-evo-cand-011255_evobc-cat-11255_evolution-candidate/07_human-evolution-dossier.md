...
- Project ID: `obs-evo-cand-011255`
- EVOBC category candidate ID: `evobc-evo-cat-11255`
- External category reference: `evobc-cat-11255`
- Source category ID: `11255`
- Source label for human review: `𢝬`
- Source codepoints: `U+2276C`
...
- `obs-evo-cand-011255-route-category-staging`
...
- `obs-evo-cand-011255-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011255-route-evolution-graph`
