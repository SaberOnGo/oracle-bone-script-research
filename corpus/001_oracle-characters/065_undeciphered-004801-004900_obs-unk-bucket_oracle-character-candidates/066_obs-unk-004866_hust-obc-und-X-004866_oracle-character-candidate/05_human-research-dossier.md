# obs-unk-004866 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004866`
- primary external id: `hust-obc-und-X-004866`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/066_obs-unk-004866_h
  ust-obc-und-X-004866_oracle-character-candidate/03_visual-assets/001_asset
  -006459_hust-obc-und-X-004866_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/422/X_？_7406_1.png`
- asset id: `asset-006459`
...
- source class: `HUST-OBC/undeciphered/X/422/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/422/X_？_7406_1.png`
- asset id: `asset-006459`
...
- English observation: `central junction, side projections, and lower opening`
- 中文观察: `中部交叉点、侧向突出和下部开口`
...
- Which source records identify obs-unk-004866 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004866？
