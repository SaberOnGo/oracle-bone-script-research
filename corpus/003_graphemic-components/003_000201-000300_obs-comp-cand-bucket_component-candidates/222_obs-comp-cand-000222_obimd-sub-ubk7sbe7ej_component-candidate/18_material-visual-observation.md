# Material Visual Observation / obs-comp-cand-000222 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000222`
- External reference / 外部参照: `obimd-sub-ubk7sbe7ej`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011867_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7z5dh17d4b/ubk7sbe7ej/ubk7sbe7ej.png`
- Checksum / 校验和:
  `62e4c16dffb7052ce8957ba0a55f7c3b1f026ae397a10431ad4542710fca13db`
...
- Marked-pixel bounds: (95,13)–(154,234); span 60 × 222 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.03%。
- 痕迹范围：(95,13)–(154,234)；跨度60 × 222 px；痕迹矩形高于宽。
