# Material Visual Observation / obs-comp-cand-002176 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002176`
- External reference / 外部参照: `obimd-sub-9xco9z4c3z`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019877_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9xco9z4c3z/9xco9z4c3z/9xco9z4c3z.png`
- Checksum / 校验和:
  `d6efe608e95406a58ecd7b8fbbbd6c4d2cf5d50ac59a5744ac4dc992583796db`
...
- Marked-pixel bounds: (79,35)–(174,205); span 96 × 171 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.62%。
- 痕迹范围：(79,35)–(174,205)；跨度96 × 171 px；痕迹矩形高于宽。
