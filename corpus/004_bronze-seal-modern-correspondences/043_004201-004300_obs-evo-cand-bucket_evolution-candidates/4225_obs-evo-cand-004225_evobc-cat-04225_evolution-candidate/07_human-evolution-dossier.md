...
- External category reference: `evobc-cat-04225`
- Source category ID: `04225`
- Source label: `槸`
...
- `obs-evo-cand-004225-route-category-staging`
...
- `obs-evo-cand-004225-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004225-route-evolution-graph`
