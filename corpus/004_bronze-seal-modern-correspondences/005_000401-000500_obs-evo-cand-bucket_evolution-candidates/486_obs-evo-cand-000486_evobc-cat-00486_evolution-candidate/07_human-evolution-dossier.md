...
- External category reference: `evobc-cat-00486`
- Source category ID: `00486`
- Source label for human review: `䢿`
...
- `obs-evo-cand-000486-route-category-staging`
...
- `obs-evo-cand-000486-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000486-route-evolution-graph`
