# Material Visual Observation / obs-comp-cand-002346 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002346`
- External reference / 外部参照: `obimd-sub-n7v6g34e0m`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020417_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/n7v6g34e0m/n7v6g34e0m/n7v6g34e0m.png`
- Checksum / 校验和:
  `90afb9562a8eecbd7d10c5b7ced4d0007175baf18f48ea613b40b9030318e2b3`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 14.36%.
- Marked-pixel bounds: (73,20)–(181,227); span 109 × 208 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占14.36%。
- 痕迹范围：(73,20)–(181,227)；跨度109 × 208 px；痕迹矩形高于宽。
