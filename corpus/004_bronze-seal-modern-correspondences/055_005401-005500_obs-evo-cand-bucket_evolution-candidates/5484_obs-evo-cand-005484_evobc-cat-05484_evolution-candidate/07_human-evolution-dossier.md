...
- External category reference: `evobc-cat-05484`
- Source category ID: `05484`
- Source label for human review: `璱`
...
- `obs-evo-cand-005484-route-category-staging`
...
- `obs-evo-cand-005484-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005484-route-evolution-graph`
