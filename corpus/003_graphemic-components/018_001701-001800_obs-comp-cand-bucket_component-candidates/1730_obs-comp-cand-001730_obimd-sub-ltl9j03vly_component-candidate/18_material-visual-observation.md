# Material Visual Observation / obs-comp-cand-001730 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001730`
- External reference / 外部参照: `obimd-sub-ltl9j03vly`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017915_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xeawj1t30j/ltl9j03vly/ltl9j03vly.png`
- Checksum / 校验和:
  `5d20e0003a605af4f82238d9ee2ead47fcad792dd7c7160189871f1e60f63d8e`
...
- Marked-pixel bounds: (79,45)–(172,200); span 94 × 156 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.05%。
- 痕迹范围：(79,45)–(172,200)；跨度94 × 156 px；痕迹矩形高于宽。
