...
- Project ID: `obs-evo-cand-003097`
- EVOBC category candidate ID: `evobc-evo-cat-03097`
- External category reference: `evobc-cat-03097`
- Source category ID: `03097`
- Source label for human review: `愴`
- Source codepoints: `U+6134`
...
- `obs-evo-cand-003097-route-category-staging`
...
- `obs-evo-cand-003097-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003097-route-evolution-graph`
