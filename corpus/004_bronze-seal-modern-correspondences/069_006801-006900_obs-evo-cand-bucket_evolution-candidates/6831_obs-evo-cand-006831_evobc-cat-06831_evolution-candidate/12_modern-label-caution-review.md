# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006831
...
- EVOBC candidate category: `evobc-evo-cat-06831`.
- Source label for search only: `罿`.
- Source codepoints for search only: `U+7F7F`.
