...
- `obs-evo-cand-012436-route-category-staging`
...
- `obs-evo-cand-012436-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012436-route-evolution-graph`
