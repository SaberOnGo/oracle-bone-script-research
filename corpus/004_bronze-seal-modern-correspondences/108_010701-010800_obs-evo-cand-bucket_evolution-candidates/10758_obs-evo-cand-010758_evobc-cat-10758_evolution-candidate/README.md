# obs-evo-cand-010758 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-010758`
- EVOBC category candidate ID: `evobc-evo-cat-10758`
- External category ref: `evobc-cat-10758`
- Source label: `龠`
- Source codepoints: `U+9FA0`
- Image reference count: `132`
- Era token counts: `BI:12;CS:1;OBC:108;SAC:2;SS:2;WSC:7`
- Source token counts: `Book:38;Web:94`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 108 image references
- era 1 / BI: 12 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 2 image references
- era 4 / WSC: 7 image references
- era 5 / CS: 1 image references
- source 0 / Web:1633: 2 image references
- source 1 / Web:105952;說文Web:58: 46 image references
