# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002565
...
- EVOBC candidate category: `evobc-evo-cat-02565`.
- Source label for search only: `崖`.
- Source codepoints for search only: `U+5D16`.
