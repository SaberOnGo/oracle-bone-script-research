...
Project ID: `obs-evo-cand-007120`
...
- Project ID: `obs-evo-cand-007120`
- EVOBC category candidate ID: `evobc-evo-cat-07120`
- External category reference: `evobc-cat-07120`
- Source category ID: `07120`
- Source label for human review: `膍`
- Source codepoints: `U+818D`
...
- `obs-evo-cand-007120-route-category-staging`
...
- `obs-evo-cand-007120-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007120-route-evolution-graph`
