...
Project ID: `obs-insc-cw-cand-000538`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000538`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000538` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2540` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `368` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `464` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `41803` [route_present_image_or_text_not_collected]
