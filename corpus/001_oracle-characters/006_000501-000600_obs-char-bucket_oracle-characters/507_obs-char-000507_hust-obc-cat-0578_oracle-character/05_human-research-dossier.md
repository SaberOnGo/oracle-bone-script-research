# obs-char-000507 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000507`
- primary external id: `hust-obc-cat-0578`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/507_obs-char-000507_hust-obc-cat-0578_orac
  le-character/03_visual-assets/001_asset-000512_hust-obc-cat-0578_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0578/X_0578_3505_1.png`
- asset id: `asset-000512`
...
- source category: `0578`
- validation class: `506`
- source image route: `HUST-OBC/deciphered/0578/X_0578_3505_1.png`
- asset id: `asset-000512`
...
- English observation: `A bold central loop is crossed by a horizontal bar
  and rises into a bent upper stem; two detached vertical marks stand near
  its lower left and right sides.`
- 中文观察: `粗重中央环形被横笔穿过并向上形成弯折主干，下部左右附近各有一条分离竖痕。`
...
- dataset label text: `㘸`
- dataset label codepoints: `U+3638`
...
- Which source records identify obs-char-000507 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000507？
