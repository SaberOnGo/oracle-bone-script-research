# Material Visual Observation / obs-comp-cand-001904 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001904`
- External reference / 外部参照: `obimd-sub-rawz6rhrtd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018314_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h16yr7furr/rawz6rhrtd/rawz6rhrtd.png`
- Checksum / 校验和:
  `777923e9f591fa682272f03069ea61f39d3bfa11d9f11f89ec35a5e43643b705`
...
- Marked-pixel bounds: (76,41)–(173,204); span 98 × 164 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.67%。
- 痕迹范围：(76,41)–(173,204)；跨度98 × 164 px；痕迹矩形高于宽。
