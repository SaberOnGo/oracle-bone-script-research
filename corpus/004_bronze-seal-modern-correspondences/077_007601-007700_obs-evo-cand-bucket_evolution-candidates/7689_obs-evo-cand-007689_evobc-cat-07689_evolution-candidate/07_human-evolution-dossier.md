...
- External category reference: `evobc-cat-07689`
- Source category ID: `07689`
- Source label for human review: `虋`
- Source codepoints: `U+864B`
...
- `obs-evo-cand-007689-route-category-staging`
...
- `obs-evo-cand-007689-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007689-route-evolution-graph`
