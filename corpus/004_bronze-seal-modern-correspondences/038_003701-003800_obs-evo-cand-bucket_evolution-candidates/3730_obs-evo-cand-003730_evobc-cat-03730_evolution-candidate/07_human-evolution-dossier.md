...
- External category reference: `evobc-cat-03730`
- Source category ID: `03730`
- Source label for human review: `昶`
- Source codepoints: `U+6636`
...
- `obs-evo-cand-003730-route-category-staging`
...
- `obs-evo-cand-003730-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003730-route-evolution-graph`
