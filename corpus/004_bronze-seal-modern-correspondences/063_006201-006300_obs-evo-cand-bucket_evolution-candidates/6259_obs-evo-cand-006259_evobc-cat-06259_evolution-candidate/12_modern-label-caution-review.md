# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006259
...
- EVOBC candidate category: `evobc-evo-cat-06259`.
- Source label for search only: `筍`.
- Source codepoints for search only: `U+7B4D`.
