...
|---|---|---|
| Source Codepoint Route | `U+35CA` | not identity |
| HUST candidate route | `hust-obc-cat-0468` | not reading |
| OBIMD route | `obimd-main-cand-001642` | not component |
| EVOBC route | `evobc-evo-cat-00035` | not evolution |
