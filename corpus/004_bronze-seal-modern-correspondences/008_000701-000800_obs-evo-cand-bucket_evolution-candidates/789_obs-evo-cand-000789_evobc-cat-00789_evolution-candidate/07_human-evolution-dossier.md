...
- Project ID: `obs-evo-cand-000789`
- EVOBC category candidate ID: `evobc-evo-cat-00789`
- External category reference: `evobc-cat-00789`
- Source category ID: `00789`
- Source label for human review: `伽`
- Source codepoints: `U+4F3D`
...
- `obs-evo-cand-000789-route-category-staging`
...
- `obs-evo-cand-000789-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000789-route-evolution-graph`
