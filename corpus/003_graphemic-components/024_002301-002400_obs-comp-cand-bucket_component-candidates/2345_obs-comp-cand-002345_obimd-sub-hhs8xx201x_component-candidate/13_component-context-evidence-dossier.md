# obs-comp-cand-002345 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002345`
- 首选外部 ID: `obimd-sub-hhs8xx201x`
- OBIMD subcharacter UID: `hhs8xx201x`
- OBIMD main character UID: `hhs8xx201x`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+25FAF;U+FD6ED; U+FD6EE; 另有 1 项
