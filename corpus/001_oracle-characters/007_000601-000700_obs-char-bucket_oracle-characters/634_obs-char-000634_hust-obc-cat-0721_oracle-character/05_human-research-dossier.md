# obs-char-000634 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/634_obs-char-000634_hust-obc-cat-0721_orac
  le-character/03_visual-assets/001_asset-000639_hust-obc-cat-0721_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0721/G_0721_乙7191反合14149反賓組.png
  `
- asset id: `asset-000639`
...
- source category: `0721`
- validation class: `633`
- source image route: `HUST-OBC/deciphered/0721/G_0721_乙7191反合14149反賓組.png`
- asset id: `asset-000639`
...
- English observation: `A long top horizontal is crossed by a central
  vertical; two diagonals descend inward to meet the stem, which continues
  as a thin pointed lower line.`
...
- dataset label text: `㛇`
- dataset label codepoints: `U+36C7`
...
- filename catalog route clues: `Heji-like filename clue: 合14149
...
- Which source records identify obs-char-000634 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000634？
