...
- External category reference: `evobc-cat-06617`
- Source category ID: `06617`
- Source label for human review: `緹`
- Source codepoints: `U+7DF9`
...
- `obs-evo-cand-006617-route-category-staging`
...
- `obs-evo-cand-006617-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006617-route-evolution-graph`
