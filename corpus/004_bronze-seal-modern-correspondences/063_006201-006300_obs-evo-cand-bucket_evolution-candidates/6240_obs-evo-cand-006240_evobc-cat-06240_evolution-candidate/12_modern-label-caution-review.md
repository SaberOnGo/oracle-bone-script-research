# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006240
...
- EVOBC candidate category: `evobc-evo-cat-06240`.
- Source label for search only: `笪`.
- Source codepoints for search only: `U+7B2A`.
