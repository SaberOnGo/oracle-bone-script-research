# obs-char-000630 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/630_obs-char-000630_hust-obc-cat-0715_0716
  _oracle-character/03_visual-assets/001_asset-000635_hust-obc-cat-0715_0716
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0715_0716/0715/G_0715_甲骨文0.png`
- asset id: `asset-000635`
...
- source category: `0715_0716`
- validation class: `629`
- source image route: `HUST-OBC/deciphered/0715_0716/0715/G_0715_甲骨文0.png`
- asset id: `asset-000635`
...
- English observation: `A short top bar crosses a right-hand vertical, while
  a separate narrow left chain has two small oval openings and several
  forked descending strokes.`
- 中文观察: `短顶横穿过右侧竖笔，分离左侧狭链含两个小椭圆空隙和数条叉状下行笔。`
...
- dataset label text: `㛁㛂`
- dataset label codepoints: `U+36C1;U+36C2`
...
- graph edge count: `2`
- codepoint routes: `U+36C1;U+36C2`
...
- Which source records identify obs-char-000630 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000630？
