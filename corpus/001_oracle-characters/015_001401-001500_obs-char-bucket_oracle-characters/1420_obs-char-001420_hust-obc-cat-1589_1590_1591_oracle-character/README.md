# obs-char-001420 Local Object Materials / obs-char-001420 本地对象资料
...
- Project ID / 项目 ID: `obs-char-001420`
- Primary external reference / 首选外部参考: `hust-obc-cat-1589_1590_1591`
- Source / 来源: `src-hust-obc`
- Packet record type / 资料包类型: `oracle_character_candidate_packet`
- Directory / 目录: `corpus/001_oracle-characters/015_001401-001500_obs-char-bucke
  t_oracle-characters/1420_obs-char-001420_hust-obc-cat-1589_1590_1591_oracle-ch
  aracter`
...
- Committed glyph image / 已提交字形图像:
  03_visual-assets/001_asset-001425_hust-obc-cat-1589_1590_1591_glyph.png
...
- Boundary caution / 边界提示: Candidate packet only. This is not an accepted oracle
  character record, not an accepted reading, not a source promotion, and not a
  decipherment conclusion. The HUST-OBC label is dataset metadata for lookup
  until cross-source review.
