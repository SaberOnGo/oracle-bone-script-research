# Material Visual Observation / obs-comp-cand-002722 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002722`
- External reference / 外部参照: `obimd-sub-ak5swmi6nj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021320_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ak5swmi6nj/ak5swmi6nj/2ga4s306eq.png`
- Checksum / 校验和:
  `d565c96d45c563feb938ac7371a8dfe5b1455a5982b3e7ef8c4c6580a0002034`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.39%.
- Marked-pixel bounds: (88,28)–(161,217); span 74 × 190 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.39%。
- 痕迹范围：(88,28)–(161,217)；跨度74 × 190 px；痕迹矩形高于宽。
