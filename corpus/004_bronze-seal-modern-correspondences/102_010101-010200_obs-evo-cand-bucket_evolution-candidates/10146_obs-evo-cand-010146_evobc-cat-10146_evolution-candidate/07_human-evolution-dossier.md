...
Project ID: `obs-evo-cand-010146`
...
- Project ID: `obs-evo-cand-010146`
- EVOBC category candidate ID: `evobc-evo-cat-10146`
- External category reference: `evobc-cat-10146`
- Source category ID: `10146`
- Source label for human review: `饰`
- Source codepoints: `U+9970`
...
- `obs-evo-cand-010146-route-category-staging`
...
- `obs-evo-cand-010146-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010146-route-evolution-graph`
