# obs-comp-cand-000960 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000960`
- 首选外部 ID: `obimd-sub-901gohvcyr`
- OBIMD subcharacter UID: `901gohvcyr`
- OBIMD main character UID: `901gohvcyr`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `6`
- codepoint 示例: U+6C5D;U+F560B; U+F560C; 另有 4 项
