# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002564
...
- EVOBC candidate category: `evobc-evo-cat-02564`.
- Source label for search only: `崔`.
- Source codepoints for search only: `U+5D14`.
