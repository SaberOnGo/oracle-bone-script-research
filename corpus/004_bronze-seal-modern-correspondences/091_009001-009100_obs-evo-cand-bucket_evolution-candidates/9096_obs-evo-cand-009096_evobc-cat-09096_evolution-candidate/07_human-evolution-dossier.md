...
- External category reference: `evobc-cat-09096`
- Source category ID: `09096`
- Source label for human review: `邟`
...
- `obs-evo-cand-009096-route-category-staging`
...
- `obs-evo-cand-009096-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009096-route-evolution-graph`
