# obs-unk-002628 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002628`
- primary external id: `hust-obc-und-L-002628`
...
- local review image route: `corpus/001_oracle-characters/043_undeciphered-002
  601-002700_obs-unk-bucket_oracle-character-candidates/028_obs-unk-002628_h
  ust-obc-und-L-002628_oracle-character-candidate/03_visual-assets/001_asset
  -004221_hust-obc-und-L-002628_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2628/L_？_4092.jpg`
- asset id: `asset-004221`
...
- source class: `HUST-OBC/undeciphered/L/2628/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2628/L_？_4092.jpg`
- asset id: `asset-004221`
...
- Which source records identify obs-unk-002628 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002628？
