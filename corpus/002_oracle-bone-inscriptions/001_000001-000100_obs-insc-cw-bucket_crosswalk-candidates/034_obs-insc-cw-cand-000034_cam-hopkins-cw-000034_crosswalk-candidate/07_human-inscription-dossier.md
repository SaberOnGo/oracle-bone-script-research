...
Project ID: `obs-insc-cw-cand-000034`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000034`
...
- Source page section: `Period I Group 2` /
  `第 I 期第 2 组`
- Source section key: `period-i-group-2`
...
- Yingguo / 英国所藏: `y198` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `125` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000034`
