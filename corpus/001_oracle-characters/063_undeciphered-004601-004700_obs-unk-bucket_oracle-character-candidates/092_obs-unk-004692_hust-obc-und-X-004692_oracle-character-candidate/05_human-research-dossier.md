# obs-unk-004692 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004692`
- primary external id: `hust-obc-und-X-004692`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/092_obs-unk-004692_h
  ust-obc-und-X-004692_oracle-character-candidate/03_visual-assets/001_asset
  -006285_hust-obc-und-X-004692_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/248/X_？_8415_1.png`
- asset id: `asset-006285`
...
- source class: `HUST-OBC/undeciphered/X/248/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/248/X_？_8415_1.png`
- asset id: `asset-006285`
...
- English observation: `two separated groups with upper branches`
- 中文观察: `带上部分支的两组分离笔画`
...
- Which source records identify obs-unk-004692 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004692？
