# Human Research Readiness Review / 正式研究准备复核: obs-evo-cand-012458
...
- Source label for lookup only: `𨞩`.
- Source codepoints for lookup only: `U+287A9`.
- Era/source code rows to open: `5`.
