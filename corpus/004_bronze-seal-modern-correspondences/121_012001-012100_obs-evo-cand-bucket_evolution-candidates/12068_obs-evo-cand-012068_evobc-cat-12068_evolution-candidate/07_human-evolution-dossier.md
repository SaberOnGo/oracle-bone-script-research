...
Project ID: `obs-evo-cand-012068`
...
- Project ID: `obs-evo-cand-012068`
- EVOBC category candidate ID: `evobc-evo-cat-12068`
- External category reference: `evobc-cat-12068`
- Source category ID: `12068`
- Source label for human review: `𦣻`
- Source codepoints: `U+268FB`
...
- `obs-evo-cand-012068-route-category-staging`
...
- `obs-evo-cand-012068-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012068-route-evolution-graph`
