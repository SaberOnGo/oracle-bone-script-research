# obs-char-001405 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001405`
- primary external id: `hust-obc-cat-1574`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1405_obs-char-001405_hust-obc-cat-1574_ora
  cle-character/03_visual-assets/001_asset-001410_hust-obc-cat-1574_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1574/G_1574_前4.24.1合6198賓組.png`
- asset id: `asset-001410`
...
- source category: `1574`
- validation class: `1404`
- source image route: `HUST-OBC/deciphered/1574/G_1574_前4.24.1合6198賓組.png`
- asset id: `asset-001410`
...
- English observation: `A broad upper frame stands above two small lower
  enclosures and short marks.`
- 中文观察: `宽大上部框形位于两个小型下部框形和短笔画之上。`
...
- dataset label text: `㨜`
- dataset label codepoints: `U+3A1C`
...
- filename catalog route clues: `Heji-like filename clue: 合6198
  (G_1574_前4.24.1合6198賓組.png)`
...
- Which source records identify obs-char-001405 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001405？
