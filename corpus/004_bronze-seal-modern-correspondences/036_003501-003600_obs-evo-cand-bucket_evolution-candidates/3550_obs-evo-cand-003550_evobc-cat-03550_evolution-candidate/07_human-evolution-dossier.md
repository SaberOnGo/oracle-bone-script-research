...
- Project ID: `obs-evo-cand-003550`
- EVOBC category candidate ID: `evobc-evo-cat-03550`
- External category reference: `evobc-cat-03550`
- Source category ID: `03550`
- Source label for human review: `攤`
- Source codepoints: `U+6524`
...
- `obs-evo-cand-003550-route-category-staging`
...
- `obs-evo-cand-003550-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003550-route-evolution-graph`
