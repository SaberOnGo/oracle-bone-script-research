# obs-char-000222 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/222_obs-char-000222_hust-obc-cat-0246_0247
  _oracle-character/03_visual-assets/001_asset-000227_hust-obc-cat-0246_0247
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0246_0247/0246/G_0246_乙3299(甲).
  png`
- asset id: `asset-000227`
...
- source category: `0246_0247`
- validation class: `221`
- source image route: `HUST-OBC/deciphered/0246_0247/0246/G_0246_乙3299(甲).png`
- asset id: `asset-000227`
...
- English observation: `The narrow image has a branching upper cluster, a
  rounded central opening, and a thin curved stroke continuing down the
  right side.`
- 中文观察: `狭长图像上方有分叉笔群，中部有圆弧开口，右侧有细弯曲笔继续下行。`
...
- dataset label text: `㓬㓭`
- dataset label codepoints: `U+34EC;U+34ED`
...
- graph edge count: `2`
- codepoint routes: `U+34EC;U+34ED`
...
- Which source records identify obs-char-000222 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000222？
