...
Project ID: `obs-evo-cand-009545`
...
- Project ID: `obs-evo-cand-009545`
- EVOBC category candidate ID: `evobc-evo-cat-09545`
- External category reference: `evobc-cat-09545`
- Source category ID: `09545`
- Source label for human review: `鑐`
- Source codepoints: `U+9450`
...
- `obs-evo-cand-009545-route-category-staging`
...
- `obs-evo-cand-009545-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009545-route-evolution-graph`
