# obs-unk-004820 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/020_obs-unk-004820_h
  ust-obc-und-X-004820_oracle-character-candidate/03_visual-assets/001_asset
  -006413_hust-obc-und-X-004820_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/376/X_？_7360_1.png`
- asset id: `asset-006413`
...
- source class: `HUST-OBC/undeciphered/X/376/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/376/X_？_7360_1.png`
- asset id: `asset-006413`
...
- English observation: `large interior opening with detached left marks`
- 中文观察: `主体内部大开口和左侧分离标记`
...
- Which source records identify obs-unk-004820 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004820？
