...
- External category reference: `evobc-cat-07052`
- Source category ID: `07052`
- Source label for human review: `脂`
- Source codepoints: `U+8102`
...
- `obs-evo-cand-007052-route-category-staging`
...
- `obs-evo-cand-007052-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007052-route-evolution-graph`
