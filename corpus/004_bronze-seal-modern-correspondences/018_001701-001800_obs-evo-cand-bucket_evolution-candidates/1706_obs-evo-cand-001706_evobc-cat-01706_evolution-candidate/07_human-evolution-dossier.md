...
- External category reference: `evobc-cat-01706`
- Source category ID: `01706`
- Source label for human review: `嘳`
- Source codepoints: `U+5633`
...
- `obs-evo-cand-001706-route-category-staging`
...
- `obs-evo-cand-001706-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001706-route-evolution-graph`
