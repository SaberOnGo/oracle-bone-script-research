# Material Visual Observation / obs-comp-cand-002044 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002044`
- External reference / 外部参照: `obimd-sub-gylityx9if`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019371_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/sj4e2q73so/gylityx9if/gylityx9if.png`
- Checksum / 校验和:
  `a4244e6cb361c5733d37c2d7c18ebd192d7e1ff22df278c100348d2f84779455`
...
- Marked-pixel bounds: (77,32)–(172,212); span 96 × 181 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.33%。
- 痕迹范围：(77,32)–(172,212)；跨度96 × 181 px；痕迹矩形高于宽。
