...
Project ID: `obs-evo-cand-005284`
...
- Project ID: `obs-evo-cand-005284`
- EVOBC category candidate ID: `evobc-evo-cat-05284`
- External category reference: `evobc-cat-05284`
- Source category ID: `05284`
- Source label for human review: `狼`
- Source codepoints: `U+72FC`
...
- `obs-evo-cand-005284-route-category-staging`
...
- `obs-evo-cand-005284-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005284-route-evolution-graph`
