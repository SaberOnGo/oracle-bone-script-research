...
- `obs-evo-cand-003404-route-category-staging`
...
- `obs-evo-cand-003404-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003404-route-evolution-graph`
