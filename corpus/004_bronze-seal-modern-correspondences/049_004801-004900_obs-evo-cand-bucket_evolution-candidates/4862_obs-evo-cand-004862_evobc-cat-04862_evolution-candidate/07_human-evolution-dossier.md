...
- External category reference: `evobc-cat-04862`
- Source category ID: `04862`
- Source label: `漁`
...
- `obs-evo-cand-004862-route-category-staging`
...
- `obs-evo-cand-004862-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004862-route-evolution-graph`
