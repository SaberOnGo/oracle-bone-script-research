...
- External category reference: `evobc-cat-11517`
- Source category ID: `11517`
- Source label for human review: `𣳟`
- Source codepoints: `U+23CDF`
- Image reference count in source metadata: `14`
...
- `obs-evo-cand-011517-route-category-staging`
...
- `obs-evo-cand-011517-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011517-route-evolution-graph`
