# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002192
...
- EVOBC candidate category: `evobc-evo-cat-02192`.
- Source label for search only: `婎`.
- Source codepoints for search only: `U+5A4E`.
