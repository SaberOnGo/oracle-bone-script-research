...
- `obs-evo-cand-001514-route-category-staging`
...
- `obs-evo-cand-001514-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001514-route-evolution-graph`
