# obs-unk-003842 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/055_undeciphered-003
  801-003900_obs-unk-bucket_oracle-character-candidates/042_obs-unk-003842_h
  ust-obc-und-L-003842_oracle-character-candidate/03_visual-assets/001_asset
  -005435_hust-obc-und-L-003842_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3842/L_？_8029.jpg`
- asset id: `asset-005435`
...
- source class: `HUST-OBC/undeciphered/L/3842/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3842/L_？_8029.jpg`
- asset id: `asset-005435`
...
- Which source records identify obs-unk-003842 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003842？
