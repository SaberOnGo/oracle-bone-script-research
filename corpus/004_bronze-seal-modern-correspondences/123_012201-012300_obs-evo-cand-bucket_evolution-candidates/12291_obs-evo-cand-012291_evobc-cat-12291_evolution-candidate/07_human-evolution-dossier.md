...
- External category reference: `evobc-cat-12291`
- Source category ID: `12291`
- Source label for human review: `𧸿`
- Source codepoints: `U+27E3F`
...
- `obs-evo-cand-012291-route-category-staging`
...
- `obs-evo-cand-012291-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012291-route-evolution-graph`
