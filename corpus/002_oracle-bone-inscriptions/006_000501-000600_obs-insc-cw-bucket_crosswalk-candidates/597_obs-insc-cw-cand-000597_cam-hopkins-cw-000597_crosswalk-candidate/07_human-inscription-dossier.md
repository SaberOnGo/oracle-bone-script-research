...
Project ID: `obs-insc-cw-cand-000597`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000597`
...
- Yingguo / 英国所藏: `y2648` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `386` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `587` in source row; primary catalog entry pending
- Heji / 合集: `41927` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000597`
