...
Project ID: `obs-evo-cand-011158`
...
- Project ID: `obs-evo-cand-011158`
- EVOBC category candidate ID: `evobc-evo-cat-11158`
- External category reference: `evobc-cat-11158`
- Source category ID: `11158`
- Source label for human review: `𢊧`
- Source codepoints: `U+222A7`
...
- `obs-evo-cand-011158-route-category-staging`
...
- `obs-evo-cand-011158-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011158-route-evolution-graph`
