...
- Project ID: `obs-evo-cand-000395`
- EVOBC category candidate ID: `evobc-evo-cat-00395`
- External category reference: `evobc-cat-00395`
- Source category ID: `00395`
- Source label for human review: `䖜`
- Source codepoints: `U+459C`
...
- `obs-evo-cand-000395-route-category-staging`
...
- `obs-evo-cand-000395-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000395-route-evolution-graph`
