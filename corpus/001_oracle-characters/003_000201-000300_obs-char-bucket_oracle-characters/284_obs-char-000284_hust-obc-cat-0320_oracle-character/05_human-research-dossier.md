# obs-char-000284 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000284`
- primary external id: `hust-obc-cat-0320`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/284_obs-char-000284_hust-obc-cat-0320_orac
  le-character/03_visual-assets/001_asset-000289_hust-obc-cat-0320_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0320/Y_0320_60025.jpg`
- asset id: `asset-000289`
...
- source category: `0320`
- validation class: `283`
- source image route: `HUST-OBC/deciphered/0320/Y_0320_60025.jpg`
- asset id: `asset-000289`
...
- English observation: `The image combines a small rounded bowl-like mark on
  the left with a larger angular upright form on the right and a long
  diagonal lower stroke.`
- 中文观察: `图像左侧有小型圆弧碗状痕迹，右侧有较大的折角直立形体，下方延伸长斜向笔画。`
...
- dataset label text: `㔶`
- dataset label codepoints: `U+3536`
...
- Which source records identify obs-char-000284 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000284？
