# obs-unk-004898 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/098_obs-unk-004898_h
  ust-obc-und-X-004898_oracle-character-candidate/03_visual-assets/001_asset
  -006491_hust-obc-und-X-004898_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/454/X_？_7434_1.png`
- asset id: `asset-006491`
...
- source class: `HUST-OBC/undeciphered/X/454/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/454/X_？_7434_1.png`
- asset id: `asset-006491`
...
- English observation: `sloping upper strokes and lower grid`
- 中文观察: `上部斜向笔画和下部格状结构`
...
- Which source records identify obs-unk-004898 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004898？
