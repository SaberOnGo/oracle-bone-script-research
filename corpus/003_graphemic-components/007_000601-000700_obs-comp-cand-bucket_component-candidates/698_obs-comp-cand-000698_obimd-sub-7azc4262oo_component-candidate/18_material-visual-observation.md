# Material Visual Observation / obs-comp-cand-000698 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000698`
- External reference / 外部参照: `obimd-sub-7azc4262oo`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013297_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7azc4262oo/7azc4262oo/7azc4262oo.png`
- Checksum / 校验和:
  `11226123f11c067b8a76d7965febb26570b7a587295c3e09a862c4e63d2eda0c`
...
- Marked-pixel bounds: (64,23)–(200,224); span 137 × 202 px; the marked
...
- 痕迹范围：(64,23)–(200,224)；跨度137 × 202 px；痕迹矩形高于宽。
