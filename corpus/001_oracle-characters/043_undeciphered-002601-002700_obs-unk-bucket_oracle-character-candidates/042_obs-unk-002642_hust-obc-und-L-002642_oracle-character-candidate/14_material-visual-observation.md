# Material Visual Observation / obs-unk-002642
...
- Project ID / 项目 ID: `obs-unk-002642`
- Source / 来源: `src-hust-obc`
- Primary external reference / 首选外部参考:
  `hust-obc-und-L-002642`
- Committed image / 已提交图像:
  `03_visual-assets/001_asset-004235_hust-obc-und-L-002642_glyph.jpg`
- Opened derivative / 已打开派生件: the committed review image

## Direct Visual Record / 直接可见记录

- English observation: A short upper bar crosses a central descending stroke.
  Several angular branches extend below, with a darker junction toward the
  center.
- 中文观察：上部短横笔痕交叉中央向下笔痕。下方伸出数条折角分支，中央
  附近的连接处较深。
