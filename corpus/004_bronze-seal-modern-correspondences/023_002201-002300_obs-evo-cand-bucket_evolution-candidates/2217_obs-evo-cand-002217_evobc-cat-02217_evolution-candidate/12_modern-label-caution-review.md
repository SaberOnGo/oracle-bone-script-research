# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002217
...
- EVOBC candidate category: `evobc-evo-cat-02217`.
- Source label for search only: `婼`.
- Source codepoints for search only: `U+5A7C`.
