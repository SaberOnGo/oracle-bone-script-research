# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000232
...
| --- | --- | --- | --- |
| `obimd-glyph-link-003268` | 󱖑 | `U+F1591` | `reviewed_metadata_only` |
| `obimd-glyph-link-003269` | 󱖒 | `U+F1592` | `reviewed_metadata_only` |
