...
- External category reference: `evobc-cat-04150`
- Source category ID: `04150`
- Source label for human review: `楖`
- Source codepoints: `U+6956`
...
- `obs-evo-cand-004150-route-category-staging`
...
- `obs-evo-cand-004150-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004150-route-evolution-graph`
