...
- External category reference: `evobc-cat-11100`
- Source category ID: `11100`
- Source label for human review: `𡱒`
...
- `obs-evo-cand-011100-route-category-staging`
...
- `obs-evo-cand-011100-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011100-route-evolution-graph`
