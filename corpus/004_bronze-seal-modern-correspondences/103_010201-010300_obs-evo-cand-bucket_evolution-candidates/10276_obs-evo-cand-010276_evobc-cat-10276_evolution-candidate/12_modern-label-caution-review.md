# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010276
...
- EVOBC candidate category: `evobc-evo-cat-10276`.
- Source label for search only: `驷`.
- Source codepoints for search only: `U+9A77`.
