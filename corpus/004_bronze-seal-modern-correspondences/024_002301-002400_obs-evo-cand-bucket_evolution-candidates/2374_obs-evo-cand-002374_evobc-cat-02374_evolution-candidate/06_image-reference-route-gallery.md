...
- `obs-evo-cand-002374-route-category-staging`
...
- `obs-evo-cand-002374-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002374-route-evolution-graph`
