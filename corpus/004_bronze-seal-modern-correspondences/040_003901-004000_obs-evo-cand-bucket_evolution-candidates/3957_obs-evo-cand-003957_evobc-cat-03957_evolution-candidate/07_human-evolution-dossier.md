...
Project ID: `obs-evo-cand-003957`
...
- Project ID: `obs-evo-cand-003957`
- EVOBC category candidate ID: `evobc-evo-cat-03957`
- External category reference: `evobc-cat-03957`
- Source category ID: `03957`
- Source label for human review: `柖`
- Source codepoints: `U+67D6`
...
- `obs-evo-cand-003957-route-category-staging`
...
- `obs-evo-cand-003957-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003957-route-evolution-graph`
