...
- `obs-evo-cand-002232-route-category-staging`
...
- `obs-evo-cand-002232-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002232-route-evolution-graph`
