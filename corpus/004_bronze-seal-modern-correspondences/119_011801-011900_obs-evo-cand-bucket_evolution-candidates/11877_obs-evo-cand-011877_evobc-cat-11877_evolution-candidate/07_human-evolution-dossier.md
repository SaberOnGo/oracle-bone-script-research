...
Project ID: `obs-evo-cand-011877`
...
- Project ID: `obs-evo-cand-011877`
- EVOBC category candidate ID: `evobc-evo-cat-11877`
- External category reference: `evobc-cat-11877`
- Source category ID: `11877`
- Source label for human review: `𥬬`
- Source codepoints: `U+25B2C`
...
- `obs-evo-cand-011877-route-category-staging`
...
- `obs-evo-cand-011877-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011877-route-evolution-graph`
