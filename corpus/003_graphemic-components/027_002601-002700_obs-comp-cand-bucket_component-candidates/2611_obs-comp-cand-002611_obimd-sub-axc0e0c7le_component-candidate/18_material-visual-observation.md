# Material Visual Observation / obs-comp-cand-002611 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002611`
- External reference / 外部参照: `obimd-sub-axc0e0c7le`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021150_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/axc0e0c7le/axc0e0c7le/axc0e0c7le.png`
- Checksum / 校验和:
  `cea33cc44d7a1d704139d2fffc08633cc768287d8187e104461f90f2f88c2796`
...
- Marked-pixel bounds: (79,20)–(186,226); span 108 × 207 px; the marked
...
- 痕迹范围：(79,20)–(186,226)；跨度108 × 207 px；痕迹矩形高于宽。
