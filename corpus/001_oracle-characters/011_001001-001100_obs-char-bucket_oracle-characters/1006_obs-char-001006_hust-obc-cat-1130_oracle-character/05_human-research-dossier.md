# obs-char-001006 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1006_obs-char-001006_hust-obc-cat-1130_ora
  cle-character/03_visual-assets/001_asset-001011_hust-obc-cat-1130_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1130/G_1130_前2.37.8(甲).png`
- asset id: `asset-001011`
...
- source category: `1130`
- validation class: `1005`
- source image route: `HUST-OBC/deciphered/1130/G_1130_前2.37.8(甲).png`
- asset id: `asset-001011`
...
- English observation: `A broad curved enclosure contains a dense group of
  short upper and interior strokes and has two lower supporting strokes.`
...
- dataset label text: `㡠`
- dataset label codepoints: `U+3860`
...
- Which source records identify obs-char-001006 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001006？
