...
- External category reference: `evobc-cat-03988`
- Source category ID: `03988`
- Source label for human review: `栓`
- Source codepoints: `U+6813`
...
- `obs-evo-cand-003988-route-category-staging`
...
- `obs-evo-cand-003988-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003988-route-evolution-graph`
