# Material Visual Observation / obs-comp-cand-000058 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000058`
- External reference / 外部参照: `obimd-sub-320qyuxb1f`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011471_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vk0iw3x90b/320qyuxb1f/320qyuxb1f.png`
- Checksum / 校验和:
  `9d4195d32c64897004b170c5e825e65641c524e3f8ccd3a86711843663fe0bbb`
...
- Marked-pixel bounds: (79,27)–(170,218); span 92 × 192 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.89%。
- 痕迹范围：(79,27)–(170,218)；跨度92 × 192 px；痕迹矩形高于宽。
