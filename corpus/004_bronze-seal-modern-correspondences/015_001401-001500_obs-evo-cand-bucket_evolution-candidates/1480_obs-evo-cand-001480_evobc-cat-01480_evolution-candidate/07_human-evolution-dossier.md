...
- External category reference: `evobc-cat-01480`
- Source category ID: `01480`
...
- `obs-evo-cand-001480-route-category-staging`
...
- `obs-evo-cand-001480-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001480-route-evolution-graph`
