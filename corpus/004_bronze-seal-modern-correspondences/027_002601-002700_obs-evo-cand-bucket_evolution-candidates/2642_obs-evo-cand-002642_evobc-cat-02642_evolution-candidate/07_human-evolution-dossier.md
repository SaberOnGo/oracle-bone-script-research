...
Project ID: `obs-evo-cand-002642`
...
- Project ID: `obs-evo-cand-002642`
- EVOBC category candidate ID: `evobc-evo-cat-02642`
- External category reference: `evobc-cat-02642`
- Source category ID: `02642`
- Source label for human review: `希`
- Source codepoints: `U+5E0C`
...
- `obs-evo-cand-002642-route-category-staging`
...
- `obs-evo-cand-002642-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002642-route-evolution-graph`
