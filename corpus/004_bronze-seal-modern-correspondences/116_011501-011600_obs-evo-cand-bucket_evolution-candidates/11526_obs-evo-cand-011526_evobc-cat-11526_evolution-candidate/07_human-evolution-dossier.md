...
Project ID: `obs-evo-cand-011526`
...
- Project ID: `obs-evo-cand-011526`
- EVOBC category candidate ID: `evobc-evo-cat-11526`
- External category reference: `evobc-cat-11526`
- Source category ID: `11526`
- Source label for human review: `𣷡`
- Source codepoints: `U+23DE1`
...
- `obs-evo-cand-011526-route-category-staging`
...
- `obs-evo-cand-011526-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011526-route-evolution-graph`
