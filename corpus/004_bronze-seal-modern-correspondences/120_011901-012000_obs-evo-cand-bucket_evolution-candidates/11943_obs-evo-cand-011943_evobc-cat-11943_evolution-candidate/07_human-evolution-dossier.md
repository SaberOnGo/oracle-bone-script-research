...
- External category reference: `evobc-cat-11943`
- Source category ID: `11943`
- Source label for human review: `𥿶`
...
- `obs-evo-cand-011943-route-category-staging`
...
- `obs-evo-cand-011943-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011943-route-evolution-graph`
