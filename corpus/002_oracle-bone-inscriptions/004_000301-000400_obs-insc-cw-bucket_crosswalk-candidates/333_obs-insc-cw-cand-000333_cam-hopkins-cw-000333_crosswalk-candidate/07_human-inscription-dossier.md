...
Project ID: `obs-insc-cw-cand-000333`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000333`
...
- Yingguo / 英国所藏: `y2007` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `511` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `38` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000333`
