# obs-comp-cand-001134 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001134`
- 首选外部 ID: `obimd-sub-rysjgchsua`
- OBIMD subcharacter UID: `rysjgchsua`
- OBIMD main character UID: `rysjgchsua`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+A999B;U+F6818; U+F6819
