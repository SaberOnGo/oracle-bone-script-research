...
- External category reference: `evobc-cat-05419`
- Source category ID: `05419`
- Source label: `琯`
...
- `obs-evo-cand-005419-route-category-staging`
...
- `obs-evo-cand-005419-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005419-route-evolution-graph`
