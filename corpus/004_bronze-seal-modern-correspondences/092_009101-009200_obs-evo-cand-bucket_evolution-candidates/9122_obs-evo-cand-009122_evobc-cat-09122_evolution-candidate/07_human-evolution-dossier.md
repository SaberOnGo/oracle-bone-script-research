...
- External category reference: `evobc-cat-09122`
- Source category ID: `09122`
- Source label for human review: `邾`
- Source codepoints: `U+90BE`
...
- `obs-evo-cand-009122-route-category-staging`
...
- `obs-evo-cand-009122-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009122-route-evolution-graph`
