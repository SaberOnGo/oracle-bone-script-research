# obs-comp-cand-002284 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002284`
- 首选外部 ID: `obimd-sub-uc9n9xrv1e`
- OBIMD subcharacter UID: `uc9n9xrv1e`
- OBIMD main character UID: `uc9n9xrv1e`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+BC515;U+FD21E; U+FD21F
