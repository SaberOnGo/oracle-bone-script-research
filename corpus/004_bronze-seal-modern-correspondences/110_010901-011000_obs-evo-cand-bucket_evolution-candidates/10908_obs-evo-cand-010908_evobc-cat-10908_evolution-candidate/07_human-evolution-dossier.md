...
- External category reference: `evobc-cat-10908`
- Source category ID: `10908`
- Source label for human review: `𠪗`
- Source codepoints: `U+20A97`
...
- `obs-evo-cand-010908-route-category-staging`
...
- `obs-evo-cand-010908-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010908-route-evolution-graph`
