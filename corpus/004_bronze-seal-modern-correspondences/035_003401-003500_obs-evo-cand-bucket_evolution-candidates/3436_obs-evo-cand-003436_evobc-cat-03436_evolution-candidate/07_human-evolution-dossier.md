...
- External category reference: `evobc-cat-03436`
- Source category ID: `03436`
- Source label for human review: `揤`
- Source codepoints: `U+63E4`
...
- `obs-evo-cand-003436-route-category-staging`
...
- `obs-evo-cand-003436-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003436-route-evolution-graph`
