...
- Project ID: `obs-evo-cand-009127`
- EVOBC category candidate ID: `evobc-evo-cat-09127`
- External category reference: `evobc-cat-09127`
- Source category ID: `09127`
- Source label for human review: `郃`
- Source codepoints: `U+90C3`
...
- `obs-evo-cand-009127-route-category-staging`
...
- `obs-evo-cand-009127-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009127-route-evolution-graph`
