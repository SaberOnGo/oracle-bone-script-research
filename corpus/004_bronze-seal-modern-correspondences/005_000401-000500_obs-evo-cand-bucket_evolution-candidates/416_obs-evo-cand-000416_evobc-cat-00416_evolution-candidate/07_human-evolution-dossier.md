...
- Project ID: `obs-evo-cand-000416`
- EVOBC category candidate ID: `evobc-evo-cat-00416`
- External category reference: `evobc-cat-00416`
- Source category ID: `00416`
- Source label for human review: `䙷`
- Source codepoints: `U+4677`
...
- `obs-evo-cand-000416-route-category-staging`
...
- `obs-evo-cand-000416-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000416-route-evolution-graph`
