...
Project ID: `obs-evo-cand-001784`
...
- Project ID: `obs-evo-cand-001784`
- EVOBC category candidate ID: `evobc-evo-cat-01784`
- External category reference: `evobc-cat-01784`
- Source category ID: `01784`
- Source label for human review: `圖`
- Source codepoints: `U+5716`
...
- `obs-evo-cand-001784-route-category-staging`
...
- `obs-evo-cand-001784-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001784-route-evolution-graph`
