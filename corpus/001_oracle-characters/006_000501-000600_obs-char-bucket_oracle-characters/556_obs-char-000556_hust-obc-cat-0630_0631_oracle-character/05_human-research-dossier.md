# obs-char-000556 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000556`
- primary external id: `hust-obc-cat-0630_0631`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/556_obs-char-000556_hust-obc-cat-0630_0631
  _oracle-character/03_visual-assets/001_asset-000561_hust-obc-cat-0630_0631
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0630_0631/0630/G_0630_乙817(甲).p
  ng`
- asset id: `asset-000561`
...
- source category: `0630_0631`
- validation class: `555`
- source image route: `HUST-OBC/deciphered/0630_0631/0630/G_0630_乙817(甲).png`
- asset id: `asset-000561`
...
- English observation: `A compact central pointed body has crossing upper
  branches and several long lower extensions, surrounded on both sides by
  detached short marks and dots.`
- 中文观察: `紧凑中央尖形体带交叉上枝和数条长下部延伸，两侧分布分离短痕与点状痕迹。`
...
- dataset label text: `㙬㙭`
- dataset label codepoints: `U+366C;U+366D`
...
- graph edge count: `2`
- codepoint routes: `U+366C;U+366D`
...
- Which source records identify obs-char-000556 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000556？
