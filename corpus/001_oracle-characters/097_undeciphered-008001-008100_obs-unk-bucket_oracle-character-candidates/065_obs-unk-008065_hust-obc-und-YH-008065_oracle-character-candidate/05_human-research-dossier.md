# obs-unk-008065 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/097_undeciphered-008
  001-008100_obs-unk-bucket_oracle-character-candidates/065_obs-unk-008065_h
  ust-obc-und-YH-008065_oracle-character-candidate/03_visual-assets/001_asse
  t-009656_hust-obc-und-YH-008065_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/606B5/Y_？_606B5.jpg`
- asset id: `asset-009656`
...
- source class: `HUST-OBC/undeciphered/Y+H/606B5/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/606B5/Y_？_606B5.jpg`
- asset id: `asset-009656`
...
- Which source records identify obs-unk-008065 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008065？
