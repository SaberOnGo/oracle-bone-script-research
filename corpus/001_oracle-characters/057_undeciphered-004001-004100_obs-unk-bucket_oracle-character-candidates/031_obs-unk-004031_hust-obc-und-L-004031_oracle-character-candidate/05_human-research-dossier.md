# obs-unk-004031 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/031_obs-unk-004031_h
  ust-obc-und-L-004031_oracle-character-candidate/03_visual-assets/001_asset
  -005624_hust-obc-und-L-004031_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4031/L_？_8610.jpg`
- asset id: `asset-005624`
...
- source class: `HUST-OBC/undeciphered/L/4031/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4031/L_？_8610.jpg`
- asset id: `asset-005624`
...
- 中文观察：上部有横向圆弧轮廓，内部可见小型暗痕；一条细长渐窄痕迹从下部中央
    向下延伸。图像未明确外缘和下端。
...
- Which source records identify obs-unk-004031 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004031？
