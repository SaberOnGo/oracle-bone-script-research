...
- External category reference: `evobc-cat-09767`
- Source category ID: `09767`
- Source label for human review: `隍`
- Source codepoints: `U+968D`
...
- `obs-evo-cand-009767-route-category-staging`
...
- `obs-evo-cand-009767-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009767-route-evolution-graph`
