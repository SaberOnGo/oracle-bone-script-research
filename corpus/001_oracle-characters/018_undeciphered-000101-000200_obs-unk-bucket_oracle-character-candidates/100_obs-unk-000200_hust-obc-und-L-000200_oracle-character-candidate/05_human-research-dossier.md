# obs-unk-000200 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000200`
- primary external id: `hust-obc-und-L-000200`
...
- local review image route: `corpus/001_oracle-characters/018_undeciphered-000
  101-000200_obs-unk-bucket_oracle-character-candidates/100_obs-unk-000200_h
  ust-obc-und-L-000200_oracle-character-candidate/03_visual-assets/001_asset
  -001793_hust-obc-und-L-000200_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/200/L_？_1060.jpg`
- asset id: `asset-001793`
...
- source class: `HUST-OBC/undeciphered/L/200/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/200/L_？_1060.jpg`
- asset id: `asset-001793`
...
- Which source records identify obs-unk-000200 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000200？
