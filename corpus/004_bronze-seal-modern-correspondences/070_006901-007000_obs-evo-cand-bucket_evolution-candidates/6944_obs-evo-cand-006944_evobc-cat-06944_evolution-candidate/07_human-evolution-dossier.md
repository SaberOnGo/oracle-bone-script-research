...
- External category reference: `evobc-cat-06944`
- Source category ID: `06944`
- Source label for human review: `聑`
- Source codepoints: `U+8051`
...
- `obs-evo-cand-006944-route-category-staging`
...
- `obs-evo-cand-006944-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006944-route-evolution-graph`
