# obs-unk-003170 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/048_undeciphered-003
  101-003200_obs-unk-bucket_oracle-character-candidates/070_obs-unk-003170_h
  ust-obc-und-L-003170_oracle-character-candidate/03_visual-assets/001_asset
  -004763_hust-obc-und-L-003170_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3170/L_？_5857.jpg`
- asset id: `asset-004763`
...
- source class: `HUST-OBC/undeciphered/L/3170/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3170/L_？_5857.jpg`
- asset id: `asset-004763`
...
- Which source records identify obs-unk-003170 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003170？
