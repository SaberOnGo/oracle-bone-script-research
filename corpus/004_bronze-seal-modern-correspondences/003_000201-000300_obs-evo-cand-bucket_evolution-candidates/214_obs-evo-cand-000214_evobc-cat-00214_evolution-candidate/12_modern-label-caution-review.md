# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000214
...
- EVOBC candidate category: `evobc-evo-cat-00214`.
- Source label for search only: `㴲`.
- Source codepoints for search only: `U+3D32`.
