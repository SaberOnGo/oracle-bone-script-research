# obs-char-001440 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001440`
- primary external id: `hust-obc-cat-1613`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1440_obs-char-001440_hust-obc-cat-1613_ora
  cle-character/03_visual-assets/001_asset-001445_hust-obc-cat-1613_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1613/L_1613_14867.jpg`
- asset id: `asset-001445`
...
- source category: `1613`
- validation class: `1439`
- source image route: `HUST-OBC/deciphered/1613/L_1613_14867.jpg`
- asset id: `asset-001445`
...
- English observation: `A faint dense cluster combines several short
  vertical and rectangular forms.`
...
- dataset label text: `㩃`
- dataset label codepoints: `U+3A43`
...
- Which source records identify obs-char-001440 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001440？
