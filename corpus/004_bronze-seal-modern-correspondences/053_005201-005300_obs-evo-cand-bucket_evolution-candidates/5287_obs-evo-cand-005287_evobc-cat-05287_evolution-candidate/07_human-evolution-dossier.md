...
- Project ID: `obs-evo-cand-005287`
- EVOBC category candidate ID: `evobc-evo-cat-05287`
- External category reference: `evobc-cat-05287`
- Source category ID: `05287`
- Source label for human review: `猈`
- Source codepoints: `U+7308`
...
- `obs-evo-cand-005287-route-category-staging`
...
- `obs-evo-cand-005287-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005287-route-evolution-graph`
