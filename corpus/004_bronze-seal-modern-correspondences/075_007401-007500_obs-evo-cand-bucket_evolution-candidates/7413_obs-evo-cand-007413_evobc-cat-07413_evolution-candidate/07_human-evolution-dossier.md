...
Project ID: `obs-evo-cand-007413`
...
- Project ID: `obs-evo-cand-007413`
- EVOBC category candidate ID: `evobc-evo-cat-07413`
- External category reference: `evobc-cat-07413`
- Source category ID: `07413`
- Source label for human review: `菜`
- Source codepoints: `U+83DC`
...
- `obs-evo-cand-007413-route-category-staging`
...
- `obs-evo-cand-007413-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007413-route-evolution-graph`
