...
- External category reference: `evobc-cat-06000`
- Source category ID: `06000`
- Source label: `祭`
...
- `obs-evo-cand-006000-route-category-staging`
...
- `obs-evo-cand-006000-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006000-route-evolution-graph`
