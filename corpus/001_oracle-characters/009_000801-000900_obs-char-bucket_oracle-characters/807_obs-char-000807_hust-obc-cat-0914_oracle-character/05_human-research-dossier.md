# obs-char-000807 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/807_obs-char-000807_hust-obc-cat-0914_orac
  le-character/03_visual-assets/001_asset-000812_hust-obc-cat-0914_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0914/G_0914_甲骨文.png`
- asset id: `asset-000812`
...
- source category: `0914`
- validation class: `806`
- source image route: `HUST-OBC/deciphered/0914/G_0914_甲骨文.png`
- asset id: `asset-000812`
...
- dataset label text: `㞈`
- dataset label codepoints: `U+3788`
...
- Which source records identify obs-char-000807 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000807？
