# Material Visual Observation / obs-comp-cand-001187 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001187`
- External reference / 外部参照: `obimd-sub-5u17bmbs6p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015377_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5u17bmbs6p/5u17bmbs6p/5u17bmbs6p.png`
- Checksum / 校验和:
  `e30520ad0bf05b47bbb55a8348ec6488c99ce59532f8f124ff3d011a9fbf5d71`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.96%.
- Marked-pixel bounds: (87,22)–(162,228); span 76 × 207 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.96%。
- 痕迹范围：(87,22)–(162,228)；跨度76 × 207 px；痕迹矩形高于宽。
