...
- External category reference: `evobc-cat-11794`
- Source category ID: `11794`
- Source label for human review: `𥎵`
- Source codepoints: `U+253B5`
...
- `obs-evo-cand-011794-route-category-staging`
...
- `obs-evo-cand-011794-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011794-route-evolution-graph`
