...
- External category reference: `evobc-cat-00254`
- Source category ID: `00254`
- Source label for human review: `㾅`
- Source codepoints: `U+3F85`
...
- `obs-evo-cand-000254-route-category-staging`
...
- `obs-evo-cand-000254-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000254-route-evolution-graph`
