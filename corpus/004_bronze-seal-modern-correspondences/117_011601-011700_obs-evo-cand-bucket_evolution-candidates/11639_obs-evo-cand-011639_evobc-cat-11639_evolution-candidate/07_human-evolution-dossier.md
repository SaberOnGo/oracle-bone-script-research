...
- External category reference: `evobc-cat-11639`
- Source category ID: `11639`
- Source label for human review: `𤥹`
...
- `obs-evo-cand-011639-route-category-staging`
...
- `obs-evo-cand-011639-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011639-route-evolution-graph`
