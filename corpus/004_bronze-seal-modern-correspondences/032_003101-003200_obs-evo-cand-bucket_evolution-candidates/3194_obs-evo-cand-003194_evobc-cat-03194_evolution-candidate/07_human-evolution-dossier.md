...
- External category reference: `evobc-cat-03194`
- Source category ID: `03194`
- Source label for human review: `懽`
- Source codepoints: `U+61FD`
...
- `obs-evo-cand-003194-route-category-staging`
...
- `obs-evo-cand-003194-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003194-route-evolution-graph`
