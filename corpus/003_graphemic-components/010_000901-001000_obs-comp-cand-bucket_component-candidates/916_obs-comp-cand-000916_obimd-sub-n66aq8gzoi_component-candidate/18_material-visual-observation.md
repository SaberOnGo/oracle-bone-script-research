# Material Visual Observation / obs-comp-cand-000916 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000916`
- External reference / 外部参照: `obimd-sub-n66aq8gzoi`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013999_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/csyhzui9uc/n66aq8gzoi/n66aq8gzoi.png`
- Checksum / 校验和:
  `69265a984f6841293733ffaa183cd5b05c6a8253f9b3cc68fe5f0eafd8020084`
...
- Marked-pixel bounds: (91,33)–(158,216); span 68 × 184 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.12%。
- 痕迹范围：(91,33)–(158,216)；跨度68 × 184 px；痕迹矩形高于宽。
