# Material Visual Observation / obs-comp-cand-001352 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001352`
- External reference / 外部参照: `obimd-sub-fff2prq8h4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015741_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/u4u121uh4d/fff2prq8h4/fff2prq8h4.png`
- Checksum / 校验和:
  `b4d39b9b50e6003ef8cc4ebaa563d00bdd17ff59e02dc56f29abb63ede6c4d28`
...
- Marked-pixel bounds: (89,20)–(184,230); span 96 × 211 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.90%。
- 痕迹范围：(89,20)–(184,230)；跨度96 × 211 px；痕迹矩形高于宽。
