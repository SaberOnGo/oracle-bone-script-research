...
- External category reference: `evobc-cat-10842`
- Source category ID: `10842`
- Source label for human review: `𠙮`
...
- `obs-evo-cand-010842-route-category-staging`
...
- `obs-evo-cand-010842-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010842-route-evolution-graph`
