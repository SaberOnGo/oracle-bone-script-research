# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002653
...
- EVOBC candidate category: `evobc-evo-cat-02653`.
- Source label for search only: `帝`.
- Source codepoints for search only: `U+5E1D`.
