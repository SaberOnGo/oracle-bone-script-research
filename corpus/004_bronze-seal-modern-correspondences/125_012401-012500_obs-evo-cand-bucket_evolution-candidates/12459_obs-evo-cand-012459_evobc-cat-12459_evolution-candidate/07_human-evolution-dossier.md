...
- Project ID: `obs-evo-cand-012459`
- EVOBC category candidate ID: `evobc-evo-cat-12459`
- External category reference: `evobc-cat-12459`
- Source category ID: `12459`
- Source label for human review: `𨞪`
- Source codepoints: `U+287AA`
...
- `obs-evo-cand-012459-route-category-staging`
...
- `obs-evo-cand-012459-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012459-route-evolution-graph`
