...
Project ID: `obs-evo-cand-003199`
...
- Project ID: `obs-evo-cand-003199`
- EVOBC category candidate ID: `evobc-evo-cat-03199`
- External category reference: `evobc-cat-03199`
- Source category ID: `03199`
- Source label for human review: `戉`
- Source codepoints: `U+6209`
- Image reference count in source metadata: `80`
...
- `obs-evo-cand-003199-route-category-staging`
...
- `obs-evo-cand-003199-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003199-route-evolution-graph`
