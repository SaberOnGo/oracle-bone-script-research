...
- Project ID: `obs-evo-cand-004884`
- EVOBC category candidate ID: `evobc-evo-cat-04884`
- External category reference: `evobc-cat-04884`
- Source category ID: `04884`
- Source label for human review: `漻`
- Source codepoints: `U+6F3B`
...
- `obs-evo-cand-004884-route-category-staging`
...
- `obs-evo-cand-004884-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004884-route-evolution-graph`
