...
Project ID: `obs-evo-cand-000358`
...
- Project ID: `obs-evo-cand-000358`
- EVOBC category candidate ID: `evobc-evo-cat-00358`
- External category reference: `evobc-cat-00358`
- Source category ID: `00358`
- Source label for human review: `䏼`
- Source codepoints: `U+43FC`
...
- `obs-evo-cand-000358-route-category-staging`
...
- `obs-evo-cand-000358-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000358-route-evolution-graph`
