# obs-unk-008489 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008489`
- primary external id: `hust-obc-und-YH-008489`
...
- local review image route: `corpus/001_oracle-characters/101_undeciphered-008
  401-008500_obs-unk-bucket_oracle-character-candidates/089_obs-unk-008489_h
  ust-obc-und-YH-008489_oracle-character-candidate/03_visual-assets/001_asse
  t-010080_hust-obc-und-YH-008489_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60B79/H_？_60B79_0.png`
- asset id: `asset-010080`
...
- source class: `HUST-OBC/undeciphered/Y+H/60B79/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60B79/H_？_60B79_0.png`
- asset id: `asset-010080`
...
- Which source records identify obs-unk-008489 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008489？
