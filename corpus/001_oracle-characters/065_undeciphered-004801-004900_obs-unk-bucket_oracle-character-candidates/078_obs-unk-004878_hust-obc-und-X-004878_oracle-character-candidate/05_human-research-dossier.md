# obs-unk-004878 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004878`
- primary external id: `hust-obc-und-X-004878`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/078_obs-unk-004878_h
  ust-obc-und-X-004878_oracle-character-candidate/03_visual-assets/001_asset
  -006471_hust-obc-und-X-004878_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/434/X_？_7417_1.png`
- asset id: `asset-006471`
...
- source class: `HUST-OBC/undeciphered/X/434/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/434/X_？_7417_1.png`
- asset id: `asset-006471`
...
- English observation: `curved upper stroke and separated rounded marks`
- 中文观察: `上部弧形笔画和分开的圆钝标记`
...
- Which source records identify obs-unk-004878 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004878？
