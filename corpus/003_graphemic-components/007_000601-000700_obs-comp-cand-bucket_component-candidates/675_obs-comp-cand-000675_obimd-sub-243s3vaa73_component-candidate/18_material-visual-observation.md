# Material Visual Observation / obs-comp-cand-000675 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000675`
- External reference / 外部参照: `obimd-sub-243s3vaa73`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013238_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/243s3vaa73/243s3vaa73/243s3vaa73.png`
- Checksum / 校验和:
  `4359f00acb173c336fa933d415f85b8f5d26518b6a36099d5484a5e805ded2ba`
...
- Marked-pixel bounds: (61,23)–(188,229); span 128 × 207 px; the marked
...
- 痕迹范围：(61,23)–(188,229)；跨度128 × 207 px；痕迹矩形高于宽。
