# obs-unk-008471 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008471`
- primary external id: `hust-obc-und-YH-008471`
...
- local review image route: `corpus/001_oracle-characters/101_undeciphered-008
  401-008500_obs-unk-bucket_oracle-character-candidates/071_obs-unk-008471_h
  ust-obc-und-YH-008471_oracle-character-candidate/03_visual-assets/001_asse
  t-010062_hust-obc-und-YH-008471_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60B3C/Y_？_60B3C.jpg`
- asset id: `asset-010062`
...
- source class: `HUST-OBC/undeciphered/Y+H/60B3C/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60B3C/Y_？_60B3C.jpg`
- asset id: `asset-010062`
...
- Which source records identify obs-unk-008471 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008471？
