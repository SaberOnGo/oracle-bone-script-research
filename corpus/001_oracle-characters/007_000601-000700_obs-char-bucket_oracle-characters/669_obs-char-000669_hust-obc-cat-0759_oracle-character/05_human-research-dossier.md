# obs-char-000669 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000669`
- primary external id: `hust-obc-cat-0759`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/669_obs-char-000669_hust-obc-cat-0759_orac
  le-character/03_visual-assets/001_asset-000674_hust-obc-cat-0759_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0759/G_0759_前8.7.1(甲).png`
- asset id: `asset-000674`
...
- source category: `0759`
- validation class: `668`
- source image route: `HUST-OBC/deciphered/0759/G_0759_前8.7.1(甲).png`
- asset id: `asset-000674`
...
- English observation: `A small upper angular cluster spreads short branches
  to both sides, then continues through a segmented wavering right descent
  into a long lower-left slanting tail.`
- 中文观察: `小型上部折角笔群向两侧伸短枝，继而沿分节波折右下笔延续成长左下斜尾。`
...
- dataset label text: `㛭`
- dataset label codepoints: `U+36ED`
...
- Which source records identify obs-char-000669 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000669？
