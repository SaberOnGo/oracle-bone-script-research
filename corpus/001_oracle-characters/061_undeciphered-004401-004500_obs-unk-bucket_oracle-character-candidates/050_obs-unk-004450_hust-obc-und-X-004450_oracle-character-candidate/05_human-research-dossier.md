# obs-unk-004450 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004450`
- primary external id: `hust-obc-und-X-004450`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/050_obs-unk-004450_h
  ust-obc-und-X-004450_oracle-character-candidate/03_visual-assets/001_asset
  -006043_hust-obc-und-X-004450_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/6/X_？_8185_1.png`
- asset id: `asset-006043`
...
- source class: `HUST-OBC/undeciphered/X/6/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/6/X_？_8185_1.png`
- asset id: `asset-006043`
...
- English observation: `A triangular upper loop sits above a crossbar`
  `and long lower curve.`
- 中文观察: `三角上部环位于横线和下部长弧线之上。`
...
- Which source records identify obs-unk-004450 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004450？
