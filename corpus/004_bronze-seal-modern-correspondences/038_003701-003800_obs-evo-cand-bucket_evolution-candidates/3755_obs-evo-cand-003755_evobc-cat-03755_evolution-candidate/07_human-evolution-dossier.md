...
- Project ID: `obs-evo-cand-003755`
- EVOBC category candidate ID: `evobc-evo-cat-03755`
- External category reference: `evobc-cat-03755`
- Source category ID: `03755`
- Source label for human review: `晬`
- Source codepoints: `U+666C`
...
- `obs-evo-cand-003755-route-category-staging`
...
- `obs-evo-cand-003755-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003755-route-evolution-graph`
