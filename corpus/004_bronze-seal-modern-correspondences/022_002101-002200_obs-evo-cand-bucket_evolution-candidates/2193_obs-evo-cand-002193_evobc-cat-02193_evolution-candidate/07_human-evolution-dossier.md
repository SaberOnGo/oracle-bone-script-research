...
- External category reference: `evobc-cat-02193`
- Source category ID: `02193`
- Source label for human review: `婏`
- Source codepoints: `U+5A4F`
...
- `obs-evo-cand-002193-route-category-staging`
...
- `obs-evo-cand-002193-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002193-route-evolution-graph`
