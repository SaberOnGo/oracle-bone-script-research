...
- External category reference: `evobc-cat-01523`
- Source category ID: `01523`
- Source label for human review: `吹`
- Source codepoints: `U+5439`
- Image reference count in source metadata: `78`
...
- `obs-evo-cand-001523-route-category-staging`
...
- `obs-evo-cand-001523-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001523-route-evolution-graph`
