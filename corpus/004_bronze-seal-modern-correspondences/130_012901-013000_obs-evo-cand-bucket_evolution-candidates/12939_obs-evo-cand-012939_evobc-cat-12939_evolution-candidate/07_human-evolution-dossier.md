...
- External category reference: `evobc-cat-12939`
- Source category ID: `12939`
- Source label for human review: `𫐢`
...
- `obs-evo-cand-012939-route-category-staging`
...
- `obs-evo-cand-012939-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012939-route-evolution-graph`
