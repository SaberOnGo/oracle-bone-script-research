...
- External category reference: `evobc-cat-00619`
- Source category ID: `00619`
- Source label for human review: `丕`
...
- `obs-evo-cand-000619-route-category-staging`
...
- `obs-evo-cand-000619-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000619-route-evolution-graph`
