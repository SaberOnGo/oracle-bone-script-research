...
Project ID: `obs-evo-cand-006290`
...
- Project ID: `obs-evo-cand-006290`
- EVOBC category candidate ID: `evobc-evo-cat-06290`
- External category reference: `evobc-cat-06290`
- Source category ID: `06290`
- Source label for human review: `箑`
- Source codepoints: `U+7B91`
...
- `obs-evo-cand-006290-route-category-staging`
...
- `obs-evo-cand-006290-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006290-route-evolution-graph`
