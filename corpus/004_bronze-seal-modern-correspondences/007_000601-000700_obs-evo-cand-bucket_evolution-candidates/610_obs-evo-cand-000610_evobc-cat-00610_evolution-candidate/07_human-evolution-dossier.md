...
Project ID: `obs-evo-cand-000610`
...
- Project ID: `obs-evo-cand-000610`
- EVOBC category candidate ID: `evobc-evo-cat-00610`
- External category reference: `evobc-cat-00610`
- Source category ID: `00610`
- Source label for human review: `上`
- Source codepoints: `U+4E0A`
- Image reference count in source metadata: `218`
...
- `obs-evo-cand-000610-route-category-staging`
...
- `obs-evo-cand-000610-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000610-route-evolution-graph`
