# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004468
...
- EVOBC candidate category: `evobc-evo-cat-04468`.
- Source label for search only: `氏`.
- Source codepoints for search only: `U+6C0F`.
