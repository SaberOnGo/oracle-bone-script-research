...
- Project ID: `obs-evo-cand-006510`
- EVOBC category candidate ID: `evobc-evo-cat-06510`
- External category reference: `evobc-cat-06510`
- Source category ID: `06510`
- Source label for human review: `絟`
- Source codepoints: `U+7D5F`
...
- `obs-evo-cand-006510-route-category-staging`
...
- `obs-evo-cand-006510-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006510-route-evolution-graph`
