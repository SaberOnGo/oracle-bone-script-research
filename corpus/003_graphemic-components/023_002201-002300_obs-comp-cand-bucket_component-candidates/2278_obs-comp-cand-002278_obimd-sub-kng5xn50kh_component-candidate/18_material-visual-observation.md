# Material Visual Observation / obs-comp-cand-002278 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002278`
- External reference / 外部参照: `obimd-sub-kng5xn50kh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020162_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bke9bjpf9r/kng5xn50kh/kng5xn50kh.png`
- Checksum / 校验和:
  `852d186546739f65a5fc8f4fc3c2484b338230ea19ff6ffee43244fe49d44868`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.28%.
- Marked-pixel bounds: (81,44)–(168,201); span 88 × 158 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.28%。
- 痕迹范围：(81,44)–(168,201)；跨度88 × 158 px；痕迹矩形高于宽。
