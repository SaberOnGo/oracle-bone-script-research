...
Project ID: `obs-evo-cand-011693`
...
- Project ID: `obs-evo-cand-011693`
- EVOBC category candidate ID: `evobc-evo-cat-11693`
- External category reference: `evobc-cat-11693`
- Source category ID: `11693`
- Source label for human review: `𤶑`
- Source codepoints: `U+24D91`
...
- `obs-evo-cand-011693-route-category-staging`
...
- `obs-evo-cand-011693-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011693-route-evolution-graph`
