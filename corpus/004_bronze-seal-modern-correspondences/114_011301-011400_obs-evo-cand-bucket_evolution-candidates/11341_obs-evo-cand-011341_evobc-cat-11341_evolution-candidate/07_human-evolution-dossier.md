...
- Project ID: `obs-evo-cand-011341`
- EVOBC category candidate ID: `evobc-evo-cat-11341`
- External category reference: `evobc-cat-11341`
- Source category ID: `11341`
- Source label for human review: `𢽛`
- Source codepoints: `U+22F5B`
...
- `obs-evo-cand-011341-route-category-staging`
...
- `obs-evo-cand-011341-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011341-route-evolution-graph`
