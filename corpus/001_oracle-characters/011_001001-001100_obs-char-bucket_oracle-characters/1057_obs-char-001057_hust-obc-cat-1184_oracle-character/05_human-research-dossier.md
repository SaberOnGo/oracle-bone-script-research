# obs-char-001057 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001057`
- primary external id: `hust-obc-cat-1184`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1057_obs-char-001057_hust-obc-cat-1184_ora
  cle-character/03_visual-assets/001_asset-001062_hust-obc-cat-1184_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1184/L_1184_10664.jpg`
- asset id: `asset-001062`
...
- source category: `1184`
- validation class: `1056`
- source image route: `HUST-OBC/deciphered/1184/L_1184_10664.jpg`
- asset id: `asset-001062`
...
- English observation: `The faint gray image shows several small separated
  curved and branching marks; individual details are low contrast.`
- 中文观察: `较淡灰色图像显示数个分离的小型弯曲和分枝笔形；单笔细节对比度较低。`
...
- dataset label text: `㢖`
- dataset label codepoints: `U+3896`
...
- Which source records identify obs-char-001057 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001057？
