...
- External category reference: `evobc-cat-12239`
- Source category ID: `12239`
- Source label for human review: `𧪖`
- Source codepoints: `U+27A96`
...
- `obs-evo-cand-012239-route-category-staging`
...
- `obs-evo-cand-012239-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012239-route-evolution-graph`
