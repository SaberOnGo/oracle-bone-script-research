...
- External category reference: `evobc-cat-05066`
- Source category ID: `05066`
...
- `obs-evo-cand-005066-route-category-staging`
...
- `obs-evo-cand-005066-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005066-route-evolution-graph`
