...
- External category reference: `evobc-cat-00049`
- Source category ID: `00049`
- Source label for human review: `㚸`
- Source codepoints: `U+36B8`
- Image reference count in source metadata: `88`
...
- `obs-evo-cand-000049-route-category-staging`
...
- `obs-evo-cand-000049-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000049-route-evolution-graph`
