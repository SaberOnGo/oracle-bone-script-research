...
- External category reference: `evobc-cat-04112`
- Source category ID: `04112`
- Source label for human review: `棺`
- Source codepoints: `U+68FA`
...
- `obs-evo-cand-004112-route-category-staging`
...
- `obs-evo-cand-004112-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004112-route-evolution-graph`
