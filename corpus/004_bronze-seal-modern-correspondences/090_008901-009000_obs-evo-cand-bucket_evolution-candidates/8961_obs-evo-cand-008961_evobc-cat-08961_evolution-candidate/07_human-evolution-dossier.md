...
- Project ID: `obs-evo-cand-008961`
- EVOBC category candidate ID: `evobc-evo-cat-08961`
- External category reference: `evobc-cat-08961`
- Source category ID: `08961`
- Source label for human review: `迩`
- Source codepoints: `U+8FE9`
...
- `obs-evo-cand-008961-route-category-staging`
...
- `obs-evo-cand-008961-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008961-route-evolution-graph`
