# obs-evo-cand-002208 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-002208`
- EVOBC category candidate ID: `evobc-evo-cat-02208`
- External category ref: `evobc-cat-02208`
- Source label: `婦`
- Source codepoints: `U+5A66`
- Image reference count: `128`
- Era token counts: `BI:53;CS:1;OBC:33;SAC:7;SS:2;WSC:32`
- Source token counts: `Book:37;Web:91`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 33 image references
...
- source 1 / Web:105952;說文Web:58: 70 image references
