...
- Project ID / 项目 ID: `obs-char-000602`
- Primary external ID / 首选外部 ID: `hust-obc-cat-0686`
...
- Source image / 来源图: `X_0686_4935_1.png`
- Image / 图像: `001_asset-000607_hust-obc-cat-0686_glyph.png`
...
- target node: `evobc-evo-cat-00046`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC image references / EvoBC 图像引用数: `12`
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/046_obs-evo-cand-000046_evobc-cat-00046_evoluti
...
- Source label text / 来源标签文字: `㚤`
- Source label codepoint / 来源标签 codepoint: `U+36A4`
