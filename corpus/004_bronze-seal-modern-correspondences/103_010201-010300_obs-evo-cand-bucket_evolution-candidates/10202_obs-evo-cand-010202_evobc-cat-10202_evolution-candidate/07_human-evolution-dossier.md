...
- External category reference: `evobc-cat-10202`
- Source category ID: `10202`
- Source label for human review: `駸`
...
- `obs-evo-cand-010202-route-category-staging`
...
- `obs-evo-cand-010202-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010202-route-evolution-graph`
