# Material Visual Observation / obs-comp-cand-001468 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001468`
- External reference / 外部参照: `obimd-sub-ake9481rl7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016045_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ake9481rl7/ake9481rl7/ake9481rl7.png`
- Checksum / 校验和:
  `8179ea0ef1d4bee815f7a9b934a7b960da734bad1992b86ac111d0a314c562ae`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.67%.
- Marked-pixel bounds: (56,32)–(190,211); span 135 × 180 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.67%。
- 痕迹范围：(56,32)–(190,211)；跨度135 × 180 px；痕迹矩形高于宽。
