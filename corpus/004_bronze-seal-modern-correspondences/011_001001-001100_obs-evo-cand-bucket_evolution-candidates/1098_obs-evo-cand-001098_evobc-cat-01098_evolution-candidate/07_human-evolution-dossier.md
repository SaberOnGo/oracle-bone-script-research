...
Project ID: `obs-evo-cand-001098`
...
- Project ID: `obs-evo-cand-001098`
- EVOBC category candidate ID: `evobc-evo-cat-01098`
- External category reference: `evobc-cat-01098`
- Source category ID: `01098`
- Source label for human review: `兵`
- Source codepoints: `U+5175`
...
- `obs-evo-cand-001098-route-category-staging`
...
- `obs-evo-cand-001098-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001098-route-evolution-graph`
