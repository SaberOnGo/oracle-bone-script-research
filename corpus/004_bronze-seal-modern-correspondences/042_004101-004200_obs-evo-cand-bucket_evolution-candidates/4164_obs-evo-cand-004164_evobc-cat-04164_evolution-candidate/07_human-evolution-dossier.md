...
- External category reference: `evobc-cat-04164`
- Source category ID: `04164`
- Source label for human review: `業`
...
- `obs-evo-cand-004164-route-category-staging`
...
- `obs-evo-cand-004164-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004164-route-evolution-graph`
