...
Project ID: `obs-insc-cw-cand-000221`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000221`
...
- Source page section: `Period I Group 17` /
  `第 I 期第 17 组`
- Source section key: `period-i-group-17`
- Section declared count: `20`
- Section observed row count: `20`
...
- Yingguo / 英国所藏: `y1293` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `454` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `731` in source row; primary catalog entry pending
- Heji / 合集: `40541` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000221`
