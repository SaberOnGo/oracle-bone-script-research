...
- External category reference: `evobc-cat-09979`
- Source category ID: `09979`
- Source label for human review: `預`
...
- `obs-evo-cand-009979-route-category-staging`
...
- `obs-evo-cand-009979-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009979-route-evolution-graph`
