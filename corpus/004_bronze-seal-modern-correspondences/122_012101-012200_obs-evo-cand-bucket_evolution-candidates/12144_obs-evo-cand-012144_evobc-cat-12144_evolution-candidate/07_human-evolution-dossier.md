...
Project ID: `obs-evo-cand-012144`
...
- Project ID: `obs-evo-cand-012144`
- EVOBC category candidate ID: `evobc-evo-cat-12144`
- External category reference: `evobc-cat-12144`
- Source category ID: `12144`
- Source label for human review: `𧇮`
- Source codepoints: `U+271EE`
...
- `obs-evo-cand-012144-route-category-staging`
...
- `obs-evo-cand-012144-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012144-route-evolution-graph`
