...
- External category reference: `evobc-cat-11547`
- Source category ID: `11547`
- Source label for human review: `𤂊`
- Source codepoints: `U+2408A`
...
- `obs-evo-cand-011547-route-category-staging`
...
- `obs-evo-cand-011547-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011547-route-evolution-graph`
