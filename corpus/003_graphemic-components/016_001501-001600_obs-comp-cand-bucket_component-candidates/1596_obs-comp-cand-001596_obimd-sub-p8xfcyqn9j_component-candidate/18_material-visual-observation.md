# Material Visual Observation / obs-comp-cand-001596 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001596`
- External reference / 外部参照: `obimd-sub-p8xfcyqn9j`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017272_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/akt7yld9xk/p8xfcyqn9j/p8xfcyqn9j.png`
- Checksum / 校验和:
  `ff55057bd47dce328823b1a5b2bf39793ee247cbc51c792009b5242a842c7419`
...
- Marked-pixel bounds: (71,27)–(188,225); span 118 × 199 px; the marked
...
- 痕迹范围：(71,27)–(188,225)；跨度118 × 199 px；痕迹矩形高于宽。
