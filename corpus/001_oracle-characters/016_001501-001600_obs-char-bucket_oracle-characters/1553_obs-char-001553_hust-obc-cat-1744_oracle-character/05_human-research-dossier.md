# obs-char-001553 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1553_obs-char-001553_hust-obc-cat-1744_ora
  cle-character/03_visual-assets/001_asset-001558_hust-obc-cat-1744_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1744/G_1744_京津2231(甲).png`
- asset id: `asset-001558`
...
- source category: `1744`
- validation class: `1552`
- source image route: `HUST-OBC/deciphered/1744/G_1744_京津2231(甲).png`
- asset id: `asset-001558`
...
- English observation: `A broad U-shaped contour stands on two short legs
  above a horizontal base.`
...
- dataset label text: `㫆`
- dataset label codepoints: `U+3AC6`
...
- Which source records identify obs-char-001553 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001553？
