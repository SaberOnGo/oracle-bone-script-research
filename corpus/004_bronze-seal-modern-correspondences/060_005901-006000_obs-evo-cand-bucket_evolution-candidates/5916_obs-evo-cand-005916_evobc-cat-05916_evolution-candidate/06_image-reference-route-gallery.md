...
- `obs-evo-cand-005916-route-category-staging`
...
- `obs-evo-cand-005916-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005916-route-evolution-graph`
