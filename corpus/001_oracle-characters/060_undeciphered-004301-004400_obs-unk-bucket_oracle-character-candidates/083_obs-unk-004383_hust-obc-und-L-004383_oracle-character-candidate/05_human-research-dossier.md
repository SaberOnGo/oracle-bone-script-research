# obs-unk-004383 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004383`
- primary external id: `hust-obc-und-L-004383`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/083_obs-unk-004383_h
  ust-obc-und-L-004383_oracle-character-candidate/03_visual-assets/001_asset
  -005976_hust-obc-und-L-004383_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4383/L_？_9746.jpg`
- asset id: `asset-005976`
...
- source class: `HUST-OBC/undeciphered/L/4383/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4383/L_？_9746.jpg`
- asset id: `asset-005976`
...
- English observation: `A branching left cluster and a separate`
  `long right trace are visible.`
- 中文观察: `左侧有分叉痕迹群，右侧另有一条较长斜向痕迹。`
...
- Which source records identify obs-unk-004383 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004383？
