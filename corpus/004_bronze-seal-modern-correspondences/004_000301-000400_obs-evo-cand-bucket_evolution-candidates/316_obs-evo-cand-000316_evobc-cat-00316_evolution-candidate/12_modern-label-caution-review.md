# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000316
...
- EVOBC candidate category: `evobc-evo-cat-00316`.
- Source label for search only: `䊽`.
- Source codepoints for search only: `U+42BD`.
