# Material Visual Observation / obs-comp-cand-000380 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000380`
- External reference / 外部参照: `obimd-sub-8jgnyw54if`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012303_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fmv0hxp7i5/8jgnyw54if/8jgnyw54if.png`
- Checksum / 校验和:
  `2c716a462eb7384692c6bca42cc4394c04ca42b80bec2e4266ef9d925285ba65`
...
- Marked-pixel bounds: (70,29)–(179,221); span 110 × 193 px; the marked
...
- 痕迹范围：(70,29)–(179,221)；跨度110 × 193 px；痕迹矩形高于宽。
