# Material Visual Observation / obs-comp-cand-001142 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001142`
- External reference / 外部参照: `obimd-sub-c40r3zyq5t`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015136_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/c40r3zyq5t/c40r3zyq5t/1pb15ex6dd.png`
- Checksum / 校验和:
  `7ba84c17ee8c20f3324a48749f13cb08ebc4453b112e0a0e4808926271d0ec9d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.48%.
- Marked-pixel bounds: (82,28)–(165,214); span 84 × 187 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.48%。
- 痕迹范围：(82,28)–(165,214)；跨度84 × 187 px；痕迹矩形高于宽。
