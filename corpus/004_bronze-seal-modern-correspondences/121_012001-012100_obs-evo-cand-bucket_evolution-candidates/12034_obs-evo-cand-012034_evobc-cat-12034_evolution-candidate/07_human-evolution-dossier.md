...
- External category reference: `evobc-cat-12034`
- Source category ID: `12034`
- Source label for human review: `𦗛`
- Source codepoints: `U+265DB`
...
- `obs-evo-cand-012034-route-category-staging`
...
- `obs-evo-cand-012034-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012034-route-evolution-graph`
