...
- Project ID: `obs-evo-cand-000389`
- EVOBC category candidate ID: `evobc-evo-cat-00389`
- External category reference: `evobc-cat-00389`
- Source category ID: `00389`
- Source label for human review: `䔿`
- Source codepoints: `U+453F`
...
- `obs-evo-cand-000389-route-category-staging`
...
- `obs-evo-cand-000389-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000389-route-evolution-graph`
