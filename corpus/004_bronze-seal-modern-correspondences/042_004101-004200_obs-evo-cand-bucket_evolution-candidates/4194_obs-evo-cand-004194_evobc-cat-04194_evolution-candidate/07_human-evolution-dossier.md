...
Project ID: `obs-evo-cand-004194`
...
- Project ID: `obs-evo-cand-004194`
- EVOBC category candidate ID: `evobc-evo-cat-04194`
- External category reference: `evobc-cat-04194`
- Source category ID: `04194`
- Source label for human review: `榺`
- Source codepoints: `U+69BA`
...
- `obs-evo-cand-004194-route-category-staging`
...
- `obs-evo-cand-004194-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004194-route-evolution-graph`
