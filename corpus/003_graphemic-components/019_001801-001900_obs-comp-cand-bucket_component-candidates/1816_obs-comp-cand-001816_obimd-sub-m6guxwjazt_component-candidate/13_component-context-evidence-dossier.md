# obs-comp-cand-001816 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001816`
- 首选外部 ID: `obimd-sub-m6guxwjazt`
- OBIMD subcharacter UID: `m6guxwjazt`
- OBIMD main character UID: `m6guxwjazt`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+2A9C7;U+FA64B; U+FA64C; 另有 1 项
