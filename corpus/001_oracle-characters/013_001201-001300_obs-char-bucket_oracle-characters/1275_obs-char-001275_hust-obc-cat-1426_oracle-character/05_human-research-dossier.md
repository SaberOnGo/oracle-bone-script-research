# obs-char-001275 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001275`
- primary external id: `hust-obc-cat-1426`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1275_obs-char-001275_hust-obc-cat-1426_ora
  cle-character/03_visual-assets/001_asset-001280_hust-obc-cat-1426_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1426/G_1426_乙1002合21914子組.png`
- asset id: `asset-001280`
...
- source category: `1426`
- validation class: `1274`
- source image route: `HUST-OBC/deciphered/1426/G_1426_乙1002合21914子組.png`
- asset id: `asset-001280`
...
- English observation: `A small faint branching form has an angular upper
  fork, a short central crossing, and a curved lower stroke.`
- 中文观察: `小型较淡分枝形体有折角上部叉形、短中央交叉笔和弯曲下行笔画。`
...
- dataset label text: `㦈`
- dataset label codepoints: `U+3988`
...
- filename catalog route clues: `Heji-like filename clue: 合21914
  (G_1426_乙1002合21914子組.png)`
...
- Which source records identify obs-char-001275 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001275？
