...
- External category reference: `evobc-cat-00270`
- Source category ID: `00270`
- Source label for human review: `䀊`
...
- `obs-evo-cand-000270-route-category-staging`
...
- `obs-evo-cand-000270-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000270-route-evolution-graph`
