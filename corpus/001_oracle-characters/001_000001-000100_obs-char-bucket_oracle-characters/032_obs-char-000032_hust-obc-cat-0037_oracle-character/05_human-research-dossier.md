# obs-char-000032 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/032_obs-char-000032_hust-obc-cat-0037_orac
  le-character/03_visual-assets/001_asset-000037_hust-obc-cat-0037_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0037/L_0037_1370.jpg`
- asset id: `asset-000037`
...
- source category: `0037`
- validation class: `31`
- source image route: `HUST-OBC/deciphered/0037/L_0037_1370.jpg`
- asset id: `asset-000037`
...
- English observation: `The small gray image shows a short horizontal mark,
  a central upright stroke, and an angular lower hook.`
- 中文观察: `小型灰度图像有短横痕、中央竖向笔画和下部折角钩状痕迹。`
...
- dataset label text: `㐛`
- dataset label codepoints: `U+341B`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/004_obs-evo-can
  d-000004_evobc-cat-00004_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/004_obs-evo-cand-000004_evobc-cat-00004_evolu
...
- Which source records identify obs-char-000032 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000032？
