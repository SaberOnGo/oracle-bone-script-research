# obs-unk-004424 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/024_obs-unk-004424_h
  ust-obc-und-L-004424_oracle-character-candidate/03_visual-assets/001_asset
  -006017_hust-obc-und-L-004424_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4424/L_？_9911.jpg`
- asset id: `asset-006017`
...
- source class: `HUST-OBC/undeciphered/L/4424/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4424/L_？_9911.jpg`
- asset id: `asset-006017`
...
- English observation: `Crossed upper traces sit above a rounded lower outline.`
- 中文观察: `上部交叉痕迹位于下部圆弧轮廓之上。`
...
- Which source records identify obs-unk-004424 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004424？
