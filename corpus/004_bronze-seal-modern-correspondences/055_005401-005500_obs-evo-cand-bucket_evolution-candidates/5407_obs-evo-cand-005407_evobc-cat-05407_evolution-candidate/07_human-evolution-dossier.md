...
Project ID: `obs-evo-cand-005407`
...
- Project ID: `obs-evo-cand-005407`
- EVOBC category candidate ID: `evobc-evo-cat-05407`
- External category reference: `evobc-cat-05407`
- Source category ID: `05407`
- Source label for human review: `琟`
- Source codepoints: `U+741F`
...
- `obs-evo-cand-005407-route-category-staging`
...
- `obs-evo-cand-005407-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005407-route-evolution-graph`
