...
- External category reference: `evobc-cat-02227`
- Source category ID: `02227`
- Source label: `媐`
...
- `obs-evo-cand-002227-route-category-staging`
...
- `obs-evo-cand-002227-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-002227-route-evolution-graph`
