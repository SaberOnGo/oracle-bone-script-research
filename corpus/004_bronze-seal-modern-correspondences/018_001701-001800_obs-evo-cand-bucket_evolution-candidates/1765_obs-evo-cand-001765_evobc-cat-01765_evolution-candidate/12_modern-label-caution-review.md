# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001765
...
- EVOBC candidate category: `evobc-evo-cat-01765`.
- Source label for search only: `困`.
- Source codepoints for search only: `U+56F0`.
