# obs-unk-002682 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002682`
- primary external id: `hust-obc-und-L-002682`
...
- local review image route: `corpus/001_oracle-characters/043_undeciphered-002
  601-002700_obs-unk-bucket_oracle-character-candidates/082_obs-unk-002682_h
  ust-obc-und-L-002682_oracle-character-candidate/03_visual-assets/001_asset
  -004275_hust-obc-und-L-002682_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2682/L_？_419.jpg`
- asset id: `asset-004275`
...
- source class: `HUST-OBC/undeciphered/L/2682/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2682/L_？_419.jpg`
- asset id: `asset-004275`
...
- Which source records identify obs-unk-002682 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002682？
