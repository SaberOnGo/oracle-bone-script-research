...
Project ID: `obs-evo-cand-011868`
...
- Project ID: `obs-evo-cand-011868`
- EVOBC category candidate ID: `evobc-evo-cat-11868`
- External category reference: `evobc-cat-11868`
- Source category ID: `11868`
- Source label for human review: `𥫧`
- Source codepoints: `U+25AE7`
...
- `obs-evo-cand-011868-route-category-staging`
...
- `obs-evo-cand-011868-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011868-route-evolution-graph`
