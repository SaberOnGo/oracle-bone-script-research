...
- External category reference: `evobc-cat-05973`
- Source category ID: `05973`
- Source label for human review: `祆`
...
- `obs-evo-cand-005973-route-category-staging`
...
- `obs-evo-cand-005973-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005973-route-evolution-graph`
