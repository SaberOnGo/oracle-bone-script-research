...
- External category reference: `evobc-cat-06371`
- Source category ID: `06371`
- Source label for human review: `籒`
...
- `obs-evo-cand-006371-route-category-staging`
...
- `obs-evo-cand-006371-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006371-route-evolution-graph`
