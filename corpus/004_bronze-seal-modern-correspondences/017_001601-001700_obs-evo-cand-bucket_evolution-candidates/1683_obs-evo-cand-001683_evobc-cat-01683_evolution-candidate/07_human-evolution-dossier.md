...
- External category reference: `evobc-cat-01683`
- Source category ID: `01683`
- Source label for human review: `嗼`
- Source codepoints: `U+55FC`
...
- `obs-evo-cand-001683-route-category-staging`
...
- `obs-evo-cand-001683-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001683-route-evolution-graph`
