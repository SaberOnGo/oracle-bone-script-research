...
Project ID: `obs-evo-cand-006127`
...
- Project ID: `obs-evo-cand-006127`
- EVOBC category candidate ID: `evobc-evo-cat-06127`
- External category reference: `evobc-cat-06127`
- Source category ID: `06127`
- Source label for human review: `穌`
- Source codepoints: `U+7A4C`
- Image reference count in source metadata: `28`
...
- `obs-evo-cand-006127-route-category-staging`
...
- `obs-evo-cand-006127-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006127-route-evolution-graph`
