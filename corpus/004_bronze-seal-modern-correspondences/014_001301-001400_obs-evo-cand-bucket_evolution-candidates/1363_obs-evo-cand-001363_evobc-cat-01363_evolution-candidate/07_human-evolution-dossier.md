...
- External category reference: `evobc-cat-01363`
- Source category ID: `01363`
- Source label for human review: `卂`
...
- `obs-evo-cand-001363-route-category-staging`
...
- `obs-evo-cand-001363-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001363-route-evolution-graph`
