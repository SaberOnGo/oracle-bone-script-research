...
- External category reference: `evobc-cat-08033`
- Source category ID: `08033`
- Source label for human review: `襗`
- Source codepoints: `U+8957`
...
- `obs-evo-cand-008033-route-category-staging`
...
- `obs-evo-cand-008033-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008033-route-evolution-graph`
