# obs-unk-007628 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-007628`
- primary external id: `hust-obc-und-YH-007628`
...
- local review image route: `corpus/001_oracle-characters/093_undeciphered-007
  601-007700_obs-unk-bucket_oracle-character-candidates/028_obs-unk-007628_h
  ust-obc-und-YH-007628_oracle-character-candidate/03_visual-assets/001_asse
  t-009219_hust-obc-und-YH-007628_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/601AA/H_？_601AA_0.png`
- asset id: `asset-009219`
...
- source class: `HUST-OBC/undeciphered/Y+H/601AA/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/601AA/H_？_601AA_0.png`
- asset id: `asset-009219`
...
- Which source records identify obs-unk-007628 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007628？
