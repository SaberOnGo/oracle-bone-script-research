...
Project ID: `obs-evo-cand-002281`
...
- Project ID: `obs-evo-cand-002281`
- EVOBC category candidate ID: `evobc-evo-cat-02281`
- External category reference: `evobc-cat-02281`
- Source category ID: `02281`
- Source label for human review: `嫵`
- Source codepoints: `U+5AF5`
...
- `obs-evo-cand-002281-route-category-staging`
...
- `obs-evo-cand-002281-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002281-route-evolution-graph`
