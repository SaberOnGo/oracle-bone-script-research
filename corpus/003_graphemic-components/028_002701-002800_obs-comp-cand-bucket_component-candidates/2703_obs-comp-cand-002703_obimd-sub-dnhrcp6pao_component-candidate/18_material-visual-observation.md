# Material Visual Observation / obs-comp-cand-002703 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002703`
- External reference / 外部参照: `obimd-sub-dnhrcp6pao`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021279_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dnhrcp6pao/dnhrcp6pao/dnhrcp6pao.png`
- Checksum / 校验和:
  `1920f623ff39b7c6512d11749b40b0f174f46eb89d1ed1342f49698fc3e95c72`
...
- Marked-pixel bounds: (91,15)–(153,232); span 63 × 218 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.69%。
- 痕迹范围：(91,15)–(153,232)；跨度63 × 218 px；痕迹矩形高于宽。
