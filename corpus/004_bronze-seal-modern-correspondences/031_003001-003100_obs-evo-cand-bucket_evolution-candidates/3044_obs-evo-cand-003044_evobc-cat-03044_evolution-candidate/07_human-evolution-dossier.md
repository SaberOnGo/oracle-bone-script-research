...
- External category reference: `evobc-cat-03044`
- Source category ID: `03044`
- Source label for human review: `惎`
...
- `obs-evo-cand-003044-route-category-staging`
...
- `obs-evo-cand-003044-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003044-route-evolution-graph`
