...
- External category reference: `evobc-cat-02872`
- Source category ID: `02872`
- Source label for human review: `得`
- Source codepoints: `U+5F97`
- Image reference count in source metadata: `296`
...
- `obs-evo-cand-002872-route-category-staging`
...
- `obs-evo-cand-002872-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002872-route-evolution-graph`
