...
Project ID: `obs-evo-cand-007771`
...
- Project ID: `obs-evo-cand-007771`
- EVOBC category candidate ID: `evobc-evo-cat-07771`
- External category reference: `evobc-cat-07771`
- Source category ID: `07771`
- Source label for human review: `蜆`
- Source codepoints: `U+8706`
...
- `obs-evo-cand-007771-route-category-staging`
...
- `obs-evo-cand-007771-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007771-route-evolution-graph`
