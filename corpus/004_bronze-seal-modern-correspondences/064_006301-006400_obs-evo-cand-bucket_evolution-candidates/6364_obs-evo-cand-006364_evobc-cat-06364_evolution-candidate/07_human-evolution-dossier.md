...
- External category reference: `evobc-cat-06364`
- Source category ID: `06364`
- Source label for human review: `籀`
- Source codepoints: `U+7C40`
...
- `obs-evo-cand-006364-route-category-staging`
...
- `obs-evo-cand-006364-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006364-route-evolution-graph`
