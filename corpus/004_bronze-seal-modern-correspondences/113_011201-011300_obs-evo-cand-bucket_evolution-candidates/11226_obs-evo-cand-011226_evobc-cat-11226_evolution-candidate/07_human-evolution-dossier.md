...
- External category reference: `evobc-cat-11226`
- Source category ID: `11226`
- Source label for human review: `𢘲`
- Source codepoints: `U+22632`
...
- `obs-evo-cand-011226-route-category-staging`
...
- `obs-evo-cand-011226-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011226-route-evolution-graph`
