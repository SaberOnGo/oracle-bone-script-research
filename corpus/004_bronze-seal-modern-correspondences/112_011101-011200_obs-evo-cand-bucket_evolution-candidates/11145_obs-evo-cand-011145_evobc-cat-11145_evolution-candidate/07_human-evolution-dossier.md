...
Project ID: `obs-evo-cand-011145`
...
- Project ID: `obs-evo-cand-011145`
- EVOBC category candidate ID: `evobc-evo-cat-11145`
- External category reference: `evobc-cat-11145`
- Source category ID: `11145`
- Source label for human review: `𢅒`
- Source codepoints: `U+22152`
...
- `obs-evo-cand-011145-route-category-staging`
...
- `obs-evo-cand-011145-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011145-route-evolution-graph`
