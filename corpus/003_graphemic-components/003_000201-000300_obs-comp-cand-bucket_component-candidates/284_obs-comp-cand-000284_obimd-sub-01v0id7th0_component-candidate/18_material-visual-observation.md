# Material Visual Observation / obs-comp-cand-000284 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000284`
- External reference / 外部参照: `obimd-sub-01v0id7th0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011926_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/01v0id7th0/01v0id7th0/01v0id7th0.png`
- Checksum / 校验和:
  `9a01a6caaa20e272236f9792bc43535d0093b898e0512ab16a0b84fac912bfe8`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.71%.
- Marked-pixel bounds: (72,31)–(177,217); span 106 × 187 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.71%。
- 痕迹范围：(72,31)–(177,217)；跨度106 × 187 px；痕迹矩形高于宽。
