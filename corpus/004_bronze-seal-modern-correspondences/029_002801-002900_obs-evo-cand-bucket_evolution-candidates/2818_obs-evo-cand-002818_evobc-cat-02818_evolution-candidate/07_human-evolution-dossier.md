...
- External category reference: `evobc-cat-02818`
- Source category ID: `02818`
- Source label for human review: `强`
...
- `obs-evo-cand-002818-route-category-staging`
...
- `obs-evo-cand-002818-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002818-route-evolution-graph`
