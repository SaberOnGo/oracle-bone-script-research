# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013520
...
- EVOBC candidate category: `evobc-evo-cat-13520`.
- Source label for search only: `𭚱`.
- Source codepoints for search only: `U+2D6B1`.
