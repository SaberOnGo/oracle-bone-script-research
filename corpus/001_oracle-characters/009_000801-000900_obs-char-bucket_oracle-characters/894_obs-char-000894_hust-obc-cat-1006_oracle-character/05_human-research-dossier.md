# obs-char-000894 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000894`
- primary external id: `hust-obc-cat-1006`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/894_obs-char-000894_hust-obc-cat-1006_orac
  le-character/03_visual-assets/001_asset-000899_hust-obc-cat-1006_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1006/G_1006_甲骨文.png`
- asset id: `asset-000899`
...
- source category: `1006`
- validation class: `893`
- source image route: `HUST-OBC/deciphered/1006/G_1006_甲骨文.png`
- asset id: `asset-000899`
...
- English observation: `A long curved stroke at left stands apart from an
  angular right-hand cluster with a pointed upper form and several
  descending strokes.`
- 中文观察: `左侧长弯曲笔与右侧折角笔群分离，右侧有尖形上部和数条下行笔。`
...
- dataset label text: `㟤`
- dataset label codepoints: `U+37E4`
...
- Which source records identify obs-char-000894 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000894？
