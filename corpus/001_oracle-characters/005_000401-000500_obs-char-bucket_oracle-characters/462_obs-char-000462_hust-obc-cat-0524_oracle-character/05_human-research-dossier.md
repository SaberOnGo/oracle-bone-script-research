# obs-char-000462 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000462`
- primary external id: `hust-obc-cat-0524`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/462_obs-char-000462_hust-obc-cat-0524_orac
  le-character/03_visual-assets/001_asset-000467_hust-obc-cat-0524_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0524/L_0524_1187.jpg`
- asset id: `asset-000467`
...
- source category: `0524`
- validation class: `461`
- source image route: `HUST-OBC/deciphered/0524/L_0524_1187.jpg`
- asset id: `asset-000467`
...
- English observation: `The small low-contrast image shows an arched outer
  outline with several thin descending inner strokes; their lower boundaries
...
- dataset label text: `㘂`
- dataset label codepoints: `U+3602`
...
- Which source records identify obs-char-000462 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000462？
