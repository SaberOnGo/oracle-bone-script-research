# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002918
...
- EVOBC candidate category: `evobc-evo-cat-02918`.
- Source label for search only: `忮`.
- Source codepoints for search only: `U+5FEE`.
