...
- Project ID: `obs-evo-cand-009579`
- EVOBC category candidate ID: `evobc-evo-cat-09579`
- External category reference: `evobc-cat-09579`
- Source category ID: `09579`
- Source label for human review: `铃`
- Source codepoints: `U+94C3`
...
- `obs-evo-cand-009579-route-category-staging`
...
- `obs-evo-cand-009579-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009579-route-evolution-graph`
