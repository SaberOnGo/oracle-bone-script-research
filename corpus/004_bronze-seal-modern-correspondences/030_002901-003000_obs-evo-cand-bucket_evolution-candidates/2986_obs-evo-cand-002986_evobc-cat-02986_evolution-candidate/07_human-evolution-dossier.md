...
Project ID: `obs-evo-cand-002986`
...
- Project ID: `obs-evo-cand-002986`
- EVOBC category candidate ID: `evobc-evo-cat-02986`
- External category reference: `evobc-cat-02986`
- Source category ID: `02986`
- Source label for human review: `恫`
- Source codepoints: `U+606B`
...
- `obs-evo-cand-002986-route-category-staging`
...
- `obs-evo-cand-002986-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002986-route-evolution-graph`
