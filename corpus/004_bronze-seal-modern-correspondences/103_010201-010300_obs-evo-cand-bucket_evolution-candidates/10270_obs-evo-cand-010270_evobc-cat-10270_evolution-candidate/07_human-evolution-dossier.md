...
- Project ID: `obs-evo-cand-010270`
- EVOBC category candidate ID: `evobc-evo-cat-10270`
- External category reference: `evobc-cat-10270`
- Source category ID: `10270`
- Source label for human review: `驭`
- Source codepoints: `U+9A6D`
...
- `obs-evo-cand-010270-route-category-staging`
...
- `obs-evo-cand-010270-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010270-route-evolution-graph`
