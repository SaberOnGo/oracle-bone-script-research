# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000610
...
- EVOBC candidate category: `evobc-evo-cat-00610`.
- Source label for search only: `上`.
- Source codepoints for search only: `U+4E0A`.
