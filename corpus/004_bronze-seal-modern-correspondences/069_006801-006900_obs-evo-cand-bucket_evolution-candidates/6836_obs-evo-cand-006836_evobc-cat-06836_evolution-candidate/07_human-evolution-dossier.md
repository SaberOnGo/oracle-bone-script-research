...
Project ID: `obs-evo-cand-006836`
...
- Project ID: `obs-evo-cand-006836`
- EVOBC category candidate ID: `evobc-evo-cat-06836`
- External category reference: `evobc-cat-06836`
- Source category ID: `06836`
- Source label for human review: `羊`
- Source codepoints: `U+7F8A`
...
- `obs-evo-cand-006836-route-category-staging`
...
- `obs-evo-cand-006836-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006836-route-evolution-graph`
