# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004262
...
- EVOBC candidate category: `evobc-evo-cat-04262`.
- Source label for search only: `橌`.
- Source codepoints for search only: `U+6A4C`.
