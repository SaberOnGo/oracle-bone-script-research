...
- External category reference: `evobc-cat-09672`
- Source category ID: `09672`
- Source label for human review: `闪`
...
- `obs-evo-cand-009672-route-category-staging`
...
- `obs-evo-cand-009672-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009672-route-evolution-graph`
