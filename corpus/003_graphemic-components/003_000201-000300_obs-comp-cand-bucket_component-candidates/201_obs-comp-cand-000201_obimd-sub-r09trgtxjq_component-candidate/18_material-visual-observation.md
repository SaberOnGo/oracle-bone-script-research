# Material Visual Observation / obs-comp-cand-000201 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000201`
- External reference / 外部参照: `obimd-sub-r09trgtxjq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011762_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/r09trgtxjq/r09trgtxjq/r09trgtxjq.png`
- Checksum / 校验和:
  `7ca4d36d3dcc36e41a6a2fdd2a9cb312e9d6b04d6367145c191eec7e3ee0ec94`
...
- Marked-pixel bounds: (88,14)–(161,237); span 74 × 224 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.29%。
- 痕迹范围：(88,14)–(161,237)；跨度74 × 224 px；痕迹矩形高于宽。
