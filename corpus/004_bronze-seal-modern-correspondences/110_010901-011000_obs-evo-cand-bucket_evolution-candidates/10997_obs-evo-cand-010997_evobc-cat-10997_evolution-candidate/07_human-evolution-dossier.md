...
- External category reference: `evobc-cat-10997`
- Source category ID: `10997`
- Source label for human review: `𡏀`
...
- `obs-evo-cand-010997-route-category-staging`
...
- `obs-evo-cand-010997-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010997-route-evolution-graph`
