...
- External category reference: `evobc-cat-05652`
- Source category ID: `05652`
- Source label for human review: `痰`
- Source codepoints: `U+75F0`
...
- `obs-evo-cand-005652-route-category-staging`
...
- `obs-evo-cand-005652-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005652-route-evolution-graph`
