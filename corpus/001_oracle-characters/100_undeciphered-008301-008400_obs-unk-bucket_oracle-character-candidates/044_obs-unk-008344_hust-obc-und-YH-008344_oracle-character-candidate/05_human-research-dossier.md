# obs-unk-008344 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008344`
- primary external id: `hust-obc-und-YH-008344`
...
- local review image route: `corpus/001_oracle-characters/100_undeciphered-008
  301-008400_obs-unk-bucket_oracle-character-candidates/044_obs-unk-008344_h
  ust-obc-und-YH-008344_oracle-character-candidate/03_visual-assets/001_asse
  t-009935_hust-obc-und-YH-008344_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60A02/Y_？_60A02.jpg`
- asset id: `asset-009935`
...
- source class: `HUST-OBC/undeciphered/Y+H/60A02/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60A02/Y_？_60A02.jpg`
- asset id: `asset-009935`
...
- Which source records identify obs-unk-008344 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008344？
