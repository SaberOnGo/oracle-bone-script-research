...
- `obs-evo-cand-006587-route-category-staging`
...
- `obs-evo-cand-006587-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006587-route-evolution-graph`
