# obs-comp-cand-002356 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002356`
- 首选外部 ID: `obimd-sub-o75vmzxbse`
- OBIMD subcharacter UID: `o75vmzxbse`
- OBIMD main character UID: `o75vmzxbse`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+BD88E;U+FD781; U+FD782; 另有 3 项
