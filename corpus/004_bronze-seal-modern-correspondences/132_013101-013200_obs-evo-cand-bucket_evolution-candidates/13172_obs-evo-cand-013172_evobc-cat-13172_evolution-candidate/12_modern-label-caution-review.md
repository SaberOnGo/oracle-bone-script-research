# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013172
...
- EVOBC candidate category: `evobc-evo-cat-13172`.
- Source label for search only: `𫾼`.
- Source codepoints for search only: `U+2BFBC`.
