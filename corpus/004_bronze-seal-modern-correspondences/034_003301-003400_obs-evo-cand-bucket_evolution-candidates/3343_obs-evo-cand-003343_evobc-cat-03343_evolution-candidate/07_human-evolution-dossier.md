...
Project ID: `obs-evo-cand-003343`
...
- Project ID: `obs-evo-cand-003343`
- EVOBC category candidate ID: `evobc-evo-cat-03343`
- External category reference: `evobc-cat-03343`
- Source category ID: `03343`
- Source label for human review: `挋`
- Source codepoints: `U+630B`
...
- `obs-evo-cand-003343-route-category-staging`
...
- `obs-evo-cand-003343-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003343-route-evolution-graph`
