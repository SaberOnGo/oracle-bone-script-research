...
Project ID: `obs-evo-cand-003941`
...
- Project ID: `obs-evo-cand-003941`
- EVOBC category candidate ID: `evobc-evo-cat-03941`
- External category reference: `evobc-cat-03941`
- Source category ID: `03941`
- Source label for human review: `枹`
- Source codepoints: `U+67B9`
...
- `obs-evo-cand-003941-route-category-staging`
...
- `obs-evo-cand-003941-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003941-route-evolution-graph`
