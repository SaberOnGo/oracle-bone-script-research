...
- External category reference: `evobc-cat-05650`
- Source category ID: `05650`
- Source label for human review: `痦`
- Source codepoints: `U+75E6`
...
- `obs-evo-cand-005650-route-category-staging`
...
- `obs-evo-cand-005650-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005650-route-evolution-graph`
