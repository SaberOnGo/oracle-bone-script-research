# Material Visual Observation / obs-comp-cand-002573 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002573`
- External reference / 外部参照: `obimd-sub-59ts5ymavk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021105_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/59ts5ymavk/59ts5ymavk/59ts5ymavk.png`
- Checksum / 校验和:
  `0f7667d38d3be0db3aa6ef95aacf627a65b22965907bd34bbaf062fbcf011a61`
...
- Marked-pixel bounds: (74,50)–(175,191); span 102 × 142 px; the marked
...
- 痕迹范围：(74,50)–(175,191)；跨度102 × 142 px；痕迹矩形高于宽。
