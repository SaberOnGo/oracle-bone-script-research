...
- External category reference: `evobc-cat-02774`
- Source category ID: `02774`
- Source label for human review: `廳`
- Source codepoints: `U+5EF3`
...
- `obs-evo-cand-002774-route-category-staging`
...
- `obs-evo-cand-002774-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002774-route-evolution-graph`
