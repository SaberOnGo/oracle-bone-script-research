# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008278
...
- EVOBC candidate category: `evobc-evo-cat-08278`.
- Source label for search only: `諟`.
- Source codepoints for search only: `U+8ADF`.
