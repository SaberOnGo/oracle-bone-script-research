...
Project ID: `obs-evo-cand-006644`
...
- Project ID: `obs-evo-cand-006644`
- EVOBC category candidate ID: `evobc-evo-cat-06644`
- External category reference: `evobc-cat-06644`
- Source category ID: `06644`
- Source label for human review: `縬`
- Source codepoints: `U+7E2C`
...
- `obs-evo-cand-006644-route-category-staging`
...
- `obs-evo-cand-006644-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006644-route-evolution-graph`
