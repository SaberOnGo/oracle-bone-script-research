# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008148
...
- EVOBC candidate category: `evobc-evo-cat-08148`.
- Source label for search only: `訥`.
- Source codepoints for search only: `U+8A25`.
