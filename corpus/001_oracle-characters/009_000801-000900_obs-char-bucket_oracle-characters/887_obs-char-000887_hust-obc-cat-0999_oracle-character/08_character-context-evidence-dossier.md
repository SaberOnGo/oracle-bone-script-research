...
- Project ID / 项目 ID: `obs-char-000887`
- Primary external ID / 首选外部 ID: `hust-obc-cat-0999`
...
- Source image / 来源图: `G_0999_前1.3.5(甲).png`
- Image / 图像: `001_asset-000892_hust-obc-cat-0999_glyph.png`
...
- Source label text / 来源标签文字: `㟝`
- Source label codepoint / 来源标签 codepoint: `U+37DD`
