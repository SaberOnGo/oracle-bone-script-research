# obs-unk-004515 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004515`
- primary external id: `hust-obc-und-X-004515`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/015_obs-unk-004515_h
  ust-obc-und-X-004515_oracle-character-candidate/03_visual-assets/001_asset
  -006108_hust-obc-und-X-004515_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/71/X_？_8255_1.png`
- asset id: `asset-006108`
...
- source class: `HUST-OBC/undeciphered/X/71/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/71/X_？_8255_1.png`
- asset id: `asset-006108`
...
- English observation: `The upper slopes, right projection, lower opening,
  central stem, and left branch are directly recorded.`
- 中文观察: `已直接记录上部斜痕、右侧外伸、下部空白、中央下痕和左分支。`
...
- Which source records identify obs-unk-004515 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004515？
