# obs-unk-003983 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/083_obs-unk-003983_h
  ust-obc-und-L-003983_oracle-character-candidate/03_visual-assets/001_asset
  -005576_hust-obc-und-L-003983_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3983/L_？_8431.jpg`
- asset id: `asset-005576`
...
- source class: `HUST-OBC/undeciphered/L/3983/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3983/L_？_8431.jpg`
- asset id: `asset-005576`
...
- English observation: Slanting traces cross a narrow center, with short side
  strokes and a darker lower trace toward the right.
- 中文观察：斜向痕迹交叉于较窄中央，两侧有短痕，右下方有较深痕迹。
...
- Which source records identify obs-unk-003983 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003983？
