...
- External category reference: `evobc-cat-10301`
- Source category ID: `10301`
- Source label for human review: `髍`
- Source codepoints: `U+9ACD`
...
- `obs-evo-cand-010301-route-category-staging`
...
- `obs-evo-cand-010301-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010301-route-evolution-graph`
