# obs-unk-002627 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002627`
- primary external id: `hust-obc-und-L-002627`
...
- local review image route: `corpus/001_oracle-characters/043_undeciphered-002
  601-002700_obs-unk-bucket_oracle-character-candidates/027_obs-unk-002627_h
  ust-obc-und-L-002627_oracle-character-candidate/03_visual-assets/001_asset
  -004220_hust-obc-und-L-002627_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2627/L_？_4091.jpg`
- asset id: `asset-004220`
...
- source class: `HUST-OBC/undeciphered/L/2627/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2627/L_？_4091.jpg`
- asset id: `asset-004220`
...
- Which source records identify obs-unk-002627 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002627？
