# Material Visual Observation / obs-comp-cand-000878 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000878`
- External reference / 外部参照: `obimd-sub-8vy37l4z17`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013950_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/o6m37o3l7o/8vy37l4z17/8vy37l4z17.png`
- Checksum / 校验和:
  `1c970d6402f5004d2b0caa58d5c8473b2344bdbc845270d12c913a7c7e103837`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.75%.
- Marked-pixel bounds: (111,28)–(142,224); span 32 × 197 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.75%。
- 痕迹范围：(111,28)–(142,224)；跨度32 × 197 px；痕迹矩形高于宽。
