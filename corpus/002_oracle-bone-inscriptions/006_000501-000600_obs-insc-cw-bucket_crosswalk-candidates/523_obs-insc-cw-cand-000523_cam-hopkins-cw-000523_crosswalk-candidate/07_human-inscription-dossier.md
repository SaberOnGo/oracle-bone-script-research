...
- Yingguo / 英国所藏: `y2513` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `353` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `334` in source row; primary catalog entry pending
- Heji / 合集: `41695` in source row; primary catalog entry pending
