# Material Visual Observation / obs-comp-cand-001323 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001323`
- External reference / 外部参照: `obimd-sub-kmbtnosiha`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015660_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kmbtnosiha/kmbtnosiha/kmbtnosiha.png`
- Checksum / 校验和:
  `c725e6e2309a4ce0b05ba4f1a74b8464689e91254d3c6a58a99e1c732ab4de07`
...
- Marked-pixel bounds: (90,39)–(159,214); span 70 × 176 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.69%。
- 痕迹范围：(90,39)–(159,214)；跨度70 × 176 px；痕迹矩形高于宽。
