...
Project ID: `obs-evo-cand-003127`
...
- Project ID: `obs-evo-cand-003127`
- EVOBC category candidate ID: `evobc-evo-cat-03127`
- External category reference: `evobc-cat-03127`
- Source category ID: `03127`
- Source label for human review: `慮`
- Source codepoints: `U+616E`
...
- `obs-evo-cand-003127-route-category-staging`
...
- `obs-evo-cand-003127-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003127-route-evolution-graph`
