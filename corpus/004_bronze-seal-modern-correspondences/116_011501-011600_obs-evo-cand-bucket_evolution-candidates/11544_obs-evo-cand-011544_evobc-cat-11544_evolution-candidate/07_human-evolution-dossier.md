...
- External category reference: `evobc-cat-11544`
- Source category ID: `11544`
- Source label for human review: `𤀑`
- Source codepoints: `U+24011`
...
- `obs-evo-cand-011544-route-category-staging`
...
- `obs-evo-cand-011544-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011544-route-evolution-graph`
