# Material Visual Observation / obs-comp-cand-002528 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002528`
- External reference / 外部参照: `obimd-sub-1s5t2e9cdw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020986_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1s5t2e9cdw/1s5t2e9cdw/04atdbzsu1.png`
- Checksum / 校验和:
  `ccd7034bf2f5ba0133c1fc7c2d7294b4e3b7e1b5cb6459107a358af2fbef6f63`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.12%.
- Marked-pixel bounds: (66,36)–(183,208); span 118 × 173 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.12%。
- 痕迹范围：(66,36)–(183,208)；跨度118 × 173 px；痕迹矩形高于宽。
