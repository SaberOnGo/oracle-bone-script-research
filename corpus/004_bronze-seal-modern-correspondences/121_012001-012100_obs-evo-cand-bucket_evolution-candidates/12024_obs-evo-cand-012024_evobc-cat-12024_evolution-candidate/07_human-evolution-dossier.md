...
- Project ID: `obs-evo-cand-012024`
- EVOBC category candidate ID: `evobc-evo-cat-12024`
- External category reference: `evobc-cat-12024`
- Source category ID: `12024`
- Source label for human review: `𦓚`
- Source codepoints: `U+264DA`
...
- `obs-evo-cand-012024-route-category-staging`
...
- `obs-evo-cand-012024-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012024-route-evolution-graph`
