...
- External category reference: `evobc-cat-11161`
- Source category ID: `11161`
- Source label for human review: `𢌟`
...
- `obs-evo-cand-011161-route-category-staging`
...
- `obs-evo-cand-011161-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011161-route-evolution-graph`
