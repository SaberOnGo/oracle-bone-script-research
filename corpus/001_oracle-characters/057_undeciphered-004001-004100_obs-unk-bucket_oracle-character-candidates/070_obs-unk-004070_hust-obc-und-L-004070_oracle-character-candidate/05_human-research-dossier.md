# obs-unk-004070 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004070`
- primary external id: `hust-obc-und-L-004070`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/070_obs-unk-004070_h
  ust-obc-und-L-004070_oracle-character-candidate/03_visual-assets/001_asset
  -005663_hust-obc-und-L-004070_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4070/L_？_8715.jpg`
- asset id: `asset-005663`
...
- source class: `HUST-OBC/undeciphered/L/4070/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4070/L_？_8715.jpg`
- asset id: `asset-005663`
...
- English observation: The upper area has short angular traces around a dark
  central mark. Below it, several slanting strokes spread toward the sides,
  with a darker crossing near the middle; the exact stroke order and joins are
  unresolved.
- 中文观察：上部有短小的折向痕迹，围绕中央较深的痕迹。下部有数条斜向痕迹向
  两侧展开，中部附近有较深的交叉处；确切的笔画顺序和连接关系仍未确定。
...
- Which source records identify obs-unk-004070 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004070？
