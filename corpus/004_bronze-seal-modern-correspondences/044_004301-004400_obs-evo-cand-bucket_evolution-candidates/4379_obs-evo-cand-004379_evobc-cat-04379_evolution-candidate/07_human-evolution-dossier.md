...
- External category reference: `evobc-cat-04379`
- Source category ID: `04379`
- Source label for human review: `歙`
- Source codepoints: `U+6B59`
...
- `obs-evo-cand-004379-route-category-staging`
...
- `obs-evo-cand-004379-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004379-route-evolution-graph`
