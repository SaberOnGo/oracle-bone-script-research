...
Project ID: `obs-evo-cand-006165`
...
- Project ID: `obs-evo-cand-006165`
- EVOBC category candidate ID: `evobc-evo-cat-06165`
- External category reference: `evobc-cat-06165`
- Source category ID: `06165`
- Source label for human review: `窕`
- Source codepoints: `U+7A95`
...
- `obs-evo-cand-006165-route-category-staging`
...
- `obs-evo-cand-006165-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006165-route-evolution-graph`
