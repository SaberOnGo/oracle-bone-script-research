...
- Project ID: `obs-evo-cand-013245`
- EVOBC category candidate ID: `evobc-evo-cat-13245`
- External category reference: `evobc-cat-13245`
- Source category ID: `13245`
- Source label for human review: `𬍋`
- Source codepoints: `U+2C34B`
...
- `obs-evo-cand-013245-route-category-staging`
...
- `obs-evo-cand-013245-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013245-route-evolution-graph`
