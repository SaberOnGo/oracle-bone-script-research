...
- External category reference: `evobc-cat-06780`
- Source category ID: `06780`
- Source label for human review: `缤`
- Source codepoints: `U+7F24`
...
- `obs-evo-cand-006780-route-category-staging`
...
- `obs-evo-cand-006780-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006780-route-evolution-graph`
