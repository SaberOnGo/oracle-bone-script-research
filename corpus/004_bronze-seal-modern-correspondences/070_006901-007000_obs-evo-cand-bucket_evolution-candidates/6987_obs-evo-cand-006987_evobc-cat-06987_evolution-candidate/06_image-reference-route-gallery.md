...
- `obs-evo-cand-006987-route-category-staging`
...
- `obs-evo-cand-006987-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006987-route-evolution-graph`
