...
- External category reference: `evobc-cat-12415`
- Source category ID: `12415`
- Source label for human review: `𨚯`
- Source codepoints: `U+286AF`
...
- `obs-evo-cand-012415-route-category-staging`
...
- `obs-evo-cand-012415-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012415-route-evolution-graph`
