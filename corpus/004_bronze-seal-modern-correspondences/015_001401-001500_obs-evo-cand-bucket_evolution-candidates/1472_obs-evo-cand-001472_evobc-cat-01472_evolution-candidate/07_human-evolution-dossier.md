...
Project ID: `obs-evo-cand-001472`
...
- Project ID: `obs-evo-cand-001472`
- EVOBC category candidate ID: `evobc-evo-cat-01472`
- External category reference: `evobc-cat-01472`
- Source category ID: `01472`
- Source label for human review: `句`
- Source codepoints: `U+53E5`
...
- `obs-evo-cand-001472-route-category-staging`
...
- `obs-evo-cand-001472-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001472-route-evolution-graph`
