# obs-char-000332 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000332`
- primary external id: `hust-obc-cat-0374`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/332_obs-char-000332_hust-obc-cat-0374_orac
  le-character/03_visual-assets/001_asset-000337_hust-obc-cat-0374_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0374/G_0374_合4659賓組.png`
- asset id: `asset-000337`
...
- source category: `0374`
- validation class: `331`
- source image route: `HUST-OBC/deciphered/0374/G_0374_合4659賓組.png`
- asset id: `asset-000337`
...
- English observation: `The image has a small upper triangular enclosure, a
  long curved descending stroke, and a rounded lower enclosure.`
- 中文观察: `图像上方有小型三角闭合轮廓，右侧有长弧形下行笔画，下方有圆弧闭合轮廓。`
...
- dataset label text: `㕬`
- dataset label codepoints: `U+356C`
...
- filename catalog route clues: `Heji-like filename clue: 合4659
  (G_0374_合4659賓組.png)`
...
- Which source records identify obs-char-000332 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000332？
