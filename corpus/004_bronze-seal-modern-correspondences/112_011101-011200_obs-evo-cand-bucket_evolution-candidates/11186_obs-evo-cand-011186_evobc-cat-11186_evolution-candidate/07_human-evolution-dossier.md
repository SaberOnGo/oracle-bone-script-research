...
- Project ID: `obs-evo-cand-011186`
- EVOBC category candidate ID: `evobc-evo-cat-11186`
- External category reference: `evobc-cat-11186`
- Source category ID: `11186`
- Source label for human review: `𢐟`
- Source codepoints: `U+2241F`
...
- `obs-evo-cand-011186-route-category-staging`
...
- `obs-evo-cand-011186-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011186-route-evolution-graph`
