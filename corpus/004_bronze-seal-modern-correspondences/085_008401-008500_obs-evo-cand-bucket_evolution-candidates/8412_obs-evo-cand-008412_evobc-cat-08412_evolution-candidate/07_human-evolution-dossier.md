...
- Project ID: `obs-evo-cand-008412`
- EVOBC category candidate ID: `evobc-evo-cat-08412`
- External category reference: `evobc-cat-08412`
- Source category ID: `08412`
- Source label for human review: `设`
- Source codepoints: `U+8BBE`
...
- `obs-evo-cand-008412-route-category-staging`
...
- `obs-evo-cand-008412-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008412-route-evolution-graph`
