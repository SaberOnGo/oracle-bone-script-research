...
- External category reference: `evobc-cat-10710`
- Source category ID: `10710`
- Source label for human review: `齊`
- Source codepoints: `U+9F4A`
- Image reference count in source metadata: `158`
...
- `obs-evo-cand-010710-route-category-staging`
...
- `obs-evo-cand-010710-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010710-route-evolution-graph`
