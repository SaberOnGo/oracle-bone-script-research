...
- External category reference: `evobc-cat-00489`
- Source category ID: `00489`
- Source label for human review: `䣆`
...
- `obs-evo-cand-000489-route-category-staging`
...
- `obs-evo-cand-000489-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000489-route-evolution-graph`
