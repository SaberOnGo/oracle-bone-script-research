...
- External category reference: `evobc-cat-05935`
- Source category ID: `05935`
- Source label for human review: `磊`
...
- `obs-evo-cand-005935-route-category-staging`
...
- `obs-evo-cand-005935-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005935-route-evolution-graph`
