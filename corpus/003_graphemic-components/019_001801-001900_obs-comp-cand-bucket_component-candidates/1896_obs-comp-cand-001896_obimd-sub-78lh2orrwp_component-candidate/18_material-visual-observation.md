# Material Visual Observation / obs-comp-cand-001896 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001896`
- External reference / 外部参照: `obimd-sub-78lh2orrwp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018306_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zog7b0d83z/78lh2orrwp/78lh2orrwp.png`
- Checksum / 校验和:
  `8badce17b14718c92e6ca1158fbd507d221ee537f006054a627c5a0419ab0d07`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.69%.
- Marked-pixel bounds: (50,26)–(212,212); span 163 × 187 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.69%。
- 痕迹范围：(50,26)–(212,212)；跨度163 × 187 px；痕迹矩形近方形。
