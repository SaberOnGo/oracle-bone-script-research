...
Project ID: `obs-evo-cand-005157`
...
- Project ID: `obs-evo-cand-005157`
- EVOBC category candidate ID: `evobc-evo-cat-05157`
- External category reference: `evobc-cat-05157`
- Source category ID: `05157`
- Source label for human review: `燦`
- Source codepoints: `U+71E6`
...
- `obs-evo-cand-005157-route-category-staging`
...
- `obs-evo-cand-005157-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005157-route-evolution-graph`
