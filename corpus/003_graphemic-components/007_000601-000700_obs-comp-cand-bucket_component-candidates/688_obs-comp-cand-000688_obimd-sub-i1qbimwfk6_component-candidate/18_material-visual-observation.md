# Material Visual Observation / obs-comp-cand-000688 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000688`
- External reference / 外部参照: `obimd-sub-i1qbimwfk6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013287_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/i1qbimwfk6/i1qbimwfk6/i1qbimwfk6.png`
- Checksum / 校验和:
  `e706b49a3ad28134bd92dc6cf2b28fa1deb8132334698cea14d248f296206aef`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.91%.
- Marked-pixel bounds: (94,27)–(159,227); span 66 × 201 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.91%。
- 痕迹范围：(94,27)–(159,227)；跨度66 × 201 px；痕迹矩形高于宽。
