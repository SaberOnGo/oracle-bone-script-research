# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013316
...
- EVOBC candidate category: `evobc-evo-cat-13316`.
- Source label for search only: `𬟿`.
- Source codepoints for search only: `U+2C7FF`.
