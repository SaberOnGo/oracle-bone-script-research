# obs-xwalk-cand-001301 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+39A4` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-1454` | not reading |
