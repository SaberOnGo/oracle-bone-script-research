# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003268
...
- EVOBC candidate category: `evobc-evo-cat-03268`.
- Source label for search only: `扼`.
- Source codepoints for search only: `U+627C`.
