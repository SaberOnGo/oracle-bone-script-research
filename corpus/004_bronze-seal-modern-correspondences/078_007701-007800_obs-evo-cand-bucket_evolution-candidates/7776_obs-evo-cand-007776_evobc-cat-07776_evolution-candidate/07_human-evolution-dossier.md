...
- Project ID: `obs-evo-cand-007776`
- EVOBC category candidate ID: `evobc-evo-cat-07776`
- External category reference: `evobc-cat-07776`
- Source category ID: `07776`
- Source label for human review: `蜑`
- Source codepoints: `U+8711`
...
- `obs-evo-cand-007776-route-category-staging`
...
- `obs-evo-cand-007776-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007776-route-evolution-graph`
