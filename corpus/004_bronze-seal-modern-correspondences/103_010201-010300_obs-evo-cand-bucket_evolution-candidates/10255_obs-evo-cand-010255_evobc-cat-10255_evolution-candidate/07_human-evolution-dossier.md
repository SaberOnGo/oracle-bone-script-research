...
- Project ID: `obs-evo-cand-010255`
- EVOBC category candidate ID: `evobc-evo-cat-10255`
- External category reference: `evobc-cat-10255`
- Source category ID: `10255`
- Source label for human review: `驗`
- Source codepoints: `U+9A57`
...
- `obs-evo-cand-010255-route-category-staging`
...
- `obs-evo-cand-010255-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010255-route-evolution-graph`
