...
- External category reference: `evobc-cat-10478`
- Source category ID: `10478`
- Source label for human review: `鴂`
...
- `obs-evo-cand-010478-route-category-staging`
...
- `obs-evo-cand-010478-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010478-route-evolution-graph`
