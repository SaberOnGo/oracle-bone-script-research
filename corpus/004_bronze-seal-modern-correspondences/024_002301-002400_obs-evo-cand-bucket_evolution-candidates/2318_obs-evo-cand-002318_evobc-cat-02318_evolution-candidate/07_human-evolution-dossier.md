...
Project ID: `obs-evo-cand-002318`
...
- Project ID: `obs-evo-cand-002318`
- EVOBC category candidate ID: `evobc-evo-cat-02318`
- External category reference: `evobc-cat-02318`
- Source category ID: `02318`
- Source label for human review: `孂`
- Source codepoints: `U+5B42`
...
- `obs-evo-cand-002318-route-category-staging`
...
- `obs-evo-cand-002318-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002318-route-evolution-graph`
