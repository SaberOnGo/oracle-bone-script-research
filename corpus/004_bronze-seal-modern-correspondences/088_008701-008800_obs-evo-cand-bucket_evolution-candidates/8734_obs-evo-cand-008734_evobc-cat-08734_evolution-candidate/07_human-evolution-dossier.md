...
- External category reference: `evobc-cat-08734`
- Source category ID: `08734`
- Source label for human review: `踣`
- Source codepoints: `U+8E23`
...
- `obs-evo-cand-008734-route-category-staging`
...
- `obs-evo-cand-008734-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008734-route-evolution-graph`
