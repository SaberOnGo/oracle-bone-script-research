...
- External category reference: `evobc-cat-06077`
- Source category ID: `06077`
- Source label for human review: `秫`
...
- `obs-evo-cand-006077-route-category-staging`
...
- `obs-evo-cand-006077-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006077-route-evolution-graph`
