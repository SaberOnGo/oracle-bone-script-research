...
Project ID: `obs-insc-cw-cand-000496`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000496`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000496` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2431` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `334` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `205` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `41542` [route_present_image_or_text_not_collected]
