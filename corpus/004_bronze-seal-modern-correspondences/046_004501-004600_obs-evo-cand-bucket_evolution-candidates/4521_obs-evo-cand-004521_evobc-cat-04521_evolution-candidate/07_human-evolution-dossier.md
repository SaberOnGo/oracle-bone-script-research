...
- External category reference: `evobc-cat-04521`
- Source category ID: `04521`
- Source label for human review: `汹`
...
- `obs-evo-cand-004521-route-category-staging`
...
- `obs-evo-cand-004521-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004521-route-evolution-graph`
