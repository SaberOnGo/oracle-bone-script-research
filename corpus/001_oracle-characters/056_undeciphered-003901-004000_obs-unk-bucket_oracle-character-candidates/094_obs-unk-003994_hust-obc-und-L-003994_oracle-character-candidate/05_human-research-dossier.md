# obs-unk-003994 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003994`
- primary external id: `hust-obc-und-L-003994`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/094_obs-unk-003994_h
  ust-obc-und-L-003994_oracle-character-candidate/03_visual-assets/001_asset
  -005587_hust-obc-und-L-003994_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3994/L_？_8452.jpg`
- asset id: `asset-005587`
...
- source class: `HUST-OBC/undeciphered/L/3994/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3994/L_？_8452.jpg`
- asset id: `asset-005587`
...
- English observation: A narrow upper trace has a short side branch; several
  thin strokes descend below it and the lower details are faint.
- 中文观察：上部窄痕迹带有短侧向分支；数条细痕迹向下延伸，下部细节较淡。
...
- Which source records identify obs-unk-003994 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003994？
