# Material Visual Observation / obs-comp-cand-000027 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000027`
- External reference / 外部参照: `obimd-sub-p31g1lor6p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011179_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/nak4ioxpg1/p31g1lor6p/p31g1lor6p.png`
- Checksum / 校验和:
  `340470370f901ca5e652e4976a90cd1127031eee27827ce65fe08a10925976c8`
...
- Marked-pixel bounds: (72,31)–(191,221); span 120 × 191 px; the marked
...
- 痕迹范围：(72,31)–(191,221)；跨度120 × 191 px；痕迹矩形高于宽。
