...
- External category reference: `evobc-cat-01606`
- Source category ID: `01606`
- Source label for human review: `唪`
...
- `obs-evo-cand-001606-route-category-staging`
...
- `obs-evo-cand-001606-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001606-route-evolution-graph`
