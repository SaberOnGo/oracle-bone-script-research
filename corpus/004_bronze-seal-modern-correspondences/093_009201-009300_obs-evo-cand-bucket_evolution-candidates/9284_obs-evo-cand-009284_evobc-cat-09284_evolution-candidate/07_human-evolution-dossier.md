...
- External category reference: `evobc-cat-09284`
- Source category ID: `09284`
- Source label for human review: `醰`
- Source codepoints: `U+91B0`
...
- `obs-evo-cand-009284-route-category-staging`
...
- `obs-evo-cand-009284-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009284-route-evolution-graph`
