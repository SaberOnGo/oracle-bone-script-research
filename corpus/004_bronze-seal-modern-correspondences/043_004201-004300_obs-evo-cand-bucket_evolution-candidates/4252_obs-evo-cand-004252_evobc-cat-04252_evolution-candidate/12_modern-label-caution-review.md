# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004252
...
- EVOBC candidate category: `evobc-evo-cat-04252`.
- Source label for search only: `樵`.
- Source codepoints for search only: `U+6A35`.
