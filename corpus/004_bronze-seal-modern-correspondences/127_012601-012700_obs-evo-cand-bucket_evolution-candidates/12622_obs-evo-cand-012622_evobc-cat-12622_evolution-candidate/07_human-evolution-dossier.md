...
Project ID: `obs-evo-cand-012622`
...
- Project ID: `obs-evo-cand-012622`
- EVOBC category candidate ID: `evobc-evo-cat-12622`
- External category reference: `evobc-cat-12622`
- Source category ID: `12622`
- Source label for human review: `𩖽`
- Source codepoints: `U+295BD`
...
- `obs-evo-cand-012622-route-category-staging`
...
- `obs-evo-cand-012622-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012622-route-evolution-graph`
