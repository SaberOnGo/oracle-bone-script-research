# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010264
...
- EVOBC candidate category: `evobc-evo-cat-10264`.
- Source label for search only: `驥`.
- Source codepoints for search only: `U+9A65`.
