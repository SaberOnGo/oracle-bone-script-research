# obs-unk-004452 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004452`
- primary external id: `hust-obc-und-X-004452`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/052_obs-unk-004452_h
  ust-obc-und-X-004452_oracle-character-candidate/03_visual-assets/001_asset
  -006045_hust-obc-und-X-004452_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/8/X_？_8187_1.png`
- asset id: `asset-006045`
...
- source class: `HUST-OBC/undeciphered/X/8/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/8/X_？_8187_1.png`
- asset id: `asset-006045`
...
- English observation: `A right forked stem stands beside a separate`
  `left branching trace.`
- 中文观察: `右侧分叉竖干旁有分离的左侧分支痕迹。`
...
- Which source records identify obs-unk-004452 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004452？
