...
- External category reference: `evobc-cat-10819`
- Source category ID: `10819`
- Source label for human review: `𠏟`
- Source codepoints: `U+203DF`
...
- `obs-evo-cand-010819-route-category-staging`
...
- `obs-evo-cand-010819-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010819-route-evolution-graph`
