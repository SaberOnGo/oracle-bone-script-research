# Human Research Readiness Review / 正式研究准备复核: obs-evo-cand-012340
...
- Source label for lookup only: `𨑗`.
- Source codepoints for lookup only: `U+28457`.
- Era/source code rows to open: `4`.
