...
- External category reference: `evobc-cat-09958`
- Source category ID: `09958`
- Source label for human review: `韧`
...
- `obs-evo-cand-009958-route-category-staging`
...
- `obs-evo-cand-009958-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009958-route-evolution-graph`
