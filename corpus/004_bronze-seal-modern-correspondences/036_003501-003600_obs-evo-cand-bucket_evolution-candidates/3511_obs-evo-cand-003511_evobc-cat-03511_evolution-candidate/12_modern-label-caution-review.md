# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003511
...
- EVOBC candidate category: `evobc-evo-cat-03511`.
- Source label for search only: `撽`.
- Source codepoints for search only: `U+64BD`.
