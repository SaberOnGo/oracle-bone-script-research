# obs-char-001250 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001250`
- primary external id: `hust-obc-cat-1398`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1250_obs-char-001250_hust-obc-cat-1398_ora
  cle-character/03_visual-assets/001_asset-001255_hust-obc-cat-1398_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1398/X_1398_1210_1.png`
- asset id: `asset-001255`
...
- source category: `1398`
- validation class: `1249`
- source image route: `HUST-OBC/deciphered/1398/X_1398_1210_1.png`
- asset id: `asset-001255`
...
- English observation: `A high-contrast image shows a large pale irregular
  figure against a black field; internal boundaries are partly obscured.`
- 中文观察: `高反差图像中，黑色背景上可见大型浅色不规则形体；内部边界部分被遮蔽。`
...
- dataset label text: `㥬`
- dataset label codepoints: `U+396C`
...
- Which source records identify obs-char-001250 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001250？
