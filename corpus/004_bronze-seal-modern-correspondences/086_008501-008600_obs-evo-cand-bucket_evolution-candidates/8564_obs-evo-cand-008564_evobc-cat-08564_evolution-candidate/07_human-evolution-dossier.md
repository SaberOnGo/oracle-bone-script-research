...
- External category reference: `evobc-cat-08564`
- Source category ID: `08564`
- Source label for human review: `賃`
- Source codepoints: `U+8CC3`
...
- `obs-evo-cand-008564-route-category-staging`
...
- `obs-evo-cand-008564-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008564-route-evolution-graph`
