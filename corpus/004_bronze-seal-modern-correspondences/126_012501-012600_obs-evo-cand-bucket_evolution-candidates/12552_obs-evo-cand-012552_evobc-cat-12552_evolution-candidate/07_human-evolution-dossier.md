...
- External category reference: `evobc-cat-12552`
- Source category ID: `12552`
- Source label for human review: `𩂖`
- Source codepoints: `U+29096`
...
- `obs-evo-cand-012552-route-category-staging`
...
- `obs-evo-cand-012552-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012552-route-evolution-graph`
