...
- External category reference: `evobc-cat-02017`
- Source category ID: `02017`
- Source label for human review: `失`
- Source codepoints: `U+5931`
...
- `obs-evo-cand-002017-route-category-staging`
...
- `obs-evo-cand-002017-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002017-route-evolution-graph`
