...
Project ID: `obs-insc-cw-cand-000104`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000104`
...
- Yingguo / 英国所藏: `y593` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `598` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `535` in source row; primary catalog entry pending
- Heji / 合集: `39967` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000104`
