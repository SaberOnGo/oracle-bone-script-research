...
Project ID: `obs-evo-cand-000200`
...
- Project ID: `obs-evo-cand-000200`
- EVOBC category candidate ID: `evobc-evo-cat-00200`
- External category reference: `evobc-cat-00200`
- Source category ID: `00200`
- Source label for human review: `㲋`
- Source codepoints: `U+3C8B`
...
- `obs-evo-cand-000200-route-category-staging`
...
- `obs-evo-cand-000200-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000200-route-evolution-graph`
