# obs-evo-cand-011091 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-011091`
- EVOBC category candidate ID: `evobc-evo-cat-11091`
- External category ref: `evobc-cat-11091`
- Source label: `𡭪`
- Source codepoints: `U+21B6A`
- Image reference count: `37`
- Era token counts: `SAC:19;WSC:18`
- Source token counts: `Book:37`
