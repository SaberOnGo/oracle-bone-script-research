# obs-unk-004883 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004883`
- primary external id: `hust-obc-und-X-004883`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/083_obs-unk-004883_h
  ust-obc-und-X-004883_oracle-character-candidate/03_visual-assets/001_asset
  -006476_hust-obc-und-X-004883_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/439/X_？_7421_1.png`
- asset id: `asset-006476`
...
- source class: `HUST-OBC/undeciphered/X/439/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/439/X_？_7421_1.png`
- asset id: `asset-006476`
...
- English observation: `two stacked angular groups with pale openings`
- 中文观察: `上下两个折角结构和浅色开口`
...
- Which source records identify obs-unk-004883 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004883？
