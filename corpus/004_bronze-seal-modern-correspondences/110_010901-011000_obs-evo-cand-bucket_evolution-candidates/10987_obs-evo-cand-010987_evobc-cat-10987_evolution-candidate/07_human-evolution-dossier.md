...
- External category reference: `evobc-cat-10987`
- Source category ID: `10987`
- Source label for human review: `𡋣`
- Source codepoints: `U+212E3`
...
- `obs-evo-cand-010987-route-category-staging`
...
- `obs-evo-cand-010987-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010987-route-evolution-graph`
