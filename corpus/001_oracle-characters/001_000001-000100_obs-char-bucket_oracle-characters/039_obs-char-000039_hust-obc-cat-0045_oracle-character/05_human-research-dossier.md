# obs-char-000039 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000039`
- primary external id: `hust-obc-cat-0045`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/039_obs-char-000039_hust-obc-cat-0045_orac
  le-character/03_visual-assets/001_asset-000044_hust-obc-cat-0045_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0045/H_0045_60C27_0.png`
- asset id: `asset-000044`
...
- source category: `0045`
- validation class: `38`
- source image route: `HUST-OBC/deciphered/0045/H_0045_60C27_0.png`
- asset id: `asset-000044`
...
- English observation: `The dark form combines a small rounded upper mark, a
  central upright, and two adjoining rectangular lower enclosures.`
- 中文观察: `深色形体含小型圆弧上部痕迹、中央竖画和两个相连的下部长方形框。`
...
- dataset label text: `㐣`
- dataset label codepoints: `U+3423`
...
- filename catalog route clues: `catalog-like filename clue: H_0045
  (H_0045_60C27_0.png)`
...
- Which source records identify obs-char-000039 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000039？
