...
Project ID: `obs-evo-cand-007604`
...
- Project ID: `obs-evo-cand-007604`
- EVOBC category candidate ID: `evobc-evo-cat-07604`
- External category reference: `evobc-cat-07604`
- Source category ID: `07604`
- Source label for human review: `薉`
- Source codepoints: `U+8589`
...
- `obs-evo-cand-007604-route-category-staging`
...
- `obs-evo-cand-007604-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007604-route-evolution-graph`
