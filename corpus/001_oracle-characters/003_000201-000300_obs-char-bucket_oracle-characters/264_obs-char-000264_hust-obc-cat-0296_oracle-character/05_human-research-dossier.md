# obs-char-000264 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000264`
- primary external id: `hust-obc-cat-0296`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/264_obs-char-000264_hust-obc-cat-0296_orac
  le-character/03_visual-assets/001_asset-000269_hust-obc-cat-0296_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0296/L_0296_4027.jpg`
- asset id: `asset-000269`
...
- source category: `0296`
- validation class: `263`
- source image route: `HUST-OBC/deciphered/0296/L_0296_4027.jpg`
- asset id: `asset-000269`
...
- English observation: `The low-contrast image shows a small arched upper
  outline and several separated angular marks below it; surface detail needs
  recheck.`
- 中文观察: `低对比度图像上方有小型拱形轮廓，下方有数处分离折角痕迹；表面细节仍需复核。`
...
- dataset label text: `㔞`
- dataset label codepoints: `U+351E`
...
- Which source records identify obs-char-000264 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000264？
