...
- External category reference: `evobc-cat-11184`
- Source category ID: `11184`
- Source label for human review: `𢐗`
- Source codepoints: `U+22417`
...
- `obs-evo-cand-011184-route-category-staging`
...
- `obs-evo-cand-011184-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011184-route-evolution-graph`
