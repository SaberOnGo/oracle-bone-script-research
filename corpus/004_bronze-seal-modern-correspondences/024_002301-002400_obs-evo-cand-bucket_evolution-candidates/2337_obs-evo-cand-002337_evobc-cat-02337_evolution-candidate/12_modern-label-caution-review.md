# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002337
...
- EVOBC candidate category: `evobc-evo-cat-02337`.
- Source label for search only: `孟`.
- Source codepoints for search only: `U+5B5F`.
