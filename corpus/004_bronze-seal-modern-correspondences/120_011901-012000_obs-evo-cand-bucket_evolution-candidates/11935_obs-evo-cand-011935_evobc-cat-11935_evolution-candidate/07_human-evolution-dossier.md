...
Project ID: `obs-evo-cand-011935`
...
- Project ID: `obs-evo-cand-011935`
- EVOBC category candidate ID: `evobc-evo-cat-11935`
- External category reference: `evobc-cat-11935`
- Source category ID: `11935`
- Source label for human review: `𥿇`
- Source codepoints: `U+25FC7`
...
- `obs-evo-cand-011935-route-category-staging`
...
- `obs-evo-cand-011935-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011935-route-evolution-graph`
