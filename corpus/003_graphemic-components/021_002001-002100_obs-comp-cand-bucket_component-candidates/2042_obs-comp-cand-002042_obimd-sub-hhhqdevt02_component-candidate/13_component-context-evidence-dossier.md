# obs-comp-cand-002042 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002042`
- 首选外部 ID: `obimd-sub-hhhqdevt02`
- OBIMD subcharacter UID: `hhhqdevt02`
...
- codepoint 示例: U+FBBCA; U+FBBCB; 另有 11 项
