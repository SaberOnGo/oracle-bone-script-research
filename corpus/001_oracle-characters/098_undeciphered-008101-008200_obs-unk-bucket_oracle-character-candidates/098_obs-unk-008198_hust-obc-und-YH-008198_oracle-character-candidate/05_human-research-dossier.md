# obs-unk-008198 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008198`
- primary external id: `hust-obc-und-YH-008198`
...
- local review image route: `corpus/001_oracle-characters/098_undeciphered-008
  101-008200_obs-unk-bucket_oracle-character-candidates/098_obs-unk-008198_h
  ust-obc-und-YH-008198_oracle-character-candidate/03_visual-assets/001_asse
  t-009789_hust-obc-und-YH-008198_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/608AA/Y_？_608AA.jpg`
- asset id: `asset-009789`
...
- source class: `HUST-OBC/undeciphered/Y+H/608AA/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/608AA/Y_？_608AA.jpg`
- asset id: `asset-009789`
...
- Which source records identify obs-unk-008198 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008198？
