...
- `obs-evo-cand-013255-route-category-staging`
...
- `obs-evo-cand-013255-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013255-route-evolution-graph`
