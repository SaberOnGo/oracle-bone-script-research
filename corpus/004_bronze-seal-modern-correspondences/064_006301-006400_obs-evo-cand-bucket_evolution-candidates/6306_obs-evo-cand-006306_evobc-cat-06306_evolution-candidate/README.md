# obs-evo-cand-006306 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-06306`
- Source label for human review: `箸`
- Source codepoints: `U+7BB8`
- Image reference count: `32`
- Era token counts: `SS:1;WSC:31`
- Source token counts: `Book:15;Web:17`
