...
- `obs-evo-cand-000784-route-category-staging`
...
- `obs-evo-cand-000784-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000784-route-evolution-graph`
