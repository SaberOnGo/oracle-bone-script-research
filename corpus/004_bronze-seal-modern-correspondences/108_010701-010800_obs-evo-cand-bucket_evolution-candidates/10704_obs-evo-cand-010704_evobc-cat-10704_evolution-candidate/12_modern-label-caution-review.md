# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010704
...
- EVOBC candidate category: `evobc-evo-cat-10704`.
- Source label for search only: `鼻`.
- Source codepoints for search only: `U+9F3B`.
