...
- External category reference: `evobc-cat-04269`
- Source category ID: `04269`
- Source label for human review: `橛`
- Source codepoints: `U+6A5B`
...
- `obs-evo-cand-004269-route-category-staging`
...
- `obs-evo-cand-004269-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004269-route-evolution-graph`
