...
Project ID: `obs-evo-cand-010372`
...
- Project ID: `obs-evo-cand-010372`
- EVOBC category candidate ID: `evobc-evo-cat-10372`
- External category reference: `evobc-cat-10372`
- Source category ID: `10372`
- Source label for human review: `魧`
- Source codepoints: `U+9B67`
...
- `obs-evo-cand-010372-route-category-staging`
...
- `obs-evo-cand-010372-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010372-route-evolution-graph`
