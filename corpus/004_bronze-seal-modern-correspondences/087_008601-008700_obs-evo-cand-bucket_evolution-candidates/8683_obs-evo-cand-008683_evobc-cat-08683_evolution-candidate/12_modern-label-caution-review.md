# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008683
...
- EVOBC candidate category: `evobc-evo-cat-08683`.
- Source label for search only: `趛`.
- Source codepoints for search only: `U+8D9B`.
