# obs-char-001166 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001166`
- primary external id: `hust-obc-cat-1306`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1166_obs-char-001166_hust-obc-cat-1306_ora
  cle-character/03_visual-assets/001_asset-001171_hust-obc-cat-1306_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1306/G_1306_乙524合643賓組.png`
- asset id: `asset-001171`
...
- source category: `1306`
- validation class: `1165`
- source image route: `HUST-OBC/deciphered/1306/G_1306_乙524合643賓組.png`
- asset id: `asset-001171`
...
- English observation: `A narrow upright form has a pointed upper tip, two
  stacked curved side bands, and a short lower base.`
- 中文观察: `狭长直立形体有尖状上端、两层弯曲侧部带和短下部底笔。`
...
- dataset label text: `㤐`
- dataset label codepoints: `U+3910`
...
- filename catalog route clues: `Heji-like filename clue: 合643
  (G_1306_乙524合643賓組.png)`
...
- Which source records identify obs-char-001166 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001166？
