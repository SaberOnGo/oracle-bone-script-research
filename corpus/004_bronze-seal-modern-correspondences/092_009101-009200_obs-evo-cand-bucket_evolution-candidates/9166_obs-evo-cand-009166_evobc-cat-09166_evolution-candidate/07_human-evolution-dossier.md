...
- External category reference: `evobc-cat-09166`
- Source category ID: `09166`
- Source label for human review: `郴`
- Source codepoints: `U+90F4`
...
- `obs-evo-cand-009166-route-category-staging`
...
- `obs-evo-cand-009166-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009166-route-evolution-graph`
