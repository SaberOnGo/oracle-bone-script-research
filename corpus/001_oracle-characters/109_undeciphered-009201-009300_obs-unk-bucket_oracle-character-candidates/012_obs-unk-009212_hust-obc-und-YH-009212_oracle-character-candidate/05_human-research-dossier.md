# obs-unk-009212 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-009212`
- primary external id: `hust-obc-und-YH-009212`
...
- local review image route: `corpus/001_oracle-characters/109_undeciphered-009
  201-009300_obs-unk-bucket_oracle-character-candidates/012_obs-unk-009212_h
  ust-obc-und-YH-009212_oracle-character-candidate/03_visual-assets/001_asse
  t-010803_hust-obc-und-YH-009212_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/613BA/H_？_613BA_0.png`
- asset id: `asset-010803`
...
- source class: `HUST-OBC/undeciphered/Y+H/613BA/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/613BA/H_？_613BA_0.png`
- asset id: `asset-010803`
...
- Which source records identify obs-unk-009212 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009212？
