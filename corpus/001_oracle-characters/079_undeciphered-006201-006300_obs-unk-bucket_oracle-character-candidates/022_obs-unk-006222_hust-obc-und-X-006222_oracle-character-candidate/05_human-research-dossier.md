# obs-unk-006222 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/079_undeciphered-006
  201-006300_obs-unk-bucket_oracle-character-candidates/022_obs-unk-006222_h
  ust-obc-und-X-006222_oracle-character-candidate/03_visual-assets/001_asset
  -007814_hust-obc-und-X-006222_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1778/X_？_4510_1.png`
- asset id: `asset-007814`
...
- source class: `HUST-OBC/undeciphered/X/1778/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1778/X_？_4510_1.png`
- asset id: `asset-007814`
...
- Which source records identify obs-unk-006222 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006222？
