# obs-char-001411 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001411`
- primary external id: `hust-obc-cat-1580`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1411_obs-char-001411_hust-obc-cat-1580_ora
  cle-character/03_visual-assets/001_asset-001416_hust-obc-cat-1580_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1580/G_1580_甲骨文0.png`
- asset id: `asset-001416`
...
- source category: `1580`
- validation class: `1410`
- source image route: `HUST-OBC/deciphered/1580/G_1580_甲骨文0.png`
- asset id: `asset-001416`
...
- English observation: `A compact knot has an upper enclosure, a central
  crossing, and lower branches.`
- 中文观察: `紧凑笔画结有上部框形、中央交叉笔和下部分枝。`
...
- dataset label text: `㨢`
- dataset label codepoints: `U+3A22`
...
- Which source records identify obs-char-001411 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001411？
