...
- Project ID: `obs-evo-cand-011293`
- EVOBC category candidate ID: `evobc-evo-cat-11293`
- External category reference: `evobc-cat-11293`
- Source category ID: `11293`
- Source label for human review: `𢨇`
- Source codepoints: `U+22A07`
...
- `obs-evo-cand-011293-route-category-staging`
...
- `obs-evo-cand-011293-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011293-route-evolution-graph`
