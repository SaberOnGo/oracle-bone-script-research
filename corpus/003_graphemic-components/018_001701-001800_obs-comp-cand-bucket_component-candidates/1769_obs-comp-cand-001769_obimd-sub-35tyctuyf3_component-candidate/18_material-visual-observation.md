# Material Visual Observation / obs-comp-cand-001769 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001769`
- External reference / 外部参照: `obimd-sub-35tyctuyf3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017970_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/soaedltvjs/35tyctuyf3/35tyctuyf3.png`
- Checksum / 校验和:
  `951d4da4c4fbe13f7e0398f23ba2255c81022b0a8e7b56aa176c230c163c2ce9`
...
- Marked-pixel bounds: (70,52)–(177,197); span 108 × 146 px; the marked
...
- 痕迹范围：(70,52)–(177,197)；跨度108 × 146 px；痕迹矩形高于宽。
