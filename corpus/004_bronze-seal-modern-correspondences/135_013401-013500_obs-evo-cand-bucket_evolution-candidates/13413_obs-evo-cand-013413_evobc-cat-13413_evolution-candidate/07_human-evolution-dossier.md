...
- External category reference: `evobc-cat-13413`
- Source category ID: `13413`
- Source label for human review: `𬮐`
- Source codepoints: `U+2CB90`
...
- `obs-evo-cand-013413-route-category-staging`
...
- `obs-evo-cand-013413-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013413-route-evolution-graph`
