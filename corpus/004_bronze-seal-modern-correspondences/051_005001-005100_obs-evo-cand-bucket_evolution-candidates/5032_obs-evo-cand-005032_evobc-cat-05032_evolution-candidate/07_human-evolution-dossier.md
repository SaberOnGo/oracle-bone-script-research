...
- Project ID: `obs-evo-cand-005032`
- EVOBC category candidate ID: `evobc-evo-cat-05032`
- External category reference: `evobc-cat-05032`
- Source category ID: `05032`
- Source label for human review: `灻`
- Source codepoints: `U+707B`
...
- `obs-evo-cand-005032-route-category-staging`
...
- `obs-evo-cand-005032-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005032-route-evolution-graph`
