...
- External category reference: `evobc-cat-10300`
- Source category ID: `10300`
- Source label for human review: `髆`
- Source codepoints: `U+9AC6`
...
- `obs-evo-cand-010300-route-category-staging`
...
- `obs-evo-cand-010300-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010300-route-evolution-graph`
