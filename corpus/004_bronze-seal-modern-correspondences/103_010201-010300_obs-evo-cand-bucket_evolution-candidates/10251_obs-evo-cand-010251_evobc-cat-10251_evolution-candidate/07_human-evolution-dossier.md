...
- External category reference: `evobc-cat-10251`
- Source category ID: `10251`
- Source label for human review: `驒`
- Source codepoints: `U+9A52`
...
- `obs-evo-cand-010251-route-category-staging`
...
- `obs-evo-cand-010251-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010251-route-evolution-graph`
