...
- Source page section: `Period III Group 4` /
  `第 III 期第 4 组`
- Source section key: `period-iii-group-4`
...
- Yingguo / 英国所藏: `y2283` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `337` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `209` in source row; primary catalog entry pending
