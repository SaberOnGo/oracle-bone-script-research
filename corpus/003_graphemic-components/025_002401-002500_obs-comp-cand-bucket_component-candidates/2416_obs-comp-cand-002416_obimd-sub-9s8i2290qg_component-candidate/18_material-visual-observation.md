# Material Visual Observation / obs-comp-cand-002416 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002416`
- External reference / 外部参照: `obimd-sub-9s8i2290qg`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020487_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9s8i2290qg/9s8i2290qg/9s8i2290qg.png`
- Checksum / 校验和:
  `e3a6a339bb7bd9600f2ce3e04d85f850377e830fc82e00303d1427fd16df7f13`
...
- Marked-pixel bounds: (88,38)–(161,208); span 74 × 171 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.42%。
- 痕迹范围：(88,38)–(161,208)；跨度74 × 171 px；痕迹矩形高于宽。
