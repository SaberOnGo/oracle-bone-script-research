...
- `obs-evo-cand-007656-route-category-staging`
...
- `obs-evo-cand-007656-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007656-route-evolution-graph`
