# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013485
...
- EVOBC candidate category: `evobc-evo-cat-13485`.
- Source label for search only: `𭆋`.
- Source codepoints for search only: `U+2D18B`.
