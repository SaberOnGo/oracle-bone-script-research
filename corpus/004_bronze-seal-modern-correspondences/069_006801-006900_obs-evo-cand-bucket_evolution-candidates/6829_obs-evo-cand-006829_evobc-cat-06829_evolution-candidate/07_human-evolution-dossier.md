...
- External category reference: `evobc-cat-06829`
- Source category ID: `06829`
- Source label for human review: `罽`
- Source codepoints: `U+7F7D`
...
- `obs-evo-cand-006829-route-category-staging`
...
- `obs-evo-cand-006829-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006829-route-evolution-graph`
