# src-tsinghua-oracle-bones Material Access Index
...
- Target records / 目标记录: excavation_or_collection_context; source_record
- Metadata profile count / 元数据概况数: 3
- Profile metrics / 概况指标: collection_inscribed_piece_count;
  collection_oracle_bone_count_over; registered_collection_provenance_names
