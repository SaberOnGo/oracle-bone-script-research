...
- External category reference: `evobc-cat-06712`
- Source category ID: `06712`
- Source label for human review: `纏`
...
- `obs-evo-cand-006712-route-category-staging`
...
- `obs-evo-cand-006712-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006712-route-evolution-graph`
