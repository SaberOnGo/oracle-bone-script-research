...
- `obs-evo-cand-010121-route-category-staging`
...
- `obs-evo-cand-010121-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010121-route-evolution-graph`
