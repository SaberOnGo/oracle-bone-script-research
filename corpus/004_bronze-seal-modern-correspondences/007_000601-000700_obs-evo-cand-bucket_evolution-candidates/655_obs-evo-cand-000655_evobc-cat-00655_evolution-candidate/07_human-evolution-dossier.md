...
- External category reference: `evobc-cat-00655`
- Source category ID: `00655`
- Source label for human review: `么`
...
- `obs-evo-cand-000655-route-category-staging`
...
- `obs-evo-cand-000655-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000655-route-evolution-graph`
