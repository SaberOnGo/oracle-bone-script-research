...
- External category reference: `evobc-cat-00345`
- Source category ID: `00345`
- Source label for human review: `䍠`
- Source codepoints: `U+4360`
...
- `obs-evo-cand-000345-route-category-staging`
...
- `obs-evo-cand-000345-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000345-route-evolution-graph`
