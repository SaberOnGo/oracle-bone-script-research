...
- External category reference: `evobc-cat-00437`
- Source category ID: `00437`
- Source label for human review: `䜕`
- Source codepoints: `U+4715`
...
- `obs-evo-cand-000437-route-category-staging`
...
- `obs-evo-cand-000437-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000437-route-evolution-graph`
