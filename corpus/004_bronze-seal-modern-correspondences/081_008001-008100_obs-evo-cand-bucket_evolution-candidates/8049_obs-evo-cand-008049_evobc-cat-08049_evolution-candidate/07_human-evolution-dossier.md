...
- External category reference: `evobc-cat-08049`
- Source category ID: `08049`
- Source label: `西`
- Source codepoints: `U+897F`
- Image reference count in source metadata: `268`
...
- `obs-evo-cand-008049-route-category-staging`
...
- `obs-evo-cand-008049-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008049-route-evolution-graph`
