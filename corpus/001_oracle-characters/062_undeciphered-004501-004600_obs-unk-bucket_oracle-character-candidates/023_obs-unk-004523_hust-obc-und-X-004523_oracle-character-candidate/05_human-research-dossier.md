# obs-unk-004523 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/023_obs-unk-004523_h
  ust-obc-und-X-004523_oracle-character-candidate/03_visual-assets/001_asset
  -006116_hust-obc-und-X-004523_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/79/X_？_8263_1.png`
- asset id: `asset-006116`
...
- source class: `HUST-OBC/undeciphered/X/79/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/79/X_？_8263_1.png`
- asset id: `asset-006116`
...
- English observation: `The central stem, horizontal projections, diagonal
  branches, and right descending trace are directly recorded.`
- 中文观察: `已直接记录中央主痕、横向外伸、斜向分支和右侧下行痕。`
...
- Which source records identify obs-unk-004523 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004523？
