...
- External category reference: `evobc-cat-06883`
- Source category ID: `06883`
- Source label for human review: `翕`
- Source codepoints: `U+7FD5`
...
- `obs-evo-cand-006883-route-category-staging`
...
- `obs-evo-cand-006883-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006883-route-evolution-graph`
