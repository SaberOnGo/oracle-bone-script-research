...
Project ID: `obs-evo-cand-004362`
...
- Project ID: `obs-evo-cand-004362`
- EVOBC category candidate ID: `evobc-evo-cat-04362`
- External category reference: `evobc-cat-04362`
- Source category ID: `04362`
- Source label for human review: `歃`
- Source codepoints: `U+6B43`
...
- `obs-evo-cand-004362-route-category-staging`
...
- `obs-evo-cand-004362-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004362-route-evolution-graph`
