# Material Visual Observation / obs-comp-cand-002438 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002438`
- External reference / 外部参照: `obimd-sub-kam577w6oq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020610_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kam577w6oq/kam577w6oq/kam577w6oq.png`
- Checksum / 校验和:
  `b64923cd6e3beebf5d71d7f1600864e80d26fb930971a3041971821b22aa9a98`
...
- Marked-pixel bounds: (78,13)–(169,237); span 92 × 225 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.09%。
- 痕迹范围：(78,13)–(169,237)；跨度92 × 225 px；痕迹矩形高于宽。
