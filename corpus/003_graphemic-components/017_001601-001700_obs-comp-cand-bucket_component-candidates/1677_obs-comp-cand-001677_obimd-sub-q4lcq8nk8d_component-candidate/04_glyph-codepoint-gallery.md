# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001677
...
| --- | --- | --- | --- |
| `obimd-glyph-link-026080` | 򩫢󹯗 | `U+A9AE2;U+F9BD7` | `reviewed_metadata_only` |
| `obimd-glyph-link-026081` | 󹯘 | `U+F9BD8` | `reviewed_metadata_only` |
| `obimd-glyph-link-026082` | 󹯙 | `U+F9BD9` | `reviewed_metadata_only` |
