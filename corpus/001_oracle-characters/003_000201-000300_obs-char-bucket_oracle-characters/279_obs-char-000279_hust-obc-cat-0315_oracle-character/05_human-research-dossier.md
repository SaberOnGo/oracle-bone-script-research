# obs-char-000279 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000279`
- primary external id: `hust-obc-cat-0315`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/279_obs-char-000279_hust-obc-cat-0315_orac
  le-character/03_visual-assets/001_asset-000284_hust-obc-cat-0315_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0315/G_0315_乙1279.png`
- asset id: `asset-000284`
...
- source category: `0315`
- validation class: `278`
- source image route: `HUST-OBC/deciphered/0315/G_0315_乙1279.png`
- asset id: `asset-000284`
...
- English observation: `The image shows a low outlined base with two upright
  supports, a small enclosed middle block, and a central upper stem with a
  rounded terminal.`
- 中文观察: `图像有低位外框底部和两道直立支撑，中部有小型闭合块状形体，中央向上伸出带圆钝末端的笔干。`
...
- dataset label text: `㔱`
- dataset label codepoints: `U+3531`
...
- Which source records identify obs-char-000279 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000279？
