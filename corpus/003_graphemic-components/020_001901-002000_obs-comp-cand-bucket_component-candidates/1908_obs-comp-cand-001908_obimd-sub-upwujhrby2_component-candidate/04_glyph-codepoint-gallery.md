# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001908
...
| --- | --- | --- | --- |
| `obimd-glyph-link-028819` | 󺸤 | `U+FAE24` | `reviewed_metadata_only` |
| `obimd-glyph-link-028820` | 󺸥 | `U+FAE25` | `reviewed_metadata_only` |
