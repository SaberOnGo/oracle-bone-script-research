# obs-unk-004367 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/067_obs-unk-004367_h
  ust-obc-und-L-004367_oracle-character-candidate/03_visual-assets/001_asset
  -005960_hust-obc-und-L-004367_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4367/L_？_9689.jpg`
- asset id: `asset-005960`
...
- source class: `HUST-OBC/undeciphered/L/4367/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4367/L_？_9689.jpg`
- asset id: `asset-005960`
...
- English observation: `Upper rounded trace, lower outline, and terminals`
  `recorded.`
- 中文观察: `已记录上部圆弧痕、下部轮廓和末端。`
...
- Which source records identify obs-unk-004367 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004367？
