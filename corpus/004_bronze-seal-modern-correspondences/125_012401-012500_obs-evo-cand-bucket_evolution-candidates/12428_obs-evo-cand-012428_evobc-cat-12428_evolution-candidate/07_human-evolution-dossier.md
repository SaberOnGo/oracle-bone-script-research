...
Project ID: `obs-evo-cand-012428`
...
- Project ID: `obs-evo-cand-012428`
- EVOBC category candidate ID: `evobc-evo-cat-12428`
- External category reference: `evobc-cat-12428`
- Source category ID: `12428`
- Source label for human review: `𨛠`
- Source codepoints: `U+286E0`
...
- `obs-evo-cand-012428-route-category-staging`
...
- `obs-evo-cand-012428-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012428-route-evolution-graph`
