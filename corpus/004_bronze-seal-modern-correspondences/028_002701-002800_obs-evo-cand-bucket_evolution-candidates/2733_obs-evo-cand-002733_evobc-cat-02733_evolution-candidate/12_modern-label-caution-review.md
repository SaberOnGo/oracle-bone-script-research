# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002733
...
- EVOBC candidate category: `evobc-evo-cat-02733`.
- Source label for search only: `庪`.
- Source codepoints for search only: `U+5EAA`.
