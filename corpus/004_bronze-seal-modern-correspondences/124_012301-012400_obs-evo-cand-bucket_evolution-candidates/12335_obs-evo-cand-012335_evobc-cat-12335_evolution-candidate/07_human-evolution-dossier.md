...
Project ID: `obs-evo-cand-012335`
...
- Project ID: `obs-evo-cand-012335`
- EVOBC category candidate ID: `evobc-evo-cat-12335`
- External category reference: `evobc-cat-12335`
- Source category ID: `12335`
- Source label for human review: `𨍮`
- Source codepoints: `U+2836E`
...
- `obs-evo-cand-012335-route-category-staging`
...
- `obs-evo-cand-012335-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012335-route-evolution-graph`
