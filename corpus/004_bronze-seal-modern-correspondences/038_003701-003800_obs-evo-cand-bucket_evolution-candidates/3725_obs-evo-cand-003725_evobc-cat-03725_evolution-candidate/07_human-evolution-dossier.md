...
- External category reference: `evobc-cat-03725`
- Source category ID: `03725`
- Source label for human review: `是`
- Source codepoints: `U+662F`
- Image reference count in source metadata: `255`
...
- `obs-evo-cand-003725-route-category-staging`
...
- `obs-evo-cand-003725-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003725-route-evolution-graph`
