# Material Visual Observation / obs-comp-cand-001147 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001147`
- External reference / 外部参照: `obimd-sub-cun5nm7d0f`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015325_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cun5nm7d0f/cun5nm7d0f/0gdd133pq6.png`
- Checksum / 校验和:
  `ab7cb0af9e6e5f2c7a9141f7230459ad7e7a8a3abe9cc42bc5ddf754ca6f536a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.22%.
- Marked-pixel bounds: (98,33)–(151,217); span 54 × 185 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.22%。
- 痕迹范围：(98,33)–(151,217)；跨度54 × 185 px；痕迹矩形高于宽。
