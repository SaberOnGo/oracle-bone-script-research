# obs-unk-006146 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006146`
- primary external id: `hust-obc-und-X-006146`
...
- local review image route: `corpus/001_oracle-characters/078_undeciphered-006
  101-006200_obs-unk-bucket_oracle-character-candidates/046_obs-unk-006146_h
  ust-obc-und-X-006146_oracle-character-candidate/03_visual-assets/001_asset
  -007738_hust-obc-und-X-006146_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1702/X_？_3882_1.png`
- asset id: `asset-007738`
...
- source class: `HUST-OBC/undeciphered/X/1702/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1702/X_？_3882_1.png`
- asset id: `asset-007738`
...
- Which source records identify obs-unk-006146 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006146？
