# Material Visual Observation / obs-comp-cand-000098 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000098`
- External reference / 外部参照: `obimd-sub-vaw8wrp6mi`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011510_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vaw8wrp6mi/vaw8wrp6mi/vaw8wrp6mi.png`
- Checksum / 校验和:
  `0bc77ff8953cb803f0c274e6e6203566a36316bb53307ebb0e5326f4d4af3e9a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.08%.
- Marked-pixel bounds: (71,18)–(178,231); span 108 × 214 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.08%。
- 痕迹范围：(71,18)–(178,231)；跨度108 × 214 px；痕迹矩形高于宽。
