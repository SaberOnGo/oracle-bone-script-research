...
- External category reference: `evobc-cat-05767`
- Source category ID: `05767`
- Source label for human review: `盩`
- Source codepoints: `U+76E9`
...
- `obs-evo-cand-005767-route-category-staging`
...
- `obs-evo-cand-005767-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005767-route-evolution-graph`
