...
Project ID: `obs-evo-cand-011776`
...
- Project ID: `obs-evo-cand-011776`
- EVOBC category candidate ID: `evobc-evo-cat-11776`
- External category reference: `evobc-cat-11776`
- Source category ID: `11776`
- Source label for human review: `𥆒`
- Source codepoints: `U+25192`
...
- `obs-evo-cand-011776-route-category-staging`
...
- `obs-evo-cand-011776-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011776-route-evolution-graph`
