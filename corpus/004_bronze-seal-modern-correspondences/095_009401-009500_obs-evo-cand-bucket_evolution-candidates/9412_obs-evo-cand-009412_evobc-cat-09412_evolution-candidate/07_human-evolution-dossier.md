...
- External category reference: `evobc-cat-09412`
- Source category ID: `09412`
- Source label for human review: `鋙`
...
- `obs-evo-cand-009412-route-category-staging`
...
- `obs-evo-cand-009412-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009412-route-evolution-graph`
