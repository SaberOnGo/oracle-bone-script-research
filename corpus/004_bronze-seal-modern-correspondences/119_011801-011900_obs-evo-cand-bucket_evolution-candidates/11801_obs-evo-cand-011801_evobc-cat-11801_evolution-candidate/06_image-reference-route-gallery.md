...
- `obs-evo-cand-011801-route-category-staging`
...
- `obs-evo-cand-011801-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011801-route-evolution-graph`
