...
- External category reference: `evobc-cat-04286`
- Source category ID: `04286`
...
- `obs-evo-cand-004286-route-category-staging`
...
- `obs-evo-cand-004286-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004286-route-evolution-graph`
