...
Project ID: `obs-evo-cand-006209`
...
- Project ID: `obs-evo-cand-006209`
- EVOBC category candidate ID: `evobc-evo-cat-06209`
- External category reference: `evobc-cat-06209`
- Source category ID: `06209`
- Source label for human review: `竪`
- Source codepoints: `U+7AEA`
...
- `obs-evo-cand-006209-route-category-staging`
...
- `obs-evo-cand-006209-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006209-route-evolution-graph`
