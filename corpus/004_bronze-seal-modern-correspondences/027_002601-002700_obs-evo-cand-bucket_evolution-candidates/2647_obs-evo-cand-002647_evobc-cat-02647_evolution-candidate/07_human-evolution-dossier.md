...
- External category reference: `evobc-cat-02647`
- Source category ID: `02647`
- Source label for human review: `帖`
- Source codepoints: `U+5E16`
...
- `obs-evo-cand-002647-route-category-staging`
...
- `obs-evo-cand-002647-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002647-route-evolution-graph`
