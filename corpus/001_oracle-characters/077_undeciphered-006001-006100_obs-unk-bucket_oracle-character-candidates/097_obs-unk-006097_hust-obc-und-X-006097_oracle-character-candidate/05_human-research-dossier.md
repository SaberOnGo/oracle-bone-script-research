# obs-unk-006097 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006097`
- primary external id: `hust-obc-und-X-006097`
...
- local review image route: `corpus/001_oracle-characters/077_undeciphered-006
  001-006100_obs-unk-bucket_oracle-character-candidates/097_obs-unk-006097_h
  ust-obc-und-X-006097_oracle-character-candidate/03_visual-assets/001_asset
  -007689_hust-obc-und-X-006097_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1653/X_？_3609_1.png`
- asset id: `asset-007689`
...
- source class: `HUST-OBC/undeciphered/X/1653/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1653/X_？_3609_1.png`
- asset id: `asset-007689`
...
- Which source records identify obs-unk-006097 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006097？
