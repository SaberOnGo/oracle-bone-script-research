...
- Review log draft ID / 复核日志草稿 ID: `source-engineering-gap-review-log-draft-0030`
- Source engineering gap ID / 来源工程缺口 ID: `source-engineering-gap-0030`
...
- Source ID / 来源 ID: `src-penn-museum-oracle-bone`
- Gap type / 缺口类型: `package_file_manifest_or_not_applicable_decision_needed`
- Priority rank / 优先级: `6`
- Current stage / 当前阶段: `pending_human_review`
- Authority tier / 来源层级: `university_museum_collection`
- Rights status / 权利状态: `metadata_only_until_verified`

## Observed Gap Evidence / 已观察缺口证据

`current_stage=pending_human_review;download_status_counts=downloaded:1;downloaded_count=1;download_log_count=1;checksum_present_count=1;field_map_count=3;package_manifest_count=0;metadata_profile_count=4;graph_edge_count=0;downloaded_file_bytes=29678;gap_type=package_file_manifest_or_not_applicable_decision_needed`
...
- metadata_profile_count: `4`
- graph_edge_count: `0`
- downloaded_file_bytes: `29678`
