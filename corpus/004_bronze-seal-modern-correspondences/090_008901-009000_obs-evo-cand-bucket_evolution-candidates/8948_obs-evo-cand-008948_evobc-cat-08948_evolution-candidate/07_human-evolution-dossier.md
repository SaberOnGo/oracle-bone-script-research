...
- Project ID: `obs-evo-cand-008948`
- EVOBC category candidate ID: `evobc-evo-cat-08948`
- External category reference: `evobc-cat-08948`
- Source category ID: `08948`
- Source label for human review: `迓`
- Source codepoints: `U+8FD3`
...
- `obs-evo-cand-008948-route-category-staging`
...
- `obs-evo-cand-008948-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008948-route-evolution-graph`
