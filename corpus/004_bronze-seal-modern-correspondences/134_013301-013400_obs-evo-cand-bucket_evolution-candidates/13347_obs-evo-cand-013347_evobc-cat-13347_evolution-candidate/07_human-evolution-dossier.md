...
- External category reference: `evobc-cat-13347`
- Source category ID: `13347`
- Source label: `𬤨`
...
- `obs-evo-cand-013347-route-category-staging`
...
- `obs-evo-cand-013347-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013347-route-evolution-graph`
