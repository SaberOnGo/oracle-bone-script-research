# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-007571
...
- EVOBC candidate category: `evobc-evo-cat-07571`.
- Source label for search only: `蔼`.
- Source codepoints for search only: `U+853C`.
