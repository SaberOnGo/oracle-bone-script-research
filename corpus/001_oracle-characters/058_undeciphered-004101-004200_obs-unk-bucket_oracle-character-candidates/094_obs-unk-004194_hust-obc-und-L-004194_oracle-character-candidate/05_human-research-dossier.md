# obs-unk-004194 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004194`
- primary external id: `hust-obc-und-L-004194`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/094_obs-unk-004194_h
  ust-obc-und-L-004194_oracle-character-candidate/03_visual-assets/001_asset
  -005787_hust-obc-und-L-004194_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4194/L_？_9133.jpg`
- asset id: `asset-005787`
...
- source class: `HUST-OBC/undeciphered/L/4194/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4194/L_？_9133.jpg`
- asset id: `asset-005787`
...
- English observation: `Upper loop, middle trace, and lower curve are visible.`
- 中文观察: `上部环形、中部痕迹和下部弧形可见。`
...
- Which source records identify obs-unk-004194 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004194？
