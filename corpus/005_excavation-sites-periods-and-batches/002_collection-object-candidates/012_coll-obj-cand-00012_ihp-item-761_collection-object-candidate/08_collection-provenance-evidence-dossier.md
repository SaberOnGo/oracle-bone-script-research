# Collection Provenance Evidence Dossier / 馆藏来源证据档案: coll-obj-cand-00012
...
The live page, source description, image checksums, and human observations are
...
| asset_id | `` |
| asset_path | `` |
| thumbnail_url | `https://museum.sinica.edu.tw/_upload/image/collection_item/thumbnail/1865f6886c275aed.jpg` |
| source_image_url | `` |
...
| `source_collection_item_id` | `761` |
| `object_title_en` | `Inscribed Animal Bone Fragment Chia 2659+2716+2763` |
| `catalog_reference_text` | `Chia 2659+2716+2763` |
| `accession_number` | `` |
| `historical_period` | `` |
| `object_date` | `` |
| `provenience` | `` |
