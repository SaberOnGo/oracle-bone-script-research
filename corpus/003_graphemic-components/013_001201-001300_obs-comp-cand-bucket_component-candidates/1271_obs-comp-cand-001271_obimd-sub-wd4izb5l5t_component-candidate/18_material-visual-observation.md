# Material Visual Observation / obs-comp-cand-001271 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001271`
- External reference / 外部参照: `obimd-sub-wd4izb5l5t`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015509_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/frmptf4le7/wd4izb5l5t/wd4izb5l5t.png`
- Checksum / 校验和:
  `5f9c6e9ee1fd6a3feed656a0b1daaa9b6cc07edc33cbecffcf735fa2fc8d4437`
...
- Marked-pixel bounds: (97,19)–(152,228); span 56 × 210 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.46%。
- 痕迹范围：(97,19)–(152,228)；跨度56 × 210 px；痕迹矩形高于宽。
