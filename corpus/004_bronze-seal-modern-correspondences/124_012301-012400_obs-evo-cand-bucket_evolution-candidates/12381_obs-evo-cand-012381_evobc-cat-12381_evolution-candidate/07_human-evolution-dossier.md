...
- Project ID: `obs-evo-cand-012381`
- EVOBC category candidate ID: `evobc-evo-cat-12381`
- External category reference: `evobc-cat-12381`
- Source category ID: `12381`
- Source label for human review: `𨖤`
- Source codepoints: `U+285A4`
...
- `obs-evo-cand-012381-route-category-staging`
...
- `obs-evo-cand-012381-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012381-route-evolution-graph`
