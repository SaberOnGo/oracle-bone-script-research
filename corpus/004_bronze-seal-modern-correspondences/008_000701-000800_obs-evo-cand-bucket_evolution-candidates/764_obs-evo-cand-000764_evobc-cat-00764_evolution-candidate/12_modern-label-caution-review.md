# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000764
...
- EVOBC candidate category: `evobc-evo-cat-00764`.
- Source label for search only: `伊`.
- Source codepoints for search only: `U+4F0A`.
