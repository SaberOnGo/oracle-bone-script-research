...
- Project ID: `obs-evo-cand-002859`
- EVOBC category candidate ID: `evobc-evo-cat-02859`
- External category reference: `evobc-cat-02859`
- Source category ID: `02859`
- Source label for human review: `往`
- Source codepoints: `U+5F80`
- Image reference count in source metadata: `73`
...
- `obs-evo-cand-002859-route-category-staging`
...
- `obs-evo-cand-002859-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002859-route-evolution-graph`
