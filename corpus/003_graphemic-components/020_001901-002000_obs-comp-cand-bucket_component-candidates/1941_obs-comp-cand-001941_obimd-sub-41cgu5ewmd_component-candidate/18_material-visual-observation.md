# Material Visual Observation / obs-comp-cand-001941 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001941`
- External reference / 外部参照: `obimd-sub-41cgu5ewmd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018727_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/41cgu5ewmd/41cgu5ewmd/41cgu5ewmd.png`
- Checksum / 校验和:
  `fe5e1bb34efd1717a230fa90833b69a6c588168b9ec9a68a513d956af4bb5d3a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.74%.
- Marked-pixel bounds: (49,19)–(205,231); span 157 × 213 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.74%。
- 痕迹范围：(49,19)–(205,231)；跨度157 × 213 px；痕迹矩形高于宽。
