# obs-char-001420 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1420_obs-char-001420_hust-obc-cat-1589_159
  0_1591_oracle-character/03_visual-assets/001_asset-001425_hust-obc-cat-158
  9_1590_1591_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1589_1590_1591/1589/G_1589_前2.3
  0.6(甲).png`
- asset id: `asset-001425`
...
- source category: `1589_1590_1591`
- validation class: `1419`
- source image route: `HUST-OBC/deciphered/1589_1590_1591/1589/G_1589_前2.30.6(
  甲).png`
- asset id: `asset-001425`
...
- English observation: `A tiny dense composite has a narrow left cluster, a
  right enclosure, and branches.`
...
- dataset label text: `㨫㨬㨭`
- dataset label codepoints: `U+3A2B;U+3A2C;U+3A2D`
...
- Which source records identify obs-char-001420 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001420？
