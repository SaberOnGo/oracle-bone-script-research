...
- External category reference: `evobc-cat-12049`
- Source category ID: `12049`
- Source label for human review: `𦝒`
...
- `obs-evo-cand-012049-route-category-staging`
...
- `obs-evo-cand-012049-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012049-route-evolution-graph`
