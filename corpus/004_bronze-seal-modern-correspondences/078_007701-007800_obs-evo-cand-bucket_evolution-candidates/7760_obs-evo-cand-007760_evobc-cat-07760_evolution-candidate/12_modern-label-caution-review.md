# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-007760
...
- EVOBC candidate category: `evobc-evo-cat-07760`.
- Source label for search only: `蛵`.
- Source codepoints for search only: `U+86F5`.
