# Material Visual Observation / obs-comp-cand-002545 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002545`
- External reference / 外部参照: `obimd-sub-7bgm052mqy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021064_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7bgm052mqy/7bgm052mqy/1cjsy1vq9c.png`
- Checksum / 校验和:
  `e694f13a288c794da9d03ea8855aa6125481873f3a5954bae37c4e12820e1574`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.11%.
- Marked-pixel bounds: (71,39)–(178,206); span 108 × 168 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.11%。
- 痕迹范围：(71,39)–(178,206)；跨度108 × 168 px；痕迹矩形高于宽。
