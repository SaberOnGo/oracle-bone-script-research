...
- `obs-evo-cand-003058-route-category-staging`
...
- `obs-evo-cand-003058-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003058-route-evolution-graph`
