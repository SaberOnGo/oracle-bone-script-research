...
- `obs-evo-cand-001812-route-category-staging`
...
- `obs-evo-cand-001812-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001812-route-evolution-graph`
