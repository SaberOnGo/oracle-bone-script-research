...
- Project ID / 项目 ID: `obs-char-000959`
- Primary external ID / 首选外部 ID: `hust-obc-cat-1079`
...
- Source image / 来源图: `G_1079_甲骨文.png`
- Image / 图像: `001_asset-000964_hust-obc-cat-1079_glyph.png`
...
- target node: `evobc-evo-cat-00088`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00088`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00088`
...
- Matched candidate folders / 匹配候选目录: `evobc-evo-cat-00088`
- Human review files / 人类复核文件:
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/088_obs-evo-cand-000088_evobc-cat-00088_evoluti
...
- Source label text / 来源标签文字: `㠭`
- Source label codepoint / 来源标签 codepoint: `U+382D`
