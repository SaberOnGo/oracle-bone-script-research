# obs-char-001326 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1326_obs-char-001326_hust-obc-cat-1482_ora
  cle-character/03_visual-assets/001_asset-001331_hust-obc-cat-1482_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1482/G_1482_粹1160(甲).png`
- asset id: `asset-001331`
...
- source category: `1482`
- validation class: `1325`
- source image route: `HUST-OBC/deciphered/1482/G_1482_粹1160(甲).png`
- asset id: `asset-001331`
...
- English observation: `The image combines separated side marks with a
  central diamond enclosure and a long right descending stroke.`
...
- dataset label text: `㧀`
- dataset label codepoints: `U+39C0`
...
- Which source records identify obs-char-001326 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001326？
