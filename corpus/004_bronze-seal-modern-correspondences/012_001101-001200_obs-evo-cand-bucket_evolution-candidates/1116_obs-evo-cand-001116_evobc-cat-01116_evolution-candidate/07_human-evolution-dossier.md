...
- External category reference: `evobc-cat-01116`
- Source category ID: `01116`
- Source label for human review: `冎`
...
- `obs-evo-cand-001116-route-category-staging`
...
- `obs-evo-cand-001116-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001116-route-evolution-graph`
