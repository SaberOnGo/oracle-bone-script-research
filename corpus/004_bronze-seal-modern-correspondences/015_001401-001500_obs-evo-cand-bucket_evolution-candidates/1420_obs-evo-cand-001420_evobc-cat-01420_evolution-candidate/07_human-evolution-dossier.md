...
- External category reference: `evobc-cat-01420`
- Source category ID: `01420`
- Source label for human review: `厕`
...
- `obs-evo-cand-001420-route-category-staging`
...
- `obs-evo-cand-001420-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001420-route-evolution-graph`
