# obs-unk-008982 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008982`
- primary external id: `hust-obc-und-YH-008982`
...
- local review image route: `corpus/001_oracle-characters/106_undeciphered-008
  901-009000_obs-unk-bucket_oracle-character-candidates/082_obs-unk-008982_h
  ust-obc-und-YH-008982_oracle-character-candidate/03_visual-assets/001_asse
  t-010573_hust-obc-und-YH-008982_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60FEA/H_？_60FEA_0.png`
- asset id: `asset-010573`
...
- source class: `HUST-OBC/undeciphered/Y+H/60FEA/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60FEA/H_？_60FEA_0.png`
- asset id: `asset-010573`
...
- Which source records identify obs-unk-008982 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008982？
