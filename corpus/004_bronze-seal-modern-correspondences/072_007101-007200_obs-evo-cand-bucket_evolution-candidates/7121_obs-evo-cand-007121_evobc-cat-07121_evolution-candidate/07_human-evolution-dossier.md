...
Project ID: `obs-evo-cand-007121`
...
- Project ID: `obs-evo-cand-007121`
- EVOBC category candidate ID: `evobc-evo-cat-07121`
- External category reference: `evobc-cat-07121`
- Source category ID: `07121`
- Source label for human review: `膎`
- Source codepoints: `U+818E`
...
- `obs-evo-cand-007121-route-category-staging`
...
- `obs-evo-cand-007121-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007121-route-evolution-graph`
