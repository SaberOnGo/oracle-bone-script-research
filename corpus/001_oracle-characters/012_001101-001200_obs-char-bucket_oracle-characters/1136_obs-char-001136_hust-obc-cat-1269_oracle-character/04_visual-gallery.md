# obs-char-001136 Visual Gallery / obs-char-001136 图像资料页
...
- Project ID / 项目 ID: `obs-char-001136`
- Primary external reference / 首选外部参考: `hust-obc-cat-1269`
...
## obs-char-001136-visual-source-001 / 图像条目

![obs-char-001136 glyph candidate](03_visual-assets/001_asset-001141_hust-obc-cat-1269_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-001141_hust-obc-cat-1269_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-001141_hust-obc-cat-1269_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/1269/G_1269_乙8896(甲).png`
