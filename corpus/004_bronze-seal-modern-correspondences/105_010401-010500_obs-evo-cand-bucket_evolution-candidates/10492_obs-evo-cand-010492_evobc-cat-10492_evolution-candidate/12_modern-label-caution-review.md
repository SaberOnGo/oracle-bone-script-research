# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010492
...
- EVOBC candidate category: `evobc-evo-cat-10492`.
- Source label for search only: `鴟`.
- Source codepoints for search only: `U+9D1F`.
