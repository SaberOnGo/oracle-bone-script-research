...
- External category reference: `evobc-cat-07255`
- Source category ID: `07255`
- Source label for human review: `芪`
...
- `obs-evo-cand-007255-route-category-staging`
...
- `obs-evo-cand-007255-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007255-route-evolution-graph`
