...
- Project ID: `obs-evo-cand-005389`
- EVOBC category candidate ID: `evobc-evo-cat-05389`
- External category reference: `evobc-cat-05389`
- Source category ID: `05389`
- Source label for human review: `珧`
- Source codepoints: `U+73E7`
...
- `obs-evo-cand-005389-route-category-staging`
...
- `obs-evo-cand-005389-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005389-route-evolution-graph`
