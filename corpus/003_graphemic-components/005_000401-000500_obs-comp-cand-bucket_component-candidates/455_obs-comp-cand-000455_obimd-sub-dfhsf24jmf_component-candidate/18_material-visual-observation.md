# Material Visual Observation / obs-comp-cand-000455 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000455`
- External reference / 外部参照: `obimd-sub-dfhsf24jmf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012603_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dgw10rc4gi/dfhsf24jmf/dfhsf24jmf.png`
- Checksum / 校验和:
  `0809b58fa3c279189746919b8058bd5129943ec051677bf7de6fc3645a9c752a`
...
- Marked-pixel bounds: (79,24)–(170,225); span 92 × 202 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.08%。
- 痕迹范围：(79,24)–(170,225)；跨度92 × 202 px；痕迹矩形高于宽。
