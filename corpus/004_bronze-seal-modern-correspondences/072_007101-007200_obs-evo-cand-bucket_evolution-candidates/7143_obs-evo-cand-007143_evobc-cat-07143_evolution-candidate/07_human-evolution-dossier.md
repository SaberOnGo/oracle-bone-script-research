...
- External category reference: `evobc-cat-07143`
- Source category ID: `07143`
- Source label: `膿`
...
- `obs-evo-cand-007143-route-category-staging`
...
- `obs-evo-cand-007143-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007143-route-evolution-graph`
