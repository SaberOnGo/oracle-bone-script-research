...
Project ID: `obs-evo-cand-004294`
...
- Project ID: `obs-evo-cand-004294`
- EVOBC category candidate ID: `evobc-evo-cat-04294`
- External category reference: `evobc-cat-04294`
- Source category ID: `04294`
- Source label for human review: `檢`
- Source codepoints: `U+6AA2`
...
- `obs-evo-cand-004294-route-category-staging`
...
- `obs-evo-cand-004294-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004294-route-evolution-graph`
