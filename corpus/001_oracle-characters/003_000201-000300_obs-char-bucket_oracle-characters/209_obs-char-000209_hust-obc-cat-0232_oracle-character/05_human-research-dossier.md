# obs-char-000209 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000209`
- primary external id: `hust-obc-cat-0232`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/209_obs-char-000209_hust-obc-cat-0232_orac
  le-character/03_visual-assets/001_asset-000214_hust-obc-cat-0232_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0232/G_0232_乙2262合4814賓組.png`
- asset id: `asset-000214`
...
- source category: `0232`
- validation class: `208`
- source image route: `HUST-OBC/deciphered/0232/G_0232_乙2262合4814賓組.png`
- asset id: `asset-000214`
...
- English observation: `The image combines a compact grid of crossing
  strokes on the left with a separate long curved stroke on the right.`
- 中文观察: `图像左侧为紧凑交叉笔组成的网格，右侧另有一条分离的长弯曲笔。`
...
- dataset label text: `㓞`
- dataset label codepoints: `U+34DE`
...
- OBIMD candidate ids / OBIMD 候选 ID: `obimd-main-cand-003002`
- OBIMD external refs / OBIMD 外部引用: `obimd-main-nzqdb3i249`
- OBIMD transcription field / OBIMD 转写字段: `𠛉|㓞`
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00021`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00021`
- EvoBC image reference count / EvoBC 图像引用数: `28`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00021`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/021_obs-evo-can
  d-000021_evobc-cat-00021_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/021_obs-evo-cand-000021_evobc-cat-00021_evolu
...
- matched OBIMD main UIDs: `nzqdb3i249`
...
- filename catalog route clues: `Heji-like filename clue: 合4814
  (G_0232_乙2262合4814賓組.png)`
...
- Which source records identify obs-char-000209 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000209？
