...
- External category reference: `evobc-cat-10005`
- Source category ID: `10005`
- Source label for human review: `頹`
- Source codepoints: `U+9839`
...
- `obs-evo-cand-010005-route-category-staging`
...
- `obs-evo-cand-010005-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010005-route-evolution-graph`
