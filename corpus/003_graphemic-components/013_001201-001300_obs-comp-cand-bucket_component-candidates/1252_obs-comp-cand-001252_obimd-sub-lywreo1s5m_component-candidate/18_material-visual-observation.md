# Material Visual Observation / obs-comp-cand-001252 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001252`
- External reference / 外部参照: `obimd-sub-lywreo1s5m`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015490_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2rptsk0t7g/lywreo1s5m/lywreo1s5m.png`
- Checksum / 校验和:
  `ac63ff81a20a0311e64e1dcb024914ac9bf6647e7a00118b357fc487b5adcb4d`
...
- Marked-pixel bounds: (63,34)–(197,219); span 135 × 186 px; the marked
...
- 痕迹范围：(63,34)–(197,219)；跨度135 × 186 px；痕迹矩形高于宽。
