# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-007359
...
- EVOBC candidate category: `evobc-evo-cat-07359`.
- Source label for search only: `药`.
- Source codepoints for search only: `U+836F`.
