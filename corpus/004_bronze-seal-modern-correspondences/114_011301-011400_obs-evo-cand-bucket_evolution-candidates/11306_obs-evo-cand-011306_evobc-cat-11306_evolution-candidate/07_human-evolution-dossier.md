...
- Project ID: `obs-evo-cand-011306`
- EVOBC category candidate ID: `evobc-evo-cat-11306`
- External category reference: `evobc-cat-11306`
- Source category ID: `11306`
- Source label for human review: `𢮘`
- Source codepoints: `U+22B98`
...
- `obs-evo-cand-011306-route-category-staging`
...
- `obs-evo-cand-011306-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011306-route-evolution-graph`
