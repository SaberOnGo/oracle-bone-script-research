...
- External category reference: `evobc-cat-05131`
- Source category ID: `05131`
- Source label for human review: `熜`
...
- `obs-evo-cand-005131-route-category-staging`
...
- `obs-evo-cand-005131-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005131-route-evolution-graph`
