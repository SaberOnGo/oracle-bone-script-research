...
- External category reference: `evobc-cat-01816`
- Source category ID: `01816`
- Source label for human review: `坒`
...
- `obs-evo-cand-001816-route-category-staging`
...
- `obs-evo-cand-001816-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001816-route-evolution-graph`
