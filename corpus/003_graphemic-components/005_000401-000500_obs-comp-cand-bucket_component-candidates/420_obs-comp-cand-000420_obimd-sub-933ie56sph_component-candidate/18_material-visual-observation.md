# Material Visual Observation / obs-comp-cand-000420 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000420`
- External reference / 外部参照: `obimd-sub-933ie56sph`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012343_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/933ie56sph/933ie56sph/933ie56sph.png`
- Checksum / 校验和:
  `8daa54e2d6c911ee15f8b5aa5ab94647e77b1a44b657acd655e7ca515fba76c1`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.71%.
- Marked-pixel bounds: (82,16)–(167,230); span 86 × 215 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.71%。
- 痕迹范围：(82,16)–(167,230)；跨度86 × 215 px；痕迹矩形高于宽。
