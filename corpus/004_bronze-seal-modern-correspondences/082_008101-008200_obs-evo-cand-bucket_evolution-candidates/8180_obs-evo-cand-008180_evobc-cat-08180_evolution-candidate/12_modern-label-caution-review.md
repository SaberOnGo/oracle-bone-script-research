# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008180
...
- EVOBC candidate category: `evobc-evo-cat-08180`.
- Source label for search only: `詗`.
- Source codepoints for search only: `U+8A57`.
