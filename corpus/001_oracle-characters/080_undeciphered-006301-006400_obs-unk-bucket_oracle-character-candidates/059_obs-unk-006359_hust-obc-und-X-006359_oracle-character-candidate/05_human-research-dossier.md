# obs-unk-006359 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006359`
- primary external id: `hust-obc-und-X-006359`
...
- local review image route: `corpus/001_oracle-characters/080_undeciphered-006
  301-006400_obs-unk-bucket_oracle-character-candidates/059_obs-unk-006359_h
  ust-obc-und-X-006359_oracle-character-candidate/03_visual-assets/001_asset
  -007950_hust-obc-und-X-006359_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1915/X_？_5260_1.png`
- asset id: `asset-007950`
...
- source class: `HUST-OBC/undeciphered/X/1915/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1915/X_？_5260_1.png`
- asset id: `asset-007950`
...
- Which source records identify obs-unk-006359 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006359？
