...
- External category reference: `evobc-cat-11563`
- Source category ID: `11563`
- Source label for human review: `𤊢`
- Source codepoints: `U+242A2`
- Image reference count in source metadata: `3`
...
- `obs-evo-cand-011563-route-category-staging`
...
- `obs-evo-cand-011563-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011563-route-evolution-graph`
