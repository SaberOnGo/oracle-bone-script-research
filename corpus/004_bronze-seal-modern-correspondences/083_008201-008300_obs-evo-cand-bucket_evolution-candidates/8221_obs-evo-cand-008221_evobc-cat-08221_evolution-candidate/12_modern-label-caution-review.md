# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008221
...
- EVOBC candidate category: `evobc-evo-cat-08221`.
- Source label for search only: `誋`.
- Source codepoints for search only: `U+8A8B`.
