# coll-obj-cand-00012 collection object candidate
...
The official page exposes three large-image routes for private inspection.
...
官方页面提供三条大图路线，仅供本地检查。请先看
`18_live-source-evidence-review.md` 中的校验和、尺寸、观察与权利边界。
图像字节只保留在被忽略的 `.working/ihp-761/`。
...
- `18_live-source-evidence-review.md`: official page, description, and image
  route evidence.
