...
- External category reference: `evobc-cat-09615`
- Source category ID: `09615`
- Source label for human review: `閉`
- Source codepoints: `U+9589`
...
- `obs-evo-cand-009615-route-category-staging`
...
- `obs-evo-cand-009615-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009615-route-evolution-graph`
