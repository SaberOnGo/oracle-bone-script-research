...
- Yingguo / 英国所藏: `y2524` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `348` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `584` in source row; primary catalog entry pending
- Heji / 合集: `41753` in source row; primary catalog entry pending
