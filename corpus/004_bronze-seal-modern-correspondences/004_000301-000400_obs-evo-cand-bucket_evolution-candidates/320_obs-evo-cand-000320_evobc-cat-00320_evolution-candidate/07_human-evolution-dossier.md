...
Project ID: `obs-evo-cand-000320`
...
- Project ID: `obs-evo-cand-000320`
- EVOBC category candidate ID: `evobc-evo-cat-00320`
- External category reference: `evobc-cat-00320`
- Source category ID: `00320`
- Source label for human review: `䋎`
- Source codepoints: `U+42CE`
...
- `obs-evo-cand-000320-route-category-staging`
...
- `obs-evo-cand-000320-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000320-route-evolution-graph`
