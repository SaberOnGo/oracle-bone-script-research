...
Project ID: `obs-evo-cand-009315`
...
- Project ID: `obs-evo-cand-009315`
- EVOBC category candidate ID: `evobc-evo-cat-09315`
- External category reference: `evobc-cat-09315`
- Source category ID: `09315`
- Source label for human review: `釭`
- Source codepoints: `U+91ED`
...
- `obs-evo-cand-009315-route-category-staging`
...
- `obs-evo-cand-009315-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009315-route-evolution-graph`
