# Material Visual Observation / obs-comp-cand-002500 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002500`
- External reference / 外部参照: `obimd-sub-a1lmo1xxj5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020754_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/a1lmo1xxj5/a1lmo1xxj5/43l4aclzq5.png`
- Checksum / 校验和:
  `963258b49c3b320b9fceae52e32a02b8befb58e5aec4af337070dd80b32fa71f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.54%.
- Marked-pixel bounds: (70,33)–(179,211); span 110 × 179 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.54%。
- 痕迹范围：(70,33)–(179,211)；跨度110 × 179 px；痕迹矩形高于宽。
