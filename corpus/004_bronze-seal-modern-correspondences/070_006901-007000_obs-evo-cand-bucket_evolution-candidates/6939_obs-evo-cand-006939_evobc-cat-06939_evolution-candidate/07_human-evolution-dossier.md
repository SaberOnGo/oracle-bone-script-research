...
- External category reference: `evobc-cat-06939`
- Source category ID: `06939`
- Source label for human review: `聆`
...
- `obs-evo-cand-006939-route-category-staging`
...
- `obs-evo-cand-006939-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006939-route-evolution-graph`
