...
- External category reference: `evobc-cat-07594`
- Source category ID: `07594`
- Source label for human review: `蕫`
- Source codepoints: `U+856B`
...
- `obs-evo-cand-007594-route-category-staging`
...
- `obs-evo-cand-007594-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007594-route-evolution-graph`
