...
- External category reference: `evobc-cat-12860`
- Source category ID: `12860`
- Source label for human review: `𪯢`
...
- `obs-evo-cand-012860-route-category-staging`
...
- `obs-evo-cand-012860-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012860-route-evolution-graph`
