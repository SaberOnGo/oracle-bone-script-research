# obs-evo-cand-006248 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-06248`
- Source label for human review: `笲`
- Source codepoints: `U+7B32`
- Image reference count: `25`
- Era token counts: `WSC:25`
- Source token counts: `Book:5;Web:20`
