...
- External category reference: `evobc-cat-01086`
- Source category ID: `01086`
- Source label for human review: `入`
- Source codepoints: `U+5165`
- Image reference count in source metadata: `170`
...
- `obs-evo-cand-001086-route-category-staging`
...
- `obs-evo-cand-001086-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001086-route-evolution-graph`
