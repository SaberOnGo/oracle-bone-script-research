...
Project ID: `obs-evo-cand-011422`
...
- Project ID: `obs-evo-cand-011422`
- EVOBC category candidate ID: `evobc-evo-cat-11422`
- External category reference: `evobc-cat-11422`
- Source category ID: `11422`
- Source label for human review: `𣎪`
- Source codepoints: `U+233AA`
...
- `obs-evo-cand-011422-route-category-staging`
...
- `obs-evo-cand-011422-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011422-route-evolution-graph`
