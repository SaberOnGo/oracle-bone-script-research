# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002169
...
- EVOBC candidate category: `evobc-evo-cat-02169`.
- Source label for search only: `娜`.
- Source codepoints for search only: `U+5A1C`.
