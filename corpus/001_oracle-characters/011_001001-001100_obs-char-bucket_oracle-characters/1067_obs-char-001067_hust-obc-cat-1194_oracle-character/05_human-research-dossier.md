# obs-char-001067 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001067`
- primary external id: `hust-obc-cat-1194`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1067_obs-char-001067_hust-obc-cat-1194_ora
  cle-character/03_visual-assets/001_asset-001072_hust-obc-cat-1194_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1194/G_1194_甲骨文.png`
- asset id: `asset-001072`
...
- source category: `1194`
- validation class: `1066`
- source image route: `HUST-OBC/deciphered/1194/G_1194_甲骨文.png`
- asset id: `asset-001072`
...
- English observation: `A small rectangular enclosure is divided into
  several interior cells and topped by a central branching stroke.`
- 中文观察: `小型矩形闭合轮廓内分为数个内部格状区域，上方有中央分枝笔。`
...
- dataset label text: `㢠`
- dataset label codepoints: `U+38A0`
...
- Which source records identify obs-char-001067 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001067？
