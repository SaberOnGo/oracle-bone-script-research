...
- External category reference: `evobc-cat-12358`
- Source category ID: `12358`
- Source label for human review: `𨒪`
- Source codepoints: `U+284AA`
...
- `obs-evo-cand-012358-route-category-staging`
...
- `obs-evo-cand-012358-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012358-route-evolution-graph`
