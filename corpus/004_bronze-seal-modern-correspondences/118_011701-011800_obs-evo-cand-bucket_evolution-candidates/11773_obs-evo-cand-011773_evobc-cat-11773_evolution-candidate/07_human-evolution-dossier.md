...
- External category reference: `evobc-cat-11773`
- Source category ID: `11773`
- Source label for human review: `𥅨`
...
- `obs-evo-cand-011773-route-category-staging`
...
- `obs-evo-cand-011773-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011773-route-evolution-graph`
