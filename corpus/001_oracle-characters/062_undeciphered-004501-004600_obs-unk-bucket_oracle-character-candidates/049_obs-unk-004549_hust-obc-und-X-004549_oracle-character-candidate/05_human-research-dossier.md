# obs-unk-004549 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004549`
- primary external id: `hust-obc-und-X-004549`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/049_obs-unk-004549_h
  ust-obc-und-X-004549_oracle-character-candidate/03_visual-assets/001_asset
  -006142_hust-obc-und-X-004549_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/105/X_？_8287_1.png`
- asset id: `asset-006142`
...
- source class: `HUST-OBC/undeciphered/X/105/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/105/X_？_8287_1.png`
- asset id: `asset-006142`
...
- English observation: `Horizontal trace and upper prongs recorded.`
- 中文观察: `已记录横向主体和上部尖突。`
...
- Which source records identify obs-unk-004549 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004549？
