...
- External category reference: `evobc-cat-02493`
- Source category ID: `02493`
- Source label for human review: `尾`
- Source codepoints: `U+5C3E`
- Image reference count in source metadata: `54`
...
- `obs-evo-cand-002493-route-category-staging`
...
- `obs-evo-cand-002493-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002493-route-evolution-graph`
