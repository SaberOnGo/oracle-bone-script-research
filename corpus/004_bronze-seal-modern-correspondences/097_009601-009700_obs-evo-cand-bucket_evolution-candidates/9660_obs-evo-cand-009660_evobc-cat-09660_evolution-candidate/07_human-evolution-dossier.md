...
- External category reference: `evobc-cat-09660`
- Source category ID: `09660`
- Source label for human review: `闖`
- Source codepoints: `U+95D6`
...
- `obs-evo-cand-009660-route-category-staging`
...
- `obs-evo-cand-009660-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009660-route-evolution-graph`
