# obs-char-000062 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/062_obs-char-000062_hust-obc-cat-0072_orac
  le-character/03_visual-assets/001_asset-000067_hust-obc-cat-0072_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0072/G_0072_林2.25.6合36518黃組.png
  `
- asset id: `asset-000067`
...
- source category: `0072`
- validation class: `61`
- source image route: `HUST-OBC/deciphered/0072/G_0072_林2.25.6合36518黃組.png`
- asset id: `asset-000067`
...
- English observation: `The thin image has a central upright stroke, a
  pointed upper loop-like mark, and a hooked lower extension.`
...
- dataset label text: `㐾`
- dataset label codepoints: `U+343E`
...
- filename catalog route clues: `Heji-like filename clue: 合36518
...
- Which source records identify obs-char-000062 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000062？
