# Collection Provenance Evidence Dossier / 馆藏来源证据档案: coll-obj-cand-00006
...
`18_live-source-evidence-review.md`. It reports `R041291`, Late Shang Period,
SYFYH127, and two private JPEG routes. The source display retains three inline
image placeholders, so it is not a complete transcription.

现场官方页面复核见 `18_live-source-evidence-review.md`。该页记录 `R041291`、
晚商、SYFYH127 和两条本地私有 JPEG 路线。来源文字仍有三个内嵌图像占位符，
因此不是完整释文。
