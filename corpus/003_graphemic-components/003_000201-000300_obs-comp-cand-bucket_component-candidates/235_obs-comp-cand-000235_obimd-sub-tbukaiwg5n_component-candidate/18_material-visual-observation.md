# Material Visual Observation / obs-comp-cand-000235 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000235`
- External reference / 外部参照: `obimd-sub-tbukaiwg5n`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011882_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/id0m0j1kjy/tbukaiwg5n/tbukaiwg5n.png`
- Checksum / 校验和:
  `f2eb1b5e169a18b56634fc6fdfbb16ad8e6038594b51412816f82ef05c5ffdac`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.97%.
- Marked-pixel bounds: (59,39)–(190,212); span 132 × 174 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.97%。
- 痕迹范围：(59,39)–(190,212)；跨度132 × 174 px；痕迹矩形高于宽。
