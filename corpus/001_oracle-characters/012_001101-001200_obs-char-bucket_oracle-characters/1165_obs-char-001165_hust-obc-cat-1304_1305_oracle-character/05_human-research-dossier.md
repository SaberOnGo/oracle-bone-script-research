# obs-char-001165 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1165_obs-char-001165_hust-obc-cat-1304_130
  5_oracle-character/03_visual-assets/001_asset-001170_hust-obc-cat-1304_130
  5_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1304_1305/1304/G_1304_乙5637(甲).
  png`
- asset id: `asset-001170`
...
- source category: `1304_1305`
- validation class: `1164`
- source image route: `HUST-OBC/deciphered/1304_1305/1304/G_1304_乙5637(甲).png`
- asset id: `asset-001170`
...
- English observation: `A narrow upright form has a pointed upper tip, a
  long left contour, and a separate rounded loop on the right.`
- 中文观察: `狭长直立形体有尖状上端、长左侧轮廓和右侧独立圆弧环。`
...
- dataset label text: `㤎㤏`
- dataset label codepoints: `U+390E;U+390F`
...
- Which source records identify obs-char-001165 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001165？
