# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010755
...
- EVOBC candidate category: `evobc-evo-cat-10755`.
- Source label for search only: `龝`.
- Source codepoints for search only: `U+9F9D`.
