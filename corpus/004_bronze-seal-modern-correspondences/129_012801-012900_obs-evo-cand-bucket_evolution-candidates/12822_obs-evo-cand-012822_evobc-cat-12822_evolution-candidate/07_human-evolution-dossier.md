...
- Project ID: `obs-evo-cand-012822`
- EVOBC category candidate ID: `evobc-evo-cat-12822`
- External category reference: `evobc-cat-12822`
- Source category ID: `12822`
- Source label for human review: `𪥽`
- Source codepoints: `U+2A97D`
...
- `obs-evo-cand-012822-route-category-staging`
...
- `obs-evo-cand-012822-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012822-route-evolution-graph`
