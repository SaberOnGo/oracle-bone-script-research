...
Project ID: `obs-evo-cand-000079`
...
- Project ID: `obs-evo-cand-000079`
- EVOBC category candidate ID: `evobc-evo-cat-00079`
- External category reference: `evobc-cat-00079`
- Source category ID: `00079`
- Source label for human review: `㞁`
- Source codepoints: `U+3781`
...
- `obs-evo-cand-000079-route-category-staging`
...
- `obs-evo-cand-000079-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000079-route-evolution-graph`
