# obs-char-000303 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/303_obs-char-000303_hust-obc-cat-0343_orac
  le-character/03_visual-assets/001_asset-000308_hust-obc-cat-0343_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0343/G_0343_乙1278反合376反賓組.png`
- asset id: `asset-000308`
...
- source category: `0343`
- validation class: `302`
- source image route: `HUST-OBC/deciphered/0343/G_0343_乙1278反合376反賓組.png`
- asset id: `asset-000308`
...
- English observation: `A long descending central stroke is joined to a
  rounded right enclosure; a curved lower tail extends to the left.`
- 中文观察: `图像中部有长下行笔画并连接右侧圆弧闭合轮廓，下方有向左弯曲的尾部。`
...
- dataset label text: `㕍`
- dataset label codepoints: `U+354D`
...
- Which source records identify obs-char-000303 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000303？
