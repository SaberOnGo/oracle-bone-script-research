...
Project ID: `obs-evo-cand-010978`
...
- Project ID: `obs-evo-cand-010978`
- EVOBC category candidate ID: `evobc-evo-cat-10978`
- External category reference: `evobc-cat-10978`
- Source category ID: `10978`
- Source label for human review: `𡉗`
- Source codepoints: `U+21257`
...
- `obs-evo-cand-010978-route-category-staging`
...
- `obs-evo-cand-010978-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010978-route-evolution-graph`
