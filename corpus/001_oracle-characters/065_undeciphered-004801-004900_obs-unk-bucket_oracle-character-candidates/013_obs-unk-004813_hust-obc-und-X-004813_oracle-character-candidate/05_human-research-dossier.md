# obs-unk-004813 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004813`
- primary external id: `hust-obc-und-X-004813`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/013_obs-unk-004813_h
  ust-obc-und-X-004813_oracle-character-candidate/03_visual-assets/001_asset
  -006406_hust-obc-und-X-004813_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/369/X_？_7354_1.png`
- asset id: `asset-006406`
...
- source class: `HUST-OBC/undeciphered/X/369/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/369/X_？_7354_1.png`
- asset id: `asset-006406`
...
- English observation: `dense upper cluster and lower branches`
- 中文观察: `高窄构图、上部密集结构和下部枝状笔画`
...
- Which source records identify obs-unk-004813 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004813？
