...
- `obs-evo-cand-003022-route-category-staging`
...
- `obs-evo-cand-003022-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003022-route-evolution-graph`
