...
- External category reference: `evobc-cat-09191`
- Source category ID: `09191`
- Source label for human review: `鄖`
...
- `obs-evo-cand-009191-route-category-staging`
...
- `obs-evo-cand-009191-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009191-route-evolution-graph`
