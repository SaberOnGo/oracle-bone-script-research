# obs-evo-cand-002409 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-002409`
- EVOBC category candidate ID: `evobc-evo-cat-02409`
- External category ref: `evobc-cat-02409`
- Source label: `寅`
- Source codepoints: `U+5BC5`
- Image reference count: `228`
- Era token counts: `BI:106;OBC:56;SAC:7;SS:1;WSC:58`
- Source token counts: `Book:104;Web:124`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 56 image references
- era 1 / BI: 106 image references
- era 2 / SS: 1 image references
- era 3 / SAC: 7 image references
- era 4 / WSC: 58 image references
- source 0 / Web:1633: 1 image references
- source 1 / Web:105952;說文Web:58: 103 image references
- source 2 / Book:17600: 18 image references
- source 3 / Book:21681: 55 image references
