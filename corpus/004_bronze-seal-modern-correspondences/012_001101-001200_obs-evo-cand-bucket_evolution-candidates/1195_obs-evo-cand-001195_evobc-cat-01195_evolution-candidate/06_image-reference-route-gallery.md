...
- `obs-evo-cand-001195-route-category-staging`
...
- `obs-evo-cand-001195-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001195-route-evolution-graph`
