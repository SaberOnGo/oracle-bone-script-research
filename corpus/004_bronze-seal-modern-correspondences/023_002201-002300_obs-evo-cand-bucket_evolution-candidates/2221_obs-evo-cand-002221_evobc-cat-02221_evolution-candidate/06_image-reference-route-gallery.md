...
- `obs-evo-cand-002221-route-category-staging`
...
- `obs-evo-cand-002221-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002221-route-evolution-graph`
