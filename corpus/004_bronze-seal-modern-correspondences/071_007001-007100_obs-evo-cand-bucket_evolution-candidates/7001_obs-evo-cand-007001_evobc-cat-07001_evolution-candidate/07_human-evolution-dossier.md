...
- Project ID: `obs-evo-cand-007001`
- EVOBC category candidate ID: `evobc-evo-cat-07001`
- External category reference: `evobc-cat-07001`
- Source category ID: `07001`
- Source label for human review: `肭`
- Source codepoints: `U+80AD`
...
- `obs-evo-cand-007001-route-category-staging`
...
- `obs-evo-cand-007001-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007001-route-evolution-graph`
