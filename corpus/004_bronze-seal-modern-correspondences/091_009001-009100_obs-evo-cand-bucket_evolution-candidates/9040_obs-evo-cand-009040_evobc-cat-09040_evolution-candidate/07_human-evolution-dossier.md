...
- External category reference: `evobc-cat-09040`
- Source category ID: `09040`
- Source label for human review: `遛`
- Source codepoints: `U+905B`
...
- `obs-evo-cand-009040-route-category-staging`
...
- `obs-evo-cand-009040-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009040-route-evolution-graph`
