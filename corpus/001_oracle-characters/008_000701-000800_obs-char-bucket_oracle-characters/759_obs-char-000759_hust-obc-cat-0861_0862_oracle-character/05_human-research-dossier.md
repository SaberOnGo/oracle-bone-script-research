# obs-char-000759 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000759`
- primary external id: `hust-obc-cat-0861_0862`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/759_obs-char-000759_hust-obc-cat-0861_0862
  _oracle-character/03_visual-assets/001_asset-000764_hust-obc-cat-0861_0862
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0861_0862/0861/G_0861_乙2762合547
  7賓組.png`
- asset id: `asset-000764`
...
- source category: `0861_0862`
- validation class: `758`
- source image route: `HUST-OBC/deciphered/0861_0862/0861/G_0861_乙2762合5477賓組.
  png`
- asset id: `asset-000764`
...
- English observation: `A central vertical has a small upper oval containing
  a dot-like mark, paired side arms ending in tiny forks or loops, and three
  spreading branches at the bottom.`
- 中文观察: `中央竖干上部有内含点状痕的小椭圆，两侧成对支臂末端为小叉或小环，底部伸出三条外展枝。`
...
- dataset label text: `㝓㝔`
- dataset label codepoints: `U+3753;U+3754`
...
- graph edge count: `2`
- codepoint routes: `U+3753;U+3754`
...
- filename catalog route clues: `Heji-like filename clue: 合5477
  (G_0861_乙2762合5477賓組.png)`
...
- Which source records identify obs-char-000759 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000759？
