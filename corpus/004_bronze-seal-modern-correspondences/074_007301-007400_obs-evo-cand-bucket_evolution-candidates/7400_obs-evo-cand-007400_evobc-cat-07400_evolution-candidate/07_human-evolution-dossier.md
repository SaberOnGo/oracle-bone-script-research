...
- External category reference: `evobc-cat-07400`
- Source category ID: `07400`
- Source label for human review: `菀`
- Source codepoints: `U+83C0`
...
- `obs-evo-cand-007400-route-category-staging`
...
- `obs-evo-cand-007400-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007400-route-evolution-graph`
