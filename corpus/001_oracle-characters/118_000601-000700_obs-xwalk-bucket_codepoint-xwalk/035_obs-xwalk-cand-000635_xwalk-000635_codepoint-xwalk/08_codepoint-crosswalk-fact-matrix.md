# obs-xwalk-cand-000635 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+36C8` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-0722` | not reading |
