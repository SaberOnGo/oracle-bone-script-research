...
- External category reference: `evobc-cat-09707`
- Source category ID: `09707`
- Source label for human review: `阴`
...
- `obs-evo-cand-009707-route-category-staging`
...
- `obs-evo-cand-009707-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009707-route-evolution-graph`
