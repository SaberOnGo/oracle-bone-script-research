...
Project ID: `obs-evo-cand-009419`
...
- Project ID: `obs-evo-cand-009419`
- EVOBC category candidate ID: `evobc-evo-cat-09419`
- External category reference: `evobc-cat-09419`
- Source category ID: `09419`
- Source label for human review: `鋯`
- Source codepoints: `U+92EF`
...
- `obs-evo-cand-009419-route-category-staging`
...
- `obs-evo-cand-009419-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009419-route-evolution-graph`
