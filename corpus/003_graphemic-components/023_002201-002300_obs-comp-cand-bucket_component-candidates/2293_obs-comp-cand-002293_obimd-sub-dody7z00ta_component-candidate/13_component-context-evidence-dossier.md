# obs-comp-cand-002293 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002293`
- 首选外部 ID: `obimd-sub-dody7z00ta`
- OBIMD subcharacter UID: `dody7z00ta`
- OBIMD main character UID: `dody7z00ta`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+A468D;U+FD379; U+FD37A
