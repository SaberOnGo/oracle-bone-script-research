...
- External category reference: `evobc-cat-01797`
- Source category ID: `01797`
- Source label for human review: `圶`
...
- `obs-evo-cand-001797-route-category-staging`
...
- `obs-evo-cand-001797-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001797-route-evolution-graph`
