# obs-char-001217 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001217`
- primary external id: `hust-obc-cat-1362`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1217_obs-char-001217_hust-obc-cat-1362_ora
  cle-character/03_visual-assets/001_asset-001222_hust-obc-cat-1362_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1362/G_1362_佚344合17464賓組.png`
- asset id: `asset-001222`
...
- source category: `1362`
- validation class: `1216`
- source image route: `HUST-OBC/deciphered/1362/G_1362_佚344合17464賓組.png`
- asset id: `asset-001222`
...
- English observation: `A dense upright cluster has an upper cross-stroke, a
  central rounded enclosure, and a pointed lower loop.`
- 中文观察: `密集直立笔群有上部横笔、中央圆弧框廓和尖状下部环。`
...
- dataset label text: `㥈`
- dataset label codepoints: `U+3948`
...
- filename catalog route clues: `Heji-like filename clue: 合17464
  (G_1362_佚344合17464賓組.png)`
...
- Which source records identify obs-char-001217 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001217？
