...
- Review log draft ID / 复核日志草稿 ID: `source-engineering-gap-review-log-draft-0010`
...
`current_stage=pending_human_review;download_status_counts=downloaded:1;http_error:1;downloaded_count=1;download_log_count=2;checksum_present_count=1;field_map_count=3;package_manifest_count=1;metadata_profile_count=3;graph_edge_count=0;downloaded_file_bytes=115569;gap_type=checksum_or_failed_download_status_review_needed`
...
- Evidence snapshot ID / 证据快照 ID: `source-engineering-gap-evidence-snapshot-0010`
