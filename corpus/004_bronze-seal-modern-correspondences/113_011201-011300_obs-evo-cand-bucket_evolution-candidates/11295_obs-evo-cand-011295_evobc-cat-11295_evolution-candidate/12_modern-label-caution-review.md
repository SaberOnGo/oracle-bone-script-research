# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-011295
...
- EVOBC candidate category: `evobc-evo-cat-11295`.
- Source label for search only: `𢨚`.
- Source codepoints for search only: `U+22A1A`.
