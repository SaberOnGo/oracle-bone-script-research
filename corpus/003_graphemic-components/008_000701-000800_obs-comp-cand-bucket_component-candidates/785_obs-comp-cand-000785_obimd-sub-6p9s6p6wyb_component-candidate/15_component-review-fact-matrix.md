# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000785
...
| Glyph or codepoint route / 字形或码位路线 | 24 OBIMD route rows; examples U+7F8C;U+F4754; U+F4755; 另有 22 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 24 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
