...
- External category reference: `evobc-cat-01655`
- Source category ID: `01655`
- Source label for human review: `喧`
...
- `obs-evo-cand-001655-route-category-staging`
...
- `obs-evo-cand-001655-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001655-route-evolution-graph`
