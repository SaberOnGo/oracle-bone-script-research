# obs-unk-006417 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/081_undeciphered-006
  401-006500_obs-unk-bucket_oracle-character-candidates/017_obs-unk-006417_h
  ust-obc-und-X-006417_oracle-character-candidate/03_visual-assets/001_asset
  -008008_hust-obc-und-X-006417_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1973/X_？_5600_1.png`
- asset id: `asset-008008`
...
- source class: `HUST-OBC/undeciphered/X/1973/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1973/X_？_5600_1.png`
- asset id: `asset-008008`
...
- Which source records identify obs-unk-006417 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006417？
