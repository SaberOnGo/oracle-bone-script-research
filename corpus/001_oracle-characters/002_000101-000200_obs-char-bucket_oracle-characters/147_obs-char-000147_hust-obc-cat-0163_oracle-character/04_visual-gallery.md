# obs-char-000147 Visual Gallery / obs-char-000147 图像资料页
...
- Primary external reference / 首选外部参考: `hust-obc-cat-0163`
...
## obs-char-000147-visual-source-001 / 图像条目

![obs-char-000147 glyph candidate](03_visual-assets/001_asset-000152_hust-obc-cat-0163_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000152_hust-obc-cat-0163_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000152_hust-obc-cat-0163_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/0163/G_0163_前6.33.1(甲).png`
