# Material Visual Observation / obs-comp-cand-001438 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001438`
- External reference / 外部参照: `obimd-sub-1su4bgys6d`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016015_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0y6gjyc5xl/1su4bgys6d/1su4bgys6d.png`
- Checksum / 校验和:
  `3a4eb2fa3698d9c4b9eab1ae9adc9dc097fae69a15381e80d069181db64d03ff`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.94%.
- Marked-pixel bounds: (79,34)–(170,215); span 92 × 182 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.94%。
- 痕迹范围：(79,34)–(170,215)；跨度92 × 182 px；痕迹矩形高于宽。
