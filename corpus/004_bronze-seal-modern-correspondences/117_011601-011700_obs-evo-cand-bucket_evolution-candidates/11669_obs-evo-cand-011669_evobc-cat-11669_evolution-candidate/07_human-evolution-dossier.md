...
- External category reference: `evobc-cat-11669`
- Source category ID: `11669`
- Source label for human review: `𤳃`
- Source codepoints: `U+24CC3`
...
- `obs-evo-cand-011669-route-category-staging`
...
- `obs-evo-cand-011669-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011669-route-evolution-graph`
