...
Project ID: `obs-evo-cand-006319`
...
- Project ID: `obs-evo-cand-006319`
- EVOBC category candidate ID: `evobc-evo-cat-06319`
- External category reference: `evobc-cat-06319`
- Source category ID: `06319`
- Source label for human review: `篙`
- Source codepoints: `U+7BD9`
...
- `obs-evo-cand-006319-route-category-staging`
...
- `obs-evo-cand-006319-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006319-route-evolution-graph`
