...
- External category reference: `evobc-cat-07564`
- Source category ID: `07564`
- Source label for human review: `蔪`
...
- `obs-evo-cand-007564-route-category-staging`
...
- `obs-evo-cand-007564-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007564-route-evolution-graph`
