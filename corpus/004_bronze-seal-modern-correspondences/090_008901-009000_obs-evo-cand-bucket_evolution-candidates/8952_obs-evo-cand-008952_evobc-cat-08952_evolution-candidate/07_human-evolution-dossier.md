...
- External category reference: `evobc-cat-08952`
- Source category ID: `08952`
- Source label for human review: `远`
...
- `obs-evo-cand-008952-route-category-staging`
...
- `obs-evo-cand-008952-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008952-route-evolution-graph`
