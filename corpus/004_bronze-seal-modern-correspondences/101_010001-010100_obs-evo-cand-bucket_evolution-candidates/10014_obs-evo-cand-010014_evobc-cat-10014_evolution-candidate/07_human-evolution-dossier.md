...
- External category reference: `evobc-cat-10014`
- Source category ID: `10014`
- Source label: `題`
...
- `obs-evo-cand-010014-route-category-staging`
...
- `obs-evo-cand-010014-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010014-route-evolution-graph`
