# obs-comp-cand-002723 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002723`
- 首选外部 ID: `obimd-sub-xjszizqtbx`
- OBIMD subcharacter UID: `xjszizqtbx`
- OBIMD main character UID: `xjszizqtbx`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+FF5AA; U+FF5AB; 另有 2 项
