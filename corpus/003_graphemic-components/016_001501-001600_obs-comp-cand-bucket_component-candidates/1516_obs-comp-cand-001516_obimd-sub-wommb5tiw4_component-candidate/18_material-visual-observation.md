# Material Visual Observation / obs-comp-cand-001516 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001516`
- External reference / 外部参照: `obimd-sub-wommb5tiw4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016479_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8u1hzbiq2w/wommb5tiw4/wommb5tiw4.png`
- Checksum / 校验和:
  `24f1040888eb458182ddf74fabd4ca7a3c79f7804b9ec78b514c3f9bb297541b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.34%.
- Marked-pixel bounds: (61,51)–(189,193); span 129 × 143 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.34%。
- 痕迹范围：(61,51)–(189,193)；跨度129 × 143 px；痕迹矩形近方形。
