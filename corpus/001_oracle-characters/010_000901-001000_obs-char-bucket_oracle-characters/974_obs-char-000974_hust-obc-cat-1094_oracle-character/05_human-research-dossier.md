# obs-char-000974 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000974`
- primary external id: `hust-obc-cat-1094`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/974_obs-char-000974_hust-obc-cat-1094_orac
  le-character/03_visual-assets/001_asset-000979_hust-obc-cat-1094_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1094/G_1094_乙669合14173賓組.png`
- asset id: `asset-000979`
...
- source category: `1094`
- validation class: `973`
- source image route: `HUST-OBC/deciphered/1094/G_1094_乙669合14173賓組.png`
- asset id: `asset-000979`
...
- English observation: `A small rectangular grid sits beside a long
  descending diagonal and a short upper stroke.`
- 中文观察: `小型矩形格状笔旁有长下行斜笔和短上部笔。`
...
- dataset label text: `㠼`
- dataset label codepoints: `U+383C`
...
- filename catalog route clues: `Heji-like filename clue: 合14173
  (G_1094_乙669合14173賓組.png)`
...
- Which source records identify obs-char-000974 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000974？
