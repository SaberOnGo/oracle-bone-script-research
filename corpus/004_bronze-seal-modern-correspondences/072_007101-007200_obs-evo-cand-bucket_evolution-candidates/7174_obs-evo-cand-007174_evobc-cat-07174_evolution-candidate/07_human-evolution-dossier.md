...
- External category reference: `evobc-cat-07174`
- Source category ID: `07174`
- Source label: `臺`
...
- `obs-evo-cand-007174-route-category-staging`
...
- `obs-evo-cand-007174-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007174-route-evolution-graph`
