...
Project ID: `obs-evo-cand-007877`
...
- Project ID: `obs-evo-cand-007877`
- EVOBC category candidate ID: `evobc-evo-cat-07877`
- External category reference: `evobc-cat-07877`
- Source category ID: `07877`
- Source label for human review: `蠗`
- Source codepoints: `U+8817`
...
- `obs-evo-cand-007877-route-category-staging`
...
- `obs-evo-cand-007877-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007877-route-evolution-graph`
