...
- External category reference: `evobc-cat-06212`
- Source category ID: `06212`
- Source label for human review: `竭`
- Source codepoints: `U+7AED`
...
- `obs-evo-cand-006212-route-category-staging`
...
- `obs-evo-cand-006212-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006212-route-evolution-graph`
