...
- External category reference: `evobc-cat-02862`
- Source category ID: `02862`
- Source label for human review: `径`
...
- `obs-evo-cand-002862-route-category-staging`
...
- `obs-evo-cand-002862-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002862-route-evolution-graph`
