# obs-char-000031 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/031_obs-char-000031_hust-obc-cat-0036_orac
  le-character/03_visual-assets/001_asset-000036_hust-obc-cat-0036_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0036/G_0036_乙4987合18404賓組.png`
- asset id: `asset-000036`
...
- source category: `0036`
- validation class: `30`
- source image route: `HUST-OBC/deciphered/0036/G_0036_乙4987合18404賓組.png`
- asset id: `asset-000036`
...
- English observation: `The tall narrow image has a branching upper tip, a
  central descending stroke, and crossed short marks near the lower end.`
- 中文观察: `高而狭长图像顶部有分叉尖端，中部有向下主笔画，下端附近有交叉短痕。`
...
- dataset label text: `㐚`
- dataset label codepoints: `U+341A`
...
- filename catalog route clues: `Heji-like filename clue: 合18404
  (G_0036_乙4987合18404賓組.png)`
...
- Which source records identify obs-char-000031 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000031？
