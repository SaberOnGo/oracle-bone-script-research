...
Project ID: `obs-insc-cw-cand-000450`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000450`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000450` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2318` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `283` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `366` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `41368` [route_present_image_or_text_not_collected]
