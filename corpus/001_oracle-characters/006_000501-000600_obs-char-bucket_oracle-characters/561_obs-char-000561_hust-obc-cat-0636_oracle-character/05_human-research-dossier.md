# obs-char-000561 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/561_obs-char-000561_hust-obc-cat-0636_orac
  le-character/03_visual-assets/001_asset-000566_hust-obc-cat-0636_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0636/G_0636_甲骨文0.png`
- asset id: `asset-000566`
...
- source category: `0636`
- validation class: `560`
- source image route: `HUST-OBC/deciphered/0636/G_0636_甲骨文0.png`
- asset id: `asset-000566`
...
- English observation: `Two separated stroke groups show paired slanting
  marks at left and a narrow looped vertical form with forked upper
  extensions at right.`
...
- dataset label text: `㙲`
- dataset label codepoints: `U+3672`
...
- Which source records identify obs-char-000561 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000561？
