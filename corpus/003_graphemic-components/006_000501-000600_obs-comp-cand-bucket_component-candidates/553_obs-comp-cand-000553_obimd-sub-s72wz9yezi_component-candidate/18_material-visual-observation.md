# Material Visual Observation / obs-comp-cand-000553 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000553`
- External reference / 外部参照: `obimd-sub-s72wz9yezi`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012805_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ghaj284ctb/s72wz9yezi/s72wz9yezi.png`
- Checksum / 校验和:
  `e4d6cb249cd76f0b77966320a71d0322d48ae279bb0fe1c5c76b0281eb50fe2d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.11%.
- Marked-pixel bounds: (65,22)–(184,227); span 120 × 206 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.11%。
- 痕迹范围：(65,22)–(184,227)；跨度120 × 206 px；痕迹矩形高于宽。
