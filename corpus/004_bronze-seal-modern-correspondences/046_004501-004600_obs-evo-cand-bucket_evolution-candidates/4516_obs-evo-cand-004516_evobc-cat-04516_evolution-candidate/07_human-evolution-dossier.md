...
- External category reference: `evobc-cat-04516`
- Source category ID: `04516`
- Source label for human review: `汲`
- Source codepoints: `U+6C72`
...
- `obs-evo-cand-004516-route-category-staging`
...
- `obs-evo-cand-004516-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004516-route-evolution-graph`
