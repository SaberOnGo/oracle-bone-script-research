...
- Project ID: `obs-evo-cand-000223`
- EVOBC category candidate ID: `evobc-evo-cat-00223`
- External category reference: `evobc-cat-00223`
- Source category ID: `00223`
- Source label for human review: `㶾`
- Source codepoints: `U+3DBE`
...
- `obs-evo-cand-000223-route-category-staging`
...
- `obs-evo-cand-000223-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000223-route-evolution-graph`
