...
- External category reference: `evobc-cat-09064`
- Source category ID: `09064`
- Source label for human review: `遺`
...
- `obs-evo-cand-009064-route-category-staging`
...
- `obs-evo-cand-009064-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009064-route-evolution-graph`
