...
- External category reference: `evobc-cat-02812`
- Source category ID: `02812`
- Source label for human review: `弳`
- Source codepoints: `U+5F33`
...
- `obs-evo-cand-002812-route-category-staging`
...
- `obs-evo-cand-002812-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002812-route-evolution-graph`
