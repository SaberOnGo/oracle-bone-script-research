...
Project ID: `obs-evo-cand-010066`
...
- Project ID: `obs-evo-cand-010066`
- EVOBC category candidate ID: `evobc-evo-cat-10066`
- External category reference: `evobc-cat-10066`
- Source category ID: `10066`
- Source label for human review: `颭`
- Source codepoints: `U+98AD`
...
- `obs-evo-cand-010066-route-category-staging`
...
- `obs-evo-cand-010066-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010066-route-evolution-graph`
