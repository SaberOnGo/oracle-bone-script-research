...
- External category reference: `evobc-cat-04385`
- Source category ID: `04385`
- Source label for human review: `止`
...
- `obs-evo-cand-004385-route-category-staging`
...
- `obs-evo-cand-004385-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004385-route-evolution-graph`
