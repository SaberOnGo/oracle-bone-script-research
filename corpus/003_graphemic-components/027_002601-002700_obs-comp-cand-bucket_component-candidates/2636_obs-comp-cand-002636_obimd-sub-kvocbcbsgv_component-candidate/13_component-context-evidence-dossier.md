# obs-comp-cand-002636 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002636`
- 首选外部 ID: `obimd-sub-kvocbcbsgv`
- OBIMD subcharacter UID: `kvocbcbsgv`
- OBIMD main character UID: `kvocbcbsgv`
- 来源 ID: `src-obimd`
...
- codepoint 示例: U+FEDC0; U+FEDC1; 另有 10 项
