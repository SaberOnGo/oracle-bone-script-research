...
- External category reference: `evobc-cat-07279`
- Source category ID: `07279`
- Source label for human review: `苙`
- Source codepoints: `U+82D9`
...
- `obs-evo-cand-007279-route-category-staging`
...
- `obs-evo-cand-007279-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007279-route-evolution-graph`
