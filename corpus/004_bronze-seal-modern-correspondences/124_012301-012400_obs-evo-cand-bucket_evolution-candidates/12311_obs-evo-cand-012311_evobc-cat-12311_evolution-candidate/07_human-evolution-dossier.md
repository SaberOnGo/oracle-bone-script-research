...
- Project ID: `obs-evo-cand-012311`
- EVOBC category candidate ID: `evobc-evo-cat-12311`
- External category reference: `evobc-cat-12311`
- Source category ID: `12311`
- Source label for human review: `𧾱`
- Source codepoints: `U+27FB1`
...
- `obs-evo-cand-012311-route-category-staging`
...
- `obs-evo-cand-012311-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012311-route-evolution-graph`
