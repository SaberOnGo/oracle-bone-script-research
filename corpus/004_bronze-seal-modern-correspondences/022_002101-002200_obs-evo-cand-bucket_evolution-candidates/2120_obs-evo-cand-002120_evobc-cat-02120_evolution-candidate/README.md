# obs-evo-cand-002120 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-002120`
- EVOBC category candidate ID: `evobc-evo-cat-02120`
- External category ref: `evobc-cat-02120`
- Source label for human review: `姑`
- Source codepoints: `U+59D1`
- Image reference count: `44`
- Era token counts: `BI:21;CS:1;SAC:7;SS:2;WSC:13`
- Source token counts: `Book:22;Web:22`
