...
Project ID: `obs-evo-cand-012097`
...
- Project ID: `obs-evo-cand-012097`
- EVOBC category candidate ID: `evobc-evo-cat-12097`
- External category reference: `evobc-cat-12097`
- Source category ID: `12097`
- Source label for human review: `𦰏`
- Source codepoints: `U+26C0F`
...
- `obs-evo-cand-012097-route-category-staging`
...
- `obs-evo-cand-012097-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012097-route-evolution-graph`
