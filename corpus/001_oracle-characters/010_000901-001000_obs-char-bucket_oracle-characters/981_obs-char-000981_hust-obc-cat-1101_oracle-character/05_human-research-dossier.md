# obs-char-000981 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/981_obs-char-000981_hust-obc-cat-1101_orac
  le-character/03_visual-assets/001_asset-000986_hust-obc-cat-1101_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1101/G_1101_甲2124(甲).png`
- asset id: `asset-000986`
...
- source category: `1101`
- validation class: `980`
- source image route: `HUST-OBC/deciphered/1101/G_1101_甲2124(甲).png`
- asset id: `asset-000986`
...
- English observation: `A large rounded upper loop connects by a long curved
  stem to a small lower rounded enclosure.`
- 中文观察: `大型圆弧上部环状笔通过长弯曲笔干连接小型下部圆弧闭合轮廓。`
...
- dataset label text: `㡃`
- dataset label codepoints: `U+3843`
...
- Which source records identify obs-char-000981 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000981？
