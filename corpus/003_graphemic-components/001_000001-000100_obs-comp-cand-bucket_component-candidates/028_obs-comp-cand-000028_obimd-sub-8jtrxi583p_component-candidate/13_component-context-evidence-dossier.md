# obs-comp-cand-000028 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000028`
- 首选外部 ID: `obimd-sub-8jtrxi583p`
- OBIMD subcharacter UID: `8jtrxi583p`
- OBIMD main character UID: `8jtrxi583p`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+4F9A;U+F02C8; U+F02C9
