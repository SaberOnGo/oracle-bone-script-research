...
- Project ID / 项目 ID: `obs-char-001245`
- Primary external ID / 首选外部 ID: `hust-obc-cat-1393`
...
- Source image / 来源图: `G_1393_前7.6.3合7921賓組.png`
- Image / 图像: `001_asset-001250_hust-obc-cat-1393_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合7921
  (G_1393_前7.6.3合7921賓組.png)`
...
- Source label text / 来源标签文字: `㥧`
- Source label codepoint / 来源标签 codepoint: `U+3967`
