...
- External category reference: `evobc-cat-09585`
- Source category ID: `09585`
- Source label for human review: `铵`
- Source codepoints: `U+94F5`
...
- `obs-evo-cand-009585-route-category-staging`
...
- `obs-evo-cand-009585-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009585-route-evolution-graph`
