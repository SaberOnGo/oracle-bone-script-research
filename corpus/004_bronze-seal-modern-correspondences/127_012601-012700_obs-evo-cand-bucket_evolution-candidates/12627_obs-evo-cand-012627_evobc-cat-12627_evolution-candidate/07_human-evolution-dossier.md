...
Project ID: `obs-evo-cand-012627`
...
- Project ID: `obs-evo-cand-012627`
- EVOBC category candidate ID: `evobc-evo-cat-12627`
- External category reference: `evobc-cat-12627`
- Source category ID: `12627`
- Source label for human review: `𩚜`
- Source codepoints: `U+2969C`
...
- `obs-evo-cand-012627-route-category-staging`
...
- `obs-evo-cand-012627-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012627-route-evolution-graph`
