# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008626
...
- EVOBC candidate category: `evobc-evo-cat-08626`.
- Source label for search only: `购`.
- Source codepoints for search only: `U+8D2D`.
