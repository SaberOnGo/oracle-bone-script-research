...
- Project ID: `obs-evo-cand-006869`
- EVOBC category candidate ID: `evobc-evo-cat-06869`
- External category reference: `evobc-cat-06869`
- Source category ID: `06869`
- Source label for human review: `羽`
- Source codepoints: `U+7FBD`
- Image reference count in source metadata: `140`
...
- `obs-evo-cand-006869-route-category-staging`
...
- `obs-evo-cand-006869-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006869-route-evolution-graph`
