# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008543
...
- EVOBC candidate category: `evobc-evo-cat-08543`.
- Source label for search only: `貪`.
- Source codepoints for search only: `U+8CAA`.
