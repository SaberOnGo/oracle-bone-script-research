...
Project ID: `obs-evo-cand-002662`
...
- Project ID: `obs-evo-cand-002662`
- EVOBC category candidate ID: `evobc-evo-cat-02662`
- External category reference: `evobc-cat-02662`
- Source category ID: `02662`
- Source label for human review: `帳`
- Source codepoints: `U+5E33`
...
- `obs-evo-cand-002662-route-category-staging`
...
- `obs-evo-cand-002662-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002662-route-evolution-graph`
