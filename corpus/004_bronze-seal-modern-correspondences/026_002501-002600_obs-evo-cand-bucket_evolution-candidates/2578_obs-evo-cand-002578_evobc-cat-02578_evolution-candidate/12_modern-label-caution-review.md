# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002578
...
- EVOBC candidate category: `evobc-evo-cat-02578`.
- Source label for search only: `嵏`.
- Source codepoints for search only: `U+5D4F`.
