# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000955
...
| --- | --- | --- | --- |
| `obimd-glyph-link-013655` | 󵖪 | `U+F55AA` | `reviewed_metadata_only` |
| `obimd-glyph-link-013656` | 󵖫 | `U+F55AB` | `reviewed_metadata_only` |
| `obimd-glyph-link-013657` | 󵖬 | `U+F55AC` | `reviewed_metadata_only` |
| `obimd-glyph-link-013658` | 󵖭 | `U+F55AD` | `reviewed_metadata_only` |
