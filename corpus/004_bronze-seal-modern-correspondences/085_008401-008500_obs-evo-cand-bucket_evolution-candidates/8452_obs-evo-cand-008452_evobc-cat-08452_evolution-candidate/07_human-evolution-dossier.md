...
- Project ID: `obs-evo-cand-008452`
- EVOBC category candidate ID: `evobc-evo-cat-08452`
- External category reference: `evobc-cat-08452`
- Source category ID: `08452`
- Source label for human review: `谍`
- Source codepoints: `U+8C0D`
...
- `obs-evo-cand-008452-route-category-staging`
...
- `obs-evo-cand-008452-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008452-route-evolution-graph`
