# obs-char-000640 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/640_obs-char-000640_hust-obc-cat-0728_orac
  le-character/03_visual-assets/001_asset-000645_hust-obc-cat-0728_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0728/G_0728_甲骨文0.png`
- asset id: `asset-000645`
...
- source category: `0728`
- validation class: `639`
- source image route: `HUST-OBC/deciphered/0728/G_0728_甲骨文0.png`
- asset id: `asset-000645`
...
- English observation: `A single slender wavering vertical has a short fork
  near the top, an angular bend and long diagonal branch at mid-height, and
  a pointed lower end.`
...
- dataset label text: `㛎`
- dataset label codepoints: `U+36CE`
...
- Which source records identify obs-char-000640 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000640？
