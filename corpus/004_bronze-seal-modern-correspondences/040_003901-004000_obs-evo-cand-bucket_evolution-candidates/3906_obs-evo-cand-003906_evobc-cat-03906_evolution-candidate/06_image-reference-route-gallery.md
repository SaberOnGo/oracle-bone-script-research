...
- `obs-evo-cand-003906-route-category-staging`
...
- `obs-evo-cand-003906-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003906-route-evolution-graph`
