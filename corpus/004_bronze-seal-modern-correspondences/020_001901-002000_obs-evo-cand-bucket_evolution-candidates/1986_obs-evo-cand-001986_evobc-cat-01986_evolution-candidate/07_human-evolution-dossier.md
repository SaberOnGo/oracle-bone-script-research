...
Project ID: `obs-evo-cand-001986`
...
- Project ID: `obs-evo-cand-001986`
- EVOBC category candidate ID: `evobc-evo-cat-01986`
- External category reference: `evobc-cat-01986`
- Source category ID: `01986`
- Source label for human review: `夅`
- Source codepoints: `U+5905`
...
- `obs-evo-cand-001986-route-category-staging`
...
- `obs-evo-cand-001986-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001986-route-evolution-graph`
