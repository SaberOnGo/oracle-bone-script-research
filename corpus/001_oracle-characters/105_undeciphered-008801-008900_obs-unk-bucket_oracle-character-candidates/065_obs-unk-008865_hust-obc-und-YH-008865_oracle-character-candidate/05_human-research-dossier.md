# obs-unk-008865 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008865`
- primary external id: `hust-obc-und-YH-008865`
...
- local review image route: `corpus/001_oracle-characters/105_undeciphered-008
  801-008900_obs-unk-bucket_oracle-character-candidates/065_obs-unk-008865_h
  ust-obc-und-YH-008865_oracle-character-candidate/03_visual-assets/001_asse
  t-010456_hust-obc-und-YH-008865_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60EB0/Y_？_60EB0.jpg`
- asset id: `asset-010456`
...
- source class: `HUST-OBC/undeciphered/Y+H/60EB0/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60EB0/Y_？_60EB0.jpg`
- asset id: `asset-010456`
...
- Which source records identify obs-unk-008865 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008865？
