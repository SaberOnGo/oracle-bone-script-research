# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000479
...
| Glyph or codepoint route / 字形或码位路线 | 88 OBIMD route rows; examples U+98A8;U+9CF3;U+F2D07; U+F2D08; 另有 86 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 88 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
