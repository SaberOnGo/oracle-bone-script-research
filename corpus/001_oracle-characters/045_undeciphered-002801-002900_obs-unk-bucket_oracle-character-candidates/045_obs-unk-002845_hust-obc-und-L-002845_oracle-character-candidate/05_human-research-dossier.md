# obs-unk-002845 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002845`
- primary external id: `hust-obc-und-L-002845`
...
- local review image route: `corpus/001_oracle-characters/045_undeciphered-002
  801-002900_obs-unk-bucket_oracle-character-candidates/045_obs-unk-002845_h
  ust-obc-und-L-002845_oracle-character-candidate/03_visual-assets/001_asset
  -004438_hust-obc-und-L-002845_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2845/L_？_4780.jpg`
- asset id: `asset-004438`
...
- source class: `HUST-OBC/undeciphered/L/2845/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2845/L_？_4780.jpg`
- asset id: `asset-004438`
...
- Which source records identify obs-unk-002845 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002845？
