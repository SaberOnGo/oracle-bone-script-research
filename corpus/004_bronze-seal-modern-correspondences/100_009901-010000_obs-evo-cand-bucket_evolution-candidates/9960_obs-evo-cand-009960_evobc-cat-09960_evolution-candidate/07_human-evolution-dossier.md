...
Project ID: `obs-evo-cand-009960`
...
- Project ID: `obs-evo-cand-009960`
- EVOBC category candidate ID: `evobc-evo-cat-09960`
- External category reference: `evobc-cat-09960`
- Source category ID: `09960`
- Source label for human review: `韱`
- Source codepoints: `U+97F1`
...
- `obs-evo-cand-009960-route-category-staging`
...
- `obs-evo-cand-009960-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009960-route-evolution-graph`
