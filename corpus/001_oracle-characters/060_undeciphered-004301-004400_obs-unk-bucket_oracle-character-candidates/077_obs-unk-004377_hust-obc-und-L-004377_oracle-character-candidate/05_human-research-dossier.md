# obs-unk-004377 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/077_obs-unk-004377_h
  ust-obc-und-L-004377_oracle-character-candidate/03_visual-assets/001_asset
  -005970_hust-obc-und-L-004377_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4377/L_？_9719.jpg`
- asset id: `asset-005970`
...
- source class: `HUST-OBC/undeciphered/L/4377/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4377/L_？_9719.jpg`
- asset id: `asset-005970`
...
- English observation: `A narrow upper cluster and angular middle`
  `strokes are visible; the lower outline is compact and open.`
- 中文观察: `上部有窄小笔画群，中部有斜向痕迹，下部轮廓紧凑且开放。`
...
- Which source records identify obs-unk-004377 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004377？
