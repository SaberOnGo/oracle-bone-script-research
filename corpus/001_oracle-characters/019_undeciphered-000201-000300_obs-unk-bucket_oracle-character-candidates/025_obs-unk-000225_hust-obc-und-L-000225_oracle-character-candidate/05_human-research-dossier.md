# obs-unk-000225 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000225`
- primary external id: `hust-obc-und-L-000225`
...
- local review image route: `corpus/001_oracle-characters/019_undeciphered-000
  201-000300_obs-unk-bucket_oracle-character-candidates/025_obs-unk-000225_h
  ust-obc-und-L-000225_oracle-character-candidate/03_visual-assets/001_asset
  -001818_hust-obc-und-L-000225_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/225/L_？_1070.jpg`
- asset id: `asset-001818`
...
- source class: `HUST-OBC/undeciphered/L/225/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/225/L_？_1070.jpg`
- asset id: `asset-001818`
...
- Which source records identify obs-unk-000225 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000225？
