# Material Visual Observation / obs-comp-cand-002075 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002075`
- External reference / 外部参照: `obimd-sub-2p7v2fpe0b`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019462_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2p7v2fpe0b/2p7v2fpe0b/2p7v2fpe0b.png`
- Checksum / 校验和:
  `9f84a86219eb91f7ff50dd9ecc229006e6a0391003bef57f8779d1f6f7d505eb`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.57%.
- Marked-pixel bounds: (44,23)–(212,223); span 169 × 201 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.57%。
- 痕迹范围：(44,23)–(212,223)；跨度169 × 201 px；痕迹矩形近方形。
