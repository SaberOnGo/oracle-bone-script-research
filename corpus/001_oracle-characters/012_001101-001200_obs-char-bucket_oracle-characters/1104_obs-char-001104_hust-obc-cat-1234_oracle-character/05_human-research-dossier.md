# obs-char-001104 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001104`
- primary external id: `hust-obc-cat-1234`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1104_obs-char-001104_hust-obc-cat-1234_ora
  cle-character/03_visual-assets/001_asset-001109_hust-obc-cat-1234_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1234/L_1234_14715.jpg`
- asset id: `asset-001109`
...
- source category: `1234`
- validation class: `1103`
- source image route: `HUST-OBC/deciphered/1234/L_1234_14715.jpg`
- asset id: `asset-001109`
...
- English observation: `A faint compact rectangular cluster contains several
  horizontal bands and short side projections; contrast is low.`
- 中文观察: `较淡的紧密矩形笔群包含数条水平带和短侧向外伸；对比度较低。`
...
- dataset label text: `㣈`
- dataset label codepoints: `U+38C8`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00106`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00106`
- EvoBC image reference count / EvoBC 图像引用数: `15`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00106`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/106_obs-evo-can
  d-000106_evobc-cat-00106_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/106_obs-evo-cand-000106_evobc-cat-00106_evolu
...
- Which source records identify obs-char-001104 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001104？
