...
- External category reference: `evobc-cat-08996`
- Source category ID: `08996`
- Source label for human review: `通`
- Source codepoints: `U+901A`
...
- `obs-evo-cand-008996-route-category-staging`
...
- `obs-evo-cand-008996-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008996-route-evolution-graph`
