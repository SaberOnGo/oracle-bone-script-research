# obs-char-001259 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1259_obs-char-001259_hust-obc-cat-1408_ora
  cle-character/03_visual-assets/001_asset-001264_hust-obc-cat-1408_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1408/G_1408_甲骨文.png`
- asset id: `asset-001264`
...
- source category: `1408`
- validation class: `1258`
- source image route: `HUST-OBC/deciphered/1408/G_1408_甲骨文.png`
- asset id: `asset-001264`
...
- dataset label text: `㥶`
- dataset label codepoints: `U+3976`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/132_obs-evo-can
  d-000132_evobc-cat-00132_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/132_obs-evo-cand-000132_evobc-cat-00132_evolu
...
- Which source records identify obs-char-001259 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001259？
