...
- External category reference: `evobc-cat-04016`
- Source category ID: `04016`
- Source label for human review: `桂`
...
- `obs-evo-cand-004016-route-category-staging`
...
- `obs-evo-cand-004016-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004016-route-evolution-graph`
