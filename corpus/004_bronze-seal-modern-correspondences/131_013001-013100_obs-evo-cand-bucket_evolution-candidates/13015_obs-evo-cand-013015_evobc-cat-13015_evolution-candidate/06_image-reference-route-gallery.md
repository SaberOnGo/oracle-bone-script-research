...
- `obs-evo-cand-013015-route-category-staging`
...
- `obs-evo-cand-013015-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013015-route-evolution-graph`
