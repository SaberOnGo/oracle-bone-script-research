...
- External category reference: `evobc-cat-02805`
- Source category ID: `02805`
- Source label for human review: `弧`
...
- `obs-evo-cand-002805-route-category-staging`
...
- `obs-evo-cand-002805-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002805-route-evolution-graph`
