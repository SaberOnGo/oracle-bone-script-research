# Material Visual Observation / obs-comp-cand-001967 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001967`
- External reference / 外部参照: `obimd-sub-81cqeht6m8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018884_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/81cqeht6m8/81cqeht6m8/81cqeht6m8.png`
- Checksum / 校验和:
  `c05f9f2faccc9b3c8357b822a40a1da0305651ced112e47ea4c72539f0715c93`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 14.12%.
- Marked-pixel bounds: (48,40)–(200,217); span 153 × 178 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占14.12%。
- 痕迹范围：(48,40)–(200,217)；跨度153 × 178 px；痕迹矩形近方形。
