...
- External category reference: `evobc-cat-08547`
- Source category ID: `08547`
- Source label for human review: `貯`
- Source codepoints: `U+8CAF`
...
- `obs-evo-cand-008547-route-category-staging`
...
- `obs-evo-cand-008547-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008547-route-evolution-graph`
