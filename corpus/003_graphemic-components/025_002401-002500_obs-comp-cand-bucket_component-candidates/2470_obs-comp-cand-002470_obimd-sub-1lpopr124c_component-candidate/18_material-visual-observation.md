# Material Visual Observation / obs-comp-cand-002470 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002470`
- External reference / 外部参照: `obimd-sub-1lpopr124c`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020655_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/v7qghw0r67/1lpopr124c/1lpopr124c.png`
- Checksum / 校验和:
  `1668fffc1ba5534deb7073458836b42a5fb81733679e3c027dcb4bc70d99aadf`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.46%.
- Marked-pixel bounds: (75,17)–(174,207); span 100 × 191 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.46%。
- 痕迹范围：(75,17)–(174,207)；跨度100 × 191 px；痕迹矩形高于宽。
