...
- External category reference: `evobc-cat-05349`
- Source category ID: `05349`
- Source label for human review: `玕`
- Source codepoints: `U+7395`
...
- `obs-evo-cand-005349-route-category-staging`
...
- `obs-evo-cand-005349-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005349-route-evolution-graph`
