# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000219
...
- EVOBC candidate category: `evobc-evo-cat-00219`.
- Source label for search only: `㵺`.
- Source codepoints for search only: `U+3D7A`.
