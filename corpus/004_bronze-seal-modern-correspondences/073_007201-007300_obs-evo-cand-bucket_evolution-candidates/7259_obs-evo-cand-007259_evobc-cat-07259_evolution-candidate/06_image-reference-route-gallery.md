...
- `obs-evo-cand-007259-route-category-staging`
...
- `obs-evo-cand-007259-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007259-route-evolution-graph`
