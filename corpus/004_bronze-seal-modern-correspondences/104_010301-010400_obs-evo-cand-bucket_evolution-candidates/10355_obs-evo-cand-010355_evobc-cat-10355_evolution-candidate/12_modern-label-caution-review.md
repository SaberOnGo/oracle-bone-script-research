# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010355
...
- EVOBC candidate category: `evobc-evo-cat-10355`.
- Source label for search only: `鬽`.
- Source codepoints for search only: `U+9B3D`.
