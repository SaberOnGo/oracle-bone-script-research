...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0942`
...
- Source image / 来源图: `L_0942_360.jpg`
- Image / 图像: `001_asset-000838_hust-obc-cat-0942_glyph.png`
...
- target node: `evobc-evo-cat-00084`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/084_obs-evo-cand-000084_evobc-cat-00084_evoluti
...
- Source label text / 来源标签文字: `㞤`
- Source label codepoint / 来源标签 codepoint: `U+37A4`
