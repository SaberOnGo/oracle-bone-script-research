...
- Review log draft ID / 复核日志草稿 ID: `codepoint-crosswalk-review-log-draft-014`
- Codepoint review task ID / codepoint 复核任务 ID: `codepoint-crosswalk-review-014`
...
- Crosswalk candidate ID / 交叉候选 ID: `hust-obimd-evobc-xwalk-001120`
- Suggested oracle character ID / 建议甲骨单字 ID: `obs-char-001120`
- Promotion queue ID / 提升队列 ID: `hust-obc-obs-char-promo-001120`
...
- HUST external ref / HUST 外部引用: `hust-obc-cat-1251`
- HUST label codepoints / HUST 标签 codepoint: `U+38D9`
- OBIMD main candidates / OBIMD 主字候选: `obimd-main-cand-002637`
- EVOBC category candidates / EVOBC 类别候选: `evobc-evo-cat-00107`
...
- `corpus/001_oracle-characters/012_001101-001200_obs-char-bucket_oracle-characters/001_hust-obc-candidate-packet-manifest.csv`
- `corpus/001_oracle-characters/012_001101-001200_obs-char-bucket_oracle-characters/1120_obs-char-001120_hust-obc-cat-1251_oracle-character/01_candidate-character-packet.json`
...
- Route availability ID: `codepoint-route-availability-014`
...
- Review task ID: `codepoint-crosswalk-review-014`
- Crosswalk candidate ID: `hust-obimd-evobc-xwalk-001120`
- Suggested oracle character ID: `obs-char-001120`
- HUST candidate packet ID: `hust-obc-candidate-packet-001120`
...
- OBIMD row count: `1`
- OBIMD source UIDs: `vha0ssegay`
- OBIMD review statuses: `obimd-main-cand-002637=reviewed_metadata_only`
- OBIMD rights statuses: `obimd-main-cand-002637=licensed_for_repository`
- EVOBC row count: `1`
- EVOBC source category IDs: `00107`
- EVOBC has bronze refs: `false`
- EVOBC has seal refs: `false`
- EVOBC review statuses: `evobc-evo-cat-00107=reviewed_metadata_only`
- EVOBC rights statuses: `evobc-evo-cat-00107=source_marked_risk_noted`
...
- Does `hust-obimd-evobc-xwalk-001120` remain unpromoted and undeciphered?
