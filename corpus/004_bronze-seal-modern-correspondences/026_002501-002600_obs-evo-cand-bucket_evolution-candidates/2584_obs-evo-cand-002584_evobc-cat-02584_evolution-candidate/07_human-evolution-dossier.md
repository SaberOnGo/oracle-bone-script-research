...
- External category reference: `evobc-cat-02584`
- Source category ID: `02584`
- Source label for human review: `嵟`
- Source codepoints: `U+5D5F`
...
- `obs-evo-cand-002584-route-category-staging`
...
- `obs-evo-cand-002584-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002584-route-evolution-graph`
