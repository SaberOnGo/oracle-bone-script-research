...
Project ID: `obs-evo-cand-010543`
...
- Project ID: `obs-evo-cand-010543`
- EVOBC category candidate ID: `evobc-evo-cat-10543`
- External category reference: `evobc-cat-10543`
- Source category ID: `10543`
- Source label for human review: `鷀`
- Source codepoints: `U+9DC0`
...
- `obs-evo-cand-010543-route-category-staging`
...
- `obs-evo-cand-010543-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010543-route-evolution-graph`
