...
- External category reference: `evobc-cat-12208`
- Source category ID: `12208`
- Source label for human review: `𧡈`
- Source codepoints: `U+27848`
...
- `obs-evo-cand-012208-route-category-staging`
...
- `obs-evo-cand-012208-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012208-route-evolution-graph`
