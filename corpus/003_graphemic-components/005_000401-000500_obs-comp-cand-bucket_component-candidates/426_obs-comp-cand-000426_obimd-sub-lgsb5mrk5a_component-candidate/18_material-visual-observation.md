# Material Visual Observation / obs-comp-cand-000426 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000426`
- External reference / 外部参照: `obimd-sub-lgsb5mrk5a`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012349_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xyp0ngvyd7/lgsb5mrk5a/lgsb5mrk5a.png`
- Checksum / 校验和:
  `fac46762c7ca7e8f3844a6da88d1e8726eefe38b5ff455968376e1f9b9f4c110`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.47%.
- Marked-pixel bounds: (57,42)–(192,195); span 136 × 154 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.47%。
- 痕迹范围：(57,42)–(192,195)；跨度136 × 154 px；痕迹矩形近方形。
