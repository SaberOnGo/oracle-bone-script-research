...
Project ID: `obs-evo-cand-009021`
...
- Project ID: `obs-evo-cand-009021`
- EVOBC category candidate ID: `evobc-evo-cat-09021`
- External category reference: `evobc-cat-09021`
- Source category ID: `09021`
- Source label for human review: `遁`
- Source codepoints: `U+9041`
...
- `obs-evo-cand-009021-route-category-staging`
...
- `obs-evo-cand-009021-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009021-route-evolution-graph`
