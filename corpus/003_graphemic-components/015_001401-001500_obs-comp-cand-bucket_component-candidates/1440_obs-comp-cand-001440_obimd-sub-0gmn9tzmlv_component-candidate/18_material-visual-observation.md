# Material Visual Observation / obs-comp-cand-001440 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001440`
- External reference / 外部参照: `obimd-sub-0gmn9tzmlv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016017_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0gmn9tzmlv/0gmn9tzmlv/0gmn9tzmlv.png`
- Checksum / 校验和:
  `7b3a5e830970a29f7617de83ac37e89ced932002384c14168a1a43fea92952a5`
...
- Marked-pixel bounds: (48,51)–(201,200); span 154 × 150 px; the marked
...
- 痕迹范围：(48,51)–(201,200)；跨度154 × 150 px；痕迹矩形近方形。
