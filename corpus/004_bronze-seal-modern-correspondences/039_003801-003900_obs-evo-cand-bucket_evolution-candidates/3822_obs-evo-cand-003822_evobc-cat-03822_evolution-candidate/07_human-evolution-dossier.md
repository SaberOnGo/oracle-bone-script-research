...
- Project ID: `obs-evo-cand-003822`
- EVOBC category candidate ID: `evobc-evo-cat-03822`
- External category reference: `evobc-cat-03822`
- Source category ID: `03822`
- Source label for human review: `最`
- Source codepoints: `U+6700`
...
- `obs-evo-cand-003822-route-category-staging`
...
- `obs-evo-cand-003822-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003822-route-evolution-graph`
