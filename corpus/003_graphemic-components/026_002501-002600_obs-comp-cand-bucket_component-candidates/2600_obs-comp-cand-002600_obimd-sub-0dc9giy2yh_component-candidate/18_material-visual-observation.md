# Material Visual Observation / obs-comp-cand-002600 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002600`
- External reference / 外部参照: `obimd-sub-0dc9giy2yh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021139_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0dc9giy2yh/0dc9giy2yh/0dc9giy2yh.png`
- Checksum / 校验和:
  `8d6c33c07ab7670a3526fcb6f22024176e0f1a4ef838d3d2f50481e6220c4e99`
...
- Marked-pixel bounds: (88,21)–(180,228); span 93 × 208 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.78%。
- 痕迹范围：(88,21)–(180,228)；跨度93 × 208 px；痕迹矩形高于宽。
