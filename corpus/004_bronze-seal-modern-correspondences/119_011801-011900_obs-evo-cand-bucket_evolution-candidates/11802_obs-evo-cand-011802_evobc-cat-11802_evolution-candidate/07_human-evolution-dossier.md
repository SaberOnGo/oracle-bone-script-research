...
- External category reference: `evobc-cat-11802`
- Source category ID: `11802`
- Source label for human review: `𥒓`
- Source codepoints: `U+25493`
...
- `obs-evo-cand-011802-route-category-staging`
...
- `obs-evo-cand-011802-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011802-route-evolution-graph`
