...
- Project ID: `obs-evo-cand-009752`
- EVOBC category candidate ID: `evobc-evo-cat-09752`
- External category reference: `evobc-cat-09752`
- Source category ID: `09752`
- Source label for human review: `陶`
- Source codepoints: `U+9676`
...
- `obs-evo-cand-009752-route-category-staging`
...
- `obs-evo-cand-009752-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009752-route-evolution-graph`
