...
Project ID: `obs-evo-cand-008527`
...
- Project ID: `obs-evo-cand-008527`
- EVOBC category candidate ID: `evobc-evo-cat-08527`
- External category reference: `evobc-cat-08527`
- Source category ID: `08527`
- Source label for human review: `貖`
- Source codepoints: `U+8C96`
...
- `obs-evo-cand-008527-route-category-staging`
...
- `obs-evo-cand-008527-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008527-route-evolution-graph`
