# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010297
...
- EVOBC candidate category: `evobc-evo-cat-10297`.
- Source label for search only: `骿`.
- Source codepoints for search only: `U+9ABF`.
