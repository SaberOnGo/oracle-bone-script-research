...
- External category reference: `evobc-cat-11309`
- Source category ID: `11309`
- Source label for human review: `𢯧`
- Source codepoints: `U+22BE7`
...
- `obs-evo-cand-011309-route-category-staging`
...
- `obs-evo-cand-011309-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011309-route-evolution-graph`
