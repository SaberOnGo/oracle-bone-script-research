...
- External category reference: `evobc-cat-01224`
- Source category ID: `01224`
- Source label for human review: `剑`
- Source codepoints: `U+5251`
...
- `obs-evo-cand-001224-route-category-staging`
...
- `obs-evo-cand-001224-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001224-route-evolution-graph`
