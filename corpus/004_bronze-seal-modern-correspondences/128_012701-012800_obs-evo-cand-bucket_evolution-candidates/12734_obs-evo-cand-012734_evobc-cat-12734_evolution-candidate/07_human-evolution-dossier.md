...
- External category reference: `evobc-cat-12734`
- Source category ID: `12734`
- Source label for human review: `𪆗`
...
- `obs-evo-cand-012734-route-category-staging`
...
- `obs-evo-cand-012734-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012734-route-evolution-graph`
