...
- External category reference: `evobc-cat-13592`
- Source category ID: `13592`
- Source label for human review: `𭾆`
- Source codepoints: `U+2DF86`
...
- `obs-evo-cand-013592-route-category-staging`
...
- `obs-evo-cand-013592-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013592-route-evolution-graph`
