# obs-unk-001629 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/033_undeciphered-001
  601-001700_obs-unk-bucket_oracle-character-candidates/029_obs-unk-001629_h
  ust-obc-und-L-001629_oracle-character-candidate/03_visual-assets/001_asset
  -003222_hust-obc-und-L-001629_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/1629/L_？_1451.jpg`
- asset id: `asset-003222`
...
- source class: `HUST-OBC/undeciphered/L/1629/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/1629/L_？_1451.jpg`
- asset id: `asset-003222`
...
- Which source records identify obs-unk-001629 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-001629？
