...
- External category reference: `evobc-cat-00806`
- Source category ID: `00806`
- Source label for human review: `佗`
...
- `obs-evo-cand-000806-route-category-staging`
...
- `obs-evo-cand-000806-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000806-route-evolution-graph`
