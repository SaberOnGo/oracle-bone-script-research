...
- Project ID: `obs-evo-cand-005711`
- EVOBC category candidate ID: `evobc-evo-cat-05711`
- External category reference: `evobc-cat-05711`
- Source category ID: `05711`
- Source label for human review: `登`
- Source codepoints: `U+767B`
- Image reference count in source metadata: `352`
...
- `obs-evo-cand-005711-route-category-staging`
...
- `obs-evo-cand-005711-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005711-route-evolution-graph`
