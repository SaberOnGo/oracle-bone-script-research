# Material Visual Observation / obs-comp-cand-001422 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001422`
- External reference / 外部参照: `obimd-sub-dhewuxyotl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015841_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dhewuxyotl/dhewuxyotl/013wy4ppyp.png`
- Checksum / 校验和:
  `b9b0bf7b7a86584abf88f7144a8d2186bc5b3daf46df1280f1077eedf9c2a12d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.35%.
- Marked-pixel bounds: (83,46)–(166,204); span 84 × 159 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.35%。
- 痕迹范围：(83,46)–(166,204)；跨度84 × 159 px；痕迹矩形高于宽。
