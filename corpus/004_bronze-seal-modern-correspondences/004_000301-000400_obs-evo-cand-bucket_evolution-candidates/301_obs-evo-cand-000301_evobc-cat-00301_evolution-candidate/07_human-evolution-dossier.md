...
Project ID: `obs-evo-cand-000301`
...
- Project ID: `obs-evo-cand-000301`
- EVOBC category candidate ID: `evobc-evo-cat-00301`
- External category reference: `evobc-cat-00301`
- Source category ID: `00301`
- Source label for human review: `䇙`
- Source codepoints: `U+41D9`
...
- `obs-evo-cand-000301-route-category-staging`
...
- `obs-evo-cand-000301-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000301-route-evolution-graph`
