...
- External category reference: `evobc-cat-07178`
- Source category ID: `07178`
- Source label for human review: `臾`
- Source codepoints: `U+81FE`
...
- `obs-evo-cand-007178-route-category-staging`
...
- `obs-evo-cand-007178-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007178-route-evolution-graph`
