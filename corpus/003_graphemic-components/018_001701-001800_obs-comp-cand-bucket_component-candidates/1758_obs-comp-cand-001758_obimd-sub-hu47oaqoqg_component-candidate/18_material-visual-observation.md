# Material Visual Observation / obs-comp-cand-001758 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001758`
- External reference / 外部参照: `obimd-sub-hu47oaqoqg`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017959_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hu47oaqoqg/hu47oaqoqg/hu47oaqoqg.png`
- Checksum / 校验和:
  `edc761cee501533759c4241406c3520d1ff39bda3cfede5bbd5c4ffea6bce3e7`
...
- Marked-pixel bounds: (68,40)–(177,205); span 110 × 166 px; the marked
...
- 痕迹范围：(68,40)–(177,205)；跨度110 × 166 px；痕迹矩形高于宽。
