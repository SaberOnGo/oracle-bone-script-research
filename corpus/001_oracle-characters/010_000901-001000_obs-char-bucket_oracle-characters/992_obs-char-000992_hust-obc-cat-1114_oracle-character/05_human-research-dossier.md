# obs-char-000992 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/992_obs-char-000992_hust-obc-cat-1114_orac
  le-character/03_visual-assets/001_asset-000997_hust-obc-cat-1114_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1114/G_1114_佚613.png`
- asset id: `asset-000997`
...
- source category: `1114`
- validation class: `991`
- source image route: `HUST-OBC/deciphered/1114/G_1114_佚613.png`
- asset id: `asset-000997`
...
- English observation: `A thin central stem has paired upper branches and a
  long descending right curve.`
- 中文观察: `纤细中央笔干有成对上部分枝和长下行右弯笔。`
...
- dataset label text: `㡐`
- dataset label codepoints: `U+3850`
...
- Which source records identify obs-char-000992 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000992？
