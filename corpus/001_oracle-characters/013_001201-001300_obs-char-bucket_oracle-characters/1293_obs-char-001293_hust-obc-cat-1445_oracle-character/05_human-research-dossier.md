# obs-char-001293 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001293`
- primary external id: `hust-obc-cat-1445`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1293_obs-char-001293_hust-obc-cat-1445_ora
  cle-character/03_visual-assets/001_asset-001298_hust-obc-cat-1445_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1445/G_1445_乙6693反(甲).png`
- asset id: `asset-001298`
...
- source category: `1445`
- validation class: `1292`
- source image route: `HUST-OBC/deciphered/1445/G_1445_乙6693反(甲).png`
- asset id: `asset-001298`
...
- English observation: `Two long outer verticals frame a small central
  rounded enclosure with a short inner horizontal.`
- 中文观察: `两条长外侧竖笔框住小型中央圆拱框形，内部有一条短横笔。`
...
- dataset label text: `㦛`
- dataset label codepoints: `U+399B`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00136`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00136`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00136`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/136_obs-evo-can
  d-000136_evobc-cat-00136_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/136_obs-evo-cand-000136_evobc-cat-00136_evolu
...
- Which source records identify obs-char-001293 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001293？
