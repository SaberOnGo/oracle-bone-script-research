...
- External category reference: `evobc-cat-12052`
- Source category ID: `12052`
- Source label for human review: `𦝭`
- Source codepoints: `U+2676D`
...
- `obs-evo-cand-012052-route-category-staging`
...
- `obs-evo-cand-012052-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012052-route-evolution-graph`
