# obs-char-000837 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000837`
- primary external id: `hust-obc-cat-0946`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/837_obs-char-000837_hust-obc-cat-0946_orac
  le-character/03_visual-assets/001_asset-000842_hust-obc-cat-0946_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0946/G_0946_乙696合707賓組.png`
- asset id: `asset-000842`
...
- source category: `0946`
- validation class: `836`
- source image route: `HUST-OBC/deciphered/0946/G_0946_乙696合707賓組.png`
- asset id: `asset-000842`
...
- English observation: `Several curved strokes meet in a central fork; short
  detached marks extend on both sides and at the upper right.`
- 中文观察: `数条弯曲笔在中央汇成分叉；两侧和右上方伸出或散置短小分离痕迹。`
...
- dataset label text: `㞨`
- dataset label codepoints: `U+37A8`
...
- filename catalog route clues: `Heji-like filename clue: 合707
  (G_0946_乙696合707賓組.png)`
...
- Which source records identify obs-char-000837 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000837？
