# obs-char-000308 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/308_obs-char-000308_hust-obc-cat-0348_orac
  le-character/03_visual-assets/001_asset-000313_hust-obc-cat-0348_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0348/G_0348_乙2170合8472賓組.png`
- asset id: `asset-000313`
...
- source category: `0348`
- validation class: `307`
- source image route: `HUST-OBC/deciphered/0348/G_0348_乙2170合8472賓組.png`
- asset id: `asset-000313`
...
- English observation: `A broad rectangular framework contains two
  horizontal internal bars, with long side strokes descending below its
  lower edge.`
...
- dataset label text: `㕒`
- dataset label codepoints: `U+3552`
...
- filename catalog route clues: `Heji-like filename clue: 合8472
...
- Which source records identify obs-char-000308 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000308？
