# obs-unk-004907 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004907`
- primary external id: `hust-obc-und-X-004907`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/007_obs-unk-004907_h
  ust-obc-und-X-004907_oracle-character-candidate/03_visual-assets/001_asset
  -006500_hust-obc-und-X-004907_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/463/X_？_7447_1.png`
- asset id: `asset-006500`
...
- The opened image shows a left outline with two light openings.
- A right upright has an upper diagonal branch and a long lower stroke.
- The source packet expects five views; one local view is present.
- 直接记录：`14_material-visual-observation.md`
- 已打开图像左侧外轮廓内可见两个浅色开口。
- 右侧直立笔画带上部斜向分枝和下部长笔画。
- 来源包记录应有五个视图；当前仅有一个本地图像。
...
- source class: `HUST-OBC/undeciphered/X/463/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/463/X_？_7447_1.png`
- asset id: `asset-006500`
- source image count: `5`
...
- Which source records identify obs-unk-004907 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004907？
