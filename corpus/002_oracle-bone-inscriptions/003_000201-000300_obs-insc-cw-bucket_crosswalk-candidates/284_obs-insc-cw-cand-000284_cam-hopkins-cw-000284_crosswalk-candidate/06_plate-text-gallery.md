...
Project ID: `obs-insc-cw-cand-000284`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000284`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000284` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y1901` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `327` [route_present_image_or_text_not_collected]
