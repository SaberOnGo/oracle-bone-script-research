...
Project ID: `obs-evo-cand-006948`
...
- Project ID: `obs-evo-cand-006948`
- EVOBC category candidate ID: `evobc-evo-cat-06948`
- External category reference: `evobc-cat-06948`
- Source category ID: `06948`
- Source label for human review: `聘`
- Source codepoints: `U+8058`
...
- `obs-evo-cand-006948-route-category-staging`
...
- `obs-evo-cand-006948-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006948-route-evolution-graph`
