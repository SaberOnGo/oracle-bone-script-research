...
- External category reference: `evobc-cat-06423`
- Source category ID: `06423`
- Source label for human review: `糕`
...
- `obs-evo-cand-006423-route-category-staging`
...
- `obs-evo-cand-006423-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006423-route-evolution-graph`
