# Material Visual Observation / obs-comp-cand-000953 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000953`
- External reference / 外部参照: `obimd-sub-p261sltt8d`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014036_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/g546qlgz9n/p261sltt8d/p261sltt8d.png`
- Checksum / 校验和:
  `0b5113104ac97c40dd85cb0b487587cbfe025ea51d01cc26aa3b41e1e511e1e0`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.51%.
- Marked-pixel bounds: (54,43)–(195,215); span 142 × 173 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.51%。
- 痕迹范围：(54,43)–(195,215)；跨度142 × 173 px；痕迹矩形高于宽。
