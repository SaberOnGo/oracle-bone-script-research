# Material Visual Observation / obs-comp-cand-000950 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000950`
- External reference / 外部参照: `obimd-sub-ugy1kvy5yz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014033_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ugy1kvy5yz/ugy1kvy5yz/ugy1kvy5yz.png`
- Checksum / 校验和:
  `d21168471b4915999d4b6936c186021761910fbda84a426794d067b9ae0c7eb2`
...
- Marked-pixel bounds: (68,38)–(181,213); span 114 × 176 px; the marked
...
- 痕迹范围：(68,38)–(181,213)；跨度114 × 176 px；痕迹矩形高于宽。
