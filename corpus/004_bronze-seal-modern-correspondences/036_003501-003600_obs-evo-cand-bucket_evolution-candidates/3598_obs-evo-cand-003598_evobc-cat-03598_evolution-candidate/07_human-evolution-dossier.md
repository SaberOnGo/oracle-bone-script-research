...
- External category reference: `evobc-cat-03598`
- Source category ID: `03598`
- Source label: `敦`
...
- `obs-evo-cand-003598-route-category-staging`
...
- `obs-evo-cand-003598-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003598-route-evolution-graph`
