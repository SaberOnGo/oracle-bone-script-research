# Material Visual Observation / obs-comp-cand-001792 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001792`
- External reference / 外部参照: `obimd-sub-4m6gjw93cc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018013_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fcooblbqyz/4m6gjw93cc/4m6gjw93cc.png`
- Checksum / 校验和:
  `8646d86080db96920c7569b8f333cd7d43a338e53319fdbc0e38f0bb6808f7fd`
...
- Marked-pixel bounds: (73,46)–(185,212); span 113 × 167 px; the marked
...
- 痕迹范围：(73,46)–(185,212)；跨度113 × 167 px；痕迹矩形高于宽。
