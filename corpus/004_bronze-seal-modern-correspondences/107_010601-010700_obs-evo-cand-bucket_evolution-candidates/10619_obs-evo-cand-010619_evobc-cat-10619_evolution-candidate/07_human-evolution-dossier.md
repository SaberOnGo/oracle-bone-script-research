...
- External category reference: `evobc-cat-10619`
- Source category ID: `10619`
- Source label for human review: `麢`
...
- `obs-evo-cand-010619-route-category-staging`
...
- `obs-evo-cand-010619-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010619-route-evolution-graph`
