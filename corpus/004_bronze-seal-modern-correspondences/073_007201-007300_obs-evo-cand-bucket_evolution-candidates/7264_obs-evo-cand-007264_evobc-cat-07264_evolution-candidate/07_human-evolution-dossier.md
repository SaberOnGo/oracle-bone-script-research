...
Project ID: `obs-evo-cand-007264`
...
- Project ID: `obs-evo-cand-007264`
- EVOBC category candidate ID: `evobc-evo-cat-07264`
- External category reference: `evobc-cat-07264`
- Source category ID: `07264`
- Source label for human review: `芸`
- Source codepoints: `U+82B8`
...
- `obs-evo-cand-007264-route-category-staging`
...
- `obs-evo-cand-007264-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007264-route-evolution-graph`
