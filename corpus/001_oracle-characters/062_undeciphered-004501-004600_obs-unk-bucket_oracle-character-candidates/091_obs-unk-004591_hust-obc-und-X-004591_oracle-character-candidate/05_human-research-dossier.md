# obs-unk-004591 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004591`
- primary external id: `hust-obc-und-X-004591`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/091_obs-unk-004591_h
  ust-obc-und-X-004591_oracle-character-candidate/03_visual-assets/001_asset
  -006184_hust-obc-und-X-004591_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/147/X_？_7215_1.png`
- asset id: `asset-006184`
...
- source class: `HUST-OBC/undeciphered/X/147/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/147/X_？_7215_1.png`
- asset id: `asset-006184`
- source image count: `4`
...
- English observation: `Large contour, interior vertical traces, and missing`
  `images recorded.`
- 中文观察: `已记录大轮廓、内部竖向痕和缺失图像。`
...
- Which source records identify obs-unk-004591 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004591？
