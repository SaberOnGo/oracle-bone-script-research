...
- External category reference: `evobc-cat-02855`
- Source category ID: `02855`
- Source label for human review: `彷`
- Source codepoints: `U+5F77`
...
- `obs-evo-cand-002855-route-category-staging`
...
- `obs-evo-cand-002855-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002855-route-evolution-graph`
