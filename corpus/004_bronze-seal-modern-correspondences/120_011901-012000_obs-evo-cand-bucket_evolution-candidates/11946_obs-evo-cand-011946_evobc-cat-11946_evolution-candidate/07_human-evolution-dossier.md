...
- Project ID: `obs-evo-cand-011946`
- EVOBC category candidate ID: `evobc-evo-cat-11946`
- External category reference: `evobc-cat-11946`
- Source category ID: `11946`
- Source label for human review: `𦀙`
- Source codepoints: `U+26019`
...
- `obs-evo-cand-011946-route-category-staging`
...
- `obs-evo-cand-011946-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011946-route-evolution-graph`
