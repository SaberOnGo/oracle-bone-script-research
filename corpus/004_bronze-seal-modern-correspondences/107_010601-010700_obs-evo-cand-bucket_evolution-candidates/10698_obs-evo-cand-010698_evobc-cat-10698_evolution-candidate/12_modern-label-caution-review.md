# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010698
...
- EVOBC candidate category: `evobc-evo-cat-10698`.
- Source label for search only: `鼫`.
- Source codepoints for search only: `U+9F2B`.
