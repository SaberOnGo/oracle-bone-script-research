# obs-evo-cand-003725 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-003725`
- EVOBC category candidate ID: `evobc-evo-cat-03725`
- External category ref: `evobc-cat-03725`
- Source label: `是`
- Source codepoints: `U+662F`
- Image reference count: `255`
- Era token counts: `BI:43;CS:2;SAC:40;SS:3;WSC:167`
- Source token counts: `Book:79;Web:176`

## Observed Code Rows / 观察到的代码行

- era 1 / BI: 43 image references
- era 2 / SS: 3 image references
- era 3 / SAC: 40 image references
- era 4 / WSC: 167 image references
- era 5 / CS: 2 image references
- source 1 / Web:105952;說文Web:58: 176 image references
- source 3 / Book:21681: 9 image references
- source 4 / Book:9131: 40 image references
