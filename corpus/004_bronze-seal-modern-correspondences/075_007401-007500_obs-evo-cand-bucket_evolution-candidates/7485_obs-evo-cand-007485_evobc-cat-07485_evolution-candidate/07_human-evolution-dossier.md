...
- External category reference: `evobc-cat-07485`
- Source category ID: `07485`
...
- `obs-evo-cand-007485-route-category-staging`
...
- `obs-evo-cand-007485-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007485-route-evolution-graph`
