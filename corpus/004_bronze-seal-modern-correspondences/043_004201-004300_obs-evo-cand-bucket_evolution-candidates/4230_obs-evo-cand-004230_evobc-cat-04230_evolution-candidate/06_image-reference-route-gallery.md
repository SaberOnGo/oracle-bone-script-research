...
- `obs-evo-cand-004230-route-category-staging`
...
- `obs-evo-cand-004230-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004230-route-evolution-graph`
