...
- `obs-evo-cand-004291-route-category-staging`
...
- `obs-evo-cand-004291-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004291-route-evolution-graph`
