# obs-char-001416 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001416`
- primary external id: `hust-obc-cat-1585`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1416_obs-char-001416_hust-obc-cat-1585_ora
  cle-character/03_visual-assets/001_asset-001421_hust-obc-cat-1585_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1585/G_1585_甲骨文0.png`
- asset id: `asset-001421`
...
- source category: `1585`
- validation class: `1415`
- source image route: `HUST-OBC/deciphered/1585/G_1585_甲骨文0.png`
- asset id: `asset-001421`
...
- English observation: `A small narrow form has an upper rectangular cap and
  a long descending curve.`
- 中文观察: `小型狭长形体有上部矩形盖和长下行弧线。`
...
- dataset label text: `㨧`
- dataset label codepoints: `U+3A27`
...
- Which source records identify obs-char-001416 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001416？
