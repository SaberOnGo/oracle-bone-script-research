# obs-unk-004828 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004828`
- primary external id: `hust-obc-und-X-004828`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/028_obs-unk-004828_h
  ust-obc-und-X-004828_oracle-character-candidate/03_visual-assets/001_asset
  -006421_hust-obc-und-X-004828_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/384/X_？_7367_1.png`
- asset id: `asset-006421`
...
- source class: `HUST-OBC/undeciphered/X/384/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/384/X_？_7367_1.png`
- asset id: `asset-006421`
...
- English observation: `upper branches and lower loop with pale opening`
- 中文观察: `上部分支和带浅色开口的下部环状结构`
...
- Which source records identify obs-unk-004828 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004828？
