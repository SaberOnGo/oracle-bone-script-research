...
Topic candidate ID: `obs-topic-cand-000011`
...
| source summary row | cam-hopkins-summary-011 |
| source group | 11 |
| source label en | animal husbandry |
| source label zh | 畜牧 |
...
| sampled route count below | 5 |

| crosswalk id | period | Yingguo route | Heji route |
| --- | --- | --- | --- |
| obs-insc-cw-cand-000355 | II | y2047 | 41086 |
| obs-insc-cw-cand-000356 | II | y2048 | ***** |
| obs-insc-cw-cand-000357 | II | y2049 | ***** |
| obs-insc-cw-cand-000455 | III | y2333 | ***** |
| obs-insc-cw-cand-000499 | IV | y2436 | ***** |
