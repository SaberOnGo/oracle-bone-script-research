# obs-evo-cand-007184 / EVOBC evolution-category candidate
...
- EVOBC category candidate ID: `evobc-evo-cat-07184`
- External category ref: `evobc-cat-07184`
- Source label for human review: `舄`
- Source codepoints: `U+8204`
- Image reference count: `32`
- Era token counts: `BI:26;SS:2;WSC:4`
- Source token counts: `Book:11;Web:21`
