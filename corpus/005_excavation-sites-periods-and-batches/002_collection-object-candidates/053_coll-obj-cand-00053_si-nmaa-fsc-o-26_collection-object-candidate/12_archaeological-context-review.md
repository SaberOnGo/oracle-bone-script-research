# Archaeological Context Review / 考古语境复核: coll-obj-cand-00053
...
| --- | --- | --- |
| Institution | `Freer Gallery of Art Study Collection` | `02_collection-source-index.csv` |
| Catalog or accession | `FSC-O-26` | `02_collection-source-index.csv` |
| Source item | `FSC-O-26` | `01_collection-object-packet.json` |
| Catalog description | `Oracle bone, incribed` | `01_collection-object-packet.json` |
| Image route | `committed_public_domain_asset` | `03_visual-asset-index.csv` |
| Findspot or provenience | `China` | `08_collection-provenance-evidence-dossier.md` |
| Period or date | `Shang dynasty, ca. 1600 - ca. 1050 BCE` | `08_collection-provenance-evidence-dossier.md` |
...
| Rights and risk | `public_domain_verified` | `02_collection-source-index.csv` |
