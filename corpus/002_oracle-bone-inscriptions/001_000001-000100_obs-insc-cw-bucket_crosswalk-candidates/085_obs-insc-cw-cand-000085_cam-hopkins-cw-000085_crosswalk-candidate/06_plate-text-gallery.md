...
Project ID: `obs-insc-cw-cand-000085`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000085`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000085` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y543` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `99` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `673` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `39854` [route_present_image_or_text_not_collected]
