# Material Visual Observation / obs-comp-cand-002673 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002673`
- External reference / 外部参照: `obimd-sub-htn7736sjm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021249_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/htn7736sjm/htn7736sjm/htn7736sjm.png`
- Checksum / 校验和:
  `125e0b7dd0944bcdaad82151623cc48c01fc563e72589750aef058eab4afb110`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.76%.
- Marked-pixel bounds: (45,33)–(199,211); span 155 × 179 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.76%。
- 痕迹范围：(45,33)–(199,211)；跨度155 × 179 px；痕迹矩形近方形。
