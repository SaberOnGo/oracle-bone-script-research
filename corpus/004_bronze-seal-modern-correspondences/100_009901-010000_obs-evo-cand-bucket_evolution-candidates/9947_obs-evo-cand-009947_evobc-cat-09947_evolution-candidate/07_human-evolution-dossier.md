...
- External category reference: `evobc-cat-09947`
- Source category ID: `09947`
- Source label for human review: `韗`
...
- `obs-evo-cand-009947-route-category-staging`
...
- `obs-evo-cand-009947-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009947-route-evolution-graph`
