# obs-char-001512 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1512_obs-char-001512_hust-obc-cat-1697_ora
  cle-character/03_visual-assets/001_asset-001517_hust-obc-cat-1697_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1697/X_1697_1664_1.png`
- asset id: `asset-001517`
...
- source category: `1697`
- validation class: `1511`
- source image route: `HUST-OBC/deciphered/1697/X_1697_1664_1.png`
- asset id: `asset-001517`
...
- English observation: `A composite separates small upper curved marks from
  a broad lower bowl-like contour.`
...
- dataset label text: `㪗`
- dataset label codepoints: `U+3A97`
...
- Which source records identify obs-char-001512 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001512？
