...
- Project ID: `obs-evo-cand-001384`
- EVOBC category candidate ID: `evobc-evo-cat-01384`
- External category reference: `evobc-cat-01384`
- Source category ID: `01384`
- Source label for human review: `卟`
- Source codepoints: `U+535F`
...
- `obs-evo-cand-001384-route-category-staging`
...
- `obs-evo-cand-001384-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001384-route-evolution-graph`
