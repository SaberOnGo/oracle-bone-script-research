# Collection Provenance Fact Matrix / 馆藏来源事实矩阵: coll-obj-cand-00054
...
| Catalog or accession route / 著录或登记路线 | 49-14-7A; source-page route only | 02_collection-source-index.csv; 06_human-collection-dossier.md |
| Image or visual route / 图像或视觉路线 | no_committed_visual_asset; open gallery before visual use | 03_visual-asset-index.csv; 04_visual-gallery.md |
| Findspot or provenience / 出土地或来源地 | Anyang | 06_human-collection-dossier.md; 08_collection-provenance-evidence-dossier.md |
| Period or date / 时期或年代 | Shang Dynasty | 06_human-collection-dossier.md; 08_collection-provenance-evidence-dossier.md |
...
| Source and rights trail / 来源与权利链 | src-penn-museum-oracle-bone; rights metadata_only_until_verified | 02_collection-source-index.csv; 09_collection-provenance-evidence-index.json |
