# obs-unk-004381 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/081_obs-unk-004381_h
  ust-obc-und-L-004381_oracle-character-candidate/03_visual-assets/001_asset
  -005974_hust-obc-und-L-004381_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4381/L_？_9737.jpg`
- asset id: `asset-005974`
...
- source class: `HUST-OBC/undeciphered/L/4381/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4381/L_？_9737.jpg`
- asset id: `asset-005974`
...
- English observation: `A rounded upper trace and stacked angular`
  `outlines are visible; a broad lower baseline has short projections.`
- 中文观察: `上部有弧形痕迹和叠置斜角轮廓，下部基线带短伸出痕迹。`
...
- Which source records identify obs-unk-004381 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004381？
