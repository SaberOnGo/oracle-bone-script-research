...
- External category reference: `evobc-cat-13308`
- Source category ID: `13308`
- Source label for human review: `𬜄`
- Source codepoints: `U+2C704`
...
- `obs-evo-cand-013308-route-category-staging`
...
- `obs-evo-cand-013308-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013308-route-evolution-graph`
