# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-001026
...
- candidate_component_id: `obs-comp-cand-001026`
- primary_external_ref_id: `obimd-sub-zrxiogzeqd`
- source_subcharacter_uid: `zrxiogzeqd`
- source_main_character_uid: `188qgh86vq`
- main_character_external_ref_id: `obimd-main-188qgh86vq`
...
- glyph_codepoint_uplus_sample: `U+B4FF4;U+F5CEA, U+F5CEB, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-014519` | `001_asset-014519_img.png` | `f69407347cd764118ce3db0dd0a42f4a352b45173868ee33f91bddc50bd6625a` |
