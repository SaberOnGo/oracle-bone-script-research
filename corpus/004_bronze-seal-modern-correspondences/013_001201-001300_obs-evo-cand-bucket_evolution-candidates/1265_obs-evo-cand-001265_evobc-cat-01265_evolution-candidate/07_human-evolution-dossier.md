...
Project ID: `obs-evo-cand-001265`
...
- Project ID: `obs-evo-cand-001265`
- EVOBC category candidate ID: `evobc-evo-cat-01265`
- External category reference: `evobc-cat-01265`
- Source category ID: `01265`
- Source label for human review: `功`
- Source codepoints: `U+529F`
...
- `obs-evo-cand-001265-route-category-staging`
...
- `obs-evo-cand-001265-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001265-route-evolution-graph`
