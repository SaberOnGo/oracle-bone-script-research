...
- Project ID: `obs-evo-cand-008630`
- EVOBC category candidate ID: `evobc-evo-cat-08630`
- External category reference: `evobc-cat-08630`
- Source category ID: `08630`
- Source label for human review: `贴`
- Source codepoints: `U+8D34`
...
- `obs-evo-cand-008630-route-category-staging`
...
- `obs-evo-cand-008630-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008630-route-evolution-graph`
