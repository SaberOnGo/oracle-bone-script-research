# obs-char-001483 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001483`
- primary external id: `hust-obc-cat-1665`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1483_obs-char-001483_hust-obc-cat-1665_ora
  cle-character/03_visual-assets/001_asset-001488_hust-obc-cat-1665_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1665/G_1665_合36417(甲).png`
- asset id: `asset-001488`
...
- source category: `1665`
- validation class: `1482`
- source image route: `HUST-OBC/deciphered/1665/G_1665_合36417(甲).png`
- asset id: `asset-001488`
...
- English observation: `A narrow tall form has upper bars, a middle loop,
  and lower branches.`
...
- dataset label text: `㩷`
- dataset label codepoints: `U+3A77`
...
- filename catalog route clues: `Heji-like filename clue: 合36417
  (G_1665_合36417(甲).png)`
...
- Which source records identify obs-char-001483 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001483？
