# obs-char-000854 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/854_obs-char-000854_hust-obc-cat-0963_orac
  le-character/03_visual-assets/001_asset-000859_hust-obc-cat-0963_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0963/L_0963_6038.jpg`
- asset id: `asset-000859`
...
- source category: `0963`
- validation class: `853`
- source image route: `HUST-OBC/deciphered/0963/L_0963_6038.jpg`
- asset id: `asset-000859`
...
- English observation: `The tiny gray image shows a small closed upper loop
  connected to a thin angled lower stroke; the resolution is low.`
- 中文观察: `微小灰度图像显示小型闭合上环与细斜向下笔相连；图像分辨率较低。`
...
- dataset label text: `㞹`
- dataset label codepoints: `U+37B9`
...
- Which source records identify obs-char-000854 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000854？
