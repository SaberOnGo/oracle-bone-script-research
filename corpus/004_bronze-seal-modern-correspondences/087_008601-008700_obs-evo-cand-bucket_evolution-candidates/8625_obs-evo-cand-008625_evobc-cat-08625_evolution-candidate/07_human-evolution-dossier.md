...
- External category reference: `evobc-cat-08625`
- Source category ID: `08625`
- Source label for human review: `贬`
...
- `obs-evo-cand-008625-route-category-staging`
...
- `obs-evo-cand-008625-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008625-route-evolution-graph`
