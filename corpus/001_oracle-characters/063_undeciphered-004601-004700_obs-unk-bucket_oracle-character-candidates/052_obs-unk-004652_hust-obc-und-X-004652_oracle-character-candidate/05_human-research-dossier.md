# obs-unk-004652 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/052_obs-unk-004652_h
  ust-obc-und-X-004652_oracle-character-candidate/03_visual-assets/001_asset
  -006245_hust-obc-und-X-004652_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/208/X_？_8380_1.png`
- asset id: `asset-006245`
...
- source class: `HUST-OBC/undeciphered/X/208/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/208/X_？_8380_1.png`
- asset id: `asset-006245`
...
- English observation: `tall open contour with small upper opening`
- 中文观察: `带上部小开口的高而开口轮廓`
...
- Which source records identify obs-unk-004652 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004652？
