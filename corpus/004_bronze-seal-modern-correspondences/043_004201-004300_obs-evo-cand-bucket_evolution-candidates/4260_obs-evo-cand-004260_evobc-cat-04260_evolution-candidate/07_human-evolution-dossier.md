...
- External category reference: `evobc-cat-04260`
- Source category ID: `04260`
- Source label for human review: `橈`
- Source codepoints: `U+6A48`
...
- `obs-evo-cand-004260-route-category-staging`
...
- `obs-evo-cand-004260-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004260-route-evolution-graph`
