...
- External category reference: `evobc-cat-11502`
- Source category ID: `11502`
- Source label for human review: `𣬡`
- Source codepoints: `U+23B21`
...
- `obs-evo-cand-011502-route-category-staging`
...
- `obs-evo-cand-011502-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011502-route-evolution-graph`
