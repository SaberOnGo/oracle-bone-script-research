...
- External category reference: `evobc-cat-09169`
- Source category ID: `09169`
- Source label for human review: `郹`
- Source codepoints: `U+90F9`
...
- `obs-evo-cand-009169-route-category-staging`
...
- `obs-evo-cand-009169-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009169-route-evolution-graph`
