# Material Visual Observation / obs-comp-cand-000134 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000134`
- External reference / 外部参照: `obimd-sub-xc484dkyvf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011546_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/j5q9a8d49b/xc484dkyvf/xc484dkyvf.png`
- Checksum / 校验和:
  `500c620e1f0ca25fb4049c84e17c959785cd8041dc898329a261aae46a3f926d`
...
- Marked-pixel bounds: (63,53)–(186,197); span 124 × 145 px; the marked
...
- 痕迹范围：(63,53)–(186,197)；跨度124 × 145 px；痕迹矩形近方形。
