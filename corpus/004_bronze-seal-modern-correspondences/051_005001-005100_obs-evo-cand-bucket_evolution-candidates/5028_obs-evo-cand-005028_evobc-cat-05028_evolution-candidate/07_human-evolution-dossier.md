...
Project ID: `obs-evo-cand-005028`
...
- Project ID: `obs-evo-cand-005028`
- EVOBC category candidate ID: `evobc-evo-cat-05028`
- External category reference: `evobc-cat-05028`
- Source category ID: `05028`
- Source label for human review: `灶`
- Source codepoints: `U+7076`
...
- `obs-evo-cand-005028-route-category-staging`
...
- `obs-evo-cand-005028-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005028-route-evolution-graph`
