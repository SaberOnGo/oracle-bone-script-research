# obs-comp-cand-000452 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000452`
- 首选外部 ID: `obimd-sub-c15glxokfb`
- OBIMD subcharacter UID: `c15glxokfb`
- OBIMD main character UID: `y0f5gu3q0a`
- 来源 ID: `src-obimd`
...
- codepoint 示例: U+F2A65; U+F2A66; 另有 30 项
