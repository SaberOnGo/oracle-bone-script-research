# obs-unk-004666 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004666`
- primary external id: `hust-obc-und-X-004666`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/066_obs-unk-004666_h
  ust-obc-und-X-004666_oracle-character-candidate/03_visual-assets/001_asset
  -006259_hust-obc-und-X-004666_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/222/X_？_8393_1.png`
- asset id: `asset-006259`
...
- source class: `HUST-OBC/undeciphered/X/222/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/222/X_？_8393_1.png`
- asset id: `asset-006259`
...
- English observation: `dark-background derivative with broken light regions`
- 中文观察: `深色背景派生图，浅色区域断续`
...
- Which source records identify obs-unk-004666 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004666？
