...
- `obs-evo-cand-011469-route-category-staging`
...
- `obs-evo-cand-011469-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011469-route-evolution-graph`
