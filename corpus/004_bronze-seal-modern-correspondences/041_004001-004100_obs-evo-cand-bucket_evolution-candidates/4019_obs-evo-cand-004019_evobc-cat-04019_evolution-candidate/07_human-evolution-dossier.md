...
Project ID: `obs-evo-cand-004019`
...
- Project ID: `obs-evo-cand-004019`
- EVOBC category candidate ID: `evobc-evo-cat-04019`
- External category reference: `evobc-cat-04019`
- Source category ID: `04019`
- Source label for human review: `桅`
- Source codepoints: `U+6845`
...
- `obs-evo-cand-004019-route-category-staging`
...
- `obs-evo-cand-004019-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004019-route-evolution-graph`
