...
Project ID: `obs-evo-cand-000023`
...
- Project ID: `obs-evo-cand-000023`
- EVOBC category candidate ID: `evobc-evo-cat-00023`
- External category reference: `evobc-cat-00023`
- Source category ID: `00023`
- Source label for human review: `㔙`
- Source codepoints: `U+3519`
...
- `obs-evo-cand-000023-route-category-staging`
...
- `obs-evo-cand-000023-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000023-route-evolution-graph`
