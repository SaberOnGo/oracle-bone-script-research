...
- External category reference: `evobc-cat-01435`
- Source category ID: `01435`
- Source label for human review: `厪`
- Source codepoints: `U+53AA`
...
- `obs-evo-cand-001435-route-category-staging`
...
- `obs-evo-cand-001435-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001435-route-evolution-graph`
