# Material Visual Observation / obs-comp-cand-000159 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000159`
- External reference / 外部参照: `obimd-sub-17p9dyty3o`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011571_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lxao6q3l56/17p9dyty3o/17p9dyty3o.png`
- Checksum / 校验和:
  `731ea51daa61c6644e4f54138ac0a4832d12203dedc33d91e25e33908a04ca6c`
...
- Marked-pixel bounds: (76,35)–(172,209); span 97 × 175 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.72%。
- 痕迹范围：(76,35)–(172,209)；跨度97 × 175 px；痕迹矩形高于宽。
