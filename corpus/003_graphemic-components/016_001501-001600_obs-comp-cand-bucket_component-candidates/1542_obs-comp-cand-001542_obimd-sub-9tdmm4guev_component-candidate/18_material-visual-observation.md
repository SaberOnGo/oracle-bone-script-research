# Material Visual Observation / obs-comp-cand-001542 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001542`
- External reference / 外部参照: `obimd-sub-9tdmm4guev`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016956_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9tdmm4guev/9tdmm4guev/9tdmm4guev.png`
- Checksum / 校验和:
  `1dee551e824c20b7740bd356b94eede8044a21247854bafd7b48dde97287a864`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.13%.
- Marked-pixel bounds: (62,17)–(174,232); span 113 × 216 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.13%。
- 痕迹范围：(62,17)–(174,232)；跨度113 × 216 px；痕迹矩形高于宽。
