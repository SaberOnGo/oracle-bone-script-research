...
Project ID: `obs-insc-cw-cand-000432`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000432`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000432` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2267` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `574` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `202` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `40982` [route_present_image_or_text_not_collected]
