# Material Visual Observation / obs-comp-cand-001098 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001098`
- External reference / 外部参照: `obimd-sub-0kcfgksim7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014907_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0kcfgksim7/0kcfgksim7/0kcfgksim7.png`
- Checksum / 校验和:
  `38ad6f24a0a33b2e7d8052cad9af44d562820a2158fcd72f19f5cd2be7e56d9e`
...
- Marked-pixel bounds: (72,26)–(180,214); span 109 × 189 px; the marked
...
- 痕迹范围：(72,26)–(180,214)；跨度109 × 189 px；痕迹矩形高于宽。
