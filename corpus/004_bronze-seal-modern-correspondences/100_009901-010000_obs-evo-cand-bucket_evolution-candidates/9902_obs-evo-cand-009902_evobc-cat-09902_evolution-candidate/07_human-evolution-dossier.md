...
- Project ID: `obs-evo-cand-009902`
- EVOBC category candidate ID: `evobc-evo-cat-09902`
- External category reference: `evobc-cat-09902`
- Source category ID: `09902`
- Source label for human review: `鞀`
- Source codepoints: `U+9780`
...
- `obs-evo-cand-009902-route-category-staging`
...
- `obs-evo-cand-009902-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009902-route-evolution-graph`
