...
Project ID: `obs-insc-cw-cand-000010`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000010`
...
- Yingguo / 英国所藏: `y60` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `33` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `480` in source row; primary catalog entry pending
- Heji / 合集: `40093` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000010`
