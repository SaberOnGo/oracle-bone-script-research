...
- External category reference: `evobc-cat-09749`
- Source category ID: `09749`
- Source label for human review: `陳`
- Source codepoints: `U+9673`
- Image reference count in source metadata: `136`
...
- `obs-evo-cand-009749-route-category-staging`
...
- `obs-evo-cand-009749-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009749-route-evolution-graph`
