# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004652
...
- EVOBC candidate category: `evobc-evo-cat-04652`.
- Source label for search only: `浏`.
- Source codepoints for search only: `U+6D4F`.
