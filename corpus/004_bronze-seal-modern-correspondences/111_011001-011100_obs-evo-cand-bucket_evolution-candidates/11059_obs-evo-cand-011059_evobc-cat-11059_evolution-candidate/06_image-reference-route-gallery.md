...
- `obs-evo-cand-011059-route-category-staging`
...
- `obs-evo-cand-011059-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011059-route-evolution-graph`
