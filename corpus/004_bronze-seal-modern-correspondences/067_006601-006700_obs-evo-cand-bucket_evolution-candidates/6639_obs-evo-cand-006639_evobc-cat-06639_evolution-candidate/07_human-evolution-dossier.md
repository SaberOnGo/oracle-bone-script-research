...
- Project ID: `obs-evo-cand-006639`
- EVOBC category candidate ID: `evobc-evo-cat-06639`
- External category reference: `evobc-cat-06639`
- Source category ID: `06639`
- Source label for human review: `縡`
- Source codepoints: `U+7E21`
...
- `obs-evo-cand-006639-route-category-staging`
...
- `obs-evo-cand-006639-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006639-route-evolution-graph`
