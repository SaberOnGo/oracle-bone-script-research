...
- `obs-evo-cand-006996-route-category-staging`
...
- `obs-evo-cand-006996-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006996-route-evolution-graph`
