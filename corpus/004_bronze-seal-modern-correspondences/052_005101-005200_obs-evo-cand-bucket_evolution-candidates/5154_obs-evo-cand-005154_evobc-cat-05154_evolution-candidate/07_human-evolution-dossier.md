...
- Project ID: `obs-evo-cand-005154`
- EVOBC category candidate ID: `evobc-evo-cat-05154`
- External category reference: `evobc-cat-05154`
- Source category ID: `05154`
- Source label for human review: `營`
- Source codepoints: `U+71DF`
...
- `obs-evo-cand-005154-route-category-staging`
...
- `obs-evo-cand-005154-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005154-route-evolution-graph`
