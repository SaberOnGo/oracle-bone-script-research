...
Project ID: `obs-evo-cand-006236`
...
- Project ID: `obs-evo-cand-006236`
- EVOBC category candidate ID: `evobc-evo-cat-06236`
- External category reference: `evobc-cat-06236`
- Source category ID: `06236`
- Source label for human review: `笢`
- Source codepoints: `U+7B22`
...
- `obs-evo-cand-006236-route-category-staging`
...
- `obs-evo-cand-006236-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006236-route-evolution-graph`
