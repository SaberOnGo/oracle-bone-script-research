...
- Project ID: `obs-evo-cand-011122`
- EVOBC category candidate ID: `evobc-evo-cat-11122`
- External category reference: `evobc-cat-11122`
- Source category ID: `11122`
- Source label for human review: `𡻴`
- Source codepoints: `U+21EF4`
...
- `obs-evo-cand-011122-route-category-staging`
...
- `obs-evo-cand-011122-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011122-route-evolution-graph`
