...
- External category reference: `evobc-cat-10373`
- Source category ID: `10373`
- Source label for human review: `魪`
- Source codepoints: `U+9B6A`
...
- `obs-evo-cand-010373-route-category-staging`
...
- `obs-evo-cand-010373-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010373-route-evolution-graph`
