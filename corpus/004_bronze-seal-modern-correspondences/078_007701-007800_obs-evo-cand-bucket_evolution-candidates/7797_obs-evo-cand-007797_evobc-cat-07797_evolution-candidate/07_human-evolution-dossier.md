...
Project ID: `obs-evo-cand-007797`
...
- Project ID: `obs-evo-cand-007797`
- EVOBC category candidate ID: `evobc-evo-cat-07797`
- External category reference: `evobc-cat-07797`
- Source category ID: `07797`
- Source label for human review: `蜻`
- Source codepoints: `U+873B`
...
- `obs-evo-cand-007797-route-category-staging`
...
- `obs-evo-cand-007797-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007797-route-evolution-graph`
