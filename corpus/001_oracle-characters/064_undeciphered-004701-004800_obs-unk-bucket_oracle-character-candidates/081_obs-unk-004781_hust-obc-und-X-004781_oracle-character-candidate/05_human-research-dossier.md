# obs-unk-004781 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004781`
- primary external id: `hust-obc-und-X-004781`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/081_obs-unk-004781_h
  ust-obc-und-X-004781_oracle-character-candidate/03_visual-assets/001_asset
  -006374_hust-obc-und-X-004781_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/337/X_？_7092_1.png`
- asset id: `asset-006374`
...
- source class: `HUST-OBC/undeciphered/X/337/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/337/X_？_7092_1.png`
- asset id: `asset-006374`
...
- English observation: `separate left opening and tall right group`
- 中文观察: `分离的左侧开口和高长右侧结构`
...
- Which source records identify obs-unk-004781 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004781？
