...
- Project ID: `obs-evo-cand-001121`
- EVOBC category candidate ID: `evobc-evo-cat-01121`
- External category reference: `evobc-cat-01121`
- Source category ID: `01121`
- Source label for human review: `冖`
- Source codepoints: `U+5196`
...
- `obs-evo-cand-001121-route-category-staging`
...
- `obs-evo-cand-001121-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001121-route-evolution-graph`
