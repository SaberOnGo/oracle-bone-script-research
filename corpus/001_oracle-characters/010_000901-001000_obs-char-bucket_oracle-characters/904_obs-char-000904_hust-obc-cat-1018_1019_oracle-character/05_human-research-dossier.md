# obs-char-000904 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000904`
- primary external id: `hust-obc-cat-1018_1019`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/904_obs-char-000904_hust-obc-cat-1018_1019
  _oracle-character/03_visual-assets/001_asset-000909_hust-obc-cat-1018_1019
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1018_1019/1018/G_1018_乙123合2076
  6.png`
- asset id: `asset-000909`
...
- source category: `1018_1019`
- validation class: `903`
- source image route: `HUST-OBC/deciphered/1018_1019/1018/G_1018_乙123合20766.pn
  g`
- asset id: `asset-000909`
...
- English observation: `A small narrow cluster combines short upper curved
  marks, a central fork, a long descending stem, and a detached right mark.`
- 中文观察: `小型狭长笔群结合上部短弯曲痕迹、中央分叉、长下行笔干和右侧分离痕迹。`
...
- dataset label text: `㟰㟱`
- dataset label codepoints: `U+37F0;U+37F1`
...
- graph edge count: `2`
- codepoint routes: `U+37F0;U+37F1`
...
- filename catalog route clues: `Heji-like filename clue: 合20766
  (G_1018_乙123合20766.png)`
...
- Which source records identify obs-char-000904 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000904？
