# obs-unk-002290 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/039_undeciphered-002
  201-002300_obs-unk-bucket_oracle-character-candidates/090_obs-unk-002290_h
  ust-obc-und-L-002290_oracle-character-candidate/03_visual-assets/001_asset
  -003883_hust-obc-und-L-002290_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2290/L_？_2930.jpg`
- asset id: `asset-003883`
...
- source class: `HUST-OBC/undeciphered/L/2290/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2290/L_？_2930.jpg`
- asset id: `asset-003883`
...
- Which source records identify obs-unk-002290 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002290？
