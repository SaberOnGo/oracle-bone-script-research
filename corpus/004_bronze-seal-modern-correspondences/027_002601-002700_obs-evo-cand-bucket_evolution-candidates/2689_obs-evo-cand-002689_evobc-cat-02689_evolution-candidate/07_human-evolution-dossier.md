...
- Project ID: `obs-evo-cand-002689`
- EVOBC category candidate ID: `evobc-evo-cat-02689`
- External category reference: `evobc-cat-02689`
- Source category ID: `02689`
- Source label for human review: `幩`
- Source codepoints: `U+5E69`
...
- `obs-evo-cand-002689-route-category-staging`
...
- `obs-evo-cand-002689-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002689-route-evolution-graph`
