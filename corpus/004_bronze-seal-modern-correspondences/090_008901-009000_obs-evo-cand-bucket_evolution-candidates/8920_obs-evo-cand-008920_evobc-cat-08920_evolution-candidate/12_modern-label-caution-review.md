# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008920
...
- EVOBC candidate category: `evobc-evo-cat-08920`.
- Source label for search only: `辬`.
- Source codepoints for search only: `U+8FAC`.
