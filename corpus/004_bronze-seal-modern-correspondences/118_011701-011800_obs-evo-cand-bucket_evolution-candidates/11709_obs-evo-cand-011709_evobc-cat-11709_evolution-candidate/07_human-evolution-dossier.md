...
- External category reference: `evobc-cat-11709`
- Source category ID: `11709`
- Source label for human review: `𤸀`
- Source codepoints: `U+24E00`
...
- `obs-evo-cand-011709-route-category-staging`
...
- `obs-evo-cand-011709-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011709-route-evolution-graph`
