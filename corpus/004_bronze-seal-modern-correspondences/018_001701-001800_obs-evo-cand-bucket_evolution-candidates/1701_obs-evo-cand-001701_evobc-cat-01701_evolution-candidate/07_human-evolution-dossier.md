...
- Project ID: `obs-evo-cand-001701`
- EVOBC category candidate ID: `evobc-evo-cat-01701`
- External category reference: `evobc-cat-01701`
- Source category ID: `01701`
- Source label for human review: `嘩`
- Source codepoints: `U+5629`
...
- `obs-evo-cand-001701-route-category-staging`
...
- `obs-evo-cand-001701-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001701-route-evolution-graph`
