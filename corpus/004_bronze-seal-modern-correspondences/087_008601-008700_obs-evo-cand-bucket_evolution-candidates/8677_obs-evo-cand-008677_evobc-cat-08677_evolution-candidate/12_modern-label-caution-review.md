# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008677
...
- EVOBC candidate category: `evobc-evo-cat-08677`.
- Source label for search only: `趍`.
- Source codepoints for search only: `U+8D8D`.
