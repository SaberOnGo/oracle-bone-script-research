# obs-evo-cand-004418 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-004418`
- EVOBC category candidate ID: `evobc-evo-cat-04418`
- External category ref: `evobc-cat-04418`
- Source label for human review: `殤`
- Source codepoints: `U+6BA4`
- Image reference count: `18`
- Era token counts: `SS:1;WSC:17`
- Source token counts: `Book:6;Web:12`
