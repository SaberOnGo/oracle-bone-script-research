# obs-comp-cand-000399 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000399`
- 首选外部 ID: `obimd-sub-fpq0j1p9ii`
- OBIMD subcharacter UID: `fpq0j1p9ii`
- OBIMD main character UID: `fpq0j1p9ii`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+2BFB9;U+F254C; U+F254D; 另有 3 项
