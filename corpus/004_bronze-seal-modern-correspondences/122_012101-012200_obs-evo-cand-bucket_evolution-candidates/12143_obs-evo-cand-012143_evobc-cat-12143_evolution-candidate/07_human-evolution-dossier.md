...
Project ID: `obs-evo-cand-012143`
...
- Project ID: `obs-evo-cand-012143`
- EVOBC category candidate ID: `evobc-evo-cat-12143`
- External category reference: `evobc-cat-12143`
- Source category ID: `12143`
- Source label for human review: `𧇏`
- Source codepoints: `U+271CF`
...
- `obs-evo-cand-012143-route-category-staging`
...
- `obs-evo-cand-012143-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012143-route-evolution-graph`
