# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004307
...
- EVOBC candidate category: `evobc-evo-cat-04307`.
- Source label for search only: `櫋`.
- Source codepoints for search only: `U+6ACB`.
