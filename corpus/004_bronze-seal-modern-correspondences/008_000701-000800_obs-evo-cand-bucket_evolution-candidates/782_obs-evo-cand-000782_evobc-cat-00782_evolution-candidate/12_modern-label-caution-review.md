# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000782
...
- EVOBC candidate category: `evobc-evo-cat-00782`.
- Source label for search only: `伯`.
- Source codepoints for search only: `U+4F2F`.
