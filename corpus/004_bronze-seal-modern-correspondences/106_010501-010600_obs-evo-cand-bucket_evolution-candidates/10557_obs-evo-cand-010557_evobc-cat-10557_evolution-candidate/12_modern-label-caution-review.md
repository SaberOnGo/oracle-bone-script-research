# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010557
...
- EVOBC candidate category: `evobc-evo-cat-10557`.
- Source label for search only: `鷟`.
- Source codepoints for search only: `U+9DDF`.
