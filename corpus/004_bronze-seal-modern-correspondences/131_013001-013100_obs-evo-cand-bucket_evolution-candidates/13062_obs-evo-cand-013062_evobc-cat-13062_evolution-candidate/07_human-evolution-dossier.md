...
- External category reference: `evobc-cat-13062`
- Source category ID: `13062`
- Source label for human review: `𫭤`
- Source codepoints: `U+2BB64`
...
- `obs-evo-cand-013062-route-category-staging`
...
- `obs-evo-cand-013062-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013062-route-evolution-graph`
