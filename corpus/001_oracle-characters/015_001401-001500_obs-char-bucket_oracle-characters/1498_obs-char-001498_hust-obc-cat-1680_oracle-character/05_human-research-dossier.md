# obs-char-001498 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1498_obs-char-001498_hust-obc-cat-1680_ora
  cle-character/03_visual-assets/001_asset-001503_hust-obc-cat-1680_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1680/G_1680_合8197賓組.png`
- asset id: `asset-001503`
...
- source category: `1680`
- validation class: `1497`
- source image route: `HUST-OBC/deciphered/1680/G_1680_合8197賓組.png`
- asset id: `asset-001503`
...
- English observation: `Two separated narrow forms repeat small upper
  clusters and long curves.`
...
- dataset label text: `㪆`
- dataset label codepoints: `U+3A86`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00146`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00146`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00146`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/146_obs-evo-can
  d-000146_evobc-cat-00146_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/146_obs-evo-cand-000146_evobc-cat-00146_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合8197
  (G_1680_合8197賓組.png)`
...
- Which source records identify obs-char-001498 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001498？
