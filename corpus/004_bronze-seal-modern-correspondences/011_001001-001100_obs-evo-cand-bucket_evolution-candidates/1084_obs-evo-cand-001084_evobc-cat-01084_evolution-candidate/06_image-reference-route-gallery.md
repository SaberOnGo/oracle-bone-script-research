...
- `obs-evo-cand-001084-route-category-staging`
...
- `obs-evo-cand-001084-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001084-route-evolution-graph`
