...
- `obs-evo-cand-012727-route-category-staging`
...
- `obs-evo-cand-012727-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012727-route-evolution-graph`
