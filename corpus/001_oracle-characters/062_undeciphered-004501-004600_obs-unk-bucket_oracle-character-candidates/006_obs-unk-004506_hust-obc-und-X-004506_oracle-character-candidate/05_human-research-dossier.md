# obs-unk-004506 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004506`
- primary external id: `hust-obc-und-X-004506`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/006_obs-unk-004506_h
  ust-obc-und-X-004506_oracle-character-candidate/03_visual-assets/001_asset
  -006099_hust-obc-und-X-004506_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/62/X_？_8247_1.png`
- asset id: `asset-006099`
...
- source class: `HUST-OBC/undeciphered/X/62/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/62/X_？_8247_1.png`
- asset id: `asset-006099`
...
- English observation: `The curved band, upright traces, lower gap, and
  right bend are recorded directly.`
- 中文观察: `已直接记录上部弧形横带、竖向痕、下部间隔和右端下弯。`
...
- Which source records identify obs-unk-004506 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004506？
