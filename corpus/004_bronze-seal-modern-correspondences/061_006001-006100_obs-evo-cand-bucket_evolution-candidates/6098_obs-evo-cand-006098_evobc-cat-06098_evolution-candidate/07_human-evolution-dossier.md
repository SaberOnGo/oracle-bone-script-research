...
- External category reference: `evobc-cat-06098`
- Source category ID: `06098`
- Source label for human review: `稗`
...
- `obs-evo-cand-006098-route-category-staging`
...
- `obs-evo-cand-006098-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006098-route-evolution-graph`
