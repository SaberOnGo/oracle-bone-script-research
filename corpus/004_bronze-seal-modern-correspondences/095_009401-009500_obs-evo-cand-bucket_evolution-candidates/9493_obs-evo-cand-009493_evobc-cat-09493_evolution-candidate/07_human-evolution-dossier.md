...
Project ID: `obs-evo-cand-009493`
...
- Project ID: `obs-evo-cand-009493`
- EVOBC category candidate ID: `evobc-evo-cat-09493`
- External category reference: `evobc-cat-09493`
- Source category ID: `09493`
- Source label for human review: `鏇`
- Source codepoints: `U+93C7`
...
- `obs-evo-cand-009493-route-category-staging`
...
- `obs-evo-cand-009493-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009493-route-evolution-graph`
