# Material Visual Observation / obs-comp-cand-002212 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002212`
- External reference / 外部参照: `obimd-sub-emizdscukm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019996_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/emizdscukm/emizdscukm/emizdscukm.png`
- Checksum / 校验和:
  `7c5c8a5e0914cc7cffd7b8792ec174d5fdbdb2b54d5f2a4c60eb2d376ad73729`
...
- Marked-pixel bounds: (57,19)–(195,222); span 139 × 204 px; the marked
...
- 痕迹范围：(57,19)–(195,222)；跨度139 × 204 px；痕迹矩形高于宽。
