...
- Project ID: `obs-evo-cand-004519`
- EVOBC category candidate ID: `evobc-evo-cat-04519`
- External category reference: `evobc-cat-04519`
- Source category ID: `04519`
- Source label for human review: `汷`
- Source codepoints: `U+6C77`
...
- `obs-evo-cand-004519-route-category-staging`
...
- `obs-evo-cand-004519-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004519-route-evolution-graph`
