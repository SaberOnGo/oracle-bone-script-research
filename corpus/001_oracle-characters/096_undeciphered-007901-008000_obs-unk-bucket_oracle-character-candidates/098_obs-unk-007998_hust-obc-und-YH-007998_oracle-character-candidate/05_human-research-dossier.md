# obs-unk-007998 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-007998`
- primary external id: `hust-obc-und-YH-007998`
...
- local review image route: `corpus/001_oracle-characters/096_undeciphered-007
  901-008000_obs-unk-bucket_oracle-character-candidates/098_obs-unk-007998_h
  ust-obc-und-YH-007998_oracle-character-candidate/03_visual-assets/001_asse
  t-009589_hust-obc-und-YH-007998_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/605EC/H_？_605EC_0.png`
- asset id: `asset-009589`
...
- source class: `HUST-OBC/undeciphered/Y+H/605EC/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/605EC/H_？_605EC_0.png`
- asset id: `asset-009589`
...
- Which source records identify obs-unk-007998 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007998？
