# obs-unk-001059 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-001059`
- primary external id: `hust-obc-und-L-001059`
...
- local review image route: `corpus/001_oracle-characters/027_undeciphered-001
  001-001100_obs-unk-bucket_oracle-character-candidates/059_obs-unk-001059_h
  ust-obc-und-L-001059_oracle-character-candidate/03_visual-assets/001_asset
  -002652_hust-obc-und-L-001059_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/1059/L_？_1299.jpg`
- asset id: `asset-002652`
...
- source class: `HUST-OBC/undeciphered/L/1059/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/1059/L_？_1299.jpg`
- asset id: `asset-002652`
...
- Which source records identify obs-unk-001059 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-001059？
