# obs-char-000959 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/959_obs-char-000959_hust-obc-cat-1079_orac
  le-character/03_visual-assets/001_asset-000964_hust-obc-cat-1079_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1079/G_1079_甲骨文.png`
- asset id: `asset-000964`
...
- source category: `1079`
- validation class: `958`
- source image route: `HUST-OBC/deciphered/1079/G_1079_甲骨文.png`
- asset id: `asset-000964`
...
- English observation: `A compact upper rounded enclosure sits above a
  jagged lower branching cluster.`
...
- dataset label text: `㠭`
- dataset label codepoints: `U+382D`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/088_obs-evo-can
  d-000088_evobc-cat-00088_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/088_obs-evo-cand-000088_evobc-cat-00088_evolu
...
- Which source records identify obs-char-000959 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000959？
