...
- External category reference: `evobc-cat-08741`
- Source category ID: `08741`
- Source label for human review: `踴`
...
- `obs-evo-cand-008741-route-category-staging`
...
- `obs-evo-cand-008741-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008741-route-evolution-graph`
