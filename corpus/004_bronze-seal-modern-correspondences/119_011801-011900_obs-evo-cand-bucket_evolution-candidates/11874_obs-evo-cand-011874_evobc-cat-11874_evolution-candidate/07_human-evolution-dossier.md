...
- External category reference: `evobc-cat-11874`
- Source category ID: `11874`
- Source label for human review: `𥬇`
- Source codepoints: `U+25B07`
...
- `obs-evo-cand-011874-route-category-staging`
...
- `obs-evo-cand-011874-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011874-route-evolution-graph`
