...
- Project ID: `obs-evo-cand-010835`
- EVOBC category candidate ID: `evobc-evo-cat-10835`
- External category reference: `evobc-cat-10835`
- Source category ID: `10835`
- Source label for human review: `𠓲`
- Source codepoints: `U+204F2`
- Image reference count in source metadata: `66`
...
- `obs-evo-cand-010835-route-category-staging`
...
- `obs-evo-cand-010835-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010835-route-evolution-graph`
