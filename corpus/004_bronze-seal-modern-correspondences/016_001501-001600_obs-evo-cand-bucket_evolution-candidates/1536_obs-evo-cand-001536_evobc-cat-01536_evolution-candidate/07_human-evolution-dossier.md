...
- External category reference: `evobc-cat-01536`
- Source category ID: `01536`
...
- `obs-evo-cand-001536-route-category-staging`
...
- `obs-evo-cand-001536-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001536-route-evolution-graph`
