...
- `obs-evo-cand-005738-route-category-staging`
...
- `obs-evo-cand-005738-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005738-route-evolution-graph`
