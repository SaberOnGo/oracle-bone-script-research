# obs-unk-004782 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004782`
- primary external id: `hust-obc-und-X-004782`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/082_obs-unk-004782_h
  ust-obc-und-X-004782_oracle-character-candidate/03_visual-assets/001_asset
  -006375_hust-obc-und-X-004782_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/338/X_？_7114_1.png`
- asset id: `asset-006375`
...
- source class: `HUST-OBC/undeciphered/X/338/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/338/X_？_7114_1.png`
- asset id: `asset-006375`
...
- English observation: `long curved line with lower hook and missing views`
- 中文观察: `带下部弯钩的长曲线，仍缺少来源视图`
...
- Which source records identify obs-unk-004782 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004782？
