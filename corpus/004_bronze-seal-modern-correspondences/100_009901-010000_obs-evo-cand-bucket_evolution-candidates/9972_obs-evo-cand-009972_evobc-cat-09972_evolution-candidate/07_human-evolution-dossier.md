...
- External category reference: `evobc-cat-09972`
- Source category ID: `09972`
- Source label for human review: `順`
- Source codepoints: `U+9806`
...
- `obs-evo-cand-009972-route-category-staging`
...
- `obs-evo-cand-009972-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009972-route-evolution-graph`
