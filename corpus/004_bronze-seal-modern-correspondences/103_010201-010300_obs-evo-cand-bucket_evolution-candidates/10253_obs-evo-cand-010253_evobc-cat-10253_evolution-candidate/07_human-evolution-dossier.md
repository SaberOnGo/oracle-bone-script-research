...
- External category reference: `evobc-cat-10253`
- Source category ID: `10253`
- Source label for human review: `驕`
- Source codepoints: `U+9A55`
...
- `obs-evo-cand-010253-route-category-staging`
...
- `obs-evo-cand-010253-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010253-route-evolution-graph`
