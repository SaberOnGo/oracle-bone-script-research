# Human Research Readiness Review / 正式研究准备复核: obs-evo-cand-012067
...
- Source label for lookup only: `𦣞`.
- Source codepoints for lookup only: `U+268DE`.
- Era/source code rows to open: `8`.
