...
- Project ID: `obs-evo-cand-011869`
- EVOBC category candidate ID: `evobc-evo-cat-11869`
- External category reference: `evobc-cat-11869`
- Source category ID: `11869`
- Source label for human review: `𥫭`
- Source codepoints: `U+25AED`
- Image reference count in source metadata: `8`
...
- `obs-evo-cand-011869-route-category-staging`
...
- `obs-evo-cand-011869-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011869-route-evolution-graph`
