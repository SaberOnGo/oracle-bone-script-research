# obs-unk-005569 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005569`
- primary external id: `hust-obc-und-X-005569`
...
- local review image route: `corpus/001_oracle-characters/072_undeciphered-005
  501-005600_obs-unk-bucket_oracle-character-candidates/069_obs-unk-005569_h
  ust-obc-und-X-005569_oracle-character-candidate/03_visual-assets/001_asset
  -007162_hust-obc-und-X-005569_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1125/X_？_8081_1.png`
- asset id: `asset-007162`
...
- source class: `HUST-OBC/undeciphered/X/1125/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1125/X_？_8081_1.png`
- asset id: `asset-007162`
...
- Which source records identify obs-unk-005569 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005569？
