...
- External category reference: `evobc-cat-06529`
- Source category ID: `06529`
- Source label for human review: `絺`
...
- `obs-evo-cand-006529-route-category-staging`
...
- `obs-evo-cand-006529-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006529-route-evolution-graph`
