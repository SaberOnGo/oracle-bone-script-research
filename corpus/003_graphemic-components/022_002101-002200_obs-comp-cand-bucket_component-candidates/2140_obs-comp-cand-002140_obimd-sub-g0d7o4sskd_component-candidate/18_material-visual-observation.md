# Material Visual Observation / obs-comp-cand-002140 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002140`
- External reference / 外部参照: `obimd-sub-g0d7o4sskd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019728_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6ewkk2w7r1/g0d7o4sskd/g0d7o4sskd.png`
- Checksum / 校验和:
  `95b9e5d3f79a501674fad2cd014f9f12df1bea3ae34f1732eaaa5024016efdfb`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.93%.
- Marked-pixel bounds: (97,20)–(171,231); span 75 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.93%。
- 痕迹范围：(97,20)–(171,231)；跨度75 × 212 px；痕迹矩形高于宽。
