...
Project ID: `obs-evo-cand-011483`
...
- Project ID: `obs-evo-cand-011483`
- EVOBC category candidate ID: `evobc-evo-cat-11483`
- External category reference: `evobc-cat-11483`
- Source category ID: `11483`
- Source label for human review: `𣧒`
- Source codepoints: `U+239D2`
...
- `obs-evo-cand-011483-route-category-staging`
...
- `obs-evo-cand-011483-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011483-route-evolution-graph`
