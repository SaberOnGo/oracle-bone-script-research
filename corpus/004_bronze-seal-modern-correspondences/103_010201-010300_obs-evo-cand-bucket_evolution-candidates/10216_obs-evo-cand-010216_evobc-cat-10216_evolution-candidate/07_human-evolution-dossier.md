...
- External category reference: `evobc-cat-10216`
- Source category ID: `10216`
- Source label for human review: `騎`
...
- `obs-evo-cand-010216-route-category-staging`
...
- `obs-evo-cand-010216-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010216-route-evolution-graph`
