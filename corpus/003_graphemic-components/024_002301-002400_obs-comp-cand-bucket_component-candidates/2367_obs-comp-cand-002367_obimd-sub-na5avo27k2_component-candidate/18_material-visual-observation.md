# Material Visual Observation / obs-comp-cand-002367 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002367`
- External reference / 外部参照: `obimd-sub-na5avo27k2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020438_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/mnw7zjieww/na5avo27k2/na5avo27k2.png`
- Checksum / 校验和:
  `33f5aff5917ec028bd2a895ffdb1a5d7096017364303b24c085a11e297f44d6d`
...
- Marked-pixel bounds: (69,15)–(180,207); span 112 × 193 px; the marked
...
- 痕迹范围：(69,15)–(180,207)；跨度112 × 193 px；痕迹矩形高于宽。
