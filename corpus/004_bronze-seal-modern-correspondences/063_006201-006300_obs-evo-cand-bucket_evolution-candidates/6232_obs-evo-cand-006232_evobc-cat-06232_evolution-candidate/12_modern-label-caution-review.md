# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006232
...
- EVOBC candidate category: `evobc-evo-cat-06232`.
- Source label for search only: `笛`.
- Source codepoints for search only: `U+7B1B`.
