# Material Visual Observation / obs-comp-cand-000742 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000742`
- External reference / 外部参照: `obimd-sub-5n30uigzj6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013469_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5n30uigzj6/5n30uigzj6/012t3k765p.png`
- Checksum / 校验和:
  `e12982ce9f36ade0e32cc91939d7633dcda6f14e6505fc39823beece4286f714`
...
- Marked-pixel bounds: (99,28)–(150,221); span 52 × 194 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.86%。
- 痕迹范围：(99,28)–(150,221)；跨度52 × 194 px；痕迹矩形高于宽。
