...
Project ID: `obs-evo-cand-000699`
...
- Project ID: `obs-evo-cand-000699`
- EVOBC category candidate ID: `evobc-evo-cat-00699`
- External category reference: `evobc-cat-00699`
- Source category ID: `00699`
- Source label for human review: `亢`
- Source codepoints: `U+4EA2`
- Image reference count in source metadata: `82`
...
- `obs-evo-cand-000699-route-category-staging`
...
- `obs-evo-cand-000699-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000699-route-evolution-graph`
