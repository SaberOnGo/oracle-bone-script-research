# obs-comp-cand-000140 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000140`
- 首选外部 ID: `obimd-sub-gtadlgs1p2`
- OBIMD subcharacter UID: `gtadlgs1p2`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+F0CC2; U+F0CC3; 另有 2 项
