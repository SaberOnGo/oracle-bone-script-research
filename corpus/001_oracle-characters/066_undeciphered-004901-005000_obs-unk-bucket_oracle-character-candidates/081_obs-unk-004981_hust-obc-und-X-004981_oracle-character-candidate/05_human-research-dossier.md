# obs-unk-004981 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004981`
- primary external id: `hust-obc-und-X-004981`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/081_obs-unk-004981_h
  ust-obc-und-X-004981_oracle-character-candidate/03_visual-assets/001_asset
  -006574_hust-obc-und-X-004981_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/537/X_？_7133_1.png`
- asset id: `asset-006574`
...
- Three separated stroke groups and a central upper opening are visible.
...
- source class: `HUST-OBC/undeciphered/X/537/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/537/X_？_7133_1.png`
- asset id: `asset-006574`
...
- Which source records identify obs-unk-004981 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004981？
