# obs-unk-004290 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/090_obs-unk-004290_h
  ust-obc-und-L-004290_oracle-character-candidate/03_visual-assets/001_asset
  -005883_hust-obc-und-L-004290_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4290/L_？_9470.jpg`
- asset id: `asset-005883`
...
- source class: `HUST-OBC/undeciphered/L/4290/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4290/L_？_9470.jpg`
- asset id: `asset-005883`
...
- English observation: `Upper traces, central descent, lower stack visible.`
- 中文观察: `上部痕迹、中央下行线和下部层叠痕迹可见。`
...
- Which source records identify obs-unk-004290 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004290？
