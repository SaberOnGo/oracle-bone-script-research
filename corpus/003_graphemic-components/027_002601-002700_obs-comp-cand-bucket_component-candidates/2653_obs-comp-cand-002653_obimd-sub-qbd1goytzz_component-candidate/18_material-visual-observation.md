# Material Visual Observation / obs-comp-cand-002653 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002653`
- External reference / 外部参照: `obimd-sub-qbd1goytzz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021229_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qbd1goytzz/qbd1goytzz/qbd1goytzz.png`
- Checksum / 校验和:
  `8fda90500509310d822c8055fecbb74e0a5a7342649e6eff1a85f4d9dd4fbb28`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.08%.
- Marked-pixel bounds: (72,31)–(177,220); span 106 × 190 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.08%。
- 痕迹范围：(72,31)–(177,220)；跨度106 × 190 px；痕迹矩形高于宽。
