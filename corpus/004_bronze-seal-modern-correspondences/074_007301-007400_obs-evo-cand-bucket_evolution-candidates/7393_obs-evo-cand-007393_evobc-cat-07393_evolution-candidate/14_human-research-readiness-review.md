# Human Research Readiness Review / 正式研究准备复核: obs-evo-cand-007393
...
- Source label for lookup only: `莫`.
- Source codepoints for lookup only: `U+83AB`.
- Era/source code rows to open: `13`.
