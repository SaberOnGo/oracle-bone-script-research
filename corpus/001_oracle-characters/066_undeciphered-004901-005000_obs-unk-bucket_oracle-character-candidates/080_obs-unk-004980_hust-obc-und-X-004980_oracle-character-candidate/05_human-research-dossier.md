# obs-unk-004980 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004980`
- primary external id: `hust-obc-und-X-004980`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/080_obs-unk-004980_h
  ust-obc-und-X-004980_oracle-character-candidate/03_visual-assets/001_asset
  -006573_hust-obc-und-X-004980_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/536/X_？_7516_1.png`
- asset id: `asset-006573`
...
- One of five expected views was opened; a central opening and lower branches
  are visible.
- 直接记录：`14_material-visual-observation.md`
- 五个预期视图中当前打开一个，可见中央开口和下部分枝。
- The remaining source views are a concrete follow-up requirement.
- 其余来源视图是明确的后续待查项。
...
- source class: `HUST-OBC/undeciphered/X/536/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/536/X_？_7516_1.png`
- asset id: `asset-006573`
...
- Which source records identify obs-unk-004980 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004980？
