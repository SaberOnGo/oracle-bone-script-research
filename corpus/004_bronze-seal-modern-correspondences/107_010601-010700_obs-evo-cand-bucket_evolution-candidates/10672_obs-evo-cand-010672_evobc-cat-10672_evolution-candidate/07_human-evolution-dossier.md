...
- External category reference: `evobc-cat-10672`
- Source category ID: `10672`
- Source label for human review: `黽`
- Source codepoints: `U+9EFD`
...
- `obs-evo-cand-010672-route-category-staging`
...
- `obs-evo-cand-010672-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010672-route-evolution-graph`
