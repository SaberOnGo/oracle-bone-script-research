...
- External category reference: `evobc-cat-08166`
- Source category ID: `08166`
- Source label for human review: `詃`
- Source codepoints: `U+8A43`
...
- `obs-evo-cand-008166-route-category-staging`
...
- `obs-evo-cand-008166-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008166-route-evolution-graph`
