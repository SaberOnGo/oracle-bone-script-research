# Material Visual Observation / obs-comp-cand-000702 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000702`
- External reference / 外部参照: `obimd-sub-p6uj3n0aze`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013301_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/p6uj3n0aze/p6uj3n0aze/2j1ndxubsk.png`
- Checksum / 校验和:
  `a76d5afb2c16d3869d9467b7df15884e2dce54876159efc2cc8678c05f4c6246`
...
- Marked-pixel bounds: (98,27)–(151,222); span 54 × 196 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.43%。
- 痕迹范围：(98,27)–(151,222)；跨度54 × 196 px；痕迹矩形高于宽。
