...
Project ID: `obs-evo-cand-004634`
...
- Project ID: `obs-evo-cand-004634`
- EVOBC category candidate ID: `evobc-evo-cat-04634`
- External category reference: `evobc-cat-04634`
- Source category ID: `04634`
- Source label for human review: `洫`
- Source codepoints: `U+6D2B`
...
- `obs-evo-cand-004634-route-category-staging`
...
- `obs-evo-cand-004634-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004634-route-evolution-graph`
