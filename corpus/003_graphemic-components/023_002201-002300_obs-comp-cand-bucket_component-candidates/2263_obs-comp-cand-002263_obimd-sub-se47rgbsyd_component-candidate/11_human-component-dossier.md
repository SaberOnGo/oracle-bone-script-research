# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-002263
...
- candidate_component_id: `obs-comp-cand-002263`
- primary_external_ref_id: `obimd-sub-se47rgbsyd`
- source_subcharacter_uid: `se47rgbsyd`
- source_main_character_uid: `se47rgbsyd`
- main_character_external_ref_id: `obimd-main-se47rgbsyd`
...
- glyph_codepoint_uplus_sample: `U+B292A;U+FCFE8, U+FCFE9`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-020076` | `001_asset-020076_img.png` | `99e2dd1b60bfc0a3176ffe50d8f8693854f54f908fe6c01da158351cdb5038f5` |
