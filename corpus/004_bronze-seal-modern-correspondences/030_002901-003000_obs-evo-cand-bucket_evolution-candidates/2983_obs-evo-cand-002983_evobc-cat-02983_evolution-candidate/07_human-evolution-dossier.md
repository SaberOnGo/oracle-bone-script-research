...
- Project ID: `obs-evo-cand-002983`
- EVOBC category candidate ID: `evobc-evo-cat-02983`
- External category reference: `evobc-cat-02983`
- Source category ID: `02983`
- Source label for human review: `恨`
- Source codepoints: `U+6068`
...
- `obs-evo-cand-002983-route-category-staging`
...
- `obs-evo-cand-002983-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002983-route-evolution-graph`
