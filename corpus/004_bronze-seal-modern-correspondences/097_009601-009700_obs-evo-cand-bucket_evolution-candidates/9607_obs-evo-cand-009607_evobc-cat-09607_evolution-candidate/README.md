# obs-evo-cand-009607 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-009607`
- EVOBC category candidate ID: `evobc-evo-cat-09607`
- External category ref: `evobc-cat-09607`
- Source label: `長`
- Source codepoints: `U+9577`
- Image reference count: `244`
- Era token counts: `BI:36;CS:1;OBC:50;SAC:7;SS:3;WSC:147`
- Source token counts: `Book:102;Web:142`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 50 image references
- era 1 / BI: 36 image references
- era 2 / SS: 3 image references
- era 3 / SAC: 7 image references
- era 4 / WSC: 147 image references
- era 5 / CS: 1 image references
- source 0 / Web:1633: 1 image references
- source 1 / Web:105952;說文Web:58: 117 image references
- source 2 / Book:17600: 9 image references
- source 3 / Book:21681: 18 image references
- source 4 / Book:9131: 7 image references
- source 5 / Book:32794: 57 image references
