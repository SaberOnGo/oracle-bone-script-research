...
- External category reference: `evobc-cat-03796`
- Source category ID: `03796`
- Source label for human review: `曉`
- Source codepoints: `U+66C9`
...
- `obs-evo-cand-003796-route-category-staging`
...
- `obs-evo-cand-003796-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003796-route-evolution-graph`
