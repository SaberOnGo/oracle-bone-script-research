# Material Visual Observation / obs-comp-cand-000155 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000155`
- External reference / 外部参照: `obimd-sub-2ap0g2qb4d`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011567_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/x9y4slwu2b/2ap0g2qb4d/2ap0g2qb4d.png`
- Checksum / 校验和:
  `90649a1112678d41765707b143367b3c3ce0d6904aa42ac7a59cbbdf20ccb8b4`
...
- Marked-pixel bounds: (93,51)–(156,213); span 64 × 163 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.25%。
- 痕迹范围：(93,51)–(156,213)；跨度64 × 163 px；痕迹矩形高于宽。
