# obs-char-000218 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000218`
- primary external id: `hust-obc-cat-0242`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/218_obs-char-000218_hust-obc-cat-0242_orac
  le-character/03_visual-assets/001_asset-000223_hust-obc-cat-0242_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0242/G_0242_前4.30.3合18453.png`
- asset id: `asset-000223`
...
- source category: `0242`
- validation class: `217`
- source image route: `HUST-OBC/deciphered/0242/G_0242_前4.30.3合18453.png`
- asset id: `asset-000223`
...
- English observation: `The image has a long curved stroke on the left and
  an elongated right frame containing crossing diagonal and horizontal
  strokes.`
- 中文观察: `图像左侧有长弯曲笔，右侧为长形框，内部含斜向和横向交叉笔。`
...
- dataset label text: `㓨`
- dataset label codepoints: `U+34E8`
...
- filename catalog route clues: `Heji-like filename clue: 合18453
  (G_0242_前4.30.3合18453.png)`
...
- Which source records identify obs-char-000218 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000218？
