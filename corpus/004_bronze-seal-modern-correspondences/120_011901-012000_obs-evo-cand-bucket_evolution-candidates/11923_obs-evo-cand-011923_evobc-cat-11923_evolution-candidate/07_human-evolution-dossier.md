...
- Project ID: `obs-evo-cand-011923`
- EVOBC category candidate ID: `evobc-evo-cat-11923`
- External category reference: `evobc-cat-11923`
- Source category ID: `11923`
- Source label for human review: `𥼚`
- Source codepoints: `U+25F1A`
...
- `obs-evo-cand-011923-route-category-staging`
...
- `obs-evo-cand-011923-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011923-route-evolution-graph`
