# obs-unk-004847 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004847`
- primary external id: `hust-obc-und-X-004847`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/047_obs-unk-004847_h
  ust-obc-und-X-004847_oracle-character-candidate/03_visual-assets/001_asset
  -006440_hust-obc-und-X-004847_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/403/X_？_7389_1.png`
- asset id: `asset-006440`
...
- source class: `HUST-OBC/undeciphered/X/403/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/403/X_？_7389_1.png`
- asset id: `asset-006440`
...
- English observation: `central curve, lower outline, and detached stroke`
- 中文观察: `中部曲线、下部围合和分离竖笔`
...
- Which source records identify obs-unk-004847 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004847？
