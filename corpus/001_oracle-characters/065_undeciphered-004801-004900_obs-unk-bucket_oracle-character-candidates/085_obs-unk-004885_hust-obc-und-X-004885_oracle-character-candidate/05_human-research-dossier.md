# obs-unk-004885 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004885`
- primary external id: `hust-obc-und-X-004885`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/085_obs-unk-004885_h
  ust-obc-und-X-004885_oracle-character-candidate/03_visual-assets/001_asset
  -006478_hust-obc-und-X-004885_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/441/X_？_7423_1.png`
- asset id: `asset-006478`
...
- source class: `HUST-OBC/undeciphered/X/441/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/441/X_？_7423_1.png`
- asset id: `asset-006478`
...
- English observation: `winding central stroke and separated side groups`
- 中文观察: `中央弯曲长笔画和分开的侧部结构`
...
- Which source records identify obs-unk-004885 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004885？
