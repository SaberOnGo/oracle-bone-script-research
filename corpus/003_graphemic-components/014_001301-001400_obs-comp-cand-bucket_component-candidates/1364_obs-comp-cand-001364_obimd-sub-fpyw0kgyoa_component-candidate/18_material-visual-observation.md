# Material Visual Observation / obs-comp-cand-001364 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001364`
- External reference / 外部参照: `obimd-sub-fpyw0kgyoa`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015783_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5i4ba39u9k/fpyw0kgyoa/fpyw0kgyoa.png`
- Checksum / 校验和:
  `fb49f5763f04d510df04c2e96b36e1934ed69741b0394f51a17bd18153903241`
...
- Marked-pixel bounds: (86,21)–(162,225); span 77 × 205 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.66%。
- 痕迹范围：(86,21)–(162,225)；跨度77 × 205 px；痕迹矩形高于宽。
