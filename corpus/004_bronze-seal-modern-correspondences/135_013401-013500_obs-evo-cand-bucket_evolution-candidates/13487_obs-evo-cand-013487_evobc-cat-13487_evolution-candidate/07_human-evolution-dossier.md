...
- External category reference: `evobc-cat-13487`
- Source category ID: `13487`
- Source label for human review: `𭇷`
- Source codepoints: `U+2D1F7`
...
- `obs-evo-cand-013487-route-category-staging`
...
- `obs-evo-cand-013487-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013487-route-evolution-graph`
