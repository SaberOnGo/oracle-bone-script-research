# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001844
...
- EVOBC candidate category: `evobc-evo-cat-01844`.
- Source label for search only: `型`.
- Source codepoints for search only: `U+578B`.
