...
- External category reference: `evobc-cat-10740`
- Source category ID: `10740`
- Source label for human review: `齹`
- Source codepoints: `U+9F79`
...
- `obs-evo-cand-010740-route-category-staging`
...
- `obs-evo-cand-010740-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010740-route-evolution-graph`
