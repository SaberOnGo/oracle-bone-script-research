# obs-unk-004742 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/042_obs-unk-004742_h
  ust-obc-und-X-004742_oracle-character-candidate/03_visual-assets/001_asset
  -006335_hust-obc-und-X-004742_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/298/X_？_7282_1.png`
- asset id: `asset-006335`
...
- source class: `HUST-OBC/undeciphered/X/298/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/298/X_？_7282_1.png`
- asset id: `asset-006335`
...
- English observation: `vertical stroke with side projections and openings`
- 中文观察: `带侧向突出和开口的竖向笔画`
...
- Which source records identify obs-unk-004742 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004742？
