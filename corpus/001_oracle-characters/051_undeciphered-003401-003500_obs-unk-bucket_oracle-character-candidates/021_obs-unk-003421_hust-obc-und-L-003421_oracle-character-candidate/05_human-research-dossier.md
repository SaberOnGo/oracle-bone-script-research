# obs-unk-003421 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003421`
- primary external id: `hust-obc-und-L-003421`
...
- local review image route: `corpus/001_oracle-characters/051_undeciphered-003
  401-003500_obs-unk-bucket_oracle-character-candidates/021_obs-unk-003421_h
  ust-obc-und-L-003421_oracle-character-candidate/03_visual-assets/001_asset
  -005014_hust-obc-und-L-003421_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3421/L_？_6559.jpg`
- asset id: `asset-005014`
...
- source class: `HUST-OBC/undeciphered/L/3421/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3421/L_？_6559.jpg`
- asset id: `asset-005014`
...
- Which source records identify obs-unk-003421 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003421？
