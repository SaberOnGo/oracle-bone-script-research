# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004617
...
- EVOBC candidate category: `evobc-evo-cat-04617`.
- Source label for search only: `洏`.
- Source codepoints for search only: `U+6D0F`.
