# Material Visual Observation / obs-comp-cand-001023 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001023`
- External reference / 外部参照: `obimd-sub-7dov2iw6pr`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014505_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/50z922qja8/7dov2iw6pr/7dov2iw6pr.png`
- Checksum / 校验和:
  `681e86a310d37c88782ffe28bead478a81f5820ef08997768170d9a751ad2fe0`
...
- Marked-pixel bounds: (59,57)–(188,192); span 130 × 136 px; the marked
...
- 痕迹范围：(59,57)–(188,192)；跨度130 × 136 px；痕迹矩形近方形。
