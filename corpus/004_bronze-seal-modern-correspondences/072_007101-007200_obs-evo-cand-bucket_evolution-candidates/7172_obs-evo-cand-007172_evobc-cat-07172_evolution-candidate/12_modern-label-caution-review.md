# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-007172
...
- EVOBC candidate category: `evobc-evo-cat-07172`.
- Source label for search only: `致`.
- Source codepoints for search only: `U+81F4`.
