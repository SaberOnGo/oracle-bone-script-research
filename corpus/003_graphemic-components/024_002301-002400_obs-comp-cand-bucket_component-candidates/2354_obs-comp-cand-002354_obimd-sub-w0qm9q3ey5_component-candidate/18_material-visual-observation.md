# Material Visual Observation / obs-comp-cand-002354 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002354`
- External reference / 外部参照: `obimd-sub-w0qm9q3ey5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020425_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/w0qm9q3ey5/w0qm9q3ey5/w0qm9q3ey5.png`
- Checksum / 校验和:
  `98cac9254c64395484eed590398f4eb38671ac0845f2ef506cb874840627cea1`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.92%.
- Marked-pixel bounds: (74,33)–(180,215); span 107 × 183 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.92%。
- 痕迹范围：(74,33)–(180,215)；跨度107 × 183 px；痕迹矩形高于宽。
