...
- External category reference: `evobc-cat-03979`
- Source category ID: `03979`
- Source label for human review: `柴`
...
- `obs-evo-cand-003979-route-category-staging`
...
- `obs-evo-cand-003979-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003979-route-evolution-graph`
