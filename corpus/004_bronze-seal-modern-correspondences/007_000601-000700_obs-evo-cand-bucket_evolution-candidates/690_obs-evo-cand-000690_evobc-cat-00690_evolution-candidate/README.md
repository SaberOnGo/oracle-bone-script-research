# obs-evo-cand-000690 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-00690`
- Source label: `五`
- Source codepoints: `U+4E94`
- Image reference count: `274`
- Era token counts: `BI:96;CS:2;OBC:33;SAC:8;SS:3;WSC:132`
- Source token counts: `Book:133;Web:141`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 33 image references
- era 1 / BI: 96 image references
- era 2 / SS: 3 image references
- era 3 / SAC: 8 image references
- era 4 / WSC: 132 image references
- era 5 / CS: 2 image references
- source 1 / Web:105952;說文Web:58: 141 image references
