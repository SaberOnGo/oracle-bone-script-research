# obs-unk-004777 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004777`
- primary external id: `hust-obc-und-X-004777`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/077_obs-unk-004777_h
  ust-obc-und-X-004777_oracle-character-candidate/03_visual-assets/001_asset
  -006370_hust-obc-und-X-004777_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/333/X_？_7317_1.png`
- asset id: `asset-006370`
...
- source class: `HUST-OBC/undeciphered/X/333/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/333/X_？_7317_1.png`
- asset id: `asset-006370`
...
- English observation: `repeated upper openings and two lower terminals`
- 中文观察: `重复的上部开口和两个下部末端`
...
- Which source records identify obs-unk-004777 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004777？
