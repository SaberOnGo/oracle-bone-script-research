# obs-char-001141 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001141`
- primary external id: `hust-obc-cat-1275`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1141_obs-char-001141_hust-obc-cat-1275_ora
  cle-character/03_visual-assets/001_asset-001146_hust-obc-cat-1275_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1275/G_1275_乙1111合9514.png`
- asset id: `asset-001146`
...
- source category: `1275`
- validation class: `1140`
- source image route: `HUST-OBC/deciphered/1275/G_1275_乙1111合9514.png`
- asset id: `asset-001146`
...
- English observation: `A slender upright stroke rises from a small angled
  lower cluster, with a pointed upper branch and a short lower hook.`
- 中文观察: `狭长直立笔画从小型斜向下部组合中上升，顶部有尖状分枝，下部有短钩笔。`
...
- dataset label text: `㣱`
- dataset label codepoints: `U+38F1`
...
- filename catalog route clues: `Heji-like filename clue: 合9514
  (G_1275_乙1111合9514.png)`
...
- Which source records identify obs-char-001141 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001141？
