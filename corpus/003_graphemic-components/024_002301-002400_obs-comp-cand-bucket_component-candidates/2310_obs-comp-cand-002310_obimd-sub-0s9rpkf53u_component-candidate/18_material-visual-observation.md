# Material Visual Observation / obs-comp-cand-002310 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002310`
- External reference / 外部参照: `obimd-sub-0s9rpkf53u`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020329_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0s9rpkf53u/0s9rpkf53u/0s9rpkf53u.png`
- Checksum / 校验和:
  `df1f16f657ec5b41a4c9646f4eca6a7471b02980faa4bd804ba842a46286092a`
...
- Marked-pixel bounds: (70,33)–(179,213); span 110 × 181 px; the marked
...
- 痕迹范围：(70,33)–(179,213)；跨度110 × 181 px；痕迹矩形高于宽。
