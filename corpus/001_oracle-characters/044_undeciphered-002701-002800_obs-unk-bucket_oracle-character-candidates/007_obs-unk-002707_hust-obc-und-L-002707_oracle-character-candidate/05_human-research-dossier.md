# obs-unk-002707 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/044_undeciphered-002
  701-002800_obs-unk-bucket_oracle-character-candidates/007_obs-unk-002707_h
  ust-obc-und-L-002707_oracle-character-candidate/03_visual-assets/001_asset
  -004300_hust-obc-und-L-002707_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2707/L_？_4299.jpg`
- asset id: `asset-004300`
...
- source class: `HUST-OBC/undeciphered/L/2707/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2707/L_？_4299.jpg`
- asset id: `asset-004300`
...
- Which source records identify obs-unk-002707 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002707？
