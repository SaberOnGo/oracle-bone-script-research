# Material Visual Observation / obs-comp-cand-002637 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002637`
- External reference / 外部参照: `obimd-sub-wzqaeg6y2w`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021176_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wzqaeg6y2w/wzqaeg6y2w/wzqaeg6y2w.png`
- Checksum / 校验和:
  `f5319ed943d074bcdfa0bdb67525a79ff040cd835e488c7c9219469139bba858`
...
- Marked-pixel bounds: (81,41)–(183,203); span 103 × 163 px; the marked
...
- 痕迹范围：(81,41)–(183,203)；跨度103 × 163 px；痕迹矩形高于宽。
