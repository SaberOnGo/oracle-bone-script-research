...
Project ID: `obs-insc-cw-cand-000522`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000522`
...
- Yingguo / 英国所藏: `y2510` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `354` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `518` in source row; primary catalog entry pending
- Heji / 合集: `41717` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000522`
