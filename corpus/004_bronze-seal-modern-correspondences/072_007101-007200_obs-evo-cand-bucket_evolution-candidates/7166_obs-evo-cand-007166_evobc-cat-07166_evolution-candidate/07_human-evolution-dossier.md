...
Project ID: `obs-evo-cand-007166`
...
- Project ID: `obs-evo-cand-007166`
- EVOBC category candidate ID: `evobc-evo-cat-07166`
- External category reference: `evobc-cat-07166`
- Source category ID: `07166`
- Source label for human review: `臫`
- Source codepoints: `U+81EB`
...
- `obs-evo-cand-007166-route-category-staging`
...
- `obs-evo-cand-007166-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007166-route-evolution-graph`
