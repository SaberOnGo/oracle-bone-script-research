...
Project ID: `obs-evo-cand-000465`
...
- Project ID: `obs-evo-cand-000465`
- EVOBC category candidate ID: `evobc-evo-cat-00465`
- External category reference: `evobc-cat-00465`
- Source category ID: `00465`
- Source label for human review: `䡈`
- Source codepoints: `U+4848`
...
- `obs-evo-cand-000465-route-category-staging`
...
- `obs-evo-cand-000465-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000465-route-evolution-graph`
