...
- External category reference: `evobc-cat-08263`
- Source category ID: `08263`
- Source label for human review: `諈`
...
- `obs-evo-cand-008263-route-category-staging`
...
- `obs-evo-cand-008263-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008263-route-evolution-graph`
