...
- External category reference: `evobc-cat-03234`
- Source category ID: `03234`
- Source label for human review: `戾`
...
- `obs-evo-cand-003234-route-category-staging`
...
- `obs-evo-cand-003234-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003234-route-evolution-graph`
