...
- External category reference: `evobc-cat-11316`
- Source category ID: `11316`
- Source label: `𢶒`
...
- `obs-evo-cand-011316-route-category-staging`
...
- `obs-evo-cand-011316-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011316-route-evolution-graph`
