...
Project ID: `obs-evo-cand-006805`
...
- Project ID: `obs-evo-cand-006805`
- EVOBC category candidate ID: `evobc-evo-cat-06805`
- External category reference: `evobc-cat-06805`
- Source category ID: `06805`
- Source label for human review: `罝`
- Source codepoints: `U+7F5D`
- Image reference count in source metadata: `62`
...
- `obs-evo-cand-006805-route-category-staging`
...
- `obs-evo-cand-006805-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006805-route-evolution-graph`
