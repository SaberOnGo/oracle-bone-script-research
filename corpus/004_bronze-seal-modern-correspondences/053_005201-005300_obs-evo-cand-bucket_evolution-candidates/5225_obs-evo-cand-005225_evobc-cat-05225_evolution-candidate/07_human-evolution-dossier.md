...
- External category reference: `evobc-cat-05225`
- Source category ID: `05225`
- Source label for human review: `犀`
...
- `obs-evo-cand-005225-route-category-staging`
...
- `obs-evo-cand-005225-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005225-route-evolution-graph`
