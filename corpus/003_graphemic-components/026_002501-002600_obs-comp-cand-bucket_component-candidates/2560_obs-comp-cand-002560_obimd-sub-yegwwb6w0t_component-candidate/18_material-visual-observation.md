# Material Visual Observation / obs-comp-cand-002560 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002560`
- External reference / 外部参照: `obimd-sub-yegwwb6w0t`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021092_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cc3pkwk0li/yegwwb6w0t/yegwwb6w0t.png`
- Checksum / 校验和:
  `82968d6bb72b16250d053b041dfdfabdbb71e3bccbfef4bce3e7790ac6cb3f61`
...
- Marked-pixel bounds: (89,37)–(164,212); span 76 × 176 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.69%。
- 痕迹范围：(89,37)–(164,212)；跨度76 × 176 px；痕迹矩形高于宽。
