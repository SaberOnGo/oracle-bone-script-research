...
- External category reference: `evobc-cat-01060`
- Source category ID: `01060`
- Source label for human review: `儻`
...
- `obs-evo-cand-001060-route-category-staging`
...
- `obs-evo-cand-001060-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001060-route-evolution-graph`
