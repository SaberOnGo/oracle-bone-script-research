...
- External category reference: `evobc-cat-09856`
- Source category ID: `09856`
- Source label: `霎`
...
- `obs-evo-cand-009856-route-category-staging`
...
- `obs-evo-cand-009856-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-009856-route-evolution-graph`
