# obs-char-000444 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000444`
- primary external id: `hust-obc-cat-0504`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/444_obs-char-000444_hust-obc-cat-0504_orac
  le-character/03_visual-assets/001_asset-000449_hust-obc-cat-0504_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0504/G_0504_乙7312合1086賓組.png`
- asset id: `asset-000449`
...
- source category: `0504`
- validation class: `443`
- source image route: `HUST-OBC/deciphered/0504/G_0504_乙7312合1086賓組.png`
- asset id: `asset-000449`
...
- English observation: `A dense branching cluster at left is separated from
  a smaller narrow zigzag form at right; several fine stroke boundaries are
  difficult to resolve.`
- 中文观察: `左侧密集分支笔画群与右侧较小狭长折线形分离，若干纤细笔画边界难以辨清。`
...
- dataset label text: `㗮`
- dataset label codepoints: `U+35EE`
...
- filename catalog route clues: `Heji-like filename clue: 合1086
  (G_0504_乙7312合1086賓組.png)`
...
- Which source records identify obs-char-000444 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000444？
