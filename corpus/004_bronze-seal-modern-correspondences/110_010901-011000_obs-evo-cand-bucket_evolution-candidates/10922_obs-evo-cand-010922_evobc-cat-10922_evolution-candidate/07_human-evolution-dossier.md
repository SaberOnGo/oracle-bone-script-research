...
- External category reference: `evobc-cat-10922`
- Source category ID: `10922`
- Source label for human review: `𠭉`
...
- `obs-evo-cand-010922-route-category-staging`
...
- `obs-evo-cand-010922-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010922-route-evolution-graph`
