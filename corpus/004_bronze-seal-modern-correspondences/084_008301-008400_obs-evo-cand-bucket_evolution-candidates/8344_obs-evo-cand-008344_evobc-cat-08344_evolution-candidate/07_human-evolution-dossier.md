...
- External category reference: `evobc-cat-08344`
- Source category ID: `08344`
- Source label for human review: `譁`
...
- `obs-evo-cand-008344-route-category-staging`
...
- `obs-evo-cand-008344-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008344-route-evolution-graph`
