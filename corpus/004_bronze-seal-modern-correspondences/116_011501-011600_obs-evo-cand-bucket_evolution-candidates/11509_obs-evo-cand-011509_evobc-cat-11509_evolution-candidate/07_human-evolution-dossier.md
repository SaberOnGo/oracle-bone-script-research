...
Project ID: `obs-evo-cand-011509`
...
- Project ID: `obs-evo-cand-011509`
- EVOBC category candidate ID: `evobc-evo-cat-11509`
- External category reference: `evobc-cat-11509`
- Source category ID: `11509`
- Source label for human review: `𣱷`
- Source codepoints: `U+23C77`
...
- `obs-evo-cand-011509-route-category-staging`
...
- `obs-evo-cand-011509-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011509-route-evolution-graph`
