...
Project ID: `obs-evo-cand-009029`
...
- Project ID: `obs-evo-cand-009029`
- EVOBC category candidate ID: `evobc-evo-cat-09029`
- External category reference: `evobc-cat-09029`
- Source category ID: `09029`
- Source label for human review: `過`
- Source codepoints: `U+904E`
...
- `obs-evo-cand-009029-route-category-staging`
...
- `obs-evo-cand-009029-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009029-route-evolution-graph`
