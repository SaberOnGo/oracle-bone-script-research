...
- `obs-evo-cand-006562-route-category-staging`
...
- `obs-evo-cand-006562-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006562-route-evolution-graph`
