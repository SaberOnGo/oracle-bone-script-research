...
- `obs-evo-cand-005456-route-category-staging`
...
- `obs-evo-cand-005456-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005456-route-evolution-graph`
