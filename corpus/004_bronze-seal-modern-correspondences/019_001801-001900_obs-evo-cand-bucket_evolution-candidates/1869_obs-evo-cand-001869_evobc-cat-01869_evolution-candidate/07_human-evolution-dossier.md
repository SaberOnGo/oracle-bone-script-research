...
Project ID: `obs-evo-cand-001869`
...
- Project ID: `obs-evo-cand-001869`
- EVOBC category candidate ID: `evobc-evo-cat-01869`
- External category reference: `evobc-cat-01869`
- Source category ID: `01869`
- Source label for human review: `埃`
- Source codepoints: `U+57C3`
...
- `obs-evo-cand-001869-route-category-staging`
...
- `obs-evo-cand-001869-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001869-route-evolution-graph`
