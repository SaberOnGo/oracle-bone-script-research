# obs-char-000770 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/770_obs-char-000770_hust-obc-cat-0874_orac
  le-character/03_visual-assets/001_asset-000775_hust-obc-cat-0874_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0874/G_0874_前4.45.3(甲).png`
- asset id: `asset-000775`
...
- source category: `0874`
- validation class: `769`
- source image route: `HUST-OBC/deciphered/0874/G_0874_前4.45.3(甲).png`
- asset id: `asset-000775`
...
- English observation: `The tiny faint image forms a narrow vertical stack
  with a small radiating top, several middle bends or openings, and forked
  angular strokes below; fine joins remain unclear.`
...
- dataset label text: `㝠`
- dataset label codepoints: `U+3760`
...
- Which source records identify obs-char-000770 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000770？
