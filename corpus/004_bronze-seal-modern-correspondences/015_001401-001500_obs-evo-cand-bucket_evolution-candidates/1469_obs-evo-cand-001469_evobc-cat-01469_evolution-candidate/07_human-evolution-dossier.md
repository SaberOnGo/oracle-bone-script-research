...
- External category reference: `evobc-cat-01469`
- Source category ID: `01469`
- Source label for human review: `叢`
- Source codepoints: `U+53E2`
...
- `obs-evo-cand-001469-route-category-staging`
...
- `obs-evo-cand-001469-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001469-route-evolution-graph`
