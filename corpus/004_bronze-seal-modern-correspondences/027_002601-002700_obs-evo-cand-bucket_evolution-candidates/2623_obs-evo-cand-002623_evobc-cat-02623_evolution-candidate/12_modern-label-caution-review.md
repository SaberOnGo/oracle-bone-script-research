# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002623
...
- EVOBC candidate category: `evobc-evo-cat-02623`.
- Source label for search only: `差`.
- Source codepoints for search only: `U+5DEE`.
