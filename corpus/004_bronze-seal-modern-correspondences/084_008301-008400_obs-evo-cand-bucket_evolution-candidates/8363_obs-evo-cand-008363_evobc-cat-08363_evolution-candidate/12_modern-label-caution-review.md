# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008363
...
- EVOBC candidate category: `evobc-evo-cat-08363`.
- Source label for search only: `譜`.
- Source codepoints for search only: `U+8B5C`.
