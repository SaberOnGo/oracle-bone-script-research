...
- External category reference: `evobc-cat-03362`
- Source category ID: `03362`
- Source label for human review: `捄`
- Source codepoints: `U+6344`
...
- `obs-evo-cand-003362-route-category-staging`
...
- `obs-evo-cand-003362-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003362-route-evolution-graph`
