...
- External category reference: `evobc-cat-09832`
- Source category ID: `09832`
- Source label for human review: `雥`
...
- `obs-evo-cand-009832-route-category-staging`
...
- `obs-evo-cand-009832-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009832-route-evolution-graph`
