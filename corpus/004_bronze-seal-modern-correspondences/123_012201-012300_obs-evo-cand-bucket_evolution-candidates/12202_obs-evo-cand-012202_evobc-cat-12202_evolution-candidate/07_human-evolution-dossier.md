...
- External category reference: `evobc-cat-12202`
- Source category ID: `12202`
- Source label for human review: `𧞯`
...
- `obs-evo-cand-012202-route-category-staging`
...
- `obs-evo-cand-012202-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012202-route-evolution-graph`
