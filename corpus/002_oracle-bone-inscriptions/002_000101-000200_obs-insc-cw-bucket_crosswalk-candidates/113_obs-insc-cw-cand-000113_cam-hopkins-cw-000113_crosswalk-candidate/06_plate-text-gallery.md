...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000113` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y616` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `157` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `613` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `39934` [route_present_image_or_text_not_collected]
