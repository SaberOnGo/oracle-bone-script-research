...
- External category reference: `evobc-cat-10003`
- Source category ID: `10003`
- Source label for human review: `頷`
- Source codepoints: `U+9837`
...
- `obs-evo-cand-010003-route-category-staging`
...
- `obs-evo-cand-010003-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010003-route-evolution-graph`
