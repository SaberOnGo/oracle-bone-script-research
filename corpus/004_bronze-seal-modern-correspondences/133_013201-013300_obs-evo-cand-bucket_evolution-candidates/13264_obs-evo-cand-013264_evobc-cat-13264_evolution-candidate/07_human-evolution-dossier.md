...
Project ID: `obs-evo-cand-013264`
...
- Project ID: `obs-evo-cand-013264`
- EVOBC category candidate ID: `evobc-evo-cat-13264`
- External category reference: `evobc-cat-13264`
- Source category ID: `13264`
- Source label for human review: `𬒣`
- Source codepoints: `U+2C4A3`
...
- `obs-evo-cand-013264-route-category-staging`
...
- `obs-evo-cand-013264-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013264-route-evolution-graph`
