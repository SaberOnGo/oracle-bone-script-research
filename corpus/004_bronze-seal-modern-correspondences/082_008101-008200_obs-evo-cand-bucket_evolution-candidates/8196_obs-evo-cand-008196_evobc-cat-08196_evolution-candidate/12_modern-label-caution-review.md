# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008196
...
- EVOBC candidate category: `evobc-evo-cat-08196`.
- Source label for search only: `詭`.
- Source codepoints for search only: `U+8A6D`.
