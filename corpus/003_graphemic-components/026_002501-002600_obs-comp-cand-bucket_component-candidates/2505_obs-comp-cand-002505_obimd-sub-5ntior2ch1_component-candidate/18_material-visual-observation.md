# Material Visual Observation / obs-comp-cand-002505 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002505`
- External reference / 外部参照: `obimd-sub-5ntior2ch1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020776_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5ntior2ch1/5ntior2ch1/5ntior2ch1.png`
- Checksum / 校验和:
  `c39dcca3d49d23348473116fd48fb2cb5ced4e9057cd5283591a251bd3ca136b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.36%.
- Marked-pixel bounds: (120,26)–(131,221); span 12 × 196 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.36%。
- 痕迹范围：(120,26)–(131,221)；跨度12 × 196 px；痕迹矩形高于宽。
