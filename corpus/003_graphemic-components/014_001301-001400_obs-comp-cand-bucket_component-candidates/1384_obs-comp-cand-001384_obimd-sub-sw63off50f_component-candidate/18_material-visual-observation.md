# Material Visual Observation / obs-comp-cand-001384 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001384`
- External reference / 外部参照: `obimd-sub-sw63off50f`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015803_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/otyf9c85b1/sw63off50f/sw63off50f.png`
- Checksum / 校验和:
  `9aed2a1060fc936c2a23edc89b5e5ff5ac596b605726b729d492de5c232b25c1`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.75%.
- Marked-pixel bounds: (82,32)–(167,213); span 86 × 182 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.75%。
- 痕迹范围：(82,32)–(167,213)；跨度86 × 182 px；痕迹矩形高于宽。
