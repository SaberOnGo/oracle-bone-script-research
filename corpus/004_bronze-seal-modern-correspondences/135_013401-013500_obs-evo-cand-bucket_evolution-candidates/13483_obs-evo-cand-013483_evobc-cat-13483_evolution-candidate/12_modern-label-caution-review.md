# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013483
...
- EVOBC candidate category: `evobc-evo-cat-13483`.
- Source label for search only: `𭅚`.
- Source codepoints for search only: `U+2D15A`.
