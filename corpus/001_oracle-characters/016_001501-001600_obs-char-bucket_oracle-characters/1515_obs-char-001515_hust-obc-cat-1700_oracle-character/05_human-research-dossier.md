# obs-char-001515 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001515`
- primary external id: `hust-obc-cat-1700`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1515_obs-char-001515_hust-obc-cat-1700_ora
  cle-character/03_visual-assets/001_asset-001520_hust-obc-cat-1700_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1700/G_1700_乙4878合701.png`
- asset id: `asset-001520`
...
- source category: `1700`
- validation class: `1514`
- source image route: `HUST-OBC/deciphered/1700/G_1700_乙4878合701.png`
- asset id: `asset-001520`
...
- English observation: `A compact angular cluster combines pointed upper
  strokes with a small lower loop.`
- 中文观察: `紧凑折角笔画群结合尖状上部笔画和小型下部环形。`
...
- dataset label text: `㪚`
- dataset label codepoints: `U+3A9A`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00150`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00150`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00150`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/150_obs-evo-can
  d-000150_evobc-cat-00150_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/150_obs-evo-cand-000150_evobc-cat-00150_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合701
  (G_1700_乙4878合701.png)`
...
- Which source records identify obs-char-001515 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001515？
