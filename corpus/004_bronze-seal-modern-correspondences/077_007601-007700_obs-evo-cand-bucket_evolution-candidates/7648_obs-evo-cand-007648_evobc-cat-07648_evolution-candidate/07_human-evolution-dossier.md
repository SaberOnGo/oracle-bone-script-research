...
Project ID: `obs-evo-cand-007648`
...
- Project ID: `obs-evo-cand-007648`
- EVOBC category candidate ID: `evobc-evo-cat-07648`
- External category reference: `evobc-cat-07648`
- Source category ID: `07648`
- Source label for human review: `藤`
- Source codepoints: `U+85E4`
...
- `obs-evo-cand-007648-route-category-staging`
...
- `obs-evo-cand-007648-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007648-route-evolution-graph`
