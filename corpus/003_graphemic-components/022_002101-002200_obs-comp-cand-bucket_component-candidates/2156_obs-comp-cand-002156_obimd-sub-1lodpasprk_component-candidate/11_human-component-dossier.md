# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-002156
...
- candidate_component_id: `obs-comp-cand-002156`
- primary_external_ref_id: `obimd-sub-1lodpasprk`
- source_subcharacter_uid: `1lodpasprk`
...
- glyph_codepoint_uplus_sample: `U+FC701, U+FC702, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-019797` | `001_asset-019797_img.png` | `bc9858cc3fc77f13b82388deea4fd781839802bbf9d4d5dddd20f7ebed2f019a` |
