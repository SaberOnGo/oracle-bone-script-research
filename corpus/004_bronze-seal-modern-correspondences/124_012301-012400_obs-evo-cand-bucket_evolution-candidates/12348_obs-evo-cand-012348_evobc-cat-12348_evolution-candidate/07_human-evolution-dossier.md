...
- Project ID: `obs-evo-cand-012348`
- EVOBC category candidate ID: `evobc-evo-cat-12348`
- External category reference: `evobc-cat-12348`
- Source category ID: `12348`
- Source label for human review: `𨒉`
- Source codepoints: `U+28489`
...
- `obs-evo-cand-012348-route-category-staging`
...
- `obs-evo-cand-012348-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012348-route-evolution-graph`
