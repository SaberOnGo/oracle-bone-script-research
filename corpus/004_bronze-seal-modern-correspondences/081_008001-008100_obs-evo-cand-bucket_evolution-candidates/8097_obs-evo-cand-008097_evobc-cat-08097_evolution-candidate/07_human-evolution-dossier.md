...
- External category reference: `evobc-cat-08097`
- Source category ID: `08097`
- Source label for human review: `觛`
- Source codepoints: `U+89DB`
...
- `obs-evo-cand-008097-route-category-staging`
...
- `obs-evo-cand-008097-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008097-route-evolution-graph`
