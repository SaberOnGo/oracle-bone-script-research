# obs-unk-004192 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004192`
- primary external id: `hust-obc-und-L-004192`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/092_obs-unk-004192_h
  ust-obc-und-L-004192_oracle-character-candidate/03_visual-assets/001_asset
  -005785_hust-obc-und-L-004192_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4192/L_？_9131.jpg`
- asset id: `asset-005785`
...
- source class: `HUST-OBC/undeciphered/L/4192/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4192/L_？_9131.jpg`
- asset id: `asset-005785`
...
- English observation: `Two upper bars and a curved lower trace are visible.`
- 中文观察: `上部两条横笔画和下方独立的弯曲痕迹可见。`
...
- Which source records identify obs-unk-004192 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004192？
