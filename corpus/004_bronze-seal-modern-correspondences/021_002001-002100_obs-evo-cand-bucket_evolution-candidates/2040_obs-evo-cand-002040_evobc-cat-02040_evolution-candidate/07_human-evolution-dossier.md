...
- External category reference: `evobc-cat-02040`
- Source category ID: `02040`
- Source label for human review: `奔`
...
- `obs-evo-cand-002040-route-category-staging`
...
- `obs-evo-cand-002040-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002040-route-evolution-graph`
