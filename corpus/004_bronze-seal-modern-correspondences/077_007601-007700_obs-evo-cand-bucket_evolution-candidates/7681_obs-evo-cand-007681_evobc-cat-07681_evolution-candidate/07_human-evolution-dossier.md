...
- Project ID: `obs-evo-cand-007681`
- EVOBC category candidate ID: `evobc-evo-cat-07681`
- External category reference: `evobc-cat-07681`
- Source category ID: `07681`
- Source label for human review: `蘳`
- Source codepoints: `U+8633`
...
- `obs-evo-cand-007681-route-category-staging`
...
- `obs-evo-cand-007681-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007681-route-evolution-graph`
