...
Project ID: `obs-insc-cw-cand-000040`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000040`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000040` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y211` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `214` [route_present_image_or_text_not_collected]
