# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000776
...
- EVOBC candidate category: `evobc-evo-cat-00776`.
- Source label for search only: `会`.
- Source codepoints for search only: `U+4F1A`.
