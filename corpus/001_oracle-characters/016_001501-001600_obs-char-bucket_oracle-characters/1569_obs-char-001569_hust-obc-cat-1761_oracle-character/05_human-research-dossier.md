# obs-char-001569 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001569`
- primary external id: `hust-obc-cat-1761`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1569_obs-char-001569_hust-obc-cat-1761_ora
  cle-character/03_visual-assets/001_asset-001574_hust-obc-cat-1761_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1761/L_1761_5676.jpg`
- asset id: `asset-001574`
...
- source category: `1761`
- validation class: `1568`
- source image route: `HUST-OBC/deciphered/1761/L_1761_5676.jpg`
- asset id: `asset-001574`
...
- English observation: `A faint narrow cluster shows several short branching
  and angular strokes.`
- 中文观察: `浅淡狭长笔画群显示数条短分枝和折角笔画。`
...
- dataset label text: `㫗`
- dataset label codepoints: `U+3AD7`
...
- Which source records identify obs-char-001569 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001569？
