# obs-char-001408 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001408`
- primary external id: `hust-obc-cat-1577`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1408_obs-char-001408_hust-obc-cat-1577_ora
  cle-character/03_visual-assets/001_asset-001413_hust-obc-cat-1577_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1577/G_1577_前6.4.9.png`
- asset id: `asset-001413`
...
- source category: `1577`
- validation class: `1407`
- source image route: `HUST-OBC/deciphered/1577/G_1577_前6.4.9.png`
- asset id: `asset-001413`
...
- English observation: `A small upper frame leads to a diagonal central
  stroke and lower branches.`
...
- dataset label text: `㨟`
- dataset label codepoints: `U+3A1F`
...
- Which source records identify obs-char-001408 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001408？
