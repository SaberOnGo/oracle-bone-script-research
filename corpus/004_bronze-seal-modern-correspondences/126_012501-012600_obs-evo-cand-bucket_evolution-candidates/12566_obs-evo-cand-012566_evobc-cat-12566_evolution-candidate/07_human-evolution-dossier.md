...
- Project ID: `obs-evo-cand-012566`
- EVOBC category candidate ID: `evobc-evo-cat-12566`
- External category reference: `evobc-cat-12566`
- Source category ID: `12566`
- Source label for human review: `𩈁`
- Source codepoints: `U+29201`
...
- `obs-evo-cand-012566-route-category-staging`
...
- `obs-evo-cand-012566-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012566-route-evolution-graph`
