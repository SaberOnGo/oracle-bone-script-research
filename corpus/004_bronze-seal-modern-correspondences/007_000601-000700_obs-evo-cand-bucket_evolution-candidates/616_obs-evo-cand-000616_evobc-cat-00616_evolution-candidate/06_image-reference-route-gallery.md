...
- `obs-evo-cand-000616-route-category-staging`
...
- `obs-evo-cand-000616-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000616-route-evolution-graph`
