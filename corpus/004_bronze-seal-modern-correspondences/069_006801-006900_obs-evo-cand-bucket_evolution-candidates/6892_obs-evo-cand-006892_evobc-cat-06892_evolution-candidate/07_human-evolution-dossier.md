...
Project ID: `obs-evo-cand-006892`
...
- Project ID: `obs-evo-cand-006892`
- EVOBC category candidate ID: `evobc-evo-cat-06892`
- External category reference: `evobc-cat-06892`
- Source category ID: `06892`
- Source label for human review: `翨`
- Source codepoints: `U+7FE8`
...
- `obs-evo-cand-006892-route-category-staging`
...
- `obs-evo-cand-006892-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006892-route-evolution-graph`
