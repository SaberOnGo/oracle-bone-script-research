...
Project ID: `obs-insc-cw-cand-000218`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000218`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000218` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y1282` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `22` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `502` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `40525` [route_present_image_or_text_not_collected]
