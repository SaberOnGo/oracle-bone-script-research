# obs-char-001507 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1507_obs-char-001507_hust-obc-cat-1692_ora
  cle-character/03_visual-assets/001_asset-001512_hust-obc-cat-1692_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1692/X_1692_4099_1.png`
- asset id: `asset-001512`
...
- source category: `1692`
- validation class: `1506`
- source image route: `HUST-OBC/deciphered/1692/X_1692_4099_1.png`
- asset id: `asset-001512`
...
- dataset label text: `㪒`
- dataset label codepoints: `U+3A92`
...
- Which source records identify obs-char-001507 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001507？
