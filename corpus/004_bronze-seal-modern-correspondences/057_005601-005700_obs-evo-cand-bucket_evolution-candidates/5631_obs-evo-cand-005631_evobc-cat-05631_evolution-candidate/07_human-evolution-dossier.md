...
- External category reference: `evobc-cat-05631`
- Source category ID: `05631`
- Source label for human review: `痂`
- Source codepoints: `U+75C2`
...
- `obs-evo-cand-005631-route-category-staging`
...
- `obs-evo-cand-005631-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005631-route-evolution-graph`
