# Material Visual Observation / obs-comp-cand-001101 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001101`
- External reference / 外部参照: `obimd-sub-4ipm1tz27z`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015025_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xlscyddubk/4ipm1tz27z/4ipm1tz27z.png`
- Checksum / 校验和:
  `74a8bfa938a9d7405de6d3b96adcc9c5772da68a554af5622010b2d64ab07914`
...
- Marked-pixel bounds: (81,31)–(172,215); span 92 × 185 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.84%。
- 痕迹范围：(81,31)–(172,215)；跨度92 × 185 px；痕迹矩形高于宽。
