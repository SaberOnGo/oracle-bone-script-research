...
Project ID: `obs-evo-cand-008663`
...
- Project ID: `obs-evo-cand-008663`
- EVOBC category candidate ID: `evobc-evo-cat-08663`
- External category reference: `evobc-cat-08663`
- Source category ID: `08663`
- Source label for human review: `赴`
- Source codepoints: `U+8D74`
...
- `obs-evo-cand-008663-route-category-staging`
...
- `obs-evo-cand-008663-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008663-route-evolution-graph`
