...
Project ID: `obs-insc-cw-cand-000314`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000314`
...
- Yingguo / 英国所藏: `y1969` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `72` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `462` in source row; primary catalog entry pending
- Heji / 合集: `40998` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000314`
