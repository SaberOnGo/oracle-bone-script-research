# Material Visual Observation / obs-comp-cand-002535 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002535`
- External reference / 外部参照: `obimd-sub-bcw474srtf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021054_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/f0csx339lz/bcw474srtf/bcw474srtf.png`
- Checksum / 校验和:
  `8f9a95396a17282dcec0762022ecc6077acf0853b7257ab8eaea771de64690d2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.50%.
- Marked-pixel bounds: (66,43)–(174,194); span 109 × 152 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.50%。
- 痕迹范围：(66,43)–(174,194)；跨度109 × 152 px；痕迹矩形高于宽。
