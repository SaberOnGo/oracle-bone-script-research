# obs-unk-004343 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004343`
- primary external id: `hust-obc-und-L-004343`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/043_obs-unk-004343_h
  ust-obc-und-L-004343_oracle-character-candidate/03_visual-assets/001_asset
  -005936_hust-obc-und-L-004343_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4343/L_？_9610.jpg`
- asset id: `asset-005936`
...
- source class: `HUST-OBC/undeciphered/L/4343/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4343/L_？_9610.jpg`
- asset id: `asset-005936`
...
- English observation: `Upper compact trace and two lower extensions recorded.`
- 中文观察: `已记录上部紧密痕和两条下部延伸痕。`
...
- Which source records identify obs-unk-004343 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004343？
