# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002566
...
| --- | --- | --- | --- |
| `obimd-glyph-link-039351` | 󾣲 | `U+FE8F2` | `reviewed_metadata_only` |
| `obimd-glyph-link-039352` | 󾣳 | `U+FE8F3` | `reviewed_metadata_only` |
| `obimd-glyph-link-039353` | 󾣴 | `U+FE8F4` | `reviewed_metadata_only` |
