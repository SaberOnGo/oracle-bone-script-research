# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006167
...
- EVOBC candidate category: `evobc-evo-cat-06167`.
- Source label for search only: `窗`.
- Source codepoints for search only: `U+7A97`.
