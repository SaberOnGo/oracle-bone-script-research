...
- External category reference: `evobc-cat-06680`
- Source category ID: `06680`
- Source label for human review: `繜`
- Source codepoints: `U+7E5C`
...
- `obs-evo-cand-006680-route-category-staging`
...
- `obs-evo-cand-006680-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006680-route-evolution-graph`
