# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010354
...
- EVOBC candidate category: `evobc-evo-cat-10354`.
- Source label for search only: `鬼`.
- Source codepoints for search only: `U+9B3C`.
