...
- External category reference: `evobc-cat-08590`
- Source category ID: `08590`
- Source label for human review: `賮`
...
- `obs-evo-cand-008590-route-category-staging`
...
- `obs-evo-cand-008590-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008590-route-evolution-graph`
