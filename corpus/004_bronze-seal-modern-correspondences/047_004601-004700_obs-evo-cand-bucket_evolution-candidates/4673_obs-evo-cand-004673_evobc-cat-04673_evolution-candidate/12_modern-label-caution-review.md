# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004673
...
- EVOBC candidate category: `evobc-evo-cat-04673`.
- Source label for search only: `浿`.
- Source codepoints for search only: `U+6D7F`.
