# obs-unk-005586 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005586`
- primary external id: `hust-obc-und-X-005586`
...
- local review image route: `corpus/001_oracle-characters/072_undeciphered-005
  501-005600_obs-unk-bucket_oracle-character-candidates/086_obs-unk-005586_h
  ust-obc-und-X-005586_oracle-character-candidate/03_visual-assets/001_asset
  -007179_hust-obc-und-X-005586_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1142/X_？_8096_1.png`
- asset id: `asset-007179`
...
- source class: `HUST-OBC/undeciphered/X/1142/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1142/X_？_8096_1.png`
- asset id: `asset-007179`
...
- Which source records identify obs-unk-005586 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005586？
