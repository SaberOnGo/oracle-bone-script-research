# Material Visual Observation / obs-comp-cand-001643 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001643`
- External reference / 外部参照: `obimd-sub-z0pbcna9kk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017319_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/z0pbcna9kk/z0pbcna9kk/z0pbcna9kk.png`
- Checksum / 校验和:
  `88255451686d417ea47527761c59e5631890f51eb6435fe09dd66cd60bded60f`
...
- Marked-pixel bounds: (69,49)–(180,198); span 112 × 150 px; the marked
...
- 痕迹范围：(69,49)–(180,198)；跨度112 × 150 px；痕迹矩形高于宽。
