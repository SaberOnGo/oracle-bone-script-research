...
- `obs-evo-cand-005951-route-category-staging`
...
- `obs-evo-cand-005951-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005951-route-evolution-graph`
