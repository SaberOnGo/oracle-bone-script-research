# Material Visual Observation / obs-comp-cand-001380 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001380`
- External reference / 外部参照: `obimd-sub-s5xwrkx3pz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015799_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/c7qvt9bwt5/s5xwrkx3pz/s5xwrkx3pz.png`
- Checksum / 校验和:
  `c16aa29b5acf955e8934a3560281108e4fab35dd67b50c35ffa9f84d97a7abfa`
...
- Marked-pixel bounds: (85,20)–(182,226); span 98 × 207 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.88%。
- 痕迹范围：(85,20)–(182,226)；跨度98 × 207 px；痕迹矩形高于宽。
