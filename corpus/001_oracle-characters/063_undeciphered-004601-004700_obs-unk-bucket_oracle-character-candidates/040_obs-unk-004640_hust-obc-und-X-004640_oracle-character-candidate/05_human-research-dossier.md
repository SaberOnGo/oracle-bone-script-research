# obs-unk-004640 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004640`
- primary external id: `hust-obc-und-X-004640`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/040_obs-unk-004640_h
  ust-obc-und-X-004640_oracle-character-candidate/03_visual-assets/001_asset
  -006233_hust-obc-und-X-004640_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/196/X_？_8369_1.png`
- asset id: `asset-006233`
...
- source class: `HUST-OBC/undeciphered/X/196/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/196/X_？_8369_1.png`
- asset id: `asset-006233`
...
- English observation: `squared U-like enclosure with inner rectangle`
- 中文观察: `近方形 U 状外轮廓及内部深色矩形`
...
- Which source records identify obs-unk-004640 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004640？
