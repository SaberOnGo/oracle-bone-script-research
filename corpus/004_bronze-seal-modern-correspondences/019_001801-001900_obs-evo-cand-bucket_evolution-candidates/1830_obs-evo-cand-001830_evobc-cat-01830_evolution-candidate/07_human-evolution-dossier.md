...
- External category reference: `evobc-cat-01830`
- Source category ID: `01830`
- Source label for human review: `坭`
- Source codepoints: `U+576D`
...
- `obs-evo-cand-001830-route-category-staging`
...
- `obs-evo-cand-001830-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001830-route-evolution-graph`
