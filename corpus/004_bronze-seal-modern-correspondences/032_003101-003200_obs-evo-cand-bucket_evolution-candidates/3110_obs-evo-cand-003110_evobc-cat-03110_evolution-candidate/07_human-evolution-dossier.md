...
- External category reference: `evobc-cat-03110`
- Source category ID: `03110`
- Source label for human review: `慍`
- Source codepoints: `U+614D`
...
- `obs-evo-cand-003110-route-category-staging`
...
- `obs-evo-cand-003110-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003110-route-evolution-graph`
