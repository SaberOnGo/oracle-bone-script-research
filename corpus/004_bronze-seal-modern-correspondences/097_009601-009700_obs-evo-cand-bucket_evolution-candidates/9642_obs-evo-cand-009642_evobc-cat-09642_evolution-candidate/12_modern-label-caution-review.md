# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-009642

English:
This object-local review sheet keeps EVOBC source labels, Unicode codepoints,
era codes, and source codes separate from confirmed modern-character identity,
reading, meaning, or decipherment claims.

Simplified Chinese:
本页用于把 EVOBC 来源标签、Unicode codepoint、时期代码和来源代码，与已确认的今字身份、读法、字义或释读结论分开复核。

## Dataset Label Is Not Identity

- Project ID: `obs-evo-cand-009642`.
- EVOBC candidate category: `evobc-evo-cat-09642`.
- Source label for search only: `encoding-review-needed`.
- Source codepoints for search only: `U+95BB`.
...
- Open dictionaries, databases, papers, and source images before identity
  claims.
...
- 打开 `03_era-source-code-index.csv`，先核对时期和来源代码。
- 打开 `09_cross-period-review-dossier.md`，先核对金文、小篆和今字路线。
