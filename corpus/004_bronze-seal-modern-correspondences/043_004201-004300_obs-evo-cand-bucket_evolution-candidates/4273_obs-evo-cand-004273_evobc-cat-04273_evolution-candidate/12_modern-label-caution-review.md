# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004273
...
- EVOBC candidate category: `evobc-evo-cat-04273`.
- Source label for search only: `機`.
- Source codepoints for search only: `U+6A5F`.
