...
- Project ID: `obs-evo-cand-007930`
- EVOBC category candidate ID: `evobc-evo-cat-07930`
- External category reference: `evobc-cat-07930`
- Source category ID: `07930`
- Source label for human review: `衷`
- Source codepoints: `U+8877`
...
- `obs-evo-cand-007930-route-category-staging`
...
- `obs-evo-cand-007930-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007930-route-evolution-graph`
