# obs-char-000939 Visual Gallery / obs-char-000939 图像资料页
...
- Primary external reference / 首选外部参考: `hust-obc-cat-1056`
...
## obs-char-000939-visual-source-001 / 图像条目

![obs-char-000939 glyph candidate](03_visual-assets/001_asset-000944_hust-obc-cat-1056_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000944_hust-obc-cat-1056_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000944_hust-obc-cat-1056_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/1056/G_1056_前2.17.6(甲).png`
