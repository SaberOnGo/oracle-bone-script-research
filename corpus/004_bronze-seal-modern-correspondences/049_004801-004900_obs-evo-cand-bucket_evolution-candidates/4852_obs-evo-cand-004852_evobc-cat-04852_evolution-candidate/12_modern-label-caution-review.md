# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004852
...
- EVOBC candidate category: `evobc-evo-cat-04852`.
- Source label for search only: `滯`.
- Source codepoints for search only: `U+6EEF`.
