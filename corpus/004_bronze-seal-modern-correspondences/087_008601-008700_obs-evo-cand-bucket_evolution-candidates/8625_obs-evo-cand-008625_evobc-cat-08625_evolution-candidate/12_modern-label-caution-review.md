# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008625
...
- EVOBC candidate category: `evobc-evo-cat-08625`.
- Source label for search only: `贬`.
- Source codepoints for search only: `U+8D2C`.
