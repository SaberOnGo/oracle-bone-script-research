...
- External category reference: `evobc-cat-09537`
- Source category ID: `09537`
- Source label for human review: `鐶`
- Source codepoints: `U+9436`
...
- `obs-evo-cand-009537-route-category-staging`
...
- `obs-evo-cand-009537-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009537-route-evolution-graph`
