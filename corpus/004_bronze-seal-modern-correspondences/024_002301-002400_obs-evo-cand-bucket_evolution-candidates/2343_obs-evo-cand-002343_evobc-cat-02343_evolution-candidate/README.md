# obs-evo-cand-002343 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-002343`
- EVOBC category candidate ID: `evobc-evo-cat-02343`
- External category ref: `evobc-cat-02343`
- Source label: `孫`
- Source codepoints: `U+5B6B`
- Image reference count: `241`
- Era token counts: `BI:128;CS:2;OBC:15;SAC:34;SS:1;WSC:61`
- Source token counts: `Book:141;Web:100`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 15 image references
- era 1 / BI: 128 image references
- era 2 / SS: 1 image references
- era 3 / SAC: 34 image references
...
- source 3 / Book:21681: 72 image references
- source 4 / Book:9131: 34 image references
- source 5 / Book:32794: 27 image references
