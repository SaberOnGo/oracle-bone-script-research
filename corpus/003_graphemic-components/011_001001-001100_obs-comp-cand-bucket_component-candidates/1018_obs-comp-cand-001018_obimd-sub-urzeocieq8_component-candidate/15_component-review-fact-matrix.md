# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001018
...
| Glyph or codepoint route / 字形或码位路线 | 9 OBIMD route rows; examples U+F5C59; U+F5C5A; 另有 7 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
