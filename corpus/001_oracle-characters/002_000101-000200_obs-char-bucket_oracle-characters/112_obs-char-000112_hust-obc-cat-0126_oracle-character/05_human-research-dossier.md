# obs-char-000112 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000112`
- primary external id: `hust-obc-cat-0126`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/112_obs-char-000112_hust-obc-cat-0126_orac
  le-character/03_visual-assets/001_asset-000117_hust-obc-cat-0126_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0126/G_0126_乙7817合13757賓組.png`
- asset id: `asset-000117`
...
- source category: `0126`
- validation class: `111`
- source image route: `HUST-OBC/deciphered/0126/G_0126_乙7817合13757賓組.png`
- asset id: `asset-000117`
...
- English observation: `The image shows two upright side strokes with an
  open curved diagonal connection running from the upper left toward the
  lower right.`
- 中文观察: `图像可见两道直立侧笔画，并有开放的弧斜连接笔画从左上向右下延伸。`
...
- dataset label text: `㑴`
- dataset label codepoints: `U+3474`
...
- filename catalog route clues: `Heji-like filename clue: 合13757
  (G_0126_乙7817合13757賓組.png)`
...
- Which source records identify obs-char-000112 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000112？
