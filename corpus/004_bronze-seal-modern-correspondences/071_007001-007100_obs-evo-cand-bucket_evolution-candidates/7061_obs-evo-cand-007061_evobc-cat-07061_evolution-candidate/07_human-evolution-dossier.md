...
Project ID: `obs-evo-cand-007061`
...
- Project ID: `obs-evo-cand-007061`
- EVOBC category candidate ID: `evobc-evo-cat-07061`
- External category reference: `evobc-cat-07061`
- Source category ID: `07061`
- Source label for human review: `脖`
- Source codepoints: `U+8116`
...
- `obs-evo-cand-007061-route-category-staging`
...
- `obs-evo-cand-007061-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007061-route-evolution-graph`
