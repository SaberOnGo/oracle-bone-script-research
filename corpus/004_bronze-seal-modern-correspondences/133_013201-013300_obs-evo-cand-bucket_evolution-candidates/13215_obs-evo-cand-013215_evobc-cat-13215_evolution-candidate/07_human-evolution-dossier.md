...
- External category reference: `evobc-cat-13215`
- Source category ID: `13215`
- Source label for human review: `𬆤`
...
- `obs-evo-cand-013215-route-category-staging`
...
- `obs-evo-cand-013215-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013215-route-evolution-graph`
