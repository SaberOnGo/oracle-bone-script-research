# Material Visual Observation / obs-comp-cand-002469 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002469`
- External reference / 外部参照: `obimd-sub-gwuro48zlp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020654_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/v7qghw0r67/gwuro48zlp/gwuro48zlp.png`
- Checksum / 校验和:
  `bda1aeb438e2db39a24744f9c347a5c29657c6df6792289e2c2c21e2e2b7e5fe`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.44%.
- Marked-pixel bounds: (45,35)–(207,209); span 163 × 175 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.44%。
- 痕迹范围：(45,35)–(207,209)；跨度163 × 175 px；痕迹矩形近方形。
