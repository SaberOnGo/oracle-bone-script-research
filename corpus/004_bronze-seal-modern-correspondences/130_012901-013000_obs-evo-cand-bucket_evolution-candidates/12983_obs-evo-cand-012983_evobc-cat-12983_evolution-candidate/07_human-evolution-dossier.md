...
- External category reference: `evobc-cat-12983`
- Source category ID: `12983`
- Source label for human review: `𫜱`
- Source codepoints: `U+2B731`
...
- `obs-evo-cand-012983-route-category-staging`
...
- `obs-evo-cand-012983-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012983-route-evolution-graph`
