# obs-unk-004875 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/075_obs-unk-004875_h
  ust-obc-und-X-004875_oracle-character-candidate/03_visual-assets/001_asset
  -006468_hust-obc-und-X-004875_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/431/X_？_7414_1.png`
- asset id: `asset-006468`
...
- source class: `HUST-OBC/undeciphered/X/431/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/431/X_？_7414_1.png`
- asset id: `asset-006468`
...
- English observation: `branching upper group and broad lower enclosure`
- 中文观察: `上部分枝结构和宽大下部外框`
...
- Which source records identify obs-unk-004875 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004875？
