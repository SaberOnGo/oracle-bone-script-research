# obs-char-000006 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/006_obs-char-000006_hust-obc-cat-0006_orac
  le-character/03_visual-assets/001_asset-000011_hust-obc-cat-0006_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0006/G_0006_甲1700合28151何組.png`
- asset id: `asset-000011`
...
- source category: `0006`
- validation class: `5`
- source image route: `HUST-OBC/deciphered/0006/G_0006_甲1700合28151何組.png`
- asset id: `asset-000011`
...
- English observation: `The compact image has a block-like upper outline and
  two rounded lower marks; the small size limits surface detail.`
- 中文观察: `图像上部呈块状轮廓，下部有两个圆弧状痕迹；图像尺寸限制了表面细节观察。`
...
- dataset label text: `⺸`
- dataset label codepoints: `U+2EB8`
...
- filename catalog route clues: `Heji-like filename clue: 合28151
...
- Which source records identify obs-char-000006 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000006？
