# obs-char-001575 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1575_obs-char-001575_hust-obc-cat-1767_ora
  cle-character/03_visual-assets/001_asset-001580_hust-obc-cat-1767_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1767/G_1767_河677(甲).png`
- asset id: `asset-001580`
...
- source category: `1767`
- validation class: `1574`
- source image route: `HUST-OBC/deciphered/1767/G_1767_河677(甲).png`
- asset id: `asset-001580`
...
- dataset label text: `㫝`
- dataset label codepoints: `U+3ADD`
...
- Which source records identify obs-char-001575 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001575？
