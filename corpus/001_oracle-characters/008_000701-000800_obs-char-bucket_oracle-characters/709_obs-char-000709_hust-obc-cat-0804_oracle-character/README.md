# obs-char-000709 Local Object Materials / obs-char-000709 本地对象资料
...
- Project ID / 项目 ID: `obs-char-000709`
- Primary external reference / 首选外部参考: `hust-obc-cat-0804`
- Source / 来源: `src-hust-obc`
- Packet record type / 资料包类型: `oracle_character_candidate_packet`
- Directory / 目录: `corpus/001_oracle-characters/008_000701-000800_obs-char-bucket_oracle-characters/709_obs-char-000709_hust-obc-cat-0804_oracle-character`

## Visual Material Status / 图像资料状态

- Status / 状态: `committed_review_image_derivative`
- Source image reference rows / 来源图像路径引用行数: `1`
- Committed glyph image / 已提交字形图像: 03_visual-assets/001_asset-000714_hust-obc-cat-0804_glyph.png
