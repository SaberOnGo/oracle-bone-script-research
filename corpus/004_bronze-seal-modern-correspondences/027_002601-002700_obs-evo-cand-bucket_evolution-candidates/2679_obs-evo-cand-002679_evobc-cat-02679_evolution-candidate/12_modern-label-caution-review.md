# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002679
...
- EVOBC candidate category: `evobc-evo-cat-02679`.
- Source label for search only: `幝`.
- Source codepoints for search only: `U+5E5D`.
