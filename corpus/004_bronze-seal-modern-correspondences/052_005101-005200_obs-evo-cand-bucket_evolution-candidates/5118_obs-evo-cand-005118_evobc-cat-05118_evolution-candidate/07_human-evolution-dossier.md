...
Project ID: `obs-evo-cand-005118`
...
- Project ID: `obs-evo-cand-005118`
- EVOBC category candidate ID: `evobc-evo-cat-05118`
- External category reference: `evobc-cat-05118`
- Source category ID: `05118`
- Source label for human review: `煬`
- Source codepoints: `U+716C`
...
- `obs-evo-cand-005118-route-category-staging`
...
- `obs-evo-cand-005118-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005118-route-evolution-graph`
