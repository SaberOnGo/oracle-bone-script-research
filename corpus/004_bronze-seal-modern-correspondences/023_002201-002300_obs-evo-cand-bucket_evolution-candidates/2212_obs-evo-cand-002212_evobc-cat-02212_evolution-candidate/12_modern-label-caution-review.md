# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002212
...
- EVOBC candidate category: `evobc-evo-cat-02212`.
- Source label for search only: `婭`.
- Source codepoints for search only: `U+5A6D`.
