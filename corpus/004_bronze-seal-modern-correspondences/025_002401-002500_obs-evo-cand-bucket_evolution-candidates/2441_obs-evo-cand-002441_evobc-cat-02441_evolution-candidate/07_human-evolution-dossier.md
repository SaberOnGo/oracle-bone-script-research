...
Project ID: `obs-evo-cand-002441`
...
- Project ID: `obs-evo-cand-002441`
- EVOBC category candidate ID: `evobc-evo-cat-02441`
- External category reference: `evobc-cat-02441`
- Source category ID: `02441`
- Source label for human review: `寮`
- Source codepoints: `U+5BEE`
...
- `obs-evo-cand-002441-route-category-staging`
...
- `obs-evo-cand-002441-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002441-route-evolution-graph`
