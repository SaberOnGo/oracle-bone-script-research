# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004626
...
- EVOBC candidate category: `evobc-evo-cat-04626`.
- Source label for search only: `洛`.
- Source codepoints for search only: `U+6D1B`.
