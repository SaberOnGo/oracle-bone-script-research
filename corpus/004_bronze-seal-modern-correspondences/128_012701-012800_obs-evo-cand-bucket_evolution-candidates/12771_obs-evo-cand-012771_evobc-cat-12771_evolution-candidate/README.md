# obs-evo-cand-012771 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-012771`
- EVOBC category candidate ID: `evobc-evo-cat-12771`
- External category ref: `evobc-cat-12771`
- Source label: `𪔉`
- Source codepoints: `U+2A509`
- Image reference count: `32`
- Era token counts: `BI:27;WSC:5`
- Source token counts: `Book:32`
