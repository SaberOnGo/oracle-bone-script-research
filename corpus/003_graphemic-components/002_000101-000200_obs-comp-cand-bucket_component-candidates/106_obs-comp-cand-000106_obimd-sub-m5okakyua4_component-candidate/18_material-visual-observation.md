# Material Visual Observation / obs-comp-cand-000106 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000106`
- External reference / 外部参照: `obimd-sub-m5okakyua4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011518_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/sq81wh8r3p/m5okakyua4/m5okakyua4.png`
- Checksum / 校验和:
  `9da17bddd8981eeec9156805e84c1a7c73add24fb97c1832af80d70a60d5d825`
...
- Marked-pixel bounds: (68,44)–(181,213); span 114 × 170 px; the marked
...
- 痕迹范围：(68,44)–(181,213)；跨度114 × 170 px；痕迹矩形高于宽。
