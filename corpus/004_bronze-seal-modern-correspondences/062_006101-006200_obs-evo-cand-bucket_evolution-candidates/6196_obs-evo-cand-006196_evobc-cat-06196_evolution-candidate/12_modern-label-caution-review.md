# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006196
...
- EVOBC candidate category: `evobc-evo-cat-06196`.
- Source label for search only: `立`.
- Source codepoints for search only: `U+7ACB`.
