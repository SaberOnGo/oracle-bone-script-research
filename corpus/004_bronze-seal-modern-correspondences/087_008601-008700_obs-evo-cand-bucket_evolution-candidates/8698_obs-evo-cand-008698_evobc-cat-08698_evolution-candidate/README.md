# obs-evo-cand-008698 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-08698`
- Source label: `足`
- Source codepoints: `U+8DB3`
- Image reference count: `117`
- Era token counts: `BI:19;CS:1;OBC:13;SS:2;WSC:82`
- Source token counts: `Book:41;Web:76`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 13 image references
