...
Project ID: `obs-evo-cand-012477`
...
- Project ID: `obs-evo-cand-012477`
- EVOBC category candidate ID: `evobc-evo-cat-12477`
- External category reference: `evobc-cat-12477`
- Source category ID: `12477`
- Source label for human review: `𨥁`
- Source codepoints: `U+28941`
...
- `obs-evo-cand-012477-route-category-staging`
...
- `obs-evo-cand-012477-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012477-route-evolution-graph`
