...
- Project ID: `obs-evo-cand-004572`
- EVOBC category candidate ID: `evobc-evo-cat-04572`
- External category reference: `evobc-cat-04572`
- Source category ID: `04572`
- Source label for human review: `泆`
- Source codepoints: `U+6CC6`
...
- `obs-evo-cand-004572-route-category-staging`
...
- `obs-evo-cand-004572-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004572-route-evolution-graph`
