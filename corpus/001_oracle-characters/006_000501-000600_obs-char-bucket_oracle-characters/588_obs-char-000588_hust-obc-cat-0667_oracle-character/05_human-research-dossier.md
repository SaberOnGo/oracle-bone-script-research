# obs-char-000588 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/588_obs-char-000588_hust-obc-cat-0667_orac
  le-character/03_visual-assets/001_asset-000593_hust-obc-cat-0667_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0667/G_0667_前6.23.5合20306𠂤組.png
  `
- asset id: `asset-000593`
...
- source category: `0667`
- validation class: `587`
- source image route: `HUST-OBC/deciphered/0667/G_0667_前6.23.5合20306𠂤組.png`
- asset id: `asset-000593`
...
- English observation: `A long central vertical rises into paired upper
  arches and carries crossing middle branches, while detached bent strokes
  stand on both sides.`
...
- dataset label text: `㚑`
- dataset label codepoints: `U+3691`
...
- filename catalog route clues: `Heji-like filename clue: 合20306
...
- Which source records identify obs-char-000588 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000588？
