...
- Project ID: `obs-evo-cand-010105`
- EVOBC category candidate ID: `evobc-evo-cat-10105`
- External category reference: `evobc-cat-10105`
- Source category ID: `10105`
- Source label for human review: `餌`
- Source codepoints: `U+990C`
...
- `obs-evo-cand-010105-route-category-staging`
...
- `obs-evo-cand-010105-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010105-route-evolution-graph`
