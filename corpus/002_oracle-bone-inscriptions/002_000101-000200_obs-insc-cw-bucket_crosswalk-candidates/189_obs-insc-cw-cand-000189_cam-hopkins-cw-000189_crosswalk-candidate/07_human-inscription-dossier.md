...
Project ID: `obs-insc-cw-cand-000189`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000189`
...
- Yingguo / 英国所藏: `y1152` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `132` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `595` in source row; primary catalog entry pending
- Heji / 合集: `40416` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000189`
