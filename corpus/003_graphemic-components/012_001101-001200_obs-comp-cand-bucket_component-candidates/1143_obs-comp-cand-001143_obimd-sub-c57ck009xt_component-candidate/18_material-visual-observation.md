# Material Visual Observation / obs-comp-cand-001143 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001143`
- External reference / 外部参照: `obimd-sub-c57ck009xt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015217_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/c57ck009xt/c57ck009xt/01s2f0zcy7.png`
- Checksum / 校验和:
  `3819f60e0420a3f3ca30d7e95eb9932b80ba9e105530e1c89c48ad7f1767dab1`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 2.85%.
- Marked-pixel bounds: (103,35)–(146,203); span 44 × 169 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占2.85%。
- 痕迹范围：(103,35)–(146,203)；跨度44 × 169 px；痕迹矩形高于宽。
