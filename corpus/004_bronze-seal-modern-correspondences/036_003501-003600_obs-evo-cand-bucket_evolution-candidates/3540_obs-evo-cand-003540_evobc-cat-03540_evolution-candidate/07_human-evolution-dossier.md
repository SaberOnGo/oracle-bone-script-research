...
- External category reference: `evobc-cat-03540`
- Source category ID: `03540`
- Source label for human review: `攀`
...
- `obs-evo-cand-003540-route-category-staging`
...
- `obs-evo-cand-003540-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003540-route-evolution-graph`
