# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013362
...
- EVOBC candidate category: `evobc-evo-cat-13362`.
- Source label for search only: `𬧿`.
- Source codepoints for search only: `U+2C9FF`.
