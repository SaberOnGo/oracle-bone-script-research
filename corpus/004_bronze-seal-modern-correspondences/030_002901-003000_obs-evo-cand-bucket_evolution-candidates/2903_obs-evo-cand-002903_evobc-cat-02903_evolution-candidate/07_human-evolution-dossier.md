...
Project ID: `obs-evo-cand-002903`
...
- Project ID: `obs-evo-cand-002903`
- EVOBC category candidate ID: `evobc-evo-cat-02903`
- External category reference: `evobc-cat-02903`
- Source category ID: `02903`
- Source label for human review: `忓`
- Source codepoints: `U+5FD3`
...
- `obs-evo-cand-002903-route-category-staging`
...
- `obs-evo-cand-002903-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002903-route-evolution-graph`
