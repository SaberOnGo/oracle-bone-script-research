# obs-char-000246 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000246`
- primary external id: `hust-obc-cat-0274`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/246_obs-char-000246_hust-obc-cat-0274_orac
  le-character/03_visual-assets/001_asset-000251_hust-obc-cat-0274_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0274/G_0274_拾8.7(甲).png`
- asset id: `asset-000251`
...
- source category: `0274`
- validation class: `245`
- source image route: `HUST-OBC/deciphered/0274/G_0274_拾8.7(甲).png`
- asset id: `asset-000251`
...
- English observation: `Three tall interior strokes rise from an open
  rounded lower contour, forming a compact upward cluster without a closed
  upper frame.`
- 中文观察: `三道高直内部笔画从开放圆弧下部轮廓中上行，形成紧凑上聚形，顶部没有闭合外框。`
...
- dataset label text: `㔈`
- dataset label codepoints: `U+3508`
...
- Which source records identify obs-char-000246 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000246？
