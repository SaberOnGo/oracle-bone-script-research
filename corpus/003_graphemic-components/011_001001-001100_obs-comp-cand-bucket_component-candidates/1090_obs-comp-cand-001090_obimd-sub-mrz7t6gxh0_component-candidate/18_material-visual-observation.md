# Material Visual Observation / obs-comp-cand-001090 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001090`
- External reference / 外部参照: `obimd-sub-mrz7t6gxh0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014899_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/mrz7t6gxh0/mrz7t6gxh0/mrz7t6gxh0.png`
- Checksum / 校验和:
  `9fedd8c7ba077fc6939a45b9fa8e74a325fc88b7b4b47b14ca75b10e9d08c5f8`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.66%.
- Marked-pixel bounds: (82,32)–(167,209); span 86 × 178 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.66%。
- 痕迹范围：(82,32)–(167,209)；跨度86 × 178 px；痕迹矩形高于宽。
