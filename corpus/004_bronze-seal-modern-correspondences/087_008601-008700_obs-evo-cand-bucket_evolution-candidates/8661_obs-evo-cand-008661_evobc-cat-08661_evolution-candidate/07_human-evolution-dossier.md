...
- External category reference: `evobc-cat-08661`
- Source category ID: `08661`
...
- `obs-evo-cand-008661-route-category-staging`
...
- `obs-evo-cand-008661-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008661-route-evolution-graph`
