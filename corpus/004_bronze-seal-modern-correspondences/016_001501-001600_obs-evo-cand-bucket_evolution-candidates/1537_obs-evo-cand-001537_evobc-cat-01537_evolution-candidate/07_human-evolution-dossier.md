...
- External category reference: `evobc-cat-01537`
- Source category ID: `01537`
- Source label for human review: `呦`
...
- `obs-evo-cand-001537-route-category-staging`
...
- `obs-evo-cand-001537-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001537-route-evolution-graph`
