...
Project ID: `obs-insc-cw-cand-000059`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000059`
...
- Yingguo / 英国所藏: `y392` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `136` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `675` in source row; primary catalog entry pending
- Heji / 合集: `39526` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000059`
