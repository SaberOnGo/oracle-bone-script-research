# obs-unk-004884 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004884`
- primary external id: `hust-obc-und-X-004884`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/084_obs-unk-004884_h
  ust-obc-und-X-004884_oracle-character-candidate/03_visual-assets/001_asset
  -006477_hust-obc-und-X-004884_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/440/X_？_7422_1.png`
- asset id: `asset-006477`
...
- source class: `HUST-OBC/undeciphered/X/440/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/440/X_？_7422_1.png`
- asset id: `asset-006477`
...
- English observation: `angular upper outline and lower V-like group`
- 中文观察: `上部折角外框和下部 V 形结构`
...
- Which source records identify obs-unk-004884 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004884？
