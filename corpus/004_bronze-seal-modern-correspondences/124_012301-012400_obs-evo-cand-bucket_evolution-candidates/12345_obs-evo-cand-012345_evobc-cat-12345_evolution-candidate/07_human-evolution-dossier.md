...
- External category reference: `evobc-cat-12345`
- Source category ID: `12345`
- Source label for human review: `𨑭`
...
- `obs-evo-cand-012345-route-category-staging`
...
- `obs-evo-cand-012345-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012345-route-evolution-graph`
