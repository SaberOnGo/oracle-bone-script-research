...
- Project ID: `obs-evo-cand-009433`
- EVOBC category candidate ID: `evobc-evo-cat-09433`
- External category reference: `evobc-cat-09433`
- Source category ID: `09433`
- Source label for human review: `錚`
- Source codepoints: `U+931A`
...
- `obs-evo-cand-009433-route-category-staging`
...
- `obs-evo-cand-009433-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009433-route-evolution-graph`
