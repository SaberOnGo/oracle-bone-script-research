...
- Project ID: `obs-evo-cand-005954`
- EVOBC category candidate ID: `evobc-evo-cat-05954`
- External category reference: `evobc-cat-05954`
- Source category ID: `05954`
- Source label for human review: `礐`
- Source codepoints: `U+7910`
...
- `obs-evo-cand-005954-route-category-staging`
...
- `obs-evo-cand-005954-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005954-route-evolution-graph`
