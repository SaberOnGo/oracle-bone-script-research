...
- External category reference: `evobc-cat-05114`
- Source category ID: `05114`
- Source label for human review: `煦`
- Source codepoints: `U+7166`
...
- `obs-evo-cand-005114-route-category-staging`
...
- `obs-evo-cand-005114-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005114-route-evolution-graph`
