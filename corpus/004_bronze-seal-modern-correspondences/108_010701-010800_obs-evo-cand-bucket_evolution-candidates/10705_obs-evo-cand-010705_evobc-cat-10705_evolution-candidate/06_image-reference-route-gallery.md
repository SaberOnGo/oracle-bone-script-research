...
- `obs-evo-cand-010705-route-category-staging`
...
- `obs-evo-cand-010705-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010705-route-evolution-graph`
