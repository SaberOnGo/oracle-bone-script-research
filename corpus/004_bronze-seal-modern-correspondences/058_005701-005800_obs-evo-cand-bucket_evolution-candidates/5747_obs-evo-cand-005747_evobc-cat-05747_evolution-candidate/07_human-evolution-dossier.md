...
- External category reference: `evobc-cat-05747`
- Source category ID: `05747`
- Source label for human review: `盌`
...
- `obs-evo-cand-005747-route-category-staging`
...
- `obs-evo-cand-005747-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005747-route-evolution-graph`
