# Material Visual Observation / obs-comp-cand-000042 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000042`
- External reference / 外部参照: `obimd-sub-urq1zuk7jt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011299_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/urq1zuk7jt/urq1zuk7jt/urq1zuk7jt.png`
- Checksum / 校验和:
  `778dde347e397b96208f1d7303a540935afe2115f60823eaa48e3e9ac1ff7fb0`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.93%.
- Marked-pixel bounds: (76,16)–(173,231); span 98 × 216 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.93%。
- 痕迹范围：(76,16)–(173,231)；跨度98 × 216 px；痕迹矩形高于宽。
