# obs-comp-cand-001806 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001806`
- 首选外部 ID: `obimd-sub-acmz4sm7sc`
- OBIMD subcharacter UID: `acmz4sm7sc`
...
- glyph-codepoint 数: `9`
- codepoint 示例: U+36BB;U+FA59A; U+FA59B; 另有 7 项
