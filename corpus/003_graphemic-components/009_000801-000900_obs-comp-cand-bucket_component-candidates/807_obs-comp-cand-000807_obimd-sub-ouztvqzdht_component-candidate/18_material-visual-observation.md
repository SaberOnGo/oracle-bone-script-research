# Material Visual Observation / obs-comp-cand-000807 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000807`
- External reference / 外部参照: `obimd-sub-ouztvqzdht`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013604_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/eadbesllam/ouztvqzdht/ouztvqzdht.png`
- Checksum / 校验和:
  `f790ab3c90df2752a17050421e520f3f389ebce0f960f6f750a0a0ed34566c22`
...
- Marked-pixel bounds: (57,34)–(192,218); span 136 × 185 px; the marked
...
- 痕迹范围：(57,34)–(192,218)；跨度136 × 185 px；痕迹矩形高于宽。
