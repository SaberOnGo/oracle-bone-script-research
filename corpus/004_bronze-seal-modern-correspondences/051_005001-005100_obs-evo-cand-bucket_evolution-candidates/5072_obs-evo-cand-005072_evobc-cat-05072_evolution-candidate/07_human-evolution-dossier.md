...
- External category reference: `evobc-cat-05072`
- Source category ID: `05072`
- Source label for human review: `烝`
...
- `obs-evo-cand-005072-route-category-staging`
...
- `obs-evo-cand-005072-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005072-route-evolution-graph`
