# obs-comp-cand-000041 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000041`
- 首选外部 ID: `obimd-sub-owcp73s8go`
- OBIMD subcharacter UID: `owcp73s8go`
- OBIMD main character UID: `owcp73s8go`
- 来源 ID: `src-obimd`
