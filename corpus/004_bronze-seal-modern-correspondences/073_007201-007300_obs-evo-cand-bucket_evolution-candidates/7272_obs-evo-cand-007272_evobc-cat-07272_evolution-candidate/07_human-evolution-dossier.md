...
- Project ID: `obs-evo-cand-007272`
- EVOBC category candidate ID: `evobc-evo-cat-07272`
- External category reference: `evobc-cat-07272`
- Source category ID: `07272`
- Source label for human review: `苍`
- Source codepoints: `U+82CD`
...
- `obs-evo-cand-007272-route-category-staging`
...
- `obs-evo-cand-007272-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007272-route-evolution-graph`
