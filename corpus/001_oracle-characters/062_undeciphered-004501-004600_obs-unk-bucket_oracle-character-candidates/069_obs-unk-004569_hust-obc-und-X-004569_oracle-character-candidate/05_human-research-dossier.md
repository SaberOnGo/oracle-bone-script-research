# obs-unk-004569 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/069_obs-unk-004569_h
  ust-obc-und-X-004569_oracle-character-candidate/03_visual-assets/001_asset
  -006162_hust-obc-und-X-004569_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/125/X_？_7213_1.png`
- asset id: `asset-006162`
...
- source class: `HUST-OBC/undeciphered/X/125/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/125/X_？_7213_1.png`
- asset id: `asset-006162`
...
- English observation: `Large left curve, two openings, and hooked endpoints`
  `recorded.`
- 中文观察: `已记录左侧大弧线、两个开口和带钩末端。`
...
- Which source records identify obs-unk-004569 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004569？
