# Material Visual Observation / obs-comp-cand-000931 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000931`
- External reference / 外部参照: `obimd-sub-yott4ymzt7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014014_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/00bv3k93fk/yott4ymzt7/yott4ymzt7.png`
- Checksum / 校验和:
  `e350728649e8154831e9adfa715229267ec3e178b274132b07d68d18f97b118d`
...
- Marked-pixel bounds: (77,27)–(171,224); span 95 × 198 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.04%。
- 痕迹范围：(77,27)–(171,224)；跨度95 × 198 px；痕迹矩形高于宽。
