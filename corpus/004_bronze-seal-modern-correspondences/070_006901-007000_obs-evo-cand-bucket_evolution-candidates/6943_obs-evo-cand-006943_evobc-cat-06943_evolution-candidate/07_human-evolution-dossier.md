...
- Project ID: `obs-evo-cand-006943`
- EVOBC category candidate ID: `evobc-evo-cat-06943`
- External category reference: `evobc-cat-06943`
- Source category ID: `06943`
- Source label for human review: `职`
- Source codepoints: `U+804C`
...
- `obs-evo-cand-006943-route-category-staging`
...
- `obs-evo-cand-006943-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006943-route-evolution-graph`
