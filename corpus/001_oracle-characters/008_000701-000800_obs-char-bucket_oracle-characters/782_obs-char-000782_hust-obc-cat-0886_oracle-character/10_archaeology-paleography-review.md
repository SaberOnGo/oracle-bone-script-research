# obs-char-000782 Archaeology Paleography Review

# obs-char-000782 考古文字复核档案
...
- first local image: `001_asset-000787_hust-obc-cat-0886_glyph.png`
- first source image: `G_0886_粹1276(甲).png`
...
- source label text: `㝬`
- source label codepoints: `U+376C`
