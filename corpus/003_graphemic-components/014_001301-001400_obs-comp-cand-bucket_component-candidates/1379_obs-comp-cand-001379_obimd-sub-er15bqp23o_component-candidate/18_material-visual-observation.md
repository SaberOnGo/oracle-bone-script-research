# Material Visual Observation / obs-comp-cand-001379 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001379`
- External reference / 外部参照: `obimd-sub-er15bqp23o`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015798_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/c7qvt9bwt5/er15bqp23o/er15bqp23o.png`
- Checksum / 校验和:
  `ec2d9bfc9abc761f25b79b931f61f07ca8dfd47d00b258051d07b80d2063cfab`
...
- Marked-pixel bounds: (80,23)–(168,224); span 89 × 202 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.60%。
- 痕迹范围：(80,23)–(168,224)；跨度89 × 202 px；痕迹矩形高于宽。
