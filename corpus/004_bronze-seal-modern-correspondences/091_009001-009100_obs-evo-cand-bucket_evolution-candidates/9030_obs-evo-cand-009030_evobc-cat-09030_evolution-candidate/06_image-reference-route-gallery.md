...
- `obs-evo-cand-009030-route-category-staging`
...
- `obs-evo-cand-009030-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009030-route-evolution-graph`
