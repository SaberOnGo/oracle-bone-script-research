# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004713
...
- EVOBC candidate category: `evobc-evo-cat-04713`.
- Source label for search only: `淋`.
- Source codepoints for search only: `U+6DCB`.
