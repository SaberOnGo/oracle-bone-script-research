# obs-char-000101 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/101_obs-char-000101_hust-obc-cat-0112_orac
  le-character/03_visual-assets/001_asset-000106_hust-obc-cat-0112_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0112/G_0112_乙8896合22246子組.png`
- asset id: `asset-000106`
...
- source category: `0112`
- validation class: `100`
- source image route: `HUST-OBC/deciphered/0112/G_0112_乙8896合22246子組.png`
- asset id: `asset-000106`
...
- English observation: `The image has a tall central axis, rounded enclosed
  marks on both sides, and a short hooked stroke near the upper right.`
...
- dataset label text: `㑦`
- dataset label codepoints: `U+3466`
...
- Which source records identify obs-char-000101 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000101？
