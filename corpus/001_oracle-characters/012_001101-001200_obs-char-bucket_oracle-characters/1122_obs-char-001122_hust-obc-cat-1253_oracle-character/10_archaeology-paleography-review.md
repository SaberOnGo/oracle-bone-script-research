# obs-char-001122 Archaeology Paleography Review

# obs-char-001122 考古文字复核档案
...
- project id: `obs-char-001122`
- primary external id: `hust-obc-cat-1253`
...
- first local image: `001_asset-001127_hust-obc-cat-1253_glyph.png`
- first source image: `G_1253_乙3415反合12939反賓組.png`
...
- graph edge count: `3`
- graph edge types: CHARACTER_HAS_HUST_OBC_CODEPOINT_LOOKUP_ROUTE; plus 2 more
- codepoint routes: U+38DB
...
- source label text: `㣛`
- source label codepoints: `U+38DB`
