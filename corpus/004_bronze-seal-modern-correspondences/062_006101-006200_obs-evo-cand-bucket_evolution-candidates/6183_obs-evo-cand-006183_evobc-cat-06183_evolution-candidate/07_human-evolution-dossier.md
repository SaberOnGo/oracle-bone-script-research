...
Project ID: `obs-evo-cand-006183`
...
- Project ID: `obs-evo-cand-006183`
- EVOBC category candidate ID: `evobc-evo-cat-06183`
- External category reference: `evobc-cat-06183`
- Source category ID: `06183`
- Source label for human review: `窵`
- Source codepoints: `U+7AB5`
...
- `obs-evo-cand-006183-route-category-staging`
...
- `obs-evo-cand-006183-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006183-route-evolution-graph`
