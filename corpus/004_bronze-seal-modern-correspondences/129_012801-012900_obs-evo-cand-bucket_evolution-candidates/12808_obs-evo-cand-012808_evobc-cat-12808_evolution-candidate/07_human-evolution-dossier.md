...
- External category reference: `evobc-cat-12808`
- Source category ID: `12808`
- Source label for human review: `𪠮`
...
- `obs-evo-cand-012808-route-category-staging`
...
- `obs-evo-cand-012808-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012808-route-evolution-graph`
