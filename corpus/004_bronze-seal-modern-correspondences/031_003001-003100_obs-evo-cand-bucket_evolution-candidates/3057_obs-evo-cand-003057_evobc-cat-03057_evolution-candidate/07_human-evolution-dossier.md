...
- External category reference: `evobc-cat-03057`
- Source category ID: `03057`
- Source label for human review: `惣`
- Source codepoints: `U+60E3`
...
- `obs-evo-cand-003057-route-category-staging`
...
- `obs-evo-cand-003057-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003057-route-evolution-graph`
