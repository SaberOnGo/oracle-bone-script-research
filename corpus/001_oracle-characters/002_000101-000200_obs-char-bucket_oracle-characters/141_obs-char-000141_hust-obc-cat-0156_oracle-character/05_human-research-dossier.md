# obs-char-000141 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/141_obs-char-000141_hust-obc-cat-0156_orac
  le-character/03_visual-assets/001_asset-000146_hust-obc-cat-0156_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0156/G_0156_存477合18690賓組.png`
- asset id: `asset-000146`
...
- source category: `0156`
- validation class: `140`
- source image route: `HUST-OBC/deciphered/0156/G_0156_存477合18690賓組.png`
- asset id: `asset-000146`
...
- English observation: `The image has an angled upper cap above a compact
  grid-like middle form, with several short uprights extending below the
  lower edge.`
...
- dataset label text: `㒒`
- dataset label codepoints: `U+3492`
...
- filename catalog route clues: `Heji-like filename clue: 合18690
  (G_0156_存477合18690賓組.png)`
...
- Which source records identify obs-char-000141 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000141？
