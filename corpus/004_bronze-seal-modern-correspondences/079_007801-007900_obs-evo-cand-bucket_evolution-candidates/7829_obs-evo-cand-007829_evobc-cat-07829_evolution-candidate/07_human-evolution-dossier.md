...
- External category reference: `evobc-cat-07829`
- Source category ID: `07829`
- Source label for human review: `螙`
...
- `obs-evo-cand-007829-route-category-staging`
...
- `obs-evo-cand-007829-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007829-route-evolution-graph`
