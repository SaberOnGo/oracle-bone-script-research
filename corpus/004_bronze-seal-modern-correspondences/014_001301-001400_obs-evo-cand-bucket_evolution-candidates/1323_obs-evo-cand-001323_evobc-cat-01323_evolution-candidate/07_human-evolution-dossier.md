...
- External category reference: `evobc-cat-01323`
- Source category ID: `01323`
- Source label: `勿`
...
- `obs-evo-cand-001323-route-category-staging`
...
- `obs-evo-cand-001323-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001323-route-evolution-graph`
