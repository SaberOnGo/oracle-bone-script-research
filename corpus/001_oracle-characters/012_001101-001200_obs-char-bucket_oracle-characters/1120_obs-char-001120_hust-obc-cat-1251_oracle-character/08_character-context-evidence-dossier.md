...
- Project ID / 项目 ID: `obs-char-001120`
- Primary external ID / 首选外部 ID: `hust-obc-cat-1251`
...
- Source image / 来源图: `G_1251_甲262(甲).png`
- Image / 图像: `001_asset-001125_hust-obc-cat-1251_glyph.png`
...
- target node: `obimd-main-cand-002637`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- target node: `evobc-evo-cat-00107`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC image references / EvoBC 图像引用数: `5`
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/107_obs-evo-cand-000107_evobc-cat-00107_evoluti
...
- Matched OBIMD main UIDs / OBIMD 主字 UID: `vha0ssegay`
...
- Source label text / 来源标签文字: `㣙`
- Source label codepoint / 来源标签 codepoint: `U+38D9`
