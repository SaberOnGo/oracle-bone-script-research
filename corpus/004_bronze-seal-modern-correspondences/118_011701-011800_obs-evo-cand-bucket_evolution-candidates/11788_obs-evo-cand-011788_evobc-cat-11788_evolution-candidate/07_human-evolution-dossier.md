...
- External category reference: `evobc-cat-11788`
- Source category ID: `11788`
- Source label for human review: `𥉴`
...
- `obs-evo-cand-011788-route-category-staging`
...
- `obs-evo-cand-011788-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011788-route-evolution-graph`
