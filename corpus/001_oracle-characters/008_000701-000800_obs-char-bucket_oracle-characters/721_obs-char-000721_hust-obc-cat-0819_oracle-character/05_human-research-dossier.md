# obs-char-000721 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/721_obs-char-000721_hust-obc-cat-0819_orac
  le-character/03_visual-assets/001_asset-000726_hust-obc-cat-0819_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0819/G_0819_乙6738合14735賓組.png`
- asset id: `asset-000726`
...
- source category: `0819`
- validation class: `720`
- source image route: `HUST-OBC/deciphered/0819/G_0819_乙6738合14735賓組.png`
- asset id: `asset-000726`
...
- English observation: `A broad top bar joins two long descending sides;
  three short bars project from the left side, while curved lower strokes
  cross and spread along the base.`
...
- dataset label text: `㜩`
- dataset label codepoints: `U+3729`
...
- filename catalog route clues: `Heji-like filename clue: 合14735
  (G_0819_乙6738合14735賓組.png)`
...
- Which source records identify obs-char-000721 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000721？
