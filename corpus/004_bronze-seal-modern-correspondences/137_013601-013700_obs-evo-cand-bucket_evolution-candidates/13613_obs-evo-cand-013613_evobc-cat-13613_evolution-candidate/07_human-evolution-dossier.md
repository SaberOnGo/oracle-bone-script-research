...
- External category reference: `evobc-cat-13613`
- Source category ID: `13613`
- Source label for human review: `𮊊`
...
- `obs-evo-cand-013613-route-category-staging`
...
- `obs-evo-cand-013613-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013613-route-evolution-graph`
