...
- Project ID: `obs-evo-cand-003437`
- EVOBC category candidate ID: `evobc-evo-cat-03437`
- External category reference: `evobc-cat-03437`
- Source category ID: `03437`
- Source label for human review: `揫`
- Source codepoints: `U+63EB`
...
- `obs-evo-cand-003437-route-category-staging`
...
- `obs-evo-cand-003437-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003437-route-evolution-graph`
