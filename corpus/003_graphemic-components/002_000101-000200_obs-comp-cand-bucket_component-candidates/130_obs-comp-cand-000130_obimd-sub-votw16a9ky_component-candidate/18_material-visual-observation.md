# Material Visual Observation / obs-comp-cand-000130 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000130`
- External reference / 外部参照: `obimd-sub-votw16a9ky`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011542_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/yvbokzhzmz/votw16a9ky/votw16a9ky.png`
- Checksum / 校验和:
  `a88722eb0f4e458e00b4913a09ded92f503b8995c5e02ff5af1cf1e1edae6356`
...
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.63%。
