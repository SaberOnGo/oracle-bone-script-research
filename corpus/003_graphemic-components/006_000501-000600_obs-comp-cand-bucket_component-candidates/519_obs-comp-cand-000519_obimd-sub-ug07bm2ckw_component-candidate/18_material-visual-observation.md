# Material Visual Observation / obs-comp-cand-000519 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000519`
- External reference / 外部参照: `obimd-sub-ug07bm2ckw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012754_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ug07bm2ckw/ug07bm2ckw/ug07bm2ckw.png`
- Checksum / 校验和:
  `a6d3b9ff6d7106afa142cb0ae2ba9f8aef8a62e9b7ef400d083de78ed9838ec2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.45%.
- Marked-pixel bounds: (60,27)–(189,219); span 130 × 193 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.45%。
- 痕迹范围：(60,27)–(189,219)；跨度130 × 193 px；痕迹矩形高于宽。
