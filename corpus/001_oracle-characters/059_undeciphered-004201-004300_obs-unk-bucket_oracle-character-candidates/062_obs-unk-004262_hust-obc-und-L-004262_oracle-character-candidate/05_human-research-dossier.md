# obs-unk-004262 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004262`
- primary external id: `hust-obc-und-L-004262`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/062_obs-unk-004262_h
  ust-obc-und-L-004262_oracle-character-candidate/03_visual-assets/001_asset
  -005855_hust-obc-und-L-004262_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4262/L_？_9392.jpg`
- asset id: `asset-005855`
...
- source class: `HUST-OBC/undeciphered/L/4262/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4262/L_？_9392.jpg`
- asset id: `asset-005855`
...
- English observation: `Central vertical, short crosses, right curve visible.`
- 中文观察: `中央竖痕、短交叉痕迹和右侧弯曲痕迹可见。`
...
- Which source records identify obs-unk-004262 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004262？
