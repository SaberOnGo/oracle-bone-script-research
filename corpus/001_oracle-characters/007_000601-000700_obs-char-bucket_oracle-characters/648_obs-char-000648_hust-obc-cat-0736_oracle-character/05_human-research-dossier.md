# obs-char-000648 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000648`
- primary external id: `hust-obc-cat-0736`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/648_obs-char-000648_hust-obc-cat-0736_orac
  le-character/03_visual-assets/001_asset-000653_hust-obc-cat-0736_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0736/G_0736_前6.29.5(甲).png`
- asset id: `asset-000653`
...
- source category: `0736`
- validation class: `647`
- source image route: `HUST-OBC/deciphered/0736/G_0736_前6.29.5(甲).png`
- asset id: `asset-000653`
...
- English observation: `A complex thin cluster combines pointed upper
  branches, a small central loop, several crossings, and an open lower
  framework; a long separate upright stands at right.`
- 中文观察: `复杂纤细笔群结合尖形上枝、小中央环、数处交叉和开口下框，右侧另有长分离竖笔。`
...
- dataset label text: `㛖`
- dataset label codepoints: `U+36D6`
...
- Which source records identify obs-char-000648 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000648？
