...
Project ID: `obs-evo-cand-011657`
...
- Project ID: `obs-evo-cand-011657`
- EVOBC category candidate ID: `evobc-evo-cat-11657`
- External category reference: `evobc-cat-11657`
- Source category ID: `11657`
- Source label for human review: `𤯍`
- Source codepoints: `U+24BCD`
...
- `obs-evo-cand-011657-route-category-staging`
...
- `obs-evo-cand-011657-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011657-route-evolution-graph`
