# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-009145
...
- EVOBC candidate category: `evobc-evo-cat-09145`.
- Source label for search only: `郛`.
- Source codepoints for search only: `U+90DB`.
