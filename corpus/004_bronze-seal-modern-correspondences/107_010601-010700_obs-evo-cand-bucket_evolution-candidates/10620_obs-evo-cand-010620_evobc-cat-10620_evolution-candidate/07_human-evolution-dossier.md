...
Project ID: `obs-evo-cand-010620`
...
- Project ID: `obs-evo-cand-010620`
- EVOBC category candidate ID: `evobc-evo-cat-10620`
- External category reference: `evobc-cat-10620`
- Source category ID: `10620`
- Source label for human review: `麤`
- Source codepoints: `U+9EA4`
...
- `obs-evo-cand-010620-route-category-staging`
...
- `obs-evo-cand-010620-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010620-route-evolution-graph`
