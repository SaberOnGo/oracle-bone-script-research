...
Project ID: `obs-evo-cand-001291`
...
- Project ID: `obs-evo-cand-001291`
- EVOBC category candidate ID: `evobc-evo-cat-01291`
- External category reference: `evobc-cat-01291`
- Source category ID: `01291`
- Source label for human review: `勎`
- Source codepoints: `U+52CE`
...
- `obs-evo-cand-001291-route-category-staging`
...
- `obs-evo-cand-001291-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001291-route-evolution-graph`
