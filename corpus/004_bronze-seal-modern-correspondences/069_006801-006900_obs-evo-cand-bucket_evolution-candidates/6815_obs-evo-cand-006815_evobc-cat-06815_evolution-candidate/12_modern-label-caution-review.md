# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006815
...
- EVOBC candidate category: `evobc-evo-cat-06815`.
- Source label for search only: `罪`.
- Source codepoints for search only: `U+7F6A`.
