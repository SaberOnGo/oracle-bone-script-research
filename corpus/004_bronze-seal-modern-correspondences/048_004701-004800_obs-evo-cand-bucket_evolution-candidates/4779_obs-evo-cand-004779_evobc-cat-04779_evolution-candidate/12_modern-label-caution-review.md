# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004779
...
- EVOBC candidate category: `evobc-evo-cat-04779`.
- Source label for search only: `湊`.
- Source codepoints for search only: `U+6E4A`.
