# Material Visual Observation / obs-comp-cand-002261 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002261`
- External reference / 外部参照: `obimd-sub-z501bkm67b`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020074_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/z501bkm67b/z501bkm67b/z501bkm67b.png`
- Checksum / 校验和:
  `111e22b81d587ded6e74d055c5c0ff52f41d91513781afc53019bc6cc354f9a9`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.54%.
- Marked-pixel bounds: (53,20)–(181,225); span 129 × 206 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.54%。
- 痕迹范围：(53,20)–(181,225)；跨度129 × 206 px；痕迹矩形高于宽。
