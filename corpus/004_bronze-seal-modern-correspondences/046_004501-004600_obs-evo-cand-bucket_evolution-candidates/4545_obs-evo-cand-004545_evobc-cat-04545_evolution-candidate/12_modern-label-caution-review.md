# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004545
...
- EVOBC candidate category: `evobc-evo-cat-04545`.
- Source label for search only: `沛`.
- Source codepoints for search only: `U+6C9B`.
