# Material Visual Observation / obs-comp-cand-001714 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001714`
- External reference / 外部参照: `obimd-sub-r7o3rpnkqu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017859_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/pmwfonj2ag/r7o3rpnkqu/r7o3rpnkqu.png`
- Checksum / 校验和:
  `55d4460410a67dfe38b17639c24044aa3c95d0fc3e28247aeac75c6ac6dfb24e`
...
- Marked-pixel bounds: (89,28)–(179,215); span 91 × 188 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.72%。
- 痕迹范围：(89,28)–(179,215)；跨度91 × 188 px；痕迹矩形高于宽。
