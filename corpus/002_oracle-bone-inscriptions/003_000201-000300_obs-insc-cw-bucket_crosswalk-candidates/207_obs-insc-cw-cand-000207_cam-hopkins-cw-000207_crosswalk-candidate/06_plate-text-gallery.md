...
Project ID: `obs-insc-cw-cand-000207`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000207`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000207` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y1209` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `81` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `734` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `40452` [route_present_image_or_text_not_collected]
