...
- External category reference: `evobc-cat-10493`
- Source category ID: `10493`
- Source label for human review: `鴠`
...
- `obs-evo-cand-010493-route-category-staging`
...
- `obs-evo-cand-010493-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010493-route-evolution-graph`
