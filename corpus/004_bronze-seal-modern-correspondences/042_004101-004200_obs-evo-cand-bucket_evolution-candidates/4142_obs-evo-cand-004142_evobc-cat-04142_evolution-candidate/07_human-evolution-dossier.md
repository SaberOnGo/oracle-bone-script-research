...
- Project ID: `obs-evo-cand-004142`
- EVOBC category candidate ID: `evobc-evo-cat-04142`
- External category reference: `evobc-cat-04142`
- Source category ID: `04142`
- Source label for human review: `楇`
- Source codepoints: `U+6947`
...
- `obs-evo-cand-004142-route-category-staging`
...
- `obs-evo-cand-004142-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004142-route-evolution-graph`
