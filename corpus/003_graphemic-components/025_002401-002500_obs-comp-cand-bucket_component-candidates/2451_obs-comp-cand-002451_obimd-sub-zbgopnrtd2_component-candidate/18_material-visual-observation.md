# Material Visual Observation / obs-comp-cand-002451 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002451`
- External reference / 外部参照: `obimd-sub-zbgopnrtd2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020636_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fom5bv844r/zbgopnrtd2/zbgopnrtd2.png`
- Checksum / 校验和:
  `ccea779b989f2cf9e9b9f7d21e15f3b351044c1e4981cba7569eaf5075a80298`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.84%.
- Marked-pixel bounds: (77,46)–(181,208); span 105 × 163 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.84%。
- 痕迹范围：(77,46)–(181,208)；跨度105 × 163 px；痕迹矩形高于宽。
