...
Project ID: `obs-evo-cand-008538`
...
- Project ID: `obs-evo-cand-008538`
- EVOBC category candidate ID: `evobc-evo-cat-08538`
- External category reference: `evobc-cat-08538`
- Source category ID: `08538`
- Source label for human review: `貣`
- Source codepoints: `U+8CA3`
...
- `obs-evo-cand-008538-route-category-staging`
...
- `obs-evo-cand-008538-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008538-route-evolution-graph`
