...
Project ID: `obs-evo-cand-004976`
...
- Project ID: `obs-evo-cand-004976`
- EVOBC category candidate ID: `evobc-evo-cat-04976`
- External category reference: `evobc-cat-04976`
- Source category ID: `04976`
- Source label for human review: `濱`
- Source codepoints: `U+6FF1`
...
- `obs-evo-cand-004976-route-category-staging`
...
- `obs-evo-cand-004976-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004976-route-evolution-graph`
