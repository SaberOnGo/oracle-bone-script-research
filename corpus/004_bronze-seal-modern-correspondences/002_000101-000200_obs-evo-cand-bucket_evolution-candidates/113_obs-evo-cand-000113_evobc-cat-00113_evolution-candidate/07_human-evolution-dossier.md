...
- External category reference: `evobc-cat-00113`
- Source category ID: `00113`
- Source label for human review: `㤅`
...
- `obs-evo-cand-000113-route-category-staging`
...
- `obs-evo-cand-000113-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000113-route-evolution-graph`
