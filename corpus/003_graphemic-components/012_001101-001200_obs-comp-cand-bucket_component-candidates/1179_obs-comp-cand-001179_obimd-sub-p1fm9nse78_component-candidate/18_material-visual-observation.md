# Material Visual Observation / obs-comp-cand-001179 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001179`
- External reference / 外部参照: `obimd-sub-p1fm9nse78`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015369_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/p1fm9nse78/p1fm9nse78/p1fm9nse78.png`
- Checksum / 校验和:
  `31e6a04754085d3b52fb6f9025eac07ab7ef6138e0278f2f44febfa16818853e`
...
- Marked-pixel bounds: (65,47)–(184,207); span 120 × 161 px; the marked
...
- 痕迹范围：(65,47)–(184,207)；跨度120 × 161 px；痕迹矩形高于宽。
