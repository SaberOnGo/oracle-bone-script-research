# obs-unk-004786 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004786`
- primary external id: `hust-obc-und-X-004786`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/086_obs-unk-004786_h
  ust-obc-und-X-004786_oracle-character-candidate/03_visual-assets/001_asset
  -006379_hust-obc-und-X-004786_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/342/X_？_7324_1.png`
- asset id: `asset-006379`
...
- source class: `HUST-OBC/undeciphered/X/342/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/342/X_？_7324_1.png`
- asset id: `asset-006379`
...
- English observation: `upper openings and lower polarity artifact`
- 中文观察: `上部开口和下部极性图像伪影`
...
- Which source records identify obs-unk-004786 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004786？
