...
- External category reference: `evobc-cat-10598`
- Source category ID: `10598`
- Source label for human review: `鹿`
...
- `obs-evo-cand-010598-route-category-staging`
...
- `obs-evo-cand-010598-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010598-route-evolution-graph`
