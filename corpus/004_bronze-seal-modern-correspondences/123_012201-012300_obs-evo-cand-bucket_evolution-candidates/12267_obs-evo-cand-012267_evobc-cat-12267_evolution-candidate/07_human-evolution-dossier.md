...
- External category reference: `evobc-cat-12267`
- Source category ID: `12267`
- Source label for human review: `𧰭`
...
- `obs-evo-cand-012267-route-category-staging`
...
- `obs-evo-cand-012267-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012267-route-evolution-graph`
