...
- External category reference: `evobc-cat-12525`
- Source category ID: `12525`
- Source label for human review: `𨻗`
- Source codepoints: `U+28ED7`
...
- `obs-evo-cand-012525-route-category-staging`
...
- `obs-evo-cand-012525-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012525-route-evolution-graph`
