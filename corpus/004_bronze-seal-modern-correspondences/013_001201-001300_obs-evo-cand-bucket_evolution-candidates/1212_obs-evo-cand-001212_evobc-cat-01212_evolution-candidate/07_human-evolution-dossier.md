...
- External category reference: `evobc-cat-01212`
- Source category ID: `01212`
- Source label for human review: `刻`
- Source codepoints: `U+523B`
...
- `obs-evo-cand-001212-route-category-staging`
...
- `obs-evo-cand-001212-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001212-route-evolution-graph`
