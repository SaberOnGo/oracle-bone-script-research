...
- External category reference: `evobc-cat-02826`
- Source category ID: `02826`
- Source label for human review: `彌`
- Source codepoints: `U+5F4C`
...
- `obs-evo-cand-002826-route-category-staging`
...
- `obs-evo-cand-002826-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002826-route-evolution-graph`
