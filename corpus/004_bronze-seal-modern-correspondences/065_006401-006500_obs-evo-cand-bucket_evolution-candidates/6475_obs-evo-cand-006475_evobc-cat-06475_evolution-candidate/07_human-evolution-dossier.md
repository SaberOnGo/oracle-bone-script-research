...
- External category reference: `evobc-cat-06475`
- Source category ID: `06475`
- Source label for human review: `累`
- Source codepoints: `U+7D2F`
...
- `obs-evo-cand-006475-route-category-staging`
...
- `obs-evo-cand-006475-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006475-route-evolution-graph`
