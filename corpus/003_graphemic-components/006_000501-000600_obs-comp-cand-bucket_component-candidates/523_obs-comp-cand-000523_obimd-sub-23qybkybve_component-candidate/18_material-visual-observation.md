# Material Visual Observation / obs-comp-cand-000523 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000523`
- External reference / 外部参照: `obimd-sub-23qybkybve`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012758_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/nq3neh9i5i/23qybkybve/23qybkybve.png`
- Checksum / 校验和:
  `7bd23f30453348cc8dbf6b80025e09b8edd1baa6370b6c687080b73cb16d9d90`
...
- Marked-pixel bounds: (91,30)–(158,217); span 68 × 188 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.20%。
- 痕迹范围：(91,30)–(158,217)；跨度68 × 188 px；痕迹矩形高于宽。
