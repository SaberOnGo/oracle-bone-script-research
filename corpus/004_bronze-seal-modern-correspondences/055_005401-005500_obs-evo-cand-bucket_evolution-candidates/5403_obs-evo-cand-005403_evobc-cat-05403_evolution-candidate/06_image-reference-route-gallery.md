...
- `obs-evo-cand-005403-route-category-staging`
...
- `obs-evo-cand-005403-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005403-route-evolution-graph`
