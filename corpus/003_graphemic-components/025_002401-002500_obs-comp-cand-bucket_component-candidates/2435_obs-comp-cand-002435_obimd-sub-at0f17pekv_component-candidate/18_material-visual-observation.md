# Material Visual Observation / obs-comp-cand-002435 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002435`
- External reference / 外部参照: `obimd-sub-at0f17pekv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020607_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/at0f17pekv/at0f17pekv/at0f17pekv.png`
- Checksum / 校验和:
  `cc83e28eb3117a8172991dd04235572ae39b2cce06d2d13fc0a3e67457be64f2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.36%.
- Marked-pixel bounds: (76,22)–(184,227); span 109 × 206 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.36%。
- 痕迹范围：(76,22)–(184,227)；跨度109 × 206 px；痕迹矩形高于宽。
