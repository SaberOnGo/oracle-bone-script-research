...
Project ID: `obs-evo-cand-002305`
...
- Project ID: `obs-evo-cand-002305`
- EVOBC category candidate ID: `evobc-evo-cat-02305`
- External category reference: `evobc-cat-02305`
- Source category ID: `02305`
- Source label for human review: `嬩`
- Source codepoints: `U+5B29`
...
- `obs-evo-cand-002305-route-category-staging`
...
- `obs-evo-cand-002305-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002305-route-evolution-graph`
