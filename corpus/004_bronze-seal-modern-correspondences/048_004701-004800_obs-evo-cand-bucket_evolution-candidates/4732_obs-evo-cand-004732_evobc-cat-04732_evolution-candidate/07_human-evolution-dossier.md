...
- External category reference: `evobc-cat-04732`
- Source category ID: `04732`
- Source label for human review: `淫`
...
- `obs-evo-cand-004732-route-category-staging`
...
- `obs-evo-cand-004732-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004732-route-evolution-graph`
