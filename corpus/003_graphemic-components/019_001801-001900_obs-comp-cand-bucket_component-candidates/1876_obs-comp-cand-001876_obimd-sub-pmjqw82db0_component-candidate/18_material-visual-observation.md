# Material Visual Observation / obs-comp-cand-001876 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001876`
- External reference / 外部参照: `obimd-sub-pmjqw82db0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018255_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/pmjqw82db0/pmjqw82db0/pmjqw82db0.png`
- Checksum / 校验和:
  `7861b66dd5b74df55a6ced3b102a72fdea7910e3906758acc07247ccf3a164f2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.15%.
- Marked-pixel bounds: (44,24)–(212,227); span 169 × 204 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.15%。
- 痕迹范围：(44,24)–(212,227)；跨度169 × 204 px；痕迹矩形高于宽。
