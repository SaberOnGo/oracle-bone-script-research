# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008470
...
- EVOBC candidate category: `evobc-evo-cat-08470`.
- Source label for search only: `谻`.
- Source codepoints for search only: `U+8C3B`.
