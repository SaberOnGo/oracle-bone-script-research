# obs-comp-cand-001264 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001264`
- 首选外部 ID: `obimd-sub-hvoexje4ex`
- OBIMD subcharacter UID: `hvoexje4ex`
- OBIMD main character UID: `hvoexje4ex`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `6`
- codepoint 示例: U+A9987;U+F74A9; U+F74AA; 另有 4 项
