...
- External category reference: `evobc-cat-13043`
- Source category ID: `13043`
- Source label for human review: `𫨙`
...
- `obs-evo-cand-013043-route-category-staging`
...
- `obs-evo-cand-013043-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013043-route-evolution-graph`
