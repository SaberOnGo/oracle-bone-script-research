# obs-char-001564 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1564_obs-char-001564_hust-obc-cat-1755_ora
  cle-character/03_visual-assets/001_asset-001569_hust-obc-cat-1755_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1755/G_1755_續3.458(甲).png`
- asset id: `asset-001569`
...
- source category: `1755`
- validation class: `1563`
- source image route: `HUST-OBC/deciphered/1755/G_1755_續3.458(甲).png`
- asset id: `asset-001569`
...
- dataset label text: `㫑`
- dataset label codepoints: `U+3AD1`
...
- Which source records identify obs-char-001564 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001564？
