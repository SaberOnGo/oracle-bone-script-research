...
- External category reference: `evobc-cat-09447`
- Source category ID: `09447`
- Source label for human review: `錸`
...
- `obs-evo-cand-009447-route-category-staging`
...
- `obs-evo-cand-009447-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009447-route-evolution-graph`
