# obs-char-000232 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000232`
- primary external id: `hust-obc-cat-0258_0259`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/232_obs-char-000232_hust-obc-cat-0258_0259
  _oracle-character/03_visual-assets/001_asset-000237_hust-obc-cat-0258_0259
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0258_0259/0258/G_0258_乙1174合218
  78子組.png`
- asset id: `asset-000237`
...
- source category: `0258_0259`
- validation class: `231`
- source image route: `HUST-OBC/deciphered/0258_0259/0258/G_0258_乙1174合21878子組
  .png`
- asset id: `asset-000237`
...
- English observation: `The small image shows a single long curved stroke
  with a short horizontal branch near the upper middle; the lower end is
  partly faint.`
- 中文观察: `小幅图像可见一条长弯曲笔画，上部中段有短横向分支；下端部分较浅。`
...
- dataset label text: `㓸㓹`
- dataset label codepoints: `U+34F8;U+34F9`
...
- graph edge count: `2`
- codepoint routes: `U+34F8;U+34F9`
...
- filename catalog route clues: `Heji-like filename clue: 合21878
...
- Which source records identify obs-char-000232 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000232？
