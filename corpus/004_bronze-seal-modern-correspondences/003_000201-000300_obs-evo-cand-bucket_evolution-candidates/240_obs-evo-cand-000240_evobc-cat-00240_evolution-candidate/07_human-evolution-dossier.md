...
- External category reference: `evobc-cat-00240`
- Source category ID: `00240`
- Source label for human review: `㻃`
...
- `obs-evo-cand-000240-route-category-staging`
...
- `obs-evo-cand-000240-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000240-route-evolution-graph`
