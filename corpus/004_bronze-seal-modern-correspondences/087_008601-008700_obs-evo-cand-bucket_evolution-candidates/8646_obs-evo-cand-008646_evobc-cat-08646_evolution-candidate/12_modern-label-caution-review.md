# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008646
...
- EVOBC candidate category: `evobc-evo-cat-08646`.
- Source label for search only: `赚`.
- Source codepoints for search only: `U+8D5A`.
