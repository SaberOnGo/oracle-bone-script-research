# obs-comp-cand-001743 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001743`
- 首选外部 ID: `obimd-sub-lvgrvm4vun`
- OBIMD subcharacter UID: `lvgrvm4vun`
- OBIMD main character UID: `fybnj2savm`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+FA19B; U+FA19C; 另有 2 项
