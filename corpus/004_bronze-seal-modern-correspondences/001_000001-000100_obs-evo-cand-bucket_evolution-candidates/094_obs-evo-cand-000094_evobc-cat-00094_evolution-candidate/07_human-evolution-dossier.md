...
- External category reference: `evobc-cat-00094`
- Source category ID: `00094`
- Source label for human review: `㡴`
- Source codepoints: `U+3874`
...
- `obs-evo-cand-000094-route-category-staging`
...
- `obs-evo-cand-000094-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000094-route-evolution-graph`
