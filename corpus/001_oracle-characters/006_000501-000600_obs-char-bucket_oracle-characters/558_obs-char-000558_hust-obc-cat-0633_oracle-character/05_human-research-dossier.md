# obs-char-000558 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/558_obs-char-000558_hust-obc-cat-0633_orac
  le-character/03_visual-assets/001_asset-000563_hust-obc-cat-0633_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0633/X_0633_4346_1.png`
- asset id: `asset-000563`
...
- source category: `0633`
- validation class: `557`
- source image route: `HUST-OBC/deciphered/0633/X_0633_4346_1.png`
- asset id: `asset-000563`
...
- English observation: `A large tall rectangular outer outline with a
  stepped lower-left side surrounds an upper three-lobed loop joined to a
  branching central stroke and long lower lines.`
...
- dataset label text: `㙯`
- dataset label codepoints: `U+366F`
...
- Which source records identify obs-char-000558 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000558？
