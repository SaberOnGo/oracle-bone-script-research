...
- External category reference: `evobc-cat-07223`
- Source category ID: `07223`
- Source label for human review: `艺`
...
- `obs-evo-cand-007223-route-category-staging`
...
- `obs-evo-cand-007223-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007223-route-evolution-graph`
