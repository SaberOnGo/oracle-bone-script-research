...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1202`
...
- Source image / 来源图: `G_1202_拾5.7(甲).png`
- Image / 图像: `001_asset-001080_hust-obc-cat-1202_glyph.png`
...
- target node: `evobc-evo-cat-00100`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/100_obs-evo-cand-000100_evobc-cat-00100_evoluti
...
- Source label text / 来源标签文字: `㢨`
- Source label codepoint / 来源标签 codepoint: `U+38A8`
