# obs-comp-cand-001357 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001357`
- 首选外部 ID: `obimd-sub-11yn2rw7ug`
- OBIMD subcharacter UID: `11yn2rw7ug`
- OBIMD main character UID: `tsa3qlzed1`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+F7B40; U+F7B41; 另有 2 项
