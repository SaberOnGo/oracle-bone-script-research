...
- Project ID: `obs-evo-cand-007019`
- EVOBC category candidate ID: `evobc-evo-cat-07019`
- External category reference: `evobc-cat-07019`
- Source category ID: `07019`
- Source label for human review: `胈`
- Source codepoints: `U+80C8`
...
- `obs-evo-cand-007019-route-category-staging`
...
- `obs-evo-cand-007019-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007019-route-evolution-graph`
