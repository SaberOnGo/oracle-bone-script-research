...
- External category reference: `evobc-cat-03937`
- Source category ID: `03937`
- Source label for human review: `枵`
- Source codepoints: `U+67B5`
...
- `obs-evo-cand-003937-route-category-staging`
...
- `obs-evo-cand-003937-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003937-route-evolution-graph`
