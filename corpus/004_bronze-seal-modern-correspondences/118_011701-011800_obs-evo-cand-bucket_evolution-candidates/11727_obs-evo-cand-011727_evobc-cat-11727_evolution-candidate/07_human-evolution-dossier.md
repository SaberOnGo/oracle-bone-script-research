...
- External category reference: `evobc-cat-11727`
- Source category ID: `11727`
- Source label for human review: `𤻀`
...
- `obs-evo-cand-011727-route-category-staging`
...
- `obs-evo-cand-011727-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011727-route-evolution-graph`
