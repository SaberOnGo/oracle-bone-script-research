...
- External category reference: `evobc-cat-11327`
- Source category ID: `11327`
- Source label for human review: `𢻹`
...
- `obs-evo-cand-011327-route-category-staging`
...
- `obs-evo-cand-011327-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011327-route-evolution-graph`
