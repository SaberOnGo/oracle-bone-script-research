# Material Visual Observation / obs-comp-cand-000924 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000924`
- External reference / 外部参照: `obimd-sub-88wwlkidbf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014007_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bw6bl0elx5/88wwlkidbf/88wwlkidbf.png`
- Checksum / 校验和:
  `b6f57efaa9f15110eef930e5b5f7f57e386c986356abe3bde2533d9ca9955cca`
...
- Marked-pixel bounds: (76,22)–(173,224); span 98 × 203 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.68%。
- 痕迹范围：(76,22)–(173,224)；跨度98 × 203 px；痕迹矩形高于宽。
