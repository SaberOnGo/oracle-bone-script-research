...
- External category reference: `evobc-cat-03844`
- Source category ID: `03844`
- Source label for human review: `朢`
- Source codepoints: `U+6722`
...
- `obs-evo-cand-003844-route-category-staging`
...
- `obs-evo-cand-003844-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003844-route-evolution-graph`
