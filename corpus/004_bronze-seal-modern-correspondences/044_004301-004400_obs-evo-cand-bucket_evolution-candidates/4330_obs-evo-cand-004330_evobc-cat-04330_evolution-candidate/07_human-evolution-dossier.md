...
Project ID: `obs-evo-cand-004330`
...
- Project ID: `obs-evo-cand-004330`
- EVOBC category candidate ID: `evobc-evo-cat-04330`
- External category reference: `evobc-cat-04330`
- Source category ID: `04330`
- Source label for human review: `權`
- Source codepoints: `U+6B0A`
...
- `obs-evo-cand-004330-route-category-staging`
...
- `obs-evo-cand-004330-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004330-route-evolution-graph`
