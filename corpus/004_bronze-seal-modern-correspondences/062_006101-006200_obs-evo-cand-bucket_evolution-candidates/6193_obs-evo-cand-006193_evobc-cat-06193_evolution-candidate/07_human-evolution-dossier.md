...
Project ID: `obs-evo-cand-006193`
...
- Project ID: `obs-evo-cand-006193`
- EVOBC category candidate ID: `evobc-evo-cat-06193`
- External category reference: `evobc-cat-06193`
- Source category ID: `06193`
- Source label for human review: `竇`
- Source codepoints: `U+7AC7`
...
- `obs-evo-cand-006193-route-category-staging`
...
- `obs-evo-cand-006193-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006193-route-evolution-graph`
