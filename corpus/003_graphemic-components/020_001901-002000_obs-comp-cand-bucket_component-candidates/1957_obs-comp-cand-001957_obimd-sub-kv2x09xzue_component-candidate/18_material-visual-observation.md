# Material Visual Observation / obs-comp-cand-001957 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001957`
- External reference / 外部参照: `obimd-sub-kv2x09xzue`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018767_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/knps4jrxz3/kv2x09xzue/kv2x09xzue.png`
- Checksum / 校验和:
  `b16bbd1e6281ec3ae41c5cd790eaeb38203a140833189c9d7891b80093d341ce`
...
- Marked-pixel bounds: (81,46)–(166,213); span 86 × 168 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.48%。
- 痕迹范围：(81,46)–(166,213)；跨度86 × 168 px；痕迹矩形高于宽。
