# Material Visual Observation / obs-comp-cand-001038 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001038`
- External reference / 外部参照: `obimd-sub-q0usnwdsfn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014531_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/mxjh9h64im/q0usnwdsfn/q0usnwdsfn.png`
- Checksum / 校验和:
  `b0c535da7993c5fb868c0902a7481d38fda0dcac0a295004664a80daee1f06d6`
...
- Marked-pixel bounds: (79,47)–(170,202); span 92 × 156 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.78%。
- 痕迹范围：(79,47)–(170,202)；跨度92 × 156 px；痕迹矩形高于宽。
