# obs-unk-004500 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004500`
- primary external id: `hust-obc-und-X-004500`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/100_obs-unk-004500_h
  ust-obc-und-X-004500_oracle-character-candidate/03_visual-assets/001_asset
  -006093_hust-obc-und-X-004500_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/56/X_？_8242_1.png`
- asset id: `asset-006093`
...
- source class: `HUST-OBC/undeciphered/X/56/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/56/X_？_8242_1.png`
- asset id: `asset-006093`
...
- English observation: `The left curve, right upright curve, lower arch, and
  separated groups are directly recorded.`
- 中文观察: `已直接记录左弧痕、右侧竖弧痕、下部 U 形拱痕和分离痕迹群。`
...
- Which source records identify obs-unk-004500 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004500？
