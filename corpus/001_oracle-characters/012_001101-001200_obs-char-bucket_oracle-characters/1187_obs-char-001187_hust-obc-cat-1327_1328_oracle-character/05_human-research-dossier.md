# obs-char-001187 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1187_obs-char-001187_hust-obc-cat-1327_132
  8_oracle-character/03_visual-assets/001_asset-001192_hust-obc-cat-1327_132
  8_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1327_1328/1327/L_1327_4931.jpg`
- asset id: `asset-001192`
...
- source category: `1327_1328`
- validation class: `1186`
- source image route: `HUST-OBC/deciphered/1327_1328/1327/L_1327_4931.jpg`
- asset id: `asset-001192`
...
- English observation: `A faint compact image shows two narrow upright forms
  above a short horizontal base, with a small upper branch.`
- 中文观察: `较淡的紧凑图像显示短横底笔上方的两个狭长直立形体，并有小型上部分枝。`
...
- dataset label text: `㤥㤦`
- dataset label codepoints: `U+3925;U+3926`
...
- Which source records identify obs-char-001187 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001187？
