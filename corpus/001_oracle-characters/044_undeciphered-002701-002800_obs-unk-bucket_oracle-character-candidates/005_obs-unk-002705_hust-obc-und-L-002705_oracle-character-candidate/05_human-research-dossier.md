# obs-unk-002705 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002705`
- primary external id: `hust-obc-und-L-002705`
...
- local review image route: `corpus/001_oracle-characters/044_undeciphered-002
  701-002800_obs-unk-bucket_oracle-character-candidates/005_obs-unk-002705_h
  ust-obc-und-L-002705_oracle-character-candidate/03_visual-assets/001_asset
  -004298_hust-obc-und-L-002705_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2705/L_？_4285.jpg`
- asset id: `asset-004298`
...
- source class: `HUST-OBC/undeciphered/L/2705/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2705/L_？_4285.jpg`
- asset id: `asset-004298`
...
- Which source records identify obs-unk-002705 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002705？
