# obs-comp-cand-002675 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002675`
- 首选外部 ID: `obimd-sub-sff3srqzre`
- OBIMD subcharacter UID: `sff3srqzre`
- OBIMD main character UID: `sff3srqzre`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+FF17F; U+FF180; 另有 1 项
