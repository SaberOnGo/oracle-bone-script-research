...
Project ID: `obs-evo-cand-001760`
...
- Project ID: `obs-evo-cand-001760`
- EVOBC category candidate ID: `evobc-evo-cat-01760`
- External category reference: `evobc-cat-01760`
- Source category ID: `01760`
- Source label for human review: `团`
- Source codepoints: `U+56E2`
...
- `obs-evo-cand-001760-route-category-staging`
...
- `obs-evo-cand-001760-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001760-route-evolution-graph`
