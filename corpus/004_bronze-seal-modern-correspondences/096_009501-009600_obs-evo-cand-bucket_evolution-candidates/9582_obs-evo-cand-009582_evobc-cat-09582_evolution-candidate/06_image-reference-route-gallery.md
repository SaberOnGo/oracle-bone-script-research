...
- `obs-evo-cand-009582-route-category-staging`
...
- `obs-evo-cand-009582-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009582-route-evolution-graph`
