# obs-unk-004174 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004174`
- primary external id: `hust-obc-und-L-004174`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/074_obs-unk-004174_h
  ust-obc-und-L-004174_oracle-character-candidate/03_visual-assets/001_asset
  -005767_hust-obc-und-L-004174_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4174/L_？_9042.jpg`
- asset id: `asset-005767`
...
- source class: `HUST-OBC/undeciphered/L/4174/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4174/L_？_9042.jpg`
- asset id: `asset-005767`
...
- Which source records identify obs-unk-004174 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004174？
