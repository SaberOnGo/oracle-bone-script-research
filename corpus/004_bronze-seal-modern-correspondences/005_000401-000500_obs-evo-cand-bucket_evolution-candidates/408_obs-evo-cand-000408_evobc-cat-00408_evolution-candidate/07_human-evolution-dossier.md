...
Project ID: `obs-evo-cand-000408`
...
- Project ID: `obs-evo-cand-000408`
- EVOBC category candidate ID: `evobc-evo-cat-00408`
- External category reference: `evobc-cat-00408`
- Source category ID: `00408`
- Source label for human review: `䘭`
- Source codepoints: `U+462D`
...
- `obs-evo-cand-000408-route-category-staging`
...
- `obs-evo-cand-000408-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000408-route-evolution-graph`
