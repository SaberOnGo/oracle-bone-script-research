...
- External category reference: `evobc-cat-13233`
- Source category ID: `13233`
- Source label for human review: `𬋴`
...
- `obs-evo-cand-013233-route-category-staging`
...
- `obs-evo-cand-013233-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013233-route-evolution-graph`
