...
- `obs-evo-cand-005464-route-category-staging`
...
- `obs-evo-cand-005464-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005464-route-evolution-graph`
