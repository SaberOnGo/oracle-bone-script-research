# obs-unk-004698 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004698`
- primary external id: `hust-obc-und-X-004698`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/098_obs-unk-004698_h
  ust-obc-und-X-004698_oracle-character-candidate/03_visual-assets/001_asset
  -006291_hust-obc-und-X-004698_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/254/X_？_7227_1.png`
- asset id: `asset-006291`
...
- source class: `HUST-OBC/undeciphered/X/254/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/254/X_？_7227_1.png`
- asset id: `asset-006291`
...
- English observation: `forked right group with narrow opening`
- 中文观察: `带狭窄开口的右侧分叉笔画组`
...
- Which source records identify obs-unk-004698 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004698？
