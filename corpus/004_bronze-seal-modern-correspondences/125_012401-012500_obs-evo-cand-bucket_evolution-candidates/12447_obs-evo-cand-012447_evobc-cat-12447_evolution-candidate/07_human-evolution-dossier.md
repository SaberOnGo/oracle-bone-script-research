...
- External category reference: `evobc-cat-12447`
- Source category ID: `12447`
- Source label for human review: `𨝄`
...
- `obs-evo-cand-012447-route-category-staging`
...
- `obs-evo-cand-012447-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012447-route-evolution-graph`
