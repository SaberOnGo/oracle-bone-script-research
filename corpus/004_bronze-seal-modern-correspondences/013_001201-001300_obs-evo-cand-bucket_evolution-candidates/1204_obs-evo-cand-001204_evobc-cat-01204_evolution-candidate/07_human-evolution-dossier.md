...
- External category reference: `evobc-cat-01204`
- Source category ID: `01204`
- Source label for human review: `刱`
- Source codepoints: `U+5231`
...
- `obs-evo-cand-001204-route-category-staging`
...
- `obs-evo-cand-001204-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001204-route-evolution-graph`
