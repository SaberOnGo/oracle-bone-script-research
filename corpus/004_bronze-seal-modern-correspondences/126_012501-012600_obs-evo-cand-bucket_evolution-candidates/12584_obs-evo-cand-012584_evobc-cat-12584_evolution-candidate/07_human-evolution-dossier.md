...
Project ID: `obs-evo-cand-012584`
...
- Project ID: `obs-evo-cand-012584`
- EVOBC category candidate ID: `evobc-evo-cat-12584`
- External category reference: `evobc-cat-12584`
- Source category ID: `12584`
- Source label for human review: `𩍝`
- Source codepoints: `U+2935D`
...
- `obs-evo-cand-012584-route-category-staging`
...
- `obs-evo-cand-012584-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012584-route-evolution-graph`
