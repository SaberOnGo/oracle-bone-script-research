...
- Project ID: `obs-evo-cand-004958`
- EVOBC category candidate ID: `evobc-evo-cat-04958`
- External category reference: `evobc-cat-04958`
- Source category ID: `04958`
- Source label for human review: `濊`
- Source codepoints: `U+6FCA`
...
- `obs-evo-cand-004958-route-category-staging`
...
- `obs-evo-cand-004958-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004958-route-evolution-graph`
