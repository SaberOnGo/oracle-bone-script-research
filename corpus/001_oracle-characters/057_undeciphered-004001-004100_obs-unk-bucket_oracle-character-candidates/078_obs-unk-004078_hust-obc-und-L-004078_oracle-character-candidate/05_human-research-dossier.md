# obs-unk-004078 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/078_obs-unk-004078_h
  ust-obc-und-L-004078_oracle-character-candidate/03_visual-assets/001_asset
  -005671_hust-obc-und-L-004078_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4078/L_？_8737.jpg`
- asset id: `asset-005671`
...
- source class: `HUST-OBC/undeciphered/L/4078/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4078/L_？_8737.jpg`
- asset id: `asset-005671`
...
- English observation: A long upright trace stands near the center with a
  rounded or loop-like mark on its right. Short slanting traces extend on the
  left and lower sides; the separate marks and their joins are not resolved.
- 中文观察：中央附近有一条较长的竖向痕迹，右侧带有圆弧或环状痕迹。左侧和下方
  有短斜痕向外伸展；各个痕迹是否分开以及连接关系尚未分辨。
...
- Which source records identify obs-unk-004078 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004078？
