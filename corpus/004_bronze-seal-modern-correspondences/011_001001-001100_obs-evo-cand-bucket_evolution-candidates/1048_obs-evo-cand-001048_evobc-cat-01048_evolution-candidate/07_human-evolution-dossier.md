...
Project ID: `obs-evo-cand-001048`
...
- Project ID: `obs-evo-cand-001048`
- EVOBC category candidate ID: `evobc-evo-cat-01048`
- External category reference: `evobc-cat-01048`
- Source category ID: `01048`
- Source label for human review: `儘`
- Source codepoints: `U+5118`
...
- `obs-evo-cand-001048-route-category-staging`
...
- `obs-evo-cand-001048-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001048-route-evolution-graph`
