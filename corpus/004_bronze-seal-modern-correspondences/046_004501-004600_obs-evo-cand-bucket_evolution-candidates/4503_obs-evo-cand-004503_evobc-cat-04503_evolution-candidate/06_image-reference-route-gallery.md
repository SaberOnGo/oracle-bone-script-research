...
- `obs-evo-cand-004503-route-category-staging`
...
- `obs-evo-cand-004503-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004503-route-evolution-graph`
