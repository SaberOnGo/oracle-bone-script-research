...
- External category reference: `evobc-cat-05766`
- Source category ID: `05766`
- Source label for human review: `盨`
- Source codepoints: `U+76E8`
...
- `obs-evo-cand-005766-route-category-staging`
...
- `obs-evo-cand-005766-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005766-route-evolution-graph`
