...
- External category reference: `evobc-cat-03255`
- Source category ID: `03255`
- Source label for human review: `扟`
...
- `obs-evo-cand-003255-route-category-staging`
...
- `obs-evo-cand-003255-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003255-route-evolution-graph`
