# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000501
...
| --- | --- | --- | --- |
| `obimd-glyph-link-007463` | 󲼶 | `U+F2F36` | `reviewed_metadata_only` |
| `obimd-glyph-link-007464` | 󲼷 | `U+F2F37` | `reviewed_metadata_only` |
| `obimd-glyph-link-007465` | 󲼸 | `U+F2F38` | `reviewed_metadata_only` |
