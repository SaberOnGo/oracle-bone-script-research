...
- External category reference: `evobc-cat-02135`
- Source category ID: `02135`
- Source label for human review: `姦`
- Source codepoints: `U+59E6`
...
- `obs-evo-cand-002135-route-category-staging`
...
- `obs-evo-cand-002135-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002135-route-evolution-graph`
