# Material Visual Observation / obs-comp-cand-001269 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001269`
- External reference / 外部参照: `obimd-sub-wxd3235odg`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015507_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/frmptf4le7/wxd3235odg/wxd3235odg.png`
- Checksum / 校验和:
  `ea587cbef4c06769d326e823e5a2917d694aed31ba216114eec315887d5ecb0e`
...
- Marked-pixel bounds: (60,23)–(191,229); span 132 × 207 px; the marked
...
- 痕迹范围：(60,23)–(191,229)；跨度132 × 207 px；痕迹矩形高于宽。
