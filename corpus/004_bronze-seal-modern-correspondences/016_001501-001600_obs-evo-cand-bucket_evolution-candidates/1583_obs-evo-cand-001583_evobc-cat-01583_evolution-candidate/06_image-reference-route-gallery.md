...
- `obs-evo-cand-001583-route-category-staging`
...
- `obs-evo-cand-001583-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001583-route-evolution-graph`
