# obs-unk-008880 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008880`
- primary external id: `hust-obc-und-YH-008880`
...
- local review image route: `corpus/001_oracle-characters/105_undeciphered-008
  801-008900_obs-unk-bucket_oracle-character-candidates/080_obs-unk-008880_h
  ust-obc-und-YH-008880_oracle-character-candidate/03_visual-assets/001_asse
  t-010471_hust-obc-und-YH-008880_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60EE8/H_？_60EE8_0.png`
- asset id: `asset-010471`
...
- source class: `HUST-OBC/undeciphered/Y+H/60EE8/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60EE8/H_？_60EE8_0.png`
- asset id: `asset-010471`
...
- Which source records identify obs-unk-008880 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008880？
