...
- External category reference: `evobc-cat-10314`
- Source category ID: `10314`
- Source label for human review: `髫`
...
- `obs-evo-cand-010314-route-category-staging`
...
- `obs-evo-cand-010314-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010314-route-evolution-graph`
