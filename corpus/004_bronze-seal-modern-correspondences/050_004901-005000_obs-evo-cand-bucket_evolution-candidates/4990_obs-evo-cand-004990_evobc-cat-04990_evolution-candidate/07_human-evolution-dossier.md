...
- Project ID: `obs-evo-cand-004990`
- EVOBC category candidate ID: `evobc-evo-cat-04990`
- External category reference: `evobc-cat-04990`
- Source category ID: `04990`
- Source label for human review: `瀙`
- Source codepoints: `U+7019`
...
- `obs-evo-cand-004990-route-category-staging`
...
- `obs-evo-cand-004990-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004990-route-evolution-graph`
