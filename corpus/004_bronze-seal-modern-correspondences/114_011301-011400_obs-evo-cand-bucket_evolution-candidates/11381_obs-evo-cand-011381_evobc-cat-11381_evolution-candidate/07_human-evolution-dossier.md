...
- Project ID: `obs-evo-cand-011381`
- EVOBC category candidate ID: `evobc-evo-cat-11381`
- External category reference: `evobc-cat-11381`
- Source category ID: `11381`
- Source label for human review: `𣃓`
- Source codepoints: `U+230D3`
...
- `obs-evo-cand-011381-route-category-staging`
...
- `obs-evo-cand-011381-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011381-route-evolution-graph`
