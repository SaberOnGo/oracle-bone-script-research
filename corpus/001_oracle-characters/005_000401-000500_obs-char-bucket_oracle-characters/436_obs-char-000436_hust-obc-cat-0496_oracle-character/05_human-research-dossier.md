# obs-char-000436 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/436_obs-char-000436_hust-obc-cat-0496_orac
  le-character/03_visual-assets/001_asset-000441_hust-obc-cat-0496_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0496/G_0496_乙8713.png`
- asset id: `asset-000441`
...
- source category: `0496`
- validation class: `435`
- source image route: `HUST-OBC/deciphered/0496/G_0496_乙8713.png`
- asset id: `asset-000441`
...
- English observation: `The low-contrast narrow image shows a long curved
  vertical stroke with several short side branches and an angular bend near
  the lower middle.`
- 中文观察: `低对比度狭窄图像中可见一条长弯曲竖笔，带数条短侧枝，中下部有折角。`
...
- dataset label text: `㗦`
- dataset label codepoints: `U+35E6`
...
- Which source records identify obs-char-000436 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000436？
