# obs-comp-cand-001888 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001888`
- 首选外部 ID: `obimd-sub-xclyxu4uku`
- OBIMD subcharacter UID: `xclyxu4uku`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+75AB;U+A6E7D;U+FACAF; U+FACB0; 另有 3 项
