...
- External category reference: `evobc-cat-08411`
- Source category ID: `08411`
- Source label for human review: `讽`
- Source codepoints: `U+8BBD`
...
- `obs-evo-cand-008411-route-category-staging`
...
- `obs-evo-cand-008411-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008411-route-evolution-graph`
