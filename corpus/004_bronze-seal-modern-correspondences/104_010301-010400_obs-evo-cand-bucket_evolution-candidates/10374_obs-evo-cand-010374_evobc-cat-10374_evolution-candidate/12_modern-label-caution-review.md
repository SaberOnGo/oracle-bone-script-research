# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010374
...
- EVOBC candidate category: `evobc-evo-cat-10374`.
- Source label for search only: `魭`.
- Source codepoints for search only: `U+9B6D`.
