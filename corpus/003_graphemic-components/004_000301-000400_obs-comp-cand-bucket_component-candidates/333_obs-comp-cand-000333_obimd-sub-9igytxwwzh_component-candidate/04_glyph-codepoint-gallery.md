# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000333
...
| --- | --- | --- | --- |
| `obimd-glyph-link-004962` | 򽰡󱻋 | `U+BDC21;U+F1ECB` | `reviewed_metadata_only` |
| `obimd-glyph-link-004963` | 󱻌 | `U+F1ECC` | `reviewed_metadata_only` |
