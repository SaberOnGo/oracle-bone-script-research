...
- `obs-evo-cand-005626-route-category-staging`
...
- `obs-evo-cand-005626-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005626-route-evolution-graph`
