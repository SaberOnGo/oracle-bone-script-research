...
Project ID: `obs-evo-cand-008850`
...
- Project ID: `obs-evo-cand-008850`
- EVOBC category candidate ID: `evobc-evo-cat-08850`
- External category reference: `evobc-cat-08850`
- Source category ID: `08850`
- Source label for human review: `輪`
- Source codepoints: `U+8F2A`
...
- `obs-evo-cand-008850-route-category-staging`
...
- `obs-evo-cand-008850-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008850-route-evolution-graph`
