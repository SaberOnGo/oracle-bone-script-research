# obs-evo-cand-000689 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-000689`
- EVOBC category candidate ID: `evobc-evo-cat-00689`
- External category ref: `evobc-cat-00689`
- Source label: `亓`
- Source codepoints: `U+4E93`
- Image reference count: `440`
- Era token counts: `BI:6;SS:1;WSC:433`
- Source token counts: `Web:440`

## Observed Code Rows / 观察到的代码行

- era 1 / BI: 6 image references
- era 2 / SS: 1 image references
- era 4 / WSC: 433 image references
- source 1 / Web:105952;說文Web:58: 440 image references
