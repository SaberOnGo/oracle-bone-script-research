# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-005221
...
- EVOBC candidate category: `evobc-evo-cat-05221`.
- Source label for search only: `牻`.
- Source codepoints for search only: `U+727B`.
