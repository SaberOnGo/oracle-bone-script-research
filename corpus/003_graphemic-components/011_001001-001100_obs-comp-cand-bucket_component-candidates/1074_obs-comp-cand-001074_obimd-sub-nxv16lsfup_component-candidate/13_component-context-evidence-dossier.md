# obs-comp-cand-001074 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001074`
- 首选外部 ID: `obimd-sub-nxv16lsfup`
- OBIMD subcharacter UID: `nxv16lsfup`
- OBIMD main character UID: `nxv16lsfup`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+5235;U+F620A; U+F620B
