# obs-char-000025 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000025`
- primary external id: `hust-obc-cat-0030`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/025_obs-char-000025_hust-obc-cat-0030_orac
  le-character/03_visual-assets/001_asset-000030_hust-obc-cat-0030_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0030/G_0030_甲193(甲).png`
- asset id: `asset-000030`
...
- source category: `0030`
- validation class: `24`
- source image route: `HUST-OBC/deciphered/0030/G_0030_甲193(甲).png`
- asset id: `asset-000030`
...
- English observation: `The thin upright image has a central vertical
  stroke, two leftward branching marks, and a long diagonal stroke on the
  right.`
- 中文观察: `纤细直立图像有中央竖画、向左分出的两处痕迹，右侧有长斜向笔画。`
...
- dataset label text: `㐔`
- dataset label codepoints: `U+3414`
...
- Which source records identify obs-char-000025 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000025？
