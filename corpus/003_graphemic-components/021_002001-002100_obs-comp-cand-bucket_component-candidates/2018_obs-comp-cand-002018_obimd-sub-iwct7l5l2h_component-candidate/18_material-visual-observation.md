# Material Visual Observation / obs-comp-cand-002018 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002018`
- External reference / 外部参照: `obimd-sub-iwct7l5l2h`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019345_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tbecf7rhkr/iwct7l5l2h/iwct7l5l2h.png`
- Checksum / 校验和:
  `6a840962777581e90421760752e7ab10194824901729caea28339cef3412b844`
...
- Marked-pixel bounds: (90,26)–(159,225); span 70 × 200 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.63%。
- 痕迹范围：(90,26)–(159,225)；跨度70 × 200 px；痕迹矩形高于宽。
