...
- Project ID: `obs-evo-cand-010360`
- EVOBC category candidate ID: `evobc-evo-cat-10360`
- External category reference: `evobc-cat-10360`
- Source category ID: `10360`
- Source label for human review: `魄`
- Source codepoints: `U+9B44`
...
- `obs-evo-cand-010360-route-category-staging`
...
- `obs-evo-cand-010360-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010360-route-evolution-graph`
