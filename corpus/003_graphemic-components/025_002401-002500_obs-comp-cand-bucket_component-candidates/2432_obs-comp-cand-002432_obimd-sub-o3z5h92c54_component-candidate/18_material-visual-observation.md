# Material Visual Observation / obs-comp-cand-002432 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002432`
- External reference / 外部参照: `obimd-sub-o3z5h92c54`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020604_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/sxj3j42ygo/o3z5h92c54/o3z5h92c54.png`
- Checksum / 校验和:
  `83c3ee53c3aec972e7962c5b70fe9fae7a30922c859718a4175ccb48fe81e74a`
...
- Marked-pixel bounds: (85,35)–(172,204); span 88 × 170 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.53%。
- 痕迹范围：(85,35)–(172,204)；跨度88 × 170 px；痕迹矩形高于宽。
