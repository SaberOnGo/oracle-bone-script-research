# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010333
...
- EVOBC candidate category: `evobc-evo-cat-10333`.
- Source label for search only: `鬝`.
- Source codepoints for search only: `U+9B1D`.
