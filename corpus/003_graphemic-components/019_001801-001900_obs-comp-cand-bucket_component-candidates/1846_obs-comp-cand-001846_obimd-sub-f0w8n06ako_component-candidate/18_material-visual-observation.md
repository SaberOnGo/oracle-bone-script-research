# Material Visual Observation / obs-comp-cand-001846 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001846`
- External reference / 外部参照: `obimd-sub-f0w8n06ako`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018207_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/eq335my2ai/f0w8n06ako/f0w8n06ako.png`
- Checksum / 校验和:
  `c209c1407a8983cd32e5db973bc37839ce1c62c064edaee83ce401a20146e912`
...
- Marked-pixel bounds: (64,50)–(200,205); span 137 × 156 px; the marked
...
- 痕迹范围：(64,50)–(200,205)；跨度137 × 156 px；痕迹矩形近方形。
