...
- External category reference: `evobc-cat-07069`
- Source category ID: `07069`
- Source label for human review: `脡`
...
- `obs-evo-cand-007069-route-category-staging`
...
- `obs-evo-cand-007069-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007069-route-evolution-graph`
