...
- External category reference: `evobc-cat-06181`
- Source category ID: `06181`
- Source label for human review: `窳`
...
- `obs-evo-cand-006181-route-category-staging`
...
- `obs-evo-cand-006181-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006181-route-evolution-graph`
