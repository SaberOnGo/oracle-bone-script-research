...
Project ID: `obs-evo-cand-004178`
...
- Project ID: `obs-evo-cand-004178`
- EVOBC category candidate ID: `evobc-evo-cat-04178`
- External category reference: `evobc-cat-04178`
- Source category ID: `04178`
- Source label for human review: `榑`
- Source codepoints: `U+6991`
...
- `obs-evo-cand-004178-route-category-staging`
...
- `obs-evo-cand-004178-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004178-route-evolution-graph`
