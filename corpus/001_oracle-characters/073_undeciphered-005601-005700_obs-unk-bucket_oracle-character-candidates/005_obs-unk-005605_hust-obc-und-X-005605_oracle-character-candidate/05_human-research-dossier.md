# obs-unk-005605 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005605`
- primary external id: `hust-obc-und-X-005605`
...
- local review image route: `corpus/001_oracle-characters/073_undeciphered-005
  601-005700_obs-unk-bucket_oracle-character-candidates/005_obs-unk-005605_h
  ust-obc-und-X-005605_oracle-character-candidate/03_visual-assets/001_asset
  -007198_hust-obc-und-X-005605_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1161/X_？_8115_1.png`
- asset id: `asset-007198`
...
- source class: `HUST-OBC/undeciphered/X/1161/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1161/X_？_8115_1.png`
- asset id: `asset-007198`
...
- Which source records identify obs-unk-005605 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005605？
