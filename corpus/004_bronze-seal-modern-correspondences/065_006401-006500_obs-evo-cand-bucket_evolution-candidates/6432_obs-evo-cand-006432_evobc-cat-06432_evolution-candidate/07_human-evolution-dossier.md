...
- External category reference: `evobc-cat-06432`
- Source category ID: `06432`
- Source label for human review: `糧`
- Source codepoints: `U+7CE7`
...
- `obs-evo-cand-006432-route-category-staging`
...
- `obs-evo-cand-006432-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006432-route-evolution-graph`
