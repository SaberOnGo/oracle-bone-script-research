...
- Project ID: `obs-evo-cand-006598`
- EVOBC category candidate ID: `evobc-evo-cat-06598`
- External category reference: `evobc-cat-06598`
- Source category ID: `06598`
- Source label for human review: `緡`
- Source codepoints: `U+7DE1`
...
- `obs-evo-cand-006598-route-category-staging`
...
- `obs-evo-cand-006598-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006598-route-evolution-graph`
