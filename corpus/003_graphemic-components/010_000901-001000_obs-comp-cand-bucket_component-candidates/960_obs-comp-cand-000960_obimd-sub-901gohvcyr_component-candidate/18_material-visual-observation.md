# Material Visual Observation / obs-comp-cand-000960 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000960`
- External reference / 外部参照: `obimd-sub-901gohvcyr`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014043_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/901gohvcyr/901gohvcyr/901gohvcyr.png`
- Checksum / 校验和:
  `0d4601509eb2529e155d36743f664c6ff40699471336c1af776a2dde48a3ea21`
...
- Marked-pixel bounds: (62,40)–(187,212); span 126 × 173 px; the marked
...
- 痕迹范围：(62,40)–(187,212)；跨度126 × 173 px；痕迹矩形高于宽。
