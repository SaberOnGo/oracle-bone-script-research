# obs-char-000259 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/259_obs-char-000259_hust-obc-cat-0291_orac
  le-character/03_visual-assets/001_asset-000264_hust-obc-cat-0291_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0291/G_0291_乙344合19855.png`
- asset id: `asset-000264`
...
- source category: `0291`
- validation class: `258`
- source image route: `HUST-OBC/deciphered/0291/G_0291_乙344合19855.png`
- asset id: `asset-000264`
...
- English observation: `Two separated forms are visible: a small stack of
  rounded marks on the left and a long curved form with a pointed lower tail
  on the right.`
...
- dataset label text: `㔙`
- dataset label codepoints: `U+3519`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00023`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00023`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00023`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/023_obs-evo-can
  d-000023_evobc-cat-00023_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/023_obs-evo-cand-000023_evobc-cat-00023_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合19855
  (G_0291_乙344合19855.png)`
...
- Which source records identify obs-char-000259 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000259？
