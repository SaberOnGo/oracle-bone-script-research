...
- `obs-evo-cand-004138-route-category-staging`
...
- `obs-evo-cand-004138-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004138-route-evolution-graph`
