...
- External category reference: `evobc-cat-10434`
- Source category ID: `10434`
- Source label for human review: `鰥`
...
- `obs-evo-cand-010434-route-category-staging`
...
- `obs-evo-cand-010434-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010434-route-evolution-graph`
