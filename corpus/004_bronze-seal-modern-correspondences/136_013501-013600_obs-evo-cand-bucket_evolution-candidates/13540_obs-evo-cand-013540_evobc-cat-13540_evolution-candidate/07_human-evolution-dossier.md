...
- External category reference: `evobc-cat-13540`
- Source category ID: `13540`
- Source label for human review: `𭤇`
- Source codepoints: `U+2D907`
...
- `obs-evo-cand-013540-route-category-staging`
...
- `obs-evo-cand-013540-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013540-route-evolution-graph`
