...
- External category reference: `evobc-cat-01153`
- Source category ID: `01153`
- Source label for human review: `凑`
...
- `obs-evo-cand-001153-route-category-staging`
...
- `obs-evo-cand-001153-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001153-route-evolution-graph`
