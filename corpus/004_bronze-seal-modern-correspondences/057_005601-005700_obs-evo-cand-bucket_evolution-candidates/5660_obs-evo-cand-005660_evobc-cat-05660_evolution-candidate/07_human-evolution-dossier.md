...
- External category reference: `evobc-cat-05660`
- Source category ID: `05660`
- Source label for human review: `瘀`
- Source codepoints: `U+7600`
...
- `obs-evo-cand-005660-route-category-staging`
...
- `obs-evo-cand-005660-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005660-route-evolution-graph`
