...
- External category reference: `evobc-cat-13147`
- Source category ID: `13147`
- Source label for human review: `𫺕`
- Source codepoints: `U+2BE95`
...
- `obs-evo-cand-013147-route-category-staging`
...
- `obs-evo-cand-013147-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013147-route-evolution-graph`
