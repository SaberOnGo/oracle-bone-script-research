# Material Visual Observation / obs-comp-cand-000956 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000956`
- External reference / 外部参照: `obimd-sub-npgbktbhuc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014039_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/npgbktbhuc/npgbktbhuc/npgbktbhuc.png`
- Checksum / 校验和:
  `b21a4dd6c405c26d4c94ce7c6f38f66333e74dae71cf8e1bad4d86618167675c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.65%.
- Marked-pixel bounds: (51,53)–(212,195); span 162 × 143 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.65%。
- 痕迹范围：(51,53)–(212,195)；跨度162 × 143 px；痕迹矩形近方形。
