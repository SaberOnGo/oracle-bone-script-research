...
- Project ID: `obs-evo-cand-009563`
- EVOBC category candidate ID: `evobc-evo-cat-09563`
- External category reference: `evobc-cat-09563`
- Source category ID: `09563`
- Source label for human review: `鑿`
- Source codepoints: `U+947F`
...
- `obs-evo-cand-009563-route-category-staging`
...
- `obs-evo-cand-009563-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009563-route-evolution-graph`
