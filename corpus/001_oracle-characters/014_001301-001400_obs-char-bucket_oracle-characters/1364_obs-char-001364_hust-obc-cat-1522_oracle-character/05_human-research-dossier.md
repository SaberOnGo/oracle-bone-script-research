# obs-char-001364 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001364`
- primary external id: `hust-obc-cat-1522`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1364_obs-char-001364_hust-obc-cat-1522_ora
  cle-character/03_visual-assets/001_asset-001369_hust-obc-cat-1522_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1522/G_1522_乙7844合22518.png`
- asset id: `asset-001369`
...
- source category: `1522`
- validation class: `1363`
- source image route: `HUST-OBC/deciphered/1522/G_1522_乙7844合22518.png`
- asset id: `asset-001369`
...
- English observation: `Two adjacent rectangular sections are divided by
  dark horizontal bars.`
- 中文观察: `相邻的两个矩形部分由深色水平横笔分隔。`
...
- dataset label text: `㧨`
- dataset label codepoints: `U+39E8`
...
- filename catalog route clues: `Heji-like filename clue: 合22518
  (G_1522_乙7844合22518.png)`
...
- Which source records identify obs-char-001364 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001364？
