...
Project ID: `obs-evo-cand-005511`
...
- Project ID: `obs-evo-cand-005511`
- EVOBC category candidate ID: `evobc-evo-cat-05511`
- External category reference: `evobc-cat-05511`
- Source category ID: `05511`
- Source label for human review: `瓮`
- Source codepoints: `U+74EE`
...
- `obs-evo-cand-005511-route-category-staging`
...
- `obs-evo-cand-005511-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005511-route-evolution-graph`
