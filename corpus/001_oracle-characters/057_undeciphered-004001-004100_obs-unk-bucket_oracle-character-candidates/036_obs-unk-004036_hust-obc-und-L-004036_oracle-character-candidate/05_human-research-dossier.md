# obs-unk-004036 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004036`
- primary external id: `hust-obc-und-L-004036`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/036_obs-unk-004036_h
  ust-obc-und-L-004036_oracle-character-candidate/03_visual-assets/001_asset
  -005629_hust-obc-und-L-004036_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4036/L_？_8622.jpg`
- asset id: `asset-005629`
...
- source class: `HUST-OBC/undeciphered/L/4036/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4036/L_？_8622.jpg`
- asset id: `asset-005629`
...
- English observation: A broad diagonal or triangular outline occupies the upper
  area, with several short internal traces. Below it are separated curved marks
  and a narrow descending trace. The crop leaves their relation uncertain.
- 中文观察：上部有较宽的斜向或三角轮廓，内部可见数条短痕；下方有分离的弧形痕迹和
    窄直下行痕。图像未明确这些痕迹的关系。
...
- Which source records identify obs-unk-004036 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004036？
