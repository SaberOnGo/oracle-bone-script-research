# Material Visual Observation / obs-comp-cand-001600 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001600`
- External reference / 外部参照: `obimd-sub-pfzarn59ab`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017276_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/pfzarn59ab/pfzarn59ab/pfzarn59ab.png`
- Checksum / 校验和:
  `f8eec21c51cc64f23fadc0014d9198e9cea28722fcf58d84e44d2603a60a6ec2`
...
- Marked-pixel bounds: (85,12)–(169,236); span 85 × 225 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.79%。
- 痕迹范围：(85,12)–(169,236)；跨度85 × 225 px；痕迹矩形高于宽。
