...
Project ID: `obs-evo-cand-010032`
...
- Project ID: `obs-evo-cand-010032`
- EVOBC category candidate ID: `evobc-evo-cat-10032`
- External category reference: `evobc-cat-10032`
- Source category ID: `10032`
- Source label for human review: `顦`
- Source codepoints: `U+9866`
...
- `obs-evo-cand-010032-route-category-staging`
...
- `obs-evo-cand-010032-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010032-route-evolution-graph`
