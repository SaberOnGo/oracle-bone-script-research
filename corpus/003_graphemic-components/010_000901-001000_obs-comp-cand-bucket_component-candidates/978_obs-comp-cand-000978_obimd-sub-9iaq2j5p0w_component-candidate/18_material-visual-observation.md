# Material Visual Observation / obs-comp-cand-000978 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000978`
- External reference / 外部参照: `obimd-sub-9iaq2j5p0w`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014260_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9iaq2j5p0w/9iaq2j5p0w/9iaq2j5p0w.png`
- Checksum / 校验和:
  `c3f195d1bb089a1488fdb416b29dfecb836e122b394daf3b3936f0ba1f603876`
...
- Marked-pixel bounds: (60,37)–(189,215); span 130 × 179 px; the marked
...
- 痕迹范围：(60,37)–(189,215)；跨度130 × 179 px；痕迹矩形高于宽。
