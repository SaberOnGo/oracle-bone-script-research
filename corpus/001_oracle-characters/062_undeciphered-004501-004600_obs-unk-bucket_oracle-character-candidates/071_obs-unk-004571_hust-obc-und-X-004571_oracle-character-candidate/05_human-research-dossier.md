# obs-unk-004571 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/071_obs-unk-004571_h
  ust-obc-und-X-004571_oracle-character-candidate/03_visual-assets/001_asset
  -006164_hust-obc-und-X-004571_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/127/X_？_8306_1.png`
- asset id: `asset-006164`
...
- source class: `HUST-OBC/undeciphered/X/127/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/127/X_？_8306_1.png`
- asset id: `asset-006164`
...
- English observation: `Forked upper terminals and split lower branches`
  `recorded.`
- 中文观察: `已记录上部叉形末端和下部分开的分支。`
...
- Which source records identify obs-unk-004571 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004571？
