# obs-unk-008665 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008665`
- primary external id: `hust-obc-und-YH-008665`
...
- local review image route: `corpus/001_oracle-characters/103_undeciphered-008
  601-008700_obs-unk-bucket_oracle-character-candidates/065_obs-unk-008665_h
  ust-obc-und-YH-008665_oracle-character-candidate/03_visual-assets/001_asse
  t-010256_hust-obc-und-YH-008665_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60CF1/H_？_60CF1_0.png`
- asset id: `asset-010256`
...
- source class: `HUST-OBC/undeciphered/Y+H/60CF1/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60CF1/H_？_60CF1_0.png`
- asset id: `asset-010256`
...
- Which source records identify obs-unk-008665 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008665？
