...
Project ID: `obs-evo-cand-010768`
...
- Project ID: `obs-evo-cand-010768`
- EVOBC category candidate ID: `evobc-evo-cat-10768`
- External category reference: `evobc-cat-10768`
- Source category ID: `10768`
- Source label for human review: `𠁊`
- Source codepoints: `U+2004A`
...
- `obs-evo-cand-010768-route-category-staging`
...
- `obs-evo-cand-010768-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010768-route-evolution-graph`
