...
Project ID: `obs-evo-cand-010312`
...
- Project ID: `obs-evo-cand-010312`
- EVOBC category candidate ID: `evobc-evo-cat-10312`
- External category reference: `evobc-cat-10312`
- Source category ID: `10312`
- Source label for human review: `髦`
- Source codepoints: `U+9AE6`
...
- `obs-evo-cand-010312-route-category-staging`
...
- `obs-evo-cand-010312-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010312-route-evolution-graph`
