...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0066`
...
- Source image / 来源图: `X_0066_1090_1.png`
- Image / 图像: `001_asset-000062_hust-obc-cat-0066_glyph.png`
...
- target node: `obimd-main-cand-001148`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Matched OBIMD main UIDs / OBIMD 主字 UID: `vnscljivvy`
...
- Source label text / 来源标签文字: `㐸`
- Source label codepoint / 来源标签 codepoint: `U+3438`
