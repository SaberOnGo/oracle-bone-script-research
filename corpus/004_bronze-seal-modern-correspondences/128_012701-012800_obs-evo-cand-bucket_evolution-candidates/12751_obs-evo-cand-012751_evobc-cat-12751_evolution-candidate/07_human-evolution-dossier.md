...
- Project ID: `obs-evo-cand-012751`
- EVOBC category candidate ID: `evobc-evo-cat-12751`
- External category reference: `evobc-cat-12751`
- Source category ID: `12751`
- Source label for human review: `𪏓`
- Source codepoints: `U+2A3D3`
...
- `obs-evo-cand-012751-route-category-staging`
...
- `obs-evo-cand-012751-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012751-route-evolution-graph`
