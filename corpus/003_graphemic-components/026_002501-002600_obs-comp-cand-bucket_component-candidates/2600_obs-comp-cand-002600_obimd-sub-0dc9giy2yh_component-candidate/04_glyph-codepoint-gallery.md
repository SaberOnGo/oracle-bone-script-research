# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002600
...
| --- | --- | --- | --- |
| `obimd-glyph-link-039531` | 󿬠 | `U+FFB20` | `reviewed_metadata_only` |
| `obimd-glyph-link-039532` | 󾭇 | `U+FEB47` | `reviewed_metadata_only` |
| `obimd-glyph-link-039533` | 󾭈 | `U+FEB48` | `reviewed_metadata_only` |
