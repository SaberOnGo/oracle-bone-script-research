...
- External category reference: `evobc-cat-13325`
- Source category ID: `13325`
- Source label: `𬡹`
...
- `obs-evo-cand-013325-route-category-staging`
...
- `obs-evo-cand-013325-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013325-route-evolution-graph`
