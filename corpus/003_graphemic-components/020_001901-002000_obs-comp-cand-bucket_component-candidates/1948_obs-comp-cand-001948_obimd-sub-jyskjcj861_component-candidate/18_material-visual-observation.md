# Material Visual Observation / obs-comp-cand-001948 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001948`
- External reference / 外部参照: `obimd-sub-jyskjcj861`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018758_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jyskjcj861/jyskjcj861/jyskjcj861.png`
- Checksum / 校验和:
  `b426a70cf879ac1aa4f78e9d96983f15d2b1fab93aeb66fead9966625426f149`
...
- Marked-pixel bounds: (60,29)–(193,222); span 134 × 194 px; the marked
...
- 痕迹范围：(60,29)–(193,222)；跨度134 × 194 px；痕迹矩形高于宽。
