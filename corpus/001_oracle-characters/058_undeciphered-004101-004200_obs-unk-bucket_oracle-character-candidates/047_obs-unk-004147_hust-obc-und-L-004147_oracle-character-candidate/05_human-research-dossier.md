# obs-unk-004147 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004147`
- primary external id: `hust-obc-und-L-004147`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/047_obs-unk-004147_h
  ust-obc-und-L-004147_oracle-character-candidate/03_visual-assets/001_asset
  -005740_hust-obc-und-L-004147_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4147/L_？_8982.jpg`
- asset id: `asset-005740`
...
- source class: `HUST-OBC/undeciphered/L/4147/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4147/L_？_8982.jpg`
- asset id: `asset-005740`
...
- English observation: A central horizontal trace lies between left and right
  upright outlines with a pointed right upper outline.
- 中文观察：中央横向痕迹位于左右竖向轮廓之间，右上轮廓带尖端。
...
- Which source records identify obs-unk-004147 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004147？
