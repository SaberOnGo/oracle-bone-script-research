...
- External category reference: `evobc-cat-12789`
- Source category ID: `12789`
- Source label for human review: `𪛅`
...
- `obs-evo-cand-012789-route-category-staging`
...
- `obs-evo-cand-012789-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012789-route-evolution-graph`
