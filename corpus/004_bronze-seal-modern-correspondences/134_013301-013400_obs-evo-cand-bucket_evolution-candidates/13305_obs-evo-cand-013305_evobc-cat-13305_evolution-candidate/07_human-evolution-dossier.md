...
- External category reference: `evobc-cat-13305`
- Source category ID: `13305`
- Source label for human review: `𬛥`
...
- `obs-evo-cand-013305-route-category-staging`
...
- `obs-evo-cand-013305-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013305-route-evolution-graph`
