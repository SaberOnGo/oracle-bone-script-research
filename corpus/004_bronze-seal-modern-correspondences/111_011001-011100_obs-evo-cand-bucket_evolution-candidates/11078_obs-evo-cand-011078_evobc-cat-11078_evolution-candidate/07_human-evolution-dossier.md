...
- External category reference: `evobc-cat-11078`
- Source category ID: `11078`
- Source label for human review: `𡩗`
- Source codepoints: `U+21A57`
...
- `obs-evo-cand-011078-route-category-staging`
...
- `obs-evo-cand-011078-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011078-route-evolution-graph`
