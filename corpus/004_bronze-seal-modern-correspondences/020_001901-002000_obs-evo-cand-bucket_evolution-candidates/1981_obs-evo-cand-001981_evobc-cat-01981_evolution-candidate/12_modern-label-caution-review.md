# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001981
...
- EVOBC candidate category: `evobc-evo-cat-01981`.
- Source label for search only: `壼`.
- Source codepoints for search only: `U+58FC`.
