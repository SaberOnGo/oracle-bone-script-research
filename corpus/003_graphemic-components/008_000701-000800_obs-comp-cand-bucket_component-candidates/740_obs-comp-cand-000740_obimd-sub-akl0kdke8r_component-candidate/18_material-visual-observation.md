# Material Visual Observation / obs-comp-cand-000740 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000740`
- External reference / 外部参照: `obimd-sub-akl0kdke8r`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013467_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/akl0kdke8r/akl0kdke8r/akl0kdke8r.png`
- Checksum / 校验和:
  `90545efb2ed5502d0edcc9e3080fcafa4c0a493ae36bca73b7e7977f4d9fd81c`
...
- Marked-pixel bounds: (78,26)–(171,224); span 94 × 199 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.88%。
- 痕迹范围：(78,26)–(171,224)；跨度94 × 199 px；痕迹矩形高于宽。
