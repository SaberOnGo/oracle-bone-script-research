...
- `obs-evo-cand-008681-route-category-staging`
...
- `obs-evo-cand-008681-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008681-route-evolution-graph`
