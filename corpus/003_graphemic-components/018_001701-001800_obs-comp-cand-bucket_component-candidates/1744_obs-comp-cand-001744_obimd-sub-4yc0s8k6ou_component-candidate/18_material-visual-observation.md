# Material Visual Observation / obs-comp-cand-001744 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001744`
- External reference / 外部参照: `obimd-sub-4yc0s8k6ou`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017945_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/alc6eyehym/4yc0s8k6ou/4yc0s8k6ou.png`
- Checksum / 校验和:
  `40191e3e224dba0d7a0e7e91602a909b78659bd43d2427fb984180e54a499cb5`
...
- Marked-pixel bounds: (72,17)–(179,230); span 108 × 214 px; the marked
...
- 痕迹范围：(72,17)–(179,230)；跨度108 × 214 px；痕迹矩形高于宽。
