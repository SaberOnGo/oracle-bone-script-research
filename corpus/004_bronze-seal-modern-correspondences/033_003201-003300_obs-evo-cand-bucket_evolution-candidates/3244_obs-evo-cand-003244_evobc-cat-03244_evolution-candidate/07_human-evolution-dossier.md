...
Project ID: `obs-evo-cand-003244`
...
- Project ID: `obs-evo-cand-003244`
- EVOBC category candidate ID: `evobc-evo-cat-03244`
- External category reference: `evobc-cat-03244`
- Source category ID: `03244`
- Source label for human review: `扌`
- Source codepoints: `U+624C`
...
- `obs-evo-cand-003244-route-category-staging`
...
- `obs-evo-cand-003244-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003244-route-evolution-graph`
