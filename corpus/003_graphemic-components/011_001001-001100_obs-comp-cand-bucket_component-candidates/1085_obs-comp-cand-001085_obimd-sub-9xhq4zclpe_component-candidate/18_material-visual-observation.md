# Material Visual Observation / obs-comp-cand-001085 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001085`
- External reference / 外部参照: `obimd-sub-9xhq4zclpe`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014782_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9xhq4zclpe/9xhq4zclpe/0w9z0hg4a1.png`
- Checksum / 校验和:
  `cd5180a91343bc09b7aeda75a54a67196fdef59d914d69bf0c150d378b25e55a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.21%.
- Marked-pixel bounds: (74,75)–(174,175); span 101 × 101 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.21%。
- 痕迹范围：(74,75)–(174,175)；跨度101 × 101 px；痕迹矩形近方形。
