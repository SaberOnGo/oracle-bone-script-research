# Material Visual Observation / obs-comp-cand-001736 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001736`
- External reference / 外部参照: `obimd-sub-iuzkqe17tf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017932_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/iuzkqe17tf/iuzkqe17tf/0lmikzlh33.png`
- Checksum / 校验和:
  `5ece417006d7fb96374aeeffd07ebff8b2216ae4ea865126113d29b1adaa7650`
...
- Marked-pixel bounds: (76,43)–(173,214); span 98 × 172 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.45%。
- 痕迹范围：(76,43)–(173,214)；跨度98 × 172 px；痕迹矩形高于宽。
