# obs-evo-cand-000659 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-000659`
- EVOBC category candidate ID: `evobc-evo-cat-00659`
- External category ref: `evobc-cat-00659`
- Source label: `乍`
- Source codepoints: `U+4E4D`
- Image reference count: `342`
- Era token counts: `BI:138;OBC:98;SAC:60;SS:2;WSC:44`
- Source token counts: `Book:202;Web:140`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 98 image references
- era 1 / BI: 138 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 60 image references
- era 4 / WSC: 44 image references
- source 0 / Web:1633: 2 image references
- source 1 / Web:105952;說文Web:58: 119 image references
- source 2 / Book:17600: 39 image references
- source 3 / Book:21681: 77 image references
- source 4 / Book:9131: 60 image references
- source 5 / Book:32794: 22 image references
- source 6 / Web:30645: 19 image references
