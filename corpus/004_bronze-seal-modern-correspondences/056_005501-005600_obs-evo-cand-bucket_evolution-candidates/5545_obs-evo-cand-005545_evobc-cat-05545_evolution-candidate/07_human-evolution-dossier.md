...
- Project ID: `obs-evo-cand-005545`
- EVOBC category candidate ID: `evobc-evo-cat-05545`
- External category reference: `evobc-cat-05545`
- Source category ID: `05545`
- Source label for human review: `甲`
- Source codepoints: `U+7532`
- Image reference count in source metadata: `211`
...
- `obs-evo-cand-005545-route-category-staging`
...
- `obs-evo-cand-005545-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005545-route-evolution-graph`
