# Material Visual Observation / obs-comp-cand-002387 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002387`
- External reference / 外部参照: `obimd-sub-wcl42s7y1r`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020458_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wcl42s7y1r/wcl42s7y1r/wcl42s7y1r.png`
- Checksum / 校验和:
  `4d22c65b1bda8d76558a3fa84fc0d41341d4d1992083675c466738fdf529d04a`
...
- Marked-pixel bounds: (63,21)–(171,228); span 109 × 208 px; the marked
...
- 痕迹范围：(63,21)–(171,228)；跨度109 × 208 px；痕迹矩形高于宽。
