...
- External category reference: `evobc-cat-07518`
- Source category ID: `07518`
- Source label for human review: `蓂`
- Source codepoints: `U+84C2`
...
- `obs-evo-cand-007518-route-category-staging`
...
- `obs-evo-cand-007518-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007518-route-evolution-graph`
