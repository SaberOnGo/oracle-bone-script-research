...
- External category reference: `evobc-cat-10929`
- Source category ID: `10929`
- Source label for human review: `𠮙`
- Source codepoints: `U+20B99`
...
- `obs-evo-cand-010929-route-category-staging`
...
- `obs-evo-cand-010929-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010929-route-evolution-graph`
