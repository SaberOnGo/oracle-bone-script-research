...
Project ID: `obs-evo-cand-004778`
...
- Project ID: `obs-evo-cand-004778`
- EVOBC category candidate ID: `evobc-evo-cat-04778`
- External category reference: `evobc-cat-04778`
- Source category ID: `04778`
- Source label for human review: `湈`
- Source codepoints: `U+6E48`
...
- `obs-evo-cand-004778-route-category-staging`
...
- `obs-evo-cand-004778-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004778-route-evolution-graph`
