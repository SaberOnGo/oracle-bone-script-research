...
- External category reference: `evobc-cat-02301`
- Source category ID: `02301`
- Source label for human review: `嬙`
...
- `obs-evo-cand-002301-route-category-staging`
...
- `obs-evo-cand-002301-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002301-route-evolution-graph`
