# obs-comp-cand-000408 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000408`
- 首选外部 ID: `obimd-sub-zqbrsgetax`
- OBIMD subcharacter UID: `zqbrsgetax`
...
- glyph-codepoint 数: `7`
- codepoint 示例: U+C2271;U+F25CC; U+F25CD; 另有 5 项
