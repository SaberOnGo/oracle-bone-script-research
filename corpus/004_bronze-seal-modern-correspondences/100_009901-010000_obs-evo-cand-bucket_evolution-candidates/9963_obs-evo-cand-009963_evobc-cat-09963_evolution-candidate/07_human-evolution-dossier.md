...
- External category reference: `evobc-cat-09963`
- Source category ID: `09963`
- Source label for human review: `韶`
- Source codepoints: `U+97F6`
...
- `obs-evo-cand-009963-route-category-staging`
...
- `obs-evo-cand-009963-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009963-route-evolution-graph`
