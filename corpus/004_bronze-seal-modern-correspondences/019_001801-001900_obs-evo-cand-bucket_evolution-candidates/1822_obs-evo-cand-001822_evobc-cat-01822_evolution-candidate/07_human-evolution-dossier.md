...
- Project ID: `obs-evo-cand-001822`
- EVOBC category candidate ID: `evobc-evo-cat-01822`
- External category reference: `evobc-cat-01822`
- Source category ID: `01822`
- Source label for human review: `坠`
- Source codepoints: `U+5760`
...
- `obs-evo-cand-001822-route-category-staging`
...
- `obs-evo-cand-001822-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001822-route-evolution-graph`
