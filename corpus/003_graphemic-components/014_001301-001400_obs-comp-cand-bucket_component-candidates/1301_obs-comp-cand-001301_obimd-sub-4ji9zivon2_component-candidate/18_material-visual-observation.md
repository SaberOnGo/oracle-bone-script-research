# Material Visual Observation / obs-comp-cand-001301 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001301`
- External reference / 外部参照: `obimd-sub-4ji9zivon2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015638_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2sdz63p9g6/4ji9zivon2/4ji9zivon2.png`
- Checksum / 校验和:
  `06fc107a0df0ff963574f418d3f88958ddc22d0fde2854bbfbcb2269962f3c19`
...
- Marked-pixel bounds: (80,17)–(168,232); span 89 × 216 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.48%。
- 痕迹范围：(80,17)–(168,232)；跨度89 × 216 px；痕迹矩形高于宽。
