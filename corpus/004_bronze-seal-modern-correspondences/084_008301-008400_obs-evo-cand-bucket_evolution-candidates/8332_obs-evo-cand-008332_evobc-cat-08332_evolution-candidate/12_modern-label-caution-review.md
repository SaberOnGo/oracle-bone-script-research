# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008332
...
- EVOBC candidate category: `evobc-evo-cat-08332`.
- Source label for search only: `謯`.
- Source codepoints for search only: `U+8B2F`.
