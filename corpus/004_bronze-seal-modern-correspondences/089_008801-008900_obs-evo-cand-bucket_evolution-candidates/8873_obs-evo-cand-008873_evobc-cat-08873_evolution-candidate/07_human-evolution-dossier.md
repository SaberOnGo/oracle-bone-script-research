...
- Project ID: `obs-evo-cand-008873`
- EVOBC category candidate ID: `evobc-evo-cat-08873`
- External category reference: `evobc-cat-08873`
- Source category ID: `08873`
- Source label for human review: `轑`
- Source codepoints: `U+8F51`
...
- `obs-evo-cand-008873-route-category-staging`
...
- `obs-evo-cand-008873-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008873-route-evolution-graph`
