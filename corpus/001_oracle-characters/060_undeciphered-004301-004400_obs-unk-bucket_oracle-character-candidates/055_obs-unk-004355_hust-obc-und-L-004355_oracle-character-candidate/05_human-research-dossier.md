# obs-unk-004355 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004355`
- primary external id: `hust-obc-und-L-004355`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/055_obs-unk-004355_h
  ust-obc-und-L-004355_oracle-character-candidate/03_visual-assets/001_asset
  -005948_hust-obc-und-L-004355_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4355/L_？_9653.jpg`
- asset id: `asset-005948`
...
- source class: `HUST-OBC/undeciphered/L/4355/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4355/L_？_9653.jpg`
- asset id: `asset-005948`
...
- English observation: `Upper arms, lower curve, and uneven terminals recorded.`
- 中文观察: `已记录上部外伸、下部弧痕和不齐末端。`
...
- Which source records identify obs-unk-004355 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004355？
