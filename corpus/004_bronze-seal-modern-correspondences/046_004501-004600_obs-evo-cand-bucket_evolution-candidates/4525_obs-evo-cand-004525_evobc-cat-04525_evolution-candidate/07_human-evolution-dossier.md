...
- External category reference: `evobc-cat-04525`
- Source category ID: `04525`
- Source label for human review: `汾`
- Source codepoints: `U+6C7E`
...
- `obs-evo-cand-004525-route-category-staging`
...
- `obs-evo-cand-004525-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004525-route-evolution-graph`
