# obs-unk-004865 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/065_obs-unk-004865_h
  ust-obc-und-X-004865_oracle-character-candidate/03_visual-assets/001_asset
  -006458_hust-obc-und-X-004865_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/421/X_？_7405_1.png`
- asset id: `asset-006458`
...
- source class: `HUST-OBC/undeciphered/X/421/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/421/X_？_7405_1.png`
- asset id: `asset-006458`
...
- English observation: `arched upper opening and two descending strokes`
- 中文观察: `上部拱形开口和两条下伸笔画`
...
- Which source records identify obs-unk-004865 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004865？
