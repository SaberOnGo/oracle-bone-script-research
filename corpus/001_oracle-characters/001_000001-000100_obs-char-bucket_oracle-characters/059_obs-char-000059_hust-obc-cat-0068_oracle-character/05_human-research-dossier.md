# obs-char-000059 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000059`
- primary external id: `hust-obc-cat-0068`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/059_obs-char-000059_hust-obc-cat-0068_orac
  le-character/03_visual-assets/001_asset-000064_hust-obc-cat-0068_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0068/L_0068_10028.jpg`
- asset id: `asset-000064`
...
- source category: `0068`
- validation class: `58`
- source image route: `HUST-OBC/deciphered/0068/L_0068_10028.jpg`
- asset id: `asset-000064`
...
- English observation: `The small gray image has a curved angular upper
  cluster and a detached forked mark below; contrast needs human recheck.`
- 中文观察: `小型灰度图像上方有弯曲折角痕迹，下方有分离的分叉痕；对比度需人工复核。`
...
- dataset label text: `㐺`
- dataset label codepoints: `U+343A`
...
- Which source records identify obs-char-000059 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000059？
