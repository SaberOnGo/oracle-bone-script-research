# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002325
...
| --- | --- | --- | --- |
| `obimd-glyph-link-035820` | 󽕢 | `U+FD562` | `reviewed_metadata_only` |
| `obimd-glyph-link-035821` | 󽕣 | `U+FD563` | `reviewed_metadata_only` |
