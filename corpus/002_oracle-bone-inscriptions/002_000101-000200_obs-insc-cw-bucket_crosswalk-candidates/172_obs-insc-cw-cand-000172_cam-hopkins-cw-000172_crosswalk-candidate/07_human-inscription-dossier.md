...
- Yingguo / 英国所藏: `y1015` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `3` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `695` in source row; primary catalog entry pending
