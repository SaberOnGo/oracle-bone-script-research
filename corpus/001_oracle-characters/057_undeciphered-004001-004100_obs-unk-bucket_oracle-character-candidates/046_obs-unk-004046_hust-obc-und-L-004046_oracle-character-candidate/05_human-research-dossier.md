# obs-unk-004046 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/046_obs-unk-004046_h
  ust-obc-und-L-004046_oracle-character-candidate/03_visual-assets/001_asset
  -005639_hust-obc-und-L-004046_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4046/L_？_8656.jpg`
- asset id: `asset-005639`
...
- source class: `HUST-OBC/undeciphered/L/4046/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4046/L_？_8656.jpg`
- asset id: `asset-005639`
...
- English observation: A thick rectangular-looking trace occupies the left
  side and contains several horizontal interior bands. A thinner trace runs
  down the right side and bends near the lower end. The boundary between the
  two areas is not clear in this crop.
...
- Which source records identify obs-unk-004046 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004046？
