...
- External category reference: `evobc-cat-02115`
- Source category ID: `02115`
- Source label: `始`
...
- `obs-evo-cand-002115-route-category-staging`
...
- `obs-evo-cand-002115-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002115-route-evolution-graph`
