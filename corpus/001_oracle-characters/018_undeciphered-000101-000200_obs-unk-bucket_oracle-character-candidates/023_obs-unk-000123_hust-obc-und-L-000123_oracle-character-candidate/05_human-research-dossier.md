# obs-unk-000123 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/018_undeciphered-000
  101-000200_obs-unk-bucket_oracle-character-candidates/023_obs-unk-000123_h
  ust-obc-und-L-000123_oracle-character-candidate/03_visual-assets/001_asset
  -001716_hust-obc-und-L-000123_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/123/L_？_1038.jpg`
- asset id: `asset-001716`
...
- source class: `HUST-OBC/undeciphered/L/123/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/123/L_？_1038.jpg`
- asset id: `asset-001716`
...
- Which source records identify obs-unk-000123 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000123？
