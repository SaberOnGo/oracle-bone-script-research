...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0344`
...
- Source image / 来源图: `G_0344_陳160背(甲).png`
- Image / 图像: `001_asset-000309_hust-obc-cat-0344_glyph.png`
...
- target node: `evobc-evo-cat-00026`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/026_obs-evo-cand-000026_evobc-cat-00026_evoluti
...
- Source label text / 来源标签文字: `㕎`
- Source label codepoint / 来源标签 codepoint: `U+354E`
