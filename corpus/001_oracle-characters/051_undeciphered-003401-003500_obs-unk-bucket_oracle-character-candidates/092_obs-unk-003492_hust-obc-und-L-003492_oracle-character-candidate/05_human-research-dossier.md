# obs-unk-003492 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003492`
- primary external id: `hust-obc-und-L-003492`
...
- local review image route: `corpus/001_oracle-characters/051_undeciphered-003
  401-003500_obs-unk-bucket_oracle-character-candidates/092_obs-unk-003492_h
  ust-obc-und-L-003492_oracle-character-candidate/03_visual-assets/001_asset
  -005085_hust-obc-und-L-003492_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3492/L_？_6840.jpg`
- asset id: `asset-005085`
...
- source class: `HUST-OBC/undeciphered/L/3492/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3492/L_？_6840.jpg`
- asset id: `asset-005085`
...
- Which source records identify obs-unk-003492 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003492？
