# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002351
...
- EVOBC candidate category: `evobc-evo-cat-02351`.
- Source label for search only: `孼`.
- Source codepoints for search only: `U+5B7C`.
