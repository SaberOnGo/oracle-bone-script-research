...
- External category reference: `evobc-cat-06447`
- Source category ID: `06447`
- Source label for human review: `紆`
...
- `obs-evo-cand-006447-route-category-staging`
...
- `obs-evo-cand-006447-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006447-route-evolution-graph`
