# obs-char-000134 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/134_obs-char-000134_hust-obc-cat-0149_orac
  le-character/03_visual-assets/001_asset-000139_hust-obc-cat-0149_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0149/G_0149_乙4779合8167賓組.png`
- asset id: `asset-000139`
...
- source category: `0149`
- validation class: `133`
- source image route: `HUST-OBC/deciphered/0149/G_0149_乙4779合8167賓組.png`
- asset id: `asset-000139`
...
- English observation: `Several narrow strokes meet near the center, with an
  upper fork, a long leftward curve, and short lower projections.`
- 中文观察: `数道窄笔在中部附近汇合，上方有分叉，左侧有长弯曲笔，下方有短伸出笔。`
...
- dataset label text: `㒋`
- dataset label codepoints: `U+348B`
...
- filename catalog route clues: `Heji-like filename clue: 合8167
...
- Which source records identify obs-char-000134 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000134？
