# Material Visual Observation / obs-comp-cand-000090 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000090`
- External reference / 外部参照: `obimd-sub-e1wrdxp259`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011502_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/e1wrdxp259/e1wrdxp259/e1wrdxp259.png`
- Checksum / 校验和:
  `2e1bb5a32f1f30313b4940c197383b1207d426bdc3628ea114dbdc66a06c03a6`
...
- Marked-pixel bounds: (77,19)–(172,231); span 96 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.19%。
- 痕迹范围：(77,19)–(172,231)；跨度96 × 213 px；痕迹矩形高于宽。
