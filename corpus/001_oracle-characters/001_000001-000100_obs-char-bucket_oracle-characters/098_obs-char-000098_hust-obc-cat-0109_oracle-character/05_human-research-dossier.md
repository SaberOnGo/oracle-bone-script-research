# obs-char-000098 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000098`
- primary external id: `hust-obc-cat-0109`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/098_obs-char-000098_hust-obc-cat-0109_orac
  le-character/03_visual-assets/001_asset-000103_hust-obc-cat-0109_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0109/G_0109_乙745合6485賓組.png`
- asset id: `asset-000103`
...
- source category: `0109`
- validation class: `97`
- source image route: `HUST-OBC/deciphered/0109/G_0109_乙745合6485賓組.png`
- asset id: `asset-000103`
...
- English observation: `The image is vertically organized, with a pointed
  upper junction, short side branches, and a narrow central descending
  stem.`
- 中文观察: `图像按纵向组织，上部中央形成尖点，两侧有短分支，中部有狭长下行主干。`
...
- dataset label text: `㑣`
- dataset label codepoints: `U+3463`
...
- filename catalog route clues: `Heji-like filename clue: 合6485
...
- Which source records identify obs-char-000098 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000098？
