...
- Project ID: `obs-evo-cand-008728`
- EVOBC category candidate ID: `evobc-evo-cat-08728`
- External category reference: `evobc-cat-08728`
- Source category ID: `08728`
- Source label for human review: `踊`
- Source codepoints: `U+8E0A`
...
- `obs-evo-cand-008728-route-category-staging`
...
- `obs-evo-cand-008728-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008728-route-evolution-graph`
