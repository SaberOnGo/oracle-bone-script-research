...
- External category reference: `evobc-cat-11858`
- Source category ID: `11858`
- Source label: `𥩮`
...
- `obs-evo-cand-011858-route-category-staging`
...
- `obs-evo-cand-011858-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011858-route-evolution-graph`
