...
- External category reference: `evobc-cat-02634`
- Source category ID: `02634`
- Source label for human review: `巿`
- Source codepoints: `U+5DFF`
...
- `obs-evo-cand-002634-route-category-staging`
...
- `obs-evo-cand-002634-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002634-route-evolution-graph`
