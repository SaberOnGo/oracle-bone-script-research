# obs-comp-cand-000343 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000343`
- 首选外部 ID: `obimd-sub-fi0wiw1adi`
- OBIMD subcharacter UID: `fi0wiw1adi`
- OBIMD main character UID: `fi0wiw1adi`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+F1F87; U+F1F88; 另有 2 项
