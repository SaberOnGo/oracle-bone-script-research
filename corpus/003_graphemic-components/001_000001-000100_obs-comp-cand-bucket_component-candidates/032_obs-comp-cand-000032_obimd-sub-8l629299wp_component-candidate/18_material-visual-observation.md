# Material Visual Observation / obs-comp-cand-000032 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000032`
- External reference / 外部参照: `obimd-sub-8l629299wp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011285_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ftj0qy2f7b/8l629299wp/8l629299wp.png`
- Checksum / 校验和:
  `5c2c08ae4dee98b12d03c7d9aa55cfcb692da88e708fc41befed7566f1a47f62`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.91%.
- Marked-pixel bounds: (51,64)–(198,190); span 148 × 127 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.91%。
- 痕迹范围：(51,64)–(198,190)；跨度148 × 127 px；痕迹矩形近方形。
