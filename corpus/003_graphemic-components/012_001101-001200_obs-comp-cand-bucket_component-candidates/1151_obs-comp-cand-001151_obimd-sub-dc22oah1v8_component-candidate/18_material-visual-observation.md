# Material Visual Observation / obs-comp-cand-001151 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001151`
- External reference / 外部参照: `obimd-sub-dc22oah1v8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015341_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dc22oah1v8/dc22oah1v8/dc22oah1v8.png`
- Checksum / 校验和:
  `be1c04a71bf1cd4277fd7f3515548b70818b7fbb4d438723fd0da6b81d88e9b7`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.38%.
- Marked-pixel bounds: (61,39)–(195,211); span 135 × 173 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.38%。
- 痕迹范围：(61,39)–(195,211)；跨度135 × 173 px；痕迹矩形高于宽。
