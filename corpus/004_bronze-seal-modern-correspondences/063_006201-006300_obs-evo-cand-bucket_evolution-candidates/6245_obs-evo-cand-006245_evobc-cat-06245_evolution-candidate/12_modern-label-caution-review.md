# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006245
...
- EVOBC candidate category: `evobc-evo-cat-06245`.
- Source label for search only: `笯`.
- Source codepoints for search only: `U+7B2F`.
