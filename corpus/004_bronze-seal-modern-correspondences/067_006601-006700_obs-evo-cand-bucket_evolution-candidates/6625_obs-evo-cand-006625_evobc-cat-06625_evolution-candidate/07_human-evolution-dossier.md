...
- External category reference: `evobc-cat-06625`
- Source category ID: `06625`
- Source label for human review: `縋`
- Source codepoints: `U+7E0B`
...
- `obs-evo-cand-006625-route-category-staging`
...
- `obs-evo-cand-006625-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006625-route-evolution-graph`
