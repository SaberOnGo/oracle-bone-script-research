...
- External category reference: `evobc-cat-04102`
- Source category ID: `04102`
- Source label for human review: `棥`
...
- `obs-evo-cand-004102-route-category-staging`
...
- `obs-evo-cand-004102-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004102-route-evolution-graph`
