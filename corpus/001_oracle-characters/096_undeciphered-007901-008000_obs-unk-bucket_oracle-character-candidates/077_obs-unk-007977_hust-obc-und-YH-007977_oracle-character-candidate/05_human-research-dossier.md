# obs-unk-007977 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-007977`
- primary external id: `hust-obc-und-YH-007977`
...
- local review image route: `corpus/001_oracle-characters/096_undeciphered-007
  901-008000_obs-unk-bucket_oracle-character-candidates/077_obs-unk-007977_h
  ust-obc-und-YH-007977_oracle-character-candidate/03_visual-assets/001_asse
  t-009568_hust-obc-und-YH-007977_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/605BE/H_？_605BE_0.png`
- asset id: `asset-009568`
...
- source class: `HUST-OBC/undeciphered/Y+H/605BE/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/605BE/H_？_605BE_0.png`
- asset id: `asset-009568`
...
- Which source records identify obs-unk-007977 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007977？
