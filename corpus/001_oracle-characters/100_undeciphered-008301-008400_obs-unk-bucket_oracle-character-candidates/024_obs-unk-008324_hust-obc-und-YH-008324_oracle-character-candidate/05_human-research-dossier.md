# obs-unk-008324 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008324`
- primary external id: `hust-obc-und-YH-008324`
...
- local review image route: `corpus/001_oracle-characters/100_undeciphered-008
  301-008400_obs-unk-bucket_oracle-character-candidates/024_obs-unk-008324_h
  ust-obc-und-YH-008324_oracle-character-candidate/03_visual-assets/001_asse
  t-009915_hust-obc-und-YH-008324_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/609DD/H_？_609DD_0.png`
- asset id: `asset-009915`
...
- source class: `HUST-OBC/undeciphered/Y+H/609DD/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/609DD/H_？_609DD_0.png`
- asset id: `asset-009915`
...
- Which source records identify obs-unk-008324 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008324？
