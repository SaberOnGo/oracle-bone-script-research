...
- External category reference: `evobc-cat-01155`
- Source category ID: `01155`
- Source label: `凘`
...
- `obs-evo-cand-001155-route-category-staging`
...
- `obs-evo-cand-001155-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001155-route-evolution-graph`
