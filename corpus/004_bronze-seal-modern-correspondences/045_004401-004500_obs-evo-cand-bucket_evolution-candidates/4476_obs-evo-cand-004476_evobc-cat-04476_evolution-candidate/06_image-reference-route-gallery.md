...
- `obs-evo-cand-004476-route-category-staging`
...
- `obs-evo-cand-004476-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004476-route-evolution-graph`
