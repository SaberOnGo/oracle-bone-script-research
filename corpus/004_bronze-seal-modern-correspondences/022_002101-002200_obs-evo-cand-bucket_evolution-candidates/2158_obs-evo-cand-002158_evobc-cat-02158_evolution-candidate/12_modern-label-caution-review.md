# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002158
...
- EVOBC candidate category: `evobc-evo-cat-02158`.
- Source label for search only: `娊`.
- Source codepoints for search only: `U+5A0A`.
