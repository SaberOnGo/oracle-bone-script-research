# Material Visual Observation / obs-comp-cand-001186 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001186`
- External reference / 外部参照: `obimd-sub-mymkzhalht`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015376_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/mymkzhalht/mymkzhalht/mymkzhalht.png`
- Checksum / 校验和:
  `bc0fd6c0309cf0e461891ea722f980461bf9963228a27d6d8bbe0faf95fc9d4e`
...
- Marked-pixel bounds: (80,29)–(170,217); span 91 × 189 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.54%。
- 痕迹范围：(80,29)–(170,217)；跨度91 × 189 px；痕迹矩形高于宽。
