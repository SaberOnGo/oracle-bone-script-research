...
- External category reference: `evobc-cat-12820`
- Source category ID: `12820`
- Source label for human review: `𪥩`
- Source codepoints: `U+2A969`
...
- `obs-evo-cand-012820-route-category-staging`
...
- `obs-evo-cand-012820-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012820-route-evolution-graph`
