...
- Project ID: `obs-evo-cand-003930`
- EVOBC category candidate ID: `evobc-evo-cat-03930`
- External category reference: `evobc-cat-03930`
- Source category ID: `03930`
- Source label for human review: `枪`
- Source codepoints: `U+67AA`
...
- `obs-evo-cand-003930-route-category-staging`
...
- `obs-evo-cand-003930-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003930-route-evolution-graph`
