# obs-unk-004476 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004476`
- primary external id: `hust-obc-und-X-004476`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/076_obs-unk-004476_h
  ust-obc-und-X-004476_oracle-character-candidate/03_visual-assets/001_asset
  -006069_hust-obc-und-X-004476_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/32/X_？_8210_1.png`
- asset id: `asset-006069`
...
- source class: `HUST-OBC/undeciphered/X/32/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/32/X_？_8210_1.png`
- asset id: `asset-006069`
...
- English observation: A high-contrast noisy crop shows dark masses divided by
  lighter vertical and curved traces.
- 中文观察: 高反差噪声裁切中，深色区域被浅色竖向和弧形痕迹分隔。
...
- Which source records identify obs-unk-004476 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004476？
