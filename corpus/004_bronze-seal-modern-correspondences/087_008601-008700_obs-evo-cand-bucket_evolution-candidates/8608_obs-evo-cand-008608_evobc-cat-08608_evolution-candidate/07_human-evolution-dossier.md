...
- Project ID: `obs-evo-cand-008608`
- EVOBC category candidate ID: `evobc-evo-cat-08608`
- External category reference: `evobc-cat-08608`
- Source category ID: `08608`
- Source label for human review: `贔`
- Source codepoints: `U+8D14`
...
- `obs-evo-cand-008608-route-category-staging`
...
- `obs-evo-cand-008608-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008608-route-evolution-graph`
