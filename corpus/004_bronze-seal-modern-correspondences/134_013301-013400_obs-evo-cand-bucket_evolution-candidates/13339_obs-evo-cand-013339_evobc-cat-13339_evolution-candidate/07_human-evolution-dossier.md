...
Project ID: `obs-evo-cand-013339`
...
- Project ID: `obs-evo-cand-013339`
- EVOBC category candidate ID: `evobc-evo-cat-13339`
- External category reference: `evobc-cat-13339`
- Source category ID: `13339`
- Source label for human review: `𬢽`
- Source codepoints: `U+2C8BD`
...
- `obs-evo-cand-013339-route-category-staging`
...
- `obs-evo-cand-013339-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013339-route-evolution-graph`
