# Human Collection Object Dossier / 馆藏对象研究档案: coll-obj-cand-00052
...
- project_id: `coll-obj-cand-00052`
- candidate_collection_object_id: `ihp-mus-obj-00052`
- source_collection_item_id: `273`
...
| `source_collection_item_id` | `273` |
| `object_title_en` | `Inscribed Plastron Ping 0264` |
| `catalog_reference_text` | `Ping 0264` |
| `object_page_url` | `https://museum.sinica.edu.tw/en/collection/32/item/273/` |
| `thumbnail_url` | `https://museum.sinica.edu.tw/_upload/image/collection_item/thumbnail/dc1318987460.jpg` |
