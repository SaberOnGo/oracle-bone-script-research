# obs-unk-004220 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/020_obs-unk-004220_h
  ust-obc-und-L-004220_oracle-character-candidate/03_visual-assets/001_asset
  -005813_hust-obc-und-L-004220_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4220/L_？_9226.jpg`
- asset id: `asset-005813`
...
- source class: `HUST-OBC/undeciphered/L/4220/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4220/L_？_9226.jpg`
- asset id: `asset-005813`
...
- English observation: `Left open outline, inner bars, right stroke visible.`
- 中文观察: `左侧开放轮廓、内部横笔画和右侧笔画可见。`
...
- Which source records identify obs-unk-004220 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004220？
