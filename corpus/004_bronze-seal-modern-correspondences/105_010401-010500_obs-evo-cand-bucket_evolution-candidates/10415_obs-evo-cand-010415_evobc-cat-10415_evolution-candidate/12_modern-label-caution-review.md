# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010415
...
- EVOBC candidate category: `evobc-evo-cat-10415`.
- Source label for search only: `鯛`.
- Source codepoints for search only: `U+9BDB`.
