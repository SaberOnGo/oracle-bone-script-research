# Material Visual Observation / obs-comp-cand-002454 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002454`
- External reference / 外部参照: `obimd-sub-tuva72ozck`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020639_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fom5bv844r/tuva72ozck/tuva72ozck.png`
- Checksum / 校验和:
  `4fa72011d7179780203e269017c93e865fb5e3473aaa4a23d730c2b1832d0406`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.00%.
- Marked-pixel bounds: (67,47)–(184,204); span 118 × 158 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.00%。
- 痕迹范围：(67,47)–(184,204)；跨度118 × 158 px；痕迹矩形高于宽。
