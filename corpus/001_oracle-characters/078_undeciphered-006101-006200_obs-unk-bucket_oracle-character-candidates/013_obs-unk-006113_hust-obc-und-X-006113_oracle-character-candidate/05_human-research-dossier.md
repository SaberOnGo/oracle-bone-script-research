# obs-unk-006113 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006113`
- primary external id: `hust-obc-und-X-006113`
...
- local review image route: `corpus/001_oracle-characters/078_undeciphered-006
  101-006200_obs-unk-bucket_oracle-character-candidates/013_obs-unk-006113_h
  ust-obc-und-X-006113_oracle-character-candidate/03_visual-assets/001_asset
  -007705_hust-obc-und-X-006113_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1669/X_？_3628_1.png`
- asset id: `asset-007705`
...
- source class: `HUST-OBC/undeciphered/X/1669/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1669/X_？_3628_1.png`
- asset id: `asset-007705`
...
- Which source records identify obs-unk-006113 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006113？
