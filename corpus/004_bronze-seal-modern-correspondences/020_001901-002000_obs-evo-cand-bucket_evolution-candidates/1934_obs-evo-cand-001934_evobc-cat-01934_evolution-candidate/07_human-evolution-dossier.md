...
- External category reference: `evobc-cat-01934`
- Source category ID: `01934`
- Source label for human review: `墇`
...
- `obs-evo-cand-001934-route-category-staging`
...
- `obs-evo-cand-001934-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001934-route-evolution-graph`
