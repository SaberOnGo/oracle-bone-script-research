...
Project ID: `obs-evo-cand-005876`
...
- Project ID: `obs-evo-cand-005876`
- EVOBC category candidate ID: `evobc-evo-cat-05876`
- External category reference: `evobc-cat-05876`
- Source category ID: `05876`
- Source label for human review: `矞`
- Source codepoints: `U+77DE`
...
- `obs-evo-cand-005876-route-category-staging`
...
- `obs-evo-cand-005876-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005876-route-evolution-graph`
