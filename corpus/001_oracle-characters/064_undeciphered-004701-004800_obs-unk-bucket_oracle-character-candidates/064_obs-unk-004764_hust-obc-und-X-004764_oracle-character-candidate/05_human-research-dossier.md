# obs-unk-004764 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004764`
- primary external id: `hust-obc-und-X-004764`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/064_obs-unk-004764_h
  ust-obc-und-X-004764_oracle-character-candidate/03_visual-assets/001_asset
  -006357_hust-obc-und-X-004764_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/320/X_？_7305_1.png`
- asset id: `asset-006357`
...
- source class: `HUST-OBC/undeciphered/X/320/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/320/X_？_7305_1.png`
- asset id: `asset-006357`
...
- English observation: `separated left enclosure and right lower hook`
- 中文观察: `分离的左侧围合结构和右下方弯钩`
...
- Which source records identify obs-unk-004764 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004764？
