# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000409
...
| --- | --- | --- | --- |
| `obimd-glyph-link-005983` | 򧈓󲗘 | `U+A7213;U+F25D8` | `reviewed_metadata_only` |
| `obimd-glyph-link-005984` | 󲗙 | `U+F25D9` | `reviewed_metadata_only` |
| `obimd-glyph-link-005985` | 󲗚 | `U+F25DA` | `reviewed_metadata_only` |
