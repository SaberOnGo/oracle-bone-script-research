# Material Visual Observation / obs-comp-cand-002129 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002129`
- External reference / 外部参照: `obimd-sub-yszlaw22lm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019686_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/yszlaw22lm/yszlaw22lm/yszlaw22lm.png`
- Checksum / 校验和:
  `39287270eb14b430bbde1279689c6a093aa8ea88947c4eb51c495d2fa5c8dd21`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.03%.
- Marked-pixel bounds: (59,44)–(212,205); span 154 × 162 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.03%。
- 痕迹范围：(59,44)–(212,205)；跨度154 × 162 px；痕迹矩形近方形。
