# Material Visual Observation / obs-comp-cand-000232 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000232`
- External reference / 外部参照: `obimd-sub-yse6qwbz47`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011879_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2i3zpwl5a9/yse6qwbz47/yse6qwbz47.png`
- Checksum / 校验和:
  `beb7865106f6d24d9c1a8e7afa273e03e130e63bafc941b46ab55f5845cc3762`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.85%.
- Marked-pixel bounds: (62,29)–(187,217); span 126 × 189 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.85%。
- 痕迹范围：(62,29)–(187,217)；跨度126 × 189 px；痕迹矩形高于宽。
