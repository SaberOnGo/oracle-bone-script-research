# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-009838
...
- EVOBC candidate category: `evobc-evo-cat-09838`.
- Source label for search only: `雱`.
- Source codepoints for search only: `U+96F1`.
