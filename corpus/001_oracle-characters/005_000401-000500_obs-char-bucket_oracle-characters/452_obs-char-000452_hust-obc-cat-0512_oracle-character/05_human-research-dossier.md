# obs-char-000452 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/452_obs-char-000452_hust-obc-cat-0512_orac
  le-character/03_visual-assets/001_asset-000457_hust-obc-cat-0512_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0512/G_0512_金476(甲).png`
- asset id: `asset-000457`
...
- source category: `0512`
- validation class: `451`
- source image route: `HUST-OBC/deciphered/0512/G_0512_金476(甲).png`
- asset id: `asset-000457`
...
- English observation: `A central vertical stroke carries several
  alternating short branches, a small enclosed oval near the middle, and a
  pointed lower fork.`
...
- dataset label text: `㗶`
- dataset label codepoints: `U+35F6`
...
- Which source records identify obs-char-000452 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000452？
