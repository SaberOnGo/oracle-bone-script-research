# Material Visual Observation / obs-comp-cand-000092 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000092`
- External reference / 外部参照: `obimd-sub-fhr5fzfhst`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011504_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fhr5fzfhst/fhr5fzfhst/fhr5fzfhst.png`
- Checksum / 校验和:
  `a114e31f1851ec38bd4cd1ba5de2c5122ef9e5b24857c3e612d43eda24969157`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.49%.
- Marked-pixel bounds: (77,18)–(172,231); span 96 × 214 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.49%。
- 痕迹范围：(77,18)–(172,231)；跨度96 × 214 px；痕迹矩形高于宽。
