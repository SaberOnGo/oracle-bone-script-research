...
- Project ID: `obs-evo-cand-007270`
- EVOBC category candidate ID: `evobc-evo-cat-07270`
- External category reference: `evobc-cat-07270`
- Source category ID: `07270`
- Source label for human review: `芾`
- Source codepoints: `U+82BE`
...
- `obs-evo-cand-007270-route-category-staging`
...
- `obs-evo-cand-007270-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007270-route-evolution-graph`
