...
- External category reference: `evobc-cat-09462`
- Source category ID: `09462`
- Source label for human review: `鍭`
- Source codepoints: `U+936D`
...
- `obs-evo-cand-009462-route-category-staging`
...
- `obs-evo-cand-009462-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009462-route-evolution-graph`
