# Material Visual Observation / obs-comp-cand-000354 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000354`
- External reference / 外部参照: `obimd-sub-5tvchkyhcj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012277_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5tvchkyhcj/5tvchkyhcj/5tvchkyhcj.png`
- Checksum / 校验和:
  `70175b27b336a5df3a4928daf84e3f217c4f4cddeeb517d8a450c9927945fe6c`
...
- Marked-pixel bounds: (70,36)–(179,214); span 110 × 179 px; the marked
...
- 痕迹范围：(70,36)–(179,214)；跨度110 × 179 px；痕迹矩形高于宽。
