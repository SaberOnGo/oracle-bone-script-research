# obs-unk-004017 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004017`
- primary external id: `hust-obc-und-L-004017`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/017_obs-unk-004017_h
  ust-obc-und-L-004017_oracle-character-candidate/03_visual-assets/001_asset
  -005610_hust-obc-und-L-004017_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4017/L_？_8544.jpg`
- asset id: `asset-005610`
...
- source class: `HUST-OBC/undeciphered/L/4017/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4017/L_？_8544.jpg`
- asset id: `asset-005610`
...
- English observation: An arched or peaked outline occupies the upper
  area, with a horizontal dark trace inside it. A short vertical trace
  descends below, while several separated horizontal or wavy traces sit near
  the lower edge.
- 中文观察：上部有拱形或尖顶轮廓，内部可见一条横向暗痕；下方有一条短直痕，
    接近下缘处另有数条分离的横向或波曲痕迹。
...
- Which source records identify obs-unk-004017 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004017？
