...
- `obs-evo-cand-013514-route-category-staging`
...
- `obs-evo-cand-013514-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013514-route-evolution-graph`
