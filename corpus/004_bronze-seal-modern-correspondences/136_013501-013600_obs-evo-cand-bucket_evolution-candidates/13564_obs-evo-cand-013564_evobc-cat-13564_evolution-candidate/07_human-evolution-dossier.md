...
- External category reference: `evobc-cat-13564`
- Source category ID: `13564`
- Source label for human review: `𭯛`
- Source codepoints: `U+2DBDB`
...
- `obs-evo-cand-013564-route-category-staging`
...
- `obs-evo-cand-013564-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013564-route-evolution-graph`
