...
- External category reference: `evobc-cat-02504`
- Source category ID: `02504`
- Source label for human review: `屏`
...
- `obs-evo-cand-002504-route-category-staging`
...
- `obs-evo-cand-002504-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002504-route-evolution-graph`
