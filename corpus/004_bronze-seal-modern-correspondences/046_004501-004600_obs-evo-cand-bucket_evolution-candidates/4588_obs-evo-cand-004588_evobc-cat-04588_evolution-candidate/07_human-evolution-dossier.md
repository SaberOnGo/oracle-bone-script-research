...
- External category reference: `evobc-cat-04588`
- Source category ID: `04588`
- Source label for human review: `泠`
- Source codepoints: `U+6CE0`
...
- `obs-evo-cand-004588-route-category-staging`
...
- `obs-evo-cand-004588-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004588-route-evolution-graph`
