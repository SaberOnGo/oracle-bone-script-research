# obs-char-000817 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000817`
- primary external id: `hust-obc-cat-0925`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/817_obs-char-000817_hust-obc-cat-0925_orac
  le-character/03_visual-assets/001_asset-000822_hust-obc-cat-0925_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0925/G_0925_乙1577合10151賓組.png`
- asset id: `asset-000822`
...
- source category: `0925`
- validation class: `816`
- source image route: `HUST-OBC/deciphered/0925/G_0925_乙1577合10151賓組.png`
- asset id: `asset-000822`
...
- English observation: `Several detached short curved strokes form two loose
  vertical groups; the left group contains longer bowed marks.`
- 中文观察: `数条分离的短弯对笔形成两个疏松竖向笔群，左群含有较长的弯曲痕迹。`
...
- dataset label text: `㞓`
- dataset label codepoints: `U+3793`
...
- filename catalog route clues: `Heji-like filename clue: 合10151
  (G_0925_乙1577合10151賓組.png)`
...
- Which source records identify obs-char-000817 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000817？
