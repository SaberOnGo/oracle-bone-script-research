# obs-unk-004736 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/036_obs-unk-004736_h
  ust-obc-und-X-004736_oracle-character-candidate/03_visual-assets/001_asset
  -006329_hust-obc-und-X-004736_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/292/X_？_7271_1.png`
- asset id: `asset-006329`
...
- source class: `HUST-OBC/undeciphered/X/292/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/292/X_？_7271_1.png`
- asset id: `asset-006329`
...
- English observation: `distinct left and right forms with openings`
- 中文观察: `带开口的分立左右结构`
...
- Which source records identify obs-unk-004736 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004736？
