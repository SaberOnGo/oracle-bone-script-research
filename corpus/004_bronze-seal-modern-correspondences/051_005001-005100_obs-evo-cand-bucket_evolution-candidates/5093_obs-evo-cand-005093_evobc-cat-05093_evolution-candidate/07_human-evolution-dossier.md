...
- External category reference: `evobc-cat-05093`
- Source category ID: `05093`
- Source label for human review: `焦`
...
- `obs-evo-cand-005093-route-category-staging`
...
- `obs-evo-cand-005093-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005093-route-evolution-graph`
