# obs-evo-cand-009242 / EVOBC evolution-category candidate
...
- EVOBC category candidate ID: `evobc-evo-cat-09242`
- External category ref: `evobc-cat-09242`
- Source label for human review: `酒`
- Source codepoints: `U+9152`
- Image reference count: `77`
- Era token counts: `BI:8;CS:2;OBC:31;SS:2;WSC:34`
- Source token counts: `Book:12;Web:65`
