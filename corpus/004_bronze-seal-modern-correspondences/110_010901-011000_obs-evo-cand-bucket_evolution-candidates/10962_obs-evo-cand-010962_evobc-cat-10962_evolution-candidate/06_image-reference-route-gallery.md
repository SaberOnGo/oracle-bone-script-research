...
- `obs-evo-cand-010962-route-category-staging`
...
- `obs-evo-cand-010962-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010962-route-evolution-graph`
