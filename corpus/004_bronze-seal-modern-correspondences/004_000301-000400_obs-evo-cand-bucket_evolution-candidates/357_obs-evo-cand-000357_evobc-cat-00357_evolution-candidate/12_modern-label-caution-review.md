# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000357
...
- EVOBC candidate category: `evobc-evo-cat-00357`.
- Source label for search only: `䏬`.
- Source codepoints for search only: `U+43EC`.
