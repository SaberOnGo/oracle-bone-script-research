# obs-char-001049 Visual Gallery / obs-char-001049 图像资料页
...
- Project ID / 项目 ID: `obs-char-001049`
- Primary external reference / 首选外部参考: `hust-obc-cat-1176`
...
## obs-char-001049-visual-source-001 / 图像条目

![obs-char-001049 glyph candidate](03_visual-assets/001_asset-001054_hust-obc-cat-1176_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-001054_hust-obc-cat-1176_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-001054_hust-obc-cat-1176_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/1176/X_1176_66_1.png`
