...
Project ID: `obs-evo-cand-003916`
...
- Project ID: `obs-evo-cand-003916`
- EVOBC category candidate ID: `evobc-evo-cat-03916`
- External category reference: `evobc-cat-03916`
- Source category ID: `03916`
- Source label for human review: `枋`
- Source codepoints: `U+678B`
...
- `obs-evo-cand-003916-route-category-staging`
...
- `obs-evo-cand-003916-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003916-route-evolution-graph`
