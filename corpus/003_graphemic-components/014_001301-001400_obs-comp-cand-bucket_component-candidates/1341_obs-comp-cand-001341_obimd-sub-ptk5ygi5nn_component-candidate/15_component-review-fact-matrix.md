# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001341
...
| Glyph or codepoint route / 字形或码位路线 | 11 OBIMD route rows; examples U+F7A0B; U+F7A0C; 另有 9 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
