...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000249` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y1596` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `166` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `***` [route_missing_or_unassigned]
- `heji_reference`: Heji reference `39865` [route_present_image_or_text_not_collected]
