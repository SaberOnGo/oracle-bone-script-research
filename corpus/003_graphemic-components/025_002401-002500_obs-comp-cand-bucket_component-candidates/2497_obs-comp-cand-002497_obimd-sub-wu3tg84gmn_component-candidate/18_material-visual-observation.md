# Material Visual Observation / obs-comp-cand-002497 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002497`
- External reference / 外部参照: `obimd-sub-wu3tg84gmn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020751_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/s2e076ohb1/wu3tg84gmn/wu3tg84gmn.png`
- Checksum / 校验和:
  `2dcb57cdf2fe4c5dc6f7849c27e2f5cef05acfea491fdd2fbb35a515461ef63e`
...
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.41%。
