# obs-char-000532 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000532`
- primary external id: `hust-obc-cat-0606`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/532_obs-char-000532_hust-obc-cat-0606_orac
  le-character/03_visual-assets/001_asset-000537_hust-obc-cat-0606_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0606/G_0606_乙1155合9472賓組.png`
- asset id: `asset-000537`
...
- source category: `0606`
- validation class: `531`
- source image route: `HUST-OBC/deciphered/0606/G_0606_乙1155合9472賓組.png`
- asset id: `asset-000537`
...
- English observation: `A low rounded rectangular enclosure has a slightly
  uneven outline, and a central vertical rises from its top edge to a short
  horizontal cap.`
- 中文观察: `低矮圆角矩形围框轮廓略不平整，中央竖笔从顶边上升至一条短横帽。`
...
- dataset label text: `㙔`
- dataset label codepoints: `U+3654`
...
- filename catalog route clues: `Heji-like filename clue: 合9472
  (G_0606_乙1155合9472賓組.png)`
...
- Which source records identify obs-char-000532 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000532？
