# Material Visual Observation / obs-comp-cand-000855 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000855`
- External reference / 外部参照: `obimd-sub-fz1qkbjoia`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013853_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ji97td3npi/fz1qkbjoia/fz1qkbjoia.png`
- Checksum / 校验和:
  `a802d3b286deabdedd851353add73e8e4de6566880b673d1a24675075e6012c8`
...
- Marked-pixel bounds: (94,27)–(166,226); span 73 × 200 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.20%。
- 痕迹范围：(94,27)–(166,226)；跨度73 × 200 px；痕迹矩形高于宽。
