...
- Project ID: `obs-evo-cand-003111`
- EVOBC category candidate ID: `evobc-evo-cat-03111`
- External category reference: `evobc-cat-03111`
- Source category ID: `03111`
- Source label for human review: `慎`
- Source codepoints: `U+614E`
...
- `obs-evo-cand-003111-route-category-staging`
...
- `obs-evo-cand-003111-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003111-route-evolution-graph`
