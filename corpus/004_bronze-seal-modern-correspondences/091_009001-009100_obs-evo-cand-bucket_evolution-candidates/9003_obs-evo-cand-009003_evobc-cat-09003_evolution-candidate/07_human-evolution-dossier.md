...
- External category reference: `evobc-cat-09003`
- Source category ID: `09003`
- Source label for human review: `連`
- Source codepoints: `U+9023`
- Image reference count in source metadata: `52`
...
- `obs-evo-cand-009003-route-category-staging`
...
- `obs-evo-cand-009003-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009003-route-evolution-graph`
