# Material Visual Observation / obs-comp-cand-001807 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001807`
- External reference / 外部参照: `obimd-sub-83rbcs41fn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018028_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/83rbcs41fn/83rbcs41fn/83rbcs41fn.png`
- Checksum / 校验和:
  `305212e40d4ae4f11a4b03fefdc98ed527143b0425dab095edafefa34f7379e6`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.66%.
- Marked-pixel bounds: (61,28)–(192,220); span 132 × 193 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.66%。
- 痕迹范围：(61,28)–(192,220)；跨度132 × 193 px；痕迹矩形高于宽。
