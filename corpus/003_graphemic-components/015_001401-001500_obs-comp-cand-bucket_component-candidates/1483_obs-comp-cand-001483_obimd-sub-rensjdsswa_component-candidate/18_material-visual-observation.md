# Material Visual Observation / obs-comp-cand-001483 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001483`
- External reference / 外部参照: `obimd-sub-rensjdsswa`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016060_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wwpyiw1vm6/rensjdsswa/rensjdsswa.png`
- Checksum / 校验和:
  `acd45668dca7b701d92be3f683c5a5a745144b92b23ba42c1815922a1f620248`
...
- Marked-pixel bounds: (74,36)–(190,211); span 117 × 176 px; the marked
...
- 痕迹范围：(74,36)–(190,211)；跨度117 × 176 px；痕迹矩形高于宽。
