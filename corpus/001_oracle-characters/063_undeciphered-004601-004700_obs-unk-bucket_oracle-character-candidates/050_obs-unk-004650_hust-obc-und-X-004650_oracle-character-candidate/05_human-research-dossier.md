# obs-unk-004650 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004650`
- primary external id: `hust-obc-und-X-004650`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/050_obs-unk-004650_h
  ust-obc-und-X-004650_oracle-character-candidate/03_visual-assets/001_asset
  -006243_hust-obc-und-X-004650_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/206/X_？_8378_1.png`
- asset id: `asset-006243`
...
- source class: `HUST-OBC/undeciphered/X/206/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/206/X_？_8378_1.png`
- asset id: `asset-006243`
...
- English observation: `two separate stacked peaked strokes`
- 中文观察: `上下叠置的两条分离尖顶笔画`
...
- Which source records identify obs-unk-004650 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004650？
