...
- External category reference: `evobc-cat-05295`
- Source category ID: `05295`
- Source label for human review: `猜`
...
- `obs-evo-cand-005295-route-category-staging`
...
- `obs-evo-cand-005295-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005295-route-evolution-graph`
