# Material Visual Observation / obs-comp-cand-000243 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000243`
- External reference / 外部参照: `obimd-sub-991ix0j4pd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011889_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/991ix0j4pd/991ix0j4pd/991ix0j4pd.png`
- Checksum / 校验和:
  `befcc0db93a7fe2d15b1fc7d9432c027c53dc38afa0757984a10d785aab30500`
...
- Marked-pixel bounds: (54,17)–(190,232); span 137 × 216 px; the marked
...
- 痕迹范围：(54,17)–(190,232)；跨度137 × 216 px；痕迹矩形高于宽。
