# obs-char-001046 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1046_obs-char-001046_hust-obc-cat-1173_ora
  cle-character/03_visual-assets/001_asset-001051_hust-obc-cat-1173_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1173/H_1173_605B1_0.png`
- asset id: `asset-001051`
...
- source category: `1173`
- validation class: `1045`
- source image route: `HUST-OBC/deciphered/1173/H_1173_605B1_0.png`
- asset id: `asset-001051`
...
- English observation: `A large bold left cluster has an open U-shaped upper
  contour and many long lower branches, beside a separate simple upright
  mark on the right.`
...
- dataset label text: `㢋`
- dataset label codepoints: `U+388B`
...
- filename catalog route clues: `catalog-like filename clue: H_1173
  (H_1173_605B1_0.png)`
...
- Which source records identify obs-char-001046 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001046？
