# obs-char-000967 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000967`
- primary external id: `hust-obc-cat-1087`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/967_obs-char-000967_hust-obc-cat-1087_orac
  le-character/03_visual-assets/001_asset-000972_hust-obc-cat-1087_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1087/G_1087_乙6419合6037賓組.png`
- asset id: `asset-000972`
...
- source category: `1087`
- validation class: `966`
- source image route: `HUST-OBC/deciphered/1087/G_1087_乙6419合6037賓組.png`
- asset id: `asset-000972`
...
- English observation: `The faint image shows a short upper curve and a
  separate lower curved stroke; the connection is unclear.`
- 中文观察: `灰度较淡图像显示上部短弯笔和分离的下部弯笔；两者连接不清。`
...
- dataset label text: `㠵`
- dataset label codepoints: `U+3835`
...
- filename catalog route clues: `Heji-like filename clue: 合6037
  (G_1087_乙6419合6037賓組.png)`
...
- Which source records identify obs-char-000967 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000967？
