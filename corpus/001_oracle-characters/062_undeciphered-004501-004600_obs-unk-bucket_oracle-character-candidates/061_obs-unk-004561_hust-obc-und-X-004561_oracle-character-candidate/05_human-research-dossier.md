# obs-unk-004561 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/061_obs-unk-004561_h
  ust-obc-und-X-004561_oracle-character-candidate/03_visual-assets/001_asset
  -006154_hust-obc-und-X-004561_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/117/X_？_8297_1.png`
- asset id: `asset-006154`
...
- source class: `HUST-OBC/undeciphered/X/117/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/117/X_？_8297_1.png`
- asset id: `asset-006154`
...
- English observation: `Upper cap, openings, and lower U-like form recorded.`
- 中文观察: `已记录上部轮廓、开口和下部 U 形区域。`
...
- Which source records identify obs-unk-004561 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004561？
