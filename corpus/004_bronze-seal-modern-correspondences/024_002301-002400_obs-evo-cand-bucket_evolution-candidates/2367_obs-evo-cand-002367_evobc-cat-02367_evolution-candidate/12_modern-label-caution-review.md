# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002367
...
- EVOBC candidate category: `evobc-evo-cat-02367`.
- Source label for search only: `宏`.
- Source codepoints for search only: `U+5B8F`.
