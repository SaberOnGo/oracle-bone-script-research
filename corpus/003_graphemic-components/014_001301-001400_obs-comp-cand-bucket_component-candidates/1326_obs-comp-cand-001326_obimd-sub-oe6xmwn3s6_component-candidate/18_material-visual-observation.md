# Material Visual Observation / obs-comp-cand-001326 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001326`
- External reference / 外部参照: `obimd-sub-oe6xmwn3s6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015663_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/oe6xmwn3s6/oe6xmwn3s6/oe6xmwn3s6.png`
- Checksum / 校验和:
  `890461835d72387bc43c7a561e2c6ef32ee28cd48341290542d90ffa27597232`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.01%.
- Marked-pixel bounds: (63,31)–(162,222); span 100 × 192 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.01%。
- 痕迹范围：(63,31)–(162,222)；跨度100 × 192 px；痕迹矩形高于宽。
