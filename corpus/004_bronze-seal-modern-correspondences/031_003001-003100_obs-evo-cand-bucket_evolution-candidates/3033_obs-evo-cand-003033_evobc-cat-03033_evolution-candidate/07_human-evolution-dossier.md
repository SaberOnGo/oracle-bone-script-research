...
- External category reference: `evobc-cat-03033`
- Source category ID: `03033`
- Source label: `悽`
...
- `obs-evo-cand-003033-route-category-staging`
...
- `obs-evo-cand-003033-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003033-route-evolution-graph`
