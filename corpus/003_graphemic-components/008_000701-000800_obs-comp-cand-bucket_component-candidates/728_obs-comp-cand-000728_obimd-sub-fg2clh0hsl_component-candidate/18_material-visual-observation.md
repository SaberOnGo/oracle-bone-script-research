# Material Visual Observation / obs-comp-cand-000728 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000728`
- External reference / 外部参照: `obimd-sub-fg2clh0hsl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013455_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fg2clh0hsl/fg2clh0hsl/fg2clh0hsl.png`
- Checksum / 校验和:
  `4576120075117d2818912d436e32af4e6724d5a8ea80e490446e948f55116e4e`
...
- Marked-pixel bounds: (85,25)–(164,225); span 80 × 201 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.91%。
- 痕迹范围：(85,25)–(164,225)；跨度80 × 201 px；痕迹矩形高于宽。
