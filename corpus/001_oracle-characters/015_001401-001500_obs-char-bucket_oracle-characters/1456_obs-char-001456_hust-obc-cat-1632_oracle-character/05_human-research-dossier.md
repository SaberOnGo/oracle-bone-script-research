# obs-char-001456 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001456`
- primary external id: `hust-obc-cat-1632`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1456_obs-char-001456_hust-obc-cat-1632_ora
  cle-character/03_visual-assets/001_asset-001461_hust-obc-cat-1632_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1632/G_1632_寧滬1.331(甲).png`
- asset id: `asset-001461`
...
- source category: `1632`
- validation class: `1455`
- source image route: `HUST-OBC/deciphered/1632/G_1632_寧滬1.331(甲).png`
- asset id: `asset-001461`
...
- English observation: `A domed enclosure contains an inner triangle above
  several lower branches.`
- 中文观察: `拱顶框形内部有三角形，下面有数条分枝。`
...
- dataset label text: `㩖`
- dataset label codepoints: `U+3A56`
...
- Which source records identify obs-char-001456 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001456？
