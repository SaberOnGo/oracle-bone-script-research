# obs-char-000061 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000061`
- primary external id: `hust-obc-cat-0070_0071`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/061_obs-char-000061_hust-obc-cat-0070_0071
  _oracle-character/03_visual-assets/001_asset-000066_hust-obc-cat-0070_0071
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0070_0071/0070/G_0070_前4.10.3合9
  477賓組.png`
- asset id: `asset-000066`
...
- source category: `0070_0071`
- validation class: `60`
- source image route: `HUST-OBC/deciphered/0070_0071/0070/G_0070_前4.10.3合9477賓
  組.png`
- asset id: `asset-000066`
...
- English observation: `The small image shows a tall angular form with a
  lower rectangular frame and a separate curved mark on the right.`
- 中文观察: `小型图像呈高而折角的形体，下方有长方形框，右侧另有弯曲痕迹。`
...
- dataset label text: `㐼㐽`
- dataset label codepoints: `U+343C;U+343D`
...
- graph edge count: `2`
- codepoint routes: `U+343C;U+343D`
...
- filename catalog route clues: `Heji-like filename clue: 合9477
  (G_0070_前4.10.3合9477賓組.png)`
...
- Which source records identify obs-char-000061 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000061？
