# obs-unk-004340 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004340`
- primary external id: `hust-obc-und-L-004340`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/040_obs-unk-004340_h
  ust-obc-und-L-004340_oracle-character-candidate/03_visual-assets/001_asset
  -005933_hust-obc-und-L-004340_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4340/L_？_9604.jpg`
- asset id: `asset-005933`
...
- source class: `HUST-OBC/undeciphered/L/4340/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4340/L_？_9604.jpg`
- asset id: `asset-005933`
...
- English observation: `Detached upper marks, central bend, and lower trace
  recorded.`
- 中文观察: `已记录上部分离短痕、中央弯痕和下部横痕。`
...
- Which source records identify obs-unk-004340 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004340？
