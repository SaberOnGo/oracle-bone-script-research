...
- External category reference: `evobc-cat-12844`
- Source category ID: `12844`
- Source label for human review: `𪫓`
- Source codepoints: `U+2AAD3`
...
- `obs-evo-cand-012844-route-category-staging`
...
- `obs-evo-cand-012844-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012844-route-evolution-graph`
