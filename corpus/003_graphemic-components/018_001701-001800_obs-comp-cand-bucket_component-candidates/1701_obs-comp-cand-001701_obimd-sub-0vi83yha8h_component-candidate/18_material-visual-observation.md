# Material Visual Observation / obs-comp-cand-001701 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001701`
- External reference / 外部参照: `obimd-sub-0vi83yha8h`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017617_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0vi83yha8h/0vi83yha8h/0vi83yha8h.png`
- Checksum / 校验和:
  `8792df8595c0bc1d1ea0e6ad46696803205ea91ac14343b22bd1919d53f977b9`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.24%.
- Marked-pixel bounds: (37,40)–(207,217); span 171 × 178 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.24%。
- 痕迹范围：(37,40)–(207,217)；跨度171 × 178 px；痕迹矩形近方形。
