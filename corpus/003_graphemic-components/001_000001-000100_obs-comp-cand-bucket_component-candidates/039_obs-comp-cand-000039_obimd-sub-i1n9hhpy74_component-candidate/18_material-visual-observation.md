# Material Visual Observation / obs-comp-cand-000039 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000039`
- External reference / 外部参照: `obimd-sub-i1n9hhpy74`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011296_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/i1n9hhpy74/i1n9hhpy74/i1n9hhpy74.png`
- Checksum / 校验和:
  `9e9c445427f275b085d1b6c03b99b91ffa3fa321fefbd3d6110d833a82914734`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.74%.
- Marked-pixel bounds: (78,17)–(178,232); span 101 × 216 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.74%。
- 痕迹范围：(78,17)–(178,232)；跨度101 × 216 px；痕迹矩形高于宽。
