...
- External category reference: `evobc-cat-04344`
- Source category ID: `04344`
- Source label for human review: `欪`
- Source codepoints: `U+6B2A`
...
- `obs-evo-cand-004344-route-category-staging`
...
- `obs-evo-cand-004344-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004344-route-evolution-graph`
