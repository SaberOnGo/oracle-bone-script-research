...
- External category reference: `evobc-cat-09557`
- Source category ID: `09557`
- Source label: `鑴`
...
- `obs-evo-cand-009557-route-category-staging`
...
- `obs-evo-cand-009557-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-009557-route-evolution-graph`
