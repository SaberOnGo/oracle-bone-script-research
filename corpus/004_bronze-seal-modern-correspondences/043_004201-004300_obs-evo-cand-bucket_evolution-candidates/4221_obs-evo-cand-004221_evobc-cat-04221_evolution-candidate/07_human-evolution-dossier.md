...
Project ID: `obs-evo-cand-004221`
...
- Project ID: `obs-evo-cand-004221`
- EVOBC category candidate ID: `evobc-evo-cat-04221`
- External category reference: `evobc-cat-04221`
- Source category ID: `04221`
- Source label for human review: `槮`
- Source codepoints: `U+69EE`
...
- `obs-evo-cand-004221-route-category-staging`
...
- `obs-evo-cand-004221-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004221-route-evolution-graph`
