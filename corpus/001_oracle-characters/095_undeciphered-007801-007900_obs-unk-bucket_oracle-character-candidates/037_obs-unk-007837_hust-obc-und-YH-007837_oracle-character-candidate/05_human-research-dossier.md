# obs-unk-007837 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-007837`
- primary external id: `hust-obc-und-YH-007837`
...
- local review image route: `corpus/001_oracle-characters/095_undeciphered-007
  801-007900_obs-unk-bucket_oracle-character-candidates/037_obs-unk-007837_h
  ust-obc-und-YH-007837_oracle-character-candidate/03_visual-assets/001_asse
  t-009428_hust-obc-und-YH-007837_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/603DC/H_？_603DC_0.png`
- asset id: `asset-009428`
...
- source class: `HUST-OBC/undeciphered/Y+H/603DC/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/603DC/H_？_603DC_0.png`
- asset id: `asset-009428`
...
- Which source records identify obs-unk-007837 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007837？
