...
Project ID: `obs-evo-cand-008203`
...
- Project ID: `obs-evo-cand-008203`
- EVOBC category candidate ID: `evobc-evo-cat-08203`
- External category reference: `evobc-cat-08203`
- Source category ID: `08203`
- Source label for human review: `詵`
- Source codepoints: `U+8A75`
...
- `obs-evo-cand-008203-route-category-staging`
...
- `obs-evo-cand-008203-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008203-route-evolution-graph`
