# Material Visual Observation / obs-comp-cand-001321 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001321`
- External reference / 外部参照: `obimd-sub-ls1cvnh96s`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015658_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ls1cvnh96s/ls1cvnh96s/ls1cvnh96s.png`
- Checksum / 校验和:
  `532599e9d73a8759532afafca313237f46f70227f982a98e8efdc904e998c54f`
...
- Marked-pixel bounds: (85,28)–(161,225); span 77 × 198 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.18%。
- 痕迹范围：(85,28)–(161,225)；跨度77 × 198 px；痕迹矩形高于宽。
