...
Project ID: `obs-evo-cand-003006`
...
- Project ID: `obs-evo-cand-003006`
- EVOBC category candidate ID: `evobc-evo-cat-03006`
- External category reference: `evobc-cat-03006`
- Source category ID: `03006`
- Source label for human review: `悍`
- Source codepoints: `U+608D`
...
- `obs-evo-cand-003006-route-category-staging`
...
- `obs-evo-cand-003006-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003006-route-evolution-graph`
