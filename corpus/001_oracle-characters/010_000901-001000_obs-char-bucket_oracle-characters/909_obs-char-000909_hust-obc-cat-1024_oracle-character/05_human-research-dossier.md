# obs-char-000909 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000909`
- primary external id: `hust-obc-cat-1024`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/909_obs-char-000909_hust-obc-cat-1024_orac
  le-character/03_visual-assets/001_asset-000914_hust-obc-cat-1024_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1024/H_1024_60F49_0.png`
- asset id: `asset-000914`
...
- source category: `1024`
- validation class: `908`
- source image route: `HUST-OBC/deciphered/1024/H_1024_60F49_0.png`
- asset id: `asset-000914`
...
- dataset label text: `㟶`
- dataset label codepoints: `U+37F6`
...
- filename catalog route clues: `catalog-like filename clue: H_1024
  (H_1024_60F49_0.png)`
...
- Which source records identify obs-char-000909 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000909？
