# Material Visual Observation / obs-comp-cand-000404 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000404`
- External reference / 外部参照: `obimd-sub-no8hgfw0su`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012327_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/no8hgfw0su/no8hgfw0su/no8hgfw0su.png`
- Checksum / 校验和:
  `c253b02107239325a88ef9be31442abe852681f5feb14fe803701c9b5af38bdd`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.90%.
- Marked-pixel bounds: (75,19)–(174,222); span 100 × 204 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.90%。
- 痕迹范围：(75,19)–(174,222)；跨度100 × 204 px；痕迹矩形高于宽。
