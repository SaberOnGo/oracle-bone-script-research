...
- Project ID: `obs-evo-cand-013035`
- EVOBC category candidate ID: `evobc-evo-cat-13035`
- External category reference: `evobc-cat-13035`
- Source category ID: `13035`
- Source label for human review: `𫧫`
- Source codepoints: `U+2B9EB`
...
- `obs-evo-cand-013035-route-category-staging`
...
- `obs-evo-cand-013035-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013035-route-evolution-graph`
