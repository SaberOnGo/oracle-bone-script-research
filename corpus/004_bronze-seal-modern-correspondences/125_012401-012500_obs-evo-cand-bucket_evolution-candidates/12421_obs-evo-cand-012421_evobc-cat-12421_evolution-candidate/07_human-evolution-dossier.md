...
- External category reference: `evobc-cat-12421`
- Source category ID: `12421`
- Source label for human review: `𨛇`
- Source codepoints: `U+286C7`
...
- `obs-evo-cand-012421-route-category-staging`
...
- `obs-evo-cand-012421-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012421-route-evolution-graph`
