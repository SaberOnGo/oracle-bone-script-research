# obs-char-000619 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000619`
- primary external id: `hust-obc-cat-0704`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/619_obs-char-000619_hust-obc-cat-0704_orac
  le-character/03_visual-assets/001_asset-000624_hust-obc-cat-0704_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0704/G_0704_京都2142合27972無名組.png
  `
- asset id: `asset-000624`
...
- source category: `0704`
- validation class: `618`
- source image route: `HUST-OBC/deciphered/0704/G_0704_京都2142合27972無名組.png`
- asset id: `asset-000624`
...
- English observation: `A thin right vertical carries two short crossbars,
  while a separate bent stroke at left descends into a long slightly curving
  tail.`
...
- dataset label text: `㚶`
- dataset label codepoints: `U+36B6`
...
- Which source records identify obs-char-000619 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000619？
