# obs-comp-cand-002156 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002156`
- 首选外部 ID: `obimd-sub-1lodpasprk`
- OBIMD subcharacter UID: `1lodpasprk`
...
- glyph-codepoint 数: `9`
- codepoint 示例: U+FC701; U+FC702; 另有 7 项
