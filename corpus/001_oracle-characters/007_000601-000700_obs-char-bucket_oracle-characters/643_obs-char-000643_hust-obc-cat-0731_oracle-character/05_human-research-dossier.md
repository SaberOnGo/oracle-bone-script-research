# obs-char-000643 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/643_obs-char-000643_hust-obc-cat-0731_orac
  le-character/03_visual-assets/001_asset-000648_hust-obc-cat-0731_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0731/G_0731_佚971(甲).png`
- asset id: `asset-000648`
...
- source category: `0731`
- validation class: `642`
- source image route: `HUST-OBC/deciphered/0731/G_0731_佚971(甲).png`
- asset id: `asset-000648`
...
- English observation: `The tiny faint image shows a central narrow vertical
  crossed by several diagonals, with short hooked projections above and
  multiple thin descending strokes below.`
...
- dataset label text: `㛑`
- dataset label codepoints: `U+36D1`
...
- Which source records identify obs-char-000643 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000643？
