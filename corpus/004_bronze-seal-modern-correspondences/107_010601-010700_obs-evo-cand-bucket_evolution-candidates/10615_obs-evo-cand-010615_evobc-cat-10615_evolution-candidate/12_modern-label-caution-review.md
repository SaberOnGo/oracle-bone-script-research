# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010615
...
- EVOBC candidate category: `evobc-evo-cat-10615`.
- Source label for search only: `麝`.
- Source codepoints for search only: `U+9E9D`.
