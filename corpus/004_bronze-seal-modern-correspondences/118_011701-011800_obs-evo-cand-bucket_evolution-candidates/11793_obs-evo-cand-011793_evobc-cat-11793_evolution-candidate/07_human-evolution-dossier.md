...
Project ID: `obs-evo-cand-011793`
...
- Project ID: `obs-evo-cand-011793`
- EVOBC category candidate ID: `evobc-evo-cat-11793`
- External category reference: `evobc-cat-11793`
- Source category ID: `11793`
- Source label for human review: `𥎯`
- Source codepoints: `U+253AF`
...
- `obs-evo-cand-011793-route-category-staging`
...
- `obs-evo-cand-011793-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011793-route-evolution-graph`
