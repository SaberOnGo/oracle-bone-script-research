...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1150`
...
- Source image / 来源图: `G_1150_京津1339(甲).png`
- Image / 图像: `001_asset-001030_hust-obc-cat-1150_glyph.png`
...
- target node: `evobc-evo-cat-00094`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC image references / EvoBC 图像引用数: `17`
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/094_obs-evo-cand-000094_evobc-cat-00094_evoluti
...
- Source label text / 来源标签文字: `㡴`
- Source label codepoint / 来源标签 codepoint: `U+3874`
