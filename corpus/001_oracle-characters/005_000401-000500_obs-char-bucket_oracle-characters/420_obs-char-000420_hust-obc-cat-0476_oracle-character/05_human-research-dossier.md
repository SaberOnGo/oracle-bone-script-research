# obs-char-000420 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000420`
- primary external id: `hust-obc-cat-0476`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/420_obs-char-000420_hust-obc-cat-0476_orac
  le-character/03_visual-assets/001_asset-000425_hust-obc-cat-0476_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0476/G_0476_乙5405(甲).png`
- asset id: `asset-000425`
...
- source category: `0476`
- validation class: `419`
- source image route: `HUST-OBC/deciphered/0476/G_0476_乙5405(甲).png`
- asset id: `asset-000425`
...
- English observation: `Several stacked zigzag strokes form a narrow
  vertical cluster with pointed upper tips and short internal crossings.`
...
- dataset label text: `㗒`
- dataset label codepoints: `U+35D2`
...
- Which source records identify obs-char-000420 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000420？
