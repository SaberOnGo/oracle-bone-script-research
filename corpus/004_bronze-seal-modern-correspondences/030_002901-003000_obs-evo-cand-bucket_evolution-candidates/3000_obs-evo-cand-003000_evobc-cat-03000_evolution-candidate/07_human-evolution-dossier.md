...
- External category reference: `evobc-cat-03000`
- Source category ID: `03000`
- Source label: `悅`
...
- `obs-evo-cand-003000-route-category-staging`
...
- `obs-evo-cand-003000-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003000-route-evolution-graph`
