...
- External category reference: `evobc-cat-03750`
- Source category ID: `03750`
- Source label for human review: `晢`
...
- `obs-evo-cand-003750-route-category-staging`
...
- `obs-evo-cand-003750-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003750-route-evolution-graph`
