# obs-char-001402 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1402_obs-char-001402_hust-obc-cat-1570_ora
  cle-character/03_visual-assets/001_asset-001407_hust-obc-cat-1570_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1570/G_1570_甲骨文.png`
- asset id: `asset-001407`
...
- source category: `1570`
- validation class: `1401`
- source image route: `HUST-OBC/deciphered/1570/G_1570_甲骨文.png`
- asset id: `asset-001407`
...
- English observation: `A broad upper frame stands above several narrow
...
- dataset label text: `㨘`
- dataset label codepoints: `U+3A18`
...
- Which source records identify obs-char-001402 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001402？
