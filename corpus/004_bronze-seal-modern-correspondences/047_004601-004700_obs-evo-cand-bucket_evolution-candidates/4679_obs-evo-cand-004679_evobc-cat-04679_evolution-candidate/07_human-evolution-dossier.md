...
Project ID: `obs-evo-cand-004679`
...
- Project ID: `obs-evo-cand-004679`
- EVOBC category candidate ID: `evobc-evo-cat-04679`
- External category reference: `evobc-cat-04679`
- Source category ID: `04679`
- Source label for human review: `涌`
- Source codepoints: `U+6D8C`
...
- `obs-evo-cand-004679-route-category-staging`
...
- `obs-evo-cand-004679-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004679-route-evolution-graph`
