...
Project ID: `obs-evo-cand-010364`
...
- Project ID: `obs-evo-cand-010364`
- EVOBC category candidate ID: `evobc-evo-cat-10364`
- External category reference: `evobc-cat-10364`
- Source category ID: `10364`
- Source label for human review: `魔`
- Source codepoints: `U+9B54`
...
- `obs-evo-cand-010364-route-category-staging`
...
- `obs-evo-cand-010364-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010364-route-evolution-graph`
