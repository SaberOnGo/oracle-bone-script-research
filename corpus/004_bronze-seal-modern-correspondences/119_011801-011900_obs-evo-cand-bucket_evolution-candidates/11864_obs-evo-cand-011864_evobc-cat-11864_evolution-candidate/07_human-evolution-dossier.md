...
Project ID: `obs-evo-cand-011864`
...
- Project ID: `obs-evo-cand-011864`
- EVOBC category candidate ID: `evobc-evo-cat-11864`
- External category reference: `evobc-cat-11864`
- Source category ID: `11864`
- Source label for human review: `𥪱`
- Source codepoints: `U+25AB1`
...
- `obs-evo-cand-011864-route-category-staging`
...
- `obs-evo-cand-011864-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011864-route-evolution-graph`
