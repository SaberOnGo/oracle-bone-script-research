# Material Visual Observation / obs-comp-cand-000895 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000895`
- External reference / 外部参照: `obimd-sub-5jkdcdmi6k`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013967_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5jkdcdmi6k/5jkdcdmi6k/5jkdcdmi6k.png`
- Checksum / 校验和:
  `5a57ae7500b8103ce66e1912df9b183fd0d69728ab3eac061ed2c18e5772952c`
...
- Marked-pixel bounds: (73,24)–(174,225); span 102 × 202 px; the marked
...
- 痕迹范围：(73,24)–(174,225)；跨度102 × 202 px；痕迹矩形高于宽。
