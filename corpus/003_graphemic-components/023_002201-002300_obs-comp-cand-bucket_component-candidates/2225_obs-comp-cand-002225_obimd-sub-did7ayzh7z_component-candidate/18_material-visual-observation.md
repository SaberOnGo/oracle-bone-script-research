# Material Visual Observation / obs-comp-cand-002225 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002225`
- External reference / 外部参照: `obimd-sub-did7ayzh7z`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020038_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/did7ayzh7z/did7ayzh7z/did7ayzh7z.png`
- Checksum / 校验和:
  `779c715114eb2c9c80ccf1591656695ce52ba39103d3a8607c8a1e8eb9cb08d6`
...
- Marked-pixel bounds: (64,19)–(182,229); span 119 × 211 px; the marked
...
- 痕迹范围：(64,19)–(182,229)；跨度119 × 211 px；痕迹矩形高于宽。
