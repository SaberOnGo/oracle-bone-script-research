# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010373
...
- EVOBC candidate category: `evobc-evo-cat-10373`.
- Source label for search only: `魪`.
- Source codepoints for search only: `U+9B6A`.
