# obs-comp-cand-000040 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000040`
- 首选外部 ID: `obimd-sub-d6k4isufpw`
- OBIMD subcharacter UID: `d6k4isufpw`
- OBIMD main character UID: `d6k4isufpw`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `6`
- codepoint 示例: U+C9F42;U+F043A; U+F043B; 另有 4 项
