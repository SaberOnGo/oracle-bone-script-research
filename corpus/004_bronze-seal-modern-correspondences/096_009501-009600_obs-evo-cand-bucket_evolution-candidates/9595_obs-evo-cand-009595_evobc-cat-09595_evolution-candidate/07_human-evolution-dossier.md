...
Project ID: `obs-evo-cand-009595`
...
- Project ID: `obs-evo-cand-009595`
- EVOBC category candidate ID: `evobc-evo-cat-09595`
- External category reference: `evobc-cat-09595`
- Source category ID: `09595`
- Source label for human review: `错`
- Source codepoints: `U+9519`
...
- `obs-evo-cand-009595-route-category-staging`
...
- `obs-evo-cand-009595-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009595-route-evolution-graph`
