# Material Visual Observation / obs-comp-cand-001204 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001204`
- External reference / 外部参照: `obimd-sub-1l0us6kkug`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015435_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1l0us6kkug/1l0us6kkug/1l0us6kkug.png`
- Checksum / 校验和:
  `4beccd0c2ce8158f1f09de904405e0753a1b55b4d5afaff76788f55f708daf6e`
...
- Marked-pixel bounds: (97,40)–(159,215); span 63 × 176 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.56%。
- 痕迹范围：(97,40)–(159,215)；跨度63 × 176 px；痕迹矩形高于宽。
