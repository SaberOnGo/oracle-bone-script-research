# obs-unk-004195 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004195`
- primary external id: `hust-obc-und-L-004195`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/095_obs-unk-004195_h
  ust-obc-und-L-004195_oracle-character-candidate/03_visual-assets/001_asset
  -005788_hust-obc-und-L-004195_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4195/L_？_9134.jpg`
- asset id: `asset-005788`
...
- source class: `HUST-OBC/undeciphered/L/4195/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4195/L_？_9134.jpg`
- asset id: `asset-005788`
...
- English observation: `Upper arch and two diverging lower strokes visible.`
- 中文观察: `上部折角弧形和两条分开的下部笔画可见。`
...
- Which source records identify obs-unk-004195 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004195？
