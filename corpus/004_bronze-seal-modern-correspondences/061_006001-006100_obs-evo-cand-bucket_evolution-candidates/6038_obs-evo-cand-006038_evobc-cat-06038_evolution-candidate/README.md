# obs-evo-cand-006038 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-06038`
- Source label: `禱`
- Source codepoints: `U+79B1`
- Image reference count: `123`
- Era token counts: `OBC:9;SS:1;WSC:113`
- Source token counts: `Book:23;Web:100`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 9 image references
- era 2 / SS: 1 image references
- era 4 / WSC: 113 image references
