...
- Project ID: `obs-evo-cand-002257`
- EVOBC category candidate ID: `evobc-evo-cat-02257`
- External category reference: `evobc-cat-02257`
- Source category ID: `02257`
- Source label for human review: `嫈`
- Source codepoints: `U+5AC8`
...
- `obs-evo-cand-002257-route-category-staging`
...
- `obs-evo-cand-002257-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002257-route-evolution-graph`
