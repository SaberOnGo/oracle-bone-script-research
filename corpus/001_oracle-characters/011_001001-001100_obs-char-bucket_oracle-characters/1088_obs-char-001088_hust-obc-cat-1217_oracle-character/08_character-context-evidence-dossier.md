...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1217`
...
- Source image / 来源图: `G_1217_京津3038合20129.png`
- Image / 图像: `001_asset-001093_hust-obc-cat-1217_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合20129
...
- target node: `evobc-evo-cat-00103`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/103_obs-evo-cand-000103_evobc-cat-00103_evoluti
...
- Source label text / 来源标签文字: `㢷`
- Source label codepoint / 来源标签 codepoint: `U+38B7`
