...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000125` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y665` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `117` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `586` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `39963` [route_present_image_or_text_not_collected]
