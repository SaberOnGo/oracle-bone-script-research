# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004347
...
- EVOBC candidate category: `evobc-evo-cat-04347`.
- Source label for search only: `欯`.
- Source codepoints for search only: `U+6B2F`.
