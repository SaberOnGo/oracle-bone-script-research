# Material Visual Observation / obs-comp-cand-000696 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000696`
- External reference / 外部参照: `obimd-sub-fxjlcidk84`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013295_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/mepmffeebh/fxjlcidk84/fxjlcidk84.png`
- Checksum / 校验和:
  `a54099904126efb58525410ef4c9090dddc322f123284f0449af9b688094f00c`
...
- Marked-pixel bounds: (88,28)–(160,218); span 73 × 191 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.32%。
- 痕迹范围：(88,28)–(160,218)；跨度73 × 191 px；痕迹矩形高于宽。
