...
Project ID: `obs-evo-cand-008575`
...
- Project ID: `obs-evo-cand-008575`
- EVOBC category candidate ID: `evobc-evo-cat-08575`
- External category reference: `evobc-cat-08575`
- Source category ID: `08575`
- Source label for human review: `賕`
- Source codepoints: `U+8CD5`
...
- `obs-evo-cand-008575-route-category-staging`
...
- `obs-evo-cand-008575-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008575-route-evolution-graph`
