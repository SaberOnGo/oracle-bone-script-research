...
- External category reference: `evobc-cat-09054`
- Source category ID: `09054`
- Source label for human review: `遯`
- Source codepoints: `U+906F`
...
- `obs-evo-cand-009054-route-category-staging`
...
- `obs-evo-cand-009054-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009054-route-evolution-graph`
