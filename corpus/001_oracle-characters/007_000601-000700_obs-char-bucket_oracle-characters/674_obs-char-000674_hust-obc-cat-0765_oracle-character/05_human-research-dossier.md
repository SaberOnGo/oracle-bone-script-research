# obs-char-000674 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/674_obs-char-000674_hust-obc-cat-0765_orac
  le-character/03_visual-assets/001_asset-000679_hust-obc-cat-0765_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0765/G_0765_乙1760合17804賓組.png`
- asset id: `asset-000679`
...
- source category: `0765`
- validation class: `673`
- source image route: `HUST-OBC/deciphered/0765/G_0765_乙1760合17804賓組.png`
- asset id: `asset-000679`
...
- English observation: `A tall right vertical is joined by a wavering
  upper-left horizontal; a small square loop and short crossbar occupy the
  middle above a long thin descent.`
- 中文观察: `高长右竖连接波折左上横笔，中部有小方环和短横栏，其下为长细下笔。`
...
- dataset label text: `㛳`
- dataset label codepoints: `U+36F3`
...
- filename catalog route clues: `Heji-like filename clue: 合17804
  (G_0765_乙1760合17804賓組.png)`
...
- Which source records identify obs-char-000674 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000674？
