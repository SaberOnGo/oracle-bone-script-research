...
- Project ID: `obs-evo-cand-004750`
- EVOBC category candidate ID: `evobc-evo-cat-04750`
- External category reference: `evobc-cat-04750`
- Source category ID: `04750`
- Source label for human review: `渒`
- Source codepoints: `U+6E12`
...
- `obs-evo-cand-004750-route-category-staging`
...
- `obs-evo-cand-004750-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004750-route-evolution-graph`
