# Material Visual Observation / obs-comp-cand-002618 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002618`
- External reference / 外部参照: `obimd-sub-l2i17obgyi`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021157_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/l2i17obgyi/l2i17obgyi/l2i17obgyi.png`
- Checksum / 校验和:
  `59124f3b2503281d8fd104a1b802f346227b011852f979fca1397d716bc5ec26`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.76%.
- Marked-pixel bounds: (95,14)–(162,238); span 68 × 225 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.76%。
- 痕迹范围：(95,14)–(162,238)；跨度68 × 225 px；痕迹矩形高于宽。
