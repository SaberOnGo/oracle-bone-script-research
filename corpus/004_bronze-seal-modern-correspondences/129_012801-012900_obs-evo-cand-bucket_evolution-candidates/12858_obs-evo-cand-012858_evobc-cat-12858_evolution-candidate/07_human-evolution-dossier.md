...
- External category reference: `evobc-cat-12858`
- Source category ID: `12858`
- Source label for human review: `𪮻`
...
- `obs-evo-cand-012858-route-category-staging`
...
- `obs-evo-cand-012858-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012858-route-evolution-graph`
