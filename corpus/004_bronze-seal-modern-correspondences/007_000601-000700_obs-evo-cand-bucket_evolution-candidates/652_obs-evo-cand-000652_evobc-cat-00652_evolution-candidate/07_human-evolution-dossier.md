...
- External category reference: `evobc-cat-00652`
- Source category ID: `00652`
- Source label for human review: `乃`
- Source codepoints: `U+4E43`
- Image reference count in source metadata: `257`
...
- `obs-evo-cand-000652-route-category-staging`
...
- `obs-evo-cand-000652-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000652-route-evolution-graph`
