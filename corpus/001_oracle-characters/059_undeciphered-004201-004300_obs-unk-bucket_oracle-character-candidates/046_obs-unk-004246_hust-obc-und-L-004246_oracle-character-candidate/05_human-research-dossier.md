# obs-unk-004246 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004246`
- primary external id: `hust-obc-und-L-004246`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/046_obs-unk-004246_h
  ust-obc-und-L-004246_oracle-character-candidate/03_visual-assets/001_asset
  -005839_hust-obc-und-L-004246_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4246/L_？_9356.jpg`
- asset id: `asset-005839`
...
- source class: `HUST-OBC/undeciphered/L/4246/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4246/L_？_9356.jpg`
- asset id: `asset-005839`
...
- English observation: `Left cluster, right curve, central marks visible.`
- 中文观察: `左侧倾斜痕迹簇、右侧弯曲痕迹和中央痕迹可见。`
...
- Which source records identify obs-unk-004246 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004246？
