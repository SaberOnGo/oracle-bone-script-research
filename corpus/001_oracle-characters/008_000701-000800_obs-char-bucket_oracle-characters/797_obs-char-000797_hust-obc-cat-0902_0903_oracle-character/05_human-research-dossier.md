# obs-char-000797 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/797_obs-char-000797_hust-obc-cat-0902_0903
  _oracle-character/03_visual-assets/001_asset-000802_hust-obc-cat-0902_0903
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0902_0903/0902/G_0902_乙804合2220
  6𠂤組.png`
- asset id: `asset-000802`
...
- source category: `0902_0903`
- validation class: `796`
- source image route: `HUST-OBC/deciphered/0902_0903/0902/G_0902_乙804合22206𠂤組.
  png`
- asset id: `asset-000802`
...
- English observation: `A dark narrow left upright joins a rounded open
  right loop through a short horizontal; the left side continues into a long
  pointed lower tail.`
- 中文观察: `深色狭长左竖通过短横连接右侧圆弯开口环；左侧继续延伸为长尖下尾。`
...
- dataset label text: `㝼㝽`
- dataset label codepoints: `U+377C;U+377D`
...
- graph edge count: `2`
- codepoint routes: `U+377C;U+377D`
...
- filename catalog route clues: `Heji-like filename clue: 合22206
  (G_0902_乙804合22206𠂤組.png)`
...
- Which source records identify obs-char-000797 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000797？
