...
- External category reference: `evobc-cat-11446`
- Source category ID: `11446`
- Source label for human review: `𣘀`
...
- `obs-evo-cand-011446-route-category-staging`
...
- `obs-evo-cand-011446-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011446-route-evolution-graph`
