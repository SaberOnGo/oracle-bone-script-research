# obs-char-000838 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000838`
- primary external id: `hust-obc-cat-0947`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/838_obs-char-000838_hust-obc-cat-0947_orac
  le-character/03_visual-assets/001_asset-000843_hust-obc-cat-0947_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0947/G_0947_庫267合39528.png`
- asset id: `asset-000843`
...
- source category: `0947`
- validation class: `837`
- source image route: `HUST-OBC/deciphered/0947/G_0947_庫267合39528.png`
- asset id: `asset-000843`
...
- English observation: `Many thin vertical and slightly curved strokes form
  two loose groups with gaps; fine connections are difficult to resolve.`
- 中文观察: `多条纤细竖笔和略弯笔形成两个疏松笔群，中间有间隔；细连接难以辨认。`
...
- dataset label text: `㞩`
- dataset label codepoints: `U+37A9`
...
- filename catalog route clues: `Heji-like filename clue: 合39528
  (G_0947_庫267合39528.png)`
...
- Which source records identify obs-char-000838 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000838？
