# obs-unk-004371 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/071_obs-unk-004371_h
  ust-obc-und-L-004371_oracle-character-candidate/03_visual-assets/001_asset
  -005964_hust-obc-und-L-004371_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4371/L_？_9699.jpg`
- asset id: `asset-005964`
...
- source class: `HUST-OBC/undeciphered/L/4371/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4371/L_？_9699.jpg`
- asset id: `asset-005964`
...
- English observation: `Left horizontal trace, right descent, and lower`
  `mark recorded.`
- 中文观察: `已记录左侧横痕、右侧下行痕和下部小痕。`
...
- Which source records identify obs-unk-004371 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004371？
