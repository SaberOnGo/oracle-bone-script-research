# src-sinica-yinshang-oracle-vocabulary Material Access Index
...
- Safe derivative JSON / 安全派生索引: 26_safe-derivative-decision-index.json
...
- Target records / 目标记录: research_topic; source_reference
- Metadata profile count / 元数据概况数: 2
- Profile metrics / 概况指标: yinshang_oracle_bone_piece_count;
  yinshang_oracle_character_count_about
