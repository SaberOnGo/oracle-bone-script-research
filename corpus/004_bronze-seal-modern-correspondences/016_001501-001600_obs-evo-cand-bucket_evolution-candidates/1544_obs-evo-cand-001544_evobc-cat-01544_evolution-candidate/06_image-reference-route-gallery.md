...
- `obs-evo-cand-001544-route-category-staging`
...
- `obs-evo-cand-001544-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001544-route-evolution-graph`
