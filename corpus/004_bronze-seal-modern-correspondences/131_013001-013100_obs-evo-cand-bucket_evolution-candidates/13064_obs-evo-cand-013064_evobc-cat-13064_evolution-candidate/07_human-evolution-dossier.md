...
- External category reference: `evobc-cat-13064`
- Source category ID: `13064`
- Source label for human review: `𫮯`
- Source codepoints: `U+2BBAF`
...
- `obs-evo-cand-013064-route-category-staging`
...
- `obs-evo-cand-013064-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013064-route-evolution-graph`
