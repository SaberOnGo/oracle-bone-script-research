# Material Visual Observation / obs-comp-cand-000113 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000113`
- External reference / 外部参照: `obimd-sub-du1603bntk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011525_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/du1603bntk/du1603bntk/du1603bntk.png`
- Checksum / 校验和:
  `3b2d90136681186e720741e6957f4e0522bc42dabaab788beb0a34bcbedd9248`
...
- Marked-pixel bounds: (76,32)–(173,221); span 98 × 190 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.18%。
- 痕迹范围：(76,32)–(173,221)；跨度98 × 190 px；痕迹矩形高于宽。
