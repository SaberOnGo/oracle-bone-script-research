# obs-unk-004044 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004044`
- primary external id: `hust-obc-und-L-004044`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/044_obs-unk-004044_h
  ust-obc-und-L-004044_oracle-character-candidate/03_visual-assets/001_asset
  -005637_hust-obc-und-L-004044_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4044/L_？_8638.jpg`
- asset id: `asset-005637`
...
- source class: `HUST-OBC/undeciphered/L/4044/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4044/L_？_8638.jpg`
- asset id: `asset-005637`
...
- English observation: A long slanting trace runs from the upper left toward
  the right side, leaving a wedge-like open area. A darker central stroke
  descends into crossed or hooked lower traces. The right contour and lower
  joins are partly obscured.
...
- Which source records identify obs-unk-004044 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004044？
