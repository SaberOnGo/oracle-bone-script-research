# Material Visual Observation / obs-comp-cand-000854 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000854`
- External reference / 外部参照: `obimd-sub-ji97td3npi`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013724_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ji97td3npi/ji97td3npi/05df3c9msa.png`
- Checksum / 校验和:
  `3f3d34401d360eb180131288ceced9743a24add2cf3a563ed3a5a3001b540cf8`
...
- Marked-pixel bounds: (88,35)–(172,214); span 85 × 180 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.26%。
- 痕迹范围：(88,35)–(172,214)；跨度85 × 180 px；痕迹矩形高于宽。
