...
- External category reference: `evobc-cat-00642`
- Source category ID: `00642`
- Source label for human review: `丵`
- Source codepoints: `U+4E35`
...
- `obs-evo-cand-000642-route-category-staging`
...
- `obs-evo-cand-000642-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000642-route-evolution-graph`
