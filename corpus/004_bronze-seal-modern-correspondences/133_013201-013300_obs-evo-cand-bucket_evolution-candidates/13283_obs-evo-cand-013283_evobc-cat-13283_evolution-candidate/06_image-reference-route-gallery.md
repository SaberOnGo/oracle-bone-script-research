...
- `obs-evo-cand-013283-route-category-staging`
...
- `obs-evo-cand-013283-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013283-route-evolution-graph`
