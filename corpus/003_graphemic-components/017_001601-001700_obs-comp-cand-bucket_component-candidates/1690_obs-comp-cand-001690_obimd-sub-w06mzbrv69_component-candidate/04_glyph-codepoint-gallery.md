# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001690
...
| --- | --- | --- | --- |
| `obimd-glyph-link-026141` | 󹳑 | `U+F9CD1` | `reviewed_metadata_only` |
| `obimd-glyph-link-026142` | 󹳒 | `U+F9CD2` | `reviewed_metadata_only` |
