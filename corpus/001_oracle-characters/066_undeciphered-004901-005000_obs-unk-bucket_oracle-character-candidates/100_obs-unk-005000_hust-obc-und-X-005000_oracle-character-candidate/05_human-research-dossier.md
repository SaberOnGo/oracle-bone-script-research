# obs-unk-005000 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005000`
- primary external id: `hust-obc-und-X-005000`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/100_obs-unk-005000_h
  ust-obc-und-X-005000_oracle-character-candidate/03_visual-assets/001_asset
  -006593_hust-obc-und-X-005000_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/556/X_？_7535_1.png`
- asset id: `asset-006593`
...
- source class: `HUST-OBC/undeciphered/X/556/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/556/X_？_7535_1.png`
- asset id: `asset-006593`
...
- Which source records identify obs-unk-005000 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005000？
