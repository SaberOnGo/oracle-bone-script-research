...
- External category reference: `evobc-cat-01359`
- Source category ID: `01359`
- Source label for human review: `匽`
- Source codepoints: `U+533D`
...
- `obs-evo-cand-001359-route-category-staging`
...
- `obs-evo-cand-001359-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001359-route-evolution-graph`
