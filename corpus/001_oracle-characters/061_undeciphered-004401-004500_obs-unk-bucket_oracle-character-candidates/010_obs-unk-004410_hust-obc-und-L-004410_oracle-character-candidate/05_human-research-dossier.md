# obs-unk-004410 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/010_obs-unk-004410_h
  ust-obc-und-L-004410_oracle-character-candidate/03_visual-assets/001_asset
  -006003_hust-obc-und-L-004410_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4410/L_？_9865.jpg`
- asset id: `asset-006003`
...
- source class: `HUST-OBC/undeciphered/L/4410/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4410/L_？_9865.jpg`
- asset id: `asset-006003`
...
- English observation: `An upper-left opening leads toward a dark diagonal`
  `trace and a short lower curve.`
- 中文观察: `左上空隙向深色斜痕和下部短弧痕方向延伸。`
...
- Which source records identify obs-unk-004410 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004410？
