# Material Visual Observation / obs-comp-cand-001227 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001227`
- External reference / 外部参照: `obimd-sub-su2e76dtfo`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015465_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/su2e76dtfo/su2e76dtfo/su2e76dtfo.png`
- Checksum / 校验和:
  `015dcedf2b4f4c2a4a835aa6c090bcde403909b6c7592a6d8bd020160656bb40`
...
- Marked-pixel bounds: (83,19)–(168,231); span 86 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.64%。
- 痕迹范围：(83,19)–(168,231)；跨度86 × 213 px；痕迹矩形高于宽。
