...
- Project ID: `obs-evo-cand-008006`
- EVOBC category candidate ID: `evobc-evo-cat-08006`
- External category reference: `evobc-cat-08006`
- Source category ID: `08006`
- Source label for human review: `褐`
- Source codepoints: `U+8910`
...
- `obs-evo-cand-008006-route-category-staging`
...
- `obs-evo-cand-008006-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008006-route-evolution-graph`
