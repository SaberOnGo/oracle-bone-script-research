# obs-unk-004272 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004272`
- primary external id: `hust-obc-und-L-004272`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/072_obs-unk-004272_h
  ust-obc-und-L-004272_oracle-character-candidate/03_visual-assets/001_asset
  -005865_hust-obc-und-L-004272_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4272/L_？_9437.jpg`
- asset id: `asset-005865`
...
- source class: `HUST-OBC/undeciphered/L/4272/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4272/L_？_9437.jpg`
- asset id: `asset-005865`
...
- English observation: `Upper bars, central trace, lower curve visible.`
- 中文观察: `顶部横痕、中央痕迹和下部弯曲痕迹可见。`
...
- Which source records identify obs-unk-004272 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004272？
