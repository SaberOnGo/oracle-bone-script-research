...
- External category reference: `evobc-cat-05297`
- Source category ID: `05297`
- Source label for human review: `猤`
...
- `obs-evo-cand-005297-route-category-staging`
...
- `obs-evo-cand-005297-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005297-route-evolution-graph`
