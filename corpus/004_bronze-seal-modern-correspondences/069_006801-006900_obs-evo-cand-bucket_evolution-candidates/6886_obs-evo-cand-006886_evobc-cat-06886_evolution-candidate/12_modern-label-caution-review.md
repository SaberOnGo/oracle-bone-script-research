# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006886
...
- EVOBC candidate category: `evobc-evo-cat-06886`.
- Source label for search only: `翟`.
- Source codepoints for search only: `U+7FDF`.
