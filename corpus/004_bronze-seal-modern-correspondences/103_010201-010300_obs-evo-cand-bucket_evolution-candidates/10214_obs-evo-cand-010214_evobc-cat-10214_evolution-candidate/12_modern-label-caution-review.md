# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010214
...
- EVOBC candidate category: `evobc-evo-cat-10214`.
- Source label for search only: `騋`.
- Source codepoints for search only: `U+9A0B`.
