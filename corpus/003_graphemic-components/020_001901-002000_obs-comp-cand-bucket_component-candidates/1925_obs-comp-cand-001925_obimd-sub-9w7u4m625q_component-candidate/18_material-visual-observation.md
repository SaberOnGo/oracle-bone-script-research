# Material Visual Observation / obs-comp-cand-001925 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001925`
- External reference / 外部参照: `obimd-sub-9w7u4m625q`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018335_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9w7u4m625q/9w7u4m625q/9w7u4m625q.png`
- Checksum / 校验和:
  `f835bc98b6336900994db7dd7261c8b51b850dac86aaf57f8cbd5def31030aa1`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.35%.
- Marked-pixel bounds: (47,27)–(204,220); span 158 × 194 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.35%。
- 痕迹范围：(47,27)–(204,220)；跨度158 × 194 px；痕迹矩形高于宽。
