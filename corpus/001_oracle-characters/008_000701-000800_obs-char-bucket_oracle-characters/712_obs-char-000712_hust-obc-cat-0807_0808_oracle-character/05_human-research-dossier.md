# obs-char-000712 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/712_obs-char-000712_hust-obc-cat-0807_0808
  _oracle-character/03_visual-assets/001_asset-000717_hust-obc-cat-0807_0808
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0807_0808/0807/G_0807_前2.5.5(甲)
  .png`
- asset id: `asset-000717`
...
- source category: `0807_0808`
- validation class: `711`
- source image route: `HUST-OBC/deciphered/0807_0808/0807/G_0807_前2.5.5(甲).png
  `
- asset id: `asset-000717`
...
- English observation: `Two adjacent dark oval or diamond-like loops contain
  central crossings and forked tops, while a detached shallow curved basin
  lies below them.`
- 中文观察: `两个相邻深色椭圆或菱形环含中央交叉和叉状顶部，下方另有分离浅弯槽。`
...
- dataset label text: `㜝㜞`
- dataset label codepoints: `U+371D;U+371E`
...
- graph edge count: `2`
- codepoint routes: `U+371D;U+371E`
...
- Which source records identify obs-char-000712 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000712？
