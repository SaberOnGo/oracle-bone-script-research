# obs-unk-004280 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004280`
- primary external id: `hust-obc-und-L-004280`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/080_obs-unk-004280_h
  ust-obc-und-L-004280_oracle-character-candidate/03_visual-assets/001_asset
  -005873_hust-obc-und-L-004280_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4280/L_？_9452.jpg`
- asset id: `asset-005873`
...
- source class: `HUST-OBC/undeciphered/L/4280/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4280/L_？_9452.jpg`
- asset id: `asset-005873`
...
- English observation: `Upper cluster, tapered outline, right trace visible.`
- 中文观察: `上部痕迹簇、收窄轮廓和右侧痕迹可见。`
...
- Which source records identify obs-unk-004280 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004280？
