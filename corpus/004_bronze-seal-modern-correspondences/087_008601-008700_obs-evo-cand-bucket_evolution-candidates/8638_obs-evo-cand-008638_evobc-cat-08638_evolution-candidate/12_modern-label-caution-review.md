# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008638
...
- EVOBC candidate category: `evobc-evo-cat-08638`.
- Source label for search only: `贿`.
- Source codepoints for search only: `U+8D3F`.
