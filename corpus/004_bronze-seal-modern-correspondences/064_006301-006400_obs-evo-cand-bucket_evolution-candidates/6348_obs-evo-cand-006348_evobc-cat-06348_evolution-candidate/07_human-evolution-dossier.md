...
- Project ID: `obs-evo-cand-006348`
- EVOBC category candidate ID: `evobc-evo-cat-06348`
- External category reference: `evobc-cat-06348`
- Source category ID: `06348`
- Source label for human review: `簜`
- Source codepoints: `U+7C1C`
...
- `obs-evo-cand-006348-route-category-staging`
...
- `obs-evo-cand-006348-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006348-route-evolution-graph`
