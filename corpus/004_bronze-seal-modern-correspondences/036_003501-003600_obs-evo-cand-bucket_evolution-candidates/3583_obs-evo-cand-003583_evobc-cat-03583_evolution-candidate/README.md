# obs-evo-cand-003583 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-03583`
- Source label: `敓`
- Source codepoints: `U+6553`
- Image reference count: `116`
- Era token counts: `BI:3;SS:1;WSC:112`
- Source token counts: `Book:16;Web:100`

## Observed Code Rows / 观察到的代码行

- era 1 / BI: 3 image references
- era 2 / SS: 1 image references
- era 4 / WSC: 112 image references
