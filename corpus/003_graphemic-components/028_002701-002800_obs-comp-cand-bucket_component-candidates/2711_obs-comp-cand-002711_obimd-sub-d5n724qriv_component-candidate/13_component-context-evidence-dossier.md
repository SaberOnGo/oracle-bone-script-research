# obs-comp-cand-002711 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002711`
- 首选外部 ID: `obimd-sub-d5n724qriv`
- OBIMD subcharacter UID: `d5n724qriv`
- OBIMD main character UID: `d5n724qriv`
- 来源 ID: `src-obimd`
...
- codepoint 示例: U+FF4B5; U+FF4B6; 另有 27 项
