# Material Visual Observation / obs-comp-cand-000212 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000212`
- External reference / 外部参照: `obimd-sub-diesgffg1o`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011857_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/diesgffg1o/diesgffg1o/diesgffg1o.png`
- Checksum / 校验和:
  `5fa92fd3bd64d3244a5e805608fa6c7642b38ce059b2eb6898e24665d254bf1f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.75%.
- Marked-pixel bounds: (87,15)–(157,232); span 71 × 218 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.75%。
- 痕迹范围：(87,15)–(157,232)；跨度71 × 218 px；痕迹矩形高于宽。
