# Material Visual Observation / obs-comp-cand-002479 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002479`
- External reference / 外部参照: `obimd-sub-h4btgo2nw7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020664_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bb0wdwlexf/h4btgo2nw7/h4btgo2nw7.png`
- Checksum / 校验和:
  `24fb56916dc879d67038a65faf8f903ba48393f20d6f51ce18640d01399a9d92`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.31%.
- Marked-pixel bounds: (59,60)–(190,189); span 132 × 130 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.31%。
- 痕迹范围：(59,60)–(190,189)；跨度132 × 130 px；痕迹矩形近方形。
