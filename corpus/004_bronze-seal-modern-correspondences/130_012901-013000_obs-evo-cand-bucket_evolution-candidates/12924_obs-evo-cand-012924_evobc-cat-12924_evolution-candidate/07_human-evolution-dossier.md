...
- External category reference: `evobc-cat-12924`
- Source category ID: `12924`
- Source label for human review: `𫉂`
- Source codepoints: `U+2B242`
...
- `obs-evo-cand-012924-route-category-staging`
...
- `obs-evo-cand-012924-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012924-route-evolution-graph`
