# obs-unk-004468 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/068_obs-unk-004468_h
  ust-obc-und-X-004468_oracle-character-candidate/03_visual-assets/001_asset
  -006061_hust-obc-und-X-004468_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/24/X_？_8203_1.png`
- asset id: `asset-006061`
...
- source class: `HUST-OBC/undeciphered/X/24/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/24/X_？_8203_1.png`
- asset id: `asset-006061`
...
- English observation: A noisy rubbing crop shows central crossings, a small
  enclosed opening, and a broad lower curve.
- 中文观察: 噪声较多的拓片裁切中有中部交叉、小封闭开口和下部弧线。
...
- Which source records identify obs-unk-004468 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004468？
