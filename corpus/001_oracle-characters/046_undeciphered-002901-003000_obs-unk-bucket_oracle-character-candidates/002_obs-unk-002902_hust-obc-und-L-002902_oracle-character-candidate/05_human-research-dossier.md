# obs-unk-002902 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/046_undeciphered-002
  901-003000_obs-unk-bucket_oracle-character-candidates/002_obs-unk-002902_h
  ust-obc-und-L-002902_oracle-character-candidate/03_visual-assets/001_asset
  -004495_hust-obc-und-L-002902_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2902/L_？_4984.jpg`
- asset id: `asset-004495`
...
- source class: `HUST-OBC/undeciphered/L/2902/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2902/L_？_4984.jpg`
- asset id: `asset-004495`
...
- Which source records identify obs-unk-002902 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002902？
