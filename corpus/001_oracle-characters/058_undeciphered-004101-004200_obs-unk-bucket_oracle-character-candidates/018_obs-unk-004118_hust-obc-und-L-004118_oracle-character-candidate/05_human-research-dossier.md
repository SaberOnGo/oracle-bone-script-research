# obs-unk-004118 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/018_obs-unk-004118_h
  ust-obc-und-L-004118_oracle-character-candidate/03_visual-assets/001_asset
  -005711_hust-obc-und-L-004118_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4118/L_？_8870.jpg`
- asset id: `asset-005711`
...
- source class: `HUST-OBC/undeciphered/L/4118/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4118/L_？_8870.jpg`
- asset id: `asset-005711`
...
- English observation: The opened image shows a compact upper outline, two
  lower-left traces, and a denser right-side group.
- 中文观察：已打开图像可见紧凑上部轮廓、左下两条痕迹和右侧密集痕迹组。
...
- Which source records identify obs-unk-004118 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004118？
