...
- Project ID / 项目 ID: `obs-char-001570`
- Primary external ID / 首选外部 ID: `hust-obc-cat-1762`
...
- Source image / 来源图: `G_1762_前1.15.6(甲).png`
- Image / 图像: `001_asset-001575_hust-obc-cat-1762_glyph.png`
...
- target node: `evobc-evo-cat-00159`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00159`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00159`
...
- Matched candidate folders / 匹配候选目录: `evobc-evo-cat-00159`
- Human review files / 人类复核文件:
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/159_obs-evo-cand-000159_evobc-cat-00159_evoluti
...
- Source label text / 来源标签文字: `㫘`
- Source label codepoint / 来源标签 codepoint: `U+3AD8`
