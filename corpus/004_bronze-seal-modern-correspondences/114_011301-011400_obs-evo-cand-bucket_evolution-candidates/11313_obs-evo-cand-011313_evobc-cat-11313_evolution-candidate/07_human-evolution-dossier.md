...
- External category reference: `evobc-cat-11313`
- Source category ID: `11313`
- Source label for human review: `𢱭`
- Source codepoints: `U+22C6D`
- Image reference count in source metadata: `118`
...
- `obs-evo-cand-011313-route-category-staging`
...
- `obs-evo-cand-011313-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011313-route-evolution-graph`
