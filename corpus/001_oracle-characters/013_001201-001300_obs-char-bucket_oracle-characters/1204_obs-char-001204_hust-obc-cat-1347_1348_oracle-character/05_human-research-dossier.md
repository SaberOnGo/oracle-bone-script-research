# obs-char-001204 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1204_obs-char-001204_hust-obc-cat-1347_134
  8_oracle-character/03_visual-assets/001_asset-001209_hust-obc-cat-1347_134
  8_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1347_1348/1347/G_1347_乙1050合135
  84賓組.png`
- asset id: `asset-001209`
...
- source category: `1347_1348`
- validation class: `1203`
- source image route: `HUST-OBC/deciphered/1347_1348/1347/G_1347_乙1050合13584賓組
  .png`
- asset id: `asset-001209`
...
- English observation: `Two adjacent narrow forms each contain a rounded
  middle loop and a pointed upper and lower end.`
- 中文观察: `两个相邻的狭长形体各自有中央圆弧环以及尖状上端和下端。`
...
- dataset label text: `㤹㤺`
- dataset label codepoints: `U+3939;U+393A`
...
- Which source records identify obs-char-001204 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001204？
