# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010341
...
- EVOBC candidate category: `evobc-evo-cat-10341`.
- Source label for search only: `鬭`.
- Source codepoints for search only: `U+9B2D`.
