# obs-char-000570 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000570`
- primary external id: `hust-obc-cat-0646`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/570_obs-char-000570_hust-obc-cat-0646_orac
  le-character/03_visual-assets/001_asset-000575_hust-obc-cat-0646_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0646/G_0646_乙8809(甲).png`
- asset id: `asset-000575`
...
- source category: `0646`
- validation class: `569`
- source image route: `HUST-OBC/deciphered/0646/G_0646_乙8809(甲).png`
- asset id: `asset-000575`
...
- English observation: `A single wavering vertical form has a small angular
  hook near the top, a sharp middle bend, and a long curved tapered lower
  tail.`
- 中文观察: `单个波折竖形近顶部有小折钩，中部急转，下方延伸长弯渐尖尾笔。`
...
- dataset label text: `㙼`
- dataset label codepoints: `U+367C`
...
- Which source records identify obs-char-000570 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000570？
