# Material Visual Observation / obs-comp-cand-000811 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000811`
- External reference / 外部参照: `obimd-sub-02fjn8nulq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013607_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/02fjn8nulq/02fjn8nulq/02fjn8nulq.png`
- Checksum / 校验和:
  `14181c1bdf0b5b47896c5e165879d86e9eece7f8257163a6927ca936807ce6b7`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.72%.
- Marked-pixel bounds: (41,39)–(207,213); span 167 × 175 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.72%。
- 痕迹范围：(41,39)–(207,213)；跨度167 × 175 px；痕迹矩形近方形。
