...
- `obs-evo-cand-005162-route-category-staging`
...
- `obs-evo-cand-005162-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005162-route-evolution-graph`
