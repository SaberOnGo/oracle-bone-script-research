...
- External category reference: `evobc-cat-06238`
- Source category ID: `06238`
- Source label for human review: `符`
- Source codepoints: `U+7B26`
...
- `obs-evo-cand-006238-route-category-staging`
...
- `obs-evo-cand-006238-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006238-route-evolution-graph`
