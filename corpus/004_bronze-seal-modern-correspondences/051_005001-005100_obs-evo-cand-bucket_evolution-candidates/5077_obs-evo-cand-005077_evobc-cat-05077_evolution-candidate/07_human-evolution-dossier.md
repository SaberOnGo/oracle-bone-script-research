...
- External category reference: `evobc-cat-05077`
- Source category ID: `05077`
- Source label for human review: `烰`
...
- `obs-evo-cand-005077-route-category-staging`
...
- `obs-evo-cand-005077-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005077-route-evolution-graph`
