# Material Visual Observation / obs-comp-cand-002498 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002498`
- External reference / 外部参照: `obimd-sub-ewbruo40n9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020752_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/s2e076ohb1/ewbruo40n9/ewbruo40n9.png`
- Checksum / 校验和:
  `98263e4a3776b0b7b6a580e0ef749aa915600d9e72b8035eb11966d17092f83c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.54%.
- Marked-pixel bounds: (53,52)–(202,197); span 150 × 146 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.54%。
- 痕迹范围：(53,52)–(202,197)；跨度150 × 146 px；痕迹矩形近方形。
