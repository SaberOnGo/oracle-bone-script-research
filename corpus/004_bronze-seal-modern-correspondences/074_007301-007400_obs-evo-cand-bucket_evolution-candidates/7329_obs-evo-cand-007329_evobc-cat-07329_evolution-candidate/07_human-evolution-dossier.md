...
- Project ID: `obs-evo-cand-007329`
- EVOBC category candidate ID: `evobc-evo-cat-07329`
- External category reference: `evobc-cat-07329`
- Source category ID: `07329`
- Source label for human review: `茷`
- Source codepoints: `U+8337`
...
- `obs-evo-cand-007329-route-category-staging`
...
- `obs-evo-cand-007329-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007329-route-evolution-graph`
