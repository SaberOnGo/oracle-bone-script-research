...
- External category reference: `evobc-cat-04111`
- Source category ID: `04111`
- Source label for human review: `棷`
...
- `obs-evo-cand-004111-route-category-staging`
...
- `obs-evo-cand-004111-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004111-route-evolution-graph`
