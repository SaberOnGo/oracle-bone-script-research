...
Project ID: `obs-evo-cand-010731`
...
- Project ID: `obs-evo-cand-010731`
- EVOBC category candidate ID: `evobc-evo-cat-10731`
- External category reference: `evobc-cat-10731`
- Source category ID: `10731`
- Source label for human review: `齭`
- Source codepoints: `U+9F6D`
...
- `obs-evo-cand-010731-route-category-staging`
...
- `obs-evo-cand-010731-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010731-route-evolution-graph`
