...
- External category reference: `evobc-cat-08280`
- Source category ID: `08280`
- Source label for human review: `諣`
...
- `obs-evo-cand-008280-route-category-staging`
...
- `obs-evo-cand-008280-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008280-route-evolution-graph`
