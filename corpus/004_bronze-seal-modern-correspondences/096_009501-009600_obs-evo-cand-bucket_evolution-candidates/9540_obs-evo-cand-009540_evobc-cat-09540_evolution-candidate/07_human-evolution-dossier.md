...
- External category reference: `evobc-cat-09540`
- Source category ID: `09540`
- Source label for human review: `鐻`
- Source codepoints: `U+943B`
...
- `obs-evo-cand-009540-route-category-staging`
...
- `obs-evo-cand-009540-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009540-route-evolution-graph`
