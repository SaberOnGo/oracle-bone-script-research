...
- External category reference: `evobc-cat-06025`
- Source category ID: `06025`
- Source label for human review: `禛`
- Source codepoints: `U+799B`
...
- `obs-evo-cand-006025-route-category-staging`
...
- `obs-evo-cand-006025-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006025-route-evolution-graph`
