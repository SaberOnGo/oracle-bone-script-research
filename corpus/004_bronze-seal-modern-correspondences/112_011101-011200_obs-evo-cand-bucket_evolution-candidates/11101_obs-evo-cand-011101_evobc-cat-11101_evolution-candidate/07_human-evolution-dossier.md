...
- External category reference: `evobc-cat-11101`
- Source category ID: `11101`
- Source label for human review: `𡱯`
...
- `obs-evo-cand-011101-route-category-staging`
...
- `obs-evo-cand-011101-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011101-route-evolution-graph`
