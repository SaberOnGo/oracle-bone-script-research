...
- External category reference: `evobc-cat-13580`
- Source category ID: `13580`
- Source label for human review: `𭹦`
...
- `obs-evo-cand-013580-route-category-staging`
...
- `obs-evo-cand-013580-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013580-route-evolution-graph`
