# obs-unk-004774 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004774`
- primary external id: `hust-obc-und-X-004774`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/074_obs-unk-004774_h
  ust-obc-und-X-004774_oracle-character-candidate/03_visual-assets/001_asset
  -006367_hust-obc-und-X-004774_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/330/X_？_7314_1.png`
- asset id: `asset-006367`
...
- source class: `HUST-OBC/undeciphered/X/330/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/330/X_？_7314_1.png`
- asset id: `asset-006367`
...
- English observation: `long upper curve, central branches, and lower terminal`
- 中文观察: `上部长曲线、中央分支和下部末端`
...
- Which source records identify obs-unk-004774 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004774？
