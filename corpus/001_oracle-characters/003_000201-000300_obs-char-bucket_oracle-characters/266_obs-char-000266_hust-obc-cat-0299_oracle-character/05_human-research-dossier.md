# obs-char-000266 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/266_obs-char-000266_hust-obc-cat-0299_orac
  le-character/03_visual-assets/001_asset-000271_hust-obc-cat-0299_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0299/G_0299_乙3029合18187賓組.png`
- asset id: `asset-000271`
...
- source category: `0299`
- validation class: `265`
- source image route: `HUST-OBC/deciphered/0299/G_0299_乙3029合18187賓組.png`
- asset id: `asset-000271`
...
- English observation: `The upright image has a pointed upper junction, two
  curved outer strokes, and a small enclosed mark along the central axis.`
- 中文观察: `直立图像上方有尖状连接处，两道弯曲外侧笔画，中轴线上有小型闭合痕迹。`
...
- dataset label text: `㔡`
- dataset label codepoints: `U+3521`
...
- filename catalog route clues: `Heji-like filename clue: 合18187
  (G_0299_乙3029合18187賓組.png)`
...
- Which source records identify obs-char-000266 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000266？
