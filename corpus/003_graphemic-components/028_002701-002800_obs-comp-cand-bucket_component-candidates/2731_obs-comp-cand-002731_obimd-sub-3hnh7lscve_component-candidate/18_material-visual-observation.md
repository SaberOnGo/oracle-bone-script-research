# Material Visual Observation / obs-comp-cand-002731 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002731`
- External reference / 外部参照: `obimd-sub-3hnh7lscve`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021347_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3hnh7lscve/3hnh7lscve/3hnh7lscve.png`
- Checksum / 校验和:
  `563df21c26a09b060253d0fd0bca653e75355dd1db5757cd47c3a0ab6b6d0463`
...
- Marked-pixel bounds: (82,10)–(151,239); span 70 × 230 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.60%。
- 痕迹范围：(82,10)–(151,239)；跨度70 × 230 px；痕迹矩形高于宽。
