# obs-comp-cand-001078 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001078`
- 首选外部 ID: `obimd-sub-avzjpgqkym`
- OBIMD subcharacter UID: `avzjpgqkym`
- OBIMD main character UID: `avzjpgqkym`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `6`
- codepoint 示例: U+81ED;U+F6318; U+F6319; 另有 4 项
