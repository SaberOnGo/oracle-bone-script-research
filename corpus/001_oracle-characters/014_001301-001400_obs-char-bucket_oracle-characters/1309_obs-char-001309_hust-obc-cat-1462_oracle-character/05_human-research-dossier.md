# obs-char-001309 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1309_obs-char-001309_hust-obc-cat-1462_ora
  cle-character/03_visual-assets/001_asset-001314_hust-obc-cat-1462_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1462/G_1462_乙9078合20587𠂤組.png`
- asset id: `asset-001314`
...
- source category: `1462`
- validation class: `1308`
- source image route: `HUST-OBC/deciphered/1462/G_1462_乙9078合20587𠂤組.png`
- asset id: `asset-001314`
...
- English observation: `A small upper angular enclosure leads into two
  descending strokes and a separate long right curve.`
- 中文观察: `小型上部折角框形向下连接两条下行笔画，右侧另有一条长弧线。`
...
- dataset label text: `㦬`
- dataset label codepoints: `U+39AC`
...
- filename catalog route clues: `Heji-like filename clue: 合20587
  (G_1462_乙9078合20587𠂤組.png)`
...
- Which source records identify obs-char-001309 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001309？
