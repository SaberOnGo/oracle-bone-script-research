...
- External category reference: `evobc-cat-04172`
- Source category ID: `04172`
- Source label for human review: `楸`
...
- `obs-evo-cand-004172-route-category-staging`
...
- `obs-evo-cand-004172-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004172-route-evolution-graph`
