# obs-unk-004816 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004816`
- primary external id: `hust-obc-und-X-004816`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/016_obs-unk-004816_h
  ust-obc-und-X-004816_oracle-character-candidate/03_visual-assets/001_asset
  -006409_hust-obc-und-X-004816_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/372/X_？_7356_1.png`
- asset id: `asset-006409`
...
- source class: `HUST-OBC/undeciphered/X/372/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/372/X_？_7356_1.png`
- asset id: `asset-006409`
...
- English observation: `upper loop, central support, and two long curves`
- 中文观察: `上部环状结构、中部支撑笔画和两条长曲线`
...
- Which source records identify obs-unk-004816 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004816？
