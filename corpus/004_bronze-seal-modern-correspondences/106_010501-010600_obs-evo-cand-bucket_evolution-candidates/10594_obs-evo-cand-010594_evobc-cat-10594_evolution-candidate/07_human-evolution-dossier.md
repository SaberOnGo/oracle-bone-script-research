...
- External category reference: `evobc-cat-10594`
- Source category ID: `10594`
- Source label for human review: `鹹`
...
- `obs-evo-cand-010594-route-category-staging`
...
- `obs-evo-cand-010594-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010594-route-evolution-graph`
