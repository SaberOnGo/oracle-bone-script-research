...
Project ID: `obs-evo-cand-002602`
...
- Project ID: `obs-evo-cand-002602`
- EVOBC category candidate ID: `evobc-evo-cat-02602`
- External category reference: `evobc-cat-02602`
- Source category ID: `02602`
- Source label for human review: `嶼`
- Source codepoints: `U+5DBC`
...
- `obs-evo-cand-002602-route-category-staging`
...
- `obs-evo-cand-002602-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002602-route-evolution-graph`
