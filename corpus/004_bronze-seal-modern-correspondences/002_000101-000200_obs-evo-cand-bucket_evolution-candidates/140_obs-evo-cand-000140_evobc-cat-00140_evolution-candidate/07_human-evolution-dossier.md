...
- Project ID: `obs-evo-cand-000140`
- EVOBC category candidate ID: `evobc-evo-cat-00140`
- External category reference: `evobc-cat-00140`
- Source category ID: `00140`
- Source label for human review: `㦹`
- Source codepoints: `U+39B9`
...
- `obs-evo-cand-000140-route-category-staging`
...
- `obs-evo-cand-000140-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000140-route-evolution-graph`
