...
Project ID: `obs-evo-cand-007252`
...
- Project ID: `obs-evo-cand-007252`
- EVOBC category candidate ID: `evobc-evo-cat-07252`
- External category reference: `evobc-cat-07252`
- Source category ID: `07252`
- Source label for human review: `芧`
- Source codepoints: `U+82A7`
...
- `obs-evo-cand-007252-route-category-staging`
...
- `obs-evo-cand-007252-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007252-route-evolution-graph`
