# obs-char-000190 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/190_obs-char-000190_hust-obc-cat-0210_0211
  _oracle-character/03_visual-assets/001_asset-000195_hust-obc-cat-0210_0211
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0210_0211/0210/G_0210_合28078無名組
  .png`
- asset id: `asset-000195`
...
- source category: `0210_0211`
- validation class: `189`
- source image route: `HUST-OBC/deciphered/0210_0211/0210/G_0210_合28078無名組.png
  `
- asset id: `asset-000195`
...
- English observation: `The image has a pointed upper enclosure with long
  strokes descending on both sides and a shorter diagonal projection toward
  the right.`
...
- dataset label text: `㓈㓉`
- dataset label codepoints: `U+34C8;U+34C9`
...
- filename catalog route clues: `Heji-like filename clue: 合28078
...
- Which source records identify obs-char-000190 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000190？
