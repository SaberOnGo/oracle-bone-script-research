...
Project ID: `obs-evo-cand-009938`
...
- Project ID: `obs-evo-cand-009938`
- EVOBC category candidate ID: `evobc-evo-cat-09938`
- External category reference: `evobc-cat-09938`
- Source category ID: `09938`
- Source label for human review: `韋`
- Source codepoints: `U+97CB`
- Image reference count in source metadata: `139`
...
- `obs-evo-cand-009938-route-category-staging`
...
- `obs-evo-cand-009938-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009938-route-evolution-graph`
