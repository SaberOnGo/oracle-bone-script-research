...
- External category reference: `evobc-cat-05395`
- Source category ID: `05395`
- Source label for human review: `珷`
- Source codepoints: `U+73F7`
...
- `obs-evo-cand-005395-route-category-staging`
...
- `obs-evo-cand-005395-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005395-route-evolution-graph`
