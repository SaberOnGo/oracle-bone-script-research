# obs-char-001583 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001583`
- primary external id: `hust-obc-cat-1775`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1583_obs-char-001583_hust-obc-cat-1775_ora
  cle-character/03_visual-assets/001_asset-001588_hust-obc-cat-1775_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1775/G_1775_屯2539(甲).png`
- asset id: `asset-001588`
...
- source category: `1775`
- validation class: `1582`
- source image route: `HUST-OBC/deciphered/1775/G_1775_屯2539(甲).png`
- asset id: `asset-001588`
...
- English observation: `Two adjacent forms show a gridded branching left
  cluster and a curved right enclosure.`
- 中文观察: `两个相邻形体左侧有格状分枝笔画群，右侧有弧形框状轮廓。`
...
- dataset label text: `㫥`
- dataset label codepoints: `U+3AE5`
...
- Which source records identify obs-char-001583 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001583？
