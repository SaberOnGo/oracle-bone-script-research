...
Project ID: `obs-insc-cw-cand-000604`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000604`
...
- Yingguo / 英国所藏: `y2663` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `384` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `655` in source row; primary catalog entry pending
- Heji / 合集: `41939` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000604`
