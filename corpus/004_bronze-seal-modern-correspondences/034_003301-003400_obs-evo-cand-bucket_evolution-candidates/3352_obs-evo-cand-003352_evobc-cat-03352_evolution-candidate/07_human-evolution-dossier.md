...
- External category reference: `evobc-cat-03352`
- Source category ID: `03352`
- Source label for human review: `挩`
...
- `obs-evo-cand-003352-route-category-staging`
...
- `obs-evo-cand-003352-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003352-route-evolution-graph`
