...
- External category reference: `evobc-cat-09083`
- Source category ID: `09083`
- Source label for human review: `邐`
- Source codepoints: `U+9090`
...
- `obs-evo-cand-009083-route-category-staging`
...
- `obs-evo-cand-009083-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009083-route-evolution-graph`
