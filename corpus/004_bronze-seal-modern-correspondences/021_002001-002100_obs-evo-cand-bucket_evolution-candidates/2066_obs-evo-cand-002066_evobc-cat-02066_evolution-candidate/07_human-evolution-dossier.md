...
- External category reference: `evobc-cat-02066`
- Source category ID: `02066`
- Source label for human review: `妀`
- Source codepoints: `U+5980`
...
- `obs-evo-cand-002066-route-category-staging`
...
- `obs-evo-cand-002066-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002066-route-evolution-graph`
