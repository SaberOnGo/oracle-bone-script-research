# obs-unk-004391 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004391`
- primary external id: `hust-obc-und-L-004391`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/091_obs-unk-004391_h
  ust-obc-und-L-004391_oracle-character-candidate/03_visual-assets/001_asset
  -005984_hust-obc-und-L-004391_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4391/L_？_9762.jpg`
- asset id: `asset-005984`
...
- source class: `HUST-OBC/undeciphered/L/4391/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4391/L_？_9762.jpg`
- asset id: `asset-005984`
...
- English observation: `A broad upper trace descends to an angular`
  `lower opening with a pointed base.`
- 中文观察: `上部宽痕向下连接斜角下部空隙，底部呈尖状。`
...
- Which source records identify obs-unk-004391 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004391？
