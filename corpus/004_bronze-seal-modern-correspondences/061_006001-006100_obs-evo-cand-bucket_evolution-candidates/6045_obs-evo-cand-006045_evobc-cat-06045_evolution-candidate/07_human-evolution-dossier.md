...
Project ID: `obs-evo-cand-006045`
...
- Project ID: `obs-evo-cand-006045`
- EVOBC category candidate ID: `evobc-evo-cat-06045`
- External category reference: `evobc-cat-06045`
- Source category ID: `06045`
- Source label for human review: `禼`
- Source codepoints: `U+79BC`
...
- `obs-evo-cand-006045-route-category-staging`
...
- `obs-evo-cand-006045-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006045-route-evolution-graph`
