# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006094
...
- EVOBC candidate category: `evobc-evo-cat-06094`.
- Source label for search only: `稍`.
- Source codepoints for search only: `U+7A0D`.
