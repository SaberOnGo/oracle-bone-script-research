# Material Visual Observation / obs-comp-cand-000191 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000191`
- External reference / 外部参照: `obimd-sub-2h3rwms23l`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011752_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2h3rwms23l/2h3rwms23l/2h3rwms23l.png`
- Checksum / 校验和:
  `986f4750826c11fb03007fbdf81bf2780a79758f1a6d5b5a29fa6cdad2edf589`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.87%.
- Marked-pixel bounds: (66,32)–(183,211); span 118 × 180 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.87%。
- 痕迹范围：(66,32)–(183,211)；跨度118 × 180 px；痕迹矩形高于宽。
