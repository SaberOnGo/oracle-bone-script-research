# Human Research Readiness Review / 人类研究准备度复核: coll-obj-cand-00019
...
| --- | --- | --- |
| Catalog source | `763` | `02_collection-source-index.csv` |
...
| Live source page | source description and image checked; rights unresolved | `18_live-source-evidence-review.md` |
...
- Which parenthetic sign, source explanation, or image observation requires
