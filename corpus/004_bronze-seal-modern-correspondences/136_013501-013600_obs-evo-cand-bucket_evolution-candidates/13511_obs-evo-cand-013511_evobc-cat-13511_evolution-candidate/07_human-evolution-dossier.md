...
- External category reference: `evobc-cat-13511`
- Source category ID: `13511`
- Source label for human review: `𭔐`
- Source codepoints: `U+2D510`
...
- `obs-evo-cand-013511-route-category-staging`
...
- `obs-evo-cand-013511-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013511-route-evolution-graph`
