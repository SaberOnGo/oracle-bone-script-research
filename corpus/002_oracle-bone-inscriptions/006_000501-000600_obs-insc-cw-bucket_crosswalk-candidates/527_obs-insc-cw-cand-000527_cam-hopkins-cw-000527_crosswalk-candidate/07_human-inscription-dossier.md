...
Project ID: `obs-insc-cw-cand-000527`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000527`
...
- Source page section: `Period V Group 6` /
  `第 V 期第 6 组`
- Source section key: `period-v-group-6`
- Section declared count: `5`
- Section observed row count: `5`
...
- Yingguo / 英国所藏: `y2523` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `365` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `493` in source row; primary catalog entry pending
- Heji / 合集: `41756` in source row; primary catalog entry pending
...
- Group and batch / 组类与批次: group `6`; batch or pit context pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000527`
