...
Project ID: `obs-insc-cw-cand-000091`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000091`
...
- Yingguo / 英国所藏: `y555` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `100` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `508` in source row; primary catalog entry pending
- Heji / 合集: `39856` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000091`
