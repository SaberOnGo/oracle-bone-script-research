# obs-evo-cand-007902 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-007902`
- EVOBC category candidate ID: `evobc-evo-cat-07902`
- External category ref: `evobc-cat-07902`
- Source label: `行`
- Source codepoints: `U+884C`
- Image reference count: `335`
- Era token counts: `BI:39;CS:2;OBC:80;SAC:20;SS:2;WSC:192`
- Source token counts: `Book:82;Web:253`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 80 image references
- era 1 / BI: 39 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 20 image references
- era 4 / WSC: 192 image references
- era 5 / CS: 2 image references
- source 0 / Web:1633: 1 image references
- source 1 / Web:105952;說文Web:58: 231 image references
- source 2 / Book:17600: 24 image references
- source 3 / Book:21681: 9 image references
- source 4 / Book:9131: 20 image references
