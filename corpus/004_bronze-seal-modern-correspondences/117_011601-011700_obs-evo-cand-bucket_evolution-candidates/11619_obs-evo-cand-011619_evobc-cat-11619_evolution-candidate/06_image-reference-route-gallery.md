...
- `obs-evo-cand-011619-route-category-staging`
...
- `obs-evo-cand-011619-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011619-route-evolution-graph`
