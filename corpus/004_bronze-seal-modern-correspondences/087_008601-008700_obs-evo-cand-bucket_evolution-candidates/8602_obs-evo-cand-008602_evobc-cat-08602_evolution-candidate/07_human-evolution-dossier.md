...
Project ID: `obs-evo-cand-008602`
...
- Project ID: `obs-evo-cand-008602`
- EVOBC category candidate ID: `evobc-evo-cat-08602`
- External category reference: `evobc-cat-08602`
- Source category ID: `08602`
- Source label for human review: `贈`
- Source codepoints: `U+8D08`
...
- `obs-evo-cand-008602-route-category-staging`
...
- `obs-evo-cand-008602-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008602-route-evolution-graph`
