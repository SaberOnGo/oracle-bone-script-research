# obs-unk-008636 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/103_undeciphered-008
  601-008700_obs-unk-bucket_oracle-character-candidates/036_obs-unk-008636_h
  ust-obc-und-YH-008636_oracle-character-candidate/03_visual-assets/001_asse
  t-010227_hust-obc-und-YH-008636_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60CB8/H_？_60CB8_0.png`
- asset id: `asset-010227`
...
- source class: `HUST-OBC/undeciphered/Y+H/60CB8/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60CB8/H_？_60CB8_0.png`
- asset id: `asset-010227`
...
- Which source records identify obs-unk-008636 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008636？
