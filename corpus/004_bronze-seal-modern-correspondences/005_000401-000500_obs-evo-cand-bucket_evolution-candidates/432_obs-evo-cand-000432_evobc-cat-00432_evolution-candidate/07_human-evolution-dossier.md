...
- External category reference: `evobc-cat-00432`
- Source category ID: `00432`
- Source label for human review: `䛮`
- Source codepoints: `U+46EE`
...
- `obs-evo-cand-000432-route-category-staging`
...
- `obs-evo-cand-000432-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000432-route-evolution-graph`
