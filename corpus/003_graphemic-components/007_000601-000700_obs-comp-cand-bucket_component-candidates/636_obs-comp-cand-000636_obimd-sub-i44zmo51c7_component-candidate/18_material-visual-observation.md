# Material Visual Observation / obs-comp-cand-000636 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000636`
- External reference / 外部参照: `obimd-sub-i44zmo51c7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013199_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/i44zmo51c7/i44zmo51c7/i44zmo51c7.png`
- Checksum / 校验和:
  `0653ae929747cb3325a55344386745286002fe9f65ad35cd2a094f2a4ba3195d`
...
- Marked-pixel bounds: (66,20)–(191,226); span 126 × 207 px; the marked
...
- 痕迹范围：(66,20)–(191,226)；跨度126 × 207 px；痕迹矩形高于宽。
