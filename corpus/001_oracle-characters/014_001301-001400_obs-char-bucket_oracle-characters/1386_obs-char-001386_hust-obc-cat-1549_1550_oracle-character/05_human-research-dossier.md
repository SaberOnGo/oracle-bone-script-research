# obs-char-001386 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001386`
- primary external id: `hust-obc-cat-1549_1550`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1386_obs-char-001386_hust-obc-cat-1549_155
  0_oracle-character/03_visual-assets/001_asset-001391_hust-obc-cat-1549_155
  0_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1549_1550/1549/G_1549_乙1956合224
  41𠂤組.png`
- asset id: `asset-001391`
...
- source category: `1549_1550`
- validation class: `1385`
- source image route: `HUST-OBC/deciphered/1549_1550/1549/G_1549_乙1956合22441𠂤組
  .png`
- asset id: `asset-001391`
...
- English observation: `A long diagonal form has several left branches and a
  narrow lower stem.`
- 中文观察: `长斜向形体有数条左部分枝和狭长下部竖干。`
...
- dataset label text: `㨃㨄`
- dataset label codepoints: `U+3A03;U+3A04`
...
- graph edge count: `2`
- codepoint routes: `U+3A03;U+3A04`
...
- filename catalog route clues: `Heji-like filename clue: 合22441
  (G_1549_乙1956合22441𠂤組.png)`
...
- Which source records identify obs-char-001386 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001386？
