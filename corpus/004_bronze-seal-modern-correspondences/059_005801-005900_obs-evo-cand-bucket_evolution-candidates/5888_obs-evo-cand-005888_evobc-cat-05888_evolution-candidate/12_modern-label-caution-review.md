# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-005888
...
- EVOBC candidate category: `evobc-evo-cat-05888`.
- Source label for search only: `矰`.
- Source codepoints for search only: `U+77F0`.
