...
- `obs-evo-cand-002079-route-category-staging`
...
- `obs-evo-cand-002079-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002079-route-evolution-graph`
