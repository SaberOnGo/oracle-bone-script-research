# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003005
...
- EVOBC candidate category: `evobc-evo-cat-03005`.
- Source label for search only: `悌`.
- Source codepoints for search only: `U+608C`.
