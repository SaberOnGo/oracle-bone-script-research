...
- External category reference: `evobc-cat-09865`
- Source category ID: `09865`
- Source label for human review: `霞`
- Source codepoints: `U+971E`
...
- `obs-evo-cand-009865-route-category-staging`
...
- `obs-evo-cand-009865-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009865-route-evolution-graph`
