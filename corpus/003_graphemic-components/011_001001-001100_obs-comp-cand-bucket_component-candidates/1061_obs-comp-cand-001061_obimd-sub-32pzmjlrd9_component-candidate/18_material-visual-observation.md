# Material Visual Observation / obs-comp-cand-001061 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001061`
- External reference / 外部参照: `obimd-sub-32pzmjlrd9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014611_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/32pzmjlrd9/32pzmjlrd9/32pzmjlrd9.png`
- Checksum / 校验和:
  `d0321fb7354e7ca1e4744ccf8d932c682416634a80b9c7529756480f8efb6696`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.51%.
- Marked-pixel bounds: (70,26)–(186,226); span 117 × 201 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.51%。
- 痕迹范围：(70,26)–(186,226)；跨度117 × 201 px；痕迹矩形高于宽。
