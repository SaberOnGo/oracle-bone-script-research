...
- Project ID: `obs-evo-cand-001176`
- EVOBC category candidate ID: `evobc-evo-cat-01176`
- External category reference: `evobc-cat-01176`
- Source category ID: `01176`
- Source label for human review: `刃`
- Source codepoints: `U+5203`
...
- `obs-evo-cand-001176-route-category-staging`
...
- `obs-evo-cand-001176-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001176-route-evolution-graph`
