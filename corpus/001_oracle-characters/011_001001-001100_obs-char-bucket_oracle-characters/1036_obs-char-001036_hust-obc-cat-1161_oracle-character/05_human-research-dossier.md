# obs-char-001036 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1036_obs-char-001036_hust-obc-cat-1161_ora
  cle-character/03_visual-assets/001_asset-001041_hust-obc-cat-1161_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1161/G_1161_京津1578合18759.png`
- asset id: `asset-001041`
...
- source category: `1161`
- validation class: `1035`
- source image route: `HUST-OBC/deciphered/1161/G_1161_京津1578合18759.png`
- asset id: `asset-001041`
...
- English observation: `A faint narrow vertical cluster has small upper
  branches, an irregular central turn, and short lower side strokes.`
...
- dataset label text: `㡿`
- dataset label codepoints: `U+387F`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/096_obs-evo-can
  d-000096_evobc-cat-00096_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/096_obs-evo-cand-000096_evobc-cat-00096_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合18759
...
- Which source records identify obs-char-001036 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001036？
