# obs-char-000121 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000121`
- primary external id: `hust-obc-cat-0135`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/121_obs-char-000121_hust-obc-cat-0135_orac
  le-character/03_visual-assets/001_asset-000126_hust-obc-cat-0135_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0135/G_0135_乙1938反合14207反賓組.png
  `
- asset id: `asset-000126`
...
- source category: `0135`
- validation class: `120`
- source image route: `HUST-OBC/deciphered/0135/G_0135_乙1938反合14207反賓組.png`
- asset id: `asset-000126`
...
- English observation: `The very narrow image forms a pointed upper tip with
  two curved outer strokes narrowing into a long tapering lower line.`
- 中文观察: `极狭长图像上端呈尖点，两侧弯曲外笔向下收拢为长而渐细的下行笔画。`
...
- dataset label text: `㑽`
- dataset label codepoints: `U+347D`
...
- filename catalog route clues: `Heji-like filename clue: 合14207
  (G_0135_乙1938反合14207反賓組.png)`
...
- Which source records identify obs-char-000121 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000121？
