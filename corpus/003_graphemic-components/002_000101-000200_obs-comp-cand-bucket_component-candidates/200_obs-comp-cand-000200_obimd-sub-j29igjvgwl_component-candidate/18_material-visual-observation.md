# Material Visual Observation / obs-comp-cand-000200 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000200`
- External reference / 外部参照: `obimd-sub-j29igjvgwl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011761_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/j29igjvgwl/j29igjvgwl/j29igjvgwl.png`
- Checksum / 校验和:
  `23d76123146e6fb7e36db6f9e0587dcf4026fecbd98237f0869c3c9f176046c9`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.29%.
- Marked-pixel bounds: (82,16)–(167,232); span 86 × 217 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.29%。
- 痕迹范围：(82,16)–(167,232)；跨度86 × 217 px；痕迹矩形高于宽。
