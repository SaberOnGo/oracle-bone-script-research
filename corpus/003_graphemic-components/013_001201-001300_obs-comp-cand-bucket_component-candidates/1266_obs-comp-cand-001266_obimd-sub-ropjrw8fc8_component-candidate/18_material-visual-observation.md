# Material Visual Observation / obs-comp-cand-001266 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001266`
- External reference / 外部参照: `obimd-sub-ropjrw8fc8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015504_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ropjrw8fc8/ropjrw8fc8/ropjrw8fc8.png`
- Checksum / 校验和:
  `ebadc3d690e552b008c6dda20fea4cf4073fcf4322c1bfda9660a0c6c117167f`
...
- Marked-pixel bounds: (69,15)–(164,232); span 96 × 218 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.11%。
- 痕迹范围：(69,15)–(164,232)；跨度96 × 218 px；痕迹矩形高于宽。
