...
- External category reference: `evobc-cat-00937`
- Source category ID: `00937`
- Source label for human review: `倩`
- Source codepoints: `U+5029`
...
- `obs-evo-cand-000937-route-category-staging`
...
- `obs-evo-cand-000937-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000937-route-evolution-graph`
