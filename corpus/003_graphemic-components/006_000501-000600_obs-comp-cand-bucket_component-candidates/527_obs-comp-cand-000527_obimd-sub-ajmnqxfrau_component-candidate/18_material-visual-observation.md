# Material Visual Observation / obs-comp-cand-000527 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000527`
- External reference / 外部参照: `obimd-sub-ajmnqxfrau`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012761_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ajmnqxfrau/ajmnqxfrau/ajmnqxfrau.png`
- Checksum / 校验和:
  `6925243acac92e1ac72f5e8bfb0920ebc6881485aec9fbada01e981d04dcea0b`
...
- Marked-pixel bounds: (63,28)–(186,218); span 124 × 191 px; the marked
...
- 痕迹范围：(63,28)–(186,218)；跨度124 × 191 px；痕迹矩形高于宽。
