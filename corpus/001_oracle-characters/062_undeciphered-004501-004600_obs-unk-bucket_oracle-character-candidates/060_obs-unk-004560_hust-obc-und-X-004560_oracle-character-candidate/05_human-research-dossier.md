# obs-unk-004560 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004560`
- primary external id: `hust-obc-und-X-004560`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/060_obs-unk-004560_h
  ust-obc-und-X-004560_oracle-character-candidate/03_visual-assets/001_asset
  -006153_hust-obc-und-X-004560_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/116/X_？_8296_1.png`
- asset id: `asset-006153`
...
- source class: `HUST-OBC/undeciphered/X/116/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/116/X_？_8296_1.png`
- asset id: `asset-006153`
...
- English observation: `Upper band, U-like outline, and detached marks noted.`
- 中文观察: `已记录上部横带、U 形轮廓和分离痕迹。`
...
- Which source records identify obs-unk-004560 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004560？
