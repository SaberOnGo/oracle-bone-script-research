# Material Visual Observation / obs-comp-cand-002061 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002061`
- External reference / 外部参照: `obimd-sub-zr3h63w2fy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019448_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zr3h63w2fy/zr3h63w2fy/zr3h63w2fy.png`
- Checksum / 校验和:
  `287282cff7d5f17df3a10b08d5539e5fc12971844e5a56a86b98f73db9ac281f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.02%.
- Marked-pixel bounds: (53,21)–(201,230); span 149 × 210 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.02%。
- 痕迹范围：(53,21)–(201,230)；跨度149 × 210 px；痕迹矩形高于宽。
