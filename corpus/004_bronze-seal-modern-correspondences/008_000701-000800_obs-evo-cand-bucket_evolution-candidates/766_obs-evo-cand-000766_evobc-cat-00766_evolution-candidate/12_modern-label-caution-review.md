# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000766
...
- EVOBC candidate category: `evobc-evo-cat-00766`.
- Source label for search only: `伍`.
- Source codepoints for search only: `U+4F0D`.
