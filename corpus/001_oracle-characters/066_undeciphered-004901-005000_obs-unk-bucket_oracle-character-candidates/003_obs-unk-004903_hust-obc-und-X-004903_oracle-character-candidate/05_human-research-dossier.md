# obs-unk-004903 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/003_obs-unk-004903_h
  ust-obc-und-X-004903_oracle-character-candidate/03_visual-assets/001_asset
  -006496_hust-obc-und-X-004903_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/459/X_？_7439_1.png`
- asset id: `asset-006496`
...
- source class: `HUST-OBC/undeciphered/X/459/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/459/X_？_7439_1.png`
- asset id: `asset-006496`
...
- English observation: `narrow curved stroke and right upright`
- 中文观察: `狭长弧形笔画和右侧直立笔画`
...
- Which source records identify obs-unk-004903 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004903？
