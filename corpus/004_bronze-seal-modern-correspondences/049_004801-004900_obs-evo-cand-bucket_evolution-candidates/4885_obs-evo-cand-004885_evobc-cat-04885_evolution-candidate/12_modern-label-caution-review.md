# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004885
...
- EVOBC candidate category: `evobc-evo-cat-04885`.
- Source label for search only: `漼`.
- Source codepoints for search only: `U+6F3C`.
