# Material Visual Observation / obs-comp-cand-000317 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000317`
- External reference / 外部参照: `obimd-sub-9h0muiwjl7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012244_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ajjda965yb/9h0muiwjl7/9h0muiwjl7.png`
- Checksum / 校验和:
  `63b01d2b7c5126846170679091216e6c70a9ec4d9b8482754742926275e26c92`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.86%.
- Marked-pixel bounds: (56,42)–(193,208); span 138 × 167 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.86%。
- 痕迹范围：(56,42)–(193,208)；跨度138 × 167 px；痕迹矩形高于宽。
