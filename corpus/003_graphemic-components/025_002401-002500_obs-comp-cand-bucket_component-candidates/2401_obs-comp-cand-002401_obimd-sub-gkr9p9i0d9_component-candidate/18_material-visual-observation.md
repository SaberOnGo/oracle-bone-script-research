# Material Visual Observation / obs-comp-cand-002401 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002401`
- External reference / 外部参照: `obimd-sub-gkr9p9i0d9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020472_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gkr9p9i0d9/gkr9p9i0d9/gkr9p9i0d9.png`
- Checksum / 校验和:
  `e48c20b66e305b8c6381ebec760387da5a9b89ffbc44d2046a62a70d9a332b01`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.80%.
- Marked-pixel bounds: (73,12)–(194,240); span 122 × 229 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.80%。
- 痕迹范围：(73,12)–(194,240)；跨度122 × 229 px；痕迹矩形高于宽。
