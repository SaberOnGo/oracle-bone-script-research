...
- External category reference: `evobc-cat-13578`
- Source category ID: `13578`
- Source label for human review: `𭸎`
...
- `obs-evo-cand-013578-route-category-staging`
...
- `obs-evo-cand-013578-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013578-route-evolution-graph`
