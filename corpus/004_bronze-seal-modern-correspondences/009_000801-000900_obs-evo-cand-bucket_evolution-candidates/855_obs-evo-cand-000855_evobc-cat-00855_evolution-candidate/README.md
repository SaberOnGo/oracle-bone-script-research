# obs-evo-cand-000855 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-00855`
- Source label for human review: `依`
- Source codepoints: `U+4F9D`
- Image reference count: `35`
- Era token counts: `BI:1;CS:1;OBC:13;SS:2;WSC:18`
- Source token counts: `Book:13;Web:22`
