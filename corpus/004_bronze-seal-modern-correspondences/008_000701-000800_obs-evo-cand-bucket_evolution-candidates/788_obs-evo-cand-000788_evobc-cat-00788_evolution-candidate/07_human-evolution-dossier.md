...
- External category reference: `evobc-cat-00788`
- Source category ID: `00788`
- Source label for human review: `似`
...
- `obs-evo-cand-000788-route-category-staging`
...
- `obs-evo-cand-000788-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000788-route-evolution-graph`
