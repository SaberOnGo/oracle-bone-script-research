# Material Visual Observation / obs-comp-cand-001887 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001887`
- External reference / 外部参照: `obimd-sub-jfkbry7mqz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018266_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wfyy86f1n0/jfkbry7mqz/jfkbry7mqz.png`
- Checksum / 校验和:
  `8f2a0c3a694be0e220370f53f2f4f1f5af0d7f3d5ff24694e07195330ebd7bbb`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.44%.
- Marked-pixel bounds: (69,18)–(180,227); span 112 × 210 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.44%。
- 痕迹范围：(69,18)–(180,227)；跨度112 × 210 px；痕迹矩形高于宽。
