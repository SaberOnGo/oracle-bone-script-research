# Material Visual Observation / obs-comp-cand-001110 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001110`
- External reference / 外部参照: `obimd-sub-bbvj8xmean`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015051_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ho95nnufi7/bbvj8xmean/bbvj8xmean.png`
- Checksum / 校验和:
  `416fbaaf2c897ce03ebdd03adcc0909a522ff81b221481365296f0e39539a82c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.08%.
- Marked-pixel bounds: (87,33)–(162,216); span 76 × 184 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.08%。
- 痕迹范围：(87,33)–(162,216)；跨度76 × 184 px；痕迹矩形高于宽。
