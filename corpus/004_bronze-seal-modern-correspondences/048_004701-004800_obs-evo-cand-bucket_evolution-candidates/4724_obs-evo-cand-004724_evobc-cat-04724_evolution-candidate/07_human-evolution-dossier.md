...
- Project ID: `obs-evo-cand-004724`
- EVOBC category candidate ID: `evobc-evo-cat-04724`
- External category reference: `evobc-cat-04724`
- Source category ID: `04724`
- Source label for human review: `淢`
- Source codepoints: `U+6DE2`
...
- `obs-evo-cand-004724-route-category-staging`
...
- `obs-evo-cand-004724-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004724-route-evolution-graph`
