# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006170
...
- EVOBC candidate category: `evobc-evo-cat-06170`.
- Source label for search only: `窞`.
- Source codepoints for search only: `U+7A9E`.
