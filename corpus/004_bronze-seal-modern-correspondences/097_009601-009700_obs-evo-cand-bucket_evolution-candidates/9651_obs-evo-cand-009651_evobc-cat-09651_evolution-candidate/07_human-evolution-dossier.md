...
Project ID: `obs-evo-cand-009651`
...
- Project ID: `obs-evo-cand-009651`
- EVOBC category candidate ID: `evobc-evo-cat-09651`
- External category reference: `evobc-cat-09651`
- Source category ID: `09651`
- Source label for human review: `闊`
- Source codepoints: `U+95CA`
...
- `obs-evo-cand-009651-route-category-staging`
...
- `obs-evo-cand-009651-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009651-route-evolution-graph`
