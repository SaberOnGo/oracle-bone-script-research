...
Project ID: `obs-evo-cand-002698`
...
- Project ID: `obs-evo-cand-002698`
- EVOBC category candidate ID: `evobc-evo-cat-02698`
- External category reference: `evobc-cat-02698`
- Source category ID: `02698`
- Source label for human review: `幷`
- Source codepoints: `U+5E77`
...
- `obs-evo-cand-002698-route-category-staging`
...
- `obs-evo-cand-002698-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002698-route-evolution-graph`
