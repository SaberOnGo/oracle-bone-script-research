# Material Visual Observation / obs-comp-cand-001522 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001522`
- External reference / 外部参照: `obimd-sub-nv9w78focj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016485_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/nv9w78focj/nv9w78focj/nv9w78focj.png`
- Checksum / 校验和:
  `d8a1fd5e0620004cf9e606c3ae9e590d6183f54fb5f09bcbfee1e4071b53a16a`
...
- Marked-pixel bounds: (79,21)–(170,224); span 92 × 204 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.64%。
- 痕迹范围：(79,21)–(170,224)；跨度92 × 204 px；痕迹矩形高于宽。
