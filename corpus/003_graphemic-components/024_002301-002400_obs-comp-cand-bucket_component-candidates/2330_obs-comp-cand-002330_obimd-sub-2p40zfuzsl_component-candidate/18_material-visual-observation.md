# Material Visual Observation / obs-comp-cand-002330 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002330`
- External reference / 外部参照: `obimd-sub-2p40zfuzsl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020349_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2p40zfuzsl/2p40zfuzsl/2p40zfuzsl.png`
- Checksum / 校验和:
  `e9a74f6e7773cdd7dce7dda1cc07cfc8416d4c31ba9596d518a384d12e22a4f1`
...
- Marked-pixel bounds: (88,17)–(163,231); span 76 × 215 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.64%。
- 痕迹范围：(88,17)–(163,231)；跨度76 × 215 px；痕迹矩形高于宽。
