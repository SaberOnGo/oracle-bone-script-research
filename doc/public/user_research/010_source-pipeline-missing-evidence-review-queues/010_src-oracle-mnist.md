...
- source_download_log_ids: `dl-oracle-mnist-readme`
- source_field_map_ids: `none`
- source_package_file_ids: `pkg-file-000026`
...
- download log ids / 下载记录 ID: `dl-oracle-mnist-readme`
- metadata profile ids / metadata profile ID: `metadata-`
  `profile-000058;metadata-profile-000059`
- large source package ids / 大型来源包 ID: `none`
- source field map ids / 字段映射 ID: `none`
- package file ids / package file ID: `pkg-file-000026`
