# Material Visual Observation / obs-comp-cand-002047 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002047`
- External reference / 外部参照: `obimd-sub-4nm99xtfab`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019416_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4nm99xtfab/4nm99xtfab/0wnnrujl76.png`
- Checksum / 校验和:
  `e1f9b9e1271de7815a1b57a2e005f4b86aabee64cd63fa2bc0abad1560e3a348`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.76%.
- Marked-pixel bounds: (69,32)–(180,214); span 112 × 183 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.76%。
- 痕迹范围：(69,32)–(180,214)；跨度112 × 183 px；痕迹矩形高于宽。
