...
- External category reference: `evobc-cat-04915`
- Source category ID: `04915`
- Source label for human review: `潯`
- Source codepoints: `U+6F6F`
...
- `obs-evo-cand-004915-route-category-staging`
...
- `obs-evo-cand-004915-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004915-route-evolution-graph`
