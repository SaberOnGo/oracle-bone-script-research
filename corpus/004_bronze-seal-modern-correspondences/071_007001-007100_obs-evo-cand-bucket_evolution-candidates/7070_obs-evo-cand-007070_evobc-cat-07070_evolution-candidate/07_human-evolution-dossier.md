...
- Project ID: `obs-evo-cand-007070`
- EVOBC category candidate ID: `evobc-evo-cat-07070`
- External category reference: `evobc-cat-07070`
- Source category ID: `07070`
- Source label for human review: `脢`
- Source codepoints: `U+8122`
...
- `obs-evo-cand-007070-route-category-staging`
...
- `obs-evo-cand-007070-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007070-route-evolution-graph`
