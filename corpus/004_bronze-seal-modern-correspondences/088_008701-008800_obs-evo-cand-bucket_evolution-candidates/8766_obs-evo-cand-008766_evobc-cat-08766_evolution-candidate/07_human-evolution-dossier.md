...
- External category reference: `evobc-cat-08766`
- Source category ID: `08766`
- Source label for human review: `蹩`
...
- `obs-evo-cand-008766-route-category-staging`
...
- `obs-evo-cand-008766-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008766-route-evolution-graph`
