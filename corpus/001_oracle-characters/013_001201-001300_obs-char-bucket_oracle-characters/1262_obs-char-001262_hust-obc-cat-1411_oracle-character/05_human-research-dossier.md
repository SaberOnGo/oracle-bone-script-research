# obs-char-001262 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1262_obs-char-001262_hust-obc-cat-1411_ora
  cle-character/03_visual-assets/001_asset-001267_hust-obc-cat-1411_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1411/X_1411_1091_1.png`
- asset id: `asset-001267`
...
- source category: `1411`
- validation class: `1261`
- source image route: `HUST-OBC/deciphered/1411/X_1411_1091_1.png`
- asset id: `asset-001267`
...
- English observation: `A large composite form has a tall capped stem, a
  lower rounded enclosure, and a separate long curved stroke.`
...
- dataset label text: `㥹`
- dataset label codepoints: `U+3979`
...
- Which source records identify obs-char-001262 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001262？
