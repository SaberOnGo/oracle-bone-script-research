...
- Project ID: `obs-evo-cand-009827`
- EVOBC category candidate ID: `evobc-evo-cat-09827`
- External category reference: `evobc-cat-09827`
- Source category ID: `09827`
- Source label for human review: `雞`
- Source codepoints: `U+96DE`
- Image reference count in source metadata: `35`
...
- `obs-evo-cand-009827-route-category-staging`
...
- `obs-evo-cand-009827-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009827-route-evolution-graph`
