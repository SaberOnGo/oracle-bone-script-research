# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-009675
...
- EVOBC candidate category: `evobc-evo-cat-09675`.
- Source label for search only: `闯`.
- Source codepoints for search only: `U+95EF`.
