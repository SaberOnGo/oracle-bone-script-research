...
- Project ID: `obs-evo-cand-000858`
- EVOBC category candidate ID: `evobc-evo-cat-00858`
- External category reference: `evobc-cat-00858`
- Source category ID: `00858`
- Source label for human review: `侦`
- Source codepoints: `U+4FA6`
...
- `obs-evo-cand-000858-route-category-staging`
...
- `obs-evo-cand-000858-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000858-route-evolution-graph`
