# obs-unk-004177 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004177`
- primary external id: `hust-obc-und-L-004177`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/077_obs-unk-004177_h
  ust-obc-und-L-004177_oracle-character-candidate/03_visual-assets/001_asset
  -005770_hust-obc-und-L-004177_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4177/L_？_9048.jpg`
- asset id: `asset-005770`
...
- source class: `HUST-OBC/undeciphered/L/4177/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4177/L_？_9048.jpg`
- asset id: `asset-005770`
...
- English observation: Upper angular groups stand beside a long right stroke
  and a lower curve.
- 中文观察: 上部折角组旁有右侧长笔画和下部弧曲痕迹。
...
- Which source records identify obs-unk-004177 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004177？
