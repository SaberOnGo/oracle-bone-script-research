...
- External category reference: `evobc-cat-06040`
- Source category ID: `06040`
- Source label for human review: `禷`
...
- `obs-evo-cand-006040-route-category-staging`
...
- `obs-evo-cand-006040-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006040-route-evolution-graph`
