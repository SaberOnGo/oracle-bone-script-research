# Material Visual Observation / obs-comp-cand-001064 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001064`
- External reference / 外部参照: `obimd-sub-y7e97sd82a`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014614_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/y7e97sd82a/y7e97sd82a/y7e97sd82a.png`
- Checksum / 校验和:
  `b47637f96fd53eecb9858561ddde727115b55be609730ddf96bae34417a09d8d`
...
- Marked-pixel bounds: (69,17)–(161,231); span 93 × 215 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.60%。
- 痕迹范围：(69,17)–(161,231)；跨度93 × 215 px；痕迹矩形高于宽。
