# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004720
...
- EVOBC candidate category: `evobc-evo-cat-04720`.
- Source label for search only: `淚`.
- Source codepoints for search only: `U+6DDA`.
