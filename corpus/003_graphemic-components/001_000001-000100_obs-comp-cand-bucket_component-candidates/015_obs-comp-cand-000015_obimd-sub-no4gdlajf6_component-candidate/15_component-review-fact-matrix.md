# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000015
...
| Glyph or codepoint route / 字形或码位路线 | 47 OBIMD route rows; examples U+5915;U+F0139; U+F013A; 另有 45 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 47 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
