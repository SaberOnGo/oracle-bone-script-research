...
- External category reference: `evobc-cat-02640`
- Source category ID: `02640`
- Source label for human review: `师`
- Source codepoints: `U+5E08`
...
- `obs-evo-cand-002640-route-category-staging`
...
- `obs-evo-cand-002640-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002640-route-evolution-graph`
