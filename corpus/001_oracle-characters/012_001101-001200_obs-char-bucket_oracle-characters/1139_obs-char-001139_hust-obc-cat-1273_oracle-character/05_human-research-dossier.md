# obs-char-001139 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1139_obs-char-001139_hust-obc-cat-1273_ora
  cle-character/03_visual-assets/001_asset-001144_hust-obc-cat-1273_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1273/G_1273_甲骨文.png`
- asset id: `asset-001144`
...
- source category: `1273`
- validation class: `1138`
- source image route: `HUST-OBC/deciphered/1273/G_1273_甲骨文.png`
- asset id: `asset-001144`
...
- dataset label text: `㣯`
- dataset label codepoints: `U+38EF`
...
- Which source records identify obs-char-001139 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001139？
