# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006253
...
- EVOBC candidate category: `evobc-evo-cat-06253`.
- Source label for search only: `笼`.
- Source codepoints for search only: `U+7B3C`.
