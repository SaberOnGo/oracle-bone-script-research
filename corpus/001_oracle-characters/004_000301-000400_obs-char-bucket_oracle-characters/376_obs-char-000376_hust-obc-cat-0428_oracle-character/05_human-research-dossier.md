# obs-char-000376 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/376_obs-char-000376_hust-obc-cat-0428_orac
  le-character/03_visual-assets/001_asset-000381_hust-obc-cat-0428_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0428/G_0428_乙5317合1051賓組.png`
- asset id: `asset-000381`
...
- source category: `0428`
- validation class: `375`
- source image route: `HUST-OBC/deciphered/0428/G_0428_乙5317合1051賓組.png`
- asset id: `asset-000381`
...
- English observation: `A thin central stem branches into a pointed upper
  fork and two long side strokes.`
...
- dataset label text: `㖢`
- dataset label codepoints: `U+35A2`
...
- Which source records identify obs-char-000376 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000376？
