# Material Visual Observation / obs-comp-cand-001588 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001588`
- External reference / 外部参照: `obimd-sub-wg4dzu9gsc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017213_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8elvo4ws82/wg4dzu9gsc/wg4dzu9gsc.png`
- Checksum / 校验和:
  `db9e622d7dee09218f2d948c1c24b297a8f1579cdc390faf71ad1042d1d9155a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.07%.
- Marked-pixel bounds: (81,29)–(179,217); span 99 × 189 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.07%。
- 痕迹范围：(81,29)–(179,217)；跨度99 × 189 px；痕迹矩形高于宽。
