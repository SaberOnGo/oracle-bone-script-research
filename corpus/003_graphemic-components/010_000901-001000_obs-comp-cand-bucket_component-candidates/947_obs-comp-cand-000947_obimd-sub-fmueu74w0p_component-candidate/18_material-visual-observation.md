# Material Visual Observation / obs-comp-cand-000947 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000947`
- External reference / 外部参照: `obimd-sub-fmueu74w0p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014030_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fmueu74w0p/fmueu74w0p/fmueu74w0p.png`
- Checksum / 校验和:
  `85b012352d6578448ce915adffafb3fb72f3be2c71138282f8793dc4329ae79a`
...
- Marked-pixel bounds: (63,37)–(184,212); span 122 × 176 px; the marked
...
- 痕迹范围：(63,37)–(184,212)；跨度122 × 176 px；痕迹矩形高于宽。
