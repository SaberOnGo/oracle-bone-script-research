...
- External category reference: `evobc-cat-04209`
- Source category ID: `04209`
- Source label for human review: `槏`
...
- `obs-evo-cand-004209-route-category-staging`
...
- `obs-evo-cand-004209-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004209-route-evolution-graph`
