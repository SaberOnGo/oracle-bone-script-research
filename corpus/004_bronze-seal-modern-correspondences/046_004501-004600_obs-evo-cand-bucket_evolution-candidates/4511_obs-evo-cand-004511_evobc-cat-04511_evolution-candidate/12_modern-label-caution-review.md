# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004511
...
- EVOBC candidate category: `evobc-evo-cat-04511`.
- Source label for search only: `汪`.
- Source codepoints for search only: `U+6C6A`.
