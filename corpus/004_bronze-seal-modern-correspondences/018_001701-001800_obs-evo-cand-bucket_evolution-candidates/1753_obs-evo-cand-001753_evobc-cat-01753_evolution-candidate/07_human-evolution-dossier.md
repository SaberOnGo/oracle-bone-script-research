...
- External category reference: `evobc-cat-01753`
- Source category ID: `01753`
- Source label for human review: `囚`
- Source codepoints: `U+56DA`
...
- `obs-evo-cand-001753-route-category-staging`
...
- `obs-evo-cand-001753-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001753-route-evolution-graph`
