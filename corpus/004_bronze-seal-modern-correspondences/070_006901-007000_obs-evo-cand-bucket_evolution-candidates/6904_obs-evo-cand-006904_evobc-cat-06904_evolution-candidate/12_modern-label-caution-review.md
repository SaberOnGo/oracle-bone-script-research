# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006904
...
- EVOBC candidate category: `evobc-evo-cat-06904`.
- Source label for search only: `翼`.
- Source codepoints for search only: `U+7FFC`.
