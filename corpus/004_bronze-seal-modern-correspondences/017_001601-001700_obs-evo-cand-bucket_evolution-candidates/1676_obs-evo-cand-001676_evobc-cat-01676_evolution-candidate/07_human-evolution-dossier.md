...
Project ID: `obs-evo-cand-001676`
...
- Project ID: `obs-evo-cand-001676`
- EVOBC category candidate ID: `evobc-evo-cat-01676`
- External category reference: `evobc-cat-01676`
- Source category ID: `01676`
- Source label for human review: `嗝`
- Source codepoints: `U+55DD`
...
- `obs-evo-cand-001676-route-category-staging`
...
- `obs-evo-cand-001676-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001676-route-evolution-graph`
