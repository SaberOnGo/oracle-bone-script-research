# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002827
...
- EVOBC candidate category: `evobc-evo-cat-02827`.
- Source label for search only: `彎`.
- Source codepoints for search only: `U+5F4E`.
