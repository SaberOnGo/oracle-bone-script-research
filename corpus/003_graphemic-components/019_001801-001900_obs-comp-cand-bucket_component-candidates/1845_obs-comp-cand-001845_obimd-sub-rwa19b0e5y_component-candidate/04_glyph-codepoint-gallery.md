# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001845
...
| --- | --- | --- | --- |
| `obimd-glyph-link-027970` | 򱖚󺘢 | `U+B159A;U+FA622` | `reviewed_metadata_only` |
| `obimd-glyph-link-027971` | 󺢶 | `U+FA8B6` | `reviewed_metadata_only` |
| `obimd-glyph-link-027972` | 󺢷 | `U+FA8B7` | `reviewed_metadata_only` |
