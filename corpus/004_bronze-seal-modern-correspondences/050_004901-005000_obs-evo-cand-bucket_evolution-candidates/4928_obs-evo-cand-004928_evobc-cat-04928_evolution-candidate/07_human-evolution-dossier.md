...
- External category reference: `evobc-cat-04928`
- Source category ID: `04928`
- Source label for human review: `澌`
...
- `obs-evo-cand-004928-route-category-staging`
...
- `obs-evo-cand-004928-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004928-route-evolution-graph`
