...
- External category reference: `evobc-cat-07639`
- Source category ID: `07639`
- Source label for human review: `藏`
- Source codepoints: `U+85CF`
...
- `obs-evo-cand-007639-route-category-staging`
...
- `obs-evo-cand-007639-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007639-route-evolution-graph`
