...
- External category reference: `evobc-cat-11961`
- Source category ID: `11961`
- Source label for human review: `𦃘`
...
- `obs-evo-cand-011961-route-category-staging`
...
- `obs-evo-cand-011961-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011961-route-evolution-graph`
