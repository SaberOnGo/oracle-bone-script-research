...
- Review draft ID / 复核草稿 ID: `source-pipeline-missing-evidence-review-draft-004`
...
- Pipeline gap status / 流水线缺口状态: `needs_field_map_review`
...
- metadata_profile_ids: `metadata-profile-000049;metadata-profile-000050`
- large_source_package_ids: `none`
- source_download_log_ids: `dl-ihp-museum-oracle-bones`
- source_field_map_ids: `field-map-000055;field-map-000056;field-map-000057`
- source_package_file_ids: `pkg-file-000018`
...
- download log ids / 下载记录 ID: `dl-ihp-museum-oracle-bones`
- metadata profile ids / metadata profile ID: `metadata-`
  `profile-000049;metadata-profile-000050`
- large source package ids / 大型来源包 ID: `none`
- source field map ids / 字段映射 ID: `field-map-000055;field-map-000056;field-`
  `map-000057`
- package file ids / package file ID: `pkg-file-000018`
