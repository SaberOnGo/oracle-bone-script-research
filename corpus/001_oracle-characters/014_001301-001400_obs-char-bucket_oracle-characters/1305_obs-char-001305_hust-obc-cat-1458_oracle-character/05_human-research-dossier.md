# obs-char-001305 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001305`
- primary external id: `hust-obc-cat-1458`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1305_obs-char-001305_hust-obc-cat-1458_ora
  cle-character/03_visual-assets/001_asset-001310_hust-obc-cat-1458_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1458/G_1458_京津1568合8177賓組.png`
- asset id: `asset-001310`
...
- source category: `1458`
- validation class: `1304`
- source image route: `HUST-OBC/deciphered/1458/G_1458_京津1568合8177賓組.png`
- asset id: `asset-001310`
...
- English observation: `A tall symmetrical cluster has a central crossing,
  paired outer curves, and several lower pointed loops.`
- 中文观察: `高直近对称笔画群有中央交叉笔、成对外侧弧线和数个下部尖状环形。`
...
- dataset label text: `㦨`
- dataset label codepoints: `U+39A8`
...
- filename catalog route clues: `Heji-like filename clue: 合8177
  (G_1458_京津1568合8177賓組.png)`
...
- Which source records identify obs-char-001305 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001305？
