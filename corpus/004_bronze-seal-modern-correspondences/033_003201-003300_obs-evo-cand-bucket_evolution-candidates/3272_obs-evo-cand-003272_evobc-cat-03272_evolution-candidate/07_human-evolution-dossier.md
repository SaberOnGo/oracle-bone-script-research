...
- External category reference: `evobc-cat-03272`
- Source category ID: `03272`
- Source label for human review: `抈`
- Source codepoints: `U+6288`
...
- `obs-evo-cand-003272-route-category-staging`
...
- `obs-evo-cand-003272-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003272-route-evolution-graph`
