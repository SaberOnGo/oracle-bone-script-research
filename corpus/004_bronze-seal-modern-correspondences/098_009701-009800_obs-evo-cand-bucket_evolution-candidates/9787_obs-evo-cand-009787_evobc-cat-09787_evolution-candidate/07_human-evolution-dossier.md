...
- Project ID: `obs-evo-cand-009787`
- EVOBC category candidate ID: `evobc-evo-cat-09787`
- External category reference: `evobc-cat-09787`
- Source category ID: `09787`
- Source label for human review: `險`
- Source codepoints: `U+96AA`
...
- `obs-evo-cand-009787-route-category-staging`
...
- `obs-evo-cand-009787-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009787-route-evolution-graph`
