# obs-char-001438 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001438`
- primary external id: `hust-obc-cat-1611`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1438_obs-char-001438_hust-obc-cat-1611_ora
  cle-character/03_visual-assets/001_asset-001443_hust-obc-cat-1611_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1611/X_1611_4494_1.png`
- asset id: `asset-001443`
...
- source category: `1611`
- validation class: `1437`
- source image route: `HUST-OBC/deciphered/1611/X_1611_4494_1.png`
- asset id: `asset-001443`
...
- English observation: `A large left enclosure is paired with a tall right
  stem marked by branches.`
...
- dataset label text: `㩁`
- dataset label codepoints: `U+3A41`
...
- Which source records identify obs-char-001438 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001438？
