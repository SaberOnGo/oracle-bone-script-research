# obs-char-000003 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/003_obs-char-000003_hust-obc-cat-0003_orac
  le-character/03_visual-assets/001_asset-000008_hust-obc-cat-0003_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0003/H_0003_60009_0.png`
- asset id: `asset-000008`
...
- source category: `0003`
- validation class: `2`
- source image route: `HUST-OBC/deciphered/0003/H_0003_60009_0.png`
- asset id: `asset-000008`
...
- English observation: `The image is a tall curved form with separated short
  strokes on its left side; the marks do not form a confirmed label here.`
- 中文观察: `图像为高而弯曲的形体，左侧有分离的短笔画；本记录不把这些痕迹定为文字标签。`
...
- dataset label text: `⺆`
- dataset label codepoints: `U+2E86`
...
- filename catalog route clues: `catalog-like filename clue: H_0003
  (H_0003_60009_0.png)`
...
- Which source records identify obs-char-000003 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000003？
