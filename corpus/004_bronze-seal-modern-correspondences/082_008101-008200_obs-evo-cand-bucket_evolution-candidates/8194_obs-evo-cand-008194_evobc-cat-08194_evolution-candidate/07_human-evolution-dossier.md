...
- External category reference: `evobc-cat-08194`
- Source category ID: `08194`
- Source label for human review: `詪`
- Source codepoints: `U+8A6A`
...
- `obs-evo-cand-008194-route-category-staging`
...
- `obs-evo-cand-008194-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008194-route-evolution-graph`
