# obs-unk-002592 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002592`
- primary external id: `hust-obc-und-L-002592`
...
- local review image route: `corpus/001_oracle-characters/042_undeciphered-002
  501-002600_obs-unk-bucket_oracle-character-candidates/092_obs-unk-002592_h
  ust-obc-und-L-002592_oracle-character-candidate/03_visual-assets/001_asset
  -004185_hust-obc-und-L-002592_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2592/L_？_4011.jpg`
- asset id: `asset-004185`
...
- source class: `HUST-OBC/undeciphered/L/2592/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2592/L_？_4011.jpg`
- asset id: `asset-004185`
...
- Which source records identify obs-unk-002592 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002592？
