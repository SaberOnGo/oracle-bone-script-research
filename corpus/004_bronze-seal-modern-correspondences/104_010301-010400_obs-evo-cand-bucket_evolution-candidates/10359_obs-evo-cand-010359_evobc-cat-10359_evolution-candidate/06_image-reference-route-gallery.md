...
- `obs-evo-cand-010359-route-category-staging`
...
- `obs-evo-cand-010359-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010359-route-evolution-graph`
