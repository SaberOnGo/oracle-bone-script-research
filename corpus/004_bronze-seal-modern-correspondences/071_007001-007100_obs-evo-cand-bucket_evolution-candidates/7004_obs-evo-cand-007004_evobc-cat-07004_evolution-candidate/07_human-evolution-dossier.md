...
- External category reference: `evobc-cat-07004`
- Source category ID: `07004`
- Source label for human review: `肰`
- Source codepoints: `U+80B0`
...
- `obs-evo-cand-007004-route-category-staging`
...
- `obs-evo-cand-007004-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007004-route-evolution-graph`
