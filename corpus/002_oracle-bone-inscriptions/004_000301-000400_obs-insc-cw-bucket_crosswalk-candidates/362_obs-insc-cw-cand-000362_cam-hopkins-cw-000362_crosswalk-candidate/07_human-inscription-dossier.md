...
- Source page section: `Period II Group 14` /
  `第 II 期第 14 组`
- Source section key: `period-ii-group-14`
...
- Yingguo / 英国所藏: `y2081` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `444` in source row; primary catalog entry pending
