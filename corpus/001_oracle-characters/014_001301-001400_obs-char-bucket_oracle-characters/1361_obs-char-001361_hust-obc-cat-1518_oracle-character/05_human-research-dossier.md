# obs-char-001361 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001361`
- primary external id: `hust-obc-cat-1518`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1361_obs-char-001361_hust-obc-cat-1518_ora
  cle-character/03_visual-assets/001_asset-001366_hust-obc-cat-1518_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1518/G_1518_乙2818(甲).png`
- asset id: `asset-001366`
...
- source category: `1518`
- validation class: `1360`
- source image route: `HUST-OBC/deciphered/1518/G_1518_乙2818(甲).png`
- asset id: `asset-001366`
...
- English observation: `A small composite has an angular upper loop and two
  long lower strokes.`
...
- dataset label text: `㧤`
- dataset label codepoints: `U+39E4`
...
- Which source records identify obs-char-001361 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001361？
