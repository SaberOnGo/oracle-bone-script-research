...
Project ID: `obs-evo-cand-007160`
...
- Project ID: `obs-evo-cand-007160`
- EVOBC category candidate ID: `evobc-evo-cat-07160`
- External category reference: `evobc-cat-07160`
- Source category ID: `07160`
- Source label for human review: `臥`
- Source codepoints: `U+81E5`
...
- `obs-evo-cand-007160-route-category-staging`
...
- `obs-evo-cand-007160-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007160-route-evolution-graph`
