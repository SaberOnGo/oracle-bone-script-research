# obs-char-001580 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001580`
- primary external id: `hust-obc-cat-1772`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1580_obs-char-001580_hust-obc-cat-1772_ora
  cle-character/03_visual-assets/001_asset-001585_hust-obc-cat-1772_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1772/L_1772_1445.jpg`
- asset id: `asset-001585`
...
- source category: `1772`
- validation class: `1579`
- source image route: `HUST-OBC/deciphered/1772/L_1772_1445.jpg`
- asset id: `asset-001585`
...
- English observation: `A very faint small diamond-like contour contains a
  short inner crossing.`
- 中文观察: `极浅淡的小型菱形轮廓包含短内部交叉笔画。`
...
- dataset label text: `㫢`
- dataset label codepoints: `U+3AE2`
...
- Which source records identify obs-char-001580 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001580？
