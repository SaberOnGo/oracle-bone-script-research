...
- External category reference: `evobc-cat-10939`
- Source category ID: `10939`
- Source label for human review: `𠲮`
...
- `obs-evo-cand-010939-route-category-staging`
...
- `obs-evo-cand-010939-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010939-route-evolution-graph`
