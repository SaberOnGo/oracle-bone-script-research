...
- External category reference: `evobc-cat-01787`
- Source category ID: `01787`
- Source label for human review: `圜`
...
- `obs-evo-cand-001787-route-category-staging`
...
- `obs-evo-cand-001787-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001787-route-evolution-graph`
