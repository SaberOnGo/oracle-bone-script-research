# obs-char-000063 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000063`
- primary external id: `hust-obc-cat-0073`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/063_obs-char-000063_hust-obc-cat-0073_orac
  le-character/03_visual-assets/001_asset-000068_hust-obc-cat-0073_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0073/G_0073_乙1905合376賓組.png`
- asset id: `asset-000068`
...
- source category: `0073`
- validation class: `62`
- source image route: `HUST-OBC/deciphered/0073/G_0073_乙1905合376賓組.png`
- asset id: `asset-000068`
...
- English observation: `The tall narrow image contains a vertical lattice of
  crossed diamond-like marks with short side strokes.`
- 中文观察: `高而狭长图像含竖向交叉格状痕迹，并有短侧向笔画。`
...
- dataset label text: `㐿`
- dataset label codepoints: `U+343F`
...
- Which source records identify obs-char-000063 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000063？
