...
- External category reference: `evobc-cat-12698`
- Source category ID: `12698`
- Source label for human review: `𩶁`
...
- `obs-evo-cand-012698-route-category-staging`
...
- `obs-evo-cand-012698-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012698-route-evolution-graph`
