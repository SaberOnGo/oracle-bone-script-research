# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-005366
...
- EVOBC candidate category: `evobc-evo-cat-05366`.
- Source label for search only: `玽`.
- Source codepoints for search only: `U+73BD`.
