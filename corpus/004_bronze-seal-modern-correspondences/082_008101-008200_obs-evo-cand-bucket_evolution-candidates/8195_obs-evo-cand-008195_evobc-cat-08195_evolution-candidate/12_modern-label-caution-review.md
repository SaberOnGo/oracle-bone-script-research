# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008195
...
- EVOBC candidate category: `evobc-evo-cat-08195`.
- Source label for search only: `詬`.
- Source codepoints for search only: `U+8A6C`.
