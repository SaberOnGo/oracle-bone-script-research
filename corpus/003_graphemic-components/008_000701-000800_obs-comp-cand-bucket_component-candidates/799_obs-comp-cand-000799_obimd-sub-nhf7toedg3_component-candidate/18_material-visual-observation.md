# Material Visual Observation / obs-comp-cand-000799 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000799`
- External reference / 外部参照: `obimd-sub-nhf7toedg3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013597_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4j5hjsdkwc/nhf7toedg3/nhf7toedg3.png`
- Checksum / 校验和:
  `9662a917755843b24c389c970276a61929ccee1dca70584142936b14b78a3ea2`
...
- Marked-pixel bounds: (70,27)–(179,224); span 110 × 198 px; the marked
...
- 痕迹范围：(70,27)–(179,224)；跨度110 × 198 px；痕迹矩形高于宽。
