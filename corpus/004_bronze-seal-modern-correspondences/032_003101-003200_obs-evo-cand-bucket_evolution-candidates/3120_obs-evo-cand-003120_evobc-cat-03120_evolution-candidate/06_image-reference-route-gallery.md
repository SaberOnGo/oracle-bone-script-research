...
- `obs-evo-cand-003120-route-category-staging`
...
- `obs-evo-cand-003120-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003120-route-evolution-graph`
