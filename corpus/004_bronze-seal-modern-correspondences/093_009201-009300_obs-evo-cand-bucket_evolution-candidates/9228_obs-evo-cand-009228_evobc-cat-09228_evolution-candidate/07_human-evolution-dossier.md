...
Project ID: `obs-evo-cand-009228`
...
- Project ID: `obs-evo-cand-009228`
- EVOBC category candidate ID: `evobc-evo-cat-09228`
- External category reference: `evobc-cat-09228`
- Source category ID: `09228`
- Source label for human review: `酂`
- Source codepoints: `U+9142`
...
- `obs-evo-cand-009228-route-category-staging`
...
- `obs-evo-cand-009228-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009228-route-evolution-graph`
