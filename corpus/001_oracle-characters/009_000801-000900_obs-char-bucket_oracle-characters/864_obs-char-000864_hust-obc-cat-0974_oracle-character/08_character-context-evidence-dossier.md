...
- Project ID / 项目 ID: `obs-char-000864`
- Primary external ID / 首选外部 ID: `hust-obc-cat-0974`
...
- Source image / 来源图: `G_0974_合5362(甲).png`
- Image / 图像: `001_asset-000869_hust-obc-cat-0974_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合5362
  (G_0974_合5362(甲).png)`
...
- Source label text / 来源标签文字: `㟄`
- Source label codepoint / 来源标签 codepoint: `U+37C4`
