# Material Visual Observation / obs-comp-cand-002101 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002101`
- External reference / 外部参照: `obimd-sub-7cerpwngv3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019547_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7cerpwngv3/7cerpwngv3/55lla2oo0z.png`
- Checksum / 校验和:
  `e17cde147a23029cfcd535936975c9652628fee69ffd1aacf5fbb2cebc5dbd3e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.37%.
- Marked-pixel bounds: (92,31)–(157,219); span 66 × 189 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.37%。
- 痕迹范围：(92,31)–(157,219)；跨度66 × 189 px；痕迹矩形高于宽。
