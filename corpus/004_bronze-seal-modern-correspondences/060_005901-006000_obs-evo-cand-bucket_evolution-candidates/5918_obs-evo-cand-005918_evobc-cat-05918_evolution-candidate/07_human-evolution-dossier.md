...
Project ID: `obs-evo-cand-005918`
...
- Project ID: `obs-evo-cand-005918`
- EVOBC category candidate ID: `evobc-evo-cat-05918`
- External category reference: `evobc-cat-05918`
- Source category ID: `05918`
- Source label for human review: `碍`
- Source codepoints: `U+788D`
...
- `obs-evo-cand-005918-route-category-staging`
...
- `obs-evo-cand-005918-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005918-route-evolution-graph`
