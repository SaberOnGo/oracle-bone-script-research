# obs-evo-cand-008976 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-008976`
- EVOBC category candidate ID: `evobc-evo-cat-08976`
- External category ref: `evobc-cat-08976`
- Source label: `追`
- Source codepoints: `U+8FFD`
- Image reference count: `176`
- Era token counts: `BI:64;CS:1;OBC:88;SAC:9;SS:2;WSC:12`
- Source token counts: `Book:75;Web:101`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 88 image references
- era 1 / BI: 64 image references
...
- source 1 / Web:105952;說文Web:58: 59 image references
- source 2 / Book:17600: 14 image references
- source 3 / Book:21681: 30 image references
- source 4 / Book:9131: 9 image references
- source 5 / Book:32794: 8 image references
