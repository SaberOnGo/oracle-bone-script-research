...
- External category reference: `evobc-cat-05046`
- Source category ID: `05046`
- Source label for human review: `炟`
...
- `obs-evo-cand-005046-route-category-staging`
...
- `obs-evo-cand-005046-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005046-route-evolution-graph`
