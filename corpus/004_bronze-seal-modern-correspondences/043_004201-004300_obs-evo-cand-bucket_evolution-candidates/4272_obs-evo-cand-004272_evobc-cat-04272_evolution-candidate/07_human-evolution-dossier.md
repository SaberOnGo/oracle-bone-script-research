...
- External category reference: `evobc-cat-04272`
- Source category ID: `04272`
- Source label for human review: `橞`
- Source codepoints: `U+6A5E`
...
- `obs-evo-cand-004272-route-category-staging`
...
- `obs-evo-cand-004272-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004272-route-evolution-graph`
