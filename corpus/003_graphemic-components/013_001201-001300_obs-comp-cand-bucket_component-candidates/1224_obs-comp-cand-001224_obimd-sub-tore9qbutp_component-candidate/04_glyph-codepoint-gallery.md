# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001224
...
| --- | --- | --- | --- |
| `obimd-glyph-link-018386` | 򯺻󷃍 | `U+AFEBB;U+F70CD` | `reviewed_metadata_only` |
| `obimd-glyph-link-018387` | 󷃎 | `U+F70CE` | `reviewed_metadata_only` |
