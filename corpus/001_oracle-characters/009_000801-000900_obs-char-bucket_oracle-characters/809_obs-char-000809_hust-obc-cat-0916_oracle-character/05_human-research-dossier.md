# obs-char-000809 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/809_obs-char-000809_hust-obc-cat-0916_orac
  le-character/03_visual-assets/001_asset-000814_hust-obc-cat-0916_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0916/G_0916_京都2070合29240無名組.png
  `
- asset id: `asset-000814`
...
- source category: `0916`
- validation class: `808`
- source image route: `HUST-OBC/deciphered/0916/G_0916_京都2070合29240無名組.png`
- asset id: `asset-000814`
...
- English observation: `A narrow vertical form has rounded open marks along
  its center and short branching strokes near the upper and lower ends.`
- 中文观察: `狭长直立形体中部沿竖向有圆弧开口痕迹，上下两端附近均可见短分枝笔画。`
...
- dataset label text: `㞊`
- dataset label codepoints: `U+378A`
...
- filename catalog route clues: `Heji-like filename clue: 合29240
...
- Which source records identify obs-char-000809 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000809？
