...
Project ID: `obs-evo-cand-001372`
...
- Project ID: `obs-evo-cand-001372`
- EVOBC category candidate ID: `evobc-evo-cat-01372`
- External category reference: `evobc-cat-01372`
- Source category ID: `01372`
- Source label for human review: `协`
- Source codepoints: `U+534F`
...
- `obs-evo-cand-001372-route-category-staging`
...
- `obs-evo-cand-001372-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001372-route-evolution-graph`
