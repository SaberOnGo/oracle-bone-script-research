...
- External category reference: `evobc-cat-08034`
- Source category ID: `08034`
- Source label: `襚`
...
- `obs-evo-cand-008034-route-category-staging`
...
- `obs-evo-cand-008034-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008034-route-evolution-graph`
