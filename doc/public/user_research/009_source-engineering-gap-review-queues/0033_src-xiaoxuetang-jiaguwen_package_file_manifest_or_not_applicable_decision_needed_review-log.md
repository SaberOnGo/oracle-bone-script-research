...
- Review log draft ID / 复核日志草稿 ID: `source-engineering-gap-review-log-draft-0033`
- Source engineering gap ID / 来源工程缺口 ID: `source-engineering-gap-0033`
...
- Gap type / 缺口类型: `package_file_manifest_or_not_applicable_decision_needed`
- Priority rank / 优先级: `6`
...
`current_stage=cleaned;download_status_counts=download_error:2;downloaded_access_restricted_page:2;downloaded_count=2;download_log_count=4;checksum_present_count=2;field_map_count=6;package_manifest_count=0;metadata_profile_count=0;graph_edge_count=0;downloaded_file_bytes=73834;gap_type=package_file_manifest_or_not_applicable_decision_needed`
...
- `open_download_manifest_download_log_and_package_manifest`
  - English: Open download manifest, download log, and package manifest.
  - 简体中文：打开下载 manifest、下载日志和 package manifest。
- `record_package_file_manifest_rows_or_explicit_not_applicable_decision`
  - English: Record package-file manifest rows or an explicit not-applicable decision.
  - 简体中文：记录 package-file manifest 行，或明确记录不适用判定。
- `keep_raw_or_temporary_files_outside_regular_git`
  - English: Keep raw or temporary files outside regular Git.
  - 简体中文：把原始或临时文件留在普通 Git 之外。
...
- download_status_counts: `download_error:2`
- downloaded_count: `2`
- download_log_count: `4`
- checksum_present_count: `2`
- field_map_count: `6`
- package_manifest_count: `0`
- metadata_profile_count: `0`
- graph_edge_count: `0`
- downloaded_file_bytes: `73834`
