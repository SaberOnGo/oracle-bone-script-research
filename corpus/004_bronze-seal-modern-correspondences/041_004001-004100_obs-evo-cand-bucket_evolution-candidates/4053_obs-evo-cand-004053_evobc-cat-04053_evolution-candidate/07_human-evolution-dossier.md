...
- External category reference: `evobc-cat-04053`
- Source category ID: `04053`
...
- `obs-evo-cand-004053-route-category-staging`
...
- `obs-evo-cand-004053-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004053-route-evolution-graph`
