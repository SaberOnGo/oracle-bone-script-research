...
- External category reference: `evobc-cat-11412`
- Source category ID: `11412`
- Source label for human review: `𣉰`
...
- `obs-evo-cand-011412-route-category-staging`
...
- `obs-evo-cand-011412-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011412-route-evolution-graph`
