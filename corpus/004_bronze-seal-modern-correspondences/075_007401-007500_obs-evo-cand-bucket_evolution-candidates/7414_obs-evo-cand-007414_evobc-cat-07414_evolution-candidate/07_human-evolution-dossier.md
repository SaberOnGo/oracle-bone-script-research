...
- External category reference: `evobc-cat-07414`
- Source category ID: `07414`
- Source label for human review: `菞`
- Source codepoints: `U+83DE`
...
- `obs-evo-cand-007414-route-category-staging`
...
- `obs-evo-cand-007414-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007414-route-evolution-graph`
