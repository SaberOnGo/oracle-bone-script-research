# obs-unk-006446 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/081_undeciphered-006
  401-006500_obs-unk-bucket_oracle-character-candidates/046_obs-unk-006446_h
  ust-obc-und-X-006446_oracle-character-candidate/03_visual-assets/001_asset
  -008037_hust-obc-und-X-006446_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2002/X_？_5637_1.png`
- asset id: `asset-008037`
...
- source class: `HUST-OBC/undeciphered/X/2002/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2002/X_？_5637_1.png`
- asset id: `asset-008037`
...
- Which source records identify obs-unk-006446 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006446？
