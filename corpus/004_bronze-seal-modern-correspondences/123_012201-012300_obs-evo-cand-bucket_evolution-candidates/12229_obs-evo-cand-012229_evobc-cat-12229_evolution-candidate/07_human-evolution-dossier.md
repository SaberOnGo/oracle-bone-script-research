...
- Project ID: `obs-evo-cand-012229`
- EVOBC category candidate ID: `evobc-evo-cat-12229`
- External category reference: `evobc-cat-12229`
- Source category ID: `12229`
- Source label for human review: `𧧒`
- Source codepoints: `U+279D2`
...
- `obs-evo-cand-012229-route-category-staging`
...
- `obs-evo-cand-012229-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012229-route-evolution-graph`
