...
- External category reference: `evobc-cat-06801`
- Source category ID: `06801`
- Source label: `罙`
...
- `obs-evo-cand-006801-route-category-staging`
...
- `obs-evo-cand-006801-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006801-route-evolution-graph`
