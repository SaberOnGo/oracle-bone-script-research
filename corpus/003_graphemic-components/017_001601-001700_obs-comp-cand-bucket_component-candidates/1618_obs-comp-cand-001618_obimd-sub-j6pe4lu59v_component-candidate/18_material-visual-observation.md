# Material Visual Observation / obs-comp-cand-001618 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001618`
- External reference / 外部参照: `obimd-sub-j6pe4lu59v`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017294_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/j6pe4lu59v/j6pe4lu59v/j6pe4lu59v.png`
- Checksum / 校验和:
  `1aebc53e3a0805bf323a3a8d09e40cf26c2d0aa8917fa4b2f8d6c068062ac6bf`
...
- Marked-pixel bounds: (75,17)–(170,231); span 96 × 215 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.48%。
- 痕迹范围：(75,17)–(170,231)；跨度96 × 215 px；痕迹矩形高于宽。
