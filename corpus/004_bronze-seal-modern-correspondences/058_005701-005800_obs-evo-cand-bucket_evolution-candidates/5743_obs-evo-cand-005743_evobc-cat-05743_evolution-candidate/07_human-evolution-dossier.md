...
- Project ID: `obs-evo-cand-005743`
- EVOBC category candidate ID: `evobc-evo-cat-05743`
- External category reference: `evobc-cat-05743`
- Source category ID: `05743`
- Source label for human review: `盈`
- Source codepoints: `U+76C8`
...
- `obs-evo-cand-005743-route-category-staging`
...
- `obs-evo-cand-005743-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005743-route-evolution-graph`
