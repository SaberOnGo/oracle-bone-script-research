# obs-char-000305 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000305`
- primary external id: `hust-obc-cat-0345`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/305_obs-char-000305_hust-obc-cat-0345_orac
  le-character/03_visual-assets/001_asset-000310_hust-obc-cat-0345_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0345/G_0345_燕796(甲).png`
- asset id: `asset-000310`
...
- source category: `0345`
- validation class: `304`
- source image route: `HUST-OBC/deciphered/0345/G_0345_燕796(甲).png`
- asset id: `asset-000310`
...
- English observation: `The image has paired upper horizontal strokes, a
  narrow crossed middle, and a broad rounded lower enclosure.`
- 中文观察: `图像上方有成对横向笔画，中部狭窄且相交，下方有宽大的圆弧闭合轮廓。`
...
- dataset label text: `㕏`
- dataset label codepoints: `U+354F`
...
- Which source records identify obs-char-000305 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000305？
