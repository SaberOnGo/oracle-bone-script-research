# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006143
...
- EVOBC candidate category: `evobc-evo-cat-06143`.
- Source label for search only: `穴`.
- Source codepoints for search only: `U+7A74`.
