...
Project ID: `obs-evo-cand-005388`
...
- Project ID: `obs-evo-cand-005388`
- EVOBC category candidate ID: `evobc-evo-cat-05388`
- External category reference: `evobc-cat-05388`
- Source category ID: `05388`
- Source label for human review: `珦`
- Source codepoints: `U+73E6`
...
- `obs-evo-cand-005388-route-category-staging`
...
- `obs-evo-cand-005388-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005388-route-evolution-graph`
