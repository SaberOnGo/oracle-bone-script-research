...
- `obs-evo-cand-007074-route-category-staging`
...
- `obs-evo-cand-007074-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007074-route-evolution-graph`
