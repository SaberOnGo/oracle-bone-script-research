# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006300
...
- EVOBC candidate category: `evobc-evo-cat-06300`.
- Source label for search only: `箬`.
- Source codepoints for search only: `U+7BAC`.
