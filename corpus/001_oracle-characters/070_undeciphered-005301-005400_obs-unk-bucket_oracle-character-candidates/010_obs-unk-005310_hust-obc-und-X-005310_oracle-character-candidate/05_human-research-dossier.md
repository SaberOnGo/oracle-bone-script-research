# obs-unk-005310 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005310`
- primary external id: `hust-obc-und-X-005310`
...
- local review image route: `corpus/001_oracle-characters/070_undeciphered-005
  301-005400_obs-unk-bucket_oracle-character-candidates/010_obs-unk-005310_h
  ust-obc-und-X-005310_oracle-character-candidate/03_visual-assets/001_asset
  -006903_hust-obc-und-X-005310_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/866/X_？_7833_1.png`
- asset id: `asset-006903`
...
- source class: `HUST-OBC/undeciphered/X/866/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/866/X_？_7833_1.png`
- asset id: `asset-006903`
...
- Which source records identify obs-unk-005310 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005310？
