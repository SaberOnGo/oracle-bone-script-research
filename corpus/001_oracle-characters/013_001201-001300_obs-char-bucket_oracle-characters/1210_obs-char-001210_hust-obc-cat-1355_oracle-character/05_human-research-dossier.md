# obs-char-001210 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001210`
- primary external id: `hust-obc-cat-1355`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1210_obs-char-001210_hust-obc-cat-1355_ora
  cle-character/03_visual-assets/001_asset-001215_hust-obc-cat-1355_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1355/G_1355_乙5234(甲).png`
- asset id: `asset-001215`
...
- source category: `1355`
- validation class: `1209`
- source image route: `HUST-OBC/deciphered/1355/G_1355_乙5234(甲).png`
- asset id: `asset-001215`
...
- English observation: `A large rectangular enclosure has a heavy upper bar,
  a left vertical, and several short interior marks.`
- 中文观察: `大型方形框廓有粗重上部横笔、左侧竖笔和数个内部短痕迹。`
...
- dataset label text: `㥁`
- dataset label codepoints: `U+3941`
...
- Which source records identify obs-char-001210 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001210？
