...
- Project ID: `obs-evo-cand-009032`
- EVOBC category candidate ID: `evobc-evo-cat-09032`
- External category reference: `evobc-cat-09032`
- Source category ID: `09032`
- Source label for human review: `遑`
- Source codepoints: `U+9051`
...
- `obs-evo-cand-009032-route-category-staging`
...
- `obs-evo-cand-009032-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009032-route-evolution-graph`
