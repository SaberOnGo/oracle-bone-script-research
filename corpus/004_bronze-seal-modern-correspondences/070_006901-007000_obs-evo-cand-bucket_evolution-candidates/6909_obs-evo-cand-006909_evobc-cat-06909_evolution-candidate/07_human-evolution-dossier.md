...
Project ID: `obs-evo-cand-006909`
...
- Project ID: `obs-evo-cand-006909`
- EVOBC category candidate ID: `evobc-evo-cat-06909`
- External category reference: `evobc-cat-06909`
- Source category ID: `06909`
- Source label for human review: `老`
- Source codepoints: `U+8001`
- Image reference count in source metadata: `143`
...
- `obs-evo-cand-006909-route-category-staging`
...
- `obs-evo-cand-006909-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006909-route-evolution-graph`
