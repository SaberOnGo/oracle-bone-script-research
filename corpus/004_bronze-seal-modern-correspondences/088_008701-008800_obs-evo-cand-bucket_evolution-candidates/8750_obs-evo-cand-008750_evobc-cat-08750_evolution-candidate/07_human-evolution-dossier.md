...
- External category reference: `evobc-cat-08750`
- Source category ID: `08750`
- Source label for human review: `蹇`
...
- `obs-evo-cand-008750-route-category-staging`
...
- `obs-evo-cand-008750-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008750-route-evolution-graph`
