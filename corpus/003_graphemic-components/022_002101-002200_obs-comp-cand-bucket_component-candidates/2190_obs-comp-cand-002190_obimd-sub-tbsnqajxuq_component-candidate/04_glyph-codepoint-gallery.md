# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002190
...
| --- | --- | --- | --- |
| `obimd-glyph-link-034052` | 󼦸 | `U+FC9B8` | `reviewed_metadata_only` |
| `obimd-glyph-link-034053` | 󼦹 | `U+FC9B9` | `reviewed_metadata_only` |
| `obimd-glyph-link-034054` | 󼦺 | `U+FC9BA` | `reviewed_metadata_only` |
