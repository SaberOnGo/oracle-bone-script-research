# obs-unk-004477 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004477`
- primary external id: `hust-obc-und-X-004477`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/077_obs-unk-004477_h
  ust-obc-und-X-004477_oracle-character-candidate/03_visual-assets/001_asset
  -006070_hust-obc-und-X-004477_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/33/X_？_8211_1.png`
- asset id: `asset-006070`
...
- source class: `HUST-OBC/undeciphered/X/33/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/33/X_？_8211_1.png`
- asset id: `asset-006070`
...
- English observation: Two similar upper strokes lead into branching lower
  traces, with a separate short stroke above.
- 中文观察: 两组相似上部横痕向下分支，上方另有一条短痕迹。
...
- Which source records identify obs-unk-004477 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004477？
