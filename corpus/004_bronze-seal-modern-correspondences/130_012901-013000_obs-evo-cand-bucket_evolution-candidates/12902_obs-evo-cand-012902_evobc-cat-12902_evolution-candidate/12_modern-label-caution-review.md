# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012902
...
- EVOBC candidate category: `evobc-evo-cat-12902`.
- Source label for search only: `𪾚`.
- Source codepoints for search only: `U+2AF9A`.
