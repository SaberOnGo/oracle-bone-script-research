# Material Visual Observation / obs-comp-cand-001598 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001598`
- External reference / 外部参照: `obimd-sub-gqqiry5kzj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017274_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wp0tnl2ydu/gqqiry5kzj/gqqiry5kzj.png`
- Checksum / 校验和:
  `6a1adddc4ffd993d5405ead60bde1ff285bd785e65055685cf2b36cc5ce9f2ac`
...
- Marked-pixel bounds: (77,23)–(179,227); span 103 × 205 px; the marked
...
- 痕迹范围：(77,23)–(179,227)；跨度103 × 205 px；痕迹矩形高于宽。
