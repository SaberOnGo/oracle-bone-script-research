# obs-char-000994 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/994_obs-char-000994_hust-obc-cat-1117_orac
  le-character/03_visual-assets/001_asset-000999_hust-obc-cat-1117_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1117/G_1117_京津3030(甲).png`
- asset id: `asset-000999`
...
- source category: `1117`
- validation class: `993`
- source image route: `HUST-OBC/deciphered/1117/G_1117_京津3030(甲).png`
- asset id: `asset-000999`
...
- English observation: `A narrow curved stroke at left is accompanied by
  several short separated interior marks.`
...
- dataset label text: `㡓`
- dataset label codepoints: `U+3853`
...
- Which source records identify obs-char-000994 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000994？
