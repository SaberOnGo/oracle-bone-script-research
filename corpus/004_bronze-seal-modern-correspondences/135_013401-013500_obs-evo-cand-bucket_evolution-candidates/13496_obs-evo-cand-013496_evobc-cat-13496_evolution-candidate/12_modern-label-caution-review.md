# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013496
...
- EVOBC candidate category: `evobc-evo-cat-13496`.
- Source label for search only: `𭍪`.
- Source codepoints for search only: `U+2D36A`.
