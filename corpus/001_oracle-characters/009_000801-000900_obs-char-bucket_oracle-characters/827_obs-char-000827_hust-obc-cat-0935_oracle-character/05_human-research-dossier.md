# obs-char-000827 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/827_obs-char-000827_hust-obc-cat-0935_orac
  le-character/03_visual-assets/001_asset-000832_hust-obc-cat-0935_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0935/L_0935_7356.jpg`
- asset id: `asset-000832`
...
- source category: `0935`
- validation class: `826`
- source image route: `HUST-OBC/deciphered/0935/L_0935_7356.jpg`
- asset id: `asset-000832`
...
- English observation: `The small gray crossing has a central diagonal with
  two short forked upper branches and a separate lower stroke.`
- 中文观察: `小型灰度交叉形中有中央斜笔，上方分出两条短枝，下方另有分离笔画。`
...
- dataset label text: `㞝`
- dataset label codepoints: `U+379D`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00082`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00082`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00082`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/082_obs-evo-can
  d-000082_evobc-cat-00082_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/082_obs-evo-cand-000082_evobc-cat-00082_evolu
...
- Which source records identify obs-char-000827 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000827？
