# Material Visual Observation / obs-comp-cand-000827 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000827`
- External reference / 外部参照: `obimd-sub-m4rdm8ckxg`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013698_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/m4rdm8ckxg/m4rdm8ckxg/m4rdm8ckxg.png`
- Checksum / 校验和:
  `8a1d45beb7e7f50cdf23ec514cbbbd1ab3585bb8ef97d4a92739e4988c7625fd`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.60%.
- Marked-pixel bounds: (82,34)–(162,218); span 81 × 185 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.60%。
- 痕迹范围：(82,34)–(162,218)；跨度81 × 185 px；痕迹矩形高于宽。
