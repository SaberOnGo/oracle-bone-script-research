...
Project ID: `obs-evo-cand-007246`
...
- Project ID: `obs-evo-cand-007246`
- EVOBC category candidate ID: `evobc-evo-cat-07246`
- External category reference: `evobc-cat-07246`
- Source category ID: `07246`
- Source label for human review: `芝`
- Source codepoints: `U+829D`
...
- `obs-evo-cand-007246-route-category-staging`
...
- `obs-evo-cand-007246-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007246-route-evolution-graph`
