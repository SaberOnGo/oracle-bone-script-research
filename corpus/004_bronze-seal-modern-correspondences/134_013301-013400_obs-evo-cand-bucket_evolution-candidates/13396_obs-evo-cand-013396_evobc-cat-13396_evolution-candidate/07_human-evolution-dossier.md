...
- External category reference: `evobc-cat-13396`
- Source category ID: `13396`
- Source label for human review: `𬫐`
- Source codepoints: `U+2CAD0`
...
- `obs-evo-cand-013396-route-category-staging`
...
- `obs-evo-cand-013396-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013396-route-evolution-graph`
