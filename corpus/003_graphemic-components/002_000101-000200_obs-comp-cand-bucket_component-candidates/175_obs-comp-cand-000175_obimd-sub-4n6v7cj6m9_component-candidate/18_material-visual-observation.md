# Material Visual Observation / obs-comp-cand-000175 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000175`
- External reference / 外部参照: `obimd-sub-4n6v7cj6m9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011587_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4n6v7cj6m9/4n6v7cj6m9/4n6v7cj6m9.png`
- Checksum / 校验和:
  `aa4091f0a57172cdfa59e64e510147c614423457a7aaefa0a074b451ca6659e4`
...
- Marked-pixel bounds: (59,20)–(190,231); span 132 × 212 px; the marked
...
- 痕迹范围：(59,20)–(190,231)；跨度132 × 212 px；痕迹矩形高于宽。
