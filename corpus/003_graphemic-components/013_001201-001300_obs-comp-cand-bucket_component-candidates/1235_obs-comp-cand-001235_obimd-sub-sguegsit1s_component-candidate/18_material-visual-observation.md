# Material Visual Observation / obs-comp-cand-001235 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001235`
- External reference / 外部参照: `obimd-sub-sguegsit1s`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015473_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kdx7k2ou1m/sguegsit1s/sguegsit1s.png`
- Checksum / 校验和:
  `1dd95d0e489a7c7b821db62dac9a801d5e017c567f31df9ff4ebdd718a5e3f93`
...
- Marked-pixel bounds: (79,24)–(170,221); span 92 × 198 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.18%。
- 痕迹范围：(79,24)–(170,221)；跨度92 × 198 px；痕迹矩形高于宽。
