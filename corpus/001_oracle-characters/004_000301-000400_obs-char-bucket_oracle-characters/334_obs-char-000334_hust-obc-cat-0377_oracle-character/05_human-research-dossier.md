# obs-char-000334 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000334`
- primary external id: `hust-obc-cat-0377`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/334_obs-char-000334_hust-obc-cat-0377_orac
  le-character/03_visual-assets/001_asset-000339_hust-obc-cat-0377_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0377/G_0377_甲504(甲).png`
- asset id: `asset-000339`
...
- source category: `0377`
- validation class: `333`
- source image route: `HUST-OBC/deciphered/0377/G_0377_甲504(甲).png`
- asset id: `asset-000339`
...
- English observation: `The image consists of four separated parallel
  horizontal strokes of different lengths.`
- 中文观察: `图像由四道分离的平行横笔画组成，四道笔画长短不同。`
...
- dataset label text: `㕯`
- dataset label codepoints: `U+356F`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00031`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00031`
- EvoBC image reference count / EvoBC 图像引用数: `25`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00031`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/031_obs-evo-can
  d-000031_evobc-cat-00031_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/031_obs-evo-cand-000031_evobc-cat-00031_evolu
...
- Which source records identify obs-char-000334 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000334？
