# obs-unk-006463 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006463`
- primary external id: `hust-obc-und-X-006463`
...
- local review image route: `corpus/001_oracle-characters/081_undeciphered-006
  401-006500_obs-unk-bucket_oracle-character-candidates/063_obs-unk-006463_h
  ust-obc-und-X-006463_oracle-character-candidate/03_visual-assets/001_asset
  -008054_hust-obc-und-X-006463_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2019/X_？_5663_1.png`
- asset id: `asset-008054`
...
- source class: `HUST-OBC/undeciphered/X/2019/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2019/X_？_5663_1.png`
- asset id: `asset-008054`
...
- Which source records identify obs-unk-006463 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006463？
