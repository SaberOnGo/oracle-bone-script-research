# obs-char-000219 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000219`
- primary external id: `hust-obc-cat-0243`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/219_obs-char-000219_hust-obc-cat-0243_orac
  le-character/03_visual-assets/001_asset-000224_hust-obc-cat-0243_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0243/G_0243_前4.38.7(甲).png`
- asset id: `asset-000224`
...
- source category: `0243`
- validation class: `218`
- source image route: `HUST-OBC/deciphered/0243/G_0243_前4.38.7(甲).png`
- asset id: `asset-000224`
...
- English observation: `The image has a broad upper curved cap, a hanging
  central loop, and a separate thin curved stroke on the right.`
- 中文观察: `图像上方有宽弯曲盖状笔，中部有悬垂环状形，右侧另有分离细弯曲笔。`
...
- dataset label text: `㓩`
- dataset label codepoints: `U+34E9`
...
- Which source records identify obs-char-000219 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000219？
