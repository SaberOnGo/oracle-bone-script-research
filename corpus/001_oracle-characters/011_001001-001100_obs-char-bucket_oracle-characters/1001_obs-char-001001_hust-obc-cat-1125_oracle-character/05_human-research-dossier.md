# obs-char-001001 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1001_obs-char-001001_hust-obc-cat-1125_ora
  cle-character/03_visual-assets/001_asset-001006_hust-obc-cat-1125_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1125/G_1125_甲骨文0.png`
- asset id: `asset-001006`
...
- source category: `1125`
- validation class: `1000`
- source image route: `HUST-OBC/deciphered/1125/G_1125_甲骨文0.png`
- asset id: `asset-001006`
...
- English observation: `A compact dark upper cluster has a rounded outer
  turn, a short interior upright, and a long lower diagonal stroke.`
- 中文观察: `紧密的深色上部笔群有圆弧外转、短内竖笔和一条长下行斜笔。`
...
- dataset label text: `㡛`
- dataset label codepoints: `U+385B`
...
- Which source records identify obs-char-001001 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001001？
