# Material Visual Observation / obs-comp-cand-002403 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002403`
- External reference / 外部参照: `obimd-sub-npykxas4c8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020474_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/npykxas4c8/npykxas4c8/npykxas4c8.png`
- Checksum / 校验和:
  `76b56d79bf53f346589fed9871803e5a3f61a56dbd43f5b1adf5b9e13ab277a9`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 16.07%.
- Marked-pixel bounds: (49,27)–(195,219); span 147 × 193 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占16.07%。
- 痕迹范围：(49,27)–(195,219)；跨度147 × 193 px；痕迹矩形高于宽。
