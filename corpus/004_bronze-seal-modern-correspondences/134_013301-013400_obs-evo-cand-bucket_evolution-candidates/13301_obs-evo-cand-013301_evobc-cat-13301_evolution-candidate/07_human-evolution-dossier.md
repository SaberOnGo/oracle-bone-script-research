...
- External category reference: `evobc-cat-13301`
- Source category ID: `13301`
- Source label for human review: `𬚪`
...
- `obs-evo-cand-013301-route-category-staging`
...
- `obs-evo-cand-013301-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013301-route-evolution-graph`
