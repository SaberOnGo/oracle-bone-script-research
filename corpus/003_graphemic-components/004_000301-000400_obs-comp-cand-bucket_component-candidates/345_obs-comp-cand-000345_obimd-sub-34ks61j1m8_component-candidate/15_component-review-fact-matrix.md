# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000345
...
| Glyph or codepoint route / 字形或码位路线 | 24 OBIMD route rows; examples U+8C5A;U+F1FBA; U+F1FBB; 另有 22 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
