...
- `obs-evo-cand-009940-route-category-staging`
...
- `obs-evo-cand-009940-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009940-route-evolution-graph`
