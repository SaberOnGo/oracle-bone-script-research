# obs-xwalk-cand-001294 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+399C;U+399D` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-1446_1447` | not reading |
