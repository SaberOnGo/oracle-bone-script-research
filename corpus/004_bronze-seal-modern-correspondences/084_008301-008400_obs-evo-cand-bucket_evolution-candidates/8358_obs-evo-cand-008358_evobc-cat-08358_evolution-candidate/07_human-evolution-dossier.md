...
Project ID: `obs-evo-cand-008358`
...
- Project ID: `obs-evo-cand-008358`
- EVOBC category candidate ID: `evobc-evo-cat-08358`
- External category reference: `evobc-cat-08358`
- Source category ID: `08358`
- Source label for human review: `譔`
- Source codepoints: `U+8B54`
...
- `obs-evo-cand-008358-route-category-staging`
...
- `obs-evo-cand-008358-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008358-route-evolution-graph`
