...
- External category reference: `evobc-cat-07476`
- Source category ID: `07476`
- Source label for human review: `葥`
- Source codepoints: `U+8465`
...
- `obs-evo-cand-007476-route-category-staging`
...
- `obs-evo-cand-007476-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007476-route-evolution-graph`
