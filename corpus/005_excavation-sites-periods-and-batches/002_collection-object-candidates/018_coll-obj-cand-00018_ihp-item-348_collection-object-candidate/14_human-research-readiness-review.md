# Human Research Readiness Review / 人类研究准备度复核: coll-obj-cand-00018
...
| --- | --- | --- |
| Catalog source | `348` | `02_collection-source-index.csv` |
...
| Live source page | source description and image checked; 3D route pending | `18_live-source-evidence-review.md` |
...
- Which 3D route, source description, or image observation requires
