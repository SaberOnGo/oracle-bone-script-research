# obs-char-000888 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000888`
- primary external id: `hust-obc-cat-1000`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/888_obs-char-000888_hust-obc-cat-1000_orac
  le-character/03_visual-assets/001_asset-000893_hust-obc-cat-1000_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1000/G_1000_甲骨文.png`
- asset id: `asset-000893`
...
- source category: `1000`
- validation class: `887`
- source image route: `HUST-OBC/deciphered/1000/G_1000_甲骨文.png`
- asset id: `asset-000893`
...
- English observation: `A bold branching cluster has a curved left stroke,
  several short upper branches, a long right curve, and lower marks.`
- 中文观察: `粗重分枝笔群含弯曲左笔、数条上部分枝、长右弯笔和下部痕迹。`
...
- dataset label text: `㟞`
- dataset label codepoints: `U+37DE`
...
- Which source records identify obs-char-000888 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000888？
