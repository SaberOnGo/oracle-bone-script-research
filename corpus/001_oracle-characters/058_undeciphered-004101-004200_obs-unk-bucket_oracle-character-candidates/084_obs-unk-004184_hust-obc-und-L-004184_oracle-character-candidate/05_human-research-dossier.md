# obs-unk-004184 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004184`
- primary external id: `hust-obc-und-L-004184`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/084_obs-unk-004184_h
  ust-obc-und-L-004184_oracle-character-candidate/03_visual-assets/001_asset
  -005777_hust-obc-und-L-004184_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4184/L_？_9068.jpg`
- asset id: `asset-005777`
...
- source class: `HUST-OBC/undeciphered/L/4184/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4184/L_？_9068.jpg`
- asset id: `asset-005777`
...
- English observation: A rounded enclosure contains an uneven angular inner
  cluster.
- 中文观察: 圆弧包围轮廓内有不规则的折角痕迹组。
...
- Which source records identify obs-unk-004184 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004184？
