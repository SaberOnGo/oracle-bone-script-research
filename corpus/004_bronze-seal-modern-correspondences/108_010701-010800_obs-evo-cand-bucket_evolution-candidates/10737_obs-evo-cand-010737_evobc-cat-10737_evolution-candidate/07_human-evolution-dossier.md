...
- External category reference: `evobc-cat-10737`
- Source category ID: `10737`
- Source label for human review: `齳`
- Source codepoints: `U+9F73`
...
- `obs-evo-cand-010737-route-category-staging`
...
- `obs-evo-cand-010737-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010737-route-evolution-graph`
