# obs-unk-003065 Local Object Materials / obs-unk-003065 本地对象资料
...
- Local review image / 本地复核图像: `03_visual-assets/001_asset-004658_hust-obc-und-L-003065_glyph.jpg`

## Object Summary / 对象摘要

- Project ID / 项目 ID: `obs-unk-003065`
- Primary external reference / 首选外部参考: `hust-obc-und-L-003065`
- Source group / 来源分组: `L` (Oracle Bone Script: Six Digit Numerical Code)
- Source class path / 来源分类路径: `HUST-OBC/undeciphered/L/3065/`
- Source image path / 来源图像路径: `HUST-OBC/undeciphered/L/3065/L_？_5479.jpg`
- Asset ID / 资产 ID: `asset-004658`
