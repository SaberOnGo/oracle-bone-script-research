# obs-comp-cand-002743 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002743`
- 首选外部 ID: `obimd-sub-x8esaf2cwr`
- OBIMD subcharacter UID: `x8esaf2cwr`
- OBIMD main character UID: `x8esaf2cwr`
- 来源 ID: `src-obimd`
