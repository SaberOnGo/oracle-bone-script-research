# obs-char-001468 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001468`
- primary external id: `hust-obc-cat-1648`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1468_obs-char-001468_hust-obc-cat-1648_ora
  cle-character/03_visual-assets/001_asset-001473_hust-obc-cat-1648_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1648/G_1648_乙1443合21924子組.png`
- asset id: `asset-001473`
...
- source category: `1648`
- validation class: `1467`
- source image route: `HUST-OBC/deciphered/1648/G_1648_乙1443合21924子組.png`
- asset id: `asset-001473`
...
- English observation: `A diagonal central band has an upper branch and a
  lower right stroke.`
- 中文观察: `中央斜向带状形有上部分枝和右侧下部笔画。`
...
- dataset label text: `㩦`
- dataset label codepoints: `U+3A66`
...
- filename catalog route clues: `Heji-like filename clue: 合21924
  (G_1648_乙1443合21924子組.png)`
...
- Which source records identify obs-char-001468 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001468？
