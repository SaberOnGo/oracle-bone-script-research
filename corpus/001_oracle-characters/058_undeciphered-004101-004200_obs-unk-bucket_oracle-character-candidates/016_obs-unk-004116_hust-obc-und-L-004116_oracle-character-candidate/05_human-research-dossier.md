# obs-unk-004116 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004116`
- primary external id: `hust-obc-und-L-004116`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/016_obs-unk-004116_h
  ust-obc-und-L-004116_oracle-character-candidate/03_visual-assets/001_asset
  -005709_hust-obc-und-L-004116_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4116/L_？_8857.jpg`
- asset id: `asset-005709`
...
- source class: `HUST-OBC/undeciphered/L/4116/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4116/L_？_8857.jpg`
- asset id: `asset-005709`
...
- Which source records identify obs-unk-004116 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004116？
