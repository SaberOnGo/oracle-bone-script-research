...
- External category reference: `evobc-cat-04747`
- Source category ID: `04747`
- Source label for human review: `清`
- Source codepoints: `U+6E05`
...
- `obs-evo-cand-004747-route-category-staging`
...
- `obs-evo-cand-004747-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004747-route-evolution-graph`
