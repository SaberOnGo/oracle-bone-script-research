...
Project ID: `obs-evo-cand-013437`
...
- Project ID: `obs-evo-cand-013437`
- EVOBC category candidate ID: `evobc-evo-cat-13437`
- External category reference: `evobc-cat-13437`
- Source category ID: `13437`
- Source label for human review: `𬳣`
- Source codepoints: `U+2CCE3`
...
- `obs-evo-cand-013437-route-category-staging`
...
- `obs-evo-cand-013437-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013437-route-evolution-graph`
