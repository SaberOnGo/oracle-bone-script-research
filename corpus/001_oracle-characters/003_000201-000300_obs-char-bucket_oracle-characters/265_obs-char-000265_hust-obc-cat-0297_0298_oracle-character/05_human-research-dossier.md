# obs-char-000265 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000265`
- primary external id: `hust-obc-cat-0297_0298`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/265_obs-char-000265_hust-obc-cat-0297_0298
  _oracle-character/03_visual-assets/001_asset-000270_hust-obc-cat-0297_0298
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0297_0298/0297/G_0297_乙7488(甲).
  png`
- asset id: `asset-000270`
...
- source category: `0297_0298`
- validation class: `264`
- source image route: `HUST-OBC/deciphered/0297_0298/0297/G_0297_乙7488(甲).png`
- asset id: `asset-000270`
...
- English observation: `The image has two slender upper branches, a rounded
  enclosed mark below, and a short detached stroke at the left.`
- 中文观察: `图像上部有两道纤细分支，下方有圆弧闭合痕迹，左侧另有短分离笔画。`
...
- dataset label text: `㔟㔠`
- dataset label codepoints: `U+351F;U+3520`
...
- graph edge count: `2`
- codepoint routes: `U+351F;U+3520`
...
- Which source records identify obs-char-000265 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000265？
