...
Project ID: `obs-evo-cand-004368`
...
- Project ID: `obs-evo-cand-004368`
- EVOBC category candidate ID: `evobc-evo-cat-04368`
- External category reference: `evobc-cat-04368`
- Source category ID: `04368`
- Source label for human review: `歋`
- Source codepoints: `U+6B4B`
...
- `obs-evo-cand-004368-route-category-staging`
...
- `obs-evo-cand-004368-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004368-route-evolution-graph`
