# obs-unk-007523 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-007523`
- primary external id: `hust-obc-und-YH-007523`
...
- local review image route: `corpus/001_oracle-characters/092_undeciphered-007
  501-007600_obs-unk-bucket_oracle-character-candidates/023_obs-unk-007523_h
  ust-obc-und-YH-007523_oracle-character-candidate/03_visual-assets/001_asse
  t-009114_hust-obc-und-YH-007523_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6007C/H_？_6007C_0.png`
- asset id: `asset-009114`
...
- source class: `HUST-OBC/undeciphered/Y+H/6007C/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6007C/H_？_6007C_0.png`
- asset id: `asset-009114`
...
- Which source records identify obs-unk-007523 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007523？
