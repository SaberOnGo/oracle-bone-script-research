...
- External category reference: `evobc-cat-03585`
- Source category ID: `03585`
- Source label for human review: `敕`
- Source codepoints: `U+6555`
...
- `obs-evo-cand-003585-route-category-staging`
...
- `obs-evo-cand-003585-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003585-route-evolution-graph`
