# Material Visual Observation / obs-comp-cand-000297 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000297`
- External reference / 外部参照: `obimd-sub-qzgadtxm9i`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012063_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qzgadtxm9i/qzgadtxm9i/qzgadtxm9i.png`
- Checksum / 校验和:
  `56b6ca4b86caee76903f3d7c6657f6c024dda97e829b4f9b61d50311e27b856f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.69%.
- Marked-pixel bounds: (72,34)–(177,215); span 106 × 182 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.69%。
- 痕迹范围：(72,34)–(177,215)；跨度106 × 182 px；痕迹矩形高于宽。
