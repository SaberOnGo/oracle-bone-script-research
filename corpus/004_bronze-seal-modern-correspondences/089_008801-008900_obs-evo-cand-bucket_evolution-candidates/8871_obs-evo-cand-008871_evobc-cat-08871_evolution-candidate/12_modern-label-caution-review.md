# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008871
...
- EVOBC candidate category: `evobc-evo-cat-08871`.
- Source label for search only: `轏`.
- Source codepoints for search only: `U+8F4F`.
