...
- External category reference: `evobc-cat-09326`
- Source category ID: `09326`
- Source label for human review: `鈂`
- Source codepoints: `U+9202`
...
- `obs-evo-cand-009326-route-category-staging`
...
- `obs-evo-cand-009326-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009326-route-evolution-graph`
