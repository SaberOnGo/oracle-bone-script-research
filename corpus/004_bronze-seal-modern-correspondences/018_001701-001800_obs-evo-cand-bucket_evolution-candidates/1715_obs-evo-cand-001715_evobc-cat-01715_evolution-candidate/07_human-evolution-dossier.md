...
Project ID: `obs-evo-cand-001715`
...
- Project ID: `obs-evo-cand-001715`
- EVOBC category candidate ID: `evobc-evo-cat-01715`
- External category reference: `evobc-cat-01715`
- Source category ID: `01715`
- Source label for human review: `噎`
- Source codepoints: `U+564E`
...
- `obs-evo-cand-001715-route-category-staging`
...
- `obs-evo-cand-001715-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001715-route-evolution-graph`
