# obs-char-000357 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000357`
- primary external id: `hust-obc-cat-0405`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/357_obs-char-000357_hust-obc-cat-0405_orac
  le-character/03_visual-assets/001_asset-000362_hust-obc-cat-0405_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0405/H_0405_6012B_0.png`
- asset id: `asset-000362`
...
- source category: `0405`
- validation class: `356`
- source image route: `HUST-OBC/deciphered/0405/H_0405_6012B_0.png`
- asset id: `asset-000362`
...
- English observation: `The dark image has a broad upper horizontal stroke,
  a central rounded mark, and long branching strokes descending below.`
- 中文观察: `深色图像上方有宽横笔画，中部有圆弧痕迹，下方有长分叉笔画向下延伸。`
...
- dataset label text: `㖋`
- dataset label codepoints: `U+358B`
...
- filename catalog route clues: `catalog-like filename clue: H_0405
  (H_0405_6012B_0.png)`
...
- Which source records identify obs-char-000357 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000357？
