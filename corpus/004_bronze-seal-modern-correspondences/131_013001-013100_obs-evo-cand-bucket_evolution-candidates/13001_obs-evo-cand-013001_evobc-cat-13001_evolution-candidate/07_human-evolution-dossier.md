...
- External category reference: `evobc-cat-13001`
- Source category ID: `13001`
- Source label for human review: `𫢱`
- Source codepoints: `U+2B8B1`
...
- `obs-evo-cand-013001-route-category-staging`
...
- `obs-evo-cand-013001-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013001-route-evolution-graph`
