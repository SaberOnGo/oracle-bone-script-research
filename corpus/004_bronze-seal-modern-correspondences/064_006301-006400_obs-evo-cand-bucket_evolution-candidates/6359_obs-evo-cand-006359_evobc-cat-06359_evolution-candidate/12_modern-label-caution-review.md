# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006359
...
- EVOBC candidate category: `evobc-evo-cat-06359`.
- Source label for search only: `簭`.
- Source codepoints for search only: `U+7C2D`.
