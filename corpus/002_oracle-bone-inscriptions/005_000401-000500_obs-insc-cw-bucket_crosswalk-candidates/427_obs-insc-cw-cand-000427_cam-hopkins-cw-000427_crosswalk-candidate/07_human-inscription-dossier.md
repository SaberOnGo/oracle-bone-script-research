...
- Source page section: `Period II Group 20` /
  `第 II 期第 20 组`
- Source section key: `period-ii-group-20`
...
- Yingguo / 英国所藏: `y2251` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `209` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `676` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000427`
