# Material Visual Observation / obs-comp-cand-000831 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000831`
- External reference / 外部参照: `obimd-sub-13cqabljgi`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013702_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/13cqabljgi/13cqabljgi/13cqabljgi.png`
- Checksum / 校验和:
  `d58c04c4136519e1668cae5609ac3e56cdb5b843be5b2963f4ac463f5812e969`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.55%.
- Marked-pixel bounds: (80,28)–(173,220); span 94 × 193 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.55%。
- 痕迹范围：(80,28)–(173,220)；跨度94 × 193 px；痕迹矩形高于宽。
