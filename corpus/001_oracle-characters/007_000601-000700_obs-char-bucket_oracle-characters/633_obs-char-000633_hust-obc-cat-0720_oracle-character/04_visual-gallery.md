# obs-char-000633 Visual Gallery / obs-char-000633 图像资料页
...
## obs-char-000633-visual-source-001 / 图像条目

![obs-char-000633 glyph candidate](03_visual-assets/001_asset-000638_hust-obc-cat-0720_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000638_hust-obc-cat-0720_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000638_hust-obc-cat-0720_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/0720/G_0720_上(2).從(甲).10(楚).png`
