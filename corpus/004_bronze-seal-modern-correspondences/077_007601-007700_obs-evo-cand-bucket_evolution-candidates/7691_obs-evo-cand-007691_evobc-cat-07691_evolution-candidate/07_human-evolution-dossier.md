...
- Project ID: `obs-evo-cand-007691`
- EVOBC category candidate ID: `evobc-evo-cat-07691`
- External category reference: `evobc-cat-07691`
- Source category ID: `07691`
- Source label for human review: `虎`
- Source codepoints: `U+864E`
- Image reference count in source metadata: `264`
...
- `obs-evo-cand-007691-route-category-staging`
...
- `obs-evo-cand-007691-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007691-route-evolution-graph`
