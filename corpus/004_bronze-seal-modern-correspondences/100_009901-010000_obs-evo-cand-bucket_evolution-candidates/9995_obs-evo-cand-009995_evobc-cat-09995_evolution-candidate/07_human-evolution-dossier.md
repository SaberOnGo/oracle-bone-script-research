...
Project ID: `obs-evo-cand-009995`
...
- Project ID: `obs-evo-cand-009995`
- EVOBC category candidate ID: `evobc-evo-cat-09995`
- External category reference: `evobc-cat-09995`
- Source category ID: `09995`
- Source label for human review: `頨`
- Source codepoints: `U+9828`
...
- `obs-evo-cand-009995-route-category-staging`
...
- `obs-evo-cand-009995-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009995-route-evolution-graph`
