# obs-char-000392 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000392`
- primary external id: `hust-obc-cat-0444`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/392_obs-char-000392_hust-obc-cat-0444_orac
  le-character/03_visual-assets/001_asset-000397_hust-obc-cat-0444_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0444/X_0444_4886_1.png`
- asset id: `asset-000397`
...
- source category: `0444`
- validation class: `391`
- source image route: `HUST-OBC/deciphered/0444/X_0444_4886_1.png`
- asset id: `asset-000397`
...
- English observation: `A tall branching form contains a rounded rectangular
  middle enclosure, a long central stem, and two levels of lower forks.`
- 中文观察: `高长分支形体中部有圆角矩形闭合轮廓，并有长中央主干和两层下部分叉。`
...
- dataset label text: `㖲`
- dataset label codepoints: `U+35B2`
...
- Which source records identify obs-char-000392 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000392？
