...
- External category reference: `evobc-cat-02255`
- Source category ID: `02255`
- Source label for human review: `嫄`
- Source codepoints: `U+5AC4`
...
- `obs-evo-cand-002255-route-category-staging`
...
- `obs-evo-cand-002255-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002255-route-evolution-graph`
