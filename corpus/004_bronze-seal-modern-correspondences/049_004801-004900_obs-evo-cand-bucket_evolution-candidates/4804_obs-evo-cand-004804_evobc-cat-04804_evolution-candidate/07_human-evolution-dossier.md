...
- External category reference: `evobc-cat-04804`
- Source category ID: `04804`
- Source label for human review: `溋`
- Source codepoints: `U+6E8B`
...
- `obs-evo-cand-004804-route-category-staging`
...
- `obs-evo-cand-004804-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004804-route-evolution-graph`
