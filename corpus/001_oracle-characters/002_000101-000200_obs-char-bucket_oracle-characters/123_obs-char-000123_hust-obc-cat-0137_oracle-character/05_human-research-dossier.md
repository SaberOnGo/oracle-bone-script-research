# obs-char-000123 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000123`
- primary external id: `hust-obc-cat-0137`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/123_obs-char-000123_hust-obc-cat-0137_orac
  le-character/03_visual-assets/001_asset-000128_hust-obc-cat-0137_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0137/G_0137_乙7795合6834賓組.png`
- asset id: `asset-000128`
...
- source category: `0137`
- validation class: `122`
- source image route: `HUST-OBC/deciphered/0137/G_0137_乙7795合6834賓組.png`
- asset id: `asset-000128`
...
- English observation: `The broad image has two sloping strokes meeting at a
  high point, with a short horizontal stroke detached inside the lower
  opening.`
...
- dataset label text: `㑿`
- dataset label codepoints: `U+347F`
...
- Which source records identify obs-char-000123 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000123？
