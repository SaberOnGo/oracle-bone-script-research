# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004920
...
- EVOBC candidate category: `evobc-evo-cat-04920`.
- Source label for search only: `潼`.
- Source codepoints for search only: `U+6F7C`.
