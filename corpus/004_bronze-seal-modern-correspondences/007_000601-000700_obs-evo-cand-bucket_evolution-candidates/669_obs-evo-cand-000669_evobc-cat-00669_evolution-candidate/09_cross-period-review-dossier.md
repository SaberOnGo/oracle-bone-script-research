...
- 本项目 ID：`obs-evo-cand-000669`
- EVOBC 候选类别 ID：`evobc-evo-cat-00669`
- 外部类别引用：`evobc-cat-00669`
- 来源类别 ID：`00669`
- 来源标签：`也`
- 来源 codepoints：`U+4E5F`
- EVOBC 图像引用数量：`531`
...
- era `4`
  token: `WSC`
  image references: 522
- era `5`
  token: `CS`
  image references: 1
- source `1`
  token: `Web:105952;說文Web:58`
  image references: 501
- source `4`
  token: `Book:9131`
  image references: 2
- source `5`
...
- `obs-evo-cand-000669-route-category-staging`
...
- `obs-evo-cand-000669-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000669-route-evolution-graph`
