...
- External category reference: `evobc-cat-09747`
- Source category ID: `09747`
- Source label for human review: `陰`
- Source codepoints: `U+9670`
- Image reference count in source metadata: `106`
...
- `obs-evo-cand-009747-route-category-staging`
...
- `obs-evo-cand-009747-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009747-route-evolution-graph`
