...
- External category reference: `evobc-cat-05244`
- Source category ID: `05244`
- Source label for human review: `犧`
...
- `obs-evo-cand-005244-route-category-staging`
...
- `obs-evo-cand-005244-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005244-route-evolution-graph`
