...
Project ID: `obs-evo-cand-012079`
...
- Project ID: `obs-evo-cand-012079`
- EVOBC category candidate ID: `evobc-evo-cat-12079`
- External category reference: `evobc-cat-12079`
- Source category ID: `12079`
- Source label for human review: `𦨷`
- Source codepoints: `U+26A37`
...
- `obs-evo-cand-012079-route-category-staging`
...
- `obs-evo-cand-012079-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012079-route-evolution-graph`
