# obs-char-000825 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/825_obs-char-000825_hust-obc-cat-0933_orac
  le-character/03_visual-assets/001_asset-000830_hust-obc-cat-0933_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0933/G_0933_前4.13.6合8367賓組.png`
- asset id: `asset-000830`
...
- source category: `0933`
- validation class: `824`
- source image route: `HUST-OBC/deciphered/0933/G_0933_前4.13.6合8367賓組.png`
- asset id: `asset-000830`
...
- English observation: `Two detached curved marks stand left of a rounded
  upper outline; a long looped stem descends from the outline.`
- 中文观察: `两个分离的弯曲痕迹位于圆弧上部轮廓左侧；一条长环状笔干从该轮廓向下延伸。`
...
- dataset label text: `㞛`
- dataset label codepoints: `U+379B`
...
- filename catalog route clues: `Heji-like filename clue: 合8367
...
- Which source records identify obs-char-000825 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000825？
