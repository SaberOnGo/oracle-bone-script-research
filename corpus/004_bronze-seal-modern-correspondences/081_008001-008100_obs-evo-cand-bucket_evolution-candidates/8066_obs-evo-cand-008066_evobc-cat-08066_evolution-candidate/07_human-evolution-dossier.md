...
- External category reference: `evobc-cat-08066`
- Source category ID: `08066`
- Source label for human review: `覡`
...
- `obs-evo-cand-008066-route-category-staging`
...
- `obs-evo-cand-008066-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008066-route-evolution-graph`
