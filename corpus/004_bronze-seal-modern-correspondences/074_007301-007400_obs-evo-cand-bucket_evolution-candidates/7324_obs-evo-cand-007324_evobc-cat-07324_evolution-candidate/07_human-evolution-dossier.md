...
- Project ID: `obs-evo-cand-007324`
- EVOBC category candidate ID: `evobc-evo-cat-07324`
- External category reference: `evobc-cat-07324`
- Source category ID: `07324`
- Source label for human review: `茮`
- Source codepoints: `U+832E`
...
- `obs-evo-cand-007324-route-category-staging`
...
- `obs-evo-cand-007324-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007324-route-evolution-graph`
