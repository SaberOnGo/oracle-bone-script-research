# Material Visual Observation / obs-comp-cand-001956 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001956`
- External reference / 外部参照: `obimd-sub-knps4jrxz3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018766_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/knps4jrxz3/knps4jrxz3/knps4jrxz3.png`
- Checksum / 校验和:
  `e4b37b7ff0d9d6580dd9167ebc1c583180e47000b1e5394ba29540768c07f1af`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.30%.
- Marked-pixel bounds: (75,17)–(173,231); span 99 × 215 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.30%。
- 痕迹范围：(75,17)–(173,231)；跨度99 × 215 px；痕迹矩形高于宽。
