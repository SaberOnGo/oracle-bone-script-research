...
- External category reference: `evobc-cat-13489`
- Source category ID: `13489`
- Source label for human review: `𭉄`
- Source codepoints: `U+2D244`
...
- `obs-evo-cand-013489-route-category-staging`
...
- `obs-evo-cand-013489-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013489-route-evolution-graph`
