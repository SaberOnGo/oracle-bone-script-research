...
- External category reference: `evobc-cat-11610`
- Source category ID: `11610`
- Source label for human review: `𤜼`
- Source codepoints: `U+2473C`
...
- `obs-evo-cand-011610-route-category-staging`
...
- `obs-evo-cand-011610-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011610-route-evolution-graph`
