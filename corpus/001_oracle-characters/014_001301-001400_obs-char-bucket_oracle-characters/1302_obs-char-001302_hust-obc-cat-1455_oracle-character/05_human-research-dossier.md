# obs-char-001302 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001302`
- primary external id: `hust-obc-cat-1455`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1302_obs-char-001302_hust-obc-cat-1455_ora
  cle-character/03_visual-assets/001_asset-001307_hust-obc-cat-1455_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1455/G_1455_合13666正賓組.png`
- asset id: `asset-001307`
...
- source category: `1455`
- validation class: `1301`
- source image route: `HUST-OBC/deciphered/1455/G_1455_合13666正賓組.png`
- asset id: `asset-001307`
...
- English observation: `A narrow form has a small upper diamond loop, a long
  descending stem, and a short lower curve.`
- 中文观察: `狭长形体有小型上部菱形环、长下行笔干和短下部弧线。`
...
- dataset label text: `㦥`
- dataset label codepoints: `U+39A5`
...
- filename catalog route clues: `Heji-like filename clue: 合13666
  (G_1455_合13666正賓組.png)`
...
- Which source records identify obs-char-001302 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001302？
