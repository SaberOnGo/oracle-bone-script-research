# obs-char-000155 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000155`
- primary external id: `hust-obc-cat-0171`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/155_obs-char-000155_hust-obc-cat-0171_orac
  le-character/03_visual-assets/001_asset-000160_hust-obc-cat-0171_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0171/G_0171_甲3939(甲).png`
- asset id: `asset-000160`
...
- source category: `0171`
- validation class: `154`
- source image route: `HUST-OBC/deciphered/0171/G_0171_甲3939(甲).png`
- asset id: `asset-000160`
...
- English observation: `The narrow image has an angled upper stroke, a small
  triangular enclosure near the middle, and several fine strokes extending
  below it.`
- 中文观察: `狭长图像上方有折斜笔，中部附近有小型三角围合，下方延伸出数道细笔。`
...
- dataset label text: `㒡`
- dataset label codepoints: `U+34A1`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00014`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00014`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00014`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/014_obs-evo-can
  d-000014_evobc-cat-00014_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/014_obs-evo-cand-000014_evobc-cat-00014_evolu
...
- Which source records identify obs-char-000155 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000155？
