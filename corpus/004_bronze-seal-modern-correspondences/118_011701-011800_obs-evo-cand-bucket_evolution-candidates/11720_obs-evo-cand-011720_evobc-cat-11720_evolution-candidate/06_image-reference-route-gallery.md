...
- `obs-evo-cand-011720-route-category-staging`
...
- `obs-evo-cand-011720-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011720-route-evolution-graph`
