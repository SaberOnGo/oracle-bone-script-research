# obs-unk-002310 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002310`
- primary external id: `hust-obc-und-L-002310`
...
- local review image route: `corpus/001_oracle-characters/040_undeciphered-002
  301-002400_obs-unk-bucket_oracle-character-candidates/010_obs-unk-002310_h
  ust-obc-und-L-002310_oracle-character-candidate/03_visual-assets/001_asset
  -003903_hust-obc-und-L-002310_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2310/L_？_2998.jpg`
- asset id: `asset-003903`
...
- source class: `HUST-OBC/undeciphered/L/2310/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2310/L_？_2998.jpg`
- asset id: `asset-003903`
...
- Which source records identify obs-unk-002310 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002310？
