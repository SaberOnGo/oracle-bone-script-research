# obs-unk-004393 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004393`
- primary external id: `hust-obc-und-L-004393`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/093_obs-unk-004393_h
  ust-obc-und-L-004393_oracle-character-candidate/03_visual-assets/001_asset
  -005986_hust-obc-und-L-004393_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4393/L_？_9776.jpg`
- asset id: `asset-005986`
...
- source class: `HUST-OBC/undeciphered/L/4393/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4393/L_？_9776.jpg`
- asset id: `asset-005986`
...
- English observation: `A dense upper cluster descends toward two darker`
  `lower marks separated by a narrow gap.`
- 中文观察: `上部密集痕迹向下连接两处较深下部痕迹，中间有窄间隔。`
...
- Which source records identify obs-unk-004393 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004393？
