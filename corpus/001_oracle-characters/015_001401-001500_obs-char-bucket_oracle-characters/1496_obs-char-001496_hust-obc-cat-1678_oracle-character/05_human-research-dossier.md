# obs-char-001496 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1496_obs-char-001496_hust-obc-cat-1678_ora
  cle-character/03_visual-assets/001_asset-001501_hust-obc-cat-1678_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1678/G_1678_前6.46.2(甲).png`
- asset id: `asset-001501`
...
- source category: `1678`
- validation class: `1495`
- source image route: `HUST-OBC/deciphered/1678/G_1678_前6.46.2(甲).png`
- asset id: `asset-001501`
...
- English observation: `A narrow upper cluster leads into a long curved left
  stroke and side marks.`
- 中文观察: `狭长上部笔画群连接长左侧弧线和侧部短笔。`
...
- dataset label text: `㪄`
- dataset label codepoints: `U+3A84`
...
- Which source records identify obs-char-001496 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001496？
