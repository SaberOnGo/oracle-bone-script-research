# obs-unk-005507 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005507`
- primary external id: `hust-obc-und-X-005507`
...
- local review image route: `corpus/001_oracle-characters/072_undeciphered-005
  501-005600_obs-unk-bucket_oracle-character-candidates/007_obs-unk-005507_h
  ust-obc-und-X-005507_oracle-character-candidate/03_visual-assets/001_asset
  -007100_hust-obc-und-X-005507_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1063/X_？_8025_1.png`
- asset id: `asset-007100`
...
- source class: `HUST-OBC/undeciphered/X/1063/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1063/X_？_8025_1.png`
- asset id: `asset-007100`
...
- Which source records identify obs-unk-005507 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005507？
