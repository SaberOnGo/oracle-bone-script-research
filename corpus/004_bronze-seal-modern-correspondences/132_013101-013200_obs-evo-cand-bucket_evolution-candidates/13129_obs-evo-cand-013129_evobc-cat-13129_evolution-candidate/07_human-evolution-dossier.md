...
- External category reference: `evobc-cat-13129`
- Source category ID: `13129`
- Source label for human review: `𫸝`
- Source codepoints: `U+2BE1D`
...
- `obs-evo-cand-013129-route-category-staging`
...
- `obs-evo-cand-013129-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013129-route-evolution-graph`
