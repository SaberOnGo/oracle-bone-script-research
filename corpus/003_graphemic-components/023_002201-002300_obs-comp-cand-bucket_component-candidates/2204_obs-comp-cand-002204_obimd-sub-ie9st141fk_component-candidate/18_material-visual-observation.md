# Material Visual Observation / obs-comp-cand-002204 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002204`
- External reference / 外部参照: `obimd-sub-ie9st141fk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019988_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/55qv0winah/ie9st141fk/ie9st141fk.png`
- Checksum / 校验和:
  `926624fdb799d9e1a02634110a9390866339c9fec112f2e6904034537d81047f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.18%.
- Marked-pixel bounds: (84,43)–(165,202); span 82 × 160 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.18%。
- 痕迹范围：(84,43)–(165,202)；跨度82 × 160 px；痕迹矩形高于宽。
