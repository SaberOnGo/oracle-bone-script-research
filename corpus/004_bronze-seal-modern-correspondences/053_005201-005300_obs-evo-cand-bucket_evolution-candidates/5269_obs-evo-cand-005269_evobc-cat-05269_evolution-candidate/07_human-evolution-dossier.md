...
- External category reference: `evobc-cat-05269`
- Source category ID: `05269`
- Source label for human review: `狟`
- Source codepoints: `U+72DF`
...
- `obs-evo-cand-005269-route-category-staging`
...
- `obs-evo-cand-005269-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005269-route-evolution-graph`
