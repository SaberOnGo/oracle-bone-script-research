...
- External category reference: `evobc-cat-05122`
- Source category ID: `05122`
- Source label for human review: `熅`
- Source codepoints: `U+7185`
...
- `obs-evo-cand-005122-route-category-staging`
...
- `obs-evo-cand-005122-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005122-route-evolution-graph`
