# obs-char-000235 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000235`
- primary external id: `hust-obc-cat-0262`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/235_obs-char-000235_hust-obc-cat-0262_orac
  le-character/03_visual-assets/001_asset-000240_hust-obc-cat-0262_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0262/G_0262_京津2323合15199.png`
- asset id: `asset-000240`
...
- source category: `0262`
- validation class: `234`
- source image route: `HUST-OBC/deciphered/0262/G_0262_京津2323合15199.png`
- asset id: `asset-000240`
...
- English observation: `The image has a block-like angular outer contour and
  an inner open angular stroke; the right side is straighter than the left.`
- 中文观察: `图像有块状折角外轮廓和内部开放折角笔画；右侧比左侧更直。`
...
- dataset label text: `㓼`
- dataset label codepoints: `U+34FC`
...
- filename catalog route clues: `Heji-like filename clue: 合15199
  (G_0262_京津2323合15199.png)`
...
- Which source records identify obs-char-000235 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000235？
