...
- External category reference: `evobc-cat-02372`
- Source category ID: `02372`
- Source label for human review: `宖`
- Source codepoints: `U+5B96`
...
- `obs-evo-cand-002372-route-category-staging`
...
- `obs-evo-cand-002372-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002372-route-evolution-graph`
