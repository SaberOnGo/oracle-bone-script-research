# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006546
...
- EVOBC candidate category: `evobc-evo-cat-06546`.
- Source label for search only: `綝`.
- Source codepoints for search only: `U+7D9D`.
