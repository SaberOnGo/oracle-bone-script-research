...
Project ID: `obs-evo-cand-003798`
...
- Project ID: `obs-evo-cand-003798`
- EVOBC category candidate ID: `evobc-evo-cat-03798`
- External category reference: `evobc-cat-03798`
- Source category ID: `03798`
- Source label for human review: `曐`
- Source codepoints: `U+66D0`
...
- `obs-evo-cand-003798-route-category-staging`
...
- `obs-evo-cand-003798-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003798-route-evolution-graph`
