# obs-char-001342 Visual Gallery / obs-char-001342 图像资料页
...
- Project ID / 项目 ID: `obs-char-001342`
- Primary external reference / 首选外部参考: `hust-obc-cat-1498`
...
## obs-char-001342-visual-source-001 / 图像条目

![obs-char-001342 glyph candidate](03_visual-assets/001_asset-001347_hust-obc-cat-1498_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-001347_hust-obc-cat-1498_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-001347_hust-obc-cat-1498_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/1498/G_1498_甲骨文0.png`
