...
Project ID: `obs-insc-cw-cand-000364`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000364`
...
- Source page section: `Period II Group 15` /
  `第 II 期第 15 组`
- Source section key: `period-ii-group-15`
- Section declared count: `1`
- Section observed row count: `1`
...
- Yingguo / 英国所藏: `y2085` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `177` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `55` in source row; primary catalog entry pending
- Heji / 合集: `40374` in source row; primary catalog entry pending
...
- Group and batch / 组类与批次: group `15`; batch or pit context pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000364`
