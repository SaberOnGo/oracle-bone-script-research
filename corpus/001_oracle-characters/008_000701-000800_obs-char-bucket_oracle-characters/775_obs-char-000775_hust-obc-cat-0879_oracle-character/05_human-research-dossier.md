# obs-char-000775 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000775`
- primary external id: `hust-obc-cat-0879`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/775_obs-char-000775_hust-obc-cat-0879_orac
  le-character/03_visual-assets/001_asset-000780_hust-obc-cat-0879_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0879/G_0879_拾5.13(甲).png`
- asset id: `asset-000780`
...
- source category: `0879`
- validation class: `774`
- source image route: `HUST-OBC/deciphered/0879/G_0879_拾5.13(甲).png`
- asset id: `asset-000780`
...
- dataset label text: `㝥`
- dataset label codepoints: `U+3765`
...
- Which source records identify obs-char-000775 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000775？
