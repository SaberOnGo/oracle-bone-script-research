...
- `obs-evo-cand-006334-route-category-staging`
...
- `obs-evo-cand-006334-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006334-route-evolution-graph`
