# obs-char-001435 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1435_obs-char-001435_hust-obc-cat-1608_ora
  cle-character/03_visual-assets/001_asset-001440_hust-obc-cat-1608_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1608/G_1608_花191(甲).png`
- asset id: `asset-001440`
...
- source category: `1608`
- validation class: `1434`
- source image route: `HUST-OBC/deciphered/1608/G_1608_花191(甲).png`
- asset id: `asset-001440`
...
- English observation: `A compact composite has an upper loop, a central
  diamond, and a long stem.`
...
- dataset label text: `㨾`
- dataset label codepoints: `U+3A3E`
...
- Which source records identify obs-char-001435 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001435？
