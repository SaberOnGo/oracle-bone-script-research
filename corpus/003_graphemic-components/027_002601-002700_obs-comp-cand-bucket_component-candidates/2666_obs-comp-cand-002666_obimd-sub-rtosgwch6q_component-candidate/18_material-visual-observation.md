# Material Visual Observation / obs-comp-cand-002666 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002666`
- External reference / 外部参照: `obimd-sub-rtosgwch6q`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021242_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rtosgwch6q/rtosgwch6q/rtosgwch6q.png`
- Checksum / 校验和:
  `97985e0a5072f8d39bc77273fb0ef090725c0c1eafb91dde9ef907cbb6f84589`
...
- Marked-pixel bounds: (93,22)–(156,219); span 64 × 198 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.17%。
- 痕迹范围：(93,22)–(156,219)；跨度64 × 198 px；痕迹矩形高于宽。
