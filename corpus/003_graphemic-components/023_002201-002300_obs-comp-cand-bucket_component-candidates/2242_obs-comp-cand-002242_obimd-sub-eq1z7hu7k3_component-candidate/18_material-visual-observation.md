# Material Visual Observation / obs-comp-cand-002242 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002242`
- External reference / 外部参照: `obimd-sub-eq1z7hu7k3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020055_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/eq1z7hu7k3/eq1z7hu7k3/eq1z7hu7k3.png`
- Checksum / 校验和:
  `3671dda055b16f65c3b42365744e1b1a5940f724caccfbd8e7e8002dc793c80c`
...
- Marked-pixel bounds: (74,51)–(175,193); span 102 × 143 px; the marked
...
- 痕迹范围：(74,51)–(175,193)；跨度102 × 143 px；痕迹矩形高于宽。
