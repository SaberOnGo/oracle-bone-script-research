# Material Visual Observation / obs-comp-cand-002112 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002112`
- External reference / 外部参照: `obimd-sub-pieez9craa`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019610_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hftl4m18q0/pieez9craa/pieez9craa.png`
- Checksum / 校验和:
  `a003f8139684b64df53478f1d952d47371300b67b432f857a683854c73488df7`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.74%.
- Marked-pixel bounds: (64,29)–(185,219); span 122 × 191 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.74%。
- 痕迹范围：(64,29)–(185,219)；跨度122 × 191 px；痕迹矩形高于宽。
