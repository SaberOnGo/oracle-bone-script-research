...
- External category reference: `evobc-cat-06197`
- Source category ID: `06197`
- Source label: `竖`
...
- `obs-evo-cand-006197-route-category-staging`
...
- `obs-evo-cand-006197-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006197-route-evolution-graph`
