# Material Visual Observation / obs-comp-cand-001828 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001828`
- External reference / 外部参照: `obimd-sub-a5cuzpn70r`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018154_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/sywfwn7sg1/a5cuzpn70r/a5cuzpn70r.png`
- Checksum / 校验和:
  `be5d6d7e6d406cc251aad8b402d27d78ed49b089a0aa8a356f785cae2ce1a304`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.31%.
- Marked-pixel bounds: (28,31)–(222,210); span 195 × 180 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.31%。
- 痕迹范围：(28,31)–(222,210)；跨度195 × 180 px；痕迹矩形近方形。
