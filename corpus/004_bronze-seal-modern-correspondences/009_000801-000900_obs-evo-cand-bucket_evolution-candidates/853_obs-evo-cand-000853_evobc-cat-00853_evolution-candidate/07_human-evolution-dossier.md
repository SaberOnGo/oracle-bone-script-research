...
- External category reference: `evobc-cat-00853`
- Source category ID: `00853`
- Source label for human review: `供`
...
- `obs-evo-cand-000853-route-category-staging`
...
- `obs-evo-cand-000853-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000853-route-evolution-graph`
