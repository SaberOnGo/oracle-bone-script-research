# obs-evo-cand-003667 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-03667`
- Source label for human review: `旆`
- Source codepoints: `U+65C6`
- Image reference count: `24`
- Era token counts: `SS:1;WSC:23`
- Source token counts: `Book:6;Web:18`
