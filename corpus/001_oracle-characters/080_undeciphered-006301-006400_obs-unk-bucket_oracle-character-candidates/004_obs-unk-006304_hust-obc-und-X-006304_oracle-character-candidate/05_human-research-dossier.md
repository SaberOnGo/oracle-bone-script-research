# obs-unk-006304 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006304`
- primary external id: `hust-obc-und-X-006304`
...
- local review image route: `corpus/001_oracle-characters/080_undeciphered-006
  301-006400_obs-unk-bucket_oracle-character-candidates/004_obs-unk-006304_h
  ust-obc-und-X-006304_oracle-character-candidate/03_visual-assets/001_asset
  -007895_hust-obc-und-X-006304_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1860/X_？_5087_1.png`
- asset id: `asset-007895`
...
- source class: `HUST-OBC/undeciphered/X/1860/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1860/X_？_5087_1.png`
- asset id: `asset-007895`
...
- Which source records identify obs-unk-006304 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006304？
