# obs-char-001214 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1214_obs-char-001214_hust-obc-cat-1359_ora
  cle-character/03_visual-assets/001_asset-001219_hust-obc-cat-1359_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1359/G_1359_京津1630合17482.png`
- asset id: `asset-001219`
...
- source category: `1359`
- validation class: `1213`
- source image route: `HUST-OBC/deciphered/1359/G_1359_京津1630合17482.png`
- asset id: `asset-001219`
...
- English observation: `A small angular upper enclosure joins a central
  horizontal crossing and a long lower vertical stroke.`
- 中文观察: `小型折角上部框廓连接中央横向交叉和长下部竖笔。`
...
- dataset label text: `㥅`
- dataset label codepoints: `U+3945`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/123_obs-evo-can
  d-000123_evobc-cat-00123_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/123_obs-evo-cand-000123_evobc-cat-00123_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合17482
...
- Which source records identify obs-char-001214 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001214？
