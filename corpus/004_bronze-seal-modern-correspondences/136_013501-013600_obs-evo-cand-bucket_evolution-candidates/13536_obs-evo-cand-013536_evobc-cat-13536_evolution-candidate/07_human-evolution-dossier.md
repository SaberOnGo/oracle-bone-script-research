...
- External category reference: `evobc-cat-13536`
- Source category ID: `13536`
- Source label for human review: `𭣽`
- Source codepoints: `U+2D8FD`
...
- `obs-evo-cand-013536-route-category-staging`
...
- `obs-evo-cand-013536-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013536-route-evolution-graph`
