# obs-comp-cand-002713 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002713`
- 首选外部 ID: `obimd-sub-xq3vzel7mw`
- OBIMD subcharacter UID: `xq3vzel7mw`
- OBIMD main character UID: `xq3vzel7mw`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+FF4DD; U+FF4DE; 另有 2 项
