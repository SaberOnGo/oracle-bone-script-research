# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001602
...
- EVOBC candidate category: `evobc-evo-cat-01602`.
- Source label for search only: `唌`.
- Source codepoints for search only: `U+550C`.
