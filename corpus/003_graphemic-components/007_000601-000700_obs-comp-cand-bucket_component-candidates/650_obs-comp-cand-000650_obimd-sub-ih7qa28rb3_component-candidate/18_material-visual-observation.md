# Material Visual Observation / obs-comp-cand-000650 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000650`
- External reference / 外部参照: `obimd-sub-ih7qa28rb3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013213_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ih7qa28rb3/ih7qa28rb3/ih7qa28rb3.png`
- Checksum / 校验和:
  `116c1d8583d467e35f84f58ca202a869ef11a161b006e9a40b23c20a433410b5`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.42%.
- Marked-pixel bounds: (61,19)–(192,229); span 132 × 211 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.42%。
- 痕迹范围：(61,19)–(192,229)；跨度132 × 211 px；痕迹矩形高于宽。
