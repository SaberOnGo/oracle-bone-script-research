...
Project ID: `obs-evo-cand-001920`
...
- Project ID: `obs-evo-cand-001920`
- EVOBC category candidate ID: `evobc-evo-cat-01920`
- External category reference: `evobc-cat-01920`
- Source category ID: `01920`
- Source label for human review: `塗`
- Source codepoints: `U+5857`
...
- `obs-evo-cand-001920-route-category-staging`
...
- `obs-evo-cand-001920-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001920-route-evolution-graph`
