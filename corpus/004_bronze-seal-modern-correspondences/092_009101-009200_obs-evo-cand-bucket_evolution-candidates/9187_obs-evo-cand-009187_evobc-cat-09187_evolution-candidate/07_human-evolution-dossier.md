...
- External category reference: `evobc-cat-09187`
- Source category ID: `09187`
- Source label for human review: `鄐`
...
- `obs-evo-cand-009187-route-category-staging`
...
- `obs-evo-cand-009187-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009187-route-evolution-graph`
