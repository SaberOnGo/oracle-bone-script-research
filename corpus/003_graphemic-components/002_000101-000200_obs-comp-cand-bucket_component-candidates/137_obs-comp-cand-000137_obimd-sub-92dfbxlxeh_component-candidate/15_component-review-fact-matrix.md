# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000137
...
| Glyph or codepoint route / 字形或码位路线 | 2 OBIMD route rows; examples U+6C96;U+F0C9A; U+F0C9B | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
