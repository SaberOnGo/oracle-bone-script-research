# obs-unk-004505 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/005_obs-unk-004505_h
  ust-obc-und-X-004505_oracle-character-candidate/03_visual-assets/001_asset
  -006098_hust-obc-und-X-004505_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/61/X_？_8246_1.png`
- asset id: `asset-006098`
...
- source class: `HUST-OBC/undeciphered/X/61/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/61/X_？_8246_1.png`
- asset id: `asset-006098`
...
- English observation: `The three separate traces, their curves, and tapered
  lower ends are directly recorded.`
- 中文观察: `已直接记录三条分离长痕、各自弧度和变细的下端。`
...
- Which source records identify obs-unk-004505 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004505？
