# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008856
...
- EVOBC candidate category: `evobc-evo-cat-08856`.
- Source label for search only: `輹`.
- Source codepoints for search only: `U+8F39`.
