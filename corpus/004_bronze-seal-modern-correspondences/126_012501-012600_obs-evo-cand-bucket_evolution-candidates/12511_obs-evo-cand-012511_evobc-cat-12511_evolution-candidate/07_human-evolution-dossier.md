...
Project ID: `obs-evo-cand-012511`
...
- Project ID: `obs-evo-cand-012511`
- EVOBC category candidate ID: `evobc-evo-cat-12511`
- External category reference: `evobc-cat-12511`
- Source category ID: `12511`
- Source label for human review: `𨶅`
- Source codepoints: `U+28D85`
...
- `obs-evo-cand-012511-route-category-staging`
...
- `obs-evo-cand-012511-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012511-route-evolution-graph`
