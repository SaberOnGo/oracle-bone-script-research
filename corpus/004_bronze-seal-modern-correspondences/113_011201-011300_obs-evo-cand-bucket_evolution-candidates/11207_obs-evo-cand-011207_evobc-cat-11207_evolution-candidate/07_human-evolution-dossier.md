...
- External category reference: `evobc-cat-11207`
- Source category ID: `11207`
- Source label for human review: `𢔋`
...
- `obs-evo-cand-011207-route-category-staging`
...
- `obs-evo-cand-011207-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011207-route-evolution-graph`
