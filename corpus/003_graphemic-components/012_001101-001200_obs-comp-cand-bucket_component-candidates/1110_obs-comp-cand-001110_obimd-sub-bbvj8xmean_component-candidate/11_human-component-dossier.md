# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-001110
...
- candidate_component_id: `obs-comp-cand-001110`
- primary_external_ref_id: `obimd-sub-bbvj8xmean`
- source_subcharacter_uid: `bbvj8xmean`
...
- glyph_codepoint_uplus_sample: `U+F665B, U+F665C, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-015051` | `001_asset-015051_img.png` | `416fbaaf2c897ce03ebdd03adcc0909a522ff81b221481365296f0e39539a82c` |
