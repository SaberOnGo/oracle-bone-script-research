...
- External category reference: `evobc-cat-02240`
- Source category ID: `02240`
- Source label for human review: `媦`
...
- `obs-evo-cand-002240-route-category-staging`
...
- `obs-evo-cand-002240-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002240-route-evolution-graph`
