# Material Visual Observation / obs-comp-cand-002689 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002689`
- External reference / 外部参照: `obimd-sub-e658trpvpa`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021265_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/e658trpvpa/e658trpvpa/e658trpvpa.png`
- Checksum / 校验和:
  `7e47ba9892e5dd8e4760ee603e1d68f3c7363355bd9a0b9da551fa399558f524`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.21%.
- Marked-pixel bounds: (99,17)–(156,225); span 58 × 209 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.21%。
- 痕迹范围：(99,17)–(156,225)；跨度58 × 209 px；痕迹矩形高于宽。
