...
Project ID: `obs-evo-cand-011597`
...
- Project ID: `obs-evo-cand-011597`
- EVOBC category candidate ID: `evobc-evo-cat-11597`
- External category reference: `evobc-cat-11597`
- Source category ID: `11597`
- Source label for human review: `𤚆`
- Source codepoints: `U+24686`
...
- `obs-evo-cand-011597-route-category-staging`
...
- `obs-evo-cand-011597-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011597-route-evolution-graph`
