# obs-unk-004552 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/052_obs-unk-004552_h
  ust-obc-und-X-004552_oracle-character-candidate/03_visual-assets/001_asset
  -006145_hust-obc-und-X-004552_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/108/X_？_8290_1.png`
- asset id: `asset-006145`
...
- source class: `HUST-OBC/undeciphered/X/108/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/108/X_？_8290_1.png`
- asset id: `asset-006145`
...
- English observation: `Upper outline, diagonal trace, and strokes recorded.`
- 中文观察: `已记录上部轮廓、斜痕和下部长痕。`
...
- Which source records identify obs-unk-004552 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004552？
