# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002631
...
- EVOBC candidate category: `evobc-evo-cat-02631`.
- Source label for search only: `巺`.
- Source codepoints for search only: `U+5DFA`.
