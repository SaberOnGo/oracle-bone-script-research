...
Project ID: `obs-evo-cand-002539`
...
- Project ID: `obs-evo-cand-002539`
- EVOBC category candidate ID: `evobc-evo-cat-02539`
- External category reference: `evobc-cat-02539`
- Source category ID: `02539`
- Source label for human review: `岡`
- Source codepoints: `U+5CA1`
...
- `obs-evo-cand-002539-route-category-staging`
...
- `obs-evo-cand-002539-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002539-route-evolution-graph`
