# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002657
...
| --- | --- | --- | --- |
| `obimd-glyph-link-040341` | 󿭓 | `U+FFB53` | `reviewed_metadata_only` |
| `obimd-glyph-link-040342` | 󾾍 | `U+FEF8D` | `reviewed_metadata_only` |
