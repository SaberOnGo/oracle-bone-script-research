...
Project ID: `obs-evo-cand-012828`
...
- Project ID: `obs-evo-cand-012828`
- EVOBC category candidate ID: `evobc-evo-cat-12828`
- External category reference: `evobc-cat-12828`
- Source category ID: `12828`
- Source label for human review: `𪧫`
- Source codepoints: `U+2A9EB`
- Image reference count in source metadata: `0`
...
- `obs-evo-cand-012828-route-category-staging`
...
- `obs-evo-cand-012828-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012828-route-evolution-graph`
