...
Project ID: `obs-evo-cand-007454`
...
- Project ID: `obs-evo-cand-007454`
- EVOBC category candidate ID: `evobc-evo-cat-07454`
- External category reference: `evobc-cat-07454`
- Source category ID: `07454`
- Source label for human review: `萱`
- Source codepoints: `U+8431`
...
- `obs-evo-cand-007454-route-category-staging`
...
- `obs-evo-cand-007454-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007454-route-evolution-graph`
