# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012961
...
- EVOBC candidate category: `evobc-evo-cat-12961`.
- Source label for search only: `𫒿`.
- Source codepoints for search only: `U+2B4BF`.
