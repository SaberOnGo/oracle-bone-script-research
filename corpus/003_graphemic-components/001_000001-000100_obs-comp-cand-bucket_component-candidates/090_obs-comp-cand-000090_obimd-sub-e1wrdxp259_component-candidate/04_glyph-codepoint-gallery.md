# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000090
...
| --- | --- | --- | --- |
| `obimd-glyph-link-001479` | 򴯚󰣕 | `U+B4BDA;U+F08D5` | `reviewed_metadata_only` |
| `obimd-glyph-link-001480` | 󰣖 | `U+F08D6` | `reviewed_metadata_only` |
