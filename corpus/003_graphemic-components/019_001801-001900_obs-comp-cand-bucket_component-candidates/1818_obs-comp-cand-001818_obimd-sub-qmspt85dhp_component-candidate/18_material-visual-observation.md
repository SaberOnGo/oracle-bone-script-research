# Material Visual Observation / obs-comp-cand-001818 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001818`
- External reference / 外部参照: `obimd-sub-qmspt85dhp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018039_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qmspt85dhp/qmspt85dhp/03ewn7k71x.png`
- Checksum / 校验和:
  `af80923887d03194215df45aa1464a0f764c35b36e0d2e74132f6a524367879d`
...
- Marked-pixel bounds: (66,36)–(183,201); span 118 × 166 px; the marked
...
- 痕迹范围：(66,36)–(183,201)；跨度118 × 166 px；痕迹矩形高于宽。
