# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006150
...
- EVOBC candidate category: `evobc-evo-cat-06150`.
- Source label for search only: `穼`.
- Source codepoints for search only: `U+7A7C`.
