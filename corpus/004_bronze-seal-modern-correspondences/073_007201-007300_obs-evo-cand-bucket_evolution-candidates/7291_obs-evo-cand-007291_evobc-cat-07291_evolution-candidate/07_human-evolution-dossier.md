...
- Project ID: `obs-evo-cand-007291`
- EVOBC category candidate ID: `evobc-evo-cat-07291`
- External category reference: `evobc-cat-07291`
- Source category ID: `07291`
- Source label for human review: `苳`
- Source codepoints: `U+82F3`
...
- `obs-evo-cand-007291-route-category-staging`
...
- `obs-evo-cand-007291-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007291-route-evolution-graph`
