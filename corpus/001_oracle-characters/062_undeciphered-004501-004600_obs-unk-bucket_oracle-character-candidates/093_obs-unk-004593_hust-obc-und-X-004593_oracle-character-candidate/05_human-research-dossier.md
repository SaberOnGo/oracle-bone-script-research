# obs-unk-004593 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/093_obs-unk-004593_h
  ust-obc-und-X-004593_oracle-character-candidate/03_visual-assets/001_asset
  -006186_hust-obc-und-X-004593_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/149/X_？_8326_1.png`
- asset id: `asset-006186`
...
- source class: `HUST-OBC/undeciphered/X/149/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/149/X_？_8326_1.png`
- asset id: `asset-006186`
...
- English observation: `Curved outer contour, central mass, opening, and`
  `point recorded.`
- 中文观察: `已记录弧形外轮廓、中央块状痕、开口和尖端。`
...
- Which source records identify obs-unk-004593 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004593？
