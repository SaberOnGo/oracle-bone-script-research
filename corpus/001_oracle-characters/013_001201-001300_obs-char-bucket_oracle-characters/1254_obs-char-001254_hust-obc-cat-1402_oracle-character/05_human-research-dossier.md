# obs-char-001254 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001254`
- primary external id: `hust-obc-cat-1402`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1254_obs-char-001254_hust-obc-cat-1402_ora
  cle-character/03_visual-assets/001_asset-001259_hust-obc-cat-1402_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1402/G_1402_七S30合13760.png`
- asset id: `asset-001259`
...
- source category: `1402`
- validation class: `1253`
- source image route: `HUST-OBC/deciphered/1402/G_1402_七S30合13760.png`
- asset id: `asset-001259`
...
- English observation: `A thin descending stroke leads to a small pointed
  enclosure near the bottom and a short trailing curve.`
- 中文观察: `细长下行笔画通向近底部的小型尖状框形，并带有短拖尾弧线。`
...
- dataset label text: `㥰`
- dataset label codepoints: `U+3970`
...
- filename catalog route clues: `Heji-like filename clue: 合13760
  (G_1402_七S30合13760.png)`
...
- Which source records identify obs-char-001254 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001254？
