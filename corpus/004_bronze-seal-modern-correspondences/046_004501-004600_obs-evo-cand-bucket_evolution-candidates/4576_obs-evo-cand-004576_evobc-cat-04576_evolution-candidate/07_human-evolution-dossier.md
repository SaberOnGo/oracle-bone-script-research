...
Project ID: `obs-evo-cand-004576`
...
- Project ID: `obs-evo-cand-004576`
- EVOBC category candidate ID: `evobc-evo-cat-04576`
- External category reference: `evobc-cat-04576`
- Source category ID: `04576`
- Source label for human review: `泏`
- Source codepoints: `U+6CCF`
...
- `obs-evo-cand-004576-route-category-staging`
...
- `obs-evo-cand-004576-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004576-route-evolution-graph`
