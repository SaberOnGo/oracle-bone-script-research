...
Project ID: `obs-evo-cand-002875`
...
- Project ID: `obs-evo-cand-002875`
- EVOBC category candidate ID: `evobc-evo-cat-02875`
- External category reference: `evobc-cat-02875`
- Source category ID: `02875`
- Source label for human review: `徝`
- Source codepoints: `U+5F9D`
...
- `obs-evo-cand-002875-route-category-staging`
...
- `obs-evo-cand-002875-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002875-route-evolution-graph`
