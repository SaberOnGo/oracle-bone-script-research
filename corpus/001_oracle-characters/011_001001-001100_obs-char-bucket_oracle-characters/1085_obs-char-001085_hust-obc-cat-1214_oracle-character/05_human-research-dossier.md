# obs-char-001085 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001085`
- primary external id: `hust-obc-cat-1214`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1085_obs-char-001085_hust-obc-cat-1214_ora
  cle-character/03_visual-assets/001_asset-001090_hust-obc-cat-1214_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1214/X_1214_2247_1.png`
- asset id: `asset-001090`
...
- source category: `1214`
- validation class: `1084`
- source image route: `HUST-OBC/deciphered/1214/X_1214_2247_1.png`
- asset id: `asset-001090`
...
- English observation: `A tall stacked form has a rounded upper enclosure, a
  central horizontal band, and a pointed lower section.`
- 中文观察: `高而叠置的形体有圆弧上部闭合轮廓、中央水平带和尖状下部部分。`
...
- dataset label text: `㢴`
- dataset label codepoints: `U+38B4`
...
- Which source records identify obs-char-001085 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001085？
