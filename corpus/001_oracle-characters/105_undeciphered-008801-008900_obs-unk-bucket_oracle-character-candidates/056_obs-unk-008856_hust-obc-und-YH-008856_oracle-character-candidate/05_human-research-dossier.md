# obs-unk-008856 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008856`
- primary external id: `hust-obc-und-YH-008856`
...
- local review image route: `corpus/001_oracle-characters/105_undeciphered-008
  801-008900_obs-unk-bucket_oracle-character-candidates/056_obs-unk-008856_h
  ust-obc-und-YH-008856_oracle-character-candidate/03_visual-assets/001_asse
  t-010447_hust-obc-und-YH-008856_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60EA0/H_？_60EA0_0.png`
- asset id: `asset-010447`
...
- source class: `HUST-OBC/undeciphered/Y+H/60EA0/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60EA0/H_？_60EA0_0.png`
- asset id: `asset-010447`
...
- Which source records identify obs-unk-008856 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008856？
