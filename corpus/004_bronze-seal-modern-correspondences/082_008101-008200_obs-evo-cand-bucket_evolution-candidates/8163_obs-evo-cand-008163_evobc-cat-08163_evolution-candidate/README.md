# obs-evo-cand-008163 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-008163`
- EVOBC category candidate ID: `evobc-evo-cat-08163`
- External category ref: `evobc-cat-08163`
- Source label: `訾`
- Source codepoints: `U+8A3E`
- Image reference count: `14`
- Era token counts: `SS:1;WSC:13`
- Source token counts: `Book:11;Web:3`
