...
- `obs-evo-cand-008550-route-category-staging`
...
- `obs-evo-cand-008550-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008550-route-evolution-graph`
