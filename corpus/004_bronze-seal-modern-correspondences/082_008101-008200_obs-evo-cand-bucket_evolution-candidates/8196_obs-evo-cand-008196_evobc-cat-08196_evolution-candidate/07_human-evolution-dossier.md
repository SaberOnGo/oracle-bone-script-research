...
Project ID: `obs-evo-cand-008196`
...
- Project ID: `obs-evo-cand-008196`
- EVOBC category candidate ID: `evobc-evo-cat-08196`
- External category reference: `evobc-cat-08196`
- Source category ID: `08196`
- Source label for human review: `詭`
- Source codepoints: `U+8A6D`
...
- `obs-evo-cand-008196-route-category-staging`
...
- `obs-evo-cand-008196-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008196-route-evolution-graph`
