...
- External category reference: `evobc-cat-09393`
- Source category ID: `09393`
- Source label for human review: `銧`
...
- `obs-evo-cand-009393-route-category-staging`
...
- `obs-evo-cand-009393-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009393-route-evolution-graph`
