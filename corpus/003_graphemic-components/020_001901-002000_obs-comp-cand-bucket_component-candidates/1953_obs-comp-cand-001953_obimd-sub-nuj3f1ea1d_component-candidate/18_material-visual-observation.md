# Material Visual Observation / obs-comp-cand-001953 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001953`
- External reference / 外部参照: `obimd-sub-nuj3f1ea1d`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018763_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/nuj3f1ea1d/nuj3f1ea1d/nuj3f1ea1d.png`
- Checksum / 校验和:
  `dd225c60e2517e6add8f4a99ce65bc0ace23d5b64a4699a79f1133dabece491b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.06%.
- Marked-pixel bounds: (58,30)–(164,216); span 107 × 187 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.06%。
- 痕迹范围：(58,30)–(164,216)；跨度107 × 187 px；痕迹矩形高于宽。
