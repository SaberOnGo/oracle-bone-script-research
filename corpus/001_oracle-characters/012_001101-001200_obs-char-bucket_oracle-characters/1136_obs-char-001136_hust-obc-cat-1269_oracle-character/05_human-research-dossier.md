# obs-char-001136 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001136`
- primary external id: `hust-obc-cat-1269`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1136_obs-char-001136_hust-obc-cat-1269_ora
  cle-character/03_visual-assets/001_asset-001141_hust-obc-cat-1269_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1269/G_1269_乙8896(甲).png`
- asset id: `asset-001141`
...
- source category: `1269`
- validation class: `1135`
- source image route: `HUST-OBC/deciphered/1269/G_1269_乙8896(甲).png`
- asset id: `asset-001141`
...
- English observation: `A faint slender form has a small upper fork, a
  rounded central turn, and long lower side strokes; contrast is low.`
- 中文观察: `较淡纤细形体有小型上部分叉、圆弧中央转笔和长下部侧笔；对比度较低。`
...
- dataset label text: `㣫`
- dataset label codepoints: `U+38EB`
...
- Which source records identify obs-char-001136 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001136？
