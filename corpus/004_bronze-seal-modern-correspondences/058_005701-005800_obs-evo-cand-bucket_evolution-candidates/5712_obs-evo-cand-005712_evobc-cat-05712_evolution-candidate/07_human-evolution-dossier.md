...
- External category reference: `evobc-cat-05712`
- Source category ID: `05712`
...
- `obs-evo-cand-005712-route-category-staging`
...
- `obs-evo-cand-005712-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005712-route-evolution-graph`
