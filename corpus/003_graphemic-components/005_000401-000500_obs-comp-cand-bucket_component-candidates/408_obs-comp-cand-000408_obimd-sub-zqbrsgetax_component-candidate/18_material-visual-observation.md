# Material Visual Observation / obs-comp-cand-000408 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000408`
- External reference / 外部参照: `obimd-sub-zqbrsgetax`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012331_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ls6u8dscwp/zqbrsgetax/zqbrsgetax.png`
- Checksum / 校验和:
  `fde70df15eb7c5c7750c0a39644648b0eab68512bc431c6de1c0770ddb87c5a9`
...
- Marked-pixel bounds: (67,32)–(182,213); span 116 × 182 px; the marked
...
- 痕迹范围：(67,32)–(182,213)；跨度116 × 182 px；痕迹矩形高于宽。
