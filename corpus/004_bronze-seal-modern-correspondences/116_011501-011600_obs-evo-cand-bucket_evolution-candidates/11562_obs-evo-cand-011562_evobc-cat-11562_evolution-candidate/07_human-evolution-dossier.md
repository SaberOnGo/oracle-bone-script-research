...
- Project ID: `obs-evo-cand-011562`
- EVOBC category candidate ID: `evobc-evo-cat-11562`
- External category reference: `evobc-cat-11562`
- Source category ID: `11562`
- Source label for human review: `𤊗`
- Source codepoints: `U+24297`
...
- `obs-evo-cand-011562-route-category-staging`
...
- `obs-evo-cand-011562-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011562-route-evolution-graph`
