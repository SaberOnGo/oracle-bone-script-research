# Material Visual Observation / obs-comp-cand-000626 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000626`
- External reference / 外部参照: `obimd-sub-e165xleaqt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013189_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/e165xleaqt/e165xleaqt/e165xleaqt.png`
- Checksum / 校验和:
  `c418b92b55a3ad2f55133a5f56345c81329bd01a036462578c57abc6ab8d4b2a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.53%.
- Marked-pixel bounds: (80,36)–(169,215); span 90 × 180 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.53%。
- 痕迹范围：(80,36)–(169,215)；跨度90 × 180 px；痕迹矩形高于宽。
