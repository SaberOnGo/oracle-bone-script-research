...
- External category reference: `evobc-cat-03698`
- Source category ID: `03698`
- Source label for human review: `旻`
...
- `obs-evo-cand-003698-route-category-staging`
...
- `obs-evo-cand-003698-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003698-route-evolution-graph`
