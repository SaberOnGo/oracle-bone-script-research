# obs-char-001263 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1263_obs-char-001263_hust-obc-cat-1412_ora
  cle-character/03_visual-assets/001_asset-001268_hust-obc-cat-1412_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1412/G_1412_甲骨文0.png`
- asset id: `asset-001268`
...
- source category: `1412`
- validation class: `1262`
- source image route: `HUST-OBC/deciphered/1412/G_1412_甲骨文0.png`
- asset id: `asset-001268`
...
- English observation: `The image contains several separated narrow
  branching clusters arranged across the vertical field.`
- 中文观察: `图像中有数个彼此分离的狭长分枝笔画群，分布在纵向画面中。`
...
- dataset label text: `㥺`
- dataset label codepoints: `U+397A`
...
- Which source records identify obs-char-001263 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001263？
