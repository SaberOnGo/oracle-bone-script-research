# obs-char-000733 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000733`
- primary external id: `hust-obc-cat-0834`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/733_obs-char-000733_hust-obc-cat-0834_orac
  le-character/03_visual-assets/001_asset-000738_hust-obc-cat-0834_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0834/G_0834_乙1781合21905子組.png`
- asset id: `asset-000738`
...
- source category: `0834`
- validation class: `732`
- source image route: `HUST-OBC/deciphered/0834/G_0834_乙1781合21905子組.png`
- asset id: `asset-000738`
...
- English observation: `Two detached vertical forms stand side by side: the
  larger left form has curved upper and forked lower branches, while the
  slimmer right form bends into a long descending leg.`
- 中文观察: `两个分离竖形并列：较大左形有弯曲上枝和分叉下枝，较细右形折转后形成长下垂笔。`
...
- dataset label text: `㜸`
- dataset label codepoints: `U+3738`
...
- filename catalog route clues: `Heji-like filename clue: 合21905
  (G_0834_乙1781合21905子組.png)`
...
- Which source records identify obs-char-000733 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000733？
