# obs-char-001579 Visual Gallery / obs-char-001579 图像资料页
...
- Project ID / 项目 ID: `obs-char-001579`
- Primary external reference / 首选外部参考: `hust-obc-cat-1771`
...
## obs-char-001579-visual-source-001 / 图像条目

![obs-char-001579 glyph candidate](03_visual-assets/001_asset-001584_hust-obc-cat-1771_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-001584_hust-obc-cat-1771_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-001584_hust-obc-cat-1771_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/1771/X_1771_4501_1.png`
