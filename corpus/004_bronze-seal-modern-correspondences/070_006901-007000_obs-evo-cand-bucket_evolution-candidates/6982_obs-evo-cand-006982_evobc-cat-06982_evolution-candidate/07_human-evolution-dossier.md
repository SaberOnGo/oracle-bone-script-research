...
- Project ID: `obs-evo-cand-006982`
- EVOBC category candidate ID: `evobc-evo-cat-06982`
- External category reference: `evobc-cat-06982`
- Source category ID: `06982`
- Source label for human review: `肒`
- Source codepoints: `U+8092`
...
- `obs-evo-cand-006982-route-category-staging`
...
- `obs-evo-cand-006982-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006982-route-evolution-graph`
