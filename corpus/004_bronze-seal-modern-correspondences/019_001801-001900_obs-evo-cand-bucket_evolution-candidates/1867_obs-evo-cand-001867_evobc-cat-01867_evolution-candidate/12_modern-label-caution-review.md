# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001867
...
- EVOBC candidate category: `evobc-evo-cat-01867`.
- Source label for search only: `垽`.
- Source codepoints for search only: `U+57BD`.
