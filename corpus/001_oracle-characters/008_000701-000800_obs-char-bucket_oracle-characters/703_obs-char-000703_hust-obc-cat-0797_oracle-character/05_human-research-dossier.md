# obs-char-000703 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/703_obs-char-000703_hust-obc-cat-0797_orac
  le-character/03_visual-assets/001_asset-000708_hust-obc-cat-0797_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0797/X_0797_3208_1.png`
- asset id: `asset-000708`
...
- source category: `0797`
- validation class: `702`
- source image route: `HUST-OBC/deciphered/0797/X_0797_3208_1.png`
- asset id: `asset-000708`
...
- English observation: `Three bold rounded forms are stacked: a wide upper
  arch divided by a horizontal bar, a small central square loop, and a broad
  curved lower basin with a white opening.`
- 中文观察: `三个粗重圆弯形上下层叠：带横隔的宽上拱、小中央方环和带白色空隙的宽弯下槽。`
...
- dataset label text: `㜓`
- dataset label codepoints: `U+3713`
...
- Which source records identify obs-char-000703 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000703？
