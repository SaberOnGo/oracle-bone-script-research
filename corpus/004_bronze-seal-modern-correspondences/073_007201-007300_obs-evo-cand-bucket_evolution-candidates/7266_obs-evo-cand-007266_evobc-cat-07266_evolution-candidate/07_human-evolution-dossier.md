...
- External category reference: `evobc-cat-07266`
- Source category ID: `07266`
- Source label for human review: `芺`
- Source codepoints: `U+82BA`
...
- `obs-evo-cand-007266-route-category-staging`
...
- `obs-evo-cand-007266-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007266-route-evolution-graph`
