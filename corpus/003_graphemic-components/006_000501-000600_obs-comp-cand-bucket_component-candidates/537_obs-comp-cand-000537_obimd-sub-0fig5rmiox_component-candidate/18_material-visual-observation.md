# Material Visual Observation / obs-comp-cand-000537 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000537`
- External reference / 外部参照: `obimd-sub-0fig5rmiox`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012771_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0fig5rmiox/0fig5rmiox/0fig5rmiox.png`
- Checksum / 校验和:
  `56d3bb0cea5890a94c3235fc1f1607710e2a0ec1c3107e9a17115cfe4ee8eddb`
...
- Marked-pixel bounds: (53,41)–(196,208); span 144 × 168 px; the marked
...
- 痕迹范围：(53,41)–(196,208)；跨度144 × 168 px；痕迹矩形近方形。
