...
- External category reference: `evobc-cat-03782`
- Source category ID: `03782`
- Source label for human review: `暤`
...
- `obs-evo-cand-003782-route-category-staging`
...
- `obs-evo-cand-003782-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003782-route-evolution-graph`
