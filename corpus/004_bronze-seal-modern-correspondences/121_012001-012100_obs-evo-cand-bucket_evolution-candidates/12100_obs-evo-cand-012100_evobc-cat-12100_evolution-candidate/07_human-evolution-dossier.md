...
- External category reference: `evobc-cat-12100`
- Source category ID: `12100`
- Source label for human review: `𦱬`
- Source codepoints: `U+26C6C`
...
- `obs-evo-cand-012100-route-category-staging`
...
- `obs-evo-cand-012100-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012100-route-evolution-graph`
