# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013708
...
- EVOBC candidate category: `evobc-evo-cat-13708`.
- Source label for search only: `寮`.
- Source codepoints for search only: `U+F9BC`.
