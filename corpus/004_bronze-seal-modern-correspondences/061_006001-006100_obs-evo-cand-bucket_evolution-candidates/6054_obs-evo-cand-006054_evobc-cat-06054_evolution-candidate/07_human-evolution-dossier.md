...
- External category reference: `evobc-cat-06054`
- Source category ID: `06054`
- Source label for human review: `秆`
- Source codepoints: `U+79C6`
...
- `obs-evo-cand-006054-route-category-staging`
...
- `obs-evo-cand-006054-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006054-route-evolution-graph`
