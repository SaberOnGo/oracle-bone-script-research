# Material Visual Observation / obs-comp-cand-001682 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001682`
- External reference / 外部参照: `obimd-sub-dljr7e3ubv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017598_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dljr7e3ubv/dljr7e3ubv/dljr7e3ubv.png`
- Checksum / 校验和:
  `83bfb78261e32df82243e9520645855726c8f238075e697389d811572e715a0e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.15%.
- Marked-pixel bounds: (71,52)–(184,192); span 114 × 141 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.15%。
- 痕迹范围：(71,52)–(184,192)；跨度114 × 141 px；痕迹矩形高于宽。
