...
- External category reference: `evobc-cat-07327`
- Source category ID: `07327`
- Source label for human review: `茲`
- Source codepoints: `U+8332`
- Image reference count in source metadata: `120`
...
- `obs-evo-cand-007327-route-category-staging`
...
- `obs-evo-cand-007327-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007327-route-evolution-graph`
