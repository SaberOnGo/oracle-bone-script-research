...
- External category reference: `evobc-cat-08054`
- Source category ID: `08054`
- Source label for human review: `覊`
...
- `obs-evo-cand-008054-route-category-staging`
...
- `obs-evo-cand-008054-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008054-route-evolution-graph`
