...
Project ID: `obs-evo-cand-007938`
...
- Project ID: `obs-evo-cand-007938`
- EVOBC category candidate ID: `evobc-evo-cat-07938`
- External category reference: `evobc-cat-07938`
- Source category ID: `07938`
- Source label for human review: `袄`
- Source codepoints: `U+8884`
...
- `obs-evo-cand-007938-route-category-staging`
...
- `obs-evo-cand-007938-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007938-route-evolution-graph`
