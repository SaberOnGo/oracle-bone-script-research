# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002613
...
| Glyph or codepoint route / 字形或码位路线 | 7 OBIMD route rows; examples U+FEBCA; U+FEBCB; 另有 5 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
