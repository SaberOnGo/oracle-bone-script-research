# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002538
...
- EVOBC candidate category: `evobc-evo-cat-02538`.
- Source label for search only: `岛`.
- Source codepoints for search only: `U+5C9B`.
