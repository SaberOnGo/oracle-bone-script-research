...
- External category reference: `evobc-cat-03280`
- Source category ID: `03280`
- Source label for human review: `抔`
- Source codepoints: `U+6294`
...
- `obs-evo-cand-003280-route-category-staging`
...
- `obs-evo-cand-003280-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003280-route-evolution-graph`
