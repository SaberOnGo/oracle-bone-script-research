...
Project ID: `obs-evo-cand-005252`
...
- Project ID: `obs-evo-cand-005252`
- EVOBC category candidate ID: `evobc-evo-cat-05252`
- External category reference: `evobc-cat-05252`
- Source category ID: `05252`
- Source label for human review: `犹`
- Source codepoints: `U+72B9`
...
- `obs-evo-cand-005252-route-category-staging`
...
- `obs-evo-cand-005252-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005252-route-evolution-graph`
