...
- External category reference: `evobc-cat-08032`
- Source category ID: `08032`
- Source label for human review: `襖`
...
- `obs-evo-cand-008032-route-category-staging`
...
- `obs-evo-cand-008032-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008032-route-evolution-graph`
