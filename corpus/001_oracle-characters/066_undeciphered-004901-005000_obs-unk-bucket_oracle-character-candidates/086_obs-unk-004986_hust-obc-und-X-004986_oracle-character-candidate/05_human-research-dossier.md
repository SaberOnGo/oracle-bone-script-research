# obs-unk-004986 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004986`
- primary external id: `hust-obc-und-X-004986`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/086_obs-unk-004986_h
  ust-obc-und-X-004986_oracle-character-candidate/03_visual-assets/001_asset
  -006579_hust-obc-und-X-004986_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/542/X_？_7522_1.png`
- asset id: `asset-006579`
...
- source class: `HUST-OBC/undeciphered/X/542/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/542/X_？_7522_1.png`
- asset id: `asset-006579`
...
- Which source records identify obs-unk-004986 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004986？
