# obs-unk-008555 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/102_undeciphered-008
  501-008600_obs-unk-bucket_oracle-character-candidates/055_obs-unk-008555_h
  ust-obc-und-YH-008555_oracle-character-candidate/03_visual-assets/001_asse
  t-010146_hust-obc-und-YH-008555_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60BF0/Y_？_60BF0.jpg`
- asset id: `asset-010146`
...
- source class: `HUST-OBC/undeciphered/Y+H/60BF0/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60BF0/Y_？_60BF0.jpg`
- asset id: `asset-010146`
...
- Which source records identify obs-unk-008555 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008555？
