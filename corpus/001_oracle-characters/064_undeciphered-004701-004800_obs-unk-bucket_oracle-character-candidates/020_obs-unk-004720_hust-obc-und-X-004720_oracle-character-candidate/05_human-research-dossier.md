# obs-unk-004720 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004720`
- primary external id: `hust-obc-und-X-004720`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/020_obs-unk-004720_h
  ust-obc-und-X-004720_oracle-character-candidate/03_visual-assets/001_asset
  -006313_hust-obc-und-X-004720_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/276/X_？_7249_1.png`
- asset id: `asset-006313`
...
- source class: `HUST-OBC/undeciphered/X/276/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/276/X_？_7249_1.png`
- asset id: `asset-006313`
- source image count: `16`
...
- English observation: `dense upper projections with broad central body`
- 中文观察: `带宽大中央主体的密集上部突出笔画`
...
- Which source records identify obs-unk-004720 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004720？
