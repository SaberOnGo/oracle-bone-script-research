...
- External category reference: `evobc-cat-01333`
- Source category ID: `01333`
- Source label: `匏`
...
- `obs-evo-cand-001333-route-category-staging`
...
- `obs-evo-cand-001333-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001333-route-evolution-graph`
