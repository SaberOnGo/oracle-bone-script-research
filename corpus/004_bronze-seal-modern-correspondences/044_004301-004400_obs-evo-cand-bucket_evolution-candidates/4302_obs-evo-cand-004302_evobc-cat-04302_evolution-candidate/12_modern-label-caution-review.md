# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004302
...
- EVOBC candidate category: `evobc-evo-cat-04302`.
- Source label for search only: `檼`.
- Source codepoints for search only: `U+6ABC`.
