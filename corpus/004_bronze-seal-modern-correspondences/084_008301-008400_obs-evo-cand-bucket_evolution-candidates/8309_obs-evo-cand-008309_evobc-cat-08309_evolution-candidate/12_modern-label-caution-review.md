# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008309
...
- EVOBC candidate category: `evobc-evo-cat-08309`.
- Source label for search only: `謏`.
- Source codepoints for search only: `U+8B0F`.
