# obs-unk-004745 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/045_obs-unk-004745_h
  ust-obc-und-X-004745_oracle-character-candidate/03_visual-assets/001_asset
  -006338_hust-obc-und-X-004745_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/301/X_？_7287_1.png`
- asset id: `asset-006338`
...
- source class: `HUST-OBC/undeciphered/X/301/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/301/X_？_7287_1.png`
- asset id: `asset-006338`
...
- English observation: `dense branching group with dotted right region`
- 中文观察: `带右侧点状区域的密集分支组`
...
- Which source records identify obs-unk-004745 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004745？
