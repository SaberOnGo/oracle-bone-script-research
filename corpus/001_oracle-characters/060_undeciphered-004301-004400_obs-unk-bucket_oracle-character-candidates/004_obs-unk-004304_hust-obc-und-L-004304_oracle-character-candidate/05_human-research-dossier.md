# obs-unk-004304 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004304`
- primary external id: `hust-obc-und-L-004304`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/004_obs-unk-004304_h
  ust-obc-und-L-004304_oracle-character-candidate/03_visual-assets/001_asset
  -005897_hust-obc-und-L-004304_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4304/L_？_9499.jpg`
- asset id: `asset-005897`
...
- source class: `HUST-OBC/undeciphered/L/4304/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4304/L_？_9499.jpg`
- asset id: `asset-005897`
...
- English observation: `Upper outline, central line, lower bars visible.`
- 中文观察: `上部轮廓、中央线和下部横痕可见。`
...
- Which source records identify obs-unk-004304 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004304？
