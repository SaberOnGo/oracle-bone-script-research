# obs-char-001328 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001328`
- primary external id: `hust-obc-cat-1484`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1328_obs-char-001328_hust-obc-cat-1484_ora
  cle-character/03_visual-assets/001_asset-001333_hust-obc-cat-1484_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1484/G_1484_京津4810合27840何組.png`
- asset id: `asset-001333`
...
- source category: `1484`
- validation class: `1327`
- source image route: `HUST-OBC/deciphered/1484/G_1484_京津4810合27840何組.png`
- asset id: `asset-001333`
...
- English observation: `A dense central crossing is flanked by a broad left
  curve and several separated right-side strokes.`
- 中文观察: `密集中央交叉笔两侧分别有宽大左弧线和数条分离的右侧笔画。`
...
- dataset label text: `㧂`
- dataset label codepoints: `U+39C2`
...
- filename catalog route clues: `Heji-like filename clue: 合27840
  (G_1484_京津4810合27840何組.png)`
...
- Which source records identify obs-char-001328 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001328？
