# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002569
...
| --- | --- | --- | --- |
| `obimd-glyph-link-039385` | 󾤧 | `U+FE927` | `reviewed_metadata_only` |
| `obimd-glyph-link-039386` | 󾤨 | `U+FE928` | `reviewed_metadata_only` |
