# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008149
...
- EVOBC candidate category: `evobc-evo-cat-08149`.
- Source label for search only: `訦`.
- Source codepoints for search only: `U+8A26`.
