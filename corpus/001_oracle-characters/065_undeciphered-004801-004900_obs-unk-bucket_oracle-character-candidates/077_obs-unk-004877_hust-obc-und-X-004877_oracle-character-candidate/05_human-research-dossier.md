# obs-unk-004877 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/077_obs-unk-004877_h
  ust-obc-und-X-004877_oracle-character-candidate/03_visual-assets/001_asset
  -006470_hust-obc-und-X-004877_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/433/X_？_7416_1.png`
- asset id: `asset-006470`
...
- source class: `HUST-OBC/undeciphered/X/433/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/433/X_？_7416_1.png`
- asset id: `asset-006470`
...
- English observation: `branching upper group and curved lower base`
- 中文观察: `上部分枝结构和弧形下部底座`
...
- Which source records identify obs-unk-004877 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004877？
