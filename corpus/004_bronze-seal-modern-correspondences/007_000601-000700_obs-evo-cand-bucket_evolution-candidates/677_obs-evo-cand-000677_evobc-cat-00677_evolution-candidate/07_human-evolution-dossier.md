...
- Project ID: `obs-evo-cand-000677`
- EVOBC category candidate ID: `evobc-evo-cat-00677`
- External category reference: `evobc-cat-00677`
- Source category ID: `00677`
- Source label for human review: `亂`
- Source codepoints: `U+4E82`
- Image reference count in source metadata: `53`
...
- `obs-evo-cand-000677-route-category-staging`
...
- `obs-evo-cand-000677-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000677-route-evolution-graph`
