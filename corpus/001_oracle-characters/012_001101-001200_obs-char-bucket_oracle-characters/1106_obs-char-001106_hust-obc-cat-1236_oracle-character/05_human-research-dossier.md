# obs-char-001106 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001106`
- primary external id: `hust-obc-cat-1236`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1106_obs-char-001106_hust-obc-cat-1236_ora
  cle-character/03_visual-assets/001_asset-001111_hust-obc-cat-1236_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1236/X_1236_4181_1.png`
- asset id: `asset-001111`
...
- source category: `1236`
- validation class: `1105`
- source image route: `HUST-OBC/deciphered/1236/X_1236_4181_1.png`
- asset id: `asset-001111`
...
- English observation: `A large rounded outer contour encloses a small inner
  loop and descends into a long central stem ending in a triangular base.`
- 中文观察: `大型圆弧外轮廓包含小型内部环笔，并向下延为以三角形底部收束的长中央笔干。`
...
- dataset label text: `㣊`
- dataset label codepoints: `U+38CA`
...
- Which source records identify obs-char-001106 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001106？
