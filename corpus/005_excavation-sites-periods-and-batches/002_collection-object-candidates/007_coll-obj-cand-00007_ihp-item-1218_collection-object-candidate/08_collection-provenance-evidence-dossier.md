# Collection Provenance Evidence Dossier / 馆藏来源证据档案: coll-obj-cand-00007
...
`18_live-source-evidence-review.md`. It reports `R044753`, Late Shang Period,
SYFYH127, and two private JPEG routes. The source display ends with an
ellipsis, so it is not a complete transcription.

现场官方页面复核见 `18_live-source-evidence-review.md`。该页记录 `R044753`、
晚商、SYFYH127 和两条本地私有 JPEG 路线。来源文字以省略号结束，因此不是
完整释文。
...
| source_row_id | `7` |
| object_page_url | `https://museum.sinica.edu.tw/en/collection/32/item/1218/` |
...
| asset_id | `` |
| asset_path | `` |
| thumbnail_url | `https://museum.sinica.edu.tw/_upload/image/collection_item/thumbnail/126675715f2cc7d9.jpg` |
| source_image_url | `` |
...
| `source_collection_item_id` | `1218` |
| `object_title_en` | `Reshaped Tortoise Carapace Yi Bian 4681` |
| `catalog_reference_text` | `Yi Bian 4681` |
| `accession_number` | `` |
| `historical_period` | `` |
| `object_date` | `` |
| `provenience` | `` |
