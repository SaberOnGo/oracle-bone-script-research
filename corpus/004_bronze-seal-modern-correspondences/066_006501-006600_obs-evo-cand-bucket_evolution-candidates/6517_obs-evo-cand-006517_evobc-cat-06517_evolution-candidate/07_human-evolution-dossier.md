...
- External category reference: `evobc-cat-06517`
- Source category ID: `06517`
- Source label for human review: `絩`
- Source codepoints: `U+7D69`
...
- `obs-evo-cand-006517-route-category-staging`
...
- `obs-evo-cand-006517-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006517-route-evolution-graph`
