...
Project ID: `obs-evo-cand-012919`
...
- Project ID: `obs-evo-cand-012919`
- EVOBC category candidate ID: `evobc-evo-cat-12919`
- External category reference: `evobc-cat-12919`
- Source category ID: `12919`
- Source label for human review: `𫆁`
- Source codepoints: `U+2B181`
...
- `obs-evo-cand-012919-route-category-staging`
...
- `obs-evo-cand-012919-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012919-route-evolution-graph`
