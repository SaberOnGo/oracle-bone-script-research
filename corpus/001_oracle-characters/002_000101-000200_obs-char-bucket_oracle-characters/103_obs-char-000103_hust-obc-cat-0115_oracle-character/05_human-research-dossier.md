# obs-char-000103 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000103`
- primary external id: `hust-obc-cat-0115`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/103_obs-char-000103_hust-obc-cat-0115_orac
  le-character/03_visual-assets/001_asset-000108_hust-obc-cat-0115_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0115/G_0115_甲骨文0.png`
- asset id: `asset-000108`
...
- source category: `0115`
- validation class: `102`
- source image route: `HUST-OBC/deciphered/0115/G_0115_甲骨文0.png`
- asset id: `asset-000108`
...
- English observation: `The small image has a thin irregular upright stroke
  at the right and a long low stroke extending leftward from its base.`
- 中文观察: `小型图像右侧有细而不规则的直立笔，底部有一道向左伸出的长低位笔画。`
...
- dataset label text: `㑩`
- dataset label codepoints: `U+3469`
...
- Which source records identify obs-char-000103 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000103？
