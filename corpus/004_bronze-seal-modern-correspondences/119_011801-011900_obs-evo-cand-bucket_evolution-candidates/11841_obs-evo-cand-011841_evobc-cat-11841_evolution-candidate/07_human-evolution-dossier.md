...
Project ID: `obs-evo-cand-011841`
...
- Project ID: `obs-evo-cand-011841`
- EVOBC category candidate ID: `evobc-evo-cat-11841`
- External category reference: `evobc-cat-11841`
- Source category ID: `11841`
- Source label for human review: `𥢢`
- Source codepoints: `U+258A2`
...
- `obs-evo-cand-011841-route-category-staging`
...
- `obs-evo-cand-011841-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011841-route-evolution-graph`
