...
- External category reference: `evobc-cat-11264`
- Source category ID: `11264`
- Source label: `𢟽`
...
- `obs-evo-cand-011264-route-category-staging`
...
- `obs-evo-cand-011264-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011264-route-evolution-graph`
