...
- External category reference: `evobc-cat-09303`
- Source category ID: `09303`
- Source label for human review: `釐`
...
- `obs-evo-cand-009303-route-category-staging`
...
- `obs-evo-cand-009303-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009303-route-evolution-graph`
