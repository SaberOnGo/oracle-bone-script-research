...
Project ID: `obs-evo-cand-004323`
...
- Project ID: `obs-evo-cand-004323`
- EVOBC category candidate ID: `evobc-evo-cat-04323`
- External category reference: `evobc-cat-04323`
- Source category ID: `04323`
- Source label for human review: `櫳`
- Source codepoints: `U+6AF3`
...
- `obs-evo-cand-004323-route-category-staging`
...
- `obs-evo-cand-004323-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004323-route-evolution-graph`
