# Material Visual Observation / obs-comp-cand-002684 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002684`
- External reference / 外部参照: `obimd-sub-a0vs6rahan`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021260_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/q5gaaxmql4/a0vs6rahan/a0vs6rahan.png`
- Checksum / 校验和:
  `360004a69dc4bbc4fc7e2aef5312fcc357ff9094ee7ecf56eb9f68f5706aab94`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.39%.
- Marked-pixel bounds: (44,60)–(204,200); span 161 × 141 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.39%。
- 痕迹范围：(44,60)–(204,200)；跨度161 × 141 px；痕迹矩形近方形。
