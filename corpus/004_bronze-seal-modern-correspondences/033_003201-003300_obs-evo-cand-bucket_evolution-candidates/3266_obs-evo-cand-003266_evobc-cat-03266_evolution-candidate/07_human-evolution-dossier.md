...
- Project ID: `obs-evo-cand-003266`
- EVOBC category candidate ID: `evobc-evo-cat-03266`
- External category reference: `evobc-cat-03266`
- Source category ID: `03266`
- Source label for human review: `批`
- Source codepoints: `U+6279`
...
- `obs-evo-cand-003266-route-category-staging`
...
- `obs-evo-cand-003266-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003266-route-evolution-graph`
