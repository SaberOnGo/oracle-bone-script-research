...
- External category reference: `evobc-cat-13452`
- Source category ID: `13452`
- Source label for human review: `𬹜`
...
- `obs-evo-cand-013452-route-category-staging`
...
- `obs-evo-cand-013452-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013452-route-evolution-graph`
