...
- External category reference: `evobc-cat-08617`
- Source category ID: `08617`
- Source label for human review: `责`
- Source codepoints: `U+8D23`
...
- `obs-evo-cand-008617-route-category-staging`
...
- `obs-evo-cand-008617-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008617-route-evolution-graph`
