# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004345
...
- EVOBC candidate category: `evobc-evo-cat-04345`.
- Source label for search only: `欬`.
- Source codepoints for search only: `U+6B2C`.
