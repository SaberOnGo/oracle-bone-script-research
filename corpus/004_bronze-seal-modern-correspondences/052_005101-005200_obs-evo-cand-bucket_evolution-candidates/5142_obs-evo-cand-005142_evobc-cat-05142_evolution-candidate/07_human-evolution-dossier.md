...
- External category reference: `evobc-cat-05142`
- Source category ID: `05142`
- Source label for human review: `燀`
- Source codepoints: `U+71C0`
...
- `obs-evo-cand-005142-route-category-staging`
...
- `obs-evo-cand-005142-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005142-route-evolution-graph`
