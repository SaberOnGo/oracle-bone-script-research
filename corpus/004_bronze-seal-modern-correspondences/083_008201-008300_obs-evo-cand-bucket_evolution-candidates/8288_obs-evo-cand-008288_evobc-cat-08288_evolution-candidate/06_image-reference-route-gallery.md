...
- `obs-evo-cand-008288-route-category-staging`
...
- `obs-evo-cand-008288-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008288-route-evolution-graph`
