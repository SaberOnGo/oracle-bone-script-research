# Material Visual Observation / obs-comp-cand-000210 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000210`
- External reference / 外部参照: `obimd-sub-7g8plsbjew`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011855_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/pa13rewdd9/7g8plsbjew/7g8plsbjew.png`
- Checksum / 校验和:
  `c19407cf11b78a02c59b6f1ac7b25db43fcefd659b39a96688925e52ec114587`
...
- Marked-pixel bounds: (80,13)–(169,238); span 90 × 226 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.63%。
- 痕迹范围：(80,13)–(169,238)；跨度90 × 226 px；痕迹矩形高于宽。
