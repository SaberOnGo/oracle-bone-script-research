...
- Project ID: `obs-evo-cand-008618`
- EVOBC category candidate ID: `evobc-evo-cat-08618`
- External category reference: `evobc-cat-08618`
- Source category ID: `08618`
- Source label for human review: `贤`
- Source codepoints: `U+8D24`
...
- `obs-evo-cand-008618-route-category-staging`
...
- `obs-evo-cand-008618-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008618-route-evolution-graph`
