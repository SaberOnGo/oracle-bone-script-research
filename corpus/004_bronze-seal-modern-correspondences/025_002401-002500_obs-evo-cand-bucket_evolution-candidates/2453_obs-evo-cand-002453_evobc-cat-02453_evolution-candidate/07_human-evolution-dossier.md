...
- External category reference: `evobc-cat-02453`
- Source category ID: `02453`
- Source label for human review: `寽`
- Source codepoints: `U+5BFD`
- Image reference count in source metadata: `23`
...
- `obs-evo-cand-002453-route-category-staging`
...
- `obs-evo-cand-002453-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002453-route-evolution-graph`
