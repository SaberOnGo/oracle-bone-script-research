# obs-evo-cand-000593 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-00593`
- Source label: `䵼`
- Source codepoints: `U+4D7C`
- Image reference count: `90`
- Era token counts: `OBC:90`
- Source token counts: `Book:51;Web:39`
...
- source 7 / Book:9676: 51 image references
