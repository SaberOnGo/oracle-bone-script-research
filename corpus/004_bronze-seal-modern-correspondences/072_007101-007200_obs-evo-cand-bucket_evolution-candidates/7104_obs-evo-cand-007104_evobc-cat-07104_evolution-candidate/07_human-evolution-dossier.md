...
Project ID: `obs-evo-cand-007104`
...
- Project ID: `obs-evo-cand-007104`
- EVOBC category candidate ID: `evobc-evo-cat-07104`
- External category reference: `evobc-cat-07104`
- Source category ID: `07104`
- Source label for human review: `腫`
- Source codepoints: `U+816B`
...
- `obs-evo-cand-007104-route-category-staging`
...
- `obs-evo-cand-007104-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007104-route-evolution-graph`
