# obs-unk-004529 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004529`
- primary external id: `hust-obc-und-X-004529`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/029_obs-unk-004529_h
  ust-obc-und-X-004529_oracle-character-candidate/03_visual-assets/001_asset
  -006122_hust-obc-und-X-004529_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/85/X_？_8269_1.png`
- asset id: `asset-006122`
...
- source class: `HUST-OBC/undeciphered/X/85/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/85/X_？_8269_1.png`
- asset id: `asset-006122`
...
- English observation: `Main outline, upper band, and three prongs recorded.`
- 中文观察: `已记录主体轮廓、上部带状痕迹和三条尖突。`
...
- Which source records identify obs-unk-004529 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004529？
