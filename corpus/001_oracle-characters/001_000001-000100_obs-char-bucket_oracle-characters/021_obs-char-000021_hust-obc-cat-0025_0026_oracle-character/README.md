# obs-char-000021 Local Object Materials / obs-char-000021 本地对象资料
...
- Project ID / 项目 ID: `obs-char-000021`
- Primary external reference / 首选外部参考: `hust-obc-cat-0025_0026`
- Source / 来源: `src-hust-obc`
- Packet record type / 资料包类型: `oracle_character_candidate_packet`
- Directory / 目录: `corpus/001_oracle-characters/001_000001-000100_obs-char-bucke
  t_oracle-characters/021_obs-char-000021_hust-obc-cat-0025_0026_oracle-characte
  r`
...
- Committed glyph image / 已提交字形图像:
  03_visual-assets/001_asset-000026_hust-obc-cat-0025_0026_glyph.png
