# obs-char-000607 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000607`
- primary external id: `hust-obc-cat-0692`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/607_obs-char-000607_hust-obc-cat-0692_orac
  le-character/03_visual-assets/001_asset-000612_hust-obc-cat-0692_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0692/G_0692_乙1706合21870子組.png`
- asset id: `asset-000612`
...
- source category: `0692`
- validation class: `606`
- source image route: `HUST-OBC/deciphered/0692/G_0692_乙1706合21870子組.png`
- asset id: `asset-000612`
...
- English observation: `A narrow irregular outer contour has paired pointed
  projections at the top, several short internal strokes, and a small
  enclosed opening near the bottom.`
- 中文观察: `狭窄不规则外轮廓顶部有成对尖突，内部有数条短笔，近底部有小型封闭空隙。`
...
- dataset label text: `㚪`
- dataset label codepoints: `U+36AA`
...
- filename catalog route clues: `Heji-like filename clue: 合21870
...
- Which source records identify obs-char-000607 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000607？
