...
- Project ID: `obs-evo-cand-002533`
- EVOBC category candidate ID: `evobc-evo-cat-02533`
- External category reference: `evobc-cat-02533`
- Source category ID: `02533`
- Source label for human review: `岊`
- Source codepoints: `U+5C8A`
...
- `obs-evo-cand-002533-route-category-staging`
...
- `obs-evo-cand-002533-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002533-route-evolution-graph`
