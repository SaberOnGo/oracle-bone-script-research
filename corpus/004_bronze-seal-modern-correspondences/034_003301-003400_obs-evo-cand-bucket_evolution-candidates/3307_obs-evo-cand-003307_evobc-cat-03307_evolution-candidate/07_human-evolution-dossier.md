...
- External category reference: `evobc-cat-03307`
- Source category ID: `03307`
- Source label for human review: `拉`
- Source codepoints: `U+62C9`
...
- `obs-evo-cand-003307-route-category-staging`
...
- `obs-evo-cand-003307-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003307-route-evolution-graph`
