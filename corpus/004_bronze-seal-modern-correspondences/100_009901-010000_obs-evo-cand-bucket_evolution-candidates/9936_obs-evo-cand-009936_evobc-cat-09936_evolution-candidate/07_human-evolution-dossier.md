...
- External category reference: `evobc-cat-09936`
- Source category ID: `09936`
- Source label for human review: `韇`
...
- `obs-evo-cand-009936-route-category-staging`
...
- `obs-evo-cand-009936-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009936-route-evolution-graph`
