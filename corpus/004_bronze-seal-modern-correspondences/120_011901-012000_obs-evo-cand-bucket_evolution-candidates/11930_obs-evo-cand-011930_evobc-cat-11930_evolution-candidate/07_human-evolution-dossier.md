...
- External category reference: `evobc-cat-11930`
- Source category ID: `11930`
- Source label for human review: `𥾲`
- Source codepoints: `U+25FB2`
...
- `obs-evo-cand-011930-route-category-staging`
...
- `obs-evo-cand-011930-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011930-route-evolution-graph`
