...
- External category reference: `evobc-cat-09150`
- Source category ID: `09150`
- Source label for human review: `郡`
- Source codepoints: `U+90E1`
...
- `obs-evo-cand-009150-route-category-staging`
...
- `obs-evo-cand-009150-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009150-route-evolution-graph`
