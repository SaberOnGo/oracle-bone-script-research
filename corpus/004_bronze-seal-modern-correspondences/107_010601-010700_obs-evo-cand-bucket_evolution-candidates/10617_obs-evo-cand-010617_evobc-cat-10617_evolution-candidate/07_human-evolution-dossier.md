...
- Project ID: `obs-evo-cand-010617`
- EVOBC category candidate ID: `evobc-evo-cat-10617`
- External category reference: `evobc-cat-10617`
- Source category ID: `10617`
- Source label for human review: `麟`
- Source codepoints: `U+9E9F`
...
- `obs-evo-cand-010617-route-category-staging`
...
- `obs-evo-cand-010617-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010617-route-evolution-graph`
