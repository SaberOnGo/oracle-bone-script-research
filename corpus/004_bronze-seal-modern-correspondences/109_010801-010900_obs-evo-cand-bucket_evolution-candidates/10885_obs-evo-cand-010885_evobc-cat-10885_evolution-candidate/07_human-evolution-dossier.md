...
- Project ID: `obs-evo-cand-010885`
- EVOBC category candidate ID: `evobc-evo-cat-10885`
- External category reference: `evobc-cat-10885`
- Source category ID: `10885`
- Source label for human review: `𠧟`
- Source codepoints: `U+209DF`
...
- `obs-evo-cand-010885-route-category-staging`
...
- `obs-evo-cand-010885-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010885-route-evolution-graph`
