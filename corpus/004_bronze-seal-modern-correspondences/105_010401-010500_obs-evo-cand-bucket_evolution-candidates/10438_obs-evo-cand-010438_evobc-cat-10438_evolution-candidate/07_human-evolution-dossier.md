...
- External category reference: `evobc-cat-10438`
- Source category ID: `10438`
- Source label for human review: `鰸`
- Source codepoints: `U+9C38`
...
- `obs-evo-cand-010438-route-category-staging`
...
- `obs-evo-cand-010438-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010438-route-evolution-graph`
