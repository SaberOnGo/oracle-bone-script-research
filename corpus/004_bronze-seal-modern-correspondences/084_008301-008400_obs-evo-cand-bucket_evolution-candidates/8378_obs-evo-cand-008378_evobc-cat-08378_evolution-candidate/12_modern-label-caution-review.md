# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008378
...
- EVOBC candidate category: `evobc-evo-cat-08378`.
- Source label for search only: `譺`.
- Source codepoints for search only: `U+8B7A`.
