...
Project ID: `obs-evo-cand-009369`
...
- Project ID: `obs-evo-cand-009369`
- EVOBC category candidate ID: `evobc-evo-cat-09369`
- External category reference: `evobc-cat-09369`
- Source category ID: `09369`
- Source label for human review: `鉦`
- Source codepoints: `U+9266`
...
- `obs-evo-cand-009369-route-category-staging`
...
- `obs-evo-cand-009369-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009369-route-evolution-graph`
