...
- Project ID: `obs-evo-cand-012639`
- EVOBC category candidate ID: `evobc-evo-cat-12639`
- External category reference: `evobc-cat-12639`
- Source category ID: `12639`
- Source label for human review: `𩞴`
- Source codepoints: `U+297B4`
- Image reference count in source metadata: `47`
...
- `obs-evo-cand-012639-route-category-staging`
...
- `obs-evo-cand-012639-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012639-route-evolution-graph`
