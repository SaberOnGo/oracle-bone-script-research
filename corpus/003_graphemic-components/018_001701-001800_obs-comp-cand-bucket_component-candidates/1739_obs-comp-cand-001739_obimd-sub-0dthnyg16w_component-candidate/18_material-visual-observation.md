# Material Visual Observation / obs-comp-cand-001739 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001739`
- External reference / 外部参照: `obimd-sub-0dthnyg16w`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017940_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/iuzkqe17tf/0dthnyg16w/0dthnyg16w.png`
- Checksum / 校验和:
  `f7f14608096add8637c1cd09bd5cc7c9f1aee5ce828f8c80b69ed12f21bb86bc`
...
- Marked-pixel bounds: (62,17)–(198,234); span 137 × 218 px; the marked
...
- 痕迹范围：(62,17)–(198,234)；跨度137 × 218 px；痕迹矩形高于宽。
