...
Project ID: `obs-evo-cand-009815`
...
- Project ID: `obs-evo-cand-009815`
- EVOBC category candidate ID: `evobc-evo-cat-09815`
- External category reference: `evobc-cat-09815`
- Source category ID: `09815`
- Source label for human review: `雐`
- Source codepoints: `U+96D0`
...
- `obs-evo-cand-009815-route-category-staging`
...
- `obs-evo-cand-009815-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009815-route-evolution-graph`
