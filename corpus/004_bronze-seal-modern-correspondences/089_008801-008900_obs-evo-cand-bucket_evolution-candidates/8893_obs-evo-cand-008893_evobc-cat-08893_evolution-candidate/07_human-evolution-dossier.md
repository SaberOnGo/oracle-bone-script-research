...
- External category reference: `evobc-cat-08893`
- Source category ID: `08893`
- Source label for human review: `轴`
...
- `obs-evo-cand-008893-route-category-staging`
...
- `obs-evo-cand-008893-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008893-route-evolution-graph`
