...
- Project ID: `obs-evo-cand-012574`
- EVOBC category candidate ID: `evobc-evo-cat-12574`
- External category reference: `evobc-cat-12574`
- Source category ID: `12574`
- Source label for human review: `𩊭`
- Source codepoints: `U+292AD`
...
- `obs-evo-cand-012574-route-category-staging`
...
- `obs-evo-cand-012574-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012574-route-evolution-graph`
