...
- External category reference: `evobc-cat-10423`
- Source category ID: `10423`
- Source label for human review: `鯾`
...
- `obs-evo-cand-010423-route-category-staging`
...
- `obs-evo-cand-010423-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010423-route-evolution-graph`
