...
- Project ID: `obs-evo-cand-011095`
- EVOBC category candidate ID: `evobc-evo-cat-11095`
- External category reference: `evobc-cat-11095`
- Source category ID: `11095`
- Source label for human review: `𡰅`
- Source codepoints: `U+21C05`
...
- `obs-evo-cand-011095-route-category-staging`
...
- `obs-evo-cand-011095-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011095-route-evolution-graph`
