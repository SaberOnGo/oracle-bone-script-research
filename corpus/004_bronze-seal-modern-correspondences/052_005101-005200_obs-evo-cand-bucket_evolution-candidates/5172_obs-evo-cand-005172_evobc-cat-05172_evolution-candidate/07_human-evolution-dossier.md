...
- External category reference: `evobc-cat-05172`
- Source category ID: `05172`
- Source label for human review: `爝`
- Source codepoints: `U+721D`
...
- `obs-evo-cand-005172-route-category-staging`
...
- `obs-evo-cand-005172-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005172-route-evolution-graph`
