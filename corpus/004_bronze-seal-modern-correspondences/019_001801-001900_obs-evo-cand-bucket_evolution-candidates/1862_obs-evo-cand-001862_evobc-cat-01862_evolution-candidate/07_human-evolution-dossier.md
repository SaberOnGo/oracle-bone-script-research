...
Project ID: `obs-evo-cand-001862`
...
- Project ID: `obs-evo-cand-001862`
- EVOBC category candidate ID: `evobc-evo-cat-01862`
- External category reference: `evobc-cat-01862`
- Source category ID: `01862`
- Source label for human review: `垦`
- Source codepoints: `U+57A6`
...
- `obs-evo-cand-001862-route-category-staging`
...
- `obs-evo-cand-001862-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001862-route-evolution-graph`
