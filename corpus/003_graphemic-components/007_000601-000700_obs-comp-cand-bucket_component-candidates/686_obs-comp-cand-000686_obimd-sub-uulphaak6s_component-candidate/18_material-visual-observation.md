# Material Visual Observation / obs-comp-cand-000686 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000686`
- External reference / 外部参照: `obimd-sub-uulphaak6s`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013285_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/uulphaak6s/uulphaak6s/uulphaak6s.png`
- Checksum / 校验和:
  `c496732182374cfc30e4443e42581ff8fd0836928b0fa815f558e880d748f1d1`
...
- Marked-pixel bounds: (64,20)–(199,227); span 136 × 208 px; the marked
...
- 痕迹范围：(64,20)–(199,227)；跨度136 × 208 px；痕迹矩形高于宽。
