...
- External category reference: `evobc-cat-12705`
- Source category ID: `12705`
- Source label for human review: `𩻀`
- Source codepoints: `U+29EC0`
...
- `obs-evo-cand-012705-route-category-staging`
...
- `obs-evo-cand-012705-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012705-route-evolution-graph`
