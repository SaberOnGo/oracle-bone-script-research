# obs-unk-004607 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/007_obs-unk-004607_h
  ust-obc-und-X-004607_oracle-character-candidate/03_visual-assets/001_asset
  -006200_hust-obc-und-X-004607_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/163/X_？_8339_1.png`
- asset id: `asset-006200`
...
- source class: `HUST-OBC/undeciphered/X/163/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/163/X_？_8339_1.png`
- asset id: `asset-006200`
...
- English observation: `tall enclosure, hooked upper ends, rounded base`
- 中文观察: `高长外轮廓、顶部钩端和圆弧下端已记录。`
...
- Which source records identify obs-unk-004607 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004607？
