...
- Local image / 本地图像:
  `03_visual-assets/001_asset-000889_hust-obc-cat-0996_glyph.png`
- Local metadata / 本地 metadata:
  `03_visual-assets/001_asset-000889_hust-obc-cat-0996_glyph.yaml`
- Source image path / 来源图像路径:
  `HUST-OBC/deciphered/0996/G_0996_京都2142合27972無名組.png`
