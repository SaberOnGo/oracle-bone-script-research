# Material Visual Observation / obs-comp-cand-002056 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002056`
- External reference / 外部参照: `obimd-sub-a2wp9gn5sp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019443_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/iuouekyjwj/a2wp9gn5sp/a2wp9gn5sp.png`
- Checksum / 校验和:
  `a11c38b53c1f3d2c41f6ebbee208657e7d01b2b59d1ebc9b08a599d5a82f8dfd`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.59%.
- Marked-pixel bounds: (75,21)–(176,226); span 102 × 206 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.59%。
- 痕迹范围：(75,21)–(176,226)；跨度102 × 206 px；痕迹矩形高于宽。
