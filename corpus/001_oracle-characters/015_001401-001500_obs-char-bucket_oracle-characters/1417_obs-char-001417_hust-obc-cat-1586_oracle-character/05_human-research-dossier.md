# obs-char-001417 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001417`
- primary external id: `hust-obc-cat-1586`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1417_obs-char-001417_hust-obc-cat-1586_ora
  cle-character/03_visual-assets/001_asset-001422_hust-obc-cat-1586_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1586/G_1586_乙2601反.png`
- asset id: `asset-001422`
...
- source category: `1586`
- validation class: `1416`
- source image route: `HUST-OBC/deciphered/1586/G_1586_乙2601反.png`
- asset id: `asset-001422`
...
- English observation: `A rounded upper enclosure has side prongs and a
  pointed lower taper.`
- 中文观察: `圆拱上部框形有侧部分叉和尖状下部收束。`
...
- dataset label text: `㨨`
- dataset label codepoints: `U+3A28`
...
- Which source records identify obs-char-001417 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001417？
