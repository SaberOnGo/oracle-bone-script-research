# obs-char-000038 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/038_obs-char-000038_hust-obc-cat-0044_orac
  le-character/03_visual-assets/001_asset-000043_hust-obc-cat-0044_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0044/G_0044_後2.42.6合28053.png`
- asset id: `asset-000043`
...
- source category: `0044`
- validation class: `37`
- source image route: `HUST-OBC/deciphered/0044/G_0044_後2.42.6合28053.png`
- asset id: `asset-000043`
...
- English observation: `The thin image has short parallel marks at the upper
  left, a central upright stroke, and a hooked lower extension.`
- 中文观察: `纤细图像左上有短平行痕迹，中部有竖向主笔画，下方延出钩状痕迹。`
...
- dataset label text: `㐢`
- dataset label codepoints: `U+3422`
...
- filename catalog route clues: `Heji-like filename clue: 合28053
...
- Which source records identify obs-char-000038 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000038？
