...
- External category reference: `evobc-cat-07186`
- Source category ID: `07186`
- Source label for human review: `舆`
- Source codepoints: `U+8206`
...
- `obs-evo-cand-007186-route-category-staging`
...
- `obs-evo-cand-007186-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007186-route-evolution-graph`
