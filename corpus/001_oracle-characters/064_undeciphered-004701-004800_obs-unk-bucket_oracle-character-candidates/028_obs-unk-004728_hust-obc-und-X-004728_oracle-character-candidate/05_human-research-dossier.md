# obs-unk-004728 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/028_obs-unk-004728_h
  ust-obc-und-X-004728_oracle-character-candidate/03_visual-assets/001_asset
  -006321_hust-obc-und-X-004728_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/284/X_？_7263_1.png`
- asset id: `asset-006321`
...
- source class: `HUST-OBC/undeciphered/X/284/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/284/X_？_7263_1.png`
- asset id: `asset-006321`
...
- English observation: `crossing upper group with broad lower opening`
- 中文观察: `带下部大开口的上部交叉笔画组`
...
- Which source records identify obs-unk-004728 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004728？
