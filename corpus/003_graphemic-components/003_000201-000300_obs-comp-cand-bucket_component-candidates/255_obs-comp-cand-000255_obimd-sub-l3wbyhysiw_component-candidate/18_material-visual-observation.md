# Material Visual Observation / obs-comp-cand-000255 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000255`
- External reference / 外部参照: `obimd-sub-l3wbyhysiw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011901_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/l3wbyhysiw/l3wbyhysiw/l3wbyhysiw.png`
- Checksum / 校验和:
  `eb29ee51a4a670f470aa8d8b5bdaf5ad8ea46f69af0a6b4ad578efbfcd8d89ed`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.50%.
- Marked-pixel bounds: (54,15)–(195,234); span 142 × 220 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.50%。
- 痕迹范围：(54,15)–(195,234)；跨度142 × 220 px；痕迹矩形高于宽。
