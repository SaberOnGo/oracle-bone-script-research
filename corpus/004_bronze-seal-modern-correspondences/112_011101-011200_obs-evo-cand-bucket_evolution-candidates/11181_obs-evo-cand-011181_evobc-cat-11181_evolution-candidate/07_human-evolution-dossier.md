...
- External category reference: `evobc-cat-11181`
- Source category ID: `11181`
- Source label for human review: `𢏡`
- Source codepoints: `U+223E1`
...
- `obs-evo-cand-011181-route-category-staging`
...
- `obs-evo-cand-011181-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011181-route-evolution-graph`
