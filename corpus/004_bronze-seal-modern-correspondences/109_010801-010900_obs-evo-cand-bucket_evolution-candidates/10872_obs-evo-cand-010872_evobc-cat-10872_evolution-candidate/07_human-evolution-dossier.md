...
- External category reference: `evobc-cat-10872`
- Source category ID: `10872`
- Source label for human review: `𠤳`
- Source codepoints: `U+20933`
...
- `obs-evo-cand-010872-route-category-staging`
...
- `obs-evo-cand-010872-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010872-route-evolution-graph`
