# obs-char-001218 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1218_obs-char-001218_hust-obc-cat-1363_ora
  cle-character/03_visual-assets/001_asset-001223_hust-obc-cat-1363_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1363/H_1363_604D9_0.png`
- asset id: `asset-001223`
...
- source category: `1363`
- validation class: `1217`
- source image route: `HUST-OBC/deciphered/1363/H_1363_604D9_0.png`
- asset id: `asset-001223`
...
- English observation: `A large angular form has a broad central crossing, a
  left outer stroke, a right curved contour, and lower enclosed marks.`
...
- dataset label text: `㥉`
- dataset label codepoints: `U+3949`
...
- filename catalog route clues: `catalog-like filename clue: H_1363
  (H_1363_604D9_0.png)`
...
- Which source records identify obs-char-001218 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001218？
