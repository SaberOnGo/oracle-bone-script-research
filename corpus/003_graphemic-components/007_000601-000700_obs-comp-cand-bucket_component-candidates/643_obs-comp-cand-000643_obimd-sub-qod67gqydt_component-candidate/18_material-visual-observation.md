# Material Visual Observation / obs-comp-cand-000643 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000643`
- External reference / 外部参照: `obimd-sub-qod67gqydt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013206_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3lrj040600/qod67gqydt/qod67gqydt.png`
- Checksum / 校验和:
  `84f63ed8bce7f6aadf9e2246ffae7bbd05a8fa128653897cd6cb9297fc5b8273`
...
- Marked-pixel bounds: (78,27)–(171,221); span 94 × 195 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.35%。
- 痕迹范围：(78,27)–(171,221)；跨度94 × 195 px；痕迹矩形高于宽。
