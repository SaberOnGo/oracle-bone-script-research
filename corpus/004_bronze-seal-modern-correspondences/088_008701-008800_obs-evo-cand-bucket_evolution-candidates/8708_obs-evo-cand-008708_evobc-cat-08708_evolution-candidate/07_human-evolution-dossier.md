...
- External category reference: `evobc-cat-08708`
- Source category ID: `08708`
- Source label for human review: `跋`
...
- `obs-evo-cand-008708-route-category-staging`
...
- `obs-evo-cand-008708-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008708-route-evolution-graph`
