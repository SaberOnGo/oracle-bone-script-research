# obs-unk-004072 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004072`
- primary external id: `hust-obc-und-L-004072`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/072_obs-unk-004072_h
  ust-obc-und-L-004072_oracle-character-candidate/03_visual-assets/001_asset
  -005665_hust-obc-und-L-004072_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4072/L_？_8718.jpg`
- asset id: `asset-005665`
...
- source class: `HUST-OBC/undeciphered/L/4072/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4072/L_？_8718.jpg`
- asset id: `asset-005665`
...
- English observation: Several thin branching traces rise above a rounded
  lower outline. The lower form contains a darker central area and a short
  horizontal edge; the branch count and their joins are not fully resolved.
- 中文观察：一个圆弧状下部轮廓上方有数条细长的分支痕迹向上伸展。下部内部中央
  较深，并带有一条短横边；分支数量及其连接关系仍未完全分辨。
...
- Which source records identify obs-unk-004072 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004072？
