# Material Visual Observation / obs-comp-cand-000463 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000463`
- External reference / 外部参照: `obimd-sub-mxsg4rdyyl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012611_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8gro2b24ja/mxsg4rdyyl/mxsg4rdyyl.png`
- Checksum / 校验和:
  `41d65f89461f7e7243a11e37497c4d648340edfe75d75110349f7a3300d06168`
...
- Marked-pixel bounds: (81,27)–(168,222); span 88 × 196 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.06%。
- 痕迹范围：(81,27)–(168,222)；跨度88 × 196 px；痕迹矩形高于宽。
