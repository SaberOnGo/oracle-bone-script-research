...
- Project ID: `obs-evo-cand-011589`
- EVOBC category candidate ID: `evobc-evo-cat-11589`
- External category reference: `evobc-cat-11589`
- Source category ID: `11589`
- Source label for human review: `𤖐`
- Source codepoints: `U+24590`
...
- `obs-evo-cand-011589-route-category-staging`
...
- `obs-evo-cand-011589-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011589-route-evolution-graph`
