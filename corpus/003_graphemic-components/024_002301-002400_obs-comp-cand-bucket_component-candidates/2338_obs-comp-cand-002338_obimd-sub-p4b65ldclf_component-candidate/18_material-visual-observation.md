# Material Visual Observation / obs-comp-cand-002338 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002338`
- External reference / 外部参照: `obimd-sub-p4b65ldclf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020357_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/crck62eltz/p4b65ldclf/p4b65ldclf.png`
- Checksum / 校验和:
  `2836ffdb8f08163da7921a8ee2ab640a0029ae5419acf9ee96dcc0c6fa26de23`
...
- Marked-pixel bounds: (79,30)–(171,215); span 93 × 186 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.53%。
- 痕迹范围：(79,30)–(171,215)；跨度93 × 186 px；痕迹矩形高于宽。
