# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002185
...
- EVOBC candidate category: `evobc-evo-cat-02185`.
- Source label for search only: `娺`.
- Source codepoints for search only: `U+5A3A`.
