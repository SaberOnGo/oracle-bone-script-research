# obs-char-000595 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/595_obs-char-000595_hust-obc-cat-0677_orac
  le-character/03_visual-assets/001_asset-000600_hust-obc-cat-0677_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0677/H_0677_60D67_0.png`
- asset id: `asset-000600`
...
- source category: `0677`
- validation class: `594`
- source image route: `HUST-OBC/deciphered/0677/H_0677_60D67_0.png`
- asset id: `asset-000600`
...
- English observation: `Two detached angular strokes stand at left; at
  right, a tall central vertical carries multiple diagonal branches and a
  broad curved lower arch.`
- 中文观察: `左侧有两条分离折角笔；右侧高长中央竖笔带多条斜枝和宽弯下拱。`
...
- dataset label text: `㚛`
- dataset label codepoints: `U+369B`
...
- filename catalog route clues: `catalog-like filename clue: H_0677
  (H_0677_60D67_0.png)`
...
- Which source records identify obs-char-000595 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000595？
