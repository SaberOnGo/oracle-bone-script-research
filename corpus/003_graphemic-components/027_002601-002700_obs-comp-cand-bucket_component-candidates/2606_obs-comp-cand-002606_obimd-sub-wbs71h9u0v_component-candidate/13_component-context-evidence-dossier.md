# obs-comp-cand-002606 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002606`
- 首选外部 ID: `obimd-sub-wbs71h9u0v`
- OBIMD subcharacter UID: `wbs71h9u0v`
- OBIMD main character UID: `wbs71h9u0v`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+FEB7F; U+FEB80; 另有 1 项
