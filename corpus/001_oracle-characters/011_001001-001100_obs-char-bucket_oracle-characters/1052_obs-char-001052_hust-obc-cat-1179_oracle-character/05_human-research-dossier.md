# obs-char-001052 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1052_obs-char-001052_hust-obc-cat-1179_ora
  cle-character/03_visual-assets/001_asset-001057_hust-obc-cat-1179_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1179/G_1179_乙5317合1051賓組.png`
- asset id: `asset-001057`
...
- source category: `1179`
- validation class: `1051`
- source image route: `HUST-OBC/deciphered/1179/G_1179_乙5317合1051賓組.png`
- asset id: `asset-001057`
...
- English observation: `A compact cluster combines short left diagonal
  marks, a long central curve, and a rounded right enclosed mark.`
...
- dataset label text: `㢑`
- dataset label codepoints: `U+3891`
...
- Which source records identify obs-char-001052 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001052？
