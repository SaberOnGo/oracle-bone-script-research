# obs-char-000587 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/587_obs-char-000587_hust-obc-cat-0666_orac
  le-character/03_visual-assets/001_asset-000592_hust-obc-cat-0666_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0666/G_0666_存下848合31791何組.png`
- asset id: `asset-000592`
...
- source category: `0666`
- validation class: `586`
- source image route: `HUST-OBC/deciphered/0666/G_0666_存下848合31791何組.png`
- asset id: `asset-000592`
...
- English observation: `Four separated bold forms occupy the corners: a
  curved upper-left stroke, a square upper-right loop, a lower-left angle,
  and a looped branching lower-right form.`
- 中文观察: `四个分离粗重形体分居四角：左上弯笔、右上方环、左下折角和右下环状分支形。`
...
- dataset label text: `㚐`
- dataset label codepoints: `U+3690`
...
- filename catalog route clues: `Heji-like filename clue: 合31791
  (G_0666_存下848合31791何組.png)`
...
- Which source records identify obs-char-000587 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000587？
