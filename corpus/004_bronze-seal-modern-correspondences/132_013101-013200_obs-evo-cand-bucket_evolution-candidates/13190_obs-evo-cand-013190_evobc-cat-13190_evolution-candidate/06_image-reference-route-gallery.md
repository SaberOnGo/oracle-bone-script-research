...
- `obs-evo-cand-013190-route-category-staging`
...
- `obs-evo-cand-013190-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013190-route-evolution-graph`
