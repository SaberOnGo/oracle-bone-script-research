# obs-unk-004489 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/089_obs-unk-004489_h
  ust-obc-und-X-004489_oracle-character-candidate/03_visual-assets/001_asset
  -006082_hust-obc-und-X-004489_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/45/X_？_8226_1.png`
- asset id: `asset-006082`
...
- source class: `HUST-OBC/undeciphered/X/45/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/45/X_？_8226_1.png`
- asset id: `asset-006082`
...
- English observation: `The upper cap, paired marks, lower angular outline,
  diagonal traces, and downward trace are directly recorded.`
- 中文观察: `已直接记录上部轮廓、两个分离痕迹、下部折线轮廓、斜向痕迹和向下长痕。`
...
- Which source records identify obs-unk-004489 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004489？
