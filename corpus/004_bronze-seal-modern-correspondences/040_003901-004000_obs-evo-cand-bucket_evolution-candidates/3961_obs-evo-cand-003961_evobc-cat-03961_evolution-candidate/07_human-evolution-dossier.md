...
Project ID: `obs-evo-cand-003961`
...
- Project ID: `obs-evo-cand-003961`
- EVOBC category candidate ID: `evobc-evo-cat-03961`
- External category reference: `evobc-cat-03961`
- Source category ID: `03961`
- Source label for human review: `柜`
- Source codepoints: `U+67DC`
...
- `obs-evo-cand-003961-route-category-staging`
...
- `obs-evo-cand-003961-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003961-route-evolution-graph`
