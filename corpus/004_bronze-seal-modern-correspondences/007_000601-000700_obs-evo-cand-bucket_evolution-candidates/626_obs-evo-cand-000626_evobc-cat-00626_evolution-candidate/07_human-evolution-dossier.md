...
- Project ID: `obs-evo-cand-000626`
- EVOBC category candidate ID: `evobc-evo-cat-00626`
- External category reference: `evobc-cat-00626`
- Source category ID: `00626`
- Source label for human review: `丝`
- Source codepoints: `U+4E1D`
...
- `obs-evo-cand-000626-route-category-staging`
...
- `obs-evo-cand-000626-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000626-route-evolution-graph`
