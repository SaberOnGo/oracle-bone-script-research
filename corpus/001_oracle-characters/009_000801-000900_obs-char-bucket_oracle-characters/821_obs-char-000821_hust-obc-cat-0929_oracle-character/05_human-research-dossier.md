# obs-char-000821 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000821`
- primary external id: `hust-obc-cat-0929`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/821_obs-char-000821_hust-obc-cat-0929_orac
  le-character/03_visual-assets/001_asset-000826_hust-obc-cat-0929_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0929/L_0929_10374.jpg`
- asset id: `asset-000826`
...
- source category: `0929`
- validation class: `820`
- source image route: `HUST-OBC/deciphered/0929/L_0929_10374.jpg`
- asset id: `asset-000826`
...
- English observation: `The small gray image shows a compact diagonal
  cluster with several short bars and a thin stem descending from its lower
  junction; fine joins are unclear.`
- 中文观察: `小型灰度图像显示紧凑的斜向笔群，含数条短横笔和一条从下方接点延伸的细笔；细连接难辨。`
...
- dataset label text: `㞗`
- dataset label codepoints: `U+3797`
...
- Which source records identify obs-char-000821 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000821？
