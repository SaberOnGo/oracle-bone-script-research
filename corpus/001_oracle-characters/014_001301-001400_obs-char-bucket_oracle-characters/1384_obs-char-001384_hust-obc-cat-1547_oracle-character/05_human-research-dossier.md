# obs-char-001384 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1384_obs-char-001384_hust-obc-cat-1547_ora
  cle-character/03_visual-assets/001_asset-001389_hust-obc-cat-1547_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1547/G_1547_乙6310合6948賓組.png`
- asset id: `asset-001389`
...
- source category: `1547`
- validation class: `1383`
- source image route: `HUST-OBC/deciphered/1547/G_1547_乙6310合6948賓組.png`
- asset id: `asset-001389`
...
- English observation: `A small pointed cluster has two detached upper marks
  and three lower branches.`
...
- dataset label text: `㨁`
- dataset label codepoints: `U+3A01`
...
- Which source records identify obs-char-001384 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001384？
