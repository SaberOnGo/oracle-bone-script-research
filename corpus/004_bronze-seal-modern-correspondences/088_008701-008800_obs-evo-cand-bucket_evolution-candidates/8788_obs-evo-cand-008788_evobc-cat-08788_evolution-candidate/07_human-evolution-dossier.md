...
- External category reference: `evobc-cat-08788`
- Source category ID: `08788`
- Source label for human review: `躬`
- Source codepoints: `U+8EAC`
...
- `obs-evo-cand-008788-route-category-staging`
...
- `obs-evo-cand-008788-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008788-route-evolution-graph`
