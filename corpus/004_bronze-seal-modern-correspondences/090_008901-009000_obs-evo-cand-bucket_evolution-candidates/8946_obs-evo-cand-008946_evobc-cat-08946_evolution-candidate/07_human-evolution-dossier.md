...
- External category reference: `evobc-cat-08946`
- Source category ID: `08946`
- Source label for human review: `运`
- Source codepoints: `U+8FD0`
...
- `obs-evo-cand-008946-route-category-staging`
...
- `obs-evo-cand-008946-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008946-route-evolution-graph`
