# src-yinqi-wenyuan Material Access Index
...
- Target records / 目标记录: source_reference; source_reference;asset_metadata;
  source_reference;oracle_inscription; source_reference;published_research_note
- Metadata profile count / 元数据概况数: 2
- Profile metrics / 概况指标: downloaded_page_size_bytes;
  registered_platform_sections
