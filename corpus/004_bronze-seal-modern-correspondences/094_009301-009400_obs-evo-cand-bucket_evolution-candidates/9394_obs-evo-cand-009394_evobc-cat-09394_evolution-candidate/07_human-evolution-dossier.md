...
- External category reference: `evobc-cat-09394`
- Source category ID: `09394`
- Source label for human review: `銨`
- Source codepoints: `U+92A8`
...
- `obs-evo-cand-009394-route-category-staging`
...
- `obs-evo-cand-009394-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009394-route-evolution-graph`
