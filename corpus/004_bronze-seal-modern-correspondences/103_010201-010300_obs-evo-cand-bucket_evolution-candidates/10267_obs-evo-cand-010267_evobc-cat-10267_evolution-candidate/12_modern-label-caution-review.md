# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010267
...
- EVOBC candidate category: `evobc-evo-cat-10267`.
- Source label for search only: `驪`.
- Source codepoints for search only: `U+9A6A`.
