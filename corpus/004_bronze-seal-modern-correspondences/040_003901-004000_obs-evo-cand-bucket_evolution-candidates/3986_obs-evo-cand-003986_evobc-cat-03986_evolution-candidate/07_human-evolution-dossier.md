...
Project ID: `obs-evo-cand-003986`
...
- Project ID: `obs-evo-cand-003986`
- EVOBC category candidate ID: `evobc-evo-cat-03986`
- External category reference: `evobc-cat-03986`
- Source category ID: `03986`
- Source label for human review: `栏`
- Source codepoints: `U+680F`
...
- `obs-evo-cand-003986-route-category-staging`
...
- `obs-evo-cand-003986-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003986-route-evolution-graph`
