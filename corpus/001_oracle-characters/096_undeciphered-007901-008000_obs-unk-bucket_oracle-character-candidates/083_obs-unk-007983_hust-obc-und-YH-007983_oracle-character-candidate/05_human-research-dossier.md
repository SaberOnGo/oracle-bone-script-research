# obs-unk-007983 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/096_undeciphered-007
  901-008000_obs-unk-bucket_oracle-character-candidates/083_obs-unk-007983_h
  ust-obc-und-YH-007983_oracle-character-candidate/03_visual-assets/001_asse
  t-009574_hust-obc-und-YH-007983_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/605CB/H_？_605CB_0.png`
- asset id: `asset-009574`
...
- source class: `HUST-OBC/undeciphered/Y+H/605CB/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/605CB/H_？_605CB_0.png`
- asset id: `asset-009574`
...
- Which source records identify obs-unk-007983 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007983？
