...
Project ID: `obs-evo-cand-004302`
...
- Project ID: `obs-evo-cand-004302`
- EVOBC category candidate ID: `evobc-evo-cat-04302`
- External category reference: `evobc-cat-04302`
- Source category ID: `04302`
- Source label for human review: `檼`
- Source codepoints: `U+6ABC`
...
- `obs-evo-cand-004302-route-category-staging`
...
- `obs-evo-cand-004302-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004302-route-evolution-graph`
