# obs-char-000184 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000184`
- primary external id: `hust-obc-cat-0203`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/184_obs-char-000184_hust-obc-cat-0203_orac
  le-character/03_visual-assets/001_asset-000189_hust-obc-cat-0203_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0203/G_0203_甲骨文0.png`
- asset id: `asset-000189`
...
- source category: `0203`
- validation class: `183`
- source image route: `HUST-OBC/deciphered/0203/G_0203_甲骨文0.png`
- asset id: `asset-000189`
...
- English observation: `The dark image has a rounded upper enclosure, two
  long side strokes, and a curved lower-right projection crossing the
  interior.`
- 中文观察: `深色图像上方有圆弧围合，两侧有长竖笔，右下方有弯曲伸笔穿过内部。`
...
- dataset label text: `㓁`
- dataset label codepoints: `U+34C1`
...
- Which source records identify obs-char-000184 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000184？
