...
- External category reference: `evobc-cat-12094`
- Source category ID: `12094`
- Source label for human review: `𦯔`
...
- `obs-evo-cand-012094-route-category-staging`
...
- `obs-evo-cand-012094-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012094-route-evolution-graph`
