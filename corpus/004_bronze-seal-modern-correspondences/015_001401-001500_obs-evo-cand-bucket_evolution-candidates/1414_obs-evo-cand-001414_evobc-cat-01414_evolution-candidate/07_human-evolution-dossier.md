...
- External category reference: `evobc-cat-01414`
- Source category ID: `01414`
- Source label for human review: `历`
- Source codepoints: `U+5386`
...
- `obs-evo-cand-001414-route-category-staging`
...
- `obs-evo-cand-001414-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001414-route-evolution-graph`
