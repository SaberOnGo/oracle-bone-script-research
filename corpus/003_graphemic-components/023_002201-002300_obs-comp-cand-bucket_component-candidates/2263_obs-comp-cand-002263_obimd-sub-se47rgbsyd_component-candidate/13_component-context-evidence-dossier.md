# obs-comp-cand-002263 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002263`
- 首选外部 ID: `obimd-sub-se47rgbsyd`
- OBIMD subcharacter UID: `se47rgbsyd`
- OBIMD main character UID: `se47rgbsyd`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+B292A;U+FCFE8; U+FCFE9
