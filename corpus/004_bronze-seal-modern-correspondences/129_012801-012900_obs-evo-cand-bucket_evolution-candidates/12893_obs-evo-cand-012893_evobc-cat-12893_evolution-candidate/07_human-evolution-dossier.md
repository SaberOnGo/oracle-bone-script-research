...
- External category reference: `evobc-cat-12893`
- Source category ID: `12893`
- Source label for human review: `𪼝`
- Source codepoints: `U+2AF1D`
...
- `obs-evo-cand-012893-route-category-staging`
...
- `obs-evo-cand-012893-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012893-route-evolution-graph`
