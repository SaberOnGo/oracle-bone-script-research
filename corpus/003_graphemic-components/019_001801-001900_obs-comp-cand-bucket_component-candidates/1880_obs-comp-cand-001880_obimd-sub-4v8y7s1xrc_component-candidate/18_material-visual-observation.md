# Material Visual Observation / obs-comp-cand-001880 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001880`
- External reference / 外部参照: `obimd-sub-4v8y7s1xrc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018259_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/nf3yu2ct27/4v8y7s1xrc/4v8y7s1xrc.png`
- Checksum / 校验和:
  `c5dbc813c12ec0870912f41f36a6aa62ccf9f3fa6fbdf6ec41fbef8499781695`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.87%.
- Marked-pixel bounds: (32,23)–(220,213); span 189 × 191 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.87%。
- 痕迹范围：(32,23)–(220,213)；跨度189 × 191 px；痕迹矩形近方形。
