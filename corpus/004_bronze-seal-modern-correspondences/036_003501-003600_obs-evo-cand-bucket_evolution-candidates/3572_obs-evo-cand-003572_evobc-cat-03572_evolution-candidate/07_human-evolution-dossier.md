...
- Project ID: `obs-evo-cand-003572`
- EVOBC category candidate ID: `evobc-evo-cat-03572`
- External category reference: `evobc-cat-03572`
- Source category ID: `03572`
- Source label for human review: `故`
- Source codepoints: `U+6545`
...
- `obs-evo-cand-003572-route-category-staging`
...
- `obs-evo-cand-003572-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003572-route-evolution-graph`
