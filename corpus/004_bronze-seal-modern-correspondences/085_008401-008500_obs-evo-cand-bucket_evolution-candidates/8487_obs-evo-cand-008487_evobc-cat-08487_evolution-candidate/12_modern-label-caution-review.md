# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008487
...
- EVOBC candidate category: `evobc-evo-cat-08487`.
- Source label for search only: `豚`.
- Source codepoints for search only: `U+8C5A`.
