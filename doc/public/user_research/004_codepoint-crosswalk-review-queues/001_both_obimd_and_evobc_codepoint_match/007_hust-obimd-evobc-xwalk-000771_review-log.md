...
- Review log draft ID / 复核日志草稿 ID: `codepoint-crosswalk-review-log-draft-007`
- Codepoint review task ID / codepoint 复核任务 ID: `codepoint-crosswalk-review-007`
...
- Crosswalk candidate ID / 交叉候选 ID: `hust-obimd-evobc-xwalk-000771`
- Suggested oracle character ID / 建议甲骨单字 ID: `obs-char-000771`
- Promotion queue ID / 提升队列 ID: `hust-obc-obs-char-promo-000771`
...
- HUST external ref / HUST 外部引用: `hust-obc-cat-0875`
- HUST label codepoints / HUST 标签 codepoint: `U+3761`
- OBIMD main candidates / OBIMD 主字候选: `obimd-main-cand-002291`
- EVOBC category candidates / EVOBC 类别候选: `evobc-evo-cat-00070`
...
- `corpus/001_oracle-characters/008_000701-000800_obs-char-bucket_oracle-characters/771_obs-char-000771_hust-obc-cat-0875_oracle-character/01_candidate-character-packet.json`
...
- Route availability ID: `codepoint-route-availability-007`
...
- Review task ID: `codepoint-crosswalk-review-007`
- Crosswalk candidate ID: `hust-obimd-evobc-xwalk-000771`
- Suggested oracle character ID: `obs-char-000771`
- HUST candidate packet ID: `hust-obc-candidate-packet-000771`
...
- OBIMD row count: `1`
- OBIMD source UIDs: `ojtpg03v54`
- OBIMD review statuses: `obimd-main-cand-002291=reviewed_metadata_only`
- OBIMD rights statuses: `obimd-main-cand-002291=licensed_for_repository`
- EVOBC row count: `1`
- EVOBC source category IDs: `00070`
- EVOBC has bronze refs: `false`
- EVOBC has seal refs: `false`
- EVOBC review statuses: `evobc-evo-cat-00070=reviewed_metadata_only`
- EVOBC rights statuses: `evobc-evo-cat-00070=source_marked_risk_noted`
...
- Does `hust-obimd-evobc-xwalk-000771` remain unpromoted and undeciphered?
