...
- External category reference: `evobc-cat-11152`
- Source category ID: `11152`
- Source label for human review: `𢇊`
- Source codepoints: `U+221CA`
...
- `obs-evo-cand-011152-route-category-staging`
...
- `obs-evo-cand-011152-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011152-route-evolution-graph`
