# Material Visual Observation / obs-comp-cand-000291 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000291`
- External reference / 外部参照: `obimd-sub-rkegfad4bl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011999_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rkegfad4bl/rkegfad4bl/rkegfad4bl.png`
- Checksum / 校验和:
  `bf282043332f735a9e9595f9bf70dc2b08761bc7d131efd953e2a1faf4da1ffd`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.20%.
- Marked-pixel bounds: (64,48)–(185,201); span 122 × 154 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.20%。
- 痕迹范围：(64,48)–(185,201)；跨度122 × 154 px；痕迹矩形高于宽。
