...
- External category reference: `evobc-cat-06400`
- Source category ID: `06400`
- Source label for human review: `粟`
- Source codepoints: `U+7C9F`
...
- `obs-evo-cand-006400-route-category-staging`
...
- `obs-evo-cand-006400-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006400-route-evolution-graph`
