...
- External category reference: `evobc-cat-09399`
- Source category ID: `09399`
- Source label for human review: `銻`
- Source codepoints: `U+92BB`
...
- `obs-evo-cand-009399-route-category-staging`
...
- `obs-evo-cand-009399-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009399-route-evolution-graph`
