...
Project ID: `obs-evo-cand-008760`
...
- Project ID: `obs-evo-cand-008760`
- EVOBC category candidate ID: `evobc-evo-cat-08760`
- External category reference: `evobc-cat-08760`
- Source category ID: `08760`
- Source label for human review: `蹛`
- Source codepoints: `U+8E5B`
...
- `obs-evo-cand-008760-route-category-staging`
...
- `obs-evo-cand-008760-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008760-route-evolution-graph`
