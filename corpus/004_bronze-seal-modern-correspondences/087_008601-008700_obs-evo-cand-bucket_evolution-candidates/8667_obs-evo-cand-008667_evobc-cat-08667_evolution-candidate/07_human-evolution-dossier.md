...
- Project ID: `obs-evo-cand-008667`
- EVOBC category candidate ID: `evobc-evo-cat-08667`
- External category reference: `evobc-cat-08667`
- Source category ID: `08667`
- Source label for human review: `赽`
- Source codepoints: `U+8D7D`
...
- `obs-evo-cand-008667-route-category-staging`
...
- `obs-evo-cand-008667-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008667-route-evolution-graph`
