...
Project ID: `obs-evo-cand-010664`
...
- Project ID: `obs-evo-cand-010664`
- EVOBC category candidate ID: `evobc-evo-cat-10664`
- External category reference: `evobc-cat-10664`
- Source category ID: `10664`
- Source label for human review: `黵`
- Source codepoints: `U+9EF5`
...
- `obs-evo-cand-010664-route-category-staging`
...
- `obs-evo-cand-010664-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010664-route-evolution-graph`
