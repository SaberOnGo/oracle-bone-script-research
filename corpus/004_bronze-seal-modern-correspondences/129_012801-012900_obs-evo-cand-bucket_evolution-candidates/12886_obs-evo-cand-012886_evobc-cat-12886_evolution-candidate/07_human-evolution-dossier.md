...
- External category reference: `evobc-cat-12886`
- Source category ID: `12886`
- Source label for human review: `𪺈`
- Source codepoints: `U+2AE88`
...
- `obs-evo-cand-012886-route-category-staging`
...
- `obs-evo-cand-012886-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012886-route-evolution-graph`
