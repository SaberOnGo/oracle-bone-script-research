# Material Visual Observation / obs-comp-cand-000194 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000194`
- External reference / 外部参照: `obimd-sub-k6l649jf98`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011755_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/k6l649jf98/k6l649jf98/k6l649jf98.png`
- Checksum / 校验和:
  `e3e084109f08e30ef6cc6e6cf53b358aac3b90e73fdf28b42a91332c1f66d94c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.07%.
- Marked-pixel bounds: (66,28)–(183,227); span 118 × 200 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.07%。
- 痕迹范围：(66,28)–(183,227)；跨度118 × 200 px；痕迹矩形高于宽。
