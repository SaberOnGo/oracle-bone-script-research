# Material Visual Observation / obs-comp-cand-002340 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002340`
- External reference / 外部参照: `obimd-sub-mdwfmpr3c8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020359_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/mdwfmpr3c8/mdwfmpr3c8/6fxcg58xzq.png`
- Checksum / 校验和:
  `08a5f11a979fc6dbe92bee4f3e740296d5be45a901fdf594a7d6fafe23db6001`
...
- Marked-pixel bounds: (69,43)–(180,200); span 112 × 158 px; the marked
...
- 痕迹范围：(69,43)–(180,200)；跨度112 × 158 px；痕迹矩形高于宽。
