...
Project ID: `obs-evo-cand-006159`
...
- Project ID: `obs-evo-cand-006159`
- EVOBC category candidate ID: `evobc-evo-cat-06159`
- External category reference: `evobc-cat-06159`
- Source category ID: `06159`
- Source label for human review: `窋`
- Source codepoints: `U+7A8B`
...
- `obs-evo-cand-006159-route-category-staging`
...
- `obs-evo-cand-006159-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006159-route-evolution-graph`
