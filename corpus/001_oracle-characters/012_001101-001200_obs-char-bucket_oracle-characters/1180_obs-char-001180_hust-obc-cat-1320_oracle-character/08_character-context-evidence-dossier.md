...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1320`
...
- Source image / 来源图: `G_1320_乙1462合6531賓組.png`
- Image / 图像: `001_asset-001185_hust-obc-cat-1320_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合6531
  (G_1320_乙1462合6531賓組.png)`
...
- target node: `evobc-evo-cat-00115`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00115`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00115`
- EvoBC image references / EvoBC 图像引用数: `4`
...
- Matched candidate folders / 匹配候选目录: `evobc-evo-cat-00115`
- Human review files / 人类复核文件:
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/115_obs-evo-cand-000115_evobc-cat-00115_evoluti
...
- Source label text / 来源标签文字: `㤞`
- Source label codepoint / 来源标签 codepoint: `U+391E`
