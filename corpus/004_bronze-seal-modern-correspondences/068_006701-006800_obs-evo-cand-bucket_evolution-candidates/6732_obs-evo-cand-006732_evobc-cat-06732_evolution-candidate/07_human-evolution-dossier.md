...
Project ID: `obs-evo-cand-006732`
...
- Project ID: `obs-evo-cand-006732`
- EVOBC category candidate ID: `evobc-evo-cat-06732`
- External category reference: `evobc-cat-06732`
- Source category ID: `06732`
- Source label for human review: `纶`
- Source codepoints: `U+7EB6`
...
- `obs-evo-cand-006732-route-category-staging`
...
- `obs-evo-cand-006732-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006732-route-evolution-graph`
