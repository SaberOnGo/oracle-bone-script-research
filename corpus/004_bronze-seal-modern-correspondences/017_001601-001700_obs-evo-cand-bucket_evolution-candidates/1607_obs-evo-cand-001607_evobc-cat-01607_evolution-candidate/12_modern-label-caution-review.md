# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001607
...
- EVOBC candidate category: `evobc-evo-cat-01607`.
- Source label for search only: `唫`.
- Source codepoints for search only: `U+552B`.
