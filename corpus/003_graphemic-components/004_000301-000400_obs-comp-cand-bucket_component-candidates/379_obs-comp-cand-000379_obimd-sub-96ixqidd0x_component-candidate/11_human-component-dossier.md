# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-000379
...
- glyph_codepoint_uplus_sample: `U+F23A7, U+F23A8, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-012302` | `001_asset-012302_img.png` | `2b153fab1a2666b770847113a7b4cdcd534a32bd0fdad346d7ca663c6e084eea` |
