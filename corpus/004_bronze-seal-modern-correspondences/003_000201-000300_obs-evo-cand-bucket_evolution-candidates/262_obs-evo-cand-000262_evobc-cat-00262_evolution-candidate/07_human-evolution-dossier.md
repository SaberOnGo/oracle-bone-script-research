...
- External category reference: `evobc-cat-00262`
- Source category ID: `00262`
- Source label for human review: `㾪`
- Source codepoints: `U+3FAA`
...
- `obs-evo-cand-000262-route-category-staging`
...
- `obs-evo-cand-000262-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000262-route-evolution-graph`
