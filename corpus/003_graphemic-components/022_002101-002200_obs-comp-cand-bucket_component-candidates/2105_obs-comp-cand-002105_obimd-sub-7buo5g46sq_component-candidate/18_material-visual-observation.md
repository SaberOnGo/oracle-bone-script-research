# Material Visual Observation / obs-comp-cand-002105 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002105`
- External reference / 外部参照: `obimd-sub-7buo5g46sq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019556_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jxtkszwkrq/7buo5g46sq/7buo5g46sq.png`
- Checksum / 校验和:
  `6481fb90d289c5e71128a46b63d9710a5488c3796040ac706c34cb3adf90ff82`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.04%.
- Marked-pixel bounds: (89,27)–(160,216); span 72 × 190 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.04%。
- 痕迹范围：(89,27)–(160,216)；跨度72 × 190 px；痕迹矩形高于宽。
