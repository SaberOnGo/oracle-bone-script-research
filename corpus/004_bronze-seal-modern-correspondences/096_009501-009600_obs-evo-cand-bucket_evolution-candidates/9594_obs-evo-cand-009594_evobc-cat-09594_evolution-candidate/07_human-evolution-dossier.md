...
- Project ID: `obs-evo-cand-009594`
- EVOBC category candidate ID: `evobc-evo-cat-09594`
- External category reference: `evobc-cat-09594`
- Source category ID: `09594`
- Source label for human review: `锐`
- Source codepoints: `U+9510`
...
- `obs-evo-cand-009594-route-category-staging`
...
- `obs-evo-cand-009594-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009594-route-evolution-graph`
