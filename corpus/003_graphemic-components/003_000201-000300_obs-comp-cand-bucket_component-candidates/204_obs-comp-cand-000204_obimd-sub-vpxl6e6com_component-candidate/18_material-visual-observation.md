# Material Visual Observation / obs-comp-cand-000204 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000204`
- External reference / 外部参照: `obimd-sub-vpxl6e6com`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011765_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h44zkm9mt8/vpxl6e6com/vpxl6e6com.png`
- Checksum / 校验和:
  `1d2ee67e76aade75c134a6aceaf2013351b91cfee4501fdb2c49d669ec5822f4`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.54%.
- Marked-pixel bounds: (53,41)–(196,206); span 144 × 166 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.54%。
- 痕迹范围：(53,41)–(196,206)；跨度144 × 166 px；痕迹矩形近方形。
