# obs-unk-008970 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/106_undeciphered-008
  901-009000_obs-unk-bucket_oracle-character-candidates/070_obs-unk-008970_h
  ust-obc-und-YH-008970_oracle-character-candidate/03_visual-assets/001_asse
  t-010561_hust-obc-und-YH-008970_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60FD5/Y_？_60FD5.jpg`
- asset id: `asset-010561`
...
- source class: `HUST-OBC/undeciphered/Y+H/60FD5/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60FD5/Y_？_60FD5.jpg`
- asset id: `asset-010561`
...
- Which source records identify obs-unk-008970 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008970？
