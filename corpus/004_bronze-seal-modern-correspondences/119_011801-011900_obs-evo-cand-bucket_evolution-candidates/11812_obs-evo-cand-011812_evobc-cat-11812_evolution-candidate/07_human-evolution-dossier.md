...
- External category reference: `evobc-cat-11812`
- Source category ID: `11812`
- Source label for human review: `𥘸`
- Source codepoints: `U+25638`
...
- `obs-evo-cand-011812-route-category-staging`
...
- `obs-evo-cand-011812-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011812-route-evolution-graph`
