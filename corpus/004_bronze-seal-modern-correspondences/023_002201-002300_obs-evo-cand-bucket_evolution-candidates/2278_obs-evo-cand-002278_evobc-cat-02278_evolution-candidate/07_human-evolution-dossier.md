...
Project ID: `obs-evo-cand-002278`
...
- Project ID: `obs-evo-cand-002278`
- EVOBC category candidate ID: `evobc-evo-cat-02278`
- External category reference: `evobc-cat-02278`
- Source category ID: `02278`
- Source label for human review: `嫯`
- Source codepoints: `U+5AEF`
...
- `obs-evo-cand-002278-route-category-staging`
...
- `obs-evo-cand-002278-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002278-route-evolution-graph`
