# obs-char-000544 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000544`
- primary external id: `hust-obc-cat-0618`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/544_obs-char-000544_hust-obc-cat-0618_orac
  le-character/03_visual-assets/001_asset-000549_hust-obc-cat-0618_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0618/G_0618_甲骨文0.png`
- asset id: `asset-000549`
...
- source category: `0618`
- validation class: `543`
- source image route: `HUST-OBC/deciphered/0618/G_0618_甲骨文0.png`
- asset id: `asset-000549`
...
- English observation: `Two angular looped forms are stacked at left, while
  a tall bent stroke at right carries a top bar and two short rightward
  branches.`
- 中文观察: `左侧层叠两个折角环形，右侧高长弯折笔带一条顶横和两条向右短枝。`
...
- dataset label text: `㙠`
- dataset label codepoints: `U+3660`
...
- Which source records identify obs-char-000544 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000544？
