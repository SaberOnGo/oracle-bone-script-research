# obs-evo-cand-006389 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-06389`
- Source label for human review: `米`
- Source codepoints: `U+7C73`
- Image reference count: `71`
- Era token counts: `CS:2;OBC:48;SS:2;WSC:19`
- Source token counts: `Book:16;Web:55`
