...
- Project ID: `obs-evo-cand-006500`
- EVOBC category candidate ID: `evobc-evo-cat-06500`
- External category reference: `evobc-cat-06500`
- Source category ID: `06500`
- Source label for human review: `絓`
- Source codepoints: `U+7D53`
...
- `obs-evo-cand-006500-route-category-staging`
...
- `obs-evo-cand-006500-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006500-route-evolution-graph`
