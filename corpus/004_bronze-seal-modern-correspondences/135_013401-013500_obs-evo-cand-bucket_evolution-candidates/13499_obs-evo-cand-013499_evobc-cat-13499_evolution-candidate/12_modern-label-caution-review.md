# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013499
...
- EVOBC candidate category: `evobc-evo-cat-13499`.
- Source label for search only: `𭎦`.
- Source codepoints for search only: `U+2D3A6`.
