# obs-char-001103 Visual Gallery / obs-char-001103 图像资料页
...
- Project ID / 项目 ID: `obs-char-001103`
- Primary external reference / 首选外部参考: `hust-obc-cat-1233`
...
## obs-char-001103-visual-source-001 / 图像条目

![obs-char-001103 glyph candidate](03_visual-assets/001_asset-001108_hust-obc-cat-1233_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-001108_hust-obc-cat-1233_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-001108_hust-obc-cat-1233_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/1233/G_1233_後2.8.7合3337賓組.png`
