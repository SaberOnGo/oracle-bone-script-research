...
- External category reference: `evobc-cat-05937`
- Source category ID: `05937`
...
- `obs-evo-cand-005937-route-category-staging`
...
- `obs-evo-cand-005937-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005937-route-evolution-graph`
