# Material Visual Observation / obs-comp-cand-000957 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000957`
- External reference / 外部参照: `obimd-sub-tdznjmpywo`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014040_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tdznjmpywo/tdznjmpywo/tdznjmpywo.png`
- Checksum / 校验和:
  `1fe3d7c567e7be7cb828f79217577659e410a70a59945d706311de04befd509f`
...
- Marked-pixel bounds: (65,41)–(184,210); span 120 × 170 px; the marked
...
- 痕迹范围：(65,41)–(184,210)；跨度120 × 170 px；痕迹矩形高于宽。
