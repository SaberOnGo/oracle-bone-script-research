# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001877
...
| --- | --- | --- | --- |
| `obimd-glyph-link-028515` | 򲦰󺮲 | `U+B29B0;U+FABB2` | `reviewed_metadata_only` |
| `obimd-glyph-link-028516` | 󺯖 | `U+FABD6` | `reviewed_metadata_only` |
| `obimd-glyph-link-028517` | 󺯗 | `U+FABD7` | `reviewed_metadata_only` |
