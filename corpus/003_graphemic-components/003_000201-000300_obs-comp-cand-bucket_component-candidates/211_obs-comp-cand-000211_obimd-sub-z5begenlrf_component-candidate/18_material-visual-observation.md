# Material Visual Observation / obs-comp-cand-000211 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000211`
- External reference / 外部参照: `obimd-sub-z5begenlrf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011856_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/z5begenlrf/z5begenlrf/z5begenlrf.png`
- Checksum / 校验和:
  `d5d667e94be57277e07ca6d4b20a163743f6d88790eb0f4f4a28aa8a91383e32`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.58%.
- Marked-pixel bounds: (81,18)–(168,236); span 88 × 219 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.58%。
- 痕迹范围：(81,18)–(168,236)；跨度88 × 219 px；痕迹矩形高于宽。
