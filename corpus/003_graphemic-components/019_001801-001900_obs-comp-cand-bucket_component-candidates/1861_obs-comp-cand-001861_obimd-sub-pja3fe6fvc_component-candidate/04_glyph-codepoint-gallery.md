# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001861
...
| --- | --- | --- | --- |
| `obimd-glyph-link-028223` | 󺨽 | `U+FAA3D` | `reviewed_metadata_only` |
| `obimd-glyph-link-028224` | 󺨾 | `U+FAA3E` | `reviewed_metadata_only` |
| `obimd-glyph-link-028225` | 󺨿 | `U+FAA3F` | `reviewed_metadata_only` |
