# obs-unk-004783 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/083_obs-unk-004783_h
  ust-obc-und-X-004783_oracle-character-candidate/03_visual-assets/001_asset
  -006376_hust-obc-und-X-004783_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/339/X_？_7321_1.png`
- asset id: `asset-006376`
...
- source class: `HUST-OBC/undeciphered/X/339/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/339/X_？_7321_1.png`
- asset id: `asset-006376`
...
- English observation: `two upper groups with detached vertical fragments`
- 中文观察: `两个上部结构和分离的竖向片段`
...
- Which source records identify obs-unk-004783 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004783？
