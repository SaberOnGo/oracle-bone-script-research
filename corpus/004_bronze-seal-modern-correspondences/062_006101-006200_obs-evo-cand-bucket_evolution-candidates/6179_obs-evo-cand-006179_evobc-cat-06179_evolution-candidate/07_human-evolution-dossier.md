...
- Project ID: `obs-evo-cand-006179`
- EVOBC category candidate ID: `evobc-evo-cat-06179`
- External category reference: `evobc-cat-06179`
- Source category ID: `06179`
- Source label for human review: `窱`
- Source codepoints: `U+7AB1`
...
- `obs-evo-cand-006179-route-category-staging`
...
- `obs-evo-cand-006179-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006179-route-evolution-graph`
