# obs-unk-004161 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/061_obs-unk-004161_h
  ust-obc-und-L-004161_oracle-character-candidate/03_visual-assets/001_asset
  -005754_hust-obc-und-L-004161_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4161/L_？_9015.jpg`
- asset id: `asset-005754`
...
- source class: `HUST-OBC/undeciphered/L/4161/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4161/L_？_9015.jpg`
- asset id: `asset-005754`
...
- English observation: A compact angular upper trace has several lower
  descending strokes.
- 中文观察: 上部有紧凑折角痕迹，下方有数条下伸笔画。
...
- Which source records identify obs-unk-004161 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004161？
