# obs-char-000273 Visual Gallery / obs-char-000273 图像资料页
...
- Project ID / 项目 ID: `obs-char-000273`
- Primary external reference / 首选外部参考: `hust-obc-cat-0308`
...
## obs-char-000273-visual-source-001 / 图像条目

![obs-char-000273 glyph candidate](03_visual-assets/001_asset-000278_hust-obc-cat-0308_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000278_hust-obc-cat-0308_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000278_hust-obc-cat-0308_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/0308/G_0308_前2.4.1(甲).png`
