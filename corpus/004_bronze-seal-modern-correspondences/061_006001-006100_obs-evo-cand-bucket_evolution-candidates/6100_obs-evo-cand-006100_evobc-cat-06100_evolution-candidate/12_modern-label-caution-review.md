# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006100
...
- EVOBC candidate category: `evobc-evo-cat-06100`.
- Source label for search only: `稙`.
- Source codepoints for search only: `U+7A19`.
