# obs-char-001101 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1101_obs-char-001101_hust-obc-cat-1230_ora
  cle-character/03_visual-assets/001_asset-001106_hust-obc-cat-1230_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1230/G_1230_甲骨文0.png`
- asset id: `asset-001106`
...
- source category: `1230`
- validation class: `1100`
- source image route: `HUST-OBC/deciphered/1230/G_1230_甲骨文0.png`
- asset id: `asset-001106`
...
- English observation: `A narrow upright form combines a long left curve
  with a central chain of crossings and short upper branches.`
- 中文观察: `狭长直立形体结合长左侧弯笔、中央连续交叉和短上部分枝。`
...
- dataset label text: `㣄`
- dataset label codepoints: `U+38C4`
...
- Which source records identify obs-char-001101 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001101？
