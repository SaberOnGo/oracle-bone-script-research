# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006750
...
- EVOBC candidate category: `evobc-evo-cat-06750`.
- Source label for search only: `络`.
- Source codepoints for search only: `U+7EDC`.
