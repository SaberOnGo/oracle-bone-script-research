...
Project ID: `obs-insc-cw-cand-000194`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000194`
...
- Yingguo / 英国所藏: `y1172` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `88` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `405` in source row; primary catalog entry pending
- Heji / 合集: `40441` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000194`
