...
- External category reference: `evobc-cat-02160`
- Source category ID: `02160`
- Source label: `娎`
...
- `obs-evo-cand-002160-route-category-staging`
...
- `obs-evo-cand-002160-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002160-route-evolution-graph`
