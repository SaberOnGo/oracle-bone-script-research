...
- External category reference: `evobc-cat-01387`
- Source category ID: `01387`
- Source label for human review: `卢`
...
- `obs-evo-cand-001387-route-category-staging`
...
- `obs-evo-cand-001387-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001387-route-evolution-graph`
