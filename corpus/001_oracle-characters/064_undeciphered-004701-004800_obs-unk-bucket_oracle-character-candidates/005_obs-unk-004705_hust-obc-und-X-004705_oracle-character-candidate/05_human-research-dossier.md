# obs-unk-004705 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004705`
- primary external id: `hust-obc-und-X-004705`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/005_obs-unk-004705_h
  ust-obc-und-X-004705_oracle-character-candidate/03_visual-assets/001_asset
  -006298_hust-obc-und-X-004705_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/261/X_？_7233_1.png`
- asset id: `asset-006298`
...
- source class: `HUST-OBC/undeciphered/X/261/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/261/X_？_7233_1.png`
- asset id: `asset-006298`
...
- English observation: `broad curved enclosure with branching middle strokes`
- 中文观察: `带中部分支笔画的宽弯曲围合结构`
...
- Which source records identify obs-unk-004705 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004705？
