# obs-char-000512 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000512`
- primary external id: `hust-obc-cat-0583`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/512_obs-char-000512_hust-obc-cat-0583_orac
  le-character/03_visual-assets/001_asset-000517_hust-obc-cat-0583_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0583/G_0583_乙405合19941𠂤組.png`
- asset id: `asset-000517`
...
- source category: `0583`
- validation class: `511`
- source image route: `HUST-OBC/deciphered/0583/G_0583_乙405合19941𠂤組.png`
- asset id: `asset-000517`
...
- English observation: `A single sinuous form curves into a broad open loop,
  with one short upper branch, a left-pointing stroke, and a thin descending
  tail.`
...
- dataset label text: `㘽`
- dataset label codepoints: `U+363D`
...
- filename catalog route clues: `Heji-like filename clue: 合19941
  (G_0583_乙405合19941𠂤組.png)`
...
- Which source records identify obs-char-000512 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000512？
