# Material Visual Observation / obs-comp-cand-001671 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001671`
- External reference / 外部参照: `obimd-sub-ww3br4ay1g`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017587_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cixqnyxp9v/ww3br4ay1g/ww3br4ay1g.png`
- Checksum / 校验和:
  `aba1146d10a1cf015659fef3fd5087d2029c1b080c94450968a180eb4a90c51b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.17%.
- Marked-pixel bounds: (77,33)–(172,213); span 96 × 181 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.17%。
- 痕迹范围：(77,33)–(172,213)；跨度96 × 181 px；痕迹矩形高于宽。
