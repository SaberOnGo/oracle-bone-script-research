# obs-comp-cand-000482 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000482`
- 首选外部 ID: `obimd-sub-wfew4citrk`
- OBIMD subcharacter UID: `wfew4citrk`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+C9F62;U+F2DAA; U+F2DAB; 另有 1 项
