# obs-char-001237 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1237_obs-char-001237_hust-obc-cat-1384_ora
  cle-character/03_visual-assets/001_asset-001242_hust-obc-cat-1384_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1384/G_1384_京都1272合24944.png`
- asset id: `asset-001242`
...
- source category: `1384`
- validation class: `1236`
- source image route: `HUST-OBC/deciphered/1384/G_1384_京都1272合24944.png`
- asset id: `asset-001242`
...
- English observation: `A compact rounded form has several short upper
  prongs, a central open loop, and a short lower base.`
- 中文观察: `紧凑圆弧形体有数条短上部尖枝、中央开放环和短下部底笔。`
...
- dataset label text: `㥞`
- dataset label codepoints: `U+395E`
...
- filename catalog route clues: `Heji-like filename clue: 合24944
...
- Which source records identify obs-char-001237 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001237？
