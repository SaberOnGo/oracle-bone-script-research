# Material Visual Observation / obs-comp-cand-000129 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000129`
- External reference / 外部参照: `obimd-sub-yvbokzhzmz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011541_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/yvbokzhzmz/yvbokzhzmz/yvbokzhzmz.png`
- Checksum / 校验和:
  `bcc1c318abef108b44ba419e7f9082a77d8fcf66b266cd9a3393ba57a128cbc6`
...
- Marked-pixel bounds: (52,31)–(197,215); span 146 × 185 px; the marked
...
- 痕迹范围：(52,31)–(197,215)；跨度146 × 185 px；痕迹矩形高于宽。
