# obs-unk-003963 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003963`
- primary external id: `hust-obc-und-L-003963`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/063_obs-unk-003963_h
  ust-obc-und-L-003963_oracle-character-candidate/03_visual-assets/001_asset
  -005556_hust-obc-und-L-003963_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3963/L_？_8362.jpg`
- asset id: `asset-005556`
...
- source class: `HUST-OBC/undeciphered/L/3963/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3963/L_？_8362.jpg`
- asset id: `asset-005556`
...
- English observation: A broad angular form has a tall central trace, middle
  crossings, and lower traces bending inward on both sides.
- 中文观察：较宽折角形体有较高中央痕迹，中部有交叉痕，下部两侧向内弯折。
...
- Which source records identify obs-unk-003963 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003963？
