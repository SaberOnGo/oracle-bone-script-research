...
- External category reference: `evobc-cat-00306`
- Source category ID: `00306`
...
- `obs-evo-cand-000306-route-category-staging`
...
- `obs-evo-cand-000306-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000306-route-evolution-graph`
