...
- Project ID: `obs-evo-cand-001251`
- EVOBC category candidate ID: `evobc-evo-cat-01251`
- External category reference: `evobc-cat-01251`
- Source category ID: `01251`
- Source label for human review: `劇`
- Source codepoints: `U+5287`
...
- `obs-evo-cand-001251-route-category-staging`
...
- `obs-evo-cand-001251-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001251-route-evolution-graph`
