...
- External category reference: `evobc-cat-00227`
- Source category ID: `00227`
- Source label for human review: `㸔`
...
- `obs-evo-cand-000227-route-category-staging`
...
- `obs-evo-cand-000227-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000227-route-evolution-graph`
