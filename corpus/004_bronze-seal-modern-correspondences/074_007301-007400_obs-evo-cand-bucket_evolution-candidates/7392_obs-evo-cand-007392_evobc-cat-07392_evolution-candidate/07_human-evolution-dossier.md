...
Project ID: `obs-evo-cand-007392`
...
- Project ID: `obs-evo-cand-007392`
- EVOBC category candidate ID: `evobc-evo-cat-07392`
- External category reference: `evobc-cat-07392`
- Source category ID: `07392`
- Source label for human review: `莪`
- Source codepoints: `U+83AA`
...
- `obs-evo-cand-007392-route-category-staging`
...
- `obs-evo-cand-007392-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007392-route-evolution-graph`
