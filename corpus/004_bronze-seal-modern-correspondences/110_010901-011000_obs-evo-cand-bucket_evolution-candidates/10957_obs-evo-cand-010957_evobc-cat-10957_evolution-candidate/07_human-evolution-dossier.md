...
- External category reference: `evobc-cat-10957`
- Source category ID: `10957`
- Source label for human review: `𠽽`
...
- `obs-evo-cand-010957-route-category-staging`
...
- `obs-evo-cand-010957-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010957-route-evolution-graph`
