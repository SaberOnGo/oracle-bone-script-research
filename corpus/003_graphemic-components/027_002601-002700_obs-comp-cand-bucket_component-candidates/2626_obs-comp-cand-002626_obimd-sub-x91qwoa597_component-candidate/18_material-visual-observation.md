# Material Visual Observation / obs-comp-cand-002626 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002626`
- External reference / 外部参照: `obimd-sub-x91qwoa597`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021165_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/x91qwoa597/x91qwoa597/x91qwoa597.png`
- Checksum / 校验和:
  `f9366d67e42602791e14cea15f359d1d4b03307c0d0e6fcd37a956c9bb79c243`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.99%.
- Marked-pixel bounds: (83,28)–(195,223); span 113 × 196 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.99%。
- 痕迹范围：(83,28)–(195,223)；跨度113 × 196 px；痕迹矩形高于宽。
