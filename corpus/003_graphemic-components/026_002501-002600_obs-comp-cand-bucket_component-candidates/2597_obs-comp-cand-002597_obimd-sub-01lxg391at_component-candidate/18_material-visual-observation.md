# Material Visual Observation / obs-comp-cand-002597 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002597`
- External reference / 外部参照: `obimd-sub-01lxg391at`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021136_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/01lxg391at/01lxg391at/01lxg391at.png`
- Checksum / 校验和:
  `eba5c926e5b16746b59cd3d33678fc62f9d07e43dfb08ebdbc466dbbea044bb4`
...
- Marked-pixel bounds: (71,17)–(156,232); span 86 × 216 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.98%。
- 痕迹范围：(71,17)–(156,232)；跨度86 × 216 px；痕迹矩形高于宽。
