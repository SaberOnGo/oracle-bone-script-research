...
Project ID: `obs-evo-cand-003958`
...
- Project ID: `obs-evo-cand-003958`
- EVOBC category candidate ID: `evobc-evo-cat-03958`
- External category reference: `evobc-cat-03958`
- Source category ID: `03958`
- Source label for human review: `柘`
- Source codepoints: `U+67D8`
...
- `obs-evo-cand-003958-route-category-staging`
...
- `obs-evo-cand-003958-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003958-route-evolution-graph`
