# Material Visual Observation / obs-comp-cand-002418 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002418`
- External reference / 外部参照: `obimd-sub-fzdfz5gkld`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020489_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fzdfz5gkld/fzdfz5gkld/fzdfz5gkld.png`
- Checksum / 校验和:
  `9123035229a31df20d6420cd83c221b151f293d308315161ebf50824c47a7277`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.23%.
- Marked-pixel bounds: (92,34)–(167,214); span 76 × 181 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.23%。
- 痕迹范围：(92,34)–(167,214)；跨度76 × 181 px；痕迹矩形高于宽。
