# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008164
...
- EVOBC candidate category: `evobc-evo-cat-08164`.
- Source label for search only: `詀`.
- Source codepoints for search only: `U+8A40`.
