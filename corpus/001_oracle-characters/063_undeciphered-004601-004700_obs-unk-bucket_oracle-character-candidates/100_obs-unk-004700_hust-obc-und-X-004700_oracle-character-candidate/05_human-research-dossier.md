# obs-unk-004700 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004700`
- primary external id: `hust-obc-und-X-004700`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/100_obs-unk-004700_h
  ust-obc-und-X-004700_oracle-character-candidate/03_visual-assets/001_asset
  -006293_hust-obc-und-X-004700_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/256/X_？_7229_1.png`
- asset id: `asset-006293`
...
- source class: `HUST-OBC/undeciphered/X/256/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/256/X_？_7229_1.png`
- asset id: `asset-006293`
...
- English observation: `broad lower mass with tall central opening`
- 中文观察: `带中央高开口的宽大下部笔画组`
...
- Which source records identify obs-unk-004700 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004700？
