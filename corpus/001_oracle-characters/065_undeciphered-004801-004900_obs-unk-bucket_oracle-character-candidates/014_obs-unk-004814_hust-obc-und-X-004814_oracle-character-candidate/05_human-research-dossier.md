# obs-unk-004814 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/014_obs-unk-004814_h
  ust-obc-und-X-004814_oracle-character-candidate/03_visual-assets/001_asset
  -006407_hust-obc-und-X-004814_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/370/X_？_7355_1.png`
- asset id: `asset-006407`
...
- source class: `HUST-OBC/undeciphered/X/370/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/370/X_？_7355_1.png`
- asset id: `asset-006407`
...
- English observation: `upper opening, middle pale openings, and lower branches`
- 中文观察: `上部开口、中部浅色开口和下部的分支结构`
...
- Which source records identify obs-unk-004814 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004814？
