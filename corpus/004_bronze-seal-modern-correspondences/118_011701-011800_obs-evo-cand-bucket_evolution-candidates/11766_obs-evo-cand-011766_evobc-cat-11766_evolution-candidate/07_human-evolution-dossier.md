...
- External category reference: `evobc-cat-11766`
- Source category ID: `11766`
- Source label for human review: `𥃍`
- Source codepoints: `U+250CD`
...
- `obs-evo-cand-011766-route-category-staging`
...
- `obs-evo-cand-011766-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011766-route-evolution-graph`
