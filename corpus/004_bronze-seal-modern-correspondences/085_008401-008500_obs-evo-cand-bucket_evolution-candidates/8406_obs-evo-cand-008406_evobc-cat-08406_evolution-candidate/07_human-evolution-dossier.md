...
Project ID: `obs-evo-cand-008406`
...
- Project ID: `obs-evo-cand-008406`
- EVOBC category candidate ID: `evobc-evo-cat-08406`
- External category reference: `evobc-cat-08406`
- Source category ID: `08406`
- Source label for human review: `讯`
- Source codepoints: `U+8BAF`
...
- `obs-evo-cand-008406-route-category-staging`
...
- `obs-evo-cand-008406-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008406-route-evolution-graph`
