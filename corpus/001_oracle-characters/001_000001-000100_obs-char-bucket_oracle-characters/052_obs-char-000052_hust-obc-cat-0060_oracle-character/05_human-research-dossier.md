# obs-char-000052 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000052`
- primary external id: `hust-obc-cat-0060`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/052_obs-char-000052_hust-obc-cat-0060_orac
  le-character/03_visual-assets/001_asset-000057_hust-obc-cat-0060_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0060/G_0060_粹720(甲).png`
- asset id: `asset-000057`
...
- source category: `0060`
- validation class: `51`
- source image route: `HUST-OBC/deciphered/0060/G_0060_粹720(甲).png`
- asset id: `asset-000057`
...
- English observation: `The narrow image shows a curved upright stroke, a
  branching upper mark, and a small enclosed oval near the lower right.`
- 中文观察: `狭长图像有弯曲直立笔画、上方分叉痕迹，右下附近有小型闭合椭圆。`
...
- dataset label text: `㐲`
- dataset label codepoints: `U+3432`
...
- Which source records identify obs-char-000052 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000052？
