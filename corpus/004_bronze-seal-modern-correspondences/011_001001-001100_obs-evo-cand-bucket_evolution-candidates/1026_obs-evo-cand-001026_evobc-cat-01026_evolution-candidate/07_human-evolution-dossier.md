...
- Project ID: `obs-evo-cand-001026`
- EVOBC category candidate ID: `evobc-evo-cat-01026`
- External category reference: `evobc-cat-01026`
- Source category ID: `01026`
- Source label for human review: `僪`
- Source codepoints: `U+50EA`
...
- `obs-evo-cand-001026-route-category-staging`
...
- `obs-evo-cand-001026-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001026-route-evolution-graph`
