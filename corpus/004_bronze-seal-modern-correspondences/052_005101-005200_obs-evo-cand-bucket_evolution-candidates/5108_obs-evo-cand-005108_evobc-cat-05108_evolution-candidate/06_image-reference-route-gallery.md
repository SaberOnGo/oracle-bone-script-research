...
- `obs-evo-cand-005108-route-category-staging`
...
- `obs-evo-cand-005108-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005108-route-evolution-graph`
