# Material Visual Observation / obs-comp-cand-001283 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001283`
- External reference / 外部参照: `obimd-sub-zkrxof2sy9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015568_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zkrxof2sy9/zkrxof2sy9/zkrxof2sy9.png`
- Checksum / 校验和:
  `905a92c77415117d10bc252c8058ce8e129da8468d28d7c5d31a2ca477be27ad`
...
- Marked-pixel bounds: (84,10)–(166,240); span 83 × 231 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.93%。
- 痕迹范围：(84,10)–(166,240)；跨度83 × 231 px；痕迹矩形高于宽。
