...
- External category reference: `evobc-cat-10876`
- Source category ID: `10876`
- Source label for human review: `𠥟`
- Source codepoints: `U+2095F`
...
- `obs-evo-cand-010876-route-category-staging`
...
- `obs-evo-cand-010876-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010876-route-evolution-graph`
