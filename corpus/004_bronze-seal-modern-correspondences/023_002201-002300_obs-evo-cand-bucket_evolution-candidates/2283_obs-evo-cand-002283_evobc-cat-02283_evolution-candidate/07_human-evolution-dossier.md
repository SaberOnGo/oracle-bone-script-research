...
- Project ID: `obs-evo-cand-002283`
- EVOBC category candidate ID: `evobc-evo-cat-02283`
- External category reference: `evobc-cat-02283`
- Source category ID: `02283`
- Source label for human review: `嫷`
- Source codepoints: `U+5AF7`
...
- `obs-evo-cand-002283-route-category-staging`
...
- `obs-evo-cand-002283-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002283-route-evolution-graph`
