...
- External category reference: `evobc-cat-04086`
- Source category ID: `04086`
- Source label for human review: `棄`
- Source codepoints: `U+68C4`
...
- `obs-evo-cand-004086-route-category-staging`
...
- `obs-evo-cand-004086-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004086-route-evolution-graph`
