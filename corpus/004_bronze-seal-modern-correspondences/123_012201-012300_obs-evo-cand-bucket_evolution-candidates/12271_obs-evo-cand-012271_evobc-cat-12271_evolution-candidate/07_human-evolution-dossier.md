...
- External category reference: `evobc-cat-12271`
- Source category ID: `12271`
- Source label for human review: `𧲤`
- Source codepoints: `U+27CA4`
...
- `obs-evo-cand-012271-route-category-staging`
...
- `obs-evo-cand-012271-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012271-route-evolution-graph`
