# Material Visual Observation / obs-comp-cand-001360 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001360`
- External reference / 外部参照: `obimd-sub-rf21ewkegh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015779_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tp5ykv5jzh/rf21ewkegh/rf21ewkegh.png`
- Checksum / 校验和:
  `3560c2c5b87d62405d10cd4aa9bffced4eef0720579e7f636ad0494e68aa041f`
...
- Marked-pixel bounds: (79,46)–(170,199); span 92 × 154 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.68%。
- 痕迹范围：(79,46)–(170,199)；跨度92 × 154 px；痕迹矩形高于宽。
