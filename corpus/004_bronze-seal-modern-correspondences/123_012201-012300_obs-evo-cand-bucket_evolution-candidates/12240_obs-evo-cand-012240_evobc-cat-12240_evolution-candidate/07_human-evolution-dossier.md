...
- External category reference: `evobc-cat-12240`
- Source category ID: `12240`
- Source label for human review: `𧪘`
- Source codepoints: `U+27A98`
...
- `obs-evo-cand-012240-route-category-staging`
...
- `obs-evo-cand-012240-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012240-route-evolution-graph`
