...
Project ID: `obs-evo-cand-005702`
...
- Project ID: `obs-evo-cand-005702`
- EVOBC category candidate ID: `evobc-evo-cat-05702`
- External category reference: `evobc-cat-05702`
- Source category ID: `05702`
- Source label for human review: `癪`
- Source codepoints: `U+766A`
...
- `obs-evo-cand-005702-route-category-staging`
...
- `obs-evo-cand-005702-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005702-route-evolution-graph`
