# obs-char-000271 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000271`
- primary external id: `hust-obc-cat-0306`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/271_obs-char-000271_hust-obc-cat-0306_orac
  le-character/03_visual-assets/001_asset-000276_hust-obc-cat-0306_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0306/G_0306_乙345合20456𠂤組.png`
- asset id: `asset-000276`
...
- source category: `0306`
- validation class: `270`
- source image route: `HUST-OBC/deciphered/0306/G_0306_乙345合20456𠂤組.png`
- asset id: `asset-000276`
...
- English observation: `The narrow image shows a thin descending stroke with
  an angular upper bend and two short curved marks near the middle; the
  lower stem continues apart.`
...
- dataset label text: `㔨`
- dataset label codepoints: `U+3528`
...
- filename catalog route clues: `Heji-like filename clue: 合20456
  (G_0306_乙345合20456𠂤組.png)`
...
- Which source records identify obs-char-000271 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000271？
