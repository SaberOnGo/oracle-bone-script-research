# obs-unk-000440 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000440`
- primary external id: `hust-obc-und-L-000440`
...
- local review image route: `corpus/001_oracle-characters/021_undeciphered-000
  401-000500_obs-unk-bucket_oracle-character-candidates/040_obs-unk-000440_h
  ust-obc-und-L-000440_oracle-character-candidate/03_visual-assets/001_asset
  -002033_hust-obc-und-L-000440_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/440/L_？_11373.jpg`
- asset id: `asset-002033`
...
- source class: `HUST-OBC/undeciphered/L/440/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/440/L_？_11373.jpg`
- asset id: `asset-002033`
...
- Which source records identify obs-unk-000440 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000440？
