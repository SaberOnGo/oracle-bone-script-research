# obs-char-001145 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1145_obs-char-001145_hust-obc-cat-1279_ora
  cle-character/03_visual-assets/001_asset-001150_hust-obc-cat-1279_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1279/G_1279_乙3250合2422賓組.png`
- asset id: `asset-001150`
...
- source category: `1279`
- validation class: `1144`
- source image route: `HUST-OBC/deciphered/1279/G_1279_乙3250合2422賓組.png`
- asset id: `asset-001150`
...
- English observation: `A small upright central stem is accompanied by a
  rounded left loop, a pointed upper-right extension, and a hooked lower
  stroke.`
- 中文观察: `小型中央直立笔旁有左侧圆弧环、右上尖状外伸笔和下部钩笔。`
...
- dataset label text: `㣵`
- dataset label codepoints: `U+38F5`
...
- filename catalog route clues: `Heji-like filename clue: 合2422
...
- Which source records identify obs-char-001145 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001145？
