...
- External category reference: `evobc-cat-05812`
- Source category ID: `05812`
- Source label for human review: `眸`
...
- `obs-evo-cand-005812-route-category-staging`
...
- `obs-evo-cand-005812-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005812-route-evolution-graph`
