...
- External category reference: `evobc-cat-08786`
- Source category ID: `08786`
- Source label for human review: `躩`
...
- `obs-evo-cand-008786-route-category-staging`
...
- `obs-evo-cand-008786-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008786-route-evolution-graph`
