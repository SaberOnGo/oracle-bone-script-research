# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000196
...
- EVOBC candidate category: `evobc-evo-cat-00196`.
- Source label for search only: `㱽`.
- Source codepoints for search only: `U+3C7D`.
