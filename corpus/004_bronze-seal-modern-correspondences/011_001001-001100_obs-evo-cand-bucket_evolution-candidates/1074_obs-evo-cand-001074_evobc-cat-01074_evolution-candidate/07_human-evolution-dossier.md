...
- Project ID: `obs-evo-cand-001074`
- EVOBC category candidate ID: `evobc-evo-cat-01074`
- External category reference: `evobc-cat-01074`
- Source category ID: `01074`
- Source label for human review: `克`
- Source codepoints: `U+514B`
- Image reference count in source metadata: `231`
...
- `obs-evo-cand-001074-route-category-staging`
...
- `obs-evo-cand-001074-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001074-route-evolution-graph`
