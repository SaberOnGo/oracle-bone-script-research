...
- External category reference: `evobc-cat-05091`
- Source category ID: `05091`
- Source label for human review: `焠`
- Source codepoints: `U+7120`
...
- `obs-evo-cand-005091-route-category-staging`
...
- `obs-evo-cand-005091-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005091-route-evolution-graph`
