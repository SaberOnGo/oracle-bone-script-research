...
- `obs-evo-cand-006718-route-category-staging`
...
- `obs-evo-cand-006718-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006718-route-evolution-graph`
