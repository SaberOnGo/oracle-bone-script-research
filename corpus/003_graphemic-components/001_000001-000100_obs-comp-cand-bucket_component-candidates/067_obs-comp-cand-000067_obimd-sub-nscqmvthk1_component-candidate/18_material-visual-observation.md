# Material Visual Observation / obs-comp-cand-000067 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000067`
- External reference / 外部参照: `obimd-sub-nscqmvthk1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011480_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/nscqmvthk1/nscqmvthk1/nscqmvthk1.png`
- Checksum / 校验和:
  `4f2d9cc0b80845f50465cc17417b9c135c60fee7fba1adcfe04160c8c505b568`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.09%.
- Marked-pixel bounds: (60,26)–(189,208); span 130 × 183 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.09%。
- 痕迹范围：(60,26)–(189,208)；跨度130 × 183 px；痕迹矩形高于宽。
