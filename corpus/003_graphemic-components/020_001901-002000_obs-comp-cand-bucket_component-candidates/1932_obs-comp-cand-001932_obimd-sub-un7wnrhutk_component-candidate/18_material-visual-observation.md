# Material Visual Observation / obs-comp-cand-001932 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001932`
- External reference / 外部参照: `obimd-sub-un7wnrhutk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018718_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/un7wnrhutk/un7wnrhutk/un7wnrhutk.png`
- Checksum / 校验和:
  `010dd1ffc477df1c052033da5e86461c3d6427733b4d922bf962deee10ae4237`
...
- Marked-pixel bounds: (61,21)–(205,219); span 145 × 199 px; the marked
...
- 痕迹范围：(61,21)–(205,219)；跨度145 × 199 px；痕迹矩形高于宽。
