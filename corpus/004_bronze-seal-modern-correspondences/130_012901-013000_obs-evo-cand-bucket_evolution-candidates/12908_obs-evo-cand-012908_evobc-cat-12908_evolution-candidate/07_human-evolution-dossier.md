...
- External category reference: `evobc-cat-12908`
- Source category ID: `12908`
- Source label for human review: `𫁤`
- Source codepoints: `U+2B064`
...
- `obs-evo-cand-012908-route-category-staging`
...
- `obs-evo-cand-012908-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012908-route-evolution-graph`
