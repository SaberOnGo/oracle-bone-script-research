...
- `obs-evo-cand-003170-route-category-staging`
...
- `obs-evo-cand-003170-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003170-route-evolution-graph`
