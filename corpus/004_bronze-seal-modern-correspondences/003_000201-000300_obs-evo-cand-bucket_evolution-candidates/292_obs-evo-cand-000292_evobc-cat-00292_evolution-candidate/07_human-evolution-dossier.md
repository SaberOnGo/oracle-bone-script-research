...
Project ID: `obs-evo-cand-000292`
...
- Project ID: `obs-evo-cand-000292`
- EVOBC category candidate ID: `evobc-evo-cat-00292`
- External category reference: `evobc-cat-00292`
- Source category ID: `00292`
- Source label for human review: `䅹`
- Source codepoints: `U+4179`
...
- `obs-evo-cand-000292-route-category-staging`
...
- `obs-evo-cand-000292-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000292-route-evolution-graph`
