...
- Project ID: `obs-evo-cand-000405`
- EVOBC category candidate ID: `evobc-evo-cat-00405`
- External category reference: `evobc-cat-00405`
- Source category ID: `00405`
- Source label for human review: `䘖`
- Source codepoints: `U+4616`
...
- `obs-evo-cand-000405-route-category-staging`
...
- `obs-evo-cand-000405-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000405-route-evolution-graph`
