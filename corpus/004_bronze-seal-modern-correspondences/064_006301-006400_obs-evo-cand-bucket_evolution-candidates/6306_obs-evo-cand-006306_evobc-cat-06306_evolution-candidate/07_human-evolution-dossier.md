...
- External category reference: `evobc-cat-06306`
- Source category ID: `06306`
- Source label for human review: `箸`
- Source codepoints: `U+7BB8`
...
- `obs-evo-cand-006306-route-category-staging`
...
- `obs-evo-cand-006306-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006306-route-evolution-graph`
