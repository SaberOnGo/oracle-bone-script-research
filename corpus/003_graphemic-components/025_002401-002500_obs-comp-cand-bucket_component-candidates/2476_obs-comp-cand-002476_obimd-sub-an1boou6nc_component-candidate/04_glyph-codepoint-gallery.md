# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002476
...
| --- | --- | --- | --- |
| `obimd-glyph-link-038142` | 򩡘󾇯 | `U+A9858;U+FE1EF` | `reviewed_metadata_only` |
| `obimd-glyph-link-038143` | 󾇰 | `U+FE1F0` | `reviewed_metadata_only` |
| `obimd-glyph-link-038144` | 󾇱 | `U+FE1F1` | `reviewed_metadata_only` |
| `obimd-glyph-link-038145` | 󾇲 | `U+FE1F2` | `reviewed_metadata_only` |
| `obimd-glyph-link-038146` | 󾇳 | `U+FE1F3` | `reviewed_metadata_only` |
