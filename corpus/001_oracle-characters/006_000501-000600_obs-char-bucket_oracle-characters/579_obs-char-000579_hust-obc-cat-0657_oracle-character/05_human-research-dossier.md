# obs-char-000579 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000579`
- primary external id: `hust-obc-cat-0657`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/579_obs-char-000579_hust-obc-cat-0657_orac
  le-character/03_visual-assets/001_asset-000584_hust-obc-cat-0657_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0657/X_0657_4443_1.png`
- asset id: `asset-000584`
...
- source category: `0657`
- validation class: `578`
- source image route: `HUST-OBC/deciphered/0657/X_0657_4443_1.png`
- asset id: `asset-000584`
...
- English observation: `Several thick diagonal arms and short upper branches
  radiate from a central junction; a long lower horizontal crosses two
  descending strokes.`
- 中文观察: `数条粗斜臂和短上枝从中央接点放射，长下横穿过两条下行笔。`
...
- dataset label text: `㚇`
- dataset label codepoints: `U+3687`
...
- Which source records identify obs-char-000579 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000579？
