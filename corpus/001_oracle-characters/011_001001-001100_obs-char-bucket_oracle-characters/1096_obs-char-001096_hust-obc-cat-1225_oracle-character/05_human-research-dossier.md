# obs-char-001096 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1096_obs-char-001096_hust-obc-cat-1225_ora
  cle-character/03_visual-assets/001_asset-001101_hust-obc-cat-1225_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1225/L_1225_10184.jpg`
- asset id: `asset-001101`
...
- source category: `1225`
- validation class: `1095`
- source image route: `HUST-OBC/deciphered/1225/L_1225_10184.jpg`
- asset id: `asset-001101`
...
- English observation: `The faint gray image shows a compact rounded cluster
  with a short lower curve; fine detail is low contrast.`
...
- dataset label text: `㢿`
- dataset label codepoints: `U+38BF`
...
- Which source records identify obs-char-001096 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001096？
