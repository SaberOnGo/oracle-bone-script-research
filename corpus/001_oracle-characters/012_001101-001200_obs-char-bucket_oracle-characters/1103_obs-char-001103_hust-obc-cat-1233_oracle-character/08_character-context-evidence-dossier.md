...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1233`
...
- Source image / 来源图: `G_1233_後2.8.7合3337賓組.png`
- Image / 图像: `001_asset-001108_hust-obc-cat-1233_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合3337
...
- target node: `evobc-evo-cat-00105`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/105_obs-evo-cand-000105_evobc-cat-00105_evoluti
...
- Source label text / 来源标签文字: `㣇`
- Source label codepoint / 来源标签 codepoint: `U+38C7`
