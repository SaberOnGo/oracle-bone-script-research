# obs-unk-004651 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/051_obs-unk-004651_h
  ust-obc-und-X-004651_oracle-character-candidate/03_visual-assets/001_asset
  -006244_hust-obc-und-X-004651_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/207/X_？_8379_1.png`
- asset id: `asset-006244`
...
- source class: `HUST-OBC/undeciphered/X/207/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/207/X_？_8379_1.png`
- asset id: `asset-006244`
...
- English observation: `triangular arch enclosing a pale central field`
- 中文观察: `围出浅色中央空间的三角拱形`
...
- Which source records identify obs-unk-004651 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004651？
