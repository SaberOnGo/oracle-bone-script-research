...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1364`
...
- Source image / 来源图: `L_1364_1002.jpg`
- Image / 图像: `001_asset-001224_hust-obc-cat-1364_glyph.png`
...
- target node: `evobc-evo-cat-00126`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/126_obs-evo-cand-000126_evobc-cat-00126_evoluti
...
- Source label text / 来源标签文字: `㥊`
- Source label codepoint / 来源标签 codepoint: `U+394A`
