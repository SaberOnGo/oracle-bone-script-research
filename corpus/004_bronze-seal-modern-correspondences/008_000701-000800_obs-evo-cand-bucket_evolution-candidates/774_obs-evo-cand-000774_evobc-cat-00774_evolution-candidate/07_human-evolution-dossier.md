...
- External category reference: `evobc-cat-00774`
- Source category ID: `00774`
- Source label for human review: `优`
...
- `obs-evo-cand-000774-route-category-staging`
...
- `obs-evo-cand-000774-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000774-route-evolution-graph`
