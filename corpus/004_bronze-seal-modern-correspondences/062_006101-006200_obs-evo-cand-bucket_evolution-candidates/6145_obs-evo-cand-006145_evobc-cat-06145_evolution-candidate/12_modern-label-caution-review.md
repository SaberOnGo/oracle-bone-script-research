# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006145
...
- EVOBC candidate category: `evobc-evo-cat-06145`.
- Source label for search only: `究`.
- Source codepoints for search only: `U+7A76`.
