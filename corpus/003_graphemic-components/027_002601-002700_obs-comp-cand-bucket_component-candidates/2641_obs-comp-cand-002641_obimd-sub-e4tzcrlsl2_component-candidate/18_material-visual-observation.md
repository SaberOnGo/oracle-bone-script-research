# Material Visual Observation / obs-comp-cand-002641 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002641`
- External reference / 外部参照: `obimd-sub-e4tzcrlsl2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021190_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/mfe79ij88l/e4tzcrlsl2/e4tzcrlsl2.png`
- Checksum / 校验和:
  `a601516a7486da8352d697eaf06ee8278a11e3b1cc8361981e84d72baec18373`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.24%.
- Marked-pixel bounds: (73,35)–(174,215); span 102 × 181 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.24%。
- 痕迹范围：(73,35)–(174,215)；跨度102 × 181 px；痕迹矩形高于宽。
