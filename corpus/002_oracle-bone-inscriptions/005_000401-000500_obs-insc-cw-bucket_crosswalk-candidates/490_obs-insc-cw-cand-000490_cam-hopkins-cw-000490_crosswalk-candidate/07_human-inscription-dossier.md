...
- Yingguo / 英国所藏: `y2413` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `281` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `349` in source row; primary catalog entry pending
- Heji / 合集: `41503` in source row; primary catalog entry pending
