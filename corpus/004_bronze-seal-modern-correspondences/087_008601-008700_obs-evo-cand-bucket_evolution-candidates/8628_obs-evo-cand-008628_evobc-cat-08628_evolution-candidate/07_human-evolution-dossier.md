...
- External category reference: `evobc-cat-08628`
- Source category ID: `08628`
- Source label for human review: `贰`
...
- `obs-evo-cand-008628-route-category-staging`
...
- `obs-evo-cand-008628-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008628-route-evolution-graph`
