...
- Project ID: `obs-evo-cand-007351`
- EVOBC category candidate ID: `evobc-evo-cat-07351`
- External category reference: `evobc-cat-07351`
- Source category ID: `07351`
- Source label for human review: `荑`
- Source codepoints: `U+8351`
...
- `obs-evo-cand-007351-route-category-staging`
...
- `obs-evo-cand-007351-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007351-route-evolution-graph`
