...
- External category reference: `evobc-cat-09641`
- Source category ID: `09641`
- Source label for human review: `閹`
...
- `obs-evo-cand-009641-route-category-staging`
...
- `obs-evo-cand-009641-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009641-route-evolution-graph`
