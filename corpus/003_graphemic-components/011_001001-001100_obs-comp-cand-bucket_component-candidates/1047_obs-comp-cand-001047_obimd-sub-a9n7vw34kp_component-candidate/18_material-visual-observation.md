# Material Visual Observation / obs-comp-cand-001047 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001047`
- External reference / 外部参照: `obimd-sub-a9n7vw34kp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014597_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/a9n7vw34kp/a9n7vw34kp/a9n7vw34kp.png`
- Checksum / 校验和:
  `7787b6a251841c5591495314f378ea4fc27de1832a0054bde747a78357c8c502`
...
- Marked-pixel bounds: (66,34)–(185,213); span 120 × 180 px; the marked
...
- 痕迹范围：(66,34)–(185,213)；跨度120 × 180 px；痕迹矩形高于宽。
