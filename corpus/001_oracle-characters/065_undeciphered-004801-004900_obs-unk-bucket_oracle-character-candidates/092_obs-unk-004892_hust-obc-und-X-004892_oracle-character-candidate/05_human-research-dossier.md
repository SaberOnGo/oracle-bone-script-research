# obs-unk-004892 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/092_obs-unk-004892_h
  ust-obc-und-X-004892_oracle-character-candidate/03_visual-assets/001_asset
  -006485_hust-obc-und-X-004892_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/448/X_？_7093_1.png`
- asset id: `asset-006485`
...
- source class: `HUST-OBC/undeciphered/X/448/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/448/X_？_7093_1.png`
- asset id: `asset-006485`
...
- English observation: `upper-left enclosure and tall right group`
- 中文观察: `左上方外框和右侧狭长结构`
...
- Which source records identify obs-unk-004892 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004892？
