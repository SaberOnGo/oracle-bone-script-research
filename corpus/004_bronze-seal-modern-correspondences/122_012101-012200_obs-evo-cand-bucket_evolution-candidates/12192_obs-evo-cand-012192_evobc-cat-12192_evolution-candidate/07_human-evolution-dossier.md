...
- External category reference: `evobc-cat-12192`
- Source category ID: `12192`
- Source label for human review: `𧙜`
...
- `obs-evo-cand-012192-route-category-staging`
...
- `obs-evo-cand-012192-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012192-route-evolution-graph`
