...
- `obs-evo-cand-000068-route-category-staging`
...
- `obs-evo-cand-000068-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000068-route-evolution-graph`
