# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002294
...
- EVOBC candidate category: `evobc-evo-cat-02294`.
- Source label for search only: `嬌`.
- Source codepoints for search only: `U+5B0C`.
