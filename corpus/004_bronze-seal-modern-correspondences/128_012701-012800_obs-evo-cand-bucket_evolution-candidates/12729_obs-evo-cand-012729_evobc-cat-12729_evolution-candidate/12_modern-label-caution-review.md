# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012729
...
- EVOBC candidate category: `evobc-evo-cat-12729`.
- Source label for search only: `𪄛`.
- Source codepoints for search only: `U+2A11B`.
