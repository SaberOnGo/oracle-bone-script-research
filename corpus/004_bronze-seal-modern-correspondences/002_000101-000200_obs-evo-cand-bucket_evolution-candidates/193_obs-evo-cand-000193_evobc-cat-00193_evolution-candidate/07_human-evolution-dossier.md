...
- External category reference: `evobc-cat-00193`
- Source category ID: `00193`
- Source label for human review: `㱙`
...
- `obs-evo-cand-000193-route-category-staging`
...
- `obs-evo-cand-000193-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000193-route-evolution-graph`
