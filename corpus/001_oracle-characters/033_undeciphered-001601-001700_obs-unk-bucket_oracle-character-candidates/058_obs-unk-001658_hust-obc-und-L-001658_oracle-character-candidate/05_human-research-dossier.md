# obs-unk-001658 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-001658`
- primary external id: `hust-obc-und-L-001658`
...
- local review image route: `corpus/001_oracle-characters/033_undeciphered-001
  601-001700_obs-unk-bucket_oracle-character-candidates/058_obs-unk-001658_h
  ust-obc-und-L-001658_oracle-character-candidate/03_visual-assets/001_asset
  -003251_hust-obc-und-L-001658_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/1658/L_？_1455.jpg`
- asset id: `asset-003251`
...
- source class: `HUST-OBC/undeciphered/L/1658/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/1658/L_？_1455.jpg`
- asset id: `asset-003251`
...
- Which source records identify obs-unk-001658 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-001658？
