# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010400
...
- EVOBC candidate category: `evobc-evo-cat-10400`.
- Source label for search only: `鮪`.
- Source codepoints for search only: `U+9BAA`.
