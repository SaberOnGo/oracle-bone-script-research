# obs-unk-004709 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/009_obs-unk-004709_h
  ust-obc-und-X-004709_oracle-character-candidate/03_visual-assets/001_asset
  -006302_hust-obc-und-X-004709_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/265/X_？_7239_1.png`
- asset id: `asset-006302`
...
- source class: `HUST-OBC/undeciphered/X/265/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/265/X_？_7239_1.png`
- asset id: `asset-006302`
...
- English observation: `curved main form with separate right stroke`
- 中文观察: `带独立右侧笔画的弯曲主体结构`
...
- Which source records identify obs-unk-004709 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004709？
