# Material Visual Observation / obs-comp-cand-001809 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001809`
- External reference / 外部参照: `obimd-sub-wxej0p8z4b`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018030_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wxej0p8z4b/wxej0p8z4b/wxej0p8z4b.png`
- Checksum / 校验和:
  `9cdb801cbce8402c7f94f9257ad664c45160548e15e57976941282ea64d5774d`
...
- Marked-pixel bounds: (56,30)–(191,227); span 136 × 198 px; the marked
...
- 痕迹范围：(56,30)–(191,227)；跨度136 × 198 px；痕迹矩形高于宽。
