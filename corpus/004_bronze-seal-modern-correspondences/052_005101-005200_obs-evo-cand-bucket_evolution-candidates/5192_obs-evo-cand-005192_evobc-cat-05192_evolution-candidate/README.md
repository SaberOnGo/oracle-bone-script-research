# obs-evo-cand-005192 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-05192`
- Source label for human review: `牂`
- Source codepoints: `U+7242`
- Image reference count: `29`
- Era token counts: `SS:1;WSC:28`
- Source token counts: `Book:7;Web:22`
