...
Project ID: `obs-insc-cw-cand-000438`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000438`
...
- Yingguo / 英国所藏: `y2289` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `551` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `182` in source row; primary catalog entry pending
- Heji / 合集: `41351` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000438`
