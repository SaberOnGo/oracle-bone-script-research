# obs-char-001534 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001534`
- primary external id: `hust-obc-cat-1720`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1534_obs-char-001534_hust-obc-cat-1720_ora
  cle-character/03_visual-assets/001_asset-001539_hust-obc-cat-1720_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1720/G_1720_乙1476合22106午組.png`
- asset id: `asset-001539`
...
- source category: `1720`
- validation class: `1533`
- source image route: `HUST-OBC/deciphered/1720/G_1720_乙1476合22106午組.png`
- asset id: `asset-001539`
...
- English observation: `A sparse pair has a pointed zigzag on the left and
  an angular cornered mark on the right.`
- 中文观察: `稀疏组合左侧有尖顶曲折笔画，右侧有折角标记。`
...
- dataset label text: `㪮`
- dataset label codepoints: `U+3AAE`
...
- filename catalog route clues: `Heji-like filename clue: 合22106
  (G_1720_乙1476合22106午組.png)`
...
- Which source records identify obs-char-001534 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001534？
