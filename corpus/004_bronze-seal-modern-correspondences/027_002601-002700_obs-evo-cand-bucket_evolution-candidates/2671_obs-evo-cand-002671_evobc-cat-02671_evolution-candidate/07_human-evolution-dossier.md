...
- External category reference: `evobc-cat-02671`
- Source category ID: `02671`
- Source label for human review: `幎`
- Source codepoints: `U+5E4E`
...
- `obs-evo-cand-002671-route-category-staging`
...
- `obs-evo-cand-002671-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002671-route-evolution-graph`
