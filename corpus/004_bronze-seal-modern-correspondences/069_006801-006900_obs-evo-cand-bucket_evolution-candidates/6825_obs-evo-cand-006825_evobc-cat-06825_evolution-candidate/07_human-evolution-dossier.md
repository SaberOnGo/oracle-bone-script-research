...
Project ID: `obs-evo-cand-006825`
...
- Project ID: `obs-evo-cand-006825`
- EVOBC category candidate ID: `evobc-evo-cat-06825`
- External category reference: `evobc-cat-06825`
- Source category ID: `06825`
- Source label for human review: `罶`
- Source codepoints: `U+7F76`
...
- `obs-evo-cand-006825-route-category-staging`
...
- `obs-evo-cand-006825-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006825-route-evolution-graph`
