# Material Visual Observation / obs-comp-cand-002417 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002417`
- External reference / 外部参照: `obimd-sub-4a15wb9p9n`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020488_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9s8i2290qg/4a15wb9p9n/4a15wb9p9n.png`
- Checksum / 校验和:
  `5cd0411cbc500c653819394158ef7704789b71d3cc7890290fe5ab54e489d0d5`
...
- Marked-pixel bounds: (68,27)–(181,218); span 114 × 192 px; the marked
...
- 痕迹范围：(68,27)–(181,218)；跨度114 × 192 px；痕迹矩形高于宽。
