# Material Visual Observation / obs-comp-cand-000991 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000991`
- External reference / 外部参照: `obimd-sub-0cejp24ntn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014361_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tp2kuz956n/0cejp24ntn/0cejp24ntn.png`
- Checksum / 校验和:
  `9543022aab4ed70bf27ba92f6ec2fd29df7dda80c260aaf0368000cdde8cb7d8`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.25%.
- Marked-pixel bounds: (73,53)–(176,212); span 104 × 160 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.25%。
- 痕迹范围：(73,53)–(176,212)；跨度104 × 160 px；痕迹矩形高于宽。
