...
- External category reference: `evobc-cat-04740`
- Source category ID: `04740`
- Source label for human review: `淵`
...
- `obs-evo-cand-004740-route-category-staging`
...
- `obs-evo-cand-004740-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004740-route-evolution-graph`
