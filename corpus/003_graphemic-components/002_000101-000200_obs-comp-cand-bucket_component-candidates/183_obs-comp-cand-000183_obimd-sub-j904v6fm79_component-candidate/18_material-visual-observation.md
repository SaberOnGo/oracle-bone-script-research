# Material Visual Observation / obs-comp-cand-000183 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000183`
- External reference / 外部参照: `obimd-sub-j904v6fm79`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011595_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/j904v6fm79/j904v6fm79/j904v6fm79.png`
- Checksum / 校验和:
  `510cbcf644a9be8c352765a8818ca18198caa52df72fde79c109d2a7b524f491`
...
- Marked-pixel bounds: (93,17)–(156,227); span 64 × 211 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.25%。
- 痕迹范围：(93,17)–(156,227)；跨度64 × 211 px；痕迹矩形高于宽。
