# Material Visual Observation / obs-comp-cand-002650 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002650`
- External reference / 外部参照: `obimd-sub-mrt5myvr4d`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021226_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/mrt5myvr4d/mrt5myvr4d/mrt5myvr4d.png`
- Checksum / 校验和:
  `c42d902c0858acefde00aafc63323269d4100aadfe186d5d82e209fed2aa27db`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.17%.
- Marked-pixel bounds: (93,26)–(160,226); span 68 × 201 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.17%。
- 痕迹范围：(93,26)–(160,226)；跨度68 × 201 px；痕迹矩形高于宽。
