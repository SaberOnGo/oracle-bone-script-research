# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000741
...
- EVOBC candidate category: `evobc-evo-cat-00741`.
- Source label for search only: `仝`.
- Source codepoints for search only: `U+4EDD`.
