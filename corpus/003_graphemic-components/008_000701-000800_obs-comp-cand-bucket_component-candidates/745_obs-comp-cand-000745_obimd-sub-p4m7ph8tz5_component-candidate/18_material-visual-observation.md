# Material Visual Observation / obs-comp-cand-000745 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000745`
- External reference / 外部参照: `obimd-sub-p4m7ph8tz5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013510_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/n0bfvspr0d/p4m7ph8tz5/p4m7ph8tz5.png`
- Checksum / 校验和:
  `b1c39fb6584e5167c3e12b11d84385f1157792a0448cc71cc4684dc4b4449820`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.13%.
- Marked-pixel bounds: (87,31)–(183,220); span 97 × 190 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.13%。
- 痕迹范围：(87,31)–(183,220)；跨度97 × 190 px；痕迹矩形高于宽。
