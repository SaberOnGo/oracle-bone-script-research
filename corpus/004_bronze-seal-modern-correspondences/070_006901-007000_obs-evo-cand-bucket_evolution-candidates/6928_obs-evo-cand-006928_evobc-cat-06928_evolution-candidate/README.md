# obs-evo-cand-006928 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-006928`
- EVOBC category candidate ID: `evobc-evo-cat-06928`
- External category ref: `evobc-cat-06928`
- Source label: `耳`
- Source codepoints: `U+8033`
- Image reference count: `123`
- Era token counts: `BI:19;CS:1;OBC:67;SAC:2;SS:2;WSC:32`
- Source token counts: `Book:55;Web:68`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 67 image references
- era 1 / BI: 19 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 2 image references
- era 4 / WSC: 32 image references
- era 5 / CS: 1 image references
- source 0 / Web:1633: 1 image references
- source 1 / Web:105952;說文Web:58: 44 image references
- source 2 / Book:17600: 18 image references
- source 3 / Book:21681: 4 image references
