# obs-unk-008989 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008989`
- primary external id: `hust-obc-und-YH-008989`
...
- local review image route: `corpus/001_oracle-characters/106_undeciphered-008
  901-009000_obs-unk-bucket_oracle-character-candidates/089_obs-unk-008989_h
  ust-obc-und-YH-008989_oracle-character-candidate/03_visual-assets/001_asse
  t-010580_hust-obc-und-YH-008989_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6100B/H_？_6100B_0.png`
- asset id: `asset-010580`
...
- source class: `HUST-OBC/undeciphered/Y+H/6100B/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6100B/H_？_6100B_0.png`
- asset id: `asset-010580`
...
- Which source records identify obs-unk-008989 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008989？
