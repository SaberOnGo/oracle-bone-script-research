...
- Project ID: `obs-evo-cand-000625`
- EVOBC category candidate ID: `evobc-evo-cat-00625`
- External category reference: `evobc-cat-00625`
- Source category ID: `00625`
- Source label for human review: `东`
- Source codepoints: `U+4E1C`
...
- `obs-evo-cand-000625-route-category-staging`
...
- `obs-evo-cand-000625-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000625-route-evolution-graph`
