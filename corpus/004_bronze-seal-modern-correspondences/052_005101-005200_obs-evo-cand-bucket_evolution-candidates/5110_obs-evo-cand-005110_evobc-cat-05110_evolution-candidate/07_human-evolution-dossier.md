...
Project ID: `obs-evo-cand-005110`
...
- Project ID: `obs-evo-cand-005110`
- EVOBC category candidate ID: `evobc-evo-cat-05110`
- External category reference: `evobc-cat-05110`
- Source category ID: `05110`
- Source label for human review: `煙`
- Source codepoints: `U+7159`
...
- `obs-evo-cand-005110-route-category-staging`
...
- `obs-evo-cand-005110-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005110-route-evolution-graph`
