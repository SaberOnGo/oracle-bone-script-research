# Material Visual Observation / obs-comp-cand-001286 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001286`
- External reference / 外部参照: `obimd-sub-8owuek2gjb`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015571_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/b9q6ewwhki/8owuek2gjb/8owuek2gjb.png`
- Checksum / 校验和:
  `3e2b40f69b3294cec544697694154cb80829449c2105a1d74dc321d8806ade1a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.70%.
- Marked-pixel bounds: (81,41)–(168,212); span 88 × 172 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.70%。
- 痕迹范围：(81,41)–(168,212)；跨度88 × 172 px；痕迹矩形高于宽。
