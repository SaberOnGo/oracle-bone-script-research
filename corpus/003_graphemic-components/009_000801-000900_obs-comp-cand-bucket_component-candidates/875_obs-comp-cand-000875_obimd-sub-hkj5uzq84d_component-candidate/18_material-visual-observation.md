# Material Visual Observation / obs-comp-cand-000875 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000875`
- External reference / 外部参照: `obimd-sub-hkj5uzq84d`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013947_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/o6m37o3l7o/hkj5uzq84d/hkj5uzq84d.png`
- Checksum / 校验和:
  `d7ca699f589d00f4f5ebb61dcb5c0c33d838c283b852122599eb387888903c4f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.59%.
- Marked-pixel bounds: (84,17)–(176,229); span 93 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.59%。
- 痕迹范围：(84,17)–(176,229)；跨度93 × 213 px；痕迹矩形高于宽。
