...
Project ID: `obs-evo-cand-007482`
...
- Project ID: `obs-evo-cand-007482`
- EVOBC category candidate ID: `evobc-evo-cat-07482`
- External category reference: `evobc-cat-07482`
- Source category ID: `07482`
- Source label for human review: `葰`
- Source codepoints: `U+8470`
...
- `obs-evo-cand-007482-route-category-staging`
...
- `obs-evo-cand-007482-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007482-route-evolution-graph`
