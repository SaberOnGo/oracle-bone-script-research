# obs-char-000107 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000107`
- primary external id: `hust-obc-cat-0121`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/107_obs-char-000107_hust-obc-cat-0121_orac
  le-character/03_visual-assets/001_asset-000112_hust-obc-cat-0121_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0121/G_0121_前1.44.7(甲).png`
- asset id: `asset-000112`
...
- source category: `0121`
- validation class: `106`
- source image route: `HUST-OBC/deciphered/0121/G_0121_前1.44.7(甲).png`
- asset id: `asset-000112`
...
- English observation: `The narrow image is formed by two long diagonal
  strokes meeting near the top and opening apart toward the lower edge.`
- 中文观察: `狭长图像由两道长斜笔构成，两笔在上方附近相接，向下端分开。`
...
- dataset label text: `㑯`
- dataset label codepoints: `U+346F`
...
- Which source records identify obs-char-000107 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000107？
