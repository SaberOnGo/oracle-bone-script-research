...
- First-wave result ID / 第一波结果 ID: `source-engineering-first-wave-review-result-0005`
- Handoff item ID / 交接项 ID: `source-engineering-review-wave-handoff-0005`
- Next action ID / 下一动作 ID: `source-engineering-next-action-0021`
...
- Action lane / 动作线: `package_manifest_or_not_applicable_review`
- Gap type / 缺口类型: `package_file_manifest_or_not_applicable_decision_needed`
- Pipeline current stage / 流水线当前阶段: `pending_human_review`
- Decision field / 决策字段: `manifest_decision`
- Decision value / 决策值: `no_package_manifest_rows_found_decision_pending`
...
- `open_large_source_register`
- `open_package_manifest`
- `open_download_manifest`
- `record_manifest_needed_or_not_applicable`
- `keep_raw_package_outside_regular_git`
