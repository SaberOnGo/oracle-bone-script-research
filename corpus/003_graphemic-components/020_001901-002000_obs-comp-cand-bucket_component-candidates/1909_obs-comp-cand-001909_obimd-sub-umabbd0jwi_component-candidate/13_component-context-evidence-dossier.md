# obs-comp-cand-001909 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001909`
- 首选外部 ID: `obimd-sub-umabbd0jwi`
- OBIMD subcharacter UID: `umabbd0jwi`
- OBIMD main character UID: `umabbd0jwi`
- 来源 ID: `src-obimd`
