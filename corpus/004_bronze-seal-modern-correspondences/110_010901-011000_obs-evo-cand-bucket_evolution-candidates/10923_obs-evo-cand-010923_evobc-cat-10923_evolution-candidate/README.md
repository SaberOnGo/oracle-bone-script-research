# obs-evo-cand-010923 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-010923`
- EVOBC category candidate ID: `evobc-evo-cat-10923`
- External category ref: `evobc-cat-10923`
- Source label: `𠭖`
- Source codepoints: `U+20B56`
- Image reference count: `39`
- Era token counts: `OBC:39`
- Source token counts: `Book:39`
