...
- `obs-evo-cand-010608-route-category-staging`
...
- `obs-evo-cand-010608-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010608-route-evolution-graph`
