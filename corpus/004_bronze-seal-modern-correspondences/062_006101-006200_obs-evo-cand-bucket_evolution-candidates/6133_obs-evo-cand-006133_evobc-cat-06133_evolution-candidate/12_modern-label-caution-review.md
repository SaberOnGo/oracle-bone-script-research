# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006133
...
- EVOBC candidate category: `evobc-evo-cat-06133`.
- Source label for search only: `穟`.
- Source codepoints for search only: `U+7A5F`.
