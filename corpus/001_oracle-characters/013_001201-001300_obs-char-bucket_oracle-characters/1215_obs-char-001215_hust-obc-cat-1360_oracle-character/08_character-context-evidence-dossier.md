...
- Project ID / 项目 ID: `obs-char-001215`
- Primary external ID / 首选外部 ID: `hust-obc-cat-1360`
...
- Source image / 来源图: `G_1360_戩33.9(甲).png`
- Image / 图像: `001_asset-001220_hust-obc-cat-1360_glyph.png`
...
- target node: `evobc-evo-cat-00124`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/124_obs-evo-cand-000124_evobc-cat-00124_evoluti
...
- Source label text / 来源标签文字: `㥆`
- Source label codepoint / 来源标签 codepoint: `U+3946`
