# obs-unk-008643 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008643`
- primary external id: `hust-obc-und-YH-008643`
...
- local review image route: `corpus/001_oracle-characters/103_undeciphered-008
  601-008700_obs-unk-bucket_oracle-character-candidates/043_obs-unk-008643_h
  ust-obc-und-YH-008643_oracle-character-candidate/03_visual-assets/001_asse
  t-010234_hust-obc-und-YH-008643_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60CC8/Y_？_60CC8.jpg`
- asset id: `asset-010234`
...
- source class: `HUST-OBC/undeciphered/Y+H/60CC8/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60CC8/Y_？_60CC8.jpg`
- asset id: `asset-010234`
...
- Which source records identify obs-unk-008643 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008643？
