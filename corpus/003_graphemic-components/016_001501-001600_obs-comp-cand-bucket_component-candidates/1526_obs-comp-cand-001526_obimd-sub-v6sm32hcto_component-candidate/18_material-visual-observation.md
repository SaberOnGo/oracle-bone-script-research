# Material Visual Observation / obs-comp-cand-001526 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001526`
- External reference / 外部参照: `obimd-sub-v6sm32hcto`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016489_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/v6sm32hcto/v6sm32hcto/v6sm32hcto.png`
- Checksum / 校验和:
  `f95b7c9e8bafd5852e4f1308fe7e67923ad4562aa3317f4f2b42f186aa444859`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.94%.
- Marked-pixel bounds: (55,14)–(185,234); span 131 × 221 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.94%。
- 痕迹范围：(55,14)–(185,234)；跨度131 × 221 px；痕迹矩形高于宽。
