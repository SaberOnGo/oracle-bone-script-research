...
- `obs-evo-cand-001947-route-category-staging`
...
- `obs-evo-cand-001947-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001947-route-evolution-graph`
