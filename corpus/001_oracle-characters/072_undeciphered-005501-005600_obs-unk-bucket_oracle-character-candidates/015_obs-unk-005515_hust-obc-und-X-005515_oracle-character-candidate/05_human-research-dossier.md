# obs-unk-005515 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005515`
- primary external id: `hust-obc-und-X-005515`
...
- local review image route: `corpus/001_oracle-characters/072_undeciphered-005
  501-005600_obs-unk-bucket_oracle-character-candidates/015_obs-unk-005515_h
  ust-obc-und-X-005515_oracle-character-candidate/03_visual-assets/001_asset
  -007108_hust-obc-und-X-005515_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1071/X_？_8032_1.png`
- asset id: `asset-007108`
...
- source class: `HUST-OBC/undeciphered/X/1071/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1071/X_？_8032_1.png`
- asset id: `asset-007108`
...
- Which source records identify obs-unk-005515 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005515？
