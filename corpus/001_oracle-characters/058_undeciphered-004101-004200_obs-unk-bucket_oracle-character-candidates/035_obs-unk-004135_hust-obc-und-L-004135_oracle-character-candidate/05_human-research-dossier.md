# obs-unk-004135 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/035_obs-unk-004135_h
  ust-obc-und-L-004135_oracle-character-candidate/03_visual-assets/001_asset
  -005728_hust-obc-und-L-004135_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4135/L_？_8911.jpg`
- asset id: `asset-005728`
...
- source class: `HUST-OBC/undeciphered/L/4135/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4135/L_？_8911.jpg`
- asset id: `asset-005728`
...
- English observation: A tall central trace has side marks;
  a separate small mark appears below left.
- 中文观察：中央较高痕迹带侧向笔痕；左下方另有小痕迹。
...
- Which source records identify obs-unk-004135 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004135？
