# Material Visual Observation / obs-comp-cand-001309 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001309`
- External reference / 外部参照: `obimd-sub-77e3f8jri8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015646_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/77e3f8jri8/77e3f8jri8/77e3f8jri8.png`
- Checksum / 校验和:
  `0b9e2df3a84d90d58fc1bdd5ca3738d26a0b1a042f97f6753dfcd6bc6593898c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.31%.
- Marked-pixel bounds: (67,19)–(180,227); span 114 × 209 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.31%。
- 痕迹范围：(67,19)–(180,227)；跨度114 × 209 px；痕迹矩形高于宽。
