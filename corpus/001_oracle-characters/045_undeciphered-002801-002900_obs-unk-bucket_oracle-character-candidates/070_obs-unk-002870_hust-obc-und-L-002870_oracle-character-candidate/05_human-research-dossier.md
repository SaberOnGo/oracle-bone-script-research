# obs-unk-002870 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002870`
- primary external id: `hust-obc-und-L-002870`
...
- local review image route: `corpus/001_oracle-characters/045_undeciphered-002
  801-002900_obs-unk-bucket_oracle-character-candidates/070_obs-unk-002870_h
  ust-obc-und-L-002870_oracle-character-candidate/03_visual-assets/001_asset
  -004463_hust-obc-und-L-002870_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2870/L_？_4882.jpg`
- asset id: `asset-004463`
...
- source class: `HUST-OBC/undeciphered/L/2870/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2870/L_？_4882.jpg`
- asset id: `asset-004463`
...
- Which source records identify obs-unk-002870 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002870？
