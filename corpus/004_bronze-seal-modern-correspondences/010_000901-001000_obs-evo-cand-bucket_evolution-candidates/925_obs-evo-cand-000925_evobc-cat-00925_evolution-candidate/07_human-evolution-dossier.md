...
- External category reference: `evobc-cat-00925`
- Source category ID: `00925`
- Source label for human review: `倗`
...
- `obs-evo-cand-000925-route-category-staging`
...
- `obs-evo-cand-000925-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000925-route-evolution-graph`
