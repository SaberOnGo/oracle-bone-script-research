# obs-char-001037 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1037_obs-char-001037_hust-obc-cat-1162_ora
  cle-character/03_visual-assets/001_asset-001042_hust-obc-cat-1162_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1162/G_1162_乙3400合1285賓組.png`
- asset id: `asset-001042`
...
- source category: `1162`
- validation class: `1036`
- source image route: `HUST-OBC/deciphered/1162/G_1162_乙3400合1285賓組.png`
- asset id: `asset-001042`
...
- English observation: `A bold horizontal bar is joined at its center to a
  single thick descending upright stroke.`
...
- dataset label text: `㢀`
- dataset label codepoints: `U+3880`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/097_obs-evo-can
  d-000097_evobc-cat-00097_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/097_obs-evo-cand-000097_evobc-cat-00097_evolu
...
- matched OBIMD main UIDs: `i9rq6029zl`
...
- Which source records identify obs-char-001037 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001037？
