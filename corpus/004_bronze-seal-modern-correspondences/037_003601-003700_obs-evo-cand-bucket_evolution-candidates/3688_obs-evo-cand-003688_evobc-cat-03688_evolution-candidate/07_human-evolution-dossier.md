...
- External category reference: `evobc-cat-03688`
- Source category ID: `03688`
- Source label for human review: `早`
...
- `obs-evo-cand-003688-route-category-staging`
...
- `obs-evo-cand-003688-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003688-route-evolution-graph`
