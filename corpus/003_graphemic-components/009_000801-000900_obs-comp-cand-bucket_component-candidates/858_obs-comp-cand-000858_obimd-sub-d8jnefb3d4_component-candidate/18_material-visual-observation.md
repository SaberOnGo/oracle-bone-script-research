# Material Visual Observation / obs-comp-cand-000858 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000858`
- External reference / 外部参照: `obimd-sub-d8jnefb3d4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013856_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/d8jnefb3d4/d8jnefb3d4/d8jnefb3d4.png`
- Checksum / 校验和:
  `5bbface384e5ddf72a87dd4494a51ed044560b3f185c1357b08fa7ae6c2fdfbd`
...
- Marked-pixel bounds: (66,25)–(188,221); span 123 × 197 px; the marked
...
- 痕迹范围：(66,25)–(188,221)；跨度123 × 197 px；痕迹矩形高于宽。
