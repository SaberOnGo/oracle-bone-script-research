...
Project ID: `obs-evo-cand-006867`
...
- Project ID: `obs-evo-cand-006867`
- EVOBC category candidate ID: `evobc-evo-cat-06867`
- External category reference: `evobc-cat-06867`
- Source category ID: `06867`
- Source label for human review: `羹`
- Source codepoints: `U+7FB9`
...
- `obs-evo-cand-006867-route-category-staging`
...
- `obs-evo-cand-006867-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006867-route-evolution-graph`
