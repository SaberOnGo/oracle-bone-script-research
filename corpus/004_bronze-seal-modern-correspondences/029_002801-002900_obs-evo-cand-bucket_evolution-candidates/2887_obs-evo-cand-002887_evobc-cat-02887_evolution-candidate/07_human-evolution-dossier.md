...
- External category reference: `evobc-cat-02887`
- Source category ID: `02887`
- Source label for human review: `徲`
...
- `obs-evo-cand-002887-route-category-staging`
...
- `obs-evo-cand-002887-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002887-route-evolution-graph`
