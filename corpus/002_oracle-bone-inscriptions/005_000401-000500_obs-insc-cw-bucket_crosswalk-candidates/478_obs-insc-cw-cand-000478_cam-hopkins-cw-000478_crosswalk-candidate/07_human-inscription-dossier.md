...
Project ID: `obs-insc-cw-cand-000478`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000478`
...
- Source page section: `Period III Group 19` /
  `第 III 期第 19 组`
- Source section key: `period-iii-group-19`
...
- Yingguo / 英国所藏: `y2387` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `566` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000478`
