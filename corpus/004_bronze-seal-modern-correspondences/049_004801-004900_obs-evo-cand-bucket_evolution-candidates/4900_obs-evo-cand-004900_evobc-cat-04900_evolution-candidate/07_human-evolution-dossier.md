...
- Project ID: `obs-evo-cand-004900`
- EVOBC category candidate ID: `evobc-evo-cat-04900`
- External category reference: `evobc-cat-04900`
- Source category ID: `04900`
- Source label for human review: `潛`
- Source codepoints: `U+6F5B`
...
- `obs-evo-cand-004900-route-category-staging`
...
- `obs-evo-cand-004900-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004900-route-evolution-graph`
