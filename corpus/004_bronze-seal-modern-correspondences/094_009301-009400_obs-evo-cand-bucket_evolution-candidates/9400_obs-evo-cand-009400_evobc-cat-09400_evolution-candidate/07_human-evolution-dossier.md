...
Project ID: `obs-evo-cand-009400`
...
- Project ID: `obs-evo-cand-009400`
- EVOBC category candidate ID: `evobc-evo-cat-09400`
- External category reference: `evobc-cat-09400`
- Source category ID: `09400`
- Source label for human review: `銼`
- Source codepoints: `U+92BC`
...
- `obs-evo-cand-009400-route-category-staging`
...
- `obs-evo-cand-009400-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009400-route-evolution-graph`
