# obs-unk-004565 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004565`
- primary external id: `hust-obc-und-X-004565`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/065_obs-unk-004565_h
  ust-obc-und-X-004565_oracle-character-candidate/03_visual-assets/001_asset
  -006158_hust-obc-und-X-004565_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/121/X_？_8301_1.png`
- asset id: `asset-006158`
...
- source class: `HUST-OBC/undeciphered/X/121/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/121/X_？_8301_1.png`
- asset id: `asset-006158`
...
- English observation: `Upper bar, U-like outline, and endpoints recorded.`
- 中文观察: `已记录上部横痕、U 形轮廓和末端。`
...
- Which source records identify obs-unk-004565 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004565？
