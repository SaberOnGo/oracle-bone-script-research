# Material Visual Observation / obs-comp-cand-000832 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000832`
- External reference / 外部参照: `obimd-sub-50ymfpwwux`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013703_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/13cqabljgi/50ymfpwwux/50ymfpwwux.png`
- Checksum / 校验和:
  `602979eb4f7826542661bdb40a66e59885f28cb4ddbf6d2a8ccf1e85af1ffa68`
...
- Marked-pixel bounds: (72,29)–(177,222); span 106 × 194 px; the marked
...
- 痕迹范围：(72,29)–(177,222)；跨度106 × 194 px；痕迹矩形高于宽。
