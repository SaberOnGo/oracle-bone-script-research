...
- External category reference: `evobc-cat-05914`
- Source category ID: `05914`
- Source label for human review: `硯`
...
- `obs-evo-cand-005914-route-category-staging`
...
- `obs-evo-cand-005914-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005914-route-evolution-graph`
