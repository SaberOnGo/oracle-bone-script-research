# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006349
...
- Project ID: `obs-evo-cand-006349`.
- EVOBC candidate category: `evobc-evo-cat-06349`.
- Source label for search only: `簝`.
- Source codepoints for search only: `U+7C1D`.
