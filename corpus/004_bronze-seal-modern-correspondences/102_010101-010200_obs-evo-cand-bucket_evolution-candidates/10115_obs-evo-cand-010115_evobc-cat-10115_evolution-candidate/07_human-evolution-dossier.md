...
Project ID: `obs-evo-cand-010115`
...
- Project ID: `obs-evo-cand-010115`
- EVOBC category candidate ID: `evobc-evo-cat-10115`
- External category reference: `evobc-cat-10115`
- Source category ID: `10115`
- Source label for human review: `餧`
- Source codepoints: `U+9927`
...
- `obs-evo-cand-010115-route-category-staging`
...
- `obs-evo-cand-010115-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010115-route-evolution-graph`
