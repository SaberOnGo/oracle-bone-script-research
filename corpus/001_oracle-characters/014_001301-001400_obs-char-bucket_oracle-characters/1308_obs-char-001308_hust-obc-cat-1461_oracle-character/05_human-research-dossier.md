# obs-char-001308 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1308_obs-char-001308_hust-obc-cat-1461_ora
  cle-character/03_visual-assets/001_asset-001313_hust-obc-cat-1461_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1461/H_1461_612BD_0.png`
- asset id: `asset-001313`
...
- source category: `1461`
- validation class: `1307`
- source image route: `HUST-OBC/deciphered/1461/H_1461_612BD_0.png`
- asset id: `asset-001313`
...
- English observation: `A composite image has a broad left branching
  cluster, a central crossing body, and a separate long right curve.`
- 中文观察: `组合图像有宽大的左侧分枝笔画群、中央交叉主体和分离的长右侧弧线。`
...
- dataset label text: `㦫`
- dataset label codepoints: `U+39AB`
...
- filename catalog route clues: `catalog-like filename clue: H_1461
  (H_1461_612BD_0.png)`
...
- Which source records identify obs-char-001308 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001308？
