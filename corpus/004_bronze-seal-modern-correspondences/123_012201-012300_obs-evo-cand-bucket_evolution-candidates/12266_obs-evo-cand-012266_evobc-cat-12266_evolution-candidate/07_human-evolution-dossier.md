...
- External category reference: `evobc-cat-12266`
- Source category ID: `12266`
- Source label for human review: `𧰩`
- Source codepoints: `U+27C29`
...
- `obs-evo-cand-012266-route-category-staging`
...
- `obs-evo-cand-012266-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012266-route-evolution-graph`
