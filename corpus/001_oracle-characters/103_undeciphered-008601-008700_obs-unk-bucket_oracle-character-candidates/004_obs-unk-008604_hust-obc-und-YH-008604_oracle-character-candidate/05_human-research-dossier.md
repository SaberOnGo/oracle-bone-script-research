# obs-unk-008604 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008604`
- primary external id: `hust-obc-und-YH-008604`
...
- local review image route: `corpus/001_oracle-characters/103_undeciphered-008
  601-008700_obs-unk-bucket_oracle-character-candidates/004_obs-unk-008604_h
  ust-obc-und-YH-008604_oracle-character-candidate/03_visual-assets/001_asse
  t-010195_hust-obc-und-YH-008604_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60C5C/H_？_60C5C_0.png`
- asset id: `asset-010195`
...
- source class: `HUST-OBC/undeciphered/Y+H/60C5C/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60C5C/H_？_60C5C_0.png`
- asset id: `asset-010195`
...
- Which source records identify obs-unk-008604 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008604？
