# obs-char-001084 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1084_obs-char-001084_hust-obc-cat-1213_ora
  cle-character/03_visual-assets/001_asset-001089_hust-obc-cat-1213_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1213/G_1213_佚722(甲).png`
- asset id: `asset-001089`
...
- source category: `1213`
- validation class: `1083`
- source image route: `HUST-OBC/deciphered/1213/G_1213_佚722(甲).png`
- asset id: `asset-001089`
...
- English observation: `A narrow upright cluster combines a pointed upper
  projection, a curved right side, and a short lower branch.`
- 中文观察: `狭长直立笔群结合尖状上部外伸、右侧弯笔和短下部分枝。`
...
- dataset label text: `㢳`
- dataset label codepoints: `U+38B3`
...
- Which source records identify obs-char-001084 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001084？
