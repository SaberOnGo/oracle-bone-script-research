...
- Project ID: `obs-evo-cand-000092`
- EVOBC category candidate ID: `evobc-evo-cat-00092`
- External category reference: `evobc-cat-00092`
- Source category ID: `00092`
- Source label for human review: `㡭`
- Source codepoints: `U+386D`
...
- `obs-evo-cand-000092-route-category-staging`
...
- `obs-evo-cand-000092-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000092-route-evolution-graph`
