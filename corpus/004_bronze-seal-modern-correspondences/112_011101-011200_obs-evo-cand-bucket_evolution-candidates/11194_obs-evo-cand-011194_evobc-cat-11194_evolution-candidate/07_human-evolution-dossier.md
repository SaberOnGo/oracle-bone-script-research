...
- External category reference: `evobc-cat-11194`
- Source category ID: `11194`
- Source label for human review: `𢒕`
- Source codepoints: `U+22495`
...
- `obs-evo-cand-011194-route-category-staging`
...
- `obs-evo-cand-011194-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011194-route-evolution-graph`
