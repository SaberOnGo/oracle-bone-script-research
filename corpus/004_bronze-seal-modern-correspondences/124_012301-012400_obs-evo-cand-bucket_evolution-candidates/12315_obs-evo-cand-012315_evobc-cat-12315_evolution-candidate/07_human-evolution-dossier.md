...
- External category reference: `evobc-cat-12315`
- Source category ID: `12315`
- Source label for human review: `𨀯`
- Source codepoints: `U+2802F`
...
- `obs-evo-cand-012315-route-category-staging`
...
- `obs-evo-cand-012315-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012315-route-evolution-graph`
