# obs-unk-004223 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004223`
- primary external id: `hust-obc-und-L-004223`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/023_obs-unk-004223_h
  ust-obc-und-L-004223_oracle-character-candidate/03_visual-assets/001_asset
  -005816_hust-obc-und-L-004223_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4223/L_？_9229.jpg`
- asset id: `asset-005816`
...
- source class: `HUST-OBC/undeciphered/L/4223/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4223/L_？_9229.jpg`
- asset id: `asset-005816`
...
- English observation: `Upper curve, central round trace, right stroke visible.`
- 中文观察: `上部宽弧、中央圆弧痕迹和右侧笔画可见。`
...
- Which source records identify obs-unk-004223 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004223？
