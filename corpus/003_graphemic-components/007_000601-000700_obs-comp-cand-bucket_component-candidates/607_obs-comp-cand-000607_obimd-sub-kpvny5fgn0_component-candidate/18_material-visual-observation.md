# Material Visual Observation / obs-comp-cand-000607 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000607`
- External reference / 外部参照: `obimd-sub-kpvny5fgn0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013155_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/s9y9vbblxa/kpvny5fgn0/kpvny5fgn0.png`
- Checksum / 校验和:
  `f5c9a69a499a55696fcd1124a1388cf43363b74d92fa2f2e51b8d6a6aadc3a81`
...
- Marked-pixel bounds: (64,18)–(187,231); span 124 × 214 px; the marked
...
- 痕迹范围：(64,18)–(187,231)；跨度124 × 214 px；痕迹矩形高于宽。
