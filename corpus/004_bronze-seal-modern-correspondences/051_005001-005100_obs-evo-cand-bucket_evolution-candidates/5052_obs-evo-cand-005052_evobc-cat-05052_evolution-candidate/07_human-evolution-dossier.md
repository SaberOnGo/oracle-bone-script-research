...
Project ID: `obs-evo-cand-005052`
...
- Project ID: `obs-evo-cand-005052`
- EVOBC category candidate ID: `evobc-evo-cat-05052`
- External category reference: `evobc-cat-05052`
- Source category ID: `05052`
- Source label for human review: `炭`
- Source codepoints: `U+70AD`
...
- `obs-evo-cand-005052-route-category-staging`
...
- `obs-evo-cand-005052-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005052-route-evolution-graph`
