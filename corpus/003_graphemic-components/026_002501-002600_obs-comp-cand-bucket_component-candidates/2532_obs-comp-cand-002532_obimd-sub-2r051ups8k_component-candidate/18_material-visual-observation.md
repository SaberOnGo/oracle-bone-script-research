# Material Visual Observation / obs-comp-cand-002532 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002532`
- External reference / 外部参照: `obimd-sub-2r051ups8k`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021051_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2r051ups8k/2r051ups8k/2r051ups8k.png`
- Checksum / 校验和:
  `b973476fd469e0340d91c25c616621dd9489c535a8c4414a412f5dc615ceec01`
...
- Marked-pixel bounds: (50,51)–(194,195); span 145 × 145 px; the marked
...
- 痕迹范围：(50,51)–(194,195)；跨度145 × 145 px；痕迹矩形近方形。
