...
Project ID: `obs-evo-cand-007356`
...
- Project ID: `obs-evo-cand-007356`
- EVOBC category candidate ID: `evobc-evo-cat-07356`
- External category reference: `evobc-cat-07356`
- Source category ID: `07356`
- Source label for human review: `荡`
- Source codepoints: `U+8361`
...
- `obs-evo-cand-007356-route-category-staging`
...
- `obs-evo-cand-007356-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007356-route-evolution-graph`
