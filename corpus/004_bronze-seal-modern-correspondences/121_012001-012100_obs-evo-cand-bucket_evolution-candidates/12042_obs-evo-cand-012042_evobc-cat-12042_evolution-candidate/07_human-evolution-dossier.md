...
Project ID: `obs-evo-cand-012042`
...
- Project ID: `obs-evo-cand-012042`
- EVOBC category candidate ID: `evobc-evo-cat-12042`
- External category reference: `evobc-cat-12042`
- Source category ID: `12042`
- Source label for human review: `𦚈`
- Source codepoints: `U+26688`
...
- `obs-evo-cand-012042-route-category-staging`
...
- `obs-evo-cand-012042-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012042-route-evolution-graph`
