# Material Visual Observation / obs-comp-cand-002172 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002172`
- External reference / 外部参照: `obimd-sub-72mwfaddd3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019873_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/q4rk3syf2x/72mwfaddd3/72mwfaddd3.png`
- Checksum / 校验和:
  `7d6a8d9fe60c1b22e140ae0e53425e996e561f2888b2c87f4d5722c8601b9596`
...
- Marked-pixel bounds: (83,32)–(166,210); span 84 × 179 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.36%。
- 痕迹范围：(83,32)–(166,210)；跨度84 × 179 px；痕迹矩形高于宽。
