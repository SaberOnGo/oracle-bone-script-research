# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010394
...
- EVOBC candidate category: `evobc-evo-cat-10394`.
- Source label for search only: `鮞`.
- Source codepoints for search only: `U+9B9E`.
