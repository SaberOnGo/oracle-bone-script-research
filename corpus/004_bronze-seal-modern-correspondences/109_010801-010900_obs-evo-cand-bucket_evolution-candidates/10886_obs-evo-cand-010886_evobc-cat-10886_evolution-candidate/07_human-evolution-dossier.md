...
- External category reference: `evobc-cat-10886`
- Source category ID: `10886`
- Source label for human review: `𠧠`
...
- `obs-evo-cand-010886-route-category-staging`
...
- `obs-evo-cand-010886-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010886-route-evolution-graph`
