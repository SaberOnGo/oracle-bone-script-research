# obs-unk-000479 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000479`
- primary external id: `hust-obc-und-L-000479`
...
- local review image route: `corpus/001_oracle-characters/021_undeciphered-000
  401-000500_obs-unk-bucket_oracle-character-candidates/079_obs-unk-000479_h
  ust-obc-und-L-000479_oracle-character-candidate/03_visual-assets/001_asset
  -002072_hust-obc-und-L-000479_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/479/L_？_1147.jpg`
- asset id: `asset-002072`
...
- source class: `HUST-OBC/undeciphered/L/479/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/479/L_？_1147.jpg`
- asset id: `asset-002072`
...
- Which source records identify obs-unk-000479 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000479？
