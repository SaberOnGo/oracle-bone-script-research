# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001306
...
| --- | --- | --- | --- |
| `obimd-glyph-link-019633` | 򺵣󷞨 | `U+BAD63;U+F77A8` | `reviewed_metadata_only` |
| `obimd-glyph-link-019634` | 󷞩 | `U+F77A9` | `reviewed_metadata_only` |
| `obimd-glyph-link-019635` | 󷞪 | `U+F77AA` | `reviewed_metadata_only` |
| `obimd-glyph-link-019636` | 󷞫 | `U+F77AB` | `reviewed_metadata_only` |
