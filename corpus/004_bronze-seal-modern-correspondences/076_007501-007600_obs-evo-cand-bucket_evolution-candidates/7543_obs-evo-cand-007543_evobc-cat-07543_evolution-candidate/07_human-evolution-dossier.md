...
Project ID: `obs-evo-cand-007543`
...
- Project ID: `obs-evo-cand-007543`
- EVOBC category candidate ID: `evobc-evo-cat-07543`
- External category reference: `evobc-cat-07543`
- Source category ID: `07543`
- Source label for human review: `蓼`
- Source codepoints: `U+84FC`
...
- `obs-evo-cand-007543-route-category-staging`
...
- `obs-evo-cand-007543-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007543-route-evolution-graph`
