# obs-char-000705 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000705`
- primary external id: `hust-obc-cat-0799`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/705_obs-char-000705_hust-obc-cat-0799_orac
  le-character/03_visual-assets/001_asset-000710_hust-obc-cat-0799_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0799/G_0799_戩5.13(甲).png`
- asset id: `asset-000710`
...
- source category: `0799`
- validation class: `704`
- source image route: `HUST-OBC/deciphered/0799/G_0799_戩5.13(甲).png`
- asset id: `asset-000710`
...
- English observation: `A tiny vertical stack combines a small divided top
  rectangle, a crossed diamond-like middle loop, and a long narrow lower
  stem with two angular bends.`
- 中文观察: `微小竖向层叠形结合带分隔的小顶矩形、交叉菱形中环和带两处折角的长狭下干。`
...
- dataset label text: `㜕`
- dataset label codepoints: `U+3715`
...
- Which source records identify obs-char-000705 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000705？
