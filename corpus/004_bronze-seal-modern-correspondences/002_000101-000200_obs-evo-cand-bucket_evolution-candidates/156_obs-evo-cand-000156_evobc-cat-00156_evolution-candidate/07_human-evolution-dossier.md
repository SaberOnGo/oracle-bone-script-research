...
- External category reference: `evobc-cat-00156`
- Source category ID: `00156`
- Source label for human review: `㫍`
- Source codepoints: `U+3ACD`
...
- `obs-evo-cand-000156-route-category-staging`
...
- `obs-evo-cand-000156-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000156-route-evolution-graph`
