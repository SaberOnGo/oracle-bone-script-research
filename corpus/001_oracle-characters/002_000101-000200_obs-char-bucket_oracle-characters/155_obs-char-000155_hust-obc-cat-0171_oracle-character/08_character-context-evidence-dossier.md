...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0171`
...
- Source image / 来源图: `G_0171_甲3939(甲).png`
- Image / 图像: `001_asset-000160_hust-obc-cat-0171_glyph.png`
...
- target node: `evobc-evo-cat-00014`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/014_obs-evo-cand-000014_evobc-cat-00014_evoluti
...
- Source label text / 来源标签文字: `㒡`
- Source label codepoint / 来源标签 codepoint: `U+34A1`
