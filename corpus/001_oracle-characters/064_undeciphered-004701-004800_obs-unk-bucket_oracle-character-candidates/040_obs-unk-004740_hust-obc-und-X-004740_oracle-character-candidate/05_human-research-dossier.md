# obs-unk-004740 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/040_obs-unk-004740_h
  ust-obc-und-X-004740_oracle-character-candidate/03_visual-assets/001_asset
  -006333_hust-obc-und-X-004740_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/296/X_？_7274_1.png`
- asset id: `asset-006333`
...
- source class: `HUST-OBC/undeciphered/X/296/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/296/X_？_7274_1.png`
- asset id: `asset-006333`
...
- English observation: `separated upper groups with lower opening`
- 中文观察: `带下部开口的分离上部结构组`
...
- Which source records identify obs-unk-004740 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004740？
