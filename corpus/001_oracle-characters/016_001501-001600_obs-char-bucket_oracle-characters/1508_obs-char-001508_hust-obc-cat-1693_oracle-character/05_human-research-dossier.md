# obs-char-001508 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001508`
- primary external id: `hust-obc-cat-1693`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1508_obs-char-001508_hust-obc-cat-1693_ora
  cle-character/03_visual-assets/001_asset-001513_hust-obc-cat-1693_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1693/L_1693_7778.jpg`
- asset id: `asset-001513`
...
- source category: `1693`
- validation class: `1507`
- source image route: `HUST-OBC/deciphered/1693/L_1693_7778.jpg`
- asset id: `asset-001513`
...
- English observation: `Two faint adjacent forms repeat a forked upper mark,
  a short crossbar, and a narrow stem.`
- 中文观察: `两个浅淡相邻形体重复分叉上部标记、短横笔和狭长竖干。`
...
- dataset label text: `㪓`
- dataset label codepoints: `U+3A93`
...
- Which source records identify obs-char-001508 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001508？
