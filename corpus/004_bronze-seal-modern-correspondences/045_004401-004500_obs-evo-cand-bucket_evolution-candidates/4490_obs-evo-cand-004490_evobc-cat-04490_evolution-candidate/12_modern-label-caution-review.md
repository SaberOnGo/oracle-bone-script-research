# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004490
...
- EVOBC candidate category: `evobc-evo-cat-04490`.
- Source label for search only: `汍`.
- Source codepoints for search only: `U+6C4D`.
