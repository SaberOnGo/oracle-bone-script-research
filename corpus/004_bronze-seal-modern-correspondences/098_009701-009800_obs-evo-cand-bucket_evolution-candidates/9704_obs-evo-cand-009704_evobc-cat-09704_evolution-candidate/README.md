# obs-evo-cand-009704 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-009704`
- EVOBC category candidate ID: `evobc-evo-cat-09704`
- External category ref: `evobc-cat-09704`
- Source label: `阱`
- Source codepoints: `U+9631`
- Image reference count: `99`
- Era token counts: `OBC:88;SS:1;WSC:10`
- Source token counts: `Book:31;Web:68`
...
- source 7 / Book:9676: 25 image references
