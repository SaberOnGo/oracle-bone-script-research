# Material Visual Observation / obs-comp-cand-000234 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000234`
- External reference / 外部参照: `obimd-sub-id0m0j1kjy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011881_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/id0m0j1kjy/id0m0j1kjy/id0m0j1kjy.png`
- Checksum / 校验和:
  `56d444b09c879984cf0f7ca5350afd7252f8c92743d72db6f7a123f3b7737814`
...
- Marked-pixel bounds: (58,51)–(191,199); span 134 × 149 px; the marked
...
- 痕迹范围：(58,51)–(191,199)；跨度134 × 149 px；痕迹矩形近方形。
