...
Project ID: `obs-evo-cand-001603`
...
- Project ID: `obs-evo-cand-001603`
- EVOBC category candidate ID: `evobc-evo-cat-01603`
- External category reference: `evobc-cat-01603`
- Source category ID: `01603`
- Source label for human review: `唏`
- Source codepoints: `U+550F`
...
- `obs-evo-cand-001603-route-category-staging`
...
- `obs-evo-cand-001603-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001603-route-evolution-graph`
