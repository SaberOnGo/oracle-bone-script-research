# obs-unk-004557 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/057_obs-unk-004557_h
  ust-obc-und-X-004557_oracle-character-candidate/03_visual-assets/001_asset
  -006150_hust-obc-und-X-004557_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/113/X_？_7102_1.png`
- asset id: `asset-006150`
...
- source class: `HUST-OBC/undeciphered/X/113/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/113/X_？_7102_1.png`
- asset id: `asset-006150`
...
- English observation: `Upper peaks, middle band, and lower traces recorded.`
- 中文观察: `已记录上部尖顶、中部横带和下部痕迹。`
...
- Which source records identify obs-unk-004557 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004557？
