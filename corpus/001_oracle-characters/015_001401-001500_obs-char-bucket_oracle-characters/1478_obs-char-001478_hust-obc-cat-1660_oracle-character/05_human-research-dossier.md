# obs-char-001478 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1478_obs-char-001478_hust-obc-cat-1660_ora
  cle-character/03_visual-assets/001_asset-001483_hust-obc-cat-1660_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1660/G_1660_乙1044合9946.png`
- asset id: `asset-001483`
...
- source category: `1660`
- validation class: `1477`
- source image route: `HUST-OBC/deciphered/1660/G_1660_乙1044合9946.png`
- asset id: `asset-001483`
...
- English observation: `A narrow tall cluster has a branching left edge and
  detached right marks.`
- 中文观察: `狭长高大笔画群有分枝左缘和分离右侧短笔。`
...
- dataset label text: `㩲`
- dataset label codepoints: `U+3A72`
...
- filename catalog route clues: `Heji-like filename clue: 合9946
...
- Which source records identify obs-char-001478 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001478？
