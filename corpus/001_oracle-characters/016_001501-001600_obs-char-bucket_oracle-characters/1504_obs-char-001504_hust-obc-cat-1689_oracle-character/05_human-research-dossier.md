# obs-char-001504 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001504`
- primary external id: `hust-obc-cat-1689`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1504_obs-char-001504_hust-obc-cat-1689_ora
  cle-character/03_visual-assets/001_asset-001509_hust-obc-cat-1689_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1689/G_1689_乙2737合1385賓組.png`
- asset id: `asset-001509`
...
- source category: `1689`
- validation class: `1503`
- source image route: `HUST-OBC/deciphered/1689/G_1689_乙2737合1385賓組.png`
- asset id: `asset-001509`
...
- English observation: `A small composite has a crossing upper structure, a
  central stem, and a lower oval loop.`
- 中文观察: `小型组合形体有交叉上部结构、中央竖干和下部椭圆环。`
...
- dataset label text: `㪏`
- dataset label codepoints: `U+3A8F`
...
- filename catalog route clues: `Heji-like filename clue: 合1385
  (G_1689_乙2737合1385賓組.png)`
...
- Which source records identify obs-char-001504 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001504？
