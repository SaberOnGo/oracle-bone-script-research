# Material Visual Observation / obs-comp-cand-001079 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001079`
- External reference / 外部参照: `obimd-sub-8kl4colp8e`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014776_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8kl4colp8e/8kl4colp8e/8kl4colp8e.png`
- Checksum / 校验和:
  `64ee9af650748712edcbe5186ec598f60f4cca44f835b230cb04f962e535f9c0`
...
- Marked-pixel bounds: (88,21)–(161,232); span 74 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.42%。
- 痕迹范围：(88,21)–(161,232)；跨度74 × 212 px；痕迹矩形高于宽。
