...
Project ID: `obs-evo-cand-002973`
...
- Project ID: `obs-evo-cand-002973`
- EVOBC category candidate ID: `evobc-evo-cat-02973`
- External category reference: `evobc-cat-02973`
- Source category ID: `02973`
- Source label for human review: `恔`
- Source codepoints: `U+6054`
...
- `obs-evo-cand-002973-route-category-staging`
...
- `obs-evo-cand-002973-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002973-route-evolution-graph`
