# obs-char-000045 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/045_obs-char-000045_hust-obc-cat-0052_0053
  _oracle-character/03_visual-assets/001_asset-000050_hust-obc-cat-0052_0053
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0052_0053/0052/G_0052_京津581合560
  7賓組.png`
- asset id: `asset-000050`
...
- source category: `0052_0053`
- validation class: `44`
- source image route: `HUST-OBC/deciphered/0052_0053/0052/G_0052_京津581合5607賓組.
  png`
- asset id: `asset-000050`
...
- English observation: `Two separated forms are visible: a small divided
  square-like form on the left and a thin upright form with an upper loop on
  the right.`
...
- dataset label text: `㐪㐫`
- dataset label codepoints: `U+342A;U+342B`
...
- filename catalog route clues: `Heji-like filename clue: 合5607
...
- Which source records identify obs-char-000045 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000045？
