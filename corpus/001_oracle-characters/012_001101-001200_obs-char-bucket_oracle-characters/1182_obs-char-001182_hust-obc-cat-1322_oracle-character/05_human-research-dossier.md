# obs-char-001182 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1182_obs-char-001182_hust-obc-cat-1322_ora
  cle-character/03_visual-assets/001_asset-001187_hust-obc-cat-1322_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1322/G_1322_乙3299合5995賓組.png`
- asset id: `asset-001187`
...
- source category: `1322`
- validation class: `1181`
- source image route: `HUST-OBC/deciphered/1322/G_1322_乙3299合5995賓組.png`
- asset id: `asset-001187`
...
- English observation: `A narrow upright form has a forked upper stroke, a
  short detached right mark, and a rounded lower enclosure.`
- 中文观察: `狭长直立形体有分叉上笔、右侧短分离痕迹和圆弧形下部框廓。`
...
- dataset label text: `㤠`
- dataset label codepoints: `U+3920`
...
- filename catalog route clues: `Heji-like filename clue: 合5995
  (G_1322_乙3299合5995賓組.png)`
...
- Which source records identify obs-char-001182 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001182？
