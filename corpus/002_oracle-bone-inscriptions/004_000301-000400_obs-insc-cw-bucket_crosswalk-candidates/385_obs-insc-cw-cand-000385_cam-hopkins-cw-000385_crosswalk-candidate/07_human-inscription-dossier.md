...
Project ID: `obs-insc-cw-cand-000385`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000385`
...
- Yingguo / 英国所藏: `y2141` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `441` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `10` in source row; primary catalog entry pending
- Heji / 合集: `41198` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000385`
