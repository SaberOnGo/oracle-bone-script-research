...
- External category reference: `evobc-cat-11910`
- Source category ID: `11910`
- Source label for human review: `𥷖`
- Source codepoints: `U+25DD6`
...
- `obs-evo-cand-011910-route-category-staging`
...
- `obs-evo-cand-011910-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011910-route-evolution-graph`
