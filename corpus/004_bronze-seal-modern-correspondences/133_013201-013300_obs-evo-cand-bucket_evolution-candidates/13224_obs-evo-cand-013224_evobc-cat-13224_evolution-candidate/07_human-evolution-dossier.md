...
- External category reference: `evobc-cat-13224`
- Source category ID: `13224`
- Source label for human review: `𬈉`
...
- `obs-evo-cand-013224-route-category-staging`
...
- `obs-evo-cand-013224-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013224-route-evolution-graph`
