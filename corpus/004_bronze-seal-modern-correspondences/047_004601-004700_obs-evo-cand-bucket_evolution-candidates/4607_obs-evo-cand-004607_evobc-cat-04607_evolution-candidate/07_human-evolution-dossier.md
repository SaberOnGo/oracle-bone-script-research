...
- External category reference: `evobc-cat-04607`
- Source category ID: `04607`
- Source label for human review: `洁`
- Source codepoints: `U+6D01`
...
- `obs-evo-cand-004607-route-category-staging`
...
- `obs-evo-cand-004607-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004607-route-evolution-graph`
