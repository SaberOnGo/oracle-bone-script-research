# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004257
...
- EVOBC candidate category: `evobc-evo-cat-04257`.
- Source label for search only: `樿`.
- Source codepoints for search only: `U+6A3F`.
