# Material Visual Observation / obs-comp-cand-001273 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001273`
- External reference / 外部参照: `obimd-sub-zu0urjl5fr`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015511_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zu0urjl5fr/zu0urjl5fr/zu0urjl5fr.png`
- Checksum / 校验和:
  `079a43a98c8cd30392f0de72216a38ac7fa568bdcc2a38b45c92648af7716bf8`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.65%.
- Marked-pixel bounds: (95,42)–(174,215); span 80 × 174 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.65%。
- 痕迹范围：(95,42)–(174,215)；跨度80 × 174 px；痕迹矩形高于宽。
