# Material Visual Observation / obs-comp-cand-001883 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001883`
- External reference / 外部参照: `obimd-sub-1orvjqlxo2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018262_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wfyy86f1n0/1orvjqlxo2/1orvjqlxo2.png`
- Checksum / 校验和:
  `beef37411acbb98851cb6880e526ebad67f38c6fc2f232acc1ffb5bac93de83d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.12%.
- Marked-pixel bounds: (76,35)–(173,209); span 98 × 175 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.12%。
- 痕迹范围：(76,35)–(173,209)；跨度98 × 175 px；痕迹矩形高于宽。
