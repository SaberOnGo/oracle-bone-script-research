...
- Project ID: `obs-evo-cand-003672`
- EVOBC category candidate ID: `evobc-evo-cat-03672`
- External category reference: `evobc-cat-03672`
- Source category ID: `03672`
- Source label for human review: `旐`
- Source codepoints: `U+65D0`
...
- `obs-evo-cand-003672-route-category-staging`
...
- `obs-evo-cand-003672-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003672-route-evolution-graph`
