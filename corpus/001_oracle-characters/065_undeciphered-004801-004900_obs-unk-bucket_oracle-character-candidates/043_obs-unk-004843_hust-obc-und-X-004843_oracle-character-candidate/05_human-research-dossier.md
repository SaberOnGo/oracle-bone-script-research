# obs-unk-004843 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004843`
- primary external id: `hust-obc-und-X-004843`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/043_obs-unk-004843_h
  ust-obc-und-X-004843_oracle-character-candidate/03_visual-assets/001_asset
  -006436_hust-obc-und-X-004843_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/399/X_？_7385_1.png`
- asset id: `asset-006436`
...
- source class: `HUST-OBC/undeciphered/X/399/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/399/X_？_7385_1.png`
- asset id: `asset-006436`
...
- English observation: `top crossing, central round mark, and lower strokes`
- 中文观察: `上部交叉、中部圆点状标记和下部长笔画`
...
- Which source records identify obs-unk-004843 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004843？
