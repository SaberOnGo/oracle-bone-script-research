...
- External category reference: `evobc-cat-12539`
- Source category ID: `12539`
- Source label for human review: `𨿌`
...
- `obs-evo-cand-012539-route-category-staging`
...
- `obs-evo-cand-012539-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012539-route-evolution-graph`
