...
- External category reference: `evobc-cat-07394`
- Source category ID: `07394`
- Source label for human review: `莲`
- Source codepoints: `U+83B2`
...
- `obs-evo-cand-007394-route-category-staging`
...
- `obs-evo-cand-007394-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007394-route-evolution-graph`
