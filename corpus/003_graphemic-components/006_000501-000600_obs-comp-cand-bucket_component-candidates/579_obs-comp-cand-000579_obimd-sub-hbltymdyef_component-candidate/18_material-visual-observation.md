# Material Visual Observation / obs-comp-cand-000579 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000579`
- External reference / 外部参照: `obimd-sub-hbltymdyef`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013107_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hbltymdyef/hbltymdyef/hbltymdyef.png`
- Checksum / 校验和:
  `7ee4915c9a8320e4662c1a71406cb681c430c1510330855e96ebf8e60019802c`
...
- Marked-pixel bounds: (86,31)–(179,227); span 94 × 197 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.82%。
- 痕迹范围：(86,31)–(179,227)；跨度94 × 197 px；痕迹矩形高于宽。
