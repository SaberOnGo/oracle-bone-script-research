...
Project ID: `obs-evo-cand-000729`
...
- Project ID: `obs-evo-cand-000729`
- EVOBC category candidate ID: `evobc-evo-cat-00729`
- External category reference: `evobc-cat-00729`
- Source category ID: `00729`
- Source label for human review: `仍`
- Source codepoints: `U+4ECD`
...
- `obs-evo-cand-000729-route-category-staging`
...
- `obs-evo-cand-000729-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000729-route-evolution-graph`
