...
- External category reference: `evobc-cat-11456`
- Source category ID: `11456`
- Source label for human review: `𣡌`
...
- `obs-evo-cand-011456-route-category-staging`
...
- `obs-evo-cand-011456-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011456-route-evolution-graph`
