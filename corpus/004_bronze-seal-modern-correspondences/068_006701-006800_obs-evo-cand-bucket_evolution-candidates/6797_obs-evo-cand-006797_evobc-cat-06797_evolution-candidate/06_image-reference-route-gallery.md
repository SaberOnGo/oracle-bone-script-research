...
- `obs-evo-cand-006797-route-category-staging`
...
- `obs-evo-cand-006797-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006797-route-evolution-graph`
