# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-002604
...
- candidate_component_id: `obs-comp-cand-002604`
- primary_external_ref_id: `obimd-sub-an8tdlt5m3`
- source_subcharacter_uid: `an8tdlt5m3`
- source_main_character_uid: `an8tdlt5m3`
- main_character_external_ref_id: `obimd-main-an8tdlt5m3`
...
- glyph_codepoint_uplus_sample: `U+FEB78, U+FFB27`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-021143` | `001_asset-021143_img.png` | `97b2cc97d261338e7ad25c53428256b60e3e7c08294763f1aa666e237bbb94d5` |
