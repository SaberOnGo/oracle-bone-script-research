...
- External category reference: `evobc-cat-12029`
- Source category ID: `12029`
- Source label for human review: `𦕆`
- Source codepoints: `U+26546`
...
- `obs-evo-cand-012029-route-category-staging`
...
- `obs-evo-cand-012029-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012029-route-evolution-graph`
