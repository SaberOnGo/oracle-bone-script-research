...
- Project ID: `obs-evo-cand-011240`
- EVOBC category candidate ID: `evobc-evo-cat-11240`
- External category reference: `evobc-cat-11240`
- Source category ID: `11240`
- Source label for human review: `𢛆`
- Source codepoints: `U+226C6`
...
- `obs-evo-cand-011240-route-category-staging`
...
- `obs-evo-cand-011240-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011240-route-evolution-graph`
