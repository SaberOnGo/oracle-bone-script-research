...
- External category reference: `evobc-cat-00551`
- Source category ID: `00551`
- Source label for human review: `䫞`
...
- `obs-evo-cand-000551-route-category-staging`
...
- `obs-evo-cand-000551-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000551-route-evolution-graph`
