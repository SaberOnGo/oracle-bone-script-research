...
Project ID: `obs-evo-cand-001415`
...
- Project ID: `obs-evo-cand-001415`
- EVOBC category candidate ID: `evobc-evo-cat-01415`
- External category reference: `evobc-cat-01415`
- Source category ID: `01415`
- Source label for human review: `厉`
- Source codepoints: `U+5389`
...
- `obs-evo-cand-001415-route-category-staging`
...
- `obs-evo-cand-001415-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001415-route-evolution-graph`
