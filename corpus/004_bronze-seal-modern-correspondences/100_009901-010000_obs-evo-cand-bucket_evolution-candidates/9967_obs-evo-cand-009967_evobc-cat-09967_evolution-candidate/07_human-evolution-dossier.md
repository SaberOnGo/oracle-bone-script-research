...
- External category reference: `evobc-cat-09967`
- Source category ID: `09967`
- Source label for human review: `響`
...
- `obs-evo-cand-009967-route-category-staging`
...
- `obs-evo-cand-009967-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009967-route-evolution-graph`
