# Material Visual Observation / obs-comp-cand-002272 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002272`
- External reference / 外部参照: `obimd-sub-xel4l5p8v6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020156_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xel4l5p8v6/xel4l5p8v6/xel4l5p8v6.png`
- Checksum / 校验和:
  `c3db26c94ffec2d405aba253205d13a2c22115ddef94e531a111fc4e74209125`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.84%.
- Marked-pixel bounds: (86,15)–(170,237); span 85 × 223 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.84%。
- 痕迹范围：(86,15)–(170,237)；跨度85 × 223 px；痕迹矩形高于宽。
