...
- External category reference: `evobc-cat-01385`
- Source category ID: `01385`
- Source label for human review: `占`
- Source codepoints: `U+5360`
- Image reference count in source metadata: `256`
...
- `obs-evo-cand-001385-route-category-staging`
...
- `obs-evo-cand-001385-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001385-route-evolution-graph`
