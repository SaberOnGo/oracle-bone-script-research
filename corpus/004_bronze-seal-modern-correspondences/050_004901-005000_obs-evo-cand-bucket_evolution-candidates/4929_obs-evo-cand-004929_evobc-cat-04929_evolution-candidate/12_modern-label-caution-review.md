# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004929
...
- EVOBC candidate category: `evobc-evo-cat-04929`.
- Source label for search only: `澍`.
- Source codepoints for search only: `U+6F8D`.
