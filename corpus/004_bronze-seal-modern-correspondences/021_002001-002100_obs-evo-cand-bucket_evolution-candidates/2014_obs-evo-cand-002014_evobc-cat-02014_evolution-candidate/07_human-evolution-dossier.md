...
- External category reference: `evobc-cat-02014`
- Source category ID: `02014`
- Source label for human review: `夭`
- Source codepoints: `U+592D`
...
- `obs-evo-cand-002014-route-category-staging`
...
- `obs-evo-cand-002014-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002014-route-evolution-graph`
