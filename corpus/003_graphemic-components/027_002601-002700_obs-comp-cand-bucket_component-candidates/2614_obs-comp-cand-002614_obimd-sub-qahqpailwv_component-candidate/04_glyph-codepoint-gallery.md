# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002614
...
| --- | --- | --- | --- |
| `obimd-glyph-link-039586` | 󾯒 | `U+FEBD2` | `reviewed_metadata_only` |
| `obimd-glyph-link-039587` | 󾯓 | `U+FEBD3` | `reviewed_metadata_only` |
| `obimd-glyph-link-039588` | 󾯔 | `U+FEBD4` | `reviewed_metadata_only` |
