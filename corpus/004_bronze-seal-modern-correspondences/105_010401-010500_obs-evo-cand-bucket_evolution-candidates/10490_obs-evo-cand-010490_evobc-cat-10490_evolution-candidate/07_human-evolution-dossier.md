...
Project ID: `obs-evo-cand-010490`
...
- Project ID: `obs-evo-cand-010490`
- EVOBC category candidate ID: `evobc-evo-cat-10490`
- External category reference: `evobc-cat-10490`
- Source category ID: `10490`
- Source label for human review: `鴝`
- Source codepoints: `U+9D1D`
...
- `obs-evo-cand-010490-route-category-staging`
...
- `obs-evo-cand-010490-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010490-route-evolution-graph`
