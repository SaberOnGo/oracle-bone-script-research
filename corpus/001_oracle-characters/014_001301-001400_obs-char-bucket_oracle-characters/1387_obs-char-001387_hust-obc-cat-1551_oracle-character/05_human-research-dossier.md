# obs-char-001387 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001387`
- primary external id: `hust-obc-cat-1551`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1387_obs-char-001387_hust-obc-cat-1551_ora
  cle-character/03_visual-assets/001_asset-001392_hust-obc-cat-1551_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1551/G_1551_乙2101合150賓組.png`
- asset id: `asset-001392`
...
- source category: `1551`
- validation class: `1386`
- source image route: `HUST-OBC/deciphered/1551/G_1551_乙2101合150賓組.png`
- asset id: `asset-001392`
...
- English observation: `A dark branching left stem is paired with a divided
  rectangular right enclosure.`
- 中文观察: `深色分枝左竖干与有隔分的右侧矩形框形相邻。`
...
- dataset label text: `㨅`
- dataset label codepoints: `U+3A05`
...
- Which source records identify obs-char-001387 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001387？
