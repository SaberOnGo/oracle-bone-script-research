...
- External category reference: `evobc-cat-07696`
- Source category ID: `07696`
- Source label for human review: `虓`
- Source codepoints: `U+8653`
...
- `obs-evo-cand-007696-route-category-staging`
...
- `obs-evo-cand-007696-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007696-route-evolution-graph`
