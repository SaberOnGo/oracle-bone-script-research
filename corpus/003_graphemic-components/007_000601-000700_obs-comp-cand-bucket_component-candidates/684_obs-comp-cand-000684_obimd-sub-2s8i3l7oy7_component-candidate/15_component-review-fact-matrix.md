# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000684
...
| Glyph or codepoint route / 字形或码位路线 | 6 OBIMD route rows; examples U+A8C8C;U+F3EAE; U+F3EAF; 另有 4 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
