# obs-unk-004449 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/049_obs-unk-004449_h
  ust-obc-und-X-004449_oracle-character-candidate/03_visual-assets/001_asset
  -006042_hust-obc-und-X-004449_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/5/X_？_8184_1.png`
- asset id: `asset-006042`
...
- source class: `HUST-OBC/undeciphered/X/5/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/5/X_？_8184_1.png`
- asset id: `asset-006042`
...
- English observation: `A tall central stem leads from upper branches to`
  `a lower open loop.`
- 中文观察: `高中央竖干从上部分支延至下部开放环状轮廓。`
...
- Which source records identify obs-unk-004449 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004449？
