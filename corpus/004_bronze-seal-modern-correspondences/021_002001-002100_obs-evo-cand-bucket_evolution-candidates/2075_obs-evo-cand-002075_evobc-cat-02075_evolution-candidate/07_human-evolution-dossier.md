...
- External category reference: `evobc-cat-02075`
- Source category ID: `02075`
- Source label for human review: `妌`
- Source codepoints: `U+598C`
...
- `obs-evo-cand-002075-route-category-staging`
...
- `obs-evo-cand-002075-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002075-route-evolution-graph`
