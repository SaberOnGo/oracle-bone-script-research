# obs-unk-004146 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004146`
- primary external id: `hust-obc-und-L-004146`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/046_obs-unk-004146_h
  ust-obc-und-L-004146_oracle-character-candidate/03_visual-assets/001_asset
  -005739_hust-obc-und-L-004146_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4146/L_？_8968.jpg`
- asset id: `asset-005739`
...
- source class: `HUST-OBC/undeciphered/L/4146/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4146/L_？_8968.jpg`
- asset id: `asset-005739`
...
- English observation: An angular upper trace turns down on the right;
  dense overlapping marks fill the lower area.
- 中文观察：上部折角痕迹向右下转折；下部有密集重叠痕迹。
...
- Which source records identify obs-unk-004146 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004146？
