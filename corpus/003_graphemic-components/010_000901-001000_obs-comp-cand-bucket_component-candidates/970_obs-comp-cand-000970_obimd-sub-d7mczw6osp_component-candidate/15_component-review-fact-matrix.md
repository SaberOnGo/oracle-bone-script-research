# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000970
...
| Glyph or codepoint route / 字形或码位路线 | 91 OBIMD route rows; examples U+5DF3;U+F5776; U+F5777; 另有 89 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 91 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
