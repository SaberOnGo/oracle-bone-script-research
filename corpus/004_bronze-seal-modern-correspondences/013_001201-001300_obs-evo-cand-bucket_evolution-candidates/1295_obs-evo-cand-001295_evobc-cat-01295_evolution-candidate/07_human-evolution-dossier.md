...
- Project ID: `obs-evo-cand-001295`
- EVOBC category candidate ID: `evobc-evo-cat-01295`
- External category reference: `evobc-cat-01295`
- Source category ID: `01295`
- Source label for human review: `勖`
- Source codepoints: `U+52D6`
...
- `obs-evo-cand-001295-route-category-staging`
...
- `obs-evo-cand-001295-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001295-route-evolution-graph`
