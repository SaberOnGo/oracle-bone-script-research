...
Project ID: `obs-evo-cand-013544`
...
- Project ID: `obs-evo-cand-013544`
- EVOBC category candidate ID: `evobc-evo-cat-13544`
- External category reference: `evobc-cat-13544`
- Source category ID: `13544`
- Source label for human review: `𭥗`
- Source codepoints: `U+2D957`
...
- `obs-evo-cand-013544-route-category-staging`
...
- `obs-evo-cand-013544-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013544-route-evolution-graph`
