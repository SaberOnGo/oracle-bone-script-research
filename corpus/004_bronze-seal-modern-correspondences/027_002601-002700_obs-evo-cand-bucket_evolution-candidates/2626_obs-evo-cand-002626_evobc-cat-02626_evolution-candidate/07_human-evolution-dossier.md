...
Project ID: `obs-evo-cand-002626`
...
- Project ID: `obs-evo-cand-002626`
- EVOBC category candidate ID: `evobc-evo-cat-02626`
- External category reference: `evobc-cat-02626`
- Source category ID: `02626`
- Source label for human review: `巳`
- Source codepoints: `U+5DF3`
- Image reference count in source metadata: `248`
...
- `obs-evo-cand-002626-route-category-staging`
...
- `obs-evo-cand-002626-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002626-route-evolution-graph`
