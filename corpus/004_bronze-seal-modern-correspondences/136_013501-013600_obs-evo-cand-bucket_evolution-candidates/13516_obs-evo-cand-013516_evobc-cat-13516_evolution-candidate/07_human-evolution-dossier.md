...
- External category reference: `evobc-cat-13516`
- Source category ID: `13516`
- Source label for human review: `𭘺`
- Source codepoints: `U+2D63A`
...
- `obs-evo-cand-013516-route-category-staging`
...
- `obs-evo-cand-013516-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013516-route-evolution-graph`
