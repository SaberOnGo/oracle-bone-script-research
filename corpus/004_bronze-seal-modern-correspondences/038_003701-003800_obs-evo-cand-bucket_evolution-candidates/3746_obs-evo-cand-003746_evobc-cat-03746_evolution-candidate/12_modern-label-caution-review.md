# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003746
...
- EVOBC candidate category: `evobc-evo-cat-03746`.
- Source label for search only: `晛`.
- Source codepoints for search only: `U+665B`.
