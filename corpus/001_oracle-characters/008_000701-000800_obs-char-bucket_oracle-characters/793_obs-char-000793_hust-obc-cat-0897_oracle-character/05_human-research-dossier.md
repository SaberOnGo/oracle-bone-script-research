# obs-char-000793 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/793_obs-char-000793_hust-obc-cat-0897_orac
  le-character/03_visual-assets/001_asset-000798_hust-obc-cat-0897_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0897/G_0897_京津3995合27389無名組.png
  `
- asset id: `asset-000798`
...
- source category: `0897`
- validation class: `792`
- source image route: `HUST-OBC/deciphered/0897/G_0897_京津3995合27389無名組.png`
- asset id: `asset-000798`
...
- English observation: `A dense forked left cluster stands beside a taller
  curved right stem with several short side branches and a pointed upper
  turn.`
- 中文观察: `浓重分叉左笔群旁有一条较高弯曲右干，右干带数条短侧枝并在上端尖折。`
...
- dataset label text: `㝷`
- dataset label codepoints: `U+3777`
...
- filename catalog route clues: `Heji-like filename clue: 合27389
...
- Which source records identify obs-char-000793 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000793？
