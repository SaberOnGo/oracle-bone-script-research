# obs-char-001338 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001338`
- primary external id: `hust-obc-cat-1494`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1338_obs-char-001338_hust-obc-cat-1494_ora
  cle-character/03_visual-assets/001_asset-001343_hust-obc-cat-1494_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1494/G_1494_後2.22.16(甲).png`
- asset id: `asset-001343`
...
- source category: `1494`
- validation class: `1337`
- source image route: `HUST-OBC/deciphered/1494/G_1494_後2.22.16(甲).png`
- asset id: `asset-001343`
...
- English observation: `A small upright form has an upper forked enclosure,
  a narrow central stem, and paired lower strokes.`
- 中文观察: `小型直立形体有上部叉状框形、狭长中央笔干和成对下部笔画。`
...
- dataset label text: `㧌`
- dataset label codepoints: `U+39CC`
...
- Which source records identify obs-char-001338 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001338？
