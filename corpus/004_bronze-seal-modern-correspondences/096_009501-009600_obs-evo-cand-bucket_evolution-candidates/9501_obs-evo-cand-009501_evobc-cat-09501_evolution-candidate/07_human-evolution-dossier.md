...
- External category reference: `evobc-cat-09501`
- Source category ID: `09501`
- Source label for human review: `鏙`
- Source codepoints: `U+93D9`
...
- `obs-evo-cand-009501-route-category-staging`
...
- `obs-evo-cand-009501-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009501-route-evolution-graph`
