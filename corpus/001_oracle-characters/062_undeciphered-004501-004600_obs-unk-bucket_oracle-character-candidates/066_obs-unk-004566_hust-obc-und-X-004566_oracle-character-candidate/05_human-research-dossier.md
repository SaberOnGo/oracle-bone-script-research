# obs-unk-004566 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/066_obs-unk-004566_h
  ust-obc-und-X-004566_oracle-character-candidate/03_visual-assets/001_asset
  -006159_hust-obc-und-X-004566_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/122/X_？_8302_1.png`
- asset id: `asset-006159`
...
- source class: `HUST-OBC/undeciphered/X/122/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/122/X_？_8302_1.png`
- asset id: `asset-006159`
...
- English observation: `Upper arch, middle band, and lower point recorded.`
- 中文观察: `已记录上部拱形、中部横带和下部尖点。`
...
- Which source records identify obs-unk-004566 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004566？
