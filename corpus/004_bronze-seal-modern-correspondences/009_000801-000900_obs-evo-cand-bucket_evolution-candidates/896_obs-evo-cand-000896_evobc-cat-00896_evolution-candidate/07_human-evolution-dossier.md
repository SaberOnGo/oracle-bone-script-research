...
- External category reference: `evobc-cat-00896`
- Source category ID: `00896`
- Source label for human review: `俟`
...
- `obs-evo-cand-000896-route-category-staging`
...
- `obs-evo-cand-000896-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000896-route-evolution-graph`
