...
Project ID: `obs-insc-cw-cand-000225`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000225`
...
- Source page section: `Period I Group 18` /
  `第 I 期第 18 组`
- Source section key: `period-i-group-18`
...
- Yingguo / 英国所藏: `y1313` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `274` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `554` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000225`
