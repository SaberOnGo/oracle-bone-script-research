# Material Visual Observation / obs-comp-cand-002732 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002732`
- External reference / 外部参照: `obimd-sub-i2gqabmuv4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021348_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/i2gqabmuv4/i2gqabmuv4/i2gqabmuv4.png`
- Checksum / 校验和:
  `c051b14a60031dd7161637905ad9f39440bb88425b985eb2786186010de03ffd`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.50%.
- Marked-pixel bounds: (78,12)–(172,241); span 95 × 230 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.50%。
- 痕迹范围：(78,12)–(172,241)；跨度95 × 230 px；痕迹矩形高于宽。
