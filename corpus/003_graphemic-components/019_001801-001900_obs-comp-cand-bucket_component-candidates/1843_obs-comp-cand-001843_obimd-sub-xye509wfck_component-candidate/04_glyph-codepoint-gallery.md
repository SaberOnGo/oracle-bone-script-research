# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001843
...
| --- | --- | --- | --- |
| `obimd-glyph-link-027955` | 󺢟 | `U+FA89F` | `reviewed_metadata_only` |
| `obimd-glyph-link-027956` | 󺢠 | `U+FA8A0` | `reviewed_metadata_only` |
