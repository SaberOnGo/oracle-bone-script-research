# Material Visual Observation / obs-comp-cand-000503 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000503`
- External reference / 外部参照: `obimd-sub-0sioiz5ezt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012739_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/za6gsc8sdo/0sioiz5ezt/0sioiz5ezt.png`
- Checksum / 校验和:
  `cac2b0bc37f80d3c1156be41875dc6a3f5c9805bee12d2146ef556dbde76ed47`
...
- Marked-pixel bounds: (75,29)–(174,222); span 100 × 194 px; the marked
...
- 痕迹范围：(75,29)–(174,222)；跨度100 × 194 px；痕迹矩形高于宽。
