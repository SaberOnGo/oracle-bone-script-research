...
- External category reference: `evobc-cat-04771`
- Source category ID: `04771`
- Source label for human review: `渾`
...
- `obs-evo-cand-004771-route-category-staging`
...
- `obs-evo-cand-004771-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004771-route-evolution-graph`
