# obs-char-000954 Visual Gallery / obs-char-000954 图像资料页
...
- Project ID / 项目 ID: `obs-char-000954`
- Primary external reference / 首选外部参考: `hust-obc-cat-1073`
...
## obs-char-000954-visual-source-001 / 图像条目

![obs-char-000954 glyph candidate](03_visual-assets/001_asset-000959_hust-obc-cat-1073_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000959_hust-obc-cat-1073_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000959_hust-obc-cat-1073_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/1073/G_1073_甲844(甲).png`
