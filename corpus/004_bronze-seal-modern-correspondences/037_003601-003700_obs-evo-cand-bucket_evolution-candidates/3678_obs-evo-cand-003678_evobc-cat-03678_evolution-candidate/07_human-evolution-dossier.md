...
- External category reference: `evobc-cat-03678`
- Source category ID: `03678`
- Source label for human review: `旞`
...
- `obs-evo-cand-003678-route-category-staging`
...
- `obs-evo-cand-003678-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003678-route-evolution-graph`
