# obs-char-001116 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001116`
- primary external id: `hust-obc-cat-1247`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1116_obs-char-001116_hust-obc-cat-1247_ora
  cle-character/03_visual-assets/001_asset-001121_hust-obc-cat-1247_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1247/G_1247_乙4502(甲).png`
- asset id: `asset-001121`
...
- source category: `1247`
- validation class: `1115`
- source image route: `HUST-OBC/deciphered/1247/G_1247_乙4502(甲).png`
- asset id: `asset-001121`
...
- English observation: `A compact upper triangular cluster contains crossed
  strokes and continues into a pointed lower branching form.`
- 中文观察: `紧密上部三角形笔群包含交叉笔，并向下延为尖状分枝形体。`
...
- dataset label text: `㣕`
- dataset label codepoints: `U+38D5`
...
- Which source records identify obs-char-001116 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001116？
