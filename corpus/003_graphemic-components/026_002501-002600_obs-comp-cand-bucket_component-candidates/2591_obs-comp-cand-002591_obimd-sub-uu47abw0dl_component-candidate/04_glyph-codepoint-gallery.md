# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002591
...
| --- | --- | --- | --- |
| `obimd-glyph-link-039500` | 󾫧 | `U+FEAE7` | `reviewed_metadata_only` |
| `obimd-glyph-link-039501` | 󾫨 | `U+FEAE8` | `reviewed_metadata_only` |
| `obimd-glyph-link-039502` | 󾫩 | `U+FEAE9` | `reviewed_metadata_only` |
