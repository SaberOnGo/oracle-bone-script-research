...
- `obs-evo-cand-012140-route-category-staging`
...
- `obs-evo-cand-012140-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012140-route-evolution-graph`
