# Material Visual Observation / obs-comp-cand-001434 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001434`
- External reference / 外部参照: `obimd-sub-oeui2r7lqj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016011_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/oeui2r7lqj/oeui2r7lqj/oeui2r7lqj.png`
- Checksum / 校验和:
  `83edacf1ddf638aeca6a755bf7b3f6ea5431a8d06b7d5821965dd2f3031f33bf`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.11%.
- Marked-pixel bounds: (28,39)–(227,208); span 200 × 170 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.11%。
- 痕迹范围：(28,39)–(227,208)；跨度200 × 170 px；痕迹矩形近方形。
