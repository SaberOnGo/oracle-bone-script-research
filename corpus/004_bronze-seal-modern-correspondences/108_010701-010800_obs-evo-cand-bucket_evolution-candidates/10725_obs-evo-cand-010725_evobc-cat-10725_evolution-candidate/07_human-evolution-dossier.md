...
- External category reference: `evobc-cat-10725`
- Source category ID: `10725`
- Source label for human review: `齡`
...
- `obs-evo-cand-010725-route-category-staging`
...
- `obs-evo-cand-010725-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010725-route-evolution-graph`
