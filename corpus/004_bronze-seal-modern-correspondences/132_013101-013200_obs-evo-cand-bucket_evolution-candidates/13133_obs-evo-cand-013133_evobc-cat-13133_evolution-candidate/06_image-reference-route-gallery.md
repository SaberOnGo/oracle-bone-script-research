...
- `obs-evo-cand-013133-route-category-staging`
...
- `obs-evo-cand-013133-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013133-route-evolution-graph`
