# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010745
...
- EVOBC candidate category: `evobc-evo-cat-10745`.
- Source label for search only: `龍`.
- Source codepoints for search only: `U+9F8D`.
