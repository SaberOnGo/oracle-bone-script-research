...
Project ID: `obs-evo-cand-010548`
...
- Project ID: `obs-evo-cand-010548`
- EVOBC category candidate ID: `evobc-evo-cat-10548`
- External category reference: `evobc-cat-10548`
- Source category ID: `10548`
- Source label for human review: `鷊`
- Source codepoints: `U+9DCA`
...
- `obs-evo-cand-010548-route-category-staging`
...
- `obs-evo-cand-010548-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010548-route-evolution-graph`
