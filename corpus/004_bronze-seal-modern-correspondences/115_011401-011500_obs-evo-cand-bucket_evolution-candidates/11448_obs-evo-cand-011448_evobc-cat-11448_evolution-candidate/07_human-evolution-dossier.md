...
- Project ID: `obs-evo-cand-011448`
- EVOBC category candidate ID: `evobc-evo-cat-11448`
- External category reference: `evobc-cat-11448`
- Source category ID: `11448`
- Source label for human review: `𣙓`
- Source codepoints: `U+23653`
...
- `obs-evo-cand-011448-route-category-staging`
...
- `obs-evo-cand-011448-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011448-route-evolution-graph`
