# obs-unk-004711 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/011_obs-unk-004711_h
  ust-obc-und-X-004711_oracle-character-candidate/03_visual-assets/001_asset
  -006304_hust-obc-und-X-004711_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/267/X_？_7241_1.png`
- asset id: `asset-006304`
...
- source class: `HUST-OBC/undeciphered/X/267/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/267/X_？_7241_1.png`
- asset id: `asset-006304`
...
- English observation: `central irregular stroke with detached fragments`
- 中文观察: `带周围分离残片的中央不规则笔画`
...
- Which source records identify obs-unk-004711 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004711？
