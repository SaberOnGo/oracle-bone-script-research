# obs-unk-008199 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008199`
- primary external id: `hust-obc-und-YH-008199`
...
- local review image route: `corpus/001_oracle-characters/098_undeciphered-008
  101-008200_obs-unk-bucket_oracle-character-candidates/099_obs-unk-008199_h
  ust-obc-und-YH-008199_oracle-character-candidate/03_visual-assets/001_asse
  t-009790_hust-obc-und-YH-008199_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/608AB/Y_？_608AB.jpg`
- asset id: `asset-009790`
...
- source class: `HUST-OBC/undeciphered/Y+H/608AB/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/608AB/Y_？_608AB.jpg`
- asset id: `asset-009790`
...
- Which source records identify obs-unk-008199 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008199？
