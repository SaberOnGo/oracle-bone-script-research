# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002350
...
- EVOBC candidate category: `evobc-evo-cat-02350`.
- Source label for search only: `孺`.
- Source codepoints for search only: `U+5B7A`.
