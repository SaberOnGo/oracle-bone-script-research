...
- Yingguo / 英国所藏: `y2034` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `256` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `125` in source row; primary catalog entry pending
