# Material Visual Observation / obs-comp-cand-002065 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002065`
- External reference / 外部参照: `obimd-sub-2g4s7ymmp2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019452_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/nclwec7ns3/2g4s7ymmp2/2g4s7ymmp2.png`
- Checksum / 校验和:
  `9b9d6e47bc58cd2d0e49f56237498673926152c992fde01feb265e3af8c93845`
...
- Marked-pixel bounds: (75,20)–(193,229); span 119 × 210 px; the marked
...
- 痕迹范围：(75,20)–(193,229)；跨度119 × 210 px；痕迹矩形高于宽。
