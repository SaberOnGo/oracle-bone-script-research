# Material Visual Observation / obs-comp-cand-002586 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002586`
- External reference / 外部参照: `obimd-sub-y3taw4yt70`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021125_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/y3taw4yt70/y3taw4yt70/y3taw4yt70.png`
- Checksum / 校验和:
  `17063d4c591b16ba56e56ce7d128b85259210fa39e8126b9d555126cb87565f0`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.00%.
- Marked-pixel bounds: (79,29)–(169,223); span 91 × 195 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.00%。
- 痕迹范围：(79,29)–(169,223)；跨度91 × 195 px；痕迹矩形高于宽。
