...
- Yingguo / 英国所藏: `y1933` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `426` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `7` in source row; primary catalog entry pending
- Heji / 合集: `40939` in source row; primary catalog entry pending
