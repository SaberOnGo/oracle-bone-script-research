...
- External category reference: `evobc-cat-00540`
- Source category ID: `00540`
- Source label for human review: `䩦`
- Source codepoints: `U+4A66`
...
- `obs-evo-cand-000540-route-category-staging`
...
- `obs-evo-cand-000540-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000540-route-evolution-graph`
