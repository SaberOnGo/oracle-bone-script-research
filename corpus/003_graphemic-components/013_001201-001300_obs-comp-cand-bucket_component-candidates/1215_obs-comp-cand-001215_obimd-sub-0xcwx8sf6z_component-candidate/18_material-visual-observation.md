# Material Visual Observation / obs-comp-cand-001215 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001215`
- External reference / 外部参照: `obimd-sub-0xcwx8sf6z`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015446_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0xcwx8sf6z/0xcwx8sf6z/0xcwx8sf6z.png`
- Checksum / 校验和:
  `2939dd5cb6d86b400eacf2227a98a5c8f40542446a31e1c469a9e313ad57c052`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.12%.
- Marked-pixel bounds: (61,50)–(188,200); span 128 × 151 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.12%。
- 痕迹范围：(61,50)–(188,200)；跨度128 × 151 px；痕迹矩形近方形。
