...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1224`
...
- Source image / 来源图: `H_1224_612DD_0.png`
- Image / 图像: `001_asset-001100_hust-obc-cat-1224_glyph.png`
...
- target node: `evobc-evo-cat-00104`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00104`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00104`
...
- Matched candidate folders / 匹配候选目录: `evobc-evo-cat-00104`
- Human review files / 人类复核文件:
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/104_obs-evo-cand-000104_evobc-cat-00104_evoluti
...
- Source label text / 来源标签文字: `㢾`
- Source label codepoint / 来源标签 codepoint: `U+38BE`
