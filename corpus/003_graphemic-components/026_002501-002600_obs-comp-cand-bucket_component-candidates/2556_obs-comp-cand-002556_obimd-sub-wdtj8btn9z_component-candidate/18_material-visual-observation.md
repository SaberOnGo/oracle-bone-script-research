# Material Visual Observation / obs-comp-cand-002556 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002556`
- External reference / 外部参照: `obimd-sub-wdtj8btn9z`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021088_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wdtj8btn9z/wdtj8btn9z/wdtj8btn9z.png`
- Checksum / 校验和:
  `cebb2945b40fa2b47abe035a93d7a988650c08171eb5f8d08b8693cb0a2a43e6`
...
- Marked-pixel bounds: (83,30)–(166,224); span 84 × 195 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.88%。
- 痕迹范围：(83,30)–(166,224)；跨度84 × 195 px；痕迹矩形高于宽。
