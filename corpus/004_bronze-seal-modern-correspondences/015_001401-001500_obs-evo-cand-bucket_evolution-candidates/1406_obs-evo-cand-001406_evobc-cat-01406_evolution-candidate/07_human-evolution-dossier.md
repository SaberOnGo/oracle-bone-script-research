...
Project ID: `obs-evo-cand-001406`
...
- Project ID: `obs-evo-cand-001406`
- EVOBC category candidate ID: `evobc-evo-cat-01406`
- External category reference: `evobc-cat-01406`
- Source category ID: `01406`
- Source label for human review: `卹`
- Source codepoints: `U+5379`
...
- `obs-evo-cand-001406-route-category-staging`
...
- `obs-evo-cand-001406-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001406-route-evolution-graph`
