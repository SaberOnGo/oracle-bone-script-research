...
- External category reference: `evobc-cat-09200`
- Source category ID: `09200`
- Source label for human review: `鄟`
...
- `obs-evo-cand-009200-route-category-staging`
...
- `obs-evo-cand-009200-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009200-route-evolution-graph`
