...
Project ID: `obs-evo-cand-008116`
...
- Project ID: `obs-evo-cand-008116`
- EVOBC category candidate ID: `evobc-evo-cat-08116`
- External category reference: `evobc-cat-08116`
- Source category ID: `08116`
- Source label for human review: `觷`
- Source codepoints: `U+89F7`
...
- `obs-evo-cand-008116-route-category-staging`
...
- `obs-evo-cand-008116-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008116-route-evolution-graph`
