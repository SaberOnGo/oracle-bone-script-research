...
Project ID: `obs-evo-cand-012895`
...
- Project ID: `obs-evo-cand-012895`
- EVOBC category candidate ID: `evobc-evo-cat-12895`
- External category reference: `evobc-cat-12895`
- Source category ID: `12895`
- Source label for human review: `𪽤`
- Source codepoints: `U+2AF64`
...
- `obs-evo-cand-012895-route-category-staging`
...
- `obs-evo-cand-012895-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012895-route-evolution-graph`
