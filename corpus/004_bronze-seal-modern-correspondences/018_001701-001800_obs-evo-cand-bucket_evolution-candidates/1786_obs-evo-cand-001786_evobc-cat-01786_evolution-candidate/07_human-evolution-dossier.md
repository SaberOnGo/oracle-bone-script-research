...
- External category reference: `evobc-cat-01786`
- Source category ID: `01786`
- Source label for human review: `圛`
- Source codepoints: `U+571B`
...
- `obs-evo-cand-001786-route-category-staging`
...
- `obs-evo-cand-001786-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001786-route-evolution-graph`
