...
- External category reference: `evobc-cat-11011`
- Source category ID: `11011`
- Source label for human review: `𡔻`
...
- `obs-evo-cand-011011-route-category-staging`
...
- `obs-evo-cand-011011-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011011-route-evolution-graph`
