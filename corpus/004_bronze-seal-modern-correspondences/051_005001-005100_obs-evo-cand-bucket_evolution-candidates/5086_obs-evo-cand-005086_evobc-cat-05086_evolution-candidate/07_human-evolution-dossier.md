...
- External category reference: `evobc-cat-05086`
- Source category ID: `05086`
- Source label for human review: `焕`
...
- `obs-evo-cand-005086-route-category-staging`
...
- `obs-evo-cand-005086-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005086-route-evolution-graph`
