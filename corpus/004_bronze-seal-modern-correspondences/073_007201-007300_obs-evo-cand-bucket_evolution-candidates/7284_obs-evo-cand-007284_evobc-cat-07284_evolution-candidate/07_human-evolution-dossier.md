...
- External category reference: `evobc-cat-07284`
- Source category ID: `07284`
- Source label for human review: `苢`
- Source codepoints: `U+82E2`
...
- `obs-evo-cand-007284-route-category-staging`
...
- `obs-evo-cand-007284-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007284-route-evolution-graph`
