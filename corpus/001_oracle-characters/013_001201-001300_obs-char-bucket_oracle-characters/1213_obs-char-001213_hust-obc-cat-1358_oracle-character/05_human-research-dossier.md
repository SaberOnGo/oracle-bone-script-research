# obs-char-001213 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001213`
- primary external id: `hust-obc-cat-1358`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1213_obs-char-001213_hust-obc-cat-1358_ora
  cle-character/03_visual-assets/001_asset-001218_hust-obc-cat-1358_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1358/G_1358_乙8502(甲).png`
- asset id: `asset-001218`
...
- source category: `1358`
- validation class: `1212`
- source image route: `HUST-OBC/deciphered/1358/G_1358_乙8502(甲).png`
- asset id: `asset-001218`
...
- English observation: `A narrow upright form has an upper horizontal, two
  short uprights, a central loop, and a long lower taper.`
...
- dataset label text: `㥄`
- dataset label codepoints: `U+3944`
...
- Which source records identify obs-char-001213 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001213？
