# Material Visual Observation / obs-comp-cand-002012 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002012`
- External reference / 外部参照: `obimd-sub-gs24si06qj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019339_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gs24si06qj/gs24si06qj/gs24si06qj.png`
- Checksum / 校验和:
  `8f548bd79f8f5b3e78837950baa0d8265268a38b8c2d191412e020752654ddad`
...
- Marked-pixel bounds: (87,31)–(162,218); span 76 × 188 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.51%。
- 痕迹范围：(87,31)–(162,218)；跨度76 × 188 px；痕迹矩形高于宽。
