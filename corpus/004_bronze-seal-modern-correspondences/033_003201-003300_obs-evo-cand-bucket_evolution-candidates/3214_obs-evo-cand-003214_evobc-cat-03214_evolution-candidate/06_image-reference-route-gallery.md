...
- `obs-evo-cand-003214-route-category-staging`
...
- `obs-evo-cand-003214-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003214-route-evolution-graph`
