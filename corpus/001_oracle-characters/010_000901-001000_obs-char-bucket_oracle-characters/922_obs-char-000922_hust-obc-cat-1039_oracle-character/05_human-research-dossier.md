# obs-char-000922 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000922`
- primary external id: `hust-obc-cat-1039`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/922_obs-char-000922_hust-obc-cat-1039_orac
  le-character/03_visual-assets/001_asset-000927_hust-obc-cat-1039_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1039/G_1039_乙1009合21926子組.png`
- asset id: `asset-000927`
...
- source category: `1039`
- validation class: `921`
- source image route: `HUST-OBC/deciphered/1039/G_1039_乙1009合21926子組.png`
- asset id: `asset-000927`
...
- English observation: `A pointed upper stroke sits above a rectangular
  central enclosure with a short right projection and two descending lower
  strokes.`
...
- dataset label text: `㠅`
- dataset label codepoints: `U+3805`
...
- filename catalog route clues: `Heji-like filename clue: 合21926
...
- Which source records identify obs-char-000922 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000922？
