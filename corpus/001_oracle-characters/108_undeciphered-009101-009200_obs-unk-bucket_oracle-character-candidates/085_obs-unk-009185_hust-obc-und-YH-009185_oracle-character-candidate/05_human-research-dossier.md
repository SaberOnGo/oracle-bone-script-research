# obs-unk-009185 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-009185`
- primary external id: `hust-obc-und-YH-009185`
...
- local review image route: `corpus/001_oracle-characters/108_undeciphered-009
  101-009200_obs-unk-bucket_oracle-character-candidates/085_obs-unk-009185_h
  ust-obc-und-YH-009185_oracle-character-candidate/03_visual-assets/001_asse
  t-010776_hust-obc-und-YH-009185_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/612FA/H_？_612FA_0.png`
- asset id: `asset-010776`
...
- source class: `HUST-OBC/undeciphered/Y+H/612FA/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/612FA/H_？_612FA_0.png`
- asset id: `asset-010776`
...
- Which source records identify obs-unk-009185 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009185？
