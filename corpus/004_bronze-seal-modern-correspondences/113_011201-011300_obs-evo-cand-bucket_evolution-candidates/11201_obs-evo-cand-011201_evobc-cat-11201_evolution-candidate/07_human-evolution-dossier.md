...
- External category reference: `evobc-cat-11201`
- Source category ID: `11201`
- Source label for human review: `𢓟`
- Source codepoints: `U+224DF`
...
- `obs-evo-cand-011201-route-category-staging`
...
- `obs-evo-cand-011201-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011201-route-evolution-graph`
