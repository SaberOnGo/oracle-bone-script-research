...
- Yingguo / 英国所藏: `y1757` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `13` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `523` in source row; primary catalog entry pending
- Heji / 合集: `39554` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000262`
