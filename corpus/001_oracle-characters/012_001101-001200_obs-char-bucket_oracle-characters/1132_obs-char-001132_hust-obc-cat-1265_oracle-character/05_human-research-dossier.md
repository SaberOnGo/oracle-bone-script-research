# obs-char-001132 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1132_obs-char-001132_hust-obc-cat-1265_ora
  cle-character/03_visual-assets/001_asset-001137_hust-obc-cat-1265_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1265/G_1265_合37439黃組.png`
- asset id: `asset-001137`
...
- source category: `1265`
- validation class: `1131`
- source image route: `HUST-OBC/deciphered/1265/G_1265_合37439黃組.png`
- asset id: `asset-001137`
...
- English observation: `A narrow diagonal cluster has repeated short
  crossings and a dotted pointed lower continuation.`
- 中文观察: `狭长斜向笔群有重复的短交叉和带点状笔迹的尖状下部延伸。`
...
- dataset label text: `㣧`
- dataset label codepoints: `U+38E7`
...
- filename catalog route clues: `Heji-like filename clue: 合37439
  (G_1265_合37439黃組.png)`
...
- Which source records identify obs-char-001132 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001132？
