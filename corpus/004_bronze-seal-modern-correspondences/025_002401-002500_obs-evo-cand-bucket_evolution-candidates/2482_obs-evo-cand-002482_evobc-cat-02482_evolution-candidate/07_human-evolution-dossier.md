...
Project ID: `obs-evo-cand-002482`
...
- Project ID: `obs-evo-cand-002482`
- EVOBC category candidate ID: `evobc-evo-cat-02482`
- External category reference: `evobc-cat-02482`
- Source category ID: `02482`
- Source label for human review: `尨`
- Source codepoints: `U+5C28`
...
- `obs-evo-cand-002482-route-category-staging`
...
- `obs-evo-cand-002482-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002482-route-evolution-graph`
