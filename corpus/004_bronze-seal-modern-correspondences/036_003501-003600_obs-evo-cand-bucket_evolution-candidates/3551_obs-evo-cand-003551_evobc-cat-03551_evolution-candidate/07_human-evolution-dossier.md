...
- External category reference: `evobc-cat-03551`
- Source category ID: `03551`
- Source label for human review: `攩`
...
- `obs-evo-cand-003551-route-category-staging`
...
- `obs-evo-cand-003551-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003551-route-evolution-graph`
