...
- External category reference: `evobc-cat-05501`
- Source category ID: `05501`
- Source label for human review: `瓛`
- Source codepoints: `U+74DB`
...
- `obs-evo-cand-005501-route-category-staging`
...
- `obs-evo-cand-005501-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005501-route-evolution-graph`
