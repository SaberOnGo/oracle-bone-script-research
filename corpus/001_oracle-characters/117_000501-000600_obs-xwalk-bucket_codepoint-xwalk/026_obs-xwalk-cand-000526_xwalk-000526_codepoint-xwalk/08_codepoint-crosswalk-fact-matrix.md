# obs-xwalk-cand-000526 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+364E` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-0600` | not reading |
