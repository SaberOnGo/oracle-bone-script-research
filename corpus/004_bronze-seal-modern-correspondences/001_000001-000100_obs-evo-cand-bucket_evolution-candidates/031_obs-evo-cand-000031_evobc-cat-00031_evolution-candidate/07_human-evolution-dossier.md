...
- External category reference: `evobc-cat-00031`
- Source category ID: `00031`
- Source label for human review: `㕯`
...
- `obs-evo-cand-000031-route-category-staging`
...
- `obs-evo-cand-000031-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000031-route-evolution-graph`
