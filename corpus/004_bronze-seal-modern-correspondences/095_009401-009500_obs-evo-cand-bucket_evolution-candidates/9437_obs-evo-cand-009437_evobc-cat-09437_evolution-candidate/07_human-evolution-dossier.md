...
- External category reference: `evobc-cat-09437`
- Source category ID: `09437`
- Source label: `錠`
...
- `obs-evo-cand-009437-route-category-staging`
...
- `obs-evo-cand-009437-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-009437-route-evolution-graph`
