...
- Project ID / 项目 ID: `obs-char-001554`
- Primary external ID / 首选外部 ID: `hust-obc-cat-1745`
...
- Source image / 来源图: `G_1745_前5.24.3合16981賓組.png`
- Image / 图像: `001_asset-001559_hust-obc-cat-1745_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合16981
  (G_1745_前5.24.3合16981賓組.png)`
...
- Source label text / 来源标签文字: `㫇`
- Source label codepoint / 来源标签 codepoint: `U+3AC7`
