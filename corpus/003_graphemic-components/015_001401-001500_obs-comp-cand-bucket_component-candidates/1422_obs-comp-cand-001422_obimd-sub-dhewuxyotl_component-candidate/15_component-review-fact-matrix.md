# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001422
...
| Glyph or codepoint route / 字形或码位路线 | 151 OBIMD route rows; examples U+8C9E;U+F8263; U+F8264; 另有 149 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 151 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
