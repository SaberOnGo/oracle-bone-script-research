...
- Yingguo / 英国所藏: `y594` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `71` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `651` in source row; primary catalog entry pending
- Heji / 合集: `39492` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000105`
