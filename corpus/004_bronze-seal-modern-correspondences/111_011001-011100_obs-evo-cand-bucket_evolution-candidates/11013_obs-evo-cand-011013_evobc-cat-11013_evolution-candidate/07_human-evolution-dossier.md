...
- External category reference: `evobc-cat-11013`
- Source category ID: `11013`
- Source label: `𡕚`
...
- `obs-evo-cand-011013-route-category-staging`
...
- `obs-evo-cand-011013-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-011013-route-evolution-graph`
