...
- `obs-evo-cand-006584-route-category-staging`
...
- `obs-evo-cand-006584-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006584-route-evolution-graph`
