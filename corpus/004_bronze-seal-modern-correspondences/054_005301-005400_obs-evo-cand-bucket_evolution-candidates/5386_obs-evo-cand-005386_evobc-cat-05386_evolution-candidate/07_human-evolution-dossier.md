...
- External category reference: `evobc-cat-05386`
- Source category ID: `05386`
- Source label for human review: `珤`
- Source codepoints: `U+73E4`
...
- `obs-evo-cand-005386-route-category-staging`
...
- `obs-evo-cand-005386-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005386-route-evolution-graph`
