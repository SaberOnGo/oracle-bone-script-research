...
- External category reference: `evobc-cat-06177`
- Source category ID: `06177`
- Source label for human review: `窮`
...
- `obs-evo-cand-006177-route-category-staging`
...
- `obs-evo-cand-006177-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006177-route-evolution-graph`
