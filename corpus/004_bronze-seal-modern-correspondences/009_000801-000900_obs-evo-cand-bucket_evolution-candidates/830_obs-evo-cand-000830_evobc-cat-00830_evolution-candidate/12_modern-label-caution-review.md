# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000830
...
- EVOBC candidate category: `evobc-evo-cat-00830`.
- Source label for search only: `使`.
- Source codepoints for search only: `U+4F7F`.
