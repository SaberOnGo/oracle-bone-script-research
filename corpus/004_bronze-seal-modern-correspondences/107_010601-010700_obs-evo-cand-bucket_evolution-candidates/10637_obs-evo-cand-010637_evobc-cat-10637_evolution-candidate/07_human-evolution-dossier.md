...
- External category reference: `evobc-cat-10637`
- Source category ID: `10637`
- Source label for human review: `黊`
...
- `obs-evo-cand-010637-route-category-staging`
...
- `obs-evo-cand-010637-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010637-route-evolution-graph`
