# obs-unk-007809 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/095_undeciphered-007
  801-007900_obs-unk-bucket_oracle-character-candidates/009_obs-unk-007809_h
  ust-obc-und-YH-007809_oracle-character-candidate/03_visual-assets/001_asse
  t-009400_hust-obc-und-YH-007809_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/603AE/Y_？_603AE.jpg`
- asset id: `asset-009400`
...
- source class: `HUST-OBC/undeciphered/Y+H/603AE/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/603AE/Y_？_603AE.jpg`
- asset id: `asset-009400`
...
- Which source records identify obs-unk-007809 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007809？
