# Collection Provenance Evidence Dossier / 馆藏来源证据档案: coll-obj-cand-00011
...
The page displays the `《丙》0086` and `《丙》0087（背面）` lines recorded in
`18_live-source-evidence-review.md`. They remain source-reported text.
