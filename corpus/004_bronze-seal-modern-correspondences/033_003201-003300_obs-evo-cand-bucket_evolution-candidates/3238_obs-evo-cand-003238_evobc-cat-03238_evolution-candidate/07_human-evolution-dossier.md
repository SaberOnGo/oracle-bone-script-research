...
- External category reference: `evobc-cat-03238`
- Source category ID: `03238`
- Source label for human review: `扃`
...
- `obs-evo-cand-003238-route-category-staging`
...
- `obs-evo-cand-003238-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003238-route-evolution-graph`
