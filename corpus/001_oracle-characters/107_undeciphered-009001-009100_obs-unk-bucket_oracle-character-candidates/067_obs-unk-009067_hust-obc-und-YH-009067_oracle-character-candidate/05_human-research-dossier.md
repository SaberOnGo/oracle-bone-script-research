# obs-unk-009067 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-009067`
- primary external id: `hust-obc-und-YH-009067`
...
- local review image route: `corpus/001_oracle-characters/107_undeciphered-009
  001-009100_obs-unk-bucket_oracle-character-candidates/067_obs-unk-009067_h
  ust-obc-und-YH-009067_oracle-character-candidate/03_visual-assets/001_asse
  t-010658_hust-obc-und-YH-009067_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6116B/Y_？_6116B.jpg`
- asset id: `asset-010658`
...
- source class: `HUST-OBC/undeciphered/Y+H/6116B/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6116B/Y_？_6116B.jpg`
- asset id: `asset-010658`
...
- Which source records identify obs-unk-009067 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009067？
