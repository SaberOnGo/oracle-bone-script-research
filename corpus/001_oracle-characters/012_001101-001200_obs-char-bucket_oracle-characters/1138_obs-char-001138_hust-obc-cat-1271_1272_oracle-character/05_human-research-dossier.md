# obs-char-001138 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001138`
- primary external id: `hust-obc-cat-1271_1272`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1138_obs-char-001138_hust-obc-cat-1271_127
  2_oracle-character/03_visual-assets/001_asset-001143_hust-obc-cat-1271_127
  2_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1271_1272/1271/G_1271_後2.20.14合
  17938賓組.png`
- asset id: `asset-001143`
...
- source category: `1271_1272`
- validation class: `1137`
- source image route: `HUST-OBC/deciphered/1271_1272/1271/G_1271_後2.20.14合1793
  8賓組.png`
- asset id: `asset-001143`
...
- English observation: `Two adjacent branching forms are linked by a central
  crossing, with a short lower horizontal base.`
- 中文观察: `两个相邻分枝形体由中央交叉相连，下方有短水平底笔。`
...
- dataset label text: `㣭㣮`
- dataset label codepoints: `U+38ED;U+38EE`
...
- graph edge count: `2`
- codepoint routes: `U+38ED;U+38EE`
...
- filename catalog route clues: `Heji-like filename clue: 合17938
  (G_1271_後2.20.14合17938賓組.png)`
...
- Which source records identify obs-char-001138 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001138？
