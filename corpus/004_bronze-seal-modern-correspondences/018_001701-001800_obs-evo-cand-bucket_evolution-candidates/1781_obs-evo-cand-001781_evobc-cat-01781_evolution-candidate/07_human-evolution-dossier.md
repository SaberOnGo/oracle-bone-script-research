...
Project ID: `obs-evo-cand-001781`
...
- Project ID: `obs-evo-cand-001781`
- EVOBC category candidate ID: `evobc-evo-cat-01781`
- External category reference: `evobc-cat-01781`
- Source category ID: `01781`
- Source label for human review: `圍`
- Source codepoints: `U+570D`
- Image reference count in source metadata: `86`
...
- `obs-evo-cand-001781-route-category-staging`
...
- `obs-evo-cand-001781-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001781-route-evolution-graph`
