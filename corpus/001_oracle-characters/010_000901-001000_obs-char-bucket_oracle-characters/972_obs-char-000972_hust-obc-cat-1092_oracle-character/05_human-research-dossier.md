# obs-char-000972 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/972_obs-char-000972_hust-obc-cat-1092_orac
  le-character/03_visual-assets/001_asset-000977_hust-obc-cat-1092_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1092/G_1092_乙221合21468𠂤組.png`
- asset id: `asset-000977`
...
- source category: `1092`
- validation class: `971`
- source image route: `HUST-OBC/deciphered/1092/G_1092_乙221合21468𠂤組.png`
- asset id: `asset-000977`
...
- English observation: `A narrow oval-like enclosure contains an inner
  vertical stroke and ends in a pointed lower fork.`
- 中文观察: `狭长椭圆状闭合轮廓含内部竖笔，并以尖形下部叉笔收尾。`
...
- dataset label text: `㠺`
- dataset label codepoints: `U+383A`
...
- filename catalog route clues: `Heji-like filename clue: 合21468
  (G_1092_乙221合21468𠂤組.png)`
...
- Which source records identify obs-char-000972 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000972？
