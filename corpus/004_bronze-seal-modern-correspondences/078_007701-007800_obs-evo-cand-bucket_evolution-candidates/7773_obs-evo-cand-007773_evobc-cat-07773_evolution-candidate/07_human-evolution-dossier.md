...
- External category reference: `evobc-cat-07773`
- Source category ID: `07773`
- Source label for human review: `蜋`
- Source codepoints: `U+870B`
...
- `obs-evo-cand-007773-route-category-staging`
...
- `obs-evo-cand-007773-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007773-route-evolution-graph`
