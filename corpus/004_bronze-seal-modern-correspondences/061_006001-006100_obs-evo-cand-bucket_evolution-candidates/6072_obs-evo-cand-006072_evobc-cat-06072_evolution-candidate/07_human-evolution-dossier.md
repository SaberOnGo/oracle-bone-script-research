...
- External category reference: `evobc-cat-06072`
- Source category ID: `06072`
- Source label for human review: `秦`
...
- `obs-evo-cand-006072-route-category-staging`
...
- `obs-evo-cand-006072-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006072-route-evolution-graph`
