...
- External category reference: `evobc-cat-08668`
- Source category ID: `08668`
- Source label for human review: `赾`
- Source codepoints: `U+8D7E`
...
- `obs-evo-cand-008668-route-category-staging`
...
- `obs-evo-cand-008668-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008668-route-evolution-graph`
