...
- External category reference: `evobc-cat-12499`
- Source category ID: `12499`
- Source label for human review: `𨰍`
...
- `obs-evo-cand-012499-route-category-staging`
...
- `obs-evo-cand-012499-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012499-route-evolution-graph`
