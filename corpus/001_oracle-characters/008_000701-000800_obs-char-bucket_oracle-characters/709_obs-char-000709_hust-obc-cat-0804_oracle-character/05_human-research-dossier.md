# obs-char-000709 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000709`
- primary external id: `hust-obc-cat-0804`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/709_obs-char-000709_hust-obc-cat-0804_orac
  le-character/03_visual-assets/001_asset-000714_hust-obc-cat-0804_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0804/G_0804_合1022甲賓間.png`
- asset id: `asset-000714`
...
- source category: `0804`
- validation class: `708`
- source image route: `HUST-OBC/deciphered/0804/G_0804_合1022甲賓間.png`
- asset id: `asset-000714`
...
- English observation: `An L-shaped angular frame is divided into several
  small rectangular compartments, with a tall left column turning into a
  shorter horizontal row at the bottom.`
...
- dataset label text: `㜚`
- dataset label codepoints: `U+371A`
...
- filename catalog route clues: `Heji-like filename clue: 合1022
  (G_0804_合1022甲賓間.png)`
...
- Which source records identify obs-char-000709 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000709？
