...
- External category reference: `evobc-cat-08071`
- Source category ID: `08071`
- Source label for human review: `親`
- Source codepoints: `U+89AA`
- Image reference count in source metadata: `71`
...
- `obs-evo-cand-008071-route-category-staging`
...
- `obs-evo-cand-008071-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008071-route-evolution-graph`
