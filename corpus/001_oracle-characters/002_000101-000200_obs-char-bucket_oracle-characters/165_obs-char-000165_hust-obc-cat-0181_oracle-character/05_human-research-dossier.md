# obs-char-000165 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/165_obs-char-000165_hust-obc-cat-0181_orac
  le-character/03_visual-assets/001_asset-000170_hust-obc-cat-0181_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0181/L_0181_7055.jpg`
- asset id: `asset-000170`
...
- source category: `0181`
- validation class: `164`
- source image route: `HUST-OBC/deciphered/0181/L_0181_7055.jpg`
- asset id: `asset-000170`
...
- English observation: `The low-resolution gray image has a dense upper
  horizontal cluster and a thin curved stroke descending below it.`
- 中文观察: `低分辨率灰度图像上方有密集横向笔群，下方有细弯曲笔向下延伸。`
...
- dataset label text: `㒫`
- dataset label codepoints: `U+34AB`
...
- Which source records identify obs-char-000165 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000165？
