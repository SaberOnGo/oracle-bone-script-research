# obs-char-001582 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001582`
- primary external id: `hust-obc-cat-1774`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1582_obs-char-001582_hust-obc-cat-1774_ora
  cle-character/03_visual-assets/001_asset-001587_hust-obc-cat-1774_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1774/X_1774_2005_1.png`
- asset id: `asset-001587`
...
- source category: `1774`
- validation class: `1581`
- source image route: `HUST-OBC/deciphered/1774/X_1774_2005_1.png`
- asset id: `asset-001587`
...
- English observation: `A tall form has repeated crossbars, a central stem,
  and long branching lower strokes.`
- 中文观察: `高大形体有重复横笔、中央竖干和长下部分枝笔画。`
...
- dataset label text: `㫤`
- dataset label codepoints: `U+3AE4`
...
- Which source records identify obs-char-001582 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001582？
