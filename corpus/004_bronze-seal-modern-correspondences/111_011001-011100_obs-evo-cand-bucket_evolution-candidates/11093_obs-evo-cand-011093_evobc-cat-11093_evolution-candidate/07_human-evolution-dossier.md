...
- Project ID: `obs-evo-cand-011093`
- EVOBC category candidate ID: `evobc-evo-cat-11093`
- External category reference: `evobc-cat-11093`
- Source category ID: `11093`
- Source label for human review: `𡮢`
- Source codepoints: `U+21BA2`
...
- `obs-evo-cand-011093-route-category-staging`
...
- `obs-evo-cand-011093-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011093-route-evolution-graph`
