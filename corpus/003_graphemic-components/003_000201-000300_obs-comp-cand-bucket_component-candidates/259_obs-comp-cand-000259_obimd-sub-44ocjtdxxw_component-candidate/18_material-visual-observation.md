# Material Visual Observation / obs-comp-cand-000259 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000259`
- External reference / 外部参照: `obimd-sub-44ocjtdxxw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011905_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/44ocjtdxxw/44ocjtdxxw/44ocjtdxxw.png`
- Checksum / 校验和:
  `c6aef12e12f4adf1c1bed8c1519d34bb4e222a110ff2e6d9b57cafe7d01c2e36`
...
- Marked-pixel bounds: (73,34)–(176,215); span 104 × 182 px; the marked
...
- 痕迹范围：(73,34)–(176,215)；跨度104 × 182 px；痕迹矩形高于宽。
