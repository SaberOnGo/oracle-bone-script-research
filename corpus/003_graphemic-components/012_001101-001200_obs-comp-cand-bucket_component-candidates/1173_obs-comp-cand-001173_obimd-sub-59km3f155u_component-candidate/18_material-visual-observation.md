# Material Visual Observation / obs-comp-cand-001173 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001173`
- External reference / 外部参照: `obimd-sub-59km3f155u`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015363_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/59km3f155u/59km3f155u/59km3f155u.png`
- Checksum / 校验和:
  `8c6c9da5569e7b1a07ebdd330016e7b2a6cd305dece692c56b9a0604023fdabb`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.55%.
- Marked-pixel bounds: (52,49)–(207,203); span 156 × 155 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.55%。
- 痕迹范围：(52,49)–(207,203)；跨度156 × 155 px；痕迹矩形近方形。
