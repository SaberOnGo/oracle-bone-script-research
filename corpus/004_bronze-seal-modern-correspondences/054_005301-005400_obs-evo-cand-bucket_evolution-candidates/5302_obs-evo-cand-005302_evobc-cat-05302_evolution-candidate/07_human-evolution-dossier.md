...
- External category reference: `evobc-cat-05302`
- Source category ID: `05302`
- Source label for human review: `猫`
- Source codepoints: `U+732B`
...
- `obs-evo-cand-005302-route-category-staging`
...
- `obs-evo-cand-005302-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005302-route-evolution-graph`
