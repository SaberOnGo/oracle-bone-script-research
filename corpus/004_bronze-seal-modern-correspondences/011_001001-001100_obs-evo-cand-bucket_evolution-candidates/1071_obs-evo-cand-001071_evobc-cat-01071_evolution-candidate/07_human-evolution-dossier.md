...
Project ID: `obs-evo-cand-001071`
...
- Project ID: `obs-evo-cand-001071`
- EVOBC category candidate ID: `evobc-evo-cat-01071`
- External category reference: `evobc-cat-01071`
- Source category ID: `01071`
- Source label for human review: `兇`
- Source codepoints: `U+5147`
...
- `obs-evo-cand-001071-route-category-staging`
...
- `obs-evo-cand-001071-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001071-route-evolution-graph`
