...
- External category reference: `evobc-cat-00104`
- Source category ID: `00104`
- Source label for human review: `㢾`
...
- `obs-evo-cand-000104-route-category-staging`
...
- `obs-evo-cand-000104-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000104-route-evolution-graph`
