...
- External category reference: `evobc-cat-00526`
- Source category ID: `00526`
- Source label for human review: `䧔`
...
- `obs-evo-cand-000526-route-category-staging`
...
- `obs-evo-cand-000526-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000526-route-evolution-graph`
