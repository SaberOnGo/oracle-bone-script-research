...
- Capture ID / 观察记录 ID: browser-meta-000006
- Access record / 访问记录: browser-access-000006
- Captured at / 观察日期: 2026-07-27
- Page title / 页面标题: 凡例
- Object type / 对象类型: online_catalog_reference_database
- Museum number / 博物馆编号: not recorded
- Description / 描述: Official legend states the database is based on the 1999
  Heji source table and records Heji plate/material references, catalog and join
  fields, and original holdings abbreviations.
- Culture or period / 文化或时期: oracle bone inscription catalog
...
- Risk note / 风险提示: Official legend metadata was read in a browser after
  restricted-page attempts; no plate image, full inscription, row export, or
  bulk payload was saved.
