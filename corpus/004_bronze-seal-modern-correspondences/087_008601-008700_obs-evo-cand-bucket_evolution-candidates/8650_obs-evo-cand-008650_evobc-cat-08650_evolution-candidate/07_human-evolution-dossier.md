...
Project ID: `obs-evo-cand-008650`
...
- Project ID: `obs-evo-cand-008650`
- EVOBC category candidate ID: `evobc-evo-cat-08650`
- External category reference: `evobc-cat-08650`
- Source category ID: `08650`
- Source label for human review: `赠`
- Source codepoints: `U+8D60`
...
- `obs-evo-cand-008650-route-category-staging`
...
- `obs-evo-cand-008650-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008650-route-evolution-graph`
