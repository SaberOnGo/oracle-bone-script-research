...
- External category reference: `evobc-cat-05216`
- Source category ID: `05216`
- Source label for human review: `牴`
- Source codepoints: `U+7274`
...
- `obs-evo-cand-005216-route-category-staging`
...
- `obs-evo-cand-005216-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005216-route-evolution-graph`
