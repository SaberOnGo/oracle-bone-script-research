...
- External category reference: `evobc-cat-11967`
- Source category ID: `11967`
- Source label: `𦄑`
...
- `obs-evo-cand-011967-route-category-staging`
...
- `obs-evo-cand-011967-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-011967-route-evolution-graph`
