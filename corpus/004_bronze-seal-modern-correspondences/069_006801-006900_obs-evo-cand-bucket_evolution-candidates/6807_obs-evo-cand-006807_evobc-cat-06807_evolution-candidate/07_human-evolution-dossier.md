...
- External category reference: `evobc-cat-06807`
- Source category ID: `06807`
- Source label for human review: `罟`
...
- `obs-evo-cand-006807-route-category-staging`
...
- `obs-evo-cand-006807-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006807-route-evolution-graph`
