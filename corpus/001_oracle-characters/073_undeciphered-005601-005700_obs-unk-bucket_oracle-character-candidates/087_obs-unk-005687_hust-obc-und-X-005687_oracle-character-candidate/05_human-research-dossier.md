# obs-unk-005687 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005687`
- primary external id: `hust-obc-und-X-005687`
...
- local review image route: `corpus/001_oracle-characters/073_undeciphered-005
  601-005700_obs-unk-bucket_oracle-character-candidates/087_obs-unk-005687_h
  ust-obc-und-X-005687_oracle-character-candidate/03_visual-assets/001_asset
  -007280_hust-obc-und-X-005687_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1243/X_？_1151_1.png`
- asset id: `asset-007280`
...
- source class: `HUST-OBC/undeciphered/X/1243/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1243/X_？_1151_1.png`
- asset id: `asset-007280`
...
- Which source records identify obs-unk-005687 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005687？
