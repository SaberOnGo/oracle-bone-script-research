# obs-char-001047 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001047`
- primary external id: `hust-obc-cat-1174`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1047_obs-char-001047_hust-obc-cat-1174_ora
  cle-character/03_visual-assets/001_asset-001052_hust-obc-cat-1174_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1174/G_1174_佚166合27453無名組.png`
- asset id: `asset-001052`
...
- source category: `1174`
- validation class: `1046`
- source image route: `HUST-OBC/deciphered/1174/G_1174_佚166合27453無名組.png`
- asset id: `asset-001052`
...
- English observation: `A narrow vertical cluster has a small upper loop, a
  central angular crossing, and a long thin lower stroke.`
- 中文观察: `狭长竖向笔群有小型上部环笔、中央棱角交叉和长而纤细的下行笔。`
...
- dataset label text: `㢌`
- dataset label codepoints: `U+388C`
...
- filename catalog route clues: `Heji-like filename clue: 合27453
  (G_1174_佚166合27453無名組.png)`
...
- Which source records identify obs-char-001047 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001047？
