# Human Research Readiness Review / 人类研究准备度复核: coll-obj-cand-00004
...
| --- | --- | --- |
| Catalog source | `1215` | `02_collection-source-index.csv` |
| Visual evidence | `external_thumbnail_url_metadata_only` | `04_visual-gallery.md` |
| Live image evidence | `three private JPEG routes` | `18_live-source-evidence-review.md` |
...
- Which of the three private JPEG routes can be reused after rights review?
...
- 三条本地私有 JPEG 路线中，哪一条在权利复核后可以再利用？
