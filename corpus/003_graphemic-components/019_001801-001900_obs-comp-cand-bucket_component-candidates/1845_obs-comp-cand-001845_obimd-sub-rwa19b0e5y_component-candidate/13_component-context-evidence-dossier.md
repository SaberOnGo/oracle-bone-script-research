# obs-comp-cand-001845 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001845`
- 首选外部 ID: `obimd-sub-rwa19b0e5y`
- OBIMD subcharacter UID: `rwa19b0e5y`
- OBIMD main character UID: `0n73hvtfpr`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+B159A;U+FA622; U+FA8B6; 另有 1 项
