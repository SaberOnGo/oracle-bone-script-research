# obs-unk-004456 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004456`
- primary external id: `hust-obc-und-X-004456`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/056_obs-unk-004456_h
  ust-obc-und-X-004456_oracle-character-candidate/03_visual-assets/001_asset
  -006049_hust-obc-und-X-004456_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/12/X_？_8192_1.png`
- asset id: `asset-006049`
...
- source class: `HUST-OBC/undeciphered/X/12/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/12/X_？_8192_1.png`
- asset id: `asset-006049`
...
- English observation: `Several separated traces occupy upper and`
  `lower positions.`
- 中文观察: `多处分离痕迹分布在上部和下部位置。`
...
- Which source records identify obs-unk-004456 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004456？
