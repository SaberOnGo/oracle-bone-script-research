# Material Visual Observation / obs-comp-cand-000381 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000381`
- External reference / 外部参照: `obimd-sub-3p906vor19`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012304_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3p906vor19/3p906vor19/3p906vor19.png`
- Checksum / 校验和:
  `9e7c620dae133b539a48cbfef502a36d13e91a056f520b5215c1dcf62998fa8f`
...
- Marked-pixel bounds: (79,22)–(170,228); span 92 × 207 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.41%。
- 痕迹范围：(79,22)–(170,228)；跨度92 × 207 px；痕迹矩形高于宽。
