# obs-evo-cand-008485 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-08485`
- Source label for human review: `豖`
- Source codepoints: `U+8C56`
- Image reference count: `51`
- Era token counts: `BI:5;OBC:45;SS:1`
- Source token counts: `Book:15;Web:36`
