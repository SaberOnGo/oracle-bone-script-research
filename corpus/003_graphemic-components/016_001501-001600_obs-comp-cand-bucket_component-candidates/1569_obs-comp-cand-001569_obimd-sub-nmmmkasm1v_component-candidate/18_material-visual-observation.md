# Material Visual Observation / obs-comp-cand-001569 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001569`
- External reference / 外部参照: `obimd-sub-nmmmkasm1v`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017116_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/nmmmkasm1v/nmmmkasm1v/nmmmkasm1v.png`
- Checksum / 校验和:
  `e4d2c43c754f471fd429a8aa3ad1fd1726759c12cb5ea755b6a54fbc45ab142e`
...
- Marked-pixel bounds: (76,34)–(176,218); span 101 × 185 px; the marked
...
- 痕迹范围：(76,34)–(176,218)；跨度101 × 185 px；痕迹矩形高于宽。
