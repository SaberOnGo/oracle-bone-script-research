# obs-char-000143 Archaeology Paleography Review

# obs-char-000143 考古文字复核档案
...
- first local image: `001_asset-000148_hust-obc-cat-0158_glyph.png`
- first source image: `G_0158_後2.21.1(甲).png`
...
- source label text: `㒔`
- source label codepoints: `U+3494`
