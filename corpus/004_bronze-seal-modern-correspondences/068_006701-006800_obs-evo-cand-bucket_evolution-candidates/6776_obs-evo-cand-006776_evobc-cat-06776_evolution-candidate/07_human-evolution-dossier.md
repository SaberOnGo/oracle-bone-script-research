...
- External category reference: `evobc-cat-06776`
- Source category ID: `06776`
- Source label for human review: `缘`
- Source codepoints: `U+7F18`
...
- `obs-evo-cand-006776-route-category-staging`
...
- `obs-evo-cand-006776-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006776-route-evolution-graph`
