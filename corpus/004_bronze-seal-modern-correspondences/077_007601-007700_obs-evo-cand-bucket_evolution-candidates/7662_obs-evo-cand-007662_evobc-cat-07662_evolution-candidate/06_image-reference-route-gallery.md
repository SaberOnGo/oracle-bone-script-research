...
- `obs-evo-cand-007662-route-category-staging`
...
- `obs-evo-cand-007662-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007662-route-evolution-graph`
