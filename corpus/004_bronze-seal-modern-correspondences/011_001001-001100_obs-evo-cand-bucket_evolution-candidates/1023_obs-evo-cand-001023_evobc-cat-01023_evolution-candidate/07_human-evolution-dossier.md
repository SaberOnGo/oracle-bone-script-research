...
- External category reference: `evobc-cat-01023`
- Source category ID: `01023`
- Source label for human review: `僧`
- Source codepoints: `U+50E7`
...
- `obs-evo-cand-001023-route-category-staging`
...
- `obs-evo-cand-001023-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001023-route-evolution-graph`
