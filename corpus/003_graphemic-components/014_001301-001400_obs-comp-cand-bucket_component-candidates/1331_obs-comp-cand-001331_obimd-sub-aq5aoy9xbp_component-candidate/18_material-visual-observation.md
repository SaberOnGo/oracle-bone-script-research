# Material Visual Observation / obs-comp-cand-001331 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001331`
- External reference / 外部参照: `obimd-sub-aq5aoy9xbp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015668_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/aq5aoy9xbp/aq5aoy9xbp/aq5aoy9xbp.png`
- Checksum / 校验和:
  `1dbc9be7478a3debdfcfb0c6bbf3ec24ca2c945379a168c6f90ea2c95919f6f2`
...
- Marked-pixel bounds: (84,16)–(158,232); span 75 × 217 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.95%。
- 痕迹范围：(84,16)–(158,232)；跨度75 × 217 px；痕迹矩形高于宽。
