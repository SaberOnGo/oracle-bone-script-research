# obs-char-001526 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001526`
- primary external id: `hust-obc-cat-1712`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1526_obs-char-001526_hust-obc-cat-1712_ora
  cle-character/03_visual-assets/001_asset-001531_hust-obc-cat-1712_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1712/G_1712_存下343合10579賓組.png`
- asset id: `asset-001531`
...
- source category: `1712`
- validation class: `1525`
- source image route: `HUST-OBC/deciphered/1712/G_1712_存下343合10579賓組.png`
- asset id: `asset-001531`
...
- English observation: `A compact composite combines a lower bowl-like mark
  with a narrow upper body and side strokes.`
- 中文观察: `紧凑组合形体结合下部盆状标记、狭长上部主体和侧部笔画。`
...
- dataset label text: `㪦`
- dataset label codepoints: `U+3AA6`
...
- filename catalog route clues: `Heji-like filename clue: 合10579
  (G_1712_存下343合10579賓組.png)`
...
- Which source records identify obs-char-001526 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001526？
