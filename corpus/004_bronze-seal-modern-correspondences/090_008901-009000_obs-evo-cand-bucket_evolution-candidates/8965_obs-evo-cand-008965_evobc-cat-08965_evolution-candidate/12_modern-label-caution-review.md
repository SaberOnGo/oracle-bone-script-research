# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008965
...
- EVOBC candidate category: `evobc-evo-cat-08965`.
- Source label for search only: `迭`.
- Source codepoints for search only: `U+8FED`.
