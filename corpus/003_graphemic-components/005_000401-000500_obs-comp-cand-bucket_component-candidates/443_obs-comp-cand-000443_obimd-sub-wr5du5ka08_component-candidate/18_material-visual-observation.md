# Material Visual Observation / obs-comp-cand-000443 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000443`
- External reference / 外部参照: `obimd-sub-wr5du5ka08`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012366_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/nqghhf5br6/wr5du5ka08/wr5du5ka08.png`
- Checksum / 校验和:
  `8de5d9fa0738558b4fed747778553d2b7e98c161df1cd2e69387bcbc0fda4cd0`
...
- Marked-pixel bounds: (83,23)–(166,220); span 84 × 198 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.36%。
- 痕迹范围：(83,23)–(166,220)；跨度84 × 198 px；痕迹矩形高于宽。
