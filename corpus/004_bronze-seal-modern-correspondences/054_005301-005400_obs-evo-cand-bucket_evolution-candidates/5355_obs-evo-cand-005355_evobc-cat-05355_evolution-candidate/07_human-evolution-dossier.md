...
- External category reference: `evobc-cat-05355`
- Source category ID: `05355`
- Source label for human review: `玢`
- Source codepoints: `U+73A2`
...
- `obs-evo-cand-005355-route-category-staging`
...
- `obs-evo-cand-005355-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005355-route-evolution-graph`
