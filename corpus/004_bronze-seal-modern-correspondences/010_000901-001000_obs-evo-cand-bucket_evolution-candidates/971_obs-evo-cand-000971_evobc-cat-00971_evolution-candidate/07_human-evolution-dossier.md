...
- External category reference: `evobc-cat-00971`
- Source category ID: `00971`
- Source label for human review: `偶`
- Source codepoints: `U+5076`
...
- `obs-evo-cand-000971-route-category-staging`
...
- `obs-evo-cand-000971-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000971-route-evolution-graph`
