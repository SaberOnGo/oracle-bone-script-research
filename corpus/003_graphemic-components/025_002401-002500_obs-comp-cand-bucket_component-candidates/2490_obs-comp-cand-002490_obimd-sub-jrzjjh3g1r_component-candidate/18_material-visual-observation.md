# Material Visual Observation / obs-comp-cand-002490 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002490`
- External reference / 外部参照: `obimd-sub-jrzjjh3g1r`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020710_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jrzjjh3g1r/jrzjjh3g1r/04ty7mn57j.png`
- Checksum / 校验和:
  `0b02caeed6344f7a9ccf369a2249cb601ca717cf9c66a5eed5ed0d73d862c2a2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.72%.
- Marked-pixel bounds: (59,98)–(190,139); span 132 × 42 px; the marked rectangle
  is wider than tall.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.72%。
- 痕迹范围：(59,98)–(190,139)；跨度132 × 42 px；痕迹矩形宽于高。
