# obs-unk-006554 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/082_undeciphered-006
  501-006600_obs-unk-bucket_oracle-character-candidates/054_obs-unk-006554_h
  ust-obc-und-X-006554_oracle-character-candidate/03_visual-assets/001_asset
  -008145_hust-obc-und-X-006554_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2110/X_？_6009_1.png`
- asset id: `asset-008145`
...
- source class: `HUST-OBC/undeciphered/X/2110/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2110/X_？_6009_1.png`
...
- Which source records identify obs-unk-006554 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006554？
