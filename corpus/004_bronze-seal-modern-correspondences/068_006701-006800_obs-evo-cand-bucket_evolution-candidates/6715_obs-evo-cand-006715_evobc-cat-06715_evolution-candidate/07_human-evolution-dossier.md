...
- External category reference: `evobc-cat-06715`
- Source category ID: `06715`
- Source label for human review: `纔`
- Source codepoints: `U+7E94`
...
- `obs-evo-cand-006715-route-category-staging`
...
- `obs-evo-cand-006715-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006715-route-evolution-graph`
