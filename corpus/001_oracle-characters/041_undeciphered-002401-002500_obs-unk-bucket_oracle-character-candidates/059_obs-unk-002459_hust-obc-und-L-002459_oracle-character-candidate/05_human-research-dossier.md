# obs-unk-002459 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002459`
- primary external id: `hust-obc-und-L-002459`
...
- local review image route: `corpus/001_oracle-characters/041_undeciphered-002
  401-002500_obs-unk-bucket_oracle-character-candidates/059_obs-unk-002459_h
  ust-obc-und-L-002459_oracle-character-candidate/03_visual-assets/001_asset
  -004052_hust-obc-und-L-002459_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2459/L_？_3598.jpg`
- asset id: `asset-004052`
...
- source class: `HUST-OBC/undeciphered/L/2459/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2459/L_？_3598.jpg`
- asset id: `asset-004052`
...
- Which source records identify obs-unk-002459 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002459？
