# obs-unk-004660 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004660`
- primary external id: `hust-obc-und-X-004660`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/060_obs-unk-004660_h
  ust-obc-und-X-004660_oracle-character-candidate/03_visual-assets/001_asset
  -006253_hust-obc-und-X-004660_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/216/X_？_8387_1.png`
- asset id: `asset-006253`
...
- source class: `HUST-OBC/undeciphered/X/216/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/216/X_？_8387_1.png`
- asset id: `asset-006253`
...
- English observation: `tall rectangular contour with left branch`
- 中文观察: `带左侧分支的高近方形轮廓`
...
- Which source records identify obs-unk-004660 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004660？
