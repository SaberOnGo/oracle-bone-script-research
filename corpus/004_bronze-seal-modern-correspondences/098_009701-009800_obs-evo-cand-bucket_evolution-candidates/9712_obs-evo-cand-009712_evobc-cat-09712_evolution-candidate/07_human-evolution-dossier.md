...
Project ID: `obs-evo-cand-009712`
...
- Project ID: `obs-evo-cand-009712`
- EVOBC category candidate ID: `evobc-evo-cat-09712`
- External category reference: `evobc-cat-09712`
- Source category ID: `09712`
- Source label for human review: `阺`
- Source codepoints: `U+963A`
...
- `obs-evo-cand-009712-route-category-staging`
...
- `obs-evo-cand-009712-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009712-route-evolution-graph`
