...
- External category reference: `evobc-cat-11116`
- Source category ID: `11116`
- Source label: `𡸱`
...
- `obs-evo-cand-011116-route-category-staging`
...
- `obs-evo-cand-011116-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011116-route-evolution-graph`
