# Material Visual Observation / obs-comp-cand-001775 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001775`
- External reference / 外部参照: `obimd-sub-qxk4ynjzrh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017976_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8sbbzthl9w/qxk4ynjzrh/qxk4ynjzrh.png`
- Checksum / 校验和:
  `64f003abc43ddf768ff6cdc4210686d9ae0d14e09fba4cfb886e8b3c67aaee72`
...
- Marked-pixel bounds: (88,19)–(179,231); span 92 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.62%。
- 痕迹范围：(88,19)–(179,231)；跨度92 × 213 px；痕迹矩形高于宽。
