...
- External category reference: `evobc-cat-07988`
- Source category ID: `07988`
- Source label: `裴`
...
- `obs-evo-cand-007988-route-category-staging`
...
- `obs-evo-cand-007988-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007988-route-evolution-graph`
