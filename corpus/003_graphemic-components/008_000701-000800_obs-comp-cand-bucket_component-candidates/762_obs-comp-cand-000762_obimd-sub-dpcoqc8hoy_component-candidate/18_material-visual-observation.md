# Material Visual Observation / obs-comp-cand-000762 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000762`
- External reference / 外部参照: `obimd-sub-dpcoqc8hoy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013525_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dpcoqc8hoy/dpcoqc8hoy/dpcoqc8hoy.png`
- Checksum / 校验和:
  `4e405baede8fea8a7345a94478911819a022fa2426fc7bf5d50367865f837b41`
...
- Marked-pixel bounds: (83,21)–(171,226); span 89 × 206 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.22%。
- 痕迹范围：(83,21)–(171,226)；跨度89 × 206 px；痕迹矩形高于宽。
