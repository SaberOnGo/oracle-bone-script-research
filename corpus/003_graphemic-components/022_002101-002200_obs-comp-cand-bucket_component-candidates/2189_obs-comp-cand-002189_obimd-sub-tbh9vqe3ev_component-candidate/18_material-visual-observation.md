# Material Visual Observation / obs-comp-cand-002189 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002189`
- External reference / 外部参照: `obimd-sub-tbh9vqe3ev`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019895_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tbh9vqe3ev/tbh9vqe3ev/tbh9vqe3ev.png`
- Checksum / 校验和:
  `d50f62f5ce134682e2fc4ec26bf8a4380db13ebd350a331b803c618140302824`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.90%.
- Marked-pixel bounds: (99,19)–(162,232); span 64 × 214 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.90%。
- 痕迹范围：(99,19)–(162,232)；跨度64 × 214 px；痕迹矩形高于宽。
