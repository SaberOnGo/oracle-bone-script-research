...
- External category reference: `evobc-cat-03073`
- Source category ID: `03073`
- Source label for human review: `愃`
...
- `obs-evo-cand-003073-route-category-staging`
...
- `obs-evo-cand-003073-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003073-route-evolution-graph`
