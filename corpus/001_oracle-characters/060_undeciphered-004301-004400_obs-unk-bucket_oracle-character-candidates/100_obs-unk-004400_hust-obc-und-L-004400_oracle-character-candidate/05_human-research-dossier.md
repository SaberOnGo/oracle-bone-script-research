# obs-unk-004400 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004400`
- primary external id: `hust-obc-und-L-004400`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/100_obs-unk-004400_h
  ust-obc-und-L-004400_oracle-character-candidate/03_visual-assets/001_asset
  -005993_hust-obc-und-L-004400_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4400/L_？_9802.jpg`
- asset id: `asset-005993`
...
- source class: `HUST-OBC/undeciphered/L/4400/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4400/L_？_9802.jpg`
- asset id: `asset-005993`
...
- English observation: `A rounded enclosing outline surrounds thin inner`
  `and branching traces.`
- 中文观察: `近圆弧外轮廓包围细的内部痕迹和下部叉状痕迹。`
...
- Which source records identify obs-unk-004400 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004400？
