# Material Visual Observation / obs-comp-cand-001751 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001751`
- External reference / 外部参照: `obimd-sub-2sxbksrwvb`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017952_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2sxbksrwvb/2sxbksrwvb/2sxbksrwvb.png`
- Checksum / 校验和:
  `72f455eb691cf0cd487d39b3f7ee77210007d218529501872a330bab3ce16d78`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.83%.
- Marked-pixel bounds: (90,25)–(162,220); span 73 × 196 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.83%。
- 痕迹范围：(90,25)–(162,220)；跨度73 × 196 px；痕迹矩形高于宽。
