...
- External category reference: `evobc-cat-02877`
- Source category ID: `02877`
- Source label for human review: `徠`
- Source codepoints: `U+5FA0`
...
- `obs-evo-cand-002877-route-category-staging`
...
- `obs-evo-cand-002877-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002877-route-evolution-graph`
