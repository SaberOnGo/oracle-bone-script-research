...
- `obs-evo-cand-006693-route-category-staging`
...
- `obs-evo-cand-006693-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006693-route-evolution-graph`
