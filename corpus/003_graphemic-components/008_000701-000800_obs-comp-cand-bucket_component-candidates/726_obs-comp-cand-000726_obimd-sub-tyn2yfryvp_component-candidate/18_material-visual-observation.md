# Material Visual Observation / obs-comp-cand-000726 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000726`
- External reference / 外部参照: `obimd-sub-tyn2yfryvp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013453_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tyn2yfryvp/tyn2yfryvp/tyn2yfryvp.png`
- Checksum / 校验和:
  `7ae1ac77cd1fa656ba19ba0cae9574bc00850c23f5fbbd3d44d8c93d2e3d23cb`
...
- Marked-pixel bounds: (84,35)–(165,219); span 82 × 185 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.65%。
- 痕迹范围：(84,35)–(165,219)；跨度82 × 185 px；痕迹矩形高于宽。
