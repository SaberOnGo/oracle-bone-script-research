# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012762
...
- Project ID: `obs-evo-cand-012762`.
- EVOBC candidate category: `evobc-evo-cat-12762`.
- Source label for search only: `𪒡`.
- Source codepoints for search only: `U+2A4A1`.
