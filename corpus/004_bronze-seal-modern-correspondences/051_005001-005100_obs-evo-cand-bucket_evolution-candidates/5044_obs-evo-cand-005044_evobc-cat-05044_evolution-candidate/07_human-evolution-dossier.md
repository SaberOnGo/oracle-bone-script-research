...
- External category reference: `evobc-cat-05044`
- Source category ID: `05044`
- Source label for human review: `炘`
- Source codepoints: `U+7098`
...
- `obs-evo-cand-005044-route-category-staging`
...
- `obs-evo-cand-005044-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005044-route-evolution-graph`
