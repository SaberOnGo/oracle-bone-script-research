# Material Visual Observation / obs-comp-cand-000886 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000886`
- External reference / 外部参照: `obimd-sub-8fx47t3vmh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013958_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bwfz1jvlck/8fx47t3vmh/8fx47t3vmh.png`
- Checksum / 校验和:
  `8f1ed6fb8827108ae97ad353f05e79965e3ce872030556fe5bf28a580fba20f9`
...
- Marked-pixel bounds: (86,23)–(174,229); span 89 × 207 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.48%。
- 痕迹范围：(86,23)–(174,229)；跨度89 × 207 px；痕迹矩形高于宽。
