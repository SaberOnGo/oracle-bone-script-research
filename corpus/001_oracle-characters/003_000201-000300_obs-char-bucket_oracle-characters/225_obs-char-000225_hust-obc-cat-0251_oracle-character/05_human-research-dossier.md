# obs-char-000225 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/225_obs-char-000225_hust-obc-cat-0251_orac
  le-character/03_visual-assets/001_asset-000230_hust-obc-cat-0251_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0251/H_0251_61064_0.png`
- asset id: `asset-000230`
...
- source category: `0251`
- validation class: `224`
- source image route: `HUST-OBC/deciphered/0251/H_0251_61064_0.png`
- asset id: `asset-000230`
...
- English observation: `The large dark image has a dense circular outer
  frame filled with crossing diagonal strokes and a central vertical line.`
...
- dataset label text: `㓱`
- dataset label codepoints: `U+34F1`
...
- filename catalog route clues: `catalog-like filename clue: H_0251
  (H_0251_61064_0.png)`
...
- Which source records identify obs-char-000225 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000225？
