...
- External category reference: `evobc-cat-13664`
- Source category ID: `13664`
- Source label for human review: `𮠑`
- Source codepoints: `U+2E811`
...
- `obs-evo-cand-013664-route-category-staging`
...
- `obs-evo-cand-013664-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013664-route-evolution-graph`
