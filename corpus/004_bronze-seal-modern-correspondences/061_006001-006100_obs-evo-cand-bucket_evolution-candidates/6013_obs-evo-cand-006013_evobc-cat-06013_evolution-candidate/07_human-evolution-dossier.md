...
Project ID: `obs-evo-cand-006013`
...
- Project ID: `obs-evo-cand-006013`
- EVOBC category candidate ID: `evobc-evo-cat-06013`
- External category reference: `evobc-cat-06013`
- Source category ID: `06013`
- Source label for human review: `禄`
- Source codepoints: `U+7984`
...
- `obs-evo-cand-006013-route-category-staging`
...
- `obs-evo-cand-006013-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006013-route-evolution-graph`
