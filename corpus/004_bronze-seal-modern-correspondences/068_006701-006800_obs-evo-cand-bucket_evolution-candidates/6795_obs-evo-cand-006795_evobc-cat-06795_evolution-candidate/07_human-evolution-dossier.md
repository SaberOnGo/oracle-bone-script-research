...
- External category reference: `evobc-cat-06795`
- Source category ID: `06795`
- Source label for human review: `罐`
- Source codepoints: `U+7F50`
...
- `obs-evo-cand-006795-route-category-staging`
...
- `obs-evo-cand-006795-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006795-route-evolution-graph`
