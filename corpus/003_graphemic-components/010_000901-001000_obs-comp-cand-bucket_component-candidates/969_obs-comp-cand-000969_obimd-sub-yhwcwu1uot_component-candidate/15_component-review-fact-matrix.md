# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000969
...
| Glyph or codepoint route / 字形或码位路线 | 85 OBIMD route rows; examples U+F5710; U+F5711; 另有 83 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 85 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
