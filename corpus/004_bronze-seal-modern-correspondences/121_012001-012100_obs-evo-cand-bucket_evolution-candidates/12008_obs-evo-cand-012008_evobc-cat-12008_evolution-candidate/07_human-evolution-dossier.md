...
Project ID: `obs-evo-cand-012008`
...
- Project ID: `obs-evo-cand-012008`
- EVOBC category candidate ID: `evobc-evo-cat-12008`
- External category reference: `evobc-cat-12008`
- Source category ID: `12008`
- Source label for human review: `𦏕`
- Source codepoints: `U+263D5`
...
- `obs-evo-cand-012008-route-category-staging`
...
- `obs-evo-cand-012008-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012008-route-evolution-graph`
