# obs-char-000382 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/382_obs-char-000382_hust-obc-cat-0434_orac
  le-character/03_visual-assets/001_asset-000387_hust-obc-cat-0434_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0434/G_0434_京津250合17593.png`
- asset id: `asset-000387`
...
- source category: `0434`
- validation class: `381`
- source image route: `HUST-OBC/deciphered/0434/G_0434_京津250合17593.png`
- asset id: `asset-000387`
...
- English observation: `An open rectangular upper outline sits above a
  central junction with three thin descending strokes.`
...
- dataset label text: `㖨`
- dataset label codepoints: `U+35A8`
...
- filename catalog route clues: `Heji-like filename clue: 合17593
  (G_0434_京津250合17593.png)`
...
- Which source records identify obs-char-000382 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000382？
