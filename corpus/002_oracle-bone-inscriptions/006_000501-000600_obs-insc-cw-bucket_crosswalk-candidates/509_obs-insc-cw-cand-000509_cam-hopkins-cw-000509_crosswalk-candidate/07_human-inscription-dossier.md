...
- Yingguo / 英国所藏: `y2487` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `588` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `400` in source row; primary catalog entry pending
