# Material Visual Observation / obs-comp-cand-000428 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000428`
- External reference / 外部参照: `obimd-sub-xedw7y2wk2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012351_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2bcusrt88g/xedw7y2wk2/xedw7y2wk2.png`
- Checksum / 校验和:
  `3a346e871bcfc16de188f2289def2e8058013e739eeb72da1964f3704d3ce41c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.02%.
- Marked-pixel bounds: (62,18)–(187,233); span 126 × 216 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.02%。
- 痕迹范围：(62,18)–(187,233)；跨度126 × 216 px；痕迹矩形高于宽。
