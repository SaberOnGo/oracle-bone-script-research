# obs-unk-004656 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004656`
- primary external id: `hust-obc-und-X-004656`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/056_obs-unk-004656_h
  ust-obc-und-X-004656_oracle-character-candidate/03_visual-assets/001_asset
  -006249_hust-obc-und-X-004656_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/212/X_？_8384_1.png`
- asset id: `asset-006249`
...
- source class: `HUST-OBC/undeciphered/X/212/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/212/X_？_8384_1.png`
- asset id: `asset-006249`
...
- English observation: `tall rounded contour with two inner strokes`
- 中文观察: `带两条内部笔画的高圆弧轮廓`
...
- Which source records identify obs-unk-004656 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004656？
