...
- `obs-evo-cand-009891-route-category-staging`
...
- `obs-evo-cand-009891-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009891-route-evolution-graph`
