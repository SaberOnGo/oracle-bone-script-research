...
- External category reference: `evobc-cat-10342`
- Source category ID: `10342`
- Source label for human review: `鬮`
- Source codepoints: `U+9B2E`
...
- `obs-evo-cand-010342-route-category-staging`
...
- `obs-evo-cand-010342-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010342-route-evolution-graph`
