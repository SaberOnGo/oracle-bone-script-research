...
Project ID: `obs-evo-cand-006148`
...
- Project ID: `obs-evo-cand-006148`
- EVOBC category candidate ID: `evobc-evo-cat-06148`
- External category reference: `evobc-cat-06148`
- Source category ID: `06148`
- Source label for human review: `穹`
- Source codepoints: `U+7A79`
...
- `obs-evo-cand-006148-route-category-staging`
...
- `obs-evo-cand-006148-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006148-route-evolution-graph`
