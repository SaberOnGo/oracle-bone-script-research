# obs-unk-004734 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/034_obs-unk-004734_h
  ust-obc-und-X-004734_oracle-character-candidate/03_visual-assets/001_asset
  -006327_hust-obc-und-X-004734_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/290/X_？_7269_1.png`
- asset id: `asset-006327`
...
- source class: `HUST-OBC/undeciphered/X/290/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/290/X_？_7269_1.png`
- asset id: `asset-006327`
...
- English observation: `separate upper band and lower long stem`
- 中文观察: `分离的上部横带和下部长竖笔画`
...
- Which source records identify obs-unk-004734 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004734？
