...
- External category reference: `evobc-cat-07713`
- Source category ID: `07713`
- Source label for human review: `虧`
- Source codepoints: `U+8667`
...
- `obs-evo-cand-007713-route-category-staging`
...
- `obs-evo-cand-007713-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007713-route-evolution-graph`
