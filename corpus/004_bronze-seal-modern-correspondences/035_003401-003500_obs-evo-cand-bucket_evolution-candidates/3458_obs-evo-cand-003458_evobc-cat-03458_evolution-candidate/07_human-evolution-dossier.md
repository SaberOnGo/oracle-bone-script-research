...
Project ID: `obs-evo-cand-003458`
...
- Project ID: `obs-evo-cand-003458`
- EVOBC category candidate ID: `evobc-evo-cat-03458`
- External category reference: `evobc-cat-03458`
- Source category ID: `03458`
- Source label for human review: `搤`
- Source codepoints: `U+6424`
...
- `obs-evo-cand-003458-route-category-staging`
...
- `obs-evo-cand-003458-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003458-route-evolution-graph`
