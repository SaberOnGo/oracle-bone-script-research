...
Project ID: `obs-evo-cand-003532`
...
- Project ID: `obs-evo-cand-003532`
- EVOBC category candidate ID: `evobc-evo-cat-03532`
- External category reference: `evobc-cat-03532`
- Source category ID: `03532`
- Source label for human review: `擫`
- Source codepoints: `U+64EB`
...
- `obs-evo-cand-003532-route-category-staging`
...
- `obs-evo-cand-003532-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003532-route-evolution-graph`
