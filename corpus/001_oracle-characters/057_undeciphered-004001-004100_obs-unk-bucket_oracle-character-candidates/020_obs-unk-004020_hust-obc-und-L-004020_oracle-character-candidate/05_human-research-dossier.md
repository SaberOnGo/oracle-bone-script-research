# obs-unk-004020 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/020_obs-unk-004020_h
  ust-obc-und-L-004020_oracle-character-candidate/03_visual-assets/001_asset
  -005613_hust-obc-und-L-004020_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4020/L_？_8573.jpg`
- asset id: `asset-005613`
...
- source class: `HUST-OBC/undeciphered/L/4020/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4020/L_？_8573.jpg`
- asset id: `asset-005613`
...
- Which source records identify obs-unk-004020 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004020？
