...
- External category reference: `evobc-cat-08255`
- Source category ID: `08255`
- Source label for human review: `誾`
- Source codepoints: `U+8ABE`
...
- `obs-evo-cand-008255-route-category-staging`
...
- `obs-evo-cand-008255-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008255-route-evolution-graph`
