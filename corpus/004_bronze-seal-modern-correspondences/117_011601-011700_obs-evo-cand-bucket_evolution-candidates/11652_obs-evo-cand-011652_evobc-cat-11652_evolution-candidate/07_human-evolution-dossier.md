...
- Project ID: `obs-evo-cand-011652`
- EVOBC category candidate ID: `evobc-evo-cat-11652`
- External category reference: `evobc-cat-11652`
- Source category ID: `11652`
- Source label for human review: `𤪠`
- Source codepoints: `U+24AA0`
...
- `obs-evo-cand-011652-route-category-staging`
...
- `obs-evo-cand-011652-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011652-route-evolution-graph`
