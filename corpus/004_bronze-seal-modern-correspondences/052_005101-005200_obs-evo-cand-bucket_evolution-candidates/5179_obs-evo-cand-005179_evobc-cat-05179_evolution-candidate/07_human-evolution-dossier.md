...
- External category reference: `evobc-cat-05179`
- Source category ID: `05179`
- Source label for human review: `爫`
...
- `obs-evo-cand-005179-route-category-staging`
...
- `obs-evo-cand-005179-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005179-route-evolution-graph`
