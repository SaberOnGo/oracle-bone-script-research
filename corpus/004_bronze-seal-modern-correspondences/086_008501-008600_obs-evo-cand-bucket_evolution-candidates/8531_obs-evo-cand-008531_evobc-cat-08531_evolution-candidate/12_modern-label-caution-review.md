# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008531
...
- EVOBC candidate category: `evobc-evo-cat-08531`.
- Source label for search only: `貛`.
- Source codepoints for search only: `U+8C9B`.
