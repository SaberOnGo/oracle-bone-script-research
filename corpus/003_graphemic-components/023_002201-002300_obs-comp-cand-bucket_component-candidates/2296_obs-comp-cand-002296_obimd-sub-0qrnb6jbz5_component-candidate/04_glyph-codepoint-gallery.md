# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002296
...
| --- | --- | --- | --- |
| `obimd-glyph-link-035574` | 󽎩 | `U+FD3A9` | `reviewed_metadata_only` |
| `obimd-glyph-link-035575` | 󽎪 | `U+FD3AA` | `reviewed_metadata_only` |
| `obimd-glyph-link-035576` | 󽎫 | `U+FD3AB` | `reviewed_metadata_only` |
