# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002826
...
- EVOBC candidate category: `evobc-evo-cat-02826`.
- Source label for search only: `彌`.
- Source codepoints for search only: `U+5F4C`.
