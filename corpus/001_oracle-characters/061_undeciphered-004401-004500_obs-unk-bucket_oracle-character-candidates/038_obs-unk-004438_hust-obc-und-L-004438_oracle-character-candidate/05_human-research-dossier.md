# obs-unk-004438 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/038_obs-unk-004438_h
  ust-obc-und-L-004438_oracle-character-candidate/03_visual-assets/001_asset
  -006031_hust-obc-und-L-004438_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4438/L_？_9968.jpg`
- asset id: `asset-006031`
...
- source class: `HUST-OBC/undeciphered/L/4438/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4438/L_？_9968.jpg`
- asset id: `asset-006031`
...
- English observation: `A left vertical trace meets a rounded right outline`
  `and lower curve.`
- 中文观察: `左侧竖痕连接右侧圆弧轮廓和下部弯痕。`
...
- Which source records identify obs-unk-004438 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004438？
