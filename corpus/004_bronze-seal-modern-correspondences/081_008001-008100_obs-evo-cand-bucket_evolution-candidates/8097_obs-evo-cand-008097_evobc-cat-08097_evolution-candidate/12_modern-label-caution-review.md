# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008097
...
- EVOBC candidate category: `evobc-evo-cat-08097`.
- Source label for search only: `觛`.
- Source codepoints for search only: `U+89DB`.
