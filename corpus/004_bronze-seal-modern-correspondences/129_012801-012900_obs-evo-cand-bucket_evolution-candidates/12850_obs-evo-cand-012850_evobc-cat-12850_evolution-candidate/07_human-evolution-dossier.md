...
- External category reference: `evobc-cat-12850`
- Source category ID: `12850`
- Source label for human review: `𪬯`
...
- `obs-evo-cand-012850-route-category-staging`
...
- `obs-evo-cand-012850-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012850-route-evolution-graph`
