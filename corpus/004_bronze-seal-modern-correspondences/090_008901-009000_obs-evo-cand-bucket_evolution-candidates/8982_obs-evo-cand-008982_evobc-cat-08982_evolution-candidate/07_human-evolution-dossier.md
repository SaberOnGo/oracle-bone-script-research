...
Project ID: `obs-evo-cand-008982`
...
- Project ID: `obs-evo-cand-008982`
- EVOBC category candidate ID: `evobc-evo-cat-08982`
- External category reference: `evobc-cat-08982`
- Source category ID: `08982`
- Source label for human review: `逅`
- Source codepoints: `U+9005`
...
- `obs-evo-cand-008982-route-category-staging`
...
- `obs-evo-cand-008982-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008982-route-evolution-graph`
