...
- External category reference: `evobc-cat-06609`
- Source category ID: `06609`
- Source label for human review: `緮`
...
- `obs-evo-cand-006609-route-category-staging`
...
- `obs-evo-cand-006609-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006609-route-evolution-graph`
