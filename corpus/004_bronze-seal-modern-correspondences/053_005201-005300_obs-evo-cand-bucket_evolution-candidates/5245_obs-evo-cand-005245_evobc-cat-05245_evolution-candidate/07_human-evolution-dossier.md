...
- External category reference: `evobc-cat-05245`
- Source category ID: `05245`
...
- `obs-evo-cand-005245-route-category-staging`
...
- `obs-evo-cand-005245-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005245-route-evolution-graph`
