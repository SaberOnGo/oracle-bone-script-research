...
- `obs-evo-cand-000151-route-category-staging`
...
- `obs-evo-cand-000151-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000151-route-evolution-graph`
