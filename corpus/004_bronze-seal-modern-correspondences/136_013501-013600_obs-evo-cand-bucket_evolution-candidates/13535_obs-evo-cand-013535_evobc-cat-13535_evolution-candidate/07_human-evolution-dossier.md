...
- External category reference: `evobc-cat-13535`
- Source category ID: `13535`
- Source label for human review: `𭣲`
- Source codepoints: `U+2D8F2`
...
- `obs-evo-cand-013535-route-category-staging`
...
- `obs-evo-cand-013535-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013535-route-evolution-graph`
