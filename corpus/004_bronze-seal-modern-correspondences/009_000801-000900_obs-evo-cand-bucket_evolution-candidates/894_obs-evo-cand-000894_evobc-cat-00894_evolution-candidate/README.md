# obs-evo-cand-000894 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-00894`
- Source label: `保`
- Source codepoints: `U+4FDD`
- Image reference count: `341`
- Era token counts: `BI:120;CS:2;OBC:134;SAC:29;SS:4;WSC:52`
- Source token counts: `Book:150;Web:191`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 134 image references
- era 1 / BI: 120 image references
