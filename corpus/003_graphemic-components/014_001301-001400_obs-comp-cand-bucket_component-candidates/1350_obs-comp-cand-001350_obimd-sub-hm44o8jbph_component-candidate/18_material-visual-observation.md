# Material Visual Observation / obs-comp-cand-001350 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001350`
- External reference / 外部参照: `obimd-sub-hm44o8jbph`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015739_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hm44o8jbph/hm44o8jbph/hm44o8jbph.png`
- Checksum / 校验和:
  `fe5f9f787d22a7922b923f4f032fa56076a5ae8ea3a31c6abeb002a1e22382c9`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.13%.
- Marked-pixel bounds: (84,25)–(165,220); span 82 × 196 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.13%。
- 痕迹范围：(84,25)–(165,220)；跨度82 × 196 px；痕迹矩形高于宽。
