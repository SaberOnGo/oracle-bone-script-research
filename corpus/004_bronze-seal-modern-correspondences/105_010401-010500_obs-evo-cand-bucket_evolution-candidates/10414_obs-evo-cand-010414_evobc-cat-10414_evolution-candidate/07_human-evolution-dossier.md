...
Project ID: `obs-evo-cand-010414`
...
- Project ID: `obs-evo-cand-010414`
- EVOBC category candidate ID: `evobc-evo-cat-10414`
- External category reference: `evobc-cat-10414`
- Source category ID: `10414`
- Source label for human review: `鯖`
- Source codepoints: `U+9BD6`
...
- `obs-evo-cand-010414-route-category-staging`
...
- `obs-evo-cand-010414-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010414-route-evolution-graph`
