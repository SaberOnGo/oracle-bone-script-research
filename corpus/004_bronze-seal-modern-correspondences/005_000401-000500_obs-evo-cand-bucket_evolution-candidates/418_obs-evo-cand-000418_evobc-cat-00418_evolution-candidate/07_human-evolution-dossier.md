...
- External category reference: `evobc-cat-00418`
- Source category ID: `00418`
- Source label for human review: `䚄`
- Source codepoints: `U+4684`
...
- `obs-evo-cand-000418-route-category-staging`
...
- `obs-evo-cand-000418-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000418-route-evolution-graph`
