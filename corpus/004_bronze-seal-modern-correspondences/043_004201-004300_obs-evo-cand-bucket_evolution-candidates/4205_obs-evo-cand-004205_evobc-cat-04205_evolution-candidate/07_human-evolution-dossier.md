...
Project ID: `obs-evo-cand-004205`
...
- Project ID: `obs-evo-cand-004205`
- EVOBC category candidate ID: `evobc-evo-cat-04205`
- External category reference: `evobc-cat-04205`
- Source category ID: `04205`
- Source label for human review: `構`
- Source codepoints: `U+69CB`
...
- `obs-evo-cand-004205-route-category-staging`
...
- `obs-evo-cand-004205-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004205-route-evolution-graph`
