# Material Visual Observation / obs-comp-cand-001432 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001432`
- External reference / 外部参照: `obimd-sub-otmub1b4dq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016009_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zgocda0mov/otmub1b4dq/otmub1b4dq.png`
- Checksum / 校验和:
  `caaf6f515521928723a69603a4389895df3c891d816a3baed94012fcdb625052`
...
- Marked-pixel bounds: (71,21)–(184,228); span 114 × 208 px; the marked
...
- 痕迹范围：(71,21)–(184,228)；跨度114 × 208 px；痕迹矩形高于宽。
