...
- External category reference: `evobc-cat-06014`
- Source category ID: `06014`
- Source label for human review: `禅`
- Source codepoints: `U+7985`
...
- `obs-evo-cand-006014-route-category-staging`
...
- `obs-evo-cand-006014-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006014-route-evolution-graph`
