...
- External category reference: `evobc-cat-02952`
- Source category ID: `02952`
- Source label for human review: `怭`
...
- `obs-evo-cand-002952-route-category-staging`
...
- `obs-evo-cand-002952-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002952-route-evolution-graph`
