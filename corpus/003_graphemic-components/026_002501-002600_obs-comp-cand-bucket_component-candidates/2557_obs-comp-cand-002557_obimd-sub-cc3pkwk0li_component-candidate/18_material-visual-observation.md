# Material Visual Observation / obs-comp-cand-002557 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002557`
- External reference / 外部参照: `obimd-sub-cc3pkwk0li`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021089_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cc3pkwk0li/cc3pkwk0li/cc3pkwk0li.png`
- Checksum / 校验和:
  `157f84264caa3dc5524a97aa735f796009b61c66dc6755ff8a550061de2e0563`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.26%.
- Marked-pixel bounds: (59,30)–(199,218); span 141 × 189 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.26%。
- 痕迹范围：(59,30)–(199,218)；跨度141 × 189 px；痕迹矩形高于宽。
