# Material Visual Observation / obs-comp-cand-002167 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002167`
- External reference / 外部参照: `obimd-sub-medazzhc49`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019868_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/medazzhc49/medazzhc49/medazzhc49.png`
- Checksum / 校验和:
  `07aaa3ca33dd196077c9e96bf56ad210a6414883e5c0e726f92835d4af248e36`
...
- Marked-pixel bounds: (82,19)–(168,230); span 87 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.93%。
- 痕迹范围：(82,19)–(168,230)；跨度87 × 212 px；痕迹矩形高于宽。
