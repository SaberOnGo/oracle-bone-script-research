# obs-unk-002903 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/046_undeciphered-002
  901-003000_obs-unk-bucket_oracle-character-candidates/003_obs-unk-002903_h
  ust-obc-und-L-002903_oracle-character-candidate/03_visual-assets/001_asset
  -004496_hust-obc-und-L-002903_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2903/L_？_4989.jpg`
- asset id: `asset-004496`
...
- source class: `HUST-OBC/undeciphered/L/2903/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2903/L_？_4989.jpg`
- asset id: `asset-004496`
...
- Which source records identify obs-unk-002903 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002903？
