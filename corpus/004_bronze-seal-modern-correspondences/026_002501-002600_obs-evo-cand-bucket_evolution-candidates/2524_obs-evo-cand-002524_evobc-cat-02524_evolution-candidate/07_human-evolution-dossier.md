...
- External category reference: `evobc-cat-02524`
- Source category ID: `02524`
- Source label for human review: `屰`
...
- `obs-evo-cand-002524-route-category-staging`
...
- `obs-evo-cand-002524-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002524-route-evolution-graph`
