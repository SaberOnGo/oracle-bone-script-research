...
Project ID: `obs-evo-cand-013595`
...
- Project ID: `obs-evo-cand-013595`
- EVOBC category candidate ID: `evobc-evo-cat-13595`
- External category reference: `evobc-cat-13595`
- Source category ID: `13595`
- Source label for human review: `𭿂`
- Source codepoints: `U+2DFC2`
...
- `obs-evo-cand-013595-route-category-staging`
...
- `obs-evo-cand-013595-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013595-route-evolution-graph`
