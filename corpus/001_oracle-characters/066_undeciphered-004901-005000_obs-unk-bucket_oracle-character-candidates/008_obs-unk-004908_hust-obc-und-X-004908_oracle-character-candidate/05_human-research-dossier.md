# obs-unk-004908 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004908`
- primary external id: `hust-obc-und-X-004908`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/008_obs-unk-004908_h
  ust-obc-und-X-004908_oracle-character-candidate/03_visual-assets/001_asset
  -006501_hust-obc-und-X-004908_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/464/X_？_7449_1.png`
- asset id: `asset-006501`
...
- The opened image shows stacked dark bands in a dense left group.
- A separate right stroke bends into a pointed lower branch.
- The single source view is present locally; no view-count gap is recorded.
- 直接记录：`14_material-visual-observation.md`
- 已打开图像左侧密集结构中可见叠置的深色横带。
- 右侧另有笔画，并弯向下方形成尖端分枝。
- 单一来源视图已在本地保存；没有记录到视图数量缺口。
...
- source class: `HUST-OBC/undeciphered/X/464/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/464/X_？_7449_1.png`
- asset id: `asset-006501`
...
- Which source records identify obs-unk-004908 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004908？
