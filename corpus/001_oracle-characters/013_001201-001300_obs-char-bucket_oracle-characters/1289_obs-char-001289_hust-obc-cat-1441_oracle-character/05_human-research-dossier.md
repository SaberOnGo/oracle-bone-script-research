# obs-char-001289 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001289`
- primary external id: `hust-obc-cat-1441`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1289_obs-char-001289_hust-obc-cat-1441_ora
  cle-character/03_visual-assets/001_asset-001294_hust-obc-cat-1441_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1441/G_1441_乙105合21306𠂤組.png`
- asset id: `asset-001294`
...
- source category: `1441`
- validation class: `1288`
- source image route: `HUST-OBC/deciphered/1441/G_1441_乙105合21306𠂤組.png`
- asset id: `asset-001294`
...
- English observation: `A narrow upright cluster has a short upper crossing,
  repeated central strokes, and a small lower loop.`
- 中文观察: `狭长直立笔画群有短上部交叉笔、重复的中央笔画和小型下部环形。`
...
- dataset label text: `㦗`
- dataset label codepoints: `U+3997`
...
- filename catalog route clues: `Heji-like filename clue: 合21306
  (G_1441_乙105合21306𠂤組.png)`
...
- Which source records identify obs-char-001289 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001289？
