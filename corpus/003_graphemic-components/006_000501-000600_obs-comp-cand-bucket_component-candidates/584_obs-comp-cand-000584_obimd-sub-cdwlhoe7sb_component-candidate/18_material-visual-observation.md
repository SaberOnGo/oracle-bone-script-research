# Material Visual Observation / obs-comp-cand-000584 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000584`
- External reference / 外部参照: `obimd-sub-cdwlhoe7sb`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013112_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cdwlhoe7sb/cdwlhoe7sb/cdwlhoe7sb.png`
- Checksum / 校验和:
  `53b120cf835376574686c8700de66e1c70d03abbacbbf920071d8d4d61b0b40a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.39%.
- Marked-pixel bounds: (55,48)–(194,202); span 140 × 155 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.39%。
- 痕迹范围：(55,48)–(194,202)；跨度140 × 155 px；痕迹矩形近方形。
