# Material Visual Observation / obs-comp-cand-001268 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001268`
- External reference / 外部参照: `obimd-sub-mb0881ajp7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015506_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/frmptf4le7/mb0881ajp7/mb0881ajp7.png`
- Checksum / 校验和:
  `87a574905e05be7a4401f530edc025e051740a7d770b1c31b6fd9cda3b94e746`
...
- Marked-pixel bounds: (75,34)–(172,209); span 98 × 176 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.42%。
- 痕迹范围：(75,34)–(172,209)；跨度98 × 176 px；痕迹矩形高于宽。
