# obs-comp-cand-002388 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002388`
- 首选外部 ID: `obimd-sub-uafxee1kjk`
- OBIMD subcharacter UID: `uafxee1kjk`
- OBIMD main character UID: `uafxee1kjk`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+C758A;U+FDACC; U+FDACD
