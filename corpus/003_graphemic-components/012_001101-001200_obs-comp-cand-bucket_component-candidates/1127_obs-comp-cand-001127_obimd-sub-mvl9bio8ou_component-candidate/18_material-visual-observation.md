# Material Visual Observation / obs-comp-cand-001127 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001127`
- External reference / 外部参照: `obimd-sub-mvl9bio8ou`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015081_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/mvl9bio8ou/mvl9bio8ou/mvl9bio8ou.png`
- Checksum / 校验和:
  `59ef7ef18805b85288692ad601adc7a2979c316c0d55080ad81aaeb1f4428a23`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.79%.
- Marked-pixel bounds: (67,31)–(186,214); span 120 × 184 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.79%。
- 痕迹范围：(67,31)–(186,214)；跨度120 × 184 px；痕迹矩形高于宽。
