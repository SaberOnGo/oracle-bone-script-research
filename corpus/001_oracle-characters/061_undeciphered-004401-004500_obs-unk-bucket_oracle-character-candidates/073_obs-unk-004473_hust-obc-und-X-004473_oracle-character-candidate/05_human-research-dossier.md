# obs-unk-004473 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/073_obs-unk-004473_h
  ust-obc-und-X-004473_oracle-character-candidate/03_visual-assets/001_asset
  -006066_hust-obc-und-X-004473_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/29/X_？_8207_1.png`
- asset id: `asset-006066`
...
- source class: `HUST-OBC/undeciphered/X/29/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/29/X_？_8207_1.png`
- asset id: `asset-006066`
...
- English observation: A broad upper form with two openings sits above a
  separate lower curved group.
- 中文观察: 两个开口的宽上部痕迹位于分离的下部弧形痕迹之上。
...
- Which source records identify obs-unk-004473 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004473？
