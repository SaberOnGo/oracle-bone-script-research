# Material Visual Observation / obs-comp-cand-001882 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001882`
- External reference / 外部参照: `obimd-sub-wfyy86f1n0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018261_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wfyy86f1n0/wfyy86f1n0/wfyy86f1n0.png`
- Checksum / 校验和:
  `1eda99dc97618e841008b8201cb47f8bf0386c26128f236ca883c9ece8278d8e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.12%.
- Marked-pixel bounds: (69,19)–(173,230); span 105 × 212 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.12%。
- 痕迹范围：(69,19)–(173,230)；跨度105 × 212 px；痕迹矩形高于宽。
