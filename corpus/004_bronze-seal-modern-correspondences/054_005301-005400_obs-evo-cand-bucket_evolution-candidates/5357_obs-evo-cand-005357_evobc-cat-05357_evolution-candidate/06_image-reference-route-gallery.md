...
- `obs-evo-cand-005357-route-category-staging`
...
- `obs-evo-cand-005357-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005357-route-evolution-graph`
