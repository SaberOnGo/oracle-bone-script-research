...
- External category reference: `evobc-cat-08839`
- Source category ID: `08839`
- Source label for human review: `輗`
- Source codepoints: `U+8F17`
...
- `obs-evo-cand-008839-route-category-staging`
...
- `obs-evo-cand-008839-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008839-route-evolution-graph`
