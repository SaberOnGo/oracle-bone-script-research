...
- `obs-evo-cand-009606-route-category-staging`
...
- `obs-evo-cand-009606-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009606-route-evolution-graph`
