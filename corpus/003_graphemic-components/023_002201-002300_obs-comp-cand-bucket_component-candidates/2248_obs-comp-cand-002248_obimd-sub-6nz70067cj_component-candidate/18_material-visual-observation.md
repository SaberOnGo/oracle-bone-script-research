# Material Visual Observation / obs-comp-cand-002248 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002248`
- External reference / 外部参照: `obimd-sub-6nz70067cj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020061_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/65i2zmqjqy/6nz70067cj/6nz70067cj.png`
- Checksum / 校验和:
  `c1f6c5d549d5805c21f39fafd8251c0a43a200a5bc9b9dc4e43ff8afcd42be25`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.04%.
- Marked-pixel bounds: (83,35)–(166,209); span 84 × 175 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.04%。
- 痕迹范围：(83,35)–(166,209)；跨度84 × 175 px；痕迹矩形高于宽。
