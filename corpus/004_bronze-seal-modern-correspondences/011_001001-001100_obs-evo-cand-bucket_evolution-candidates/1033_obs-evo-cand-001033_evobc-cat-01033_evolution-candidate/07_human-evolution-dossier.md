...
- External category reference: `evobc-cat-01033`
- Source category ID: `01033`
- Source label for human review: `價`
- Source codepoints: `U+50F9`
...
- `obs-evo-cand-001033-route-category-staging`
...
- `obs-evo-cand-001033-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001033-route-evolution-graph`
