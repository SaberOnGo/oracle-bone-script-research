...
Project ID: `obs-insc-cw-cand-000601`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000601`
...
- Source page section: `Period V Group 19` /
  `第 V 期第 19 组`
- Source section key: `period-v-group-19`
...
- Yingguo / 英国所藏: `y2655` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `404` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `516` in source row; primary catalog entry pending
- Heji / 合集: `41937` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000601`
