...
- External category reference: `evobc-cat-11749`
- Source category ID: `11749`
- Source label for human review: `𥀊`
...
- `obs-evo-cand-011749-route-category-staging`
...
- `obs-evo-cand-011749-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011749-route-evolution-graph`
