...
Project ID: `obs-evo-cand-003209`
...
- Project ID: `obs-evo-cand-003209`
- EVOBC category candidate ID: `evobc-evo-cat-03209`
- External category reference: `evobc-cat-03209`
- Source category ID: `03209`
- Source label for human review: `戔`
- Source codepoints: `U+6214`
...
- `obs-evo-cand-003209-route-category-staging`
...
- `obs-evo-cand-003209-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003209-route-evolution-graph`
