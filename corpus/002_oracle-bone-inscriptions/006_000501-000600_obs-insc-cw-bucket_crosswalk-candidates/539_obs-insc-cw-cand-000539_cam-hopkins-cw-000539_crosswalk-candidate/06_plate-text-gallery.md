...
Project ID: `obs-insc-cw-cand-000539`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000539`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000539` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2541` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `366` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `463` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `41804` [route_present_image_or_text_not_collected]
