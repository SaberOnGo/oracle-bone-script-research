...
Project ID: `obs-evo-cand-002764`
...
- Project ID: `obs-evo-cand-002764`
- EVOBC category candidate ID: `evobc-evo-cat-02764`
- External category reference: `evobc-cat-02764`
- Source category ID: `02764`
- Source label for human review: `廡`
- Source codepoints: `U+5EE1`
...
- `obs-evo-cand-002764-route-category-staging`
...
- `obs-evo-cand-002764-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002764-route-evolution-graph`
