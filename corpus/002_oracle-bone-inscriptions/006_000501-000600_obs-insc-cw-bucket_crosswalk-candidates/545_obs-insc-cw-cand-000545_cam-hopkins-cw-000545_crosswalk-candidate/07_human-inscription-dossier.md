...
- Yingguo / 英国所藏: `y2547` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `376` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `549` in source row; primary catalog entry pending
- Heji / 合集: `41824` in source row; primary catalog entry pending
