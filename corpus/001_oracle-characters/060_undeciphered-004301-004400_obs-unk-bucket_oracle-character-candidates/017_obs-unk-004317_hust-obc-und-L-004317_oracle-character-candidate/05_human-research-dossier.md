# obs-unk-004317 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004317`
- primary external id: `hust-obc-und-L-004317`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/017_obs-unk-004317_h
  ust-obc-und-L-004317_oracle-character-candidate/03_visual-assets/001_asset
  -005910_hust-obc-und-L-004317_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4317/L_？_952.jpg`
- asset id: `asset-005910`
...
- source class: `HUST-OBC/undeciphered/L/4317/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4317/L_？_952.jpg`
- asset id: `asset-005910`
...
- English observation: `Small upper divergence and middle horizontal
  trace recorded in 14 file.`
- 中文观察: `已在 14 文件记录上部分开痕和中部横向痕迹。`
...
- Which source records identify obs-unk-004317 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004317？
