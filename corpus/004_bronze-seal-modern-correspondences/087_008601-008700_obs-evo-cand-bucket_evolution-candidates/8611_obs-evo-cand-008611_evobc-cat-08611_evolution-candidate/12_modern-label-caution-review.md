# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008611
...
- EVOBC candidate category: `evobc-evo-cat-08611`.
- Source label for search only: `贛`.
- Source codepoints for search only: `U+8D1B`.
