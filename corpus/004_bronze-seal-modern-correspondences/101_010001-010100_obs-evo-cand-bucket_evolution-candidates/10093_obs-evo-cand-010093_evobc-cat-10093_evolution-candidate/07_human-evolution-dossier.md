...
Project ID: `obs-evo-cand-010093`
...
- Project ID: `obs-evo-cand-010093`
- EVOBC category candidate ID: `evobc-evo-cat-10093`
- External category reference: `evobc-cat-10093`
- Source category ID: `10093`
- Source label for human review: `飹`
- Source codepoints: `U+98F9`
...
- `obs-evo-cand-010093-route-category-staging`
...
- `obs-evo-cand-010093-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010093-route-evolution-graph`
