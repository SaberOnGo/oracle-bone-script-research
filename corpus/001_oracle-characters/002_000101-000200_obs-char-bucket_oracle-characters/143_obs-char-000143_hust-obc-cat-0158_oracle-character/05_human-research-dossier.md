# obs-char-000143 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000143`
- primary external id: `hust-obc-cat-0158`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/143_obs-char-000143_hust-obc-cat-0158_orac
  le-character/03_visual-assets/001_asset-000148_hust-obc-cat-0158_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0158/G_0158_後2.21.1(甲).png`
- asset id: `asset-000148`
...
- source category: `0158`
- validation class: `142`
- source image route: `HUST-OBC/deciphered/0158/G_0158_後2.21.1(甲).png`
- asset id: `asset-000148`
...
- English observation: `The narrow image has a small forked upper stem, a
  rounded loop on the left, and a long curved stroke descending on the
  right.`
- 中文观察: `狭长图像上方有小分叉主笔，左侧有圆弧环状笔，右侧有长弯曲下行笔。`
...
- dataset label text: `㒔`
- dataset label codepoints: `U+3494`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00013`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00013`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00013`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/013_obs-evo-can
  d-000013_evobc-cat-00013_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/013_obs-evo-cand-000013_evobc-cat-00013_evolu
...
- Which source records identify obs-char-000143 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000143？
