# obs-char-000784 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000784`
- primary external id: `hust-obc-cat-0888`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/784_obs-char-000784_hust-obc-cat-0888_orac
  le-character/03_visual-assets/001_asset-000789_hust-obc-cat-0888_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0888/G_0888_甲2812(甲).png`
- asset id: `asset-000789`
...
- source category: `0888`
- validation class: `783`
- source image route: `HUST-OBC/deciphered/0888/G_0888_甲2812(甲).png`
- asset id: `asset-000789`
...
- English observation: `The small image shows a rounded irregular body with
  two tiny upper oval marks, an inner opening crossed by short strokes, and
  a broad curved lower base.`
- 中文观察: `小图像显示不规则圆弯主体，上方有两个小椭圆痕，内部空隙被短笔交叉，下方为宽弯底部。`
...
- dataset label text: `㝮`
- dataset label codepoints: `U+376E`
...
- Which source records identify obs-char-000784 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000784？
