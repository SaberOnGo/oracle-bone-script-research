# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002586
...
| --- | --- | --- | --- |
| `obimd-glyph-link-039481` | 󾪈 | `U+FEA88` | `reviewed_metadata_only` |
| `obimd-glyph-link-039482` | 󾪉 | `U+FEA89` | `reviewed_metadata_only` |
