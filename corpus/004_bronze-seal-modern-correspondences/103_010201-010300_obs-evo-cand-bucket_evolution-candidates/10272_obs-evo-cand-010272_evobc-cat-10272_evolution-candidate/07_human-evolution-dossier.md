...
Project ID: `obs-evo-cand-010272`
...
- Project ID: `obs-evo-cand-010272`
- EVOBC category candidate ID: `evobc-evo-cat-10272`
- External category reference: `evobc-cat-10272`
- Source category ID: `10272`
- Source label for human review: `驱`
- Source codepoints: `U+9A71`
...
- `obs-evo-cand-010272-route-category-staging`
...
- `obs-evo-cand-010272-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010272-route-evolution-graph`
