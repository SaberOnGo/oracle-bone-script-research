...
- Project ID: `obs-evo-cand-012316`
- EVOBC category candidate ID: `evobc-evo-cat-12316`
- External category reference: `evobc-cat-12316`
- Source category ID: `12316`
- Source label for human review: `𨅄`
- Source codepoints: `U+28144`
...
- `obs-evo-cand-012316-route-category-staging`
...
- `obs-evo-cand-012316-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012316-route-evolution-graph`
