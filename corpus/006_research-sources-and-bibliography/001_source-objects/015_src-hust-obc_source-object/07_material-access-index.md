# src-hust-obc Material Access Index
...
- Profile metrics / 概况指标: figshare_file_size_bytes; figshare_license;
  ocr_inverse_mapping_count; ocr_mapping_count; validation_label_count;
  validation_label_crosswalk_count; validation_label_multi_component_count;
  validation_label_single_component_count; validation_label_value_range;
  validation_source_category_count;
  validation_source_category_multi_member_count
