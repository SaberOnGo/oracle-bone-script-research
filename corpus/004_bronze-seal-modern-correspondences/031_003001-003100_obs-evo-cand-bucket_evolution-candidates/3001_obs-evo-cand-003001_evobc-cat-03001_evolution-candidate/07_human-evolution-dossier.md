...
- External category reference: `evobc-cat-03001`
- Source category ID: `03001`
- Source label for human review: `悆`
- Source codepoints: `U+6086`
...
- `obs-evo-cand-003001-route-category-staging`
...
- `obs-evo-cand-003001-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003001-route-evolution-graph`
