# obs-char-000227 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/227_obs-char-000227_hust-obc-cat-0253_orac
  le-character/03_visual-assets/001_asset-000232_hust-obc-cat-0253_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0253/G_0253_合14294賓組.png`
- asset id: `asset-000232`
...
- source category: `0253`
- validation class: `226`
- source image route: `HUST-OBC/deciphered/0253/G_0253_合14294賓組.png`
- asset id: `asset-000232`
...
- English observation: `The image is a simple thin curved upper stroke that
  turns into a long descending line on the right.`
...
- dataset label text: `㓳`
- dataset label codepoints: `U+34F3`
...
- filename catalog route clues: `Heji-like filename clue: 合14294
  (G_0253_合14294賓組.png)`
...
- Which source records identify obs-char-000227 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000227？
