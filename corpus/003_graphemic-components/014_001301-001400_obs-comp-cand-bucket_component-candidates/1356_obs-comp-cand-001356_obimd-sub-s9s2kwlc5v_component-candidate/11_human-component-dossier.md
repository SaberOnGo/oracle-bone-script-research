# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-001356
...
- candidate_component_id: `obs-comp-cand-001356`
- primary_external_ref_id: `obimd-sub-s9s2kwlc5v`
- source_subcharacter_uid: `s9s2kwlc5v`
...
- glyph_codepoint_uplus_sample: `U+F7B16, U+F7B17, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-015745` | `001_asset-015745_img.png` | `58317b4b90455e0cd19c31100de959dab19992034e469fb8bf3ccf132fbfb339` |
