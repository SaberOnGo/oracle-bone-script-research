# obs-char-000730 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/730_obs-char-000730_hust-obc-cat-0831_orac
  le-character/03_visual-assets/001_asset-000735_hust-obc-cat-0831_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0831/G_0831_乙3394合3238賓組.png`
- asset id: `asset-000735`
...
- source category: `0831`
- validation class: `729`
- source image route: `HUST-OBC/deciphered/0831/G_0831_乙3394合3238賓組.png`
- asset id: `asset-000735`
...
- English observation: `Two tall slightly curved verticals stand side by
  side, with a short inward diagonal near the middle and separated hooked or
  bowed continuations above and below.`
- 中文观察: `两条略弯的高长竖笔并列，中部附近有一条向内短斜笔，上下另见分离的钩曲或弓形延笔。`
...
- dataset label text: `㜵`
- dataset label codepoints: `U+3735`
...
- filename catalog route clues: `Heji-like filename clue: 合3238
...
- Which source records identify obs-char-000730 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000730？
