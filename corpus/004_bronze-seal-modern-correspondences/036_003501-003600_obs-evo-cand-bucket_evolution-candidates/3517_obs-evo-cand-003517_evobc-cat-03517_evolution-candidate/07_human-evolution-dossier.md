...
- External category reference: `evobc-cat-03517`
- Source category ID: `03517`
- Source label for human review: `操`
- Source codepoints: `U+64CD`
...
- `obs-evo-cand-003517-route-category-staging`
...
- `obs-evo-cand-003517-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003517-route-evolution-graph`
