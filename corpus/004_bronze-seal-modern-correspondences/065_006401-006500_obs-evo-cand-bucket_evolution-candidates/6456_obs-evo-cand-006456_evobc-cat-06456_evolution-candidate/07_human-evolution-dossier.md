...
- External category reference: `evobc-cat-06456`
- Source category ID: `06456`
- Source label for human review: `純`
- Source codepoints: `U+7D14`
- Image reference count in source metadata: `98`
...
- `obs-evo-cand-006456-route-category-staging`
...
- `obs-evo-cand-006456-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006456-route-evolution-graph`
