# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012739
...
- EVOBC candidate category: `evobc-evo-cat-12739`.
- Source label for search only: `𪈿`.
- Source codepoints for search only: `U+2A23F`.
