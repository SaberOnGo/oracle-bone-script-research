# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008208
...
- EVOBC candidate category: `evobc-evo-cat-08208`.
- Source label for search only: `詽`.
- Source codepoints for search only: `U+8A7D`.
