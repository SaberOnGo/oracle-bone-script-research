...
- External category reference: `evobc-cat-11505`
- Source category ID: `11505`
- Source label for human review: `𣬶`
...
- `obs-evo-cand-011505-route-category-staging`
...
- `obs-evo-cand-011505-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011505-route-evolution-graph`
