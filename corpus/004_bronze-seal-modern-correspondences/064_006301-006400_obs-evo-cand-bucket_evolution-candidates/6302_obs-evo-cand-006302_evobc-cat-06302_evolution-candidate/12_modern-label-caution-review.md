# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006302
...
- EVOBC candidate category: `evobc-evo-cat-06302`.
- Source label for search only: `箯`.
- Source codepoints for search only: `U+7BAF`.
