# obs-unk-004618 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/018_obs-unk-004618_h
  ust-obc-und-X-004618_oracle-character-candidate/03_visual-assets/001_asset
  -006211_hust-obc-und-X-004618_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/174/X_？_8349_1.png`
- asset id: `asset-006211`
...
- source class: `HUST-OBC/undeciphered/X/174/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/174/X_？_8349_1.png`
- asset id: `asset-006211`
...
- English observation: `high outer contour, central junction, inner trace`
- 中文观察: `高大外围轮廓、中央交接点和内部斜痕已记录。`
...
- Which source records identify obs-unk-004618 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004618？
