...
- Review log draft ID / 复核日志草稿 ID: `xxt-obm-access-review-log-draft-0002`
- Follow-up review task ID / 后续复核任务 ID: `xxt-obm-followup-review-0002`
...
- Targeted download ID / 目标下载 ID: `dl-xxt-obm-appendix02`
- Targeted URL / 目标 URL: `https://xiaoxue.iis.sinica.edu.tw/obm/Home/Appendix02`
