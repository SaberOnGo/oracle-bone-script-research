...
- External category reference: `evobc-cat-06303`
- Source category ID: `06303`
- Source label for human review: `箱`
- Source codepoints: `U+7BB1`
...
- `obs-evo-cand-006303-route-category-staging`
...
- `obs-evo-cand-006303-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006303-route-evolution-graph`
