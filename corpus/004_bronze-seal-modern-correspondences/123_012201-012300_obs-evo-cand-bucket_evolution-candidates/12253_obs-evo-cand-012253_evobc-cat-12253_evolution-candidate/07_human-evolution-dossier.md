...
- External category reference: `evobc-cat-12253`
- Source category ID: `12253`
- Source label for human review: `𧬨`
- Source codepoints: `U+27B28`
...
- `obs-evo-cand-012253-route-category-staging`
...
- `obs-evo-cand-012253-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012253-route-evolution-graph`
