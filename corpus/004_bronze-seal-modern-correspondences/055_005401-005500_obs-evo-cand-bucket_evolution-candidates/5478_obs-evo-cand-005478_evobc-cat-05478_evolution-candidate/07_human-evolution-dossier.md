...
- External category reference: `evobc-cat-05478`
- Source category ID: `05478`
- Source label for human review: `璨`
- Source codepoints: `U+74A8`
...
- `obs-evo-cand-005478-route-category-staging`
...
- `obs-evo-cand-005478-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005478-route-evolution-graph`
