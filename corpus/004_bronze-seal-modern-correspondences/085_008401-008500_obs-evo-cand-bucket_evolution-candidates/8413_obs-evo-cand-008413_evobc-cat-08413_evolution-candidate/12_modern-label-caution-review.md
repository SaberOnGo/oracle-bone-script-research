# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008413
...
- EVOBC candidate category: `evobc-evo-cat-08413`.
- Source label for search only: `访`.
- Source codepoints for search only: `U+8BBF`.
