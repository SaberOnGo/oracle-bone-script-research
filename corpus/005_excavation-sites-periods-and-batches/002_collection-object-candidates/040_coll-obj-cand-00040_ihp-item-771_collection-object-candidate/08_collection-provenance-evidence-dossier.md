# Collection Provenance Evidence Dossier / 馆藏来源证据档案: coll-obj-cand-00040
...
| source_row_id | `40` |
| object_page_url | `https://museum.sinica.edu.tw/en/collection/32/item/771/` |
...
| asset_id | `` |
| asset_path | `` |
| thumbnail_url | `https://museum.sinica.edu.tw/_upload/image/collection_item/thumbnail/115f488d1fb39b0.jpg` |
| source_image_url | `` |
...
| `source_collection_item_id` | `771` |
| `object_title_en` | `Inscribed Plastron I 5867+8202` |
| `catalog_reference_text` | `I 5867+8202` |
| `accession_number` | `` |
| `historical_period` | `` |
| `object_date` | `` |
| `provenience` | `` |
