...
- External category reference: `evobc-cat-08941`
- Source category ID: `08941`
- Source label for human review: `迈`
...
- `obs-evo-cand-008941-route-category-staging`
...
- `obs-evo-cand-008941-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008941-route-evolution-graph`
