...
- `obs-evo-cand-002678-route-category-staging`
...
- `obs-evo-cand-002678-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002678-route-evolution-graph`
