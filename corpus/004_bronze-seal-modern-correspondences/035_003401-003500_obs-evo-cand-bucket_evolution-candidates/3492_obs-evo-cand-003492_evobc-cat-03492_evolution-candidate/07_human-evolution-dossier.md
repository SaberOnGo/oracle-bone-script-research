...
- External category reference: `evobc-cat-03492`
- Source category ID: `03492`
- Source label for human review: `撅`
- Source codepoints: `U+6485`
...
- `obs-evo-cand-003492-route-category-staging`
...
- `obs-evo-cand-003492-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003492-route-evolution-graph`
