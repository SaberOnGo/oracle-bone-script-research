# obs-char-001198 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1198_obs-char-001198_hust-obc-cat-1339_ora
  cle-character/03_visual-assets/001_asset-001203_hust-obc-cat-1339_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1339/H_1339_60746_0.png`
- asset id: `asset-001203`
...
- source category: `1339`
- validation class: `1197`
- source image route: `HUST-OBC/deciphered/1339/H_1339_60746_0.png`
- asset id: `asset-001203`
...
- English observation: `A large dark branching form has a long descending
  left stroke, a broad upper junction, and two rightward projections.`
- 中文观察: `大型深色分枝形体有长下行左笔、宽大的上部连接处和两条向右外伸笔。`
...
- dataset label text: `㤱`
- dataset label codepoints: `U+3931`
...
- filename catalog route clues: `catalog-like filename clue: H_1339
  (H_1339_60746_0.png)`
...
- Which source records identify obs-char-001198 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001198？
