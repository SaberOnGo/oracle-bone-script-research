# obs-char-001082 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1082_obs-char-001082_hust-obc-cat-1211_ora
  cle-character/03_visual-assets/001_asset-001087_hust-obc-cat-1211_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1211/G_1211_七S132.png`
- asset id: `asset-001087`
...
- source category: `1211`
- validation class: `1081`
- source image route: `HUST-OBC/deciphered/1211/G_1211_七S132.png`
- asset id: `asset-001087`
...
- English observation: `A broad upper curved contour joins a central upright
  and several lower branching strokes.`
- 中文观察: `宽大的上部弯曲轮廓连接中央直立笔和数条下部分枝。`
...
- dataset label text: `㢱`
- dataset label codepoints: `U+38B1`
...
- Which source records identify obs-char-001082 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001082？
