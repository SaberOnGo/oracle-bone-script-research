# Material Visual Observation / obs-comp-cand-001431 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001431`
- External reference / 外部参照: `obimd-sub-zgocda0mov`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016008_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zgocda0mov/zgocda0mov/zgocda0mov.png`
- Checksum / 校验和:
  `01010d427778173c5ecb5c2f645decb8c19c4359afce8092195f4798215cc1b8`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.98%.
- Marked-pixel bounds: (77,18)–(178,231); span 102 × 214 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.98%。
- 痕迹范围：(77,18)–(178,231)；跨度102 × 214 px；痕迹矩形高于宽。
