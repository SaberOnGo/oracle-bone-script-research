...
- External category reference: `evobc-cat-07755`
- Source category ID: `07755`
- Source label for human review: `蛧`
- Source codepoints: `U+86E7`
...
- `obs-evo-cand-007755-route-category-staging`
...
- `obs-evo-cand-007755-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007755-route-evolution-graph`
