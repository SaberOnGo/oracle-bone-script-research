...
- External category reference: `evobc-cat-09761`
- Source category ID: `09761`
- Source label for human review: `隅`
...
- `obs-evo-cand-009761-route-category-staging`
...
- `obs-evo-cand-009761-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009761-route-evolution-graph`
