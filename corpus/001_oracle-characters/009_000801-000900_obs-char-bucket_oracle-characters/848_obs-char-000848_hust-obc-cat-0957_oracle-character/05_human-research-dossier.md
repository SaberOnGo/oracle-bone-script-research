# obs-char-000848 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/848_obs-char-000848_hust-obc-cat-0957_orac
  le-character/03_visual-assets/001_asset-000853_hust-obc-cat-0957_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0957/G_0957_佚678(甲).png`
- asset id: `asset-000853`
...
- source category: `0957`
- validation class: `847`
- source image route: `HUST-OBC/deciphered/0957/G_0957_佚678(甲).png`
- asset id: `asset-000853`
...
- dataset label text: `㞳`
- dataset label codepoints: `U+37B3`
...
- Which source records identify obs-char-000848 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000848？
