...
- External category reference: `evobc-cat-11815`
- Source category ID: `11815`
- Source label for human review: `𥙝`
...
- `obs-evo-cand-011815-route-category-staging`
...
- `obs-evo-cand-011815-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011815-route-evolution-graph`
