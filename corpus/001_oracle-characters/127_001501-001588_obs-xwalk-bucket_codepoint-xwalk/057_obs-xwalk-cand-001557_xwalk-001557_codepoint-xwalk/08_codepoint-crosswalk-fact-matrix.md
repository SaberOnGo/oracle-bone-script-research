...
|---|---|---|
| Source Codepoint Route | `U+3ACA` | not identity |
| HUST candidate route | `hust-obc-cat-1748` | not reading |
| OBIMD route | `pending route` | not component |
| EVOBC route | `evobc-evo-cat-00155` | not evolution |
| Source and rights trail | `source_marked_risk_noted` | source-marked risk note required |
| Missing evidence route | `matched_evobc_by_codepoint` | not decipherment |
