...
- External category reference: `evobc-cat-02274`
- Source category ID: `02274`
- Source label for human review: `嫧`
...
- `obs-evo-cand-002274-route-category-staging`
...
- `obs-evo-cand-002274-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002274-route-evolution-graph`
