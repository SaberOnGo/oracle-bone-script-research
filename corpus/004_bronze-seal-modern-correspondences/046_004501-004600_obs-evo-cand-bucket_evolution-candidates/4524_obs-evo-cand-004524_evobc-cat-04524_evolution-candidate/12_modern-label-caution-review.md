# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004524
...
- EVOBC candidate category: `evobc-evo-cat-04524`.
- Source label for search only: `汽`.
- Source codepoints for search only: `U+6C7D`.
