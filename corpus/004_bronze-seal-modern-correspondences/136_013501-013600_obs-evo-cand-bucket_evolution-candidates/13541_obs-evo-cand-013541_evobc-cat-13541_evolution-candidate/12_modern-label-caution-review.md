# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013541
...
- EVOBC candidate category: `evobc-evo-cat-13541`.
- Source label for search only: `𭤌`.
- Source codepoints for search only: `U+2D90C`.
