...
- Project ID: `obs-evo-cand-006465`
- EVOBC category candidate ID: `evobc-evo-cat-06465`
- External category reference: `evobc-cat-06465`
- Source category ID: `06465`
- Source label for human review: `紟`
- Source codepoints: `U+7D1F`
...
- `obs-evo-cand-006465-route-category-staging`
...
- `obs-evo-cand-006465-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006465-route-evolution-graph`
