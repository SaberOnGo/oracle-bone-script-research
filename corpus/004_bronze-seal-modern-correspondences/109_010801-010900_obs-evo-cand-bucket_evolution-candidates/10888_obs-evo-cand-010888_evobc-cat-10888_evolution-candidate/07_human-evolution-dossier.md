...
- External category reference: `evobc-cat-10888`
- Source category ID: `10888`
- Source label for human review: `𠧥`
- Source codepoints: `U+209E5`
...
- `obs-evo-cand-010888-route-category-staging`
...
- `obs-evo-cand-010888-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010888-route-evolution-graph`
