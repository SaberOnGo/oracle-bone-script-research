...
- External category reference: `evobc-cat-01505`
- Source category ID: `01505`
- Source label: `君`
- Source codepoints: `U+541B`
- Image reference count in source metadata: `418`
...
- `obs-evo-cand-001505-route-category-staging`
...
- `obs-evo-cand-001505-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-001505-route-evolution-graph`
