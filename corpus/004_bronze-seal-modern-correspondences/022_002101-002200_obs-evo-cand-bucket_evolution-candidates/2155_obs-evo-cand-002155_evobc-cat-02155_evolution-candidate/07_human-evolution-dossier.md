...
Project ID: `obs-evo-cand-002155`
...
- Project ID: `obs-evo-cand-002155`
- EVOBC category candidate ID: `evobc-evo-cat-02155`
- External category reference: `evobc-cat-02155`
- Source category ID: `02155`
- Source label for human review: `娅`
- Source codepoints: `U+5A05`
...
- `obs-evo-cand-002155-route-category-staging`
...
- `obs-evo-cand-002155-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002155-route-evolution-graph`
