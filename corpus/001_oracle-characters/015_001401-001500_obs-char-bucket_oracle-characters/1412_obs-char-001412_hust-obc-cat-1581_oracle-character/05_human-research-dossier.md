# obs-char-001412 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1412_obs-char-001412_hust-obc-cat-1581_ora
  cle-character/03_visual-assets/001_asset-001417_hust-obc-cat-1581_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1581/G_1581_甲骨文0.png`
- asset id: `asset-001417`
...
- source category: `1581`
- validation class: `1411`
- source image route: `HUST-OBC/deciphered/1581/G_1581_甲骨文0.png`
- asset id: `asset-001417`
...
- English observation: `A narrow upright form has a dark upper stroke and a
  long irregular lower stem.`
- 中文观察: `狭长直立形体有深色上部笔画和长不规则下部竖干。`
...
- dataset label text: `㨣`
- dataset label codepoints: `U+3A23`
...
- Which source records identify obs-char-001412 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001412？
