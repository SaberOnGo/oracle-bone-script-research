# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008612
...
- EVOBC candidate category: `evobc-evo-cat-08612`.
- Source label for search only: `贝`.
- Source codepoints for search only: `U+8D1D`.
