# obs-char-001460 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001460`
- primary external id: `hust-obc-cat-1637`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1460_obs-char-001460_hust-obc-cat-1637_ora
  cle-character/03_visual-assets/001_asset-001465_hust-obc-cat-1637_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1637/X_1637_2002_1.png`
- asset id: `asset-001465`
...
- source category: `1637`
- validation class: `1459`
- source image route: `HUST-OBC/deciphered/1637/X_1637_2002_1.png`
- asset id: `asset-001465`
...
- English observation: `A large dark upper form has inner openings, long
  lower curves, and a U-shaped base.`
- 中文观察: `大型深色上部形体有内部空隙、长下部弧线和U形底部。`
...
- dataset label text: `㩛`
- dataset label codepoints: `U+3A5B`
...
- Which source records identify obs-char-001460 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001460？
