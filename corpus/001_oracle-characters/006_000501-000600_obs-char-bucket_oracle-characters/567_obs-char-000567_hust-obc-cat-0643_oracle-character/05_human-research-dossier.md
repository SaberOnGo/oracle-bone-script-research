# obs-char-000567 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000567`
- primary external id: `hust-obc-cat-0643`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/567_obs-char-000567_hust-obc-cat-0643_orac
  le-character/03_visual-assets/001_asset-000572_hust-obc-cat-0643_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0643/G_0643_乙1931合9019.png`
- asset id: `asset-000572`
...
- source category: `0643`
- validation class: `566`
- source image route: `HUST-OBC/deciphered/0643/G_0643_乙1931合9019.png`
- asset id: `asset-000572`
...
- English observation: `A long thin vertical carries a short upper-right bar
  and ends below in a small pointed enclosure divided by several crossing
  strokes.`
...
- dataset label text: `㙹`
- dataset label codepoints: `U+3679`
...
- filename catalog route clues: `Heji-like filename clue: 合9019
  (G_0643_乙1931合9019.png)`
...
- Which source records identify obs-char-000567 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000567？
