...
- Project ID: `obs-evo-cand-001361`
- EVOBC category candidate ID: `evobc-evo-cat-01361`
- External category reference: `evobc-cat-01361`
- Source category ID: `01361`
- Source label for human review: `區`
- Source codepoints: `U+5340`
...
- `obs-evo-cand-001361-route-category-staging`
...
- `obs-evo-cand-001361-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001361-route-evolution-graph`
