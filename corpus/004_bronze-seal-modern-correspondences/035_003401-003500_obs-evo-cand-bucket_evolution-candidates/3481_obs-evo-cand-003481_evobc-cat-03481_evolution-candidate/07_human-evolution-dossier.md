...
- External category reference: `evobc-cat-03481`
- Source category ID: `03481`
- Source label for human review: `摭`
- Source codepoints: `U+646D`
...
- `obs-evo-cand-003481-route-category-staging`
...
- `obs-evo-cand-003481-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003481-route-evolution-graph`
