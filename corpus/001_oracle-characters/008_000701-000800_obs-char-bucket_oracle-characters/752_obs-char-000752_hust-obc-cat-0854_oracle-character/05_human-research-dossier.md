# obs-char-000752 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/752_obs-char-000752_hust-obc-cat-0854_orac
  le-character/03_visual-assets/001_asset-000757_hust-obc-cat-0854_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0854/G_0854_乙7160(甲).png`
- asset id: `asset-000757`
...
- source category: `0854`
- validation class: `751`
- source image route: `HUST-OBC/deciphered/0854/G_0854_乙7160(甲).png`
- asset id: `asset-000757`
...
- dataset label text: `㝌`
- dataset label codepoints: `U+374C`
...
- Which source records identify obs-char-000752 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000752？
