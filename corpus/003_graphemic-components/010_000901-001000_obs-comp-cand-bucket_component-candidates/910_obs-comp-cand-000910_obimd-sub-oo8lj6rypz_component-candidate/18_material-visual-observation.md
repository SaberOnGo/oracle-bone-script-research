# Material Visual Observation / obs-comp-cand-000910 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000910`
- External reference / 外部参照: `obimd-sub-oo8lj6rypz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013982_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/sdos1cdyy4/oo8lj6rypz/oo8lj6rypz.png`
- Checksum / 校验和:
  `044a243dfa64233a42e47504e82f9dcd383dc5702d4b4d8d92d9e52454951e9e`
...
- Marked-pixel bounds: (85,35)–(164,215); span 80 × 181 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.52%。
- 痕迹范围：(85,35)–(164,215)；跨度80 × 181 px；痕迹矩形高于宽。
