# obs-unk-004931 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004931`
- primary external id: `hust-obc-und-X-004931`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/031_obs-unk-004931_h
  ust-obc-und-X-004931_oracle-character-candidate/03_visual-assets/001_asset
  -006524_hust-obc-und-X-004931_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/487/X_？_7471_1.png`
- asset id: `asset-006524`
...
- Two upper openings lead into a long lower stroke and branches.
...
- source class: `HUST-OBC/undeciphered/X/487/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/487/X_？_7471_1.png`
- asset id: `asset-006524`
...
- Which source records identify obs-unk-004931 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004931？
