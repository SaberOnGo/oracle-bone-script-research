...
- External category reference: `evobc-cat-07981`
- Source category ID: `07981`
- Source label: `裞`
...
- `obs-evo-cand-007981-route-category-staging`
...
- `obs-evo-cand-007981-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-007981-route-evolution-graph`
