...
- External category reference: `evobc-cat-13263`
- Source category ID: `13263`
- Source label for human review: `𬑽`
- Source codepoints: `U+2C47D`
...
- `obs-evo-cand-013263-route-category-staging`
...
- `obs-evo-cand-013263-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013263-route-evolution-graph`
