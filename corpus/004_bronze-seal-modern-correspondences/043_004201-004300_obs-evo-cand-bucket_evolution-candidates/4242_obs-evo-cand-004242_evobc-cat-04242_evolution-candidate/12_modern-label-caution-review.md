# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004242
...
- EVOBC candidate category: `evobc-evo-cat-04242`.
- Source label for search only: `樜`.
- Source codepoints for search only: `U+6A1C`.
