...
- External category reference: `evobc-cat-11918`
- Source category ID: `11918`
- Source label for human review: `𥹧`
...
- `obs-evo-cand-011918-route-category-staging`
...
- `obs-evo-cand-011918-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011918-route-evolution-graph`
