# obs-unk-003886 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003886`
- primary external id: `hust-obc-und-L-003886`
...
- local review image route: `corpus/001_oracle-characters/055_undeciphered-003
  801-003900_obs-unk-bucket_oracle-character-candidates/086_obs-unk-003886_h
  ust-obc-und-L-003886_oracle-character-candidate/03_visual-assets/001_asset
  -005479_hust-obc-und-L-003886_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3886/L_？_8166.jpg`
- asset id: `asset-005479`
...
- source class: `HUST-OBC/undeciphered/L/3886/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3886/L_？_8166.jpg`
- asset id: `asset-005479`
...
- Which source records identify obs-unk-003886 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003886？
