...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000153` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y842` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `159` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `605` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `40162` [route_present_image_or_text_not_collected]
