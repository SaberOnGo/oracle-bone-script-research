# Material Visual Observation / obs-comp-cand-000544 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000544`
- External reference / 外部参照: `obimd-sub-446qjw4xgi`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012778_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/446qjw4xgi/446qjw4xgi/446qjw4xgi.png`
- Checksum / 校验和:
  `20c8859c4caa442876b26b4ff8d1d6da8a52967166987c6ef08522ac24ea2aca`
...
- Marked-pixel bounds: (87,12)–(162,233); span 76 × 222 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.15%。
- 痕迹范围：(87,12)–(162,233)；跨度76 × 222 px；痕迹矩形高于宽。
