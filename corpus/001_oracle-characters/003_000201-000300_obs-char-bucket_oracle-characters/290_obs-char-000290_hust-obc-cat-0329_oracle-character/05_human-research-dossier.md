# obs-char-000290 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000290`
- primary external id: `hust-obc-cat-0329`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/290_obs-char-000290_hust-obc-cat-0329_orac
  le-character/03_visual-assets/001_asset-000295_hust-obc-cat-0329_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0329/G_0329_乙1425(甲).png`
- asset id: `asset-000295`
...
- source category: `0329`
- validation class: `289`
- source image route: `HUST-OBC/deciphered/0329/G_0329_乙1425(甲).png`
- asset id: `asset-000295`
...
- English observation: `The compact image has an upper rounded arch and a
  lower rounded enclosure with a short horizontal interior mark, separated
  by a narrow gap.`
- 中文观察: `紧凑图像上部为圆弧拱形，下部为带短内横画的圆弧闭合轮廓，中间有狭窄间隔。`
...
- dataset label text: `㔿`
- dataset label codepoints: `U+353F`
...
- Which source records identify obs-char-000290 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000290？
