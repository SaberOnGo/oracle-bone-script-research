# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008173
...
- EVOBC candidate category: `evobc-evo-cat-08173`.
- Source label for search only: `詎`.
- Source codepoints for search only: `U+8A4E`.
