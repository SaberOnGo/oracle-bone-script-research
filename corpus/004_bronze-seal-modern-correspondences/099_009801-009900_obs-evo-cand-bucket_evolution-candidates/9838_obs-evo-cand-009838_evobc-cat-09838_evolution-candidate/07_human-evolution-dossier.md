...
Project ID: `obs-evo-cand-009838`
...
- Project ID: `obs-evo-cand-009838`
- EVOBC category candidate ID: `evobc-evo-cat-09838`
- External category reference: `evobc-cat-09838`
- Source category ID: `09838`
- Source label for human review: `雱`
- Source codepoints: `U+96F1`
...
- `obs-evo-cand-009838-route-category-staging`
...
- `obs-evo-cand-009838-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009838-route-evolution-graph`
