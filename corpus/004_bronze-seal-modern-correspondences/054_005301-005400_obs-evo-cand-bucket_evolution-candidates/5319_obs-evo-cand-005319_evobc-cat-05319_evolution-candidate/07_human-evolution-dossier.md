...
- External category reference: `evobc-cat-05319`
- Source category ID: `05319`
- Source label for human review: `獞`
- Source codepoints: `U+735E`
...
- `obs-evo-cand-005319-route-category-staging`
...
- `obs-evo-cand-005319-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005319-route-evolution-graph`
