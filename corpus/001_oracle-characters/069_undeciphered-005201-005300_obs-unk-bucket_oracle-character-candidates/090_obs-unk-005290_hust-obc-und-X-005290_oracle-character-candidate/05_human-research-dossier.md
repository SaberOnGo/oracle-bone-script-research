# obs-unk-005290 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/069_undeciphered-005
  201-005300_obs-unk-bucket_oracle-character-candidates/090_obs-unk-005290_h
  ust-obc-und-X-005290_oracle-character-candidate/03_visual-assets/001_asset
  -006883_hust-obc-und-X-005290_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/846/X_？_7810_1.png`
- asset id: `asset-006883`
...
- source class: `HUST-OBC/undeciphered/X/846/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/846/X_？_7810_1.png`
- asset id: `asset-006883`
...
- Which source records identify obs-unk-005290 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005290？
