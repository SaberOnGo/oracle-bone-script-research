...
- External category reference: `evobc-cat-12168`
- Source category ID: `12168`
- Source label for human review: `𧒎`
- Source codepoints: `U+2748E`
...
- `obs-evo-cand-012168-route-category-staging`
...
- `obs-evo-cand-012168-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012168-route-evolution-graph`
