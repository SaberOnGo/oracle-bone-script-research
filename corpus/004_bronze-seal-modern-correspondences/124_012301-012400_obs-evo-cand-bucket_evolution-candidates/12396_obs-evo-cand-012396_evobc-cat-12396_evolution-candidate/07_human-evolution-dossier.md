...
- External category reference: `evobc-cat-12396`
- Source category ID: `12396`
- Source label for human review: `𨙫`
- Source codepoints: `U+2866B`
...
- `obs-evo-cand-012396-route-category-staging`
...
- `obs-evo-cand-012396-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012396-route-evolution-graph`
