# obs-char-000899 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000899`
- primary external id: `hust-obc-cat-1013`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/899_obs-char-000899_hust-obc-cat-1013_orac
  le-character/03_visual-assets/001_asset-000904_hust-obc-cat-1013_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1013/G_1013_甲骨文.png`
- asset id: `asset-000904`
...
- source category: `1013`
- validation class: `898`
- source image route: `HUST-OBC/deciphered/1013/G_1013_甲骨文.png`
- asset id: `asset-000904`
...
- English observation: `Two short upright strokes above a broad open curve
  form the main structure; a short right projection extends from the lower
  curve.`
- 中文观察: `两条上方短直立笔位于宽大开放弯笔之上构成主体；下弯笔右侧伸出短笔。`
...
- dataset label text: `㟫`
- dataset label codepoints: `U+37EB`
...
- Which source records identify obs-char-000899 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000899？
