# Material Visual Observation / obs-comp-cand-002571 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002571`
- External reference / 外部参照: `obimd-sub-dsv4lhwhn7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021103_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dsv4lhwhn7/dsv4lhwhn7/dsv4lhwhn7.png`
- Checksum / 校验和:
  `988d7b6789e34189b2d462f7980b0d40270633b77691b50da4348405e12ea65a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.33%.
- Marked-pixel bounds: (56,67)–(201,200); span 146 × 134 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.33%。
- 痕迹范围：(56,67)–(201,200)；跨度146 × 134 px；痕迹矩形近方形。
