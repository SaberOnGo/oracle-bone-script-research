# obs-char-000541 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000541`
- primary external id: `hust-obc-cat-0615`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/541_obs-char-000541_hust-obc-cat-0615_orac
  le-character/03_visual-assets/001_asset-000546_hust-obc-cat-0615_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0615/G_0615_前2.12.4合36842黃組.png
  `
- asset id: `asset-000546`
...
- source category: `0615`
- validation class: `540`
- source image route: `HUST-OBC/deciphered/0615/G_0615_前2.12.4合36842黃組.png`
- asset id: `asset-000546`
...
- English observation: `A pointed upper oval contains a horizontal divider
  and narrows into a central stem; a lower crossbar supports three long
  descending strokes.`
- 中文观察: `尖顶上部椭圆内有一条横向分隔，并收窄为中央干；下部横栏带三条长下垂笔。`
...
- dataset label text: `㙝`
- dataset label codepoints: `U+365D`
...
- filename catalog route clues: `Heji-like filename clue: 合36842
  (G_0615_前2.12.4合36842黃組.png)`
...
- Which source records identify obs-char-000541 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000541？
