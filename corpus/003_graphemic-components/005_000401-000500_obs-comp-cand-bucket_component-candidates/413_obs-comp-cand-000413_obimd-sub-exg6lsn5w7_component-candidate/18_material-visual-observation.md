# Material Visual Observation / obs-comp-cand-000413 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000413`
- External reference / 外部参照: `obimd-sub-exg6lsn5w7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012336_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/exg6lsn5w7/exg6lsn5w7/exg6lsn5w7.png`
- Checksum / 校验和:
  `a97814aaa1842d3fd6f8d5c5de0f6a70f4b9515c4457335e4029304f0f6086c3`
...
- Marked-pixel bounds: (78,16)–(171,233); span 94 × 218 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.96%。
- 痕迹范围：(78,16)–(171,233)；跨度94 × 218 px；痕迹矩形高于宽。
