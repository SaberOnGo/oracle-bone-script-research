...
- Project ID: `obs-evo-cand-006850`
- EVOBC category candidate ID: `evobc-evo-cat-06850`
- External category reference: `evobc-cat-06850`
- Source category ID: `06850`
- Source label for human review: `羞`
- Source codepoints: `U+7F9E`
- Image reference count in source metadata: `114`
...
- `obs-evo-cand-006850-route-category-staging`
...
- `obs-evo-cand-006850-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006850-route-evolution-graph`
