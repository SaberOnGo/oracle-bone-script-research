# obs-char-000677 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000677`
- primary external id: `hust-obc-cat-0768`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/677_obs-char-000677_hust-obc-cat-0768_orac
  le-character/03_visual-assets/001_asset-000682_hust-obc-cat-0768_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0768/G_0768_佚697合7652.png`
- asset id: `asset-000682`
...
- source category: `0768`
- validation class: `676`
- source image route: `HUST-OBC/deciphered/0768/G_0768_佚697合7652.png`
- asset id: `asset-000682`
...
- English observation: `An irregular rounded upper outline contains a small
  oval opening at left and a hooked right side; a detached pointed
  triangular outline hangs below.`
- 中文观察: `不规则圆弯上轮廓含左侧小椭圆空隙和钩曲右边，下方悬有分离尖三角轮廓。`
...
- dataset label text: `㛶`
- dataset label codepoints: `U+36F6`
...
- filename catalog route clues: `Heji-like filename clue: 合7652
  (G_0768_佚697合7652.png)`
...
- Which source records identify obs-char-000677 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000677？
