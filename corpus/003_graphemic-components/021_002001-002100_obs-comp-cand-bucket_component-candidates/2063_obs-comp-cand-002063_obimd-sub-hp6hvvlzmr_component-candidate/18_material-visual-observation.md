# Material Visual Observation / obs-comp-cand-002063 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002063`
- External reference / 外部参照: `obimd-sub-hp6hvvlzmr`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019450_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zr3h63w2fy/hp6hvvlzmr/hp6hvvlzmr.png`
- Checksum / 校验和:
  `1c2ea26ee6bc8789f4141dac51224645458102bc1cc006e46bca3dde14654b53`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.67%.
- Marked-pixel bounds: (88,18)–(172,231); span 85 × 214 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.67%。
- 痕迹范围：(88,18)–(172,231)；跨度85 × 214 px；痕迹矩形高于宽。
