...
- External category reference: `evobc-cat-12320`
- Source category ID: `12320`
- Source label for human review: `𨈢`
- Source codepoints: `U+28222`
...
- `obs-evo-cand-012320-route-category-staging`
...
- `obs-evo-cand-012320-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012320-route-evolution-graph`
