...
- External category reference: `evobc-cat-03769`
- Source category ID: `03769`
- Source label for human review: `暆`
- Source codepoints: `U+6686`
...
- `obs-evo-cand-003769-route-category-staging`
...
- `obs-evo-cand-003769-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003769-route-evolution-graph`
