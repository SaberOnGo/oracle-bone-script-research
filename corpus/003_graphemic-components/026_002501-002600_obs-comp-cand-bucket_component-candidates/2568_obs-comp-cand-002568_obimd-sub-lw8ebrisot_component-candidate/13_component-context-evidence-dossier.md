# obs-comp-cand-002568 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002568`
- 首选外部 ID: `obimd-sub-lw8ebrisot`
- OBIMD subcharacter UID: `lw8ebrisot`
...
- codepoint 示例: U+FE90C; U+FE90D; 另有 10 项
