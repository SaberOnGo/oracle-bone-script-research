...
- External category reference: `evobc-cat-09727`
- Source category ID: `09727`
- Source label for human review: `陔`
- Source codepoints: `U+9654`
...
- `obs-evo-cand-009727-route-category-staging`
...
- `obs-evo-cand-009727-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009727-route-evolution-graph`
