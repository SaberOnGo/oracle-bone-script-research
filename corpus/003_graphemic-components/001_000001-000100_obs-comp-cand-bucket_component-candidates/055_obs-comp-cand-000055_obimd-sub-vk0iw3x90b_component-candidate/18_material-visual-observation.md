# Material Visual Observation / obs-comp-cand-000055 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000055`
- External reference / 外部参照: `obimd-sub-vk0iw3x90b`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011468_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vk0iw3x90b/vk0iw3x90b/vk0iw3x90b.png`
- Checksum / 校验和:
  `9759d095ac59f8b8594bc7efe8b4d4d78177a39107e7f29630008362884a56f3`
...
- Marked-pixel bounds: (76,40)–(173,199); span 98 × 160 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.49%。
- 痕迹范围：(76,40)–(173,199)；跨度98 × 160 px；痕迹矩形高于宽。
