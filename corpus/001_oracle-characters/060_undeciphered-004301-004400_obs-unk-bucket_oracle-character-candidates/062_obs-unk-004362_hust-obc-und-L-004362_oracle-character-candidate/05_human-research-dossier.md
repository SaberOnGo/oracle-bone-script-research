# obs-unk-004362 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004362`
- primary external id: `hust-obc-und-L-004362`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/062_obs-unk-004362_h
  ust-obc-und-L-004362_oracle-character-candidate/03_visual-assets/001_asset
  -005955_hust-obc-und-L-004362_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4362/L_？_9672.jpg`
- asset id: `asset-005955`
...
- source class: `HUST-OBC/undeciphered/L/4362/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4362/L_？_9672.jpg`
- asset id: `asset-005955`
...
- English observation: `Left diagonal trace, central cluster, and right`
  `terminal recorded.`
- 中文观察: `已记录左侧斜痕、中央痕簇和右侧末端。`
...
- Which source records identify obs-unk-004362 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004362？
