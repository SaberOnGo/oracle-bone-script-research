...
- `obs-evo-cand-007952-route-category-staging`
...
- `obs-evo-cand-007952-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007952-route-evolution-graph`
