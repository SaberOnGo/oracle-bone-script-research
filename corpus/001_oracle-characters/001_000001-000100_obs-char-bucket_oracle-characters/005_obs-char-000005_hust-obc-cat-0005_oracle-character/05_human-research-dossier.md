# obs-char-000005 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000005`
- primary external id: `hust-obc-cat-0005`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/005_obs-char-000005_hust-obc-cat-0005_orac
  le-character/03_visual-assets/001_asset-000010_hust-obc-cat-0005_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0005/G_0005_甲1170合31823無名組.png`
- asset id: `asset-000010`
...
- source category: `0005`
- validation class: `4`
- source image route: `HUST-OBC/deciphered/0005/G_0005_甲1170合31823無名組.png`
- asset id: `asset-000010`
...
- English observation: `The image shows paired curved outer strokes with
  shorter marks between them; the right edge is more strongly curved.`
- 中文观察: `图像可见成对弯曲外笔画，中间夹有短痕；右侧边缘的弯曲更明显。`
...
- dataset label text: `⺌`
- dataset label codepoints: `U+2E8C`
...
- filename catalog route clues: `Heji-like filename clue: 合31823
  (G_0005_甲1170合31823無名組.png)`
...
- Which source records identify obs-char-000005 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000005？
