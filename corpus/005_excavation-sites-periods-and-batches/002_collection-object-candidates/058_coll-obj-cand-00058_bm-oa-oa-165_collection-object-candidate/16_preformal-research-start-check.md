# Preformal Research Start Check / 正式研究开始前开包核查: coll-obj-cand-00058
...
| --- | --- | --- |
| 1 | `02_collection-source-index.csv` | `OA+.165` |
| 2 | `04_visual-gallery.md` | `no_committed_visual_asset` |
...
- 不确认卜辞身份或释文
- 不接受释读、构件归属或断代结论
- candidate_collection_object_id: `bm-oa-165-object-candidate`
