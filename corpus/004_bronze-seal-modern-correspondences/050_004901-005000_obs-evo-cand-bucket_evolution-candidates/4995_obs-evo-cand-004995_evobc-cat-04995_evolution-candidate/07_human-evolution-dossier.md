...
- External category reference: `evobc-cat-04995`
- Source category ID: `04995`
- Source label for human review: `瀣`
...
- `obs-evo-cand-004995-route-category-staging`
...
- `obs-evo-cand-004995-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004995-route-evolution-graph`
