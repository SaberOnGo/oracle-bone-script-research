...
- Project ID: `obs-evo-cand-010025`
- EVOBC category candidate ID: `evobc-evo-cat-10025`
- External category reference: `evobc-cat-10025`
- Source category ID: `10025`
- Source label for human review: `顛`
- Source codepoints: `U+985B`
...
- `obs-evo-cand-010025-route-category-staging`
...
- `obs-evo-cand-010025-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010025-route-evolution-graph`
