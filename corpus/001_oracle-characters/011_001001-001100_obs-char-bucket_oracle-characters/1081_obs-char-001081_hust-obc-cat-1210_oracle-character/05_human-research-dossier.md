# obs-char-001081 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001081`
- primary external id: `hust-obc-cat-1210`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1081_obs-char-001081_hust-obc-cat-1210_ora
  cle-character/03_visual-assets/001_asset-001086_hust-obc-cat-1210_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1210/G_1210_合30178無名組.png`
- asset id: `asset-001086`
...
- source category: `1210`
- validation class: `1080`
- source image route: `HUST-OBC/deciphered/1210/G_1210_合30178無名組.png`
- asset id: `asset-001086`
...
- English observation: `A narrow vertical form has a short upper branch, a
  central crossing, and two long lower strokes.`
- 中文观察: `狭长竖向形体有短上部分枝、中央交叉和两条长下部笔。`
...
- dataset label text: `㢰`
- dataset label codepoints: `U+38B0`
...
- filename catalog route clues: `Heji-like filename clue: 合30178
  (G_1210_合30178無名組.png)`
...
- Which source records identify obs-char-001081 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001081？
