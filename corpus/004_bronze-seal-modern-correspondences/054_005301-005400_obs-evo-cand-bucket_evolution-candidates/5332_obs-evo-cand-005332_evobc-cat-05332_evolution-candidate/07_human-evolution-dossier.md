...
- External category reference: `evobc-cat-05332`
- Source category ID: `05332`
- Source label for human review: `獶`
- Source codepoints: `U+7376`
...
- `obs-evo-cand-005332-route-category-staging`
...
- `obs-evo-cand-005332-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005332-route-evolution-graph`
