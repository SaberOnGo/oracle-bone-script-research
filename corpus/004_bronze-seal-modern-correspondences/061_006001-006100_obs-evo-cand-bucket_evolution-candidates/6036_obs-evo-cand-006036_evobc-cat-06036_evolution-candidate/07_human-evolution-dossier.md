...
- External category reference: `evobc-cat-06036`
- Source category ID: `06036`
- Source label for human review: `禮`
- Source codepoints: `U+79AE`
...
- `obs-evo-cand-006036-route-category-staging`
...
- `obs-evo-cand-006036-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006036-route-evolution-graph`
