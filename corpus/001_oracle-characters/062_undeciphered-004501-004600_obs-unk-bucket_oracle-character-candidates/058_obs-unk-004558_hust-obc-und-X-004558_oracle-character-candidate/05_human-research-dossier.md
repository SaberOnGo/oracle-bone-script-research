# obs-unk-004558 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/058_obs-unk-004558_h
  ust-obc-und-X-004558_oracle-character-candidate/03_visual-assets/001_asset
  -006151_hust-obc-und-X-004558_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/114/X_？_7212_1.png`
- asset id: `asset-006151`
...
- source class: `HUST-OBC/undeciphered/X/114/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/114/X_？_7212_1.png`
- asset id: `asset-006151`
...
- English observation: `Upper curve, lower loop, and branching traces recorded.`
- 中文观察: `已记录上部弯痕、下部环痕和分支。`
...
- Which source records identify obs-unk-004558 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004558？
