...
Project ID: `obs-evo-cand-001964`
...
- Project ID: `obs-evo-cand-001964`
- EVOBC category candidate ID: `evobc-evo-cat-01964`
- External category reference: `evobc-cat-01964`
- Source category ID: `01964`
- Source label for human review: `壛`
- Source codepoints: `U+58DB`
...
- `obs-evo-cand-001964-route-category-staging`
...
- `obs-evo-cand-001964-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001964-route-evolution-graph`
