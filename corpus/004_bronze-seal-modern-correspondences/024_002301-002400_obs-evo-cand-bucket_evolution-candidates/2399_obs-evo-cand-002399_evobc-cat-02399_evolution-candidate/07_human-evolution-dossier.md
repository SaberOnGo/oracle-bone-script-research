...
- External category reference: `evobc-cat-02399`
- Source category ID: `02399`
- Source label for human review: `宷`
...
- `obs-evo-cand-002399-route-category-staging`
...
- `obs-evo-cand-002399-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002399-route-evolution-graph`
