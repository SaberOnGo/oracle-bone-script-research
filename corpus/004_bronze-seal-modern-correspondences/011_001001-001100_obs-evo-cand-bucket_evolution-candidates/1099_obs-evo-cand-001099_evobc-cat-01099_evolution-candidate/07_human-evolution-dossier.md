...
- External category reference: `evobc-cat-01099`
- Source category ID: `01099`
- Source label for human review: `其`
- Source codepoints: `U+5176`
- Image reference count in source metadata: `152`
...
- `obs-evo-cand-001099-route-category-staging`
...
- `obs-evo-cand-001099-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001099-route-evolution-graph`
