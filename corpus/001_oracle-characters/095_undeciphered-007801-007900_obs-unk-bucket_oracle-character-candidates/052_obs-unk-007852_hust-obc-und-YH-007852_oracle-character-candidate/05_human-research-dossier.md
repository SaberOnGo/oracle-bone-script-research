# obs-unk-007852 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-007852`
- primary external id: `hust-obc-und-YH-007852`
...
- local review image route: `corpus/001_oracle-characters/095_undeciphered-007
  801-007900_obs-unk-bucket_oracle-character-candidates/052_obs-unk-007852_h
  ust-obc-und-YH-007852_oracle-character-candidate/03_visual-assets/001_asse
  t-009443_hust-obc-und-YH-007852_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/603F7/H_？_603F7_0.png`
- asset id: `asset-009443`
...
- source class: `HUST-OBC/undeciphered/Y+H/603F7/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/603F7/H_？_603F7_0.png`
- asset id: `asset-009443`
...
- Which source records identify obs-unk-007852 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007852？
