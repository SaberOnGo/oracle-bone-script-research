...
- External category reference: `evobc-cat-09862`
- Source category ID: `09862`
- Source label for human review: `霚`
- Source codepoints: `U+971A`
...
- `obs-evo-cand-009862-route-category-staging`
...
- `obs-evo-cand-009862-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009862-route-evolution-graph`
