...
- External category reference: `evobc-cat-04690`
- Source category ID: `04690`
- Source label: `涩`
...
- `obs-evo-cand-004690-route-category-staging`
...
- `obs-evo-cand-004690-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004690-route-evolution-graph`
