# Material Visual Observation / obs-comp-cand-001777 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001777`
- External reference / 外部参照: `obimd-sub-hzqkqnkpuv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017978_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8sbbzthl9w/hzqkqnkpuv/hzqkqnkpuv.png`
- Checksum / 校验和:
  `cfffdb2ccf4181c598634ee2d896d0c966426dfa968f8d8317eb043ff70644bd`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.84%.
- Marked-pixel bounds: (80,39)–(168,210); span 89 × 172 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.84%。
- 痕迹范围：(80,39)–(168,210)；跨度89 × 172 px；痕迹矩形高于宽。
