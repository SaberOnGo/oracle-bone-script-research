# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004330
...
- EVOBC candidate category: `evobc-evo-cat-04330`.
- Source label for search only: `權`.
- Source codepoints for search only: `U+6B0A`.
