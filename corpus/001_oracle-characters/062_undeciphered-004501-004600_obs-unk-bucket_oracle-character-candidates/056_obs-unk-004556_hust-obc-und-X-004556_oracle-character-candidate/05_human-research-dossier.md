# obs-unk-004556 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004556`
- primary external id: `hust-obc-und-X-004556`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/056_obs-unk-004556_h
  ust-obc-und-X-004556_oracle-character-candidate/03_visual-assets/001_asset
  -006149_hust-obc-und-X-004556_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/112/X_？_8294_1.png`
- asset id: `asset-006149`
...
- source class: `HUST-OBC/undeciphered/X/112/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/112/X_？_8294_1.png`
- asset id: `asset-006149`
...
- English observation: `Upper cap, interior mark, and lower outline recorded.`
- 中文观察: `已记录上部帽状轮廓、内部痕迹和下部轮廓。`
...
- Which source records identify obs-unk-004556 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004556？
