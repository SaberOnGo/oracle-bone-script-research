...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1226`
...
- Source image / 来源图: `G_1226_合387反(甲).png`
- Image / 图像: `001_asset-001102_hust-obc-cat-1226_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合387
  (G_1226_合387反(甲).png)`
...
- Source label text / 来源标签文字: `㣀`
- Source label codepoint / 来源标签 codepoint: `U+38C0`
