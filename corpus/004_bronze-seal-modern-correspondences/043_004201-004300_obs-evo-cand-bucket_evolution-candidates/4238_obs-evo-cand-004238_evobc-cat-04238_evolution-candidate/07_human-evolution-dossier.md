...
- External category reference: `evobc-cat-04238`
- Source category ID: `04238`
- Source label for human review: `樗`
...
- `obs-evo-cand-004238-route-category-staging`
...
- `obs-evo-cand-004238-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004238-route-evolution-graph`
