...
Project ID: `obs-evo-cand-003178`
...
- Project ID: `obs-evo-cand-003178`
- EVOBC category candidate ID: `evobc-evo-cat-03178`
- External category reference: `evobc-cat-03178`
- Source category ID: `03178`
- Source label for human review: `懕`
- Source codepoints: `U+61D5`
...
- `obs-evo-cand-003178-route-category-staging`
...
- `obs-evo-cand-003178-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003178-route-evolution-graph`
