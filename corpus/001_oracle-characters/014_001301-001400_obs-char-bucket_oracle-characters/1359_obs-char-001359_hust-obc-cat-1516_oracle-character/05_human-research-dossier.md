# obs-char-001359 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001359`
- primary external id: `hust-obc-cat-1516`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1359_obs-char-001359_hust-obc-cat-1516_ora
  cle-character/03_visual-assets/001_asset-001364_hust-obc-cat-1516_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1516/X_1516_6219_1.png`
- asset id: `asset-001364`
...
- source category: `1516`
- validation class: `1358`
- source image route: `HUST-OBC/deciphered/1516/X_1516_6219_1.png`
- asset id: `asset-001364`
...
- English observation: `A large upper form has a broad horizontal crossing
  and several lower branches, with a separate curved stroke below left.`
- 中文观察: `大型上部形体有宽大水平交叉笔和数条下部分枝，左下另有分离弧线。`
...
- dataset label text: `㧢`
- dataset label codepoints: `U+39E2`
...
- Which source records identify obs-char-001359 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001359？
