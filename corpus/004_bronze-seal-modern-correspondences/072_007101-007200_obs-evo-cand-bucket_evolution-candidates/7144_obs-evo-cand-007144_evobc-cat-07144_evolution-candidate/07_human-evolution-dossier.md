...
Project ID: `obs-evo-cand-007144`
...
- Project ID: `obs-evo-cand-007144`
- EVOBC category candidate ID: `evobc-evo-cat-07144`
- External category reference: `evobc-cat-07144`
- Source category ID: `07144`
- Source label for human review: `臀`
- Source codepoints: `U+81C0`
...
- `obs-evo-cand-007144-route-category-staging`
...
- `obs-evo-cand-007144-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007144-route-evolution-graph`
