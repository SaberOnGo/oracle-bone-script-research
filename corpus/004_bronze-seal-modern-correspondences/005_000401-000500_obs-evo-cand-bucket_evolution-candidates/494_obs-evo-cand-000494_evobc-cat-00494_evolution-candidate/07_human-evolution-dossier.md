...
- External category reference: `evobc-cat-00494`
- Source category ID: `00494`
- Source label for human review: `䣍`
...
- `obs-evo-cand-000494-route-category-staging`
...
- `obs-evo-cand-000494-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000494-route-evolution-graph`
