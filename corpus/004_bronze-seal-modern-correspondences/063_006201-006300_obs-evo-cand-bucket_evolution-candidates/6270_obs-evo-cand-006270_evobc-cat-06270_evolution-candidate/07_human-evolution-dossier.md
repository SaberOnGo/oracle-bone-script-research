...
- External category reference: `evobc-cat-06270`
- Source category ID: `06270`
- Source label for human review: `筤`
...
- `obs-evo-cand-006270-route-category-staging`
...
- `obs-evo-cand-006270-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006270-route-evolution-graph`
