...
- External category reference: `evobc-cat-00055`
- Source category ID: `00055`
- Source label for human review: `㛙`
- Source codepoints: `U+36D9`
...
- `obs-evo-cand-000055-route-category-staging`
...
- `obs-evo-cand-000055-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000055-route-evolution-graph`
