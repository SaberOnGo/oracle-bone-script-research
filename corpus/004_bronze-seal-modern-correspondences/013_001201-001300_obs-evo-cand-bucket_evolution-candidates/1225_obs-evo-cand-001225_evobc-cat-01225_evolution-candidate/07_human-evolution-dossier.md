...
- External category reference: `evobc-cat-01225`
- Source category ID: `01225`
- Source label for human review: `剔`
...
- `obs-evo-cand-001225-route-category-staging`
...
- `obs-evo-cand-001225-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001225-route-evolution-graph`
