...
- `obs-evo-cand-000070-route-category-staging`
...
- `obs-evo-cand-000070-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000070-route-evolution-graph`
