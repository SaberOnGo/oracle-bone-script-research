...
- External category reference: `evobc-cat-06330`
- Source category ID: `06330`
- Source label for human review: `篰`
...
- `obs-evo-cand-006330-route-category-staging`
...
- `obs-evo-cand-006330-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006330-route-evolution-graph`
