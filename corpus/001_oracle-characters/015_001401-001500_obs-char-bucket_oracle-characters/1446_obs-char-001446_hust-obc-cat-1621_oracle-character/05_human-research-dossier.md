# obs-char-001446 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001446`
- primary external id: `hust-obc-cat-1621`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1446_obs-char-001446_hust-obc-cat-1621_ora
  cle-character/03_visual-assets/001_asset-001451_hust-obc-cat-1621_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1621/X_1621_1293_1.png`
- asset id: `asset-001451`
...
- source category: `1621`
- validation class: `1445`
- source image route: `HUST-OBC/deciphered/1621/X_1621_1293_1.png`
- asset id: `asset-001451`
...
- English observation: `A large rounded outer contour contains an inner
  enclosure and side branches.`
- 中文观察: `大型圆拱外轮廓内部有框形和侧部分枝。`
...
- dataset label text: `㩋`
- dataset label codepoints: `U+3A4B`
...
- Which source records identify obs-char-001446 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001446？
