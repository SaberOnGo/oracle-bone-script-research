...
- External category reference: `evobc-cat-06343`
- Source category ID: `06343`
- Source label for human review: `簌`
- Source codepoints: `U+7C0C`
...
- `obs-evo-cand-006343-route-category-staging`
...
- `obs-evo-cand-006343-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006343-route-evolution-graph`
