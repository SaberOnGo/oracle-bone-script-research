# Material Visual Observation / obs-comp-cand-002553 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002553`
- External reference / 外部参照: `obimd-sub-x6df7lvo0d`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021085_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/d91rup9lkj/x6df7lvo0d/x6df7lvo0d.png`
- Checksum / 校验和:
  `42f9910c42e0be8057edab9f85b3e44ed46cd090c58c87c0cfbf31b1b60f7df3`
...
- Marked-pixel bounds: (86,17)–(182,227); span 97 × 211 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.13%。
- 痕迹范围：(86,17)–(182,227)；跨度97 × 211 px；痕迹矩形高于宽。
