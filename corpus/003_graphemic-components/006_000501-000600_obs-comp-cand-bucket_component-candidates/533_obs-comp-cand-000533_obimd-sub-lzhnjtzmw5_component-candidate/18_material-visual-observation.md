# Material Visual Observation / obs-comp-cand-000533 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000533`
- External reference / 外部参照: `obimd-sub-lzhnjtzmw5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012767_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/m32ngscsu1/lzhnjtzmw5/lzhnjtzmw5.png`
- Checksum / 校验和:
  `ae37b1eea15fa36605eca5adfbdab63b74299e4370e778abd908b7c1a660b5ee`
...
- Marked-pixel bounds: (78,43)–(171,213); span 94 × 171 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.78%。
- 痕迹范围：(78,43)–(171,213)；跨度94 × 171 px；痕迹矩形高于宽。
