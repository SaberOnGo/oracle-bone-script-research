# Material Visual Observation / obs-comp-cand-001105 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001105`
- External reference / 外部参照: `obimd-sub-s3c8e2qncp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015046_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/r424gd7pwf/s3c8e2qncp/s3c8e2qncp.png`
- Checksum / 校验和:
  `ff2f4c790e3663ee691e23c36dce92d853ef871c1744b5feeaad4af0413110ab`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.07%.
- Marked-pixel bounds: (67,45)–(195,205); span 129 × 161 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.07%。
- 痕迹范围：(67,45)–(195,205)；跨度129 × 161 px；痕迹矩形高于宽。
