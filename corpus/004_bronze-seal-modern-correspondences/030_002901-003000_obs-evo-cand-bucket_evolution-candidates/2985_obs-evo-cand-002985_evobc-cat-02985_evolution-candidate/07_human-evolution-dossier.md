...
- External category reference: `evobc-cat-02985`
- Source category ID: `02985`
- Source label for human review: `恪`
- Source codepoints: `U+606A`
...
- `obs-evo-cand-002985-route-category-staging`
...
- `obs-evo-cand-002985-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002985-route-evolution-graph`
