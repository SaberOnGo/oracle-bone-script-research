# obs-char-000413 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000413`
- primary external id: `hust-obc-cat-0469`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/413_obs-char-000413_hust-obc-cat-0469_orac
  le-character/03_visual-assets/001_asset-000418_hust-obc-cat-0469_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0469/G_0469_乙192合20072𠂤組.png`
- asset id: `asset-000418`
...
- source category: `0469`
- validation class: `412`
- source image route: `HUST-OBC/deciphered/0469/G_0469_乙192合20072𠂤組.png`
- asset id: `asset-000418`
...
- English observation: `A broad open triangular top narrows into small
  central loops and a long angular lower extension.`
- 中文观察: `宽大开放三角形上部向下收窄为小型中央环形笔画，并连接长折角下部延伸。`
...
- dataset label text: `㗋`
- dataset label codepoints: `U+35CB`
...
- Which source records identify obs-char-000413 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000413？
