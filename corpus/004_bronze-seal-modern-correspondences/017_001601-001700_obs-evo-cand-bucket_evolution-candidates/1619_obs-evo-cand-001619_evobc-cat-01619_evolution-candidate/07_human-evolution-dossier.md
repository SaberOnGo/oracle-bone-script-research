...
- External category reference: `evobc-cat-01619`
- Source category ID: `01619`
- Source label for human review: `商`
- Source codepoints: `U+5546`
- Image reference count in source metadata: `267`
...
- `obs-evo-cand-001619-route-category-staging`
...
- `obs-evo-cand-001619-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001619-route-evolution-graph`
