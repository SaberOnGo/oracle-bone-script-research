# Material Visual Observation / obs-comp-cand-000458 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000458`
- External reference / 外部参照: `obimd-sub-1vtfwm0co9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012606_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1vtfwm0co9/1vtfwm0co9/1vtfwm0co9.png`
- Checksum / 校验和:
  `1987f2bccfb388cdde9edcd30829d51c3d0e46f3405f776c7d294700af2b22b8`
...
- Marked-pixel bounds: (66,10)–(184,237); span 119 × 228 px; the marked
...
- 痕迹范围：(66,10)–(184,237)；跨度119 × 228 px；痕迹矩形高于宽。
