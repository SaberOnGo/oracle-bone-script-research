...
Project ID: `obs-evo-cand-003444`
...
- Project ID: `obs-evo-cand-003444`
- EVOBC category candidate ID: `evobc-evo-cat-03444`
- External category reference: `evobc-cat-03444`
- Source category ID: `03444`
- Source label for human review: `搅`
- Source codepoints: `U+6405`
...
- `obs-evo-cand-003444-route-category-staging`
...
- `obs-evo-cand-003444-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003444-route-evolution-graph`
