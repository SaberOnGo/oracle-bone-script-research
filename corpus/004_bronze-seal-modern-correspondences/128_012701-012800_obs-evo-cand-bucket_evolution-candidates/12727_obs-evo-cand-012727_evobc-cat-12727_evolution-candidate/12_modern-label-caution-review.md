# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012727
...
- EVOBC candidate category: `evobc-evo-cat-12727`.
- Source label for search only: `𪃟`.
- Source codepoints for search only: `U+2A0DF`.
