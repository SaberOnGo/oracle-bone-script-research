...
- External category reference: `evobc-cat-06848`
- Source category ID: `06848`
- Source label for human review: `羜`
...
- `obs-evo-cand-006848-route-category-staging`
...
- `obs-evo-cand-006848-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006848-route-evolution-graph`
