...
- External category reference: `evobc-cat-04717`
- Source category ID: `04717`
- Source label for human review: `淔`
...
- `obs-evo-cand-004717-route-category-staging`
...
- `obs-evo-cand-004717-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004717-route-evolution-graph`
