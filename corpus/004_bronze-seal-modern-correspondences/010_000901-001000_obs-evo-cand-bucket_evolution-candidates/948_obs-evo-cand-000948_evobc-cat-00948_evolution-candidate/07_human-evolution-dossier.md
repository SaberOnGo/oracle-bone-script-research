...
Project ID: `obs-evo-cand-000948`
...
- Project ID: `obs-evo-cand-000948`
- EVOBC category candidate ID: `evobc-evo-cat-00948`
- External category reference: `evobc-cat-00948`
- Source category ID: `00948`
- Source label for human review: `偄`
- Source codepoints: `U+5044`
...
- `obs-evo-cand-000948-route-category-staging`
...
- `obs-evo-cand-000948-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000948-route-evolution-graph`
