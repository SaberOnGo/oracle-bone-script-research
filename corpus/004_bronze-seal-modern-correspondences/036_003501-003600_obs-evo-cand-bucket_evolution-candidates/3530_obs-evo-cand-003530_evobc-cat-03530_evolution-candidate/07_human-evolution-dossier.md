...
- External category reference: `evobc-cat-03530`
- Source category ID: `03530`
- Source label for human review: `擩`
...
- `obs-evo-cand-003530-route-category-staging`
...
- `obs-evo-cand-003530-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003530-route-evolution-graph`
