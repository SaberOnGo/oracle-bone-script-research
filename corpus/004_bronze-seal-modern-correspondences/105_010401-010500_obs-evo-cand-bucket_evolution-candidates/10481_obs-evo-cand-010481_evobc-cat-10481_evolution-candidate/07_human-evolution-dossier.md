...
- External category reference: `evobc-cat-10481`
- Source category ID: `10481`
- Source label for human review: `鴆`
...
- `obs-evo-cand-010481-route-category-staging`
...
- `obs-evo-cand-010481-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010481-route-evolution-graph`
