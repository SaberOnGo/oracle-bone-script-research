# obs-char-000214 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/214_obs-char-000214_hust-obc-cat-0238_orac
  le-character/03_visual-assets/001_asset-000219_hust-obc-cat-0238_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0238/X_0238_2193_1.png`
- asset id: `asset-000219`
...
- source category: `0238`
- validation class: `213`
- source image route: `HUST-OBC/deciphered/0238/X_0238_2193_1.png`
- asset id: `asset-000219`
...
- English observation: `The image has a large rounded loop on the left
  connected through a central crossing to a long curved stroke on the
  right.`
...
- dataset label text: `㓤`
- dataset label codepoints: `U+34E4`
...
- Which source records identify obs-char-000214 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000214？
