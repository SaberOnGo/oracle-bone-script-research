# obs-unk-003888 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/055_undeciphered-003
  801-003900_obs-unk-bucket_oracle-character-candidates/088_obs-unk-003888_h
  ust-obc-und-L-003888_oracle-character-candidate/03_visual-assets/001_asset
  -005481_hust-obc-und-L-003888_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3888/L_？_818.jpg`
- asset id: `asset-005481`
...
- source class: `HUST-OBC/undeciphered/L/3888/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3888/L_？_818.jpg`
- asset id: `asset-005481`
...
- Which source records identify obs-unk-003888 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003888？
