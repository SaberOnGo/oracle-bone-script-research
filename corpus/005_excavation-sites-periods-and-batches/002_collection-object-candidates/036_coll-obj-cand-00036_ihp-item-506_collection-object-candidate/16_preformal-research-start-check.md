# Preformal Research Start Check / 正式研究开始前开包核查: coll-obj-cand-00036
...
| --- | --- | --- |
| 1 | `02_collection-source-index.csv` | `506` |
...
| 6 | `18_live-source-evidence-review.md` | current page and image evidence |
