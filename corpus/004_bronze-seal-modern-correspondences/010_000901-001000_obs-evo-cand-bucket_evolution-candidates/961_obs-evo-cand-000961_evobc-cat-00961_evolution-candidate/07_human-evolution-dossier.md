...
- Project ID: `obs-evo-cand-000961`
- EVOBC category candidate ID: `evobc-evo-cat-00961`
- External category reference: `evobc-cat-00961`
- Source category ID: `00961`
- Source label for human review: `健`
- Source codepoints: `U+5065`
...
- `obs-evo-cand-000961-route-category-staging`
...
- `obs-evo-cand-000961-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000961-route-evolution-graph`
