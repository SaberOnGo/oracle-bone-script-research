# obs-char-000127 Visual Gallery / obs-char-000127 图像资料页
...
- Project ID / 项目 ID: `obs-char-000127`
- Primary external reference / 首选外部参考: `hust-obc-cat-0141`
...
## obs-char-000127-visual-source-001 / 图像条目

![obs-char-000127 glyph candidate](03_visual-assets/001_asset-000132_hust-obc-cat-0141_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000132_hust-obc-cat-0141_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000132_hust-obc-cat-0141_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/0141/G_0141_乙1157合14153賓組.png`
