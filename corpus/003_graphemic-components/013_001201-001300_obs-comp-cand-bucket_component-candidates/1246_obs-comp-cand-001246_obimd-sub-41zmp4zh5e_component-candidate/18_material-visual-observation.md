# Material Visual Observation / obs-comp-cand-001246 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001246`
- External reference / 外部参照: `obimd-sub-41zmp4zh5e`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015484_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/41zmp4zh5e/41zmp4zh5e/41zmp4zh5e.png`
- Checksum / 校验和:
  `26cce71e4daf46b724705c5df3f9cd32edc40bc0a4bd8f5773dd319422fd034e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 14.17%.
- Marked-pixel bounds: (56,23)–(185,220); span 130 × 198 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占14.17%。
- 痕迹范围：(56,23)–(185,220)；跨度130 × 198 px；痕迹矩形高于宽。
