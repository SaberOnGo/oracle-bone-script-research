...
- External category reference: `evobc-cat-07039`
- Source category ID: `07039`
- Source label for human review: `胯`
- Source codepoints: `U+80EF`
...
- `obs-evo-cand-007039-route-category-staging`
...
- `obs-evo-cand-007039-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007039-route-evolution-graph`
