# obs-char-000111 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000111`
- primary external id: `hust-obc-cat-0125`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/111_obs-char-000111_hust-obc-cat-0125_orac
  le-character/03_visual-assets/001_asset-000116_hust-obc-cat-0125_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0125/G_0125_前4.46.3合20407𠂤組.png
  `
- asset id: `asset-000116`
...
- source category: `0125`
- validation class: `110`
- source image route: `HUST-OBC/deciphered/0125/G_0125_前4.46.3合20407𠂤組.png`
- asset id: `asset-000116`
...
- English observation: `The narrow image has a small angular upper mark, a
  long descending central stroke, and a short horizontal cross stroke near
  the lower end.`
...
- dataset label text: `㑳`
- dataset label codepoints: `U+3473`
...
- filename catalog route clues: `Heji-like filename clue: 合20407
  (G_0125_前4.46.3合20407𠂤組.png)`
...
- Which source records identify obs-char-000111 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000111？
