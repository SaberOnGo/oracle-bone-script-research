# obs-unk-004612 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004612`
- primary external id: `hust-obc-und-X-004612`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/012_obs-unk-004612_h
  ust-obc-und-X-004612_oracle-character-candidate/03_visual-assets/001_asset
  -006205_hust-obc-und-X-004612_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/168/X_？_8344_1.png`
- asset id: `asset-006205`
...
- source class: `HUST-OBC/undeciphered/X/168/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/168/X_？_8344_1.png`
- asset id: `asset-006205`
...
- English observation: `central junction with upper and lower branches`
- 中文观察: `中央交接点及上下分支痕迹已记录。`
...
- Which source records identify obs-unk-004612 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004612？
