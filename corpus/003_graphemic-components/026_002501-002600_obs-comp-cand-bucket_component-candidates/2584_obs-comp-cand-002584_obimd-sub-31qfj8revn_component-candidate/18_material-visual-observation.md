# Material Visual Observation / obs-comp-cand-002584 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002584`
- External reference / 外部参照: `obimd-sub-31qfj8revn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021123_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/31qfj8revn/31qfj8revn/31qfj8revn.png`
- Checksum / 校验和:
  `0f927bf41fd771da4ddcb3174ec9b28ba68bf4e6e5d653cf9ca40ad238f6f86d`
...
- Marked-pixel bounds: (86,22)–(163,227); span 78 × 206 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.37%。
- 痕迹范围：(86,22)–(163,227)；跨度78 × 206 px；痕迹矩形高于宽。
