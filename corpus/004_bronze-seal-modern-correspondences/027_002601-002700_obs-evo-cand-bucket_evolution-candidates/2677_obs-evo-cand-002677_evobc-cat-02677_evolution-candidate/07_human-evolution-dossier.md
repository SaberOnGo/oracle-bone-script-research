...
- External category reference: `evobc-cat-02677`
- Source category ID: `02677`
- Source label for human review: `幗`
...
- `obs-evo-cand-002677-route-category-staging`
...
- `obs-evo-cand-002677-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002677-route-evolution-graph`
