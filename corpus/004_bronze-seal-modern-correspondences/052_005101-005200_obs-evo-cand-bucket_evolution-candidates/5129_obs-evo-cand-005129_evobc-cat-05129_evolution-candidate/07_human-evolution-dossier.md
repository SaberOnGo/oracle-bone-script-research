...
- Project ID: `obs-evo-cand-005129`
- EVOBC category candidate ID: `evobc-evo-cat-05129`
- External category reference: `evobc-cat-05129`
- Source category ID: `05129`
- Source label for human review: `熚`
- Source codepoints: `U+719A`
...
- `obs-evo-cand-005129-route-category-staging`
...
- `obs-evo-cand-005129-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005129-route-evolution-graph`
