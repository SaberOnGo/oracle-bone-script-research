# Material Visual Observation / obs-comp-cand-001823 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001823`
- External reference / 外部参照: `obimd-sub-sywfwn7sg1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018149_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/sywfwn7sg1/sywfwn7sg1/sywfwn7sg1.png`
- Checksum / 校验和:
  `1f6409dd01532e8b776c73e4441cd7a97848011f46aed7262bd7f17fd00b8d21`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.83%.
- Marked-pixel bounds: (61,31)–(210,217); span 150 × 187 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.83%。
- 痕迹范围：(61,31)–(210,217)；跨度150 × 187 px；痕迹矩形高于宽。
