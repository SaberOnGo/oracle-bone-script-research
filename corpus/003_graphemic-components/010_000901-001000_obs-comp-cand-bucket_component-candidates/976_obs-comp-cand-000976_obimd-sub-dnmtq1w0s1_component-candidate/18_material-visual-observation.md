# Material Visual Observation / obs-comp-cand-000976 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000976`
- External reference / 外部参照: `obimd-sub-dnmtq1w0s1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014258_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/r79attbhro/dnmtq1w0s1/dnmtq1w0s1.png`
- Checksum / 校验和:
  `5b2ef293b26e9fd04632bd3e00fdc00d15d771c40e098befb86971ba4dbc8923`
...
- Marked-pixel bounds: (77,47)–(172,204); span 96 × 158 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.70%。
- 痕迹范围：(77,47)–(172,204)；跨度96 × 158 px；痕迹矩形高于宽。
