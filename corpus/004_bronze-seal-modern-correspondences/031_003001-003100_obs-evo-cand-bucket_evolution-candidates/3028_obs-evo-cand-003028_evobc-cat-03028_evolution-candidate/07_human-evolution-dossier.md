...
- External category reference: `evobc-cat-03028`
- Source category ID: `03028`
- Source label for human review: `悵`
...
- `obs-evo-cand-003028-route-category-staging`
...
- `obs-evo-cand-003028-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003028-route-evolution-graph`
