# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010241
...
- EVOBC candidate category: `evobc-evo-cat-10241`.
- Source label for search only: `騽`.
- Source codepoints for search only: `U+9A3D`.
