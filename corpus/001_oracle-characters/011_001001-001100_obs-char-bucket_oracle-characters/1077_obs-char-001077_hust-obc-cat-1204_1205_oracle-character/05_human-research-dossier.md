# obs-char-001077 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1077_obs-char-001077_hust-obc-cat-1204_120
  5_oracle-character/03_visual-assets/001_asset-001082_hust-obc-cat-1204_120
  5_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1204_1205/1204/G_1204_續3.28.7(甲
  ).png`
- asset id: `asset-001082`
...
- source category: `1204_1205`
- validation class: `1076`
- source image route: `HUST-OBC/deciphered/1204_1205/1204/G_1204_續3.28.7(甲).pn
  g`
- asset id: `asset-001082`
...
- English observation: `A narrow oval-like enclosure contains a central
  branching stroke and several short side marks near its edges.`
...
- dataset label text: `㢪㢫`
- dataset label codepoints: `U+38AA;U+38AB`
...
- graph edge count: `2`
- codepoint routes: `U+38AA;U+38AB`
...
- Which source records identify obs-char-001077 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001077？
