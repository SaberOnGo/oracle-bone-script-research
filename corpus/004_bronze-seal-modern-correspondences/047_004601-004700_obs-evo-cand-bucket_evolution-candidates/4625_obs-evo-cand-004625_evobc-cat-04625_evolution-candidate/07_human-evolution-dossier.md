...
- Project ID: `obs-evo-cand-004625`
- EVOBC category candidate ID: `evobc-evo-cat-04625`
- External category reference: `evobc-cat-04625`
- Source category ID: `04625`
- Source label for human review: `洚`
- Source codepoints: `U+6D1A`
...
- `obs-evo-cand-004625-route-category-staging`
...
- `obs-evo-cand-004625-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004625-route-evolution-graph`
