...
- External category reference: `evobc-cat-08254`
- Source category ID: `08254`
- Source label for human review: `誽`
...
- `obs-evo-cand-008254-route-category-staging`
...
- `obs-evo-cand-008254-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008254-route-evolution-graph`
