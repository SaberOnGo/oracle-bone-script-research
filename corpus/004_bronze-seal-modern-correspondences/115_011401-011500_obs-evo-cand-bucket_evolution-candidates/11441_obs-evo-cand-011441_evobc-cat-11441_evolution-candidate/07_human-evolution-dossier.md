...
- External category reference: `evobc-cat-11441`
- Source category ID: `11441`
- Source label for human review: `𣔺`
- Source codepoints: `U+2353A`
...
- `obs-evo-cand-011441-route-category-staging`
...
- `obs-evo-cand-011441-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011441-route-evolution-graph`
