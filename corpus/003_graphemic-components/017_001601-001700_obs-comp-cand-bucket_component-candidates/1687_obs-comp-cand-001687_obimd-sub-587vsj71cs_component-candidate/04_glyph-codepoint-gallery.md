# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001687
...
| --- | --- | --- | --- |
| `obimd-glyph-link-026129` | 󹲮 | `U+F9CAE` | `reviewed_metadata_only` |
| `obimd-glyph-link-026130` | 󹲯 | `U+F9CAF` | `reviewed_metadata_only` |
