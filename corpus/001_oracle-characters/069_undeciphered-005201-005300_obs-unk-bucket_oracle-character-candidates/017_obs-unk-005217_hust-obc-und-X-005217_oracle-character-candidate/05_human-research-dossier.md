# obs-unk-005217 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/069_undeciphered-005
  201-005300_obs-unk-bucket_oracle-character-candidates/017_obs-unk-005217_h
  ust-obc-und-X-005217_oracle-character-candidate/03_visual-assets/001_asset
  -006810_hust-obc-und-X-005217_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/773/X_？_7735_1.png`
- asset id: `asset-006810`
...
- source class: `HUST-OBC/undeciphered/X/773/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/773/X_？_7735_1.png`
- asset id: `asset-006810`
...
- Which source records identify obs-unk-005217 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005217？
