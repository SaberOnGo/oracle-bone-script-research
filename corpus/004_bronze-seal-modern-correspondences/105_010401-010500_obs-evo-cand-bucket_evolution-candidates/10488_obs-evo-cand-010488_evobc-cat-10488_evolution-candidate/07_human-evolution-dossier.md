...
- External category reference: `evobc-cat-10488`
- Source category ID: `10488`
- Source label: `鴛`
...
- `obs-evo-cand-010488-route-category-staging`
...
- `obs-evo-cand-010488-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010488-route-evolution-graph`
