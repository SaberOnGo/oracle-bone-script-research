# obs-unk-003369 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003369`
- primary external id: `hust-obc-und-L-003369`
...
- local review image route: `corpus/001_oracle-characters/050_undeciphered-003
  301-003400_obs-unk-bucket_oracle-character-candidates/069_obs-unk-003369_h
  ust-obc-und-L-003369_oracle-character-candidate/03_visual-assets/001_asset
  -004962_hust-obc-und-L-003369_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3369/L_？_6429.jpg`
- asset id: `asset-004962`
...
- source class: `HUST-OBC/undeciphered/L/3369/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3369/L_？_6429.jpg`
- asset id: `asset-004962`
...
- Which source records identify obs-unk-003369 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003369？
