...
Project ID: `obs-evo-cand-011081`
...
- Project ID: `obs-evo-cand-011081`
- EVOBC category candidate ID: `evobc-evo-cat-11081`
- External category reference: `evobc-cat-11081`
- Source category ID: `11081`
- Source label for human review: `𡩡`
- Source codepoints: `U+21A61`
...
- `obs-evo-cand-011081-route-category-staging`
...
- `obs-evo-cand-011081-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011081-route-evolution-graph`
