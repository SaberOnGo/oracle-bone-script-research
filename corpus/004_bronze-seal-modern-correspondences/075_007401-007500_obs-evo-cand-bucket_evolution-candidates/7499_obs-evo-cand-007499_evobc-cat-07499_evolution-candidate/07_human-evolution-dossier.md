...
- External category reference: `evobc-cat-07499`
- Source category ID: `07499`
- Source label for human review: `蒜`
- Source codepoints: `U+849C`
...
- `obs-evo-cand-007499-route-category-staging`
...
- `obs-evo-cand-007499-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007499-route-evolution-graph`
