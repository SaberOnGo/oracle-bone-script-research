# Material Visual Observation / obs-comp-cand-002546 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002546`
- External reference / 外部参照: `obimd-sub-npj62t4ckh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021078_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7bgm052mqy/npj62t4ckh/npj62t4ckh.png`
- Checksum / 校验和:
  `de9699a37e25c104e0f2293778495b3a9578931ab27084c84642e405173e5e08`
...
- Marked-pixel bounds: (58,53)–(189,193); span 132 × 141 px; the marked
...
- 痕迹范围：(58,53)–(189,193)；跨度132 × 141 px；痕迹矩形近方形。
