...
- Project ID: `obs-evo-cand-011737`
- EVOBC category candidate ID: `evobc-evo-cat-11737`
- External category reference: `evobc-cat-11737`
- Source category ID: `11737`
- Source label for human review: `𤼁`
- Source codepoints: `U+24F01`
...
- `obs-evo-cand-011737-route-category-staging`
...
- `obs-evo-cand-011737-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011737-route-evolution-graph`
