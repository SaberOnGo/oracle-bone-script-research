# Material Visual Observation / obs-comp-cand-002654 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002654`
- External reference / 外部参照: `obimd-sub-ghswt6r5vl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021230_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ghswt6r5vl/ghswt6r5vl/ghswt6r5vl.png`
- Checksum / 校验和:
  `a1f7292b4cbf086b6690e6366a8ef52468f837bdad553f9e2f31de3f923c2110`
...
- Marked-pixel bounds: (80,17)–(170,236); span 91 × 220 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.57%。
- 痕迹范围：(80,17)–(170,236)；跨度91 × 220 px；痕迹矩形高于宽。
