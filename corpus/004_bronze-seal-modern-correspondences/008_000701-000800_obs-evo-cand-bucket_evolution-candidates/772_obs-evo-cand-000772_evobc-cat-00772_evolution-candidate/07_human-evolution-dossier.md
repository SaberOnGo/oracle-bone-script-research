...
- External category reference: `evobc-cat-00772`
- Source category ID: `00772`
- Source label for human review: `伖`
- Source codepoints: `U+4F16`
...
- `obs-evo-cand-000772-route-category-staging`
...
- `obs-evo-cand-000772-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000772-route-evolution-graph`
