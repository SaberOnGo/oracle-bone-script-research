# Material Visual Observation / obs-comp-cand-002043 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002043`
- External reference / 外部参照: `obimd-sub-sj4e2q73so`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019370_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/sj4e2q73so/sj4e2q73so/sj4e2q73so.png`
- Checksum / 校验和:
  `2ac906ed7658de634dde2300cb07fec618e5b0053ed98059bd99461fee5a9f19`
...
- Marked-pixel bounds: (83,22)–(186,223); span 104 × 202 px; the marked
...
- 痕迹范围：(83,22)–(186,223)；跨度104 × 202 px；痕迹矩形高于宽。
