...
- 项目 ID: `obs-char-001278`
- 首选外部 ID: `hust-obc-cat-1429_1430`
- 来源 ID: `src-hust-obc`
...
- 来源图像路线数: `1`
- 本地复核图像数: `1`
- 首个来源图像名: `G_1429_寧滬2.145(甲).png`
- 首个本地图像名: `001_asset-001283_hust-obc-cat-1429_1430_glyph.png`
