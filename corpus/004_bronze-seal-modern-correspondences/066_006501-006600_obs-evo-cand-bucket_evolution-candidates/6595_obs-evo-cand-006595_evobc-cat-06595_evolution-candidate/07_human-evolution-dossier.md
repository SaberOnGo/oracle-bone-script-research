...
- External category reference: `evobc-cat-06595`
- Source category ID: `06595`
- Source label for human review: `緞`
...
- `obs-evo-cand-006595-route-category-staging`
...
- `obs-evo-cand-006595-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006595-route-evolution-graph`
