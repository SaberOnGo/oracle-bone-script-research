...
Project ID: `obs-evo-cand-006093`
...
- Project ID: `obs-evo-cand-006093`
- EVOBC category candidate ID: `evobc-evo-cat-06093`
- External category reference: `evobc-cat-06093`
- Source category ID: `06093`
- Source label for human review: `稌`
- Source codepoints: `U+7A0C`
...
- `obs-evo-cand-006093-route-category-staging`
...
- `obs-evo-cand-006093-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006093-route-evolution-graph`
