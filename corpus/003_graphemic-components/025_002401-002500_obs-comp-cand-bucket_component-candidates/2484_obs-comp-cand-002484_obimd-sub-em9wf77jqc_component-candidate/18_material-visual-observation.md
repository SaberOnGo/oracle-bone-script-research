# Material Visual Observation / obs-comp-cand-002484 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002484`
- External reference / 外部参照: `obimd-sub-em9wf77jqc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020682_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/em9wf77jqc/em9wf77jqc/5erlcizd8p.png`
- Checksum / 校验和:
  `f5ce15ed99eea6fb73a6ca173de68139b62199041b397ef023fccade0db9ff13`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.16%.
- Marked-pixel bounds: (58,55)–(191,187); span 134 × 133 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.16%。
- 痕迹范围：(58,55)–(191,187)；跨度134 × 133 px；痕迹矩形近方形。
