# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004227
...
- EVOBC candidate category: `evobc-evo-cat-04227`.
- Source label for search only: `槽`.
- Source codepoints for search only: `U+69FD`.
