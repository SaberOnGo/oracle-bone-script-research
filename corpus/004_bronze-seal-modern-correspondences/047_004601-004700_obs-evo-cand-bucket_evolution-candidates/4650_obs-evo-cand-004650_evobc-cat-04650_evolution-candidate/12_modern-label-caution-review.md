# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004650
...
- EVOBC candidate category: `evobc-evo-cat-04650`.
- Source label for search only: `浊`.
- Source codepoints for search only: `U+6D4A`.
