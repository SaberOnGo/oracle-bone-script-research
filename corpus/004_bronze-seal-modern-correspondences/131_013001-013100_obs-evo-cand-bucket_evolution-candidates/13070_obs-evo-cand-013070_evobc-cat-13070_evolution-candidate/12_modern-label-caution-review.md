# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013070
...
- EVOBC candidate category: `evobc-evo-cat-13070`.
- Source label for search only: `𫯺`.
- Source codepoints for search only: `U+2BBFA`.
