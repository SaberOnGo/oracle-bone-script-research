...
Project ID: `obs-evo-cand-008277`
...
- Project ID: `obs-evo-cand-008277`
- EVOBC category candidate ID: `evobc-evo-cat-08277`
- External category reference: `evobc-cat-08277`
- Source category ID: `08277`
- Source label for human review: `諞`
- Source codepoints: `U+8ADE`
...
- `obs-evo-cand-008277-route-category-staging`
...
- `obs-evo-cand-008277-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008277-route-evolution-graph`
