...
- External category reference: `evobc-cat-07802`
- Source category ID: `07802`
- Source label for human review: `蝁`
- Source codepoints: `U+8741`
...
- `obs-evo-cand-007802-route-category-staging`
...
- `obs-evo-cand-007802-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007802-route-evolution-graph`
