...
- `obs-evo-cand-012341-route-category-staging`
...
- `obs-evo-cand-012341-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012341-route-evolution-graph`
