# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-002240
...
- glyph_codepoint_uplus_sample: `U+6790;U+FCDF0, U+FCDF1, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-020053` | `001_asset-020053_img.png` | `9288d925362147adff830071443fc62ddaaa70e6b993322d658f3f57ade49f9a` |
