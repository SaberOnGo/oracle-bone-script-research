...
Project ID: `obs-evo-cand-007048`
...
- Project ID: `obs-evo-cand-007048`
- EVOBC category candidate ID: `evobc-evo-cat-07048`
- External category reference: `evobc-cat-07048`
- Source category ID: `07048`
- Source label for human review: `能`
- Source codepoints: `U+80FD`
...
- `obs-evo-cand-007048-route-category-staging`
...
- `obs-evo-cand-007048-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007048-route-evolution-graph`
