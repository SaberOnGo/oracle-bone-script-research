...
- External category reference: `evobc-cat-13567`
- Source category ID: `13567`
- Source label for human review: `𭰮`
- Source codepoints: `U+2DC2E`
...
- `obs-evo-cand-013567-route-category-staging`
...
- `obs-evo-cand-013567-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013567-route-evolution-graph`
