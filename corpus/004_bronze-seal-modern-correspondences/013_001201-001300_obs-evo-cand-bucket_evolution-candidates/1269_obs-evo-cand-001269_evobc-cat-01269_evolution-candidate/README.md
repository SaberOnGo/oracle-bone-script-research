# obs-evo-cand-001269 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-001269`
- EVOBC category candidate ID: `evobc-evo-cat-01269`
- External category ref: `evobc-cat-01269`
- Source label: `劦`
- Source codepoints: `U+52A6`
- Image reference count: `152`
- Era token counts: `BI:8;OBC:140;SS:1;WSC:3`
- Source token counts: `Book:74;Web:78`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 140 image references
