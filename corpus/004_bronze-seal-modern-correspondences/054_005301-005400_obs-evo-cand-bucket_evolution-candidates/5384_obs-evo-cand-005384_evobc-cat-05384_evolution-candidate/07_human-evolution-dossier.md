...
- External category reference: `evobc-cat-05384`
- Source category ID: `05384`
- Source label for human review: `珢`
...
- `obs-evo-cand-005384-route-category-staging`
...
- `obs-evo-cand-005384-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005384-route-evolution-graph`
