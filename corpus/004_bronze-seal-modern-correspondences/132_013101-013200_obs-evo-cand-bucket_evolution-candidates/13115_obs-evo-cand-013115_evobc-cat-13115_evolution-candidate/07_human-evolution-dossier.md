...
- External category reference: `evobc-cat-13115`
- Source category ID: `13115`
- Source label for human review: `𫶏`
...
- `obs-evo-cand-013115-route-category-staging`
...
- `obs-evo-cand-013115-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013115-route-evolution-graph`
