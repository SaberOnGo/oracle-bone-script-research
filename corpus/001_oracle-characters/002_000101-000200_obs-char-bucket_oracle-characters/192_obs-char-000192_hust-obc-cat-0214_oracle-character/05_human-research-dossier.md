# obs-char-000192 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/192_obs-char-000192_hust-obc-cat-0214_orac
  le-character/03_visual-assets/001_asset-000197_hust-obc-cat-0214_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0214/G_0214_前7.13(甲).png`
- asset id: `asset-000197`
...
- source category: `0214`
- validation class: `191`
- source image route: `HUST-OBC/deciphered/0214/G_0214_前7.13(甲).png`
- asset id: `asset-000197`
...
- English observation: `The image has a pointed upper cap, two long curved
  inner strokes, and broad outer strokes descending toward the lower sides.`
...
- dataset label text: `㓌`
- dataset label codepoints: `U+34CC`
...
- Which source records identify obs-char-000192 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000192？
