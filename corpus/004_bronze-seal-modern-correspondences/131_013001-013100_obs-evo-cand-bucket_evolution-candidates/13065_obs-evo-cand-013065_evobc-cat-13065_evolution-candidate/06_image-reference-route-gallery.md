...
- `obs-evo-cand-013065-route-category-staging`
...
- `obs-evo-cand-013065-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013065-route-evolution-graph`
