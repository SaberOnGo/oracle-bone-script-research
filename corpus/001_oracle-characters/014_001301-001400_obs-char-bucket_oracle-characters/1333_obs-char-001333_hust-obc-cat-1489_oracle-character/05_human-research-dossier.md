# obs-char-001333 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001333`
- primary external id: `hust-obc-cat-1489`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1333_obs-char-001333_hust-obc-cat-1489_ora
  cle-character/03_visual-assets/001_asset-001338_hust-obc-cat-1489_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1489/G_1489_甲骨文0.png`
- asset id: `asset-001338`
...
- source category: `1489`
- validation class: `1332`
- source image route: `HUST-OBC/deciphered/1489/G_1489_甲骨文0.png`
- asset id: `asset-001338`
...
- English observation: `Two adjacent narrow forms combine long left branches
  with a right angular enclosure and a cross-stroke.`
- 中文观察: `两个相邻狭长形体结合左侧长分枝、右侧折角框形和一条横笔。`
...
- dataset label text: `㧇`
- dataset label codepoints: `U+39C7`
...
- Which source records identify obs-char-001333 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001333？
