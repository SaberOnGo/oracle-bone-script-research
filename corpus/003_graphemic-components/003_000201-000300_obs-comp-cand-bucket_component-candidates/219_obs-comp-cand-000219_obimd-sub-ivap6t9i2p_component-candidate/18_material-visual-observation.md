# Material Visual Observation / obs-comp-cand-000219 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000219`
- External reference / 外部参照: `obimd-sub-ivap6t9i2p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011864_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xwck9dcioj/ivap6t9i2p/ivap6t9i2p.png`
- Checksum / 校验和:
  `94c412c77dc96acce1937162bfe67d893e78af0dcf2886aa93d60283b0ff4a06`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.30%.
- Marked-pixel bounds: (82,17)–(164,236); span 83 × 220 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.30%。
- 痕迹范围：(82,17)–(164,236)；跨度83 × 220 px；痕迹矩形高于宽。
