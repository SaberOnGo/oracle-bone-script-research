# obs-char-000537 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/537_obs-char-000537_hust-obc-cat-0611_orac
  le-character/03_visual-assets/001_asset-000542_hust-obc-cat-0611_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0611/G_0611_前7.5.3(甲).png`
- asset id: `asset-000542`
...
- source category: `0611`
- validation class: `536`
- source image route: `HUST-OBC/deciphered/0611/G_0611_前7.5.3(甲).png`
- asset id: `asset-000542`
...
- English observation: `A narrow upright three-sided outline has a straight
  top bar, two short lower legs, and a thin central vertical rising above
  the top edge.`
- 中文观察: `狭长直立三边轮廓带平直顶横和两条短下腿，纤细中央竖笔伸出顶边上方。`
...
- dataset label text: `㙙`
- dataset label codepoints: `U+3659`
...
- Which source records identify obs-char-000537 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000537？
