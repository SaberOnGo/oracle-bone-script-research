# obs-char-000243 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/243_obs-char-000243_hust-obc-cat-0270_0271
  _oracle-character/03_visual-assets/001_asset-000248_hust-obc-cat-0270_0271
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0270_0271/0270/G_0270_前5.3.1(甲)
  .png`
- asset id: `asset-000248`
...
- source category: `0270_0271`
- validation class: `242`
- source image route: `HUST-OBC/deciphered/0270_0271/0270/G_0270_前5.3.1(甲).png
  `
- asset id: `asset-000248`
...
- English observation: `Three tall strokes stand within an open rounded
  lower contour; the center stroke reaches higher than the curved base.`
- 中文观察: `三道高直笔画位于开放的圆弧下部轮廓内；中央笔高出弯曲底部。`
...
- dataset label text: `㔄㔅`
- dataset label codepoints: `U+3504;U+3505`
...
- Which source records identify obs-char-000243 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000243？
