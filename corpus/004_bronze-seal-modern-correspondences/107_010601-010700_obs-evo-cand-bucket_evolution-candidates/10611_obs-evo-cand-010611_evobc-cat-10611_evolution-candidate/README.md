# obs-evo-cand-010611 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-010611`
- EVOBC category candidate ID: `evobc-evo-cat-10611`
- External category ref: `evobc-cat-10611`
- Source label: `麗`
- Source codepoints: `U+9E97`
- Image reference count: `110`
- Era token counts: `BI:13;CS:3;OBC:58;SAC:6;SS:4;WSC:26`
- Source token counts: `Book:51;Web:58;說文Web:1`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 58 image references
- era 1 / BI: 13 image references
- era 2 / SS: 4 image references
- era 3 / SAC: 6 image references
- era 4 / WSC: 26 image references
- era 5 / CS: 3 image references
- source 0 / Web:1633: 3 image references
- source 1 / Web:105952;說文Web:58: 32 image references
- source 2 / Book:17600: 12 image references
- source 3 / Book:21681: 3 image references
- source 4 / Book:9131: 6 image references
- source 5 / Book:32794: 12 image references
- source 6 / Web:30645: 24 image references
- source 7 / Book:9676: 18 image references
