# obs-unk-004741 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/041_obs-unk-004741_h
  ust-obc-und-X-004741_oracle-character-candidate/03_visual-assets/001_asset
  -006334_hust-obc-und-X-004741_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/297/X_？_7275_1.png`
- asset id: `asset-006334`
...
- source class: `HUST-OBC/undeciphered/X/297/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/297/X_？_7275_1.png`
- asset id: `asset-006334`
...
- English observation: `upper and central openings with long lower curve`
- 中文观察: `带长下部弯曲笔画的上下开口结构`
...
- Which source records identify obs-unk-004741 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004741？
