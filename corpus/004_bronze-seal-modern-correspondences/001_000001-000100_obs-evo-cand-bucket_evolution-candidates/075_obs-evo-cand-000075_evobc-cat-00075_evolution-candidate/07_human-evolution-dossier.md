...
- External category reference: `evobc-cat-00075`
- Source category ID: `00075`
- Source label for human review: `㝬`
...
- `obs-evo-cand-000075-route-category-staging`
...
- `obs-evo-cand-000075-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000075-route-evolution-graph`
