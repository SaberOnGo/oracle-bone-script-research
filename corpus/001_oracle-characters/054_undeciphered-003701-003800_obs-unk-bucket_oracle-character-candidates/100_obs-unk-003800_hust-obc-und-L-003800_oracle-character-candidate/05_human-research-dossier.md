# obs-unk-003800 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003800`
- primary external id: `hust-obc-und-L-003800`
...
- local review image route: `corpus/001_oracle-characters/054_undeciphered-003
  701-003800_obs-unk-bucket_oracle-character-candidates/100_obs-unk-003800_h
  ust-obc-und-L-003800_oracle-character-candidate/03_visual-assets/001_asset
  -005393_hust-obc-und-L-003800_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3800/L_？_7902.jpg`
- asset id: `asset-005393`
...
- source class: `HUST-OBC/undeciphered/L/3800/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3800/L_？_7902.jpg`
- asset id: `asset-005393`
...
- Which source records identify obs-unk-003800 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003800？
