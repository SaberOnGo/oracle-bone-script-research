...
- External category reference: `evobc-cat-00973`
- Source category ID: `00973`
- Source label for human review: `偿`
- Source codepoints: `U+507F`
...
- `obs-evo-cand-000973-route-category-staging`
...
- `obs-evo-cand-000973-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000973-route-evolution-graph`
