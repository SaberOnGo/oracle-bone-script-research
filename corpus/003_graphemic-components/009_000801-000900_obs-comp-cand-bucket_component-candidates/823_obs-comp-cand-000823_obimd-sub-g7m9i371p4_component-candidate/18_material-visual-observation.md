# Material Visual Observation / obs-comp-cand-000823 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000823`
- External reference / 外部参照: `obimd-sub-g7m9i371p4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013694_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/g7m9i371p4/g7m9i371p4/g7m9i371p4.png`
- Checksum / 校验和:
  `dd7d716d76fce03c707178b159784fcf3a631792ade992b3ecd00751b32af360`
...
- Marked-pixel bounds: (74,41)–(197,211); span 124 × 171 px; the marked
...
- 痕迹范围：(74,41)–(197,211)；跨度124 × 171 px；痕迹矩形高于宽。
