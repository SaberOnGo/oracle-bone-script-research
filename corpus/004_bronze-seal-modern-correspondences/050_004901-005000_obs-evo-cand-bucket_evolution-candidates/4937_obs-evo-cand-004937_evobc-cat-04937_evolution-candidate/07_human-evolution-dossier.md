...
- Project ID: `obs-evo-cand-004937`
- EVOBC category candidate ID: `evobc-evo-cat-04937`
- External category reference: `evobc-cat-04937`
- Source category ID: `04937`
- Source label for human review: `澣`
- Source codepoints: `U+6FA3`
...
- `obs-evo-cand-004937-route-category-staging`
...
- `obs-evo-cand-004937-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004937-route-evolution-graph`
