# Material Visual Observation / obs-comp-cand-001121 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001121`
- External reference / 外部参照: `obimd-sub-qom5qq71bd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015062_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qom5qq71bd/qom5qq71bd/qom5qq71bd.png`
- Checksum / 校验和:
  `258edf7e967490c1173ac013d8c92c0beaf42fc8070f94ab84f093a458ad4c3f`
...
- Marked-pixel bounds: (80,19)–(176,229); span 97 × 211 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.33%。
- 痕迹范围：(80,19)–(176,229)；跨度97 × 211 px；痕迹矩形高于宽。
