...
- `obs-evo-cand-000681-route-category-staging`
...
- `obs-evo-cand-000681-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000681-route-evolution-graph`
