...
- Project ID: `obs-evo-cand-002893`
- EVOBC category candidate ID: `evobc-evo-cat-02893`
- External category reference: `evobc-cat-02893`
- Source category ID: `02893`
- Source label for human review: `徽`
- Source codepoints: `U+5FBD`
...
- `obs-evo-cand-002893-route-category-staging`
...
- `obs-evo-cand-002893-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002893-route-evolution-graph`
