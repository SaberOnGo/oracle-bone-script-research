# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002453
...
| --- | --- | --- | --- |
| `obimd-glyph-link-037649` | 󽾠 | `U+FDFA0` | `reviewed_metadata_only` |
| `obimd-glyph-link-037650` | 󽾡 | `U+FDFA1` | `reviewed_metadata_only` |
| `obimd-glyph-link-037651` | 󽾢 | `U+FDFA2` | `reviewed_metadata_only` |
| `obimd-glyph-link-037652` | 󽾣 | `U+FDFA3` | `reviewed_metadata_only` |
| `obimd-glyph-link-037653` | 󽾤 | `U+FDFA4` | `reviewed_metadata_only` |
