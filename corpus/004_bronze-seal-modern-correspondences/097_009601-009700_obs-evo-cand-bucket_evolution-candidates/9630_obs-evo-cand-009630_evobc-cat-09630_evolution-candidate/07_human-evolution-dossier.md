...
- Project ID: `obs-evo-cand-009630`
- EVOBC category candidate ID: `evobc-evo-cat-09630`
- External category reference: `evobc-cat-09630`
- Source category ID: `09630`
- Source label for human review: `閣`
- Source codepoints: `U+95A3`
...
- `obs-evo-cand-009630-route-category-staging`
...
- `obs-evo-cand-009630-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009630-route-evolution-graph`
