# Material Visual Observation / obs-comp-cand-001474 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001474`
- External reference / 外部参照: `obimd-sub-ykxksit86p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016051_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gqezg03aqo/ykxksit86p/ykxksit86p.png`
- Checksum / 校验和:
  `04d69856c7af42a774a14d1c73e28623149c1202f4571227168d20bef0e3b617`
...
- Marked-pixel bounds: (72,34)–(178,219); span 107 × 186 px; the marked
...
- 痕迹范围：(72,34)–(178,219)；跨度107 × 186 px；痕迹矩形高于宽。
