...
- External category reference: `evobc-cat-04184`
- Source category ID: `04184`
- Source label for human review: `榜`
- Source codepoints: `U+699C`
...
- `obs-evo-cand-004184-route-category-staging`
...
- `obs-evo-cand-004184-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004184-route-evolution-graph`
