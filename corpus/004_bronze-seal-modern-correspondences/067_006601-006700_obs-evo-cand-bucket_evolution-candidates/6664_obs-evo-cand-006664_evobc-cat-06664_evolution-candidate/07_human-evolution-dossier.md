...
Project ID: `obs-evo-cand-006664`
...
- Project ID: `obs-evo-cand-006664`
- EVOBC category candidate ID: `evobc-evo-cat-06664`
- External category reference: `evobc-cat-06664`
- Source category ID: `06664`
- Source label for human review: `繅`
- Source codepoints: `U+7E45`
...
- `obs-evo-cand-006664-route-category-staging`
...
- `obs-evo-cand-006664-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006664-route-evolution-graph`
