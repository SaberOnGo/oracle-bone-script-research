# obs-char-000609 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000609`
- primary external id: `hust-obc-cat-0694`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/609_obs-char-000609_hust-obc-cat-0694_orac
  le-character/03_visual-assets/001_asset-000614_hust-obc-cat-0694_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0694/G_0694_甲骨文0.png`
- asset id: `asset-000614`
...
- source category: `0694`
- validation class: `608`
- source image route: `HUST-OBC/deciphered/0694/G_0694_甲骨文0.png`
- asset id: `asset-000614`
...
- English observation: `Several thin angular strokes intersect around a
  small central triangular space, with forked ends spreading upward and
  downward.`
- 中文观察: `数条纤细折角笔围绕中央小三角空隙相交，叉状末端分别向上、向下展开。`
...
- dataset label text: `㚬`
- dataset label codepoints: `U+36AC`
...
- Which source records identify obs-char-000609 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000609？
