...
- External category reference: `evobc-cat-07051`
- Source category ID: `07051`
- Source label for human review: `脁`
- Source codepoints: `U+8101`
...
- `obs-evo-cand-007051-route-category-staging`
...
- `obs-evo-cand-007051-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007051-route-evolution-graph`
