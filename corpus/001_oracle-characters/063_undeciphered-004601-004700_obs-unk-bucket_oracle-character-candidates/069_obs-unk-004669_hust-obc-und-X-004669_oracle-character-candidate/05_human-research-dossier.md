# obs-unk-004669 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/069_obs-unk-004669_h
  ust-obc-und-X-004669_oracle-character-candidate/03_visual-assets/001_asset
  -006262_hust-obc-und-X-004669_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/225/X_？_7222_1.png`
- asset id: `asset-006262`
...
- source class: `HUST-OBC/undeciphered/X/225/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/225/X_？_7222_1.png`
- asset id: `asset-006262`
...
- English observation: `crossed strokes with right triangular opening`
- 中文观察: `带右侧三角开口的交叉笔画`
...
- Which source records identify obs-unk-004669 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004669？
