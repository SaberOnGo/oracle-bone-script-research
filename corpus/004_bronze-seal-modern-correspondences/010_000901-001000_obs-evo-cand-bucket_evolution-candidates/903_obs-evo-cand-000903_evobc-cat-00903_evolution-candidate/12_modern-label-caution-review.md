# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000903
...
- EVOBC candidate category: `evobc-evo-cat-00903`.
- Source label for search only: `修`.
- Source codepoints for search only: `U+4FEE`.
