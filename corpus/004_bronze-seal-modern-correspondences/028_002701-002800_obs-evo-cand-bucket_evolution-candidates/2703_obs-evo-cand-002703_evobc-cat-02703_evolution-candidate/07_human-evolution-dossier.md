...
- External category reference: `evobc-cat-02703`
- Source category ID: `02703`
- Source label for human review: `幼`
...
- `obs-evo-cand-002703-route-category-staging`
...
- `obs-evo-cand-002703-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002703-route-evolution-graph`
