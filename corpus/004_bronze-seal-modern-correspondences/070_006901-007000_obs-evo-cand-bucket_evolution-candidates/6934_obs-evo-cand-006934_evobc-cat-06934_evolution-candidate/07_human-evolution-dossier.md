...
- Project ID: `obs-evo-cand-006934`
- EVOBC category candidate ID: `evobc-evo-cat-06934`
- External category reference: `evobc-cat-06934`
- Source category ID: `06934`
- Source label for human review: `耽`
- Source codepoints: `U+803D`
...
- `obs-evo-cand-006934-route-category-staging`
...
- `obs-evo-cand-006934-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006934-route-evolution-graph`
