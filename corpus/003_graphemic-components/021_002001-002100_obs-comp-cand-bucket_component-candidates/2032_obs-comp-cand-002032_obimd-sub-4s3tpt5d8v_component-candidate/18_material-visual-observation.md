# Material Visual Observation / obs-comp-cand-002032 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002032`
- External reference / 外部参照: `obimd-sub-4s3tpt5d8v`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019359_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4s3tpt5d8v/4s3tpt5d8v/4s3tpt5d8v.png`
- Checksum / 校验和:
  `4a2d7bad217312aa1762ddff13287a36ebd84e0458f661a823fedbcdf1a4629c`
...
- Marked-pixel bounds: (76,50)–(173,210); span 98 × 161 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.50%。
- 痕迹范围：(76,50)–(173,210)；跨度98 × 161 px；痕迹矩形高于宽。
