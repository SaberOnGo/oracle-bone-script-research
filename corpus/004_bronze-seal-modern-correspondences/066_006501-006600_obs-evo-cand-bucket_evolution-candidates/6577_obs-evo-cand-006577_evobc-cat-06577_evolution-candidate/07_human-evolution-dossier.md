...
- External category reference: `evobc-cat-06577`
- Source category ID: `06577`
- Source label for human review: `緆`
- Source codepoints: `U+7DC6`
...
- `obs-evo-cand-006577-route-category-staging`
...
- `obs-evo-cand-006577-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006577-route-evolution-graph`
