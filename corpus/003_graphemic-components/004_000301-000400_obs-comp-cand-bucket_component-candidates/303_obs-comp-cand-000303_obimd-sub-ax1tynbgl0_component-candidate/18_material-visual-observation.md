# Material Visual Observation / obs-comp-cand-000303 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000303`
- External reference / 外部参照: `obimd-sub-ax1tynbgl0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012069_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/aki498y6jc/ax1tynbgl0/ax1tynbgl0.png`
- Checksum / 校验和:
  `95fc2fc969aedc882a70a098bed395c5be0778f671d453d6110b29fa5b6f89ab`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.45%.
- Marked-pixel bounds: (97,28)–(152,220); span 56 × 193 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.45%。
- 痕迹范围：(97,28)–(152,220)；跨度56 × 193 px；痕迹矩形高于宽。
