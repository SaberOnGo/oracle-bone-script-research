...
- External category reference: `evobc-cat-01921`
- Source category ID: `01921`
- Source label for human review: `塘`
...
- `obs-evo-cand-001921-route-category-staging`
...
- `obs-evo-cand-001921-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001921-route-evolution-graph`
