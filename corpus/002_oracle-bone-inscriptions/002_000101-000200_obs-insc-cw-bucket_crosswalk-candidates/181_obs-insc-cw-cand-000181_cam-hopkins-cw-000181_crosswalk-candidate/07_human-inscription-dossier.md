...
Project ID: `obs-insc-cw-cand-000181`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000181`
...
- Yingguo / 英国所藏: `y1105` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `150` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `611` in source row; primary catalog entry pending
- Heji / 合集: `40353` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000181`
