# Material Visual Observation / obs-comp-cand-002019 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002019`
- External reference / 外部参照: `obimd-sub-t4ht5564u7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019346_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tbecf7rhkr/t4ht5564u7/t4ht5564u7.png`
- Checksum / 校验和:
  `f5a23f30829042949ee7923eb2f63e54236a60ddfa458d7fc6a8113b9b40c501`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.92%.
- Marked-pixel bounds: (87,24)–(162,227); span 76 × 204 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.92%。
- 痕迹范围：(87,24)–(162,227)；跨度76 × 204 px；痕迹矩形高于宽。
