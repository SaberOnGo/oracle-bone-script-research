...
Project ID: `obs-evo-cand-012898`
...
- Project ID: `obs-evo-cand-012898`
- EVOBC category candidate ID: `evobc-evo-cat-12898`
- External category reference: `evobc-cat-12898`
- Source category ID: `12898`
- Source label for human review: `𪽾`
- Source codepoints: `U+2AF7E`
...
- `obs-evo-cand-012898-route-category-staging`
...
- `obs-evo-cand-012898-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012898-route-evolution-graph`
