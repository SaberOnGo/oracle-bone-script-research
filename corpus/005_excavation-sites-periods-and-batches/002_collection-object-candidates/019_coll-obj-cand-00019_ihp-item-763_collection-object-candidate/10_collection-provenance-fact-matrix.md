# Collection Provenance Fact Matrix / 馆藏来源事实矩阵: coll-obj-cand-00019
...
- Use `18_live-source-evidence-review.md` for source description, image hash,
  and private visual observations.
...
| Catalog or accession route / 著录或登记路线 | 763; source-page route only | 02_collection-source-index.csv; 06_human-collection-dossier.md |
...
- candidate_collection_object_id: `ihp-mus-obj-00019`
