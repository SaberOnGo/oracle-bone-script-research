...
- Yingguo / 英国所藏: `y1846` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `563` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `711` in source row; primary catalog entry pending
- Heji / 合集: `40308` in source row; primary catalog entry pending
