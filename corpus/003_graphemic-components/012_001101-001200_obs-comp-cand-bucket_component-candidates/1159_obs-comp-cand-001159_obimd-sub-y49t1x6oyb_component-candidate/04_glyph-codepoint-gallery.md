# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001159
...
| --- | --- | --- | --- |
| `obimd-glyph-link-017440` | 󶬋 | `U+F6B0B` | `reviewed_metadata_only` |
| `obimd-glyph-link-017441` | 󶬌 | `U+F6B0C` | `reviewed_metadata_only` |
| `obimd-glyph-link-017442` | 󶬍 | `U+F6B0D` | `reviewed_metadata_only` |
