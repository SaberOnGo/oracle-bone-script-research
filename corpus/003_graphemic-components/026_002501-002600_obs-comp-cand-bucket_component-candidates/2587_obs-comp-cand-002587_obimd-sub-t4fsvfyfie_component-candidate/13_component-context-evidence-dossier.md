# obs-comp-cand-002587 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002587`
- 首选外部 ID: `obimd-sub-t4fsvfyfie`
- OBIMD subcharacter UID: `t4fsvfyfie`
- OBIMD main character UID: `t4fsvfyfie`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `8`
- codepoint 示例: U+FEA9F; U+FEAA0; 另有 6 项
