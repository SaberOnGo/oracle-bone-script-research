...
- Project ID: `obs-evo-cand-003690`
- EVOBC category candidate ID: `evobc-evo-cat-03690`
- External category reference: `evobc-cat-03690`
- Source category ID: `03690`
- Source label for human review: `旭`
- Source codepoints: `U+65ED`
...
- `obs-evo-cand-003690-route-category-staging`
...
- `obs-evo-cand-003690-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003690-route-evolution-graph`
