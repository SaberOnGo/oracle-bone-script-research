...
- Yingguo / 英国所藏: `y566` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `97` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `364` in source row; primary catalog entry pending
- Heji / 合集: `39874` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000096`
