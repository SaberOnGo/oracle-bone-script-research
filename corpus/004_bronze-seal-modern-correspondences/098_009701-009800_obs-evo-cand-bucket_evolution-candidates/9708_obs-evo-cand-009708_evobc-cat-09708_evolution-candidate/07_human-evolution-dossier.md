...
- External category reference: `evobc-cat-09708`
- Source category ID: `09708`
- Source label for human review: `阵`
- Source codepoints: `U+9635`
...
- `obs-evo-cand-009708-route-category-staging`
...
- `obs-evo-cand-009708-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009708-route-evolution-graph`
