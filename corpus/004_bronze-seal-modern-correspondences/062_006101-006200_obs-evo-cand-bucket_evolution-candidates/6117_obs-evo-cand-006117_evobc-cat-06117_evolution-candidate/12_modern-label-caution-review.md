# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006117
...
- EVOBC candidate category: `evobc-evo-cat-06117`.
- Source label for search only: `稼`.
- Source codepoints for search only: `U+7A3C`.
