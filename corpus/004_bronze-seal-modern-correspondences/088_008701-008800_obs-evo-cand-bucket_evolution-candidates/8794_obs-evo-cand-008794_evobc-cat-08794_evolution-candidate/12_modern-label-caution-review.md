# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008794
...
- EVOBC candidate category: `evobc-evo-cat-08794`.
- Source label for search only: `軌`.
- Source codepoints for search only: `U+8ECC`.
