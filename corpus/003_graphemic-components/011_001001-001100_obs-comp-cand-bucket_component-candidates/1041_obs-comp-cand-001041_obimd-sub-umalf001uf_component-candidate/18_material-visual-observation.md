# Material Visual Observation / obs-comp-cand-001041 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001041`
- External reference / 外部参照: `obimd-sub-umalf001uf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014591_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/umalf001uf/umalf001uf/umalf001uf.png`
- Checksum / 校验和:
  `963f9b1d6c31f6b92feb9605d92bb24a87dd38db26db4085520f16ab3445e8f5`
...
- Marked-pixel bounds: (83,23)–(176,222); span 94 × 200 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.35%。
- 痕迹范围：(83,23)–(176,222)；跨度94 × 200 px；痕迹矩形高于宽。
