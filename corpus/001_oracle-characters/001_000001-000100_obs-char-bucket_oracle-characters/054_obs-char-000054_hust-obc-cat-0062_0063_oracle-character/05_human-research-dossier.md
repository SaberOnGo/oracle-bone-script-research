# obs-char-000054 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/054_obs-char-000054_hust-obc-cat-0062_0063
  _oracle-character/03_visual-assets/001_asset-000059_hust-obc-cat-0062_0063
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0062_0063/0062/H_0062_61070_0.p
  ng`
- asset id: `asset-000059`
...
- source category: `0062_0063`
- validation class: `53`
- source image route: `HUST-OBC/deciphered/0062_0063/0062/H_0062_61070_0.png`
- asset id: `asset-000059`
...
- English observation: `The image combines a broad crossed upper framework
  with a separate lower arched form and a central descending stroke.`
- 中文观察: `图像上方为宽大的交叉框架，下方有分离拱形体，中部有向下主笔画。`
...
- dataset label text: `㐴㐵`
- dataset label codepoints: `U+3434;U+3435`
...
- filename catalog route clues: `catalog-like filename clue: H_0062
  (H_0062_61070_0.png)`
...
- Which source records identify obs-char-000054 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000054？
