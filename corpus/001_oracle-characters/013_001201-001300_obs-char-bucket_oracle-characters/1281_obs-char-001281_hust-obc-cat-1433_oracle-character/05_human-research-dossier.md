# obs-char-001281 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1281_obs-char-001281_hust-obc-cat-1433_ora
  cle-character/03_visual-assets/001_asset-001286_hust-obc-cat-1433_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1433/L_1433_1575.jpg`
- asset id: `asset-001286`
...
- source category: `1433`
- validation class: `1280`
- source image route: `HUST-OBC/deciphered/1433/L_1433_1575.jpg`
- asset id: `asset-001286`
...
- English observation: `A small compact angular form has a short upper bar,
  a central descending stroke, and a long lower diagonal.`
- 中文观察: `小型紧凑折角形体有短上横笔、中央下行笔画和一条长下部斜笔。`
...
- dataset label text: `㦏`
- dataset label codepoints: `U+398F`
...
- Which source records identify obs-char-001281 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001281？
