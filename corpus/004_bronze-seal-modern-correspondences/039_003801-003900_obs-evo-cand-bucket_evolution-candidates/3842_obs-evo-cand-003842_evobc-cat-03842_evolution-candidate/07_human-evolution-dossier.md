...
Project ID: `obs-evo-cand-003842`
...
- Project ID: `obs-evo-cand-003842`
- EVOBC category candidate ID: `evobc-evo-cat-03842`
- External category reference: `evobc-cat-03842`
- Source category ID: `03842`
- Source label for human review: `朝`
- Source codepoints: `U+671D`
...
- `obs-evo-cand-003842-route-category-staging`
...
- `obs-evo-cand-003842-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003842-route-evolution-graph`
