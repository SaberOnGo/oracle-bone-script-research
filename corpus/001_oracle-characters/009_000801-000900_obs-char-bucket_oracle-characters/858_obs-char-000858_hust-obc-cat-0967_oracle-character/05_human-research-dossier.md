# obs-char-000858 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000858`
- primary external id: `hust-obc-cat-0967`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/858_obs-char-000858_hust-obc-cat-0967_orac
  le-character/03_visual-assets/001_asset-000863_hust-obc-cat-0967_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0967/G_0967_乙5317合1051賓組.png`
- asset id: `asset-000863`
...
- source category: `0967`
- validation class: `857`
- source image route: `HUST-OBC/deciphered/0967/G_0967_乙5317合1051賓組.png`
- asset id: `asset-000863`
...
- English observation: `A branching central-left cluster rises from a thin
  stem; several separate vertical strokes stand on the right.`
- 中文观察: `中央偏左分枝笔群从细笔干向上展开；右侧另有数条分离竖笔。`
...
- dataset label text: `㞽`
- dataset label codepoints: `U+37BD`
...
- filename catalog route clues: `Heji-like filename clue: 合1051
  (G_0967_乙5317合1051賓組.png)`
...
- Which source records identify obs-char-000858 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000858？
