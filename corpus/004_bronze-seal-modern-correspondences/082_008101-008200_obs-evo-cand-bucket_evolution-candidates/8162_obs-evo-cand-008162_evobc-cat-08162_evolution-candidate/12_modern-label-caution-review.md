# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008162
...
- Project ID: `obs-evo-cand-008162`.
- EVOBC candidate category: `evobc-evo-cat-08162`.
- Source label for search only: `証`.
- Source codepoints for search only: `U+8A3C`.
