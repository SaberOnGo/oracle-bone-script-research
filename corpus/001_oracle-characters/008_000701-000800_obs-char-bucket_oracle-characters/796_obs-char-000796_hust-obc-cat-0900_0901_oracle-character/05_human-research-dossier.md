# obs-char-000796 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000796`
- primary external id: `hust-obc-cat-0900_0901`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/796_obs-char-000796_hust-obc-cat-0900_0901
  _oracle-character/03_visual-assets/001_asset-000801_hust-obc-cat-0900_0901
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0900_0901/0901/G_0901_甲骨文0.png`
- asset id: `asset-000801`
...
- source category: `0900_0901`
- validation class: `795`
- source image route: `HUST-OBC/deciphered/0900_0901/0901/G_0901_甲骨文0.png`
- asset id: `asset-000801`
...
- English observation: `Two tall branching uprights descend into a lower
  rectangular frame divided by a horizontal bar, with short roots extending
  below the frame.`
- 中文观察: `两条高长分枝竖笔下接矩形下框，下框由横笔分隔，并向下伸出短根。`
...
- dataset label text: `㝺㝻`
- dataset label codepoints: `U+377A;U+377B`
...
- graph edge count: `2`
- codepoint routes: `U+377A;U+377B`
...
- Which source records identify obs-char-000796 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000796？
