# obs-char-001527 Visual Gallery / obs-char-001527 图像资料页
...
- Project ID / 项目 ID: `obs-char-001527`
- Primary external reference / 首选外部参考: `hust-obc-cat-1713`
...
## obs-char-001527-visual-source-001 / 图像条目

![obs-char-001527 glyph candidate](03_visual-assets/001_asset-001532_hust-obc-cat-1713_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-001532_hust-obc-cat-1713_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-001532_hust-obc-cat-1713_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/1713/G_1713_七76.png`
