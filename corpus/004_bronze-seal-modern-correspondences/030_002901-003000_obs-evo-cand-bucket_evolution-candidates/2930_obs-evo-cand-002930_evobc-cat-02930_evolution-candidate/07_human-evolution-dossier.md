...
- External category reference: `evobc-cat-02930`
- Source category ID: `02930`
- Source label for human review: `怋`
...
- `obs-evo-cand-002930-route-category-staging`
...
- `obs-evo-cand-002930-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002930-route-evolution-graph`
