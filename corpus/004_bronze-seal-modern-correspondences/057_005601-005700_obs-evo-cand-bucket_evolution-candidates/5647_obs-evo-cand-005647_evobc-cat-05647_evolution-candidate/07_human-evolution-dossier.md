...
Project ID: `obs-evo-cand-005647`
...
- Project ID: `obs-evo-cand-005647`
- EVOBC category candidate ID: `evobc-evo-cat-05647`
- External category reference: `evobc-cat-05647`
- Source category ID: `05647`
- Source label for human review: `痡`
- Source codepoints: `U+75E1`
...
- `obs-evo-cand-005647-route-category-staging`
...
- `obs-evo-cand-005647-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005647-route-evolution-graph`
