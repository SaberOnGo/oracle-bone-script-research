# obs-unk-004702 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/002_obs-unk-004702_h
  ust-obc-und-X-004702_oracle-character-candidate/03_visual-assets/001_asset
  -006295_hust-obc-und-X-004702_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/258/X_？_7231_1.png`
- asset id: `asset-006295`
...
- source class: `HUST-OBC/undeciphered/X/258/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/258/X_？_7231_1.png`
- asset id: `asset-006295`
...
- English observation: `upper openings with right branch and lower fragment`
- 中文观察: `带右侧分支和下部残片的上部开口组`
...
- Which source records identify obs-unk-004702 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004702？
