...
- External category reference: `evobc-cat-02849`
- Source category ID: `02849`
- Source label for human review: `彫`
- Source codepoints: `U+5F6B`
...
- `obs-evo-cand-002849-route-category-staging`
...
- `obs-evo-cand-002849-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002849-route-evolution-graph`
