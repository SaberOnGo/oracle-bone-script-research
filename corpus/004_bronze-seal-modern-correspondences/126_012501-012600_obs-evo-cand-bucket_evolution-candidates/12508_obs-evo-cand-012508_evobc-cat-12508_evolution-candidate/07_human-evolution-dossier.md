...
Project ID: `obs-evo-cand-012508`
...
- Project ID: `obs-evo-cand-012508`
- EVOBC category candidate ID: `evobc-evo-cat-12508`
- External category reference: `evobc-cat-12508`
- Source category ID: `12508`
- Source label for human review: `𨳾`
- Source codepoints: `U+28CFE`
...
- `obs-evo-cand-012508-route-category-staging`
...
- `obs-evo-cand-012508-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012508-route-evolution-graph`
