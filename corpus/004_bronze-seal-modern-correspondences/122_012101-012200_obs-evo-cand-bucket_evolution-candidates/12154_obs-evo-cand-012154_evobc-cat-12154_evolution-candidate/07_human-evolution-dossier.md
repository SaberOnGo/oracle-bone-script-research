...
Project ID: `obs-evo-cand-012154`
...
- Project ID: `obs-evo-cand-012154`
- EVOBC category candidate ID: `evobc-evo-cat-12154`
- External category reference: `evobc-cat-12154`
- Source category ID: `12154`
- Source label for human review: `𧊝`
- Source codepoints: `U+2729D`
...
- `obs-evo-cand-012154-route-category-staging`
...
- `obs-evo-cand-012154-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012154-route-evolution-graph`
