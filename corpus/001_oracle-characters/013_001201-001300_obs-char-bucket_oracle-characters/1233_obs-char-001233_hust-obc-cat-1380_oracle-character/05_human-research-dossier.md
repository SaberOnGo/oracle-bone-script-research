# obs-char-001233 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001233`
- primary external id: `hust-obc-cat-1380`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1233_obs-char-001233_hust-obc-cat-1380_ora
  cle-character/03_visual-assets/001_asset-001238_hust-obc-cat-1380_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1380/X_1380_5996_1.png`
- asset id: `asset-001238`
...
- source category: `1380`
- validation class: `1232`
- source image route: `HUST-OBC/deciphered/1380/X_1380_5996_1.png`
- asset id: `asset-001238`
...
- English observation: `A large branching form has a small upper arch, a
  long central curve, a broad lower arch, and several lower branches.`
- 中文观察: `大型分枝形体有小型上拱、中央长弯笔、宽大下拱和数条下部分枝。`
...
- dataset label text: `㥚`
- dataset label codepoints: `U+395A`
...
- Which source records identify obs-char-001233 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001233？
