# obs-char-000440 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/440_obs-char-000440_hust-obc-cat-0500_orac
  le-character/03_visual-assets/001_asset-000445_hust-obc-cat-0500_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0500/L_0500_6472.jpg`
- asset id: `asset-000445`
...
- source category: `0500`
- validation class: `439`
- source image route: `HUST-OBC/deciphered/0500/L_0500_6472.jpg`
- asset id: `asset-000445`
...
- English observation: `The very small low-resolution image shows a dense
  irregular cluster with several short crossings and two longer slanting
  strokes along the right side.`
...
- dataset label text: `㗪`
- dataset label codepoints: `U+35EA`
...
- Which source records identify obs-char-000440 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000440？
