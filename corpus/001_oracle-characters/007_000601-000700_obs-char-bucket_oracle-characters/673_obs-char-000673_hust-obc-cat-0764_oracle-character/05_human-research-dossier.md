# obs-char-000673 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000673`
- primary external id: `hust-obc-cat-0764`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/673_obs-char-000673_hust-obc-cat-0764_orac
  le-character/03_visual-assets/001_asset-000678_hust-obc-cat-0764_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0764/G_0764_乙6688合16335賓組.png`
- asset id: `asset-000678`
...
- source category: `0764`
- validation class: `672`
- source image route: `HUST-OBC/deciphered/0764/G_0764_乙6688合16335賓組.png`
- asset id: `asset-000678`
...
- English observation: `A slender upright is crossed near the upper middle
  by a long horizontal, sends a short branch to the right below it, and
  curves into a long pointed lower stroke.`
- 中文观察: `纤细直竖近上中部被长横穿过，其下向右伸短枝，并弯成长尖下笔。`
...
- dataset label text: `㛲`
- dataset label codepoints: `U+36F2`
...
- filename catalog route clues: `Heji-like filename clue: 合16335
  (G_0764_乙6688合16335賓組.png)`
...
- Which source records identify obs-char-000673 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000673？
