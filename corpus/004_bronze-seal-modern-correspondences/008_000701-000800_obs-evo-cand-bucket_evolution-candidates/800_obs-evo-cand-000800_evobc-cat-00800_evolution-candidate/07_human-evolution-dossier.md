...
- External category reference: `evobc-cat-00800`
- Source category ID: `00800`
- Source label for human review: `住`
...
- `obs-evo-cand-000800-route-category-staging`
...
- `obs-evo-cand-000800-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000800-route-evolution-graph`
