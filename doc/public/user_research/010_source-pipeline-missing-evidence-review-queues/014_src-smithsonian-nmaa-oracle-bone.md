...
- Review draft ID / 复核草稿 ID: `source-pipeline-missing-evidence-review-draft-014`
...
- Pipeline gap status / 流水线缺口状态: `needs_access_boundary_review`
...
- `source-pipeline-phase-action-missing-evidence-route-017`

### Action IDs / 动作 ID

- `source-pipeline-phase-action-missing-evidence-017`

### Result scaffold IDs / 结果脚手架 ID

- `source-pipeline-phase-action-missing-evidence-result-017`
...
- downloaded_metadata_profile_row_count: `3`
- large_source_register_row_count: `0`
- source_download_log_row_count: `2`
- source_field_map_row_count: `3`
- source_package_file_manifest_row_count: `1`
- all_sources_review_status_counts: `reviewed:1`
- metadata_profile_ids: `metadata-profile-000031;metadata-`
  `profile-000032;metadata-profile-000033`
- large_source_package_ids: `none`
- source_download_log_ids: `dl-smithsonian-nmaa-fsc-o-28;dl-smithsonian-nmaa-`
  `fsc-o-26-archive`
- source_field_map_ids: `field-map-000043;field-map-000044;field-map-000045`
- source_package_file_ids: `pkg-file-000028`
...
- download log ids / 下载记录 ID: `dl-smithsonian-nmaa-fsc-o-28;dl-smithsonian-`
  `nmaa-fsc-o-26-archive`
- metadata profile ids / metadata profile ID: `metadata-`
  `profile-000031;metadata-profile-000032;metadata-profile-000033`
- large source package ids / 大型来源包 ID: `none`
- source field map ids / 字段映射 ID: `field-map-000043;field-map-000044;field-`
  `map-000045`
- package file ids / package file ID: `pkg-file-000028`
