...
- External category reference: `evobc-cat-10080`
- Source category ID: `10080`
- Source label for human review: `飞`
- Source codepoints: `U+98DE`
...
- `obs-evo-cand-010080-route-category-staging`
...
- `obs-evo-cand-010080-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010080-route-evolution-graph`
