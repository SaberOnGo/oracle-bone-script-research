# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000855
...
- EVOBC candidate category: `evobc-evo-cat-00855`.
- Source label for search only: `依`.
- Source codepoints for search only: `U+4F9D`.
