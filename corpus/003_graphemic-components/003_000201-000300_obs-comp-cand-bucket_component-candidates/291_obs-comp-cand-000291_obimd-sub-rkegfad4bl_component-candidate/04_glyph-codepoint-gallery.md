# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000291
...
| --- | --- | --- | --- |
| `obimd-glyph-link-004072` | 򳁦󱨺 | `U+B3066;U+F1A3A` | `reviewed_metadata_only` |
| `obimd-glyph-link-004073` | 󱨻 | `U+F1A3B` | `reviewed_metadata_only` |
| `obimd-glyph-link-004074` | 󱨼 | `U+F1A3C` | `reviewed_metadata_only` |
| `obimd-glyph-link-004075` | 󱨾 | `U+F1A3E` | `reviewed_metadata_only` |
