# obs-xwalk-cand-000791 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+3775` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-0895` | not reading |
| OBIMD route / OBIMD 路线 | `obimd-main-cand-000853` | not component |
| EVOBC route / EVOBC 路线 | `evobc-evo-cat-00078` | not evolution |
