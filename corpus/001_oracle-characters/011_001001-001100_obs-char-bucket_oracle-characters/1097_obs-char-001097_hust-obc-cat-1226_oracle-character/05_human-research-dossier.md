# obs-char-001097 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1097_obs-char-001097_hust-obc-cat-1226_ora
  cle-character/03_visual-assets/001_asset-001102_hust-obc-cat-1226_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1226/G_1226_合387反(甲).png`
- asset id: `asset-001102`
...
- source category: `1226`
- validation class: `1096`
- source image route: `HUST-OBC/deciphered/1226/G_1226_合387反(甲).png`
- asset id: `asset-001102`
...
- English observation: `A dense upright cluster has two short upper
  branches, a rounded central enclosure, and lower side strokes.`
- 中文观察: `密集直立笔群有两条短上部分枝、圆弧中央闭合轮廓和下部侧笔。`
...
- dataset label text: `㣀`
- dataset label codepoints: `U+38C0`
...
- filename catalog route clues: `Heji-like filename clue: 合387
  (G_1226_合387反(甲).png)`
...
- Which source records identify obs-char-001097 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001097？
