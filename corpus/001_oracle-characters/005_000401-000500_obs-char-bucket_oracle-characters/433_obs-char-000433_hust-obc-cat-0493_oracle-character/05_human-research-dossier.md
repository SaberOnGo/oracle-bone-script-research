# obs-char-000433 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000433`
- primary external id: `hust-obc-cat-0493`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/433_obs-char-000433_hust-obc-cat-0493_orac
  le-character/03_visual-assets/001_asset-000438_hust-obc-cat-0493_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0493/G_0493_前2.19.6合36961黃組.png
  `
- asset id: `asset-000438`
...
- source category: `0493`
- validation class: `432`
- source image route: `HUST-OBC/deciphered/0493/G_0493_前2.19.6合36961黃組.png`
- asset id: `asset-000438`
...
- English observation: `The very small image shows a narrow vertical form
  with short branching strokes near the top and a compact crossed cluster in
  the middle.`
- 中文观察: `极小图像显示狭长竖向形体，上部有短分支笔画，中部为紧凑交叉笔画群。`
...
- dataset label text: `㗣`
- dataset label codepoints: `U+35E3`
...
- filename catalog route clues: `Heji-like filename clue: 合36961
  (G_0493_前2.19.6合36961黃組.png)`
...
- Which source records identify obs-char-000433 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000433？
