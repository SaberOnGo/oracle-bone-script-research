...
- External category reference: `evobc-cat-11133`
- Source category ID: `11133`
- Source label for human review: `𡿯`
- Source codepoints: `U+21FEF`
...
- `obs-evo-cand-011133-route-category-staging`
...
- `obs-evo-cand-011133-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011133-route-evolution-graph`
