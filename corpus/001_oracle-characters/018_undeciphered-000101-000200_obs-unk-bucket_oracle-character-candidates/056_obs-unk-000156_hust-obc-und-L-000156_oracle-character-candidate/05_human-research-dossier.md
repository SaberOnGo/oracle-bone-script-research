# obs-unk-000156 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/018_undeciphered-000
  101-000200_obs-unk-bucket_oracle-character-candidates/056_obs-unk-000156_h
  ust-obc-und-L-000156_oracle-character-candidate/03_visual-assets/001_asset
  -001749_hust-obc-und-L-000156_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/156/L_？_1050.jpg`
- asset id: `asset-001749`
...
- source class: `HUST-OBC/undeciphered/L/156/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/156/L_？_1050.jpg`
- asset id: `asset-001749`
...
- Which source records identify obs-unk-000156 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000156？
