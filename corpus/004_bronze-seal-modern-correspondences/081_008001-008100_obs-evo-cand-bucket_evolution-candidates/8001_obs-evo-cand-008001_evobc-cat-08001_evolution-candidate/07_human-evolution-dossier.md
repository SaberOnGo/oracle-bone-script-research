...
- External category reference: `evobc-cat-08001`
- Source category ID: `08001`
- Source label for human review: `褊`
...
- `obs-evo-cand-008001-route-category-staging`
...
- `obs-evo-cand-008001-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008001-route-evolution-graph`
