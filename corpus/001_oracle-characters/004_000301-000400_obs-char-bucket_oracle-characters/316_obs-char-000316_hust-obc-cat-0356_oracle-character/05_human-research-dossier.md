# obs-char-000316 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000316`
- primary external id: `hust-obc-cat-0356`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/316_obs-char-000316_hust-obc-cat-0356_orac
  le-character/03_visual-assets/001_asset-000321_hust-obc-cat-0356_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0356/G_0356_京津2445合18312賓組.png`
- asset id: `asset-000321`
...
- source category: `0356`
- validation class: `315`
- source image route: `HUST-OBC/deciphered/0356/G_0356_京津2445合18312賓組.png`
- asset id: `asset-000321`
...
- English observation: `The image combines a small left rounded form with a
  tall angular right form, crossing central strokes, and a hooked lower
  curve.`
- 中文观察: `图像左侧有小型圆弧形体，右侧为高直折角形体，中部笔画相交，下方有钩状弧笔画。`
...
- dataset label text: `㕚`
- dataset label codepoints: `U+355A`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00027`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00027`
- EvoBC image reference count / EvoBC 图像引用数: `14`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00027`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/027_obs-evo-can
  d-000027_evobc-cat-00027_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/027_obs-evo-cand-000027_evobc-cat-00027_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合18312
  (G_0356_京津2445合18312賓組.png)`
...
- Which source records identify obs-char-000316 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000316？
