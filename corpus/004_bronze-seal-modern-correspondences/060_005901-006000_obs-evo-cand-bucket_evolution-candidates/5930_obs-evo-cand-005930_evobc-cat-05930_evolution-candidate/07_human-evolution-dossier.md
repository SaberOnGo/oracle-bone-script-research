...
Project ID: `obs-evo-cand-005930`
...
- Project ID: `obs-evo-cand-005930`
- EVOBC category candidate ID: `evobc-evo-cat-05930`
- External category reference: `evobc-cat-05930`
- Source category ID: `05930`
- Source label for human review: `碩`
- Source codepoints: `U+78A9`
...
- `obs-evo-cand-005930-route-category-staging`
...
- `obs-evo-cand-005930-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005930-route-evolution-graph`
