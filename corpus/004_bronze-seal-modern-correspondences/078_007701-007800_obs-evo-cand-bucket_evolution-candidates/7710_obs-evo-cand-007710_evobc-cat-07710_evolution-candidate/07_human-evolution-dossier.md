...
- Project ID: `obs-evo-cand-007710`
- EVOBC category candidate ID: `evobc-evo-cat-07710`
- External category reference: `evobc-cat-07710`
- Source category ID: `07710`
- Source label for human review: `虤`
- Source codepoints: `U+8664`
...
- `obs-evo-cand-007710-route-category-staging`
...
- `obs-evo-cand-007710-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007710-route-evolution-graph`
