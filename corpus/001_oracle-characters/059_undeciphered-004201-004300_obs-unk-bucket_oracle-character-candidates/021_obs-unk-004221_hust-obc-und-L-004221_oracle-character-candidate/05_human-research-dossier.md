# obs-unk-004221 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/021_obs-unk-004221_h
  ust-obc-und-L-004221_oracle-character-candidate/03_visual-assets/001_asset
  -005814_hust-obc-und-L-004221_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4221/L_？_9227.jpg`
- asset id: `asset-005814`
...
- source class: `HUST-OBC/undeciphered/L/4221/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4221/L_？_9227.jpg`
- asset id: `asset-005814`
...
- English observation: `Left outline, inner bars, right curved stroke visible.`
- 中文观察: `左侧开放轮廓、内部横笔画和右侧弯曲笔画可见。`
...
- Which source records identify obs-unk-004221 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004221？
