...
The observed fields may support a source-marked museum metadata route. They do
not support an image claim, inscription identity, reading, component assignment,
rights clearance, or decipherment.

这些观察字段只能支持带来源标记的博物馆 metadata 路线，不能支持图像结论、卜辞身份、释读、构件归属、权利清理或破译结论。
