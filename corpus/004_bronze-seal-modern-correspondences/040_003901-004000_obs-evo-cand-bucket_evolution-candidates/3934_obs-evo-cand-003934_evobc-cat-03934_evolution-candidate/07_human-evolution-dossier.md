...
Project ID: `obs-evo-cand-003934`
...
- Project ID: `obs-evo-cand-003934`
- EVOBC category candidate ID: `evobc-evo-cat-03934`
- External category reference: `evobc-cat-03934`
- Source category ID: `03934`
- Source label for human review: `枱`
- Source codepoints: `U+67B1`
...
- `obs-evo-cand-003934-route-category-staging`
...
- `obs-evo-cand-003934-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003934-route-evolution-graph`
