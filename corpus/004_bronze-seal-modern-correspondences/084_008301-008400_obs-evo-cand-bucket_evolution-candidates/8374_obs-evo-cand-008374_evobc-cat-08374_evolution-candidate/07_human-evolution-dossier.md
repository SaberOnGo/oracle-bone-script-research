...
- Project ID: `obs-evo-cand-008374`
- EVOBC category candidate ID: `evobc-evo-cat-08374`
- External category reference: `evobc-cat-08374`
- Source category ID: `08374`
- Source label for human review: `譴`
- Source codepoints: `U+8B74`
...
- `obs-evo-cand-008374-route-category-staging`
...
- `obs-evo-cand-008374-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008374-route-evolution-graph`
