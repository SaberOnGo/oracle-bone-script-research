...
- External category reference: `evobc-cat-02652`
- Source category ID: `02652`
- Source label for human review: `帛`
...
- `obs-evo-cand-002652-route-category-staging`
...
- `obs-evo-cand-002652-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002652-route-evolution-graph`
