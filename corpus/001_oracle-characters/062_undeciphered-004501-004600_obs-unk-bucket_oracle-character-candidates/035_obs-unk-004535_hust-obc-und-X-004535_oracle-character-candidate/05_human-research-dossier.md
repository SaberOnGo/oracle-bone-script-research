# obs-unk-004535 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/035_obs-unk-004535_h
  ust-obc-und-X-004535_oracle-character-candidate/03_visual-assets/001_asset
  -006128_hust-obc-und-X-004535_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/91/X_？_7210_1.png`
- asset id: `asset-006128`
...
- source class: `HUST-OBC/undeciphered/X/91/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/91/X_？_7210_1.png`
- asset id: `asset-006128`
...
- English observation: `Forked stem, slants, and lower branches recorded.`
- 中文观察: `已记录分叉长痕、斜向痕迹和下部分支。`
...
- Which source records identify obs-unk-004535 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004535？
