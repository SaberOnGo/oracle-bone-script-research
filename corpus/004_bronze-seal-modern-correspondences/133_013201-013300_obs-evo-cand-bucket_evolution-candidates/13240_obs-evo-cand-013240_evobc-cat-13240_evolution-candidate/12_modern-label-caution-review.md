# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013240
...
- EVOBC candidate category: `evobc-evo-cat-13240`.
- Source label for search only: `𬌪`.
- Source codepoints for search only: `U+2C32A`.
