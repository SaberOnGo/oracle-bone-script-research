...
- External category reference: `evobc-cat-02777`
- Source category ID: `02777`
- Source label for human review: `廷`
- Source codepoints: `U+5EF7`
- Image reference count in source metadata: `162`
...
- `obs-evo-cand-002777-route-category-staging`
...
- `obs-evo-cand-002777-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002777-route-evolution-graph`
