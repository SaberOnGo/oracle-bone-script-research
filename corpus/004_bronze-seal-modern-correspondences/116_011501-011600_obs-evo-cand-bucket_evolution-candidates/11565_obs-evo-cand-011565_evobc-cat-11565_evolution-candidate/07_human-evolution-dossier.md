...
- External category reference: `evobc-cat-11565`
- Source category ID: `11565`
- Source label for human review: `𤋀`
...
- `obs-evo-cand-011565-route-category-staging`
...
- `obs-evo-cand-011565-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011565-route-evolution-graph`
