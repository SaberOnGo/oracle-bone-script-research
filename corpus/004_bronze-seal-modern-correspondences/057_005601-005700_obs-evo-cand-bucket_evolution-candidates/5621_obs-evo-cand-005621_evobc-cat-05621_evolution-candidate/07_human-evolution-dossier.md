...
- External category reference: `evobc-cat-05621`
- Source category ID: `05621`
- Source label for human review: `疳`
...
- `obs-evo-cand-005621-route-category-staging`
...
- `obs-evo-cand-005621-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005621-route-evolution-graph`
