# Material Visual Observation / obs-comp-cand-001094 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001094`
- External reference / 外部参照: `obimd-sub-y8fa87ilz9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014903_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/t1wd9fiznl/y8fa87ilz9/y8fa87ilz9.png`
- Checksum / 校验和:
  `782538309fc10c2c2d478ad1db7f0e12a36d1e0ca7de79b0e21e19add672514a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.26%.
- Marked-pixel bounds: (87,48)–(162,205); span 76 × 158 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.26%。
- 痕迹范围：(87,48)–(162,205)；跨度76 × 158 px；痕迹矩形高于宽。
