# obs-unk-003001 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003001`
- primary external id: `hust-obc-und-L-003001`
...
- local review image route: `corpus/001_oracle-characters/047_undeciphered-003
  001-003100_obs-unk-bucket_oracle-character-candidates/001_obs-unk-003001_h
  ust-obc-und-L-003001_oracle-character-candidate/03_visual-assets/001_asset
  -004594_hust-obc-und-L-003001_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3001/L_？_5324.jpg`
- asset id: `asset-004594`
...
- source class: `HUST-OBC/undeciphered/L/3001/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3001/L_？_5324.jpg`
- asset id: `asset-004594`
...
- Which source records identify obs-unk-003001 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003001？
