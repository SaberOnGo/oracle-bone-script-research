...
- External category reference: `evobc-cat-06616`
- Source category ID: `06616`
- Source label for human review: `緸`
...
- `obs-evo-cand-006616-route-category-staging`
...
- `obs-evo-cand-006616-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006616-route-evolution-graph`
