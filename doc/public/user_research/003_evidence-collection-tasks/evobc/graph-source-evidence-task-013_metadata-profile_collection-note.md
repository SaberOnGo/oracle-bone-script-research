...
- Evidence collection task ID / 证据收集任务 ID: `graph-source-evidence-task-013`
...
- Target evidence section / 目标证据章节: `metadata_profile`
- Collection scope / 收集范围: `collect_metadata_profile_metrics_and_cautions`
- Expected output path from task queue / 任务队列预期输出路径: `doc/public/user_research/003_evidence-collection-tasks/evobc/graph-source-evidence-task-013_metadata-profile_collection-note.md`
...
- Collection scope / 收集范围:
  - `collect_metadata_profile_metrics_and_cautions`
- Task status / 任务状态:
  - `not_started`
