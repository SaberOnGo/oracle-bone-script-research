...
- Project ID: `obs-evo-cand-002939`
- EVOBC category candidate ID: `evobc-evo-cat-02939`
- External category reference: `evobc-cat-02939`
- Source category ID: `02939`
- Source label for human review: `怛`
- Source codepoints: `U+601B`
...
- `obs-evo-cand-002939-route-category-staging`
...
- `obs-evo-cand-002939-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002939-route-evolution-graph`
