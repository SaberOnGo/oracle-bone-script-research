# obs-char-001162 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1162_obs-char-001162_hust-obc-cat-1301_ora
  cle-character/03_visual-assets/001_asset-001167_hust-obc-cat-1301_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1301/G_1301_甲587合31759何組.png`
- asset id: `asset-001167`
...
- source category: `1301`
- validation class: `1161`
- source image route: `HUST-OBC/deciphered/1301/G_1301_甲587合31759何組.png`
- asset id: `asset-001167`
...
- English observation: `A narrow vertical form has a short upper
  cross-stroke, a small central square enclosure, and a lower hook.`
- 中文观察: `狭长竖向形体有短上部横笔、小型中央方形框廓和下部钩笔。`
...
- dataset label text: `㤋`
- dataset label codepoints: `U+390B`
...
- filename catalog route clues: `Heji-like filename clue: 合31759
...
- Which source records identify obs-char-001162 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001162？
