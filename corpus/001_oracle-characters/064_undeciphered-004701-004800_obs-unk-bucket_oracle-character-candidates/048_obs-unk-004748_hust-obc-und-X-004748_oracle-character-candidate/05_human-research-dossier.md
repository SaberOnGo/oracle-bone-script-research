# obs-unk-004748 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004748`
- primary external id: `hust-obc-und-X-004748`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/048_obs-unk-004748_h
  ust-obc-und-X-004748_oracle-character-candidate/03_visual-assets/001_asset
  -006341_hust-obc-und-X-004748_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/304/X_？_7110_1.png`
- asset id: `asset-006341`
...
- source class: `HUST-OBC/undeciphered/X/304/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/304/X_？_7110_1.png`
- asset id: `asset-006341`
...
- English observation: `rounded upper opening with two lower curves`
- 中文观察: `带下部两条弯曲笔画的上部圆钝开口`
...
- Which source records identify obs-unk-004748 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004748？
