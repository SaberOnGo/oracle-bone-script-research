# obs-unk-004776 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/076_obs-unk-004776_h
  ust-obc-und-X-004776_oracle-character-candidate/03_visual-assets/001_asset
  -006369_hust-obc-und-X-004776_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/332/X_？_7316_1.png`
- asset id: `asset-006369`
...
- source class: `HUST-OBC/undeciphered/X/332/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/332/X_？_7316_1.png`
- asset id: `asset-006369`
...
- English observation: `curved upper stroke and tall right-side terminal`
- 中文观察: `上部弯曲笔画和右侧高长末端`
...
- Which source records identify obs-unk-004776 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004776？
