# Material Visual Observation / obs-comp-cand-002364 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002364`
- External reference / 外部参照: `obimd-sub-9x6rmfgsol`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020435_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/j0cf8hrkjw/9x6rmfgsol/9x6rmfgsol.png`
- Checksum / 校验和:
  `535a39944152831160c8438cfde87fbe30403a47dace1cde245369ab4f808022`
...
- Marked-pixel bounds: (61,64)–(188,183); span 128 × 120 px; the marked
...
- 痕迹范围：(61,64)–(188,183)；跨度128 × 120 px；痕迹矩形近方形。
