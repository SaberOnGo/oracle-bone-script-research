...
- External category reference: `evobc-cat-08090`
- Source category ID: `08090`
- Source label for human review: `觉`
...
- `obs-evo-cand-008090-route-category-staging`
...
- `obs-evo-cand-008090-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008090-route-evolution-graph`
