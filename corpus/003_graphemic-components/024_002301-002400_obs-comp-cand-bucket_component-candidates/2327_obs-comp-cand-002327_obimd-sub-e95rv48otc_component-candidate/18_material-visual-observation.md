# Material Visual Observation / obs-comp-cand-002327 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002327`
- External reference / 外部参照: `obimd-sub-e95rv48otc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020346_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/e95rv48otc/e95rv48otc/e95rv48otc.png`
- Checksum / 校验和:
  `be234e330a1a0209316d51f2ddd2b0763aa16c6693b5f862f5707bc83f1e72d8`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.64%.
- Marked-pixel bounds: (77,37)–(173,210); span 97 × 174 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.64%。
- 痕迹范围：(77,37)–(173,210)；跨度97 × 174 px；痕迹矩形高于宽。
