# obs-unk-003966 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003966`
- primary external id: `hust-obc-und-L-003966`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/066_obs-unk-003966_h
  ust-obc-und-L-003966_oracle-character-candidate/03_visual-assets/001_asset
  -005559_hust-obc-und-L-003966_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3966/L_？_8377.jpg`
- asset id: `asset-005559`
...
- source class: `HUST-OBC/undeciphered/L/3966/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3966/L_？_8377.jpg`
- asset id: `asset-005559`
...
- English observation: Sharp upper angles sit above a darker trace and a broad
  lower bar with a short angled mark below.
- 中文观察：尖锐上部折角位于较深痕迹和较宽下部横痕之上，横痕下有短斜痕。
...
- Which source records identify obs-unk-003966 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003966？
