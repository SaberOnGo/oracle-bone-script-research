# obs-unk-004309 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/009_obs-unk-004309_h
  ust-obc-und-L-004309_oracle-character-candidate/03_visual-assets/001_asset
  -005902_hust-obc-und-L-004309_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4309/L_？_9504.jpg`
- asset id: `asset-005902`
...
- source class: `HUST-OBC/undeciphered/L/4309/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4309/L_？_9504.jpg`
- asset id: `asset-005902`
...
- English observation: `Outer curve, inner descents, uneven edges visible.`
- 中文观察: `外部弧形轮廓、内部下行痕迹和不均匀下缘可见。`
...
- Which source records identify obs-unk-004309 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004309？
