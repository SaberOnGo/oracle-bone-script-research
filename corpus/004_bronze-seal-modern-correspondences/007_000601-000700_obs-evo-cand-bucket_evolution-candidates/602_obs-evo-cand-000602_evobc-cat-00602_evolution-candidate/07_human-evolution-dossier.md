...
- External category reference: `evobc-cat-00602`
- Source category ID: `00602`
...
- `obs-evo-cand-000602-route-category-staging`
...
- `obs-evo-cand-000602-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000602-route-evolution-graph`
