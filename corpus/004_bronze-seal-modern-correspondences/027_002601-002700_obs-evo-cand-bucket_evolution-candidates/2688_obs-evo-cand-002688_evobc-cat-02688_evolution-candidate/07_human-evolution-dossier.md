...
- Project ID: `obs-evo-cand-002688`
- EVOBC category candidate ID: `evobc-evo-cat-02688`
- External category reference: `evobc-cat-02688`
- Source category ID: `02688`
- Source label for human review: `幨`
- Source codepoints: `U+5E68`
...
- `obs-evo-cand-002688-route-category-staging`
...
- `obs-evo-cand-002688-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002688-route-evolution-graph`
