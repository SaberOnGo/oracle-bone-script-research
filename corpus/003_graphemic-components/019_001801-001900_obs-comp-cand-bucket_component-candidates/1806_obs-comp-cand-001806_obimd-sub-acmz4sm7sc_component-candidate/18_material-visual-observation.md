# Material Visual Observation / obs-comp-cand-001806 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001806`
- External reference / 外部参照: `obimd-sub-acmz4sm7sc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018027_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tvnicmgqzf/acmz4sm7sc/acmz4sm7sc.png`
- Checksum / 校验和:
  `d7083103ab6caddaedfe52629343294c6e5b9d28ad3fc5ebaa2bb012309fe7f9`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.50%.
- Marked-pixel bounds: (71,21)–(173,223); span 103 × 203 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.50%。
- 痕迹范围：(71,21)–(173,223)；跨度103 × 203 px；痕迹矩形高于宽。
