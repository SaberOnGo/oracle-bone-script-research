...
Project ID: `obs-evo-cand-010938`
...
- Project ID: `obs-evo-cand-010938`
- EVOBC category candidate ID: `evobc-evo-cat-10938`
- External category reference: `evobc-cat-10938`
- Source category ID: `10938`
- Source label for human review: `𠲋`
- Source codepoints: `U+20C8B`
...
- `obs-evo-cand-010938-route-category-staging`
...
- `obs-evo-cand-010938-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010938-route-evolution-graph`
