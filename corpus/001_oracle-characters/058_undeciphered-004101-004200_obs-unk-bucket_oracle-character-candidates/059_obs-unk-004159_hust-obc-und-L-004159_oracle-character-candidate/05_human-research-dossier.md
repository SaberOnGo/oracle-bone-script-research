# obs-unk-004159 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004159`
- primary external id: `hust-obc-und-L-004159`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/059_obs-unk-004159_h
  ust-obc-und-L-004159_oracle-character-candidate/03_visual-assets/001_asset
  -005752_hust-obc-und-L-004159_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4159/L_？_9012.jpg`
- asset id: `asset-005752`
...
- source class: `HUST-OBC/undeciphered/L/4159/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4159/L_？_9012.jpg`
- asset id: `asset-005752`
...
- English observation: A dense central cluster has short side marks and a
  tapered lower endpoint.
- 中文观察：密集中央痕迹簇带短侧痕，并向下收窄至末端。
...
- Which source records identify obs-unk-004159 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004159？
