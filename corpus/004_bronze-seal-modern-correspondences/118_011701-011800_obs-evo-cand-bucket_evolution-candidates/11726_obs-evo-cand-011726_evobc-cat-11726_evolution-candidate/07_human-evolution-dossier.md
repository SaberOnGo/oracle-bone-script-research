...
- External category reference: `evobc-cat-11726`
- Source category ID: `11726`
- Source label for human review: `𤺪`
...
- `obs-evo-cand-011726-route-category-staging`
...
- `obs-evo-cand-011726-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011726-route-evolution-graph`
