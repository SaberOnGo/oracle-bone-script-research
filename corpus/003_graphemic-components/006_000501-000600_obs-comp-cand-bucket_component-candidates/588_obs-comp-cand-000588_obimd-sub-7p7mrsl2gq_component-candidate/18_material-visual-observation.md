# Material Visual Observation / obs-comp-cand-000588 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000588`
- External reference / 外部参照: `obimd-sub-7p7mrsl2gq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013116_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/e19hd5tm0i/7p7mrsl2gq/7p7mrsl2gq.png`
- Checksum / 校验和:
  `1abcc677e8ebb509149392a36c20ee4f572f32e9dcd07d7ead9bc3cc33e1608c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.73%.
- Marked-pixel bounds: (76,38)–(173,210); span 98 × 173 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.73%。
- 痕迹范围：(76,38)–(173,210)；跨度98 × 173 px；痕迹矩形高于宽。
