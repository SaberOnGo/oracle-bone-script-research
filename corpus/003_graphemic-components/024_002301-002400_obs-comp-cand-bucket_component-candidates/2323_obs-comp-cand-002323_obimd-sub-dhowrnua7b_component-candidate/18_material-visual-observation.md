# Material Visual Observation / obs-comp-cand-002323 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002323`
- External reference / 外部参照: `obimd-sub-dhowrnua7b`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020342_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wil5zsif77/dhowrnua7b/dhowrnua7b.png`
- Checksum / 校验和:
  `8d0339c23ac91beec975f46d91c52f16f82174990a7dd6001cec521606a61571`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.74%.
- Marked-pixel bounds: (79,38)–(167,204); span 89 × 167 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.74%。
- 痕迹范围：(79,38)–(167,204)；跨度89 × 167 px；痕迹矩形高于宽。
