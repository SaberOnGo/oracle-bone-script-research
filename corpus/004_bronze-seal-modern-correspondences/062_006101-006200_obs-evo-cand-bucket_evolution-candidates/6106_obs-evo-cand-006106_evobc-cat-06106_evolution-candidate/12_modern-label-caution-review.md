# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006106
...
- Project ID: `obs-evo-cand-006106`.
- EVOBC candidate category: `evobc-evo-cat-06106`.
- Source label for search only: `稬`.
- Source codepoints for search only: `U+7A2C`.
