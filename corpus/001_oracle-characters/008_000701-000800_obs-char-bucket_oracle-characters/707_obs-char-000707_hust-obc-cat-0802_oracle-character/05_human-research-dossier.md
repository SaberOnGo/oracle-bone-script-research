# obs-char-000707 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000707`
- primary external id: `hust-obc-cat-0802`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/707_obs-char-000707_hust-obc-cat-0802_orac
  le-character/03_visual-assets/001_asset-000712_hust-obc-cat-0802_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0802/G_0802_乙3468合10613賓組.png`
- asset id: `asset-000712`
...
- source category: `0802`
- validation class: `706`
- source image route: `HUST-OBC/deciphered/0802/G_0802_乙3468合10613賓組.png`
- asset id: `asset-000712`
...
- English observation: `A small detached loop with an inner bar sits at
  upper left and a dark forked loop at upper right; many thin curved strokes
  spread downward from their central junction.`
...
- dataset label text: `㜘`
- dataset label codepoints: `U+3718`
...
- filename catalog route clues: `Heji-like filename clue: 合10613
...
- Which source records identify obs-char-000707 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000707？
