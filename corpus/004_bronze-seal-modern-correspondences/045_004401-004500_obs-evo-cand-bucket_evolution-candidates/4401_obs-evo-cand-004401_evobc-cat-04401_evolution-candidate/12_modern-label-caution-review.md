# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004401
...
- EVOBC candidate category: `evobc-evo-cat-04401`.
- Source label for search only: `死`.
- Source codepoints for search only: `U+6B7B`.
