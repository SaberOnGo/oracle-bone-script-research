# obs-unk-004205 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/005_obs-unk-004205_h
  ust-obc-und-L-004205_oracle-character-candidate/03_visual-assets/001_asset
  -005798_hust-obc-und-L-004205_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4205/L_？_9160.jpg`
- asset id: `asset-005798`
...
- source class: `HUST-OBC/undeciphered/L/4205/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4205/L_？_9160.jpg`
- asset id: `asset-005798`
...
- English observation: `Upper outline, inner traces, and lower strokes visible.`
- 中文观察: `上部轮廓、内部痕迹和两条下部笔画可见。`
...
- Which source records identify obs-unk-004205 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004205？
