# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008895
...
- EVOBC candidate category: `evobc-evo-cat-08895`.
- Source label for search only: `载`.
- Source codepoints for search only: `U+8F7D`.
