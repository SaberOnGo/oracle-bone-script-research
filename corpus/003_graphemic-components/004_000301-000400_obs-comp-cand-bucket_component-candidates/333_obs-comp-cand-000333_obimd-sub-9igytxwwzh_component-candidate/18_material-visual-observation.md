# Material Visual Observation / obs-comp-cand-000333 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000333`
- External reference / 外部参照: `obimd-sub-9igytxwwzh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012257_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9igytxwwzh/9igytxwwzh/9igytxwwzh.png`
- Checksum / 校验和:
  `abc3a5708d70239383e3717baf07507152c27c5c710a163b7fd3fff982e11574`
...
- Marked-pixel bounds: (65,29)–(184,220); span 120 × 192 px; the marked
...
- 痕迹范围：(65,29)–(184,220)；跨度120 × 192 px；痕迹矩形高于宽。
