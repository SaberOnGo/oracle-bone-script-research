...
- External category reference: `evobc-cat-02964`
- Source category ID: `02964`
- Source label for human review: `恂`
- Source codepoints: `U+6042`
...
- `obs-evo-cand-002964-route-category-staging`
...
- `obs-evo-cand-002964-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002964-route-evolution-graph`
