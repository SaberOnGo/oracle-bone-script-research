...
Project ID: `obs-evo-cand-004193`
...
- Project ID: `obs-evo-cand-004193`
- EVOBC category candidate ID: `evobc-evo-cat-04193`
- External category reference: `evobc-cat-04193`
- Source category ID: `04193`
- Source label for human review: `榹`
- Source codepoints: `U+69B9`
...
- `obs-evo-cand-004193-route-category-staging`
...
- `obs-evo-cand-004193-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004193-route-evolution-graph`
