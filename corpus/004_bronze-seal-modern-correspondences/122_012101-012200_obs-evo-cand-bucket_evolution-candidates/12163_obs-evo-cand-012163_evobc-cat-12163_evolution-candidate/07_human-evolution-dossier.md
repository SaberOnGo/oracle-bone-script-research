...
- External category reference: `evobc-cat-12163`
- Source category ID: `12163`
- Source label for human review: `𧎌`
...
- `obs-evo-cand-012163-route-category-staging`
...
- `obs-evo-cand-012163-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012163-route-evolution-graph`
