# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001684
...
| --- | --- | --- | --- |
| `obimd-glyph-link-026123` | 󹱐 | `U+F9C50` | `reviewed_metadata_only` |
| `obimd-glyph-link-026124` | 󹱑 | `U+F9C51` | `reviewed_metadata_only` |
