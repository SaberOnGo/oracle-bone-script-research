# obs-char-000322 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000322`
- primary external id: `hust-obc-cat-0364`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/322_obs-char-000322_hust-obc-cat-0364_orac
  le-character/03_visual-assets/001_asset-000327_hust-obc-cat-0364_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0364/X_0364_498_1.png`
- asset id: `asset-000327`
...
- source category: `0364`
- validation class: `321`
- source image route: `HUST-OBC/deciphered/0364/X_0364_498_1.png`
- asset id: `asset-000327`
...
- English observation: `A large dark rounded upper cluster sits on a long
  vertical stroke; smaller rounded marks flank it, with a crossbar and lower
  descending stroke.`
- 中文观察: `大型深色圆弧上部形体位于长直笔画之上，两侧有较小圆弧痕迹，下面有横笔画和下行笔画。`
...
- dataset label text: `㕢`
- dataset label codepoints: `U+3562`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00028`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00028`
- EvoBC image reference count / EvoBC 图像引用数: `20`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00028`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/028_obs-evo-can
  d-000028_evobc-cat-00028_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/028_obs-evo-cand-000028_evobc-cat-00028_evolu
...
- Which source records identify obs-char-000322 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000322？
