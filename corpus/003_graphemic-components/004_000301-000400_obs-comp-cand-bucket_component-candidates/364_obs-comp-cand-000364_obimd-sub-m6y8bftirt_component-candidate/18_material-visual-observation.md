# Material Visual Observation / obs-comp-cand-000364 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000364`
- External reference / 外部参照: `obimd-sub-m6y8bftirt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012287_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/m6y8bftirt/m6y8bftirt/m6y8bftirt.png`
- Checksum / 校验和:
  `9dab28b191d3210f97a8876732dfe0e687cb038bef78a159aa663831798ad450`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.88%.
- Marked-pixel bounds: (79,29)–(170,220); span 92 × 192 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.88%。
- 痕迹范围：(79,29)–(170,220)；跨度92 × 192 px；痕迹矩形高于宽。
