...
- External category reference: `evobc-cat-12899`
- Source category ID: `12899`
- Source label for human review: `𪾂`
...
- `obs-evo-cand-012899-route-category-staging`
...
- `obs-evo-cand-012899-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012899-route-evolution-graph`
