# Material Visual Observation / obs-comp-cand-001014 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001014`
- External reference / 外部参照: `obimd-sub-9aai46wd9w`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014477_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9aai46wd9w/9aai46wd9w/9aai46wd9w.png`
- Checksum / 校验和:
  `3b894c6645e0a7d8de65fe4342e2d75757967a4c33d5bc9f222256a529428035`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.91%.
- Marked-pixel bounds: (42,37)–(202,216); span 161 × 180 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.91%。
- 痕迹范围：(42,37)–(202,216)；跨度161 × 180 px；痕迹矩形近方形。
