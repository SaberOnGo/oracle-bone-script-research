...
- External category reference: `evobc-cat-12056`
- Source category ID: `12056`
- Source label for human review: `𦞦`
...
- `obs-evo-cand-012056-route-category-staging`
...
- `obs-evo-cand-012056-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012056-route-evolution-graph`
