# obs-comp-cand-001796 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001796`
- 首选外部 ID: `obimd-sub-n92bww8sym`
- OBIMD subcharacter UID: `n92bww8sym`
- OBIMD main character UID: `n92bww8sym`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `6`
- codepoint 示例: U+754B;U+FA51A; U+FA51B; 另有 4 项
