...
- `obs-evo-cand-008651-route-category-staging`
...
- `obs-evo-cand-008651-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008651-route-evolution-graph`
