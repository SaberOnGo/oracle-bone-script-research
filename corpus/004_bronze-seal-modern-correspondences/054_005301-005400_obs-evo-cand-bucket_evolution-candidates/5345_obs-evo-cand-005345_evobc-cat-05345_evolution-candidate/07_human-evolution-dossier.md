...
- External category reference: `evobc-cat-05345`
- Source category ID: `05345`
- Source label for human review: `王`
- Source codepoints: `U+738B`
- Image reference count in source metadata: `439`
...
- `obs-evo-cand-005345-route-category-staging`
...
- `obs-evo-cand-005345-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005345-route-evolution-graph`
