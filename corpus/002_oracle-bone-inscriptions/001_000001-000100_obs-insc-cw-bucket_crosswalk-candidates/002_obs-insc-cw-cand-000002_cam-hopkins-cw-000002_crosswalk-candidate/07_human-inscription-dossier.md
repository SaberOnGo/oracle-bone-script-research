...
Project ID: `obs-insc-cw-cand-000002`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000002`
...
- Yingguo / 英国所藏: `y13` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `24` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `703` in source row; primary catalog entry pending
- Heji / 合集: `39545` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000002`
