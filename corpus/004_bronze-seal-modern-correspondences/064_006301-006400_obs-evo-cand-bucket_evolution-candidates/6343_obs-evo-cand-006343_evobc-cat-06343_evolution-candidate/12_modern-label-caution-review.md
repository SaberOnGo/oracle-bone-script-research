# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006343
...
- EVOBC candidate category: `evobc-evo-cat-06343`.
- Source label for search only: `簌`.
- Source codepoints for search only: `U+7C0C`.
