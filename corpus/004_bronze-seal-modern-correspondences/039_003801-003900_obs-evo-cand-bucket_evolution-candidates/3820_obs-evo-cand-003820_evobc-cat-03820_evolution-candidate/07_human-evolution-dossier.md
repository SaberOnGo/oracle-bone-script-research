...
- External category reference: `evobc-cat-03820`
- Source category ID: `03820`
- Source label for human review: `曾`
...
- `obs-evo-cand-003820-route-category-staging`
...
- `obs-evo-cand-003820-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003820-route-evolution-graph`
