# obs-unk-008610 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/103_undeciphered-008
  601-008700_obs-unk-bucket_oracle-character-candidates/010_obs-unk-008610_h
  ust-obc-und-YH-008610_oracle-character-candidate/03_visual-assets/001_asse
  t-010201_hust-obc-und-YH-008610_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60C6C/H_？_60C6C_0.png`
- asset id: `asset-010201`
...
- source class: `HUST-OBC/undeciphered/Y+H/60C6C/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60C6C/H_？_60C6C_0.png`
- asset id: `asset-010201`
...
- Which source records identify obs-unk-008610 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008610？
