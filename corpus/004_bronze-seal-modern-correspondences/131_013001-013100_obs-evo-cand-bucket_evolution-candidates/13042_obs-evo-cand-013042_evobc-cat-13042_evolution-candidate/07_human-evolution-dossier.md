...
Project ID: `obs-evo-cand-013042`
...
- Project ID: `obs-evo-cand-013042`
- EVOBC category candidate ID: `evobc-evo-cat-13042`
- External category reference: `evobc-cat-13042`
- Source category ID: `13042`
- Source label for human review: `𫨗`
- Source codepoints: `U+2BA17`
...
- `obs-evo-cand-013042-route-category-staging`
...
- `obs-evo-cand-013042-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013042-route-evolution-graph`
