# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013036
...
- EVOBC candidate category: `evobc-evo-cat-13036`.
- Source label for search only: `𫧰`.
- Source codepoints for search only: `U+2B9F0`.
