...
- External category reference: `evobc-cat-06157`
- Source category ID: `06157`
- Source label for human review: `窈`
- Source codepoints: `U+7A88`
...
- `obs-evo-cand-006157-route-category-staging`
...
- `obs-evo-cand-006157-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006157-route-evolution-graph`
