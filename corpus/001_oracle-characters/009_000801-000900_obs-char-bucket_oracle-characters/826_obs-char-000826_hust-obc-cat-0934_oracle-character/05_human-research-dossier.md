# obs-char-000826 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000826`
- primary external id: `hust-obc-cat-0934`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/826_obs-char-000826_hust-obc-cat-0934_orac
  le-character/03_visual-assets/001_asset-000831_hust-obc-cat-0934_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0934/G_0934_乙7430合1248賓組.png`
- asset id: `asset-000831`
...
- source category: `0934`
- validation class: `825`
- source image route: `HUST-OBC/deciphered/0934/G_0934_乙7430合1248賓組.png`
- asset id: `asset-000831`
...
- English observation: `Thin parallel strokes at left accompany a central
  angular loop; a lower diagonal branch extends rightward, and fine joins
  are unclear.`
- 中文观察: `左侧细平行笔伴随中央折角环状痕迹；下方斜向分枝向右延伸，细连接难辨。`
...
- dataset label text: `㞜`
- dataset label codepoints: `U+379C`
...
- filename catalog route clues: `Heji-like filename clue: 合1248
  (G_0934_乙7430合1248賓組.png)`
...
- Which source records identify obs-char-000826 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000826？
