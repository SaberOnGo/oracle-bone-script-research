# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-000394
...
- candidate_component_id: `obs-comp-cand-000394`
- primary_external_ref_id: `obimd-sub-at88lnryep`
- source_subcharacter_uid: `at88lnryep`
- source_main_character_uid: `at88lnryep`
- main_character_external_ref_id: `obimd-main-at88lnryep`
...
- glyph_codepoint_uplus_sample: `U+C22B8;U+F24FD, U+F24FE, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-012317` | `001_asset-012317_img.png` | `4837ed993dec8b4e309dfaa76d06bc8bb208b0cd935ce6590bcb3eafbaa89270` |
