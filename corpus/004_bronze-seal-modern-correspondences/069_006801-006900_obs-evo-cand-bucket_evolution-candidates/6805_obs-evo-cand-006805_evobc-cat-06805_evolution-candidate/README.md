# obs-evo-cand-006805 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-06805`
- Source label for human review: `罝`
- Source codepoints: `U+7F5D`
- Image reference count: `62`
- Era token counts: `OBC:61;SS:1`
- Source token counts: `Book:18;Web:44`
