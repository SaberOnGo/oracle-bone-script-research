# obs-unk-004767 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004767`
- primary external id: `hust-obc-und-X-004767`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/067_obs-unk-004767_h
  ust-obc-und-X-004767_oracle-character-candidate/03_visual-assets/001_asset
  -006360_hust-obc-und-X-004767_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/323/X_？_7308_1.png`
- asset id: `asset-006360`
...
- source class: `HUST-OBC/undeciphered/X/323/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/323/X_？_7308_1.png`
- asset id: `asset-006360`
...
- English observation: `left opening and separate right triangular group`
- 中文观察: `左侧开口和分离的右侧三角结构`
...
- Which source records identify obs-unk-004767 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004767？
