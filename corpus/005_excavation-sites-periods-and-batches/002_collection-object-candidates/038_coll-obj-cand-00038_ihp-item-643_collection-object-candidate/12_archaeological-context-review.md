# Archaeological Context Review / 考古语境复核: coll-obj-cand-00038
...
| Source item | `643` | `01_collection-object-packet.json` |
| Catalog description | `Ping 0247` | `01_collection-object-packet.json` |
