# Material Visual Observation / obs-comp-cand-000595 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000595`
- External reference / 外部参照: `obimd-sub-dmiddz5ehl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013123_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dmiddz5ehl/dmiddz5ehl/dmiddz5ehl.png`
- Checksum / 校验和:
  `1965b8e1250ddace1fd2156c325e4c081308e2b2bc9ace3d3ae8be364e4e41aa`
...
- Marked-pixel bounds: (81,18)–(168,232); span 88 × 215 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.91%。
- 痕迹范围：(81,18)–(168,232)；跨度88 × 215 px；痕迹矩形高于宽。
