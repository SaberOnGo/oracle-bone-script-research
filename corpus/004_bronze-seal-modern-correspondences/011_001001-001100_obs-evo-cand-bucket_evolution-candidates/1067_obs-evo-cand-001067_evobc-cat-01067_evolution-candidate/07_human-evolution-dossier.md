...
- External category reference: `evobc-cat-01067`
- Source category ID: `01067`
- Source label for human review: `元`
- Source codepoints: `U+5143`
- Image reference count in source metadata: `198`
...
- `obs-evo-cand-001067-route-category-staging`
...
- `obs-evo-cand-001067-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001067-route-evolution-graph`
