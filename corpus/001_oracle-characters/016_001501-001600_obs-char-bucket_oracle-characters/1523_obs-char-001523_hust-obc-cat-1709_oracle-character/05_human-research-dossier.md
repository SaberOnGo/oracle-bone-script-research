# obs-char-001523 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1523_obs-char-001523_hust-obc-cat-1709_ora
  cle-character/03_visual-assets/001_asset-001528_hust-obc-cat-1709_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1709/G_1709_乙5350合7996賓組.png`
- asset id: `asset-001528`
...
- source category: `1709`
- validation class: `1522`
- source image route: `HUST-OBC/deciphered/1709/G_1709_乙5350合7996賓組.png`
- asset id: `asset-001528`
...
- English observation: `A small upright form has a forked upper end, a
  crossbar, and two lower legs.`
- 中文观察: `小型直立形体有分叉上端、横笔和两条下部支脚。`
...
- dataset label text: `㪣`
- dataset label codepoints: `U+3AA3`
...
- filename catalog route clues: `Heji-like filename clue: 合7996
  (G_1709_乙5350合7996賓組.png)`
...
- Which source records identify obs-char-001523 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001523？
