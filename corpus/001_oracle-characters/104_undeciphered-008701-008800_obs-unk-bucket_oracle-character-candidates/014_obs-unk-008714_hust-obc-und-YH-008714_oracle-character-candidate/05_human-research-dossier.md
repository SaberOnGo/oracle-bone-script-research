# obs-unk-008714 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/104_undeciphered-008
  701-008800_obs-unk-bucket_oracle-character-candidates/014_obs-unk-008714_h
  ust-obc-und-YH-008714_oracle-character-candidate/03_visual-assets/001_asse
  t-010305_hust-obc-und-YH-008714_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60D4D/Y_？_60D4D.jpg`
- asset id: `asset-010305`
...
- source class: `HUST-OBC/undeciphered/Y+H/60D4D/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60D4D/Y_？_60D4D.jpg`
- asset id: `asset-010305`
...
- Which source records identify obs-unk-008714 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008714？
