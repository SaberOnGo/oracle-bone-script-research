# Material Visual Observation / obs-comp-cand-002357 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002357`
- External reference / 外部参照: `obimd-sub-rp1zjtuksu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020428_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rp1zjtuksu/rp1zjtuksu/rp1zjtuksu.png`
- Checksum / 校验和:
  `8be294a6930a81e0def6c4110b5cd83111684ec58ac2d742791c104838e01247`
...
- Marked-pixel bounds: (70,46)–(179,208); span 110 × 163 px; the marked
...
- 痕迹范围：(70,46)–(179,208)；跨度110 × 163 px；痕迹矩形高于宽。
