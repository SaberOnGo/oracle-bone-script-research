# Material Visual Observation / obs-comp-cand-001089 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001089`
- External reference / 外部参照: `obimd-sub-11fne5mtbh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014898_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fmdym8mxmv/11fne5mtbh/11fne5mtbh.png`
- Checksum / 校验和:
  `92712a4626c2b1839a34cdcab2df27baaf81b553a0d2e3ad545c3a78b87bb726`
...
- Marked-pixel bounds: (92,24)–(167,226); span 76 × 203 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.06%。
- 痕迹范围：(92,24)–(167,226)；跨度76 × 203 px；痕迹矩形高于宽。
