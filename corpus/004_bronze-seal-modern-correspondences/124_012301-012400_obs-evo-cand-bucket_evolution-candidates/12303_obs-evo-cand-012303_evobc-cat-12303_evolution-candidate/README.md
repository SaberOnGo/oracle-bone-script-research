# obs-evo-cand-012303 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-12303`
- Source label for human review: `𧼷`
- Source codepoints: `U+27F37`
- Image reference count: `25`
- Era token counts: `WSC:25`
- Source token counts: `Book:25`
