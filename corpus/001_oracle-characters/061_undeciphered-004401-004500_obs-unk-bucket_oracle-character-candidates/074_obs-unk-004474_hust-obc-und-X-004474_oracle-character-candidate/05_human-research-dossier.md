# obs-unk-004474 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/074_obs-unk-004474_h
  ust-obc-und-X-004474_oracle-character-candidate/03_visual-assets/001_asset
  -006067_hust-obc-und-X-004474_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/30/X_？_8208_1.png`
- asset id: `asset-006067`
...
- source class: `HUST-OBC/undeciphered/X/30/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/30/X_？_8208_1.png`
- asset id: `asset-006067`
...
- English observation: Adjacent mark groups show a left enclosed opening and
  a right rounded mass with side protrusions.
- 中文观察: 相邻痕迹中左侧有封闭开口，右侧上部较圆并带侧突。
...
- Which source records identify obs-unk-004474 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004474？
