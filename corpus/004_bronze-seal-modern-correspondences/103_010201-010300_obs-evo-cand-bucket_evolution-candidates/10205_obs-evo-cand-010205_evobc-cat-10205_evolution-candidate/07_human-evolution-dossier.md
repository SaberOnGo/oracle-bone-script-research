...
- Project ID: `obs-evo-cand-010205`
- EVOBC category candidate ID: `evobc-evo-cat-10205`
- External category reference: `evobc-cat-10205`
- Source category ID: `10205`
- Source label for human review: `駼`
- Source codepoints: `U+99FC`
...
- `obs-evo-cand-010205-route-category-staging`
...
- `obs-evo-cand-010205-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010205-route-evolution-graph`
