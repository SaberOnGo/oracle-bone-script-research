...
- `obs-evo-cand-003155-route-category-staging`
...
- `obs-evo-cand-003155-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003155-route-evolution-graph`
