...
- `obs-evo-cand-013538-route-category-staging`
...
- `obs-evo-cand-013538-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013538-route-evolution-graph`
