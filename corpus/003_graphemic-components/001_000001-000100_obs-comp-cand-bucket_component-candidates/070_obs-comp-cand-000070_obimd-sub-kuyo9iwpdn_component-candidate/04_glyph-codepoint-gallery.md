# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000070
...
| --- | --- | --- | --- |
| `obimd-glyph-link-001298` | 󿴳 | `U+FFD33` | `reviewed_metadata_only` |
| `obimd-glyph-link-001299` | 󰚩 | `U+F06A9` | `reviewed_metadata_only` |
| `obimd-glyph-link-001300` | 󰚪 | `U+F06AA` | `reviewed_metadata_only` |
| `obimd-glyph-link-001301` | 󰚫 | `U+F06AB` | `reviewed_metadata_only` |
