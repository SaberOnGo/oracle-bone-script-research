...
- External category reference: `evobc-cat-03034`
- Source category ID: `03034`
- Source label for human review: `惀`
...
- `obs-evo-cand-003034-route-category-staging`
...
- `obs-evo-cand-003034-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003034-route-evolution-graph`
