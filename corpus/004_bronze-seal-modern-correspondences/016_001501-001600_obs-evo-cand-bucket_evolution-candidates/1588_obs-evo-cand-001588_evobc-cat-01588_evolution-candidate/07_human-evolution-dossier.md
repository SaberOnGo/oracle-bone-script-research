...
- External category reference: `evobc-cat-01588`
- Source category ID: `01588`
- Source label for human review: `哦`
...
- `obs-evo-cand-001588-route-category-staging`
...
- `obs-evo-cand-001588-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001588-route-evolution-graph`
