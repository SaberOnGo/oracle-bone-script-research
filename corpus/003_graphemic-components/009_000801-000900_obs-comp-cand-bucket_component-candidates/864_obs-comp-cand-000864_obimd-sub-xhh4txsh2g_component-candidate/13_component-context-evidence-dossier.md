# obs-comp-cand-000864 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000864`
- 首选外部 ID: `obimd-sub-xhh4txsh2g`
- OBIMD subcharacter UID: `xhh4txsh2g`
- OBIMD main character UID: `xhh4txsh2g`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+A6E7A;U+F4E04; U+F4E05
