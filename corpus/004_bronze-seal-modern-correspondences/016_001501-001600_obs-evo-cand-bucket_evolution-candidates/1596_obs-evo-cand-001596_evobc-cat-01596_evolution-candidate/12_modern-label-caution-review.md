# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001596
...
- EVOBC candidate category: `evobc-evo-cat-01596`.
- Source label for search only: `哽`.
- Source codepoints for search only: `U+54FD`.
