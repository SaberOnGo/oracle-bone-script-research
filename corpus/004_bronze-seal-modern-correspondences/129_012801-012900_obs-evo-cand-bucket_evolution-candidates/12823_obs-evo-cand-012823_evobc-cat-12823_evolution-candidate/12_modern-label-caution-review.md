# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012823
...
- EVOBC candidate category: `evobc-evo-cat-12823`.
- Source label for search only: `𪧇`.
- Source codepoints for search only: `U+2A9C7`.
