...
- External category reference: `evobc-cat-07565`
- Source category ID: `07565`
- Source label for human review: `蔫`
...
- `obs-evo-cand-007565-route-category-staging`
...
- `obs-evo-cand-007565-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007565-route-evolution-graph`
