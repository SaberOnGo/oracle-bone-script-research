# Material Visual Observation / obs-comp-cand-001927 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001927`
- External reference / 外部参照: `obimd-sub-6k62imdisa`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018337_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6k62imdisa/6k62imdisa/6k62imdisa.png`
- Checksum / 校验和:
  `7e945e069a9db7225865fd147d686ed4938c000fa83531d28d833ddfbc1b5c5b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.93%.
- Marked-pixel bounds: (55,23)–(202,228); span 148 × 206 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.93%。
- 痕迹范围：(55,23)–(202,228)；跨度148 × 206 px；痕迹矩形高于宽。
