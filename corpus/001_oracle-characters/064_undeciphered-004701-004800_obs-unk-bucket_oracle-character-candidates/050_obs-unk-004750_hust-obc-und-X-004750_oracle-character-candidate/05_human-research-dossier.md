# obs-unk-004750 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/050_obs-unk-004750_h
  ust-obc-und-X-004750_oracle-character-candidate/03_visual-assets/001_asset
  -006343_hust-obc-und-X-004750_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/306/X_？_7291_1.png`
- asset id: `asset-006343`
...
- source class: `HUST-OBC/undeciphered/X/306/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/306/X_？_7291_1.png`
- asset id: `asset-006343`
...
- English observation: `central stem with lower openings and curve`
- 中文观察: `带下部开口和弯曲笔画的中央竖向主体`
...
- Which source records identify obs-unk-004750 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004750？
