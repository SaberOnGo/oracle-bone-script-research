# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000788
...
- EVOBC candidate category: `evobc-evo-cat-00788`.
- Source label for search only: `似`.
- Source codepoints for search only: `U+4F3C`.
