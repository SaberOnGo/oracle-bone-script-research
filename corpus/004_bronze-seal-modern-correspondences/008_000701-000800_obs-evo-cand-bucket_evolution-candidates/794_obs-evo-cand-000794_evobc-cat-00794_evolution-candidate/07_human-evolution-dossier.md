...
- External category reference: `evobc-cat-00794`
- Source category ID: `00794`
- Source label for human review: `佃`
- Source codepoints: `U+4F43`
...
- `obs-evo-cand-000794-route-category-staging`
...
- `obs-evo-cand-000794-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000794-route-evolution-graph`
