# obs-char-000599 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000599`
- primary external id: `hust-obc-cat-0683`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/599_obs-char-000599_hust-obc-cat-0683_orac
  le-character/03_visual-assets/001_asset-000604_hust-obc-cat-0683_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0683/G_0683_前6.35.1(甲).png`
- asset id: `asset-000604`
...
- source category: `0683`
- validation class: `598`
- source image route: `HUST-OBC/deciphered/0683/G_0683_前6.35.1(甲).png`
- asset id: `asset-000604`
...
- English observation: `A left rectangular upper frame with a horizontal
  divider continues into two forked lower strokes, while a detached tall
  zigzag branching form stands at right.`
- 中文观察: `左侧带横向分隔的矩形上框延续为两条叉状下笔，右侧为分离高长锯折分支形。`
...
- dataset label text: `㚡`
- dataset label codepoints: `U+36A1`
...
- Which source records identify obs-char-000599 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000599？
