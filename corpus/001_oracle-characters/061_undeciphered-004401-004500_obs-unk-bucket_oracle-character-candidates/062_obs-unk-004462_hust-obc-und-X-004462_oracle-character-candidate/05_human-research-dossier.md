# obs-unk-004462 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004462`
- primary external id: `hust-obc-und-X-004462`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/062_obs-unk-004462_h
  ust-obc-und-X-004462_oracle-character-candidate/03_visual-assets/001_asset
  -006055_hust-obc-und-X-004462_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/18/X_？_8197_1.png`
- asset id: `asset-006055`
...
- source class: `HUST-OBC/undeciphered/X/18/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/18/X_？_8197_1.png`
- asset id: `asset-006055`
...
- English observation: A bent upper stroke leads to two stacked rounded
  openings and a pointed lower terminal.
- 中文观察: 弯折的上部痕迹通向两个叠置圆弧开口和尖状下端。
...
- Which source records identify obs-unk-004462 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004462？
