...
Project ID: `obs-insc-cw-cand-000436`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000436`
...
- Source page section: `Period III Group 3` /
  `第 III 期第 3 组`
- Source section key: `period-iii-group-3`
...
- Yingguo / 英国所藏: `y2279` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `529` in source row; primary catalog entry pending
...
- Group and batch / 组类与批次: group `3`; batch or pit context pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000436`
