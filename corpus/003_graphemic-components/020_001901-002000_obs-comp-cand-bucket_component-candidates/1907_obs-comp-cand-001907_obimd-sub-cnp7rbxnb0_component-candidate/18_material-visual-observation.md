# Material Visual Observation / obs-comp-cand-001907 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001907`
- External reference / 外部参照: `obimd-sub-cnp7rbxnb0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018317_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vha0ssegay/cnp7rbxnb0/cnp7rbxnb0.png`
- Checksum / 校验和:
  `25d4eb9a78f1c455ece8a91cb7e43c4a27bfaaf2a2b612472fbcb669253b8904`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.33%.
- Marked-pixel bounds: (63,25)–(184,219); span 122 × 195 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.33%。
- 痕迹范围：(63,25)–(184,219)；跨度122 × 195 px；痕迹矩形高于宽。
