...
- Project ID: `obs-evo-cand-002261`
- EVOBC category candidate ID: `evobc-evo-cat-02261`
- External category reference: `evobc-cat-02261`
- Source category ID: `02261`
- Source label for human review: `嫌`
- Source codepoints: `U+5ACC`
...
- `obs-evo-cand-002261-route-category-staging`
...
- `obs-evo-cand-002261-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002261-route-evolution-graph`
