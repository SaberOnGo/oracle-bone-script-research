# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006895
...
- EVOBC candidate category: `evobc-evo-cat-06895`.
- Source label for search only: `翬`.
- Source codepoints for search only: `U+7FEC`.
