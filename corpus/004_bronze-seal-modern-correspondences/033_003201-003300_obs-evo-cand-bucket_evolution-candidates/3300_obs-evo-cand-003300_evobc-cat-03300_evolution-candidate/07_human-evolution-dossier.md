...
- Project ID: `obs-evo-cand-003300`
- EVOBC category candidate ID: `evobc-evo-cat-03300`
- External category reference: `evobc-cat-03300`
- Source category ID: `03300`
- Source label for human review: `抶`
- Source codepoints: `U+62B6`
...
- `obs-evo-cand-003300-route-category-staging`
...
- `obs-evo-cand-003300-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003300-route-evolution-graph`
