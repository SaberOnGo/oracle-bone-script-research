...
Project ID: `obs-evo-cand-006511`
...
- Project ID: `obs-evo-cand-006511`
- EVOBC category candidate ID: `evobc-evo-cat-06511`
- External category reference: `evobc-cat-06511`
- Source category ID: `06511`
- Source label for human review: `絠`
- Source codepoints: `U+7D60`
...
- `obs-evo-cand-006511-route-category-staging`
...
- `obs-evo-cand-006511-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006511-route-evolution-graph`
