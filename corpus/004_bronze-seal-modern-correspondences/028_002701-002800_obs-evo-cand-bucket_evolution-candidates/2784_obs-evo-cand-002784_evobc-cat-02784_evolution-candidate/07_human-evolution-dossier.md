...
Project ID: `obs-evo-cand-002784`
...
- Project ID: `obs-evo-cand-002784`
- EVOBC category candidate ID: `evobc-evo-cat-02784`
- External category reference: `evobc-cat-02784`
- Source category ID: `02784`
- Source label for human review: `弃`
- Source codepoints: `U+5F03`
...
- `obs-evo-cand-002784-route-category-staging`
...
- `obs-evo-cand-002784-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002784-route-evolution-graph`
