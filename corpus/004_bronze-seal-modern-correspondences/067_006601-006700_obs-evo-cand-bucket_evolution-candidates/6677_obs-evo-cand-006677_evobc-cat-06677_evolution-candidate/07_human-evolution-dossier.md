...
- External category reference: `evobc-cat-06677`
- Source category ID: `06677`
- Source label for human review: `繙`
- Source codepoints: `U+7E59`
...
- `obs-evo-cand-006677-route-category-staging`
...
- `obs-evo-cand-006677-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006677-route-evolution-graph`
