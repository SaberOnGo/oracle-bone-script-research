# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002622
...
| Glyph or codepoint route / 字形或码位路线 | 15 OBIMD route rows; examples U+FEC6A; U+FEC6B; 另有 13 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
