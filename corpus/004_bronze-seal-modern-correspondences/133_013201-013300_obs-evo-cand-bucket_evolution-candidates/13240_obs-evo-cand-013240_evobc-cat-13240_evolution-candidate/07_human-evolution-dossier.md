...
- External category reference: `evobc-cat-13240`
- Source category ID: `13240`
- Source label for human review: `𬌪`
- Source codepoints: `U+2C32A`
...
- `obs-evo-cand-013240-route-category-staging`
...
- `obs-evo-cand-013240-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013240-route-evolution-graph`
