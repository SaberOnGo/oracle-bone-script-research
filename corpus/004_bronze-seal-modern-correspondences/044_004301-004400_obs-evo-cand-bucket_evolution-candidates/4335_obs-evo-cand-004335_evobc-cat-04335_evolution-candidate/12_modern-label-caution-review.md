# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004335
...
- EVOBC candidate category: `evobc-evo-cat-04335`.
- Source label for search only: `欚`.
- Source codepoints for search only: `U+6B1A`.
