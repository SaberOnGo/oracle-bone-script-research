# obs-unk-004511 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004511`
- primary external id: `hust-obc-und-X-004511`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/011_obs-unk-004511_h
  ust-obc-und-X-004511_oracle-character-candidate/03_visual-assets/001_asset
  -006104_hust-obc-und-X-004511_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/67/X_？_8252_1.png`
- asset id: `asset-006104`
...
- source class: `HUST-OBC/undeciphered/X/67/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/67/X_？_8252_1.png`
- asset id: `asset-006104`
...
- English observation: `The long band, pointed peaks, central valley, side
  prongs, and right projection are recorded directly.`
- 中文观察: `已直接记录长横带、尖峰、中央谷部、两侧分支和右端外伸痕。`
...
- Which source records identify obs-unk-004511 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004511？
