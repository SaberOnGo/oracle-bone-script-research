...
- Yingguo / 英国所藏: `y1595` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `170` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `570` in source row; primary catalog entry pending
- Heji / 合集: `40599` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000248`
