...
Project ID: `obs-evo-cand-003027`
...
- Project ID: `obs-evo-cand-003027`
- EVOBC category candidate ID: `evobc-evo-cat-03027`
- External category reference: `evobc-cat-03027`
- Source category ID: `03027`
- Source label for human review: `悴`
- Source codepoints: `U+60B4`
...
- `obs-evo-cand-003027-route-category-staging`
...
- `obs-evo-cand-003027-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003027-route-evolution-graph`
