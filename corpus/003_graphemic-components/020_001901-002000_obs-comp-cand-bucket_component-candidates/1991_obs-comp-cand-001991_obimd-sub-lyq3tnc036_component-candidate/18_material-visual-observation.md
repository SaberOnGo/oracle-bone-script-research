# Material Visual Observation / obs-comp-cand-001991 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001991`
- External reference / 外部参照: `obimd-sub-lyq3tnc036`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018983_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lyq3tnc036/lyq3tnc036/lyq3tnc036.png`
- Checksum / 校验和:
  `232d9ddfa8dd33488d2488329abb965906fbb7747cf684e6e0070ad2033d580c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.99%.
- Marked-pixel bounds: (71,41)–(178,204); span 108 × 164 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.99%。
- 痕迹范围：(71,41)–(178,204)；跨度108 × 164 px；痕迹矩形高于宽。
