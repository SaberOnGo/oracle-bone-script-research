# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004512
...
- EVOBC candidate category: `evobc-evo-cat-04512`.
- Source label for search only: `汫`.
- Source codepoints for search only: `U+6C6B`.
