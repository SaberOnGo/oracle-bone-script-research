# obs-char-000049 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/049_obs-char-000049_hust-obc-cat-0057_orac
  le-character/03_visual-assets/001_asset-000054_hust-obc-cat-0057_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0057/H_0057_607F8_0.png`
- asset id: `asset-000054`
...
- source category: `0057`
- validation class: `48`
- source image route: `HUST-OBC/deciphered/0057/H_0057_607F8_0.png`
- asset id: `asset-000054`
...
- English observation: `Two adjacent forms are visible, with branching
  strokes on the left and a looped, crossing form with a lower diamond-like
  mark on the right.`
- 中文观察: `图像可见两个相邻形体，左侧有分叉笔画，右侧有环状交叉形和下部菱状痕迹。`
...
- dataset label text: `㐯`
- dataset label codepoints: `U+342F`
...
- filename catalog route clues: `catalog-like filename clue: H_0057
  (H_0057_607F8_0.png)`
...
- Which source records identify obs-char-000049 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000049？
