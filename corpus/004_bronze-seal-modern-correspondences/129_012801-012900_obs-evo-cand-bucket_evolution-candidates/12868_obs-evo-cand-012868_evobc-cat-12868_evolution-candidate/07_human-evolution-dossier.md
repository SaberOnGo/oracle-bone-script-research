...
- Project ID: `obs-evo-cand-012868`
- EVOBC category candidate ID: `evobc-evo-cat-12868`
- External category reference: `evobc-cat-12868`
- Source category ID: `12868`
- Source label for human review: `𪲞`
- Source codepoints: `U+2AC9E`
...
- `obs-evo-cand-012868-route-category-staging`
...
- `obs-evo-cand-012868-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012868-route-evolution-graph`
