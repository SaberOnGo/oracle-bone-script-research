# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001441
...
| Glyph or codepoint route / 字形或码位路线 | 2 OBIMD route rows; examples U+ADB0A;U+F842B; U+F842C | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
