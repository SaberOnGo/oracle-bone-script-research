# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000363
...
| --- | --- | --- | --- |
| `obimd-glyph-link-005443` | 󲅾 | `U+F217E` | `reviewed_metadata_only` |
| `obimd-glyph-link-005444` | 󲅿 | `U+F217F` | `reviewed_metadata_only` |
