# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004651
...
- Project ID: `obs-evo-cand-004651`.
- EVOBC candidate category: `evobc-evo-cat-04651`.
- Source label for search only: `测`.
- Source codepoints for search only: `U+6D4B`.
