...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1295`
...
- Source image / 来源图: `G_1295_乙6638(甲).png`
- Image / 图像: `001_asset-001161_hust-obc-cat-1295_glyph.png`
...
- target node: `evobc-evo-cat-00113`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC image references / EvoBC 图像引用数: `26`
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/113_obs-evo-cand-000113_evobc-cat-00113_evoluti
...
- Source label text / 来源标签文字: `㤅`
- Source label codepoint / 来源标签 codepoint: `U+3905`
