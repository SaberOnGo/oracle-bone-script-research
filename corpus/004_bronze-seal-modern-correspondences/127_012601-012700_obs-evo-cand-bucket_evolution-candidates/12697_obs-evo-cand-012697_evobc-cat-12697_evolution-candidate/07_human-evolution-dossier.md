...
Project ID: `obs-evo-cand-012697`
...
- Project ID: `obs-evo-cand-012697`
- EVOBC category candidate ID: `evobc-evo-cat-12697`
- External category reference: `evobc-cat-12697`
- Source category ID: `12697`
- Source label for human review: `𩵦`
- Source codepoints: `U+29D66`
...
- `obs-evo-cand-012697-route-category-staging`
...
- `obs-evo-cand-012697-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012697-route-evolution-graph`
