# obs-unk-004637 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/037_obs-unk-004637_h
  ust-obc-und-X-004637_oracle-character-candidate/03_visual-assets/001_asset
  -006230_hust-obc-und-X-004637_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/193/X_？_8366_1.png`
- asset id: `asset-006230`
...
- source class: `HUST-OBC/undeciphered/X/193/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/193/X_？_8366_1.png`
- asset id: `asset-006230`
...
- English observation: `curved enclosure with upper tail and lower-left taper`
- 中文观察: `粗重弧形围合、右上突出处和左下尾状延伸`
...
- Which source records identify obs-unk-004637 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004637？
