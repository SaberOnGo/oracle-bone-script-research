...
- External category reference: `evobc-cat-09456`
- Source category ID: `09456`
- Source label for human review: `鍜`
...
- `obs-evo-cand-009456-route-category-staging`
...
- `obs-evo-cand-009456-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009456-route-evolution-graph`
