# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008907
...
- EVOBC candidate category: `evobc-evo-cat-08907`.
- Source label for search only: `辜`.
- Source codepoints for search only: `U+8F9C`.
