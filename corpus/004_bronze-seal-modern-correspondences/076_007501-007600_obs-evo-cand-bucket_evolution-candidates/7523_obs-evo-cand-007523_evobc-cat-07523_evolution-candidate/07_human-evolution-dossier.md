...
Project ID: `obs-evo-cand-007523`
...
- Project ID: `obs-evo-cand-007523`
- EVOBC category candidate ID: `evobc-evo-cat-07523`
- External category reference: `evobc-cat-07523`
- Source category ID: `07523`
- Source label for human review: `蓉`
- Source codepoints: `U+84C9`
...
- `obs-evo-cand-007523-route-category-staging`
...
- `obs-evo-cand-007523-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007523-route-evolution-graph`
