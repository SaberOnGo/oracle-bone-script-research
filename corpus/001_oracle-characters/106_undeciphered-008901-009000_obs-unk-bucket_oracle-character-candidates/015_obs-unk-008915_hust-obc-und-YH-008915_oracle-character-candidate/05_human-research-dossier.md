# obs-unk-008915 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008915`
- primary external id: `hust-obc-und-YH-008915`
...
- local review image route: `corpus/001_oracle-characters/106_undeciphered-008
  901-009000_obs-unk-bucket_oracle-character-candidates/015_obs-unk-008915_h
  ust-obc-und-YH-008915_oracle-character-candidate/03_visual-assets/001_asse
  t-010506_hust-obc-und-YH-008915_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60F57/H_？_60F57_0.png`
- asset id: `asset-010506`
...
- source class: `HUST-OBC/undeciphered/Y+H/60F57/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60F57/H_？_60F57_0.png`
- asset id: `asset-010506`
...
- Which source records identify obs-unk-008915 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008915？
