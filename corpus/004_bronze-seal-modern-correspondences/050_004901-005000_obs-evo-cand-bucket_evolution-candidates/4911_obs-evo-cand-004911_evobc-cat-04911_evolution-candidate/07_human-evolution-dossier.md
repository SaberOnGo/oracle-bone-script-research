...
Project ID: `obs-evo-cand-004911`
...
- Project ID: `obs-evo-cand-004911`
- EVOBC category candidate ID: `evobc-evo-cat-04911`
- External category reference: `evobc-cat-04911`
- Source category ID: `04911`
- Source label for human review: `潩`
- Source codepoints: `U+6F69`
...
- `obs-evo-cand-004911-route-category-staging`
...
- `obs-evo-cand-004911-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004911-route-evolution-graph`
