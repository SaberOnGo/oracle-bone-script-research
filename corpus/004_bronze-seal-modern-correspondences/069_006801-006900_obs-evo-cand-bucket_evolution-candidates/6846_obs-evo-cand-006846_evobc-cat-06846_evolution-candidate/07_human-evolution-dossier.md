...
- External category reference: `evobc-cat-06846`
- Source category ID: `06846`
- Source label: `羘`
...
- `obs-evo-cand-006846-route-category-staging`
...
- `obs-evo-cand-006846-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006846-route-evolution-graph`
