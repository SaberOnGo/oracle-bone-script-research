# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-000086
...
- candidate_component_id: `obs-comp-cand-000086`
- primary_external_ref_id: `obimd-sub-k729lc981z`
- source_subcharacter_uid: `k729lc981z`
- source_main_character_uid: `lpjmcjuz4z`
- main_character_external_ref_id: `obimd-main-lpjmcjuz4z`
...
- glyph_codepoint_uplus_sample: `U+F08A1, U+F08A2`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-011498` | `001_asset-011498_img.png` | `db1c73cc66c57833fab6cee00c34efd78210fa7e3a0f18eaac1516b471ef2adf` |
