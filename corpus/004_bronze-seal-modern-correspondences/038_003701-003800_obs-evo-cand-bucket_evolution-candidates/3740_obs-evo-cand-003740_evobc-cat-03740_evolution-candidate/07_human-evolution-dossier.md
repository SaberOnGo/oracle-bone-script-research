...
- External category reference: `evobc-cat-03740`
- Source category ID: `03740`
- Source label: `晐`
...
- `obs-evo-cand-003740-route-category-staging`
...
- `obs-evo-cand-003740-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003740-route-evolution-graph`
