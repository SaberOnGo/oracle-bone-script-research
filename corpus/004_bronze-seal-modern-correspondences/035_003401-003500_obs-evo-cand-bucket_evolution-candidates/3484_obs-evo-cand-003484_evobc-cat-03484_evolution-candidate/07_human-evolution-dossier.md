...
- External category reference: `evobc-cat-03484`
- Source category ID: `03484`
- Source label for human review: `摴`
- Source codepoints: `U+6474`
...
- `obs-evo-cand-003484-route-category-staging`
...
- `obs-evo-cand-003484-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003484-route-evolution-graph`
