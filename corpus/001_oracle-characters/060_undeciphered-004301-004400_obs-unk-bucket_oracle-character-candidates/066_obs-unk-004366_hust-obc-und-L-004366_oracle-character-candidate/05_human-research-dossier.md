# obs-unk-004366 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/066_obs-unk-004366_h
  ust-obc-und-L-004366_oracle-character-candidate/03_visual-assets/001_asset
  -005959_hust-obc-und-L-004366_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4366/L_？_9688.jpg`
- asset id: `asset-005959`
...
- source class: `HUST-OBC/undeciphered/L/4366/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4366/L_？_9688.jpg`
- asset id: `asset-005959`
...
- English observation: `Upper crossing, central descent, and lower curve`
  `recorded.`
- 中文观察: `已记录上部交叉、中央下行和下部弧痕。`
...
- Which source records identify obs-unk-004366 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004366？
