# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001669
...
| Glyph or codepoint route / 字形或码位路线 | 194 OBIMD route rows; examples U+8CD3;U+3033E;U+FFA56; U+F9A88; 另有 192 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 194 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
