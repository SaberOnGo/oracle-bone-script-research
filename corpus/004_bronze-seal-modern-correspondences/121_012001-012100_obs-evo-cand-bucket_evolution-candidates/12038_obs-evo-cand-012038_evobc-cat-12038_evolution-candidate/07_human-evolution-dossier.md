...
- External category reference: `evobc-cat-12038`
- Source category ID: `12038`
- Source label for human review: `𦘠`
...
- `obs-evo-cand-012038-route-category-staging`
...
- `obs-evo-cand-012038-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012038-route-evolution-graph`
