...
- External category reference: `evobc-cat-04402`
- Source category ID: `04402`
- Source label for human review: `歾`
- Source codepoints: `U+6B7E`
...
- `obs-evo-cand-004402-route-category-staging`
...
- `obs-evo-cand-004402-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004402-route-evolution-graph`
