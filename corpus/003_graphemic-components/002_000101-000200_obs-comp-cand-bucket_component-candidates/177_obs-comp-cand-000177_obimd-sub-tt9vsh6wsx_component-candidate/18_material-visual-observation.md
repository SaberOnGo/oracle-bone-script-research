# Material Visual Observation / obs-comp-cand-000177 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000177`
- External reference / 外部参照: `obimd-sub-tt9vsh6wsx`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011589_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4n6v7cj6m9/tt9vsh6wsx/tt9vsh6wsx.png`
- Checksum / 校验和:
  `efd8bcfff67bdcb1ab8b0010f362ff9262129a4ccaeb7aed3cd21aa2a5474678`
...
- Marked-pixel bounds: (57,11)–(192,236); span 136 × 226 px; the marked
...
- 痕迹范围：(57,11)–(192,236)；跨度136 × 226 px；痕迹矩形高于宽。
