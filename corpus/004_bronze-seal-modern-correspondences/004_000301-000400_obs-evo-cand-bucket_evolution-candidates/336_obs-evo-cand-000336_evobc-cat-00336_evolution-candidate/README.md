# obs-evo-cand-000336 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-000336`
- EVOBC category candidate ID: `evobc-evo-cat-00336`
- External category ref: `evobc-cat-00336`
- Source label: `䌛`
- Source codepoints: `U+431B`
- Image reference count: `38`
- Era token counts: `BI:11;WSC:27`
- Source token counts: `Book:38`
