...
- External category reference: `evobc-cat-01102`
- Source category ID: `01102`
- Source label for human review: `兹`
...
- `obs-evo-cand-001102-route-category-staging`
...
- `obs-evo-cand-001102-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001102-route-evolution-graph`
