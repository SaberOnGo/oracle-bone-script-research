...
- External category reference: `evobc-cat-02873`
- Source category ID: `02873`
- Source label for human review: `徙`
...
- `obs-evo-cand-002873-route-category-staging`
...
- `obs-evo-cand-002873-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002873-route-evolution-graph`
