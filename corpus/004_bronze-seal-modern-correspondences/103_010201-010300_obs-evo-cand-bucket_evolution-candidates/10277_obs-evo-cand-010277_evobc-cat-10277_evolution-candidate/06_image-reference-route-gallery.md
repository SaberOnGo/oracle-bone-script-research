...
- `obs-evo-cand-010277-route-category-staging`
...
- `obs-evo-cand-010277-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010277-route-evolution-graph`
