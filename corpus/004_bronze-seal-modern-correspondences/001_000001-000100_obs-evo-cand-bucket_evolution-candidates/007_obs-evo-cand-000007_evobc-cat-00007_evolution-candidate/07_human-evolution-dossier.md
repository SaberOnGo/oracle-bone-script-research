...
- External category reference: `evobc-cat-00007`
- Source category ID: `00007`
- Source label for human review: `㐵`
...
- `obs-evo-cand-000007-route-category-staging`
...
- `obs-evo-cand-000007-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000007-route-evolution-graph`
