# Material Visual Observation / obs-comp-cand-000847 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000847`
- External reference / 外部参照: `obimd-sub-tzqeya1t3a`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013718_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tzqeya1t3a/tzqeya1t3a/tzqeya1t3a.png`
- Checksum / 校验和:
  `a5e99f904adac74df4434a1d4573209f5a3b671a22b8f3d5394e747847ff4fc5`
...
- Marked-pixel bounds: (64,30)–(196,223); span 133 × 194 px; the marked
...
- 痕迹范围：(64,30)–(196,223)；跨度133 × 194 px；痕迹矩形高于宽。
