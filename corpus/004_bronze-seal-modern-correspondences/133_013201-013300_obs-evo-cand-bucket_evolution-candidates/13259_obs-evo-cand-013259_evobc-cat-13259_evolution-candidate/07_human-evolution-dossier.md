...
- External category reference: `evobc-cat-13259`
- Source category ID: `13259`
- Source label for human review: `𬐷`
...
- `obs-evo-cand-013259-route-category-staging`
...
- `obs-evo-cand-013259-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013259-route-evolution-graph`
