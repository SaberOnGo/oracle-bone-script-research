...
- External category reference: `evobc-cat-04116`
- Source category ID: `04116`
- Source label for human review: `椄`
- Source codepoints: `U+6904`
...
- `obs-evo-cand-004116-route-category-staging`
...
- `obs-evo-cand-004116-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004116-route-evolution-graph`
