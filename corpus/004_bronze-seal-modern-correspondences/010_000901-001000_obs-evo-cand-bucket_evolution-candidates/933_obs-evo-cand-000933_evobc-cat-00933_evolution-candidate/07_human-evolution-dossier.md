...
Project ID: `obs-evo-cand-000933`
...
- Project ID: `obs-evo-cand-000933`
- EVOBC category candidate ID: `evobc-evo-cat-00933`
- External category reference: `evobc-cat-00933`
- Source category ID: `00933`
- Source label for human review: `倡`
- Source codepoints: `U+5021`
...
- `obs-evo-cand-000933-route-category-staging`
...
- `obs-evo-cand-000933-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000933-route-evolution-graph`
