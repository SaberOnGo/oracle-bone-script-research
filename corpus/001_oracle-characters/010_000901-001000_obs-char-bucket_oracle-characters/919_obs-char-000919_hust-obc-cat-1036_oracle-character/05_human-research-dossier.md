# obs-char-000919 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/919_obs-char-000919_hust-obc-cat-1036_orac
  le-character/03_visual-assets/001_asset-000924_hust-obc-cat-1036_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1036/G_1036_乙1710合7407.png`
- asset id: `asset-000924`
...
- source category: `1036`
- validation class: `918`
- source image route: `HUST-OBC/deciphered/1036/G_1036_乙1710合7407.png`
- asset id: `asset-000924`
...
- English observation: `A pointed upper enclosure with a horizontal interior
  stroke sits above two descending side curves.`
- 中文观察: `带内部横笔的尖形上部闭合轮廓位于两条下行侧弯笔之上。`
...
- dataset label text: `㠂`
- dataset label codepoints: `U+3802`
...
- filename catalog route clues: `Heji-like filename clue: 合7407
  (G_1036_乙1710合7407.png)`
...
- Which source records identify obs-char-000919 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000919？
