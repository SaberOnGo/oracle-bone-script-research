...
Project ID: `obs-evo-cand-008800`
...
- Project ID: `obs-evo-cand-008800`
- EVOBC category candidate ID: `evobc-evo-cat-08800`
- External category reference: `evobc-cat-08800`
- Source category ID: `08800`
- Source label for human review: `軔`
- Source codepoints: `U+8ED4`
...
- `obs-evo-cand-008800-route-category-staging`
...
- `obs-evo-cand-008800-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008800-route-evolution-graph`
