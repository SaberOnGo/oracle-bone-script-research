...
Project ID: `obs-insc-cw-cand-000015`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000015`
...
- Yingguo / 英国所藏: `y79` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `53` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `637` in source row; primary catalog entry pending
- Heji / 合集: `39617` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000015`
