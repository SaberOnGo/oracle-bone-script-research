# obs-unk-004186 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/086_obs-unk-004186_h
  ust-obc-und-L-004186_oracle-character-candidate/03_visual-assets/001_asset
  -005779_hust-obc-und-L-004186_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4186/L_？_9108.jpg`
- asset id: `asset-005779`
...
- source class: `HUST-OBC/undeciphered/L/4186/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4186/L_？_9108.jpg`
- asset id: `asset-005779`
...
- English observation: `Rounded mark over a horizontal stroke; central stroke
stroke descends below it.`
- 中文观察: `横笔画上方有圆弧状痕迹；一条收窄的中央笔画向下
延伸。`
...
- Which source records identify obs-unk-004186 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004186？
