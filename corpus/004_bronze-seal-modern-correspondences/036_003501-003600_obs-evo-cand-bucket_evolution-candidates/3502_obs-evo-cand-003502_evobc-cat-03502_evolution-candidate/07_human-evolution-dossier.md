...
Project ID: `obs-evo-cand-003502`
...
- Project ID: `obs-evo-cand-003502`
- EVOBC category candidate ID: `evobc-evo-cat-03502`
- External category reference: `evobc-cat-03502`
- Source category ID: `03502`
- Source label for human review: `撣`
- Source codepoints: `U+64A3`
...
- `obs-evo-cand-003502-route-category-staging`
...
- `obs-evo-cand-003502-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003502-route-evolution-graph`
