# obs-unk-007164 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-007164`
- primary external id: `hust-obc-und-YH-007164`
...
- local review image route: `corpus/001_oracle-characters/088_undeciphered-007
  101-007200_obs-unk-bucket_oracle-character-candidates/064_obs-unk-007164_h
  ust-obc-und-YH-007164_oracle-character-candidate/03_visual-assets/001_asse
  t-008755_hust-obc-und-YH-007164_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60844/H_？_60844_0.png`
- asset id: `asset-008755`
...
- source class: `HUST-OBC/undeciphered/Y+H/60844/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60844/H_？_60844_0.png`
- asset id: `asset-008755`
...
- Which source records identify obs-unk-007164 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007164？
