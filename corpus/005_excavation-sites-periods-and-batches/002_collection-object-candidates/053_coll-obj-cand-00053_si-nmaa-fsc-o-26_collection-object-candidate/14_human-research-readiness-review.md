# Human Research Readiness Review / 人类研究准备度复核: coll-obj-cand-00053
...
| --- | --- | --- |
| Catalog source | `FSC-O-26` | `02_collection-source-index.csv` |
| Visual evidence | `committed_public_domain_asset` | `04_visual-gallery.md` |
| Findspot route | `China` | `08_collection-provenance-evidence-dossier.md` |
| Period route | `Shang dynasty, ca. 1600 - ca. 1050 BCE` | `12_archaeological-context-review.md` |
