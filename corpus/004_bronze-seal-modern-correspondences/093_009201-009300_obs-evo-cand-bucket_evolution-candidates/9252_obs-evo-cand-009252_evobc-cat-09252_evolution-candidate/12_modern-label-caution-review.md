# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-009252
...
- EVOBC candidate category: `evobc-evo-cat-09252`.
- Source label for search only: `酬`.
- Source codepoints for search only: `U+916C`.
