...
Project ID: `obs-evo-cand-007910`
...
- Project ID: `obs-evo-cand-007910`
- EVOBC category candidate ID: `evobc-evo-cat-07910`
- External category reference: `evobc-cat-07910`
- Source category ID: `07910`
- Source label for human review: `衙`
- Source codepoints: `U+8859`
...
- `obs-evo-cand-007910-route-category-staging`
...
- `obs-evo-cand-007910-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007910-route-evolution-graph`
