# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000554
...
- EVOBC candidate category: `evobc-evo-cat-00554`.
- Source label for search only: `䬫`.
- Source codepoints for search only: `U+4B2B`.
