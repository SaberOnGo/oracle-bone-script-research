# obs-char-000060 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000060`
- primary external id: `hust-obc-cat-0069`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/060_obs-char-000060_hust-obc-cat-0069_orac
  le-character/03_visual-assets/001_asset-000065_hust-obc-cat-0069_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0069/L_0069_13075.jpg`
- asset id: `asset-000065`
...
- source category: `0069`
- validation class: `59`
- source image route: `HUST-OBC/deciphered/0069/L_0069_13075.jpg`
- asset id: `asset-000065`
...
- English observation: `The tiny gray image shows a narrow vertical chain of
  enclosed diamond-like marks with short cross strokes; detail needs
  recheck.`
- 中文观察: `微小灰度图像呈窄长竖向链状形体，含闭合菱状痕迹和短交叉笔画；细节需复核。`
...
- dataset label text: `㐻`
- dataset label codepoints: `U+343B`
...
- Which source records identify obs-char-000060 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000060？
