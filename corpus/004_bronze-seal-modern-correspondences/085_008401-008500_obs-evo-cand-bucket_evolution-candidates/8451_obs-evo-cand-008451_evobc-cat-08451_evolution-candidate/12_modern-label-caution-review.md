# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008451
...
- EVOBC candidate category: `evobc-evo-cat-08451`.
- Source label for search only: `谋`.
- Source codepoints for search only: `U+8C0B`.
