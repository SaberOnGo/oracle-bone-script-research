...
- `obs-evo-cand-013655-route-category-staging`
...
- `obs-evo-cand-013655-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013655-route-evolution-graph`
