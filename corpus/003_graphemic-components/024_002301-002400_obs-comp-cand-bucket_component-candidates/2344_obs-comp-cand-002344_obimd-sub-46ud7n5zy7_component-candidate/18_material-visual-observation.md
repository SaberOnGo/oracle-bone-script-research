# Material Visual Observation / obs-comp-cand-002344 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002344`
- External reference / 外部参照: `obimd-sub-46ud7n5zy7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020415_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/28p358130o/46ud7n5zy7/46ud7n5zy7.png`
- Checksum / 校验和:
  `010eb06b52a220a84eec82c5f615ee66a837cf6c10d76d7044be72fae6ce9240`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.10%.
- Marked-pixel bounds: (96,22)–(153,227); span 58 × 206 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.10%。
- 痕迹范围：(96,22)–(153,227)；跨度58 × 206 px；痕迹矩形高于宽。
