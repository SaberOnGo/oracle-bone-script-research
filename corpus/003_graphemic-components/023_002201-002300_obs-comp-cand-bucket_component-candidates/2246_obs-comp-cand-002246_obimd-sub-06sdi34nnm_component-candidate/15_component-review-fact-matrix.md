# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002246
...
| Glyph or codepoint route / 字形或码位路线 | 2 OBIMD route rows; examples U+FCE9A; U+FCE9B | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
