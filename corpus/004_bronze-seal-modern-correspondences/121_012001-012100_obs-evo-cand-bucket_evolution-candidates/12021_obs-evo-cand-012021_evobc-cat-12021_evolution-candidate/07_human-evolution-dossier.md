...
Project ID: `obs-evo-cand-012021`
...
- Project ID: `obs-evo-cand-012021`
- EVOBC category candidate ID: `evobc-evo-cat-12021`
- External category reference: `evobc-cat-12021`
- Source category ID: `12021`
- Source label for human review: `𦒴`
- Source codepoints: `U+264B4`
...
- `obs-evo-cand-012021-route-category-staging`
...
- `obs-evo-cand-012021-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012021-route-evolution-graph`
