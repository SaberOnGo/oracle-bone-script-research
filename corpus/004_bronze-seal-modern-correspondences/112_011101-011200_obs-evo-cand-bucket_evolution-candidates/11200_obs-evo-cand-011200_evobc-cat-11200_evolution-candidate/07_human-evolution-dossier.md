...
- External category reference: `evobc-cat-11200`
- Source category ID: `11200`
- Source label for human review: `𢓜`
- Source codepoints: `U+224DC`
- Image reference count in source metadata: `46`
...
- `obs-evo-cand-011200-route-category-staging`
...
- `obs-evo-cand-011200-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011200-route-evolution-graph`
