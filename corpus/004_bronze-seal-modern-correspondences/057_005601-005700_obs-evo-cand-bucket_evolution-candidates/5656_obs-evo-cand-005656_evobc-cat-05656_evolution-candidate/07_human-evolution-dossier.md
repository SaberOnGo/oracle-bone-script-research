...
- Project ID: `obs-evo-cand-005656`
- EVOBC category candidate ID: `evobc-evo-cat-05656`
- External category reference: `evobc-cat-05656`
- Source category ID: `05656`
- Source label for human review: `痵`
- Source codepoints: `U+75F5`
...
- `obs-evo-cand-005656-route-category-staging`
...
- `obs-evo-cand-005656-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005656-route-evolution-graph`
