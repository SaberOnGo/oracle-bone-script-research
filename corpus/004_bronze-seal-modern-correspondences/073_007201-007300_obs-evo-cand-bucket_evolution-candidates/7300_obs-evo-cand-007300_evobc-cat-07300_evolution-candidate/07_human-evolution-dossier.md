...
- External category reference: `evobc-cat-07300`
- Source category ID: `07300`
- Source label for human review: `茁`
...
- `obs-evo-cand-007300-route-category-staging`
...
- `obs-evo-cand-007300-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007300-route-evolution-graph`
