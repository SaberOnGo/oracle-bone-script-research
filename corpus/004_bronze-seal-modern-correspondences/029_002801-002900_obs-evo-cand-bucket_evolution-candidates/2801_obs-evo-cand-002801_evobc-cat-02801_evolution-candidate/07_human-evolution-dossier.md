...
- External category reference: `evobc-cat-02801`
- Source category ID: `02801`
- Source label for human review: `弟`
- Source codepoints: `U+5F1F`
- Image reference count in source metadata: `151`
...
- `obs-evo-cand-002801-route-category-staging`
...
- `obs-evo-cand-002801-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002801-route-evolution-graph`
