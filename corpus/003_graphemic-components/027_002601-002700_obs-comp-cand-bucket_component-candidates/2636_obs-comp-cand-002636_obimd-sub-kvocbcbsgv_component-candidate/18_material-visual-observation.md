# Material Visual Observation / obs-comp-cand-002636 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002636`
- External reference / 外部参照: `obimd-sub-kvocbcbsgv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021175_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kvocbcbsgv/kvocbcbsgv/kvocbcbsgv.png`
- Checksum / 校验和:
  `55defae1c94b9eb55acd073bbf960cd6d548d595ec23034d78ba7139d7fbbec1`
...
- Marked-pixel bounds: (80,42)–(180,202); span 101 × 161 px; the marked
...
- 痕迹范围：(80,42)–(180,202)；跨度101 × 161 px；痕迹矩形高于宽。
