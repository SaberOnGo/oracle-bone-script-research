# obs-evo-cand-002752 / EVOBC evolution-category candidate
...
- EVOBC category candidate ID: `evobc-evo-cat-02752`
- External category ref: `evobc-cat-02752`
- Source label for human review: `廌`
- Source codepoints: `U+5ECC`
- Image reference count: `72`
- Era token counts: `BI:3;OBC:40;SAC:2;SS:1;WSC:26`
- Source token counts: `Book:27;Web:45`
