# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013475
...
- EVOBC candidate category: `evobc-evo-cat-13475`.
- Source label for search only: `𭄋`.
- Source codepoints for search only: `U+2D10B`.
