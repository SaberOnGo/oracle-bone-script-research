# Material Visual Observation / obs-comp-cand-000697 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000697`
- External reference / 外部参照: `obimd-sub-oh2hn4qlz0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013296_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/mepmffeebh/oh2hn4qlz0/oh2hn4qlz0.png`
- Checksum / 校验和:
  `9c9a85195cd69bccfc762edd9c9d6fb0fb5e1b735c1e17bc8aa9ae173b4f4e95`
...
- Marked-pixel bounds: (85,21)–(169,229); span 85 × 209 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.31%。
- 痕迹范围：(85,21)–(169,229)；跨度85 × 209 px；痕迹矩形高于宽。
