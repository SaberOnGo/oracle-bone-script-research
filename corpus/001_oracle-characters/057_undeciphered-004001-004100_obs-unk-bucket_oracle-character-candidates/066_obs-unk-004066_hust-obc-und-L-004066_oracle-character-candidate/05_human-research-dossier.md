# obs-unk-004066 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004066`
- primary external id: `hust-obc-und-L-004066`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/066_obs-unk-004066_h
  ust-obc-und-L-004066_oracle-character-candidate/03_visual-assets/001_asset
  -005659_hust-obc-und-L-004066_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4066/L_？_8711.jpg`
- asset id: `asset-005659`
...
- source class: `HUST-OBC/undeciphered/L/4066/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4066/L_？_8711.jpg`
- asset id: `asset-005659`
...
- English observation: The image contains a dense upright cluster of dark
  slanting and vertical traces. The outside marks taper toward a lower point,
  while the central area is darker and partly merged; individual joins remain
  uncertain.
- 中文观察：图中是一个较密集的竖向痕迹组，包含深色的斜向和竖向痕迹。外侧
  痕迹向下方尖点收窄，中央区域较深且部分相连；各条痕迹的连接关系仍不确定。
...
- Which source records identify obs-unk-004066 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004066？
