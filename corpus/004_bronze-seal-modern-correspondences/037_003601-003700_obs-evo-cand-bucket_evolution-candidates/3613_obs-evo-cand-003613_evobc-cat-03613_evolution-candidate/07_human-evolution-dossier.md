...
- External category reference: `evobc-cat-03613`
- Source category ID: `03613`
- Source label for human review: `敺`
- Source codepoints: `U+657A`
...
- `obs-evo-cand-003613-route-category-staging`
...
- `obs-evo-cand-003613-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003613-route-evolution-graph`
