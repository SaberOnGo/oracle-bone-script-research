# Material Visual Observation / obs-comp-cand-001610 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001610`
- External reference / 外部参照: `obimd-sub-2qtimwiv3e`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017286_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kei9slmf3p/2qtimwiv3e/2qtimwiv3e.png`
- Checksum / 校验和:
  `7106e4cd83e373b9eaa11406d877f57b546d2e3aa60fca34760979a1ebdbaeb8`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.24%.
- Marked-pixel bounds: (82,15)–(147,231); span 66 × 217 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.24%。
- 痕迹范围：(82,15)–(147,231)；跨度66 × 217 px；痕迹矩形高于宽。
