# Material Visual Observation / obs-comp-cand-000682 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000682`
- External reference / 外部参照: `obimd-sub-dplz0o0oa3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013281_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/s8bffjoah6/dplz0o0oa3/dplz0o0oa3.png`
- Checksum / 校验和:
  `f624555675a422b258957d48f2e2bf897811ec5975902c1ea8b5a21c3c493188`
...
- Marked-pixel bounds: (68,36)–(181,214); span 114 × 179 px; the marked
...
- 痕迹范围：(68,36)–(181,214)；跨度114 × 179 px；痕迹矩形高于宽。
