...
- Project ID: `obs-evo-cand-005348`
- EVOBC category candidate ID: `evobc-evo-cat-05348`
- External category reference: `evobc-cat-05348`
- Source category ID: `05348`
- Source label for human review: `玓`
- Source codepoints: `U+7393`
...
- `obs-evo-cand-005348-route-category-staging`
...
- `obs-evo-cand-005348-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005348-route-evolution-graph`
