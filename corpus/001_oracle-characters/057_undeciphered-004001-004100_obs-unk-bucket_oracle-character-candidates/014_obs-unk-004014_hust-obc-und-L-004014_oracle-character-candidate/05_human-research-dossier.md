# obs-unk-004014 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004014`
- primary external id: `hust-obc-und-L-004014`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/014_obs-unk-004014_h
  ust-obc-und-L-004014_oracle-character-candidate/03_visual-assets/001_asset
  -005607_hust-obc-und-L-004014_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4014/L_？_8540.jpg`
- asset id: `asset-005607`
...
- source class: `HUST-OBC/undeciphered/L/4014/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4014/L_？_8540.jpg`
- asset id: `asset-005607`
...
- English observation: The visible material is arranged on a diagonal.
  A darker curved or angled trace occupies the center, with two short
  separated marks at the left and a thin curved trace toward the upper right.
- 中文观察：可见材料沿斜向分布；中央有较深的弯曲或折线状痕迹，左侧有两枚分离的短痕，右上方另有细长弧形
  痕迹。
...
- Which source records identify obs-unk-004014 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004014？
