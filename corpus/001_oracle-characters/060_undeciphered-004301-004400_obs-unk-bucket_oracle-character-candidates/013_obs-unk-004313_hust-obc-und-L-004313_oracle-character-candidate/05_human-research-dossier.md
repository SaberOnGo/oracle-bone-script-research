# obs-unk-004313 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/013_obs-unk-004313_h
  ust-obc-und-L-004313_oracle-character-candidate/03_visual-assets/001_asset
  -005906_hust-obc-und-L-004313_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4313/L_？_9510.jpg`
- asset id: `asset-005906`
...
- source class: `HUST-OBC/undeciphered/L/4313/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4313/L_？_9510.jpg`
- asset id: `asset-005906`
...
- English observation: `Upper bent trace and separated lower slants
  recorded in 14 file.`
- 中文观察: `已在 14 文件记录上部弯痕和分开的下部斜痕。`
...
- Which source records identify obs-unk-004313 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004313？
