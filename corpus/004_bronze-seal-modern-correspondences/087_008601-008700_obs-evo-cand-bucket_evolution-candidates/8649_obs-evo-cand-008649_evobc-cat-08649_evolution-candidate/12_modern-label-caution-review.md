# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008649
...
- EVOBC candidate category: `evobc-evo-cat-08649`.
- Source label for search only: `赟`.
- Source codepoints for search only: `U+8D5F`.
