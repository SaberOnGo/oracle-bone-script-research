# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003432
...
- EVOBC candidate category: `evobc-evo-cat-03432`.
- Source label for search only: `揟`.
- Source codepoints for search only: `U+63DF`.
