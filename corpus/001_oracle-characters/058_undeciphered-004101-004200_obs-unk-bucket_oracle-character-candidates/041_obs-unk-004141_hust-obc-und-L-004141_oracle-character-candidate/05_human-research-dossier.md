# obs-unk-004141 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004141`
- primary external id: `hust-obc-und-L-004141`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/041_obs-unk-004141_h
  ust-obc-und-L-004141_oracle-character-candidate/03_visual-assets/001_asset
  -005734_hust-obc-und-L-004141_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4141/L_？_8955.jpg`
- asset id: `asset-005734`
...
- source class: `HUST-OBC/undeciphered/L/4141/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4141/L_？_8955.jpg`
- asset id: `asset-005734`
...
- English observation: A pointed upper outline sits above small marks and
  a broad wavy lower trace.
- 中文观察：尖顶上部轮廓位于小痕迹和下部宽波状痕迹上方。
...
- Which source records identify obs-unk-004141 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004141？
