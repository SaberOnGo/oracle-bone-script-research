...
- External category reference: `evobc-cat-03113`
- Source category ID: `03113`
- Source label for human review: `慓`
- Source codepoints: `U+6153`
...
- `obs-evo-cand-003113-route-category-staging`
...
- `obs-evo-cand-003113-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003113-route-evolution-graph`
