# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002159
...
| Glyph or codepoint route / 字形或码位路线 | 33 OBIMD route rows; examples U+5BC5;U+FC733; U+FC734; 另有 31 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 33 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
