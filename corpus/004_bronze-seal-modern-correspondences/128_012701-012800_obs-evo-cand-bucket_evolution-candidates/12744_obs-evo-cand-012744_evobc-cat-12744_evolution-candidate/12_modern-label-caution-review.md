# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012744
...
- EVOBC candidate category: `evobc-evo-cat-12744`.
- Source label for search only: `𪊵`.
- Source codepoints for search only: `U+2A2B5`.
