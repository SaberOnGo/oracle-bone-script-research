# obs-unk-004208 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004208`
- primary external id: `hust-obc-und-L-004208`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/008_obs-unk-004208_h
  ust-obc-und-L-004208_oracle-character-candidate/03_visual-assets/001_asset
  -005801_hust-obc-und-L-004208_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4208/L_？_9163.jpg`
- asset id: `asset-005801`
...
- source class: `HUST-OBC/undeciphered/L/4208/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4208/L_？_9163.jpg`
- asset id: `asset-005801`
...
- English observation: `Pointed outline, side marks, and wavy base visible.`
- 中文观察: `中央尖顶轮廓、两侧痕迹和波曲底部可见。`
...
- Which source records identify obs-unk-004208 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004208？
