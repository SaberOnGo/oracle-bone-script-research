# Material Visual Observation / obs-comp-cand-000842 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000842`
- External reference / 外部参照: `obimd-sub-y0jr13abk4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013713_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xvt1om20u0/y0jr13abk4/y0jr13abk4.png`
- Checksum / 校验和:
  `5ddae93b5235b6c3c4df12398a295aa125124ab326af3d570be7754f5712c23b`
...
- Marked-pixel bounds: (83,17)–(163,230); span 81 × 214 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.07%。
- 痕迹范围：(83,17)–(163,230)；跨度81 × 214 px；痕迹矩形高于宽。
