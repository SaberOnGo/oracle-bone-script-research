# Archaeological Context Review / 考古语境复核: coll-obj-cand-00041
...
Use `18_live-source-evidence-review.md` for the live page and direct visual
observations.
...
| Source item | `772` | `01_collection-object-packet.json` |
| Catalog description | `Ping 0069` | `01_collection-object-packet.json` |
