# obs-unk-003412 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/051_undeciphered-003
  401-003500_obs-unk-bucket_oracle-character-candidates/012_obs-unk-003412_h
  ust-obc-und-L-003412_oracle-character-candidate/03_visual-assets/001_asset
  -005005_hust-obc-und-L-003412_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3412/L_？_6538.jpg`
- asset id: `asset-005005`
...
- source class: `HUST-OBC/undeciphered/L/3412/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3412/L_？_6538.jpg`
- asset id: `asset-005005`
...
- Which source records identify obs-unk-003412 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003412？
