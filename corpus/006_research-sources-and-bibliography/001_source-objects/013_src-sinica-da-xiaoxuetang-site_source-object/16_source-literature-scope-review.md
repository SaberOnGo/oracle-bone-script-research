...
- Authority tier / 证据等级: institutional_portal
- Scope / 适用范围: Official Digital Archives profile for Xiaoxuetang as an
  integrated philology database covering oracle bone, bronze, Warring States,
  seal, regular-script, phonology, and dictionary-index resources.
