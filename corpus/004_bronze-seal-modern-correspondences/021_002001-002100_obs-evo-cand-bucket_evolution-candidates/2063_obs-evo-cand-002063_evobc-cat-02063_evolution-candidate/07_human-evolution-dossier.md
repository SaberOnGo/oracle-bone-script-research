...
- External category reference: `evobc-cat-02063`
- Source category ID: `02063`
- Source label for human review: `奻`
...
- `obs-evo-cand-002063-route-category-staging`
...
- `obs-evo-cand-002063-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002063-route-evolution-graph`
