...
Project ID: `obs-evo-cand-006921`
...
- Project ID: `obs-evo-cand-006921`
- EVOBC category candidate ID: `evobc-evo-cat-06921`
- External category reference: `evobc-cat-06921`
- Source category ID: `06921`
- Source label for human review: `耒`
- Source codepoints: `U+8012`
...
- `obs-evo-cand-006921-route-category-staging`
...
- `obs-evo-cand-006921-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006921-route-evolution-graph`
