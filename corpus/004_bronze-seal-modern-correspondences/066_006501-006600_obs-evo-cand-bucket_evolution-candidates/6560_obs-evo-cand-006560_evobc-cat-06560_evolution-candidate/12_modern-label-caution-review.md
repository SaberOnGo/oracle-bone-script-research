# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006560
...
- EVOBC candidate category: `evobc-evo-cat-06560`.
- Source label for search only: `綱`.
- Source codepoints for search only: `U+7DB1`.
