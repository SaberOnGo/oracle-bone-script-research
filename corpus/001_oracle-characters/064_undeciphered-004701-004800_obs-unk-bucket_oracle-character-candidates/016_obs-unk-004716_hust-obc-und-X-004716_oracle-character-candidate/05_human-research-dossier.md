# obs-unk-004716 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004716`
- primary external id: `hust-obc-und-X-004716`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/016_obs-unk-004716_h
  ust-obc-und-X-004716_oracle-character-candidate/03_visual-assets/001_asset
  -006309_hust-obc-und-X-004716_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/272/X_？_7245_1.png`
- asset id: `asset-006309`
...
- source class: `HUST-OBC/undeciphered/X/272/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/272/X_？_7245_1.png`
- asset id: `asset-006309`
...
- English observation: `rounded upper enclosure with lower branch`
- 中文观察: `带下部分支的圆钝上部围合结构`
...
- Which source records identify obs-unk-004716 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004716？
