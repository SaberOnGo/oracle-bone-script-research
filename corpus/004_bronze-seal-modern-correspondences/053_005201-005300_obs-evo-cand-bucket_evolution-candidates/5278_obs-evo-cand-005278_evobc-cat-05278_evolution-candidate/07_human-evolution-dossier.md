...
- External category reference: `evobc-cat-05278`
- Source category ID: `05278`
- Source label for human review: `狭`
...
- `obs-evo-cand-005278-route-category-staging`
...
- `obs-evo-cand-005278-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005278-route-evolution-graph`
