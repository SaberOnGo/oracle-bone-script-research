...
- External category reference: `evobc-cat-10857`
- Source category ID: `10857`
- Source label for human review: `𠡗`
- Source codepoints: `U+20857`
...
- `obs-evo-cand-010857-route-category-staging`
...
- `obs-evo-cand-010857-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010857-route-evolution-graph`
