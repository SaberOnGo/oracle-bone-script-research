...
- External category reference: `evobc-cat-01618`
- Source category ID: `01618`
- Source label for human review: `啄`
- Source codepoints: `U+5544`
...
- `obs-evo-cand-001618-route-category-staging`
...
- `obs-evo-cand-001618-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001618-route-evolution-graph`
