# Material Visual Observation / obs-comp-cand-000826 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000826`
- External reference / 外部参照: `obimd-sub-r2tbnngvcz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013697_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/r2tbnngvcz/r2tbnngvcz/r2tbnngvcz.png`
- Checksum / 校验和:
  `a52df4582b28a827b2312e2a3d42cddd7430b97ed9cd0fb4099b8e386b4b5926`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.95%.
- Marked-pixel bounds: (75,21)–(188,231); span 114 × 211 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.95%。
- 痕迹范围：(75,21)–(188,231)；跨度114 × 211 px；痕迹矩形高于宽。
