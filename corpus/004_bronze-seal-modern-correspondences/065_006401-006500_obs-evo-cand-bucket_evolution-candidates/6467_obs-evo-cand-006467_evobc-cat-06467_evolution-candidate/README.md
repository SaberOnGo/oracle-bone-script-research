# obs-evo-cand-006467 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-06467`
- Source label for human review: `紡`
- Source codepoints: `U+7D21`
- Image reference count: `60`
- Era token counts: `CS:1;SS:2;WSC:57`
- Source token counts: `Book:6;Web:54`
