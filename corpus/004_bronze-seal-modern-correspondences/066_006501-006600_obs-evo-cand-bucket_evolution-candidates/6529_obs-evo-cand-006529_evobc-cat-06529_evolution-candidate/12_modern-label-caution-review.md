# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006529
...
- EVOBC candidate category: `evobc-evo-cat-06529`.
- Source label for search only: `絺`.
- Source codepoints for search only: `U+7D7A`.
