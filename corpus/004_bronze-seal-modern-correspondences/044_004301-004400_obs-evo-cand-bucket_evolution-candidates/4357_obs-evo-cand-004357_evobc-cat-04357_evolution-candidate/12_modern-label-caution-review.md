# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004357
...
- EVOBC candidate category: `evobc-evo-cat-04357`.
- Source label for search only: `欽`.
- Source codepoints for search only: `U+6B3D`.
