# Material Visual Observation / obs-comp-cand-002134 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002134`
- External reference / 外部参照: `obimd-sub-c3ebatw1vp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019691_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rfhhuaqrts/c3ebatw1vp/c3ebatw1vp.png`
- Checksum / 校验和:
  `991ea9169ea559731c952839c25d4957424c402df33674a66c75e9639d6d45ac`
...
- Marked-pixel bounds: (79,29)–(170,222); span 92 × 194 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.56%。
- 痕迹范围：(79,29)–(170,222)；跨度92 × 194 px；痕迹矩形高于宽。
