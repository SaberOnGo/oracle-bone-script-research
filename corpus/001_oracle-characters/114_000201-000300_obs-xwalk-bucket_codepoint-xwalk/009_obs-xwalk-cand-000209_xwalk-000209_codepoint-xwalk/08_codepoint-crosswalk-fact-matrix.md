...
|---|---|---|
| Source Codepoint Route | `U+34DE` | not identity |
| HUST candidate route | `hust-obc-cat-0232` | not reading |
| OBIMD route | `obimd-main-cand-003002` | not component |
| EVOBC route | `evobc-evo-cat-00021` | not evolution |
