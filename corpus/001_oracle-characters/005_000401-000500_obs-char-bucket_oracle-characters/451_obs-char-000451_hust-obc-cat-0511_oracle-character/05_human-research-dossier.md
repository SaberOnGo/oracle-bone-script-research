# obs-char-000451 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/451_obs-char-000451_hust-obc-cat-0511_orac
  le-character/03_visual-assets/001_asset-000456_hust-obc-cat-0511_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0511/G_0511_乙6694合903賓組.png`
- asset id: `asset-000456`
...
- source category: `0511`
- validation class: `450`
- source image route: `HUST-OBC/deciphered/0511/G_0511_乙6694合903賓組.png`
- asset id: `asset-000456`
...
- English observation: `An angled upper stroke connects to a small
  rectangular enclosure, with one short side branch and a narrow vertical
  extension below.`
- 中文观察: `上部斜向笔画连接小型矩形围框，侧面有一条短分支，下方为狭长竖向延伸。`
...
- dataset label text: `㗵`
- dataset label codepoints: `U+35F5`
...
- filename catalog route clues: `Heji-like filename clue: 合903
...
- Which source records identify obs-char-000451 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000451？
