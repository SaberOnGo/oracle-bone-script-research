...
- External category reference: `evobc-cat-00120`
- Source category ID: `00120`
- Source label for human review: `㤶`
...
- `obs-evo-cand-000120-route-category-staging`
...
- `obs-evo-cand-000120-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000120-route-evolution-graph`
