# obs-char-000722 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/722_obs-char-000722_hust-obc-cat-0820_orac
  le-character/03_visual-assets/001_asset-000727_hust-obc-cat-0820_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0820/G_0820_林1.24.5合36924黃組.png
  `
- asset id: `asset-000727`
...
- source category: `0820`
- validation class: `721`
- source image route: `HUST-OBC/deciphered/0820/G_0820_林1.24.5合36924黃組.png`
- asset id: `asset-000727`
...
- English observation: `A narrow divided loop stands at upper left beside a
  forked angular right cluster; two long tapering strokes descend at
  different angles below them.`
...
- dataset label text: `㜪`
- dataset label codepoints: `U+372A`
...
- filename catalog route clues: `Heji-like filename clue: 合36924
...
- Which source records identify obs-char-000722 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000722？
