...
Project ID: `obs-evo-cand-012198`
...
- Project ID: `obs-evo-cand-012198`
- EVOBC category candidate ID: `evobc-evo-cat-12198`
- External category reference: `evobc-cat-12198`
- Source category ID: `12198`
- Source label for human review: `𧛫`
- Source codepoints: `U+276EB`
...
- `obs-evo-cand-012198-route-category-staging`
...
- `obs-evo-cand-012198-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012198-route-evolution-graph`
