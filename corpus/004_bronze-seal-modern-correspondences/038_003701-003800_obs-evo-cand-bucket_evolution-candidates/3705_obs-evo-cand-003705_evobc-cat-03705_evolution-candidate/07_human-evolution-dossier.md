...
- External category reference: `evobc-cat-03705`
- Source category ID: `03705`
- Source label for human review: `昈`
- Source codepoints: `U+6608`
...
- `obs-evo-cand-003705-route-category-staging`
...
- `obs-evo-cand-003705-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003705-route-evolution-graph`
