...
- External category reference: `evobc-cat-13153`
- Source category ID: `13153`
- Source label: `𫻛`
...
- `obs-evo-cand-013153-route-category-staging`
...
- `obs-evo-cand-013153-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013153-route-evolution-graph`
