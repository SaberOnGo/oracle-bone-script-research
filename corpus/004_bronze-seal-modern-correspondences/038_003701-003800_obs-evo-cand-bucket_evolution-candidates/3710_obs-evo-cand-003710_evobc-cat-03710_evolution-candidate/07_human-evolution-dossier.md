...
- External category reference: `evobc-cat-03710`
- Source category ID: `03710`
- Source label for human review: `昏`
- Source codepoints: `U+660F`
...
- `obs-evo-cand-003710-route-category-staging`
...
- `obs-evo-cand-003710-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003710-route-evolution-graph`
