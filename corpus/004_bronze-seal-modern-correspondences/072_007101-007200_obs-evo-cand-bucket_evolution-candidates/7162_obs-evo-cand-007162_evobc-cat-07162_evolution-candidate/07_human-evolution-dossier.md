...
- External category reference: `evobc-cat-07162`
- Source category ID: `07162`
- Source label for human review: `臧`
- Source codepoints: `U+81E7`
...
- `obs-evo-cand-007162-route-category-staging`
...
- `obs-evo-cand-007162-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007162-route-evolution-graph`
