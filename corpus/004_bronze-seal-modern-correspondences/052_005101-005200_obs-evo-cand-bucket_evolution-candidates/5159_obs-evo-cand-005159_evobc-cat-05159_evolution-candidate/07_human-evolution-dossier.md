...
- External category reference: `evobc-cat-05159`
- Source category ID: `05159`
- Source label for human review: `燭`
- Source codepoints: `U+71ED`
...
- `obs-evo-cand-005159-route-category-staging`
...
- `obs-evo-cand-005159-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005159-route-evolution-graph`
