...
- `obs-evo-cand-012969-route-category-staging`
...
- `obs-evo-cand-012969-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012969-route-evolution-graph`
