...
- External category reference: `evobc-cat-09028`
- Source category ID: `09028`
- Source label for human review: `遍`
- Source codepoints: `U+904D`
...
- `obs-evo-cand-009028-route-category-staging`
...
- `obs-evo-cand-009028-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009028-route-evolution-graph`
