...
Project ID: `obs-evo-cand-013000`
...
- Project ID: `obs-evo-cand-013000`
- EVOBC category candidate ID: `evobc-evo-cat-13000`
- External category reference: `evobc-cat-13000`
- Source category ID: `13000`
- Source label for human review: `𫢢`
- Source codepoints: `U+2B8A2`
...
- `obs-evo-cand-013000-route-category-staging`
...
- `obs-evo-cand-013000-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013000-route-evolution-graph`
