...
Project ID: `obs-evo-cand-004609`
...
- Project ID: `obs-evo-cand-004609`
- EVOBC category candidate ID: `evobc-evo-cat-04609`
- External category reference: `evobc-cat-04609`
- Source category ID: `04609`
- Source label for human review: `洅`
- Source codepoints: `U+6D05`
...
- `obs-evo-cand-004609-route-category-staging`
...
- `obs-evo-cand-004609-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004609-route-evolution-graph`
