...
- External category reference: `evobc-cat-03489`
- Source category ID: `03489`
- Source label for human review: `摺`
...
- `obs-evo-cand-003489-route-category-staging`
...
- `obs-evo-cand-003489-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003489-route-evolution-graph`
