...
- External category reference: `evobc-cat-12821`
- Source category ID: `12821`
- Source label for human review: `𪥸`
- Source codepoints: `U+2A978`
...
- `obs-evo-cand-012821-route-category-staging`
...
- `obs-evo-cand-012821-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012821-route-evolution-graph`
