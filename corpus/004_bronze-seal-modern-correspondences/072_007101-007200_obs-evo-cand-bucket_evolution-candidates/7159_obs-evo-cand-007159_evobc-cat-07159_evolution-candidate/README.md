# obs-evo-cand-007159 / EVOBC evolution-category candidate
...
- EVOBC category candidate ID: `evobc-evo-cat-07159`
- External category ref: `evobc-cat-07159`
- Source label for human review: `臤`
- Source codepoints: `U+81E4`
- Image reference count: `43`
- Era token counts: `OBC:27;SAC:2;SS:1;WSC:13`
- Source token counts: `Book:17;Web:26`
