# Human Research Readiness Review / 正式研究准备复核: obs-evo-cand-013714
...
- Source label for lookup only: `直`.
- Source codepoints for lookup only: `U+FAA8`.
- Era/source code rows to open: `0`.
