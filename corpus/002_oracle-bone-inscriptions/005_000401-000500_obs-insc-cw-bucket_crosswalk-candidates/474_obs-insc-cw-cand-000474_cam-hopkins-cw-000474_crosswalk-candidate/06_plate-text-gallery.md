...
Project ID: `obs-insc-cw-cand-000474`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000474`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000474` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2381` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `339` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `174` [route_present_image_or_text_not_collected]
