...
- External category reference: `evobc-cat-02908`
- Source category ID: `02908`
- Source label for human review: `忝`
- Source codepoints: `U+5FDD`
...
- `obs-evo-cand-002908-route-category-staging`
...
- `obs-evo-cand-002908-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002908-route-evolution-graph`
