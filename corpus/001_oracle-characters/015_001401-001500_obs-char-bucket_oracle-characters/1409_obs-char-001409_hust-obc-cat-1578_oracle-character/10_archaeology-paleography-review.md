# obs-char-001409 Archaeology Paleography Review

# obs-char-001409 考古文字复核档案
...
- first local image: `001_asset-001414_hust-obc-cat-1578_glyph.png`
- first source image: `G_1578_七R5.png`
...
- source label text: `㨠`
- source label codepoints: `U+3A20`
