# obs-char-000408 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000408`
- primary external id: `hust-obc-cat-0464`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/408_obs-char-000408_hust-obc-cat-0464_orac
  le-character/03_visual-assets/001_asset-000413_hust-obc-cat-0464_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0464/H_0464_60219_0.png`
- asset id: `asset-000413`
...
- source category: `0464`
- validation class: `407`
- source image route: `HUST-OBC/deciphered/0464/H_0464_60219_0.png`
- asset id: `asset-000413`
...
- English observation: `The image contains a narrow capped loop at left and
  a larger crossed enclosure with a long angular lower extension at right.`
...
- dataset label text: `㗆`
- dataset label codepoints: `U+35C6`
...
- filename catalog route clues: `catalog-like filename clue: H_0464
  (H_0464_60219_0.png)`
...
- Which source records identify obs-char-000408 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000408？
