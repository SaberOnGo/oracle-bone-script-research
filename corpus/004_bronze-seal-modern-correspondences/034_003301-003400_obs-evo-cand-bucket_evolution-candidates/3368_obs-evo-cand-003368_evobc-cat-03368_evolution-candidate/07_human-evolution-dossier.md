...
Project ID: `obs-evo-cand-003368`
...
- Project ID: `obs-evo-cand-003368`
- EVOBC category candidate ID: `evobc-evo-cat-03368`
- External category reference: `evobc-cat-03368`
- Source category ID: `03368`
- Source label for human review: `捌`
- Source codepoints: `U+634C`
...
- `obs-evo-cand-003368-route-category-staging`
...
- `obs-evo-cand-003368-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003368-route-evolution-graph`
