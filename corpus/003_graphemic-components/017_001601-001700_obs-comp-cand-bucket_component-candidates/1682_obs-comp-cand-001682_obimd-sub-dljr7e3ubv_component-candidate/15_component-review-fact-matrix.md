# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001682
...
| Glyph or codepoint route / 字形或码位路线 | 5 OBIMD route rows; examples U+A99AB;U+F9C1C; U+F9C1D; 另有 3 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
