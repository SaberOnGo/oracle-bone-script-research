...
- External category reference: `evobc-cat-02630`
- Source category ID: `02630`
- Source label for human review: `巹`
- Source codepoints: `U+5DF9`
...
- `obs-evo-cand-002630-route-category-staging`
...
- `obs-evo-cand-002630-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002630-route-evolution-graph`
