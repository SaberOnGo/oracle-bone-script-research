...
- External category reference: `evobc-cat-04261`
- Source category ID: `04261`
- Source label: `橋`
...
- `obs-evo-cand-004261-route-category-staging`
...
- `obs-evo-cand-004261-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-004261-route-evolution-graph`
