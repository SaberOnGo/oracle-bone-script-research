...
Project ID: `obs-evo-cand-013665`
...
- Project ID: `obs-evo-cand-013665`
- EVOBC category candidate ID: `evobc-evo-cat-13665`
- External category reference: `evobc-cat-13665`
- Source category ID: `13665`
- Source label for human review: `𮠦`
- Source codepoints: `U+2E826`
...
- `obs-evo-cand-013665-route-category-staging`
...
- `obs-evo-cand-013665-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013665-route-evolution-graph`
