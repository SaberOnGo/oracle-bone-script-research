...
- External category reference: `evobc-cat-01267`
- Source category ID: `01267`
- Source label for human review: `务`
- Source codepoints: `U+52A1`
...
- `obs-evo-cand-001267-route-category-staging`
...
- `obs-evo-cand-001267-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001267-route-evolution-graph`
