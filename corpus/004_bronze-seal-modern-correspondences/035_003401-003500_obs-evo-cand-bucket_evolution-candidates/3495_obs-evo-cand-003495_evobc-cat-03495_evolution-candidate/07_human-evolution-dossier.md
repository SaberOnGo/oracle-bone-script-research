...
- External category reference: `evobc-cat-03495`
- Source category ID: `03495`
- Source label for human review: `撎`
...
- `obs-evo-cand-003495-route-category-staging`
...
- `obs-evo-cand-003495-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003495-route-evolution-graph`
