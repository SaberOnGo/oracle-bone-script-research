# Material Visual Observation / obs-comp-cand-002020 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002020`
- External reference / 外部参照: `obimd-sub-0mddg7btht`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019347_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tbecf7rhkr/0mddg7btht/0mddg7btht.png`
- Checksum / 校验和:
  `a6fca56ce2b70f4a47ade5a4f008feaabced6824e886090ad38607aab5d6463d`
...
- Marked-pixel bounds: (87,9)–(164,243); span 78 × 235 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.12%。
- 痕迹范围：(87,9)–(164,243)；跨度78 × 235 px；痕迹矩形高于宽。
