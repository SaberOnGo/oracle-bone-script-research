...
Project ID: `obs-insc-cw-cand-000590`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000590`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000590` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2639` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `390` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `484` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `41952` [route_present_image_or_text_not_collected]
