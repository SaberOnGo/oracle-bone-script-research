# obs-unk-004069 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004069`
- primary external id: `hust-obc-und-L-004069`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/069_obs-unk-004069_h
  ust-obc-und-L-004069_oracle-character-candidate/03_visual-assets/001_asset
  -005662_hust-obc-und-L-004069_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4069/L_？_8714.jpg`
- asset id: `asset-005662`
...
- source class: `HUST-OBC/undeciphered/L/4069/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4069/L_？_8714.jpg`
- asset id: `asset-005662`
...
- English observation: A broad compact group occupies the left side, with dark
  horizontal and vertical traces inside a rounded or angular outline. A thinner
  slanting trace extends on the right and ends lower; its connection to the left
  group is not clear.
- 中文观察：左侧有一个较宽的紧凑痕迹组，圆弧或折角轮廓内部可见深色的横向和
  竖向痕迹。右侧有一条较细的斜向痕迹向下延伸；它是否连接左侧痕迹组尚不清楚。
...
- Which source records identify obs-unk-004069 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004069？
