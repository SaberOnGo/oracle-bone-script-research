...
- External category reference: `evobc-cat-01990`
- Source category ID: `01990`
- Source label for human review: `夋`
- Source codepoints: `U+590B`
...
- `obs-evo-cand-001990-route-category-staging`
...
- `obs-evo-cand-001990-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001990-route-evolution-graph`
