...
- Project ID: `obs-evo-cand-000169`
- EVOBC category candidate ID: `evobc-evo-cat-00169`
- External category reference: `evobc-cat-00169`
- Source category ID: `00169`
- Source label for human review: `㭾`
- Source codepoints: `U+3B7E`
...
- `obs-evo-cand-000169-route-category-staging`
...
- `obs-evo-cand-000169-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000169-route-evolution-graph`
