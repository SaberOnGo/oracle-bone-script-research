...
- External category reference: `evobc-cat-07403`
- Source category ID: `07403`
- Source label: `菆`
...
- `obs-evo-cand-007403-route-category-staging`
...
- `obs-evo-cand-007403-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007403-route-evolution-graph`
