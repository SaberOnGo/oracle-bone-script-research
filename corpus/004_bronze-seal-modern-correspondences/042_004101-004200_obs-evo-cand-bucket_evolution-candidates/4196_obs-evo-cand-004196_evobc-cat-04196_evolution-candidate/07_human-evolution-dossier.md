...
- External category reference: `evobc-cat-04196`
- Source category ID: `04196`
- Source label for human review: `榼`
- Source codepoints: `U+69BC`
...
- `obs-evo-cand-004196-route-category-staging`
...
- `obs-evo-cand-004196-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004196-route-evolution-graph`
