...
Project ID: `obs-evo-cand-013230`
...
- Project ID: `obs-evo-cand-013230`
- EVOBC category candidate ID: `evobc-evo-cat-13230`
- External category reference: `evobc-cat-13230`
- Source category ID: `13230`
- Source label for human review: `𬋇`
- Source codepoints: `U+2C2C7`
...
- `obs-evo-cand-013230-route-category-staging`
...
- `obs-evo-cand-013230-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013230-route-evolution-graph`
