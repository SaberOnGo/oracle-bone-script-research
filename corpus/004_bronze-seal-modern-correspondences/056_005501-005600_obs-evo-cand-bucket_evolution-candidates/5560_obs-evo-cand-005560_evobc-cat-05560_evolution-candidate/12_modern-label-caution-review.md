# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-005560
...
- EVOBC candidate category: `evobc-evo-cat-05560`.
- Source label for search only: `界`.
- Source codepoints for search only: `U+754C`.
