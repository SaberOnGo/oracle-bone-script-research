# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004642
...
- EVOBC candidate category: `evobc-evo-cat-04642`.
- Source label for search only: `活`.
- Source codepoints for search only: `U+6D3B`.
