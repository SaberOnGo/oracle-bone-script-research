# obs-unk-005356 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005356`
- primary external id: `hust-obc-und-X-005356`
...
- local review image route: `corpus/001_oracle-characters/070_undeciphered-005
  301-005400_obs-unk-bucket_oracle-character-candidates/056_obs-unk-005356_h
  ust-obc-und-X-005356_oracle-character-candidate/03_visual-assets/001_asset
  -006949_hust-obc-und-X-005356_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/912/X_？_7875_1.png`
- asset id: `asset-006949`
...
- source class: `HUST-OBC/undeciphered/X/912/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/912/X_？_7875_1.png`
- asset id: `asset-006949`
...
- Which source records identify obs-unk-005356 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005356？
