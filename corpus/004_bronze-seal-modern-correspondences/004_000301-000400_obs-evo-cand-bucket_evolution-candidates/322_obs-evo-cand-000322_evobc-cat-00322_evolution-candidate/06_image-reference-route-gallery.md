...
- `obs-evo-cand-000322-route-category-staging`
...
- `obs-evo-cand-000322-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000322-route-evolution-graph`
