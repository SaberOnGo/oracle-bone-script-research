...
Project ID: `obs-evo-cand-003041`
...
- Project ID: `obs-evo-cand-003041`
- EVOBC category candidate ID: `evobc-evo-cat-03041`
- External category reference: `evobc-cat-03041`
- Source category ID: `03041`
- Source label for human review: `惉`
- Source codepoints: `U+60C9`
...
- `obs-evo-cand-003041-route-category-staging`
...
- `obs-evo-cand-003041-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003041-route-evolution-graph`
