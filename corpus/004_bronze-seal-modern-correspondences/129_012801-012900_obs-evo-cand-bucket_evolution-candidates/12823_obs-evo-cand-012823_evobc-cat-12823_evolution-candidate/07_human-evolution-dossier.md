...
Project ID: `obs-evo-cand-012823`
...
- Project ID: `obs-evo-cand-012823`
- EVOBC category candidate ID: `evobc-evo-cat-12823`
- External category reference: `evobc-cat-12823`
- Source category ID: `12823`
- Source label for human review: `𪧇`
- Source codepoints: `U+2A9C7`
- Image reference count in source metadata: `39`
...
- `obs-evo-cand-012823-route-category-staging`
...
- `obs-evo-cand-012823-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012823-route-evolution-graph`
