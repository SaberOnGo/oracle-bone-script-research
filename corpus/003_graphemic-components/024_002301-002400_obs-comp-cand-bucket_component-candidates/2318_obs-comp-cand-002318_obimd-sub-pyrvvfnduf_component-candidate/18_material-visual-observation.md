# Material Visual Observation / obs-comp-cand-002318 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002318`
- External reference / 外部参照: `obimd-sub-pyrvvfnduf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020337_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3jzeliplnn/pyrvvfnduf/pyrvvfnduf.png`
- Checksum / 校验和:
  `0b1a1672cfe16188b4fb70f488c606a938e4330e37459b4b4e307d21389bf99b`
...
- Marked-pixel bounds: (65,34)–(184,213); span 120 × 180 px; the marked
...
- 痕迹范围：(65,34)–(184,213)；跨度120 × 180 px；痕迹矩形高于宽。
