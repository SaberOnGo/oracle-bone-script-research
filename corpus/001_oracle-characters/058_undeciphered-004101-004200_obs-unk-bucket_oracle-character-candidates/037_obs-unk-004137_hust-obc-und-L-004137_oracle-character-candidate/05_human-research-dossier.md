# obs-unk-004137 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/037_obs-unk-004137_h
  ust-obc-und-L-004137_oracle-character-candidate/03_visual-assets/001_asset
  -005730_hust-obc-und-L-004137_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4137/L_？_8940.jpg`
- asset id: `asset-005730`
...
- source class: `HUST-OBC/undeciphered/L/4137/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4137/L_？_8940.jpg`
- asset id: `asset-005730`
...
- English observation: Two tall curved traces rise above a narrow central
  trace and a compact lower angular mark.
- 中文观察：两条较高弯曲痕迹位于窄中央痕迹和下部折角痕迹上方。
...
- Which source records identify obs-unk-004137 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004137？
