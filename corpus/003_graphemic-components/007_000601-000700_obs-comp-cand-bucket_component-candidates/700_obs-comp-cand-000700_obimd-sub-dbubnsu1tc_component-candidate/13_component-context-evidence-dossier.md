# obs-comp-cand-000700 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000700`
- 首选外部 ID: `obimd-sub-dbubnsu1tc`
- OBIMD subcharacter UID: `dbubnsu1tc`
- OBIMD main character UID: `dbubnsu1tc`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+2B9D6;U+F3FF3; U+F3FF4; 另有 2 项
