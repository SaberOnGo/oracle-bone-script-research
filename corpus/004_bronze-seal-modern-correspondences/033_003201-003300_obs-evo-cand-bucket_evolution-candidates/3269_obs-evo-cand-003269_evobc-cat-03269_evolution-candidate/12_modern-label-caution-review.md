# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003269
...
- EVOBC candidate category: `evobc-evo-cat-03269`.
- Source label for search only: `承`.
- Source codepoints for search only: `U+627F`.
