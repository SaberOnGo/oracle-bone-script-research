# obs-unk-004564 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004564`
- primary external id: `hust-obc-und-X-004564`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/064_obs-unk-004564_h
  ust-obc-und-X-004564_oracle-character-candidate/03_visual-assets/001_asset
  -006157_hust-obc-und-X-004564_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/120/X_？_8300_1.png`
- asset id: `asset-006157`
...
- source class: `HUST-OBC/undeciphered/X/120/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/120/X_？_8300_1.png`
- asset id: `asset-006157`
...
- English observation: `Wavy traces, channels, and lower opening recorded.`
- 中文观察: `已记录波曲痕迹、内部通道和下部开口。`
...
- Which source records identify obs-unk-004564 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004564？
