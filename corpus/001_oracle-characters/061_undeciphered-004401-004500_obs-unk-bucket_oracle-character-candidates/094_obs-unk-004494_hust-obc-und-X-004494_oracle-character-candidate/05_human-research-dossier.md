# obs-unk-004494 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/094_obs-unk-004494_h
  ust-obc-und-X-004494_oracle-character-candidate/03_visual-assets/001_asset
  -006087_hust-obc-und-X-004494_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/50/X_？_8234_1.png`
- asset id: `asset-006087`
...
- source class: `HUST-OBC/undeciphered/X/50/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/50/X_？_8234_1.png`
- asset id: `asset-006087`
...
- English observation: `The side traces, central cluster, enclosed opening, and
  short rising stroke are directly recorded.`
- 中文观察: `已直接记录两侧痕迹、中央弯曲痕迹群、封闭开口和短上伸痕。`
...
- Which source records identify obs-unk-004494 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004494？
