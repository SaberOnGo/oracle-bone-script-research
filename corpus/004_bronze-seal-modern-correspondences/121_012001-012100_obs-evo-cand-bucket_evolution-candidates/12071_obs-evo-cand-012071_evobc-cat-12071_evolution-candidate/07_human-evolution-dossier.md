...
- Project ID: `obs-evo-cand-012071`
- EVOBC category candidate ID: `evobc-evo-cat-12071`
- External category reference: `evobc-cat-12071`
- Source category ID: `12071`
- Source label for human review: `𦤜`
- Source codepoints: `U+2691C`
...
- `obs-evo-cand-012071-route-category-staging`
...
- `obs-evo-cand-012071-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012071-route-evolution-graph`
