...
Project ID: `obs-evo-cand-009117`
...
- Project ID: `obs-evo-cand-009117`
- EVOBC category candidate ID: `evobc-evo-cat-09117`
- External category reference: `evobc-cat-09117`
- Source category ID: `09117`
- Source label for human review: `邸`
- Source codepoints: `U+90B8`
...
- `obs-evo-cand-009117-route-category-staging`
...
- `obs-evo-cand-009117-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009117-route-evolution-graph`
