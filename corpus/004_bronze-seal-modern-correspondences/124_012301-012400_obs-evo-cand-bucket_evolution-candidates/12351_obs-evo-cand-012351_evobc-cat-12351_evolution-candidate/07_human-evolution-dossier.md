...
Project ID: `obs-evo-cand-012351`
...
- Project ID: `obs-evo-cand-012351`
- EVOBC category candidate ID: `evobc-evo-cat-12351`
- External category reference: `evobc-cat-12351`
- Source category ID: `12351`
- Source label for human review: `𨒐`
- Source codepoints: `U+28490`
...
- `obs-evo-cand-012351-route-category-staging`
...
- `obs-evo-cand-012351-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012351-route-evolution-graph`
