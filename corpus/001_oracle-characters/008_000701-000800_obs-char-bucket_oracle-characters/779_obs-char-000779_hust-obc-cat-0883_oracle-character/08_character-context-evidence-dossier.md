...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0883`
...
- Source image / 来源图: `X_0883_2897_1.png`
- Image / 图像: `001_asset-000784_hust-obc-cat-0883_glyph.png`
...
- target node: `evobc-evo-cat-00073`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/073_obs-evo-cand-000073_evobc-cat-00073_evoluti
...
- Source label text / 来源标签文字: `㝩`
- Source label codepoint / 来源标签 codepoint: `U+3769`
