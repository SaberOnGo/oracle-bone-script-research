...
- `obs-evo-cand-013086-route-category-staging`
...
- `obs-evo-cand-013086-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013086-route-evolution-graph`
