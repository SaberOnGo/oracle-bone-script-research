# obs-unk-004864 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004864`
- primary external id: `hust-obc-und-X-004864`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/064_obs-unk-004864_h
  ust-obc-und-X-004864_oracle-character-candidate/03_visual-assets/001_asset
  -006457_hust-obc-und-X-004864_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/420/X_？_7404_1.png`
- asset id: `asset-006457`
...
- source class: `HUST-OBC/undeciphered/X/420/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/420/X_？_7404_1.png`
- asset id: `asset-006457`
...
- English observation: `upper opening and three descending strokes`
- 中文观察: `上部开口和三条下伸笔画`
...
- Which source records identify obs-unk-004864 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004864？
