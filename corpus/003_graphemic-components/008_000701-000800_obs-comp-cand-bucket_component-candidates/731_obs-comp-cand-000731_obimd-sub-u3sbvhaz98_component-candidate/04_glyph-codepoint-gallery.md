# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000731
...
| --- | --- | --- | --- |
| `obimd-glyph-link-010596` | 󴋽 | `U+F42FD` | `reviewed_metadata_only` |
| `obimd-glyph-link-010597` | 󴋾 | `U+F42FE` | `reviewed_metadata_only` |
| `obimd-glyph-link-010598` | 󴋿 | `U+F42FF` | `reviewed_metadata_only` |
| `obimd-glyph-link-010599` | 󴌀 | `U+F4300` | `reviewed_metadata_only` |
