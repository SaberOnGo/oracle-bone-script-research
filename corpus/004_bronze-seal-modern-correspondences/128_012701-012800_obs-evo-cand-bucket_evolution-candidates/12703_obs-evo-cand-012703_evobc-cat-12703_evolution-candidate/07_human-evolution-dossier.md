...
- Project ID: `obs-evo-cand-012703`
- EVOBC category candidate ID: `evobc-evo-cat-12703`
- External category reference: `evobc-cat-12703`
- Source category ID: `12703`
- Source label for human review: `𩸈`
- Source codepoints: `U+29E08`
...
- `obs-evo-cand-012703-route-category-staging`
...
- `obs-evo-cand-012703-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012703-route-evolution-graph`
