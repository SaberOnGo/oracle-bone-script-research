...
Project ID: `obs-evo-cand-011626`
...
- Project ID: `obs-evo-cand-011626`
- EVOBC category candidate ID: `evobc-evo-cat-11626`
- External category reference: `evobc-cat-11626`
- Source category ID: `11626`
- Source label for human review: `𤠝`
- Source codepoints: `U+2481D`
- Image reference count in source metadata: `25`
...
- `obs-evo-cand-011626-route-category-staging`
...
- `obs-evo-cand-011626-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011626-route-evolution-graph`
