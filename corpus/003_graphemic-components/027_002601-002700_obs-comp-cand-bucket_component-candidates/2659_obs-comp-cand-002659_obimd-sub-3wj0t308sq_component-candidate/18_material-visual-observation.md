# Material Visual Observation / obs-comp-cand-002659 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002659`
- External reference / 外部参照: `obimd-sub-3wj0t308sq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021235_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3wj0t308sq/3wj0t308sq/3wj0t308sq.png`
- Checksum / 校验和:
  `331cc150eff79fa20c862fd3eddd23ad3c25d59e5d95b053fe867b5e8b7dcaf0`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.11%.
- Marked-pixel bounds: (95,19)–(154,230); span 60 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.11%。
- 痕迹范围：(95,19)–(154,230)；跨度60 × 212 px；痕迹矩形高于宽。
