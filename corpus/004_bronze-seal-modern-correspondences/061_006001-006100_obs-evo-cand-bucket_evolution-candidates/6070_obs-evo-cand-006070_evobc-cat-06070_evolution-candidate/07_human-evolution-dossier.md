...
Project ID: `obs-evo-cand-006070`
...
- Project ID: `obs-evo-cand-006070`
- EVOBC category candidate ID: `evobc-evo-cat-06070`
- External category reference: `evobc-cat-06070`
- Source category ID: `06070`
- Source label for human review: `秠`
- Source codepoints: `U+79E0`
...
- `obs-evo-cand-006070-route-category-staging`
...
- `obs-evo-cand-006070-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006070-route-evolution-graph`
