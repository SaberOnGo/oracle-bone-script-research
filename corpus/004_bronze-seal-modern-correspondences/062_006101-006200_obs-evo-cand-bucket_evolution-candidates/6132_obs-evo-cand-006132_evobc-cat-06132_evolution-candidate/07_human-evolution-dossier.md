...
Project ID: `obs-evo-cand-006132`
...
- Project ID: `obs-evo-cand-006132`
- EVOBC category candidate ID: `evobc-evo-cat-06132`
- External category reference: `evobc-cat-06132`
- Source category ID: `06132`
- Source label for human review: `穜`
- Source codepoints: `U+7A5C`
...
- `obs-evo-cand-006132-route-category-staging`
...
- `obs-evo-cand-006132-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006132-route-evolution-graph`
