# Material Visual Observation / obs-comp-cand-001678 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001678`
- External reference / 外部参照: `obimd-sub-rieg6lacvu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017594_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/a0xx5u34nm/rieg6lacvu/rieg6lacvu.png`
- Checksum / 校验和:
  `ce5d68e0c94c87c7d7c67536d6806c8098e1ec925521ee1778dc94e07e8d2522`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.99%.
- Marked-pixel bounds: (62,20)–(192,230); span 131 × 211 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.99%。
- 痕迹范围：(62,20)–(192,230)；跨度131 × 211 px；痕迹矩形高于宽。
