# Material Visual Observation / obs-comp-cand-000068 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000068`
- External reference / 外部参照: `obimd-sub-wiqqiqakh8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011481_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/nscqmvthk1/wiqqiqakh8/wiqqiqakh8.png`
- Checksum / 校验和:
  `26cdc3e6b2952623c04b394a8c0dd990951fbbc960fa2acc2ee9de0cbc8ef8ba`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.72%.
- Marked-pixel bounds: (60,28)–(189,214); span 130 × 187 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.72%。
- 痕迹范围：(60,28)–(189,214)；跨度130 × 187 px；痕迹矩形高于宽。
