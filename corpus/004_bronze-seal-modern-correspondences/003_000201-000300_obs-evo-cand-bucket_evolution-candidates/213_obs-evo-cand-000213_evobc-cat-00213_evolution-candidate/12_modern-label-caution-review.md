# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000213
...
- EVOBC candidate category: `evobc-evo-cat-00213`.
- Source label for search only: `㴪`.
- Source codepoints for search only: `U+3D2A`.
