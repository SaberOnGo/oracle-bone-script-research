...
- External category reference: `evobc-cat-01029`
- Source category ID: `01029`
- Source label for human review: `僯`
...
- `obs-evo-cand-001029-route-category-staging`
...
- `obs-evo-cand-001029-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001029-route-evolution-graph`
