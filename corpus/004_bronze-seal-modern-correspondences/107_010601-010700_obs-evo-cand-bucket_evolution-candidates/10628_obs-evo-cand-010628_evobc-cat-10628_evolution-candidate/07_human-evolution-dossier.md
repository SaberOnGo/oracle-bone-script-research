...
Project ID: `obs-evo-cand-010628`
...
- Project ID: `obs-evo-cand-010628`
- EVOBC category candidate ID: `evobc-evo-cat-10628`
- External category reference: `evobc-cat-10628`
- Source category ID: `10628`
- Source label for human review: `麵`
- Source codepoints: `U+9EB5`
...
- `obs-evo-cand-010628-route-category-staging`
...
- `obs-evo-cand-010628-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010628-route-evolution-graph`
