# obs-char-000385 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000385`
- primary external id: `hust-obc-cat-0437`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/385_obs-char-000385_hust-obc-cat-0437_orac
  le-character/03_visual-assets/001_asset-000390_hust-obc-cat-0437_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0437/G_0437_甲骨文.png`
- asset id: `asset-000390`
...
- source category: `0437`
- validation class: `384`
- source image route: `HUST-OBC/deciphered/0437/G_0437_甲骨文.png`
- asset id: `asset-000390`
...
- English observation: `A forked upper stem sits above a peaked open outline
  and a short crooked central mark.`
- 中文观察: `分叉上部主干位于尖顶开放轮廓之上，轮廓内有短曲折中央痕迹。`
...
- dataset label text: `㖫`
- dataset label codepoints: `U+35AB`
...
- Which source records identify obs-char-000385 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000385？
