# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010595
...
- EVOBC candidate category: `evobc-evo-cat-10595`.
- Source label for search only: `鹺`.
- Source codepoints for search only: `U+9E7A`.
