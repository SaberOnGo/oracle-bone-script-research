# obs-unk-004516 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004516`
- primary external id: `hust-obc-und-X-004516`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/016_obs-unk-004516_h
  ust-obc-und-X-004516_oracle-character-candidate/03_visual-assets/001_asset
  -006109_hust-obc-und-X-004516_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/72/X_？_8256_1.png`
- asset id: `asset-006109`
...
- source class: `HUST-OBC/undeciphered/X/72/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/72/X_？_8256_1.png`
- asset id: `asset-006109`
...
- English observation: `The upper cap, two interior openings, lower trace, and
  side projections are directly recorded.`
- 中文观察: `已直接记录上部横帽、两个内部空隙、下部长痕和两侧外伸痕。`
...
- Which source records identify obs-unk-004516 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004516？
