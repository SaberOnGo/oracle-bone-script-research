...
- External category reference: `evobc-cat-02733`
- Source category ID: `02733`
- Source label for human review: `庪`
...
- `obs-evo-cand-002733-route-category-staging`
...
- `obs-evo-cand-002733-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002733-route-evolution-graph`
