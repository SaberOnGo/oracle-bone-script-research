...
- External category reference: `evobc-cat-05366`
- Source category ID: `05366`
- Source label for human review: `玽`
...
- `obs-evo-cand-005366-route-category-staging`
...
- `obs-evo-cand-005366-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005366-route-evolution-graph`
