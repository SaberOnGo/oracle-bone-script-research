...
Project ID: `obs-evo-cand-011298`
...
- Project ID: `obs-evo-cand-011298`
- EVOBC category candidate ID: `evobc-evo-cat-11298`
- External category reference: `evobc-cat-11298`
- Source category ID: `11298`
- Source label for human review: `𢪇`
- Source codepoints: `U+22A87`
...
- `obs-evo-cand-011298-route-category-staging`
...
- `obs-evo-cand-011298-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011298-route-evolution-graph`
