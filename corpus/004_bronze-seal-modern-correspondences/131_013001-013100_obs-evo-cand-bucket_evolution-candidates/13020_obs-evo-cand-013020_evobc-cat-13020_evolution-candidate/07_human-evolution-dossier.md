...
Project ID: `obs-evo-cand-013020`
...
- Project ID: `obs-evo-cand-013020`
- EVOBC category candidate ID: `evobc-evo-cat-13020`
- External category reference: `evobc-cat-13020`
- Source category ID: `13020`
- Source label for human review: `𫦡`
- Source codepoints: `U+2B9A1`
...
- `obs-evo-cand-013020-route-category-staging`
...
- `obs-evo-cand-013020-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013020-route-evolution-graph`
