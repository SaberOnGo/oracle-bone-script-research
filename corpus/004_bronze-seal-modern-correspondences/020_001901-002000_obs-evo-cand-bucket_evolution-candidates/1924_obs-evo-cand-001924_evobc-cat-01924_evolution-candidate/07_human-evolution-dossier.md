...
Project ID: `obs-evo-cand-001924`
...
- Project ID: `obs-evo-cand-001924`
- EVOBC category candidate ID: `evobc-evo-cat-01924`
- External category reference: `evobc-cat-01924`
- Source category ID: `01924`
- Source label for human review: `塧`
- Source codepoints: `U+5867`
...
- `obs-evo-cand-001924-route-category-staging`
...
- `obs-evo-cand-001924-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001924-route-evolution-graph`
