# obs-unk-004218 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004218`
- primary external id: `hust-obc-und-L-004218`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/018_obs-unk-004218_h
  ust-obc-und-L-004218_oracle-character-candidate/03_visual-assets/001_asset
  -005811_hust-obc-und-L-004218_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4218/L_？_9224.jpg`
- asset id: `asset-005811`
...
- source class: `HUST-OBC/undeciphered/L/4218/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4218/L_？_9224.jpg`
- asset id: `asset-005811`
...
- English observation: `Tall irregular cluster and crossing diagonals visible.`
- 中文观察: `高而不规则的痕迹簇及交叉斜笔画可见。`
...
- Which source records identify obs-unk-004218 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004218？
