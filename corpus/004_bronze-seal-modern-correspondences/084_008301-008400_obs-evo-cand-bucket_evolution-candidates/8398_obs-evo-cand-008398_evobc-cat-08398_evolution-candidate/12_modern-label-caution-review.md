# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008398
...
- EVOBC candidate category: `evobc-evo-cat-08398`.
- Source label for search only: `讜`.
- Source codepoints for search only: `U+8B9C`.
