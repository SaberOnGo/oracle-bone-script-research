...
- External category reference: `evobc-cat-10009`
- Source category ID: `10009`
...
- `obs-evo-cand-010009-route-category-staging`
...
- `obs-evo-cand-010009-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010009-route-evolution-graph`
