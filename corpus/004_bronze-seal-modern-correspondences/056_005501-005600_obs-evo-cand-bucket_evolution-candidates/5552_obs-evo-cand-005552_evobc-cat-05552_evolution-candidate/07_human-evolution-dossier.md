...
Project ID: `obs-evo-cand-005552`
...
- Project ID: `obs-evo-cand-005552`
- EVOBC category candidate ID: `evobc-evo-cat-05552`
- External category reference: `evobc-cat-05552`
- Source category ID: `05552`
- Source label for human review: `町`
- Source codepoints: `U+753A`
...
- `obs-evo-cand-005552-route-category-staging`
...
- `obs-evo-cand-005552-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005552-route-evolution-graph`
