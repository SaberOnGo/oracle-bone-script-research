# obs-char-000500 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000500`
- primary external id: `hust-obc-cat-0571`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/500_obs-char-000500_hust-obc-cat-0571_orac
  le-character/03_visual-assets/001_asset-000505_hust-obc-cat-0571_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0571/G_0571_七S180.png`
- asset id: `asset-000505`
...
- source category: `0571`
- validation class: `499`
- source image route: `HUST-OBC/deciphered/0571/G_0571_七S180.png`
- asset id: `asset-000505`
...
- English observation: `A narrow upright form combines a forked upper
  crossing, a central enclosed diamond divided by short strokes, and two
  long diverging lower extensions.`
- 中文观察: `狭长直立形体结合叉状上部交叉、由短笔分隔的中央菱形围框和两条长分向下部延伸。`
...
- dataset label text: `㘱`
- dataset label codepoints: `U+3631`
...
- Which source records identify obs-char-000500 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000500？
