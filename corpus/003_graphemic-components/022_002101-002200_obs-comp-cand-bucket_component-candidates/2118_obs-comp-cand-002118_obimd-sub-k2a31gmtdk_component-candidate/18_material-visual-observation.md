# Material Visual Observation / obs-comp-cand-002118 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002118`
- External reference / 外部参照: `obimd-sub-k2a31gmtdk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019675_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7gvythc7mi/k2a31gmtdk/k2a31gmtdk.png`
- Checksum / 校验和:
  `68661f6dc4481aa65bc796dd3c89cf3f988526ab7c0fe2000ba6788ee2f471a1`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.24%.
- Marked-pixel bounds: (66,51)–(183,192); span 118 × 142 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.24%。
- 痕迹范围：(66,51)–(183,192)；跨度118 × 142 px；痕迹矩形高于宽。
