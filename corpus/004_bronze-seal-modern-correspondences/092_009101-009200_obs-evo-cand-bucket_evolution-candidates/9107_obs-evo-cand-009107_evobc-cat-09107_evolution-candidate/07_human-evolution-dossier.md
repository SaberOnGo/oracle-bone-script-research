...
Project ID: `obs-evo-cand-009107`
...
- Project ID: `obs-evo-cand-009107`
- EVOBC category candidate ID: `evobc-evo-cat-09107`
- External category reference: `evobc-cat-09107`
- Source category ID: `09107`
- Source label for human review: `邭`
- Source codepoints: `U+90AD`
...
- `obs-evo-cand-009107-route-category-staging`
...
- `obs-evo-cand-009107-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009107-route-evolution-graph`
