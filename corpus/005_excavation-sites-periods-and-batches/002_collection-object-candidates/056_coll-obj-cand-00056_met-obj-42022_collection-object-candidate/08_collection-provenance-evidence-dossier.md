# Collection Provenance Evidence Dossier / 馆藏来源证据档案: coll-obj-cand-00056
...
| evidence_download_id | `dl-metmuseum-object-42022` |
| source_file_path | `corpus/005_excavation-sites-periods-and-batches/000_collection-registers/005_metmuseum-oracle-bone-object-staging.csv` |
| source_row_id | `2` |
| object_page_url | `https://www.metmuseum.org/art/collection/search/42022` |
...
| http_status | `200` |
| accessed_file_size_bytes | `1504` |
| checksum_sha256 | `6476cda2ef3e03fefb80be4c9b725e78b460131f7246d0faff101066297545c0` |
| local_temp_path | `tmp/source_downloads/dl-metmuseum-object-42022.json` |
...
| asset_path | `corpus/005_excavation-sites-periods-and-batches/001_public-domain-object-image-assets/002_asset-000002_met-obj-42022_object-image.jpg` |
| thumbnail_url | `` |
| source_image_url | `https://images.metmuseum.org/CRDImages/as/original/LC-18_56_71_002.jpg` |

## Findspot Period Batch Plate Evidence / 出土地、时期、批次与图版证据

| Catalog field / 著录字段 | Source value / 来源取值 |
| --- | --- |
| `collection_name` | `The Met Collection` |
| `source_collection_item_id` | `42022` |
| `object_title_en` | `Oracle Bone Fragment` |
| `catalog_reference_text` | `` |
| `accession_number` | `18.56.71` |
| `historical_period` | `Shang dynasty ca. 1600-1046 BCE` |
| `object_date` | `13th-11th century BCE` |
| `provenience` | `` |
| `geography` | `` |
...
All rows here are candidate evidence only. They preserve source, rights, visual,
catalog, and missing-context routes for human review; they are not a
