# Material Visual Observation / obs-comp-cand-002218 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002218`
- External reference / 外部参照: `obimd-sub-h32m5ulkit`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020002_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h32m5ulkit/h32m5ulkit/2cwkm99jxj.png`
- Checksum / 校验和:
  `c1dc7e6c04668f3a207f71abf81ef6a5f85f457d2aa6fa0c986aa532bd6deb2b`
...
- Marked-pixel bounds: (82,45)–(167,210); span 86 × 166 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.40%。
- 痕迹范围：(82,45)–(167,210)；跨度86 × 166 px；痕迹矩形高于宽。
