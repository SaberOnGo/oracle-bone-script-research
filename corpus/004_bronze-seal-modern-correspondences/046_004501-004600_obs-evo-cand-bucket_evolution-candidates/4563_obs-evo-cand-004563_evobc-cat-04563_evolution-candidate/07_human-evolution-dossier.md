...
- External category reference: `evobc-cat-04563`
- Source category ID: `04563`
- Source label for human review: `沼`
...
- `obs-evo-cand-004563-route-category-staging`
...
- `obs-evo-cand-004563-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004563-route-evolution-graph`
