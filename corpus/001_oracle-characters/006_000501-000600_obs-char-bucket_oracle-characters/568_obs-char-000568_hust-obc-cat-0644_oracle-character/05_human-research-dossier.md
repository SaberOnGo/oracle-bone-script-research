# obs-char-000568 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000568`
- primary external id: `hust-obc-cat-0644`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/568_obs-char-000568_hust-obc-cat-0644_orac
  le-character/03_visual-assets/001_asset-000573_hust-obc-cat-0644_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0644/G_0644_乙137合21339𠂤組.png`
- asset id: `asset-000573`
...
- source category: `0644`
- validation class: `567`
- source image route: `HUST-OBC/deciphered/0644/G_0644_乙137合21339𠂤組.png`
- asset id: `asset-000573`
...
- English observation: `A single narrow sinuous form begins with a pointed
  angular upper turn and continues through two broad bends into a tapered
  lower curve.`
- 中文观察: `单个狭窄曲折形以上部尖折起始，经两处宽弯延续为渐尖下曲线。`
...
- dataset label text: `㙺`
- dataset label codepoints: `U+367A`
...
- filename catalog route clues: `Heji-like filename clue: 合21339
  (G_0644_乙137合21339𠂤組.png)`
...
- Which source records identify obs-char-000568 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000568？
