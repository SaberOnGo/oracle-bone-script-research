...
- External category reference: `evobc-cat-00955`
- Source category ID: `00955`
- Source label for human review: `偓`
- Source codepoints: `U+5053`
...
- `obs-evo-cand-000955-route-category-staging`
...
- `obs-evo-cand-000955-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000955-route-evolution-graph`
