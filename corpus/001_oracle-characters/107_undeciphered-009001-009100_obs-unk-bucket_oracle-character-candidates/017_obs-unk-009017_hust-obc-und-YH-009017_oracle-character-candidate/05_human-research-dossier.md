# obs-unk-009017 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-009017`
- primary external id: `hust-obc-und-YH-009017`
...
- local review image route: `corpus/001_oracle-characters/107_undeciphered-009
  001-009100_obs-unk-bucket_oracle-character-candidates/017_obs-unk-009017_h
  ust-obc-und-YH-009017_oracle-character-candidate/03_visual-assets/001_asse
  t-010608_hust-obc-und-YH-009017_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/610AE/H_？_610AE_0.png`
- asset id: `asset-010608`
...
- source class: `HUST-OBC/undeciphered/Y+H/610AE/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/610AE/H_？_610AE_0.png`
- asset id: `asset-010608`
...
- Which source records identify obs-unk-009017 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009017？
