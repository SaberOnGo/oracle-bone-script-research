...
Project ID: `obs-evo-cand-005842`
...
- Project ID: `obs-evo-cand-005842`
- EVOBC category candidate ID: `evobc-evo-cat-05842`
- External category reference: `evobc-cat-05842`
- Source category ID: `05842`
- Source label for human review: `瞀`
- Source codepoints: `U+7780`
...
- `obs-evo-cand-005842-route-category-staging`
...
- `obs-evo-cand-005842-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005842-route-evolution-graph`
