...
Project ID: `obs-evo-cand-003954`
...
- Project ID: `obs-evo-cand-003954`
- EVOBC category candidate ID: `evobc-evo-cat-03954`
- External category reference: `evobc-cat-03954`
- Source category ID: `03954`
- Source label for human review: `某`
- Source codepoints: `U+67D0`
...
- `obs-evo-cand-003954-route-category-staging`
...
- `obs-evo-cand-003954-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003954-route-evolution-graph`
