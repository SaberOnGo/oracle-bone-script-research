# obs-unk-008873 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/105_undeciphered-008
  801-008900_obs-unk-bucket_oracle-character-candidates/073_obs-unk-008873_h
  ust-obc-und-YH-008873_oracle-character-candidate/03_visual-assets/001_asse
  t-010464_hust-obc-und-YH-008873_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60EC0/H_？_60EC0_0.png`
- asset id: `asset-010464`
...
- source class: `HUST-OBC/undeciphered/Y+H/60EC0/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60EC0/H_？_60EC0_0.png`
- asset id: `asset-010464`
...
- Which source records identify obs-unk-008873 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008873？
