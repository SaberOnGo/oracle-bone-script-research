# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000840
...
| Glyph or codepoint route / 字形或码位路线 | 13 OBIMD route rows; examples U+F4B9E; U+F4B9F; 另有 11 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
