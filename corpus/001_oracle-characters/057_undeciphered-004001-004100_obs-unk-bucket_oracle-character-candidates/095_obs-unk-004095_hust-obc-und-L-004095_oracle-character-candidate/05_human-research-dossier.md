# obs-unk-004095 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/095_obs-unk-004095_h
  ust-obc-und-L-004095_oracle-character-candidate/03_visual-assets/001_asset
  -005688_hust-obc-und-L-004095_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4095/L_？_8803.jpg`
- asset id: `asset-005688`
...
- source class: `HUST-OBC/undeciphered/L/4095/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4095/L_？_8803.jpg`
- asset id: `asset-005688`
...
- English observation: A compact upper group has several rounded or peaked
  dark lobes. Two narrow traces descend from the group toward the bottom;
  their sides and endpoints are partly blurred in the small image.
- 中文观察：图像上部是一个较紧凑的深色痕迹组，含有数个弯曲或尖顶
...
- Which source records identify obs-unk-004095 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004095？
