...
- External category reference: `evobc-cat-08407`
- Source category ID: `08407`
- Source label for human review: `记`
- Source codepoints: `U+8BB0`
...
- `obs-evo-cand-008407-route-category-staging`
...
- `obs-evo-cand-008407-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008407-route-evolution-graph`
