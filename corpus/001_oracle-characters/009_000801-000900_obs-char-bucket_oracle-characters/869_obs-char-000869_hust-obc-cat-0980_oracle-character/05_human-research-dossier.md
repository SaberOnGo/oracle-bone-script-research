# obs-char-000869 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/869_obs-char-000869_hust-obc-cat-0980_orac
  le-character/03_visual-assets/001_asset-000874_hust-obc-cat-0980_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0980/L_0980_10666.jpg`
- asset id: `asset-000874`
...
- source category: `0980`
- validation class: `868`
- source image route: `HUST-OBC/deciphered/0980/L_0980_10666.jpg`
- asset id: `asset-000874`
...
- English observation: `The tiny gray image shows an angular upper cluster
  above a horizontal base with short vertical strokes; exact joins are
  unclear.`
...
- dataset label text: `㟊`
- dataset label codepoints: `U+37CA`
...
- Which source records identify obs-char-000869 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000869？
