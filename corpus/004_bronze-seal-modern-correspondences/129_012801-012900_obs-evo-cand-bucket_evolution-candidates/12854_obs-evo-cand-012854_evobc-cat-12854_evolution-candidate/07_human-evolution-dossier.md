...
- Project ID: `obs-evo-cand-012854`
- EVOBC category candidate ID: `evobc-evo-cat-12854`
- External category reference: `evobc-cat-12854`
- Source category ID: `12854`
- Source label for human review: `𪭍`
- Source codepoints: `U+2AB4D`
...
- `obs-evo-cand-012854-route-category-staging`
...
- `obs-evo-cand-012854-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012854-route-evolution-graph`
