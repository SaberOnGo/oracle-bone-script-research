# obs-comp-cand-000459 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000459`
- 首选外部 ID: `obimd-sub-czt8eczekd`
- OBIMD subcharacter UID: `czt8eczekd`
- OBIMD main character UID: `czt8eczekd`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+81BA;U+F2B9B; U+F2B9C; 另有 3 项
