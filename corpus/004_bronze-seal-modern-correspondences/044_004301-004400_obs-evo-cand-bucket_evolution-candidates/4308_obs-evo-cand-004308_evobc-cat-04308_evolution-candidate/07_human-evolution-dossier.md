...
Project ID: `obs-evo-cand-004308`
...
- Project ID: `obs-evo-cand-004308`
- EVOBC category candidate ID: `evobc-evo-cat-04308`
- External category reference: `evobc-cat-04308`
- Source category ID: `04308`
- Source label for human review: `櫌`
- Source codepoints: `U+6ACC`
...
- `obs-evo-cand-004308-route-category-staging`
...
- `obs-evo-cand-004308-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004308-route-evolution-graph`
