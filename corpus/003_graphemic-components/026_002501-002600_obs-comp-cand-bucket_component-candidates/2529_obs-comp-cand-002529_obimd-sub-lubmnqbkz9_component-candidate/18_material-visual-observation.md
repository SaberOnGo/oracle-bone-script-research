# Material Visual Observation / obs-comp-cand-002529 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002529`
- External reference / 外部参照: `obimd-sub-lubmnqbkz9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021048_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1s5t2e9cdw/lubmnqbkz9/lubmnqbkz9.png`
- Checksum / 校验和:
  `55ae91ef700e4c6cc5daea74ea31e6b4160367a70f878374a732438bf72a75b6`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.16%.
- Marked-pixel bounds: (85,39)–(164,205); span 80 × 167 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.16%。
- 痕迹范围：(85,39)–(164,205)；跨度80 × 167 px；痕迹矩形高于宽。
