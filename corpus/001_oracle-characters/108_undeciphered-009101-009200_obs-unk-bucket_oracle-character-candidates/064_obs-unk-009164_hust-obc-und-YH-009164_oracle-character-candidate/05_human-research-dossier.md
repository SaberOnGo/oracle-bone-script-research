# obs-unk-009164 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/108_undeciphered-009
  101-009200_obs-unk-bucket_oracle-character-candidates/064_obs-unk-009164_h
  ust-obc-und-YH-009164_oracle-character-candidate/03_visual-assets/001_asse
  t-010755_hust-obc-und-YH-009164_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/612C3/H_？_612C3_0.png`
- asset id: `asset-010755`
...
- source class: `HUST-OBC/undeciphered/Y+H/612C3/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/612C3/H_？_612C3_0.png`
- asset id: `asset-010755`
...
- Which source records identify obs-unk-009164 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009164？
