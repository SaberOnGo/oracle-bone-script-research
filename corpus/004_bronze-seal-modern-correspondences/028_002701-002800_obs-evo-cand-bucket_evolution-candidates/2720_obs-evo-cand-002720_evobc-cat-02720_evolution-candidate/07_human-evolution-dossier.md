...
Project ID: `obs-evo-cand-002720`
...
- Project ID: `obs-evo-cand-002720`
- EVOBC category candidate ID: `evobc-evo-cat-02720`
- External category reference: `evobc-cat-02720`
- Source category ID: `02720`
- Source label for human review: `庖`
- Source codepoints: `U+5E96`
...
- `obs-evo-cand-002720-route-category-staging`
...
- `obs-evo-cand-002720-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002720-route-evolution-graph`
