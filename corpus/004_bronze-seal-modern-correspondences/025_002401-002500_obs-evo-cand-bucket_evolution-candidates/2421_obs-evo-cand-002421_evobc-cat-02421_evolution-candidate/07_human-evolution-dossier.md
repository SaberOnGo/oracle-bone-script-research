...
- External category reference: `evobc-cat-02421`
- Source category ID: `02421`
- Source label for human review: `寔`
...
- `obs-evo-cand-002421-route-category-staging`
...
- `obs-evo-cand-002421-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002421-route-evolution-graph`
