...
- External category reference: `evobc-cat-12236`
- Source category ID: `12236`
- Source label for human review: `𧩻`
- Source codepoints: `U+27A7B`
...
- `obs-evo-cand-012236-route-category-staging`
...
- `obs-evo-cand-012236-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012236-route-evolution-graph`
