# Material Visual Observation / obs-comp-cand-000114 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000114`
- External reference / 外部参照: `obimd-sub-8tu8ldh995`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011526_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8tu8ldh995/8tu8ldh995/8tu8ldh995.png`
- Checksum / 校验和:
  `de8e00556474fff0113e97a26a3c8a3a42ae04ed9c003ffeebf05c4f5e599af6`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.53%.
- Marked-pixel bounds: (61,43)–(188,210); span 128 × 168 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.53%。
- 痕迹范围：(61,43)–(188,210)；跨度128 × 168 px；痕迹矩形高于宽。
