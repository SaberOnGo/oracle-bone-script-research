...
- External category reference: `evobc-cat-03159`
- Source category ID: `03159`
- Source label for human review: `憪`
...
- `obs-evo-cand-003159-route-category-staging`
...
- `obs-evo-cand-003159-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003159-route-evolution-graph`
