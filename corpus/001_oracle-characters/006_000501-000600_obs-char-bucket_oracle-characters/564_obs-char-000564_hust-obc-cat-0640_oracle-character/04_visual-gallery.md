# obs-char-000564 Visual Gallery / obs-char-000564 图像资料页
...
- Primary external reference / 首选外部参考: `hust-obc-cat-0640`
...
## obs-char-000564-visual-source-001 / 图像条目

![obs-char-000564 glyph candidate](03_visual-assets/001_asset-000569_hust-obc-cat-0640_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000569_hust-obc-cat-0640_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000569_hust-obc-cat-0640_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/0640/G_0640_前2.14.4(甲).png`
