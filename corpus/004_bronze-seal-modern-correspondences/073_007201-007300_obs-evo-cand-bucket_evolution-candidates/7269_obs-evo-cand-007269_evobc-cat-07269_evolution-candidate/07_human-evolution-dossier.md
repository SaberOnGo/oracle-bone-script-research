...
- External category reference: `evobc-cat-07269`
- Source category ID: `07269`
- Source label for human review: `芽`
...
- `obs-evo-cand-007269-route-category-staging`
...
- `obs-evo-cand-007269-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007269-route-evolution-graph`
