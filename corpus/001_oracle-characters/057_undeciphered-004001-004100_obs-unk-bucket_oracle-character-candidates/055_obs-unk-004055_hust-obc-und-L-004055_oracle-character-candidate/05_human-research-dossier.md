# obs-unk-004055 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004055`
- primary external id: `hust-obc-und-L-004055`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/055_obs-unk-004055_h
  ust-obc-und-L-004055_oracle-character-candidate/03_visual-assets/001_asset
  -005648_hust-obc-und-L-004055_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4055/L_？_8670.jpg`
- asset id: `asset-005648`
...
- source class: `HUST-OBC/undeciphered/L/4055/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4055/L_？_8670.jpg`
- asset id: `asset-005648`
...
- English observation: A short upper trace leads toward a central descending
  stroke. Two rounded or loop-like marks appear near the lower center, while
  a long slanting contour runs down the right side. The joins are not clear.
...
- Which source records identify obs-unk-004055 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004055？
