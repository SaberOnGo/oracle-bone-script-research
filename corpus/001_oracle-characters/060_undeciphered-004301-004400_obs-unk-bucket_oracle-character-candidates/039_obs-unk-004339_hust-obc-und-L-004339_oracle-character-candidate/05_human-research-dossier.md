# obs-unk-004339 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004339`
- primary external id: `hust-obc-und-L-004339`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/039_obs-unk-004339_h
  ust-obc-und-L-004339_oracle-character-candidate/03_visual-assets/001_asset
  -005932_hust-obc-und-L-004339_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4339/L_？_9602.jpg`
- asset id: `asset-005932`
...
- source class: `HUST-OBC/undeciphered/L/4339/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4339/L_？_9602.jpg`
- asset id: `asset-005932`
...
- English observation: `Left curve, upper rounded mark, and right curve
  recorded.`
- 中文观察: `已记录左侧弯痕、上部圆转痕和右侧弯痕。`
...
- Which source records identify obs-unk-004339 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004339？
