# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004403
...
- EVOBC candidate category: `evobc-evo-cat-04403`.
- Source label for search only: `歿`.
- Source codepoints for search only: `U+6B7F`.
