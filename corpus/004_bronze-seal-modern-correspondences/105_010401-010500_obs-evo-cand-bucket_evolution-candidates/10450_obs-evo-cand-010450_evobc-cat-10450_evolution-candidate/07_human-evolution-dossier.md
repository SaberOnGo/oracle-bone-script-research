...
- External category reference: `evobc-cat-10450`
- Source category ID: `10450`
- Source label: `鱥`
...
- `obs-evo-cand-010450-route-category-staging`
...
- `obs-evo-cand-010450-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010450-route-evolution-graph`
