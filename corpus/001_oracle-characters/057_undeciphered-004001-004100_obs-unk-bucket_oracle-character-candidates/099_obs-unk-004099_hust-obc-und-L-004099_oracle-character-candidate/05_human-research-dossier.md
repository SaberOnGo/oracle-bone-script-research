# obs-unk-004099 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/099_obs-unk-004099_h
  ust-obc-und-L-004099_oracle-character-candidate/03_visual-assets/001_asset
  -005692_hust-obc-und-L-004099_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4099/L_？_8817.jpg`
- asset id: `asset-005692`
...
- source class: `HUST-OBC/undeciphered/L/4099/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4099/L_？_8817.jpg`
- asset id: `asset-005692`
...
- English observation: A shallow rounded lower outline contains a dark central
  spot or short trace. Two upright branching groups rise from the left and
  right sides; the relation between the side groups and lower outline is not
  fully resolved.
- 中文观察：图像下部有一个较浅的弧形轮廓，内部中央可见深色点状或
...
- Which source records identify obs-unk-004099 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004099？
