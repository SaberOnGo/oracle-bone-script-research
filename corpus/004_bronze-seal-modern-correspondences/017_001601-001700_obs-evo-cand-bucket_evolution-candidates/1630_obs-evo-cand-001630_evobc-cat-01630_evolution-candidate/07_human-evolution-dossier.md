...
- External category reference: `evobc-cat-01630`
- Source category ID: `01630`
- Source label for human review: `啙`
- Source codepoints: `U+5559`
...
- `obs-evo-cand-001630-route-category-staging`
...
- `obs-evo-cand-001630-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001630-route-evolution-graph`
