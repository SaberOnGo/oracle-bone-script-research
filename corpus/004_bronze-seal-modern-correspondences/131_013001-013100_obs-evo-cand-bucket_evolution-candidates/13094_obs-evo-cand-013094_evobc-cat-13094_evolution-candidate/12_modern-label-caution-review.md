# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013094
...
- EVOBC candidate category: `evobc-evo-cat-13094`.
- Source label for search only: `𫳞`.
- Source codepoints for search only: `U+2BCDE`.
