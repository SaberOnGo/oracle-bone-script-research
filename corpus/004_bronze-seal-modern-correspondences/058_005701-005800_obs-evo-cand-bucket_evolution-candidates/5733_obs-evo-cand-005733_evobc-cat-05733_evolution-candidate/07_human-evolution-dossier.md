...
- External category reference: `evobc-cat-05733`
- Source category ID: `05733`
- Source label: `皯`
...
- `obs-evo-cand-005733-route-category-staging`
...
- `obs-evo-cand-005733-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005733-route-evolution-graph`
