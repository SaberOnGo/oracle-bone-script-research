...
Project ID: `obs-evo-cand-006144`
...
- Project ID: `obs-evo-cand-006144`
- EVOBC category candidate ID: `evobc-evo-cat-06144`
- External category reference: `evobc-cat-06144`
- Source category ID: `06144`
- Source label for human review: `穵`
- Source codepoints: `U+7A75`
...
- `obs-evo-cand-006144-route-category-staging`
...
- `obs-evo-cand-006144-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006144-route-evolution-graph`
