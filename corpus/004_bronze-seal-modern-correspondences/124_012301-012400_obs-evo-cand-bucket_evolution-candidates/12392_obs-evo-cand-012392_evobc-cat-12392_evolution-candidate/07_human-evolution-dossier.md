...
- External category reference: `evobc-cat-12392`
- Source category ID: `12392`
- Source label for human review: `𨘚`
- Source codepoints: `U+2861A`
...
- `obs-evo-cand-012392-route-category-staging`
...
- `obs-evo-cand-012392-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012392-route-evolution-graph`
