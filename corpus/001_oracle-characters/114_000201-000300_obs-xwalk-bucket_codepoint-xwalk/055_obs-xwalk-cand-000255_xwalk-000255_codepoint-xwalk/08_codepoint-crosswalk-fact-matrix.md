# obs-xwalk-cand-000255 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+3513` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-0285` | not reading |
