...
- External category reference: `evobc-cat-03389`
- Source category ID: `03389`
- Source label for human review: `捾`
- Source codepoints: `U+637E`
...
- `obs-evo-cand-003389-route-category-staging`
...
- `obs-evo-cand-003389-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003389-route-evolution-graph`
