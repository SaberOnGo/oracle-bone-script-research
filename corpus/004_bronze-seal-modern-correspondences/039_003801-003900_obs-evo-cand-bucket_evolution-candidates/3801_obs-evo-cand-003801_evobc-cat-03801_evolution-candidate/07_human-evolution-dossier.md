...
- External category reference: `evobc-cat-03801`
- Source category ID: `03801`
- Source label for human review: `曙`
...
- `obs-evo-cand-003801-route-category-staging`
...
- `obs-evo-cand-003801-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003801-route-evolution-graph`
