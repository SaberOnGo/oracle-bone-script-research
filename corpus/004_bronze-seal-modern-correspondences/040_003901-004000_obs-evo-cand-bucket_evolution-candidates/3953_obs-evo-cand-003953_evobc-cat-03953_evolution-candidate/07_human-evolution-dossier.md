...
- External category reference: `evobc-cat-03953`
- Source category ID: `03953`
- Source label: `柏`
...
- `obs-evo-cand-003953-route-category-staging`
...
- `obs-evo-cand-003953-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-003953-route-evolution-graph`
