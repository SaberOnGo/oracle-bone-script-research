...
Project ID: `obs-evo-cand-003788`
...
- Project ID: `obs-evo-cand-003788`
- EVOBC category candidate ID: `evobc-evo-cat-03788`
- External category reference: `evobc-cat-03788`
- Source category ID: `03788`
- Source label for human review: `暴`
- Source codepoints: `U+66B4`
...
- `obs-evo-cand-003788-route-category-staging`
...
- `obs-evo-cand-003788-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003788-route-evolution-graph`
