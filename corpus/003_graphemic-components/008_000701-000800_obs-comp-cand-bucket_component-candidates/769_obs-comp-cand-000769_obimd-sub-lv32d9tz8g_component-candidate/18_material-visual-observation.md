# Material Visual Observation / obs-comp-cand-000769 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000769`
- External reference / 外部参照: `obimd-sub-lv32d9tz8g`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013532_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lv32d9tz8g/lv32d9tz8g/lv32d9tz8g.png`
- Checksum / 校验和:
  `a351b6975ac6c5d5bc0886d7789635c25b5d4fd1855777cda1ff6455c884dd84`
...
- Marked-pixel bounds: (83,24)–(166,229); span 84 × 206 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.98%。
- 痕迹范围：(83,24)–(166,229)；跨度84 × 206 px；痕迹矩形高于宽。
