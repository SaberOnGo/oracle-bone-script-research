...
- External category reference: `evobc-cat-07307`
- Source category ID: `07307`
- Source label for human review: `茈`
- Source codepoints: `U+8308`
...
- `obs-evo-cand-007307-route-category-staging`
...
- `obs-evo-cand-007307-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007307-route-evolution-graph`
