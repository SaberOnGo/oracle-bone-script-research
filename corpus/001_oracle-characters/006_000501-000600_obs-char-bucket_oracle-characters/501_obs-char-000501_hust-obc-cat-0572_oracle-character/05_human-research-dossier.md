# obs-char-000501 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/501_obs-char-000501_hust-obc-cat-0572_orac
  le-character/03_visual-assets/001_asset-000506_hust-obc-cat-0572_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0572/G_0572_京津978合15808.png`
- asset id: `asset-000506`
...
- source category: `0572`
- validation class: `500`
- source image route: `HUST-OBC/deciphered/0572/G_0572_京津978合15808.png`
- asset id: `asset-000506`
...
- English observation: `Two short horizontal bars and a small vertical mark
  sit above a long central curved stroke that ends in several crossed and
  branching lower lines.`
...
- dataset label text: `㘲`
- dataset label codepoints: `U+3632`
...
- filename catalog route clues: `Heji-like filename clue: 合15808
...
- Which source records identify obs-char-000501 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000501？
