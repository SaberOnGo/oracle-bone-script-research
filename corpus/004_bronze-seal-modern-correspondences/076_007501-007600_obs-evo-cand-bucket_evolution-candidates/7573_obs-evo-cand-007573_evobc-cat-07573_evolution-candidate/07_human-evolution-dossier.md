...
- External category reference: `evobc-cat-07573`
- Source category ID: `07573`
- Source label for human review: `蔿`
- Source codepoints: `U+853F`
...
- `obs-evo-cand-007573-route-category-staging`
...
- `obs-evo-cand-007573-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007573-route-evolution-graph`
