# obs-char-001252 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001252`
- primary external id: `hust-obc-cat-1400`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1252_obs-char-001252_hust-obc-cat-1400_ora
  cle-character/03_visual-assets/001_asset-001257_hust-obc-cat-1400_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1400/G_1400_乙5568反合12466反賓組.png
  `
- asset id: `asset-001257`
...
- source category: `1400`
- validation class: `1251`
- source image route: `HUST-OBC/deciphered/1400/G_1400_乙5568反合12466反賓組.png`
- asset id: `asset-001257`
...
- English observation: `A small outlined upper loop sits above a thin
  central stem and a lower angular hooked loop.`
- 中文观察: `小型轮廓上部环形位于细中央笔干之上，下方接折角钩状环形。`
...
- dataset label text: `㥮`
- dataset label codepoints: `U+396E`
...
- filename catalog route clues: `Heji-like filename clue: 合12466
  (G_1400_乙5568反合12466反賓組.png)`
...
- Which source records identify obs-char-001252 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001252？
