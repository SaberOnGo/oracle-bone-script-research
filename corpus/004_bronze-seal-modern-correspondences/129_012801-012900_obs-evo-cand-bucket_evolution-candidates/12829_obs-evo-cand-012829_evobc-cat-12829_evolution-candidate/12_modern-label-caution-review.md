# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012829
...
- EVOBC candidate category: `evobc-evo-cat-12829`.
- Source label for search only: `𪧯`.
- Source codepoints for search only: `U+2A9EF`.
