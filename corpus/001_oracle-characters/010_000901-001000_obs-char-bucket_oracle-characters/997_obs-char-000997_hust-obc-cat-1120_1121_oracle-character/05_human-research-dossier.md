# obs-char-000997 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/997_obs-char-000997_hust-obc-cat-1120_1121
  _oracle-character/03_visual-assets/001_asset-001002_hust-obc-cat-1120_1121
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1120_1121/1120/G_1120_京津4144合27
  937何組.png`
- asset id: `asset-001002`
...
- source category: `1120_1121`
- validation class: `996`
- source image route: `HUST-OBC/deciphered/1120_1121/1120/G_1120_京津4144合27937何
  組.png`
- asset id: `asset-001002`
...
- English observation: `A narrow stacked form combines an upper pointed
  enclosure and a lower oval loop.`
- 中文观察: `狭长叠置形体结合上部尖形闭合轮廓和下部椭圆环状笔。`
...
- dataset label text: `㡖㡗`
- dataset label codepoints: `U+3856;U+3857`
...
- filename catalog route clues: `Heji-like filename clue: 合27937
  (G_1120_京津4144合27937何組.png)`
...
- Which source records identify obs-char-000997 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000997？
