# obs-comp-cand-001149 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001149`
- 首选外部 ID: `obimd-sub-xbrbbm12wm`
- OBIMD subcharacter UID: `xbrbbm12wm`
- OBIMD main character UID: `xbrbbm12wm`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+F6A27; U+F6A28; 另有 1 项
