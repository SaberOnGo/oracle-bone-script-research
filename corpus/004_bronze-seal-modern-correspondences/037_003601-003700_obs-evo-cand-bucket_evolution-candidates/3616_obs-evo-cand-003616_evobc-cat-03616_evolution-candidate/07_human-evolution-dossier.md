...
Project ID: `obs-evo-cand-003616`
...
- Project ID: `obs-evo-cand-003616`
- EVOBC category candidate ID: `evobc-evo-cat-03616`
- External category reference: `evobc-cat-03616`
- Source category ID: `03616`
- Source label for human review: `敾`
- Source codepoints: `U+657E`
...
- `obs-evo-cand-003616-route-category-staging`
...
- `obs-evo-cand-003616-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003616-route-evolution-graph`
