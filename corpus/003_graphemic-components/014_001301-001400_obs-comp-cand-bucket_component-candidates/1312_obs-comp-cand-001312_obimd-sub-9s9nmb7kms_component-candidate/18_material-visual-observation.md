# Material Visual Observation / obs-comp-cand-001312 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001312`
- External reference / 外部参照: `obimd-sub-9s9nmb7kms`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015649_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/d0hauaf16v/9s9nmb7kms/9s9nmb7kms.png`
- Checksum / 校验和:
  `529dfaae58b160bced3d99541f427020f30893f91a350d45ee22bad1bc903cb4`
...
- Marked-pixel bounds: (89,24)–(166,223); span 78 × 200 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.45%。
- 痕迹范围：(89,24)–(166,223)；跨度78 × 200 px；痕迹矩形高于宽。
