...
- `obs-evo-cand-004641-route-category-staging`
...
- `obs-evo-cand-004641-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004641-route-evolution-graph`
