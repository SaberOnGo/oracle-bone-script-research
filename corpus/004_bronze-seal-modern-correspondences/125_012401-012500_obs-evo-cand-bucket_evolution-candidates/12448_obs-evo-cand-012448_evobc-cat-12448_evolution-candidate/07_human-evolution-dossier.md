...
- External category reference: `evobc-cat-12448`
- Source category ID: `12448`
- Source label for human review: `𨝍`
- Source codepoints: `U+2874D`
...
- `obs-evo-cand-012448-route-category-staging`
...
- `obs-evo-cand-012448-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012448-route-evolution-graph`
