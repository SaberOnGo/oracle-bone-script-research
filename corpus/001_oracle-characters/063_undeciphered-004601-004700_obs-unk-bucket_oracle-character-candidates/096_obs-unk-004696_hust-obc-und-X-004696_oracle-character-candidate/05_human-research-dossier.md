# obs-unk-004696 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004696`
- primary external id: `hust-obc-und-X-004696`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/096_obs-unk-004696_h
  ust-obc-und-X-004696_oracle-character-candidate/03_visual-assets/001_asset
  -006289_hust-obc-und-X-004696_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/252/X_？_8419_1.png`
- asset id: `asset-006289`
...
- source class: `HUST-OBC/undeciphered/X/252/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/252/X_？_8419_1.png`
- asset id: `asset-006289`
...
- English observation: `open angular outline with inner stroke`
- 中文观察: `带内部笔画的开放折角轮廓`
...
- Which source records identify obs-unk-004696 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004696？
