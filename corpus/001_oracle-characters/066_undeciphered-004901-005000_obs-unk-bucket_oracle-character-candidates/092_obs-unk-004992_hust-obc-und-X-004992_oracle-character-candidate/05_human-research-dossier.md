# obs-unk-004992 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004992`
- primary external id: `hust-obc-und-X-004992`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/092_obs-unk-004992_h
  ust-obc-und-X-004992_oracle-character-candidate/03_visual-assets/001_asset
  -006585_hust-obc-und-X-004992_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/548/X_？_7134_1.png`
- asset id: `asset-006585`
...
- One of two expected views was opened; an upper angled outline is visible.
- 直接记录：`14_material-visual-observation.md`
- 两个预期视图中当前打开一个，可见上部斜向轮廓。
...
- source class: `HUST-OBC/undeciphered/X/548/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/548/X_？_7134_1.png`
- asset id: `asset-006585`
...
- Which source records identify obs-unk-004992 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004992？
