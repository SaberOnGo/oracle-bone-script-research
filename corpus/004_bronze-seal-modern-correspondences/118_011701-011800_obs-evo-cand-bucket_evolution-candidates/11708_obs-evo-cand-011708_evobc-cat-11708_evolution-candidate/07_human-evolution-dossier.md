...
- Project ID: `obs-evo-cand-011708`
- EVOBC category candidate ID: `evobc-evo-cat-11708`
- External category reference: `evobc-cat-11708`
- Source category ID: `11708`
- Source label for human review: `𤷰`
- Source codepoints: `U+24DF0`
...
- `obs-evo-cand-011708-route-category-staging`
...
- `obs-evo-cand-011708-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011708-route-evolution-graph`
