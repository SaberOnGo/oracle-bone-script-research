...
- External category reference: `evobc-cat-12922`
- Source category ID: `12922`
- Source label: `𫈛`
...
- `obs-evo-cand-012922-route-category-staging`
...
- `obs-evo-cand-012922-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012922-route-evolution-graph`
