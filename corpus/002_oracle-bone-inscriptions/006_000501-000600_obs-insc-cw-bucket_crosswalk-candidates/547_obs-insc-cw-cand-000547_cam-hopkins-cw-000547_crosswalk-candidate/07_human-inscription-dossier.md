...
Project ID: `obs-insc-cw-cand-000547`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000547`
...
- Yingguo / 英国所藏: `y2552` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `372` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `512` in source row; primary catalog entry pending
- Heji / 合集: `41831` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000547`
