# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004828
...
- EVOBC candidate category: `evobc-evo-cat-04828`.
- Source label for search only: `溽`.
- Source codepoints for search only: `U+6EBD`.
