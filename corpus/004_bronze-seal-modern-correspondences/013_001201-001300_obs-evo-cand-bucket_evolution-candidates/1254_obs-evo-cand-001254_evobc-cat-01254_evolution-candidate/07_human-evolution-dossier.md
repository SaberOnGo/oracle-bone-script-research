...
- External category reference: `evobc-cat-01254`
- Source category ID: `01254`
- Source label for human review: `劊`
...
- `obs-evo-cand-001254-route-category-staging`
...
- `obs-evo-cand-001254-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001254-route-evolution-graph`
