# Material Visual Observation / obs-comp-cand-000678 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000678`
- External reference / 外部参照: `obimd-sub-my9kducfis`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013277_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/my9kducfis/my9kducfis/my9kducfis.png`
- Checksum / 校验和:
  `c58c4735db7523fe48b1449c11538724c93699bebb439b9ff5ace3b2bf8ce4fe`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.64%.
- Marked-pixel bounds: (47,27)–(211,217); span 165 × 191 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.64%。
- 痕迹范围：(47,27)–(211,217)；跨度165 × 191 px；痕迹矩形近方形。
