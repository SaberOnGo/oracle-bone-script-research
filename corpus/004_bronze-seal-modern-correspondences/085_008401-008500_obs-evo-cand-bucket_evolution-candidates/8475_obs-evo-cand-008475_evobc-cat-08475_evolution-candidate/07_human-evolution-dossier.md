...
Project ID: `obs-evo-cand-008475`
...
- Project ID: `obs-evo-cand-008475`
- EVOBC category candidate ID: `evobc-evo-cat-08475`
- External category reference: `evobc-cat-08475`
- Source category ID: `08475`
- Source label for human review: `豅`
- Source codepoints: `U+8C45`
...
- `obs-evo-cand-008475-route-category-staging`
...
- `obs-evo-cand-008475-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008475-route-evolution-graph`
