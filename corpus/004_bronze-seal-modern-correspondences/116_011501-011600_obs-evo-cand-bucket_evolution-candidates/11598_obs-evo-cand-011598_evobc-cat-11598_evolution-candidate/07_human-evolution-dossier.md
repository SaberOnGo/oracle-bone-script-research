...
- External category reference: `evobc-cat-11598`
- Source category ID: `11598`
- Source label for human review: `𤚝`
- Source codepoints: `U+2469D`
...
- `obs-evo-cand-011598-route-category-staging`
...
- `obs-evo-cand-011598-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011598-route-evolution-graph`
