...
- External category reference: `evobc-cat-08532`
- Source category ID: `08532`
- Source label for human review: `貜`
...
- `obs-evo-cand-008532-route-category-staging`
...
- `obs-evo-cand-008532-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008532-route-evolution-graph`
