...
- External category reference: `evobc-cat-00378`
- Source category ID: `00378`
- Source label for human review: `䒨`
- Source codepoints: `U+44A8`
...
- `obs-evo-cand-000378-route-category-staging`
...
- `obs-evo-cand-000378-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000378-route-evolution-graph`
