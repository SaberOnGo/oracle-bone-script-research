...
- External category reference: `evobc-cat-12028`
- Source category ID: `12028`
- Source label for human review: `𦔼`
...
- `obs-evo-cand-012028-route-category-staging`
...
- `obs-evo-cand-012028-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012028-route-evolution-graph`
