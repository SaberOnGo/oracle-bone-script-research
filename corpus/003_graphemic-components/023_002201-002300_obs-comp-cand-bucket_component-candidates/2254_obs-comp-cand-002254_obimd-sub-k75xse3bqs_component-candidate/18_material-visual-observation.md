# Material Visual Observation / obs-comp-cand-002254 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002254`
- External reference / 外部参照: `obimd-sub-k75xse3bqs`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020067_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rbq68qstjy/k75xse3bqs/k75xse3bqs.png`
- Checksum / 校验和:
  `85540bb1b5a3022b053e637af2c824aa6a11a31f8268ab41fa98e56674183801`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.95%.
- Marked-pixel bounds: (72,39)–(177,204); span 106 × 166 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.95%。
- 痕迹范围：(72,39)–(177,204)；跨度106 × 166 px；痕迹矩形高于宽。
