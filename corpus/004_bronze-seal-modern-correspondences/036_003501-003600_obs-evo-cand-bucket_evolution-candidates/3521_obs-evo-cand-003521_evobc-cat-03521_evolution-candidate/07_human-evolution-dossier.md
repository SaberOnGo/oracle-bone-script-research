...
- External category reference: `evobc-cat-03521`
- Source category ID: `03521`
- Source label for human review: `擖`
- Source codepoints: `U+64D6`
...
- `obs-evo-cand-003521-route-category-staging`
...
- `obs-evo-cand-003521-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003521-route-evolution-graph`
