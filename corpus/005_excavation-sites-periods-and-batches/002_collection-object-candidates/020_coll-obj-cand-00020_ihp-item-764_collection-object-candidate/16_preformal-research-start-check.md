# Preformal Research Start Check / 正式研究开始前开包核查: coll-obj-cand-00020
...
| --- | --- | --- |
| 1 | `02_collection-source-index.csv` | `764` |
...
- Which source description, ink observation, or image route still needs an
  independent check?
