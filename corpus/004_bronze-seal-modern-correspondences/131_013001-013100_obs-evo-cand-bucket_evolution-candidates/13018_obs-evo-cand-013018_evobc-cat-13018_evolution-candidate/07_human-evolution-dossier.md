...
- Project ID: `obs-evo-cand-013018`
- EVOBC category candidate ID: `evobc-evo-cat-13018`
- External category reference: `evobc-cat-13018`
- Source category ID: `13018`
- Source label for human review: `𫦆`
- Source codepoints: `U+2B986`
...
- `obs-evo-cand-013018-route-category-staging`
...
- `obs-evo-cand-013018-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013018-route-evolution-graph`
