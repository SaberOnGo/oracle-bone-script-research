# obs-unk-004180 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/080_obs-unk-004180_h
  ust-obc-und-L-004180_oracle-character-candidate/03_visual-assets/001_asset
  -005773_hust-obc-und-L-004180_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4180/L_？_9057.jpg`
- asset id: `asset-005773`
...
- source class: `HUST-OBC/undeciphered/L/4180/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4180/L_？_9057.jpg`
- asset id: `asset-005773`
...
- English observation: Upper-left horizontal branches stand above a lower
  rectangular outline.
- 中文观察: 左上横向分支笔画位于下部近矩形轮廓之上。
...
- Which source records identify obs-unk-004180 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004180？
