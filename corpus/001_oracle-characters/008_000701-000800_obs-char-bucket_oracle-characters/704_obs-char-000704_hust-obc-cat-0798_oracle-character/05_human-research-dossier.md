# obs-char-000704 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/704_obs-char-000704_hust-obc-cat-0798_orac
  le-character/03_visual-assets/001_asset-000709_hust-obc-cat-0798_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0798/G_0798_乙1070合14153賓組.png`
- asset id: `asset-000709`
...
- source category: `0798`
- validation class: `703`
- source image route: `HUST-OBC/deciphered/0798/G_0798_乙1070合14153賓組.png`
- asset id: `asset-000709`
...
- English observation: `A central rounded rectangular loop with an inner
  horizontal is surrounded by four detached short marks placed above, below,
  and on both sides.`
...
- dataset label text: `㜔`
- dataset label codepoints: `U+3714`
...
- Which source records identify obs-char-000704 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000704？
