# obs-unk-004238 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004238`
- primary external id: `hust-obc-und-L-004238`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/038_obs-unk-004238_h
  ust-obc-und-L-004238_oracle-character-candidate/03_visual-assets/001_asset
  -005831_hust-obc-und-L-004238_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4238/L_？_9305.jpg`
- asset id: `asset-005831`
...
- source class: `HUST-OBC/undeciphered/L/4238/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4238/L_？_9305.jpg`
- asset id: `asset-005831`
...
- English observation: `Upper angle, open outline, right curve visible.`
- 中文观察: `上部斜痕、开放轮廓和右侧弯曲笔画可见。`
...
- Which source records identify obs-unk-004238 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004238？
