...
- Project ID: `obs-evo-cand-001252`
- EVOBC category candidate ID: `evobc-evo-cat-01252`
- External category reference: `evobc-cat-01252`
- Source category ID: `01252`
- Source label for human review: `劈`
- Source codepoints: `U+5288`
...
- `obs-evo-cand-001252-route-category-staging`
...
- `obs-evo-cand-001252-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001252-route-evolution-graph`
