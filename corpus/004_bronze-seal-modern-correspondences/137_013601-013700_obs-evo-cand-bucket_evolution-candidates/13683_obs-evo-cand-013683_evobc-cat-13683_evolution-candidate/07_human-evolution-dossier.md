...
Project ID: `obs-evo-cand-013683`
...
- Project ID: `obs-evo-cand-013683`
- EVOBC category candidate ID: `evobc-evo-cat-13683`
- External category reference: `evobc-cat-13683`
- Source category ID: `13683`
- Source label for human review: `𮨥`
- Source codepoints: `U+2EA25`
...
- `obs-evo-cand-013683-route-category-staging`
...
- `obs-evo-cand-013683-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013683-route-evolution-graph`
