# Material Visual Observation / obs-comp-cand-000389 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000389`
- External reference / 外部参照: `obimd-sub-07ktdj9irl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012312_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rnar1q86c5/07ktdj9irl/07ktdj9irl.png`
- Checksum / 校验和:
  `5ed54e17cf3a1eac8c762ecf450bdd72ef3317a1dc0dd5191e86076260377bca`
...
- Marked-pixel bounds: (87,20)–(161,227); span 75 × 208 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.91%。
- 痕迹范围：(87,20)–(161,227)；跨度75 × 208 px；痕迹矩形高于宽。
