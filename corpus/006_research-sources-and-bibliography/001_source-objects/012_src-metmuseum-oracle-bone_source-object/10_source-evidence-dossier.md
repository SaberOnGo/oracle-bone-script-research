...
- Source URL / 来源链接: https://www.metmuseum.org/art/collection/search/42045
- Scope / 适用范围: Official Met collection and Open Access API records for
  oracle-bone objects including 42045 / 67.43.14 and 42022 / 18.56.71 with
  public-domain flags and image URLs.
...
- Risk note / 风险提示: The Met API marks selected objects as public domain, but
  object metadata and image URLs can be revised and should retain object-level
