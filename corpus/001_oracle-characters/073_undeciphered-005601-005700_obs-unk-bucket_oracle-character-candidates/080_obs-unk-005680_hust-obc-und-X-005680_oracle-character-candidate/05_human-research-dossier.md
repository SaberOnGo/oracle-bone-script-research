# obs-unk-005680 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005680`
- primary external id: `hust-obc-und-X-005680`
...
- local review image route: `corpus/001_oracle-characters/073_undeciphered-005
  601-005700_obs-unk-bucket_oracle-character-candidates/080_obs-unk-005680_h
  ust-obc-und-X-005680_oracle-character-candidate/03_visual-assets/001_asset
  -007273_hust-obc-und-X-005680_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1236/X_？_1121_1.png`
- asset id: `asset-007273`
...
- source class: `HUST-OBC/undeciphered/X/1236/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1236/X_？_1121_1.png`
- asset id: `asset-007273`
...
- Which source records identify obs-unk-005680 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005680？
