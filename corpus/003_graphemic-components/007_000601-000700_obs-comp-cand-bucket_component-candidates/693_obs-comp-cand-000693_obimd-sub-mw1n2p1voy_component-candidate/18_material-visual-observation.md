# Material Visual Observation / obs-comp-cand-000693 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000693`
- External reference / 外部参照: `obimd-sub-mw1n2p1voy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013292_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/mw1n2p1voy/mw1n2p1voy/mw1n2p1voy.png`
- Checksum / 校验和:
  `cb161d8cc2fdc404cc453b99ec8c98ef083f7844574fa63d5162b1aeb771494c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.20%.
- Marked-pixel bounds: (59,21)–(171,227); span 113 × 207 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.20%。
- 痕迹范围：(59,21)–(171,227)；跨度113 × 207 px；痕迹矩形高于宽。
