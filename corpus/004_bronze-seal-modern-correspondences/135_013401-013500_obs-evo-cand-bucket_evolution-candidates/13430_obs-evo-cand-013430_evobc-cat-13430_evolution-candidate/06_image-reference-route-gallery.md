...
- `obs-evo-cand-013430-route-category-staging`
...
- `obs-evo-cand-013430-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013430-route-evolution-graph`
