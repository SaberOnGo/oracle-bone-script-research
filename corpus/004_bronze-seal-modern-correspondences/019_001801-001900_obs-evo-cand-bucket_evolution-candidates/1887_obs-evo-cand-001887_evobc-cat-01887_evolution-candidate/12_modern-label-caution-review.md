# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001887
...
- EVOBC candidate category: `evobc-evo-cat-01887`.
- Source label for search only: `埸`.
- Source codepoints for search only: `U+57F8`.
