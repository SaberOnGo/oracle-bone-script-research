...
- Project ID: `obs-evo-cand-012547`
- EVOBC category candidate ID: `evobc-evo-cat-12547`
- External category reference: `evobc-cat-12547`
- Source category ID: `12547`
- Source label for human review: `𩁆`
- Source codepoints: `U+29046`
...
- `obs-evo-cand-012547-route-category-staging`
...
- `obs-evo-cand-012547-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012547-route-evolution-graph`
