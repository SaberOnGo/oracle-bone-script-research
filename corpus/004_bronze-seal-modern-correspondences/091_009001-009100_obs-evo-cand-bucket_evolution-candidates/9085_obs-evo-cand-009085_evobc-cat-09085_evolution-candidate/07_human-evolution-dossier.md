...
- External category reference: `evobc-cat-09085`
- Source category ID: `09085`
- Source label for human review: `邒`
...
- `obs-evo-cand-009085-route-category-staging`
...
- `obs-evo-cand-009085-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009085-route-evolution-graph`
