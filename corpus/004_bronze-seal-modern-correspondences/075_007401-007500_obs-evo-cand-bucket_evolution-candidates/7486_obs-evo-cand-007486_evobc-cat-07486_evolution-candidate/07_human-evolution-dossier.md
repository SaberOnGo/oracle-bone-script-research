...
Project ID: `obs-evo-cand-007486`
...
- Project ID: `obs-evo-cand-007486`
- EVOBC category candidate ID: `evobc-evo-cat-07486`
- External category reference: `evobc-cat-07486`
- Source category ID: `07486`
- Source label for human review: `葷`
- Source codepoints: `U+8477`
...
- `obs-evo-cand-007486-route-category-staging`
...
- `obs-evo-cand-007486-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007486-route-evolution-graph`
