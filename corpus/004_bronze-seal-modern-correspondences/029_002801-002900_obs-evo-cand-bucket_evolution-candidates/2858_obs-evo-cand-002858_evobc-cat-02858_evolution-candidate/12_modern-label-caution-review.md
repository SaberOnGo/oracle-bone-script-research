# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002858
...
- EVOBC candidate category: `evobc-evo-cat-02858`.
- Source label for search only: `彼`.
- Source codepoints for search only: `U+5F7C`.
