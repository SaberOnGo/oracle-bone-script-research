# obs-char-001525 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001525`
- primary external id: `hust-obc-cat-1711`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1525_obs-char-001525_hust-obc-cat-1711_ora
  cle-character/03_visual-assets/001_asset-001530_hust-obc-cat-1711_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1711/X_1711_4894_1.png`
- asset id: `asset-001530`
...
- source category: `1711`
- validation class: `1524`
- source image route: `HUST-OBC/deciphered/1711/X_1711_4894_1.png`
- asset id: `asset-001530`
...
- dataset label text: `㪥`
- dataset label codepoints: `U+3AA5`
...
- Which source records identify obs-char-001525 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001525？
