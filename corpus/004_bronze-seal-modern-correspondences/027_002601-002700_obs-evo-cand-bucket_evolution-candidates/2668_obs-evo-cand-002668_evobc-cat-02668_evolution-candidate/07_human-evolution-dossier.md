...
- External category reference: `evobc-cat-02668`
- Source category ID: `02668`
- Source label for human review: `幃`
...
- `obs-evo-cand-002668-route-category-staging`
...
- `obs-evo-cand-002668-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002668-route-evolution-graph`
