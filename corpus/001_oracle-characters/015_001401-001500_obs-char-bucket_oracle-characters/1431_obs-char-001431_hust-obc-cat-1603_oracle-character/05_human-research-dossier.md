# obs-char-001431 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1431_obs-char-001431_hust-obc-cat-1603_ora
  cle-character/03_visual-assets/001_asset-001436_hust-obc-cat-1603_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1603/G_1603_林2.26.7合28195何組.png
  `
- asset id: `asset-001436`
...
- source category: `1603`
- validation class: `1430`
- source image route: `HUST-OBC/deciphered/1603/G_1603_林2.26.7合28195何組.png`
- asset id: `asset-001436`
...
- English observation: `A dense left cluster is paired with a tall right
  stem and side branches.`
- 中文观察: `密集左侧笔画群与高大右侧竖干及侧部分枝相邻。`
...
- dataset label text: `㨹`
- dataset label codepoints: `U+3A39`
...
- filename catalog route clues: `Heji-like filename clue: 合28195
...
- Which source records identify obs-char-001431 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001431？
