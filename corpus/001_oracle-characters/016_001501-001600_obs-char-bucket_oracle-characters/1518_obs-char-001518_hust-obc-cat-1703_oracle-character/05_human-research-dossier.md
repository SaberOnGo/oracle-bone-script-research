# obs-char-001518 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1518_obs-char-001518_hust-obc-cat-1703_ora
  cle-character/03_visual-assets/001_asset-001523_hust-obc-cat-1703_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1703/G_1703_京津4617.png`
- asset id: `asset-001523`
...
- source category: `1703`
- validation class: `1517`
- source image route: `HUST-OBC/deciphered/1703/G_1703_京津4617.png`
- asset id: `asset-001523`
...
- English observation: `Two faint adjacent forms each show a central
  vertical and short lateral branches.`
...
- dataset label text: `㪝`
- dataset label codepoints: `U+3A9D`
...
- Which source records identify obs-char-001518 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001518？
