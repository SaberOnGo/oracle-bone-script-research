...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0924`
...
- Source image / 来源图: `G_0924_前7.36.2(甲).png`
- Image / 图像: `001_asset-000821_hust-obc-cat-0924_glyph.png`
...
- target node: `evobc-evo-cat-00081`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/081_obs-evo-cand-000081_evobc-cat-00081_evoluti
...
- Source label text / 来源标签文字: `㞒`
- Source label codepoint / 来源标签 codepoint: `U+3792`
