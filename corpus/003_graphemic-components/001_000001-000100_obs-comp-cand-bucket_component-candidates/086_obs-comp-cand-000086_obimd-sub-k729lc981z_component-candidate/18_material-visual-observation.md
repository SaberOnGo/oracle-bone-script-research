# Material Visual Observation / obs-comp-cand-000086 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000086`
- External reference / 外部参照: `obimd-sub-k729lc981z`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011498_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lpjmcjuz4z/k729lc981z/k729lc981z.png`
- Checksum / 校验和:
  `db1c73cc66c57833fab6cee00c34efd78210fa7e3a0f18eaac1516b471ef2adf`
...
- Marked-pixel bounds: (58,31)–(191,214); span 134 × 184 px; the marked
...
- 痕迹范围：(58,31)–(191,214)；跨度134 × 184 px；痕迹矩形高于宽。
