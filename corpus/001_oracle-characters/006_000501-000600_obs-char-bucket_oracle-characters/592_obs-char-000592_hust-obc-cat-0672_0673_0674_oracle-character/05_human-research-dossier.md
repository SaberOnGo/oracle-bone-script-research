# obs-char-000592 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000592`
- primary external id: `hust-obc-cat-0672_0673_0674`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/592_obs-char-000592_hust-obc-cat-0672_0673
  _0674_oracle-character/03_visual-assets/001_asset-000597_hust-obc-cat-0672
  _0673_0674_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0672_0673_0674/0672/G_0672_乙184
  合19755𠂤組.png`
- asset id: `asset-000597`
...
- source category: `0672_0673_0674`
- validation class: `591`
- source image route: `HUST-OBC/deciphered/0672_0673_0674/0672/G_0672_乙184合197
  55𠂤組.png`
- asset id: `asset-000597`
...
- English observation: `Two detached sinuous forms stand side by side, the
  left ending in a rounded lower loop and the right carrying a short upper
  fork and long curved descent.`
- 中文观察: `两个分离曲折形并列，左侧以下部圆环收束，右侧带短上叉和长弯下行笔。`
...
- dataset label text: `㚖㚗㚘`
- dataset label codepoints: `U+3696;U+3697;U+3698`
...
- graph edge count: `2`
- codepoint routes: `U+3696;U+3697;U+3698`
...
- filename catalog route clues: `Heji-like filename clue: 合19755
  (G_0672_乙184合19755𠂤組.png)`
...
- Which source records identify obs-char-000592 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000592？
