# obs-char-000986 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/986_obs-char-000986_hust-obc-cat-1108_orac
  le-character/03_visual-assets/001_asset-000991_hust-obc-cat-1108_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1108/G_1108_乙738(甲).png`
- asset id: `asset-000991`
...
- source category: `1108`
- validation class: `985`
- source image route: `HUST-OBC/deciphered/1108/G_1108_乙738(甲).png`
- asset id: `asset-000991`
...
- English observation: `A tall central upright is flanked by two left
  horizontal strokes and a short right branch.`
...
- dataset label text: `㡊`
- dataset label codepoints: `U+384A`
...
- Which source records identify obs-char-000986 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000986？
