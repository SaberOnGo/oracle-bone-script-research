# obs-char-001189 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1189_obs-char-001189_hust-obc-cat-1330_ora
  cle-character/03_visual-assets/001_asset-001194_hust-obc-cat-1330_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1330/G_1330_七T22.png`
- asset id: `asset-001194`
...
- source category: `1330`
- validation class: `1188`
- source image route: `HUST-OBC/deciphered/1330/G_1330_七T22.png`
- asset id: `asset-001194`
...
- dataset label text: `㤨`
- dataset label codepoints: `U+3928`
...
- Which source records identify obs-char-001189 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001189？
