# obs-unk-004533 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/033_obs-unk-004533_h
  ust-obc-und-X-004533_oracle-character-candidate/03_visual-assets/001_asset
  -006126_hust-obc-und-X-004533_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/89/X_？_8273_1.png`
- asset id: `asset-006126`
...
- source class: `HUST-OBC/undeciphered/X/89/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/89/X_？_8273_1.png`
- asset id: `asset-006126`
...
- English observation: `Junction, branches, opening, and lower loop recorded.`
- 中文观察: `已记录中央连接处、分支、开口和下部环状痕迹。`
...
- Which source records identify obs-unk-004533 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004533？
