...
- External category reference: `evobc-cat-02748`
- Source category ID: `02748`
- Source label for human review: `廇`
...
- `obs-evo-cand-002748-route-category-staging`
...
- `obs-evo-cand-002748-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002748-route-evolution-graph`
