# Material Visual Observation / obs-comp-cand-002530 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002530`
- External reference / 外部参照: `obimd-sub-1r30xz0nrz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021049_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1r30xz0nrz/1r30xz0nrz/1r30xz0nrz.png`
- Checksum / 校验和:
  `08029cf1e17e07253de8ef612182d2380d4acf385b0962705d80ec3429091acf`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.28%.
- Marked-pixel bounds: (77,32)–(172,211); span 96 × 180 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.28%。
- 痕迹范围：(77,32)–(172,211)；跨度96 × 180 px；痕迹矩形高于宽。
