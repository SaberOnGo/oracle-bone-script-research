# Material Visual Observation / obs-comp-cand-000454 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000454`
- External reference / 外部参照: `obimd-sub-dgw10rc4gi`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012602_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dgw10rc4gi/dgw10rc4gi/dgw10rc4gi.png`
- Checksum / 校验和:
  `c68546eb8c5d81f1b6f8a86515ddb7638867383370ad01573847b8c45924b174`
...
- Marked-pixel bounds: (79,26)–(170,226); span 92 × 201 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.33%。
- 痕迹范围：(79,26)–(170,226)；跨度92 × 201 px；痕迹矩形高于宽。
