...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000084` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y533` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `140` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `388` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `39524` [route_present_image_or_text_not_collected]
