# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006308
...
- EVOBC candidate category: `evobc-evo-cat-06308`.
- Source label for search only: `箾`.
- Source codepoints for search only: `U+7BBE`.
