# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002037
...
| --- | --- | --- | --- |
| `obimd-glyph-link-031347` | 󻮘 | `U+FBB98` | `reviewed_metadata_only` |
| `obimd-glyph-link-031348` | 󻮙 | `U+FBB99` | `reviewed_metadata_only` |
| `obimd-glyph-link-031349` | 󻮚 | `U+FBB9A` | `reviewed_metadata_only` |
| `obimd-glyph-link-031350` | 󻮛 | `U+FBB9B` | `reviewed_metadata_only` |
