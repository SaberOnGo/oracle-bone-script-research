...
- External category reference: `evobc-cat-11227`
- Source category ID: `11227`
- Source label for human review: `𢘽`
- Source codepoints: `U+2263D`
...
- `obs-evo-cand-011227-route-category-staging`
...
- `obs-evo-cand-011227-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011227-route-evolution-graph`
