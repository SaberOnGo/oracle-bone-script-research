# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013218
...
- EVOBC candidate category: `evobc-evo-cat-13218`.
- Source label for search only: `𬆱`.
- Source codepoints for search only: `U+2C1B1`.
