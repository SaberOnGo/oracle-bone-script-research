...
- External category reference: `evobc-cat-03317`
- Source category ID: `03317`
- Source label for human review: `拗`
- Source codepoints: `U+62D7`
...
- `obs-evo-cand-003317-route-category-staging`
...
- `obs-evo-cand-003317-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003317-route-evolution-graph`
