# Material Visual Observation / obs-comp-cand-001395 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001395`
- External reference / 外部参照: `obimd-sub-q3hrv2vesz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015814_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/q3hrv2vesz/q3hrv2vesz/q3hrv2vesz.png`
- Checksum / 校验和:
  `d230d5a66aceca3d24b75ac681bee0bfac6b7c791b446041e2be70fa295af713`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.35%.
- Marked-pixel bounds: (65,23)–(180,222); span 116 × 200 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.35%。
- 痕迹范围：(65,23)–(180,222)；跨度116 × 200 px；痕迹矩形高于宽。
