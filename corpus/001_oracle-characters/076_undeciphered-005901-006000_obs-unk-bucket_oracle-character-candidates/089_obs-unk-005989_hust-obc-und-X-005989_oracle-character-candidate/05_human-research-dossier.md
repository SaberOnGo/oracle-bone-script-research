# obs-unk-005989 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/076_undeciphered-005
  901-006000_obs-unk-bucket_oracle-character-candidates/089_obs-unk-005989_h
  ust-obc-und-X-005989_oracle-character-candidate/03_visual-assets/001_asset
  -007581_hust-obc-und-X-005989_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1545/X_？_2972_1.png`
- asset id: `asset-007581`
...
- source class: `HUST-OBC/undeciphered/X/1545/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1545/X_？_2972_1.png`
- asset id: `asset-007581`
...
- Which source records identify obs-unk-005989 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005989？
