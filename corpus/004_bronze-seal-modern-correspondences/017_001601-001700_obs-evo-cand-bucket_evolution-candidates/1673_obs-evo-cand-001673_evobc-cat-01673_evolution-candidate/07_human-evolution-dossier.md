...
- Project ID: `obs-evo-cand-001673`
- EVOBC category candidate ID: `evobc-evo-cat-01673`
- External category reference: `evobc-cat-01673`
- Source category ID: `01673`
- Source label for human review: `嗚`
- Source codepoints: `U+55DA`
...
- `obs-evo-cand-001673-route-category-staging`
...
- `obs-evo-cand-001673-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001673-route-evolution-graph`
