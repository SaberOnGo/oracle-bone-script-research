...
- External category reference: `evobc-cat-01013`
- Source category ID: `01013`
- Source label for human review: `僓`
- Source codepoints: `U+50D3`
...
- `obs-evo-cand-001013-route-category-staging`
...
- `obs-evo-cand-001013-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001013-route-evolution-graph`
