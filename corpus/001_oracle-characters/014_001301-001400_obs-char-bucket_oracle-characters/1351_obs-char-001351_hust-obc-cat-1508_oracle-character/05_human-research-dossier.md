# obs-char-001351 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001351`
- primary external id: `hust-obc-cat-1508`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1351_obs-char-001351_hust-obc-cat-1508_ora
  cle-character/03_visual-assets/001_asset-001356_hust-obc-cat-1508_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1508/G_1508_甲875合27582無名組.png`
- asset id: `asset-001356`
...
- source category: `1508`
- validation class: `1350`
- source image route: `HUST-OBC/deciphered/1508/G_1508_甲875合27582無名組.png`
- asset id: `asset-001356`
...
- English observation: `A central vertical stroke crosses a broad horizontal
  bar, with several small detached side marks.`
- 中文观察: `中央竖笔穿过宽大的水平横部，两侧有数个小型分离标记。`
...
- dataset label text: `㧚`
- dataset label codepoints: `U+39DA`
...
- filename catalog route clues: `Heji-like filename clue: 合27582
  (G_1508_甲875合27582無名組.png)`
...
- Which source records identify obs-char-001351 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001351？
