# obs-unk-004374 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/074_obs-unk-004374_h
  ust-obc-und-L-004374_oracle-character-candidate/03_visual-assets/001_asset
  -005967_hust-obc-und-L-004374_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4374/L_？_9712.jpg`
- asset id: `asset-005967`
...
- source class: `HUST-OBC/undeciphered/L/4374/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4374/L_？_9712.jpg`
- asset id: `asset-005967`
...
- English observation: `Right vertical trace, upper loop, and lower`
  `diagonal recorded.`
- 中文观察: `已记录右侧纵痕、上部环痕和下部斜痕。`
...
- Which source records identify obs-unk-004374 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004374？
