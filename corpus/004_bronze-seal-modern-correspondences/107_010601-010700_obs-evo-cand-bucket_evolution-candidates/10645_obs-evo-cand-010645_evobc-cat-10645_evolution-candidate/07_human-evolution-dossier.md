...
Project ID: `obs-evo-cand-010645`
...
- Project ID: `obs-evo-cand-010645`
- EVOBC category candidate ID: `evobc-evo-cat-10645`
- External category reference: `evobc-cat-10645`
- Source category ID: `10645`
- Source label for human review: `默`
- Source codepoints: `U+9ED8`
...
- `obs-evo-cand-010645-route-category-staging`
...
- `obs-evo-cand-010645-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010645-route-evolution-graph`
