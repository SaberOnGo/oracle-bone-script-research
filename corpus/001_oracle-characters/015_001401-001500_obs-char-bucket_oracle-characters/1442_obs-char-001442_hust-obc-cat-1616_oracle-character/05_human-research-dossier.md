# obs-char-001442 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1442_obs-char-001442_hust-obc-cat-1616_ora
  cle-character/03_visual-assets/001_asset-001447_hust-obc-cat-1616_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1616/G_1616_乙1556(甲).png`
- asset id: `asset-001447`
...
- source category: `1616`
- validation class: `1441`
- source image route: `HUST-OBC/deciphered/1616/G_1616_乙1556(甲).png`
- asset id: `asset-001447`
...
- English observation: `A narrow curved stem has repeated short marks along
  its left side.`
- 中文观察: `狭长弧形竖干左侧有重复短笔。`
...
- dataset label text: `㩆`
- dataset label codepoints: `U+3A46`
...
- Which source records identify obs-char-001442 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001442？
