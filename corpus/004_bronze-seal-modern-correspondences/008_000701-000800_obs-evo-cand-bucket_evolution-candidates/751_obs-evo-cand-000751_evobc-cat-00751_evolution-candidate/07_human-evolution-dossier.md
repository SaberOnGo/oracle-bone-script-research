...
- External category reference: `evobc-cat-00751`
- Source category ID: `00751`
- Source label for human review: `仲`
...
- `obs-evo-cand-000751-route-category-staging`
...
- `obs-evo-cand-000751-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000751-route-evolution-graph`
