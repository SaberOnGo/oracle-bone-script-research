...
- External category reference: `evobc-cat-00091`
- Source category ID: `00091`
- Source label: `㡀`
...
- `obs-evo-cand-000091-route-category-staging`
...
- `obs-evo-cand-000091-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-000091-route-evolution-graph`
