...
Project ID: `obs-evo-cand-007506`
...
- Project ID: `obs-evo-cand-007506`
- EVOBC category candidate ID: `evobc-evo-cat-07506`
- External category reference: `evobc-cat-07506`
- Source category ID: `07506`
- Source label for human review: `蒩`
- Source codepoints: `U+84A9`
...
- `obs-evo-cand-007506-route-category-staging`
...
- `obs-evo-cand-007506-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007506-route-evolution-graph`
