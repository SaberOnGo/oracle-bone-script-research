# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000659
...
- EVOBC candidate category: `evobc-evo-cat-00659`.
- Source label for search only: `乍`.
- Source codepoints for search only: `U+4E4D`.
