# Material Visual Observation / obs-comp-cand-001082 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001082`
- External reference / 外部参照: `obimd-sub-kzmks2fxlw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014779_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kzmks2fxlw/kzmks2fxlw/kzmks2fxlw.png`
- Checksum / 校验和:
  `c31de8bf4cda2845370e71301fa78a2a44080bf8c2182ba89cdd092d15f20426`
...
- Marked-pixel bounds: (85,27)–(162,222); span 78 × 196 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.28%。
- 痕迹范围：(85,27)–(162,222)；跨度78 × 196 px；痕迹矩形高于宽。
