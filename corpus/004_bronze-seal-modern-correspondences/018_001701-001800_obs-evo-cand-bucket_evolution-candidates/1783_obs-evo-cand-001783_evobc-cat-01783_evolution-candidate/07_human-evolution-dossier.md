...
Project ID: `obs-evo-cand-001783`
...
- Project ID: `obs-evo-cand-001783`
- EVOBC category candidate ID: `evobc-evo-cat-01783`
- External category reference: `evobc-cat-01783`
- Source category ID: `01783`
- Source label for human review: `圓`
- Source codepoints: `U+5713`
...
- `obs-evo-cand-001783-route-category-staging`
...
- `obs-evo-cand-001783-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001783-route-evolution-graph`
