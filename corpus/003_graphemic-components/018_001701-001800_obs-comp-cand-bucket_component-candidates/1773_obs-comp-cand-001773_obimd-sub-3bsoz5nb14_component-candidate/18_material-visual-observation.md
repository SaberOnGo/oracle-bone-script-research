# Material Visual Observation / obs-comp-cand-001773 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001773`
- External reference / 外部参照: `obimd-sub-3bsoz5nb14`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017974_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8sbbzthl9w/3bsoz5nb14/3bsoz5nb14.png`
- Checksum / 校验和:
  `8a0e49d3fdaf160b9e5b035fcf5d075bdc05c1e8de7b16bf940d8d7ad183bd24`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.10%.
- Marked-pixel bounds: (74,24)–(175,225); span 102 × 202 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.10%。
- 痕迹范围：(74,24)–(175,225)；跨度102 × 202 px；痕迹矩形高于宽。
