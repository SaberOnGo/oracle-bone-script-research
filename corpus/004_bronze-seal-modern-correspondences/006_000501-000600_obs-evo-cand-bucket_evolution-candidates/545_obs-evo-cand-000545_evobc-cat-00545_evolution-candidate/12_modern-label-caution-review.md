# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000545
...
- EVOBC candidate category: `evobc-evo-cat-00545`.
- Source label for search only: `䪝`.
- Source codepoints for search only: `U+4A9D`.
