# Material Visual Observation / obs-comp-cand-002095 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002095`
- External reference / 外部参照: `obimd-sub-0lplfrdm68`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019541_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0lplfrdm68/0lplfrdm68/0lplfrdm68.png`
- Checksum / 校验和:
  `51e1d1736ffe1796fde7fbd6ba6b3f21404f1908f798fa5127c9e357576dc907`
...
- Marked-pixel bounds: (59,19)–(183,229); span 125 × 211 px; the marked
...
- 痕迹范围：(59,19)–(183,229)；跨度125 × 211 px；痕迹矩形高于宽。
