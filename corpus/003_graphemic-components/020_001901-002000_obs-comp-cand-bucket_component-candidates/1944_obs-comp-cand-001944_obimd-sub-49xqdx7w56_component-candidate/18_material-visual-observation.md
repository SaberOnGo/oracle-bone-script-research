# Material Visual Observation / obs-comp-cand-001944 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001944`
- External reference / 外部参照: `obimd-sub-49xqdx7w56`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018754_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/49xqdx7w56/49xqdx7w56/49xqdx7w56.png`
- Checksum / 校验和:
  `a8bfd8eb958234d64b2470a8c935b27e56f8a7bb48aa6c198afd1f572f056b37`
...
- Marked-pixel bounds: (63,12)–(207,235); span 145 × 224 px; the marked
...
- 痕迹范围：(63,12)–(207,235)；跨度145 × 224 px；痕迹矩形高于宽。
