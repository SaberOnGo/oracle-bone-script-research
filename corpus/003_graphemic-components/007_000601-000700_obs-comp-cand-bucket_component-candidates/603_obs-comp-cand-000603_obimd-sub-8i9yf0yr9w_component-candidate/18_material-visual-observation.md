# Material Visual Observation / obs-comp-cand-000603 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000603`
- External reference / 外部参照: `obimd-sub-8i9yf0yr9w`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013136_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8i9yf0yr9w/8i9yf0yr9w/8i9yf0yr9w.png`
- Checksum / 校验和:
  `8e6ee0e1066615d5959cc240d9f7a0c35f0aaa325cc54db7bf8d98bc842682b3`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.61%.
- Marked-pixel bounds: (70,13)–(181,235); span 112 × 223 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.61%。
- 痕迹范围：(70,13)–(181,235)；跨度112 × 223 px；痕迹矩形高于宽。
