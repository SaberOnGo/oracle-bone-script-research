# Material Visual Observation / obs-comp-cand-002398 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002398`
- External reference / 外部参照: `obimd-sub-u50t291yp7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020469_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6p9l9b6dwr/u50t291yp7/u50t291yp7.png`
- Checksum / 校验和:
  `f74d1b01f2e5b3918f30ebebbb86868bfacfbf969d8708783e21be5fbb9d2893`
...
- Marked-pixel bounds: (85,20)–(179,229); span 95 × 210 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.33%。
- 痕迹范围：(85,20)–(179,229)；跨度95 × 210 px；痕迹矩形高于宽。
