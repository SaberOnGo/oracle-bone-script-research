# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000187
...
| --- | --- | --- | --- |
| `obimd-glyph-link-002562` | 󱅙 | `U+F1159` | `reviewed_metadata_only` |
| `obimd-glyph-link-002563` | 󱅚 | `U+F115A` | `reviewed_metadata_only` |
| `obimd-glyph-link-002564` | 󱅛 | `U+F115B` | `reviewed_metadata_only` |
