# obs-unk-004620 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/020_obs-unk-004620_h
  ust-obc-und-X-004620_oracle-character-candidate/03_visual-assets/001_asset
  -006213_hust-obc-und-X-004620_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/176/X_？_8351_1.png`
- asset id: `asset-006213`
...
- source class: `HUST-OBC/undeciphered/X/176/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/176/X_？_8351_1.png`
- asset id: `asset-006213`
...
- English observation: `central loop, upper branches, split lower feet`
- 中文观察: `中央环状空间、上部分支和下部双足已记录。`
...
- Which source records identify obs-unk-004620 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004620？
