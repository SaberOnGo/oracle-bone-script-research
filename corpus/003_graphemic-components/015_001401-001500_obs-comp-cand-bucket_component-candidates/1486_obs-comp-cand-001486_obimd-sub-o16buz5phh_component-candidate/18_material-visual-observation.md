# Material Visual Observation / obs-comp-cand-001486 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001486`
- External reference / 外部参照: `obimd-sub-o16buz5phh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016063_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h521w0m697/o16buz5phh/o16buz5phh.png`
- Checksum / 校验和:
  `2256d8188c482b45c2ea05d9a89d28bc145984b7f9d2c10ef4034c9a0bbedd02`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.71%.
- Marked-pixel bounds: (63,17)–(196,230); span 134 × 214 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.71%。
- 痕迹范围：(63,17)–(196,230)；跨度134 × 214 px；痕迹矩形高于宽。
