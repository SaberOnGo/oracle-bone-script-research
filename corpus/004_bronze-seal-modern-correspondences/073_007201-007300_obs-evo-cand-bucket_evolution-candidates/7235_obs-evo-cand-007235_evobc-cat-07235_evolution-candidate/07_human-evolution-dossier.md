...
- Project ID: `obs-evo-cand-007235`
- EVOBC category candidate ID: `evobc-evo-cat-07235`
- External category reference: `evobc-cat-07235`
- Source category ID: `07235`
- Source label for human review: `芎`
- Source codepoints: `U+828E`
...
- `obs-evo-cand-007235-route-category-staging`
...
- `obs-evo-cand-007235-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007235-route-evolution-graph`
