# obs-char-000620 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000620`
- primary external id: `hust-obc-cat-0705`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/620_obs-char-000620_hust-obc-cat-0705_orac
  le-character/03_visual-assets/001_asset-000625_hust-obc-cat-0705_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0705/G_0705_京津4000.png`
- asset id: `asset-000625`
...
- source category: `0705`
- validation class: `619`
- source image route: `HUST-OBC/deciphered/0705/G_0705_京津4000.png`
- asset id: `asset-000625`
...
- English observation: `Two detached groups stand side by side: a branched
  slanting stem with pointed ends at left and a simple upright cross at
  right.`
- 中文观察: `两个分离笔群并列：左侧为带尖端的分枝斜干，右侧为简单直立十字形。`
...
- dataset label text: `㚷`
- dataset label codepoints: `U+36B7`
...
- Which source records identify obs-char-000620 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000620？
