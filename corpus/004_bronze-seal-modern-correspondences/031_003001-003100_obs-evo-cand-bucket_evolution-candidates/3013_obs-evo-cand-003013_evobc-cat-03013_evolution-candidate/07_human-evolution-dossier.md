...
- External category reference: `evobc-cat-03013`
- Source category ID: `03013`
- Source label for human review: `悘`
...
- `obs-evo-cand-003013-route-category-staging`
...
- `obs-evo-cand-003013-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003013-route-evolution-graph`
