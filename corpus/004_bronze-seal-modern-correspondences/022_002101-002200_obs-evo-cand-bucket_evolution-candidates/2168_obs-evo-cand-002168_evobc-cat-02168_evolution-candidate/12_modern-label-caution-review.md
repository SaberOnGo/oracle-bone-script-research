# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002168
...
- EVOBC candidate category: `evobc-evo-cat-02168`.
- Source label for search only: `娛`.
- Source codepoints for search only: `U+5A1B`.
