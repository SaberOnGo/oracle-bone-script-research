...
- External category reference: `evobc-cat-10167`
- Source category ID: `10167`
- Source label for human review: `馵`
...
- `obs-evo-cand-010167-route-category-staging`
...
- `obs-evo-cand-010167-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010167-route-evolution-graph`
