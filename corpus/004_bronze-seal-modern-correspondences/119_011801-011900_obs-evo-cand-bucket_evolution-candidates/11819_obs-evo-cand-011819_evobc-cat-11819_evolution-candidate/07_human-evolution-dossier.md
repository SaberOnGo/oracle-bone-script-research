...
- External category reference: `evobc-cat-11819`
- Source category ID: `11819`
- Source label for human review: `𥚡`
...
- `obs-evo-cand-011819-route-category-staging`
...
- `obs-evo-cand-011819-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011819-route-evolution-graph`
