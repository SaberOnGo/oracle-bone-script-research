...
Project ID: `obs-evo-cand-005886`
...
- Project ID: `obs-evo-cand-005886`
- EVOBC category candidate ID: `evobc-evo-cat-05886`
- External category reference: `evobc-cat-05886`
- Source category ID: `05886`
- Source label for human review: `矮`
- Source codepoints: `U+77EE`
...
- `obs-evo-cand-005886-route-category-staging`
...
- `obs-evo-cand-005886-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005886-route-evolution-graph`
