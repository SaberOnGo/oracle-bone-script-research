...
Project ID: `obs-evo-cand-012471`
...
- Project ID: `obs-evo-cand-012471`
- EVOBC category candidate ID: `evobc-evo-cat-12471`
- External category reference: `evobc-cat-12471`
- Source category ID: `12471`
- Source label for human review: `𨡽`
- Source codepoints: `U+2887D`
...
- `obs-evo-cand-012471-route-category-staging`
...
- `obs-evo-cand-012471-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012471-route-evolution-graph`
