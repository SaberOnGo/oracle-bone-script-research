...
Project ID: `obs-evo-cand-007483`
...
- Project ID: `obs-evo-cand-007483`
- EVOBC category candidate ID: `evobc-evo-cat-07483`
- External category reference: `evobc-cat-07483`
- Source category ID: `07483`
- Source label for human review: `葲`
- Source codepoints: `U+8472`
...
- `obs-evo-cand-007483-route-category-staging`
...
- `obs-evo-cand-007483-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007483-route-evolution-graph`
