...
- External category reference: `evobc-cat-01256`
- Source category ID: `01256`
- Source label for human review: `劌`
- Source codepoints: `U+528C`
...
- `obs-evo-cand-001256-route-category-staging`
...
- `obs-evo-cand-001256-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001256-route-evolution-graph`
