# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010585
...
- EVOBC candidate category: `evobc-evo-cat-10585`.
- Source label for search only: `鸭`.
- Source codepoints for search only: `U+9E2D`.
