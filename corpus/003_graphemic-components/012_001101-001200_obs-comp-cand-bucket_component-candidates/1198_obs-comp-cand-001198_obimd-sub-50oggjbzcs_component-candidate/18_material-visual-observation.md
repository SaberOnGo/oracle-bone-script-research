# Material Visual Observation / obs-comp-cand-001198 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001198`
- External reference / 外部参照: `obimd-sub-50oggjbzcs`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015388_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/50oggjbzcs/50oggjbzcs/0qbuyrjdjk.png`
- Checksum / 校验和:
  `78b28d8f5a934ba8da1c848b183f23bdd04c4f9aa62f7d5adc197376db548ba5`
...
- Marked-pixel bounds: (93,25)–(156,222); span 64 × 198 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.55%。
- 痕迹范围：(93,25)–(156,222)；跨度64 × 198 px；痕迹矩形高于宽。
