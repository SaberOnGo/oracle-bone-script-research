...
Project ID: `obs-evo-cand-013371`
...
- Project ID: `obs-evo-cand-013371`
- EVOBC category candidate ID: `evobc-evo-cat-13371`
- External category reference: `evobc-cat-13371`
- Source category ID: `13371`
- Source label for human review: `𬩵`
- Source codepoints: `U+2CA75`
...
- `obs-evo-cand-013371-route-category-staging`
...
- `obs-evo-cand-013371-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013371-route-evolution-graph`
