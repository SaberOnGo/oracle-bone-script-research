...
- External category reference: `evobc-cat-11109`
- Source category ID: `11109`
- Source label for human review: `𡵇`
- Source codepoints: `U+21D47`
...
- `obs-evo-cand-011109-route-category-staging`
...
- `obs-evo-cand-011109-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011109-route-evolution-graph`
