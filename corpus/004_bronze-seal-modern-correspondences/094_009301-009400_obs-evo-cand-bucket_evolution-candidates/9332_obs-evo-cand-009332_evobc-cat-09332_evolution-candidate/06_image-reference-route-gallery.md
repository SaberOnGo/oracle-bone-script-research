...
- `obs-evo-cand-009332-route-category-staging`
...
- `obs-evo-cand-009332-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009332-route-evolution-graph`
