# obs-unk-004841 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004841`
- primary external id: `hust-obc-und-X-004841`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/041_obs-unk-004841_h
  ust-obc-und-X-004841_oracle-character-candidate/03_visual-assets/001_asset
  -006434_hust-obc-und-X-004841_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/397/X_？_7383_1.png`
- asset id: `asset-006434`
...
- source class: `HUST-OBC/undeciphered/X/397/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/397/X_？_7383_1.png`
- asset id: `asset-006434`
...
- English observation: `low band with two central pale openings`
- 中文观察: `带两个中部浅色开口的低位横向结构`
...
- Which source records identify obs-unk-004841 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004841？
