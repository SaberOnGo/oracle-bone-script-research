...
- External category reference: `evobc-cat-13517`
- Source category ID: `13517`
- Source label for human review: `𭙘`
...
- `obs-evo-cand-013517-route-category-staging`
...
- `obs-evo-cand-013517-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013517-route-evolution-graph`
