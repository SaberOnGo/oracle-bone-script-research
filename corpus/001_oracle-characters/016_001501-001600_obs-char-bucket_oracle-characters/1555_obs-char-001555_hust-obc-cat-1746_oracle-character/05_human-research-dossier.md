# obs-char-001555 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001555`
- primary external id: `hust-obc-cat-1746`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1555_obs-char-001555_hust-obc-cat-1746_ora
  cle-character/03_visual-assets/001_asset-001560_hust-obc-cat-1746_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1746/X_1746_1805_1.png`
- asset id: `asset-001560`
...
- source category: `1746`
- validation class: `1554`
- source image route: `HUST-OBC/deciphered/1746/X_1746_1805_1.png`
- asset id: `asset-001560`
...
- English observation: `A bold diamond-like enclosure contains several
  rounded inner openings.`
- 中文观察: `醒目的菱形框形包含数个圆折内部开口。`
...
- dataset label text: `㫈`
- dataset label codepoints: `U+3AC8`
...
- Which source records identify obs-char-001555 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001555？
