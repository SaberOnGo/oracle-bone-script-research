...
- `obs-evo-cand-009073-route-category-staging`
...
- `obs-evo-cand-009073-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009073-route-evolution-graph`
