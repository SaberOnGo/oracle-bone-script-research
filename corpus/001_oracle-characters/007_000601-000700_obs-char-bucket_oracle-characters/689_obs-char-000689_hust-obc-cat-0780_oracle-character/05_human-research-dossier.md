# obs-char-000689 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000689`
- primary external id: `hust-obc-cat-0780`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/689_obs-char-000689_hust-obc-cat-0780_orac
  le-character/03_visual-assets/001_asset-000694_hust-obc-cat-0780_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0780/G_0780_乙161合22349子組.png`
- asset id: `asset-000694`
...
- source category: `0780`
- validation class: `688`
- source image route: `HUST-OBC/deciphered/0780/G_0780_乙161合22349子組.png`
- asset id: `asset-000694`
...
- English observation: `Several detached small oval marks form a loose left
  column, while a narrow right stem carries a rounded side loop and divides
  into pointed lower strokes.`
- 中文观察: `数个分离小椭圆痕组成疏松左列，狭窄右干带圆弯侧环并分成尖形下笔。`
...
- dataset label text: `㜂`
- dataset label codepoints: `U+3702`
...
- filename catalog route clues: `Heji-like filename clue: 合22349
  (G_0780_乙161合22349子組.png)`
...
- Which source records identify obs-char-000689 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000689？
