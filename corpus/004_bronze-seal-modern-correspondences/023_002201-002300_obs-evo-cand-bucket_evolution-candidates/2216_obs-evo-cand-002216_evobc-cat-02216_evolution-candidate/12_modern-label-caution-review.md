# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002216
...
- EVOBC candidate category: `evobc-evo-cat-02216`.
- Source label for search only: `婺`.
- Source codepoints for search only: `U+5A7A`.
