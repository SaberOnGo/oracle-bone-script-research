# obs-evo-cand-002060 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-002060`
- EVOBC category candidate ID: `evobc-evo-cat-02060`
- External category ref: `evobc-cat-02060`
- Source label: `女`
- Source codepoints: `U+5973`
- Image reference count: `454`
- Era token counts: `BI:145;CS:1;OBC:153;SAC:20;SS:2;WSC:133`
- Source token counts: `Book:221;Web:233`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 153 image references
- era 1 / BI: 145 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 20 image references
- era 4 / WSC: 133 image references
- era 5 / CS: 1 image references
- source 0 / Web:1633: 1 image references
- source 1 / Web:105952;說文Web:58: 209 image references
- source 2 / Book:17600: 80 image references
- source 3 / Book:21681: 88 image references
