# obs-unk-009216 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-009216`
- primary external id: `hust-obc-und-YH-009216`
...
- local review image route: `corpus/001_oracle-characters/109_undeciphered-009
  201-009300_obs-unk-bucket_oracle-character-candidates/016_obs-unk-009216_h
  ust-obc-und-YH-009216_oracle-character-candidate/03_visual-assets/001_asse
  t-010807_hust-obc-und-YH-009216_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/613C5/H_？_613C5_0.png`
- asset id: `asset-010807`
...
- source class: `HUST-OBC/undeciphered/Y+H/613C5/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/613C5/H_？_613C5_0.png`
- asset id: `asset-010807`
...
- Which source records identify obs-unk-009216 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009216？
