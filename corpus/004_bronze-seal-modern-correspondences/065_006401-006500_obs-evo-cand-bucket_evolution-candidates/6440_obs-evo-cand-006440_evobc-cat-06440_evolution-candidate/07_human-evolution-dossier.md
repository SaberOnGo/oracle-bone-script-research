...
- External category reference: `evobc-cat-06440`
- Source category ID: `06440`
- Source label for human review: `糿`
...
- `obs-evo-cand-006440-route-category-staging`
...
- `obs-evo-cand-006440-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006440-route-evolution-graph`
