# Material Visual Observation / obs-comp-cand-001325 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001325`
- External reference / 外部参照: `obimd-sub-earnw14zid`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015662_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/earnw14zid/earnw14zid/earnw14zid.png`
- Checksum / 校验和:
  `1894e3011fb769937733efe775451f3ace9c99eeb74b7072b96e2cfc675eb8b6`
...
- Marked-pixel bounds: (80,32)–(169,221); span 90 × 190 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.09%。
- 痕迹范围：(80,32)–(169,221)；跨度90 × 190 px；痕迹矩形高于宽。
