...
Project ID: `obs-evo-cand-008942`
...
- Project ID: `obs-evo-cand-008942`
- EVOBC category candidate ID: `evobc-evo-cat-08942`
- External category reference: `evobc-cat-08942`
- Source category ID: `08942`
- Source label for human review: `迊`
- Source codepoints: `U+8FCA`
...
- `obs-evo-cand-008942-route-category-staging`
...
- `obs-evo-cand-008942-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008942-route-evolution-graph`
