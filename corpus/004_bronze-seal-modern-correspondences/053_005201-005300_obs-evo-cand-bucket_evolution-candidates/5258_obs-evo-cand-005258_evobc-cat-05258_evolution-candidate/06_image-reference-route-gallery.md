...
- `obs-evo-cand-005258-route-category-staging`
...
- `obs-evo-cand-005258-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005258-route-evolution-graph`
