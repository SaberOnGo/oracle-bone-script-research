...
Project ID: `obs-evo-cand-003023`
...
- Project ID: `obs-evo-cand-003023`
- EVOBC category candidate ID: `evobc-evo-cat-03023`
- External category reference: `evobc-cat-03023`
- Source category ID: `03023`
- Source label for human review: `悰`
- Source codepoints: `U+60B0`
...
- `obs-evo-cand-003023-route-category-staging`
...
- `obs-evo-cand-003023-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003023-route-evolution-graph`
