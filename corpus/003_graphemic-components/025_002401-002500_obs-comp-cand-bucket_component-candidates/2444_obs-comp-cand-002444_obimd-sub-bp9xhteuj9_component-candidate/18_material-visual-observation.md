# Material Visual Observation / obs-comp-cand-002444 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002444`
- External reference / 外部参照: `obimd-sub-bp9xhteuj9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020616_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bp9xhteuj9/bp9xhteuj9/bp9xhteuj9.png`
- Checksum / 校验和:
  `876a8a811353a0cd0fd5b8b9f66511dcd856b702fe76dfdca4196447cbca9b6d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.47%.
- Marked-pixel bounds: (77,17)–(183,231); span 107 × 215 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.47%。
- 痕迹范围：(77,17)–(183,231)；跨度107 × 215 px；痕迹矩形高于宽。
