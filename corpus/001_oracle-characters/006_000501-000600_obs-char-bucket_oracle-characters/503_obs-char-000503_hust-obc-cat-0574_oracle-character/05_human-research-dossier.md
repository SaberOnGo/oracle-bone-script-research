# obs-char-000503 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/503_obs-char-000503_hust-obc-cat-0574_orac
  le-character/03_visual-assets/001_asset-000508_hust-obc-cat-0574_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0574/H_0574_60794_0.png`
- asset id: `asset-000508`
...
- source category: `0574`
- validation class: `502`
- source image route: `HUST-OBC/deciphered/0574/H_0574_60794_0.png`
- asset id: `asset-000508`
...
- English observation: `Two bold forms stand apart: a branching vertical
  trunk with a lower loop on a base at left, and a curved upper arch with a
  long descending side at right.`
- 中文观察: `两个粗重形体彼此分离：左侧为带下环和底线的分支竖干，右侧为上部弯拱及长下行侧笔。`
...
- dataset label text: `㘴`
- dataset label codepoints: `U+3634`
...
- filename catalog route clues: `catalog-like filename clue: H_0574
  (H_0574_60794_0.png)`
...
- Which source records identify obs-char-000503 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000503？
