# obs-unk-004398 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/098_obs-unk-004398_h
  ust-obc-und-L-004398_oracle-character-candidate/03_visual-assets/001_asset
  -005991_hust-obc-und-L-004398_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4398/L_？_9793.jpg`
- asset id: `asset-005991`
...
- source class: `HUST-OBC/undeciphered/L/4398/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4398/L_？_9793.jpg`
- asset id: `asset-005991`
...
- English observation: `A thin central trace has diagonal branches and`
  `short lower horizontal marks.`
- 中文观察: `中央细长痕有斜向分支，下部两侧有短横向痕迹。`
...
- Which source records identify obs-unk-004398 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004398？
