# obs-unk-004751 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/051_obs-unk-004751_h
  ust-obc-und-X-004751_oracle-character-candidate/03_visual-assets/001_asset
  -006344_hust-obc-und-X-004751_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/307/X_？_7292_1.png`
- asset id: `asset-006344`
...
- source class: `HUST-OBC/undeciphered/X/307/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/307/X_？_7292_1.png`
- asset id: `asset-006344`
...
- English observation: `separate tall forms with pale openings`
- 中文观察: `带浅色开口的分离高形结构`
...
- Which source records identify obs-unk-004751 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004751？
