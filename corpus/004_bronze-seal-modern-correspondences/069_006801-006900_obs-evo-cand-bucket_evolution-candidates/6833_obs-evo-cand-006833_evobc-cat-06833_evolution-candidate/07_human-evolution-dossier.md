...
Project ID: `obs-evo-cand-006833`
...
- Project ID: `obs-evo-cand-006833`
- EVOBC category candidate ID: `evobc-evo-cat-06833`
- External category reference: `evobc-cat-06833`
- Source category ID: `06833`
- Source label for human review: `羅`
- Source codepoints: `U+7F85`
...
- `obs-evo-cand-006833-route-category-staging`
...
- `obs-evo-cand-006833-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006833-route-evolution-graph`
