...
- Project ID: `obs-evo-cand-012133`
- EVOBC category candidate ID: `evobc-evo-cat-12133`
- External category reference: `evobc-cat-12133`
- Source category ID: `12133`
- Source label for human review: `𧃖`
- Source codepoints: `U+270D6`
...
- `obs-evo-cand-012133-route-category-staging`
...
- `obs-evo-cand-012133-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012133-route-evolution-graph`
