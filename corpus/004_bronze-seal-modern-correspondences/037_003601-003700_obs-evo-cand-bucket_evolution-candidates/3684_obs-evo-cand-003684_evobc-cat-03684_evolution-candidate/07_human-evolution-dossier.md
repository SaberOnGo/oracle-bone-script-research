...
- External category reference: `evobc-cat-03684`
- Source category ID: `03684`
- Source label for human review: `日`
- Source codepoints: `U+65E5`
- Image reference count in source metadata: `376`
...
- `obs-evo-cand-003684-route-category-staging`
...
- `obs-evo-cand-003684-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003684-route-evolution-graph`
