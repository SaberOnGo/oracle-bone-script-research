# obs-char-001543 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1543_obs-char-001543_hust-obc-cat-1732_ora
  cle-character/03_visual-assets/001_asset-001548_hust-obc-cat-1732_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1732/X_1732_3501_1.png`
- asset id: `asset-001548`
...
- source category: `1732`
- validation class: `1542`
- source image route: `HUST-OBC/deciphered/1732/X_1732_3501_1.png`
- asset id: `asset-001548`
...
- English observation: `Sparse strokes surround a central vertical branch,
  with several detached short marks.`
...
- dataset label text: `㪺`
- dataset label codepoints: `U+3ABA`
...
- Which source records identify obs-char-001543 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001543？
