# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000825
...
- EVOBC candidate category: `evobc-evo-cat-00825`.
- Source label for search only: `佺`.
- Source codepoints for search only: `U+4F7A`.
