# Material Visual Observation / obs-comp-cand-001393 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001393`
- External reference / 外部参照: `obimd-sub-e6w7q0ux9y`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015812_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ff8rp0nh6u/e6w7q0ux9y/e6w7q0ux9y.png`
- Checksum / 校验和:
  `ed994101efffd6a74175037c073d5ad6070bbd460eb819faee75bbf3e1b84ae8`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.22%.
- Marked-pixel bounds: (69,32)–(180,221); span 112 × 190 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.22%。
- 痕迹范围：(69,32)–(180,221)；跨度112 × 190 px；痕迹矩形高于宽。
