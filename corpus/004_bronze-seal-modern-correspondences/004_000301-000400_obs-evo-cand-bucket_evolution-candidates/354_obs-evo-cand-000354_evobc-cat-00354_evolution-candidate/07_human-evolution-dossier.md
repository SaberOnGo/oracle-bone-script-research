...
- External category reference: `evobc-cat-00354`
- Source category ID: `00354`
- Source label for human review: `䏢`
...
- `obs-evo-cand-000354-route-category-staging`
...
- `obs-evo-cand-000354-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000354-route-evolution-graph`
