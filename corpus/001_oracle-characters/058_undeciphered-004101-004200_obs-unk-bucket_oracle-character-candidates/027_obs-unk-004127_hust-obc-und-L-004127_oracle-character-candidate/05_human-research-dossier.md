# obs-unk-004127 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004127`
- primary external id: `hust-obc-und-L-004127`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/027_obs-unk-004127_h
  ust-obc-und-L-004127_oracle-character-candidate/03_visual-assets/001_asset
  -005720_hust-obc-und-L-004127_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4127/L_？_8893.jpg`
- asset id: `asset-005720`
...
- source class: `HUST-OBC/undeciphered/L/4127/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4127/L_？_8893.jpg`
- asset id: `asset-005720`
...
- English observation: A narrow central group has a longer left turning trace;
  short pointed strokes are visible at the upper right.
- 中文观察：中央窄痕迹簇左侧有较长折转痕迹；右上方可见短尖痕迹。
...
- Which source records identify obs-unk-004127 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004127？
