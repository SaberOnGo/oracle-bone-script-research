# Material Visual Observation / obs-comp-cand-000126 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000126`
- External reference / 外部参照: `obimd-sub-08fa78pdp8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011538_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/08fa78pdp8/08fa78pdp8/08fa78pdp8.png`
- Checksum / 校验和:
  `f3eec0d508be5b59dfb90fdfbcc471503568cc02ae058f37ad5a396eb5109009`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.73%.
- Marked-pixel bounds: (83,19)–(180,232); span 98 × 214 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.73%。
- 痕迹范围：(83,19)–(180,232)；跨度98 × 214 px；痕迹矩形高于宽。
