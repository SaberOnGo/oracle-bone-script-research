...
- External category reference: `evobc-cat-00903`
- Source category ID: `00903`
- Source label for human review: `修`
- Source codepoints: `U+4FEE`
...
- `obs-evo-cand-000903-route-category-staging`
...
- `obs-evo-cand-000903-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000903-route-evolution-graph`
