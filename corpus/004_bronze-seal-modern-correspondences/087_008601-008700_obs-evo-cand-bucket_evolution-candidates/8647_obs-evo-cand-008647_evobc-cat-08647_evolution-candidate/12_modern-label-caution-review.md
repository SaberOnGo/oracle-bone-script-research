# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008647
...
- EVOBC candidate category: `evobc-evo-cat-08647`.
- Source label for search only: `赛`.
- Source codepoints for search only: `U+8D5B`.
