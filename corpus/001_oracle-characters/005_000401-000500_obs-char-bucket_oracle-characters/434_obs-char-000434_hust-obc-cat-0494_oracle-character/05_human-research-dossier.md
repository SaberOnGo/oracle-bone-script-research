# obs-char-000434 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/434_obs-char-000434_hust-obc-cat-0494_orac
  le-character/03_visual-assets/001_asset-000439_hust-obc-cat-0494_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0494/G_0494_寧滬1.231(甲).png`
- asset id: `asset-000439`
...
- source category: `0494`
- validation class: `433`
- source image route: `HUST-OBC/deciphered/0494/G_0494_寧滬1.231(甲).png`
- asset id: `asset-000439`
...
- English observation: `Two adjacent upright forms are visible: the left has
  an upper crossing and curved lower stroke, while the right has a small
  boxed top and long descending lines.`
- 中文观察: `两个直立形体相邻：左侧上部交叉、下部弯曲，右侧顶部有小框并带长下行笔画。`
...
- dataset label text: `㗤`
- dataset label codepoints: `U+35E4`
...
- Which source records identify obs-char-000434 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000434？
