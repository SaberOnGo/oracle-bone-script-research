# Material Visual Observation / obs-comp-cand-000996 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000996`
- External reference / 外部参照: `obimd-sub-q71z8tnnc6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014366_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/q71z8tnnc6/q71z8tnnc6/05rv5jfu7e.png`
- Checksum / 校验和:
  `3645698528d47c9bf5252960bc3b9dd318b2c4b3b95bdf8a78cbb34d0fcf8f8c`
...
- Marked-pixel bounds: (87,30)–(162,220); span 76 × 191 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.24%。
- 痕迹范围：(87,30)–(162,220)；跨度76 × 191 px；痕迹矩形高于宽。
