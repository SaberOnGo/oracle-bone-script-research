...
- `obs-evo-cand-004228-route-category-staging`
...
- `obs-evo-cand-004228-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004228-route-evolution-graph`
