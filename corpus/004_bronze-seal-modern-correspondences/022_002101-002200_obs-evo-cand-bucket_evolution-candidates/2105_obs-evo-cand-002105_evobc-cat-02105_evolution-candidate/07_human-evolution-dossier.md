...
Project ID: `obs-evo-cand-002105`
...
- Project ID: `obs-evo-cand-002105`
- EVOBC category candidate ID: `evobc-evo-cat-02105`
- External category reference: `evobc-cat-02105`
- Source category ID: `02105`
- Source label for human review: `妹`
- Source codepoints: `U+59B9`
- Image reference count in source metadata: `133`
...
- `obs-evo-cand-002105-route-category-staging`
...
- `obs-evo-cand-002105-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002105-route-evolution-graph`
