# obs-char-001075 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001075`
- primary external id: `hust-obc-cat-1202`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1075_obs-char-001075_hust-obc-cat-1202_ora
  cle-character/03_visual-assets/001_asset-001080_hust-obc-cat-1202_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1202/G_1202_拾5.7(甲).png`
- asset id: `asset-001080`
...
- source category: `1202`
- validation class: `1074`
- source image route: `HUST-OBC/deciphered/1202/G_1202_拾5.7(甲).png`
- asset id: `asset-001080`
...
- English observation: `A tall tapered curved stroke has a short right
  branch and a thin lower-left descending stroke.`
- 中文观察: `高而收窄的弯曲笔有右侧短分枝和左下方纤细下行笔。`
...
- dataset label text: `㢨`
- dataset label codepoints: `U+38A8`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00100`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00100`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00100`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/100_obs-evo-can
  d-000100_evobc-cat-00100_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/100_obs-evo-cand-000100_evobc-cat-00100_evolu
...
- Which source records identify obs-char-001075 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001075？
