# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004892
...
- EVOBC candidate category: `evobc-evo-cat-04892`.
- Source label for search only: `潏`.
- Source codepoints for search only: `U+6F4F`.
