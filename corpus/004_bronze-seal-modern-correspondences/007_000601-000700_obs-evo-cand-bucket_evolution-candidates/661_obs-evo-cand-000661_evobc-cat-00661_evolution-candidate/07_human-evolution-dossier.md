...
- Project ID: `obs-evo-cand-000661`
- EVOBC category candidate ID: `evobc-evo-cat-00661`
- External category reference: `evobc-cat-00661`
- Source category ID: `00661`
- Source label for human review: `乏`
- Source codepoints: `U+4E4F`
...
- `obs-evo-cand-000661-route-category-staging`
...
- `obs-evo-cand-000661-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000661-route-evolution-graph`
