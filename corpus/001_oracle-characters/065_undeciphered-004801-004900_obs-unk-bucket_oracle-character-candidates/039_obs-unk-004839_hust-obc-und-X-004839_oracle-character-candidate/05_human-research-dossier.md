# obs-unk-004839 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004839`
- primary external id: `hust-obc-und-X-004839`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/039_obs-unk-004839_h
  ust-obc-und-X-004839_oracle-character-candidate/03_visual-assets/001_asset
  -006432_hust-obc-und-X-004839_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/395/X_？_7379_1.png`
- asset id: `asset-006432`
...
- source class: `HUST-OBC/undeciphered/X/395/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/395/X_？_7379_1.png`
- asset id: `asset-006432`
...
- English observation: `two upper groups and broad lower opening`
- 中文观察: `上部两个结构和下部宽大开口`
...
- Which source records identify obs-unk-004839 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004839？
