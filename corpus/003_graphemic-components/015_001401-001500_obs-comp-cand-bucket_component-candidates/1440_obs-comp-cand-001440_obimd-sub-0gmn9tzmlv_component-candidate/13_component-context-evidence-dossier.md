# obs-comp-cand-001440 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001440`
- 首选外部 ID: `obimd-sub-0gmn9tzmlv`
- OBIMD subcharacter UID: `0gmn9tzmlv`
- OBIMD main character UID: `0gmn9tzmlv`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+29C47;U+F841A; U+F841B
