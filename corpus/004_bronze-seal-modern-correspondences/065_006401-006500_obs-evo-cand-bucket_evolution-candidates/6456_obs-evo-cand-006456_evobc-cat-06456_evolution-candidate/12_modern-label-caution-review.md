# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006456
...
- EVOBC candidate category: `evobc-evo-cat-06456`.
- Source label for search only: `純`.
- Source codepoints for search only: `U+7D14`.
