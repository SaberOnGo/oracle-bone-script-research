# Material Visual Observation / obs-comp-cand-002628 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002628`
- External reference / 外部参照: `obimd-sub-b1pjnbqrdr`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021167_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/b1pjnbqrdr/b1pjnbqrdr/b1pjnbqrdr.png`
- Checksum / 校验和:
  `36b531856e9963e52ddbcfc3e14a0b33ecdd7fa87024d9671203583f6029f231`
...
- Marked-pixel bounds: (80,23)–(173,227); span 94 × 205 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.38%。
- 痕迹范围：(80,23)–(173,227)；跨度94 × 205 px；痕迹矩形高于宽。
