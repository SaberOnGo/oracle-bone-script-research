# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001752
...
| --- | --- | --- | --- |
| `obimd-glyph-link-027000` | 򤌰󺈚 | `U+A4330;U+FA21A` | `reviewed_metadata_only` |
| `obimd-glyph-link-027001` | 󺈛 | `U+FA21B` | `reviewed_metadata_only` |
