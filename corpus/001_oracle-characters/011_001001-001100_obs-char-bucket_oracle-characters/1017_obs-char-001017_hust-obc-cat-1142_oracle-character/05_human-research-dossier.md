# obs-char-001017 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1017_obs-char-001017_hust-obc-cat-1142_ora
  cle-character/03_visual-assets/001_asset-001022_hust-obc-cat-1142_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1142/G_1142_乙333.png`
- asset id: `asset-001022`
...
- source category: `1142`
- validation class: `1016`
- source image route: `HUST-OBC/deciphered/1142/G_1142_乙333.png`
- asset id: `asset-001022`
...
- dataset label text: `㡬`
- dataset label codepoints: `U+386C`
...
- Which source records identify obs-char-001017 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001017？
