# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002401
...
| --- | --- | --- | --- |
| `obimd-glyph-link-036817` | 򩂭򩄲󽭧 | `U+A90AD;U+A9132;U+FDB67` | `reviewed_metadata_only` |
| `obimd-glyph-link-036818` | 󽭨 | `U+FDB68` | `reviewed_metadata_only` |
| `obimd-glyph-link-036819` | 󽭩 | `U+FDB69` | `reviewed_metadata_only` |
