...
Project ID: `obs-evo-cand-005860`
...
- Project ID: `obs-evo-cand-005860`
- EVOBC category candidate ID: `evobc-evo-cat-05860`
- External category reference: `evobc-cat-05860`
- Source category ID: `05860`
- Source label for human review: `瞴`
- Source codepoints: `U+77B4`
...
- `obs-evo-cand-005860-route-category-staging`
...
- `obs-evo-cand-005860-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005860-route-evolution-graph`
