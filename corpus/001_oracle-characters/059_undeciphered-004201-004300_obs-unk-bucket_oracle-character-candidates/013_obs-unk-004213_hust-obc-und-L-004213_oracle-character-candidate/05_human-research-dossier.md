# obs-unk-004213 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004213`
- primary external id: `hust-obc-und-L-004213`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/013_obs-unk-004213_h
  ust-obc-und-L-004213_oracle-character-candidate/03_visual-assets/001_asset
  -005806_hust-obc-und-L-004213_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4213/L_？_9192.jpg`
- asset id: `asset-005806`
...
- source class: `HUST-OBC/undeciphered/L/4213/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4213/L_？_9192.jpg`
- asset id: `asset-005806`
...
- English observation: `Upper frame, inner bar, lower central trace visible.`
- 中文观察: `上部框状轮廓、内部横痕和下部中央痕迹可见。`
...
- Which source records identify obs-unk-004213 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004213？
