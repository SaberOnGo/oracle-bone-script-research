...
- External category reference: `evobc-cat-01762`
- Source category ID: `01762`
- Source label for human review: `囩`
- Source codepoints: `U+56E9`
...
- `obs-evo-cand-001762-route-category-staging`
...
- `obs-evo-cand-001762-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001762-route-evolution-graph`
