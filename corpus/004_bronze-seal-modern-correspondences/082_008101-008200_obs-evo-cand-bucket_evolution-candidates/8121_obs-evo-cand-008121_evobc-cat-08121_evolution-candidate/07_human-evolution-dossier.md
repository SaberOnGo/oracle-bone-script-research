...
- External category reference: `evobc-cat-08121`
- Source category ID: `08121`
- Source label for human review: `言`
...
- `obs-evo-cand-008121-route-category-staging`
...
- `obs-evo-cand-008121-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008121-route-evolution-graph`
