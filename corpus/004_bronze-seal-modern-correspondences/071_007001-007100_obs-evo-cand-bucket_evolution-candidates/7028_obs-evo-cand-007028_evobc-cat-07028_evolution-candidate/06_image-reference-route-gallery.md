...
- `obs-evo-cand-007028-route-category-staging`
...
- `obs-evo-cand-007028-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007028-route-evolution-graph`
