...
Project ID: `obs-insc-cw-cand-000507`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000507`
...
- Source page section: `Period IV Group 17` /
  `第 IV 期第 17 组`
- Source section key: `period-iv-group-17`
...
- Yingguo / 英国所藏: `y2466` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `325` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `393` in source row; primary catalog entry pending
- Heji / 合集: `41303` in source row; primary catalog entry pending
...
- Findspot / 出土地: 待查: excavation or findspot evidence for the physical
  object
- Period / 时期: `IV` from source metadata; not a new dating
- Group and batch / 组类与批次: group `17`; batch or pit context pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000507`
