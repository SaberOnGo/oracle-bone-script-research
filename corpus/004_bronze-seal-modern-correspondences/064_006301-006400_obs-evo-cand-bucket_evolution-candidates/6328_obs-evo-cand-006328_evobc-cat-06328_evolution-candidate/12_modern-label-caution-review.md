# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006328
...
- EVOBC candidate category: `evobc-evo-cat-06328`.
- Source label for search only: `篪`.
- Source codepoints for search only: `U+7BEA`.
