# Material Visual Observation / obs-comp-cand-002193 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002193`
- External reference / 外部参照: `obimd-sub-n3oe6amcoo`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019899_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/n3oe6amcoo/n3oe6amcoo/n3oe6amcoo.png`
- Checksum / 校验和:
  `b2118255f9bb25e2056c6bbee182c6d1d8eae1e10bc67f8b4b325fb4b93cb4fa`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.96%.
- Marked-pixel bounds: (63,40)–(186,202); span 124 × 163 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.96%。
- 痕迹范围：(63,40)–(186,202)；跨度124 × 163 px；痕迹矩形高于宽。
