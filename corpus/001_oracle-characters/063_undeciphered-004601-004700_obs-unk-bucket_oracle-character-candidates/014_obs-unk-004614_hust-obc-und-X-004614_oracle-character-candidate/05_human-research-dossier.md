# obs-unk-004614 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004614`
- primary external id: `hust-obc-und-X-004614`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/014_obs-unk-004614_h
  ust-obc-und-X-004614_oracle-character-candidate/03_visual-assets/001_asset
  -006207_hust-obc-und-X-004614_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/170/X_？_8345_1.png`
- asset id: `asset-006207`
...
- source class: `HUST-OBC/undeciphered/X/170/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/170/X_？_8345_1.png`
- asset id: `asset-006207`
...
- English observation: `upper loops, central junction, lower open curve`
- 中文观察: `上部环状形体、中央交接点和下部弯曲痕已记录。`
...
- Which source records identify obs-unk-004614 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004614？
