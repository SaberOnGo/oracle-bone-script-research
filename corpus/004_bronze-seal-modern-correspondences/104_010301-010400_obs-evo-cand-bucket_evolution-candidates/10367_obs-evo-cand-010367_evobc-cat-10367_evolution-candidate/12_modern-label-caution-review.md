# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010367
...
- EVOBC candidate category: `evobc-evo-cat-10367`.
- Source label for search only: `魚`.
- Source codepoints for search only: `U+9B5A`.
