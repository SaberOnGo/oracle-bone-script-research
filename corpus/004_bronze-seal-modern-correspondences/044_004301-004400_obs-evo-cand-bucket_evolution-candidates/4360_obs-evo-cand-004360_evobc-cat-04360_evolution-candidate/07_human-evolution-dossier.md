...
- External category reference: `evobc-cat-04360`
- Source category ID: `04360`
- Source label for human review: `歁`
- Source codepoints: `U+6B41`
...
- `obs-evo-cand-004360-route-category-staging`
...
- `obs-evo-cand-004360-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004360-route-evolution-graph`
