...
- External category reference: `evobc-cat-00119`
- Source category ID: `00119`
- Source label for human review: `㤵`
- Source codepoints: `U+3935`
...
- `obs-evo-cand-000119-route-category-staging`
...
- `obs-evo-cand-000119-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000119-route-evolution-graph`
