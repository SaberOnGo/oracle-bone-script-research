# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012760
...
- EVOBC candidate category: `evobc-evo-cat-12760`.
- Source label for search only: `𪒜`.
- Source codepoints for search only: `U+2A49C`.
