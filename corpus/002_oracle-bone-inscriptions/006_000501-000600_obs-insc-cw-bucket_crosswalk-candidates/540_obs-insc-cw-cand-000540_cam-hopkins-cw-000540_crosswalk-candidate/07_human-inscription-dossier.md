...
- Yingguo / 英国所藏: `y2542` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `375` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `742` in source row; primary catalog entry pending
- Heji / 合集: `41802` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000540`
