# obs-unk-008276 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/099_undeciphered-008
  201-008300_obs-unk-bucket_oracle-character-candidates/076_obs-unk-008276_h
  ust-obc-und-YH-008276_oracle-character-candidate/03_visual-assets/001_asse
  t-009867_hust-obc-und-YH-008276_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6093C/H_？_6093C_0.png`
- asset id: `asset-009867`
...
- source class: `HUST-OBC/undeciphered/Y+H/6093C/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6093C/H_？_6093C_0.png`
- asset id: `asset-009867`
...
- Which source records identify obs-unk-008276 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008276？
