# Material Visual Observation / obs-comp-cand-000308 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000308`
- External reference / 外部参照: `obimd-sub-3uiwedg1ki`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012170_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3uiwedg1ki/3uiwedg1ki/3uiwedg1ki.png`
- Checksum / 校验和:
  `8c303aa31513c43887ca2fbe81192e4c4ac9127fca203dcf51690d6151150bc3`
...
- Marked-pixel bounds: (66,22)–(183,224); span 118 × 203 px; the marked
...
- 痕迹范围：(66,22)–(183,224)；跨度118 × 203 px；痕迹矩形高于宽。
