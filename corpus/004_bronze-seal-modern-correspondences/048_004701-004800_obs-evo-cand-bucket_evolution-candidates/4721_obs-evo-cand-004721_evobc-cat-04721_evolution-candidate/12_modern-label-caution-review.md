# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004721
...
- EVOBC candidate category: `evobc-evo-cat-04721`.
- Source label for search only: `淜`.
- Source codepoints for search only: `U+6DDC`.
