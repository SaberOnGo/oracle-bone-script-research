# Material Visual Observation / obs-comp-cand-001339 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001339`
- External reference / 外部参照: `obimd-sub-ndlvxfb2d5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015722_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ar259dtulv/ndlvxfb2d5/ndlvxfb2d5.png`
- Checksum / 校验和:
  `801599025ddff5bf25b26b5dfd4e241e311dbac791215cd3e396b20f51c2eab7`
...
- Marked-pixel bounds: (88,35)–(161,208); span 74 × 174 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.65%。
- 痕迹范围：(88,35)–(161,208)；跨度74 × 174 px；痕迹矩形高于宽。
