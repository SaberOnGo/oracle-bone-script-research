...
- External category reference: `evobc-cat-00199`
- Source category ID: `00199`
- Source label for human review: `㲃`
...
- `obs-evo-cand-000199-route-category-staging`
...
- `obs-evo-cand-000199-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000199-route-evolution-graph`
