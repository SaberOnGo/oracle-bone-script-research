...
- Yingguo / 英国所藏: `y2545` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `369` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `577` in source row; primary catalog entry pending
- Heji / 合集: `41829` in source row; primary catalog entry pending
