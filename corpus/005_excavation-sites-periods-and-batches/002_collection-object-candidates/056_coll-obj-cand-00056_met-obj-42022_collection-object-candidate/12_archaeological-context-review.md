# Archaeological Context Review / 考古语境复核: coll-obj-cand-00056
...
| Catalog or accession | `18.56.71` | `02_collection-source-index.csv` |
| Source item | `42022` | `01_collection-object-packet.json` |
| Catalog description | `Oracle Bone Fragment` | `01_collection-object-packet.json` |
