# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001640
...
| --- | --- | --- | --- |
| `obimd-glyph-link-025332` | 󹠵 | `U+F9835` | `reviewed_metadata_only` |
| `obimd-glyph-link-025333` | 󹠶 | `U+F9836` | `reviewed_metadata_only` |
| `obimd-glyph-link-025334` | 󹠷 | `U+F9837` | `reviewed_metadata_only` |
