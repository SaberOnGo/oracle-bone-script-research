# Material Visual Observation / obs-comp-cand-002503 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002503`
- External reference / 外部参照: `obimd-sub-zz00qbgu3m`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020767_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zz00qbgu3m/zz00qbgu3m/9yx8phkl83.png`
- Checksum / 校验和:
  `0cb7c5601be1480b0cc5b191b7f98689ef8176333f6278a7e479d31b0da24c41`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.50%.
- Marked-pixel bounds: (46,93)–(203,160); span 158 × 68 px; the marked rectangle
  is wider than tall.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.50%。
- 痕迹范围：(46,93)–(203,160)；跨度158 × 68 px；痕迹矩形宽于高。
