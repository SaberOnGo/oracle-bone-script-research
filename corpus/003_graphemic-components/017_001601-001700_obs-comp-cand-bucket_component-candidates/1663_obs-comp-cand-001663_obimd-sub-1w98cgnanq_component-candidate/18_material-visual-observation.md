# Material Visual Observation / obs-comp-cand-001663 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001663`
- External reference / 外部参照: `obimd-sub-1w98cgnanq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017339_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1w98cgnanq/1w98cgnanq/1w98cgnanq.png`
- Checksum / 校验和:
  `a79cad4451525af0c302c8119cb347c02b282b937cd5c458ef6c6c233a9b92ab`
...
- Marked-pixel bounds: (60,47)–(177,199); span 118 × 153 px; the marked
...
- 痕迹范围：(60,47)–(177,199)；跨度118 × 153 px；痕迹矩形高于宽。
