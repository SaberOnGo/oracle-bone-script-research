# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002625
...
- EVOBC candidate category: `evobc-evo-cat-02625`.
- Source label for search only: `已`.
- Source codepoints for search only: `U+5DF2`.
