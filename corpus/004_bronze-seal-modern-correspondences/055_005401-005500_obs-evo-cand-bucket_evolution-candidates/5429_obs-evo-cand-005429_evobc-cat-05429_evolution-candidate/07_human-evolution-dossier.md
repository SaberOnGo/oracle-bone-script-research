...
Project ID: `obs-evo-cand-005429`
...
- Project ID: `obs-evo-cand-005429`
- EVOBC category candidate ID: `evobc-evo-cat-05429`
- External category reference: `evobc-cat-05429`
- Source category ID: `05429`
- Source label for human review: `瑀`
- Source codepoints: `U+7440`
...
- `obs-evo-cand-005429-route-category-staging`
...
- `obs-evo-cand-005429-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005429-route-evolution-graph`
