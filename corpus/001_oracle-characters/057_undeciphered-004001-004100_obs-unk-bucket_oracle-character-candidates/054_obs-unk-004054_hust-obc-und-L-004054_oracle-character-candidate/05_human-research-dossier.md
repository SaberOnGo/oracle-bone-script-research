# obs-unk-004054 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/054_obs-unk-004054_h
  ust-obc-und-L-004054_oracle-character-candidate/03_visual-assets/001_asset
  -005647_hust-obc-und-L-004054_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4054/L_？_8669.jpg`
- asset id: `asset-005647`
...
- source class: `HUST-OBC/undeciphered/L/4054/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4054/L_？_8669.jpg`
- asset id: `asset-005647`
...
- English observation: A long curved contour runs down the left side. Short
  upper traces extend toward the right, while a darker rounded mark occupies
  the lower right. The connections between these areas remain uncertain.
...
- Which source records identify obs-unk-004054 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004054？
