...
- External category reference: `evobc-cat-01868`
- Source category ID: `01868`
- Source label for human review: `埂`
- Source codepoints: `U+57C2`
...
- `obs-evo-cand-001868-route-category-staging`
...
- `obs-evo-cand-001868-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001868-route-evolution-graph`
