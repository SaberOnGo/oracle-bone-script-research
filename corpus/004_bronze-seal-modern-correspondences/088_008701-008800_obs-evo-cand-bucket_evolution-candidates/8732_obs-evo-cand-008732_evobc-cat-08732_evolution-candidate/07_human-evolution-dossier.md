...
- External category reference: `evobc-cat-08732`
- Source category ID: `08732`
- Source label for human review: `踝`
- Source codepoints: `U+8E1D`
...
- `obs-evo-cand-008732-route-category-staging`
...
- `obs-evo-cand-008732-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008732-route-evolution-graph`
