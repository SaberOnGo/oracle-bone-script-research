...
- External category reference: `evobc-cat-11492`
- Source category ID: `11492`
- Source label: `𣪙`
...
- `obs-evo-cand-011492-route-category-staging`
...
- `obs-evo-cand-011492-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011492-route-evolution-graph`
