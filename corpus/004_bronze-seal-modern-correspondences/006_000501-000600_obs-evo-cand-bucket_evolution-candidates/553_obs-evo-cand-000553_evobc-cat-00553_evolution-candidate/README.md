# obs-evo-cand-000553 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-000553`
- EVOBC category candidate ID: `evobc-evo-cat-00553`
- External category ref: `evobc-cat-00553`
- Source label: `䬦`
- Source codepoints: `U+4B26`
- Image reference count: `53`
- Era token counts: `BI:53`
- Source token counts: `Web:53`
