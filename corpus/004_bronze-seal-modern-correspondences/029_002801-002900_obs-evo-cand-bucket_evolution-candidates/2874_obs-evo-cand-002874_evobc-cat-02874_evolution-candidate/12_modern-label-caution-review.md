# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002874
...
- EVOBC candidate category: `evobc-evo-cat-02874`.
- Source label for search only: `徛`.
- Source codepoints for search only: `U+5F9B`.
