# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013547
...
- EVOBC candidate category: `evobc-evo-cat-13547`.
- Source label for search only: `𭦡`.
- Source codepoints for search only: `U+2D9A1`.
