...
Project ID: `obs-evo-cand-013125`
...
- Project ID: `obs-evo-cand-013125`
- EVOBC category candidate ID: `evobc-evo-cat-13125`
- External category reference: `evobc-cat-13125`
- Source category ID: `13125`
- Source label for human review: `𫷼`
- Source codepoints: `U+2BDFC`
...
- `obs-evo-cand-013125-route-category-staging`
...
- `obs-evo-cand-013125-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013125-route-evolution-graph`
