...
- External category reference: `evobc-cat-11187`
- Source category ID: `11187`
- Source label for human review: `𢐩`
- Source codepoints: `U+22429`
...
- `obs-evo-cand-011187-route-category-staging`
...
- `obs-evo-cand-011187-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011187-route-evolution-graph`
