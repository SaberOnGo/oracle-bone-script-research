...
- External category reference: `evobc-cat-05280`
- Source category ID: `05280`
- Source label for human review: `狷`
- Source codepoints: `U+72F7`
...
- `obs-evo-cand-005280-route-category-staging`
...
- `obs-evo-cand-005280-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005280-route-evolution-graph`
