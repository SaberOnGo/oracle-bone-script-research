# obs-char-000076 Archaeology Paleography Review

# obs-char-000076 考古文字复核档案
...
- first local image: `001_asset-000081_hust-obc-cat-0086_glyph.png`
- first source image: `G_0086_前6.2.3(甲).png`
...
- source label text: `㑌`
- source label codepoints: `U+344C`
