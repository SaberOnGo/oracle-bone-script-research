# obs-unk-004302 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/002_obs-unk-004302_h
  ust-obc-und-L-004302_oracle-character-candidate/03_visual-assets/001_asset
  -005895_hust-obc-und-L-004302_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4302/L_？_9497.jpg`
- asset id: `asset-005895`
...
- source class: `HUST-OBC/undeciphered/L/4302/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4302/L_？_9497.jpg`
- asset id: `asset-005895`
...
- English observation: `Central oval, side bars, lower mark visible.`
- 中文观察: `中央椭圆轮廓、两侧横痕和下部标记可见。`
...
- Which source records identify obs-unk-004302 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004302？
