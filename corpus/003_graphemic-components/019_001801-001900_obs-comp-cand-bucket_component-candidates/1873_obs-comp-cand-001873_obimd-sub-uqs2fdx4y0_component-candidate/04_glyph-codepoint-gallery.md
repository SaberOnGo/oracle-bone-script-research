# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001873
...
| --- | --- | --- | --- |
| `obimd-glyph-link-028453` | 򮝍󺟹 | `U+AE74D;U+FA7F9` | `reviewed_metadata_only` |
| `obimd-glyph-link-028454` | 󺭱 | `U+FAB71` | `reviewed_metadata_only` |
| `obimd-glyph-link-028455` | 󺭲 | `U+FAB72` | `reviewed_metadata_only` |
| `obimd-glyph-link-028456` | 󺭳 | `U+FAB73` | `reviewed_metadata_only` |
| `obimd-glyph-link-028457` | 󺭴 | `U+FAB74` | `reviewed_metadata_only` |
