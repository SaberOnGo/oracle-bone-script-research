# Material Visual Observation / obs-comp-cand-000145 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000145`
- External reference / 外部参照: `obimd-sub-7tszx5wu4p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011557_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7tszx5wu4p/7tszx5wu4p/7tszx5wu4p.png`
- Checksum / 校验和:
  `d5705019af83cb1d016df03aea4fe19d353987c235a7d3ee0465c3f07390c6f5`
...
- Marked-pixel bounds: (56,38)–(212,208); span 157 × 171 px; the marked
...
- 痕迹范围：(56,38)–(212,208)；跨度157 × 171 px；痕迹矩形近方形。
