...
- Project ID: `obs-evo-cand-008769`
- EVOBC category candidate ID: `evobc-evo-cat-08769`
- External category reference: `evobc-cat-08769`
- Source category ID: `08769`
- Source label for human review: `蹮`
- Source codepoints: `U+8E6E`
...
- `obs-evo-cand-008769-route-category-staging`
...
- `obs-evo-cand-008769-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008769-route-evolution-graph`
