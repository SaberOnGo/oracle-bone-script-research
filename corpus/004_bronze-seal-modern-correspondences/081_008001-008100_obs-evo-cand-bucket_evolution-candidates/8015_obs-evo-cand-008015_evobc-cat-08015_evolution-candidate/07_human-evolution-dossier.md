...
- External category reference: `evobc-cat-08015`
- Source category ID: `08015`
- Source label for human review: `褫`
...
- `obs-evo-cand-008015-route-category-staging`
...
- `obs-evo-cand-008015-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008015-route-evolution-graph`
