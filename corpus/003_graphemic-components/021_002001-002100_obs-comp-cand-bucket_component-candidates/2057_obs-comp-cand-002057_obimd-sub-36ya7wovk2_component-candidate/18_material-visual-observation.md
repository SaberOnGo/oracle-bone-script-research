# Material Visual Observation / obs-comp-cand-002057 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002057`
- External reference / 外部参照: `obimd-sub-36ya7wovk2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019444_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/iuouekyjwj/36ya7wovk2/36ya7wovk2.png`
- Checksum / 校验和:
  `485ea5889ba4208a0be10aae1af2dd24db19c863ff8914922f8755f3ebcf9e48`
...
- Marked-pixel bounds: (63,24)–(207,220); span 145 × 197 px; the marked
...
- 痕迹范围：(63,24)–(207,220)；跨度145 × 197 px；痕迹矩形高于宽。
