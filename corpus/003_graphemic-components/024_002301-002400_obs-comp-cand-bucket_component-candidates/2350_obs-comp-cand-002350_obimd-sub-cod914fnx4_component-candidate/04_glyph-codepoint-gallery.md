# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002350
...
| --- | --- | --- | --- |
| `obimd-glyph-link-036085` | 򽢍󽝀 | `U+BD88D;U+FD740` | `reviewed_metadata_only` |
| `obimd-glyph-link-036086` | 󽝂 | `U+FD742` | `reviewed_metadata_only` |
| `obimd-glyph-link-036087` | 󽝃 | `U+FD743` | `reviewed_metadata_only` |
