# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006743
...
- EVOBC candidate category: `evobc-evo-cat-06743`.
- Source label for search only: `绊`.
- Source codepoints for search only: `U+7ECA`.
