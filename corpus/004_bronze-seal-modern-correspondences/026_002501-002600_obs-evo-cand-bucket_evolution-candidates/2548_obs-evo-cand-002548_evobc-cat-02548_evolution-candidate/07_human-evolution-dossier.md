...
- Project ID: `obs-evo-cand-002548`
- EVOBC category candidate ID: `evobc-evo-cat-02548`
- External category reference: `evobc-cat-02548`
- Source category ID: `02548`
- Source label for human review: `岵`
- Source codepoints: `U+5CB5`
...
- `obs-evo-cand-002548-route-category-staging`
...
- `obs-evo-cand-002548-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002548-route-evolution-graph`
