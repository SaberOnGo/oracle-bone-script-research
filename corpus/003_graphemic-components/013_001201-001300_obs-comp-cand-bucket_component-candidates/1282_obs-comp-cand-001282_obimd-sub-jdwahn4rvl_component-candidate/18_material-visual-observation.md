# Material Visual Observation / obs-comp-cand-001282 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001282`
- External reference / 外部参照: `obimd-sub-jdwahn4rvl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015567_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/31gq0i3w4d/jdwahn4rvl/jdwahn4rvl.png`
- Checksum / 校验和:
  `e465469c9e19e7d7ddede61121a614816b0b9c7309dfbf158180b09e78b62da2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.93%.
- Marked-pixel bounds: (68,23)–(181,225); span 114 × 203 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.93%。
- 痕迹范围：(68,23)–(181,225)；跨度114 × 203 px；痕迹矩形高于宽。
