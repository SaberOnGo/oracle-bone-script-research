...
- External category reference: `evobc-cat-02938`
- Source category ID: `02938`
- Source label for human review: `怚`
- Source codepoints: `U+601A`
...
- `obs-evo-cand-002938-route-category-staging`
...
- `obs-evo-cand-002938-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002938-route-evolution-graph`
