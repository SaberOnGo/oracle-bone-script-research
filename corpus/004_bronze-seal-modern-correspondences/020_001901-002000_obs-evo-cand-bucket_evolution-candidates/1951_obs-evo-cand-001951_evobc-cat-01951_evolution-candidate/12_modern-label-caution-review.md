# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001951
...
- EVOBC candidate category: `evobc-evo-cat-01951`.
- Source label for search only: `墽`.
- Source codepoints for search only: `U+58BD`.
