...
Project ID: `obs-evo-cand-008369`
...
- Project ID: `obs-evo-cand-008369`
- EVOBC category candidate ID: `evobc-evo-cat-08369`
- External category reference: `evobc-cat-08369`
- Source category ID: `08369`
- Source label for human review: `譬`
- Source codepoints: `U+8B6C`
...
- `obs-evo-cand-008369-route-category-staging`
...
- `obs-evo-cand-008369-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008369-route-evolution-graph`
