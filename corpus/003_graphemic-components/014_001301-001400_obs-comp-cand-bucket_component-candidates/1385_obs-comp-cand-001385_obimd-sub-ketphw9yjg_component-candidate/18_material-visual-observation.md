# Material Visual Observation / obs-comp-cand-001385 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001385`
- External reference / 外部参照: `obimd-sub-ketphw9yjg`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015804_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/otyf9c85b1/ketphw9yjg/ketphw9yjg.png`
- Checksum / 校验和:
  `29b7c4f8ab82773fbc8208ae163eff50c8cc10aabee705ce270b3593173946e4`
...
- Marked-pixel bounds: (85,18)–(155,230); span 71 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.88%。
- 痕迹范围：(85,18)–(155,230)；跨度71 × 213 px；痕迹矩形高于宽。
