...
Project ID: `obs-evo-cand-010405`
...
- Project ID: `obs-evo-cand-010405`
- EVOBC category candidate ID: `evobc-evo-cat-10405`
- External category reference: `evobc-cat-10405`
- Source category ID: `10405`
- Source label for human review: `鮸`
- Source codepoints: `U+9BB8`
...
- `obs-evo-cand-010405-route-category-staging`
...
- `obs-evo-cand-010405-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010405-route-evolution-graph`
