...
Project ID: `obs-insc-cw-cand-000095`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000095`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000095` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y564` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `93` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `522` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `39868` [route_present_image_or_text_not_collected]
