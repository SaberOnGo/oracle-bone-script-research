# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010393
...
- EVOBC candidate category: `evobc-evo-cat-10393`.
- Source label for search only: `鮚`.
- Source codepoints for search only: `U+9B9A`.
