# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001563
...
| --- | --- | --- | --- |
| `obimd-glyph-link-024366` | 󹉄 | `U+F9244` | `reviewed_metadata_only` |
| `obimd-glyph-link-024367` | 󹉅 | `U+F9245` | `reviewed_metadata_only` |
| `obimd-glyph-link-024368` | 󹉆 | `U+F9246` | `reviewed_metadata_only` |
| `obimd-glyph-link-024369` | 󹉇 | `U+F9247` | `reviewed_metadata_only` |
| `obimd-glyph-link-024370` | 󹉈 | `U+F9248` | `reviewed_metadata_only` |
