...
- Project ID: `obs-evo-cand-007032`
- EVOBC category candidate ID: `evobc-evo-cat-07032`
- External category reference: `evobc-cat-07032`
- Source category ID: `07032`
- Source label for human review: `胜`
- Source codepoints: `U+80DC`
...
- `obs-evo-cand-007032-route-category-staging`
...
- `obs-evo-cand-007032-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007032-route-evolution-graph`
