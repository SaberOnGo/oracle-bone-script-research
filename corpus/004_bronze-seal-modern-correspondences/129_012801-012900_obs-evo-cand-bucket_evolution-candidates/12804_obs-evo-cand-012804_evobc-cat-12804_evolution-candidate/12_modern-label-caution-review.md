# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012804
...
- EVOBC candidate category: `evobc-evo-cat-12804`.
- Source label for search only: `𪠍`.
- Source codepoints for search only: `U+2A80D`.
