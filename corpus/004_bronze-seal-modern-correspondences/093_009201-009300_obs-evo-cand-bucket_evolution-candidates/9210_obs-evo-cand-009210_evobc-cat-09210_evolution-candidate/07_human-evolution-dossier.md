...
- External category reference: `evobc-cat-09210`
- Source category ID: `09210`
- Source label for human review: `鄩`
- Source codepoints: `U+9129`
...
- `obs-evo-cand-009210-route-category-staging`
...
- `obs-evo-cand-009210-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009210-route-evolution-graph`
