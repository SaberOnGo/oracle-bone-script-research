# Material Visual Observation / obs-comp-cand-001355 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001355`
- External reference / 外部参照: `obimd-sub-b1ojfpwayk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015744_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/b1ojfpwayk/b1ojfpwayk/b1ojfpwayk.png`
- Checksum / 校验和:
  `b9e392e87d3244249f129ee2815cadddbc0e927f5dd6b52b40308b43370c77fd`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.89%.
- Marked-pixel bounds: (62,47)–(187,200); span 126 × 154 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.89%。
- 痕迹范围：(62,47)–(187,200)；跨度126 × 154 px；痕迹矩形高于宽。
