# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002924
...
- EVOBC candidate category: `evobc-evo-cat-02924`.
- Source label for search only: `忼`.
- Source codepoints for search only: `U+5FFC`.
