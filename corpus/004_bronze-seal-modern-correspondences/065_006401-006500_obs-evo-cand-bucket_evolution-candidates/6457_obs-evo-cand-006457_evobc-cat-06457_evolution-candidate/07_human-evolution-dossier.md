...
- External category reference: `evobc-cat-06457`
- Source category ID: `06457`
- Source label for human review: `紕`
- Source codepoints: `U+7D15`
...
- `obs-evo-cand-006457-route-category-staging`
...
- `obs-evo-cand-006457-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006457-route-evolution-graph`
