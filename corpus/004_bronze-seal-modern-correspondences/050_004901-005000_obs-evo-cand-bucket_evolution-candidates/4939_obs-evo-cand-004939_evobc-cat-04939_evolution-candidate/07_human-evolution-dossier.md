...
Project ID: `obs-evo-cand-004939`
...
- Project ID: `obs-evo-cand-004939`
- EVOBC category candidate ID: `evobc-evo-cat-04939`
- External category reference: `evobc-cat-04939`
- Source category ID: `04939`
- Source label for human review: `澥`
- Source codepoints: `U+6FA5`
...
- `obs-evo-cand-004939-route-category-staging`
...
- `obs-evo-cand-004939-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004939-route-evolution-graph`
