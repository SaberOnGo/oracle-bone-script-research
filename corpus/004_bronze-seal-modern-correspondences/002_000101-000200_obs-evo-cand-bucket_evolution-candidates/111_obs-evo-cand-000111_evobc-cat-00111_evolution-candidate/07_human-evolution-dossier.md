...
Project ID: `obs-evo-cand-000111`
...
- Project ID: `obs-evo-cand-000111`
- EVOBC category candidate ID: `evobc-evo-cat-00111`
- External category reference: `evobc-cat-00111`
- Source category ID: `00111`
- Source label for human review: `㣻`
- Source codepoints: `U+38FB`
...
- `obs-evo-cand-000111-route-category-staging`
...
- `obs-evo-cand-000111-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000111-route-evolution-graph`
