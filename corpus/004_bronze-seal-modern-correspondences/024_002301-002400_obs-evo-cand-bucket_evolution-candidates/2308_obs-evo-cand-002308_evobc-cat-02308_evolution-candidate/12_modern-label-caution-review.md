# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002308
...
- EVOBC candidate category: `evobc-evo-cat-02308`.
- Source label for search only: `嬭`.
- Source codepoints for search only: `U+5B2D`.
