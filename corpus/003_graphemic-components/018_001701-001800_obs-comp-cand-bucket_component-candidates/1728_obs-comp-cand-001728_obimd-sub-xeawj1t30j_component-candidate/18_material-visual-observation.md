# Material Visual Observation / obs-comp-cand-001728 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001728`
- External reference / 外部参照: `obimd-sub-xeawj1t30j`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017913_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xeawj1t30j/xeawj1t30j/xeawj1t30j.png`
- Checksum / 校验和:
  `5a12721676b583a092aef374776d6f22a803ba152b20f86680312f0f772a82bb`
...
- Marked-pixel bounds: (75,62)–(173,181); span 99 × 120 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.83%。
- 痕迹范围：(75,62)–(173,181)；跨度99 × 120 px；痕迹矩形高于宽。
