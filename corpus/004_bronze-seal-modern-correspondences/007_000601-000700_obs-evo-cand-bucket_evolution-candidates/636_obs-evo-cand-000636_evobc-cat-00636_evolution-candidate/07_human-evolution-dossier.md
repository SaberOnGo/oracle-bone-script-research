...
- External category reference: `evobc-cat-00636`
- Source category ID: `00636`
- Source label for human review: `丮`
- Source codepoints: `U+4E2E`
...
- `obs-evo-cand-000636-route-category-staging`
...
- `obs-evo-cand-000636-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000636-route-evolution-graph`
