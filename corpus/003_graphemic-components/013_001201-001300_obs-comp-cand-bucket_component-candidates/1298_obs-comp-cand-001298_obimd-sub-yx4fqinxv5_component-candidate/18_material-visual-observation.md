# Material Visual Observation / obs-comp-cand-001298 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001298`
- External reference / 外部参照: `obimd-sub-yx4fqinxv5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015635_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2sdz63p9g6/yx4fqinxv5/yx4fqinxv5.png`
- Checksum / 校验和:
  `2e734599ae4f7a42070e6ff510f796e033a1d7877045956494499131d62454a7`
...
- Marked-pixel bounds: (88,44)–(172,206); span 85 × 163 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.34%。
- 痕迹范围：(88,44)–(172,206)；跨度85 × 163 px；痕迹矩形高于宽。
