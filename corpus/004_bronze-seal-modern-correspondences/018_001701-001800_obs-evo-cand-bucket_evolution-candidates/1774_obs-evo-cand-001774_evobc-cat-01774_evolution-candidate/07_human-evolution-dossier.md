...
- External category reference: `evobc-cat-01774`
- Source category ID: `01774`
- Source label for human review: `圃`
...
- `obs-evo-cand-001774-route-category-staging`
...
- `obs-evo-cand-001774-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001774-route-evolution-graph`
