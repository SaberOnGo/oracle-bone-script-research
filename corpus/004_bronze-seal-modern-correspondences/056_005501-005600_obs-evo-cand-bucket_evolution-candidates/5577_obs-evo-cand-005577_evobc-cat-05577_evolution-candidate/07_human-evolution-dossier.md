...
- External category reference: `evobc-cat-05577`
- Source category ID: `05577`
- Source label for human review: `畦`
- Source codepoints: `U+7566`
...
- `obs-evo-cand-005577-route-category-staging`
...
- `obs-evo-cand-005577-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005577-route-evolution-graph`
