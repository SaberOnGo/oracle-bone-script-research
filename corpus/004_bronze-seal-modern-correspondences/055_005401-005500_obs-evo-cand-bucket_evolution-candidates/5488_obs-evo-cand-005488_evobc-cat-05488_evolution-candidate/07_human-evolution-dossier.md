...
- Project ID: `obs-evo-cand-005488`
- EVOBC category candidate ID: `evobc-evo-cat-05488`
- External category reference: `evobc-cat-05488`
- Source category ID: `05488`
- Source label for human review: `璽`
- Source codepoints: `U+74BD`
...
- `obs-evo-cand-005488-route-category-staging`
...
- `obs-evo-cand-005488-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005488-route-evolution-graph`
