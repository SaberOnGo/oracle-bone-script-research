# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001012
...
| Glyph or codepoint route / 字形或码位路线 | 14 OBIMD route rows; examples U+F5B9C; U+F5B9D; 另有 12 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
