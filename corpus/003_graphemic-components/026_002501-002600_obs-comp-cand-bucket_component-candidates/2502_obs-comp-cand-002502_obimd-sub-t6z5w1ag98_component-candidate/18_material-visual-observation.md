# Material Visual Observation / obs-comp-cand-002502 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002502`
- External reference / 外部参照: `obimd-sub-t6z5w1ag98`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020766_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gvea18bccm/t6z5w1ag98/t6z5w1ag98.png`
- Checksum / 校验和:
  `7a320760232afdfb25e5065bab2b317ee8e42805299c844a6002a0d8b1f3682d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 2.89%.
- Marked-pixel bounds: (55,94)–(196,147); span 142 × 54 px; the marked rectangle
  is wider than tall.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占2.89%。
- 痕迹范围：(55,94)–(196,147)；跨度142 × 54 px；痕迹矩形宽于高。
