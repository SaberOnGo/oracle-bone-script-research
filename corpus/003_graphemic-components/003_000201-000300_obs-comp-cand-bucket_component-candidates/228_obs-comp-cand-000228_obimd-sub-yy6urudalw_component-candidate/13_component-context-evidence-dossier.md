# obs-comp-cand-000228 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000228`
- 首选外部 ID: `obimd-sub-yy6urudalw`
- OBIMD subcharacter UID: `yy6urudalw`
- OBIMD main character UID: `wko0jz3cod`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `8`
- codepoint 示例: U+F1541; U+F1542; 另有 6 项
