# Material Visual Observation / obs-comp-cand-000334 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000334`
- External reference / 外部参照: `obimd-sub-fzv0acj6pa`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012258_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fzv0acj6pa/fzv0acj6pa/fzv0acj6pa.png`
- Checksum / 校验和:
  `b026750506fa9c09c86c3292d77ea9b1f7589f509caca689cd28cc744ff80400`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.48%.
- Marked-pixel bounds: (41,27)–(208,220); span 168 × 194 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.48%。
- 痕迹范围：(41,27)–(208,220)；跨度168 × 194 px；痕迹矩形近方形。
