...
- External category reference: `evobc-cat-03144`
- Source category ID: `03144`
- Source label for human review: `憍`
- Source codepoints: `U+618D`
...
- `obs-evo-cand-003144-route-category-staging`
...
- `obs-evo-cand-003144-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003144-route-evolution-graph`
