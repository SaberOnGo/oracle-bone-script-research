# Material Visual Observation / obs-comp-cand-000263 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000263`
- External reference / 外部参照: `obimd-sub-vjeofagqay`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011909_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hoshv8o78k/vjeofagqay/vjeofagqay.png`
- Checksum / 校验和:
  `a38b477bc0e311c626ebffb2a988fd9544fd5287db2f06311d96de726cd8bcee`
...
- Marked-pixel bounds: (68,45)–(181,205); span 114 × 161 px; the marked
...
- 痕迹范围：(68,45)–(181,205)；跨度114 × 161 px；痕迹矩形高于宽。
