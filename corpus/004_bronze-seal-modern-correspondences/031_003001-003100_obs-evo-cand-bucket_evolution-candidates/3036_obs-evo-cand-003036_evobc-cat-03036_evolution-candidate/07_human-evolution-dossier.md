...
- External category reference: `evobc-cat-03036`
- Source category ID: `03036`
- Source label for human review: `惃`
- Source codepoints: `U+60C3`
...
- `obs-evo-cand-003036-route-category-staging`
...
- `obs-evo-cand-003036-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003036-route-evolution-graph`
