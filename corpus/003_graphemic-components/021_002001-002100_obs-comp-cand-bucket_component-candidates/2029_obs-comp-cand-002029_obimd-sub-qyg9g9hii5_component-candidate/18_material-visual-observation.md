# Material Visual Observation / obs-comp-cand-002029 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002029`
- External reference / 外部参照: `obimd-sub-qyg9g9hii5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019356_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qyg9g9hii5/qyg9g9hii5/qyg9g9hii5.png`
- Checksum / 校验和:
  `5d89f60fc14923c433744b281f0b77a37fcbf7fa4b5dfb1831672d8c5444668d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.48%.
- Marked-pixel bounds: (70,54)–(179,189); span 110 × 136 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.48%。
- 痕迹范围：(70,54)–(179,189)；跨度110 × 136 px；痕迹矩形高于宽。
