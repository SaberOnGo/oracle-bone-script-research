...
- External category reference: `evobc-cat-10465`
- Source category ID: `10465`
- Source label for human review: `鳏`
...
- `obs-evo-cand-010465-route-category-staging`
...
- `obs-evo-cand-010465-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010465-route-evolution-graph`
