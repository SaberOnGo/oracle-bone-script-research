...
Project ID: `obs-evo-cand-006233`
...
- Project ID: `obs-evo-cand-006233`
- EVOBC category candidate ID: `evobc-evo-cat-06233`
- External category reference: `evobc-cat-06233`
- Source category ID: `06233`
- Source label for human review: `笞`
- Source codepoints: `U+7B1E`
...
- `obs-evo-cand-006233-route-category-staging`
...
- `obs-evo-cand-006233-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006233-route-evolution-graph`
