# Material Visual Observation / obs-comp-cand-001898 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001898`
- External reference / 外部参照: `obimd-sub-5diuh9hkw7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018308_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5diuh9hkw7/5diuh9hkw7/5diuh9hkw7.png`
- Checksum / 校验和:
  `bd6900c92942c04a8a04e8a4a1f822732411bbba269ffd81199ffd293ea5bbb8`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.26%.
- Marked-pixel bounds: (56,27)–(194,225); span 139 × 199 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.26%。
- 痕迹范围：(56,27)–(194,225)；跨度139 × 199 px；痕迹矩形高于宽。
