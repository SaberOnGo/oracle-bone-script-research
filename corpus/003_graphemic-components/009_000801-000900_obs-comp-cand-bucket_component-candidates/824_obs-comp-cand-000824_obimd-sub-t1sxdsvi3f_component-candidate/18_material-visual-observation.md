# Material Visual Observation / obs-comp-cand-000824 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000824`
- External reference / 外部参照: `obimd-sub-t1sxdsvi3f`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013695_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/nnm6jhv5jz/t1sxdsvi3f/t1sxdsvi3f.png`
- Checksum / 校验和:
  `690ce3a9022ab1f4298b5a7b95fdd79d3660ad01b7f8a3787d847f9e5a5114c8`
...
- Marked-pixel bounds: (78,33)–(171,220); span 94 × 188 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.52%。
- 痕迹范围：(78,33)–(171,220)；跨度94 × 188 px；痕迹矩形高于宽。
