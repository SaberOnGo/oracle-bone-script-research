# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000285
...
| --- | --- | --- | --- |
| `obimd-glyph-link-003952` | 򻴒󱦢 | `U+BBD12;U+F19A2` | `reviewed_metadata_only` |
| `obimd-glyph-link-003953` | 󱦣 | `U+F19A3` | `reviewed_metadata_only` |
