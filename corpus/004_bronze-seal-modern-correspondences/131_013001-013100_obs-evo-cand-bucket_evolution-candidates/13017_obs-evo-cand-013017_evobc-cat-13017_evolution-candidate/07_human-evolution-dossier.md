...
- External category reference: `evobc-cat-13017`
- Source category ID: `13017`
- Source label for human review: `𫦄`
- Source codepoints: `U+2B984`
...
- `obs-evo-cand-013017-route-category-staging`
...
- `obs-evo-cand-013017-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013017-route-evolution-graph`
