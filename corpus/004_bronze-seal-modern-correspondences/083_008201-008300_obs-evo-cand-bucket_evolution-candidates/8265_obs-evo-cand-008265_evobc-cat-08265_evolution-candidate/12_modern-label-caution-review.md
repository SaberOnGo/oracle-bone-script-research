# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008265
...
- EVOBC candidate category: `evobc-evo-cat-08265`.
- Source label for search only: `請`.
- Source codepoints for search only: `U+8ACB`.
