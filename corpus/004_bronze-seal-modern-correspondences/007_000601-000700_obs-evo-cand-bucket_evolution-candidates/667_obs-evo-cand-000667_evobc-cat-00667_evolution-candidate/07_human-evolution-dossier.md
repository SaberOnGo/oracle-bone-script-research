...
- Project ID: `obs-evo-cand-000667`
- EVOBC category candidate ID: `evobc-evo-cat-00667`
- External category reference: `evobc-cat-00667`
- Source category ID: `00667`
- Source label for human review: `九`
- Source codepoints: `U+4E5D`
- Image reference count in source metadata: `206`
...
- `obs-evo-cand-000667-route-category-staging`
...
- `obs-evo-cand-000667-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000667-route-evolution-graph`
