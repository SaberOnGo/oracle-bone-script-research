...
- Yingguo / 英国所藏: `y2593` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `605` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `377` in source row; primary catalog entry pending
- Heji / 合集: `41867` in source row; primary catalog entry pending
