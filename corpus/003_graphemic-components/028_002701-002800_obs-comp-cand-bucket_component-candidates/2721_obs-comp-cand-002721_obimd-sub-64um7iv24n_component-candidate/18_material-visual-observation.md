# Material Visual Observation / obs-comp-cand-002721 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002721`
- External reference / 外部参照: `obimd-sub-64um7iv24n`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021319_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/64um7iv24n/64um7iv24n/64um7iv24n.png`
- Checksum / 校验和:
  `9e77361730697acbc9509c6cf3e50c860d47bcb974ac35e30e525b6f2fde52ee`
...
- Marked-pixel bounds: (92,22)–(177,228); span 86 × 207 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.76%。
- 痕迹范围：(92,22)–(177,228)；跨度86 × 207 px；痕迹矩形高于宽。
