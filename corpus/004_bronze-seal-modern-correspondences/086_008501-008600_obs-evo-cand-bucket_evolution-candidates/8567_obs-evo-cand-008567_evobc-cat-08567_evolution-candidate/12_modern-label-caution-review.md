# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008567
...
- EVOBC candidate category: `evobc-evo-cat-08567`.
- Source label for search only: `資`.
- Source codepoints for search only: `U+8CC7`.
