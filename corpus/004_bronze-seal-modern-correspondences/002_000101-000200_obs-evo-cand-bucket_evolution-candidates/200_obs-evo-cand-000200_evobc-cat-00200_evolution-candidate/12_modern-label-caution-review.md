# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000200
...
- EVOBC candidate category: `evobc-evo-cat-00200`.
- Source label for search only: `㲋`.
- Source codepoints for search only: `U+3C8B`.
