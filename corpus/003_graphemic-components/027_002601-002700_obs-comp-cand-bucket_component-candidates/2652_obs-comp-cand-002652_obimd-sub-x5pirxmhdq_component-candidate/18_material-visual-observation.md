# Material Visual Observation / obs-comp-cand-002652 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002652`
- External reference / 外部参照: `obimd-sub-x5pirxmhdq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021228_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/v4h7pminh1/x5pirxmhdq/x5pirxmhdq.png`
- Checksum / 校验和:
  `a37c2e0d5993f8ade19308683c9faf9e64412e21cb4b69abac42f1b98d41ae3c`
...
- Marked-pixel bounds: (91,20)–(160,228); span 70 × 209 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.85%。
- 痕迹范围：(91,20)–(160,228)；跨度70 × 209 px；痕迹矩形高于宽。
