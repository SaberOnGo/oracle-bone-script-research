...
Project ID: `obs-evo-cand-008894`
...
- Project ID: `obs-evo-cand-008894`
- EVOBC category candidate ID: `evobc-evo-cat-08894`
- External category reference: `evobc-cat-08894`
- Source category ID: `08894`
- Source label for human review: `轻`
- Source codepoints: `U+8F7B`
...
- `obs-evo-cand-008894-route-category-staging`
...
- `obs-evo-cand-008894-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008894-route-evolution-graph`
