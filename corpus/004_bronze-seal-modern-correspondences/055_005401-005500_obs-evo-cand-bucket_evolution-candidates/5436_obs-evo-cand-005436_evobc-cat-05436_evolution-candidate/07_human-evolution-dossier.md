...
Project ID: `obs-evo-cand-005436`
...
- Project ID: `obs-evo-cand-005436`
- EVOBC category candidate ID: `evobc-evo-cat-05436`
- External category reference: `evobc-cat-05436`
- Source category ID: `05436`
- Source label for human review: `瑒`
- Source codepoints: `U+7452`
...
- `obs-evo-cand-005436-route-category-staging`
...
- `obs-evo-cand-005436-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005436-route-evolution-graph`
