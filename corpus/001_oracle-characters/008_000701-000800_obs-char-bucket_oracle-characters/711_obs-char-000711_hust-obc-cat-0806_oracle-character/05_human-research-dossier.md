# obs-char-000711 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000711`
- primary external id: `hust-obc-cat-0806`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/711_obs-char-000711_hust-obc-cat-0806_orac
  le-character/03_visual-assets/001_asset-000716_hust-obc-cat-0806_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0806/L_0806_3814.jpg`
- asset id: `asset-000716`
...
- source category: `0806`
- validation class: `710`
- source image route: `HUST-OBC/deciphered/0806/L_0806_3814.jpg`
- asset id: `asset-000716`
...
- English observation: `The tiny faint image shows a crossed branching upper
  stem separated by a white gap from a shallow lower rectangular loop; fine
  upper joins are difficult to resolve.`
- 中文观察: `微小淡弱图像显示交叉分枝上干与浅下部矩形环之间隔有白隙，上部细接点难辨。`
...
- dataset label text: `㜜`
- dataset label codepoints: `U+371C`
...
- Which source records identify obs-char-000711 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000711？
