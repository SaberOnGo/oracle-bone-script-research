...
- External category reference: `evobc-cat-09432`
- Source category ID: `09432`
- Source label for human review: `錙`
- Source codepoints: `U+9319`
...
- `obs-evo-cand-009432-route-category-staging`
...
- `obs-evo-cand-009432-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009432-route-evolution-graph`
