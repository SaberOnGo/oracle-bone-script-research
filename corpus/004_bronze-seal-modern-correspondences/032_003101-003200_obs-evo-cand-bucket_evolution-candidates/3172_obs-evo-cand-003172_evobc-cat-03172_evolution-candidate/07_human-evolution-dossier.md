...
- Project ID: `obs-evo-cand-003172`
- EVOBC category candidate ID: `evobc-evo-cat-03172`
- External category reference: `evobc-cat-03172`
- Source category ID: `03172`
- Source label for human review: `懇`
- Source codepoints: `U+61C7`
...
- `obs-evo-cand-003172-route-category-staging`
...
- `obs-evo-cand-003172-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003172-route-evolution-graph`
