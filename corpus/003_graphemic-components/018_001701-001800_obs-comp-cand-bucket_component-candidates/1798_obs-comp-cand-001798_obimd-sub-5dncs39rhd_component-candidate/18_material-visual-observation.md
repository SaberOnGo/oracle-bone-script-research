# Material Visual Observation / obs-comp-cand-001798 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001798`
- External reference / 外部参照: `obimd-sub-5dncs39rhd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018019_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hcj1lu3l9a/5dncs39rhd/5dncs39rhd.png`
- Checksum / 校验和:
  `17eef1579880efd50063539458dbfb6e538d7908d881b49b4391403210428d52`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.14%.
- Marked-pixel bounds: (87,14)–(170,234); span 84 × 221 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.14%。
- 痕迹范围：(87,14)–(170,234)；跨度84 × 221 px；痕迹矩形高于宽。
