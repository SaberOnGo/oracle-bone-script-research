# obs-unk-003958 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/058_obs-unk-003958_h
  ust-obc-und-L-003958_oracle-character-candidate/03_visual-assets/001_asset
  -005551_hust-obc-und-L-003958_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3958/L_？_8351.jpg`
- asset id: `asset-005551`
...
- source class: `HUST-OBC/undeciphered/L/3958/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3958/L_？_8351.jpg`
- asset id: `asset-005551`
...
- English observation: A rounded enclosure has a short inner angled trace and
  two narrow lower traces meeting a low stroke.
- 中文观察：弧状围合轮廓内有短斜痕，下方两条窄痕与低处痕迹相接。
...
- Which source records identify obs-unk-003958 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003958？
