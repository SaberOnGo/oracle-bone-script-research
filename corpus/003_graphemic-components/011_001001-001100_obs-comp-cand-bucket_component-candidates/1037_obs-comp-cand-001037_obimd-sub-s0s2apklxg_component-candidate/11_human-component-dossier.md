# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-001037
...
- candidate_component_id: `obs-comp-cand-001037`
- primary_external_ref_id: `obimd-sub-s0s2apklxg`
- source_subcharacter_uid: `s0s2apklxg`
...
- glyph_codepoint_uplus_sample: `U+F5E4A, U+F5E4B`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-014530` | `001_asset-014530_img.png` | `c9e2fdcdbe1a7f6d6c2cf5a128899e541e538fa356cbab1f555bfffee1559226` |
