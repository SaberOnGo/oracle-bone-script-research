...
- External category reference: `evobc-cat-04599`
- Source category ID: `04599`
- Source label for human review: `泭`
- Source codepoints: `U+6CED`
...
- `obs-evo-cand-004599-route-category-staging`
...
- `obs-evo-cand-004599-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004599-route-evolution-graph`
