# Material Visual Observation / obs-comp-cand-000672 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000672`
- External reference / 外部参照: `obimd-sub-sst8wbq7kw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013235_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/sst8wbq7kw/sst8wbq7kw/sst8wbq7kw.png`
- Checksum / 校验和:
  `8bd9c9c3f9344656b33f4432f4eb7af7a063424da5ba85755f46117aa4bb512f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.40%.
- Marked-pixel bounds: (69,36)–(180,216); span 112 × 181 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.40%。
- 痕迹范围：(69,36)–(180,216)；跨度112 × 181 px；痕迹矩形高于宽。
