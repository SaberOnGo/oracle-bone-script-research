# obs-char-001320 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001320`
- primary external id: `hust-obc-cat-1476`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1320_obs-char-001320_hust-obc-cat-1476_ora
  cle-character/03_visual-assets/001_asset-001325_hust-obc-cat-1476_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1476/G_1476_乙393合21153𠂤組.png`
- asset id: `asset-001325`
...
- source category: `1476`
- validation class: `1319`
- source image route: `HUST-OBC/deciphered/1476/G_1476_乙393合21153𠂤組.png`
- asset id: `asset-001325`
...
- English observation: `A small narrow form has a short upper crossing, a
  curved central stem, and a hooked lower turn.`
- 中文观察: `小型狭长形体有短上部交叉笔、弯曲中央笔干和钩状下部转折。`
...
- dataset label text: `㦺`
- dataset label codepoints: `U+39BA`
...
- filename catalog route clues: `Heji-like filename clue: 合21153
  (G_1476_乙393合21153𠂤組.png)`
...
- Which source records identify obs-char-001320 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001320？
