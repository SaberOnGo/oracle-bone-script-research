# obs-evo-cand-002364 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-002364`
- EVOBC category candidate ID: `evobc-evo-cat-02364`
- External category ref: `evobc-cat-02364`
- Source label: `宋`
- Source codepoints: `U+5B8B`
- Image reference count: `101`
- Era token counts: `BI:14;CS:1;OBC:30;SAC:9;SS:2;WSC:45`
- Source token counts: `Book:45;Web:56`
...
- era 4 / WSC: 45 image references
- era 5 / CS: 1 image references
- source 0 / Web:1633: 1 image references
- source 1 / Web:105952;說文Web:58: 55 image references
