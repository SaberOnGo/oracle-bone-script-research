...
- Project ID: `obs-evo-cand-009007`
- EVOBC category candidate ID: `evobc-evo-cat-09007`
- External category reference: `evobc-cat-09007`
- Source category ID: `09007`
- Source label for human review: `逫`
- Source codepoints: `U+902B`
...
- `obs-evo-cand-009007-route-category-staging`
...
- `obs-evo-cand-009007-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009007-route-evolution-graph`
