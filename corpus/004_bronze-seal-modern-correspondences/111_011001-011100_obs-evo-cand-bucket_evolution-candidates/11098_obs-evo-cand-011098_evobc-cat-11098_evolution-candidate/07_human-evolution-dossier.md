...
- Project ID: `obs-evo-cand-011098`
- EVOBC category candidate ID: `evobc-evo-cat-11098`
- External category reference: `evobc-cat-11098`
- Source category ID: `11098`
- Source label for human review: `𡱂`
- Source codepoints: `U+21C42`
...
- `obs-evo-cand-011098-route-category-staging`
...
- `obs-evo-cand-011098-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011098-route-evolution-graph`
