# Material Visual Observation / obs-comp-cand-000383 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000383`
- External reference / 外部参照: `obimd-sub-awg8lyvedy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012306_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/awg8lyvedy/awg8lyvedy/awg8lyvedy.png`
- Checksum / 校验和:
  `2e76ced9919a3d58d256a1370527b413c2e7ae7ff64df6bddc974d87b34534d7`
...
- Marked-pixel bounds: (78,31)–(171,219); span 94 × 189 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.46%。
- 痕迹范围：(78,31)–(171,219)；跨度94 × 189 px；痕迹矩形高于宽。
