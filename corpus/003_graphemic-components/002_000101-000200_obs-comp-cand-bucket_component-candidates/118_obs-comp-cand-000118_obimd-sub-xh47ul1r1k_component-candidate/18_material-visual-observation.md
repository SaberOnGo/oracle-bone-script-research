# Material Visual Observation / obs-comp-cand-000118 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000118`
- External reference / 外部参照: `obimd-sub-xh47ul1r1k`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011530_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xh47ul1r1k/xh47ul1r1k/xh47ul1r1k.png`
- Checksum / 校验和:
  `e284e6febf24e5fd007203ec1fd3198afa6fd66f7708d7f76451a2d592dce898`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.09%.
- Marked-pixel bounds: (54,41)–(178,220); span 125 × 180 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.09%。
- 痕迹范围：(54,41)–(178,220)；跨度125 × 180 px；痕迹矩形高于宽。
