...
- Project ID: `obs-evo-cand-007314`
- EVOBC category candidate ID: `evobc-evo-cat-07314`
- External category reference: `evobc-cat-07314`
- Source category ID: `07314`
- Source label for human review: `茞`
- Source codepoints: `U+831E`
...
- `obs-evo-cand-007314-route-category-staging`
...
- `obs-evo-cand-007314-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007314-route-evolution-graph`
