# obs-unk-004372 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/072_obs-unk-004372_h
  ust-obc-und-L-004372_oracle-character-candidate/03_visual-assets/001_asset
  -005965_hust-obc-und-L-004372_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4372/L_？_9700.jpg`
- asset id: `asset-005965`
...
- source class: `HUST-OBC/undeciphered/L/4372/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4372/L_？_9700.jpg`
- asset id: `asset-005965`
...
- English observation: `Upper diagonal, lower open mark, and right curve`
  `recorded.`
- 中文观察: `已记录上部斜痕、左下开放痕和右侧弧线。`
...
- Which source records identify obs-unk-004372 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004372？
