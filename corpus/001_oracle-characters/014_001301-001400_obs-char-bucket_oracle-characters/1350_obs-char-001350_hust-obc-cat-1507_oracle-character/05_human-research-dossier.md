# obs-char-001350 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001350`
- primary external id: `hust-obc-cat-1507`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1350_obs-char-001350_hust-obc-cat-1507_ora
  cle-character/03_visual-assets/001_asset-001355_hust-obc-cat-1507_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1507/G_1507_佚973合4654賓組.png`
- asset id: `asset-001355`
...
- source category: `1507`
- validation class: `1349`
- source image route: `HUST-OBC/deciphered/1507/G_1507_佚973合4654賓組.png`
- asset id: `asset-001355`
...
- English observation: `Two adjacent forms combine a pointed left enclosure
  with a rounded right upper body and long lower curves.`
- 中文观察: `两个相邻形体结合左侧尖状框形、右侧圆拱上部主体和长下部弧线。`
...
- dataset label text: `㧙`
- dataset label codepoints: `U+39D9`
...
- filename catalog route clues: `Heji-like filename clue: 合4654
  (G_1507_佚973合4654賓組.png)`
...
- Which source records identify obs-char-001350 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001350？
