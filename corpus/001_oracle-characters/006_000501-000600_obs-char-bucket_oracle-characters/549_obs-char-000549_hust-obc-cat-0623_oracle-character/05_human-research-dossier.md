# obs-char-000549 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000549`
- primary external id: `hust-obc-cat-0623`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/549_obs-char-000549_hust-obc-cat-0623_orac
  le-character/03_visual-assets/001_asset-000554_hust-obc-cat-0623_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0623/G_0623_庫1870合41227.png`
- asset id: `asset-000554`
...
- source category: `0623`
- validation class: `548`
- source image route: `HUST-OBC/deciphered/0623/G_0623_庫1870合41227.png`
- asset id: `asset-000554`
...
- English observation: `A short cross sits at the top of a long bent
  descending stroke, while two small linked loops hang below its central
  bend.`
- 中文观察: `短交叉位于长弯折下行笔顶端，两个相连小环垂在其中部弯折下方。`
...
- dataset label text: `㙥`
- dataset label codepoints: `U+3665`
...
- filename catalog route clues: `Heji-like filename clue: 合41227
  (G_0623_庫1870合41227.png)`
...
- Which source records identify obs-char-000549 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000549？
