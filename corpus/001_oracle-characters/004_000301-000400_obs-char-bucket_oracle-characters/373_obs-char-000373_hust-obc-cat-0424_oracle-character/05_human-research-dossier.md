# obs-char-000373 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/373_obs-char-000373_hust-obc-cat-0424_orac
  le-character/03_visual-assets/001_asset-000378_hust-obc-cat-0424_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0424/G_0424_甲骨文0.png`
- asset id: `asset-000378`
...
- source category: `0424`
- validation class: `372`
- source image route: `HUST-OBC/deciphered/0424/G_0424_甲骨文0.png`
- asset id: `asset-000378`
...
- dataset label text: `㖞`
- dataset label codepoints: `U+359E`
...
- Which source records identify obs-char-000373 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000373？
