...
- Project ID: `obs-evo-cand-009973`
- EVOBC category candidate ID: `evobc-evo-cat-09973`
- External category reference: `evobc-cat-09973`
- Source category ID: `09973`
- Source label for human review: `須`
- Source codepoints: `U+9808`
- Image reference count in source metadata: `113`
...
- `obs-evo-cand-009973-route-category-staging`
...
- `obs-evo-cand-009973-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009973-route-evolution-graph`
