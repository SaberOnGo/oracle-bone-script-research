...
- External category reference: `evobc-cat-12184`
- Source category ID: `12184`
- Source label for human review: `𧗠`
- Source codepoints: `U+275E0`
...
- `obs-evo-cand-012184-route-category-staging`
...
- `obs-evo-cand-012184-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012184-route-evolution-graph`
