# obs-char-001059 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001059`
- primary external id: `hust-obc-cat-1186`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1059_obs-char-001059_hust-obc-cat-1186_ora
  cle-character/03_visual-assets/001_asset-001064_hust-obc-cat-1186_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1186/G_1186_寧滬1.236(甲).png`
- asset id: `asset-001064`
...
- validation class: `1058`
- source image route: `HUST-OBC/deciphered/1186/G_1186_寧滬1.236(甲).png`
- asset id: `asset-001064`
...
- English observation: `A narrow upright form has two pointed upper peaks, a
  horizontal crossbar, and a long central lower stroke.`
- 中文观察: `狭长直立形体有两个尖状上峰、水平横笔和长中央下行笔。`
...
- dataset label text: `㢘`
- dataset label codepoints: `U+3898`
...
- Which source records identify obs-char-001059 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001059？
