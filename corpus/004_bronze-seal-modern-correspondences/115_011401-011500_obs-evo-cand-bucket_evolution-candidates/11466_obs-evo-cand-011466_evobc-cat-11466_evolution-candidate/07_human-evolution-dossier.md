...
Project ID: `obs-evo-cand-011466`
...
- Project ID: `obs-evo-cand-011466`
- EVOBC category candidate ID: `evobc-evo-cat-11466`
- External category reference: `evobc-cat-11466`
- Source category ID: `11466`
- Source label for human review: `𣣆`
- Source codepoints: `U+238C6`
...
- `obs-evo-cand-011466-route-category-staging`
...
- `obs-evo-cand-011466-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011466-route-evolution-graph`
