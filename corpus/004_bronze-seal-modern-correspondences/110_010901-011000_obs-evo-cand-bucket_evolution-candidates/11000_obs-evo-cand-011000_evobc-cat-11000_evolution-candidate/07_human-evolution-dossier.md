...
Project ID: `obs-evo-cand-011000`
...
- Project ID: `obs-evo-cand-011000`
- EVOBC category candidate ID: `evobc-evo-cat-11000`
- External category reference: `evobc-cat-11000`
- Source category ID: `11000`
- Source label for human review: `𡏹`
- Source codepoints: `U+213F9`
- Image reference count in source metadata: `85`
...
- `obs-evo-cand-011000-route-category-staging`
...
- `obs-evo-cand-011000-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011000-route-evolution-graph`
