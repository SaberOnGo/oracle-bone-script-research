# Material Visual Observation / obs-comp-cand-002568 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002568`
- External reference / 外部参照: `obimd-sub-lw8ebrisot`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021100_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/uhn8agncvy/lw8ebrisot/lw8ebrisot.png`
- Checksum / 校验和:
  `82aa1bce070658959881c227512f160f41672beffc4e83cf9bae52be3110a1e4`
...
- Marked-pixel bounds: (81,32)–(167,212); span 87 × 181 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.81%。
- 痕迹范围：(81,32)–(167,212)；跨度87 × 181 px；痕迹矩形高于宽。
