...
- Project ID: `obs-evo-cand-009436`
- EVOBC category candidate ID: `evobc-evo-cat-09436`
- External category reference: `evobc-cat-09436`
- Source category ID: `09436`
- Source label for human review: `錟`
- Source codepoints: `U+931F`
...
- `obs-evo-cand-009436-route-category-staging`
...
- `obs-evo-cand-009436-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009436-route-evolution-graph`
