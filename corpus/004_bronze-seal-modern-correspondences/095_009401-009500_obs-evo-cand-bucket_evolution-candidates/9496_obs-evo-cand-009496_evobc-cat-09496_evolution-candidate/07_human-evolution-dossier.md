...
Project ID: `obs-evo-cand-009496`
...
- Project ID: `obs-evo-cand-009496`
- EVOBC category candidate ID: `evobc-evo-cat-09496`
- External category reference: `evobc-cat-09496`
- Source category ID: `09496`
- Source label for human review: `鏌`
- Source codepoints: `U+93CC`
...
- `obs-evo-cand-009496-route-category-staging`
...
- `obs-evo-cand-009496-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009496-route-evolution-graph`
