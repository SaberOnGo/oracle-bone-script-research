# obs-unk-004338 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004338`
- primary external id: `hust-obc-und-L-004338`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/038_obs-unk-004338_h
  ust-obc-und-L-004338_oracle-character-candidate/03_visual-assets/001_asset
  -005931_hust-obc-und-L-004338_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4338/L_？_9593.jpg`
- asset id: `asset-005931`
...
- source class: `HUST-OBC/undeciphered/L/4338/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4338/L_？_9593.jpg`
- asset id: `asset-005931`
...
- English observation: `Broad upper trace and lower compact cluster recorded.`
- 中文观察: `已记录上部宽痕和下部紧密痕迹组。`
...
- Which source records identify obs-unk-004338 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004338？
