# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-001686
...
- candidate_component_id: `obs-comp-cand-001686`
- primary_external_ref_id: `obimd-sub-pzuji4u0at`
- source_subcharacter_uid: `pzuji4u0at`
- source_main_character_uid: `pzuji4u0at`
- main_character_external_ref_id: `obimd-main-pzuji4u0at`
...
- glyph_codepoint_uplus_sample: `U+A999D;U+F9C94, U+F9C95`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-017602` | `001_asset-017602_img.png` | `df238b2bce6c0e7ed0abc9a9f054b4d17e8f1f83db068fc2543befd181324e12` |
