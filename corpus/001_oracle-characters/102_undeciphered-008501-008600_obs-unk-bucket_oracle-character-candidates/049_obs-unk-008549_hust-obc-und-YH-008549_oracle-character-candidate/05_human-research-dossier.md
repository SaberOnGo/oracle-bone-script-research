# obs-unk-008549 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008549`
- primary external id: `hust-obc-und-YH-008549`
...
- local review image route: `corpus/001_oracle-characters/102_undeciphered-008
  501-008600_obs-unk-bucket_oracle-character-candidates/049_obs-unk-008549_h
  ust-obc-und-YH-008549_oracle-character-candidate/03_visual-assets/001_asse
  t-010140_hust-obc-und-YH-008549_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60BE2/H_？_60BE2_0.png`
- asset id: `asset-010140`
...
- source class: `HUST-OBC/undeciphered/Y+H/60BE2/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60BE2/H_？_60BE2_0.png`
- asset id: `asset-010140`
...
- Which source records identify obs-unk-008549 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008549？
