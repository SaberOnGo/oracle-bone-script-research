# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006554
...
- EVOBC candidate category: `evobc-evo-cat-06554`.
- Source label for search only: `綪`.
- Source codepoints for search only: `U+7DAA`.
