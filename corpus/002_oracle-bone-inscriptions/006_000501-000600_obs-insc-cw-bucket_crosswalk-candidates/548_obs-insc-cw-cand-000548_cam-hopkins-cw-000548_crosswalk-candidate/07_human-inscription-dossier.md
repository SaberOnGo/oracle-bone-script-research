...
Project ID: `obs-insc-cw-cand-000548`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000548`
...
- Yingguo / 英国所藏: `y2555` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `359` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `452` in source row; primary catalog entry pending
- Heji / 合集: `41818` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000548`
