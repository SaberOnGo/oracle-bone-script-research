# obs-unk-004199 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/099_obs-unk-004199_h
  ust-obc-und-L-004199_oracle-character-candidate/03_visual-assets/001_asset
  -005792_hust-obc-und-L-004199_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4199/L_？_9146.jpg`
- asset id: `asset-005792`
...
- source class: `HUST-OBC/undeciphered/L/4199/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4199/L_？_9146.jpg`
- asset id: `asset-005792`
...
- English observation: `Upper outline, descent, and pointed terminal visible.`
- 中文观察: `上部轮廓、中央下伸痕迹和尖状末端可见。`
...
- Which source records identify obs-unk-004199 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004199？
