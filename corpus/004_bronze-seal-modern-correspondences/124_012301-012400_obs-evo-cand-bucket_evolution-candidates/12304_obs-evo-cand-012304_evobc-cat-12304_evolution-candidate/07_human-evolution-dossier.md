...
- External category reference: `evobc-cat-12304`
- Source category ID: `12304`
- Source label for human review: `𧽊`
- Source codepoints: `U+27F4A`
...
- `obs-evo-cand-012304-route-category-staging`
...
- `obs-evo-cand-012304-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012304-route-evolution-graph`
