...
- Yingguo / 英国所藏: `y626` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `259` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `666` in source row; primary catalog entry pending
- Heji / 合集: `39908` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000115`
