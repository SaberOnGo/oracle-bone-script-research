...
- `obs-evo-cand-001431-route-category-staging`
...
- `obs-evo-cand-001431-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001431-route-evolution-graph`
