...
Project ID: `obs-evo-cand-009584`
...
- Project ID: `obs-evo-cand-009584`
- EVOBC category candidate ID: `evobc-evo-cat-09584`
- External category reference: `evobc-cat-09584`
- Source category ID: `09584`
- Source label for human review: `铲`
- Source codepoints: `U+94F2`
...
- `obs-evo-cand-009584-route-category-staging`
...
- `obs-evo-cand-009584-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009584-route-evolution-graph`
