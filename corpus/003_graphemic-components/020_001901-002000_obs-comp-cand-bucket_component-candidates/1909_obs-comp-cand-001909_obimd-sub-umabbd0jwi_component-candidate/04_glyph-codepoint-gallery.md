# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001909
...
| --- | --- | --- | --- |
| `obimd-glyph-link-028821` | 󺹉 | `U+FAE49` | `reviewed_metadata_only` |
| `obimd-glyph-link-028822` | 󺹊 | `U+FAE4A` | `reviewed_metadata_only` |
