...
- External category reference: `evobc-cat-03253`
- Source category ID: `03253`
- Source label for human review: `扜`
...
- `obs-evo-cand-003253-route-category-staging`
...
- `obs-evo-cand-003253-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003253-route-evolution-graph`
