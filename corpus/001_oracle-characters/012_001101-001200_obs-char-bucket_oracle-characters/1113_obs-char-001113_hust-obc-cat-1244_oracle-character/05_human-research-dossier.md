# obs-char-001113 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1113_obs-char-001113_hust-obc-cat-1244_ora
  cle-character/03_visual-assets/001_asset-001118_hust-obc-cat-1244_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1244/H_1244_60B4B_0.png`
- asset id: `asset-001118`
...
- source category: `1244`
- validation class: `1112`
- source image route: `HUST-OBC/deciphered/1244/H_1244_60B4B_0.png`
- asset id: `asset-001118`
...
- English observation: `A broad peaked enclosure contains a central
  crossing, a long vertical stroke, and several short detached interior
  strokes.`
- 中文观察: `宽大的尖顶闭合轮廓包含中央交叉、长竖笔和数条短而分离的内部笔。`
...
- dataset label text: `㣒`
- dataset label codepoints: `U+38D2`
...
- filename catalog route clues: `catalog-like filename clue: H_1244
  (H_1244_60B4B_0.png)`
...
- Which source records identify obs-char-001113 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001113？
