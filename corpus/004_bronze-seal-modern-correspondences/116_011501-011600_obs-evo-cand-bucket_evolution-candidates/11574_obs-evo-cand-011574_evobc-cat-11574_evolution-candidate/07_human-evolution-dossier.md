...
Project ID: `obs-evo-cand-011574`
...
- Project ID: `obs-evo-cand-011574`
- EVOBC category candidate ID: `evobc-evo-cat-11574`
- External category reference: `evobc-cat-11574`
- Source category ID: `11574`
- Source label for human review: `𤏳`
- Source codepoints: `U+243F3`
...
- `obs-evo-cand-011574-route-category-staging`
...
- `obs-evo-cand-011574-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011574-route-evolution-graph`
