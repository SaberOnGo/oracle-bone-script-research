...
Project ID: `obs-evo-cand-012851`
...
- Project ID: `obs-evo-cand-012851`
- EVOBC category candidate ID: `evobc-evo-cat-12851`
- External category reference: `evobc-cat-12851`
- Source category ID: `12851`
- Source label for human review: `𪬴`
- Source codepoints: `U+2AB34`
...
- `obs-evo-cand-012851-route-category-staging`
...
- `obs-evo-cand-012851-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012851-route-evolution-graph`
