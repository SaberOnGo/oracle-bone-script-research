# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-005628
...
- EVOBC candidate category: `evobc-evo-cat-05628`.
- Source label for search only: `疾`.
- Source codepoints for search only: `U+75BE`.
