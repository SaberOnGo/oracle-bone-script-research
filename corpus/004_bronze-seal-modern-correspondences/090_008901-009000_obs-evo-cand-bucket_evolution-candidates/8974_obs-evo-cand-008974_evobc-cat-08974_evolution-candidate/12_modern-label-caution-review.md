# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008974
...
- EVOBC candidate category: `evobc-evo-cat-08974`.
- Source label for search only: `迺`.
- Source codepoints for search only: `U+8FFA`.
