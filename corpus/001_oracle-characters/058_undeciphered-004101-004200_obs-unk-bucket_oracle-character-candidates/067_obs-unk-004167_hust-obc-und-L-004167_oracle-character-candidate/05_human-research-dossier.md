# obs-unk-004167 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004167`
- primary external id: `hust-obc-und-L-004167`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/067_obs-unk-004167_h
  ust-obc-und-L-004167_oracle-character-candidate/03_visual-assets/001_asset
  -005760_hust-obc-und-L-004167_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4167/L_？_9030.jpg`
- asset id: `asset-005760`
...
- source class: `HUST-OBC/undeciphered/L/4167/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4167/L_？_9030.jpg`
- asset id: `asset-005760`
...
- English observation: A dense central crossing group has a long curved left
  stroke.
- 中文观察: 中央有密集交会组，左侧有较长弧曲笔画。
...
- Which source records identify obs-unk-004167 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004167？
