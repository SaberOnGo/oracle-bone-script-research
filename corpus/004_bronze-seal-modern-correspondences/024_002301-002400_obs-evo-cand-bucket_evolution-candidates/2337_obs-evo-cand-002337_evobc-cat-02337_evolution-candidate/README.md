# obs-evo-cand-002337 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-002337`
- EVOBC category candidate ID: `evobc-evo-cat-02337`
- External category ref: `evobc-cat-02337`
- Source label: `孟`
- Source codepoints: `U+5B5F`
- Image reference count: `172`
- Era token counts: `BI:86;CS:2;OBC:24;SAC:28;SS:3;WSC:29`
- Source token counts: `Book:92;Web:80`
