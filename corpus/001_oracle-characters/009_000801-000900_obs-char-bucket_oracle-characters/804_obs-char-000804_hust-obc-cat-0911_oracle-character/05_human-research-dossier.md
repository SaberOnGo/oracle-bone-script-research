# obs-char-000804 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000804`
- primary external id: `hust-obc-cat-0911`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/804_obs-char-000804_hust-obc-cat-0911_orac
  le-character/03_visual-assets/001_asset-000809_hust-obc-cat-0911_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0911/G_0911_乙8520合21868子組.png`
- asset id: `asset-000809`
...
- source category: `0911`
- validation class: `803`
- source image route: `HUST-OBC/deciphered/0911/G_0911_乙8520合21868子組.png`
- asset id: `asset-000809`
...
- English observation: `A thin vertical form begins with a rounded closed
  loop and continues through angled side strokes to a pointed lower end.`
...
- dataset label text: `㞅`
- dataset label codepoints: `U+3785`
...
- filename catalog route clues: `Heji-like filename clue: 合21868
  (G_0911_乙8520合21868子組.png)`
...
- Which source records identify obs-char-000804 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000804？
