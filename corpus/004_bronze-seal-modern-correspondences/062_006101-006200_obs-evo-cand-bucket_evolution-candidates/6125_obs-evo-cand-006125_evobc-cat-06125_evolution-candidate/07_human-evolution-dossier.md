...
- External category reference: `evobc-cat-06125`
- Source category ID: `06125`
- Source label for human review: `穊`
...
- `obs-evo-cand-006125-route-category-staging`
...
- `obs-evo-cand-006125-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006125-route-evolution-graph`
