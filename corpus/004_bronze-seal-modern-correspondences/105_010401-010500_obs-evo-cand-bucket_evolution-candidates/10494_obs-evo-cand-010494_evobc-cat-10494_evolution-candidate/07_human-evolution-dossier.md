...
- External category reference: `evobc-cat-10494`
- Source category ID: `10494`
- Source label for human review: `鴡`
- Source codepoints: `U+9D21`
...
- `obs-evo-cand-010494-route-category-staging`
...
- `obs-evo-cand-010494-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010494-route-evolution-graph`
