# obs-char-001157 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001157`
- primary external id: `hust-obc-cat-1296`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1157_obs-char-001157_hust-obc-cat-1296_ora
  cle-character/03_visual-assets/001_asset-001162_hust-obc-cat-1296_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1296/G_1296_燕412合8833賓組.png`
- asset id: `asset-001162`
...
- source category: `1296`
- validation class: `1156`
- source image route: `HUST-OBC/deciphered/1296/G_1296_燕412合8833賓組.png`
- asset id: `asset-001162`
...
- English observation: `A dense two-part cluster has a pointed left
  projection, a central crossing, and a tall angular right contour.`
- 中文观察: `密集的两部分笔群有左侧尖状外伸、中央交叉和高直的右侧折角轮廓。`
...
- dataset label text: `㤆`
- dataset label codepoints: `U+3906`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00114`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00114`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00114`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/114_obs-evo-can
  d-000114_evobc-cat-00114_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/114_obs-evo-cand-000114_evobc-cat-00114_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合8833
  (G_1296_燕412合8833賓組.png)`
...
- Which source records identify obs-char-001157 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001157？
