...
- Source page section: `Period III Group 14` /
  `第 III 期第 14 组`
- Source section key: `period-iii-group-14`
...
- Yingguo / 英国所藏: `y2346` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `570` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `87` in source row; primary catalog entry pending
