...
- Project ID: `obs-evo-cand-003090`
- EVOBC category candidate ID: `evobc-evo-cat-03090`
- External category reference: `evobc-cat-03090`
- Source category ID: `03090`
- Source label for human review: `愤`
- Source codepoints: `U+6124`
...
- `obs-evo-cand-003090-route-category-staging`
...
- `obs-evo-cand-003090-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003090-route-evolution-graph`
