# obs-unk-004255 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004255`
- primary external id: `hust-obc-und-L-004255`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/055_obs-unk-004255_h
  ust-obc-und-L-004255_oracle-character-candidate/03_visual-assets/001_asset
  -005848_hust-obc-und-L-004255_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4255/L_？_9373.jpg`
- asset id: `asset-005848`
...
- source class: `HUST-OBC/undeciphered/L/4255/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4255/L_？_9373.jpg`
- asset id: `asset-005848`
...
- English observation: `Rounded upper outline, bars, lower marks visible.`
- 中文观察: `圆转上部轮廓、内部横痕和下部痕迹可见。`
...
- Which source records identify obs-unk-004255 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004255？
