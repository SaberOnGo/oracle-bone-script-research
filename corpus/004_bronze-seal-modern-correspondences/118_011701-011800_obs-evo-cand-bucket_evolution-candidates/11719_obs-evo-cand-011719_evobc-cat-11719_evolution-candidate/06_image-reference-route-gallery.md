...
- `obs-evo-cand-011719-route-category-staging`
...
- `obs-evo-cand-011719-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011719-route-evolution-graph`
