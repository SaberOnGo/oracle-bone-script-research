...
Project ID: `obs-evo-cand-012629`
...
- Project ID: `obs-evo-cand-012629`
- EVOBC category candidate ID: `evobc-evo-cat-12629`
- External category reference: `evobc-cat-12629`
- Source category ID: `12629`
- Source label for human review: `𩚠`
- Source codepoints: `U+296A0`
...
- `obs-evo-cand-012629-route-category-staging`
...
- `obs-evo-cand-012629-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012629-route-evolution-graph`
