...
Project ID: `obs-evo-cand-008967`
...
- Project ID: `obs-evo-cand-008967`
- EVOBC category candidate ID: `evobc-evo-cat-08967`
- External category reference: `evobc-cat-08967`
- Source category ID: `08967`
- Source label for human review: `述`
- Source codepoints: `U+8FF0`
...
- `obs-evo-cand-008967-route-category-staging`
...
- `obs-evo-cand-008967-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008967-route-evolution-graph`
