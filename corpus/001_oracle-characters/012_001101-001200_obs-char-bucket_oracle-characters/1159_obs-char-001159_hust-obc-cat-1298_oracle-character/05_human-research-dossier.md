# obs-char-001159 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1159_obs-char-001159_hust-obc-cat-1298_ora
  cle-character/03_visual-assets/001_asset-001164_hust-obc-cat-1298_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1298/L_1298_3568.jpg`
- asset id: `asset-001164`
...
- source category: `1298`
- validation class: `1158`
- source image route: `HUST-OBC/deciphered/1298/L_1298_3568.jpg`
- asset id: `asset-001164`
...
- English observation: `A faint small form has a short upper horizontal, a
  central upright, and a rounded lower loop; contrast is low.`
- 中文观察: `较淡的小型形体有短上部横笔、中央直立笔和下部圆弧环；图像对比度较低。`
...
- dataset label text: `㤈`
- dataset label codepoints: `U+3908`
...
- Which source records identify obs-char-001159 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001159？
