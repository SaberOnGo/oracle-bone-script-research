...
- Project ID: `obs-evo-cand-007040`
- EVOBC category candidate ID: `evobc-evo-cat-07040`
- External category reference: `evobc-cat-07040`
- Source category ID: `07040`
- Source label for human review: `胲`
- Source codepoints: `U+80F2`
...
- `obs-evo-cand-007040-route-category-staging`
...
- `obs-evo-cand-007040-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007040-route-evolution-graph`
