...
- External category reference: `evobc-cat-08733`
- Source category ID: `08733`
- Source label for human review: `踞`
...
- `obs-evo-cand-008733-route-category-staging`
...
- `obs-evo-cand-008733-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008733-route-evolution-graph`
