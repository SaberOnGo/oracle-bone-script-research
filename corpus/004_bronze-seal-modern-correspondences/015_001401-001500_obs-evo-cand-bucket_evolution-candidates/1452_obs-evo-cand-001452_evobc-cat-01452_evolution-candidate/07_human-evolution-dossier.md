...
- Project ID: `obs-evo-cand-001452`
- EVOBC category candidate ID: `evobc-evo-cat-01452`
- External category reference: `evobc-cat-01452`
- Source category ID: `01452`
- Source label for human review: `友`
- Source codepoints: `U+53CB`
...
- `obs-evo-cand-001452-route-category-staging`
...
- `obs-evo-cand-001452-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001452-route-evolution-graph`
