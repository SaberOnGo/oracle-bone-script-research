# obs-char-000529 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/529_obs-char-000529_hust-obc-cat-0603_orac
  le-character/03_visual-assets/001_asset-000534_hust-obc-cat-0603_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0603/G_0603_乙5327合22044午組.png`
- asset id: `asset-000534`
...
- source category: `0603`
- validation class: `528`
- source image route: `HUST-OBC/deciphered/0603/G_0603_乙5327合22044午組.png`
- asset id: `asset-000534`
...
- English observation: `Several long parallel wavering vertical strokes form
  a narrow band, while the two inner strokes meet to outline a slim pointed
  loop.`
- 中文观察: `数条长平行波折竖笔组成狭窄带状，其中两条内笔相接形成细长尖顶环。`
...
- dataset label text: `㙑`
- dataset label codepoints: `U+3651`
...
- filename catalog route clues: `Heji-like filename clue: 合22044
  (G_0603_乙5327合22044午組.png)`
...
- Which source records identify obs-char-000529 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000529？
