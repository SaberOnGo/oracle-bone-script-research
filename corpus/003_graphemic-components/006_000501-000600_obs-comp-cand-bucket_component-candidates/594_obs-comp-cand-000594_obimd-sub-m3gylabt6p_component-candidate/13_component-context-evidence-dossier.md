# obs-comp-cand-000594 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000594`
- 首选外部 ID: `obimd-sub-m3gylabt6p`
- OBIMD subcharacter UID: `m3gylabt6p`
- OBIMD main character UID: `m3gylabt6p`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+2C962;U+F38DD; U+F38DE; 另有 1 项
