...
- External category reference: `evobc-cat-10295`
- Source category ID: `10295`
- Source label for human review: `骼`
- Source codepoints: `U+9ABC`
...
- `obs-evo-cand-010295-route-category-staging`
...
- `obs-evo-cand-010295-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010295-route-evolution-graph`
