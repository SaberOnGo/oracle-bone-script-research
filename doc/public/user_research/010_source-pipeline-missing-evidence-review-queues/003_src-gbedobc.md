...
- Review draft ID / 复核草稿 ID: `source-pipeline-missing-evidence-review-draft-003`
...
- Pipeline gap status / 流水线缺口状态: `needs_package_manifest_review`
...
- `source-pipeline-phase-action-missing-evidence-route-006`

### Action IDs / 动作 ID

- `source-pipeline-phase-action-missing-evidence-006`

### Result scaffold IDs / 结果脚手架 ID

- `source-pipeline-phase-action-missing-evidence-result-006`
...
- metadata_profile_ids: `metadata-profile-000060;metadata-`
  `profile-000061;metadata-profile-000062`
- large_source_package_ids: `none`
- source_download_log_ids: `dl-gbedobc-repo-page;dl-gbedobc-nature-pdf`
- source_field_map_ids: `field-map-000023`
- source_package_file_ids: `pkg-file-000016;pkg-file-000017`
...
- download log ids / 下载记录 ID: `dl-gbedobc-repo-page;dl-gbedobc-nature-pdf`
- metadata profile ids / metadata profile ID: `metadata-`
  `profile-000060;metadata-profile-000061;metadata-profile-000062`
- large source package ids / 大型来源包 ID: `none`
- source field map ids / 字段映射 ID: `field-map-000023`
- package file ids / package file ID: `pkg-file-000016;pkg-file-000017`
