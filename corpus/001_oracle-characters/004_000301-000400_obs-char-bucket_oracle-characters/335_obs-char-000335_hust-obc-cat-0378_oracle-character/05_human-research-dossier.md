# obs-char-000335 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000335`
- primary external id: `hust-obc-cat-0378`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/335_obs-char-000335_hust-obc-cat-0378_orac
  le-character/03_visual-assets/001_asset-000340_hust-obc-cat-0378_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0378/G_0378_珠437(甲).png`
- asset id: `asset-000340`
...
- source category: `0378`
- validation class: `334`
- source image route: `HUST-OBC/deciphered/0378/G_0378_珠437(甲).png`
- asset id: `asset-000340`
...
- English observation: `A pointed diamond-like outer enclosure contains a
  central horizontal and vertical crossing structure.`
- 中文观察: `尖顶菱状外部闭合轮廓内部有横竖交叉结构。`
...
- dataset label text: `㕰`
- dataset label codepoints: `U+3570`
...
- Which source records identify obs-char-000335 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000335？
