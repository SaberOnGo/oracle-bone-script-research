...
- External category reference: `evobc-cat-00570`
- Source category ID: `00570`
- Source label for human review: `䯏`
...
- `obs-evo-cand-000570-route-category-staging`
...
- `obs-evo-cand-000570-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000570-route-evolution-graph`
