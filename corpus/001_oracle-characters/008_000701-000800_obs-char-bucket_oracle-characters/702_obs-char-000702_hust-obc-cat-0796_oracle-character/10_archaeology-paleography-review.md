# obs-char-000702 Archaeology Paleography Review

# obs-char-000702 考古文字复核档案
...
- first local image: `001_asset-000707_hust-obc-cat-0796_glyph.png`
- first source image: `G_0796_前5.17.3(甲).png`
...
- source label text: `㜒`
- source label codepoints: `U+3712`
