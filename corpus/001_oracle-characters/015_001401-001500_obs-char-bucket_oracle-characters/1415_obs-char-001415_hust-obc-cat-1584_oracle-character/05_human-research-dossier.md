# obs-char-001415 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1415_obs-char-001415_hust-obc-cat-1584_ora
  cle-character/03_visual-assets/001_asset-001420_hust-obc-cat-1584_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1584/X_1584_4167_1.png`
- asset id: `asset-001420`
...
- source category: `1584`
- validation class: `1414`
- source image route: `HUST-OBC/deciphered/1584/X_1584_4167_1.png`
- asset id: `asset-001420`
...
- English observation: `A large stacked form has rounded upper bands, a
  central enclosure, and lower legs.`
...
- dataset label text: `㨦`
- dataset label codepoints: `U+3A26`
...
- Which source records identify obs-char-001415 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001415？
