# obs-unk-004007 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/007_obs-unk-004007_h
  ust-obc-und-L-004007_oracle-character-candidate/03_visual-assets/001_asset
  -005600_hust-obc-und-L-004007_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4007/L_？_8497.jpg`
- asset id: `asset-005600`
...
- source class: `HUST-OBC/undeciphered/L/4007/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4007/L_？_8497.jpg`
- asset id: `asset-005600`
...
- English observation: A pointed upper outline sits above a broad curved lower
  trace with a central vertical mark.
- 中文观察：上部有尖状轮廓，下方有较宽弯曲痕迹，中部可见纵向痕迹。
...
- Which source records identify obs-unk-004007 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004007？
