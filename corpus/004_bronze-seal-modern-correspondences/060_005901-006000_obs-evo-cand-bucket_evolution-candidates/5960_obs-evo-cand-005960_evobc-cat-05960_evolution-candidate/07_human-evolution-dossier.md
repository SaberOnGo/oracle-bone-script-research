...
- External category reference: `evobc-cat-05960`
- Source category ID: `05960`
- Source label for human review: `礩`
- Source codepoints: `U+7929`
...
- `obs-evo-cand-005960-route-category-staging`
...
- `obs-evo-cand-005960-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005960-route-evolution-graph`
