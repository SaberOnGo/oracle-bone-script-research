# Material Visual Observation / obs-comp-cand-002151 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002151`
- External reference / 外部参照: `obimd-sub-na8kqoctw0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019792_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/k0pxsd02si/na8kqoctw0/na8kqoctw0.png`
- Checksum / 校验和:
  `15eb1fb63a7655a1f9b39ef1fda4ecdb270ad0310b80a96c30feb6da1b028922`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.06%.
- Marked-pixel bounds: (34,26)–(205,226); span 172 × 201 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.06%。
- 痕迹范围：(34,26)–(205,226)；跨度172 × 201 px；痕迹矩形近方形。
