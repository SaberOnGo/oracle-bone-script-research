...
Project ID: `obs-evo-cand-003977`
...
- Project ID: `obs-evo-cand-003977`
- EVOBC category candidate ID: `evobc-evo-cat-03977`
- External category reference: `evobc-cat-03977`
- Source category ID: `03977`
- Source label for human review: `柲`
- Source codepoints: `U+67F2`
...
- `obs-evo-cand-003977-route-category-staging`
...
- `obs-evo-cand-003977-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003977-route-evolution-graph`
