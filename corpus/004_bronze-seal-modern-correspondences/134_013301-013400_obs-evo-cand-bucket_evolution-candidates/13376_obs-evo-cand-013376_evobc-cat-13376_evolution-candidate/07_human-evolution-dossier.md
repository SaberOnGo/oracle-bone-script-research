...
- External category reference: `evobc-cat-13376`
- Source category ID: `13376`
- Source label for human review: `𬪂`
- Source codepoints: `U+2CA82`
...
- `obs-evo-cand-013376-route-category-staging`
...
- `obs-evo-cand-013376-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013376-route-evolution-graph`
