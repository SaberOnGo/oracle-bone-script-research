...
- External category reference: `evobc-cat-01396`
- Source category ID: `01396`
- Source label for human review: `卯`
- Source codepoints: `U+536F`
...
- `obs-evo-cand-001396-route-category-staging`
...
- `obs-evo-cand-001396-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001396-route-evolution-graph`
