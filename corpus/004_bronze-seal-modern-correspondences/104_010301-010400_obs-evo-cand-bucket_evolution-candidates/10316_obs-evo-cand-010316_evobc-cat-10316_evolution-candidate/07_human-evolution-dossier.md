...
- External category reference: `evobc-cat-10316`
- Source category ID: `10316`
- Source label: `髮`
...
- `obs-evo-cand-010316-route-category-staging`
...
- `obs-evo-cand-010316-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010316-route-evolution-graph`
