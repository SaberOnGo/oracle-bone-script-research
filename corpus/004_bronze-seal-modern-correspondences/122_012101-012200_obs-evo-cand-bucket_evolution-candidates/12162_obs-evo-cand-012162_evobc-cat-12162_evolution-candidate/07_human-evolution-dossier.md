...
- External category reference: `evobc-cat-12162`
- Source category ID: `12162`
- Source label for human review: `𧍸`
...
- `obs-evo-cand-012162-route-category-staging`
...
- `obs-evo-cand-012162-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012162-route-evolution-graph`
