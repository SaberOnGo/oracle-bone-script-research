...
Project ID: `obs-insc-cw-cand-000155`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000155`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000155` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y856` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `162` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `479` [route_present_image_or_text_not_collected]
