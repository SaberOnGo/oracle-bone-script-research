# obs-unk-008752 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/104_undeciphered-008
  701-008800_obs-unk-bucket_oracle-character-candidates/052_obs-unk-008752_h
  ust-obc-und-YH-008752_oracle-character-candidate/03_visual-assets/001_asse
  t-010343_hust-obc-und-YH-008752_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60DB6/H_？_60DB6_0.png`
- asset id: `asset-010343`
...
- source class: `HUST-OBC/undeciphered/Y+H/60DB6/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60DB6/H_？_60DB6_0.png`
- asset id: `asset-010343`
...
- Which source records identify obs-unk-008752 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008752？
