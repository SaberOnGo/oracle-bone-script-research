...
- `obs-evo-cand-002999-route-category-staging`
...
- `obs-evo-cand-002999-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002999-route-evolution-graph`
