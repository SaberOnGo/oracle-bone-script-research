...
Project ID: `obs-evo-cand-003386`
...
- Project ID: `obs-evo-cand-003386`
- EVOBC category candidate ID: `evobc-evo-cat-03386`
- External category reference: `evobc-cat-03386`
- Source category ID: `03386`
- Source label for human review: `捻`
- Source codepoints: `U+637B`
...
- `obs-evo-cand-003386-route-category-staging`
...
- `obs-evo-cand-003386-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003386-route-evolution-graph`
