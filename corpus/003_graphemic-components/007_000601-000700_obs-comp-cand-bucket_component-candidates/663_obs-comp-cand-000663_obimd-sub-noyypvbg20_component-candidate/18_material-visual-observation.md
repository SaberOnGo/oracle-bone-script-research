# Material Visual Observation / obs-comp-cand-000663 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000663`
- External reference / 外部参照: `obimd-sub-noyypvbg20`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013226_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/noyypvbg20/noyypvbg20/noyypvbg20.png`
- Checksum / 校验和:
  `9c2d54adcb45c1aaa0ba412391c0aa101305b61521f0d5751c4b7a44c09d0e77`
...
- Marked-pixel bounds: (82,21)–(167,225); span 86 × 205 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.88%。
- 痕迹范围：(82,21)–(167,225)；跨度86 × 205 px；痕迹矩形高于宽。
