# Material Visual Observation / obs-comp-cand-002534 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002534`
- External reference / 外部参照: `obimd-sub-f0csx339lz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021053_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/f0csx339lz/f0csx339lz/f0csx339lz.png`
- Checksum / 校验和:
  `a94f30e8d3002c087dc942af780afc744bcc8093a66befb37337b276b627ba97`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.99%.
- Marked-pixel bounds: (66,43)–(174,199); span 109 × 157 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.99%。
- 痕迹范围：(66,43)–(174,199)；跨度109 × 157 px；痕迹矩形高于宽。
