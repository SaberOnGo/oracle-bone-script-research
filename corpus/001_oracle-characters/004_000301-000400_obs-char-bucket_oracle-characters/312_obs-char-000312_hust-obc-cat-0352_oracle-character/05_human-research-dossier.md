# obs-char-000312 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000312`
- primary external id: `hust-obc-cat-0352`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/312_obs-char-000312_hust-obc-cat-0352_orac
  le-character/03_visual-assets/001_asset-000317_hust-obc-cat-0352_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0352/G_0352_乙1798合21934.png`
- asset id: `asset-000317`
...
- source category: `0352`
- validation class: `311`
- source image route: `HUST-OBC/deciphered/0352/G_0352_乙1798合21934.png`
- asset id: `asset-000317`
...
- English observation: `The image contains three small rounded
  enclosure-like forms arranged across the upper and lower portions.`
- 中文观察: `图像含三个小型圆弧闭合形体，分布在上部和下部不同位置。`
...
- dataset label text: `㕖`
- dataset label codepoints: `U+3556`
...
- filename catalog route clues: `Heji-like filename clue: 合21934
  (G_0352_乙1798合21934.png)`
...
- Which source records identify obs-char-000312 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000312？
