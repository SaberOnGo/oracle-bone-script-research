# obs-unk-004941 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/041_obs-unk-004941_h
  ust-obc-und-X-004941_oracle-character-candidate/03_visual-assets/001_asset
  -006534_hust-obc-und-X-004941_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/497/X_？_7480_1.png`
- asset id: `asset-006534`
...
- A dense dark body contains two lower openings and a right branch.
...
- source class: `HUST-OBC/undeciphered/X/497/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/497/X_？_7480_1.png`
- asset id: `asset-006534`
...
- Which source records identify obs-unk-004941 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004941？
