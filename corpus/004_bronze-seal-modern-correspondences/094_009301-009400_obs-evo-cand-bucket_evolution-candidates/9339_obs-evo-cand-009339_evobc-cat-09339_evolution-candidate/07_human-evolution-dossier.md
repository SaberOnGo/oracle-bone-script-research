...
Project ID: `obs-evo-cand-009339`
...
- Project ID: `obs-evo-cand-009339`
- EVOBC category candidate ID: `evobc-evo-cat-09339`
- External category reference: `evobc-cat-09339`
- Source category ID: `09339`
- Source label for human review: `鈙`
- Source codepoints: `U+9219`
...
- `obs-evo-cand-009339-route-category-staging`
...
- `obs-evo-cand-009339-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009339-route-evolution-graph`
