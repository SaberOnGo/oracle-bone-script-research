# Material Visual Observation / obs-comp-cand-000522 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000522`
- External reference / 外部参照: `obimd-sub-nq3neh9i5i`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012757_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/nq3neh9i5i/nq3neh9i5i/nq3neh9i5i.png`
- Checksum / 校验和:
  `ec8ad8898a5dfa2ab10dad548102f9b5e9ffd765d32d453729dfc54086824601`
...
- Marked-pixel bounds: (81,35)–(168,222); span 88 × 188 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.20%。
- 痕迹范围：(81,35)–(168,222)；跨度88 × 188 px；痕迹矩形高于宽。
