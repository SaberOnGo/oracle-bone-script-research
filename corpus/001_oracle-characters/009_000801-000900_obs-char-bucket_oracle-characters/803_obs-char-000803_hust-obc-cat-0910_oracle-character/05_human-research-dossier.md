# obs-char-000803 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/803_obs-char-000803_hust-obc-cat-0910_orac
  le-character/03_visual-assets/001_asset-000808_hust-obc-cat-0910_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0910/G_0910_合10406反(甲).png`
- asset id: `asset-000808`
...
- source category: `0910`
- validation class: `802`
- source image route: `HUST-OBC/deciphered/0910/G_0910_合10406反(甲).png`
- asset id: `asset-000808`
...
- English observation: `The compact image contains neighboring angular and
  rounded marks, several short crossing strokes, and a small detached
  upright at right.`
- 中文观察: `紧凑图像含相邻的折角与圆弧痕迹，中间有数条短交叉笔，右侧可见小型分离直立笔。`
...
- dataset label text: `㞄`
- dataset label codepoints: `U+3784`
...
- filename catalog route clues: `Heji-like filename clue: 合10406
  (G_0910_合10406反(甲).png)`
...
- Which source records identify obs-char-000803 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000803？
