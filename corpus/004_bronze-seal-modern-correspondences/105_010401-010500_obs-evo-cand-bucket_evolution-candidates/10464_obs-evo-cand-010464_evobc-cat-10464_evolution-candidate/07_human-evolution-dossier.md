...
Project ID: `obs-evo-cand-010464`
...
- Project ID: `obs-evo-cand-010464`
- EVOBC category candidate ID: `evobc-evo-cat-10464`
- External category reference: `evobc-cat-10464`
- Source category ID: `10464`
- Source label for human review: `鳄`
- Source codepoints: `U+9CC4`
...
- `obs-evo-cand-010464-route-category-staging`
...
- `obs-evo-cand-010464-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010464-route-evolution-graph`
