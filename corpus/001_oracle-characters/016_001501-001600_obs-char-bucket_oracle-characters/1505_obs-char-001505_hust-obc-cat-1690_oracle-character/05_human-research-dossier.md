# obs-char-001505 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001505`
- primary external id: `hust-obc-cat-1690`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1505_obs-char-001505_hust-obc-cat-1690_ora
  cle-character/03_visual-assets/001_asset-001510_hust-obc-cat-1690_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1690/G_1690_乙1834合21741.png`
- asset id: `asset-001510`
...
- source category: `1690`
- validation class: `1504`
- source image route: `HUST-OBC/deciphered/1690/G_1690_乙1834合21741.png`
- asset id: `asset-001510`
...
- English observation: `A dark rounded form has an angular outer contour and
  an open inner space.`
...
- dataset label text: `㪐`
- dataset label codepoints: `U+3A90`
...
- filename catalog route clues: `Heji-like filename clue: 合21741
  (G_1690_乙1834合21741.png)`
...
- Which source records identify obs-char-001505 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001505？
