...
Project ID: `obs-evo-cand-007835`
...
- Project ID: `obs-evo-cand-007835`
- EVOBC category candidate ID: `evobc-evo-cat-07835`
- External category reference: `evobc-cat-07835`
- Source category ID: `07835`
- Source label for human review: `螮`
- Source codepoints: `U+87AE`
...
- `obs-evo-cand-007835-route-category-staging`
...
- `obs-evo-cand-007835-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007835-route-evolution-graph`
