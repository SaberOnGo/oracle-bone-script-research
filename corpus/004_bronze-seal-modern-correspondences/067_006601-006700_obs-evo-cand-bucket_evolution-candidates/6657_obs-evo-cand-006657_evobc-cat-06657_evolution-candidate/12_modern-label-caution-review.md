# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006657
...
- EVOBC candidate category: `evobc-evo-cat-06657`.
- Source label for search only: `總`.
- Source codepoints for search only: `U+7E3D`.
