...
Project ID: `obs-evo-cand-009038`
...
- Project ID: `obs-evo-cand-009038`
- EVOBC category candidate ID: `evobc-evo-cat-09038`
- External category reference: `evobc-cat-09038`
- Source category ID: `09038`
- Source label for human review: `遘`
- Source codepoints: `U+9058`
- Image reference count in source metadata: `92`
...
- `obs-evo-cand-009038-route-category-staging`
...
- `obs-evo-cand-009038-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009038-route-evolution-graph`
