...
- Project ID: `obs-evo-cand-000997`
- EVOBC category candidate ID: `evobc-evo-cat-00997`
- External category reference: `evobc-cat-00997`
- Source category ID: `00997`
- Source label for human review: `傴`
- Source codepoints: `U+50B4`
...
- `obs-evo-cand-000997-route-category-staging`
...
- `obs-evo-cand-000997-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000997-route-evolution-graph`
