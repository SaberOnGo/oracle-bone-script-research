...
- External category reference: `evobc-cat-04861`
- Source category ID: `04861`
- Source label for human review: `漀`
...
- `obs-evo-cand-004861-route-category-staging`
...
- `obs-evo-cand-004861-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004861-route-evolution-graph`
