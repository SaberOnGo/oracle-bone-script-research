# obs-unk-004153 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/053_obs-unk-004153_h
  ust-obc-und-L-004153_oracle-character-candidate/03_visual-assets/001_asset
  -005746_hust-obc-und-L-004153_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4153/L_？_8999.jpg`
- asset id: `asset-005746`
...
- source class: `HUST-OBC/undeciphered/L/4153/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4153/L_？_8999.jpg`
- asset id: `asset-005746`
...
- English observation: A tall left angular trace stands beside a rounded
  right outline containing a small inner mark.
- 中文观察：左侧较高折角痕迹旁有带内部小痕迹的右侧圆弧轮廓。
...
- Which source records identify obs-unk-004153 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004153？
