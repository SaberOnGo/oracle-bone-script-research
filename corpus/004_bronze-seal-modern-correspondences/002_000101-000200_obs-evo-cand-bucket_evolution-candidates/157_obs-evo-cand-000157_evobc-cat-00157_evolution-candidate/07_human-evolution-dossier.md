...
- Project ID: `obs-evo-cand-000157`
- EVOBC category candidate ID: `evobc-evo-cat-00157`
- External category reference: `evobc-cat-00157`
- Source category ID: `00157`
- Source label for human review: `㫏`
- Source codepoints: `U+3ACF`
...
- `obs-evo-cand-000157-route-category-staging`
...
- `obs-evo-cand-000157-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000157-route-evolution-graph`
