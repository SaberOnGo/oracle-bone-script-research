# obs-char-001179 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1179_obs-char-001179_hust-obc-cat-1319_ora
  cle-character/03_visual-assets/001_asset-001184_hust-obc-cat-1319_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1319/G_1319_京津4265.png`
- asset id: `asset-001184`
...
- source category: `1319`
- validation class: `1178`
- source image route: `HUST-OBC/deciphered/1319/G_1319_京津4265.png`
- asset id: `asset-001184`
...
- English observation: `A faint peaked form has two descending side strokes,
  a central lower curve, and a small hooked turn.`
- 中文观察: `较淡的尖顶形体有两条下行侧笔、中央下部弯笔和小型钩转。`
...
- dataset label text: `㤝`
- dataset label codepoints: `U+391D`
...
- Which source records identify obs-char-001179 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001179？
