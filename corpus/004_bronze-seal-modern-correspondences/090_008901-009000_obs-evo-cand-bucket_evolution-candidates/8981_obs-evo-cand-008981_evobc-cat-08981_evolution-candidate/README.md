# obs-evo-cand-008981 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-008981`
- EVOBC category candidate ID: `evobc-evo-cat-08981`
- External category ref: `evobc-cat-08981`
- Source label for human review: `逃`
- Source codepoints: `U+9003`
- Image reference count: `41`
- Era token counts: `BI:4;CS:1;SS:2;WSC:34`
- Source token counts: `Book:12;Web:29`
