...
- External category reference: `evobc-cat-11846`
- Source category ID: `11846`
- Source label for human review: `𥥣`
- Source codepoints: `U+25963`
...
- `obs-evo-cand-011846-route-category-staging`
...
- `obs-evo-cand-011846-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011846-route-evolution-graph`
