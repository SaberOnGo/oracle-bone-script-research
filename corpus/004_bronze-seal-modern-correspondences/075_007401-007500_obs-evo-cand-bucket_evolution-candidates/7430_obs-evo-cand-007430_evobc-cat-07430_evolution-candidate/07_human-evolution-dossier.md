...
Project ID: `obs-evo-cand-007430`
...
- Project ID: `obs-evo-cand-007430`
- EVOBC category candidate ID: `evobc-evo-cat-07430`
- External category reference: `evobc-cat-07430`
- Source category ID: `07430`
- Source label for human review: `菿`
- Source codepoints: `U+83FF`
...
- `obs-evo-cand-007430-route-category-staging`
...
- `obs-evo-cand-007430-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007430-route-evolution-graph`
