...
- `obs-evo-cand-004624-route-category-staging`
...
- `obs-evo-cand-004624-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004624-route-evolution-graph`
