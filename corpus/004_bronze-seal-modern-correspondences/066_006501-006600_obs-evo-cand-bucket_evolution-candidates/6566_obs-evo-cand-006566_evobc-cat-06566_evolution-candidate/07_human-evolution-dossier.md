...
- External category reference: `evobc-cat-06566`
- Source category ID: `06566`
- Source label for human review: `綻`
- Source codepoints: `U+7DBB`
...
- `obs-evo-cand-006566-route-category-staging`
...
- `obs-evo-cand-006566-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006566-route-evolution-graph`
