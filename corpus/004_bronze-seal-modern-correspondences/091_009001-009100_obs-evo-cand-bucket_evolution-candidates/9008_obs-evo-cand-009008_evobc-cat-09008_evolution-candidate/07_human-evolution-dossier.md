...
Project ID: `obs-evo-cand-009008`
...
- Project ID: `obs-evo-cand-009008`
- EVOBC category candidate ID: `evobc-evo-cat-09008`
- External category reference: `evobc-cat-09008`
- Source category ID: `09008`
- Source label for human review: `逭`
- Source codepoints: `U+902D`
...
- `obs-evo-cand-009008-route-category-staging`
...
- `obs-evo-cand-009008-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009008-route-evolution-graph`
