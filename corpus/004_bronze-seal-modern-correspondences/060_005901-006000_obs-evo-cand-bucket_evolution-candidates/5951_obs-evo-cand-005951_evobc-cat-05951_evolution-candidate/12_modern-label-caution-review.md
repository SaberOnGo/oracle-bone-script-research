# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-005951
...
- EVOBC candidate category: `evobc-evo-cat-05951`.
- Source label for search only: `磿`.
- Source codepoints for search only: `U+78FF`.
