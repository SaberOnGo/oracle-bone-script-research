# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008619
...
- EVOBC candidate category: `evobc-evo-cat-08619`.
- Source label for search only: `败`.
- Source codepoints for search only: `U+8D25`.
