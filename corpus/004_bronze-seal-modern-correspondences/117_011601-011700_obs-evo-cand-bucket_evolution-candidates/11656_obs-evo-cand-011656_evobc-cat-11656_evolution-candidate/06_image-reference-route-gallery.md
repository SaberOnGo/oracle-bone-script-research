...
- `obs-evo-cand-011656-route-category-staging`
...
- `obs-evo-cand-011656-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011656-route-evolution-graph`
