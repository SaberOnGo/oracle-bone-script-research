# obs-unk-004498 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/098_obs-unk-004498_h
  ust-obc-und-X-004498_oracle-character-candidate/03_visual-assets/001_asset
  -006091_hust-obc-und-X-004498_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/54/X_？_8238_1.png`
- asset id: `asset-006091`
...
- source class: `HUST-OBC/undeciphered/X/54/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/54/X_？_8238_1.png`
- asset id: `asset-006091`
...
- English observation: `The separate lower-left and upper-right curves, their
  gap, and tapered raster edges are directly recorded.`
- 中文观察: `已直接记录左下与右上分离弧痕、两者间隙和变细的栅格边缘。`
...
- Which source records identify obs-unk-004498 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004498？
