# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000777
...
- EVOBC candidate category: `evobc-evo-cat-00777`.
- Source label for search only: `伟`.
- Source codepoints for search only: `U+4F1F`.
