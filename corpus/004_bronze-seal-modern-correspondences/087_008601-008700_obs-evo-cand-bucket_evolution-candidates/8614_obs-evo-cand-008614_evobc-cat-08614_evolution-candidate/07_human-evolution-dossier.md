...
- External category reference: `evobc-cat-08614`
- Source category ID: `08614`
- Source label for human review: `负`
...
- `obs-evo-cand-008614-route-category-staging`
...
- `obs-evo-cand-008614-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008614-route-evolution-graph`
