# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000049
...
| Glyph or codepoint route / 字形或码位路线 | 31 OBIMD route rows; examples U+4E59;U+F0543; U+F0544; 另有 29 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 31 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
