# Material Visual Observation / obs-comp-cand-000670 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000670`
- External reference / 外部参照: `obimd-sub-qhmhxv0zyb`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013233_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qhmhxv0zyb/qhmhxv0zyb/qhmhxv0zyb.png`
- Checksum / 校验和:
  `3613aba64c530fbc1ae176cda3725366797cc7c588db7121a3f5f5d5d5ca4728`
...
- Marked-pixel bounds: (83,26)–(166,226); span 84 × 201 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.31%。
- 痕迹范围：(83,26)–(166,226)；跨度84 × 201 px；痕迹矩形高于宽。
