...
Project ID: `obs-evo-cand-002147`
...
- Project ID: `obs-evo-cand-002147`
- EVOBC category candidate ID: `evobc-evo-cat-02147`
- External category reference: `evobc-cat-02147`
- Source category ID: `02147`
- Source label for human review: `姻`
- Source codepoints: `U+59FB`
...
- `obs-evo-cand-002147-route-category-staging`
...
- `obs-evo-cand-002147-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002147-route-evolution-graph`
