# obs-unk-005428 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/071_undeciphered-005
  401-005500_obs-unk-bucket_oracle-character-candidates/028_obs-unk-005428_h
  ust-obc-und-X-005428_oracle-character-candidate/03_visual-assets/001_asset
  -007021_hust-obc-und-X-005428_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/984/X_？_7947_1.png`
- asset id: `asset-007021`
...
- source class: `HUST-OBC/undeciphered/X/984/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/984/X_？_7947_1.png`
- asset id: `asset-007021`
...
- Which source records identify obs-unk-005428 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005428？
