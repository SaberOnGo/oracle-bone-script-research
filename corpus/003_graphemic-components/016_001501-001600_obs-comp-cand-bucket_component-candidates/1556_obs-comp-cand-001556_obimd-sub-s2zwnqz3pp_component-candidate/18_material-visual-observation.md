# Material Visual Observation / obs-comp-cand-001556 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001556`
- External reference / 外部参照: `obimd-sub-s2zwnqz3pp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017076_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/f0j9ho8ua2/s2zwnqz3pp/27btpxjt4q.png`
- Checksum / 校验和:
  `6c6808746fa60f2fc0d0fd3799fb2441dcca697a399fc069dee2880523b2e4a4`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.32%.
- Marked-pixel bounds: (81,43)–(168,202); span 88 × 160 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.32%。
- 痕迹范围：(81,43)–(168,202)；跨度88 × 160 px；痕迹矩形高于宽。
