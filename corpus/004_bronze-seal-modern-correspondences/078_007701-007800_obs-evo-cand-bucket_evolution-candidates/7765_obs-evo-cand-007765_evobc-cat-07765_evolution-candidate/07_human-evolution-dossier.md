...
- Project ID: `obs-evo-cand-007765`
- EVOBC category candidate ID: `evobc-evo-cat-07765`
- External category reference: `evobc-cat-07765`
- Source category ID: `07765`
- Source label for human review: `蛺`
- Source codepoints: `U+86FA`
...
- `obs-evo-cand-007765-route-category-staging`
...
- `obs-evo-cand-007765-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007765-route-evolution-graph`
