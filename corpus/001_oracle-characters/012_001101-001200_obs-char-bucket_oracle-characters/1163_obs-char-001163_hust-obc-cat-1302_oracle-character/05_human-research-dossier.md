# obs-char-001163 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001163`
- primary external id: `hust-obc-cat-1302`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1163_obs-char-001163_hust-obc-cat-1302_ora
  cle-character/03_visual-assets/001_asset-001168_hust-obc-cat-1302_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1302/G_1302_京津2769合7927𠂤賓間.png`
- asset id: `asset-001168`
...
- source category: `1302`
- validation class: `1162`
- source image route: `HUST-OBC/deciphered/1302/G_1302_京津2769合7927𠂤賓間.png`
- asset id: `asset-001168`
...
- English observation: `A peaked upper form has a broad horizontal bar, two
  short downward marks, and a rounded lower enclosure.`
- 中文观察: `尖顶上部形体有宽横笔、两条短下行痕迹和圆弧形下部框廓。`
...
- dataset label text: `㤌`
- dataset label codepoints: `U+390C`
...
- filename catalog route clues: `Heji-like filename clue: 合7927
  (G_1302_京津2769合7927𠂤賓間.png)`
...
- Which source records identify obs-char-001163 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001163？
