...
- External category reference: `evobc-cat-00054`
- Source category ID: `00054`
- Source label for human review: `㛗`
...
- `obs-evo-cand-000054-route-category-staging`
...
- `obs-evo-cand-000054-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000054-route-evolution-graph`
