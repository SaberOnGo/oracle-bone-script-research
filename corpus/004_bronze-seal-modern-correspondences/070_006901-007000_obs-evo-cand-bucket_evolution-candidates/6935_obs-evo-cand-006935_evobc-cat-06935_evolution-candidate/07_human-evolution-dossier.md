...
Project ID: `obs-evo-cand-006935`
...
- Project ID: `obs-evo-cand-006935`
- EVOBC category candidate ID: `evobc-evo-cat-06935`
- External category reference: `evobc-cat-06935`
- Source category ID: `06935`
- Source label for human review: `耿`
- Source codepoints: `U+803F`
...
- `obs-evo-cand-006935-route-category-staging`
...
- `obs-evo-cand-006935-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006935-route-evolution-graph`
