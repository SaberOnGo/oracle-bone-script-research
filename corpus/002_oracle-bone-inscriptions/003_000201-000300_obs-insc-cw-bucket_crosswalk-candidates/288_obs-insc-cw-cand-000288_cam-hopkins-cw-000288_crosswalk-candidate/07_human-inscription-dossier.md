...
- Yingguo / 英国所藏: `y1914` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `294` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `403` in source row; primary catalog entry pending
- Heji / 合集: `40890` in source row; primary catalog entry pending
