...
Project ID: `obs-evo-cand-002680`
...
- Project ID: `obs-evo-cand-002680`
- EVOBC category candidate ID: `evobc-evo-cat-02680`
- External category reference: `evobc-cat-02680`
- Source category ID: `02680`
- Source label for human review: `幞`
- Source codepoints: `U+5E5E`
...
- `obs-evo-cand-002680-route-category-staging`
...
- `obs-evo-cand-002680-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002680-route-evolution-graph`
