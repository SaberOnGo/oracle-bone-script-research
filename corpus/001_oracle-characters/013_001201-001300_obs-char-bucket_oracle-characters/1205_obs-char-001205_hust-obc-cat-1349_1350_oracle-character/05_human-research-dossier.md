# obs-char-001205 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1205_obs-char-001205_hust-obc-cat-1349_135
  0_oracle-character/03_visual-assets/001_asset-001210_hust-obc-cat-1349_135
  0_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1349_1350/1349/G_1349_乙8795合319
  41.png`
- asset id: `asset-001210`
...
- source category: `1349_1350`
- validation class: `1204`
- source image route: `HUST-OBC/deciphered/1349_1350/1349/G_1349_乙8795合31941.p
  ng`
- asset id: `asset-001210`
...
- English observation: `A rounded upper enclosure sits above two pairs of
  short branching strokes and pointed lower ends.`
- 中文观察: `圆弧形上部框廓位于两组短分枝笔和尖状下端之上。`
...
- dataset label text: `㤻㤼`
- dataset label codepoints: `U+393B;U+393C`
...
- filename catalog route clues: `Heji-like filename clue: 合31941
  (G_1349_乙8795合31941.png)`
...
- Which source records identify obs-char-001205 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001205？
