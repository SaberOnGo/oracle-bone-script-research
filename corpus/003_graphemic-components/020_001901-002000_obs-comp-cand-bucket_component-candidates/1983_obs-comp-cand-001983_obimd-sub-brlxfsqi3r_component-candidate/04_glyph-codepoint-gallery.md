# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001983
...
| --- | --- | --- | --- |
| `obimd-glyph-link-030158` | 󻖄 | `U+FB584` | `reviewed_metadata_only` |
| `obimd-glyph-link-030159` | 󻖅 | `U+FB585` | `reviewed_metadata_only` |
