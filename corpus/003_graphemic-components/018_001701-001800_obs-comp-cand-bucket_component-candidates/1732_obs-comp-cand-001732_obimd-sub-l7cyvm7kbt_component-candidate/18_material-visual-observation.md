# Material Visual Observation / obs-comp-cand-001732 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001732`
- External reference / 外部参照: `obimd-sub-l7cyvm7kbt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017917_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/l7cyvm7kbt/l7cyvm7kbt/308alvh4ph.png`
- Checksum / 校验和:
  `26ffb8050f7768c2429499cc2ead185119db5a61f9e7d7e2f9d9e6cb17b9023a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.06%.
- Marked-pixel bounds: (57,85)–(192,158); span 136 × 74 px; the marked rectangle
  is wider than tall.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.06%。
- 痕迹范围：(57,85)–(192,158)；跨度136 × 74 px；痕迹矩形宽于高。
