...
- External category reference: `evobc-cat-09858`
- Source category ID: `09858`
- Source label for human review: `霑`
...
- `obs-evo-cand-009858-route-category-staging`
...
- `obs-evo-cand-009858-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009858-route-evolution-graph`
