...
- External category reference: `evobc-cat-01471`
- Source category ID: `01471`
- Source label for human review: `古`
- Source codepoints: `U+53E4`
- Image reference count in source metadata: `316`
...
- `obs-evo-cand-001471-route-category-staging`
...
- `obs-evo-cand-001471-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001471-route-evolution-graph`
