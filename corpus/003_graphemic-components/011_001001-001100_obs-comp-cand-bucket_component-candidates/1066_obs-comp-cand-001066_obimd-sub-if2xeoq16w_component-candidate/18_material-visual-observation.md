# Material Visual Observation / obs-comp-cand-001066 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001066`
- External reference / 外部参照: `obimd-sub-if2xeoq16w`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014616_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/if2xeoq16w/if2xeoq16w/if2xeoq16w.png`
- Checksum / 校验和:
  `b3e8745e4ea20acac2aae8194e2b42bacb51787c14cc0565d1bcb3139bf1a832`
...
- Marked-pixel bounds: (65,38)–(184,216); span 120 × 179 px; the marked
...
- 痕迹范围：(65,38)–(184,216)；跨度120 × 179 px；痕迹矩形高于宽。
