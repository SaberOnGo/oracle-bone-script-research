...
Project ID: `obs-evo-cand-004409`
...
- Project ID: `obs-evo-cand-004409`
- EVOBC category candidate ID: `evobc-evo-cat-04409`
- External category reference: `evobc-cat-04409`
- Source category ID: `04409`
- Source label for human review: `殊`
- Source codepoints: `U+6B8A`
...
- `obs-evo-cand-004409-route-category-staging`
...
- `obs-evo-cand-004409-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004409-route-evolution-graph`
