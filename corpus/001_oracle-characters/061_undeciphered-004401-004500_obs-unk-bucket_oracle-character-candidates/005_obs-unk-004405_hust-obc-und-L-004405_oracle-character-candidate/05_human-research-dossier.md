# obs-unk-004405 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004405`
- primary external id: `hust-obc-und-L-004405`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/005_obs-unk-004405_h
  ust-obc-und-L-004405_oracle-character-candidate/03_visual-assets/001_asset
  -005998_hust-obc-und-L-004405_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4405/L_？_9835.jpg`
- asset id: `asset-005998`
...
- source class: `HUST-OBC/undeciphered/L/4405/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4405/L_？_9835.jpg`
- asset id: `asset-005998`
...
- English observation: `A rounded upper form sits above a stem and two`
  `lower diagonal projections.`
- 中文观察: `上部圆弧形状位于中央痕和两条下部斜向伸出痕上方。`
...
- Which source records identify obs-unk-004405 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004405？
