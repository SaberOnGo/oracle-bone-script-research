# Material Visual Observation / obs-comp-cand-001166 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001166`
- External reference / 外部参照: `obimd-sub-piqtpz29xl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015356_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/piqtpz29xl/piqtpz29xl/piqtpz29xl.png`
- Checksum / 校验和:
  `cea0ef24fe3a31bbb296a9c471bb12b419731f9c0be3c46141203b76bf4b92a9`
...
- Marked-pixel bounds: (91,36)–(158,218); span 68 × 183 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.98%。
- 痕迹范围：(91,36)–(158,218)；跨度68 × 183 px；痕迹矩形高于宽。
