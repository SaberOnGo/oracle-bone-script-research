...
- External category reference: `evobc-cat-09033`
- Source category ID: `09033`
- Source label for human review: `遒`
...
- `obs-evo-cand-009033-route-category-staging`
...
- `obs-evo-cand-009033-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009033-route-evolution-graph`
