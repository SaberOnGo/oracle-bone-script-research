# obs-unk-004906 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/006_obs-unk-004906_h
  ust-obc-und-X-004906_oracle-character-candidate/03_visual-assets/001_asset
  -006499_hust-obc-und-X-004906_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/462/X_？_7444_1.png`
- asset id: `asset-006499`
...
- A right upright has a lower branch and several curved descenders.
- The source packet expects ten views; one local view is present.
- 直接记录：`14_material-visual-observation.md`
- 已打开图像左侧外轮廓内可见两个浅色开口。
- 右侧直立笔画下部有分枝和数条弧形下行笔画。
- 来源包记录应有十个视图；当前仅有一个本地图像。
...
- source class: `HUST-OBC/undeciphered/X/462/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/462/X_？_7444_1.png`
- asset id: `asset-006499`
...
- Which source records identify obs-unk-004906 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004906？
