# Material Visual Observation / obs-comp-cand-001670 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001670`
- External reference / 外部参照: `obimd-sub-ki5ox0jyx5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017539_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cixqnyxp9v/ki5ox0jyx5/1ebg3i36cb.png`
- Checksum / 校验和:
  `d4eb0d0e21397b2b7b005903057b28073e4d21eec5cbc3c0738ed3fdeeb918c0`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.91%.
- Marked-pixel bounds: (82,29)–(167,214); span 86 × 186 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.91%。
- 痕迹范围：(82,29)–(167,214)；跨度86 × 186 px；痕迹矩形高于宽。
