# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002212
...
| Glyph or codepoint route / 字形或码位路线 | 3 OBIMD route rows; examples U+FCBED; U+FCBEE; 另有 1 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
