...
Project ID: `obs-evo-cand-012655`
...
- Project ID: `obs-evo-cand-012655`
- EVOBC category candidate ID: `evobc-evo-cat-12655`
- External category reference: `evobc-cat-12655`
- Source category ID: `12655`
- Source label for human review: `𩣌`
- Source codepoints: `U+298CC`
...
- `obs-evo-cand-012655-route-category-staging`
...
- `obs-evo-cand-012655-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012655-route-evolution-graph`
