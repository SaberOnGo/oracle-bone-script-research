...
- Project ID: `obs-evo-cand-002929`
- EVOBC category candidate ID: `evobc-evo-cat-02929`
- External category reference: `evobc-cat-02929`
- Source category ID: `02929`
- Source label for human review: `怊`
- Source codepoints: `U+600A`
...
- `obs-evo-cand-002929-route-category-staging`
...
- `obs-evo-cand-002929-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002929-route-evolution-graph`
