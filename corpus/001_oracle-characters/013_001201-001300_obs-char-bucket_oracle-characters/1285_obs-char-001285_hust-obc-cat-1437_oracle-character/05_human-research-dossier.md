# obs-char-001285 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1285_obs-char-001285_hust-obc-cat-1437_ora
  cle-character/03_visual-assets/001_asset-001290_hust-obc-cat-1437_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1437/G_1437_乙324合21622子組.png`
- asset id: `asset-001290`
...
- source category: `1437`
- validation class: `1284`
- source image route: `HUST-OBC/deciphered/1437/G_1437_乙324合21622子組.png`
- asset id: `asset-001290`
...
- English observation: `Two broad pointed curves face inward, leaving an
  open central gap and a narrow lower junction.`
...
- dataset label text: `㦓`
- dataset label codepoints: `U+3993`
...
- Which source records identify obs-char-001285 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001285？
