# Material Visual Observation / obs-comp-cand-000613 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000613`
- External reference / 外部参照: `obimd-sub-nynbz4agj2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013176_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/z403ojus93/nynbz4agj2/nynbz4agj2.png`
- Checksum / 校验和:
  `afa65ccd0b5c6000c7673abe2711187c9e074dd1f854acb4c4f8b84fe46ac80d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.92%.
- Marked-pixel bounds: (80,20)–(170,227); span 91 × 208 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.92%。
- 痕迹范围：(80,20)–(170,227)；跨度91 × 208 px；痕迹矩形高于宽。
