...
- External category reference: `evobc-cat-09679`
- Source category ID: `09679`
- Source label for human review: `闹`
...
- `obs-evo-cand-009679-route-category-staging`
...
- `obs-evo-cand-009679-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009679-route-evolution-graph`
