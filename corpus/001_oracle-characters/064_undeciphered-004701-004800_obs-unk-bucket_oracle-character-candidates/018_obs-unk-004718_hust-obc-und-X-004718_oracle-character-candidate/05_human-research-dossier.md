# obs-unk-004718 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/018_obs-unk-004718_h
  ust-obc-und-X-004718_oracle-character-candidate/03_visual-assets/001_asset
  -006311_hust-obc-und-X-004718_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/274/X_？_7247_1.png`
- asset id: `asset-006311`
...
- source class: `HUST-OBC/undeciphered/X/274/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/274/X_？_7247_1.png`
- asset id: `asset-006311`
...
- English observation: `long upper horizontal with lower curved hook`
- 中文观察: `带下部弯钩的上部长横笔画`
...
- Which source records identify obs-unk-004718 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004718？
