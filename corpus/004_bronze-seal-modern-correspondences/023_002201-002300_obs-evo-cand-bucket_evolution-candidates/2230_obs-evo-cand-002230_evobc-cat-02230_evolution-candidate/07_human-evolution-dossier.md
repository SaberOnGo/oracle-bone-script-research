...
- External category reference: `evobc-cat-02230`
- Source category ID: `02230`
- Source label for human review: `媓`
...
- `obs-evo-cand-002230-route-category-staging`
...
- `obs-evo-cand-002230-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002230-route-evolution-graph`
