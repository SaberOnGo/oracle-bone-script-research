...
- Yingguo / 英国所藏: `y1011` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `4` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `474` in source row; primary catalog entry pending
- Heji / 合集: `40302` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000169`
