# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008352
...
- EVOBC candidate category: `evobc-evo-cat-08352`.
- Source label for search only: `譌`.
- Source codepoints for search only: `U+8B4C`.
