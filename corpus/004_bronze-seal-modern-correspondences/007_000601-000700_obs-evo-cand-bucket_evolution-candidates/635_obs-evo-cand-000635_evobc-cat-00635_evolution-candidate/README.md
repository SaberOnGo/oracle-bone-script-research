# obs-evo-cand-000635 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-00635`
- Source label: `中`
- Source codepoints: `U+4E2D`
- Image reference count: `426`
- Era token counts: `BI:96;CS:3;OBC:144;SAC:24;SS:4;WSC:155`
- Source token counts: `Book:171;Web:255`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 144 image references
- era 1 / BI: 96 image references
- era 2 / SS: 4 image references
- era 3 / SAC: 24 image references
- era 4 / WSC: 155 image references
- era 5 / CS: 3 image references
- source 0 / Web:1633: 3 image references
- source 1 / Web:105952;說文Web:58: 192 image references
- source 2 / Book:17600: 27 image references
- source 3 / Book:21681: 42 image references
- source 4 / Book:9131: 24 image references
- source 5 / Book:32794: 62 image references
