...
Project ID: `obs-evo-cand-009460`
...
- Project ID: `obs-evo-cand-009460`
- EVOBC category candidate ID: `evobc-evo-cat-09460`
- External category reference: `evobc-cat-09460`
- Source category ID: `09460`
- Source label for human review: `鍥`
- Source codepoints: `U+9365`
...
- `obs-evo-cand-009460-route-category-staging`
...
- `obs-evo-cand-009460-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009460-route-evolution-graph`
