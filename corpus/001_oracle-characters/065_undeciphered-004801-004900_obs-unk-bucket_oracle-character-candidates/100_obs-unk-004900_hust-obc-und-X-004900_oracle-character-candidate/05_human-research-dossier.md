# obs-unk-004900 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/100_obs-unk-004900_h
  ust-obc-und-X-004900_oracle-character-candidate/03_visual-assets/001_asset
  -006493_hust-obc-und-X-004900_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/456/X_？_7436_1.png`
- asset id: `asset-006493`
...
- source class: `HUST-OBC/undeciphered/X/456/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/456/X_？_7436_1.png`
- asset id: `asset-006493`
...
- English observation: `central branching stroke and flanking marks`
- 中文观察: `中央分枝长笔画和两侧标记`
...
- Which source records identify obs-unk-004900 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004900？
