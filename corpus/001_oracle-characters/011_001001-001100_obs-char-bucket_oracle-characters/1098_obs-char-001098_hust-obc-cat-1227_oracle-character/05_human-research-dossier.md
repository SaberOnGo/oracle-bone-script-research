# obs-char-001098 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001098`
- primary external id: `hust-obc-cat-1227`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1098_obs-char-001098_hust-obc-cat-1227_ora
  cle-character/03_visual-assets/001_asset-001103_hust-obc-cat-1227_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1227/G_1227_乙7012(甲).png`
- asset id: `asset-001103`
...
- source category: `1227`
- validation class: `1097`
- source image route: `HUST-OBC/deciphered/1227/G_1227_乙7012(甲).png`
- asset id: `asset-001103`
...
- English observation: `A narrow form has an upper crossing, a small central
  enclosure, and two long lower branching strokes.`
- 中文观察: `狭长形体有上部交叉、小型中央闭合笔和两条长下部分枝。`
...
- dataset label text: `㣁`
- dataset label codepoints: `U+38C1`
...
- Which source records identify obs-char-001098 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001098？
