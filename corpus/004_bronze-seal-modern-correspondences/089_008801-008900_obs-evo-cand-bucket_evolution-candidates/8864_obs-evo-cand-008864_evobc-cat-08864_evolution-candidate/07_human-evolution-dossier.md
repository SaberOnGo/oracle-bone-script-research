...
Project ID: `obs-evo-cand-008864`
...
- Project ID: `obs-evo-cand-008864`
- EVOBC category candidate ID: `evobc-evo-cat-08864`
- External category reference: `evobc-cat-08864`
- Source category ID: `08864`
- Source label for human review: `轄`
- Source codepoints: `U+8F44`
...
- `obs-evo-cand-008864-route-category-staging`
...
- `obs-evo-cand-008864-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008864-route-evolution-graph`
