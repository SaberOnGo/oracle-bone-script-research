# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001527
...
| Glyph or codepoint route / 字形或码位路线 | 452 OBIMD route rows; examples U+2BE49;U+F8D5B; U+F8D5C; 另有 450 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 452 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
