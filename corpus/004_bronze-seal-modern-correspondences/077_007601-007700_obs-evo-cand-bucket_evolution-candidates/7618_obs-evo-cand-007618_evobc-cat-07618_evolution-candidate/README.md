# obs-evo-cand-007618 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-007618`
- EVOBC category candidate ID: `evobc-evo-cat-07618`
- External category ref: `evobc-cat-07618`
- Source label for human review: `薦`
- Source codepoints: `U+85A6`
- Image reference count: `92`
- Era token counts: `BI:11;OBC:64;SAC:6;WSC:11`
- Source token counts: `Book:35;Web:57`
