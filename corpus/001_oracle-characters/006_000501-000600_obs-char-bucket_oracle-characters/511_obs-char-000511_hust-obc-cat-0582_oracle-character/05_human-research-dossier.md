# obs-char-000511 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/511_obs-char-000511_hust-obc-cat-0582_orac
  le-character/03_visual-assets/001_asset-000516_hust-obc-cat-0582_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0582/G_0582_前7.14.2(甲).png`
- asset id: `asset-000516`
...
- source category: `0582`
- validation class: `510`
- source image route: `HUST-OBC/deciphered/0582/G_0582_前7.14.2(甲).png`
- asset id: `asset-000516`
...
- dataset label text: `㘼`
- dataset label codepoints: `U+363C`
...
- Which source records identify obs-char-000511 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000511？
