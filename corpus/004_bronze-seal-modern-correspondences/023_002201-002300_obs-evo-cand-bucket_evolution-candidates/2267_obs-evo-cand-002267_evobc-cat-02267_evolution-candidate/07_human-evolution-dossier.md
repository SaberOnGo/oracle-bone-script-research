...
- External category reference: `evobc-cat-02267`
- Source category ID: `02267`
- Source label for human review: `嫛`
- Source codepoints: `U+5ADB`
...
- `obs-evo-cand-002267-route-category-staging`
...
- `obs-evo-cand-002267-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002267-route-evolution-graph`
