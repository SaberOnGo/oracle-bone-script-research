...
- External category reference: `evobc-cat-08498`
- Source category ID: `08498`
- Source label for human review: `豩`
...
- `obs-evo-cand-008498-route-category-staging`
...
- `obs-evo-cand-008498-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008498-route-evolution-graph`
