...
- Project ID: `obs-evo-cand-005645`
- EVOBC category candidate ID: `evobc-evo-cat-05645`
- External category reference: `evobc-cat-05645`
- Source category ID: `05645`
- Source label for human review: `痞`
- Source codepoints: `U+75DE`
...
- `obs-evo-cand-005645-route-category-staging`
...
- `obs-evo-cand-005645-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005645-route-evolution-graph`
