...
- External category reference: `evobc-cat-01260`
- Source category ID: `01260`
- Source label for human review: `劓`
- Source codepoints: `U+5293`
...
- `obs-evo-cand-001260-route-category-staging`
...
- `obs-evo-cand-001260-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001260-route-evolution-graph`
