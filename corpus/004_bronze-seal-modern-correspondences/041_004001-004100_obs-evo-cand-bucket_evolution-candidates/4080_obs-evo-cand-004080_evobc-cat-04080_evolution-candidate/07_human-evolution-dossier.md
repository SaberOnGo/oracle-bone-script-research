...
- External category reference: `evobc-cat-04080`
- Source category ID: `04080`
- Source label for human review: `梲`
- Source codepoints: `U+68B2`
...
- `obs-evo-cand-004080-route-category-staging`
...
- `obs-evo-cand-004080-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004080-route-evolution-graph`
