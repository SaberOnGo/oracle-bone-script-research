# obs-unk-002619 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002619`
- primary external id: `hust-obc-und-L-002619`
...
- local review image route: `corpus/001_oracle-characters/043_undeciphered-002
  601-002700_obs-unk-bucket_oracle-character-candidates/019_obs-unk-002619_h
  ust-obc-und-L-002619_oracle-character-candidate/03_visual-assets/001_asset
  -004212_hust-obc-und-L-002619_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2619/L_？_4062.jpg`
- asset id: `asset-004212`
...
- source class: `HUST-OBC/undeciphered/L/2619/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2619/L_？_4062.jpg`
- asset id: `asset-004212`
...
- Which source records identify obs-unk-002619 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002619？
