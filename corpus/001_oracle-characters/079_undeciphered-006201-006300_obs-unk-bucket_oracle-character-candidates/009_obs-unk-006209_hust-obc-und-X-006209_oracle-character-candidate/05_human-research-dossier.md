# obs-unk-006209 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006209`
- primary external id: `hust-obc-und-X-006209`
...
- local review image route: `corpus/001_oracle-characters/079_undeciphered-006
  201-006300_obs-unk-bucket_oracle-character-candidates/009_obs-unk-006209_h
  ust-obc-und-X-006209_oracle-character-candidate/03_visual-assets/001_asset
  -007801_hust-obc-und-X-006209_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1765/X_？_4429_1.png`
- asset id: `asset-007801`
...
- source class: `HUST-OBC/undeciphered/X/1765/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1765/X_？_4429_1.png`
- asset id: `asset-007801`
...
- Which source records identify obs-unk-006209 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006209？
