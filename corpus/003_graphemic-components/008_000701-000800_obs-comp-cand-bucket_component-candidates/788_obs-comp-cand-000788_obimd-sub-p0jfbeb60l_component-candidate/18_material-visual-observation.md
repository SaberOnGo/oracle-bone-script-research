# Material Visual Observation / obs-comp-cand-000788 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000788`
- External reference / 外部参照: `obimd-sub-p0jfbeb60l`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013587_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6p9s6p6wyb/p0jfbeb60l/p0jfbeb60l.png`
- Checksum / 校验和:
  `019593eecc742b4e23c11e15a4e9aa6dde50127e4ce0d9bcbe7b3f4376aef3a2`
...
- Marked-pixel bounds: (71,26)–(178,225); span 108 × 200 px; the marked
...
- 痕迹范围：(71,26)–(178,225)；跨度108 × 200 px；痕迹矩形高于宽。
