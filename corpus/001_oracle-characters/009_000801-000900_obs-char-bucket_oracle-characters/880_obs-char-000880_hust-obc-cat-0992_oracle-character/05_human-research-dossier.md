# obs-char-000880 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000880`
- primary external id: `hust-obc-cat-0992`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/880_obs-char-000880_hust-obc-cat-0992_orac
  le-character/03_visual-assets/001_asset-000885_hust-obc-cat-0992_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0992/H_0992_606FF_0.png`
- asset id: `asset-000885`
...
- source category: `0992`
- validation class: `879`
- source image route: `HUST-OBC/deciphered/0992/H_0992_606FF_0.png`
- asset id: `asset-000885`
...
- English observation: `Two broad outer vertical curves flank a central
  branching stem; two long lower diagonals end in horizontal feet, with
  short detached blocks around them.`
- 中文观察: `两条宽大外侧弯曲竖笔分列中央分枝笔干两旁；两条长下斜笔以横向笔足收尾，周围有分离块状痕迹。`
...
- dataset label text: `㟖`
- dataset label codepoints: `U+37D6`
...
- filename catalog route clues: `catalog-like filename clue: H_0992
  (H_0992_606FF_0.png)`
...
- Which source records identify obs-char-000880 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000880？
