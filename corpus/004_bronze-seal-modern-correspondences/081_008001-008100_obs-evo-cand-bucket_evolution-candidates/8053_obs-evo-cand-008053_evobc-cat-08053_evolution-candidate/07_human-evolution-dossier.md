...
Project ID: `obs-evo-cand-008053`
...
- Project ID: `obs-evo-cand-008053`
- EVOBC category candidate ID: `evobc-evo-cat-08053`
- External category reference: `evobc-cat-08053`
- Source category ID: `08053`
- Source label for human review: `覆`
- Source codepoints: `U+8986`
...
- `obs-evo-cand-008053-route-category-staging`
...
- `obs-evo-cand-008053-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008053-route-evolution-graph`
