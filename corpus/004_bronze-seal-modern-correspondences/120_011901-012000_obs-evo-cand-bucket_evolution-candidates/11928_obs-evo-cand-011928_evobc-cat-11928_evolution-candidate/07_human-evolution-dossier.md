...
- External category reference: `evobc-cat-11928`
- Source category ID: `11928`
- Source label: `𥾠`
...
- `obs-evo-cand-011928-route-category-staging`
...
- `obs-evo-cand-011928-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011928-route-evolution-graph`
