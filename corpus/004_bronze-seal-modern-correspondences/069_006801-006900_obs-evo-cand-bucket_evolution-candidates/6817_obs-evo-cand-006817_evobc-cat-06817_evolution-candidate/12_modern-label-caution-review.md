# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006817
...
- EVOBC candidate category: `evobc-evo-cat-06817`.
- Source label for search only: `罭`.
- Source codepoints for search only: `U+7F6D`.
