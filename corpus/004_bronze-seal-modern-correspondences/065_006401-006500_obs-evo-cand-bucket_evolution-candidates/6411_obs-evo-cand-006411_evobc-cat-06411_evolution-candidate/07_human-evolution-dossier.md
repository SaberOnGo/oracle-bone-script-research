...
- External category reference: `evobc-cat-06411`
- Source category ID: `06411`
- Source label: `粺`
...
- `obs-evo-cand-006411-route-category-staging`
...
- `obs-evo-cand-006411-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006411-route-evolution-graph`
