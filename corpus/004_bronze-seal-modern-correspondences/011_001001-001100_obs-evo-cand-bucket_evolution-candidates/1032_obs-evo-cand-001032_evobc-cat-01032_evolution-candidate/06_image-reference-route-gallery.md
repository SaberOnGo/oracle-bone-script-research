...
- `obs-evo-cand-001032-route-category-staging`
...
- `obs-evo-cand-001032-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001032-route-evolution-graph`
