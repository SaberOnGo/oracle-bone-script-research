...
- External category reference: `evobc-cat-08990`
- Source category ID: `08990`
- Source label for human review: `逐`
- Source codepoints: `U+9010`
- Image reference count in source metadata: `215`
...
- `obs-evo-cand-008990-route-category-staging`
...
- `obs-evo-cand-008990-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008990-route-evolution-graph`
