...
- External category reference: `evobc-cat-02754`
- Source category ID: `02754`
- Source label for human review: `廏`
- Source codepoints: `U+5ECF`
...
- `obs-evo-cand-002754-route-category-staging`
...
- `obs-evo-cand-002754-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002754-route-evolution-graph`
