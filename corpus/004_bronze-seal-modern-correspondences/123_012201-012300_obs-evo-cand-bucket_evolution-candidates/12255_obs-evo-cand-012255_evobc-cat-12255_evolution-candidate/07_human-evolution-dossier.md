...
Project ID: `obs-evo-cand-012255`
...
- Project ID: `obs-evo-cand-012255`
- EVOBC category candidate ID: `evobc-evo-cat-12255`
- External category reference: `evobc-cat-12255`
- Source category ID: `12255`
- Source label for human review: `𧬼`
- Source codepoints: `U+27B3C`
...
- `obs-evo-cand-012255-route-category-staging`
...
- `obs-evo-cand-012255-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012255-route-evolution-graph`
