...
- External category reference: `evobc-cat-02967`
- Source category ID: `02967`
- Source label for human review: `恉`
- Source codepoints: `U+6049`
...
- `obs-evo-cand-002967-route-category-staging`
...
- `obs-evo-cand-002967-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002967-route-evolution-graph`
