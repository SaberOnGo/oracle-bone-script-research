...
Project ID: `obs-evo-cand-000365`
...
- Project ID: `obs-evo-cand-000365`
- EVOBC category candidate ID: `evobc-evo-cat-00365`
- External category reference: `evobc-cat-00365`
- Source category ID: `00365`
- Source label for human review: `䐤`
- Source codepoints: `U+4424`
...
- `obs-evo-cand-000365-route-category-staging`
...
- `obs-evo-cand-000365-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000365-route-evolution-graph`
