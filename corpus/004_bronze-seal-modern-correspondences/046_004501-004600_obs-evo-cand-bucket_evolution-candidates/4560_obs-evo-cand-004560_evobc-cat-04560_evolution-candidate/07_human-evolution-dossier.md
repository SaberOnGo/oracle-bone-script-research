...
Project ID: `obs-evo-cand-004560`
...
- Project ID: `obs-evo-cand-004560`
- EVOBC category candidate ID: `evobc-evo-cat-04560`
- External category reference: `evobc-cat-04560`
- Source category ID: `04560`
- Source label for human review: `沸`
- Source codepoints: `U+6CB8`
...
- `obs-evo-cand-004560-route-category-staging`
...
- `obs-evo-cand-004560-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004560-route-evolution-graph`
