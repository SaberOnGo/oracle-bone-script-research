# obs-char-001034 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001034`
- primary external id: `hust-obc-cat-1159`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1034_obs-char-001034_hust-obc-cat-1159_ora
  cle-character/03_visual-assets/001_asset-001039_hust-obc-cat-1159_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1159/G_1159_前6.56.2(甲).png`
- asset id: `asset-001039`
...
- source category: `1159`
- validation class: `1033`
- source image route: `HUST-OBC/deciphered/1159/G_1159_前6.56.2(甲).png`
- asset id: `asset-001039`
...
- English observation: `A thin branching upper stem continues into a long
  central curve beside a small rectangular lower mark.`
- 中文观察: `纤细分枝上部笔干继续为长中央弯笔，旁侧有小型矩形下部笔。`
...
- dataset label text: `㡽`
- dataset label codepoints: `U+387D`
...
- Which source records identify obs-char-001034 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001034？
