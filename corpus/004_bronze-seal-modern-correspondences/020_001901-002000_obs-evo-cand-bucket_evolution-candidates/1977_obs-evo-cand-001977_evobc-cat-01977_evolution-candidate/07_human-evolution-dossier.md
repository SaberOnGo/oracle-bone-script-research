...
Project ID: `obs-evo-cand-001977`
...
- Project ID: `obs-evo-cand-001977`
- EVOBC category candidate ID: `evobc-evo-cat-01977`
- External category reference: `evobc-cat-01977`
- Source category ID: `01977`
- Source label for human review: `壶`
- Source codepoints: `U+58F6`
...
- `obs-evo-cand-001977-route-category-staging`
...
- `obs-evo-cand-001977-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001977-route-evolution-graph`
