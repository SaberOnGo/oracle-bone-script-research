...
- External category reference: `evobc-cat-11460`
- Source category ID: `11460`
- Source label for human review: `𣢘`
- Source codepoints: `U+23898`
...
- `obs-evo-cand-011460-route-category-staging`
...
- `obs-evo-cand-011460-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011460-route-evolution-graph`
