...
Project ID: `obs-evo-cand-002513`
...
- Project ID: `obs-evo-cand-002513`
- EVOBC category candidate ID: `evobc-evo-cat-02513`
- External category reference: `evobc-cat-02513`
- Source category ID: `02513`
- Source label for human review: `屟`
- Source codepoints: `U+5C5F`
...
- `obs-evo-cand-002513-route-category-staging`
...
- `obs-evo-cand-002513-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002513-route-evolution-graph`
