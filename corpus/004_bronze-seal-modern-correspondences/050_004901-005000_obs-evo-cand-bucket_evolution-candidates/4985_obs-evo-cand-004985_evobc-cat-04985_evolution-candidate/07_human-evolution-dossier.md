...
Project ID: `obs-evo-cand-004985`
...
- Project ID: `obs-evo-cand-004985`
- EVOBC category candidate ID: `evobc-evo-cat-04985`
- External category reference: `evobc-cat-04985`
- Source category ID: `04985`
- Source label for human review: `瀏`
- Source codepoints: `U+700F`
...
- `obs-evo-cand-004985-route-category-staging`
...
- `obs-evo-cand-004985-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004985-route-evolution-graph`
