# obs-char-000172 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/172_obs-char-000172_hust-obc-cat-0188_orac
  le-character/03_visual-assets/001_asset-000177_hust-obc-cat-0188_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0188/G_0188_乙139合19983𠂤組.png`
- asset id: `asset-000177`
...
- source category: `0188`
- validation class: `171`
- source image route: `HUST-OBC/deciphered/0188/G_0188_乙139合19983𠂤組.png`
- asset id: `asset-000177`
...
- English observation: `The narrow image has a long central descending
  stroke, short upper side marks, and a branching projection toward the
  right at mid-height.`
- 中文观察: `狭长图像中部有长下行主笔，上方有短侧痕，中部高度向右伸出分支。`
...
- dataset label text: `㒲`
- dataset label codepoints: `U+34B2`
...
- Which source records identify obs-char-000172 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000172？
