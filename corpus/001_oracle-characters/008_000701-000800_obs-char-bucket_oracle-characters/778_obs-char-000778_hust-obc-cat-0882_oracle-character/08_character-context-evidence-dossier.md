...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0882`
...
- Source image / 来源图: `G_0882_京津3728合26779出組.png`
- Image / 图像: `001_asset-000783_hust-obc-cat-0882_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合26779
...
- target node: `evobc-evo-cat-00072`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/072_obs-evo-cand-000072_evobc-cat-00072_evoluti
...
- Source label text / 来源标签文字: `㝨`
- Source label codepoint / 来源标签 codepoint: `U+3768`
