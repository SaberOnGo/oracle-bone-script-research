# obs-char-001527 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1527_obs-char-001527_hust-obc-cat-1713_ora
  cle-character/03_visual-assets/001_asset-001532_hust-obc-cat-1713_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1713/G_1713_七76.png`
- asset id: `asset-001532`
...
- source category: `1713`
- validation class: `1526`
- source image route: `HUST-OBC/deciphered/1713/G_1713_七76.png`
- asset id: `asset-001532`
...
- English observation: `Two separated angular forms include a crossed
  enclosure on the left and open strokes on the right.`
...
- dataset label text: `㪧`
- dataset label codepoints: `U+3AA7`
...
- Which source records identify obs-char-001527 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001527？
