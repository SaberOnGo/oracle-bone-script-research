# obs-char-001557 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001557`
- primary external id: `hust-obc-cat-1748`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1557_obs-char-001557_hust-obc-cat-1748_ora
  cle-character/03_visual-assets/001_asset-001562_hust-obc-cat-1748_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1748/L_1748_6326.jpg`
- asset id: `asset-001562`
...
- source category: `1748`
- validation class: `1556`
- source image route: `HUST-OBC/deciphered/1748/L_1748_6326.jpg`
- asset id: `asset-001562`
...
- English observation: `A very faint small form has an upper cross, a
  central loop, and a lower diagonal.`
- 中文观察: `极浅淡的小型形体有上部交叉、中央环形和下部斜笔。`
...
- dataset label text: `㫊`
- dataset label codepoints: `U+3ACA`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00155`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00155`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00155`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/155_obs-evo-can
  d-000155_evobc-cat-00155_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/155_obs-evo-cand-000155_evobc-cat-00155_evolu
...
- Which source records identify obs-char-001557 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001557？
