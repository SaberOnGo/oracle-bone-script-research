# obs-evo-cand-008938 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-08938`
- Source label for human review: `迅`
- Source codepoints: `U+8FC5`
- Image reference count: `71`
- Era token counts: `OBC:69;SS:2`
- Source token counts: `Book:4;Web:67`
