# obs-char-001342 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001342`
- primary external id: `hust-obc-cat-1498`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1342_obs-char-001342_hust-obc-cat-1498_ora
  cle-character/03_visual-assets/001_asset-001347_hust-obc-cat-1498_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1498/G_1498_甲骨文0.png`
- asset id: `asset-001347`
...
- source category: `1498`
- validation class: `1341`
- source image route: `HUST-OBC/deciphered/1498/G_1498_甲骨文0.png`
- asset id: `asset-001347`
...
- English observation: `A symmetrical stacked form combines two rounded
  rectangular sections with pointed upper and lower ends.`
- 中文观察: `近对称上下排列形体结合两个圆折矩形段，上下端均呈尖状。`
...
- dataset label text: `㧐`
- dataset label codepoints: `U+39D0`
...
- Which source records identify obs-char-001342 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001342？
