# obs-char-001395 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1395_obs-char-001395_hust-obc-cat-1560_ora
  cle-character/03_visual-assets/001_asset-001400_hust-obc-cat-1560_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1560/G_1560_甲骨文.png`
- asset id: `asset-001400`
...
- source category: `1560`
- validation class: `1394`
- source image route: `HUST-OBC/deciphered/1560/G_1560_甲骨文.png`
- asset id: `asset-001400`
...
- English observation: `Two adjacent branching forms have angular upper
  loops and repeated side strokes.`
- 中文观察: `相邻两个分枝形体有角状上部环形和重复侧部笔画。`
...
- dataset label text: `㨎`
- dataset label codepoints: `U+3A0E`
...
- Which source records identify obs-char-001395 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001395？
