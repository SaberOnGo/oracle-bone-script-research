...
- Project ID: `obs-evo-cand-004800`
- EVOBC category candidate ID: `evobc-evo-cat-04800`
- External category reference: `evobc-cat-04800`
- Source category ID: `04800`
- Source label for human review: `湿`
- Source codepoints: `U+6E7F`
...
- `obs-evo-cand-004800-route-category-staging`
...
- `obs-evo-cand-004800-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004800-route-evolution-graph`
