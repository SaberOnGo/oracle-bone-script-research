# obs-unk-004699 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004699`
- primary external id: `hust-obc-und-X-004699`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/099_obs-unk-004699_h
  ust-obc-und-X-004699_oracle-character-candidate/03_visual-assets/001_asset
  -006292_hust-obc-und-X-004699_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/255/X_？_7228_1.png`
- asset id: `asset-006292`
...
- source class: `HUST-OBC/undeciphered/X/255/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/255/X_？_7228_1.png`
- asset id: `asset-006292`
...
- English observation: `arched upper strokes with lower opening; view pending`
- 中文观察: `带下部开口的拱形上部笔画，视图待取`
...
- Which source records identify obs-unk-004699 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004699？
