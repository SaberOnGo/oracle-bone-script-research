...
- `obs-evo-cand-011491-route-category-staging`
...
- `obs-evo-cand-011491-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011491-route-evolution-graph`
