...
- External category reference: `evobc-cat-02276`
- Source category ID: `02276`
- Source label for human review: `嫫`
- Source codepoints: `U+5AEB`
...
- `obs-evo-cand-002276-route-category-staging`
...
- `obs-evo-cand-002276-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002276-route-evolution-graph`
