# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006111
...
- EVOBC candidate category: `evobc-evo-cat-06111`.
- Source label for search only: `稳`.
- Source codepoints for search only: `U+7A33`.
