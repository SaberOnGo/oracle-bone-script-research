...
Project ID: `obs-evo-cand-008716`
...
- Project ID: `obs-evo-cand-008716`
- EVOBC category candidate ID: `evobc-evo-cat-08716`
- External category reference: `evobc-cat-08716`
- Source category ID: `08716`
- Source label for human review: `跟`
- Source codepoints: `U+8DDF`
...
- `obs-evo-cand-008716-route-category-staging`
...
- `obs-evo-cand-008716-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008716-route-evolution-graph`
