...
Project ID: `obs-insc-cw-cand-000057`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000057`
...
- Yingguo / 英国所藏: `y374` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `79` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `411` in source row; primary catalog entry pending
- Heji / 合集: `39782` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000057`
