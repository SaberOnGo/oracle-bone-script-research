# Material Visual Observation / obs-comp-cand-000015 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000015`
- External reference / 外部参照: `obimd-sub-no4gdlajf6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011101_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/no4gdlajf6/no4gdlajf6/083o9tfibd.png`
- Checksum / 校验和:
  `93d8e9a073a3c1f50d3290ac189873fc691e7024ef8a988f3e9dad3f296741cf`
...
- Marked-pixel bounds: (85,23)–(164,221); span 80 × 199 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.76%。
- 痕迹范围：(85,23)–(164,221)；跨度80 × 199 px；痕迹矩形高于宽。
