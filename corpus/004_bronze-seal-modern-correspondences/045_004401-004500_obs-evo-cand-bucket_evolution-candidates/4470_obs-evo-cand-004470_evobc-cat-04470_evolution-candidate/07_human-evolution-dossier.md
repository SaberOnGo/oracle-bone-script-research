...
Project ID: `obs-evo-cand-004470`
...
- Project ID: `obs-evo-cand-004470`
- EVOBC category candidate ID: `evobc-evo-cat-04470`
- External category reference: `evobc-cat-04470`
- Source category ID: `04470`
- Source label for human review: `民`
- Source codepoints: `U+6C11`
- Image reference count in source metadata: `300`
...
- `obs-evo-cand-004470-route-category-staging`
...
- `obs-evo-cand-004470-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004470-route-evolution-graph`
