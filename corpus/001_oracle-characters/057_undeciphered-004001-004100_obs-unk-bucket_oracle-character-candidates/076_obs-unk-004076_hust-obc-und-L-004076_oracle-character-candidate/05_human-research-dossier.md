# obs-unk-004076 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004076`
- primary external id: `hust-obc-und-L-004076`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/076_obs-unk-004076_h
  ust-obc-und-L-004076_oracle-character-candidate/03_visual-assets/001_asset
  -005669_hust-obc-und-L-004076_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4076/L_？_8735.jpg`
- asset id: `asset-005669`
...
- source class: `HUST-OBC/undeciphered/L/4076/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4076/L_？_8735.jpg`
- asset id: `asset-005669`
...
- English observation: A long horizontal trace crosses the top and a central
  vertical trace descends below it. The lower area contains several triangular
  or pointed marks along a broad base; their spacing and connections remain
  uncertain.
...
- Which source records identify obs-unk-004076 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004076？
