...
- External category reference: `evobc-cat-02251`
- Source category ID: `02251`
- Source label for human review: `媿`
- Source codepoints: `U+5ABF`
...
- `obs-evo-cand-002251-route-category-staging`
...
- `obs-evo-cand-002251-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002251-route-evolution-graph`
