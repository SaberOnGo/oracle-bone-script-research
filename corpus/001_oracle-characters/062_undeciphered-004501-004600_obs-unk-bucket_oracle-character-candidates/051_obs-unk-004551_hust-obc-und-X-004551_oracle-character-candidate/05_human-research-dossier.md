# obs-unk-004551 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004551`
- primary external id: `hust-obc-und-X-004551`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/051_obs-unk-004551_h
  ust-obc-und-X-004551_oracle-character-candidate/03_visual-assets/001_asset
  -006144_hust-obc-und-X-004551_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/107/X_？_8289_1.png`
- asset id: `asset-006144`
...
- source class: `HUST-OBC/undeciphered/X/107/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/107/X_？_8289_1.png`
- asset id: `asset-006144`
...
- English observation: `Upper prongs, side traces, and lower loop recorded.`
- 中文观察: `已记录上部尖突、侧部痕迹和下部环痕。`
...
- Which source records identify obs-unk-004551 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004551？
