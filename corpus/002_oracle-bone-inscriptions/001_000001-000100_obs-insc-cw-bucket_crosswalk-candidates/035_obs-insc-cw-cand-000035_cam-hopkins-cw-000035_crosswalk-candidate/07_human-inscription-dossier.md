...
- Yingguo / 英国所藏: `y200` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `199` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `716` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000035`
