...
- External category reference: `evobc-cat-04232`
- Source category ID: `04232`
- Source label for human review: `樂`
- Source codepoints: `U+6A02`
- Image reference count in source metadata: `235`
...
- `obs-evo-cand-004232-route-category-staging`
...
- `obs-evo-cand-004232-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004232-route-evolution-graph`
