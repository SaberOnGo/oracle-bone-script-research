# obs-char-000482 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000482`
- primary external id: `hust-obc-cat-0547`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/482_obs-char-000482_hust-obc-cat-0547_orac
  le-character/03_visual-assets/001_asset-000487_hust-obc-cat-0547_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0547/H_0547_60A03_0.png`
- asset id: `asset-000487`
...
- source category: `0547`
- validation class: `481`
- source image route: `HUST-OBC/deciphered/0547/H_0547_60A03_0.png`
- asset id: `asset-000487`
...
- dataset label text: `㘙`
- dataset label codepoints: `U+3619`
...
- filename catalog route clues: `catalog-like filename clue: H_0547
  (H_0547_60A03_0.png)`
...
- Which source records identify obs-char-000482 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000482？
