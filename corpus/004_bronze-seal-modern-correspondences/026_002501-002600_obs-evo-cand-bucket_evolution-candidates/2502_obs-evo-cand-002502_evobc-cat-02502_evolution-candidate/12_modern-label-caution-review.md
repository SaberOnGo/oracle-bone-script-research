# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002502
...
- EVOBC candidate category: `evobc-evo-cat-02502`.
- Source label for search only: `屍`.
- Source codepoints for search only: `U+5C4D`.
