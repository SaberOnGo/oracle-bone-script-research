...
- Project ID: `obs-evo-cand-009097`
- EVOBC category candidate ID: `evobc-evo-cat-09097`
- External category reference: `evobc-cat-09097`
- Source category ID: `09097`
- Source label for human review: `邠`
- Source codepoints: `U+90A0`
...
- `obs-evo-cand-009097-route-category-staging`
...
- `obs-evo-cand-009097-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009097-route-evolution-graph`
