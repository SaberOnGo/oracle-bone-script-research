...
Project ID: `obs-evo-cand-010182`
...
- Project ID: `obs-evo-cand-010182`
- EVOBC category candidate ID: `evobc-evo-cat-10182`
- External category reference: `evobc-cat-10182`
- Source category ID: `10182`
- Source label for human review: `駒`
- Source codepoints: `U+99D2`
...
- `obs-evo-cand-010182-route-category-staging`
...
- `obs-evo-cand-010182-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010182-route-evolution-graph`
