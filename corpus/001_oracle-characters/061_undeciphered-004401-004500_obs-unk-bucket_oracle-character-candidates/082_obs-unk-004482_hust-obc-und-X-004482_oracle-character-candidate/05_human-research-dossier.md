# obs-unk-004482 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004482`
- primary external id: `hust-obc-und-X-004482`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/082_obs-unk-004482_h
  ust-obc-und-X-004482_oracle-character-candidate/03_visual-assets/001_asset
  -006075_hust-obc-und-X-004482_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/38/X_？_8216_1.png`
- asset id: `asset-006075`
...
- source class: `HUST-OBC/undeciphered/X/38/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/38/X_？_8216_1.png`
- asset id: `asset-006075`
...
- English observation: A noisy inverted crop shows a thin irregular light trace
  with scattered isolated marks.
- 中文观察: 噪声较多的反相裁切中有细长不规则浅色痕迹和散点。
...
- Which source records identify obs-unk-004482 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004482？
