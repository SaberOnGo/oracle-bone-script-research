# obs-char-001073 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1073_obs-char-001073_hust-obc-cat-1200_ora
  cle-character/03_visual-assets/001_asset-001078_hust-obc-cat-1200_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1200/G_1200_甲骨文.png`
- asset id: `asset-001078`
...
- source category: `1200`
- validation class: `1072`
- source image route: `HUST-OBC/deciphered/1200/G_1200_甲骨文.png`
- asset id: `asset-001078`
...
- English observation: `A central upright branching form is accompanied by
  several detached short marks on the left and a small angular right
  branch.`
- 中文观察: `中央直立分枝形体左侧有数条分离短笔，右侧有小型棱角分枝。`
...
- dataset label text: `㢦`
- dataset label codepoints: `U+38A6`
...
- Which source records identify obs-char-001073 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001073？
