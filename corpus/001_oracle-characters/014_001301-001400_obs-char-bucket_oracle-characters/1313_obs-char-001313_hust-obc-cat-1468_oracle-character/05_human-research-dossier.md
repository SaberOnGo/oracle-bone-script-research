# obs-char-001313 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1313_obs-char-001313_hust-obc-cat-1468_ora
  cle-character/03_visual-assets/001_asset-001318_hust-obc-cat-1468_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1468/G_1468_京都624合18704.png`
- asset id: `asset-001318`
...
- source category: `1468`
- validation class: `1312`
- source image route: `HUST-OBC/deciphered/1468/G_1468_京都624合18704.png`
- asset id: `asset-001318`
...
- English observation: `A narrow upright form has a central vertical, an
  upper fork, and several short side branches.`
...
- dataset label text: `㦲`
- dataset label codepoints: `U+39B2`
...
- filename catalog route clues: `Heji-like filename clue: 合18704
  (G_1468_京都624合18704.png)`
...
- Which source records identify obs-char-001313 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001313？
