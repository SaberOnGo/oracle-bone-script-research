# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002576
...
- EVOBC candidate category: `evobc-evo-cat-02576`.
- Source label for search only: `嵌`.
- Source codepoints for search only: `U+5D4C`.
