# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-005755
...
- EVOBC candidate category: `evobc-evo-cat-05755`.
- Source label for search only: `盛`.
- Source codepoints for search only: `U+76DB`.
