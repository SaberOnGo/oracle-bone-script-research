...
- Project ID: `obs-evo-cand-002656`
- EVOBC category candidate ID: `evobc-evo-cat-02656`
- External category reference: `evobc-cat-02656`
- Source category ID: `02656`
- Source label for human review: `帥`
- Source codepoints: `U+5E25`
...
- `obs-evo-cand-002656-route-category-staging`
...
- `obs-evo-cand-002656-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002656-route-evolution-graph`
