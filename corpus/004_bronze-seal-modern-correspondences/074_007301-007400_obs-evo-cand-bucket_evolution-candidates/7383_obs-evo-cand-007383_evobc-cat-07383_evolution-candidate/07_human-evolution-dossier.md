...
- External category reference: `evobc-cat-07383`
- Source category ID: `07383`
- Source label for human review: `莞`
- Source codepoints: `U+839E`
...
- `obs-evo-cand-007383-route-category-staging`
...
- `obs-evo-cand-007383-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007383-route-evolution-graph`
