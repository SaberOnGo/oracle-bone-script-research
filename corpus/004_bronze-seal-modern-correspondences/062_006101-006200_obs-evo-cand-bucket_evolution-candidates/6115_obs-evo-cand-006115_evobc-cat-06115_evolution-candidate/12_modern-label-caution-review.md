# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006115
...
- EVOBC candidate category: `evobc-evo-cat-06115`.
- Source label for search only: `稺`.
- Source codepoints for search only: `U+7A3A`.
