...
- External category reference: `evobc-cat-04415`
- Source category ID: `04415`
- Source label for human review: `殜`
- Source codepoints: `U+6B9C`
...
- `obs-evo-cand-004415-route-category-staging`
...
- `obs-evo-cand-004415-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004415-route-evolution-graph`
