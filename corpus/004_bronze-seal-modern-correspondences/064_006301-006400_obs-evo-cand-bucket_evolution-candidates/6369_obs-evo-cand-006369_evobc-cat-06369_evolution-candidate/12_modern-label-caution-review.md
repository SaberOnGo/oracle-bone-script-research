# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006369
...
- EVOBC candidate category: `evobc-evo-cat-06369`.
- Source label for search only: `籍`.
- Source codepoints for search only: `U+7C4D`.
