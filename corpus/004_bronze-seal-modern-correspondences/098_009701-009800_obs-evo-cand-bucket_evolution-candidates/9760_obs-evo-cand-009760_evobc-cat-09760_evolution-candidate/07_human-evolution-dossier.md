...
- Project ID: `obs-evo-cand-009760`
- EVOBC category candidate ID: `evobc-evo-cat-09760`
- External category reference: `evobc-cat-09760`
- Source category ID: `09760`
- Source label for human review: `隄`
- Source codepoints: `U+9684`
...
- `obs-evo-cand-009760-route-category-staging`
...
- `obs-evo-cand-009760-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009760-route-evolution-graph`
