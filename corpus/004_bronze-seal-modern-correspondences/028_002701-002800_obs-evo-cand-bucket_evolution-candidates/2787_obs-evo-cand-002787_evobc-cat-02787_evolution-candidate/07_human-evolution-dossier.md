...
Project ID: `obs-evo-cand-002787`
...
- Project ID: `obs-evo-cand-002787`
- EVOBC category candidate ID: `evobc-evo-cat-02787`
- External category reference: `evobc-cat-02787`
- Source category ID: `02787`
- Source label for human review: `弈`
- Source codepoints: `U+5F08`
...
- `obs-evo-cand-002787-route-category-staging`
...
- `obs-evo-cand-002787-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002787-route-evolution-graph`
