...
- External category reference: `evobc-cat-02032`
- Source category ID: `02032`
- Source label for human review: `奉`
- Source codepoints: `U+5949`
- Image reference count in source metadata: `72`
...
- `obs-evo-cand-002032-route-category-staging`
...
- `obs-evo-cand-002032-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002032-route-evolution-graph`
