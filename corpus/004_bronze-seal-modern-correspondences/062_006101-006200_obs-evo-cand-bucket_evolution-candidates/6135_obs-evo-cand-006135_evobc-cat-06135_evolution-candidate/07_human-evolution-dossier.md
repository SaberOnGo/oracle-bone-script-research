...
- External category reference: `evobc-cat-06135`
- Source category ID: `06135`
- Source label for human review: `穤`
- Source codepoints: `U+7A64`
...
- `obs-evo-cand-006135-route-category-staging`
...
- `obs-evo-cand-006135-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006135-route-evolution-graph`
