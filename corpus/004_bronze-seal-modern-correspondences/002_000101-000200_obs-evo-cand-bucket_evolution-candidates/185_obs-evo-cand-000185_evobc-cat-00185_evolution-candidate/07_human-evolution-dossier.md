...
- Project ID: `obs-evo-cand-000185`
- EVOBC category candidate ID: `evobc-evo-cat-00185`
- External category reference: `evobc-cat-00185`
- Source category ID: `00185`
- Source label for human review: `㰦`
- Source codepoints: `U+3C26`
...
- `obs-evo-cand-000185-route-category-staging`
...
- `obs-evo-cand-000185-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000185-route-evolution-graph`
