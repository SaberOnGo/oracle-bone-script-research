...
Project ID: `obs-evo-cand-005111`
...
- Project ID: `obs-evo-cand-005111`
- EVOBC category candidate ID: `evobc-evo-cat-05111`
- External category reference: `evobc-cat-05111`
- Source category ID: `05111`
- Source label for human review: `煜`
- Source codepoints: `U+715C`
...
- `obs-evo-cand-005111-route-category-staging`
...
- `obs-evo-cand-005111-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005111-route-evolution-graph`
