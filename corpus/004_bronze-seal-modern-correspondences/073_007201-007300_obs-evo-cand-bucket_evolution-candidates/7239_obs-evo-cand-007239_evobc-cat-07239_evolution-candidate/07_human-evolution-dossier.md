...
Project ID: `obs-evo-cand-007239`
...
- Project ID: `obs-evo-cand-007239`
- EVOBC category candidate ID: `evobc-evo-cat-07239`
- External category reference: `evobc-cat-07239`
- Source category ID: `07239`
- Source label for human review: `芒`
- Source codepoints: `U+8292`
...
- `obs-evo-cand-007239-route-category-staging`
...
- `obs-evo-cand-007239-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007239-route-evolution-graph`
