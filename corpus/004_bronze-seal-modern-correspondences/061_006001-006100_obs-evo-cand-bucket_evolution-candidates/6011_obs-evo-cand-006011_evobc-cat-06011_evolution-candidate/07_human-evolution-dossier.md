...
- External category reference: `evobc-cat-06011`
- Source category ID: `06011`
- Source label for human review: `禁`
- Source codepoints: `U+7981`
...
- `obs-evo-cand-006011-route-category-staging`
...
- `obs-evo-cand-006011-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006011-route-evolution-graph`
