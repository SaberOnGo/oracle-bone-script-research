# Material Visual Observation / obs-comp-cand-001609 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001609`
- External reference / 外部参照: `obimd-sub-evdky2imry`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017285_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kei9slmf3p/evdky2imry/evdky2imry.png`
- Checksum / 校验和:
  `3747c739b285321d007113a52527952d2c6158c4cd29a8715b7b6ca6d84896fc`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.28%.
- Marked-pixel bounds: (61,51)–(187,199); span 127 × 149 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.28%。
- 痕迹范围：(61,51)–(187,199)；跨度127 × 149 px；痕迹矩形近方形。
