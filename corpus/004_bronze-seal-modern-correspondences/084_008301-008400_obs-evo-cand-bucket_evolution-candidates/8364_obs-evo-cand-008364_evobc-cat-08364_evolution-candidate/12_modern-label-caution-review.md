# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008364
...
- EVOBC candidate category: `evobc-evo-cat-08364`.
- Source label for search only: `譞`.
- Source codepoints for search only: `U+8B5E`.
