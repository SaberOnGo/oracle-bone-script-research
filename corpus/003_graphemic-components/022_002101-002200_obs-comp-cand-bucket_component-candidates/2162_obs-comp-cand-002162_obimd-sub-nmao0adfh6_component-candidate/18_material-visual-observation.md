# Material Visual Observation / obs-comp-cand-002162 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002162`
- External reference / 外部参照: `obimd-sub-nmao0adfh6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019841_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/u3lh7tekno/nmao0adfh6/06g6jfga5o.png`
- Checksum / 校验和:
  `7612888339c1b3b0fed10d8d9206e1a3d1507ef778096158b32e0ffe0fea929a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.08%.
- Marked-pixel bounds: (79,28)–(170,214); span 92 × 187 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.08%。
- 痕迹范围：(79,28)–(170,214)；跨度92 × 187 px；痕迹矩形高于宽。
