...
- `obs-evo-cand-010010-route-category-staging`
...
- `obs-evo-cand-010010-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010010-route-evolution-graph`
