...
- External category reference: `evobc-cat-07557`
- Source category ID: `07557`
- Source label for human review: `蔟`
...
- `obs-evo-cand-007557-route-category-staging`
...
- `obs-evo-cand-007557-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007557-route-evolution-graph`
