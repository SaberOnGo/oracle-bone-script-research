...
- External category reference: `evobc-cat-09455`
- Source category ID: `09455`
- Source label for human review: `鍛`
- Source codepoints: `U+935B`
...
- `obs-evo-cand-009455-route-category-staging`
...
- `obs-evo-cand-009455-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009455-route-evolution-graph`
