# Material Visual Observation / obs-comp-cand-000138 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000138`
- External reference / 外部参照: `obimd-sub-dtu9bl4faf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011550_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dtu9bl4faf/dtu9bl4faf/dtu9bl4faf.png`
- Checksum / 校验和:
  `251ca959e5b097f71467237a9c0cde19a3848713db7d82e113d182f7e24131e4`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.88%.
- Marked-pixel bounds: (100,26)–(149,228); span 50 × 203 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.88%。
- 痕迹范围：(100,26)–(149,228)；跨度50 × 203 px；痕迹矩形高于宽。
