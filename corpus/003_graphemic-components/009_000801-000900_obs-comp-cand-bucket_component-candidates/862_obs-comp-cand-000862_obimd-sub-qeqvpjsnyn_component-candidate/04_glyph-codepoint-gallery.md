# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000862
...
| --- | --- | --- | --- |
| `obimd-glyph-link-012459` | 旡󴷾 | `U+65E1;U+F4DFE` | `reviewed_metadata_only` |
| `obimd-glyph-link-012460` | 󴷿 | `U+F4DFF` | `reviewed_metadata_only` |
