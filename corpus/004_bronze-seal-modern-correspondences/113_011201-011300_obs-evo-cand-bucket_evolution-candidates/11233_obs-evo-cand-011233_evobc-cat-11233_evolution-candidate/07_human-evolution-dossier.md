...
- External category reference: `evobc-cat-11233`
- Source category ID: `11233`
- Source label for human review: `𢚖`
...
- `obs-evo-cand-011233-route-category-staging`
...
- `obs-evo-cand-011233-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011233-route-evolution-graph`
