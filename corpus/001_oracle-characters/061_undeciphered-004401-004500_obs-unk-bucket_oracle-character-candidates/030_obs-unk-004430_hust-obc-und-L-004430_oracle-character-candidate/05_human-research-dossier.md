# obs-unk-004430 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/030_obs-unk-004430_h
  ust-obc-und-L-004430_oracle-character-candidate/03_visual-assets/001_asset
  -006023_hust-obc-und-L-004430_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4430/L_？_9929.jpg`
- asset id: `asset-006023`
...
- source class: `HUST-OBC/undeciphered/L/4430/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4430/L_？_9929.jpg`
- asset id: `asset-006023`
...
- English observation: `Slanting traces flank a central line above`
  `a lower open outline.`
- 中文观察: `斜向痕迹位于中央线两侧和下部开放轮廓之上。`
...
- Which source records identify obs-unk-004430 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004430？
