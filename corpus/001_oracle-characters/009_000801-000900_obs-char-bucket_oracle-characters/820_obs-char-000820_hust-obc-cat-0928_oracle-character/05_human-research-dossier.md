# obs-char-000820 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000820`
- primary external id: `hust-obc-cat-0928`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/820_obs-char-000820_hust-obc-cat-0928_orac
  le-character/03_visual-assets/001_asset-000825_hust-obc-cat-0928_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0928/H_0928_60495_0.png`
- asset id: `asset-000825`
...
- source category: `0928`
- validation class: `819`
- source image route: `HUST-OBC/deciphered/0928/H_0928_60495_0.png`
- asset id: `asset-000825`
...
- English observation: `A long central descending stroke crosses a diagonal
  branch; several separate blocky marks surround the crossing on both
  sides.`
- 中文观察: `长直向下延伸的中央笔横过斜向分枝，交叉两侧分布着数个分离的块状痕迹。`
...
- dataset label text: `㞖`
- dataset label codepoints: `U+3796`
...
- filename catalog route clues: `catalog-like filename clue: H_0928
  (H_0928_60495_0.png)`
...
- Which source records identify obs-char-000820 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000820？
