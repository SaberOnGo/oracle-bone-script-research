...
- External category reference: `evobc-cat-07217`
- Source category ID: `07217`
- Source label for human review: `色`
...
- `obs-evo-cand-007217-route-category-staging`
...
- `obs-evo-cand-007217-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007217-route-evolution-graph`
