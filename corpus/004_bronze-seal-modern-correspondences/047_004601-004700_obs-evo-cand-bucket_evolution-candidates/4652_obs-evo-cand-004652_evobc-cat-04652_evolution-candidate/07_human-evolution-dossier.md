...
- External category reference: `evobc-cat-04652`
- Source category ID: `04652`
- Source label for human review: `浏`
...
- `obs-evo-cand-004652-route-category-staging`
...
- `obs-evo-cand-004652-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004652-route-evolution-graph`
