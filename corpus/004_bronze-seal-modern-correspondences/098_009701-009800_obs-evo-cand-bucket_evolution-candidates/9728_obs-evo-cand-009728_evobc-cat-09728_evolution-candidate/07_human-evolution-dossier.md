...
- External category reference: `evobc-cat-09728`
- Source category ID: `09728`
- Source label for human review: `陖`
- Source codepoints: `U+9656`
...
- `obs-evo-cand-009728-route-category-staging`
...
- `obs-evo-cand-009728-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009728-route-evolution-graph`
