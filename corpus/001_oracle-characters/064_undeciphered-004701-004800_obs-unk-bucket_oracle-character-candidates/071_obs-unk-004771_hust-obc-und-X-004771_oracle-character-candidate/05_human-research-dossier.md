# obs-unk-004771 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004771`
- primary external id: `hust-obc-und-X-004771`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/071_obs-unk-004771_h
  ust-obc-und-X-004771_oracle-character-candidate/03_visual-assets/001_asset
  -006364_hust-obc-und-X-004771_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/327/X_？_7311_1.png`
- asset id: `asset-006364`
...
- source class: `HUST-OBC/undeciphered/X/327/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/327/X_？_7311_1.png`
- asset id: `asset-006364`
...
- English observation: `detached left stroke and two pale openings`
- 中文观察: `分离的左侧竖笔和两个浅色开口`
...
- Which source records identify obs-unk-004771 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004771？
