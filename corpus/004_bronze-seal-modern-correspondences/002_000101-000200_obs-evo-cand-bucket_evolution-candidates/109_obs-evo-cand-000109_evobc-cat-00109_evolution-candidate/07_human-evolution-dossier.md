...
- External category reference: `evobc-cat-00109`
- Source category ID: `00109`
- Source label for human review: `㣣`
- Source codepoints: `U+38E3`
...
- `obs-evo-cand-000109-route-category-staging`
...
- `obs-evo-cand-000109-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000109-route-evolution-graph`
