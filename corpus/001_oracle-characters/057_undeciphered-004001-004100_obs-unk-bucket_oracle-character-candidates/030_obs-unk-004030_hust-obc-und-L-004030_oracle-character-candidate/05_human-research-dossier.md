# obs-unk-004030 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/030_obs-unk-004030_h
  ust-obc-und-L-004030_oracle-character-candidate/03_visual-assets/001_asset
  -005623_hust-obc-und-L-004030_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4030/L_？_8609.jpg`
- asset id: `asset-005623`
...
- source class: `HUST-OBC/undeciphered/L/4030/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4030/L_？_8609.jpg`
- asset id: `asset-005623`
...
- English observation: A broad peaked outline occupies the upper area, with
  several internal angular traces. A long tapered stroke descends from the
  lower center. The crop does not show the complete outer edges.
- 中文观察：上部有较宽的尖顶轮廓，内部可见数条折角痕迹；一条长而渐窄的痕迹从
    下部中央向下延伸。图像未显示外侧轮廓的完整边缘。
...
- Which source records identify obs-unk-004030 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004030？
