# obs-evo-cand-002096 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-02096`
- Source label for human review: `妬`
- Source codepoints: `U+59AC`
- Image reference count: `46`
- Era token counts: `OBC:46`
