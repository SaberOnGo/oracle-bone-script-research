...
Project ID: `obs-evo-cand-006540`
...
- Project ID: `obs-evo-cand-006540`
- EVOBC category candidate ID: `evobc-evo-cat-06540`
- External category reference: `evobc-cat-06540`
- Source category ID: `06540`
- Source label for human review: `綌`
- Source codepoints: `U+7D8C`
...
- `obs-evo-cand-006540-route-category-staging`
...
- `obs-evo-cand-006540-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006540-route-evolution-graph`
