...
Project ID: `obs-evo-cand-001731`
...
- Project ID: `obs-evo-cand-001731`
- EVOBC category candidate ID: `evobc-evo-cat-01731`
- External category reference: `evobc-cat-01731`
- Source category ID: `01731`
- Source label for human review: `嚃`
- Source codepoints: `U+5683`
...
- `obs-evo-cand-001731-route-category-staging`
...
- `obs-evo-cand-001731-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001731-route-evolution-graph`
