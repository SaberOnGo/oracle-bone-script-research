...
- External category reference: `evobc-cat-03410`
- Source category ID: `03410`
- Source label for human review: `探`
- Source codepoints: `U+63A2`
...
- `obs-evo-cand-003410-route-category-staging`
...
- `obs-evo-cand-003410-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003410-route-evolution-graph`
