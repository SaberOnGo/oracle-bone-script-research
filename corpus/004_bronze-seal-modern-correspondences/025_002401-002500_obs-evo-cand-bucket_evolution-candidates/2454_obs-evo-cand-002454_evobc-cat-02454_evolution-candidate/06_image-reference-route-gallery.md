...
- `obs-evo-cand-002454-route-category-staging`
...
- `obs-evo-cand-002454-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002454-route-evolution-graph`
