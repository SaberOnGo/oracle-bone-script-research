...
- External category reference: `evobc-cat-02003`
- Source category ID: `02003`
- Source label for human review: `夜`
- Source codepoints: `U+591C`
...
- `obs-evo-cand-002003-route-category-staging`
...
- `obs-evo-cand-002003-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002003-route-evolution-graph`
