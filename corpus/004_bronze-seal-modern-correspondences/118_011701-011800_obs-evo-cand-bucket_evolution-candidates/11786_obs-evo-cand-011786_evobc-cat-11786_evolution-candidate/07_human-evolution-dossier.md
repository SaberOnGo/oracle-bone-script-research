...
- Project ID: `obs-evo-cand-011786`
- EVOBC category candidate ID: `evobc-evo-cat-11786`
- External category reference: `evobc-cat-11786`
- Source category ID: `11786`
- Source label for human review: `𥉃`
- Source codepoints: `U+25243`
...
- `obs-evo-cand-011786-route-category-staging`
...
- `obs-evo-cand-011786-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011786-route-evolution-graph`
