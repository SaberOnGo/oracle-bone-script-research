...
Project ID: `obs-evo-cand-002340`
...
- Project ID: `obs-evo-cand-002340`
- EVOBC category candidate ID: `evobc-evo-cat-02340`
- External category reference: `evobc-cat-02340`
- Source category ID: `02340`
- Source label for human review: `学`
- Source codepoints: `U+5B66`
...
- `obs-evo-cand-002340-route-category-staging`
...
- `obs-evo-cand-002340-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002340-route-evolution-graph`
