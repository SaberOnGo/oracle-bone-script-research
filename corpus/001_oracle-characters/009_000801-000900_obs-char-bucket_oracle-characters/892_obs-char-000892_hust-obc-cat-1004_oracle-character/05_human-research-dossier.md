# obs-char-000892 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/892_obs-char-000892_hust-obc-cat-1004_orac
  le-character/03_visual-assets/001_asset-000897_hust-obc-cat-1004_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1004/G_1004_乙4524合902賓組.png`
- asset id: `asset-000897`
...
- source category: `1004`
- validation class: `891`
- source image route: `HUST-OBC/deciphered/1004/G_1004_乙4524合902賓組.png`
- asset id: `asset-000897`
...
- English observation: `A narrow dense cluster combines parallel left
  strokes with a central enclosed loop and short branching marks.`
- 中文观察: `狭长密集笔群结合左侧平行笔、中央闭合环状痕迹和短分枝笔。`
...
- dataset label text: `㟢`
- dataset label codepoints: `U+37E2`
...
- Which source records identify obs-char-000892 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000892？
