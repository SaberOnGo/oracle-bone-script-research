# obs-char-000471 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/471_obs-char-000471_hust-obc-cat-0533_orac
  le-character/03_visual-assets/001_asset-000476_hust-obc-cat-0533_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0533/G_0533_前6.24.6(甲).png`
- asset id: `asset-000476`
...
- source category: `0533`
- validation class: `470`
- source image route: `HUST-OBC/deciphered/0533/G_0533_前6.24.6(甲).png`
- asset id: `asset-000476`
...
- English observation: `A narrow pointed outer outline encloses a small
  upper rectangle and several curved or branching lower strokes that meet
  near the bottom.`
...
- dataset label text: `㘋`
- dataset label codepoints: `U+360B`
...
- Which source records identify obs-char-000471 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000471？
