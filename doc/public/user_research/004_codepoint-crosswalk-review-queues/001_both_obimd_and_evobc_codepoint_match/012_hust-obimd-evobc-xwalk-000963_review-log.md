...
- Review log draft ID / 复核日志草稿 ID: `codepoint-crosswalk-review-log-draft-012`
- Codepoint review task ID / codepoint 复核任务 ID: `codepoint-crosswalk-review-012`
...
- Crosswalk candidate ID / 交叉候选 ID: `hust-obimd-evobc-xwalk-000963`
- Suggested oracle character ID / 建议甲骨单字 ID: `obs-char-000963`
- Promotion queue ID / 提升队列 ID: `hust-obc-obs-char-promo-000963`
...
- HUST external ref / HUST 外部引用: `hust-obc-cat-1083`
- HUST label codepoints / HUST 标签 codepoint: `U+3831`
- OBIMD main candidates / OBIMD 主字候选: `obimd-main-cand-002775`
- EVOBC category candidates / EVOBC 类别候选: `evobc-evo-cat-00090`
- EVOBC image reference count / EVOBC 图像引用数: `99`
...
- `corpus/001_oracle-characters/010_000901-001000_obs-char-bucket_oracle-characters/001_hust-obc-candidate-packet-manifest.csv`
- `corpus/001_oracle-characters/010_000901-001000_obs-char-bucket_oracle-characters/963_obs-char-000963_hust-obc-cat-1083_oracle-character/01_candidate-character-packet.json`
...
- Route availability ID: `codepoint-route-availability-012`
...
- Review task ID: `codepoint-crosswalk-review-012`
- Crosswalk candidate ID: `hust-obimd-evobc-xwalk-000963`
- Suggested oracle character ID: `obs-char-000963`
- HUST candidate packet ID: `hust-obc-candidate-packet-000963`
...
- OBIMD row count: `1`
- OBIMD source UIDs: `rny4p2gchp`
- OBIMD review statuses: `obimd-main-cand-002775=reviewed_metadata_only`
- OBIMD rights statuses: `obimd-main-cand-002775=licensed_for_repository`
- EVOBC row count: `1`
- EVOBC source category IDs: `00090`
- EVOBC has bronze refs: `true`
- EVOBC has seal refs: `false`
- EVOBC review statuses: `evobc-evo-cat-00090=reviewed_metadata_only`
- EVOBC rights statuses: `evobc-evo-cat-00090=source_marked_risk_noted`
...
- Does `hust-obimd-evobc-xwalk-000963` remain unpromoted and undeciphered?
