# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-009845
...
- EVOBC candidate category: `evobc-evo-cat-09845`.
- Source label for search only: `雾`.
- Source codepoints for search only: `U+96FE`.
