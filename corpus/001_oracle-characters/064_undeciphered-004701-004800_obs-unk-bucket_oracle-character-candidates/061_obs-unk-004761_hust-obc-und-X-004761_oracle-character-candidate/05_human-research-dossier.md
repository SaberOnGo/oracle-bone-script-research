# obs-unk-004761 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004761`
- primary external id: `hust-obc-und-X-004761`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/061_obs-unk-004761_h
  ust-obc-und-X-004761_oracle-character-candidate/03_visual-assets/001_asset
  -006354_hust-obc-und-X-004761_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/317/X_？_7301_1.png`
- asset id: `asset-006354`
...
- source class: `HUST-OBC/undeciphered/X/317/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/317/X_？_7301_1.png`
- asset id: `asset-006354`
...
- English observation: `curved upper contour, right opening, and lower terminal`
- 中文观察: `弯曲上部轮廓、右侧开口和下部末端`
...
- Which source records identify obs-unk-004761 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004761？
