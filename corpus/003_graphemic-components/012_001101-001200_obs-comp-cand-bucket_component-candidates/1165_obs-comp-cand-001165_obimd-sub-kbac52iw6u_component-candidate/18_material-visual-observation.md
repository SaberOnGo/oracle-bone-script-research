# Material Visual Observation / obs-comp-cand-001165 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001165`
- External reference / 外部参照: `obimd-sub-kbac52iw6u`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015355_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kbac52iw6u/kbac52iw6u/kbac52iw6u.png`
- Checksum / 校验和:
  `6b980ee569e2bb68a6133496210d71b5765be069c35a9b2c6cec1d1c35bd5904`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.89%.
- Marked-pixel bounds: (83,27)–(166,222); span 84 × 196 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.89%。
- 痕迹范围：(83,27)–(166,222)；跨度84 × 196 px；痕迹矩形高于宽。
