# obs-comp-cand-000190 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000190`
- 首选外部 ID: `obimd-sub-c21flybnax`
- OBIMD subcharacter UID: `c21flybnax`
- OBIMD main character UID: `c21flybnax`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `8`
- codepoint 示例: U+A0001;U+F1211; U+F1212; 另有 6 项
