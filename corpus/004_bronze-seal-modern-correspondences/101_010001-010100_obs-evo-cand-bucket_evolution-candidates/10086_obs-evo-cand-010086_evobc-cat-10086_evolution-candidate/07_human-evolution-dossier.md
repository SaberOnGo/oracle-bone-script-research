...
Project ID: `obs-evo-cand-010086`
...
- Project ID: `obs-evo-cand-010086`
- EVOBC category candidate ID: `evobc-evo-cat-10086`
- External category reference: `evobc-cat-10086`
- Source category ID: `10086`
- Source label for human review: `飫`
- Source codepoints: `U+98EB`
...
- `obs-evo-cand-010086-route-category-staging`
...
- `obs-evo-cand-010086-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010086-route-evolution-graph`
