# obs-unk-004856 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/056_obs-unk-004856_h
  ust-obc-und-X-004856_oracle-character-candidate/03_visual-assets/001_asset
  -006449_hust-obc-und-X-004856_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/412/X_？_7397_1.png`
- asset id: `asset-006449`
...
- source class: `HUST-OBC/undeciphered/X/412/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/412/X_？_7397_1.png`
- asset id: `asset-006449`
...
- English observation: `large curved outline and lower small opening`
- 中文观察: `大曲线围合和下部小开口`
...
- Which source records identify obs-unk-004856 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004856？
