...
Project ID: `obs-evo-cand-011679`
...
- Project ID: `obs-evo-cand-011679`
- EVOBC category candidate ID: `evobc-evo-cat-11679`
- External category reference: `evobc-cat-11679`
- Source category ID: `11679`
- Source label for human review: `𤵈`
- Source codepoints: `U+24D48`
...
- `obs-evo-cand-011679-route-category-staging`
...
- `obs-evo-cand-011679-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011679-route-evolution-graph`
