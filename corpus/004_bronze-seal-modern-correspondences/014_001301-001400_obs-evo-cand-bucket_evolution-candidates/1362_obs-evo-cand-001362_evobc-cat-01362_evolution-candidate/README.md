# obs-evo-cand-001362 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-001362`
- EVOBC category candidate ID: `evobc-evo-cat-01362`
- External category ref: `evobc-cat-01362`
- Source label: `十`
- Source codepoints: `U+5341`
- Image reference count: `200`
- Era token counts: `BI:74;CS:1;OBC:30;SAC:22;SS:2;WSC:71`
- Source token counts: `Book:108;Web:92`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 30 image references
- era 1 / BI: 74 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 22 image references
- era 4 / WSC: 71 image references
- era 5 / CS: 1 image references
- source 1 / Web:105952;說文Web:58: 92 image references
