# Material Visual Observation / obs-comp-cand-000853 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000853`
- External reference / 外部参照: `obimd-sub-ilh8kgxttw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013723_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ilh8kgxttw/ilh8kgxttw/ilh8kgxttw.png`
- Checksum / 校验和:
  `4c40c12d24fadda98097e7f7851c7346cd8e04e9ab72c8a35ba6412329c12ec0`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.05%.
- Marked-pixel bounds: (72,21)–(188,225); span 117 × 205 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.05%。
- 痕迹范围：(72,21)–(188,225)；跨度117 × 205 px；痕迹矩形高于宽。
