# Material Visual Observation / obs-comp-cand-002455 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002455`
- External reference / 外部参照: `obimd-sub-voijxc93c5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020640_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/voijxc93c5/voijxc93c5/voijxc93c5.png`
- Checksum / 校验和:
  `135c2e1224706b3491e4981856987ee1cd34eb316d52fd76b0f3de52b5ddb8fd`
...
- Marked-pixel bounds: (64,38)–(182,207); span 119 × 170 px; the marked
...
- 痕迹范围：(64,38)–(182,207)；跨度119 × 170 px；痕迹矩形高于宽。
