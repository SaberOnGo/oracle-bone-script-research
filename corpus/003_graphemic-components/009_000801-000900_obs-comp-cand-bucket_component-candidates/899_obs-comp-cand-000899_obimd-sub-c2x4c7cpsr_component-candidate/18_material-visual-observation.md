# Material Visual Observation / obs-comp-cand-000899 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000899`
- External reference / 外部参照: `obimd-sub-c2x4c7cpsr`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013971_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1u3e5w4k2u/c2x4c7cpsr/c2x4c7cpsr.png`
- Checksum / 校验和:
  `3af085035111a3d735f6908c0b2dac7edf1e5e21a9c1a0971786cd4ef561de46`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.88%.
- Marked-pixel bounds: (57,34)–(192,219); span 136 × 186 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.88%。
- 痕迹范围：(57,34)–(192,219)；跨度136 × 186 px；痕迹矩形高于宽。
