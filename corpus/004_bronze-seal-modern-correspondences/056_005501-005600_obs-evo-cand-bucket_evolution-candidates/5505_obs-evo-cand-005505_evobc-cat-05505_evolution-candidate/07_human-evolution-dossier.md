...
- External category reference: `evobc-cat-05505`
- Source category ID: `05505`
- Source label for human review: `瓢`
- Source codepoints: `U+74E2`
...
- `obs-evo-cand-005505-route-category-staging`
...
- `obs-evo-cand-005505-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005505-route-evolution-graph`
