# Material Visual Observation / obs-comp-cand-001214 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001214`
- External reference / 外部参照: `obimd-sub-gyyxdn4gis`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015445_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cw5ssmu5j4/gyyxdn4gis/gyyxdn4gis.png`
- Checksum / 校验和:
  `093ba746bd2195377352c082f1fcd039456668679542030d440e2d1170b2e904`
...
- Marked-pixel bounds: (72,13)–(173,232); span 102 × 220 px; the marked
...
- 痕迹范围：(72,13)–(173,232)；跨度102 × 220 px；痕迹矩形高于宽。
