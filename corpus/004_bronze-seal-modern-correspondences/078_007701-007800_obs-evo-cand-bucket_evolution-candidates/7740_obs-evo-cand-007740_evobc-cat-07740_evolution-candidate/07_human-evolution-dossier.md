...
- Project ID: `obs-evo-cand-007740`
- EVOBC category candidate ID: `evobc-evo-cat-07740`
- External category reference: `evobc-cat-07740`
- Source category ID: `07740`
- Source label for human review: `蛁`
- Source codepoints: `U+86C1`
...
- `obs-evo-cand-007740-route-category-staging`
...
- `obs-evo-cand-007740-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007740-route-evolution-graph`
