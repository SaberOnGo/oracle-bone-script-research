...
- Project ID: `obs-evo-cand-010699`
- EVOBC category candidate ID: `evobc-evo-cat-10699`
- External category reference: `evobc-cat-10699`
- Source category ID: `10699`
- Source label for human review: `鼬`
- Source codepoints: `U+9F2C`
...
- `obs-evo-cand-010699-route-category-staging`
...
- `obs-evo-cand-010699-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010699-route-evolution-graph`
