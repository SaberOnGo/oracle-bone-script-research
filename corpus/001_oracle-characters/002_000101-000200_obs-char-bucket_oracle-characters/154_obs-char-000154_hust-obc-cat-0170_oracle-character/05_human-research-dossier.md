# obs-char-000154 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/154_obs-char-000154_hust-obc-cat-0170_orac
  le-character/03_visual-assets/001_asset-000159_hust-obc-cat-0170_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0170/G_0170_前4.30.2合12賓組.png`
- asset id: `asset-000159`
...
- source category: `0170`
- validation class: `153`
- source image route: `HUST-OBC/deciphered/0170/G_0170_前4.30.2合12賓組.png`
- asset id: `asset-000159`
...
- English observation: `The image has a pointed upper stem, a broad
  horizontal lower-left form, and a compact rectangular mark on the lower
  right.`
- 中文观察: `图像上方有尖状主笔，下方左侧有宽横向形体，右下方有紧凑长方形痕迹。`
...
- dataset label text: `㒠`
- dataset label codepoints: `U+34A0`
...
- filename catalog route clues: `Heji-like filename clue: 合12
...
- Which source records identify obs-char-000154 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000154？
