# Material Visual Observation / obs-comp-cand-001692 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001692`
- External reference / 外部参照: `obimd-sub-3eorzalgl4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017608_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3eorzalgl4/3eorzalgl4/3eorzalgl4.png`
- Checksum / 校验和:
  `60e12cba1e74512946bd50ffdeeab042356cc6e252504590276be3b3dca43ae7`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.55%.
- Marked-pixel bounds: (86,36)–(166,211); span 81 × 176 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.55%。
- 痕迹范围：(86,36)–(166,211)；跨度81 × 176 px；痕迹矩形高于宽。
