# obs-unk-008153 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008153`
- primary external id: `hust-obc-und-YH-008153`
...
- local review image route: `corpus/001_oracle-characters/098_undeciphered-008
  101-008200_obs-unk-bucket_oracle-character-candidates/053_obs-unk-008153_h
  ust-obc-und-YH-008153_oracle-character-candidate/03_visual-assets/001_asse
  t-009744_hust-obc-und-YH-008153_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/607E1/H_？_607E1_0.png`
- asset id: `asset-009744`
...
- source class: `HUST-OBC/undeciphered/Y+H/607E1/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/607E1/H_？_607E1_0.png`
- asset id: `asset-009744`
...
- Which source records identify obs-unk-008153 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008153？
