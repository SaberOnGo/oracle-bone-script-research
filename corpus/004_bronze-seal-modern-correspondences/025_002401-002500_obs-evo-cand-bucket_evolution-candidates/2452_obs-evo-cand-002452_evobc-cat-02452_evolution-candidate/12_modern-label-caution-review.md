# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002452
...
- EVOBC candidate category: `evobc-evo-cat-02452`.
- Source label for search only: `导`.
- Source codepoints for search only: `U+5BFC`.
