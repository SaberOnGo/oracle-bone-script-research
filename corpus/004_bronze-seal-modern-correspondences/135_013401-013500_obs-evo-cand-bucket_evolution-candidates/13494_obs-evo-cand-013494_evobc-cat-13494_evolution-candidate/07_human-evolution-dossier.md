...
- External category reference: `evobc-cat-13494`
- Source category ID: `13494`
- Source label for human review: `𭌠`
...
- `obs-evo-cand-013494-route-category-staging`
...
- `obs-evo-cand-013494-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013494-route-evolution-graph`
