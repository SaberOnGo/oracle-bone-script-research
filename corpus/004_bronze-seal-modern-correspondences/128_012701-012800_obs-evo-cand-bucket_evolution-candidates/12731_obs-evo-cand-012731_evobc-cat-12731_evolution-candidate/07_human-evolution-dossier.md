...
- External category reference: `evobc-cat-12731`
- Source category ID: `12731`
- Source label for human review: `𪅀`
...
- `obs-evo-cand-012731-route-category-staging`
...
- `obs-evo-cand-012731-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012731-route-evolution-graph`
