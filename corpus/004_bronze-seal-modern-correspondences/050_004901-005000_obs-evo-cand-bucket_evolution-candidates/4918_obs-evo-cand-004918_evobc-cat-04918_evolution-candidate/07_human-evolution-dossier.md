...
- External category reference: `evobc-cat-04918`
- Source category ID: `04918`
- Source label for human review: `潸`
...
- `obs-evo-cand-004918-route-category-staging`
...
- `obs-evo-cand-004918-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004918-route-evolution-graph`
