# obs-char-001244 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1244_obs-char-001244_hust-obc-cat-1392_ora
  cle-character/03_visual-assets/001_asset-001249_hust-obc-cat-1392_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1392/G_1392_乙7200(甲).png`
- asset id: `asset-001249`
...
- source category: `1392`
- validation class: `1243`
- source image route: `HUST-OBC/deciphered/1392/G_1392_乙7200(甲).png`
- asset id: `asset-001249`
...
- English observation: `A small upright form has a shallow arched top, two
  inner curved strokes, and a short lower vertical.`
...
- dataset label text: `㥦`
- dataset label codepoints: `U+3966`
...
- Which source records identify obs-char-001244 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001244？
