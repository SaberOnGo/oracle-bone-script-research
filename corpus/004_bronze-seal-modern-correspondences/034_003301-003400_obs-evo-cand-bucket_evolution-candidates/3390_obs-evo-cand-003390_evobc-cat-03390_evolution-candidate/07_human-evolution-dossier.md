...
Project ID: `obs-evo-cand-003390`
...
- Project ID: `obs-evo-cand-003390`
- EVOBC category candidate ID: `evobc-evo-cat-03390`
- External category reference: `evobc-cat-03390`
- Source category ID: `03390`
- Source label for human review: `捿`
- Source codepoints: `U+637F`
...
- `obs-evo-cand-003390-route-category-staging`
...
- `obs-evo-cand-003390-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003390-route-evolution-graph`
