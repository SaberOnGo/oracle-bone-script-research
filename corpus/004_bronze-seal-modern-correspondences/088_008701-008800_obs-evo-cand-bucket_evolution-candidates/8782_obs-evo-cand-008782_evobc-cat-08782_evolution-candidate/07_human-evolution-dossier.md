...
- External category reference: `evobc-cat-08782`
- Source category ID: `08782`
- Source label for human review: `躗`
...
- `obs-evo-cand-008782-route-category-staging`
...
- `obs-evo-cand-008782-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008782-route-evolution-graph`
