...
- External category reference: `evobc-cat-07366`
- Source category ID: `07366`
- Source label for human review: `荺`
...
- `obs-evo-cand-007366-route-category-staging`
...
- `obs-evo-cand-007366-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007366-route-evolution-graph`
