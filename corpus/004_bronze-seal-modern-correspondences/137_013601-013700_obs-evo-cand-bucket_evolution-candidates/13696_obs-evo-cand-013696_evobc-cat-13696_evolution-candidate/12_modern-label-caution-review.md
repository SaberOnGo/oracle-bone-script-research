# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013696
...
- EVOBC candidate category: `evobc-evo-cat-13696`.
- Source label for search only: `𮮝`.
- Source codepoints for search only: `U+2EB9D`.
