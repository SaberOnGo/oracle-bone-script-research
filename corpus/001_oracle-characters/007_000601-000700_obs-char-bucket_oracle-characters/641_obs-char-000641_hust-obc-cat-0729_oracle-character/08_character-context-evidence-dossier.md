...
- Project ID / 项目 ID: `obs-char-000641`
- Primary external ID / 首选外部 ID: `hust-obc-cat-0729`
...
- Source image / 来源图: `G_0729_前6.51.4合4890賓組.png`
- Image / 图像: `001_asset-000646_hust-obc-cat-0729_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合4890
...
- target node: `evobc-evo-cat-00053`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/053_obs-evo-cand-000053_evobc-cat-00053_evoluti
...
- Source label text / 来源标签文字: `㛏`
- Source label codepoint / 来源标签 codepoint: `U+36CF`
