# obs-char-001390 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001390`
- primary external id: `hust-obc-cat-1555`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1390_obs-char-001390_hust-obc-cat-1555_ora
  cle-character/03_visual-assets/001_asset-001395_hust-obc-cat-1555_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1555/X_1555_1976_1.png`
- asset id: `asset-001395`
...
- source category: `1555`
- validation class: `1389`
- source image route: `HUST-OBC/deciphered/1555/X_1555_1976_1.png`
- asset id: `asset-001395`
...
- English observation: `Two large branching clusters have broad horizontal
  strokes and separate stems.`
- 中文观察: `两个大型分枝笔画群有宽大水平笔画和分离竖干。`
...
- dataset label text: `㨉`
- dataset label codepoints: `U+3A09`
...
- Which source records identify obs-char-001390 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001390？
