...
- External category reference: `evobc-cat-10714`
- Source category ID: `10714`
- Source label for human review: `齎`
- Source codepoints: `U+9F4E`
...
- `obs-evo-cand-010714-route-category-staging`
...
- `obs-evo-cand-010714-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010714-route-evolution-graph`
