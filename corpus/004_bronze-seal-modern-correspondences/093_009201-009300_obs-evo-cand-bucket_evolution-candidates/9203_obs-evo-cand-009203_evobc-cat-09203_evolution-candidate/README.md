# obs-evo-cand-009203 / EVOBC evolution-category candidate
...
- EVOBC category candidate ID: `evobc-evo-cat-09203`
- External category ref: `evobc-cat-09203`
- Source label for human review: `鄢`
- Source codepoints: `U+9122`
- Image reference count: `30`
- Era token counts: `SS:1;WSC:29`
- Source token counts: `Book:7;Web:23`
