# Material Visual Observation / obs-comp-cand-002382 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002382`
- External reference / 外部参照: `obimd-sub-0uwtmkfamk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020453_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3lxxctblxe/0uwtmkfamk/0uwtmkfamk.png`
- Checksum / 校验和:
  `23a9c00c61060d71b09246c5dd44d87232c9e11a9bb2fdee839532af07be949b`
...
- Marked-pixel bounds: (77,41)–(170,202); span 94 × 162 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.24%。
- 痕迹范围：(77,41)–(170,202)；跨度94 × 162 px；痕迹矩形高于宽。
