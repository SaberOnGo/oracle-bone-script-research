# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004535
...
- EVOBC candidate category: `evobc-evo-cat-04535`.
- Source label for search only: `沋`.
- Source codepoints for search only: `U+6C8B`.
