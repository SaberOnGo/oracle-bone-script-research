...
Project ID: `obs-evo-cand-006302`
...
- Project ID: `obs-evo-cand-006302`
- EVOBC category candidate ID: `evobc-evo-cat-06302`
- External category reference: `evobc-cat-06302`
- Source category ID: `06302`
- Source label for human review: `箯`
- Source codepoints: `U+7BAF`
...
- `obs-evo-cand-006302-route-category-staging`
...
- `obs-evo-cand-006302-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006302-route-evolution-graph`
