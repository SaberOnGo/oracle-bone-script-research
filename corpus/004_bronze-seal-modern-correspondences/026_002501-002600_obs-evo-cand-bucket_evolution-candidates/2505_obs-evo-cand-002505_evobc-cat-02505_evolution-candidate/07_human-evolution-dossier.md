...
- External category reference: `evobc-cat-02505`
- Source category ID: `02505`
- Source label for human review: `屐`
- Source codepoints: `U+5C50`
...
- `obs-evo-cand-002505-route-category-staging`
...
- `obs-evo-cand-002505-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002505-route-evolution-graph`
