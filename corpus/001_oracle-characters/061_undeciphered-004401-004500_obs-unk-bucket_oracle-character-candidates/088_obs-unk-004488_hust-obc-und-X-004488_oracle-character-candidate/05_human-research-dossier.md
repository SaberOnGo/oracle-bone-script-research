# obs-unk-004488 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004488`
- primary external id: `hust-obc-und-X-004488`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/088_obs-unk-004488_h
  ust-obc-und-X-004488_oracle-character-candidate/03_visual-assets/001_asset
  -006081_hust-obc-und-X-004488_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/44/X_？_8225_1.png`
- asset id: `asset-006081`
...
- source class: `HUST-OBC/undeciphered/X/44/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/44/X_？_8225_1.png`
- asset id: `asset-006081`
...
- English observation: A curved upper trace and central bar lead into a long
  lower curve with a rounded terminal.
- 中文观察: 上部弧线和中部横痕连接长下部弧线及圆弧末端。
...
- Which source records identify obs-unk-004488 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004488？
