# obs-unk-006398 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006398`
- primary external id: `hust-obc-und-X-006398`
...
- local review image route: `corpus/001_oracle-characters/080_undeciphered-006
  301-006400_obs-unk-bucket_oracle-character-candidates/098_obs-unk-006398_h
  ust-obc-und-X-006398_oracle-character-candidate/03_visual-assets/001_asset
  -007989_hust-obc-und-X-006398_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1954/X_？_5404_1.png`
- asset id: `asset-007989`
...
- source class: `HUST-OBC/undeciphered/X/1954/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1954/X_？_5404_1.png`
- asset id: `asset-007989`
...
- Which source records identify obs-unk-006398 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006398？
