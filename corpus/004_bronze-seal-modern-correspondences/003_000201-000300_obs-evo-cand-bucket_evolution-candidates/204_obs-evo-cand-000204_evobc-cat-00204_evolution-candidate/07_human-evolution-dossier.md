...
- External category reference: `evobc-cat-00204`
- Source category ID: `00204`
- Source label for human review: `㳄`
- Source codepoints: `U+3CC4`
- Image reference count in source metadata: `64`
...
- `obs-evo-cand-000204-route-category-staging`
...
- `obs-evo-cand-000204-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000204-route-evolution-graph`
