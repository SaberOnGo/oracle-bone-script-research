...
- External category reference: `evobc-cat-00224`
- Source category ID: `00224`
- Source label for human review: `㷉`
...
- `obs-evo-cand-000224-route-category-staging`
...
- `obs-evo-cand-000224-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000224-route-evolution-graph`
