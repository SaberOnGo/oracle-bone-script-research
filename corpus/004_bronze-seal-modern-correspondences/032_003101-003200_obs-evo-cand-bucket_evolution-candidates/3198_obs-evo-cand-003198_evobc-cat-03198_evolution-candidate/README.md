# obs-evo-cand-003198 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-003198`
- EVOBC category candidate ID: `evobc-evo-cat-03198`
- External category ref: `evobc-cat-03198`
- Source label: `戈`
- Source codepoints: `U+6208`
- Image reference count: `241`
- Era token counts: `BI:101;CS:1;OBC:54;SAC:27;SS:2;WSC:56`
- Source token counts: `Book:117;Web:124`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 54 image references
- era 1 / BI: 101 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 27 image references
- era 4 / WSC: 56 image references
- era 5 / CS: 1 image references
- source 0 / Web:1633: 1 image references
- source 1 / Web:105952;說文Web:58: 102 image references
- source 2 / Book:17600: 14 image references
- source 3 / Book:21681: 50 image references
- source 4 / Book:9131: 27 image references
- source 5 / Book:32794: 22 image references
- source 6 / Web:30645: 21 image references
- source 7 / Book:9676: 4 image references
