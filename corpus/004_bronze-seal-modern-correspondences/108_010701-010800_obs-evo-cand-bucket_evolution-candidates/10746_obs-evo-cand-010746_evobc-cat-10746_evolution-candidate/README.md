# obs-evo-cand-010746 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-010746`
- EVOBC category candidate ID: `evobc-evo-cat-10746`
- External category ref: `evobc-cat-10746`
- Source label: `龏`
- Source codepoints: `U+9F8F`
- Image reference count: `156`
- Era token counts: `BI:56;OBC:35;SAC:19;SS:1;WSC:45`
- Source token counts: `Book:78;Web:78`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 35 image references
- era 1 / BI: 56 image references
