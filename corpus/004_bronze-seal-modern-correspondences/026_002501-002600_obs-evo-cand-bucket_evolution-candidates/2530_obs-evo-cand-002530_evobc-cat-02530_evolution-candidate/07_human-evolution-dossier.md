...
Project ID: `obs-evo-cand-002530`
...
- Project ID: `obs-evo-cand-002530`
- EVOBC category candidate ID: `evobc-evo-cat-02530`
- External category reference: `evobc-cat-02530`
- Source category ID: `02530`
- Source label for human review: `屿`
- Source codepoints: `U+5C7F`
...
- `obs-evo-cand-002530-route-category-staging`
...
- `obs-evo-cand-002530-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002530-route-evolution-graph`
