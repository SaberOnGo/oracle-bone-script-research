# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013531
...
- EVOBC candidate category: `evobc-evo-cat-13531`.
- Source label for search only: `𭟪`.
- Source codepoints for search only: `U+2D7EA`.
