...
Project ID: `obs-evo-cand-010166`
...
- Project ID: `obs-evo-cand-010166`
- EVOBC category candidate ID: `evobc-evo-cat-10166`
- External category reference: `evobc-cat-10166`
- Source category ID: `10166`
- Source label for human review: `馴`
- Source codepoints: `U+99B4`
...
- `obs-evo-cand-010166-route-category-staging`
...
- `obs-evo-cand-010166-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010166-route-evolution-graph`
