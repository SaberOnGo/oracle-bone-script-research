# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010271
...
- EVOBC candidate category: `evobc-evo-cat-10271`.
- Source label for search only: `驯`.
- Source codepoints for search only: `U+9A6F`.
