...
- External category reference: `evobc-cat-00916`
- Source category ID: `00916`
- Source label for human review: `倅`
- Source codepoints: `U+5005`
...
- `obs-evo-cand-000916-route-category-staging`
...
- `obs-evo-cand-000916-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000916-route-evolution-graph`
