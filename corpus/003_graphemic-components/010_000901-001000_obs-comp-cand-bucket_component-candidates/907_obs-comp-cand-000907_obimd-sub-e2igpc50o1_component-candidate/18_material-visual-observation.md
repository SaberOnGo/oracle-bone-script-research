# Material Visual Observation / obs-comp-cand-000907 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000907`
- External reference / 外部参照: `obimd-sub-e2igpc50o1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013979_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/sbjf4foazl/e2igpc50o1/e2igpc50o1.png`
- Checksum / 校验和:
  `cf0e68b8208848611f2c4e6d8e0532c07f265a1896553ed1a4f08a8bf9f7f986`
...
- Marked-pixel bounds: (87,24)–(173,228); span 87 × 205 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.95%。
- 痕迹范围：(87,24)–(173,228)；跨度87 × 205 px；痕迹矩形高于宽。
