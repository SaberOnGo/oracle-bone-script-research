...
Project ID: `obs-evo-cand-011232`
...
- Project ID: `obs-evo-cand-011232`
- EVOBC category candidate ID: `evobc-evo-cat-11232`
- External category reference: `evobc-cat-11232`
- Source category ID: `11232`
- Source label for human review: `𢙿`
- Source codepoints: `U+2267F`
...
- `obs-evo-cand-011232-route-category-staging`
...
- `obs-evo-cand-011232-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011232-route-evolution-graph`
