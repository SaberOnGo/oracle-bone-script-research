...
Project ID: `obs-insc-cw-cand-000018`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000018`
...
- Yingguo / 英国所藏: `y86` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `185` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `391` in source row; primary catalog entry pending
- Heji / 合集: `39560` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000018`
