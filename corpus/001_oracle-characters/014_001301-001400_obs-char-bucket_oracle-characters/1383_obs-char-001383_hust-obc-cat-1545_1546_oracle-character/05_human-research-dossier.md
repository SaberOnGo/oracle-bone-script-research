# obs-char-001383 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1383_obs-char-001383_hust-obc-cat-1545_154
  6_oracle-character/03_visual-assets/001_asset-001388_hust-obc-cat-1545_154
  6_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1545_1546/1545/G_1545_乙140合2072
  7.png`
- asset id: `asset-001388`
...
- source category: `1545_1546`
- validation class: `1382`
- source image route: `HUST-OBC/deciphered/1545_1546/1545/G_1545_乙140合20727.pn
  g`
- asset id: `asset-001388`
...
- English observation: `A narrow composite has an upper crossing, repeated
  left branches, and a long curve.`
...
- dataset label text: `㧿㨀`
- dataset label codepoints: `U+39FF;U+3A00`
...
- filename catalog route clues: `Heji-like filename clue: 合20727
  (G_1545_乙140合20727.png)`
...
- Which source records identify obs-char-001383 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001383？
