# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002142
...
| --- | --- | --- | --- |
| `obimd-glyph-link-033276` | 󼯌 | `U+FCBCC` | `reviewed_metadata_only` |
| `obimd-glyph-link-033277` | 󼯍 | `U+FCBCD` | `reviewed_metadata_only` |
