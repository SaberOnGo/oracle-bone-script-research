...
- External category reference: `evobc-cat-07680`
- Source category ID: `07680`
- Source label for human review: `蘰`
- Source codepoints: `U+8630`
...
- `obs-evo-cand-007680-route-category-staging`
...
- `obs-evo-cand-007680-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007680-route-evolution-graph`
