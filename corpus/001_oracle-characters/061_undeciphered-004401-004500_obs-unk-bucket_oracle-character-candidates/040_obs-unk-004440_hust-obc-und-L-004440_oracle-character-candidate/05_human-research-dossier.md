# obs-unk-004440 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004440`
- primary external id: `hust-obc-und-L-004440`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/040_obs-unk-004440_h
  ust-obc-und-L-004440_oracle-character-candidate/03_visual-assets/001_asset
  -006033_hust-obc-und-L-004440_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4440/L_？_9970.jpg`
- asset id: `asset-006033`
...
- source class: `HUST-OBC/undeciphered/L/4440/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4440/L_？_9970.jpg`
- asset id: `asset-006033`
...
- English observation: `An upper triangular trace sits above a broad`
  `lower outline.`
- 中文观察: `上部三角状痕迹位于下部宽轮廓之上。`
...
- Which source records identify obs-unk-004440 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004440？
