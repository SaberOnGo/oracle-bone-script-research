...
- External category reference: `evobc-cat-02538`
- Source category ID: `02538`
- Source label for human review: `岛`
- Source codepoints: `U+5C9B`
...
- `obs-evo-cand-002538-route-category-staging`
...
- `obs-evo-cand-002538-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002538-route-evolution-graph`
