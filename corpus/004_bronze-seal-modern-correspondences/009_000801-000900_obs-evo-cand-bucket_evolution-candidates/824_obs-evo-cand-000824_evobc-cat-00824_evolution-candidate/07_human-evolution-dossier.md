...
- External category reference: `evobc-cat-00824`
- Source category ID: `00824`
- Source label for human review: `佸`
...
- `obs-evo-cand-000824-route-category-staging`
...
- `obs-evo-cand-000824-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000824-route-evolution-graph`
