...
- External category reference: `evobc-cat-04523`
- Source category ID: `04523`
- Source label for human review: `汻`
...
- `obs-evo-cand-004523-route-category-staging`
...
- `obs-evo-cand-004523-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004523-route-evolution-graph`
