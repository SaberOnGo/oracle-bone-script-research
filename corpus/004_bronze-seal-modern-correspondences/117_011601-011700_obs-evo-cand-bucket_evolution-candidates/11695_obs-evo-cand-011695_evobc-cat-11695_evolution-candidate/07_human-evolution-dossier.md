...
- External category reference: `evobc-cat-11695`
- Source category ID: `11695`
- Source label for human review: `𤶖`
...
- `obs-evo-cand-011695-route-category-staging`
...
- `obs-evo-cand-011695-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011695-route-evolution-graph`
