...
- External category reference: `evobc-cat-12248`
- Source category ID: `12248`
- Source label for human review: `𧫾`
- Source codepoints: `U+27AFE`
...
- `obs-evo-cand-012248-route-category-staging`
...
- `obs-evo-cand-012248-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012248-route-evolution-graph`
