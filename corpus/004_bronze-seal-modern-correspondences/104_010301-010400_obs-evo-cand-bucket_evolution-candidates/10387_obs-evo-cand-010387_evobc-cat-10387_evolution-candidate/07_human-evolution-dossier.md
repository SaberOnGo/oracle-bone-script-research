...
Project ID: `obs-evo-cand-010387`
...
- Project ID: `obs-evo-cand-010387`
- EVOBC category candidate ID: `evobc-evo-cat-10387`
- External category reference: `evobc-cat-10387`
- Source category ID: `10387`
- Source label for human review: `鮌`
- Source codepoints: `U+9B8C`
...
- `obs-evo-cand-010387-route-category-staging`
...
- `obs-evo-cand-010387-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010387-route-evolution-graph`
