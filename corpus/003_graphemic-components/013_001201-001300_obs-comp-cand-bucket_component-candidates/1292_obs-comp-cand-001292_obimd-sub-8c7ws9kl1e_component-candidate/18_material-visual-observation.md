# Material Visual Observation / obs-comp-cand-001292 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001292`
- External reference / 外部参照: `obimd-sub-8c7ws9kl1e`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015577_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bxk4wfwnci/8c7ws9kl1e/8c7ws9kl1e.png`
- Checksum / 校验和:
  `ab3868d68be5cc26cf980abc5f028bf133f389cdea385212ee1530fb25cad857`
...
- Marked-pixel bounds: (90,23)–(159,226); span 70 × 204 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.05%。
- 痕迹范围：(90,23)–(159,226)；跨度70 × 204 px；痕迹矩形高于宽。
