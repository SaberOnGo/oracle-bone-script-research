# obs-unk-004682 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/082_obs-unk-004682_h
  ust-obc-und-X-004682_oracle-character-candidate/03_visual-assets/001_asset
  -006275_hust-obc-und-X-004682_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/238/X_？_8406_1.png`
- asset id: `asset-006275`
...
- source class: `HUST-OBC/undeciphered/X/238/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/238/X_？_8406_1.png`
- asset id: `asset-006275`
...
- English observation: `pale central band in thresholded dark field`
- 中文观察: `阈值化深色区域中的中央浅色带`
...
- Which source records identify obs-unk-004682 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004682？
