...
Project ID: `obs-evo-cand-011451`
...
- Project ID: `obs-evo-cand-011451`
- EVOBC category candidate ID: `evobc-evo-cat-11451`
- External category reference: `evobc-cat-11451`
- Source category ID: `11451`
- Source label for human review: `𣚵`
- Source codepoints: `U+236B5`
...
- `obs-evo-cand-011451-route-category-staging`
...
- `obs-evo-cand-011451-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011451-route-evolution-graph`
