...
- External category reference: `evobc-cat-01632`
- Source category ID: `01632`
- Source label for human review: `啜`
...
- `obs-evo-cand-001632-route-category-staging`
...
- `obs-evo-cand-001632-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001632-route-evolution-graph`
