# Material Visual Observation / obs-comp-cand-002660 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002660`
- External reference / 外部参照: `obimd-sub-tmhw6nvg5h`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021236_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tmhw6nvg5h/tmhw6nvg5h/tmhw6nvg5h.png`
- Checksum / 校验和:
  `8290563e3b7c87b895ca08da5a76165f36e85ea575555ec7f338f9c0abdae71a`
...
- Marked-pixel bounds: (87,22)–(168,222); span 82 × 201 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.27%。
- 痕迹范围：(87,22)–(168,222)；跨度82 × 201 px；痕迹矩形高于宽。
