...
- Project ID: `obs-evo-cand-001129`
- EVOBC category candidate ID: `evobc-evo-cat-01129`
- External category reference: `evobc-cat-01129`
- Source category ID: `01129`
- Source label for human review: `冡`
- Source codepoints: `U+51A1`
...
- `obs-evo-cand-001129-route-category-staging`
...
- `obs-evo-cand-001129-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001129-route-evolution-graph`
