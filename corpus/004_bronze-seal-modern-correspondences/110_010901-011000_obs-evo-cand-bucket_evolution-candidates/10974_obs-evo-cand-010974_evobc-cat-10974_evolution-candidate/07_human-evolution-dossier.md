...
- External category reference: `evobc-cat-10974`
- Source category ID: `10974`
- Source label: `𡈣`
...
- `obs-evo-cand-010974-route-category-staging`
...
- `obs-evo-cand-010974-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010974-route-evolution-graph`
