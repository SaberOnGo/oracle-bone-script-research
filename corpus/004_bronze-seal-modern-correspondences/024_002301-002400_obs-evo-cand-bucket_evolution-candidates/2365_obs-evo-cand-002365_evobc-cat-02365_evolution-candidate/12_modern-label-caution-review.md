# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002365
...
- EVOBC candidate category: `evobc-evo-cat-02365`.
- Source label for search only: `完`.
- Source codepoints for search only: `U+5B8C`.
