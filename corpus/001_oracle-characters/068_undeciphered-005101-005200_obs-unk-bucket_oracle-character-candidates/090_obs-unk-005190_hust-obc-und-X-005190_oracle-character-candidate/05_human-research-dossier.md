# obs-unk-005190 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005190`
- primary external id: `hust-obc-und-X-005190`
...
- local review image route: `corpus/001_oracle-characters/068_undeciphered-005
  101-005200_obs-unk-bucket_oracle-character-candidates/090_obs-unk-005190_h
  ust-obc-und-X-005190_oracle-character-candidate/03_visual-assets/001_asset
  -006783_hust-obc-und-X-005190_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/746/X_？_7711_1.png`
- asset id: `asset-006783`
...
- source class: `HUST-OBC/undeciphered/X/746/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/746/X_？_7711_1.png`
- asset id: `asset-006783`
...
- Which source records identify obs-unk-005190 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005190？
