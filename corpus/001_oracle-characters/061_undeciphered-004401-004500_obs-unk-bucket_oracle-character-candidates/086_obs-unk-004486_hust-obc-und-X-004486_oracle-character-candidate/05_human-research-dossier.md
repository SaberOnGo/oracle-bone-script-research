# obs-unk-004486 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004486`
- primary external id: `hust-obc-und-X-004486`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/086_obs-unk-004486_h
  ust-obc-und-X-004486_oracle-character-candidate/03_visual-assets/001_asset
  -006079_hust-obc-und-X-004486_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/42/X_？_8223_1.png`
- asset id: `asset-006079`
...
- source class: `HUST-OBC/undeciphered/X/42/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/42/X_？_8223_1.png`
- asset id: `asset-006079`
...
- English observation: A tall narrow outline has a forked crown, a lower
  junction, and two hanging terminals.
- 中文观察: 高窄框状痕迹有分叉顶部、下部连接处和两个下垂末端。
...
- Which source records identify obs-unk-004486 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004486？
