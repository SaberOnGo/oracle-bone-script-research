...
- External category reference: `evobc-cat-03088`
- Source category ID: `03088`
- Source label for human review: `感`
...
- `obs-evo-cand-003088-route-category-staging`
...
- `obs-evo-cand-003088-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003088-route-evolution-graph`
