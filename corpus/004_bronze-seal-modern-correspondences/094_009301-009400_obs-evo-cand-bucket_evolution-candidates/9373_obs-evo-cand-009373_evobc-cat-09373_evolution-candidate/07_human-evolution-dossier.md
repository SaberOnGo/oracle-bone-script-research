...
Project ID: `obs-evo-cand-009373`
...
- Project ID: `obs-evo-cand-009373`
- EVOBC category candidate ID: `evobc-evo-cat-09373`
- External category reference: `evobc-cat-09373`
- Source category ID: `09373`
- Source label for human review: `鉵`
- Source codepoints: `U+9275`
...
- `obs-evo-cand-009373-route-category-staging`
...
- `obs-evo-cand-009373-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009373-route-evolution-graph`
