...
- External category reference: `evobc-cat-13197`
- Source category ID: `13197`
- Source label for human review: `𬄑`
...
- `obs-evo-cand-013197-route-category-staging`
...
- `obs-evo-cand-013197-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013197-route-evolution-graph`
