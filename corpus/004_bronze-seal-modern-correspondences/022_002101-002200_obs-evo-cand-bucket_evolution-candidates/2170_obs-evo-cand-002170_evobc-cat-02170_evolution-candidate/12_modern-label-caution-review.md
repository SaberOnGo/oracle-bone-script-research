# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002170
...
- EVOBC candidate category: `evobc-evo-cat-02170`.
- Source label for search only: `娝`.
- Source codepoints for search only: `U+5A1D`.
