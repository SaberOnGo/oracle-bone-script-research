# obs-unk-000988 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000988`
- primary external id: `hust-obc-und-L-000988`
...
- local review image route: `corpus/001_oracle-characters/026_undeciphered-000
  901-001000_obs-unk-bucket_oracle-character-candidates/088_obs-unk-000988_h
  ust-obc-und-L-000988_oracle-character-candidate/03_visual-assets/001_asset
  -002581_hust-obc-und-L-000988_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/988/L_？_1281.jpg`
- asset id: `asset-002581`
...
- source class: `HUST-OBC/undeciphered/L/988/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/988/L_？_1281.jpg`
- asset id: `asset-002581`
...
- Which source records identify obs-unk-000988 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000988？
