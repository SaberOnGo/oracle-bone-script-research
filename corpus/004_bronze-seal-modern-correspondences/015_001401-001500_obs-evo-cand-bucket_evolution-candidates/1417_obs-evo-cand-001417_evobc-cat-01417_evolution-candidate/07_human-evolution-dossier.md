...
Project ID: `obs-evo-cand-001417`
...
- Project ID: `obs-evo-cand-001417`
- EVOBC category candidate ID: `evobc-evo-cat-01417`
- External category reference: `evobc-cat-01417`
- Source category ID: `01417`
- Source label for human review: `厌`
- Source codepoints: `U+538C`
...
- `obs-evo-cand-001417-route-category-staging`
...
- `obs-evo-cand-001417-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001417-route-evolution-graph`
