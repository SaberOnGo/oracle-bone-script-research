...
Project ID: `obs-evo-cand-011204`
...
- Project ID: `obs-evo-cand-011204`
- EVOBC category candidate ID: `evobc-evo-cat-11204`
- External category reference: `evobc-cat-11204`
- Source category ID: `11204`
- Source label for human review: `𢓲`
- Source codepoints: `U+224F2`
...
- `obs-evo-cand-011204-route-category-staging`
...
- `obs-evo-cand-011204-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011204-route-evolution-graph`
