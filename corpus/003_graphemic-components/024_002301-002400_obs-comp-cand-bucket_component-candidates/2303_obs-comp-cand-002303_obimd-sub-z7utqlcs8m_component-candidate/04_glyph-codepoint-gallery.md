# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002303
...
| --- | --- | --- | --- |
| `obimd-glyph-link-035691` | 򧔼󽑩 | `U+A753C;U+FD469` | `reviewed_metadata_only` |
| `obimd-glyph-link-035692` | 󽑪 | `U+FD46A` | `reviewed_metadata_only` |
| `obimd-glyph-link-035693` | 󽑫 | `U+FD46B` | `reviewed_metadata_only` |
