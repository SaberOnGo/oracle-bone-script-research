...
- External category reference: `evobc-cat-07926`
- Source category ID: `07926`
- Source label for human review: `衯`
- Source codepoints: `U+886F`
...
- `obs-evo-cand-007926-route-category-staging`
...
- `obs-evo-cand-007926-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007926-route-evolution-graph`
