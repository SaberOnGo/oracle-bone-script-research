# obs-unk-004597 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/097_obs-unk-004597_h
  ust-obc-und-X-004597_oracle-character-candidate/03_visual-assets/001_asset
  -006190_hust-obc-und-X-004597_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/153/X_？_8330_1.png`
- asset id: `asset-006190`
...
- source class: `HUST-OBC/undeciphered/X/153/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/153/X_？_8330_1.png`
- asset id: `asset-006190`
...
- English observation: `Apex opening, arch, two inner traces, and open`
  `base recorded.`
- 中文观察: `已记录尖顶开口、拱痕、两条内部痕和开放底部。`
...
- Which source records identify obs-unk-004597 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004597？
