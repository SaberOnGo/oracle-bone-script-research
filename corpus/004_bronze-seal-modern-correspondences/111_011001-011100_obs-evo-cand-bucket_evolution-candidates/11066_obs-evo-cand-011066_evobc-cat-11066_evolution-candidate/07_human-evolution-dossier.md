...
Project ID: `obs-evo-cand-011066`
...
- Project ID: `obs-evo-cand-011066`
- EVOBC category candidate ID: `evobc-evo-cat-11066`
- External category reference: `evobc-cat-11066`
- Source category ID: `11066`
- Source label for human review: `𡧖`
- Source codepoints: `U+219D6`
...
- `obs-evo-cand-011066-route-category-staging`
...
- `obs-evo-cand-011066-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011066-route-evolution-graph`
