# obs-char-000046 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000046`
- primary external id: `hust-obc-cat-0054`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/046_obs-char-000046_hust-obc-cat-0054_orac
  le-character/03_visual-assets/001_asset-000051_hust-obc-cat-0054_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0054/L_0054_13693.jpg`
- asset id: `asset-000051`
...
- source category: `0054`
- validation class: `45`
- source image route: `HUST-OBC/deciphered/0054/L_0054_13693.jpg`
- asset id: `asset-000051`
...
- English observation: `The tiny gray image has two neighboring angular
  upper marks, a short connecting stroke, and two thin lower strokes.`
- 中文观察: `微小灰度图像上方有两个相邻折角痕迹，中间有短连接笔画，下方有两条细笔画。`
...
- dataset label text: `㐬`
- dataset label codepoints: `U+342C`
...
- Which source records identify obs-char-000046 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000046？
