...
- External category reference: `evobc-cat-13205`
- Source category ID: `13205`
- Source label for human review: `𬅨`
- Source codepoints: `U+2C168`
...
- `obs-evo-cand-013205-route-category-staging`
...
- `obs-evo-cand-013205-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013205-route-evolution-graph`
