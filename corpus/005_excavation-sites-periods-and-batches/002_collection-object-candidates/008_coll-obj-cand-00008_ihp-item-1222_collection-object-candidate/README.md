# coll-obj-cand-00008 collection object candidate
...
- `18_live-source-evidence-review.md`: live official-page and image-route
  evidence review.
- `19_official-page-text-evidence.md`: paired official page snapshots,
  placeholder responses, and image-response evidence.
...
- object_title_en: `Tortoise Carapace Fragments Yi Bian
