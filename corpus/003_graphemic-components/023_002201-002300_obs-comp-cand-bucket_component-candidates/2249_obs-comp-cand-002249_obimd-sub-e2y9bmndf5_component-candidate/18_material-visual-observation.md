# Material Visual Observation / obs-comp-cand-002249 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002249`
- External reference / 外部参照: `obimd-sub-e2y9bmndf5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020062_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ha65d656ik/e2y9bmndf5/e2y9bmndf5.png`
- Checksum / 校验和:
  `8191bee3fd1db2c5fc5f4600ee79b95cf2e56cc3d4034d921f7a29e4e0dd5646`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.18%.
- Marked-pixel bounds: (83,42)–(166,201); span 84 × 160 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.18%。
- 痕迹范围：(83,42)–(166,201)；跨度84 × 160 px；痕迹矩形高于宽。
