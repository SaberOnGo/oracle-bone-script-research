...
Project ID: `obs-evo-cand-008998`
...
- Project ID: `obs-evo-cand-008998`
- EVOBC category candidate ID: `evobc-evo-cat-08998`
- External category reference: `evobc-cat-08998`
- Source category ID: `08998`
- Source label for human review: `逞`
- Source codepoints: `U+901E`
...
- `obs-evo-cand-008998-route-category-staging`
...
- `obs-evo-cand-008998-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008998-route-evolution-graph`
