# Material Visual Observation / obs-comp-cand-001518 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001518`
- External reference / 外部参照: `obimd-sub-ekqpz9e16e`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016481_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ekqpz9e16e/ekqpz9e16e/ekqpz9e16e.png`
- Checksum / 校验和:
  `e674e1d3fb13860084341d58700e9f71e62671b4987946bdfe5ae1f50328454c`
...
- Marked-pixel bounds: (45,51)–(207,195); span 163 × 145 px; the marked
...
- 痕迹范围：(45,51)–(207,195)；跨度163 × 145 px；痕迹矩形近方形。
