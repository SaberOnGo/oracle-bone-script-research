...
- External category reference: `evobc-cat-09052`
- Source category ID: `09052`
- Source label for human review: `遭`
- Source codepoints: `U+906D`
- Image reference count in source metadata: `119`
...
- `obs-evo-cand-009052-route-category-staging`
...
- `obs-evo-cand-009052-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009052-route-evolution-graph`
