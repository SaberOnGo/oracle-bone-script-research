...
- External category reference: `evobc-cat-05817`
- Source category ID: `05817`
- Source label for human review: `眾`
- Source codepoints: `U+773E`
- Image reference count in source metadata: `168`
...
- `obs-evo-cand-005817-route-category-staging`
...
- `obs-evo-cand-005817-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005817-route-evolution-graph`
