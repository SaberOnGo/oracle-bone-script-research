# obs-unk-004725 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004725`
- primary external id: `hust-obc-und-X-004725`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/025_obs-unk-004725_h
  ust-obc-und-X-004725_oracle-character-candidate/03_visual-assets/001_asset
  -006318_hust-obc-und-X-004725_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/281/X_？_7261_1.png`
- asset id: `asset-006318`
...
- source class: `HUST-OBC/undeciphered/X/281/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/281/X_？_7261_1.png`
- asset id: `asset-006318`
...
- English observation: `broad upper wedge with two pale openings`
- 中文观察: `带两个浅色开口的宽大上部楔状结构`
...
- Which source records identify obs-unk-004725 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004725？
