# Material Visual Observation / obs-comp-cand-000044 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000044`
- External reference / 外部参照: `obimd-sub-rzfokwkc7a`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011301_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rzfokwkc7a/rzfokwkc7a/0nw6g0u36w.png`
- Checksum / 校验和:
  `d3e6ce4769cc324893a495261fba377f2dd9305366f71aa03e79377fac3c1b3a`
...
- Marked-pixel bounds: (80,28)–(169,217); span 90 × 190 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.44%。
- 痕迹范围：(80,28)–(169,217)；跨度90 × 190 px；痕迹矩形高于宽。
