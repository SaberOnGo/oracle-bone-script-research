# Material Visual Observation / obs-comp-cand-001095 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001095`
- External reference / 外部参照: `obimd-sub-5cuto8p2fx`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014904_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5cuto8p2fx/5cuto8p2fx/5cuto8p2fx.png`
- Checksum / 校验和:
  `9953c5c5597cc8262d2958978328948cd1990b8ca4b07bdf2a60d7c7575ab100`
...
- Marked-pixel bounds: (66,22)–(180,226); span 115 × 205 px; the marked
...
- 痕迹范围：(66,22)–(180,226)；跨度115 × 205 px；痕迹矩形高于宽。
