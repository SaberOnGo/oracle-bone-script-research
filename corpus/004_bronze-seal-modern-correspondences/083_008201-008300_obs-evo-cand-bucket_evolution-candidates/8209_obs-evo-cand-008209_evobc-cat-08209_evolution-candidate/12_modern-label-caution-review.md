# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008209
...
- EVOBC candidate category: `evobc-evo-cat-08209`.
- Source label for search only: `詾`.
- Source codepoints for search only: `U+8A7E`.
