# Material Visual Observation / obs-comp-cand-000290 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000290`
- External reference / 外部参照: `obimd-sub-hxfd7qqttz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011998_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hxfd7qqttz/hxfd7qqttz/hxfd7qqttz.png`
- Checksum / 校验和:
  `b6c75839b3d1e533382f99dc51cbcdedc98af5b316cbad33784c0e72382448cc`
...
- Marked-pixel bounds: (63,47)–(187,202); span 125 × 156 px; the marked
...
- 痕迹范围：(63,47)–(187,202)；跨度125 × 156 px；痕迹矩形高于宽。
