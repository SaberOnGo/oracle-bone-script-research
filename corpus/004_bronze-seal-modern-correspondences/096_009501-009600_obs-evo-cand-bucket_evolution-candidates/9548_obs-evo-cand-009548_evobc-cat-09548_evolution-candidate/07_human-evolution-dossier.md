...
Project ID: `obs-evo-cand-009548`
...
- Project ID: `obs-evo-cand-009548`
- EVOBC category candidate ID: `evobc-evo-cat-09548`
- External category reference: `evobc-cat-09548`
- Source category ID: `09548`
- Source label for human review: `鑞`
- Source codepoints: `U+945E`
...
- `obs-evo-cand-009548-route-category-staging`
...
- `obs-evo-cand-009548-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009548-route-evolution-graph`
