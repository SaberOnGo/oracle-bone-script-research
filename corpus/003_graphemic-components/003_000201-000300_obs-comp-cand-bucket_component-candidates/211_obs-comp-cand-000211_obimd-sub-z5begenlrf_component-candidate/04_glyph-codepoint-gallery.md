# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000211
...
| --- | --- | --- | --- |
| `obimd-glyph-link-003107` | 󱏺 | `U+F13FA` | `reviewed_metadata_only` |
| `obimd-glyph-link-003108` | 󱏻 | `U+F13FB` | `reviewed_metadata_only` |
| `obimd-glyph-link-003109` | 󱏼 | `U+F13FC` | `reviewed_metadata_only` |
