# obs-unk-004874 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004874`
- primary external id: `hust-obc-und-X-004874`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/074_obs-unk-004874_h
  ust-obc-und-X-004874_oracle-character-candidate/03_visual-assets/001_asset
  -006467_hust-obc-und-X-004874_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/430/X_？_7413_1.png`
- asset id: `asset-006467`
...
- source class: `HUST-OBC/undeciphered/X/430/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/430/X_？_7413_1.png`
- asset id: `asset-006467`
...
- English observation: `tall paired strokes and a right curved return`
- 中文观察: `成对长笔画和右侧回转弧笔画`
...
- Which source records identify obs-unk-004874 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004874？
