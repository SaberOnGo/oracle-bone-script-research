# obs-unk-003067 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/047_undeciphered-003
  001-003100_obs-unk-bucket_oracle-character-candidates/067_obs-unk-003067_h
  ust-obc-und-L-003067_oracle-character-candidate/03_visual-assets/001_asset
  -004660_hust-obc-und-L-003067_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3067/L_？_5490.jpg`
- asset id: `asset-004660`
...
- source class: `HUST-OBC/undeciphered/L/3067/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3067/L_？_5490.jpg`
- asset id: `asset-004660`
...
- Which source records identify obs-unk-003067 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003067？
