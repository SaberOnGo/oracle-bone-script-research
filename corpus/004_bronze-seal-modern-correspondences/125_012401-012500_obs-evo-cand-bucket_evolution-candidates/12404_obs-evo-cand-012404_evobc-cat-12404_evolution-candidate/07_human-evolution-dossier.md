...
Project ID: `obs-evo-cand-012404`
...
- Project ID: `obs-evo-cand-012404`
- EVOBC category candidate ID: `evobc-evo-cat-12404`
- External category reference: `evobc-cat-12404`
- Source category ID: `12404`
- Source label for human review: `𨙽`
- Source codepoints: `U+2867D`
...
- `obs-evo-cand-012404-route-category-staging`
...
- `obs-evo-cand-012404-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012404-route-evolution-graph`
