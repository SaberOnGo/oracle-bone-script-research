...
- `obs-evo-cand-012647-route-category-staging`
...
- `obs-evo-cand-012647-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012647-route-evolution-graph`
