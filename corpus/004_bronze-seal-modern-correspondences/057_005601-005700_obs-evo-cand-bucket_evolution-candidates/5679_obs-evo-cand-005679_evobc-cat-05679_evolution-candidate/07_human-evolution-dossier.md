...
- External category reference: `evobc-cat-05679`
- Source category ID: `05679`
- Source label for human review: `瘱`
- Source codepoints: `U+7631`
...
- `obs-evo-cand-005679-route-category-staging`
...
- `obs-evo-cand-005679-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005679-route-evolution-graph`
