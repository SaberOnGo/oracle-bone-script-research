...
- Project ID: `obs-evo-cand-001093`
- EVOBC category candidate ID: `evobc-evo-cat-01093`
- External category reference: `evobc-cat-01093`
- Source category ID: `01093`
- Source label for human review: `六`
- Source codepoints: `U+516D`
- Image reference count in source metadata: `202`
...
- `obs-evo-cand-001093-route-category-staging`
...
- `obs-evo-cand-001093-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001093-route-evolution-graph`
