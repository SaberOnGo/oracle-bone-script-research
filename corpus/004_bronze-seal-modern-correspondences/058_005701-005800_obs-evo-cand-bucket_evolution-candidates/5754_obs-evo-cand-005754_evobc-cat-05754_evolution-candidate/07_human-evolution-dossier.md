...
- External category reference: `evobc-cat-05754`
- Source category ID: `05754`
- Source label for human review: `盘`
- Source codepoints: `U+76D8`
...
- `obs-evo-cand-005754-route-category-staging`
...
- `obs-evo-cand-005754-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005754-route-evolution-graph`
