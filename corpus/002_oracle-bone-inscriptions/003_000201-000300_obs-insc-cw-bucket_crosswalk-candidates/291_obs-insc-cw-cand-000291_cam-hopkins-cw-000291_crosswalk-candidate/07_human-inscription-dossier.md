...
- Source page section: `Wu tsu` /
  `午祖（原页标签）`
- Source section key: `period-I-wu-tsu`
...
- Yingguo / 英国所藏: `y1920` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `560` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `725` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000291`
