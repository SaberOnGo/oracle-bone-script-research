...
- External category reference: `evobc-cat-02583`
- Source category ID: `02583`
- Source label for human review: `嵞`
- Source codepoints: `U+5D5E`
...
- `obs-evo-cand-002583-route-category-staging`
...
- `obs-evo-cand-002583-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002583-route-evolution-graph`
