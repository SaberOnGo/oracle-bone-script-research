...
Project ID: `obs-evo-cand-012331`
...
- Project ID: `obs-evo-cand-012331`
- EVOBC category candidate ID: `evobc-evo-cat-12331`
- External category reference: `evobc-cat-12331`
- Source category ID: `12331`
- Source label for human review: `𨍁`
- Source codepoints: `U+28341`
...
- `obs-evo-cand-012331-route-category-staging`
...
- `obs-evo-cand-012331-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012331-route-evolution-graph`
