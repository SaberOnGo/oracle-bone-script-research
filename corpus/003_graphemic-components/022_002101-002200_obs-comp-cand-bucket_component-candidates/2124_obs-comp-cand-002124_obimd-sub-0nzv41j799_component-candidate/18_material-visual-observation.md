# Material Visual Observation / obs-comp-cand-002124 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002124`
- External reference / 外部参照: `obimd-sub-0nzv41j799`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019681_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dlza5ir0k7/0nzv41j799/0nzv41j799.png`
- Checksum / 校验和:
  `3ed17b2bf99025581bcf370aa364e1aa612401db0fc5ec2472c964cf59fcdf1e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.66%.
- Marked-pixel bounds: (79,37)–(170,194); span 92 × 158 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.66%。
- 痕迹范围：(79,37)–(170,194)；跨度92 × 158 px；痕迹矩形高于宽。
