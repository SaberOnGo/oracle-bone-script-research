...
- External category reference: `evobc-cat-12620`
- Source category ID: `12620`
- Source label for human review: `𩖊`
- Source codepoints: `U+2958A`
...
- `obs-evo-cand-012620-route-category-staging`
...
- `obs-evo-cand-012620-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012620-route-evolution-graph`
