# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006745
...
- EVOBC candidate category: `evobc-evo-cat-06745`.
- Source label for search only: `经`.
- Source codepoints for search only: `U+7ECF`.
