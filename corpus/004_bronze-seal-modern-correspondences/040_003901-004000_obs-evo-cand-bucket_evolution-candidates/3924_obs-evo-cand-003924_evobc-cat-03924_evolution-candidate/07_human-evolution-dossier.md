...
- External category reference: `evobc-cat-03924`
- Source category ID: `03924`
- Source label for human review: `枕`
- Source codepoints: `U+6795`
...
- `obs-evo-cand-003924-route-category-staging`
...
- `obs-evo-cand-003924-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003924-route-evolution-graph`
