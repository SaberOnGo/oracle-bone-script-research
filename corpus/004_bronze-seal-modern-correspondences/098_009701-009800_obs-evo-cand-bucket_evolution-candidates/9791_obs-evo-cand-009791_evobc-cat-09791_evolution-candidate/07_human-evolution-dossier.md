...
- External category reference: `evobc-cat-09791`
- Source category ID: `09791`
- Source label for human review: `隴`
- Source codepoints: `U+96B4`
...
- `obs-evo-cand-009791-route-category-staging`
...
- `obs-evo-cand-009791-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009791-route-evolution-graph`
