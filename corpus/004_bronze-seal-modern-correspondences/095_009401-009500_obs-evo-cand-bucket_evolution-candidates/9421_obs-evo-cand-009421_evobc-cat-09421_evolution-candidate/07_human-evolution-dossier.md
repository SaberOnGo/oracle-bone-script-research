...
Project ID: `obs-evo-cand-009421`
...
- Project ID: `obs-evo-cand-009421`
- EVOBC category candidate ID: `evobc-evo-cat-09421`
- External category reference: `evobc-cat-09421`
- Source category ID: `09421`
- Source label for human review: `鋻`
- Source codepoints: `U+92FB`
...
- `obs-evo-cand-009421-route-category-staging`
...
- `obs-evo-cand-009421-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009421-route-evolution-graph`
