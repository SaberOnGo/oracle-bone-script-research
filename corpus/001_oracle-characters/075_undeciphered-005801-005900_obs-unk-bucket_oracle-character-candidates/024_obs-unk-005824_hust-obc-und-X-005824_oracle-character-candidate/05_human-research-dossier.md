# obs-unk-005824 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005824`
- primary external id: `hust-obc-und-X-005824`
...
- local review image route: `corpus/001_oracle-characters/075_undeciphered-005
  801-005900_obs-unk-bucket_oracle-character-candidates/024_obs-unk-005824_h
  ust-obc-und-X-005824_oracle-character-candidate/03_visual-assets/001_asset
  -007416_hust-obc-und-X-005824_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1380/X_？_1912_1.png`
- asset id: `asset-007416`
...
- source class: `HUST-OBC/undeciphered/X/1380/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1380/X_？_1912_1.png`
- asset id: `asset-007416`
...
- Which source records identify obs-unk-005824 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005824？
