# obs-char-000774 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/774_obs-char-000774_hust-obc-cat-0878_orac
  le-character/03_visual-assets/001_asset-000779_hust-obc-cat-0878_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0878/H_0878_6078F_0.png`
- asset id: `asset-000779`
...
- source category: `0878`
- validation class: `773`
- source image route: `HUST-OBC/deciphered/0878/H_0878_6078F_0.png`
- asset id: `asset-000779`
...
- English observation: `A tall left stem branches above and into three long
  lower legs; at right, an angular roof with a horizontal inner bar stands
  above a detached pointed oval loop.`
...
- dataset label text: `㝤`
- dataset label codepoints: `U+3764`
...
- filename catalog route clues: `catalog-like filename clue: H_0878
  (H_0878_6078F_0.png)`
...
- Which source records identify obs-char-000774 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000774？
