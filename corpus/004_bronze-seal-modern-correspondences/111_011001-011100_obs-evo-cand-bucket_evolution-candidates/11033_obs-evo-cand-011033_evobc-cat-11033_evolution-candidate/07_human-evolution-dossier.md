...
- External category reference: `evobc-cat-11033`
- Source category ID: `11033`
- Source label for human review: `𡛫`
...
- `obs-evo-cand-011033-route-category-staging`
...
- `obs-evo-cand-011033-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011033-route-evolution-graph`
