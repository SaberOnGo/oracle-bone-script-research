# obs-unk-006130 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006130`
- primary external id: `hust-obc-und-X-006130`
...
- local review image route: `corpus/001_oracle-characters/078_undeciphered-006
  101-006200_obs-unk-bucket_oracle-character-candidates/030_obs-unk-006130_h
  ust-obc-und-X-006130_oracle-character-candidate/03_visual-assets/001_asset
  -007722_hust-obc-und-X-006130_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1686/X_？_3855_1.png`
- asset id: `asset-007722`
...
- source class: `HUST-OBC/undeciphered/X/1686/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1686/X_？_3855_1.png`
- asset id: `asset-007722`
...
- Which source records identify obs-unk-006130 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006130？
