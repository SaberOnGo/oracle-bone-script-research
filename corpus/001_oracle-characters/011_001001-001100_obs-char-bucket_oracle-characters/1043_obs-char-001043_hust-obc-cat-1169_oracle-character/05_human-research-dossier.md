# obs-char-001043 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1043_obs-char-001043_hust-obc-cat-1169_ora
  cle-character/03_visual-assets/001_asset-001048_hust-obc-cat-1169_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1169/G_1169_前6.3.6合15216賓組.png`
- asset id: `asset-001048`
...
- source category: `1169`
- validation class: `1042`
- source image route: `HUST-OBC/deciphered/1169/G_1169_前6.3.6合15216賓組.png`
- asset id: `asset-001048`
...
- dataset label text: `㢇`
- dataset label codepoints: `U+3887`
...
- filename catalog route clues: `Heji-like filename clue: 合15216
...
- Which source records identify obs-char-001043 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001043？
