# Collection Provenance Fact Matrix / 馆藏来源事实矩阵: coll-obj-cand-00024
...
- Use `18_live-source-evidence-review.md` for source text, image checksum, and
...
| Catalog or accession route / 著录或登记路线 | 781; source-page route only | 02_collection-source-index.csv; 06_human-collection-dossier.md |
...
| Live source text / 现场来源文字 | checked, not independently confirmed | 18_live-source-evidence-review.md |
...
- candidate_collection_object_id: `ihp-mus-obj-00024`
