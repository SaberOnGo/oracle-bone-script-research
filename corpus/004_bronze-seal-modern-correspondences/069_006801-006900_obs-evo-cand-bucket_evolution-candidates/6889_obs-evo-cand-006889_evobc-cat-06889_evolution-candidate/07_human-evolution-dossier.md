...
- External category reference: `evobc-cat-06889`
- Source category ID: `06889`
- Source label for human review: `翣`
...
- `obs-evo-cand-006889-route-category-staging`
...
- `obs-evo-cand-006889-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006889-route-evolution-graph`
