...
Project ID: `obs-evo-cand-005222`
...
- Project ID: `obs-evo-cand-005222`
- EVOBC category candidate ID: `evobc-evo-cat-05222`
- External category reference: `evobc-cat-05222`
- Source category ID: `05222`
- Source label for human review: `牼`
- Source codepoints: `U+727C`
...
- `obs-evo-cand-005222-route-category-staging`
...
- `obs-evo-cand-005222-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005222-route-evolution-graph`
