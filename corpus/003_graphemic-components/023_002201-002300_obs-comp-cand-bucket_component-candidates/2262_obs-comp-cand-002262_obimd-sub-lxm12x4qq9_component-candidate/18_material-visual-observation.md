# Material Visual Observation / obs-comp-cand-002262 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002262`
- External reference / 外部参照: `obimd-sub-lxm12x4qq9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020075_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/z501bkm67b/lxm12x4qq9/lxm12x4qq9.png`
- Checksum / 校验和:
  `9380d3e89f9b83c1662600261380d34bd8858bde5d1f1103603c901f6bd9a098`
...
- Marked-pixel bounds: (72,50)–(177,193); span 106 × 144 px; the marked
...
- 痕迹范围：(72,50)–(177,193)；跨度106 × 144 px；痕迹矩形高于宽。
