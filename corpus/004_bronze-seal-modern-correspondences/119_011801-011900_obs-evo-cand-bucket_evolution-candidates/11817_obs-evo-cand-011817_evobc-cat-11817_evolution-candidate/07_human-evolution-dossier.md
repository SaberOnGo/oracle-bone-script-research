...
- External category reference: `evobc-cat-11817`
- Source category ID: `11817`
- Source label for human review: `𥙻`
...
- `obs-evo-cand-011817-route-category-staging`
...
- `obs-evo-cand-011817-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011817-route-evolution-graph`
