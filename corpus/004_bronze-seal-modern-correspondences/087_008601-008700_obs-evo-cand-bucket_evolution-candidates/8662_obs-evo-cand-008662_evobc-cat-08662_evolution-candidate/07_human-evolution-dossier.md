...
- External category reference: `evobc-cat-08662`
- Source category ID: `08662`
- Source label for human review: `赳`
- Source codepoints: `U+8D73`
...
- `obs-evo-cand-008662-route-category-staging`
...
- `obs-evo-cand-008662-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008662-route-evolution-graph`
