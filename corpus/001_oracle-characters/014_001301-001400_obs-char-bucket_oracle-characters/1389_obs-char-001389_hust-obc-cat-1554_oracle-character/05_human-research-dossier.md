# obs-char-001389 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001389`
- primary external id: `hust-obc-cat-1554`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1389_obs-char-001389_hust-obc-cat-1554_ora
  cle-character/03_visual-assets/001_asset-001394_hust-obc-cat-1554_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1554/G_1554_乙5403合7352賓組.png`
- asset id: `asset-001394`
...
- source category: `1554`
- validation class: `1388`
- source image route: `HUST-OBC/deciphered/1554/G_1554_乙5403合7352賓組.png`
- asset id: `asset-001394`
...
- English observation: `Two adjacent forms combine a left curved cluster
  with a right pointed loop.`
- 中文观察: `相邻两个形体组合为左侧弧形笔画群和右侧尖状环形。`
...
- dataset label text: `㨈`
- dataset label codepoints: `U+3A08`
...
- filename catalog route clues: `Heji-like filename clue: 合7352
  (G_1554_乙5403合7352賓組.png)`
...
- Which source records identify obs-char-001389 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001389？
