# Material Visual Observation / obs-comp-cand-001359 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001359`
- External reference / 外部参照: `obimd-sub-wv6662htwa`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015778_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tp5ykv5jzh/wv6662htwa/wv6662htwa.png`
- Checksum / 校验和:
  `e840c08c173fde7a907fac318504c798caa8709f85147c3af8f1b4bfd826ce5a`
...
- Marked-pixel bounds: (74,55)–(175,190); span 102 × 136 px; the marked
...
- 痕迹范围：(74,55)–(175,190)；跨度102 × 136 px；痕迹矩形高于宽。
