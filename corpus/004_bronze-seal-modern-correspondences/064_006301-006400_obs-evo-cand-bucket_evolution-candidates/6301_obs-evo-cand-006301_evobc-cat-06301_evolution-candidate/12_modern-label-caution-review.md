# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006301
...
- EVOBC candidate category: `evobc-evo-cat-06301`.
- Source label for search only: `箭`.
- Source codepoints for search only: `U+7BAD`.
