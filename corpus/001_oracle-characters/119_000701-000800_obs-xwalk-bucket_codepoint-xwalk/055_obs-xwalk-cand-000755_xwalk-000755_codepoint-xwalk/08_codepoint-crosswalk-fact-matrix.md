# obs-xwalk-cand-000755 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+374F` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-0857` | not reading |
