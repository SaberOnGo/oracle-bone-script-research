...
- External category reference: `evobc-cat-09556`
- Source category ID: `09556`
- Source label for human review: `鑲`
- Source codepoints: `U+9472`
...
- `obs-evo-cand-009556-route-category-staging`
...
- `obs-evo-cand-009556-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009556-route-evolution-graph`
