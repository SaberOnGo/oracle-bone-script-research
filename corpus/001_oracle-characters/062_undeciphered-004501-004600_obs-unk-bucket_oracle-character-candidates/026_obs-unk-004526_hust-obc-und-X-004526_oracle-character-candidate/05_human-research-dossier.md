# obs-unk-004526 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004526`
- primary external id: `hust-obc-und-X-004526`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/026_obs-unk-004526_h
  ust-obc-und-X-004526_oracle-character-candidate/03_visual-assets/001_asset
  -006119_hust-obc-und-X-004526_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/82/X_？_8265_1.png`
- asset id: `asset-006119`
...
- source class: `HUST-OBC/undeciphered/X/82/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/82/X_？_8265_1.png`
- asset id: `asset-006119`
...
- English observation: `Upper marks, left trace, and lower tip recorded.`
- 中文观察: `已记录上方分离痕迹、左伸痕迹和下方尖端。`
...
- Which source records identify obs-unk-004526 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004526？
