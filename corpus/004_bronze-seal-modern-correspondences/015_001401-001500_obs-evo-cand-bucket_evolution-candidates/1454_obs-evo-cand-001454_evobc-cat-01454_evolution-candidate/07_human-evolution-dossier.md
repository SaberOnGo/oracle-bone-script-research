...
- External category reference: `evobc-cat-01454`
- Source category ID: `01454`
- Source label for human review: `反`
...
- `obs-evo-cand-001454-route-category-staging`
...
- `obs-evo-cand-001454-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001454-route-evolution-graph`
