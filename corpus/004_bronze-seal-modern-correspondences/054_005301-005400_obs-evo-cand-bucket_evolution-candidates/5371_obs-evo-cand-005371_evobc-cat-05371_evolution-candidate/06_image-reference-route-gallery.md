...
- `obs-evo-cand-005371-route-category-staging`
...
- `obs-evo-cand-005371-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005371-route-evolution-graph`
