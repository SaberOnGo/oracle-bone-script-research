# Human Collection Object Dossier / 馆藏对象研究档案: coll-obj-cand-00051
...
- project_id: `coll-obj-cand-00051`
- candidate_collection_object_id: `ihp-mus-obj-00051`
- source_collection_item_id: `271`
...
| `source_collection_item_id` | `271` |
| `object_title_en` | `Inscribed Plastron Ping 0342` |
| `catalog_reference_text` | `Ping 0342` |
| `object_page_url` | `https://museum.sinica.edu.tw/en/collection/32/item/271/` |
| `thumbnail_url` | `https://museum.sinica.edu.tw/_upload/image/collection_item/thumbnail/dc1318987401.jpg` |
