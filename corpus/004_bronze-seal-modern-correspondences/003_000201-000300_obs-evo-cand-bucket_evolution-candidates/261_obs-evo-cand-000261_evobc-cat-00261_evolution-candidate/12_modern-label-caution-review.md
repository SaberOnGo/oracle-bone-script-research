# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000261
...
- EVOBC candidate category: `evobc-evo-cat-00261`.
- Source label for search only: `㾢`.
- Source codepoints for search only: `U+3FA2`.
