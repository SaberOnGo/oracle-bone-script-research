# obs-unk-008151 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008151`
- primary external id: `hust-obc-und-YH-008151`
...
- local review image route: `corpus/001_oracle-characters/098_undeciphered-008
  101-008200_obs-unk-bucket_oracle-character-candidates/051_obs-unk-008151_h
  ust-obc-und-YH-008151_oracle-character-candidate/03_visual-assets/001_asse
  t-009742_hust-obc-und-YH-008151_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/607DD/H_？_607DD_0.png`
- asset id: `asset-009742`
...
- source class: `HUST-OBC/undeciphered/Y+H/607DD/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/607DD/H_？_607DD_0.png`
- asset id: `asset-009742`
...
- Which source records identify obs-unk-008151 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008151？
