...
- `obs-evo-cand-008315-route-category-staging`
...
- `obs-evo-cand-008315-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008315-route-evolution-graph`
