...
- Project ID / 项目 ID: `obs-char-001293`
- Primary external ID / 首选外部 ID: `hust-obc-cat-1445`
...
- Source image / 来源图: `G_1445_乙6693反(甲).png`
- Image / 图像: `001_asset-001298_hust-obc-cat-1445_glyph.png`
...
- target node: `evobc-evo-cat-00136`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC image references / EvoBC 图像引用数: `14`
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/136_obs-evo-cand-000136_evobc-cat-00136_evoluti
...
- Source label text / 来源标签文字: `㦛`
- Source label codepoint / 来源标签 codepoint: `U+399B`
