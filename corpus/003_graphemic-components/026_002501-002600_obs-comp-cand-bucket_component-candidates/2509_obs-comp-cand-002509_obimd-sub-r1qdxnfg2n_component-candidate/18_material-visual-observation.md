# Material Visual Observation / obs-comp-cand-002509 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002509`
- External reference / 外部参照: `obimd-sub-r1qdxnfg2n`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020784_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fd6c02qezd/r1qdxnfg2n/r1qdxnfg2n.png`
- Checksum / 校验和:
  `ba8477239712bb29fe732b537c0adf1d0194ffc268f9c07e345f1c70e0320196`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.46%.
- Marked-pixel bounds: (60,72)–(184,185); span 125 × 114 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.46%。
- 痕迹范围：(60,72)–(184,185)；跨度125 × 114 px；痕迹矩形近方形。
