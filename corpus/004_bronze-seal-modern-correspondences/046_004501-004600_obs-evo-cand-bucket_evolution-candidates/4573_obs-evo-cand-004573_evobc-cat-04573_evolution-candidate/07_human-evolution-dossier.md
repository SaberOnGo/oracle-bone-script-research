...
Project ID: `obs-evo-cand-004573`
...
- Project ID: `obs-evo-cand-004573`
- EVOBC category candidate ID: `evobc-evo-cat-04573`
- External category reference: `evobc-cat-04573`
- Source category ID: `04573`
- Source label for human review: `泉`
- Source codepoints: `U+6CC9`
- Image reference count in source metadata: `97`
...
- `obs-evo-cand-004573-route-category-staging`
...
- `obs-evo-cand-004573-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004573-route-evolution-graph`
