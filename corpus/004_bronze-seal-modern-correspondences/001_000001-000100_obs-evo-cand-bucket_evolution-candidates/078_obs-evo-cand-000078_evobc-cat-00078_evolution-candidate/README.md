# obs-evo-cand-000078 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-000078`
- EVOBC category candidate ID: `evobc-evo-cat-00078`
- External category ref: `evobc-cat-00078`
- Source label for human review: `㝵`
- Source codepoints: `U+3775`
- Image reference count: `52`
- Era token counts: `OBC:52`
- Source token counts: `Web:52`
