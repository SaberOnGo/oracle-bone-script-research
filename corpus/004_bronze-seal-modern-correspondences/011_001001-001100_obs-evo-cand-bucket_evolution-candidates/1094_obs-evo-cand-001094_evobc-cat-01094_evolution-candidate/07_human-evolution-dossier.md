...
- External category reference: `evobc-cat-01094`
- Source category ID: `01094`
- Source label for human review: `兮`
- Source codepoints: `U+516E`
- Image reference count in source metadata: `137`
...
- `obs-evo-cand-001094-route-category-staging`
...
- `obs-evo-cand-001094-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001094-route-evolution-graph`
