...
- External category reference: `evobc-cat-13651`
- Source category ID: `13651`
- Source label for human review: `𮛘`
- Source codepoints: `U+2E6D8`
...
- `obs-evo-cand-013651-route-category-staging`
...
- `obs-evo-cand-013651-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013651-route-evolution-graph`
