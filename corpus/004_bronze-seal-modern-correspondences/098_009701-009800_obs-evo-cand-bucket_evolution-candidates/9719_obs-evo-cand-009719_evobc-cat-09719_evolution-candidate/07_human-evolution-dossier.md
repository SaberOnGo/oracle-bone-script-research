...
- External category reference: `evobc-cat-09719`
- Source category ID: `09719`
- Source label for human review: `附`
- Source codepoints: `U+9644`
...
- `obs-evo-cand-009719-route-category-staging`
...
- `obs-evo-cand-009719-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009719-route-evolution-graph`
