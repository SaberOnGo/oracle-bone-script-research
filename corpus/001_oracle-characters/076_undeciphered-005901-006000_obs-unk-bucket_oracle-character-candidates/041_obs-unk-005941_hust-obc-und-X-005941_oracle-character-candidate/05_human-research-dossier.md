# obs-unk-005941 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/076_undeciphered-005
  901-006000_obs-unk-bucket_oracle-character-candidates/041_obs-unk-005941_h
  ust-obc-und-X-005941_oracle-character-candidate/03_visual-assets/001_asset
  -007533_hust-obc-und-X-005941_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1497/X_？_2682_1.png`
- asset id: `asset-007533`
...
- source class: `HUST-OBC/undeciphered/X/1497/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1497/X_？_2682_1.png`
- asset id: `asset-007533`
...
- Which source records identify obs-unk-005941 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005941？
