...
Project ID: `obs-evo-cand-002522`
...
- Project ID: `obs-evo-cand-002522`
- EVOBC category candidate ID: `evobc-evo-cat-02522`
- External category reference: `evobc-cat-02522`
- Source category ID: `02522`
- Source label for human review: `屮`
- Source codepoints: `U+5C6E`
...
- `obs-evo-cand-002522-route-category-staging`
...
- `obs-evo-cand-002522-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002522-route-evolution-graph`
