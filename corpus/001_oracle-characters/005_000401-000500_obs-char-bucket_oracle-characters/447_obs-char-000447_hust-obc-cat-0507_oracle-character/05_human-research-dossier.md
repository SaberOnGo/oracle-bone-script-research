# obs-char-000447 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000447`
- primary external id: `hust-obc-cat-0507`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/447_obs-char-000447_hust-obc-cat-0507_orac
  le-character/03_visual-assets/001_asset-000452_hust-obc-cat-0507_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0507/L_0507_11641.jpg`
- asset id: `asset-000452`
...
- source category: `0507`
- validation class: `446`
- source image route: `HUST-OBC/deciphered/0507/L_0507_11641.jpg`
- asset id: `asset-000452`
...
- English observation: `The low-contrast image contains two separated narrow
  forms: a crossed and curved form at left and a pointed outlined form at
  right.`
- 中文观察: `低对比度图像包含两个分离的狭长形体：左侧交叉弯曲，右侧为尖顶轮廓形。`
...
- dataset label text: `㗱`
- dataset label codepoints: `U+35F1`
...
- Which source records identify obs-char-000447 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000447？
