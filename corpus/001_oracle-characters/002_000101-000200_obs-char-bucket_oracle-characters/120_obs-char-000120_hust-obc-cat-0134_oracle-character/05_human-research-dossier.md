# obs-char-000120 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/120_obs-char-000120_hust-obc-cat-0134_orac
  le-character/03_visual-assets/001_asset-000125_hust-obc-cat-0134_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0134/G_0134_京津3950合28109無名組.png
  `
- asset id: `asset-000125`
...
- source category: `0134`
- validation class: `119`
- source image route: `HUST-OBC/deciphered/0134/G_0134_京津3950合28109無名組.png`
- asset id: `asset-000125`
...
- English observation: `The small image has a pointed upper enclosure above
  a rectangular lower form, with a narrow central descending stroke and a
  split lower mark.`
...
- dataset label text: `㑼`
- dataset label codepoints: `U+347C`
...
- filename catalog route clues: `Heji-like filename clue: 合28109
...
- Which source records identify obs-char-000120 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000120？
