...
Project ID: `obs-evo-cand-004290`
...
- Project ID: `obs-evo-cand-004290`
- EVOBC category candidate ID: `evobc-evo-cat-04290`
- External category reference: `evobc-cat-04290`
- Source category ID: `04290`
- Source label for human review: `檗`
- Source codepoints: `U+6A97`
...
- `obs-evo-cand-004290-route-category-staging`
...
- `obs-evo-cand-004290-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004290-route-evolution-graph`
