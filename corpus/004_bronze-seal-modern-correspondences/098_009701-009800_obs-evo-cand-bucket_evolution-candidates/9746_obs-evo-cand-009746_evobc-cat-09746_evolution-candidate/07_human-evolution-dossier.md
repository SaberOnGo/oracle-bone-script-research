...
Project ID: `obs-evo-cand-009746`
...
- Project ID: `obs-evo-cand-009746`
- EVOBC category candidate ID: `evobc-evo-cat-09746`
- External category reference: `evobc-cat-09746`
- Source category ID: `09746`
- Source label for human review: `陯`
- Source codepoints: `U+966F`
...
- `obs-evo-cand-009746-route-category-staging`
...
- `obs-evo-cand-009746-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009746-route-evolution-graph`
