...
Project ID: `obs-evo-cand-007208`
...
- Project ID: `obs-evo-cand-007208`
- EVOBC category candidate ID: `evobc-evo-cat-07208`
- External category reference: `evobc-cat-07208`
- Source category ID: `07208`
- Source label for human review: `艇`
- Source codepoints: `U+8247`
...
- `obs-evo-cand-007208-route-category-staging`
...
- `obs-evo-cand-007208-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007208-route-evolution-graph`
