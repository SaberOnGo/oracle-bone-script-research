# obs-unk-007782 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-007782`
- primary external id: `hust-obc-und-YH-007782`
...
- local review image route: `corpus/001_oracle-characters/094_undeciphered-007
  701-007800_obs-unk-bucket_oracle-character-candidates/082_obs-unk-007782_h
  ust-obc-und-YH-007782_oracle-character-candidate/03_visual-assets/001_asse
  t-009373_hust-obc-und-YH-007782_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6033F/H_？_6033F_0.png`
- asset id: `asset-009373`
...
- source class: `HUST-OBC/undeciphered/Y+H/6033F/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6033F/H_？_6033F_0.png`
- asset id: `asset-009373`
- source image count: `24`
...
- Which source records identify obs-unk-007782 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007782？
