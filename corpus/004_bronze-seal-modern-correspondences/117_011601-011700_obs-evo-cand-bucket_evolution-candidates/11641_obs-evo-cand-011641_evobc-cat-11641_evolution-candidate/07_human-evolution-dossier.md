...
- Project ID: `obs-evo-cand-011641`
- EVOBC category candidate ID: `evobc-evo-cat-11641`
- External category reference: `evobc-cat-11641`
- Source category ID: `11641`
- Source label for human review: `𤦃`
- Source codepoints: `U+24983`
...
- `obs-evo-cand-011641-route-category-staging`
...
- `obs-evo-cand-011641-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011641-route-evolution-graph`
