...
Project ID: `obs-evo-cand-005915`
...
- Project ID: `obs-evo-cand-005915`
- EVOBC category candidate ID: `evobc-evo-cat-05915`
- External category reference: `evobc-cat-05915`
- Source category ID: `05915`
- Source label for human review: `硻`
- Source codepoints: `U+787B`
...
- `obs-evo-cand-005915-route-category-staging`
...
- `obs-evo-cand-005915-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005915-route-evolution-graph`
