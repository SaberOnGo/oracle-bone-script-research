# obs-unk-005463 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/071_undeciphered-005
  401-005500_obs-unk-bucket_oracle-character-candidates/063_obs-unk-005463_h
  ust-obc-und-X-005463_oracle-character-candidate/03_visual-assets/001_asset
  -007056_hust-obc-und-X-005463_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1019/X_？_7982_1.png`
- asset id: `asset-007056`
...
- source class: `HUST-OBC/undeciphered/X/1019/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1019/X_？_7982_1.png`
- asset id: `asset-007056`
...
- Which source records identify obs-unk-005463 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005463？
