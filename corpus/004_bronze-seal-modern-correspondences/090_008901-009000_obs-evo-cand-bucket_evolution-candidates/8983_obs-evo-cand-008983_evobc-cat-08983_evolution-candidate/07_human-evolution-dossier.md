...
- External category reference: `evobc-cat-08983`
- Source category ID: `08983`
- Source label for human review: `逆`
- Source codepoints: `U+9006`
- Image reference count in source metadata: `193`
...
- `obs-evo-cand-008983-route-category-staging`
...
- `obs-evo-cand-008983-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008983-route-evolution-graph`
