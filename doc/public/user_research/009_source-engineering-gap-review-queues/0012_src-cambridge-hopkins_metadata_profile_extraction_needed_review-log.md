...
`current_stage=pending_human_review;download_status_counts=downloaded:1;downloaded_count=1;download_log_count=1;checksum_present_count=1;field_map_count=2;package_manifest_count=0;metadata_profile_count=0;graph_edge_count=4403;downloaded_file_bytes=74132;gap_type=metadata_profile_extraction_needed`
