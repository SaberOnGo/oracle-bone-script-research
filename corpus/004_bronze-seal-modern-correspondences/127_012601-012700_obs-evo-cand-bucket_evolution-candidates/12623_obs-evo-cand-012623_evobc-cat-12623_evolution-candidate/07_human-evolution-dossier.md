...
- External category reference: `evobc-cat-12623`
- Source category ID: `12623`
- Source label for human review: `𩘴`
...
- `obs-evo-cand-012623-route-category-staging`
...
- `obs-evo-cand-012623-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012623-route-evolution-graph`
