# Material Visual Observation / obs-comp-cand-002377 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002377`
- External reference / 外部参照: `obimd-sub-wq0qysgfqi`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020448_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ubq4rpw1wu/wq0qysgfqi/wq0qysgfqi.png`
- Checksum / 校验和:
  `3fdac4852763f1028653541bb3ce8655254678d429541e0885edc8446675cd2b`
...
- Marked-pixel bounds: (76,37)–(173,209); span 98 × 173 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.05%。
- 痕迹范围：(76,37)–(173,209)；跨度98 × 173 px；痕迹矩形高于宽。
