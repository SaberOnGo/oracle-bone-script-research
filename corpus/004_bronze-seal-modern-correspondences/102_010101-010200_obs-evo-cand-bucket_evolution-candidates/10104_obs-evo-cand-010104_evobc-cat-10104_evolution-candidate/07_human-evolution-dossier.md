...
- External category reference: `evobc-cat-10104`
- Source category ID: `10104`
- Source label for human review: `養`
...
- `obs-evo-cand-010104-route-category-staging`
...
- `obs-evo-cand-010104-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010104-route-evolution-graph`
