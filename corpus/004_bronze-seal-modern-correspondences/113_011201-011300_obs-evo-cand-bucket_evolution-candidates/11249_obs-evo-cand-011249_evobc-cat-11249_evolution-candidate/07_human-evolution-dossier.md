...
Project ID: `obs-evo-cand-011249`
...
- Project ID: `obs-evo-cand-011249`
- EVOBC category candidate ID: `evobc-evo-cat-11249`
- External category reference: `evobc-cat-11249`
- Source category ID: `11249`
- Source label for human review: `𢝐`
- Source codepoints: `U+22750`
...
- `obs-evo-cand-011249-route-category-staging`
...
- `obs-evo-cand-011249-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011249-route-evolution-graph`
