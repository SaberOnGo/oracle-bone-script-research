# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000827
...
- EVOBC candidate category: `evobc-evo-cat-00827`.
- Source label for search only: `佼`.
- Source codepoints for search only: `U+4F7C`.
