# obs-unk-009404 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/111_undeciphered-009
  401-009408_obs-unk-bucket_oracle-character-candidates/004_obs-unk-009404_h
  ust-obc-und-YH-009404_oracle-character-candidate/03_visual-assets/001_asse
  t-010995_hust-obc-und-YH-009404_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/618EB/Y_？_618EB.jpg`
- asset id: `asset-010995`
...
- source class: `HUST-OBC/undeciphered/Y+H/618EB/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/618EB/Y_？_618EB.jpg`
- asset id: `asset-010995`
...
- Which source records identify obs-unk-009404 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009404？
