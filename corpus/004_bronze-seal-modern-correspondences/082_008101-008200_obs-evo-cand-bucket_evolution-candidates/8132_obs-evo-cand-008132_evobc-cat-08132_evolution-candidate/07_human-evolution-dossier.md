...
- External category reference: `evobc-cat-08132`
- Source category ID: `08132`
- Source label for human review: `訏`
...
- `obs-evo-cand-008132-route-category-staging`
...
- `obs-evo-cand-008132-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008132-route-evolution-graph`
