# Material Visual Observation / obs-comp-cand-001786 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001786`
- External reference / 外部参照: `obimd-sub-86d04i30jc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018007_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/86d04i30jc/86d04i30jc/86d04i30jc.png`
- Checksum / 校验和:
  `73391b51cc4451638990f04f722a75eb828898c1da01ec9de8161f71d53535da`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.54%.
- Marked-pixel bounds: (81,39)–(163,202); span 83 × 164 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.54%。
- 痕迹范围：(81,39)–(163,202)；跨度83 × 164 px；痕迹矩形高于宽。
