# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008341
...
- EVOBC candidate category: `evobc-evo-cat-08341`.
- Source label for search only: `謼`.
- Source codepoints for search only: `U+8B3C`.
