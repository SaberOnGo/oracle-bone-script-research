# Material Visual Observation / obs-comp-cand-002276 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002276`
- External reference / 外部参照: `obimd-sub-bke9bjpf9r`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020160_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bke9bjpf9r/bke9bjpf9r/bke9bjpf9r.png`
- Checksum / 校验和:
  `a9fde5fa09f38e8c497d36e4b9df3aa92931ab2867fe31429286ed69be1e7674`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.42%.
- Marked-pixel bounds: (79,21)–(178,229); span 100 × 209 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.42%。
- 痕迹范围：(79,21)–(178,229)；跨度100 × 209 px；痕迹矩形高于宽。
