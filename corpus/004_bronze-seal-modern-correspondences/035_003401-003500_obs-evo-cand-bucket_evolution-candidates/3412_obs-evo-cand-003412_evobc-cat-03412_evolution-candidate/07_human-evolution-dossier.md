...
- External category reference: `evobc-cat-03412`
- Source category ID: `03412`
- Source label for human review: `接`
...
- `obs-evo-cand-003412-route-category-staging`
...
- `obs-evo-cand-003412-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003412-route-evolution-graph`
