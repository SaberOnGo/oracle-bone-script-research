# Material Visual Observation / obs-comp-cand-001815 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001815`
- External reference / 外部参照: `obimd-sub-6w6nubiwsc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018036_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6w6nubiwsc/6w6nubiwsc/6w6nubiwsc.png`
- Checksum / 校验和:
  `a8a9fff3e9dda99222ade86c494506cc4e40ac63448ee2eacaebcde09d250d42`
...
- Marked-pixel bounds: (54,32)–(209,218); span 156 × 187 px; the marked
...
- 痕迹范围：(54,32)–(209,218)；跨度156 × 187 px；痕迹矩形近方形。
