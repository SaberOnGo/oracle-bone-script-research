...
Project ID: `obs-evo-cand-010735`
...
- Project ID: `obs-evo-cand-010735`
- EVOBC category candidate ID: `evobc-evo-cat-10735`
- External category reference: `evobc-cat-10735`
- Source category ID: `10735`
- Source label for human review: `齱`
- Source codepoints: `U+9F71`
...
- `obs-evo-cand-010735-route-category-staging`
...
- `obs-evo-cand-010735-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010735-route-evolution-graph`
