...
- Project ID: `obs-evo-cand-011274`
- EVOBC category candidate ID: `evobc-evo-cat-11274`
- External category reference: `evobc-cat-11274`
- Source category ID: `11274`
- Source label for human review: `𢣭`
- Source codepoints: `U+228ED`
...
- `obs-evo-cand-011274-route-category-staging`
...
- `obs-evo-cand-011274-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011274-route-evolution-graph`
