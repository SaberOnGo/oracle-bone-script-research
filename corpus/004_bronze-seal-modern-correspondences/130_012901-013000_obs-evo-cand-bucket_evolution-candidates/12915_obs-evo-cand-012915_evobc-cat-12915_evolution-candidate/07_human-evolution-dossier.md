...
- Project ID: `obs-evo-cand-012915`
- EVOBC category candidate ID: `evobc-evo-cat-12915`
- External category reference: `evobc-cat-12915`
- Source category ID: `12915`
- Source label for human review: `𫅊`
- Source codepoints: `U+2B14A`
...
- `obs-evo-cand-012915-route-category-staging`
...
- `obs-evo-cand-012915-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012915-route-evolution-graph`
