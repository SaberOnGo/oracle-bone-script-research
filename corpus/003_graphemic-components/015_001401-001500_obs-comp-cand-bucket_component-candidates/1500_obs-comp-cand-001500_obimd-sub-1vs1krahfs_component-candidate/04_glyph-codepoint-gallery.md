# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001500
...
| --- | --- | --- | --- |
| `obimd-glyph-link-022700` | 󸧛 | `U+F89DB` | `reviewed_metadata_only` |
| `obimd-glyph-link-022701` | 󸧜 | `U+F89DC` | `reviewed_metadata_only` |
| `obimd-glyph-link-022702` | 󸧝 | `U+F89DD` | `reviewed_metadata_only` |
