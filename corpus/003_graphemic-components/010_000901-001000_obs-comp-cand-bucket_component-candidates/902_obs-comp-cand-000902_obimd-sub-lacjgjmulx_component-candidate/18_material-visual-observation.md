# Material Visual Observation / obs-comp-cand-000902 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000902`
- External reference / 外部参照: `obimd-sub-lacjgjmulx`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013974_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lacjgjmulx/lacjgjmulx/lacjgjmulx.png`
- Checksum / 校验和:
  `1ef243813e805f15406ecfe4668938c91ce7f904bdd85e98e381585d769a0ef8`
...
- Marked-pixel bounds: (59,15)–(171,231); span 113 × 217 px; the marked
...
- 痕迹范围：(59,15)–(171,231)；跨度113 × 217 px；痕迹矩形高于宽。
