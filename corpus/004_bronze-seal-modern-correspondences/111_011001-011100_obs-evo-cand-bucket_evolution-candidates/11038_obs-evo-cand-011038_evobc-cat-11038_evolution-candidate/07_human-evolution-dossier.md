...
- External category reference: `evobc-cat-11038`
- Source category ID: `11038`
- Source label for human review: `𡜍`
- Source codepoints: `U+2170D`
- Image reference count in source metadata: `21`
...
- `obs-evo-cand-011038-route-category-staging`
...
- `obs-evo-cand-011038-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011038-route-evolution-graph`
