...
- External category reference: `evobc-cat-06678`
- Source category ID: `06678`
- Source label for human review: `繚`
...
- `obs-evo-cand-006678-route-category-staging`
...
- `obs-evo-cand-006678-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006678-route-evolution-graph`
