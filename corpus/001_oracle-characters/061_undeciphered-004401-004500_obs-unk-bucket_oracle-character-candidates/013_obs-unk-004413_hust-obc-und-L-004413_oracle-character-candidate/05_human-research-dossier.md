# obs-unk-004413 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/013_obs-unk-004413_h
  ust-obc-und-L-004413_oracle-character-candidate/03_visual-assets/001_asset
  -006006_hust-obc-und-L-004413_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4413/L_？_9868.jpg`
- asset id: `asset-006006`
...
- source class: `HUST-OBC/undeciphered/L/4413/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4413/L_？_9868.jpg`
- asset id: `asset-006006`
...
- English observation: `A rounded peak and sloping sides surround`
  `a lower central opening.`
- 中文观察: `圆钝尖峰和斜边围绕下部中央开口。`
...
- Which source records identify obs-unk-004413 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004413？
