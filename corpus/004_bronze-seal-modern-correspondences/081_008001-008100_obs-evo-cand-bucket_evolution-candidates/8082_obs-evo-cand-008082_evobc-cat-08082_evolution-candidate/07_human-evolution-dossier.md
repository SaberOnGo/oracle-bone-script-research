...
Project ID: `obs-evo-cand-008082`
...
- Project ID: `obs-evo-cand-008082`
- EVOBC category candidate ID: `evobc-evo-cat-08082`
- External category reference: `evobc-cat-08082`
- Source category ID: `08082`
- Source label for human review: `覿`
- Source codepoints: `U+89BF`
...
- `obs-evo-cand-008082-route-category-staging`
...
- `obs-evo-cand-008082-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008082-route-evolution-graph`
