# Material Visual Observation / obs-comp-cand-001586 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001586`
- External reference / 外部参照: `obimd-sub-ihsuhqgmdc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017167_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ihsuhqgmdc/ihsuhqgmdc/02pwle9kwz.png`
- Checksum / 校验和:
  `4430ac687ffc9d7ed90230b9f6d8b6c88ca4c89be856a35a0985a242406f7a86`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.98%.
- Marked-pixel bounds: (43,71)–(206,172); span 164 × 102 px; the marked
  rectangle is wider than tall.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.98%。
- 痕迹范围：(43,71)–(206,172)；跨度164 × 102 px；痕迹矩形宽于高。
