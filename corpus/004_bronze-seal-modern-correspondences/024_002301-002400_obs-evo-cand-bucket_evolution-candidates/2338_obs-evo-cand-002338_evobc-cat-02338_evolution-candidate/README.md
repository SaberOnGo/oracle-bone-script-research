# obs-evo-cand-002338 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-002338`
- EVOBC category candidate ID: `evobc-evo-cat-02338`
- External category ref: `evobc-cat-02338`
- Source label: `季`
- Source codepoints: `U+5B63`
- Image reference count: `246`
- Era token counts: `BI:126;CS:1;OBC:73;SAC:17;SS:2;WSC:27`
- Source token counts: `Book:134;Web:112`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 73 image references
- era 1 / BI: 126 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 17 image references
- era 4 / WSC: 27 image references
- era 5 / CS: 1 image references
- source 0 / Web:1633: 2 image references
- source 1 / Web:105952;說文Web:58: 66 image references
- source 2 / Book:17600: 11 image references
- source 3 / Book:21681: 84 image references
- source 4 / Book:9131: 17 image references
- source 5 / Book:32794: 18 image references
- source 6 / Web:30645: 44 image references
