...
- Project ID: `obs-evo-cand-009777`
- EVOBC category candidate ID: `evobc-evo-cat-09777`
- External category reference: `evobc-cat-09777`
- Source category ID: `09777`
- Source label for human review: `隘`
- Source codepoints: `U+9698`
...
- `obs-evo-cand-009777-route-category-staging`
...
- `obs-evo-cand-009777-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009777-route-evolution-graph`
