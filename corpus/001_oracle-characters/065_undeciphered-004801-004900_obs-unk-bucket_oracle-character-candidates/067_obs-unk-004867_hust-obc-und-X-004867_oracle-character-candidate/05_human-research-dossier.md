# obs-unk-004867 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004867`
- primary external id: `hust-obc-und-X-004867`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/067_obs-unk-004867_h
  ust-obc-und-X-004867_oracle-character-candidate/03_visual-assets/001_asset
  -006460_hust-obc-und-X-004867_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/423/X_？_7407_1.png`
- asset id: `asset-006460`
...
- source class: `HUST-OBC/undeciphered/X/423/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/423/X_？_7407_1.png`
- asset id: `asset-006460`
...
- English observation: `separated branched and curved groups`
- 中文观察: `分离的分支结构和曲线结构`
...
- Which source records identify obs-unk-004867 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004867？
