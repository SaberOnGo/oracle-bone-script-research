...
- External category reference: `evobc-cat-08685`
- Source category ID: `08685`
- Source label for human review: `趞`
- Source codepoints: `U+8D9E`
...
- `obs-evo-cand-008685-route-category-staging`
...
- `obs-evo-cand-008685-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008685-route-evolution-graph`
