...
- `obs-evo-cand-002171-route-category-staging`
...
- `obs-evo-cand-002171-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002171-route-evolution-graph`
