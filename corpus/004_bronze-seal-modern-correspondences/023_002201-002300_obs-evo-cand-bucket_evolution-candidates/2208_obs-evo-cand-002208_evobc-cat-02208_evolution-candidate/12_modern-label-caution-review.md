# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002208
...
- EVOBC candidate category: `evobc-evo-cat-02208`.
- Source label for search only: `婦`.
- Source codepoints for search only: `U+5A66`.
