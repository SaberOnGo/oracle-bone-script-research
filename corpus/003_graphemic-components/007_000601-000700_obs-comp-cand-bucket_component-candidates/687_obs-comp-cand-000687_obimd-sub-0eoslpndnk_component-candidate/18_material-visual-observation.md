# Material Visual Observation / obs-comp-cand-000687 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000687`
- External reference / 外部参照: `obimd-sub-0eoslpndnk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013286_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0eoslpndnk/0eoslpndnk/0eoslpndnk.png`
- Checksum / 校验和:
  `f6c7ac778389e371bfbd87d023f496c05d5e33729dd5d629a05af867688ff541`
...
- Marked-pixel bounds: (60,27)–(189,224); span 130 × 198 px; the marked
...
- 痕迹范围：(60,27)–(189,224)；跨度130 × 198 px；痕迹矩形高于宽。
