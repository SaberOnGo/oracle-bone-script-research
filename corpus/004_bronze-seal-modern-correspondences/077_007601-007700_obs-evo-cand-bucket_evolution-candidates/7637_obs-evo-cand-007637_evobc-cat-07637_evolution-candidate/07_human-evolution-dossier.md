...
Project ID: `obs-evo-cand-007637`
...
- Project ID: `obs-evo-cand-007637`
- EVOBC category candidate ID: `evobc-evo-cat-07637`
- External category reference: `evobc-cat-07637`
- Source category ID: `07637`
- Source label for human review: `藋`
- Source codepoints: `U+85CB`
...
- `obs-evo-cand-007637-route-category-staging`
...
- `obs-evo-cand-007637-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007637-route-evolution-graph`
