# obs-evo-cand-005758 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-005758`
- EVOBC category candidate ID: `evobc-evo-cat-05758`
- External category ref: `evobc-cat-05758`
- Source label: `盟`
- Source codepoints: `U+76DF`
- Image reference count: `119`
- Era token counts: `BI:29;CS:2;OBC:63;SS:5;WSC:20`
- Source token counts: `Book:9;Web:110`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 63 image references
- era 1 / BI: 29 image references
- era 2 / SS: 5 image references
