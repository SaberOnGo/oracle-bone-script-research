# obs-char-000923 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000923`
- primary external id: `hust-obc-cat-1040`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/923_obs-char-000923_hust-obc-cat-1040_orac
  le-character/03_visual-assets/001_asset-000928_hust-obc-cat-1040_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1040/G_1040_乙405(甲).png`
- asset id: `asset-000928`
...
- source category: `1040`
- validation class: `922`
- source image route: `HUST-OBC/deciphered/1040/G_1040_乙405(甲).png`
- asset id: `asset-000928`
...
- English observation: `A broad curved upper stroke crosses a central
  junction and continues into a long descending right stroke.`
- 中文观察: `宽大弯曲上笔交叉中央交会点，并延续为右侧长下行笔。`
...
- dataset label text: `㠆`
- dataset label codepoints: `U+3806`
...
- Which source records identify obs-char-000923 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000923？
