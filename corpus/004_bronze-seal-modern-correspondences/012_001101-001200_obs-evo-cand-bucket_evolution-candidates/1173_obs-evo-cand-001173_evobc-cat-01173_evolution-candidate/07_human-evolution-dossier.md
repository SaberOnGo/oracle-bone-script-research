...
- External category reference: `evobc-cat-01173`
- Source category ID: `01173`
- Source label for human review: `函`
- Source codepoints: `U+51FD`
...
- `obs-evo-cand-001173-route-category-staging`
...
- `obs-evo-cand-001173-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001173-route-evolution-graph`
