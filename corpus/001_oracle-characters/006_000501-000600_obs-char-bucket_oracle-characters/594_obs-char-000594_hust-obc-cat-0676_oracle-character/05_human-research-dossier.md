# obs-char-000594 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/594_obs-char-000594_hust-obc-cat-0676_orac
  le-character/03_visual-assets/001_asset-000599_hust-obc-cat-0676_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0676/G_0676_京津1372(甲).png`
- asset id: `asset-000599`
...
- source category: `0676`
- validation class: `593`
- source image route: `HUST-OBC/deciphered/0676/G_0676_京津1372(甲).png`
- asset id: `asset-000599`
...
- English observation: `Several detached long curved and slanting strokes
  stand side by side, some with short forked branches and all ending at
  different heights.`
- 中文观察: `数条分离长弯笔和斜笔并列，部分带短叉枝，各笔末端高度不同。`
...
- dataset label text: `㚚`
- dataset label codepoints: `U+369A`
...
- Which source records identify obs-char-000594 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000594？
