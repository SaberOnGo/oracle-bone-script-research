# Material Visual Observation / obs-comp-cand-002624 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002624`
- External reference / 外部参照: `obimd-sub-kqep0e5n7r`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021163_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kqep0e5n7r/kqep0e5n7r/kqep0e5n7r.png`
- Checksum / 校验和:
  `b201d57cfba45bf2c2d9428f0492d4f6a510a2303a03206fab9436a1ef92e1b6`
...
- Marked-pixel bounds: (91,10)–(163,237); span 73 × 228 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.26%。
- 痕迹范围：(91,10)–(163,237)；跨度73 × 228 px；痕迹矩形高于宽。
