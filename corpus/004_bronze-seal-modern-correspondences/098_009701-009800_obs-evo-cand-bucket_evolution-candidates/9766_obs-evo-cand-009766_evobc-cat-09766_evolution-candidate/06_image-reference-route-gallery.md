...
- `obs-evo-cand-009766-route-category-staging`
...
- `obs-evo-cand-009766-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009766-route-evolution-graph`
