# obs-char-001117 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001117`
- primary external id: `hust-obc-cat-1248`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1117_obs-char-001117_hust-obc-cat-1248_ora
  cle-character/03_visual-assets/001_asset-001122_hust-obc-cat-1248_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1248/H_1248_6106B_0.png`
- asset id: `asset-001122`
...
- source category: `1248`
- validation class: `1116`
- source image route: `HUST-OBC/deciphered/1248/H_1248_6106B_0.png`
- asset id: `asset-001122`
...
- English observation: `A large angular upper frame with crossed diagonals
  sits above a rounded lower cluster with branching strokes.`
- 中文观察: `大型带交叉斜笔的棱角上部框架位于带分枝笔的圆弧下部笔群之上。`
...
- dataset label text: `㣖`
- dataset label codepoints: `U+38D6`
...
- filename catalog route clues: `catalog-like filename clue: H_1248
  (H_1248_6106B_0.png)`
...
- Which source records identify obs-char-001117 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001117？
