# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000652
...
| --- | --- | --- | --- |
| `obimd-glyph-link-009597` | 󳱀 | `U+F3C40` | `reviewed_metadata_only` |
| `obimd-glyph-link-009598` | 󳱁 | `U+F3C41` | `reviewed_metadata_only` |
| `obimd-glyph-link-009599` | 󳱂 | `U+F3C42` | `reviewed_metadata_only` |
| `obimd-glyph-link-009600` | 󳱄 | `U+F3C44` | `reviewed_metadata_only` |
| `obimd-glyph-link-009601` | 󳱅 | `U+F3C45` | `reviewed_metadata_only` |
