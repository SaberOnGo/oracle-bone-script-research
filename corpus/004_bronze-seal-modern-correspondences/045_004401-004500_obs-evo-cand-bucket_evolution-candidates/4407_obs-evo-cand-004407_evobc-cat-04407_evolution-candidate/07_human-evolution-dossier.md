...
- External category reference: `evobc-cat-04407`
- Source category ID: `04407`
- Source label for human review: `殄`
...
- `obs-evo-cand-004407-route-category-staging`
...
- `obs-evo-cand-004407-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004407-route-evolution-graph`
