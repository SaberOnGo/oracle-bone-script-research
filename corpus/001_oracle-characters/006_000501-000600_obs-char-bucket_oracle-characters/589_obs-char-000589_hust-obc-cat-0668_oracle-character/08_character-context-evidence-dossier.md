...
- Project ID / 项目 ID: `obs-char-000589`
- Primary external ID / 首选外部 ID: `hust-obc-cat-0668`
...
- Source image / 来源图: `G_0668_京都2033合28953無名組.png`
- Image / 图像: `001_asset-000594_hust-obc-cat-0668_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合28953
  (G_0668_京都2033合28953無名組.png)`
...
- target node: `evobc-evo-cat-00043`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00043`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00043`
- EvoBC image references / EvoBC 图像引用数: `1`
...
- Matched candidate folders / 匹配候选目录: `evobc-evo-cat-00043`
- Human review files / 人类复核文件:
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/043_obs-evo-cand-000043_evobc-cat-00043_evoluti
...
- Source label text / 来源标签文字: `㚒`
- Source label codepoint / 来源标签 codepoint: `U+3692`
