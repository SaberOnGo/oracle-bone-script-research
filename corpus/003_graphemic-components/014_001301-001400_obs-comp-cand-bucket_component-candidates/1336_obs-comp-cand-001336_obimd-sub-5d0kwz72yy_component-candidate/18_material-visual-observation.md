# Material Visual Observation / obs-comp-cand-001336 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001336`
- External reference / 外部参照: `obimd-sub-5d0kwz72yy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015673_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5d0kwz72yy/5d0kwz72yy/5d0kwz72yy.png`
- Checksum / 校验和:
  `c6ab80b24dc833c6e7c8b9a5f2e41871dd249a7a00e2abe6987bc57eb748a6dd`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.19%.
- Marked-pixel bounds: (81,18)–(166,229); span 86 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.19%。
- 痕迹范围：(81,18)–(166,229)；跨度86 × 212 px；痕迹矩形高于宽。
