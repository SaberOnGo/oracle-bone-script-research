# obs-char-000787 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000787`
- primary external id: `hust-obc-cat-0891`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/787_obs-char-000787_hust-obc-cat-0891_orac
  le-character/03_visual-assets/001_asset-000792_hust-obc-cat-0891_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0891/G_0891_合36746黃組.png`
- asset id: `asset-000792`
...
- source category: `0891`
- validation class: `786`
- source image route: `HUST-OBC/deciphered/0891/G_0891_合36746黃組.png`
- asset id: `asset-000792`
...
- dataset label text: `㝱`
- dataset label codepoints: `U+3771`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00076`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00076`
- EvoBC image reference count / EvoBC 图像引用数: `18`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00076`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/076_obs-evo-can
  d-000076_evobc-cat-00076_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/076_obs-evo-cand-000076_evobc-cat-00076_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合36746
  (G_0891_合36746黃組.png)`
...
- Which source records identify obs-char-000787 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000787？
