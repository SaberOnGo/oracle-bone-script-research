...
- External category reference: `evobc-cat-09472`
- Source category ID: `09472`
- Source label for human review: `鎊`
...
- `obs-evo-cand-009472-route-category-staging`
...
- `obs-evo-cand-009472-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009472-route-evolution-graph`
