# obs-unk-004584 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/084_obs-unk-004584_h
  ust-obc-und-X-004584_oracle-character-candidate/03_visual-assets/001_asset
  -006177_hust-obc-und-X-004584_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/140/X_？_8318_1.png`
- asset id: `asset-006177`
...
- source class: `HUST-OBC/undeciphered/X/140/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/140/X_？_8318_1.png`
- asset id: `asset-006177`
...
- English observation: `Curved diagonal, lower opening, and block terminal`
  `recorded.`
- 中文观察: `已记录弧形斜痕、下部开口和块状末端。`
...
- Which source records identify obs-unk-004584 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004584？
