# obs-unk-004727 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/027_obs-unk-004727_h
  ust-obc-und-X-004727_oracle-character-candidate/03_visual-assets/001_asset
  -006320_hust-obc-und-X-004727_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/283/X_？_7262_1.png`
- asset id: `asset-006320`
...
- source class: `HUST-OBC/undeciphered/X/283/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/283/X_？_7262_1.png`
- asset id: `asset-006320`
...
- English observation: `curved upper opening with lower pale opening`
- 中文观察: `带下部浅色开口的弯曲上部围合`
...
- Which source records identify obs-unk-004727 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004727？
