# Material Visual Observation / obs-comp-cand-000959 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000959`
- External reference / 外部参照: `obimd-sub-3tsrz44re1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014042_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3tsrz44re1/3tsrz44re1/3tsrz44re1.png`
- Checksum / 校验和:
  `eaa8cdbd52800a1c9728573bc6d55b1d630f65a5f475657e1af69788286e4dc0`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.19%.
- Marked-pixel bounds: (58,30)–(194,206); span 137 × 177 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.19%。
- 痕迹范围：(58,30)–(194,206)；跨度137 × 177 px；痕迹矩形高于宽。
