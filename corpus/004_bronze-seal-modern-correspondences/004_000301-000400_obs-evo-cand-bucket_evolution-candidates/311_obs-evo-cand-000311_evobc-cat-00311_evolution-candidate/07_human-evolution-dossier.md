...
Project ID: `obs-evo-cand-000311`
...
- Project ID: `obs-evo-cand-000311`
- EVOBC category candidate ID: `evobc-evo-cat-00311`
- External category reference: `evobc-cat-00311`
- Source category ID: `00311`
- Source label for human review: `䊤`
- Source codepoints: `U+42A4`
...
- `obs-evo-cand-000311-route-category-staging`
...
- `obs-evo-cand-000311-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000311-route-evolution-graph`
