# obs-unk-004854 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/054_obs-unk-004854_h
  ust-obc-und-X-004854_oracle-character-candidate/03_visual-assets/001_asset
  -006447_hust-obc-und-X-004854_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/410/X_？_7395_1.png`
- asset id: `asset-006447`
...
- source class: `HUST-OBC/undeciphered/X/410/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/410/X_？_7395_1.png`
- asset id: `asset-006447`
...
- English observation: `large curved group with detached lower marks`
- 中文观察: `大曲线结构和下部分离标记`
...
- Which source records identify obs-unk-004854 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004854？
