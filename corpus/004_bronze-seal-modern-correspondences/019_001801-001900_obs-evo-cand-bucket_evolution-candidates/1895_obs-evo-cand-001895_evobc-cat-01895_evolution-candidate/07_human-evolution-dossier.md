...
- External category reference: `evobc-cat-01895`
- Source category ID: `01895`
- Source label for human review: `堅`
- Source codepoints: `U+5805`
...
- `obs-evo-cand-001895-route-category-staging`
...
- `obs-evo-cand-001895-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001895-route-evolution-graph`
