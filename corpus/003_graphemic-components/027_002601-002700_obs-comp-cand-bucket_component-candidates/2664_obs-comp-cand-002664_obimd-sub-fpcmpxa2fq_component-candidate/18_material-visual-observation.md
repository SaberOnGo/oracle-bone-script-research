# Material Visual Observation / obs-comp-cand-002664 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002664`
- External reference / 外部参照: `obimd-sub-fpcmpxa2fq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021240_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/m26yvo17yk/fpcmpxa2fq/fpcmpxa2fq.png`
- Checksum / 校验和:
  `581d88ffcf9d85e8b97969f4e091bed19429c8acfab75bc333a80ca497b00b8b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.31%.
- Marked-pixel bounds: (50,37)–(160,221); span 111 × 185 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.31%。
- 痕迹范围：(50,37)–(160,221)；跨度111 × 185 px；痕迹矩形高于宽。
