# obs-char-000084 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000084`
- primary external id: `hust-obc-cat-0094`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/084_obs-char-000084_hust-obc-cat-0094_orac
  le-character/03_visual-assets/001_asset-000089_hust-obc-cat-0094_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0094/G_0094_甲骨文.png`
- asset id: `asset-000089`
...
- source category: `0094`
- validation class: `83`
- source image route: `HUST-OBC/deciphered/0094/G_0094_甲骨文.png`
- asset id: `asset-000089`
...
- English observation: `The image is roughly symmetrical, with several short
  upper strokes and a broad curved lower enclosure that narrows toward the
  bottom.`
- 中文观察: `图像大致左右对称，上方有数道短笔，下方有宽弧形围合，向底部逐渐收窄。`
...
- dataset label text: `㑔`
- dataset label codepoints: `U+3454`
...
- Which source records identify obs-char-000084 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000084？
