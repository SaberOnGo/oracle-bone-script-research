...
Project ID: `obs-evo-cand-006704`
...
- Project ID: `obs-evo-cand-006704`
- EVOBC category candidate ID: `evobc-evo-cat-06704`
- External category reference: `evobc-cat-06704`
- Source category ID: `06704`
- Source label for human review: `纂`
- Source codepoints: `U+7E82`
...
- `obs-evo-cand-006704-route-category-staging`
...
- `obs-evo-cand-006704-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006704-route-evolution-graph`
