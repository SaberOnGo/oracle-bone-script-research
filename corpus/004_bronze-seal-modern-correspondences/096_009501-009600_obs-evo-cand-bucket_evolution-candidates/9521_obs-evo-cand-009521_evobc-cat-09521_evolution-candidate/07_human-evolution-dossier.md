...
Project ID: `obs-evo-cand-009521`
...
- Project ID: `obs-evo-cand-009521`
- EVOBC category candidate ID: `evobc-evo-cat-09521`
- External category reference: `evobc-cat-09521`
- Source category ID: `09521`
- Source label for human review: `鐊`
- Source codepoints: `U+940A`
...
- `obs-evo-cand-009521-route-category-staging`
...
- `obs-evo-cand-009521-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009521-route-evolution-graph`
