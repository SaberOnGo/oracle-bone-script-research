# obs-comp-cand-001150 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001150`
- 首选外部 ID: `obimd-sub-i5iv3migqj`
- OBIMD subcharacter UID: `i5iv3migqj`
- OBIMD main character UID: `i5iv3migqj`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+355A;U+53C9;U+F6A2C; U+F6A2D; 另有 3 项
