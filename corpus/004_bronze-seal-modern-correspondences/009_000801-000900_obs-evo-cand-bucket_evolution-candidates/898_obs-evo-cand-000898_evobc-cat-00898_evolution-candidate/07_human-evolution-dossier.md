...
- External category reference: `evobc-cat-00898`
- Source category ID: `00898`
- Source label for human review: `信`
...
- `obs-evo-cand-000898-route-category-staging`
...
- `obs-evo-cand-000898-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000898-route-evolution-graph`
