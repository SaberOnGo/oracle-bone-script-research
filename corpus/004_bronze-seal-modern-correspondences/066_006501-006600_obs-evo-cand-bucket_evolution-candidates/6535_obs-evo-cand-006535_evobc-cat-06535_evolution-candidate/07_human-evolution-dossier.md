...
Project ID: `obs-evo-cand-006535`
...
- Project ID: `obs-evo-cand-006535`
- EVOBC category candidate ID: `evobc-evo-cat-06535`
- External category reference: `evobc-cat-06535`
- Source category ID: `06535`
- Source label for human review: `綅`
- Source codepoints: `U+7D85`
...
- `obs-evo-cand-006535-route-category-staging`
...
- `obs-evo-cand-006535-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006535-route-evolution-graph`
