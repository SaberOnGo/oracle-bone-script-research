# Material Visual Observation / obs-comp-cand-002448 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002448`
- External reference / 外部参照: `obimd-sub-mf2902f6ro`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020620_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/mf2902f6ro/mf2902f6ro/mf2902f6ro.png`
- Checksum / 校验和:
  `d7fc90fa325070978d7d0af345bb91a7c6b17df716d9e2e49411860a5d17275c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.71%.
- Marked-pixel bounds: (53,42)–(199,215); span 147 × 174 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.71%。
- 痕迹范围：(53,42)–(199,215)；跨度147 × 174 px；痕迹矩形近方形。
