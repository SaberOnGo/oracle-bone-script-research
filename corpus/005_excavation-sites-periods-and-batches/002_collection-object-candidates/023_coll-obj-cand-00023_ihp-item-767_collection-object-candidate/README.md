# coll-obj-cand-00023 collection object candidate
...
`.working/ihp-767/` snapshots. Images were fetched for private inspection only;
...
- dimensions: `3.2(L)×1.8(W) cm`
- findspot: `Hsiao-t'un, Anyan County, Honan Province`
