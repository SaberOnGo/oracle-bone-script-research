...
- Project ID: `obs-evo-cand-008137`
- EVOBC category candidate ID: `evobc-evo-cat-08137`
- External category reference: `evobc-cat-08137`
- Source category ID: `08137`
- Source label for human review: `訕`
- Source codepoints: `U+8A15`
...
- `obs-evo-cand-008137-route-category-staging`
...
- `obs-evo-cand-008137-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008137-route-evolution-graph`
