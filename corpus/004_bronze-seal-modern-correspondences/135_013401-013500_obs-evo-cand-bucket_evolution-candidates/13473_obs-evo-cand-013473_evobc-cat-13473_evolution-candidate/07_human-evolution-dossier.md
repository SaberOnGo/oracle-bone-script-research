...
- Project ID: `obs-evo-cand-013473`
- EVOBC category candidate ID: `evobc-evo-cat-13473`
- External category reference: `evobc-cat-13473`
- Source category ID: `13473`
- Source label for human review: `𭃼`
- Source codepoints: `U+2D0FC`
...
- `obs-evo-cand-013473-route-category-staging`
...
- `obs-evo-cand-013473-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013473-route-evolution-graph`
