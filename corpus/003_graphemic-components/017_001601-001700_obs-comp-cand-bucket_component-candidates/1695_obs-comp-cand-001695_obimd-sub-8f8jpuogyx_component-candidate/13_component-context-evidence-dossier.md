# obs-comp-cand-001695 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001695`
- 首选外部 ID: `obimd-sub-8f8jpuogyx`
- OBIMD subcharacter UID: `8f8jpuogyx`
...
- glyph-codepoint 数: `6`
- codepoint 示例: U+F9D1D; U+F9D1E; 另有 4 项
