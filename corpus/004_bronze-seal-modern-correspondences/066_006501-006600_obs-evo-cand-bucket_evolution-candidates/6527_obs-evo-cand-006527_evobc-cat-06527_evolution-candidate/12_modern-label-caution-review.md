# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006527
...
- EVOBC candidate category: `evobc-evo-cat-06527`.
- Source label for search only: `絶`.
- Source codepoints for search only: `U+7D76`.
