# Material Visual Observation / obs-comp-cand-000020 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000020`
- External reference / 外部参照: `obimd-sub-dvdjluqxnp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011172_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dvdjluqxnp/dvdjluqxnp/dvdjluqxnp.png`
- Checksum / 校验和:
  `d88372907be7efe5277385141f4144819b619aca1457fb4d13c3b9d8eeeda951`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.10%.
- Marked-pixel bounds: (61,24)–(188,227); span 128 × 204 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.10%。
- 痕迹范围：(61,24)–(188,227)；跨度128 × 204 px；痕迹矩形高于宽。
