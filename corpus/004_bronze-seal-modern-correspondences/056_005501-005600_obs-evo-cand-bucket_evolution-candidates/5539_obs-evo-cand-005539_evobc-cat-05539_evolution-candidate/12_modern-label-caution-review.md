# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-005539
...
- EVOBC candidate category: `evobc-evo-cat-05539`.
- Source label for search only: `用`.
- Source codepoints for search only: `U+7528`.
