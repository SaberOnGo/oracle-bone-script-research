# obs-char-000166 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/166_obs-char-000166_hust-obc-cat-0182_orac
  le-character/03_visual-assets/001_asset-000171_hust-obc-cat-0182_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0182/G_0182_乙1376合4855賓組.png`
- asset id: `asset-000171`
...
- source category: `0182`
- validation class: `165`
- source image route: `HUST-OBC/deciphered/0182/G_0182_乙1376合4855賓組.png`
- asset id: `asset-000171`
...
- English observation: `The image has two short upper horizontal bars, a
  narrow descending stroke, and a hooked projection near the lower end.`
- 中文观察: `图像上方有两道短横笔，中部有窄下行笔，下端附近有钩状伸出笔。`
...
- dataset label text: `㒬`
- dataset label codepoints: `U+34AC`
...
- Which source records identify obs-char-000166 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000166？
