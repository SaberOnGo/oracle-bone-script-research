...
- External category reference: `evobc-cat-11461`
- Source category ID: `11461`
- Source label for human review: `𣢝`
...
- `obs-evo-cand-011461-route-category-staging`
...
- `obs-evo-cand-011461-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011461-route-evolution-graph`
