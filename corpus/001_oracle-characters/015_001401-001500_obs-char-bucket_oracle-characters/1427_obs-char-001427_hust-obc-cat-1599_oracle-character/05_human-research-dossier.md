# obs-char-001427 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1427_obs-char-001427_hust-obc-cat-1599_ora
  cle-character/03_visual-assets/001_asset-001432_hust-obc-cat-1599_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1599/G_1599_粹260(甲).png`
- asset id: `asset-001432`
...
- source category: `1599`
- validation class: `1426`
- source image route: `HUST-OBC/deciphered/1599/G_1599_粹260(甲).png`
- asset id: `asset-001432`
...
- English observation: `A broad upper bar leads into many long separated
  lower prongs.`
- 中文观察: `宽大上部横笔连接多条长分离下部分叉。`
...
- dataset label text: `㨵`
- dataset label codepoints: `U+3A35`
...
- Which source records identify obs-char-001427 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001427？
