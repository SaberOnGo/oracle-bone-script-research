...
- Project ID: `obs-evo-cand-002031`
- EVOBC category candidate ID: `evobc-evo-cat-02031`
- External category reference: `evobc-cat-02031`
- Source category ID: `02031`
- Source label for human review: `奈`
- Source codepoints: `U+5948`
...
- `obs-evo-cand-002031-route-category-staging`
...
- `obs-evo-cand-002031-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002031-route-evolution-graph`
