# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010327
...
- EVOBC candidate category: `evobc-evo-cat-10327`.
- Source label for search only: `鬋`.
- Source codepoints for search only: `U+9B0B`.
