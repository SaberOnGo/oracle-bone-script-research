...
- External category reference: `evobc-cat-11413`
- Source category ID: `11413`
- Source label for human review: `𣉴`
- Source codepoints: `U+23274`
...
- `obs-evo-cand-011413-route-category-staging`
...
- `obs-evo-cand-011413-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011413-route-evolution-graph`
