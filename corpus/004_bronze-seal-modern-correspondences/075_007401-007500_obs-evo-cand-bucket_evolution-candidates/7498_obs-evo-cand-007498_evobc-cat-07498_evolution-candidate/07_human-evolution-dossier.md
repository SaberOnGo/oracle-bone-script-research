...
- External category reference: `evobc-cat-07498`
- Source category ID: `07498`
- Source label for human review: `蒚`
...
- `obs-evo-cand-007498-route-category-staging`
...
- `obs-evo-cand-007498-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007498-route-evolution-graph`
