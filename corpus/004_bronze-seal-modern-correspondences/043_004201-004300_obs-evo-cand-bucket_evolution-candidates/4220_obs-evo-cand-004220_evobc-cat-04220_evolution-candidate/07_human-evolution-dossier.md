...
- Project ID: `obs-evo-cand-004220`
- EVOBC category candidate ID: `evobc-evo-cat-04220`
- External category reference: `evobc-cat-04220`
- Source category ID: `04220`
- Source label for human review: `槭`
- Source codepoints: `U+69ED`
...
- `obs-evo-cand-004220-route-category-staging`
...
- `obs-evo-cand-004220-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004220-route-evolution-graph`
