...
- External category reference: `evobc-cat-04688`
- Source category ID: `04688`
- Source label for human review: `润`
- Source codepoints: `U+6DA6`
...
- `obs-evo-cand-004688-route-category-staging`
...
- `obs-evo-cand-004688-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004688-route-evolution-graph`
