# Material Visual Observation / obs-comp-cand-002351 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002351`
- External reference / 外部参照: `obimd-sub-4xjqeyfys5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020422_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6x2xfo2ygq/4xjqeyfys5/4xjqeyfys5.png`
- Checksum / 校验和:
  `6b07fe871af1875e27e0dedf05dbbc36986f12b8ee4f1ee864f56701b242c805`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.88%.
- Marked-pixel bounds: (83,14)–(174,238); span 92 × 225 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.88%。
- 痕迹范围：(83,14)–(174,238)；跨度92 × 225 px；痕迹矩形高于宽。
