...
Project ID: `obs-insc-cw-cand-000352`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000352`
...
- Period label: `II`
- Classification group: `10`
- Declared group count: `4`
...
- Source page section: `Period II Group 10` /
  `第 II 期第 10 组`
- Source section key: `period-ii-group-10`
- Section declared count: `4`
- Section observed row count: `4`
...
- Yingguo / 英国所藏: `y2042` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `456` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `25` in source row; primary catalog entry pending
- Heji / 合集: `41075` in source row; primary catalog entry pending
...
- Group and batch / 组类与批次: group `10`; batch or pit context pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000352`
