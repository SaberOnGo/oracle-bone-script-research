# Material Visual Observation / obs-comp-cand-000154 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000154`
- External reference / 外部参照: `obimd-sub-x9y4slwu2b`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011566_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/x9y4slwu2b/x9y4slwu2b/x9y4slwu2b.png`
- Checksum / 校验和:
  `a9f3a357ab48ede2bfcf4d22148284d1977bdfa2f3cec5971d032c57b238c0fe`
...
- Marked-pixel bounds: (82,29)–(167,223); span 86 × 195 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.72%。
- 痕迹范围：(82,29)–(167,223)；跨度86 × 195 px；痕迹矩形高于宽。
