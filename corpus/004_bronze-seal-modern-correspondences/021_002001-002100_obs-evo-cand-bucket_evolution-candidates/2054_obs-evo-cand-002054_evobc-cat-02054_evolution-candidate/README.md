# obs-evo-cand-002054 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-02054`
- Source label: `奭`
- Source codepoints: `U+596D`
- Image reference count: `58`
- Era token counts: `OBC:39;WSC:19`
- Source token counts: `Book:40;Web:18`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 39 image references
- era 4 / WSC: 19 image references
- source 0 / Web:1633: 11 image references
