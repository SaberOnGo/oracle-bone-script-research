# obs-unk-008720 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/104_undeciphered-008
  701-008800_obs-unk-bucket_oracle-character-candidates/020_obs-unk-008720_h
  ust-obc-und-YH-008720_oracle-character-candidate/03_visual-assets/001_asse
  t-010311_hust-obc-und-YH-008720_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60D56/H_？_60D56_0.png`
- asset id: `asset-010311`
...
- source class: `HUST-OBC/undeciphered/Y+H/60D56/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60D56/H_？_60D56_0.png`
- asset id: `asset-010311`
...
- Which source records identify obs-unk-008720 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008720？
