...
- `obs-evo-cand-013131-route-category-staging`
...
- `obs-evo-cand-013131-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013131-route-evolution-graph`
