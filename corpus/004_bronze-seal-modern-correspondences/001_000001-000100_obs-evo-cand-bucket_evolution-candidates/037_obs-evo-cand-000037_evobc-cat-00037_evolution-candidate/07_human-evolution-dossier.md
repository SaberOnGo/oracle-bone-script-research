...
- External category reference: `evobc-cat-00037`
- Source category ID: `00037`
- Source label for human review: `㗬`
...
- `obs-evo-cand-000037-route-category-staging`
...
- `obs-evo-cand-000037-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000037-route-evolution-graph`
