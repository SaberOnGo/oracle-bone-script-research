...
- `obs-evo-cand-008551-route-category-staging`
...
- `obs-evo-cand-008551-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008551-route-evolution-graph`
