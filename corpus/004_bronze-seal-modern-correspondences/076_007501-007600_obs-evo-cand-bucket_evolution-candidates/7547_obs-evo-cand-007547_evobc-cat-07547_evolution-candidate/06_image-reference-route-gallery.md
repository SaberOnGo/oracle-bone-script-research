...
- `obs-evo-cand-007547-route-category-staging`
...
- `obs-evo-cand-007547-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007547-route-evolution-graph`
