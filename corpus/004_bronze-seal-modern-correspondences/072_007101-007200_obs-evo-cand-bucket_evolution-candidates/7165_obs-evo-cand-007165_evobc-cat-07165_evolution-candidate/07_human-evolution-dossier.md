...
- External category reference: `evobc-cat-07165`
- Source category ID: `07165`
- Source label for human review: `自`
- Source codepoints: `U+81EA`
- Image reference count in source metadata: `374`
...
- `obs-evo-cand-007165-route-category-staging`
...
- `obs-evo-cand-007165-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007165-route-evolution-graph`
