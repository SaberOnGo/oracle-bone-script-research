...
Project ID: `obs-evo-cand-003074`
...
- Project ID: `obs-evo-cand-003074`
- EVOBC category candidate ID: `evobc-evo-cat-03074`
- External category reference: `evobc-cat-03074`
- Source category ID: `03074`
- Source label for human review: `愄`
- Source codepoints: `U+6104`
...
- `obs-evo-cand-003074-route-category-staging`
...
- `obs-evo-cand-003074-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003074-route-evolution-graph`
