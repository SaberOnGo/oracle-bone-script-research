...
- Project ID: `obs-evo-cand-001145`
- EVOBC category candidate ID: `evobc-evo-cat-01145`
- External category reference: `evobc-cat-01145`
- Source category ID: `01145`
- Source label for human review: `净`
- Source codepoints: `U+51C0`
...
- `obs-evo-cand-001145-route-category-staging`
...
- `obs-evo-cand-001145-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001145-route-evolution-graph`
