...
- External category reference: `evobc-cat-04223`
- Source category ID: `04223`
- Source label for human review: `槳`
...
- `obs-evo-cand-004223-route-category-staging`
...
- `obs-evo-cand-004223-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004223-route-evolution-graph`
