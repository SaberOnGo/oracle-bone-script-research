...
- `obs-evo-cand-007894-route-category-staging`
...
- `obs-evo-cand-007894-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007894-route-evolution-graph`
