...
- Project ID: `obs-evo-cand-006907`
- EVOBC category candidate ID: `evobc-evo-cat-06907`
- External category reference: `evobc-cat-06907`
- Source category ID: `06907`
- Source label for human review: `翿`
- Source codepoints: `U+7FFF`
...
- `obs-evo-cand-006907-route-category-staging`
...
- `obs-evo-cand-006907-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006907-route-evolution-graph`
