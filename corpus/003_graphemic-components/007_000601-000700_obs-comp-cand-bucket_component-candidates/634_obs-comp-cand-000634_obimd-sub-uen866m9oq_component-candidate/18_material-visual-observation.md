# Material Visual Observation / obs-comp-cand-000634 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000634`
- External reference / 外部参照: `obimd-sub-uen866m9oq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013197_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2lep30tiiz/uen866m9oq/uen866m9oq.png`
- Checksum / 校验和:
  `1fdf68642b56122e9421dc62c0dfd9b1361964e6c7c433c442dd3b3908e82f38`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.51%.
- Marked-pixel bounds: (53,15)–(180,232); span 128 × 218 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.51%。
- 痕迹范围：(53,15)–(180,232)；跨度128 × 218 px；痕迹矩形高于宽。
