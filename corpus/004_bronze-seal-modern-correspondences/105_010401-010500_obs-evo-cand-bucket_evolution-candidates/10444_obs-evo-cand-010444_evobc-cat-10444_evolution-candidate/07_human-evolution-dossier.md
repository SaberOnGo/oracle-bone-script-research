...
- Project ID: `obs-evo-cand-010444`
- EVOBC category candidate ID: `evobc-evo-cat-10444`
- External category reference: `evobc-cat-10444`
- Source category ID: `10444`
- Source label for human review: `鱒`
- Source codepoints: `U+9C52`
...
- `obs-evo-cand-010444-route-category-staging`
...
- `obs-evo-cand-010444-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010444-route-evolution-graph`
