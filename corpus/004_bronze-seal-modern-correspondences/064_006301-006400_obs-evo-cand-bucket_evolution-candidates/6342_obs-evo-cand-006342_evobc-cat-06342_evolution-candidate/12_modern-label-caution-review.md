# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006342
...
- EVOBC candidate category: `evobc-evo-cat-06342`.
- Source label for search only: `簋`.
- Source codepoints for search only: `U+7C0B`.
