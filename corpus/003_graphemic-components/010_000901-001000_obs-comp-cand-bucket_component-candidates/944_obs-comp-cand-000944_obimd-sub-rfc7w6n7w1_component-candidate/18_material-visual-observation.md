# Material Visual Observation / obs-comp-cand-000944 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000944`
- External reference / 外部参照: `obimd-sub-rfc7w6n7w1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014027_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rfc7w6n7w1/rfc7w6n7w1/rfc7w6n7w1.png`
- Checksum / 校验和:
  `442f3a20289a05a2182d0820ace1efc277125cee65a606b10a0e5aae8e07ae35`
...
- Marked-pixel bounds: (66,19)–(189,230); span 124 × 212 px; the marked
...
- 痕迹范围：(66,19)–(189,230)；跨度124 × 212 px；痕迹矩形高于宽。
