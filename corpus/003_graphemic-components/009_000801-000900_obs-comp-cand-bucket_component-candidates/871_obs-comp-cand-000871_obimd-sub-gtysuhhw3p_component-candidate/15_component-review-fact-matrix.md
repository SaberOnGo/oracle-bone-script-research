# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000871
...
| Glyph or codepoint route / 字形或码位路线 | 24 OBIMD route rows; examples U+F4E5A; U+F4E5B; 另有 22 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
