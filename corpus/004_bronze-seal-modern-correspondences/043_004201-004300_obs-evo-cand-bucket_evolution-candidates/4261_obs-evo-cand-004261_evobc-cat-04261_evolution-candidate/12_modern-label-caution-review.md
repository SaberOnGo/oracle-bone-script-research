# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004261
...
- EVOBC candidate category: `evobc-evo-cat-04261`.
- Source label for search only: `橋`.
- Source codepoints for search only: `U+6A4B`.
