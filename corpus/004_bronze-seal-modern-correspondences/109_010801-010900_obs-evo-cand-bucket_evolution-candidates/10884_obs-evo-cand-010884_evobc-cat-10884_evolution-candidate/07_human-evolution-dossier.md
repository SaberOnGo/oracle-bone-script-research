...
- External category reference: `evobc-cat-10884`
- Source category ID: `10884`
- Source label for human review: `𠧞`
- Source codepoints: `U+209DE`
- Image reference count in source metadata: `42`
...
- `obs-evo-cand-010884-route-category-staging`
...
- `obs-evo-cand-010884-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010884-route-evolution-graph`
