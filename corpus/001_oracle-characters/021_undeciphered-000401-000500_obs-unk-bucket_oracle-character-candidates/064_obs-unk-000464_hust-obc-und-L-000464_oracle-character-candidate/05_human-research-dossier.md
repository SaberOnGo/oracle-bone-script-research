# obs-unk-000464 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000464`
- primary external id: `hust-obc-und-L-000464`
...
- local review image route: `corpus/001_oracle-characters/021_undeciphered-000
  401-000500_obs-unk-bucket_oracle-character-candidates/064_obs-unk-000464_h
  ust-obc-und-L-000464_oracle-character-candidate/03_visual-assets/001_asset
  -002057_hust-obc-und-L-000464_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/464/L_？_1144.jpg`
- asset id: `asset-002057`
...
- source class: `HUST-OBC/undeciphered/L/464/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/464/L_？_1144.jpg`
- asset id: `asset-002057`
...
- Which source records identify obs-unk-000464 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000464？
