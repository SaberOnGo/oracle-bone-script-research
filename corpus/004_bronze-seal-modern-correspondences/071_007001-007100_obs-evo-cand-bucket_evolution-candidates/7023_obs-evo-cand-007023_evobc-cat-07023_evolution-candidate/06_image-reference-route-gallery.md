...
- `obs-evo-cand-007023-route-category-staging`
...
- `obs-evo-cand-007023-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007023-route-evolution-graph`
