# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006775
...
- EVOBC candidate category: `evobc-evo-cat-06775`.
- Source label for search only: `编`.
- Source codepoints for search only: `U+7F16`.
