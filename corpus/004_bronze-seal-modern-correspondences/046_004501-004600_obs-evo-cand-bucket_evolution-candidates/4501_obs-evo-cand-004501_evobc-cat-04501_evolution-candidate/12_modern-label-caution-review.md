# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004501
...
- EVOBC candidate category: `evobc-evo-cat-04501`.
- Source label for search only: `汝`.
- Source codepoints for search only: `U+6C5D`.
