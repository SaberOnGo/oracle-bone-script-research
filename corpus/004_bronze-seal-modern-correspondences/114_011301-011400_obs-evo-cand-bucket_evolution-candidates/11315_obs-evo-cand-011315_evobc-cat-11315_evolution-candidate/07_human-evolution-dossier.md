...
- Project ID: `obs-evo-cand-011315`
- EVOBC category candidate ID: `evobc-evo-cat-11315`
- External category reference: `evobc-cat-11315`
- Source category ID: `11315`
- Source label for human review: `𢴜`
- Source codepoints: `U+22D1C`
...
- `obs-evo-cand-011315-route-category-staging`
...
- `obs-evo-cand-011315-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011315-route-evolution-graph`
