# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006787
...
- EVOBC candidate category: `evobc-evo-cat-06787`.
- Source label for search only: `缿`.
- Source codepoints for search only: `U+7F3F`.
