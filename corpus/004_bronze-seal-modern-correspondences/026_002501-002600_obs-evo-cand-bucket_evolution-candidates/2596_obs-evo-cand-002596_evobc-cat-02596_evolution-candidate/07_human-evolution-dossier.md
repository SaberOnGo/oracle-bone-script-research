...
- External category reference: `evobc-cat-02596`
- Source category ID: `02596`
...
- `obs-evo-cand-002596-route-category-staging`
...
- `obs-evo-cand-002596-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002596-route-evolution-graph`
