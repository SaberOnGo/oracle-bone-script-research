...
- Project ID: `obs-evo-cand-004916`
- EVOBC category candidate ID: `evobc-evo-cat-04916`
- External category reference: `evobc-cat-04916`
- Source category ID: `04916`
- Source label for human review: `潰`
- Source codepoints: `U+6F70`
...
- `obs-evo-cand-004916-route-category-staging`
...
- `obs-evo-cand-004916-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004916-route-evolution-graph`
