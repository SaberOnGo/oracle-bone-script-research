# obs-comp-cand-002744 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002744`
- 首选外部 ID: `obimd-sub-p5hwr8pgcv`
- OBIMD subcharacter UID: `p5hwr8pgcv`
- OBIMD main character UID: `p5hwr8pgcv`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+FF7EB; U+FF7EC; 另有 1 项
