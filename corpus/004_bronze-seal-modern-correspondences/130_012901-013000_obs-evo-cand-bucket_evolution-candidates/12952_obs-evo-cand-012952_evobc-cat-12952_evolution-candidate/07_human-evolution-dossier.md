...
- External category reference: `evobc-cat-12952`
- Source category ID: `12952`
- Source label for human review: `𫑩`
...
- `obs-evo-cand-012952-route-category-staging`
...
- `obs-evo-cand-012952-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012952-route-evolution-graph`
