...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000104` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y593` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `598` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `535` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `39967` [route_present_image_or_text_not_collected]
