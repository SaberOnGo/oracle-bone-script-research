# obs-char-000004 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000004`
- primary external id: `hust-obc-cat-0004`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/004_obs-char-000004_hust-obc-cat-0004_orac
  le-character/03_visual-assets/001_asset-000009_hust-obc-cat-0004_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0004/G_0004_乙7674(甲).png`
- asset id: `asset-000009`
...
- source category: `0004`
- validation class: `3`
- source image route: `HUST-OBC/deciphered/0004/G_0004_乙7674(甲).png`
- asset id: `asset-000009`
...
- English observation: `The small, thin image has a central vertical stroke
  with several branching diagonal strokes.`
...
- dataset label text: `⺊`
- dataset label codepoints: `U+2E8A`
...
- Which source records identify obs-char-000004 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000004？
