...
- External category reference: `evobc-cat-00587`
- Source category ID: `00587`
- Source label for human review: `䵂`
...
- `obs-evo-cand-000587-route-category-staging`
...
- `obs-evo-cand-000587-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000587-route-evolution-graph`
