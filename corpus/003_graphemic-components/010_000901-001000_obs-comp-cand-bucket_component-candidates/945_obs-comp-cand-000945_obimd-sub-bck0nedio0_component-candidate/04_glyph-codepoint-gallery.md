# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000945
...
| --- | --- | --- | --- |
| `obimd-glyph-link-013606` | 򩂊󵓈 | `U+A908A;U+F54C8` | `reviewed_metadata_only` |
| `obimd-glyph-link-013607` | 󵓉 | `U+F54C9` | `reviewed_metadata_only` |
