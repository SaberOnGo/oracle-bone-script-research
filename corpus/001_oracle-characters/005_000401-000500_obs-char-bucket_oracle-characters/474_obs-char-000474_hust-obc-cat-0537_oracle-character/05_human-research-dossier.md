# obs-char-000474 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/474_obs-char-000474_hust-obc-cat-0537_orac
  le-character/03_visual-assets/001_asset-000479_hust-obc-cat-0537_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0537/G_0537_後1.24.7合28003無名組.pn
  g`
- asset id: `asset-000479`
...
- source category: `0537`
- validation class: `473`
- source image route: `HUST-OBC/deciphered/0537/G_0537_後1.24.7合28003無名組.png`
- asset id: `asset-000479`
...
- dataset label text: `㘏`
- dataset label codepoints: `U+360F`
...
- filename catalog route clues: `Heji-like filename clue: 合28003
...
- Which source records identify obs-char-000474 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000474？
