# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-011648
...
- EVOBC candidate category: `evobc-evo-cat-11648`.
- Source label for search only: `𤨊`.
- Source codepoints for search only: `U+24A0A`.
