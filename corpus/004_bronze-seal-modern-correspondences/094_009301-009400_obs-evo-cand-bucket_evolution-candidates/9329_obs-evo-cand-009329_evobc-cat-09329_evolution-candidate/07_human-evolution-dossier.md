...
- External category reference: `evobc-cat-09329`
- Source category ID: `09329`
- Source label for human review: `鈋`
...
- `obs-evo-cand-009329-route-category-staging`
...
- `obs-evo-cand-009329-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009329-route-evolution-graph`
