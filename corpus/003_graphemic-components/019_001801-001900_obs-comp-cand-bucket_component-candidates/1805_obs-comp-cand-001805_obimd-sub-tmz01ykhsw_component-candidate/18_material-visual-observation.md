# Material Visual Observation / obs-comp-cand-001805 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001805`
- External reference / 外部参照: `obimd-sub-tmz01ykhsw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018026_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tvnicmgqzf/tmz01ykhsw/tmz01ykhsw.png`
- Checksum / 校验和:
  `1fc7acf7f68f3cc48ec8d5cd09d1c35bc24a0adc763f49f22ceab5155bdf0aa0`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.68%.
- Marked-pixel bounds: (79,23)–(173,226); span 95 × 204 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.68%。
- 痕迹范围：(79,23)–(173,226)；跨度95 × 204 px；痕迹矩形高于宽。
