# Material Visual Observation / obs-comp-cand-001634 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001634`
- External reference / 外部参照: `obimd-sub-kbn6bnvddu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017310_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kbn6bnvddu/kbn6bnvddu/kbn6bnvddu.png`
- Checksum / 校验和:
  `75a7ded46b9f0cd96a37ce5f5fc1f49ea4e55444cd0d3e505470e6309dadf990`
...
- Marked-pixel bounds: (76,42)–(170,202); span 95 × 161 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.60%。
- 痕迹范围：(76,42)–(170,202)；跨度95 × 161 px；痕迹矩形高于宽。
