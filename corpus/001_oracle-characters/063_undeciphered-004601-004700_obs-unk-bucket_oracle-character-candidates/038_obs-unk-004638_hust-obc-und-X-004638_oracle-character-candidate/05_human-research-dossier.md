# obs-unk-004638 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/038_obs-unk-004638_h
  ust-obc-und-X-004638_oracle-character-candidate/03_visual-assets/001_asset
  -006231_hust-obc-und-X-004638_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/194/X_？_8367_1.png`
- asset id: `asset-006231`
...
- source class: `HUST-OBC/undeciphered/X/194/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/194/X_？_8367_1.png`
- asset id: `asset-006231`
...
- English observation: `uneven rectangular enclosure with two projections`
- 中文观察: `不规则近方框围合及上下突出笔画`
...
- Which source records identify obs-unk-004638 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004638？
