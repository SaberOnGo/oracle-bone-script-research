# obs-unk-008167 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008167`
- primary external id: `hust-obc-und-YH-008167`
...
- local review image route: `corpus/001_oracle-characters/098_undeciphered-008
  101-008200_obs-unk-bucket_oracle-character-candidates/067_obs-unk-008167_h
  ust-obc-und-YH-008167_oracle-character-candidate/03_visual-assets/001_asse
  t-009758_hust-obc-und-YH-008167_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/607FE/H_？_607FE_0.png`
- asset id: `asset-009758`
...
- source class: `HUST-OBC/undeciphered/Y+H/607FE/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/607FE/H_？_607FE_0.png`
- asset id: `asset-009758`
...
- Which source records identify obs-unk-008167 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008167？
