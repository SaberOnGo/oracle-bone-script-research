# obs-char-000173 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/173_obs-char-000173_hust-obc-cat-0189_0190
  _oracle-character/03_visual-assets/001_asset-000178_hust-obc-cat-0189_0190
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0189_0190/0189/G_0189_京都782合261
  84.png`
- asset id: `asset-000178`
...
- source category: `0189_0190`
- validation class: `172`
- source image route: `HUST-OBC/deciphered/0189_0190/0189/G_0189_京都782合26184.p
  ng`
- asset id: `asset-000178`
...
- English observation: `The tall image has a central vertical stroke with
  short irregular branches extending to both sides.`
- 中文观察: `高形图像中部有竖直主笔，两侧伸出长短不齐的短分支。`
...
- dataset label text: `㒳㒴`
- dataset label codepoints: `U+34B3;U+34B4`
...
- filename catalog route clues: `Heji-like filename clue: 合26184
...
- Which source records identify obs-char-000173 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000173？
