# Material Visual Observation / obs-comp-cand-000482 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000482`
- External reference / 外部参照: `obimd-sub-wfew4citrk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012718_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/x0wt5y5bs2/wfew4citrk/wfew4citrk.png`
- Checksum / 校验和:
  `5b7d64c855c3e0a70d5da29ac5c22d3004ca4eea97120178229cca7d57866c5d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.17%.
- Marked-pixel bounds: (73,18)–(176,228); span 104 × 211 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.17%。
- 痕迹范围：(73,18)–(176,228)；跨度104 × 211 px；痕迹矩形高于宽。
