...
- Project ID: `obs-evo-cand-003310`
- EVOBC category candidate ID: `evobc-evo-cat-03310`
- External category reference: `evobc-cat-03310`
- Source category ID: `03310`
- Source label for human review: `拍`
- Source codepoints: `U+62CD`
...
- `obs-evo-cand-003310-route-category-staging`
...
- `obs-evo-cand-003310-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003310-route-evolution-graph`
