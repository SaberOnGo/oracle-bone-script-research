# obs-char-000237 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/237_obs-char-000237_hust-obc-cat-0264_orac
  le-character/03_visual-assets/001_asset-000242_hust-obc-cat-0264_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0264/G_0264_前6.35.4(甲).png`
- asset id: `asset-000242`
...
- source category: `0264`
- validation class: `236`
- source image route: `HUST-OBC/deciphered/0264/G_0264_前6.35.4(甲).png`
- asset id: `asset-000242`
...
- English observation: `The compact image is divided by diagonal crossings
  and short angular marks, with a small branching form visible near the
  lower left.`
...
- dataset label text: `㓾`
- dataset label codepoints: `U+34FE`
...
- Which source records identify obs-char-000237 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000237？
