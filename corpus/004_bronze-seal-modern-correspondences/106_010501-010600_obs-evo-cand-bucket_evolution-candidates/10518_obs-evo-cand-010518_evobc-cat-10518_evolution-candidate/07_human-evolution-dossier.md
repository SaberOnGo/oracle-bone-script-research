...
- External category reference: `evobc-cat-10518`
- Source category ID: `10518`
- Source label for human review: `鵰`
...
- `obs-evo-cand-010518-route-category-staging`
...
- `obs-evo-cand-010518-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010518-route-evolution-graph`
