...
- External category reference: `evobc-cat-01379`
- Source category ID: `01379`
- Source label for human review: `南`
- Source codepoints: `U+5357`
- Image reference count in source metadata: `254`
...
- `obs-evo-cand-001379-route-category-staging`
...
- `obs-evo-cand-001379-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001379-route-evolution-graph`
