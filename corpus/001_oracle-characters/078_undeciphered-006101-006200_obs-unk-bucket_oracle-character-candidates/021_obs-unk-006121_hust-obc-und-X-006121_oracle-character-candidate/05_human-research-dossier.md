# obs-unk-006121 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006121`
- primary external id: `hust-obc-und-X-006121`
...
- local review image route: `corpus/001_oracle-characters/078_undeciphered-006
  101-006200_obs-unk-bucket_oracle-character-candidates/021_obs-unk-006121_h
  ust-obc-und-X-006121_oracle-character-candidate/03_visual-assets/001_asset
  -007713_hust-obc-und-X-006121_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1677/X_？_3716_1.png`
- asset id: `asset-007713`
...
- source class: `HUST-OBC/undeciphered/X/1677/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1677/X_？_3716_1.png`
- asset id: `asset-007713`
...
- Which source records identify obs-unk-006121 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006121？
