# Material Visual Observation / obs-comp-cand-000366 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000366`
- External reference / 外部参照: `obimd-sub-cdalwkdxte`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012289_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cdalwkdxte/cdalwkdxte/cdalwkdxte.png`
- Checksum / 校验和:
  `166c8c3744070be2d0cf78514a9a60bcfc4af78ead69886f36f3748fb5795edc`
...
- Marked-pixel bounds: (62,42)–(187,215); span 126 × 174 px; the marked
...
- 痕迹范围：(62,42)–(187,215)；跨度126 × 174 px；痕迹矩形高于宽。
