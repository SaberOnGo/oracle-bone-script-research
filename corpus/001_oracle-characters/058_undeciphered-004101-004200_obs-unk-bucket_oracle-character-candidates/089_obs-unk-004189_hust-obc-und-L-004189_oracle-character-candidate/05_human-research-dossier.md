# obs-unk-004189 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004189`
- primary external id: `hust-obc-und-L-004189`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/089_obs-unk-004189_h
  ust-obc-und-L-004189_oracle-character-candidate/03_visual-assets/001_asset
  -005782_hust-obc-und-L-004189_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4189/L_？_9111.jpg`
- asset id: `asset-005782`
...
- source class: `HUST-OBC/undeciphered/L/4189/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4189/L_？_9111.jpg`
- asset id: `asset-005782`
...
- English observation: `Angular outline and diagonals; inner trace visible.`
- 中文观察: `外围折角轮廓和上部斜笔画可见；内部痕迹仍待核对。`
...
- Which source records identify obs-unk-004189 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004189？
