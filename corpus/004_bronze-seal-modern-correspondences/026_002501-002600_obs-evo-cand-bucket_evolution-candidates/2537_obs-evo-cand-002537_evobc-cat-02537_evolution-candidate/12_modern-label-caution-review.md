# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002537
...
- EVOBC candidate category: `evobc-evo-cat-02537`.
- Source label for search only: `岚`.
- Source codepoints for search only: `U+5C9A`.
