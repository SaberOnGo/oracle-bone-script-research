# Material Visual Observation / obs-comp-cand-002281 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002281`
- External reference / 外部参照: `obimd-sub-aamr2zeydd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020165_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/aamr2zeydd/aamr2zeydd/aamr2zeydd.png`
- Checksum / 校验和:
  `7f4fa1b85847f9f52353ea45d3b990896dc832f0182d49381796614fe466ed06`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.10%.
- Marked-pixel bounds: (70,30)–(179,213); span 110 × 184 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.10%。
- 痕迹范围：(70,30)–(179,213)；跨度110 × 184 px；痕迹矩形高于宽。
