...
Project ID: `obs-evo-cand-001208`
...
- Project ID: `obs-evo-cand-001208`
- EVOBC category candidate ID: `evobc-evo-cat-01208`
- External category reference: `evobc-cat-01208`
- Source category ID: `01208`
- Source label for human review: `制`
- Source codepoints: `U+5236`
...
- `obs-evo-cand-001208-route-category-staging`
...
- `obs-evo-cand-001208-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001208-route-evolution-graph`
