...
Project ID: `obs-evo-cand-013282`
...
- Project ID: `obs-evo-cand-013282`
- EVOBC category candidate ID: `evobc-evo-cat-13282`
- External category reference: `evobc-cat-13282`
- Source category ID: `13282`
- Source label for human review: `𬔥`
- Source codepoints: `U+2C525`
...
- `obs-evo-cand-013282-route-category-staging`
...
- `obs-evo-cand-013282-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013282-route-evolution-graph`
