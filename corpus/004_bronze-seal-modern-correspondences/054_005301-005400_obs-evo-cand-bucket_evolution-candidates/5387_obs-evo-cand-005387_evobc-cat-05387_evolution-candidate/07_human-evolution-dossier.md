...
- Project ID: `obs-evo-cand-005387`
- EVOBC category candidate ID: `evobc-evo-cat-05387`
- External category reference: `evobc-cat-05387`
- Source category ID: `05387`
- Source label for human review: `珥`
- Source codepoints: `U+73E5`
...
- `obs-evo-cand-005387-route-category-staging`
...
- `obs-evo-cand-005387-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005387-route-evolution-graph`
