# Human Research Readiness Review / 正式研究准备复核: obs-evo-cand-006468
...
- Source label for lookup only: `索`.
- Source codepoints for lookup only: `U+7D22`.
- Era/source code rows to open: `10`.
