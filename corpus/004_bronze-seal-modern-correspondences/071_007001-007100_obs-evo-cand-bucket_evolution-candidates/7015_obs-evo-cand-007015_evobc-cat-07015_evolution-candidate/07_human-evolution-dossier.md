...
- External category reference: `evobc-cat-07015`
- Source category ID: `07015`
- Source label for human review: `胃`
- Source codepoints: `U+80C3`
...
- `obs-evo-cand-007015-route-category-staging`
...
- `obs-evo-cand-007015-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007015-route-evolution-graph`
