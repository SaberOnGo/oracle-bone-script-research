# Material Visual Observation / obs-comp-cand-001683 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001683`
- External reference / 外部参照: `obimd-sub-o3bsvqjwn2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017599_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dljr7e3ubv/o3bsvqjwn2/o3bsvqjwn2.png`
- Checksum / 校验和:
  `a62f55b7529146c20855168d9d2121bf440e3cbc0fd62e9f1fd948338049bbc2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.96%.
- Marked-pixel bounds: (69,43)–(180,201); span 112 × 159 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.96%。
- 痕迹范围：(69,43)–(180,201)；跨度112 × 159 px；痕迹矩形高于宽。
