...
Project ID: `obs-evo-cand-006279`
...
- Project ID: `obs-evo-cand-006279`
- EVOBC category candidate ID: `evobc-evo-cat-06279`
- External category reference: `evobc-cat-06279`
- Source category ID: `06279`
- Source label for human review: `筵`
- Source codepoints: `U+7B75`
...
- `obs-evo-cand-006279-route-category-staging`
...
- `obs-evo-cand-006279-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006279-route-evolution-graph`
