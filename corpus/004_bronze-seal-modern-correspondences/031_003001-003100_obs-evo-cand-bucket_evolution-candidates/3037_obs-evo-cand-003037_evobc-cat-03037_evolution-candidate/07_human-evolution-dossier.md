...
- External category reference: `evobc-cat-03037`
- Source category ID: `03037`
- Source label for human review: `惄`
- Source codepoints: `U+60C4`
...
- `obs-evo-cand-003037-route-category-staging`
...
- `obs-evo-cand-003037-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003037-route-evolution-graph`
