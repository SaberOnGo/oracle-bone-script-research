...
- Yingguo / 英国所藏: `y2381` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `339` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `174` in source row; primary catalog entry pending
