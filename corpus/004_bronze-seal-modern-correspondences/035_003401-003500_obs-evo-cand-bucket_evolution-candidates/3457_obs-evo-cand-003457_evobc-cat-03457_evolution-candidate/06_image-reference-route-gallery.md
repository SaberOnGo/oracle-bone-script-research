...
- `obs-evo-cand-003457-route-category-staging`
...
- `obs-evo-cand-003457-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003457-route-evolution-graph`
