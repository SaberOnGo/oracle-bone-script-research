# Material Visual Observation / obs-comp-cand-002332 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002332`
- External reference / 外部参照: `obimd-sub-lv9elwagak`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020351_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8l2orhbsvl/lv9elwagak/lv9elwagak.png`
- Checksum / 校验和:
  `8a279c407ad4a4e2c9e83abcb4daef07487881505cbf81fc2fd81c3c9b3a7f3c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.27%.
- Marked-pixel bounds: (76,39)–(173,206); span 98 × 168 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.27%。
- 痕迹范围：(76,39)–(173,206)；跨度98 × 168 px；痕迹矩形高于宽。
