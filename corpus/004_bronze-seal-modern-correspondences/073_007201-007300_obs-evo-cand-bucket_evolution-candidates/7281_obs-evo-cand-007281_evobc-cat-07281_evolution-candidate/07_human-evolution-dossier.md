...
- External category reference: `evobc-cat-07281`
- Source category ID: `07281`
- Source label for human review: `苞`
- Source codepoints: `U+82DE`
...
- `obs-evo-cand-007281-route-category-staging`
...
- `obs-evo-cand-007281-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007281-route-evolution-graph`
