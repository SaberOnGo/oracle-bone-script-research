# Material Visual Observation / obs-comp-cand-000386 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000386`
- External reference / 外部参照: `obimd-sub-rnar1q86c5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012309_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rnar1q86c5/rnar1q86c5/rnar1q86c5.png`
- Checksum / 校验和:
  `edd09e2b0b1d3939f73554e92e21c53c46627f8b51a0be11100525997832c383`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.79%.
- Marked-pixel bounds: (86,16)–(163,232); span 78 × 217 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.79%。
- 痕迹范围：(86,16)–(163,232)；跨度78 × 217 px；痕迹矩形高于宽。
