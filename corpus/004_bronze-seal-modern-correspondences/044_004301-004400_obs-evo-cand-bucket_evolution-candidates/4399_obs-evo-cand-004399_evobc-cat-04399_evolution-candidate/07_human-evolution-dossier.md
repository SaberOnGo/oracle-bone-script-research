...
- Project ID: `obs-evo-cand-004399`
- EVOBC category candidate ID: `evobc-evo-cat-04399`
- External category reference: `evobc-cat-04399`
- Source category ID: `04399`
- Source label for human review: `歹`
- Source codepoints: `U+6B79`
...
- `obs-evo-cand-004399-route-category-staging`
...
- `obs-evo-cand-004399-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004399-route-evolution-graph`
