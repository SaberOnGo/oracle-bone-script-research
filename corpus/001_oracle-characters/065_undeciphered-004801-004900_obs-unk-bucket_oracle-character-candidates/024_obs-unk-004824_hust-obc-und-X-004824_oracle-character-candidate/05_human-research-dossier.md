# obs-unk-004824 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004824`
- primary external id: `hust-obc-und-X-004824`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/024_obs-unk-004824_h
  ust-obc-und-X-004824_oracle-character-candidate/03_visual-assets/001_asset
  -006417_hust-obc-und-X-004824_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/380/X_？_7364_1.png`
- asset id: `asset-006417`
...
- source class: `HUST-OBC/undeciphered/X/380/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/380/X_？_7364_1.png`
- asset id: `asset-006417`
...
- English observation: `upper projections and lower lobes with openings`
- 中文观察: `上部突出笔画和带开口的下部块状结构`
...
- Which source records identify obs-unk-004824 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004824？
