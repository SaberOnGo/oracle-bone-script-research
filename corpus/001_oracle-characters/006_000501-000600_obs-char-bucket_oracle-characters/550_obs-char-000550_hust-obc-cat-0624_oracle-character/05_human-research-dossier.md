# obs-char-000550 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000550`
- primary external id: `hust-obc-cat-0624`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/550_obs-char-000550_hust-obc-cat-0624_orac
  le-character/03_visual-assets/001_asset-000555_hust-obc-cat-0624_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0624/G_0624_乙7122合14951賓組.png`
- asset id: `asset-000555`
...
- source category: `0624`
- validation class: `549`
- source image route: `HUST-OBC/deciphered/0624/G_0624_乙7122合14951賓組.png`
- asset id: `asset-000555`
...
- English observation: `A broad curved lower basin supports a zigzag line
  with three upward peaks, and two small stacked-loop forms rise above
  separate peaks.`
- 中文观察: `宽弯下部盆形承托带三个上尖的折线，两个小型叠环形分别升出不同尖峰。`
...
- dataset label text: `㙦`
- dataset label codepoints: `U+3666`
...
- filename catalog route clues: `Heji-like filename clue: 合14951
  (G_0624_乙7122合14951賓組.png)`
...
- Which source records identify obs-char-000550 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000550？
