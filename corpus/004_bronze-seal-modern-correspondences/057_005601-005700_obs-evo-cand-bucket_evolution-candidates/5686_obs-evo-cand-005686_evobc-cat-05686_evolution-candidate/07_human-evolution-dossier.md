...
- Project ID: `obs-evo-cand-005686`
- EVOBC category candidate ID: `evobc-evo-cat-05686`
- External category reference: `evobc-cat-05686`
- Source category ID: `05686`
- Source label for human review: `瘿`
- Source codepoints: `U+763F`
...
- `obs-evo-cand-005686-route-category-staging`
...
- `obs-evo-cand-005686-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005686-route-evolution-graph`
