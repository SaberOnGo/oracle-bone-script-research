# obs-unk-004458 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004458`
- primary external id: `hust-obc-und-X-004458`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/058_obs-unk-004458_h
  ust-obc-und-X-004458_oracle-character-candidate/03_visual-assets/001_asset
  -006051_hust-obc-und-X-004458_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/14/X_？_7203_1.png`
- asset id: `asset-006051`
...
- source class: `HUST-OBC/undeciphered/X/14/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/14/X_？_7203_1.png`
- asset id: `asset-006051`
...
- English observation: A rounded upper enclosure has side traces and two
  lower legs.
- 中文观察: `圆弧上部外框有侧向痕迹和两条下行痕迹。`
...
- Which source records identify obs-unk-004458 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004458？
