...
- External category reference: `evobc-cat-02282`
- Source category ID: `02282`
- Source label for human review: `嫶`
- Source codepoints: `U+5AF6`
...
- `obs-evo-cand-002282-route-category-staging`
...
- `obs-evo-cand-002282-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002282-route-evolution-graph`
