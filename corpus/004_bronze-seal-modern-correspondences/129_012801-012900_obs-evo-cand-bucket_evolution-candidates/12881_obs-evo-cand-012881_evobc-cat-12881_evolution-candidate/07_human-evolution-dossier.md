...
Project ID: `obs-evo-cand-012881`
...
- Project ID: `obs-evo-cand-012881`
- EVOBC category candidate ID: `evobc-evo-cat-12881`
- External category reference: `evobc-cat-12881`
- Source category ID: `12881`
- Source label for human review: `𪷾`
- Source codepoints: `U+2ADFE`
- Image reference count in source metadata: `11`
...
- `obs-evo-cand-012881-route-category-staging`
...
- `obs-evo-cand-012881-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012881-route-evolution-graph`
