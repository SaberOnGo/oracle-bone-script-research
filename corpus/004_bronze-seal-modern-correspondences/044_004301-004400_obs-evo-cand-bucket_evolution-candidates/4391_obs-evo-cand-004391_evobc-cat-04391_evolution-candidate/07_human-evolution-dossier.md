...
- External category reference: `evobc-cat-04391`
- Source category ID: `04391`
- Source label for human review: `歫`
...
- `obs-evo-cand-004391-route-category-staging`
...
- `obs-evo-cand-004391-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004391-route-evolution-graph`
