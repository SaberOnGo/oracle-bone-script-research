...
- External category reference: `evobc-cat-07821`
- Source category ID: `07821`
- Source label for human review: `蝯`
...
- `obs-evo-cand-007821-route-category-staging`
...
- `obs-evo-cand-007821-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007821-route-evolution-graph`
