...
- External category reference: `evobc-cat-11870`
- Source category ID: `11870`
...
- `obs-evo-cand-011870-route-category-staging`
...
- `obs-evo-cand-011870-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011870-route-evolution-graph`
