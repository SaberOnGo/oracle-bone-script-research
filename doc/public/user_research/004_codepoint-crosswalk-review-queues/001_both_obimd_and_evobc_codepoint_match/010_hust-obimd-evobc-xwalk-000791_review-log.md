...
- Review log draft ID / 复核日志草稿 ID: `codepoint-crosswalk-review-log-draft-010`
- Codepoint review task ID / codepoint 复核任务 ID: `codepoint-crosswalk-review-010`
...
- Crosswalk candidate ID / 交叉候选 ID: `hust-obimd-evobc-xwalk-000791`
- Suggested oracle character ID / 建议甲骨单字 ID: `obs-char-000791`
- Promotion queue ID / 提升队列 ID: `hust-obc-obs-char-promo-000791`
...
- HUST external ref / HUST 外部引用: `hust-obc-cat-0895`
- HUST label codepoints / HUST 标签 codepoint: `U+3775`
- OBIMD main candidates / OBIMD 主字候选: `obimd-main-cand-000853`
- EVOBC category candidates / EVOBC 类别候选: `evobc-evo-cat-00078`
...
- `corpus/001_oracle-characters/008_000701-000800_obs-char-bucket_oracle-characters/791_obs-char-000791_hust-obc-cat-0895_oracle-character/01_candidate-character-packet.json`
...
- Route availability ID: `codepoint-route-availability-010`
...
- Review task ID: `codepoint-crosswalk-review-010`
- Crosswalk candidate ID: `hust-obimd-evobc-xwalk-000791`
- Suggested oracle character ID: `obs-char-000791`
- HUST candidate packet ID: `hust-obc-candidate-packet-000791`
...
- OBIMD row count: `1`
- OBIMD source UIDs: `e19hd5tm0i`
- OBIMD review statuses: `obimd-main-cand-000853=reviewed_metadata_only`
- OBIMD rights statuses: `obimd-main-cand-000853=licensed_for_repository`
- EVOBC row count: `1`
- EVOBC source category IDs: `00078`
- EVOBC has bronze refs: `false`
- EVOBC has seal refs: `false`
- EVOBC review statuses: `evobc-evo-cat-00078=reviewed_metadata_only`
- EVOBC rights statuses: `evobc-evo-cat-00078=source_marked_risk_noted`
...
- Does `hust-obimd-evobc-xwalk-000791` remain unpromoted and undeciphered?
