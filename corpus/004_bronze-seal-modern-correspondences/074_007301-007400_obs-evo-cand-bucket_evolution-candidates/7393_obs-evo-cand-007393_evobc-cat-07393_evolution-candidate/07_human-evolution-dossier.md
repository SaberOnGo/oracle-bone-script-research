...
- Project ID: `obs-evo-cand-007393`
- EVOBC category candidate ID: `evobc-evo-cat-07393`
- External category reference: `evobc-cat-07393`
- Source category ID: `07393`
- Source label for human review: `莫`
- Source codepoints: `U+83AB`
...
- `obs-evo-cand-007393-route-category-staging`
...
- `obs-evo-cand-007393-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007393-route-evolution-graph`
