...
- Source page section: `Period IV Group 9` /
  `第 IV 期第 9 组`
- Source section key: `period-iv-group-9`
...
- Yingguo / 英国所藏: `y2431` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `334` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `205` in source row; primary catalog entry pending
- Heji / 合集: `41542` in source row; primary catalog entry pending
