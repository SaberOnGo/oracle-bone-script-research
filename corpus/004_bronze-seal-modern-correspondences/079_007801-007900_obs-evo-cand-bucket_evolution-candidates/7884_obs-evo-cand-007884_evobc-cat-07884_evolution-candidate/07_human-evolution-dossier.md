...
Project ID: `obs-evo-cand-007884`
...
- Project ID: `obs-evo-cand-007884`
- EVOBC category candidate ID: `evobc-evo-cat-07884`
- External category reference: `evobc-cat-07884`
- Source category ID: `07884`
- Source label for human review: `蠥`
- Source codepoints: `U+8825`
...
- `obs-evo-cand-007884-route-category-staging`
...
- `obs-evo-cand-007884-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007884-route-evolution-graph`
