# obs-char-000830 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000830`
- primary external id: `hust-obc-cat-0938`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/830_obs-char-000830_hust-obc-cat-0938_orac
  le-character/03_visual-assets/001_asset-000835_hust-obc-cat-0938_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0938/G_0938_京都3166合2815賓組.png`
- asset id: `asset-000835`
...
- source category: `0938`
- validation class: `829`
- source image route: `HUST-OBC/deciphered/0938/G_0938_京都3166合2815賓組.png`
- asset id: `asset-000835`
...
- English observation: `An open angular enclosure at left is paired with a
  long curved stroke at right; the lower tips are separated.`
- 中文观察: `左侧开口折角轮廓与右侧长弯曲笔并列出现；下端笔尖彼此分离。`
...
- dataset label text: `㞠`
- dataset label codepoints: `U+37A0`
...
- filename catalog route clues: `Heji-like filename clue: 合2815
  (G_0938_京都3166合2815賓組.png)`
...
- Which source records identify obs-char-000830 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000830？
