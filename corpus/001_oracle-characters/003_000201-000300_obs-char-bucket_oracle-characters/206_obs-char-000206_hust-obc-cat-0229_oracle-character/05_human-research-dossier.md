# obs-char-000206 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000206`
- primary external id: `hust-obc-cat-0229`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/206_obs-char-000206_hust-obc-cat-0229_orac
  le-character/03_visual-assets/001_asset-000211_hust-obc-cat-0229_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0229/G_0229_中大43.png`
- asset id: `asset-000211`
...
- source category: `0229`
- validation class: `205`
- source image route: `HUST-OBC/deciphered/0229/G_0229_中大43.png`
- asset id: `asset-000211`
...
- English observation: `The image has a short separate stroke on the left, a
  branching central form, and a long curved stroke descending toward the
  lower right.`
- 中文观察: `图像左侧有分离短笔，中部有分叉形，右下方有长弯曲笔向下延伸。`
...
- dataset label text: `㓛`
- dataset label codepoints: `U+34DB`
...
- Which source records identify obs-char-000206 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000206？
