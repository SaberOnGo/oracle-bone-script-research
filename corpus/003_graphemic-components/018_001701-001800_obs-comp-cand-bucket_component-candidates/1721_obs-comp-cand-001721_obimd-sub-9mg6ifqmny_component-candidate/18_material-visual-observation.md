# Material Visual Observation / obs-comp-cand-001721 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001721`
- External reference / 外部参照: `obimd-sub-9mg6ifqmny`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017900_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9mg6ifqmny/9mg6ifqmny/9mg6ifqmny.png`
- Checksum / 校验和:
  `a41cbd2e7b607483e7836c06ef276aece1145ecc9290db49143ee2e1ba036733`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.62%.
- Marked-pixel bounds: (61,55)–(207,201); span 147 × 147 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.62%。
- 痕迹范围：(61,55)–(207,201)；跨度147 × 147 px；痕迹矩形近方形。
