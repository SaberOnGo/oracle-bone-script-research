...
- External category reference: `evobc-cat-13652`
- Source category ID: `13652`
- Source label for human review: `𮝇`
- Source codepoints: `U+2E747`
...
- `obs-evo-cand-013652-route-category-staging`
...
- `obs-evo-cand-013652-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013652-route-evolution-graph`
