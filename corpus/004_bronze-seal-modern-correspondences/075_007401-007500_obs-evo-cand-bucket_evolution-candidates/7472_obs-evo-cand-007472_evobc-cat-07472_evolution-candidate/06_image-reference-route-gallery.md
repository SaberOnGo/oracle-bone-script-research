...
- `obs-evo-cand-007472-route-category-staging`
...
- `obs-evo-cand-007472-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007472-route-evolution-graph`
