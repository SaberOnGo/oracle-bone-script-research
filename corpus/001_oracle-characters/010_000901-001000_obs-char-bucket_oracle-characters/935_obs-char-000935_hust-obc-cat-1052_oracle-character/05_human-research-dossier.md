# obs-char-000935 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000935`
- primary external id: `hust-obc-cat-1052`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/935_obs-char-000935_hust-obc-cat-1052_orac
  le-character/03_visual-assets/001_asset-000940_hust-obc-cat-1052_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1052/G_1052_乙1277合376賓組.png`
- asset id: `asset-000940`
...
- source category: `1052`
- validation class: `934`
- source image route: `HUST-OBC/deciphered/1052/G_1052_乙1277合376賓組.png`
- asset id: `asset-000940`
...
- English observation: `Two long parallel strokes flank a central descending
  line with short branches and additional lower side strokes.`
- 中文观察: `两条长平行笔分列中央下行笔，两侧带有短分枝和额外下部侧笔。`
...
- dataset label text: `㠒`
- dataset label codepoints: `U+3812`
...
- Which source records identify obs-char-000935 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000935？
