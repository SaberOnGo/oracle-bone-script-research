...
- Project ID: `obs-evo-cand-005415`
- EVOBC category candidate ID: `evobc-evo-cat-05415`
- External category reference: `evobc-cat-05415`
- Source category ID: `05415`
- Source label for human review: `琫`
- Source codepoints: `U+742B`
...
- `obs-evo-cand-005415-route-category-staging`
...
- `obs-evo-cand-005415-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005415-route-evolution-graph`
