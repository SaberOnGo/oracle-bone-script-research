...
- External category reference: `evobc-cat-05811`
- Source category ID: `05811`
- Source label: `眷`
...
- `obs-evo-cand-005811-route-category-staging`
...
- `obs-evo-cand-005811-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005811-route-evolution-graph`
