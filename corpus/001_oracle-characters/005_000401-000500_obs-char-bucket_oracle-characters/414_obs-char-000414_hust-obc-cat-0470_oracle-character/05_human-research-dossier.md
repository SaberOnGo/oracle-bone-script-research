# obs-char-000414 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/414_obs-char-000414_hust-obc-cat-0470_orac
  le-character/03_visual-assets/001_asset-000419_hust-obc-cat-0470_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0470/G_0470_乙4770合7076賓組.png`
- asset id: `asset-000419`
...
- source category: `0470`
- validation class: `413`
- source image route: `HUST-OBC/deciphered/0470/G_0470_乙4770合7076賓組.png`
- asset id: `asset-000419`
...
- English observation: `Two separated forms are visible: a crossed
  rectangular cluster at left and a tall curved form with an upper enclosure
  at right.`
- 中文观察: `可见两个分离形体：左侧为交叉矩形笔画群，右侧为带上部闭合轮廓的高长弧形形体。`
...
- dataset label text: `㗌`
- dataset label codepoints: `U+35CC`
...
- filename catalog route clues: `Heji-like filename clue: 合7076
  (G_0470_乙4770合7076賓組.png)`
...
- Which source records identify obs-char-000414 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000414？
