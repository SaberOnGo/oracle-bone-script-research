# Material Visual Observation / obs-comp-cand-001708 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001708`
- External reference / 外部参照: `obimd-sub-s1n3ksksbg`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017846_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/s1n3ksksbg/s1n3ksksbg/s1n3ksksbg.png`
- Checksum / 校验和:
  `a273e74c83437eba0f6b8ae18961da880bc06f952965a3204ed85d98b5dedbe6`
...
- Marked-pixel bounds: (66,47)–(183,205); span 118 × 159 px; the marked
...
- 痕迹范围：(66,47)–(183,205)；跨度118 × 159 px；痕迹矩形高于宽。
