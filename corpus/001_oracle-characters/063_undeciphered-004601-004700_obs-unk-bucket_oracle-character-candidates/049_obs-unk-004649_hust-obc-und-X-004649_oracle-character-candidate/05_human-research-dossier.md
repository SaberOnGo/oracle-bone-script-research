# obs-unk-004649 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004649`
- primary external id: `hust-obc-und-X-004649`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/049_obs-unk-004649_h
  ust-obc-und-X-004649_oracle-character-candidate/03_visual-assets/001_asset
  -006242_hust-obc-und-X-004649_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/205/X_？_8377_1.png`
- asset id: `asset-006242`
...
- source class: `HUST-OBC/undeciphered/X/205/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/205/X_？_8377_1.png`
- asset id: `asset-006242`
...
- English observation: `noisy thresholded image with unclear stroke boundaries`
- 中文观察: `噪声阈值化图像，笔画边界暂不清楚`
...
- Which source records identify obs-unk-004649 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004649？
