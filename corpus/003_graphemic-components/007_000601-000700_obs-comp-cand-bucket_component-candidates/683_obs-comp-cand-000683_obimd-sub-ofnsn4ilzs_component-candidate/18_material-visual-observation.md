# Material Visual Observation / obs-comp-cand-000683 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000683`
- External reference / 外部参照: `obimd-sub-ofnsn4ilzs`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013282_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/s8bffjoah6/ofnsn4ilzs/ofnsn4ilzs.png`
- Checksum / 校验和:
  `6df35eb4daa7c6f7a4c8910955c0dcebf7b33e87e6720d2c35d3655cc6aa1d79`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.42%.
- Marked-pixel bounds: (62,36)–(187,216); span 126 × 181 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.42%。
- 痕迹范围：(62,36)–(187,216)；跨度126 × 181 px；痕迹矩形高于宽。
