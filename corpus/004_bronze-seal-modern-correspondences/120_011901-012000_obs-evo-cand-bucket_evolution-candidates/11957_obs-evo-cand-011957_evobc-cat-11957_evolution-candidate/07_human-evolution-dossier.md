...
Project ID: `obs-evo-cand-011957`
...
- Project ID: `obs-evo-cand-011957`
- EVOBC category candidate ID: `evobc-evo-cat-11957`
- External category reference: `evobc-cat-11957`
- Source category ID: `11957`
- Source label for human review: `𦂕`
- Source codepoints: `U+26095`
...
- `obs-evo-cand-011957-route-category-staging`
...
- `obs-evo-cand-011957-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011957-route-evolution-graph`
