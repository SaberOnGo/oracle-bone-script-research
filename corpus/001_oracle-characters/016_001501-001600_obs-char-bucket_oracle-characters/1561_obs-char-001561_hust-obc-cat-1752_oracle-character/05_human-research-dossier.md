# obs-char-001561 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1561_obs-char-001561_hust-obc-cat-1752_ora
  cle-character/03_visual-assets/001_asset-001566_hust-obc-cat-1752_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1752/X_1752_4857_1.png`
- asset id: `asset-001566`
...
- source category: `1752`
- validation class: `1560`
- source image route: `HUST-OBC/deciphered/1752/X_1752_4857_1.png`
- asset id: `asset-001566`
...
- English observation: `A dark tall form has upper loops, a central opening,
  and branching pointed lower strokes.`
- 中文观察: `深色高大形体有上部环形、中央开口和分枝尖状下部笔画。`
...
- dataset label text: `㫎`
- dataset label codepoints: `U+3ACE`
...
- Which source records identify obs-char-001561 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001561？
