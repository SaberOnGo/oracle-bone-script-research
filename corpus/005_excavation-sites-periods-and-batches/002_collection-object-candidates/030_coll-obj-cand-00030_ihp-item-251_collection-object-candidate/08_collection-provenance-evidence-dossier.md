# Collection Provenance Evidence Dossier / 馆藏来源证据档案: coll-obj-cand-00030
...
| source_row_id | `30` |
| object_page_url | `https://museum.sinica.edu.tw/en/collection/32/item/251/` |
...
| asset_id | `` |
| asset_path | `` |
| thumbnail_url | `https://museum.sinica.edu.tw/_upload/image/collection_item/thumbnail/dc1258944327.jpg` |
| source_image_url | `` |
...
| `source_collection_item_id` | `251` |
| `object_title_en` | `Inscribed Plastron Ping 0469` |
| `catalog_reference_text` | `Ping 0469` |
| `accession_number` | `` |
| `historical_period` | `` |
| `object_date` | `` |
| `provenience` | `` |
