# obs-char-001570 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1570_obs-char-001570_hust-obc-cat-1762_ora
  cle-character/03_visual-assets/001_asset-001575_hust-obc-cat-1762_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1762/G_1762_前1.15.6(甲).png`
- asset id: `asset-001575`
...
- source category: `1762`
- validation class: `1569`
- source image route: `HUST-OBC/deciphered/1762/G_1762_前1.15.6(甲).png`
- asset id: `asset-001575`
...
- English observation: `A composite has an upper rounded enclosure, side
  marks, and a dense lower branching cluster.`
...
- dataset label text: `㫘`
- dataset label codepoints: `U+3AD8`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/159_obs-evo-can
  d-000159_evobc-cat-00159_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/159_obs-evo-cand-000159_evobc-cat-00159_evolu
...
- Which source records identify obs-char-001570 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001570？
