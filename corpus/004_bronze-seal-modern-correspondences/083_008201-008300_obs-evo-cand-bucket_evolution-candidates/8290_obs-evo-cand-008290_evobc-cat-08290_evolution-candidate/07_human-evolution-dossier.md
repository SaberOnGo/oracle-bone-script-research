...
- External category reference: `evobc-cat-08290`
- Source category ID: `08290`
- Source label for human review: `諱`
- Source codepoints: `U+8AF1`
...
- `obs-evo-cand-008290-route-category-staging`
...
- `obs-evo-cand-008290-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008290-route-evolution-graph`
