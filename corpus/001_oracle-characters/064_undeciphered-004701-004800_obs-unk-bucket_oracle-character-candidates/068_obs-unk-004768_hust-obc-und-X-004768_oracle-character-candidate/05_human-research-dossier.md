# obs-unk-004768 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004768`
- primary external id: `hust-obc-und-X-004768`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/068_obs-unk-004768_h
  ust-obc-und-X-004768_oracle-character-candidate/03_visual-assets/001_asset
  -006361_hust-obc-und-X-004768_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/324/X_？_7309_1.png`
- asset id: `asset-006361`
...
- source class: `HUST-OBC/undeciphered/X/324/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/324/X_？_7309_1.png`
- asset id: `asset-006361`
...
- English observation: `left V-shaped group and right enclosed opening`
- 中文观察: `左侧 V 形结构和右侧围合开口`
...
- Which source records identify obs-unk-004768 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004768？
