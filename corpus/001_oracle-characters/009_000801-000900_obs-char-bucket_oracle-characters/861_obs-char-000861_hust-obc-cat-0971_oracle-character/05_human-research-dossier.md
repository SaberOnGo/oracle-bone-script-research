# obs-char-000861 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/861_obs-char-000861_hust-obc-cat-0971_orac
  le-character/03_visual-assets/001_asset-000866_hust-obc-cat-0971_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0971/L_0971_1032.jpg`
- asset id: `asset-000866`
...
- source category: `0971`
- validation class: `860`
- source image route: `HUST-OBC/deciphered/0971/L_0971_1032.jpg`
- asset id: `asset-000866`
...
- English observation: `The small gray image has a thin curved mark at left
  and a separate angular cluster at right with several short branches; the
  gap is unclear.`
- 中文观察: `小型灰度图像左侧有细弯笔，右侧有带数条短分枝的分离折角笔群；间隔难辨。`
...
- dataset label text: `㟁`
- dataset label codepoints: `U+37C1`
...
- Which source records identify obs-char-000861 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000861？
