...
- External category reference: `evobc-cat-11053`
- Source category ID: `11053`
- Source label for human review: `𡣗`
- Source codepoints: `U+218D7`
...
- `obs-evo-cand-011053-route-category-staging`
...
- `obs-evo-cand-011053-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011053-route-evolution-graph`
