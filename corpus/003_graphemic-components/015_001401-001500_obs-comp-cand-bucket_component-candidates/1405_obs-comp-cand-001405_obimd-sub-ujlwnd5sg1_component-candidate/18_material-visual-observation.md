# Material Visual Observation / obs-comp-cand-001405 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001405`
- External reference / 外部参照: `obimd-sub-ujlwnd5sg1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015824_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/v34viqk9rx/ujlwnd5sg1/ujlwnd5sg1.png`
- Checksum / 校验和:
  `5fc67b43504830566e07f4ddbddbd8dc4cd5d951c6604d02da1a83ffa1880d77`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.73%.
- Marked-pixel bounds: (51,41)–(194,214); span 144 × 174 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.73%。
- 痕迹范围：(51,41)–(194,214)；跨度144 × 174 px；痕迹矩形高于宽。
