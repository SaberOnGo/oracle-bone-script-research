# obs-char-000771 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000771`
- primary external id: `hust-obc-cat-0875`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/771_obs-char-000771_hust-obc-cat-0875_orac
  le-character/03_visual-assets/001_asset-000776_hust-obc-cat-0875_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0875/G_0875_甲骨文.png`
- asset id: `asset-000776`
...
- source category: `0875`
- validation class: `770`
- source image route: `HUST-OBC/deciphered/0875/G_0875_甲骨文.png`
- asset id: `asset-000776`
...
- English observation: `Two detached forms stand side by side: a left stem
  with a rounded upper fork and four lower roots, and a right form with a
  tilted top loop above a pointed divided outline.`
- 中文观察: `两个分离形并列：左侧竖干上端圆弯分叉、下伸四根；右形为倾斜上环叠在带分隔的尖形轮廓上。`
...
- dataset label text: `㝡`
- dataset label codepoints: `U+3761`
...
- OBIMD candidate ids / OBIMD 候选 ID: `obimd-main-cand-002291`
- OBIMD external refs / OBIMD 外部引用: `obimd-main-ojtpg03v54`
- OBIMD transcription field / OBIMD 转写字段: `㝡`
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00070`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00070`
- EvoBC image reference count / EvoBC 图像引用数: `24`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00070`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/070_obs-evo-can
  d-000070_evobc-cat-00070_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/070_obs-evo-cand-000070_evobc-cat-00070_evolu
...
- matched OBIMD main UIDs: `ojtpg03v54`
...
- Which source records identify obs-char-000771 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000771？
