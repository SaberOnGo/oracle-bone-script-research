# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000262
...
- EVOBC candidate category: `evobc-evo-cat-00262`.
- Source label for search only: `㾪`.
- Source codepoints for search only: `U+3FAA`.
