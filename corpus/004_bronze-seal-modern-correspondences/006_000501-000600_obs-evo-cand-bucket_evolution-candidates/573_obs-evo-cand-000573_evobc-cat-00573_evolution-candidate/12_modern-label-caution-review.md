# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000573
...
- EVOBC candidate category: `evobc-evo-cat-00573`.
- Source label for search only: `䰍`.
- Source codepoints for search only: `U+4C0D`.
