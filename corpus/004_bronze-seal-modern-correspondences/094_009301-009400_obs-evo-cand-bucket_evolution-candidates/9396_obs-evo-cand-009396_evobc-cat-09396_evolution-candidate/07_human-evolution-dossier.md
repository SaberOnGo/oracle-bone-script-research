...
Project ID: `obs-evo-cand-009396`
...
- Project ID: `obs-evo-cand-009396`
- EVOBC category candidate ID: `evobc-evo-cat-09396`
- External category reference: `evobc-cat-09396`
- Source category ID: `09396`
- Source label for human review: `銴`
- Source codepoints: `U+92B4`
...
- `obs-evo-cand-009396-route-category-staging`
...
- `obs-evo-cand-009396-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009396-route-evolution-graph`
