...
- External category reference: `evobc-cat-13278`
- Source category ID: `13278`
- Source label for human review: `𬔍`
...
- `obs-evo-cand-013278-route-category-staging`
...
- `obs-evo-cand-013278-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013278-route-evolution-graph`
