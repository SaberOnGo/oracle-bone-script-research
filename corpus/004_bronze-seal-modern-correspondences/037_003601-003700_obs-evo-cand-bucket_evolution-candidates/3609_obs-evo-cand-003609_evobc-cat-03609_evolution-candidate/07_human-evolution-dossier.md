...
- External category reference: `evobc-cat-03609`
- Source category ID: `03609`
- Source label for human review: `敶`
- Source codepoints: `U+6576`
...
- `obs-evo-cand-003609-route-category-staging`
...
- `obs-evo-cand-003609-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003609-route-evolution-graph`
