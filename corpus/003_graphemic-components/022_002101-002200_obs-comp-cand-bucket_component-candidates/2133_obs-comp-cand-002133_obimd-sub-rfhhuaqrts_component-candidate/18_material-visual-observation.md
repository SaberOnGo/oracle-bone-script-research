# Material Visual Observation / obs-comp-cand-002133 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002133`
- External reference / 外部参照: `obimd-sub-rfhhuaqrts`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019690_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rfhhuaqrts/rfhhuaqrts/rfhhuaqrts.png`
- Checksum / 校验和:
  `6da18d46a927f1b3d473913dca2fd5593382589fdb26e4bbf4dbd994eefde248`
...
- Marked-pixel bounds: (96,38)–(153,206); span 58 × 169 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.96%。
- 痕迹范围：(96,38)–(153,206)；跨度58 × 169 px；痕迹矩形高于宽。
