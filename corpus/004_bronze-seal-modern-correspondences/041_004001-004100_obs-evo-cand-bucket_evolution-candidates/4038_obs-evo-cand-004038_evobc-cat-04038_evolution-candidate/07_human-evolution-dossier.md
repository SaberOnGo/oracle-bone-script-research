...
- External category reference: `evobc-cat-04038`
- Source category ID: `04038`
- Source label for human review: `桴`
...
- `obs-evo-cand-004038-route-category-staging`
...
- `obs-evo-cand-004038-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004038-route-evolution-graph`
