# obs-unk-003125 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003125`
- primary external id: `hust-obc-und-L-003125`
...
- local review image route: `corpus/001_oracle-characters/048_undeciphered-003
  101-003200_obs-unk-bucket_oracle-character-candidates/025_obs-unk-003125_h
  ust-obc-und-L-003125_oracle-character-candidate/03_visual-assets/001_asset
  -004718_hust-obc-und-L-003125_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3125/L_？_5699.jpg`
- asset id: `asset-004718`
...
- source class: `HUST-OBC/undeciphered/L/3125/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3125/L_？_5699.jpg`
- asset id: `asset-004718`
...
- Which source records identify obs-unk-003125 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003125？
