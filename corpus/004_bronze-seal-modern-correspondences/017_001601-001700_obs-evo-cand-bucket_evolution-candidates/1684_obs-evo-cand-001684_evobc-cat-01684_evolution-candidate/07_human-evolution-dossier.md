...
- Project ID: `obs-evo-cand-001684`
- EVOBC category candidate ID: `evobc-evo-cat-01684`
- External category reference: `evobc-cat-01684`
- Source category ID: `01684`
- Source label for human review: `嗽`
- Source codepoints: `U+55FD`
...
- `obs-evo-cand-001684-route-category-staging`
...
- `obs-evo-cand-001684-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001684-route-evolution-graph`
