...
- Project ID: `obs-evo-cand-002474`
- EVOBC category candidate ID: `evobc-evo-cat-02474`
- External category reference: `evobc-cat-02474`
- Source category ID: `02474`
- Source label for human review: `尚`
- Source codepoints: `U+5C1A`
- Image reference count in source metadata: `144`
...
- `obs-evo-cand-002474-route-category-staging`
...
- `obs-evo-cand-002474-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002474-route-evolution-graph`
