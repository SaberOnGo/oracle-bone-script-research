...
- External category reference: `evobc-cat-00242`
- Source category ID: `00242`
- Source label for human review: `㻚`
...
- `obs-evo-cand-000242-route-category-staging`
...
- `obs-evo-cand-000242-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000242-route-evolution-graph`
