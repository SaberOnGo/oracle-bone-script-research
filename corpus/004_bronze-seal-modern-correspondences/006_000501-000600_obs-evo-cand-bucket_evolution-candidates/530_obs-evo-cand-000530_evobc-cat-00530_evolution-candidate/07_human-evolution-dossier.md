...
- External category reference: `evobc-cat-00530`
- Source category ID: `00530`
- Source label for human review: `䧞`
...
- `obs-evo-cand-000530-route-category-staging`
...
- `obs-evo-cand-000530-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000530-route-evolution-graph`
