# obs-char-001492 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1492_obs-char-001492_hust-obc-cat-1674_ora
  cle-character/03_visual-assets/001_asset-001497_hust-obc-cat-1674_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1674/G_1674_乙3661(甲).png`
- asset id: `asset-001497`
...
- source category: `1674`
- validation class: `1491`
- source image route: `HUST-OBC/deciphered/1674/G_1674_乙3661(甲).png`
- asset id: `asset-001497`
...
- English observation: `A scattered upper cluster sits above a rectangular
  lower frame with divisions.`
...
- dataset label text: `㪀`
- dataset label codepoints: `U+3A80`
...
- Which source records identify obs-char-001492 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001492？
