...
Project ID: `obs-evo-cand-003811`
...
- Project ID: `obs-evo-cand-003811`
- EVOBC category candidate ID: `evobc-evo-cat-03811`
- External category reference: `evobc-cat-03811`
- Source category ID: `03811`
- Source label for human review: `曲`
- Source codepoints: `U+66F2`
...
- `obs-evo-cand-003811-route-category-staging`
...
- `obs-evo-cand-003811-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003811-route-evolution-graph`
