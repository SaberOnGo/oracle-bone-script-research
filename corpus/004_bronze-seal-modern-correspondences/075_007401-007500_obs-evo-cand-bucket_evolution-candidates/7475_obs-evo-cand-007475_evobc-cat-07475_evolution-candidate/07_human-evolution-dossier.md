...
- Project ID: `obs-evo-cand-007475`
- EVOBC category candidate ID: `evobc-evo-cat-07475`
- External category reference: `evobc-cat-07475`
- Source category ID: `07475`
- Source label for human review: `董`
- Source codepoints: `U+8463`
...
- `obs-evo-cand-007475-route-category-staging`
...
- `obs-evo-cand-007475-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007475-route-evolution-graph`
