...
- External category reference: `evobc-cat-01232`
- Source category ID: `01232`
- Source label for human review: `剡`
- Source codepoints: `U+5261`
...
- `obs-evo-cand-001232-route-category-staging`
...
- `obs-evo-cand-001232-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001232-route-evolution-graph`
