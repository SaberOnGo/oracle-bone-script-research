# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010669
...
- EVOBC candidate category: `evobc-evo-cat-10669`.
- Source label for search only: `黺`.
- Source codepoints for search only: `U+9EFA`.
