...
Project ID: `obs-evo-cand-010188`
...
- Project ID: `obs-evo-cand-010188`
- EVOBC category candidate ID: `evobc-evo-cat-10188`
- External category reference: `evobc-cat-10188`
- Source category ID: `10188`
- Source label for human review: `駙`
- Source codepoints: `U+99D9`
...
- `obs-evo-cand-010188-route-category-staging`
...
- `obs-evo-cand-010188-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010188-route-evolution-graph`
