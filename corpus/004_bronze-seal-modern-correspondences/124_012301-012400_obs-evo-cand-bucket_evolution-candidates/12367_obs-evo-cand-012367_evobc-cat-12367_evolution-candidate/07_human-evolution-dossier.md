...
- External category reference: `evobc-cat-12367`
- Source category ID: `12367`
- Source label for human review: `𨓚`
- Source codepoints: `U+284DA`
...
- `obs-evo-cand-012367-route-category-staging`
...
- `obs-evo-cand-012367-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012367-route-evolution-graph`
