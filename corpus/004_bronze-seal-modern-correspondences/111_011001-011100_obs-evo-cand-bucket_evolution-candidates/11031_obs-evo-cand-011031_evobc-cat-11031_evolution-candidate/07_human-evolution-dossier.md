...
- External category reference: `evobc-cat-11031`
- Source category ID: `11031`
- Source label for human review: `𡚽`
...
- `obs-evo-cand-011031-route-category-staging`
...
- `obs-evo-cand-011031-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011031-route-evolution-graph`
