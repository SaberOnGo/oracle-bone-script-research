...
- External category reference: `evobc-cat-02494`
- Source category ID: `02494`
- Source label for human review: `尿`
- Source codepoints: `U+5C3F`
...
- `obs-evo-cand-002494-route-category-staging`
...
- `obs-evo-cand-002494-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002494-route-evolution-graph`
