# Material Visual Observation / obs-comp-cand-000424 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000424`
- External reference / 外部参照: `obimd-sub-54s1u855x9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012347_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/54s1u855x9/54s1u855x9/54s1u855x9.png`
- Checksum / 校验和:
  `5780c5436b2f48e5d20c1467d29a46706e819738d6b5114c595a0b26e44e66d5`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.62%.
- Marked-pixel bounds: (57,28)–(191,223); span 135 × 196 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.62%。
- 痕迹范围：(57,28)–(191,223)；跨度135 × 196 px；痕迹矩形高于宽。
