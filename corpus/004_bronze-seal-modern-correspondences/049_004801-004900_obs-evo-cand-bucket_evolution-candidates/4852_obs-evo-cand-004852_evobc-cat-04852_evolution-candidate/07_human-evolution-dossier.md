...
Project ID: `obs-evo-cand-004852`
...
- Project ID: `obs-evo-cand-004852`
- EVOBC category candidate ID: `evobc-evo-cat-04852`
- External category reference: `evobc-cat-04852`
- Source category ID: `04852`
- Source label for human review: `滯`
- Source codepoints: `U+6EEF`
...
- `obs-evo-cand-004852-route-category-staging`
...
- `obs-evo-cand-004852-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004852-route-evolution-graph`
