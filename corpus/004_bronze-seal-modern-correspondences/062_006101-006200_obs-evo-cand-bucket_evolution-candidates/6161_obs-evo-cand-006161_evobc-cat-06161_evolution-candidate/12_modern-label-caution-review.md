# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006161
...
- EVOBC candidate category: `evobc-evo-cat-06161`.
- Source label for search only: `窐`.
- Source codepoints for search only: `U+7A90`.
