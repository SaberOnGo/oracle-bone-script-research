# obs-unk-005600 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/072_undeciphered-005
  501-005600_obs-unk-bucket_oracle-character-candidates/100_obs-unk-005600_h
  ust-obc-und-X-005600_oracle-character-candidate/03_visual-assets/001_asset
  -007193_hust-obc-und-X-005600_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1156/X_？_8111_1.png`
- asset id: `asset-007193`
...
- source class: `HUST-OBC/undeciphered/X/1156/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1156/X_？_8111_1.png`
- asset id: `asset-007193`
...
- Which source records identify obs-unk-005600 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005600？
