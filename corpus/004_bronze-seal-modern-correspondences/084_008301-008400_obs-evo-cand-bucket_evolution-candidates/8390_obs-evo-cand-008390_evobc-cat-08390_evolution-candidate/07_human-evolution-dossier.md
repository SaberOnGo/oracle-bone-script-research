...
Project ID: `obs-evo-cand-008390`
...
- Project ID: `obs-evo-cand-008390`
- EVOBC category candidate ID: `evobc-evo-cat-08390`
- External category reference: `evobc-cat-08390`
- Source category ID: `08390`
- Source label for human review: `讒`
- Source codepoints: `U+8B92`
...
- `obs-evo-cand-008390-route-category-staging`
...
- `obs-evo-cand-008390-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008390-route-evolution-graph`
