# Material Visual Observation / obs-comp-cand-000955 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000955`
- External reference / 外部参照: `obimd-sub-zgipta73eu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014038_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zgipta73eu/zgipta73eu/zgipta73eu.png`
- Checksum / 校验和:
  `b3356739b908e7bd943197b5e8864dbf0fac5de3702bb5c6129c95602206194a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.13%.
- Marked-pixel bounds: (44,42)–(191,209); span 148 × 168 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.13%。
- 痕迹范围：(44,42)–(191,209)；跨度148 × 168 px；痕迹矩形近方形。
