# obs-char-000597 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000597`
- primary external id: `hust-obc-cat-0680_0681`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/597_obs-char-000597_hust-obc-cat-0680_0681
  _oracle-character/03_visual-assets/001_asset-000602_hust-obc-cat-0680_0681
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0680_0681/0680/G_0680_甲骨文0.png`
- asset id: `asset-000602`
...
- source category: `0680_0681`
- validation class: `596`
- source image route: `HUST-OBC/deciphered/0680_0681/0680/G_0680_甲骨文0.png`
- asset id: `asset-000602`
...
- English observation: `A vertical stack combines a tiny top rectangle, a
  larger middle rectangular outline, a narrow connecting stem, and crossed
  forked strokes at the bottom.`
- 中文观察: `竖向层叠形结合微小顶矩形、较大中部矩形框、狭窄连接干和底部交叉叉笔。`
...
- dataset label text: `㚞㚟`
- dataset label codepoints: `U+369E;U+369F`
...
- graph edge count: `2`
- codepoint routes: `U+369E;U+369F`
...
- Which source records identify obs-char-000597 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000597？
