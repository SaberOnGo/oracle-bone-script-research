...
Project ID: `obs-evo-cand-007881`
...
- Project ID: `obs-evo-cand-007881`
- EVOBC category candidate ID: `evobc-evo-cat-07881`
- External category reference: `evobc-cat-07881`
- Source category ID: `07881`
- Source label for human review: `蠜`
- Source codepoints: `U+881C`
...
- `obs-evo-cand-007881-route-category-staging`
...
- `obs-evo-cand-007881-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007881-route-evolution-graph`
