# obs-unk-004059 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004059`
- primary external id: `hust-obc-und-L-004059`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/059_obs-unk-004059_h
  ust-obc-und-L-004059_oracle-character-candidate/03_visual-assets/001_asset
  -005652_hust-obc-und-L-004059_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4059/L_？_8692.jpg`
- asset id: `asset-005652`
...
- source class: `HUST-OBC/undeciphered/L/4059/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4059/L_？_8692.jpg`
- asset id: `asset-005652`
...
- English observation: Two upward curved traces frame the upper sides. The
  forms narrow toward a central lower shaft and end in a pointed triangular
  contour with short interior marks. The joins and lower opening are unclear.
...
- Which source records identify obs-unk-004059 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004059？
