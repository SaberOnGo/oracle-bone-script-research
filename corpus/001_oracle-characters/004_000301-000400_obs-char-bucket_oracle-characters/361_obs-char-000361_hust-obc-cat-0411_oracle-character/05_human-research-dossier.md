# obs-char-000361 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000361`
- primary external id: `hust-obc-cat-0411`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/361_obs-char-000361_hust-obc-cat-0411_orac
  le-character/03_visual-assets/001_asset-000366_hust-obc-cat-0411_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0411/Y_0411_60558.jpg`
- asset id: `asset-000366`
...
- source category: `0411`
- validation class: `360`
- source image route: `HUST-OBC/deciphered/0411/Y_0411_60558.jpg`
- asset id: `asset-000366`
...
- English observation: `A bold angular upper form is connected to a long
  vertical stroke and a small pointed lower enclosure.`
- 中文观察: `粗重的上部折角形体连接长竖笔画，下方接有小型尖状闭合轮廓。`
...
- dataset label text: `㖑`
- dataset label codepoints: `U+3591`
...
- Which source records identify obs-char-000361 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000361？
