# obs-char-000584 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/584_obs-char-000584_hust-obc-cat-0663_orac
  le-character/03_visual-assets/001_asset-000589_hust-obc-cat-0663_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0663/G_0663_京津2725合4375賓組.png`
- asset id: `asset-000589`
...
- source category: `0663`
- validation class: `583`
- source image route: `HUST-OBC/deciphered/0663/G_0663_京津2725合4375賓組.png`
- asset id: `asset-000589`
...
- English observation: `A compact left cluster combines two upper verticals,
  a middle oval loop, and a short lower base; three detached diagonal dashes
  stand at right.`
...
- dataset label text: `㚍`
- dataset label codepoints: `U+368D`
...
- filename catalog route clues: `Heji-like filename clue: 合4375
...
- Which source records identify obs-char-000584 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000584？
