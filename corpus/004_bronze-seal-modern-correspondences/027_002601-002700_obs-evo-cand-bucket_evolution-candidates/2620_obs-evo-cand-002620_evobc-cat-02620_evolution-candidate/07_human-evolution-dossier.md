...
- External category reference: `evobc-cat-02620`
- Source category ID: `02620`
- Source label for human review: `巨`
...
- `obs-evo-cand-002620-route-category-staging`
...
- `obs-evo-cand-002620-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002620-route-evolution-graph`
