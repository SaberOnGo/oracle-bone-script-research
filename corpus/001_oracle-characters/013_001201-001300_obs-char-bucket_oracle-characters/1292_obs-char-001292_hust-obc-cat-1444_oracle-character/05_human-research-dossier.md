# obs-char-001292 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001292`
- primary external id: `hust-obc-cat-1444`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1292_obs-char-001292_hust-obc-cat-1444_ora
  cle-character/03_visual-assets/001_asset-001297_hust-obc-cat-1444_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1444/G_1444_乙5329合10976賓組.png`
- asset id: `asset-001297`
...
- source category: `1444`
- validation class: `1291`
- source image route: `HUST-OBC/deciphered/1444/G_1444_乙5329合10976賓組.png`
- asset id: `asset-001297`
...
- dataset label text: `㦚`
- dataset label codepoints: `U+399A`
...
- filename catalog route clues: `Heji-like filename clue: 合10976
...
- Which source records identify obs-char-001292 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001292？
