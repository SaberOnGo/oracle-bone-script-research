# obs-unk-005854 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005854`
- primary external id: `hust-obc-und-X-005854`
...
- local review image route: `corpus/001_oracle-characters/075_undeciphered-005
  801-005900_obs-unk-bucket_oracle-character-candidates/054_obs-unk-005854_h
  ust-obc-und-X-005854_oracle-character-candidate/03_visual-assets/001_asset
  -007446_hust-obc-und-X-005854_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1410/X_？_2124_1.png`
- asset id: `asset-007446`
...
- source class: `HUST-OBC/undeciphered/X/1410/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1410/X_？_2124_1.png`
- asset id: `asset-007446`
...
- Which source records identify obs-unk-005854 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005854？
