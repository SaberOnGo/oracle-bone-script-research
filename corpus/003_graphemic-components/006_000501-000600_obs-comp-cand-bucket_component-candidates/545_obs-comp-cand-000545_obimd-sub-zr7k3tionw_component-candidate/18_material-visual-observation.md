# Material Visual Observation / obs-comp-cand-000545 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000545`
- External reference / 外部参照: `obimd-sub-zr7k3tionw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012779_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/446qjw4xgi/zr7k3tionw/zr7k3tionw.png`
- Checksum / 校验和:
  `8fe23fb459c9afc8539461377d17105f0bc4063469a8010a1f6624943738ed4b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.43%.
- Marked-pixel bounds: (87,12)–(162,235); span 76 × 224 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.43%。
- 痕迹范围：(87,12)–(162,235)；跨度76 × 224 px；痕迹矩形高于宽。
