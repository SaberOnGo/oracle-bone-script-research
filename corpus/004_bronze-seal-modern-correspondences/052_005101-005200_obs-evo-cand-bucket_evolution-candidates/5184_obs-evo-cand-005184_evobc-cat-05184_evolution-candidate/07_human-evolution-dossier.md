...
- External category reference: `evobc-cat-05184`
- Source category ID: `05184`
- Source label for human review: `爲`
- Source codepoints: `U+7232`
- Image reference count in source metadata: `171`
...
- `obs-evo-cand-005184-route-category-staging`
...
- `obs-evo-cand-005184-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005184-route-evolution-graph`
