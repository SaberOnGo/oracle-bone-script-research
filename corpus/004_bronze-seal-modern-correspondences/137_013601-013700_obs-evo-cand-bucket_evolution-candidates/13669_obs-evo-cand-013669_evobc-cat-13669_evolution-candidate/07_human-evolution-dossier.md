...
- External category reference: `evobc-cat-13669`
- Source category ID: `13669`
- Source label for human review: `𮣘`
...
- `obs-evo-cand-013669-route-category-staging`
...
- `obs-evo-cand-013669-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013669-route-evolution-graph`
