...
- External category reference: `evobc-cat-08704`
- Source category ID: `08704`
- Source label for human review: `跀`
...
- `obs-evo-cand-008704-route-category-staging`
...
- `obs-evo-cand-008704-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008704-route-evolution-graph`
