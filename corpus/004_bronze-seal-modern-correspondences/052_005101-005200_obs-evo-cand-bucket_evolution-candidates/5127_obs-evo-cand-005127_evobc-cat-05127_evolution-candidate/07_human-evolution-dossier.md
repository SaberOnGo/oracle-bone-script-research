...
Project ID: `obs-evo-cand-005127`
...
- Project ID: `obs-evo-cand-005127`
- EVOBC category candidate ID: `evobc-evo-cat-05127`
- External category reference: `evobc-cat-05127`
- Source category ID: `05127`
- Source label for human review: `熒`
- Source codepoints: `U+7192`
...
- `obs-evo-cand-005127-route-category-staging`
...
- `obs-evo-cand-005127-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005127-route-evolution-graph`
