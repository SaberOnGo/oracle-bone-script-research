# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001671
...
| Glyph or codepoint route / 字形或码位路线 | 14 OBIMD route rows; examples U+F9B7E; U+F9B7F; 另有 12 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
