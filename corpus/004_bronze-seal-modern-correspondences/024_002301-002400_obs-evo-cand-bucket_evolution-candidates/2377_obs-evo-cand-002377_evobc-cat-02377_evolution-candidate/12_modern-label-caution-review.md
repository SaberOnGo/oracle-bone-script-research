# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002377
...
- EVOBC candidate category: `evobc-evo-cat-02377`.
- Source label for search only: `宛`.
- Source codepoints for search only: `U+5B9B`.
