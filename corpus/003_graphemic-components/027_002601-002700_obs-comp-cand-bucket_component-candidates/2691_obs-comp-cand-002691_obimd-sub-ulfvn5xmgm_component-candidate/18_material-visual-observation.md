# Material Visual Observation / obs-comp-cand-002691 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002691`
- External reference / 外部参照: `obimd-sub-ulfvn5xmgm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021267_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ulfvn5xmgm/ulfvn5xmgm/ulfvn5xmgm.png`
- Checksum / 校验和:
  `f53384011c8173a0c1f7362cc5655bf41d95c44c8634c8a347c23da51c23aa29`
...
- Marked-pixel bounds: (92,17)–(152,229); span 61 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.87%。
- 痕迹范围：(92,17)–(152,229)；跨度61 × 213 px；痕迹矩形高于宽。
