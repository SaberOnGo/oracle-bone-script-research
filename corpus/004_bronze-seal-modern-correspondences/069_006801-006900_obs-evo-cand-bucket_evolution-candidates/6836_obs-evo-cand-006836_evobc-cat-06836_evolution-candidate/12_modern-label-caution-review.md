# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006836
...
- EVOBC candidate category: `evobc-evo-cat-06836`.
- Source label for search only: `羊`.
- Source codepoints for search only: `U+7F8A`.
