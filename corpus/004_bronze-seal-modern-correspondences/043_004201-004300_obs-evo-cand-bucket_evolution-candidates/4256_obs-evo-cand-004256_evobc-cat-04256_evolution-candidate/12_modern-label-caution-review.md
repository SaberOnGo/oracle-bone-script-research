# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004256
...
- Project ID: `obs-evo-cand-004256`.
- EVOBC candidate category: `evobc-evo-cat-04256`.
- Source label for search only: `樻`.
- Source codepoints for search only: `U+6A3B`.
