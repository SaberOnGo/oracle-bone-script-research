# obs-char-001137 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1137_obs-char-001137_hust-obc-cat-1270_ora
  cle-character/03_visual-assets/001_asset-001142_hust-obc-cat-1270_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1270/G_1270_甲骨文.png`
- asset id: `asset-001142`
...
- source category: `1270`
- validation class: `1136`
- source image route: `HUST-OBC/deciphered/1270/G_1270_甲骨文.png`
- asset id: `asset-001142`
...
- English observation: `A compact upright enclosure has two tall side
  curves, a central crossing, and a low rounded base.`
- 中文观察: `紧密直立闭合形体有两条高侧弯笔、中央交叉和低位圆弧底部。`
...
- dataset label text: `㣬`
- dataset label codepoints: `U+38EC`
...
- Which source records identify obs-char-001137 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001137？
