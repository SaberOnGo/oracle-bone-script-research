...
- External category reference: `evobc-cat-00977`
- Source category ID: `00977`
- Source label for human review: `傋`
- Source codepoints: `U+508B`
...
- `obs-evo-cand-000977-route-category-staging`
...
- `obs-evo-cand-000977-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000977-route-evolution-graph`
