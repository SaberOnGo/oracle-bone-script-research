# obs-char-001232 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001232`
- primary external id: `hust-obc-cat-1378_1379`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1232_obs-char-001232_hust-obc-cat-1378_137
  9_oracle-character/03_visual-assets/001_asset-001237_hust-obc-cat-1378_137
  9_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1378_1379/1378/H_1378_60A30_0.p
  ng`
- asset id: `asset-001237`
...
- source category: `1378_1379`
- validation class: `1231`
- source image route: `HUST-OBC/deciphered/1378_1379/1378/H_1378_60A30_0.png`
- asset id: `asset-001237`
...
- English observation: `A large dense form has an upper rectangular
  enclosure, a central stem, and a broad lower angular body.`
- 中文观察: `大型密集形体有上部方形框廓、中央笔干和宽大的下部折角形体。`
...
- dataset label text: `㥘㥙`
- dataset label codepoints: `U+3958;U+3959`
...
- graph edge count: `2`
- codepoint routes: `U+3958;U+3959`
...
- filename catalog route clues: `catalog-like filename clue: H_1378
  (H_1378_60A30_0.png)`
...
- Which source records identify obs-char-001232 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001232？
