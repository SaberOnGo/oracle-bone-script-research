...
Project ID: `obs-evo-cand-003420`
...
- Project ID: `obs-evo-cand-003420`
- EVOBC category candidate ID: `evobc-evo-cat-03420`
- External category reference: `evobc-cat-03420`
- Source category ID: `03420`
- Source label for human review: `揃`
- Source codepoints: `U+63C3`
...
- `obs-evo-cand-003420-route-category-staging`
...
- `obs-evo-cand-003420-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003420-route-evolution-graph`
