# Material Visual Observation / obs-comp-cand-001086 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001086`
- External reference / 外部参照: `obimd-sub-f1uojpw9ej`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014829_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/f1uojpw9ej/f1uojpw9ej/f1uojpw9ej.png`
- Checksum / 校验和:
  `7ba1401da78b3f07db82d55639ab8c5344786b2958927155b3dd779708e1e7c8`
...
- Marked-pixel bounds: (72,80)–(183,174); span 112 × 95 px; the marked rectangle
  is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.13%。
- 痕迹范围：(72,80)–(183,174)；跨度112 × 95 px；痕迹矩形近方形。
