# obs-char-000548 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000548`
- primary external id: `hust-obc-cat-0622`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/548_obs-char-000548_hust-obc-cat-0622_orac
  le-character/03_visual-assets/001_asset-000553_hust-obc-cat-0622_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0622/G_0622_乙3262合7440.png`
- asset id: `asset-000553`
...
- source category: `0622`
- validation class: `547`
- source image route: `HUST-OBC/deciphered/0622/G_0622_乙3262合7440.png`
- asset id: `asset-000553`
...
- English observation: `Two long bowed upright strokes stand apart, each
  with a short upper side branch; a broad lower bar crosses both and extends
  beyond them.`
- 中文观察: `两条长弓曲直立笔分开排列，各带一条上部短侧枝；宽下横穿过两笔并向外伸出。`
...
- dataset label text: `㙤`
- dataset label codepoints: `U+3664`
...
- filename catalog route clues: `Heji-like filename clue: 合7440
  (G_0622_乙3262合7440.png)`
...
- Which source records identify obs-char-000548 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000548？
