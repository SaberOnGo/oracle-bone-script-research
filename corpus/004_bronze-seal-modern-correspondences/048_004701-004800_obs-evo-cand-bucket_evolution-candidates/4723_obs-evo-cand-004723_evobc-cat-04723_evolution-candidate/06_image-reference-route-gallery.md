...
- `obs-evo-cand-004723-route-category-staging`
...
- `obs-evo-cand-004723-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004723-route-evolution-graph`
