# Material Visual Observation / obs-comp-cand-000795 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000795`
- External reference / 外部参照: `obimd-sub-2tq601zel0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013593_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2tq601zel0/2tq601zel0/2tq601zel0.png`
- Checksum / 校验和:
  `6d5f55956c898673c41d95d36d7672957537e6b96649f3c51f181080d32cd2ca`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.93%.
- Marked-pixel bounds: (45,20)–(199,228); span 155 × 209 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.93%。
- 痕迹范围：(45,20)–(199,228)；跨度155 × 209 px；痕迹矩形高于宽。
