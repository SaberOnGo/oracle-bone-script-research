# obs-char-001136 Archaeology Paleography Review

# obs-char-001136 考古文字复核档案
...
- first local image: `001_asset-001141_hust-obc-cat-1269_glyph.png`
- first source image: `G_1269_乙8896(甲).png`
...
- source label text: `㣫`
- source label codepoints: `U+38EB`
