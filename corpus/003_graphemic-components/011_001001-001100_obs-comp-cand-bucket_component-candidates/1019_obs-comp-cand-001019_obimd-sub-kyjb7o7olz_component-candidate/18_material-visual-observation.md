# Material Visual Observation / obs-comp-cand-001019 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001019`
- External reference / 外部参照: `obimd-sub-kyjb7o7olz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014501_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kyjb7o7olz/kyjb7o7olz/kyjb7o7olz.png`
- Checksum / 校验和:
  `2f729296e5de38f2dfa1a44d1a72dc1517bd2fc0f899f2e0487135633e0d6848`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.09%.
- Marked-pixel bounds: (62,52)–(194,198); span 133 × 147 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.09%。
- 痕迹范围：(62,52)–(194,198)；跨度133 × 147 px；痕迹矩形近方形。
