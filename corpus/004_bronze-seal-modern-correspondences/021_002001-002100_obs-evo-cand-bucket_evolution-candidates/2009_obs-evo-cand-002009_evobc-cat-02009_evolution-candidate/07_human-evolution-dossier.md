...
- External category reference: `evobc-cat-02009`
- Source category ID: `02009`
- Source label for human review: `夨`
- Source codepoints: `U+5928`
- Image reference count in source metadata: `104`
...
- `obs-evo-cand-002009-route-category-staging`
...
- `obs-evo-cand-002009-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002009-route-evolution-graph`
