...
Project ID: `obs-evo-cand-005563`
...
- Project ID: `obs-evo-cand-005563`
- EVOBC category candidate ID: `evobc-evo-cat-05563`
- External category reference: `evobc-cat-05563`
- Source category ID: `05563`
- Source label for human review: `畏`
- Source codepoints: `U+754F`
...
- `obs-evo-cand-005563-route-category-staging`
...
- `obs-evo-cand-005563-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005563-route-evolution-graph`
