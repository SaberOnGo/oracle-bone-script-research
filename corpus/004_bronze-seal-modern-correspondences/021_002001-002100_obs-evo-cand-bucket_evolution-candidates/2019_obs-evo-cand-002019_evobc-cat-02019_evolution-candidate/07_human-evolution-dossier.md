...
- External category reference: `evobc-cat-02019`
- Source category ID: `02019`
- Source label for human review: `头`
...
- `obs-evo-cand-002019-route-category-staging`
...
- `obs-evo-cand-002019-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002019-route-evolution-graph`
