# obs-unk-004889 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004889`
- primary external id: `hust-obc-und-X-004889`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/089_obs-unk-004889_h
  ust-obc-und-X-004889_oracle-character-candidate/03_visual-assets/001_asset
  -006482_hust-obc-und-X-004889_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/445/X_？_7427_1.png`
- asset id: `asset-006482`
...
- source class: `HUST-OBC/undeciphered/X/445/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/445/X_？_7427_1.png`
- asset id: `asset-006482`
...
- English observation: `three stacked groups with pale openings`
- 中文观察: `上下三组结构和浅色开口`
...
- Which source records identify obs-unk-004889 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004889？
