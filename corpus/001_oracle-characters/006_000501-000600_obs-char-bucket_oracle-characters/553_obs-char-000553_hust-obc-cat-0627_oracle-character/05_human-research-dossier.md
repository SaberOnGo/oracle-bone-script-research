# obs-char-000553 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/553_obs-char-000553_hust-obc-cat-0627_orac
  le-character/03_visual-assets/001_asset-000558_hust-obc-cat-0627_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0627/G_0627_寧滬1.234(甲).png`
- asset id: `asset-000558`
...
- source category: `0627`
- validation class: `552`
- source image route: `HUST-OBC/deciphered/0627/G_0627_寧滬1.234(甲).png`
- asset id: `asset-000558`
...
- English observation: `A tall narrow triangular outline stands at left; at
  right, a long curved upright is crossed near the middle by a diagonal
  stroke.`
...
- dataset label text: `㙩`
- dataset label codepoints: `U+3669`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00042`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00042`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00042`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/042_obs-evo-can
  d-000042_evobc-cat-00042_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/042_obs-evo-cand-000042_evobc-cat-00042_evolu
...
- Which source records identify obs-char-000553 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000553？
