# obs-char-001562 Archaeology Paleography Review

# obs-char-001562 考古文字复核档案
...
- first local image: `001_asset-001567_hust-obc-cat-1753_glyph.png`
- first source image: `G_1753_掇2.403(甲).png`
...
- source label text: `㫏`
- source label codepoints: `U+3ACF`
