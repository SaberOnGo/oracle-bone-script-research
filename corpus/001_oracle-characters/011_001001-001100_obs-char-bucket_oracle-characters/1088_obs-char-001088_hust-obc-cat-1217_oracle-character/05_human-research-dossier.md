# obs-char-001088 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1088_obs-char-001088_hust-obc-cat-1217_ora
  cle-character/03_visual-assets/001_asset-001093_hust-obc-cat-1217_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1217/G_1217_京津3038合20129.png`
- asset id: `asset-001093`
...
- source category: `1217`
- validation class: `1087`
- source image route: `HUST-OBC/deciphered/1217/G_1217_京津3038合20129.png`
- asset id: `asset-001093`
...
- English observation: `A narrow vertical form has a forked upper end, a
  central upright, and a long descending right curve.`
...
- dataset label text: `㢷`
- dataset label codepoints: `U+38B7`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00103`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00103`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00103`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/103_obs-evo-can
  d-000103_evobc-cat-00103_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/103_obs-evo-cand-000103_evobc-cat-00103_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合20129
  (G_1217_京津3038合20129.png)`
...
- Which source records identify obs-char-001088 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001088？
