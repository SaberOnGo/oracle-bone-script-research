...
- `obs-evo-cand-006419-route-category-staging`
...
- `obs-evo-cand-006419-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006419-route-evolution-graph`
