# Evolution Review Fact Matrix / 字形演化复核事实矩阵: obs-evo-cand-009762
...
| Era and source-code route / 时期与来源代码路线 | 3 era/source rows; dataset labels are search aids only. | `03_era-source-code-index.csv` |
