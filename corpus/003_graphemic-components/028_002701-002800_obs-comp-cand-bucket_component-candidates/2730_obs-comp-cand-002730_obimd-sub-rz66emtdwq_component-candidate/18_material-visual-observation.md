# Material Visual Observation / obs-comp-cand-002730 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002730`
- External reference / 外部参照: `obimd-sub-rz66emtdwq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021346_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rz66emtdwq/rz66emtdwq/rz66emtdwq.png`
- Checksum / 校验和:
  `340d41be58e8a26feabe6bf263338679cd4a3456a29a368f768df544c5ac8979`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.29%.
- Marked-pixel bounds: (51,29)–(189,209); span 139 × 181 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.29%。
- 痕迹范围：(51,29)–(189,209)；跨度139 × 181 px；痕迹矩形高于宽。
