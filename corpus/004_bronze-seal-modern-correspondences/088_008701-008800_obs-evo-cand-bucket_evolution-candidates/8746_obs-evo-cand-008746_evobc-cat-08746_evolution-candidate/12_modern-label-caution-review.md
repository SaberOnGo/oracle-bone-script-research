# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008746
...
- EVOBC candidate category: `evobc-evo-cat-08746`.
- Source label for search only: `踽`.
- Source codepoints for search only: `U+8E3D`.
