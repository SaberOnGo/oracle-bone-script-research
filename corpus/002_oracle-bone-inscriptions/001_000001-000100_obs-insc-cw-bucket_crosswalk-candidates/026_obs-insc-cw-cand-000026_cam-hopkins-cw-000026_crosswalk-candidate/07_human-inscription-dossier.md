...
- Yingguo / 英国所藏: `y158` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `147` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `506` in source row; primary catalog entry pending
