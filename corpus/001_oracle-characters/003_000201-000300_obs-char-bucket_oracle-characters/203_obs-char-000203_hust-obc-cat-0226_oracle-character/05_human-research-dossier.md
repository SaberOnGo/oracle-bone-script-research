# obs-char-000203 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/203_obs-char-000203_hust-obc-cat-0226_orac
  le-character/03_visual-assets/001_asset-000208_hust-obc-cat-0226_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0226/G_0226_乙9091反合20045反𠂤組.png
  `
- asset id: `asset-000208`
...
- source category: `0226`
- validation class: `202`
- source image route: `HUST-OBC/deciphered/0226/G_0226_乙9091反合20045反𠂤組.png`
- asset id: `asset-000208`
...
- English observation: `The image has a deep rounded lower bowl, two short
  upright strokes inside, and a narrow central opening at the top.`
- 中文观察: `图像下部有深圆弧碗状框，内部有两道短竖笔，上方中央有窄开口。`
...
- dataset label text: `㓘`
- dataset label codepoints: `U+34D8`
...
- filename catalog route clues: `Heji-like filename clue: 合20045
  (G_0226_乙9091反合20045反𠂤組.png)`
...
- Which source records identify obs-char-000203 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000203？
