...
- External category reference: `evobc-cat-06761`
- Source category ID: `06761`
- Source label for human review: `维`
...
- `obs-evo-cand-006761-route-category-staging`
...
- `obs-evo-cand-006761-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006761-route-evolution-graph`
