# obs-char-001168 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1168_obs-char-001168_hust-obc-cat-1308_ora
  cle-character/03_visual-assets/001_asset-001173_hust-obc-cat-1308_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1308/G_1308_菁8.1(甲).png`
- asset id: `asset-001173`
...
- source category: `1308`
- validation class: `1167`
- source image route: `HUST-OBC/deciphered/1308/G_1308_菁8.1(甲).png`
- asset id: `asset-001173`
...
- English observation: `A small stacked angular form crosses a central
  horizontal stroke and joins a long right vertical ending in a base.`
...
- dataset label text: `㤒`
- dataset label codepoints: `U+3912`
...
- Which source records identify obs-char-001168 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001168？
