# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008143
...
- EVOBC candidate category: `evobc-evo-cat-08143`.
- Source label for search only: `訞`.
- Source codepoints for search only: `U+8A1E`.
