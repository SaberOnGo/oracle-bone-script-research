...
Project ID: `obs-insc-cw-cand-000371`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000371`
...
- Yingguo / 英国所藏: `y2110` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `460` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `90` in source row; primary catalog entry pending
- Heji / 合集: `41135` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000371`
