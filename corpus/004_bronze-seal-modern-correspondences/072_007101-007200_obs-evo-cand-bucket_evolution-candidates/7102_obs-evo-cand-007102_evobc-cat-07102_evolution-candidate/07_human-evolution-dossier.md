...
- External category reference: `evobc-cat-07102`
- Source category ID: `07102`
- Source label for human review: `腦`
- Source codepoints: `U+8166`
...
- `obs-evo-cand-007102-route-category-staging`
...
- `obs-evo-cand-007102-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007102-route-evolution-graph`
