# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002883
...
- EVOBC candidate category: `evobc-evo-cat-02883`.
- Source label for search only: `循`.
- Source codepoints for search only: `U+5FAA`.
