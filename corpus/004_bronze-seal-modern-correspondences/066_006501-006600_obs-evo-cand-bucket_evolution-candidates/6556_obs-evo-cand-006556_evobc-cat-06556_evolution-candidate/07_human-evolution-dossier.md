...
- External category reference: `evobc-cat-06556`
- Source category ID: `06556`
- Source label for human review: `綬`
...
- `obs-evo-cand-006556-route-category-staging`
...
- `obs-evo-cand-006556-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006556-route-evolution-graph`
