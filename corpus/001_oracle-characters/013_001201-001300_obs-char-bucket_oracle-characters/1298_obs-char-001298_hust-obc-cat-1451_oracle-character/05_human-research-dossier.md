# obs-char-001298 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001298`
- primary external id: `hust-obc-cat-1451`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1298_obs-char-001298_hust-obc-cat-1451_ora
  cle-character/03_visual-assets/001_asset-001303_hust-obc-cat-1451_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1451/L_1451_4264.jpg`
- asset id: `asset-001303`
...
- source category: `1451`
- validation class: `1297`
- source image route: `HUST-OBC/deciphered/1451/L_1451_4264.jpg`
- asset id: `asset-001303`
...
- English observation: `A faint isolated form has a short rounded horizontal
  body and a small detached lower pointed mark.`
- 中文观察: `较淡的孤立形体有短圆拱水平主体和一个分离的下部尖状标记。`
...
- dataset label text: `㦡`
- dataset label codepoints: `U+39A1`
...
- Which source records identify obs-char-001298 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001298？
