# obs-char-001030 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001030`
- primary external id: `hust-obc-cat-1155`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1030_obs-char-001030_hust-obc-cat-1155_ora
  cle-character/03_visual-assets/001_asset-001035_hust-obc-cat-1155_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1155/G_1155_掇1.204.png`
- asset id: `asset-001035`
...
- source category: `1155`
- validation class: `1029`
- source image route: `HUST-OBC/deciphered/1155/G_1155_掇1.204.png`
- asset id: `asset-001035`
...
- English observation: `A thin central upright ends in a small pointed
  enclosure with two lower branching strokes and a short upper projection.`
...
- dataset label text: `㡹`
- dataset label codepoints: `U+3879`
...
- Which source records identify obs-char-001030 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001030？
