...
- External category reference: `evobc-cat-12373`
- Source category ID: `12373`
- Source label for human review: `𨕖`
- Source codepoints: `U+28556`
...
- `obs-evo-cand-012373-route-category-staging`
...
- `obs-evo-cand-012373-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012373-route-evolution-graph`
