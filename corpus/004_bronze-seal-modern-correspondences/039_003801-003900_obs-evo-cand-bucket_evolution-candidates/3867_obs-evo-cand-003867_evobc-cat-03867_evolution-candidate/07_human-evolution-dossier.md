...
- External category reference: `evobc-cat-03867`
- Source category ID: `03867`
- Source label for human review: `杆`
- Source codepoints: `U+6746`
...
- `obs-evo-cand-003867-route-category-staging`
...
- `obs-evo-cand-003867-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003867-route-evolution-graph`
