...
Project ID: `obs-evo-cand-007073`
...
- Project ID: `obs-evo-cand-007073`
- EVOBC category candidate ID: `evobc-evo-cat-07073`
- External category reference: `evobc-cat-07073`
- Source category ID: `07073`
- Source label for human review: `脩`
- Source codepoints: `U+8129`
...
- `obs-evo-cand-007073-route-category-staging`
...
- `obs-evo-cand-007073-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007073-route-evolution-graph`
