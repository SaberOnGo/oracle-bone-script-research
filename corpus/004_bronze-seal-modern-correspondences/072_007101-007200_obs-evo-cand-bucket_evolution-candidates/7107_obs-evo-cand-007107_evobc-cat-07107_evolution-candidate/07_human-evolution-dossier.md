...
- External category reference: `evobc-cat-07107`
- Source category ID: `07107`
- Source label for human review: `腱`
...
- `obs-evo-cand-007107-route-category-staging`
...
- `obs-evo-cand-007107-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007107-route-evolution-graph`
