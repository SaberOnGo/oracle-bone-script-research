...
Project ID: `obs-evo-cand-009597`
...
- Project ID: `obs-evo-cand-009597`
- EVOBC category candidate ID: `evobc-evo-cat-09597`
- External category reference: `evobc-cat-09597`
- Source category ID: `09597`
- Source label for human review: `锥`
- Source codepoints: `U+9525`
...
- `obs-evo-cand-009597-route-category-staging`
...
- `obs-evo-cand-009597-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009597-route-evolution-graph`
