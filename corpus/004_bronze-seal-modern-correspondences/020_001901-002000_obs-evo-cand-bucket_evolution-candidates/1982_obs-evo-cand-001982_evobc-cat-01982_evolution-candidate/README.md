# obs-evo-cand-001982 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-001982`
- EVOBC category candidate ID: `evobc-evo-cat-01982`
- External category ref: `evobc-cat-01982`
- Source label: `壽`
- Source codepoints: `U+58FD`
- Image reference count: `304`
- Era token counts: `BI:191;CS:1;SAC:58;SS:2;WSC:52`
- Source token counts: `Book:229;Web:75`

## Observed Code Rows / 观察到的代码行

- era 1 / BI: 191 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 58 image references
- era 4 / WSC: 52 image references
- era 5 / CS: 1 image references
- source 1 / Web:105952;說文Web:58: 75 image references
- source 3 / Book:21681: 133 image references
- source 4 / Book:9131: 58 image references
