...
- External category reference: `evobc-cat-03804`
- Source category ID: `03804`
- Source label for human review: `曡`
...
- `obs-evo-cand-003804-route-category-staging`
...
- `obs-evo-cand-003804-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003804-route-evolution-graph`
