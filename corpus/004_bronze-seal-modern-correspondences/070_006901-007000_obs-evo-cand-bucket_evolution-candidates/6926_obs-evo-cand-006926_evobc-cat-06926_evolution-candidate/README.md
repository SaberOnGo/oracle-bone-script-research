# obs-evo-cand-006926 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-06926`
- Source label for human review: `耤`
- Source codepoints: `U+8024`
- Image reference count: `167`
- Era token counts: `BI:10;OBC:151;SS:1;WSC:5`
- Source token counts: `Book:51;Web:116`

## Observed Code Rows / 观察到的代码行

- era `0`
  token: `OBC`
  image references: 151
- era `1`
  token: `BI`
  image references: 10
- era `2`
