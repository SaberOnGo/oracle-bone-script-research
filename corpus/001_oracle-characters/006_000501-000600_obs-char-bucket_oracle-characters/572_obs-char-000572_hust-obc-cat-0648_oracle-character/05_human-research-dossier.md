# obs-char-000572 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/572_obs-char-000572_hust-obc-cat-0648_orac
  le-character/03_visual-assets/001_asset-000577_hust-obc-cat-0648_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0648/G_0648_中大189.png`
- asset id: `asset-000577`
...
- source category: `0648`
- validation class: `571`
- source image route: `HUST-OBC/deciphered/0648/G_0648_中大189.png`
- asset id: `asset-000577`
...
- English observation: `An irregular pointed outer loop contains a small
  inner oval mark, while two short nearly parallel strokes project from the
  upper right.`
- 中文观察: `不规则尖形外环内有一处小椭圆痕，右上伸出两条近乎平行的短笔。`
...
- dataset label text: `㙾`
- dataset label codepoints: `U+367E`
...
- Which source records identify obs-char-000572 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000572？
