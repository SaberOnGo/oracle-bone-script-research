...
- External category reference: `evobc-cat-00429`
- Source category ID: `00429`
- Source label for human review: `䛠`
- Source codepoints: `U+46E0`
...
- `obs-evo-cand-000429-route-category-staging`
...
- `obs-evo-cand-000429-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000429-route-evolution-graph`
