...
Project ID: `obs-evo-cand-005411`
...
- Project ID: `obs-evo-cand-005411`
- EVOBC category candidate ID: `evobc-evo-cat-05411`
- External category reference: `evobc-cat-05411`
- Source category ID: `05411`
- Source label for human review: `琤`
- Source codepoints: `U+7424`
...
- `obs-evo-cand-005411-route-category-staging`
...
- `obs-evo-cand-005411-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005411-route-evolution-graph`
