...
Project ID: `obs-evo-cand-008495`
...
- Project ID: `obs-evo-cand-008495`
- EVOBC category candidate ID: `evobc-evo-cat-08495`
- External category reference: `evobc-cat-08495`
- Source category ID: `08495`
- Source label for human review: `豦`
- Source codepoints: `U+8C66`
...
- `obs-evo-cand-008495-route-category-staging`
...
- `obs-evo-cand-008495-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008495-route-evolution-graph`
