# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001703
...
| Glyph or codepoint route / 字形或码位路线 | 4 OBIMD route rows; examples U+C9B5F;U+F9DBE; U+F9DBF; 另有 2 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
