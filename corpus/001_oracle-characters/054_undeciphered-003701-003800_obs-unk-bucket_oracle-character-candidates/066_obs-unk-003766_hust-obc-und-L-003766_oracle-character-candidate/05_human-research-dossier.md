# obs-unk-003766 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/054_undeciphered-003
  701-003800_obs-unk-bucket_oracle-character-candidates/066_obs-unk-003766_h
  ust-obc-und-L-003766_oracle-character-candidate/03_visual-assets/001_asset
  -005359_hust-obc-und-L-003766_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3766/L_？_7762.jpg`
- asset id: `asset-005359`
...
- source class: `HUST-OBC/undeciphered/L/3766/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3766/L_？_7762.jpg`
- asset id: `asset-005359`
...
- Which source records identify obs-unk-003766 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003766？
