...
Project ID: `obs-evo-cand-011479`
...
- Project ID: `obs-evo-cand-011479`
- EVOBC category candidate ID: `evobc-evo-cat-11479`
- External category reference: `evobc-cat-11479`
- Source category ID: `11479`
- Source label for human review: `𣦹`
- Source codepoints: `U+239B9`
- Image reference count in source metadata: `81`
...
- `obs-evo-cand-011479-route-category-staging`
...
- `obs-evo-cand-011479-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011479-route-evolution-graph`
