# obs-char-001314 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001314`
- primary external id: `hust-obc-cat-1469`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1314_obs-char-001314_hust-obc-cat-1469_ora
  cle-character/03_visual-assets/001_asset-001319_hust-obc-cat-1469_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1469/L_1469_6860.jpg`
- asset id: `asset-001319`
...
- source category: `1469`
- validation class: `1313`
- source image route: `HUST-OBC/deciphered/1469/L_1469_6860.jpg`
- asset id: `asset-001319`
...
- English observation: `A small faint form has a rounded upper bar, a thin
  central stem, and a pointed lower loop.`
- 中文观察: `小型较淡形体有圆拱上横部、细中央笔干和尖状下部环形。`
...
- dataset label text: `㦳`
- dataset label codepoints: `U+39B3`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00138`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00138`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00138`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/138_obs-evo-can
  d-000138_evobc-cat-00138_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/138_obs-evo-cand-000138_evobc-cat-00138_evolu
...
- Which source records identify obs-char-001314 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001314？
