# obs-char-001296 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001296`
- primary external id: `hust-obc-cat-1449`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1296_obs-char-001296_hust-obc-cat-1449_ora
  cle-character/03_visual-assets/001_asset-001301_hust-obc-cat-1449_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1449/G_1449_乙162合19801𠂤組.png`
- asset id: `asset-001301`
...
- source category: `1449`
- validation class: `1295`
- source image route: `HUST-OBC/deciphered/1449/G_1449_乙162合19801𠂤組.png`
- asset id: `asset-001301`
...
- English observation: `A large peaked form has a segmented upper contour, a
  central vertical, and several rounded lower branches.`
- 中文观察: `大型尖顶形体有分段上部轮廓、中央竖笔和数条圆拱下部分枝。`
...
- dataset label text: `㦟`
- dataset label codepoints: `U+399F`
...
- filename catalog route clues: `Heji-like filename clue: 合19801
  (G_1449_乙162合19801𠂤組.png)`
...
- Which source records identify obs-char-001296 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001296？
