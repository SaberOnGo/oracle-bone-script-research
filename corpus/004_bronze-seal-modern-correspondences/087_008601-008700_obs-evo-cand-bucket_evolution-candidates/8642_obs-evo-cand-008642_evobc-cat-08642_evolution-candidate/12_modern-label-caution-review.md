# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008642
...
- EVOBC candidate category: `evobc-evo-cat-08642`.
- Source label for search only: `赏`.
- Source codepoints for search only: `U+8D4F`.
