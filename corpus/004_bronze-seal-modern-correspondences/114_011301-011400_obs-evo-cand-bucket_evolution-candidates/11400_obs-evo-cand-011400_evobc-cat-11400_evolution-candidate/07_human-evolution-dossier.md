...
- External category reference: `evobc-cat-11400`
- Source category ID: `11400`
- Source label for human review: `𣆑`
- Source codepoints: `U+23191`
- Image reference count in source metadata: `40`
...
- `obs-evo-cand-011400-route-category-staging`
...
- `obs-evo-cand-011400-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011400-route-evolution-graph`
