...
- External category reference: `evobc-cat-04119`
- Source category ID: `04119`
- Source label for human review: `椋`
- Source codepoints: `U+690B`
...
- `obs-evo-cand-004119-route-category-staging`
...
- `obs-evo-cand-004119-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004119-route-evolution-graph`
