# obs-char-000260 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000260`
- primary external id: `hust-obc-cat-0292`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/260_obs-char-000260_hust-obc-cat-0292_orac
  le-character/03_visual-assets/001_asset-000265_hust-obc-cat-0292_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0292/X_0292_4243_1.png`
- asset id: `asset-000265`
...
- source category: `0292`
- validation class: `259`
- source image route: `HUST-OBC/deciphered/0292/X_0292_4243_1.png`
- asset id: `asset-000265`
...
- English observation: `The large dark image has a thick upper block, two
  long descending strokes, and a heavy irregular terminal at the lower
  right.`
- 中文观察: `大幅深色图像有粗重上部块状形体、两道长下行笔，右下有厚重不规则末端。`
...
- dataset label text: `㔚`
- dataset label codepoints: `U+351A`
...
- Which source records identify obs-char-000260 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000260？
