# obs-char-000409 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000409`
- primary external id: `hust-obc-cat-0465`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/409_obs-char-000409_hust-obc-cat-0465_orac
  le-character/03_visual-assets/001_asset-000414_hust-obc-cat-0465_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0465/X_0465_5592_1.png`
- asset id: `asset-000414`
...
- source category: `0465`
- validation class: `408`
- source image route: `HUST-OBC/deciphered/0465/X_0465_5592_1.png`
- asset id: `asset-000414`
...
- English observation: `Two dark separated forms are visible: a divided oval
  with a hooked lower stroke at left and a forked branching stem at right.`
- 中文观察: `可见两个深色分离形体：左侧为带下钩的分隔椭圆，右侧为分叉分支主干。`
...
- dataset label text: `㗇`
- dataset label codepoints: `U+35C7`
...
- Which source records identify obs-char-000409 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000409？
