...
Project ID: `obs-evo-cand-005507`
...
- Project ID: `obs-evo-cand-005507`
- EVOBC category candidate ID: `evobc-evo-cat-05507`
- External category reference: `evobc-cat-05507`
- Source category ID: `05507`
- Source label for human review: `瓦`
- Source codepoints: `U+74E6`
...
- `obs-evo-cand-005507-route-category-staging`
...
- `obs-evo-cand-005507-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005507-route-evolution-graph`
