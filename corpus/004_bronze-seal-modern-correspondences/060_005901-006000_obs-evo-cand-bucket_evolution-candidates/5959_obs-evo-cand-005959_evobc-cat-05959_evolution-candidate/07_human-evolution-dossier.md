...
Project ID: `obs-evo-cand-005959`
...
- Project ID: `obs-evo-cand-005959`
- EVOBC category candidate ID: `evobc-evo-cat-05959`
- External category reference: `evobc-cat-05959`
- Source category ID: `05959`
- Source label for human review: `礦`
- Source codepoints: `U+7926`
...
- `obs-evo-cand-005959-route-category-staging`
...
- `obs-evo-cand-005959-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005959-route-evolution-graph`
