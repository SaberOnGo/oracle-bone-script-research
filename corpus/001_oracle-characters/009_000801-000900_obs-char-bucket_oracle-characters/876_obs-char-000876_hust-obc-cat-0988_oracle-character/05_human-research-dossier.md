# obs-char-000876 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000876`
- primary external id: `hust-obc-cat-0988`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/876_obs-char-000876_hust-obc-cat-0988_orac
  le-character/03_visual-assets/001_asset-000881_hust-obc-cat-0988_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0988/L_0988_1024.jpg`
- asset id: `asset-000881`
...
- source category: `0988`
- validation class: `875`
- source image route: `HUST-OBC/deciphered/0988/L_0988_1024.jpg`
- asset id: `asset-000881`
...
- English observation: `The tiny gray image shows two separated thick
  slightly curved vertical strokes; internal detail is not available at this
  resolution.`
- 中文观察: `微小灰度图像显示两条分离的粗重略弯竖笔；当前分辨率下无法辨认内部细节。`
...
- dataset label text: `㟒`
- dataset label codepoints: `U+37D2`
...
- Which source records identify obs-char-000876 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000876？
