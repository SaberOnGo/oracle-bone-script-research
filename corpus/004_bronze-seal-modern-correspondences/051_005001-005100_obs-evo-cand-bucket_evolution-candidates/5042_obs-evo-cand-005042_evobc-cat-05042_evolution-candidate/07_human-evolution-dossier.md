...
- External category reference: `evobc-cat-05042`
- Source category ID: `05042`
- Source label for human review: `炒`
...
- `obs-evo-cand-005042-route-category-staging`
...
- `obs-evo-cand-005042-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005042-route-evolution-graph`
