# Material Visual Observation / obs-comp-cand-000412 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000412`
- External reference / 外部参照: `obimd-sub-91wuvmq6ju`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012335_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/91wuvmq6ju/91wuvmq6ju/91wuvmq6ju.png`
- Checksum / 校验和:
  `185dcd2e907053030c2a814655804c0d1d7b77e8f45c8fd48160559ca15db224`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.70%.
- Marked-pixel bounds: (53,42)–(196,216); span 144 × 175 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.70%。
- 痕迹范围：(53,42)–(196,216)；跨度144 × 175 px；痕迹矩形高于宽。
