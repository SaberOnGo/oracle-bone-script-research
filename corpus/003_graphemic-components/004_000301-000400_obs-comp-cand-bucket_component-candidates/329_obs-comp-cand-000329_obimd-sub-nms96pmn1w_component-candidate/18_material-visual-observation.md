# Material Visual Observation / obs-comp-cand-000329 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000329`
- External reference / 外部参照: `obimd-sub-nms96pmn1w`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012254_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/nms96pmn1w/nms96pmn1w/nms96pmn1w.png`
- Checksum / 校验和:
  `70ec6c0305dc01b07be17de6a12a09d4475cfc97d3fa2a3f2f8fa88ff42f245f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.81%.
- Marked-pixel bounds: (66,53)–(183,196); span 118 × 144 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.81%。
- 痕迹范围：(66,53)–(183,196)；跨度118 × 144 px；痕迹矩形高于宽。
