...
- `obs-evo-cand-000501-route-category-staging`
...
- `obs-evo-cand-000501-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000501-route-evolution-graph`
