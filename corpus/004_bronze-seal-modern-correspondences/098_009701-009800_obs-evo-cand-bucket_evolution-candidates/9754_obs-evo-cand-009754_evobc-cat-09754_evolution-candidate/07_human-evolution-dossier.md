...
- External category reference: `evobc-cat-09754`
- Source category ID: `09754`
...
- `obs-evo-cand-009754-route-category-staging`
...
- `obs-evo-cand-009754-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009754-route-evolution-graph`
