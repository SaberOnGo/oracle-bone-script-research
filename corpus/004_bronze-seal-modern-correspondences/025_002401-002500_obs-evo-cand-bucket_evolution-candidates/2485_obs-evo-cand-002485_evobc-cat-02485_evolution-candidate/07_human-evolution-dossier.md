...
Project ID: `obs-evo-cand-002485`
...
- Project ID: `obs-evo-cand-002485`
- EVOBC category candidate ID: `evobc-evo-cat-02485`
- External category reference: `evobc-cat-02485`
- Source category ID: `02485`
- Source label for human review: `尲`
- Source codepoints: `U+5C32`
...
- `obs-evo-cand-002485-route-category-staging`
...
- `obs-evo-cand-002485-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002485-route-evolution-graph`
