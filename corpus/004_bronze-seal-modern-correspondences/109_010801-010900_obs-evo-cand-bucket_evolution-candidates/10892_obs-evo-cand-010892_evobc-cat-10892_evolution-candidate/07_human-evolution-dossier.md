...
- External category reference: `evobc-cat-10892`
- Source category ID: `10892`
- Source label for human review: `𠨋`
- Source codepoints: `U+20A0B`
...
- `obs-evo-cand-010892-route-category-staging`
...
- `obs-evo-cand-010892-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010892-route-evolution-graph`
