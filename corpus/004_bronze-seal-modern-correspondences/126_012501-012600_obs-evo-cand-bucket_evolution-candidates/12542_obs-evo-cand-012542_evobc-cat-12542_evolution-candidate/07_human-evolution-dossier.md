...
Project ID: `obs-evo-cand-012542`
...
- Project ID: `obs-evo-cand-012542`
- EVOBC category candidate ID: `evobc-evo-cat-12542`
- External category reference: `evobc-cat-12542`
- Source category ID: `12542`
- Source label for human review: `𨿳`
- Source codepoints: `U+28FF3`
- Image reference count in source metadata: `20`
...
- `obs-evo-cand-012542-route-category-staging`
...
- `obs-evo-cand-012542-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012542-route-evolution-graph`
