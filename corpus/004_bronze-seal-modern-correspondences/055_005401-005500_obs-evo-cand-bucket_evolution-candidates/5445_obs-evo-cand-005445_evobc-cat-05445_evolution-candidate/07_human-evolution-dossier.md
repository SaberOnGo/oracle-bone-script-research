...
- External category reference: `evobc-cat-05445`
- Source category ID: `05445`
- Source label for human review: `瑣`
...
- `obs-evo-cand-005445-route-category-staging`
...
- `obs-evo-cand-005445-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005445-route-evolution-graph`
