...
- External category reference: `evobc-cat-06476`
- Source category ID: `06476`
- Source label for human review: `細`
- Source codepoints: `U+7D30`
...
- `obs-evo-cand-006476-route-category-staging`
...
- `obs-evo-cand-006476-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006476-route-evolution-graph`
