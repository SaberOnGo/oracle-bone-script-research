...
Project ID: `obs-evo-cand-002331`
...
- Project ID: `obs-evo-cand-002331`
- EVOBC category candidate ID: `evobc-evo-cat-02331`
- External category reference: `evobc-cat-02331`
- Source category ID: `02331`
- Source label for human review: `存`
- Source codepoints: `U+5B58`
...
- `obs-evo-cand-002331-route-category-staging`
...
- `obs-evo-cand-002331-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002331-route-evolution-graph`
