...
- External category reference: `evobc-cat-04397`
- Source category ID: `04397`
- Source label for human review: `歷`
- Source codepoints: `U+6B77`
- Image reference count in source metadata: `55`
...
- `obs-evo-cand-004397-route-category-staging`
...
- `obs-evo-cand-004397-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004397-route-evolution-graph`
