...
Project ID: `obs-evo-cand-002415`
...
- Project ID: `obs-evo-cand-002415`
- EVOBC category candidate ID: `evobc-evo-cat-02415`
- External category reference: `evobc-cat-02415`
- Source category ID: `02415`
- Source label for human review: `寍`
- Source codepoints: `U+5BCD`
...
- `obs-evo-cand-002415-route-category-staging`
...
- `obs-evo-cand-002415-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002415-route-evolution-graph`
