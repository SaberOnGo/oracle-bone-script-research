...
- External category reference: `evobc-cat-07173`
- Source category ID: `07173`
- Source label for human review: `臸`
- Source codepoints: `U+81F8`
...
- `obs-evo-cand-007173-route-category-staging`
...
- `obs-evo-cand-007173-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007173-route-evolution-graph`
