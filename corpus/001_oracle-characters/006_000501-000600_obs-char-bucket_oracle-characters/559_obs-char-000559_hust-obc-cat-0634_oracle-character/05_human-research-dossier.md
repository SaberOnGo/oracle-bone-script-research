# obs-char-000559 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000559`
- primary external id: `hust-obc-cat-0634`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/559_obs-char-000559_hust-obc-cat-0634_orac
  le-character/03_visual-assets/001_asset-000564_hust-obc-cat-0634_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0634/G_0634_京津3876合28421何組.png`
- asset id: `asset-000564`
...
- source category: `0634`
- validation class: `558`
- source image route: `HUST-OBC/deciphered/0634/G_0634_京津3876合28421何組.png`
- asset id: `asset-000564`
...
- English observation: `A slender vertical form has a crossed double loop at
  the top, alternating angular side branches through the middle, and a small
  fork at the lower end.`
- 中文观察: `狭长竖形顶部为交叉双环，中部两侧交替伸出折角枝笔，下端形成小叉。`
...
- dataset label text: `㙰`
- dataset label codepoints: `U+3670`
...
- filename catalog route clues: `Heji-like filename clue: 合28421
...
- Which source records identify obs-char-000559 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000559？
