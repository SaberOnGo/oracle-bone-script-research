# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008804
...
- EVOBC candidate category: `evobc-evo-cat-08804`.
- Source label for search only: `軝`.
- Source codepoints for search only: `U+8EDD`.
