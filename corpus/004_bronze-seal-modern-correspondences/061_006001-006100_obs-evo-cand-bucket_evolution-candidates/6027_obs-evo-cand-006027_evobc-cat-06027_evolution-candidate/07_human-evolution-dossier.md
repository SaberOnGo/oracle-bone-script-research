...
- External category reference: `evobc-cat-06027`
- Source category ID: `06027`
- Source label for human review: `禝`
...
- `obs-evo-cand-006027-route-category-staging`
...
- `obs-evo-cand-006027-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006027-route-evolution-graph`
