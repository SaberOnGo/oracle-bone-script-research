...
- External category reference: `evobc-cat-08142`
- Source category ID: `08142`
- Source label for human review: `訝`
...
- `obs-evo-cand-008142-route-category-staging`
...
- `obs-evo-cand-008142-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008142-route-evolution-graph`
