# obs-char-000676 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/676_obs-char-000676_hust-obc-cat-0767_orac
  le-character/03_visual-assets/001_asset-000681_hust-obc-cat-0767_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0767/G_0767_京津3322.png`
- asset id: `asset-000681`
...
- source category: `0767`
- validation class: `675`
- source image route: `HUST-OBC/deciphered/0767/G_0767_京津3322.png`
- asset id: `asset-000681`
...
- English observation: `A long rising diagonal crosses a tall right-hand
  upright near its top, while three thin vertical or slanting strokes hang
  separately beneath the diagonal.`
...
- dataset label text: `㛵`
- dataset label codepoints: `U+36F5`
...
- Which source records identify obs-char-000676 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000676？
