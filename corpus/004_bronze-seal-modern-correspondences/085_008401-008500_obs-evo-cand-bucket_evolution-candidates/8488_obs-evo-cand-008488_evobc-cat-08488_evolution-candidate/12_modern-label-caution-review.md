# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008488
...
- EVOBC candidate category: `evobc-evo-cat-08488`.
- Source label for search only: `豛`.
- Source codepoints for search only: `U+8C5B`.
