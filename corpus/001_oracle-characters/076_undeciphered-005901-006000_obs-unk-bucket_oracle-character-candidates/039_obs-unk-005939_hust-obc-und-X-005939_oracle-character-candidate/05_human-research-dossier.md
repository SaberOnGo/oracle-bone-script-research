# obs-unk-005939 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005939`
- primary external id: `hust-obc-und-X-005939`
...
- local review image route: `corpus/001_oracle-characters/076_undeciphered-005
  901-006000_obs-unk-bucket_oracle-character-candidates/039_obs-unk-005939_h
  ust-obc-und-X-005939_oracle-character-candidate/03_visual-assets/001_asset
  -007531_hust-obc-und-X-005939_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1495/X_？_2677_1.png`
- asset id: `asset-007531`
...
- source class: `HUST-OBC/undeciphered/X/1495/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1495/X_？_2677_1.png`
- asset id: `asset-007531`
...
- Which source records identify obs-unk-005939 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005939？
