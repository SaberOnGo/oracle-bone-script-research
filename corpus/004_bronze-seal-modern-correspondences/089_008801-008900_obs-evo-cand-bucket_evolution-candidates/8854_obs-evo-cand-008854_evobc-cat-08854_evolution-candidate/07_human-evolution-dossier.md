...
- External category reference: `evobc-cat-08854`
- Source category ID: `08854`
- Source label for human review: `輶`
...
- `obs-evo-cand-008854-route-category-staging`
...
- `obs-evo-cand-008854-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008854-route-evolution-graph`
