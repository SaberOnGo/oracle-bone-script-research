# Material Visual Observation / obs-comp-cand-001623 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001623`
- External reference / 外部参照: `obimd-sub-gv1u69q6hv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017299_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5fsjukjyjt/gv1u69q6hv/gv1u69q6hv.png`
- Checksum / 校验和:
  `e439ac6e23b6686de3099a9ed54977736e420d40f363d6a3e39f708abda2b75c`
...
- Marked-pixel bounds: (74,38)–(171,210); span 98 × 173 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.94%。
- 痕迹范围：(74,38)–(171,210)；跨度98 × 173 px；痕迹矩形高于宽。
