...
Project ID: `obs-evo-cand-007468`
...
- Project ID: `obs-evo-cand-007468`
- EVOBC category candidate ID: `evobc-evo-cat-07468`
- External category reference: `evobc-cat-07468`
- Source category ID: `07468`
- Source label for human review: `著`
- Source codepoints: `U+8457`
...
- `obs-evo-cand-007468-route-category-staging`
...
- `obs-evo-cand-007468-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007468-route-evolution-graph`
