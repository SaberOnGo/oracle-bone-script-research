...
- External category reference: `evobc-cat-11135`
- Source category ID: `11135`
- Source label: `𢀀`
...
- `obs-evo-cand-011135-route-category-staging`
...
- `obs-evo-cand-011135-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011135-route-evolution-graph`
