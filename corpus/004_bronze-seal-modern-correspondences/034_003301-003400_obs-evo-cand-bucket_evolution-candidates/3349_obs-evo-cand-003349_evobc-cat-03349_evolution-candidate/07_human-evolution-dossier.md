...
Project ID: `obs-evo-cand-003349`
...
- Project ID: `obs-evo-cand-003349`
- EVOBC category candidate ID: `evobc-evo-cat-03349`
- External category reference: `evobc-cat-03349`
- Source category ID: `03349`
- Source label for human review: `挤`
- Source codepoints: `U+6324`
...
- `obs-evo-cand-003349-route-category-staging`
...
- `obs-evo-cand-003349-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003349-route-evolution-graph`
