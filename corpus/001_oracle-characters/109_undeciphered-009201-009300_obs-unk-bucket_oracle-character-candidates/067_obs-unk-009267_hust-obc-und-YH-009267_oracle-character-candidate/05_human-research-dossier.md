# obs-unk-009267 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-009267`
- primary external id: `hust-obc-und-YH-009267`
...
- local review image route: `corpus/001_oracle-characters/109_undeciphered-009
  201-009300_obs-unk-bucket_oracle-character-candidates/067_obs-unk-009267_h
  ust-obc-und-YH-009267_oracle-character-candidate/03_visual-assets/001_asse
  t-010858_hust-obc-und-YH-009267_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/615AB/H_？_615AB_0.png`
- asset id: `asset-010858`
...
- source class: `HUST-OBC/undeciphered/Y+H/615AB/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/615AB/H_？_615AB_0.png`
- asset id: `asset-010858`
...
- Which source records identify obs-unk-009267 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009267？
