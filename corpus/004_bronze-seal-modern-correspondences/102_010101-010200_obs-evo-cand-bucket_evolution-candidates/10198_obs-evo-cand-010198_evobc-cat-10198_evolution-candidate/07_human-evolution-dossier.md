...
Project ID: `obs-evo-cand-010198`
...
- Project ID: `obs-evo-cand-010198`
- EVOBC category candidate ID: `evobc-evo-cat-10198`
- External category reference: `evobc-cat-10198`
- Source category ID: `10198`
- Source label for human review: `駭`
- Source codepoints: `U+99ED`
...
- `obs-evo-cand-010198-route-category-staging`
...
- `obs-evo-cand-010198-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010198-route-evolution-graph`
