...
- External category reference: `evobc-cat-00910`
- Source category ID: `00910`
- Source label for human review: `俺`
...
- `obs-evo-cand-000910-route-category-staging`
...
- `obs-evo-cand-000910-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000910-route-evolution-graph`
