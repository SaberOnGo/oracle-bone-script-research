# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000768
...
- EVOBC candidate category: `evobc-evo-cat-00768`.
- Source label for search only: `伏`.
- Source codepoints for search only: `U+4F0F`.
