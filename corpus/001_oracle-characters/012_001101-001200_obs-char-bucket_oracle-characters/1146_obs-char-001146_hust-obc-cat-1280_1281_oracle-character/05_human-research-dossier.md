# obs-char-001146 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1146_obs-char-001146_hust-obc-cat-1280_128
  1_oracle-character/03_visual-assets/001_asset-001151_hust-obc-cat-1280_128
  1_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1280_1281/1280/G_1280_甲骨文.png`
- asset id: `asset-001151`
...
- source category: `1280_1281`
- validation class: `1145`
- source image route: `HUST-OBC/deciphered/1280_1281/1280/G_1280_甲骨文.png`
- asset id: `asset-001151`
...
- English observation: `A broad curved left contour joins a small enclosed
  loop on the right, with a long descending stroke below.`
- 中文观察: `宽大的左侧弯曲轮廓连接右侧小型闭合环，下面有长下行笔。`
...
- dataset label text: `㣶㣷`
- dataset label codepoints: `U+38F6;U+38F7`
...
- Which source records identify obs-char-001146 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001146？
