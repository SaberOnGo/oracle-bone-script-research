# obs-unk-003430 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003430`
- primary external id: `hust-obc-und-L-003430`
...
- local review image route: `corpus/001_oracle-characters/051_undeciphered-003
  401-003500_obs-unk-bucket_oracle-character-candidates/030_obs-unk-003430_h
  ust-obc-und-L-003430_oracle-character-candidate/03_visual-assets/001_asset
  -005023_hust-obc-und-L-003430_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3430/L_？_6571.jpg`
- asset id: `asset-005023`
...
- source class: `HUST-OBC/undeciphered/L/3430/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3430/L_？_6571.jpg`
- asset id: `asset-005023`
...
- Which source records identify obs-unk-003430 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003430？
