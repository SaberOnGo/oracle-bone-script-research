# obs-char-000724 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/724_obs-char-000724_hust-obc-cat-0822_orac
  le-character/03_visual-assets/001_asset-000729_hust-obc-cat-0822_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0822/G_0822_京都2141(甲).png`
- asset id: `asset-000729`
...
- source category: `0822`
- validation class: `723`
- source image route: `HUST-OBC/deciphered/0822/G_0822_京都2141(甲).png`
- asset id: `asset-000729`
...
- English observation: `Two detached pointed curved forms occupy the upper
  row; below them, bent strokes gather around a small angular opening and
  extend into a hooked base.`
- 中文观察: `上排有两个分离的尖弯形；其下折笔围绕一个小折角空隙聚合，并延伸为钩曲底部。`
...
- dataset label text: `㜬`
- dataset label codepoints: `U+372C`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/061_obs-evo-can
  d-000061_evobc-cat-00061_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/061_obs-evo-cand-000061_evobc-cat-00061_evolu
...
- Which source records identify obs-char-000724 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000724？
