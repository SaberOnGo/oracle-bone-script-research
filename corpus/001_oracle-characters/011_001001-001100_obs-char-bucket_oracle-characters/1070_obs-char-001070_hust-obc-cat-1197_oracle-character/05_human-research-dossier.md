# obs-char-001070 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1070_obs-char-001070_hust-obc-cat-1197_ora
  cle-character/03_visual-assets/001_asset-001075_hust-obc-cat-1197_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1197/G_1197_後2.7.2(甲).png`
- asset id: `asset-001075`
...
- source category: `1197`
- validation class: `1069`
- source image route: `HUST-OBC/deciphered/1197/G_1197_後2.7.2(甲).png`
- asset id: `asset-001075`
...
- English observation: `Two pointed branching clusters sit above a
  rectangular lower enclosure divided into four visible cells.`
...
- dataset label text: `㢣`
- dataset label codepoints: `U+38A3`
...
- Which source records identify obs-char-001070 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001070？
