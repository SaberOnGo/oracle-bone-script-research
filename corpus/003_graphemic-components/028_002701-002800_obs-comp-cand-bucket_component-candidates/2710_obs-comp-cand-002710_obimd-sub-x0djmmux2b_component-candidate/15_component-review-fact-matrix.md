# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002710
...
| Glyph or codepoint route / 字形或码位路线 | 11 OBIMD route rows; examples U+FF4A5; U+FF4A6; 另有 9 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
