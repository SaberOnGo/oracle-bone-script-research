...
- `obs-evo-cand-001963-route-category-staging`
...
- `obs-evo-cand-001963-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001963-route-evolution-graph`
