...
- `obs-evo-cand-008405-route-category-staging`
...
- `obs-evo-cand-008405-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008405-route-evolution-graph`
