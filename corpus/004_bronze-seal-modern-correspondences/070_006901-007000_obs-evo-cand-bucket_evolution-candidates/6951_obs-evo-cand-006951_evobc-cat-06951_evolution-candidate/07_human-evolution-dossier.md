...
Project ID: `obs-evo-cand-006951`
...
- Project ID: `obs-evo-cand-006951`
- EVOBC category candidate ID: `evobc-evo-cat-06951`
- External category reference: `evobc-cat-06951`
- Source category ID: `06951`
- Source label for human review: `聝`
- Source codepoints: `U+805D`
- Image reference count in source metadata: `45`
...
- `obs-evo-cand-006951-route-category-staging`
...
- `obs-evo-cand-006951-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006951-route-evolution-graph`
