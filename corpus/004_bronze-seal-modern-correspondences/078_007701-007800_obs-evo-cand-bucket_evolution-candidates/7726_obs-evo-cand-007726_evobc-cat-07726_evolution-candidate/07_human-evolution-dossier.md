...
- External category reference: `evobc-cat-07726`
- Source category ID: `07726`
- Source label for human review: `蚍`
- Source codepoints: `U+868D`
...
- `obs-evo-cand-007726-route-category-staging`
...
- `obs-evo-cand-007726-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007726-route-evolution-graph`
