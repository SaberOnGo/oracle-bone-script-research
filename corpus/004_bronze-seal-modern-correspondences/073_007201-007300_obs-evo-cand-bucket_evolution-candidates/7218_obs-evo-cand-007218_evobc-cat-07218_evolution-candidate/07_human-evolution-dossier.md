...
- External category reference: `evobc-cat-07218`
- Source category ID: `07218`
- Source label for human review: `艳`
- Source codepoints: `U+8273`
...
- `obs-evo-cand-007218-route-category-staging`
...
- `obs-evo-cand-007218-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007218-route-evolution-graph`
