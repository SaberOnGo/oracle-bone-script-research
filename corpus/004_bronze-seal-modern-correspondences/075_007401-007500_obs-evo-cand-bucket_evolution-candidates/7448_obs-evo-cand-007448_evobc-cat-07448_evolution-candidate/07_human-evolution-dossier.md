...
Project ID: `obs-evo-cand-007448`
...
- Project ID: `obs-evo-cand-007448`
- EVOBC category candidate ID: `evobc-evo-cat-07448`
- External category reference: `evobc-cat-07448`
- Source category ID: `07448`
- Source label for human review: `营`
- Source codepoints: `U+8425`
...
- `obs-evo-cand-007448-route-category-staging`
...
- `obs-evo-cand-007448-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007448-route-evolution-graph`
