# Material Visual Observation / obs-comp-cand-000921 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000921`
- External reference / 外部参照: `obimd-sub-besab3nl4a`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014004_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/x4mvyzj0ob/besab3nl4a/besab3nl4a.png`
- Checksum / 校验和:
  `736399a0d063a5d622207ea60e589d90691b468859bd43f29159770b9934e289`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.49%.
- Marked-pixel bounds: (94,26)–(154,225); span 61 × 200 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.49%。
- 痕迹范围：(94,26)–(154,225)；跨度61 × 200 px；痕迹矩形高于宽。
