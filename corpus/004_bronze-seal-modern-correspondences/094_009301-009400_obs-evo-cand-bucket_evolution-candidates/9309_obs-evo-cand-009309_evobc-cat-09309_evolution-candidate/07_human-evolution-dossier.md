...
Project ID: `obs-evo-cand-009309`
...
- Project ID: `obs-evo-cand-009309`
- EVOBC category candidate ID: `evobc-evo-cat-09309`
- External category reference: `evobc-cat-09309`
- Source category ID: `09309`
- Source label for human review: `釣`
- Source codepoints: `U+91E3`
...
- `obs-evo-cand-009309-route-category-staging`
...
- `obs-evo-cand-009309-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009309-route-evolution-graph`
