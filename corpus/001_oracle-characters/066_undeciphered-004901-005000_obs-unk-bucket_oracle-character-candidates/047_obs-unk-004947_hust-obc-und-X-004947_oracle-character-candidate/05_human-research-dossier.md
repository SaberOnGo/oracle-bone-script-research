# obs-unk-004947 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/047_obs-unk-004947_h
  ust-obc-und-X-004947_oracle-character-candidate/03_visual-assets/001_asset
  -006540_hust-obc-und-X-004947_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/503/X_？_7486_1.png`
- asset id: `asset-006540`
...
- A large arch encloses a light opening and a short inner branch.
- The single source view is present locally.
- 直接记录：`14_material-visual-observation.md`
- 大弧形外轮廓包围浅色开口，并带一条短内部分枝。
- 单一来源视图已在本地保存。
...
- source class: `HUST-OBC/undeciphered/X/503/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/503/X_？_7486_1.png`
- asset id: `asset-006540`
...
- Which source records identify obs-unk-004947 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004947？
