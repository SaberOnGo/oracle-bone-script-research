# obs-char-000432 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000432`
- primary external id: `hust-obc-cat-0492`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/432_obs-char-000432_hust-obc-cat-0492_orac
  le-character/03_visual-assets/001_asset-000437_hust-obc-cat-0492_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0492/G_0492_甲骨文0.png`
- asset id: `asset-000437`
...
- source category: `0492`
- validation class: `431`
- source image route: `HUST-OBC/deciphered/0492/G_0492_甲骨文0.png`
- asset id: `asset-000437`
...
- English observation: `A broad curved stroke crosses a central angular
  cluster; a separate hooked or bent extension descends toward the lower
  left.`
- 中文观察: `宽弧笔画穿过中央折角笔画群，另有钩曲或弯折延伸向左下方下垂。`
...
- dataset label text: `㗢`
- dataset label codepoints: `U+35E2`
...
- Which source records identify obs-char-000432 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000432？
