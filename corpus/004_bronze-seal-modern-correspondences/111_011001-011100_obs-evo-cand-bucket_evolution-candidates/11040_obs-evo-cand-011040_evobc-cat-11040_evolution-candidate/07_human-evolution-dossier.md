...
Project ID: `obs-evo-cand-011040`
...
- Project ID: `obs-evo-cand-011040`
- EVOBC category candidate ID: `evobc-evo-cat-11040`
- External category reference: `evobc-cat-11040`
- Source category ID: `11040`
- Source label for human review: `𡝫`
- Source codepoints: `U+2176B`
...
- `obs-evo-cand-011040-route-category-staging`
...
- `obs-evo-cand-011040-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011040-route-evolution-graph`
