# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000733
...
| --- | --- | --- | --- |
| `obimd-glyph-link-010654` | 󴋧 | `U+F42E7` | `reviewed_metadata_only` |
| `obimd-glyph-link-010655` | 󴋨 | `U+F42E8` | `reviewed_metadata_only` |
