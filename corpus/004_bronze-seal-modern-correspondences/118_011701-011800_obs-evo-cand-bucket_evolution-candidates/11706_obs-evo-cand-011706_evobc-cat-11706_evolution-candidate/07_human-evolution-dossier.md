...
- External category reference: `evobc-cat-11706`
- Source category ID: `11706`
- Source label for human review: `𤷗`
...
- `obs-evo-cand-011706-route-category-staging`
...
- `obs-evo-cand-011706-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011706-route-evolution-graph`
