...
Project ID: `obs-evo-cand-010265`
...
- Project ID: `obs-evo-cand-010265`
- EVOBC category candidate ID: `evobc-evo-cat-10265`
- External category reference: `evobc-cat-10265`
- Source category ID: `10265`
- Source label for human review: `驧`
- Source codepoints: `U+9A67`
...
- `obs-evo-cand-010265-route-category-staging`
...
- `obs-evo-cand-010265-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010265-route-evolution-graph`
