...
- External category reference: `evobc-cat-07071`
- Source category ID: `07071`
- Source label for human review: `脣`
...
- `obs-evo-cand-007071-route-category-staging`
...
- `obs-evo-cand-007071-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007071-route-evolution-graph`
