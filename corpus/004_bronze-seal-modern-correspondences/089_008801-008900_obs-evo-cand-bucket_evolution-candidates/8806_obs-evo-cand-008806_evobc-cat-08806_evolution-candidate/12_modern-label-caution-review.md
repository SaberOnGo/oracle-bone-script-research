# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008806
...
- EVOBC candidate category: `evobc-evo-cat-08806`.
- Source label for search only: `軟`.
- Source codepoints for search only: `U+8EDF`.
