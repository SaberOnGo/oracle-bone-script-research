# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002343
...
- EVOBC candidate category: `evobc-evo-cat-02343`.
- Source label for search only: `孫`.
- Source codepoints for search only: `U+5B6B`.
