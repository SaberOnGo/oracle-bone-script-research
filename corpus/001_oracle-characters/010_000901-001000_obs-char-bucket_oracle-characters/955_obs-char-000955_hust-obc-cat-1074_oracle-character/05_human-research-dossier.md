# obs-char-000955 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/955_obs-char-000955_hust-obc-cat-1074_orac
  le-character/03_visual-assets/001_asset-000960_hust-obc-cat-1074_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1074/G_1074_甲骨文0.png`
- asset id: `asset-000960`
...
- source category: `1074`
- validation class: `954`
- source image route: `HUST-OBC/deciphered/1074/G_1074_甲骨文0.png`
- asset id: `asset-000960`
...
- English observation: `A central crossbar and upright lead into several
...
- dataset label text: `㠨`
- dataset label codepoints: `U+3828`
...
- Which source records identify obs-char-000955 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000955？
