...
Project ID: `obs-evo-cand-010194`
...
- Project ID: `obs-evo-cand-010194`
- EVOBC category candidate ID: `evobc-evo-cat-10194`
- External category reference: `evobc-cat-10194`
- Source category ID: `10194`
- Source label for human review: `駥`
- Source codepoints: `U+99E5`
...
- `obs-evo-cand-010194-route-category-staging`
...
- `obs-evo-cand-010194-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010194-route-evolution-graph`
