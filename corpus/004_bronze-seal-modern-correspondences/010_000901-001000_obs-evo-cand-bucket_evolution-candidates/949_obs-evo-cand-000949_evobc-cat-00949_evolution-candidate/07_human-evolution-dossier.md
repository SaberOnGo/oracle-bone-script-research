...
- Project ID: `obs-evo-cand-000949`
- EVOBC category candidate ID: `evobc-evo-cat-00949`
- External category reference: `evobc-cat-00949`
- Source category ID: `00949`
- Source label for human review: `偆`
- Source codepoints: `U+5046`
...
- `obs-evo-cand-000949-route-category-staging`
...
- `obs-evo-cand-000949-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000949-route-evolution-graph`
