...
- `obs-evo-cand-004907-route-category-staging`
...
- `obs-evo-cand-004907-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004907-route-evolution-graph`
