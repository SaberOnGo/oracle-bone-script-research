...
- External category reference: `evobc-cat-09898`
- Source category ID: `09898`
- Source label for human review: `靶`
...
- `obs-evo-cand-009898-route-category-staging`
...
- `obs-evo-cand-009898-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009898-route-evolution-graph`
