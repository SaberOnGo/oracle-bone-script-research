# obs-unk-004102 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004102`
- primary external id: `hust-obc-und-L-004102`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/002_obs-unk-004102_h
  ust-obc-und-L-004102_oracle-character-candidate/03_visual-assets/001_asset
  -005695_hust-obc-und-L-004102_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4102/L_？_8822.jpg`
- asset id: `asset-005695`
...
- source class: `HUST-OBC/undeciphered/L/4102/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4102/L_？_8822.jpg`
- asset id: `asset-005695`
...
- Which source records identify obs-unk-004102 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004102？
