# obs-char-001331 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001331`
- primary external id: `hust-obc-cat-1487`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1331_obs-char-001331_hust-obc-cat-1487_ora
  cle-character/03_visual-assets/001_asset-001336_hust-obc-cat-1487_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1487/G_1487_乙2882合5447賓組.png`
- asset id: `asset-001336`
...
- source category: `1487`
- validation class: `1330`
- source image route: `HUST-OBC/deciphered/1487/G_1487_乙2882合5447賓組.png`
- asset id: `asset-001336`
...
- English observation: `A broad upper fork leads into a central curved lower
  body with a pointed enclosed end.`
- 中文观察: `宽大的上部叉形向下连接中央弯曲主体，末端为尖状框内形体。`
...
- dataset label text: `㧅`
- dataset label codepoints: `U+39C5`
...
- filename catalog route clues: `Heji-like filename clue: 合5447
...
- Which source records identify obs-char-001331 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001331？
