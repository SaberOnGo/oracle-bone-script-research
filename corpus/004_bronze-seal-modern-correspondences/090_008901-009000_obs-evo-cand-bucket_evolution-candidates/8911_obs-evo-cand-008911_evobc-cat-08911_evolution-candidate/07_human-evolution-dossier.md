...
- External category reference: `evobc-cat-08911`
- Source category ID: `08911`
- Source label for human review: `辠`
...
- `obs-evo-cand-008911-route-category-staging`
...
- `obs-evo-cand-008911-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008911-route-evolution-graph`
