...
Project ID: `obs-insc-cw-cand-000556`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000556`
...
- Yingguo / 英国所藏: `y2565` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `364` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `583` in source row; primary catalog entry pending
- Heji / 合集: `41777` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000556`
