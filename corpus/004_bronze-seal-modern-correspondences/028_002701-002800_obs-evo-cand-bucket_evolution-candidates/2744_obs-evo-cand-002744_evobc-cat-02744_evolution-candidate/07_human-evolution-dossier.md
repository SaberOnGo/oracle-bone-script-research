...
- External category reference: `evobc-cat-02744`
- Source category ID: `02744`
- Source label for human review: `庾`
- Source codepoints: `U+5EBE`
...
- `obs-evo-cand-002744-route-category-staging`
...
- `obs-evo-cand-002744-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002744-route-evolution-graph`
