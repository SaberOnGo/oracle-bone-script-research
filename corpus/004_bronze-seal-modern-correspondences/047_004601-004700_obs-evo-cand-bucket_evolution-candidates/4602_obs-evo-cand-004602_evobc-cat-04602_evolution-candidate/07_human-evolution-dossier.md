...
- External category reference: `evobc-cat-04602`
- Source category ID: `04602`
- Source label for human review: `泰`
- Source codepoints: `U+6CF0`
...
- `obs-evo-cand-004602-route-category-staging`
...
- `obs-evo-cand-004602-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004602-route-evolution-graph`
