...
Project ID: `obs-insc-cw-cand-000109`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000109`
...
- Yingguo / 英国所藏: `y609` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `138` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `495` in source row; primary catalog entry pending
- Heji / 合集: `39515` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000109`
