...
Project ID: `obs-evo-cand-003292`
...
- Project ID: `obs-evo-cand-003292`
- EVOBC category candidate ID: `evobc-evo-cat-03292`
- External category reference: `evobc-cat-03292`
- Source category ID: `03292`
- Source label for human review: `披`
- Source codepoints: `U+62AB`
...
- `obs-evo-cand-003292-route-category-staging`
...
- `obs-evo-cand-003292-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003292-route-evolution-graph`
