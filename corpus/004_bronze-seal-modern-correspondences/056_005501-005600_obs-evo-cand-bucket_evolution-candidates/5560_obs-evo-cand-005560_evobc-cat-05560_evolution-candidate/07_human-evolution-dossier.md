...
Project ID: `obs-evo-cand-005560`
...
- Project ID: `obs-evo-cand-005560`
- EVOBC category candidate ID: `evobc-evo-cat-05560`
- External category reference: `evobc-cat-05560`
- Source category ID: `05560`
- Source label for human review: `界`
- Source codepoints: `U+754C`
...
- `obs-evo-cand-005560-route-category-staging`
...
- `obs-evo-cand-005560-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005560-route-evolution-graph`
