...
Project ID: `obs-evo-cand-002669`
...
- Project ID: `obs-evo-cand-002669`
- EVOBC category candidate ID: `evobc-evo-cat-02669`
- External category reference: `evobc-cat-02669`
- Source category ID: `02669`
- Source label for human review: `幅`
- Source codepoints: `U+5E45`
...
- `obs-evo-cand-002669-route-category-staging`
...
- `obs-evo-cand-002669-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002669-route-evolution-graph`
