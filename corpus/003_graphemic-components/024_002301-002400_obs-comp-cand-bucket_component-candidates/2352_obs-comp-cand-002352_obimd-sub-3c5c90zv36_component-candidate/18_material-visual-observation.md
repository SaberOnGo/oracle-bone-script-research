# Material Visual Observation / obs-comp-cand-002352 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002352`
- External reference / 外部参照: `obimd-sub-3c5c90zv36`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020423_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3c5c90zv36/3c5c90zv36/3c5c90zv36.png`
- Checksum / 校验和:
  `35c7f34913b39d02155a4bb2be189f365ede84b87b053030d4974d69e7fc8027`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.18%.
- Marked-pixel bounds: (80,12)–(171,234); span 92 × 223 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.18%。
- 痕迹范围：(80,12)–(171,234)；跨度92 × 223 px；痕迹矩形高于宽。
