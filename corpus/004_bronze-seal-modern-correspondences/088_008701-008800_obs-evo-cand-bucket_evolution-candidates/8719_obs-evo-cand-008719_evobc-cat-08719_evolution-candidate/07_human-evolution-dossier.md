...
- External category reference: `evobc-cat-08719`
- Source category ID: `08719`
- Source label for human review: `跨`
...
- `obs-evo-cand-008719-route-category-staging`
...
- `obs-evo-cand-008719-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008719-route-evolution-graph`
