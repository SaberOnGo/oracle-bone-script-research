# Material Visual Observation / obs-comp-cand-000031 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000031`
- External reference / 外部参照: `obimd-sub-8zmubiqmfe`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011284_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ftj0qy2f7b/8zmubiqmfe/8zmubiqmfe.png`
- Checksum / 校验和:
  `1cbbafde9564d46b2522758846fbe293d2cf97da0b4f6e31271e954bece6c8e7`
...
- Marked-pixel bounds: (64,44)–(185,201); span 122 × 158 px; the marked
...
- 痕迹范围：(64,44)–(185,201)；跨度122 × 158 px；痕迹矩形高于宽。
