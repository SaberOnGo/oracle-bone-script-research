# obs-unk-004331 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/031_obs-unk-004331_h
  ust-obc-und-L-004331_oracle-character-candidate/03_visual-assets/001_asset
  -005924_hust-obc-und-L-004331_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4331/L_？_957.jpg`
- asset id: `asset-005924`
...
- source class: `HUST-OBC/undeciphered/L/4331/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4331/L_？_957.jpg`
- asset id: `asset-005924`
...
- English observation: `Left outer curve, middle diagonal, and right mark
  recorded.`
- 中文观察: `已记录左侧外弯痕、中部斜痕和右侧短痕。`
...
- Which source records identify obs-unk-004331 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004331？
