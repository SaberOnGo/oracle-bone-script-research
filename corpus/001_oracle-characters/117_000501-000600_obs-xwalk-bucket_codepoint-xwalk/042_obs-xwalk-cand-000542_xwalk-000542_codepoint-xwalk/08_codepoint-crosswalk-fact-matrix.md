# obs-xwalk-cand-000542 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+365E` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-0616` | not reading |
