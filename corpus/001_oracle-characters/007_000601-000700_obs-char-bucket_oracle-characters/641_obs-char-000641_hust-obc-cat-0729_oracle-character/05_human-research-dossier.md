# obs-char-000641 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000641`
- primary external id: `hust-obc-cat-0729`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/641_obs-char-000641_hust-obc-cat-0729_orac
  le-character/03_visual-assets/001_asset-000646_hust-obc-cat-0729_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0729/G_0729_前6.51.4合4890賓組.png`
- asset id: `asset-000646`
...
- source category: `0729`
- validation class: `640`
- source image route: `HUST-OBC/deciphered/0729/G_0729_前6.51.4合4890賓組.png`
- asset id: `asset-000646`
...
- English observation: `A slender wavering vertical has a small hooked upper
  turn, two crossing branches near the middle, and a narrow open loop along
  its lower descent.`
- 中文观察: `纤细波折竖笔带小型钩曲上折，中部附近有两条交叉枝，下行段形成狭窄开口环。`
...
- dataset label text: `㛏`
- dataset label codepoints: `U+36CF`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00053`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00053`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00053`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/053_obs-evo-can
  d-000053_evobc-cat-00053_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/053_obs-evo-cand-000053_evobc-cat-00053_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合4890
  (G_0729_前6.51.4合4890賓組.png)`
...
- Which source records identify obs-char-000641 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000641？
