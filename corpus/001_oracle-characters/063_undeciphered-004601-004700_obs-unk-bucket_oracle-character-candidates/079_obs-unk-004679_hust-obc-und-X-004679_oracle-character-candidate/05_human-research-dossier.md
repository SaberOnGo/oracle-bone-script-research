# obs-unk-004679 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/079_obs-unk-004679_h
  ust-obc-und-X-004679_oracle-character-candidate/03_visual-assets/001_asset
  -006272_hust-obc-und-X-004679_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/235/X_？_8404_1.png`
- asset id: `asset-006272`
...
- source class: `HUST-OBC/undeciphered/X/235/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/235/X_？_8404_1.png`
- asset id: `asset-006272`
...
- English observation: `curved dark band with central opening and pointed ends`
- 中文观察: `带中央开口和尖端的弯曲深色带`
...
- Which source records identify obs-unk-004679 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004679？
