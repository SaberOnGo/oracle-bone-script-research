...
- External category reference: `evobc-cat-11617`
- Source category ID: `11617`
- Source label for human review: `𤞟`
...
- `obs-evo-cand-011617-route-category-staging`
...
- `obs-evo-cand-011617-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011617-route-evolution-graph`
