# obs-char-000991 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/991_obs-char-000991_hust-obc-cat-1113_orac
  le-character/03_visual-assets/001_asset-000996_hust-obc-cat-1113_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1113/G_1113_佚545(甲).png`
- asset id: `asset-000996`
...
- source category: `1113`
- validation class: `990`
- source image route: `HUST-OBC/deciphered/1113/G_1113_佚545(甲).png`
- asset id: `asset-000996`
...
- English observation: `Two separated upright clusters each contain crossed
  upper branches and pointed lower strokes.`
...
- dataset label text: `㡏`
- dataset label codepoints: `U+384F`
...
- Which source records identify obs-char-000991 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000991？
