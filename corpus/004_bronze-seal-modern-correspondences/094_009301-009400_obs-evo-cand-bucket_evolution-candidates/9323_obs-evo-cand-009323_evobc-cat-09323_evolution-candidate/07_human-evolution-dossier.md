...
Project ID: `obs-evo-cand-009323`
...
- Project ID: `obs-evo-cand-009323`
- EVOBC category candidate ID: `evobc-evo-cat-09323`
- External category reference: `evobc-cat-09323`
- Source category ID: `09323`
- Source label for human review: `釿`
- Source codepoints: `U+91FF`
...
- `obs-evo-cand-009323-route-category-staging`
...
- `obs-evo-cand-009323-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009323-route-evolution-graph`
