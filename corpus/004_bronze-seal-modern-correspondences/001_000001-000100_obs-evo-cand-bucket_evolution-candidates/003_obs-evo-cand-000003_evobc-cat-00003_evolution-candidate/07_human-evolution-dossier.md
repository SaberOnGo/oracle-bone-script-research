...
- Project ID: `obs-evo-cand-000003`
- EVOBC category candidate ID: `evobc-evo-cat-00003`
- External category reference: `evobc-cat-00003`
- Source category ID: `00003`
- Source label for human review: `㐎`
- Source codepoints: `U+340E`
...
- `obs-evo-cand-000003-route-category-staging`
...
- `obs-evo-cand-000003-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000003-route-evolution-graph`
