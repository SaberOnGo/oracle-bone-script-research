...
Project ID: `obs-insc-cw-cand-000256`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000256`
...
- Yingguo / 英国所藏: `y1707` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `212` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `591` in source row; primary catalog entry pending
- Heji / 合集: `40483` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000256`
