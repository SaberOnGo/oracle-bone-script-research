...
Project ID: `obs-evo-cand-009694`
...
- Project ID: `obs-evo-cand-009694`
- EVOBC category candidate ID: `evobc-evo-cat-09694`
- External category reference: `evobc-cat-09694`
- Source category ID: `09694`
- Source label for human review: `阢`
- Source codepoints: `U+9622`
...
- `obs-evo-cand-009694-route-category-staging`
...
- `obs-evo-cand-009694-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009694-route-evolution-graph`
