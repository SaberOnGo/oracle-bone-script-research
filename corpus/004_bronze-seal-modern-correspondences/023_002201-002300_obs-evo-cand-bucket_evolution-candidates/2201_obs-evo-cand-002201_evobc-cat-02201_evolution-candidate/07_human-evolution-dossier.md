...
- Project ID: `obs-evo-cand-002201`
- EVOBC category candidate ID: `evobc-evo-cat-02201`
- External category reference: `evobc-cat-02201`
- Source category ID: `02201`
- Source label for human review: `婞`
- Source codepoints: `U+5A5E`
...
- `obs-evo-cand-002201-route-category-staging`
...
- `obs-evo-cand-002201-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002201-route-evolution-graph`
