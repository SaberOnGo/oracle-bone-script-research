# Material Visual Observation / obs-comp-cand-001585 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001585`
- External reference / 外部参照: `obimd-sub-o7ewwuz4l7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017166_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/u878nsmv98/o7ewwuz4l7/o7ewwuz4l7.png`
- Checksum / 校验和:
  `ec7495cab8cb01f96b3eaa3633543bd0255a62c8706d3300b9dfe56ad5cd46cc`
...
- Marked-pixel bounds: (78,21)–(168,230); span 91 × 210 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.18%。
- 痕迹范围：(78,21)–(168,230)；跨度91 × 210 px；痕迹矩形高于宽。
