# obs-unk-005729 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/074_undeciphered-005
  701-005800_obs-unk-bucket_oracle-character-candidates/029_obs-unk-005729_h
  ust-obc-und-X-005729_oracle-character-candidate/03_visual-assets/001_asset
  -007321_hust-obc-und-X-005729_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1285/X_？_1287_1.png`
- asset id: `asset-007321`
...
- source class: `HUST-OBC/undeciphered/X/1285/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1285/X_？_1287_1.png`
- asset id: `asset-007321`
...
- Which source records identify obs-unk-005729 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005729？
