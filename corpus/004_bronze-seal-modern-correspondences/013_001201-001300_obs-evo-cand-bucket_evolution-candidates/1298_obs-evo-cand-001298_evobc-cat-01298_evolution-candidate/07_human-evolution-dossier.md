...
- External category reference: `evobc-cat-01298`
- Source category ID: `01298`
- Source label for human review: `勛`
...
- `obs-evo-cand-001298-route-category-staging`
...
- `obs-evo-cand-001298-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001298-route-evolution-graph`
