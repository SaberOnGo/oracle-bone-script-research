...
- Project ID: `obs-evo-cand-010192`
- EVOBC category candidate ID: `evobc-evo-cat-10192`
- External category reference: `evobc-cat-10192`
- Source category ID: `10192`
- Source label for human review: `駟`
- Source codepoints: `U+99DF`
...
- `obs-evo-cand-010192-route-category-staging`
...
- `obs-evo-cand-010192-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010192-route-evolution-graph`
