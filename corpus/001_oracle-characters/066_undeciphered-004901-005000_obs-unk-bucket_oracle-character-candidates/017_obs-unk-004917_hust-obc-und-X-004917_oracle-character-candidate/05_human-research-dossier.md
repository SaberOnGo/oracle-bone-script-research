# obs-unk-004917 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004917`
- primary external id: `hust-obc-und-X-004917`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/017_obs-unk-004917_h
  ust-obc-und-X-004917_oracle-character-candidate/03_visual-assets/001_asset
  -006510_hust-obc-und-X-004917_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/473/X_？_7457_1.png`
- asset id: `asset-006510`
...
- Several branches radiate from a central junction with lower overlap.
- The source packet expects eight views; one local view is present.
- 直接记录：`14_material-visual-observation.md`
- 多条分枝从中央连接处放射，底部存在重叠结构。
- 来源包记录应有八个视图；当前仅有一个本地图像。
...
- source class: `HUST-OBC/undeciphered/X/473/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/473/X_？_7457_1.png`
- asset id: `asset-006510`
- source image count: `8`
...
- Which source records identify obs-unk-004917 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004917？
