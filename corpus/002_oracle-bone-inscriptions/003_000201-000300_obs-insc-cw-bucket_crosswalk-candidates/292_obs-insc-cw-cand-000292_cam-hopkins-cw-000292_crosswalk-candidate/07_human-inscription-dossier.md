...
Project ID: `obs-insc-cw-cand-000292`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000292`
...
- Yingguo / 英国所藏: `y1923` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `418` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `124` in source row; primary catalog entry pending
- Heji / 合集: `41027` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000292`
