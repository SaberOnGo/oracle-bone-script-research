# obs-char-001312 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1312_obs-char-001312_hust-obc-cat-1467_ora
  cle-character/03_visual-assets/001_asset-001317_hust-obc-cat-1467_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1467/G_1467_後2.14.18(甲).png`
- asset id: `asset-001317`
...
- source category: `1467`
- validation class: `1311`
- source image route: `HUST-OBC/deciphered/1467/G_1467_後2.14.18(甲).png`
- asset id: `asset-001317`
...
- English observation: `Several separated narrow curved strokes form a
  vertical cluster with pointed upper and lower ends.`
- 中文观察: `数条分离的狭长弧笔组成纵向笔画群，上下端多呈尖状。`
...
- dataset label text: `㦱`
- dataset label codepoints: `U+39B1`
...
- Which source records identify obs-char-001312 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001312？
