...
- External category reference: `evobc-cat-12454`
- Source category ID: `12454`
- Source label for human review: `𨞊`
...
- `obs-evo-cand-012454-route-category-staging`
...
- `obs-evo-cand-012454-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012454-route-evolution-graph`
