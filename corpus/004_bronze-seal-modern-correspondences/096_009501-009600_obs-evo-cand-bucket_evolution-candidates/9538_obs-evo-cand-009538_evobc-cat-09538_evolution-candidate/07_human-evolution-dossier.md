...
- External category reference: `evobc-cat-09538`
- Source category ID: `09538`
- Source label for human review: `鐸`
- Source codepoints: `U+9438`
...
- `obs-evo-cand-009538-route-category-staging`
...
- `obs-evo-cand-009538-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009538-route-evolution-graph`
