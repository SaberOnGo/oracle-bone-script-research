# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002744
...
| --- | --- | --- | --- |
| `obimd-glyph-link-041664` | 󿭼 | `U+FFB7C` | `reviewed_metadata_only` |
| `obimd-glyph-link-041665` | 󿟫 | `U+FF7EB` | `reviewed_metadata_only` |
| `obimd-glyph-link-041666` | 󿟬 | `U+FF7EC` | `reviewed_metadata_only` |
