# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001167
...
| Glyph or codepoint route / 字形或码位路线 | 3 OBIMD route rows; examples U+F6B6D; U+F6B6E; 另有 1 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
