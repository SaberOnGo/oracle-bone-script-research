...
- Review log draft ID / 复核日志草稿 ID: `codepoint-crosswalk-review-log-draft-011`
- Codepoint review task ID / codepoint 复核任务 ID: `codepoint-crosswalk-review-011`
...
- Crosswalk candidate ID / 交叉候选 ID: `hust-obimd-evobc-xwalk-000852`
- Suggested oracle character ID / 建议甲骨单字 ID: `obs-char-000852`
- Promotion queue ID / 提升队列 ID: `hust-obc-obs-char-promo-000852`
...
- HUST external ref / HUST 外部引用: `hust-obc-cat-0961`
- HUST label codepoints / HUST 标签 codepoint: `U+37B7`
- OBIMD main candidates / OBIMD 主字候选: `obimd-main-cand-001869`
- EVOBC category candidates / EVOBC 类别候选: `evobc-evo-cat-00086`
- EVOBC image reference count / EVOBC 图像引用数: `51`
...
- `corpus/001_oracle-characters/009_000801-000900_obs-char-bucket_oracle-characters/001_hust-obc-candidate-packet-manifest.csv`
- `corpus/001_oracle-characters/009_000801-000900_obs-char-bucket_oracle-characters/852_obs-char-000852_hust-obc-cat-0961_oracle-character/01_candidate-character-packet.json`
...
- Route availability ID: `codepoint-route-availability-011`
...
- Review task ID: `codepoint-crosswalk-review-011`
- Crosswalk candidate ID: `hust-obimd-evobc-xwalk-000852`
- Suggested oracle character ID: `obs-char-000852`
- HUST candidate packet ID: `hust-obc-candidate-packet-000852`
...
- OBIMD row count: `1`
- OBIMD source UIDs: `hcsv6oxj1l`
- OBIMD review statuses: `obimd-main-cand-001869=reviewed_metadata_only`
- OBIMD rights statuses: `obimd-main-cand-001869=licensed_for_repository`
- EVOBC row count: `1`
- EVOBC source category IDs: `00086`
- EVOBC has bronze refs: `false`
- EVOBC has seal refs: `false`
- EVOBC review statuses: `evobc-evo-cat-00086=reviewed_metadata_only`
- EVOBC rights statuses: `evobc-evo-cat-00086=source_marked_risk_noted`
...
- Does `hust-obimd-evobc-xwalk-000852` remain unpromoted and undeciphered?
