# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002321
...
| --- | --- | --- | --- |
| `obimd-glyph-link-035805` | 򧇚󽕄 | `U+A71DA;U+FD544` | `reviewed_metadata_only` |
| `obimd-glyph-link-035806` | 󽕅 | `U+FD545` | `reviewed_metadata_only` |
