...
Project ID: `obs-evo-cand-001855`
...
- Project ID: `obs-evo-cand-001855`
- EVOBC category candidate ID: `evobc-evo-cat-01855`
- External category reference: `evobc-cat-01855`
- Source category ID: `01855`
- Source label for human review: `垛`
- Source codepoints: `U+579B`
...
- `obs-evo-cand-001855-route-category-staging`
...
- `obs-evo-cand-001855-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001855-route-evolution-graph`
