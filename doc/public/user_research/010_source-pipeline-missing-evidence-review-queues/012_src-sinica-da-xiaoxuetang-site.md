...
- Review draft ID / 复核草稿 ID: `source-pipeline-missing-evidence-review-draft-012`
...
- Source type / 来源类型: `online_portal`
- Rights status / 权利状态: `metadata_only_until_verified`
- Pipeline gap status / 流水线缺口状态: `needs_download_or_access_review`
...
- `corpus/006_research-sources-and-bibliography/000_source-`
  `registers/009_source-package-file-manifest.csv`
...
- metadata_profile_ids: `metadata-profile-000044;metadata-`
  `profile-000045;metadata-profile-000046`
- large_source_package_ids: `none`
- source_download_log_ids: `dl-sinica-da-xiaoxuetang-site`
- source_field_map_ids: `field-map-000052`
...
- download log ids / 下载记录 ID: `dl-sinica-da-xiaoxuetang-site`
- metadata profile ids / metadata profile ID: `metadata-`
  `profile-000044;metadata-profile-000045;metadata-profile-000046`
- large source package ids / 大型来源包 ID: `none`
- source field map ids / 字段映射 ID: `field-map-000052`
