...
Project ID: `obs-evo-cand-008900`
...
- Project ID: `obs-evo-cand-008900`
- EVOBC category candidate ID: `evobc-evo-cat-08900`
- External category reference: `evobc-cat-08900`
- Source category ID: `08900`
- Source label for human review: `辍`
- Source codepoints: `U+8F8D`
...
- `obs-evo-cand-008900-route-category-staging`
...
- `obs-evo-cand-008900-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008900-route-evolution-graph`
