...
- Project ID: `obs-evo-cand-005271`
- EVOBC category candidate ID: `evobc-evo-cat-05271`
- External category reference: `evobc-cat-05271`
- Source category ID: `05271`
- Source label for human review: `狡`
- Source codepoints: `U+72E1`
...
- `obs-evo-cand-005271-route-category-staging`
...
- `obs-evo-cand-005271-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005271-route-evolution-graph`
