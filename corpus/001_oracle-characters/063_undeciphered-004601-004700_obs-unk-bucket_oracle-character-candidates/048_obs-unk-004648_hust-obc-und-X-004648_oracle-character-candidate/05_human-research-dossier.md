# obs-unk-004648 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004648`
- primary external id: `hust-obc-und-X-004648`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/048_obs-unk-004648_h
  ust-obc-und-X-004648_oracle-character-candidate/03_visual-assets/001_asset
  -006241_hust-obc-und-X-004648_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/204/X_？_8376_1.png`
- asset id: `asset-006241`
...
- source class: `HUST-OBC/undeciphered/X/204/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/204/X_？_8376_1.png`
- asset id: `asset-006241`
...
- English observation: `long curved stroke with branches and lower loop`
- 中文观察: `带分支和下部环曲的长弧形笔画`
...
- Which source records identify obs-unk-004648 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004648？
