# obs-char-001108 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001108`
- primary external id: `hust-obc-cat-1238`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1108_obs-char-001108_hust-obc-cat-1238_ora
  cle-character/03_visual-assets/001_asset-001113_hust-obc-cat-1238_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1238/X_1238_5947_1.png`
- asset id: `asset-001113`
...
- source category: `1238`
- validation class: `1107`
- source image route: `HUST-OBC/deciphered/1238/X_1238_5947_1.png`
- asset id: `asset-001113`
...
- English observation: `A broad arch-like form has a rounded upper loop, a
  central junction, and long curved side strokes descending on both sides.`
- 中文观察: `宽大的拱弧形体有圆弧上部环笔、中央连接处和向两侧下行的长弯笔。`
...
- dataset label text: `㣌`
- dataset label codepoints: `U+38CC`
...
- Which source records identify obs-char-001108 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001108？
