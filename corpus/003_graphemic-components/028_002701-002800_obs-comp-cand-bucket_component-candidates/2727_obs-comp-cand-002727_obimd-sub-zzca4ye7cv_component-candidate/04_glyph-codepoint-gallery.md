# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002727
...
| --- | --- | --- | --- |
| `obimd-glyph-link-041445` | 󿘲 | `U+FF632` | `reviewed_metadata_only` |
| `obimd-glyph-link-041446` | 󿘳 | `U+FF633` | `reviewed_metadata_only` |
| `obimd-glyph-link-041447` | 󿘴 | `U+FF634` | `reviewed_metadata_only` |
| `obimd-glyph-link-041448` | 󿘵 | `U+FF635` | `reviewed_metadata_only` |
