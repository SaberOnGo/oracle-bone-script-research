# Material Visual Observation / obs-comp-cand-000445 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000445`
- External reference / 外部参照: `obimd-sub-ed04il53n7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012368_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ed04il53n7/ed04il53n7/ed04il53n7.png`
- Checksum / 校验和:
  `3e9959cfb7fe15e796a7c56779f456fd9a0bb5f5db4946b973eb1170064e3c25`
...
- Marked-pixel bounds: (77,36)–(172,214); span 96 × 179 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.01%。
- 痕迹范围：(77,36)–(172,214)；跨度96 × 179 px；痕迹矩形高于宽。
