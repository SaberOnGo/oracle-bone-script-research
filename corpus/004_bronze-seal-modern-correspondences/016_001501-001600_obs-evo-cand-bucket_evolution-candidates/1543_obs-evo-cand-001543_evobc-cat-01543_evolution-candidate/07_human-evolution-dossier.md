...
Project ID: `obs-evo-cand-001543`
...
- Project ID: `obs-evo-cand-001543`
- EVOBC category candidate ID: `evobc-evo-cat-01543`
- External category reference: `evobc-cat-01543`
- Source category ID: `01543`
- Source label for human review: `呱`
- Source codepoints: `U+5471`
...
- `obs-evo-cand-001543-route-category-staging`
...
- `obs-evo-cand-001543-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001543-route-evolution-graph`
