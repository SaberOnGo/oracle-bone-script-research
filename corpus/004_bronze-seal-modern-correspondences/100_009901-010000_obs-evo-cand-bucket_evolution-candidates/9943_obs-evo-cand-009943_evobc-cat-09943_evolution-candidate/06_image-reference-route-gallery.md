...
- `obs-evo-cand-009943-route-category-staging`
...
- `obs-evo-cand-009943-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009943-route-evolution-graph`
