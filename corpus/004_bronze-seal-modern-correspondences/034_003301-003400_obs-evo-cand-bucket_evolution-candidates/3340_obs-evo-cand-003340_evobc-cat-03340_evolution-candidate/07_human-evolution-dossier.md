...
Project ID: `obs-evo-cand-003340`
...
- Project ID: `obs-evo-cand-003340`
- EVOBC category candidate ID: `evobc-evo-cat-03340`
- External category reference: `evobc-cat-03340`
- Source category ID: `03340`
- Source label for human review: `指`
- Source codepoints: `U+6307`
...
- `obs-evo-cand-003340-route-category-staging`
...
- `obs-evo-cand-003340-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003340-route-evolution-graph`
