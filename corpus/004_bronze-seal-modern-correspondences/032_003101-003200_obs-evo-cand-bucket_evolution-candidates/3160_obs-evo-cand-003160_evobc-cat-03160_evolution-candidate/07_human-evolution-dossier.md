...
Project ID: `obs-evo-cand-003160`
...
- Project ID: `obs-evo-cand-003160`
- EVOBC category candidate ID: `evobc-evo-cat-03160`
- External category reference: `evobc-cat-03160`
- Source category ID: `03160`
- Source label for human review: `憬`
- Source codepoints: `U+61AC`
...
- `obs-evo-cand-003160-route-category-staging`
...
- `obs-evo-cand-003160-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003160-route-evolution-graph`
