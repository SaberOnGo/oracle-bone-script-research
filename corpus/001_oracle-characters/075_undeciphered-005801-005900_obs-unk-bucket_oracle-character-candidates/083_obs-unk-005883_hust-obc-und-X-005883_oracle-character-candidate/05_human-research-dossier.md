# obs-unk-005883 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005883`
- primary external id: `hust-obc-und-X-005883`
...
- local review image route: `corpus/001_oracle-characters/075_undeciphered-005
  801-005900_obs-unk-bucket_oracle-character-candidates/083_obs-unk-005883_h
  ust-obc-und-X-005883_oracle-character-candidate/03_visual-assets/001_asset
  -007475_hust-obc-und-X-005883_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1439/X_？_2254_1.png`
- asset id: `asset-007475`
...
- source class: `HUST-OBC/undeciphered/X/1439/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1439/X_？_2254_1.png`
- asset id: `asset-007475`
...
- Which source records identify obs-unk-005883 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005883？
