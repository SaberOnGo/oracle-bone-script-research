...
- External category reference: `evobc-cat-02767`
- Source category ID: `02767`
- Source label for human review: `廥`
...
- `obs-evo-cand-002767-route-category-staging`
...
- `obs-evo-cand-002767-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002767-route-evolution-graph`
