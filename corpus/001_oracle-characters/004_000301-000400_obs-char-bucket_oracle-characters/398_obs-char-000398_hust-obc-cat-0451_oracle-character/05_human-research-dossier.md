# obs-char-000398 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000398`
- primary external id: `hust-obc-cat-0451`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/398_obs-char-000398_hust-obc-cat-0451_orac
  le-character/03_visual-assets/001_asset-000403_hust-obc-cat-0451_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0451/G_0451_乙92合21785.png`
- asset id: `asset-000403`
...
- source category: `0451`
- validation class: `397`
- source image route: `HUST-OBC/deciphered/0451/G_0451_乙92合21785.png`
- asset id: `asset-000403`
...
- English observation: `Two small upper enclosed marks connect to a long
  curved lower stroke and a short side branch.`
- 中文观察: `两个小型上部闭合痕迹连接长弧形下部笔画和短侧向分支。`
...
- dataset label text: `㖹`
- dataset label codepoints: `U+35B9`
...
- filename catalog route clues: `Heji-like filename clue: 合21785
...
- Which source records identify obs-char-000398 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000398？
