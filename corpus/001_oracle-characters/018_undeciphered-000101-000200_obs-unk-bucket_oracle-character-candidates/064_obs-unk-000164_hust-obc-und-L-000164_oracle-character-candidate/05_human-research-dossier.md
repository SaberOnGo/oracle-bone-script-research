# obs-unk-000164 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000164`
- primary external id: `hust-obc-und-L-000164`
...
- local review image route: `corpus/001_oracle-characters/018_undeciphered-000
  101-000200_obs-unk-bucket_oracle-character-candidates/064_obs-unk-000164_h
  ust-obc-und-L-000164_oracle-character-candidate/03_visual-assets/001_asset
  -001757_hust-obc-und-L-000164_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/164/L_？_1051.jpg`
- asset id: `asset-001757`
...
- source class: `HUST-OBC/undeciphered/L/164/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/164/L_？_1051.jpg`
- asset id: `asset-001757`
...
- Which source records identify obs-unk-000164 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000164？
