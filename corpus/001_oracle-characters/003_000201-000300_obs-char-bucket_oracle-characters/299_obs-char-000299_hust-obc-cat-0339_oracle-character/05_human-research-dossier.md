# obs-char-000299 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/299_obs-char-000299_hust-obc-cat-0339_orac
  le-character/03_visual-assets/001_asset-000304_hust-obc-cat-0339_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0339/G_0339_佚725合4990賓組.png`
- asset id: `asset-000304`
...
- source category: `0339`
- validation class: `298`
- source image route: `HUST-OBC/deciphered/0339/G_0339_佚725合4990賓組.png`
- asset id: `asset-000304`
...
- English observation: `The image has a large peaked outer angle, nested
  sloping strokes, and a small lower rounded enclosure with a short inner
  bar.`
...
- dataset label text: `㕉`
- dataset label codepoints: `U+3549`
...
- filename catalog route clues: `Heji-like filename clue: 合4990
...
- Which source records identify obs-char-000299 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000299？
