# Material Visual Observation / obs-comp-cand-002548 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002548`
- External reference / 外部参照: `obimd-sub-puunytmd6z`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021080_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/puunytmd6z/puunytmd6z/puunytmd6z.png`
- Checksum / 校验和:
  `8d98fdd4ca7fe486c53db643be00ec3046a7effd584d4744d3e3acab43f393f0`
...
- Marked-pixel bounds: (78,24)–(169,212); span 92 × 189 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.08%。
- 痕迹范围：(78,24)–(169,212)；跨度92 × 189 px；痕迹矩形高于宽。
