...
- External category reference: `evobc-cat-12061`
- Source category ID: `12061`
- Source label for human review: `𦠆`
...
- `obs-evo-cand-012061-route-category-staging`
...
- `obs-evo-cand-012061-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012061-route-evolution-graph`
