# obs-evo-cand-002075 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-02075`
- Source label: `妌`
- Source codepoints: `U+598C`
- Image reference count: `81`
- Era token counts: `OBC:80;SS:1`
- Source token counts: `Book:31;Web:50`
