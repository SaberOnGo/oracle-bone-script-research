...
- External category reference: `evobc-cat-07856`
- Source category ID: `07856`
- Source label for human review: `蟡`
- Source codepoints: `U+87E1`
...
- `obs-evo-cand-007856-route-category-staging`
...
- `obs-evo-cand-007856-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007856-route-evolution-graph`
