...
Project ID: `obs-evo-cand-002579`
...
- Project ID: `obs-evo-cand-002579`
- EVOBC category candidate ID: `evobc-evo-cat-02579`
- External category reference: `evobc-cat-02579`
- Source category ID: `02579`
- Source label for human review: `嵐`
- Source codepoints: `U+5D50`
...
- `obs-evo-cand-002579-route-category-staging`
...
- `obs-evo-cand-002579-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002579-route-evolution-graph`
