# obs-unk-000822 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000822`
- primary external id: `hust-obc-und-L-000822`
...
- local review image route: `corpus/001_oracle-characters/025_undeciphered-000
  801-000900_obs-unk-bucket_oracle-character-candidates/022_obs-unk-000822_h
  ust-obc-und-L-000822_oracle-character-candidate/03_visual-assets/001_asset
  -002415_hust-obc-und-L-000822_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/822/L_？_12389.jpg`
- asset id: `asset-002415`
...
- source class: `HUST-OBC/undeciphered/L/822/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/822/L_？_12389.jpg`
- asset id: `asset-002415`
...
- Which source records identify obs-unk-000822 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000822？
