# obs-char-001243 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001243`
- primary external id: `hust-obc-cat-1391`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1243_obs-char-001243_hust-obc-cat-1391_ora
  cle-character/03_visual-assets/001_asset-001248_hust-obc-cat-1391_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1391/X_1391_3988_1.png`
- asset id: `asset-001248`
...
- source category: `1391`
- validation class: `1242`
- source image route: `HUST-OBC/deciphered/1391/X_1391_3988_1.png`
- asset id: `asset-001248`
...
- English observation: `The image contains several separated branching
  forms, including tall side marks and a larger lower angular form.`
...
- dataset label text: `㥥`
- dataset label codepoints: `U+3965`
...
- Which source records identify obs-char-001243 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001243？
