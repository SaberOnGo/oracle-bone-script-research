...
- External category reference: `evobc-cat-11945`
- Source category ID: `11945`
- Source label: `𦀂`
...
- `obs-evo-cand-011945-route-category-staging`
...
- `obs-evo-cand-011945-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011945-route-evolution-graph`
