...
- External category reference: `evobc-cat-10575`
- Source category ID: `10575`
- Source label for human review: `鸒`
...
- `obs-evo-cand-010575-route-category-staging`
...
- `obs-evo-cand-010575-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010575-route-evolution-graph`
