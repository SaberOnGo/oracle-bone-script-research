# obs-char-000484 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000484`
- primary external id: `hust-obc-cat-0549`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/484_obs-char-000484_hust-obc-cat-0549_orac
  le-character/03_visual-assets/001_asset-000489_hust-obc-cat-0549_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0549/G_0549_乙1047合13584賓組.png`
- asset id: `asset-000489`
...
- source category: `0549`
- validation class: `483`
- source image route: `HUST-OBC/deciphered/0549/G_0549_乙1047合13584賓組.png`
- asset id: `asset-000489`
...
- English observation: `A pointed outer outline encloses a central vertical
  stroke with two upper diagonal branches and shorter transverse strokes
  near the middle.`
- 中文观察: `尖顶外轮廓包围中央竖笔，竖笔上部有两条斜向分支，中部附近另有较短横向笔画。`
...
- dataset label text: `㘛`
- dataset label codepoints: `U+361B`
...
- filename catalog route clues: `Heji-like filename clue: 合13584
  (G_0549_乙1047合13584賓組.png)`
...
- Which source records identify obs-char-000484 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000484？
