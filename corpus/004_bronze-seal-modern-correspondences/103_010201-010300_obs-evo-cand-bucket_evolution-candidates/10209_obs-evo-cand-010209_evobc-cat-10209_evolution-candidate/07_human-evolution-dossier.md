...
- External category reference: `evobc-cat-10209`
- Source category ID: `10209`
- Source label for human review: `騀`
- Source codepoints: `U+9A00`
...
- `obs-evo-cand-010209-route-category-staging`
...
- `obs-evo-cand-010209-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010209-route-evolution-graph`
