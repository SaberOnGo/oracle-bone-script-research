...
- Project ID: `obs-evo-cand-001239`
- EVOBC category candidate ID: `evobc-evo-cat-01239`
- External category reference: `evobc-cat-01239`
- Source category ID: `01239`
- Source label for human review: `剭`
- Source codepoints: `U+526D`
...
- `obs-evo-cand-001239-route-category-staging`
...
- `obs-evo-cand-001239-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001239-route-evolution-graph`
