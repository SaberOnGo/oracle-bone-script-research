...
- External category reference: `evobc-cat-01578`
- Source category ID: `01578`
- Source label for human review: `品`
- Source codepoints: `U+54C1`
- Image reference count in source metadata: `84`
...
- `obs-evo-cand-001578-route-category-staging`
...
- `obs-evo-cand-001578-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001578-route-evolution-graph`
