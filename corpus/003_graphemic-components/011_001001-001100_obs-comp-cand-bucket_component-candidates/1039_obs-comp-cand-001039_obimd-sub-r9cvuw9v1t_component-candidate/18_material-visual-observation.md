# Material Visual Observation / obs-comp-cand-001039 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001039`
- External reference / 外部参照: `obimd-sub-r9cvuw9v1t`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014532_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/r9cvuw9v1t/r9cvuw9v1t/09hpwwk8cq.png`
- Checksum / 校验和:
  `3a4ba554ff9fac5fa9e125785f169bea92dd1b96d228de7faf14544afa463c8b`
...
- Marked-pixel bounds: (86,28)–(163,221); span 78 × 194 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.48%。
- 痕迹范围：(86,28)–(163,221)；跨度78 × 194 px；痕迹矩形高于宽。
