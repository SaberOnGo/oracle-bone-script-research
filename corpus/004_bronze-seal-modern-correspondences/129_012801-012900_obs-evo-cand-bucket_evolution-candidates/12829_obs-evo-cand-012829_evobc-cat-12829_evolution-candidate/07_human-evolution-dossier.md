...
- External category reference: `evobc-cat-12829`
- Source category ID: `12829`
- Source label for human review: `𪧯`
- Source codepoints: `U+2A9EF`
...
- `obs-evo-cand-012829-route-category-staging`
...
- `obs-evo-cand-012829-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012829-route-evolution-graph`
