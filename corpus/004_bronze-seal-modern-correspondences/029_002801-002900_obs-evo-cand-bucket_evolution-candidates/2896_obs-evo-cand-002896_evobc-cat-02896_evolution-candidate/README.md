# obs-evo-cand-002896 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-02896`
- Source label: `忄`
- Source codepoints: `U+5FC4`
- Image reference count: `126`
- Era token counts: `BI:14;SS:1;WSC:111`
- Source token counts: `Web:126`

## Observed Code Rows / 观察到的代码行

- era 1 / BI: 14 image references
- era 2 / SS: 1 image references
- era 4 / WSC: 111 image references
