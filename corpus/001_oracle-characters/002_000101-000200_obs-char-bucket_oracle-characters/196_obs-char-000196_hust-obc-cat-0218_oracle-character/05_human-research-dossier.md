# obs-char-000196 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000196`
- primary external id: `hust-obc-cat-0218`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/196_obs-char-000196_hust-obc-cat-0218_orac
  le-character/03_visual-assets/001_asset-000201_hust-obc-cat-0218_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0218/G_0218_京津4814.png`
- asset id: `asset-000201`
...
- source category: `0218`
- validation class: `195`
- source image route: `HUST-OBC/deciphered/0218/G_0218_京津4814.png`
- asset id: `asset-000201`
...
- English observation: `The image is a dense chain of crossing and looping
  strokes with short side projections extending at several levels.`
- 中文观察: `图像是交叉、环绕笔组成的密集链状形体，多个高度有短侧向伸笔。`
...
- dataset label text: `㓐`
- dataset label codepoints: `U+34D0`
...
- Which source records identify obs-char-000196 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000196？
