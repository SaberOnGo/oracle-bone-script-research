...
- External category reference: `evobc-cat-09704`
- Source category ID: `09704`
- Source label for human review: `阱`
...
- `obs-evo-cand-009704-route-category-staging`
...
- `obs-evo-cand-009704-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009704-route-evolution-graph`
