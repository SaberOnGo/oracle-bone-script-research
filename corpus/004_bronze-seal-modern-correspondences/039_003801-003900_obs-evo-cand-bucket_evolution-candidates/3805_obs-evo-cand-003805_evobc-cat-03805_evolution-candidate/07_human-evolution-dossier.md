...
- External category reference: `evobc-cat-03805`
- Source category ID: `03805`
- Source label for human review: `曣`
- Source codepoints: `U+66E3`
...
- `obs-evo-cand-003805-route-category-staging`
...
- `obs-evo-cand-003805-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003805-route-evolution-graph`
