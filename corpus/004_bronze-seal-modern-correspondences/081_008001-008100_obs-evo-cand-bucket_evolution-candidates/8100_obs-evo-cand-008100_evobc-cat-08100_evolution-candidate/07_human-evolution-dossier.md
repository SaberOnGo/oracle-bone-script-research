...
- External category reference: `evobc-cat-08100`
- Source category ID: `08100`
- Source label for human review: `觠`
- Source codepoints: `U+89E0`
...
- `obs-evo-cand-008100-route-category-staging`
...
- `obs-evo-cand-008100-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008100-route-evolution-graph`
