...
- External category reference: `evobc-cat-05095`
- Source category ID: `05095`
- Source label for human review: `焬`
- Source codepoints: `U+712C`
...
- `obs-evo-cand-005095-route-category-staging`
...
- `obs-evo-cand-005095-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005095-route-evolution-graph`
