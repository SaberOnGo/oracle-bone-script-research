# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000459
...
| Glyph or codepoint route / 字形或码位路线 | 5 OBIMD route rows; examples U+81BA;U+F2B9B; U+F2B9C; 另有 3 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
