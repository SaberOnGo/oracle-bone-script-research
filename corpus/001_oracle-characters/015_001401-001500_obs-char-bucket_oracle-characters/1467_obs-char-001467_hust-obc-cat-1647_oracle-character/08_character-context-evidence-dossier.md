...
- Project ID / 项目 ID: `obs-char-001467`
- Primary external ID / 首选外部 ID: `hust-obc-cat-1647`
...
- Source image / 来源图: `G_1647_後1.23.1(甲).png`
- Image / 图像: `001_asset-001472_hust-obc-cat-1647_glyph.png`
...
- Source label text / 来源标签文字: `㩥`
- Source label codepoint / 来源标签 codepoint: `U+3A65`
