# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013133
...
- EVOBC candidate category: `evobc-evo-cat-13133`.
- Source label for search only: `𫸭`.
- Source codepoints for search only: `U+2BE2D`.
