...
Project ID: `obs-evo-cand-008367`
...
- Project ID: `obs-evo-cand-008367`
- EVOBC category candidate ID: `evobc-evo-cat-08367`
- External category reference: `evobc-cat-08367`
- Source category ID: `08367`
- Source label for human review: `譥`
- Source codepoints: `U+8B65`
...
- `obs-evo-cand-008367-route-category-staging`
...
- `obs-evo-cand-008367-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008367-route-evolution-graph`
