# obs-char-000473 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000473`
- primary external id: `hust-obc-cat-0535_0536`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/473_obs-char-000473_hust-obc-cat-0535_0536
  _oracle-character/03_visual-assets/001_asset-000478_hust-obc-cat-0535_0536
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0535_0536/0535/G_0535_乙1277合376
  賓組.png`
- asset id: `asset-000478`
...
- source category: `0535_0536`
- validation class: `472`
- source image route: `HUST-OBC/deciphered/0535_0536/0535/G_0535_乙1277合376賓組.p
  ng`
- asset id: `asset-000478`
...
- English observation: `A thin detached curved stroke at left stands beside
  a pointed outlined form at right that contains a small central enclosure
  and a long lower base.`
- 中文观察: `左侧纤细分离弯笔与右侧尖顶轮廓形并列，右形内部有小型中央围框和较长下底线。`
...
- dataset label text: `㘍㘎`
- dataset label codepoints: `U+360D;U+360E`
...
- graph edge count: `2`
- codepoint routes: `U+360D;U+360E`
...
- filename catalog route clues: `Heji-like filename clue: 合376
  (G_0535_乙1277合376賓組.png)`
...
- Which source records identify obs-char-000473 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000473？
