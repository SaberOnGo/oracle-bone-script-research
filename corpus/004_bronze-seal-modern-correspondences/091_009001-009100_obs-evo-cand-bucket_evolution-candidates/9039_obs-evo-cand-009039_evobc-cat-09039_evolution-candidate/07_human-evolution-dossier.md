...
- External category reference: `evobc-cat-09039`
- Source category ID: `09039`
- Source label for human review: `遙`
- Source codepoints: `U+9059`
...
- `obs-evo-cand-009039-route-category-staging`
...
- `obs-evo-cand-009039-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009039-route-evolution-graph`
