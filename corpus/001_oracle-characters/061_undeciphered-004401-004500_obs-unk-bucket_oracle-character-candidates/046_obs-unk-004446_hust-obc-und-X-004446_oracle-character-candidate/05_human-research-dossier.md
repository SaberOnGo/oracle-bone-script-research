# obs-unk-004446 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004446`
- primary external id: `hust-obc-und-X-004446`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/046_obs-unk-004446_h
  ust-obc-und-X-004446_oracle-character-candidate/03_visual-assets/001_asset
  -006039_hust-obc-und-X-004446_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2/X_？_7101_1.png`
- asset id: `asset-006039`
...
- source class: `HUST-OBC/undeciphered/X/2/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2/X_？_7101_1.png`
- asset id: `asset-006039`
...
- English observation: `A forked upper trace meets a rounded middle`
  `outline and long tail.`
- 中文观察: `分叉上部痕迹连接中部圆弧轮廓和长尾痕迹。`
...
- Which source records identify obs-unk-004446 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004446？
