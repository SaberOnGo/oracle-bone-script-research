...
- External category reference: `evobc-cat-10570`
- Source category ID: `10570`
- Source label for human review: `鷽`
...
- `obs-evo-cand-010570-route-category-staging`
...
- `obs-evo-cand-010570-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010570-route-evolution-graph`
