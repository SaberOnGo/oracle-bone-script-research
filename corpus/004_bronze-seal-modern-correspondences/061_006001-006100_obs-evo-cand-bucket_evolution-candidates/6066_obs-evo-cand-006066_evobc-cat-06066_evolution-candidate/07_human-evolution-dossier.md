...
- Project ID: `obs-evo-cand-006066`
- EVOBC category candidate ID: `evobc-evo-cat-06066`
- External category reference: `evobc-cat-06066`
- Source category ID: `06066`
- Source label for human review: `秚`
- Source codepoints: `U+79DA`
...
- `obs-evo-cand-006066-route-category-staging`
...
- `obs-evo-cand-006066-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006066-route-evolution-graph`
