...
- External category reference: `evobc-cat-10067`
- Source category ID: `10067`
- Source label for human review: `颮`
- Source codepoints: `U+98AE`
...
- `obs-evo-cand-010067-route-category-staging`
...
- `obs-evo-cand-010067-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010067-route-evolution-graph`
