...
- External category reference: `evobc-cat-08151`
- Source category ID: `08151`
- Source label for human review: `訪`
...
- `obs-evo-cand-008151-route-category-staging`
...
- `obs-evo-cand-008151-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008151-route-evolution-graph`
