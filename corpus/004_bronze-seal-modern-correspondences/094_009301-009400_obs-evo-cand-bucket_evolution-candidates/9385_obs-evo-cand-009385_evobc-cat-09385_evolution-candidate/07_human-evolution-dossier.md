...
- External category reference: `evobc-cat-09385`
- Source category ID: `09385`
- Source label: `銒`
...
- `obs-evo-cand-009385-route-category-staging`
...
- `obs-evo-cand-009385-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009385-route-evolution-graph`
