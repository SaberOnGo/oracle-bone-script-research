# obs-xwalk-cand-001503 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+3A8D;U+3A8E` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-1687_1688` | not reading |
