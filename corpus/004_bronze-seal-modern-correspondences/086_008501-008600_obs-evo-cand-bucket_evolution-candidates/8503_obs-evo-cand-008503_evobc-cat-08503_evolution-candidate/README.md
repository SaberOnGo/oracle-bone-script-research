# obs-evo-cand-008503 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-008503`
- EVOBC category candidate ID: `evobc-evo-cat-08503`
- External category ref: `evobc-cat-08503`
- Source label: `豰`
- Source codepoints: `U+8C70`
- Image reference count: `43`
- Era token counts: `OBC:43`
- Source token counts: `Web:43`
