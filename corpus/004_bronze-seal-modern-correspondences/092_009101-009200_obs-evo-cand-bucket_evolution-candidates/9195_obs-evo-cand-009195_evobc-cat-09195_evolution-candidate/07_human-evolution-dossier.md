...
- External category reference: `evobc-cat-09195`
- Source category ID: `09195`
- Source label for human review: `鄚`
...
- `obs-evo-cand-009195-route-category-staging`
...
- `obs-evo-cand-009195-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009195-route-evolution-graph`
