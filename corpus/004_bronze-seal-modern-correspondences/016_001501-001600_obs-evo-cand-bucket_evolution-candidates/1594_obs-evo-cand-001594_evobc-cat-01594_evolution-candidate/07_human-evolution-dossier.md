...
Project ID: `obs-evo-cand-001594`
...
- Project ID: `obs-evo-cand-001594`
- EVOBC category candidate ID: `evobc-evo-cat-01594`
- External category reference: `evobc-cat-01594`
- Source category ID: `01594`
- Source label for human review: `哴`
- Source codepoints: `U+54F4`
...
- `obs-evo-cand-001594-route-category-staging`
...
- `obs-evo-cand-001594-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001594-route-evolution-graph`
