# obs-unk-005086 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005086`
- primary external id: `hust-obc-und-X-005086`
...
- local review image route: `corpus/001_oracle-characters/067_undeciphered-005
  001-005100_obs-unk-bucket_oracle-character-candidates/086_obs-unk-005086_h
  ust-obc-und-X-005086_oracle-character-candidate/03_visual-assets/001_asset
  -006679_hust-obc-und-X-005086_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/642/X_？_7612_1.png`
- asset id: `asset-006679`
...
- source class: `HUST-OBC/undeciphered/X/642/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/642/X_？_7612_1.png`
- asset id: `asset-006679`
...
- Which source records identify obs-unk-005086 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005086？
