# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001914
...
| --- | --- | --- | --- |
| `obimd-glyph-link-028858` | 󺺢 | `U+FAEA2` | `reviewed_metadata_only` |
| `obimd-glyph-link-028859` | 󺺣 | `U+FAEA3` | `reviewed_metadata_only` |
| `obimd-glyph-link-028860` | 󺺤 | `U+FAEA4` | `reviewed_metadata_only` |
| `obimd-glyph-link-028861` | 󺺥 | `U+FAEA5` | `reviewed_metadata_only` |
| `obimd-glyph-link-028862` | 󺺦 | `U+FAEA6` | `reviewed_metadata_only` |
