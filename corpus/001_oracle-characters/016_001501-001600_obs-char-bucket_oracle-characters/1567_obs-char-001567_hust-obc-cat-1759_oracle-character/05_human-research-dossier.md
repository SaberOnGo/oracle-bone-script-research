# obs-char-001567 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1567_obs-char-001567_hust-obc-cat-1759_ora
  cle-character/03_visual-assets/001_asset-001572_hust-obc-cat-1759_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1759/X_1759_5888_1.png`
- asset id: `asset-001572`
...
- source category: `1759`
- validation class: `1566`
- source image route: `HUST-OBC/deciphered/1759/X_1759_5888_1.png`
- asset id: `asset-001572`
...
- English observation: `A tall winding contour has an upper angled section,
  side branches, and a lower diamond loop.`
- 中文观察: `高大曲折轮廓有上部斜向段、侧部分枝和下部菱形环。`
...
- dataset label text: `㫕`
- dataset label codepoints: `U+3AD5`
...
- Which source records identify obs-char-001567 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001567？
