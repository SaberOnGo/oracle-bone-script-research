# obs-evo-cand-003601 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-003601`
- EVOBC category candidate ID: `evobc-evo-cat-03601`
- External category ref: `evobc-cat-03601`
- Source label: `敬`
- Source codepoints: `U+656C`
- Image reference count: `166`
- Era token counts: `BI:52;CS:1;SAC:16;SS:2;WSC:95`
- Source token counts: `Book:78;Web:88`
...
- era 4 / WSC: 95 image references
- era 5 / CS: 1 image references
- source 1 / Web:105952;說文Web:58: 88 image references
- source 3 / Book:21681: 18 image references
- source 4 / Book:9131: 16 image references
- source 5 / Book:32794: 44 image references
