# obs-evo-cand-002010 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-002010`
- EVOBC category candidate ID: `evobc-evo-cat-02010`
- External category ref: `evobc-cat-02010`
- Source label: `天`
- Source codepoints: `U+5929`
- Image reference count: `390`
- Era token counts: `BI:94;CS:2;OBC:75;SAC:27;SS:2;WSC:190`
- Source token counts: `Book:116;Web:274`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 75 image references
- era 1 / BI: 94 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 27 image references
- era 4 / WSC: 190 image references
- era 5 / CS: 2 image references
- source 0 / Web:1633: 1 image references
- source 1 / Web:105952;說文Web:58: 250 image references
- source 2 / Book:17600: 17 image references
- source 3 / Book:21681: 40 image references
- source 4 / Book:9131: 27 image references
- source 5 / Book:32794: 23 image references
- source 6 / Web:30645: 23 image references
- source 7 / Book:9676: 9 image references
