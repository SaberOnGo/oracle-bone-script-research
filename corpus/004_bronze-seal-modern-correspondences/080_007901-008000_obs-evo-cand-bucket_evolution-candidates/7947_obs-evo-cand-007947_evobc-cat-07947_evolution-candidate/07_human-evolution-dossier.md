...
- Project ID: `obs-evo-cand-007947`
- EVOBC category candidate ID: `evobc-evo-cat-07947`
- External category reference: `evobc-cat-07947`
- Source category ID: `07947`
- Source label for human review: `袗`
- Source codepoints: `U+8897`
...
- `obs-evo-cand-007947-route-category-staging`
...
- `obs-evo-cand-007947-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007947-route-evolution-graph`
