...
- Primary external ID / 首选外部 ID: `hust-obc-und-X-006294`
...
- Index row count / 索引行数: `61`
- Source image route count / 来源图像路线数: `61`
- Local review image count / 本地复核图像数: `1`
- Source image / 来源图: `X_？_502_1.png`
- Image / 图像: `001_asset-000005_hust-X-006294_glyph.png`
