...
Project ID: `obs-evo-cand-007271`
...
- Project ID: `obs-evo-cand-007271`
- EVOBC category candidate ID: `evobc-evo-cat-07271`
- External category reference: `evobc-cat-07271`
- Source category ID: `07271`
- Source label for human review: `苃`
- Source codepoints: `U+82C3`
...
- `obs-evo-cand-007271-route-category-staging`
...
- `obs-evo-cand-007271-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007271-route-evolution-graph`
