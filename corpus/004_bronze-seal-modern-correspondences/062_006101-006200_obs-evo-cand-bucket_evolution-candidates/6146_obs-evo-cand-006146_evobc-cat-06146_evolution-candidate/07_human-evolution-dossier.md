...
- External category reference: `evobc-cat-06146`
- Source category ID: `06146`
- Source label for human review: `穷`
- Source codepoints: `U+7A77`
...
- `obs-evo-cand-006146-route-category-staging`
...
- `obs-evo-cand-006146-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006146-route-evolution-graph`
