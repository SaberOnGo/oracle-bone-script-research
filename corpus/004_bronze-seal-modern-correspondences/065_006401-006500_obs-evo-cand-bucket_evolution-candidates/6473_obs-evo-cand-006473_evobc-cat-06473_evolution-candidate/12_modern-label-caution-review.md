# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006473
...
- EVOBC candidate category: `evobc-evo-cat-06473`.
- Source label for search only: `紫`.
- Source codepoints for search only: `U+7D2B`.
