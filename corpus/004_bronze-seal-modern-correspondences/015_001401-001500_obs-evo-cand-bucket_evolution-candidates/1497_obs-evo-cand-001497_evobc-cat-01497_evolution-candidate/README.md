# obs-evo-cand-001497 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-001497`
- EVOBC category candidate ID: `evobc-evo-cat-01497`
- External category ref: `evobc-cat-01497`
- Source label: `同`
- Source codepoints: `U+540C`
- Image reference count: `176`
- Era token counts: `BI:38;CS:1;OBC:83;SAC:2;SS:2;WSC:50`
- Source token counts: `Book:68;Web:108`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 83 image references
- era 1 / BI: 38 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 2 image references
- era 4 / WSC: 50 image references
...
- source 3 / Book:21681: 17 image references
