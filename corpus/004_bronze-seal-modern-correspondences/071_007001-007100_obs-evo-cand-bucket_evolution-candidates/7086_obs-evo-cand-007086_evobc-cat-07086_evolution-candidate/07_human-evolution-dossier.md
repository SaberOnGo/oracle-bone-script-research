...
Project ID: `obs-evo-cand-007086`
...
- Project ID: `obs-evo-cand-007086`
- EVOBC category candidate ID: `evobc-evo-cat-07086`
- External category reference: `evobc-cat-07086`
- Source category ID: `07086`
- Source label for human review: `腆`
- Source codepoints: `U+8146`
...
- `obs-evo-cand-007086-route-category-staging`
...
- `obs-evo-cand-007086-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007086-route-evolution-graph`
