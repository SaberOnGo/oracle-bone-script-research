...
- External category reference: `evobc-cat-02936`
- Source category ID: `02936`
- Source label for human review: `怖`
- Source codepoints: `U+6016`
...
- `obs-evo-cand-002936-route-category-staging`
...
- `obs-evo-cand-002936-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002936-route-evolution-graph`
