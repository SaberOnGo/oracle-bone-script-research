# obs-unk-006602 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/083_undeciphered-006
  601-006700_obs-unk-bucket_oracle-character-candidates/002_obs-unk-006602_h
  ust-obc-und-X-006602_oracle-character-candidate/03_visual-assets/001_asset
  -008193_hust-obc-und-X-006602_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2158/X_？_6295_1.png`
- asset id: `asset-008193`
...
- source class: `HUST-OBC/undeciphered/X/2158/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2158/X_？_6295_1.png`
- asset id: `asset-008193`
...
- Which source records identify obs-unk-006602 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006602？
