...
- `obs-evo-cand-009586-route-category-staging`
...
- `obs-evo-cand-009586-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009586-route-evolution-graph`
