...
- External category reference: `evobc-cat-07517`
- Source category ID: `07517`
- Source label for human review: `蓁`
- Source codepoints: `U+84C1`
...
- `obs-evo-cand-007517-route-category-staging`
...
- `obs-evo-cand-007517-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007517-route-evolution-graph`
