# Material Visual Observation / obs-comp-cand-002183 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002183`
- External reference / 外部参照: `obimd-sub-a5yunoxatt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019889_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/a5yunoxatt/a5yunoxatt/a5yunoxatt.png`
- Checksum / 校验和:
  `72233662c4eaad25d4ff8a4cf52dc1bc0b2bbfcacb1fc751c5c0ba07917dc0a9`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.24%.
- Marked-pixel bounds: (50,42)–(199,210); span 150 × 169 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.24%。
- 痕迹范围：(50,42)–(199,210)；跨度150 × 169 px；痕迹矩形近方形。
