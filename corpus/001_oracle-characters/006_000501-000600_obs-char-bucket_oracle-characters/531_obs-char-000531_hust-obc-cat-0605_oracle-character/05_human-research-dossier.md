# obs-char-000531 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000531`
- primary external id: `hust-obc-cat-0605`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/531_obs-char-000531_hust-obc-cat-0605_orac
  le-character/03_visual-assets/001_asset-000536_hust-obc-cat-0605_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0605/X_0605_3074_1.png`
- asset id: `asset-000536`
...
- source category: `0605`
- validation class: `530`
- source image route: `HUST-OBC/deciphered/0605/X_0605_3074_1.png`
- asset id: `asset-000536`
...
- English observation: `A bold central vertical crosses a long top bar and
  divides a rounded lower outline; below it, diagonal branches extend to
  both sides around a long tail.`
- 中文观察: `粗重中央竖笔穿过长顶横并分隔圆弧下轮廓，其下斜枝向两侧伸出并围绕长尾笔。`
...
- dataset label text: `㙓`
- dataset label codepoints: `U+3653`
...
- Which source records identify obs-char-000531 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000531？
