# obs-unk-005870 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005870`
- primary external id: `hust-obc-und-X-005870`
...
- local review image route: `corpus/001_oracle-characters/075_undeciphered-005
  801-005900_obs-unk-bucket_oracle-character-candidates/070_obs-unk-005870_h
  ust-obc-und-X-005870_oracle-character-candidate/03_visual-assets/001_asset
  -007462_hust-obc-und-X-005870_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1426/X_？_2207_1.png`
- asset id: `asset-007462`
...
- source class: `HUST-OBC/undeciphered/X/1426/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1426/X_？_2207_1.png`
- asset id: `asset-007462`
...
- Which source records identify obs-unk-005870 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005870？
