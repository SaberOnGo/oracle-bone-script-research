...
Project ID: `obs-evo-cand-012902`
...
- Project ID: `obs-evo-cand-012902`
- EVOBC category candidate ID: `evobc-evo-cat-12902`
- External category reference: `evobc-cat-12902`
- Source category ID: `12902`
- Source label for human review: `𪾚`
- Source codepoints: `U+2AF9A`
...
- `obs-evo-cand-012902-route-category-staging`
...
- `obs-evo-cand-012902-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012902-route-evolution-graph`
