# Material Visual Observation / obs-comp-cand-001601 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001601`
- External reference / 外部参照: `obimd-sub-iftkudcar6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017277_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/iftkudcar6/iftkudcar6/iftkudcar6.png`
- Checksum / 校验和:
  `76a30c2e25b9dad2d1d3c97de6fdb0d09a162b92fb9a0589686bdd1e2556f8c6`
...
- Marked-pixel bounds: (86,31)–(163,229); span 78 × 199 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.85%。
- 痕迹范围：(86,31)–(163,229)；跨度78 × 199 px；痕迹矩形高于宽。
