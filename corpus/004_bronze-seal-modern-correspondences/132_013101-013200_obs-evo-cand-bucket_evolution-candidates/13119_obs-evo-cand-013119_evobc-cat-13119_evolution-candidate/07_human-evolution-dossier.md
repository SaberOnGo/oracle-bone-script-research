...
- External category reference: `evobc-cat-13119`
- Source category ID: `13119`
- Source label for human review: `𫶶`
- Source codepoints: `U+2BDB6`
...
- `obs-evo-cand-013119-route-category-staging`
...
- `obs-evo-cand-013119-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013119-route-evolution-graph`
