# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013337
...
- EVOBC candidate category: `evobc-evo-cat-13337`.
- Source label for search only: `𬢩`.
- Source codepoints for search only: `U+2C8A9`.
