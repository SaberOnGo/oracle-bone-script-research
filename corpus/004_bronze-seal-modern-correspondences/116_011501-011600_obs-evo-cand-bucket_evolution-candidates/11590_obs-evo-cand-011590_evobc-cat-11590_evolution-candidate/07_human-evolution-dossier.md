...
- External category reference: `evobc-cat-11590`
- Source category ID: `11590`
- Source label for human review: `𤖚`
...
- `obs-evo-cand-011590-route-category-staging`
...
- `obs-evo-cand-011590-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011590-route-evolution-graph`
