# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000505
...
| Glyph or codepoint route / 字形或码位路线 | 5 OBIMD route rows; examples U+CF928;U+F2F7C; U+F2F7D; 另有 3 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
