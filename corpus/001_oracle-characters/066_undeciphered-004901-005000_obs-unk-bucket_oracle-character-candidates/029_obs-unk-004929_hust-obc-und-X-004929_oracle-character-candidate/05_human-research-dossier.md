# obs-unk-004929 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/029_obs-unk-004929_h
  ust-obc-und-X-004929_oracle-character-candidate/03_visual-assets/001_asset
  -006522_hust-obc-und-X-004929_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/485/X_？_7469_1.png`
- asset id: `asset-006522`
...
- Two separated groups and a long lower stroke are visible.
...
- source class: `HUST-OBC/undeciphered/X/485/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/485/X_？_7469_1.png`
- asset id: `asset-006522`
...
- Which source records identify obs-unk-004929 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004929？
