...
- External category reference: `evobc-cat-13709`
- Source category ID: `13709`
- Source label for human review: `臨`
...
- `obs-evo-cand-013709-route-category-staging`
...
- `obs-evo-cand-013709-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013709-route-evolution-graph`
