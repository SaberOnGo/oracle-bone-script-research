...
Project ID: `obs-evo-cand-000783`
...
- Project ID: `obs-evo-cand-000783`
- EVOBC category candidate ID: `evobc-evo-cat-00783`
- External category reference: `evobc-cat-00783`
- Source category ID: `00783`
- Source label for human review: `伴`
- Source codepoints: `U+4F34`
...
- `obs-evo-cand-000783-route-category-staging`
...
- `obs-evo-cand-000783-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000783-route-evolution-graph`
