...
Project ID: `obs-evo-cand-013152`
...
- Project ID: `obs-evo-cand-013152`
- EVOBC category candidate ID: `evobc-evo-cat-13152`
- External category reference: `evobc-cat-13152`
- Source category ID: `13152`
- Source label for human review: `𫻆`
- Source codepoints: `U+2BEC6`
...
- `obs-evo-cand-013152-route-category-staging`
...
- `obs-evo-cand-013152-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013152-route-evolution-graph`
