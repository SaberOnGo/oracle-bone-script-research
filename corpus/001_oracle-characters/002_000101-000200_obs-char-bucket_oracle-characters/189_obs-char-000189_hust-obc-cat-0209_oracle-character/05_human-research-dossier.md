# obs-char-000189 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/189_obs-char-000189_hust-obc-cat-0209_orac
  le-character/03_visual-assets/001_asset-000194_hust-obc-cat-0209_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0209/L_0209_9095.jpg`
- asset id: `asset-000194`
...
- source category: `0209`
- validation class: `188`
- source image route: `HUST-OBC/deciphered/0209/L_0209_9095.jpg`
- asset id: `asset-000194`
...
- English observation: `The low-resolution gray image has two rounded upper
  lobes above a short horizontal base and a thin central descending stroke.`
...
- dataset label text: `㓇`
- dataset label codepoints: `U+34C7`
...
- Which source records identify obs-char-000189 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000189？
