# obs-char-001284 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1284_obs-char-001284_hust-obc-cat-1436_ora
  cle-character/03_visual-assets/001_asset-001289_hust-obc-cat-1436_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1436/G_1436_合28319(甲).png`
- asset id: `asset-001289`
...
- source category: `1436`
- validation class: `1283`
- source image route: `HUST-OBC/deciphered/1436/G_1436_合28319(甲).png`
- asset id: `asset-001289`
...
- English observation: `A dense branching form has a dark upper crossing, a
  long right curve, and several lower diagonal strokes.`
- 中文观察: `密集分枝形体有深色上部交叉笔、长右侧弧线和数条下部斜笔。`
...
- dataset label text: `㦒`
- dataset label codepoints: `U+3992`
...
- filename catalog route clues: `Heji-like filename clue: 合28319
  (G_1436_合28319(甲).png)`
...
- Which source records identify obs-char-001284 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001284？
