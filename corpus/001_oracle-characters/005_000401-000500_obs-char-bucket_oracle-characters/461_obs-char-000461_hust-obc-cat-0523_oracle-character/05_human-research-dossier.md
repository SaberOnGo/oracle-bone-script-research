# obs-char-000461 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/461_obs-char-000461_hust-obc-cat-0523_orac
  le-character/03_visual-assets/001_asset-000466_hust-obc-cat-0523_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0523/G_0523_京津3220合10062.png`
- asset id: `asset-000466`
...
- source category: `0523`
- validation class: `460`
- source image route: `HUST-OBC/deciphered/0523/G_0523_京津3220合10062.png`
- asset id: `asset-000466`
...
- English observation: `A narrow pointed outer loop encloses several stacked
  angular and curved strokes, including a small upper division and a hooked
  lower cluster.`
- 中文观察: `狭长尖顶外环包围数条层叠折角和弯曲笔画，其中上部有小型分隔，下部为钩曲笔画群。`
...
- dataset label text: `㘁`
- dataset label codepoints: `U+3601`
...
- filename catalog route clues: `Heji-like filename clue: 合10062
...
- Which source records identify obs-char-000461 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000461？
