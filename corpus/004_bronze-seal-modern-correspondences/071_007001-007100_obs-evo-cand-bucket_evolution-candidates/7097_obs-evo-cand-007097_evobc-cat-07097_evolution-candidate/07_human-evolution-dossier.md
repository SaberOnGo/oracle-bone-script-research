...
- External category reference: `evobc-cat-07097`
- Source category ID: `07097`
- Source label for human review: `腕`
...
- `obs-evo-cand-007097-route-category-staging`
...
- `obs-evo-cand-007097-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007097-route-evolution-graph`
