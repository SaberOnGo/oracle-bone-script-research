# obs-char-000459 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/459_obs-char-000459_hust-obc-cat-0521_orac
  le-character/03_visual-assets/001_asset-000464_hust-obc-cat-0521_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0521/G_0521_乙5061合13517賓組.png`
- asset id: `asset-000464`
...
- source category: `0521`
- validation class: `458`
- source image route: `HUST-OBC/deciphered/0521/G_0521_乙5061合13517賓組.png`
- asset id: `asset-000464`
...
- English observation: `A broad arched stroke has a short central stem
  rising from its top and two long slightly curved strokes descending from
...
- dataset label text: `㗿`
- dataset label codepoints: `U+35FF`
...
- filename catalog route clues: `Heji-like filename clue: 合13517
...
- Which source records identify obs-char-000459 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000459？
