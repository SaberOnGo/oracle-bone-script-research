# Material Visual Observation / obs-comp-cand-001814 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001814`
- External reference / 外部参照: `obimd-sub-srr795shtm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018035_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/srr795shtm/srr795shtm/srr795shtm.png`
- Checksum / 校验和:
  `83a10c898f62aed41c9bd914a04762d16c06b46edffcf400f7ddd7e78c7f5b85`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.89%.
- Marked-pixel bounds: (98,20)–(150,230); span 53 × 211 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.89%。
- 痕迹范围：(98,20)–(150,230)；跨度53 × 211 px；痕迹矩形高于宽。
