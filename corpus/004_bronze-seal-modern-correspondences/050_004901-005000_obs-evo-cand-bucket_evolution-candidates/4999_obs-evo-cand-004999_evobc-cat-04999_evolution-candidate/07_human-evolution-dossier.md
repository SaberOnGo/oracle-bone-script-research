...
Project ID: `obs-evo-cand-004999`
...
- Project ID: `obs-evo-cand-004999`
- EVOBC category candidate ID: `evobc-evo-cat-04999`
- External category reference: `evobc-cat-04999`
- Source category ID: `04999`
- Source label for human review: `瀪`
- Source codepoints: `U+702A`
...
- `obs-evo-cand-004999-route-category-staging`
...
- `obs-evo-cand-004999-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004999-route-evolution-graph`
