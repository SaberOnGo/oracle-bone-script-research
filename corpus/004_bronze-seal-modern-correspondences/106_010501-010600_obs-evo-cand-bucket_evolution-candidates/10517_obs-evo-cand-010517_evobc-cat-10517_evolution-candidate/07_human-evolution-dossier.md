...
- Project ID: `obs-evo-cand-010517`
- EVOBC category candidate ID: `evobc-evo-cat-10517`
- External category reference: `evobc-cat-10517`
- Source category ID: `10517`
- Source label for human review: `鵬`
- Source codepoints: `U+9D6C`
...
- `obs-evo-cand-010517-route-category-staging`
...
- `obs-evo-cand-010517-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010517-route-evolution-graph`
