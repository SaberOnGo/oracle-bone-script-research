...
- External category reference: `evobc-cat-09363`
- Source category ID: `09363`
- Source label for human review: `鉛`
- Source codepoints: `U+925B`
...
- `obs-evo-cand-009363-route-category-staging`
...
- `obs-evo-cand-009363-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009363-route-evolution-graph`
