...
Project ID: `obs-insc-cw-cand-000129`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000129`
...
- Yingguo / 英国所藏: `y680` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `262` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `677` in source row; primary catalog entry pending
- Heji / 合集: `40345` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000129`
