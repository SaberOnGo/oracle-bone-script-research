# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-005501
...
- EVOBC candidate category: `evobc-evo-cat-05501`.
- Source label for search only: `瓛`.
- Source codepoints for search only: `U+74DB`.
