...
- External category reference: `evobc-cat-08543`
- Source category ID: `08543`
- Source label for human review: `貪`
...
- `obs-evo-cand-008543-route-category-staging`
...
- `obs-evo-cand-008543-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008543-route-evolution-graph`
