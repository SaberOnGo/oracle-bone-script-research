...
- External category reference: `evobc-cat-02150`
- Source category ID: `02150`
- Source label for human review: `姿`
- Source codepoints: `U+59FF`
...
- `obs-evo-cand-002150-route-category-staging`
...
- `obs-evo-cand-002150-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002150-route-evolution-graph`
