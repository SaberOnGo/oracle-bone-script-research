...
- External category reference: `evobc-cat-11763`
- Source category ID: `11763`
- Source label for human review: `𥃂`
- Source codepoints: `U+250C2`
...
- `obs-evo-cand-011763-route-category-staging`
...
- `obs-evo-cand-011763-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011763-route-evolution-graph`
