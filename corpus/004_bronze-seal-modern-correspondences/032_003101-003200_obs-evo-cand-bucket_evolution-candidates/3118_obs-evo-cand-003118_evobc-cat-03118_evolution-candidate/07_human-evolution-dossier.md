...
Project ID: `obs-evo-cand-003118`
...
- Project ID: `obs-evo-cand-003118`
- EVOBC category candidate ID: `evobc-evo-cat-03118`
- External category reference: `evobc-cat-03118`
- Source category ID: `03118`
- Source label for human review: `慙`
- Source codepoints: `U+6159`
...
- `obs-evo-cand-003118-route-category-staging`
...
- `obs-evo-cand-003118-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003118-route-evolution-graph`
