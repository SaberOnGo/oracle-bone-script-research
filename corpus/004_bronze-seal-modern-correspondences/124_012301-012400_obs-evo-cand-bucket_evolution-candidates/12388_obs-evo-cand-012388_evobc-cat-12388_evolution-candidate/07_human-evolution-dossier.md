...
- Project ID: `obs-evo-cand-012388`
- EVOBC category candidate ID: `evobc-evo-cat-12388`
- External category reference: `evobc-cat-12388`
- Source category ID: `12388`
- Source label for human review: `𨗩`
- Source codepoints: `U+285E9`
...
- `obs-evo-cand-012388-route-category-staging`
...
- `obs-evo-cand-012388-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012388-route-evolution-graph`
