# Material Visual Observation / obs-comp-cand-000452 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000452`
- External reference / 外部参照: `obimd-sub-c15glxokfb`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012600_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/y0f5gu3q0a/c15glxokfb/c15glxokfb.png`
- Checksum / 校验和:
  `7c50447f4f1c09aabafd8cd1f74e87847179d0ba17f996ee778f4eee4ebf13c5`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.66%.
- Marked-pixel bounds: (63,29)–(186,209); span 124 × 181 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.66%。
- 痕迹范围：(63,29)–(186,209)；跨度124 × 181 px；痕迹矩形高于宽。
