# Material Visual Observation / obs-comp-cand-001487 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001487`
- External reference / 外部参照: `obimd-sub-cz9doc0d73`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016064_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cz9doc0d73/cz9doc0d73/cz9doc0d73.png`
- Checksum / 校验和:
  `e9fa4cf9761ba334b4509541871f520faa6b7abf9a24c9f8599b4977af88878c`
...
- Marked-pixel bounds: (76,30)–(169,224); span 94 × 195 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.86%。
- 痕迹范围：(76,30)–(169,224)；跨度94 × 195 px；痕迹矩形高于宽。
