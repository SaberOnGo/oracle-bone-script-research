# obs-evo-cand-000294 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-00294`
- Source label: `䇂`
- Source codepoints: `U+41C2`
- Image reference count: `131`
- Era token counts: `OBC:131`
- Source token counts: `Book:48;Web:83`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 131 image references
