# Material Visual Observation / obs-comp-cand-001290 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001290`
- External reference / 外部参照: `obimd-sub-g4i0301407`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015575_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vtg60f34gv/g4i0301407/g4i0301407.png`
- Checksum / 校验和:
  `685504284a04142323f28ad417e86320d23f75af7ec327e385160f93c1c484cd`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.13%.
- Marked-pixel bounds: (86,25)–(163,229); span 78 × 205 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.13%。
- 痕迹范围：(86,25)–(163,229)；跨度78 × 205 px；痕迹矩形高于宽。
