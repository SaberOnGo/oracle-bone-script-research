# obs-comp-cand-000599 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000599`
- 首选外部 ID: `obimd-sub-ptbmxdfm3i`
- OBIMD subcharacter UID: `ptbmxdfm3i`
- OBIMD main character UID: `ptbmxdfm3i`
- 来源 ID: `src-obimd`
