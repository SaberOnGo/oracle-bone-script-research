# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002737
...
| Glyph or codepoint route / 字形或码位路线 | 6 OBIMD route rows; examples U+FF727; U+FF728; 另有 4 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
