...
- External category reference: `evobc-cat-03202`
- Source category ID: `03202`
- Source label for human review: `戍`
...
- `obs-evo-cand-003202-route-category-staging`
...
- `obs-evo-cand-003202-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003202-route-evolution-graph`
