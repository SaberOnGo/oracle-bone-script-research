...
- External category reference: `evobc-cat-00843`
- Source category ID: `00843`
- Source label for human review: `侐`
...
- `obs-evo-cand-000843-route-category-staging`
...
- `obs-evo-cand-000843-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000843-route-evolution-graph`
