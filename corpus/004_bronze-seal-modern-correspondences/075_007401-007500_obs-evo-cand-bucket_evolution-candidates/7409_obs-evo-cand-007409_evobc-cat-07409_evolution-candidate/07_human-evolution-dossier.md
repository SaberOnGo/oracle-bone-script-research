...
- External category reference: `evobc-cat-07409`
- Source category ID: `07409`
...
- `obs-evo-cand-007409-route-category-staging`
...
- `obs-evo-cand-007409-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007409-route-evolution-graph`
