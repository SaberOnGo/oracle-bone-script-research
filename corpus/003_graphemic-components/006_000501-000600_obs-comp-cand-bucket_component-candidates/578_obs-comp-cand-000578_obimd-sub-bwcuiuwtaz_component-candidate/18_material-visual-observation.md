# Material Visual Observation / obs-comp-cand-000578 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000578`
- External reference / 外部参照: `obimd-sub-bwcuiuwtaz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013106_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bwcuiuwtaz/bwcuiuwtaz/bwcuiuwtaz.png`
- Checksum / 校验和:
  `ccef167c13842c17e9f80480833ae4b942327a6a27521b531689ff397794e2ef`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.94%.
- Marked-pixel bounds: (53,37)–(196,212); span 144 × 176 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.94%。
- 痕迹范围：(53,37)–(196,212)；跨度144 × 176 px；痕迹矩形高于宽。
