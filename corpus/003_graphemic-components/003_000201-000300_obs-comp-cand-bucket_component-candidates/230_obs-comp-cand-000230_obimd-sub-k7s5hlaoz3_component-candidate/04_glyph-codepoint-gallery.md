# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000230
...
| --- | --- | --- | --- |
| `obimd-glyph-link-003255` | 艿󱕻 | `U+827F;U+F157B` | `reviewed_metadata_only` |
| `obimd-glyph-link-003256` | 󱕼 | `U+F157C` | `reviewed_metadata_only` |
| `obimd-glyph-link-003257` | 󱕽 | `U+F157D` | `reviewed_metadata_only` |
| `obimd-glyph-link-003258` | 󱕾 | `U+F157E` | `reviewed_metadata_only` |
| `obimd-glyph-link-003259` | 󱕿 | `U+F157F` | `reviewed_metadata_only` |
