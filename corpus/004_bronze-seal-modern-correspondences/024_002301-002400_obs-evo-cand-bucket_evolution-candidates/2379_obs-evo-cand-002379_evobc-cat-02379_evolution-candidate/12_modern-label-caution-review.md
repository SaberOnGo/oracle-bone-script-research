# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002379
...
- EVOBC candidate category: `evobc-evo-cat-02379`.
- Source label for search only: `宝`.
- Source codepoints for search only: `U+5B9D`.
