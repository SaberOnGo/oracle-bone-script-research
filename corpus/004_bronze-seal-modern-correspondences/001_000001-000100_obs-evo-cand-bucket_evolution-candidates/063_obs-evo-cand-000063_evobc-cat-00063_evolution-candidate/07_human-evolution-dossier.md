...
- Project ID: `obs-evo-cand-000063`
- EVOBC category candidate ID: `evobc-evo-cat-00063`
- External category reference: `evobc-cat-00063`
- Source category ID: `00063`
- Source label for human review: `㜳`
- Source codepoints: `U+3733`
...
- `obs-evo-cand-000063-route-category-staging`
...
- `obs-evo-cand-000063-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000063-route-evolution-graph`
