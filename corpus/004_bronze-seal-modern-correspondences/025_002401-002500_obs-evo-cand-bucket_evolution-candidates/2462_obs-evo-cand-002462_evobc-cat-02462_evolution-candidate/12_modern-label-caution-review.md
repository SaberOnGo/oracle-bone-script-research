# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002462
...
- EVOBC candidate category: `evobc-evo-cat-02462`.
- Source label for search only: `尊`.
- Source codepoints for search only: `U+5C0A`.
