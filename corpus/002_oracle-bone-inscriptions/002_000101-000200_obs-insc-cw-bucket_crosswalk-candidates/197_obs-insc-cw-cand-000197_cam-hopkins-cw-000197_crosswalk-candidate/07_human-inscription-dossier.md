...
- Yingguo / 英国所藏: `y1177` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `242` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `449` in source row; primary catalog entry pending
- Heji / 合集: `40437` in source row; primary catalog entry pending
