# obs-unk-004093 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/093_obs-unk-004093_h
  ust-obc-und-L-004093_oracle-character-candidate/03_visual-assets/001_asset
  -005686_hust-obc-und-L-004093_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4093/L_？_8798.jpg`
- asset id: `asset-005686`
...
- source class: `HUST-OBC/undeciphered/L/4093/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4093/L_？_8798.jpg`
- asset id: `asset-005686`
...
- English observation: Two adjacent dark trace clusters are visible. The left
  cluster has short slanting marks and a denser lower area; the right cluster
  has a thin upright trace with an angled or curved lower end.
...
- Which source records identify obs-unk-004093 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004093？
