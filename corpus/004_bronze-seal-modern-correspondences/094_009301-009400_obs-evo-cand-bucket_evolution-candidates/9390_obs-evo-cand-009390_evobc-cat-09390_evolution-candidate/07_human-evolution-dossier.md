...
Project ID: `obs-evo-cand-009390`
...
- Project ID: `obs-evo-cand-009390`
- EVOBC category candidate ID: `evobc-evo-cat-09390`
- External category reference: `evobc-cat-09390`
- Source category ID: `09390`
- Source label for human review: `銚`
- Source codepoints: `U+929A`
...
- `obs-evo-cand-009390-route-category-staging`
...
- `obs-evo-cand-009390-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009390-route-evolution-graph`
