...
- External category reference: `evobc-cat-09820`
- Source category ID: `09820`
- Source label for human review: `雗`
- Source codepoints: `U+96D7`
...
- `obs-evo-cand-009820-route-category-staging`
...
- `obs-evo-cand-009820-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009820-route-evolution-graph`
