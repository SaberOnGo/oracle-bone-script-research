...
Project ID: `obs-evo-cand-011866`
...
- Project ID: `obs-evo-cand-011866`
- EVOBC category candidate ID: `evobc-evo-cat-11866`
- External category reference: `evobc-cat-11866`
- Source category ID: `11866`
- Source label for human review: `𥪶`
- Source codepoints: `U+25AB6`
...
- `obs-evo-cand-011866-route-category-staging`
...
- `obs-evo-cand-011866-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011866-route-evolution-graph`
