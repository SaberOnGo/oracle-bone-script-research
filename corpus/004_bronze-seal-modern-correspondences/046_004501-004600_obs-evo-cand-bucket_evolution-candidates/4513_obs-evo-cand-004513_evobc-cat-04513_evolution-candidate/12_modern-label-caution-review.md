# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004513
...
- EVOBC candidate category: `evobc-evo-cat-04513`.
- Source label for search only: `汭`.
- Source codepoints for search only: `U+6C6D`.
