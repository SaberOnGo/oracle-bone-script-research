# obs-unk-002130 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002130`
- primary external id: `hust-obc-und-L-002130`
...
- local review image route: `corpus/001_oracle-characters/038_undeciphered-002
  101-002200_obs-unk-bucket_oracle-character-candidates/030_obs-unk-002130_h
  ust-obc-und-L-002130_oracle-character-candidate/03_visual-assets/001_asset
  -003723_hust-obc-und-L-002130_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2130/L_？_2392.jpg`
- asset id: `asset-003723`
...
- source class: `HUST-OBC/undeciphered/L/2130/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2130/L_？_2392.jpg`
- asset id: `asset-003723`
...
- Which source records identify obs-unk-002130 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002130？
