...
Project ID: `obs-evo-cand-011997`
...
- Project ID: `obs-evo-cand-011997`
- EVOBC category candidate ID: `evobc-evo-cat-11997`
- External category reference: `evobc-cat-11997`
- Source category ID: `11997`
- Source label for human review: `𦌵`
- Source codepoints: `U+26335`
...
- `obs-evo-cand-011997-route-category-staging`
...
- `obs-evo-cand-011997-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011997-route-evolution-graph`
