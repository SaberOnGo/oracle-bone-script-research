...
Project ID: `obs-evo-cand-010830`
...
- Project ID: `obs-evo-cand-010830`
- EVOBC category candidate ID: `evobc-evo-cat-10830`
- External category reference: `evobc-cat-10830`
- Source category ID: `10830`
- Source label for human review: `𠒤`
- Source codepoints: `U+204A4`
...
- `obs-evo-cand-010830-route-category-staging`
...
- `obs-evo-cand-010830-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010830-route-evolution-graph`
