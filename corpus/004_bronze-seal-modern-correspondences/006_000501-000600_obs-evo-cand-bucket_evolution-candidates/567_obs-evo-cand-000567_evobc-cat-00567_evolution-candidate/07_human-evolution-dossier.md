...
- External category reference: `evobc-cat-00567`
- Source category ID: `00567`
- Source label for human review: `䮺`
...
- `obs-evo-cand-000567-route-category-staging`
...
- `obs-evo-cand-000567-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000567-route-evolution-graph`
