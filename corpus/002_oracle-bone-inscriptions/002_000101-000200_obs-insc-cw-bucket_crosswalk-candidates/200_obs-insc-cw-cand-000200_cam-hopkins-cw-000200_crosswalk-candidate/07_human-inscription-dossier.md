...
- Yingguo / 英国所藏: `y1180` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `41` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `664` in source row; primary catalog entry pending
- Heji / 合集: `40438` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000200`
