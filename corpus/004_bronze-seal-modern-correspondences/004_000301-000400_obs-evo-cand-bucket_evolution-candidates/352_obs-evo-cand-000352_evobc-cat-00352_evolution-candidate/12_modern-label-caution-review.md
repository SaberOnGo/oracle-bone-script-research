# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000352
...
- EVOBC candidate category: `evobc-evo-cat-00352`.
- Source label for search only: `䏛`.
- Source codepoints for search only: `U+43DB`.
