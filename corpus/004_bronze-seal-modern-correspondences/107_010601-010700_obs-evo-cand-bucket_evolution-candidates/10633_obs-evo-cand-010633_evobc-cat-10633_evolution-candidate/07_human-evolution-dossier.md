...
- External category reference: `evobc-cat-10633`
- Source category ID: `10633`
- Source label for human review: `黂`
- Source codepoints: `U+9EC2`
...
- `obs-evo-cand-010633-route-category-staging`
...
- `obs-evo-cand-010633-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010633-route-evolution-graph`
