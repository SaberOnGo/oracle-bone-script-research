# obs-char-000297 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000297`
- primary external id: `hust-obc-cat-0336_0337`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/297_obs-char-000297_hust-obc-cat-0336_0337
  _oracle-character/03_visual-assets/001_asset-000302_hust-obc-cat-0336_0337
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0336_0337/0336/G_0336_甲骨文0.png`
- asset id: `asset-000302`
...
- source category: `0336_0337`
- validation class: `296`
- source image route: `HUST-OBC/deciphered/0336_0337/0336/G_0336_甲骨文0.png`
- asset id: `asset-000302`
...
- English observation: `The image consists of two vertically stacked rounded
  rectangular outlines with a narrow gap and no clearly visible interior
  mark.`
- 中文观察: `图像由上下叠置的两个圆角长方形轮廓组成，中间有狭窄间隔，未见清楚的内部痕迹。`
...
- dataset label text: `㕆㕇`
- dataset label codepoints: `U+3546;U+3547`
...
- graph edge count: `2`
- codepoint routes: `U+3546;U+3547`
...
- Which source records identify obs-char-000297 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000297？
