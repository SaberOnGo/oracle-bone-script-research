# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008500
...
- EVOBC candidate category: `evobc-evo-cat-08500`.
- Source label for search only: `豫`.
- Source codepoints for search only: `U+8C6B`.
