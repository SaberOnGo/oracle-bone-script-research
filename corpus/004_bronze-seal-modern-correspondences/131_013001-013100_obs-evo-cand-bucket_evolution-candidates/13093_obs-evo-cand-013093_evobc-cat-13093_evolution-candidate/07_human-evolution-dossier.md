...
Project ID: `obs-evo-cand-013093`
...
- Project ID: `obs-evo-cand-013093`
- EVOBC category candidate ID: `evobc-evo-cat-13093`
- External category reference: `evobc-cat-13093`
- Source category ID: `13093`
- Source label for human review: `𫳗`
- Source codepoints: `U+2BCD7`
...
- `obs-evo-cand-013093-route-category-staging`
...
- `obs-evo-cand-013093-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013093-route-evolution-graph`
