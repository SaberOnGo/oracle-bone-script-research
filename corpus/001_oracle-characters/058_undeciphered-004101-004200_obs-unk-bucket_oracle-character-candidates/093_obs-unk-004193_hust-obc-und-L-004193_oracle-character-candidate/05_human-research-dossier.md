# obs-unk-004193 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/093_obs-unk-004193_h
  ust-obc-und-L-004193_oracle-character-candidate/03_visual-assets/001_asset
  -005786_hust-obc-und-L-004193_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4193/L_？_9132.jpg`
- asset id: `asset-005786`
...
- source class: `HUST-OBC/undeciphered/L/4193/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4193/L_？_9132.jpg`
- asset id: `asset-005786`
...
- English observation: `Upright trace, rounded mark, and lower turn visible.`
- 中文观察: `直立痕迹、弧形痕迹和下部转折可见。`
...
- Which source records identify obs-unk-004193 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004193？
