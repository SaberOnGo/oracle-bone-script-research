# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008323
...
- EVOBC candidate category: `evobc-evo-cat-08323`.
- Source label for search only: `謟`.
- Source codepoints for search only: `U+8B1F`.
