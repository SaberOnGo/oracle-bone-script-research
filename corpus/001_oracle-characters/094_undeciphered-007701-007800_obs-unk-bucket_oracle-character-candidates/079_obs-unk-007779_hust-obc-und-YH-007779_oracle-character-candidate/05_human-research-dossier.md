# obs-unk-007779 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/094_undeciphered-007
  701-007800_obs-unk-bucket_oracle-character-candidates/079_obs-unk-007779_h
  ust-obc-und-YH-007779_oracle-character-candidate/03_visual-assets/001_asse
  t-009370_hust-obc-und-YH-007779_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6033C/H_？_6033C_0.png`
- asset id: `asset-009370`
...
- source class: `HUST-OBC/undeciphered/Y+H/6033C/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6033C/H_？_6033C_0.png`
...
- Which source records identify obs-unk-007779 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007779？
