# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012304
...
- EVOBC candidate category: `evobc-evo-cat-12304`.
- Source label for search only: `𧽊`.
- Source codepoints for search only: `U+27F4A`.
