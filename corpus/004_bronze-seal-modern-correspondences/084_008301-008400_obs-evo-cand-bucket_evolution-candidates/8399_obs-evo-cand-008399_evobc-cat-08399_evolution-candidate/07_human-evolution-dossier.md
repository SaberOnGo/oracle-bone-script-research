...
- Project ID: `obs-evo-cand-008399`
- EVOBC category candidate ID: `evobc-evo-cat-08399`
- External category reference: `evobc-cat-08399`
- Source category ID: `08399`
- Source label for human review: `讟`
- Source codepoints: `U+8B9F`
...
- `obs-evo-cand-008399-route-category-staging`
...
- `obs-evo-cand-008399-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008399-route-evolution-graph`
