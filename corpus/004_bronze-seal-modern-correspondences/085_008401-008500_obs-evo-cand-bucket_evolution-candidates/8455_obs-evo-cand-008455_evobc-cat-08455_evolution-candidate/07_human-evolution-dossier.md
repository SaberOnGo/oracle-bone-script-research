...
- External category reference: `evobc-cat-08455`
- Source category ID: `08455`
- Source label for human review: `谘`
- Source codepoints: `U+8C18`
...
- `obs-evo-cand-008455-route-category-staging`
...
- `obs-evo-cand-008455-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008455-route-evolution-graph`
