...
- Project ID: `obs-evo-cand-005285`
- EVOBC category candidate ID: `evobc-evo-cat-05285`
- External category reference: `evobc-cat-05285`
- Source category ID: `05285`
- Source label for human review: `狽`
- Source codepoints: `U+72FD`
...
- `obs-evo-cand-005285-route-category-staging`
...
- `obs-evo-cand-005285-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005285-route-evolution-graph`
