# obs-unk-004227 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004227`
- primary external id: `hust-obc-und-L-004227`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/027_obs-unk-004227_h
  ust-obc-und-L-004227_oracle-character-candidate/03_visual-assets/001_asset
  -005820_hust-obc-und-L-004227_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4227/L_？_9253.jpg`
- asset id: `asset-005820`
...
- source class: `HUST-OBC/undeciphered/L/4227/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4227/L_？_9253.jpg`
- asset id: `asset-005820`
...
- English observation: `Upper marks, rounded form, lower curve visible.`
- 中文观察: `上部痕迹、圆弧形态和下部弯曲笔画可见。`
...
- Which source records identify obs-unk-004227 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004227？
