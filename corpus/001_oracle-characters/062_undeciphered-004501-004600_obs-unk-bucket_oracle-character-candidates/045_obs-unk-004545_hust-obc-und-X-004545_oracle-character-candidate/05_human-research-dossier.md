# obs-unk-004545 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/045_obs-unk-004545_h
  ust-obc-und-X-004545_oracle-character-candidate/03_visual-assets/001_asset
  -006138_hust-obc-und-X-004545_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/101/X_？_8284_1.png`
- asset id: `asset-006138`
...
- source class: `HUST-OBC/undeciphered/X/101/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/101/X_？_8284_1.png`
- asset id: `asset-006138`
...
- English observation: `Junction, four lobes, and count mismatch recorded.`
- 中文观察: `已记录中央连接处、四个区域和数量不一致。`
...
- Which source records identify obs-unk-004545 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004545？
