# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006519
...
- EVOBC candidate category: `evobc-evo-cat-06519`.
- Source label for search only: `絬`.
- Source codepoints for search only: `U+7D6C`.
