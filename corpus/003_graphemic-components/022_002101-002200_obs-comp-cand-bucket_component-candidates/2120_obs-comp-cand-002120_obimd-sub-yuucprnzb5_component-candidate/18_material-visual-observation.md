# Material Visual Observation / obs-comp-cand-002120 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002120`
- External reference / 外部参照: `obimd-sub-yuucprnzb5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019677_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/yuucprnzb5/yuucprnzb5/yuucprnzb5.png`
- Checksum / 校验和:
  `a8be2c8cb6a23a4c82f1680470c23e729c8a740a97336f750a7d89f047496579`
...
- Marked-pixel bounds: (71,18)–(171,228); span 101 × 211 px; the marked
...
- 痕迹范围：(71,18)–(171,228)；跨度101 × 211 px；痕迹矩形高于宽。
