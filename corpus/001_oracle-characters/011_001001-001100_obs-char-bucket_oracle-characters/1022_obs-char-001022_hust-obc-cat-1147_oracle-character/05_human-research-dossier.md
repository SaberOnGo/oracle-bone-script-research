# obs-char-001022 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001022`
- primary external id: `hust-obc-cat-1147`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1022_obs-char-001022_hust-obc-cat-1147_ora
  cle-character/03_visual-assets/001_asset-001027_hust-obc-cat-1147_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1147/G_1147_乙4057(甲).png`
- asset id: `asset-001027`
...
- source category: `1147`
- validation class: `1021`
- source image route: `HUST-OBC/deciphered/1147/G_1147_乙4057(甲).png`
- asset id: `asset-001027`
...
- English observation: `A low elongated enclosure has a thick left base, a
  pointed right extension, and a short branching stroke above.`
- 中文观察: `低位狭长闭合轮廓有粗重左侧底部、尖状右侧外伸和上方短分枝笔。`
...
- dataset label text: `㡱`
- dataset label codepoints: `U+3871`
...
- Which source records identify obs-char-001022 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001022？
