# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008511
...
- EVOBC candidate category: `evobc-evo-cat-08511`.
- Source label for search only: `豺`.
- Source codepoints for search only: `U+8C7A`.
