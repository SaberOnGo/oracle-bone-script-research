...
Project ID: `obs-evo-cand-007551`
...
- Project ID: `obs-evo-cand-007551`
- EVOBC category candidate ID: `evobc-evo-cat-07551`
- External category reference: `evobc-cat-07551`
- Source category ID: `07551`
- Source label for human review: `蔓`
- Source codepoints: `U+8513`
...
- `obs-evo-cand-007551-route-category-staging`
...
- `obs-evo-cand-007551-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007551-route-evolution-graph`
