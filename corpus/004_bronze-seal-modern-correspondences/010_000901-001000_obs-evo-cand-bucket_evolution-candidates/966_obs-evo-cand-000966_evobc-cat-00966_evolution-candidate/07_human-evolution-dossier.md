...
- External category reference: `evobc-cat-00966`
- Source category ID: `00966`
- Source label for human review: `偰`
- Source codepoints: `U+5070`
...
- `obs-evo-cand-000966-route-category-staging`
...
- `obs-evo-cand-000966-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000966-route-evolution-graph`
