# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010362
...
- EVOBC candidate category: `evobc-evo-cat-10362`.
- Source label for search only: `魋`.
- Source codepoints for search only: `U+9B4B`.
