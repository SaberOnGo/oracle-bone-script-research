...
- `obs-evo-cand-009244-route-category-staging`
...
- `obs-evo-cand-009244-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009244-route-evolution-graph`
