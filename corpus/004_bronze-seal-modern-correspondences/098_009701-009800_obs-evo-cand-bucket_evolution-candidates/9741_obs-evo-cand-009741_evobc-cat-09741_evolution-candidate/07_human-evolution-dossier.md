...
- Project ID: `obs-evo-cand-009741`
- EVOBC category candidate ID: `evobc-evo-cat-09741`
- External category reference: `evobc-cat-09741`
- Source category ID: `09741`
- Source label for human review: `险`
- Source codepoints: `U+9669`
...
- `obs-evo-cand-009741-route-category-staging`
...
- `obs-evo-cand-009741-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009741-route-evolution-graph`
