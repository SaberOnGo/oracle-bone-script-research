# Archaeological Context Review / 考古语境复核: coll-obj-cand-00016
...
| Catalog or accession | `R044636`; joined label needs independent catalog check | `02_collection-source-index.csv`; `18_live-source-evidence-review.md` |
| Source item | `778` | `01_collection-object-packet.json` |
| Catalog description | `I 4603` | `01_collection-object-packet.json` |
| Image route | `local_private_visual_inspection_only`; rights review required | `03_collection-source-index.csv`; `18_live-source-evidence-review.md` |
