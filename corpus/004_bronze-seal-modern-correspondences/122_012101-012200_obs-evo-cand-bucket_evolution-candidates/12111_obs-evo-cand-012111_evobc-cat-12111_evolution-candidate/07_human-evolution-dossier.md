...
- External category reference: `evobc-cat-12111`
- Source category ID: `12111`
- Source label for human review: `𦵯`
...
- `obs-evo-cand-012111-route-category-staging`
...
- `obs-evo-cand-012111-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012111-route-evolution-graph`
