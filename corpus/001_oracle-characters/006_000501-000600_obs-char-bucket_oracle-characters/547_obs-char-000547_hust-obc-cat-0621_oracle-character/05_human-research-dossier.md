# obs-char-000547 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/547_obs-char-000547_hust-obc-cat-0621_orac
  le-character/03_visual-assets/001_asset-000552_hust-obc-cat-0621_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0621/G_0621_乙6275合9654.png`
- asset id: `asset-000552`
...
- source category: `0621`
- validation class: `546`
- source image route: `HUST-OBC/deciphered/0621/G_0621_乙6275合9654.png`
- asset id: `asset-000552`
...
- English observation: `A small pointed upper loop is crossed by a narrow
  central stem and a short rightward diagonal, above a long tapered
  descending stroke.`
- 中文观察: `小型尖顶上环被狭窄中央干和右向短斜笔穿过，下方延伸一条长渐尖下行笔。`
...
- dataset label text: `㙣`
- dataset label codepoints: `U+3663`
...
- filename catalog route clues: `Heji-like filename clue: 合9654
  (G_0621_乙6275合9654.png)`
...
- Which source records identify obs-char-000547 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000547？
