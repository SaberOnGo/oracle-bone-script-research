# Material Visual Observation / obs-comp-cand-001182 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001182`
- External reference / 外部参照: `obimd-sub-yxs0sfuelg`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015372_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4vpgmxwaa2/yxs0sfuelg/yxs0sfuelg.png`
- Checksum / 校验和:
  `1fcfb9b38716574e5b53ef634bcac280f771625cf61b7b74e3a7650880421d82`
...
- Marked-pixel bounds: (96,33)–(153,216); span 58 × 184 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.39%。
- 痕迹范围：(96,33)–(153,216)；跨度58 × 184 px；痕迹矩形高于宽。
