# obs-evo-cand-002624 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-002624`
- EVOBC category candidate ID: `evobc-evo-cat-02624`
- External category ref: `evobc-cat-02624`
- Source label: `己`
- Source codepoints: `U+5DF1`
- Image reference count: `252`
- Era token counts: `BI:68;CS:2;OBC:47;SAC:9;SS:3;WSC:123`
- Source token counts: `Book:96;Web:156`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 47 image references
- era 1 / BI: 68 image references
- era 2 / SS: 3 image references
- era 3 / SAC: 9 image references
- era 4 / WSC: 123 image references
- era 5 / CS: 2 image references
- source 0 / Web:1633: 1 image references
- source 1 / Web:105952;說文Web:58: 135 image references
- source 2 / Book:17600: 20 image references
- source 3 / Book:21681: 35 image references
