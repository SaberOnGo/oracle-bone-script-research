# obs-char-001122 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1122_obs-char-001122_hust-obc-cat-1253_ora
  cle-character/03_visual-assets/001_asset-001127_hust-obc-cat-1253_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1253/G_1253_乙3415反合12939反賓組.png
  `
- asset id: `asset-001127`
...
- source category: `1253`
- validation class: `1121`
- source image route: `HUST-OBC/deciphered/1253/G_1253_乙3415反合12939反賓組.png`
- asset id: `asset-001127`
...
- English observation: `A narrow upright cluster has repeated short side
  branches around a central stem and pointed lower strokes.`
- 中文观察: `狭长直立笔群围绕中央笔干有重复的短侧分枝和尖状下部笔。`
...
- dataset label text: `㣛`
- dataset label codepoints: `U+38DB`
...
- matched OBIMD main UIDs: `swd7pw3btv`
...
- filename catalog route clues: `Heji-like filename clue: 合12939
...
- Which source records identify obs-char-001122 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001122？
