...
- External category reference: `evobc-cat-01686`
- Source category ID: `01686`
- Source label for human review: `嗿`
...
- `obs-evo-cand-001686-route-category-staging`
...
- `obs-evo-cand-001686-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001686-route-evolution-graph`
