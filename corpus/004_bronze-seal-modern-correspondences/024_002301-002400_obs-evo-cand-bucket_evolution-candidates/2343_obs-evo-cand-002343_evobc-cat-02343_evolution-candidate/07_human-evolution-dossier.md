...
- External category reference: `evobc-cat-02343`
- Source category ID: `02343`
- Source label for human review: `孫`
- Source codepoints: `U+5B6B`
- Image reference count in source metadata: `241`
...
- `obs-evo-cand-002343-route-category-staging`
...
- `obs-evo-cand-002343-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002343-route-evolution-graph`
