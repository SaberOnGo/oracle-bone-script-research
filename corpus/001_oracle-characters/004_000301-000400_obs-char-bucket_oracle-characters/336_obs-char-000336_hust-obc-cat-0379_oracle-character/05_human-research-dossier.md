# obs-char-000336 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/336_obs-char-000336_hust-obc-cat-0379_orac
  le-character/03_visual-assets/001_asset-000341_hust-obc-cat-0379_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0379/G_0379_後2.25.6(甲).png`
- asset id: `asset-000341`
...
- source category: `0379`
- validation class: `335`
- source image route: `HUST-OBC/deciphered/0379/G_0379_後2.25.6(甲).png`
- asset id: `asset-000341`
...
- English observation: `A thin central vertical stroke is flanked by two
  outward curved forms and a small rounded mark at the top.`
- 中文观察: `纤细中部直笔画两侧有向外弯曲的形体，顶部另有小型圆弧痕迹。`
...
- dataset label text: `㕱`
- dataset label codepoints: `U+3571`
...
- Which source records identify obs-char-000336 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000336？
