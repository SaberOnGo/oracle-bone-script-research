# Material Visual Observation / obs-comp-cand-000287 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000287`
- External reference / 外部参照: `obimd-sub-cdi7snpjks`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011950_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rlx0knkq0v/cdi7snpjks/02ufik6rl9.png`
- Checksum / 校验和:
  `15e80ce0a15402680c0741ba8e4f79694f9b5e56c6565b0d9e9f8005230171b4`
...
- Marked-pixel bounds: (84,29)–(165,220); span 82 × 192 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.52%。
- 痕迹范围：(84,29)–(165,220)；跨度82 × 192 px；痕迹矩形高于宽。
