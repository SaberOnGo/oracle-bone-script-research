# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002568
...
- Project ID: `obs-evo-cand-002568`.
- EVOBC candidate category: `evobc-evo-cat-02568`.
- Source label for search only: `崝`.
- Source codepoints for search only: `U+5D1D`.
