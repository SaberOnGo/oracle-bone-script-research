# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008135
...
- EVOBC candidate category: `evobc-evo-cat-08135`.
- Source label for search only: `訒`.
- Source codepoints for search only: `U+8A12`.
