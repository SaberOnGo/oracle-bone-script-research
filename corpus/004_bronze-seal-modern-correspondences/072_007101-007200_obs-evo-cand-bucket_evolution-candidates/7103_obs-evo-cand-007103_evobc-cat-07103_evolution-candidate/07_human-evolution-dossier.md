...
Project ID: `obs-evo-cand-007103`
...
- Project ID: `obs-evo-cand-007103`
- EVOBC category candidate ID: `evobc-evo-cat-07103`
- External category reference: `evobc-cat-07103`
- Source category ID: `07103`
- Source label for human review: `腨`
- Source codepoints: `U+8168`
...
- `obs-evo-cand-007103-route-category-staging`
...
- `obs-evo-cand-007103-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007103-route-evolution-graph`
