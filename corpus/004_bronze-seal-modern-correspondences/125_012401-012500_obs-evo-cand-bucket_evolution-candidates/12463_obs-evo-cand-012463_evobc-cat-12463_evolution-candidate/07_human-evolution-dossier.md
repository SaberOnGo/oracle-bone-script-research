...
- Project ID: `obs-evo-cand-012463`
- EVOBC category candidate ID: `evobc-evo-cat-12463`
- External category reference: `evobc-cat-12463`
- Source category ID: `12463`
- Source label for human review: `𨟇`
- Source codepoints: `U+287C7`
...
- `obs-evo-cand-012463-route-category-staging`
...
- `obs-evo-cand-012463-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012463-route-evolution-graph`
