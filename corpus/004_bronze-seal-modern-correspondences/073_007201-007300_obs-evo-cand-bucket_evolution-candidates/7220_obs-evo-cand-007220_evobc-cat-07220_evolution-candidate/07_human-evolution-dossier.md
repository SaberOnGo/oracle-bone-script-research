...
- External category reference: `evobc-cat-07220`
- Source category ID: `07220`
- Source label for human review: `艵`
- Source codepoints: `U+8275`
...
- `obs-evo-cand-007220-route-category-staging`
...
- `obs-evo-cand-007220-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007220-route-evolution-graph`
