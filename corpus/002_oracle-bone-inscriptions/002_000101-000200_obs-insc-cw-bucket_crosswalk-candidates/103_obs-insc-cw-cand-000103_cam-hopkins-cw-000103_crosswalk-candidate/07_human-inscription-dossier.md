...
Project ID: `obs-insc-cw-cand-000103`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000103`
...
- Yingguo / 英国所藏: `y584` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `264` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `604` in source row; primary catalog entry pending
- Heji / 合集: `39883` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000103`
