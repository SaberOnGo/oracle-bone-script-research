...
- External category reference: `evobc-cat-07554`
- Source category ID: `07554`
- Source label for human review: `蔗`
- Source codepoints: `U+8517`
...
- `obs-evo-cand-007554-route-category-staging`
...
- `obs-evo-cand-007554-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007554-route-evolution-graph`
