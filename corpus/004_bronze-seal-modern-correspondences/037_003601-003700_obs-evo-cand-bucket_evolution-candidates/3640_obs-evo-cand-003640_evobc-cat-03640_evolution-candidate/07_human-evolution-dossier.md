...
- External category reference: `evobc-cat-03640`
- Source category ID: `03640`
- Source label for human review: `斤`
...
- `obs-evo-cand-003640-route-category-staging`
...
- `obs-evo-cand-003640-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003640-route-evolution-graph`
