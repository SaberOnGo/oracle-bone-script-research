# obs-unk-004341 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/041_obs-unk-004341_h
  ust-obc-und-L-004341_oracle-character-candidate/03_visual-assets/001_asset
  -005934_hust-obc-und-L-004341_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4341/L_？_9606.jpg`
- asset id: `asset-005934`
...
- source class: `HUST-OBC/undeciphered/L/4341/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4341/L_？_9606.jpg`
- asset id: `asset-005934`
...
- English observation: `Three adjacent curved traces and their gap recorded.`
- 中文观察: `已记录三条相邻弯痕及其间空隙。`
...
- Which source records identify obs-unk-004341 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004341？
