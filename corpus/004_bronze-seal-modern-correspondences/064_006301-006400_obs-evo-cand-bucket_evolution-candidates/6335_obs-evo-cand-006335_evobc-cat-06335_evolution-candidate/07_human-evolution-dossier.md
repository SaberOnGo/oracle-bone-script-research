...
- External category reference: `evobc-cat-06335`
- Source category ID: `06335`
- Source label for human review: `篼`
...
- `obs-evo-cand-006335-route-category-staging`
...
- `obs-evo-cand-006335-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006335-route-evolution-graph`
