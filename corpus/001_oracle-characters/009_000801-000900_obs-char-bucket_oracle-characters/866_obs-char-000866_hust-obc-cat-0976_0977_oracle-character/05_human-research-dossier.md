# obs-char-000866 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000866`
- primary external id: `hust-obc-cat-0976_0977`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/866_obs-char-000866_hust-obc-cat-0976_0977
  _oracle-character/03_visual-assets/001_asset-000871_hust-obc-cat-0976_0977
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0976_0977/0976/G_0976_甲骨文.png`
- asset id: `asset-000871`
...
- source category: `0976_0977`
- validation class: `865`
- source image route: `HUST-OBC/deciphered/0976_0977/0976/G_0976_甲骨文.png`
- asset id: `asset-000871`
...
- English observation: `Detached marks at left flank a central rounded
  crossing with a horizontal stroke and two lower legs; a short curved mark
  sits at right.`
- 中文观察: `左侧分离痕迹分列中央圆弧交叉形两旁，中央有横笔和两条下支；右侧有短弯笔。`
...
- dataset label text: `㟆㟇`
- dataset label codepoints: `U+37C6;U+37C7`
...
- graph edge count: `2`
- codepoint routes: `U+37C6;U+37C7`
...
- Which source records identify obs-char-000866 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000866？
