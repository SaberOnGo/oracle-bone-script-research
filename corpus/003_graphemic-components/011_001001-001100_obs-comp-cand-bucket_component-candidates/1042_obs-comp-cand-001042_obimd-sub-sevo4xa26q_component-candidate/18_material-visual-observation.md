# Material Visual Observation / obs-comp-cand-001042 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001042`
- External reference / 外部参照: `obimd-sub-sevo4xa26q`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014592_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/sevo4xa26q/sevo4xa26q/sevo4xa26q.png`
- Checksum / 校验和:
  `528840321f1367c3957fc48fc8e28cd1a9b35f28acb59636c55bd7c0b5b1c4af`
...
- Marked-pixel bounds: (79,35)–(170,216); span 92 × 182 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.84%。
- 痕迹范围：(79,35)–(170,216)；跨度92 × 182 px；痕迹矩形高于宽。
