...
- External category reference: `evobc-cat-07248`
- Source category ID: `07248`
- Source label for human review: `芟`
...
- `obs-evo-cand-007248-route-category-staging`
...
- `obs-evo-cand-007248-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007248-route-evolution-graph`
