...
- Project ID: `obs-evo-cand-011043`
- EVOBC category candidate ID: `evobc-evo-cat-11043`
- External category reference: `evobc-cat-11043`
- Source category ID: `11043`
- Source label for human review: `𡞪`
- Source codepoints: `U+217AA`
...
- `obs-evo-cand-011043-route-category-staging`
...
- `obs-evo-cand-011043-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011043-route-evolution-graph`
