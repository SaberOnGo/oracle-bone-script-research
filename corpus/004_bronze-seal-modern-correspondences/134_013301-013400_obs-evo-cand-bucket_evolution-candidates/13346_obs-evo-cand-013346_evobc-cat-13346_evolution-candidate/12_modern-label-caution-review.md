# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013346
...
- EVOBC candidate category: `evobc-evo-cat-13346`.
- Source label for search only: `𬤊`.
- Source codepoints for search only: `U+2C90A`.
