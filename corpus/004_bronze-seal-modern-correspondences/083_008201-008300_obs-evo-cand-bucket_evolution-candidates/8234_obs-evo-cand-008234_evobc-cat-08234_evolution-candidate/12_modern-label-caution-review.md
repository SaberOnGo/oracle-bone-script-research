# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008234
...
- EVOBC candidate category: `evobc-evo-cat-08234`.
- Source label for search only: `語`.
- Source codepoints for search only: `U+8A9E`.
