...
- External category reference: `evobc-cat-12205`
- Source category ID: `12205`
- Source label for human review: `𧠑`
- Source codepoints: `U+27811`
...
- `obs-evo-cand-012205-route-category-staging`
...
- `obs-evo-cand-012205-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012205-route-evolution-graph`
