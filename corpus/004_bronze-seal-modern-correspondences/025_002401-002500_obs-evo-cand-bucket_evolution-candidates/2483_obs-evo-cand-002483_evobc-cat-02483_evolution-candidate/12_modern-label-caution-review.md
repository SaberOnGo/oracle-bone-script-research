# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002483
...
- EVOBC candidate category: `evobc-evo-cat-02483`.
- Source label for search only: `尬`.
- Source codepoints for search only: `U+5C2C`.
