# obs-char-001154 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1154_obs-char-001154_hust-obc-cat-1293_ora
  cle-character/03_visual-assets/001_asset-001159_hust-obc-cat-1293_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1293/G_1293_乙188合21017𠂤組.png`
- asset id: `asset-001159`
...
- source category: `1293`
- validation class: `1153`
- source image route: `HUST-OBC/deciphered/1293/G_1293_乙188合21017𠂤組.png`
- asset id: `asset-001159`
...
- English observation: `A simple rounded vertical enclosure has a straight
  left edge, a curved right edge, and a short lower base stroke.`
...
- dataset label text: `㤃`
- dataset label codepoints: `U+3903`
...
- filename catalog route clues: `Heji-like filename clue: 合21017
...
- Which source records identify obs-char-001154 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001154？
