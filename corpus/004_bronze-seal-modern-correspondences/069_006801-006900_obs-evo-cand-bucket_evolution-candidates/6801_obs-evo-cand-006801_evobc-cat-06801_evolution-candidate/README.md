# obs-evo-cand-006801 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-006801`
- EVOBC category candidate ID: `evobc-evo-cat-06801`
- External category ref: `evobc-cat-06801`
- Source label: `罙`
- Source codepoints: `U+7F59`
- Image reference count: `115`
- Era token counts: `OBC:114;SAC:1`
- Source token counts: `Book:27;Web:88`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 114 image references
