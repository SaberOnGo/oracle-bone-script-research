...
Project ID: `obs-evo-cand-003525`
...
- Project ID: `obs-evo-cand-003525`
- EVOBC category candidate ID: `evobc-evo-cat-03525`
- External category reference: `evobc-cat-03525`
- Source category ID: `03525`
- Source label for human review: `擢`
- Source codepoints: `U+64E2`
...
- `obs-evo-cand-003525-route-category-staging`
...
- `obs-evo-cand-003525-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003525-route-evolution-graph`
