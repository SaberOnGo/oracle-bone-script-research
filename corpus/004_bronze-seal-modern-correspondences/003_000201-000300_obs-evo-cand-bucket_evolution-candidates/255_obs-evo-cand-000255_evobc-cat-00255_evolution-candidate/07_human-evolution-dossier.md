...
- External category reference: `evobc-cat-00255`
- Source category ID: `00255`
- Source label for human review: `㾊`
...
- `obs-evo-cand-000255-route-category-staging`
...
- `obs-evo-cand-000255-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000255-route-evolution-graph`
