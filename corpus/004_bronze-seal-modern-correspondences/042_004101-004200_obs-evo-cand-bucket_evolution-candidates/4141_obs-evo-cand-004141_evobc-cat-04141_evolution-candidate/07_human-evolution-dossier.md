...
- External category reference: `evobc-cat-04141`
- Source category ID: `04141`
- Source label for human review: `楅`
- Source codepoints: `U+6945`
...
- `obs-evo-cand-004141-route-category-staging`
...
- `obs-evo-cand-004141-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004141-route-evolution-graph`
