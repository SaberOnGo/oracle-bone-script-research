...
- Source page section: `Period IV Group 16` /
  `第 IV 期第 16 组`
- Source section key: `period-iv-group-16`
...
- Yingguo / 英国所藏: `y2443` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `590` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `399` in source row; primary catalog entry pending
- Heji / 合集: `41660` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000503`
