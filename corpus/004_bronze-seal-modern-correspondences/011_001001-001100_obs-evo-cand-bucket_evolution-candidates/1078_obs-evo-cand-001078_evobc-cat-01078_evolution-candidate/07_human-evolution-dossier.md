...
- External category reference: `evobc-cat-01078`
- Source category ID: `01078`
- Source label: `兒`
...
- `obs-evo-cand-001078-route-category-staging`
...
- `obs-evo-cand-001078-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-001078-route-evolution-graph`
