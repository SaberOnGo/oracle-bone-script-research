# obs-char-000304 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/304_obs-char-000304_hust-obc-cat-0344_orac
  le-character/03_visual-assets/001_asset-000309_hust-obc-cat-0344_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0344/G_0344_陳160背(甲).png`
- asset id: `asset-000309`
...
- source category: `0344`
- validation class: `303`
- source image route: `HUST-OBC/deciphered/0344/G_0344_陳160背(甲).png`
- asset id: `asset-000309`
...
- English observation: `The image combines a small left enclosure with a
  taller branching upright form and a pointed descending lower stroke.`
- 中文观察: `图像左侧有小型闭合轮廓，右侧为较高的分叉直立形体，下方有尖状下行笔画。`
...
- dataset label text: `㕎`
- dataset label codepoints: `U+354E`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00026`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00026`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00026`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/026_obs-evo-can
  d-000026_evobc-cat-00026_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/026_obs-evo-cand-000026_evobc-cat-00026_evolu
...
- Which source records identify obs-char-000304 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000304？
