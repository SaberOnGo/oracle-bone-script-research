# obs-unk-004836 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/036_obs-unk-004836_h
  ust-obc-und-X-004836_oracle-character-candidate/03_visual-assets/001_asset
  -006429_hust-obc-und-X-004836_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/392/X_？_7377_1.png`
- asset id: `asset-006429`
...
- source class: `HUST-OBC/undeciphered/X/392/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/392/X_？_7377_1.png`
- asset id: `asset-006429`
...
- English observation: `two upper openings and separate lower opening`
- 中文观察: `上部两个开口和分离的下部开口`
...
- Which source records identify obs-unk-004836 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004836？
