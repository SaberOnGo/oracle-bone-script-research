...
- Project ID: `obs-evo-cand-000495`
- EVOBC category candidate ID: `evobc-evo-cat-00495`
- External category reference: `evobc-cat-00495`
- Source category ID: `00495`
- Source label for human review: `䣓`
- Source codepoints: `U+48D3`
...
- `obs-evo-cand-000495-route-category-staging`
...
- `obs-evo-cand-000495-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000495-route-evolution-graph`
