# obs-unk-007707 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-007707`
- primary external id: `hust-obc-und-YH-007707`
...
- local review image route: `corpus/001_oracle-characters/094_undeciphered-007
  701-007800_obs-unk-bucket_oracle-character-candidates/007_obs-unk-007707_h
  ust-obc-und-YH-007707_oracle-character-candidate/03_visual-assets/001_asse
  t-009298_hust-obc-und-YH-007707_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/602A2/H_？_602A2_0.png`
- asset id: `asset-009298`
...
- source class: `HUST-OBC/undeciphered/Y+H/602A2/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/602A2/H_？_602A2_0.png`
- asset id: `asset-009298`
...
- Which source records identify obs-unk-007707 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007707？
