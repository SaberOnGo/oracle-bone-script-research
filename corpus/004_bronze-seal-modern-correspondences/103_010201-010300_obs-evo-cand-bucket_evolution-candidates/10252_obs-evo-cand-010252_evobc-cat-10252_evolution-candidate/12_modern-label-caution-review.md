# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010252
...
- EVOBC candidate category: `evobc-evo-cat-10252`.
- Source label for search only: `驔`.
- Source codepoints for search only: `U+9A54`.
