...
- `obs-evo-cand-003333-route-category-staging`
...
- `obs-evo-cand-003333-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003333-route-evolution-graph`
