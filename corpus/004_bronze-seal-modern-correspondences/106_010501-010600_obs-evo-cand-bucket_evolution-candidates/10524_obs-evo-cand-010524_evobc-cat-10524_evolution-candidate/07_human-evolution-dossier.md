...
- External category reference: `evobc-cat-10524`
- Source category ID: `10524`
- Source label for human review: `鶄`
- Source codepoints: `U+9D84`
...
- `obs-evo-cand-010524-route-category-staging`
...
- `obs-evo-cand-010524-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010524-route-evolution-graph`
