...
- External category reference: `evobc-cat-03566`
- Source category ID: `03566`
- Source label for human review: `放`
...
- `obs-evo-cand-003566-route-category-staging`
...
- `obs-evo-cand-003566-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003566-route-evolution-graph`
