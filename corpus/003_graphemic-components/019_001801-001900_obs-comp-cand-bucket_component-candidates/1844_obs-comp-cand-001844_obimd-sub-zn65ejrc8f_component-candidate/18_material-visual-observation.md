# Material Visual Observation / obs-comp-cand-001844 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001844`
- External reference / 外部参照: `obimd-sub-zn65ejrc8f`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018205_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zn65ejrc8f/zn65ejrc8f/zn65ejrc8f.png`
- Checksum / 校验和:
  `8614b80ca85b513f94529044b8f382f7b7d997cfbe2586493086c3acd7be0c41`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.95%.
- Marked-pixel bounds: (73,41)–(179,212); span 107 × 172 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.95%。
- 痕迹范围：(73,41)–(179,212)；跨度107 × 172 px；痕迹矩形高于宽。
