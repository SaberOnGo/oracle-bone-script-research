# obs-xwalk-cand-000828 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+379E` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-0936` | not reading |
