# obs-unk-004037 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/037_obs-unk-004037_h
  ust-obc-und-L-004037_oracle-character-candidate/03_visual-assets/001_asset
  -005630_hust-obc-und-L-004037_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4037/L_？_8624.jpg`
- asset id: `asset-005630`
...
- source class: `HUST-OBC/undeciphered/L/4037/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4037/L_？_8624.jpg`
- asset id: `asset-005630`
...
- English observation: Several short angular traces occupy the upper
  area. A narrow central trace descends to a compact loop-like lower area
  with a dark interior mark. The crop leaves the joining points uncertain.
- 中文观察：上部有数条短折角痕迹；一条窄直中央痕迹向下延伸至紧凑的环状下部区域，
    内部较深。图像未明确各痕迹的连接点。
...
- Which source records identify obs-unk-004037 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004037？
