...
- Project ID: `obs-evo-cand-012716`
- EVOBC category candidate ID: `evobc-evo-cat-12716`
- External category reference: `evobc-cat-12716`
- Source category ID: `12716`
- Source label for human review: `𩾯`
- Source codepoints: `U+29FAF`
...
- `obs-evo-cand-012716-route-category-staging`
...
- `obs-evo-cand-012716-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012716-route-evolution-graph`
