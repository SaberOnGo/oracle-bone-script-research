# obs-char-000742 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/742_obs-char-000742_hust-obc-cat-0844_orac
  le-character/03_visual-assets/001_asset-000747_hust-obc-cat-0844_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0844/G_0844_甲骨文.png`
- asset id: `asset-000747`
...
- source category: `0844`
- validation class: `741`
- source image route: `HUST-OBC/deciphered/0844/G_0844_甲骨文.png`
- asset id: `asset-000747`
...
- English observation: `A detached rounded rectangular loop with a short
  inner bar sits above a central stem that divides into two upper diagonals
  and two long lower legs.`
...
- dataset label text: `㝂`
- dataset label codepoints: `U+3742`
...
- Which source records identify obs-char-000742 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000742？
