...
- External category reference: `evobc-cat-11800`
- Source category ID: `11800`
- Source label for human review: `𥑲`
- Source codepoints: `U+25472`
...
- `obs-evo-cand-011800-route-category-staging`
...
- `obs-evo-cand-011800-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011800-route-evolution-graph`
