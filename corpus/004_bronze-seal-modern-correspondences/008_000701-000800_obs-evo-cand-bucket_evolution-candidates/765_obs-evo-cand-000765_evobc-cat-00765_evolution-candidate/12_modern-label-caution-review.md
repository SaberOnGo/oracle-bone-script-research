# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000765
...
- EVOBC candidate category: `evobc-evo-cat-00765`.
- Source label for search only: `伋`.
- Source codepoints for search only: `U+4F0B`.
