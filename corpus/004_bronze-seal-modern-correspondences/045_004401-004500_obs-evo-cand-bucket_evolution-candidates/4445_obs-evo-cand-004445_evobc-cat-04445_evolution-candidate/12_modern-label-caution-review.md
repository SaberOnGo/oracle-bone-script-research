# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004445
...
- EVOBC candidate category: `evobc-evo-cat-04445`.
- Source label for search only: `每`.
- Source codepoints for search only: `U+6BCF`.
