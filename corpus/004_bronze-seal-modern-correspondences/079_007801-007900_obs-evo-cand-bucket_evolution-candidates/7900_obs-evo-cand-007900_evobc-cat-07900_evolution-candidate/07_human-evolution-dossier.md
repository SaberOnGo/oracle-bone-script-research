...
- External category reference: `evobc-cat-07900`
- Source category ID: `07900`
- Source label for human review: `衊`
...
- `obs-evo-cand-007900-route-category-staging`
...
- `obs-evo-cand-007900-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007900-route-evolution-graph`
