# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004416
...
- EVOBC candidate category: `evobc-evo-cat-04416`.
- Source label for search only: `殟`.
- Source codepoints for search only: `U+6B9F`.
