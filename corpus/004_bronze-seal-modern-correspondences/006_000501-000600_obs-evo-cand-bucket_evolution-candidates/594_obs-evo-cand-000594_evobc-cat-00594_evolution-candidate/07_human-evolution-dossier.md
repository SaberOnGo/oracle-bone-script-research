...
Project ID: `obs-evo-cand-000594`
...
- Project ID: `obs-evo-cand-000594`
- EVOBC category candidate ID: `evobc-evo-cat-00594`
- External category reference: `evobc-cat-00594`
- Source category ID: `00594`
- Source label for human review: `䶂`
- Source codepoints: `U+4D82`
...
- `obs-evo-cand-000594-route-category-staging`
...
- `obs-evo-cand-000594-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000594-route-evolution-graph`
