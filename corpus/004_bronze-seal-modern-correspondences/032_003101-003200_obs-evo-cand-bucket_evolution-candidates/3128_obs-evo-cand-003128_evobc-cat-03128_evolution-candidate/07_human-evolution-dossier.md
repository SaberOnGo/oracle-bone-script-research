...
- Project ID: `obs-evo-cand-003128`
- EVOBC category candidate ID: `evobc-evo-cat-03128`
- External category reference: `evobc-cat-03128`
- Source category ID: `03128`
- Source label for human review: `慯`
- Source codepoints: `U+616F`
...
- `obs-evo-cand-003128-route-category-staging`
...
- `obs-evo-cand-003128-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003128-route-evolution-graph`
