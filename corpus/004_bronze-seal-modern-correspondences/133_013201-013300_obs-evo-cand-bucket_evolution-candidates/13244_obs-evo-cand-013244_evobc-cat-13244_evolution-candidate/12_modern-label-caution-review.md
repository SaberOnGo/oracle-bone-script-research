# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013244
...
- EVOBC candidate category: `evobc-evo-cat-13244`.
- Source label for search only: `𬍊`.
- Source codepoints for search only: `U+2C34A`.
