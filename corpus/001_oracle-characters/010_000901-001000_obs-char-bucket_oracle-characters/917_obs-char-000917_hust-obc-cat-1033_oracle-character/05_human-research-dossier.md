# obs-char-000917 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000917`
- primary external id: `hust-obc-cat-1033`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/917_obs-char-000917_hust-obc-cat-1033_orac
  le-character/03_visual-assets/001_asset-000922_hust-obc-cat-1033_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1033/G_1033_甲骨文.png`
- asset id: `asset-000922`
...
- source category: `1033`
- validation class: `916`
- source image route: `HUST-OBC/deciphered/1033/G_1033_甲骨文.png`
- asset id: `asset-000922`
...
- English observation: `Two star-like branching marks sit above a rounded
  open cluster and a long lower stem with a looped side branch.`
- 中文观察: `两个星状分枝痕迹位于圆弧开放笔群之上，下接带环状侧分枝的长笔干。`
...
- dataset label text: `㟿`
- dataset label codepoints: `U+37FF`
...
- Which source records identify obs-char-000917 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000917？
