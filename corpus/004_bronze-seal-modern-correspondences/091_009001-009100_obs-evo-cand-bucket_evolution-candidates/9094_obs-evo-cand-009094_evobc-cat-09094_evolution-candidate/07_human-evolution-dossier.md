...
- External category reference: `evobc-cat-09094`
- Source category ID: `09094`
- Source label for human review: `邜`
- Source codepoints: `U+909C`
...
- `obs-evo-cand-009094-route-category-staging`
...
- `obs-evo-cand-009094-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009094-route-evolution-graph`
