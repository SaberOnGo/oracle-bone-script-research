# obs-evo-cand-001619 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-001619`
- EVOBC category candidate ID: `evobc-evo-cat-01619`
- External category ref: `evobc-cat-01619`
- Source label: `商`
- Source codepoints: `U+5546`
- Image reference count: `267`
- Era token counts: `BI:54;CS:1;OBC:167;SAC:10;SS:4;WSC:31`
- Source token counts: `Book:119;Web:148`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 167 image references
- era 1 / BI: 54 image references
- era 2 / SS: 4 image references
- era 3 / SAC: 10 image references
- era 4 / WSC: 31 image references
- era 5 / CS: 1 image references
- source 0 / Web:1633: 10 image references
- source 1 / Web:105952;說文Web:58: 96 image references
- source 2 / Book:17600: 46 image references
- source 3 / Book:21681: 13 image references
- source 4 / Book:9131: 10 image references
- source 5 / Book:32794: 22 image references
- source 6 / Web:30645: 42 image references
- source 7 / Book:9676: 28 image references
