...
- External category reference: `evobc-cat-04683`
- Source category ID: `04683`
...
- `obs-evo-cand-004683-route-category-staging`
...
- `obs-evo-cand-004683-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004683-route-evolution-graph`
