...
- External category reference: `evobc-cat-00889`
- Source category ID: `00889`
- Source label for human review: `俘`
- Source codepoints: `U+4FD8`
...
- `obs-evo-cand-000889-route-category-staging`
...
- `obs-evo-cand-000889-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000889-route-evolution-graph`
