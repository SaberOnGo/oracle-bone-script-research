# obs-unk-004448 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004448`
- primary external id: `hust-obc-und-X-004448`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/048_obs-unk-004448_h
  ust-obc-und-X-004448_oracle-character-candidate/03_visual-assets/001_asset
  -006041_hust-obc-und-X-004448_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/4/X_？_8183_1.png`
- asset id: `asset-006041`
...
- source class: `HUST-OBC/undeciphered/X/4/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/4/X_？_8183_1.png`
- asset id: `asset-006041`
...
- English observation: `Large upper loops surround a central dark trace`
  `and lower stem.`
- 中文观察: `上部大环围住中央深痕和下部竖痕。`
...
- Which source records identify obs-unk-004448 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004448？
