...
Project ID: `obs-evo-cand-000422`
...
- Project ID: `obs-evo-cand-000422`
- EVOBC category candidate ID: `evobc-evo-cat-00422`
- External category reference: `evobc-cat-00422`
- Source category ID: `00422`
- Source label for human review: `䚮`
- Source codepoints: `U+46AE`
...
- `obs-evo-cand-000422-route-category-staging`
...
- `obs-evo-cand-000422-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000422-route-evolution-graph`
