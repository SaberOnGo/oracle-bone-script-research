# Material Visual Observation / obs-comp-cand-002725 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002725`
- External reference / 外部参照: `obimd-sub-uj5cin0oda`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021341_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/uj5cin0oda/uj5cin0oda/uj5cin0oda.png`
- Checksum / 校验和:
  `2a30ca98dc38186fc62ba2f09565707b2c978c0f2275cdb58a15cd2bba7a70e8`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.40%.
- Marked-pixel bounds: (83,17)–(171,229); span 89 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.40%。
- 痕迹范围：(83,17)–(171,229)；跨度89 × 213 px；痕迹矩形高于宽。
