...
- Yingguo / 英国所藏: `y2531` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `351` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `627` in source row; primary catalog entry pending
- Heji / 合集: `41772` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000534`
