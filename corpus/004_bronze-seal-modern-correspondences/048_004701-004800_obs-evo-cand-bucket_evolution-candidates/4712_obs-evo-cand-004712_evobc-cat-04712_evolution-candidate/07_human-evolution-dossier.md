...
- External category reference: `evobc-cat-04712`
- Source category ID: `04712`
- Source label for human review: `淊`
...
- `obs-evo-cand-004712-route-category-staging`
...
- `obs-evo-cand-004712-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004712-route-evolution-graph`
