# obs-unk-004763 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/063_obs-unk-004763_h
  ust-obc-und-X-004763_oracle-character-candidate/03_visual-assets/001_asset
  -006356_hust-obc-und-X-004763_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/319/X_？_7303_1.png`
- asset id: `asset-006356`
...
- source class: `HUST-OBC/undeciphered/X/319/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/319/X_？_7303_1.png`
- asset id: `asset-006356`
...
- English observation: `left enclosure and right hook with missing views`
- 中文观察: `左侧围合结构和右侧弯钩，仍缺少来源视图`
...
- Which source records identify obs-unk-004763 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004763？
