...
- Yingguo / 英国所藏: `y523` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `193` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `527` in source row; primary catalog entry pending
