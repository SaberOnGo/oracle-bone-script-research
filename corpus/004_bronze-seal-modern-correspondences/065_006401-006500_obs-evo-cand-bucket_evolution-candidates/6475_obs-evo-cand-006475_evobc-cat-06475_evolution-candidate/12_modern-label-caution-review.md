# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006475
...
- EVOBC candidate category: `evobc-evo-cat-06475`.
- Source label for search only: `累`.
- Source codepoints for search only: `U+7D2F`.
