...
- Project ID: `obs-evo-cand-002428`
- EVOBC category candidate ID: `evobc-evo-cat-02428`
- External category reference: `evobc-cat-02428`
- Source category ID: `02428`
- Source label for human review: `寞`
- Source codepoints: `U+5BDE`
...
- `obs-evo-cand-002428-route-category-staging`
...
- `obs-evo-cand-002428-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002428-route-evolution-graph`
