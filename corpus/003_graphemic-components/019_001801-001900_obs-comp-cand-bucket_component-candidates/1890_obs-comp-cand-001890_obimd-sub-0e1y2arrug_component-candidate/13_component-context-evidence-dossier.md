# obs-comp-cand-001890 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001890`
- 首选外部 ID: `obimd-sub-0e1y2arrug`
- OBIMD subcharacter UID: `0e1y2arrug`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+FACBA; U+FACBB; 另有 3 项
