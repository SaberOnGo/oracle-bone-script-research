...
- Project ID: `obs-evo-cand-003998`
- EVOBC category candidate ID: `evobc-evo-cat-03998`
- External category reference: `evobc-cat-03998`
- Source category ID: `03998`
- Source label for human review: `栞`
- Source codepoints: `U+681E`
...
- `obs-evo-cand-003998-route-category-staging`
...
- `obs-evo-cand-003998-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003998-route-evolution-graph`
