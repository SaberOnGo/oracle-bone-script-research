# obs-evo-cand-011743 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-011743`
- EVOBC category candidate ID: `evobc-evo-cat-11743`
- External category ref: `evobc-cat-11743`
- Source label for human review: `𤼷`
- Source codepoints: `U+24F37`
- Image reference count: `12`
- Era token counts: `OBC:12`
- Source token counts: `Book:1;Web:11`
