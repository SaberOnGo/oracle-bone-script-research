...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000256` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y1707` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `212` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `591` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `40483` [route_present_image_or_text_not_collected]
