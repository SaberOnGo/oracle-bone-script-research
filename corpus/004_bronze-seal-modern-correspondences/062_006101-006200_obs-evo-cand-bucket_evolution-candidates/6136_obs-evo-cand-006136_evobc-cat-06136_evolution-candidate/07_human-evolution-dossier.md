...
- External category reference: `evobc-cat-06136`
- Source category ID: `06136`
...
- `obs-evo-cand-006136-route-category-staging`
...
- `obs-evo-cand-006136-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006136-route-evolution-graph`
