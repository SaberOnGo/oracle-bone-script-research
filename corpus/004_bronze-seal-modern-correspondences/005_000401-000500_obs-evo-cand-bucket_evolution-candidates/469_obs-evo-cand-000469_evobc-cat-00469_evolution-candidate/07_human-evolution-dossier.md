...
Project ID: `obs-evo-cand-000469`
...
- Project ID: `obs-evo-cand-000469`
- EVOBC category candidate ID: `evobc-evo-cat-00469`
- External category reference: `evobc-cat-00469`
- Source category ID: `00469`
- Source label for human review: `䢅`
- Source codepoints: `U+4885`
...
- `obs-evo-cand-000469-route-category-staging`
...
- `obs-evo-cand-000469-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000469-route-evolution-graph`
