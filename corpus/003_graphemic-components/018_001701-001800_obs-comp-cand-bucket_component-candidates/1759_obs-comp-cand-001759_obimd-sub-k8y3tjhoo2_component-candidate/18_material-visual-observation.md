# Material Visual Observation / obs-comp-cand-001759 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001759`
- External reference / 外部参照: `obimd-sub-k8y3tjhoo2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017960_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cr5nhxdhbt/k8y3tjhoo2/k8y3tjhoo2.png`
- Checksum / 校验和:
  `25bff7a5079b174dd38717591d1945d0c2a2ce755bc850dd86e4fc689774d206`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.83%.
- Marked-pixel bounds: (87,25)–(162,220); span 76 × 196 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.83%。
- 痕迹范围：(87,25)–(162,220)；跨度76 × 196 px；痕迹矩形高于宽。
