...
- External category reference: `evobc-cat-00702`
- Source category ID: `00702`
- Source label for human review: `亦`
- Source codepoints: `U+4EA6`
- Image reference count in source metadata: `195`
...
- `obs-evo-cand-000702-route-category-staging`
...
- `obs-evo-cand-000702-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000702-route-evolution-graph`
