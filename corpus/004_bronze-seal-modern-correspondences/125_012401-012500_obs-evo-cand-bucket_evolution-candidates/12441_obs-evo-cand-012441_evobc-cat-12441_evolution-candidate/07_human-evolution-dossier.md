...
- External category reference: `evobc-cat-12441`
- Source category ID: `12441`
- Source label for human review: `𨜌`
- Source codepoints: `U+2870C`
...
- `obs-evo-cand-012441-route-category-staging`
...
- `obs-evo-cand-012441-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012441-route-evolution-graph`
