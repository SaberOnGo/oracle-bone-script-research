...
- External category reference: `evobc-cat-10861`
- Source category ID: `10861`
- Source label for human review: `𠢥`
- Source codepoints: `U+208A5`
...
- `obs-evo-cand-010861-route-category-staging`
...
- `obs-evo-cand-010861-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010861-route-evolution-graph`
