...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1081`
...
- Source image / 来源图: `G_1081_乙3282合14127賓組.png`
- Image / 图像: `001_asset-000966_hust-obc-cat-1081_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合14127
...
- target node: `evobc-evo-cat-00089`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC image references / EvoBC 图像引用数: `147`
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/089_obs-evo-cand-000089_evobc-cat-00089_evoluti
...
- Source label text / 来源标签文字: `㠯`
- Source label codepoint / 来源标签 codepoint: `U+382F`
