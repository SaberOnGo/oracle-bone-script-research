# obs-xwalk-cand-000263 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+351D` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-0295` | not reading |
