# obs-char-000186 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/186_obs-char-000186_hust-obc-cat-0205_0206
  _oracle-character/03_visual-assets/001_asset-000191_hust-obc-cat-0205_0206
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0205_0206/0205/G_0205_乙3400合128
  5賓組.png`
- asset id: `asset-000191`
...
- source category: `0205_0206`
- validation class: `185`
- source image route: `HUST-OBC/deciphered/0205_0206/0205/G_0205_乙3400合1285賓組.
  png`
- asset id: `asset-000191`
...
- English observation: `The image forms a deep U-shaped lower frame with two
  upright side strokes, short upper caps, and crossing strokes inside the
  lower opening.`
- 中文观察: `图像下部形成深 U 形框，两侧有竖笔，上端有短盖笔，框内有交叉笔。`
...
- dataset label text: `㓃㓄`
- dataset label codepoints: `U+34C3;U+34C4`
...
- Which source records identify obs-char-000186 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000186？
