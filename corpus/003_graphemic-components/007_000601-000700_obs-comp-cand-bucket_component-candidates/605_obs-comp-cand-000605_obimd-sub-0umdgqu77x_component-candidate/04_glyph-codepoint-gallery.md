# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000605
...
| --- | --- | --- | --- |
| `obimd-glyph-link-009091` | 悤󳥬 | `U+60A4;U+F396C` | `reviewed_metadata_only` |
| `obimd-glyph-link-009092` | 󳥭 | `U+F396D` | `reviewed_metadata_only` |
