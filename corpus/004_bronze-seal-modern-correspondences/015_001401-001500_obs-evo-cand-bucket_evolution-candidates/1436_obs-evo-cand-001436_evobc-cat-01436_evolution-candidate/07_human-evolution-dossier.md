...
- External category reference: `evobc-cat-01436`
- Source category ID: `01436`
- Source label for human review: `厬`
...
- `obs-evo-cand-001436-route-category-staging`
...
- `obs-evo-cand-001436-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001436-route-evolution-graph`
