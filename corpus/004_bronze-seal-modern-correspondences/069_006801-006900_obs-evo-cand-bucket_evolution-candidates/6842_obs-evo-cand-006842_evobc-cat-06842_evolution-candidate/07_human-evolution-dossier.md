...
- Project ID: `obs-evo-cand-006842`
- EVOBC category candidate ID: `evobc-evo-cat-06842`
- External category reference: `evobc-cat-06842`
- Source category ID: `06842`
- Source label for human review: `羒`
- Source codepoints: `U+7F92`
...
- `obs-evo-cand-006842-route-category-staging`
...
- `obs-evo-cand-006842-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006842-route-evolution-graph`
