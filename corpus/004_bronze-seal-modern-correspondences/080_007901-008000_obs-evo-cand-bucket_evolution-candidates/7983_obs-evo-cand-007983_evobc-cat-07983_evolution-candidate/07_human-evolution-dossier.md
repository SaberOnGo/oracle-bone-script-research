...
- External category reference: `evobc-cat-07983`
- Source category ID: `07983`
- Source label for human review: `裤`
...
- `obs-evo-cand-007983-route-category-staging`
...
- `obs-evo-cand-007983-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007983-route-evolution-graph`
