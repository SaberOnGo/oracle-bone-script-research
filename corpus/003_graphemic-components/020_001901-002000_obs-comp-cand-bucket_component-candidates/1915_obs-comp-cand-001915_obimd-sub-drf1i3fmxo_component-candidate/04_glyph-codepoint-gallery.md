# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001915
...
| --- | --- | --- | --- |
| `obimd-glyph-link-028863` | 򩨰󺺩 | `U+A9A30;U+FAEA9` | `reviewed_metadata_only` |
| `obimd-glyph-link-028864` | 󺺪 | `U+FAEAA` | `reviewed_metadata_only` |
