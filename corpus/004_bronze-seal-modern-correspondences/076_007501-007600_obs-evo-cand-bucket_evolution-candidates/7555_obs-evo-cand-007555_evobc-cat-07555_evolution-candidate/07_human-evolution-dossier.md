...
- External category reference: `evobc-cat-07555`
- Source category ID: `07555`
...
- `obs-evo-cand-007555-route-category-staging`
...
- `obs-evo-cand-007555-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007555-route-evolution-graph`
