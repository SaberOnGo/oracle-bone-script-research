...
- External category reference: `evobc-cat-08809`
- Source category ID: `08809`
- Source label for human review: `軨`
...
- `obs-evo-cand-008809-route-category-staging`
...
- `obs-evo-cand-008809-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008809-route-evolution-graph`
