...
Project ID: `obs-evo-cand-009573`
...
- Project ID: `obs-evo-cand-009573`
- EVOBC category candidate ID: `evobc-evo-cat-09573`
- External category reference: `evobc-cat-09573`
- Source category ID: `09573`
- Source label for human review: `钧`
- Source codepoints: `U+94A7`
...
- `obs-evo-cand-009573-route-category-staging`
...
- `obs-evo-cand-009573-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009573-route-evolution-graph`
