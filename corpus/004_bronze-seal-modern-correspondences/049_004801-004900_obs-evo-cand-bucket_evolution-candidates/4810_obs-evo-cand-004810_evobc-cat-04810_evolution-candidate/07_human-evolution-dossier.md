...
Project ID: `obs-evo-cand-004810`
...
- Project ID: `obs-evo-cand-004810`
- EVOBC category candidate ID: `evobc-evo-cat-04810`
- External category reference: `evobc-cat-04810`
- Source category ID: `04810`
- Source label for human review: `溜`
- Source codepoints: `U+6E9C`
...
- `obs-evo-cand-004810-route-category-staging`
...
- `obs-evo-cand-004810-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004810-route-evolution-graph`
