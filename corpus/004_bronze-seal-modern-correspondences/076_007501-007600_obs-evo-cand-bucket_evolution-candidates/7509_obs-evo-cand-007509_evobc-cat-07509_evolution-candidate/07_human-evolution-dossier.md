...
Project ID: `obs-evo-cand-007509`
...
- Project ID: `obs-evo-cand-007509`
- EVOBC category candidate ID: `evobc-evo-cat-07509`
- External category reference: `evobc-cat-07509`
- Source category ID: `07509`
- Source label for human review: `蒲`
- Source codepoints: `U+84B2`
...
- `obs-evo-cand-007509-route-category-staging`
...
- `obs-evo-cand-007509-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007509-route-evolution-graph`
