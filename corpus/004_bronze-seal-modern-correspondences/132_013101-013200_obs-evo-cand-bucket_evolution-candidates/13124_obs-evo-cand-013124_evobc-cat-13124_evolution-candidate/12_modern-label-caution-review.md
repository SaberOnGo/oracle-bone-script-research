# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013124
...
- EVOBC candidate category: `evobc-evo-cat-13124`.
- Source label for search only: `𫷺`.
- Source codepoints for search only: `U+2BDFA`.
