# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006108
...
- EVOBC candidate category: `evobc-evo-cat-06108`.
- Source label for search only: `種`.
- Source codepoints for search only: `U+7A2E`.
