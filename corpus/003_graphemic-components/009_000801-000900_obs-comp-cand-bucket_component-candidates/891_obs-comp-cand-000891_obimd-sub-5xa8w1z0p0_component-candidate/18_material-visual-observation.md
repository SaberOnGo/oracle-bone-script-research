# Material Visual Observation / obs-comp-cand-000891 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000891`
- External reference / 外部参照: `obimd-sub-5xa8w1z0p0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013963_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5xa8w1z0p0/5xa8w1z0p0/5xa8w1z0p0.png`
- Checksum / 校验和:
  `ed7aa80dc7e670583690d6902093479edd1f8de4ab6899781c8ddc16dccf2597`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.77%.
- Marked-pixel bounds: (52,43)–(198,204); span 147 × 162 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.77%。
- 痕迹范围：(52,43)–(198,204)；跨度147 × 162 px；痕迹矩形近方形。
