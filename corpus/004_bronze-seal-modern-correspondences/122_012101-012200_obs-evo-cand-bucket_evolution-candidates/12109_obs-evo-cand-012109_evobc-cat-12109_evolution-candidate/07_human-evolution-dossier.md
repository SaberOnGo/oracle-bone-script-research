...
- External category reference: `evobc-cat-12109`
- Source category ID: `12109`
- Source label: `𦴦`
...
- `obs-evo-cand-012109-route-category-staging`
...
- `obs-evo-cand-012109-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012109-route-evolution-graph`
