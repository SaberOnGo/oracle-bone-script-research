...
- External category reference: `evobc-cat-07003`
- Source category ID: `07003`
- Source label for human review: `肯`
...
- `obs-evo-cand-007003-route-category-staging`
...
- `obs-evo-cand-007003-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007003-route-evolution-graph`
