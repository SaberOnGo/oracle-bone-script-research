...
- External category reference: `evobc-cat-13649`
- Source category ID: `13649`
- Source label for human review: `𮚾`
...
- `obs-evo-cand-013649-route-category-staging`
...
- `obs-evo-cand-013649-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013649-route-evolution-graph`
