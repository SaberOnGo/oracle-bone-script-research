...
- External category reference: `evobc-cat-05578`
- Source category ID: `05578`
- Source label: `番`
...
- `obs-evo-cand-005578-route-category-staging`
...
- `obs-evo-cand-005578-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005578-route-evolution-graph`
