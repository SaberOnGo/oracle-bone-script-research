# Material Visual Observation / obs-comp-cand-000351 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000351`
- External reference / 外部参照: `obimd-sub-bayjrx4i6e`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012275_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bayjrx4i6e/bayjrx4i6e/bayjrx4i6e.png`
- Checksum / 校验和:
  `785fa2a0bb871cfdeaa1c3160501334226a43fed44ddc7e34a5b8988bd3153b0`
...
- Marked-pixel bounds: (85,41)–(164,208); span 80 × 168 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.34%。
- 痕迹范围：(85,41)–(164,208)；跨度80 × 168 px；痕迹矩形高于宽。
