# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-007176
...
- EVOBC candidate category: `evobc-evo-cat-07176`.
- Source label for search only: `臼`.
- Source codepoints for search only: `U+81FC`.
