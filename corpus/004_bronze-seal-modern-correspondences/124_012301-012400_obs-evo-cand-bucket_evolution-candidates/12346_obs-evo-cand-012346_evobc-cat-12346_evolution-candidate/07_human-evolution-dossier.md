...
Project ID: `obs-evo-cand-012346`
...
- Project ID: `obs-evo-cand-012346`
- EVOBC category candidate ID: `evobc-evo-cat-12346`
- External category reference: `evobc-cat-12346`
- Source category ID: `12346`
- Source label for human review: `𨑺`
- Source codepoints: `U+2847A`
...
- `obs-evo-cand-012346-route-category-staging`
...
- `obs-evo-cand-012346-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012346-route-evolution-graph`
