...
- External category reference: `evobc-cat-12099`
- Source category ID: `12099`
- Source label for human review: `𦱓`
- Source codepoints: `U+26C53`
...
- `obs-evo-cand-012099-route-category-staging`
...
- `obs-evo-cand-012099-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012099-route-evolution-graph`
