# Material Visual Observation / obs-comp-cand-002326 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002326`
- External reference / 外部参照: `obimd-sub-r7n676rlfv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020345_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wil5zsif77/r7n676rlfv/r7n676rlfv.png`
- Checksum / 校验和:
  `0ba83a8bf79f66d93ae9d46c1bf1c6e32fd3d3e01d37acb653e09e42590382ce`
...
- Marked-pixel bounds: (90,33)–(187,212); span 98 × 180 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.99%。
- 痕迹范围：(90,33)–(187,212)；跨度98 × 180 px；痕迹矩形高于宽。
