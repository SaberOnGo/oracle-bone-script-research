# obs-char-001471 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1471_obs-char-001471_hust-obc-cat-1651_ora
  cle-character/03_visual-assets/001_asset-001476_hust-obc-cat-1651_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1651/G_1651_前4.47.3(甲).png`
- asset id: `asset-001476`
...
- source category: `1651`
- validation class: `1470`
- source image route: `HUST-OBC/deciphered/1651/G_1651_前4.47.3(甲).png`
- asset id: `asset-001476`
...
- English observation: `A narrow upper enclosure has side branches above a
  long lower stroke.`
...
- dataset label text: `㩩`
- dataset label codepoints: `U+3A69`
...
- Which source records identify obs-char-001471 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001471？
