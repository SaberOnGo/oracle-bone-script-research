# Material Visual Observation / obs-comp-cand-000930 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000930`
- External reference / 外部参照: `obimd-sub-00bv3k93fk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014013_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/00bv3k93fk/00bv3k93fk/00bv3k93fk.png`
- Checksum / 校验和:
  `6f089676069830faf16208cd7fbf5eecbe862132898293c3ef0e25b691666b30`
...
- Marked-pixel bounds: (78,31)–(171,222); span 94 × 192 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.38%。
- 痕迹范围：(78,31)–(171,222)；跨度94 × 192 px；痕迹矩形高于宽。
