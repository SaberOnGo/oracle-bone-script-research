...
- External category reference: `evobc-cat-06687`
- Source category ID: `06687`
- Source label for human review: `繩`
...
- `obs-evo-cand-006687-route-category-staging`
...
- `obs-evo-cand-006687-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006687-route-evolution-graph`
