# Material Visual Observation / obs-comp-cand-001138 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001138`
- External reference / 外部参照: `obimd-sub-l2vxxrjn36`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015092_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/l2vxxrjn36/l2vxxrjn36/l2vxxrjn36.png`
- Checksum / 校验和:
  `fdccc4aeca320534d33e093bdb1c00e3775f96cf45e359d0d459d78c6fd8a4d8`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.18%.
- Marked-pixel bounds: (73,35)–(183,231); span 111 × 197 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.18%。
- 痕迹范围：(73,35)–(183,231)；跨度111 × 197 px；痕迹矩形高于宽。
