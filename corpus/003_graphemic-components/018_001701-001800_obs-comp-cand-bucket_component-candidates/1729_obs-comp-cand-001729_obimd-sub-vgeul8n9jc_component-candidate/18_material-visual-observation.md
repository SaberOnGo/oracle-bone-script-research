# Material Visual Observation / obs-comp-cand-001729 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001729`
- External reference / 外部参照: `obimd-sub-vgeul8n9jc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017914_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xeawj1t30j/vgeul8n9jc/vgeul8n9jc.png`
- Checksum / 校验和:
  `32ede51b109e207db00710cd6514764af7a3a2cac9162e65eebff926828b61ee`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.36%.
- Marked-pixel bounds: (86,41)–(164,204); span 79 × 164 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.36%。
- 痕迹范围：(86,41)–(164,204)；跨度79 × 164 px；痕迹矩形高于宽。
