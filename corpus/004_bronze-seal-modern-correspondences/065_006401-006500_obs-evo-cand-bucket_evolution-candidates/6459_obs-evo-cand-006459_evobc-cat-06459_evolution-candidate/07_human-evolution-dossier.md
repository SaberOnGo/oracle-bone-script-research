...
- External category reference: `evobc-cat-06459`
- Source category ID: `06459`
- Source label for human review: `紘`
- Source codepoints: `U+7D18`
...
- `obs-evo-cand-006459-route-category-staging`
...
- `obs-evo-cand-006459-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006459-route-evolution-graph`
