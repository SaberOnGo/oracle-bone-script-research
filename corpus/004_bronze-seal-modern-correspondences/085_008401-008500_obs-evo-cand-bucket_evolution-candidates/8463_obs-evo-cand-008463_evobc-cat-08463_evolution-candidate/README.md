# obs-evo-cand-008463 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-08463`
- Source label for human review: `谪`
- Source codepoints: `U+8C2A`
- Image reference count: `18`
- Era token counts: `BI:18`
