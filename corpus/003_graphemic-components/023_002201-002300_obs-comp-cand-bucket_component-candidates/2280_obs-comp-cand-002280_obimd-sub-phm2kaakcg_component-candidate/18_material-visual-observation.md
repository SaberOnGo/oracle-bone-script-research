# Material Visual Observation / obs-comp-cand-002280 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002280`
- External reference / 外部参照: `obimd-sub-phm2kaakcg`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020164_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/l72ae71syd/phm2kaakcg/phm2kaakcg.png`
- Checksum / 校验和:
  `c0358c3e4c2ffa87084dacfdcda9a235aee1bcc001819b5b8a1ac6af1d0dc071`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.70%.
- Marked-pixel bounds: (69,20)–(177,228); span 109 × 209 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.70%。
- 痕迹范围：(69,20)–(177,228)；跨度109 × 209 px；痕迹矩形高于宽。
