# obs-char-000610 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/610_obs-char-000610_hust-obc-cat-0695_orac
  le-character/03_visual-assets/001_asset-000615_hust-obc-cat-0695_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0695/G_0695_菁11.4(甲).png`
- asset id: `asset-000615`
...
- source category: `0695`
- validation class: `609`
- source image route: `HUST-OBC/deciphered/0695/G_0695_菁11.4(甲).png`
- asset id: `asset-000615`
...
- English observation: `A pointed leaf-like outer outline is open or split
  at the top and contains several short angular strokes around a central
  white gap.`
...
- dataset label text: `㚭`
- dataset label codepoints: `U+36AD`
...
- Which source records identify obs-char-000610 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000610？
