# obs-unk-004388 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/088_obs-unk-004388_h
  ust-obc-und-L-004388_oracle-character-candidate/03_visual-assets/001_asset
  -005981_hust-obc-und-L-004388_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4388/L_？_9759.jpg`
- asset id: `asset-005981`
...
- source class: `HUST-OBC/undeciphered/L/4388/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4388/L_？_9759.jpg`
- asset id: `asset-005981`
...
- English observation: `A narrow central group and a pointed lower`
  `outline with a curved base are visible.`
- 中文观察: `中央痕迹群较窄，下部有带弧形底部的尖角轮廓。`
...
- Which source records identify obs-unk-004388 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004388？
