...
Project ID: `obs-insc-cw-cand-000425`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000425`
...
- Source page section: `Period II Group 19` /
  `第 II 期第 19 组`
- Source section key: `period-ii-group-19`
- Section declared count: `22`
...
- Yingguo / 英国所藏: `y2248` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `480` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `52` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000425`
