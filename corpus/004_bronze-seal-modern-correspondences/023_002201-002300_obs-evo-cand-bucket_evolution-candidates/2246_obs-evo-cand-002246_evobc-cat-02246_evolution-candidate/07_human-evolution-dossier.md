...
- External category reference: `evobc-cat-02246`
- Source category ID: `02246`
- Source label for human review: `媲`
- Source codepoints: `U+5AB2`
...
- `obs-evo-cand-002246-route-category-staging`
...
- `obs-evo-cand-002246-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002246-route-evolution-graph`
