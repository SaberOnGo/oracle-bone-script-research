# obs-char-001091 Archaeology Paleography Review

# obs-char-001091 考古文字复核档案
...
- first local image: `001_asset-001096_hust-obc-cat-1220_glyph.png`
- first source image: `G_1220_甲骨文.png`
...
- source label text: `㢺`
- source label codepoints: `U+38BA`
