# obs-char-000993 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000993`
- primary external id: `hust-obc-cat-1115_1116`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/993_obs-char-000993_hust-obc-cat-1115_1116
  _oracle-character/03_visual-assets/001_asset-000998_hust-obc-cat-1115_1116
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1115_1116/1115/G_1115_七S73.png`
- asset id: `asset-000998`
...
- source category: `1115_1116`
- validation class: `992`
- source image route: `HUST-OBC/deciphered/1115_1116/1115/G_1115_七S73.png`
- asset id: `asset-000998`
...
- English observation: `A small upper branching cluster sits above a
  rectangular central enclosure and two lower side strokes.`
- 中文观察: `小型上部分枝笔群位于矩形中央闭合轮廓之上，下方有两条侧笔。`
...
- dataset label text: `㡑㡒`
- dataset label codepoints: `U+3851;U+3852`
...
- graph edge count: `2`
- codepoint routes: `U+3851;U+3852`
...
- Which source records identify obs-char-000993 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000993？
