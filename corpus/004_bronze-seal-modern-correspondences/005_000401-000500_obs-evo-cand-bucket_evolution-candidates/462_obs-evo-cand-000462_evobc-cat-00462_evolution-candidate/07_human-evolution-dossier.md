...
- Project ID: `obs-evo-cand-000462`
- EVOBC category candidate ID: `evobc-evo-cat-00462`
- External category reference: `evobc-cat-00462`
- Source category ID: `00462`
- Source label for human review: `䠪`
- Source codepoints: `U+482A`
...
- `obs-evo-cand-000462-route-category-staging`
...
- `obs-evo-cand-000462-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000462-route-evolution-graph`
