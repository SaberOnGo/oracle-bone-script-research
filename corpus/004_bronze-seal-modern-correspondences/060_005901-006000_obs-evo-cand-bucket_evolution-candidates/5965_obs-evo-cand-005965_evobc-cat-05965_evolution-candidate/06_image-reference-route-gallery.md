...
- `obs-evo-cand-005965-route-category-staging`
...
- `obs-evo-cand-005965-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005965-route-evolution-graph`
