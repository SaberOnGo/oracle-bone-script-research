# obs-unk-005683 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/073_undeciphered-005
  601-005700_obs-unk-bucket_oracle-character-candidates/083_obs-unk-005683_h
  ust-obc-und-X-005683_oracle-character-candidate/03_visual-assets/001_asset
  -007276_hust-obc-und-X-005683_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1239/X_？_1127_1.png`
- asset id: `asset-007276`
...
- source class: `HUST-OBC/undeciphered/X/1239/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1239/X_？_1127_1.png`
- asset id: `asset-007276`
...
- Which source records identify obs-unk-005683 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005683？
