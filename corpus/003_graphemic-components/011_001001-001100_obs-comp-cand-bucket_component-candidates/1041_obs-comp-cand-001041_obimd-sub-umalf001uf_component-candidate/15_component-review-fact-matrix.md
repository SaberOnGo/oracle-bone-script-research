# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001041
...
| Glyph or codepoint route / 字形或码位路线 | 4 OBIMD route rows; examples U+2627C;U+F5ECD; U+F5ECE; 另有 2 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
