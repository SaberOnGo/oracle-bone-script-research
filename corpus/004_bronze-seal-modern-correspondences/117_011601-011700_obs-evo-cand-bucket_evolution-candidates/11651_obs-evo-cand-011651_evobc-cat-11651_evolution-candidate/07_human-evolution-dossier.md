...
Project ID: `obs-evo-cand-011651`
...
- Project ID: `obs-evo-cand-011651`
- EVOBC category candidate ID: `evobc-evo-cat-11651`
- External category reference: `evobc-cat-11651`
- Source category ID: `11651`
- Source label for human review: `𤪕`
- Source codepoints: `U+24A95`
...
- `obs-evo-cand-011651-route-category-staging`
...
- `obs-evo-cand-011651-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011651-route-evolution-graph`
