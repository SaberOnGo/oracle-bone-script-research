# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003692
...
- EVOBC candidate category: `evobc-evo-cat-03692`.
- Source label for search only: `旱`.
- Source codepoints for search only: `U+65F1`.
