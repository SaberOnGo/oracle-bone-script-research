# obs-unk-006644 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006644`
- primary external id: `hust-obc-und-X-006644`
...
- local review image route: `corpus/001_oracle-characters/083_undeciphered-006
  601-006700_obs-unk-bucket_oracle-character-candidates/044_obs-unk-006644_h
  ust-obc-und-X-006644_oracle-character-candidate/03_visual-assets/001_asset
  -008235_hust-obc-und-X-006644_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2200/X_？_659_1.png`
- asset id: `asset-008235`
...
- source class: `HUST-OBC/undeciphered/X/2200/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2200/X_？_659_1.png`
- asset id: `asset-008235`
...
- Which source records identify obs-unk-006644 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006644？
