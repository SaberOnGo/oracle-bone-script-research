...
Project ID: `obs-evo-cand-006058`
...
- Project ID: `obs-evo-cand-006058`
- EVOBC category candidate ID: `evobc-evo-cat-06058`
- External category reference: `evobc-cat-06058`
- Source category ID: `06058`
- Source label for human review: `种`
- Source codepoints: `U+79CD`
...
- `obs-evo-cand-006058-route-category-staging`
...
- `obs-evo-cand-006058-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006058-route-evolution-graph`
