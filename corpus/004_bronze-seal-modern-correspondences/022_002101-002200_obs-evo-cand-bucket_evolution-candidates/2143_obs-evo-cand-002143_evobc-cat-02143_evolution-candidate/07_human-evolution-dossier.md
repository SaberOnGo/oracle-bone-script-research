...
- External category reference: `evobc-cat-02143`
- Source category ID: `02143`
- Source label for human review: `姶`
...
- `obs-evo-cand-002143-route-category-staging`
...
- `obs-evo-cand-002143-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002143-route-evolution-graph`
