# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004232
...
- EVOBC candidate category: `evobc-evo-cat-04232`.
- Source label for search only: `樂`.
- Source codepoints for search only: `U+6A02`.
