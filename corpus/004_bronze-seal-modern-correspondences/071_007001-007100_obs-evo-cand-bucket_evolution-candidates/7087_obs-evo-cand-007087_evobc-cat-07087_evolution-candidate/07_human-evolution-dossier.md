...
- External category reference: `evobc-cat-07087`
- Source category ID: `07087`
- Source label for human review: `腈`
- Source codepoints: `U+8148`
...
- `obs-evo-cand-007087-route-category-staging`
...
- `obs-evo-cand-007087-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007087-route-evolution-graph`
