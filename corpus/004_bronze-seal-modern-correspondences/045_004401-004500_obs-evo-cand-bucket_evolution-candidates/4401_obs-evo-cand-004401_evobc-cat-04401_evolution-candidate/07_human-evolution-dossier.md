...
Project ID: `obs-evo-cand-004401`
...
- Project ID: `obs-evo-cand-004401`
- EVOBC category candidate ID: `evobc-evo-cat-04401`
- External category reference: `evobc-cat-04401`
- Source category ID: `04401`
- Source label for human review: `死`
- Source codepoints: `U+6B7B`
- Image reference count in source metadata: `185`
...
- `obs-evo-cand-004401-route-category-staging`
...
- `obs-evo-cand-004401-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004401-route-evolution-graph`
