...
- External category reference: `evobc-cat-07326`
- Source category ID: `07326`
- Source label for human review: `茱`
...
- `obs-evo-cand-007326-route-category-staging`
...
- `obs-evo-cand-007326-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007326-route-evolution-graph`
