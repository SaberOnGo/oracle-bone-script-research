# obs-unk-008007 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008007`
- primary external id: `hust-obc-und-YH-008007`
...
- local review image route: `corpus/001_oracle-characters/097_undeciphered-008
  001-008100_obs-unk-bucket_oracle-character-candidates/007_obs-unk-008007_h
  ust-obc-und-YH-008007_oracle-character-candidate/03_visual-assets/001_asse
  t-009598_hust-obc-und-YH-008007_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/605F9/H_？_605F9_0.png`
- asset id: `asset-009598`
...
- source class: `HUST-OBC/undeciphered/Y+H/605F9/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/605F9/H_？_605F9_0.png`
- asset id: `asset-009598`
...
- Which source records identify obs-unk-008007 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008007？
