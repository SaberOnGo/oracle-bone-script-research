...
- External category reference: `evobc-cat-04200`
- Source category ID: `04200`
- Source label for human review: `槂`
- Source codepoints: `U+69C2`
...
- `obs-evo-cand-004200-route-category-staging`
...
- `obs-evo-cand-004200-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004200-route-evolution-graph`
