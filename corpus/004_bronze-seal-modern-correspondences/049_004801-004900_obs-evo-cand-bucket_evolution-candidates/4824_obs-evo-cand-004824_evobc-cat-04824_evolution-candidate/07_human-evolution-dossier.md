...
- External category reference: `evobc-cat-04824`
- Source category ID: `04824`
- Source label for human review: `溶`
- Source codepoints: `U+6EB6`
...
- `obs-evo-cand-004824-route-category-staging`
...
- `obs-evo-cand-004824-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004824-route-evolution-graph`
