# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006792
...
- EVOBC candidate category: `evobc-evo-cat-06792`.
- Source label for search only: `罌`.
- Source codepoints for search only: `U+7F4C`.
