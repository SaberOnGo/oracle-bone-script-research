...
- External category reference: `evobc-cat-04092`
- Source category ID: `04092`
- Source label for human review: `棐`
...
- `obs-evo-cand-004092-route-category-staging`
...
- `obs-evo-cand-004092-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004092-route-evolution-graph`
