...
- `obs-evo-cand-013262-route-category-staging`
...
- `obs-evo-cand-013262-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013262-route-evolution-graph`
