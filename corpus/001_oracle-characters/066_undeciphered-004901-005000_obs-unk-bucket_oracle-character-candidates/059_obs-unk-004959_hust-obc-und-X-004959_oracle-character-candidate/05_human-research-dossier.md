# obs-unk-004959 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/059_obs-unk-004959_h
  ust-obc-und-X-004959_oracle-character-candidate/03_visual-assets/001_asset
  -006552_hust-obc-und-X-004959_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/515/X_？_7131_1.png`
- asset id: `asset-006552`
...
- source class: `HUST-OBC/undeciphered/X/515/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/515/X_？_7131_1.png`
- asset id: `asset-006552`
...
- Which source records identify obs-unk-004959 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004959？
