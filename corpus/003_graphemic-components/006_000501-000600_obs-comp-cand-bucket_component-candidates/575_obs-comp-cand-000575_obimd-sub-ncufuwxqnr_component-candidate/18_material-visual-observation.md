# Material Visual Observation / obs-comp-cand-000575 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000575`
- External reference / 外部参照: `obimd-sub-ncufuwxqnr`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013103_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hlxb5g91kc/ncufuwxqnr/ncufuwxqnr.png`
- Checksum / 校验和:
  `eb47ca5de81dfe24016f320ee41374dbfbd314f75846236a616aa3ddf5df9105`
...
- Marked-pixel bounds: (76,27)–(173,225); span 98 × 199 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.91%。
- 痕迹范围：(76,27)–(173,225)；跨度98 × 199 px；痕迹矩形高于宽。
