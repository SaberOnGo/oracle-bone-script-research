...
- Project ID: `obs-evo-cand-006753`
- EVOBC category candidate ID: `evobc-evo-cat-06753`
- External category reference: `evobc-cat-06753`
- Source category ID: `06753`
- Source label for human review: `统`
- Source codepoints: `U+7EDF`
...
- `obs-evo-cand-006753-route-category-staging`
...
- `obs-evo-cand-006753-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006753-route-evolution-graph`
