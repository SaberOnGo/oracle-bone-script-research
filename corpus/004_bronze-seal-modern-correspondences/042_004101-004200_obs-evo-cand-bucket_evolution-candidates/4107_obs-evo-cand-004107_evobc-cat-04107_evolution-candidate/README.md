# obs-evo-cand-004107 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-04107`
- Source label for human review: `森`
- Source codepoints: `U+68EE`
- Image reference count: `33`
- Era token counts: `OBC:31;SS:2`
- Source token counts: `Book:3;Web:30`
