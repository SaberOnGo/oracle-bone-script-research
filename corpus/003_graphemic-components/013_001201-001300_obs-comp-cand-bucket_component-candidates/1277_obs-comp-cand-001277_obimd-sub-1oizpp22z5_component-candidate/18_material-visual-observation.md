# Material Visual Observation / obs-comp-cand-001277 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001277`
- External reference / 外部参照: `obimd-sub-1oizpp22z5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015562_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4yk9wrn272/1oizpp22z5/1oizpp22z5.png`
- Checksum / 校验和:
  `f66a68ab8895b3362e1e47948e2d0421438142200dd839e8da94684bf763beba`
...
- Marked-pixel bounds: (57,53)–(192,200); span 136 × 148 px; the marked
...
- 痕迹范围：(57,53)–(192,200)；跨度136 × 148 px；痕迹矩形近方形。
