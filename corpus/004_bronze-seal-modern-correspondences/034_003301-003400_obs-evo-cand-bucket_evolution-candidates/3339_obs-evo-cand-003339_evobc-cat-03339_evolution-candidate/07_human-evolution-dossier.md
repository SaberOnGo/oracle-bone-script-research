...
- External category reference: `evobc-cat-03339`
- Source category ID: `03339`
- Source label for human review: `挃`
- Source codepoints: `U+6303`
...
- `obs-evo-cand-003339-route-category-staging`
...
- `obs-evo-cand-003339-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003339-route-evolution-graph`
