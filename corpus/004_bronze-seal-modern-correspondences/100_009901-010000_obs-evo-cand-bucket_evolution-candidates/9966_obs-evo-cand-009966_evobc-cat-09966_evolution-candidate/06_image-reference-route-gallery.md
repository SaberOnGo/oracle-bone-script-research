...
- `obs-evo-cand-009966-route-category-staging`
...
- `obs-evo-cand-009966-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009966-route-evolution-graph`
