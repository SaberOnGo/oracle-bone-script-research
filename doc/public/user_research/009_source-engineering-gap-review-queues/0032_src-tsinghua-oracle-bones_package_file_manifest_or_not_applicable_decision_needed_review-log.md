...
- Review log draft ID / 复核日志草稿 ID: `source-engineering-gap-review-log-draft-0032`
- Source engineering gap ID / 来源工程缺口 ID: `source-engineering-gap-0032`
...
`current_stage=pending_human_review;download_status_counts=downloaded:1;downloaded_count=1;download_log_count=1;checksum_present_count=1;field_map_count=2;package_manifest_count=0;metadata_profile_count=3;graph_edge_count=0;downloaded_file_bytes=42876;gap_type=package_file_manifest_or_not_applicable_decision_needed`
