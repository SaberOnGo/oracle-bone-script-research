# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004272
...
- EVOBC candidate category: `evobc-evo-cat-04272`.
- Source label for search only: `橞`.
- Source codepoints for search only: `U+6A5E`.
