...
Project ID: `obs-evo-cand-003291`
...
- Project ID: `obs-evo-cand-003291`
- EVOBC category candidate ID: `evobc-evo-cat-03291`
- External category reference: `evobc-cat-03291`
- Source category ID: `03291`
- Source label for human review: `抪`
- Source codepoints: `U+62AA`
...
- `obs-evo-cand-003291-route-category-staging`
...
- `obs-evo-cand-003291-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003291-route-evolution-graph`
