...
- External category reference: `evobc-cat-05193`
- Source category ID: `05193`
- Source label for human review: `牄`
- Source codepoints: `U+7244`
...
- `obs-evo-cand-005193-route-category-staging`
...
- `obs-evo-cand-005193-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005193-route-evolution-graph`
