...
Project ID: `obs-evo-cand-006588`
...
- Project ID: `obs-evo-cand-006588`
- EVOBC category candidate ID: `evobc-evo-cat-06588`
- External category reference: `evobc-cat-06588`
- Source category ID: `06588`
- Source label for human review: `緒`
- Source codepoints: `U+7DD2`
...
- `obs-evo-cand-006588-route-category-staging`
...
- `obs-evo-cand-006588-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006588-route-evolution-graph`
