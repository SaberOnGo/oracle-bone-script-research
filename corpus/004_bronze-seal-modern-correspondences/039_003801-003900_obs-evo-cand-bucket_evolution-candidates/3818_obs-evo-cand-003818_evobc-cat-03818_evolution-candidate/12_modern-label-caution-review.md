# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003818
...
- EVOBC candidate category: `evobc-evo-cat-03818`.
- Source label for search only: `曼`.
- Source codepoints for search only: `U+66FC`.
