# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008676
...
- EVOBC candidate category: `evobc-evo-cat-08676`.
- Source label for search only: `趋`.
- Source codepoints for search only: `U+8D8B`.
