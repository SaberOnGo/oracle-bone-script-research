# Material Visual Observation / obs-comp-cand-002678 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002678`
- External reference / 外部参照: `obimd-sub-74isp0z9bg`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021254_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vh510bocta/74isp0z9bg/74isp0z9bg.png`
- Checksum / 校验和:
  `95a3495c9000b263213a19d9f421d422824ff61cecd16c75d372c7d737148f89`
...
- Marked-pixel bounds: (90,18)–(174,229); span 85 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.79%。
- 痕迹范围：(90,18)–(174,229)；跨度85 × 212 px；痕迹矩形高于宽。
