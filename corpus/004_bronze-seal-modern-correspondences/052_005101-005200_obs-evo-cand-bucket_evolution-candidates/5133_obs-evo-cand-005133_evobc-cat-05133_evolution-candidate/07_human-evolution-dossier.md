...
- External category reference: `evobc-cat-05133`
- Source category ID: `05133`
- Source label for human review: `熠`
- Source codepoints: `U+71A0`
...
- `obs-evo-cand-005133-route-category-staging`
...
- `obs-evo-cand-005133-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005133-route-evolution-graph`
