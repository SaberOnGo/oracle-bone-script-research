...
Project ID: `obs-evo-cand-013009`
...
- Project ID: `obs-evo-cand-013009`
- EVOBC category candidate ID: `evobc-evo-cat-13009`
- External category reference: `evobc-cat-13009`
- Source category ID: `13009`
- Source label for human review: `𫤂`
- Source codepoints: `U+2B902`
...
- `obs-evo-cand-013009-route-category-staging`
...
- `obs-evo-cand-013009-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013009-route-evolution-graph`
