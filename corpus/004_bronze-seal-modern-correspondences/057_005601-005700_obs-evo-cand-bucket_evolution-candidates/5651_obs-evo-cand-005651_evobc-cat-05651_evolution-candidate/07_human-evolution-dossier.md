...
- External category reference: `evobc-cat-05651`
- Source category ID: `05651`
- Source label for human review: `痬`
- Source codepoints: `U+75EC`
...
- `obs-evo-cand-005651-route-category-staging`
...
- `obs-evo-cand-005651-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005651-route-evolution-graph`
