# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002622
...
- EVOBC candidate category: `evobc-evo-cat-02622`.
- Source label for search only: `巫`.
- Source codepoints for search only: `U+5DEB`.
