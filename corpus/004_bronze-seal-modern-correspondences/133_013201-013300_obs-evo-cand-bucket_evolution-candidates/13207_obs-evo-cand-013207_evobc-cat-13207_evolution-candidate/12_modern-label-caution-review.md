# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013207
...
- EVOBC candidate category: `evobc-evo-cat-13207`.
- Source label for search only: `𬅪`.
- Source codepoints for search only: `U+2C16A`.
