...
Project ID: `obs-evo-cand-003079`
...
- Project ID: `obs-evo-cand-003079`
- EVOBC category candidate ID: `evobc-evo-cat-03079`
- External category reference: `evobc-cat-03079`
- Source category ID: `03079`
- Source label for human review: `愋`
- Source codepoints: `U+610B`
...
- `obs-evo-cand-003079-route-category-staging`
...
- `obs-evo-cand-003079-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003079-route-evolution-graph`
