# Material Visual Observation / obs-comp-cand-001183 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001183`
- External reference / 外部参照: `obimd-sub-upv9mf4trj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015373_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/upv9mf4trj/upv9mf4trj/upv9mf4trj.png`
- Checksum / 校验和:
  `069f2fd2b9fa1c8945318f24f56ef59a657e542a8c93ee7bbc0a521a295dce2b`
...
- Marked-pixel bounds: (79,33)–(170,221); span 92 × 189 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.44%。
- 痕迹范围：(79,33)–(170,221)；跨度92 × 189 px；痕迹矩形高于宽。
