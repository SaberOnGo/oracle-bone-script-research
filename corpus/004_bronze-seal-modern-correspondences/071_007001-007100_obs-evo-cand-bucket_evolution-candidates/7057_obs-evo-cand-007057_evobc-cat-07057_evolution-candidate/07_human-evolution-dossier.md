...
- External category reference: `evobc-cat-07057`
- Source category ID: `07057`
- Source label for human review: `脉`
...
- `obs-evo-cand-007057-route-category-staging`
...
- `obs-evo-cand-007057-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007057-route-evolution-graph`
