...
- External category reference: `evobc-cat-02711`
- Source category ID: `02711`
- Source label for human review: `床`
...
- `obs-evo-cand-002711-route-category-staging`
...
- `obs-evo-cand-002711-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002711-route-evolution-graph`
