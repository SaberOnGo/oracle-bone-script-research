...
- External category reference: `evobc-cat-08381`
- Source category ID: `08381`
- Source label for human review: `讀`
...
- `obs-evo-cand-008381-route-category-staging`
...
- `obs-evo-cand-008381-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008381-route-evolution-graph`
