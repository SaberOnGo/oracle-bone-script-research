# obs-unk-004802 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004802`
- primary external id: `hust-obc-und-X-004802`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/002_obs-unk-004802_h
  ust-obc-und-X-004802_oracle-character-candidate/03_visual-assets/001_asset
  -006395_hust-obc-und-X-004802_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/358/X_？_7341_1.png`
- asset id: `asset-006395`
...
- source class: `HUST-OBC/undeciphered/X/358/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/358/X_？_7341_1.png`
- asset id: `asset-006395`
...
- English observation: `multiple left openings and separate right terminal`
- 中文观察: `左侧多个开口和分离的右侧末端`
...
- Which source records identify obs-unk-004802 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004802？
