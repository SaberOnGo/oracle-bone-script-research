...
- Project ID: `obs-evo-cand-008621`
- EVOBC category candidate ID: `evobc-evo-cat-08621`
- External category reference: `evobc-cat-08621`
- Source category ID: `08621`
- Source label for human review: `质`
- Source codepoints: `U+8D28`
...
- `obs-evo-cand-008621-route-category-staging`
...
- `obs-evo-cand-008621-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008621-route-evolution-graph`
