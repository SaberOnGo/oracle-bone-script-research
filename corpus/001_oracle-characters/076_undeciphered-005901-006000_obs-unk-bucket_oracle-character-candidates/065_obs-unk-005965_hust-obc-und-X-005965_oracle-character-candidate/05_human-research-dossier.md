# obs-unk-005965 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005965`
- primary external id: `hust-obc-und-X-005965`
...
- local review image route: `corpus/001_oracle-characters/076_undeciphered-005
  901-006000_obs-unk-bucket_oracle-character-candidates/065_obs-unk-005965_h
  ust-obc-und-X-005965_oracle-character-candidate/03_visual-assets/001_asset
  -007557_hust-obc-und-X-005965_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1521/X_？_2926_1.png`
- asset id: `asset-007557`
...
- source class: `HUST-OBC/undeciphered/X/1521/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1521/X_？_2926_1.png`
- asset id: `asset-007557`
...
- Which source records identify obs-unk-005965 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005965？
