# obs-evo-cand-001585 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-001585`
- EVOBC category candidate ID: `evobc-evo-cat-01585`
- External category ref: `evobc-cat-01585`
- Source label: `員`
- Source codepoints: `U+54E1`
- Image reference count: `160`
- Era token counts: `BI:28;CS:1;OBC:38;SAC:2;SS:3;WSC:88`
- Source token counts: `Book:41;Web:119`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 38 image references
- era 1 / BI: 28 image references
...
- source 1 / Web:105952;說文Web:58: 97 image references
- source 2 / Book:17600: 4 image references
