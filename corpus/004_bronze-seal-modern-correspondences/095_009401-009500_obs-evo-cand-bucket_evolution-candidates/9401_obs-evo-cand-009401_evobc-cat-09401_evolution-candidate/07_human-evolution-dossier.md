...
Project ID: `obs-evo-cand-009401`
...
- Project ID: `obs-evo-cand-009401`
- EVOBC category candidate ID: `evobc-evo-cat-09401`
- External category reference: `evobc-cat-09401`
- Source category ID: `09401`
- Source label for human review: `銽`
- Source codepoints: `U+92BD`
...
- `obs-evo-cand-009401-route-category-staging`
...
- `obs-evo-cand-009401-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009401-route-evolution-graph`
