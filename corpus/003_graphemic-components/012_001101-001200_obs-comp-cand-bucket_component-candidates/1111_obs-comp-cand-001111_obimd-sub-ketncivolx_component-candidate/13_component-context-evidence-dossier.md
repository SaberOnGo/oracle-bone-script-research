# obs-comp-cand-001111 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001111`
- 首选外部 ID: `obimd-sub-ketncivolx`
- OBIMD subcharacter UID: `ketncivolx`
- OBIMD main character UID: `ketncivolx`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+25FC6;U+F6664; U+F6665; 另有 3 项
