...
- External category reference: `evobc-cat-13089`
- Source category ID: `13089`
- Source label for human review: `𫳆`
- Source codepoints: `U+2BCC6`
...
- `obs-evo-cand-013089-route-category-staging`
...
- `obs-evo-cand-013089-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013089-route-evolution-graph`
