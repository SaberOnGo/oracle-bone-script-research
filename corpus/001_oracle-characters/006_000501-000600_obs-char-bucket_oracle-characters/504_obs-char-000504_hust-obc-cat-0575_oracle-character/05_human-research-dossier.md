# obs-char-000504 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000504`
- primary external id: `hust-obc-cat-0575`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/504_obs-char-000504_hust-obc-cat-0575_orac
  le-character/03_visual-assets/001_asset-000509_hust-obc-cat-0575_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0575/G_0575_佚657合18755賓組.png`
- asset id: `asset-000509`
...
- source category: `0575`
- validation class: `503`
- source image route: `HUST-OBC/deciphered/0575/G_0575_佚657合18755賓組.png`
- asset id: `asset-000509`
...
- English observation: `The very small low-contrast image shows two
  separated clusters: short marks above a forked form at left and a narrow
  branching vertical form at right.`
...
- dataset label text: `㘵`
- dataset label codepoints: `U+3635`
...
- filename catalog route clues: `Heji-like filename clue: 合18755
  (G_0575_佚657合18755賓組.png)`
...
- Which source records identify obs-char-000504 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000504？
