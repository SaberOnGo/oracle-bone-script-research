...
- External category reference: `evobc-cat-05420`
- Source category ID: `05420`
- Source label: `琰`
...
- `obs-evo-cand-005420-route-category-staging`
...
- `obs-evo-cand-005420-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005420-route-evolution-graph`
