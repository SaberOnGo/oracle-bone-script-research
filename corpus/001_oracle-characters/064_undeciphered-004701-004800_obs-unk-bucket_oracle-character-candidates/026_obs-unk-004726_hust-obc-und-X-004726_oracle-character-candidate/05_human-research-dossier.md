# obs-unk-004726 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004726`
- primary external id: `hust-obc-und-X-004726`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/026_obs-unk-004726_h
  ust-obc-und-X-004726_oracle-character-candidate/03_visual-assets/001_asset
  -006319_hust-obc-und-X-004726_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/282/X_？_7108_1.png`
- asset id: `asset-006319`
...
- source class: `HUST-OBC/undeciphered/X/282/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/282/X_？_7108_1.png`
- asset id: `asset-006319`
...
- English observation: `thin branching stroke with long lower curve`
- 中文观察: `带下部长弯曲笔画的细长分支结构`
...
- Which source records identify obs-unk-004726 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004726？
