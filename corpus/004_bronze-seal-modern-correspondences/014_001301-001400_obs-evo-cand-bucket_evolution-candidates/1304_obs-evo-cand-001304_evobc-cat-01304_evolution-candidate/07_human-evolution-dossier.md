...
Project ID: `obs-evo-cand-001304`
...
- Project ID: `obs-evo-cand-001304`
- EVOBC category candidate ID: `evobc-evo-cat-01304`
- External category reference: `evobc-cat-01304`
- Source category ID: `01304`
- Source label for human review: `勢`
- Source codepoints: `U+52E2`
...
- `obs-evo-cand-001304-route-category-staging`
...
- `obs-evo-cand-001304-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001304-route-evolution-graph`
