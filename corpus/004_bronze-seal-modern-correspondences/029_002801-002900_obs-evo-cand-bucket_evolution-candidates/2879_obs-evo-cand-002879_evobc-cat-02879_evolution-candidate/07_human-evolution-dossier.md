...
- External category reference: `evobc-cat-02879`
- Source category ID: `02879`
- Source label for human review: `徥`
- Source codepoints: `U+5FA5`
...
- `obs-evo-cand-002879-route-category-staging`
...
- `obs-evo-cand-002879-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002879-route-evolution-graph`
