# obs-unk-004972 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004972`
- primary external id: `hust-obc-und-X-004972`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/072_obs-unk-004972_h
  ust-obc-und-X-004972_oracle-character-candidate/03_visual-assets/001_asset
  -006565_hust-obc-und-X-004972_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/528/X_？_7508_1.png`
- asset id: `asset-006565`
...
- A left outline and a branched central-right upright are visible.
...
- source class: `HUST-OBC/undeciphered/X/528/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/528/X_？_7508_1.png`
- asset id: `asset-006565`
...
- Which source records identify obs-unk-004972 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004972？
