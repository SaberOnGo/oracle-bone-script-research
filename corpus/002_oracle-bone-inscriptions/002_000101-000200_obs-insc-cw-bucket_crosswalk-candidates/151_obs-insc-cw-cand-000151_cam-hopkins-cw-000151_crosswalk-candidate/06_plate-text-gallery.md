...
Project ID: `obs-insc-cw-cand-000151`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000151`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000151` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y835` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `154` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `715` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `40076` [route_present_image_or_text_not_collected]
