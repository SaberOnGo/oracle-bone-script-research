# obs-char-000437 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000437`
- primary external id: `hust-obc-cat-0497`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/437_obs-char-000437_hust-obc-cat-0497_orac
  le-character/03_visual-assets/001_asset-000442_hust-obc-cat-0497_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0497/G_0497_佚707合10298賓組.png`
- asset id: `asset-000442`
...
- source category: `0497`
- validation class: `436`
- source image route: `HUST-OBC/deciphered/0497/G_0497_佚707合10298賓組.png`
- asset id: `asset-000442`
...
- English observation: `Two irregular side clusters flank a central enclosed
  or crossed area; a broad curved stroke extends downward and bends to the
  right.`
...
- dataset label text: `㗧`
- dataset label codepoints: `U+35E7`
...
- filename catalog route clues: `Heji-like filename clue: 合10298
...
- Which source records identify obs-char-000437 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000437？
