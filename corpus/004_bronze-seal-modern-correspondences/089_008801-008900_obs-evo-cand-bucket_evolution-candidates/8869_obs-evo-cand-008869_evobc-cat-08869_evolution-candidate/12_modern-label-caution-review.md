# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008869
...
- EVOBC candidate category: `evobc-evo-cat-08869`.
- Source label for search only: `轍`.
- Source codepoints for search only: `U+8F4D`.
