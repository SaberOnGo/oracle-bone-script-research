...
- External category reference: `evobc-cat-12382`
- Source category ID: `12382`
- Source label for human review: `𨖵`
...
- `obs-evo-cand-012382-route-category-staging`
...
- `obs-evo-cand-012382-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012382-route-evolution-graph`
