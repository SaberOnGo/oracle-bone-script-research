...
Project ID: `obs-evo-cand-002804`
...
- Project ID: `obs-evo-cand-002804`
- EVOBC category candidate ID: `evobc-evo-cat-02804`
- External category reference: `evobc-cat-02804`
- Source category ID: `02804`
- Source label for human review: `弦`
- Source codepoints: `U+5F26`
...
- `obs-evo-cand-002804-route-category-staging`
...
- `obs-evo-cand-002804-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002804-route-evolution-graph`
