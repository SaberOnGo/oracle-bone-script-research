...
Project ID: `obs-evo-cand-009786`
...
- Project ID: `obs-evo-cand-009786`
- EVOBC category candidate ID: `evobc-evo-cat-09786`
- External category reference: `evobc-cat-09786`
- Source category ID: `09786`
- Source label for human review: `隨`
- Source codepoints: `U+96A8`
...
- `obs-evo-cand-009786-route-category-staging`
...
- `obs-evo-cand-009786-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009786-route-evolution-graph`
