# Archaeological Context Review / 考古语境复核: coll-obj-cand-00057
...
| --- | --- | --- |
| Institution | `Cambridge University Library Hopkins Collection` | `02_collection-source-index.csv` |
| Catalog or accession | `CUL.52` | `02_collection-source-index.csv` |
| Source item | `CUL.52` | `01_collection-object-packet.json` |
| Catalog description | `Finding-list row: period I, group 6, count 48; y608 / c52 / h521 / j39514; candidate route only` | `01_collection-object-packet.json` |
...
| Period or date | `Period I group 6 source-row label; needs human review` | `08_collection-provenance-evidence-dossier.md` |
