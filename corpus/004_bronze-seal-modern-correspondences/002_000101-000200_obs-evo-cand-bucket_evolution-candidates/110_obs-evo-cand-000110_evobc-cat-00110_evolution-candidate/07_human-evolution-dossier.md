...
Project ID: `obs-evo-cand-000110`
...
- Project ID: `obs-evo-cand-000110`
- EVOBC category candidate ID: `evobc-evo-cat-00110`
- External category reference: `evobc-cat-00110`
- Source category ID: `00110`
- Source label for human review: `㣤`
- Source codepoints: `U+38E4`
...
- `obs-evo-cand-000110-route-category-staging`
...
- `obs-evo-cand-000110-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000110-route-evolution-graph`
