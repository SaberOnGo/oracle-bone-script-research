# Material Visual Observation / obs-comp-cand-000718 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000718`
- External reference / 外部参照: `obimd-sub-5l2g3imogi`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013430_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5l2g3imogi/5l2g3imogi/5l2g3imogi.png`
- Checksum / 校验和:
  `1b6391d37ca8e0bcf0022b3c0856b689b03981aa757f699eb8d1786bdc584a73`
...
- Marked-pixel bounds: (77,33)–(172,222); span 96 × 190 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.73%。
- 痕迹范围：(77,33)–(172,222)；跨度96 × 190 px；痕迹矩形高于宽。
