# Material Visual Observation / obs-comp-cand-000631 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000631`
- External reference / 外部参照: `obimd-sub-fp0gk2d44n`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013194_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fp0gk2d44n/fp0gk2d44n/fp0gk2d44n.png`
- Checksum / 校验和:
  `0bc584484c23a7bfd82acd71c0708e144f769cebaa6143e02c4c4fddf305e34c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.29%.
- Marked-pixel bounds: (65,30)–(183,220); span 119 × 191 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.29%。
- 痕迹范围：(65,30)–(183,220)；跨度119 × 191 px；痕迹矩形高于宽。
