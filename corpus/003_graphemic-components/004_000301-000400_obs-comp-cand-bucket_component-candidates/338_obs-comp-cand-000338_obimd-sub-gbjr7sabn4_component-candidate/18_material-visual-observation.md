# Material Visual Observation / obs-comp-cand-000338 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000338`
- External reference / 外部参照: `obimd-sub-gbjr7sabn4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012262_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gbjr7sabn4/gbjr7sabn4/gbjr7sabn4.png`
- Checksum / 校验和:
  `43fe5a906701d30cb30f9eb2e0bcd7a782aca880f3f562f719eaab3ab741bef2`
...
- Marked-pixel bounds: (79,29)–(170,221); span 92 × 193 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.24%。
- 痕迹范围：(79,29)–(170,221)；跨度92 × 193 px；痕迹矩形高于宽。
