...
- External category reference: `evobc-cat-04036`
- Source category ID: `04036`
- Source label for human review: `桰`
...
- `obs-evo-cand-004036-route-category-staging`
...
- `obs-evo-cand-004036-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004036-route-evolution-graph`
