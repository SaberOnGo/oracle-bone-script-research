# Material Visual Observation / obs-comp-cand-001365 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001365`
- External reference / 外部参照: `obimd-sub-79c9fojxw0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015784_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/79c9fojxw0/79c9fojxw0/79c9fojxw0.png`
- Checksum / 校验和:
  `f0a5dcf76ba118268ea6e629ee60090d3e9b29ab657671a80080235cdc72a6f4`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.08%.
- Marked-pixel bounds: (75,23)–(182,217); span 108 × 195 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.08%。
- 痕迹范围：(75,23)–(182,217)；跨度108 × 195 px；痕迹矩形高于宽。
