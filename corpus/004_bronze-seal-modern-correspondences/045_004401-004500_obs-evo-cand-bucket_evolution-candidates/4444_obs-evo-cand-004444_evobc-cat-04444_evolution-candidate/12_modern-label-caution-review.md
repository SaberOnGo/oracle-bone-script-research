# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004444
...
- EVOBC candidate category: `evobc-evo-cat-04444`.
- Source label for search only: `母`.
- Source codepoints for search only: `U+6BCD`.
