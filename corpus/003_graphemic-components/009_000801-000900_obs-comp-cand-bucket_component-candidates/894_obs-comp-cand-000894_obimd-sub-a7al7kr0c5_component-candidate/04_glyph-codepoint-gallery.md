# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000894
...
| --- | --- | --- | --- |
| `obimd-glyph-link-012841` | 󵀒 | `U+F5012` | `reviewed_metadata_only` |
| `obimd-glyph-link-012842` | 󵀓 | `U+F5013` | `reviewed_metadata_only` |
| `obimd-glyph-link-012843` | 󵀔 | `U+F5014` | `reviewed_metadata_only` |
