...
Project ID: `obs-evo-cand-009420`
...
- Project ID: `obs-evo-cand-009420`
- EVOBC category candidate ID: `evobc-evo-cat-09420`
- External category reference: `evobc-cat-09420`
- Source category ID: `09420`
- Source label for human review: `鋸`
- Source codepoints: `U+92F8`
...
- `obs-evo-cand-009420-route-category-staging`
...
- `obs-evo-cand-009420-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009420-route-evolution-graph`
