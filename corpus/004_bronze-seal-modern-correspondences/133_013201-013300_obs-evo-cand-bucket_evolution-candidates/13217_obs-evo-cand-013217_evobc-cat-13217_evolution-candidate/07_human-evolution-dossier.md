...
- External category reference: `evobc-cat-13217`
- Source category ID: `13217`
- Source label for human review: `𬆬`
...
- `obs-evo-cand-013217-route-category-staging`
...
- `obs-evo-cand-013217-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013217-route-evolution-graph`
