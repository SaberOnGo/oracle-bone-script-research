# obs-char-000560 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/560_obs-char-000560_hust-obc-cat-0635_orac
  le-character/03_visual-assets/001_asset-000565_hust-obc-cat-0635_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0635/G_0635_甲骨文0.png`
- asset id: `asset-000565`
...
- source category: `0635`
- validation class: `559`
- source image route: `HUST-OBC/deciphered/0635/G_0635_甲骨文0.png`
- asset id: `asset-000565`
...
- English observation: `A pointed oval outer outline encloses a small
  centrally divided rectangle and two long narrow strokes that continue
  downward toward the open lower end.`
...
- dataset label text: `㙱`
- dataset label codepoints: `U+3671`
...
- Which source records identify obs-char-000560 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000560？
