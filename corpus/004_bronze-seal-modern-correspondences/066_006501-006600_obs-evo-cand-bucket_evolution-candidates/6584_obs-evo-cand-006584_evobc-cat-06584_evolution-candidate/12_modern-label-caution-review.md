# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006584
...
- EVOBC candidate category: `evobc-evo-cat-06584`.
- Source label for search only: `緍`.
- Source codepoints for search only: `U+7DCD`.
