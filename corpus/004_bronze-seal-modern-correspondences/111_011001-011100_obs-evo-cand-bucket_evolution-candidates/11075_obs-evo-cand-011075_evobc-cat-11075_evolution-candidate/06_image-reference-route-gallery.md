...
- `obs-evo-cand-011075-route-category-staging`
...
- `obs-evo-cand-011075-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011075-route-evolution-graph`
