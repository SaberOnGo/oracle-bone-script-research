# Material Visual Observation / obs-comp-cand-002433 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002433`
- External reference / 外部参照: `obimd-sub-unan8n2rta`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020605_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/unan8n2rta/unan8n2rta/unan8n2rta.png`
- Checksum / 校验和:
  `86cc7b5285547aae9030ed1b70ef9e7c4abc536b88a05e817f7405d481d01ea3`
...
- Marked-pixel bounds: (72,27)–(177,217); span 106 × 191 px; the marked
...
- 痕迹范围：(72,27)–(177,217)；跨度106 × 191 px；痕迹矩形高于宽。
