# obs-char-001528 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1528_obs-char-001528_hust-obc-cat-1714_ora
  cle-character/03_visual-assets/001_asset-001533_hust-obc-cat-1714_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1714/X_1714_4831_1.png`
- asset id: `asset-001533`
...
- source category: `1714`
- validation class: `1527`
- source image route: `HUST-OBC/deciphered/1714/X_1714_4831_1.png`
- asset id: `asset-001533`
...
- English observation: `A large dark composite has two upper openings and
  several long branching lower strokes.`
...
- dataset label text: `㪨`
- dataset label codepoints: `U+3AA8`
...
- Which source records identify obs-char-001528 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001528？
