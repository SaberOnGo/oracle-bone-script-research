# Material Visual Observation / obs-comp-cand-002665 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002665`
- External reference / 外部参照: `obimd-sub-33cdlwuhk3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021241_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/33cdlwuhk3/33cdlwuhk3/33cdlwuhk3.png`
- Checksum / 校验和:
  `a2f0e36e7eaeaf41c8ae525b85764e79c0b5ef0d045ba379b71f62ef9d3bf563`
...
- Marked-pixel bounds: (88,19)–(169,225); span 82 × 207 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.06%。
- 痕迹范围：(88,19)–(169,225)；跨度82 × 207 px；痕迹矩形高于宽。
