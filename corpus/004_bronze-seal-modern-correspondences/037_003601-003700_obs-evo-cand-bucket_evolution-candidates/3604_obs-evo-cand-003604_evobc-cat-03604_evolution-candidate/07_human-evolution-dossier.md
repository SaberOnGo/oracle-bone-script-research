...
Project ID: `obs-evo-cand-003604`
...
- Project ID: `obs-evo-cand-003604`
- EVOBC category candidate ID: `evobc-evo-cat-03604`
- External category reference: `evobc-cat-03604`
- Source category ID: `03604`
- Source label for human review: `数`
- Source codepoints: `U+6570`
...
- `obs-evo-cand-003604-route-category-staging`
...
- `obs-evo-cand-003604-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003604-route-evolution-graph`
