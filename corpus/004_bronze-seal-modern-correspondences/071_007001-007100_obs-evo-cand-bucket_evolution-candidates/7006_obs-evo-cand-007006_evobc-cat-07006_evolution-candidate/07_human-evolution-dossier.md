...
- External category reference: `evobc-cat-07006`
- Source category ID: `07006`
- Source label for human review: `育`
...
- `obs-evo-cand-007006-route-category-staging`
...
- `obs-evo-cand-007006-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007006-route-evolution-graph`
