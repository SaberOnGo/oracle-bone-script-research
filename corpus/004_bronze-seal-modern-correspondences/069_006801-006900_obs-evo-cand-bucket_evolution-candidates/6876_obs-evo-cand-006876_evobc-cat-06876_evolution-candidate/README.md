# obs-evo-cand-006876 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-06876`
- Source label: `翊`
- Source codepoints: `U+7FCA`
- Image reference count: `89`
- Era token counts: `BI:1;OBC:87;SS:1`
- Source token counts: `Book:11;Web:78`
