# obs-char-001445 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1445_obs-char-001445_hust-obc-cat-1620_ora
  cle-character/03_visual-assets/001_asset-001450_hust-obc-cat-1620_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1620/G_1620_乙3956.png`
- asset id: `asset-001450`
...
- source category: `1620`
- validation class: `1444`
- source image route: `HUST-OBC/deciphered/1620/G_1620_乙3956.png`
- asset id: `asset-001450`
...
- English observation: `Two upright stems have small forked tops joined by a
  central crossing.`
- 中文观察: `两条直立竖干有小型分叉顶部，并由中央交叉笔连接。`
...
- dataset label text: `㩊`
- dataset label codepoints: `U+3A4A`
...
- Which source records identify obs-char-001445 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001445？
