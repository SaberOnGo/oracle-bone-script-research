# obs-char-000228 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/228_obs-char-000228_hust-obc-cat-0254_orac
  le-character/03_visual-assets/001_asset-000233_hust-obc-cat-0254_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0254/L_0254_276.jpg`
- asset id: `asset-000233`
...
- source category: `0254`
- validation class: `227`
- source image route: `HUST-OBC/deciphered/0254/L_0254_276.jpg`
- asset id: `asset-000233`
...
- English observation: `The low-resolution gray image shows two short
  separated strokes, one more upright and one curving outward toward the
  lower right.`
...
- dataset label text: `㓴`
- dataset label codepoints: `U+34F4`
...
- Which source records identify obs-char-000228 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000228？
