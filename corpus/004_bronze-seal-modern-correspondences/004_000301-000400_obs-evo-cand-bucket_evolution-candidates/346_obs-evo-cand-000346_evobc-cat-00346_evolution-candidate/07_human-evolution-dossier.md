...
- External category reference: `evobc-cat-00346`
- Source category ID: `00346`
- Source label for human review: `䍡`
...
- `obs-evo-cand-000346-route-category-staging`
...
- `obs-evo-cand-000346-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000346-route-evolution-graph`
