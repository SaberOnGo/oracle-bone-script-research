...
- External category reference: `evobc-cat-06162`
- Source category ID: `06162`
- Source label for human review: `窑`
...
- `obs-evo-cand-006162-route-category-staging`
...
- `obs-evo-cand-006162-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006162-route-evolution-graph`
