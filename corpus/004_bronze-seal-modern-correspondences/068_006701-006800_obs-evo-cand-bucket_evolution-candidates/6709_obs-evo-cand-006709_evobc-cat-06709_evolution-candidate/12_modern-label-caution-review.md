# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006709
...
- EVOBC candidate category: `evobc-evo-cat-06709`.
- Source label for search only: `纊`.
- Source codepoints for search only: `U+7E8A`.
