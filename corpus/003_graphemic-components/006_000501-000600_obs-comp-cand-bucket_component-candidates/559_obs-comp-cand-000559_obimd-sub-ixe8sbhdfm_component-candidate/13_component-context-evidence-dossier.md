# obs-comp-cand-000559 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000559`
- 首选外部 ID: `obimd-sub-ixe8sbhdfm`
- OBIMD subcharacter UID: `ixe8sbhdfm`
- OBIMD main character UID: `ixe8sbhdfm`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+F3441; U+F3442; 另有 1 项
