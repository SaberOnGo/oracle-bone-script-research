...
- External category reference: `evobc-cat-11718`
- Source category ID: `11718`
- Source label for human review: `𤹞`
- Source codepoints: `U+24E5E`
...
- `obs-evo-cand-011718-route-category-staging`
...
- `obs-evo-cand-011718-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011718-route-evolution-graph`
