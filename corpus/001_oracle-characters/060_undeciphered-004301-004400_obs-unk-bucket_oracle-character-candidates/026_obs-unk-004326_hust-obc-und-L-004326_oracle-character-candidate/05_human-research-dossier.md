# obs-unk-004326 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/026_obs-unk-004326_h
  ust-obc-und-L-004326_oracle-character-candidate/03_visual-assets/001_asset
  -005919_hust-obc-und-L-004326_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4326/L_？_9559.jpg`
- asset id: `asset-005919`
...
- source class: `HUST-OBC/undeciphered/L/4326/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4326/L_？_9559.jpg`
- asset id: `asset-005919`
...
- English observation: `Upper rounded mark, horizontal trace, and lower
  stem recorded.`
- 中文观察: `已记录上部圆转痕、横痕和下部细痕。`
...
- Which source records identify obs-unk-004326 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004326？
