# obs-unk-005960 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/076_undeciphered-005
  901-006000_obs-unk-bucket_oracle-character-candidates/060_obs-unk-005960_h
  ust-obc-und-X-005960_oracle-character-candidate/03_visual-assets/001_asset
  -007552_hust-obc-und-X-005960_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1516/X_？_2808_1.png`
- asset id: `asset-007552`
...
- source class: `HUST-OBC/undeciphered/X/1516/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1516/X_？_2808_1.png`
- asset id: `asset-007552`
...
- Which source records identify obs-unk-005960 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005960？
