...
- External category reference: `evobc-cat-07138`
- Source category ID: `07138`
- Source label for human review: `膹`
- Source codepoints: `U+81B9`
...
- `obs-evo-cand-007138-route-category-staging`
...
- `obs-evo-cand-007138-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007138-route-evolution-graph`
