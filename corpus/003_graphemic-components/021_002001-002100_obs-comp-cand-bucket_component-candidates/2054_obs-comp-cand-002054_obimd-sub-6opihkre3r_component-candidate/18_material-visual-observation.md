# Material Visual Observation / obs-comp-cand-002054 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002054`
- External reference / 外部参照: `obimd-sub-6opihkre3r`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019441_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/iuouekyjwj/6opihkre3r/6opihkre3r.png`
- Checksum / 校验和:
  `261333410e2ac6a2f9c10d61f0e9d0eb2edb4ac5a0b173802048c60394ae013b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.49%.
- Marked-pixel bounds: (61,21)–(178,225); span 118 × 205 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.49%。
- 痕迹范围：(61,21)–(178,225)；跨度118 × 205 px；痕迹矩形高于宽。
