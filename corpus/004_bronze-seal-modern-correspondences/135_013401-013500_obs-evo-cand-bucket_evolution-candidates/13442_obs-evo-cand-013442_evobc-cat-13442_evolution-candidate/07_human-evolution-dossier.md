...
Project ID: `obs-evo-cand-013442`
...
- Project ID: `obs-evo-cand-013442`
- EVOBC category candidate ID: `evobc-evo-cat-13442`
- External category reference: `evobc-cat-13442`
- Source category ID: `13442`
- Source label for human review: `𬴥`
- Source codepoints: `U+2CD25`
...
- `obs-evo-cand-013442-route-category-staging`
...
- `obs-evo-cand-013442-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013442-route-evolution-graph`
