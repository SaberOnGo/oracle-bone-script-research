...
- External category reference: `evobc-cat-03524`
- Source category ID: `03524`
- Source label for human review: `擠`
...
- `obs-evo-cand-003524-route-category-staging`
...
- `obs-evo-cand-003524-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003524-route-evolution-graph`
