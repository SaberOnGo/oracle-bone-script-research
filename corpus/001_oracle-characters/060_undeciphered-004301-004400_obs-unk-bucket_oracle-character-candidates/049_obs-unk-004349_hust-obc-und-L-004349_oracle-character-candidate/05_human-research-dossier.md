# obs-unk-004349 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004349`
- primary external id: `hust-obc-und-L-004349`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/049_obs-unk-004349_h
  ust-obc-und-L-004349_oracle-character-candidate/03_visual-assets/001_asset
  -005942_hust-obc-und-L-004349_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4349/L_？_9647.jpg`
- asset id: `asset-005942`
...
- source class: `HUST-OBC/undeciphered/L/4349/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4349/L_？_9647.jpg`
- asset id: `asset-005942`
...
- English observation: `Rounded upper trace, side hooks, and lower extension`
  `recorded.`
- 中文观察: `已记录上部圆弧痕、两侧外伸痕和下部延伸。`
...
- Which source records identify obs-unk-004349 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004349？
