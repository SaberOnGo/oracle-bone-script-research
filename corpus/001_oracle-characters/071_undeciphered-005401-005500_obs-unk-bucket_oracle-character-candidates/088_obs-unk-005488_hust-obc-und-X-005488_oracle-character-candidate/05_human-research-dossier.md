# obs-unk-005488 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005488`
- primary external id: `hust-obc-und-X-005488`
...
- local review image route: `corpus/001_oracle-characters/071_undeciphered-005
  401-005500_obs-unk-bucket_oracle-character-candidates/088_obs-unk-005488_h
  ust-obc-und-X-005488_oracle-character-candidate/03_visual-assets/001_asset
  -007081_hust-obc-und-X-005488_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1044/X_？_8005_1.png`
- asset id: `asset-007081`
...
- source class: `HUST-OBC/undeciphered/X/1044/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1044/X_？_8005_1.png`
- asset id: `asset-007081`
...
- Which source records identify obs-unk-005488 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005488？
