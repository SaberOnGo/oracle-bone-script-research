# Material Visual Observation / obs-comp-cand-000403 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000403`
- External reference / 外部参照: `obimd-sub-qj5ls1wkvt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012326_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qj5ls1wkvt/qj5ls1wkvt/qj5ls1wkvt.png`
- Checksum / 校验和:
  `aca1dd87b0675f8d005aa9011249d24735a62ce96574cb1b3bf6685d8b7a0d41`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 15.85%.
- Marked-pixel bounds: (49,22)–(200,224); span 152 × 203 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占15.85%。
- 痕迹范围：(49,22)–(200,224)；跨度152 × 203 px；痕迹矩形高于宽。
