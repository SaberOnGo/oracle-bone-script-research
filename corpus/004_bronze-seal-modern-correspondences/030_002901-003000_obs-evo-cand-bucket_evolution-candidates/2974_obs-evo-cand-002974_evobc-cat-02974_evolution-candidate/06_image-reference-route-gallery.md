...
- `obs-evo-cand-002974-route-category-staging`
...
- `obs-evo-cand-002974-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002974-route-evolution-graph`
