...
- Evidence collection task ID / 证据收集任务 ID: `graph-source-evidence-task-003`
...
- Target evidence section / 目标证据章节: `package_manifest`
- Collection scope / 收集范围: `collect_package_manifest_rows_and_commit_policy_notes`
- Expected output path from task queue / 任务队列预期输出路径: `doc/public/user_research/003_evidence-collection-tasks/hust-obc/graph-source-evidence-task-003_package-manifest_collection-note.md`
...
- Collection scope / 收集范围:
  - `collect_package_manifest_rows_and_commit_policy_notes`
- Task status / 任务状态:
  - `not_started`
