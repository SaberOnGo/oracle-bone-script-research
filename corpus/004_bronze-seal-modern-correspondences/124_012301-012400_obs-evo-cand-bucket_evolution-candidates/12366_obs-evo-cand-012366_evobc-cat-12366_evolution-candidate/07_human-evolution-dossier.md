...
- Project ID: `obs-evo-cand-012366`
- EVOBC category candidate ID: `evobc-evo-cat-12366`
- External category reference: `evobc-cat-12366`
- Source category ID: `12366`
- Source label for human review: `𨓐`
- Source codepoints: `U+284D0`
...
- `obs-evo-cand-012366-route-category-staging`
...
- `obs-evo-cand-012366-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012366-route-evolution-graph`
