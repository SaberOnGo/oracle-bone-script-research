...
- `obs-evo-cand-005890-route-category-staging`
...
- `obs-evo-cand-005890-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005890-route-evolution-graph`
