# obs-unk-004703 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004703`
- primary external id: `hust-obc-und-X-004703`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/003_obs-unk-004703_h
  ust-obc-und-X-004703_oracle-character-candidate/03_visual-assets/001_asset
  -006296_hust-obc-und-X-004703_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/259/X_？_7232_1.png`
- asset id: `asset-006296`
...
- source class: `HUST-OBC/undeciphered/X/259/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/259/X_？_7232_1.png`
- asset id: `asset-006296`
...
- English observation: `branching form with long central opening`
- 中文观察: `带中央长开口的分支形笔画组`
...
- Which source records identify obs-unk-004703 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004703？
