# obs-char-001102 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001102`
- primary external id: `hust-obc-cat-1231_1232`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1102_obs-char-001102_hust-obc-cat-1231_123
  2_oracle-character/03_visual-assets/001_asset-001107_hust-obc-cat-1231_123
  2_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1231_1232/1231/G_1231_乙3340(甲).
  png`
- asset id: `asset-001107`
...
- source category: `1231_1232`
- validation class: `1101`
- source image route: `HUST-OBC/deciphered/1231_1232/1231/G_1231_乙3340(甲).png`
- asset id: `asset-001107`
...
- English observation: `A broad peaked contour descends into two rounded
  lower enclosed forms.`
- 中文观察: `宽大的尖顶轮廓向下分为两个圆弧下部闭合形体。`
...
- dataset label text: `㣅㣆`
- dataset label codepoints: `U+38C5;U+38C6`
...
- graph edge count: `2`
- codepoint routes: `U+38C5;U+38C6`
...
- Which source records identify obs-char-001102 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001102？
