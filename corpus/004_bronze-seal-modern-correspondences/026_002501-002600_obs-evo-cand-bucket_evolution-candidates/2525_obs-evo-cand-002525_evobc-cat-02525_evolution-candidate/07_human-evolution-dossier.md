...
- External category reference: `evobc-cat-02525`
- Source category ID: `02525`
- Source label for human review: `山`
- Source codepoints: `U+5C71`
- Image reference count in source metadata: `197`
...
- `obs-evo-cand-002525-route-category-staging`
...
- `obs-evo-cand-002525-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002525-route-evolution-graph`
