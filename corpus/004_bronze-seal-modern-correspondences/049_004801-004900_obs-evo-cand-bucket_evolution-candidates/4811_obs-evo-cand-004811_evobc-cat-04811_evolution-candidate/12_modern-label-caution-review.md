# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004811
...
- EVOBC candidate category: `evobc-evo-cat-04811`.
- Source label for search only: `溝`.
- Source codepoints for search only: `U+6E9D`.
