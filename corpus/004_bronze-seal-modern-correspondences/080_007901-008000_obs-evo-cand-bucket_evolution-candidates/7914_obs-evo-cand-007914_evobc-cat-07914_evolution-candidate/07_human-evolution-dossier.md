...
- External category reference: `evobc-cat-07914`
- Source category ID: `07914`
- Source label for human review: `衠`
- Source codepoints: `U+8860`
...
- `obs-evo-cand-007914-route-category-staging`
...
- `obs-evo-cand-007914-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007914-route-evolution-graph`
