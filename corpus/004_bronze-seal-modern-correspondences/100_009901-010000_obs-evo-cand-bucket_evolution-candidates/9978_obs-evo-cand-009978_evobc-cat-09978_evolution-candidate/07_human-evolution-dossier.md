...
- External category reference: `evobc-cat-09978`
- Source category ID: `09978`
- Source label for human review: `頏`
...
- `obs-evo-cand-009978-route-category-staging`
...
- `obs-evo-cand-009978-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009978-route-evolution-graph`
