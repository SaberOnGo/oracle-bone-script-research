# obs-char-001388 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1388_obs-char-001388_hust-obc-cat-1552_155
  3_oracle-character/03_visual-assets/001_asset-001393_hust-obc-cat-1552_155
  3_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1552_1553/1552/G_1552_乙533合454賓
  組.png`
- asset id: `asset-001393`
...
- source category: `1552_1553`
- validation class: `1387`
- source image route: `HUST-OBC/deciphered/1552_1553/1552/G_1552_乙533合454賓組.pn
  g`
- asset id: `asset-001393`
...
- English observation: `A peaked upper fork leads into a long central stem
  with side branches.`
- 中文观察: `尖拱上部分叉连接长中央竖干，旁有侧部分枝。`
...
- dataset label text: `㨆㨇`
- dataset label codepoints: `U+3A06;U+3A07`
...
- filename catalog route clues: `Heji-like filename clue: 合454
  (G_1552_乙533合454賓組.png)`
...
- Which source records identify obs-char-001388 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001388？
