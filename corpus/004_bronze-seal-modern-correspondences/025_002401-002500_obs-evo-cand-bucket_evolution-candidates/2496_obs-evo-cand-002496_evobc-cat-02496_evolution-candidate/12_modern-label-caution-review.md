# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002496
...
- EVOBC candidate category: `evobc-evo-cat-02496`.
- Source label for search only: `层`.
- Source codepoints for search only: `U+5C42`.
