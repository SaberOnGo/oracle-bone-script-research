...
- External category reference: `evobc-cat-05758`
- Source category ID: `05758`
- Source label: `盟`
...
- `obs-evo-cand-005758-route-category-staging`
...
- `obs-evo-cand-005758-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005758-route-evolution-graph`
