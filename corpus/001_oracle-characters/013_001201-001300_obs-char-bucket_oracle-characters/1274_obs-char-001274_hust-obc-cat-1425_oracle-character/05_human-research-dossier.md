# obs-char-001274 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1274_obs-char-001274_hust-obc-cat-1425_ora
  cle-character/03_visual-assets/001_asset-001279_hust-obc-cat-1425_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1425/G_1425_乙8698合22268子組.png`
- asset id: `asset-001279`
...
- source category: `1425`
- validation class: `1273`
- source image route: `HUST-OBC/deciphered/1425/G_1425_乙8698合22268子組.png`
- asset id: `asset-001279`
...
- English observation: `A dense dark form has a pointed upper turn, a narrow
  central enclosure, left lower marks, and a long right edge.`
- 中文观察: `密集深色形体有尖状上部转折、狭长中央框形、左下标记和长右侧边线。`
...
- dataset label text: `㦇`
- dataset label codepoints: `U+3987`
...
- filename catalog route clues: `Heji-like filename clue: 合22268
  (G_1425_乙8698合22268子組.png)`
...
- Which source records identify obs-char-001274 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001274？
