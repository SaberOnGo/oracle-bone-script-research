...
- `obs-evo-cand-010902-route-category-staging`
...
- `obs-evo-cand-010902-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010902-route-evolution-graph`
