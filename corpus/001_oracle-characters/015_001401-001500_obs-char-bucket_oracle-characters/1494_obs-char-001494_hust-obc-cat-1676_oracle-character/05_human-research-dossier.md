# obs-char-001494 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001494`
- primary external id: `hust-obc-cat-1676`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1494_obs-char-001494_hust-obc-cat-1676_ora
  cle-character/03_visual-assets/001_asset-001499_hust-obc-cat-1676_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1676/G_1676_中大4.png`
- asset id: `asset-001499`
...
- source category: `1676`
- validation class: `1493`
- source image route: `HUST-OBC/deciphered/1676/G_1676_中大4.png`
- asset id: `asset-001499`
...
- English observation: `A narrow branching form has an upper cap, a middle
  loop, and a long stem.`
- 中文观察: `狭长分枝形体有上盖、中部环形和长竖干。`
...
- dataset label text: `㪂`
- dataset label codepoints: `U+3A82`
...
- Which source records identify obs-char-001494 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001494？
