# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002610
...
| --- | --- | --- | --- |
| `obimd-glyph-link-039573` | 󿬲 | `U+FFB32` | `reviewed_metadata_only` |
| `obimd-glyph-link-039574` | 󾮜 | `U+FEB9C` | `reviewed_metadata_only` |
