# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010213
...
- EVOBC candidate category: `evobc-evo-cat-10213`.
- Source label for search only: `騊`.
- Source codepoints for search only: `U+9A0A`.
