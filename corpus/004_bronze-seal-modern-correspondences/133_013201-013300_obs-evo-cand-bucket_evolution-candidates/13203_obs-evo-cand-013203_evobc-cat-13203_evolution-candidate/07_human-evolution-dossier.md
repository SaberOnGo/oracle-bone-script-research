...
- Project ID: `obs-evo-cand-013203`
- EVOBC category candidate ID: `evobc-evo-cat-13203`
- External category reference: `evobc-cat-13203`
- Source category ID: `13203`
- Source label for human review: `𬅤`
- Source codepoints: `U+2C164`
...
- `obs-evo-cand-013203-route-category-staging`
...
- `obs-evo-cand-013203-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013203-route-evolution-graph`
