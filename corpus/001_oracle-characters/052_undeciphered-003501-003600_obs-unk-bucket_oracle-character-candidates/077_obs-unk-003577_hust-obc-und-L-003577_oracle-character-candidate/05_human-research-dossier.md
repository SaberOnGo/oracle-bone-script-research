# obs-unk-003577 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003577`
- primary external id: `hust-obc-und-L-003577`
...
- local review image route: `corpus/001_oracle-characters/052_undeciphered-003
  501-003600_obs-unk-bucket_oracle-character-candidates/077_obs-unk-003577_h
  ust-obc-und-L-003577_oracle-character-candidate/03_visual-assets/001_asset
  -005170_hust-obc-und-L-003577_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3577/L_？_7116.jpg`
- asset id: `asset-005170`
...
- source class: `HUST-OBC/undeciphered/L/3577/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3577/L_？_7116.jpg`
- asset id: `asset-005170`
...
- Which source records identify obs-unk-003577 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003577？
