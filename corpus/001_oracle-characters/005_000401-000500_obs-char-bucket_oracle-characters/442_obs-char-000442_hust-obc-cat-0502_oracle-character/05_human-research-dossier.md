# obs-char-000442 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000442`
- primary external id: `hust-obc-cat-0502`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/442_obs-char-000442_hust-obc-cat-0502_orac
  le-character/03_visual-assets/001_asset-000447_hust-obc-cat-0502_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0502/H_0502_60284_0.png`
- asset id: `asset-000447`
...
- source category: `0502`
- validation class: `441`
- source image route: `HUST-OBC/deciphered/0502/H_0502_60284_0.png`
- asset id: `asset-000447`
...
- English observation: `Two vertically separated clusters are visible: an
  upper crossed looping form with a bent tail, and a lower broad curve
  flanked by two branching strokes.`
- 中文观察: `可见两个上下分离的笔画群：上部为交叉环曲形及弯折尾笔，下部宽弧两侧各有分支笔画。`
...
- dataset label text: `㗬`
- dataset label codepoints: `U+35EC`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00037`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/037_obs-evo-can
  d-000037_evobc-cat-00037_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/037_obs-evo-cand-000037_evobc-cat-00037_evolu
...
- filename catalog route clues: `catalog-like filename clue: H_0502
  (H_0502_60284_0.png)`
...
- Which source records identify obs-char-000442 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000442？
