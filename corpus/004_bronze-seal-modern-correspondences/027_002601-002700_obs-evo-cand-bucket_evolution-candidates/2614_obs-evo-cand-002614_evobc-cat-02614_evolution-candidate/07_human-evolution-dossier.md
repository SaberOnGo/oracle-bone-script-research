...
- External category reference: `evobc-cat-02614`
- Source category ID: `02614`
- Source label for human review: `巡`
...
- `obs-evo-cand-002614-route-category-staging`
...
- `obs-evo-cand-002614-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002614-route-evolution-graph`
