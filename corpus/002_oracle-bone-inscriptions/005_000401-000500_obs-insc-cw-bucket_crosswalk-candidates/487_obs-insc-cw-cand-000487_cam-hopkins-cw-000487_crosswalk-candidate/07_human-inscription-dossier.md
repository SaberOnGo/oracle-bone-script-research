...
- Yingguo / 英国所藏: `y2408` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `579` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `29` in source row; primary catalog entry pending
- Heji / 合集: `41488` in source row; primary catalog entry pending
