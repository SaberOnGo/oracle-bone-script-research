# obs-evo-cand-011755 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-011755`
- EVOBC category candidate ID: `evobc-evo-cat-11755`
- External category ref: `evobc-cat-11755`
- Source label: `𥁰`
- Source codepoints: `U+25070`
- Image reference count: `39`
- Era token counts: `OBC:14;SS:1;WSC:24`
- Source token counts: `Book:31;Web:7;說文Web:1`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 14 image references
