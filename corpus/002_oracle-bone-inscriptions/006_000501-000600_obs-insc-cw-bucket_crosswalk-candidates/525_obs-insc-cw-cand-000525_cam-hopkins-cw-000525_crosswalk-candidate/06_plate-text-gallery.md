...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000525` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2518` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `554` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `740` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `41741` [route_present_image_or_text_not_collected]
