...
Project ID: `obs-evo-cand-011123`
...
- Project ID: `obs-evo-cand-011123`
- EVOBC category candidate ID: `evobc-evo-cat-11123`
- External category reference: `evobc-cat-11123`
- Source category ID: `11123`
- Source label for human review: `𡼝`
- Source codepoints: `U+21F1D`
...
- `obs-evo-cand-011123-route-category-staging`
...
- `obs-evo-cand-011123-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011123-route-evolution-graph`
