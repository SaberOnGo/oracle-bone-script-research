...
- External category reference: `evobc-cat-02692`
- Source category ID: `02692`
- Source label for human review: `幰`
...
- `obs-evo-cand-002692-route-category-staging`
...
- `obs-evo-cand-002692-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002692-route-evolution-graph`
