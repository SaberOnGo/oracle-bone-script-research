# obs-evo-cand-010267 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-010267`
- EVOBC category candidate ID: `evobc-evo-cat-10267`
- External category ref: `evobc-cat-10267`
- Source label: `驪`
- Source codepoints: `U+9A6A`
- Image reference count: `13`
- Era token counts: `OBC:8;SS:1;WSC:4`
- Source token counts: `Book:12;Web:1`
