...
- Project ID: `obs-evo-cand-006152`
- EVOBC category candidate ID: `evobc-evo-cat-06152`
- External category reference: `evobc-cat-06152`
- Source category ID: `06152`
- Source label for human review: `窀`
- Source codepoints: `U+7A80`
...
- `obs-evo-cand-006152-route-category-staging`
...
- `obs-evo-cand-006152-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006152-route-evolution-graph`
