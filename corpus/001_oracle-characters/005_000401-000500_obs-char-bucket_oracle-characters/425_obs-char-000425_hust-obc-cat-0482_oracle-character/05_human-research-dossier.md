# obs-char-000425 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000425`
- primary external id: `hust-obc-cat-0482`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/425_obs-char-000425_hust-obc-cat-0482_orac
  le-character/03_visual-assets/001_asset-000430_hust-obc-cat-0482_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0482/X_0482_5597_1.png`
- asset id: `asset-000430`
...
- source category: `0482`
- validation class: `424`
- source image route: `HUST-OBC/deciphered/0482/X_0482_5597_1.png`
- asset id: `asset-000430`
...
- English observation: `Two bold separated forms are visible: a sinuous
  crossed form at left and a tall pointed outline on a short base at right.`
- 中文观察: `可见两个粗重分离形体：左侧为曲折交叉形，右侧为立于短底线上的高尖轮廓。`
...
- dataset label text: `㗘`
- dataset label codepoints: `U+35D8`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00036`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00036`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00036`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/036_obs-evo-can
  d-000036_evobc-cat-00036_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/036_obs-evo-cand-000036_evobc-cat-00036_evolu
...
- Which source records identify obs-char-000425 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000425？
