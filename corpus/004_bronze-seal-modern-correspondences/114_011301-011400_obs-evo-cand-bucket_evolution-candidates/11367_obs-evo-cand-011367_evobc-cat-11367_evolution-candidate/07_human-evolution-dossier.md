...
- External category reference: `evobc-cat-11367`
- Source category ID: `11367`
- Source label for human review: `𣀙`
- Source codepoints: `U+23019`
...
- `obs-evo-cand-011367-route-category-staging`
...
- `obs-evo-cand-011367-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011367-route-evolution-graph`
