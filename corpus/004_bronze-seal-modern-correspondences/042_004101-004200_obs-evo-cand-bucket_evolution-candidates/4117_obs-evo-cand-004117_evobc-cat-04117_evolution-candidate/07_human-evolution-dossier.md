...
Project ID: `obs-evo-cand-004117`
...
- Project ID: `obs-evo-cand-004117`
- EVOBC category candidate ID: `evobc-evo-cat-04117`
- External category reference: `evobc-cat-04117`
- Source category ID: `04117`
- Source label for human review: `椅`
- Source codepoints: `U+6905`
...
- `obs-evo-cand-004117-route-category-staging`
...
- `obs-evo-cand-004117-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004117-route-evolution-graph`
