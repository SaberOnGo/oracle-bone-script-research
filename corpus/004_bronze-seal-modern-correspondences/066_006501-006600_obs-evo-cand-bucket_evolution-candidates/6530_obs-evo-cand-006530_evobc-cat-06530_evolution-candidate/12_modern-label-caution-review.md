# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006530
...
- EVOBC candidate category: `evobc-evo-cat-06530`.
- Source label for search only: `絻`.
- Source codepoints for search only: `U+7D7B`.
