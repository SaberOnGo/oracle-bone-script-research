...
Project ID: `obs-evo-cand-003235`
...
- Project ID: `obs-evo-cand-003235`
- EVOBC category candidate ID: `evobc-evo-cat-03235`
- External category reference: `evobc-cat-03235`
- Source category ID: `03235`
- Source label for human review: `房`
- Source codepoints: `U+623F`
...
- `obs-evo-cand-003235-route-category-staging`
...
- `obs-evo-cand-003235-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003235-route-evolution-graph`
