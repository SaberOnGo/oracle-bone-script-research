# obs-evo-cand-005559 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-005559`
- EVOBC category candidate ID: `evobc-evo-cat-05559`
- External category ref: `evobc-cat-05559`
- Source label: `畋`
- Source codepoints: `U+754B`
- Image reference count: `68`
- Era token counts: `BI:3;OBC:39;SS:1;WSC:25`
- Source token counts: `Book:29;Web:39`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 39 image references
- era 1 / BI: 3 image references
- era 2 / SS: 1 image references
- era 4 / WSC: 25 image references
- source 0 / Web:1633: 1 image references
- source 1 / Web:105952;說文Web:58: 17 image references
