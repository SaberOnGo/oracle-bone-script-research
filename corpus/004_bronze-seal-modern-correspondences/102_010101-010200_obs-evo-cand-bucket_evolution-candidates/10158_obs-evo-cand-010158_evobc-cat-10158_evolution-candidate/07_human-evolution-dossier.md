...
Project ID: `obs-evo-cand-010158`
...
- Project ID: `obs-evo-cand-010158`
- EVOBC category candidate ID: `evobc-evo-cat-10158`
- External category reference: `evobc-cat-10158`
- Source category ID: `10158`
- Source label for human review: `馨`
- Source codepoints: `U+99A8`
...
- `obs-evo-cand-010158-route-category-staging`
...
- `obs-evo-cand-010158-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010158-route-evolution-graph`
