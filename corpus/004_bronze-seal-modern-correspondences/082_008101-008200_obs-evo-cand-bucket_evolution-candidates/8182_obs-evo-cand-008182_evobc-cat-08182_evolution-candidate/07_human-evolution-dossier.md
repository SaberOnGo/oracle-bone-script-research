...
Project ID: `obs-evo-cand-008182`
...
- Project ID: `obs-evo-cand-008182`
- EVOBC category candidate ID: `evobc-evo-cat-08182`
- External category reference: `evobc-cat-08182`
- Source category ID: `08182`
- Source label for human review: `詛`
- Source codepoints: `U+8A5B`
...
- `obs-evo-cand-008182-route-category-staging`
...
- `obs-evo-cand-008182-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008182-route-evolution-graph`
