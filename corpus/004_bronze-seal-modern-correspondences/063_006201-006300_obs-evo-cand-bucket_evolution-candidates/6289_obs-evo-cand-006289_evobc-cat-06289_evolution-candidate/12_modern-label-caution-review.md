# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006289
...
- EVOBC candidate category: `evobc-evo-cat-06289`.
- Source label for search only: `箏`.
- Source codepoints for search only: `U+7B8F`.
