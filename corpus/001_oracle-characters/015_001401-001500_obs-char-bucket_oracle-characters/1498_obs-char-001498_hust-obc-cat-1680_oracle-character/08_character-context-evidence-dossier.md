...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1680`
...
- Source image / 来源图: `G_1680_合8197賓組.png`
- Image / 图像: `001_asset-001503_hust-obc-cat-1680_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合8197
  (G_1680_合8197賓組.png)`
...
- target node: `evobc-evo-cat-00146`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/146_obs-evo-cand-000146_evobc-cat-00146_evoluti
...
- Source label text / 来源标签文字: `㪆`
- Source label codepoint / 来源标签 codepoint: `U+3A86`
