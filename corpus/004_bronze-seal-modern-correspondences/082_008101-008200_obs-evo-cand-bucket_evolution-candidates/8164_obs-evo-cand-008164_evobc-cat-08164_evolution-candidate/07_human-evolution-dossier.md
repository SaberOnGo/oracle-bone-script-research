...
Project ID: `obs-evo-cand-008164`
...
- Project ID: `obs-evo-cand-008164`
- EVOBC category candidate ID: `evobc-evo-cat-08164`
- External category reference: `evobc-cat-08164`
- Source category ID: `08164`
- Source label for human review: `詀`
- Source codepoints: `U+8A40`
...
- `obs-evo-cand-008164-route-category-staging`
...
- `obs-evo-cand-008164-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008164-route-evolution-graph`
