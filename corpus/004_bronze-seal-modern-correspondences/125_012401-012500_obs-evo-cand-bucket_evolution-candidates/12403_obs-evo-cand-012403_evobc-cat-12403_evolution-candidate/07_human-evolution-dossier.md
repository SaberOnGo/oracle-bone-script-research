...
- Project ID: `obs-evo-cand-012403`
- EVOBC category candidate ID: `evobc-evo-cat-12403`
- External category reference: `evobc-cat-12403`
- Source category ID: `12403`
- Source label for human review: `𨙼`
- Source codepoints: `U+2867C`
...
- `obs-evo-cand-012403-route-category-staging`
...
- `obs-evo-cand-012403-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012403-route-evolution-graph`
