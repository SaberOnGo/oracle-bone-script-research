# obs-unk-004840 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/040_obs-unk-004840_h
  ust-obc-und-X-004840_oracle-character-candidate/03_visual-assets/001_asset
  -006433_hust-obc-und-X-004840_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/396/X_？_7382_1.png`
- asset id: `asset-006433`
...
- source class: `HUST-OBC/undeciphered/X/396/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/396/X_？_7382_1.png`
- asset id: `asset-006433`
...
- English observation: `central uprights, right extension, and lower opening`
- 中文观察: `中部竖笔、右侧延伸和下部开口`
...
- Which source records identify obs-unk-004840 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004840？
