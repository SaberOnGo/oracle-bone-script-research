# Material Visual Observation / obs-comp-cand-001834 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001834`
- External reference / 外部参照: `obimd-sub-0g9f2s2g2f`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018160_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7h3wu2xyyf/0g9f2s2g2f/0g9f2s2g2f.png`
- Checksum / 校验和:
  `f9585aec943927f85ae25fbdb02fc1b66059e6d782343f0ab375d9f69b0235f3`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.88%.
- Marked-pixel bounds: (57,16)–(192,232); span 136 × 217 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.88%。
- 痕迹范围：(57,16)–(192,232)；跨度136 × 217 px；痕迹矩形高于宽。
