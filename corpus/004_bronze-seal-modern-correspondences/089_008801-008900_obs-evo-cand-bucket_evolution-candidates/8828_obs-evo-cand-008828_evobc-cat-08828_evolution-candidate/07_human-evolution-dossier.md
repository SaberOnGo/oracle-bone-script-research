...
- External category reference: `evobc-cat-08828`
- Source category ID: `08828`
- Source label for human review: `輅`
...
- `obs-evo-cand-008828-route-category-staging`
...
- `obs-evo-cand-008828-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008828-route-evolution-graph`
