...
- Project ID: `obs-evo-cand-004935`
- EVOBC category candidate ID: `evobc-evo-cat-04935`
- External category reference: `evobc-cat-04935`
- Source category ID: `04935`
- Source label for human review: `澜`
- Source codepoints: `U+6F9C`
...
- `obs-evo-cand-004935-route-category-staging`
...
- `obs-evo-cand-004935-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004935-route-evolution-graph`
