# Material Visual Observation / obs-comp-cand-001315 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001315`
- External reference / 外部参照: `obimd-sub-yqwtqscvwf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015652_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/yqwtqscvwf/yqwtqscvwf/yqwtqscvwf.png`
- Checksum / 校验和:
  `389ebfe62c1a78341aba0b0bb8fa1cc8a93587153e43ee77c1fee95252234606`
...
- Marked-pixel bounds: (51,53)–(198,201); span 148 × 149 px; the marked
...
- 痕迹范围：(51,53)–(198,201)；跨度148 × 149 px；痕迹矩形近方形。
