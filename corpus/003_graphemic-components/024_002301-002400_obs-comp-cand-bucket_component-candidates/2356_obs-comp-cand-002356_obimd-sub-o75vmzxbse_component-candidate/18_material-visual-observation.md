# Material Visual Observation / obs-comp-cand-002356 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002356`
- External reference / 外部参照: `obimd-sub-o75vmzxbse`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020427_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/o75vmzxbse/o75vmzxbse/o75vmzxbse.png`
- Checksum / 校验和:
  `0f32e03e7c1584cd7e2e80b7679a7fbe09999656023a9a17917633d47a0e11ae`
...
- Marked-pixel bounds: (79,8)–(169,240); span 91 × 233 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.04%。
- 痕迹范围：(79,8)–(169,240)；跨度91 × 233 px；痕迹矩形高于宽。
