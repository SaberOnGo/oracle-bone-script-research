# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013007
...
- EVOBC candidate category: `evobc-evo-cat-13007`.
- Source label for search only: `𫣺`.
- Source codepoints for search only: `U+2B8FA`.
