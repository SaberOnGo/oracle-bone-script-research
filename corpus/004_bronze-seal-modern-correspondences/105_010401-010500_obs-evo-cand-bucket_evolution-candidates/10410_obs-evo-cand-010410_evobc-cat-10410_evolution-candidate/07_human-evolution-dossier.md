...
- External category reference: `evobc-cat-10410`
- Source category ID: `10410`
...
- `obs-evo-cand-010410-route-category-staging`
...
- `obs-evo-cand-010410-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010410-route-evolution-graph`
