# obs-char-001490 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1490_obs-char-001490_hust-obc-cat-1672_ora
  cle-character/03_visual-assets/001_asset-001495_hust-obc-cat-1672_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1672/G_1672_乙4227合18693.png`
- asset id: `asset-001495`
...
- source category: `1672`
- validation class: `1489`
- source image route: `HUST-OBC/deciphered/1672/G_1672_乙4227合18693.png`
- asset id: `asset-001495`
...
- English observation: `Three separated rounded enclosures form two upper
  marks and one lower mark.`
...
- dataset label text: `㩾`
- dataset label codepoints: `U+3A7E`
...
- filename catalog route clues: `Heji-like filename clue: 合18693
...
- Which source records identify obs-char-001490 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001490？
