# obs-unk-004671 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/071_obs-unk-004671_h
  ust-obc-und-X-004671_oracle-character-candidate/03_visual-assets/001_asset
  -006264_hust-obc-und-X-004671_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/227/X_？_8396_1.png`
- asset id: `asset-006264`
...
- source class: `HUST-OBC/undeciphered/X/227/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/227/X_？_8396_1.png`
- asset id: `asset-006264`
...
- English observation: `tall central stroke with left branch and right curve`
- 中文观察: `带左侧分支和右侧弧线的高中央笔画`
...
- Which source records identify obs-unk-004671 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004671？
