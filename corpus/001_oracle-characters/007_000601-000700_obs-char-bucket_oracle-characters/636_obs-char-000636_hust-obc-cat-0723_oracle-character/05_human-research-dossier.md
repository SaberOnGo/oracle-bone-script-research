# obs-char-000636 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/636_obs-char-000636_hust-obc-cat-0723_orac
  le-character/03_visual-assets/001_asset-000641_hust-obc-cat-0723_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0723/H_0723_60164_0.png`
- asset id: `asset-000641`
...
- source category: `0723`
- validation class: `635`
- source image route: `HUST-OBC/deciphered/0723/H_0723_60164_0.png`
- asset id: `asset-000641`
...
- English observation: `A thick central upright branches into two long upper
  diagonals and two spreading lower legs; a short extra diagonal crosses the
  upper-left branch.`
- 中文观察: `粗中央直干分出两条长上斜枝和两条外展下腿，另有短斜笔穿过左上枝。`
...
- dataset label text: `㛉`
- dataset label codepoints: `U+36C9`
...
- filename catalog route clues: `catalog-like filename clue: H_0723
  (H_0723_60164_0.png)`
...
- Which source records identify obs-char-000636 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000636？
