# obs-unk-004714 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/014_obs-unk-004714_h
  ust-obc-und-X-004714_oracle-character-candidate/03_visual-assets/001_asset
  -006307_hust-obc-und-X-004714_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/270/X_？_7244_1.png`
- asset id: `asset-006307`
...
- source class: `HUST-OBC/undeciphered/X/270/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/270/X_？_7244_1.png`
- asset id: `asset-006307`
...
- English observation: `rounded upper band with separate lower form`
- 中文观察: `带分离下部结构的圆钝上部横带`
...
- Which source records identify obs-unk-004714 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004714？
