# obs-char-000137 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000137`
- primary external id: `hust-obc-cat-0152`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/137_obs-char-000137_hust-obc-cat-0152_orac
  le-character/03_visual-assets/001_asset-000142_hust-obc-cat-0152_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0152/G_0152_乙1239.png`
- asset id: `asset-000142`
...
- source category: `0152`
- validation class: `136`
- source image route: `HUST-OBC/deciphered/0152/G_0152_乙1239.png`
- asset id: `asset-000142`
...
- English observation: `The image shows an open triangular upper frame, a
  crossbar inside it, and a narrow pointed stroke descending from the
  center.`
- 中文观察: `图像上部为开放三角形框，内部有横笔，中央向下延伸一条窄而尖的笔画。`
...
- dataset label text: `㒎`
- dataset label codepoints: `U+348E`
...
- Which source records identify obs-char-000137 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000137？
