# obs-unk-004925 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/025_obs-unk-004925_h
  ust-obc-und-X-004925_oracle-character-candidate/03_visual-assets/001_asset
  -006518_hust-obc-und-X-004925_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/481/X_？_7466_1.png`
- asset id: `asset-006518`
...
- Two separated groups are visible with a long right descent.
...
- source class: `HUST-OBC/undeciphered/X/481/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/481/X_？_7466_1.png`
- asset id: `asset-006518`
...
- Which source records identify obs-unk-004925 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004925？
