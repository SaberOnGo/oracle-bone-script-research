...
- External category reference: `evobc-cat-07247`
- Source category ID: `07247`
- Source label for human review: `芞`
...
- `obs-evo-cand-007247-route-category-staging`
...
- `obs-evo-cand-007247-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007247-route-evolution-graph`
