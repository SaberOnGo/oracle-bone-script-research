# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006426
...
- EVOBC candidate category: `evobc-evo-cat-06426`.
- Source label for search only: `糜`.
- Source codepoints for search only: `U+7CDC`.
