# Material Visual Observation / obs-comp-cand-001726 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001726`
- External reference / 外部参照: `obimd-sub-kkt3pdctdg`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017905_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kkt3pdctdg/kkt3pdctdg/00eyzc9ief.png`
- Checksum / 校验和:
  `adb962e8f3c4bafaefb7926e7983d5478a21cc902e763965f015bcb178b40459`
...
- Marked-pixel bounds: (51,75)–(198,170); span 148 × 96 px; the marked rectangle
  is wider than tall.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.38%。
- 痕迹范围：(51,75)–(198,170)；跨度148 × 96 px；痕迹矩形宽于高。
