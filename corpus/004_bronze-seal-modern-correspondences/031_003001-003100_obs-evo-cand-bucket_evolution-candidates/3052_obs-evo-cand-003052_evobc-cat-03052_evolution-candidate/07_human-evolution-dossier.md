...
- External category reference: `evobc-cat-03052`
- Source category ID: `03052`
- Source label for human review: `惝`
...
- `obs-evo-cand-003052-route-category-staging`
...
- `obs-evo-cand-003052-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003052-route-evolution-graph`
