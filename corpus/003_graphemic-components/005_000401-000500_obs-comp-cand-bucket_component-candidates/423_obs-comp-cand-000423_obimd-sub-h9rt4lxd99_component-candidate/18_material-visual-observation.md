# Material Visual Observation / obs-comp-cand-000423 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000423`
- External reference / 外部参照: `obimd-sub-h9rt4lxd99`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012346_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h9rt4lxd99/h9rt4lxd99/h9rt4lxd99.png`
- Checksum / 校验和:
  `781ec0ab46daf5e2586ddf6840c358a052c4d75ee859136aacd4446c2e286a90`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.74%.
- Marked-pixel bounds: (58,31)–(191,212); span 134 × 182 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.74%。
- 痕迹范围：(58,31)–(191,212)；跨度134 × 182 px；痕迹矩形高于宽。
