# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001800
...
| --- | --- | --- | --- |
| `obimd-glyph-link-027445` | 畐󺔾 | `U+7550;U+FA53E` | `reviewed_metadata_only` |
| `obimd-glyph-link-027446` | 󺔿 | `U+FA53F` | `reviewed_metadata_only` |
| `obimd-glyph-link-027447` | 󺕀 | `U+FA540` | `reviewed_metadata_only` |
