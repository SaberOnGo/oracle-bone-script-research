# obs-comp-cand-000645 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000645`
- 首选外部 ID: `obimd-sub-iexlgj4cvt`
- OBIMD subcharacter UID: `iexlgj4cvt`
- OBIMD main character UID: `iexlgj4cvt`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+A6D5C;U+F3BAC; U+F3BAD; 另有 3 项
