...
- External category reference: `evobc-cat-02868`
- Source category ID: `02868`
- Source label for human review: `徎`
...
- `obs-evo-cand-002868-route-category-staging`
...
- `obs-evo-cand-002868-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002868-route-evolution-graph`
