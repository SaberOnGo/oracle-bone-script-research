# obs-xwalk-cand-001345 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+39D4` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-1502` | not reading |
| OBIMD route / OBIMD 路线 | `pending route` | not component |
| EVOBC route / EVOBC 路线 | `evobc-evo-cat-00143` | not evolution |
| Source and rights trail / 来源与权利链 | `source_marked_risk_noted` | source-marked risk note required |
| Missing evidence route / 缺失证据路线 | `matched_evobc_by_codepoint` | not decipherment |
