# src-cambridge-hopkins Material Access Index / src-cambridge-hopkins 资料访问索引
...
| --- | --- | --- | --- |
| Source summary / 来源摘要 | `README.md` | present | source ID `src-cambridge-hopkins` |
...
| Field maps / 字段映射 | `04_field-map-route-index.csv` | field_rows_present | 2 row(s); target records: oracle_inscription;statistics |
