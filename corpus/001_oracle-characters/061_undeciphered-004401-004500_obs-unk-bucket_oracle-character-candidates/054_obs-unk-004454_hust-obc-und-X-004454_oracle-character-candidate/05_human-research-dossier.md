# obs-unk-004454 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004454`
- primary external id: `hust-obc-und-X-004454`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/054_obs-unk-004454_h
  ust-obc-und-X-004454_oracle-character-candidate/03_visual-assets/001_asset
  -006047_hust-obc-und-X-004454_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/10/X_？_8190_1.png`
- asset id: `asset-006047`
...
- source class: `HUST-OBC/undeciphered/X/10/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/10/X_？_8190_1.png`
- asset id: `asset-006047`
...
- English observation: `A central forked trace stands between a long`
  `left curve and right mark.`
- 中文观察: `中央分叉痕迹位于左侧长弯痕和右侧痕迹之间。`
...
- Which source records identify obs-unk-004454 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004454？
