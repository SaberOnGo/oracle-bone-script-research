...
- Project ID: `obs-evo-cand-009664`
- EVOBC category candidate ID: `evobc-evo-cat-09664`
- External category reference: `evobc-cat-09664`
- Source category ID: `09664`
- Source label for human review: `闞`
- Source codepoints: `U+95DE`
...
- `obs-evo-cand-009664-route-category-staging`
...
- `obs-evo-cand-009664-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009664-route-evolution-graph`
