# obs-unk-004684 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004684`
- primary external id: `hust-obc-und-X-004684`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/084_obs-unk-004684_h
  ust-obc-und-X-004684_oracle-character-candidate/03_visual-assets/001_asset
  -006277_hust-obc-und-X-004684_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/240/X_？_8408_1.png`
- asset id: `asset-006277`
...
- source class: `HUST-OBC/undeciphered/X/240/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/240/X_？_8408_1.png`
- asset id: `asset-006277`
...
- English observation: `broad group with right opening and uneven edges`
- 中文观察: `带右侧开口和不规则边缘的宽大笔画组`
...
- Which source records identify obs-unk-004684 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004684？
