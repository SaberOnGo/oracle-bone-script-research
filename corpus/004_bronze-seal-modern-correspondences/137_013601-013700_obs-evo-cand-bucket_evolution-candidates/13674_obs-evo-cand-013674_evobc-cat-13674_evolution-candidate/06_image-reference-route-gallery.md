...
- `obs-evo-cand-013674-route-category-staging`
...
- `obs-evo-cand-013674-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013674-route-evolution-graph`
