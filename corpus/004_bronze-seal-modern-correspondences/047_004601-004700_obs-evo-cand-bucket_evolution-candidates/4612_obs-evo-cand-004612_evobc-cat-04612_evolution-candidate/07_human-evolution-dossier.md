...
Project ID: `obs-evo-cand-004612`
...
- Project ID: `obs-evo-cand-004612`
- EVOBC category candidate ID: `evobc-evo-cat-04612`
- External category reference: `evobc-cat-04612`
- Source category ID: `04612`
- Source label for human review: `洈`
- Source codepoints: `U+6D08`
...
- `obs-evo-cand-004612-route-category-staging`
...
- `obs-evo-cand-004612-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004612-route-evolution-graph`
