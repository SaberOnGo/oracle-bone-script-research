...
Project ID: `obs-evo-cand-012602`
...
- Project ID: `obs-evo-cand-012602`
- EVOBC category candidate ID: `evobc-evo-cat-12602`
- External category reference: `evobc-cat-12602`
- Source category ID: `12602`
- Source label for human review: `𩐙`
- Source codepoints: `U+29419`
...
- `obs-evo-cand-012602-route-category-staging`
...
- `obs-evo-cand-012602-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012602-route-evolution-graph`
