# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000540
...
- EVOBC candidate category: `evobc-evo-cat-00540`.
- Source label for search only: `䩦`.
- Source codepoints for search only: `U+4A66`.
