...
- Project ID: `obs-evo-cand-000644`
- EVOBC category candidate ID: `evobc-evo-cat-00644`
- External category reference: `evobc-cat-00644`
- Source category ID: `00644`
- Source label for human review: `丸`
- Source codepoints: `U+4E38`
...
- `obs-evo-cand-000644-route-category-staging`
...
- `obs-evo-cand-000644-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000644-route-evolution-graph`
