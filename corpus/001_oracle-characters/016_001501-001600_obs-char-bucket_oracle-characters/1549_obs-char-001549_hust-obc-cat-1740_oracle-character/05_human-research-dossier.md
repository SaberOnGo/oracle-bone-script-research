# obs-char-001549 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001549`
- primary external id: `hust-obc-cat-1740`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1549_obs-char-001549_hust-obc-cat-1740_ora
  cle-character/03_visual-assets/001_asset-001554_hust-obc-cat-1740_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1740/G_1740_乙152合20364𠂤組.png`
- asset id: `asset-001554`
...
- source category: `1740`
- validation class: `1548`
- source image route: `HUST-OBC/deciphered/1740/G_1740_乙152合20364𠂤組.png`
- asset id: `asset-001554`
...
- English observation: `A sparse composite pairs two curved left strokes
  with a small angular right cluster.`
- 中文观察: `稀疏组合形体将两条左侧弧笔与右侧小型折角笔画群相配。`
...
- dataset label text: `㫂`
- dataset label codepoints: `U+3AC2`
...
- Which source records identify obs-char-001549 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001549？
