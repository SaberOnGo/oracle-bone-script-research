# obs-unk-004943 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004943`
- primary external id: `hust-obc-und-X-004943`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/043_obs-unk-004943_h
  ust-obc-und-X-004943_oracle-character-candidate/03_visual-assets/001_asset
  -006536_hust-obc-und-X-004943_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/499/X_？_7482_1.png`
- asset id: `asset-006536`
...
- A dark crop has pale irregular openings but unclear stroke edges.
- The single source view is present locally.
- 直接记录：`14_material-visual-observation.md`
- 深色裁切中有不规则浅色开口，但笔画边缘不清。
- 单一来源视图已在本地保存。
...
- source class: `HUST-OBC/undeciphered/X/499/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/499/X_？_7482_1.png`
- asset id: `asset-006536`
...
- Which source records identify obs-unk-004943 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004943？
