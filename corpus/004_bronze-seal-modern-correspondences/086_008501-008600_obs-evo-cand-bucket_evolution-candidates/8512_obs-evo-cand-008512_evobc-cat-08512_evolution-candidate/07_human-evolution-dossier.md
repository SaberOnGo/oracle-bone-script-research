...
Project ID: `obs-evo-cand-008512`
...
- Project ID: `obs-evo-cand-008512`
- EVOBC category candidate ID: `evobc-evo-cat-08512`
- External category reference: `evobc-cat-08512`
- Source category ID: `08512`
- Source label for human review: `豻`
- Source codepoints: `U+8C7B`
...
- `obs-evo-cand-008512-route-category-staging`
...
- `obs-evo-cand-008512-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008512-route-evolution-graph`
