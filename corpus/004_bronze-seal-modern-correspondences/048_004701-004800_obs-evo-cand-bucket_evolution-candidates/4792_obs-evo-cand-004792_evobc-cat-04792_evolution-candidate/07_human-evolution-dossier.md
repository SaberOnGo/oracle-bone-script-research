...
- External category reference: `evobc-cat-04792`
- Source category ID: `04792`
- Source label for human review: `湡`
...
- `obs-evo-cand-004792-route-category-staging`
...
- `obs-evo-cand-004792-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004792-route-evolution-graph`
