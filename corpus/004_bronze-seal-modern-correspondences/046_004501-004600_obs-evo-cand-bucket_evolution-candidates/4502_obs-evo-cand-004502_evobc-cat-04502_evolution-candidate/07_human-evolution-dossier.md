...
- External category reference: `evobc-cat-04502`
- Source category ID: `04502`
- Source label for human review: `江`
- Source codepoints: `U+6C5F`
...
- `obs-evo-cand-004502-route-category-staging`
...
- `obs-evo-cand-004502-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004502-route-evolution-graph`
