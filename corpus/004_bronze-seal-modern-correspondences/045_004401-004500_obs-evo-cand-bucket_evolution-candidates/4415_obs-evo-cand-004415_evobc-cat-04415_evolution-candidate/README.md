# obs-evo-cand-004415 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-04415`
- Source label for human review: `殜`
- Source codepoints: `U+6B9C`
- Image reference count: `15`
- Era token counts: `SAC:1;WSC:14`
- Source token counts: `Book:1;Web:14`
