...
- External category reference: `evobc-cat-09549`
- Source category ID: `09549`
- Source label for human review: `鑠`
...
- `obs-evo-cand-009549-route-category-staging`
...
- `obs-evo-cand-009549-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009549-route-evolution-graph`
