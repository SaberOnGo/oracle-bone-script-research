...
- `obs-evo-cand-009261-route-category-staging`
...
- `obs-evo-cand-009261-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009261-route-evolution-graph`
