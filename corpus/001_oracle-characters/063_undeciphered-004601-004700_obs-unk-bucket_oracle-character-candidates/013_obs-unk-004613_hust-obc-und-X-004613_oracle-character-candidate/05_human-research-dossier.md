# obs-unk-004613 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004613`
- primary external id: `hust-obc-und-X-004613`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/013_obs-unk-004613_h
  ust-obc-und-X-004613_oracle-character-candidate/03_visual-assets/001_asset
  -006206_hust-obc-und-X-004613_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/169/X_？_7217_1.png`
- asset id: `asset-006206`
...
- source class: `HUST-OBC/undeciphered/X/169/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/169/X_？_7217_1.png`
- asset id: `asset-006206`
...
- English observation: `upper loop, branching traces, lower angular terminal`
- 中文观察: `上部环状痕、分支痕迹和下部角状末端已记录。`
...
- Which source records identify obs-unk-004613 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004613？
