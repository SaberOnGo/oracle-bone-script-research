...
- Project ID: `obs-evo-cand-005458`
- EVOBC category candidate ID: `evobc-evo-cat-05458`
- External category reference: `evobc-cat-05458`
- Source category ID: `05458`
- Source label for human review: `璁`
- Source codepoints: `U+7481`
...
- `obs-evo-cand-005458-route-category-staging`
...
- `obs-evo-cand-005458-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005458-route-evolution-graph`
