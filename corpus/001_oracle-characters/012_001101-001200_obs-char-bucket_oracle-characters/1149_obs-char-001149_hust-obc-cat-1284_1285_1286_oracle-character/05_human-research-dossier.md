# obs-char-001149 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1149_obs-char-001149_hust-obc-cat-1284_128
  5_1286_oracle-character/03_visual-assets/001_asset-001154_hust-obc-cat-128
  4_1285_1286_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1284_1285_1286/1284/G_1284_乙333
  7合1773賓組.png`
- asset id: `asset-001154`
...
- source category: `1284_1285_1286`
- validation class: `1148`
- source image route: `HUST-OBC/deciphered/1284_1285_1286/1284/G_1284_乙3337合17
  73賓組.png`
- asset id: `asset-001154`
...
- English observation: `A compact dark form has a tall right outer contour,
  an upper crossing, and two rounded lower interior marks.`
- 中文观察: `紧凑的深色形体有高直的右侧外轮廓、上部交叉笔和两个下部圆弧内部痕迹。`
...
- dataset label text: `㣺㣻㣼`
- dataset label codepoints: `U+38FA;U+38FB;U+38FC`
...
- filename catalog route clues: `Heji-like filename clue: 合1773
...
- Which source records identify obs-char-001149 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001149？
