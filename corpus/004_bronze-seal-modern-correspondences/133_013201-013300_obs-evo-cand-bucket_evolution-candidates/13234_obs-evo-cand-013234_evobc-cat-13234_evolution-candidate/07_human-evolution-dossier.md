...
- External category reference: `evobc-cat-13234`
- Source category ID: `13234`
- Source label for human review: `𬋶`
- Source codepoints: `U+2C2F6`
...
- `obs-evo-cand-013234-route-category-staging`
...
- `obs-evo-cand-013234-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013234-route-evolution-graph`
