# obs-evo-cand-010604 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-10604`
- Source label: `麋`
- Source codepoints: `U+9E8B`
- Image reference count: `119`
- Era token counts: `BI:5;OBC:102;SAC:1;SS:1;WSC:10`
- Source token counts: `Book:46;Web:73`
