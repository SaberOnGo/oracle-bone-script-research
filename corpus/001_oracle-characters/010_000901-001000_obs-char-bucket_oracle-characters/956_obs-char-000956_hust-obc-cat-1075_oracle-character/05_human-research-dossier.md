# obs-char-000956 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/956_obs-char-000956_hust-obc-cat-1075_orac
  le-character/03_visual-assets/001_asset-000961_hust-obc-cat-1075_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1075/H_1075_60BAF_0.png`
- asset id: `asset-000961`
...
- source category: `1075`
- validation class: `955`
- source image route: `HUST-OBC/deciphered/1075/H_1075_60BAF_0.png`
- asset id: `asset-000961`
...
- English observation: `A large arch-like outer frame encloses several
  distinct interior clusters and lower descending strokes.`
- 中文观察: `大型拱弧状外框围合数个可分辨的内部笔群和下部下行笔。`
...
- dataset label text: `㠩`
- dataset label codepoints: `U+3829`
...
- filename catalog route clues: `catalog-like filename clue: H_1075
  (H_1075_60BAF_0.png)`
...
- Which source records identify obs-char-000956 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000956？
