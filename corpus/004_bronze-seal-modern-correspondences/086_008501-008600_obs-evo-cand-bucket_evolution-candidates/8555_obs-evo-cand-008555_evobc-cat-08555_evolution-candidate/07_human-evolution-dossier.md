...
Project ID: `obs-evo-cand-008555`
...
- Project ID: `obs-evo-cand-008555`
- EVOBC category candidate ID: `evobc-evo-cat-08555`
- External category reference: `evobc-cat-08555`
- Source category ID: `08555`
- Source label for human review: `貸`
- Source codepoints: `U+8CB8`
...
- `obs-evo-cand-008555-route-category-staging`
...
- `obs-evo-cand-008555-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008555-route-evolution-graph`
