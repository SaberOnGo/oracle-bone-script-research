# obs-char-000401 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/401_obs-char-000401_hust-obc-cat-0454_orac
  le-character/03_visual-assets/001_asset-000406_hust-obc-cat-0454_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0454/G_0454_乙4752合2755.png`
- asset id: `asset-000406`
...
- source category: `0454`
- validation class: `400`
- source image route: `HUST-OBC/deciphered/0454/G_0454_乙4752合2755.png`
- asset id: `asset-000406`
...
- English observation: `Two adjacent clusters are visible: a crossed
  grid-like group at left and a looping vertical group with a zigzag lower
  end at right.`
- 中文观察: `可见两个相邻笔画群：左侧为交叉网格状笔画，右侧为下端折曲的环状竖向笔画群。`
...
- dataset label text: `㖼`
- dataset label codepoints: `U+35BC`
...
- filename catalog route clues: `Heji-like filename clue: 合2755
...
- Which source records identify obs-char-000401 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000401？
