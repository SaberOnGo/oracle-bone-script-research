...
- External category reference: `evobc-cat-01626`
- Source category ID: `01626`
...
- `obs-evo-cand-001626-route-category-staging`
...
- `obs-evo-cand-001626-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001626-route-evolution-graph`
