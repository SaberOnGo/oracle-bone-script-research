# Material Visual Observation / obs-comp-cand-001386 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001386`
- External reference / 外部参照: `obimd-sub-i2m9i5ytbg`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015805_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/i2m9i5ytbg/i2m9i5ytbg/i2m9i5ytbg.png`
- Checksum / 校验和:
  `37ffac68a6fa7b0b6928359453c94e8791489e568a10fe09466e2f49b1c7703a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.88%.
- Marked-pixel bounds: (79,35)–(170,209); span 92 × 175 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.88%。
- 痕迹范围：(79,35)–(170,209)；跨度92 × 175 px；痕迹矩形高于宽。
