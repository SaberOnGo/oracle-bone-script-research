# obs-unk-004563 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/063_obs-unk-004563_h
  ust-obc-und-X-004563_oracle-character-candidate/03_visual-assets/001_asset
  -006156_hust-obc-und-X-004563_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/119/X_？_8299_1.png`
- asset id: `asset-006156`
...
- source class: `HUST-OBC/undeciphered/X/119/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/119/X_？_8299_1.png`
- asset id: `asset-006156`
...
- English observation: `Upper traces, band, and lower curve recorded.`
- 中文观察: `已记录上部痕迹、横带和下部弯痕。`
...
- Which source records identify obs-unk-004563 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004563？
