# obs-unk-004939 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/039_obs-unk-004939_h
  ust-obc-und-X-004939_oracle-character-candidate/03_visual-assets/001_asset
  -006532_hust-obc-und-X-004939_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/495/X_？_7478_1.png`
- asset id: `asset-006532`
...
- A long upper stroke meets a rounded lower opening and two lower marks.
- The single source view is present locally.
- 直接记录：`14_material-visual-observation.md`
- 长上部笔画连接圆弧下方开口和两条下部标记。
- 单一来源视图已在本地保存。
...
- source class: `HUST-OBC/undeciphered/X/495/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/495/X_？_7478_1.png`
- asset id: `asset-006532`
...
- Which source records identify obs-unk-004939 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004939？
