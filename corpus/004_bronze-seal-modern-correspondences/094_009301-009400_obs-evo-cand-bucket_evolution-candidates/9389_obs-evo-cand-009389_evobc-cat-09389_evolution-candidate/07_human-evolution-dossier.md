...
- External category reference: `evobc-cat-09389`
- Source category ID: `09389`
- Source label for human review: `銘`
- Source codepoints: `U+9298`
...
- `obs-evo-cand-009389-route-category-staging`
...
- `obs-evo-cand-009389-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009389-route-evolution-graph`
