...
Project ID: `obs-insc-cw-cand-000027`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000027`
...
- Source page section: `Period I Group 1` /
  `第 I 期第 1 组`
- Source section key: `period-i-group-1`
- Section declared count: `30`
- Section observed row count: `30`
...
- Yingguo / 英国所藏: `y163` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `149` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `630` in source row; primary catalog entry pending
- Heji / 合集: `39663` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000027`
