# obs-xwalk-cand-001531 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+3AAB` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-1717` | not reading |
