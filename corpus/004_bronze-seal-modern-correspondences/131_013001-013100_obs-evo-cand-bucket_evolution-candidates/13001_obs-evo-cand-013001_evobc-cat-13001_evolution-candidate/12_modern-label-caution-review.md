# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013001
...
- EVOBC candidate category: `evobc-evo-cat-13001`.
- Source label for search only: `𫢱`.
- Source codepoints for search only: `U+2B8B1`.
