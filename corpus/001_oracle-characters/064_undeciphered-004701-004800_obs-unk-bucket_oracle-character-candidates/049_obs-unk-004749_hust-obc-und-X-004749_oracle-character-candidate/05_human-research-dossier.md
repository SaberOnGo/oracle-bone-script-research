# obs-unk-004749 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004749`
- primary external id: `hust-obc-und-X-004749`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/049_obs-unk-004749_h
  ust-obc-und-X-004749_oracle-character-candidate/03_visual-assets/001_asset
  -006342_hust-obc-und-X-004749_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/305/X_？_7290_1.png`
- asset id: `asset-006342`
...
- source class: `HUST-OBC/undeciphered/X/305/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/305/X_？_7290_1.png`
- asset id: `asset-006342`
...
- English observation: `rounded upper enclosure with right branches`
- 中文观察: `带右侧分支的圆钝上部围合结构`
...
- Which source records identify obs-unk-004749 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004749？
