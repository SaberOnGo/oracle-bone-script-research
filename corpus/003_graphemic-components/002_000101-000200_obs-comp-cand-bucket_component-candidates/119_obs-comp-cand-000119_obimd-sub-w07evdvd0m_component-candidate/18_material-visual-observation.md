# Material Visual Observation / obs-comp-cand-000119 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000119`
- External reference / 外部参照: `obimd-sub-w07evdvd0m`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011531_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xh47ul1r1k/w07evdvd0m/w07evdvd0m.png`
- Checksum / 校验和:
  `ab26569ff0e5a7a40fcca5f34b771d2d654cbe08d5f61247279372d43bc7fbee`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.56%.
- Marked-pixel bounds: (66,28)–(191,219); span 126 × 192 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.56%。
- 痕迹范围：(66,28)–(191,219)；跨度126 × 192 px；痕迹矩形高于宽。
