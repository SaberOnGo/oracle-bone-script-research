# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000296
...
| Glyph or codepoint route / 字形或码位路线 | 8 OBIMD route rows; examples U+F1AC7; U+F1AC8; 另有 6 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
