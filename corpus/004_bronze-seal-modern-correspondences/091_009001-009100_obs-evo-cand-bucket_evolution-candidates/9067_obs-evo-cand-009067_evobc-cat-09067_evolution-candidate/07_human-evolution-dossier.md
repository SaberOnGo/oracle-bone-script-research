...
- Project ID: `obs-evo-cand-009067`
- EVOBC category candidate ID: `evobc-evo-cat-09067`
- External category reference: `evobc-cat-09067`
- Source category ID: `09067`
- Source label for human review: `遽`
- Source codepoints: `U+907D`
...
- `obs-evo-cand-009067-route-category-staging`
...
- `obs-evo-cand-009067-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009067-route-evolution-graph`
