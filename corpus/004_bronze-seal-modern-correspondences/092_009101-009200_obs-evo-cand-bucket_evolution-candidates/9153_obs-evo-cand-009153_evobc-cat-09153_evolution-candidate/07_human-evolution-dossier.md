...
- External category reference: `evobc-cat-09153`
- Source category ID: `09153`
- Source label for human review: `郤`
...
- `obs-evo-cand-009153-route-category-staging`
...
- `obs-evo-cand-009153-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009153-route-evolution-graph`
