...
- External category reference: `evobc-cat-10320`
- Source category ID: `10320`
- Source label for human review: `髺`
- Source codepoints: `U+9AFA`
...
- `obs-evo-cand-010320-route-category-staging`
...
- `obs-evo-cand-010320-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010320-route-evolution-graph`
