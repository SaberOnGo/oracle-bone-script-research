...
- External category reference: `evobc-cat-01220`
- Source category ID: `01220`
- Source label for human review: `剋`
- Source codepoints: `U+524B`
...
- `obs-evo-cand-001220-route-category-staging`
...
- `obs-evo-cand-001220-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001220-route-evolution-graph`
