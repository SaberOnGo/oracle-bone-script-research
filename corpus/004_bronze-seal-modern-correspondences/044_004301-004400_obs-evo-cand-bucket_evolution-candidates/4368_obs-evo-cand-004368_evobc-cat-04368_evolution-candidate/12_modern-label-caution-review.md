# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004368
...
- EVOBC candidate category: `evobc-evo-cat-04368`.
- Source label for search only: `歋`.
- Source codepoints for search only: `U+6B4B`.
