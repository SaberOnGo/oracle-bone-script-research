...
- External category reference: `evobc-cat-10992`
- Source category ID: `10992`
- Source label for human review: `𡍌`
...
- `obs-evo-cand-010992-route-category-staging`
...
- `obs-evo-cand-010992-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010992-route-evolution-graph`
