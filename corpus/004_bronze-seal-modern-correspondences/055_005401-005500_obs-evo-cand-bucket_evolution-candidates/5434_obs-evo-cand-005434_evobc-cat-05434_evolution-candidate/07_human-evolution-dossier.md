...
- Project ID: `obs-evo-cand-005434`
- EVOBC category candidate ID: `evobc-evo-cat-05434`
- External category reference: `evobc-cat-05434`
- Source category ID: `05434`
- Source label for human review: `瑎`
- Source codepoints: `U+744E`
...
- `obs-evo-cand-005434-route-category-staging`
...
- `obs-evo-cand-005434-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005434-route-evolution-graph`
