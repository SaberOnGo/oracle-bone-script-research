# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004613
...
- EVOBC candidate category: `evobc-evo-cat-04613`.
- Source label for search only: `洋`.
- Source codepoints for search only: `U+6D0B`.
