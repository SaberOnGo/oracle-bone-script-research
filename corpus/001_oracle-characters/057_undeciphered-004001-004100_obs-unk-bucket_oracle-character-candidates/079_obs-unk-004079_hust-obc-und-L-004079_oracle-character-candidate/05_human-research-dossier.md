# obs-unk-004079 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004079`
- primary external id: `hust-obc-und-L-004079`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/079_obs-unk-004079_h
  ust-obc-und-L-004079_oracle-character-candidate/03_visual-assets/001_asset
  -005672_hust-obc-und-L-004079_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4079/L_？_8746.jpg`
- asset id: `asset-005672`
...
- source class: `HUST-OBC/undeciphered/L/4079/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4079/L_？_8746.jpg`
- asset id: `asset-005672`
...
- English observation: A narrow irregular trace runs down the left side. A
  rounded or angular enclosure appears at the upper right, with a darker
  interior and a lower taper; whether the two areas form one group is unclear.
...
- Which source records identify obs-unk-004079 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004079？
