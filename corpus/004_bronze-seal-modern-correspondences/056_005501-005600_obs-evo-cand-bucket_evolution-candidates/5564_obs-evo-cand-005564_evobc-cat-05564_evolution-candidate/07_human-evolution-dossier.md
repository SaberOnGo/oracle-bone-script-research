...
- External category reference: `evobc-cat-05564`
- Source category ID: `05564`
- Source label for human review: `畐`
- Source codepoints: `U+7550`
...
- `obs-evo-cand-005564-route-category-staging`
...
- `obs-evo-cand-005564-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005564-route-evolution-graph`
