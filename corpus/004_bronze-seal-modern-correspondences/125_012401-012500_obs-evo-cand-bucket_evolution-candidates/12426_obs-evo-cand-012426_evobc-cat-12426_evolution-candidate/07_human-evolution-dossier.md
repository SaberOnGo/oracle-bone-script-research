...
- Project ID: `obs-evo-cand-012426`
- EVOBC category candidate ID: `evobc-evo-cat-12426`
- External category reference: `evobc-cat-12426`
- Source category ID: `12426`
- Source label for human review: `𨛚`
- Source codepoints: `U+286DA`
...
- `obs-evo-cand-012426-route-category-staging`
...
- `obs-evo-cand-012426-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012426-route-evolution-graph`
