# Material Visual Observation / obs-comp-cand-001546 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001546`
- External reference / 外部参照: `obimd-sub-viv127p4q5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016960_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/viv127p4q5/viv127p4q5/viv127p4q5.png`
- Checksum / 校验和:
  `33874368b7da4551b381e9b9cccceb73c12258814b2a9cff5849cada04b2efe2`
...
- Marked-pixel bounds: (93,23)–(167,223); span 75 × 201 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.25%。
- 痕迹范围：(93,23)–(167,223)；跨度75 × 201 px；痕迹矩形高于宽。
