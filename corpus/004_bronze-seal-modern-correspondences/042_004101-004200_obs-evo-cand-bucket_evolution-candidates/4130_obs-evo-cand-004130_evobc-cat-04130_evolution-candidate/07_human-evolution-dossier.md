...
Project ID: `obs-evo-cand-004130`
...
- Project ID: `obs-evo-cand-004130`
- EVOBC category candidate ID: `evobc-evo-cat-04130`
- External category reference: `evobc-cat-04130`
- Source category ID: `04130`
- Source label for human review: `椲`
- Source codepoints: `U+6932`
...
- `obs-evo-cand-004130-route-category-staging`
...
- `obs-evo-cand-004130-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004130-route-evolution-graph`
