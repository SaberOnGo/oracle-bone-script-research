...
- External category reference: `evobc-cat-08836`
- Source category ID: `08836`
- Source label for human review: `輔`
...
- `obs-evo-cand-008836-route-category-staging`
...
- `obs-evo-cand-008836-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008836-route-evolution-graph`
