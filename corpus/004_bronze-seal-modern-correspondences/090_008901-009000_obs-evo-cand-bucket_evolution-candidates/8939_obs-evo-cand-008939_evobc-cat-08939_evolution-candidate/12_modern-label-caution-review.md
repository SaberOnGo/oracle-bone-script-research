# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008939
...
- EVOBC candidate category: `evobc-evo-cat-08939`.
- Source label for search only: `迆`.
- Source codepoints for search only: `U+8FC6`.
