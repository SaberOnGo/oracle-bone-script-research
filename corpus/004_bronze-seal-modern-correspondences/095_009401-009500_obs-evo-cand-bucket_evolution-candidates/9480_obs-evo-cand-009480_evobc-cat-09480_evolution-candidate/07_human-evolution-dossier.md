...
- External category reference: `evobc-cat-09480`
- Source category ID: `09480`
- Source label for human review: `鎘`
...
- `obs-evo-cand-009480-route-category-staging`
...
- `obs-evo-cand-009480-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009480-route-evolution-graph`
