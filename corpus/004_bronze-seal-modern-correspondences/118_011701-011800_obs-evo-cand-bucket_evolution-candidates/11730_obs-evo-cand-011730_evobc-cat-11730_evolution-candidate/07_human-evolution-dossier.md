...
- External category reference: `evobc-cat-11730`
- Source category ID: `11730`
- Source label for human review: `𤻐`
- Source codepoints: `U+24ED0`
...
- `obs-evo-cand-011730-route-category-staging`
...
- `obs-evo-cand-011730-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011730-route-evolution-graph`
