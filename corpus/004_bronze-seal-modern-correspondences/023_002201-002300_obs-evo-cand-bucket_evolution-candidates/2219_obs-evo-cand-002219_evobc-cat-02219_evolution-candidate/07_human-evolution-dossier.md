...
- External category reference: `evobc-cat-02219`
- Source category ID: `02219`
- Source label for human review: `婿`
- Source codepoints: `U+5A7F`
...
- `obs-evo-cand-002219-route-category-staging`
...
- `obs-evo-cand-002219-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002219-route-evolution-graph`
