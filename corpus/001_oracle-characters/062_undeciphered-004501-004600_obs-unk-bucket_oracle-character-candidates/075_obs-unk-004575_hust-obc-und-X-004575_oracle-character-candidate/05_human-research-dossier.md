# obs-unk-004575 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004575`
- primary external id: `hust-obc-und-X-004575`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/075_obs-unk-004575_h
  ust-obc-und-X-004575_oracle-character-candidate/03_visual-assets/001_asset
  -006168_hust-obc-und-X-004575_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/131/X_？_8310_1.png`
- asset id: `asset-006168`
...
- source class: `HUST-OBC/undeciphered/X/131/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/131/X_？_8310_1.png`
- asset id: `asset-006168`
...
- English observation: `Three upper projections and long lower trace recorded.`
- 中文观察: `已记录三个上部突出部分和下行长痕。`
...
- Which source records identify obs-unk-004575 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004575？
