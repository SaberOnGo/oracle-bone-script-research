# obs-char-001448 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1448_obs-char-001448_hust-obc-cat-1623_162
  4_oracle-character/03_visual-assets/001_asset-001453_hust-obc-cat-1623_162
  4_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1623_1624/1623/G_1623_前6.53.4合5
  426𠂤組.png`
- asset id: `asset-001453`
...
- source category: `1623_1624`
- validation class: `1447`
- source image route: `HUST-OBC/deciphered/1623_1624/1623/G_1623_前6.53.4合5426𠂤
  組.png`
- asset id: `asset-001453`
...
- English observation: `Two narrow branching forms share a pointed upper
  center and lower stem.`
- 中文观察: `两个狭长分枝形体共有尖状上部中心和下部竖干。`
...
- dataset label text: `㩍㩎`
- dataset label codepoints: `U+3A4D;U+3A4E`
...
- filename catalog route clues: `Heji-like filename clue: 合5426
...
- Which source records identify obs-char-001448 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001448？
