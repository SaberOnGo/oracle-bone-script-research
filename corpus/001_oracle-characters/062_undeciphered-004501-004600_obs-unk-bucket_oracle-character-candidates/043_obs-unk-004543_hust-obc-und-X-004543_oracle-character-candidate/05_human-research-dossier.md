# obs-unk-004543 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004543`
- primary external id: `hust-obc-und-X-004543`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/043_obs-unk-004543_h
  ust-obc-und-X-004543_oracle-character-candidate/03_visual-assets/001_asset
  -006136_hust-obc-und-X-004543_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/99/X_？_8282_1.png`
- asset id: `asset-006136`
...
- source class: `HUST-OBC/undeciphered/X/99/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/99/X_？_8282_1.png`
- asset id: `asset-006136`
...
- English observation: `Left curve, side branch, and oval recorded.`
- 中文观察: `已记录左侧弯痕、侧部分支和椭圆轮廓。`
...
- Which source records identify obs-unk-004543 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004543？
