# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012816
...
- Project ID: `obs-evo-cand-012816`.
- EVOBC candidate category: `evobc-evo-cat-12816`.
- Source label for search only: `𪣬`.
- Source codepoints for search only: `U+2A8EC`.
