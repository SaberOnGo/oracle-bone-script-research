...
- External category reference: `evobc-cat-03729`
- Source category ID: `03729`
- Source label for human review: `昵`
...
- `obs-evo-cand-003729-route-category-staging`
...
- `obs-evo-cand-003729-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003729-route-evolution-graph`
