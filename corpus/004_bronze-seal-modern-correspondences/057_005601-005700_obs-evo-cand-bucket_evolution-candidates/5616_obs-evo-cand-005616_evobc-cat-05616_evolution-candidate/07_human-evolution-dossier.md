...
Project ID: `obs-evo-cand-005616`
...
- Project ID: `obs-evo-cand-005616`
- EVOBC category candidate ID: `evobc-evo-cat-05616`
- External category reference: `evobc-cat-05616`
- Source category ID: `05616`
- Source label for human review: `疦`
- Source codepoints: `U+75A6`
...
- `obs-evo-cand-005616-route-category-staging`
...
- `obs-evo-cand-005616-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005616-route-evolution-graph`
