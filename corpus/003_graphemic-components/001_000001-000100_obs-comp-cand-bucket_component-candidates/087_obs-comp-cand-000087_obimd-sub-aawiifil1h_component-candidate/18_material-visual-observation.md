# Material Visual Observation / obs-comp-cand-000087 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000087`
- External reference / 外部参照: `obimd-sub-aawiifil1h`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011499_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/aawiifil1h/aawiifil1h/aawiifil1h.png`
- Checksum / 校验和:
  `bc7c9785d367fbfae2e97904250ff27c580311eaed04dc699e35b82c8f32a6c4`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.22%.
- Marked-pixel bounds: (60,43)–(189,215); span 130 × 173 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.22%。
- 痕迹范围：(60,43)–(189,215)；跨度130 × 173 px；痕迹矩形高于宽。
