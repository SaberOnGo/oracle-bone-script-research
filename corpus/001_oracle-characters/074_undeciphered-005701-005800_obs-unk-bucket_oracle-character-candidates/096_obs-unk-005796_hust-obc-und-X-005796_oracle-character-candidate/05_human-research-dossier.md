# obs-unk-005796 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/074_undeciphered-005
  701-005800_obs-unk-bucket_oracle-character-candidates/096_obs-unk-005796_h
  ust-obc-und-X-005796_oracle-character-candidate/03_visual-assets/001_asset
  -007388_hust-obc-und-X-005796_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1352/X_？_1627_1.png`
- asset id: `asset-007388`
...
- source class: `HUST-OBC/undeciphered/X/1352/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1352/X_？_1627_1.png`
- asset id: `asset-007388`
...
- Which source records identify obs-unk-005796 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005796？
