...
Project ID: `obs-evo-cand-000722`
...
- Project ID: `obs-evo-cand-000722`
- EVOBC category candidate ID: `evobc-evo-cat-00722`
- External category reference: `evobc-cat-00722`
- Source category ID: `00722`
- Source label for human review: `仄`
- Source codepoints: `U+4EC4`
...
- `obs-evo-cand-000722-route-category-staging`
...
- `obs-evo-cand-000722-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000722-route-evolution-graph`
