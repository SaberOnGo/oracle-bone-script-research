# obs-comp-cand-002657 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002657`
- 首选外部 ID: `obimd-sub-xkmcvrx1mq`
- OBIMD subcharacter UID: `xkmcvrx1mq`
- OBIMD main character UID: `xkmcvrx1mq`
- 来源 ID: `src-obimd`
