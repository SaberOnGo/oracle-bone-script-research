...
- External category reference: `evobc-cat-05251`
- Source category ID: `05251`
- Source label for human review: `状`
- Source codepoints: `U+72B6`
...
- `obs-evo-cand-005251-route-category-staging`
...
- `obs-evo-cand-005251-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005251-route-evolution-graph`
