# obs-unk-006311 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006311`
- primary external id: `hust-obc-und-X-006311`
...
- local review image route: `corpus/001_oracle-characters/080_undeciphered-006
  301-006400_obs-unk-bucket_oracle-character-candidates/011_obs-unk-006311_h
  ust-obc-und-X-006311_oracle-character-candidate/03_visual-assets/001_asset
  -007902_hust-obc-und-X-006311_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1867/X_？_5094_1.png`
- asset id: `asset-007902`
...
- source class: `HUST-OBC/undeciphered/X/1867/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1867/X_？_5094_1.png`
- asset id: `asset-007902`
...
- Which source records identify obs-unk-006311 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006311？
