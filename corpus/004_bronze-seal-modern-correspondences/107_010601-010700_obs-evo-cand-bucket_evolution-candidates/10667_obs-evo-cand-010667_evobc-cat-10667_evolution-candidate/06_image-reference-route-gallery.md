...
- `obs-evo-cand-010667-route-category-staging`
...
- `obs-evo-cand-010667-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010667-route-evolution-graph`
