...
- `obs-evo-cand-011353-route-category-staging`
...
- `obs-evo-cand-011353-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011353-route-evolution-graph`
