# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001239
...
| --- | --- | --- | --- |
| `obimd-glyph-link-018638` | 𬆤󷉇 | `U+2C1A4;U+F7247` | `reviewed_metadata_only` |
| `obimd-glyph-link-018639` | 󷉈 | `U+F7248` | `reviewed_metadata_only` |
| `obimd-glyph-link-018640` | 󷉍 | `U+F724D` | `reviewed_metadata_only` |
