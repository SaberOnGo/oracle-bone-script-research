...
- Project ID: `obs-evo-cand-001926`
- EVOBC category candidate ID: `evobc-evo-cat-01926`
- External category reference: `evobc-cat-01926`
- Source category ID: `01926`
- Source label for human review: `塵`
- Source codepoints: `U+5875`
...
- `obs-evo-cand-001926-route-category-staging`
...
- `obs-evo-cand-001926-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001926-route-evolution-graph`
