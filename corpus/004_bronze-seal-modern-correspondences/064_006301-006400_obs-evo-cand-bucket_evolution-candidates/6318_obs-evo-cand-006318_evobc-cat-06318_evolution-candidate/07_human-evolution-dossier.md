...
- External category reference: `evobc-cat-06318`
- Source category ID: `06318`
- Source label for human review: `篎`
...
- `obs-evo-cand-006318-route-category-staging`
...
- `obs-evo-cand-006318-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006318-route-evolution-graph`
