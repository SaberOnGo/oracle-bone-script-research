# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004344
...
- EVOBC candidate category: `evobc-evo-cat-04344`.
- Source label for search only: `欪`.
- Source codepoints for search only: `U+6B2A`.
