# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000749
...
- EVOBC candidate category: `evobc-evo-cat-00749`.
- Source label for search only: `仮`.
- Source codepoints for search only: `U+4EEE`.
