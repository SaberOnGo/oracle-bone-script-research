# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000244
...
- EVOBC candidate category: `evobc-evo-cat-00244`.
- Source label for search only: `㼭`.
- Source codepoints for search only: `U+3F2D`.
