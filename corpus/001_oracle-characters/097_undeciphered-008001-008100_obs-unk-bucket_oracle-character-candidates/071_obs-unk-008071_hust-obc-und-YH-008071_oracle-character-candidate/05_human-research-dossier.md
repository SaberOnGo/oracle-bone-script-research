# obs-unk-008071 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008071`
- primary external id: `hust-obc-und-YH-008071`
...
- local review image route: `corpus/001_oracle-characters/097_undeciphered-008
  001-008100_obs-unk-bucket_oracle-character-candidates/071_obs-unk-008071_h
  ust-obc-und-YH-008071_oracle-character-candidate/03_visual-assets/001_asse
  t-009662_hust-obc-und-YH-008071_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/606C4/H_？_606C4_0.png`
- asset id: `asset-009662`
...
- source class: `HUST-OBC/undeciphered/Y+H/606C4/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/606C4/H_？_606C4_0.png`
- asset id: `asset-009662`
...
- Which source records identify obs-unk-008071 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008071？
