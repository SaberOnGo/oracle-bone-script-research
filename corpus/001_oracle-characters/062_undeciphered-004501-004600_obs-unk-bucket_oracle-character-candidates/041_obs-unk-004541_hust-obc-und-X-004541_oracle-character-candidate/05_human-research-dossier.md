# obs-unk-004541 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/041_obs-unk-004541_h
  ust-obc-und-X-004541_oracle-character-candidate/03_visual-assets/001_asset
  -006134_hust-obc-und-X-004541_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/97/X_？_8280_1.png`
- asset id: `asset-006134`
...
- source class: `HUST-OBC/undeciphered/X/97/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/97/X_？_8280_1.png`
- asset id: `asset-006134`
...
- English observation: `Junction, bent branch, and long lower trace recorded.`
- 中文观察: `已记录连接处、弯曲分支和下部长痕。`
...
- Which source records identify obs-unk-004541 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004541？
