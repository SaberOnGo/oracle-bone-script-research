# obs-evo-cand-000702 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-000702`
- EVOBC category candidate ID: `evobc-evo-cat-00702`
- External category ref: `evobc-cat-00702`
- Source label: `亦`
- Source codepoints: `U+4EA6`
- Image reference count: `195`
- Era token counts: `BI:35;CS:1;OBC:82;SAC:2;SS:2;WSC:73`
- Source token counts: `Book:66;Web:129`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 82 image references
...
- source 1 / Web:105952;說文Web:58: 105 image references
