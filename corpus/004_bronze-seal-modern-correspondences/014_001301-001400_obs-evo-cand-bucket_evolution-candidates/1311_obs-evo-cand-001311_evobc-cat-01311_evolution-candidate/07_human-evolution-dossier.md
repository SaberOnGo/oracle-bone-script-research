...
- Project ID: `obs-evo-cand-001311`
- EVOBC category candidate ID: `evobc-evo-cat-01311`
- External category reference: `evobc-cat-01311`
- Source category ID: `01311`
- Source label for human review: `勰`
- Source codepoints: `U+52F0`
...
- `obs-evo-cand-001311-route-category-staging`
...
- `obs-evo-cand-001311-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001311-route-evolution-graph`
