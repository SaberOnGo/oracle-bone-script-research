# obs-evo-cand-001636 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-01636`
- Source label for human review: `啻`
- Source codepoints: `U+557B`
- Image reference count: `55`
- Era token counts: `BI:24;SS:1;WSC:30`
- Source token counts: `Book:33;Web:22`
