...
- External category reference: `evobc-cat-04741`
- Source category ID: `04741`
- Source label for human review: `淶`
- Source codepoints: `U+6DF6`
...
- `obs-evo-cand-004741-route-category-staging`
...
- `obs-evo-cand-004741-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004741-route-evolution-graph`
