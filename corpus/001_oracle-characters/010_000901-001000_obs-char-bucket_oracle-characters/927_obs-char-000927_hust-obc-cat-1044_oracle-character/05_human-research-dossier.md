# obs-char-000927 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/927_obs-char-000927_hust-obc-cat-1044_orac
  le-character/03_visual-assets/001_asset-000932_hust-obc-cat-1044_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1044/G_1044_乙2772.png`
- asset id: `asset-000932`
...
- source category: `1044`
- validation class: `926`
- source image route: `HUST-OBC/deciphered/1044/G_1044_乙2772.png`
- asset id: `asset-000932`
...
- English observation: `A tall rectangular form is divided by a horizontal
  middle stroke and has short projections at both sides.`
- 中文观察: `高长矩形形体由中部横笔分隔，两侧各有短伸笔。`
...
- dataset label text: `㠊`
- dataset label codepoints: `U+380A`
...
- Which source records identify obs-char-000927 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000927？
