...
Project ID: `obs-evo-cand-008368`
...
- Project ID: `obs-evo-cand-008368`
- EVOBC category candidate ID: `evobc-evo-cat-08368`
- External category reference: `evobc-cat-08368`
- Source category ID: `08368`
- Source label for human review: `警`
- Source codepoints: `U+8B66`
...
- `obs-evo-cand-008368-route-category-staging`
...
- `obs-evo-cand-008368-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008368-route-evolution-graph`
