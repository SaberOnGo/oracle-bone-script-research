...
- `obs-evo-cand-008855-route-category-staging`
...
- `obs-evo-cand-008855-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008855-route-evolution-graph`
