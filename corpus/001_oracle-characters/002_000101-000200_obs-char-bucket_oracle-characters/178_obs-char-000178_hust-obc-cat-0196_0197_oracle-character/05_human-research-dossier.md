# obs-char-000178 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/178_obs-char-000178_hust-obc-cat-0196_0197
  _oracle-character/03_visual-assets/001_asset-000183_hust-obc-cat-0196_0197
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0196_0197/0196/G_0196_乙4540合136
  75賓組.png`
- asset id: `asset-000183`
...
- source category: `0196_0197`
- validation class: `177`
- source image route: `HUST-OBC/deciphered/0196_0197/0196/G_0196_乙4540合13675賓組
  .png`
- asset id: `asset-000183`
...
- English observation: `The image has a rectangular outer frame with a
  central angled opening and two short vertical strokes descending below the
  lower edge.`
...
- dataset label text: `㒺㒻`
- dataset label codepoints: `U+34BA;U+34BB`
...
- filename catalog route clues: `Heji-like filename clue: 合13675
...
- Which source records identify obs-char-000178 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000178？
