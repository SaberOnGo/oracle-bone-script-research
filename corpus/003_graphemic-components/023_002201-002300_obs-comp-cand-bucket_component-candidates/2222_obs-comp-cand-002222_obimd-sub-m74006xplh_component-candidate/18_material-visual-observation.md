# Material Visual Observation / obs-comp-cand-002222 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002222`
- External reference / 外部参照: `obimd-sub-m74006xplh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020035_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/m74006xplh/m74006xplh/m74006xplh.png`
- Checksum / 校验和:
  `0f966517710a020a23edabd1456332c31f0efda9c963f72e98deb2c17d9c671c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.37%.
- Marked-pixel bounds: (85,10)–(165,240); span 81 × 231 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.37%。
- 痕迹范围：(85,10)–(165,240)；跨度81 × 231 px；痕迹矩形高于宽。
