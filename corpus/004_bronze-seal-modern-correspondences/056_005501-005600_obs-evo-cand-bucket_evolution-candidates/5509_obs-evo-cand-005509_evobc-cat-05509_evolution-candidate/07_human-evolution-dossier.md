...
- External category reference: `evobc-cat-05509`
- Source category ID: `05509`
- Source label for human review: `瓪`
- Source codepoints: `U+74EA`
...
- `obs-evo-cand-005509-route-category-staging`
...
- `obs-evo-cand-005509-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005509-route-evolution-graph`
