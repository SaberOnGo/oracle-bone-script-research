# Material Visual Observation / obs-comp-cand-002302 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002302`
- External reference / 外部参照: `obimd-sub-ipk3zzo75v`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020321_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ipk3zzo75v/ipk3zzo75v/ipk3zzo75v.png`
- Checksum / 校验和:
  `0edc1151d5e769831085f8f2df4b42f1f3d7877ea23d81d4fd804e1f66c17f75`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.90%.
- Marked-pixel bounds: (80,24)–(186,226); span 107 × 203 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.90%。
- 痕迹范围：(80,24)–(186,226)；跨度107 × 203 px；痕迹矩形高于宽。
