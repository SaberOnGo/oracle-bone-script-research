# Material Visual Observation / obs-comp-cand-000499 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000499`
- External reference / 外部参照: `obimd-sub-30vdsr9swu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012735_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/30vdsr9swu/30vdsr9swu/30vdsr9swu.png`
- Checksum / 校验和:
  `4f7afcededb8189d9c1c8d4a65b1815e29753c8afe439a8746c611212d1b64d9`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.46%.
- Marked-pixel bounds: (58,39)–(191,210); span 134 × 172 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.46%。
- 痕迹范围：(58,39)–(191,210)；跨度134 × 172 px；痕迹矩形高于宽。
