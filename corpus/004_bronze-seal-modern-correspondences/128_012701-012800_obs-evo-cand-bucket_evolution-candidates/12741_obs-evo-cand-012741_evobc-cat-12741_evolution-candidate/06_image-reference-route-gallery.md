...
- `obs-evo-cand-012741-route-category-staging`
...
- `obs-evo-cand-012741-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012741-route-evolution-graph`
