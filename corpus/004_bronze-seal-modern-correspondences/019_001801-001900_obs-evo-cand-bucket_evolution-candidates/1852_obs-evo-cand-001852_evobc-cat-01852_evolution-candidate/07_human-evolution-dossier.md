...
- Project ID: `obs-evo-cand-001852`
- EVOBC category candidate ID: `evobc-evo-cat-01852`
- External category reference: `evobc-cat-01852`
- Source category ID: `01852`
- Source label for human review: `垕`
- Source codepoints: `U+5795`
...
- `obs-evo-cand-001852-route-category-staging`
...
- `obs-evo-cand-001852-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001852-route-evolution-graph`
