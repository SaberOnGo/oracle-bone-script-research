...
Project ID: `obs-evo-cand-009249`
...
- Project ID: `obs-evo-cand-009249`
- EVOBC category candidate ID: `evobc-evo-cat-09249`
- External category reference: `evobc-cat-09249`
- Source category ID: `09249`
- Source label for human review: `酨`
- Source codepoints: `U+9168`
...
- `obs-evo-cand-009249-route-category-staging`
...
- `obs-evo-cand-009249-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009249-route-evolution-graph`
