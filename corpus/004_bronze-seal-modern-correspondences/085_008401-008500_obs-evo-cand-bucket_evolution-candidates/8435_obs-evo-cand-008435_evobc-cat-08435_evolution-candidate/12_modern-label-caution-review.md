# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008435
...
- EVOBC candidate category: `evobc-evo-cat-08435`.
- Source label for search only: `语`.
- Source codepoints for search only: `U+8BED`.
