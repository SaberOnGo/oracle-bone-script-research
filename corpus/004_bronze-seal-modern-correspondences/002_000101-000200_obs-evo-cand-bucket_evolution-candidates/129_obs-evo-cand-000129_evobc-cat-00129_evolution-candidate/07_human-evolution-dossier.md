...
- External category reference: `evobc-cat-00129`
- Source category ID: `00129`
- Source label for human review: `㥠`
...
- `obs-evo-cand-000129-route-category-staging`
...
- `obs-evo-cand-000129-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000129-route-evolution-graph`
