# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002196
...
- EVOBC candidate category: `evobc-evo-cat-02196`.
- Source label for search only: `婓`.
- Source codepoints for search only: `U+5A53`.
