# obs-unk-006429 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/081_undeciphered-006
  401-006500_obs-unk-bucket_oracle-character-candidates/029_obs-unk-006429_h
  ust-obc-und-X-006429_oracle-character-candidate/03_visual-assets/001_asset
  -008020_hust-obc-und-X-006429_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1985/X_？_5617_1.png`
- asset id: `asset-008020`
...
- source class: `HUST-OBC/undeciphered/X/1985/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1985/X_？_5617_1.png`
- asset id: `asset-008020`
...
- Which source records identify obs-unk-006429 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006429？
