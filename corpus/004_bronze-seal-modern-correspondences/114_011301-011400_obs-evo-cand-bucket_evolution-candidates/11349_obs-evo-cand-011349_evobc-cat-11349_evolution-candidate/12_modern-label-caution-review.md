# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-011349
...
- EVOBC candidate category: `evobc-evo-cat-11349`.
- Source label for search only: `𢾝`.
- Source codepoints for search only: `U+22F9D`.
