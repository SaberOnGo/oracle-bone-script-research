# Material Visual Observation / obs-comp-cand-001243 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001243`
- External reference / 外部参照: `obimd-sub-ciduvuy3ar`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015481_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ciduvuy3ar/ciduvuy3ar/ciduvuy3ar.png`
- Checksum / 校验和:
  `4817419557f3a48ed17d21f52da309e0cf274a4180121d99ee41ad795da7a198`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.85%.
- Marked-pixel bounds: (65,52)–(183,192); span 119 × 141 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.85%。
- 痕迹范围：(65,52)–(183,192)；跨度119 × 141 px；痕迹矩形近方形。
