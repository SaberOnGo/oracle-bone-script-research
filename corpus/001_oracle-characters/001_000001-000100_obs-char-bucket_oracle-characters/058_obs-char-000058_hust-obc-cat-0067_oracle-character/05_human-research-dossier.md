# obs-char-000058 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000058`
- primary external id: `hust-obc-cat-0067`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/058_obs-char-000058_hust-obc-cat-0067_orac
  le-character/03_visual-assets/001_asset-000063_hust-obc-cat-0067_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0067/H_0067_60A87_0.png`
- asset id: `asset-000063`
...
- source category: `0067`
- validation class: `57`
- source image route: `HUST-OBC/deciphered/0067/H_0067_60A87_0.png`
- asset id: `asset-000063`
...
- English observation: `The image shows a tall rectangular enclosure with
  angular interior marks, a horizontal upper stroke, and a short lower bar.`
...
- dataset label text: `㐹`
- dataset label codepoints: `U+3439`
...
- filename catalog route clues: `catalog-like filename clue: H_0067
  (H_0067_60A87_0.png)`
...
- Which source records identify obs-char-000058 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000058？
