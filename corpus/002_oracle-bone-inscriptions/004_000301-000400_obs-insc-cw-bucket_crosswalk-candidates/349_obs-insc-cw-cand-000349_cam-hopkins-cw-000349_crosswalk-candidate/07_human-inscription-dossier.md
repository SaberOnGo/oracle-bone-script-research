...
- Yingguo / 英国所藏: `y2037` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `448` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `68` in source row; primary catalog entry pending
