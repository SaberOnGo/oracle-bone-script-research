# Material Visual Observation / obs-comp-cand-002524 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002524`
- External reference / 外部参照: `obimd-sub-jjm889wxay`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020914_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jjm889wxay/jjm889wxay/2b1hnrki1y.png`
- Checksum / 校验和:
  `4c81c206971565d710fe152c70692cae325ea95d4bb38a363c0b35a17520d77f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.12%.
- Marked-pixel bounds: (85,36)–(164,214); span 80 × 179 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.12%。
- 痕迹范围：(85,36)–(164,214)；跨度80 × 179 px；痕迹矩形高于宽。
