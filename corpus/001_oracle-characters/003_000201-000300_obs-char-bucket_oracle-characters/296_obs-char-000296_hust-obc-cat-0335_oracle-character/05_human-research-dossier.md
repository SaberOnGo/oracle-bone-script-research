# obs-char-000296 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000296`
- primary external id: `hust-obc-cat-0335`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/296_obs-char-000296_hust-obc-cat-0335_orac
  le-character/03_visual-assets/001_asset-000301_hust-obc-cat-0335_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0335/G_0335_乙5402反合12434反.png`
- asset id: `asset-000301`
...
- source category: `0335`
- validation class: `295`
- source image route: `HUST-OBC/deciphered/0335/G_0335_乙5402反合12434反.png`
- asset id: `asset-000301`
...
- English observation: `The image has a broad peaked outer contour with
  sloping side strokes and a small rounded enclosure with an inner
  horizontal mark.`
- 中文观察: `图像有宽大的尖顶外轮廓和倾斜侧笔，内部有带内横画的小型圆弧闭合轮廓。`
...
- dataset label text: `㕅`
- dataset label codepoints: `U+3545`
...
- filename catalog route clues: `Heji-like filename clue: 合12434
  (G_0335_乙5402反合12434反.png)`
...
- Which source records identify obs-char-000296 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000296？
