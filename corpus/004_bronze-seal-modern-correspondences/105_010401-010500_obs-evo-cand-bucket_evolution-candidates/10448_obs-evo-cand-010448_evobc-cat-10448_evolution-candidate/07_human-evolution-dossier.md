...
- External category reference: `evobc-cat-10448`
- Source category ID: `10448`
- Source label for human review: `鱢`
...
- `obs-evo-cand-010448-route-category-staging`
...
- `obs-evo-cand-010448-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010448-route-evolution-graph`
