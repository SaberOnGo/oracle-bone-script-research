...
- External category reference: `evobc-cat-13247`
- Source category ID: `13247`
- Source label for human review: `𬍧`
...
- `obs-evo-cand-013247-route-category-staging`
...
- `obs-evo-cand-013247-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013247-route-evolution-graph`
