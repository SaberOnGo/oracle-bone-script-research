# Material Visual Observation / obs-comp-cand-002058 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002058`
- External reference / 外部参照: `obimd-sub-ls6kprxw1j`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019445_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ls6kprxw1j/ls6kprxw1j/ls6kprxw1j.png`
- Checksum / 校验和:
  `f9edcf4f78baa58fd1eb3b312fa5ba052b748b2bc1c7445339c71c2667f5faa3`
...
- Marked-pixel bounds: (65,18)–(195,230); span 131 × 213 px; the marked
...
- 痕迹范围：(65,18)–(195,230)；跨度131 × 213 px；痕迹矩形高于宽。
