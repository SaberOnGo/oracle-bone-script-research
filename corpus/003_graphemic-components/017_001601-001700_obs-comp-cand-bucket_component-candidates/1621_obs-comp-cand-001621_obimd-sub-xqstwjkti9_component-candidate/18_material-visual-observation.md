# Material Visual Observation / obs-comp-cand-001621 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001621`
- External reference / 外部参照: `obimd-sub-xqstwjkti9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017297_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xqstwjkti9/xqstwjkti9/xqstwjkti9.png`
- Checksum / 校验和:
  `717e2993bf2f34355c1ed0a12d281169aca3f8c52425564a24431482f5828642`
...
- Marked-pixel bounds: (82,40)–(167,204); span 86 × 165 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.78%。
- 痕迹范围：(82,40)–(167,204)；跨度86 × 165 px；痕迹矩形高于宽。
