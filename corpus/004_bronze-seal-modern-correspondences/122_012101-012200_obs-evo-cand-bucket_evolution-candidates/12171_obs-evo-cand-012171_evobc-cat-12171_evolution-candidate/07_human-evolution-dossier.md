...
- External category reference: `evobc-cat-12171`
- Source category ID: `12171`
- Source label for human review: `𧓉`
- Source codepoints: `U+274C9`
...
- `obs-evo-cand-012171-route-category-staging`
...
- `obs-evo-cand-012171-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012171-route-evolution-graph`
