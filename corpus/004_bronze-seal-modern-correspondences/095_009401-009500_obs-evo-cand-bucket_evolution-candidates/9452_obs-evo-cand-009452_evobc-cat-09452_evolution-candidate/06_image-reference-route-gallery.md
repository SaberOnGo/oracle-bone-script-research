...
- `obs-evo-cand-009452-route-category-staging`
...
- `obs-evo-cand-009452-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009452-route-evolution-graph`
