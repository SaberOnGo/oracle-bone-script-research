...
- `obs-evo-cand-002055-route-category-staging`
...
- `obs-evo-cand-002055-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002055-route-evolution-graph`
