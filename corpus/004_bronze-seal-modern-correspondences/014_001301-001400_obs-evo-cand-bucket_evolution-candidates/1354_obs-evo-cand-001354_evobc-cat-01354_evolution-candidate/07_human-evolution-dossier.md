...
- Project ID: `obs-evo-cand-001354`
- EVOBC category candidate ID: `evobc-evo-cat-01354`
- External category reference: `evobc-cat-01354`
- Source category ID: `01354`
- Source label for human review: `匵`
- Source codepoints: `U+5335`
...
- `obs-evo-cand-001354-route-category-staging`
...
- `obs-evo-cand-001354-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001354-route-evolution-graph`
