# Archaeological Context Review / 考古语境复核: coll-obj-cand-00005
...
The live museum page reports `Late Shang Period`, `SYFYH251, Hsiao-t'un,
...
现场博物馆页面报告“晚商”、`SYFYH251, Hsiao-t'un, Anyang County, Honan
...
| Source item | `1216` | `01_collection-object-packet.json` |
| Catalog description | `Tortoise Carapace for DivinationYi Bian 8806+8865+8997` | `01_collection-object-packet.json` |
