# obs-unk-004150 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/050_obs-unk-004150_h
  ust-obc-und-L-004150_oracle-character-candidate/03_visual-assets/001_asset
  -005743_hust-obc-und-L-004150_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4150/L_？_8989.jpg`
- asset id: `asset-005743`
...
- source class: `HUST-OBC/undeciphered/L/4150/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4150/L_？_8989.jpg`
- asset id: `asset-005743`
...
- English observation: Two upright trace groups have angular left marks and
  a taller curved right trace.
- 中文观察：两组竖向痕迹带左侧折角笔痕和右侧较高弯曲痕迹。
...
- Which source records identify obs-unk-004150 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004150？
