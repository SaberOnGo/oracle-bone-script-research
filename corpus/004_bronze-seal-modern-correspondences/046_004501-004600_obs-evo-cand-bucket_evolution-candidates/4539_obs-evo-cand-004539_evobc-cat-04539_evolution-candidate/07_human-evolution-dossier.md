...
Project ID: `obs-evo-cand-004539`
...
- Project ID: `obs-evo-cand-004539`
- EVOBC category candidate ID: `evobc-evo-cat-04539`
- External category reference: `evobc-cat-04539`
- Source category ID: `04539`
- Source label for human review: `沒`
- Source codepoints: `U+6C92`
...
- `obs-evo-cand-004539-route-category-staging`
...
- `obs-evo-cand-004539-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004539-route-evolution-graph`
