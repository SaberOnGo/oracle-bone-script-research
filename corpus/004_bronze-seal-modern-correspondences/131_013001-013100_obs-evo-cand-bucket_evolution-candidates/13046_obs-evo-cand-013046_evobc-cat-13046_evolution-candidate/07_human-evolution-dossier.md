...
Project ID: `obs-evo-cand-013046`
...
- Project ID: `obs-evo-cand-013046`
- EVOBC category candidate ID: `evobc-evo-cat-13046`
- External category reference: `evobc-cat-13046`
- Source category ID: `13046`
- Source label for human review: `𫨾`
- Source codepoints: `U+2BA3E`
...
- `obs-evo-cand-013046-route-category-staging`
...
- `obs-evo-cand-013046-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013046-route-evolution-graph`
