...
Project ID: `obs-evo-cand-001031`
...
- Project ID: `obs-evo-cand-001031`
- EVOBC category candidate ID: `evobc-evo-cat-01031`
- External category reference: `evobc-cat-01031`
- Source category ID: `01031`
- Source label for human review: `僵`
- Source codepoints: `U+50F5`
...
- `obs-evo-cand-001031-route-category-staging`
...
- `obs-evo-cand-001031-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001031-route-evolution-graph`
