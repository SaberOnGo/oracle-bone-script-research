...
- Project ID: `obs-evo-cand-004621`
- EVOBC category candidate ID: `evobc-evo-cat-04621`
- External category reference: `evobc-cat-04621`
- Source category ID: `04621`
- Source label for human review: `洔`
- Source codepoints: `U+6D14`
...
- `obs-evo-cand-004621-route-category-staging`
...
- `obs-evo-cand-004621-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004621-route-evolution-graph`
