# obs-comp-cand-002092 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002092`
- 首选外部 ID: `obimd-sub-1tvpevfzmn`
- OBIMD subcharacter UID: `1tvpevfzmn`
- OBIMD main character UID: `1tvpevfzmn`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+AEE2B;U+FC090; U+FC091; 另有 1 项
