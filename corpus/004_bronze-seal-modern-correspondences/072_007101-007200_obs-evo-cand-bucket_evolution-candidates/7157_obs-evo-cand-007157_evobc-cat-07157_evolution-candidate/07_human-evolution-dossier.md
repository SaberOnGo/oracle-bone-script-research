...
- External category reference: `evobc-cat-07157`
- Source category ID: `07157`
- Source label for human review: `臡`
...
- `obs-evo-cand-007157-route-category-staging`
...
- `obs-evo-cand-007157-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007157-route-evolution-graph`
