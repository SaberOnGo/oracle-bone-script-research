# Material Visual Observation / obs-comp-cand-001715 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001715`
- External reference / 外部参照: `obimd-sub-0kzlglkv4r`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017860_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/pmwfonj2ag/0kzlglkv4r/0kzlglkv4r.png`
- Checksum / 校验和:
  `160d6ffc6ba6e139d49a7cf497516b07c3c60aec75160caef4cbf67607fc9a48`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.48%.
- Marked-pixel bounds: (75,27)–(191,221); span 117 × 195 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.48%。
- 痕迹范围：(75,27)–(191,221)；跨度117 × 195 px；痕迹矩形高于宽。
