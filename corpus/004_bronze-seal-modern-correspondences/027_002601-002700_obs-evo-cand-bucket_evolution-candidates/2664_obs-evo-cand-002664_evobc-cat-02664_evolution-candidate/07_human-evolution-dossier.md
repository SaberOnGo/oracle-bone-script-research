...
Project ID: `obs-evo-cand-002664`
...
- Project ID: `obs-evo-cand-002664`
- EVOBC category candidate ID: `evobc-evo-cat-02664`
- External category reference: `evobc-cat-02664`
- Source category ID: `02664`
- Source label for human review: `帶`
- Source codepoints: `U+5E36`
...
- `obs-evo-cand-002664-route-category-staging`
...
- `obs-evo-cand-002664-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002664-route-evolution-graph`
