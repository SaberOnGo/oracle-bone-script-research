# obs-char-000766 Archaeology Paleography Review

# obs-char-000766 考古文字复核档案
...
- first local image: `001_asset-000771_hust-obc-cat-0869_glyph.png`
- first source image: `G_0869_後2.21.14(甲).png`
...
- source label text: `㝛`
- source label codepoints: `U+375B`
