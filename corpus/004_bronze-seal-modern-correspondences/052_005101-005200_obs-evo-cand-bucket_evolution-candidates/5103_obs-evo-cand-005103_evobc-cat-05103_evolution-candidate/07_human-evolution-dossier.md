...
Project ID: `obs-evo-cand-005103`
...
- Project ID: `obs-evo-cand-005103`
- EVOBC category candidate ID: `evobc-evo-cat-05103`
- External category reference: `evobc-cat-05103`
- Source category ID: `05103`
- Source label for human review: `煌`
- Source codepoints: `U+714C`
...
- `obs-evo-cand-005103-route-category-staging`
...
- `obs-evo-cand-005103-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005103-route-evolution-graph`
