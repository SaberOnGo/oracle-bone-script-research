...
- External category reference: `evobc-cat-05998`
- Source category ID: `05998`
- Source label: `祪`
...
- `obs-evo-cand-005998-route-category-staging`
...
- `obs-evo-cand-005998-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005998-route-evolution-graph`
