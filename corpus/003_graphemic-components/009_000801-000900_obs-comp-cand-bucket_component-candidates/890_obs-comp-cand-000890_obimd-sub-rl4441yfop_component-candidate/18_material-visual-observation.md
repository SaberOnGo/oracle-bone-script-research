# Material Visual Observation / obs-comp-cand-000890 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000890`
- External reference / 外部参照: `obimd-sub-rl4441yfop`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013962_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rl4441yfop/rl4441yfop/rl4441yfop.png`
- Checksum / 校验和:
  `3470f8b4673faf51b143bb0e92a407a745f674f359644515ea22b7403fa8a288`
...
- Marked-pixel bounds: (79,34)–(170,218); span 92 × 185 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.22%。
- 痕迹范围：(79,34)–(170,218)；跨度92 × 185 px；痕迹矩形高于宽。
