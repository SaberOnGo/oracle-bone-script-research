...
- External category reference: `evobc-cat-11840`
- Source category ID: `11840`
- Source label for human review: `𥠰`
...
- `obs-evo-cand-011840-route-category-staging`
...
- `obs-evo-cand-011840-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011840-route-evolution-graph`
