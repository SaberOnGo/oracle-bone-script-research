# obs-char-000428 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/428_obs-char-000428_hust-obc-cat-0486_orac
  le-character/03_visual-assets/001_asset-000433_hust-obc-cat-0486_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0486/G_0486_乙972反合11423賓組.png`
- asset id: `asset-000433`
...
- source category: `0486`
- validation class: `427`
- source image route: `HUST-OBC/deciphered/0486/G_0486_乙972反合11423賓組.png`
- asset id: `asset-000433`
...
- English observation: `A detached left cluster has two long upper strokes
  above a short bar, while a taller right cluster combines a central
  crossing with angled lower strokes.`
...
- dataset label text: `㗜`
- dataset label codepoints: `U+35DC`
...
- filename catalog route clues: `Heji-like filename clue: 合11423
...
- Which source records identify obs-char-000428 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000428？
