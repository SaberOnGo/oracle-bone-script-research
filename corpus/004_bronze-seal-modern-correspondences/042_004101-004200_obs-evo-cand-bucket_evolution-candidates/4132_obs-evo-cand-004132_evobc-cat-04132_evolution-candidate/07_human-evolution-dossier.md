...
- Project ID: `obs-evo-cand-004132`
- EVOBC category candidate ID: `evobc-evo-cat-04132`
- External category reference: `evobc-cat-04132`
- Source category ID: `04132`
- Source label for human review: `椵`
- Source codepoints: `U+6935`
...
- `obs-evo-cand-004132-route-category-staging`
...
- `obs-evo-cand-004132-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004132-route-evolution-graph`
