# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008906
...
- EVOBC candidate category: `evobc-evo-cat-08906`.
- Source label for search only: `辛`.
- Source codepoints for search only: `U+8F9B`.
