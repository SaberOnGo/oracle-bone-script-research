...
Project ID: `obs-evo-cand-011229`
...
- Project ID: `obs-evo-cand-011229`
- EVOBC category candidate ID: `evobc-evo-cat-11229`
- External category reference: `evobc-cat-11229`
- Source category ID: `11229`
- Source label for human review: `𢙡`
- Source codepoints: `U+22661`
...
- `obs-evo-cand-011229-route-category-staging`
...
- `obs-evo-cand-011229-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011229-route-evolution-graph`
