# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008716
...
- EVOBC candidate category: `evobc-evo-cat-08716`.
- Source label for search only: `跟`.
- Source codepoints for search only: `U+8DDF`.
