...
- External category reference: `evobc-cat-06585`
- Source category ID: `06585`
- Source label for human review: `緎`
...
- `obs-evo-cand-006585-route-category-staging`
...
- `obs-evo-cand-006585-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006585-route-evolution-graph`
