# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000797
...
- EVOBC candidate category: `evobc-evo-cat-00797`.
- Source label for search only: `佋`.
- Source codepoints for search only: `U+4F4B`.
