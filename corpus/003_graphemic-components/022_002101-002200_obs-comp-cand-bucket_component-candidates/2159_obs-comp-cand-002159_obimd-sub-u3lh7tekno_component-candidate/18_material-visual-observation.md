# Material Visual Observation / obs-comp-cand-002159 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002159`
- External reference / 外部参照: `obimd-sub-u3lh7tekno`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019800_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/u3lh7tekno/u3lh7tekno/0vyliznirb.png`
- Checksum / 校验和:
  `acb31fefbad36d3dbddc0531846f7ba9d0096030f0160be573c649476d99b0a9`
...
- Marked-pixel bounds: (85,19)–(164,223); span 80 × 205 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.52%。
- 痕迹范围：(85,19)–(164,223)；跨度80 × 205 px；痕迹矩形高于宽。
