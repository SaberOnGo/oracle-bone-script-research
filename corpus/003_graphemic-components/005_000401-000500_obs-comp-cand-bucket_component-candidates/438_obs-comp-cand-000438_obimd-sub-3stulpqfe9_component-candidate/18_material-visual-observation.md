# Material Visual Observation / obs-comp-cand-000438 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000438`
- External reference / 外部参照: `obimd-sub-3stulpqfe9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012361_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3stulpqfe9/3stulpqfe9/3stulpqfe9.png`
- Checksum / 校验和:
  `611855d487ed35841ab4b4615a36569bb6f610673c3e066450e12791ac99b33a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 16.38%.
- Marked-pixel bounds: (34,20)–(215,227); span 182 × 208 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占16.38%。
- 痕迹范围：(34,20)–(215,227)；跨度182 × 208 px；痕迹矩形近方形。
