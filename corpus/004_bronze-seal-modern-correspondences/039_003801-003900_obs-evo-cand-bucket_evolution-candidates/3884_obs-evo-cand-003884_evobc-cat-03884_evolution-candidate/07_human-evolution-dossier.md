...
Project ID: `obs-evo-cand-003884`
...
- Project ID: `obs-evo-cand-003884`
- EVOBC category candidate ID: `evobc-evo-cat-03884`
- External category reference: `evobc-cat-03884`
- Source category ID: `03884`
- Source label for human review: `杚`
- Source codepoints: `U+675A`
...
- `obs-evo-cand-003884-route-category-staging`
...
- `obs-evo-cand-003884-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003884-route-evolution-graph`
