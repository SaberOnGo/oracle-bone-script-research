...
Project ID: `obs-insc-cw-cand-000441`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000441`
...
- Yingguo / 英国所藏: `y2294` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `280` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `401` in source row; primary catalog entry pending
- Heji / 合集: `41348` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000441`
