...
- Project ID: `obs-evo-cand-008345`
- EVOBC category candidate ID: `evobc-evo-cat-08345`
- External category reference: `evobc-cat-08345`
- Source category ID: `08345`
- Source label for human review: `譄`
- Source codepoints: `U+8B44`
...
- `obs-evo-cand-008345-route-category-staging`
...
- `obs-evo-cand-008345-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008345-route-evolution-graph`
