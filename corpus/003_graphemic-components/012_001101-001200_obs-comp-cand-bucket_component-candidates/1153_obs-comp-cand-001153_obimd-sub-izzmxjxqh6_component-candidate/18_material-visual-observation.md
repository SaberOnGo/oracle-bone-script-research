# Material Visual Observation / obs-comp-cand-001153 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001153`
- External reference / 外部参照: `obimd-sub-izzmxjxqh6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015343_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/izzmxjxqh6/izzmxjxqh6/izzmxjxqh6.png`
- Checksum / 校验和:
  `190a096e6ac774c1ea62928a8cff3ab53cd782987637e6b4b721f1106e7fa593`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.85%.
- Marked-pixel bounds: (69,39)–(187,213); span 119 × 175 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.85%。
- 痕迹范围：(69,39)–(187,213)；跨度119 × 175 px；痕迹矩形高于宽。
