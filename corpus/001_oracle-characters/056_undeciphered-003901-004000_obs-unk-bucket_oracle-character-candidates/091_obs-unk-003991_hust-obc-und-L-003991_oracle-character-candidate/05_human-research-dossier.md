# obs-unk-003991 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003991`
- primary external id: `hust-obc-und-L-003991`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/091_obs-unk-003991_h
  ust-obc-und-L-003991_oracle-character-candidate/03_visual-assets/001_asset
  -005584_hust-obc-und-L-003991_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3991/L_？_8446.jpg`
- asset id: `asset-005584`
...
- source class: `HUST-OBC/undeciphered/L/3991/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3991/L_？_8446.jpg`
- asset id: `asset-005584`
...
- English observation: A forked upper trace sits above a descending central
  stroke; dense angular marks occupy the lower right.
...
- Which source records identify obs-unk-003991 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003991？
