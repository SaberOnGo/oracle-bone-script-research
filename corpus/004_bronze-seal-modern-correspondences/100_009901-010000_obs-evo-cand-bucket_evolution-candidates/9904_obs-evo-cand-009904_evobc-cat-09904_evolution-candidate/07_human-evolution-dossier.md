...
Project ID: `obs-evo-cand-009904`
...
- Project ID: `obs-evo-cand-009904`
- EVOBC category candidate ID: `evobc-evo-cat-09904`
- External category reference: `evobc-cat-09904`
- Source category ID: `09904`
- Source label for human review: `鞃`
- Source codepoints: `U+9783`
...
- `obs-evo-cand-009904-route-category-staging`
...
- `obs-evo-cand-009904-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009904-route-evolution-graph`
