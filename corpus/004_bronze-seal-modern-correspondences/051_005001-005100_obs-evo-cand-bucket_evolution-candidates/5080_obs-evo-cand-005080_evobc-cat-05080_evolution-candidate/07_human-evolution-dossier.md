...
- External category reference: `evobc-cat-05080`
- Source category ID: `05080`
- Source label for human review: `焂`
...
- `obs-evo-cand-005080-route-category-staging`
...
- `obs-evo-cand-005080-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005080-route-evolution-graph`
