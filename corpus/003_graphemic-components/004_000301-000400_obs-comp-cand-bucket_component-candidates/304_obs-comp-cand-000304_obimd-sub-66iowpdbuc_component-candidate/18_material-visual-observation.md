# Material Visual Observation / obs-comp-cand-000304 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000304`
- External reference / 外部参照: `obimd-sub-66iowpdbuc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012070_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/66iowpdbuc/66iowpdbuc/060m8jhc19.png`
- Checksum / 校验和:
  `6f708fb1e90a0fdcea9164f259fbc4dc1a5c2aa894db1c1360a46daae9697163`
...
- Marked-pixel bounds: (85,43)–(164,205); span 80 × 163 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.52%。
- 痕迹范围：(85,43)–(164,205)；跨度80 × 163 px；痕迹矩形高于宽。
