...
- External category reference: `evobc-cat-00931`
- Source category ID: `00931`
- Source label: `借`
...
- `obs-evo-cand-000931-route-category-staging`
...
- `obs-evo-cand-000931-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000931-route-evolution-graph`
