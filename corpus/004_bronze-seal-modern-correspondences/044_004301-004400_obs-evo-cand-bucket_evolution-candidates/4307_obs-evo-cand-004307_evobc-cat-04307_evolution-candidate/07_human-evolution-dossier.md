...
- External category reference: `evobc-cat-04307`
- Source category ID: `04307`
- Source label for human review: `櫋`
...
- `obs-evo-cand-004307-route-category-staging`
...
- `obs-evo-cand-004307-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004307-route-evolution-graph`
