# Material Visual Observation / obs-comp-cand-001668 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001668`
- External reference / 外部参照: `obimd-sub-6m2fhuraxn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017344_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/uhz6qrd2d9/6m2fhuraxn/6m2fhuraxn.png`
- Checksum / 校验和:
  `e59e928f6b0a6390f8fddc763d2c8225ee9f607971e78938a4a10da91f29bbc4`
...
- Marked-pixel bounds: (71,51)–(178,193); span 108 × 143 px; the marked
...
- 痕迹范围：(71,51)–(178,193)；跨度108 × 143 px；痕迹矩形高于宽。
