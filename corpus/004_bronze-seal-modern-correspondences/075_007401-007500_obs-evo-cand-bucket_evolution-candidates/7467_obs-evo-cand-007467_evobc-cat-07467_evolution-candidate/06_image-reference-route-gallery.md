...
- `obs-evo-cand-007467-route-category-staging`
...
- `obs-evo-cand-007467-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007467-route-evolution-graph`
