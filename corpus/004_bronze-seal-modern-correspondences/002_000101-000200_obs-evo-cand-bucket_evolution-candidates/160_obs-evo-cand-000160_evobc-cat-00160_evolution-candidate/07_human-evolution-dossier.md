...
- External category reference: `evobc-cat-00160`
- Source category ID: `00160`
- Source label for human review: `㫷`
...
- `obs-evo-cand-000160-route-category-staging`
...
- `obs-evo-cand-000160-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000160-route-evolution-graph`
