# obs-char-000182 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/182_obs-char-000182_hust-obc-cat-0201_orac
  le-character/03_visual-assets/001_asset-000187_hust-obc-cat-0201_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0201/G_0201_甲骨文.png`
- asset id: `asset-000187`
...
- source category: `0201`
- validation class: `181`
- source image route: `HUST-OBC/deciphered/0201/G_0201_甲骨文.png`
- asset id: `asset-000187`
...
- English observation: `The image has a pointed upper junction, two long
  outer strokes descending on both sides, and a short central lower stroke.`
...
- dataset label text: `㒿`
- dataset label codepoints: `U+34BF`
...
- Which source records identify obs-char-000182 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000182？
