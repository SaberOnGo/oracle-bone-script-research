# obs-char-001516 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001516`
- primary external id: `hust-obc-cat-1701`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1516_obs-char-001516_hust-obc-cat-1701_ora
  cle-character/03_visual-assets/001_asset-001521_hust-obc-cat-1701_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1701/G_1701_存49(甲).png`
- asset id: `asset-001521`
...
- source category: `1701`
- validation class: `1515`
- source image route: `HUST-OBC/deciphered/1701/G_1701_存49(甲).png`
- asset id: `asset-001521`
...
- English observation: `An upper crossed cluster sits above a separate
  horizontal stroke and a long curved lower line.`
- 中文观察: `上部交叉笔画群位于分离的横笔和长弧形下部笔画之上。`
...
- dataset label text: `㪛`
- dataset label codepoints: `U+3A9B`
...
- Which source records identify obs-char-001516 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001516？
