# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000974

English:
This human-readable matrix gives a compact review order for one OBIMD component
candidate. It keeps glyph-codepoint, image, source, near-shape,
character-context, and rights routes together without promoting any route into a
formal component assignment.

简体中文：
本矩阵为一个 OBIMD 构件候选对象提供简明的人工复核顺序，把 codepoint、图像、来源、近形和上下文路线放在同一对象目录内。
...
| Glyph or codepoint route / 字形或码位路线 | 16 OBIMD route rows; examples U+F5801; U+F5802; 另有 14 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 0 local image rows; not_found_in_registered_source_package_route_indexed | 06_component-visual-index.csv; 07_component-visual-gallery.md |
