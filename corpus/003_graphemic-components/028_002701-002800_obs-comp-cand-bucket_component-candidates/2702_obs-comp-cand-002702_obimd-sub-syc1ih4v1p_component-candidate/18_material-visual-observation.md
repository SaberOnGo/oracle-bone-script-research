# Material Visual Observation / obs-comp-cand-002702 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002702`
- External reference / 外部参照: `obimd-sub-syc1ih4v1p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021278_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/syc1ih4v1p/syc1ih4v1p/syc1ih4v1p.png`
- Checksum / 校验和:
  `12b3bfcd41e40469c145c3d4dc6d32a6775ccb2a84d3314d516cd829996d2f6a`
...
- Marked-pixel bounds: (99,21)–(160,230); span 62 × 210 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.81%。
- 痕迹范围：(99,21)–(160,230)；跨度62 × 210 px；痕迹矩形高于宽。
