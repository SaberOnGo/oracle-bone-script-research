...
- Project ID: `obs-evo-cand-012846`
- EVOBC category candidate ID: `evobc-evo-cat-12846`
- External category reference: `evobc-cat-12846`
- Source category ID: `12846`
- Source label for human review: `𪫜`
- Source codepoints: `U+2AADC`
...
- `obs-evo-cand-012846-route-category-staging`
...
- `obs-evo-cand-012846-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012846-route-evolution-graph`
