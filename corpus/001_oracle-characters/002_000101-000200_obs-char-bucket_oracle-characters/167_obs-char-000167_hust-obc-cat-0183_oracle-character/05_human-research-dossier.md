# obs-char-000167 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/167_obs-char-000167_hust-obc-cat-0183_orac
  le-character/03_visual-assets/001_asset-000172_hust-obc-cat-0183_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0183/G_0183_乙7750合787賓組.png`
- asset id: `asset-000172`
...
- source category: `0183`
- validation class: `166`
- source image route: `HUST-OBC/deciphered/0183/G_0183_乙7750合787賓組.png`
- asset id: `asset-000172`
...
- English observation: `The broad image shows two separated tall forms: a
  long curved stroke on the left and a branched angular form on the right
  with a small terminal mark.`
...
- dataset label text: `㒭`
- dataset label codepoints: `U+34AD`
...
- filename catalog route clues: `Heji-like filename clue: 合787
...
- Which source records identify obs-char-000167 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000167？
