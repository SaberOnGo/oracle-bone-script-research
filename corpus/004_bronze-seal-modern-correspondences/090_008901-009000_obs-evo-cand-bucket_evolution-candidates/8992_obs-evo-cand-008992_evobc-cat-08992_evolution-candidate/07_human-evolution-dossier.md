...
Project ID: `obs-evo-cand-008992`
...
- Project ID: `obs-evo-cand-008992`
- EVOBC category candidate ID: `evobc-evo-cat-08992`
- External category reference: `evobc-cat-08992`
- Source category ID: `08992`
- Source label for human review: `递`
- Source codepoints: `U+9012`
...
- `obs-evo-cand-008992-route-category-staging`
...
- `obs-evo-cand-008992-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008992-route-evolution-graph`
