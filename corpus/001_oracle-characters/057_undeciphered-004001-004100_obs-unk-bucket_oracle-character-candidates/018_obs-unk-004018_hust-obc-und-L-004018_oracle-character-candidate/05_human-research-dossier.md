# obs-unk-004018 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004018`
- primary external id: `hust-obc-und-L-004018`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/018_obs-unk-004018_h
  ust-obc-und-L-004018_oracle-character-candidate/03_visual-assets/001_asset
  -005611_hust-obc-und-L-004018_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4018/L_？_8571.jpg`
- asset id: `asset-005611`
...
- source class: `HUST-OBC/undeciphered/L/4018/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4018/L_？_8571.jpg`
- asset id: `asset-005611`
...
- Which source records identify obs-unk-004018 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004018？
