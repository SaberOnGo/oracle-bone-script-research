# obs-char-001339 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1339_obs-char-001339_hust-obc-cat-1495_ora
  cle-character/03_visual-assets/001_asset-001344_hust-obc-cat-1495_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1495/G_1495_佚21(甲).png`
- asset id: `asset-001344`
...
- source category: `1495`
- validation class: `1338`
- source image route: `HUST-OBC/deciphered/1495/G_1495_佚21(甲).png`
- asset id: `asset-001344`
...
- English observation: `A narrow branching form has an upper curve, a
  central vertical, several side branches, and a pointed lower end.`
...
- dataset label text: `㧍`
- dataset label codepoints: `U+39CD`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/142_obs-evo-can
  d-000142_evobc-cat-00142_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/142_obs-evo-cand-000142_evobc-cat-00142_evolu
...
- Which source records identify obs-char-001339 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001339？
