...
Project ID: `obs-evo-cand-012565`
...
- Project ID: `obs-evo-cand-012565`
- EVOBC category candidate ID: `evobc-evo-cat-12565`
- External category reference: `evobc-cat-12565`
- Source category ID: `12565`
- Source label for human review: `𩇜`
- Source codepoints: `U+291DC`
...
- `obs-evo-cand-012565-route-category-staging`
...
- `obs-evo-cand-012565-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012565-route-evolution-graph`
