...
- External category reference: `evobc-cat-07495`
- Source category ID: `07495`
- Source label for human review: `蒐`
- Source codepoints: `U+8490`
...
- `obs-evo-cand-007495-route-category-staging`
...
- `obs-evo-cand-007495-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007495-route-evolution-graph`
