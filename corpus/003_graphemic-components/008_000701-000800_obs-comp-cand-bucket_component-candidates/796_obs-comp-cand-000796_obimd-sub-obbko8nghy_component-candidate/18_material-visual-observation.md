# Material Visual Observation / obs-comp-cand-000796 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000796`
- External reference / 外部参照: `obimd-sub-obbko8nghy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013594_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2tq601zel0/obbko8nghy/obbko8nghy.png`
- Checksum / 校验和:
  `9de7ba925bc2945c269a2dff7861cf4b6ad50e7f7cb28b80c607211e3789a5ef`
- Rights status / 权利状态: `licensed_for_repository`
- Review status / 复核状态: `needs_human_visual_review`

## Direct Visual Record / 直接可见记录

- English observation: The opened raster contains a contrasting mark field. The
  following profile describes pixels only and does not segment individual
  strokes.
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.56%.
- Marked-pixel bounds: (46,36)–(199,219); span 154 × 184 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.56%。
- 痕迹范围：(46,36)–(199,219)；跨度154 × 184 px；痕迹矩形近方形。
