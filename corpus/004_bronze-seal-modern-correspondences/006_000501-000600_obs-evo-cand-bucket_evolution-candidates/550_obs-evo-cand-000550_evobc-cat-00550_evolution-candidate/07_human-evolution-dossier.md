...
- External category reference: `evobc-cat-00550`
- Source category ID: `00550`
- Source label for human review: `䫌`
- Source codepoints: `U+4ACC`
...
- `obs-evo-cand-000550-route-category-staging`
...
- `obs-evo-cand-000550-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000550-route-evolution-graph`
