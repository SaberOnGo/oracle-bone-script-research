...
- External category reference: `evobc-cat-06917`
- Source category ID: `06917`
- Source label for human review: `耎`
...
- `obs-evo-cand-006917-route-category-staging`
...
- `obs-evo-cand-006917-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006917-route-evolution-graph`
