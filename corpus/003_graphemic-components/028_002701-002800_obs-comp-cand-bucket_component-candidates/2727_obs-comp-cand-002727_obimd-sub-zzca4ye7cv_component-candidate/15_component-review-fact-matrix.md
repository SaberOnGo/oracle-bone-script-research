# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002727
...
| Glyph or codepoint route / 字形或码位路线 | 4 OBIMD route rows; examples U+FF632; U+FF633; 另有 2 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
