...
- External category reference: `evobc-cat-12517`
- Source category ID: `12517`
- Source label for human review: `𨸡`
...
- `obs-evo-cand-012517-route-category-staging`
...
- `obs-evo-cand-012517-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012517-route-evolution-graph`
