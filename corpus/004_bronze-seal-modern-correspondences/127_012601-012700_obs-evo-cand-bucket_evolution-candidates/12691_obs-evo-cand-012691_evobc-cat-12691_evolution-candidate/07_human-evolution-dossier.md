...
- External category reference: `evobc-cat-12691`
- Source category ID: `12691`
- Source label for human review: `𩱭`
...
- `obs-evo-cand-012691-route-category-staging`
...
- `obs-evo-cand-012691-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012691-route-evolution-graph`
