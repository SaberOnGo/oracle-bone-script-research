...
- Project ID: `obs-evo-cand-011468`
- EVOBC category candidate ID: `evobc-evo-cat-11468`
- External category reference: `evobc-cat-11468`
- Source category ID: `11468`
- Source label for human review: `𣣞`
- Source codepoints: `U+238DE`
...
- `obs-evo-cand-011468-route-category-staging`
...
- `obs-evo-cand-011468-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011468-route-evolution-graph`
