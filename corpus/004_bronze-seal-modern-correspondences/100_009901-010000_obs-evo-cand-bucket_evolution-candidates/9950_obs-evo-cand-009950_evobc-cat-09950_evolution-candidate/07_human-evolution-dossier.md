...
Project ID: `obs-evo-cand-009950`
...
- Project ID: `obs-evo-cand-009950`
- EVOBC category candidate ID: `evobc-evo-cat-09950`
- External category reference: `evobc-cat-09950`
- Source category ID: `09950`
- Source label for human review: `韜`
- Source codepoints: `U+97DC`
...
- `obs-evo-cand-009950-route-category-staging`
...
- `obs-evo-cand-009950-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009950-route-evolution-graph`
