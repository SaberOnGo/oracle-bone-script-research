# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001686
...
| --- | --- | --- | --- |
| `obimd-glyph-link-026127` | 򩦝󹲔 | `U+A999D;U+F9C94` | `reviewed_metadata_only` |
| `obimd-glyph-link-026128` | 󹲕 | `U+F9C95` | `reviewed_metadata_only` |
