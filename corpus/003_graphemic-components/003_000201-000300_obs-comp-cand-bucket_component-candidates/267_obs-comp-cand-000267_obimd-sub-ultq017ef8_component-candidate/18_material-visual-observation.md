# Material Visual Observation / obs-comp-cand-000267 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000267`
- External reference / 外部参照: `obimd-sub-ultq017ef8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011912_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ultq017ef8/ultq017ef8/ultq017ef8.png`
- Checksum / 校验和:
  `0e3cbbca6b83ec7bb0640b6714f2aeaa080b27eebc46963df3731d5047e5316e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.70%.
- Marked-pixel bounds: (52,42)–(197,199); span 146 × 158 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.70%。
- 痕迹范围：(52,42)–(197,199)；跨度146 × 158 px；痕迹矩形近方形。
