...
- Yingguo / 英国所藏: `y2540` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `368` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `464` in source row; primary catalog entry pending
- Heji / 合集: `41803` in source row; primary catalog entry pending
