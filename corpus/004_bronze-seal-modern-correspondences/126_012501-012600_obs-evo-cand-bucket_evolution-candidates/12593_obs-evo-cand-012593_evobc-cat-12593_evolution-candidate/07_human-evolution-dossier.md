...
Project ID: `obs-evo-cand-012593`
...
- Project ID: `obs-evo-cand-012593`
- EVOBC category candidate ID: `evobc-evo-cat-12593`
- External category reference: `evobc-cat-12593`
- Source category ID: `12593`
- Source label for human review: `𩏂`
- Source codepoints: `U+293C2`
...
- `obs-evo-cand-012593-route-category-staging`
...
- `obs-evo-cand-012593-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012593-route-evolution-graph`
