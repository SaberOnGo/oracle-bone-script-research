...
- `obs-evo-cand-005555-route-category-staging`
...
- `obs-evo-cand-005555-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005555-route-evolution-graph`
