# obs-char-000193 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/193_obs-char-000193_hust-obc-cat-0215_orac
  le-character/03_visual-assets/001_asset-000198_hust-obc-cat-0215_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0215/G_0215_掇1.432合32770歷組.png`
- asset id: `asset-000198`
...
- source category: `0215`
- validation class: `192`
- source image route: `HUST-OBC/deciphered/0215/G_0215_掇1.432合32770歷組.png`
- asset id: `asset-000198`
...
- English observation: `The image has a central angular crossing with a
  short upper stroke, a long diagonal stroke toward the lower left, and a
  separate lower-right mark.`
...
- dataset label text: `㓍`
- dataset label codepoints: `U+34CD`
...
- filename catalog route clues: `Heji-like filename clue: 合32770
  (G_0215_掇1.432合32770歷組.png)`
...
- Which source records identify obs-char-000193 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000193？
