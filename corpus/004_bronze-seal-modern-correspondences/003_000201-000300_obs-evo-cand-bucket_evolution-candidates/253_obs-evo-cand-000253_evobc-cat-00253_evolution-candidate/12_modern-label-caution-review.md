# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000253
...
- EVOBC candidate category: `evobc-evo-cat-00253`.
- Source label for search only: `㽿`.
- Source codepoints for search only: `U+3F7F`.
