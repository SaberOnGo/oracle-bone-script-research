# obs-unk-004292 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/092_obs-unk-004292_h
  ust-obc-und-L-004292_oracle-character-candidate/03_visual-assets/001_asset
  -005885_hust-obc-und-L-004292_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4292/L_？_9478.jpg`
- asset id: `asset-005885`
...
- source class: `HUST-OBC/undeciphered/L/4292/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4292/L_？_9478.jpg`
- asset id: `asset-005885`
...
- English observation: `Dense upper cluster, left curve, right descent visible.`
- 中文观察: `密集上部痕迹组、左侧弯痕和右侧下行痕迹可见。`
...
- Which source records identify obs-unk-004292 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004292？
