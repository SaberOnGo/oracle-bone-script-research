# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006870
...
- EVOBC candidate category: `evobc-evo-cat-06870`.
- Source label for search only: `羿`.
- Source codepoints for search only: `U+7FBF`.
