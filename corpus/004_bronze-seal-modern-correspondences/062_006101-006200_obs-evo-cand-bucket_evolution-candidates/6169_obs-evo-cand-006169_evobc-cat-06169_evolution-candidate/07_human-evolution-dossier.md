...
- External category reference: `evobc-cat-06169`
- Source category ID: `06169`
- Source label for human review: `窜`
- Source codepoints: `U+7A9C`
...
- `obs-evo-cand-006169-route-category-staging`
...
- `obs-evo-cand-006169-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006169-route-evolution-graph`
