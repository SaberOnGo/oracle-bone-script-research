# obs-char-001482 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001482`
- primary external id: `hust-obc-cat-1664`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1482_obs-char-001482_hust-obc-cat-1664_ora
  cle-character/03_visual-assets/001_asset-001487_hust-obc-cat-1664_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1664/L_1664_12870.jpg`
- asset id: `asset-001487`
...
- source category: `1664`
- validation class: `1481`
- source image route: `HUST-OBC/deciphered/1664/L_1664_12870.jpg`
- asset id: `asset-001487`
...
- English observation: `A faint dense cluster has a central enclosure and
  radiating short strokes.`
- 中文观察: `浅淡密集笔画群有中央框形和放射状短笔。`
...
- dataset label text: `㩶`
- dataset label codepoints: `U+3A76`
...
- Which source records identify obs-char-001482 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001482？
