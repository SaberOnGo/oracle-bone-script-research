# obs-char-001282 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001282`
- primary external id: `hust-obc-cat-1434`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1282_obs-char-001282_hust-obc-cat-1434_ora
  cle-character/03_visual-assets/001_asset-001287_hust-obc-cat-1434_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1434/G_1434_乙442合21907子組.png`
- asset id: `asset-001287`
...
- source category: `1434`
- validation class: `1281`
- source image route: `HUST-OBC/deciphered/1434/G_1434_乙442合21907子組.png`
- asset id: `asset-001287`
...
- English observation: `A faint narrow upright form has a short upper
  crossing, a thin central stem, and small side ticks.`
- 中文观察: `较淡狭长直立形体有短上部交叉笔、细中央笔干和小型侧向短笔。`
...
- dataset label text: `㦐`
- dataset label codepoints: `U+3990`
...
- filename catalog route clues: `Heji-like filename clue: 合21907
  (G_1434_乙442合21907子組.png)`
...
- Which source records identify obs-char-001282 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001282？
