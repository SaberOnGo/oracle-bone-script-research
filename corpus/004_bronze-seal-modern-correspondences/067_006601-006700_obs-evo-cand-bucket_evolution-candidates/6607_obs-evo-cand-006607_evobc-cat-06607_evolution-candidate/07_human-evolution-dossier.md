...
- External category reference: `evobc-cat-06607`
- Source category ID: `06607`
- Source label for human review: `緬`
...
- `obs-evo-cand-006607-route-category-staging`
...
- `obs-evo-cand-006607-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006607-route-evolution-graph`
