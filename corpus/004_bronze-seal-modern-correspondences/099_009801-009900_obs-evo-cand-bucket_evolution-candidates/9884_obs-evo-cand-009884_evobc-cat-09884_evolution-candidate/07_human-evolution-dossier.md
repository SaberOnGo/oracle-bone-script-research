...
- External category reference: `evobc-cat-09884`
- Source category ID: `09884`
- Source label: `靚`
...
- `obs-evo-cand-009884-route-category-staging`
...
- `obs-evo-cand-009884-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-009884-route-evolution-graph`
