# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013472
...
- EVOBC candidate category: `evobc-evo-cat-13472`.
- Source label for search only: `𭂢`.
- Source codepoints for search only: `U+2D0A2`.
