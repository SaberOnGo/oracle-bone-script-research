...
- Project ID: `obs-evo-cand-013447`
- EVOBC category candidate ID: `evobc-evo-cat-13447`
- External category reference: `evobc-cat-13447`
- Source category ID: `13447`
- Source label for human review: `𬶷`
- Source codepoints: `U+2CDB7`
...
- `obs-evo-cand-013447-route-category-staging`
...
- `obs-evo-cand-013447-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013447-route-evolution-graph`
