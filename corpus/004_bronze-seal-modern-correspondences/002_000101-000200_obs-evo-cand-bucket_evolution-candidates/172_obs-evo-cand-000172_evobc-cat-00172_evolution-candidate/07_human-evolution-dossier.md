...
- External category reference: `evobc-cat-00172`
- Source category ID: `00172`
- Source label for human review: `㮔`
- Source codepoints: `U+3B94`
...
- `obs-evo-cand-000172-route-category-staging`
...
- `obs-evo-cand-000172-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000172-route-evolution-graph`
