...
Project ID: `obs-insc-cw-cand-000078`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000078`
...
- Source page section: `Period I Group 4` /
  `第 I 期第 4 组`
- Source section key: `period-i-group-4`
...
- Yingguo / 英国所藏: `y505` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `210` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `360` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000078`
