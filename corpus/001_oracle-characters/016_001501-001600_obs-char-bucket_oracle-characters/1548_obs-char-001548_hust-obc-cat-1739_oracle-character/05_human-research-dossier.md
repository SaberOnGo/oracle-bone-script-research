# obs-char-001548 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001548`
- primary external id: `hust-obc-cat-1739`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1548_obs-char-001548_hust-obc-cat-1739_ora
  cle-character/03_visual-assets/001_asset-001553_hust-obc-cat-1739_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1739/L_1739_11929.jpg`
- asset id: `asset-001553`
...
- source category: `1739`
- validation class: `1547`
- source image route: `HUST-OBC/deciphered/1739/L_1739_11929.jpg`
- asset id: `asset-001553`
...
- English observation: `A very faint form has a short upper bar, a small
  central enclosure, and lower vertical marks.`
- 中文观察: `极浅淡形体有短上横笔、小型中央框形和下部竖向笔画。`
...
- dataset label text: `㫁`
- dataset label codepoints: `U+3AC1`
...
- Which source records identify obs-char-001548 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001548？
