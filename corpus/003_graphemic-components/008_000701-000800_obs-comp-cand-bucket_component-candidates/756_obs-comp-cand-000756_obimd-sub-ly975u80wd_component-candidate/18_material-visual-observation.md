# Material Visual Observation / obs-comp-cand-000756 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000756`
- External reference / 外部参照: `obimd-sub-ly975u80wd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013520_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ly975u80wd/ly975u80wd/ly975u80wd.png`
- Checksum / 校验和:
  `fbfa822084c31dc883894acf8dff7473446f6176eaf60c8f9df285aed4ec7e97`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.57%.
- Marked-pixel bounds: (75,20)–(174,227); span 100 × 208 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.57%。
- 痕迹范围：(75,20)–(174,227)；跨度100 × 208 px；痕迹矩形高于宽。
