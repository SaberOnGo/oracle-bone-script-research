...
- External category reference: `evobc-cat-05852`
- Source category ID: `05852`
- Source label for human review: `瞞`
- Source codepoints: `U+779E`
...
- `obs-evo-cand-005852-route-category-staging`
...
- `obs-evo-cand-005852-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005852-route-evolution-graph`
