...
Project ID: `obs-evo-cand-003835`
...
- Project ID: `obs-evo-cand-003835`
- EVOBC category candidate ID: `evobc-evo-cat-03835`
- External category reference: `evobc-cat-03835`
- Source category ID: `03835`
- Source label for human review: `朓`
- Source codepoints: `U+6713`
...
- `obs-evo-cand-003835-route-category-staging`
...
- `obs-evo-cand-003835-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003835-route-evolution-graph`
