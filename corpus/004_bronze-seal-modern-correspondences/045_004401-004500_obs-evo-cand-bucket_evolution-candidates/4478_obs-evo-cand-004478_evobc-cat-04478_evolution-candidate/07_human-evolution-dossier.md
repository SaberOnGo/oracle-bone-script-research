...
Project ID: `obs-evo-cand-004478`
...
- Project ID: `obs-evo-cand-004478`
- EVOBC category candidate ID: `evobc-evo-cat-04478`
- External category reference: `evobc-cat-04478`
- Source category ID: `04478`
- Source label for human review: `氵`
- Source codepoints: `U+6C35`
...
- `obs-evo-cand-004478-route-category-staging`
...
- `obs-evo-cand-004478-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004478-route-evolution-graph`
