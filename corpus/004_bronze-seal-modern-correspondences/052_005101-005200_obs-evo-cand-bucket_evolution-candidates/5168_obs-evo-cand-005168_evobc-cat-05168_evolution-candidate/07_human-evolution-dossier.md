...
- External category reference: `evobc-cat-05168`
- Source category ID: `05168`
- Source label for human review: `爓`
- Source codepoints: `U+7213`
...
- `obs-evo-cand-005168-route-category-staging`
...
- `obs-evo-cand-005168-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005168-route-evolution-graph`
