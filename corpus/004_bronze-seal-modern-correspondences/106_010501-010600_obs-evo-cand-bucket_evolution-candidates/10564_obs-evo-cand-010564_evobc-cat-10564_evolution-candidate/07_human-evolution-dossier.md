...
- External category reference: `evobc-cat-10564`
- Source category ID: `10564`
- Source label for human review: `鷲`
- Source codepoints: `U+9DF2`
...
- `obs-evo-cand-010564-route-category-staging`
...
- `obs-evo-cand-010564-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010564-route-evolution-graph`
