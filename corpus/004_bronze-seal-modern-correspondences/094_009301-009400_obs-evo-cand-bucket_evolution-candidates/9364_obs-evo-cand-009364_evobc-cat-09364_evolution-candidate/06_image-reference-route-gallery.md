...
- `obs-evo-cand-009364-route-category-staging`
...
- `obs-evo-cand-009364-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009364-route-evolution-graph`
