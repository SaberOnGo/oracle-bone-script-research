...
- External category reference: `evobc-cat-11443`
- Source category ID: `11443`
- Source label for human review: `𣖨`
- Source codepoints: `U+235A8`
...
- `obs-evo-cand-011443-route-category-staging`
...
- `obs-evo-cand-011443-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011443-route-evolution-graph`
