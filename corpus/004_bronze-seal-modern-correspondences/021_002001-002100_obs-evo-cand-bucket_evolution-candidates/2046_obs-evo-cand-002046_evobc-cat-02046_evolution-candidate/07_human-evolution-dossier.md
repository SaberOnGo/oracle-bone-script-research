...
Project ID: `obs-evo-cand-002046`
...
- Project ID: `obs-evo-cand-002046`
- EVOBC category candidate ID: `evobc-evo-cat-02046`
- External category reference: `evobc-cat-02046`
- Source category ID: `02046`
- Source label for human review: `奞`
- Source codepoints: `U+595E`
...
- `obs-evo-cand-002046-route-category-staging`
...
- `obs-evo-cand-002046-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002046-route-evolution-graph`
