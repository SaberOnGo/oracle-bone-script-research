# obs-unk-003984 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/084_obs-unk-003984_h
  ust-obc-und-L-003984_oracle-character-candidate/03_visual-assets/001_asset
  -005577_hust-obc-und-L-003984_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3984/L_？_8438.jpg`
- asset id: `asset-005577`
...
- source class: `HUST-OBC/undeciphered/L/3984/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3984/L_？_8438.jpg`
- asset id: `asset-005577`
...
- English observation: Two upper forked traces rise above a broad enclosure with
  a central diagonal or crossing trace.
- 中文观察：两条上部短分叉痕迹位于较宽围合轮廓之上，围合内有中央斜向或交叉
  痕迹。
...
- Which source records identify obs-unk-003984 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003984？
