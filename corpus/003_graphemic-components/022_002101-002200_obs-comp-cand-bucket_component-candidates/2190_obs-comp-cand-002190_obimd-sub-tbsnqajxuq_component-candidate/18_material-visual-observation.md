# Material Visual Observation / obs-comp-cand-002190 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002190`
- External reference / 外部参照: `obimd-sub-tbsnqajxuq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019896_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tbh9vqe3ev/tbsnqajxuq/tbsnqajxuq.png`
- Checksum / 校验和:
  `1a07bcec38854b8ec5add2b760c09fae9ccd2633d0169ec1a547dfe4ad4b689b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.52%.
- Marked-pixel bounds: (96,30)–(153,213); span 58 × 184 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.52%。
- 痕迹范围：(96,30)–(153,213)；跨度58 × 184 px；痕迹矩形高于宽。
