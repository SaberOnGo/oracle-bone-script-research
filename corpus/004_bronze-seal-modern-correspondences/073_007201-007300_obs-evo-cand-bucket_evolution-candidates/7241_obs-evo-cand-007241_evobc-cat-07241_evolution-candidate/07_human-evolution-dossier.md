...
- External category reference: `evobc-cat-07241`
- Source category ID: `07241`
- Source label for human review: `芔`
...
- `obs-evo-cand-007241-route-category-staging`
...
- `obs-evo-cand-007241-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007241-route-evolution-graph`
