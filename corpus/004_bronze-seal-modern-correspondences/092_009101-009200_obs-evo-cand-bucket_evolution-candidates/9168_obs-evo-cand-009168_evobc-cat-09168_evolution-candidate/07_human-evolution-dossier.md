...
- Project ID: `obs-evo-cand-009168`
- EVOBC category candidate ID: `evobc-evo-cat-09168`
- External category reference: `evobc-cat-09168`
- Source category ID: `09168`
- Source label for human review: `郷`
- Source codepoints: `U+90F7`
...
- `obs-evo-cand-009168-route-category-staging`
...
- `obs-evo-cand-009168-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009168-route-evolution-graph`
