# obs-char-000485 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/485_obs-char-000485_hust-obc-cat-0550_orac
  le-character/03_visual-assets/001_asset-000490_hust-obc-cat-0550_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0550/G_0550_京津4364合29711無名組.png
  `
- asset id: `asset-000490`
...
- source category: `0550`
- validation class: `484`
- source image route: `HUST-OBC/deciphered/0550/G_0550_京津4364合29711無名組.png`
- asset id: `asset-000490`
...
- English observation: `A detached pointed top and two long side strokes
  surround a central rectangular loop divided by one vertical inner line.`
- 中文观察: `分离尖顶和两条长侧笔围绕中央矩形环形，环内由一条竖线分隔。`
...
- dataset label text: `㘜`
- dataset label codepoints: `U+361C`
...
- filename catalog route clues: `Heji-like filename clue: 合29711
  (G_0550_京津4364合29711無名組.png)`
...
- Which source records identify obs-char-000485 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000485？
