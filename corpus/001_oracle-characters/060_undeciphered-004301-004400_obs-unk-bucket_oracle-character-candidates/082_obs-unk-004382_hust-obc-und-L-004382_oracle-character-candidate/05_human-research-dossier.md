# obs-unk-004382 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/082_obs-unk-004382_h
  ust-obc-und-L-004382_oracle-character-candidate/03_visual-assets/001_asset
  -005975_hust-obc-und-L-004382_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4382/L_？_9738.jpg`
- asset id: `asset-005975`
...
- source class: `HUST-OBC/undeciphered/L/4382/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4382/L_？_9738.jpg`
- asset id: `asset-005975`
...
- English observation: `A long upper horizontal trace and two lower`
  `angular outlines are visible.`
- 中文观察: `上部有长横向痕迹，下部可见两处斜角轮廓。`
...
- Which source records identify obs-unk-004382 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004382？
