# Material Visual Observation / obs-comp-cand-002181 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002181`
- External reference / 外部参照: `obimd-sub-udp7306t31`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019887_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hk9f0607uj/udp7306t31/udp7306t31.png`
- Checksum / 校验和:
  `0db956c8f4f1520a9600c4dd158e7849543fdc4212dbcd10ad4d79e9fff220b8`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.84%.
- Marked-pixel bounds: (65,31)–(190,215); span 126 × 185 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.84%。
- 痕迹范围：(65,31)–(190,215)；跨度126 × 185 px；痕迹矩形高于宽。
