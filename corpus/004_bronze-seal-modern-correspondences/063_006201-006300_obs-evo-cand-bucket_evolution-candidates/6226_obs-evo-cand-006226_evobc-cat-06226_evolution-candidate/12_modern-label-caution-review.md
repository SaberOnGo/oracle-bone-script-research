# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006226
...
- EVOBC candidate category: `evobc-evo-cat-06226`.
- Source label for search only: `笏`.
- Source codepoints for search only: `U+7B0F`.
