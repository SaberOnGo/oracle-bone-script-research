# obs-comp-cand-002070 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002070`
- 首选外部 ID: `obimd-sub-yaysiuwhi0`
- OBIMD subcharacter UID: `yaysiuwhi0`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+FBE79; U+FBE7A; 另有 1 项
