# Material Visual Observation / obs-comp-cand-001463 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001463`
- External reference / 外部参照: `obimd-sub-2u8lblv476`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016040_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2u8lblv476/2u8lblv476/2u8lblv476.png`
- Checksum / 校验和:
  `947d3ebcb6cfa9e7504ae6a13d1ff3471cfe99b1038c76485b4e0a50cd769e7d`
...
- Marked-pixel bounds: (56,28)–(190,211); span 135 × 184 px; the marked
...
- 痕迹范围：(56,28)–(190,211)；跨度135 × 184 px；痕迹矩形高于宽。
