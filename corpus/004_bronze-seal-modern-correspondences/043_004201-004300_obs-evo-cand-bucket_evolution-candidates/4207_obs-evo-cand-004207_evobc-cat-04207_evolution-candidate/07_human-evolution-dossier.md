...
- External category reference: `evobc-cat-04207`
- Source category ID: `04207`
- Source label for human review: `槍`
...
- `obs-evo-cand-004207-route-category-staging`
...
- `obs-evo-cand-004207-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004207-route-evolution-graph`
