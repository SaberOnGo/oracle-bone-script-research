...
- External category reference: `evobc-cat-12393`
- Source category ID: `12393`
- Source label for human review: `𨘷`
- Source codepoints: `U+28637`
...
- `obs-evo-cand-012393-route-category-staging`
...
- `obs-evo-cand-012393-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012393-route-evolution-graph`
