# obs-char-000087 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000087`
- primary external id: `hust-obc-cat-0097`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/087_obs-char-000087_hust-obc-cat-0097_orac
  le-character/03_visual-assets/001_asset-000092_hust-obc-cat-0097_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0097/G_0097_乙3405合17085.png`
- asset id: `asset-000092`
...
- source category: `0097`
- validation class: `86`
- source image route: `HUST-OBC/deciphered/0097/G_0097_乙3405合17085.png`
- asset id: `asset-000092`
...
- English observation: `The narrow image has a curved upright left stroke,
  two short rightward branches, and a separate diagonal stroke at the lower
  left.`
- 中文观察: `狭长图像左侧有弧曲直立笔，向右分出两道短笔，左下另有一道斜笔。`
...
- dataset label text: `㑗`
- dataset label codepoints: `U+3457`
...
- filename catalog route clues: `Heji-like filename clue: 合17085
  (G_0097_乙3405合17085.png)`
...
- Which source records identify obs-char-000087 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000087？
