...
- External category reference: `evobc-cat-06199`
- Source category ID: `06199`
- Source label for human review: `竘`
- Source codepoints: `U+7AD8`
...
- `obs-evo-cand-006199-route-category-staging`
...
- `obs-evo-cand-006199-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006199-route-evolution-graph`
