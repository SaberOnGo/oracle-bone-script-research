...
- Project ID: `obs-evo-cand-000919`
- EVOBC category candidate ID: `evobc-evo-cat-00919`
- External category reference: `evobc-cat-00919`
- Source category ID: `00919`
- Source label for human review: `倉`
- Source codepoints: `U+5009`
...
- `obs-evo-cand-000919-route-category-staging`
...
- `obs-evo-cand-000919-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000919-route-evolution-graph`
