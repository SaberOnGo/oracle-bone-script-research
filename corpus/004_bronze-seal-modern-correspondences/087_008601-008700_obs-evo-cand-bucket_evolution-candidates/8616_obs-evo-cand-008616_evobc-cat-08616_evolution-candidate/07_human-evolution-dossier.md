...
- External category reference: `evobc-cat-08616`
- Source category ID: `08616`
- Source label for human review: `财`
- Source codepoints: `U+8D22`
...
- `obs-evo-cand-008616-route-category-staging`
...
- `obs-evo-cand-008616-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008616-route-evolution-graph`
