# obs-unk-005300 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005300`
- primary external id: `hust-obc-und-X-005300`
...
- local review image route: `corpus/001_oracle-characters/069_undeciphered-005
  201-005300_obs-unk-bucket_oracle-character-candidates/100_obs-unk-005300_h
  ust-obc-und-X-005300_oracle-character-candidate/03_visual-assets/001_asset
  -006893_hust-obc-und-X-005300_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/856/X_？_7821_1.png`
- asset id: `asset-006893`
...
- source class: `HUST-OBC/undeciphered/X/856/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/856/X_？_7821_1.png`
- asset id: `asset-006893`
...
- Which source records identify obs-unk-005300 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005300？
