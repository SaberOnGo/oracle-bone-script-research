# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008371
...
- EVOBC candidate category: `evobc-evo-cat-08371`.
- Source label for search only: `譯`.
- Source codepoints for search only: `U+8B6F`.
