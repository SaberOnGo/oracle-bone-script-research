# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-009586
...
- EVOBC candidate category: `evobc-evo-cat-09586`.
- Source label for search only: `银`.
- Source codepoints for search only: `U+94F6`.
