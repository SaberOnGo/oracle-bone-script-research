# Material Visual Observation / obs-comp-cand-000583 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000583`
- External reference / 外部参照: `obimd-sub-0rv771drzl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013111_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0rv771drzl/0rv771drzl/0rv771drzl.png`
- Checksum / 校验和:
  `fa0d3c6de6a49d4dbbb0d30958284586c80f22f7e4a05cfb117a8584255dd1df`
...
- Marked-pixel bounds: (55,45)–(194,204); span 140 × 160 px; the marked
...
- 痕迹范围：(55,45)–(194,204)；跨度140 × 160 px；痕迹矩形近方形。
