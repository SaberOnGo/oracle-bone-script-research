# obs-unk-004731 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004731`
- primary external id: `hust-obc-und-X-004731`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/031_obs-unk-004731_h
  ust-obc-und-X-004731_oracle-character-candidate/03_visual-assets/001_asset
  -006324_hust-obc-und-X-004731_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/287/X_？_7266_1.png`
- asset id: `asset-006324`
...
- source class: `HUST-OBC/undeciphered/X/287/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/287/X_？_7266_1.png`
- asset id: `asset-006324`
...
- English observation: `tall left form with separate right stroke`
- 中文观察: `带分离右侧笔画的左侧高形结构`
...
- Which source records identify obs-unk-004731 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004731？
