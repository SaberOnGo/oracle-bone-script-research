...
- Review log draft ID / 复核日志草稿 ID: `codepoint-crosswalk-review-log-draft-008`
- Codepoint review task ID / codepoint 复核任务 ID: `codepoint-crosswalk-review-008`
...
- Crosswalk candidate ID / 交叉候选 ID: `hust-obimd-evobc-xwalk-000780`
- Suggested oracle character ID / 建议甲骨单字 ID: `obs-char-000780`
- Promotion queue ID / 提升队列 ID: `hust-obc-obs-char-promo-000780`
...
- HUST external ref / HUST 外部引用: `hust-obc-cat-0884`
- HUST label codepoints / HUST 标签 codepoint: `U+376A`
- OBIMD main candidates / OBIMD 主字候选: `obimd-main-cand-003071`
- EVOBC category candidates / EVOBC 类别候选: `evobc-evo-cat-00074`
...
- `corpus/001_oracle-characters/008_000701-000800_obs-char-bucket_oracle-characters/780_obs-char-000780_hust-obc-cat-0884_oracle-character/01_candidate-character-packet.json`
...
- Route availability ID: `codepoint-route-availability-008`
...
- Review task ID: `codepoint-crosswalk-review-008`
- Crosswalk candidate ID: `hust-obimd-evobc-xwalk-000780`
- Suggested oracle character ID: `obs-char-000780`
- HUST candidate packet ID: `hust-obc-candidate-packet-000780`
...
- OBIMD row count: `1`
- OBIMD source UIDs: `x9f7dp1d6n`
- OBIMD review statuses: `obimd-main-cand-003071=reviewed_metadata_only`
- OBIMD rights statuses: `obimd-main-cand-003071=licensed_for_repository`
- EVOBC row count: `1`
- EVOBC source category IDs: `00074`
- EVOBC has bronze refs: `true`
- EVOBC has seal refs: `false`
- EVOBC review statuses: `evobc-evo-cat-00074=reviewed_metadata_only`
- EVOBC rights statuses: `evobc-evo-cat-00074=source_marked_risk_noted`
...
- Does `hust-obimd-evobc-xwalk-000780` remain unpromoted and undeciphered?
