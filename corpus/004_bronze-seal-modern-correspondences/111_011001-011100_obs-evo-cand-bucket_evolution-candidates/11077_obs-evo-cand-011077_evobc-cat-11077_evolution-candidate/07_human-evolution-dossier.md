...
- External category reference: `evobc-cat-11077`
- Source category ID: `11077`
- Source label for human review: `𡨿`
...
- `obs-evo-cand-011077-route-category-staging`
...
- `obs-evo-cand-011077-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011077-route-evolution-graph`
