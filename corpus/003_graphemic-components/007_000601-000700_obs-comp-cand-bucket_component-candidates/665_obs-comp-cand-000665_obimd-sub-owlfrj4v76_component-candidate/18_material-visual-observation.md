# Material Visual Observation / obs-comp-cand-000665 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000665`
- External reference / 外部参照: `obimd-sub-owlfrj4v76`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013228_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/owlfrj4v76/owlfrj4v76/owlfrj4v76.png`
- Checksum / 校验和:
  `bf4cce402483903adb1bcede2acb40f1a66fbf97d59852499d01b8e909155be0`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.70%.
- Marked-pixel bounds: (60,44)–(189,204); span 130 × 161 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.70%。
- 痕迹范围：(60,44)–(189,204)；跨度130 × 161 px；痕迹矩形高于宽。
