...
- External category reference: `evobc-cat-06503`
- Source category ID: `06503`
- Source label for human review: `絖`
- Source codepoints: `U+7D56`
...
- `obs-evo-cand-006503-route-category-staging`
...
- `obs-evo-cand-006503-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006503-route-evolution-graph`
