...
- Project ID: `obs-evo-cand-007858`
- EVOBC category candidate ID: `evobc-evo-cat-07858`
- External category reference: `evobc-cat-07858`
- Source category ID: `07858`
- Source label for human review: `蟥`
- Source codepoints: `U+87E5`
...
- `obs-evo-cand-007858-route-category-staging`
...
- `obs-evo-cand-007858-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007858-route-evolution-graph`
