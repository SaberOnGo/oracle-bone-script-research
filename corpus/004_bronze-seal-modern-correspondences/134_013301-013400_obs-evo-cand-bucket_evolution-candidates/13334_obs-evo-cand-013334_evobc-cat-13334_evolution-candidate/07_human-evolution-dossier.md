...
- External category reference: `evobc-cat-13334`
- Source category ID: `13334`
- Source label for human review: `𬢜`
- Source codepoints: `U+2C89C`
...
- `obs-evo-cand-013334-route-category-staging`
...
- `obs-evo-cand-013334-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013334-route-evolution-graph`
