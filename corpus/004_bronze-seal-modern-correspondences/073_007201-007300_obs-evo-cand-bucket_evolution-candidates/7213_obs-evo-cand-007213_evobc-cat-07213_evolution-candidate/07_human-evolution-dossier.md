...
- External category reference: `evobc-cat-07213`
- Source category ID: `07213`
- Source label for human review: `艮`
...
- `obs-evo-cand-007213-route-category-staging`
...
- `obs-evo-cand-007213-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007213-route-evolution-graph`
