# obs-evo-cand-001573 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-001573`
- EVOBC category candidate ID: `evobc-evo-cat-01573`
- External category ref: `evobc-cat-01573`
- Source label: `咸`
- Source codepoints: `U+54B8`
- Image reference count: `153`
- Era token counts: `BI:35;CS:1;OBC:85;SAC:7;SS:2;WSC:23`
- Source token counts: `Book:53;Web:100`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 85 image references
- era 1 / BI: 35 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 7 image references
- era 4 / WSC: 23 image references
- era 5 / CS: 1 image references
- source 0 / Web:1633: 2 image references
- source 1 / Web:105952;說文Web:58: 56 image references
