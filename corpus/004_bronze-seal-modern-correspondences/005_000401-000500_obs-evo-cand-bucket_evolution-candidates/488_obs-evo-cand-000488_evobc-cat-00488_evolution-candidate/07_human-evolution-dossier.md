...
- External category reference: `evobc-cat-00488`
- Source category ID: `00488`
- Source label for human review: `䣄`
...
- `obs-evo-cand-000488-route-category-staging`
...
- `obs-evo-cand-000488-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000488-route-evolution-graph`
