# Material Visual Observation / obs-comp-cand-002196 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002196`
- External reference / 外部参照: `obimd-sub-8p0clmx851`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019902_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8p0clmx851/8p0clmx851/8p0clmx851.png`
- Checksum / 校验和:
  `300966fad1c990bff8c6f9ac7d6e145aa91d8f0eb40887cd6d80927a5a5ad80c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.69%.
- Marked-pixel bounds: (93,37)–(156,208); span 64 × 172 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.69%。
- 痕迹范围：(93,37)–(156,208)；跨度64 × 172 px；痕迹矩形高于宽。
