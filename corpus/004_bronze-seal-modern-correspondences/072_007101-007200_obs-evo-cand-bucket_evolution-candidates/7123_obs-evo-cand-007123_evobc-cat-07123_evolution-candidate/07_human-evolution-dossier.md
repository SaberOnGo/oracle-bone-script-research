...
Project ID: `obs-evo-cand-007123`
...
- Project ID: `obs-evo-cand-007123`
- EVOBC category candidate ID: `evobc-evo-cat-07123`
- External category reference: `evobc-cat-07123`
- Source category ID: `07123`
- Source label for human review: `膕`
- Source codepoints: `U+8195`
...
- `obs-evo-cand-007123-route-category-staging`
...
- `obs-evo-cand-007123-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007123-route-evolution-graph`
