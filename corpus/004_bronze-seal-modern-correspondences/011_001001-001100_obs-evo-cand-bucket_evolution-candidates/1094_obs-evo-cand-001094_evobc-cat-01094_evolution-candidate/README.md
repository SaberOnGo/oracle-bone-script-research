# obs-evo-cand-001094 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-001094`
- EVOBC category candidate ID: `evobc-evo-cat-01094`
- External category ref: `evobc-cat-01094`
- Source label: `兮`
- Source codepoints: `U+516E`
- Image reference count: `137`
- Era token counts: `BI:25;CS:1;OBC:104;SS:2;WSC:5`
- Source token counts: `Book:41;Web:96`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 104 image references
