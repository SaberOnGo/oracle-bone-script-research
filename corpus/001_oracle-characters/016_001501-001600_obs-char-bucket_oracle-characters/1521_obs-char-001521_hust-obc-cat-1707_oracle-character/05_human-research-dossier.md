# obs-char-001521 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1521_obs-char-001521_hust-obc-cat-1707_ora
  cle-character/03_visual-assets/001_asset-001526_hust-obc-cat-1707_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1707/X_1707_1034_1.png`
- asset id: `asset-001526`
...
- source category: `1707`
- validation class: `1520`
- source image route: `HUST-OBC/deciphered/1707/X_1707_1034_1.png`
- asset id: `asset-001526`
...
- English observation: `Two adjacent forms show curved upper contours,
  separated horizontal marks, and long lower strokes.`
- 中文观察: `两个相邻形体有弧形上部轮廓、分离横笔和长下部笔画。`
...
- dataset label text: `㪡`
- dataset label codepoints: `U+3AA1`
...
- Which source records identify obs-char-001521 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001521？
