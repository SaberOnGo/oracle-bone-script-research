# Material Visual Observation / obs-comp-cand-002424 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002424`
- External reference / 外部参照: `obimd-sub-njhj6kig4b`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020495_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jpxofd3gmu/njhj6kig4b/njhj6kig4b.png`
- Checksum / 校验和:
  `927c4149cef98344aaabab5a9649d94a0a03fa1dd5e0d19a1ceb86490f7294f0`
...
- Marked-pixel bounds: (87,19)–(174,231); span 88 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.23%。
- 痕迹范围：(87,19)–(174,231)；跨度88 × 213 px；痕迹矩形高于宽。
