...
- External category reference: `evobc-cat-06415`
- Source category ID: `06415`
- Source label for human review: `糂`
...
- `obs-evo-cand-006415-route-category-staging`
...
- `obs-evo-cand-006415-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006415-route-evolution-graph`
