...
- Project ID: `obs-evo-cand-009665`
- EVOBC category candidate ID: `evobc-evo-cat-09665`
- External category reference: `evobc-cat-09665`
- Source category ID: `09665`
- Source label for human review: `闠`
- Source codepoints: `U+95E0`
...
- `obs-evo-cand-009665-route-category-staging`
...
- `obs-evo-cand-009665-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009665-route-evolution-graph`
