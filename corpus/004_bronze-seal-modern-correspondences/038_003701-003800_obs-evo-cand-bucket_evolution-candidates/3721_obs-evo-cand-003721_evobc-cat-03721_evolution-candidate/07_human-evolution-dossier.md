...
- External category reference: `evobc-cat-03721`
- Source category ID: `03721`
- Source label for human review: `昨`
- Source codepoints: `U+6628`
...
- `obs-evo-cand-003721-route-category-staging`
...
- `obs-evo-cand-003721-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003721-route-evolution-graph`
