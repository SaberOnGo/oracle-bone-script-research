# obs-unk-006166 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006166`
- primary external id: `hust-obc-und-X-006166`
...
- local review image route: `corpus/001_oracle-characters/078_undeciphered-006
  101-006200_obs-unk-bucket_oracle-character-candidates/066_obs-unk-006166_h
  ust-obc-und-X-006166_oracle-character-candidate/03_visual-assets/001_asset
  -007758_hust-obc-und-X-006166_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1722/X_？_4088_1.png`
- asset id: `asset-007758`
...
- source class: `HUST-OBC/undeciphered/X/1722/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1722/X_？_4088_1.png`
- asset id: `asset-007758`
...
- Which source records identify obs-unk-006166 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006166？
