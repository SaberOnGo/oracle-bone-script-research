# Material Visual Observation / obs-comp-cand-002050 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002050`
- External reference / 外部参照: `obimd-sub-gek2hvsfx5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019437_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4nm99xtfab/gek2hvsfx5/gek2hvsfx5.png`
- Checksum / 校验和:
  `1f21de29652ecae7c207cf995efd538068c15407ba20c4f824b300181f0c1a44`
...
- Marked-pixel bounds: (45,28)–(216,222); span 172 × 195 px; the marked
...
- 痕迹范围：(45,28)–(216,222)；跨度172 × 195 px；痕迹矩形近方形。
