...
- Source page section: `Period I Group 12` /
  `第 I 期第 12 组`
- Source section key: `period-i-group-12`
- Section declared count: `8`
- Section observed row count: `8`
...
- Yingguo / 英国所藏: `y943` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `224` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000159`
