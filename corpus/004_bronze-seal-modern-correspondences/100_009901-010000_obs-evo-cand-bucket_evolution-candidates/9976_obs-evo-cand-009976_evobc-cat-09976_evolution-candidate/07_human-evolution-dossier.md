...
- External category reference: `evobc-cat-09976`
- Source category ID: `09976`
- Source label for human review: `頍`
...
- `obs-evo-cand-009976-route-category-staging`
...
- `obs-evo-cand-009976-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009976-route-evolution-graph`
