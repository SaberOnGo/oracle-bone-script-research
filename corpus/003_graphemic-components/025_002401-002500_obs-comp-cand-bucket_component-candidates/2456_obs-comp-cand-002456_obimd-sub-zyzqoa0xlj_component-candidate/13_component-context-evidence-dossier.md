# obs-comp-cand-002456 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002456`
- 首选外部 ID: `obimd-sub-zyzqoa0xlj`
- OBIMD subcharacter UID: `zyzqoa0xlj`
...
- glyph-codepoint 数: `7`
- codepoint 示例: U+7950;U+FDFCC; U+FDFCD; 另有 5 项
