# Material Visual Observation / obs-comp-cand-000217 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000217`
- External reference / 外部参照: `obimd-sub-5osdmihofa`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011862_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8uh1kfvlhb/5osdmihofa/5osdmihofa.png`
- Checksum / 校验和:
  `8993e093c3c53239947f40fb4e000fb16ad1f45d8c53bf4520b1c0b3b2085faf`
...
- Marked-pixel bounds: (82,26)–(167,223); span 86 × 198 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.99%。
- 痕迹范围：(82,26)–(167,223)；跨度86 × 198 px；痕迹矩形高于宽。
