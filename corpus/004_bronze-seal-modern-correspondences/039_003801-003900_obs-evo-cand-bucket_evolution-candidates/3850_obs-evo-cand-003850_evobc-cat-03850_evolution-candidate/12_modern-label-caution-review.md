# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003850
...
- EVOBC candidate category: `evobc-evo-cat-03850`.
- Source label for search only: `本`.
- Source codepoints for search only: `U+672C`.
