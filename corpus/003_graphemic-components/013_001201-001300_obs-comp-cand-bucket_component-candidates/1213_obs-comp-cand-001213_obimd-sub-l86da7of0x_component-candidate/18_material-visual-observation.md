# Material Visual Observation / obs-comp-cand-001213 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001213`
- External reference / 外部参照: `obimd-sub-l86da7of0x`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015444_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lsh0azwee5/l86da7of0x/l86da7of0x.png`
- Checksum / 校验和:
  `70604fa2dbdce736cda4eb3b331573d8675ae28c8327c3be2e3542ff67274ef2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.62%.
- Marked-pixel bounds: (58,47)–(191,203); span 134 × 157 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.62%。
- 痕迹范围：(58,47)–(191,203)；跨度134 × 157 px；痕迹矩形近方形。
