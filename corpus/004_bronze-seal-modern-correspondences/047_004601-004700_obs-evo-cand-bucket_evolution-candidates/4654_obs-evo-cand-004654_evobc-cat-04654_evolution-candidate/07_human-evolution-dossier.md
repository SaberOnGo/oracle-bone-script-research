...
- External category reference: `evobc-cat-04654`
- Source category ID: `04654`
- Source label for human review: `浗`
...
- `obs-evo-cand-004654-route-category-staging`
...
- `obs-evo-cand-004654-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004654-route-evolution-graph`
