...
- External category reference: `evobc-cat-05809`
- Source category ID: `05809`
- Source label for human review: `眴`
- Source codepoints: `U+7734`
...
- `obs-evo-cand-005809-route-category-staging`
...
- `obs-evo-cand-005809-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005809-route-evolution-graph`
