...
- Project ID: `obs-evo-cand-002590`
- EVOBC category candidate ID: `evobc-evo-cat-02590`
- External category reference: `evobc-cat-02590`
- Source category ID: `02590`
- Source label for human review: `嶏`
- Source codepoints: `U+5D8F`
...
- `obs-evo-cand-002590-route-category-staging`
...
- `obs-evo-cand-002590-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002590-route-evolution-graph`
