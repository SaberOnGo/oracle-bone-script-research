...
- Project ID: `obs-evo-cand-004657`
- EVOBC category candidate ID: `evobc-evo-cat-04657`
- External category reference: `evobc-cat-04657`
- Source category ID: `04657`
- Source label for human review: `浝`
- Source codepoints: `U+6D5D`
...
- `obs-evo-cand-004657-route-category-staging`
...
- `obs-evo-cand-004657-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004657-route-evolution-graph`
