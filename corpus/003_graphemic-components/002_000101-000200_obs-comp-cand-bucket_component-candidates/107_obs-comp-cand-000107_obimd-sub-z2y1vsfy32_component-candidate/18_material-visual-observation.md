# Material Visual Observation / obs-comp-cand-000107 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000107`
- External reference / 外部参照: `obimd-sub-z2y1vsfy32`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011519_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/z2y1vsfy32/z2y1vsfy32/z2y1vsfy32.png`
- Checksum / 校验和:
  `19c887fd8ab5f1f3e728a6306c0e4a80cef005e7b60b56e6847f728b0e67d6a6`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.89%.
- Marked-pixel bounds: (60,18)–(189,235); span 130 × 218 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.89%。
- 痕迹范围：(60,18)–(189,235)；跨度130 × 218 px；痕迹矩形高于宽。
