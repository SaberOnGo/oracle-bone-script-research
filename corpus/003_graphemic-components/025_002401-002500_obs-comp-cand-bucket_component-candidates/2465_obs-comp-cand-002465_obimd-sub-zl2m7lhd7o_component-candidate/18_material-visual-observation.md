# Material Visual Observation / obs-comp-cand-002465 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002465`
- External reference / 外部参照: `obimd-sub-zl2m7lhd7o`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020650_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qw5vx1k0rw/zl2m7lhd7o/zl2m7lhd7o.png`
- Checksum / 校验和:
  `de3bf94808286987a8d1d2873c57eff738e41045a332c3455c1e7ebfceba6c66`
...
- Marked-pixel bounds: (86,17)–(158,234); span 73 × 218 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.73%。
- 痕迹范围：(86,17)–(158,234)；跨度73 × 218 px；痕迹矩形高于宽。
