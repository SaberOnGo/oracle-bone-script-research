# obs-char-000363 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000363`
- primary external id: `hust-obc-cat-0413`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/363_obs-char-000363_hust-obc-cat-0413_orac
  le-character/03_visual-assets/001_asset-000368_hust-obc-cat-0413_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0413/G_0413_乙1661反合9258反.png`
- asset id: `asset-000368`
...
- source category: `0413`
- validation class: `362`
- source image route: `HUST-OBC/deciphered/0413/G_0413_乙1661反合9258反.png`
- asset id: `asset-000368`
...
- English observation: `Two forked upper strokes rise over a small
  rectangular enclosure with two descending legs.`
- 中文观察: `两个分叉上行笔画位于小型矩形闭合轮廓之上，轮廓下有两条下行支脚。`
...
- dataset label text: `㖓`
- dataset label codepoints: `U+3593`
...
- filename catalog route clues: `Heji-like filename clue: 合9258
  (G_0413_乙1661反合9258反.png)`
...
- Which source records identify obs-char-000363 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000363？
