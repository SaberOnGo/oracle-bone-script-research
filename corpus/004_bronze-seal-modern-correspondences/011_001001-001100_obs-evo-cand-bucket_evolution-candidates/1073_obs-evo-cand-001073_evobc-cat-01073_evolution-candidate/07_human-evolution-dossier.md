...
- External category reference: `evobc-cat-01073`
- Source category ID: `01073`
- Source label for human review: `光`
- Source codepoints: `U+5149`
...
- `obs-evo-cand-001073-route-category-staging`
...
- `obs-evo-cand-001073-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001073-route-evolution-graph`
