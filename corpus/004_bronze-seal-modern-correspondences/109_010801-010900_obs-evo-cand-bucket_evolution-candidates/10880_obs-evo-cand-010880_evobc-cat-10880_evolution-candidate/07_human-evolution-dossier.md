...
- External category reference: `evobc-cat-10880`
- Source category ID: `10880`
- Source label for human review: `𠦌`
- Source codepoints: `U+2098C`
...
- `obs-evo-cand-010880-route-category-staging`
...
- `obs-evo-cand-010880-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010880-route-evolution-graph`
