...
Project ID: `obs-evo-cand-010123`
...
- Project ID: `obs-evo-cand-010123`
- EVOBC category candidate ID: `evobc-evo-cat-10123`
- External category reference: `evobc-cat-10123`
- Source category ID: `10123`
- Source label for human review: `餶`
- Source codepoints: `U+9936`
...
- `obs-evo-cand-010123-route-category-staging`
...
- `obs-evo-cand-010123-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010123-route-evolution-graph`
