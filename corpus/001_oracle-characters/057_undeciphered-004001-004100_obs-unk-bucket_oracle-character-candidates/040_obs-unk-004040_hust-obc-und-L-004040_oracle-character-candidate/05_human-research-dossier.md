# obs-unk-004040 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004040`
- primary external id: `hust-obc-und-L-004040`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/040_obs-unk-004040_h
  ust-obc-und-L-004040_oracle-character-candidate/03_visual-assets/001_asset
  -005633_hust-obc-und-L-004040_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4040/L_？_8634.jpg`
- asset id: `asset-005633`
...
- source class: `HUST-OBC/undeciphered/L/4040/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4040/L_？_8634.jpg`
- asset id: `asset-005633`
...
- English observation: A long slanting contour runs down the left side. Near
  the lower center is a compact angular area with a dark internal mark, while
  a separate curved edge rises on the right. The crop is small.
- 中文观察：左侧有长而斜向下行的轮廓；下部中央有紧凑折角区域，内部较深，右侧另有
    弧形边缘上行。图像较小。
...
- Which source records identify obs-unk-004040 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004040？
