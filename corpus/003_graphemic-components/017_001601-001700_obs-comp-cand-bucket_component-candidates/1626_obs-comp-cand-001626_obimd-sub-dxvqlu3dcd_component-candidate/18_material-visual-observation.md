# Material Visual Observation / obs-comp-cand-001626 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001626`
- External reference / 外部参照: `obimd-sub-dxvqlu3dcd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017302_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dxvqlu3dcd/dxvqlu3dcd/dxvqlu3dcd.png`
- Checksum / 校验和:
  `14f54f052956e544ab82b5ab094b9dfe98cd619a4bb26a7bc5f1c36038762c5a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.47%.
- Marked-pixel bounds: (80,22)–(184,226); span 105 × 205 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.47%。
- 痕迹范围：(80,22)–(184,226)；跨度105 × 205 px；痕迹矩形高于宽。
