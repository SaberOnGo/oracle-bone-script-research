...
Project ID: `obs-evo-cand-011645`
...
- Project ID: `obs-evo-cand-011645`
- EVOBC category candidate ID: `evobc-evo-cat-11645`
- External category reference: `evobc-cat-11645`
- Source category ID: `11645`
- Source label for human review: `𤧧`
- Source codepoints: `U+249E7`
...
- `obs-evo-cand-011645-route-category-staging`
...
- `obs-evo-cand-011645-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011645-route-evolution-graph`
