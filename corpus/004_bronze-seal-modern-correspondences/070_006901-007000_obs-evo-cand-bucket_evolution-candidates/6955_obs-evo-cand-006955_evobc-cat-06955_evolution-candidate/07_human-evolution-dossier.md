...
Project ID: `obs-evo-cand-006955`
...
- Project ID: `obs-evo-cand-006955`
- EVOBC category candidate ID: `evobc-evo-cat-06955`
- External category reference: `evobc-cat-06955`
- Source category ID: `06955`
- Source label for human review: `聮`
- Source codepoints: `U+806E`
...
- `obs-evo-cand-006955-route-category-staging`
...
- `obs-evo-cand-006955-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006955-route-evolution-graph`
