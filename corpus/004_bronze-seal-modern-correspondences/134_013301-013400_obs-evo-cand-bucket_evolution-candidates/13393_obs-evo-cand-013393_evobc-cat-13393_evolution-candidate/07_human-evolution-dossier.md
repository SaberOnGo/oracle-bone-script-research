...
- External category reference: `evobc-cat-13393`
- Source category ID: `13393`
- Source label for human review: `𬪴`
- Source codepoints: `U+2CAB4`
...
- `obs-evo-cand-013393-route-category-staging`
...
- `obs-evo-cand-013393-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013393-route-evolution-graph`
