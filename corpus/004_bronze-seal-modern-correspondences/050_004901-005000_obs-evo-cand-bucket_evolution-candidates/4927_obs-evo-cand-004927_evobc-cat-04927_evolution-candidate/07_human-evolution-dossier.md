...
- External category reference: `evobc-cat-04927`
- Source category ID: `04927`
- Source label for human review: `澇`
...
- `obs-evo-cand-004927-route-category-staging`
...
- `obs-evo-cand-004927-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004927-route-evolution-graph`
