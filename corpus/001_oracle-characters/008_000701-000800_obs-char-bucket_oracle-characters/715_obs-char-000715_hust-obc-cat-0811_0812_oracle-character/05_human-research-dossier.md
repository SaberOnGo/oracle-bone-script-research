# obs-char-000715 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000715`
- primary external id: `hust-obc-cat-0811_0812`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/715_obs-char-000715_hust-obc-cat-0811_0812
  _oracle-character/03_visual-assets/001_asset-000720_hust-obc-cat-0811_0812
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0811_0812/0811/G_0811_甲骨文0.png`
- asset id: `asset-000720`
...
- source category: `0811_0812`
- validation class: `714`
- source image route: `HUST-OBC/deciphered/0811_0812/0811/G_0811_甲骨文0.png`
- asset id: `asset-000720`
...
- English observation: `Two detached bold pointed forms stand side by side,
  each with a hollow lower triangular opening; the taller right form has an
  extra short side projection.`
- 中文观察: `两个分离粗重尖形并列，各有中空下三角空隙；较高右形另带短侧突。`
...
- dataset label text: `㜡㜢`
- dataset label codepoints: `U+3721;U+3722`
...
- graph edge count: `2`
- codepoint routes: `U+3721;U+3722`
...
- Which source records identify obs-char-000715 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000715？
