...
- External category reference: `evobc-cat-11335`
- Source category ID: `11335`
- Source label for human review: `𢼶`
...
- `obs-evo-cand-011335-route-category-staging`
...
- `obs-evo-cand-011335-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011335-route-evolution-graph`
