...
- External category reference: `evobc-cat-05924`
- Source category ID: `05924`
- Source label for human review: `碗`
...
- `obs-evo-cand-005924-route-category-staging`
...
- `obs-evo-cand-005924-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005924-route-evolution-graph`
