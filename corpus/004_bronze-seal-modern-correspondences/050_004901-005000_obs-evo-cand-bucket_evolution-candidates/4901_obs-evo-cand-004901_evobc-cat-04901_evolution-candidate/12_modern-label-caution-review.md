# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004901
...
- EVOBC candidate category: `evobc-evo-cat-04901`.
- Source label for search only: `潜`.
- Source codepoints for search only: `U+6F5C`.
