...
- Project ID: `obs-evo-cand-005027`
- EVOBC category candidate ID: `evobc-evo-cat-05027`
- External category reference: `evobc-cat-05027`
- Source category ID: `05027`
- Source label for human review: `灵`
- Source codepoints: `U+7075`
...
- `obs-evo-cand-005027-route-category-staging`
...
- `obs-evo-cand-005027-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005027-route-evolution-graph`
