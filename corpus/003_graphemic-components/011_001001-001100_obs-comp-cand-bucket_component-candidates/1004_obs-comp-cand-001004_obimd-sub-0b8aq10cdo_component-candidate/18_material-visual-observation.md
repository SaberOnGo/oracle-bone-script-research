# Material Visual Observation / obs-comp-cand-001004 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001004`
- External reference / 外部参照: `obimd-sub-0b8aq10cdo`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014467_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7wrt6jfhfq/0b8aq10cdo/0b8aq10cdo.png`
- Checksum / 校验和:
  `e2010654cd84920149293f3510950d721acec7b84589a155ff7a5bcb6547be54`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.78%.
- Marked-pixel bounds: (83,18)–(181,230); span 99 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.78%。
- 痕迹范围：(83,18)–(181,230)；跨度99 × 213 px；痕迹矩形高于宽。
