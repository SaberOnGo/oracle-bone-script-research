...
- External category reference: `evobc-cat-08913`
- Source category ID: `08913`
- Source label for human review: `辤`
...
- `obs-evo-cand-008913-route-category-staging`
...
- `obs-evo-cand-008913-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008913-route-evolution-graph`
