# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000992
...
| --- | --- | --- | --- |
| `obimd-glyph-link-014382` | 󵨧 | `U+F5A27` | `reviewed_metadata_only` |
| `obimd-glyph-link-014383` | 󵨨 | `U+F5A28` | `reviewed_metadata_only` |
