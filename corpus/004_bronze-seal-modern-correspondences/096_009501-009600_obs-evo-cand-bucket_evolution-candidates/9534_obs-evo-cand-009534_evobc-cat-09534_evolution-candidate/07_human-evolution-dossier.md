...
- External category reference: `evobc-cat-09534`
- Source category ID: `09534`
- Source label for human review: `鐱`
...
- `obs-evo-cand-009534-route-category-staging`
...
- `obs-evo-cand-009534-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009534-route-evolution-graph`
