...
- External category reference: `evobc-cat-04803`
- Source category ID: `04803`
- Source label for human review: `溉`
- Source codepoints: `U+6E89`
...
- `obs-evo-cand-004803-route-category-staging`
...
- `obs-evo-cand-004803-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004803-route-evolution-graph`
