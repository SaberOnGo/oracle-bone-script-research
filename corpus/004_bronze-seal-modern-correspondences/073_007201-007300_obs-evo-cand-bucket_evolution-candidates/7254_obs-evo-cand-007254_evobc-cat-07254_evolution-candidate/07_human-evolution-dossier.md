...
Project ID: `obs-evo-cand-007254`
...
- Project ID: `obs-evo-cand-007254`
- EVOBC category candidate ID: `evobc-evo-cat-07254`
- External category reference: `evobc-cat-07254`
- Source category ID: `07254`
- Source label for human review: `芩`
- Source codepoints: `U+82A9`
...
- `obs-evo-cand-007254-route-category-staging`
...
- `obs-evo-cand-007254-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007254-route-evolution-graph`
