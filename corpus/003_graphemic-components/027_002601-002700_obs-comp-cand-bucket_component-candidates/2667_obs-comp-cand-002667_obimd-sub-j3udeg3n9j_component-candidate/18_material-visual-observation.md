# Material Visual Observation / obs-comp-cand-002667 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002667`
- External reference / 外部参照: `obimd-sub-j3udeg3n9j`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021243_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rtosgwch6q/j3udeg3n9j/j3udeg3n9j.png`
- Checksum / 校验和:
  `b1ada04faa8694b5fa4ff878214ec6cabf7da0f2fd594b42133c7dbb2601972a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.96%.
- Marked-pixel bounds: (98,17)–(151,231); span 54 × 215 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.96%。
- 痕迹范围：(98,17)–(151,231)；跨度54 × 215 px；痕迹矩形高于宽。
