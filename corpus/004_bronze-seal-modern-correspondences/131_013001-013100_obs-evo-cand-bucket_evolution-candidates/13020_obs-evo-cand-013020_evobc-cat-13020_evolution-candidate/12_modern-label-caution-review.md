# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013020
...
- EVOBC candidate category: `evobc-evo-cat-13020`.
- Source label for search only: `𫦡`.
- Source codepoints for search only: `U+2B9A1`.
