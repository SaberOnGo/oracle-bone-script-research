# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006645
...
- EVOBC candidate category: `evobc-evo-cat-06645`.
- Source label for search only: `縭`.
- Source codepoints for search only: `U+7E2D`.
