# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006121
...
- EVOBC candidate category: `evobc-evo-cat-06121`.
- Source label for search only: `穀`.
- Source codepoints for search only: `U+7A40`.
