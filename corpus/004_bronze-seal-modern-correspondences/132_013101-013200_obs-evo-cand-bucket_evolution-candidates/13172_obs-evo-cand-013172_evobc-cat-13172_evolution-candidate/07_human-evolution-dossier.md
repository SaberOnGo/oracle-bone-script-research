...
- External category reference: `evobc-cat-13172`
- Source category ID: `13172`
- Source label for human review: `𫾼`
...
- `obs-evo-cand-013172-route-category-staging`
...
- `obs-evo-cand-013172-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013172-route-evolution-graph`
