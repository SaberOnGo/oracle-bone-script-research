...
Project ID: `obs-evo-cand-011688`
...
- Project ID: `obs-evo-cand-011688`
- EVOBC category candidate ID: `evobc-evo-cat-11688`
- External category reference: `evobc-cat-11688`
- Source category ID: `11688`
- Source label for human review: `𤵾`
- Source codepoints: `U+24D7E`
...
- `obs-evo-cand-011688-route-category-staging`
...
- `obs-evo-cand-011688-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011688-route-evolution-graph`
