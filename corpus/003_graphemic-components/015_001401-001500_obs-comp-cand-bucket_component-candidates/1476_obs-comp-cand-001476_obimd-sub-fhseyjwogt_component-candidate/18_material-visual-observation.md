# Material Visual Observation / obs-comp-cand-001476 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001476`
- External reference / 外部参照: `obimd-sub-fhseyjwogt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016053_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fhseyjwogt/fhseyjwogt/fhseyjwogt.png`
- Checksum / 校验和:
  `eef392fc8fa55f8a2c82d37ab4563bdd185633728a2194352acd01f8ab3e4d0d`
...
- Marked-pixel bounds: (70,40)–(179,203); span 110 × 164 px; the marked
...
- 痕迹范围：(70,40)–(179,203)；跨度110 × 164 px；痕迹矩形高于宽。
