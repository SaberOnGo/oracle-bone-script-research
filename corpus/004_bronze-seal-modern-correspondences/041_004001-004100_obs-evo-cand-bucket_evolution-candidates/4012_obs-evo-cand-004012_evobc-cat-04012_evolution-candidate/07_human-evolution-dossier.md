...
- External category reference: `evobc-cat-04012`
- Source category ID: `04012`
- Source label for human review: `格`
...
- `obs-evo-cand-004012-route-category-staging`
...
- `obs-evo-cand-004012-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004012-route-evolution-graph`
