# obs-unk-004976 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/076_obs-unk-004976_h
  ust-obc-und-X-004976_oracle-character-candidate/03_visual-assets/001_asset
  -006569_hust-obc-und-X-004976_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/532/X_？_7512_1.png`
- asset id: `asset-006569`
...
- A dense branched left form and a separate split right form are visible.
...
- source class: `HUST-OBC/undeciphered/X/532/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/532/X_？_7512_1.png`
- asset id: `asset-006569`
...
- Which source records identify obs-unk-004976 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004976？
