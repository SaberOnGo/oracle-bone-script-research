# obs-unk-004445 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004445`
- primary external id: `hust-obc-und-X-004445`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/045_obs-unk-004445_h
  ust-obc-und-X-004445_oracle-character-candidate/03_visual-assets/001_asset
  -006038_hust-obc-und-X-004445_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1/X_？_7091_1.png`
- asset id: `asset-006038`
...
- source class: `HUST-OBC/undeciphered/X/1/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1/X_？_7091_1.png`
- asset id: `asset-006038`
...
- English observation: `A tall upper stem joins broad middle branches`
  `and a lower loop.`
- 中文观察: `高的上部竖痕连接中部宽分支和下部环状轮廓。`
...
- Which source records identify obs-unk-004445 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004445？
