# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006690
...
- EVOBC candidate category: `evobc-evo-cat-06690`.
- Source label for search only: `繭`.
- Source codepoints for search only: `U+7E6D`.
