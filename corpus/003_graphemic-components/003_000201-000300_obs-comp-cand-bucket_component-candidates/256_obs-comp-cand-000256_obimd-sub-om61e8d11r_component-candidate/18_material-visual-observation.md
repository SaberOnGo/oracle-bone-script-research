# Material Visual Observation / obs-comp-cand-000256 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000256`
- External reference / 外部参照: `obimd-sub-om61e8d11r`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011902_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/om61e8d11r/om61e8d11r/om61e8d11r.png`
- Checksum / 校验和:
  `533d6572679661c78329116f91f45b239a93d4259b4245996dc8860387b8f685`
...
- Marked-pixel bounds: (80,20)–(169,229); span 90 × 210 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.63%。
- 痕迹范围：(80,20)–(169,229)；跨度90 × 210 px；痕迹矩形高于宽。
