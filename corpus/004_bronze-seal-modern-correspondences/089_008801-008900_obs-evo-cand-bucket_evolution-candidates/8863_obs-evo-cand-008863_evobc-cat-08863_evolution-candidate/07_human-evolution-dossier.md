...
- External category reference: `evobc-cat-08863`
- Source category ID: `08863`
- Source label for human review: `轃`
- Source codepoints: `U+8F43`
...
- `obs-evo-cand-008863-route-category-staging`
...
- `obs-evo-cand-008863-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008863-route-evolution-graph`
