# Material Visual Observation / obs-comp-cand-001911 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001911`
- External reference / 外部参照: `obimd-sub-0bwtsvgzvy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018321_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0bwtsvgzvy/0bwtsvgzvy/0bwtsvgzvy.png`
- Checksum / 校验和:
  `121b41cc296fb94a766a0cc4ddfe9cfe6c0470056fcdfafa5fba0ebb12f6b9a3`
...
- Marked-pixel bounds: (51,27)–(212,225); span 162 × 199 px; the marked
...
- 痕迹范围：(51,27)–(212,225)；跨度162 × 199 px；痕迹矩形高于宽。
