# obs-evo-cand-000344 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-000344`
- EVOBC category candidate ID: `evobc-evo-cat-00344`
- External category ref: `evobc-cat-00344`
- Source label: `䍜`
- Source codepoints: `U+435C`
- Image reference count: `91`
- Era token counts: `OBC:91`
- Source token counts: `Book:7;Web:84`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 91 image references
- source 0 / Web:1633: 4 image references
- source 6 / Web:30645: 80 image references
