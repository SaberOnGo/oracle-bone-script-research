...
- External category reference: `evobc-cat-04991`
- Source category ID: `04991`
- Source label: `瀛`
...
- `obs-evo-cand-004991-route-category-staging`
...
- `obs-evo-cand-004991-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-004991-route-evolution-graph`
