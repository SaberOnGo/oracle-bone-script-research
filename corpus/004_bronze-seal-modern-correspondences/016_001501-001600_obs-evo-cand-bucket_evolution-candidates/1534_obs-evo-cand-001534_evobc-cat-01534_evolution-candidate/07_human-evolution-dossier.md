...
Project ID: `obs-evo-cand-001534`
...
- Project ID: `obs-evo-cand-001534`
- EVOBC category candidate ID: `evobc-evo-cat-01534`
- External category reference: `evobc-cat-01534`
- Source category ID: `01534`
- Source label for human review: `呕`
- Source codepoints: `U+5455`
...
- `obs-evo-cand-001534-route-category-staging`
...
- `obs-evo-cand-001534-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001534-route-evolution-graph`
