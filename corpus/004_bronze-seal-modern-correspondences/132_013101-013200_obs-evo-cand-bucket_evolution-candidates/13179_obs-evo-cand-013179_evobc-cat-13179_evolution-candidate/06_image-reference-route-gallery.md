...
- `obs-evo-cand-013179-route-category-staging`
...
- `obs-evo-cand-013179-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013179-route-evolution-graph`
