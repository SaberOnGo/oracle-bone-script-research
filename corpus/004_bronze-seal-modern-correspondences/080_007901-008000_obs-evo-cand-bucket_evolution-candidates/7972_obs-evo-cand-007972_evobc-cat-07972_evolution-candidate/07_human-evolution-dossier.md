...
- External category reference: `evobc-cat-07972`
- Source category ID: `07972`
- Source label for human review: `裔`
...
- `obs-evo-cand-007972-route-category-staging`
...
- `obs-evo-cand-007972-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007972-route-evolution-graph`
