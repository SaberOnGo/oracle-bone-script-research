# obs-char-000146 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000146`
- primary external id: `hust-obc-cat-0161_0162`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/146_obs-char-000146_hust-obc-cat-0161_0162
  _oracle-character/03_visual-assets/001_asset-000151_hust-obc-cat-0161_0162
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0161_0162/0161/G_0161_乙2641合333
  3賓組.png`
- asset id: `asset-000151`
...
- source category: `0161_0162`
- validation class: `145`
- source image route: `HUST-OBC/deciphered/0161_0162/0161/G_0161_乙2641合3333賓組.
  png`
- asset id: `asset-000151`
...
- English observation: `The narrow image has a short upper horizontal mark,
  two long descending curved strokes, and a small forked mark near the
  bottom.`
- 中文观察: `狭长图像上方有短横笔，两道长弯曲笔向下延伸，底部附近有小型分叉痕迹。`
...
- dataset label text: `㒗㒘`
- dataset label codepoints: `U+3497;U+3498`
...
- graph edge count: `2`
- codepoint routes: `U+3497;U+3498`
...
- filename catalog route clues: `Heji-like filename clue: 合3333
  (G_0161_乙2641合3333賓組.png)`
...
- Which source records identify obs-char-000146 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000146？
