...
- External category reference: `evobc-cat-09646`
- Source category ID: `09646`
- Source label for human review: `闃`
- Source codepoints: `U+95C3`
...
- `obs-evo-cand-009646-route-category-staging`
...
- `obs-evo-cand-009646-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009646-route-evolution-graph`
