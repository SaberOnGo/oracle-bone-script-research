...
- External category reference: `evobc-cat-03818`
- Source category ID: `03818`
- Source label for human review: `曼`
- Source codepoints: `U+66FC`
...
- `obs-evo-cand-003818-route-category-staging`
...
- `obs-evo-cand-003818-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003818-route-evolution-graph`
