...
- External category reference: `evobc-cat-12003`
- Source category ID: `12003`
- Source label for human review: `𦎇`
- Source codepoints: `U+26387`
...
- `obs-evo-cand-012003-route-category-staging`
...
- `obs-evo-cand-012003-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012003-route-evolution-graph`
