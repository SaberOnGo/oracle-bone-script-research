...
- External category reference: `evobc-cat-01574`
- Source category ID: `01574`
- Source label for human review: `咺`
- Source codepoints: `U+54BA`
...
- `obs-evo-cand-001574-route-category-staging`
...
- `obs-evo-cand-001574-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001574-route-evolution-graph`
