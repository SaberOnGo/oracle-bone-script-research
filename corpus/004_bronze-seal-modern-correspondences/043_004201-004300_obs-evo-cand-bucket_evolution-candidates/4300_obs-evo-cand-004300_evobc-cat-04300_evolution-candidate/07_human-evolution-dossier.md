...
- External category reference: `evobc-cat-04300`
- Source category ID: `04300`
- Source label for human review: `檹`
- Source codepoints: `U+6AB9`
...
- `obs-evo-cand-004300-route-category-staging`
...
- `obs-evo-cand-004300-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004300-route-evolution-graph`
