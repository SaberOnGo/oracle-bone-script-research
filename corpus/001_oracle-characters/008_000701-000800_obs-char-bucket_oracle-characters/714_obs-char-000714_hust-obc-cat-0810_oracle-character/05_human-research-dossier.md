# obs-char-000714 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000714`
- primary external id: `hust-obc-cat-0810`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/714_obs-char-000714_hust-obc-cat-0810_orac
  le-character/03_visual-assets/001_asset-000719_hust-obc-cat-0810_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0810/G_0810_前6.54.1合1012賓組.png`
- asset id: `asset-000719`
...
- source category: `0810`
- validation class: `713`
- source image route: `HUST-OBC/deciphered/0810/G_0810_前6.54.1合1012賓組.png`
- asset id: `asset-000719`
...
- English observation: `Two long slightly curving uprights rise separately
  from a rounded lower rectangular grid divided by one vertical and one
  horizontal inner bar.`
- 中文观察: `两条长而微弯的直立笔分别从圆角下部矩形格升起，格内有一竖一横两条分隔栏。`
...
- dataset label text: `㜠`
- dataset label codepoints: `U+3720`
...
- filename catalog route clues: `Heji-like filename clue: 合1012
...
- Which source records identify obs-char-000714 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000714？
