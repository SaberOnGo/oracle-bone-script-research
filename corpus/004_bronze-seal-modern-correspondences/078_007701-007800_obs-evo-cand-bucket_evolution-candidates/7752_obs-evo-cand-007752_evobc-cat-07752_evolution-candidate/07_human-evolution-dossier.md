...
Project ID: `obs-evo-cand-007752`
...
- Project ID: `obs-evo-cand-007752`
- EVOBC category candidate ID: `evobc-evo-cat-07752`
- External category reference: `evobc-cat-07752`
- Source category ID: `07752`
- Source label for human review: `蛟`
- Source codepoints: `U+86DF`
...
- `obs-evo-cand-007752-route-category-staging`
...
- `obs-evo-cand-007752-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007752-route-evolution-graph`
