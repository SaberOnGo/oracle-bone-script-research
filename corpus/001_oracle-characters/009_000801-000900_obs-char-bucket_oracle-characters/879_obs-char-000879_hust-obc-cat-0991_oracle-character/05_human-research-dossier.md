# obs-char-000879 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000879`
- primary external id: `hust-obc-cat-0991`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/879_obs-char-000879_hust-obc-cat-0991_orac
  le-character/03_visual-assets/001_asset-000884_hust-obc-cat-0991_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0991/G_0991_乙282(甲).png`
- asset id: `asset-000884`
...
- source category: `0991`
- validation class: `878`
- source image route: `HUST-OBC/deciphered/0991/G_0991_乙282(甲).png`
- asset id: `asset-000884`
...
- English observation: `Two long outer curves flank a central rounded
  enclosure with a horizontal upper stroke; the lower parts converge toward
  the enclosure.`
- 中文观察: `两条长外弯曲笔分列中央圆弧闭合轮廓两旁，轮廓上方有横笔；下部笔画向轮廓收拢。`
...
- dataset label text: `㟕`
- dataset label codepoints: `U+37D5`
...
- Which source records identify obs-char-000879 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000879？
