...
- External category reference: `evobc-cat-02093`
- Source category ID: `02093`
- Source label for human review: `妦`
- Source codepoints: `U+59A6`
...
- `obs-evo-cand-002093-route-category-staging`
...
- `obs-evo-cand-002093-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002093-route-evolution-graph`
