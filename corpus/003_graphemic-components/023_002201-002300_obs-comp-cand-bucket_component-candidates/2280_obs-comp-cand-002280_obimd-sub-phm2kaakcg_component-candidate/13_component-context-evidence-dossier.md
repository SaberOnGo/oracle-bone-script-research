# obs-comp-cand-002280 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002280`
- 首选外部 ID: `obimd-sub-phm2kaakcg`
- OBIMD subcharacter UID: `phm2kaakcg`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+8FA5;U+FD1A4; U+FD1A5; 另有 2 项
