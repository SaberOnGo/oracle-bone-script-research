...
- External category reference: `evobc-cat-11839`
- Source category ID: `11839`
...
- `obs-evo-cand-011839-route-category-staging`
...
- `obs-evo-cand-011839-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011839-route-evolution-graph`
