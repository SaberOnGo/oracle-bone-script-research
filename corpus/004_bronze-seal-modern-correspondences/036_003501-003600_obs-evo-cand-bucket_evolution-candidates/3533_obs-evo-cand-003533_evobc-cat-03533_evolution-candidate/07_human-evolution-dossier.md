...
- External category reference: `evobc-cat-03533`
- Source category ID: `03533`
- Source label for human review: `擬`
- Source codepoints: `U+64EC`
...
- `obs-evo-cand-003533-route-category-staging`
...
- `obs-evo-cand-003533-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003533-route-evolution-graph`
