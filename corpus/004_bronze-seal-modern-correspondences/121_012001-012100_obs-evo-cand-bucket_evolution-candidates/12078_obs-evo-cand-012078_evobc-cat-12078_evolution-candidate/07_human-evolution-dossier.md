...
- External category reference: `evobc-cat-12078`
- Source category ID: `12078`
- Source label for human review: `𦨱`
...
- `obs-evo-cand-012078-route-category-staging`
...
- `obs-evo-cand-012078-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012078-route-evolution-graph`
