...
- External category reference: `evobc-cat-04088`
- Source category ID: `04088`
- Source label for human review: `棈`
- Source codepoints: `U+68C8`
...
- `obs-evo-cand-004088-route-category-staging`
...
- `obs-evo-cand-004088-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004088-route-evolution-graph`
