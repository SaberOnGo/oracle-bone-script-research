...
Project ID: `obs-evo-cand-009723`
...
- Project ID: `obs-evo-cand-009723`
- EVOBC category candidate ID: `evobc-evo-cat-09723`
- External category reference: `evobc-cat-09723`
- Source category ID: `09723`
- Source label for human review: `陊`
- Source codepoints: `U+964A`
...
- `obs-evo-cand-009723-route-category-staging`
...
- `obs-evo-cand-009723-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009723-route-evolution-graph`
