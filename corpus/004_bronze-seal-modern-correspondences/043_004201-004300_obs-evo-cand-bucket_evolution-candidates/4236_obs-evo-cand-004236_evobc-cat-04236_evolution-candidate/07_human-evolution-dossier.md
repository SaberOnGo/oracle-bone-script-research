...
- External category reference: `evobc-cat-04236`
- Source category ID: `04236`
- Source label: `樔`
...
- `obs-evo-cand-004236-route-category-staging`
...
- `obs-evo-cand-004236-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004236-route-evolution-graph`
