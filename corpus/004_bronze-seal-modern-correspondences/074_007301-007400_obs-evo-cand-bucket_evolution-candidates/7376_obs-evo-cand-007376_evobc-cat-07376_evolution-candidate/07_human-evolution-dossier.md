...
- External category reference: `evobc-cat-07376`
- Source category ID: `07376`
- Source label: `莒`
...
- `obs-evo-cand-007376-route-category-staging`
...
- `obs-evo-cand-007376-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007376-route-evolution-graph`
