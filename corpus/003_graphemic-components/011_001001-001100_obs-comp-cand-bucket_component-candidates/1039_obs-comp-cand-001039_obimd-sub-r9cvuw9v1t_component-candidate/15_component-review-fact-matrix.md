# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001039
...
| Glyph or codepoint route / 字形或码位路线 | 58 OBIMD route rows; examples U+898B;U+F5E5E; U+F5E5F; 另有 56 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 58 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
