# obs-char-000238 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000238`
- primary external id: `hust-obc-cat-0265`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/238_obs-char-000238_hust-obc-cat-0265_orac
  le-character/03_visual-assets/001_asset-000243_hust-obc-cat-0265_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0265/L_0265_3413.jpg`
- asset id: `asset-000243`
...
- source category: `0265`
- validation class: `237`
- source image route: `HUST-OBC/deciphered/0265/L_0265_3413.jpg`
- asset id: `asset-000243`
...
- English observation: `The low-contrast gray image shows a curved outer
  stroke around a thin central vertical form with short diagonal branches.`
- 中文观察: `低对比度灰度图像有环抱中央的弯曲外笔，中部细竖形带有短斜向分支。`
...
- dataset label text: `㓿`
- dataset label codepoints: `U+34FF`
...
- Which source records identify obs-char-000238 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000238？
