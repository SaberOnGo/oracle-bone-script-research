...
- External category reference: `evobc-cat-09699`
- Source category ID: `09699`
- Source label for human review: `阫`
...
- `obs-evo-cand-009699-route-category-staging`
...
- `obs-evo-cand-009699-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009699-route-evolution-graph`
