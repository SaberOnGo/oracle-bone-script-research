...
- External category reference: `evobc-cat-11234`
- Source category ID: `11234`
- Source label for human review: `𢚚`
- Source codepoints: `U+2269A`
...
- `obs-evo-cand-011234-route-category-staging`
...
- `obs-evo-cand-011234-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011234-route-evolution-graph`
