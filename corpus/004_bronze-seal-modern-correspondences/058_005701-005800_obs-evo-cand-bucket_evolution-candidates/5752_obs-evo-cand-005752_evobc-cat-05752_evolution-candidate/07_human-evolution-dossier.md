...
- External category reference: `evobc-cat-05752`
- Source category ID: `05752`
- Source label for human review: `盖`
...
- `obs-evo-cand-005752-route-category-staging`
...
- `obs-evo-cand-005752-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005752-route-evolution-graph`
