...
- External category reference: `evobc-cat-02586`
- Source category ID: `02586`
- Source label for human review: `嵬`
...
- `obs-evo-cand-002586-route-category-staging`
...
- `obs-evo-cand-002586-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002586-route-evolution-graph`
