...
- External category reference: `evobc-cat-05765`
- Source category ID: `05765`
- Source label for human review: `盧`
- Source codepoints: `U+76E7`
...
- `obs-evo-cand-005765-route-category-staging`
...
- `obs-evo-cand-005765-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005765-route-evolution-graph`
