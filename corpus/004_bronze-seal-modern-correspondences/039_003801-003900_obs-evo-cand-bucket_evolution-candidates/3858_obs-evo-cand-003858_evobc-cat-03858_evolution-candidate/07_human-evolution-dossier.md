...
Project ID: `obs-evo-cand-003858`
...
- Project ID: `obs-evo-cand-003858`
- EVOBC category candidate ID: `evobc-evo-cat-03858`
- External category reference: `evobc-cat-03858`
- Source category ID: `03858`
- Source label for human review: `朹`
- Source codepoints: `U+6739`
...
- `obs-evo-cand-003858-route-category-staging`
...
- `obs-evo-cand-003858-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003858-route-evolution-graph`
