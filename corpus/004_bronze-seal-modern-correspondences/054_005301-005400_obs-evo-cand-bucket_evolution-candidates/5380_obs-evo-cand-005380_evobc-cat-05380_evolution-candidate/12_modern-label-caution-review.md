# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-005380
...
- EVOBC candidate category: `evobc-evo-cat-05380`.
- Source label for search only: `珛`.
- Source codepoints for search only: `U+73DB`.
