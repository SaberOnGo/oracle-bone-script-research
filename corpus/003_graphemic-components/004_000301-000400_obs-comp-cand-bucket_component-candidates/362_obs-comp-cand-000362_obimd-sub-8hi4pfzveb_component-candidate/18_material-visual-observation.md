# Material Visual Observation / obs-comp-cand-000362 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000362`
- External reference / 外部参照: `obimd-sub-8hi4pfzveb`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012285_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h9hoshfwwj/8hi4pfzveb/8hi4pfzveb.png`
- Checksum / 校验和:
  `eae4249ae3958106679148892f18fcda7d02d9cc5a76b3ee7703e333e807b127`
...
- Marked-pixel bounds: (79,18)–(170,230); span 92 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.43%。
- 痕迹范围：(79,18)–(170,230)；跨度92 × 213 px；痕迹矩形高于宽。
