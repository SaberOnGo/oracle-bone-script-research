...
- External category reference: `evobc-cat-08021`
- Source category ID: `08021`
- Source label for human review: `褸`
- Source codepoints: `U+8938`
...
- `obs-evo-cand-008021-route-category-staging`
...
- `obs-evo-cand-008021-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008021-route-evolution-graph`
