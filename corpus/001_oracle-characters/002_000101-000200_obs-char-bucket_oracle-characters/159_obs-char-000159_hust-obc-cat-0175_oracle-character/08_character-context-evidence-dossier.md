...
- Project ID / 项目 ID: `obs-char-000159`
- Primary external ID / 首选外部 ID: `hust-obc-cat-0175`
...
- Source image / 来源图: `G_0175_合565(甲).png`
- Image / 图像: `001_asset-000164_hust-obc-cat-0175_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合565
  (G_0175_合565(甲).png)`
...
- Source label text / 来源标签文字: `㒥`
- Source label codepoint / 来源标签 codepoint: `U+34A5`
