...
Project ID: `obs-evo-cand-003590`
...
- Project ID: `obs-evo-cand-003590`
- EVOBC category candidate ID: `evobc-evo-cat-03590`
- External category reference: `evobc-cat-03590`
- Source category ID: `03590`
- Source label for human review: `敜`
- Source codepoints: `U+655C`
...
- `obs-evo-cand-003590-route-category-staging`
...
- `obs-evo-cand-003590-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003590-route-evolution-graph`
