...
Project ID: `obs-evo-cand-003728`
...
- Project ID: `obs-evo-cand-003728`
- EVOBC category candidate ID: `evobc-evo-cat-03728`
- External category reference: `evobc-cat-03728`
- Source category ID: `03728`
- Source label for human review: `昴`
- Source codepoints: `U+6634`
...
- `obs-evo-cand-003728-route-category-staging`
...
- `obs-evo-cand-003728-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003728-route-evolution-graph`
