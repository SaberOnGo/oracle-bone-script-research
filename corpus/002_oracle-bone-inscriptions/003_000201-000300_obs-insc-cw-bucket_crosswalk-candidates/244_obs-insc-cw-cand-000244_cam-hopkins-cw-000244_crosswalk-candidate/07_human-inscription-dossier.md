...
- Yingguo / 英国所藏: `y1590` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `167` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `633` in source row; primary catalog entry pending
