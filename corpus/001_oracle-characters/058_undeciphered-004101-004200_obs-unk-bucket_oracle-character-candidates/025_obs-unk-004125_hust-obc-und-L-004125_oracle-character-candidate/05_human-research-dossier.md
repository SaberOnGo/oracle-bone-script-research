# obs-unk-004125 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004125`
- primary external id: `hust-obc-und-L-004125`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/025_obs-unk-004125_h
  ust-obc-und-L-004125_oracle-character-candidate/03_visual-assets/001_asset
  -005718_hust-obc-und-L-004125_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4125/L_？_8891.jpg`
- asset id: `asset-005718`
...
- source class: `HUST-OBC/undeciphered/L/4125/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4125/L_？_8891.jpg`
- asset id: `asset-005718`
...
- English observation: Two curved strokes flank a narrow central trace;
  a short trace descends to a compact lower mark.
- 中文观察：两条弯曲笔痕分列在中央痕迹两侧；短痕迹向下延至下部痕迹。
...
- Which source records identify obs-unk-004125 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004125？
