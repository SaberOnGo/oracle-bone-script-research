# obs-unk-004668 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/068_obs-unk-004668_h
  ust-obc-und-X-004668_oracle-character-candidate/03_visual-assets/001_asset
  -006261_hust-obc-und-X-004668_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/224/X_？_7105_1.png`
- asset id: `asset-006261`
...
- source class: `HUST-OBC/undeciphered/X/224/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/224/X_？_7105_1.png`
- asset id: `asset-006261`
...
- English observation: `upper contour with right opening and downstroke`
- 中文观察: `带右侧开口和下行笔画的上部轮廓`
...
- Which source records identify obs-unk-004668 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004668？
