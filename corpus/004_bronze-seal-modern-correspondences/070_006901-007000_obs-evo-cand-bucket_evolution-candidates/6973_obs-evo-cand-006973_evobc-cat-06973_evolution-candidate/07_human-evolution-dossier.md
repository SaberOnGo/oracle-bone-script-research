...
Project ID: `obs-evo-cand-006973`
...
- Project ID: `obs-evo-cand-006973`
- EVOBC category candidate ID: `evobc-evo-cat-06973`
- External category reference: `evobc-cat-06973`
- Source category ID: `06973`
- Source label for human review: `肆`
- Source codepoints: `U+8086`
...
- `obs-evo-cand-006973-route-category-staging`
...
- `obs-evo-cand-006973-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006973-route-evolution-graph`
