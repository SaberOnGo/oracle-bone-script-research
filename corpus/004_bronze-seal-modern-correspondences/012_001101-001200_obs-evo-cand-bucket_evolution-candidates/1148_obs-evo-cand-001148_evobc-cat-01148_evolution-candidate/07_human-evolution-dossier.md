...
- External category reference: `evobc-cat-01148`
- Source category ID: `01148`
- Source label for human review: `凊`
...
- `obs-evo-cand-001148-route-category-staging`
...
- `obs-evo-cand-001148-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001148-route-evolution-graph`
