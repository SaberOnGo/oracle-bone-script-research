...
- Project ID: `obs-evo-cand-003441`
- EVOBC category candidate ID: `evobc-evo-cat-03441`
- External category reference: `evobc-cat-03441`
- Source category ID: `03441`
- Source label for human review: `揱`
- Source codepoints: `U+63F1`
...
- `obs-evo-cand-003441-route-category-staging`
...
- `obs-evo-cand-003441-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003441-route-evolution-graph`
