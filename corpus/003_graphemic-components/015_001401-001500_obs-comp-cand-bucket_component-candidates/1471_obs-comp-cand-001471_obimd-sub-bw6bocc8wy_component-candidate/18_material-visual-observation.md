# Material Visual Observation / obs-comp-cand-001471 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001471`
- External reference / 外部参照: `obimd-sub-bw6bocc8wy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016048_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fu6caa5q2a/bw6bocc8wy/bw6bocc8wy.png`
- Checksum / 校验和:
  `808e9a7a26d71ec4342710302504c981785183975ae56a7e231cab0e264ba2cb`
...
- Marked-pixel bounds: (82,41)–(167,202); span 86 × 162 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.52%。
- 痕迹范围：(82,41)–(167,202)；跨度86 × 162 px；痕迹矩形高于宽。
