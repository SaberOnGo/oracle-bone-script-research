...
Project ID: `obs-evo-cand-000313`
...
- Project ID: `obs-evo-cand-000313`
- EVOBC category candidate ID: `evobc-evo-cat-00313`
- External category reference: `evobc-cat-00313`
- Source category ID: `00313`
- Source label for human review: `䊮`
- Source codepoints: `U+42AE`
...
- `obs-evo-cand-000313-route-category-staging`
...
- `obs-evo-cand-000313-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000313-route-evolution-graph`
