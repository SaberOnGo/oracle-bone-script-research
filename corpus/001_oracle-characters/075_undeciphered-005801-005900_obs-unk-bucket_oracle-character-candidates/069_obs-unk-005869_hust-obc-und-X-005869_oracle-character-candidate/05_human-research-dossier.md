# obs-unk-005869 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005869`
- primary external id: `hust-obc-und-X-005869`
...
- local review image route: `corpus/001_oracle-characters/075_undeciphered-005
  801-005900_obs-unk-bucket_oracle-character-candidates/069_obs-unk-005869_h
  ust-obc-und-X-005869_oracle-character-candidate/03_visual-assets/001_asset
  -007461_hust-obc-und-X-005869_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1425/X_？_2205_1.png`
- asset id: `asset-007461`
...
- source class: `HUST-OBC/undeciphered/X/1425/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1425/X_？_2205_1.png`
- asset id: `asset-007461`
...
- Which source records identify obs-unk-005869 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005869？
