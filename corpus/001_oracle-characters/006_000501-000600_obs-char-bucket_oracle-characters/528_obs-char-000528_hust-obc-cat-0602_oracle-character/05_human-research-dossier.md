# obs-char-000528 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000528`
- primary external id: `hust-obc-cat-0602`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/528_obs-char-000528_hust-obc-cat-0602_orac
  le-character/03_visual-assets/001_asset-000533_hust-obc-cat-0602_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0602/G_0602_乙1948合21840.png`
- asset id: `asset-000533`
...
- source category: `0602`
- validation class: `527`
- source image route: `HUST-OBC/deciphered/0602/G_0602_乙1948合21840.png`
- asset id: `asset-000533`
...
- English observation: `Four near-vertical wavering strokes stand side by
  side; short cross-strokes join the left pair, and two tiny detached dots
  lie between the right strokes.`
- 中文观察: `四条近竖向波折笔并列，短横连接左侧一对，右侧笔画之间有两个微小分离点。`
...
- dataset label text: `㙐`
- dataset label codepoints: `U+3650`
...
- filename catalog route clues: `Heji-like filename clue: 合21840
  (G_0602_乙1948合21840.png)`
...
- Which source records identify obs-char-000528 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000528？
