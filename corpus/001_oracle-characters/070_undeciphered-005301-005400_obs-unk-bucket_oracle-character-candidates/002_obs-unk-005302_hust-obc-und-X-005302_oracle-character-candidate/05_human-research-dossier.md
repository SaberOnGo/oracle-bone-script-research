# obs-unk-005302 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005302`
- primary external id: `hust-obc-und-X-005302`
...
- local review image route: `corpus/001_oracle-characters/070_undeciphered-005
  301-005400_obs-unk-bucket_oracle-character-candidates/002_obs-unk-005302_h
  ust-obc-und-X-005302_oracle-character-candidate/03_visual-assets/001_asset
  -006895_hust-obc-und-X-005302_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/858/X_？_7825_1.png`
- asset id: `asset-006895`
...
- source class: `HUST-OBC/undeciphered/X/858/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/858/X_？_7825_1.png`
- asset id: `asset-006895`
...
- Which source records identify obs-unk-005302 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005302？
