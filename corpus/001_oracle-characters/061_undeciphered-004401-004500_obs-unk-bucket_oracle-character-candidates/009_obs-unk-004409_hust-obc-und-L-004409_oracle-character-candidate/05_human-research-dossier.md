# obs-unk-004409 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/009_obs-unk-004409_h
  ust-obc-und-L-004409_oracle-character-candidate/03_visual-assets/001_asset
  -006002_hust-obc-und-L-004409_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4409/L_？_9864.jpg`
- asset id: `asset-006002`
...
- source class: `HUST-OBC/undeciphered/L/4409/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4409/L_？_9864.jpg`
- asset id: `asset-006002`
...
- English observation: `An open left outline sits beside a long right trace`
  `with small outward bends.`
- 中文观察: `左侧开放轮廓旁有右侧长痕，长痕带有多处外转折。`
...
- Which source records identify obs-unk-004409 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004409？
