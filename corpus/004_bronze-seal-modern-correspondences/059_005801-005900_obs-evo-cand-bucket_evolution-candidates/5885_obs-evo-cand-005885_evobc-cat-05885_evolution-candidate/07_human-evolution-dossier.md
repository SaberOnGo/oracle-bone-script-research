...
- Project ID: `obs-evo-cand-005885`
- EVOBC category candidate ID: `evobc-evo-cat-05885`
- External category reference: `evobc-cat-05885`
- Source category ID: `05885`
- Source label for human review: `短`
- Source codepoints: `U+77ED`
...
- `obs-evo-cand-005885-route-category-staging`
...
- `obs-evo-cand-005885-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005885-route-evolution-graph`
