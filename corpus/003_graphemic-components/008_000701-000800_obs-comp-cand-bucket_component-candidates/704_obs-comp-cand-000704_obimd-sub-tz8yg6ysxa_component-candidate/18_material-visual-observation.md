# Material Visual Observation / obs-comp-cand-000704 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000704`
- External reference / 外部参照: `obimd-sub-tz8yg6ysxa`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013344_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/i3lktxnh52/tz8yg6ysxa/1rz4vfy6ew.png`
- Checksum / 校验和:
  `f2f609c4578017ba6fcd9d67d731d405f8d0dc3c925e381675a205276bc95a35`
...
- Marked-pixel bounds: (88,33)–(161,217); span 74 × 185 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.82%。
- 痕迹范围：(88,33)–(161,217)；跨度74 × 185 px；痕迹矩形高于宽。
