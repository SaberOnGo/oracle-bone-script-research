# obs-char-000069 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000069`
- primary external id: `hust-obc-cat-0079`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/069_obs-char-000069_hust-obc-cat-0079_orac
  le-character/03_visual-assets/001_asset-000074_hust-obc-cat-0079_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0079/G_0079_乙837合16462.png`
- asset id: `asset-000074`
...
- source category: `0079`
- validation class: `68`
- source image route: `HUST-OBC/deciphered/0079/G_0079_乙837合16462.png`
- asset id: `asset-000074`
...
- English observation: `The tiny gray image shows a curved left cluster with
  short inner marks and a separate angular mark on the right.`
- 中文观察: `微小灰度图像左侧为弯曲形体并含短内部痕迹，右侧另有折角痕迹。`
...
- dataset label text: `㑅`
- dataset label codepoints: `U+3445`
...
- filename catalog route clues: `Heji-like filename clue: 合16462
  (G_0079_乙837合16462.png)`
...
- Which source records identify obs-char-000069 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000069？
