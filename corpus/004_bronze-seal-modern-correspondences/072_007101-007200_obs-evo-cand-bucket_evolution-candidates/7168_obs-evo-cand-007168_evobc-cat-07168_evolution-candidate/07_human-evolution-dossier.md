...
- External category reference: `evobc-cat-07168`
- Source category ID: `07168`
- Source label for human review: `臭`
...
- `obs-evo-cand-007168-route-category-staging`
...
- `obs-evo-cand-007168-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007168-route-evolution-graph`
