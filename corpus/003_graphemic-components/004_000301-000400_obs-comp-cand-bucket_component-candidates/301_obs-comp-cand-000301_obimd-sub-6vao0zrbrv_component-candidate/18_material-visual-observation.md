# Material Visual Observation / obs-comp-cand-000301 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000301`
- External reference / 外部参照: `obimd-sub-6vao0zrbrv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012067_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6vao0zrbrv/6vao0zrbrv/6vao0zrbrv.png`
- Checksum / 校验和:
  `81c6eab2c0f005e8f748e9d60be9ee47c152cedd6036191704e07608533b7459`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.11%.
- Marked-pixel bounds: (65,27)–(184,219); span 120 × 193 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.11%。
- 痕迹范围：(65,27)–(184,219)；跨度120 × 193 px；痕迹矩形高于宽。
