# obs-char-001375 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001375`
- primary external id: `hust-obc-cat-1536`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1375_obs-char-001375_hust-obc-cat-1536_ora
  cle-character/03_visual-assets/001_asset-001380_hust-obc-cat-1536_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1536/G_1536_前2.8.3(甲).png`
- asset id: `asset-001380`
...
- source category: `1536`
- validation class: `1374`
- source image route: `HUST-OBC/deciphered/1536/G_1536_前2.8.3(甲).png`
- asset id: `asset-001380`
...
- English observation: `A dark stacked left cluster is paired with rounded
  right forms and a long stem.`
- 中文观察: `深色叠置左侧笔画群与圆拱右侧形体及长竖干相邻。`
...
- dataset label text: `㧶`
- dataset label codepoints: `U+39F6`
...
- Which source records identify obs-char-001375 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001375？
