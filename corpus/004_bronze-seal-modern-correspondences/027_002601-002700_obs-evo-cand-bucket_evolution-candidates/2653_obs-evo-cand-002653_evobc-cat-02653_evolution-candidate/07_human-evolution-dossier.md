...
Project ID: `obs-evo-cand-002653`
...
- Project ID: `obs-evo-cand-002653`
- EVOBC category candidate ID: `evobc-evo-cat-02653`
- External category reference: `evobc-cat-02653`
- Source category ID: `02653`
- Source label for human review: `帝`
- Source codepoints: `U+5E1D`
- Image reference count in source metadata: `189`
...
- `obs-evo-cand-002653-route-category-staging`
...
- `obs-evo-cand-002653-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002653-route-evolution-graph`
