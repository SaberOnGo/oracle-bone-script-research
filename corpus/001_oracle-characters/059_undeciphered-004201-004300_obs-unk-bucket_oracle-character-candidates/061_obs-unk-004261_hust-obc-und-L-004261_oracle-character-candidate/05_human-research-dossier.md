# obs-unk-004261 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/061_obs-unk-004261_h
  ust-obc-und-L-004261_oracle-character-candidate/03_visual-assets/001_asset
  -005854_hust-obc-und-L-004261_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4261/L_？_9389.jpg`
- asset id: `asset-005854`
...
- source class: `HUST-OBC/undeciphered/L/4261/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4261/L_？_9389.jpg`
- asset id: `asset-005854`
...
- English observation: `Upper-left curve, central marks, right trace visible.`
- 中文观察: `左上弯曲痕迹、中央痕迹和右侧长痕迹可见。`
...
- Which source records identify obs-unk-004261 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004261？
