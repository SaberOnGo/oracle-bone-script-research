...
- External category reference: `evobc-cat-06035`
- Source category ID: `06035`
- Source label for human review: `禫`
- Source codepoints: `U+79AB`
...
- `obs-evo-cand-006035-route-category-staging`
...
- `obs-evo-cand-006035-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006035-route-evolution-graph`
