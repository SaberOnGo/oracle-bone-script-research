...
- External category reference: `evobc-cat-04312`
- Source category ID: `04312`
- Source label for human review: `櫓`
- Source codepoints: `U+6AD3`
...
- `obs-evo-cand-004312-route-category-staging`
...
- `obs-evo-cand-004312-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004312-route-evolution-graph`
