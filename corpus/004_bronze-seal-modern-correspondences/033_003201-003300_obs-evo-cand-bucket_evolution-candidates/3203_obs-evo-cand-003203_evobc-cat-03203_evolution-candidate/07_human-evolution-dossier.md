...
- External category reference: `evobc-cat-03203`
- Source category ID: `03203`
...
- `obs-evo-cand-003203-route-category-staging`
...
- `obs-evo-cand-003203-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003203-route-evolution-graph`
