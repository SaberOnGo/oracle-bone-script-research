...
- `obs-evo-cand-011834-route-category-staging`
...
- `obs-evo-cand-011834-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011834-route-evolution-graph`
