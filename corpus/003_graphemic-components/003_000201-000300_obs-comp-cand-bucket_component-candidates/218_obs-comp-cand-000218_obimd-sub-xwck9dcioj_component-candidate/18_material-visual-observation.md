# Material Visual Observation / obs-comp-cand-000218 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000218`
- External reference / 外部参照: `obimd-sub-xwck9dcioj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011863_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xwck9dcioj/xwck9dcioj/xwck9dcioj.png`
- Checksum / 校验和:
  `6c9c3f0d158732aff19c15e76f3f2f84444444f8839e2fa3936d3d96939e651b`
...
- Marked-pixel bounds: (82,11)–(165,241); span 84 × 231 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.48%。
- 痕迹范围：(82,11)–(165,241)；跨度84 × 231 px；痕迹矩形高于宽。
