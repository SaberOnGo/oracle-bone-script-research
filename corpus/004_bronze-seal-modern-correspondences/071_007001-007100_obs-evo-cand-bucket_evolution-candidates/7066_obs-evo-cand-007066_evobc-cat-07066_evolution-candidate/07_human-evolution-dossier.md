...
- Project ID: `obs-evo-cand-007066`
- EVOBC category candidate ID: `evobc-evo-cat-07066`
- External category reference: `evobc-cat-07066`
- Source category ID: `07066`
- Source label for human review: `脜`
- Source codepoints: `U+811C`
...
- `obs-evo-cand-007066-route-category-staging`
...
- `obs-evo-cand-007066-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007066-route-evolution-graph`
