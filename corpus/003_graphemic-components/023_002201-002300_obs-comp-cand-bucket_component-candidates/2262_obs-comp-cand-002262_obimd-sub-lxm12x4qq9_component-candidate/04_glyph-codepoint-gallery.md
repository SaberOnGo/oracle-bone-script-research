# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002262
...
| --- | --- | --- | --- |
| `obimd-glyph-link-034944` | 󼿖 | `U+FCFD6` | `reviewed_metadata_only` |
| `obimd-glyph-link-034945` | 󼿗 | `U+FCFD7` | `reviewed_metadata_only` |
| `obimd-glyph-link-034946` | 󼿘 | `U+FCFD8` | `reviewed_metadata_only` |
