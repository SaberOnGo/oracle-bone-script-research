# Material Visual Observation / obs-comp-cand-000484 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000484`
- External reference / 外部参照: `obimd-sub-r4asdq2rc4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012720_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/x0wt5y5bs2/r4asdq2rc4/r4asdq2rc4.png`
- Checksum / 校验和:
  `d5991fd4b55c0825ec740f148ec1111fe342673c8e783c0056f393f86654b48a`
...
- Marked-pixel bounds: (77,22)–(172,230); span 96 × 209 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.49%。
- 痕迹范围：(77,22)–(172,230)；跨度96 × 209 px；痕迹矩形高于宽。
