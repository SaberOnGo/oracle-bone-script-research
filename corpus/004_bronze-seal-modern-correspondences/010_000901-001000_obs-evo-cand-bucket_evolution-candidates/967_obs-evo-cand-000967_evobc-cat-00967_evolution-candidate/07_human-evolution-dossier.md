...
- External category reference: `evobc-cat-00967`
- Source category ID: `00967`
- Source label for human review: `偲`
- Source codepoints: `U+5072`
...
- `obs-evo-cand-000967-route-category-staging`
...
- `obs-evo-cand-000967-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000967-route-evolution-graph`
