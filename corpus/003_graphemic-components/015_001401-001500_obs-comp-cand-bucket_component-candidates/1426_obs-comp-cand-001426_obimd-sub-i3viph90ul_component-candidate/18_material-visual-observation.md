# Material Visual Observation / obs-comp-cand-001426 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001426`
- External reference / 外部参照: `obimd-sub-i3viph90ul`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016003_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/n9qxfnupux/i3viph90ul/i3viph90ul.png`
- Checksum / 校验和:
  `3a7dec1217f377d2c23071b25a868df0c70e2c23dfbb8cd24195d5d883848a37`
...
- Marked-pixel bounds: (83,33)–(166,213); span 84 × 181 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.31%。
- 痕迹范围：(83,33)–(166,213)；跨度84 × 181 px；痕迹矩形高于宽。
