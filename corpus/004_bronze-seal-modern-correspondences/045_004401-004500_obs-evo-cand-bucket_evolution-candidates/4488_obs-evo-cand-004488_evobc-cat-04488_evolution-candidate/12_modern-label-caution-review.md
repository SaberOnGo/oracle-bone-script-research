# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004488
...
- EVOBC candidate category: `evobc-evo-cat-04488`.
- Source label for search only: `汊`.
- Source codepoints for search only: `U+6C4A`.
