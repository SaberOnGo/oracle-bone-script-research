# obs-char-000652 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000652`
- primary external id: `hust-obc-cat-0740`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/652_obs-char-000652_hust-obc-cat-0740_orac
  le-character/03_visual-assets/001_asset-000657_hust-obc-cat-0740_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0740/G_0740_乙1598(甲).png`
- asset id: `asset-000657`
...
- source category: `0740`
- validation class: `651`
- source image route: `HUST-OBC/deciphered/0740/G_0740_乙1598(甲).png`
- asset id: `asset-000657`
...
- English observation: `Three close vertical chains hang from a shallow
  curved top, each containing small stacked oval or diamond-shaped openings,
  with pointed lower ends.`
- 中文观察: `三条紧邻竖链悬于浅弯顶线下，各含层叠小椭圆或菱形空隙，下端收尖。`
...
- dataset label text: `㛚`
- dataset label codepoints: `U+36DA`
...
- Which source records identify obs-char-000652 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000652？
