# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000609
...
| Glyph or codepoint route / 字形或码位路线 | 16 OBIMD route rows; examples U+6276;U+A2020;U+F3995; U+F3996; 另有 14 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 16 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
