# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012797
...
- EVOBC candidate category: `evobc-evo-cat-12797`.
- Source label for search only: `𪞿`.
- Source codepoints for search only: `U+2A7BF`.
