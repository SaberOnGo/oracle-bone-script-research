# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004704
...
- EVOBC candidate category: `evobc-evo-cat-04704`.
- Source label for search only: `涿`.
- Source codepoints for search only: `U+6DBF`.
