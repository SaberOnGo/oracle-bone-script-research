...
- External category reference: `evobc-cat-00974`
- Source category ID: `00974`
- Source label for human review: `傀`
- Source codepoints: `U+5080`
...
- `obs-evo-cand-000974-route-category-staging`
...
- `obs-evo-cand-000974-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000974-route-evolution-graph`
