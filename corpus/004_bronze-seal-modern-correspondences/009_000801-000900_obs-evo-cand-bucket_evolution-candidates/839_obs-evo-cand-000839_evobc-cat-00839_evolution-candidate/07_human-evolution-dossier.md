...
Project ID: `obs-evo-cand-000839`
...
- Project ID: `obs-evo-cand-000839`
- EVOBC category candidate ID: `evobc-evo-cat-00839`
- External category reference: `evobc-cat-00839`
- Source category ID: `00839`
- Source label for human review: `侉`
- Source codepoints: `U+4F89`
...
- `obs-evo-cand-000839-route-category-staging`
...
- `obs-evo-cand-000839-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000839-route-evolution-graph`
