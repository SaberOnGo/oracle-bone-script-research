...
- External category reference: `evobc-cat-06900`
- Source category ID: `06900`
- Source label for human review: `翱`
- Source codepoints: `U+7FF1`
...
- `obs-evo-cand-006900-route-category-staging`
...
- `obs-evo-cand-006900-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006900-route-evolution-graph`
