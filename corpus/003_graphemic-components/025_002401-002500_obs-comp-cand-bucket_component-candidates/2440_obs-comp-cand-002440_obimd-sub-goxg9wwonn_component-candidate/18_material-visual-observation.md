# Material Visual Observation / obs-comp-cand-002440 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002440`
- External reference / 外部参照: `obimd-sub-goxg9wwonn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020612_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/goxg9wwonn/goxg9wwonn/goxg9wwonn.png`
- Checksum / 校验和:
  `c05755757060135509ed878dfe0674487411eeb44aa6cf90e598079f22071bcd`
...
- Marked-pixel bounds: (57,27)–(193,222); span 137 × 196 px; the marked
...
- 痕迹范围：(57,27)–(193,222)；跨度137 × 196 px；痕迹矩形高于宽。
