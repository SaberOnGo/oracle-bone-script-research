...
- External category reference: `evobc-cat-03571`
- Source category ID: `03571`
- Source label for human review: `敄`
- Source codepoints: `U+6544`
...
- `obs-evo-cand-003571-route-category-staging`
...
- `obs-evo-cand-003571-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003571-route-evolution-graph`
