...
- `obs-evo-cand-004777-route-category-staging`
...
- `obs-evo-cand-004777-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004777-route-evolution-graph`
