# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013478
...
- EVOBC candidate category: `evobc-evo-cat-13478`.
- Source label for search only: `𭄯`.
- Source codepoints for search only: `U+2D12F`.
