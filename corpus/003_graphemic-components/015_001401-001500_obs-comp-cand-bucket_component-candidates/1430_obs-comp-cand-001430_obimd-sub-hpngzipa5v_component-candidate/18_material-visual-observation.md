# Material Visual Observation / obs-comp-cand-001430 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001430`
- External reference / 外部参照: `obimd-sub-hpngzipa5v`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016007_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kgnlcsowqg/hpngzipa5v/hpngzipa5v.png`
- Checksum / 校验和:
  `d846f850001e74f7996355209a4a283899b323d955cd4ef82ed0f89ac0aa05ee`
...
- Marked-pixel bounds: (72,38)–(189,211); span 118 × 174 px; the marked
...
- 痕迹范围：(72,38)–(189,211)；跨度118 × 174 px；痕迹矩形高于宽。
