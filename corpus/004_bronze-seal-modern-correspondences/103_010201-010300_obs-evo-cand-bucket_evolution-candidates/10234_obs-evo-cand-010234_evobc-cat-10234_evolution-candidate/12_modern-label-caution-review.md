# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010234
...
- EVOBC candidate category: `evobc-evo-cat-10234`.
- Source label for search only: `騯`.
- Source codepoints for search only: `U+9A2F`.
