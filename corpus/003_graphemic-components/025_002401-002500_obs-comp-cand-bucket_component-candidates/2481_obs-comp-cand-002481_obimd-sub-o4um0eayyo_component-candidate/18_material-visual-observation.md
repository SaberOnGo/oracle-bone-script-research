# Material Visual Observation / obs-comp-cand-002481 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002481`
- External reference / 外部参照: `obimd-sub-o4um0eayyo`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020669_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/oqwz3j1hh1/o4um0eayyo/o4um0eayyo.png`
- Checksum / 校验和:
  `a7ef0e3a512485dfb53eed63738cb2b1d353fd7087a4add4c95ad6d0bb982fa0`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.19%.
- Marked-pixel bounds: (60,59)–(189,191); span 130 × 133 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.19%。
- 痕迹范围：(60,59)–(189,191)；跨度130 × 133 px；痕迹矩形近方形。
