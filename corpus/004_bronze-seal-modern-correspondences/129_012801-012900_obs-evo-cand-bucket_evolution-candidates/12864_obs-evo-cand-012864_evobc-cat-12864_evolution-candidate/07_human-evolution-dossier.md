...
- External category reference: `evobc-cat-12864`
- Source category ID: `12864`
- Source label for human review: `𪰼`
...
- `obs-evo-cand-012864-route-category-staging`
...
- `obs-evo-cand-012864-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012864-route-evolution-graph`
