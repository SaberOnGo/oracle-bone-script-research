...
- External category reference: `evobc-cat-03101`
- Source category ID: `03101`
- Source label for human review: `愿`
...
- `obs-evo-cand-003101-route-category-staging`
...
- `obs-evo-cand-003101-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003101-route-evolution-graph`
