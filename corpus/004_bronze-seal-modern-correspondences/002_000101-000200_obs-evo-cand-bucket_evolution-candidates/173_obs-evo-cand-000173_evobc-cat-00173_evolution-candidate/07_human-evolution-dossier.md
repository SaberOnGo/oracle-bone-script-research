...
Project ID: `obs-evo-cand-000173`
...
- Project ID: `obs-evo-cand-000173`
- EVOBC category candidate ID: `evobc-evo-cat-00173`
- External category reference: `evobc-cat-00173`
- Source category ID: `00173`
- Source label for human review: `㮚`
- Source codepoints: `U+3B9A`
...
- `obs-evo-cand-000173-route-category-staging`
...
- `obs-evo-cand-000173-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000173-route-evolution-graph`
