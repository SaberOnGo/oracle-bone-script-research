...
Project ID: `obs-insc-cw-cand-000448`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000448`
...
- Yingguo / 英国所藏: `y2316` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `284` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `353` in source row; primary catalog entry pending
- Heji / 合集: `41364` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000448`
