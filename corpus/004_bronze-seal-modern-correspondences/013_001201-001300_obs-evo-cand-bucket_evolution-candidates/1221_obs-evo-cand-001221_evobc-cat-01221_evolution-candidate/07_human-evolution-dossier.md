...
- External category reference: `evobc-cat-01221`
- Source category ID: `01221`
- Source label for human review: `剌`
- Source codepoints: `U+524C`
...
- `obs-evo-cand-001221-route-category-staging`
...
- `obs-evo-cand-001221-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001221-route-evolution-graph`
