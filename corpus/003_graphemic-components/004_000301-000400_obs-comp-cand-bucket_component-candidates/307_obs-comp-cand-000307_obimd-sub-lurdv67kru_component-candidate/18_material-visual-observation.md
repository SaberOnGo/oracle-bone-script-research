# Material Visual Observation / obs-comp-cand-000307 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000307`
- External reference / 外部参照: `obimd-sub-lurdv67kru`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012169_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/y1fizk7ybg/lurdv67kru/lurdv67kru.png`
- Checksum / 校验和:
  `4f8bbbec3d2897cb21666339df6e52f166a10d5203eb7d9c7b19769e58a4e733`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.17%.
- Marked-pixel bounds: (73,18)–(176,222); span 104 × 205 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.17%。
- 痕迹范围：(73,18)–(176,222)；跨度104 × 205 px；痕迹矩形高于宽。
