...
- External category reference: `evobc-cat-03575`
- Source category ID: `03575`
- Source label for human review: `效`
...
- `obs-evo-cand-003575-route-category-staging`
...
- `obs-evo-cand-003575-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003575-route-evolution-graph`
