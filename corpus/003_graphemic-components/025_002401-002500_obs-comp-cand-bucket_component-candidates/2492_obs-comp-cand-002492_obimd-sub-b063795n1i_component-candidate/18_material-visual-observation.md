# Material Visual Observation / obs-comp-cand-002492 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002492`
- External reference / 外部参照: `obimd-sub-b063795n1i`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020714_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8gxzzbv7w8/b063795n1i/b063795n1i.png`
- Checksum / 校验和:
  `0702bc6ac323030649672e91b8988b7f5fe7874634dc7ac3d7ced917be0d6c1f`
...
- Marked-pixel bounds: (83,25)–(164,217); span 82 × 193 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.13%。
- 痕迹范围：(83,25)–(164,217)；跨度82 × 193 px；痕迹矩形高于宽。
