# obs-unk-003976 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003976`
- primary external id: `hust-obc-und-L-003976`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/076_obs-unk-003976_h
  ust-obc-und-L-003976_oracle-character-candidate/03_visual-assets/001_asset
  -005569_hust-obc-und-L-003976_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3976/L_？_841.jpg`
- asset id: `asset-005569`
...
- source class: `HUST-OBC/undeciphered/L/3976/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3976/L_？_841.jpg`
- asset id: `asset-005569`
...
- English observation: A small crossed upper mark sits above a rounded lower
  enclosure with a darker diagonal trace.
- 中文观察：小交叉上部痕迹位于弧状下部围合轮廓之上，围合内或侧旁有较深斜痕。
...
- Which source records identify obs-unk-003976 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003976？
