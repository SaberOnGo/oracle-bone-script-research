...
Project ID: `obs-evo-cand-001035`
...
- Project ID: `obs-evo-cand-001035`
- EVOBC category candidate ID: `evobc-evo-cat-01035`
- External category reference: `evobc-cat-01035`
- Source category ID: `01035`
- Source label for human review: `僾`
- Source codepoints: `U+50FE`
...
- `obs-evo-cand-001035-route-category-staging`
...
- `obs-evo-cand-001035-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001035-route-evolution-graph`
