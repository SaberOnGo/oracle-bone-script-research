...
- External category reference: `evobc-cat-08954`
- Source category ID: `08954`
- Source label for human review: `连`
...
- `obs-evo-cand-008954-route-category-staging`
...
- `obs-evo-cand-008954-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008954-route-evolution-graph`
