...
Project ID: `obs-evo-cand-002469`
...
- Project ID: `obs-evo-cand-002469`
- EVOBC category candidate ID: `evobc-evo-cat-02469`
- External category reference: `evobc-cat-02469`
- Source category ID: `02469`
- Source label for human review: `少`
- Source codepoints: `U+5C11`
- Image reference count in source metadata: `178`
...
- `obs-evo-cand-002469-route-category-staging`
...
- `obs-evo-cand-002469-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002469-route-evolution-graph`
