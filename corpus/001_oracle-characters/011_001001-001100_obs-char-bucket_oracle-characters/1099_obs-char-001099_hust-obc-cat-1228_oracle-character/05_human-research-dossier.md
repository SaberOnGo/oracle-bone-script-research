# obs-char-001099 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1099_obs-char-001099_hust-obc-cat-1228_ora
  cle-character/03_visual-assets/001_asset-001104_hust-obc-cat-1228_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1228/G_1228_掇2.62(甲).png`
- asset id: `asset-001104`
...
- source category: `1228`
- validation class: `1098`
- source image route: `HUST-OBC/deciphered/1228/G_1228_掇2.62(甲).png`
- asset id: `asset-001104`
...
- English observation: `A narrow vertical form has a pointed upper branch, a
  central upright, and a rounded lower curve.`
- 中文观察: `狭长竖向形体有尖状上部分枝、中央直立笔和圆弧下部弯笔。`
...
- dataset label text: `㣂`
- dataset label codepoints: `U+38C2`
...
- Which source records identify obs-char-001099 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001099？
