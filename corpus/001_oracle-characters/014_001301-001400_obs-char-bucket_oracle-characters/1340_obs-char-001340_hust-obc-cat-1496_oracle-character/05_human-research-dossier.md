# obs-char-001340 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1340_obs-char-001340_hust-obc-cat-1496_ora
  cle-character/03_visual-assets/001_asset-001345_hust-obc-cat-1496_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1496/G_1496_京津1605合13498賓組.png`
- asset id: `asset-001345`
...
- source category: `1496`
- validation class: `1339`
- source image route: `HUST-OBC/deciphered/1496/G_1496_京津1605合13498賓組.png`
- asset id: `asset-001345`
...
- English observation: `A small composite form has a short upper rectangular
  bar, a long descending diagonal, and a lower hook.`
...
- dataset label text: `㧎`
- dataset label codepoints: `U+39CE`
...
- filename catalog route clues: `Heji-like filename clue: 合13498
  (G_1496_京津1605合13498賓組.png)`
...
- Which source records identify obs-char-001340 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001340？
