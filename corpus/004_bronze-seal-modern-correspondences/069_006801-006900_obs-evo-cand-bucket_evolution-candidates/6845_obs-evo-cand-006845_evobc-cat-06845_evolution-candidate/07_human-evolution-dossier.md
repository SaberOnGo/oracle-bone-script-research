...
- External category reference: `evobc-cat-06845`
- Source category ID: `06845`
- Source label for human review: `羖`
...
- `obs-evo-cand-006845-route-category-staging`
...
- `obs-evo-cand-006845-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006845-route-evolution-graph`
