# obs-char-000231 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000231`
- primary external id: `hust-obc-cat-0257`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/231_obs-char-000231_hust-obc-cat-0257_orac
  le-character/03_visual-assets/001_asset-000236_hust-obc-cat-0257_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0257/G_0257_甲2124(甲).png`
- asset id: `asset-000236`
...
- source category: `0257`
- validation class: `230`
- source image route: `HUST-OBC/deciphered/0257/G_0257_甲2124(甲).png`
- asset id: `asset-000236`
...
- English observation: `The narrow upright image has a curved outer stroke,
  a short crossing stroke near the upper middle, and a hooked descending
  stroke on the right.`
...
- dataset label text: `㓷`
- dataset label codepoints: `U+34F7`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/022_obs-evo-can
  d-000022_evobc-cat-00022_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/022_obs-evo-cand-000022_evobc-cat-00022_evolu
...
- Which source records identify obs-char-000231 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000231？
