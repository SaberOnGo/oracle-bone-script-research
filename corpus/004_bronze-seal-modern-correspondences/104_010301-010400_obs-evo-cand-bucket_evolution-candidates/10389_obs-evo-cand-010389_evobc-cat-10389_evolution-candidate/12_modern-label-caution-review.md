# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010389
...
- EVOBC candidate category: `evobc-evo-cat-10389`.
- Source label for search only: `鮏`.
- Source codepoints for search only: `U+9B8F`.
