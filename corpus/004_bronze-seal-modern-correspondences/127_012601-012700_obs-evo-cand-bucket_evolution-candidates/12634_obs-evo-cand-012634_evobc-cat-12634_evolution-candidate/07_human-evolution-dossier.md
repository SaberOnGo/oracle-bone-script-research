...
- External category reference: `evobc-cat-12634`
- Source category ID: `12634`
- Source label for human review: `𩜒`
- Source codepoints: `U+29712`
...
- `obs-evo-cand-012634-route-category-staging`
...
- `obs-evo-cand-012634-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012634-route-evolution-graph`
