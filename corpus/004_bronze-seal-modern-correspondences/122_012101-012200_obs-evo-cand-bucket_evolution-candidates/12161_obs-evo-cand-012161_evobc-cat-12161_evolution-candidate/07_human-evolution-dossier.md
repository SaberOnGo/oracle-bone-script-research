...
- External category reference: `evobc-cat-12161`
- Source category ID: `12161`
- Source label for human review: `𧍵`
- Source codepoints: `U+27375`
...
- `obs-evo-cand-012161-route-category-staging`
...
- `obs-evo-cand-012161-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012161-route-evolution-graph`
