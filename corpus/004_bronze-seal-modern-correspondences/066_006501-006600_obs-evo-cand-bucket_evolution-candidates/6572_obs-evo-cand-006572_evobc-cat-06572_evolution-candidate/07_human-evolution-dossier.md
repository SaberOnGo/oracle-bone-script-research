...
- Project ID: `obs-evo-cand-006572`
- EVOBC category candidate ID: `evobc-evo-cat-06572`
- External category reference: `evobc-cat-06572`
- Source category ID: `06572`
- Source label for human review: `緁`
- Source codepoints: `U+7DC1`
...
- `obs-evo-cand-006572-route-category-staging`
...
- `obs-evo-cand-006572-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006572-route-evolution-graph`
