...
- External category reference: `evobc-cat-06111`
- Source category ID: `06111`
- Source label for human review: `稳`
...
- `obs-evo-cand-006111-route-category-staging`
...
- `obs-evo-cand-006111-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006111-route-evolution-graph`
