# Material Visual Observation / obs-comp-cand-001345 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001345`
- External reference / 外部参照: `obimd-sub-1ooijljqrv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015728_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1ooijljqrv/1ooijljqrv/1ooijljqrv.png`
- Checksum / 校验和:
  `5a23cc8c328d6a958cd9af3e60640331f3d93f808e9d2d5b42d11c2fad430202`
...
- Marked-pixel bounds: (66,33)–(192,216); span 127 × 184 px; the marked
...
- 痕迹范围：(66,33)–(192,216)；跨度127 × 184 px；痕迹矩形高于宽。
