# obs-char-001529 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1529_obs-char-001529_hust-obc-cat-1715_ora
  cle-character/03_visual-assets/001_asset-001534_hust-obc-cat-1715_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1715/X_1715_5160_1.png`
- asset id: `asset-001534`
...
- source category: `1715`
- validation class: `1528`
- source image route: `HUST-OBC/deciphered/1715/X_1715_5160_1.png`
- asset id: `asset-001534`
...
- English observation: `A dense tall contour has several upper prongs, two
  inner openings, and curved lower tails.`
- 中文观察: `密集高大轮廓有数个上部分叉、两个内部开口和弧形下部尾笔。`
...
- dataset label text: `㪩`
- dataset label codepoints: `U+3AA9`
...
- Which source records identify obs-char-001529 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001529？
