# obs-unk-004626 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004626`
- primary external id: `hust-obc-und-X-004626`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/026_obs-unk-004626_h
  ust-obc-und-X-004626_oracle-character-candidate/03_visual-assets/001_asset
  -006219_hust-obc-und-X-004626_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/182/X_？_8356_1.png`
- asset id: `asset-006219`
...
- source class: `HUST-OBC/undeciphered/X/182/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/182/X_？_8356_1.png`
- asset id: `asset-006219`
...
- English observation: `open curved contour with broad pale field`
- 中文观察: `开放弯曲轮廓和宽大浅色区域已记录。`
...
- Which source records identify obs-unk-004626 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004626？
