# obs-char-000480 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000480`
- primary external id: `hust-obc-cat-0544_0545`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/480_obs-char-000480_hust-obc-cat-0544_0545
  _oracle-character/03_visual-assets/001_asset-000485_hust-obc-cat-0544_0545
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0544_0545/0544/G_0544_京津1440合10
  986.png`
- asset id: `asset-000485`
...
- source category: `0544_0545`
- validation class: `479`
- source image route: `HUST-OBC/deciphered/0544_0545/0544/G_0544_京津1440合10986.
  png`
- asset id: `asset-000485`
...
- English observation: `A pointed polygonal outer enclosure contains two
  separated inner outlines: a small rounded rectangular form above and a
  larger rectangular form below.`
- 中文观察: `尖顶多边外围框内有两个分离内轮廓：上部为小型圆角矩形，下部为较大矩形。`
...
- dataset label text: `㘖㘗`
- dataset label codepoints: `U+3616;U+3617`
...
- graph edge count: `2`
- codepoint routes: `U+3616;U+3617`
...
- filename catalog route clues: `Heji-like filename clue: 合10986
  (G_0544_京津1440合10986.png)`
...
- Which source records identify obs-char-000480 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000480？
