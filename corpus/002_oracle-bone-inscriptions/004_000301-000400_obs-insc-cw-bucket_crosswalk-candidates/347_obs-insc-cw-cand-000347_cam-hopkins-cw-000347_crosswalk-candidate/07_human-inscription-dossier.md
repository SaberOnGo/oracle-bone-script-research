...
Project ID: `obs-insc-cw-cand-000347`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000347`
...
- Yingguo / 英国所藏: `y2025` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `476` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `83` in source row; primary catalog entry pending
- Heji / 合集: `41032` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000347`
