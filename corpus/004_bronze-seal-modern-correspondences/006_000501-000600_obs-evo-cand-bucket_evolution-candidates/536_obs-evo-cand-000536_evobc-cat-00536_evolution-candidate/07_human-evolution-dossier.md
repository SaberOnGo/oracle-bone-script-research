...
Project ID: `obs-evo-cand-000536`
...
- Project ID: `obs-evo-cand-000536`
- EVOBC category candidate ID: `evobc-evo-cat-00536`
- External category reference: `evobc-cat-00536`
- Source category ID: `00536`
- Source label for human review: `䨮`
- Source codepoints: `U+4A2E`
...
- `obs-evo-cand-000536-route-category-staging`
...
- `obs-evo-cand-000536-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000536-route-evolution-graph`
