# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008182
...
- EVOBC candidate category: `evobc-evo-cat-08182`.
- Source label for search only: `詛`.
- Source codepoints for search only: `U+8A5B`.
