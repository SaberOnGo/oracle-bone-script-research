# obs-unk-004351 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/051_obs-unk-004351_h
  ust-obc-und-L-004351_oracle-character-candidate/03_visual-assets/001_asset
  -005944_hust-obc-und-L-004351_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4351/L_？_9649.jpg`
- asset id: `asset-005944`
...
- source class: `HUST-OBC/undeciphered/L/4351/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4351/L_？_9649.jpg`
- asset id: `asset-005944`
...
- English observation: `Central trace, left branch, and bent lower end`
  `recorded.`
- 中文观察: `已记录中央痕迹、左侧分支和下部弯折末端。`
...
- Which source records identify obs-unk-004351 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004351？
