...
Project ID: `obs-evo-cand-013379`
...
- Project ID: `obs-evo-cand-013379`
- EVOBC category candidate ID: `evobc-evo-cat-13379`
- External category reference: `evobc-cat-13379`
- Source category ID: `13379`
- Source label for human review: `𬪆`
- Source codepoints: `U+2CA86`
...
- `obs-evo-cand-013379-route-category-staging`
...
- `obs-evo-cand-013379-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013379-route-evolution-graph`
