...
Project ID: `obs-insc-cw-cand-000062`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000062`
...
- Yingguo / 英国所藏: `y409` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `243` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `656` in source row; primary catalog entry pending
- Heji / 合集: `39811` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000062`
