# Material Visual Observation / obs-comp-cand-002355 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002355`
- External reference / 外部参照: `obimd-sub-f7q42uyo0n`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020426_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/w0qm9q3ey5/f7q42uyo0n/f7q42uyo0n.png`
- Checksum / 校验和:
  `dc1b04e5ad926ae4821db2880f339b0abd165531f312af956ac3e71fcfdf6c93`
...
- Marked-pixel bounds: (80,22)–(169,221); span 90 × 200 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.92%。
- 痕迹范围：(80,22)–(169,221)；跨度90 × 200 px；痕迹矩形高于宽。
