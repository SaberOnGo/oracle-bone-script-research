# obs-unk-003961 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/061_obs-unk-003961_h
  ust-obc-und-L-003961_oracle-character-candidate/03_visual-assets/001_asset
  -005554_hust-obc-und-L-003961_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3961/L_？_8357.jpg`
- asset id: `asset-005554`
...
- source class: `HUST-OBC/undeciphered/L/3961/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3961/L_？_8357.jpg`
- asset id: `asset-005554`
...
- English observation: A small upper enclosure sends a narrow trace downward,
  with a separate curved trace at the left.
- 中文观察：上部小围合轮廓向下连出窄痕，左侧另有分开的弧痕。
...
- Which source records identify obs-unk-003961 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003961？
