# obs-unk-003987 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003987`
- primary external id: `hust-obc-und-L-003987`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/087_obs-unk-003987_h
  ust-obc-und-L-003987_oracle-character-candidate/03_visual-assets/001_asset
  -005580_hust-obc-und-L-003987_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3987/L_？_8441.jpg`
- asset id: `asset-005580`
...
- source class: `HUST-OBC/undeciphered/L/3987/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3987/L_？_8441.jpg`
- asset id: `asset-005580`
...
- English observation: Two upright or forked traces rise above a broad lower
  enclosure; a diagonal or crossing trace is visible inside it.
- 中文观察：两条直立或分叉痕迹位于较宽下部围合轮廓之上；内部可见斜向或
  交叉痕迹。
...
- Which source records identify obs-unk-003987 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003987？
