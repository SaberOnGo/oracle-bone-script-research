...
Project ID: `obs-evo-cand-008720`
...
- Project ID: `obs-evo-cand-008720`
- EVOBC category candidate ID: `evobc-evo-cat-08720`
- External category reference: `evobc-cat-08720`
- Source category ID: `08720`
- Source label for human review: `跪`
- Source codepoints: `U+8DEA`
...
- `obs-evo-cand-008720-route-category-staging`
...
- `obs-evo-cand-008720-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008720-route-evolution-graph`
