# obs-char-001568 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1568_obs-char-001568_hust-obc-cat-1760_ora
  cle-character/03_visual-assets/001_asset-001573_hust-obc-cat-1760_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1760/L_1760_284.jpg`
- asset id: `asset-001573`
...
- source category: `1760`
- validation class: `1567`
- source image route: `HUST-OBC/deciphered/1760/L_1760_284.jpg`
- asset id: `asset-001573`
...
- English observation: `A very faint small form preserves a shallow upper
  curve and a short lower crossbar.`
...
- dataset label text: `㫖`
- dataset label codepoints: `U+3AD6`
...
- Which source records identify obs-char-001568 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001568？
