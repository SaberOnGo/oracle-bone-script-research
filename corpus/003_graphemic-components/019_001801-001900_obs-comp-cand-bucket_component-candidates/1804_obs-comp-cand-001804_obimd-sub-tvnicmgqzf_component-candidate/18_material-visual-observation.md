# Material Visual Observation / obs-comp-cand-001804 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001804`
- External reference / 外部参照: `obimd-sub-tvnicmgqzf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018025_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tvnicmgqzf/tvnicmgqzf/tvnicmgqzf.png`
- Checksum / 校验和:
  `021e8801308a34d519c9f2cf6c5a029e19917e01fc1c6edd2abf39adb0b66540`
...
- Marked-pixel bounds: (85,20)–(166,227); span 82 × 208 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.26%。
- 痕迹范围：(85,20)–(166,227)；跨度82 × 208 px；痕迹矩形高于宽。
