# obs-char-001031 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001031`
- primary external id: `hust-obc-cat-1156`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1031_obs-char-001031_hust-obc-cat-1156_ora
  cle-character/03_visual-assets/001_asset-001036_hust-obc-cat-1156_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1156/G_1156_乙1290(甲).png`
- asset id: `asset-001036`
...
- source category: `1156`
- validation class: `1030`
- source image route: `HUST-OBC/deciphered/1156/G_1156_乙1290(甲).png`
- asset id: `asset-001036`
...
- English observation: `A long left-pointing horizontal stroke crosses a
  central upright and meets a curved angular form on the right.`
- 中文观察: `长左向水平笔穿过中央直立笔，并与右侧弯曲棱角形体相接。`
...
- dataset label text: `㡺`
- dataset label codepoints: `U+387A`
...
- Which source records identify obs-char-001031 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001031？
