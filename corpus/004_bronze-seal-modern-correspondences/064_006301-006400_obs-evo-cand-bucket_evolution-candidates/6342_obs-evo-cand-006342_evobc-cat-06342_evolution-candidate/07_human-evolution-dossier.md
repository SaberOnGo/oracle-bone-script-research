...
Project ID: `obs-evo-cand-006342`
...
- Project ID: `obs-evo-cand-006342`
- EVOBC category candidate ID: `evobc-evo-cat-06342`
- External category reference: `evobc-cat-06342`
- Source category ID: `06342`
- Source label for human review: `簋`
- Source codepoints: `U+7C0B`
- Image reference count in source metadata: `205`
...
- `obs-evo-cand-006342-route-category-staging`
...
- `obs-evo-cand-006342-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006342-route-evolution-graph`
