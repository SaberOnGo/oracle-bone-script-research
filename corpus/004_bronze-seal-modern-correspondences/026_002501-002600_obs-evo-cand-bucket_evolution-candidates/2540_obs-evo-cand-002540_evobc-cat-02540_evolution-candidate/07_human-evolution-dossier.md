...
Project ID: `obs-evo-cand-002540`
...
- Project ID: `obs-evo-cand-002540`
- EVOBC category candidate ID: `evobc-evo-cat-02540`
- External category reference: `evobc-cat-02540`
- Source category ID: `02540`
- Source label for human review: `岦`
- Source codepoints: `U+5CA6`
...
- `obs-evo-cand-002540-route-category-staging`
...
- `obs-evo-cand-002540-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002540-route-evolution-graph`
