# Material Visual Observation / obs-comp-cand-000016 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000016`
- External reference / 外部参照: `obimd-sub-dg3rdvnaw9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011148_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/no4gdlajf6/dg3rdvnaw9/4m8klzz1jn.png`
- Checksum / 校验和:
  `9a7a20c6ad7c0f8ebccd89645a31b016d1baf8c973505ae92f742e9c75abaa34`
...
- Marked-pixel bounds: (82,22)–(167,227); span 86 × 206 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.48%。
- 痕迹范围：(82,22)–(167,227)；跨度86 × 206 px；痕迹矩形高于宽。
