...
- `obs-evo-cand-002465-route-category-staging`
...
- `obs-evo-cand-002465-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002465-route-evolution-graph`
