# obs-char-000596 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/596_obs-char-000596_hust-obc-cat-0678_0679
  _oracle-character/03_visual-assets/001_asset-000601_hust-obc-cat-0678_0679
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0678_0679/0678/G_0678_乙3380反合17
  301反.png`
- asset id: `asset-000601`
...
- source category: `0678_0679`
- validation class: `595`
- source image route: `HUST-OBC/deciphered/0678_0679/0678/G_0678_乙3380反合17301反
  .png`
- asset id: `asset-000601`
...
- English observation: `Two long narrow upper strokes flank a small pointed
  loop, below which a bold curved loop and hooked descending tail form a
  compact lower cluster.`
- 中文观察: `两条长狭上笔夹着小型尖环，其下粗弯环和钩曲下垂尾组成紧凑下部笔群。`
...
- dataset label text: `㚜㚝`
- dataset label codepoints: `U+369C;U+369D`
...
- Which source records identify obs-char-000596 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000596？
