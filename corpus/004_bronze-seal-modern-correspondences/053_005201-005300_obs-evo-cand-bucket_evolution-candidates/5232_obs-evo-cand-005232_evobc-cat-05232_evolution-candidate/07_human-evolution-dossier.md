...
- Project ID: `obs-evo-cand-005232`
- EVOBC category candidate ID: `evobc-evo-cat-05232`
- External category reference: `evobc-cat-05232`
- Source category ID: `05232`
- Source label for human review: `犎`
- Source codepoints: `U+728E`
...
- `obs-evo-cand-005232-route-category-staging`
...
- `obs-evo-cand-005232-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005232-route-evolution-graph`
