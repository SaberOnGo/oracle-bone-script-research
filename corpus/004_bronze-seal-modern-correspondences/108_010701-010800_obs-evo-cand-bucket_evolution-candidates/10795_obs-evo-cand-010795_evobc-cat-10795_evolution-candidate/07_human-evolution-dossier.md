...
- Project ID: `obs-evo-cand-010795`
- EVOBC category candidate ID: `evobc-evo-cat-10795`
- External category reference: `evobc-cat-10795`
- Source category ID: `10795`
- Source label for human review: `𠈲`
- Source codepoints: `U+20232`
...
- `obs-evo-cand-010795-route-category-staging`
...
- `obs-evo-cand-010795-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010795-route-evolution-graph`
