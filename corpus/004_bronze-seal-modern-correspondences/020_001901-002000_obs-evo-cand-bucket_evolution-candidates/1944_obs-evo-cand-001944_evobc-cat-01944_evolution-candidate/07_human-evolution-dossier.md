...
Project ID: `obs-evo-cand-001944`
...
- Project ID: `obs-evo-cand-001944`
- EVOBC category candidate ID: `evobc-evo-cat-01944`
- External category reference: `evobc-cat-01944`
- Source category ID: `01944`
- Source label for human review: `墠`
- Source codepoints: `U+58A0`
...
- `obs-evo-cand-001944-route-category-staging`
...
- `obs-evo-cand-001944-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001944-route-evolution-graph`
