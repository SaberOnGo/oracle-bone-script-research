...
Project ID: `obs-evo-cand-001661`
...
- Project ID: `obs-evo-cand-001661`
- EVOBC category candidate ID: `evobc-evo-cat-01661`
- External category reference: `evobc-cat-01661`
- Source category ID: `01661`
- Source label for human review: `喻`
- Source codepoints: `U+55BB`
...
- `obs-evo-cand-001661-route-category-staging`
...
- `obs-evo-cand-001661-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001661-route-evolution-graph`
