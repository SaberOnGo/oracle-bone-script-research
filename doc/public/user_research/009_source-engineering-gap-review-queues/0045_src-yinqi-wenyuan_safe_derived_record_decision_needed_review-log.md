...
- Review log draft ID / 复核日志草稿 ID: `source-engineering-gap-review-log-draft-0045`
- Source engineering gap ID / 来源工程缺口 ID: `source-engineering-gap-0045`
...
`current_stage=pending_human_review;download_status_counts=downloaded:1;downloaded_count=1;download_log_count=1;checksum_present_count=1;field_map_count=0;package_manifest_count=0;metadata_profile_count=2;graph_edge_count=0;downloaded_file_bytes=32900;gap_type=safe_derived_record_decision_needed`
