# obs-comp-cand-000488 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000488`
- 首选外部 ID: `obimd-sub-32rwmop1h1`
- OBIMD subcharacter UID: `32rwmop1h1`
- OBIMD main character UID: `32rwmop1h1`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+F2DEE; U+F2DEF; 另有 1 项
