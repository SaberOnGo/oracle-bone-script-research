# obs-unk-003220 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003220`
- primary external id: `hust-obc-und-L-003220`
...
- local review image route: `corpus/001_oracle-characters/049_undeciphered-003
  201-003300_obs-unk-bucket_oracle-character-candidates/020_obs-unk-003220_h
  ust-obc-und-L-003220_oracle-character-candidate/03_visual-assets/001_asset
  -004813_hust-obc-und-L-003220_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3220/L_？_604.jpg`
- asset id: `asset-004813`
...
- source class: `HUST-OBC/undeciphered/L/3220/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3220/L_？_604.jpg`
- asset id: `asset-004813`
...
- Which source records identify obs-unk-003220 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003220？
