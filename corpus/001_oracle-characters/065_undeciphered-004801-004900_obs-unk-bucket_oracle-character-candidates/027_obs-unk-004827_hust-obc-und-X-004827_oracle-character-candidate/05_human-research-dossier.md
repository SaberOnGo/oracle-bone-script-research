# obs-unk-004827 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004827`
- primary external id: `hust-obc-und-X-004827`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/027_obs-unk-004827_h
  ust-obc-und-X-004827_oracle-character-candidate/03_visual-assets/001_asset
  -006420_hust-obc-und-X-004827_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/383/X_？_7366_1.png`
- asset id: `asset-006420`
...
- source class: `HUST-OBC/undeciphered/X/383/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/383/X_？_7366_1.png`
- asset id: `asset-006420`
...
- English observation: `pointed upper outline and lower U-shaped opening`
- 中文观察: `上部尖状围合和下部 U 形开口`
...
- Which source records identify obs-unk-004827 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004827？
