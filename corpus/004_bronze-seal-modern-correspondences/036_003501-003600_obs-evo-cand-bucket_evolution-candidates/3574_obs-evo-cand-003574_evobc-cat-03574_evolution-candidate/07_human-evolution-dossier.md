...
Project ID: `obs-evo-cand-003574`
...
- Project ID: `obs-evo-cand-003574`
- EVOBC category candidate ID: `evobc-evo-cat-03574`
- External category reference: `evobc-cat-03574`
- Source category ID: `03574`
- Source label for human review: `敇`
- Source codepoints: `U+6547`
...
- `obs-evo-cand-003574-route-category-staging`
...
- `obs-evo-cand-003574-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003574-route-evolution-graph`
