# obs-unk-004627 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004627`
- primary external id: `hust-obc-und-X-004627`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/027_obs-unk-004627_h
  ust-obc-und-X-004627_oracle-character-candidate/03_visual-assets/001_asset
  -006220_hust-obc-und-X-004627_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/183/X_？_8357_1.png`
- asset id: `asset-006220`
...
- source class: `HUST-OBC/undeciphered/X/183/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/183/X_？_8357_1.png`
- asset id: `asset-006220`
...
- English observation: `stacked pointed form and lower U-shaped form`
- 中文观察: `上下分置的尖顶形体和下部 U 形痕已记录。`
...
- Which source records identify obs-unk-004627 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004627？
