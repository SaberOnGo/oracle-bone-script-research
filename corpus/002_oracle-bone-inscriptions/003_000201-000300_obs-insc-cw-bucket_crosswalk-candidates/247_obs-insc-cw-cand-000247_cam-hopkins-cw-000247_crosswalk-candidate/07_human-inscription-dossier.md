...
Project ID: `obs-insc-cw-cand-000247`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000247`
...
- Source page section: `Period I Group 19` /
  `第 I 期第 19 组`
- Source section key: `period-i-group-19`
- Section declared count: `13`
- Section observed row count: `22`
...
- Yingguo / 英国所藏: `y1594` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `171` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `733` in source row; primary catalog entry pending
- Heji / 合集: `40742` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000247`
