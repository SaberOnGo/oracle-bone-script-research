# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-005948
...
- EVOBC candidate category: `evobc-evo-cat-05948`.
- Source label for search only: `磺`.
- Source codepoints for search only: `U+78FA`.
