# Material Visual Observation / obs-comp-cand-000992 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000992`
- External reference / 外部参照: `obimd-sub-gomr9f3nzo`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014362_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tp2kuz956n/gomr9f3nzo/gomr9f3nzo.png`
- Checksum / 校验和:
  `f12e4c5cd6a3716a404c6f61798f00f6df630e5fce2b23ed1c7973078ec09da7`
...
- Marked-pixel bounds: (72,38)–(179,227); span 108 × 190 px; the marked
...
- 痕迹范围：(72,38)–(179,227)；跨度108 × 190 px；痕迹矩形高于宽。
