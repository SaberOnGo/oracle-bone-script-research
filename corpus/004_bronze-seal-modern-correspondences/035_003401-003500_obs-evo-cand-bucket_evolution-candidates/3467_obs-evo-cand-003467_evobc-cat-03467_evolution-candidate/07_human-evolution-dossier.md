...
- Project ID: `obs-evo-cand-003467`
- EVOBC category candidate ID: `evobc-evo-cat-03467`
- External category reference: `evobc-cat-03467`
- Source category ID: `03467`
- Source label for human review: `摄`
- Source codepoints: `U+6444`
...
- `obs-evo-cand-003467-route-category-staging`
...
- `obs-evo-cand-003467-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003467-route-evolution-graph`
