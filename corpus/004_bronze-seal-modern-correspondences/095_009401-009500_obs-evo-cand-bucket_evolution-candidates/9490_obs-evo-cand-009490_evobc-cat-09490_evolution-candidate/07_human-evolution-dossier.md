...
Project ID: `obs-evo-cand-009490`
...
- Project ID: `obs-evo-cand-009490`
- EVOBC category candidate ID: `evobc-evo-cat-09490`
- External category reference: `evobc-cat-09490`
- Source category ID: `09490`
- Source label for human review: `鎱`
- Source codepoints: `U+93B1`
...
- `obs-evo-cand-009490-route-category-staging`
...
- `obs-evo-cand-009490-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009490-route-evolution-graph`
