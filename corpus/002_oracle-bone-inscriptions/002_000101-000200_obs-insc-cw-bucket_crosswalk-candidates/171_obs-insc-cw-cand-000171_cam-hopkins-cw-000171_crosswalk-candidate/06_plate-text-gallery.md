...
Project ID: `obs-insc-cw-cand-000171`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000171`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000171` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y1014` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `11` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `341` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `40783` [route_present_image_or_text_not_collected]
