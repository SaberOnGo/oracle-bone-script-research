# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002551
...
- EVOBC candidate category: `evobc-evo-cat-02551`.
- Source label for search only: `峋`.
- Source codepoints for search only: `U+5CCB`.
