# obs-unk-004954 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/054_obs-unk-004954_h
  ust-obc-und-X-004954_oracle-character-candidate/03_visual-assets/001_asset
  -006547_hust-obc-und-X-004954_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/510/X_？_7492_1.png`
- asset id: `asset-006547`
...
- A central diagonal crosses an upper opening and lower-left band.
...
- source class: `HUST-OBC/undeciphered/X/510/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/510/X_？_7492_1.png`
- asset id: `asset-006547`
...
- Which source records identify obs-unk-004954 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004954？
