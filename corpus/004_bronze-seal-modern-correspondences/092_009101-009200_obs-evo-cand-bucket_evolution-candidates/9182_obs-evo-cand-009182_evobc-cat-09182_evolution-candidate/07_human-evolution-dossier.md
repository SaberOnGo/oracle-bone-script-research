...
- External category reference: `evobc-cat-09182`
- Source category ID: `09182`
- Source label: `鄊`
...
- `obs-evo-cand-009182-route-category-staging`
...
- `obs-evo-cand-009182-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009182-route-evolution-graph`
