# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000618
...
| --- | --- | --- | --- |
| `obimd-glyph-link-009186` | 󳧸 | `U+F39F8` | `reviewed_metadata_only` |
| `obimd-glyph-link-009187` | 󳧹 | `U+F39F9` | `reviewed_metadata_only` |
| `obimd-glyph-link-009188` | 󳧺 | `U+F39FA` | `reviewed_metadata_only` |
