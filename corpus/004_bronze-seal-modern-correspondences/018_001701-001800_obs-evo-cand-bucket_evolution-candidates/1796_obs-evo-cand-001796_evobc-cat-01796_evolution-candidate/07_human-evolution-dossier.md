...
- Project ID: `obs-evo-cand-001796`
- EVOBC category candidate ID: `evobc-evo-cat-01796`
- External category reference: `evobc-cat-01796`
- Source category ID: `01796`
- Source label for human review: `地`
- Source codepoints: `U+5730`
...
- `obs-evo-cand-001796-route-category-staging`
...
- `obs-evo-cand-001796-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001796-route-evolution-graph`
