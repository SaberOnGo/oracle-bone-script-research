# obs-char-000889 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/889_obs-char-000889_hust-obc-cat-1001_orac
  le-character/03_visual-assets/001_asset-000894_hust-obc-cat-1001_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1001/G_1001_前4.13.7合5902賓組.png`
- asset id: `asset-000894`
...
- source category: `1001`
- validation class: `888`
- source image route: `HUST-OBC/deciphered/1001/G_1001_前4.13.7合5902賓組.png`
- asset id: `asset-000894`
...
- English observation: `Two outer curves enclose a narrow central crossing
  and branching strokes; a short detached mark sits at right.`
- 中文观察: `两条外弯曲笔围住狭长中央交叉和分枝笔；右侧有短小分离痕迹。`
...
- dataset label text: `㟟`
- dataset label codepoints: `U+37DF`
...
- filename catalog route clues: `Heji-like filename clue: 合5902
  (G_1001_前4.13.7合5902賓組.png)`
...
- Which source records identify obs-char-000889 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000889？
