# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002334
...
- EVOBC candidate category: `evobc-evo-cat-02334`.
- Source label for search only: `孛`.
- Source codepoints for search only: `U+5B5B`.
