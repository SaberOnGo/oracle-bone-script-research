...
- External category reference: `evobc-cat-01773`
- Source category ID: `01773`
- Source label for human review: `圂`
- Source codepoints: `U+5702`
...
- `obs-evo-cand-001773-route-category-staging`
...
- `obs-evo-cand-001773-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001773-route-evolution-graph`
