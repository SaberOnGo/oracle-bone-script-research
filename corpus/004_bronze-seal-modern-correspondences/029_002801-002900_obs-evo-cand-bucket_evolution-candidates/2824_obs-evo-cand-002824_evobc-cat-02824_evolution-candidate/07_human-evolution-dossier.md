...
- External category reference: `evobc-cat-02824`
- Source category ID: `02824`
- Source label: `彉`
...
- `obs-evo-cand-002824-route-category-staging`
...
- `obs-evo-cand-002824-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002824-route-evolution-graph`
