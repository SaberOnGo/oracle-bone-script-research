# Material Visual Observation / obs-comp-cand-002429 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002429`
- External reference / 外部参照: `obimd-sub-s1jcilzc8h`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020552_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7sys4laq6v/s1jcilzc8h/1idqm5xae8.png`
- Checksum / 校验和:
  `ccb0fc447d21d72d41fb575503ef1f98d526013b97ea115829c55b1f8b7ce9bc`
...
- Marked-pixel bounds: (81,34)–(168,219); span 88 × 186 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.28%。
- 痕迹范围：(81,34)–(168,219)；跨度88 × 186 px；痕迹矩形高于宽。
