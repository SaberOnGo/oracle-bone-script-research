# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001167
...
| --- | --- | --- | --- |
| `obimd-glyph-link-017485` | 󶭭 | `U+F6B6D` | `reviewed_metadata_only` |
| `obimd-glyph-link-017486` | 󶭮 | `U+F6B6E` | `reviewed_metadata_only` |
| `obimd-glyph-link-017487` | 󶭯 | `U+F6B6F` | `reviewed_metadata_only` |
