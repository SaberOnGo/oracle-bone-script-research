# obs-char-001479 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001479`
- primary external id: `hust-obc-cat-1661`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1479_obs-char-001479_hust-obc-cat-1661_ora
  cle-character/03_visual-assets/001_asset-001484_hust-obc-cat-1661_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1661/G_1661_乙6698合10184賓組.png`
- asset id: `asset-001484`
...
- source category: `1661`
- validation class: `1478`
- source image route: `HUST-OBC/deciphered/1661/G_1661_乙6698合10184賓組.png`
- asset id: `asset-001484`
...
- English observation: `A simple pointed upper loop leads into two long
  descending strokes.`
- 中文观察: `简单尖状上部环形连接两条长下行笔画。`
...
- dataset label text: `㩳`
- dataset label codepoints: `U+3A73`
...
- filename catalog route clues: `Heji-like filename clue: 合10184
  (G_1661_乙6698合10184賓組.png)`
...
- Which source records identify obs-char-001479 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001479？
