...
- External category reference: `evobc-cat-07489`
- Source category ID: `07489`
- Source label for human review: `葼`
...
- `obs-evo-cand-007489-route-category-staging`
...
- `obs-evo-cand-007489-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007489-route-evolution-graph`
