# Material Visual Observation / obs-comp-cand-002708 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002708`
- External reference / 外部参照: `obimd-sub-amjxzogjym`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021284_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/amjxzogjym/amjxzogjym/amjxzogjym.png`
- Checksum / 校验和:
  `3a43b4403f8c6a60e8489b8479d2f4e5522f890807c0adeb15f0f47516b20a6e`
...
- Marked-pixel bounds: (97,19)–(161,231); span 65 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.01%。
- 痕迹范围：(97,19)–(161,231)；跨度65 × 213 px；痕迹矩形高于宽。
