# obs-unk-003121 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003121`
- primary external id: `hust-obc-und-L-003121`
...
- local review image route: `corpus/001_oracle-characters/048_undeciphered-003
  101-003200_obs-unk-bucket_oracle-character-candidates/021_obs-unk-003121_h
  ust-obc-und-L-003121_oracle-character-candidate/03_visual-assets/001_asset
  -004714_hust-obc-und-L-003121_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3121/L_？_5695.jpg`
- asset id: `asset-004714`
...
- source class: `HUST-OBC/undeciphered/L/3121/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3121/L_？_5695.jpg`
- asset id: `asset-004714`
...
- Which source records identify obs-unk-003121 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003121？
