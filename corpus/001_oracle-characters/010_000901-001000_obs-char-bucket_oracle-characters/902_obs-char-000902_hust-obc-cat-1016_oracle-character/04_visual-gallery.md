# obs-char-000902 Visual Gallery / obs-char-000902 图像资料页
...
- Project ID / 项目 ID: `obs-char-000902`
- Primary external reference / 首选外部参考: `hust-obc-cat-1016`
...
## obs-char-000902-visual-source-001 / 图像条目

![obs-char-000902 glyph candidate](03_visual-assets/001_asset-000907_hust-obc-cat-1016_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000907_hust-obc-cat-1016_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000907_hust-obc-cat-1016_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/1016/X_1016_4701_1.png`
