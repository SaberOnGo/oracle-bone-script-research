...
- External category reference: `evobc-cat-12141`
- Source category ID: `12141`
- Source label for human review: `𧆷`
...
- `obs-evo-cand-012141-route-category-staging`
...
- `obs-evo-cand-012141-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012141-route-evolution-graph`
