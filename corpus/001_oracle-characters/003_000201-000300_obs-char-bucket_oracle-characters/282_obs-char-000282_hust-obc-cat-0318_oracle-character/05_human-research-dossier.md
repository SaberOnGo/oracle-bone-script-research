# obs-char-000282 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000282`
- primary external id: `hust-obc-cat-0318`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/282_obs-char-000282_hust-obc-cat-0318_orac
  le-character/03_visual-assets/001_asset-000287_hust-obc-cat-0318_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0318/G_0318_乙5272合1140賓組.png`
- asset id: `asset-000287`
...
- source category: `0318`
- validation class: `281`
- source image route: `HUST-OBC/deciphered/0318/G_0318_乙5272合1140賓組.png`
- asset id: `asset-000287`
...
- English observation: `The compact image shows a small curved enclosure
  with a dark lower base, a short branching mark above, and an open
  extension toward the right.`
- 中文观察: `紧凑图像有小型弧形闭合轮廓和较深的下部底线，上方有短分支痕迹，右侧留有开放延伸。`
...
- dataset label text: `㔴`
- dataset label codepoints: `U+3534`
...
- filename catalog route clues: `Heji-like filename clue: 合1140
  (G_0318_乙5272合1140賓組.png)`
...
- Which source records identify obs-char-000282 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000282？
