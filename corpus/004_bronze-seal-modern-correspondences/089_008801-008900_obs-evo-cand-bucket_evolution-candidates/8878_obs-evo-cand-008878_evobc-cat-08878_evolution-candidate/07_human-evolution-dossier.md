...
- External category reference: `evobc-cat-08878`
- Source category ID: `08878`
- Source label for human review: `轘`
- Source codepoints: `U+8F58`
...
- `obs-evo-cand-008878-route-category-staging`
...
- `obs-evo-cand-008878-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008878-route-evolution-graph`
