...
Project ID: `obs-evo-cand-009113`
...
- Project ID: `obs-evo-cand-009113`
- EVOBC category candidate ID: `evobc-evo-cat-09113`
- External category reference: `evobc-cat-09113`
- Source category ID: `09113`
- Source label for human review: `邳`
- Source codepoints: `U+90B3`
...
- `obs-evo-cand-009113-route-category-staging`
...
- `obs-evo-cand-009113-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009113-route-evolution-graph`
