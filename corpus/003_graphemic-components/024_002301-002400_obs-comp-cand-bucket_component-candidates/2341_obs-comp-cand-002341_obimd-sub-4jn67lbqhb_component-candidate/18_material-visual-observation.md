# Material Visual Observation / obs-comp-cand-002341 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002341`
- External reference / 外部参照: `obimd-sub-4jn67lbqhb`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020379_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4jn67lbqhb/4jn67lbqhb/1f2f72z3xt.png`
- Checksum / 校验和:
  `e7c5f81ff049d97fa4076aef7ef77efc21cc618d9d6819d88478980de2fcb9a3`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.94%.
- Marked-pixel bounds: (62,38)–(187,205); span 126 × 168 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.94%。
- 痕迹范围：(62,38)–(187,205)；跨度126 × 168 px；痕迹矩形高于宽。
