...
- External category reference: `evobc-cat-00590`
- Source category ID: `00590`
- Source label for human review: `䵴`
- Source codepoints: `U+4D74`
...
- `obs-evo-cand-000590-route-category-staging`
...
- `obs-evo-cand-000590-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000590-route-evolution-graph`
