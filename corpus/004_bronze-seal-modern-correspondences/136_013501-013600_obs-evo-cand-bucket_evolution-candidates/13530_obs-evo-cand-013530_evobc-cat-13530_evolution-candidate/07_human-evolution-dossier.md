...
Project ID: `obs-evo-cand-013530`
...
- Project ID: `obs-evo-cand-013530`
- EVOBC category candidate ID: `evobc-evo-cat-13530`
- External category reference: `evobc-cat-13530`
- Source category ID: `13530`
- Source label for human review: `𭟂`
- Source codepoints: `U+2D7C2`
...
- `obs-evo-cand-013530-route-category-staging`
...
- `obs-evo-cand-013530-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013530-route-evolution-graph`
