...
- Project ID: `obs-evo-cand-012761`
- EVOBC category candidate ID: `evobc-evo-cat-12761`
- External category reference: `evobc-cat-12761`
- Source category ID: `12761`
- Source label for human review: `𪒠`
- Source codepoints: `U+2A4A0`
...
- `obs-evo-cand-012761-route-category-staging`
...
- `obs-evo-cand-012761-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012761-route-evolution-graph`
