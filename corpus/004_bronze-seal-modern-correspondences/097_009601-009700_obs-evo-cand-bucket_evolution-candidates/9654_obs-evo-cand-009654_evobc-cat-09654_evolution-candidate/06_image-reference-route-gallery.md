...
- `obs-evo-cand-009654-route-category-staging`
...
- `obs-evo-cand-009654-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009654-route-evolution-graph`
