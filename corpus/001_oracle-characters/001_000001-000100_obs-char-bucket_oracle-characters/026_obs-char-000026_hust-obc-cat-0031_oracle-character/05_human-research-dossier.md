# obs-char-000026 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/026_obs-char-000026_hust-obc-cat-0031_orac
  le-character/03_visual-assets/001_asset-000031_hust-obc-cat-0031_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0031/L_0031_1415.jpg`
- asset id: `asset-000031`
...
- source category: `0031`
- validation class: `25`
- source image route: `HUST-OBC/deciphered/0031/L_0031_1415.jpg`
- asset id: `asset-000031`
...
- English observation: `The low-contrast image shows a branching central
  form with short diagonal strokes extending to both sides.`
...
- dataset label text: `㐕`
- dataset label codepoints: `U+3415`
...
- Which source records identify obs-char-000026 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000026？
