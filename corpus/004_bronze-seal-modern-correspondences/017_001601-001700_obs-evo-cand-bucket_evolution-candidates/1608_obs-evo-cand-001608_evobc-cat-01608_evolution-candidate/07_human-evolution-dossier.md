...
- External category reference: `evobc-cat-01608`
- Source category ID: `01608`
- Source label for human review: `唬`
- Source codepoints: `U+552C`
...
- `obs-evo-cand-001608-route-category-staging`
...
- `obs-evo-cand-001608-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001608-route-evolution-graph`
