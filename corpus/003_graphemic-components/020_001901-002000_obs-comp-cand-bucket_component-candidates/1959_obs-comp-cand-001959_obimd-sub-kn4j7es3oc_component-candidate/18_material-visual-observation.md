# Material Visual Observation / obs-comp-cand-001959 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001959`
- External reference / 外部参照: `obimd-sub-kn4j7es3oc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018769_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/knps4jrxz3/kn4j7es3oc/kn4j7es3oc.png`
- Checksum / 校验和:
  `bf56334745b9cf96b5d459b99844ba565f14562b2cf7363babde0b2344822eb0`
...
- Marked-pixel bounds: (60,27)–(188,216); span 129 × 190 px; the marked
...
- 痕迹范围：(60,27)–(188,216)；跨度129 × 190 px；痕迹矩形高于宽。
