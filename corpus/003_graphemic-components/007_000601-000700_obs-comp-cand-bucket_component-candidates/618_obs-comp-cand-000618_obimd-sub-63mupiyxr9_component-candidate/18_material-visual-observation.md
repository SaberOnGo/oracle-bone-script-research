# Material Visual Observation / obs-comp-cand-000618 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000618`
- External reference / 外部参照: `obimd-sub-63mupiyxr9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013181_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zapprwvtx9/63mupiyxr9/63mupiyxr9.png`
- Checksum / 校验和:
  `836afedd9943bf05b4e4747b18614454155dbaf20f507a9fd85e74ad3dc148ae`
...
- Marked-pixel bounds: (94,23)–(179,232); span 86 × 210 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.00%。
- 痕迹范围：(94,23)–(179,232)；跨度86 × 210 px；痕迹矩形高于宽。
