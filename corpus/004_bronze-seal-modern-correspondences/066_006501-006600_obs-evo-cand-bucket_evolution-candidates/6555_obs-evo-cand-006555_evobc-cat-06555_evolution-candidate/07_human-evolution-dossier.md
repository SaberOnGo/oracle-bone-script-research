...
Project ID: `obs-evo-cand-006555`
...
- Project ID: `obs-evo-cand-006555`
- EVOBC category candidate ID: `evobc-evo-cat-06555`
- External category reference: `evobc-cat-06555`
- Source category ID: `06555`
- Source label for human review: `綫`
- Source codepoints: `U+7DAB`
...
- `obs-evo-cand-006555-route-category-staging`
...
- `obs-evo-cand-006555-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006555-route-evolution-graph`
