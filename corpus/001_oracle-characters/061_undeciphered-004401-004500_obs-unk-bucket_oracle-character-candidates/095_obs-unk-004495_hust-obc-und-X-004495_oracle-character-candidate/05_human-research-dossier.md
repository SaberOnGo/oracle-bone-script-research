# obs-unk-004495 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004495`
- primary external id: `hust-obc-und-X-004495`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/095_obs-unk-004495_h
  ust-obc-und-X-004495_oracle-character-candidate/03_visual-assets/001_asset
  -006088_hust-obc-und-X-004495_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/51/X_？_8235_1.png`
- asset id: `asset-006088`
...
- source class: `HUST-OBC/undeciphered/X/51/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/51/X_？_8235_1.png`
- asset id: `asset-006088`
...
- English observation: `The outer curves, pointed ends, central-right stroke,
  and lower fork are directly recorded.`
- 中文观察: `已直接记录两侧外弧、尖出末端、中央偏右痕迹和下部叉状痕。`
...
- Which source records identify obs-unk-004495 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004495？
