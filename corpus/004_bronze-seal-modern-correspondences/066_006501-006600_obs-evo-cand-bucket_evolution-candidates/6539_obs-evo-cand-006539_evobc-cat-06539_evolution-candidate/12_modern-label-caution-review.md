# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006539
...
- EVOBC candidate category: `evobc-evo-cat-06539`.
- Source label for search only: `綊`.
- Source codepoints for search only: `U+7D8A`.
