...
- External category reference: `evobc-cat-03665`
- Source category ID: `03665`
- Source label for human review: `旄`
- Source codepoints: `U+65C4`
...
- `obs-evo-cand-003665-route-category-staging`
...
- `obs-evo-cand-003665-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003665-route-evolution-graph`
