...
- External category reference: `evobc-cat-05069`
- Source category ID: `05069`
- Source label for human review: `烙`
- Source codepoints: `U+70D9`
...
- `obs-evo-cand-005069-route-category-staging`
...
- `obs-evo-cand-005069-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005069-route-evolution-graph`
