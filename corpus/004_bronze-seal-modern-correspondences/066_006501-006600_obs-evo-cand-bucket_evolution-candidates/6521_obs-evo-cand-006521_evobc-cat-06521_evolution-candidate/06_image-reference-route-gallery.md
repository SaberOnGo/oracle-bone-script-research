...
- `obs-evo-cand-006521-route-category-staging`
...
- `obs-evo-cand-006521-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006521-route-evolution-graph`
