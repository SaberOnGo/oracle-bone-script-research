...
- External category reference: `evobc-cat-11917`
- Source category ID: `11917`
- Source label for human review: `𥹅`
...
- `obs-evo-cand-011917-route-category-staging`
...
- `obs-evo-cand-011917-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011917-route-evolution-graph`
