# obs-comp-cand-002319 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002319`
- 首选外部 ID: `obimd-sub-q66wswcsev`
- OBIMD subcharacter UID: `q66wswcsev`
- OBIMD main character UID: `q66wswcsev`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+B0D4F;U+FD528; U+FD529; 另有 1 项
