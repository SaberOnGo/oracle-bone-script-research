# Material Visual Observation / obs-comp-cand-000877 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000877`
- External reference / 外部参照: `obimd-sub-2yc4b192t5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013949_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/o6m37o3l7o/2yc4b192t5/2yc4b192t5.png`
- Checksum / 校验和:
  `25e82db173a3a5175901daff95b1b1119375c9655c8bff6814b94d67230a3aaa`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.57%.
- Marked-pixel bounds: (102,30)–(147,222); span 46 × 193 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.57%。
- 痕迹范围：(102,30)–(147,222)；跨度46 × 193 px；痕迹矩形高于宽。
