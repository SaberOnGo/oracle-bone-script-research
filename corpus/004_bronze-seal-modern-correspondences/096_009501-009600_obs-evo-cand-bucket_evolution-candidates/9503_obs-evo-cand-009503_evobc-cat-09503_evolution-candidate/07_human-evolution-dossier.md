...
- External category reference: `evobc-cat-09503`
- Source category ID: `09503`
- Source label for human review: `鏝`
- Source codepoints: `U+93DD`
...
- `obs-evo-cand-009503-route-category-staging`
...
- `obs-evo-cand-009503-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009503-route-evolution-graph`
