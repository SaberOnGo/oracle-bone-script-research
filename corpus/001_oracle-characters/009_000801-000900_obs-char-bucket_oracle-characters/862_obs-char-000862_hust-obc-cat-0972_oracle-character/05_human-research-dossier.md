# obs-char-000862 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000862`
- primary external id: `hust-obc-cat-0972`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/862_obs-char-000862_hust-obc-cat-0972_orac
  le-character/03_visual-assets/001_asset-000867_hust-obc-cat-0972_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0972/G_0972_前4.13.5(甲).png`
- asset id: `asset-000867`
...
- source category: `0972`
- validation class: `861`
- source image route: `HUST-OBC/deciphered/0972/G_0972_前4.13.5(甲).png`
- asset id: `asset-000867`
...
- English observation: `A tall narrow outline has pointed upper strokes,
  several parallel interior verticals, and separated lower tips.`
- 中文观察: `高长狭窄轮廓上部有尖形笔画，内部有数条平行竖笔，下端笔尖彼此分离。`
...
- dataset label text: `㟂`
- dataset label codepoints: `U+37C2`
...
- Which source records identify obs-char-000862 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000862？
