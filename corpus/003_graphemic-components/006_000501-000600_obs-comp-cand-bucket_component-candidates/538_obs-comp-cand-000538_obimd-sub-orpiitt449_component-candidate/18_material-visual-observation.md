# Material Visual Observation / obs-comp-cand-000538 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000538`
- External reference / 外部参照: `obimd-sub-orpiitt449`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012772_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/orpiitt449/orpiitt449/orpiitt449.png`
- Checksum / 校验和:
  `7895e3fafbd35dca914268a8f074d2190b560734a00e4e6dd507115f3238cea9`
...
- Marked-pixel bounds: (82,25)–(167,223); span 86 × 199 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.65%。
- 痕迹范围：(82,25)–(167,223)；跨度86 × 199 px；痕迹矩形高于宽。
