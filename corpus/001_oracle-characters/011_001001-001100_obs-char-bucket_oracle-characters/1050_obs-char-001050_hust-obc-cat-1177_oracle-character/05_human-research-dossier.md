# obs-char-001050 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1050_obs-char-001050_hust-obc-cat-1177_ora
  cle-character/03_visual-assets/001_asset-001055_hust-obc-cat-1177_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1177/L_1177_1079.jpg`
- asset id: `asset-001055`
...
- source category: `1177`
- validation class: `1049`
- source image route: `HUST-OBC/deciphered/1177/L_1177_1079.jpg`
- asset id: `asset-001055`
...
- English observation: `A faint gray star-like crossing is connected to a
  short descending stem; the image has low contrast.`
- 中文观察: `较淡灰色星状交叉笔连接短下行笔干；图像对比度较低。`
...
- dataset label text: `㢏`
- dataset label codepoints: `U+388F`
...
- Which source records identify obs-char-001050 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001050？
