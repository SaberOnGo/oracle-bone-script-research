...
- External category reference: `evobc-cat-01948`
- Source category ID: `01948`
- Source label for human review: `墮`
- Source codepoints: `U+58AE`
...
- `obs-evo-cand-001948-route-category-staging`
...
- `obs-evo-cand-001948-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001948-route-evolution-graph`
