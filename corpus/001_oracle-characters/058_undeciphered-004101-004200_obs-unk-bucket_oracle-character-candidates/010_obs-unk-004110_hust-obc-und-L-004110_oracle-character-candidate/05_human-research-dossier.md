# obs-unk-004110 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/010_obs-unk-004110_h
  ust-obc-und-L-004110_oracle-character-candidate/03_visual-assets/001_asset
  -005703_hust-obc-und-L-004110_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4110/L_？_8846.jpg`
- asset id: `asset-005703`
...
- source class: `HUST-OBC/undeciphered/L/4110/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4110/L_？_8846.jpg`
- asset id: `asset-005703`
...
- English observation: The opened image shows repeated short left strokes,
  an angular central cluster, and a separate lower oval mark.
- 中文观察：已打开图像可见左侧短笔画簇、中央折角痕迹和下方椭圆痕迹。
...
- Which source records identify obs-unk-004110 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004110？
