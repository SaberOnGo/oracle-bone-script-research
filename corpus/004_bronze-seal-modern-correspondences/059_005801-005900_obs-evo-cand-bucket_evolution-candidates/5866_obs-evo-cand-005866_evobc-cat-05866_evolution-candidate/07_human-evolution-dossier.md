...
Project ID: `obs-evo-cand-005866`
...
- Project ID: `obs-evo-cand-005866`
- EVOBC category candidate ID: `evobc-evo-cat-05866`
- External category reference: `evobc-cat-05866`
- Source category ID: `05866`
- Source label for human review: `瞿`
- Source codepoints: `U+77BF`
...
- `obs-evo-cand-005866-route-category-staging`
...
- `obs-evo-cand-005866-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005866-route-evolution-graph`
