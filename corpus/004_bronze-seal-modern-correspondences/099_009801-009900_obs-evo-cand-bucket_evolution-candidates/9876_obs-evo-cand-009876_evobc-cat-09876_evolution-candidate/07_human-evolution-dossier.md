...
- External category reference: `evobc-cat-09876`
- Source category ID: `09876`
- Source label for human review: `霿`
- Source codepoints: `U+973F`
...
- `obs-evo-cand-009876-route-category-staging`
...
- `obs-evo-cand-009876-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009876-route-evolution-graph`
