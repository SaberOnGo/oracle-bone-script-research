# Material Visual Observation / obs-comp-cand-000700 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000700`
- External reference / 外部参照: `obimd-sub-dbubnsu1tc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013299_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dbubnsu1tc/dbubnsu1tc/dbubnsu1tc.png`
- Checksum / 校验和:
  `14506e0358afda493fe1acff6dc3647275bca6c1f2c3a24bcc9f51b060315eef`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.35%.
- Marked-pixel bounds: (84,17)–(158,231); span 75 × 215 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.35%。
- 痕迹范围：(84,17)–(158,231)；跨度75 × 215 px；痕迹矩形高于宽。
