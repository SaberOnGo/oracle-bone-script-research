...
Project ID: `obs-evo-cand-005516`
...
- Project ID: `obs-evo-cand-005516`
- EVOBC category candidate ID: `evobc-evo-cat-05516`
- External category reference: `evobc-cat-05516`
- Source category ID: `05516`
- Source label for human review: `瓻`
- Source codepoints: `U+74FB`
...
- `obs-evo-cand-005516-route-category-staging`
...
- `obs-evo-cand-005516-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005516-route-evolution-graph`
