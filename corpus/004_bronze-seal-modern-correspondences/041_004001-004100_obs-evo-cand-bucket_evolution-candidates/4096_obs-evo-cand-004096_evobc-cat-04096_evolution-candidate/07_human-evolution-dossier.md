...
Project ID: `obs-evo-cand-004096`
...
- Project ID: `obs-evo-cand-004096`
- EVOBC category candidate ID: `evobc-evo-cat-04096`
- External category reference: `evobc-cat-04096`
- Source category ID: `04096`
- Source label for human review: `棘`
- Source codepoints: `U+68D8`
...
- `obs-evo-cand-004096-route-category-staging`
...
- `obs-evo-cand-004096-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004096-route-evolution-graph`
