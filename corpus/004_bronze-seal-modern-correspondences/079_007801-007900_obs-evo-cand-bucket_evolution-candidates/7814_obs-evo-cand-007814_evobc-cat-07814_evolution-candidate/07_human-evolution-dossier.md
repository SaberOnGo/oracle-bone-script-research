...
Project ID: `obs-evo-cand-007814`
...
- Project ID: `obs-evo-cand-007814`
- EVOBC category candidate ID: `evobc-evo-cat-07814`
- External category reference: `evobc-cat-07814`
- Source category ID: `07814`
- Source label for human review: `蝠`
- Source codepoints: `U+8760`
...
- `obs-evo-cand-007814-route-category-staging`
...
- `obs-evo-cand-007814-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007814-route-evolution-graph`
