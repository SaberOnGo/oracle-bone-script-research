...
- External category reference: `evobc-cat-09336`
- Source category ID: `09336`
- Source label for human review: `鈔`
...
- `obs-evo-cand-009336-route-category-staging`
...
- `obs-evo-cand-009336-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009336-route-evolution-graph`
