# obs-unk-002788 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002788`
- primary external id: `hust-obc-und-L-002788`
...
- local review image route: `corpus/001_oracle-characters/044_undeciphered-002
  701-002800_obs-unk-bucket_oracle-character-candidates/088_obs-unk-002788_h
  ust-obc-und-L-002788_oracle-character-candidate/03_visual-assets/001_asset
  -004381_hust-obc-und-L-002788_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2788/L_？_4599.jpg`
- asset id: `asset-004381`
...
- source class: `HUST-OBC/undeciphered/L/2788/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2788/L_？_4599.jpg`
- asset id: `asset-004381`
...
- Which source records identify obs-unk-002788 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002788？
