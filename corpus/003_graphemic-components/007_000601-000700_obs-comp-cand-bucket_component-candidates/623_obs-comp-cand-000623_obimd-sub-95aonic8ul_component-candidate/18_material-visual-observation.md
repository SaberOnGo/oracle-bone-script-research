# Material Visual Observation / obs-comp-cand-000623 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000623`
- External reference / 外部参照: `obimd-sub-95aonic8ul`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013186_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/61p261idyu/95aonic8ul/95aonic8ul.png`
- Checksum / 校验和:
  `2354c91fa09837dc81bc5911f463f8aef2231c4a316d9f9d458e1e3671cf9651`
...
- Marked-pixel bounds: (80,20)–(172,234); span 93 × 215 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.87%。
- 痕迹范围：(80,20)–(172,234)；跨度93 × 215 px；痕迹矩形高于宽。
