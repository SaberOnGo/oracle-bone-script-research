...
Project ID: `obs-insc-cw-cand-000300`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000300`
...
- Yingguo / 英国所藏: `y1937` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `266` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `6` in source row; primary catalog entry pending
- Heji / 合集: `40995` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000300`
