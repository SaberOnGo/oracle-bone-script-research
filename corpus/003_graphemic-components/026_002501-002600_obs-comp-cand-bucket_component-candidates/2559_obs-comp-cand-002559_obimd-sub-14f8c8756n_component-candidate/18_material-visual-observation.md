# Material Visual Observation / obs-comp-cand-002559 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002559`
- External reference / 外部参照: `obimd-sub-14f8c8756n`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021091_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cc3pkwk0li/14f8c8756n/14f8c8756n.png`
- Checksum / 校验和:
  `8c68a1f1ac961ed120737d5a73a3009e4b2ad98ce7968862ad93b1f318add52a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.27%.
- Marked-pixel bounds: (87,39)–(165,207); span 79 × 169 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.27%。
- 痕迹范围：(87,39)–(165,207)；跨度79 × 169 px；痕迹矩形高于宽。
