# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002799
...
- EVOBC candidate category: `evobc-evo-cat-02799`.
- Source label for search only: `弜`.
- Source codepoints for search only: `U+5F1C`.
