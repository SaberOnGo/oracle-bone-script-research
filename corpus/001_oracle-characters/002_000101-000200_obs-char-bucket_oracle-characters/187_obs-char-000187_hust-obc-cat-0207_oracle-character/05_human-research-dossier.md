# obs-char-000187 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000187`
- primary external id: `hust-obc-cat-0207`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/187_obs-char-000187_hust-obc-cat-0207_orac
  le-character/03_visual-assets/001_asset-000192_hust-obc-cat-0207_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0207/G_0207_甲3365(甲).png`
- asset id: `asset-000192`
...
- source category: `0207`
- validation class: `186`
- source image route: `HUST-OBC/deciphered/0207/G_0207_甲3365(甲).png`
- asset id: `asset-000192`
...
- English observation: `The image has a compact banded upper cluster, a
  central descending group of strokes, and irregular side projections.`
- 中文观察: `图像上方有紧凑带状笔群，中部有分组下行笔，两侧有不规则伸出笔。`
...
- dataset label text: `㓅`
- dataset label codepoints: `U+34C5`
...
- Which source records identify obs-char-000187 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000187？
