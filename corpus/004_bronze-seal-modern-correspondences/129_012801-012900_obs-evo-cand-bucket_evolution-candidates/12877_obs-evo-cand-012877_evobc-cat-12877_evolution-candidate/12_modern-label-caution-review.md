# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012877
...
- EVOBC candidate category: `evobc-evo-cat-12877`.
- Source label for search only: `𪶍`.
- Source codepoints for search only: `U+2AD8D`.
