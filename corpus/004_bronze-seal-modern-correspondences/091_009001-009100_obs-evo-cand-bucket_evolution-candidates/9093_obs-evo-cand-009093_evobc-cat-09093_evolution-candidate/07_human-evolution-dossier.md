...
Project ID: `obs-evo-cand-009093`
...
- Project ID: `obs-evo-cand-009093`
- EVOBC category candidate ID: `evobc-evo-cat-09093`
- External category reference: `evobc-cat-09093`
- Source category ID: `09093`
- Source label for human review: `邛`
- Source codepoints: `U+909B`
...
- `obs-evo-cand-009093-route-category-staging`
...
- `obs-evo-cand-009093-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009093-route-evolution-graph`
