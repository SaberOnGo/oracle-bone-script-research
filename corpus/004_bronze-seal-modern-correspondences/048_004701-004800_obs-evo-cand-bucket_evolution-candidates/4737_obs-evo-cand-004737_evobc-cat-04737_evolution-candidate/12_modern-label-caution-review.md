# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004737
...
- EVOBC candidate category: `evobc-evo-cat-04737`.
- Source label for search only: `深`.
- Source codepoints for search only: `U+6DF1`.
