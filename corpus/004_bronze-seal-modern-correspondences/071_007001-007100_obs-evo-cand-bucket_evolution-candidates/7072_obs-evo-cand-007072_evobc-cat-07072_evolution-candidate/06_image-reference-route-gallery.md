...
- `obs-evo-cand-007072-route-category-staging`
...
- `obs-evo-cand-007072-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007072-route-evolution-graph`
