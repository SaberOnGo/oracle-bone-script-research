...
- External category reference: `evobc-cat-06106`
- Source category ID: `06106`
- Source label for human review: `稬`
- Source codepoints: `U+7A2C`
...
- `obs-evo-cand-006106-route-category-staging`
...
- `obs-evo-cand-006106-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006106-route-evolution-graph`
