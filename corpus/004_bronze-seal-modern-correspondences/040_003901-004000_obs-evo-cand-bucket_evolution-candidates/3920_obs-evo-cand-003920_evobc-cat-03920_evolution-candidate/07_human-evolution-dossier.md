...
Project ID: `obs-evo-cand-003920`
...
- Project ID: `obs-evo-cand-003920`
- EVOBC category candidate ID: `evobc-evo-cat-03920`
- External category reference: `evobc-cat-03920`
- Source category ID: `03920`
- Source label for human review: `析`
- Source codepoints: `U+6790`
...
- `obs-evo-cand-003920-route-category-staging`
...
- `obs-evo-cand-003920-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003920-route-evolution-graph`
