...
Project ID: `obs-evo-cand-006643`
...
- Project ID: `obs-evo-cand-006643`
- EVOBC category candidate ID: `evobc-evo-cat-06643`
- External category reference: `evobc-cat-06643`
- Source category ID: `06643`
- Source label for human review: `縫`
- Source codepoints: `U+7E2B`
...
- `obs-evo-cand-006643-route-category-staging`
...
- `obs-evo-cand-006643-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006643-route-evolution-graph`
