# obs-comp-cand-000905 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000905`
- 首选外部 ID: `obimd-sub-rfxejqz8as`
- OBIMD subcharacter UID: `rfxejqz8as`
- OBIMD main character UID: `rfxejqz8as`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+F5132; U+F5133; 另有 3 项
