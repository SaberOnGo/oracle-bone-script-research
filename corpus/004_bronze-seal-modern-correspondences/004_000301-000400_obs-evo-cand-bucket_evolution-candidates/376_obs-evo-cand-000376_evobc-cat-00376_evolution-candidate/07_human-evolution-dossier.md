...
- External category reference: `evobc-cat-00376`
- Source category ID: `00376`
- Source label for human review: `䒤`
- Source codepoints: `U+44A4`
...
- `obs-evo-cand-000376-route-category-staging`
...
- `obs-evo-cand-000376-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000376-route-evolution-graph`
