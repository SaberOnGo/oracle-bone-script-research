# Material Visual Observation / obs-comp-cand-001776 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001776`
- External reference / 外部参照: `obimd-sub-27rbdclns4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017977_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8sbbzthl9w/27rbdclns4/27rbdclns4.png`
- Checksum / 校验和:
  `a639d08545202e0b316b3e9b352737539e513cdcf7917c9055c43e1e23ede84b`
...
- Marked-pixel bounds: (74,47)–(175,212); span 102 × 166 px; the marked
...
- 痕迹范围：(74,47)–(175,212)；跨度102 × 166 px；痕迹矩形高于宽。
