# obs-comp-cand-001275 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001275`
- 首选外部 ID: `obimd-sub-si8qqdmshi`
- OBIMD subcharacter UID: `si8qqdmshi`
- OBIMD main character UID: `si8qqdmshi`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+5F81;U+F754C; U+F754D
