...
- `obs-evo-cand-011392-route-category-staging`
...
- `obs-evo-cand-011392-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011392-route-evolution-graph`
