# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002560
...
- EVOBC candidate category: `evobc-evo-cat-02560`.
- Source label for search only: `崋`.
- Source codepoints for search only: `U+5D0B`.
