# Material Visual Observation / obs-comp-cand-002697 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002697`
- External reference / 外部参照: `obimd-sub-5maxp2o3xc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021273_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5maxp2o3xc/5maxp2o3xc/5maxp2o3xc.png`
- Checksum / 校验和:
  `b560902abd0035c60e354157d75adab0480770203f9eb38ce43e43bc395417d6`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.52%.
- Marked-pixel bounds: (89,17)–(164,229); span 76 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.52%。
- 痕迹范围：(89,17)–(164,229)；跨度76 × 213 px；痕迹矩形高于宽。
