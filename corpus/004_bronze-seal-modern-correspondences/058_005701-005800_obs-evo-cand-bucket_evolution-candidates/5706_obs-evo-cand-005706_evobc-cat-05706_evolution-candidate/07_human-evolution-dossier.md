...
- Project ID: `obs-evo-cand-005706`
- EVOBC category candidate ID: `evobc-evo-cat-05706`
- External category reference: `evobc-cat-05706`
- Source category ID: `05706`
- Source label for human review: `癰`
- Source codepoints: `U+7670`
...
- `obs-evo-cand-005706-route-category-staging`
...
- `obs-evo-cand-005706-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005706-route-evolution-graph`
