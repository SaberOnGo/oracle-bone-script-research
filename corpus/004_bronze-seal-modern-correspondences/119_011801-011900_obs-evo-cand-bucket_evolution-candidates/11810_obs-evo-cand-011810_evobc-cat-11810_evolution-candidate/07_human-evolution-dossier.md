...
Project ID: `obs-evo-cand-011810`
...
- Project ID: `obs-evo-cand-011810`
- EVOBC category candidate ID: `evobc-evo-cat-11810`
- External category reference: `evobc-cat-11810`
- Source category ID: `11810`
- Source label for human review: `𥘒`
- Source codepoints: `U+25612`
...
- `obs-evo-cand-011810-route-category-staging`
...
- `obs-evo-cand-011810-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011810-route-evolution-graph`
