# obs-char-001409 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001409`
- primary external id: `hust-obc-cat-1578`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1409_obs-char-001409_hust-obc-cat-1578_ora
  cle-character/03_visual-assets/001_asset-001414_hust-obc-cat-1578_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1578/G_1578_七R5.png`
- asset id: `asset-001414`
...
- source category: `1578`
- validation class: `1408`
- source image route: `HUST-OBC/deciphered/1578/G_1578_七R5.png`
- asset id: `asset-001414`
...
- English observation: `Two tall stems have short upper caps, inner
  branches, and long lower strokes.`
- 中文观察: `两条高大竖干有短上盖、内部枝笔和长下部笔画。`
...
- dataset label text: `㨠`
- dataset label codepoints: `U+3A20`
...
- Which source records identify obs-char-001409 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001409？
