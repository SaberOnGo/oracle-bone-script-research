...
- External category reference: `evobc-cat-13054`
- Source category ID: `13054`
- Source label for human review: `𫪟`
...
- `obs-evo-cand-013054-route-category-staging`
...
- `obs-evo-cand-013054-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013054-route-evolution-graph`
