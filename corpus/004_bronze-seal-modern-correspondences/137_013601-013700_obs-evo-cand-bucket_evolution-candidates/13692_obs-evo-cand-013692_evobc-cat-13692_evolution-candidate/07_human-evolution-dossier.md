...
- External category reference: `evobc-cat-13692`
- Source category ID: `13692`
- Source label for human review: `𮫦`
- Source codepoints: `U+2EAE6`
...
- `obs-evo-cand-013692-route-category-staging`
...
- `obs-evo-cand-013692-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013692-route-evolution-graph`
