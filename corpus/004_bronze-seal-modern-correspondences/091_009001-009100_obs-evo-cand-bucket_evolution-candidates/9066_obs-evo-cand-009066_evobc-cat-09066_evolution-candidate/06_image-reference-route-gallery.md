...
- `obs-evo-cand-009066-route-category-staging`
...
- `obs-evo-cand-009066-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009066-route-evolution-graph`
