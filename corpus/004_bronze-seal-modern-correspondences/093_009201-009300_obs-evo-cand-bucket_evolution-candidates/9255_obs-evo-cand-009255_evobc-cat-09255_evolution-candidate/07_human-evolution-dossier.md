...
- External category reference: `evobc-cat-09255`
- Source category ID: `09255`
- Source label for human review: `酲`
...
- `obs-evo-cand-009255-route-category-staging`
...
- `obs-evo-cand-009255-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009255-route-evolution-graph`
