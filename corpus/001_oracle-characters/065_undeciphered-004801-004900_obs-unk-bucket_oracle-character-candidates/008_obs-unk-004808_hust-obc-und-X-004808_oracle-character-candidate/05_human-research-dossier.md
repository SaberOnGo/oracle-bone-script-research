# obs-unk-004808 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/008_obs-unk-004808_h
  ust-obc-und-X-004808_oracle-character-candidate/03_visual-assets/001_asset
  -006401_hust-obc-und-X-004808_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/364/X_？_7347_1.png`
- asset id: `asset-006401`
...
- source class: `HUST-OBC/undeciphered/X/364/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/364/X_？_7347_1.png`
- asset id: `asset-006401`
...
- English observation: `three openings in a broad horizontal group`
- 中文观察: `宽大横向结构中的三个开口`
...
- Which source records identify obs-unk-004808 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004808？
