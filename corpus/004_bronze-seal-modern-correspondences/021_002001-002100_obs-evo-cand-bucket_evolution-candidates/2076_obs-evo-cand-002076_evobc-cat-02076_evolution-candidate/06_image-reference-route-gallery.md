...
- `obs-evo-cand-002076-route-category-staging`
...
- `obs-evo-cand-002076-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002076-route-evolution-graph`
