...
- Project ID: `obs-evo-cand-010964`
- EVOBC category candidate ID: `evobc-evo-cat-10964`
- External category reference: `evobc-cat-10964`
- Source category ID: `10964`
- Source label for human review: `𡄑`
- Source codepoints: `U+21111`
...
- `obs-evo-cand-010964-route-category-staging`
...
- `obs-evo-cand-010964-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010964-route-evolution-graph`
