...
- External category reference: `evobc-cat-07668`
- Source category ID: `07668`
- Source label for human review: `蘙`
- Source codepoints: `U+8619`
...
- `obs-evo-cand-007668-route-category-staging`
...
- `obs-evo-cand-007668-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007668-route-evolution-graph`
