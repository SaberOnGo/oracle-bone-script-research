...
- Project ID: `obs-evo-cand-001161`
- EVOBC category candidate ID: `evobc-evo-cat-01161`
- External category reference: `evobc-cat-01161`
- Source category ID: `01161`
- Source label for human review: `凥`
- Source codepoints: `U+51E5`
...
- `obs-evo-cand-001161-route-category-staging`
...
- `obs-evo-cand-001161-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001161-route-evolution-graph`
