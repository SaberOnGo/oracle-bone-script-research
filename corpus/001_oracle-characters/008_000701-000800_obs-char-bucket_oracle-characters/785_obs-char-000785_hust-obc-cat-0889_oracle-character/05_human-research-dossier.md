# obs-char-000785 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000785`
- primary external id: `hust-obc-cat-0889`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/785_obs-char-000785_hust-obc-cat-0889_orac
  le-character/03_visual-assets/001_asset-000790_hust-obc-cat-0889_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0889/G_0889_佚270(甲).png`
- asset id: `asset-000790`
...
- source category: `0889`
- validation class: `784`
- source image route: `HUST-OBC/deciphered/0889/G_0889_佚270(甲).png`
- asset id: `asset-000790`
...
- English observation: `A long thin crescent-like outline encloses several
  angular inner strokes and tapers into a separate-looking lower point and
  tail.`
- 中文观察: `长而细的月牙状轮廓围住数条折角内笔，并收束为近似分离的下尖和尾笔。`
...
- dataset label text: `㝯`
- dataset label codepoints: `U+376F`
...
- Which source records identify obs-char-000785 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000785？
