...
Project ID: `obs-evo-cand-006389`
...
- Project ID: `obs-evo-cand-006389`
- EVOBC category candidate ID: `evobc-evo-cat-06389`
- External category reference: `evobc-cat-06389`
- Source category ID: `06389`
- Source label for human review: `米`
- Source codepoints: `U+7C73`
...
- `obs-evo-cand-006389-route-category-staging`
...
- `obs-evo-cand-006389-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006389-route-evolution-graph`
