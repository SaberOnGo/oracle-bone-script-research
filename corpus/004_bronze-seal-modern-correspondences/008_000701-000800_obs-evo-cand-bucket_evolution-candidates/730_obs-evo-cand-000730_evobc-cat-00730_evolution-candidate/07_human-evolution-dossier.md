...
- External category reference: `evobc-cat-00730`
- Source category ID: `00730`
- Source label for human review: `从`
- Source codepoints: `U+4ECE`
- Image reference count in source metadata: `129`
...
- `obs-evo-cand-000730-route-category-staging`
...
- `obs-evo-cand-000730-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000730-route-evolution-graph`
