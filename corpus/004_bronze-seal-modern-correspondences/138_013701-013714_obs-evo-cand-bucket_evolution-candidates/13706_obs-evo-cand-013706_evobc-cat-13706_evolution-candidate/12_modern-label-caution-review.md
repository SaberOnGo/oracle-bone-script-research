# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013706
...
- EVOBC candidate category: `evobc-evo-cat-13706`.
- Source label for search only: `烈`.
- Source codepoints for search only: `U+F99F`.
