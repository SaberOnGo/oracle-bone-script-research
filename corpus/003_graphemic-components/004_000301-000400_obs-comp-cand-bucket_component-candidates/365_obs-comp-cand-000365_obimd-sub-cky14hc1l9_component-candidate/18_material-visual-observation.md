# Material Visual Observation / obs-comp-cand-000365 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000365`
- External reference / 外部参照: `obimd-sub-cky14hc1l9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012288_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cky14hc1l9/cky14hc1l9/cky14hc1l9.png`
- Checksum / 校验和:
  `55ae60532adb229fe9872aea390cbed49dfa276fb574cc6246e21086e1fa7245`
...
- Marked-pixel bounds: (76,20)–(173,210); span 98 × 191 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.02%。
- 痕迹范围：(76,20)–(173,210)；跨度98 × 191 px；痕迹矩形高于宽。
