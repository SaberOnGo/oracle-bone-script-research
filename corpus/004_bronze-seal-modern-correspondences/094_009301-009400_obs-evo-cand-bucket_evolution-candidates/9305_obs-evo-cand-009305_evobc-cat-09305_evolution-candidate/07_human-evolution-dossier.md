...
- External category reference: `evobc-cat-09305`
- Source category ID: `09305`
- Source label for human review: `釗`
...
- `obs-evo-cand-009305-route-category-staging`
...
- `obs-evo-cand-009305-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009305-route-evolution-graph`
