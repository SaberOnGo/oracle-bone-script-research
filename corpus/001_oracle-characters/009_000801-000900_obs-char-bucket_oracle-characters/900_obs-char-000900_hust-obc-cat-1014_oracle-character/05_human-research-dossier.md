# obs-char-000900 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/900_obs-char-000900_hust-obc-cat-1014_orac
  le-character/03_visual-assets/001_asset-000905_hust-obc-cat-1014_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1014/G_1014_佚708合30413無名組.png`
- asset id: `asset-000905`
...
- source category: `1014`
- validation class: `899`
- source image route: `HUST-OBC/deciphered/1014/G_1014_佚708合30413無名組.png`
- asset id: `asset-000905`
...
- English observation: `A narrow form has an angular upper-left stroke, a
  long descending curve, and an open lower loop with short side
  projections.`
...
- dataset label text: `㟬`
- dataset label codepoints: `U+37EC`
...
- filename catalog route clues: `Heji-like filename clue: 合30413
...
- Which source records identify obs-char-000900 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000900？
