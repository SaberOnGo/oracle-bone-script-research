...
- External category reference: `evobc-cat-08756`
- Source category ID: `08756`
- Source label for human review: `蹎`
...
- `obs-evo-cand-008756-route-category-staging`
...
- `obs-evo-cand-008756-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008756-route-evolution-graph`
