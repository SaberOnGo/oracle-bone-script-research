...
- External category reference: `evobc-cat-10568`
- Source category ID: `10568`
- Source label for human review: `鷺`
- Source codepoints: `U+9DFA`
...
- `obs-evo-cand-010568-route-category-staging`
...
- `obs-evo-cand-010568-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010568-route-evolution-graph`
