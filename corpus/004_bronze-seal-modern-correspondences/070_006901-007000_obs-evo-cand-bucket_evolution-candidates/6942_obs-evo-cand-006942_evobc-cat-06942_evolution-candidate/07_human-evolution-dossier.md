...
Project ID: `obs-evo-cand-006942`
...
- Project ID: `obs-evo-cand-006942`
- EVOBC category candidate ID: `evobc-evo-cat-06942`
- External category reference: `evobc-cat-06942`
- Source category ID: `06942`
- Source label for human review: `聋`
- Source codepoints: `U+804B`
...
- `obs-evo-cand-006942-route-category-staging`
...
- `obs-evo-cand-006942-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006942-route-evolution-graph`
