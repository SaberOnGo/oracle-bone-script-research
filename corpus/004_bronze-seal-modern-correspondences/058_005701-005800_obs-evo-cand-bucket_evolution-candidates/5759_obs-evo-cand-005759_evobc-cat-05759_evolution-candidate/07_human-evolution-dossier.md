...
Project ID: `obs-evo-cand-005759`
...
- Project ID: `obs-evo-cand-005759`
- EVOBC category candidate ID: `evobc-evo-cat-05759`
- External category reference: `evobc-cat-05759`
- Source category ID: `05759`
- Source label for human review: `盠`
- Source codepoints: `U+76E0`
...
- `obs-evo-cand-005759-route-category-staging`
...
- `obs-evo-cand-005759-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005759-route-evolution-graph`
