# Material Visual Observation / obs-comp-cand-002375 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002375`
- External reference / 外部参照: `obimd-sub-ubq4rpw1wu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020446_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ubq4rpw1wu/ubq4rpw1wu/ubq4rpw1wu.png`
- Checksum / 校验和:
  `223790825d5f528f1cd9e4ac3e8b1f5bfe374190f21b88e4248c384f58dde5cd`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.55%.
- Marked-pixel bounds: (76,40)–(173,205); span 98 × 166 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.55%。
- 痕迹范围：(76,40)–(173,205)；跨度98 × 166 px；痕迹矩形高于宽。
