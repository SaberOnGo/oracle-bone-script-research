# Material Visual Observation / obs-comp-cand-000149 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000149`
- External reference / 外部参照: `obimd-sub-pfscmtnqbm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011561_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/pfscmtnqbm/pfscmtnqbm/pfscmtnqbm.png`
- Checksum / 校验和:
  `13f6fbeb4173f2fd5f6b5b899acd00884f6f17bfe26189914947faabacfe40bf`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.69%.
- Marked-pixel bounds: (58,27)–(191,218); span 134 × 192 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.69%。
- 痕迹范围：(58,27)–(191,218)；跨度134 × 192 px；痕迹矩形高于宽。
