...
- External category reference: `evobc-cat-10501`
- Source category ID: `10501`
- Source label for human review: `鴲`
...
- `obs-evo-cand-010501-route-category-staging`
...
- `obs-evo-cand-010501-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010501-route-evolution-graph`
