...
Project ID: `obs-evo-cand-002564`
...
- Project ID: `obs-evo-cand-002564`
- EVOBC category candidate ID: `evobc-evo-cat-02564`
- External category reference: `evobc-cat-02564`
- Source category ID: `02564`
- Source label for human review: `崔`
- Source codepoints: `U+5D14`
...
- `obs-evo-cand-002564-route-category-staging`
...
- `obs-evo-cand-002564-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002564-route-evolution-graph`
