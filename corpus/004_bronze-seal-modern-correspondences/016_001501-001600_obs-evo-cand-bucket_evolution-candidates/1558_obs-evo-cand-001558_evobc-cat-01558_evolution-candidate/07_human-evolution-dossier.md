...
- External category reference: `evobc-cat-01558`
- Source category ID: `01558`
- Source label for human review: `咎`
- Source codepoints: `U+548E`
- Image reference count in source metadata: `181`
...
- `obs-evo-cand-001558-route-category-staging`
...
- `obs-evo-cand-001558-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001558-route-evolution-graph`
