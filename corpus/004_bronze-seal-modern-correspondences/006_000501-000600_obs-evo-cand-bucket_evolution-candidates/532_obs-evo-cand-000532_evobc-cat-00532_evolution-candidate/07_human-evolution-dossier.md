...
Project ID: `obs-evo-cand-000532`
...
- Project ID: `obs-evo-cand-000532`
- EVOBC category candidate ID: `evobc-evo-cat-00532`
- External category reference: `evobc-cat-00532`
- Source category ID: `00532`
- Source label for human review: `䧿`
- Source codepoints: `U+49FF`
...
- `obs-evo-cand-000532-route-category-staging`
...
- `obs-evo-cand-000532-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000532-route-evolution-graph`
