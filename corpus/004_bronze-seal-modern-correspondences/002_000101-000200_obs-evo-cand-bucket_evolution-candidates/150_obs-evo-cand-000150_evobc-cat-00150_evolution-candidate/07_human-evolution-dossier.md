...
- External category reference: `evobc-cat-00150`
- Source category ID: `00150`
- Source label for human review: `㪚`
...
- `obs-evo-cand-000150-route-category-staging`
...
- `obs-evo-cand-000150-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000150-route-evolution-graph`
