...
- External category reference: `evobc-cat-07459`
- Source category ID: `07459`
- Source label for human review: `落`
- Source codepoints: `U+843D`
...
- `obs-evo-cand-007459-route-category-staging`
...
- `obs-evo-cand-007459-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007459-route-evolution-graph`
