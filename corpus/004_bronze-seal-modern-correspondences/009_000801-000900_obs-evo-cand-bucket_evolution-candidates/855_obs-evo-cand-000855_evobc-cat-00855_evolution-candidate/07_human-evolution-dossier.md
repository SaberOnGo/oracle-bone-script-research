...
- External category reference: `evobc-cat-00855`
- Source category ID: `00855`
- Source label for human review: `依`
- Source codepoints: `U+4F9D`
...
- `obs-evo-cand-000855-route-category-staging`
...
- `obs-evo-cand-000855-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000855-route-evolution-graph`
