# obs-unk-004414 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/014_obs-unk-004414_h
  ust-obc-und-L-004414_oracle-character-candidate/03_visual-assets/001_asset
  -006007_hust-obc-und-L-004414_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4414/L_？_9869.jpg`
- asset id: `asset-006007`
...
- source class: `HUST-OBC/undeciphered/L/4414/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4414/L_？_9869.jpg`
- asset id: `asset-006007`
...
- English observation: `A small upper cap sits above a dark diagonal`
  `and open lower outline.`
- 中文观察: `上部短盖状轮廓位于较深斜痕和下部开放轮廓之上。`
...
- Which source records identify obs-unk-004414 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004414？
