...
- Project ID: `obs-evo-cand-010516`
- EVOBC category candidate ID: `evobc-evo-cat-10516`
- External category reference: `evobc-cat-10516`
- Source category ID: `10516`
- Source label for human review: `鵠`
- Source codepoints: `U+9D60`
...
- `obs-evo-cand-010516-route-category-staging`
...
- `obs-evo-cand-010516-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010516-route-evolution-graph`
