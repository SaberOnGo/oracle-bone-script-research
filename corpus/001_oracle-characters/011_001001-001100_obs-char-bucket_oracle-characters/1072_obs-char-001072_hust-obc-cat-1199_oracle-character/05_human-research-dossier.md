# obs-char-001072 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1072_obs-char-001072_hust-obc-cat-1199_ora
  cle-character/03_visual-assets/001_asset-001077_hust-obc-cat-1199_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1199/G_1199_史購270.png`
- asset id: `asset-001077`
...
- source category: `1199`
- validation class: `1071`
- source image route: `HUST-OBC/deciphered/1199/G_1199_史購270.png`
- asset id: `asset-001077`
...
- dataset label text: `㢥`
- dataset label codepoints: `U+38A5`
...
- Which source records identify obs-char-001072 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001072？
