# Material Visual Observation / obs-comp-cand-000571 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000571`
- External reference / 外部参照: `obimd-sub-kzzehs3b2j`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012823_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kzzehs3b2j/kzzehs3b2j/kzzehs3b2j.png`
- Checksum / 校验和:
  `246991e4d08f4d10051eb88e72b68e1a95b073780902bf40e77bdfbb1fa8f96b`
...
- Marked-pixel bounds: (87,24)–(162,223); span 76 × 200 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.04%。
- 痕迹范围：(87,24)–(162,223)；跨度76 × 200 px；痕迹矩形高于宽。
