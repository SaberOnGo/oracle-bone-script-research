# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004634
...
- EVOBC candidate category: `evobc-evo-cat-04634`.
- Source label for search only: `洫`.
- Source codepoints for search only: `U+6D2B`.
