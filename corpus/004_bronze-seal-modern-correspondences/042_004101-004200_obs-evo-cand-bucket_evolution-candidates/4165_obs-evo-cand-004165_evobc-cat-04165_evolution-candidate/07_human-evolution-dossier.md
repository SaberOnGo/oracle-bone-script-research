...
- External category reference: `evobc-cat-04165`
- Source category ID: `04165`
- Source label for human review: `楮`
- Source codepoints: `U+696E`
...
- `obs-evo-cand-004165-route-category-staging`
...
- `obs-evo-cand-004165-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004165-route-evolution-graph`
