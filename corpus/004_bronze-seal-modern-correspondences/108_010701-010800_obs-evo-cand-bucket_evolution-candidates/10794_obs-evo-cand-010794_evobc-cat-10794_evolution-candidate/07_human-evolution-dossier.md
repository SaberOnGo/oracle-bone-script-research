...
Project ID: `obs-evo-cand-010794`
...
- Project ID: `obs-evo-cand-010794`
- EVOBC category candidate ID: `evobc-evo-cat-10794`
- External category reference: `evobc-cat-10794`
- Source category ID: `10794`
- Source label for human review: `𠈪`
- Source codepoints: `U+2022A`
...
- `obs-evo-cand-010794-route-category-staging`
...
- `obs-evo-cand-010794-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010794-route-evolution-graph`
