# obs-char-001063 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001063`
- primary external id: `hust-obc-cat-1190`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1063_obs-char-001063_hust-obc-cat-1190_ora
  cle-character/03_visual-assets/001_asset-001068_hust-obc-cat-1190_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1190/G_1190_林1.18.14合17612賓組.pn
  g`
- asset id: `asset-001068`
...
- source category: `1190`
- validation class: `1062`
- source image route: `HUST-OBC/deciphered/1190/G_1190_林1.18.14合17612賓組.png`
- asset id: `asset-001068`
...
- English observation: `Two thin upright strokes stand apart, each with a
  forked upper end and short lower side branches.`
- 中文观察: `两条纤细直立笔彼此分离，各自有分叉上端和短下部侧分枝。`
...
- dataset label text: `㢜`
- dataset label codepoints: `U+389C`
...
- filename catalog route clues: `Heji-like filename clue: 合17612
  (G_1190_林1.18.14合17612賓組.png)`
...
- Which source records identify obs-char-001063 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001063？
