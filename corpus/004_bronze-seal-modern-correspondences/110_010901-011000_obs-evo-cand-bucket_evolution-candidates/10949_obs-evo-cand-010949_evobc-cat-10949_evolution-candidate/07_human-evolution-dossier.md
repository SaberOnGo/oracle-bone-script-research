...
- External category reference: `evobc-cat-10949`
- Source category ID: `10949`
- Source label for human review: `𠷗`
- Source codepoints: `U+20DD7`
...
- `obs-evo-cand-010949-route-category-staging`
...
- `obs-evo-cand-010949-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010949-route-evolution-graph`
