# obs-char-001045 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001045`
- primary external id: `hust-obc-cat-1171_1172`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1045_obs-char-001045_hust-obc-cat-1171_117
  2_oracle-character/03_visual-assets/001_asset-001050_hust-obc-cat-1171_117
  2_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1171_1172/1171/G_1171_前1.9.6(甲)
  .png`
- asset id: `asset-001050`
...
- source category: `1171_1172`
- validation class: `1044`
- source image route: `HUST-OBC/deciphered/1171_1172/1171/G_1171_前1.9.6(甲).png
  `
- asset id: `asset-001050`
...
- English observation: `A narrow stacked form combines a pointed rounded
  upper enclosure, a horizontal middle band, and a lower trapezoid-like
  enclosure.`
- 中文观察: `狭长叠置形体结合尖状圆弧上部闭合轮廓、横向中部带和下部梯形状闭合轮廓。`
...
- dataset label text: `㢉㢊`
- dataset label codepoints: `U+3889;U+388A`
...
- graph edge count: `2`
- codepoint routes: `U+3889;U+388A`
...
- Which source records identify obs-char-001045 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001045？
