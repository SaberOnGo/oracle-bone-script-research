# Material Visual Observation / obs-comp-cand-002228 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002228`
- External reference / 外部参照: `obimd-sub-xooru90akr`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020041_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bru91s7d68/xooru90akr/xooru90akr.png`
- Checksum / 校验和:
  `9c78c9ff0d199f311f38f640dd8c63b3f019c6cc9f36ab72f1fcce219633e51f`
...
- Marked-pixel bounds: (81,26)–(168,218); span 88 × 193 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.40%。
- 痕迹范围：(81,26)–(168,218)；跨度88 × 193 px；痕迹矩形高于宽。
