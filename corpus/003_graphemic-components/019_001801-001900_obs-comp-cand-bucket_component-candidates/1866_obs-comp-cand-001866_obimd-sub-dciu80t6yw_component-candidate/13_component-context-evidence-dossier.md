# obs-comp-cand-001866 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001866`
- 首选外部 ID: `obimd-sub-dciu80t6yw`
- OBIMD subcharacter UID: `dciu80t6yw`
- OBIMD main character UID: `dciu80t6yw`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+FAB1A; U+FAB1B; 另有 2 项
