...
- External category reference: `evobc-cat-08880`
- Source category ID: `08880`
- Source label for human review: `轚`
- Source codepoints: `U+8F5A`
...
- `obs-evo-cand-008880-route-category-staging`
...
- `obs-evo-cand-008880-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008880-route-evolution-graph`
