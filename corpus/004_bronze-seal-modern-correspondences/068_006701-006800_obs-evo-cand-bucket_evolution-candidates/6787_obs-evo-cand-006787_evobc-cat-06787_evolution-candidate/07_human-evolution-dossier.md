...
Project ID: `obs-evo-cand-006787`
...
- Project ID: `obs-evo-cand-006787`
- EVOBC category candidate ID: `evobc-evo-cat-06787`
- External category reference: `evobc-cat-06787`
- Source category ID: `06787`
- Source label for human review: `缿`
- Source codepoints: `U+7F3F`
...
- `obs-evo-cand-006787-route-category-staging`
...
- `obs-evo-cand-006787-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006787-route-evolution-graph`
