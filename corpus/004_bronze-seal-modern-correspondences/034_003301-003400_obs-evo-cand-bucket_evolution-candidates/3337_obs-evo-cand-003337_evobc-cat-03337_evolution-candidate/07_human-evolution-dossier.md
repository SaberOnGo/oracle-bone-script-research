...
Project ID: `obs-evo-cand-003337`
...
- Project ID: `obs-evo-cand-003337`
- EVOBC category candidate ID: `evobc-evo-cat-03337`
- External category reference: `evobc-cat-03337`
- Source category ID: `03337`
- Source label for human review: `持`
- Source codepoints: `U+6301`
...
- `obs-evo-cand-003337-route-category-staging`
...
- `obs-evo-cand-003337-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003337-route-evolution-graph`
