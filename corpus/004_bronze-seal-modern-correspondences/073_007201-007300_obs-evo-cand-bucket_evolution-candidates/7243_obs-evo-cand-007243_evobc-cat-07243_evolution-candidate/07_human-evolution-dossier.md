...
Project ID: `obs-evo-cand-007243`
...
- Project ID: `obs-evo-cand-007243`
- EVOBC category candidate ID: `evobc-evo-cat-07243`
- External category reference: `evobc-cat-07243`
- Source category ID: `07243`
- Source label for human review: `芘`
- Source codepoints: `U+8298`
...
- `obs-evo-cand-007243-route-category-staging`
...
- `obs-evo-cand-007243-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007243-route-evolution-graph`
