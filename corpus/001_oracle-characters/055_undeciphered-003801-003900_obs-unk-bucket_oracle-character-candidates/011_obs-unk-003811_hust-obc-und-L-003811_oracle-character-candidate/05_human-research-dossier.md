# obs-unk-003811 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003811`
- primary external id: `hust-obc-und-L-003811`
...
- local review image route: `corpus/001_oracle-characters/055_undeciphered-003
  801-003900_obs-unk-bucket_oracle-character-candidates/011_obs-unk-003811_h
  ust-obc-und-L-003811_oracle-character-candidate/03_visual-assets/001_asset
  -005404_hust-obc-und-L-003811_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3811/L_？_7951.jpg`
- asset id: `asset-005404`
...
- source class: `HUST-OBC/undeciphered/L/3811/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3811/L_？_7951.jpg`
- asset id: `asset-005404`
...
- Which source records identify obs-unk-003811 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003811？
