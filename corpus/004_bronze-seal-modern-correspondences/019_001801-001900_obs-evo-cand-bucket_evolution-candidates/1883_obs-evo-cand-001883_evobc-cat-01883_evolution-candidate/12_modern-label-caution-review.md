# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001883
...
- EVOBC candidate category: `evobc-evo-cat-01883`.
- Source label for search only: `埴`.
- Source codepoints for search only: `U+57F4`.
