# obs-unk-004451 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/051_obs-unk-004451_h
  ust-obc-und-X-004451_oracle-character-candidate/03_visual-assets/001_asset
  -006044_hust-obc-und-X-004451_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/7/X_？_8186_1.png`
- asset id: `asset-006044`
...
- source class: `HUST-OBC/undeciphered/X/7/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/7/X_？_8186_1.png`
- asset id: `asset-006044`
...
- English observation: `Two tall parallel traces stand above a lower`
  `branching cluster.`
- 中文观察: `两条高的平行痕迹位于下部分支聚集处之上。`
...
- Which source records identify obs-unk-004451 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004451？
