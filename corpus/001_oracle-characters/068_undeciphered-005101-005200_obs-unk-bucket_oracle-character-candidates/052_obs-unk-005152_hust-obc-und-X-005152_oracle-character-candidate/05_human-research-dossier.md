# obs-unk-005152 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005152`
- primary external id: `hust-obc-und-X-005152`
...
- local review image route: `corpus/001_oracle-characters/068_undeciphered-005
  101-005200_obs-unk-bucket_oracle-character-candidates/052_obs-unk-005152_h
  ust-obc-und-X-005152_oracle-character-candidate/03_visual-assets/001_asset
  -006745_hust-obc-und-X-005152_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/708/X_？_7676_1.png`
- asset id: `asset-006745`
...
- source class: `HUST-OBC/undeciphered/X/708/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/708/X_？_7676_1.png`
- asset id: `asset-006745`
...
- Which source records identify obs-unk-005152 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005152？
