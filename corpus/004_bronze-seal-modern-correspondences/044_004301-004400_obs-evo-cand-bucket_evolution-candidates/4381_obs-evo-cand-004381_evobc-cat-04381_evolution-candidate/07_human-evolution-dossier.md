...
Project ID: `obs-evo-cand-004381`
...
- Project ID: `obs-evo-cand-004381`
- EVOBC category candidate ID: `evobc-evo-cat-04381`
- External category reference: `evobc-cat-04381`
- Source category ID: `04381`
- Source label for human review: `歜`
- Source codepoints: `U+6B5C`
...
- `obs-evo-cand-004381-route-category-staging`
...
- `obs-evo-cand-004381-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004381-route-evolution-graph`
