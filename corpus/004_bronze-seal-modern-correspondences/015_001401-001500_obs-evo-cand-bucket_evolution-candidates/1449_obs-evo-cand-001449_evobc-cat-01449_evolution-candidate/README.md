# obs-evo-cand-001449 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-01449`
- Source label: `又`
- Source codepoints: `U+53C8`
- Image reference count: `686`
- Era token counts: `BI:121;CS:1;OBC:108;SAC:14;SS:2;WSC:440`
- Source token counts: `Book:139;Web:547`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 108 image references
- era 1 / BI: 121 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 14 image references
- era 4 / WSC: 440 image references
- era 5 / CS: 1 image references
- source 1 / Web:105952;說文Web:58: 547 image references
- source 2 / Book:17600: 54 image references
- source 3 / Book:21681: 65 image references
