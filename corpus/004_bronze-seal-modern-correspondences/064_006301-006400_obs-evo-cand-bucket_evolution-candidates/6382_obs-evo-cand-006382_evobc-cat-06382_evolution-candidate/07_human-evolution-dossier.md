...
- External category reference: `evobc-cat-06382`
- Source category ID: `06382`
...
- `obs-evo-cand-006382-route-category-staging`
...
- `obs-evo-cand-006382-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006382-route-evolution-graph`
