# Material Visual Observation / obs-comp-cand-000934 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000934`
- External reference / 外部参照: `obimd-sub-oaaqvh5dtf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014017_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/oaaqvh5dtf/oaaqvh5dtf/oaaqvh5dtf.png`
- Checksum / 校验和:
  `6b364b8d2c07b6fbe321fcd2a3dde91509a118c32657678664221d4db0d4f82c`
...
- Marked-pixel bounds: (63,41)–(186,210); span 124 × 170 px; the marked
...
- 痕迹范围：(63,41)–(186,210)；跨度124 × 170 px；痕迹矩形高于宽。
