# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000149
...
| --- | --- | --- | --- |
| `obimd-glyph-link-002030` | 󰸕 | `U+F0E15` | `reviewed_metadata_only` |
| `obimd-glyph-link-002031` | 󰸖 | `U+F0E16` | `reviewed_metadata_only` |
