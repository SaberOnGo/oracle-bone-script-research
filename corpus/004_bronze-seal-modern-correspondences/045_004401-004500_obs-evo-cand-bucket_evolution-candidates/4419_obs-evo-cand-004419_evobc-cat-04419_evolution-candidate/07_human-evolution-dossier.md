...
- External category reference: `evobc-cat-04419`
- Source category ID: `04419`
- Source label for human review: `殨`
- Source codepoints: `U+6BA8`
...
- `obs-evo-cand-004419-route-category-staging`
...
- `obs-evo-cand-004419-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004419-route-evolution-graph`
