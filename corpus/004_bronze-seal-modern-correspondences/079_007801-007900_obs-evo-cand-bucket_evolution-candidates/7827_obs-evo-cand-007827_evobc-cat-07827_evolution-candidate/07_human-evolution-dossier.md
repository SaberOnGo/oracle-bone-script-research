...
- External category reference: `evobc-cat-07827`
- Source category ID: `07827`
- Source label for human review: `螕`
- Source codepoints: `U+8795`
...
- `obs-evo-cand-007827-route-category-staging`
...
- `obs-evo-cand-007827-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007827-route-evolution-graph`
