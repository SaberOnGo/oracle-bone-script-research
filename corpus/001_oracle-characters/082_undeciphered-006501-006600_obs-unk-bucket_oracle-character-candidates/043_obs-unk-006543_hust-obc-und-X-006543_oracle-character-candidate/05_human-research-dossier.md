# obs-unk-006543 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006543`
- primary external id: `hust-obc-und-X-006543`
...
- local review image route: `corpus/001_oracle-characters/082_undeciphered-006
  501-006600_obs-unk-bucket_oracle-character-candidates/043_obs-unk-006543_h
  ust-obc-und-X-006543_oracle-character-candidate/03_visual-assets/001_asset
  -008134_hust-obc-und-X-006543_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2099/X_？_5917_1.png`
- asset id: `asset-008134`
...
- source class: `HUST-OBC/undeciphered/X/2099/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2099/X_？_5917_1.png`
- asset id: `asset-008134`
...
- Which source records identify obs-unk-006543 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006543？
