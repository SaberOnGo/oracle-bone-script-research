...
- External category reference: `evobc-cat-04526`
- Source category ID: `04526`
- Source label for human review: `沁`
- Source codepoints: `U+6C81`
...
- `obs-evo-cand-004526-route-category-staging`
...
- `obs-evo-cand-004526-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004526-route-evolution-graph`
