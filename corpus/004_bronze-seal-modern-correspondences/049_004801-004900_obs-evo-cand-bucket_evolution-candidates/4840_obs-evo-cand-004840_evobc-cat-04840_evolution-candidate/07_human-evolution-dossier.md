...
- Project ID: `obs-evo-cand-004840`
- EVOBC category candidate ID: `evobc-evo-cat-04840`
- External category reference: `evobc-cat-04840`
- Source category ID: `04840`
- Source label for human review: `滐`
- Source codepoints: `U+6ED0`
...
- `obs-evo-cand-004840-route-category-staging`
...
- `obs-evo-cand-004840-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004840-route-evolution-graph`
