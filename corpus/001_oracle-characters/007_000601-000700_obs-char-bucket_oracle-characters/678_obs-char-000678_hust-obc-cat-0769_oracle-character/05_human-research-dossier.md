# obs-char-000678 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000678`
- primary external id: `hust-obc-cat-0769`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/678_obs-char-000678_hust-obc-cat-0769_orac
  le-character/03_visual-assets/001_asset-000683_hust-obc-cat-0769_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0769/G_0769_乙5311合6946賓組.png`
- asset id: `asset-000683`
...
- source category: `0769`
- validation class: `677`
- source image route: `HUST-OBC/deciphered/0769/G_0769_乙5311合6946賓組.png`
- asset id: `asset-000683`
...
- English observation: `A thin slanting central stem has a crossed fork at
  the top, several short left-facing branches along its middle, and a tiny
  detached cross near the lower end.`
...
- dataset label text: `㛷`
- dataset label codepoints: `U+36F7`
...
- filename catalog route clues: `Heji-like filename clue: 合6946
...
- Which source records identify obs-char-000678 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000678？
