...
- Project ID: `obs-evo-cand-004729`
- EVOBC category candidate ID: `evobc-evo-cat-04729`
- External category reference: `evobc-cat-04729`
- Source category ID: `04729`
- Source label for human review: `淨`
- Source codepoints: `U+6DE8`
...
- `obs-evo-cand-004729-route-category-staging`
...
- `obs-evo-cand-004729-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004729-route-evolution-graph`
