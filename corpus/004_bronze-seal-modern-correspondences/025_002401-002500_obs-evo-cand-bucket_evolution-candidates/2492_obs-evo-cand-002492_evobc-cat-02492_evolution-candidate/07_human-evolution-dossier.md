...
Project ID: `obs-evo-cand-002492`
...
- Project ID: `obs-evo-cand-002492`
- EVOBC category candidate ID: `evobc-evo-cat-02492`
- External category reference: `evobc-cat-02492`
- Source category ID: `02492`
- Source label for human review: `尽`
- Source codepoints: `U+5C3D`
...
- `obs-evo-cand-002492-route-category-staging`
...
- `obs-evo-cand-002492-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002492-route-evolution-graph`
