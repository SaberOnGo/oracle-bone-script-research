...
- Project ID: `obs-evo-cand-010898`
- EVOBC category candidate ID: `evobc-evo-cat-10898`
- External category reference: `evobc-cat-10898`
- Source category ID: `10898`
- Source label for human review: `𠨸`
- Source codepoints: `U+20A38`
...
- `obs-evo-cand-010898-route-category-staging`
...
- `obs-evo-cand-010898-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010898-route-evolution-graph`
