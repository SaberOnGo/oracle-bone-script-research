...
- External category reference: `evobc-cat-09873`
- Source category ID: `09873`
- Source label for human review: `霸`
- Source codepoints: `U+9738`
- Image reference count in source metadata: `145`
...
- `obs-evo-cand-009873-route-category-staging`
...
- `obs-evo-cand-009873-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009873-route-evolution-graph`
