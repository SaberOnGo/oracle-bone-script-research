# obs-unk-007689 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-007689`
- primary external id: `hust-obc-und-YH-007689`
...
- local review image route: `corpus/001_oracle-characters/093_undeciphered-007
  601-007700_obs-unk-bucket_oracle-character-candidates/089_obs-unk-007689_h
  ust-obc-und-YH-007689_oracle-character-candidate/03_visual-assets/001_asse
  t-009280_hust-obc-und-YH-007689_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6026A/H_？_6026A_0.png`
- asset id: `asset-009280`
...
- source class: `HUST-OBC/undeciphered/Y+H/6026A/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6026A/H_？_6026A_0.png`
- asset id: `asset-009280`
...
- Which source records identify obs-unk-007689 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007689？
