# obs-char-000926 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000926`
- primary external id: `hust-obc-cat-1043`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/926_obs-char-000926_hust-obc-cat-1043_orac
  le-character/03_visual-assets/001_asset-000931_hust-obc-cat-1043_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1043/G_1043_前4.5.2合10058賓組.png`
- asset id: `asset-000931`
...
- source category: `1043`
- validation class: `925`
- source image route: `HUST-OBC/deciphered/1043/G_1043_前4.5.2合10058賓組.png`
- asset id: `asset-000931`
...
- English observation: `A triangular upper projection sits above a
  horizontal crossbar and central stem, with jagged side branches on both
  sides.`
- 中文观察: `三角形上伸笔位于横笔和中央笔干之上，两侧带有曲折分枝。`
...
- dataset label text: `㠉`
- dataset label codepoints: `U+3809`
...
- filename catalog route clues: `Heji-like filename clue: 合10058
  (G_1043_前4.5.2合10058賓組.png)`
...
- Which source records identify obs-char-000926 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000926？
