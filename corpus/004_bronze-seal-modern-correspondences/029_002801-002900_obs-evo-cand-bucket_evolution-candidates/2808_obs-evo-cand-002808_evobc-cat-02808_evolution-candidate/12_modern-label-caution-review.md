# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002808
...
- EVOBC candidate category: `evobc-evo-cat-02808`.
- Source label for search only: `弭`.
- Source codepoints for search only: `U+5F2D`.
