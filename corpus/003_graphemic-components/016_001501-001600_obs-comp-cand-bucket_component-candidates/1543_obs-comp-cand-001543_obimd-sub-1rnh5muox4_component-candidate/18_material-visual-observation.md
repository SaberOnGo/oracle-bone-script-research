# Material Visual Observation / obs-comp-cand-001543 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001543`
- External reference / 外部参照: `obimd-sub-1rnh5muox4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016957_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1rnh5muox4/1rnh5muox4/1rnh5muox4.png`
- Checksum / 校验和:
  `809889030963763676b51db1f8e9397f39764e183e7e5e6c3b3d5f0cf99e8bda`
...
- Marked-pixel bounds: (77,43)–(185,212); span 109 × 170 px; the marked
...
- 痕迹范围：(77,43)–(185,212)；跨度109 × 170 px；痕迹矩形高于宽。
