...
- External category reference: `evobc-cat-10187`
- Source category ID: `10187`
- Source label for human review: `駘`
- Source codepoints: `U+99D8`
...
- `obs-evo-cand-010187-route-category-staging`
...
- `obs-evo-cand-010187-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010187-route-evolution-graph`
