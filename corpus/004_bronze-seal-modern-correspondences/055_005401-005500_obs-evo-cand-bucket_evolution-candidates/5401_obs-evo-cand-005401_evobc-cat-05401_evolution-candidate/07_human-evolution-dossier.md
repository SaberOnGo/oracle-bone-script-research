...
- Project ID: `obs-evo-cand-005401`
- EVOBC category candidate ID: `evobc-evo-cat-05401`
- External category reference: `evobc-cat-05401`
- Source category ID: `05401`
- Source label for human review: `琅`
- Source codepoints: `U+7405`
...
- `obs-evo-cand-005401-route-category-staging`
...
- `obs-evo-cand-005401-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005401-route-evolution-graph`
