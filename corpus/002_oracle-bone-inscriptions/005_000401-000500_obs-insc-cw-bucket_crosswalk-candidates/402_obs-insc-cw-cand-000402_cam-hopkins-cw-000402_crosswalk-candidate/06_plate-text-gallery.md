...
Project ID: `obs-insc-cw-cand-000402`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000402`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000402` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2184` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `469` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `75�` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `41196` [route_present_image_or_text_not_collected]
