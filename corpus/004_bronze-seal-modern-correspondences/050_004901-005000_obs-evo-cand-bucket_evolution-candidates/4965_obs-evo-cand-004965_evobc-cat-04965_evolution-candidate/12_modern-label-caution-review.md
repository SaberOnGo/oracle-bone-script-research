# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004965
...
- EVOBC candidate category: `evobc-evo-cat-04965`.
- Source label for search only: `濟`.
- Source codepoints for search only: `U+6FDF`.
