# Material Visual Observation / obs-comp-cand-000236 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000236`
- External reference / 外部参照: `obimd-sub-qsajusmznc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011883_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/id0m0j1kjy/qsajusmznc/qsajusmznc.png`
- Checksum / 校验和:
  `99b742701f136708d6df77c561223ad3ac70480831b5f00e9fa77237942894dc`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.72%.
- Marked-pixel bounds: (57,41)–(192,207); span 136 × 167 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.72%。
- 痕迹范围：(57,41)–(192,207)；跨度136 × 167 px；痕迹矩形高于宽。
