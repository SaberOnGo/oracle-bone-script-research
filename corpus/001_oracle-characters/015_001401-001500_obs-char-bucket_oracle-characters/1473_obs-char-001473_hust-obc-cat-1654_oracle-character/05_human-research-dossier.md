# obs-char-001473 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1473_obs-char-001473_hust-obc-cat-1654_ora
  cle-character/03_visual-assets/001_asset-001478_hust-obc-cat-1654_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1654/G_1654_乙8688合35501黃組.png`
- asset id: `asset-001478`
...
- source category: `1654`
- validation class: `1472`
- source image route: `HUST-OBC/deciphered/1654/G_1654_乙8688合35501黃組.png`
- asset id: `asset-001478`
...
- English observation: `A stacked central form has a broad upper bar, lower
  curves, and detached marks.`
- 中文观察: `叠置中央形体有宽大上横笔、下部弧线和分离短笔。`
...
- dataset label text: `㩬`
- dataset label codepoints: `U+3A6C`
...
- Which source records identify obs-char-001473 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001473？
