# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000748
...
- EVOBC candidate category: `evobc-evo-cat-00748`.
- Source label for search only: `仪`.
- Source codepoints for search only: `U+4EEA`.
