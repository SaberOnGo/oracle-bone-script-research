# obs-char-000763 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/763_obs-char-000763_hust-obc-cat-0866_orac
  le-character/03_visual-assets/001_asset-000768_hust-obc-cat-0866_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0866/H_0866_611AA_0.png`
- asset id: `asset-000768`
...
- source category: `0866`
- validation class: `762`
- source image route: `HUST-OBC/deciphered/0866/H_0866_611AA_0.png`
- asset id: `asset-000768`
...
- English observation: `Two detached forms stand side by side: the left is a
  tall stem branching above and below, while the right forms a long pointed
  oval opening joined at its middle.`
...
- dataset label text: `㝘`
- dataset label codepoints: `U+3758`
...
- filename catalog route clues: `catalog-like filename clue: H_0866
  (H_0866_611AA_0.png)`
...
- Which source records identify obs-char-000763 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000763？
