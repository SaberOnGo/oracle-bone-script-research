...
Project ID: `obs-evo-cand-006668`
...
- Project ID: `obs-evo-cand-006668`
- EVOBC category candidate ID: `evobc-evo-cat-06668`
- External category reference: `evobc-cat-06668`
- Source category ID: `06668`
- Source label for human review: `繏`
- Source codepoints: `U+7E4F`
...
- `obs-evo-cand-006668-route-category-staging`
...
- `obs-evo-cand-006668-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006668-route-evolution-graph`
