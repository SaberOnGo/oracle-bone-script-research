...
- `obs-evo-cand-008784-route-category-staging`
...
- `obs-evo-cand-008784-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008784-route-evolution-graph`
