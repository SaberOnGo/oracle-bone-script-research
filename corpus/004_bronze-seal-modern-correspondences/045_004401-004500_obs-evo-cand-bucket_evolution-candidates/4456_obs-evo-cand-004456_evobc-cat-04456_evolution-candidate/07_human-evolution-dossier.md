...
Project ID: `obs-evo-cand-004456`
...
- Project ID: `obs-evo-cand-004456`
- EVOBC category candidate ID: `evobc-evo-cat-04456`
- External category reference: `evobc-cat-04456`
- Source category ID: `04456`
- Source label for human review: `毣`
- Source codepoints: `U+6BE3`
...
- `obs-evo-cand-004456-route-category-staging`
...
- `obs-evo-cand-004456-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004456-route-evolution-graph`
