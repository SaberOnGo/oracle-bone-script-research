...
- `obs-evo-cand-006163-route-category-staging`
...
- `obs-evo-cand-006163-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006163-route-evolution-graph`
