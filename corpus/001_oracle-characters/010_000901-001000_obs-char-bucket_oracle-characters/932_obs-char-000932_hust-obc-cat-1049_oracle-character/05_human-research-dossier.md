# obs-char-000932 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/932_obs-char-000932_hust-obc-cat-1049_orac
  le-character/03_visual-assets/001_asset-000937_hust-obc-cat-1049_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1049/G_1049_甲骨文.png`
- asset id: `asset-000937`
...
- source category: `1049`
- validation class: `931`
- source image route: `HUST-OBC/deciphered/1049/G_1049_甲骨文.png`
- asset id: `asset-000937`
...
- English observation: `A small square-like upper enclosure sits on a
  central stem with a short right branch and a lower diagonal projection.`
- 中文观察: `小型方形近似闭合轮廓位于中央笔干之上，右侧有短分枝，下部伸出斜笔。`
...
- dataset label text: `㠏`
- dataset label codepoints: `U+380F`
...
- Which source records identify obs-char-000932 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000932？
