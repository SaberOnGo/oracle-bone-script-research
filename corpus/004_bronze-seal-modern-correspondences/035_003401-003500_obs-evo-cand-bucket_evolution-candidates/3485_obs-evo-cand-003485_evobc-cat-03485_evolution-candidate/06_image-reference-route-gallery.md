...
- `obs-evo-cand-003485-route-category-staging`
...
- `obs-evo-cand-003485-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003485-route-evolution-graph`
