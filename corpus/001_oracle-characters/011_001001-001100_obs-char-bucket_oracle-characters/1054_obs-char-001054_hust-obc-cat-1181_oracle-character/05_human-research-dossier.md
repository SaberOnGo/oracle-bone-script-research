# obs-char-001054 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001054`
- primary external id: `hust-obc-cat-1181`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1054_obs-char-001054_hust-obc-cat-1181_ora
  cle-character/03_visual-assets/001_asset-001059_hust-obc-cat-1181_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1181/G_1181_甲骨文0.png`
- asset id: `asset-001059`
...
- source category: `1181`
- validation class: `1053`
- source image route: `HUST-OBC/deciphered/1181/G_1181_甲骨文0.png`
- asset id: `asset-001059`
...
- English observation: `A tall narrow enclosure has short upper projections,
  two horizontal interior bands, and a tapered lower end.`
- 中文观察: `高而狭长的闭合轮廓有短上部外伸、两条内部水平带和收窄下端。`
...
- dataset label text: `㢓`
- dataset label codepoints: `U+3893`
...
- Which source records identify obs-char-001054 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001054？
