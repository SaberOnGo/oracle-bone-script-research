# obs-unk-004587 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/087_obs-unk-004587_h
  ust-obc-und-X-004587_oracle-character-candidate/03_visual-assets/001_asset
  -006180_hust-obc-und-X-004587_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/143/X_？_8321_1.png`
- asset id: `asset-006180`
...
- source class: `HUST-OBC/undeciphered/X/143/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/143/X_？_8321_1.png`
- asset id: `asset-006180`
...
- English observation: `Small and large openings, arch, and three pointed`
  `terminals recorded.`
- 中文观察: `已记录大小开口、拱形轮廓和三个尖状末端。`
...
- Which source records identify obs-unk-004587 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004587？
