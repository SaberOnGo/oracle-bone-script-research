...
- External category reference: `evobc-cat-13118`
- Source category ID: `13118`
- Source label for human review: `𫶪`
- Source codepoints: `U+2BDAA`
...
- `obs-evo-cand-013118-route-category-staging`
...
- `obs-evo-cand-013118-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013118-route-evolution-graph`
