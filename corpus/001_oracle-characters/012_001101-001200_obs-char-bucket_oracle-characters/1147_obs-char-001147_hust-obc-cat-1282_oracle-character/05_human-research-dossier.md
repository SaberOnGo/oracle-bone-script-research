# obs-char-001147 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001147`
- primary external id: `hust-obc-cat-1282`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1147_obs-char-001147_hust-obc-cat-1282_ora
  cle-character/03_visual-assets/001_asset-001152_hust-obc-cat-1282_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1282/G_1282_後1.7.10合27632無名組.pn
  g`
- asset id: `asset-001152`
...
- source category: `1282`
- validation class: `1146`
- source image route: `HUST-OBC/deciphered/1282/G_1282_後1.7.10合27632無名組.png`
- asset id: `asset-001152`
...
- English observation: `A dense upright cluster has a short branched top, a
  small angular central enclosure, and a long right-side stroke.`
- 中文观察: `密集的直立笔群有短分枝上部、小型中央折角框廓和长右侧笔。`
...
- dataset label text: `㣸`
- dataset label codepoints: `U+38F8`
...
- filename catalog route clues: `Heji-like filename clue: 合27632
  (G_1282_後1.7.10合27632無名組.png)`
...
- Which source records identify obs-char-001147 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001147？
