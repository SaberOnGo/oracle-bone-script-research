...
- External category reference: `evobc-cat-04897`
- Source category ID: `04897`
- Source label for human review: `潕`
...
- `obs-evo-cand-004897-route-category-staging`
...
- `obs-evo-cand-004897-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004897-route-evolution-graph`
