# obs-unk-004697 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/097_obs-unk-004697_h
  ust-obc-und-X-004697_oracle-character-candidate/03_visual-assets/001_asset
  -006290_hust-obc-und-X-004697_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/253/X_？_7226_1.png`
- asset id: `asset-006290`
...
- source class: `HUST-OBC/undeciphered/X/253/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/253/X_？_7226_1.png`
- asset id: `asset-006290`
...
- English observation: `two groups with upper opening and detached fragments`
- 中文观察: `带上部开口和分离残片的两组笔画`
...
- Which source records identify obs-unk-004697 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004697？
