# Material Visual Observation / obs-comp-cand-000873 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000873`
- External reference / 外部参照: `obimd-sub-gy1x9yvcck`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013945_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/o6m37o3l7o/gy1x9yvcck/gy1x9yvcck.png`
- Checksum / 校验和:
  `0a3ad1c712453e7e4fc311149acf14658fd4e6c300f451e2ca855e11afa383da`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.54%.
- Marked-pixel bounds: (79,17)–(176,229); span 98 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.54%。
- 痕迹范围：(79,17)–(176,229)；跨度98 × 213 px；痕迹矩形高于宽。
