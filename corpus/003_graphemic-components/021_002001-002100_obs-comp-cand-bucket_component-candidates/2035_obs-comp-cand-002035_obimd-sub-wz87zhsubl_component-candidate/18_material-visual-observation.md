# Material Visual Observation / obs-comp-cand-002035 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002035`
- External reference / 外部参照: `obimd-sub-wz87zhsubl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019362_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/sqh9trpulp/wz87zhsubl/wz87zhsubl.png`
- Checksum / 校验和:
  `6f55d001b822b8cdde338e316484dcecdf86cb83a644544a69e1b99d7af50a40`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.79%.
- Marked-pixel bounds: (57,25)–(190,215); span 134 × 191 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.79%。
- 痕迹范围：(57,25)–(190,215)；跨度134 × 191 px；痕迹矩形高于宽。
