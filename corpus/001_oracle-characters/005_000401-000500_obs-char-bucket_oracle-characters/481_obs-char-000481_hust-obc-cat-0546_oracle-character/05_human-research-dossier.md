# obs-char-000481 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000481`
- primary external id: `hust-obc-cat-0546`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/481_obs-char-000481_hust-obc-cat-0546_orac
  le-character/03_visual-assets/001_asset-000486_hust-obc-cat-0546_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0546/G_0546_乙8688合35501黃組.png`
- asset id: `asset-000486`
...
- source category: `0546`
- validation class: `480`
- source image route: `HUST-OBC/deciphered/0546/G_0546_乙8688合35501黃組.png`
- asset id: `asset-000486`
...
- English observation: `A broad pointed upper outline surrounds a central
  vertical stroke crossed by several short horizontal or slanting bars; the
  outer sides remain partly separated.`
- 中文观察: `宽尖顶上部轮廓围绕中央竖笔，竖笔被数条短横或斜笔穿过，外侧笔画部分断离。`
...
- dataset label text: `㘘`
- dataset label codepoints: `U+3618`
...
- filename catalog route clues: `Heji-like filename clue: 合35501
  (G_0546_乙8688合35501黃組.png)`
...
- Which source records identify obs-char-000481 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000481？
