...
- `obs-evo-cand-011569-route-category-staging`
...
- `obs-evo-cand-011569-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011569-route-evolution-graph`
