# obs-unk-004667 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/067_obs-unk-004667_h
  ust-obc-und-X-004667_oracle-character-candidate/03_visual-assets/001_asset
  -006260_hust-obc-und-X-004667_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/223/X_？_8394_1.png`
- asset id: `asset-006260`
...
- source class: `HUST-OBC/undeciphered/X/223/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/223/X_？_8394_1.png`
- asset id: `asset-006260`
...
- English observation: `broad horizontal form with curled left cluster`
- 中文观察: `带左侧卷曲聚集的宽横向形体`
...
- Which source records identify obs-unk-004667 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004667？
