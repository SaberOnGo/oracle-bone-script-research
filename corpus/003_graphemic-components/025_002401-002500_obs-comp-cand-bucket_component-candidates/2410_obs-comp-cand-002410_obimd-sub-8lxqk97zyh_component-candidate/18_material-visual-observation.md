# Material Visual Observation / obs-comp-cand-002410 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002410`
- External reference / 外部参照: `obimd-sub-8lxqk97zyh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020481_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8lxqk97zyh/8lxqk97zyh/8lxqk97zyh.png`
- Checksum / 校验和:
  `565ecf455ff22a4482ba0ae747637db3bbfca60f1907b85284c6ab9af630a169`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.16%.
- Marked-pixel bounds: (80,20)–(176,231); span 97 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.16%。
- 痕迹范围：(80,20)–(176,231)；跨度97 × 212 px；痕迹矩形高于宽。
