...
- `obs-evo-cand-005887-route-category-staging`
...
- `obs-evo-cand-005887-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005887-route-evolution-graph`
