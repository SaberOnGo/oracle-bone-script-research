# obs-unk-001913 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/036_undeciphered-001
  901-002000_obs-unk-bucket_oracle-character-candidates/013_obs-unk-001913_h
  ust-obc-und-L-001913_oracle-character-candidate/03_visual-assets/001_asset
  -003506_hust-obc-und-L-001913_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/1913/L_？_1554.jpg`
- asset id: `asset-003506`
...
- source class: `HUST-OBC/undeciphered/L/1913/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/1913/L_？_1554.jpg`
- asset id: `asset-003506`
...
- Which source records identify obs-unk-001913 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-001913？
