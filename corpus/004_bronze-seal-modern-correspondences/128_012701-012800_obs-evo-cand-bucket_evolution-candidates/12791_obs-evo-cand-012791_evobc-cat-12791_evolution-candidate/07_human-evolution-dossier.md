...
- External category reference: `evobc-cat-12791`
- Source category ID: `12791`
- Source label for human review: `𪛊`
...
- `obs-evo-cand-012791-route-category-staging`
...
- `obs-evo-cand-012791-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012791-route-evolution-graph`
