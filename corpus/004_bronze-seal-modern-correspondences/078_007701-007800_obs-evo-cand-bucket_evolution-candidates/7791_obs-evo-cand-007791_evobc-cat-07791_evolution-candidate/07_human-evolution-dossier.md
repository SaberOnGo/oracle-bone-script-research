...
- External category reference: `evobc-cat-07791`
- Source category ID: `07791`
- Source label for human review: `蜭`
- Source codepoints: `U+872D`
...
- `obs-evo-cand-007791-route-category-staging`
...
- `obs-evo-cand-007791-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007791-route-evolution-graph`
