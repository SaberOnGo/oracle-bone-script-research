...
- External category reference: `evobc-cat-07862`
- Source category ID: `07862`
- Source label for human review: `蟬`
...
- `obs-evo-cand-007862-route-category-staging`
...
- `obs-evo-cand-007862-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007862-route-evolution-graph`
