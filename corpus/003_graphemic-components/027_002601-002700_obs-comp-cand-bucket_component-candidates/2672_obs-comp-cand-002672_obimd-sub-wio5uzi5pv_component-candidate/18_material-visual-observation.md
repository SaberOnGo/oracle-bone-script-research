# Material Visual Observation / obs-comp-cand-002672 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002672`
- External reference / 外部参照: `obimd-sub-wio5uzi5pv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021248_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wio5uzi5pv/wio5uzi5pv/wio5uzi5pv.png`
- Checksum / 校验和:
  `fc299d3b9a64d75c002bfeaebfafe2acfd1660581e04d35e47827bf96dce4ee8`
...
- Marked-pixel bounds: (94,18)–(160,231); span 67 × 214 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.80%。
- 痕迹范围：(94,18)–(160,231)；跨度67 × 214 px；痕迹矩形高于宽。
