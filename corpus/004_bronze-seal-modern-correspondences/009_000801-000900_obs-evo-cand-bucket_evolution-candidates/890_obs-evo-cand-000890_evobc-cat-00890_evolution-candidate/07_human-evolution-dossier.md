...
- External category reference: `evobc-cat-00890`
- Source category ID: `00890`
- Source label for human review: `俙`
- Source codepoints: `U+4FD9`
...
- `obs-evo-cand-000890-route-category-staging`
...
- `obs-evo-cand-000890-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000890-route-evolution-graph`
