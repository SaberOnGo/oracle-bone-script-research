...
- Project ID: `obs-evo-cand-013235`
- EVOBC category candidate ID: `evobc-evo-cat-13235`
- External category reference: `evobc-cat-13235`
- Source category ID: `13235`
- Source label for human review: `𬋸`
- Source codepoints: `U+2C2F8`
...
- `obs-evo-cand-013235-route-category-staging`
...
- `obs-evo-cand-013235-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013235-route-evolution-graph`
