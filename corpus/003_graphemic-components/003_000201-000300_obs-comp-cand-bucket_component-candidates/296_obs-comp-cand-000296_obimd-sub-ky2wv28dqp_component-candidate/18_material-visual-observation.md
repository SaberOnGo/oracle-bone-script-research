# Material Visual Observation / obs-comp-cand-000296 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000296`
- External reference / 外部参照: `obimd-sub-ky2wv28dqp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012062_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1wismy95hz/ky2wv28dqp/ky2wv28dqp.png`
- Checksum / 校验和:
  `9a093f4771762119fc353a5f54aeb2101840a5d9c3e2d827b1b5e74133637529`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.36%.
- Marked-pixel bounds: (76,20)–(173,229); span 98 × 210 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.36%。
- 痕迹范围：(76,20)–(173,229)；跨度98 × 210 px；痕迹矩形高于宽。
