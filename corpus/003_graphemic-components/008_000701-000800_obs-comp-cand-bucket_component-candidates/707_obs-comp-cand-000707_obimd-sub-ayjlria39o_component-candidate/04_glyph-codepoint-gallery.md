# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000707
...
| --- | --- | --- | --- |
| `obimd-glyph-link-010251` | 勹󴂧 | `U+52F9;U+F40A7` | `reviewed_metadata_only` |
| `obimd-glyph-link-010252` | 󴂨 | `U+F40A8` | `reviewed_metadata_only` |
| `obimd-glyph-link-010253` | 󴂩 | `U+F40A9` | `reviewed_metadata_only` |
