# obs-char-000835 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000835`
- primary external id: `hust-obc-cat-0944`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/835_obs-char-000835_hust-obc-cat-0944_orac
  le-character/03_visual-assets/001_asset-000840_hust-obc-cat-0944_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0944/G_0944_後2.36.6合32906歷組.png
  `
- asset id: `asset-000840`
...
- source category: `0944`
- validation class: `834`
- source image route: `HUST-OBC/deciphered/0944/G_0944_後2.36.6合32906歷組.png`
- asset id: `asset-000840`
...
- English observation: `A thin outer curve at left accompanies a central
  upright with short upper bars and a small rounded enclosure; lower joins
  are unclear.`
- 中文观察: `左侧细外弯笔伴随中央直立笔，中央上部有短横笔并带小圆弧闭合痕迹；下部连接难辨。`
...
- dataset label text: `㞦`
- dataset label codepoints: `U+37A6`
...
- filename catalog route clues: `Heji-like filename clue: 合32906
  (G_0944_後2.36.6合32906歷組.png)`
...
- Which source records identify obs-char-000835 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000835？
