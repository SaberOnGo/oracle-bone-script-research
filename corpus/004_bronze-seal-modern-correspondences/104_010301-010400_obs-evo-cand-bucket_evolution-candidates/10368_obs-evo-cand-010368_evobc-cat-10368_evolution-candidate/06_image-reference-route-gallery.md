...
- `obs-evo-cand-010368-route-category-staging`
...
- `obs-evo-cand-010368-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010368-route-evolution-graph`
