...
- External category reference: `evobc-cat-06241`
- Source category ID: `06241`
- Source label for human review: `笫`
- Source codepoints: `U+7B2B`
...
- `obs-evo-cand-006241-route-category-staging`
...
- `obs-evo-cand-006241-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006241-route-evolution-graph`
