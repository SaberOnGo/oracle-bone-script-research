# obs-char-001404 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001404`
- primary external id: `hust-obc-cat-1573`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1404_obs-char-001404_hust-obc-cat-1573_ora
  cle-character/03_visual-assets/001_asset-001409_hust-obc-cat-1573_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1573/G_1573_前4.47.2合11010賓組.png
  `
- asset id: `asset-001409`
...
- source category: `1573`
- validation class: `1403`
- source image route: `HUST-OBC/deciphered/1573/G_1573_前4.47.2合11010賓組.png`
- asset id: `asset-001409`
...
- dataset label text: `㨛`
- dataset label codepoints: `U+3A1B`
...
- filename catalog route clues: `Heji-like filename clue: 合11010
  (G_1573_前4.47.2合11010賓組.png)`
...
- Which source records identify obs-char-001404 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001404？
