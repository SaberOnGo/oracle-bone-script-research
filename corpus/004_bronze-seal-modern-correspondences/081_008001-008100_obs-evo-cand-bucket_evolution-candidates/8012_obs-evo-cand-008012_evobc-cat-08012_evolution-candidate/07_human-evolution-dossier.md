...
Project ID: `obs-evo-cand-008012`
...
- Project ID: `obs-evo-cand-008012`
- EVOBC category candidate ID: `evobc-evo-cat-08012`
- External category reference: `evobc-cat-08012`
- Source category ID: `08012`
- Source label for human review: `褚`
- Source codepoints: `U+891A`
...
- `obs-evo-cand-008012-route-category-staging`
...
- `obs-evo-cand-008012-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008012-route-evolution-graph`
