...
Project ID: `obs-evo-cand-004968`
...
- Project ID: `obs-evo-cand-004968`
- EVOBC category candidate ID: `evobc-evo-cat-04968`
- External category reference: `evobc-cat-04968`
- Source category ID: `04968`
- Source label for human review: `濤`
- Source codepoints: `U+6FE4`
...
- `obs-evo-cand-004968-route-category-staging`
...
- `obs-evo-cand-004968-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004968-route-evolution-graph`
