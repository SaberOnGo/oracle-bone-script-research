# obs-char-000745 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/745_obs-char-000745_hust-obc-cat-0847_orac
  le-character/03_visual-assets/001_asset-000750_hust-obc-cat-0847_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0847/H_0847_60A9A_0.png`
- asset id: `asset-000750`
...
- source category: `0847`
- validation class: `744`
- source image route: `HUST-OBC/deciphered/0847/H_0847_60A9A_0.png`
- asset id: `asset-000750`
...
- English observation: `A compact upper branching cluster stands above a
  broad pointed rounded lower outline that is open at both upper sides and
  carries two short inward-facing marks.`
- 中文观察: `紧凑上部分枝笔群位于宽大尖底圆弯轮廓上方；下轮廓两侧上端开口，并带两条向内短痕。`
...
- dataset label text: `㝅`
- dataset label codepoints: `U+3745`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00066`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00066`
- EvoBC image reference count / EvoBC 图像引用数: `55`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00066`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/066_obs-evo-can
  d-000066_evobc-cat-00066_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/066_obs-evo-cand-000066_evobc-cat-00066_evolu
...
- filename catalog route clues: `catalog-like filename clue: H_0847
  (H_0847_60A9A_0.png)`
...
- Which source records identify obs-char-000745 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000745？
