# Material Visual Observation / obs-comp-cand-002463 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002463`
- External reference / 外部参照: `obimd-sub-qw5vx1k0rw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020648_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qw5vx1k0rw/qw5vx1k0rw/qw5vx1k0rw.png`
- Checksum / 校验和:
  `1349a2d353dbd01f23ca490c070ab86a8b5fa5ac73a127ec60b3cdb21a53b29f`
...
- Marked-pixel bounds: (74,12)–(194,240); span 121 × 229 px; the marked
...
- 痕迹范围：(74,12)–(194,240)；跨度121 × 229 px；痕迹矩形高于宽。
