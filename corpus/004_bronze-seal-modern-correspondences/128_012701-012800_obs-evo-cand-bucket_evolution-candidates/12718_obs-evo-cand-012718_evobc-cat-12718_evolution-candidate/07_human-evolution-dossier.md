...
- External category reference: `evobc-cat-12718`
- Source category ID: `12718`
- Source label for human review: `𩿊`
...
- `obs-evo-cand-012718-route-category-staging`
...
- `obs-evo-cand-012718-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012718-route-evolution-graph`
