# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008810
...
- EVOBC candidate category: `evobc-evo-cat-08810`.
- Source label for search only: `軫`.
- Source codepoints for search only: `U+8EEB`.
