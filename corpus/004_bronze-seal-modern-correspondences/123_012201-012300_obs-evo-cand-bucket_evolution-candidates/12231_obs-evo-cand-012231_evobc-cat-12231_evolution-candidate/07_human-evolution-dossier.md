...
- External category reference: `evobc-cat-12231`
- Source category ID: `12231`
- Source label for human review: `𧧬`
...
- `obs-evo-cand-012231-route-category-staging`
...
- `obs-evo-cand-012231-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012231-route-evolution-graph`
