# Archaeological Context Review / 考古语境复核: coll-obj-cand-00015
...
| Catalog or accession | `R035203`; source-page label still needs independent catalog check | `02_collection-source-index.csv`; `18_live-source-evidence-review.md` |
| Source item | `777` | `01_collection-object-packet.json` |
| Catalog description | `Chia 2928` | `01_collection-object-packet.json` |
...
| Findspot or provenience | source-reported Anyang County; independent check pending | `08_collection-provenance-evidence-dossier.md` |
