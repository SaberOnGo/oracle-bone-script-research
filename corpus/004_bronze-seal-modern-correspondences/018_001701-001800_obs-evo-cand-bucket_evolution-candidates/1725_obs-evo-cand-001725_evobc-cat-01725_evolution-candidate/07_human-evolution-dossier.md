...
- External category reference: `evobc-cat-01725`
- Source category ID: `01725`
- Source label for human review: `噬`
...
- `obs-evo-cand-001725-route-category-staging`
...
- `obs-evo-cand-001725-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001725-route-evolution-graph`
