...
- External category reference: `evobc-cat-05167`
- Source category ID: `05167`
- Source label for human review: `爒`
- Source codepoints: `U+7212`
...
- `obs-evo-cand-005167-route-category-staging`
...
- `obs-evo-cand-005167-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005167-route-evolution-graph`
