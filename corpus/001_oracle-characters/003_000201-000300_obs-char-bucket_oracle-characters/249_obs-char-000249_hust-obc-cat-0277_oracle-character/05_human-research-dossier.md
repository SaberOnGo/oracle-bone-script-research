# obs-char-000249 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000249`
- primary external id: `hust-obc-cat-0277`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/249_obs-char-000249_hust-obc-cat-0277_orac
  le-character/03_visual-assets/001_asset-000254_hust-obc-cat-0277_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0277/G_0277_乙5450反合4477反賓組.png`
- asset id: `asset-000254`
...
- source category: `0277`
- validation class: `248`
- source image route: `HUST-OBC/deciphered/0277/G_0277_乙5450反合4477反賓組.png`
- asset id: `asset-000254`
...
- English observation: `The image has crossing strokes at the top, an
  angular enclosed middle area, and a long diagonal stroke descending along
  the right side.`
- 中文观察: `图像顶部有交叉笔，中部有折角围合区域，右侧有长斜笔向下伸展。`
...
- dataset label text: `㔋`
- dataset label codepoints: `U+350B`
...
- filename catalog route clues: `Heji-like filename clue: 合4477
  (G_0277_乙5450反合4477反賓組.png)`
...
- Which source records identify obs-char-000249 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000249？
