# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-007345
...
- EVOBC candidate category: `evobc-evo-cat-07345`.
- Source label for search only: `荋`.
- Source codepoints for search only: `U+834B`.
