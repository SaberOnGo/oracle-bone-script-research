...
- External category reference: `evobc-cat-08902`
- Source category ID: `08902`
- Source label: `辑`
...
- `obs-evo-cand-008902-route-category-staging`
...
- `obs-evo-cand-008902-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008902-route-evolution-graph`
