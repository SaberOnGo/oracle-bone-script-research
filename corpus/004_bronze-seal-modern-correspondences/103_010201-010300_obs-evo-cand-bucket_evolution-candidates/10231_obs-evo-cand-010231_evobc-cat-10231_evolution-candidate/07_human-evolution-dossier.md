...
- Project ID: `obs-evo-cand-010231`
- EVOBC category candidate ID: `evobc-evo-cat-10231`
- External category reference: `evobc-cat-10231`
- Source category ID: `10231`
- Source label for human review: `騬`
- Source codepoints: `U+9A2C`
...
- `obs-evo-cand-010231-route-category-staging`
...
- `obs-evo-cand-010231-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010231-route-evolution-graph`
