...
- External category reference: `evobc-cat-05459`
- Source category ID: `05459`
- Source label for human review: `璅`
...
- `obs-evo-cand-005459-route-category-staging`
...
- `obs-evo-cand-005459-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005459-route-evolution-graph`
