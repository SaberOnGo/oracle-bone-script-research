...
- External category reference: `evobc-cat-01088`
- Source category ID: `01088`
- Source label for human review: `內`
- Source codepoints: `U+5167`
- Image reference count in source metadata: `175`
...
- `obs-evo-cand-001088-route-category-staging`
...
- `obs-evo-cand-001088-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001088-route-evolution-graph`
