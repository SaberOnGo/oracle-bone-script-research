...
- External category reference: `evobc-cat-11516`
- Source category ID: `11516`
- Source label for human review: `𣳕`
- Source codepoints: `U+23CD5`
...
- `obs-evo-cand-011516-route-category-staging`
...
- `obs-evo-cand-011516-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011516-route-evolution-graph`
