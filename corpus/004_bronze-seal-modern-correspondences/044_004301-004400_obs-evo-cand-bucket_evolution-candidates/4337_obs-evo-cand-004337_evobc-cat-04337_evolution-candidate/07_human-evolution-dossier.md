...
- Project ID: `obs-evo-cand-004337`
- EVOBC category candidate ID: `evobc-evo-cat-04337`
- External category reference: `evobc-cat-04337`
- Source category ID: `04337`
- Source label for human review: `次`
- Source codepoints: `U+6B21`
- Image reference count in source metadata: `87`
...
- `obs-evo-cand-004337-route-category-staging`
...
- `obs-evo-cand-004337-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004337-route-evolution-graph`
