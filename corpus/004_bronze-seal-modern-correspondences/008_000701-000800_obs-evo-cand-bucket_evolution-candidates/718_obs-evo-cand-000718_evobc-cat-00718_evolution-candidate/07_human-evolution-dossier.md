...
- External category reference: `evobc-cat-00718`
- Source category ID: `00718`
- Source label for human review: `亼`
...
- `obs-evo-cand-000718-route-category-staging`
...
- `obs-evo-cand-000718-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000718-route-evolution-graph`
