# Material Visual Observation / obs-comp-cand-001025 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001025`
- External reference / 外部参照: `obimd-sub-188qgh86vq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014518_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/188qgh86vq/188qgh86vq/188qgh86vq.png`
- Checksum / 校验和:
  `4d009b42cb6db10481d0982a1000b79f71c7a28ae39b638dd6f729897467c882`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.63%.
- Marked-pixel bounds: (89,24)–(160,230); span 72 × 207 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.63%。
- 痕迹范围：(89,24)–(160,230)；跨度72 × 207 px；痕迹矩形高于宽。
