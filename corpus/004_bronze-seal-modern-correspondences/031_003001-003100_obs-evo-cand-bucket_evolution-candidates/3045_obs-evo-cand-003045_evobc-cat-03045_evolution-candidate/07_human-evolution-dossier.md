...
- External category reference: `evobc-cat-03045`
- Source category ID: `03045`
- Source label for human review: `惏`
...
- `obs-evo-cand-003045-route-category-staging`
...
- `obs-evo-cand-003045-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003045-route-evolution-graph`
