# obs-char-001087 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1087_obs-char-001087_hust-obc-cat-1216_ora
  cle-character/03_visual-assets/001_asset-001092_hust-obc-cat-1216_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1216/G_1216_前5.10.1(甲).png`
- asset id: `asset-001092`
...
- source category: `1216`
- validation class: `1086`
- source image route: `HUST-OBC/deciphered/1216/G_1216_前5.10.1(甲).png`
- asset id: `asset-001092`
...
- English observation: `A compact upright cluster has an angular upper
  projection, a small enclosed central band, and two lower pointed strokes.`
- 中文观察: `紧密直立笔群有棱角上部外伸、小型中央闭合带和两条尖状下部笔。`
...
- dataset label text: `㢶`
- dataset label codepoints: `U+38B6`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/102_obs-evo-can
  d-000102_evobc-cat-00102_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/102_obs-evo-cand-000102_evobc-cat-00102_evolu
...
- Which source records identify obs-char-001087 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001087？
