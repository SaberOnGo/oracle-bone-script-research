# obs-evo-cand-010065 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-10065`
- Source label: `風`
- Source codepoints: `U+98A8`
- Image reference count: `158`
- Era token counts: `BI:1;CS:1;OBC:133;SS:3;WSC:20`
- Source token counts: `Book:89;Web:69`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 133 image references
...
- source 7 / Book:9676: 83 image references
