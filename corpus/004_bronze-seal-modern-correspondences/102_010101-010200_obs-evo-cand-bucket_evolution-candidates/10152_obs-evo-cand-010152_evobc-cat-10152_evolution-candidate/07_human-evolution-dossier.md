...
- External category reference: `evobc-cat-10152`
- Source category ID: `10152`
- Source label for human review: `馆`
- Source codepoints: `U+9986`
...
- `obs-evo-cand-010152-route-category-staging`
...
- `obs-evo-cand-010152-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010152-route-evolution-graph`
