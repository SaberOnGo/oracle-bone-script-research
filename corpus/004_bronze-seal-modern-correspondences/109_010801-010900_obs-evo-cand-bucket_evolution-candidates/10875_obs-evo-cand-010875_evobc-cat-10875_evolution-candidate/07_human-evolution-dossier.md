...
- External category reference: `evobc-cat-10875`
- Source category ID: `10875`
- Source label for human review: `𠥜`
- Source codepoints: `U+2095C`
...
- `obs-evo-cand-010875-route-category-staging`
...
- `obs-evo-cand-010875-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010875-route-evolution-graph`
