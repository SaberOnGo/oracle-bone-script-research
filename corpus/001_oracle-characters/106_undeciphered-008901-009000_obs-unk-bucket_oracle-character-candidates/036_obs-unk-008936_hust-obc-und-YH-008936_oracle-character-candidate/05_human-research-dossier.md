# obs-unk-008936 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008936`
- primary external id: `hust-obc-und-YH-008936`
...
- local review image route: `corpus/001_oracle-characters/106_undeciphered-008
  901-009000_obs-unk-bucket_oracle-character-candidates/036_obs-unk-008936_h
  ust-obc-und-YH-008936_oracle-character-candidate/03_visual-assets/001_asse
  t-010527_hust-obc-und-YH-008936_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60F80/Y_？_60F80.jpg`
- asset id: `asset-010527`
...
- source class: `HUST-OBC/undeciphered/Y+H/60F80/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60F80/Y_？_60F80.jpg`
- asset id: `asset-010527`
...
- Which source records identify obs-unk-008936 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008936？
