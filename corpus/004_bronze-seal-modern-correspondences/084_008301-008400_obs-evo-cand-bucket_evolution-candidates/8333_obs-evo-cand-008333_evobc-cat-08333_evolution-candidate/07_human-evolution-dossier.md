...
Project ID: `obs-evo-cand-008333`
...
- Project ID: `obs-evo-cand-008333`
- EVOBC category candidate ID: `evobc-evo-cat-08333`
- External category reference: `evobc-cat-08333`
- Source category ID: `08333`
- Source label for human review: `謰`
- Source codepoints: `U+8B30`
...
- `obs-evo-cand-008333-route-category-staging`
...
- `obs-evo-cand-008333-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008333-route-evolution-graph`
