# obs-char-000252 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000252`
- primary external id: `hust-obc-cat-0280`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/252_obs-char-000252_hust-obc-cat-0280_orac
  le-character/03_visual-assets/001_asset-000257_hust-obc-cat-0280_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0280/G_0280_乙3380反合17301反.png`
- asset id: `asset-000257`
...
- source category: `0280`
- validation class: `251`
- source image route: `HUST-OBC/deciphered/0280/G_0280_乙3380反合17301反.png`
- asset id: `asset-000257`
...
- English observation: `The image has a rounded rectangular outer contour, a
  short upper bar, and several irregular strokes inside the lower enclosed
  area.`
...
- dataset label text: `㔎`
- dataset label codepoints: `U+350E`
...
- Which source records identify obs-char-000252 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000252？
