...
- External category reference: `evobc-cat-11474`
- Source category ID: `11474`
- Source label for human review: `𣤰`
...
- `obs-evo-cand-011474-route-category-staging`
...
- `obs-evo-cand-011474-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011474-route-evolution-graph`
