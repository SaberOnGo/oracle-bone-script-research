# Material Visual Observation / obs-comp-cand-000532 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000532`
- External reference / 外部参照: `obimd-sub-m32ngscsu1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012766_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/m32ngscsu1/m32ngscsu1/m32ngscsu1.png`
- Checksum / 校验和:
  `35c69f69faf4023b1158da6f8c31763222cf5a489ed42e5f88f7ad804b4214fe`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.66%.
- Marked-pixel bounds: (59,51)–(190,194); span 132 × 144 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.66%。
- 痕迹范围：(59,51)–(190,194)；跨度132 × 144 px；痕迹矩形近方形。
