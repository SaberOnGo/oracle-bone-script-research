# Material Visual Observation / obs-comp-cand-001811 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001811`
- External reference / 外部参照: `obimd-sub-7w3mprfyzd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018032_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7w3mprfyzd/7w3mprfyzd/7w3mprfyzd.png`
- Checksum / 校验和:
  `f694bf64b2d34d502289ffccfb42e068c97e18afb38dce05f10862139cfad1c7`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 14.59%.
- Marked-pixel bounds: (36,33)–(212,208); span 177 × 176 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占14.59%。
- 痕迹范围：(36,33)–(212,208)；跨度177 × 176 px；痕迹矩形近方形。
