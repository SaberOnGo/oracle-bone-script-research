# obs-char-001316 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001316`
- primary external id: `hust-obc-cat-1471_1472`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1316_obs-char-001316_hust-obc-cat-1471_147
  2_oracle-character/03_visual-assets/001_asset-001321_hust-obc-cat-1471_147
  2_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1471_1472/1471/G_1471_存265(甲).p
  ng`
- asset id: `asset-001321`
...
- source category: `1471_1472`
- validation class: `1315`
- source image route: `HUST-OBC/deciphered/1471_1472/1471/G_1471_存265(甲).png`
- asset id: `asset-001321`
...
- English observation: `A tall rounded form has a central enclosed body,
  short inner divisions, and a broad lower outer curve.`
- 中文观察: `高直圆拱形体有中央框形主体、内部短分隔笔画和宽大的下部外侧弧线。`
...
- dataset label text: `㦵㦶`
- dataset label codepoints: `U+39B5;U+39B6`
...
- graph edge count: `2`
- codepoint routes: `U+39B5;U+39B6`
...
- Which source records identify obs-char-001316 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001316？
