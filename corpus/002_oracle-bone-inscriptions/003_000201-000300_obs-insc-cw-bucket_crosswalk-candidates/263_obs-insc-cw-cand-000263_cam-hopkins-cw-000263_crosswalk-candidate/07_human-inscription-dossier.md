...
- Yingguo / 英国所藏: `y1765` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `60` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `357` in source row; primary catalog entry pending
- Heji / 合集: `40853` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000263`
