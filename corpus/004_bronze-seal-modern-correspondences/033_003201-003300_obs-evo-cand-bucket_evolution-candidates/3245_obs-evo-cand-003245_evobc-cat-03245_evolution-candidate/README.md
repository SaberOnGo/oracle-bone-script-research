# obs-evo-cand-003245 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-003245`
- EVOBC category candidate ID: `evobc-evo-cat-03245`
- External category ref: `evobc-cat-03245`
- Source label: `才`
- Source codepoints: `U+624D`
- Image reference count: `288`
- Era token counts: `BI:98;CS:2;OBC:85;SAC:13;SS:2;WSC:88`
- Source token counts: `Book:138;Web:150`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 85 image references
- era 1 / BI: 98 image references
