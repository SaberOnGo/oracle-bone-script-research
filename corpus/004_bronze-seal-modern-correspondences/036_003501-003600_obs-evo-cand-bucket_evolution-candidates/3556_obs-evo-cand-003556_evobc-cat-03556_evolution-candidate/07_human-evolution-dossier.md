...
- External category reference: `evobc-cat-03556`
- Source category ID: `03556`
- Source label for human review: `攴`
- Source codepoints: `U+6534`
...
- `obs-evo-cand-003556-route-category-staging`
...
- `obs-evo-cand-003556-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003556-route-evolution-graph`
