...
- External category reference: `evobc-cat-10701`
- Source category ID: `10701`
- Source label for human review: `鼶`
- Source codepoints: `U+9F36`
...
- `obs-evo-cand-010701-route-category-staging`
...
- `obs-evo-cand-010701-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010701-route-evolution-graph`
