...
- External category reference: `evobc-cat-13512`
- Source category ID: `13512`
- Source label for human review: `𭔕`
- Source codepoints: `U+2D515`
...
- `obs-evo-cand-013512-route-category-staging`
...
- `obs-evo-cand-013512-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013512-route-evolution-graph`
