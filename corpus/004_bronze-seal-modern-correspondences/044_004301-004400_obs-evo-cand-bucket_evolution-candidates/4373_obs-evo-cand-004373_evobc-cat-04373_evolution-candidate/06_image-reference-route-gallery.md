...
- `obs-evo-cand-004373-route-category-staging`
...
- `obs-evo-cand-004373-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004373-route-evolution-graph`
