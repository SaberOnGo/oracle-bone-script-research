...
Project ID: `obs-evo-cand-000059`
...
- Project ID: `obs-evo-cand-000059`
- EVOBC category candidate ID: `evobc-evo-cat-00059`
- External category reference: `evobc-cat-00059`
- Source category ID: `00059`
- Source label for human review: `㛻`
- Source codepoints: `U+36FB`
...
- `obs-evo-cand-000059-route-category-staging`
...
- `obs-evo-cand-000059-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000059-route-evolution-graph`
