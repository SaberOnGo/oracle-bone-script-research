# Material Visual Observation / obs-comp-cand-002038 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002038`
- External reference / 外部参照: `obimd-sub-wn1shjuwz7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019365_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4noufqnl4f/wn1shjuwz7/wn1shjuwz7.png`
- Checksum / 校验和:
  `9b0aa32ae01dfe37dff1f3c0a051fb4244e446990120417c93803184dbae65c7`
...
- Marked-pixel bounds: (73,18)–(177,228); span 105 × 211 px; the marked
...
- 痕迹范围：(73,18)–(177,228)；跨度105 × 211 px；痕迹矩形高于宽。
