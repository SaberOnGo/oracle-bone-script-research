# obs-unk-000660 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/023_undeciphered-000
  601-000700_obs-unk-bucket_oracle-character-candidates/060_obs-unk-000660_h
  ust-obc-und-L-000660_oracle-character-candidate/03_visual-assets/001_asset
  -002253_hust-obc-und-L-000660_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/660/L_？_1198.jpg`
- asset id: `asset-002253`
...
- source class: `HUST-OBC/undeciphered/L/660/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/660/L_？_1198.jpg`
- asset id: `asset-002253`
...
- Which source records identify obs-unk-000660 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000660？
