...
- External category reference: `evobc-cat-06149`
- Source category ID: `06149`
- Source label for human review: `空`
...
- `obs-evo-cand-006149-route-category-staging`
...
- `obs-evo-cand-006149-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006149-route-evolution-graph`
