# obs-evo-cand-002611 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-002611`
- EVOBC category candidate ID: `evobc-evo-cat-02611`
- External category ref: `evobc-cat-02611`
- Source label: `州`
- Source codepoints: `U+5DDE`
- Image reference count: `138`
- Era token counts: `BI:15;CS:3;OBC:40;SAC:5;SS:3;WSC:72`
- Source token counts: `Book:42;Web:96`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 40 image references
- era 1 / BI: 15 image references
