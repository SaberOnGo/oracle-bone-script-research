...
- `obs-evo-cand-006266-route-category-staging`
...
- `obs-evo-cand-006266-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006266-route-evolution-graph`
