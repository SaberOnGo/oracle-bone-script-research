...
- Project ID: `obs-evo-cand-003133`
- EVOBC category candidate ID: `evobc-evo-cat-03133`
- External category reference: `evobc-cat-03133`
- Source category ID: `03133`
- Source label for human review: `慶`
- Source codepoints: `U+6176`
- Image reference count in source metadata: `128`
...
- `obs-evo-cand-003133-route-category-staging`
...
- `obs-evo-cand-003133-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003133-route-evolution-graph`
