# obs-comp-cand-001990 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001990`
- 首选外部 ID: `obimd-sub-l9s5pvc4ia`
- OBIMD subcharacter UID: `l9s5pvc4ia`
- OBIMD main character UID: `l9s5pvc4ia`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+20D35;U+FB610; U+FB611; 另有 3 项
