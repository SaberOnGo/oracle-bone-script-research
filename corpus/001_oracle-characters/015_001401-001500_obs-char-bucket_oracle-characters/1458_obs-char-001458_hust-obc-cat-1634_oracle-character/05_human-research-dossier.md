# obs-char-001458 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001458`
- primary external id: `hust-obc-cat-1634`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1458_obs-char-001458_hust-obc-cat-1634_ora
  cle-character/03_visual-assets/001_asset-001463_hust-obc-cat-1634_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1634/G_1634_乙1052合116賓組.png`
- asset id: `asset-001463`
...
- source category: `1634`
- validation class: `1457`
- source image route: `HUST-OBC/deciphered/1634/G_1634_乙1052合116賓組.png`
- asset id: `asset-001463`
...
- English observation: `A narrow curved form has a small upper hook and
  several long inner curves.`
- 中文观察: `狭长弧形体有小型上部钩笔和数条长内部弧线。`
...
- dataset label text: `㩘`
- dataset label codepoints: `U+3A58`
...
- filename catalog route clues: `Heji-like filename clue: 合116
  (G_1634_乙1052合116賓組.png)`
...
- Which source records identify obs-char-001458 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001458？
