...
Project ID: `obs-evo-cand-010951`
...
- Project ID: `obs-evo-cand-010951`
- EVOBC category candidate ID: `evobc-evo-cat-10951`
- External category reference: `evobc-cat-10951`
- Source category ID: `10951`
- Source label for human review: `𠸱`
- Source codepoints: `U+20E31`
...
- `obs-evo-cand-010951-route-category-staging`
...
- `obs-evo-cand-010951-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010951-route-evolution-graph`
