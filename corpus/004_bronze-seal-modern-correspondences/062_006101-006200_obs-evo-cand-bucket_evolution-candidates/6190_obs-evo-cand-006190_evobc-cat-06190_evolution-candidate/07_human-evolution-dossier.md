...
- External category reference: `evobc-cat-06190`
- Source category ID: `06190`
- Source label for human review: `竄`
...
- `obs-evo-cand-006190-route-category-staging`
...
- `obs-evo-cand-006190-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006190-route-evolution-graph`
