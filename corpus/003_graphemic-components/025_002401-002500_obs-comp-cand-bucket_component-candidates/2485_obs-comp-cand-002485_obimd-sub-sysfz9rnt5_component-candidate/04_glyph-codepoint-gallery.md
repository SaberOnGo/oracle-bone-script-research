# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002485
...
| --- | --- | --- | --- |
| `obimd-glyph-link-038254` | 󾊧 | `U+FE2A7` | `reviewed_metadata_only` |
| `obimd-glyph-link-038255` | 󾊨 | `U+FE2A8` | `reviewed_metadata_only` |
