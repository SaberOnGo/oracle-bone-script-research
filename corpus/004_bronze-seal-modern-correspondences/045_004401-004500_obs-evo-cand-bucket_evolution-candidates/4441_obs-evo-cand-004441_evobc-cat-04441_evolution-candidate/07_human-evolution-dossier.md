...
- External category reference: `evobc-cat-04441`
- Source category ID: `04441`
- Source label for human review: `毇`
...
- `obs-evo-cand-004441-route-category-staging`
...
- `obs-evo-cand-004441-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004441-route-evolution-graph`
