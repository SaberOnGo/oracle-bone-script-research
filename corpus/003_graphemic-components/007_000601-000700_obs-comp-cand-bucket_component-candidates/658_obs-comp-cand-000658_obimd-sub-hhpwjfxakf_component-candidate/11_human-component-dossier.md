# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-000658
...
- candidate_component_id: `obs-comp-cand-000658`
- primary_external_ref_id: `obimd-sub-hhpwjfxakf`
- source_subcharacter_uid: `hhpwjfxakf`
...
- glyph_codepoint_uplus_sample: `U+F3C92, U+F3C93, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-013221` | `001_asset-013221_img.png` | `056f96e23f22374ac25ae1c5e3ab3849a948b3193293ce2457de2fcd2ae4d8d1` |
