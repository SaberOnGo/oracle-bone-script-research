...
Project ID: `obs-evo-cand-010988`
...
- Project ID: `obs-evo-cand-010988`
- EVOBC category candidate ID: `evobc-evo-cat-10988`
- External category reference: `evobc-cat-10988`
- Source category ID: `10988`
- Source label for human review: `𡋫`
- Source codepoints: `U+212EB`
...
- `obs-evo-cand-010988-route-category-staging`
...
- `obs-evo-cand-010988-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010988-route-evolution-graph`
