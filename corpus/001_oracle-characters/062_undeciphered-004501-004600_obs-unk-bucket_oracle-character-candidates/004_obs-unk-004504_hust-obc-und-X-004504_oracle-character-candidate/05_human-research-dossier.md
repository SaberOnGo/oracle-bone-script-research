# obs-unk-004504 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/004_obs-unk-004504_h
  ust-obc-und-X-004504_oracle-character-candidate/03_visual-assets/001_asset
  -006097_hust-obc-und-X-004504_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/60/X_？_8245_1.png`
- asset id: `asset-006097`
...
- source class: `HUST-OBC/undeciphered/X/60/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/60/X_？_8245_1.png`
- asset id: `asset-006097`
...
- English observation: `The dark field, light gaps, irregular lower edge, and
  polarity uncertainty are directly recorded.`
- 中文观察: `已直接记录深色区域、内部浅色空隙、不规则下缘和极性待核状态。`
...
- Which source records identify obs-unk-004504 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004504？
