# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010458
...
- EVOBC candidate category: `evobc-evo-cat-10458`.
- Source label for search only: `鱺`.
- Source codepoints for search only: `U+9C7A`.
