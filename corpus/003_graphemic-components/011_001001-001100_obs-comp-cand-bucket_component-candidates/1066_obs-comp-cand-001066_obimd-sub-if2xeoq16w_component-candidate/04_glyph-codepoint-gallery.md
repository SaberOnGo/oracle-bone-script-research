# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001066
...
| --- | --- | --- | --- |
| `obimd-glyph-link-015669` | 򦵰󶅼 | `U+A6D70;U+F617C` | `reviewed_metadata_only` |
| `obimd-glyph-link-015670` | 󶅽 | `U+F617D` | `reviewed_metadata_only` |
