...
- External category reference: `evobc-cat-12704`
- Source category ID: `12704`
- Source label for human review: `𩹯`
...
- `obs-evo-cand-012704-route-category-staging`
...
- `obs-evo-cand-012704-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012704-route-evolution-graph`
