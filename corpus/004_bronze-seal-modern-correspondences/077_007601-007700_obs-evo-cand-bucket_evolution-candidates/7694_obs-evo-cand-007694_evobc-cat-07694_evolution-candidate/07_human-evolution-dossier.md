...
Project ID: `obs-evo-cand-007694`
...
- Project ID: `obs-evo-cand-007694`
- EVOBC category candidate ID: `evobc-evo-cat-07694`
- External category reference: `evobc-cat-07694`
- Source category ID: `07694`
- Source label for human review: `虑`
- Source codepoints: `U+8651`
...
- `obs-evo-cand-007694-route-category-staging`
...
- `obs-evo-cand-007694-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007694-route-evolution-graph`
