...
- External category reference: `evobc-cat-07636`
- Source category ID: `07636`
- Source label for human review: `藉`
...
- `obs-evo-cand-007636-route-category-staging`
...
- `obs-evo-cand-007636-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007636-route-evolution-graph`
