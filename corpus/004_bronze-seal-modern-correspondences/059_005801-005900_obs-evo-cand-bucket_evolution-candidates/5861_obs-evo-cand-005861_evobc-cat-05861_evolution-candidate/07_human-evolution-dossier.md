...
Project ID: `obs-evo-cand-005861`
...
- Project ID: `obs-evo-cand-005861`
- EVOBC category candidate ID: `evobc-evo-cat-05861`
- External category reference: `evobc-cat-05861`
- Source category ID: `05861`
- Source label for human review: `瞵`
- Source codepoints: `U+77B5`
...
- `obs-evo-cand-005861-route-category-staging`
...
- `obs-evo-cand-005861-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005861-route-evolution-graph`
