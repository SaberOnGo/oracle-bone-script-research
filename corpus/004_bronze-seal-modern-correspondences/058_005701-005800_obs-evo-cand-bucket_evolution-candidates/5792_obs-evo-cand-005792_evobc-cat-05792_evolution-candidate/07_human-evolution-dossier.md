...
Project ID: `obs-evo-cand-005792`
...
- Project ID: `obs-evo-cand-005792`
- EVOBC category candidate ID: `evobc-evo-cat-05792`
- External category reference: `evobc-cat-05792`
- Source category ID: `05792`
- Source label for human review: `眓`
- Source codepoints: `U+7713`
...
- `obs-evo-cand-005792-route-category-staging`
...
- `obs-evo-cand-005792-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005792-route-evolution-graph`
