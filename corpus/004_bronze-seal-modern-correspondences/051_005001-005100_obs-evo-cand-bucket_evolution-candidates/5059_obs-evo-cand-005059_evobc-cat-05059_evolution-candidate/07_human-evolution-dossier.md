...
- External category reference: `evobc-cat-05059`
- Source category ID: `05059`
- Source label for human review: `炼`
- Source codepoints: `U+70BC`
...
- `obs-evo-cand-005059-route-category-staging`
...
- `obs-evo-cand-005059-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005059-route-evolution-graph`
