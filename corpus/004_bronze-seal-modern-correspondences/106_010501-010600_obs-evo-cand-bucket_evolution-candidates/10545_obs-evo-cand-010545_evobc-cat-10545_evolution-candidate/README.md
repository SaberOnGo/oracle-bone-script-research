# obs-evo-cand-010545 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-10545`
- Source label for human review: `鷄`
- Source codepoints: `U+9DC4`
- Image reference count: `64`
- Era token counts: `OBC:64`
- Source token counts: `Book:40;Web:24`
