...
- Project ID: `obs-evo-cand-011575`
- EVOBC category candidate ID: `evobc-evo-cat-11575`
- External category reference: `evobc-cat-11575`
- Source category ID: `11575`
- Source label for human review: `𤏻`
- Source codepoints: `U+243FB`
...
- `obs-evo-cand-011575-route-category-staging`
...
- `obs-evo-cand-011575-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011575-route-evolution-graph`
