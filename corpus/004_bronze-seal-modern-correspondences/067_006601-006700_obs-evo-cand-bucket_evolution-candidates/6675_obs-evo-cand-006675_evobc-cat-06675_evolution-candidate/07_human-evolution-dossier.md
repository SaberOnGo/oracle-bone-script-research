...
- External category reference: `evobc-cat-06675`
- Source category ID: `06675`
- Source label for human review: `繖`
...
- `obs-evo-cand-006675-route-category-staging`
...
- `obs-evo-cand-006675-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006675-route-evolution-graph`
