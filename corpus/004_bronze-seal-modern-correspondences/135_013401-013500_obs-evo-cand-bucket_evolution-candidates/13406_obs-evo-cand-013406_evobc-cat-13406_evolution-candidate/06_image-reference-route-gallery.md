...
- `obs-evo-cand-013406-route-category-staging`
...
- `obs-evo-cand-013406-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013406-route-evolution-graph`
