# obs-unk-002320 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002320`
- primary external id: `hust-obc-und-L-002320`
...
- local review image route: `corpus/001_oracle-characters/040_undeciphered-002
  301-002400_obs-unk-bucket_oracle-character-candidates/020_obs-unk-002320_h
  ust-obc-und-L-002320_oracle-character-candidate/03_visual-assets/001_asset
  -003913_hust-obc-und-L-002320_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2320/L_？_3013.jpg`
- asset id: `asset-003913`
...
- source class: `HUST-OBC/undeciphered/L/2320/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2320/L_？_3013.jpg`
- asset id: `asset-003913`
...
- Which source records identify obs-unk-002320 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002320？
