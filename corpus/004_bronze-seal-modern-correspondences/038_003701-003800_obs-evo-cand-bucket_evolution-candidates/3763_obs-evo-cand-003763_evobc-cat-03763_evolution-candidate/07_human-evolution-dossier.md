...
- External category reference: `evobc-cat-03763`
- Source category ID: `03763`
- Source label for human review: `晹`
- Source codepoints: `U+6679`
...
- `obs-evo-cand-003763-route-category-staging`
...
- `obs-evo-cand-003763-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003763-route-evolution-graph`
