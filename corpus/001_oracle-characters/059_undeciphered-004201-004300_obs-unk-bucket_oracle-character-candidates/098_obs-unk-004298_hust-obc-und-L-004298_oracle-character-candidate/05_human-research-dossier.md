# obs-unk-004298 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004298`
- primary external id: `hust-obc-und-L-004298`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/098_obs-unk-004298_h
  ust-obc-und-L-004298_oracle-character-candidate/03_visual-assets/001_asset
  -005891_hust-obc-und-L-004298_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4298/L_？_949.jpg`
- asset id: `asset-005891`
...
- source class: `HUST-OBC/undeciphered/L/4298/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4298/L_？_949.jpg`
- asset id: `asset-005891`
...
- English observation: `Long left curve, upper arc, right hook visible.`
- 中文观察: `左侧长弯痕、上部弧痕和右侧钩痕可见。`
...
- Which source records identify obs-unk-004298 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004298？
