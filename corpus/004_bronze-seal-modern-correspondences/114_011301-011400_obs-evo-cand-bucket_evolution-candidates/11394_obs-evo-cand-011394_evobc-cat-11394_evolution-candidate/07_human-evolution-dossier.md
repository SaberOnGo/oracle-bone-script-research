...
- External category reference: `evobc-cat-11394`
- Source category ID: `11394`
- Source label for human review: `𣄰`
- Source codepoints: `U+23130`
...
- `obs-evo-cand-011394-route-category-staging`
...
- `obs-evo-cand-011394-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011394-route-evolution-graph`
