...
- External category reference: `evobc-cat-08865`
- Source category ID: `08865`
- Source label for human review: `轅`
- Source codepoints: `U+8F45`
...
- `obs-evo-cand-008865-route-category-staging`
...
- `obs-evo-cand-008865-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008865-route-evolution-graph`
