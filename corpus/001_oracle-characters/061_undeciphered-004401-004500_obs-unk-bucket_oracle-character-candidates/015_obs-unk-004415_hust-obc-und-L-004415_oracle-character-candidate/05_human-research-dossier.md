# obs-unk-004415 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004415`
- primary external id: `hust-obc-und-L-004415`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/015_obs-unk-004415_h
  ust-obc-und-L-004415_oracle-character-candidate/03_visual-assets/001_asset
  -006008_hust-obc-und-L-004415_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4415/L_？_9870.jpg`
- asset id: `asset-006008`
...
- source class: `HUST-OBC/undeciphered/L/4415/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4415/L_？_9870.jpg`
- asset id: `asset-006008`
...
- English observation: `An angular upper arch leads to a central trace`
  `and long lower diagonal.`
- 中文观察: `上部角状弧形痕迹通向中央痕迹和下部长斜痕。`
...
- Which source records identify obs-unk-004415 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004415？
