# obs-unk-004265 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/065_obs-unk-004265_h
  ust-obc-und-L-004265_oracle-character-candidate/03_visual-assets/001_asset
  -005858_hust-obc-und-L-004265_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4265/L_？_9401.jpg`
- asset id: `asset-005858`
...
- source class: `HUST-OBC/undeciphered/L/4265/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4265/L_？_9401.jpg`
- asset id: `asset-005858`
...
- English observation: `Upper angles, left descent, short lower marks visible.`
- 中文观察: `上部棱角轮廓、左侧下行痕迹和下部短痕可见。`
...
- Which source records identify obs-unk-004265 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004265？
