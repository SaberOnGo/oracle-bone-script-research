...
- `obs-evo-cand-012535-route-category-staging`
...
- `obs-evo-cand-012535-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012535-route-evolution-graph`
