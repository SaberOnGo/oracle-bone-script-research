# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000589
...
- EVOBC candidate category: `evobc-evo-cat-00589`.
- Source label for search only: `䵭`.
- Source codepoints for search only: `U+4D6D`.
