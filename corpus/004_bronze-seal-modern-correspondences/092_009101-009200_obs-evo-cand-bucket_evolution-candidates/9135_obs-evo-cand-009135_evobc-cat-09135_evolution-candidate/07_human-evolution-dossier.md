...
Project ID: `obs-evo-cand-009135`
...
- Project ID: `obs-evo-cand-009135`
- EVOBC category candidate ID: `evobc-evo-cat-09135`
- External category reference: `evobc-cat-09135`
- Source category ID: `09135`
- Source label for human review: `郍`
- Source codepoints: `U+90CD`
...
- `obs-evo-cand-009135-route-category-staging`
...
- `obs-evo-cand-009135-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009135-route-evolution-graph`
