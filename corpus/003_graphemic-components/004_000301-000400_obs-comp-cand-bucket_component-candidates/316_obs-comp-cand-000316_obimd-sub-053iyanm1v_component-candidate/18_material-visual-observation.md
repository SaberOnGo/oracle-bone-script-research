# Material Visual Observation / obs-comp-cand-000316 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000316`
- External reference / 外部参照: `obimd-sub-053iyanm1v`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012243_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ajjda965yb/053iyanm1v/053iyanm1v.png`
- Checksum / 校验和:
  `b75bd04ee417abbc299e17552f0cf8444f41a7cbce2c5a4352118dfbb3604573`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.34%.
- Marked-pixel bounds: (56,39)–(193,215); span 138 × 177 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.34%。
- 痕迹范围：(56,39)–(193,215)；跨度138 × 177 px；痕迹矩形高于宽。
