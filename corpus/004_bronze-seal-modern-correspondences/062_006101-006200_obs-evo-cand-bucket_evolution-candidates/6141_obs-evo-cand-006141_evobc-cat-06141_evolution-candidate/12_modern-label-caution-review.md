# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006141
...
- EVOBC candidate category: `evobc-evo-cat-06141`.
- Source label for search only: `穮`.
- Source codepoints for search only: `U+7A6E`.
