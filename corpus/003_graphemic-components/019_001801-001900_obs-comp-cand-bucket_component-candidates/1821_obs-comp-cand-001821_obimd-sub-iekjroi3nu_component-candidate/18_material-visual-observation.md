# Material Visual Observation / obs-comp-cand-001821 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001821`
- External reference / 外部参照: `obimd-sub-iekjroi3nu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018147_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/j3rxkj56cs/iekjroi3nu/iekjroi3nu.png`
- Checksum / 校验和:
  `052700c686687b0902213c444e1434ef88bdb652b0a26998102107b89c901db8`
...
- Marked-pixel bounds: (53,19)–(205,228); span 153 × 210 px; the marked
...
- 痕迹范围：(53,19)–(205,228)；跨度153 × 210 px；痕迹矩形高于宽。
