...
- External category reference: `evobc-cat-08337`
- Source category ID: `08337`
- Source label for human review: `謵`
...
- `obs-evo-cand-008337-route-category-staging`
...
- `obs-evo-cand-008337-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008337-route-evolution-graph`
