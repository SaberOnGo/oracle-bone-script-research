...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1700`
...
- Source image / 来源图: `G_1700_乙4878合701.png`
- Image / 图像: `001_asset-001520_hust-obc-cat-1700_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合701
...
- target node: `evobc-evo-cat-00150`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/150_obs-evo-cand-000150_evobc-cat-00150_evoluti
...
- Source label text / 来源标签文字: `㪚`
- Source label codepoint / 来源标签 codepoint: `U+3A9A`
