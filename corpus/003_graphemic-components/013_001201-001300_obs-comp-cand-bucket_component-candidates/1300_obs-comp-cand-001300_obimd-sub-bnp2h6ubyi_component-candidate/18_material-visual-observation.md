# Material Visual Observation / obs-comp-cand-001300 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001300`
- External reference / 外部参照: `obimd-sub-bnp2h6ubyi`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015637_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2sdz63p9g6/bnp2h6ubyi/bnp2h6ubyi.png`
- Checksum / 校验和:
  `d3243fe9f2dc1849a8cee5165d15aeccbf5c25ebd1ef1a6e09af48530a375aff`
...
- Marked-pixel bounds: (87,32)–(151,219); span 65 × 188 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.97%。
- 痕迹范围：(87,32)–(151,219)；跨度65 × 188 px；痕迹矩形高于宽。
