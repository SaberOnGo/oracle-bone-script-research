...
Project ID: `obs-evo-cand-002152`
...
- Project ID: `obs-evo-cand-002152`
- EVOBC category candidate ID: `evobc-evo-cat-02152`
- External category reference: `evobc-cat-02152`
- Source category ID: `02152`
- Source label for human review: `威`
- Source codepoints: `U+5A01`
...
- `obs-evo-cand-002152-route-category-staging`
...
- `obs-evo-cand-002152-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002152-route-evolution-graph`
