...
- Project ID: `obs-evo-cand-013654`
- EVOBC category candidate ID: `evobc-evo-cat-13654`
- External category reference: `evobc-cat-13654`
- Source category ID: `13654`
- Source label for human review: `𮞰`
- Source codepoints: `U+2E7B0`
...
- `obs-evo-cand-013654-route-category-staging`
...
- `obs-evo-cand-013654-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013654-route-evolution-graph`
