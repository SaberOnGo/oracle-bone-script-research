# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006868
...
- EVOBC candidate category: `evobc-evo-cat-06868`.
- Source label for search only: `羼`.
- Source codepoints for search only: `U+7FBC`.
