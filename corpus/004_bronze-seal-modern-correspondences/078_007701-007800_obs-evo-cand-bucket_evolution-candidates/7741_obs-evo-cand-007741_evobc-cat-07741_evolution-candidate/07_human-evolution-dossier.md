...
Project ID: `obs-evo-cand-007741`
...
- Project ID: `obs-evo-cand-007741`
- EVOBC category candidate ID: `evobc-evo-cat-07741`
- External category reference: `evobc-cat-07741`
- Source category ID: `07741`
- Source label for human review: `蛄`
- Source codepoints: `U+86C4`
...
- `obs-evo-cand-007741-route-category-staging`
...
- `obs-evo-cand-007741-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007741-route-evolution-graph`
