...
- External category reference: `evobc-cat-05260`
- Source category ID: `05260`
- Source label for human review: `狇`
...
- `obs-evo-cand-005260-route-category-staging`
...
- `obs-evo-cand-005260-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005260-route-evolution-graph`
