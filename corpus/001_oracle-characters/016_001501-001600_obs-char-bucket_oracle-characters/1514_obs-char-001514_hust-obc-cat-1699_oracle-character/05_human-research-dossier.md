# obs-char-001514 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001514`
- primary external id: `hust-obc-cat-1699`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1514_obs-char-001514_hust-obc-cat-1699_ora
  cle-character/03_visual-assets/001_asset-001519_hust-obc-cat-1699_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1699/G_1699_乙4736(甲).png`
- asset id: `asset-001519`
...
- source category: `1699`
- validation class: `1513`
- source image route: `HUST-OBC/deciphered/1699/G_1699_乙4736(甲).png`
- asset id: `asset-001519`
...
- English observation: `A sparse composite has layered curved marks on the
  left and a detached hooked mark on the right.`
- 中文观察: `稀疏组合形体左侧有层叠弧笔，右侧有分离的钩状标记。`
...
- dataset label text: `㪙`
- dataset label codepoints: `U+3A99`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00149`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00149`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/149_obs-evo-can
  d-000149_evobc-cat-00149_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/149_obs-evo-cand-000149_evobc-cat-00149_evolu
...
- Which source records identify obs-char-001514 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001514？
