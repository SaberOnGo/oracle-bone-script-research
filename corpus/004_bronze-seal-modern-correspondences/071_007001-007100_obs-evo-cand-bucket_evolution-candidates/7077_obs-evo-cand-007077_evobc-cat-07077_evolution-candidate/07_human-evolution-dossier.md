...
- External category reference: `evobc-cat-07077`
- Source category ID: `07077`
- Source label for human review: `脮`
- Source codepoints: `U+812E`
...
- `obs-evo-cand-007077-route-category-staging`
...
- `obs-evo-cand-007077-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007077-route-evolution-graph`
