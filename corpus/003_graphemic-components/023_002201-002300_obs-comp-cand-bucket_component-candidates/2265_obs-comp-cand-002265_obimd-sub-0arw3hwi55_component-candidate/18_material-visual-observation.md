# Material Visual Observation / obs-comp-cand-002265 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002265`
- External reference / 外部参照: `obimd-sub-0arw3hwi55`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020106_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/m2w1k92a5a/0arw3hwi55/0arw3hwi55.png`
- Checksum / 校验和:
  `0d36c4e5b33f4fa4c80bb2153bd281208f542b40ace283c3cd3edd48c4d560ac`
...
- Marked-pixel bounds: (84,33)–(165,209); span 82 × 177 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.45%。
- 痕迹范围：(84,33)–(165,209)；跨度82 × 177 px；痕迹矩形高于宽。
