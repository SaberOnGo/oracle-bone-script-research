# Material Visual Observation / obs-comp-cand-002174 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002174`
- External reference / 外部参照: `obimd-sub-0aysjz0vm0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019875_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/q4rk3syf2x/0aysjz0vm0/0aysjz0vm0.png`
- Checksum / 校验和:
  `b2c641e74076235ece1ee07b80a86f330088fa481ce7adb8725f261532f72115`
...
- Marked-pixel bounds: (92,30)–(157,219); span 66 × 190 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.13%。
- 痕迹范围：(92,30)–(157,219)；跨度66 × 190 px；痕迹矩形高于宽。
