...
- `obs-evo-cand-001748-route-category-staging`
...
- `obs-evo-cand-001748-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001748-route-evolution-graph`
