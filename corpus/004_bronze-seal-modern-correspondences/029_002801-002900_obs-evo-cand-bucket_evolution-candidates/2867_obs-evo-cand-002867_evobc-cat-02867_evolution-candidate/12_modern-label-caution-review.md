# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002867
...
- EVOBC candidate category: `evobc-evo-cat-02867`.
- Source label for search only: `後`.
- Source codepoints for search only: `U+5F8C`.
