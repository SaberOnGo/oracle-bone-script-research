...
Project ID: `obs-evo-cand-004414`
...
- Project ID: `obs-evo-cand-004414`
- EVOBC category candidate ID: `evobc-evo-cat-04414`
- External category reference: `evobc-cat-04414`
- Source category ID: `04414`
- Source label for human review: `殛`
- Source codepoints: `U+6B9B`
...
- `obs-evo-cand-004414-route-category-staging`
...
- `obs-evo-cand-004414-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004414-route-evolution-graph`
