# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003143
...
- EVOBC candidate category: `evobc-evo-cat-03143`.
- Source label for search only: `憌`.
- Source codepoints for search only: `U+618C`.
