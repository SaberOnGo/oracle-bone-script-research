# Material Visual Observation / obs-comp-cand-002285 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002285`
- External reference / 外部参照: `obimd-sub-alc6p2yimn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020169_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/alc6p2yimn/alc6p2yimn/alc6p2yimn.png`
- Checksum / 校验和:
  `c0137c5507e75577e68e1250975330f2f1428f44c7743c31e6524c07cc1cd619`
...
- Marked-pixel bounds: (55,31)–(194,212); span 140 × 182 px; the marked
...
- 痕迹范围：(55,31)–(194,212)；跨度140 × 182 px；痕迹矩形高于宽。
