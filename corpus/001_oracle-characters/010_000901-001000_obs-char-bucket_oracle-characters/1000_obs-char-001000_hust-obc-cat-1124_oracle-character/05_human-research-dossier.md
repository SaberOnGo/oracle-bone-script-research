# obs-char-001000 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001000`
- primary external id: `hust-obc-cat-1124`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/1000_obs-char-001000_hust-obc-cat-1124_ora
  cle-character/03_visual-assets/001_asset-001005_hust-obc-cat-1124_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1124/G_1124_後2.26.11(甲).png`
- asset id: `asset-001005`
...
- source category: `1124`
- validation class: `999`
- source image route: `HUST-OBC/deciphered/1124/G_1124_後2.26.11(甲).png`
- asset id: `asset-001005`
...
- English observation: `Three short upright strokes rise above a rounded
  enclosure with lower side branches and a central descending stroke.`
- 中文观察: `三条短直立笔位于圆弧闭合轮廓之上，下部有侧分枝和中央下行笔。`
...
- dataset label text: `㡚`
- dataset label codepoints: `U+385A`
...
- Which source records identify obs-char-001000 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001000？
