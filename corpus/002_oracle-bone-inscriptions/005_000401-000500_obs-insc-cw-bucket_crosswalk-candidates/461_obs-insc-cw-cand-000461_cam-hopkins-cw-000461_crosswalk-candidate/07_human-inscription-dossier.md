...
Project ID: `obs-insc-cw-cand-000461`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000461`
...
- Source page section: `Period III Group 17` /
  `第 III 期第 17 组`
- Source section key: `period-iii-group-17`
...
- Yingguo / 英国所藏: `y2351` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `575` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `398` in source row; primary catalog entry pending
- Heji / 合集: `41304` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000461`
