# Material Visual Observation / obs-comp-cand-001540 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001540`
- External reference / 外部参照: `obimd-sub-7erj65ocvr`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016954_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/aelrb19u0i/7erj65ocvr/7erj65ocvr.png`
- Checksum / 校验和:
  `cf18fc4e4106730d6670500b4b0f981454455ef451307e2ed84f4bbe4612bc98`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.80%.
- Marked-pixel bounds: (78,40)–(171,207); span 94 × 168 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.80%。
- 痕迹范围：(78,40)–(171,207)；跨度94 × 168 px；痕迹矩形高于宽。
