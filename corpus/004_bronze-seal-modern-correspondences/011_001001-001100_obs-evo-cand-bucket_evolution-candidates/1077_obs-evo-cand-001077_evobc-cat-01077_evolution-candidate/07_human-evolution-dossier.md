...
- External category reference: `evobc-cat-01077`
- Source category ID: `01077`
- Source label for human review: `兑`
- Source codepoints: `U+5151`
...
- `obs-evo-cand-001077-route-category-staging`
...
- `obs-evo-cand-001077-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001077-route-evolution-graph`
