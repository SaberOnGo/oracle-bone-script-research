# obs-char-000136 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/136_obs-char-000136_hust-obc-cat-0151_orac
  le-character/03_visual-assets/001_asset-000141_hust-obc-cat-0151_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0151/G_0151_乙1221合17933.png`
- asset id: `asset-000141`
...
- source category: `0151`
- validation class: `135`
- source image route: `HUST-OBC/deciphered/0151/G_0151_乙1221合17933.png`
- asset id: `asset-000141`
...
- English observation: `The image combines a small angular cluster at the
  top with a narrow curved stroke extending downward from its right side.`
- 中文观察: `图像上方有小型折角笔群，右侧连接一条向下延伸的窄弯曲笔。`
...
- dataset label text: `㒍`
- dataset label codepoints: `U+348D`
...
- filename catalog route clues: `Heji-like filename clue: 合17933
  (G_0151_乙1221合17933.png)`
...
- Which source records identify obs-char-000136 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000136？
