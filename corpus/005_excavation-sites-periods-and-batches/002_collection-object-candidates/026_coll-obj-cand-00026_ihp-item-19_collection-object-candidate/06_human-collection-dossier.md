# Human Collection Object Dossier / 馆藏对象研究档案: coll-obj-cand-00026
...
- project_id: `coll-obj-cand-00026`
- candidate_collection_object_id: `ihp-mus-obj-00026`
- source_collection_item_id: `19`
...
| `source_collection_item_id` | `19` |
| `object_title_en` | `Inscribed Deer Skull Chia 3940` |
| `catalog_reference_text` | `Chia 3940` |
| `object_page_url` | `https://museum.sinica.edu.tw/en/collection/32/item/19/` |
| `thumbnail_url` | `https://museum.sinica.edu.tw/_upload/image/collection_item/thumbnail/3175f69c749919f9.jpg` |
