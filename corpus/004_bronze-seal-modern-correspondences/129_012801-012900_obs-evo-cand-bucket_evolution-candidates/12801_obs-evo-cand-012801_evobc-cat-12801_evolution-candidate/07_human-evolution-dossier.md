...
Project ID: `obs-evo-cand-012801`
...
- Project ID: `obs-evo-cand-012801`
- EVOBC category candidate ID: `evobc-evo-cat-12801`
- External category reference: `evobc-cat-12801`
- Source category ID: `12801`
- Source label for human review: `𪠁`
- Source codepoints: `U+2A801`
...
- `obs-evo-cand-012801-route-category-staging`
...
- `obs-evo-cand-012801-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012801-route-evolution-graph`
