# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002601
...
- EVOBC candidate category: `evobc-evo-cat-02601`.
- Source label for search only: `嶺`.
- Source codepoints for search only: `U+5DBA`.
