# Material Visual Observation / obs-comp-cand-000888 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000888`
- External reference / 外部参照: `obimd-sub-cvzszyp6bm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013960_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cvzszyp6bm/cvzszyp6bm/cvzszyp6bm.png`
- Checksum / 校验和:
  `7222b44cb8ef84507e6c68aa778194039f083a87030a1965986b84d430504e3a`
...
- Marked-pixel bounds: (77,34)–(172,217); span 96 × 184 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.32%。
- 痕迹范围：(77,34)–(172,217)；跨度96 × 184 px；痕迹矩形高于宽。
