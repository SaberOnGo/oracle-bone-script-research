# obs-char-000890 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/890_obs-char-000890_hust-obc-cat-1002_orac
  le-character/03_visual-assets/001_asset-000895_hust-obc-cat-1002_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1002/X_1002_5033_1.png`
- asset id: `asset-000895`
...
- source category: `1002`
- validation class: `889`
- source image route: `HUST-OBC/deciphered/1002/X_1002_5033_1.png`
- asset id: `asset-000895`
...
- English observation: `A very bold dense form combines an upper horizontal
  and upright with a large irregular lower mass and internal openings.`
...
- dataset label text: `㟠`
- dataset label codepoints: `U+37E0`
...
- Which source records identify obs-char-000890 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000890？
