# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006518
...
- EVOBC candidate category: `evobc-evo-cat-06518`.
- Source label for search only: `絫`.
- Source codepoints for search only: `U+7D6B`.
