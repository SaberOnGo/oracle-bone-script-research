# obs-unk-004628 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/028_obs-unk-004628_h
  ust-obc-und-X-004628_oracle-character-candidate/03_visual-assets/001_asset
  -006221_hust-obc-und-X-004628_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/184/X_？_8358_1.png`
- asset id: `asset-006221`
...
- source class: `HUST-OBC/undeciphered/X/184/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/184/X_？_8358_1.png`
- asset id: `asset-006221`
...
- English observation: `upper arch, cross trace, lower loop`
- 中文观察: `上部弧形、横向痕和下部环状形体已记录。`
...
- Which source records identify obs-unk-004628 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004628？
