...
- External category reference: `evobc-cat-12495`
- Source category ID: `12495`
- Source label for human review: `𨮣`
- Source codepoints: `U+28BA3`
...
- `obs-evo-cand-012495-route-category-staging`
...
- `obs-evo-cand-012495-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012495-route-evolution-graph`
