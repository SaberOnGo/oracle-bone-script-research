...
- External category reference: `evobc-cat-13128`
- Source category ID: `13128`
...
- `obs-evo-cand-013128-route-category-staging`
...
- `obs-evo-cand-013128-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013128-route-evolution-graph`
