# obs-char-000033 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/033_obs-char-000033_hust-obc-cat-0038_orac
  le-character/03_visual-assets/001_asset-000038_hust-obc-cat-0038_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0038/G_0038_後1.15.15合6942賓組.png
  `
- asset id: `asset-000038`
...
- source category: `0038`
- validation class: `32`
- source image route: `HUST-OBC/deciphered/0038/G_0038_後1.15.15合6942賓組.png`
- asset id: `asset-000038`
...
- English observation: `Two neighboring forms are visible, each with a
  central oval-like mark and short strokes extending to both sides.`
...
- dataset label text: `㐜`
- dataset label codepoints: `U+341C`
...
- filename catalog route clues: `Heji-like filename clue: 合6942
  (G_0038_後1.15.15合6942賓組.png)`
...
- Which source records identify obs-char-000033 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000033？
