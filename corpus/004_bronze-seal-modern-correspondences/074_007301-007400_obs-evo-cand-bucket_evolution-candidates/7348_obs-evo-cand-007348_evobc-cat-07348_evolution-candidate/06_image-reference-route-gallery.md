...
- `obs-evo-cand-007348-route-category-staging`
...
- `obs-evo-cand-007348-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007348-route-evolution-graph`
