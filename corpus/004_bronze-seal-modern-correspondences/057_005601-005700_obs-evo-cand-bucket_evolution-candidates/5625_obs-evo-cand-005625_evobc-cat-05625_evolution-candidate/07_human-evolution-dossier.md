...
- External category reference: `evobc-cat-05625`
- Source category ID: `05625`
- Source label for human review: `疹`
...
- `obs-evo-cand-005625-route-category-staging`
...
- `obs-evo-cand-005625-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005625-route-evolution-graph`
