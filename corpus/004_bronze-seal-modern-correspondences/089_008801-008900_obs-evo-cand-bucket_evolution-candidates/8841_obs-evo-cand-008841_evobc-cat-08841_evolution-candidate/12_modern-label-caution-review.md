# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008841
...
- EVOBC candidate category: `evobc-evo-cat-08841`.
- Source label for search only: `輜`.
- Source codepoints for search only: `U+8F1C`.
