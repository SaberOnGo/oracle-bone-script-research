...
- External category reference: `evobc-cat-09852`
- Source category ID: `09852`
- Source label for human review: `霆`
- Source codepoints: `U+9706`
...
- `obs-evo-cand-009852-route-category-staging`
...
- `obs-evo-cand-009852-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009852-route-evolution-graph`
