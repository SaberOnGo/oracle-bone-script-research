# obs-unk-006114 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/078_undeciphered-006
  101-006200_obs-unk-bucket_oracle-character-candidates/014_obs-unk-006114_h
  ust-obc-und-X-006114_oracle-character-candidate/03_visual-assets/001_asset
  -007706_hust-obc-und-X-006114_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1670/X_？_3629_1.png`
- asset id: `asset-007706`
...
- source class: `HUST-OBC/undeciphered/X/1670/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1670/X_？_3629_1.png`
- asset id: `asset-007706`
...
- Which source records identify obs-unk-006114 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006114？
