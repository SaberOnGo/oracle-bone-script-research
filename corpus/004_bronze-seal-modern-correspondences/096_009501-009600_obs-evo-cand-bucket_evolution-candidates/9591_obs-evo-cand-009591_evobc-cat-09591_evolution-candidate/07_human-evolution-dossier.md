...
- External category reference: `evobc-cat-09591`
- Source category ID: `09591`
- Source label for human review: `锄`
...
- `obs-evo-cand-009591-route-category-staging`
...
- `obs-evo-cand-009591-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009591-route-evolution-graph`
