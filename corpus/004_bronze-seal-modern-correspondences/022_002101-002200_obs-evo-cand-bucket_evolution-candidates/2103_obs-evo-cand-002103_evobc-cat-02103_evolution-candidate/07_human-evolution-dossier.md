...
Project ID: `obs-evo-cand-002103`
...
- Project ID: `obs-evo-cand-002103`
- EVOBC category candidate ID: `evobc-evo-cat-02103`
- External category reference: `evobc-cat-02103`
- Source category ID: `02103`
- Source label for human review: `妶`
- Source codepoints: `U+59B6`
...
- `obs-evo-cand-002103-route-category-staging`
...
- `obs-evo-cand-002103-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002103-route-evolution-graph`
