...
- Project ID: `obs-evo-cand-000716`
- EVOBC category candidate ID: `evobc-evo-cat-00716`
- External category reference: `evobc-cat-00716`
- Source category ID: `00716`
- Source label for human review: `人`
- Source codepoints: `U+4EBA`
- Image reference count in source metadata: `626`
...
- `obs-evo-cand-000716-route-category-staging`
...
- `obs-evo-cand-000716-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000716-route-evolution-graph`
