...
Project ID: `obs-evo-cand-004768`
...
- Project ID: `obs-evo-cand-004768`
- EVOBC category candidate ID: `evobc-evo-cat-04768`
- External category reference: `evobc-cat-04768`
- Source category ID: `04768`
- Source label for human review: `渴`
- Source codepoints: `U+6E34`
...
- `obs-evo-cand-004768-route-category-staging`
...
- `obs-evo-cand-004768-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004768-route-evolution-graph`
