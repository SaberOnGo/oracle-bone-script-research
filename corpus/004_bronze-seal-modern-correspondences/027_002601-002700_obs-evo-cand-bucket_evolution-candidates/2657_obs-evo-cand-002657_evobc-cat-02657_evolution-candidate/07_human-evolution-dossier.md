...
- Project ID: `obs-evo-cand-002657`
- EVOBC category candidate ID: `evobc-evo-cat-02657`
- External category reference: `evobc-cat-02657`
- Source category ID: `02657`
- Source label for human review: `带`
- Source codepoints: `U+5E26`
...
- `obs-evo-cand-002657-route-category-staging`
...
- `obs-evo-cand-002657-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002657-route-evolution-graph`
