# obs-char-001197 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001197`
- primary external id: `hust-obc-cat-1338`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1197_obs-char-001197_hust-obc-cat-1338_ora
  cle-character/03_visual-assets/001_asset-001202_hust-obc-cat-1338_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1338/G_1338_乙4692合22043午組.png`
- asset id: `asset-001202`
...
- source category: `1338`
- validation class: `1196`
- source image route: `HUST-OBC/deciphered/1338/G_1338_乙4692合22043午組.png`
- asset id: `asset-001202`
...
- English observation: `Two detached slender branching clusters are visible,
  with unequal sizes and pointed lower ends.`
- 中文观察: `可见两个分离的狭长分枝笔群，大小不等且下端呈尖状。`
...
- dataset label text: `㤰`
- dataset label codepoints: `U+3930`
...
- Which source records identify obs-char-001197 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001197？
