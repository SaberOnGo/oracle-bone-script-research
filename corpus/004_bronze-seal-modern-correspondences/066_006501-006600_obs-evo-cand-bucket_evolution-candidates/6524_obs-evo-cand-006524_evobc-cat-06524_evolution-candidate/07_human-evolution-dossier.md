...
Project ID: `obs-evo-cand-006524`
...
- Project ID: `obs-evo-cand-006524`
- EVOBC category candidate ID: `evobc-evo-cat-06524`
- External category reference: `evobc-cat-06524`
- Source category ID: `06524`
- Source label for human review: `絲`
- Source codepoints: `U+7D72`
- Image reference count in source metadata: `108`
...
- `obs-evo-cand-006524-route-category-staging`
...
- `obs-evo-cand-006524-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006524-route-evolution-graph`
