# Material Visual Observation / obs-comp-cand-000135 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000135`
- External reference / 外部参照: `obimd-sub-8xhrt6fscw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011547_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8xhrt6fscw/8xhrt6fscw/8xhrt6fscw.png`
- Checksum / 校验和:
  `40da0badd32794f258a0f483ccda8577c0d5f36af469d6d741d6c472ca13db4d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.96%.
- Marked-pixel bounds: (46,36)–(203,207); span 158 × 172 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.96%。
- 痕迹范围：(46,36)–(203,207)；跨度158 × 172 px；痕迹矩形近方形。
