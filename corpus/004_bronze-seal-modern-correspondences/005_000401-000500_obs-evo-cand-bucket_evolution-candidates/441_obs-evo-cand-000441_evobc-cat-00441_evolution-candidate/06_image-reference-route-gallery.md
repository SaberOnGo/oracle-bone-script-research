...
- `obs-evo-cand-000441-route-category-staging`
...
- `obs-evo-cand-000441-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000441-route-evolution-graph`
