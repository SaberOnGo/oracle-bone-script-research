# src-nlc-oracle-world Material Access Index
...
- Field map count / 字段映射数: 4
- Target records / 目标记录: oracle_inscription; oracle_inscription;
  excavation_or_collection_context; source_reference
- Metadata profile count / 元数据概况数: 7
- Profile metrics / 概况指标: nlc_heji_cataloged_count;
  nlc_oracle_bone_holding_count; nlc_yinqi_cuibian_cataloged_count;
  oracle_world_object_image_count; oracle_world_object_record_count;
