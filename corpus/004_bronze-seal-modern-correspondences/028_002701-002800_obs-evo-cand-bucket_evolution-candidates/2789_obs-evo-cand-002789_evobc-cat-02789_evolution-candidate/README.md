# obs-evo-cand-002789 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-002789`
- EVOBC category candidate ID: `evobc-evo-cat-02789`
- External category ref: `evobc-cat-02789`
- Source label: `弋`
- Source codepoints: `U+5F0B`
- Image reference count: `164`
- Era token counts: `BI:19;CS:1;OBC:106;SS:2;WSC:36`
- Source token counts: `Book:54;Web:110`
...
- source 6 / Web:30645: 63 image references
