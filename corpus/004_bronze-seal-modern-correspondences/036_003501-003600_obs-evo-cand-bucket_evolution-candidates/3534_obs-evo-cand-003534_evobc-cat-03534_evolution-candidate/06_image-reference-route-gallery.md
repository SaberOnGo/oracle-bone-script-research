...
- `obs-evo-cand-003534-route-category-staging`
...
- `obs-evo-cand-003534-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003534-route-evolution-graph`
