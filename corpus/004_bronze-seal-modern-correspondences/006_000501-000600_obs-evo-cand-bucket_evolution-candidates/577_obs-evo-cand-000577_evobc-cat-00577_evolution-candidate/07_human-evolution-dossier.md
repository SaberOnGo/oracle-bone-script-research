...
Project ID: `obs-evo-cand-000577`
...
- Project ID: `obs-evo-cand-000577`
- EVOBC category candidate ID: `evobc-evo-cat-00577`
- External category reference: `evobc-cat-00577`
- Source category ID: `00577`
- Source label for human review: `䱄`
- Source codepoints: `U+4C44`
...
- `obs-evo-cand-000577-route-category-staging`
...
- `obs-evo-cand-000577-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000577-route-evolution-graph`
