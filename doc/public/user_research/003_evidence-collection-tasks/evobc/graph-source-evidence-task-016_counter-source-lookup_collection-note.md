...
- Evidence collection task ID / 证据收集任务 ID: `graph-source-evidence-task-016`
...
- Target evidence section / 目标证据章节: `counter_source_lookup`
- Collection scope / 收集范围: `collect_counter_source_lookup_plan_without_claiming_identity`
- Expected output path from task queue / 任务队列预期输出路径: `doc/public/user_research/003_evidence-collection-tasks/evobc/graph-source-evidence-task-016_counter-source-lookup_collection-note.md`
...
- Collection scope / 收集范围:
  - `collect_counter_source_lookup_plan_without_claiming_identity`
- Task status / 任务状态:
  - `not_started`
