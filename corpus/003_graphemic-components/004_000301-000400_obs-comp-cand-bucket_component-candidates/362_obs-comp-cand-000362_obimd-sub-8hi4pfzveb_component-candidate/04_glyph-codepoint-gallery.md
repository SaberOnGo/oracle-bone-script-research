# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000362
...
| --- | --- | --- | --- |
| `obimd-glyph-link-005440` | 󲅦 | `U+F2166` | `reviewed_metadata_only` |
| `obimd-glyph-link-005441` | 󲅧 | `U+F2167` | `reviewed_metadata_only` |
| `obimd-glyph-link-005442` | 󲅨 | `U+F2168` | `reviewed_metadata_only` |
