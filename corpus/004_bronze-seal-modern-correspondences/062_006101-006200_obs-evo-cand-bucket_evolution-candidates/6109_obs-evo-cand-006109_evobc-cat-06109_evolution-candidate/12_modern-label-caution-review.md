# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006109
...
- EVOBC candidate category: `evobc-evo-cat-06109`.
- Source label for search only: `稯`.
- Source codepoints for search only: `U+7A2F`.
