...
- External category reference: `evobc-cat-06756`
- Source category ID: `06756`
- Source label for human review: `绩`
...
- `obs-evo-cand-006756-route-category-staging`
...
- `obs-evo-cand-006756-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006756-route-evolution-graph`
