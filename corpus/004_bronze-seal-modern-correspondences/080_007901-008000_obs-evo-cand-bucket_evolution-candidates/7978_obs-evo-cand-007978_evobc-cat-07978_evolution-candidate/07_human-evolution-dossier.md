...
- Project ID: `obs-evo-cand-007978`
- EVOBC category candidate ID: `evobc-evo-cat-07978`
- External category reference: `evobc-cat-07978`
- Source category ID: `07978`
- Source label for human review: `裛`
- Source codepoints: `U+88DB`
...
- `obs-evo-cand-007978-route-category-staging`
...
- `obs-evo-cand-007978-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007978-route-evolution-graph`
