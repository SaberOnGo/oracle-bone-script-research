# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006802
...
- EVOBC candidate category: `evobc-evo-cat-06802`.
- Source label for search only: `罚`.
- Source codepoints for search only: `U+7F5A`.
