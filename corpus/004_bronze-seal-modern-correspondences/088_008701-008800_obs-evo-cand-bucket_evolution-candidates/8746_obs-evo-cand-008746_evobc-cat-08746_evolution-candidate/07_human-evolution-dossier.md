...
- External category reference: `evobc-cat-08746`
- Source category ID: `08746`
- Source label: `踽`
...
- `obs-evo-cand-008746-route-category-staging`
...
- `obs-evo-cand-008746-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008746-route-evolution-graph`
