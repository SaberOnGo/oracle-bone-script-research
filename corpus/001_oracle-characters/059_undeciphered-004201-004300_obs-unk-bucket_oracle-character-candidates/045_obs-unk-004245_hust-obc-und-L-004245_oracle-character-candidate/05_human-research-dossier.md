# obs-unk-004245 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004245`
- primary external id: `hust-obc-und-L-004245`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/045_obs-unk-004245_h
  ust-obc-und-L-004245_oracle-character-candidate/03_visual-assets/001_asset
  -005838_hust-obc-und-L-004245_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4245/L_？_9355.jpg`
- asset id: `asset-005838`
...
- source class: `HUST-OBC/undeciphered/L/4245/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4245/L_？_9355.jpg`
- asset id: `asset-005838`
...
- English observation: `Upper curves, central mark, rounded base visible.`
- 中文观察: `上部弯曲痕迹、中央痕迹和下部围合痕迹可见。`
...
- Which source records identify obs-unk-004245 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004245？
