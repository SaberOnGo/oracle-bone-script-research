...
- Project ID: `obs-evo-cand-005634`
- EVOBC category candidate ID: `evobc-evo-cat-05634`
- External category reference: `evobc-cat-05634`
- Source category ID: `05634`
- Source label for human review: `症`
- Source codepoints: `U+75C7`
...
- `obs-evo-cand-005634-route-category-staging`
...
- `obs-evo-cand-005634-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005634-route-evolution-graph`
