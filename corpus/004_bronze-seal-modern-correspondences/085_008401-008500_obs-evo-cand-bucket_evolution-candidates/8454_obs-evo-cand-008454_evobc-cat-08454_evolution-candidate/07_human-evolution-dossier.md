...
- External category reference: `evobc-cat-08454`
- Source category ID: `08454`
- Source label for human review: `谓`
- Source codepoints: `U+8C13`
...
- `obs-evo-cand-008454-route-category-staging`
...
- `obs-evo-cand-008454-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008454-route-evolution-graph`
