...
Project ID: `obs-evo-cand-005337`
...
- Project ID: `obs-evo-cand-005337`
- EVOBC category candidate ID: `evobc-evo-cat-05337`
- External category reference: `evobc-cat-05337`
- Source category ID: `05337`
- Source label for human review: `獿`
- Source codepoints: `U+737F`
...
- `obs-evo-cand-005337-route-category-staging`
...
- `obs-evo-cand-005337-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005337-route-evolution-graph`
