# obs-unk-003949 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/049_obs-unk-003949_h
  ust-obc-und-L-003949_oracle-character-candidate/03_visual-assets/001_asset
  -005542_hust-obc-und-L-003949_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3949/L_？_8329.jpg`
- asset id: `asset-005542`
...
- source class: `HUST-OBC/undeciphered/L/3949/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3949/L_？_8329.jpg`
- asset id: `asset-005542`
...
- English observation: A compact dark cluster has curved, slanting, and short
  horizontal traces; a small rounded mark is visible at lower right.
- 中文观察: 紧凑深色痕迹组有弧向、斜向和短横向痕迹，右下方可见小圆弧状痕迹。
...
- Which source records identify obs-unk-003949 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003949？
