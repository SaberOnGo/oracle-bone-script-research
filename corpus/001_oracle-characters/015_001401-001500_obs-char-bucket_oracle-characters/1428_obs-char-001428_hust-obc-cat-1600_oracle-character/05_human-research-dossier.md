# obs-char-001428 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1428_obs-char-001428_hust-obc-cat-1600_ora
  cle-character/03_visual-assets/001_asset-001433_hust-obc-cat-1600_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1600/G_1600_前4.42.4(甲).png`
- asset id: `asset-001433`
...
- source category: `1600`
- validation class: `1427`
- source image route: `HUST-OBC/deciphered/1600/G_1600_前4.42.4(甲).png`
- asset id: `asset-001433`
...
- English observation: `A compact rounded form has an upper loop, a lower
  loop, and side marks.`
- 中文观察: `紧凑圆拱形体有上部环形、下部环形和侧部笔画。`
...
- dataset label text: `㨶`
- dataset label codepoints: `U+3A36`
...
- Which source records identify obs-char-001428 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001428？
