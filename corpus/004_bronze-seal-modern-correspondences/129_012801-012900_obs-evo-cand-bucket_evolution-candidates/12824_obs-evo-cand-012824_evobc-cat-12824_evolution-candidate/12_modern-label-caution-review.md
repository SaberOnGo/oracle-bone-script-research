# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012824
...
- EVOBC candidate category: `evobc-evo-cat-12824`.
- Source label for search only: `𪧝`.
- Source codepoints for search only: `U+2A9DD`.
