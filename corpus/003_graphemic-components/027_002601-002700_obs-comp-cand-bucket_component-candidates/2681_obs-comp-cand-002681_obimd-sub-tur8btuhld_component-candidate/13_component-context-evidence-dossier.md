# obs-comp-cand-002681 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002681`
- 首选外部 ID: `obimd-sub-tur8btuhld`
- OBIMD subcharacter UID: `tur8btuhld`
- OBIMD main character UID: `tur8btuhld`
- 来源 ID: `src-obimd`
...
- codepoint 示例: U+FF1D4; U+FF1D5; 另有 11 项
