...
Project ID: `obs-evo-cand-003813`
...
- Project ID: `obs-evo-cand-003813`
- EVOBC category candidate ID: `evobc-evo-cat-03813`
- External category reference: `evobc-cat-03813`
- Source category ID: `03813`
- Source label for human review: `更`
- Source codepoints: `U+66F4`
...
- `obs-evo-cand-003813-route-category-staging`
...
- `obs-evo-cand-003813-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003813-route-evolution-graph`
