# obs-comp-cand-001486 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001486`
- 首选外部 ID: `obimd-sub-o16buz5phh`
- OBIMD subcharacter UID: `o16buz5phh`
- OBIMD main character UID: `h521w0m697`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+3C43;U+F8D42; U+F8D43; 另有 3 项
