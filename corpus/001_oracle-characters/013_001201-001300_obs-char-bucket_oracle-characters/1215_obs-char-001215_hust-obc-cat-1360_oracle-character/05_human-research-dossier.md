# obs-char-001215 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001215`
- primary external id: `hust-obc-cat-1360`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1215_obs-char-001215_hust-obc-cat-1360_ora
  cle-character/03_visual-assets/001_asset-001220_hust-obc-cat-1360_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1360/G_1360_戩33.9(甲).png`
- asset id: `asset-001220`
...
- source category: `1360`
- validation class: `1214`
- source image route: `HUST-OBC/deciphered/1360/G_1360_戩33.9(甲).png`
- asset id: `asset-001220`
...
- English observation: `A simple branching form has a long upper stem,
  several left side branches, and a short lower base.`
- 中文观察: `简洁分枝形体有长上部笔干、数条左侧分枝和短下部底笔。`
...
- dataset label text: `㥆`
- dataset label codepoints: `U+3946`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00124`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00124`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00124`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/124_obs-evo-can
  d-000124_evobc-cat-00124_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/124_obs-evo-cand-000124_evobc-cat-00124_evolu
...
- Which source records identify obs-char-001215 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001215？
