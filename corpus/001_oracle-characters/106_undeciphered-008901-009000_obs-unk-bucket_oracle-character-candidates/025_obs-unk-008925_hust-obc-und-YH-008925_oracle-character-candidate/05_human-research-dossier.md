# obs-unk-008925 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/106_undeciphered-008
  901-009000_obs-unk-bucket_oracle-character-candidates/025_obs-unk-008925_h
  ust-obc-und-YH-008925_oracle-character-candidate/03_visual-assets/001_asse
  t-010516_hust-obc-und-YH-008925_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60F6D/H_？_60F6D_0.png`
- asset id: `asset-010516`
...
- source class: `HUST-OBC/undeciphered/Y+H/60F6D/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60F6D/H_？_60F6D_0.png`
- asset id: `asset-010516`
...
- Which source records identify obs-unk-008925 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008925？
