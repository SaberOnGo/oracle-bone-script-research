...
- External category reference: `evobc-cat-02110`
- Source category ID: `02110`
- Source label: `姁`
...
- `obs-evo-cand-002110-route-category-staging`
...
- `obs-evo-cand-002110-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-002110-route-evolution-graph`
