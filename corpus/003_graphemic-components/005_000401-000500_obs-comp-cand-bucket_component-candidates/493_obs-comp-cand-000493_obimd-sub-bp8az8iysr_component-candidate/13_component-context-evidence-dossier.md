# obs-comp-cand-000493 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000493`
- 首选外部 ID: `obimd-sub-bp8az8iysr`
- OBIMD subcharacter UID: `bp8az8iysr`
- OBIMD main character UID: `bp8az8iysr`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+A4E0F;U+F2E64; U+F2E65; 另有 1 项
