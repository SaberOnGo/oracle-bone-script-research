...
- External category reference: `evobc-cat-01573`
- Source category ID: `01573`
- Source label: `咸`
- Source codepoints: `U+54B8`
- Image reference count in source metadata: `153`
...
- `obs-evo-cand-001573-route-category-staging`
...
- `obs-evo-cand-001573-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001573-route-evolution-graph`
