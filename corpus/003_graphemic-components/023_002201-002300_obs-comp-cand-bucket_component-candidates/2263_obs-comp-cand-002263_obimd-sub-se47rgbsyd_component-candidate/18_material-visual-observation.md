# Material Visual Observation / obs-comp-cand-002263 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002263`
- External reference / 外部参照: `obimd-sub-se47rgbsyd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020076_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/se47rgbsyd/se47rgbsyd/se47rgbsyd.png`
- Checksum / 校验和:
  `99e2dd1b60bfc0a3176ffe50d8f8693854f54f908fe6c01da158351cdb5038f5`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.11%.
- Marked-pixel bounds: (80,25)–(171,225); span 92 × 201 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.11%。
- 痕迹范围：(80,25)–(171,225)；跨度92 × 201 px；痕迹矩形高于宽。
