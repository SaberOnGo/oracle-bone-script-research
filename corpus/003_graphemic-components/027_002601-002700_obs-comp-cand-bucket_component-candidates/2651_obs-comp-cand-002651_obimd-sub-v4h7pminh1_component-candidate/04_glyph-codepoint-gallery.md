# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002651
...
| --- | --- | --- | --- |
| `obimd-glyph-link-040280` | 󾼴 | `U+FEF34` | `reviewed_metadata_only` |
| `obimd-glyph-link-040281` | 󾼵 | `U+FEF35` | `reviewed_metadata_only` |
| `obimd-glyph-link-040282` | 󾼶 | `U+FEF36` | `reviewed_metadata_only` |
