# obs-unk-009006 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-009006`
- primary external id: `hust-obc-und-YH-009006`
...
- local review image route: `corpus/001_oracle-characters/107_undeciphered-009
  001-009100_obs-unk-bucket_oracle-character-candidates/006_obs-unk-009006_h
  ust-obc-und-YH-009006_oracle-character-candidate/03_visual-assets/001_asse
  t-010597_hust-obc-und-YH-009006_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6107F/H_？_6107F_0.png`
- asset id: `asset-010597`
...
- source class: `HUST-OBC/undeciphered/Y+H/6107F/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6107F/H_？_6107F_0.png`
- asset id: `asset-010597`
...
- Which source records identify obs-unk-009006 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009006？
