# obs-char-001192 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1192_obs-char-001192_hust-obc-cat-1333_ora
  cle-character/03_visual-assets/001_asset-001197_hust-obc-cat-1333_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1333/G_1333_京都615(甲).png`
- asset id: `asset-001197`
...
- source category: `1333`
- validation class: `1191`
- source image route: `HUST-OBC/deciphered/1333/G_1333_京都615(甲).png`
- asset id: `asset-001197`
...
- English observation: `Two long curved strokes descend together and meet in
  a pointed lower fork.`
...
- dataset label text: `㤫`
- dataset label codepoints: `U+392B`
...
- Which source records identify obs-char-001192 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001192？
