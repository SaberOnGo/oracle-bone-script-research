# obs-unk-004765 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004765`
- primary external id: `hust-obc-und-X-004765`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/065_obs-unk-004765_h
  ust-obc-und-X-004765_oracle-character-candidate/03_visual-assets/001_asset
  -006358_hust-obc-und-X-004765_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/321/X_？_7306_1.png`
- asset id: `asset-006358`
...
- source class: `HUST-OBC/undeciphered/X/321/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/321/X_？_7306_1.png`
- asset id: `asset-006358`
...
- English observation: `separated enclosure and lower zigzag with missing view`
- 中文观察: `分离的围合结构和下部折线，仍缺少一个视图`
...
- Which source records identify obs-unk-004765 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004765？
