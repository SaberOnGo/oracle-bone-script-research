# Material Visual Observation / obs-comp-cand-002013 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002013`
- External reference / 外部参照: `obimd-sub-8f4p8labox`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019340_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gs24si06qj/8f4p8labox/8f4p8labox.png`
- Checksum / 校验和:
  `ac20697feda39ef4cc9ea0fdb24d5e62820045d8df2eaac71ea3cf2b17200a9c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.41%.
- Marked-pixel bounds: (76,34)–(169,203); span 94 × 170 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.41%。
- 痕迹范围：(76,34)–(169,203)；跨度94 × 170 px；痕迹矩形高于宽。
