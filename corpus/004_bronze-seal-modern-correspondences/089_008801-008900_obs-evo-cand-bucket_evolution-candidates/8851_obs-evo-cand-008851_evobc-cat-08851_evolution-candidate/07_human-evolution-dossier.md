...
Project ID: `obs-evo-cand-008851`
...
- Project ID: `obs-evo-cand-008851`
- EVOBC category candidate ID: `evobc-evo-cat-08851`
- External category reference: `evobc-cat-08851`
- Source category ID: `08851`
- Source label for human review: `輬`
- Source codepoints: `U+8F2C`
...
- `obs-evo-cand-008851-route-category-staging`
...
- `obs-evo-cand-008851-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008851-route-evolution-graph`
