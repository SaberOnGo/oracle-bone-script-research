# obs-unk-004000 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004000`
- primary external id: `hust-obc-und-L-004000`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/100_obs-unk-004000_h
  ust-obc-und-L-004000_oracle-character-candidate/03_visual-assets/001_asset
  -005593_hust-obc-und-L-004000_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4000/L_？_848.jpg`
- asset id: `asset-005593`
...
- source class: `HUST-OBC/undeciphered/L/4000/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4000/L_？_848.jpg`
- asset id: `asset-005593`
...
- English observation: Several tall curving or segmented traces run roughly
  vertically; the marks are tightly grouped.
- 中文观察：数条较高的弯曲或分段痕迹大致纵向排列，痕迹分布较紧。
...
- Which source records identify obs-unk-004000 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004000？
