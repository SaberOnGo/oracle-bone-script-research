# obs-char-001120 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001120`
- primary external id: `hust-obc-cat-1251`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1120_obs-char-001120_hust-obc-cat-1251_ora
  cle-character/03_visual-assets/001_asset-001125_hust-obc-cat-1251_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1251/G_1251_甲262(甲).png`
- asset id: `asset-001125`
...
- source category: `1251`
- validation class: `1119`
- source image route: `HUST-OBC/deciphered/1251/G_1251_甲262(甲).png`
- asset id: `asset-001125`
...
- English observation: `A compact upright form has several pointed upper
  branches and a long lower forked extension.`
- 中文观察: `紧密直立形体有数个尖状上部分枝和长下部叉状外伸。`
...
- dataset label text: `㣙`
- dataset label codepoints: `U+38D9`
...
- OBIMD candidate ids / OBIMD 候选 ID: `obimd-main-cand-002637`
- OBIMD external refs / OBIMD 外部引用: `obimd-main-vha0ssegay`
- OBIMD transcription field / OBIMD 转写字段: `㣙`
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00107`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00107`
- EvoBC image reference count / EvoBC 图像引用数: `5`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00107`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/107_obs-evo-can
  d-000107_evobc-cat-00107_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/107_obs-evo-cand-000107_evobc-cat-00107_evolu
...
- object-local component human files / 对象内构件人类档案:
  ...
  corpus/003_graphemic-components/020_001901-002000_obs-comp-cand-bucket_compo
  nent-candidates/1907_obs-comp-cand-001907_obimd-sub-cnp7rbxnb0_component-can
  didate/README.md
  corpus/003_graphemic-components/020_001901-002000_obs-comp-cand-bucket_compo
  nent-candidates/1907_obs-comp-cand-001907_obimd-sub-cnp7rbxnb0_component-can
  didate/11_human-component-dossier.md
...
- Which source records identify obs-char-001120 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001120？
