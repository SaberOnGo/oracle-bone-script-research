# obs-char-001510 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001510`
- primary external id: `hust-obc-cat-1695`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1510_obs-char-001510_hust-obc-cat-1695_ora
  cle-character/03_visual-assets/001_asset-001515_hust-obc-cat-1695_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1695/G_1695_庫1644合41540.png`
- asset id: `asset-001515`
...
- source category: `1695`
- validation class: `1509`
- source image route: `HUST-OBC/deciphered/1695/G_1695_庫1644合41540.png`
- asset id: `asset-001515`
...
- English observation: `A simple upright form has a top bar, a central stem,
  a lower base, and a right looped mark.`
...
- dataset label text: `㪕`
- dataset label codepoints: `U+3A95`
...
- filename catalog route clues: `Heji-like filename clue: 合41540
...
- Which source records identify obs-char-001510 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001510？
