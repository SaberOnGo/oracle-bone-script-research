...
- Project ID: `obs-evo-cand-002923`
- EVOBC category candidate ID: `evobc-evo-cat-02923`
- External category reference: `evobc-cat-02923`
- Source category ID: `02923`
- Source label for human review: `忻`
- Source codepoints: `U+5FFB`
...
- `obs-evo-cand-002923-route-category-staging`
...
- `obs-evo-cand-002923-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002923-route-evolution-graph`
