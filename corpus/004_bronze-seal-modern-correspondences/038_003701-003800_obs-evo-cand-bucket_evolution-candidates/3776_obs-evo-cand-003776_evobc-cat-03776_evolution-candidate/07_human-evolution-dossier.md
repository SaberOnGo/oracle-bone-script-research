...
- External category reference: `evobc-cat-03776`
- Source category ID: `03776`
- Source label for human review: `暏`
- Source codepoints: `U+668F`
...
- `obs-evo-cand-003776-route-category-staging`
...
- `obs-evo-cand-003776-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003776-route-evolution-graph`
