# obs-unk-004681 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004681`
- primary external id: `hust-obc-und-X-004681`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/081_obs-unk-004681_h
  ust-obc-und-X-004681_oracle-character-candidate/03_visual-assets/001_asset
  -006274_hust-obc-und-X-004681_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/237/X_？_8405_1.png`
- asset id: `asset-006274`
...
- source class: `HUST-OBC/undeciphered/X/237/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/237/X_？_8405_1.png`
- asset id: `asset-006274`
...
- English observation: `tapered stem with opening and lower diagonal limb`
- 中文观察: `带开口和下部斜向笔画的收窄笔干`
...
- Which source records identify obs-unk-004681 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004681？
