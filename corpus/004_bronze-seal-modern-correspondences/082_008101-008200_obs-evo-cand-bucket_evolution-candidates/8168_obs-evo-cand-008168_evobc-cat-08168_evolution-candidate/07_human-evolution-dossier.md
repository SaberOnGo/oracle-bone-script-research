...
- External category reference: `evobc-cat-08168`
- Source category ID: `08168`
- Source label for human review: `詆`
...
- `obs-evo-cand-008168-route-category-staging`
...
- `obs-evo-cand-008168-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008168-route-evolution-graph`
