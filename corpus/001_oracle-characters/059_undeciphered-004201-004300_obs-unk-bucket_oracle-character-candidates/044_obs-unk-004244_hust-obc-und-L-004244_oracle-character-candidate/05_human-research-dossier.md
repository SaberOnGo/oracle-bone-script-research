# obs-unk-004244 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/044_obs-unk-004244_h
  ust-obc-und-L-004244_oracle-character-candidate/03_visual-assets/001_asset
  -005837_hust-obc-und-L-004244_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4244/L_？_9354.jpg`
- asset id: `asset-005837`
...
- source class: `HUST-OBC/undeciphered/L/4244/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4244/L_？_9354.jpg`
- asset id: `asset-005837`
...
- English observation: `Upper outline, inner bar, central trace visible.`
- 中文观察: `上部轮廓、内部横痕和中央痕迹可见。`
...
- Which source records identify obs-unk-004244 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004244？
