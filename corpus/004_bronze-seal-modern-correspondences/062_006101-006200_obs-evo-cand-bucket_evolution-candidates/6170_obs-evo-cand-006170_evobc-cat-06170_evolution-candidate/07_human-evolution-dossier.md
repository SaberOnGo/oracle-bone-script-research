...
- External category reference: `evobc-cat-06170`
- Source category ID: `06170`
- Source label for human review: `窞`
...
- `obs-evo-cand-006170-route-category-staging`
...
- `obs-evo-cand-006170-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006170-route-evolution-graph`
