...
Project ID: `obs-evo-cand-012103`
...
- Project ID: `obs-evo-cand-012103`
- EVOBC category candidate ID: `evobc-evo-cat-12103`
- External category reference: `evobc-cat-12103`
- Source category ID: `12103`
- Source label for human review: `𦳔`
- Source codepoints: `U+26CD4`
...
- `obs-evo-cand-012103-route-category-staging`
...
- `obs-evo-cand-012103-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012103-route-evolution-graph`
