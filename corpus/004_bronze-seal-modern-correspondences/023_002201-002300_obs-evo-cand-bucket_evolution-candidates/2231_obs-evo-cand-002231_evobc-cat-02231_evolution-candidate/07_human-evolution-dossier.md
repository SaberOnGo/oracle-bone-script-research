...
Project ID: `obs-evo-cand-002231`
...
- Project ID: `obs-evo-cand-002231`
- EVOBC category candidate ID: `evobc-evo-cat-02231`
- External category reference: `evobc-cat-02231`
- Source category ID: `02231`
- Source label for human review: `媕`
- Source codepoints: `U+5A95`
...
- `obs-evo-cand-002231-route-category-staging`
...
- `obs-evo-cand-002231-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002231-route-evolution-graph`
