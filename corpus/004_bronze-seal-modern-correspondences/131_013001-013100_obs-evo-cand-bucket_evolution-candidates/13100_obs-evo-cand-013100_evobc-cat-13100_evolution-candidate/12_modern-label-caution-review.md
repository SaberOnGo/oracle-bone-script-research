# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013100
...
- EVOBC candidate category: `evobc-evo-cat-13100`.
- Source label for search only: `𫳭`.
- Source codepoints for search only: `U+2BCED`.
