# Material Visual Observation / obs-comp-cand-002301 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002301`
- External reference / 外部参照: `obimd-sub-huoz3b61jz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020320_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/huoz3b61jz/huoz3b61jz/huoz3b61jz.png`
- Checksum / 校验和:
  `d5e3602405ab9e1f11a33ae6b80c652c9017ccab4acc9f2559d79512aa93a542`
...
- Marked-pixel bounds: (78,18)–(179,231); span 102 × 214 px; the marked
...
- 痕迹范围：(78,18)–(179,231)；跨度102 × 214 px；痕迹矩形高于宽。
