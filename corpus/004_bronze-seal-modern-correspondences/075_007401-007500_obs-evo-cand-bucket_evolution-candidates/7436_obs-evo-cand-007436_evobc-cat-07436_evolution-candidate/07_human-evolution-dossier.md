...
- External category reference: `evobc-cat-07436`
- Source category ID: `07436`
- Source label for human review: `萆`
...
- `obs-evo-cand-007436-route-category-staging`
...
- `obs-evo-cand-007436-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007436-route-evolution-graph`
