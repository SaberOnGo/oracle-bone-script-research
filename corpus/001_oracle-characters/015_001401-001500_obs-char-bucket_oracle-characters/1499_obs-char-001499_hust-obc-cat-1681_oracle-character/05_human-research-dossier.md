# obs-char-001499 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001499`
- primary external id: `hust-obc-cat-1681`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1499_obs-char-001499_hust-obc-cat-1681_ora
  cle-character/03_visual-assets/001_asset-001504_hust-obc-cat-1681_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1681/G_1681_乙5269合926賓組.png`
- asset id: `asset-001504`
...
- source category: `1681`
- validation class: `1498`
- source image route: `HUST-OBC/deciphered/1681/G_1681_乙5269合926賓組.png`
- asset id: `asset-001504`
...
- English observation: `An upper leaf-like form is paired with a divided
  right enclosure and stem.`
- 中文观察: `上部叶状形体与隔分右侧框形及竖干相邻。`
...
- dataset label text: `㪇`
- dataset label codepoints: `U+3A87`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00147`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00147`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00147`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/147_obs-evo-can
  d-000147_evobc-cat-00147_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/147_obs-evo-cand-000147_evobc-cat-00147_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合926
  (G_1681_乙5269合926賓組.png)`
...
- Which source records identify obs-char-001499 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001499？
