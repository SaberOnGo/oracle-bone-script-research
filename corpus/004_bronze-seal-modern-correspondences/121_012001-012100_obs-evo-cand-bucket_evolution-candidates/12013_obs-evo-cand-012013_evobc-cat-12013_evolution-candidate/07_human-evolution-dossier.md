...
- External category reference: `evobc-cat-12013`
- Source category ID: `12013`
- Source label for human review: `𦐜`
- Source codepoints: `U+2641C`
...
- `obs-evo-cand-012013-route-category-staging`
...
- `obs-evo-cand-012013-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012013-route-evolution-graph`
