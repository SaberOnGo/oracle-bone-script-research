...
- Project ID: `obs-evo-cand-008334`
- EVOBC category candidate ID: `evobc-evo-cat-08334`
- External category reference: `evobc-cat-08334`
- Source category ID: `08334`
- Source label for human review: `謱`
- Source codepoints: `U+8B31`
...
- `obs-evo-cand-008334-route-category-staging`
...
- `obs-evo-cand-008334-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008334-route-evolution-graph`
