# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002464
...
- EVOBC candidate category: `evobc-evo-cat-02464`.
- Source label for search only: `尌`.
- Source codepoints for search only: `U+5C0C`.
