...
- `obs-evo-cand-006697-route-category-staging`
...
- `obs-evo-cand-006697-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006697-route-evolution-graph`
