...
- Project ID: `obs-evo-cand-000374`
- EVOBC category candidate ID: `evobc-evo-cat-00374`
- External category reference: `evobc-cat-00374`
- Source category ID: `00374`
- Source label for human review: `䒖`
- Source codepoints: `U+4496`
...
- `obs-evo-cand-000374-route-category-staging`
...
- `obs-evo-cand-000374-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000374-route-evolution-graph`
