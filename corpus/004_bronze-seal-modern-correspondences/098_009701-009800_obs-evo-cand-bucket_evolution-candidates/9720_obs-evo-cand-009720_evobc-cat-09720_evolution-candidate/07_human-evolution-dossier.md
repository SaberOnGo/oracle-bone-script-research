...
Project ID: `obs-evo-cand-009720`
...
- Project ID: `obs-evo-cand-009720`
- EVOBC category candidate ID: `evobc-evo-cat-09720`
- External category reference: `evobc-cat-09720`
- Source category ID: `09720`
- Source label for human review: `际`
- Source codepoints: `U+9645`
...
- `obs-evo-cand-009720-route-category-staging`
...
- `obs-evo-cand-009720-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009720-route-evolution-graph`
