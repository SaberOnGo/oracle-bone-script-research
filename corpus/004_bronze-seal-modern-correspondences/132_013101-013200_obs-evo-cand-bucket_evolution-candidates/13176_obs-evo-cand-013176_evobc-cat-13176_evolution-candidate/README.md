# obs-evo-cand-013176 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-13176`
- Source label: `𫿜`
- Source codepoints: `U+2BFDC`
- Image reference count: `49`
- Era token counts: `BI:49`
- Source token counts: `Book:49`

## Observed Code Rows / 观察到的代码行

- era 1 / BI: 49 image references
- source 3 / Book:21681: 49 image references
