...
- External category reference: `evobc-cat-08665`
- Source category ID: `08665`
- Source label for human review: `起`
...
- `obs-evo-cand-008665-route-category-staging`
...
- `obs-evo-cand-008665-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008665-route-evolution-graph`
