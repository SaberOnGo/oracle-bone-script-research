...
- Project ID: `obs-evo-cand-011631`
- EVOBC category candidate ID: `evobc-evo-cat-11631`
- External category reference: `evobc-cat-11631`
- Source category ID: `11631`
- Source label for human review: `𤢬`
- Source codepoints: `U+248AC`
...
- `obs-evo-cand-011631-route-category-staging`
...
- `obs-evo-cand-011631-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011631-route-evolution-graph`
