...
- External category reference: `evobc-cat-10660`
- Source category ID: `10660`
- Source label for human review: `黱`
...
- `obs-evo-cand-010660-route-category-staging`
...
- `obs-evo-cand-010660-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010660-route-evolution-graph`
