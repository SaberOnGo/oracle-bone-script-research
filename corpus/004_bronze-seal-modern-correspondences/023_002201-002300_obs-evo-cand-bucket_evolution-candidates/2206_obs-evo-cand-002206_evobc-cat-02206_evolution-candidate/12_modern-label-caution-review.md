# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002206
...
- EVOBC candidate category: `evobc-evo-cat-02206`.
- Source label for search only: `婤`.
- Source codepoints for search only: `U+5A64`.
