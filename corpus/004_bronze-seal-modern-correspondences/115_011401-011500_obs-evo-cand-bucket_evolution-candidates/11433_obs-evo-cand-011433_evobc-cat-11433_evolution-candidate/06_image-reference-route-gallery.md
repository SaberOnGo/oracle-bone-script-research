...
- `obs-evo-cand-011433-route-category-staging`
...
- `obs-evo-cand-011433-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011433-route-evolution-graph`
