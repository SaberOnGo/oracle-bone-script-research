# obs-unk-004266 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004266`
- primary external id: `hust-obc-und-L-004266`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/066_obs-unk-004266_h
  ust-obc-und-L-004266_oracle-character-candidate/03_visual-assets/001_asset
  -005859_hust-obc-und-L-004266_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4266/L_？_9415.jpg`
- asset id: `asset-005859`
...
- source class: `HUST-OBC/undeciphered/L/4266/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4266/L_？_9415.jpg`
- asset id: `asset-005859`
...
- English observation: `Left branches, pointed lower mark, right curve visible.`
- 中文观察: `左侧分支、下部尖细痕迹和右侧弯曲痕迹可见。`
...
- Which source records identify obs-unk-004266 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004266？
