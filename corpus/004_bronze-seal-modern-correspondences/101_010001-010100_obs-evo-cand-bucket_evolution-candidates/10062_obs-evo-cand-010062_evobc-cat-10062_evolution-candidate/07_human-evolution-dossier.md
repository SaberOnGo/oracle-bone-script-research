...
- External category reference: `evobc-cat-10062`
- Source category ID: `10062`
- Source label for human review: `额`
...
- `obs-evo-cand-010062-route-category-staging`
...
- `obs-evo-cand-010062-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010062-route-evolution-graph`
