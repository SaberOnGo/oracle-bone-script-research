...
Project ID: `obs-evo-cand-000447`
...
- Project ID: `obs-evo-cand-000447`
- EVOBC category candidate ID: `evobc-evo-cat-00447`
- External category reference: `evobc-cat-00447`
- Source category ID: `00447`
- Source label for human review: `䝰`
- Source codepoints: `U+4770`
...
- `obs-evo-cand-000447-route-category-staging`
...
- `obs-evo-cand-000447-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000447-route-evolution-graph`
