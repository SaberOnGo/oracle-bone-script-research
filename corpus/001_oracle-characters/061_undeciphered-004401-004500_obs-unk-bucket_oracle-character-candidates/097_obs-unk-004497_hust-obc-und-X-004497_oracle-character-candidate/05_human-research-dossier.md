# obs-unk-004497 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/097_obs-unk-004497_h
  ust-obc-und-X-004497_oracle-character-candidate/03_visual-assets/001_asset
  -006090_hust-obc-und-X-004497_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/53/X_？_8237_1.png`
- asset id: `asset-006090`
...
- source class: `HUST-OBC/undeciphered/X/53/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/53/X_？_8237_1.png`
- asset id: `asset-006090`
...
- English observation: `The two pointed peaks, inner tips, separated side
  traces, and detached lower mark are directly recorded.`
- 中文观察: `已直接记录两个尖峰、内侧短痕、分离侧痕和下部小分离痕。`
...
- Which source records identify obs-unk-004497 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004497？
