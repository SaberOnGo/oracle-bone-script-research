# Material Visual Observation / obs-comp-cand-000765 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000765`
- External reference / 外部参照: `obimd-sub-deedlyt9l2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013528_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ohovbcjeax/deedlyt9l2/deedlyt9l2.png`
- Checksum / 校验和:
  `2945b8c34ae68027545e31e537aad176c62d589cfcb2c1d9a70f21ddf56195b5`
...
- Marked-pixel bounds: (61,71)–(205,169); span 145 × 99 px; the marked rectangle
  is wider than tall.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.05%。
- 痕迹范围：(61,71)–(205,169)；跨度145 × 99 px；痕迹矩形宽于高。
