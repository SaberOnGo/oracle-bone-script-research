# obs-unk-004869 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/069_obs-unk-004869_h
  ust-obc-und-X-004869_oracle-character-candidate/03_visual-assets/001_asset
  -006462_hust-obc-und-X-004869_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/425/X_？_7409_1.png`
- asset id: `asset-006462`
...
- source class: `HUST-OBC/undeciphered/X/425/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/425/X_？_7409_1.png`
- asset id: `asset-006462`
...
- English observation: `tall central stroke and rounded lower enclosure`
- 中文观察: `中央长笔画和下部圆钝外框`
...
- Which source records identify obs-unk-004869 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004869？
