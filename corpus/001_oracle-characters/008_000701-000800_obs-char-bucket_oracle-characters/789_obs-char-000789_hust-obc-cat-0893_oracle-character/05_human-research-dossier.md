# obs-char-000789 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/789_obs-char-000789_hust-obc-cat-0893_orac
  le-character/03_visual-assets/001_asset-000794_hust-obc-cat-0893_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0893/G_0893_京津1559合6538.png`
- asset id: `asset-000794`
...
- source category: `0893`
- validation class: `788`
- source image route: `HUST-OBC/deciphered/0893/G_0893_京津1559合6538.png`
- asset id: `asset-000794`
...
- English observation: `A single thin wavering stem begins at a pointed
  upper loop, curves through the middle, and ends at a short horizontal
  foot.`
- 中文观察: `单条细波折干起于尖顶上环，中部弯曲，下端收于一条短横脚。`
...
- dataset label text: `㝳`
- dataset label codepoints: `U+3773`
...
- filename catalog route clues: `Heji-like filename clue: 合6538
...
- Which source records identify obs-char-000789 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000789？
