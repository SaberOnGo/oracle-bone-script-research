# obs-unk-005332 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005332`
- primary external id: `hust-obc-und-X-005332`
...
- local review image route: `corpus/001_oracle-characters/070_undeciphered-005
  301-005400_obs-unk-bucket_oracle-character-candidates/032_obs-unk-005332_h
  ust-obc-und-X-005332_oracle-character-candidate/03_visual-assets/001_asset
  -006925_hust-obc-und-X-005332_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/888/X_？_7853_1.png`
- asset id: `asset-006925`
...
- source class: `HUST-OBC/undeciphered/X/888/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/888/X_？_7853_1.png`
- asset id: `asset-006925`
...
- Which source records identify obs-unk-005332 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005332？
