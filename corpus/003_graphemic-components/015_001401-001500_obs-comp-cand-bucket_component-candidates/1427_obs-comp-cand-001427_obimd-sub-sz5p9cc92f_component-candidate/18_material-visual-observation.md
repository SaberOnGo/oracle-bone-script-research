# Material Visual Observation / obs-comp-cand-001427 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001427`
- External reference / 外部参照: `obimd-sub-sz5p9cc92f`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016004_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/n9qxfnupux/sz5p9cc92f/sz5p9cc92f.png`
- Checksum / 校验和:
  `e3953f4c3455f5c8797cd506be39e56b07498a033ea79a70ee8e076dd27af15c`
...
- Marked-pixel bounds: (82,29)–(167,217); span 86 × 189 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.00%。
- 痕迹范围：(82,29)–(167,217)；跨度86 × 189 px；痕迹矩形高于宽。
