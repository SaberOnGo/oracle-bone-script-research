...
Project ID: `obs-evo-cand-001974`
...
- Project ID: `obs-evo-cand-001974`
- EVOBC category candidate ID: `evobc-evo-cat-01974`
- External category reference: `evobc-cat-01974`
- Source category ID: `01974`
- Source label for human review: `壳`
- Source codepoints: `U+58F3`
...
- `obs-evo-cand-001974-route-category-staging`
...
- `obs-evo-cand-001974-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001974-route-evolution-graph`
