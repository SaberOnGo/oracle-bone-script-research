# obs-char-001369 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1369_obs-char-001369_hust-obc-cat-1528_ora
  cle-character/03_visual-assets/001_asset-001374_hust-obc-cat-1528_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1528/H_1528_610A3_0.png`
- asset id: `asset-001374`
...
- source category: `1528`
- validation class: `1368`
- source image route: `HUST-OBC/deciphered/1528/H_1528_610A3_0.png`
- asset id: `asset-001374`
...
- English observation: `A broad cross-like framework has central stems,
  lower bars, and a small box.`
...
- dataset label text: `㧮`
- dataset label codepoints: `U+39EE`
...
- filename catalog route clues: `catalog-like filename clue: H_1528
  (H_1528_610A3_0.png)`
...
- Which source records identify obs-char-001369 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001369？
