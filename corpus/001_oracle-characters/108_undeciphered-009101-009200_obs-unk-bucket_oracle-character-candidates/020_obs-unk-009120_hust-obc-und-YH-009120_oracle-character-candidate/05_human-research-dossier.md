# obs-unk-009120 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-009120`
- primary external id: `hust-obc-und-YH-009120`
...
- local review image route: `corpus/001_oracle-characters/108_undeciphered-009
  101-009200_obs-unk-bucket_oracle-character-candidates/020_obs-unk-009120_h
  ust-obc-und-YH-009120_oracle-character-candidate/03_visual-assets/001_asse
  t-010711_hust-obc-und-YH-009120_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/611FF/Y_？_611FF.jpg`
- asset id: `asset-010711`
...
- source class: `HUST-OBC/undeciphered/Y+H/611FF/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/611FF/Y_？_611FF.jpg`
- asset id: `asset-010711`
...
- Which source records identify obs-unk-009120 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009120？
