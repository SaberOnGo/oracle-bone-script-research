...
- External category reference: `evobc-cat-00390`
- Source category ID: `00390`
- Source label for human review: `䕉`
- Source codepoints: `U+4549`
...
- `obs-evo-cand-000390-route-category-staging`
...
- `obs-evo-cand-000390-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000390-route-evolution-graph`
