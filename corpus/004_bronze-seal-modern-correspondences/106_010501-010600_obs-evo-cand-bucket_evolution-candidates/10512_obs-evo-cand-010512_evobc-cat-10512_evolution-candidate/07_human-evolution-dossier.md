...
- External category reference: `evobc-cat-10512`
- Source category ID: `10512`
- Source label for human review: `鵔`
- Source codepoints: `U+9D54`
...
- `obs-evo-cand-010512-route-category-staging`
...
- `obs-evo-cand-010512-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010512-route-evolution-graph`
