# obs-unk-008280 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008280`
- primary external id: `hust-obc-und-YH-008280`
...
- local review image route: `corpus/001_oracle-characters/099_undeciphered-008
  201-008300_obs-unk-bucket_oracle-character-candidates/080_obs-unk-008280_h
  ust-obc-und-YH-008280_oracle-character-candidate/03_visual-assets/001_asse
  t-009871_hust-obc-und-YH-008280_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6094E/Y_？_6094E.jpg`
- asset id: `asset-009871`
...
- source class: `HUST-OBC/undeciphered/Y+H/6094E/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6094E/Y_？_6094E.jpg`
- asset id: `asset-009871`
...
- Which source records identify obs-unk-008280 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008280？
