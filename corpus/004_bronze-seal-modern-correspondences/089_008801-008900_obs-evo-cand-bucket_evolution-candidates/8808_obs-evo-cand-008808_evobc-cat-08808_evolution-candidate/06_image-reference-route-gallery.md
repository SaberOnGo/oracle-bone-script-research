...
- `obs-evo-cand-008808-route-category-staging`
...
- `obs-evo-cand-008808-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008808-route-evolution-graph`
