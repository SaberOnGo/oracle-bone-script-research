# obs-unk-004353 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004353`
- primary external id: `hust-obc-und-L-004353`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/053_obs-unk-004353_h
  ust-obc-und-L-004353_oracle-character-candidate/03_visual-assets/001_asset
  -005946_hust-obc-und-L-004353_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4353/L_？_9651.jpg`
- asset id: `asset-005946`
...
- source class: `HUST-OBC/undeciphered/L/4353/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4353/L_？_9651.jpg`
- asset id: `asset-005946`
...
- English observation: `Upper descending traces, central line, and left`
  `branch recorded.`
- 中文观察: `已记录上部下行痕、中央纵痕和左侧分支。`
...
- Which source records identify obs-unk-004353 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004353？
