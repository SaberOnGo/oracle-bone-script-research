...
- External category reference: `evobc-cat-00097`
- Source category ID: `00097`
- Source label for human review: `㢀`
...
- `obs-evo-cand-000097-route-category-staging`
...
- `obs-evo-cand-000097-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000097-route-evolution-graph`
