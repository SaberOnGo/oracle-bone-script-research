...
- External category reference: `evobc-cat-06252`
- Source category ID: `06252`
- Source label for human review: `笺`
- Source codepoints: `U+7B3A`
...
- `obs-evo-cand-006252-route-category-staging`
...
- `obs-evo-cand-006252-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006252-route-evolution-graph`
