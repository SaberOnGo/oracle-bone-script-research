...
- External category reference: `evobc-cat-00611`
- Source category ID: `00611`
- Source label for human review: `下`
- Source codepoints: `U+4E0B`
- Image reference count in source metadata: `236`
...
- `obs-evo-cand-000611-route-category-staging`
...
- `obs-evo-cand-000611-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000611-route-evolution-graph`
