...
- External category reference: `evobc-cat-06719`
- Source category ID: `06719`
- Source label for human review: `纘`
- Source codepoints: `U+7E98`
...
- `obs-evo-cand-006719-route-category-staging`
...
- `obs-evo-cand-006719-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006719-route-evolution-graph`
