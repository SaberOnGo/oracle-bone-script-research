# Material Visual Observation / obs-comp-cand-001428 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001428`
- External reference / 外部参照: `obimd-sub-vgvqkrxgz3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016005_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vgvqkrxgz3/vgvqkrxgz3/vgvqkrxgz3.png`
- Checksum / 校验和:
  `88888aaf8ddf260ddf3524edd8d0911385379d240a729c8d0cba5b0a02f31e3a`
...
- Marked-pixel bounds: (79,30)–(170,216); span 92 × 187 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.96%。
- 痕迹范围：(79,30)–(170,216)；跨度92 × 187 px；痕迹矩形高于宽。
