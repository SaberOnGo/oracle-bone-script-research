# obs-unk-004217 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004217`
- primary external id: `hust-obc-und-L-004217`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/017_obs-unk-004217_h
  ust-obc-und-L-004217_oracle-character-candidate/03_visual-assets/001_asset
  -005810_hust-obc-und-L-004217_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4217/L_？_9223.jpg`
- asset id: `asset-005810`
...
- source class: `HUST-OBC/undeciphered/L/4217/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4217/L_？_9223.jpg`
- asset id: `asset-005810`
...
- English observation: `Left curve, rounded trace, lower diagonals visible.`
- 中文观察: `左侧弯曲痕迹、右上圆弧和下部斜笔画可见。`
...
- Which source records identify obs-unk-004217 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004217？
