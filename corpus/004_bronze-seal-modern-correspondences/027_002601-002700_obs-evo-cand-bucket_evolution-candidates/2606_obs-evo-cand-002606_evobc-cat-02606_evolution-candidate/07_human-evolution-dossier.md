...
- Project ID: `obs-evo-cand-002606`
- EVOBC category candidate ID: `evobc-evo-cat-02606`
- External category reference: `evobc-cat-02606`
- Source category ID: `02606`
- Source label for human review: `巍`
- Source codepoints: `U+5DCD`
...
- `obs-evo-cand-002606-route-category-staging`
...
- `obs-evo-cand-002606-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002606-route-evolution-graph`
