# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000657
...
| --- | --- | --- | --- |
| `obimd-glyph-link-009653` | 󳲉 | `U+F3C89` | `reviewed_metadata_only` |
| `obimd-glyph-link-009654` | 󳲊 | `U+F3C8A` | `reviewed_metadata_only` |
| `obimd-glyph-link-009655` | 󳲋 | `U+F3C8B` | `reviewed_metadata_only` |
