# obs-unk-004307 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/007_obs-unk-004307_h
  ust-obc-und-L-004307_oracle-character-candidate/03_visual-assets/001_asset
  -005900_hust-obc-und-L-004307_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4307/L_？_9501.jpg`
- asset id: `asset-005900`
...
- source class: `HUST-OBC/undeciphered/L/4307/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4307/L_？_9501.jpg`
- asset id: `asset-005900`
...
- English observation: `Separated left and right trace clusters visible.`
- 中文观察: `彼此分开的左右痕迹组可见。`
...
- Which source records identify obs-unk-004307 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004307？
