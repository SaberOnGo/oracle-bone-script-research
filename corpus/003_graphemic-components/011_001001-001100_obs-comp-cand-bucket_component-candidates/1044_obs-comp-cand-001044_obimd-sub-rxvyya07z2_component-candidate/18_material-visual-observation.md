# Material Visual Observation / obs-comp-cand-001044 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001044`
- External reference / 外部参照: `obimd-sub-rxvyya07z2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014594_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rxvyya07z2/rxvyya07z2/rxvyya07z2.png`
- Checksum / 校验和:
  `45a6f9a8ec567a3143226bd91010218e63507d4d5394c2122c4672cf40db52ad`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.82%.
- Marked-pixel bounds: (65,18)–(176,230); span 112 × 213 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.82%。
- 痕迹范围：(65,18)–(176,230)；跨度112 × 213 px；痕迹矩形高于宽。
