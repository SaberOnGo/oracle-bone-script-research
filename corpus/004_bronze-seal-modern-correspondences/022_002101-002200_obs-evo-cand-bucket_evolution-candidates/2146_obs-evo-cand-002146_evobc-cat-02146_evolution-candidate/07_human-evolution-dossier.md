...
- Project ID: `obs-evo-cand-002146`
- EVOBC category candidate ID: `evobc-evo-cat-02146`
- External category reference: `evobc-cat-02146`
- Source category ID: `02146`
- Source label for human review: `姺`
- Source codepoints: `U+59FA`
...
- `obs-evo-cand-002146-route-category-staging`
...
- `obs-evo-cand-002146-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002146-route-evolution-graph`
