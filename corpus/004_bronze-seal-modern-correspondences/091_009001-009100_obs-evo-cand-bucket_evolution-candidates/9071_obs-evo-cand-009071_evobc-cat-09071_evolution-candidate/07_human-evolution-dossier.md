...
- Project ID: `obs-evo-cand-009071`
- EVOBC category candidate ID: `evobc-evo-cat-09071`
- External category reference: `evobc-cat-09071`
- Source category ID: `09071`
- Source label for human review: `邁`
- Source codepoints: `U+9081`
- Image reference count in source metadata: `204`
...
- `obs-evo-cand-009071-route-category-staging`
...
- `obs-evo-cand-009071-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009071-route-evolution-graph`
