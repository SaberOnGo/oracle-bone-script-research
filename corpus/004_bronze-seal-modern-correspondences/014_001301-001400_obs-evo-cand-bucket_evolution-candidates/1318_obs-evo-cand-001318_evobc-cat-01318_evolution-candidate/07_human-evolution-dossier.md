...
Project ID: `obs-evo-cand-001318`
...
- Project ID: `obs-evo-cand-001318`
- EVOBC category candidate ID: `evobc-evo-cat-01318`
- External category reference: `evobc-cat-01318`
- Source category ID: `01318`
- Source label for human review: `勺`
- Source codepoints: `U+52FA`
...
- `obs-evo-cand-001318-route-category-staging`
...
- `obs-evo-cand-001318-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001318-route-evolution-graph`
