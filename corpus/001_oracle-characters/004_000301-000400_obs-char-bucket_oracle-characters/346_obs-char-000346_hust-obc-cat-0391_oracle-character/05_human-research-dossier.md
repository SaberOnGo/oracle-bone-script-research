# obs-char-000346 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000346`
- primary external id: `hust-obc-cat-0391`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/346_obs-char-000346_hust-obc-cat-0391_orac
  le-character/03_visual-assets/001_asset-000351_hust-obc-cat-0391_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0391/G_0391_甲214(甲).png`
- asset id: `asset-000351`
...
- source category: `0391`
- validation class: `345`
- source image route: `HUST-OBC/deciphered/0391/G_0391_甲214(甲).png`
- asset id: `asset-000351`
...
- English observation: `A narrow pointed central form has a short horizontal
  cross stroke and a flared lower point.`
- 中文观察: `狭长尖状中部形体有短横交叉笔画，下方形成展开的尖状末端。`
...
- dataset label text: `㕽`
- dataset label codepoints: `U+357D`
...
- Which source records identify obs-char-000346 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000346？
