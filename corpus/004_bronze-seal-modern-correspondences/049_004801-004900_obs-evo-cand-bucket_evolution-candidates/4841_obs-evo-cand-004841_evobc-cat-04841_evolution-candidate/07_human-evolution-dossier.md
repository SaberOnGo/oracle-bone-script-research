...
Project ID: `obs-evo-cand-004841`
...
- Project ID: `obs-evo-cand-004841`
- EVOBC category candidate ID: `evobc-evo-cat-04841`
- External category reference: `evobc-cat-04841`
- Source category ID: `04841`
- Source label for human review: `滑`
- Source codepoints: `U+6ED1`
...
- `obs-evo-cand-004841-route-category-staging`
...
- `obs-evo-cand-004841-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004841-route-evolution-graph`
