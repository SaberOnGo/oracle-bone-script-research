...
Project ID: `obs-evo-cand-013162`
...
- Project ID: `obs-evo-cand-013162`
- EVOBC category candidate ID: `evobc-evo-cat-13162`
- External category reference: `evobc-cat-13162`
- Source category ID: `13162`
- Source label for human review: `𫼈`
- Source codepoints: `U+2BF08`
...
- `obs-evo-cand-013162-route-category-staging`
...
- `obs-evo-cand-013162-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013162-route-evolution-graph`
