# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012533
...
- EVOBC candidate category: `evobc-evo-cat-12533`.
- Source label for search only: `𨾊`.
- Source codepoints for search only: `U+28F8A`.
