...
- External category reference: `evobc-cat-09561`
- Source category ID: `09561`
- Source label for human review: `鑽`
- Source codepoints: `U+947D`
...
- `obs-evo-cand-009561-route-category-staging`
...
- `obs-evo-cand-009561-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009561-route-evolution-graph`
