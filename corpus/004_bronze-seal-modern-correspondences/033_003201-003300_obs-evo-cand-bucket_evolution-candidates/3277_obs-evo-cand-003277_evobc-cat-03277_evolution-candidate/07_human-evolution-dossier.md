...
- Project ID: `obs-evo-cand-003277`
- EVOBC category candidate ID: `evobc-evo-cat-03277`
- External category reference: `evobc-cat-03277`
- Source category ID: `03277`
- Source label for human review: `抎`
- Source codepoints: `U+628E`
...
- `obs-evo-cand-003277-route-category-staging`
...
- `obs-evo-cand-003277-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003277-route-evolution-graph`
