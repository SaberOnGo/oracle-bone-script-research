# obs-char-000486 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000486`
- primary external id: `hust-obc-cat-0551`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/486_obs-char-000486_hust-obc-cat-0551_orac
  le-character/03_visual-assets/001_asset-000491_hust-obc-cat-0551_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0551/G_0551_乙21(甲).png`
- asset id: `asset-000491`
...
- source category: `0551`
- validation class: `485`
- source image route: `HUST-OBC/deciphered/0551/G_0551_乙21(甲).png`
- asset id: `asset-000491`
...
- English observation: `A narrow vertical form stacks a pointed upper loop
  with internal branches, a small lower diamond-shaped loop, and a forked
...
- dataset label text: `㘝`
- dataset label codepoints: `U+361D`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/038_obs-evo-can
  d-000038_evobc-cat-00038_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/038_obs-evo-cand-000038_evobc-cat-00038_evolu
...
- matched OBIMD main UIDs: `a8vnbz5v1s`
...
- Which source records identify obs-char-000486 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000486？
