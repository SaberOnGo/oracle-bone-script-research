# obs-char-000806 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/806_obs-char-000806_hust-obc-cat-0913_orac
  le-character/03_visual-assets/001_asset-000811_hust-obc-cat-0913_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0913/G_0913_甲骨文0.png`
- asset id: `asset-000811`
...
- source category: `0913`
- validation class: `805`
- source image route: `HUST-OBC/deciphered/0913/G_0913_甲骨文0.png`
- asset id: `asset-000811`
...
- English observation: `A broad horizontal bar crosses a central upright;
  three curved short strokes rise near its right side, while a long stem
  descends below.`
- 中文观察: `宽大横笔横过中央直立笔；右侧附近三条弯曲短笔向上，下方延伸竖直长干。`
...
- dataset label text: `㞇`
- dataset label codepoints: `U+3787`
...
- Which source records identify obs-char-000806 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000806？
