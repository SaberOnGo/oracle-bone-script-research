# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010957
...
- EVOBC candidate category: `evobc-evo-cat-10957`.
- Source label for search only: `𠽽`.
- Source codepoints for search only: `U+20F7D`.
