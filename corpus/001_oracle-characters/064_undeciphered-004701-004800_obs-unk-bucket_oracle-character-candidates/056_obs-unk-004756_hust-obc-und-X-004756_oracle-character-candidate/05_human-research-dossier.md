# obs-unk-004756 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/056_obs-unk-004756_h
  ust-obc-und-X-004756_oracle-character-candidate/03_visual-assets/001_asset
  -006349_hust-obc-und-X-004756_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/312/X_？_7297_1.png`
- asset id: `asset-006349`
...
- source class: `HUST-OBC/undeciphered/X/312/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/312/X_？_7297_1.png`
- asset id: `asset-006349`
...
- English observation: `distinct left and right groups with lower openings`
- 中文观察: `带下部开口的分立左右结构`
...
- Which source records identify obs-unk-004756 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004756？
