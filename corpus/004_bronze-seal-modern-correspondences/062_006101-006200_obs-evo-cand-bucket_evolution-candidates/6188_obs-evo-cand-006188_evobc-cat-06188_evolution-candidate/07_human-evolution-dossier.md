...
- External category reference: `evobc-cat-06188`
- Source category ID: `06188`
- Source label for human review: `竁`
- Source codepoints: `U+7AC1`
...
- `obs-evo-cand-006188-route-category-staging`
...
- `obs-evo-cand-006188-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006188-route-evolution-graph`
