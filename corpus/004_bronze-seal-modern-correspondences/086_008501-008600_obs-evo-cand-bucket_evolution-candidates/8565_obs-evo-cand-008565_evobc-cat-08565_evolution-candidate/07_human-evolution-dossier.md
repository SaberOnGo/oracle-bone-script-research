...
- Project ID: `obs-evo-cand-008565`
- EVOBC category candidate ID: `evobc-evo-cat-08565`
- External category reference: `evobc-cat-08565`
- Source category ID: `08565`
- Source label for human review: `賄`
- Source codepoints: `U+8CC4`
...
- `obs-evo-cand-008565-route-category-staging`
...
- `obs-evo-cand-008565-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008565-route-evolution-graph`
