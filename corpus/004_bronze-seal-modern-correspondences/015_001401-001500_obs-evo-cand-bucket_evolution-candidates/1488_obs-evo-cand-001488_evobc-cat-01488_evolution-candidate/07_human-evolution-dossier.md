...
Project ID: `obs-evo-cand-001488`
...
- Project ID: `obs-evo-cand-001488`
- EVOBC category candidate ID: `evobc-evo-cat-01488`
- External category reference: `evobc-cat-01488`
- Source category ID: `01488`
- Source label for human review: `叹`
- Source codepoints: `U+53F9`
...
- `obs-evo-cand-001488-route-category-staging`
...
- `obs-evo-cand-001488-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001488-route-evolution-graph`
