...
- External category reference: `evobc-cat-06913`
- Source category ID: `06913`
- Source label for human review: `耇`
- Source codepoints: `U+8007`
- Image reference count in source metadata: `33`
...
- `obs-evo-cand-006913-route-category-staging`
...
- `obs-evo-cand-006913-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006913-route-evolution-graph`
