...
- External category reference: `evobc-cat-09655`
- Source category ID: `09655`
- Source label for human review: `闑`
...
- `obs-evo-cand-009655-route-category-staging`
...
- `obs-evo-cand-009655-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009655-route-evolution-graph`
