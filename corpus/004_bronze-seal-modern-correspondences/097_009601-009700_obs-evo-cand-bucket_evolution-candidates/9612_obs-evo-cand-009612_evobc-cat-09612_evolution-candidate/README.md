# obs-evo-cand-009612 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-009612`
- EVOBC category candidate ID: `evobc-evo-cat-09612`
- External category ref: `evobc-cat-09612`
- Source label: `門`
- Source codepoints: `U+9580`
- Image reference count: `201`
- Era token counts: `BI:45;CS:1;OBC:65;SAC:2;SS:2;WSC:86`
- Source token counts: `Book:68;Web:133`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 65 image references
- era 1 / BI: 45 image references
...
- source 1 / Web:105952;說文Web:58: 111 image references
- source 2 / Book:17600: 18 image references
