...
- External category reference: `evobc-cat-13222`
- Source category ID: `13222`
- Source label for human review: `𬇢`
...
- `obs-evo-cand-013222-route-category-staging`
...
- `obs-evo-cand-013222-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013222-route-evolution-graph`
