# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-001264
...
- glyph_codepoint_uplus_sample: `U+A9987;U+F74A9, U+F74AA, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-015502` | `001_asset-015502_img.png` | `c9e05a203b08e2ce465777212772f250ba6d31a727f03944d3cd5da6595c0641` |
