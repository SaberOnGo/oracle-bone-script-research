# obs-unk-004114 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/014_obs-unk-004114_h
  ust-obc-und-L-004114_oracle-character-candidate/03_visual-assets/001_asset
  -005707_hust-obc-und-L-004114_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4114/L_？_8851.jpg`
- asset id: `asset-005707`
...
- source class: `HUST-OBC/undeciphered/L/4114/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4114/L_？_8851.jpg`
- asset id: `asset-005707`
...
- English observation: The opened image shows a narrow upper trace and a broad
  lower angular outline with a dark base.
- 中文观察：已打开图像可见窄长上部痕迹、宽下部折角轮廓和深色基部。
...
- Which source records identify obs-unk-004114 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004114？
