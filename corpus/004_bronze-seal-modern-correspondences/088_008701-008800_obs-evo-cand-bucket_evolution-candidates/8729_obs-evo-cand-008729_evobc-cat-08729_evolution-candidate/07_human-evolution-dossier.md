...
Project ID: `obs-evo-cand-008729`
...
- Project ID: `obs-evo-cand-008729`
- EVOBC category candidate ID: `evobc-evo-cat-08729`
- External category reference: `evobc-cat-08729`
- Source category ID: `08729`
- Source label for human review: `踐`
- Source codepoints: `U+8E10`
...
- `obs-evo-cand-008729-route-category-staging`
...
- `obs-evo-cand-008729-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008729-route-evolution-graph`
