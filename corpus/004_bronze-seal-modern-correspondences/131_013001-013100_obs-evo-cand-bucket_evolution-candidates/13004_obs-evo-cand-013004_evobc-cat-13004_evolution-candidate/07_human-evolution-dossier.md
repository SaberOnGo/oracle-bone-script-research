...
Project ID: `obs-evo-cand-013004`
...
- Project ID: `obs-evo-cand-013004`
- EVOBC category candidate ID: `evobc-evo-cat-13004`
- External category reference: `evobc-cat-13004`
- Source category ID: `13004`
- Source label for human review: `𫣑`
- Source codepoints: `U+2B8D1`
...
- `obs-evo-cand-013004-route-category-staging`
...
- `obs-evo-cand-013004-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013004-route-evolution-graph`
