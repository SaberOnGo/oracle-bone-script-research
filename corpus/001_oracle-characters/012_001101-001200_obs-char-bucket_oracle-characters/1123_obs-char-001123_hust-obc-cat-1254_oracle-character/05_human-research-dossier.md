# obs-char-001123 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1123_obs-char-001123_hust-obc-cat-1254_ora
  cle-character/03_visual-assets/001_asset-001128_hust-obc-cat-1254_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1254/L_1254_637.jpg`
- asset id: `asset-001128`
...
- source category: `1254`
- validation class: `1122`
- source image route: `HUST-OBC/deciphered/1254/L_1254_637.jpg`
- asset id: `asset-001128`
...
- English observation: `A faint gray form has a small angular upper
  enclosure, two short lower curves, and separated lower strokes; contrast
  is low.`
...
- dataset label text: `㣜`
- dataset label codepoints: `U+38DC`
...
- Which source records identify obs-char-001123 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001123？
