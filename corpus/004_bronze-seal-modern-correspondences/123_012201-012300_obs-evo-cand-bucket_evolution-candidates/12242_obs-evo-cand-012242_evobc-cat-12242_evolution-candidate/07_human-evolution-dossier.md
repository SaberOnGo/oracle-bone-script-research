...
- External category reference: `evobc-cat-12242`
- Source category ID: `12242`
- Source label for human review: `𧪾`
- Source codepoints: `U+27ABE`
...
- `obs-evo-cand-012242-route-category-staging`
...
- `obs-evo-cand-012242-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012242-route-evolution-graph`
