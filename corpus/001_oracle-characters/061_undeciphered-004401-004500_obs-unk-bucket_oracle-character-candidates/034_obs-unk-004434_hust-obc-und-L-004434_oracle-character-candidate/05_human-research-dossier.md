# obs-unk-004434 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004434`
- primary external id: `hust-obc-und-L-004434`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/034_obs-unk-004434_h
  ust-obc-und-L-004434_oracle-character-candidate/03_visual-assets/001_asset
  -006027_hust-obc-und-L-004434_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4434/L_？_9964.jpg`
- asset id: `asset-006027`
...
- source class: `HUST-OBC/undeciphered/L/4434/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4434/L_？_9964.jpg`
- asset id: `asset-006027`
...
- English observation: `A left open trace sits beside a rounded middle outline.`
- 中文观察: `左侧开放痕迹紧邻中部圆弧轮廓。`
...
- Which source records identify obs-unk-004434 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004434？
