# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006905
...
- EVOBC candidate category: `evobc-evo-cat-06905`.
- Source label for search only: `翽`.
- Source codepoints for search only: `U+7FFD`.
