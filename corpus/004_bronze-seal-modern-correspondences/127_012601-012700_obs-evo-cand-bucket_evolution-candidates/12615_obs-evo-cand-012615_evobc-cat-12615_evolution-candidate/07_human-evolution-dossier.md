...
- External category reference: `evobc-cat-12615`
- Source category ID: `12615`
- Source label for human review: `𩔂`
- Source codepoints: `U+29502`
...
- `obs-evo-cand-012615-route-category-staging`
...
- `obs-evo-cand-012615-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012615-route-evolution-graph`
