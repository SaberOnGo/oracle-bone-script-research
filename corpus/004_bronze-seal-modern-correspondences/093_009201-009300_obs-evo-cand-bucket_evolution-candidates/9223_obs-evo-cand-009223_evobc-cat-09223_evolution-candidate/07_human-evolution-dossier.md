...
- External category reference: `evobc-cat-09223`
- Source category ID: `09223`
- Source label for human review: `鄷`
...
- `obs-evo-cand-009223-route-category-staging`
...
- `obs-evo-cand-009223-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009223-route-evolution-graph`
