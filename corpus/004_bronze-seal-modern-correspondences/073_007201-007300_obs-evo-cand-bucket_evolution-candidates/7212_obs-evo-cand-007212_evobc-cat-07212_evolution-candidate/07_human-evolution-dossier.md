...
- Project ID: `obs-evo-cand-007212`
- EVOBC category candidate ID: `evobc-evo-cat-07212`
- External category reference: `evobc-cat-07212`
- Source category ID: `07212`
- Source label for human review: `艫`
- Source codepoints: `U+826B`
...
- `obs-evo-cand-007212-route-category-staging`
...
- `obs-evo-cand-007212-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007212-route-evolution-graph`
