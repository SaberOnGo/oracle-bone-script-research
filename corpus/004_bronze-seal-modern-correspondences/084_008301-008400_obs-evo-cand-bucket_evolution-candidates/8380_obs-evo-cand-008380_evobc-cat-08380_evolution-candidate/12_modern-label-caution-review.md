# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008380
...
- EVOBC candidate category: `evobc-evo-cat-08380`.
- Source label for search only: `譽`.
- Source codepoints for search only: `U+8B7D`.
