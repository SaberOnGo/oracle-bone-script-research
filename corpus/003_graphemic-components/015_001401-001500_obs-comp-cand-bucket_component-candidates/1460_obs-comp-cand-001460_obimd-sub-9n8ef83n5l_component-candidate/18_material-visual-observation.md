# Material Visual Observation / obs-comp-cand-001460 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001460`
- External reference / 外部参照: `obimd-sub-9n8ef83n5l`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016037_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9n8ef83n5l/9n8ef83n5l/9n8ef83n5l.png`
- Checksum / 校验和:
  `cfda2785434c010754704650f890cc98b0f4810c007481d55e31813d2a9a538f`
...
- Marked-pixel bounds: (73,45)–(176,201); span 104 × 157 px; the marked
...
- 痕迹范围：(73,45)–(176,201)；跨度104 × 157 px；痕迹矩形高于宽。
