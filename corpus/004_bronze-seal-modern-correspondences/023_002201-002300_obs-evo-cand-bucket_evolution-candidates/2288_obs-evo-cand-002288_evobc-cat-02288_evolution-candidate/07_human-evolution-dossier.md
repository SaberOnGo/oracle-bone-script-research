...
- External category reference: `evobc-cat-02288`
- Source category ID: `02288`
- Source label for human review: `嫿`
- Source codepoints: `U+5AFF`
...
- `obs-evo-cand-002288-route-category-staging`
...
- `obs-evo-cand-002288-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002288-route-evolution-graph`
