...
- External category reference: `evobc-cat-04217`
- Source category ID: `04217`
- Source label for human review: `槧`
...
- `obs-evo-cand-004217-route-category-staging`
...
- `obs-evo-cand-004217-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004217-route-evolution-graph`
