# Material Visual Observation / obs-comp-cand-000929 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000929`
- External reference / 外部参照: `obimd-sub-fzkl7e4vel`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014012_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fzkl7e4vel/fzkl7e4vel/fzkl7e4vel.png`
- Checksum / 校验和:
  `abb9b513c0ebeb3eadcdf2c957e9d51af0c8a0fe2c9b552e1540b1a4f1cbafde`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.45%.
- Marked-pixel bounds: (85,25)–(163,227); span 79 × 203 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.45%。
- 痕迹范围：(85,25)–(163,227)；跨度79 × 203 px；痕迹矩形高于宽。
