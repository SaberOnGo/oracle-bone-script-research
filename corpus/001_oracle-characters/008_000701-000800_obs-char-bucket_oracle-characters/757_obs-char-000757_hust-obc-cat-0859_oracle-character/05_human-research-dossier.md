# obs-char-000757 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/757_obs-char-000757_hust-obc-cat-0859_orac
  le-character/03_visual-assets/001_asset-000762_hust-obc-cat-0859_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0859/G_0859_甲骨文0.png`
- asset id: `asset-000762`
...
- source category: `0859`
- validation class: `756`
- source image route: `HUST-OBC/deciphered/0859/G_0859_甲骨文0.png`
- asset id: `asset-000762`
...
- dataset label text: `㝑`
- dataset label codepoints: `U+3751`
...
- Which source records identify obs-char-000757 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000757？
