...
- External category reference: `evobc-cat-00601`
- Source category ID: `00601`
- Source label for human review: `一`
- Source codepoints: `U+4E00`
- Image reference count in source metadata: `427`
...
- `obs-evo-cand-000601-route-category-staging`
...
- `obs-evo-cand-000601-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000601-route-evolution-graph`
