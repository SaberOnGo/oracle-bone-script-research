...
Project ID: `obs-evo-cand-004364`
...
- Project ID: `obs-evo-cand-004364`
- EVOBC category candidate ID: `evobc-evo-cat-04364`
- External category reference: `evobc-cat-04364`
- Source category ID: `04364`
- Source label for human review: `歇`
- Source codepoints: `U+6B47`
...
- `obs-evo-cand-004364-route-category-staging`
...
- `obs-evo-cand-004364-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004364-route-evolution-graph`
