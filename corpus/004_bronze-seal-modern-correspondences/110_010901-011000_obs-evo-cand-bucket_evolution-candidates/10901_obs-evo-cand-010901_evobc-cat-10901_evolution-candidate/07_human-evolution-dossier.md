...
- External category reference: `evobc-cat-10901`
- Source category ID: `10901`
- Source label for human review: `𠩜`
- Source codepoints: `U+20A5C`
...
- `obs-evo-cand-010901-route-category-staging`
...
- `obs-evo-cand-010901-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010901-route-evolution-graph`
