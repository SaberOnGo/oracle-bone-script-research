...
- External category reference: `evobc-cat-07591`
- Source category ID: `07591`
- Source label for human review: `蕨`
...
- `obs-evo-cand-007591-route-category-staging`
...
- `obs-evo-cand-007591-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007591-route-evolution-graph`
