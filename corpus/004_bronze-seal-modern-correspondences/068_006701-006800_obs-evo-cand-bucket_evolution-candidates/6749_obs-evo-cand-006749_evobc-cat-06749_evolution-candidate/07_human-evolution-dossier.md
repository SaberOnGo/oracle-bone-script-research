...
Project ID: `obs-evo-cand-006749`
...
- Project ID: `obs-evo-cand-006749`
- EVOBC category candidate ID: `evobc-evo-cat-06749`
- External category reference: `evobc-cat-06749`
- Source category ID: `06749`
- Source label for human review: `给`
- Source codepoints: `U+7ED9`
...
- `obs-evo-cand-006749-route-category-staging`
...
- `obs-evo-cand-006749-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006749-route-evolution-graph`
