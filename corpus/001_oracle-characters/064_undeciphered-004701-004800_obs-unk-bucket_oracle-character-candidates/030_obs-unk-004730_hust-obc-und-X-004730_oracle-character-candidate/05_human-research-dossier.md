# obs-unk-004730 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/030_obs-unk-004730_h
  ust-obc-und-X-004730_oracle-character-candidate/03_visual-assets/001_asset
  -006323_hust-obc-und-X-004730_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/286/X_？_7265_1.png`
- asset id: `asset-006323`
...
- source class: `HUST-OBC/undeciphered/X/286/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/286/X_？_7265_1.png`
- asset id: `asset-006323`
...
- English observation: `upper branching form with separate lower U-stroke`
- 中文观察: `带分离下部 U 形笔画的上部分支结构`
...
- Which source records identify obs-unk-004730 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004730？
