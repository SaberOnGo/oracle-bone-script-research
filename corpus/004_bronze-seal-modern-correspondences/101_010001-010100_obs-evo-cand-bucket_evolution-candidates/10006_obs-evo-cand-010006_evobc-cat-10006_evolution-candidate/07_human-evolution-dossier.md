...
- External category reference: `evobc-cat-10006`
- Source category ID: `10006`
- Source label for human review: `頻`
...
- `obs-evo-cand-010006-route-category-staging`
...
- `obs-evo-cand-010006-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010006-route-evolution-graph`
