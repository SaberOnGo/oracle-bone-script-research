...
- External category reference: `evobc-cat-05736`
- Source category ID: `05736`
- Source label for human review: `皸`
- Source codepoints: `U+76B8`
...
- `obs-evo-cand-005736-route-category-staging`
...
- `obs-evo-cand-005736-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005736-route-evolution-graph`
