...
- External category reference: `evobc-cat-00871`
- Source category ID: `00871`
- Source label for human review: `俁`
- Source codepoints: `U+4FC1`
...
- `obs-evo-cand-000871-route-category-staging`
...
- `obs-evo-cand-000871-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000871-route-evolution-graph`
