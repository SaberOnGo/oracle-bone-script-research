# Material Visual Observation / obs-comp-cand-002175 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002175`
- External reference / 外部参照: `obimd-sub-7ezpstbc1y`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019876_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7ezpstbc1y/7ezpstbc1y/7ezpstbc1y.png`
- Checksum / 校验和:
  `dd5d54553876991ada6fbb2ad776b8e04593b81d31c7739f281bc16eb502f959`
...
- Marked-pixel bounds: (71,38)–(178,218); span 108 × 181 px; the marked
...
- 痕迹范围：(71,38)–(178,218)；跨度108 × 181 px；痕迹矩形高于宽。
