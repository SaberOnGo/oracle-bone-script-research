# obs-char-000348 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000348`
- primary external id: `hust-obc-cat-0393`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/348_obs-char-000348_hust-obc-cat-0393_orac
  le-character/03_visual-assets/001_asset-000353_hust-obc-cat-0393_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0393/H_0393_60F62_0.png`
- asset id: `asset-000353`
...
- source category: `0393`
- validation class: `347`
- source image route: `HUST-OBC/deciphered/0393/H_0393_60F62_0.png`
- asset id: `asset-000353`
...
- English observation: `The large rounded outer contour contains a tall
  branching central stroke and several detached short marks; the dark image
  needs recheck.`
- 中文观察: `大型圆弧外轮廓内部有高直分叉中轴和数个分离短痕迹；深色图像仍需复核。`
...
- dataset label text: `㕿`
- dataset label codepoints: `U+357F`
...
- filename catalog route clues: `catalog-like filename clue: H_0393
  (H_0393_60F62_0.png)`
...
- Which source records identify obs-char-000348 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000348？
