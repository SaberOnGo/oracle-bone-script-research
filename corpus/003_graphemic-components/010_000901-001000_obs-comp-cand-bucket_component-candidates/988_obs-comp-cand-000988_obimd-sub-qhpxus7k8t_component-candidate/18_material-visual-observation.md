# Material Visual Observation / obs-comp-cand-000988 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000988`
- External reference / 外部参照: `obimd-sub-qhpxus7k8t`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014358_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qhpxus7k8t/qhpxus7k8t/qhpxus7k8t.png`
- Checksum / 校验和:
  `e561bffcde6f6ed4263828ad1cc4e60689589fad11ce0d61b026b7425398f010`
...
- Marked-pixel bounds: (76,42)–(173,209); span 98 × 168 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.67%。
- 痕迹范围：(76,42)–(173,209)；跨度98 × 168 px；痕迹矩形高于宽。
