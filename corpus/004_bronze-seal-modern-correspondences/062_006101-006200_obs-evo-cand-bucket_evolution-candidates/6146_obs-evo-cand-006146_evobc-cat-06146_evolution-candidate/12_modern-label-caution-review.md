# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006146
...
- EVOBC candidate category: `evobc-evo-cat-06146`.
- Source label for search only: `穷`.
- Source codepoints for search only: `U+7A77`.
