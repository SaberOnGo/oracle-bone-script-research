# Material Visual Observation / obs-comp-cand-000196 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000196`
- External reference / 外部参照: `obimd-sub-93bm8ylj5e`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011757_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/k6l649jf98/93bm8ylj5e/93bm8ylj5e.png`
- Checksum / 校验和:
  `ef11deb436774324465cc894bff092cefb55dd705c800db1ffe5945a692a9c05`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.90%.
- Marked-pixel bounds: (57,39)–(192,217); span 136 × 179 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.90%。
- 痕迹范围：(57,39)–(192,217)；跨度136 × 179 px；痕迹矩形高于宽。
