...
- External category reference: `evobc-cat-11246`
- Source category ID: `11246`
- Source label: `𢜨`
...
- `obs-evo-cand-011246-route-category-staging`
...
- `obs-evo-cand-011246-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011246-route-evolution-graph`
