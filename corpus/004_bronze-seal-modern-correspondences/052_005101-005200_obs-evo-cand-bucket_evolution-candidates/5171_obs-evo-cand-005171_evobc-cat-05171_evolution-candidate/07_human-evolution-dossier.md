...
- Project ID: `obs-evo-cand-005171`
- EVOBC category candidate ID: `evobc-evo-cat-05171`
- External category reference: `evobc-cat-05171`
- Source category ID: `05171`
- Source label for human review: `爛`
- Source codepoints: `U+721B`
...
- `obs-evo-cand-005171-route-category-staging`
...
- `obs-evo-cand-005171-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005171-route-evolution-graph`
