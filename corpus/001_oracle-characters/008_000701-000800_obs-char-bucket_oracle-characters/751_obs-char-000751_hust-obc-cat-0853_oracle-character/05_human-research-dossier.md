# obs-char-000751 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000751`
- primary external id: `hust-obc-cat-0853`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/751_obs-char-000751_hust-obc-cat-0853_orac
  le-character/03_visual-assets/001_asset-000756_hust-obc-cat-0853_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0853/L_0853_1082.jpg`
- asset id: `asset-000756`
...
- source category: `0853`
- validation class: `750`
- source image route: `HUST-OBC/deciphered/0853/L_0853_1082.jpg`
- asset id: `asset-000756`
...
- English observation: `The tiny low-resolution image shows a compact
  angular cluster with a central crossing, short left and upper branches,
  and a bent right chevron; fine joins remain unclear.`
- 中文观察: `微小低分辨率图像显示紧凑折角笔群，含中央交叉、左侧和上部短枝及右侧弯折尖角；细接点仍难辨。`
...
- dataset label text: `㝋`
- dataset label codepoints: `U+374B`
...
- Which source records identify obs-char-000751 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000751？
