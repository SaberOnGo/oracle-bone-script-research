# Material Visual Observation / obs-comp-cand-000370 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000370`
- External reference / 外部参照: `obimd-sub-lv9rlaeib9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012293_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lv9rlaeib9/lv9rlaeib9/lv9rlaeib9.png`
- Checksum / 校验和:
  `a70bd22691e4065bd777fb7721753e23742446dbefcc57be0f2a829065bbcafc`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.68%.
- Marked-pixel bounds: (64,17)–(184,231); span 121 × 215 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.68%。
- 痕迹范围：(64,17)–(184,231)；跨度121 × 215 px；痕迹矩形高于宽。
