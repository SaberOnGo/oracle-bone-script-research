...
- External category reference: `evobc-cat-03060`
- Source category ID: `03060`
- Source label for human review: `惨`
...
- `obs-evo-cand-003060-route-category-staging`
...
- `obs-evo-cand-003060-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003060-route-evolution-graph`
