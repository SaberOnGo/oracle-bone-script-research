# obs-unk-004483 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/083_obs-unk-004483_h
  ust-obc-und-X-004483_oracle-character-candidate/03_visual-assets/001_asset
  -006076_hust-obc-und-X-004483_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/39/X_？_8217_1.png`
- asset id: `asset-006076`
...
- source class: `HUST-OBC/undeciphered/X/39/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/39/X_？_8217_1.png`
- asset id: `asset-006076`
...
- English observation: A narrow upper wedge and small openings sit above a
  crossbar and pointed lower frame.
- 中文观察: 窄上部楔痕和小开口位于横线及尖状下部框痕之上。
...
- Which source records identify obs-unk-004483 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004483？
