# Material Visual Observation / obs-comp-cand-001913 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001913`
- External reference / 外部参照: `obimd-sub-2ucenh7n1c`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018323_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wf3aejbrt3/2ucenh7n1c/2ucenh7n1c.png`
- Checksum / 校验和:
  `f9470b8bb232dfa42e9e9c054fad00b36eb095a477458eca25f6116293bb3df1`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.94%.
- Marked-pixel bounds: (79,41)–(170,203); span 92 × 163 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.94%。
- 痕迹范围：(79,41)–(170,203)；跨度92 × 163 px；痕迹矩形高于宽。
