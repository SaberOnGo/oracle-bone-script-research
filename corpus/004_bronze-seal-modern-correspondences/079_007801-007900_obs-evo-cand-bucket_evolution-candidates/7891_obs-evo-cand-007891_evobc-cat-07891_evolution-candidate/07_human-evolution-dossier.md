...
- External category reference: `evobc-cat-07891`
- Source category ID: `07891`
- Source label for human review: `蠸`
- Source codepoints: `U+8838`
...
- `obs-evo-cand-007891-route-category-staging`
...
- `obs-evo-cand-007891-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007891-route-evolution-graph`
