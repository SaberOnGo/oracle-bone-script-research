...
- External category reference: `evobc-cat-12640`
- Source category ID: `12640`
- Source label for human review: `𩟧`
- Source codepoints: `U+297E7`
...
- `obs-evo-cand-012640-route-category-staging`
...
- `obs-evo-cand-012640-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012640-route-evolution-graph`
