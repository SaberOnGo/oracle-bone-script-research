# obs-unk-008061 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008061`
- primary external id: `hust-obc-und-YH-008061`
...
- local review image route: `corpus/001_oracle-characters/097_undeciphered-008
  001-008100_obs-unk-bucket_oracle-character-candidates/061_obs-unk-008061_h
  ust-obc-und-YH-008061_oracle-character-candidate/03_visual-assets/001_asse
  t-009652_hust-obc-und-YH-008061_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/606B0/H_？_606B0_0.png`
- asset id: `asset-009652`
...
- source class: `HUST-OBC/undeciphered/Y+H/606B0/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/606B0/H_？_606B0_0.png`
- asset id: `asset-009652`
...
- Which source records identify obs-unk-008061 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008061？
