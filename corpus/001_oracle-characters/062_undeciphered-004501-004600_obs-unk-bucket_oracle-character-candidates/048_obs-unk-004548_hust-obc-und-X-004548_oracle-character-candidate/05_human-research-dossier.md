# obs-unk-004548 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/048_obs-unk-004548_h
  ust-obc-und-X-004548_oracle-character-candidate/03_visual-assets/001_asset
  -006141_hust-obc-und-X-004548_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/104/X_？_8286_1.png`
- asset id: `asset-006141`
...
- source class: `HUST-OBC/undeciphered/X/104/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/104/X_？_8286_1.png`
- asset id: `asset-006141`
...
- English observation: `Lower outline, central trace, and right lobe recorded.`
- 中文观察: `已记录下部轮廓、中央长痕和右侧区域。`
...
- Which source records identify obs-unk-004548 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004548？
