...
- External category reference: `evobc-cat-06439`
- Source category ID: `06439`
- Source label for human review: `糾`
- Source codepoints: `U+7CFE`
...
- `obs-evo-cand-006439-route-category-staging`
...
- `obs-evo-cand-006439-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006439-route-evolution-graph`
