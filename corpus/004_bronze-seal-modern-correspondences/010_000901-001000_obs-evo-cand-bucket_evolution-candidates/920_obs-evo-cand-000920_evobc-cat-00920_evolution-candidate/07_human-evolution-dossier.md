...
Project ID: `obs-evo-cand-000920`
...
- Project ID: `obs-evo-cand-000920`
- EVOBC category candidate ID: `evobc-evo-cat-00920`
- External category reference: `evobc-cat-00920`
- Source category ID: `00920`
- Source label for human review: `倌`
- Source codepoints: `U+500C`
...
- `obs-evo-cand-000920-route-category-staging`
...
- `obs-evo-cand-000920-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000920-route-evolution-graph`
