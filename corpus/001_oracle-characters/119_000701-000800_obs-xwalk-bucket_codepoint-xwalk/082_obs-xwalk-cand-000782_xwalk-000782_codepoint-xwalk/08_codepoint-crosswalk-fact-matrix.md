...
|---|---|---|
| Source Codepoint Route | `U+376C` | not identity |
| HUST candidate route | `hust-obc-cat-0886` | not reading |
| OBIMD route | `obimd-main-cand-000981` | not component |
| EVOBC route | `evobc-evo-cat-00075` | not evolution |
