...
- `obs-evo-cand-005942-route-category-staging`
...
- `obs-evo-cand-005942-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005942-route-evolution-graph`
