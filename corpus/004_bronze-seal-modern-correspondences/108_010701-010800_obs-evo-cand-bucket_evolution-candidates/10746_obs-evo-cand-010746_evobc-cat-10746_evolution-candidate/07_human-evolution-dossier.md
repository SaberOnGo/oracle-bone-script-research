...
- External category reference: `evobc-cat-10746`
- Source category ID: `10746`
- Source label for human review: `龏`
- Source codepoints: `U+9F8F`
- Image reference count in source metadata: `156`
...
- `obs-evo-cand-010746-route-category-staging`
...
- `obs-evo-cand-010746-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010746-route-evolution-graph`
