# obs-unk-004385 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004385`
- primary external id: `hust-obc-und-L-004385`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/085_obs-unk-004385_h
  ust-obc-und-L-004385_oracle-character-candidate/03_visual-assets/001_asset
  -005978_hust-obc-und-L-004385_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4385/L_？_9748.jpg`
- asset id: `asset-005978`
...
- source class: `HUST-OBC/undeciphered/L/4385/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4385/L_？_9748.jpg`
- asset id: `asset-005978`
...
- English observation: `Short upper traces descend into a compact`
  `lower cluster; a curved lower trace opens toward the left.`
- 中文观察: `上部短痕向下进入紧凑痕迹群，下部有向左开放的弧痕。`
...
- Which source records identify obs-unk-004385 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004385？
