# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002465
...
- EVOBC candidate category: `evobc-evo-cat-02465`.
- Source label for search only: `對`.
- Source codepoints for search only: `U+5C0D`.
