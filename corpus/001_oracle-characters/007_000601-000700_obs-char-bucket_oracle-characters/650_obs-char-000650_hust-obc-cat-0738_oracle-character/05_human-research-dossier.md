# obs-char-000650 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000650`
- primary external id: `hust-obc-cat-0738`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/650_obs-char-000650_hust-obc-cat-0738_orac
  le-character/03_visual-assets/001_asset-000655_hust-obc-cat-0738_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0738/X_0738_5455_1.png`
- asset id: `asset-000655`
...
- source category: `0738`
- validation class: `649`
- source image route: `HUST-OBC/deciphered/0738/X_0738_5455_1.png`
- asset id: `asset-000655`
...
- English observation: `A central tall upright is capped by a hollow pointed
  triangle and crossed above an inverted triangular opening; curved side
  branches lead to two long outer legs.`
- 中文观察: `中央高竖顶端为中空尖三角，并在倒三角空隙上方被横笔穿过；弯侧枝连接两条长外腿。`
...
- dataset label text: `㛘`
- dataset label codepoints: `U+36D8`
...
- Which source records identify obs-char-000650 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000650？
