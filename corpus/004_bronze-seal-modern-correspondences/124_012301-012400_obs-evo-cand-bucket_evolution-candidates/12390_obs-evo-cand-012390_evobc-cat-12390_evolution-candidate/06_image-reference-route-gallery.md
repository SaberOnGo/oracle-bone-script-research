...
- `obs-evo-cand-012390-route-category-staging`
...
- `obs-evo-cand-012390-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012390-route-evolution-graph`
