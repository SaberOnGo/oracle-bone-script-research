# Material Visual Observation / obs-comp-cand-002070 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002070`
- External reference / 外部参照: `obimd-sub-yaysiuwhi0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019457_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0tk0pmitom/yaysiuwhi0/yaysiuwhi0.png`
- Checksum / 校验和:
  `bab9b6cb038545c6cd6f95225dc2969fb7e5fc34f00643d28eb3c4f68e7046ed`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.35%.
- Marked-pixel bounds: (65,18)–(186,229); span 122 × 212 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.35%。
- 痕迹范围：(65,18)–(186,229)；跨度122 × 212 px；痕迹矩形高于宽。
