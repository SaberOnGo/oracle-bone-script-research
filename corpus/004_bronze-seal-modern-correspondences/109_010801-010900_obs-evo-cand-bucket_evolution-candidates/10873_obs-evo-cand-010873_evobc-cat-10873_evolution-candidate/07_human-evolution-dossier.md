...
- External category reference: `evobc-cat-10873`
- Source category ID: `10873`
- Source label for human review: `𠥆`
- Source codepoints: `U+20946`
- Image reference count in source metadata: `15`
...
- `obs-evo-cand-010873-route-category-staging`
...
- `obs-evo-cand-010873-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010873-route-evolution-graph`
