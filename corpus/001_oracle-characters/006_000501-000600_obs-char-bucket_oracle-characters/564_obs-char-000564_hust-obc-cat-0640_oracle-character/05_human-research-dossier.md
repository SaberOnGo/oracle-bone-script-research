# obs-char-000564 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000564`
- primary external id: `hust-obc-cat-0640`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/564_obs-char-000564_hust-obc-cat-0640_orac
  le-character/03_visual-assets/001_asset-000569_hust-obc-cat-0640_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0640/G_0640_前2.14.4(甲).png`
- asset id: `asset-000569`
...
- source category: `0640`
- validation class: `563`
- source image route: `HUST-OBC/deciphered/0640/G_0640_前2.14.4(甲).png`
- asset id: `asset-000569`
...
- English observation: `A bold upright U-shaped outline has two raised upper
  tips, a horizontal divider across the middle, and a narrow pointed
  bottom.`
- 中文观察: `粗重直立 U 形轮廓带两个上伸尖端，中部有横向分隔，下端狭窄而尖。`
...
- dataset label text: `㙶`
- dataset label codepoints: `U+3676`
...
- Which source records identify obs-char-000564 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000564？
