...
Project ID: `obs-evo-cand-001819`
...
- Project ID: `obs-evo-cand-001819`
- EVOBC category candidate ID: `evobc-evo-cat-01819`
- External category reference: `evobc-cat-01819`
- Source category ID: `01819`
- Source label for human review: `坚`
- Source codepoints: `U+575A`
...
- `obs-evo-cand-001819-route-category-staging`
...
- `obs-evo-cand-001819-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001819-route-evolution-graph`
