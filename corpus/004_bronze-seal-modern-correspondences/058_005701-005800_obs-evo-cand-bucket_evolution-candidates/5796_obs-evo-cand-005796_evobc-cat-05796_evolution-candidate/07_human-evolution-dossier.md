...
- External category reference: `evobc-cat-05796`
- Source category ID: `05796`
- Source label for human review: `眚`
- Source codepoints: `U+771A`
...
- `obs-evo-cand-005796-route-category-staging`
...
- `obs-evo-cand-005796-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005796-route-evolution-graph`
