# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000119
...
| Glyph or codepoint route / 字形或码位路线 | 18 OBIMD route rows; examples U+BB176;U+F0B3B; U+F0B3C; 另有 16 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
