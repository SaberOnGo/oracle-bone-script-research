...
- `obs-evo-cand-005140-route-category-staging`
...
- `obs-evo-cand-005140-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005140-route-evolution-graph`
