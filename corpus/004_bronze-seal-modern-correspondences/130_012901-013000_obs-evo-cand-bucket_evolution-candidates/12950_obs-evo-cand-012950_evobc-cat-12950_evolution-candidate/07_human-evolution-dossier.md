...
- External category reference: `evobc-cat-12950`
- Source category ID: `12950`
...
- `obs-evo-cand-012950-route-category-staging`
...
- `obs-evo-cand-012950-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012950-route-evolution-graph`
