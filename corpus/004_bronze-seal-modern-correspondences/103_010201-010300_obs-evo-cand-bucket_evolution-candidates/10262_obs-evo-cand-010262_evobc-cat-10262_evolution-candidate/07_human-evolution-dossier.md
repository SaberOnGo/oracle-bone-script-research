...
- External category reference: `evobc-cat-10262`
- Source category ID: `10262`
- Source label for human review: `驢`
- Source codepoints: `U+9A62`
...
- `obs-evo-cand-010262-route-category-staging`
...
- `obs-evo-cand-010262-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010262-route-evolution-graph`
