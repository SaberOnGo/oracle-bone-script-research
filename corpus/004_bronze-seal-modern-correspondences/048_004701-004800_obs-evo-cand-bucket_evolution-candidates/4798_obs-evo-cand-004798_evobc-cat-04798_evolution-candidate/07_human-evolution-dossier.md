...
Project ID: `obs-evo-cand-004798`
...
- Project ID: `obs-evo-cand-004798`
- EVOBC category candidate ID: `evobc-evo-cat-04798`
- External category reference: `evobc-cat-04798`
- Source category ID: `04798`
- Source label for human review: `湳`
- Source codepoints: `U+6E73`
...
- `obs-evo-cand-004798-route-category-staging`
...
- `obs-evo-cand-004798-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004798-route-evolution-graph`
