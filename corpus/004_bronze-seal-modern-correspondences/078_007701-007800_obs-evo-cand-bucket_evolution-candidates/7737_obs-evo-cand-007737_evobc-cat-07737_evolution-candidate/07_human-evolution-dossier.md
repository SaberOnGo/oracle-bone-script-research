...
- External category reference: `evobc-cat-07737`
- Source category ID: `07737`
- Source label for human review: `蚩`
- Source codepoints: `U+86A9`
...
- `obs-evo-cand-007737-route-category-staging`
...
- `obs-evo-cand-007737-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007737-route-evolution-graph`
