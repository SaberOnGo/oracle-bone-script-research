...
- External category reference: `evobc-cat-00144`
- Source category ID: `00144`
- Source label for human review: `㩜`
...
- `obs-evo-cand-000144-route-category-staging`
...
- `obs-evo-cand-000144-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000144-route-evolution-graph`
