...
Project ID: `obs-evo-cand-009377`
...
- Project ID: `obs-evo-cand-009377`
- EVOBC category candidate ID: `evobc-evo-cat-09377`
- External category reference: `evobc-cat-09377`
- Source category ID: `09377`
- Source label for human review: `鉻`
- Source codepoints: `U+927B`
...
- `obs-evo-cand-009377-route-category-staging`
...
- `obs-evo-cand-009377-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009377-route-evolution-graph`
