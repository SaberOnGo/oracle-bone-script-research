...
- External category reference: `evobc-cat-13140`
- Source category ID: `13140`
- Source label: `𫹌`
...
- `obs-evo-cand-013140-route-category-staging`
...
- `obs-evo-cand-013140-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013140-route-evolution-graph`
