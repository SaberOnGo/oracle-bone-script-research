# Material Visual Observation / obs-comp-cand-000146 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000146`
- External reference / 外部参照: `obimd-sub-944ledw1r7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011558_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/944ledw1r7/944ledw1r7/944ledw1r7.png`
- Checksum / 校验和:
  `1cde06613e8363819399750bc112e55ac8b1cd573927269dcdaa22829d23b05e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.85%.
- Marked-pixel bounds: (58,24)–(191,231); span 134 × 208 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.85%。
- 痕迹范围：(58,24)–(191,231)；跨度134 × 208 px；痕迹矩形高于宽。
