# Material Visual Observation / obs-comp-cand-001613 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001613`
- External reference / 外部参照: `obimd-sub-qhpo6v8lz2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017289_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/yo5h3qdl2s/qhpo6v8lz2/qhpo6v8lz2.png`
- Checksum / 校验和:
  `ea2c87f8b46f290b0e4878457dad29ed0f01a38fe7b25d8e0941c00b28c958fd`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.16%.
- Marked-pixel bounds: (97,17)–(154,232); span 58 × 216 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.16%。
- 痕迹范围：(97,17)–(154,232)；跨度58 × 216 px；痕迹矩形高于宽。
