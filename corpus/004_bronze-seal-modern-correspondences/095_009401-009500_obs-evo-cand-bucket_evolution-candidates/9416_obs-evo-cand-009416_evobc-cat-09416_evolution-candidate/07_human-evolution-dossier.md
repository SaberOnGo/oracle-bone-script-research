...
- Project ID: `obs-evo-cand-009416`
- EVOBC category candidate ID: `evobc-evo-cat-09416`
- External category reference: `evobc-cat-09416`
- Source category ID: `09416`
- Source label for human review: `鋤`
- Source codepoints: `U+92E4`
...
- `obs-evo-cand-009416-route-category-staging`
...
- `obs-evo-cand-009416-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009416-route-evolution-graph`
