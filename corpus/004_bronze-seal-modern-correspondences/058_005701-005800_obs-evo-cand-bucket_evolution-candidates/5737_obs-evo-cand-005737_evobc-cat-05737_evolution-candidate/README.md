# obs-evo-cand-005737 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-005737`
- EVOBC category candidate ID: `evobc-evo-cat-05737`
- External category ref: `evobc-cat-05737`
- Source label: `皿`
- Source codepoints: `U+76BF`
- Image reference count: `84`
- Era token counts: `BI:12;CS:1;OBC:62;SAC:2;SS:2;WSC:5`
- Source token counts: `Book:44;Web:40`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 62 image references
- era 1 / BI: 12 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 2 image references
- era 4 / WSC: 5 image references
- era 5 / CS: 1 image references
- source 0 / Web:1633: 1 image references
- source 1 / Web:105952;說文Web:58: 18 image references
