# obs-unk-004045 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004045`
- primary external id: `hust-obc-und-L-004045`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/045_obs-unk-004045_h
  ust-obc-und-L-004045_oracle-character-candidate/03_visual-assets/001_asset
  -005638_hust-obc-und-L-004045_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4045/L_？_8639.jpg`
- asset id: `asset-005638`
...
- source class: `HUST-OBC/undeciphered/L/4045/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4045/L_？_8639.jpg`
- asset id: `asset-005638`
...
- Which source records identify obs-unk-004045 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004045？
