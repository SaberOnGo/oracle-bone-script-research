# Material Visual Observation / obs-comp-cand-002427 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002427`
- External reference / 外部参照: `obimd-sub-ml37ma287p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020498_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jpxofd3gmu/ml37ma287p/ml37ma287p.png`
- Checksum / 校验和:
  `d9c6a38e29d88ae08448193b6572085c0098209a7a417e012e1699ee02308c6a`
...
- Marked-pixel bounds: (85,23)–(164,232); span 80 × 210 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.75%。
- 痕迹范围：(85,23)–(164,232)；跨度80 × 210 px；痕迹矩形高于宽。
