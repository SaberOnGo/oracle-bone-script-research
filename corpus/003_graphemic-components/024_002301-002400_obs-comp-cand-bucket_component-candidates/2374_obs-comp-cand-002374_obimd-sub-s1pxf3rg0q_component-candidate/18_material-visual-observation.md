# Material Visual Observation / obs-comp-cand-002374 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002374`
- External reference / 外部参照: `obimd-sub-s1pxf3rg0q`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020445_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/s1pxf3rg0q/s1pxf3rg0q/s1pxf3rg0q.png`
- Checksum / 校验和:
  `afa58ee8f28446ba2fb8c6dafc575afd794cb1c49d56723e74afe16dd003bccd`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.78%.
- Marked-pixel bounds: (51,52)–(198,189); span 148 × 138 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.78%。
- 痕迹范围：(51,52)–(198,189)；跨度148 × 138 px；痕迹矩形近方形。
