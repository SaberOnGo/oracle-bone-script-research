# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002193
...
- EVOBC candidate category: `evobc-evo-cat-02193`.
- Source label for search only: `婏`.
- Source codepoints for search only: `U+5A4F`.
