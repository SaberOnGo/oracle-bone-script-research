...
- External category reference: `evobc-cat-11354`
- Source category ID: `11354`
- Source label for human review: `𢿃`
- Source codepoints: `U+22FC3`
...
- `obs-evo-cand-011354-route-category-staging`
...
- `obs-evo-cand-011354-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011354-route-evolution-graph`
