...
- External category reference: `evobc-cat-08835`
- Source category ID: `08835`
- Source label for human review: `輓`
- Source codepoints: `U+8F13`
...
- `obs-evo-cand-008835-route-category-staging`
...
- `obs-evo-cand-008835-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008835-route-evolution-graph`
