...
- External category reference: `evobc-cat-04575`
- Source category ID: `04575`
- Source label for human review: `泌`
...
- `obs-evo-cand-004575-route-category-staging`
...
- `obs-evo-cand-004575-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004575-route-evolution-graph`
