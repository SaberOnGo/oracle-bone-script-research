...
- External category reference: `evobc-cat-09474`
- Source category ID: `09474`
- Source label for human review: `鎌`
...
- `obs-evo-cand-009474-route-category-staging`
...
- `obs-evo-cand-009474-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009474-route-evolution-graph`
