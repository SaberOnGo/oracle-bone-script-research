...
Project ID: `obs-evo-cand-011671`
...
- Project ID: `obs-evo-cand-011671`
- EVOBC category candidate ID: `evobc-evo-cat-11671`
- External category reference: `evobc-cat-11671`
- Source category ID: `11671`
- Source label for human review: `𤴖`
- Source codepoints: `U+24D16`
...
- `obs-evo-cand-011671-route-category-staging`
...
- `obs-evo-cand-011671-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011671-route-evolution-graph`
