...
- Project ID: `obs-evo-cand-006280`
- EVOBC category candidate ID: `evobc-evo-cat-06280`
- External category reference: `evobc-cat-06280`
- Source category ID: `06280`
- Source label for human review: `筹`
- Source codepoints: `U+7B79`
...
- `obs-evo-cand-006280-route-category-staging`
...
- `obs-evo-cand-006280-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006280-route-evolution-graph`
