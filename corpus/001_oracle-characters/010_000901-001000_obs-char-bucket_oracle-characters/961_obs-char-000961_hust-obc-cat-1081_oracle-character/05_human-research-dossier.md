# obs-char-000961 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000961`
- primary external id: `hust-obc-cat-1081`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/961_obs-char-000961_hust-obc-cat-1081_orac
  le-character/03_visual-assets/001_asset-000966_hust-obc-cat-1081_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1081/G_1081_乙3282合14127賓組.png`
- asset id: `asset-000966`
...
- source category: `1081`
- validation class: `960`
- source image route: `HUST-OBC/deciphered/1081/G_1081_乙3282合14127賓組.png`
- asset id: `asset-000966`
...
- English observation: `A central Y-shaped branching form rises from a long
  horizontal base stroke.`
- 中文观察: `中央 Y 形分枝形体从长横向底笔上方伸起。`
...
- dataset label text: `㠯`
- dataset label codepoints: `U+382F`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00089`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00089`
- EvoBC image reference count / EvoBC 图像引用数: `147`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00089`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/089_obs-evo-can
  d-000089_evobc-cat-00089_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/089_obs-evo-cand-000089_evobc-cat-00089_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合14127
  (G_1081_乙3282合14127賓組.png)`
...
- Which source records identify obs-char-000961 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000961？
