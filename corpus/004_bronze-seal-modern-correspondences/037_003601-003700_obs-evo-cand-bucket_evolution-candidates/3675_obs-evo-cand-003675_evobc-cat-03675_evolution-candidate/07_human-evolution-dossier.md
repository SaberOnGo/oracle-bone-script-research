...
- External category reference: `evobc-cat-03675`
- Source category ID: `03675`
- Source label for human review: `旚`
- Source codepoints: `U+65DA`
...
- `obs-evo-cand-003675-route-category-staging`
...
- `obs-evo-cand-003675-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003675-route-evolution-graph`
