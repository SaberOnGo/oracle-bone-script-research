# obs-comp-cand-002138 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002138`
- 首选外部 ID: `obimd-sub-gtjlzc5fyr`
- OBIMD subcharacter UID: `gtjlzc5fyr`
- OBIMD main character UID: `gtjlzc5fyr`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+ADAC2;U+FC53D; U+FC53E; 另有 3 项
