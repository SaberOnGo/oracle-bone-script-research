...
- `obs-evo-cand-008747-route-category-staging`
...
- `obs-evo-cand-008747-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008747-route-evolution-graph`
