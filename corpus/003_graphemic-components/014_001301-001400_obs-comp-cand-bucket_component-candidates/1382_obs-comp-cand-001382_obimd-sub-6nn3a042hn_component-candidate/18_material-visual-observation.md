# Material Visual Observation / obs-comp-cand-001382 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001382`
- External reference / 外部参照: `obimd-sub-6nn3a042hn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015801_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6nn3a042hn/6nn3a042hn/6nn3a042hn.png`
- Checksum / 校验和:
  `d78b982120dacb5f849e1030c3bdc03802b5d792a29fd4e41216c397c9b32cf8`
...
- Marked-pixel bounds: (82,40)–(167,201); span 86 × 162 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.08%。
- 痕迹范围：(82,40)–(167,201)；跨度86 × 162 px；痕迹矩形高于宽。
