# Human Research Readiness Review / 正式研究准备复核: obs-evo-cand-011117

English:
This readiness review lists the evidence that must be opened before formal
paleographic, evolution, or correspondence research begins. It keeps source
routes, missing evidence, and candidate labels visible without promoting them
into conclusions.

Simplified Chinese:
本页列出正式古文字、字形演化或对应研究开始前必须打开的证据。它只保留来源路线、缺失证据和候选标签，不把它们提升为研究结论。

## Source Trail Before Research

- Open `02_evolution-source-index.csv` for `src-evobc` routes.
...
- Rights status remains `source_marked_risk_noted` until separately reviewed.
...
- Confirm `4` image route rows are only routes.
...
- Source label for lookup only: `𡹆`.
- Source codepoints for lookup only: `U+21E46`.
- Era/source code rows to open: `2`.
...
- 哪条甲骨图像、拓片、图版或卜辞证据已打开？
- 哪条金文、小篆或今字来源能支持对照？
- 哪份 manifest、checksum、字段映射、权利说明和风险提示需先核对？
