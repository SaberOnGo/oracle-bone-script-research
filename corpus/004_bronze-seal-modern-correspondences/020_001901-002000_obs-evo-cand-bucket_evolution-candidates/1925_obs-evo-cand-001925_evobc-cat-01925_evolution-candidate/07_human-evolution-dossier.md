...
- External category reference: `evobc-cat-01925`
- Source category ID: `01925`
- Source label for human review: `填`
...
- `obs-evo-cand-001925-route-category-staging`
...
- `obs-evo-cand-001925-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001925-route-evolution-graph`
