...
- Project ID: `obs-evo-cand-012676`
- EVOBC category candidate ID: `evobc-evo-cat-12676`
- External category reference: `evobc-cat-12676`
- Source category ID: `12676`
- Source label for human review: `𩬽`
- Source codepoints: `U+29B3D`
...
- `obs-evo-cand-012676-route-category-staging`
...
- `obs-evo-cand-012676-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012676-route-evolution-graph`
