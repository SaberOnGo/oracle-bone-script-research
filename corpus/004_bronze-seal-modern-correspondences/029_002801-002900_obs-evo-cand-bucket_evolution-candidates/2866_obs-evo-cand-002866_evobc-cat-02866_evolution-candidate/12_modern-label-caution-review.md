# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002866
...
- EVOBC candidate category: `evobc-evo-cat-02866`.
- Source label for search only: `律`.
- Source codepoints for search only: `U+5F8B`.
