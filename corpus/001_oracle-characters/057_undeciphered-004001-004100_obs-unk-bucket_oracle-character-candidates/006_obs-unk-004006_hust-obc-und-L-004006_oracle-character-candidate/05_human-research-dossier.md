# obs-unk-004006 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/006_obs-unk-004006_h
  ust-obc-und-L-004006_oracle-character-candidate/03_visual-assets/001_asset
  -005599_hust-obc-und-L-004006_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4006/L_？_8496.jpg`
- asset id: `asset-005599`
...
- source class: `HUST-OBC/undeciphered/L/4006/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4006/L_？_8496.jpg`
- asset id: `asset-005599`
...
- English observation: Two rounded enclosed traces appear above a lower
  angular band; the lower point is broad.
- 中文观察：上部可见两个圆弧状围合痕迹，下方有较宽的角状痕迹带。
...
- Which source records identify obs-unk-004006 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004006？
