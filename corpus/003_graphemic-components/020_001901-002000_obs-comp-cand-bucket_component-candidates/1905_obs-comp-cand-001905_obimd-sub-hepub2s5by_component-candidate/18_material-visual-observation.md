# Material Visual Observation / obs-comp-cand-001905 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001905`
- External reference / 外部参照: `obimd-sub-hepub2s5by`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018315_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h16yr7furr/hepub2s5by/hepub2s5by.png`
- Checksum / 校验和:
  `bb7cc392d521e02e614af8e3871da4ad6f534e9b55625c177a5599ac2a56c10d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.52%.
- Marked-pixel bounds: (39,44)–(216,215); span 178 × 172 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.52%。
- 痕迹范围：(39,44)–(216,215)；跨度178 × 172 px；痕迹矩形近方形。
