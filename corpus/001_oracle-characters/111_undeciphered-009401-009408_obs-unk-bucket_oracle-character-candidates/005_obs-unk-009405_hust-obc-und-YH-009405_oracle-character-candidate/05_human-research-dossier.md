# obs-unk-009405 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-009405`
- primary external id: `hust-obc-und-YH-009405`
...
- local review image route: `corpus/001_oracle-characters/111_undeciphered-009
  401-009408_obs-unk-bucket_oracle-character-candidates/005_obs-unk-009405_h
  ust-obc-und-YH-009405_oracle-character-candidate/03_visual-assets/001_asse
  t-010996_hust-obc-und-YH-009405_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/618EC/Y_？_618EC.jpg`
- asset id: `asset-010996`
...
- source class: `HUST-OBC/undeciphered/Y+H/618EC/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/618EC/Y_？_618EC.jpg`
- asset id: `asset-010996`
...
- Which source records identify obs-unk-009405 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009405？
