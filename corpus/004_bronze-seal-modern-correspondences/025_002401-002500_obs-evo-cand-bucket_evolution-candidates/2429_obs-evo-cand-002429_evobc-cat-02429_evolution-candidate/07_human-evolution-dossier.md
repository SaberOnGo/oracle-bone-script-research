...
- External category reference: `evobc-cat-02429`
- Source category ID: `02429`
- Source label for human review: `察`
- Source codepoints: `U+5BDF`
...
- `obs-evo-cand-002429-route-category-staging`
...
- `obs-evo-cand-002429-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002429-route-evolution-graph`
