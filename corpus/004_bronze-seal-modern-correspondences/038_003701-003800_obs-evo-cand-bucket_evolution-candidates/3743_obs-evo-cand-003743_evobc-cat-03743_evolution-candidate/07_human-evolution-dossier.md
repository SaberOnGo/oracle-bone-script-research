...
- Project ID: `obs-evo-cand-003743`
- EVOBC category candidate ID: `evobc-evo-cat-03743`
- External category reference: `evobc-cat-03743`
- Source category ID: `03743`
- Source label for human review: `晕`
- Source codepoints: `U+6655`
...
- `obs-evo-cand-003743-route-category-staging`
...
- `obs-evo-cand-003743-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003743-route-evolution-graph`
