# obs-evo-cand-002777 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-02777`
- Source label: `廷`
- Source codepoints: `U+5EF7`
- Image reference count: `162`
- Era token counts: `BI:89;CS:1;SAC:5;SS:2;WSC:65`
- Source token counts: `Book:74;Web:88`

## Observed Code Rows / 观察到的代码行

- era 1 / BI: 89 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 5 image references
- era 4 / WSC: 65 image references
- era 5 / CS: 1 image references
- source 1 / Web:105952;說文Web:58: 88 image references
- source 3 / Book:21681: 54 image references
