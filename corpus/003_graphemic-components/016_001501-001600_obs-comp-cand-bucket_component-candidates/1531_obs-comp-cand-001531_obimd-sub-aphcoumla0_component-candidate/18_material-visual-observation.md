# Material Visual Observation / obs-comp-cand-001531 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001531`
- External reference / 外部参照: `obimd-sub-aphcoumla0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016945_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/aphcoumla0/aphcoumla0/aphcoumla0.png`
- Checksum / 校验和:
  `16418cd8c78d86943aedaf54973f1f17960b9730b1cd1f75f2aa3168491251b7`
...
- Marked-pixel bounds: (71,47)–(178,199); span 108 × 153 px; the marked
...
- 痕迹范围：(71,47)–(178,199)；跨度108 × 153 px；痕迹矩形高于宽。
