# obs-char-000891 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/891_obs-char-000891_hust-obc-cat-1003_orac
  le-character/03_visual-assets/001_asset-000896_hust-obc-cat-1003_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1003/X_1003_5154_1.png`
- asset id: `asset-000896`
...
- source category: `1003`
- validation class: `890`
- source image route: `HUST-OBC/deciphered/1003/X_1003_5154_1.png`
- asset id: `asset-000896`
...
- English observation: `Two stacked rounded forms with jagged upper edges
  sit beside a long curved outer stroke; their openings remain distinct.`
- 中文观察: `两个上缘锯齿状的叠置圆弧形体位于长弯曲外笔旁；各自开口保持清楚。`
...
- dataset label text: `㟡`
- dataset label codepoints: `U+37E1`
...
- Which source records identify obs-char-000891 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000891？
