...
- External category reference: `evobc-cat-00355`
- Source category ID: `00355`
- Source label for human review: `䏤`
...
- `obs-evo-cand-000355-route-category-staging`
...
- `obs-evo-cand-000355-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000355-route-evolution-graph`
