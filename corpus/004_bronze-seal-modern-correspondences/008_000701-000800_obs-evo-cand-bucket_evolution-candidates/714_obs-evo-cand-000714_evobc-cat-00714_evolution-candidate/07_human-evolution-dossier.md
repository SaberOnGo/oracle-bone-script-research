...
- External category reference: `evobc-cat-00714`
- Source category ID: `00714`
- Source label: `亵`
...
- `obs-evo-cand-000714-route-category-staging`
...
- `obs-evo-cand-000714-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-000714-route-evolution-graph`
