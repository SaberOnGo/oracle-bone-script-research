# obs-evo-cand-008600 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-008600`
- EVOBC category candidate ID: `evobc-evo-cat-08600`
- External category ref: `evobc-cat-08600`
- Source label: `賽`
- Source codepoints: `U+8CFD`
- Image reference count: `80`
- Era token counts: `SS:2;WSC:78`
- Source token counts: `Book:12;Web:68`

## Observed Code Rows / 观察到的代码行

- era 2 / SS: 2 image references
- era 4 / WSC: 78 image references
- source 1 / Web:105952;說文Web:58: 68 image references
