...
- External category reference: `evobc-cat-10426`
- Source category ID: `10426`
- Source label for human review: `鰈`
...
- `obs-evo-cand-010426-route-category-staging`
...
- `obs-evo-cand-010426-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010426-route-evolution-graph`
