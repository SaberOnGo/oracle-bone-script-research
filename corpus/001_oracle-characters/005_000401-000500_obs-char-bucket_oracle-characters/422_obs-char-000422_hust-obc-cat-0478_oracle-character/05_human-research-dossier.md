# obs-char-000422 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/422_obs-char-000422_hust-obc-cat-0478_orac
  le-character/03_visual-assets/001_asset-000427_hust-obc-cat-0478_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0478/G_0478_前1.25.3.png`
- asset id: `asset-000427`
...
- source category: `0478`
- validation class: `421`
- source image route: `HUST-OBC/deciphered/0478/G_0478_前1.25.3.png`
- asset id: `asset-000427`
...
- English observation: `The small image shows two narrow upright forms and a
  detached short horizontal stroke near the lower left; fine strokes are
  difficult to resolve.`
- 中文观察: `小图中可见两个狭长直立形体，左下另有一短横；细笔画因分辨率较低而难以辨清。`
...
- dataset label text: `㗔`
- dataset label codepoints: `U+35D4`
...
- Which source records identify obs-char-000422 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000422？
