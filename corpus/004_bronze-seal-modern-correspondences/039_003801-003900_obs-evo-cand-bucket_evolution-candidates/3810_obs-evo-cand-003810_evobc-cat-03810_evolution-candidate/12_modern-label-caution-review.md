# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003810
...
- EVOBC candidate category: `evobc-evo-cat-03810`.
- Source label for search only: `曰`.
- Source codepoints for search only: `U+66F0`.
