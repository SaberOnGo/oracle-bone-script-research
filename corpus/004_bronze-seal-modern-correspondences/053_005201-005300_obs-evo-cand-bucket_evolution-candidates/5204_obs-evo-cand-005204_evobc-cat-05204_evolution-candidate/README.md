# obs-evo-cand-005204 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-05204`
- Source label for human review: `牜`
- Source codepoints: `U+725C`
- Image reference count: `49`
- Era token counts: `BI:9;WSC:40`
- Source token counts: `Book:1;Web:48`
