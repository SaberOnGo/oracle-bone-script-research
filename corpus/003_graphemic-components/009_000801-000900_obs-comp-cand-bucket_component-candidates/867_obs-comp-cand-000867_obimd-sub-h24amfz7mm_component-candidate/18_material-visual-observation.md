# Material Visual Observation / obs-comp-cand-000867 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000867`
- External reference / 外部参照: `obimd-sub-h24amfz7mm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013864_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h24amfz7mm/h24amfz7mm/h24amfz7mm.png`
- Checksum / 校验和:
  `43ae3aa4743ed54325ff4957fd031e581f74d71223c6d45c207dadbde64fbcb9`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.42%.
- Marked-pixel bounds: (63,34)–(197,215); span 135 × 182 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.42%。
- 痕迹范围：(63,34)–(197,215)；跨度135 × 182 px；痕迹矩形高于宽。
