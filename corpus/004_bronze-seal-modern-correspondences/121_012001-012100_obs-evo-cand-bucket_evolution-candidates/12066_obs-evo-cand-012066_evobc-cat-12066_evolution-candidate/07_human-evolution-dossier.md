...
- External category reference: `evobc-cat-12066`
- Source category ID: `12066`
- Source label for human review: `𦣝`
- Source codepoints: `U+268DD`
...
- `obs-evo-cand-012066-route-category-staging`
...
- `obs-evo-cand-012066-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012066-route-evolution-graph`
