...
- External category reference: `evobc-cat-05940`
- Source category ID: `05940`
- Source label for human review: `磕`
- Source codepoints: `U+78D5`
...
- `obs-evo-cand-005940-route-category-staging`
...
- `obs-evo-cand-005940-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005940-route-evolution-graph`
