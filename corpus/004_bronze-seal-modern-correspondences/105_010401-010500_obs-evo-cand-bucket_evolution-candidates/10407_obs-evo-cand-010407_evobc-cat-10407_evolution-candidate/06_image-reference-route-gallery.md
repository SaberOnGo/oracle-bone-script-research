...
- `obs-evo-cand-010407-route-category-staging`
...
- `obs-evo-cand-010407-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010407-route-evolution-graph`
