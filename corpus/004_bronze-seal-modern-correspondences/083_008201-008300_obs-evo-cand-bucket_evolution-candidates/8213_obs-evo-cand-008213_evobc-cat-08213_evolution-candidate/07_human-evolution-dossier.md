...
- External category reference: `evobc-cat-08213`
- Source category ID: `08213`
- Source label for human review: `誂`
...
- `obs-evo-cand-008213-route-category-staging`
...
- `obs-evo-cand-008213-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008213-route-evolution-graph`
