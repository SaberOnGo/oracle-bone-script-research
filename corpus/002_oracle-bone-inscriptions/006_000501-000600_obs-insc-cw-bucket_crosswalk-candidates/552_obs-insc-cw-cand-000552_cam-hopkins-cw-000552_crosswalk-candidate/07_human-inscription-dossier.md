...
- Yingguo / 英国所藏: `y2560` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `360` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `689` in source row; primary catalog entry pending
