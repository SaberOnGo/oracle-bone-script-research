# obs-unk-005821 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005821`
- primary external id: `hust-obc-und-X-005821`
...
- local review image route: `corpus/001_oracle-characters/075_undeciphered-005
  801-005900_obs-unk-bucket_oracle-character-candidates/021_obs-unk-005821_h
  ust-obc-und-X-005821_oracle-character-candidate/03_visual-assets/001_asset
  -007413_hust-obc-und-X-005821_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1377/X_？_1908_1.png`
- asset id: `asset-007413`
...
- source class: `HUST-OBC/undeciphered/X/1377/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1377/X_？_1908_1.png`
- asset id: `asset-007413`
...
- Which source records identify obs-unk-005821 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005821？
