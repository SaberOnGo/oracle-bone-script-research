# Material Visual Observation / obs-comp-cand-002743 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002743`
- External reference / 外部参照: `obimd-sub-x8esaf2cwr`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021359_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/x8esaf2cwr/x8esaf2cwr/x8esaf2cwr.png`
- Checksum / 校验和:
  `c776d41587db9fb34383fa8cde9ede72fe32402a13c0f928edfc96348900fab5`
...
- Marked-pixel bounds: (42,43)–(207,199); span 166 × 157 px; the marked
...
- 痕迹范围：(42,43)–(207,199)；跨度166 × 157 px；痕迹矩形近方形。
