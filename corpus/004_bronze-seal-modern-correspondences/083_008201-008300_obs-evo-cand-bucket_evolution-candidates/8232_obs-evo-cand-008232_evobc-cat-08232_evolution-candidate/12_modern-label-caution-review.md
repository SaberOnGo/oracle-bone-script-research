# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008232
...
- EVOBC candidate category: `evobc-evo-cat-08232`.
- Source label for search only: `誚`.
- Source codepoints for search only: `U+8A9A`.
