...
Project ID: `obs-evo-cand-002475`
...
- Project ID: `obs-evo-cand-002475`
- EVOBC category candidate ID: `evobc-evo-cat-02475`
- External category reference: `evobc-cat-02475`
- Source category ID: `02475`
- Source label for human review: `尝`
- Source codepoints: `U+5C1D`
...
- `obs-evo-cand-002475-route-category-staging`
...
- `obs-evo-cand-002475-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002475-route-evolution-graph`
