# obs-evo-cand-002336 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-02336`
- Source label: `孝`
- Source codepoints: `U+5B5D`
- Image reference count: `172`
- Era token counts: `BI:111;CS:3;SAC:17;SS:2;WSC:39`
- Source token counts: `Book:99;Web:73`

## Observed Code Rows / 观察到的代码行

- era 1 / BI: 111 image references
