...
Project ID: `obs-evo-cand-004639`
...
- Project ID: `obs-evo-cand-004639`
- EVOBC category candidate ID: `evobc-evo-cat-04639`
- External category reference: `evobc-cat-04639`
- Source category ID: `04639`
- Source label for human review: `洵`
- Source codepoints: `U+6D35`
...
- `obs-evo-cand-004639-route-category-staging`
...
- `obs-evo-cand-004639-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004639-route-evolution-graph`
