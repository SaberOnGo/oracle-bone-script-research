...
- External category reference: `evobc-cat-02621`
- Source category ID: `02621`
- Source label for human review: `巩`
- Source codepoints: `U+5DE9`
...
- `obs-evo-cand-002621-route-category-staging`
...
- `obs-evo-cand-002621-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002621-route-evolution-graph`
