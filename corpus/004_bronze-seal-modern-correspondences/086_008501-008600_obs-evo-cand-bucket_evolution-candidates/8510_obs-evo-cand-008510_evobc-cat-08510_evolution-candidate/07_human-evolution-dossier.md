...
- External category reference: `evobc-cat-08510`
- Source category ID: `08510`
- Source label for human review: `豹`
...
- `obs-evo-cand-008510-route-category-staging`
...
- `obs-evo-cand-008510-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008510-route-evolution-graph`
