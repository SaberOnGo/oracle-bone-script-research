# Material Visual Observation / obs-comp-cand-000073 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000073`
- External reference / 外部参照: `obimd-sub-t4tioxlhov`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011485_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/t4tioxlhov/t4tioxlhov/t4tioxlhov.png`
- Checksum / 校验和:
  `981af5b5b81264928ed6add247caebf216186b79f7c35cbc39468378a728dfe2`
...
- Marked-pixel bounds: (68,23)–(181,224); span 114 × 202 px; the marked
...
- 痕迹范围：(68,23)–(181,224)；跨度114 × 202 px；痕迹矩形高于宽。
