...
- External category reference: `evobc-cat-11438`
- Source category ID: `11438`
- Source label for human review: `𣓆`
...
- `obs-evo-cand-011438-route-category-staging`
...
- `obs-evo-cand-011438-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011438-route-evolution-graph`
