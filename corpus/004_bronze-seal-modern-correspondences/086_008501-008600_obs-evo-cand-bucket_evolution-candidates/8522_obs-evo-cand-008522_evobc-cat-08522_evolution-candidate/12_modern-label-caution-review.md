# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008522
...
- EVOBC candidate category: `evobc-evo-cat-08522`.
- Source label for search only: `貍`.
- Source codepoints for search only: `U+8C8D`.
