# Material Visual Observation / obs-comp-cand-000022 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000022`
- External reference / 外部参照: `obimd-sub-vbkc7p8qc9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011174_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vbkc7p8qc9/vbkc7p8qc9/vbkc7p8qc9.png`
- Checksum / 校验和:
  `5589a11c785b4810aeae37dc6af1c553a2ea4c946d4e7808fc989b3dda428423`
...
- Marked-pixel bounds: (61,15)–(186,233); span 126 × 219 px; the marked
...
- 痕迹范围：(61,15)–(186,233)；跨度126 × 219 px；痕迹矩形高于宽。
