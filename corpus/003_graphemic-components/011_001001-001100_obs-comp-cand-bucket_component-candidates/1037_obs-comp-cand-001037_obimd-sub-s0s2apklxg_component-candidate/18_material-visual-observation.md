# Material Visual Observation / obs-comp-cand-001037 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001037`
- External reference / 外部参照: `obimd-sub-s0s2apklxg`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014530_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/mxjh9h64im/s0s2apklxg/s0s2apklxg.png`
- Checksum / 校验和:
  `c9e2fdcdbe1a7f6d6c2cf5a128899e541e538fa356cbab1f555bfffee1559226`
...
- Marked-pixel bounds: (70,44)–(179,206); span 110 × 163 px; the marked
...
- 痕迹范围：(70,44)–(179,206)；跨度110 × 163 px；痕迹矩形高于宽。
