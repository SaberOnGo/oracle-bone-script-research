...
- `obs-evo-cand-006612-route-category-staging`
...
- `obs-evo-cand-006612-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006612-route-evolution-graph`
