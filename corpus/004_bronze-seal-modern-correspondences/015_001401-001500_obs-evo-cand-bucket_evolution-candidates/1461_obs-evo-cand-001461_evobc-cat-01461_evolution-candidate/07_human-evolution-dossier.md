...
Project ID: `obs-evo-cand-001461`
...
- Project ID: `obs-evo-cand-001461`
- EVOBC category candidate ID: `evobc-evo-cat-01461`
- External category reference: `evobc-cat-01461`
- Source category ID: `01461`
- Source label for human review: `受`
- Source codepoints: `U+53D7`
- Image reference count in source metadata: `372`
...
- `obs-evo-cand-001461-route-category-staging`
...
- `obs-evo-cand-001461-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001461-route-evolution-graph`
