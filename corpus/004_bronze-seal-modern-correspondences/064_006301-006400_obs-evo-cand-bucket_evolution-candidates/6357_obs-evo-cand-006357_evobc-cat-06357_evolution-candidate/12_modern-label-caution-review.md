# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006357
...
- EVOBC candidate category: `evobc-evo-cat-06357`.
- Source label for search only: `簫`.
- Source codepoints for search only: `U+7C2B`.
