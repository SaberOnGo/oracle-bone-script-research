# obs-char-000119 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/119_obs-char-000119_hust-obc-cat-0133_orac
  le-character/03_visual-assets/001_asset-000124_hust-obc-cat-0133_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0133/H_0133_607D1_0.png`
- asset id: `asset-000124`
...
- source category: `0133`
- validation class: `118`
- source image route: `HUST-OBC/deciphered/0133/H_0133_607D1_0.png`
- asset id: `asset-000124`
...
- English observation: `The tall dark image has a broad top bar, diagonal
  strokes converging at the center, a long lower vertical, and crossing
  lower projections.`
- 中文观察: `高而深色的图像上方有宽横笔，斜向笔画在中部汇合，下方有长竖笔和交叉伸出笔。`
...
- dataset label text: `㑻`
- dataset label codepoints: `U+347B`
...
- filename catalog route clues: `catalog-like filename clue: H_0133
  (H_0133_607D1_0.png)`
...
- Which source records identify obs-char-000119 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000119？
