# obs-char-001126 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1126_obs-char-001126_hust-obc-cat-1257_ora
  cle-character/03_visual-assets/001_asset-001131_hust-obc-cat-1257_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1257/G_1257_京都2142合27972無名組.png
  `
- asset id: `asset-001131`
...
- source category: `1257`
- validation class: `1125`
- source image route: `HUST-OBC/deciphered/1257/G_1257_京都2142合27972無名組.png`
- asset id: `asset-001131`
...
- English observation: `A dense upright cluster has a pointed upper
  projection, several short leftward branches, and a long central lower
  stroke.`
...
- dataset label text: `㣟`
- dataset label codepoints: `U+38DF`
...
- Which source records identify obs-char-001126 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001126？
