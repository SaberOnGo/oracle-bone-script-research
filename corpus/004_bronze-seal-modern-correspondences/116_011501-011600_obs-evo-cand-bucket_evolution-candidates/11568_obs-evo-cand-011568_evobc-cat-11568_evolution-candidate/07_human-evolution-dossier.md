...
- External category reference: `evobc-cat-11568`
- Source category ID: `11568`
- Source label for human review: `𤌤`
- Source codepoints: `U+24324`
...
- `obs-evo-cand-011568-route-category-staging`
...
- `obs-evo-cand-011568-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011568-route-evolution-graph`
