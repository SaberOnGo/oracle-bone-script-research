...
- External category reference: `evobc-cat-00212`
- Source category ID: `00212`
- Source label for human review: `㴩`
...
- `obs-evo-cand-000212-route-category-staging`
...
- `obs-evo-cand-000212-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000212-route-evolution-graph`
