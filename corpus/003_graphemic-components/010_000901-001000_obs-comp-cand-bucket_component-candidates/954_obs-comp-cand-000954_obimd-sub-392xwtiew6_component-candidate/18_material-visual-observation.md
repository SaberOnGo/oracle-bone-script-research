# Material Visual Observation / obs-comp-cand-000954 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000954`
- External reference / 外部参照: `obimd-sub-392xwtiew6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014037_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xblum49kus/392xwtiew6/392xwtiew6.png`
- Checksum / 校验和:
  `e771745ae607f507f89fa8b5abd79aa4c62ea674545e04a3dd24355f89511bc8`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.59%.
- Marked-pixel bounds: (61,41)–(188,217); span 128 × 177 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.59%。
- 痕迹范围：(61,41)–(188,217)；跨度128 × 177 px；痕迹矩形高于宽。
