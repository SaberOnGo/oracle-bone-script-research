# Material Visual Observation / obs-comp-cand-001259 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001259`
- External reference / 外部参照: `obimd-sub-l12a906yri`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015497_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/l12a906yri/l12a906yri/l12a906yri.png`
- Checksum / 校验和:
  `d3e0a2f772c77c04e541f7dc5fffc976313262255dab42eb0a6f92761f9e8278`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.10%.
- Marked-pixel bounds: (77,24)–(178,223); span 102 × 200 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.10%。
- 痕迹范围：(77,24)–(178,223)；跨度102 × 200 px；痕迹矩形高于宽。
