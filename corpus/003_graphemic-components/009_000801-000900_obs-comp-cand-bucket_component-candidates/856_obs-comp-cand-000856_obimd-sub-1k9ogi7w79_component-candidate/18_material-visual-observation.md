# Material Visual Observation / obs-comp-cand-000856 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000856`
- External reference / 外部参照: `obimd-sub-1k9ogi7w79`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013854_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1k9ogi7w79/1k9ogi7w79/1k9ogi7w79.png`
- Checksum / 校验和:
  `c011b7d93e142cf6e1cd8b5f52c0401486508f0708a45fead2a7697f637658de`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.61%.
- Marked-pixel bounds: (65,18)–(184,230); span 120 × 213 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.61%。
- 痕迹范围：(65,18)–(184,230)；跨度120 × 213 px；痕迹矩形高于宽。
