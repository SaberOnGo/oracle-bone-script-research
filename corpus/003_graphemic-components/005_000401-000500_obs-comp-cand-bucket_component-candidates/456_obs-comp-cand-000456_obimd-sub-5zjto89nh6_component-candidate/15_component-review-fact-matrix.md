# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000456
...
| Glyph or codepoint route / 字形或码位路线 | 8 OBIMD route rows; examples U+7126;U+244EA;U+C9B7F;U+F2B4A; U+F2B4B; 另有 6 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
