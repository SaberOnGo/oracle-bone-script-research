# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006503
...
- EVOBC candidate category: `evobc-evo-cat-06503`.
- Source label for search only: `絖`.
- Source codepoints for search only: `U+7D56`.
