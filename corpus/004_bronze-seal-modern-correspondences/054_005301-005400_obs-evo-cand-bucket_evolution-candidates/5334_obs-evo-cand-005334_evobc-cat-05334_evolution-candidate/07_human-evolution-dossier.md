...
Project ID: `obs-evo-cand-005334`
...
- Project ID: `obs-evo-cand-005334`
- EVOBC category candidate ID: `evobc-evo-cat-05334`
- External category reference: `evobc-cat-05334`
- Source category ID: `05334`
- Source label for human review: `獸`
- Source codepoints: `U+7378`
...
- `obs-evo-cand-005334-route-category-staging`
...
- `obs-evo-cand-005334-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005334-route-evolution-graph`
