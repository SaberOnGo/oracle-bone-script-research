...
Project ID: `obs-evo-cand-004458`
...
- Project ID: `obs-evo-cand-004458`
- EVOBC category candidate ID: `evobc-evo-cat-04458`
- External category reference: `evobc-cat-04458`
- Source category ID: `04458`
- Source label for human review: `毨`
- Source codepoints: `U+6BE8`
...
- `obs-evo-cand-004458-route-category-staging`
...
- `obs-evo-cand-004458-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004458-route-evolution-graph`
