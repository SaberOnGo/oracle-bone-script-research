...
- External category reference: `evobc-cat-06278`
- Source category ID: `06278`
- Source label for human review: `筳`
- Source codepoints: `U+7B73`
...
- `obs-evo-cand-006278-route-category-staging`
...
- `obs-evo-cand-006278-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006278-route-evolution-graph`
