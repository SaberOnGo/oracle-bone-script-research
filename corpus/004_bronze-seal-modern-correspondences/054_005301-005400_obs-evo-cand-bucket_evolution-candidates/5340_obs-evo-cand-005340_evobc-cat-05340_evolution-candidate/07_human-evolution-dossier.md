...
- External category reference: `evobc-cat-05340`
- Source category ID: `05340`
- Source label for human review: `玅`
...
- `obs-evo-cand-005340-route-category-staging`
...
- `obs-evo-cand-005340-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005340-route-evolution-graph`
