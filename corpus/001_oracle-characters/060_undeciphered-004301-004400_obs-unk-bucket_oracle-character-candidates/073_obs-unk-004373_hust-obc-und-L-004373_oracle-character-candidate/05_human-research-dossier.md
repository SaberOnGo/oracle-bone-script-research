# obs-unk-004373 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/073_obs-unk-004373_h
  ust-obc-und-L-004373_oracle-character-candidate/03_visual-assets/001_asset
  -005966_hust-obc-und-L-004373_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4373/L_？_9701.jpg`
- asset id: `asset-005966`
...
- source class: `HUST-OBC/undeciphered/L/4373/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4373/L_？_9701.jpg`
- asset id: `asset-005966`
...
- English observation: `Upper mark, middle cluster, and lower curve recorded.`
- 中文观察: `已记录上部痕、中央痕簇和下部弧线。`
...
- Which source records identify obs-unk-004373 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004373？
