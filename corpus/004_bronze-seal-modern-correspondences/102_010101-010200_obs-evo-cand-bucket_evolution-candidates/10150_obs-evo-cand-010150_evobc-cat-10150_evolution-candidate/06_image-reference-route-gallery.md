...
- `obs-evo-cand-010150-route-category-staging`
...
- `obs-evo-cand-010150-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010150-route-evolution-graph`
