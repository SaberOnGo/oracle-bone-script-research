...
- External category reference: `evobc-cat-10814`
- Source category ID: `10814`
- Source label for human review: `𠍵`
...
- `obs-evo-cand-010814-route-category-staging`
...
- `obs-evo-cand-010814-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010814-route-evolution-graph`
