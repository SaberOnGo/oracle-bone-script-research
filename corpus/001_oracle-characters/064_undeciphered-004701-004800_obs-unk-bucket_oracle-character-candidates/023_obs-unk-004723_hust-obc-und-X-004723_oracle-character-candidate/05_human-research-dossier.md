# obs-unk-004723 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004723`
- primary external id: `hust-obc-und-X-004723`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/023_obs-unk-004723_h
  ust-obc-und-X-004723_oracle-character-candidate/03_visual-assets/001_asset
  -006316_hust-obc-und-X-004723_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/279/X_？_7259_1.png`
- asset id: `asset-006316`
...
- source class: `HUST-OBC/undeciphered/X/279/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/279/X_？_7259_1.png`
- asset id: `asset-006316`
...
- English observation: `branching junction with lower curved stroke`
- 中文观察: `带下部弯曲笔画的分支连接处`
...
- Which source records identify obs-unk-004723 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004723？
