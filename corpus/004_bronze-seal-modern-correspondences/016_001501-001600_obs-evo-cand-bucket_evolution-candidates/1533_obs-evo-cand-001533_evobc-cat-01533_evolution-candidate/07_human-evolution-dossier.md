...
- External category reference: `evobc-cat-01533`
- Source category ID: `01533`
- Source label for human review: `告`
- Source codepoints: `U+544A`
- Image reference count in source metadata: `243`
...
- `obs-evo-cand-001533-route-category-staging`
...
- `obs-evo-cand-001533-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001533-route-evolution-graph`
