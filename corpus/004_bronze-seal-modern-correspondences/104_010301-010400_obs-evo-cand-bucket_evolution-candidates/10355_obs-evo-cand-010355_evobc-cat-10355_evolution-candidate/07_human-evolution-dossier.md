...
- External category reference: `evobc-cat-10355`
- Source category ID: `10355`
- Source label for human review: `鬽`
...
- `obs-evo-cand-010355-route-category-staging`
...
- `obs-evo-cand-010355-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010355-route-evolution-graph`
