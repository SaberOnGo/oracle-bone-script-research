...
- External category reference: `evobc-cat-10390`
- Source category ID: `10390`
- Source label for human review: `鮐`
...
- `obs-evo-cand-010390-route-category-staging`
...
- `obs-evo-cand-010390-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010390-route-evolution-graph`
