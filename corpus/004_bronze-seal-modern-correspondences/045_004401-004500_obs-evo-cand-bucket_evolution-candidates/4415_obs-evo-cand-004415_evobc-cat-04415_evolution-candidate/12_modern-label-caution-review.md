# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004415
...
- EVOBC candidate category: `evobc-evo-cat-04415`.
- Source label for search only: `殜`.
- Source codepoints for search only: `U+6B9C`.
