# obs-evo-cand-002839 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-02839`
- Source label: `彝`
- Source codepoints: `U+5F5D`
- Image reference count: `634`
- Era token counts: `BI:510;OBC:91;SAC:22;SS:1;WSC:10`
- Source token counts: `Book:573;Web:61`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 91 image references
- era 1 / BI: 510 image references
- era 2 / SS: 1 image references
- era 3 / SAC: 22 image references
- era 4 / WSC: 10 image references
- source 0 / Web:1633: 2 image references
- source 1 / Web:105952;說文Web:58: 15 image references
- source 2 / Book:17600: 23 image references
- source 3 / Book:21681: 510 image references
- source 4 / Book:9131: 22 image references
