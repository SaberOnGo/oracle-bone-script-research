# obs-char-000971 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000971`
- primary external id: `hust-obc-cat-1091`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/971_obs-char-000971_hust-obc-cat-1091_orac
  le-character/03_visual-assets/001_asset-000976_hust-obc-cat-1091_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1091/G_1091_前2.38.1合36512黃組.png
  `
- asset id: `asset-000976`
...
- source category: `1091`
- validation class: `970`
- source image route: `HUST-OBC/deciphered/1091/G_1091_前2.38.1合36512黃組.png`
- asset id: `asset-000976`
...
- English observation: `Two thick upright strokes enclose a rounded lower
  curve, forming a compact bold cluster.`
- 中文观察: `两条粗重直立笔围合圆弧下弯笔，形成紧密粗重笔群。`
...
- dataset label text: `㠹`
- dataset label codepoints: `U+3839`
...
- filename catalog route clues: `Heji-like filename clue: 合36512
...
- Which source records identify obs-char-000971 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000971？
