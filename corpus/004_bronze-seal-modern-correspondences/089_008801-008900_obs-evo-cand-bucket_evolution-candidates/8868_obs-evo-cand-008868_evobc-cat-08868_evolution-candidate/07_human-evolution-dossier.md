...
- External category reference: `evobc-cat-08868`
- Source category ID: `08868`
- Source label: `轉`
...
- `obs-evo-cand-008868-route-category-staging`
...
- `obs-evo-cand-008868-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-008868-route-evolution-graph`
