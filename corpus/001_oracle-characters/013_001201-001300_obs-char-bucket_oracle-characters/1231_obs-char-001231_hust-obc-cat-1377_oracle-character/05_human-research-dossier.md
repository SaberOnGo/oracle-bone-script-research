# obs-char-001231 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001231`
- primary external id: `hust-obc-cat-1377`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1231_obs-char-001231_hust-obc-cat-1377_ora
  cle-character/03_visual-assets/001_asset-001236_hust-obc-cat-1377_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1377/G_1377_甲骨文0.png`
- asset id: `asset-001236`
...
- source category: `1377`
- validation class: `1230`
- source image route: `HUST-OBC/deciphered/1377/G_1377_甲骨文0.png`
- asset id: `asset-001236`
...
- English observation: `A small upright form has a rounded upper enclosure,
  a central vertical, and two long lower side strokes.`
- 中文观察: `小型直立形体有圆弧形上部框廓、中央竖笔和两条长下部侧笔。`
...
- dataset label text: `㥗`
- dataset label codepoints: `U+3957`
...
- Which source records identify obs-char-001231 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001231？
