# obs-char-000295 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000295`
- primary external id: `hust-obc-cat-0334`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/295_obs-char-000295_hust-obc-cat-0334_orac
  le-character/03_visual-assets/001_asset-000300_hust-obc-cat-0334_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0334/G_0334_京津2220(甲).png`
- asset id: `asset-000300`
...
- source category: `0334`
- validation class: `294`
- source image route: `HUST-OBC/deciphered/0334/G_0334_京津2220(甲).png`
- asset id: `asset-000300`
...
- English observation: `The dark image contains a slim central vertical
  cluster, short side bars, and several forked or crossing strokes toward
  the lower end.`
- 中文观察: `深色图像含纤细的中央竖向簇、短侧向横痕，以及下端附近数处分叉或交叉笔画。`
...
- dataset label text: `㕄`
- dataset label codepoints: `U+3544`
...
- Which source records identify obs-char-000295 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000295？
