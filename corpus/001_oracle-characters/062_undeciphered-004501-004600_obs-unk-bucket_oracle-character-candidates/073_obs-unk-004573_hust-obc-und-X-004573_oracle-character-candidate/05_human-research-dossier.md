# obs-unk-004573 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/073_obs-unk-004573_h
  ust-obc-und-X-004573_oracle-character-candidate/03_visual-assets/001_asset
  -006166_hust-obc-und-X-004573_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/129/X_？_8308_1.png`
- asset id: `asset-006166`
...
- source class: `HUST-OBC/undeciphered/X/129/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/129/X_？_8308_1.png`
- asset id: `asset-006166`
...
- English observation: `Tall point, right bar, open lower area, and tip`
  `recorded.`
- 中文观察: `已记录高尖痕、右侧横痕、下部开放区和尖端。`
...
- Which source records identify obs-unk-004573 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004573？
