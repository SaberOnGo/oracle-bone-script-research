# obs-unk-004550 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/050_obs-unk-004550_h
  ust-obc-und-X-004550_oracle-character-candidate/03_visual-assets/001_asset
  -006143_hust-obc-und-X-004550_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/106/X_？_8288_1.png`
- asset id: `asset-006143`
...
- source class: `HUST-OBC/undeciphered/X/106/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/106/X_？_8288_1.png`
- asset id: `asset-006143`
...
- English observation: `Upper enclosure, crossing, and lower traces recorded.`
- 中文观察: `已记录上部轮廓、交叉处和下部痕迹。`
...
- Which source records identify obs-unk-004550 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004550？
