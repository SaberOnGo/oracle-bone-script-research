...
Project ID: `obs-evo-cand-012169`
...
- Project ID: `obs-evo-cand-012169`
- EVOBC category candidate ID: `evobc-evo-cat-12169`
- External category reference: `evobc-cat-12169`
- Source category ID: `12169`
- Source label for human review: `𧒜`
- Source codepoints: `U+2749C`
...
- `obs-evo-cand-012169-route-category-staging`
...
- `obs-evo-cand-012169-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012169-route-evolution-graph`
