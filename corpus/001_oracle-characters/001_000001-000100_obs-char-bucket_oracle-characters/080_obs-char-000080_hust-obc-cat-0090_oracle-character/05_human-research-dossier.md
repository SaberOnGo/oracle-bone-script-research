# obs-char-000080 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000080`
- primary external id: `hust-obc-cat-0090`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/080_obs-char-000080_hust-obc-cat-0090_orac
  le-character/03_visual-assets/001_asset-000085_hust-obc-cat-0090_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0090/X_0090_4171_1.png`
- asset id: `asset-000085`
...
- source category: `0090`
- validation class: `79`
- source image route: `HUST-OBC/deciphered/0090/X_0090_4171_1.png`
- asset id: `asset-000085`
...
- English observation: `The large image has a thick upper horizontal cap, a
  long irregular descending stroke, and a diagonal branch on the lower
  left.`
- 中文观察: `大型图像上方有粗横向顶笔，中部有长而不规则的下行笔画，左下有斜向分支。`
...
- dataset label text: `㑐`
- dataset label codepoints: `U+3450`
...
- Which source records identify obs-char-000080 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000080？
