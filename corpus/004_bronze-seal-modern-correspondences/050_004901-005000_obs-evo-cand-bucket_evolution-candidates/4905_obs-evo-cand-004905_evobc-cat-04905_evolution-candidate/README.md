# obs-evo-cand-004905 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-004905`
- EVOBC category candidate ID: `evobc-evo-cat-04905`
- External category ref: `evobc-cat-04905`
- Source label: `潢`
- Source codepoints: `U+6F62`
- Image reference count: `21`
- Era token counts: `BI:2;OBC:18;SS:1`
- Source token counts: `Book:16;Web:5`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 18 image references
