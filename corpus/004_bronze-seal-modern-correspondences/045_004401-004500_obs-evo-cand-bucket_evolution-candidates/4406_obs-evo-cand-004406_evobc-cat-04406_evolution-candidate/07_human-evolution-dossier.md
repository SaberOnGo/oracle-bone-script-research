...
Project ID: `obs-evo-cand-004406`
...
- Project ID: `obs-evo-cand-004406`
- EVOBC category candidate ID: `evobc-evo-cat-04406`
- External category reference: `evobc-cat-04406`
- Source category ID: `04406`
- Source label for human review: `殃`
- Source codepoints: `U+6B83`
...
- `obs-evo-cand-004406-route-category-staging`
...
- `obs-evo-cand-004406-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004406-route-evolution-graph`
