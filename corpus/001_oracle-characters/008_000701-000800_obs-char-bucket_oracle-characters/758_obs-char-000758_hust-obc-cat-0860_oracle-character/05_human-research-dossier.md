# obs-char-000758 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/758_obs-char-000758_hust-obc-cat-0860_orac
  le-character/03_visual-assets/001_asset-000763_hust-obc-cat-0860_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0860/G_0860_乙4211.png`
- asset id: `asset-000763`
...
- source category: `0860`
- validation class: `757`
- source image route: `HUST-OBC/deciphered/0860/G_0860_乙4211.png`
- asset id: `asset-000763`
...
- English observation: `Two detached forms stand side by side: a slim left
  branching stem, and a right pointed angular outline divided into two
  stacked rounded compartments.`
...
- dataset label text: `㝒`
- dataset label codepoints: `U+3752`
...
- Which source records identify obs-char-000758 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000758？
