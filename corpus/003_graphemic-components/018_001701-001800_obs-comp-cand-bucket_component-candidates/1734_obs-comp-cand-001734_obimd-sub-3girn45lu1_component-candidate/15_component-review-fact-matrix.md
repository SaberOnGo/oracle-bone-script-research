...
| Glyph or codepoint route | 2 OBIMD route rows; examples U+FA159; U+FA15A | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence | 2 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
