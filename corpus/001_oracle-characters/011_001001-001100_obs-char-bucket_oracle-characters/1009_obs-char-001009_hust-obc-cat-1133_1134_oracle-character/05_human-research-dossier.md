# obs-char-001009 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001009`
- primary external id: `hust-obc-cat-1133_1134`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1009_obs-char-001009_hust-obc-cat-1133_113
  4_oracle-character/03_visual-assets/001_asset-001014_hust-obc-cat-1133_113
  4_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1133_1134/1133/G_1133_京津3087合21
  248𠂤組.png`
- asset id: `asset-001014`
...
- source category: `1133_1134`
- validation class: `1008`
- source image route: `HUST-OBC/deciphered/1133_1134/1133/G_1133_京津3087合21248𠂤
  組.png`
- asset id: `asset-001014`
...
- English observation: `A rounded central enclosure with a dark interior
  mark is flanked by curved side strokes and two lower split strokes.`
- 中文观察: `圆弧中央闭合轮廓内有深色内笔，两侧有弯曲外笔，下部有两条分开笔。`
...
- dataset label text: `㡣㡤`
- dataset label codepoints: `U+3863;U+3864`
...
- graph edge count: `2`
- codepoint routes: `U+3863;U+3864`
...
- filename catalog route clues: `Heji-like filename clue: 合21248
  (G_1133_京津3087合21248𠂤組.png)`
...
- Which source records identify obs-char-001009 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001009？
