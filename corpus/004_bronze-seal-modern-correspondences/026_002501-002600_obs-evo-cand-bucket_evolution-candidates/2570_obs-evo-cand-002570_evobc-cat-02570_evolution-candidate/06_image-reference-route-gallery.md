...
- `obs-evo-cand-002570-route-category-staging`
...
- `obs-evo-cand-002570-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002570-route-evolution-graph`
