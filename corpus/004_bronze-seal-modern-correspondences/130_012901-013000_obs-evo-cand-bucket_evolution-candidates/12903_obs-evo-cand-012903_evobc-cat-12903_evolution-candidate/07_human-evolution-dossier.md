...
- External category reference: `evobc-cat-12903`
- Source category ID: `12903`
- Source label for human review: `𪾡`
...
- `obs-evo-cand-012903-route-category-staging`
...
- `obs-evo-cand-012903-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012903-route-evolution-graph`
