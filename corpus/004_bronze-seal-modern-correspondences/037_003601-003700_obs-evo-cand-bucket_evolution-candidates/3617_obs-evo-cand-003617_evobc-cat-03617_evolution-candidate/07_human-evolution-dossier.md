...
- External category reference: `evobc-cat-03617`
- Source category ID: `03617`
- Source label for human review: `敿`
- Source codepoints: `U+657F`
...
- `obs-evo-cand-003617-route-category-staging`
...
- `obs-evo-cand-003617-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003617-route-evolution-graph`
