# Material Visual Observation / obs-comp-cand-001664 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001664`
- External reference / 外部参照: `obimd-sub-ix033niy64`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017340_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ix033niy64/ix033niy64/ix033niy64.png`
- Checksum / 校验和:
  `4903ea3cdbe8614d31d9effc5fff634efb157b4c0dba312d8511d7cd914b822e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.47%.
- Marked-pixel bounds: (68,48)–(181,197); span 114 × 150 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.47%。
- 痕迹范围：(68,48)–(181,197)；跨度114 × 150 px；痕迹矩形高于宽。
