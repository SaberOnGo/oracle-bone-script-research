...
- External category reference: `evobc-cat-09698`
- Source category ID: `09698`
- Source label for human review: `阪`
- Source codepoints: `U+962A`
...
- `obs-evo-cand-009698-route-category-staging`
...
- `obs-evo-cand-009698-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009698-route-evolution-graph`
