# Material Visual Observation / obs-comp-cand-002363 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002363`
- External reference / 外部参照: `obimd-sub-w2nmq54ds4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020434_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/j0cf8hrkjw/w2nmq54ds4/w2nmq54ds4.png`
- Checksum / 校验和:
  `20ea5cf53126816d68cd05455364655bd21991866c433aab79c6fb011affa8d9`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.64%.
- Marked-pixel bounds: (65,48)–(184,197); span 120 × 150 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.64%。
- 痕迹范围：(65,48)–(184,197)；跨度120 × 150 px；痕迹矩形高于宽。
