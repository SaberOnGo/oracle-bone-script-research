...
- External category reference: `evobc-cat-04257`
- Source category ID: `04257`
- Source label for human review: `樿`
...
- `obs-evo-cand-004257-route-category-staging`
...
- `obs-evo-cand-004257-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004257-route-evolution-graph`
