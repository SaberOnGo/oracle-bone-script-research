...
- Project ID: `obs-evo-cand-004955`
- EVOBC category candidate ID: `evobc-evo-cat-04955`
- External category reference: `evobc-cat-04955`
- Source category ID: `04955`
- Source label for human review: `濄`
- Source codepoints: `U+6FC4`
...
- `obs-evo-cand-004955-route-category-staging`
...
- `obs-evo-cand-004955-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004955-route-evolution-graph`
