# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-009121
...
- EVOBC candidate category: `evobc-evo-cat-09121`.
- Source label for search only: `邽`.
- Source codepoints for search only: `U+90BD`.
