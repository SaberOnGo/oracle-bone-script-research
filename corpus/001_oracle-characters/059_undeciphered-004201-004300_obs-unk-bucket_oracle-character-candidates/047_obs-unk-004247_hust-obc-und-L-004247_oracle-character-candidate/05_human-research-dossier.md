# obs-unk-004247 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004247`
- primary external id: `hust-obc-und-L-004247`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/047_obs-unk-004247_h
  ust-obc-und-L-004247_oracle-character-candidate/03_visual-assets/001_asset
  -005840_hust-obc-und-L-004247_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4247/L_？_9357.jpg`
- asset id: `asset-005840`
...
- source class: `HUST-OBC/undeciphered/L/4247/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4247/L_？_9357.jpg`
- asset id: `asset-005840`
...
- English observation: `Upper angles, inner bar, long right trace visible.`
- 中文观察: `棱角状上部轮廓、内部横痕和右侧长痕迹可见。`
...
- Which source records identify obs-unk-004247 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004247？
