# obs-char-000990 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/990_obs-char-000990_hust-obc-cat-1112_orac
  le-character/03_visual-assets/001_asset-000995_hust-obc-cat-1112_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1112/X_1112_3669_1.png`
- asset id: `asset-000995`
...
- source category: `1112`
- validation class: `989`
- source image route: `HUST-OBC/deciphered/1112/X_1112_3669_1.png`
- asset id: `asset-000995`
...
- English observation: `A dense bold form combines stacked rounded
  enclosures, diagonal connecting strokes, and a long lower curve.`
...
- dataset label text: `㡎`
- dataset label codepoints: `U+384E`
...
- Which source records identify obs-char-000990 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000990？
