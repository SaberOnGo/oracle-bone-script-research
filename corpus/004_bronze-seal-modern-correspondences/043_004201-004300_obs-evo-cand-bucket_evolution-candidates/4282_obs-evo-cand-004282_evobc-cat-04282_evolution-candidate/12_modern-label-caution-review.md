# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004282
...
- EVOBC candidate category: `evobc-evo-cat-04282`.
- Source label for search only: `檄`.
- Source codepoints for search only: `U+6A84`.
