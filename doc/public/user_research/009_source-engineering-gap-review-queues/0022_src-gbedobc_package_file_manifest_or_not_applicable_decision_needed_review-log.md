...
- Review log draft ID / 复核日志草稿 ID: `source-engineering-gap-review-log-draft-0022`
- Source engineering gap ID / 来源工程缺口 ID: `source-engineering-gap-0022`
...
`current_stage=pending_human_review;download_status_counts=downloaded:2;downloaded_count=2;download_log_count=2;checksum_present_count=2;field_map_count=1;package_manifest_count=0;metadata_profile_count=3;graph_edge_count=0;downloaded_file_bytes=2100908;gap_type=package_file_manifest_or_not_applicable_decision_needed`
...
- metadata_profile_count: `3`
- graph_edge_count: `0`
- downloaded_file_bytes: `2100908`
