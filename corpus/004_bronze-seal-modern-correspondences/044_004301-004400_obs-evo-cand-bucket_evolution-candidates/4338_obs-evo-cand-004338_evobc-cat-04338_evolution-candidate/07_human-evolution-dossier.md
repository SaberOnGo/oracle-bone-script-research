...
- External category reference: `evobc-cat-04338`
- Source category ID: `04338`
- Source label for human review: `欢`
- Source codepoints: `U+6B22`
...
- `obs-evo-cand-004338-route-category-staging`
...
- `obs-evo-cand-004338-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004338-route-evolution-graph`
