# Material Visual Observation / obs-comp-cand-000729 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000729`
- External reference / 外部参照: `obimd-sub-i72tgmcydj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013456_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/i72tgmcydj/i72tgmcydj/i72tgmcydj.png`
- Checksum / 校验和:
  `5960324e5bfa94243f91df1832d6597d6c23856becda65b66c04198d05983821`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.43%.
- Marked-pixel bounds: (89,23)–(185,226); span 97 × 204 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.43%。
- 痕迹范围：(89,23)–(185,226)；跨度97 × 204 px；痕迹矩形高于宽。
