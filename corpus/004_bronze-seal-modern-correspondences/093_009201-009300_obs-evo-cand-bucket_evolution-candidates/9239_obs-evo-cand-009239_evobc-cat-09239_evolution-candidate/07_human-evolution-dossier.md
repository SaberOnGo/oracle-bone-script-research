...
- Project ID: `obs-evo-cand-009239`
- EVOBC category candidate ID: `evobc-evo-cat-09239`
- External category reference: `evobc-cat-09239`
- Source category ID: `09239`
- Source label for human review: `配`
- Source codepoints: `U+914D`
...
- `obs-evo-cand-009239-route-category-staging`
...
- `obs-evo-cand-009239-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009239-route-evolution-graph`
