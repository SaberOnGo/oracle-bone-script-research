# obs-unk-004207 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/007_obs-unk-004207_h
  ust-obc-und-L-004207_oracle-character-candidate/03_visual-assets/001_asset
  -005800_hust-obc-und-L-004207_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4207/L_？_9162.jpg`
- asset id: `asset-005800`
...
- source class: `HUST-OBC/undeciphered/L/4207/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4207/L_？_9162.jpg`
- asset id: `asset-005800`
...
- English observation: `Tall outline, inner marks, and lower strokes visible.`
- 中文观察: `较高轮廓、内部痕迹和两条下部笔画可见。`
...
- Which source records identify obs-unk-004207 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004207？
