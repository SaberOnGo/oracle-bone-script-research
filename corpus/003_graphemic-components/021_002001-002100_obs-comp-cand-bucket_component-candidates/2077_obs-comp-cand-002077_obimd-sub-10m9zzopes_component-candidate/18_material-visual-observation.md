# Material Visual Observation / obs-comp-cand-002077 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002077`
- External reference / 外部参照: `obimd-sub-10m9zzopes`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019464_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/egf0h3s4xh/10m9zzopes/10m9zzopes.png`
- Checksum / 校验和:
  `12e371b95047db0ddbaaf7bfaab19793d050ad9660cbb01b41542a0037bbdac6`
...
- Marked-pixel bounds: (60,28)–(194,225); span 135 × 198 px; the marked
...
- 痕迹范围：(60,28)–(194,225)；跨度135 × 198 px；痕迹矩形高于宽。
