# Material Visual Observation / obs-comp-cand-001688 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001688`
- External reference / 外部参照: `obimd-sub-kk9zxal8u7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017604_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kk9zxal8u7/kk9zxal8u7/kk9zxal8u7.png`
- Checksum / 校验和:
  `0c5deddec14ce85717c34aaeb1d98fea43af0bc11828909ad0079c3fff89612e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.58%.
- Marked-pixel bounds: (68,52)–(181,193); span 114 × 142 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.58%。
- 痕迹范围：(68,52)–(181,193)；跨度114 × 142 px；痕迹矩形高于宽。
