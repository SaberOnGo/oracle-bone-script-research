...
|---|---|---|
| Source Codepoint Route | `U+3431` | not identity |
| HUST candidate route | `hust-obc-cat-0059` | not reading |
| OBIMD route | `obimd-main-cand-001015` | not component |
| EVOBC route | `evobc-evo-cat-00006` | not evolution |
