# obs-unk-002924 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/046_undeciphered-002
  901-003000_obs-unk-bucket_oracle-character-candidates/024_obs-unk-002924_h
  ust-obc-und-L-002924_oracle-character-candidate/03_visual-assets/001_asset
  -004517_hust-obc-und-L-002924_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2924/L_？_5047.jpg`
- asset id: `asset-004517`
...
- source class: `HUST-OBC/undeciphered/L/2924/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2924/L_？_5047.jpg`
- asset id: `asset-004517`
...
- Which source records identify obs-unk-002924 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002924？
