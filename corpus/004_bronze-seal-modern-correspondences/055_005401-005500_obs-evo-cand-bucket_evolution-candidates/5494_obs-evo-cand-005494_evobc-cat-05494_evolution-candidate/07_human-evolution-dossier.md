...
- External category reference: `evobc-cat-05494`
- Source category ID: `05494`
- Source label for human review: `瓏`
- Source codepoints: `U+74CF`
...
- `obs-evo-cand-005494-route-category-staging`
...
- `obs-evo-cand-005494-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005494-route-evolution-graph`
