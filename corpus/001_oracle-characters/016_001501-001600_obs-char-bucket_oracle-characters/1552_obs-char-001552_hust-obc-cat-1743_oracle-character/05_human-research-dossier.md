# obs-char-001552 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001552`
- primary external id: `hust-obc-cat-1743`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1552_obs-char-001552_hust-obc-cat-1743_ora
  cle-character/03_visual-assets/001_asset-001557_hust-obc-cat-1743_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1743/G_1743_京津1640合4344賓組.png`
- asset id: `asset-001557`
...
- source category: `1743`
- validation class: `1551`
- source image route: `HUST-OBC/deciphered/1743/G_1743_京津1640合4344賓組.png`
- asset id: `asset-001557`
...
- English observation: `Two narrow adjacent forms show a branching curved
  left contour and short right crossbars.`
...
- dataset label text: `㫅`
- dataset label codepoints: `U+3AC5`
...
- filename catalog route clues: `Heji-like filename clue: 合4344
  (G_1743_京津1640合4344賓組.png)`
...
- Which source records identify obs-char-001552 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001552？
