# obs-char-001334 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1334_obs-char-001334_hust-obc-cat-1490_ora
  cle-character/03_visual-assets/001_asset-001339_hust-obc-cat-1490_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1490/G_1490_合28190(甲).png`
- asset id: `asset-001339`
...
- source category: `1490`
- validation class: `1333`
- source image route: `HUST-OBC/deciphered/1490/G_1490_合28190(甲).png`
- asset id: `asset-001339`
...
- English observation: `A small faint cluster has a pointed upper mark, a
  narrow central stroke, and two lower loops.`
- 中文观察: `小型较淡笔画群有尖状上部标记、狭长中央笔画和两个下部环形。`
...
- dataset label text: `㧈`
- dataset label codepoints: `U+39C8`
...
- filename catalog route clues: `Heji-like filename clue: 合28190
  (G_1490_合28190(甲).png)`
...
- Which source records identify obs-char-001334 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001334？
