# Material Visual Observation / obs-comp-cand-000711 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000711`
- External reference / 外部参照: `obimd-sub-um3hp76w21`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013423_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/um3hp76w21/um3hp76w21/um3hp76w21.png`
- Checksum / 校验和:
  `1e422fdb2e37cad9f5317851b9edbb7f9c4f944071248d56726d9e0f5b9b3228`
...
- Marked-pixel bounds: (52,24)–(197,226); span 146 × 203 px; the marked
...
- 痕迹范围：(52,24)–(197,226)；跨度146 × 203 px；痕迹矩形高于宽。
