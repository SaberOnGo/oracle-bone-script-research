...
- External category reference: `evobc-cat-08219`
- Source category ID: `08219`
- Source label for human review: `誉`
- Source codepoints: `U+8A89`
...
- `obs-evo-cand-008219-route-category-staging`
...
- `obs-evo-cand-008219-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008219-route-evolution-graph`
