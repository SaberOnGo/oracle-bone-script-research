...
- External category reference: `evobc-cat-01141`
- Source category ID: `01141`
...
- `obs-evo-cand-001141-route-category-staging`
...
- `obs-evo-cand-001141-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001141-route-evolution-graph`
