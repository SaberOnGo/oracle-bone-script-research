...
Project ID: `obs-evo-cand-010307`
...
- Project ID: `obs-evo-cand-010307`
- EVOBC category candidate ID: `evobc-evo-cat-10307`
- External category reference: `evobc-cat-10307`
- Source category ID: `10307`
- Source label for human review: `髖`
- Source codepoints: `U+9AD6`
...
- `obs-evo-cand-010307-route-category-staging`
...
- `obs-evo-cand-010307-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010307-route-evolution-graph`
