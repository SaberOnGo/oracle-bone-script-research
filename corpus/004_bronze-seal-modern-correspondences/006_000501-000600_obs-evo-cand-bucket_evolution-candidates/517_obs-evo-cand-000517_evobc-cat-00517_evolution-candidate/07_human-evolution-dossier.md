...
Project ID: `obs-evo-cand-000517`
...
- Project ID: `obs-evo-cand-000517`
- EVOBC category candidate ID: `evobc-evo-cat-00517`
- External category reference: `evobc-cat-00517`
- Source category ID: `00517`
- Source label for human review: `䦔`
- Source codepoints: `U+4994`
...
- `obs-evo-cand-000517-route-category-staging`
...
- `obs-evo-cand-000517-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000517-route-evolution-graph`
