# obs-evo-cand-011659 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-11659`
- Source label for human review: `𤰇`
- Source codepoints: `U+24C07`
- Image reference count: `17`
- Era token counts: `OBC:17`
