# Material Visual Observation / obs-comp-cand-002450 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002450`
- External reference / 外部参照: `obimd-sub-fom5bv844r`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020622_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fom5bv844r/fom5bv844r/0x0k8zp1ug.png`
- Checksum / 校验和:
  `91ec38a6e8df068ae3f37af8a369a3cdf516a672843deb3f90158f76cf48b6ba`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.45%.
- Marked-pixel bounds: (67,34)–(182,209); span 116 × 176 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.45%。
- 痕迹范围：(67,34)–(182,209)；跨度116 × 176 px；痕迹矩形高于宽。
