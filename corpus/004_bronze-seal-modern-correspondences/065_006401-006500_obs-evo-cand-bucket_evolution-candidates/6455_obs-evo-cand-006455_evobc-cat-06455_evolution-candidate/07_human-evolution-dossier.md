...
Project ID: `obs-evo-cand-006455`
...
- Project ID: `obs-evo-cand-006455`
- EVOBC category candidate ID: `evobc-evo-cat-06455`
- External category reference: `evobc-cat-06455`
- Source category ID: `06455`
- Source label for human review: `紓`
- Source codepoints: `U+7D13`
...
- `obs-evo-cand-006455-route-category-staging`
...
- `obs-evo-cand-006455-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006455-route-evolution-graph`
