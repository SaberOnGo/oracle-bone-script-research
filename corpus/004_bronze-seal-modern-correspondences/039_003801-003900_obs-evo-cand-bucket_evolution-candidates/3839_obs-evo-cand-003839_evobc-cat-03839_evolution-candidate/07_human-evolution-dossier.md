...
- External category reference: `evobc-cat-03839`
- Source category ID: `03839`
...
- `obs-evo-cand-003839-route-category-staging`
...
- `obs-evo-cand-003839-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003839-route-evolution-graph`
