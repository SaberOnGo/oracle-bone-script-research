...
- `obs-evo-cand-003639-route-category-staging`
...
- `obs-evo-cand-003639-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003639-route-evolution-graph`
