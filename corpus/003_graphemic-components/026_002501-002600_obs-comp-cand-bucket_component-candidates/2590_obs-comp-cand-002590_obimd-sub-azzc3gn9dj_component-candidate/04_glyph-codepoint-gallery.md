# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002590
...
| --- | --- | --- | --- |
| `obimd-glyph-link-039497` | 󾫢 | `U+FEAE2` | `reviewed_metadata_only` |
| `obimd-glyph-link-039498` | 󾫣 | `U+FEAE3` | `reviewed_metadata_only` |
| `obimd-glyph-link-039499` | 󾫤 | `U+FEAE4` | `reviewed_metadata_only` |
