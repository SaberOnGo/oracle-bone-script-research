# obs-char-000009 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000009`
- primary external id: `hust-obc-cat-0009`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/009_obs-char-000009_hust-obc-cat-0009_orac
  le-character/03_visual-assets/001_asset-000014_hust-obc-cat-0009_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0009/G_0009_屯2118.png`
- asset id: `asset-000014`
...
- source category: `0009`
- validation class: `8`
- source image route: `HUST-OBC/deciphered/0009/G_0009_屯2118.png`
- asset id: `asset-000014`
...
- English observation: `The image contains two rows of small rounded forms,
  with paired marks visible in each row.`
- 中文观察: `图像含两行小型圆弧形体，每行都可见成对痕迹。`
...
- dataset label text: `〢`
- dataset label codepoints: `U+3022`
...
- Which source records identify obs-char-000009 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000009？
