# obs-unk-008019 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/097_undeciphered-008
  001-008100_obs-unk-bucket_oracle-character-candidates/019_obs-unk-008019_h
  ust-obc-und-YH-008019_oracle-character-candidate/03_visual-assets/001_asse
  t-009610_hust-obc-und-YH-008019_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6062E/H_？_6062E_0.png`
- asset id: `asset-009610`
...
- source class: `HUST-OBC/undeciphered/Y+H/6062E/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6062E/H_？_6062E_0.png`
- asset id: `asset-009610`
...
- Which source records identify obs-unk-008019 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008019？
