...
- External category reference: `evobc-cat-10989`
- Source category ID: `10989`
- Source label for human review: `𡋷`
- Source codepoints: `U+212F7`
...
- `obs-evo-cand-010989-route-category-staging`
...
- `obs-evo-cand-010989-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010989-route-evolution-graph`
