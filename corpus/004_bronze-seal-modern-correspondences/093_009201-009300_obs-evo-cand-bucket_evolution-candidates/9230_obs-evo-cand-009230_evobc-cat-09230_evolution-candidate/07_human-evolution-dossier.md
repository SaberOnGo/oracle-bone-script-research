...
- External category reference: `evobc-cat-09230`
- Source category ID: `09230`
- Source label for human review: `酄`
...
- `obs-evo-cand-009230-route-category-staging`
...
- `obs-evo-cand-009230-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009230-route-evolution-graph`
