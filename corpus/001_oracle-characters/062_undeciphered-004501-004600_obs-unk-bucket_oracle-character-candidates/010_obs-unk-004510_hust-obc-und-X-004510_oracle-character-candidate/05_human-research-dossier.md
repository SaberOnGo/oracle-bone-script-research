# obs-unk-004510 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004510`
- primary external id: `hust-obc-und-X-004510`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/010_obs-unk-004510_h
  ust-obc-und-X-004510_oracle-character-candidate/03_visual-assets/001_asset
  -006103_hust-obc-und-X-004510_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/66/X_？_8251_1.png`
- asset id: `asset-006103`
...
- source class: `HUST-OBC/undeciphered/X/66/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/66/X_？_8251_1.png`
- asset id: `asset-006103`
...
- English observation: `The separated fragments, upper trace, lower groups, and
  short vertical pieces are directly recorded.`
- 中文观察: `已直接记录分离片段、上部横痕、下部痕迹群和短竖片段。`
...
- Which source records identify obs-unk-004510 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004510？
