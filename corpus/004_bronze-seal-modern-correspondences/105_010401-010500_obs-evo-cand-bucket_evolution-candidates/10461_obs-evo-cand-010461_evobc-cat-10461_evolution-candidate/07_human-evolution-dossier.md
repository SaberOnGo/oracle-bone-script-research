...
- Project ID: `obs-evo-cand-010461`
- EVOBC category candidate ID: `evobc-evo-cat-10461`
- External category reference: `evobc-cat-10461`
- Source category ID: `10461`
- Source label for human review: `鲜`
- Source codepoints: `U+9C9C`
...
- `obs-evo-cand-010461-route-category-staging`
...
- `obs-evo-cand-010461-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010461-route-evolution-graph`
