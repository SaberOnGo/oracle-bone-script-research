...
- External category reference: `evobc-cat-09099`
- Source category ID: `09099`
- Source label for human review: `邢`
- Source codepoints: `U+90A2`
...
- `obs-evo-cand-009099-route-category-staging`
...
- `obs-evo-cand-009099-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009099-route-evolution-graph`
