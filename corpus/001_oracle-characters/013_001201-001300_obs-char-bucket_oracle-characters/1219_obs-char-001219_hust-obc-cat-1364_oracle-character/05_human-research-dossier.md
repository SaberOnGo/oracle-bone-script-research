# obs-char-001219 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1219_obs-char-001219_hust-obc-cat-1364_ora
  cle-character/03_visual-assets/001_asset-001224_hust-obc-cat-1364_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1364/L_1364_1002.jpg`
- asset id: `asset-001224`
...
- source category: `1364`
- validation class: `1218`
- source image route: `HUST-OBC/deciphered/1364/L_1364_1002.jpg`
- asset id: `asset-001224`
...
- English observation: `A faint small rounded enclosure contains an inner
  loop and a short upper stroke; contrast is low.`
- 中文观察: `较淡的小型圆弧框廓包含内部环和短上部笔；图像对比度较低。`
...
- dataset label text: `㥊`
- dataset label codepoints: `U+394A`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00126`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00126`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00126`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/126_obs-evo-can
  d-000126_evobc-cat-00126_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/126_obs-evo-cand-000126_evobc-cat-00126_evolu
...
- Which source records identify obs-char-001219 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001219？
