# Material Visual Observation / obs-comp-cand-001763 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001763`
- External reference / 外部参照: `obimd-sub-xwmrgwb38v`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017964_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xwmrgwb38v/xwmrgwb38v/xwmrgwb38v.png`
- Checksum / 校验和:
  `daf1d0f877366be427baf8445b82f65a3e82fc9f5411ce23de28389a9f13ced6`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.81%.
- Marked-pixel bounds: (75,48)–(174,194); span 100 × 147 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.81%。
- 痕迹范围：(75,48)–(174,194)；跨度100 × 147 px；痕迹矩形高于宽。
