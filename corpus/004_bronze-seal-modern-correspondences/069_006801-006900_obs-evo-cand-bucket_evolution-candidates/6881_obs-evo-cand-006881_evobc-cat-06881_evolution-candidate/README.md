# obs-evo-cand-006881 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-006881`
- EVOBC category candidate ID: `evobc-evo-cat-06881`
- External category ref: `evobc-cat-06881`
- Source label: `習`
- Source codepoints: `U+7FD2`
- Image reference count: `156`
- Era token counts: `CS:1;OBC:44;SS:1;WSC:110`
- Source token counts: `Book:19;Web:137`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 44 image references
- era 2 / SS: 1 image references
- era 4 / WSC: 110 image references
- era 5 / CS: 1 image references
- source 0 / Web:1633: 1 image references
- source 1 / Web:105952;說文Web:58: 114 image references
