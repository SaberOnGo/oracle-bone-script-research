...
- External category reference: `evobc-cat-06591`
- Source category ID: `06591`
- Source label for human review: `線`
- Source codepoints: `U+7DDA`
...
- `obs-evo-cand-006591-route-category-staging`
...
- `obs-evo-cand-006591-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006591-route-evolution-graph`
