...
- External category reference: `evobc-cat-02299`
- Source category ID: `02299`
- Source label for human review: `嬖`
...
- `obs-evo-cand-002299-route-category-staging`
...
- `obs-evo-cand-002299-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002299-route-evolution-graph`
