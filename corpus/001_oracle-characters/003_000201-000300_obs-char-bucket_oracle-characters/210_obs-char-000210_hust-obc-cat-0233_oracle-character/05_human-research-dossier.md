# obs-char-000210 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/210_obs-char-000210_hust-obc-cat-0233_orac
  le-character/03_visual-assets/001_asset-000215_hust-obc-cat-0233_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0233/G_0233_京津4901合31801無名組.png
  `
- asset id: `asset-000215`
...
- source category: `0233`
- validation class: `209`
- source image route: `HUST-OBC/deciphered/0233/G_0233_京津4901合31801無名組.png`
- asset id: `asset-000215`
...
- English observation: `The image has a pointed upper V-shaped mark, a
  curved branching lower-left form, and a separate long stroke on the
  right.`
- 中文观察: `图像上方有尖顶 V 形痕迹，左下方有弯曲分支形，右侧另有分离长笔。`
...
- dataset label text: `㓟`
- dataset label codepoints: `U+34DF`
...
- filename catalog route clues: `Heji-like filename clue: 合31801
...
- Which source records identify obs-char-000210 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000210？
