# Material Visual Observation / obs-comp-cand-000825 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000825`
- External reference / 外部参照: `obimd-sub-wrd3sifbau`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013696_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wrd3sifbau/wrd3sifbau/wrd3sifbau.png`
- Checksum / 校验和:
  `d1a0f7e9beee846bf31c8e300b98fc924e49828ae0e345edcb6312a694c7b704`
...
- Marked-pixel bounds: (67,31)–(182,220); span 116 × 190 px; the marked
...
- 痕迹范围：(67,31)–(182,220)；跨度116 × 190 px；痕迹矩形高于宽。
