...
Project ID: `obs-evo-cand-005556`
...
- Project ID: `obs-evo-cand-005556`
- EVOBC category candidate ID: `evobc-evo-cat-05556`
- External category reference: `evobc-cat-05556`
- Source category ID: `05556`
- Source label for human review: `甿`
- Source codepoints: `U+753F`
...
- `obs-evo-cand-005556-route-category-staging`
...
- `obs-evo-cand-005556-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005556-route-evolution-graph`
