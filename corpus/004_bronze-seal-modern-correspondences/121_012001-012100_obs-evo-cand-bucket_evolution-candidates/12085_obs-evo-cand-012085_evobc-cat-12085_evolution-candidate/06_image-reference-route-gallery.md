...
- `obs-evo-cand-012085-route-category-staging`
...
- `obs-evo-cand-012085-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012085-route-evolution-graph`
