# Material Visual Observation / obs-comp-cand-002392 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002392`
- External reference / 外部参照: `obimd-sub-qbf67i5b2z`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020463_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kbaaq0n44y/qbf67i5b2z/qbf67i5b2z.png`
- Checksum / 校验和:
  `2e6f179a642bcc55963e2b71ac5e5ab81720798991da0eff71327119454ddc50`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.93%.
- Marked-pixel bounds: (81,36)–(168,212); span 88 × 177 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.93%。
- 痕迹范围：(81,36)–(168,212)；跨度88 × 177 px；痕迹矩形高于宽。
