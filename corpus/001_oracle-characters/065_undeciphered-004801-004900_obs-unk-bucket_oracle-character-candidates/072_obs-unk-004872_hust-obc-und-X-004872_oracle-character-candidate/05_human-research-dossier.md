# obs-unk-004872 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/072_obs-unk-004872_h
  ust-obc-und-X-004872_oracle-character-candidate/03_visual-assets/001_asset
  -006465_hust-obc-und-X-004872_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/428/X_？_7411_1.png`
- asset id: `asset-006465`
...
- source class: `HUST-OBC/undeciphered/X/428/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/428/X_？_7411_1.png`
- asset id: `asset-006465`
...
- English observation: `thick upper group and two lower angular groups`
- 中文观察: `上部粗笔画组和下部两个折角结构`
...
- Which source records identify obs-unk-004872 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004872？
