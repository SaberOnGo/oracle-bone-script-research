# Material Visual Observation / obs-comp-cand-002051 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002051`
- External reference / 外部参照: `obimd-sub-v5pc6weeyk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019438_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4nm99xtfab/v5pc6weeyk/v5pc6weeyk.png`
- Checksum / 校验和:
  `cf22e607a2822644ba0074b7c762573b03007ea9e7c7d1ef6ff93258f5ba4ef5`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.26%.
- Marked-pixel bounds: (76,27)–(173,215); span 98 × 189 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.26%。
- 痕迹范围：(76,27)–(173,215)；跨度98 × 189 px；痕迹矩形高于宽。
