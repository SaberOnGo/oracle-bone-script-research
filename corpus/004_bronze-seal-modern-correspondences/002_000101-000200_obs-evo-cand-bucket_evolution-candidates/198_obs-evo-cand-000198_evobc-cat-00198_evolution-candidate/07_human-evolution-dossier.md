...
- External category reference: `evobc-cat-00198`
- Source category ID: `00198`
- Source label for human review: `㲂`
...
- `obs-evo-cand-000198-route-category-staging`
...
- `obs-evo-cand-000198-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000198-route-evolution-graph`
