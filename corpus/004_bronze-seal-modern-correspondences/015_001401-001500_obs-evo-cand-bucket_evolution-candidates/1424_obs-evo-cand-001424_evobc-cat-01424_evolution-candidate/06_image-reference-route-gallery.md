...
- `obs-evo-cand-001424-route-category-staging`
...
- `obs-evo-cand-001424-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001424-route-evolution-graph`
