...
- External category reference: `evobc-cat-00256`
- Source category ID: `00256`
- Source label for human review: `㾌`
...
- `obs-evo-cand-000256-route-category-staging`
...
- `obs-evo-cand-000256-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000256-route-evolution-graph`
