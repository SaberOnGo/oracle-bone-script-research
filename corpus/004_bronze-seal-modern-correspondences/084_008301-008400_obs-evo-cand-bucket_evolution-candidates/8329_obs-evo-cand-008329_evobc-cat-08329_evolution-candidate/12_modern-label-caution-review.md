# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008329
...
- EVOBC candidate category: `evobc-evo-cat-08329`.
- Source label for search only: `謫`.
- Source codepoints for search only: `U+8B2B`.
