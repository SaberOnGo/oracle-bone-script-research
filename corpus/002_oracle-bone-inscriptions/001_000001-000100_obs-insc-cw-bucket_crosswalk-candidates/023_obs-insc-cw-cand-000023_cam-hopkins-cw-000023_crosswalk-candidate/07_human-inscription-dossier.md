...
Project ID: `obs-insc-cw-cand-000023`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000023`
...
- Yingguo / 英国所藏: `y133` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `248` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `417` in source row; primary catalog entry pending
- Heji / 合集: `39688` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000023`
