...
- External category reference: `evobc-cat-00573`
- Source category ID: `00573`
- Source label for human review: `䰍`
...
- `obs-evo-cand-000573-route-category-staging`
...
- `obs-evo-cand-000573-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000573-route-evolution-graph`
