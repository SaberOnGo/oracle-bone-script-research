# obs-unk-003970 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/070_obs-unk-003970_h
  ust-obc-und-L-003970_oracle-character-candidate/03_visual-assets/001_asset
  -005563_hust-obc-und-L-003970_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3970/L_？_839.jpg`
- asset id: `asset-005563`
...
- source class: `HUST-OBC/undeciphered/L/3970/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3970/L_？_839.jpg`
- asset id: `asset-005563`
...
- English observation: A tall narrow form has curved side traces and a pointed
  or arched upper central trace.
- 中文观察：较高较窄形体两侧有弧痕，顶部中央有尖点状或拱形痕迹。
...
- Which source records identify obs-unk-003970 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003970？
