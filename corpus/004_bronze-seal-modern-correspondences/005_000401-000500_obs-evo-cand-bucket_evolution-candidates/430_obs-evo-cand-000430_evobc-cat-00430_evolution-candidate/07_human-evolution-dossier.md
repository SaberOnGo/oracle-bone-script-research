...
- External category reference: `evobc-cat-00430`
- Source category ID: `00430`
- Source label for human review: `䛦`
...
- `obs-evo-cand-000430-route-category-staging`
...
- `obs-evo-cand-000430-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000430-route-evolution-graph`
