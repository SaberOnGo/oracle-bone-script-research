...
- External category reference: `evobc-cat-07799`
- Source category ID: `07799`
- Source label for human review: `蜽`
...
- `obs-evo-cand-007799-route-category-staging`
...
- `obs-evo-cand-007799-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007799-route-evolution-graph`
