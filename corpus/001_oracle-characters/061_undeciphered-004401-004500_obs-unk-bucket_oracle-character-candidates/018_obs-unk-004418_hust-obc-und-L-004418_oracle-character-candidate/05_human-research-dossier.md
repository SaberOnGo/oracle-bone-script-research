# obs-unk-004418 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004418`
- primary external id: `hust-obc-und-L-004418`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/018_obs-unk-004418_h
  ust-obc-und-L-004418_oracle-character-candidate/03_visual-assets/001_asset
  -006011_hust-obc-und-L-004418_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4418/L_？_9892.jpg`
- asset id: `asset-006011`
...
- source class: `HUST-OBC/undeciphered/L/4418/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4418/L_？_9892.jpg`
- asset id: `asset-006011`
...
- English observation: `A rounded upper outline sits above a small oval`
  `and lower U-shaped trace.`
- 中文观察: `圆弧上部轮廓位于小椭圆和下部 U 形痕迹之上。`
...
- Which source records identify obs-unk-004418 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004418？
