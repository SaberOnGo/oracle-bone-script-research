...
Project ID: `obs-evo-cand-003714`
...
- Project ID: `obs-evo-cand-003714`
- EVOBC category candidate ID: `evobc-evo-cat-03714`
- External category reference: `evobc-cat-03714`
- Source category ID: `03714`
- Source label for human review: `昕`
- Source codepoints: `U+6615`
...
- `obs-evo-cand-003714-route-category-staging`
...
- `obs-evo-cand-003714-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003714-route-evolution-graph`
