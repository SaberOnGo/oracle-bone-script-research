...
- External category reference: `evobc-cat-02587`
- Source category ID: `02587`
- Source label for human review: `嵯`
- Source codepoints: `U+5D6F`
...
- `obs-evo-cand-002587-route-category-staging`
...
- `obs-evo-cand-002587-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002587-route-evolution-graph`
