# obs-char-000102 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000102`
- primary external id: `hust-obc-cat-0113_0114`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/102_obs-char-000102_hust-obc-cat-0113_0114
  _oracle-character/03_visual-assets/001_asset-000107_hust-obc-cat-0113_0114
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0113_0114/0113/Y_0113_612B8.jpg
  `
- asset id: `asset-000107`
...
- source category: `0113_0114`
- validation class: `101`
- source image route: `HUST-OBC/deciphered/0113_0114/0113/Y_0113_612B8.jpg`
- asset id: `asset-000107`
...
- English observation: `The enlarged image is arranged on a diagonal, with
  three rounded enclosures linked in sequence and a long lower descending
  stroke.`
- 中文观察: `放大图像沿斜向排列，有三个依次相连的弧形围合，并有长下行笔画。`
...
- dataset label text: `㑧㑨`
- dataset label codepoints: `U+3467;U+3468`
...
- graph edge count: `2`
- codepoint routes: `U+3467;U+3468`
...
- Which source records identify obs-char-000102 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000102？
