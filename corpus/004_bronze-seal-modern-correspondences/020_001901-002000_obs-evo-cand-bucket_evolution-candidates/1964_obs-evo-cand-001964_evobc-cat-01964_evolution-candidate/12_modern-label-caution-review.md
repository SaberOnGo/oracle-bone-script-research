# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001964
...
- EVOBC candidate category: `evobc-evo-cat-01964`.
- Source label for search only: `壛`.
- Source codepoints for search only: `U+58DB`.
