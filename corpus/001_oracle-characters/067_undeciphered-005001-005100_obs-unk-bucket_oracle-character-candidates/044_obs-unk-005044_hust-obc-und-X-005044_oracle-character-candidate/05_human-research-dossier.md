# obs-unk-005044 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/067_undeciphered-005
  001-005100_obs-unk-bucket_oracle-character-candidates/044_obs-unk-005044_h
  ust-obc-und-X-005044_oracle-character-candidate/03_visual-assets/001_asset
  -006637_hust-obc-und-X-005044_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/600/X_？_7574_1.png`
- asset id: `asset-006637`
...
- source class: `HUST-OBC/undeciphered/X/600/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/600/X_？_7574_1.png`
- asset id: `asset-006637`
...
- Which source records identify obs-unk-005044 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005044？
