# Material Visual Observation / obs-unk-002666
...
- English observation: A central crossing joins a tall upright stroke and
  short diagonal branches. The lower end narrows into a small separate tip.
- 中文观察：中央交叉处连接一条较高的直立笔痕和短斜分支。下端收窄为一
  个小而分离的末端。
