...
- Project ID: `obs-evo-cand-005723`
- EVOBC category candidate ID: `evobc-evo-cat-05723`
- External category reference: `evobc-cat-05723`
- Source category ID: `05723`
- Source label for human review: `皎`
- Source codepoints: `U+768E`
...
- `obs-evo-cand-005723-route-category-staging`
...
- `obs-evo-cand-005723-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005723-route-evolution-graph`
