# Material Visual Observation / obs-comp-cand-002436 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002436`
- External reference / 外部参照: `obimd-sub-4cylbd0s3d`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020608_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4cylbd0s3d/4cylbd0s3d/4cylbd0s3d.png`
- Checksum / 校验和:
  `be0a8601a56b5408c3d03d02b23214c2c9424db1ce837e630374fda7c1d0ed04`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.63%.
- Marked-pixel bounds: (83,18)–(177,230); span 95 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.63%。
- 痕迹范围：(83,18)–(177,230)；跨度95 × 213 px；痕迹矩形高于宽。
