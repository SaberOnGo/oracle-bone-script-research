...
- `obs-evo-cand-012307-route-category-staging`
...
- `obs-evo-cand-012307-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012307-route-evolution-graph`
