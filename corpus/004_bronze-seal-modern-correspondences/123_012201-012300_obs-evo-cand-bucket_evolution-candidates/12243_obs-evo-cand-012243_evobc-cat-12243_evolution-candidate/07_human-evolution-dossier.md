...
- External category reference: `evobc-cat-12243`
- Source category ID: `12243`
- Source label for human review: `𧫂`
- Source codepoints: `U+27AC2`
...
- `obs-evo-cand-012243-route-category-staging`
...
- `obs-evo-cand-012243-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012243-route-evolution-graph`
