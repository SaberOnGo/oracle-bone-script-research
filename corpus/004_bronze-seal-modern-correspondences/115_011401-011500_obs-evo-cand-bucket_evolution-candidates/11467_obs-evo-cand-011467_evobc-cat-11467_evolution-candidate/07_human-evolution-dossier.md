...
Project ID: `obs-evo-cand-011467`
...
- Project ID: `obs-evo-cand-011467`
- EVOBC category candidate ID: `evobc-evo-cat-11467`
- External category reference: `evobc-cat-11467`
- Source category ID: `11467`
- Source label for human review: `𣣚`
- Source codepoints: `U+238DA`
...
- `obs-evo-cand-011467-route-category-staging`
...
- `obs-evo-cand-011467-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011467-route-evolution-graph`
