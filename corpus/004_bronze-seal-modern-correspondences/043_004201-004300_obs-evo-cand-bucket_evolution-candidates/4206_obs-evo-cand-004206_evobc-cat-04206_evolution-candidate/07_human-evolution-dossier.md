...
- External category reference: `evobc-cat-04206`
- Source category ID: `04206`
- Source label for human review: `槌`
- Source codepoints: `U+69CC`
...
- `obs-evo-cand-004206-route-category-staging`
...
- `obs-evo-cand-004206-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004206-route-evolution-graph`
