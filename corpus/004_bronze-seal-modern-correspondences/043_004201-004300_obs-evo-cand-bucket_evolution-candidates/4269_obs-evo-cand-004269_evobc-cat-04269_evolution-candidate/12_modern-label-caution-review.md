# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004269
...
- EVOBC candidate category: `evobc-evo-cat-04269`.
- Source label for search only: `橛`.
- Source codepoints for search only: `U+6A5B`.
