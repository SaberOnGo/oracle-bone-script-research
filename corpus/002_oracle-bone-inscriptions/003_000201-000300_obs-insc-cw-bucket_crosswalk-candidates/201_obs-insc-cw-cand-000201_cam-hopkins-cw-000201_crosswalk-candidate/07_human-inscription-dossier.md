...
- Yingguo / 英国所藏: `y1181` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `50` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `640` in source row; primary catalog entry pending
