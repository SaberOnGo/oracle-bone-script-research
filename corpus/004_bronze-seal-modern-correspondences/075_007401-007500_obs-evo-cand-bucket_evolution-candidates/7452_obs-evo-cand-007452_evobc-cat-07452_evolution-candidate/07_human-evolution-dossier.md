...
Project ID: `obs-evo-cand-007452`
...
- Project ID: `obs-evo-cand-007452`
- EVOBC category candidate ID: `evobc-evo-cat-07452`
- External category reference: `evobc-cat-07452`
- Source category ID: `07452`
- Source label for human review: `萯`
- Source codepoints: `U+842F`
...
- `obs-evo-cand-007452-route-category-staging`
...
- `obs-evo-cand-007452-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007452-route-evolution-graph`
