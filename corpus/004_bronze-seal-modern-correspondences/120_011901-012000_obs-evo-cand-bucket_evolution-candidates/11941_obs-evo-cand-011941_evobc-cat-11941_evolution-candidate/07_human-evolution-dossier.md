...
- Project ID: `obs-evo-cand-011941`
- EVOBC category candidate ID: `evobc-evo-cat-11941`
- External category reference: `evobc-cat-11941`
- Source category ID: `11941`
- Source label for human review: `𥿫`
- Source codepoints: `U+25FEB`
...
- `obs-evo-cand-011941-route-category-staging`
...
- `obs-evo-cand-011941-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011941-route-evolution-graph`
