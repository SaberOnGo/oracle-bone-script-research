...
Project ID: `obs-evo-cand-001936`
...
- Project ID: `obs-evo-cand-001936`
- EVOBC category candidate ID: `evobc-evo-cat-01936`
- External category reference: `evobc-cat-01936`
- Source category ID: `01936`
- Source label for human review: `墊`
- Source codepoints: `U+588A`
...
- `obs-evo-cand-001936-route-category-staging`
...
- `obs-evo-cand-001936-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001936-route-evolution-graph`
