# obs-char-000129 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000129`
- primary external id: `hust-obc-cat-0143`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/129_obs-char-000129_hust-obc-cat-0143_orac
  le-character/03_visual-assets/001_asset-000134_hust-obc-cat-0143_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0143/G_0143_乙4667合17920賓組.png`
- asset id: `asset-000134`
...
- source category: `0143`
- validation class: `128`
- source image route: `HUST-OBC/deciphered/0143/G_0143_乙4667合17920賓組.png`
- asset id: `asset-000134`
...
- English observation: `The image shows a tall straight form with a top
  cross stroke on the left, beside a separate curved descending form on the
  right.`
...
- dataset label text: `㒅`
- dataset label codepoints: `U+3485`
...
- filename catalog route clues: `Heji-like filename clue: 合17920
  (G_0143_乙4667合17920賓組.png)`
...
- Which source records identify obs-char-000129 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000129？
