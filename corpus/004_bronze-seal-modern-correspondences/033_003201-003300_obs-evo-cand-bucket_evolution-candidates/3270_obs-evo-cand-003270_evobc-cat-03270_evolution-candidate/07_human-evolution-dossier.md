...
Project ID: `obs-evo-cand-003270`
...
- Project ID: `obs-evo-cand-003270`
- EVOBC category candidate ID: `evobc-evo-cat-03270`
- External category reference: `evobc-cat-03270`
- Source category ID: `03270`
- Source label for human review: `技`
- Source codepoints: `U+6280`
...
- `obs-evo-cand-003270-route-category-staging`
...
- `obs-evo-cand-003270-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003270-route-evolution-graph`
