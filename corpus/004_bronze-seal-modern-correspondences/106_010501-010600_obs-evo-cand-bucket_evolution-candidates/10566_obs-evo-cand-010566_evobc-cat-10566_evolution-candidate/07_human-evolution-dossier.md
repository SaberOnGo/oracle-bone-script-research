...
- External category reference: `evobc-cat-10566`
- Source category ID: `10566`
- Source label for human review: `鷸`
...
- `obs-evo-cand-010566-route-category-staging`
...
- `obs-evo-cand-010566-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010566-route-evolution-graph`
