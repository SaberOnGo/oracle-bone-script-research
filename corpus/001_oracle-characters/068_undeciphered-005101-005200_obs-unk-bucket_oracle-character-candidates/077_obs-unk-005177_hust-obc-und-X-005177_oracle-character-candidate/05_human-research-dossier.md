# obs-unk-005177 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005177`
- primary external id: `hust-obc-und-X-005177`
...
- local review image route: `corpus/001_oracle-characters/068_undeciphered-005
  101-005200_obs-unk-bucket_oracle-character-candidates/077_obs-unk-005177_h
  ust-obc-und-X-005177_oracle-character-candidate/03_visual-assets/001_asset
  -006770_hust-obc-und-X-005177_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/733/X_？_7699_1.png`
- asset id: `asset-006770`
...
- source class: `HUST-OBC/undeciphered/X/733/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/733/X_？_7699_1.png`
- asset id: `asset-006770`
...
- Which source records identify obs-unk-005177 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005177？
