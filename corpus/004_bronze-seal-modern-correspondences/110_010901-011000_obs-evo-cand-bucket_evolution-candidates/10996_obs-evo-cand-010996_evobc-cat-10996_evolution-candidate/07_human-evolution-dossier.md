...
- External category reference: `evobc-cat-10996`
- Source category ID: `10996`
- Source label for human review: `𡎿`
...
- `obs-evo-cand-010996-route-category-staging`
...
- `obs-evo-cand-010996-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010996-route-evolution-graph`
