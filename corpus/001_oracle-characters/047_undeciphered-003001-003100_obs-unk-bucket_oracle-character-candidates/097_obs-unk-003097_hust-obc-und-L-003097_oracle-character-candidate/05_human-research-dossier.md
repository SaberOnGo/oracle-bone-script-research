# obs-unk-003097 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/047_undeciphered-003
  001-003100_obs-unk-bucket_oracle-character-candidates/097_obs-unk-003097_h
  ust-obc-und-L-003097_oracle-character-candidate/03_visual-assets/001_asset
  -004690_hust-obc-und-L-003097_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3097/L_？_5596.jpg`
- asset id: `asset-004690`
...
- source class: `HUST-OBC/undeciphered/L/3097/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3097/L_？_5596.jpg`
- asset id: `asset-004690`
...
- Which source records identify obs-unk-003097 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003097？
