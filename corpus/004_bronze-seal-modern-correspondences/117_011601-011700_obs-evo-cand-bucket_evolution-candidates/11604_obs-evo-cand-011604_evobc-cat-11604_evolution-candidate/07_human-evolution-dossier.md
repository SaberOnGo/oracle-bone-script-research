...
- External category reference: `evobc-cat-11604`
- Source category ID: `11604`
- Source label for human review: `𤛬`
- Source codepoints: `U+246EC`
...
- `obs-evo-cand-011604-route-category-staging`
...
- `obs-evo-cand-011604-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011604-route-evolution-graph`
