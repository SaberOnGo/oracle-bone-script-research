...
- Project ID: `obs-evo-cand-013025`
- EVOBC category candidate ID: `evobc-evo-cat-13025`
- External category reference: `evobc-cat-13025`
- Source category ID: `13025`
- Source label for human review: `𫧄`
- Source codepoints: `U+2B9C4`
...
- `obs-evo-cand-013025-route-category-staging`
...
- `obs-evo-cand-013025-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013025-route-evolution-graph`
