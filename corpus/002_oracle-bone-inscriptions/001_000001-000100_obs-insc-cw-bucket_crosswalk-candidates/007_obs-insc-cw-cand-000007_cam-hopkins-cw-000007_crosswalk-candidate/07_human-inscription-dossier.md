...
Project ID: `obs-insc-cw-cand-000007`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000007`
...
- Yingguo / 英国所藏: `y38` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `70` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `491` in source row; primary catalog entry pending
- Heji / 合集: `39500` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000007`
