...
- External category reference: `evobc-cat-07640`
- Source category ID: `07640`
- Source label for human review: `藑`
...
- `obs-evo-cand-007640-route-category-staging`
...
- `obs-evo-cand-007640-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007640-route-evolution-graph`
