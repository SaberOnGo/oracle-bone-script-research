...
- External category reference: `evobc-cat-12750`
- Source category ID: `12750`
- Source label for human review: `𪏌`
- Source codepoints: `U+2A3CC`
...
- `obs-evo-cand-012750-route-category-staging`
...
- `obs-evo-cand-012750-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012750-route-evolution-graph`
