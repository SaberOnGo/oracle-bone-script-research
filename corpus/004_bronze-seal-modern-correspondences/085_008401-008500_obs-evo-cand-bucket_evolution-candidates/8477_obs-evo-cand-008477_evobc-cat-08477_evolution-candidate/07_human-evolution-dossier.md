...
- External category reference: `evobc-cat-08477`
- Source category ID: `08477`
- Source label for human review: `豈`
...
- `obs-evo-cand-008477-route-category-staging`
...
- `obs-evo-cand-008477-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008477-route-evolution-graph`
