...
- External category reference: `evobc-cat-10555`
- Source category ID: `10555`
- Source label for human review: `鷚`
...
- `obs-evo-cand-010555-route-category-staging`
...
- `obs-evo-cand-010555-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010555-route-evolution-graph`
