...
- External category reference: `evobc-cat-04273`
- Source category ID: `04273`
- Source label: `機`
...
- `obs-evo-cand-004273-route-category-staging`
...
- `obs-evo-cand-004273-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004273-route-evolution-graph`
