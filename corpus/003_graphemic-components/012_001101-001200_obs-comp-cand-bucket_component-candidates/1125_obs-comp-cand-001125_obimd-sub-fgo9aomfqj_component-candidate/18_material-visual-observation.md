# Material Visual Observation / obs-comp-cand-001125 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001125`
- External reference / 外部参照: `obimd-sub-fgo9aomfqj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015066_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fgo9aomfqj/fgo9aomfqj/39c9gsndm8.png`
- Checksum / 校验和:
  `d3f5023c638e6ac28c465d8ab695a5b912694f03bc517c8c0ae1aec267fb9ad0`
...
- Marked-pixel bounds: (79,33)–(170,216); span 92 × 184 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.55%。
- 痕迹范围：(79,33)–(170,216)；跨度92 × 184 px；痕迹矩形高于宽。
