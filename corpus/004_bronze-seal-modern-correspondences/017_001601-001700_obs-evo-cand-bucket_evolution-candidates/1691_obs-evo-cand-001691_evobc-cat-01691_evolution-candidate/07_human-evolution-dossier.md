...
Project ID: `obs-evo-cand-001691`
...
- Project ID: `obs-evo-cand-001691`
- EVOBC category candidate ID: `evobc-evo-cat-01691`
- External category reference: `evobc-cat-01691`
- Source category ID: `01691`
- Source label for human review: `嘉`
- Source codepoints: `U+5609`
...
- `obs-evo-cand-001691-route-category-staging`
...
- `obs-evo-cand-001691-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001691-route-evolution-graph`
