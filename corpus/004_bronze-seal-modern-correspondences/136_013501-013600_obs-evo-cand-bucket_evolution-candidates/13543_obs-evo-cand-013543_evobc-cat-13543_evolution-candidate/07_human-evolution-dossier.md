...
Project ID: `obs-evo-cand-013543`
...
- Project ID: `obs-evo-cand-013543`
- EVOBC category candidate ID: `evobc-evo-cat-13543`
- External category reference: `evobc-cat-13543`
- Source category ID: `13543`
- Source label for human review: `𭥔`
- Source codepoints: `U+2D954`
...
- `obs-evo-cand-013543-route-category-staging`
...
- `obs-evo-cand-013543-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013543-route-evolution-graph`
