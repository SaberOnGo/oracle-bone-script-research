...
- External category reference: `evobc-cat-06082`
- Source category ID: `06082`
- Source label for human review: `秳`
- Source codepoints: `U+79F3`
...
- `obs-evo-cand-006082-route-category-staging`
...
- `obs-evo-cand-006082-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006082-route-evolution-graph`
