...
- External category reference: `evobc-cat-09429`
- Source category ID: `09429`
- Source label for human review: `錔`
- Source codepoints: `U+9314`
...
- `obs-evo-cand-009429-route-category-staging`
...
- `obs-evo-cand-009429-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009429-route-evolution-graph`
