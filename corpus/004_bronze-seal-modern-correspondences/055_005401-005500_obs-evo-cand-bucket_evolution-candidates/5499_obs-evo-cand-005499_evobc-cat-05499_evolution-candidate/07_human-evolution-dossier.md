...
- External category reference: `evobc-cat-05499`
- Source category ID: `05499`
- Source label for human review: `瓘`
...
- `obs-evo-cand-005499-route-category-staging`
...
- `obs-evo-cand-005499-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005499-route-evolution-graph`
