# obs-char-000223 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000223`
- primary external id: `hust-obc-cat-0248`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/223_obs-char-000223_hust-obc-cat-0248_orac
  le-character/03_visual-assets/001_asset-000228_hust-obc-cat-0248_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0248/G_0248_中大11.png`
- asset id: `asset-000228`
...
- source category: `0248`
- validation class: `222`
- source image route: `HUST-OBC/deciphered/0248/G_0248_中大11.png`
- asset id: `asset-000228`
...
- English observation: `The very narrow image has a long descending stroke
  with a short diagonal branch projecting toward the lower right.`
...
- dataset label text: `㓮`
- dataset label codepoints: `U+34EE`
...
- Which source records identify obs-char-000223 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000223？
