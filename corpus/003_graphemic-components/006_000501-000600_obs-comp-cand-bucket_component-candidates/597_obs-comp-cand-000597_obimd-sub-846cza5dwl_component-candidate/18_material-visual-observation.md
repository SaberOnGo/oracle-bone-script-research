# Material Visual Observation / obs-comp-cand-000597 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000597`
- External reference / 外部参照: `obimd-sub-846cza5dwl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013125_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/846cza5dwl/846cza5dwl/846cza5dwl.png`
- Checksum / 校验和:
  `7724cb414e9b5b196150cc97b5fb37657caddd50db95443b74639eed16de2d0a`
...
- Marked-pixel bounds: (81,15)–(168,234); span 88 × 220 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.83%。
- 痕迹范围：(81,15)–(168,234)；跨度88 × 220 px；痕迹矩形高于宽。
