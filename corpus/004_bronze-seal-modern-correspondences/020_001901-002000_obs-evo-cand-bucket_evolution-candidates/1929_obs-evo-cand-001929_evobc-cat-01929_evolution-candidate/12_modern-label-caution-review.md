# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001929
...
- EVOBC candidate category: `evobc-evo-cat-01929`.
- Source label for search only: `塼`.
- Source codepoints for search only: `U+587C`.
