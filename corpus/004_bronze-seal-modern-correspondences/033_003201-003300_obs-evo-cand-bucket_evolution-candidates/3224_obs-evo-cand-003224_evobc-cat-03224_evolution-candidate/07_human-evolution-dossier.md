...
- External category reference: `evobc-cat-03224`
- Source category ID: `03224`
...
- `obs-evo-cand-003224-route-category-staging`
...
- `obs-evo-cand-003224-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003224-route-evolution-graph`
