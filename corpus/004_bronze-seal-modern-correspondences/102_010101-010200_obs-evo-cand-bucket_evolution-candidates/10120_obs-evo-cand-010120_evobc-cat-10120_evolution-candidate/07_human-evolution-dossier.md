...
Project ID: `obs-evo-cand-010120`
...
- Project ID: `obs-evo-cand-010120`
- EVOBC category candidate ID: `evobc-evo-cat-10120`
- External category reference: `evobc-cat-10120`
- Source category ID: `10120`
- Source label for human review: `餱`
- Source codepoints: `U+9931`
...
- `obs-evo-cand-010120-route-category-staging`
...
- `obs-evo-cand-010120-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010120-route-evolution-graph`
