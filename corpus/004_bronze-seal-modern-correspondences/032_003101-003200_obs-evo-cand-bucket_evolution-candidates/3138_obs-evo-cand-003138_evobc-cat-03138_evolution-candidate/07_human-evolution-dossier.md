...
- External category reference: `evobc-cat-03138`
- Source category ID: `03138`
- Source label for human review: `慽`
- Source codepoints: `U+617D`
...
- `obs-evo-cand-003138-route-category-staging`
...
- `obs-evo-cand-003138-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003138-route-evolution-graph`
