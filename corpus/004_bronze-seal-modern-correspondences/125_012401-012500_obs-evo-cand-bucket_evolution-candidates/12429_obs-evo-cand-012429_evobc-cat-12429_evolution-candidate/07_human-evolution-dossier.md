...
- External category reference: `evobc-cat-12429`
- Source category ID: `12429`
- Source label for human review: `𨛡`
- Source codepoints: `U+286E1`
...
- `obs-evo-cand-012429-route-category-staging`
...
- `obs-evo-cand-012429-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012429-route-evolution-graph`
