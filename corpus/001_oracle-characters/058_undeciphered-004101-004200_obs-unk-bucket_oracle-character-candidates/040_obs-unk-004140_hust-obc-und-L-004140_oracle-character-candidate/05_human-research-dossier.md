# obs-unk-004140 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004140`
- primary external id: `hust-obc-und-L-004140`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/040_obs-unk-004140_h
  ust-obc-und-L-004140_oracle-character-candidate/03_visual-assets/001_asset
  -005733_hust-obc-und-L-004140_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4140/L_？_8953.jpg`
- asset id: `asset-005733`
...
- source class: `HUST-OBC/undeciphered/L/4140/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4140/L_？_8953.jpg`
- asset id: `asset-005733`
...
- English observation: Detached marks line the left of a taller curved right
  cluster with a narrowed lower junction.
- 中文观察：分离痕迹排列在较高右侧弯曲痕迹簇左边，下部逐渐收窄。
...
- Which source records identify obs-unk-004140 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004140？
