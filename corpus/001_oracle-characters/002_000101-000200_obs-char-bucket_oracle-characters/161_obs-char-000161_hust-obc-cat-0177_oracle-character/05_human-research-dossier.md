# obs-char-000161 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000161`
- primary external id: `hust-obc-cat-0177`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/161_obs-char-000161_hust-obc-cat-0177_orac
  le-character/03_visual-assets/001_asset-000166_hust-obc-cat-0177_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0177/G_0177_後2.20.10合17961賓組.pn
  g`
- asset id: `asset-000166`
...
- source category: `0177`
- validation class: `160`
- source image route: `HUST-OBC/deciphered/0177/G_0177_後2.20.10合17961賓組.png`
- asset id: `asset-000166`
...
- English observation: `The narrow image has a dense branched upper cluster,
  a long central descending stroke, and short irregular marks along the
  right side.`
...
- dataset label text: `㒧`
- dataset label codepoints: `U+34A7`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00015`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00015`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00015`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/015_obs-evo-can
  d-000015_evobc-cat-00015_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/015_obs-evo-cand-000015_evobc-cat-00015_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合17961
  (G_0177_後2.20.10合17961賓組.png)`
...
- Which source records identify obs-char-000161 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000161？
