# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010713
...
- EVOBC candidate category: `evobc-evo-cat-10713`.
- Source label for search only: `齍`.
- Source codepoints for search only: `U+9F4D`.
