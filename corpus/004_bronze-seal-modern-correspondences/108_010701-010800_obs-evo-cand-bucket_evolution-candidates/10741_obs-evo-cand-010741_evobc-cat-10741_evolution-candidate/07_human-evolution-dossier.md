...
- Project ID: `obs-evo-cand-010741`
- EVOBC category candidate ID: `evobc-evo-cat-10741`
- External category reference: `evobc-cat-10741`
- Source category ID: `10741`
- Source label for human review: `齺`
- Source codepoints: `U+9F7A`
...
- `obs-evo-cand-010741-route-category-staging`
...
- `obs-evo-cand-010741-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010741-route-evolution-graph`
