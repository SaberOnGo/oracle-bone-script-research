...
- External category reference: `evobc-cat-05844`
- Source category ID: `05844`
- Source label for human review: `瞂`
...
- `obs-evo-cand-005844-route-category-staging`
...
- `obs-evo-cand-005844-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005844-route-evolution-graph`
