# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000686
...
| Glyph or codepoint route / 字形或码位路线 | 6 OBIMD route rows; examples U+F3ECA; U+F3ECB; 另有 4 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
