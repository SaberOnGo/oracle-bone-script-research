# Material Visual Observation / obs-comp-cand-000474 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000474`
- External reference / 外部参照: `obimd-sub-ah10xtkbxp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012624_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ah10xtkbxp/ah10xtkbxp/ah10xtkbxp.png`
- Checksum / 校验和:
  `8afc6f1bc7ae68edc39eeca83b88a24acb0d633c8c9a02abc592868a0c36ede3`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.38%.
- Marked-pixel bounds: (77,20)–(191,231); span 115 × 212 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.38%。
- 痕迹范围：(77,20)–(191,231)；跨度115 × 212 px；痕迹矩形高于宽。
