...
Project ID: `obs-evo-cand-012220`
...
- Project ID: `obs-evo-cand-012220`
- EVOBC category candidate ID: `evobc-evo-cat-12220`
- External category reference: `evobc-cat-12220`
- Source category ID: `12220`
- Source label for human review: `𧥧`
- Source codepoints: `U+27967`
...
- `obs-evo-cand-012220-route-category-staging`
...
- `obs-evo-cand-012220-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012220-route-evolution-graph`
