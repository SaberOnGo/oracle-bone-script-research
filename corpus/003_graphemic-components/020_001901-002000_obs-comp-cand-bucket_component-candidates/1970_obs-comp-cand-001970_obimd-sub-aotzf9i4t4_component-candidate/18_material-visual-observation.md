# Material Visual Observation / obs-comp-cand-001970 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001970`
- External reference / 外部参照: `obimd-sub-aotzf9i4t4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018962_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/aotzf9i4t4/aotzf9i4t4/aotzf9i4t4.png`
- Checksum / 校验和:
  `a7090ecb5cf2f493c87f1b6adb5dc3fe0ed3595fc1fbf2c6e03c2ce223e205c2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.09%.
- Marked-pixel bounds: (51,28)–(204,219); span 154 × 192 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.09%。
- 痕迹范围：(51,28)–(204,219)；跨度154 × 192 px；痕迹矩形高于宽。
