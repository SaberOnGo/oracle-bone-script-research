# obs-unk-003149 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003149`
- primary external id: `hust-obc-und-L-003149`
...
- local review image route: `corpus/001_oracle-characters/048_undeciphered-003
  101-003200_obs-unk-bucket_oracle-character-candidates/049_obs-unk-003149_h
  ust-obc-und-L-003149_oracle-character-candidate/03_visual-assets/001_asset
  -004742_hust-obc-und-L-003149_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3149/L_？_5796.jpg`
- asset id: `asset-004742`
...
- source class: `HUST-OBC/undeciphered/L/3149/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3149/L_？_5796.jpg`
- asset id: `asset-004742`
...
- Which source records identify obs-unk-003149 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003149？
