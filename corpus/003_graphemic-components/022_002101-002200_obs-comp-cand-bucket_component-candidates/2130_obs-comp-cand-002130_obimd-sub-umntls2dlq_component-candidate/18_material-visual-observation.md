# Material Visual Observation / obs-comp-cand-002130 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002130`
- External reference / 外部参照: `obimd-sub-umntls2dlq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019687_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/umntls2dlq/umntls2dlq/umntls2dlq.png`
- Checksum / 校验和:
  `ca6d432d07d8e57aa275da3b3db7c94464f51b68530f4f5593b25cf55377ee03`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.51%.
- Marked-pixel bounds: (81,33)–(168,210); span 88 × 178 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.51%。
- 痕迹范围：(81,33)–(168,210)；跨度88 × 178 px；痕迹矩形高于宽。
