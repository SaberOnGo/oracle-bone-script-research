...
- Project ID: `obs-evo-cand-010303`
- EVOBC category candidate ID: `evobc-evo-cat-10303`
- External category reference: `evobc-cat-10303`
- Source category ID: `10303`
- Source label for human review: `髑`
- Source codepoints: `U+9AD1`
...
- `obs-evo-cand-010303-route-category-staging`
...
- `obs-evo-cand-010303-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010303-route-evolution-graph`
