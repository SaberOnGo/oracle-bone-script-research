# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006760
...
- EVOBC candidate category: `evobc-evo-cat-06760`.
- Source label for search only: `绳`.
- Source codepoints for search only: `U+7EF3`.
