# obs-char-000868 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000868`
- primary external id: `hust-obc-cat-0979`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/868_obs-char-000868_hust-obc-cat-0979_orac
  le-character/03_visual-assets/001_asset-000873_hust-obc-cat-0979_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0979/G_0979_京津3835合29907.png`
- asset id: `asset-000873`
...
- source category: `0979`
- validation class: `867`
- source image route: `HUST-OBC/deciphered/0979/G_0979_京津3835合29907.png`
- asset id: `asset-000873`
...
- English observation: `A thin left descending stroke stands beside a
  compact angular upper form and a lower rectangular enclosure.`
- 中文观察: `纤细左侧下垂笔旁有紧凑折角上部形体和下方矩形闭合轮廓。`
...
- dataset label text: `㟉`
- dataset label codepoints: `U+37C9`
...
- filename catalog route clues: `Heji-like filename clue: 合29907
  (G_0979_京津3835合29907.png)`
...
- Which source records identify obs-char-000868 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000868？
