...
- Direct visual observations currently cover `5531` of `10996` images.
- 当前直接视觉观察覆盖 `10996` 幅图像中的 `5531` 幅。
- Images with a local derivative but no direct observation: `5465`.
- 已有本地派生件但尚无直接观察的图像：`5465` 幅。
