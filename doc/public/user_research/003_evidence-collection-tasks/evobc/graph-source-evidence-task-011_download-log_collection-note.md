...
- Evidence collection task ID / 证据收集任务 ID: `graph-source-evidence-task-011`
...
- Target evidence section / 目标证据章节: `download_log`
- Collection scope / 收集范围: `collect_download_log_rows_and_access_or_checksum_notes`
- Expected output path from task queue / 任务队列预期输出路径: `doc/public/user_research/003_evidence-collection-tasks/evobc/graph-source-evidence-task-011_download-log_collection-note.md`
...
- Collection scope / 收集范围:
  - `collect_download_log_rows_and_access_or_checksum_notes`
- Task status / 任务状态:
  - `not_started`
