# Material Visual Observation / obs-comp-cand-000093 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000093`
- External reference / 外部参照: `obimd-sub-ya2h4cjfaz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011505_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ya2h4cjfaz/ya2h4cjfaz/ya2h4cjfaz.png`
- Checksum / 校验和:
  `108a90f3ee011faadeeb251b2b35e197bff71c4a3508be75a6953d2f429ef1cd`
...
- Marked-pixel bounds: (70,28)–(179,220); span 110 × 193 px; the marked
...
- 痕迹范围：(70,28)–(179,220)；跨度110 × 193 px；痕迹矩形高于宽。
