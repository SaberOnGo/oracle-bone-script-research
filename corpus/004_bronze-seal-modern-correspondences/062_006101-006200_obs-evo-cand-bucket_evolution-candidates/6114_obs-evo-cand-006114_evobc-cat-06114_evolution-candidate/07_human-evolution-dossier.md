...
- Project ID: `obs-evo-cand-006114`
- EVOBC category candidate ID: `evobc-evo-cat-06114`
- External category reference: `evobc-cat-06114`
- Source category ID: `06114`
- Source label for human review: `稹`
- Source codepoints: `U+7A39`
...
- `obs-evo-cand-006114-route-category-staging`
...
- `obs-evo-cand-006114-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006114-route-evolution-graph`
