...
- External category reference: `evobc-cat-01900`
- Source category ID: `01900`
...
- `obs-evo-cand-001900-route-category-staging`
...
- `obs-evo-cand-001900-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001900-route-evolution-graph`
