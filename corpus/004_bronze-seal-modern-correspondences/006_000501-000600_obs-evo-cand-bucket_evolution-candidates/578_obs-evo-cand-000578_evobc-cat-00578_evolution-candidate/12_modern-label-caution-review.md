# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000578
...
- EVOBC candidate category: `evobc-evo-cat-00578`.
- Source label for search only: `䱜`.
- Source codepoints for search only: `U+4C5C`.
