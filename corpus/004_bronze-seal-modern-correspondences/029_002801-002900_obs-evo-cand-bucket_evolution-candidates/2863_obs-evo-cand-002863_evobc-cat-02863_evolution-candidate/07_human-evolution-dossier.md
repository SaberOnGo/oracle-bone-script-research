...
- External category reference: `evobc-cat-02863`
- Source category ID: `02863`
- Source label for human review: `待`
- Source codepoints: `U+5F85`
...
- `obs-evo-cand-002863-route-category-staging`
...
- `obs-evo-cand-002863-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002863-route-evolution-graph`
