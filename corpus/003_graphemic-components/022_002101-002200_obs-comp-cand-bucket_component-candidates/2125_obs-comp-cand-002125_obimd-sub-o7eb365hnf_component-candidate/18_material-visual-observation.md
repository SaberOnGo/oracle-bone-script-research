# Material Visual Observation / obs-comp-cand-002125 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002125`
- External reference / 外部参照: `obimd-sub-o7eb365hnf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019682_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/o7eb365hnf/o7eb365hnf/o7eb365hnf.png`
- Checksum / 校验和:
  `5b70ffb54071fbfe09154ab1cbde313483e69727985fb22472466db93a5b64e9`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.07%.
- Marked-pixel bounds: (43,31)–(221,216); span 179 × 186 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.07%。
- 痕迹范围：(43,31)–(221,216)；跨度179 × 186 px；痕迹矩形近方形。
