# obs-char-000419 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000419`
- primary external id: `hust-obc-cat-0475`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/419_obs-char-000419_hust-obc-cat-0475_orac
  le-character/03_visual-assets/001_asset-000424_hust-obc-cat-0475_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0475/H_0475_602A3_0.png`
- asset id: `asset-000424`
...
- source category: `0475`
- validation class: `418`
- source image route: `HUST-OBC/deciphered/0475/H_0475_602A3_0.png`
- asset id: `asset-000424`
...
- English observation: `Two separated bold forms are visible: a capped
  rectangular cross at left and a large crossed upper loop with an angular
  lower extension at right.`
- 中文观察: `可见两个粗重分离形体：左侧为带横帽矩形交叉，右侧为大型交叉上部环形及折角下部延伸。`
...
- dataset label text: `㗑`
- dataset label codepoints: `U+35D1`
...
- filename catalog route clues: `catalog-like filename clue: H_0475
  (H_0475_602A3_0.png)`
...
- Which source records identify obs-char-000419 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000419？
