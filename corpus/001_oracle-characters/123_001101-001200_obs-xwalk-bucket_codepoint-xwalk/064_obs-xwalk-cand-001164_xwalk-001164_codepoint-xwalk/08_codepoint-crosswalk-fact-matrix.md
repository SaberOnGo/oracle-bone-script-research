# obs-xwalk-cand-001164 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+390D` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-1303` | not reading |
