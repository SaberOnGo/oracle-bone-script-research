# Material Visual Observation / obs-comp-cand-000864 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000864`
- External reference / 外部参照: `obimd-sub-xhh4txsh2g`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013861_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xhh4txsh2g/xhh4txsh2g/xhh4txsh2g.png`
- Checksum / 校验和:
  `2bd22f4bcbc9b15ae62e999231425e850fd018d06d5dc0bd0f70255f8ce0ed7a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.45%.
- Marked-pixel bounds: (57,22)–(204,229); span 148 × 208 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.45%。
- 痕迹范围：(57,22)–(204,229)；跨度148 × 208 px；痕迹矩形高于宽。
