...
- Yingguo / 英国所藏: `y462` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `137` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `380` in source row; primary catalog entry pending
- Heji / 合集: `39721` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000070`
