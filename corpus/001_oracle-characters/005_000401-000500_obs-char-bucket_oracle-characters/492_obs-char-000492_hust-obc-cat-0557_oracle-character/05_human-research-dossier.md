# obs-char-000492 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/492_obs-char-000492_hust-obc-cat-0557_orac
  le-character/03_visual-assets/001_asset-000497_hust-obc-cat-0557_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0557/H_0557_61182_0.png`
- asset id: `asset-000497`
...
- source category: `0557`
- validation class: `491`
- source image route: `HUST-OBC/deciphered/0557/H_0557_61182_0.png`
- asset id: `asset-000497`
...
- English observation: `A long top bar and left vertical form an open frame
  around detached inner dashes, a branching central stem, and a crossed
  cluster extending toward the lower right.`
...
- dataset label text: `㘣`
- dataset label codepoints: `U+3623`
...
- filename catalog route clues: `catalog-like filename clue: H_0557
  (H_0557_61182_0.png)`
...
- Which source records identify obs-char-000492 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000492？
