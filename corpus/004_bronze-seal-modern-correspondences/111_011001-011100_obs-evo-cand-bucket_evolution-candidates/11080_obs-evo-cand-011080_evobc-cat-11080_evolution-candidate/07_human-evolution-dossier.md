...
Project ID: `obs-evo-cand-011080`
...
- Project ID: `obs-evo-cand-011080`
- EVOBC category candidate ID: `evobc-evo-cat-11080`
- External category reference: `evobc-cat-11080`
- Source category ID: `11080`
- Source label for human review: `𡩝`
- Source codepoints: `U+21A5D`
...
- `obs-evo-cand-011080-route-category-staging`
...
- `obs-evo-cand-011080-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011080-route-evolution-graph`
