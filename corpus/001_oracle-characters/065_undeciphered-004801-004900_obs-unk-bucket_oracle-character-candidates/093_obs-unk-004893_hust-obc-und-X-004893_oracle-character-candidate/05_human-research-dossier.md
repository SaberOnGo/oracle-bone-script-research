# obs-unk-004893 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004893`
- primary external id: `hust-obc-und-X-004893`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/093_obs-unk-004893_h
  ust-obc-und-X-004893_oracle-character-candidate/03_visual-assets/001_asset
  -006486_hust-obc-und-X-004893_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/449/X_？_7125_1.png`
- asset id: `asset-006486`
...
- source class: `HUST-OBC/undeciphered/X/449/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/449/X_？_7125_1.png`
- asset id: `asset-006486`
...
- English observation: `left branched stroke and right diamond opening`
- 中文观察: `左侧分枝长笔画和右侧菱形开口`
...
- Which source records identify obs-unk-004893 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004893？
