...
- Yingguo / 英国所藏: `y2109` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `459` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `91` in source row; primary catalog entry pending
- Heji / 合集: `41136` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000370`
