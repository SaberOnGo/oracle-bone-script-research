# obs-unk-004829 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/029_obs-unk-004829_h
  ust-obc-und-X-004829_oracle-character-candidate/03_visual-assets/001_asset
  -006422_hust-obc-und-X-004829_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/385/X_？_7368_1.png`
- asset id: `asset-006422`
...
- source class: `HUST-OBC/undeciphered/X/385/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/385/X_？_7368_1.png`
- asset id: `asset-006422`
...
- English observation: `separated upper bar and lower rectangular opening`
- 中文观察: `分离的上部横向结构和下部矩形开口`
...
- Which source records identify obs-unk-004829 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004829？
