# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004466
...
- EVOBC candidate category: `evobc-evo-cat-04466`.
- Source label for search only: `氊`.
- Source codepoints for search only: `U+6C0A`.
