# obs-unk-004603 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/003_obs-unk-004603_h
  ust-obc-und-X-004603_oracle-character-candidate/03_visual-assets/001_asset
  -006196_hust-obc-und-X-004603_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/159/X_？_8335_1.png`
- asset id: `asset-006196`
...
- source class: `HUST-OBC/undeciphered/X/159/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/159/X_？_8335_1.png`
- asset id: `asset-006196`
...
- English observation: `Central stem, upper branches, lower branch, and`
  `point recorded.`
- 中文观察: `已记录中央主痕、上部分支、下部分支和尖端。`
...
- Which source records identify obs-unk-004603 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004603？
