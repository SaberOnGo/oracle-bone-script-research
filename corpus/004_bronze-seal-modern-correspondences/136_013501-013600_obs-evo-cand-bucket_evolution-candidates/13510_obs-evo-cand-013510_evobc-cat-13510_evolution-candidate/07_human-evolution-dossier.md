...
- External category reference: `evobc-cat-13510`
- Source category ID: `13510`
- Source label for human review: `𭔎`
- Source codepoints: `U+2D50E`
...
- `obs-evo-cand-013510-route-category-staging`
...
- `obs-evo-cand-013510-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013510-route-evolution-graph`
