...
- Project ID: `obs-evo-cand-002396`
- EVOBC category candidate ID: `evobc-evo-cat-02396`
- External category reference: `evobc-cat-02396`
- Source category ID: `02396`
- Source label for human review: `宴`
- Source codepoints: `U+5BB4`
...
- `obs-evo-cand-002396-route-category-staging`
...
- `obs-evo-cand-002396-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002396-route-evolution-graph`
