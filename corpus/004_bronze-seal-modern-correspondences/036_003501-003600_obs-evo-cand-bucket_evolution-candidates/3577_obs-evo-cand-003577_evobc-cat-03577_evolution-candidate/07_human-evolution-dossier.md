...
Project ID: `obs-evo-cand-003577`
...
- Project ID: `obs-evo-cand-003577`
- EVOBC category candidate ID: `evobc-evo-cat-03577`
- External category reference: `evobc-cat-03577`
- Source category ID: `03577`
- Source label for human review: `敋`
- Source codepoints: `U+654B`
...
- `obs-evo-cand-003577-route-category-staging`
...
- `obs-evo-cand-003577-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003577-route-evolution-graph`
