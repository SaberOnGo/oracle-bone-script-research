# obs-unk-004675 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004675`
- primary external id: `hust-obc-und-X-004675`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/075_obs-unk-004675_h
  ust-obc-und-X-004675_oracle-character-candidate/03_visual-assets/001_asset
  -006268_hust-obc-und-X-004675_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/231/X_？_8400_1.png`
- asset id: `asset-006268`
...
- source class: `HUST-OBC/undeciphered/X/231/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/231/X_？_8400_1.png`
- asset id: `asset-006268`
...
- English observation: `tall form with three central openings and bent terminal`
- 中文观察: `带三个中央开口和弯曲末端的高形笔画`
...
- Which source records identify obs-unk-004675 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004675？
