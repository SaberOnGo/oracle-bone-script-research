# obs-unk-004210 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/010_obs-unk-004210_h
  ust-obc-und-L-004210_oracle-character-candidate/03_visual-assets/001_asset
  -005803_hust-obc-und-L-004210_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4210/L_？_9167.jpg`
- asset id: `asset-005803`
...
- source class: `HUST-OBC/undeciphered/L/4210/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4210/L_？_9167.jpg`
- asset id: `asset-005803`
...
- English observation: `Upper point, cross trace, and lower waves visible.`
- 中文观察: `上部尖顶、交叉痕迹和下部波曲笔画可见。`
...
- Which source records identify obs-unk-004210 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004210？
