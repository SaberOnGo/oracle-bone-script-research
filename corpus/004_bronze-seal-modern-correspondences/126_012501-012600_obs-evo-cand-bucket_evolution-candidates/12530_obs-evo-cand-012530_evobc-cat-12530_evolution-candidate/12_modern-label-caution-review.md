# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012530
...
- EVOBC candidate category: `evobc-evo-cat-12530`.
- Source label for search only: `𨽽`.
- Source codepoints for search only: `U+28F7D`.
