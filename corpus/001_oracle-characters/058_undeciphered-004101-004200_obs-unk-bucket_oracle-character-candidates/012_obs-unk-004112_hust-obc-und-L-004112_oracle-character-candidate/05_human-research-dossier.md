# obs-unk-004112 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004112`
- primary external id: `hust-obc-und-L-004112`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/012_obs-unk-004112_h
  ust-obc-und-L-004112_oracle-character-candidate/03_visual-assets/001_asset
  -005705_hust-obc-und-L-004112_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4112/L_？_8848.jpg`
- asset id: `asset-005705`
...
- source class: `HUST-OBC/undeciphered/L/4112/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4112/L_？_8848.jpg`
- asset id: `asset-005705`
...
- English observation: The opened image shows a central enclosed form, a thin
  right curve, and fine branching strokes at lower left.
- 中文观察：已打开图像可见中央封闭形态、右侧细弯线和左下分支笔画。
...
- Which source records identify obs-unk-004112 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004112？
