# Material Visual Observation / obs-comp-cand-001016 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001016`
- External reference / 外部参照: `obimd-sub-b9o5x78opw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014498_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/47ioadp9wd/b9o5x78opw/b9o5x78opw.png`
- Checksum / 校验和:
  `a21c48a8bd8e3a03fa9288acd3d7aeb622096fc730a16a10d179892bf6a93b2a`
...
- Marked-pixel bounds: (55,81)–(193,168); span 139 × 88 px; the marked rectangle
  is wider than tall.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.21%。
- 痕迹范围：(55,81)–(193,168)；跨度139 × 88 px；痕迹矩形宽于高。
