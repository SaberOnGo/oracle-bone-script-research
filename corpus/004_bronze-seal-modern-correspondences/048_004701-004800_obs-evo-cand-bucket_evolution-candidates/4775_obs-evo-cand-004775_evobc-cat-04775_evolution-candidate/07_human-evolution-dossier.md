...
- External category reference: `evobc-cat-04775`
- Source category ID: `04775`
- Source label for human review: `湄`
- Source codepoints: `U+6E44`
...
- `obs-evo-cand-004775-route-category-staging`
...
- `obs-evo-cand-004775-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004775-route-evolution-graph`
