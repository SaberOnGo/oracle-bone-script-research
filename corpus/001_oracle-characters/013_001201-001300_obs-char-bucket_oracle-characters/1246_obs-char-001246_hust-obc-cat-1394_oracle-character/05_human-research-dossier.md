# obs-char-001246 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001246`
- primary external id: `hust-obc-cat-1394`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1246_obs-char-001246_hust-obc-cat-1394_ora
  cle-character/03_visual-assets/001_asset-001251_hust-obc-cat-1394_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1394/L_1394_8272.jpg`
- asset id: `asset-001251`
...
- source category: `1394`
- validation class: `1245`
- source image route: `HUST-OBC/deciphered/1394/L_1394_8272.jpg`
- asset id: `asset-001251`
...
- English observation: `A small dense rounded cluster has a dark outer
  contour, several inner angular marks, and limited resolution.`
- 中文观察: `小型密集圆拱笔画群有深色外轮廓、数个内部折角笔画，图像分辨率有限。`
...
- dataset label text: `㥨`
- dataset label codepoints: `U+3968`
...
- Which source records identify obs-char-001246 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001246？
