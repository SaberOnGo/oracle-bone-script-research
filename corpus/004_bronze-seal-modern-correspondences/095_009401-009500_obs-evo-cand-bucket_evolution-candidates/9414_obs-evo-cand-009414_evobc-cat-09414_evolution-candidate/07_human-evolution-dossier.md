...
- External category reference: `evobc-cat-09414`
- Source category ID: `09414`
...
- `obs-evo-cand-009414-route-category-staging`
...
- `obs-evo-cand-009414-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009414-route-evolution-graph`
