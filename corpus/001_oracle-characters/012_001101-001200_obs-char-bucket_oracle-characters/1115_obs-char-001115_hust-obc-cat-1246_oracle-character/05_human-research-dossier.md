# obs-char-001115 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001115`
- primary external id: `hust-obc-cat-1246`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1115_obs-char-001115_hust-obc-cat-1246_ora
  cle-character/03_visual-assets/001_asset-001120_hust-obc-cat-1246_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1246/G_1246_京津2746(甲).png`
- asset id: `asset-001120`
...
- source category: `1246`
- validation class: `1114`
- source image route: `HUST-OBC/deciphered/1246/G_1246_京津2746(甲).png`
- asset id: `asset-001120`
...
- English observation: `A slender upright form has two short upper prongs, a
  long central stem, and a broad low arch with side drops.`
- 中文观察: `纤细直立形体有两个短上部分叉、长中央笔干和带两侧下垂笔的宽大低位拱弧。`
...
- dataset label text: `㣔`
- dataset label codepoints: `U+38D4`
...
- Which source records identify obs-char-001115 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001115？
