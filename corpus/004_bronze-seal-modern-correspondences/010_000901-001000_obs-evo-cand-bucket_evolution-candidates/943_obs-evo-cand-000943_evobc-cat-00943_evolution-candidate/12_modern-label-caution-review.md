# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000943
...
- EVOBC candidate category: `evobc-evo-cat-00943`.
- Source label for search only: `值`.
- Source codepoints for search only: `U+503C`.
