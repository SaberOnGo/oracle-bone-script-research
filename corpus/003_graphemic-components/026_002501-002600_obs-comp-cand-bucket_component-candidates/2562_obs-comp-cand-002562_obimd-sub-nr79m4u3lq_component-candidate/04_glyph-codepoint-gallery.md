# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002562
...
| --- | --- | --- | --- |
| `obimd-glyph-link-039323` | 󾢼 | `U+FE8BC` | `reviewed_metadata_only` |
| `obimd-glyph-link-039324` | 󾢽 | `U+FE8BD` | `reviewed_metadata_only` |
