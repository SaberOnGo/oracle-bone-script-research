...
- External category reference: `evobc-cat-00213`
- Source category ID: `00213`
- Source label for human review: `㴪`
- Source codepoints: `U+3D2A`
...
- `obs-evo-cand-000213-route-category-staging`
...
- `obs-evo-cand-000213-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000213-route-evolution-graph`
