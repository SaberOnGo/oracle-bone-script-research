# Material Visual Observation / obs-comp-cand-000492 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000492`
- External reference / 外部参照: `obimd-sub-papxu0m6p6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012728_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/papxu0m6p6/papxu0m6p6/papxu0m6p6.png`
- Checksum / 校验和:
  `2252031e44015b98a8402bd0bf9808579e27ced81ec06fa43008874223cf4c68`
...
- Marked-pixel bounds: (56,35)–(193,208); span 138 × 174 px; the marked
...
- 痕迹范围：(56,35)–(193,208)；跨度138 × 174 px；痕迹矩形高于宽。
