...
Project ID: `obs-evo-cand-001779`
...
- Project ID: `obs-evo-cand-001779`
- EVOBC category candidate ID: `evobc-evo-cat-01779`
- External category reference: `evobc-cat-01779`
- Source category ID: `01779`
- Source label for human review: `圉`
- Source codepoints: `U+5709`
...
- `obs-evo-cand-001779-route-category-staging`
...
- `obs-evo-cand-001779-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001779-route-evolution-graph`
