# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006101
...
- EVOBC candidate category: `evobc-evo-cat-06101`.
- Source label for search only: `稚`.
- Source codepoints for search only: `U+7A1A`.
