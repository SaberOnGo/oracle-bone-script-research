...
- External category reference: `evobc-cat-02401`
- Source category ID: `02401`
- Source label for human review: `容`
- Source codepoints: `U+5BB9`
...
- `obs-evo-cand-002401-route-category-staging`
...
- `obs-evo-cand-002401-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002401-route-evolution-graph`
