...
- External category reference: `evobc-cat-10204`
- Source category ID: `10204`
- Source label for human review: `駻`
...
- `obs-evo-cand-010204-route-category-staging`
...
- `obs-evo-cand-010204-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010204-route-evolution-graph`
