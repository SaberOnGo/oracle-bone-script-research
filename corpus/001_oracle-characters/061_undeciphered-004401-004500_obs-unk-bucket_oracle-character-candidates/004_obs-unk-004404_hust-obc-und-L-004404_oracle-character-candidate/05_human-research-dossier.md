# obs-unk-004404 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/004_obs-unk-004404_h
  ust-obc-und-L-004404_oracle-character-candidate/03_visual-assets/001_asset
  -005997_hust-obc-und-L-004404_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4404/L_？_9834.jpg`
- asset id: `asset-005997`
...
- source class: `HUST-OBC/undeciphered/L/4404/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4404/L_？_9834.jpg`
- asset id: `asset-005997`
...
- English observation: `A pointed upper trace sits above a compact cluster with`
  `curved side projections.`
- 中文观察: `上部尖痕位于紧凑痕迹群上方，侧边有弧形伸出痕迹。`
...
- Which source records identify obs-unk-004404 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004404？
