...
- External category reference: `evobc-cat-02685`
- Source category ID: `02685`
- Source label for human review: `幣`
- Source codepoints: `U+5E63`
...
- `obs-evo-cand-002685-route-category-staging`
...
- `obs-evo-cand-002685-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002685-route-evolution-graph`
