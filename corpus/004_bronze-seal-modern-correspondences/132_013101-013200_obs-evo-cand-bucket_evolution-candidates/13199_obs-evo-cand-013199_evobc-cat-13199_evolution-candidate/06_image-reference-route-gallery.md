...
- `obs-evo-cand-013199-route-category-staging`
...
- `obs-evo-cand-013199-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013199-route-evolution-graph`
