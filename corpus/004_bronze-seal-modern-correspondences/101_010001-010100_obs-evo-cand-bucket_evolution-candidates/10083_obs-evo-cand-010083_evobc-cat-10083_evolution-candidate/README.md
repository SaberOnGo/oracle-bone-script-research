# obs-evo-cand-010083 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-010083`
- EVOBC category candidate ID: `evobc-evo-cat-10083`
- External category ref: `evobc-cat-10083`
- Source label: `飤`
- Source codepoints: `U+98E4`
- Image reference count: `35`
- Era token counts: `BI:11;OBC:11;SAC:12;SS:1`
- Source token counts: `Book:27;Web:8`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 11 image references
