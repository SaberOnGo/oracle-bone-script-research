...
- Project ID: `obs-evo-cand-009225`
- EVOBC category candidate ID: `evobc-evo-cat-09225`
- External category reference: `evobc-cat-09225`
- Source category ID: `09225`
- Source label for human review: `鄾`
- Source codepoints: `U+913E`
...
- `obs-evo-cand-009225-route-category-staging`
...
- `obs-evo-cand-009225-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009225-route-evolution-graph`
