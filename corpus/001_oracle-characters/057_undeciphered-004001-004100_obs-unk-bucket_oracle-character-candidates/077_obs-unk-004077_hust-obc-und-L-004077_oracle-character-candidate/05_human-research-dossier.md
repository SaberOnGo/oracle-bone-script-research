# obs-unk-004077 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/077_obs-unk-004077_h
  ust-obc-und-L-004077_oracle-character-candidate/03_visual-assets/001_asset
  -005670_hust-obc-und-L-004077_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4077/L_？_8736.jpg`
- asset id: `asset-005670`
...
- source class: `HUST-OBC/undeciphered/L/4077/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4077/L_？_8736.jpg`
- asset id: `asset-005670`
...
- English observation: A broad upper trace forms a shallow bar or enclosure. A
  narrow central trace descends below it, with a shorter angled mark near the
  lower end; the upper boundary and lower join are partly unclear.
- 中文观察：上部有一条较宽的浅弧形横向痕迹或轮廓。中央有一条狭长痕迹向下延伸，
  下端附近带有较短的斜向痕迹；上部边界和下部连接处部分不清楚。
...
- Which source records identify obs-unk-004077 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004077？
