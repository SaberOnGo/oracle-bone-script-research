...
Project ID: `obs-evo-cand-007458`
...
- Project ID: `obs-evo-cand-007458`
- EVOBC category candidate ID: `evobc-evo-cat-07458`
- External category reference: `evobc-cat-07458`
- Source category ID: `07458`
- Source label for human review: `萹`
- Source codepoints: `U+8439`
...
- `obs-evo-cand-007458-route-category-staging`
...
- `obs-evo-cand-007458-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007458-route-evolution-graph`
