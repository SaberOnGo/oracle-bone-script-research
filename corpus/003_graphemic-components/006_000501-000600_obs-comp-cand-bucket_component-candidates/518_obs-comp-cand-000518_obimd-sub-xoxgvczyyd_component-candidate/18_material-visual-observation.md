# Material Visual Observation / obs-comp-cand-000518 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000518`
- External reference / 外部参照: `obimd-sub-xoxgvczyyd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012753_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xoxgvczyyd/xoxgvczyyd/xoxgvczyyd.png`
- Checksum / 校验和:
  `5180c1285e6d4dab62848c59b5925e1d61e261b6d1f19d18a35a7ad1e7adbab8`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.46%.
- Marked-pixel bounds: (50,47)–(199,203); span 150 × 157 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.46%。
- 痕迹范围：(50,47)–(199,203)；跨度150 × 157 px；痕迹矩形近方形。
