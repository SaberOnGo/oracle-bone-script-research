...
- `obs-evo-cand-013107-route-category-staging`
...
- `obs-evo-cand-013107-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013107-route-evolution-graph`
