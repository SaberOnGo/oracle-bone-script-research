# obs-char-000230 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/230_obs-char-000230_hust-obc-cat-0256_orac
  le-character/03_visual-assets/001_asset-000235_hust-obc-cat-0256_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0256/G_0256_乙1239反.png`
- asset id: `asset-000235`
...
- source category: `0256`
- validation class: `229`
- source image route: `HUST-OBC/deciphered/0256/G_0256_乙1239反.png`
- asset id: `asset-000235`
...
- English observation: `The narrow image has a long central descending
  stroke with several short curved side strokes opening toward the left.`
...
- dataset label text: `㓶`
- dataset label codepoints: `U+34F6`
...
- Which source records identify obs-char-000230 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000230？
