...
- Project ID: `obs-evo-cand-010149`
- EVOBC category candidate ID: `evobc-evo-cat-10149`
- External category reference: `evobc-cat-10149`
- Source category ID: `10149`
- Source label for human review: `饶`
- Source codepoints: `U+9976`
...
- `obs-evo-cand-010149-route-category-staging`
...
- `obs-evo-cand-010149-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010149-route-evolution-graph`
