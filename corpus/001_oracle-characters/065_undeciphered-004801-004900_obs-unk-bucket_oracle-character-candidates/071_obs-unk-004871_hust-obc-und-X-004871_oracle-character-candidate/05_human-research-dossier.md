# obs-unk-004871 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/071_obs-unk-004871_h
  ust-obc-und-X-004871_oracle-character-candidate/03_visual-assets/001_asset
  -006464_hust-obc-und-X-004871_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/427/X_？_7410_1.png`
- asset id: `asset-006464`
...
- source class: `HUST-OBC/undeciphered/X/427/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/427/X_？_7410_1.png`
- asset id: `asset-006464`
...
- English observation: `upright upper outline and lower U-like outline`
- 中文观察: `上部直立外框和下部 U 形外框`
...
- Which source records identify obs-unk-004871 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004871？
