...
- Project ID: `obs-evo-cand-013151`
- EVOBC category candidate ID: `evobc-evo-cat-13151`
- External category reference: `evobc-cat-13151`
- Source category ID: `13151`
- Source label for human review: `𫺽`
- Source codepoints: `U+2BEBD`
...
- `obs-evo-cand-013151-route-category-staging`
...
- `obs-evo-cand-013151-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013151-route-evolution-graph`
