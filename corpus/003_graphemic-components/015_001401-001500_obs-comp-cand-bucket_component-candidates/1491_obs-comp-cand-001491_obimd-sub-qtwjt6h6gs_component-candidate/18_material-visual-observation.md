# Material Visual Observation / obs-comp-cand-001491 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001491`
- External reference / 外部参照: `obimd-sub-qtwjt6h6gs`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016102_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qtwjt6h6gs/qtwjt6h6gs/qtwjt6h6gs.png`
- Checksum / 校验和:
  `a732c4248605f0a2f1bea915d65a371613eb13f0c292c29a99d50011197dc626`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.41%.
- Marked-pixel bounds: (74,49)–(184,196); span 111 × 148 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.41%。
- 痕迹范围：(74,49)–(184,196)；跨度111 × 148 px；痕迹矩形高于宽。
