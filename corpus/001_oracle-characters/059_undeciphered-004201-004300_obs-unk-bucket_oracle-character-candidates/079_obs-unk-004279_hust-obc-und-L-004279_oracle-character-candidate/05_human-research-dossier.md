# obs-unk-004279 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/079_obs-unk-004279_h
  ust-obc-und-L-004279_oracle-character-candidate/03_visual-assets/001_asset
  -005872_hust-obc-und-L-004279_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4279/L_？_9451.jpg`
- asset id: `asset-005872`
...
- source class: `HUST-OBC/undeciphered/L/4279/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4279/L_？_9451.jpg`
- asset id: `asset-005872`
...
- English observation: `Upper bars, central line, pointed outline visible.`
- 中文观察: `上部横痕、中央竖痕和尖细下部轮廓可见。`
...
- Which source records identify obs-unk-004279 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004279？
