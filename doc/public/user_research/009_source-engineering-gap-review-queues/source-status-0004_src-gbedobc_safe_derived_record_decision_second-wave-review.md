...
- Review draft ID / 复核草稿 ID: `source-engineering-second-wave-review-draft-0004`
- Continuation task ID / 后续任务 ID: `source-engineering-second-wave-source-checklist-0004`
- Source status ID / 来源状态 ID: `source-engineering-first-wave-source-status-0004`
...
- First-wave status / 第一波状态: `metadata_profiles_available_safe_derived_decision_pending`
- Source action lane / 来源动作泳道: `safe_derived_record_decision`

## Objective / 目标

`decide_safe_derived_record_staging_or_review_queue_after_source_marked_review;decide_safe_derived_record_staging_or_review_queue;keep_metadata_only_boundary;record_human_review_before_any_source_promotion_or_import`

## Blockers / 阻断项

- `safe_derived_record_decision_pending`
- `source_marked_review_required_before_promotion`
...
- `doc/public/user_research/009_source-engineering-gap-review-queues/0036_src-gbedobc_safe_derived_record_decision_needed_next-action-result.md`
