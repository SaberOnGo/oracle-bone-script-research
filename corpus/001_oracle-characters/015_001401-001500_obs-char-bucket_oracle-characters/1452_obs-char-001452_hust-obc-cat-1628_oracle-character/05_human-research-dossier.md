# obs-char-001452 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001452`
- primary external id: `hust-obc-cat-1628`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1452_obs-char-001452_hust-obc-cat-1628_ora
  cle-character/03_visual-assets/001_asset-001457_hust-obc-cat-1628_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1628/G_1628_乙5397(甲).png`
- asset id: `asset-001457`
...
- source category: `1628`
- validation class: `1451`
- source image route: `HUST-OBC/deciphered/1628/G_1628_乙5397(甲).png`
- asset id: `asset-001457`
...
- English observation: `A stacked narrow form has an upper enclosure, a
  diagonal, and a lower loop.`
- 中文观察: `叠置狭长形体有上部框形、斜笔和下部环形。`
...
- dataset label text: `㩒`
- dataset label codepoints: `U+3A52`
...
- Which source records identify obs-char-001452 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001452？
