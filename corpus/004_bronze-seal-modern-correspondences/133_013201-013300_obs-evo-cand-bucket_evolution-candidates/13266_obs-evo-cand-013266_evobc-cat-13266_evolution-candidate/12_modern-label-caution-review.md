# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013266
...
- EVOBC candidate category: `evobc-evo-cat-13266`.
- Source label for search only: `𬒬`.
- Source codepoints for search only: `U+2C4AC`.
