...
- `obs-evo-cand-000118-route-category-staging`
...
- `obs-evo-cand-000118-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000118-route-evolution-graph`
