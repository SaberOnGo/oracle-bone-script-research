# Material Visual Observation / obs-comp-cand-002145 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002145`
- External reference / 外部参照: `obimd-sub-m8oinptiwo`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019733_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6x8v1c8903/m8oinptiwo/m8oinptiwo.png`
- Checksum / 校验和:
  `58c20b3c9a16c0de7532760edba80bf32ea7ff2f9eba0644bca5c3e45a229828`
...
- Marked-pixel bounds: (70,40)–(179,204); span 110 × 165 px; the marked
...
- 痕迹范围：(70,40)–(179,204)；跨度110 × 165 px；痕迹矩形高于宽。
