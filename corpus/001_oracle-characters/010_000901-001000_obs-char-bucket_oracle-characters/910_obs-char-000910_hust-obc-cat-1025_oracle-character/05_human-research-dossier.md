# obs-char-000910 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/910_obs-char-000910_hust-obc-cat-1025_orac
  le-character/03_visual-assets/001_asset-000915_hust-obc-cat-1025_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1025/G_1025_甲骨文.png`
- asset id: `asset-000915`
...
- source category: `1025`
- validation class: `909`
- source image route: `HUST-OBC/deciphered/1025/G_1025_甲骨文.png`
- asset id: `asset-000915`
...
- English observation: `A thin compact form has repeated short horizontal
  marks at left, a rounded central body, and a small branching projection at
  lower right.`
...
- dataset label text: `㟷`
- dataset label codepoints: `U+37F7`
...
- Which source records identify obs-char-000910 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000910？
