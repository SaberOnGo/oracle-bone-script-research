...
- External category reference: `evobc-cat-11364`
- Source category ID: `11364`
- Source label for human review: `𣀇`
- Source codepoints: `U+23007`
...
- `obs-evo-cand-011364-route-category-staging`
...
- `obs-evo-cand-011364-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011364-route-evolution-graph`
