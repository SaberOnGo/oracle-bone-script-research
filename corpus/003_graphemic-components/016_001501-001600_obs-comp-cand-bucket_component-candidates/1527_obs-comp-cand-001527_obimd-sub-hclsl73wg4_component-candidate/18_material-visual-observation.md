# Material Visual Observation / obs-comp-cand-001527 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001527`
- External reference / 外部参照: `obimd-sub-hclsl73wg4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016490_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hclsl73wg4/hclsl73wg4/0ap1jc7hvo.png`
- Checksum / 校验和:
  `11dca2cfc28dfcb187b88e0fb587ed3cb8bbdad44f122aee6a667b7ac6f8b3f8`
...
- Marked-pixel bounds: (87,38)–(162,205); span 76 × 168 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.44%。
- 痕迹范围：(87,38)–(162,205)；跨度76 × 168 px；痕迹矩形高于宽。
