# obs-char-000239 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000239`
- primary external id: `hust-obc-cat-0266`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/239_obs-char-000239_hust-obc-cat-0266_orac
  le-character/03_visual-assets/001_asset-000244_hust-obc-cat-0266_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0266/G_0266_甲骨文.png`
- asset id: `asset-000244`
...
- source category: `0266`
- validation class: `238`
- source image route: `HUST-OBC/deciphered/0266/G_0266_甲骨文.png`
- asset id: `asset-000244`
...
- English observation: `The image has a rounded lower contour, an upright
  left-side stroke, several short branching marks above, and a detached
  diagonal mark at lower right.`
- 中文观察: `图像有圆弧下部轮廓，左侧有直立笔，上方有数道短分叉痕，右下另有分离斜痕。`
...
- dataset label text: `㔀`
- dataset label codepoints: `U+3500`
...
- Which source records identify obs-char-000239 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000239？
