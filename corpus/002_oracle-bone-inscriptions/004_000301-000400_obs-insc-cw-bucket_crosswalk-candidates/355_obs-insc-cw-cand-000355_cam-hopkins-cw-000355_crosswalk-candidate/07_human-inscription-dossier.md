...
Project ID: `obs-insc-cw-cand-000355`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000355`
...
- Source page section: `Period II Group 11` /
  `第 II 期第 11 组`
- Source section key: `period-ii-group-11`
- Section declared count: `3`
- Section observed row count: `3`
...
- Yingguo / 英国所藏: `y2047` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `307` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: 待查: missing Chalfant reference in source row
- Heji / 合集: `41086` in source row; primary catalog entry pending
...
- Group and batch / 组类与批次: group `11`; batch or pit context pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000355`
