# src-ihp-oracle-rubbings Material Access Index / src-ihp-oracle-rubbings 资料访问索引
...
| --- | --- | --- | --- |
| Source summary / 来源摘要 | `README.md` | present | source ID `src-ihp-oracle-rubbings` |
...
| Field maps / 字段映射 | `04_field-map-route-index.csv` | field_rows_present | 1 row(s); target records: asset_metadata; excavation_or_collection_context |
...
- Risk note / 风险提示: Official collection database with explicit site policy; raw image reuse requires policy review.
