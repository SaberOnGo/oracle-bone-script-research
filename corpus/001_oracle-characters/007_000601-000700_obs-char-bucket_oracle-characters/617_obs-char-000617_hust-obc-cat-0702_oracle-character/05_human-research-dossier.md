# obs-char-000617 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000617`
- primary external id: `hust-obc-cat-0702`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/617_obs-char-000617_hust-obc-cat-0702_orac
  le-character/03_visual-assets/001_asset-000622_hust-obc-cat-0702_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0702/G_0702_乙2合11832.png`
- asset id: `asset-000622`
...
- source category: `0702`
- validation class: `616`
- source image route: `HUST-OBC/deciphered/0702/G_0702_乙2合11832.png`
- asset id: `asset-000622`
...
- English observation: `A tall vertical joins short top and bottom bars and
  is crossed near the upper middle by a long horizontal with a small extra
  stroke at left.`
...
- dataset label text: `㚴`
- dataset label codepoints: `U+36B4`
...
- filename catalog route clues: `Heji-like filename clue: 合11832
  (G_0702_乙2合11832.png)`
...
- Which source records identify obs-char-000617 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000617？
