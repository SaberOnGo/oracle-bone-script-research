...
- 本项目 ID：`obs-evo-cand-006916`
- EVOBC 候选类别 ID：`evobc-evo-cat-06916`
- 外部类别引用：`evobc-cat-06916`
- 来源类别 ID：`06916`
- 来源标签：`而`
- 来源 codepoints：`U+800C`
- EVOBC 图像引用数量：`442`
...
- era `4`
  token: `WSC`
  image references: 408
- era `5`
  token: `CS`
  image references: 2
- source `1`
  token: `Web:105952;說文Web:58`
  image references: 397
- source `3`
  token: `Book:21681`
  image references: 1
- source `4`
...
- `obs-evo-cand-006916-route-category-staging`
...
- `obs-evo-cand-006916-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006916-route-evolution-graph`
