# obs-comp-cand-000821 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000821`
- 首选外部 ID: `obimd-sub-we92o7vlu9`
- OBIMD subcharacter UID: `we92o7vlu9`
- OBIMD main character UID: `we92o7vlu9`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+4F13;U+F4A22; U+F4A23
