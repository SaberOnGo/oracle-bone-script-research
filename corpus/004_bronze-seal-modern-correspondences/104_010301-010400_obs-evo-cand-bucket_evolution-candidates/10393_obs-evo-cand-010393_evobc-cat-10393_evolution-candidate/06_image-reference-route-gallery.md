...
- `obs-evo-cand-010393-route-category-staging`
...
- `obs-evo-cand-010393-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010393-route-evolution-graph`
