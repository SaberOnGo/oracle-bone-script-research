...
- Project ID: `obs-evo-cand-005535`
- EVOBC category candidate ID: `evobc-evo-cat-05535`
- External category reference: `evobc-cat-05535`
- Source category ID: `05535`
- Source label for human review: `產`
- Source codepoints: `U+7522`
...
- `obs-evo-cand-005535-route-category-staging`
...
- `obs-evo-cand-005535-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005535-route-evolution-graph`
