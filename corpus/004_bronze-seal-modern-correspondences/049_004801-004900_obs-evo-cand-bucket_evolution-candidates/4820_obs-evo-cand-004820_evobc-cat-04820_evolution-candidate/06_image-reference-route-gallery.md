...
- `obs-evo-cand-004820-route-category-staging`
...
- `obs-evo-cand-004820-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004820-route-evolution-graph`
