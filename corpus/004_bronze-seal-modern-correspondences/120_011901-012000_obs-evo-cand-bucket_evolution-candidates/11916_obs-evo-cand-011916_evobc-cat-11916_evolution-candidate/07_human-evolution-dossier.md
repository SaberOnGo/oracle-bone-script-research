...
- External category reference: `evobc-cat-11916`
- Source category ID: `11916`
- Source label for human review: `𥹃`
...
- `obs-evo-cand-011916-route-category-staging`
...
- `obs-evo-cand-011916-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011916-route-evolution-graph`
