...
- External category reference: `evobc-cat-06703`
- Source category ID: `06703`
- Source label for human review: `纁`
- Source codepoints: `U+7E81`
...
- `obs-evo-cand-006703-route-category-staging`
...
- `obs-evo-cand-006703-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006703-route-evolution-graph`
