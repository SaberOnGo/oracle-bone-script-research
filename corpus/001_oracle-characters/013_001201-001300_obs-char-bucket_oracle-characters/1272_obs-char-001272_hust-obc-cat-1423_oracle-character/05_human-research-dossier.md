# obs-char-001272 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001272`
- primary external id: `hust-obc-cat-1423`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1272_obs-char-001272_hust-obc-cat-1423_ora
  cle-character/03_visual-assets/001_asset-001277_hust-obc-cat-1423_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1423/G_1423_乙1234.png`
- asset id: `asset-001277`
...
- source category: `1423`
- validation class: `1271`
- source image route: `HUST-OBC/deciphered/1423/G_1423_乙1234.png`
- asset id: `asset-001277`
...
- English observation: `A narrow branching form has a short upper
  cross-stroke, a curved central stem, and a small left projection.`
- 中文观察: `狭长分枝形体有短上部横笔、弯曲中央笔干和一条小型左侧外伸笔画。`
...
- dataset label text: `㦅`
- dataset label codepoints: `U+3985`
...
- Which source records identify obs-char-001272 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001272？
