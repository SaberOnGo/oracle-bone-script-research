# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013505
...
- EVOBC candidate category: `evobc-evo-cat-13505`.
- Source label for search only: `𭒽`.
- Source codepoints for search only: `U+2D4BD`.
