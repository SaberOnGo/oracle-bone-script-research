...
- External category reference: `evobc-cat-04614`
- Source category ID: `04614`
- Source label for human review: `洌`
- Source codepoints: `U+6D0C`
...
- `obs-evo-cand-004614-route-category-staging`
...
- `obs-evo-cand-004614-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004614-route-evolution-graph`
