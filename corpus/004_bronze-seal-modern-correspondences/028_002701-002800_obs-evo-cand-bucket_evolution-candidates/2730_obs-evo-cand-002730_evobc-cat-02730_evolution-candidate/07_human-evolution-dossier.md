...
Project ID: `obs-evo-cand-002730`
...
- Project ID: `obs-evo-cand-002730`
- EVOBC category candidate ID: `evobc-evo-cat-02730`
- External category reference: `evobc-cat-02730`
- Source category ID: `02730`
- Source label for human review: `庤`
- Source codepoints: `U+5EA4`
...
- `obs-evo-cand-002730-route-category-staging`
...
- `obs-evo-cand-002730-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002730-route-evolution-graph`
