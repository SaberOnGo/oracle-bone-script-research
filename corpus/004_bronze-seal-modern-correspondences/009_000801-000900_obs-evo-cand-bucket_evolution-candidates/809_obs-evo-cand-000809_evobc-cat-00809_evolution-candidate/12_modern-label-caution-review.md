# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000809
...
- EVOBC candidate category: `evobc-evo-cat-00809`.
- Source label for search only: `佛`.
- Source codepoints for search only: `U+4F5B`.
