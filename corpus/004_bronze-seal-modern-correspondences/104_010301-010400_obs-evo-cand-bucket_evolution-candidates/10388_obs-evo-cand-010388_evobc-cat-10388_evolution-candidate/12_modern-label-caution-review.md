# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010388
...
- EVOBC candidate category: `evobc-evo-cat-10388`.
- Source label for search only: `鮍`.
- Source codepoints for search only: `U+9B8D`.
