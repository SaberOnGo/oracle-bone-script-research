...
- External category reference: `evobc-cat-03180`
- Source category ID: `03180`
- Source label for human review: `懘`
- Source codepoints: `U+61D8`
...
- `obs-evo-cand-003180-route-category-staging`
...
- `obs-evo-cand-003180-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003180-route-evolution-graph`
