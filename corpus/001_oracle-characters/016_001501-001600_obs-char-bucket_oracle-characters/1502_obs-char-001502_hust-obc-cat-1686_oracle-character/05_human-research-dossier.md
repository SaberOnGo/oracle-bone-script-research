# obs-char-001502 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1502_obs-char-001502_hust-obc-cat-1686_ora
  cle-character/03_visual-assets/001_asset-001507_hust-obc-cat-1686_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1686/G_1686_京津4832.png`
- asset id: `asset-001507`
...
- source category: `1686`
- validation class: `1501`
- source image route: `HUST-OBC/deciphered/1686/G_1686_京津4832.png`
- asset id: `asset-001507`
...
- English observation: `A paired form combines a peaked upper mark, a
  gridded left body, and a branching right stroke.`
...
- dataset label text: `㪌`
- dataset label codepoints: `U+3A8C`
...
- Which source records identify obs-char-001502 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001502？
