# obs-char-000396 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000396`
- primary external id: `hust-obc-cat-0449`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/396_obs-char-000396_hust-obc-cat-0449_orac
  le-character/03_visual-assets/001_asset-000401_hust-obc-cat-0449_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0449/G_0449_乙4465反合14084反.png`
- asset id: `asset-000401`
...
- source category: `0449`
- validation class: `395`
- source image route: `HUST-OBC/deciphered/0449/G_0449_乙4465反合14084反.png`
- asset id: `asset-000401`
...
- English observation: `Two similar separated forms each show an upper
  crossing, a small rectangular loop, and an angular lower descender.`
- 中文观察: `两个相似的分离形体各有上部交叉、小矩形环形轮廓和折角下行笔画。`
...
- dataset label text: `㖷`
- dataset label codepoints: `U+35B7`
...
- filename catalog route clues: `Heji-like filename clue: 合14084
  (G_0449_乙4465反合14084反.png)`
...
- Which source records identify obs-char-000396 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000396？
