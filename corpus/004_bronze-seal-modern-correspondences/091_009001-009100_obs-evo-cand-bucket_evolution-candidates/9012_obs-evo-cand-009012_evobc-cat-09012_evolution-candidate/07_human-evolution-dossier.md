...
- Project ID: `obs-evo-cand-009012`
- EVOBC category candidate ID: `evobc-evo-cat-09012`
- External category reference: `evobc-cat-09012`
- Source category ID: `09012`
- Source label for human review: `逳`
- Source codepoints: `U+9033`
...
- `obs-evo-cand-009012-route-category-staging`
...
- `obs-evo-cand-009012-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009012-route-evolution-graph`
