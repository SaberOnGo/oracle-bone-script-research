...
- External category reference: `evobc-cat-13265`
- Source category ID: `13265`
- Source label for human review: `𬒤`
...
- `obs-evo-cand-013265-route-category-staging`
...
- `obs-evo-cand-013265-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013265-route-evolution-graph`
