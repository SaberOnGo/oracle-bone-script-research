...
Project ID: `obs-evo-cand-003978`
...
- Project ID: `obs-evo-cand-003978`
- EVOBC category candidate ID: `evobc-evo-cat-03978`
- External category reference: `evobc-cat-03978`
- Source category ID: `03978`
- Source label for human review: `柳`
- Source codepoints: `U+67F3`
...
- `obs-evo-cand-003978-route-category-staging`
...
- `obs-evo-cand-003978-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003978-route-evolution-graph`
