...
- External category reference: `evobc-cat-04009`
- Source category ID: `04009`
- Source label for human review: `核`
...
- `obs-evo-cand-004009-route-category-staging`
...
- `obs-evo-cand-004009-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004009-route-evolution-graph`
