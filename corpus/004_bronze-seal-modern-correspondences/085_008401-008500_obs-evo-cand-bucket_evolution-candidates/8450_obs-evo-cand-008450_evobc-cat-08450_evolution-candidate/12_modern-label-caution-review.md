# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008450
...
- EVOBC candidate category: `evobc-evo-cat-08450`.
- Source label for search only: `谊`.
- Source codepoints for search only: `U+8C0A`.
