...
Project ID: `obs-evo-cand-008055`
...
- Project ID: `obs-evo-cand-008055`
- EVOBC category candidate ID: `evobc-evo-cat-08055`
- External category reference: `evobc-cat-08055`
- Source category ID: `08055`
- Source label for human review: `見`
- Source codepoints: `U+898B`
...
- `obs-evo-cand-008055-route-category-staging`
...
- `obs-evo-cand-008055-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008055-route-evolution-graph`
