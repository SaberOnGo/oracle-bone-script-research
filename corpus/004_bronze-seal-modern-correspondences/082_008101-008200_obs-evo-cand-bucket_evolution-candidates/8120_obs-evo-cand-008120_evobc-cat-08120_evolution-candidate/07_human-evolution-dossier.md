...
- External category reference: `evobc-cat-08120`
- Source category ID: `08120`
- Source label for human review: `觿`
- Source codepoints: `U+89FF`
...
- `obs-evo-cand-008120-route-category-staging`
...
- `obs-evo-cand-008120-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008120-route-evolution-graph`
