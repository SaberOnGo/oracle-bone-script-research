# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-002568
...
- candidate_component_id: `obs-comp-cand-002568`
- primary_external_ref_id: `obimd-sub-lw8ebrisot`
- source_subcharacter_uid: `lw8ebrisot`
...
- glyph_codepoint_uplus_sample: `U+FE90C, U+FE90D, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-021100` | `001_asset-021100_img.png` | `82aa1bce070658959881c227512f160f41672beffc4e83cf9bae52be3110a1e4` |
