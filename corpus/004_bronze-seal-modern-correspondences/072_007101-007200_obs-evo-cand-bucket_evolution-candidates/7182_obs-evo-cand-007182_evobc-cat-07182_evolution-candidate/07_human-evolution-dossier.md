...
- External category reference: `evobc-cat-07182`
- Source category ID: `07182`
- Source label for human review: `舂`
- Source codepoints: `U+8202`
...
- `obs-evo-cand-007182-route-category-staging`
...
- `obs-evo-cand-007182-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007182-route-evolution-graph`
