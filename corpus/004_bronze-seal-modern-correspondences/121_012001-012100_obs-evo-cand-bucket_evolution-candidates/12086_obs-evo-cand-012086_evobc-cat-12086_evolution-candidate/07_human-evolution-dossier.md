...
Project ID: `obs-evo-cand-012086`
...
- Project ID: `obs-evo-cand-012086`
- EVOBC category candidate ID: `evobc-evo-cat-12086`
- External category reference: `evobc-cat-12086`
- Source category ID: `12086`
- Source label for human review: `𦫿`
- Source codepoints: `U+26AFF`
...
- `obs-evo-cand-012086-route-category-staging`
...
- `obs-evo-cand-012086-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012086-route-evolution-graph`
