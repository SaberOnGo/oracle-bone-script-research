# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008436
...
- EVOBC candidate category: `evobc-evo-cat-08436`.
- Source label for search only: `误`.
- Source codepoints for search only: `U+8BEF`.
