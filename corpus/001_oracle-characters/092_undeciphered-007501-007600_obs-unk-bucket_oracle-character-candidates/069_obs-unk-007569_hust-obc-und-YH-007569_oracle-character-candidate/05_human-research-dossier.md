# obs-unk-007569 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/092_undeciphered-007
  501-007600_obs-unk-bucket_oracle-character-candidates/069_obs-unk-007569_h
  ust-obc-und-YH-007569_oracle-character-candidate/03_visual-assets/001_asse
  t-009160_hust-obc-und-YH-007569_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/600CF/H_？_600CF_0.png`
- asset id: `asset-009160`
...
- source class: `HUST-OBC/undeciphered/Y+H/600CF/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/600CF/H_？_600CF_0.png`
- asset id: `asset-009160`
...
- Which source records identify obs-unk-007569 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007569？
