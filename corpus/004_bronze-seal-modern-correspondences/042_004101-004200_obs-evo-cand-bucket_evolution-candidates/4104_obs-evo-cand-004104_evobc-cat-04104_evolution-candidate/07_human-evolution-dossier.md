...
- Project ID: `obs-evo-cand-004104`
- EVOBC category candidate ID: `evobc-evo-cat-04104`
- External category reference: `evobc-cat-04104`
- Source category ID: `04104`
- Source label for human review: `棨`
- Source codepoints: `U+68E8`
...
- `obs-evo-cand-004104-route-category-staging`
...
- `obs-evo-cand-004104-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004104-route-evolution-graph`
