...
Project ID: `obs-evo-cand-002706`
...
- Project ID: `obs-evo-cand-002706`
- EVOBC category candidate ID: `evobc-evo-cat-02706`
- External category reference: `evobc-cat-02706`
- Source category ID: `02706`
- Source label for human review: `广`
- Source codepoints: `U+5E7F`
...
- `obs-evo-cand-002706-route-category-staging`
...
- `obs-evo-cand-002706-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002706-route-evolution-graph`
