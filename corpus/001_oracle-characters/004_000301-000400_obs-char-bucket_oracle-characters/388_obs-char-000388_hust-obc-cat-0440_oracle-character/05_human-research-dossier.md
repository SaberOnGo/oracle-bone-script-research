# obs-char-000388 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/388_obs-char-000388_hust-obc-cat-0440_orac
  le-character/03_visual-assets/001_asset-000393_hust-obc-cat-0440_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0440/G_0440_乙6708合14311.png`
- asset id: `asset-000393`
...
- source category: `0440`
- validation class: `387`
- source image route: `HUST-OBC/deciphered/0440/G_0440_乙6708合14311.png`
- asset id: `asset-000393`
...
- English observation: `A thin central stem is crossed by several short
  angled branches, with multiple narrow descenders.`
- 中文观察: `纤细中央主干被数个短斜向分支交叉，并有多条狭窄下行笔画。`
...
- dataset label text: `㖮`
- dataset label codepoints: `U+35AE`
...
- filename catalog route clues: `Heji-like filename clue: 合14311
  (G_0440_乙6708合14311.png)`
...
- Which source records identify obs-char-000388 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000388？
