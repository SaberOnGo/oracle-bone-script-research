...
Project ID: `obs-evo-cand-005431`
...
- Project ID: `obs-evo-cand-005431`
- EVOBC category candidate ID: `evobc-evo-cat-05431`
- External category reference: `evobc-cat-05431`
- Source category ID: `05431`
- Source label for human review: `瑂`
- Source codepoints: `U+7442`
...
- `obs-evo-cand-005431-route-category-staging`
...
- `obs-evo-cand-005431-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005431-route-evolution-graph`
