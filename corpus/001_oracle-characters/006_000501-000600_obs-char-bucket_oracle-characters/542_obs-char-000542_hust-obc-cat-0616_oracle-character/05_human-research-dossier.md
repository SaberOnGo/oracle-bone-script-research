# obs-char-000542 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/542_obs-char-000542_hust-obc-cat-0616_orac
  le-character/03_visual-assets/001_asset-000547_hust-obc-cat-0616_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0616/G_0616_乙173合15973.png`
- asset id: `asset-000547`
...
- source category: `0616`
- validation class: `541`
- source image route: `HUST-OBC/deciphered/0616/G_0616_乙173合15973.png`
- asset id: `asset-000547`
...
- English observation: `A broad top bar caps a dense central angular cluster
  with an open loop and several crossings; a central stroke divides below
  into two long diagonals.`
- 中文观察: `宽顶横盖住带开口环和数处交叉的密集中央折笔群，中央笔下部分成两条长斜笔。`
...
- dataset label text: `㙞`
- dataset label codepoints: `U+365E`
...
- filename catalog route clues: `Heji-like filename clue: 合15973
...
- Which source records identify obs-char-000542 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000542？
