...
- Project ID: `obs-evo-cand-009017`
- EVOBC category candidate ID: `evobc-evo-cat-09017`
- External category reference: `evobc-cat-09017`
- Source category ID: `09017`
- Source label for human review: `逹`
- Source codepoints: `U+9039`
...
- `obs-evo-cand-009017-route-category-staging`
...
- `obs-evo-cand-009017-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009017-route-evolution-graph`
