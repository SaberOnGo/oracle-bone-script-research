...
- Project ID: `obs-evo-cand-004833`
- EVOBC category candidate ID: `evobc-evo-cat-04833`
- External category reference: `evobc-cat-04833`
- Source category ID: `04833`
- Source label for human review: `滅`
- Source codepoints: `U+6EC5`
...
- `obs-evo-cand-004833-route-category-staging`
...
- `obs-evo-cand-004833-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004833-route-evolution-graph`
