# Material Visual Observation / obs-comp-cand-001571 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001571`
- External reference / 外部参照: `obimd-sub-a8n7ywfrd3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017118_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/a8n7ywfrd3/a8n7ywfrd3/a8n7ywfrd3.png`
- Checksum / 校验和:
  `d4a3fde7d48ae2447654a1237980c95eb6ab524ab9e3a5e193b26d7198408520`
...
- Marked-pixel bounds: (48,57)–(212,174); span 165 × 118 px; the marked
...
- 痕迹范围：(48,57)–(212,174)；跨度165 × 118 px；痕迹矩形宽于高。
