...
- Project ID: `obs-evo-cand-004197`
- EVOBC category candidate ID: `evobc-evo-cat-04197`
- External category reference: `evobc-cat-04197`
- Source category ID: `04197`
- Source label for human review: `榾`
- Source codepoints: `U+69BE`
...
- `obs-evo-cand-004197-route-category-staging`
...
- `obs-evo-cand-004197-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004197-route-evolution-graph`
