...
Project ID: `obs-evo-cand-004836`
...
- Project ID: `obs-evo-cand-004836`
- EVOBC category candidate ID: `evobc-evo-cat-04836`
- External category reference: `evobc-cat-04836`
- Source category ID: `04836`
- Source label for human review: `滈`
- Source codepoints: `U+6EC8`
...
- `obs-evo-cand-004836-route-category-staging`
...
- `obs-evo-cand-004836-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004836-route-evolution-graph`
