# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008753
...
- EVOBC candidate category: `evobc-evo-cat-08753`.
- Source label for search only: `蹊`.
- Source codepoints for search only: `U+8E4A`.
