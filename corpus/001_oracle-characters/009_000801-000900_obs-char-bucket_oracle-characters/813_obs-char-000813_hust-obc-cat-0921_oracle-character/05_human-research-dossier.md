# obs-char-000813 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000813`
- primary external id: `hust-obc-cat-0921`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/813_obs-char-000813_hust-obc-cat-0921_orac
  le-character/03_visual-assets/001_asset-000818_hust-obc-cat-0921_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0921/G_0921_後2.21.6(甲).png`
- asset id: `asset-000818`
...
- source category: `0921`
- validation class: `812`
- source image route: `HUST-OBC/deciphered/0921/G_0921_後2.21.6(甲).png`
- asset id: `asset-000818`
...
- English observation: `A small rounded open loop at upper left connects to
  a tall upright ending in a pointed lower tip; the upper stroke is broad
  and hooked.`
- 中文观察: `上左方可见小型圆弧环状开口，与向下延伸的高长直立笔连接，上笔宽厚并带钩形。`
...
- dataset label text: `㞏`
- dataset label codepoints: `U+378F`
...
- Which source records identify obs-char-000813 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000813？
