...
- External category reference: `evobc-cat-00397`
- Source category ID: `00397`
- Source label for human review: `䖥`
...
- `obs-evo-cand-000397-route-category-staging`
...
- `obs-evo-cand-000397-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000397-route-evolution-graph`
