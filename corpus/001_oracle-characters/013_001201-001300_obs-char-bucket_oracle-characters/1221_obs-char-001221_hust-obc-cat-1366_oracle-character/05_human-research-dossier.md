# obs-char-001221 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001221`
- primary external id: `hust-obc-cat-1366`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1221_obs-char-001221_hust-obc-cat-1366_ora
  cle-character/03_visual-assets/001_asset-001226_hust-obc-cat-1366_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1366/G_1366_乙2409合10200.png`
- asset id: `asset-001226`
...
- source category: `1366`
- validation class: `1220`
- source image route: `HUST-OBC/deciphered/1366/G_1366_乙2409合10200.png`
- asset id: `asset-001226`
...
- English observation: `A narrow dense form has an upper horizontal
  enclosure, a central branching stroke, and a hooked lower end.`
- 中文观察: `狭长密集形体有上部横向框廓、中央分枝笔和钩状下端。`
...
- dataset label text: `㥌`
- dataset label codepoints: `U+394C`
...
- filename catalog route clues: `Heji-like filename clue: 合10200
  (G_1366_乙2409合10200.png)`
...
- Which source records identify obs-char-001221 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001221？
