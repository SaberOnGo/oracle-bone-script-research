...
Project ID: `obs-evo-cand-009519`
...
- Project ID: `obs-evo-cand-009519`
- EVOBC category candidate ID: `evobc-evo-cat-09519`
- External category reference: `evobc-cat-09519`
- Source category ID: `09519`
- Source label for human review: `鐈`
- Source codepoints: `U+9408`
...
- `obs-evo-cand-009519-route-category-staging`
...
- `obs-evo-cand-009519-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009519-route-evolution-graph`
