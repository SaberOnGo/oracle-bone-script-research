...
- External category reference: `evobc-cat-12106`
- Source category ID: `12106`
- Source label for human review: `𦳢`
...
- `obs-evo-cand-012106-route-category-staging`
...
- `obs-evo-cand-012106-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012106-route-evolution-graph`
