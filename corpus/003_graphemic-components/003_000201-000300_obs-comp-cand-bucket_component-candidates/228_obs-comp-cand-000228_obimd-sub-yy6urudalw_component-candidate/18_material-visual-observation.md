# Material Visual Observation / obs-comp-cand-000228 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000228`
- External reference / 外部参照: `obimd-sub-yy6urudalw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011875_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wko0jz3cod/yy6urudalw/yy6urudalw.png`
- Checksum / 校验和:
  `f2078b9c297e911d70d3f4b7ab26ea0c771332b32bf5dc2dc27e64153206d134`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.51%.
- Marked-pixel bounds: (36,45)–(217,206); span 182 × 162 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.51%。
- 痕迹范围：(36,45)–(217,206)；跨度182 × 162 px；痕迹矩形近方形。
