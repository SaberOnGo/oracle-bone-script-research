...
- External category reference: `evobc-cat-08295`
- Source category ID: `08295`
- Source label for human review: `諸`
- Source codepoints: `U+8AF8`
...
- `obs-evo-cand-008295-route-category-staging`
...
- `obs-evo-cand-008295-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008295-route-evolution-graph`
