# obs-evo-cand-002344 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-002344`
- EVOBC category candidate ID: `evobc-evo-cat-02344`
- External category ref: `evobc-cat-02344`
- Source label: `孰`
- Source codepoints: `U+5B70`
- Image reference count: `59`
- Era token counts: `BI:1;OBC:46;SAC:4;SS:1;WSC:7`
- Source token counts: `Book:8;Web:51`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 46 image references
