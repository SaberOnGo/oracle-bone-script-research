# obs-char-001230 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1230_obs-char-001230_hust-obc-cat-1376_ora
  cle-character/03_visual-assets/001_asset-001235_hust-obc-cat-1376_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1376/L_1376_13164.jpg`
- asset id: `asset-001235`
...
- source category: `1376`
- validation class: `1229`
- source image route: `HUST-OBC/deciphered/1376/L_1376_13164.jpg`
- asset id: `asset-001235`
...
- English observation: `A faint narrow form has a short upper crossing, a
  curved central stroke, and a hooked lower turn.`
- 中文观察: `较淡的狭长形体有短上部交叉、中央弯笔和钩状下部转折。`
...
- dataset label text: `㥖`
- dataset label codepoints: `U+3956`
...
- Which source records identify obs-char-001230 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001230？
