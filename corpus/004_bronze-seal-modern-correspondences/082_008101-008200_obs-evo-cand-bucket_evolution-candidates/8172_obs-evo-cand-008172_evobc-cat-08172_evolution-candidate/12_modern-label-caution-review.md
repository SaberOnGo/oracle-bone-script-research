# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008172
...
- EVOBC candidate category: `evobc-evo-cat-08172`.
- Source label for search only: `詍`.
- Source codepoints for search only: `U+8A4D`.
