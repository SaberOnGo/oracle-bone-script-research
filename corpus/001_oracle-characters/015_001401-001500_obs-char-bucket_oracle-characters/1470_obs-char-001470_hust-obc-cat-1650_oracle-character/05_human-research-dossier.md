# obs-char-001470 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001470`
- primary external id: `hust-obc-cat-1650`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1470_obs-char-001470_hust-obc-cat-1650_ora
  cle-character/03_visual-assets/001_asset-001475_hust-obc-cat-1650_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1650/G_1650_乙5338合10344賓組.png`
- asset id: `asset-001475`
...
- source category: `1650`
- validation class: `1469`
- source image route: `HUST-OBC/deciphered/1650/G_1650_乙5338合10344賓組.png`
- asset id: `asset-001475`
...
- English observation: `A compact dense cluster combines stacked angular
  forms and a central diagonal.`
- 中文观察: `紧凑密集笔画群组合叠置角状形体和中央斜笔。`
...
- dataset label text: `㩨`
- dataset label codepoints: `U+3A68`
...
- filename catalog route clues: `Heji-like filename clue: 合10344
  (G_1650_乙5338合10344賓組.png)`
...
- Which source records identify obs-char-001470 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001470？
