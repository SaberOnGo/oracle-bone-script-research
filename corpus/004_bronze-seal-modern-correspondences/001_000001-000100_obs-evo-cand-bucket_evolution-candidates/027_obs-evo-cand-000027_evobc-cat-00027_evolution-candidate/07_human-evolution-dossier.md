...
- Project ID: `obs-evo-cand-000027`
- EVOBC category candidate ID: `evobc-evo-cat-00027`
- External category reference: `evobc-cat-00027`
- Source category ID: `00027`
- Source label for human review: `㕚`
- Source codepoints: `U+355A`
...
- `obs-evo-cand-000027-route-category-staging`
...
- `obs-evo-cand-000027-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000027-route-evolution-graph`
