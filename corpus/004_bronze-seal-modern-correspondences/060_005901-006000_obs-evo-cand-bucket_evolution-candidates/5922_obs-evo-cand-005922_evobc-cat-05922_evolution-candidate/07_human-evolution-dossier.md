...
Project ID: `obs-evo-cand-005922`
...
- Project ID: `obs-evo-cand-005922`
- EVOBC category candidate ID: `evobc-evo-cat-05922`
- External category reference: `evobc-cat-05922`
- Source category ID: `05922`
- Source label for human review: `碒`
- Source codepoints: `U+7892`
...
- `obs-evo-cand-005922-route-category-staging`
...
- `obs-evo-cand-005922-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005922-route-evolution-graph`
