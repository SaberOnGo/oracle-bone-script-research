...
- External category reference: `evobc-cat-12848`
- Source category ID: `12848`
- Source label for human review: `𪬆`
- Source codepoints: `U+2AB06`
...
- `obs-evo-cand-012848-route-category-staging`
...
- `obs-evo-cand-012848-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012848-route-evolution-graph`
