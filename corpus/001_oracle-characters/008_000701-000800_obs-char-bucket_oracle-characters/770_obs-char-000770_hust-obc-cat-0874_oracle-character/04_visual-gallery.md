# obs-char-000770 Visual Gallery / obs-char-000770 图像资料页
...
- Primary external reference / 首选外部参考: `hust-obc-cat-0874`
...
## obs-char-000770-visual-source-001 / 图像条目

![obs-char-000770 glyph candidate](03_visual-assets/001_asset-000775_hust-obc-cat-0874_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000775_hust-obc-cat-0874_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000775_hust-obc-cat-0874_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/0874/G_0874_前4.45.3(甲).png`
