# Material Visual Observation / obs-comp-cand-001193 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001193`
- External reference / 外部参照: `obimd-sub-5wxvkutef7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015383_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5wxvkutef7/5wxvkutef7/5wxvkutef7.png`
- Checksum / 校验和:
  `19f0f3fc127641b22a0a9098f1cd0dfbd5f236d6af42515df3995c71aab394ce`
...
- Marked-pixel bounds: (75,21)–(175,228); span 101 × 208 px; the marked
...
- 痕迹范围：(75,21)–(175,228)；跨度101 × 208 px；痕迹矩形高于宽。
