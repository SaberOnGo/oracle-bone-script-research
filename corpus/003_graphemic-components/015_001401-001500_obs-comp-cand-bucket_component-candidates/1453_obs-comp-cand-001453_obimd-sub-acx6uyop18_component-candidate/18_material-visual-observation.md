# Material Visual Observation / obs-comp-cand-001453 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001453`
- External reference / 外部参照: `obimd-sub-acx6uyop18`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016030_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/acx6uyop18/acx6uyop18/acx6uyop18.png`
- Checksum / 校验和:
  `72b3de05491c03b59f21b96e5304f7d83b2ef95a346c61b22ec207cf1ef31d70`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.67%.
- Marked-pixel bounds: (75,54)–(174,190); span 100 × 137 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.67%。
- 痕迹范围：(75,54)–(174,190)；跨度100 × 137 px；痕迹矩形高于宽。
