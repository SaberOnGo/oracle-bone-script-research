# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002150
...
- EVOBC candidate category: `evobc-evo-cat-02150`.
- Source label for search only: `姿`.
- Source codepoints for search only: `U+59FF`.
