# obs-xwalk-cand-000641 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+36CF` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-0729` | not reading |
| OBIMD route / OBIMD 路线 | `pending route` | not component |
| EVOBC route / EVOBC 路线 | `evobc-evo-cat-00053` | not evolution |
...
| HUST candidate route | `corpus/001_oracle-characters/007_000601-000700_obs-char-bucket_oracle-characters/641_obs-char-000641_hust-obc-cat-0729_oracle-character/01_candidate-character-packet.json` | open packet and local glyph dossier first |
