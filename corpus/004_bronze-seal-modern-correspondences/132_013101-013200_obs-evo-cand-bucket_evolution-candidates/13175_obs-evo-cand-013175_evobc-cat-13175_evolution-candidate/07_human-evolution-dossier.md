...
- Project ID: `obs-evo-cand-013175`
- EVOBC category candidate ID: `evobc-evo-cat-13175`
- External category reference: `evobc-cat-13175`
- Source category ID: `13175`
- Source label for human review: `𫿗`
- Source codepoints: `U+2BFD7`
...
- `obs-evo-cand-013175-route-category-staging`
...
- `obs-evo-cand-013175-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013175-route-evolution-graph`
