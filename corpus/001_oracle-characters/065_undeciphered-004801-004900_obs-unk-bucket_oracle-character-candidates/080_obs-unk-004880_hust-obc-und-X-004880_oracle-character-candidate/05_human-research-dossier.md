# obs-unk-004880 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/080_obs-unk-004880_h
  ust-obc-und-X-004880_oracle-character-candidate/03_visual-assets/001_asset
  -006473_hust-obc-und-X-004880_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/436/X_？_7419_1.png`
- asset id: `asset-006473`
...
- source class: `HUST-OBC/undeciphered/X/436/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/436/X_？_7419_1.png`
- asset id: `asset-006473`
...
- English observation: `left branching group and lower-right fork`
- 中文观察: `左侧分枝结构和右下方分叉`
...
- Which source records identify obs-unk-004880 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004880？
