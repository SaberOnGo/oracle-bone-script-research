...
- External category reference: `evobc-cat-12935`
- Source category ID: `12935`
- Source label for human review: `𫍉`
...
- `obs-evo-cand-012935-route-category-staging`
...
- `obs-evo-cand-012935-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012935-route-evolution-graph`
