...
- External category reference: `evobc-cat-13124`
- Source category ID: `13124`
- Source label for human review: `𫷺`
...
- `obs-evo-cand-013124-route-category-staging`
...
- `obs-evo-cand-013124-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013124-route-evolution-graph`
