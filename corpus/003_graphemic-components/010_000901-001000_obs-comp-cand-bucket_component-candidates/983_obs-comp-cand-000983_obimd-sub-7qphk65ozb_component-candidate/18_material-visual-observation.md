# Material Visual Observation / obs-comp-cand-000983 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000983`
- External reference / 外部参照: `obimd-sub-7qphk65ozb`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014265_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wex7jm17pb/7qphk65ozb/03tl5wzcvo.png`
- Checksum / 校验和:
  `d90c1a8e68dced020a653aa0b52cda20bc262a956226850c5a5e02f7d9d5cc11`
...
- Marked-pixel bounds: (87,37)–(162,212); span 76 × 176 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.23%。
- 痕迹范围：(87,37)–(162,212)；跨度76 × 176 px；痕迹矩形高于宽。
