...
- External category reference: `evobc-cat-01386`
- Source category ID: `01386`
- Source label for human review: `卡`
- Source codepoints: `U+5361`
...
- `obs-evo-cand-001386-route-category-staging`
...
- `obs-evo-cand-001386-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001386-route-evolution-graph`
