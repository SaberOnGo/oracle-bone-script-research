...
- External category reference: `evobc-cat-03067`
- Source category ID: `03067`
- Source label for human review: `惴`
...
- `obs-evo-cand-003067-route-category-staging`
...
- `obs-evo-cand-003067-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003067-route-evolution-graph`
