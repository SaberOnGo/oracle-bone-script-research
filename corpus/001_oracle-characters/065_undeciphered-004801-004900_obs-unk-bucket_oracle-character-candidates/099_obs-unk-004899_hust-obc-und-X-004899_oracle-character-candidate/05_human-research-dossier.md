# obs-unk-004899 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/099_obs-unk-004899_h
  ust-obc-und-X-004899_oracle-character-candidate/03_visual-assets/001_asset
  -006492_hust-obc-und-X-004899_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/455/X_？_7435_1.png`
- asset id: `asset-006492`
...
- source class: `HUST-OBC/undeciphered/X/455/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/455/X_？_7435_1.png`
- asset id: `asset-006492`
...
- English observation: `tall right stroke and separated side marks`
- 中文观察: `右侧高长笔画和分开的侧部标记`
...
- Which source records identify obs-unk-004899 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004899？
