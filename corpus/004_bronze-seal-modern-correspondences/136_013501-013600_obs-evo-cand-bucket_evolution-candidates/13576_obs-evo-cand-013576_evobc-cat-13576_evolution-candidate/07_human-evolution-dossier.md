...
- External category reference: `evobc-cat-13576`
- Source category ID: `13576`
- Source label for human review: `𭶥`
...
- `obs-evo-cand-013576-route-category-staging`
...
- `obs-evo-cand-013576-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013576-route-evolution-graph`
