...
- External category reference: `evobc-cat-07056`
- Source category ID: `07056`
...
- `obs-evo-cand-007056-route-category-staging`
...
- `obs-evo-cand-007056-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007056-route-evolution-graph`
