# obs-char-000832 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/832_obs-char-000832_hust-obc-cat-0941_orac
  le-character/03_visual-assets/001_asset-000837_hust-obc-cat-0941_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0941/L_0941_2402.jpg`
- asset id: `asset-000837`
...
- source category: `0941`
- validation class: `831`
- source image route: `HUST-OBC/deciphered/0941/L_0941_2402.jpg`
- asset id: `asset-000837`
...
- English observation: `The tiny gray image shows two short curved marks
  with a small central crossing; exact joins remain unclear.`
- 中文观察: `微小灰度图像显示两条短弯曲笔和一个中央小交叉；具体连接仍不清楚。`
...
- dataset label text: `㞣`
- dataset label codepoints: `U+37A3`
...
- Which source records identify obs-char-000832 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000832？
