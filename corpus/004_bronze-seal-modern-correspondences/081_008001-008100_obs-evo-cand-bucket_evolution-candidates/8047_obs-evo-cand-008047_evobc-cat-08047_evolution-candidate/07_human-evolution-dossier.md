...
- External category reference: `evobc-cat-08047`
- Source category ID: `08047`
- Source label for human review: `襺`
- Source codepoints: `U+897A`
...
- `obs-evo-cand-008047-route-category-staging`
...
- `obs-evo-cand-008047-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008047-route-evolution-graph`
