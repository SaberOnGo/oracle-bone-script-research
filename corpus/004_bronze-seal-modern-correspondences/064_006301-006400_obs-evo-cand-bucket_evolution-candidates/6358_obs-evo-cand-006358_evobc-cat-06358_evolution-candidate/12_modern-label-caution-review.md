# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006358
...
- EVOBC candidate category: `evobc-evo-cat-06358`.
- Source label for search only: `簬`.
- Source codepoints for search only: `U+7C2C`.
