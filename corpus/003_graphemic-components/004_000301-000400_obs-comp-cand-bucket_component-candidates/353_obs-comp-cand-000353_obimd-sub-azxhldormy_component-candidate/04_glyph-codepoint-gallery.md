# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000353
...
| --- | --- | --- | --- |
| `obimd-glyph-link-005261` | 󿳹 | `U+FFCF9` | `reviewed_metadata_only` |
| `obimd-glyph-link-005262` | 󲁹 | `U+F2079` | `reviewed_metadata_only` |
| `obimd-glyph-link-005263` | 󲁺 | `U+F207A` | `reviewed_metadata_only` |
| `obimd-glyph-link-005264` | 󲁻 | `U+F207B` | `reviewed_metadata_only` |
