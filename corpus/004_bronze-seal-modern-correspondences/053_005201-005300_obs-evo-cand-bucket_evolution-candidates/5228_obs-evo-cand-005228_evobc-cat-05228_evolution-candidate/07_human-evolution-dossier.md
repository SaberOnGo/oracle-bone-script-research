...
- External category reference: `evobc-cat-05228`
- Source category ID: `05228`
- Source label for human review: `犇`
...
- `obs-evo-cand-005228-route-category-staging`
...
- `obs-evo-cand-005228-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005228-route-evolution-graph`
