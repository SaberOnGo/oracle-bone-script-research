# obs-comp-cand-000813 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000813`
- 首选外部 ID: `obimd-sub-jshaxuelhn`
- OBIMD subcharacter UID: `jshaxuelhn`
- OBIMD main character UID: `jshaxuelhn`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+9B25;U+FFC37; U+F499D; 另有 3 项
