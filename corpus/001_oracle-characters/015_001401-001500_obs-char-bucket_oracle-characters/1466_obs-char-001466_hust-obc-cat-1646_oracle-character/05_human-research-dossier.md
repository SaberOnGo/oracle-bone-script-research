# obs-char-001466 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1466_obs-char-001466_hust-obc-cat-1646_ora
  cle-character/03_visual-assets/001_asset-001471_hust-obc-cat-1646_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1646/L_1646_3045.jpg`
- asset id: `asset-001471`
...
- source category: `1646`
- validation class: `1465`
- source image route: `HUST-OBC/deciphered/1646/L_1646_3045.jpg`
- asset id: `asset-001471`
...
- English observation: `A faint compact cluster has a pointed upper contour
  and lower branches.`
...
- dataset label text: `㩤`
- dataset label codepoints: `U+3A64`
...
- Which source records identify obs-char-001466 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001466？
