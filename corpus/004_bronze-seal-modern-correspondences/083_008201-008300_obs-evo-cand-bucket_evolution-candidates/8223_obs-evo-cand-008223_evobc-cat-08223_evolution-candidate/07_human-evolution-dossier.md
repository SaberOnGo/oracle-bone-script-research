...
- External category reference: `evobc-cat-08223`
- Source category ID: `08223`
- Source label for human review: `誎`
- Source codepoints: `U+8A8E`
...
- `obs-evo-cand-008223-route-category-staging`
...
- `obs-evo-cand-008223-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008223-route-evolution-graph`
