# Material Visual Observation / obs-comp-cand-000828 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000828`
- External reference / 外部参照: `obimd-sub-4wsrhqopug`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013699_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4wsrhqopug/4wsrhqopug/4wsrhqopug.png`
- Checksum / 校验和:
  `d5205e64edc5e44ed59af54e781c124ae7b81eb90ccda73914dfbc910533efa7`
...
- Marked-pixel bounds: (91,19)–(157,225); span 67 × 207 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.61%。
- 痕迹范围：(91,19)–(157,225)；跨度67 × 207 px；痕迹矩形高于宽。
