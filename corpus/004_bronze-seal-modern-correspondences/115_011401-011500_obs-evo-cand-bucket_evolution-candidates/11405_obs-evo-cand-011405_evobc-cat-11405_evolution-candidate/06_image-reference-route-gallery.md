...
- `obs-evo-cand-011405-route-category-staging`
...
- `obs-evo-cand-011405-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011405-route-evolution-graph`
