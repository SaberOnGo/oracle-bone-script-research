...
- External category reference: `evobc-cat-03880`
- Source category ID: `03880`
- Source label for human review: `杖`
...
- `obs-evo-cand-003880-route-category-staging`
...
- `obs-evo-cand-003880-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003880-route-evolution-graph`
