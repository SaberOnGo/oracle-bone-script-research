...
- `obs-evo-cand-000278-route-category-staging`
...
- `obs-evo-cand-000278-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000278-route-evolution-graph`
