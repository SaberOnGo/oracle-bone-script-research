# Material Visual Observation / obs-comp-cand-001657 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001657`
- External reference / 外部参照: `obimd-sub-d4shm13fe5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017333_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/r26j6lro1i/d4shm13fe5/d4shm13fe5.png`
- Checksum / 校验和:
  `99ad8a55caa061ae635a3201d6969b432d559a81b746894f1ece17804e7f26be`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.65%.
- Marked-pixel bounds: (72,49)–(185,197); span 114 × 149 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.65%。
- 痕迹范围：(72,49)–(185,197)；跨度114 × 149 px；痕迹矩形高于宽。
