...
- External category reference: `evobc-cat-00842`
- Source category ID: `00842`
- Source label for human review: `侍`
...
- `obs-evo-cand-000842-route-category-staging`
...
- `obs-evo-cand-000842-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000842-route-evolution-graph`
