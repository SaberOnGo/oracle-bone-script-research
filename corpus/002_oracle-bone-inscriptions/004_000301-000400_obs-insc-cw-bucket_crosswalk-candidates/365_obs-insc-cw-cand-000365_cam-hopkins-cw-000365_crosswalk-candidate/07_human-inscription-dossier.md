...
- Source page section: `Period II Group 16` /
  `第 II 期第 16 组`
- Source section key: `period-ii-group-16`
...
- Yingguo / 英国所藏: `y2088` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `211` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `70` in source row; primary catalog entry pending
- Heji / 合集: `39749` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000365`
