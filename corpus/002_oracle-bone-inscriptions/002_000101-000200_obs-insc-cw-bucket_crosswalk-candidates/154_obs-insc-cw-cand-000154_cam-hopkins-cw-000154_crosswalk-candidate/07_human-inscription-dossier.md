...
- Yingguo / 英国所藏: `y848` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `253` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `687` in source row; primary catalog entry pending
