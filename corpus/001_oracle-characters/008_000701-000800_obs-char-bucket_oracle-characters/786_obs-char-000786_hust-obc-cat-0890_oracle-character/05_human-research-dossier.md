# obs-char-000786 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000786`
- primary external id: `hust-obc-cat-0890`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/786_obs-char-000786_hust-obc-cat-0890_orac
  le-character/03_visual-assets/001_asset-000791_hust-obc-cat-0890_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0890/L_0890_9396.jpg`
- asset id: `asset-000791`
...
- source category: `0890`
- validation class: `785`
- source image route: `HUST-OBC/deciphered/0890/L_0890_9396.jpg`
- asset id: `asset-000791`
...
- English observation: `The tiny faint image contains two small upper looped
  or diamond-like marks and a lower angular cluster with an enclosed
  opening; fine connections remain difficult to resolve.`
- 中文观察: `微小淡弱图像含两个小型上部环状或菱形痕，以及带空隙的下部折角笔群；细连接仍难辨。`
...
- dataset label text: `㝰`
- dataset label codepoints: `U+3770`
...
- Which source records identify obs-char-000786 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000786？
