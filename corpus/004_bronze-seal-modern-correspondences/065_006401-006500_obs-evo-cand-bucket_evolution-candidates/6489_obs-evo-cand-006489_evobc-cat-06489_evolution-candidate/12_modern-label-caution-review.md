# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006489
...
- EVOBC candidate category: `evobc-evo-cat-06489`.
- Source label for search only: `終`.
- Source codepoints for search only: `U+7D42`.
