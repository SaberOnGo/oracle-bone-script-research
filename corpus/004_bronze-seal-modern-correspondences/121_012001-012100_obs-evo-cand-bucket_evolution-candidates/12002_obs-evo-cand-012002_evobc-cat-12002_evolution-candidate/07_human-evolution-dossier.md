...
- External category reference: `evobc-cat-12002`
- Source category ID: `12002`
- Source label: `𦎅`
...
- `obs-evo-cand-012002-route-category-staging`
...
- `obs-evo-cand-012002-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012002-route-evolution-graph`
