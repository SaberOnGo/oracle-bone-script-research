...
Project ID: `obs-evo-cand-005233`
...
- Project ID: `obs-evo-cand-005233`
- EVOBC category candidate ID: `evobc-evo-cat-05233`
- External category reference: `evobc-cat-05233`
- Source category ID: `05233`
- Source label for human review: `犒`
- Source codepoints: `U+7292`
...
- `obs-evo-cand-005233-route-category-staging`
...
- `obs-evo-cand-005233-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005233-route-evolution-graph`
