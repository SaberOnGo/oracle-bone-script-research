...
- Project ID / 项目 ID: `obs-char-001401`
- Primary external ID / 首选外部 ID: `hust-obc-cat-1569`
...
- Source image / 来源图: `G_1569_拾4.9(甲).png`
- Image / 图像: `001_asset-001406_hust-obc-cat-1569_glyph.png`
...
- Source label text / 来源标签文字: `㨗`
- Source label codepoint / 来源标签 codepoint: `U+3A17`
