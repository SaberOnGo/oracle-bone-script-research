# obs-char-001546 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1546_obs-char-001546_hust-obc-cat-1735_ora
  cle-character/03_visual-assets/001_asset-001551_hust-obc-cat-1735_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1735/G_1735_京津4462(甲).png`
- asset id: `asset-001551`
...
- source category: `1735`
- validation class: `1545`
- source image route: `HUST-OBC/deciphered/1735/G_1735_京津4462(甲).png`
- asset id: `asset-001551`
...
- English observation: `A composite has a rounded upper enclosure, a pointed
  lower base, and a long right contour.`
- 中文观察: `组合形体有圆折上部框形、尖状下部底形和右侧长轮廓。`
...
- dataset label text: `㪽`
- dataset label codepoints: `U+3ABD`
...
- Which source records identify obs-char-001546 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001546？
