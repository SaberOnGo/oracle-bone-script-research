...
Project ID: `obs-evo-cand-006621`
...
- Project ID: `obs-evo-cand-006621`
- EVOBC category candidate ID: `evobc-evo-cat-06621`
- External category reference: `evobc-cat-06621`
- Source category ID: `06621`
- Source label for human review: `縁`
- Source codepoints: `U+7E01`
...
- `obs-evo-cand-006621-route-category-staging`
...
- `obs-evo-cand-006621-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006621-route-evolution-graph`
