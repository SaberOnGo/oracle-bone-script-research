# obs-unk-004600 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/100_obs-unk-004600_h
  ust-obc-und-X-004600_oracle-character-candidate/03_visual-assets/001_asset
  -006193_hust-obc-und-X-004600_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/156/X_？_8333_1.png`
- asset id: `asset-006193`
...
- source class: `HUST-OBC/undeciphered/X/156/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/156/X_？_8333_1.png`
- asset id: `asset-006193`
...
- English observation: `Central stem, left hook, upper branch, and split`
  `lower traces recorded.`
- 中文观察: `已记录中央主痕、左侧钩痕、上部分支和分开的下部痕。`
...
- Which source records identify obs-unk-004600 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004600？
