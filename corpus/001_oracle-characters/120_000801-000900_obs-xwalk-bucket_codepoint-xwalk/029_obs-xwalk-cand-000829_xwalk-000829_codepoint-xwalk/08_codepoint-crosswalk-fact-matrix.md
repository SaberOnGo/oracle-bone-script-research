# obs-xwalk-cand-000829 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+379F` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-0937` | not reading |
...
| HUST candidate route | `corpus/001_oracle-characters/009_000801-000900_obs-char-bucket_oracle-characters/829_obs-char-000829_hust-obc-cat-0937_oracle-character/01_candidate-character-packet.json` | open packet and local glyph dossier first |
