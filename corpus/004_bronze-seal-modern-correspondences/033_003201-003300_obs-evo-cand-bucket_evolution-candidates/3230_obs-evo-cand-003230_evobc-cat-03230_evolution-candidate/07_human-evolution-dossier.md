...
- External category reference: `evobc-cat-03230`
- Source category ID: `03230`
- Source label for human review: `戹`
...
- `obs-evo-cand-003230-route-category-staging`
...
- `obs-evo-cand-003230-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003230-route-evolution-graph`
