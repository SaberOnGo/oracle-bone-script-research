# obs-xwalk-cand-001000 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+385A` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-1124` | not reading |
