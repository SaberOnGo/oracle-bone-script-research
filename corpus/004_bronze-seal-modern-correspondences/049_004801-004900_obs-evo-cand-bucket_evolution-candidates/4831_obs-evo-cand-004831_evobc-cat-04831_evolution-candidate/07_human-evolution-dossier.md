...
- External category reference: `evobc-cat-04831`
- Source category ID: `04831`
- Source label for human review: `滃`
...
- `obs-evo-cand-004831-route-category-staging`
...
- `obs-evo-cand-004831-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004831-route-evolution-graph`
