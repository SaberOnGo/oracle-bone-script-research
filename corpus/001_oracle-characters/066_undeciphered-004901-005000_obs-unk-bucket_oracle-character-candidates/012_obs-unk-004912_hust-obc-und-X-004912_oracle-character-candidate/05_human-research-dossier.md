# obs-unk-004912 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004912`
- primary external id: `hust-obc-und-X-004912`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/012_obs-unk-004912_h
  ust-obc-und-X-004912_oracle-character-candidate/03_visual-assets/001_asset
  -006505_hust-obc-und-X-004912_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/468/X_？_7453_1.png`
- asset id: `asset-006505`
...
- The left angular outline has openings; the right junction has two branches.
- The single source view is present locally.
- 直接记录：`14_material-visual-observation.md`
- 左侧角状外轮廓有开口；右侧连接处有两条分枝。
- 单一来源视图已在本地保存。
...
- source class: `HUST-OBC/undeciphered/X/468/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/468/X_？_7453_1.png`
- asset id: `asset-006505`
...
- Which source records identify obs-unk-004912 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004912？
