...
Project ID: `obs-evo-cand-013335`
...
- Project ID: `obs-evo-cand-013335`
- EVOBC category candidate ID: `evobc-evo-cat-13335`
- External category reference: `evobc-cat-13335`
- Source category ID: `13335`
- Source label for human review: `𬢠`
- Source codepoints: `U+2C8A0`
...
- `obs-evo-cand-013335-route-category-staging`
...
- `obs-evo-cand-013335-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013335-route-evolution-graph`
