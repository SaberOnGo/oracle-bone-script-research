...
- External category reference: `evobc-cat-13378`
- Source category ID: `13378`
- Source label for human review: `𬪅`
...
- `obs-evo-cand-013378-route-category-staging`
...
- `obs-evo-cand-013378-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013378-route-evolution-graph`
