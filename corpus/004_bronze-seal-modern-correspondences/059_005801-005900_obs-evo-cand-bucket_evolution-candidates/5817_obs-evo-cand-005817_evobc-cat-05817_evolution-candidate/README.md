# obs-evo-cand-005817 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-05817`
- Source label: `眾`
- Source codepoints: `U+773E`
- Image reference count: `168`
- Era token counts: `BI:13;CS:2;OBC:101;SS:2;WSC:50`
- Source token counts: `Book:59;Web:109`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 101 image references
- era 1 / BI: 13 image references
- era 2 / SS: 2 image references
- era 4 / WSC: 50 image references
- era 5 / CS: 2 image references
- source 0 / Web:1633: 5 image references
- source 1 / Web:105952;說文Web:58: 80 image references
- source 2 / Book:17600: 24 image references
- source 3 / Book:21681: 5 image references
- source 5 / Book:32794: 24 image references
