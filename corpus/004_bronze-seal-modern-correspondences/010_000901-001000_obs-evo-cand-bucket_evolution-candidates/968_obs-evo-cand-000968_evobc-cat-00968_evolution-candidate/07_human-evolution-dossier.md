...
- Project ID: `obs-evo-cand-000968`
- EVOBC category candidate ID: `evobc-evo-cat-00968`
- External category reference: `evobc-cat-00968`
- Source category ID: `00968`
- Source label for human review: `偳`
- Source codepoints: `U+5073`
...
- `obs-evo-cand-000968-route-category-staging`
...
- `obs-evo-cand-000968-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000968-route-evolution-graph`
