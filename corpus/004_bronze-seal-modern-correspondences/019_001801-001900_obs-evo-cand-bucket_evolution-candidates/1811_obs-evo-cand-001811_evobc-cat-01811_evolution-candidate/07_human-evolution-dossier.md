...
- Project ID: `obs-evo-cand-001811`
- EVOBC category candidate ID: `evobc-evo-cat-01811`
- External category reference: `evobc-cat-01811`
- Source category ID: `01811`
- Source label for human review: `坋`
- Source codepoints: `U+574B`
...
- `obs-evo-cand-001811-route-category-staging`
...
- `obs-evo-cand-001811-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001811-route-evolution-graph`
