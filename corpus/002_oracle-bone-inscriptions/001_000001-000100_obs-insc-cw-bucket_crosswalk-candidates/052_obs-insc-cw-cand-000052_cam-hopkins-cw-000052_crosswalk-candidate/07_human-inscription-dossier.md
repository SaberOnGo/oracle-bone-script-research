...
- Yingguo / 英国所藏: `y339` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `43` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `618` in source row; primary catalog entry pending
- Heji / 合集: `40571` in source row; primary catalog entry pending
