# obs-char-000938 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000938`
- primary external id: `hust-obc-cat-1055`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/938_obs-char-000938_hust-obc-cat-1055_orac
  le-character/03_visual-assets/001_asset-000943_hust-obc-cat-1055_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1055/H_1055_612C1_0.png`
- asset id: `asset-000943`
...
- source category: `1055`
- validation class: `937`
- source image route: `HUST-OBC/deciphered/1055/H_1055_612C1_0.png`
- asset id: `asset-000943`
...
- English observation: `A very bold form combines an upper U-like cluster, a
  long horizontal crossbar, a lower pointed projection, and a separate
  central descending stroke.`
- 中文观察: `粗重形体结合上部 U 形笔群、长横笔、下部尖形伸笔和分离的中央下行笔。`
...
- dataset label text: `㠕`
- dataset label codepoints: `U+3815`
...
- filename catalog route clues: `catalog-like filename clue: H_1055
  (H_1055_612C1_0.png)`
...
- Which source records identify obs-char-000938 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000938？
