# obs-evo-cand-001754 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-01754`
- Source label: `四`
- Source codepoints: `U+56DB`
- Image reference count: `272`
- Era token counts: `BI:95;CS:1;OBC:28;SAC:14;SS:4;WSC:130`
- Source token counts: `Book:132;Web:140`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 28 image references
- era 1 / BI: 95 image references
- era 2 / SS: 4 image references
- era 3 / SAC: 14 image references
- era 4 / WSC: 130 image references
- era 5 / CS: 1 image references
- source 1 / Web:105952;說文Web:58: 140 image references
