...
- Project ID: `obs-evo-cand-006800`
- EVOBC category candidate ID: `evobc-evo-cat-06800`
- External category reference: `evobc-cat-06800`
- Source category ID: `06800`
- Source label for human review: `罘`
- Source codepoints: `U+7F58`
...
- `obs-evo-cand-006800-route-category-staging`
...
- `obs-evo-cand-006800-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006800-route-evolution-graph`
