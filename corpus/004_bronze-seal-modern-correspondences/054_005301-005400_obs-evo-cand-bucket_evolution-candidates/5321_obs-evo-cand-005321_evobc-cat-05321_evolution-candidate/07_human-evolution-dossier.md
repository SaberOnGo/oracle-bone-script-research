...
- Project ID: `obs-evo-cand-005321`
- EVOBC category candidate ID: `evobc-evo-cat-05321`
- External category reference: `evobc-cat-05321`
- Source category ID: `05321`
- Source label for human review: `獠`
- Source codepoints: `U+7360`
...
- `obs-evo-cand-005321-route-category-staging`
...
- `obs-evo-cand-005321-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005321-route-evolution-graph`
