...
- External category reference: `evobc-cat-02404`
- Source category ID: `02404`
- Source label for human review: `宿`
- Source codepoints: `U+5BBF`
...
- `obs-evo-cand-002404-route-category-staging`
...
- `obs-evo-cand-002404-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002404-route-evolution-graph`
