# obs-unk-006406 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006406`
- primary external id: `hust-obc-und-X-006406`
...
- local review image route: `corpus/001_oracle-characters/081_undeciphered-006
  401-006500_obs-unk-bucket_oracle-character-candidates/006_obs-unk-006406_h
  ust-obc-und-X-006406_oracle-character-candidate/03_visual-assets/001_asset
  -007997_hust-obc-und-X-006406_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1962/X_？_545_1.png`
- asset id: `asset-007997`
...
- source class: `HUST-OBC/undeciphered/X/1962/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1962/X_？_545_1.png`
- asset id: `asset-007997`
...
- Which source records identify obs-unk-006406 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006406？
