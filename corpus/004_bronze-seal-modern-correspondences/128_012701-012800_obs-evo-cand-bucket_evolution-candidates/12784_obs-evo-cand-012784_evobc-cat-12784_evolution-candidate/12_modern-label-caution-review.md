# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012784
...
- EVOBC candidate category: `evobc-evo-cat-12784`.
- Source label for search only: `𪗍`.
- Source codepoints for search only: `U+2A5CD`.
