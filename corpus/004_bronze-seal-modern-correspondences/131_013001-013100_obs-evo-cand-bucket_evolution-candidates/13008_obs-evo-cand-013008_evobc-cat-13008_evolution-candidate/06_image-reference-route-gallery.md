...
- `obs-evo-cand-013008-route-category-staging`
...
- `obs-evo-cand-013008-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013008-route-evolution-graph`
