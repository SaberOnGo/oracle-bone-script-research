# Material Visual Observation / obs-comp-cand-000400 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000400`
- External reference / 外部参照: `obimd-sub-b4g0n16lxd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012323_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/b4g0n16lxd/b4g0n16lxd/b4g0n16lxd.png`
- Checksum / 校验和:
  `c5e16a3e8c55faa5c1ccb3ab0161cc3f2cc622c93546576d8699e23917eeb03e`
...
- Marked-pixel bounds: (77,26)–(172,223); span 96 × 198 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.18%。
- 痕迹范围：(77,26)–(172,223)；跨度96 × 198 px；痕迹矩形高于宽。
