# obs-evo-cand-008128 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-08128`
- Source label: `訊`
- Source codepoints: `U+8A0A`
- Image reference count: `103`
- Era token counts: `BI:38;CS:1;OBC:52;SS:2;WSC:10`
- Source token counts: `Book:45;Web:58`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 52 image references
