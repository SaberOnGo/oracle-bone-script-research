# obs-char-000269 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000269`
- primary external id: `hust-obc-cat-0302_0303`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/269_obs-char-000269_hust-obc-cat-0302_0303
  _oracle-character/03_visual-assets/001_asset-000274_hust-obc-cat-0302_0303
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0302_0303/0302/G_0302_乙102合2139
  8.png`
- asset id: `asset-000274`
...
- source category: `0302_0303`
- validation class: `268`
- source image route: `HUST-OBC/deciphered/0302_0303/0302/G_0302_乙102合21398.pn
  g`
- asset id: `asset-000274`
...
- English observation: `The image has three short parallel curved marks on
  the left and a long descending stroke on the right with a slight angular
  turn.`
- 中文观察: `图像左侧有三道短而平行的弯曲痕迹，右侧有长下行笔画并带轻微折转。`
...
- dataset label text: `㔤㔥`
- dataset label codepoints: `U+3524;U+3525`
...
- graph edge count: `2`
- codepoint routes: `U+3524;U+3525`
...
- filename catalog route clues: `Heji-like filename clue: 合21398
...
- Which source records identify obs-char-000269 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000269？
