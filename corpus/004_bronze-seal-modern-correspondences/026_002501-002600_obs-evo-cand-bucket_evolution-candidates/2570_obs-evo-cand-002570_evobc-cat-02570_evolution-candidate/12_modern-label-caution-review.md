# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002570
...
- EVOBC candidate category: `evobc-evo-cat-02570`.
- Source label for search only: `崟`.
- Source codepoints for search only: `U+5D1F`.
