# Material Visual Observation / obs-comp-cand-002197 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002197`
- External reference / 外部参照: `obimd-sub-wt5bp4oddj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019903_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/phxqocglhv/wt5bp4oddj/wt5bp4oddj.png`
- Checksum / 校验和:
  `0267c08664bd9594378041bc02199c92840ebc1a87f178b3c080b01a0948aac9`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.27%.
- Marked-pixel bounds: (92,30)–(157,205); span 66 × 176 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.27%。
- 痕迹范围：(92,30)–(157,205)；跨度66 × 176 px；痕迹矩形高于宽。
