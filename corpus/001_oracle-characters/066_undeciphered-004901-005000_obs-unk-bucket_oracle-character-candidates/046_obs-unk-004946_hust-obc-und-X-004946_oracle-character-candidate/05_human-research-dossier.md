# obs-unk-004946 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004946`
- primary external id: `hust-obc-und-X-004946`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/046_obs-unk-004946_h
  ust-obc-und-X-004946_oracle-character-candidate/03_visual-assets/001_asset
  -006539_hust-obc-und-X-004946_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/502/X_？_7485_1.png`
- asset id: `asset-006539`
...
- Two separated branched groups are visible.
...
- source class: `HUST-OBC/undeciphered/X/502/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/502/X_？_7485_1.png`
- asset id: `asset-006539`
...
- Which source records identify obs-unk-004946 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004946？
