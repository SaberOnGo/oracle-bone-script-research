...
- Project ID: `obs-evo-cand-006981`
- EVOBC category candidate ID: `evobc-evo-cat-06981`
- External category reference: `evobc-cat-06981`
- Source category ID: `06981`
- Source label for human review: `肎`
- Source codepoints: `U+808E`
...
- `obs-evo-cand-006981-route-category-staging`
...
- `obs-evo-cand-006981-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006981-route-evolution-graph`
