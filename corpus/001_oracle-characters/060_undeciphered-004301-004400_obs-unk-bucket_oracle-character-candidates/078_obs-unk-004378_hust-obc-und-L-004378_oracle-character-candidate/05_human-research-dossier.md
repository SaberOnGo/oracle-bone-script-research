# obs-unk-004378 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004378`
- primary external id: `hust-obc-und-L-004378`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/078_obs-unk-004378_h
  ust-obc-und-L-004378_oracle-character-candidate/03_visual-assets/001_asset
  -005971_hust-obc-und-L-004378_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4378/L_？_9724.jpg`
- asset id: `asset-005971`
...
- source class: `HUST-OBC/undeciphered/L/4378/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4378/L_？_9724.jpg`
- asset id: `asset-005971`
...
- English observation: `A tall left trace and stacked central strokes`
  `are visible; a curved trace descends on the lower right.`
- 中文观察: `左侧有纵向痕迹，中部笔痕叠置，右下有向下弯曲的痕迹。`
...
- Which source records identify obs-unk-004378 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004378？
