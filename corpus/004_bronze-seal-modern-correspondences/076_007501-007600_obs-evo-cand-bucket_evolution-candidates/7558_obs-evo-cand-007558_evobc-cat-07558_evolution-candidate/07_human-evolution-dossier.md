...
- External category reference: `evobc-cat-07558`
- Source category ID: `07558`
- Source label for human review: `蔡`
- Source codepoints: `U+8521`
- Image reference count in source metadata: `100`
...
- `obs-evo-cand-007558-route-category-staging`
...
- `obs-evo-cand-007558-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007558-route-evolution-graph`
