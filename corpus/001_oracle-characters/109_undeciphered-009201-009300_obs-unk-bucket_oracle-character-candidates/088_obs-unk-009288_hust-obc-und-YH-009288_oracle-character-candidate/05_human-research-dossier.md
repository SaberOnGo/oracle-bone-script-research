# obs-unk-009288 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/109_undeciphered-009
  201-009300_obs-unk-bucket_oracle-character-candidates/088_obs-unk-009288_h
  ust-obc-und-YH-009288_oracle-character-candidate/03_visual-assets/001_asse
  t-010879_hust-obc-und-YH-009288_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/615EF/H_？_615EF_0.png`
- asset id: `asset-010879`
...
- source class: `HUST-OBC/undeciphered/Y+H/615EF/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/615EF/H_？_615EF_0.png`
- asset id: `asset-010879`
...
- Which source records identify obs-unk-009288 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009288？
