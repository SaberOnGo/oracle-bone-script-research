...
- External category reference: `evobc-cat-08278`
- Source category ID: `08278`
- Source label for human review: `諟`
...
- `obs-evo-cand-008278-route-category-staging`
...
- `obs-evo-cand-008278-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008278-route-evolution-graph`
