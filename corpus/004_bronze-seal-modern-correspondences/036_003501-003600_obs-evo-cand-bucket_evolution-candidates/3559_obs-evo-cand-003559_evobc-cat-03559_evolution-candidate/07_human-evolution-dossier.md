...
- External category reference: `evobc-cat-03559`
- Source category ID: `03559`
- Source label for human review: `攷`
- Source codepoints: `U+6537`
...
- `obs-evo-cand-003559-route-category-staging`
...
- `obs-evo-cand-003559-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003559-route-evolution-graph`
