...
- External category reference: `evobc-cat-05504`
- Source category ID: `05504`
- Source label for human review: `瓠`
- Source codepoints: `U+74E0`
...
- `obs-evo-cand-005504-route-category-staging`
...
- `obs-evo-cand-005504-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005504-route-evolution-graph`
