...
Project ID: `obs-evo-cand-010127`
...
- Project ID: `obs-evo-cand-010127`
- EVOBC category candidate ID: `evobc-evo-cat-10127`
- External category reference: `evobc-cat-10127`
- Source category ID: `10127`
- Source label for human review: `餾`
- Source codepoints: `U+993E`
...
- `obs-evo-cand-010127-route-category-staging`
...
- `obs-evo-cand-010127-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010127-route-evolution-graph`
