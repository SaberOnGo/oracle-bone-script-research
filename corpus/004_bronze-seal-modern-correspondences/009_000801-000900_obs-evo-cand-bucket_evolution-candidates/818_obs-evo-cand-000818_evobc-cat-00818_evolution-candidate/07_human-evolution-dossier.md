...
- Project ID: `obs-evo-cand-000818`
- EVOBC category candidate ID: `evobc-evo-cat-00818`
- External category reference: `evobc-cat-00818`
- Source category ID: `00818`
- Source label for human review: `佯`
- Source codepoints: `U+4F6F`
...
- `obs-evo-cand-000818-route-category-staging`
...
- `obs-evo-cand-000818-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000818-route-evolution-graph`
