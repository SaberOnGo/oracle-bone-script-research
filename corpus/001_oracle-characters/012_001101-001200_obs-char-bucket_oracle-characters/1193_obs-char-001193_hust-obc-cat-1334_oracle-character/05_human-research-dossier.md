# obs-char-001193 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001193`
- primary external id: `hust-obc-cat-1334`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1193_obs-char-001193_hust-obc-cat-1334_ora
  cle-character/03_visual-assets/001_asset-001198_hust-obc-cat-1334_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1334/X_1334_219_1.png`
- asset id: `asset-001198`
...
- source category: `1334`
- validation class: `1192`
- source image route: `HUST-OBC/deciphered/1334/X_1334_219_1.png`
- asset id: `asset-001198`
...
- English observation: `A large branching form has a long central descending
  stroke, a broad left branch, an upper fork, and three detached small
  marks.`
- 中文观察: `大型分枝形体有中央长下行笔、宽大左侧分枝、上部分叉和三个分离的小型痕迹。`
...
- dataset label text: `㤬`
- dataset label codepoints: `U+392C`
...
- Which source records identify obs-char-001193 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001193？
