# Material Visual Observation / obs-comp-cand-000555 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000555`
- External reference / 外部参照: `obimd-sub-dzob6ag7n1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012807_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dzob6ag7n1/dzob6ag7n1/dzob6ag7n1.png`
- Checksum / 校验和:
  `09ecbc254bbf304f4f4f713f06086c189b6d03dcde89fedfc4b39e0065b09e89`
...
- Marked-pixel bounds: (65,20)–(184,230); span 120 × 211 px; the marked
...
- 痕迹范围：(65,20)–(184,230)；跨度120 × 211 px；痕迹矩形高于宽。
