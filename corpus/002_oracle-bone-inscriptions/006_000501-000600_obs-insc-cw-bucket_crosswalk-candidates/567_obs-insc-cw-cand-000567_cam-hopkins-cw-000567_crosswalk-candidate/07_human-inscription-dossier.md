...
- Yingguo / 英国所藏: `y2582` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `409` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `536` in source row; primary catalog entry pending
