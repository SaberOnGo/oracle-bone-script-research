# obs-unk-002044 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002044`
- primary external id: `hust-obc-und-L-002044`
...
- local review image route: `corpus/001_oracle-characters/037_undeciphered-002
  001-002100_obs-unk-bucket_oracle-character-candidates/044_obs-unk-002044_h
  ust-obc-und-L-002044_oracle-character-candidate/03_visual-assets/001_asset
  -003637_hust-obc-und-L-002044_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2044/L_？_2104.jpg`
- asset id: `asset-003637`
...
- source class: `HUST-OBC/undeciphered/L/2044/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2044/L_？_2104.jpg`
- asset id: `asset-003637`
...
- Which source records identify obs-unk-002044 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002044？
