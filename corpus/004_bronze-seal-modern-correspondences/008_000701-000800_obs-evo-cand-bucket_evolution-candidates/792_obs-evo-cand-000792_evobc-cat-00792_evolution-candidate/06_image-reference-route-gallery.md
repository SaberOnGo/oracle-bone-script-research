...
- `obs-evo-cand-000792-route-category-staging`
...
- `obs-evo-cand-000792-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000792-route-evolution-graph`
