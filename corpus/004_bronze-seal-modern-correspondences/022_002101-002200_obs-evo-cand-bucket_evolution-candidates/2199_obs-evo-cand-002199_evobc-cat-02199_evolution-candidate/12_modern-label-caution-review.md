# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002199
...
- EVOBC candidate category: `evobc-evo-cat-02199`.
- Source label for search only: `婚`.
- Source codepoints for search only: `U+5A5A`.
