# Material Visual Observation / obs-comp-cand-001703 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001703`
- External reference / 外部参照: `obimd-sub-i72bd4i3o5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017619_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/i72bd4i3o5/i72bd4i3o5/i72bd4i3o5.png`
- Checksum / 校验和:
  `70d786d5fbd05bfbe21fccd882d93fbdb9ded751984bd5077bbf32a9169ef367`
...
- Marked-pixel bounds: (80,36)–(169,209); span 90 × 174 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.70%。
- 痕迹范围：(80,36)–(169,209)；跨度90 × 174 px；痕迹矩形高于宽。
