...
- Project ID: `obs-evo-cand-011310`
- EVOBC category candidate ID: `evobc-evo-cat-11310`
- External category reference: `evobc-cat-11310`
- Source category ID: `11310`
- Source label for human review: `𢯶`
- Source codepoints: `U+22BF6`
...
- `obs-evo-cand-011310-route-category-staging`
...
- `obs-evo-cand-011310-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011310-route-evolution-graph`
