# obs-comp-cand-002647 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002647`
- 首选外部 ID: `obimd-sub-lcolftissc`
- OBIMD subcharacter UID: `lcolftissc`
...
- codepoint 示例: U+FEEED; U+FEEEE; 另有 12 项
