...
- External category reference: `evobc-cat-01197`
- Source category ID: `01197`
- Source label for human review: `判`
- Source codepoints: `U+5224`
...
- `obs-evo-cand-001197-route-category-staging`
...
- `obs-evo-cand-001197-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001197-route-evolution-graph`
