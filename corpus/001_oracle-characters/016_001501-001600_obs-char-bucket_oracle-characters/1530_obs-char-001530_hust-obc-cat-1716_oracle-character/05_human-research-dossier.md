# obs-char-001530 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1530_obs-char-001530_hust-obc-cat-1716_ora
  cle-character/03_visual-assets/001_asset-001535_hust-obc-cat-1716_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1716/G_1716_乙1001合21564.png`
- asset id: `asset-001535`
...
- source category: `1716`
- validation class: `1529`
- source image route: `HUST-OBC/deciphered/1716/G_1716_乙1001合21564.png`
- asset id: `asset-001535`
...
- English observation: `Two faint adjacent forms repeat tall branching
  strokes with open central spaces.`
- 中文观察: `两个浅淡相邻形体重复高大分枝笔画，中央留有开放空间。`
...
- dataset label text: `㪪`
- dataset label codepoints: `U+3AAA`
...
- filename catalog route clues: `Heji-like filename clue: 合21564
...
- Which source records identify obs-char-001530 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001530？
