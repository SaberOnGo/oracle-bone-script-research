...
Project ID: `obs-evo-cand-002921`
...
- Project ID: `obs-evo-cand-002921`
- EVOBC category candidate ID: `evobc-evo-cat-02921`
- External category reference: `evobc-cat-02921`
- Source category ID: `02921`
- Source label for human review: `忳`
- Source codepoints: `U+5FF3`
...
- `obs-evo-cand-002921-route-category-staging`
...
- `obs-evo-cand-002921-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002921-route-evolution-graph`
