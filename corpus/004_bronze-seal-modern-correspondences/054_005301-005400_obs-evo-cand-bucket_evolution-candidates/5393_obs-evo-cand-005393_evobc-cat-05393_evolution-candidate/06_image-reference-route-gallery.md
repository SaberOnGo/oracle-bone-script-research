...
- `obs-evo-cand-005393-route-category-staging`
...
- `obs-evo-cand-005393-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005393-route-evolution-graph`
