# obs-unk-004022 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/022_obs-unk-004022_h
  ust-obc-und-L-004022_oracle-character-candidate/03_visual-assets/001_asset
  -005615_hust-obc-und-L-004022_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4022/L_？_8575.jpg`
- asset id: `asset-005615`
...
- source class: `HUST-OBC/undeciphered/L/4022/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4022/L_？_8575.jpg`
- asset id: `asset-005615`
...
- English observation: A narrow upright trace rises from a compact
  horizontal cluster. The upper end has a short protruding mark, while the
  lower cluster has thin extensions on both sides. The crop is tight.
- 中文观察：一条窄直痕从紧凑的横向痕迹组合中向上延伸；上端有短小凸出痕迹，
    下部组合两侧有细小延伸。图像裁切较紧。
...
- Which source records identify obs-unk-004022 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004022？
