...
- External category reference: `evobc-cat-06097`
- Source category ID: `06097`
- Source label: `稕`
...
- `obs-evo-cand-006097-route-category-staging`
...
- `obs-evo-cand-006097-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-006097-route-evolution-graph`
