# obs-comp-cand-000332 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000332`
- 首选外部 ID: `obimd-sub-n5t0jhw1aa`
- OBIMD subcharacter UID: `n5t0jhw1aa`
- OBIMD main character UID: `n5t0jhw1aa`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+F1EC6; U+F1EC7; 另有 1 项
