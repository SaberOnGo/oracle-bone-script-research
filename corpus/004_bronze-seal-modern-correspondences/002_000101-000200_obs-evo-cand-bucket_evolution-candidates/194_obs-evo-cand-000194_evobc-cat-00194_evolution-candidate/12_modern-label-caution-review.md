# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000194
...
- EVOBC candidate category: `evobc-evo-cat-00194`.
- Source label for search only: `㱚`.
- Source codepoints for search only: `U+3C5A`.
