...
Project ID: `obs-evo-cand-011723`
...
- Project ID: `obs-evo-cand-011723`
- EVOBC category candidate ID: `evobc-evo-cat-11723`
- External category reference: `evobc-cat-11723`
- Source category ID: `11723`
- Source label for human review: `𤺄`
- Source codepoints: `U+24E84`
...
- `obs-evo-cand-011723-route-category-staging`
...
- `obs-evo-cand-011723-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011723-route-evolution-graph`
