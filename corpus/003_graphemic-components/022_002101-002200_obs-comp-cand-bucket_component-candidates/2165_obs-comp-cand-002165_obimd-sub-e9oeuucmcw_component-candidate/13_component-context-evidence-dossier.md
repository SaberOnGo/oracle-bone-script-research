# obs-comp-cand-002165 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002165`
- 首选外部 ID: `obimd-sub-e9oeuucmcw`
- OBIMD subcharacter UID: `e9oeuucmcw`
...
- glyph-codepoint 数: `6`
- codepoint 示例: U+FC793; U+FC794; 另有 4 项
