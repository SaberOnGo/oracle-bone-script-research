...
Project ID: `obs-evo-cand-012673`
...
- Project ID: `obs-evo-cand-012673`
- EVOBC category candidate ID: `evobc-evo-cat-12673`
- External category reference: `evobc-cat-12673`
- Source category ID: `12673`
- Source label for human review: `𩫠`
- Source codepoints: `U+29AE0`
...
- `obs-evo-cand-012673-route-category-staging`
...
- `obs-evo-cand-012673-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012673-route-evolution-graph`
