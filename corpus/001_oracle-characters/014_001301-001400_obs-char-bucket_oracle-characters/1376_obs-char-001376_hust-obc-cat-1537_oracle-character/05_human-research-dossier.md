# obs-char-001376 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1376_obs-char-001376_hust-obc-cat-1537_ora
  cle-character/03_visual-assets/001_asset-001381_hust-obc-cat-1537_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1537/H_1537_60699_0.png`
- asset id: `asset-001381`
...
- source category: `1537`
- validation class: `1375`
- source image route: `HUST-OBC/deciphered/1537/H_1537_60699_0.png`
- asset id: `asset-001381`
...
- English observation: `Two separated forms combine a branched left stem
  with angular right strokes.`
- 中文观察: `两个分离形体组合为分枝左竖干和角状右侧笔画。`
...
- dataset label text: `㧷`
- dataset label codepoints: `U+39F7`
...
- filename catalog route clues: `catalog-like filename clue: H_1537
  (H_1537_60699_0.png)`
...
- Which source records identify obs-char-001376 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001376？
