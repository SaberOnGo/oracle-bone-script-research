...
- External category reference: `evobc-cat-08372`
- Source category ID: `08372`
- Source label for human review: `議`
...
- `obs-evo-cand-008372-route-category-staging`
...
- `obs-evo-cand-008372-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008372-route-evolution-graph`
