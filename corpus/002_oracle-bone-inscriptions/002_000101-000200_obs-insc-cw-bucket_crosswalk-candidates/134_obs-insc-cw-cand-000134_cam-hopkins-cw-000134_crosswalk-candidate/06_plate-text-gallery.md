...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000134` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y729` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `173` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `407` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `40205` [route_present_image_or_text_not_collected]
