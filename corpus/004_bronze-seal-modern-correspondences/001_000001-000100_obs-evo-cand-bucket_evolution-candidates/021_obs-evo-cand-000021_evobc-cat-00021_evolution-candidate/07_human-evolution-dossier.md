...
Project ID: `obs-evo-cand-000021`
...
- Project ID: `obs-evo-cand-000021`
- EVOBC category candidate ID: `evobc-evo-cat-00021`
- External category reference: `evobc-cat-00021`
- Source category ID: `00021`
- Source label for human review: `㓞`
- Source codepoints: `U+34DE`
...
- `obs-evo-cand-000021-route-category-staging`
...
- `obs-evo-cand-000021-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000021-route-evolution-graph`
