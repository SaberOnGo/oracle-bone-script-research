...
- Yingguo / 英国所藏: `y1997` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `435` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `730` in source row; primary catalog entry pending
- Heji / 合集: `41119` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000324`
