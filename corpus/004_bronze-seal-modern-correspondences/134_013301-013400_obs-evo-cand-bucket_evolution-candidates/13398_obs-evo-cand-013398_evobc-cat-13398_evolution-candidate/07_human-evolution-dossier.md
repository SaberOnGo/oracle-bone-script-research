...
- Project ID: `obs-evo-cand-013398`
- EVOBC category candidate ID: `evobc-evo-cat-13398`
- External category reference: `evobc-cat-13398`
- Source category ID: `13398`
- Source label for human review: `𬫔`
- Source codepoints: `U+2CAD4`
...
- `obs-evo-cand-013398-route-category-staging`
...
- `obs-evo-cand-013398-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013398-route-evolution-graph`
