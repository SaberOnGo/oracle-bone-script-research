# obs-comp-cand-000375 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000375`
- 首选外部 ID: `obimd-sub-jstya23ki5`
- OBIMD subcharacter UID: `jstya23ki5`
- OBIMD main character UID: `jstya23ki5`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+9A29;U+F2330; U+F2331; 另有 2 项
