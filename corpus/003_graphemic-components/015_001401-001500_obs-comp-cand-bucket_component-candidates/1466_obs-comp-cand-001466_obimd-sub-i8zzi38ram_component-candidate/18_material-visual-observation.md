# Material Visual Observation / obs-comp-cand-001466 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001466`
- External reference / 外部参照: `obimd-sub-i8zzi38ram`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016043_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7jecspy8fk/i8zzi38ram/i8zzi38ram.png`
- Checksum / 校验和:
  `f2157f9d63aa689fbf4f7c2e1068b5bea3f3b3caf0b6bd3936caf0469b4c3d5d`
...
- Marked-pixel bounds: (52,19)–(199,230); span 148 × 212 px; the marked
...
- 痕迹范围：(52,19)–(199,230)；跨度148 × 212 px；痕迹矩形高于宽。
