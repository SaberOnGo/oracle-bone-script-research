# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001497
...
- EVOBC candidate category: `evobc-evo-cat-01497`.
- Source label for search only: `同`.
- Source codepoints for search only: `U+540C`.
