...
Project ID: `obs-evo-cand-012777`
...
- Project ID: `obs-evo-cand-012777`
- EVOBC category candidate ID: `evobc-evo-cat-12777`
- External category reference: `evobc-cat-12777`
- Source category ID: `12777`
- Source label for human review: `𪕣`
- Source codepoints: `U+2A563`
...
- `obs-evo-cand-012777-route-category-staging`
...
- `obs-evo-cand-012777-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012777-route-evolution-graph`
