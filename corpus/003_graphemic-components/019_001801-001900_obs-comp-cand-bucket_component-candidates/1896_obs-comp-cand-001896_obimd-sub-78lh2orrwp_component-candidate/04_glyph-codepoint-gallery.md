# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001896
...
| --- | --- | --- | --- |
| `obimd-glyph-link-028747` | 󂸸󺴸 | `U+C2E38;U+FAD38` | `reviewed_metadata_only` |
| `obimd-glyph-link-028748` | 󺴹 | `U+FAD39` | `reviewed_metadata_only` |
