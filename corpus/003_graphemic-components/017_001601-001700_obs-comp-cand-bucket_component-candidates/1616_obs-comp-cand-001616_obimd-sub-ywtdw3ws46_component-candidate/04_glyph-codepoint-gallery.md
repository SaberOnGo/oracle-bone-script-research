# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001616
...
| --- | --- | --- | --- |
| `obimd-glyph-link-025140` | 򡭱󹚩 | `U+A1B71;U+F96A9` | `reviewed_metadata_only` |
| `obimd-glyph-link-025141` | 󹚪 | `U+F96AA` | `reviewed_metadata_only` |
| `obimd-glyph-link-025142` | 󹚫 | `U+F96AB` | `reviewed_metadata_only` |
| `obimd-glyph-link-025143` | 󹚬 | `U+F96AC` | `reviewed_metadata_only` |
| `obimd-glyph-link-025144` | 󹚭 | `U+F96AD` | `reviewed_metadata_only` |
