...
- `obs-evo-cand-001565-route-category-staging`
...
- `obs-evo-cand-001565-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001565-route-evolution-graph`
