# obs-char-001550 Human Research Dossier / 人类研究档案

This object-local dossier is the human research entrance for this
oracle-character candidate. It gathers current source routes, images, graph
clues, and missing research sections in one place.

本文件是该甲骨单字候选对象的人类研究入口。它把现有来源路线、字形图片、图谱线索和缺失研究项集中放在同一个对象目录内。
...
- project id: `obs-char-001550`
- primary external id: `hust-obc-cat-1741`
- source id: `src-hust-obc`
- packet: `01_candidate-character-packet.json`
- record type: `oracle_character_candidate_packet`
- review status: `needs_cross_source_review`
- promotion status: `needs_cross_source_review`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1550_obs-char-001550_hust-obc-cat-1741_ora
  cle-character/03_visual-assets/001_asset-001555_hust-obc-cat-1741_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1741/X_1741_4717_2.png`
- asset id: `asset-001555`
- download id: `dl-hust-obc-figshare-raw`
- source package: `large-src-000001`
- rights status: `source_marked_risk_noted`
- review status: `needs_human_visual_review`
- risk note: `HUST-OBC image derivative extracted from registered large
...
- source category: `1741`
- validation class: `1549`
- source image route: `HUST-OBC/deciphered/1741/X_1741_4717_2.png`
- asset id: `asset-001555`
...
- English observation: `A large dark form has a rounded upper enclosure, a
  broad middle body, and long lower strokes.`
- 中文观察: `大型深色形体有圆折上部框形、宽大中部主体和长下部笔画。`
...
- decipherment status: `unknown_until_cross_source_review`
- dataset label status: `dataset_label_candidate_not_accepted_reading`
- dataset label text: `㫃`
- dataset label codepoints: `U+3AC3`
...
cross-source and human review are complete.

来源标签只是从数据集复制来的检索线索。跨来源和人工复核完成前，它不是已接受的今字、读音或意义。

## 4. Later-Script And Cross-Source Routes / 后世字形路线

- graph edge count: `4`
- codepoint routes: `U+3AC3`
- cross-source status: `matched_obimd_and_evobc_by_codepoint`
...
- matched source ids / 匹配来源 ID: `src-hust-obc; src-obimd; src-evobc`
- OBIMD candidate ids / OBIMD 候选 ID: `obimd-main-cand-002692`
- OBIMD external refs / OBIMD 外部引用: `obimd-main-mm49eilaqb`
- OBIMD transcription field / OBIMD 转写字段: `㫃|𭤨`
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00154`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00154`
- EvoBC image reference count / EvoBC 图像引用数: `76`
- EvoBC oracle-bone source refs / EvoBC 甲骨来源标记: `true`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00154`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/154_obs-evo-can
  d-000154_evobc-cat-00154_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/154_obs-evo-cand-000154_evobc-cat-00154_evolu
  tion-candidate/07_human-evolution-dossier.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/154_obs-evo-cand-000154_evobc-cat-00154_evolu
  tion-candidate/09_cross-period-review-dossier.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/154_obs-evo-cand-000154_evobc-cat-00154_evolu
  tion-candidate/11_evolution-review-fact-matrix.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/154_obs-evo-cand-000154_evobc-cat-00154_evolu
  tion-candidate/12_modern-label-caution-review.md`
...
- matched OBIMD main UIDs: `mm49eilaqb`
- object-local component human files / 对象内构件人类档案:
  corpus/003_graphemic-components/020_001901-002000_obs-comp-cand-bucket_compo
  nent-candidates/1936_obs-comp-cand-001936_obimd-sub-mm49eilaqb_component-can
  didate/README.md
  corpus/003_graphemic-components/020_001901-002000_obs-comp-cand-bucket_compo
  nent-candidates/1936_obs-comp-cand-001936_obimd-sub-mm49eilaqb_component-can
  ...
  corpus/003_graphemic-components/020_001901-002000_obs-comp-cand-bucket_compo
  nent-candidates/1937_obs-comp-cand-001937_obimd-sub-j1sekhafab_component-can
  didate/README.md
  corpus/003_graphemic-components/020_001901-002000_obs-comp-cand-bucket_compo
  nent-candidates/1937_obs-comp-cand-001937_obimd-sub-j1sekhafab_component-can
  didate/11_human-component-dossier.md
...
- filename catalog route clues: `待查：需要从来源图像文件名和原始著录路线继续核对`
...
- Which source records identify obs-char-001550 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001550？
...
This dossier is a preparation-stage research entrance. It records what is
available and what is missing; it does not promote any candidate into formal
scholarship.
