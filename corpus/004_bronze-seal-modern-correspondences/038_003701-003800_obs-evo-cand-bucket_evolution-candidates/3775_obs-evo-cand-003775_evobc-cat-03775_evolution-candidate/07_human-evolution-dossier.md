...
- External category reference: `evobc-cat-03775`
- Source category ID: `03775`
- Source label for human review: `暍`
- Source codepoints: `U+668D`
...
- `obs-evo-cand-003775-route-category-staging`
...
- `obs-evo-cand-003775-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003775-route-evolution-graph`
