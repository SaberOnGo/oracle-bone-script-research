# Material Visual Observation / obs-comp-cand-000465 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000465`
- External reference / 外部参照: `obimd-sub-rru5a6mm78`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012613_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8gro2b24ja/rru5a6mm78/rru5a6mm78.png`
- Checksum / 校验和:
  `b8be68ccb84bd2f30e876eab936055d2d3dd9a2cd12f4c9989e467cc0f93666c`
...
- Marked-pixel bounds: (57,49)–(191,197); span 135 × 149 px; the marked
...
- 痕迹范围：(57,49)–(191,197)；跨度135 × 149 px；痕迹矩形近方形。
