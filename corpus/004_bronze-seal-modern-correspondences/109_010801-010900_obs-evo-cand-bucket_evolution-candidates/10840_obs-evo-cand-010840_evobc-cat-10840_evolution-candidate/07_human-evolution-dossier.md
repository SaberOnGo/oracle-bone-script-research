...
- External category reference: `evobc-cat-10840`
- Source category ID: `10840`
- Source label for human review: `𠗲`
- Source codepoints: `U+205F2`
...
- `obs-evo-cand-010840-route-category-staging`
...
- `obs-evo-cand-010840-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010840-route-evolution-graph`
