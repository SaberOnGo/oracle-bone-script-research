...
- External category reference: `evobc-cat-12884`
- Source category ID: `12884`
- Source label for human review: `𪹃`
- Source codepoints: `U+2AE43`
...
- `obs-evo-cand-012884-route-category-staging`
...
- `obs-evo-cand-012884-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012884-route-evolution-graph`
