...
Project ID: `obs-evo-cand-005336`
...
- Project ID: `obs-evo-cand-005336`
- EVOBC category candidate ID: `evobc-evo-cat-05336`
- External category reference: `evobc-cat-05336`
- Source category ID: `05336`
- Source label for human review: `獻`
- Source codepoints: `U+737B`
...
- `obs-evo-cand-005336-route-category-staging`
...
- `obs-evo-cand-005336-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005336-route-evolution-graph`
