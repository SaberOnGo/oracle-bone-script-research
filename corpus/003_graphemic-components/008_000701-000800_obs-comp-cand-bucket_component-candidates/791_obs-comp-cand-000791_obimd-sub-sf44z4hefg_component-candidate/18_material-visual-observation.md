# Material Visual Observation / obs-comp-cand-000791 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000791`
- External reference / 外部参照: `obimd-sub-sf44z4hefg`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013590_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6p9s6p6wyb/sf44z4hefg/sf44z4hefg.png`
- Checksum / 校验和:
  `442e3774d0c85ef460368b2c57c10bddc02156c93864105ae13e475ab384b250`
...
- Marked-pixel bounds: (69,25)–(180,226); span 112 × 202 px; the marked
...
- 痕迹范围：(69,25)–(180,226)；跨度112 × 202 px；痕迹矩形高于宽。
