...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0059`
...
- Source image / 来源图: `G_0059_乙2593(甲).png`
- Image / 图像: `001_asset-000056_hust-obc-cat-0059_glyph.png`
...
- target node: `obimd-main-cand-001015`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- target node: `evobc-evo-cat-00006`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC image references / EvoBC 图像引用数: `27`
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/006_obs-evo-cand-000006_evobc-cat-00006_evoluti
...
- Matched OBIMD main UIDs / OBIMD 主字 UID: `omtx3jpdtq`
...
- Source label text / 来源标签文字: `㐱`
- Source label codepoint / 来源标签 codepoint: `U+3431`
