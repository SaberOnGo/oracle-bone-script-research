...
- `obs-evo-cand-007788-route-category-staging`
...
- `obs-evo-cand-007788-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007788-route-evolution-graph`
