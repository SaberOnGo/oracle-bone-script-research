# obs-char-000048 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000048`
- primary external id: `hust-obc-cat-0056`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/048_obs-char-000048_hust-obc-cat-0056_orac
  le-character/03_visual-assets/001_asset-000053_hust-obc-cat-0056_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0056/X_0056_109_1.png`
- asset id: `asset-000053`
...
- source category: `0056`
- validation class: `47`
- source image route: `HUST-OBC/deciphered/0056/X_0056_109_1.png`
- asset id: `asset-000053`
...
- English observation: `Two dark forms are stacked vertically: the upper has
  a long top bar and curved side strokes, while the lower forms a rounded
  bowl.`
- 中文观察: `图像上下叠置两个深色形体：上方有长横画和弯曲侧笔画，下方呈圆弧框。`
...
- dataset label text: `㐮`
- dataset label codepoints: `U+342E`
...
- Which source records identify obs-char-000048 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000048？
