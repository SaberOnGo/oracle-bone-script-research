# obs-char-001041 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1041_obs-char-001041_hust-obc-cat-1167_ora
  cle-character/03_visual-assets/001_asset-001046_hust-obc-cat-1167_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1167/G_1167_甲骨文.png`
- asset id: `asset-001046`
...
- source category: `1167`
- validation class: `1040`
- source image route: `HUST-OBC/deciphered/1167/G_1167_甲骨文.png`
- asset id: `asset-001046`
...
- English observation: `A short horizontal upper stroke sits beside a long
  upright and a rounded descending curve with a hooked right terminal.`
- 中文观察: `短水平上部笔旁有长直立笔和圆弧下行笔，右端带钩状末笔。`
...
- dataset label text: `㢅`
- dataset label codepoints: `U+3885`
...
- Which source records identify obs-char-001041 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001041？
