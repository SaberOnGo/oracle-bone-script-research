...
Project ID: `obs-evo-cand-007435`
...
- Project ID: `obs-evo-cand-007435`
- EVOBC category candidate ID: `evobc-evo-cat-07435`
- External category reference: `evobc-cat-07435`
- Source category ID: `07435`
- Source label for human review: `萅`
- Source codepoints: `U+8405`
...
- `obs-evo-cand-007435-route-category-staging`
...
- `obs-evo-cand-007435-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007435-route-evolution-graph`
