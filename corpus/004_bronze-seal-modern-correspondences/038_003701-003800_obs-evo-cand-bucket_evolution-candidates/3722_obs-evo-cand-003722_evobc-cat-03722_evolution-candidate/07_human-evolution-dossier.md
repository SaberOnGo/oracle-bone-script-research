...
- External category reference: `evobc-cat-03722`
- Source category ID: `03722`
- Source label for human review: `昪`
...
- `obs-evo-cand-003722-route-category-staging`
...
- `obs-evo-cand-003722-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003722-route-evolution-graph`
