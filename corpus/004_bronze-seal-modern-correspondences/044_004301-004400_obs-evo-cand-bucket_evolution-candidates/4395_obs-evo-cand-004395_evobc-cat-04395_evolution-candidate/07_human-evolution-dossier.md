...
- External category reference: `evobc-cat-04395`
- Source category ID: `04395`
- Source label for human review: `歱`
...
- `obs-evo-cand-004395-route-category-staging`
...
- `obs-evo-cand-004395-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004395-route-evolution-graph`
