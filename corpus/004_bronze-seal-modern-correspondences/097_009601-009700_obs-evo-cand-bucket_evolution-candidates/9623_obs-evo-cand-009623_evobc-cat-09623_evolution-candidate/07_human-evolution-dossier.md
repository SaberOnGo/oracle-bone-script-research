...
- External category reference: `evobc-cat-09623`
- Source category ID: `09623`
- Source label for human review: `閔`
- Source codepoints: `U+9594`
...
- `obs-evo-cand-009623-route-category-staging`
...
- `obs-evo-cand-009623-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009623-route-evolution-graph`
