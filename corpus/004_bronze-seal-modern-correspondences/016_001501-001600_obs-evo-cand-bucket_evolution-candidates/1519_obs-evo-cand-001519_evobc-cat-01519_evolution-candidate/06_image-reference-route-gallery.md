...
- `obs-evo-cand-001519-route-category-staging`
...
- `obs-evo-cand-001519-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001519-route-evolution-graph`
