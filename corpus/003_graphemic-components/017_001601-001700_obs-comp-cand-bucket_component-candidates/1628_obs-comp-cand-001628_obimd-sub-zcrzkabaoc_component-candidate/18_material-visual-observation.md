# Material Visual Observation / obs-comp-cand-001628 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001628`
- External reference / 外部参照: `obimd-sub-zcrzkabaoc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017304_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dxvqlu3dcd/zcrzkabaoc/zcrzkabaoc.png`
- Checksum / 校验和:
  `6a4ce7fb702949c5a490c46c6038fa9ace7d1c48a1139a83cfb06b69e0752597`
...
- Marked-pixel bounds: (56,38)–(197,209); span 142 × 172 px; the marked
...
- 痕迹范围：(56,38)–(197,209)；跨度142 × 172 px；痕迹矩形高于宽。
