...
- External category reference: `evobc-cat-00741`
- Source category ID: `00741`
- Source label for human review: `仝`
- Source codepoints: `U+4EDD`
...
- `obs-evo-cand-000741-route-category-staging`
...
- `obs-evo-cand-000741-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000741-route-evolution-graph`
