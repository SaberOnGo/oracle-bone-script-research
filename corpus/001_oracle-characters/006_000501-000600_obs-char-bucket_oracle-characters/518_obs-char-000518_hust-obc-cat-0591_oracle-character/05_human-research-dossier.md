# obs-char-000518 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/518_obs-char-000518_hust-obc-cat-0591_orac
  le-character/03_visual-assets/001_asset-000523_hust-obc-cat-0591_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0591/G_0591_合35273(甲).png`
- asset id: `asset-000523`
...
- source category: `0591`
- validation class: `517`
- source image route: `HUST-OBC/deciphered/0591/G_0591_合35273(甲).png`
- asset id: `asset-000523`
...
- English observation: `A tiny divided box-like cluster with protruding
  upper strokes sits above a long bent stem that ends in a crossed angular
  lower form.`
- 中文观察: `带上部伸出笔画的小型分隔框状群位于长弯折主干上方，主干下端形成交叉折角形。`
...
- dataset label text: `㙅`
- dataset label codepoints: `U+3645`
...
- filename catalog route clues: `Heji-like filename clue: 合35273
  (G_0591_合35273(甲).png)`
...
- Which source records identify obs-char-000518 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000518？
