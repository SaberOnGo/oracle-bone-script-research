...
- External category reference: `evobc-cat-08076`
- Source category ID: `08076`
- Source label for human review: `覲`
...
- `obs-evo-cand-008076-route-category-staging`
...
- `obs-evo-cand-008076-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008076-route-evolution-graph`
