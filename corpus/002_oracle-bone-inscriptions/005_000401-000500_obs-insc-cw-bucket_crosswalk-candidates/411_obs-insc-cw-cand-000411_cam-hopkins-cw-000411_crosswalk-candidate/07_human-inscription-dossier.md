...
Project ID: `obs-insc-cw-cand-000411`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000411`
...
- Yingguo / 英国所藏: `y2209` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `446` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `40` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000411`
