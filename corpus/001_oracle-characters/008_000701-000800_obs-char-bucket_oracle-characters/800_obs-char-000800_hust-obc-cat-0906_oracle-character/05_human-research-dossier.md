# obs-char-000800 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000800`
- primary external id: `hust-obc-cat-0906`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/800_obs-char-000800_hust-obc-cat-0906_orac
  le-character/03_visual-assets/001_asset-000805_hust-obc-cat-0906_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0906/G_0906_乙8722合22135子組.png`
- asset id: `asset-000805`
...
- source category: `0906`
- validation class: `799`
- source image route: `HUST-OBC/deciphered/0906/G_0906_乙8722合22135子組.png`
- asset id: `asset-000805`
...
- English observation: `A pointed upper diagonal leads into a small
  rectangular middle frame; a short lower branch projects from the frame and
  bends toward the right.`
- 中文观察: `尖形上斜笔引入小型中部矩形框；框下伸出短枝并向右弯折。`
...
- dataset label text: `㞀`
- dataset label codepoints: `U+3780`
...
- filename catalog route clues: `Heji-like filename clue: 合22135
  (G_0906_乙8722合22135子組.png)`
...
- Which source records identify obs-char-000800 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000800？
