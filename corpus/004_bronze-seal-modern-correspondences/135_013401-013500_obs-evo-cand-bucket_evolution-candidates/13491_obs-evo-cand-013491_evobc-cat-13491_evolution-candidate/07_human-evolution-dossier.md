...
- External category reference: `evobc-cat-13491`
- Source category ID: `13491`
- Source label for human review: `𭉢`
...
- `obs-evo-cand-013491-route-category-staging`
...
- `obs-evo-cand-013491-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013491-route-evolution-graph`
