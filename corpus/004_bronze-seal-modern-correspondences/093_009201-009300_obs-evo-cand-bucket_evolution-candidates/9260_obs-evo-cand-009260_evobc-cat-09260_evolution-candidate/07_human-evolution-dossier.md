...
Project ID: `obs-evo-cand-009260`
...
- Project ID: `obs-evo-cand-009260`
- EVOBC category candidate ID: `evobc-evo-cat-09260`
- External category reference: `evobc-cat-09260`
- Source category ID: `09260`
- Source label for human review: `酹`
- Source codepoints: `U+9179`
...
- `obs-evo-cand-009260-route-category-staging`
...
- `obs-evo-cand-009260-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009260-route-evolution-graph`
