# obs-unk-007672 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-007672`
- primary external id: `hust-obc-und-YH-007672`
...
- local review image route: `corpus/001_oracle-characters/093_undeciphered-007
  601-007700_obs-unk-bucket_oracle-character-candidates/072_obs-unk-007672_h
  ust-obc-und-YH-007672_oracle-character-candidate/03_visual-assets/001_asse
  t-009263_hust-obc-und-YH-007672_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6020F/H_？_6020F_0.png`
- asset id: `asset-009263`
...
- source class: `HUST-OBC/undeciphered/Y+H/6020F/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6020F/H_？_6020F_0.png`
- asset id: `asset-009263`
...
- Which source records identify obs-unk-007672 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007672？
