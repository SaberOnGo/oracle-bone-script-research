# obs-char-000952 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000952`
- primary external id: `hust-obc-cat-1070`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/952_obs-char-000952_hust-obc-cat-1070_orac
  le-character/03_visual-assets/001_asset-000957_hust-obc-cat-1070_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1070/G_1070_乙3217合1780.png`
- asset id: `asset-000957`
...
- source category: `1070`
- validation class: `951`
- source image route: `HUST-OBC/deciphered/1070/G_1070_乙3217合1780.png`
- asset id: `asset-000957`
...
- English observation: `A broad pointed roof-like form has sloping sides, a
  heavy lower base, and a central dark interior.`
- 中文观察: `宽大尖形屋顶状形体有倾斜两侧、粗重下部底笔和中央深色内部笔。`
...
- dataset label text: `㠤`
- dataset label codepoints: `U+3824`
...
- filename catalog route clues: `Heji-like filename clue: 合1780
  (G_1070_乙3217合1780.png)`
...
- Which source records identify obs-char-000952 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000952？
