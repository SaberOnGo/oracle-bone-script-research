...
- Yingguo / 英国所藏: `y834` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `155` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `569` in source row; primary catalog entry pending
- Heji / 合集: `40075` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000150`
