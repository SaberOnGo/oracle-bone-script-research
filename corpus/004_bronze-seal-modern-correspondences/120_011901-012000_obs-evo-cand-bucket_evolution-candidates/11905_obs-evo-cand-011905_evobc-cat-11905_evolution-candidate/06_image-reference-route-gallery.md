...
- `obs-evo-cand-011905-route-category-staging`
...
- `obs-evo-cand-011905-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011905-route-evolution-graph`
