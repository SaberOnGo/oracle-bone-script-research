...
- External category reference: `evobc-cat-12769`
- Source category ID: `12769`
- Source label for human review: `𪓾`
- Source codepoints: `U+2A4FE`
...
- `obs-evo-cand-012769-route-category-staging`
...
- `obs-evo-cand-012769-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012769-route-evolution-graph`
