# obs-unk-002435 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002435`
- primary external id: `hust-obc-und-L-002435`
...
- local review image route: `corpus/001_oracle-characters/041_undeciphered-002
  401-002500_obs-unk-bucket_oracle-character-candidates/035_obs-unk-002435_h
  ust-obc-und-L-002435_oracle-character-candidate/03_visual-assets/001_asset
  -004028_hust-obc-und-L-002435_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2435/L_？_3495.jpg`
- asset id: `asset-004028`
...
- source class: `HUST-OBC/undeciphered/L/2435/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2435/L_？_3495.jpg`
- asset id: `asset-004028`
...
- Which source records identify obs-unk-002435 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002435？
