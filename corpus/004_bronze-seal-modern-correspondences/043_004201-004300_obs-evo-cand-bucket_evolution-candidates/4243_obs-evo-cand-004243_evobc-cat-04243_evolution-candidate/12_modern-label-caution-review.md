# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004243
...
- EVOBC candidate category: `evobc-evo-cat-04243`.
- Source label for search only: `樝`.
- Source codepoints for search only: `U+6A1D`.
