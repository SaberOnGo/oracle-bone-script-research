...
Project ID: `obs-evo-cand-005858`
...
- Project ID: `obs-evo-cand-005858`
- EVOBC category candidate ID: `evobc-evo-cat-05858`
- External category reference: `evobc-cat-05858`
- Source category ID: `05858`
- Source label for human review: `瞫`
- Source codepoints: `U+77AB`
...
- `obs-evo-cand-005858-route-category-staging`
...
- `obs-evo-cand-005858-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005858-route-evolution-graph`
