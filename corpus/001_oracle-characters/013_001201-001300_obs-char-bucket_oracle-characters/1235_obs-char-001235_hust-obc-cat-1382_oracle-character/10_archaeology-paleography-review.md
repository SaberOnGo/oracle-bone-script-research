# obs-char-001235 Archaeology Paleography Review

# obs-char-001235 考古文字复核档案
...
- first local image: `001_asset-001240_hust-obc-cat-1382_glyph.png`
- first source image: `G_1382_合26898(甲).png`
...
- source label text: `㥜`
- source label codepoints: `U+395C`
