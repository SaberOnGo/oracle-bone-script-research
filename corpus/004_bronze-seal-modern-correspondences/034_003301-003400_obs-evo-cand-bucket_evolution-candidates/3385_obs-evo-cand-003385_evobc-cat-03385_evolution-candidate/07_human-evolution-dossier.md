...
- Project ID: `obs-evo-cand-003385`
- EVOBC category candidate ID: `evobc-evo-cat-03385`
- External category reference: `evobc-cat-03385`
- Source category ID: `03385`
- Source label for human review: `捷`
- Source codepoints: `U+6377`
...
- `obs-evo-cand-003385-route-category-staging`
...
- `obs-evo-cand-003385-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003385-route-evolution-graph`
