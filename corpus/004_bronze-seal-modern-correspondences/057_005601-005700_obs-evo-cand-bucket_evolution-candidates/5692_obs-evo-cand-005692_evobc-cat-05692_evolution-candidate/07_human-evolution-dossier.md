...
- External category reference: `evobc-cat-05692`
- Source category ID: `05692`
- Source label: `癉`
...
- `obs-evo-cand-005692-route-category-staging`
...
- `obs-evo-cand-005692-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005692-route-evolution-graph`
