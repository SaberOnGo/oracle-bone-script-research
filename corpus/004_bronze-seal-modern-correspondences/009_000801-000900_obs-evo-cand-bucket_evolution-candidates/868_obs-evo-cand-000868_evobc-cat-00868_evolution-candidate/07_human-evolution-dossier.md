...
Project ID: `obs-evo-cand-000868`
...
- Project ID: `obs-evo-cand-000868`
- EVOBC category candidate ID: `evobc-evo-cat-00868`
- External category reference: `evobc-cat-00868`
- Source category ID: `00868`
- Source label for human review: `侸`
- Source codepoints: `U+4FB8`
...
- `obs-evo-cand-000868-route-category-staging`
...
- `obs-evo-cand-000868-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000868-route-evolution-graph`
