# obs-unk-004295 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004295`
- primary external id: `hust-obc-und-L-004295`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/095_obs-unk-004295_h
  ust-obc-und-L-004295_oracle-character-candidate/03_visual-assets/001_asset
  -005888_hust-obc-und-L-004295_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4295/L_？_9484.jpg`
- asset id: `asset-005888`
...
- source class: `HUST-OBC/undeciphered/L/4295/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4295/L_？_9484.jpg`
- asset id: `asset-005888`
...
- English observation: `Upper slants, central line, lower-left traces visible.`
- 中文观察: `上部斜痕、中央线和左下痕迹可见。`
...
- Which source records identify obs-unk-004295 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004295？
