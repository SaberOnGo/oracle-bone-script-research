# obs-unk-006006 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/077_undeciphered-006
  001-006100_obs-unk-bucket_oracle-character-candidates/006_obs-unk-006006_h
  ust-obc-und-X-006006_oracle-character-candidate/03_visual-assets/001_asset
  -007598_hust-obc-und-X-006006_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1562/X_？_3114_1.png`
- asset id: `asset-007598`
...
- source class: `HUST-OBC/undeciphered/X/1562/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1562/X_？_3114_1.png`
- asset id: `asset-007598`
...
- Which source records identify obs-unk-006006 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006006？
