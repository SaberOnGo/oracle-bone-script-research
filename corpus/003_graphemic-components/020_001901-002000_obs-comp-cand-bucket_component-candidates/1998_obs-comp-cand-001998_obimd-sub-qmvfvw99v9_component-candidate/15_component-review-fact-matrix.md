# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001998
...
| Glyph or codepoint route / 字形或码位路线 | 147 OBIMD route rows; examples U+5176;U+FB6EA; U+FB6EB; 另有 145 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 147 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
