# obs-char-000754 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000754`
- primary external id: `hust-obc-cat-0856`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/754_obs-char-000754_hust-obc-cat-0856_orac
  le-character/03_visual-assets/001_asset-000759_hust-obc-cat-0856_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0856/X_0856_2856_1.png`
- asset id: `asset-000759`
...
- source category: `0856`
- validation class: `753`
- source image route: `HUST-OBC/deciphered/0856/X_0856_2856_1.png`
- asset id: `asset-000759`
...
- English observation: `A broad high-sided upper outline surrounds a smaller
  pointed loop; its central lower stem joins a dense branching cluster that
  ends in several short roots.`
...
- dataset label text: `㝎`
- dataset label codepoints: `U+374E`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/067_obs-evo-can
  d-000067_evobc-cat-00067_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/067_obs-evo-cand-000067_evobc-cat-00067_evolu
...
- Which source records identify obs-char-000754 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000754？
