# obs-char-001372 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001372`
- primary external id: `hust-obc-cat-1531`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1372_obs-char-001372_hust-obc-cat-1531_ora
  cle-character/03_visual-assets/001_asset-001377_hust-obc-cat-1531_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1531/G_1531_京津1067合15379賓組.png`
- asset id: `asset-001377`
...
- source category: `1531`
- validation class: `1371`
- source image route: `HUST-OBC/deciphered/1531/G_1531_京津1067合15379賓組.png`
- asset id: `asset-001377`
...
- English observation: `A narrow vertical form has repeated right notches
  and a lower curved loop.`
- 中文观察: `狭长竖向形体有重复右向缺口和下部弧形环。`
...
- dataset label text: `㧱`
- dataset label codepoints: `U+39F1`
...
- filename catalog route clues: `Heji-like filename clue: 合15379
  (G_1531_京津1067合15379賓組.png)`
...
- Which source records identify obs-char-001372 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001372？
