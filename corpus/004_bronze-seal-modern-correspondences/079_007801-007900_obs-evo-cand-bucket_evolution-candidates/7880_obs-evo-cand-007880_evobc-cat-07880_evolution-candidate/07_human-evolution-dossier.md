...
Project ID: `obs-evo-cand-007880`
...
- Project ID: `obs-evo-cand-007880`
- EVOBC category candidate ID: `evobc-evo-cat-07880`
- External category reference: `evobc-cat-07880`
- Source category ID: `07880`
- Source label for human review: `蠛`
- Source codepoints: `U+881B`
...
- `obs-evo-cand-007880-route-category-staging`
...
- `obs-evo-cand-007880-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007880-route-evolution-graph`
