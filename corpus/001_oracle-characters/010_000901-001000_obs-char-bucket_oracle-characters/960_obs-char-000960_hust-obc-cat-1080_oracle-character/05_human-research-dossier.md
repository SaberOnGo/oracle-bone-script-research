# obs-char-000960 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000960`
- primary external id: `hust-obc-cat-1080`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/960_obs-char-000960_hust-obc-cat-1080_orac
  le-character/03_visual-assets/001_asset-000965_hust-obc-cat-1080_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1080/G_1080_乙1010合21731子組.png`
- asset id: `asset-000965`
...
- source category: `1080`
- validation class: `959`
- source image route: `HUST-OBC/deciphered/1080/G_1080_乙1010合21731子組.png`
- asset id: `asset-000965`
...
- English observation: `A rounded enclosed form has two pointed upper
  projections, a horizontal interior stroke, and a thick curved base.`
- 中文观察: `圆弧闭合形体有两个尖形上伸笔、内部横笔和粗重弯曲底笔。`
...
- dataset label text: `㠮`
- dataset label codepoints: `U+382E`
...
- filename catalog route clues: `Heji-like filename clue: 合21731
  (G_1080_乙1010合21731子組.png)`
...
- Which source records identify obs-char-000960 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000960？
