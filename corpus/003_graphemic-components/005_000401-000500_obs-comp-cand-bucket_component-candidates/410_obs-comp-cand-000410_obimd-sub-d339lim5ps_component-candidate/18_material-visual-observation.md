# Material Visual Observation / obs-comp-cand-000410 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000410`
- External reference / 外部参照: `obimd-sub-d339lim5ps`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012333_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/d339lim5ps/d339lim5ps/d339lim5ps.png`
- Checksum / 校验和:
  `4434f7276d4e2829649ed13d3fa017b421ebb44fd1ba99f8ef48476b8ffcf9ab`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.50%.
- Marked-pixel bounds: (79,19)–(170,225); span 92 × 207 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.50%。
- 痕迹范围：(79,19)–(170,225)；跨度92 × 207 px；痕迹矩形高于宽。
