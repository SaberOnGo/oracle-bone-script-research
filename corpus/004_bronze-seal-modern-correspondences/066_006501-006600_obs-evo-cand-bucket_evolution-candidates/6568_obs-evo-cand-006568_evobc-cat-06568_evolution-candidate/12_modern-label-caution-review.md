# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006568
...
- EVOBC candidate category: `evobc-evo-cat-06568`.
- Source label for search only: `綽`.
- Source codepoints for search only: `U+7DBD`.
