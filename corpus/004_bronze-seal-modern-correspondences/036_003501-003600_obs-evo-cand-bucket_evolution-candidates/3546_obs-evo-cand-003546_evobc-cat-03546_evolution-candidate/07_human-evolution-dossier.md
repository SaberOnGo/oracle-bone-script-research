...
- External category reference: `evobc-cat-03546`
- Source category ID: `03546`
- Source label for human review: `攙`
...
- `obs-evo-cand-003546-route-category-staging`
...
- `obs-evo-cand-003546-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003546-route-evolution-graph`
