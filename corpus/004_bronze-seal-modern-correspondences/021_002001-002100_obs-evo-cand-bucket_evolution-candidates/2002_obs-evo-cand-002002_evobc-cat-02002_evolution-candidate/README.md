# obs-evo-cand-002002 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-002002`
- EVOBC category candidate ID: `evobc-evo-cat-02002`
- External category ref: `evobc-cat-02002`
- Source label: `多`
- Source codepoints: `U+591A`
- Image reference count: `246`
- Era token counts: `BI:72;CS:1;OBC:102;SAC:7;SS:3;WSC:61`
- Source token counts: `Book:95;Web:151`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 102 image references
- era 1 / BI: 72 image references
- era 2 / SS: 3 image references
- era 3 / SAC: 7 image references
- era 4 / WSC: 61 image references
...
- source 3 / Book:21681: 36 image references
- source 4 / Book:9131: 7 image references
- source 5 / Book:32794: 20 image references
