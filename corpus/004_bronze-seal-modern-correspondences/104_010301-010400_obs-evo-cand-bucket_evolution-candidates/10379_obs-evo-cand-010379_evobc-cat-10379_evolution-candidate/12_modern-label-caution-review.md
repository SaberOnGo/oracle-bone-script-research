# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010379
...
- EVOBC candidate category: `evobc-evo-cat-10379`.
- Source label for search only: `魼`.
- Source codepoints for search only: `U+9B7C`.
