# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013286
...
- EVOBC candidate category: `evobc-evo-cat-13286`.
- Source label for search only: `𬖡`.
- Source codepoints for search only: `U+2C5A1`.
