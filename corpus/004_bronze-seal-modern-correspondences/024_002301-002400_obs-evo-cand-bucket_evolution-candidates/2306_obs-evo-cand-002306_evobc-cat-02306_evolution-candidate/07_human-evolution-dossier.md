...
- External category reference: `evobc-cat-02306`
- Source category ID: `02306`
- Source label for human review: `嬪`
- Source codepoints: `U+5B2A`
...
- `obs-evo-cand-002306-route-category-staging`
...
- `obs-evo-cand-002306-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002306-route-evolution-graph`
