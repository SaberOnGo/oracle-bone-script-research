# obs-unk-004469 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/069_obs-unk-004469_h
  ust-obc-und-X-004469_oracle-character-candidate/03_visual-assets/001_asset
  -006062_hust-obc-und-X-004469_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/25/X_？_7204_1.png`
- asset id: `asset-006062`
...
- source class: `HUST-OBC/undeciphered/X/25/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/25/X_？_7204_1.png`
- asset id: `asset-006062`
...
- English observation: Crossing upper traces lead to a long horizontal stroke
  and two separate lower terminals.
- 中文观察: 交叉上部痕迹连接中部横线，并向下分成两个末端。
...
- Which source records identify obs-unk-004469 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004469？
