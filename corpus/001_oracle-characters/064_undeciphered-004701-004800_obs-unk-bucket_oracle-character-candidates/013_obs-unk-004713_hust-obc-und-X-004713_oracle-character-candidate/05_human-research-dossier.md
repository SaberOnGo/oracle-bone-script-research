# obs-unk-004713 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004713`
- primary external id: `hust-obc-und-X-004713`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/013_obs-unk-004713_h
  ust-obc-und-X-004713_oracle-character-candidate/03_visual-assets/001_asset
  -006306_hust-obc-und-X-004713_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/269/X_？_7243_1.png`
- asset id: `asset-006306`
...
- source class: `HUST-OBC/undeciphered/X/269/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/269/X_？_7243_1.png`
- asset id: `asset-006306`
...
- English observation: `cross-like upper group with lower split strokes`
- 中文观察: `带下部开叉笔画的十字状上部结构`
...
- Which source records identify obs-unk-004713 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004713？
