...
- External category reference: `evobc-cat-07828`
- Source category ID: `07828`
- Source label for human review: `螘`
- Source codepoints: `U+8798`
...
- `obs-evo-cand-007828-route-category-staging`
...
- `obs-evo-cand-007828-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007828-route-evolution-graph`
