...
- External category reference: `evobc-cat-12357`
- Source category ID: `12357`
- Source label: `𨒩`
...
- `obs-evo-cand-012357-route-category-staging`
...
- `obs-evo-cand-012357-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012357-route-evolution-graph`
