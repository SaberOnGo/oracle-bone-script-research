# Material Visual Observation / obs-comp-cand-000707 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000707`
- External reference / 外部参照: `obimd-sub-ayjlria39o`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013383_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ayjlria39o/ayjlria39o/ayjlria39o.png`
- Checksum / 校验和:
  `a418b4fbebe5ea55cea03c633390eff5fce623eb3d3bed16e9d40337a0e7ad91`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.52%.
- Marked-pixel bounds: (78,56)–(172,212); span 95 × 157 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.52%。
- 痕迹范围：(78,56)–(172,212)；跨度95 × 157 px；痕迹矩形高于宽。
