...
- External category reference: `evobc-cat-07339`
- Source category ID: `07339`
- Source label for human review: `荄`
...
- `obs-evo-cand-007339-route-category-staging`
...
- `obs-evo-cand-007339-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007339-route-evolution-graph`
