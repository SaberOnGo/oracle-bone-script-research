...
- `obs-evo-cand-008502-route-category-staging`
...
- `obs-evo-cand-008502-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008502-route-evolution-graph`
