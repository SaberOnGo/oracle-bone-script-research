...
- External category reference: `evobc-cat-09656`
- Source category ID: `09656`
- Source label for human review: `闒`
- Source codepoints: `U+95D2`
...
- `obs-evo-cand-009656-route-category-staging`
...
- `obs-evo-cand-009656-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009656-route-evolution-graph`
