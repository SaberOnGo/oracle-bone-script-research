# obs-char-000816 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000816`
- primary external id: `hust-obc-cat-0924`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/816_obs-char-000816_hust-obc-cat-0924_orac
  le-character/03_visual-assets/001_asset-000821_hust-obc-cat-0924_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0924/G_0924_前7.36.2(甲).png`
- asset id: `asset-000821`
...
- source category: `0924`
- validation class: `815`
- source image route: `HUST-OBC/deciphered/0924/G_0924_前7.36.2(甲).png`
- asset id: `asset-000821`
...
- English observation: `Three detached roughly horizontal strokes are
  stacked with clear gaps; the upper and lower strokes are broader than the
  middle one.`
- 中文观察: `三条分离的近水平笔画上下叠置，之间有明显间隔，上下两笔宽于中间笔。`
...
- dataset label text: `㞒`
- dataset label codepoints: `U+3792`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00081`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00081`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00081`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/081_obs-evo-can
  d-000081_evobc-cat-00081_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/081_obs-evo-cand-000081_evobc-cat-00081_evolu
...
- Which source records identify obs-char-000816 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000816？
