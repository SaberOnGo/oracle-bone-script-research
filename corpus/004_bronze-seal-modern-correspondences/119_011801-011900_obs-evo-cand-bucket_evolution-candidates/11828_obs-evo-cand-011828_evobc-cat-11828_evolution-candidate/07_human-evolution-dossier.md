...
Project ID: `obs-evo-cand-011828`
...
- Project ID: `obs-evo-cand-011828`
- EVOBC category candidate ID: `evobc-evo-cat-11828`
- External category reference: `evobc-cat-11828`
- Source category ID: `11828`
- Source label for human review: `𥛳`
- Source codepoints: `U+256F3`
...
- `obs-evo-cand-011828-route-category-staging`
...
- `obs-evo-cand-011828-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011828-route-evolution-graph`
