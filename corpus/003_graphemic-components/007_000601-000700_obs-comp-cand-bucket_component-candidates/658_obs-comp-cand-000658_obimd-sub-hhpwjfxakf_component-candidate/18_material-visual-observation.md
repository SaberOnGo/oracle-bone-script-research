# Material Visual Observation / obs-comp-cand-000658 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000658`
- External reference / 外部参照: `obimd-sub-hhpwjfxakf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013221_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/yz361h0hzf/hhpwjfxakf/hhpwjfxakf.png`
- Checksum / 校验和:
  `056f96e23f22374ac25ae1c5e3ab3849a948b3193293ce2457de2fcd2ae4d8d1`
...
- Marked-pixel bounds: (71,30)–(178,222); span 108 × 193 px; the marked
...
- 痕迹范围：(71,30)–(178,222)；跨度108 × 193 px；痕迹矩形高于宽。
