...
- External category reference: `evobc-cat-00372`
- Source category ID: `00372`
- Source label for human review: `䑲`
...
- `obs-evo-cand-000372-route-category-staging`
...
- `obs-evo-cand-000372-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000372-route-evolution-graph`
