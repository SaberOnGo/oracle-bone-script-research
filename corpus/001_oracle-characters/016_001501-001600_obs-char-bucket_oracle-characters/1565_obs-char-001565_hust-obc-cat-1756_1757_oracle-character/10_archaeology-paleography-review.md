# obs-char-001565 Archaeology Paleography Review

# obs-char-001565 考古文字复核档案
...
- first local image: `001_asset-001570_hust-obc-cat-1756_1757_glyph.png`
- first source image: `G_1756_後2.6.14(甲).png`
...
- source label text: `㫒㫓`
- source label codepoints: `U+3AD2;U+3AD3`
