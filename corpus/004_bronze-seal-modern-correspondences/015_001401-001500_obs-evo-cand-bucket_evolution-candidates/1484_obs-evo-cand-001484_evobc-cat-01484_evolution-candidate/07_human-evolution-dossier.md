...
- Project ID: `obs-evo-cand-001484`
- EVOBC category candidate ID: `evobc-evo-cat-01484`
- External category reference: `evobc-cat-01484`
- Source category ID: `01484`
- Source label for human review: `叵`
- Source codepoints: `U+53F5`
...
- `obs-evo-cand-001484-route-category-staging`
...
- `obs-evo-cand-001484-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001484-route-evolution-graph`
