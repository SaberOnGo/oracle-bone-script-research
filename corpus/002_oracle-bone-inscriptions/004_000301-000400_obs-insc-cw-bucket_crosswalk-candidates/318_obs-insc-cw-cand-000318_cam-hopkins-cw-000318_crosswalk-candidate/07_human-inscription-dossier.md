...
- Yingguo / 英国所藏: `y1974` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `458` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `60` in source row; primary catalog entry pending
- Heji / 合集: `41000` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000318`
