...
- External category reference: `evobc-cat-10599`
- Source category ID: `10599`
- Source label for human review: `麀`
...
- `obs-evo-cand-010599-route-category-staging`
...
- `obs-evo-cand-010599-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010599-route-evolution-graph`
