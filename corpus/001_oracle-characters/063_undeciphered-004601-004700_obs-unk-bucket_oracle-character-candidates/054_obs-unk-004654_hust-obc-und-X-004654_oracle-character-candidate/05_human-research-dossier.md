# obs-unk-004654 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/054_obs-unk-004654_h
  ust-obc-und-X-004654_oracle-character-candidate/03_visual-assets/001_asset
  -006247_hust-obc-und-X-004654_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/210/X_？_8382_1.png`
- asset id: `asset-006247`
...
- source class: `HUST-OBC/undeciphered/X/210/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/210/X_？_8382_1.png`
- asset id: `asset-006247`
...
- English observation: `two tall sides with a central V-like notch`
- 中文观察: `带中央 V 状缺口的两条高侧笔画`
...
- Which source records identify obs-unk-004654 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004654？
