...
- External category reference: `evobc-cat-04305`
- Source category ID: `04305`
- Source label for human review: `櫂`
- Source codepoints: `U+6AC2`
...
- `obs-evo-cand-004305-route-category-staging`
...
- `obs-evo-cand-004305-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004305-route-evolution-graph`
