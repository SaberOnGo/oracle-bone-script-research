# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010440
...
- EVOBC candidate category: `evobc-evo-cat-10440`.
- Source label for search only: `鰼`.
- Source codepoints for search only: `U+9C3C`.
