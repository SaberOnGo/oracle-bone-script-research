...
- Project ID: `obs-evo-cand-007226`
- EVOBC category candidate ID: `evobc-evo-cat-07226`
- External category reference: `evobc-cat-07226`
- Source category ID: `07226`
- Source label for human review: `艾`
- Source codepoints: `U+827E`
...
- `obs-evo-cand-007226-route-category-staging`
...
- `obs-evo-cand-007226-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007226-route-evolution-graph`
