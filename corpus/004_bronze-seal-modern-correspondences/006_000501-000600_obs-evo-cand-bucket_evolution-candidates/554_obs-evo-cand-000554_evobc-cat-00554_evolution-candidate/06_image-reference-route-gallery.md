...
- `obs-evo-cand-000554-route-category-staging`
...
- `obs-evo-cand-000554-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000554-route-evolution-graph`
