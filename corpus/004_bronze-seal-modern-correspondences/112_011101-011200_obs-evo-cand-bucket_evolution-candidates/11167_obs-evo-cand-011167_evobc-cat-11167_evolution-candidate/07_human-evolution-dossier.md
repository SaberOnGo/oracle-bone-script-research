...
- External category reference: `evobc-cat-11167`
- Source category ID: `11167`
- Source label for human review: `𢍉`
- Source codepoints: `U+22349`
...
- `obs-evo-cand-011167-route-category-staging`
...
- `obs-evo-cand-011167-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011167-route-evolution-graph`
