...
- External category reference: `evobc-cat-10143`
- Source category ID: `10143`
...
- `obs-evo-cand-010143-route-category-staging`
...
- `obs-evo-cand-010143-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010143-route-evolution-graph`
