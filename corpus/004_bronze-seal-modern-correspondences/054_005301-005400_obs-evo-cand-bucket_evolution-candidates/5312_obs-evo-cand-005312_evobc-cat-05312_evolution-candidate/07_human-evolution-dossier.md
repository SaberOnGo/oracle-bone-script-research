...
- External category reference: `evobc-cat-05312`
- Source category ID: `05312`
- Source label for human review: `獄`
- Source codepoints: `U+7344`
...
- `obs-evo-cand-005312-route-category-staging`
...
- `obs-evo-cand-005312-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005312-route-evolution-graph`
