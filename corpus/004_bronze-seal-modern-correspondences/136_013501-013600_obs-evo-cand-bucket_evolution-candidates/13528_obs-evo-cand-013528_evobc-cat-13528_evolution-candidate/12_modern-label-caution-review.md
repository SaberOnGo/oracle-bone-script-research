# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013528
...
- EVOBC candidate category: `evobc-evo-cat-13528`.
- Source label for search only: `𭞳`.
- Source codepoints for search only: `U+2D7B3`.
