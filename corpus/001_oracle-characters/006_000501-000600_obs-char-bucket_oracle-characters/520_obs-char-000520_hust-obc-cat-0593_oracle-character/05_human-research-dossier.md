# obs-char-000520 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000520`
- primary external id: `hust-obc-cat-0593`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/520_obs-char-000520_hust-obc-cat-0593_orac
  le-character/03_visual-assets/001_asset-000525_hust-obc-cat-0593_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0593/G_0593_乙2047合815賓組.png`
- asset id: `asset-000525`
...
- source category: `0593`
- validation class: `519`
- source image route: `HUST-OBC/deciphered/0593/G_0593_乙2047合815賓組.png`
- asset id: `asset-000525`
...
- English observation: `A long tapered vertical stroke contains a small open
  loop on its lower left and is crossed near the bottom by a short
...
- dataset label text: `㙇`
- dataset label codepoints: `U+3647`
...
- filename catalog route clues: `Heji-like filename clue: 合815
  (G_0593_乙2047合815賓組.png)`
...
- Which source records identify obs-char-000520 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000520？
