# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008953
...
- EVOBC candidate category: `evobc-evo-cat-08953`.
- Source label for search only: `违`.
- Source codepoints for search only: `U+8FDD`.
