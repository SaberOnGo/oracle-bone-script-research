...
- External category reference: `evobc-cat-10683`
- Source category ID: `10683`
- Source label for human review: `鼎`
- Source codepoints: `U+9F0E`
- Image reference count in source metadata: `466`
...
- source `1`
  ...
  image references: 240
- source `2`
  token: `Book:17600`
  image references: 14
- source `3`
  token: `Book:21681`
  image references: 111
- source `4`
  token: `Book:9131`
  image references: 31
- source `5`
...
- `obs-evo-cand-010683-route-category-staging`
...
- `obs-evo-cand-010683-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010683-route-evolution-graph`
