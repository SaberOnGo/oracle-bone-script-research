...
Project ID: `obs-evo-cand-004380`
...
- Project ID: `obs-evo-cand-004380`
- EVOBC category candidate ID: `evobc-evo-cat-04380`
- External category reference: `evobc-cat-04380`
- Source category ID: `04380`
- Source label for human review: `歛`
- Source codepoints: `U+6B5B`
...
- `obs-evo-cand-004380-route-category-staging`
...
- `obs-evo-cand-004380-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004380-route-evolution-graph`
