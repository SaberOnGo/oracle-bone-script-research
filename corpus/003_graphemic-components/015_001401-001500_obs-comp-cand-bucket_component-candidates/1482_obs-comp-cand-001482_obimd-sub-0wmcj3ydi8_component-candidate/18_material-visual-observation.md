# Material Visual Observation / obs-comp-cand-001482 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001482`
- External reference / 外部参照: `obimd-sub-0wmcj3ydi8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016059_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0wmcj3ydi8/0wmcj3ydi8/0wmcj3ydi8.png`
- Checksum / 校验和:
  `809e05ff888fc0470a8859e94903c6e5f8c41080423a5ff9fe89f5ed15b88c01`
...
- Marked-pixel bounds: (56,54)–(193,189); span 138 × 136 px; the marked
...
- 痕迹范围：(56,54)–(193,189)；跨度138 × 136 px；痕迹矩形近方形。
