# Material Visual Observation / obs-comp-cand-001687 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001687`
- External reference / 外部参照: `obimd-sub-587vsj71cs`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017603_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/587vsj71cs/587vsj71cs/587vsj71cs.png`
- Checksum / 校验和:
  `a2da664524991a9890393a656081f25946c4e12da8eb9da115bfce3129ed671a`
...
- Marked-pixel bounds: (61,31)–(192,205); span 132 × 175 px; the marked
...
- 痕迹范围：(61,31)–(192,205)；跨度132 × 175 px；痕迹矩形高于宽。
