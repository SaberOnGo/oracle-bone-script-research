# obs-char-001180 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001180`
- primary external id: `hust-obc-cat-1320`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1180_obs-char-001180_hust-obc-cat-1320_ora
  cle-character/03_visual-assets/001_asset-001185_hust-obc-cat-1320_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1320/G_1320_乙1462合6531賓組.png`
- asset id: `asset-001185`
...
- source category: `1320`
- validation class: `1179`
- source image route: `HUST-OBC/deciphered/1320/G_1320_乙1462合6531賓組.png`
- asset id: `asset-001185`
...
- English observation: `A dense branching cluster has upper prongs, a
  central crossing, and long unequal strokes descending on both sides.`
...
- dataset label text: `㤞`
- dataset label codepoints: `U+391E`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/115_obs-evo-can
  d-000115_evobc-cat-00115_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/115_obs-evo-cand-000115_evobc-cat-00115_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合6531
...
- Which source records identify obs-char-001180 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001180？
