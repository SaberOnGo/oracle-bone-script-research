# Material Visual Observation / obs-comp-cand-002345 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002345`
- External reference / 外部参照: `obimd-sub-hhs8xx201x`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020416_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hhs8xx201x/hhs8xx201x/hhs8xx201x.png`
- Checksum / 校验和:
  `86726b8d25e83e9f170227c764452e938fd7d7ee46076575cb8ef5edce3ac6e7`
...
- Marked-pixel bounds: (80,27)–(169,217); span 90 × 191 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.76%。
- 痕迹范围：(80,27)–(169,217)；跨度90 × 191 px；痕迹矩形高于宽。
