# obs-char-000874 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000874`
- primary external id: `hust-obc-cat-0986`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/874_obs-char-000874_hust-obc-cat-0986_orac
  le-character/03_visual-assets/001_asset-000879_hust-obc-cat-0986_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0986/G_0986_京津3722合31771何組.png`
- asset id: `asset-000879`
...
- source category: `0986`
- validation class: `873`
- source image route: `HUST-OBC/deciphered/0986/G_0986_京津3722合31771何組.png`
- asset id: `asset-000879`
...
- English observation: `A bold central upright has a forked rounded upper
  section and a broad lower cross or branch; a detached curved stroke stands
  at left.`
- 中文观察: `粗重中央直立笔上部呈圆弧分叉，下部有宽大的横向交叉或分枝；左侧有分离弯笔。`
...
- dataset label text: `㟐`
- dataset label codepoints: `U+37D0`
...
- filename catalog route clues: `Heji-like filename clue: 合31771
  (G_0986_京津3722合31771何組.png)`
...
- Which source records identify obs-char-000874 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000874？
