...
Project ID: `obs-evo-cand-000857`
...
- Project ID: `obs-evo-cand-000857`
- EVOBC category candidate ID: `evobc-evo-cat-00857`
- External category reference: `evobc-cat-00857`
- Source category ID: `00857`
- Source label for human review: `侣`
- Source codepoints: `U+4FA3`
...
- `obs-evo-cand-000857-route-category-staging`
...
- `obs-evo-cand-000857-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000857-route-evolution-graph`
