...
Project ID: `obs-evo-cand-002598`
...
- Project ID: `obs-evo-cand-002598`
- EVOBC category candidate ID: `evobc-evo-cat-02598`
- External category reference: `evobc-cat-02598`
- Source category ID: `02598`
- Source label for human review: `嶨`
- Source codepoints: `U+5DA8`
...
- `obs-evo-cand-002598-route-category-staging`
...
- `obs-evo-cand-002598-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002598-route-evolution-graph`
