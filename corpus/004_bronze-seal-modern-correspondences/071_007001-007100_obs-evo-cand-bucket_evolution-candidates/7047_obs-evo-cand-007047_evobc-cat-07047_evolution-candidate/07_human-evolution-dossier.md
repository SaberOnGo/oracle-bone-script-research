...
- External category reference: `evobc-cat-07047`
- Source category ID: `07047`
- Source label for human review: `胼`
...
- `obs-evo-cand-007047-route-category-staging`
...
- `obs-evo-cand-007047-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007047-route-evolution-graph`
