...
- `obs-evo-cand-012172-route-category-staging`
...
- `obs-evo-cand-012172-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012172-route-evolution-graph`
