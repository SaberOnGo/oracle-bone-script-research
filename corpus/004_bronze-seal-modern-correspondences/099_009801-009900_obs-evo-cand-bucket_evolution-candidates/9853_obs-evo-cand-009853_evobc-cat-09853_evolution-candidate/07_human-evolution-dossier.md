...
Project ID: `obs-evo-cand-009853`
...
- Project ID: `obs-evo-cand-009853`
- EVOBC category candidate ID: `evobc-evo-cat-09853`
- External category reference: `evobc-cat-09853`
- Source category ID: `09853`
- Source label for human review: `震`
- Source codepoints: `U+9707`
...
- `obs-evo-cand-009853-route-category-staging`
...
- `obs-evo-cand-009853-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009853-route-evolution-graph`
