...
- External category reference: `evobc-cat-08393`
- Source category ID: `08393`
- Source label for human review: `讖`
- Source codepoints: `U+8B96`
...
- `obs-evo-cand-008393-route-category-staging`
...
- `obs-evo-cand-008393-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008393-route-evolution-graph`
