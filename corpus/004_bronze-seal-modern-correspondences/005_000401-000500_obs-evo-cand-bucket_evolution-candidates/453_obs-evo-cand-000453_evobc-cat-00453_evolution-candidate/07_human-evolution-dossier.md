...
Project ID: `obs-evo-cand-000453`
...
- Project ID: `obs-evo-cand-000453`
- EVOBC category candidate ID: `evobc-evo-cat-00453`
- External category reference: `evobc-cat-00453`
- Source category ID: `00453`
- Source label for human review: `䞦`
- Source codepoints: `U+47A6`
...
- `obs-evo-cand-000453-route-category-staging`
...
- `obs-evo-cand-000453-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000453-route-evolution-graph`
