# Material Visual Observation / obs-comp-cand-001820 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001820`
- External reference / 外部参照: `obimd-sub-bzimognfvp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018146_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bzimognfvp/bzimognfvp/bzimognfvp.png`
- Checksum / 校验和:
  `097fb08354e5c5d84ea8e1a90b0bf714ab1ce1ed4fbc640957d09c4991f9d29f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.56%.
- Marked-pixel bounds: (57,22)–(200,228); span 144 × 207 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.56%。
- 痕迹范围：(57,22)–(200,228)；跨度144 × 207 px；痕迹矩形高于宽。
