...
Project ID: `obs-insc-cw-cand-000204`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000204`
...
- Yingguo / 英国所藏: `y1197` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `61` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `632` in source row; primary catalog entry pending
- Heji / 合集: `40451` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000204`
