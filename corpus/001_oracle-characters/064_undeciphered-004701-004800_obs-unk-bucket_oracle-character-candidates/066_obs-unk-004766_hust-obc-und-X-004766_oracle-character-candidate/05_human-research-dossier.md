# obs-unk-004766 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004766`
- primary external id: `hust-obc-und-X-004766`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/066_obs-unk-004766_h
  ust-obc-und-X-004766_oracle-character-candidate/03_visual-assets/001_asset
  -006359_hust-obc-und-X-004766_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/322/X_？_7307_1.png`
- asset id: `asset-006359`
...
- source class: `HUST-OBC/undeciphered/X/322/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/322/X_？_7307_1.png`
- asset id: `asset-006359`
...
- English observation: `central stem, side strokes, and lower bar`
- 中文观察: `中央茎状结构、两侧笔画和下部横向笔画`
...
- Which source records identify obs-unk-004766 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004766？
