...
- Project ID: `obs-evo-cand-012561`
- EVOBC category candidate ID: `evobc-evo-cat-12561`
- External category reference: `evobc-cat-12561`
- Source category ID: `12561`
- Source label for human review: `𩆁`
- Source codepoints: `U+29181`
...
- `obs-evo-cand-012561-route-category-staging`
...
- `obs-evo-cand-012561-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012561-route-evolution-graph`
