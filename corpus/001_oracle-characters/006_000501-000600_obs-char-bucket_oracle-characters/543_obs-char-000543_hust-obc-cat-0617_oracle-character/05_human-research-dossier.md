# obs-char-000543 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000543`
- primary external id: `hust-obc-cat-0617`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/543_obs-char-000543_hust-obc-cat-0617_orac
  le-character/03_visual-assets/001_asset-000548_hust-obc-cat-0617_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0617/G_0617_京津2632(甲).png`
- asset id: `asset-000548`
...
- source category: `0617`
- validation class: `542`
- source image route: `HUST-OBC/deciphered/0617/G_0617_京津2632(甲).png`
- asset id: `asset-000548`
...
- English observation: `Two narrow jagged vertical strokes run side by side,
  meeting at several diagonal junctions and ending in separated pointed
  lower extensions.`
- 中文观察: `两条狭长锯折竖笔并列，在数个斜向接点处相交，下端形成彼此分离的尖形延伸。`
...
- dataset label text: `㙟`
- dataset label codepoints: `U+365F`
...
- Which source records identify obs-char-000543 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000543？
