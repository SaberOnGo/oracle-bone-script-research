...
- External category reference: `evobc-cat-08127`
- Source category ID: `08127`
- Source label for human review: `計`
- Source codepoints: `U+8A08`
...
- `obs-evo-cand-008127-route-category-staging`
...
- `obs-evo-cand-008127-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008127-route-evolution-graph`
