# obs-unk-004737 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/037_obs-unk-004737_h
  ust-obc-und-X-004737_oracle-character-candidate/03_visual-assets/001_asset
  -006330_hust-obc-und-X-004737_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/293/X_？_7109_1.png`
- asset id: `asset-006330`
...
- source class: `HUST-OBC/undeciphered/X/293/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/293/X_？_7109_1.png`
- asset id: `asset-006330`
...
- English observation: `sloping stroke with central and lower openings`
- 中文观察: `带中央和下部开口的斜向笔画`
...
- Which source records identify obs-unk-004737 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004737？
