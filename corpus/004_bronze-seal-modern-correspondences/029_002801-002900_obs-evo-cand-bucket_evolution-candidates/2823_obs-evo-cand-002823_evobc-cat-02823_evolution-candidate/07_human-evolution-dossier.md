...
- External category reference: `evobc-cat-02823`
- Source category ID: `02823`
- Source label for human review: `彈`
- Source codepoints: `U+5F48`
- Image reference count in source metadata: `38`
...
- `obs-evo-cand-002823-route-category-staging`
...
- `obs-evo-cand-002823-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002823-route-evolution-graph`
