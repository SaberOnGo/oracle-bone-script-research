# obs-char-001574 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1574_obs-char-001574_hust-obc-cat-1766_ora
  cle-character/03_visual-assets/001_asset-001579_hust-obc-cat-1766_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1766/L_1766_5902.jpg`
- asset id: `asset-001579`
...
- source category: `1766`
- validation class: `1573`
- source image route: `HUST-OBC/deciphered/1766/L_1766_5902.jpg`
- asset id: `asset-001579`
...
- English observation: `A very small form combines a short upper bar, a
  middle band, and a lower pointed mark.`
- 中文观察: `极小形体结合短上横笔、中部带状结构和下部尖状标记。`
...
- dataset label text: `㫜`
- dataset label codepoints: `U+3ADC`
...
- Which source records identify obs-char-001574 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001574？
