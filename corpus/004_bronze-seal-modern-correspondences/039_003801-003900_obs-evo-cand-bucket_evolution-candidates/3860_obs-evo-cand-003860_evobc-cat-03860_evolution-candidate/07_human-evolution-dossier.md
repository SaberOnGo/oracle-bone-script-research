...
Project ID: `obs-evo-cand-003860`
...
- Project ID: `obs-evo-cand-003860`
- EVOBC category candidate ID: `evobc-evo-cat-03860`
- External category reference: `evobc-cat-03860`
- Source category ID: `03860`
- Source label for human review: `朻`
- Source codepoints: `U+673B`
...
- `obs-evo-cand-003860-route-category-staging`
...
- `obs-evo-cand-003860-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003860-route-evolution-graph`
