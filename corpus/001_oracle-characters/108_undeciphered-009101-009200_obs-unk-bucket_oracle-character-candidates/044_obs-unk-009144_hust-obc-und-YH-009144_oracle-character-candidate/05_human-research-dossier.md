# obs-unk-009144 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-009144`
- primary external id: `hust-obc-und-YH-009144`
...
- local review image route: `corpus/001_oracle-characters/108_undeciphered-009
  101-009200_obs-unk-bucket_oracle-character-candidates/044_obs-unk-009144_h
  ust-obc-und-YH-009144_oracle-character-candidate/03_visual-assets/001_asse
  t-010735_hust-obc-und-YH-009144_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/612A3/H_？_612A3_0.png`
- asset id: `asset-010735`
...
- source class: `HUST-OBC/undeciphered/Y+H/612A3/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/612A3/H_？_612A3_0.png`
- asset id: `asset-010735`
...
- Which source records identify obs-unk-009144 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009144？
