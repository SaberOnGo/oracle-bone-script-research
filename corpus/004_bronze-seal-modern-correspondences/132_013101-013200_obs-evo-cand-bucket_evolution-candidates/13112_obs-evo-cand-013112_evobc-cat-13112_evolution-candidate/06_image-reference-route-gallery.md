...
- `obs-evo-cand-013112-route-category-staging`
...
- `obs-evo-cand-013112-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013112-route-evolution-graph`
