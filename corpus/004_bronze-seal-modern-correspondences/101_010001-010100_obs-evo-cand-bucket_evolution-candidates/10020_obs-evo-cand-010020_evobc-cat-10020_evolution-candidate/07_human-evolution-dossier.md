...
- External category reference: `evobc-cat-10020`
- Source category ID: `10020`
- Source label for human review: `顔`
- Source codepoints: `U+9854`
...
- `obs-evo-cand-010020-route-category-staging`
...
- `obs-evo-cand-010020-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010020-route-evolution-graph`
