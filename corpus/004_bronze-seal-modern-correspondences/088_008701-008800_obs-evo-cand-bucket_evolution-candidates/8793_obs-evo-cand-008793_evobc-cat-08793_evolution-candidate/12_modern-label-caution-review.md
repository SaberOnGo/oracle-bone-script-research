# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008793
...
- EVOBC candidate category: `evobc-evo-cat-08793`.
- Source label for search only: `軋`.
- Source codepoints for search only: `U+8ECB`.
