# obs-char-001114 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1114_obs-char-001114_hust-obc-cat-1245_ora
  cle-character/03_visual-assets/001_asset-001119_hust-obc-cat-1245_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1245/H_1245_6106E_0.png`
- asset id: `asset-001119`
...
- source category: `1245`
- validation class: `1113`
- source image route: `HUST-OBC/deciphered/1245/H_1245_6106E_0.png`
- asset id: `asset-001119`
...
- English observation: `A large angular upper frame contains intersecting
  diagonal strokes above a separate lower rounded cluster and descending
  stem.`
...
- dataset label text: `㣓`
- dataset label codepoints: `U+38D3`
...
- filename catalog route clues: `catalog-like filename clue: H_1245
  (H_1245_6106E_0.png)`
...
- Which source records identify obs-char-001114 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001114？
