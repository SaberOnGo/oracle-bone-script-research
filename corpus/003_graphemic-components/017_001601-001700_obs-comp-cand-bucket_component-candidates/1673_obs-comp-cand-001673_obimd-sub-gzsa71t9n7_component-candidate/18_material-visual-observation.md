# Material Visual Observation / obs-comp-cand-001673 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001673`
- External reference / 外部参照: `obimd-sub-gzsa71t9n7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017589_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cixqnyxp9v/gzsa71t9n7/gzsa71t9n7.png`
- Checksum / 校验和:
  `4b3a280044578962f7f3cd8d16ae6757d03a03ee43be8c939e765633fda31ae7`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.15%.
- Marked-pixel bounds: (71,40)–(178,205); span 108 × 166 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.15%。
- 痕迹范围：(71,40)–(178,205)；跨度108 × 166 px；痕迹矩形高于宽。
