# Material Visual Observation / obs-comp-cand-002599 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002599`
- External reference / 外部参照: `obimd-sub-d1oyno57ys`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021138_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/d1oyno57ys/d1oyno57ys/d1oyno57ys.png`
- Checksum / 校验和:
  `24ebf3bb066146012ad3b12a3dbbd57f183f6d4c0be747ca3d20c3c9ab77445d`
...
- Marked-pixel bounds: (79,18)–(164,228); span 86 × 211 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.02%。
- 痕迹范围：(79,18)–(164,228)；跨度86 × 211 px；痕迹矩形高于宽。
