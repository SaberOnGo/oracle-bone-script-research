# obs-unk-006409 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/081_undeciphered-006
  401-006500_obs-unk-bucket_oracle-character-candidates/009_obs-unk-006409_h
  ust-obc-und-X-006409_oracle-character-candidate/03_visual-assets/001_asset
  -008000_hust-obc-und-X-006409_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1965/X_？_548_1.png`
- asset id: `asset-008000`
...
- source class: `HUST-OBC/undeciphered/X/1965/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1965/X_？_548_1.png`
- asset id: `asset-008000`
...
- Which source records identify obs-unk-006409 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006409？
