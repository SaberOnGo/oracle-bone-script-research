# Material Visual Observation / obs-comp-cand-001554 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001554`
- External reference / 外部参照: `obimd-sub-z640bkv6r7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016968_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/z640bkv6r7/z640bkv6r7/0rdtcyhim9.png`
- Checksum / 校验和:
  `f8589580ef878a943b9c467485824fd51c28cb5e274d5797340fe08adea1b66f`
...
- Marked-pixel bounds: (83,34)–(166,210); span 84 × 177 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.90%。
- 痕迹范围：(83,34)–(166,210)；跨度84 × 177 px；痕迹矩形高于宽。
