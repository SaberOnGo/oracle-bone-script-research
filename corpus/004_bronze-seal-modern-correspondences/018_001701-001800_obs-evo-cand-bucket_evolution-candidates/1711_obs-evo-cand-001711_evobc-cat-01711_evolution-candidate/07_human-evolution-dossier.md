...
- External category reference: `evobc-cat-01711`
- Source category ID: `01711`
- Source label for human review: `噂`
- Source codepoints: `U+5642`
...
- `obs-evo-cand-001711-route-category-staging`
...
- `obs-evo-cand-001711-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001711-route-evolution-graph`
