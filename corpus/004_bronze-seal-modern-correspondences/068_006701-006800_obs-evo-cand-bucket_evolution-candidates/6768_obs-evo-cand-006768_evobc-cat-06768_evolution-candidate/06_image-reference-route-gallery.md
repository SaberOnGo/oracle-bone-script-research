...
- `obs-evo-cand-006768-route-category-staging`
...
- `obs-evo-cand-006768-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006768-route-evolution-graph`
