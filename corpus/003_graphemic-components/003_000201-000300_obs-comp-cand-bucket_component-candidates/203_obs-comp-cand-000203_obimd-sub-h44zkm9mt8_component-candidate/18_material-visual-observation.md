# Material Visual Observation / obs-comp-cand-000203 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000203`
- External reference / 外部参照: `obimd-sub-h44zkm9mt8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011764_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h44zkm9mt8/h44zkm9mt8/h44zkm9mt8.png`
- Checksum / 校验和:
  `a82cee07f495508ef29a4b87e64d0f3f18971d18ee74c9747cb306a81586d699`
...
- Marked-pixel bounds: (76,27)–(173,226); span 98 × 200 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.53%。
- 痕迹范围：(76,27)–(173,226)；跨度98 × 200 px；痕迹矩形高于宽。
