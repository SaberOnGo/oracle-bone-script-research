...
- External category reference: `evobc-cat-10747`
- Source category ID: `10747`
- Source label for human review: `龐`
- Source codepoints: `U+9F90`
...
- `obs-evo-cand-010747-route-category-staging`
...
- `obs-evo-cand-010747-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010747-route-evolution-graph`
