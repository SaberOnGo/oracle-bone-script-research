# obs-unk-004333 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/033_obs-unk-004333_h
  ust-obc-und-L-004333_oracle-character-candidate/03_visual-assets/001_asset
  -005926_hust-obc-und-L-004333_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4333/L_？_9575.jpg`
- asset id: `asset-005926`
...
- source class: `HUST-OBC/undeciphered/L/4333/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4333/L_？_9575.jpg`
- asset id: `asset-005926`
...
- English observation: `Two upper curves and a broad lower trace recorded.`
- 中文观察: `已记录两条上部弯痕和下部宽痕。`
...
- Which source records identify obs-unk-004333 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004333？
