...
- Project ID: `obs-evo-cand-008271`
- EVOBC category candidate ID: `evobc-evo-cat-08271`
- External category reference: `evobc-cat-08271`
- Source category ID: `08271`
- Source label for human review: `諕`
- Source codepoints: `U+8AD5`
...
- `obs-evo-cand-008271-route-category-staging`
...
- `obs-evo-cand-008271-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008271-route-evolution-graph`
