...
- Project ID: `obs-evo-cand-010771`
- EVOBC category candidate ID: `evobc-evo-cat-10771`
- External category reference: `evobc-cat-10771`
- Source category ID: `10771`
- Source label for human review: `𠂇`
- Source codepoints: `U+20087`
- Image reference count in source metadata: `65`
...
- `obs-evo-cand-010771-route-category-staging`
...
- `obs-evo-cand-010771-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010771-route-evolution-graph`
