# obs-unk-004294 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/094_obs-unk-004294_h
  ust-obc-und-L-004294_oracle-character-candidate/03_visual-assets/001_asset
  -005887_hust-obc-und-L-004294_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4294/L_？_9483.jpg`
- asset id: `asset-005887`
...
- source class: `HUST-OBC/undeciphered/L/4294/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4294/L_？_9483.jpg`
- asset id: `asset-005887`
...
- English observation: `Dark cluster, right projection, lower curves visible.`
- 中文观察: `深色痕迹组、右侧伸出痕迹和下部弯痕可见。`
...
- Which source records identify obs-unk-004294 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004294？
