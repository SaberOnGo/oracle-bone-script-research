...
- External category reference: `evobc-cat-01401`
- Source category ID: `01401`
...
- `obs-evo-cand-001401-route-category-staging`
...
- `obs-evo-cand-001401-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001401-route-evolution-graph`
