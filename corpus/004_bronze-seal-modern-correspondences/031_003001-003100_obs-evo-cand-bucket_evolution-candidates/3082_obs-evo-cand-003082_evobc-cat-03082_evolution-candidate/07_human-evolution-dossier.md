...
- External category reference: `evobc-cat-03082`
- Source category ID: `03082`
- Source label for human review: `愐`
...
- `obs-evo-cand-003082-route-category-staging`
...
- `obs-evo-cand-003082-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003082-route-evolution-graph`
