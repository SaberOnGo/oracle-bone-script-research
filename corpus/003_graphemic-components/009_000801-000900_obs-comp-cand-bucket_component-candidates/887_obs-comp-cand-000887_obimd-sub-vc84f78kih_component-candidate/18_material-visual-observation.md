# Material Visual Observation / obs-comp-cand-000887 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000887`
- External reference / 外部参照: `obimd-sub-vc84f78kih`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013959_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bwfz1jvlck/vc84f78kih/vc84f78kih.png`
- Checksum / 校验和:
  `f22f5a653308d042504e51e4eaa06fd4e433f3eca8fe50d9f3f4495623119db3`
...
- Marked-pixel bounds: (96,33)–(153,218); span 58 × 186 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.71%。
- 痕迹范围：(96,33)–(153,218)；跨度58 × 186 px；痕迹矩形高于宽。
