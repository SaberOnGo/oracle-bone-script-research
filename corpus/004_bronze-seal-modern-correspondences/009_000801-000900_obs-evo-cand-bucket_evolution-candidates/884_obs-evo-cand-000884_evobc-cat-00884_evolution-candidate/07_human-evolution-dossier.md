...
Project ID: `obs-evo-cand-000884`
...
- Project ID: `obs-evo-cand-000884`
- EVOBC category candidate ID: `evobc-evo-cat-00884`
- External category reference: `evobc-cat-00884`
- Source category ID: `00884`
- Source label for human review: `俑`
- Source codepoints: `U+4FD1`
...
- `obs-evo-cand-000884-route-category-staging`
...
- `obs-evo-cand-000884-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000884-route-evolution-graph`
