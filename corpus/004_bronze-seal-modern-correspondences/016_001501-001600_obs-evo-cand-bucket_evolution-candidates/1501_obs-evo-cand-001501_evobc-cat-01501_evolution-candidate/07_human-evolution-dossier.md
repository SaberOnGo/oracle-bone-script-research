...
Project ID: `obs-evo-cand-001501`
...
- Project ID: `obs-evo-cand-001501`
- EVOBC category candidate ID: `evobc-evo-cat-01501`
- External category reference: `evobc-cat-01501`
- Source category ID: `01501`
- Source label for human review: `吐`
- Source codepoints: `U+5410`
...
- `obs-evo-cand-001501-route-category-staging`
...
- `obs-evo-cand-001501-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001501-route-evolution-graph`
