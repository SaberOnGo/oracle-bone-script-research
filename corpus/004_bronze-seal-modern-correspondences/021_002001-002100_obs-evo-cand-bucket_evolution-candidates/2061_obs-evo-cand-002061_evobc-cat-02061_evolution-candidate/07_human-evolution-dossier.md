...
- Project ID: `obs-evo-cand-002061`
- EVOBC category candidate ID: `evobc-evo-cat-02061`
- External category reference: `evobc-cat-02061`
- Source category ID: `02061`
- Source label for human review: `奴`
- Source codepoints: `U+5974`
...
- `obs-evo-cand-002061-route-category-staging`
...
- `obs-evo-cand-002061-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002061-route-evolution-graph`
