...
- External category reference: `evobc-cat-03832`
- Source category ID: `03832`
- Source label for human review: `服`
...
- `obs-evo-cand-003832-route-category-staging`
...
- `obs-evo-cand-003832-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003832-route-evolution-graph`
