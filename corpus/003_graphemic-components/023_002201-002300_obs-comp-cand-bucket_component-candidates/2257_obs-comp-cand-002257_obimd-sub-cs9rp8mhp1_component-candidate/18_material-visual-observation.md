# Material Visual Observation / obs-comp-cand-002257 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002257`
- External reference / 外部参照: `obimd-sub-cs9rp8mhp1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020070_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0yj8abtf8t/cs9rp8mhp1/cs9rp8mhp1.png`
- Checksum / 校验和:
  `699fd11d1adc733c051a37c50b44400f45c4f25347be803f44baf14a4ca79065`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.80%.
- Marked-pixel bounds: (79,37)–(169,210); span 91 × 174 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.80%。
- 痕迹范围：(79,37)–(169,210)；跨度91 × 174 px；痕迹矩形高于宽。
