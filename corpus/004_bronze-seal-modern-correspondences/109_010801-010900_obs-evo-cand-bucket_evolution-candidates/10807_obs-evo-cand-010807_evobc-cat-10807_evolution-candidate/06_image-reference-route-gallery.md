...
- `obs-evo-cand-010807-route-category-staging`
...
- `obs-evo-cand-010807-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010807-route-evolution-graph`
