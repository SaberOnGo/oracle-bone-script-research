# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002224
...
| Glyph or codepoint route / 字形或码位路线 | 5 OBIMD route rows; examples U+FCCCE; U+FCCCF; 另有 3 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
