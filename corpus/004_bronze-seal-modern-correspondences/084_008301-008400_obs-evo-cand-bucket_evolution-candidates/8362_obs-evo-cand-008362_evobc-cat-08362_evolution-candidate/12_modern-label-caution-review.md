# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008362
...
- EVOBC candidate category: `evobc-evo-cat-08362`.
- Source label for search only: `譚`.
- Source codepoints for search only: `U+8B5A`.
