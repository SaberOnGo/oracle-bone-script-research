...
- External category reference: `evobc-cat-11897`
- Source category ID: `11897`
- Source label for human review: `𥲅`
- Source codepoints: `U+25C85`
...
- `obs-evo-cand-011897-route-category-staging`
...
- `obs-evo-cand-011897-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011897-route-evolution-graph`
