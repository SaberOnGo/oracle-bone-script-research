...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0468`
...
- Source image / 来源图: `G_0468_乙1916合938賓組.png`
- Image / 图像: `001_asset-000417_hust-obc-cat-0468_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合938
...
- target node: `obimd-main-cand-001642`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- target node: `evobc-evo-cat-00035`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/035_obs-evo-cand-000035_evobc-cat-00035_evoluti
...
- Matched OBIMD main UIDs / OBIMD 主字 UID: `ytmsqjgowx`
...
- Source label text / 来源标签文字: `㗊`
- Source label codepoint / 来源标签 codepoint: `U+35CA`
