...
Project ID: `obs-evo-cand-004358`
...
- Project ID: `obs-evo-cand-004358`
- EVOBC category candidate ID: `evobc-evo-cat-04358`
- External category reference: `evobc-cat-04358`
- Source category ID: `04358`
- Source label for human review: `款`
- Source codepoints: `U+6B3E`
...
- `obs-evo-cand-004358-route-category-staging`
...
- `obs-evo-cand-004358-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004358-route-evolution-graph`
