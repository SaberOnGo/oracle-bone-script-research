...
- External category reference: `evobc-cat-03797`
- Source category ID: `03797`
- Source label for human review: `曏`
- Source codepoints: `U+66CF`
...
- `obs-evo-cand-003797-route-category-staging`
...
- `obs-evo-cand-003797-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003797-route-evolution-graph`
