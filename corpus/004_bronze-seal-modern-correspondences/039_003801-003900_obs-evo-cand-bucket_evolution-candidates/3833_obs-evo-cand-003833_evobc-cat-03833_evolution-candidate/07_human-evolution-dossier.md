...
- External category reference: `evobc-cat-03833`
- Source category ID: `03833`
- Source label for human review: `朏`
...
- `obs-evo-cand-003833-route-category-staging`
...
- `obs-evo-cand-003833-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003833-route-evolution-graph`
