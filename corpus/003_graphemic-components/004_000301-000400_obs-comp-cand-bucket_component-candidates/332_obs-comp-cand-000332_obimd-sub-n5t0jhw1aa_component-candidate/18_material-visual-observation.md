# Material Visual Observation / obs-comp-cand-000332 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000332`
- External reference / 外部参照: `obimd-sub-n5t0jhw1aa`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012256_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/n5t0jhw1aa/n5t0jhw1aa/n5t0jhw1aa.png`
- Checksum / 校验和:
  `f800247c673ad05d880c499b983d26d2f63e6f722119f23afc905890b41b5b13`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.48%.
- Marked-pixel bounds: (44,26)–(205,228); span 162 × 203 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.48%。
- 痕迹范围：(44,26)–(205,228)；跨度162 × 203 px；痕迹矩形高于宽。
