...
Project ID: `obs-evo-cand-002780`
...
- Project ID: `obs-evo-cand-002780`
- EVOBC category candidate ID: `evobc-evo-cat-02780`
- External category reference: `evobc-cat-02780`
- Source category ID: `02780`
- Source label for human review: `廿`
- Source codepoints: `U+5EFF`
...
- `obs-evo-cand-002780-route-category-staging`
...
- `obs-evo-cand-002780-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002780-route-evolution-graph`
