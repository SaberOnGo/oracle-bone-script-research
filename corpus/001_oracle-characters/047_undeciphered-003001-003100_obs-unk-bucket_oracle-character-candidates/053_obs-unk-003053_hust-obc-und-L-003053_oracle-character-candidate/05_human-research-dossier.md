# obs-unk-003053 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003053`
- primary external id: `hust-obc-und-L-003053`
...
- local review image route: `corpus/001_oracle-characters/047_undeciphered-003
  001-003100_obs-unk-bucket_oracle-character-candidates/053_obs-unk-003053_h
  ust-obc-und-L-003053_oracle-character-candidate/03_visual-assets/001_asset
  -004646_hust-obc-und-L-003053_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3053/L_？_5455.jpg`
- asset id: `asset-004646`
...
- source class: `HUST-OBC/undeciphered/L/3053/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3053/L_？_5455.jpg`
- asset id: `asset-004646`
...
- Which source records identify obs-unk-003053 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003053？
