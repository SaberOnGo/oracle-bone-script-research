...
- External category reference: `evobc-cat-04535`
- Source category ID: `04535`
- Source label for human review: `沋`
...
- `obs-evo-cand-004535-route-category-staging`
...
- `obs-evo-cand-004535-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004535-route-evolution-graph`
