...
- External category reference: `evobc-cat-04865`
- Source category ID: `04865`
- Source label for human review: `漆`
...
- `obs-evo-cand-004865-route-category-staging`
...
- `obs-evo-cand-004865-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004865-route-evolution-graph`
