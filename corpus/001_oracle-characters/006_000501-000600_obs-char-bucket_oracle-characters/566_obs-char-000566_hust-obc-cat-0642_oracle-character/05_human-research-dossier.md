# obs-char-000566 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/566_obs-char-000566_hust-obc-cat-0642_orac
  le-character/03_visual-assets/001_asset-000571_hust-obc-cat-0642_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0642/G_0642_乙1800(甲).png`
- asset id: `asset-000571`
...
- source category: `0642`
- validation class: `565`
- source image route: `HUST-OBC/deciphered/0642/G_0642_乙1800(甲).png`
- asset id: `asset-000571`
...
- English observation: `A long central vertical has short horizontal caps at
  top and bottom, flanked by two bowed outer strokes with short inward
  branches.`
...
- dataset label text: `㙸`
- dataset label codepoints: `U+3678`
...
- Which source records identify obs-char-000566 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000566？
