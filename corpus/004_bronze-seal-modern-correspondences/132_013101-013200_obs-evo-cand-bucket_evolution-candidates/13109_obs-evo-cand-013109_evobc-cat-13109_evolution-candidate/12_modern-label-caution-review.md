# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013109
...
- EVOBC candidate category: `evobc-evo-cat-13109`.
- Source label for search only: `𫴪`.
- Source codepoints for search only: `U+2BD2A`.
