# obs-char-001500 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001500`
- primary external id: `hust-obc-cat-1682_1683_1684`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1500_obs-char-001500_hust-obc-cat-1682_168
  3_1684_oracle-character/03_visual-assets/001_asset-001505_hust-obc-cat-168
  2_1683_1684_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1682_1683_1684/1683/G_1683_乙474
  1(甲).png`
- asset id: `asset-001505`
...
- source category: `1682_1683_1684`
- validation class: `1499`
- source image route: `HUST-OBC/deciphered/1682_1683_1684/1683/G_1683_乙4741(甲)
  .png`
- asset id: `asset-001505`
...
- English observation: `A faint compact cluster has upper prongs, a narrow
  body, and a lower curve.`
- 中文观察: `浅淡紧凑笔画群有上部分叉、狭长主体和下部弧线。`
...
- dataset label text: `㪈㪉㪊`
- dataset label codepoints: `U+3A88;U+3A89;U+3A8A`
...
- graph edge count: `2`
- codepoint routes: `U+3A88;U+3A89;U+3A8A`
...
- Which source records identify obs-char-001500 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001500？
