# obs-char-001090 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001090`
- primary external id: `hust-obc-cat-1219`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1090_obs-char-001090_hust-obc-cat-1219_ora
  cle-character/03_visual-assets/001_asset-001095_hust-obc-cat-1219_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1219/G_1219_後1.13.5合33040𠂤賓間.pn
  g`
- asset id: `asset-001095`
...
- source category: `1219`
- validation class: `1089`
- source image route: `HUST-OBC/deciphered/1219/G_1219_後1.13.5合33040𠂤賓間.png`
- asset id: `asset-001095`
...
- English observation: `A low rounded enclosure is crossed by a central
  upright and accompanied by two short upper side strokes.`
- 中文观察: `低位圆弧闭合轮廓被中央直立笔穿过，两侧有两条短上部笔。`
...
- dataset label text: `㢹`
- dataset label codepoints: `U+38B9`
...
- filename catalog route clues: `Heji-like filename clue: 合33040
...
- Which source records identify obs-char-001090 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001090？
