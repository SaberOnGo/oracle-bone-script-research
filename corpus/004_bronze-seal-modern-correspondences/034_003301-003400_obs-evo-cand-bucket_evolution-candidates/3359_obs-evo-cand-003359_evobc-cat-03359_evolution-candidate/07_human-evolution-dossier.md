...
- External category reference: `evobc-cat-03359`
- Source category ID: `03359`
- Source label for human review: `挽`
- Source codepoints: `U+633D`
...
- `obs-evo-cand-003359-route-category-staging`
...
- `obs-evo-cand-003359-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003359-route-evolution-graph`
