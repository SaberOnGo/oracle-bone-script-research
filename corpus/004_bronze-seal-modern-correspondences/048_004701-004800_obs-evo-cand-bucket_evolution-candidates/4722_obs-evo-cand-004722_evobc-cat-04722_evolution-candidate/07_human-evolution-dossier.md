...
- External category reference: `evobc-cat-04722`
- Source category ID: `04722`
- Source label for human review: `淠`
- Source codepoints: `U+6DE0`
...
- `obs-evo-cand-004722-route-category-staging`
...
- `obs-evo-cand-004722-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004722-route-evolution-graph`
