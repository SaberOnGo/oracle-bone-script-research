# obs-char-001324 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001324`
- primary external id: `hust-obc-cat-1480`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1324_obs-char-001324_hust-obc-cat-1480_ora
  cle-character/03_visual-assets/001_asset-001329_hust-obc-cat-1480_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1480/G_1480_後1.10.4(甲).png`
- asset id: `asset-001329`
...
- source category: `1480`
- validation class: `1323`
- source image route: `HUST-OBC/deciphered/1480/G_1480_後1.10.4(甲).png`
- asset id: `asset-001329`
...
- English observation: `Several separated angular strokes include a short
  upper diagonal, a left mark, and a central branching form.`
...
- dataset label text: `㦾`
- dataset label codepoints: `U+39BE`
...
- Which source records identify obs-char-001324 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001324？
