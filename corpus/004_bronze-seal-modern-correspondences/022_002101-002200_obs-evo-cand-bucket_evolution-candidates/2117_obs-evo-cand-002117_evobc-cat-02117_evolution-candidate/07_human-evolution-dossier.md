...
- External category reference: `evobc-cat-02117`
- Source category ID: `02117`
- Source label for human review: `姍`
- Source codepoints: `U+59CD`
...
- `obs-evo-cand-002117-route-category-staging`
...
- `obs-evo-cand-002117-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002117-route-evolution-graph`
