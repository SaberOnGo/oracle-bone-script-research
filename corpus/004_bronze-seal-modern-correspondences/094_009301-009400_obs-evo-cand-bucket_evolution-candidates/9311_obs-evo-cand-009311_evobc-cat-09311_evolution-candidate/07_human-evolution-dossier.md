...
- Project ID: `obs-evo-cand-009311`
- EVOBC category candidate ID: `evobc-evo-cat-09311`
- External category reference: `evobc-cat-09311`
- Source category ID: `09311`
- Source label for human review: `釧`
- Source codepoints: `U+91E7`
...
- `obs-evo-cand-009311-route-category-staging`
...
- `obs-evo-cand-009311-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009311-route-evolution-graph`
