...
- Project ID: `obs-evo-cand-012033`
- EVOBC category candidate ID: `evobc-evo-cat-12033`
- External category reference: `evobc-cat-12033`
- Source category ID: `12033`
- Source label for human review: `𦗕`
- Source codepoints: `U+265D5`
...
- `obs-evo-cand-012033-route-category-staging`
...
- `obs-evo-cand-012033-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012033-route-evolution-graph`
