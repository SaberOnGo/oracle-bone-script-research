# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004913
...
- EVOBC candidate category: `evobc-evo-cat-04913`.
- Source label for search only: `潭`.
- Source codepoints for search only: `U+6F6D`.
