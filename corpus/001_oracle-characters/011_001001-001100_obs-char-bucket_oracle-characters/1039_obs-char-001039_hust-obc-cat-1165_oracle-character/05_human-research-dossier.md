# obs-char-001039 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001039`
- primary external id: `hust-obc-cat-1165`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1039_obs-char-001039_hust-obc-cat-1165_ora
  cle-character/03_visual-assets/001_asset-001044_hust-obc-cat-1165_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1165/L_1165_11205.jpg`
- asset id: `asset-001044`
...
- source category: `1165`
- validation class: `1038`
- source image route: `HUST-OBC/deciphered/1165/L_1165_11205.jpg`
- asset id: `asset-001044`
...
- English observation: `The faint gray image shows a small branching cluster
  with a central horizontal bar and a rounded lower loop; detail is low
  contrast.`
- 中文观察: `较淡灰色图像显示带中央水平横笔和圆弧下部环笔的小型分枝笔群；细节对比度较低。`
...
- dataset label text: `㢃`
- dataset label codepoints: `U+3883`
...
- Which source records identify obs-char-001039 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001039？
