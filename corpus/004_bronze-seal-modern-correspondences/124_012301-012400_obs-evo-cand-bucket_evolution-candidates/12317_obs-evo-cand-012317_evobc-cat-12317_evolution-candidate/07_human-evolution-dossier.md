...
- External category reference: `evobc-cat-12317`
- Source category ID: `12317`
- Source label for human review: `𨆨`
- Source codepoints: `U+281A8`
...
- `obs-evo-cand-012317-route-category-staging`
...
- `obs-evo-cand-012317-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012317-route-evolution-graph`
