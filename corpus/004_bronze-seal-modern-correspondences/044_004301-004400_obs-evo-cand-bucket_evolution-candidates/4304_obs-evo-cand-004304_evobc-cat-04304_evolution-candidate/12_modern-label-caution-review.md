# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004304
...
- EVOBC candidate category: `evobc-evo-cat-04304`.
- Source label for search only: `檿`.
- Source codepoints for search only: `U+6ABF`.
