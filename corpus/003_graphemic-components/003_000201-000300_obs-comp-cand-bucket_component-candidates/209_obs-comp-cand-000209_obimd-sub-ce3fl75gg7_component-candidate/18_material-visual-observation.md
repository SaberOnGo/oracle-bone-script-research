# Material Visual Observation / obs-comp-cand-000209 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000209`
- External reference / 外部参照: `obimd-sub-ce3fl75gg7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011821_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/pa13rewdd9/ce3fl75gg7/12u1ldsljy.png`
- Checksum / 校验和:
  `9d4310695d7050ee284939147367fbbd16fe7d79dbcc139a80918b6810e387c7`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.21%.
- Marked-pixel bounds: (78,32)–(171,218); span 94 × 187 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.21%。
- 痕迹范围：(78,32)–(171,218)；跨度94 × 187 px；痕迹矩形高于宽。
