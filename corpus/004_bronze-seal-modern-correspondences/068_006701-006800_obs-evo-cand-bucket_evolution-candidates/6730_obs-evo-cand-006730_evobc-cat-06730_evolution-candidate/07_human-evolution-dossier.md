...
- External category reference: `evobc-cat-06730`
- Source category ID: `06730`
- Source label for human review: `纳`
- Source codepoints: `U+7EB3`
...
- `obs-evo-cand-006730-route-category-staging`
...
- `obs-evo-cand-006730-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006730-route-evolution-graph`
