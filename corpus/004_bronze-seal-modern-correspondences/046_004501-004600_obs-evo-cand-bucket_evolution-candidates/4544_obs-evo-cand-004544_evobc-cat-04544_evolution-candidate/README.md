# obs-evo-cand-004544 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-004544`
- EVOBC category candidate ID: `evobc-evo-cat-04544`
- External category ref: `evobc-cat-04544`
- Source label: `沚`
- Source codepoints: `U+6C9A`
- Image reference count: `73`
- Era token counts: `BI:3;OBC:70`
- Source token counts: `Book:6;Web:67`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 70 image references
