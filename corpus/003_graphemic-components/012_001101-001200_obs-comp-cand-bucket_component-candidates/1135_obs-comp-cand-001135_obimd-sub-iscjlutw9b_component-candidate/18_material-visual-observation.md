# Material Visual Observation / obs-comp-cand-001135 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001135`
- External reference / 外部参照: `obimd-sub-iscjlutw9b`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015089_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/iscjlutw9b/iscjlutw9b/iscjlutw9b.png`
- Checksum / 校验和:
  `1b2a71121467e2c2ac3f53e60b15b6f05e7410eec68c853d4b560efbb99c68a9`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.01%.
- Marked-pixel bounds: (64,51)–(185,198); span 122 × 148 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.01%。
- 痕迹范围：(64,51)–(185,198)；跨度122 × 148 px；痕迹矩形高于宽。
