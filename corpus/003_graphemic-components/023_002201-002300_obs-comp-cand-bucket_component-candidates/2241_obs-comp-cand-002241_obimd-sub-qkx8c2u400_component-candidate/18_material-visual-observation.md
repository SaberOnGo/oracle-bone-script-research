# Material Visual Observation / obs-comp-cand-002241 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002241`
- External reference / 外部参照: `obimd-sub-qkx8c2u400`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020054_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/piajc9ws3q/qkx8c2u400/qkx8c2u400.png`
- Checksum / 校验和:
  `afbaa42a51a4d10703fc9a678edc74135cbfee2cd2fc3047340adb6e38d30212`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.97%.
- Marked-pixel bounds: (72,27)–(189,226); span 118 × 200 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.97%。
- 痕迹范围：(72,27)–(189,226)；跨度118 × 200 px；痕迹矩形高于宽。
