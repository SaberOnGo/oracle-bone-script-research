# obs-comp-cand-002489 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002489`
- 首选外部 ID: `obimd-sub-tjt5illw2p`
- OBIMD subcharacter UID: `tjt5illw2p`
- OBIMD main character UID: `tjt5illw2p`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+FE2F0; U+FE2F1; 另有 1 项
