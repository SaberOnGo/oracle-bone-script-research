...
- External category reference: `evobc-cat-03143`
- Source category ID: `03143`
- Source label for human review: `憌`
...
- `obs-evo-cand-003143-route-category-staging`
...
- `obs-evo-cand-003143-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003143-route-evolution-graph`
