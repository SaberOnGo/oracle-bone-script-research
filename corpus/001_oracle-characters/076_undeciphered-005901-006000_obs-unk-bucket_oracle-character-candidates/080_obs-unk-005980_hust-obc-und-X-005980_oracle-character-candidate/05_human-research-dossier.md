# obs-unk-005980 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005980`
- primary external id: `hust-obc-und-X-005980`
...
- local review image route: `corpus/001_oracle-characters/076_undeciphered-005
  901-006000_obs-unk-bucket_oracle-character-candidates/080_obs-unk-005980_h
  ust-obc-und-X-005980_oracle-character-candidate/03_visual-assets/001_asset
  -007572_hust-obc-und-X-005980_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1536/X_？_2961_1.png`
- asset id: `asset-007572`
...
- source class: `HUST-OBC/undeciphered/X/1536/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1536/X_？_2961_1.png`
- asset id: `asset-007572`
...
- Which source records identify obs-unk-005980 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005980？
