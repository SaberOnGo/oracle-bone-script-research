...
- External category reference: `evobc-cat-03993`
- Source category ID: `03993`
- Source label for human review: `栘`
- Source codepoints: `U+6818`
...
- `obs-evo-cand-003993-route-category-staging`
...
- `obs-evo-cand-003993-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003993-route-evolution-graph`
