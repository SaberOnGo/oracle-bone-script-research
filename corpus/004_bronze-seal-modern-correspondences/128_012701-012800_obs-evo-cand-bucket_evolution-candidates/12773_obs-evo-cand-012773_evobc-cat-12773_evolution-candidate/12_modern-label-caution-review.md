# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012773
...
- EVOBC candidate category: `evobc-evo-cat-12773`.
- Source label for search only: `𪔚`.
- Source codepoints for search only: `U+2A51A`.
