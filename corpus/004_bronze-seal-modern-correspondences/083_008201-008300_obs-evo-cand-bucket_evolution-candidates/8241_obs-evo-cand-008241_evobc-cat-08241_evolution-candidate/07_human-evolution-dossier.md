...
Project ID: `obs-evo-cand-008241`
...
- Project ID: `obs-evo-cand-008241`
- EVOBC category candidate ID: `evobc-evo-cat-08241`
- External category reference: `evobc-cat-08241`
- Source category ID: `08241`
- Source label for human review: `誦`
- Source codepoints: `U+8AA6`
...
- `obs-evo-cand-008241-route-category-staging`
...
- `obs-evo-cand-008241-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008241-route-evolution-graph`
