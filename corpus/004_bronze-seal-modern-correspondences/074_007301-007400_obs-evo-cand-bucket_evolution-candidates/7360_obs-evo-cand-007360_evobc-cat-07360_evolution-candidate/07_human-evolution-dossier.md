...
Project ID: `obs-evo-cand-007360`
...
- Project ID: `obs-evo-cand-007360`
- EVOBC category candidate ID: `evobc-evo-cat-07360`
- External category reference: `evobc-cat-07360`
- Source category ID: `07360`
- Source label for human review: `荱`
- Source codepoints: `U+8371`
...
- `obs-evo-cand-007360-route-category-staging`
...
- `obs-evo-cand-007360-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007360-route-evolution-graph`
