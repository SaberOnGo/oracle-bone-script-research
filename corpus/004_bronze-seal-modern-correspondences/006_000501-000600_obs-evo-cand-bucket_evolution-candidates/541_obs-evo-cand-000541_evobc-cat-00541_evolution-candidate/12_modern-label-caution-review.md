# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000541
...
- EVOBC candidate category: `evobc-evo-cat-00541`.
- Source label for search only: `䩪`.
- Source codepoints for search only: `U+4A6A`.
