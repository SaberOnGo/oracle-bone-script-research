# obs-comp-cand-000747 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000747`
- 首选外部 ID: `obimd-sub-ep7qnow4pv`
- OBIMD subcharacter UID: `ep7qnow4pv`
- OBIMD main character UID: `ep7qnow4pv`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `6`
- codepoint 示例: U+4E9F;U+F4444; U+F4445; 另有 4 项
