...
- External category reference: `evobc-cat-07426`
- Source category ID: `07426`
- Source label for human review: `菹`
...
- `obs-evo-cand-007426-route-category-staging`
...
- `obs-evo-cand-007426-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007426-route-evolution-graph`
