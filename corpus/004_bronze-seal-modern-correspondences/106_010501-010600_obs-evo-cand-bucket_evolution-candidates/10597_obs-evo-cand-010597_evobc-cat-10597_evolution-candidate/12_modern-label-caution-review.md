# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010597
...
- EVOBC candidate category: `evobc-evo-cat-10597`.
- Source label for search only: `鹽`.
- Source codepoints for search only: `U+9E7D`.
