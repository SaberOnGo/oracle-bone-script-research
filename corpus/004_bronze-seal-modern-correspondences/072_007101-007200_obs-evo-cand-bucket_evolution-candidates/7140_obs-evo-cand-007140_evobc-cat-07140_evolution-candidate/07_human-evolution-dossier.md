...
- External category reference: `evobc-cat-07140`
- Source category ID: `07140`
- Source label for human review: `膻`
- Source codepoints: `U+81BB`
...
- `obs-evo-cand-007140-route-category-staging`
...
- `obs-evo-cand-007140-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007140-route-evolution-graph`
