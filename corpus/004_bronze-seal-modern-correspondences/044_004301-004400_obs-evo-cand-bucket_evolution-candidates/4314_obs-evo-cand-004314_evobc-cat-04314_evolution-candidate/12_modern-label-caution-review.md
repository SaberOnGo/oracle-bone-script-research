# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004314
...
- EVOBC candidate category: `evobc-evo-cat-04314`.
- Source label for search only: `櫛`.
- Source codepoints for search only: `U+6ADB`.
