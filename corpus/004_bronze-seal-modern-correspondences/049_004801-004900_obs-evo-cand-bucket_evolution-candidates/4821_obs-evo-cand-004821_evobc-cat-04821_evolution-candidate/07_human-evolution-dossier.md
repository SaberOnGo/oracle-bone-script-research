...
- Project ID: `obs-evo-cand-004821`
- EVOBC category candidate ID: `evobc-evo-cat-04821`
- External category reference: `evobc-cat-04821`
- Source category ID: `04821`
- Source label for human review: `溯`
- Source codepoints: `U+6EAF`
...
- `obs-evo-cand-004821-route-category-staging`
...
- `obs-evo-cand-004821-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004821-route-evolution-graph`
