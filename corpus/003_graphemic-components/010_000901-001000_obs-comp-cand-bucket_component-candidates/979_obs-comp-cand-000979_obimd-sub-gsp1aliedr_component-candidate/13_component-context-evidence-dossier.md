# obs-comp-cand-000979 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000979`
- 首选外部 ID: `obimd-sub-gsp1aliedr`
- OBIMD subcharacter UID: `gsp1aliedr`
- OBIMD main character UID: `gsp1aliedr`
- 来源 ID: `src-obimd`
