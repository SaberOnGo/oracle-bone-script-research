# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010460
...
- EVOBC candidate category: `evobc-evo-cat-10460`.
- Source label for search only: `鱼`.
- Source codepoints for search only: `U+9C7C`.
