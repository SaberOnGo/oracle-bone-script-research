...
Project ID: `obs-evo-cand-013472`
...
- Project ID: `obs-evo-cand-013472`
- EVOBC category candidate ID: `evobc-evo-cat-13472`
- External category reference: `evobc-cat-13472`
- Source category ID: `13472`
- Source label for human review: `𭂢`
- Source codepoints: `U+2D0A2`
...
- `obs-evo-cand-013472-route-category-staging`
...
- `obs-evo-cand-013472-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013472-route-evolution-graph`
