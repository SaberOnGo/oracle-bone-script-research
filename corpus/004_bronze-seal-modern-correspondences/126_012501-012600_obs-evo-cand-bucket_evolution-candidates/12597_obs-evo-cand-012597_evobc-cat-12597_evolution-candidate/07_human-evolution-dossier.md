...
Project ID: `obs-evo-cand-012597`
...
- Project ID: `obs-evo-cand-012597`
- EVOBC category candidate ID: `evobc-evo-cat-12597`
- External category reference: `evobc-cat-12597`
- Source category ID: `12597`
- Source label for human review: `𩏐`
- Source codepoints: `U+293D0`
...
- `obs-evo-cand-012597-route-category-staging`
...
- `obs-evo-cand-012597-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012597-route-evolution-graph`
