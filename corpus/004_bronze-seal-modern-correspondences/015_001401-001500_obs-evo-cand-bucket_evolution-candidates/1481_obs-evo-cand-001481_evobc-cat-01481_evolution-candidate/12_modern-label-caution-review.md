# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001481
...
- EVOBC candidate category: `evobc-evo-cat-01481`.
- Source label for search only: `史`.
- Source codepoints for search only: `U+53F2`.
