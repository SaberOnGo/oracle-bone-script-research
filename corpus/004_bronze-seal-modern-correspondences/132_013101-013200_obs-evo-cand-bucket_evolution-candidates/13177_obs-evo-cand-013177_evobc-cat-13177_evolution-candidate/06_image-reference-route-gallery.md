...
- `obs-evo-cand-013177-route-category-staging`
...
- `obs-evo-cand-013177-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013177-route-evolution-graph`
