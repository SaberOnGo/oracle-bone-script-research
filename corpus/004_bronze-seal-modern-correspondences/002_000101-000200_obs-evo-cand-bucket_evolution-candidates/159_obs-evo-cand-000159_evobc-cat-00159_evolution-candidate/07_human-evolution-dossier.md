...
- Project ID: `obs-evo-cand-000159`
- EVOBC category candidate ID: `evobc-evo-cat-00159`
- External category reference: `evobc-cat-00159`
- Source category ID: `00159`
- Source label for human review: `㫘`
- Source codepoints: `U+3AD8`
...
- `obs-evo-cand-000159-route-category-staging`
...
- `obs-evo-cand-000159-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000159-route-evolution-graph`
