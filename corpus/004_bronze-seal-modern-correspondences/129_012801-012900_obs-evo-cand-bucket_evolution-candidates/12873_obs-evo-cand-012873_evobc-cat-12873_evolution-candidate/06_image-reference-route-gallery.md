...
- `obs-evo-cand-012873-route-category-staging`
...
- `obs-evo-cand-012873-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012873-route-evolution-graph`
