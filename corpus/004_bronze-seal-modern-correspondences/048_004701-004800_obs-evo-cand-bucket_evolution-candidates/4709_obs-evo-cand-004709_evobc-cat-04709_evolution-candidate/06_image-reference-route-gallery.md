...
- `obs-evo-cand-004709-route-category-staging`
...
- `obs-evo-cand-004709-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004709-route-evolution-graph`
