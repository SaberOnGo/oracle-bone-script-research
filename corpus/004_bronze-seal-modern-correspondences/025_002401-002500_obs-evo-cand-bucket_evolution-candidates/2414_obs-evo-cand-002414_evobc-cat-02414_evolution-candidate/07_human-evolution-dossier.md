...
Project ID: `obs-evo-cand-002414`
...
- Project ID: `obs-evo-cand-002414`
- EVOBC category candidate ID: `evobc-evo-cat-02414`
- External category reference: `evobc-cat-02414`
- Source category ID: `02414`
- Source label for human review: `富`
- Source codepoints: `U+5BCC`
...
- `obs-evo-cand-002414-route-category-staging`
...
- `obs-evo-cand-002414-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002414-route-evolution-graph`
