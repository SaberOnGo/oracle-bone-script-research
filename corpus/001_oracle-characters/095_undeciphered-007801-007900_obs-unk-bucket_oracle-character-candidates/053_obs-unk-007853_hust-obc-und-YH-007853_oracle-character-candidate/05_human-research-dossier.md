# obs-unk-007853 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-007853`
- primary external id: `hust-obc-und-YH-007853`
...
- local review image route: `corpus/001_oracle-characters/095_undeciphered-007
  801-007900_obs-unk-bucket_oracle-character-candidates/053_obs-unk-007853_h
  ust-obc-und-YH-007853_oracle-character-candidate/03_visual-assets/001_asse
  t-009444_hust-obc-und-YH-007853_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/603F8/H_？_603F8_0.png`
- asset id: `asset-009444`
...
- source class: `HUST-OBC/undeciphered/Y+H/603F8/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/603F8/H_？_603F8_0.png`
- asset id: `asset-009444`
...
- Which source records identify obs-unk-007853 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007853？
