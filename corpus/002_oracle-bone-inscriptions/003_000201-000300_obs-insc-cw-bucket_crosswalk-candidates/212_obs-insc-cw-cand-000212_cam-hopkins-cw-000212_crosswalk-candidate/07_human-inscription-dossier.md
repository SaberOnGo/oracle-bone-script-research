...
- Yingguo / 英国所藏: `y1241` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `182` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `456` in source row; primary catalog entry pending
- Heji / 合集: `40450` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000212`
