...
- External category reference: `evobc-cat-06492`
- Source category ID: `06492`
- Source label for human review: `絅`
- Source codepoints: `U+7D45`
...
- `obs-evo-cand-006492-route-category-staging`
...
- `obs-evo-cand-006492-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006492-route-evolution-graph`
