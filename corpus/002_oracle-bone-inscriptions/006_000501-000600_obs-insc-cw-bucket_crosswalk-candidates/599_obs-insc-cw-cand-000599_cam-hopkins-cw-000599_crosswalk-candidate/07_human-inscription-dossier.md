...
Project ID: `obs-insc-cw-cand-000599`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000599`
...
- Yingguo / 英国所藏: `y2651` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `403` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `485` in source row; primary catalog entry pending
- Heji / 合集: `41925` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000599`
