# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004382
...
- EVOBC candidate category: `evobc-evo-cat-04382`.
- Source label for search only: `歟`.
- Source codepoints for search only: `U+6B5F`.
