# Material Visual Observation / obs-comp-cand-001221 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001221`
- External reference / 外部参照: `obimd-sub-jl0fjl7uo6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015452_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jl0fjl7uo6/jl0fjl7uo6/jl0fjl7uo6.png`
- Checksum / 校验和:
  `c336afc01ec59948260c41d2d90105167723b6bcb642e225cf6e2bad22976bec`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.66%.
- Marked-pixel bounds: (57,23)–(202,226); span 146 × 204 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.66%。
- 痕迹范围：(57,23)–(202,226)；跨度146 × 204 px；痕迹矩形高于宽。
