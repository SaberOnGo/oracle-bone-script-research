...
Project ID: `obs-evo-cand-009774`
...
- Project ID: `obs-evo-cand-009774`
- EVOBC category candidate ID: `evobc-evo-cat-09774`
- External category reference: `evobc-cat-09774`
- Source category ID: `09774`
- Source label for human review: `隕`
- Source codepoints: `U+9695`
...
- `obs-evo-cand-009774-route-category-staging`
...
- `obs-evo-cand-009774-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009774-route-evolution-graph`
