...
- External category reference: `evobc-cat-05657`
- Source category ID: `05657`
- Source label for human review: `痹`
- Source codepoints: `U+75F9`
...
- `obs-evo-cand-005657-route-category-staging`
...
- `obs-evo-cand-005657-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005657-route-evolution-graph`
