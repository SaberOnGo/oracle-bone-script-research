# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002226
...
- EVOBC candidate category: `evobc-evo-cat-02226`.
- Source label for search only: `媌`.
- Source codepoints for search only: `U+5A8C`.
