# obs-unk-004109 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004109`
- primary external id: `hust-obc-und-L-004109`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/009_obs-unk-004109_h
  ust-obc-und-L-004109_oracle-character-candidate/03_visual-assets/001_asset
  -005702_hust-obc-und-L-004109_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4109/L_？_8845.jpg`
- asset id: `asset-005702`
...
- source class: `HUST-OBC/undeciphered/L/4109/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4109/L_？_8845.jpg`
- asset id: `asset-005702`
...
- English observation: The opened image shows a compact upper form, a curved
  middle trace, and a short darker mark below.
- 中文观察：已打开图像可见紧凑上部形态、弯曲中部痕迹和下方短深色痕迹。
...
- Which source records identify obs-unk-004109 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004109？
