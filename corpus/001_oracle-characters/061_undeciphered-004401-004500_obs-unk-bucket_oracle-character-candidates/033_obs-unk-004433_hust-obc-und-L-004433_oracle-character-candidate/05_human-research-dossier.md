# obs-unk-004433 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/033_obs-unk-004433_h
  ust-obc-und-L-004433_oracle-character-candidate/03_visual-assets/001_asset
  -006026_hust-obc-und-L-004433_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4433/L_？_9963.jpg`
- asset id: `asset-006026`
...
- source class: `HUST-OBC/undeciphered/L/4433/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4433/L_？_9963.jpg`
- asset id: `asset-006026`
...
- English observation: `A left vertical cluster sits beside a taller`
  `right trace.`
- 中文观察: `左侧竖向痕迹聚集处紧邻较高的右侧痕迹。`
...
- Which source records identify obs-unk-004433 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004433？
