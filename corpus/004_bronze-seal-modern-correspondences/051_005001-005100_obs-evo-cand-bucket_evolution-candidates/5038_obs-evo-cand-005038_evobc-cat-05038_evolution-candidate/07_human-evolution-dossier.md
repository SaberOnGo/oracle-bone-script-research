...
Project ID: `obs-evo-cand-005038`
...
- Project ID: `obs-evo-cand-005038`
- EVOBC category candidate ID: `evobc-evo-cat-05038`
- External category reference: `evobc-cat-05038`
- Source category ID: `05038`
- Source label for human review: `炅`
- Source codepoints: `U+7085`
...
- `obs-evo-cand-005038-route-category-staging`
...
- `obs-evo-cand-005038-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005038-route-evolution-graph`
