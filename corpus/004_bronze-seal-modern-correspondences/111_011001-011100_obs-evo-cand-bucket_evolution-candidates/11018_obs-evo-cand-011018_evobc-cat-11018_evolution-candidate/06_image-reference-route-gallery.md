...
- `obs-evo-cand-011018-route-category-staging`
...
- `obs-evo-cand-011018-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011018-route-evolution-graph`
