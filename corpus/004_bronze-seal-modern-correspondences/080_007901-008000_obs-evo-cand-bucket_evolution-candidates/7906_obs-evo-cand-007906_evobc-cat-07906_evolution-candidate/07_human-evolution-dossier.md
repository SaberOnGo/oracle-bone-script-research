...
- External category reference: `evobc-cat-07906`
- Source category ID: `07906`
- Source label for human review: `術`
...
- `obs-evo-cand-007906-route-category-staging`
...
- `obs-evo-cand-007906-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007906-route-evolution-graph`
