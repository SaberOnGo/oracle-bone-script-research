# Preformal Research Start Check / 正式研究开始前开包核查: coll-obj-cand-00011
...
| --- | --- | --- |
| 1 | `02_collection-source-index.csv` | `775` |
| 2 | `18_live-source-evidence-review.md` | page and text/image evidence |
