...
- External category reference: `evobc-cat-05116`
- Source category ID: `05116`
- Source label for human review: `煨`
- Source codepoints: `U+7168`
...
- `obs-evo-cand-005116-route-category-staging`
...
- `obs-evo-cand-005116-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005116-route-evolution-graph`
