...
- External category reference: `evobc-cat-02129`
- Source category ID: `02129`
- Source label: `姜`
...
- `obs-evo-cand-002129-route-category-staging`
...
- `obs-evo-cand-002129-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002129-route-evolution-graph`
