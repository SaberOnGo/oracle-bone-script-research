...
- External category reference: `evobc-cat-02467`
- Source category ID: `02467`
- Source label: `小`
...
- `obs-evo-cand-002467-route-category-staging`
...
- `obs-evo-cand-002467-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-002467-route-evolution-graph`
