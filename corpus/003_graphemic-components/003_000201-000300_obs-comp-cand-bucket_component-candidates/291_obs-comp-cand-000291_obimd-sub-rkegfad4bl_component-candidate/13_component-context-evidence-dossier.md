# obs-comp-cand-000291 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000291`
- 首选外部 ID: `obimd-sub-rkegfad4bl`
- OBIMD subcharacter UID: `rkegfad4bl`
- OBIMD main character UID: `rkegfad4bl`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+B3066;U+F1A3A; U+F1A3B; 另有 2 项
