...
- External category reference: `evobc-cat-08359`
- Source category ID: `08359`
- Source label for human review: `譖`
...
- `obs-evo-cand-008359-route-category-staging`
...
- `obs-evo-cand-008359-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008359-route-evolution-graph`
