# obs-unk-006590 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/082_undeciphered-006
  501-006600_obs-unk-bucket_oracle-character-candidates/090_obs-unk-006590_h
  ust-obc-und-X-006590_oracle-character-candidate/03_visual-assets/001_asset
  -008181_hust-obc-und-X-006590_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2146/X_？_6253_1.png`
- asset id: `asset-008181`
...
- source class: `HUST-OBC/undeciphered/X/2146/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2146/X_？_6253_1.png`
...
- Which source records identify obs-unk-006590 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006590？
