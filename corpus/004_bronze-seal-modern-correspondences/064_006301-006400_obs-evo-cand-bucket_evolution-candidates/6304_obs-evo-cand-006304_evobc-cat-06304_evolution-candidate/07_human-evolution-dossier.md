...
- External category reference: `evobc-cat-06304`
- Source category ID: `06304`
- Source label for human review: `箴`
- Source codepoints: `U+7BB4`
...
- `obs-evo-cand-006304-route-category-staging`
...
- `obs-evo-cand-006304-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006304-route-evolution-graph`
