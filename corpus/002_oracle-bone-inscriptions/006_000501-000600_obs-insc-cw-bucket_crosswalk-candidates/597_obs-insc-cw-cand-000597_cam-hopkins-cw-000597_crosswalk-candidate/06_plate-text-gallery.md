...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000597` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2648` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `386` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `587` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `41927` [route_present_image_or_text_not_collected]
