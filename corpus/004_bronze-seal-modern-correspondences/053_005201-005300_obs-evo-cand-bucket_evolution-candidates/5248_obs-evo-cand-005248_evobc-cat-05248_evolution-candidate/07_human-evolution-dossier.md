...
- External category reference: `evobc-cat-05248`
- Source category ID: `05248`
- Source label: `犮`
...
- `obs-evo-cand-005248-route-category-staging`
...
- `obs-evo-cand-005248-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005248-route-evolution-graph`
