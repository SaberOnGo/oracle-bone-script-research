...
- Project ID: `obs-evo-cand-004480`
- EVOBC category candidate ID: `evobc-evo-cat-04480`
- External category reference: `evobc-cat-04480`
- Source category ID: `04480`
- Source label for human review: `氾`
- Source codepoints: `U+6C3E`
...
- `obs-evo-cand-004480-route-category-staging`
...
- `obs-evo-cand-004480-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004480-route-evolution-graph`
