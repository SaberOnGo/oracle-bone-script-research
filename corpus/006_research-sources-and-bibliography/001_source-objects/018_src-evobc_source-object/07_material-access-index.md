# src-evobc Material Access Index
...
- Target records / 目标记录: graphic_evolution; source_record
- Metadata profile count / 元数据概况数: 7
- Profile metrics / 概况指标: category_mapping_count; class_count;
  classes_without_images; era_image_counts; image_reference_count;
  source_image_counts; worksheet_shape
