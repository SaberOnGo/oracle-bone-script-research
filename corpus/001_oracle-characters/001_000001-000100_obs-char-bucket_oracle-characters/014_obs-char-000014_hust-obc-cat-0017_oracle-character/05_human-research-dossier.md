# obs-char-000014 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000014`
- primary external id: `hust-obc-cat-0017`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/014_obs-char-000014_hust-obc-cat-0017_orac
  le-character/03_visual-assets/001_asset-000019_hust-obc-cat-0017_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0017/H_0017_602A8_0.png`
- asset id: `asset-000019`
...
- source category: `0017`
- validation class: `13`
- source image route: `HUST-OBC/deciphered/0017/H_0017_602A8_0.png`
- asset id: `asset-000019`
...
- English observation: `Two separated forms are visible: the left has an
  angular crossing shape, while the right has a rounded loop and pointed
  top.`
- 中文观察: `图像可见两个分离形体：左侧为折角交叉形，右侧有圆弧环状部分和尖顶。`
...
- dataset label text: `㐇`
- dataset label codepoints: `U+3407`
...
- filename catalog route clues: `catalog-like filename clue: H_0017
  (H_0017_602A8_0.png)`
...
- Which source records identify obs-char-000014 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000014？
