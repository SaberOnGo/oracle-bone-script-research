...
- External category reference: `evobc-cat-02233`
- Source category ID: `02233`
- Source label for human review: `媛`
- Source codepoints: `U+5A9B`
...
- `obs-evo-cand-002233-route-category-staging`
...
- `obs-evo-cand-002233-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002233-route-evolution-graph`
