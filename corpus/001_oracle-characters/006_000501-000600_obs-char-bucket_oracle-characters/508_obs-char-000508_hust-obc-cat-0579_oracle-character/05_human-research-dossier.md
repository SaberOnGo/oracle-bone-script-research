# obs-char-000508 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/508_obs-char-000508_hust-obc-cat-0579_orac
  le-character/03_visual-assets/001_asset-000513_hust-obc-cat-0579_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0579/G_0579_甲骨文0.png`
- asset id: `asset-000513`
...
- source category: `0579`
- validation class: `507`
- source image route: `HUST-OBC/deciphered/0579/G_0579_甲骨文0.png`
- asset id: `asset-000513`
...
- dataset label text: `㘹`
- dataset label codepoints: `U+3639`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/039_obs-evo-can
  d-000039_evobc-cat-00039_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/039_obs-evo-cand-000039_evobc-cat-00039_evolu
...
- Which source records identify obs-char-000508 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000508？
