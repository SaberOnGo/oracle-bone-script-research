...
- `obs-evo-cand-006327-route-category-staging`
...
- `obs-evo-cand-006327-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006327-route-evolution-graph`
