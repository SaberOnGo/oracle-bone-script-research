...
- Project ID: `obs-evo-cand-012129`
- EVOBC category candidate ID: `evobc-evo-cat-12129`
- External category reference: `evobc-cat-12129`
- Source category ID: `12129`
- Source label for human review: `𧀨`
- Source codepoints: `U+27028`
...
- `obs-evo-cand-012129-route-category-staging`
...
- `obs-evo-cand-012129-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012129-route-evolution-graph`
