# obs-char-001353 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1353_obs-char-001353_hust-obc-cat-1510_ora
  cle-character/03_visual-assets/001_asset-001358_hust-obc-cat-1510_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1510/G_1510_前6.61.2(甲).png`
- asset id: `asset-001358`
...
- source category: `1510`
- validation class: `1352`
- source image route: `HUST-OBC/deciphered/1510/G_1510_前6.61.2(甲).png`
- asset id: `asset-001358`
...
- English observation: `A compact symmetrical cluster has a pointed upper
  enclosure, paired side branches, and a central lower stroke.`
- 中文观察: `紧凑近对称笔画群有尖顶上部框形、成对侧部分枝和中央下行笔。`
...
- dataset label text: `㧜`
- dataset label codepoints: `U+39DC`
...
- Which source records identify obs-char-001353 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001353？
