# obs-char-000576 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000576`
- primary external id: `hust-obc-cat-0652`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/576_obs-char-000576_hust-obc-cat-0652_orac
  le-character/03_visual-assets/001_asset-000581_hust-obc-cat-0652_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0652/G_0652_前5.8.3合4733𠂤賓間.png`
- asset id: `asset-000581`
...
- source category: `0652`
- validation class: `575`
- source image route: `HUST-OBC/deciphered/0652/G_0652_前5.8.3合4733𠂤賓間.png`
- asset id: `asset-000581`
...
- English observation: `A long central vertical is crossed by a small
  horizontal oval loop at left, while its upper section bends and carries a
  short diagonal branch.`
- 中文观察: `长中央竖笔被左侧小型横椭圆环穿过，上段弯折并带一条短斜枝。`
...
- dataset label text: `㚂`
- dataset label codepoints: `U+3682`
...
- filename catalog route clues: `Heji-like filename clue: 合4733
  (G_0652_前5.8.3合4733𠂤賓間.png)`
...
- Which source records identify obs-char-000576 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000576？
