...
- External category reference: `evobc-cat-10558`
- Source category ID: `10558`
- Source label for human review: `鷢`
- Source codepoints: `U+9DE2`
...
- `obs-evo-cand-010558-route-category-staging`
...
- `obs-evo-cand-010558-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010558-route-evolution-graph`
