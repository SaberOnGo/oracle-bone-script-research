...
- External category reference: `evobc-cat-02293`
- Source category ID: `02293`
- Source label for human review: `嬉`
...
- `obs-evo-cand-002293-route-category-staging`
...
- `obs-evo-cand-002293-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002293-route-evolution-graph`
