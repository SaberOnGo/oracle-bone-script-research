...
- External category reference: `evobc-cat-00099`
- Source category ID: `00099`
- Source label for human review: `㢟`
- Source codepoints: `U+389F`
...
- `obs-evo-cand-000099-route-category-staging`
...
- `obs-evo-cand-000099-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000099-route-evolution-graph`
