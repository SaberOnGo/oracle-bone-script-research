...
- `obs-evo-cand-004981-route-category-staging`
...
- `obs-evo-cand-004981-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004981-route-evolution-graph`
