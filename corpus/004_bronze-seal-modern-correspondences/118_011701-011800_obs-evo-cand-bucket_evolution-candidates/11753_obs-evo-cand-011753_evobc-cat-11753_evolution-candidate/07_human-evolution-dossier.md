...
- External category reference: `evobc-cat-11753`
- Source category ID: `11753`
- Source label for human review: `𥁑`
...
- `obs-evo-cand-011753-route-category-staging`
...
- `obs-evo-cand-011753-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011753-route-evolution-graph`
