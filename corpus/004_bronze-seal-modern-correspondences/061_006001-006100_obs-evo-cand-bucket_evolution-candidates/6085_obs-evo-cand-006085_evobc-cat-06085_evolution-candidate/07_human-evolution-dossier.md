...
Project ID: `obs-evo-cand-006085`
...
- Project ID: `obs-evo-cand-006085`
- EVOBC category candidate ID: `evobc-evo-cat-06085`
- External category reference: `evobc-cat-06085`
- Source category ID: `06085`
- Source label for human review: `秹`
- Source codepoints: `U+79F9`
...
- `obs-evo-cand-006085-route-category-staging`
...
- `obs-evo-cand-006085-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006085-route-evolution-graph`
