...
- External category reference: `evobc-cat-12545`
- Source category ID: `12545`
- Source label for human review: `𩀢`
- Source codepoints: `U+29022`
...
- `obs-evo-cand-012545-route-category-staging`
...
- `obs-evo-cand-012545-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012545-route-evolution-graph`
