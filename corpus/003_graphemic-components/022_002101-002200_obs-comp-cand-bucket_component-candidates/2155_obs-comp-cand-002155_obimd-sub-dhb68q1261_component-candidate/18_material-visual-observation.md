# Material Visual Observation / obs-comp-cand-002155 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002155`
- External reference / 外部参照: `obimd-sub-dhb68q1261`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019796_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cv483h1fw2/dhb68q1261/dhb68q1261.png`
- Checksum / 校验和:
  `ad69c1f304a9b75ae8142945fb36717712fb386164108eee447f251242433b4f`
...
- Marked-pixel bounds: (87,31)–(162,212); span 76 × 182 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.75%。
- 痕迹范围：(87,31)–(162,212)；跨度76 × 182 px；痕迹矩形高于宽。
