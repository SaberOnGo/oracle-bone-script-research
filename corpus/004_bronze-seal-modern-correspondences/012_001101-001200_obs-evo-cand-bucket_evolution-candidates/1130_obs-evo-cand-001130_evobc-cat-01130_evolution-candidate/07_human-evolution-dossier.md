...
- Project ID: `obs-evo-cand-001130`
- EVOBC category candidate ID: `evobc-evo-cat-01130`
- External category reference: `evobc-cat-01130`
- Source category ID: `01130`
- Source label for human review: `冢`
- Source codepoints: `U+51A2`
...
- `obs-evo-cand-001130-route-category-staging`
...
- `obs-evo-cand-001130-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001130-route-evolution-graph`
