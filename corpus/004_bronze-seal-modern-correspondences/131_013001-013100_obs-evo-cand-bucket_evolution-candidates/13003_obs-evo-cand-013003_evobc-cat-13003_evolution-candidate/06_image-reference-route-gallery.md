...
- `obs-evo-cand-013003-route-category-staging`
...
- `obs-evo-cand-013003-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013003-route-evolution-graph`
