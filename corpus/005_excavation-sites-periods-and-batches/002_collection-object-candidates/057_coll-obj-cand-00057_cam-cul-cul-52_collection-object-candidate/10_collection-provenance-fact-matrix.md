# Collection Provenance Fact Matrix / 馆藏来源事实矩阵: coll-obj-cand-00057
...
| Catalog or accession route / 著录或登记路线 | CUL.52; source-page route only | 02_collection-source-index.csv; 06_human-collection-dossier.md |
...
| Period or date / 时期或年代 | Period I group 6 source-row label; needs human review | 06_human-collection-dossier.md; 08_collection-provenance-evidence-dossier.md |
...
| Source and rights trail / 来源与权利链 | src-cambridge-hopkins; rights metadata_only_until_verified | 02_collection-source-index.csv; 09_collection-provenance-evidence-index.json |
