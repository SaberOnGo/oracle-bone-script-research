...
- External category reference: `evobc-cat-12790`
- Source category ID: `12790`
- Source label for human review: `𪛈`
...
- `obs-evo-cand-012790-route-category-staging`
...
- `obs-evo-cand-012790-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012790-route-evolution-graph`
