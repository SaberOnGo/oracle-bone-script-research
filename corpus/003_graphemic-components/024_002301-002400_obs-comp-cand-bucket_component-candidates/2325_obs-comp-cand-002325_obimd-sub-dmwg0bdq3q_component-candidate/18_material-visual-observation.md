# Material Visual Observation / obs-comp-cand-002325 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002325`
- External reference / 外部参照: `obimd-sub-dmwg0bdq3q`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020344_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wil5zsif77/dmwg0bdq3q/dmwg0bdq3q.png`
- Checksum / 校验和:
  `317742edabd54d6521bc9b525c93b94e671bc1c008c2ca953a4c1e783425b930`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.06%.
- Marked-pixel bounds: (77,30)–(172,221); span 96 × 192 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.06%。
- 痕迹范围：(77,30)–(172,221)；跨度96 × 192 px；痕迹矩形高于宽。
