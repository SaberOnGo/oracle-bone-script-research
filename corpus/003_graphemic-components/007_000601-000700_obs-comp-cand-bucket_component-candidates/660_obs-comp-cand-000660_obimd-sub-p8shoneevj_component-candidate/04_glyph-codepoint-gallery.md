# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000660
...
| --- | --- | --- | --- |
| `obimd-glyph-link-009685` | 󳳆 | `U+F3CC6` | `reviewed_metadata_only` |
| `obimd-glyph-link-009686` | 󳳇 | `U+F3CC7` | `reviewed_metadata_only` |
