# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004919
...
- EVOBC candidate category: `evobc-evo-cat-04919`.
- Source label for search only: `潺`.
- Source codepoints for search only: `U+6F7A`.
