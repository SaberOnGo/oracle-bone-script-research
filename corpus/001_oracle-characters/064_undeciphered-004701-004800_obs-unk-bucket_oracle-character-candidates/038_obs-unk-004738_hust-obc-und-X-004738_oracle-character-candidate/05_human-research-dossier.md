# obs-unk-004738 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004738`
- primary external id: `hust-obc-und-X-004738`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/038_obs-unk-004738_h
  ust-obc-und-X-004738_oracle-character-candidate/03_visual-assets/001_asset
  -006331_hust-obc-und-X-004738_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/294/X_？_7272_1.png`
- asset id: `asset-006331`
...
- source class: `HUST-OBC/undeciphered/X/294/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/294/X_？_7272_1.png`
- asset id: `asset-006331`
...
- English observation: `separated fragments with upper-right openings`
- 中文观察: `带右上开口的分离笔画残片`
...
- Which source records identify obs-unk-004738 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004738？
