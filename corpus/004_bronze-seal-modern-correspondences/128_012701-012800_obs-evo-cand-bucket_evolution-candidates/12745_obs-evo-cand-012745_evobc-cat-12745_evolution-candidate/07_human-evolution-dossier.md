...
- External category reference: `evobc-cat-12745`
- Source category ID: `12745`
- Source label for human review: `𪋧`
...
- `obs-evo-cand-012745-route-category-staging`
...
- `obs-evo-cand-012745-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012745-route-evolution-graph`
