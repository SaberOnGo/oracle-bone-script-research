...
- Source page section: `Period I Group 5` /
  `第 I 期第 5 组`
- Source section key: `period-i-group-5`
...
- Yingguo / 英国所藏: `y521` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `119` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `487` in source row; primary catalog entry pending
- Heji / 合集: `39516` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000080`
