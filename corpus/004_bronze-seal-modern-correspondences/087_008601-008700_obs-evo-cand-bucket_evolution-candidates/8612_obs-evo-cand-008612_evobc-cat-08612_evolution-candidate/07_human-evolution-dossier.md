...
- External category reference: `evobc-cat-08612`
- Source category ID: `08612`
- Source label for human review: `贝`
...
- `obs-evo-cand-008612-route-category-staging`
...
- `obs-evo-cand-008612-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008612-route-evolution-graph`
