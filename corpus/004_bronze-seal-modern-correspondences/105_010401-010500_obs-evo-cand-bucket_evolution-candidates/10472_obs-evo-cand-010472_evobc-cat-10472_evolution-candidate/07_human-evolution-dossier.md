...
- External category reference: `evobc-cat-10472`
- Source category ID: `10472`
- Source label for human review: `鳬`
...
- `obs-evo-cand-010472-route-category-staging`
...
- `obs-evo-cand-010472-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010472-route-evolution-graph`
