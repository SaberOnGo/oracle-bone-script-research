...
- External category reference: `evobc-cat-08923`
- Source category ID: `08923`
- Source label for human review: `辯`
...
- `obs-evo-cand-008923-route-category-staging`
...
- `obs-evo-cand-008923-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008923-route-evolution-graph`
