...
- External category reference: `evobc-cat-04796`
- Source category ID: `04796`
- Source label for human review: `湮`
...
- `obs-evo-cand-004796-route-category-staging`
...
- `obs-evo-cand-004796-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004796-route-evolution-graph`
