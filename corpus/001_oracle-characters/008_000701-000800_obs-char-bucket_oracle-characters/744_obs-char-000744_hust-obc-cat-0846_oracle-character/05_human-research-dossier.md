# obs-char-000744 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/744_obs-char-000744_hust-obc-cat-0846_orac
  le-character/03_visual-assets/001_asset-000749_hust-obc-cat-0846_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0846/X_0846_1475_1.png`
- asset id: `asset-000749`
...
- source category: `0846`
- validation class: `743`
- source image route: `HUST-OBC/deciphered/0846/X_0846_1475_1.png`
- asset id: `asset-000749`
...
- English observation: `Two tall detached forms stand side by side: the left
  is a long Y-shaped branch, while the right upright passes through a small
  angular loop and crossing lower strokes.`
- 中文观察: `两个高长分离形并列：左侧为长 Y 形分枝，右侧竖干穿过小折角环和交叉下笔。`
...
- dataset label text: `㝄`
- dataset label codepoints: `U+3744`
...
- Which source records identify obs-char-000744 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000744？
