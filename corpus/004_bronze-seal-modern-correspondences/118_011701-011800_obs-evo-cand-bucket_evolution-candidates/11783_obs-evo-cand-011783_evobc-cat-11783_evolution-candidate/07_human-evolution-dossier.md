...
- External category reference: `evobc-cat-11783`
- Source category ID: `11783`
- Source label for human review: `𥈛`
- Source codepoints: `U+2521B`
...
- `obs-evo-cand-011783-route-category-staging`
...
- `obs-evo-cand-011783-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011783-route-evolution-graph`
