# Material Visual Observation / obs-comp-cand-002719 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002719`
- External reference / 外部参照: `obimd-sub-blnw7kod24`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021295_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hdyubeknoa/blnw7kod24/blnw7kod24.png`
- Checksum / 校验和:
  `5a34770fe0d8684031321d233d8ea51260c378bdf780fc5840ef005772df8efc`
...
- Marked-pixel bounds: (69,36)–(180,207); span 112 × 172 px; the marked
...
- 痕迹范围：(69,36)–(180,207)；跨度112 × 172 px；痕迹矩形高于宽。
