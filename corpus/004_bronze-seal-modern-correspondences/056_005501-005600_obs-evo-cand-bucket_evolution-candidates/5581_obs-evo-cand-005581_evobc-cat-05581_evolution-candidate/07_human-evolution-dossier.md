...
- External category reference: `evobc-cat-05581`
- Source category ID: `05581`
- Source label for human review: `畯`
- Source codepoints: `U+756F`
...
- `obs-evo-cand-005581-route-category-staging`
...
- `obs-evo-cand-005581-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005581-route-evolution-graph`
