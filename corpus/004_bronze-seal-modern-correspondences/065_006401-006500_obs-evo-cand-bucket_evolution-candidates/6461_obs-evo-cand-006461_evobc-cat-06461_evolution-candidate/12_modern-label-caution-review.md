# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006461
...
- EVOBC candidate category: `evobc-evo-cat-06461`.
- Source label for search only: `級`.
- Source codepoints for search only: `U+7D1A`.
