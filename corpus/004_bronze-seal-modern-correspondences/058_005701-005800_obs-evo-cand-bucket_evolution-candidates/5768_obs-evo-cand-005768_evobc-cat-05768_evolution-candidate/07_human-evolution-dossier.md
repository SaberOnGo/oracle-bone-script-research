...
- External category reference: `evobc-cat-05768`
- Source category ID: `05768`
- Source label for human review: `盪`
- Source codepoints: `U+76EA`
...
- `obs-evo-cand-005768-route-category-staging`
...
- `obs-evo-cand-005768-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005768-route-evolution-graph`
