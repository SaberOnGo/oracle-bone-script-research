# Material Visual Observation / obs-comp-cand-001088 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001088`
- External reference / 外部参照: `obimd-sub-rxgt4nludm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014897_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fmdym8mxmv/rxgt4nludm/rxgt4nludm.png`
- Checksum / 校验和:
  `b99267dd41980c3145527faeb5c85eeb64c9b7f320d210a7104740535cfb3c94`
...
- Marked-pixel bounds: (82,26)–(177,220); span 96 × 195 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.24%。
- 痕迹范围：(82,26)–(177,220)；跨度96 × 195 px；痕迹矩形高于宽。
