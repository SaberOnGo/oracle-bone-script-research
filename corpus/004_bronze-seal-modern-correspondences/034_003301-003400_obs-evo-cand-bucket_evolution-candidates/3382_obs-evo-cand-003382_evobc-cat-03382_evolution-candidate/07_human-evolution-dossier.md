...
- External category reference: `evobc-cat-03382`
- Source category ID: `03382`
- Source label for human review: `据`
- Source codepoints: `U+636E`
...
- `obs-evo-cand-003382-route-category-staging`
...
- `obs-evo-cand-003382-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003382-route-evolution-graph`
