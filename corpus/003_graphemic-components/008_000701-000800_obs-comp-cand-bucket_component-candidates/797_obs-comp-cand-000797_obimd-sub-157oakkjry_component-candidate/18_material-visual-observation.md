# Material Visual Observation / obs-comp-cand-000797 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000797`
- External reference / 外部参照: `obimd-sub-157oakkjry`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013595_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2tq601zel0/157oakkjry/157oakkjry.png`
- Checksum / 校验和:
  `fc685f8ef724f96e5cde8fac1acc095ed5e4a794e0a55c63a863884d32f5a561`
...
- Marked-pixel bounds: (57,28)–(209,221); span 153 × 194 px; the marked
...
- 痕迹范围：(57,28)–(209,221)；跨度153 × 194 px；痕迹矩形高于宽。
