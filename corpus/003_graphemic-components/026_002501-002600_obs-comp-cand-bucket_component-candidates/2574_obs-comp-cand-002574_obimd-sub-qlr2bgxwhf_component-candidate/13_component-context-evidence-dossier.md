# obs-comp-cand-002574 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002574`
- 首选外部 ID: `obimd-sub-qlr2bgxwhf`
- OBIMD subcharacter UID: `qlr2bgxwhf`
- OBIMD main character UID: `qlr2bgxwhf`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+FE9EA; U+FE9EB; 另有 2 项
