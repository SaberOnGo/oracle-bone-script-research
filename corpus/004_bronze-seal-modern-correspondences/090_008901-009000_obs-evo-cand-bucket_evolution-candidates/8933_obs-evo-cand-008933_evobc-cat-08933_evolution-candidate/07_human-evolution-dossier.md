...
- External category reference: `evobc-cat-08933`
- Source category ID: `08933`
- Source label for human review: `辿`
...
- `obs-evo-cand-008933-route-category-staging`
...
- `obs-evo-cand-008933-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008933-route-evolution-graph`
