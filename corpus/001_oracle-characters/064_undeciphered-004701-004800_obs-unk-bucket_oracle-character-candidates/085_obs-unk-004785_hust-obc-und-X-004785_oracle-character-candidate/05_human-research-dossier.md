# obs-unk-004785 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004785`
- primary external id: `hust-obc-und-X-004785`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/085_obs-unk-004785_h
  ust-obc-und-X-004785_oracle-character-candidate/03_visual-assets/001_asset
  -006378_hust-obc-und-X-004785_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/341/X_？_7323_1.png`
- asset id: `asset-006378`
...
- source class: `HUST-OBC/undeciphered/X/341/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/341/X_？_7323_1.png`
- asset id: `asset-006378`
...
- English observation: `three separated groups with long terminals`
- 中文观察: `三个分离结构和细长末端`
...
- Which source records identify obs-unk-004785 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004785？
