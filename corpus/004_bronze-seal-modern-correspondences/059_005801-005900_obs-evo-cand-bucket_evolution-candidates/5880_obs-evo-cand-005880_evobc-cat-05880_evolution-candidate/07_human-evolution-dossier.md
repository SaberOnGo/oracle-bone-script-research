...
Project ID: `obs-evo-cand-005880`
...
- Project ID: `obs-evo-cand-005880`
- EVOBC category candidate ID: `evobc-evo-cat-05880`
- External category reference: `evobc-cat-05880`
- Source category ID: `05880`
- Source label for human review: `矤`
- Source codepoints: `U+77E4`
...
- `obs-evo-cand-005880-route-category-staging`
...
- `obs-evo-cand-005880-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005880-route-evolution-graph`
