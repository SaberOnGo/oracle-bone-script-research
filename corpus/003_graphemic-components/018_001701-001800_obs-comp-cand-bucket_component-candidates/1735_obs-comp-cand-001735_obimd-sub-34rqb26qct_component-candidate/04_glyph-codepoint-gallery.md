# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001735
...
| --- | --- | --- | --- |
| `obimd-glyph-link-026865` | 󺅜 | `U+FA15C` | `reviewed_metadata_only` |
| `obimd-glyph-link-026866` | 󺅝 | `U+FA15D` | `reviewed_metadata_only` |
| `obimd-glyph-link-026867` | 󺅞 | `U+FA15E` | `reviewed_metadata_only` |
| `obimd-glyph-link-026868` | 󺅟 | `U+FA15F` | `reviewed_metadata_only` |
