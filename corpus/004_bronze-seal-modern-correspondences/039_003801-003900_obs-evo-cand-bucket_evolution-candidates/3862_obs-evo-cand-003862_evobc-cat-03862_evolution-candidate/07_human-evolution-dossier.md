...
Project ID: `obs-evo-cand-003862`
...
- Project ID: `obs-evo-cand-003862`
- EVOBC category candidate ID: `evobc-evo-cat-03862`
- External category reference: `evobc-cat-03862`
- Source category ID: `03862`
- Source label for human review: `朾`
- Source codepoints: `U+673E`
...
- `obs-evo-cand-003862-route-category-staging`
...
- `obs-evo-cand-003862-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003862-route-evolution-graph`
