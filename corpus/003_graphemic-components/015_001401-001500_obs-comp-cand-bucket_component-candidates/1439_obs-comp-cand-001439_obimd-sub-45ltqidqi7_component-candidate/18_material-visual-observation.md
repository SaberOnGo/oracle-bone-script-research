# Material Visual Observation / obs-comp-cand-001439 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001439`
- External reference / 外部参照: `obimd-sub-45ltqidqi7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016016_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0y6gjyc5xl/45ltqidqi7/45ltqidqi7.png`
- Checksum / 校验和:
  `4e724c5bbe8e26746a555abfee266afc2fd96be224302548292ee3413bf46181`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.26%.
- Marked-pixel bounds: (56,29)–(187,221); span 132 × 193 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.26%。
- 痕迹范围：(56,29)–(187,221)；跨度132 × 193 px；痕迹矩形高于宽。
