# obs-char-000250 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/250_obs-char-000250_hust-obc-cat-0278_orac
  le-character/03_visual-assets/001_asset-000255_hust-obc-cat-0278_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0278/G_0278_甲骨文0.png`
- asset id: `asset-000255`
...
- source category: `0278`
- validation class: `249`
- source image route: `HUST-OBC/deciphered/0278/G_0278_甲骨文0.png`
- asset id: `asset-000255`
...
- English observation: `Two separated dark clusters are visible: the left is
  a thin upright form with a short top branch, while the right is denser and
...
- dataset label text: `㔌`
- dataset label codepoints: `U+350C`
...
- Which source records identify obs-char-000250 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000250？
