# Material Visual Observation / obs-comp-cand-000268 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000268`
- External reference / 外部参照: `obimd-sub-vtvu5qmvvo`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011913_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ultq017ef8/vtvu5qmvvo/vtvu5qmvvo.png`
- Checksum / 校验和:
  `b5a8c398fab480c23d47d5311ef35cca6adef08d5a3781003d285fe052bf6454`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.74%.
- Marked-pixel bounds: (49,16)–(200,225); span 152 × 210 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.74%。
- 痕迹范围：(49,16)–(200,225)；跨度152 × 210 px；痕迹矩形高于宽。
