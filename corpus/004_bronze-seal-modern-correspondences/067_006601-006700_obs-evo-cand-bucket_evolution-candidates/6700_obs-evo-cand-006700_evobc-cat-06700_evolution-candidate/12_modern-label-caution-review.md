# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006700
...
- EVOBC candidate category: `evobc-evo-cat-06700`.
- Source label for search only: `繽`.
- Source codepoints for search only: `U+7E7D`.
