# obs-char-001322 Archaeology Paleography Review

# obs-char-001322 考古文字复核档案
...
- first local image: `001_asset-001327_hust-obc-cat-1478_glyph.png`
- first source image: `G_1478_京津3135(甲).png`
...
- source label text: `㦼`
- source label codepoints: `U+39BC`
