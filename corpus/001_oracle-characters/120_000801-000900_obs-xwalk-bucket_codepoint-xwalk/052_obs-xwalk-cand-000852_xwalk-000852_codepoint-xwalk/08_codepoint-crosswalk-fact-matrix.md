...
|---|---|---|
| Source Codepoint Route | `U+37B7` | not identity |
| HUST candidate route | `hust-obc-cat-0961` | not reading |
| OBIMD route | `obimd-main-cand-001869` | not component |
| EVOBC route | `evobc-evo-cat-00086` | not evolution |
