# obs-char-000728 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000728`
- primary external id: `hust-obc-cat-0829`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/728_obs-char-000728_hust-obc-cat-0829_orac
  le-character/03_visual-assets/001_asset-000733_hust-obc-cat-0829_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0829/G_0829_乙4309合6477賓組.png`
- asset id: `asset-000733`
...
- source category: `0829`
- validation class: `727`
- source image route: `HUST-OBC/deciphered/0829/G_0829_乙4309合6477賓組.png`
- asset id: `asset-000733`
...
- English observation: `A long central stem rises into three curved upper
  prongs, is crossed by two spreading diagonals near the middle, and
  continues as a tapered lower vertical.`
- 中文观察: `长中央干上端伸出三条弯曲支笔，中部附近被两条外展斜笔交叉，并延续为渐细下竖。`
...
- dataset label text: `㜳`
- dataset label codepoints: `U+3733`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00063`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00063`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00063`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/063_obs-evo-can
  d-000063_evobc-cat-00063_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/063_obs-evo-cand-000063_evobc-cat-00063_evolu
...
- Which source records identify obs-char-000728 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000728？
