# obs-unk-002588 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002588`
- primary external id: `hust-obc-und-L-002588`
...
- local review image route: `corpus/001_oracle-characters/042_undeciphered-002
  501-002600_obs-unk-bucket_oracle-character-candidates/088_obs-unk-002588_h
  ust-obc-und-L-002588_oracle-character-candidate/03_visual-assets/001_asset
  -004181_hust-obc-und-L-002588_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2588/L_？_3994.jpg`
- asset id: `asset-004181`
...
- source class: `HUST-OBC/undeciphered/L/2588/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2588/L_？_3994.jpg`
- asset id: `asset-004181`
...
- Which source records identify obs-unk-002588 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002588？
