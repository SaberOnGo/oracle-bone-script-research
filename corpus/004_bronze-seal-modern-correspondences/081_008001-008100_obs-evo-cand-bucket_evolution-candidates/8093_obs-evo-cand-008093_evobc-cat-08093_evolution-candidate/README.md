# obs-evo-cand-008093 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-008093`
- EVOBC category candidate ID: `evobc-evo-cat-08093`
- External category ref: `evobc-cat-08093`
- Source label: `角`
- Source codepoints: `U+89D2`
- Image reference count: `135`
- Era token counts: `BI:21;CS:1;OBC:69;SAC:3;SS:2;WSC:39`
- Source token counts: `Book:58;Web:77`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 69 image references
- era 1 / BI: 21 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 3 image references
- era 4 / WSC: 39 image references
...
- source 3 / Book:21681: 6 image references
