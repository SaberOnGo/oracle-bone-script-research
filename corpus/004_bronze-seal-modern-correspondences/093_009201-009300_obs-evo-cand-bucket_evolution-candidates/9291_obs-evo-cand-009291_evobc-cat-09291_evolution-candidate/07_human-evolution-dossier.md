...
Project ID: `obs-evo-cand-009291`
...
- Project ID: `obs-evo-cand-009291`
- EVOBC category candidate ID: `evobc-evo-cat-09291`
- External category reference: `evobc-cat-09291`
- Source category ID: `09291`
- Source label for human review: `釀`
- Source codepoints: `U+91C0`
...
- `obs-evo-cand-009291-route-category-staging`
...
- `obs-evo-cand-009291-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009291-route-evolution-graph`
