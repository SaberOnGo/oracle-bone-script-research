...
- External category reference: `evobc-cat-11276`
- Source category ID: `11276`
- Source label for human review: `𢣼`
- Source codepoints: `U+228FC`
...
- `obs-evo-cand-011276-route-category-staging`
...
- `obs-evo-cand-011276-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011276-route-evolution-graph`
