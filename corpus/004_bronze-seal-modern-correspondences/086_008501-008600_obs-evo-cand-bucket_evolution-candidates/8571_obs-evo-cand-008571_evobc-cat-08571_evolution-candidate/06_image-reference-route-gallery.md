...
- `obs-evo-cand-008571-route-category-staging`
...
- `obs-evo-cand-008571-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008571-route-evolution-graph`
