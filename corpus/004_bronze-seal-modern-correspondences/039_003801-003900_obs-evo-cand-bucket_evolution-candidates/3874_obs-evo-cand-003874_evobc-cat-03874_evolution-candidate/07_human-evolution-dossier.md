...
- External category reference: `evobc-cat-03874`
- Source category ID: `03874`
- Source label for human review: `杏`
- Source codepoints: `U+674F`
...
- `obs-evo-cand-003874-route-category-staging`
...
- `obs-evo-cand-003874-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003874-route-evolution-graph`
