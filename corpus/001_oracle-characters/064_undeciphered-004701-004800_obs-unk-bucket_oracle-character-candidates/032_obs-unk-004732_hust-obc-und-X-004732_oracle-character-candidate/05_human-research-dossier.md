# obs-unk-004732 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/032_obs-unk-004732_h
  ust-obc-und-X-004732_oracle-character-candidate/03_visual-assets/001_asset
  -006325_hust-obc-und-X-004732_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/288/X_？_7267_1.png`
- asset id: `asset-006325`
...
- source class: `HUST-OBC/undeciphered/X/288/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/288/X_？_7267_1.png`
- asset id: `asset-006325`
...
- English observation: `separate left and right branching groups`
- 中文观察: `分离的左右两组分支笔画`
...
- Which source records identify obs-unk-004732 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004732？
