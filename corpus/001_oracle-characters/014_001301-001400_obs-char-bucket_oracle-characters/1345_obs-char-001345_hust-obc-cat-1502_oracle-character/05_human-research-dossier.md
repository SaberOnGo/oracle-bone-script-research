# obs-char-001345 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001345`
- primary external id: `hust-obc-cat-1502`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1345_obs-char-001345_hust-obc-cat-1502_ora
  cle-character/03_visual-assets/001_asset-001350_hust-obc-cat-1502_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1502/G_1502_乙6277合7075賓組.png`
- asset id: `asset-001350`
...
- source category: `1502`
- validation class: `1344`
- source image route: `HUST-OBC/deciphered/1502/G_1502_乙6277合7075賓組.png`
- asset id: `asset-001350`
...
- English observation: `A small upright form has a short upper bar, a narrow
  rounded body, and a pointed lower end.`
- 中文观察: `小型直立形体有短上横笔、狭长圆拱主体和尖状下端。`
...
- dataset label text: `㧔`
- dataset label codepoints: `U+39D4`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00143`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00143`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00143`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/143_obs-evo-can
  d-000143_evobc-cat-00143_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/143_obs-evo-cand-000143_evobc-cat-00143_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合7075
  (G_1502_乙6277合7075賓組.png)`
...
- Which source records identify obs-char-001345 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001345？
