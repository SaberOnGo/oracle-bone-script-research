...
- `obs-evo-cand-001019-route-category-staging`
...
- `obs-evo-cand-001019-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001019-route-evolution-graph`
