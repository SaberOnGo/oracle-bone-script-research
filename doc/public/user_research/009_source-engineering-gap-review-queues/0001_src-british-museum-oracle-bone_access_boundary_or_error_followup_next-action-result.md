...
- First-wave result ID / 第一波结果 ID:
  - `source-engineering-first-wave-review-result-0001`
- Handoff item ID / 交接项 ID: `source-engineering-review-wave-handoff-0001`
- Next action ID / 下一动作 ID: `source-engineering-next-action-0001`
...
- Source URL / 来源 URL:
  - `https://www.britishmuseum.org/collection/object/A_OA-165`
- Authority tier / 来源层级: `museum_collection`
- Rights status / 权利状态: `metadata_only_until_verified`
- Risk note / 风险提示: Official museum collection record; image/licensing
  policies require object-level review.

## Metadata Result / 元数据结果

- Action lane / 动作线: `access_boundary_followup`
- Gap type / 缺口类型: `access_boundary_or_error_followup`
- Pipeline current stage / 流水线当前阶段: `discovered_access_boundary_or_error`
- Decision field / 决策字段: `access_outcome`
- Decision value / 决策值: `access_boundary_recorded_http_error_403`
