# obs-comp-cand-000734 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000734`
- 首选外部 ID: `obimd-sub-vvqlhyb7jr`
- OBIMD subcharacter UID: `vvqlhyb7jr`
- OBIMD main character UID: `vvqlhyb7jr`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `8`
- codepoint 示例: U+F42EB; U+F42EC; 另有 6 项
