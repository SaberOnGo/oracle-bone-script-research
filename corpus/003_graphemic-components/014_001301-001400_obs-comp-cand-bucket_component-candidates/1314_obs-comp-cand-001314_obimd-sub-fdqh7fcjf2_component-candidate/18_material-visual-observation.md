# Material Visual Observation / obs-comp-cand-001314 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001314`
- External reference / 外部参照: `obimd-sub-fdqh7fcjf2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015651_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fdqh7fcjf2/fdqh7fcjf2/fdqh7fcjf2.png`
- Checksum / 校验和:
  `650d607072bb1c2783715426b953687000f3eaad01ff6699aa7f8e78904b8c4c`
...
- Marked-pixel bounds: (90,19)–(179,228); span 90 × 210 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.70%。
- 痕迹范围：(90,19)–(179,228)；跨度90 × 210 px；痕迹矩形高于宽。
