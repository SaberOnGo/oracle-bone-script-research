# obs-unk-004920 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004920`
- primary external id: `hust-obc-und-X-004920`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/020_obs-unk-004920_h
  ust-obc-und-X-004920_oracle-character-candidate/03_visual-assets/001_asset
  -006513_hust-obc-und-X-004920_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/476/X_？_7461_1.png`
- asset id: `asset-006513`
...
- A branched upper group meets a lower large light opening.
...
- source class: `HUST-OBC/undeciphered/X/476/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/476/X_？_7461_1.png`
- asset id: `asset-006513`
...
- Which source records identify obs-unk-004920 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004920？
