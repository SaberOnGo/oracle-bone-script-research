...
- External category reference: `evobc-cat-11808`
- Source category ID: `11808`
- Source label for human review: `𥖠`
- Source codepoints: `U+255A0`
...
- `obs-evo-cand-011808-route-category-staging`
...
- `obs-evo-cand-011808-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011808-route-evolution-graph`
