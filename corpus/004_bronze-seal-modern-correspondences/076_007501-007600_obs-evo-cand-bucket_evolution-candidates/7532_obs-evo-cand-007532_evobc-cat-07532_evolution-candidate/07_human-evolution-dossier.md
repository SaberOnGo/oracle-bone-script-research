...
Project ID: `obs-evo-cand-007532`
...
- Project ID: `obs-evo-cand-007532`
- EVOBC category candidate ID: `evobc-evo-cat-07532`
- External category reference: `evobc-cat-07532`
- Source category ID: `07532`
- Source label for human review: `蓩`
- Source codepoints: `U+84E9`
...
- `obs-evo-cand-007532-route-category-staging`
...
- `obs-evo-cand-007532-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007532-route-evolution-graph`
