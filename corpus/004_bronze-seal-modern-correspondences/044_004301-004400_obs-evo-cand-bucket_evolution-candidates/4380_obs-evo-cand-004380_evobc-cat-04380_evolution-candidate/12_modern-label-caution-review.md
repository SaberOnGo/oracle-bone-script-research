# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004380
...
- EVOBC candidate category: `evobc-evo-cat-04380`.
- Source label for search only: `歛`.
- Source codepoints for search only: `U+6B5B`.
