...
Project ID: `obs-evo-cand-008840`
...
- Project ID: `obs-evo-cand-008840`
- EVOBC category candidate ID: `evobc-evo-cat-08840`
- External category reference: `evobc-cat-08840`
- Source category ID: `08840`
- Source label for human review: `輙`
- Source codepoints: `U+8F19`
...
- `obs-evo-cand-008840-route-category-staging`
...
- `obs-evo-cand-008840-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008840-route-evolution-graph`
