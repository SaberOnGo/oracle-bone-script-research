...
- External category reference: `evobc-cat-13174`
- Source category ID: `13174`
- Source label for human review: `𫿆`
- Source codepoints: `U+2BFC6`
...
- `obs-evo-cand-013174-route-category-staging`
...
- `obs-evo-cand-013174-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013174-route-evolution-graph`
