# obs-char-001571 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1571_obs-char-001571_hust-obc-cat-1763_ora
  cle-character/03_visual-assets/001_asset-001576_hust-obc-cat-1763_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1763/G_1763_河129(甲).png`
- asset id: `asset-001576`
...
- source category: `1763`
- validation class: `1570`
- source image route: `HUST-OBC/deciphered/1763/G_1763_河129(甲).png`
- asset id: `asset-001576`
...
- English observation: `Two stacked forms show an open rectangular upper
  contour and a broad pointed lower mark.`
...
- dataset label text: `㫙`
- dataset label codepoints: `U+3AD9`
...
- Which source records identify obs-char-001571 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001571？
