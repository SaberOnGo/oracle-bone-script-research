# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004630
...
- EVOBC candidate category: `evobc-evo-cat-04630`.
- Source label for search only: `津`.
- Source codepoints for search only: `U+6D25`.
