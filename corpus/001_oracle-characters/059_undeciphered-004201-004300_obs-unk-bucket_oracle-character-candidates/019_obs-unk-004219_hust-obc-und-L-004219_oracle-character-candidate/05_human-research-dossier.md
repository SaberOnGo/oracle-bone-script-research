# obs-unk-004219 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004219`
- primary external id: `hust-obc-und-L-004219`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/019_obs-unk-004219_h
  ust-obc-und-L-004219_oracle-character-candidate/03_visual-assets/001_asset
  -005812_hust-obc-und-L-004219_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4219/L_？_9225.jpg`
- asset id: `asset-005812`
...
- source class: `HUST-OBC/undeciphered/L/4219/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4219/L_？_9225.jpg`
- asset id: `asset-005812`
...
- English observation: `Upper rectangular outline and lower diagonal visible.`
- 中文观察: `上部方框轮廓和下部斜向痕迹可见。`
...
- Which source records identify obs-unk-004219 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004219？
