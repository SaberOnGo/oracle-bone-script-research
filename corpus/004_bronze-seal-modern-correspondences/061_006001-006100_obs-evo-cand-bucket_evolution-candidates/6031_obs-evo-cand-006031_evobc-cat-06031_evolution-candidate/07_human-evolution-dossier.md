...
- External category reference: `evobc-cat-06031`
- Source category ID: `06031`
- Source label for human review: `禦`
- Source codepoints: `U+79A6`
- Image reference count in source metadata: `125`
...
- `obs-evo-cand-006031-route-category-staging`
...
- `obs-evo-cand-006031-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006031-route-evolution-graph`
