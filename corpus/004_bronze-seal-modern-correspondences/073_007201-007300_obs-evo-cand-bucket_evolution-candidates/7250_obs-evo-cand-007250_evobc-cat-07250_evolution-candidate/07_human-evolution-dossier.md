...
- External category reference: `evobc-cat-07250`
- Source category ID: `07250`
- Source label: `芣`
...
- `obs-evo-cand-007250-route-category-staging`
...
- `obs-evo-cand-007250-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007250-route-evolution-graph`
