# obs-char-001129 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1129_obs-char-001129_hust-obc-cat-1260_ora
  cle-character/03_visual-assets/001_asset-001134_hust-obc-cat-1260_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1260/G_1260_佚199合32148歷組.png`
- asset id: `asset-001134`
...
- source category: `1260`
- validation class: `1128`
- source image route: `HUST-OBC/deciphered/1260/G_1260_佚199合32148歷組.png`
- asset id: `asset-001134`
...
- English observation: `A tall narrow rectangular enclosure is divided by
  horizontal bands and narrows into a pointed lower stem.`
- 中文观察: `高而狭长的矩形闭合轮廓被水平带分隔，并向下收束为尖状笔干。`
...
- dataset label text: `㣢`
- dataset label codepoints: `U+38E2`
...
- filename catalog route clues: `Heji-like filename clue: 合32148
  (G_1260_佚199合32148歷組.png)`
...
- Which source records identify obs-char-001129 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001129？
