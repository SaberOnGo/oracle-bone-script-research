# obs-unk-009207 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-009207`
- primary external id: `hust-obc-und-YH-009207`
...
- local review image route: `corpus/001_oracle-characters/109_undeciphered-009
  201-009300_obs-unk-bucket_oracle-character-candidates/007_obs-unk-009207_h
  ust-obc-und-YH-009207_oracle-character-candidate/03_visual-assets/001_asse
  t-010798_hust-obc-und-YH-009207_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6138C/H_？_6138C_0.png`
- asset id: `asset-010798`
...
- source class: `HUST-OBC/undeciphered/Y+H/6138C/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6138C/H_？_6138C_0.png`
- asset id: `asset-010798`
...
- Which source records identify obs-unk-009207 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009207？
