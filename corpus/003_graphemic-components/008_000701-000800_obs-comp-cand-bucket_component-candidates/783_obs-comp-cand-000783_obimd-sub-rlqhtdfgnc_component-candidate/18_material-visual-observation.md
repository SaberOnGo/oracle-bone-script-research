# Material Visual Observation / obs-comp-cand-000783 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000783`
- External reference / 外部参照: `obimd-sub-rlqhtdfgnc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013545_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/llttpz4l8h/rlqhtdfgnc/rlqhtdfgnc.png`
- Checksum / 校验和:
  `d4aed5d0acf6c4bc477bc70e7dabe604c71a33b6a858323be6eaf4be4b6e3a3c`
...
- Marked-pixel bounds: (63,23)–(185,229); span 123 × 207 px; the marked
...
- 痕迹范围：(63,23)–(185,229)；跨度123 × 207 px；痕迹矩形高于宽。
