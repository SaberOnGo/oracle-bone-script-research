...
- External category reference: `evobc-cat-10402`
- Source category ID: `10402`
- Source label for human review: `鮭`
- Source codepoints: `U+9BAD`
...
- `obs-evo-cand-010402-route-category-staging`
...
- `obs-evo-cand-010402-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010402-route-evolution-graph`
