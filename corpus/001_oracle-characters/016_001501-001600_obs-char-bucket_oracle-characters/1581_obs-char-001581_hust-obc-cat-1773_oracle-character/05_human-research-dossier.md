# obs-char-001581 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001581`
- primary external id: `hust-obc-cat-1773`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1581_obs-char-001581_hust-obc-cat-1773_ora
  cle-character/03_visual-assets/001_asset-001586_hust-obc-cat-1773_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1773/G_1773_佚895(甲).png`
- asset id: `asset-001586`
...
- source category: `1773`
- validation class: `1580`
- source image route: `HUST-OBC/deciphered/1773/G_1773_佚895(甲).png`
- asset id: `asset-001586`
...
- English observation: `A dense composite combines an upper loop, branching
  right strokes, and a lower enclosed contour.`
- 中文观察: `密集组合形体结合上部环形、右侧分枝笔画和下部框状轮廓。`
...
- dataset label text: `㫣`
- dataset label codepoints: `U+3AE3`
...
- Which source records identify obs-char-001581 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001581？
