# obs-char-000116 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/116_obs-char-000116_hust-obc-cat-0130_orac
  le-character/03_visual-assets/001_asset-000121_hust-obc-cat-0130_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0130/G_0130_乙2100合6485賓組.png`
- asset id: `asset-000121`
...
- source category: `0130`
- validation class: `115`
- source image route: `HUST-OBC/deciphered/0130/G_0130_乙2100合6485賓組.png`
- asset id: `asset-000121`
...
- English observation: `The image has a branching upper junction, a long
  central descending stroke, and several short detached curved marks on both
  sides.`
...
- dataset label text: `㑸`
- dataset label codepoints: `U+3478`
...
- Which source records identify obs-char-000116 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000116？
