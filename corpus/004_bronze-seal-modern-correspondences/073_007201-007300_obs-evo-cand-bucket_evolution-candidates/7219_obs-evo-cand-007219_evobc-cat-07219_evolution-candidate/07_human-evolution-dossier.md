...
- External category reference: `evobc-cat-07219`
- Source category ID: `07219`
- Source label: `艴`
...
- `obs-evo-cand-007219-route-category-staging`
...
- `obs-evo-cand-007219-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007219-route-evolution-graph`
