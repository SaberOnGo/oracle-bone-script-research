# Material Visual Observation / obs-comp-cand-000669 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000669`
- External reference / 外部参照: `obimd-sub-dmt62prazn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013232_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dmt62prazn/dmt62prazn/dmt62prazn.png`
- Checksum / 校验和:
  `b73d8dffd42398c7839f4698abda01c7216dd6df97ef06a42fe6a781373f08dc`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.68%.
- Marked-pixel bounds: (63,25)–(204,221); span 142 × 197 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.68%。
- 痕迹范围：(63,25)–(204,221)；跨度142 × 197 px；痕迹矩形高于宽。
