...
- Project ID: `obs-evo-cand-004731`
- EVOBC category candidate ID: `evobc-evo-cat-04731`
- External category reference: `evobc-cat-04731`
- Source category ID: `04731`
- Source label for human review: `淪`
- Source codepoints: `U+6DEA`
...
- `obs-evo-cand-004731-route-category-staging`
...
- `obs-evo-cand-004731-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004731-route-evolution-graph`
