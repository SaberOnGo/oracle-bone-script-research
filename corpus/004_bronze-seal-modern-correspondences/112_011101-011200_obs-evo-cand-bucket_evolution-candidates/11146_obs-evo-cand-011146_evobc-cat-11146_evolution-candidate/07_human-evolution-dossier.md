...
- Project ID: `obs-evo-cand-011146`
- EVOBC category candidate ID: `evobc-evo-cat-11146`
- External category reference: `evobc-cat-11146`
- Source category ID: `11146`
- Source label for human review: `𢅜`
- Source codepoints: `U+2215C`
- Image reference count in source metadata: `19`
...
- `obs-evo-cand-011146-route-category-staging`
...
- `obs-evo-cand-011146-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011146-route-evolution-graph`
