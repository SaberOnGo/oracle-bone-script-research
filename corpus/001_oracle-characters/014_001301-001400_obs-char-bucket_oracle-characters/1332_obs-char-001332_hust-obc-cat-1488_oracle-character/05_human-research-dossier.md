# obs-char-001332 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1332_obs-char-001332_hust-obc-cat-1488_ora
  cle-character/03_visual-assets/001_asset-001337_hust-obc-cat-1488_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1488/H_1488_60456_0.png`
- asset id: `asset-001337`
...
- source category: `1488`
- validation class: `1331`
- source image route: `HUST-OBC/deciphered/1488/H_1488_60456_0.png`
- asset id: `asset-001337`
...
- English observation: `A large dark form has a peaked upper enclosure, a
  central crossing, lower side curves, and a long stem.`
- 中文观察: `大型深色形体有尖顶上部框形、中央交叉笔、下部侧弧和长中央笔干。`
...
- dataset label text: `㧆`
- dataset label codepoints: `U+39C6`
...
- filename catalog route clues: `catalog-like filename clue: H_1488
  (H_1488_60456_0.png)`
...
- Which source records identify obs-char-001332 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001332？
