...
Project ID: `obs-evo-cand-011606`
...
- Project ID: `obs-evo-cand-011606`
- EVOBC category candidate ID: `evobc-evo-cat-11606`
- External category reference: `evobc-cat-11606`
- Source category ID: `11606`
- Source label for human review: `𤜩`
- Source codepoints: `U+24729`
...
- `obs-evo-cand-011606-route-category-staging`
...
- `obs-evo-cand-011606-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011606-route-evolution-graph`
