...
- Yingguo / 英国所藏: `y2636` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `391` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `581` in source row; primary catalog entry pending
- Heji / 合集: `41949` in source row; primary catalog entry pending
