...
- External category reference: `evobc-cat-00154`
- Source category ID: `00154`
- Source label for human review: `㫃`
- Source codepoints: `U+3AC3`
...
- `obs-evo-cand-000154-route-category-staging`
...
- `obs-evo-cand-000154-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000154-route-evolution-graph`
