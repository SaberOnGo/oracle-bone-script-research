...
- External category reference: `evobc-cat-08281`
- Source category ID: `08281`
- Source label: `諥`
...
- `obs-evo-cand-008281-route-category-staging`
...
- `obs-evo-cand-008281-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008281-route-evolution-graph`
