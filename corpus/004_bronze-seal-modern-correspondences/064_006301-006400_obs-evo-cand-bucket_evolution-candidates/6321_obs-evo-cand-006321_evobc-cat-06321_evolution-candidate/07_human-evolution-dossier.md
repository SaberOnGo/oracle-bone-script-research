...
- External category reference: `evobc-cat-06321`
- Source category ID: `06321`
- Source label for human review: `篝`
- Source codepoints: `U+7BDD`
...
- `obs-evo-cand-006321-route-category-staging`
...
- `obs-evo-cand-006321-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006321-route-evolution-graph`
