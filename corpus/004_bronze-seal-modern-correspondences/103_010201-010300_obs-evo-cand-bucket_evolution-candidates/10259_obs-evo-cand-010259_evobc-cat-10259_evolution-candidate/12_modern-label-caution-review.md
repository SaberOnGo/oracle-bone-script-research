# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010259
...
- EVOBC candidate category: `evobc-evo-cat-10259`.
- Source label for search only: `驛`.
- Source codepoints for search only: `U+9A5B`.
