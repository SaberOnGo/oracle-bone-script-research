# Material Visual Observation / obs-comp-cand-000530 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000530`
- External reference / 外部参照: `obimd-sub-e5v2cd930z`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012764_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/e5v2cd930z/e5v2cd930z/e5v2cd930z.png`
- Checksum / 校验和:
  `f2af7af22b0c8ea19f1283f49fea66ffc1ef9ad66e3f0dc7653bf536062f873c`
...
- Marked-pixel bounds: (61,43)–(188,205); span 128 × 163 px; the marked
...
- 痕迹范围：(61,43)–(188,205)；跨度128 × 163 px；痕迹矩形高于宽。
