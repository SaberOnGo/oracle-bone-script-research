...
- External category reference: `evobc-cat-00980`
- Source category ID: `00980`
- Source label for human review: `傎`
- Source codepoints: `U+508E`
...
- `obs-evo-cand-000980-route-category-staging`
...
- `obs-evo-cand-000980-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000980-route-evolution-graph`
