# Material Visual Observation / obs-comp-cand-000759 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000759`
- External reference / 外部参照: `obimd-sub-rxp0h9qzt7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013523_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7nw813njs0/rxp0h9qzt7/rxp0h9qzt7.png`
- Checksum / 校验和:
  `f3883d28164ac3e1d94f609a69959acc14776148e348298181068cfe90807806`
...
- Marked-pixel bounds: (56,34)–(193,223); span 138 × 190 px; the marked
...
- 痕迹范围：(56,34)–(193,223)；跨度138 × 190 px；痕迹矩形高于宽。
