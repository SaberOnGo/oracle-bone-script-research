...
- External category reference: `evobc-cat-01171`
- Source category ID: `01171`
- Source label for human review: `击`
- Source codepoints: `U+51FB`
...
- `obs-evo-cand-001171-route-category-staging`
...
- `obs-evo-cand-001171-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001171-route-evolution-graph`
