# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008183
...
- EVOBC candidate category: `evobc-evo-cat-08183`.
- Source label for search only: `詞`.
- Source codepoints for search only: `U+8A5E`.
