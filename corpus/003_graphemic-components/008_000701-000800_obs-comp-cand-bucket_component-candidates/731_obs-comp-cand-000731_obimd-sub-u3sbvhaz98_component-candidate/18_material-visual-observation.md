# Material Visual Observation / obs-comp-cand-000731 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000731`
- External reference / 外部参照: `obimd-sub-u3sbvhaz98`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013458_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0fjs8401bp/u3sbvhaz98/u3sbvhaz98.png`
- Checksum / 校验和:
  `43c394f1ec4a6d1df2290c4a8d0bc50c61fc05671347849f223e364501833f12`
...
- Marked-pixel bounds: (72,20)–(169,232); span 98 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.69%。
- 痕迹范围：(72,20)–(169,232)；跨度98 × 213 px；痕迹矩形高于宽。
