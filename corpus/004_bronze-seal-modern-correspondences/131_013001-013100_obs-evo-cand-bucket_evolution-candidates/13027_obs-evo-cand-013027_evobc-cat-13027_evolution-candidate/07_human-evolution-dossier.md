...
- External category reference: `evobc-cat-13027`
- Source category ID: `13027`
- Source label for human review: `𫧈`
- Source codepoints: `U+2B9C8`
...
- `obs-evo-cand-013027-route-category-staging`
...
- `obs-evo-cand-013027-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013027-route-evolution-graph`
