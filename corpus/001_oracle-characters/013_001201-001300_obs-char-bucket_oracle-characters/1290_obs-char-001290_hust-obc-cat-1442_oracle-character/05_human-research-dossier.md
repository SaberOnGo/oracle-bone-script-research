# obs-char-001290 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1290_obs-char-001290_hust-obc-cat-1442_ora
  cle-character/03_visual-assets/001_asset-001295_hust-obc-cat-1442_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1442/G_1442_乙3477反合1822反賓組.png`
- asset id: `asset-001295`
...
- source category: `1442`
- validation class: `1289`
- source image route: `HUST-OBC/deciphered/1442/G_1442_乙3477反合1822反賓組.png`
- asset id: `asset-001295`
...
- English observation: `A rectangular middle enclosure is flanked by long
  outer verticals and contains short inner cross-strokes.`
...
- dataset label text: `㦘`
- dataset label codepoints: `U+3998`
...
- filename catalog route clues: `Heji-like filename clue: 合1822
...
- Which source records identify obs-char-001290 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001290？
