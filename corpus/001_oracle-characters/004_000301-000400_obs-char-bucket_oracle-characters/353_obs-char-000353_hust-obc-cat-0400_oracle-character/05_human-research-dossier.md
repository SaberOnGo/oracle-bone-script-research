# obs-char-000353 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000353`
- primary external id: `hust-obc-cat-0400`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/353_obs-char-000353_hust-obc-cat-0400_orac
  le-character/03_visual-assets/001_asset-000358_hust-obc-cat-0400_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0400/G_0400_乙2331合9507賓組.png`
- asset id: `asset-000358`
...
- source category: `0400`
- validation class: `352`
- source image route: `HUST-OBC/deciphered/0400/G_0400_乙2331合9507賓組.png`
- asset id: `asset-000358`
...
- English observation: `The narrow image has a slanting branched upper
  stroke, a curved lower stroke, and a short left-side projection.`
- 中文观察: `狭长图像上方有斜向分叉笔画，下方有弧形笔画，左侧有短向外伸出。`
...
- dataset label text: `㖆`
- dataset label codepoints: `U+3586`
...
- filename catalog route clues: `Heji-like filename clue: 合9507
  (G_0400_乙2331合9507賓組.png)`
...
- Which source records identify obs-char-000353 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000353？
