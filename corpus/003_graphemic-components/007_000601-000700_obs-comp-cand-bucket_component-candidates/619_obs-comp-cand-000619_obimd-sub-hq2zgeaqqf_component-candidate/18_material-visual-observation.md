# Material Visual Observation / obs-comp-cand-000619 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000619`
- External reference / 外部参照: `obimd-sub-hq2zgeaqqf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013182_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hq2zgeaqqf/hq2zgeaqqf/hq2zgeaqqf.png`
- Checksum / 校验和:
  `c86b911db653bfc5eee047a98df977a14f40aade2ed459000ac2379f374e5a2d`
...
- Marked-pixel bounds: (42,29)–(218,215); span 177 × 187 px; the marked
...
- 痕迹范围：(42,29)–(218,215)；跨度177 × 187 px；痕迹矩形近方形。
