# obs-char-000089 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/089_obs-char-000089_hust-obc-cat-0099_orac
  le-character/03_visual-assets/001_asset-000094_hust-obc-cat-0099_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0099/G_0099_乙8688合35501黃組.png`
- asset id: `asset-000094`
...
- source category: `0099`
- validation class: `88`
- source image route: `HUST-OBC/deciphered/0099/G_0099_乙8688合35501黃組.png`
- asset id: `asset-000094`
...
- English observation: `The compact image has a central vertical stroke,
  short horizontal strokes at several levels, and small side projections.`
- 中文观察: `小型图像有中央竖笔，在不同高度分布短横笔，并有小幅向两侧伸出。`
...
- dataset label text: `㑙`
- dataset label codepoints: `U+3459`
...
- Which source records identify obs-char-000089 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000089？
