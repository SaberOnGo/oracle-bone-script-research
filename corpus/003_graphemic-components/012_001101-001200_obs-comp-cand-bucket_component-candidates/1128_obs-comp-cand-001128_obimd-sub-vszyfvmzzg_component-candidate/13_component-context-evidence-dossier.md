# obs-comp-cand-001128 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001128`
- 首选外部 ID: `obimd-sub-vszyfvmzzg`
- OBIMD subcharacter UID: `vszyfvmzzg`
- OBIMD main character UID: `vszyfvmzzg`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+A71D4;U+F6789; U+F678A
