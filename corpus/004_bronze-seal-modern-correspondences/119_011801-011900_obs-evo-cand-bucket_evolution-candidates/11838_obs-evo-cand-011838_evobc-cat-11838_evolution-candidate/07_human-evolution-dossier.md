...
- External category reference: `evobc-cat-11838`
- Source category ID: `11838`
- Source label for human review: `𥞥`
- Source codepoints: `U+257A5`
...
- `obs-evo-cand-011838-route-category-staging`
...
- `obs-evo-cand-011838-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011838-route-evolution-graph`
