...
Project ID: `obs-evo-cand-004764`
...
- Project ID: `obs-evo-cand-004764`
- EVOBC category candidate ID: `evobc-evo-cat-04764`
- External category reference: `evobc-cat-04764`
- Source category ID: `04764`
- Source label for human review: `測`
- Source codepoints: `U+6E2C`
...
- `obs-evo-cand-004764-route-category-staging`
...
- `obs-evo-cand-004764-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004764-route-evolution-graph`
