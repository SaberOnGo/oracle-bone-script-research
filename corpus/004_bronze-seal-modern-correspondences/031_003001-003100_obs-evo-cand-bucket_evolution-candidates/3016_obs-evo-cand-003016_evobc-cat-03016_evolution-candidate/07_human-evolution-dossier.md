...
Project ID: `obs-evo-cand-003016`
...
- Project ID: `obs-evo-cand-003016`
- EVOBC category candidate ID: `evobc-evo-cat-03016`
- External category reference: `evobc-cat-03016`
- Source category ID: `03016`
- Source label for human review: `悟`
- Source codepoints: `U+609F`
...
- `obs-evo-cand-003016-route-category-staging`
...
- `obs-evo-cand-003016-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003016-route-evolution-graph`
