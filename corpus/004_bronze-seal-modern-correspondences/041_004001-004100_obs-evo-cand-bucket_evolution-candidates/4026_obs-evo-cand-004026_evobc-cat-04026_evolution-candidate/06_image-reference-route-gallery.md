...
- `obs-evo-cand-004026-route-category-staging`
...
- `obs-evo-cand-004026-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004026-route-evolution-graph`
