# Material Visual Observation / obs-comp-cand-000091 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000091`
- External reference / 外部参照: `obimd-sub-zssbtvgekq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011503_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/e1wrdxp259/zssbtvgekq/zssbtvgekq.png`
- Checksum / 校验和:
  `10fd5b50f5370b071d3fa6d6f1ffce610d69a4027015a0b0fa3aa37d0caffc13`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.23%.
- Marked-pixel bounds: (40,42)–(209,213); span 170 × 172 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.23%。
- 痕迹范围：(40,42)–(209,213)；跨度170 × 172 px；痕迹矩形近方形。
