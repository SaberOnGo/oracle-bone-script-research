...
- Project ID: `obs-evo-cand-003491`
- EVOBC category candidate ID: `evobc-evo-cat-03491`
- External category reference: `evobc-cat-03491`
- Source category ID: `03491`
- Source label for human review: `摽`
- Source codepoints: `U+647D`
...
- `obs-evo-cand-003491-route-category-staging`
...
- `obs-evo-cand-003491-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003491-route-evolution-graph`
