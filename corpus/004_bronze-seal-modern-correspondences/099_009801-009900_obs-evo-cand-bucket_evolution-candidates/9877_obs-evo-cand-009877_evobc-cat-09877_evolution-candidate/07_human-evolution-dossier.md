...
- External category reference: `evobc-cat-09877`
- Source category ID: `09877`
- Source label for human review: `靁`
...
- `obs-evo-cand-009877-route-category-staging`
...
- `obs-evo-cand-009877-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009877-route-evolution-graph`
