...
- Project ID: `obs-evo-cand-007953`
- EVOBC category candidate ID: `evobc-evo-cat-07953`
- External category reference: `evobc-cat-07953`
- Source category ID: `07953`
- Source label for human review: `袤`
- Source codepoints: `U+88A4`
...
- `obs-evo-cand-007953-route-category-staging`
...
- `obs-evo-cand-007953-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007953-route-evolution-graph`
