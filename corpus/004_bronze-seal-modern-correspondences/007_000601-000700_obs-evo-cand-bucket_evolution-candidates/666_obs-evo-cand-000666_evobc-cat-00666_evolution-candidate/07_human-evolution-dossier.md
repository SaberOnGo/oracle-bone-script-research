...
Project ID: `obs-evo-cand-000666`
...
- Project ID: `obs-evo-cand-000666`
- EVOBC category candidate ID: `evobc-evo-cat-00666`
- External category reference: `evobc-cat-00666`
- Source category ID: `00666`
- Source label for human review: `乙`
- Source codepoints: `U+4E59`
...
- `obs-evo-cand-000666-route-category-staging`
...
- `obs-evo-cand-000666-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000666-route-evolution-graph`
