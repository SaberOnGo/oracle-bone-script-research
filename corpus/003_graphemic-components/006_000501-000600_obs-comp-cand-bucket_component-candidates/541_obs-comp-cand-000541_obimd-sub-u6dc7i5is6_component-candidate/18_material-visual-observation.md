# Material Visual Observation / obs-comp-cand-000541 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000541`
- External reference / 外部参照: `obimd-sub-u6dc7i5is6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012775_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/u6dc7i5is6/u6dc7i5is6/u6dc7i5is6.png`
- Checksum / 校验和:
  `a5346ac38c7f50a76c00219a89fedb7c6578d2da7b77669d5258e63bd68e43ee`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.86%.
- Marked-pixel bounds: (77,46)–(172,203); span 96 × 158 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.86%。
- 痕迹范围：(77,46)–(172,203)；跨度96 × 158 px；痕迹矩形高于宽。
