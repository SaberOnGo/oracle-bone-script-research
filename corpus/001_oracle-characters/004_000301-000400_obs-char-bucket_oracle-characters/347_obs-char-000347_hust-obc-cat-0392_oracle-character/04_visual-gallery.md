# obs-char-000347 Visual Gallery / obs-char-000347 图像资料页
...
- Project ID / 项目 ID: `obs-char-000347`
- Primary external reference / 首选外部参考: `hust-obc-cat-0392`
...
## obs-char-000347-visual-source-001 / 图像条目

![obs-char-000347 glyph candidate](03_visual-assets/001_asset-000352_hust-obc-cat-0392_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000352_hust-obc-cat-0392_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000352_hust-obc-cat-0392_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/0392/G_0392_乙6776(甲).png`
