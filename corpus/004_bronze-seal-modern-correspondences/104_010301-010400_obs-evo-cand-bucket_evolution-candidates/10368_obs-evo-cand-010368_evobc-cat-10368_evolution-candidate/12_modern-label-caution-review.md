# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010368
...
- EVOBC candidate category: `evobc-evo-cat-10368`.
- Source label for search only: `魝`.
- Source codepoints for search only: `U+9B5D`.
