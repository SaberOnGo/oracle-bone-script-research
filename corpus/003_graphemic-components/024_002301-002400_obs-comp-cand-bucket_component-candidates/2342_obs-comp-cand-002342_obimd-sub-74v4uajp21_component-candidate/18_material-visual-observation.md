# Material Visual Observation / obs-comp-cand-002342 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002342`
- External reference / 外部参照: `obimd-sub-74v4uajp21`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020413_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4jn67lbqhb/74v4uajp21/74v4uajp21.png`
- Checksum / 校验和:
  `a23d8baf0e1d531852529e8f1205a73f9e7d539e368cf541ef3abf11fc47d3d8`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.69%.
- Marked-pixel bounds: (78,37)–(171,206); span 94 × 170 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.69%。
- 痕迹范围：(78,37)–(171,206)；跨度94 × 170 px；痕迹矩形高于宽。
