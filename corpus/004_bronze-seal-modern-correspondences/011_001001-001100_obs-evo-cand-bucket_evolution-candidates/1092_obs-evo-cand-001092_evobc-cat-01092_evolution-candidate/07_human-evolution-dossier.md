...
- External category reference: `evobc-cat-01092`
- Source category ID: `01092`
- Source label: `公`
- Source codepoints: `U+516C`
- Image reference count in source metadata: `337`
...
- `obs-evo-cand-001092-route-category-staging`
...
- `obs-evo-cand-001092-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001092-route-evolution-graph`
