# obs-char-000257 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000257`
- primary external id: `hust-obc-cat-0289`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/257_obs-char-000257_hust-obc-cat-0289_orac
  le-character/03_visual-assets/001_asset-000262_hust-obc-cat-0289_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0289/G_0289_乙6700合6484賓組.png`
- asset id: `asset-000262`
...
- source category: `0289`
- validation class: `256`
- source image route: `HUST-OBC/deciphered/0289/G_0289_乙6700合6484賓組.png`
- asset id: `asset-000262`
...
- English observation: `Two long angled strokes open upward from a small
  lower junction; a short branch projects toward the right side.`
- 中文观察: `两道长斜笔从下部小连接处向上张开，右侧有一道短分支外伸。`
...
- dataset label text: `㔗`
- dataset label codepoints: `U+3517`
...
- filename catalog route clues: `Heji-like filename clue: 合6484
  (G_0289_乙6700合6484賓組.png)`
...
- Which source records identify obs-char-000257 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000257？
