...
- External category reference: `evobc-cat-10226`
- Source category ID: `10226`
- Source label for human review: `騥`
...
- `obs-evo-cand-010226-route-category-staging`
...
- `obs-evo-cand-010226-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010226-route-evolution-graph`
