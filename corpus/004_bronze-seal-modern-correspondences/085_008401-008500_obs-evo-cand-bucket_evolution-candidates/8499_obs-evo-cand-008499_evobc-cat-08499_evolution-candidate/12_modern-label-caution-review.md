# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008499
...
- EVOBC candidate category: `evobc-evo-cat-08499`.
- Source label for search only: `豪`.
- Source codepoints for search only: `U+8C6A`.
