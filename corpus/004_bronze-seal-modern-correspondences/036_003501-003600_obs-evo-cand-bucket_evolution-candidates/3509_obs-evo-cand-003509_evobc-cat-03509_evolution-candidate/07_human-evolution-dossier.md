...
- Project ID: `obs-evo-cand-003509`
- EVOBC category candidate ID: `evobc-evo-cat-03509`
- External category reference: `evobc-cat-03509`
- Source category ID: `03509`
- Source label for human review: `撲`
- Source codepoints: `U+64B2`
...
- `obs-evo-cand-003509-route-category-staging`
...
- `obs-evo-cand-003509-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003509-route-evolution-graph`
