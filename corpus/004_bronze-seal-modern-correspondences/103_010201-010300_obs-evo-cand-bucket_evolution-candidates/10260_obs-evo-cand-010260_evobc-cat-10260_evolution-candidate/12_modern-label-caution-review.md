# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010260
...
- EVOBC candidate category: `evobc-evo-cat-10260`.
- Source label for search only: `驟`.
- Source codepoints for search only: `U+9A5F`.
