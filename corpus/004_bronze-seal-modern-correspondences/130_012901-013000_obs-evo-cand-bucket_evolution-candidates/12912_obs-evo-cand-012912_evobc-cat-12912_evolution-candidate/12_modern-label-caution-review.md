# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012912
...
- EVOBC candidate category: `evobc-evo-cat-12912`.
- Source label for search only: `𫂷`.
- Source codepoints for search only: `U+2B0B7`.
