...
Project ID: `obs-evo-cand-003612`
...
- Project ID: `obs-evo-cand-003612`
- EVOBC category candidate ID: `evobc-evo-cat-03612`
- External category reference: `evobc-cat-03612`
- Source category ID: `03612`
- Source label for human review: `敹`
- Source codepoints: `U+6579`
...
- `obs-evo-cand-003612-route-category-staging`
...
- `obs-evo-cand-003612-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003612-route-evolution-graph`
