...
- External category reference: `evobc-cat-08056`
- Source category ID: `08056`
- Source label for human review: `規`
- Source codepoints: `U+898F`
...
- `obs-evo-cand-008056-route-category-staging`
...
- `obs-evo-cand-008056-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008056-route-evolution-graph`
