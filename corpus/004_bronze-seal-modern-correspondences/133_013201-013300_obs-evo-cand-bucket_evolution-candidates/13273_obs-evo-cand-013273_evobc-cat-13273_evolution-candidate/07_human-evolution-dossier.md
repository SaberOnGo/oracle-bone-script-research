...
Project ID: `obs-evo-cand-013273`
...
- Project ID: `obs-evo-cand-013273`
- EVOBC category candidate ID: `evobc-evo-cat-13273`
- External category reference: `evobc-cat-13273`
- Source category ID: `13273`
- Source label for human review: `𬓶`
- Source codepoints: `U+2C4F6`
- Image reference count in source metadata: `22`
...
- `obs-evo-cand-013273-route-category-staging`
...
- `obs-evo-cand-013273-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013273-route-evolution-graph`
