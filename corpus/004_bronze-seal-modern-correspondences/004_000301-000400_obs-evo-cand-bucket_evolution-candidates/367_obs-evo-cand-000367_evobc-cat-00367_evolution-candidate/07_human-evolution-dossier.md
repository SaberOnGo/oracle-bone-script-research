...
Project ID: `obs-evo-cand-000367`
...
- Project ID: `obs-evo-cand-000367`
- EVOBC category candidate ID: `evobc-evo-cat-00367`
- External category reference: `evobc-cat-00367`
- Source category ID: `00367`
- Source label for human review: `䑂`
- Source codepoints: `U+4442`
...
- `obs-evo-cand-000367-route-category-staging`
...
- `obs-evo-cand-000367-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000367-route-evolution-graph`
