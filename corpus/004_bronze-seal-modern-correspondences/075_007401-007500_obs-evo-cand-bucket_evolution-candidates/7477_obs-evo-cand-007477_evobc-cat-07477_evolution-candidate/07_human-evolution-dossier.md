...
- External category reference: `evobc-cat-07477`
- Source category ID: `07477`
- Source label for human review: `葦`
...
- `obs-evo-cand-007477-route-category-staging`
...
- `obs-evo-cand-007477-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007477-route-evolution-graph`
