...
- External category reference: `evobc-cat-02751`
- Source category ID: `02751`
...
- `obs-evo-cand-002751-route-category-staging`
...
- `obs-evo-cand-002751-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002751-route-evolution-graph`
