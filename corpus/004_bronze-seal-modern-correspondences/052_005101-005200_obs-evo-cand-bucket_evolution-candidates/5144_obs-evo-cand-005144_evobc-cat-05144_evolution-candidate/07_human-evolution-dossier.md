...
Project ID: `obs-evo-cand-005144`
...
- Project ID: `obs-evo-cand-005144`
- EVOBC category candidate ID: `evobc-evo-cat-05144`
- External category reference: `evobc-cat-05144`
- Source category ID: `05144`
- Source label for human review: `燃`
- Source codepoints: `U+71C3`
...
- `obs-evo-cand-005144-route-category-staging`
...
- `obs-evo-cand-005144-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005144-route-evolution-graph`
