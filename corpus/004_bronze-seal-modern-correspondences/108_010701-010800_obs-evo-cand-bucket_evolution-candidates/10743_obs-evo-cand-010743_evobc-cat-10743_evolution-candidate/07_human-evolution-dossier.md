...
- External category reference: `evobc-cat-10743`
- Source category ID: `10743`
- Source label for human review: `齿`
- Source codepoints: `U+9F7F`
...
- `obs-evo-cand-010743-route-category-staging`
...
- `obs-evo-cand-010743-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010743-route-evolution-graph`
