...
- External category reference: `evobc-cat-06838`
- Source category ID: `06838`
- Source label for human review: `羌`
- Source codepoints: `U+7F8C`
- Image reference count in source metadata: `244`
...
- `obs-evo-cand-006838-route-category-staging`
...
- `obs-evo-cand-006838-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006838-route-evolution-graph`
