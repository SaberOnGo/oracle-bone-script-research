# obs-char-000921 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000921`
- primary external id: `hust-obc-cat-1038`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/921_obs-char-000921_hust-obc-cat-1038_orac
  le-character/03_visual-assets/001_asset-000926_hust-obc-cat-1038_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1038/G_1038_乙1049(甲).png`
- asset id: `asset-000926`
...
- source category: `1038`
- validation class: `920`
- source image route: `HUST-OBC/deciphered/1038/G_1038_乙1049(甲).png`
- asset id: `asset-000926`
...
- English observation: `A narrow vertical form combines an upper crossing, a
  central angular enclosure, detached side marks, and lower branching
  strokes.`
- 中文观察: `狭长竖向形体结合上部交叉、中央折角轮廓、分离侧痕迹和下部分枝笔。`
...
- dataset label text: `㠄`
- dataset label codepoints: `U+3804`
...
- Which source records identify obs-char-000921 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000921？
