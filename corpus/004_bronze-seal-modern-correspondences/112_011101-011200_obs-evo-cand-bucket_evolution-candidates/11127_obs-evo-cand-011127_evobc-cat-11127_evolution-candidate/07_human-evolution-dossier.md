...
Project ID: `obs-evo-cand-011127`
...
- Project ID: `obs-evo-cand-011127`
- EVOBC category candidate ID: `evobc-evo-cat-11127`
- External category reference: `evobc-cat-11127`
- Source category ID: `11127`
- Source label for human review: `𡽬`
- Source codepoints: `U+21F6C`
...
- `obs-evo-cand-011127-route-category-staging`
...
- `obs-evo-cand-011127-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011127-route-evolution-graph`
