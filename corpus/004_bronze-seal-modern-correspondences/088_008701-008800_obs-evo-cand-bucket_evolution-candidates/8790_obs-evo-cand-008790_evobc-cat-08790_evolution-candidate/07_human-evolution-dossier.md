...
Project ID: `obs-evo-cand-008790`
...
- Project ID: `obs-evo-cand-008790`
- EVOBC category candidate ID: `evobc-evo-cat-08790`
- External category reference: `evobc-cat-08790`
- Source category ID: `08790`
- Source label for human review: `躳`
- Source codepoints: `U+8EB3`
...
- `obs-evo-cand-008790-route-category-staging`
...
- `obs-evo-cand-008790-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008790-route-evolution-graph`
