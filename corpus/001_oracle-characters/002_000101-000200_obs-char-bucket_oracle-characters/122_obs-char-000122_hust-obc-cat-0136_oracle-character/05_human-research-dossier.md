# obs-char-000122 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/122_obs-char-000122_hust-obc-cat-0136_orac
  le-character/03_visual-assets/001_asset-000127_hust-obc-cat-0136_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0136/L_0136_315.jpg`
- asset id: `asset-000127`
...
- source category: `0136`
- validation class: `121`
- source image route: `HUST-OBC/deciphered/0136/L_0136_315.jpg`
- asset id: `asset-000127`
...
- English observation: `The low-resolution gray image shows a short angular
  upper block and a thicker curved stroke descending toward the lower
  right.`
- 中文观察: `低分辨率灰度图像上方有短折角块状痕迹，并有较粗弯曲笔向右下延伸。`
...
- dataset label text: `㑾`
- dataset label codepoints: `U+347E`
...
- Which source records identify obs-char-000122 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000122？
