# obs-unk-003869 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003869`
- primary external id: `hust-obc-und-L-003869`
...
- local review image route: `corpus/001_oracle-characters/055_undeciphered-003
  801-003900_obs-unk-bucket_oracle-character-candidates/069_obs-unk-003869_h
  ust-obc-und-L-003869_oracle-character-candidate/03_visual-assets/001_asset
  -005462_hust-obc-und-L-003869_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3869/L_？_8112.jpg`
- asset id: `asset-005462`
...
- source class: `HUST-OBC/undeciphered/L/3869/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3869/L_？_8112.jpg`
- asset id: `asset-005462`
...
- Which source records identify obs-unk-003869 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003869？
