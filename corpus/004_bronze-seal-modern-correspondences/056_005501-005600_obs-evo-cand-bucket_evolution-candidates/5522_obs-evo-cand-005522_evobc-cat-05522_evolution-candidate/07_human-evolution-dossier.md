...
Project ID: `obs-evo-cand-005522`
...
- Project ID: `obs-evo-cand-005522`
- EVOBC category candidate ID: `evobc-evo-cat-05522`
- External category reference: `evobc-cat-05522`
- Source category ID: `05522`
- Source label for human review: `甈`
- Source codepoints: `U+7508`
...
- `obs-evo-cand-005522-route-category-staging`
...
- `obs-evo-cand-005522-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005522-route-evolution-graph`
