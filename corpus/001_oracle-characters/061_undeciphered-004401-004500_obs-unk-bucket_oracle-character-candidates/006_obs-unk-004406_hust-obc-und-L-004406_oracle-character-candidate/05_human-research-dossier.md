# obs-unk-004406 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004406`
- primary external id: `hust-obc-und-L-004406`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/006_obs-unk-004406_h
  ust-obc-und-L-004406_oracle-character-candidate/03_visual-assets/001_asset
  -005999_hust-obc-und-L-004406_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4406/L_？_9836.jpg`
- asset id: `asset-005999`
...
- source class: `HUST-OBC/undeciphered/L/4406/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4406/L_？_9836.jpg`
- asset id: `asset-005999`
...
- English observation: `A broad upper rectangular outline sits above two`
  `descending diagonal traces.`
- 中文观察: `上部宽矩形轮廓下方有两条向下的斜向痕迹。`
...
- Which source records identify obs-unk-004406 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004406？
