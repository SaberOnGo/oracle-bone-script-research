# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000536
...
- EVOBC candidate category: `evobc-evo-cat-00536`.
- Source label for search only: `䨮`.
- Source codepoints for search only: `U+4A2E`.
