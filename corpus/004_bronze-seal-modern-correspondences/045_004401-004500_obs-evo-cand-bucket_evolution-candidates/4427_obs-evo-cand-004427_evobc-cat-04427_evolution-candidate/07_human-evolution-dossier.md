...
- External category reference: `evobc-cat-04427`
- Source category ID: `04427`
- Source label for human review: `段`
...
- `obs-evo-cand-004427-route-category-staging`
...
- `obs-evo-cand-004427-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004427-route-evolution-graph`
