...
Project ID: `obs-evo-cand-000915`
...
- Project ID: `obs-evo-cand-000915`
- EVOBC category candidate ID: `evobc-evo-cat-00915`
- External category reference: `evobc-cat-00915`
- Source category ID: `00915`
- Source label for human review: `倄`
- Source codepoints: `U+5004`
...
- `obs-evo-cand-000915-route-category-staging`
...
- `obs-evo-cand-000915-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000915-route-evolution-graph`
