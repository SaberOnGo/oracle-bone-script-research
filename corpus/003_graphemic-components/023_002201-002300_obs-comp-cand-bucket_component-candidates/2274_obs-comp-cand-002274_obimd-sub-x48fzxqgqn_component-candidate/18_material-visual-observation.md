# Material Visual Observation / obs-comp-cand-002274 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002274`
- External reference / 外部参照: `obimd-sub-x48fzxqgqn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020158_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/x48fzxqgqn/x48fzxqgqn/x48fzxqgqn.png`
- Checksum / 校验和:
  `9b3ceef0f0d42a4982bad1fe3b33679ff2fc150d45c53da0f765203d375e076f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.80%.
- Marked-pixel bounds: (85,31)–(162,204); span 78 × 174 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.80%。
- 痕迹范围：(85,31)–(162,204)；跨度78 × 174 px；痕迹矩形高于宽。
