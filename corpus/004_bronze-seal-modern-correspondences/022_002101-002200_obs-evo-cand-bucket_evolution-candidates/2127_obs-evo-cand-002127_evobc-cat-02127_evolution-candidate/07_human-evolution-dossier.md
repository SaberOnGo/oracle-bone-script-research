...
- Project ID: `obs-evo-cand-002127`
- EVOBC category candidate ID: `evobc-evo-cat-02127`
- External category reference: `evobc-cat-02127`
- Source category ID: `02127`
- Source label for human review: `姚`
- Source codepoints: `U+59DA`
...
- `obs-evo-cand-002127-route-category-staging`
...
- `obs-evo-cand-002127-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002127-route-evolution-graph`
