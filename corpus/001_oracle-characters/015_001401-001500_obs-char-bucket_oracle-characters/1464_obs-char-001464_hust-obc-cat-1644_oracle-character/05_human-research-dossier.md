# obs-char-001464 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001464`
- primary external id: `hust-obc-cat-1644`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1464_obs-char-001464_hust-obc-cat-1644_ora
  cle-character/03_visual-assets/001_asset-001469_hust-obc-cat-1644_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1644/X_1644_2006_1.png`
- asset id: `asset-001469`
...
- source category: `1644`
- validation class: `1463`
- source image route: `HUST-OBC/deciphered/1644/X_1644_2006_1.png`
- asset id: `asset-001469`
...
- English observation: `A large composite has a rounded upper enclosure, a
  long stem, and lower legs.`
- 中文观察: `大型组合形体有圆拱上部框形、长竖干和下部分叉。`
...
- dataset label text: `㩢`
- dataset label codepoints: `U+3A62`
...
- Which source records identify obs-char-001464 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001464？
