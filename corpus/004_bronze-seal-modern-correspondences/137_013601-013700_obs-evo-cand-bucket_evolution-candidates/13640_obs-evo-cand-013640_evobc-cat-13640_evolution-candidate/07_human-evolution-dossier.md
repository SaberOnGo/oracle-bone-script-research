...
- Project ID: `obs-evo-cand-013640`
- EVOBC category candidate ID: `evobc-evo-cat-13640`
- External category reference: `evobc-cat-13640`
- Source category ID: `13640`
- Source label for human review: `𮗹`
- Source codepoints: `U+2E5F9`
...
- `obs-evo-cand-013640-route-category-staging`
...
- `obs-evo-cand-013640-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013640-route-evolution-graph`
