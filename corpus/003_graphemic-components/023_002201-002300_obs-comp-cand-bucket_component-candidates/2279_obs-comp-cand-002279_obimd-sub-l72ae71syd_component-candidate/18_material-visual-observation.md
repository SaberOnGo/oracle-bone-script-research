# Material Visual Observation / obs-comp-cand-002279 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002279`
- External reference / 外部参照: `obimd-sub-l72ae71syd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020163_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/l72ae71syd/l72ae71syd/l72ae71syd.png`
- Checksum / 校验和:
  `3ba9681a7e9a895bf920bc908f2e6da8b34f7baffb0d02bea5dae76deb7ffd28`
...
- Marked-pixel bounds: (78,34)–(174,211); span 97 × 178 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.22%。
- 痕迹范围：(78,34)–(174,211)；跨度97 × 178 px；痕迹矩形高于宽。
