# Material Visual Observation / obs-comp-cand-001859 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001859`
- External reference / 外部参照: `obimd-sub-4a48e8qf41`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018238_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bfwtwd92m1/4a48e8qf41/4a48e8qf41.png`
- Checksum / 校验和:
  `ec6e2d0a6014401b75a1dee451ac3c4d011390be3d7b645922297d436672b1c3`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.52%.
- Marked-pixel bounds: (46,47)–(196,201); span 151 × 155 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.52%。
- 痕迹范围：(46,47)–(196,201)；跨度151 × 155 px；痕迹矩形近方形。
