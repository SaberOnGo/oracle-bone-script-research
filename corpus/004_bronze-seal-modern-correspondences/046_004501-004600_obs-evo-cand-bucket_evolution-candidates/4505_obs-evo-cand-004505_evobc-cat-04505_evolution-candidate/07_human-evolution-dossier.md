...
- External category reference: `evobc-cat-04505`
- Source category ID: `04505`
- Source label for human review: `汤`
...
- `obs-evo-cand-004505-route-category-staging`
...
- `obs-evo-cand-004505-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004505-route-evolution-graph`
