...
- External category reference: `evobc-cat-11570`
- Source category ID: `11570`
- Source label for human review: `𤍮`
- Source codepoints: `U+2436E`
...
- `obs-evo-cand-011570-route-category-staging`
...
- `obs-evo-cand-011570-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011570-route-evolution-graph`
