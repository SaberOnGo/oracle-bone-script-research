# Material Visual Observation / obs-comp-cand-000182 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000182`
- External reference / 外部参照: `obimd-sub-tiaauw1dk5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011594_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3wku1ohk1p/tiaauw1dk5/tiaauw1dk5.png`
- Checksum / 校验和:
  `65982914995ac9907f345c4e9542c367e7d013b7ca2de67090a2637481807030`
...
- Marked-pixel bounds: (60,12)–(177,234); span 118 × 223 px; the marked
...
- 痕迹范围：(60,12)–(177,234)；跨度118 × 223 px；痕迹矩形高于宽。
