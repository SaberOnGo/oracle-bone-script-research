...
Project ID: `obs-evo-cand-009881`
...
- Project ID: `obs-evo-cand-009881`
- EVOBC category candidate ID: `evobc-evo-cat-09881`
- External category reference: `evobc-cat-09881`
- Source category ID: `09881`
- Source label for human review: `青`
- Source codepoints: `U+9752`
...
- `obs-evo-cand-009881-route-category-staging`
...
- `obs-evo-cand-009881-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009881-route-evolution-graph`
