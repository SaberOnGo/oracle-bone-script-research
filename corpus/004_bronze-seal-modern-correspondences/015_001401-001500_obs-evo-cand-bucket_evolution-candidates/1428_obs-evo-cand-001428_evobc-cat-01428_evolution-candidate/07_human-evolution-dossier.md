...
- External category reference: `evobc-cat-01428`
- Source category ID: `01428`
- Source label for human review: `原`
...
- `obs-evo-cand-001428-route-category-staging`
...
- `obs-evo-cand-001428-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001428-route-evolution-graph`
