...
- External category reference: `evobc-cat-08210`
- Source category ID: `08210`
- Source label for human review: `詿`
- Source codepoints: `U+8A7F`
...
- `obs-evo-cand-008210-route-category-staging`
...
- `obs-evo-cand-008210-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008210-route-evolution-graph`
