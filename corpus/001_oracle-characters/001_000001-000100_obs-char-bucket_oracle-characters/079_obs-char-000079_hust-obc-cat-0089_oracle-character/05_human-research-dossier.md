# obs-char-000079 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/079_obs-char-000079_hust-obc-cat-0089_orac
  le-character/03_visual-assets/001_asset-000084_hust-obc-cat-0089_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0089/G_0089_乙3400合1285賓組.png`
- asset id: `asset-000084`
...
- source category: `0089`
- validation class: `78`
- source image route: `HUST-OBC/deciphered/0089/G_0089_乙3400合1285賓組.png`
- asset id: `asset-000084`
...
- English observation: `The narrow image shows a central descending stem
  that branches into two long curved side strokes.`
...
- dataset label text: `㑏`
- dataset label codepoints: `U+344F`
...
- Which source records identify obs-char-000079 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000079？
