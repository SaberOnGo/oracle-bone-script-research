...
- External category reference: `evobc-cat-03601`
- Source category ID: `03601`
- Source label for human review: `敬`
- Source codepoints: `U+656C`
- Image reference count in source metadata: `166`
...
- `obs-evo-cand-003601-route-category-staging`
...
- `obs-evo-cand-003601-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003601-route-evolution-graph`
