# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010586
...
- EVOBC candidate category: `evobc-evo-cat-10586`.
- Source label for search only: `鸽`.
- Source codepoints for search only: `U+9E3D`.
