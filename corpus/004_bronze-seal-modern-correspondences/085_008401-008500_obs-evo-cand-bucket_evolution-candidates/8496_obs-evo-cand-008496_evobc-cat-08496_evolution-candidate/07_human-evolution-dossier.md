...
- External category reference: `evobc-cat-08496`
- Source category ID: `08496`
- Source label for human review: `豧`
- Source codepoints: `U+8C67`
...
- `obs-evo-cand-008496-route-category-staging`
...
- `obs-evo-cand-008496-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008496-route-evolution-graph`
