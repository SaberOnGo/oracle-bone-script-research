# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000144
...
- EVOBC candidate category: `evobc-evo-cat-00144`.
- Source label for search only: `㩜`.
- Source codepoints for search only: `U+3A5C`.
