...
- External category reference: `evobc-cat-01734`
- Source category ID: `01734`
- Source label for human review: `嚏`
- Source codepoints: `U+568F`
...
- `obs-evo-cand-001734-route-category-staging`
...
- `obs-evo-cand-001734-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001734-route-evolution-graph`
