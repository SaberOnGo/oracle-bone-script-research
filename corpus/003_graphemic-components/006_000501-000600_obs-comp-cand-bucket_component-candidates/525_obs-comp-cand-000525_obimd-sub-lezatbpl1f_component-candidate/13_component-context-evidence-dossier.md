# obs-comp-cand-000525 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000525`
- 首选外部 ID: `obimd-sub-lezatbpl1f`
- OBIMD subcharacter UID: `lezatbpl1f`
- OBIMD main character UID: `lezatbpl1f`
- 来源 ID: `src-obimd`
