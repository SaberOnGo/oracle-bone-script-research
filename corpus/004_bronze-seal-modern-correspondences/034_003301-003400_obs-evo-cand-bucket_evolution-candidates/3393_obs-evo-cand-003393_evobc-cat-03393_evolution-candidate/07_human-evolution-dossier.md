...
Project ID: `obs-evo-cand-003393`
...
- Project ID: `obs-evo-cand-003393`
- EVOBC category candidate ID: `evobc-evo-cat-03393`
- External category reference: `evobc-cat-03393`
- Source category ID: `03393`
- Source label for human review: `掄`
- Source codepoints: `U+6384`
...
- `obs-evo-cand-003393-route-category-staging`
...
- `obs-evo-cand-003393-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003393-route-evolution-graph`
