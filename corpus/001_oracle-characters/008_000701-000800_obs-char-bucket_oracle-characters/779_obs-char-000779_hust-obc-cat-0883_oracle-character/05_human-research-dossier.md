# obs-char-000779 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/779_obs-char-000779_hust-obc-cat-0883_orac
  le-character/03_visual-assets/001_asset-000784_hust-obc-cat-0883_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0883/X_0883_2897_1.png`
- asset id: `asset-000784`
...
- source category: `0883`
- validation class: `778`
- source image route: `HUST-OBC/deciphered/0883/X_0883_2897_1.png`
- asset id: `asset-000784`
...
- English observation: `A bold irregular cluster combines a tilted upper
  loop and a large open left outline with a thick descending center; a small
  right junction forks into two long lower strokes.`
- 中文观察: `粗重不规则笔群结合倾斜上环、大型左侧开口轮廓和粗下行中央笔；右侧小接点分出两条长下笔。`
...
- dataset label text: `㝩`
- dataset label codepoints: `U+3769`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00073`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00073`
- EvoBC image reference count / EvoBC 图像引用数: `6`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00073`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/073_obs-evo-can
  d-000073_evobc-cat-00073_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/073_obs-evo-cand-000073_evobc-cat-00073_evolu
...
- Which source records identify obs-char-000779 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000779？
