# Material Visual Observation / obs-comp-cand-001939 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001939`
- External reference / 外部参照: `obimd-sub-oqgvu8863v`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018725_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/giysoy67zo/oqgvu8863v/oqgvu8863v.png`
- Checksum / 校验和:
  `abca608b5013e5b43da6870129c7cd5e8829429abd9d54d6f57fedbd6cece625`
...
- Marked-pixel bounds: (72,33)–(177,212); span 106 × 180 px; the marked
...
- 痕迹范围：(72,33)–(177,212)；跨度106 × 180 px；痕迹矩形高于宽。
