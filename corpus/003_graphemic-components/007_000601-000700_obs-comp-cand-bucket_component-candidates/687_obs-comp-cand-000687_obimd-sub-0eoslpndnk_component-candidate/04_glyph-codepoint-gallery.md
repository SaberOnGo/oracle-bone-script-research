# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000687
...
| --- | --- | --- | --- |
| `obimd-glyph-link-009969` | 󳻖 | `U+F3ED6` | `reviewed_metadata_only` |
| `obimd-glyph-link-009970` | 󳻗 | `U+F3ED7` | `reviewed_metadata_only` |
| `obimd-glyph-link-009971` | 󳻘 | `U+F3ED8` | `reviewed_metadata_only` |
| `obimd-glyph-link-009972` | 󳻙 | `U+F3ED9` | `reviewed_metadata_only` |
| `obimd-glyph-link-009973` | 󳻚 | `U+F3EDA` | `reviewed_metadata_only` |
