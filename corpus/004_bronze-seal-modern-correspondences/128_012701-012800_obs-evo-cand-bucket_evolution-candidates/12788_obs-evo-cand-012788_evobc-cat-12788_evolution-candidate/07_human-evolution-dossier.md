...
- External category reference: `evobc-cat-12788`
- Source category ID: `12788`
- Source label for human review: `𪚦`
- Source codepoints: `U+2A6A6`
...
- `obs-evo-cand-012788-route-category-staging`
...
- `obs-evo-cand-012788-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012788-route-evolution-graph`
