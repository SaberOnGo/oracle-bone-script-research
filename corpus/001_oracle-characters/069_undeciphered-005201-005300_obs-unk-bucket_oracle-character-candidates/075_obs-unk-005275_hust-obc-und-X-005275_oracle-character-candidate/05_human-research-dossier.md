# obs-unk-005275 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005275`
- primary external id: `hust-obc-und-X-005275`
...
- local review image route: `corpus/001_oracle-characters/069_undeciphered-005
  201-005300_obs-unk-bucket_oracle-character-candidates/075_obs-unk-005275_h
  ust-obc-und-X-005275_oracle-character-candidate/03_visual-assets/001_asset
  -006868_hust-obc-und-X-005275_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/831/X_？_7792_1.png`
- asset id: `asset-006868`
...
- source class: `HUST-OBC/undeciphered/X/831/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/831/X_？_7792_1.png`
- asset id: `asset-006868`
...
- Which source records identify obs-unk-005275 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005275？
