# obs-unk-006413 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/081_undeciphered-006
  401-006500_obs-unk-bucket_oracle-character-candidates/013_obs-unk-006413_h
  ust-obc-und-X-006413_oracle-character-candidate/03_visual-assets/001_asset
  -008004_hust-obc-und-X-006413_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1969/X_？_553_1.png`
- asset id: `asset-008004`
...
- source class: `HUST-OBC/undeciphered/X/1969/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1969/X_？_553_1.png`
...
- Which source records identify obs-unk-006413 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006413？
