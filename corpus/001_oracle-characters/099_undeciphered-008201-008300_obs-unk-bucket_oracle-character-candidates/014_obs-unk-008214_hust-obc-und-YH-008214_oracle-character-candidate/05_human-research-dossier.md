# obs-unk-008214 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008214`
- primary external id: `hust-obc-und-YH-008214`
...
- local review image route: `corpus/001_oracle-characters/099_undeciphered-008
  201-008300_obs-unk-bucket_oracle-character-candidates/014_obs-unk-008214_h
  ust-obc-und-YH-008214_oracle-character-candidate/03_visual-assets/001_asse
  t-009805_hust-obc-und-YH-008214_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/608BF/Y_？_608BF.jpg`
- asset id: `asset-009805`
...
- source class: `HUST-OBC/undeciphered/Y+H/608BF/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/608BF/Y_？_608BF.jpg`
- asset id: `asset-009805`
...
- Which source records identify obs-unk-008214 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008214？
