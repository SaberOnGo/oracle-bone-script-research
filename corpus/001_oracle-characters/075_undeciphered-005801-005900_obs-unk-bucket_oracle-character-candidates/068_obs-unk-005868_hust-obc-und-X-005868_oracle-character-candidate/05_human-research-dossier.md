# obs-unk-005868 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005868`
- primary external id: `hust-obc-und-X-005868`
...
- local review image route: `corpus/001_oracle-characters/075_undeciphered-005
  801-005900_obs-unk-bucket_oracle-character-candidates/068_obs-unk-005868_h
  ust-obc-und-X-005868_oracle-character-candidate/03_visual-assets/001_asset
  -007460_hust-obc-und-X-005868_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1424/X_？_2203_1.png`
- asset id: `asset-007460`
...
- source class: `HUST-OBC/undeciphered/X/1424/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1424/X_？_2203_1.png`
- asset id: `asset-007460`
...
- Which source records identify obs-unk-005868 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005868？
