# obs-unk-004655 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/055_obs-unk-004655_h
  ust-obc-und-X-004655_oracle-character-candidate/03_visual-assets/001_asset
  -006248_hust-obc-und-X-004655_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/211/X_？_8383_1.png`
- asset id: `asset-006248`
...
- source class: `HUST-OBC/undeciphered/X/211/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/211/X_？_8383_1.png`
- asset id: `asset-006248`
...
- English observation: `crossing thick strokes with two pale openings`
- 中文观察: `带两个浅色开口的交叉粗重笔画`
...
- Which source records identify obs-unk-004655 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004655？
