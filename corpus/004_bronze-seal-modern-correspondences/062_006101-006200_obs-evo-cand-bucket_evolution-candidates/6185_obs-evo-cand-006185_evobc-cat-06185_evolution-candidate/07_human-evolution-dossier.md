...
- External category reference: `evobc-cat-06185`
- Source category ID: `06185`
- Source label for human review: `窺`
- Source codepoints: `U+7ABA`
...
- `obs-evo-cand-006185-route-category-staging`
...
- `obs-evo-cand-006185-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006185-route-evolution-graph`
