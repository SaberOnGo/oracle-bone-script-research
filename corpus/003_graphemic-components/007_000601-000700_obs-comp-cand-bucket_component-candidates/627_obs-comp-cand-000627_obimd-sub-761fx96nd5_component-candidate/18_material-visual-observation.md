# Material Visual Observation / obs-comp-cand-000627 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000627`
- External reference / 外部参照: `obimd-sub-761fx96nd5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013190_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/e165xleaqt/761fx96nd5/761fx96nd5.png`
- Checksum / 校验和:
  `6e6ffad043abcbfc5fa7cd476d7fe6fba49040adc65274890ee252fe1f0ff787`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.23%.
- Marked-pixel bounds: (79,22)–(200,225); span 122 × 204 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.23%。
- 痕迹范围：(79,22)–(200,225)；跨度122 × 204 px；痕迹矩形高于宽。
