# Material Visual Observation / obs-comp-cand-002690 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002690`
- External reference / 外部参照: `obimd-sub-uoh6yyyf8h`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021266_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/uoh6yyyf8h/uoh6yyyf8h/uoh6yyyf8h.png`
- Checksum / 校验和:
  `9f135b9d027370b16ef2aa1ccd4c1d61986b83d0f50851326ccd50314440c8af`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.74%.
- Marked-pixel bounds: (100,22)–(149,216); span 50 × 195 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.74%。
- 痕迹范围：(100,22)–(149,216)；跨度50 × 195 px；痕迹矩形高于宽。
