# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002848
...
- EVOBC candidate category: `evobc-evo-cat-02848`.
- Source label for search only: `彪`.
- Source codepoints for search only: `U+5F6A`.
