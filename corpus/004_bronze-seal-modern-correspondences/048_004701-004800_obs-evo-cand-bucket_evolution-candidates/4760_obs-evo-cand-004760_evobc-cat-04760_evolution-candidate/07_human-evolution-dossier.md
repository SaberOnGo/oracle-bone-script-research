...
- External category reference: `evobc-cat-04760`
- Source category ID: `04760`
- Source label for human review: `渥`
...
- `obs-evo-cand-004760-route-category-staging`
...
- `obs-evo-cand-004760-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004760-route-evolution-graph`
