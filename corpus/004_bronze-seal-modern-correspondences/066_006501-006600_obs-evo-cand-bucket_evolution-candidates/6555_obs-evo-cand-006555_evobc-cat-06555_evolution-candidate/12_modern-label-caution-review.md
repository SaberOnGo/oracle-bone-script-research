# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006555
...
- EVOBC candidate category: `evobc-evo-cat-06555`.
- Source label for search only: `綫`.
- Source codepoints for search only: `U+7DAB`.
