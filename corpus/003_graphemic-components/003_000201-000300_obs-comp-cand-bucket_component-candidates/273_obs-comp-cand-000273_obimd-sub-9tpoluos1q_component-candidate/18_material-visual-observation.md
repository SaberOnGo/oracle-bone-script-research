# Material Visual Observation / obs-comp-cand-000273 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000273`
- External reference / 外部参照: `obimd-sub-9tpoluos1q`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011917_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9tpoluos1q/9tpoluos1q/9tpoluos1q.png`
- Checksum / 校验和:
  `c5d5d4d93701accec021b74b0f9c80409146d9c2c39fe199194a2133b5b17e77`
...
- Marked-pixel bounds: (90,22)–(159,225); span 70 × 204 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.04%。
- 痕迹范围：(90,22)–(159,225)；跨度70 × 204 px；痕迹矩形高于宽。
