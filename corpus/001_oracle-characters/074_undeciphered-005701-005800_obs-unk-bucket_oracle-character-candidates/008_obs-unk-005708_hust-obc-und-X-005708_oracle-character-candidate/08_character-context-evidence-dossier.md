...
- Primary external ID / 首选外部 ID: `hust-obc-und-X-005708`
...
- Index row count / 索引行数: `50`
- Source image route count / 来源图像路线数: `50`
- Local review image count / 本地复核图像数: `1`
- Source image / 来源图: `X_？_1176_1.png`
- Image / 图像: `001_asset-000004_hust-X-005708_glyph.png`
