# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006463
...
- EVOBC candidate category: `evobc-evo-cat-06463`.
- Source label for search only: `紝`.
- Source codepoints for search only: `U+7D1D`.
