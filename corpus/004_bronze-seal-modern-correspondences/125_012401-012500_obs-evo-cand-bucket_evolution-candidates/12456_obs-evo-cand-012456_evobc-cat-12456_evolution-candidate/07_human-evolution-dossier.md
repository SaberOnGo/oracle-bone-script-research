...
- Project ID: `obs-evo-cand-012456`
- EVOBC category candidate ID: `evobc-evo-cat-12456`
- External category reference: `evobc-cat-12456`
- Source category ID: `12456`
- Source label for human review: `𨞖`
- Source codepoints: `U+28796`
...
- `obs-evo-cand-012456-route-category-staging`
...
- `obs-evo-cand-012456-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012456-route-evolution-graph`
