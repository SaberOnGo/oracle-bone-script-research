...
- External category reference: `evobc-cat-04226`
- Source category ID: `04226`
- Source label for human review: `槹`
...
- `obs-evo-cand-004226-route-category-staging`
...
- `obs-evo-cand-004226-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004226-route-evolution-graph`
