# Material Visual Observation / obs-comp-cand-002108 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002108`
- External reference / 外部参照: `obimd-sub-0gb8tth8uf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019559_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/srhk7ugxm8/0gb8tth8uf/0gb8tth8uf.png`
- Checksum / 校验和:
  `e18ab63406144bb7d81b77fea38fba34dcb01cf12234b6a40282da1afdfddc5a`
...
- Marked-pixel bounds: (90,19)–(160,230); span 71 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.90%。
- 痕迹范围：(90,19)–(160,230)；跨度71 × 212 px；痕迹矩形高于宽。
