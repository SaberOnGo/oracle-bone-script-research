# Material Visual Observation / obs-comp-cand-001802 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001802`
- External reference / 外部参照: `obimd-sub-vf4c383b64`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018023_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vf4c383b64/vf4c383b64/vf4c383b64.png`
- Checksum / 校验和:
  `56f8cbd2759be5f04a8bd511cad0f2c3f0cddad7ef8fa0bd93bc2108c904f4a5`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 16.81%.
- Marked-pixel bounds: (46,24)–(203,215); span 158 × 192 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占16.81%。
- 痕迹范围：(46,24)–(203,215)；跨度158 × 192 px；痕迹矩形高于宽。
