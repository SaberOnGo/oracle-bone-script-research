...
- External category reference: `evobc-cat-09457`
- Source category ID: `09457`
- Source label for human review: `鍠`
- Source codepoints: `U+9360`
...
- `obs-evo-cand-009457-route-category-staging`
...
- `obs-evo-cand-009457-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009457-route-evolution-graph`
