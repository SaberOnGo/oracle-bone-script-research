...
- External category reference: `evobc-cat-10692`
- Source category ID: `10692`
- Source label for human review: `鼛`
...
- `obs-evo-cand-010692-route-category-staging`
...
- `obs-evo-cand-010692-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010692-route-evolution-graph`
