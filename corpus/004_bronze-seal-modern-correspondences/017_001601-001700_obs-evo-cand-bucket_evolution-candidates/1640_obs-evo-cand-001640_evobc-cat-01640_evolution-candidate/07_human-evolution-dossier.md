...
- External category reference: `evobc-cat-01640`
- Source category ID: `01640`
- Source label for human review: `喅`
- Source codepoints: `U+5585`
...
- `obs-evo-cand-001640-route-category-staging`
...
- `obs-evo-cand-001640-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001640-route-evolution-graph`
