# obs-unk-004364 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/064_obs-unk-004364_h
  ust-obc-und-L-004364_oracle-character-candidate/03_visual-assets/001_asset
  -005957_hust-obc-und-L-004364_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4364/L_？_9686.jpg`
- asset id: `asset-005957`
...
- source class: `HUST-OBC/undeciphered/L/4364/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4364/L_？_9686.jpg`
- asset id: `asset-005957`
...
- English observation: `Upper crossed cluster and lower diagonal trace`
  `recorded.`
- 中文观察: `已记录上部交叉痕簇和下部斜向痕迹。`
...
- Which source records identify obs-unk-004364 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004364？
