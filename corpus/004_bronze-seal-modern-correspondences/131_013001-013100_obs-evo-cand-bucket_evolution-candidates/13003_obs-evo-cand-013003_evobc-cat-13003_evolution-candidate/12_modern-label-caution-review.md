# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013003
...
- EVOBC candidate category: `evobc-evo-cat-13003`.
- Source label for search only: `𫣐`.
- Source codepoints for search only: `U+2B8D0`.
