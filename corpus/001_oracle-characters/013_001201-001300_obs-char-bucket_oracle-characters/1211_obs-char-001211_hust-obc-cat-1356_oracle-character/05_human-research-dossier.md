# obs-char-001211 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1211_obs-char-001211_hust-obc-cat-1356_ora
  cle-character/03_visual-assets/001_asset-001216_hust-obc-cat-1356_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1356/G_1356_乙4721反(甲).png`
- asset id: `asset-001216`
...
- source category: `1356`
- validation class: `1210`
- source image route: `HUST-OBC/deciphered/1356/G_1356_乙4721反(甲).png`
- asset id: `asset-001216`
...
- English observation: `A broad upper cluster has several pointed prongs, a
  central rounded band, and multiple lower branches.`
- 中文观察: `宽大的上部笔群有数条尖状枝、中央圆弧带和多条下部分枝。`
...
- dataset label text: `㥂`
- dataset label codepoints: `U+3942`
...
- Which source records identify obs-char-001211 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001211？
