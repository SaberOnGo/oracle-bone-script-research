# obs-unk-004033 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004033`
- primary external id: `hust-obc-und-L-004033`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/033_obs-unk-004033_h
  ust-obc-und-L-004033_oracle-character-candidate/03_visual-assets/001_asset
  -005626_hust-obc-und-L-004033_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4033/L_？_8617.jpg`
- asset id: `asset-005626`
...
- source class: `HUST-OBC/undeciphered/L/4033/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4033/L_？_8617.jpg`
- asset id: `asset-005626`
...
- English observation: Several pointed or branching traces occupy the upper
  area. A narrow central trace descends toward a separate rounded or wavy
  lower cluster. The crop leaves the connection between the areas uncertain.
- 中文观察：上部有数条尖顶或分叉痕迹；一条窄直中央痕迹向下延伸至另一个圆弧或波曲
    下部组合。图像未明确上下区域的连接关系。
...
- Which source records identify obs-unk-004033 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004033？
