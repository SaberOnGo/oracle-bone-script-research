# obs-unk-004919 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004919`
- primary external id: `hust-obc-und-X-004919`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/019_obs-unk-004919_h
  ust-obc-und-X-004919_oracle-character-candidate/03_visual-assets/001_asset
  -006512_hust-obc-und-X-004919_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/475/X_？_7460_1.png`
- asset id: `asset-006512`
...
- A long central stroke meets a large lower oval opening.
...
- source class: `HUST-OBC/undeciphered/X/475/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/475/X_？_7460_1.png`
- asset id: `asset-006512`
...
- Which source records identify obs-unk-004919 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004919？
