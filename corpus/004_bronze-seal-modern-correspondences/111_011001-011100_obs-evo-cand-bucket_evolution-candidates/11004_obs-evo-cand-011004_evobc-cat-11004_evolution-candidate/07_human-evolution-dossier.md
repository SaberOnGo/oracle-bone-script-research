...
Project ID: `obs-evo-cand-011004`
...
- Project ID: `obs-evo-cand-011004`
- EVOBC category candidate ID: `evobc-evo-cat-11004`
- External category reference: `evobc-cat-11004`
- Source category ID: `11004`
- Source label for human review: `𡐲`
- Source codepoints: `U+21432`
...
- `obs-evo-cand-011004-route-category-staging`
...
- `obs-evo-cand-011004-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011004-route-evolution-graph`
