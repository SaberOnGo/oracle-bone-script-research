# obs-unk-000398 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000398`
- primary external id: `hust-obc-und-L-000398`
...
- local review image route: `corpus/001_oracle-characters/020_undeciphered-000
  301-000400_obs-unk-bucket_oracle-character-candidates/098_obs-unk-000398_h
  ust-obc-und-L-000398_oracle-character-candidate/03_visual-assets/001_asset
  -001991_hust-obc-und-L-000398_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/398/L_？_11227.jpg`
- asset id: `asset-001991`
...
- source class: `HUST-OBC/undeciphered/L/398/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/398/L_？_11227.jpg`
- asset id: `asset-001991`
...
- Which source records identify obs-unk-000398 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000398？
