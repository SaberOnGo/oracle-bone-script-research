...
- Project ID: `obs-evo-cand-009809`
- EVOBC category candidate ID: `evobc-evo-cat-09809`
- External category reference: `evobc-cat-09809`
- Source category ID: `09809`
- Source label for human review: `雉`
- Source codepoints: `U+96C9`
- Image reference count in source metadata: `165`
...
- `obs-evo-cand-009809-route-category-staging`
...
- `obs-evo-cand-009809-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009809-route-evolution-graph`
