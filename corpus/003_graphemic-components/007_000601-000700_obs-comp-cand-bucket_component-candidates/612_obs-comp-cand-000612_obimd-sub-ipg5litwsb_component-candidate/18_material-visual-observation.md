# Material Visual Observation / obs-comp-cand-000612 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000612`
- External reference / 外部参照: `obimd-sub-ipg5litwsb`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013175_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/z403ojus93/ipg5litwsb/ipg5litwsb.png`
- Checksum / 校验和:
  `295a1e47a6fab73b83a8aa7fb8c11cf7f79773e2829f97fa79c664225d147e86`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.59%.
- Marked-pixel bounds: (84,19)–(174,229); span 91 × 211 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.59%。
- 痕迹范围：(84,19)–(174,229)；跨度91 × 211 px；痕迹矩形高于宽。
