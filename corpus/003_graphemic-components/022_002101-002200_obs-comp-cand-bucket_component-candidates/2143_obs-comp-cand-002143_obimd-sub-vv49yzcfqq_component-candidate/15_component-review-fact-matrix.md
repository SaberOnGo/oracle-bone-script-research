# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002143
...
| Glyph or codepoint route / 字形或码位路线 | 2 OBIMD route rows; examples U+FC5A2; U+FC5A3 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
