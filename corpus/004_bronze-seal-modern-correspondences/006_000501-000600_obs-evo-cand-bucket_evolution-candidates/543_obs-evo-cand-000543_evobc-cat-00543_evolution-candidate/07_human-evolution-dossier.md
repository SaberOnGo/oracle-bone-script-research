...
Project ID: `obs-evo-cand-000543`
...
- Project ID: `obs-evo-cand-000543`
- EVOBC category candidate ID: `evobc-evo-cat-00543`
- External category reference: `evobc-cat-00543`
- Source category ID: `00543`
- Source label for human review: `䪛`
- Source codepoints: `U+4A9B`
...
- `obs-evo-cand-000543-route-category-staging`
...
- `obs-evo-cand-000543-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000543-route-evolution-graph`
