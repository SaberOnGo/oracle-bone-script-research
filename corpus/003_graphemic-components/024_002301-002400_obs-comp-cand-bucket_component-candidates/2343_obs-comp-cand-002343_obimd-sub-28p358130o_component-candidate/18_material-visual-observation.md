# Material Visual Observation / obs-comp-cand-002343 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002343`
- External reference / 外部参照: `obimd-sub-28p358130o`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020414_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/28p358130o/28p358130o/28p358130o.png`
- Checksum / 校验和:
  `964c9ed47758157fc16ea15fb54d8e801abf529f175719820930eb284086f128`
...
- Marked-pixel bounds: (75,22)–(181,232); span 107 × 211 px; the marked
...
- 痕迹范围：(75,22)–(181,232)；跨度107 × 211 px；痕迹矩形高于宽。
