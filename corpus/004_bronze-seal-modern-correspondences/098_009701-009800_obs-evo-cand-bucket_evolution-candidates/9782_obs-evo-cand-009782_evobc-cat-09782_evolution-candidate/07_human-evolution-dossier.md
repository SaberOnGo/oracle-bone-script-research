...
- External category reference: `evobc-cat-09782`
- Source category ID: `09782`
- Source label: `隤`
...
- `obs-evo-cand-009782-route-category-staging`
...
- `obs-evo-cand-009782-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-009782-route-evolution-graph`
