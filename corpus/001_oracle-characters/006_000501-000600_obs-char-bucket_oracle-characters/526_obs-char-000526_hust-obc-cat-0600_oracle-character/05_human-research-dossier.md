# obs-char-000526 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000526`
- primary external id: `hust-obc-cat-0600`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/526_obs-char-000526_hust-obc-cat-0600_orac
  le-character/03_visual-assets/001_asset-000531_hust-obc-cat-0600_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0600/L_0600_10204.jpg`
- asset id: `asset-000531`
...
- source category: `0600`
- validation class: `525`
- source image route: `HUST-OBC/deciphered/0600/L_0600_10204.jpg`
- asset id: `asset-000531`
...
- English observation: `The very small low-contrast image shows short
  crossed angular strokes above, a bent descending stroke at right, and a
  detached curved mark at lower left.`
- 中文观察: `极小低对比度图像显示上部短交叉折笔、右侧弯折下行笔和左下分离弯痕。`
...
- dataset label text: `㙎`
- dataset label codepoints: `U+364E`
...
- Which source records identify obs-char-000526 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000526？
