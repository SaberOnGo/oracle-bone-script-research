...
- External category reference: `evobc-cat-08379`
- Source category ID: `08379`
- Source label for human review: `譻`
- Source codepoints: `U+8B7B`
...
- `obs-evo-cand-008379-route-category-staging`
...
- `obs-evo-cand-008379-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008379-route-evolution-graph`
