# obs-unk-004172 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/072_obs-unk-004172_h
  ust-obc-und-L-004172_oracle-character-candidate/03_visual-assets/001_asset
  -005765_hust-obc-und-L-004172_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4172/L_？_9038.jpg`
- asset id: `asset-005765`
...
- source class: `HUST-OBC/undeciphered/L/4172/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4172/L_？_9038.jpg`
- asset id: `asset-005765`
...
- English observation: A broad upper contour sits above two long curved lower
  strokes.
- 中文观察: 宽大的上部轮廓下方有两条较长弧曲笔画。
...
- Which source records identify obs-unk-004172 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004172？
