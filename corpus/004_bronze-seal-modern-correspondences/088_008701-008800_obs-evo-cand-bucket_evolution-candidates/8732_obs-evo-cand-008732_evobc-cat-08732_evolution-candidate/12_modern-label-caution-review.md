# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008732
...
- EVOBC candidate category: `evobc-evo-cat-08732`.
- Source label for search only: `踝`.
- Source codepoints for search only: `U+8E1D`.
