...
- Project ID: `obs-evo-cand-009650`
- EVOBC category candidate ID: `evobc-evo-cat-09650`
- External category reference: `evobc-cat-09650`
- Source category ID: `09650`
- Source label for human review: `闉`
- Source codepoints: `U+95C9`
...
- `obs-evo-cand-009650-route-category-staging`
...
- `obs-evo-cand-009650-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009650-route-evolution-graph`
