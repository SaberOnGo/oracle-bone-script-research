# obs-char-001029 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001029`
- primary external id: `hust-obc-cat-1154`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1029_obs-char-001029_hust-obc-cat-1154_ora
  cle-character/03_visual-assets/001_asset-001034_hust-obc-cat-1154_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1154/G_1154_前7.35.2(甲).png`
- asset id: `asset-001034`
...
- source category: `1154`
- validation class: `1028`
- source image route: `HUST-OBC/deciphered/1154/G_1154_前7.35.2(甲).png`
- asset id: `asset-001034`
...
- English observation: `A narrow upright form has a shallow upper curve, a
  small central enclosed mark, and long thin lower strokes.`
- 中文观察: `狭长直立形体有浅弯上部笔、小型中央闭合笔和数条细长下部笔。`
...
- dataset label text: `㡸`
- dataset label codepoints: `U+3878`
...
- Which source records identify obs-char-001029 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001029？
