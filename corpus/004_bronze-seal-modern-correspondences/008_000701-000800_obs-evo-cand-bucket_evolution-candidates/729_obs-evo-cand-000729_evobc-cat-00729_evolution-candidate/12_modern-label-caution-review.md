# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000729
...
- EVOBC candidate category: `evobc-evo-cat-00729`.
- Source label for search only: `仍`.
- Source codepoints for search only: `U+4ECD`.
