...
- External category reference: `evobc-cat-08349`
- Source category ID: `08349`
- Source label for human review: `證`
...
- `obs-evo-cand-008349-route-category-staging`
...
- `obs-evo-cand-008349-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008349-route-evolution-graph`
