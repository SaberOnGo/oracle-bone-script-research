# Material Visual Observation / obs-comp-cand-000419 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000419`
- External reference / 外部参照: `obimd-sub-v026vtmjx4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012342_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0zij73e4bo/v026vtmjx4/v026vtmjx4.png`
- Checksum / 校验和:
  `d495dc7d457effc235af2068a9fe141f87aaeeaba0a6fefe50fd80bbf9afae2f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.28%.
- Marked-pixel bounds: (81,27)–(168,227); span 88 × 201 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.28%。
- 痕迹范围：(81,27)–(168,227)；跨度88 × 201 px；痕迹矩形高于宽。
