...
- Project ID: `obs-evo-cand-011107`
- EVOBC category candidate ID: `evobc-evo-cat-11107`
- External category reference: `evobc-cat-11107`
- Source category ID: `11107`
- Source label for human review: `𡴘`
- Source codepoints: `U+21D18`
...
- `obs-evo-cand-011107-route-category-staging`
...
- `obs-evo-cand-011107-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011107-route-evolution-graph`
