# obs-unk-004902 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004902`
- primary external id: `hust-obc-und-X-004902`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/002_obs-unk-004902_h
  ust-obc-und-X-004902_oracle-character-candidate/03_visual-assets/001_asset
  -006495_hust-obc-und-X-004902_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/458/X_？_7438_1.png`
- asset id: `asset-006495`
...
- source class: `HUST-OBC/undeciphered/X/458/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/458/X_？_7438_1.png`
- asset id: `asset-006495`
...
- English observation: `broad outer boundary and scattered interior marks`
- 中文观察: `宽大外侧边界和散布的内部标记`
...
- Which source records identify obs-unk-004902 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004902？
