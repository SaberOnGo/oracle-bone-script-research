...
- External category reference: `evobc-cat-07369`
- Source category ID: `07369`
- Source label for human review: `莃`
- Source codepoints: `U+8383`
...
- `obs-evo-cand-007369-route-category-staging`
...
- `obs-evo-cand-007369-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007369-route-evolution-graph`
