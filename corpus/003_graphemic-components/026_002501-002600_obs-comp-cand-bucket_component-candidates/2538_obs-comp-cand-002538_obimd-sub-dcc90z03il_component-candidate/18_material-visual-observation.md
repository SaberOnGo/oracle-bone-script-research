# Material Visual Observation / obs-comp-cand-002538 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002538`
- External reference / 外部参照: `obimd-sub-dcc90z03il`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021057_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dcc90z03il/dcc90z03il/dcc90z03il.png`
- Checksum / 校验和:
  `892574c290038c179ae65e4242989df37002d70b31948b087700eede2e768a56`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.90%.
- Marked-pixel bounds: (50,27)–(215,227); span 166 × 201 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.90%。
- 痕迹范围：(50,27)–(215,227)；跨度166 × 201 px；痕迹矩形高于宽。
