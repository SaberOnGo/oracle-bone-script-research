# Material Visual Observation / obs-comp-cand-002014 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002014`
- External reference / 外部参照: `obimd-sub-3x31l3cpax`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019341_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7hsrnqwx2f/3x31l3cpax/3x31l3cpax.png`
- Checksum / 校验和:
  `07d9c79b0c5d3cd77741ae05baadef6d9a3596ef0bdbb2ebb2a053a56cedc844`
...
- Marked-pixel bounds: (65,13)–(177,233); span 113 × 221 px; the marked
...
- 痕迹范围：(65,13)–(177,233)；跨度113 × 221 px；痕迹矩形高于宽。
