# Human Collection Object Dossier / 馆藏对象研究档案: coll-obj-cand-00011
...
The current official page, source-displayed lines, and four private image
routes are recorded in `18_live-source-evidence-review.md`.
...
- project_id: `coll-obj-cand-00011`
- candidate_collection_object_id: `ihp-mus-obj-00011`
- source_collection_item_id: `775`
...
| `source_collection_item_id` | `775` |
| `object_title_en` | `Inscribed Plastron Ping 0086` |
| `catalog_reference_text` | `Ping 0086` |
| `object_page_url` | `https://museum.sinica.edu.tw/en/collection/32/item/775/` |
| `thumbnail_url` | `https://museum.sinica.edu.tw/_upload/image/collection_item/thumbnail/1805f688155263ca.jpg` |
...
- source_display_status: source-reported; image placeholders retained
