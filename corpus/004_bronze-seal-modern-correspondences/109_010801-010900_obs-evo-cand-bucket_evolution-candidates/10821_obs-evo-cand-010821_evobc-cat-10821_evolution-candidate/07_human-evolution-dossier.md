...
Project ID: `obs-evo-cand-010821`
...
- Project ID: `obs-evo-cand-010821`
- EVOBC category candidate ID: `evobc-evo-cat-10821`
- External category reference: `evobc-cat-10821`
- Source category ID: `10821`
- Source label for human review: `𠏶`
- Source codepoints: `U+203F6`
...
- `obs-evo-cand-010821-route-category-staging`
...
- `obs-evo-cand-010821-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010821-route-evolution-graph`
