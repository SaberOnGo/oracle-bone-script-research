...
- External category reference: `evobc-cat-13400`
- Source category ID: `13400`
- Source label for human review: `𬫠`
- Source codepoints: `U+2CAE0`
...
- `obs-evo-cand-013400-route-category-staging`
...
- `obs-evo-cand-013400-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013400-route-evolution-graph`
