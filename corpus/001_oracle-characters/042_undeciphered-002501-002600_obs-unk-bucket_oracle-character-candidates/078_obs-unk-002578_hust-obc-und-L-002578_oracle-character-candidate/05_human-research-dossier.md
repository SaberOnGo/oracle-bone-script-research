# obs-unk-002578 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002578`
- primary external id: `hust-obc-und-L-002578`
...
- local review image route: `corpus/001_oracle-characters/042_undeciphered-002
  501-002600_obs-unk-bucket_oracle-character-candidates/078_obs-unk-002578_h
  ust-obc-und-L-002578_oracle-character-candidate/03_visual-assets/001_asset
  -004171_hust-obc-und-L-002578_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2578/L_？_3961.jpg`
- asset id: `asset-004171`
...
- source class: `HUST-OBC/undeciphered/L/2578/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2578/L_？_3961.jpg`
- asset id: `asset-004171`
...
- Which source records identify obs-unk-002578 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002578？
