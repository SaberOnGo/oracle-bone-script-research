...
Project ID: `obs-evo-cand-007079`
...
- Project ID: `obs-evo-cand-007079`
- EVOBC category candidate ID: `evobc-evo-cat-07079`
- External category reference: `evobc-cat-07079`
- Source category ID: `07079`
- Source label for human review: `脰`
- Source codepoints: `U+8130`
...
- `obs-evo-cand-007079-route-category-staging`
...
- `obs-evo-cand-007079-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007079-route-evolution-graph`
