...
Project ID: `obs-insc-cw-cand-000573`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000573`
...
- Source page section: `Period V Group 13` /
  `第 V 期第 13 组`
- Source section key: `period-v-group-13`
...
- Yingguo / 英国所藏: `y2592` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `606` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `667` in source row; primary catalog entry pending
- Heji / 合集: `41865` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000573`
