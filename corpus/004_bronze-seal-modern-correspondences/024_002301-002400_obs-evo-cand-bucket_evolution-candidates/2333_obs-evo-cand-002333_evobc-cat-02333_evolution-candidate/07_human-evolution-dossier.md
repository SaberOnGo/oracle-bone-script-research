...
Project ID: `obs-evo-cand-002333`
...
- Project ID: `obs-evo-cand-002333`
- EVOBC category candidate ID: `evobc-evo-cat-02333`
- External category reference: `evobc-cat-02333`
- Source category ID: `02333`
- Source label for human review: `孚`
- Source codepoints: `U+5B5A`
- Image reference count in source metadata: `96`
...
- `obs-evo-cand-002333-route-category-staging`
...
- `obs-evo-cand-002333-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002333-route-evolution-graph`
