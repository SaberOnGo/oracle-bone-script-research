...
Project ID: `obs-evo-cand-000153`
...
- Project ID: `obs-evo-cand-000153`
- EVOBC category candidate ID: `evobc-evo-cat-00153`
- External category reference: `evobc-cat-00153`
- Source category ID: `00153`
- Source label for human review: `㪿`
- Source codepoints: `U+3ABF`
...
- `obs-evo-cand-000153-route-category-staging`
...
- `obs-evo-cand-000153-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000153-route-evolution-graph`
