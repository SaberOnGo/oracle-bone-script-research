...
- External category reference: `evobc-cat-02217`
- Source category ID: `02217`
- Source label for human review: `婼`
- Source codepoints: `U+5A7C`
...
- `obs-evo-cand-002217-route-category-staging`
...
- `obs-evo-cand-002217-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002217-route-evolution-graph`
