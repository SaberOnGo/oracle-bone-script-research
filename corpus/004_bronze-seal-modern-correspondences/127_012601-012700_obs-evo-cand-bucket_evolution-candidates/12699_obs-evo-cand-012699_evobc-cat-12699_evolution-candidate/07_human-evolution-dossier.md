...
- External category reference: `evobc-cat-12699`
- Source category ID: `12699`
- Source label for human review: `𩶧`
...
- `obs-evo-cand-012699-route-category-staging`
...
- `obs-evo-cand-012699-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012699-route-evolution-graph`
