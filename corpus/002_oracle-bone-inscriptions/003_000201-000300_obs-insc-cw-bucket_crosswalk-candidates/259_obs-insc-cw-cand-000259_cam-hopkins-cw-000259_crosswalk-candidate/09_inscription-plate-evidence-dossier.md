# Inscription And Plate Evidence Dossier / 卜辞与图版证据档案
...
This file is a human evidence dossier for one inscription and plate
crosswalk candidate. It gathers the routes a reviewer must open before
treating any text, OCR, plate, catalog number, or object record as evidence.

本文件是一个卜辞与图版互证候选的人类证据档案。它汇总复核者在使用任何全文、OCR、图版、著录号或馆藏对象记录前必须打开的路线。
...
- Missing catalog refs: `cambridge_university_library; chalfant; heji`
...
separate occurrence review before they can support character dossiers.

时期和分组标签来自导入 metadata，只是复核信号，不是新增断代结论。关联字形仍需单独的字形出处复核，才可支持单字档案。
