# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010269
...
- EVOBC candidate category: `evobc-evo-cat-10269`.
- Source label for search only: `马`.
- Source codepoints for search only: `U+9A6C`.
