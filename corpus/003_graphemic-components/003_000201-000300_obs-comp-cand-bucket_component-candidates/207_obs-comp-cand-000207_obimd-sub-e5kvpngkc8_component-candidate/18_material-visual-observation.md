# Material Visual Observation / obs-comp-cand-000207 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000207`
- External reference / 外部参照: `obimd-sub-e5kvpngkc8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011768_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/e5kvpngkc8/e5kvpngkc8/e5kvpngkc8.png`
- Checksum / 校验和:
  `39d4b40fa778f28ea48a4543d72035d6665326ffbc4c1599059622fc75143b1a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.45%.
- Marked-pixel bounds: (67,14)–(182,247); span 116 × 234 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.45%。
- 痕迹范围：(67,14)–(182,247)；跨度116 × 234 px；痕迹矩形高于宽。
