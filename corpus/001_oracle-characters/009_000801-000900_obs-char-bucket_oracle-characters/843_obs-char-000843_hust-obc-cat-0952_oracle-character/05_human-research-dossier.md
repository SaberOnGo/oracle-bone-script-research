# obs-char-000843 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/843_obs-char-000843_hust-obc-cat-0952_orac
  le-character/03_visual-assets/001_asset-000848_hust-obc-cat-0952_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0952/G_0952_前6.43.1(甲).png`
- asset id: `asset-000848`
...
- source category: `0952`
- validation class: `842`
- source image route: `HUST-OBC/deciphered/0952/G_0952_前6.43.1(甲).png`
- asset id: `asset-000848`
...
- dataset label text: `㞮`
- dataset label codepoints: `U+37AE`
...
- Which source records identify obs-char-000843 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000843？
