...
Project ID: `obs-evo-cand-007727`
...
- Project ID: `obs-evo-cand-007727`
- EVOBC category candidate ID: `evobc-evo-cat-07727`
- External category reference: `evobc-cat-07727`
- Source category ID: `07727`
- Source label for human review: `蚑`
- Source codepoints: `U+8691`
...
- `obs-evo-cand-007727-route-category-staging`
...
- `obs-evo-cand-007727-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007727-route-evolution-graph`
