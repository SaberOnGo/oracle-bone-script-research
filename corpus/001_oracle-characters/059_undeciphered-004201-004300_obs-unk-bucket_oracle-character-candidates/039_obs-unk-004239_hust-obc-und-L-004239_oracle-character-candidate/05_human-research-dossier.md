# obs-unk-004239 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004239`
- primary external id: `hust-obc-und-L-004239`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/039_obs-unk-004239_h
  ust-obc-und-L-004239_oracle-character-candidate/03_visual-assets/001_asset
  -005832_hust-obc-und-L-004239_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4239/L_？_9308.jpg`
- asset id: `asset-005832`
...
- source class: `HUST-OBC/undeciphered/L/4239/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4239/L_？_9308.jpg`
- asset id: `asset-005832`
...
- English observation: `Upper marks, central trace, lower curve visible.`
- 中文观察: `上部痕迹、中央笔画和下部弯曲形态可见。`
...
- Which source records identify obs-unk-004239 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004239？
