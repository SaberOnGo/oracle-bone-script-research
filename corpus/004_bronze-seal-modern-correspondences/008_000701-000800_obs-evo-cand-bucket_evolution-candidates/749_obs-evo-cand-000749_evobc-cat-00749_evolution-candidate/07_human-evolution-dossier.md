...
Project ID: `obs-evo-cand-000749`
...
- Project ID: `obs-evo-cand-000749`
- EVOBC category candidate ID: `evobc-evo-cat-00749`
- External category reference: `evobc-cat-00749`
- Source category ID: `00749`
- Source label for human review: `仮`
- Source codepoints: `U+4EEE`
...
- `obs-evo-cand-000749-route-category-staging`
...
- `obs-evo-cand-000749-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000749-route-evolution-graph`
