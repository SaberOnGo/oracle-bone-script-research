...
- External category reference: `evobc-cat-10864`
- Source category ID: `10864`
- Source label for human review: `𠣦`
- Source codepoints: `U+208E6`
...
- `obs-evo-cand-010864-route-category-staging`
...
- `obs-evo-cand-010864-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010864-route-evolution-graph`
