...
- External category reference: `evobc-cat-07697`
- Source category ID: `07697`
- Source label for human review: `虔`
...
- `obs-evo-cand-007697-route-category-staging`
...
- `obs-evo-cand-007697-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007697-route-evolution-graph`
