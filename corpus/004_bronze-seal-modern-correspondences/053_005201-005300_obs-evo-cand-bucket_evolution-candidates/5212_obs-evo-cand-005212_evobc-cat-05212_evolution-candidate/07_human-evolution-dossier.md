...
- External category reference: `evobc-cat-05212`
- Source category ID: `05212`
- Source label for human review: `牪`
...
- `obs-evo-cand-005212-route-category-staging`
...
- `obs-evo-cand-005212-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005212-route-evolution-graph`
