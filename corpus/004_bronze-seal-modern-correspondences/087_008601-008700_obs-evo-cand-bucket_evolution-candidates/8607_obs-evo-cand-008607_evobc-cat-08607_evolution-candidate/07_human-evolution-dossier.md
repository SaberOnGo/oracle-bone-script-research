...
- External category reference: `evobc-cat-08607`
- Source category ID: `08607`
- Source label for human review: `贐`
...
- `obs-evo-cand-008607-route-category-staging`
...
- `obs-evo-cand-008607-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008607-route-evolution-graph`
