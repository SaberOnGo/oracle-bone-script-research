# Material Visual Observation / obs-comp-cand-000213 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000213`
- External reference / 外部参照: `obimd-sub-fn6hszube7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011858_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fn6hszube7/fn6hszube7/fn6hszube7.png`
- Checksum / 校验和:
  `369c0ec7b2157bb9e9a8be8579773b3cc788a578093c2579f3090dcc4ad4da59`
...
- Marked-pixel bounds: (82,19)–(167,230); span 86 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.31%。
- 痕迹范围：(82,19)–(167,230)；跨度86 × 212 px；痕迹矩形高于宽。
