# obs-unk-004084 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004084`
- primary external id: `hust-obc-und-L-004084`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/084_obs-unk-004084_h
  ust-obc-und-L-004084_oracle-character-candidate/03_visual-assets/001_asset
  -005677_hust-obc-und-L-004084_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4084/L_？_8765.jpg`
- asset id: `asset-005677`
...
- source class: `HUST-OBC/undeciphered/L/4084/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4084/L_？_8765.jpg`
- asset id: `asset-005677`
...
- Which source records identify obs-unk-004084 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004084？
