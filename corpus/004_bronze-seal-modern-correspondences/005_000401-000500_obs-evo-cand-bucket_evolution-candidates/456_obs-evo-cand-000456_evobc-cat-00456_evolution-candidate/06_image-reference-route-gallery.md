...
- `obs-evo-cand-000456-route-category-staging`
...
- `obs-evo-cand-000456-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000456-route-evolution-graph`
