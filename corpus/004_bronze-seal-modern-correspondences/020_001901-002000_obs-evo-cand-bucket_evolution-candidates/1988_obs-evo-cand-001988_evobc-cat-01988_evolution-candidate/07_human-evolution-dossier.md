...
- External category reference: `evobc-cat-01988`
- Source category ID: `01988`
- Source label for human review: `备`
...
- `obs-evo-cand-001988-route-category-staging`
...
- `obs-evo-cand-001988-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001988-route-evolution-graph`
