...
Project ID: `obs-evo-cand-005475`
...
- Project ID: `obs-evo-cand-005475`
- EVOBC category candidate ID: `evobc-evo-cat-05475`
- External category reference: `evobc-cat-05475`
- Source category ID: `05475`
- Source label for human review: `璣`
- Source codepoints: `U+74A3`
...
- `obs-evo-cand-005475-route-category-staging`
...
- `obs-evo-cand-005475-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005475-route-evolution-graph`
