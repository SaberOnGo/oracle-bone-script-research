# Material Visual Observation / obs-comp-cand-001465 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001465`
- External reference / 外部参照: `obimd-sub-7jecspy8fk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016042_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7jecspy8fk/7jecspy8fk/7jecspy8fk.png`
- Checksum / 校验和:
  `bee69904fa9173dd4e8d7769fcdf79d8a9e8d170b4d8c456f90e00859f38fa86`
...
- Marked-pixel bounds: (64,52)–(185,191); span 122 × 140 px; the marked
...
- 痕迹范围：(64,52)–(185,191)；跨度122 × 140 px；痕迹矩形近方形。
