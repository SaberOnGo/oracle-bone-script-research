...
Project ID: `obs-evo-cand-011607`
...
- Project ID: `obs-evo-cand-011607`
- EVOBC category candidate ID: `evobc-evo-cat-11607`
- External category reference: `evobc-cat-11607`
- Source category ID: `11607`
- Source label for human review: `𤜪`
- Source codepoints: `U+2472A`
...
- `obs-evo-cand-011607-route-category-staging`
...
- `obs-evo-cand-011607-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011607-route-evolution-graph`
