# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001324
...
| --- | --- | --- | --- |
| `obimd-glyph-link-019779` | 󷢥 | `U+F78A5` | `reviewed_metadata_only` |
| `obimd-glyph-link-019780` | 󷢦 | `U+F78A6` | `reviewed_metadata_only` |
| `obimd-glyph-link-019781` | 󷢧 | `U+F78A7` | `reviewed_metadata_only` |
