...
Project ID: `obs-insc-cw-cand-000533`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000533`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000533` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2530` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `345` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `578` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `41771` [route_present_image_or_text_not_collected]
