...
- External category reference: `evobc-cat-04146`
- Source category ID: `04146`
- Source label for human review: `楎`
- Source codepoints: `U+694E`
...
- `obs-evo-cand-004146-route-category-staging`
...
- `obs-evo-cand-004146-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004146-route-evolution-graph`
