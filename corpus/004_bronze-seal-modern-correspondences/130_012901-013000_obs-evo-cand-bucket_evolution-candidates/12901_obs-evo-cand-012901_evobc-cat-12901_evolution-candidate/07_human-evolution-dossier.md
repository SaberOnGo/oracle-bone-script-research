...
- External category reference: `evobc-cat-12901`
- Source category ID: `12901`
- Source label for human review: `𪾌`
- Source codepoints: `U+2AF8C`
...
- `obs-evo-cand-012901-route-category-staging`
...
- `obs-evo-cand-012901-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012901-route-evolution-graph`
