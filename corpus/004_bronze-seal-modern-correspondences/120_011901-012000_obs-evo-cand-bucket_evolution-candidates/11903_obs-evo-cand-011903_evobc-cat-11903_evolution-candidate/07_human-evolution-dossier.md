...
Project ID: `obs-evo-cand-011903`
...
- Project ID: `obs-evo-cand-011903`
- EVOBC category candidate ID: `evobc-evo-cat-11903`
- External category reference: `evobc-cat-11903`
- Source category ID: `11903`
- Source label for human review: `𥴊`
- Source codepoints: `U+25D0A`
...
- `obs-evo-cand-011903-route-category-staging`
...
- `obs-evo-cand-011903-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011903-route-evolution-graph`
