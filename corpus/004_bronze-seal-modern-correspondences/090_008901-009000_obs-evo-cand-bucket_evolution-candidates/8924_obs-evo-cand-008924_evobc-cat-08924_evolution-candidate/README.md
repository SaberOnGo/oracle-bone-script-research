# obs-evo-cand-008924 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-08924`
- Source label: `辰`
- Source codepoints: `U+8FB0`
- Image reference count: `322`
- Era token counts: `BI:93;CS:1;OBC:142;SAC:5;SS:2;WSC:79`
- Source token counts: `Book:121;Web:201`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 142 image references
- era 1 / BI: 93 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 5 image references
- era 4 / WSC: 79 image references
- era 5 / CS: 1 image references
- source 0 / Web:1633: 2 image references
- source 1 / Web:105952;說文Web:58: 159 image references
