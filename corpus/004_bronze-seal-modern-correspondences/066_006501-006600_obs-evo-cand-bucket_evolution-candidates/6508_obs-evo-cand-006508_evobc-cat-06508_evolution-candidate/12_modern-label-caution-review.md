# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006508
...
- EVOBC candidate category: `evobc-evo-cat-06508`.
- Source label for search only: `絝`.
- Source codepoints for search only: `U+7D5D`.
