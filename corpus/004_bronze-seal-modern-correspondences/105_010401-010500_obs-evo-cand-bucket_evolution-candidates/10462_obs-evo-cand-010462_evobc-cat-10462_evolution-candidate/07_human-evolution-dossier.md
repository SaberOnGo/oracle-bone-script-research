...
- External category reference: `evobc-cat-10462`
- Source category ID: `10462`
- Source label for human review: `鲨`
...
- `obs-evo-cand-010462-route-category-staging`
...
- `obs-evo-cand-010462-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010462-route-evolution-graph`
