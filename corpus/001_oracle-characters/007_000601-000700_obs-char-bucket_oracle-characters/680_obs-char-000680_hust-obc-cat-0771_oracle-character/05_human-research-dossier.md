# obs-char-000680 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/680_obs-char-000680_hust-obc-cat-0771_orac
  le-character/03_visual-assets/001_asset-000685_hust-obc-cat-0771_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0771/G_0771_前4.33.6合18805賓組.png
  `
- asset id: `asset-000685`
...
- source category: `0771`
- validation class: `679`
- source image route: `HUST-OBC/deciphered/0771/G_0771_前4.33.6合18805賓組.png`
- asset id: `asset-000685`
...
- dataset label text: `㛹`
- dataset label codepoints: `U+36F9`
...
- filename catalog route clues: `Heji-like filename clue: 合18805
  (G_0771_前4.33.6合18805賓組.png)`
...
- Which source records identify obs-char-000680 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000680？
