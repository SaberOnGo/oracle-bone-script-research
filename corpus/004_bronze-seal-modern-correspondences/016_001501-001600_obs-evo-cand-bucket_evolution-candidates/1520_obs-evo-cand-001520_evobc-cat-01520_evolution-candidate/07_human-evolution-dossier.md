...
- Project ID: `obs-evo-cand-001520`
- EVOBC category candidate ID: `evobc-evo-cat-01520`
- External category reference: `evobc-cat-01520`
- Source category ID: `01520`
- Source label for human review: `吶`
- Source codepoints: `U+5436`
...
- `obs-evo-cand-001520-route-category-staging`
...
- `obs-evo-cand-001520-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001520-route-evolution-graph`
