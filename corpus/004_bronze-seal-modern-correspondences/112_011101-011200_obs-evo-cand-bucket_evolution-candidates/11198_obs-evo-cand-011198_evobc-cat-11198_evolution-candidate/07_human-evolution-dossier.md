...
- External category reference: `evobc-cat-11198`
- Source category ID: `11198`
- Source label: `𢓄`
...
- `obs-evo-cand-011198-route-category-staging`
...
- `obs-evo-cand-011198-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011198-route-evolution-graph`
