...
- External category reference: `evobc-cat-03455`
- Source category ID: `03455`
- Source label for human review: `搜`
- Source codepoints: `U+641C`
...
- `obs-evo-cand-003455-route-category-staging`
...
- `obs-evo-cand-003455-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003455-route-evolution-graph`
