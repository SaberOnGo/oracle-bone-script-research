# Material Visual Observation / obs-comp-cand-000479 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000479`
- External reference / 外部参照: `obimd-sub-x0wt5y5bs2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012628_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/x0wt5y5bs2/x0wt5y5bs2/0qp8oj43k8.png`
- Checksum / 校验和:
  `15835152f3c0147fc2e4d0c4110bdac30257eb7424f10ec6216a16402dd9d2b7`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.40%.
- Marked-pixel bounds: (53,34)–(196,218); span 144 × 185 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.40%。
- 痕迹范围：(53,34)–(196,218)；跨度144 × 185 px；痕迹矩形高于宽。
