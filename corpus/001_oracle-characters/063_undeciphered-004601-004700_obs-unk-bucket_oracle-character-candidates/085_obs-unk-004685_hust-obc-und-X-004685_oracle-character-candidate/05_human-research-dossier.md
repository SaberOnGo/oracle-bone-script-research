# obs-unk-004685 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004685`
- primary external id: `hust-obc-und-X-004685`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/085_obs-unk-004685_h
  ust-obc-und-X-004685_oracle-character-candidate/03_visual-assets/001_asset
  -006278_hust-obc-und-X-004685_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/241/X_？_8409_1.png`
- asset id: `asset-006278`
...
- source class: `HUST-OBC/undeciphered/X/241/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/241/X_？_8409_1.png`
- asset id: `asset-006278`
...
- English observation: `compact horizontal form with central pale slit`
- 中文观察: `带中央浅色裂隙的紧凑横向形体`
...
- Which source records identify obs-unk-004685 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004685？
