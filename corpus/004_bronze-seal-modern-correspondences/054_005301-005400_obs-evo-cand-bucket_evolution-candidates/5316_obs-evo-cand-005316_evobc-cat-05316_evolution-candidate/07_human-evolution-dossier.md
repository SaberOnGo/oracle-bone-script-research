...
Project ID: `obs-evo-cand-005316`
...
- Project ID: `obs-evo-cand-005316`
- EVOBC category candidate ID: `evobc-evo-cat-05316`
- External category reference: `evobc-cat-05316`
- Source category ID: `05316`
- Source label for human review: `獒`
- Source codepoints: `U+7352`
...
- `obs-evo-cand-005316-route-category-staging`
...
- `obs-evo-cand-005316-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005316-route-evolution-graph`
