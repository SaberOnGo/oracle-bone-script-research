...
- External category reference: `evobc-cat-06629`
- Source category ID: `06629`
- Source label for human review: `縑`
...
- `obs-evo-cand-006629-route-category-staging`
...
- `obs-evo-cand-006629-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006629-route-evolution-graph`
