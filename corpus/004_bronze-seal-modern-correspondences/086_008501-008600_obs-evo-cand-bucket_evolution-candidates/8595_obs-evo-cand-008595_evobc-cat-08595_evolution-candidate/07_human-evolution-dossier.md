...
- Project ID: `obs-evo-cand-008595`
- EVOBC category candidate ID: `evobc-evo-cat-08595`
- External category reference: `evobc-cat-08595`
- Source category ID: `08595`
- Source label for human review: `賸`
- Source codepoints: `U+8CF8`
...
- `obs-evo-cand-008595-route-category-staging`
...
- `obs-evo-cand-008595-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008595-route-evolution-graph`
