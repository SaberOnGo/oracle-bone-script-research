# obs-unk-004806 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/006_obs-unk-004806_h
  ust-obc-und-X-004806_oracle-character-candidate/03_visual-assets/001_asset
  -006399_hust-obc-und-X-004806_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/362/X_？_7345_1.png`
- asset id: `asset-006399`
...
- source class: `HUST-OBC/undeciphered/X/362/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/362/X_？_7345_1.png`
- asset id: `asset-006399`
...
- English observation: `central openings with detached surrounding fragments`
- 中文观察: `中央开口和周围的分离片段`
...
- Which source records identify obs-unk-004806 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004806？
