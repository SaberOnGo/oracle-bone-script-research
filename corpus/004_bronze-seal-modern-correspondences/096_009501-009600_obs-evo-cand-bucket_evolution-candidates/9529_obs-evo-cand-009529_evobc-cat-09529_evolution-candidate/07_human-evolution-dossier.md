...
- External category reference: `evobc-cat-09529`
- Source category ID: `09529`
- Source label for human review: `鐘`
- Source codepoints: `U+9418`
- Image reference count in source metadata: `146`
...
- `obs-evo-cand-009529-route-category-staging`
...
- `obs-evo-cand-009529-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009529-route-evolution-graph`
