...
Project ID: `obs-evo-cand-007544`
...
- Project ID: `obs-evo-cand-007544`
- EVOBC category candidate ID: `evobc-evo-cat-07544`
- External category reference: `evobc-cat-07544`
- Source category ID: `07544`
- Source label for human review: `蓾`
- Source codepoints: `U+84FE`
...
- `obs-evo-cand-007544-route-category-staging`
...
- `obs-evo-cand-007544-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007544-route-evolution-graph`
