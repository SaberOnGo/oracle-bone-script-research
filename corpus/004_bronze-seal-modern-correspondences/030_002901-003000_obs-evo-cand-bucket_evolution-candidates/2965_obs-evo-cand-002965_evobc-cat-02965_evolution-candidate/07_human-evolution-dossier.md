...
- External category reference: `evobc-cat-02965`
- Source category ID: `02965`
- Source label for human review: `恃`
...
- `obs-evo-cand-002965-route-category-staging`
...
- `obs-evo-cand-002965-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002965-route-evolution-graph`
