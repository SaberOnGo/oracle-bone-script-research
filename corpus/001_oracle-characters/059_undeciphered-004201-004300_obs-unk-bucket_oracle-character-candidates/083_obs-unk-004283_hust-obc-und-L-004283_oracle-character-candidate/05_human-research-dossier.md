# obs-unk-004283 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/083_obs-unk-004283_h
  ust-obc-und-L-004283_oracle-character-candidate/03_visual-assets/001_asset
  -005876_hust-obc-und-L-004283_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4283/L_？_9459.jpg`
- asset id: `asset-005876`
...
- source class: `HUST-OBC/undeciphered/L/4283/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4283/L_？_9459.jpg`
- asset id: `asset-005876`
...
- English observation: `Upper slants, central bar, lower box visible.`
- 中文观察: `上部斜痕、中央横痕和下部矩形轮廓可见。`
...
- Which source records identify obs-unk-004283 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004283？
