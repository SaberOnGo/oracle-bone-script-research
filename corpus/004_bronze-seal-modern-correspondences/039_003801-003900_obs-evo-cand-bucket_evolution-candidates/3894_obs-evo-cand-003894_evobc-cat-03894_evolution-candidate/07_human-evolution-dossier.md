...
- External category reference: `evobc-cat-03894`
- Source category ID: `03894`
...
- `obs-evo-cand-003894-route-category-staging`
...
- `obs-evo-cand-003894-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003894-route-evolution-graph`
