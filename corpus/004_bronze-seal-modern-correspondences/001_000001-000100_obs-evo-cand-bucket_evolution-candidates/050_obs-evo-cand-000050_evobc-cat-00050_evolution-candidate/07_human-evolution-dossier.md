...
- External category reference: `evobc-cat-00050`
- Source category ID: `00050`
- Source label for human review: `㚾`
...
- `obs-evo-cand-000050-route-category-staging`
...
- `obs-evo-cand-000050-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000050-route-evolution-graph`
