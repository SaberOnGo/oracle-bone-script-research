...
Project ID: `obs-evo-cand-000944`
...
- Project ID: `obs-evo-cand-000944`
- EVOBC category candidate ID: `evobc-evo-cat-00944`
- External category reference: `evobc-cat-00944`
- Source category ID: `00944`
- Source label for human review: `倽`
- Source codepoints: `U+503D`
...
- `obs-evo-cand-000944-route-category-staging`
...
- `obs-evo-cand-000944-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000944-route-evolution-graph`
