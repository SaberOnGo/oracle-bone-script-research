# obs-unk-004471 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/071_obs-unk-004471_h
  ust-obc-und-X-004471_oracle-character-candidate/03_visual-assets/001_asset
  -006064_hust-obc-und-X-004471_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/27/X_？_8205_1.png`
- asset id: `asset-006064`
...
- source class: `HUST-OBC/undeciphered/X/27/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/27/X_？_8205_1.png`
- asset id: `asset-006064`
...
- English observation: A broad top stroke sits above repeated rounded openings
  and a small crossed lower terminal.
- 中文观察: 宽顶部横痕位于连续圆弧开口和小型交叉下端之上。
...
- Which source records identify obs-unk-004471 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004471？
