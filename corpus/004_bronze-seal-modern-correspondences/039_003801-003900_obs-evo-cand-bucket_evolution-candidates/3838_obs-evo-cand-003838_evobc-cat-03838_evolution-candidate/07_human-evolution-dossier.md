...
- External category reference: `evobc-cat-03838`
- Source category ID: `03838`
- Source label for human review: `朗`
...
- `obs-evo-cand-003838-route-category-staging`
...
- `obs-evo-cand-003838-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003838-route-evolution-graph`
