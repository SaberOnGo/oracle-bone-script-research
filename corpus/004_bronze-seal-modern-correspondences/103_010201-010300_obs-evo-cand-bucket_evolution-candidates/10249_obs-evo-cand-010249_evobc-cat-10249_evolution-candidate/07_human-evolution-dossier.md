...
- External category reference: `evobc-cat-10249`
- Source category ID: `10249`
- Source label for human review: `驍`
- Source codepoints: `U+9A4D`
...
- `obs-evo-cand-010249-route-category-staging`
...
- `obs-evo-cand-010249-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010249-route-evolution-graph`
