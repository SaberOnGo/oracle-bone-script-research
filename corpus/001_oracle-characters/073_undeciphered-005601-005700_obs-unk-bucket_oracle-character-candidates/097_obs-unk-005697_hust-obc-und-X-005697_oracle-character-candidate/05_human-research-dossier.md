# obs-unk-005697 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/073_undeciphered-005
  601-005700_obs-unk-bucket_oracle-character-candidates/097_obs-unk-005697_h
  ust-obc-und-X-005697_oracle-character-candidate/03_visual-assets/001_asset
  -007290_hust-obc-und-X-005697_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1253/X_？_1164_1.png`
- asset id: `asset-007290`
...
- source class: `HUST-OBC/undeciphered/X/1253/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1253/X_？_1164_1.png`
- asset id: `asset-007290`
...
- Which source records identify obs-unk-005697 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005697？
