# obs-char-001048 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1048_obs-char-001048_hust-obc-cat-1175_ora
  cle-character/03_visual-assets/001_asset-001053_hust-obc-cat-1175_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1175/G_1175_坊間4.91(甲).png`
- asset id: `asset-001053`
...
- source category: `1175`
- validation class: `1047`
- source image route: `HUST-OBC/deciphered/1175/G_1175_坊間4.91(甲).png`
- asset id: `asset-001053`
...
- English observation: `A star-like upper crossing sits above a horizontal
  bar and a single descending upright stroke.`
- 中文观察: `星状上部交叉笔位于水平横笔和一条单独下行直立笔之上。`
...
- dataset label text: `㢍`
- dataset label codepoints: `U+388D`
...
- Which source records identify obs-char-001048 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001048？
