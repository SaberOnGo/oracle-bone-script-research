# obs-unk-003389 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003389`
- primary external id: `hust-obc-und-L-003389`
...
- local review image route: `corpus/001_oracle-characters/050_undeciphered-003
  301-003400_obs-unk-bucket_oracle-character-candidates/089_obs-unk-003389_h
  ust-obc-und-L-003389_oracle-character-candidate/03_visual-assets/001_asset
  -004982_hust-obc-und-L-003389_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3389/L_？_6493.jpg`
- asset id: `asset-004982`
...
- source class: `HUST-OBC/undeciphered/L/3389/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3389/L_？_6493.jpg`
- asset id: `asset-004982`
...
- Which source records identify obs-unk-003389 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003389？
