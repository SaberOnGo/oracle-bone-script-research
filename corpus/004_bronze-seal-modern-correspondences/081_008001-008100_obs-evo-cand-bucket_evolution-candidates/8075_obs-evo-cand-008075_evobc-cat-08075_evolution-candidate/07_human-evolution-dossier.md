...
Project ID: `obs-evo-cand-008075`
...
- Project ID: `obs-evo-cand-008075`
- EVOBC category candidate ID: `evobc-evo-cat-08075`
- External category reference: `evobc-cat-08075`
- Source category ID: `08075`
- Source label for human review: `覰`
- Source codepoints: `U+89B0`
...
- `obs-evo-cand-008075-route-category-staging`
...
- `obs-evo-cand-008075-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008075-route-evolution-graph`
