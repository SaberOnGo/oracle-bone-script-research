...
Project ID: `obs-evo-cand-009639`
...
- Project ID: `obs-evo-cand-009639`
- EVOBC category candidate ID: `evobc-evo-cat-09639`
- External category reference: `evobc-cat-09639`
- Source category ID: `09639`
- Source label for human review: `閵`
- Source codepoints: `U+95B5`
...
- `obs-evo-cand-009639-route-category-staging`
...
- `obs-evo-cand-009639-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009639-route-evolution-graph`
