# obs-char-000261 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/261_obs-char-000261_hust-obc-cat-0293_orac
  le-character/03_visual-assets/001_asset-000266_hust-obc-cat-0293_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0293/G_0293_乙5312反(甲).png`
- asset id: `asset-000266`
...
- source category: `0293`
- validation class: `260`
- source image route: `HUST-OBC/deciphered/0293/G_0293_乙5312反(甲).png`
- asset id: `asset-000266`
...
- English observation: `The small image shows a thin curved stroke
  descending from the upper left, with a short branch extending near the
  lower junction.`
- 中文观察: `小型图像有一道从左上向下弯曲的细笔画，靠近下部连接处另有短分支。`
...
- dataset label text: `㔛`
- dataset label codepoints: `U+351B`
...
- Which source records identify obs-char-000261 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000261？
