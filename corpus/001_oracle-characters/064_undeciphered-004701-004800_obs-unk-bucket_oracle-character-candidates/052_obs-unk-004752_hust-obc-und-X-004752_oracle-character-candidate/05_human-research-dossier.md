# obs-unk-004752 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004752`
- primary external id: `hust-obc-und-X-004752`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/052_obs-unk-004752_h
  ust-obc-und-X-004752_oracle-character-candidate/03_visual-assets/001_asset
  -006345_hust-obc-und-X-004752_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/308/X_？_7293_1.png`
- asset id: `asset-006345`
...
- source class: `HUST-OBC/undeciphered/X/308/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/308/X_？_7293_1.png`
- asset id: `asset-006345`
...
- English observation: `dense upper mass with long central opening`
- 中文观察: `带中央长开口的密集上部笔画组`
...
- Which source records identify obs-unk-004752 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004752？
