# obs-unk-000941 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000941`
- primary external id: `hust-obc-und-L-000941`
...
- local review image route: `corpus/001_oracle-characters/026_undeciphered-000
  901-001000_obs-unk-bucket_oracle-character-candidates/041_obs-unk-000941_h
  ust-obc-und-L-000941_oracle-character-candidate/03_visual-assets/001_asset
  -002534_hust-obc-und-L-000941_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/941/L_？_1267.jpg`
- asset id: `asset-002534`
...
- source class: `HUST-OBC/undeciphered/L/941/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/941/L_？_1267.jpg`
- asset id: `asset-002534`
...
- Which source records identify obs-unk-000941 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000941？
