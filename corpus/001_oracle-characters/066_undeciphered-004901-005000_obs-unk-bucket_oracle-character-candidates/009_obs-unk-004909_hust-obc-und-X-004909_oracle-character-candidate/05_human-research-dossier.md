# obs-unk-004909 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004909`
- primary external id: `hust-obc-und-X-004909`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/009_obs-unk-004909_h
  ust-obc-und-X-004909_oracle-character-candidate/03_visual-assets/001_asset
  -006502_hust-obc-und-X-004909_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/465/X_？_7450_1.png`
- asset id: `asset-006502`
...
- The left group has four light openings; a right stroke branches below.
- The single source view is present locally.
- 直接记录：`14_material-visual-observation.md`
- 左侧结构有四处浅色开口；右侧笔画在下部发生分枝。
- 单一来源视图已在本地保存。
...
- source class: `HUST-OBC/undeciphered/X/465/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/465/X_？_7450_1.png`
- asset id: `asset-006502`
...
- Which source records identify obs-unk-004909 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004909？
