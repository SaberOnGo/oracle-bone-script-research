...
- External category reference: `evobc-cat-03724`
- Source category ID: `03724`
- Source label for human review: `昭`
- Source codepoints: `U+662D`
...
- `obs-evo-cand-003724-route-category-staging`
...
- `obs-evo-cand-003724-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003724-route-evolution-graph`
