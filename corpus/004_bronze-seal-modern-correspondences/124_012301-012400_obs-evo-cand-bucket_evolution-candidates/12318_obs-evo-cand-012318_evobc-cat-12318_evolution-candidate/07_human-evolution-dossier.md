...
- External category reference: `evobc-cat-12318`
- Source category ID: `12318`
- Source label: `𨇪`
...
- `obs-evo-cand-012318-route-category-staging`
...
- `obs-evo-cand-012318-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012318-route-evolution-graph`
