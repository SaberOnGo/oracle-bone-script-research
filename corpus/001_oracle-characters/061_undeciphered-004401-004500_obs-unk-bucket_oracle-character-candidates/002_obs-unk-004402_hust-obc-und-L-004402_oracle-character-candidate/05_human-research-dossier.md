# obs-unk-004402 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004402`
- primary external id: `hust-obc-und-L-004402`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/002_obs-unk-004402_h
  ust-obc-und-L-004402_oracle-character-candidate/03_visual-assets/001_asset
  -005995_hust-obc-und-L-004402_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4402/L_？_9832.jpg`
- asset id: `asset-005995`
...
- source class: `HUST-OBC/undeciphered/L/4402/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4402/L_？_9832.jpg`
- asset id: `asset-005995`
...
- English observation: `An upper branch leads into a dark diagonal trace and a`
  `slightly widened lower turn.`
- 中文观察: `上部叉痕进入深色斜痕，下端略变宽并转折。`
...
- Which source records identify obs-unk-004402 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004402？
