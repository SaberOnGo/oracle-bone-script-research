...
- `obs-evo-cand-005215-route-category-staging`
...
- `obs-evo-cand-005215-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005215-route-evolution-graph`
