# Material Visual Observation / obs-comp-cand-000115 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000115`
- External reference / 外部参照: `obimd-sub-fy8197yoy0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011527_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fy8197yoy0/fy8197yoy0/fy8197yoy0.png`
- Checksum / 校验和:
  `802829107f39e378d2f0420750cad5459dfb815efe3f70787b184c582dbf0224`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 16.64%.
- Marked-pixel bounds: (57,20)–(218,231); span 162 × 212 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占16.64%。
- 痕迹范围：(57,20)–(218,231)；跨度162 × 212 px；痕迹矩形高于宽。
