# obs-char-001234 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1234_obs-char-001234_hust-obc-cat-1381_ora
  cle-character/03_visual-assets/001_asset-001239_hust-obc-cat-1381_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1381/X_1381_1238_1.png`
- asset id: `asset-001239`
...
- source category: `1381`
- validation class: `1233`
- source image route: `HUST-OBC/deciphered/1381/X_1381_1238_1.png`
- asset id: `asset-001239`
...
- English observation: `A tall complex form has an upper pointed loop, a
  long central stroke, a lower branching cluster, and a detached right
  line.`
...
- dataset label text: `㥛`
- dataset label codepoints: `U+395B`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00128`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00128`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00128`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/128_obs-evo-can
  d-000128_evobc-cat-00128_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/128_obs-evo-cand-000128_evobc-cat-00128_evolu
...
- Which source records identify obs-char-001234 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001234？
