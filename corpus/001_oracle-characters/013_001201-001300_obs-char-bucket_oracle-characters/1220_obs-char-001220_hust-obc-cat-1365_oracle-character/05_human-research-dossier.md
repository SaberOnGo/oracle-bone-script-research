# obs-char-001220 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1220_obs-char-001220_hust-obc-cat-1365_ora
  cle-character/03_visual-assets/001_asset-001225_hust-obc-cat-1365_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1365/G_1365_乙8013合462賓組.png`
- asset id: `asset-001225`
...
- source category: `1365`
- validation class: `1219`
- source image route: `HUST-OBC/deciphered/1365/G_1365_乙8013合462賓組.png`
- asset id: `asset-001225`
...
- English observation: `A horizontal rounded enclosure has three inner
  vertical divisions and tapered ends on both sides.`
- 中文观察: `横向圆弧框廓有三个内部竖向分隔，两侧末端逐渐收尖。`
...
- dataset label text: `㥋`
- dataset label codepoints: `U+394B`
...
- filename catalog route clues: `Heji-like filename clue: 合462
  (G_1365_乙8013合462賓組.png)`
...
- Which source records identify obs-char-001220 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001220？
