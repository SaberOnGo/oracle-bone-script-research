...
Project ID: `obs-insc-cw-cand-000089`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000089`
...
- Yingguo / 英国所藏: `y553` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `94` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `389` in source row; primary catalog entry pending
- Heji / 合集: `40402` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000089`
