# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008880
...
- EVOBC candidate category: `evobc-evo-cat-08880`.
- Source label for search only: `轚`.
- Source codepoints for search only: `U+8F5A`.
