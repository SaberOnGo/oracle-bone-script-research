...
- Project ID / 项目 ID: `obs-char-000538`
- Primary external ID / 首选外部 ID: `hust-obc-cat-0612`
...
- Source image / 来源图: `G_0612_後2.30.8合26845出組.png`
- Image / 图像: `001_asset-000543_hust-obc-cat-0612_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合26845
  (G_0612_後2.30.8合26845出組.png)`
...
- Source label text / 来源标签文字: `㙚`
- Source label codepoint / 来源标签 codepoint: `U+365A`
