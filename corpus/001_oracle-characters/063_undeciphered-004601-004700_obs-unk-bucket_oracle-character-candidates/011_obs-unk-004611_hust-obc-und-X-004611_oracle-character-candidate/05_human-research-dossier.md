# obs-unk-004611 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/011_obs-unk-004611_h
  ust-obc-und-X-004611_oracle-character-candidate/03_visual-assets/001_asset
  -006204_hust-obc-und-X-004611_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/167/X_？_8343_1.png`
- asset id: `asset-006204`
...
- source class: `HUST-OBC/undeciphered/X/167/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/167/X_？_8343_1.png`
- asset id: `asset-006204`
...
- English observation: `broad dark mass, three projections, baseline`
- 中文观察: `宽大深色形体、三条分支和水平底痕已记录。`
...
- Which source records identify obs-unk-004611 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004611？
