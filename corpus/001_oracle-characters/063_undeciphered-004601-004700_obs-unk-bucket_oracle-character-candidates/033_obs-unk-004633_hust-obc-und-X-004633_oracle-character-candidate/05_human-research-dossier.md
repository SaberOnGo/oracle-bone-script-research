# obs-unk-004633 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/033_obs-unk-004633_h
  ust-obc-und-X-004633_oracle-character-candidate/03_visual-assets/001_asset
  -006226_hust-obc-und-X-004633_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/189/X_？_8363_1.png`
- asset id: `asset-006226`
...
- source class: `HUST-OBC/undeciphered/X/189/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/189/X_？_8363_1.png`
- asset id: `asset-006226`
...
- English observation: `outer enclosure, inner loop, extended baseline`
- 中文观察: `外围框状轮廓、内部环状形体和延伸底痕已记录。`
...
- Which source records identify obs-unk-004633 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004633？
