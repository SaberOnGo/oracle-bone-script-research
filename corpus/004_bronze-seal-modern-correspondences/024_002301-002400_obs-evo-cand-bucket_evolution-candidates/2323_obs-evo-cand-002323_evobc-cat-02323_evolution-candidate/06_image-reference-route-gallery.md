...
- `obs-evo-cand-002323-route-category-staging`
...
- `obs-evo-cand-002323-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002323-route-evolution-graph`
