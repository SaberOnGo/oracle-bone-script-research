# obs-char-000333 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/333_obs-char-000333_hust-obc-cat-0375_0376
  _oracle-character/03_visual-assets/001_asset-000338_hust-obc-cat-0375_0376
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0375_0376/0375/G_0375_甲骨文0.png`
- asset id: `asset-000338`
...
- source category: `0375_0376`
- validation class: `332`
- source image route: `HUST-OBC/deciphered/0375_0376/0375/G_0375_甲骨文0.png`
- asset id: `asset-000338`
...
- English observation: `The tall rectangular enclosure contains one long
  interior vertical stroke with a slight diagonal change.`
- 中文观察: `高直方形闭合轮廓内部有一条长直笔画，并在中部略有斜向变化。`
...
- dataset label text: `㕭㕮`
- dataset label codepoints: `U+356D;U+356E`
...
- Which source records identify obs-char-000333 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000333？
