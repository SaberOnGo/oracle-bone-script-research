# obs-unk-004361 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/061_obs-unk-004361_h
  ust-obc-und-L-004361_oracle-character-candidate/03_visual-assets/001_asset
  -005954_hust-obc-und-L-004361_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4361/L_？_9667.jpg`
- asset id: `asset-005954`
...
- source class: `HUST-OBC/undeciphered/L/4361/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4361/L_？_9667.jpg`
- asset id: `asset-005954`
...
- English observation: `Upper angular cluster, lower bowl, and terminals`
  `recorded.`
- 中文观察: `已记录上部斜角痕簇、下部弧痕和末端。`
...
- Which source records identify obs-unk-004361 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004361？
