...
- External category reference: `evobc-cat-02144`
- Source category ID: `02144`
- Source label for human review: `姷`
...
- `obs-evo-cand-002144-route-category-staging`
...
- `obs-evo-cand-002144-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002144-route-evolution-graph`
