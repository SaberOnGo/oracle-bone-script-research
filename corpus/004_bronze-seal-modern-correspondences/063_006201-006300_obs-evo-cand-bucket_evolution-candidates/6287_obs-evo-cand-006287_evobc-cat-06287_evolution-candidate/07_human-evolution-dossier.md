...
- External category reference: `evobc-cat-06287`
- Source category ID: `06287`
- Source label for human review: `箇`
...
- `obs-evo-cand-006287-route-category-staging`
...
- `obs-evo-cand-006287-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006287-route-evolution-graph`
