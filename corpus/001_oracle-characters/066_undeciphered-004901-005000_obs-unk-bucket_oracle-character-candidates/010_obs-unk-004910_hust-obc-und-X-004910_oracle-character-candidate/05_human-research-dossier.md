# obs-unk-004910 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004910`
- primary external id: `hust-obc-und-X-004910`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/010_obs-unk-004910_h
  ust-obc-und-X-004910_oracle-character-candidate/03_visual-assets/001_asset
  -006503_hust-obc-und-X-004910_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/466/X_？_7451_1.png`
- asset id: `asset-006503`
...
- A broad left-to-center stroke meets a right outlined opening.
- The single source view is present locally.
- 直接记录：`14_material-visual-observation.md`
- 一条由左向中央的粗横笔画连接右侧外轮廓开口。
- 单一来源视图已在本地保存。
...
- source class: `HUST-OBC/undeciphered/X/466/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/466/X_？_7451_1.png`
- asset id: `asset-006503`
...
- Which source records identify obs-unk-004910 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004910？
