...
- Project ID: `obs-evo-cand-007546`
- EVOBC category candidate ID: `evobc-evo-cat-07546`
- External category reference: `evobc-cat-07546`
- Source category ID: `07546`
- Source label for human review: `蔆`
- Source codepoints: `U+8506`
...
- `obs-evo-cand-007546-route-category-staging`
...
- `obs-evo-cand-007546-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007546-route-evolution-graph`
