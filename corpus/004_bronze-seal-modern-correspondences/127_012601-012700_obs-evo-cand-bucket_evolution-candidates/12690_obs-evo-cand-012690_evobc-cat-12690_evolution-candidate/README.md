# obs-evo-cand-012690 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-12690`
- Source label: `𩱫`
- Source codepoints: `U+29C6B`
- Image reference count: `110`
- Era token counts: `BI:1;OBC:109`
- Source token counts: `Book:103;Web:7`
...
- source 7 / Book:9676: 58 image references
