# obs-char-000318 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000318`
- primary external id: `hust-obc-cat-0358`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/318_obs-char-000318_hust-obc-cat-0358_orac
  le-character/03_visual-assets/001_asset-000323_hust-obc-cat-0358_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0358/G_0358_乙4518合9774賓組.png`
- asset id: `asset-000323`
...
- source category: `0358`
- validation class: `317`
- source image route: `HUST-OBC/deciphered/0358/G_0358_乙4518合9774賓組.png`
- asset id: `asset-000323`
...
- English observation: `The image has a long upper horizontal stroke, a
  central inverted-angle form, and pointed strokes descending at both
  sides.`
- 中文观察: `图像上方有长横笔画，中部为倒折角形体，两侧向下伸出尖状笔画。`
...
- dataset label text: `㕜`
- dataset label codepoints: `U+355C`
...
- Which source records identify obs-char-000318 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000318？
