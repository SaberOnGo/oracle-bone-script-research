# obs-unk-004111 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/011_obs-unk-004111_h
  ust-obc-und-L-004111_oracle-character-candidate/03_visual-assets/001_asset
  -005704_hust-obc-und-L-004111_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4111/L_？_8847.jpg`
- asset id: `asset-005704`
...
- source class: `HUST-OBC/undeciphered/L/4111/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4111/L_？_8847.jpg`
- asset id: `asset-005704`
...
- English observation: The opened image shows a broad upper form, a narrow
  stem, angular lower strokes, and a right-side descending tail.
- 中文观察：已打开图像可见宽上部形态、窄主干、下部折角和右侧尾笔。
...
- Which source records identify obs-unk-004111 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004111？
