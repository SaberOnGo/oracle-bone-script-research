...
Project ID: `obs-evo-cand-004529`
...
- Project ID: `obs-evo-cand-004529`
- EVOBC category candidate ID: `evobc-evo-cat-04529`
- External category reference: `evobc-cat-04529`
- Source category ID: `04529`
- Source label for human review: `沄`
- Source codepoints: `U+6C84`
...
- `obs-evo-cand-004529-route-category-staging`
...
- `obs-evo-cand-004529-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004529-route-evolution-graph`
