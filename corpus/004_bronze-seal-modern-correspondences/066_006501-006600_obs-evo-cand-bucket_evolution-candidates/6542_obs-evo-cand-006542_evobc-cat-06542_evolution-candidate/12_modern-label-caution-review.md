# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006542
...
- EVOBC candidate category: `evobc-evo-cat-06542`.
- Source label for search only: `綏`.
- Source codepoints for search only: `U+7D8F`.
