...
- External category reference: `evobc-cat-10544`
- Source category ID: `10544`
...
- `obs-evo-cand-010544-route-category-staging`
...
- `obs-evo-cand-010544-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010544-route-evolution-graph`
