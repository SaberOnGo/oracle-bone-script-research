...
- External category reference: `evobc-cat-01144`
- Source category ID: `01144`
- Source label for human review: `冻`
...
- `obs-evo-cand-001144-route-category-staging`
...
- `obs-evo-cand-001144-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001144-route-evolution-graph`
