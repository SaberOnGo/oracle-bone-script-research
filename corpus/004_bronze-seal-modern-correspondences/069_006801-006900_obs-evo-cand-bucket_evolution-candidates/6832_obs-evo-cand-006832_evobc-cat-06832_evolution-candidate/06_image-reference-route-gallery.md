...
- `obs-evo-cand-006832-route-category-staging`
...
- `obs-evo-cand-006832-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006832-route-evolution-graph`
