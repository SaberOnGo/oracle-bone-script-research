# obs-unk-002458 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002458`
- primary external id: `hust-obc-und-L-002458`
...
- local review image route: `corpus/001_oracle-characters/041_undeciphered-002
  401-002500_obs-unk-bucket_oracle-character-candidates/058_obs-unk-002458_h
  ust-obc-und-L-002458_oracle-character-candidate/03_visual-assets/001_asset
  -004051_hust-obc-und-L-002458_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2458/L_？_3597.jpg`
- asset id: `asset-004051`
...
- source class: `HUST-OBC/undeciphered/L/2458/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2458/L_？_3597.jpg`
- asset id: `asset-004051`
...
- Which source records identify obs-unk-002458 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002458？
