# obs-char-001105 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001105`
- primary external id: `hust-obc-cat-1235`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1105_obs-char-001105_hust-obc-cat-1235_ora
  cle-character/03_visual-assets/001_asset-001110_hust-obc-cat-1235_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1235/G_1235_甲骨文0.png`
- asset id: `asset-001110`
...
- source category: `1235`
- validation class: `1104`
- source image route: `HUST-OBC/deciphered/1235/G_1235_甲骨文0.png`
- asset id: `asset-001110`
...
- English observation: `A dense dark left block with several vertical bars
  stands beside a branching right cluster with crossed strokes.`
- 中文观察: `密集深色左侧块状形体有数条竖笔，旁边是带交叉笔的右侧分枝笔群。`
...
- dataset label text: `㣉`
- dataset label codepoints: `U+38C9`
...
- Which source records identify obs-char-001105 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001105？
