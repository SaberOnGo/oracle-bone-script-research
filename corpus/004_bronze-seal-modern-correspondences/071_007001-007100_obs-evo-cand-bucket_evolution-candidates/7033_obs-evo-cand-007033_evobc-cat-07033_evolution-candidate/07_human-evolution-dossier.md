...
- External category reference: `evobc-cat-07033`
- Source category ID: `07033`
- Source label for human review: `胝`
- Source codepoints: `U+80DD`
...
- `obs-evo-cand-007033-route-category-staging`
...
- `obs-evo-cand-007033-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007033-route-evolution-graph`
