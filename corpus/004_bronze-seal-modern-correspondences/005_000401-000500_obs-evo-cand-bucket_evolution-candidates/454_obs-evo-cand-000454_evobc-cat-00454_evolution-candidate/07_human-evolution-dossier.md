...
Project ID: `obs-evo-cand-000454`
...
- Project ID: `obs-evo-cand-000454`
- EVOBC category candidate ID: `evobc-evo-cat-00454`
- External category reference: `evobc-cat-00454`
- Source category ID: `00454`
- Source label for human review: `䞨`
- Source codepoints: `U+47A8`
...
- `obs-evo-cand-000454-route-category-staging`
...
- `obs-evo-cand-000454-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000454-route-evolution-graph`
