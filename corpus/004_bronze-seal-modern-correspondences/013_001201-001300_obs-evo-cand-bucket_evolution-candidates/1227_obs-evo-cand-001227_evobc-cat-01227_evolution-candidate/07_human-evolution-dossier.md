...
- Project ID: `obs-evo-cand-001227`
- EVOBC category candidate ID: `evobc-evo-cat-01227`
- External category reference: `evobc-cat-01227`
- Source category ID: `01227`
- Source label for human review: `剗`
- Source codepoints: `U+5257`
...
- `obs-evo-cand-001227-route-category-staging`
...
- `obs-evo-cand-001227-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001227-route-evolution-graph`
