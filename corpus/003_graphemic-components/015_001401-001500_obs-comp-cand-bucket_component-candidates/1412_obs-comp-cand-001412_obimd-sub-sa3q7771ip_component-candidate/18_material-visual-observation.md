# Material Visual Observation / obs-comp-cand-001412 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001412`
- External reference / 外部参照: `obimd-sub-sa3q7771ip`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015831_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fkhhsjy5jk/sa3q7771ip/sa3q7771ip.png`
- Checksum / 校验和:
  `b884a42bcd923658e67471dca73772bc7c3f6fec9e7d76355982a40d399f08c9`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 14.85%.
- Marked-pixel bounds: (34,22)–(226,222); span 193 × 201 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占14.85%。
- 痕迹范围：(34,22)–(226,222)；跨度193 × 201 px；痕迹矩形近方形。
