...
- External category reference: `evobc-cat-09726`
- Source category ID: `09726`
- Source label for human review: `限`
- Source codepoints: `U+9650`
...
- `obs-evo-cand-009726-route-category-staging`
...
- `obs-evo-cand-009726-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009726-route-evolution-graph`
