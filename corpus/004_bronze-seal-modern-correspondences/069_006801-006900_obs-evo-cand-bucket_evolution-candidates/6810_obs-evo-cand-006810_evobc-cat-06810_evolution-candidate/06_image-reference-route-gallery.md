...
- `obs-evo-cand-006810-route-category-staging`
...
- `obs-evo-cand-006810-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006810-route-evolution-graph`
