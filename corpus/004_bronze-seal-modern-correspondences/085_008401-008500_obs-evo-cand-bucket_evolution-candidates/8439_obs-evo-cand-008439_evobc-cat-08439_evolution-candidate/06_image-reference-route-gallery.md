...
- `obs-evo-cand-008439-route-category-staging`
...
- `obs-evo-cand-008439-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008439-route-evolution-graph`
