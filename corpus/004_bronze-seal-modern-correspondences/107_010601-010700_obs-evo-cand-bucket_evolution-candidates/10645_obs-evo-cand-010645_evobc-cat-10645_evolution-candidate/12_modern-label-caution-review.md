# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010645
...
- EVOBC candidate category: `evobc-evo-cat-10645`.
- Source label for search only: `默`.
- Source codepoints for search only: `U+9ED8`.
