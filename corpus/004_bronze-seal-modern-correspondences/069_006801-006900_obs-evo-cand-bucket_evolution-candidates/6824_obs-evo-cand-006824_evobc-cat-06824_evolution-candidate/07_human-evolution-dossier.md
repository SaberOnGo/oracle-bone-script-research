...
- External category reference: `evobc-cat-06824`
- Source category ID: `06824`
- Source label for human review: `罵`
...
- `obs-evo-cand-006824-route-category-staging`
...
- `obs-evo-cand-006824-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006824-route-evolution-graph`
