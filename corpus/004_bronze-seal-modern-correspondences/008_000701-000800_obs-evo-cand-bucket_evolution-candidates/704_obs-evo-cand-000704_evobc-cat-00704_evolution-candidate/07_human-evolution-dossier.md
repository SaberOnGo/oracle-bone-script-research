...
Project ID: `obs-evo-cand-000704`
...
- Project ID: `obs-evo-cand-000704`
- EVOBC category candidate ID: `evobc-evo-cat-00704`
- External category reference: `evobc-cat-00704`
- Source category ID: `00704`
- Source label for human review: `亨`
- Source codepoints: `U+4EA8`
...
- `obs-evo-cand-000704-route-category-staging`
...
- `obs-evo-cand-000704-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000704-route-evolution-graph`
