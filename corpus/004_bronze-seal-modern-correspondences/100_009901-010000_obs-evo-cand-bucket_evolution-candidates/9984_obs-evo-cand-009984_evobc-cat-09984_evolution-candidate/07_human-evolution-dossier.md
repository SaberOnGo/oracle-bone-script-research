...
- External category reference: `evobc-cat-09984`
- Source category ID: `09984`
- Source label for human review: `領`
...
- `obs-evo-cand-009984-route-category-staging`
...
- `obs-evo-cand-009984-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009984-route-evolution-graph`
