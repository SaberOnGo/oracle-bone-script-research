...
- External category reference: `evobc-cat-00691`
- Source category ID: `00691`
- Source label for human review: `井`
- Source codepoints: `U+4E95`
...
- `obs-evo-cand-000691-route-category-staging`
...
- `obs-evo-cand-000691-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000691-route-evolution-graph`
