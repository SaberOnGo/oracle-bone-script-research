# obs-unk-008821 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008821`
- primary external id: `hust-obc-und-YH-008821`
...
- local review image route: `corpus/001_oracle-characters/105_undeciphered-008
  801-008900_obs-unk-bucket_oracle-character-candidates/021_obs-unk-008821_h
  ust-obc-und-YH-008821_oracle-character-candidate/03_visual-assets/001_asse
  t-010412_hust-obc-und-YH-008821_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60E56/H_？_60E56_0.png`
- asset id: `asset-010412`
...
- source class: `HUST-OBC/undeciphered/Y+H/60E56/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60E56/H_？_60E56_0.png`
- asset id: `asset-010412`
...
- Which source records identify obs-unk-008821 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008821？
