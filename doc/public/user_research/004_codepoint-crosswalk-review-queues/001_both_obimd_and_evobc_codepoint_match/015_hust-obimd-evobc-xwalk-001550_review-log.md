...
- Review log draft ID / 复核日志草稿 ID: `codepoint-crosswalk-review-log-draft-015`
- Codepoint review task ID / codepoint 复核任务 ID: `codepoint-crosswalk-review-015`
...
- Crosswalk candidate ID / 交叉候选 ID: `hust-obimd-evobc-xwalk-001550`
- Suggested oracle character ID / 建议甲骨单字 ID: `obs-char-001550`
- Promotion queue ID / 提升队列 ID: `hust-obc-obs-char-promo-001550`
...
- HUST external ref / HUST 外部引用: `hust-obc-cat-1741`
- HUST label codepoints / HUST 标签 codepoint: `U+3AC3`
- OBIMD main candidates / OBIMD 主字候选: `obimd-main-cand-002692`
- EVOBC category candidates / EVOBC 类别候选: `evobc-evo-cat-00154`
...
- `corpus/001_oracle-characters/016_001501-001600_obs-char-bucket_oracle-characters/001_hust-obc-candidate-packet-manifest.csv`
- `corpus/001_oracle-characters/016_001501-001600_obs-char-bucket_oracle-characters/1550_obs-char-001550_hust-obc-cat-1741_oracle-character/01_candidate-character-packet.json`
...
- Route availability ID: `codepoint-route-availability-015`
...
- Review task ID: `codepoint-crosswalk-review-015`
- Crosswalk candidate ID: `hust-obimd-evobc-xwalk-001550`
- Suggested oracle character ID: `obs-char-001550`
- HUST candidate packet ID: `hust-obc-candidate-packet-001550`
...
- OBIMD row count: `1`
- OBIMD source UIDs: `mm49eilaqb`
- OBIMD review statuses: `obimd-main-cand-002692=reviewed_metadata_only`
- OBIMD rights statuses: `obimd-main-cand-002692=licensed_for_repository`
- EVOBC row count: `1`
- EVOBC source category IDs: `00154`
- EVOBC has bronze refs: `true`
- EVOBC has seal refs: `false`
- EVOBC review statuses: `evobc-evo-cat-00154=reviewed_metadata_only`
- EVOBC rights statuses: `evobc-evo-cat-00154=source_marked_risk_noted`
...
- Does `hust-obimd-evobc-xwalk-001550` remain unpromoted and undeciphered?
