...
Project ID: `obs-insc-cw-cand-000188`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000188`
...
- Yingguo / 英国所藏: `y1151` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `38` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `406` in source row; primary catalog entry pending
- Heji / 合集: `40417` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000188`
