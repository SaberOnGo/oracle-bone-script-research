# obs-unk-006441 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006441`
- primary external id: `hust-obc-und-X-006441`
...
- local review image route: `corpus/001_oracle-characters/081_undeciphered-006
  401-006500_obs-unk-bucket_oracle-character-candidates/041_obs-unk-006441_h
  ust-obc-und-X-006441_oracle-character-candidate/03_visual-assets/001_asset
  -008032_hust-obc-und-X-006441_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1997/X_？_5631_1.png`
- asset id: `asset-008032`
...
- source class: `HUST-OBC/undeciphered/X/1997/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1997/X_？_5631_1.png`
- asset id: `asset-008032`
...
- Which source records identify obs-unk-006441 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006441？
