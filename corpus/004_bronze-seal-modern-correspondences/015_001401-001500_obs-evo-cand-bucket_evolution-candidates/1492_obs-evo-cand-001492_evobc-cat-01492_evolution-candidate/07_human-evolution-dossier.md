...
- External category reference: `evobc-cat-01492`
- Source category ID: `01492`
- Source label for human review: `各`
- Source codepoints: `U+5404`
- Image reference count in source metadata: `275`
...
- `obs-evo-cand-001492-route-category-staging`
...
- `obs-evo-cand-001492-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001492-route-evolution-graph`
