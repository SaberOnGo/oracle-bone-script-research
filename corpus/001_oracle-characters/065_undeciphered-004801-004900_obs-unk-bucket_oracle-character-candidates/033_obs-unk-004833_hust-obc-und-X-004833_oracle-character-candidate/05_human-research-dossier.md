# obs-unk-004833 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/033_obs-unk-004833_h
  ust-obc-und-X-004833_oracle-character-candidate/03_visual-assets/001_asset
  -006426_hust-obc-und-X-004833_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/389/X_？_7372_1.png`
- asset id: `asset-006426`
...
- source class: `HUST-OBC/undeciphered/X/389/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/389/X_？_7372_1.png`
- asset id: `asset-006426`
...
- English observation: `upper inner strokes and lower broad opening`
- 中文观察: `上部内部笔画和下部宽大开口`
...
- Which source records identify obs-unk-004833 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004833？
