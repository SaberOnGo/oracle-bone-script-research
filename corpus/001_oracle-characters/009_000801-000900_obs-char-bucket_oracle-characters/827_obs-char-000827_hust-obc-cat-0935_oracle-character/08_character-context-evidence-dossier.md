...
- Project ID / 项目 ID: `obs-char-000827`
- Primary external ID / 首选外部 ID: `hust-obc-cat-0935`
...
- Source image / 来源图: `L_0935_7356.jpg`
- Image / 图像: `001_asset-000832_hust-obc-cat-0935_glyph.png`
...
- target node: `evobc-evo-cat-00082`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC image references / EvoBC 图像引用数: `31`
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/082_obs-evo-cand-000082_evobc-cat-00082_evoluti
...
- Source label text / 来源标签文字: `㞝`
- Source label codepoint / 来源标签 codepoint: `U+379D`
