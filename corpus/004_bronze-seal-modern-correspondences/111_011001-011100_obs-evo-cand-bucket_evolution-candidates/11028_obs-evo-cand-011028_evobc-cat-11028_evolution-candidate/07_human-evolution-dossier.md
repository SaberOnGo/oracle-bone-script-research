...
Project ID: `obs-evo-cand-011028`
...
- Project ID: `obs-evo-cand-011028`
- EVOBC category candidate ID: `evobc-evo-cat-11028`
- External category reference: `evobc-cat-11028`
- Source category ID: `11028`
- Source label for human review: `𡚪`
- Source codepoints: `U+216AA`
...
- `obs-evo-cand-011028-route-category-staging`
...
- `obs-evo-cand-011028-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011028-route-evolution-graph`
