...
- External category reference: `evobc-cat-08154`
- Source category ID: `08154`
- Source label for human review: `設`
- Source codepoints: `U+8A2D`
...
- `obs-evo-cand-008154-route-category-staging`
...
- `obs-evo-cand-008154-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008154-route-evolution-graph`
