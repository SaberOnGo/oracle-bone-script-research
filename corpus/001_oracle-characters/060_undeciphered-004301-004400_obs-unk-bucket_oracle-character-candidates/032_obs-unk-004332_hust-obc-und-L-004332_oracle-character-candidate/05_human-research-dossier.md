# obs-unk-004332 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004332`
- primary external id: `hust-obc-und-L-004332`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/032_obs-unk-004332_h
  ust-obc-und-L-004332_oracle-character-candidate/03_visual-assets/001_asset
  -005925_hust-obc-und-L-004332_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4332/L_？_9574.jpg`
- asset id: `asset-005925`
...
- source class: `HUST-OBC/undeciphered/L/4332/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4332/L_？_9574.jpg`
- asset id: `asset-005925`
...
- English observation: `Stacked trace groups and lower horizontal mark
  recorded.`
- 中文观察: `已记录分层痕迹组和下部横向痕迹。`
...
- Which source records identify obs-unk-004332 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004332？
