...
- External category reference: `evobc-cat-10084`
- Source category ID: `10084`
- Source label for human review: `飧`
...
- `obs-evo-cand-010084-route-category-staging`
...
- `obs-evo-cand-010084-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010084-route-evolution-graph`
