# obs-char-000174 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000174`
- primary external id: `hust-obc-cat-0191`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/174_obs-char-000174_hust-obc-cat-0191_orac
  le-character/03_visual-assets/001_asset-000179_hust-obc-cat-0191_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0191/G_0191_合33069無名組.png`
- asset id: `asset-000179`
...
- source category: `0191`
- validation class: `173`
- source image route: `HUST-OBC/deciphered/0191/G_0191_合33069無名組.png`
- asset id: `asset-000179`
...
- English observation: `The image has a rounded angular upper loop connected
  to a long curved stroke that descends and hooks toward the lower right.`
- 中文观察: `图像上方有圆弧折角环状形，连接长弯曲笔向下延伸并在右下方收成钩状。`
...
- dataset label text: `㒵`
- dataset label codepoints: `U+34B5`
...
- filename catalog route clues: `Heji-like filename clue: 合33069
  (G_0191_合33069無名組.png)`
...
- Which source records identify obs-char-000174 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000174？
