...
Project ID: `obs-evo-cand-008526`
...
- Project ID: `obs-evo-cand-008526`
- EVOBC category candidate ID: `evobc-evo-cat-08526`
- External category reference: `evobc-cat-08526`
- Source category ID: `08526`
- Source label for human review: `貔`
- Source codepoints: `U+8C94`
...
- `obs-evo-cand-008526-route-category-staging`
...
- `obs-evo-cand-008526-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008526-route-evolution-graph`
