...
- `obs-evo-cand-011039-route-category-staging`
...
- `obs-evo-cand-011039-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011039-route-evolution-graph`
