...
- External category reference: `evobc-cat-07237`
- Source category ID: `07237`
- Source label: `芐`
...
- `obs-evo-cand-007237-route-category-staging`
...
- `obs-evo-cand-007237-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-007237-route-evolution-graph`
