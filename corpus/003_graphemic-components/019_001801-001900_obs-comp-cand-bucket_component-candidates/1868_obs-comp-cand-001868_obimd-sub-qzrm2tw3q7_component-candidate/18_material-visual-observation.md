# Material Visual Observation / obs-comp-cand-001868 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001868`
- External reference / 外部参照: `obimd-sub-qzrm2tw3q7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018247_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/znikm1880t/qzrm2tw3q7/qzrm2tw3q7.png`
- Checksum / 校验和:
  `f71f79d1104d6a6f5182284c2634012e574cc562d3e892f9e0c0f8f3dc8c4bf3`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.20%.
- Marked-pixel bounds: (40,36)–(213,213); span 174 × 178 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.20%。
- 痕迹范围：(40,36)–(213,213)；跨度174 × 178 px；痕迹矩形近方形。
