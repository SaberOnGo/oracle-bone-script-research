# obs-unk-003598 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003598`
- primary external id: `hust-obc-und-L-003598`
...
- local review image route: `corpus/001_oracle-characters/052_undeciphered-003
  501-003600_obs-unk-bucket_oracle-character-candidates/098_obs-unk-003598_h
  ust-obc-und-L-003598_oracle-character-candidate/03_visual-assets/001_asset
  -005191_hust-obc-und-L-003598_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3598/L_？_7263.jpg`
- asset id: `asset-005191`
...
- source class: `HUST-OBC/undeciphered/L/3598/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3598/L_？_7263.jpg`
- asset id: `asset-005191`
...
- Which source records identify obs-unk-003598 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003598？
