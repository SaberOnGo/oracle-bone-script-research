# Material Visual Observation / obs-comp-cand-000884 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000884`
- External reference / 外部参照: `obimd-sub-bwfz1jvlck`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013956_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bwfz1jvlck/bwfz1jvlck/bwfz1jvlck.png`
- Checksum / 校验和:
  `fb167882fd178b2f2e88a9d7a97ac1310ffa61d862f9979f629c8b316d7173db`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.61%.
- Marked-pixel bounds: (89,27)–(171,225); span 83 × 199 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.61%。
- 痕迹范围：(89,27)–(171,225)；跨度83 × 199 px；痕迹矩形高于宽。
