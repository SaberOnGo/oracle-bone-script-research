# obs-evo-cand-012682 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-012682`
- EVOBC category candidate ID: `evobc-evo-cat-12682`
- External category ref: `evobc-cat-12682`
- Source label: `𩰫`
- Source codepoints: `U+29C2B`
- Image reference count: `16`
- Era token counts: `BI:16`
- Source token counts: `Book:4;Web:12`
