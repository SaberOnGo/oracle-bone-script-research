# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006103
...
- EVOBC candidate category: `evobc-evo-cat-06103`.
- Source label for search only: `稞`.
- Source codepoints for search only: `U+7A1E`.
