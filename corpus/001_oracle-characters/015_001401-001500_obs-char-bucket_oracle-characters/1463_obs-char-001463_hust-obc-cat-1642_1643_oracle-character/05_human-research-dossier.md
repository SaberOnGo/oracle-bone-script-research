# obs-char-001463 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001463`
- primary external id: `hust-obc-cat-1642_1643`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1463_obs-char-001463_hust-obc-cat-1642_164
  3_oracle-character/03_visual-assets/001_asset-001468_hust-obc-cat-1642_164
  3_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1642_1643/1642/G_1642_佚740(甲).p
  ng`
- asset id: `asset-001468`
...
- source category: `1642_1643`
- validation class: `1462`
- source image route: `HUST-OBC/deciphered/1642_1643/1642/G_1642_佚740(甲).png`
- asset id: `asset-001468`
...
- English observation: `A symmetrical pointed upper cluster sits above a
  dense lower stem.`
- 中文观察: `对称尖状上部笔画群位于密集下部竖干之上。`
...
- dataset label text: `㩠㩡`
- dataset label codepoints: `U+3A60;U+3A61`
...
- graph edge count: `2`
- codepoint routes: `U+3A60;U+3A61`
...
- Which source records identify obs-char-001463 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001463？
