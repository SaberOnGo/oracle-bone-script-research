# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006839
...
- EVOBC candidate category: `evobc-evo-cat-06839`.
- Source label for search only: `羍`.
- Source codepoints for search only: `U+7F8D`.
