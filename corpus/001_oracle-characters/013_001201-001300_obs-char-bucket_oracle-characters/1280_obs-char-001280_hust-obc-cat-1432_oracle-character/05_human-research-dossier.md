# obs-char-001280 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1280_obs-char-001280_hust-obc-cat-1432_ora
  cle-character/03_visual-assets/001_asset-001285_hust-obc-cat-1432_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1432/G_1432_乙1968(甲).png`
- asset id: `asset-001285`
...
- source category: `1432`
- validation class: `1279`
- source image route: `HUST-OBC/deciphered/1432/G_1432_乙1968(甲).png`
- asset id: `asset-001285`
...
- English observation: `A narrow upright form has crossed upper strokes, a
  rectangular middle enclosure, and paired lower branches.`
- 中文观察: `狭长直立形体有交叉上部笔画、矩形中部框形和成对下部分枝。`
...
- dataset label text: `㦎`
- dataset label codepoints: `U+398E`
...
- Which source records identify obs-char-001280 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001280？
