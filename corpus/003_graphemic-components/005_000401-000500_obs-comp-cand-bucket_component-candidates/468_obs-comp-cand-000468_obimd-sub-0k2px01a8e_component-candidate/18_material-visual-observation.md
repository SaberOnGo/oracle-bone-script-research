# Material Visual Observation / obs-comp-cand-000468 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000468`
- External reference / 外部参照: `obimd-sub-0k2px01a8e`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012620_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0k2px01a8e/0k2px01a8e/0k2px01a8e.png`
- Checksum / 校验和:
  `0d8f3536fd6acb94b632787ae723d1ee7f3c8249bc187a17ce29c43493ba7554`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.65%.
- Marked-pixel bounds: (72,25)–(177,223); span 106 × 199 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.65%。
- 痕迹范围：(72,25)–(177,223)；跨度106 × 199 px；痕迹矩形高于宽。
