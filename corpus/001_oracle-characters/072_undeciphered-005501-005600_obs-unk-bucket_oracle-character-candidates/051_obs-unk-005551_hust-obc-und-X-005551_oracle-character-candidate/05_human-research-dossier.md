# obs-unk-005551 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/072_undeciphered-005
  501-005600_obs-unk-bucket_oracle-character-candidates/051_obs-unk-005551_h
  ust-obc-und-X-005551_oracle-character-candidate/03_visual-assets/001_asset
  -007144_hust-obc-und-X-005551_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1107/X_？_8065_1.png`
- asset id: `asset-007144`
...
- source class: `HUST-OBC/undeciphered/X/1107/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1107/X_？_8065_1.png`
- asset id: `asset-007144`
...
- Which source records identify obs-unk-005551 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005551？
