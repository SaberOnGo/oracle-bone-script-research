...
- External category reference: `evobc-cat-11892`
- Source category ID: `11892`
- Source label for human review: `𥰿`
...
- `obs-evo-cand-011892-route-category-staging`
...
- `obs-evo-cand-011892-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011892-route-evolution-graph`
