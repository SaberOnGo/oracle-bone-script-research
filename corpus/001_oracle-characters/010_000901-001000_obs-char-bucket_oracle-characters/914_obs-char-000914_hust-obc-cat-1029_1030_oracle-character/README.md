# obs-char-000914 Local Object Materials / obs-char-000914 本地对象资料
...
- Project ID / 项目 ID: `obs-char-000914`
- Primary external reference / 首选外部参考: `hust-obc-cat-1029_1030`
- Source / 来源: `src-hust-obc`
- Packet record type / 资料包类型: `oracle_character_candidate_packet`
- Directory / 目录: `corpus/001_oracle-characters/010_000901-001000_obs-char-bucke
  t_oracle-characters/914_obs-char-000914_hust-obc-cat-1029_1030_oracle-characte
  r`
...
- Committed glyph image / 已提交字形图像:
  03_visual-assets/001_asset-000919_hust-obc-cat-1029_1030_glyph.png
