...
Project ID: `obs-evo-cand-011775`
...
- Project ID: `obs-evo-cand-011775`
- EVOBC category candidate ID: `evobc-evo-cat-11775`
- External category reference: `evobc-cat-11775`
- Source category ID: `11775`
- Source label for human review: `𥆋`
- Source codepoints: `U+2518B`
...
- `obs-evo-cand-011775-route-category-staging`
...
- `obs-evo-cand-011775-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011775-route-evolution-graph`
