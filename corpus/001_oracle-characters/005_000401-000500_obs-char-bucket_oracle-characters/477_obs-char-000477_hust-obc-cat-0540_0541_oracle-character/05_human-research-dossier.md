# obs-char-000477 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000477`
- primary external id: `hust-obc-cat-0540_0541`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/477_obs-char-000477_hust-obc-cat-0540_0541
  _oracle-character/03_visual-assets/001_asset-000482_hust-obc-cat-0540_0541
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0540_0541/0540/H_0540_60A4F_0.p
  ng`
- asset id: `asset-000482`
...
- source category: `0540_0541`
- validation class: `476`
- source image route: `HUST-OBC/deciphered/0540_0541/0540/H_0540_60A4F_0.png`
- asset id: `asset-000482`
...
- English observation: `A large bold pointed arch encloses a long central
  horizontal bar, three short marks above it, and three separated vertical
  marks below.`
- 中文观察: `大型粗重尖拱形包围一条中央长横，其上有三处短痕，下方有三条分离竖向痕迹。`
...
- dataset label text: `㘒㘓`
- dataset label codepoints: `U+3612;U+3613`
...
- graph edge count: `2`
- codepoint routes: `U+3612;U+3613`
...
- filename catalog route clues: `catalog-like filename clue: H_0540
  (H_0540_60A4F_0.png)`
...
- Which source records identify obs-char-000477 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000477？
