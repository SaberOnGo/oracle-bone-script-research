...
- Project ID: `obs-evo-cand-013680`
- EVOBC category candidate ID: `evobc-evo-cat-13680`
- External category reference: `evobc-cat-13680`
- Source category ID: `13680`
- Source label for human review: `𮧧`
- Source codepoints: `U+2E9E7`
...
- `obs-evo-cand-013680-route-category-staging`
...
- `obs-evo-cand-013680-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013680-route-evolution-graph`
