# Material Visual Observation / obs-comp-cand-000809 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000809`
- External reference / 外部参照: `obimd-sub-hk6lg5z420`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013605_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/eadbesllam/hk6lg5z420/hk6lg5z420.png`
- Checksum / 校验和:
  `78ceb6a8221fdde1f21ae33ec4106ea49fbe631aded15dc2d2fc7c39d891837c`
...
- Marked-pixel bounds: (69,37)–(180,215); span 112 × 179 px; the marked
...
- 痕迹范围：(69,37)–(180,215)；跨度112 × 179 px；痕迹矩形高于宽。
