# Material Visual Observation / obs-comp-cand-001274 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001274`
- External reference / 外部参照: `obimd-sub-a86w5j02cu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015512_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zu0urjl5fr/a86w5j02cu/a86w5j02cu.png`
- Checksum / 校验和:
  `9c609ce4e26e358c58ba03497358fb8b3914caf1727a458a7c37bae7b15c3ad0`
...
- Marked-pixel bounds: (77,39)–(172,210); span 96 × 172 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.28%。
- 痕迹范围：(77,39)–(172,210)；跨度96 × 172 px；痕迹矩形高于宽。
