# obs-evo-cand-004471 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-004471`
- EVOBC category candidate ID: `evobc-evo-cat-04471`
- External category ref: `evobc-cat-04471`
- Source label: `氒`
- Source codepoints: `U+6C12`
- Image reference count: `270`
- Era token counts: `BI:195;OBC:35;SAC:25;SS:1;WSC:14`
- Source token counts: `Book:187;Web:83`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 35 image references
- era 1 / BI: 195 image references
...
- source 3 / Book:21681: 142 image references
