# obs-unk-002133 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002133`
- primary external id: `hust-obc-und-L-002133`
...
- local review image route: `corpus/001_oracle-characters/038_undeciphered-002
  101-002200_obs-unk-bucket_oracle-character-candidates/033_obs-unk-002133_h
  ust-obc-und-L-002133_oracle-character-candidate/03_visual-assets/001_asset
  -003726_hust-obc-und-L-002133_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2133/L_？_2405.jpg`
- asset id: `asset-003726`
...
- source class: `HUST-OBC/undeciphered/L/2133/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2133/L_？_2405.jpg`
- asset id: `asset-003726`
...
- Which source records identify obs-unk-002133 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002133？
