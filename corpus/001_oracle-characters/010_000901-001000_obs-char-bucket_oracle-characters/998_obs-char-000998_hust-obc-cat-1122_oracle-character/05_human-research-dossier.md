# obs-char-000998 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000998`
- primary external id: `hust-obc-cat-1122`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/998_obs-char-000998_hust-obc-cat-1122_orac
  le-character/03_visual-assets/001_asset-001003_hust-obc-cat-1122_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1122/L_1122_5261.jpg`
- asset id: `asset-001003`
...
- source category: `1122`
- validation class: `997`
- source image route: `HUST-OBC/deciphered/1122/L_1122_5261.jpg`
- asset id: `asset-001003`
...
- English observation: `The faint gray image shows a small rounded mark
  continuing into a short descending curved stroke; detail is low contrast.`
- 中文观察: `灰度较淡图像显示小型圆弧痕迹延续为短下行弯笔；细节反差较低。`
...
- dataset label text: `㡘`
- dataset label codepoints: `U+3858`
...
- Which source records identify obs-char-000998 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000998？
