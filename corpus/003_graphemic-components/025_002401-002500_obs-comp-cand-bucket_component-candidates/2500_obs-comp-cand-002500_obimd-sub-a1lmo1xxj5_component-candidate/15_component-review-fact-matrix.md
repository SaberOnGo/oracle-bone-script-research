# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002500
...
| Glyph or codepoint route / 字形或码位路线 | 11 OBIMD route rows; examples U+7532;U+FE381; U+FE382; 另有 9 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 11 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
