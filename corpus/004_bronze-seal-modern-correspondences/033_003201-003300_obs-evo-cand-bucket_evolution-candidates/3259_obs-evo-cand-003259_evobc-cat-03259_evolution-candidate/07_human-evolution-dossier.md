...
- External category reference: `evobc-cat-03259`
- Source category ID: `03259`
- Source label for human review: `扫`
...
- `obs-evo-cand-003259-route-category-staging`
...
- `obs-evo-cand-003259-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003259-route-evolution-graph`
