# obs-char-000221 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000221`
- primary external id: `hust-obc-cat-0245`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/221_obs-char-000221_hust-obc-cat-0245_orac
  le-character/03_visual-assets/001_asset-000226_hust-obc-cat-0245_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0245/X_0245_2183_1.png`
- asset id: `asset-000226`
...
- source category: `0245`
- validation class: `220`
- source image route: `HUST-OBC/deciphered/0245/X_0245_2183_1.png`
- asset id: `asset-000226`
...
- English observation: `The image contains several separated forms: a forked
  upper mark, a short upright oval on the left, a long curved stroke on the
  right, and lower hooks.`
- 中文观察: `图像含数处分离形体：上方有分叉痕，左侧有短直椭圆形，右侧有长弯曲笔，下方有钩状笔。`
...
- dataset label text: `㓫`
- dataset label codepoints: `U+34EB`
...
- Which source records identify obs-char-000221 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000221？
