# obs-unk-004330 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/030_obs-unk-004330_h
  ust-obc-und-L-004330_oracle-character-candidate/03_visual-assets/001_asset
  -005923_hust-obc-und-L-004330_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4330/L_？_9562.jpg`
- asset id: `asset-005923`
...
- source class: `HUST-OBC/undeciphered/L/4330/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4330/L_？_9562.jpg`
- asset id: `asset-005923`
...
- English observation: `Compact diagonal cluster and lower-left trace
  recorded.`
- 中文观察: `已记录紧密斜痕组和左下延伸痕迹。`
...
- Which source records identify obs-unk-004330 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004330？
