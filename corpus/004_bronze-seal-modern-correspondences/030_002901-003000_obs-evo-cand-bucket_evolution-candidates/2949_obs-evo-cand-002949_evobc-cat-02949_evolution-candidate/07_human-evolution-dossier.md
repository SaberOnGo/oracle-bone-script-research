...
- External category reference: `evobc-cat-02949`
- Source category ID: `02949`
- Source label for human review: `怩`
- Source codepoints: `U+6029`
...
- `obs-evo-cand-002949-route-category-staging`
...
- `obs-evo-cand-002949-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002949-route-evolution-graph`
