# obs-unk-000544 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000544`
- primary external id: `hust-obc-und-L-000544`
...
- local review image route: `corpus/001_oracle-characters/022_undeciphered-000
  501-000600_obs-unk-bucket_oracle-character-candidates/044_obs-unk-000544_h
  ust-obc-und-L-000544_oracle-character-candidate/03_visual-assets/001_asset
  -002137_hust-obc-und-L-000544_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/544/L_？_11618.jpg`
- asset id: `asset-002137`
...
- source class: `HUST-OBC/undeciphered/L/544/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/544/L_？_11618.jpg`
- asset id: `asset-002137`
...
- Which source records identify obs-unk-000544 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000544？
