# obs-comp-cand-001232 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001232`
- 首选外部 ID: `obimd-sub-epuiyzcv4m`
- OBIMD subcharacter UID: `epuiyzcv4m`
- OBIMD main character UID: `epuiyzcv4m`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+A9996;U+F71BE; U+F71BF; 另有 3 项
