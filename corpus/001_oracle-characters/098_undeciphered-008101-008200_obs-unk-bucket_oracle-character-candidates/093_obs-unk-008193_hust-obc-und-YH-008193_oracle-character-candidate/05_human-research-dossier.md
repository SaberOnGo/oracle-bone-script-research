# obs-unk-008193 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008193`
- primary external id: `hust-obc-und-YH-008193`
...
- local review image route: `corpus/001_oracle-characters/098_undeciphered-008
  101-008200_obs-unk-bucket_oracle-character-candidates/093_obs-unk-008193_h
  ust-obc-und-YH-008193_oracle-character-candidate/03_visual-assets/001_asse
  t-009784_hust-obc-und-YH-008193_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/608A2/Y_？_608A2.jpg`
- asset id: `asset-009784`
...
- source class: `HUST-OBC/undeciphered/Y+H/608A2/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/608A2/Y_？_608A2.jpg`
- asset id: `asset-009784`
...
- Which source records identify obs-unk-008193 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008193？
