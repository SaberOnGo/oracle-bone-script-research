# obs-char-001477 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001477`
- primary external id: `hust-obc-cat-1658_1659`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1477_obs-char-001477_hust-obc-cat-1658_165
  9_oracle-character/03_visual-assets/001_asset-001482_hust-obc-cat-1658_165
  9_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1658_1659/1658/G_1658_乙4534合142
  10賓組.png`
- asset id: `asset-001482`
...
- source category: `1658_1659`
- validation class: `1476`
- source image route: `HUST-OBC/deciphered/1658_1659/1658/G_1658_乙4534合14210賓組
  .png`
- asset id: `asset-001482`
...
- English observation: `A peaked upper stem sits above a small divided
  enclosure and two prongs.`
- 中文观察: `尖拱上部竖干位于小型隔分框形和两个分叉之上。`
...
- dataset label text: `㩰㩱`
- dataset label codepoints: `U+3A70;U+3A71`
...
- graph edge count: `2`
- codepoint routes: `U+3A70;U+3A71`
...
- filename catalog route clues: `Heji-like filename clue: 合14210
  (G_1658_乙4534合14210賓組.png)`
...
- Which source records identify obs-char-001477 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001477？
