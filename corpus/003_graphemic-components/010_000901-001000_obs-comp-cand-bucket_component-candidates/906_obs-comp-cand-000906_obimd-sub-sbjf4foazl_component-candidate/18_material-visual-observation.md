# Material Visual Observation / obs-comp-cand-000906 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000906`
- External reference / 外部参照: `obimd-sub-sbjf4foazl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013978_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/sbjf4foazl/sbjf4foazl/sbjf4foazl.png`
- Checksum / 校验和:
  `17ff1112f3d1982da3923dc9afac214536bf2146507367748c48791155a420f3`
...
- Marked-pixel bounds: (80,32)–(169,218); span 90 × 187 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.55%。
- 痕迹范围：(80,32)–(169,218)；跨度90 × 187 px；痕迹矩形高于宽。
