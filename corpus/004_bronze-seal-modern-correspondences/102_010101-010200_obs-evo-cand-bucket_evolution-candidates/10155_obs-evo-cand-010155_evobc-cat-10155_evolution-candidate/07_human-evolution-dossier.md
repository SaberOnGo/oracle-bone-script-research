...
- Project ID: `obs-evo-cand-010155`
- EVOBC category candidate ID: `evobc-evo-cat-10155`
- External category reference: `evobc-cat-10155`
- Source category ID: `10155`
- Source label for human review: `馘`
- Source codepoints: `U+9998`
...
- `obs-evo-cand-010155-route-category-staging`
...
- `obs-evo-cand-010155-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010155-route-evolution-graph`
