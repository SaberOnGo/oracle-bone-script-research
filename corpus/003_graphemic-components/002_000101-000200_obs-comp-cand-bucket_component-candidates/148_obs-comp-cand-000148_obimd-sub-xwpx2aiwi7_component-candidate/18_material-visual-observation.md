# Material Visual Observation / obs-comp-cand-000148 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000148`
- External reference / 外部参照: `obimd-sub-xwpx2aiwi7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011560_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xwpx2aiwi7/xwpx2aiwi7/xwpx2aiwi7.png`
- Checksum / 校验和:
  `f2596901180f3bbbb66a1f26a297dfe80caa0ba28113dc88b3d715e0edc26165`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.26%.
- Marked-pixel bounds: (57,19)–(192,223); span 136 × 205 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.26%。
- 痕迹范围：(57,19)–(192,223)；跨度136 × 205 px；痕迹矩形高于宽。
