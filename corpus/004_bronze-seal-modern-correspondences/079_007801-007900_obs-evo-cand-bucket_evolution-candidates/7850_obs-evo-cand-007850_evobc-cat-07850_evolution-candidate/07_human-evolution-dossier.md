...
- External category reference: `evobc-cat-07850`
- Source category ID: `07850`
- Source label for human review: `蟊`
...
- `obs-evo-cand-007850-route-category-staging`
...
- `obs-evo-cand-007850-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007850-route-evolution-graph`
