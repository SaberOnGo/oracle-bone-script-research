...
Project ID: `obs-evo-cand-003518`
...
- Project ID: `obs-evo-cand-003518`
- EVOBC category candidate ID: `evobc-evo-cat-03518`
- External category reference: `evobc-cat-03518`
- Source category ID: `03518`
- Source label for human review: `擐`
- Source codepoints: `U+64D0`
...
- `obs-evo-cand-003518-route-category-staging`
...
- `obs-evo-cand-003518-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003518-route-evolution-graph`
