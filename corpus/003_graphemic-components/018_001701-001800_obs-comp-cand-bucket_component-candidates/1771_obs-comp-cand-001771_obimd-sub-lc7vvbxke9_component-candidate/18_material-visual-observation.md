# Material Visual Observation / obs-comp-cand-001771 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001771`
- External reference / 外部参照: `obimd-sub-lc7vvbxke9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017972_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/soaedltvjs/lc7vvbxke9/lc7vvbxke9.png`
- Checksum / 校验和:
  `7c81f9fde0995db808f6cae14794e36582f7108b5c4fdcdf2ac7b8351eea0458`
...
- Marked-pixel bounds: (64,28)–(185,221); span 122 × 194 px; the marked
...
- 痕迹范围：(64,28)–(185,221)；跨度122 × 194 px；痕迹矩形高于宽。
