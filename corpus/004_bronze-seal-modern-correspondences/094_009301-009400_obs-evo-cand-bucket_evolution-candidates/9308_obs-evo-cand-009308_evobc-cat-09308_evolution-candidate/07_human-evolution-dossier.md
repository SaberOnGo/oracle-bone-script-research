...
- External category reference: `evobc-cat-09308`
- Source category ID: `09308`
...
- `obs-evo-cand-009308-route-category-staging`
...
- `obs-evo-cand-009308-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009308-route-evolution-graph`
