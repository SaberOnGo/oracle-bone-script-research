# obs-char-000302 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/302_obs-char-000302_hust-obc-cat-0342_orac
  le-character/03_visual-assets/001_asset-000307_hust-obc-cat-0342_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0342/G_0342_乙825合6457賓組.png`
- asset id: `asset-000307`
...
- source category: `0342`
- validation class: `301`
- source image route: `HUST-OBC/deciphered/0342/G_0342_乙825合6457賓組.png`
- asset id: `asset-000307`
...
- dataset label text: `㕌`
- dataset label codepoints: `U+354C`
...
- Which source records identify obs-char-000302 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000302？
