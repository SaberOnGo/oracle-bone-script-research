# Material Visual Observation / obs-comp-cand-000075 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000075`
- External reference / 外部参照: `obimd-sub-bnyfd3v7j2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011487_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/t4tioxlhov/bnyfd3v7j2/bnyfd3v7j2.png`
- Checksum / 校验和:
  `32dac7be0f9232d98ee156b7b0e84095a378b3929ade28d87b298514826f649a`
...
- Marked-pixel bounds: (82,18)–(167,230); span 86 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.29%。
- 痕迹范围：(82,18)–(167,230)；跨度86 × 213 px；痕迹矩形高于宽。
