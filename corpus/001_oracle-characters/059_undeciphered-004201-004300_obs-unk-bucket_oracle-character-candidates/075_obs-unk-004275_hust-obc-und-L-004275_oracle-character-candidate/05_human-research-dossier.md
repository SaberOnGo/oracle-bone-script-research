# obs-unk-004275 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004275`
- primary external id: `hust-obc-und-L-004275`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/075_obs-unk-004275_h
  ust-obc-und-L-004275_oracle-character-candidate/03_visual-assets/001_asset
  -005868_hust-obc-und-L-004275_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4275/L_？_9440.jpg`
- asset id: `asset-005868`
...
- source class: `HUST-OBC/undeciphered/L/4275/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4275/L_？_9440.jpg`
- asset id: `asset-005868`
...
- English observation: `Upper bar, central trace, lower crossings visible.`
- 中文观察: `上部横痕、中央痕迹和下部交叉痕迹可见。`
...
- Which source records identify obs-unk-004275 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004275？
