...
- External category reference: `evobc-cat-12878`
- Source category ID: `12878`
- Source label for human review: `𪶩`
- Source codepoints: `U+2ADA9`
...
- `obs-evo-cand-012878-route-category-staging`
...
- `obs-evo-cand-012878-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012878-route-evolution-graph`
