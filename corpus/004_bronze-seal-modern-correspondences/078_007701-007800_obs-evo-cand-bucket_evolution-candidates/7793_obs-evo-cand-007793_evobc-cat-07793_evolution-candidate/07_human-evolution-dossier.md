...
Project ID: `obs-evo-cand-007793`
...
- Project ID: `obs-evo-cand-007793`
- EVOBC category candidate ID: `evobc-evo-cat-07793`
- External category reference: `evobc-cat-07793`
- Source category ID: `07793`
- Source label for human review: `蜰`
- Source codepoints: `U+8730`
...
- `obs-evo-cand-007793-route-category-staging`
...
- `obs-evo-cand-007793-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007793-route-evolution-graph`
