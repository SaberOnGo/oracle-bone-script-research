# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006144
...
- EVOBC candidate category: `evobc-evo-cat-06144`.
- Source label for search only: `穵`.
- Source codepoints for search only: `U+7A75`.
