...
- External category reference: `evobc-cat-04658`
- Source category ID: `04658`
- Source label for human review: `浞`
- Source codepoints: `U+6D5E`
...
- `obs-evo-cand-004658-route-category-staging`
...
- `obs-evo-cand-004658-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004658-route-evolution-graph`
