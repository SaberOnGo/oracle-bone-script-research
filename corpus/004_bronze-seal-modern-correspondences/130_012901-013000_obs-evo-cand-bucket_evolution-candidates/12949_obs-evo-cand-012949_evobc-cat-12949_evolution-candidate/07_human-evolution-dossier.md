...
- External category reference: `evobc-cat-12949`
- Source category ID: `12949`
- Source label for human review: `𫑤`
...
- `obs-evo-cand-012949-route-category-staging`
...
- `obs-evo-cand-012949-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012949-route-evolution-graph`
