# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000165
...
| --- | --- | --- | --- |
| `obimd-glyph-link-002152` | 󰼆 | `U+F0F06` | `reviewed_metadata_only` |
| `obimd-glyph-link-002153` | 󰼇 | `U+F0F07` | `reviewed_metadata_only` |
