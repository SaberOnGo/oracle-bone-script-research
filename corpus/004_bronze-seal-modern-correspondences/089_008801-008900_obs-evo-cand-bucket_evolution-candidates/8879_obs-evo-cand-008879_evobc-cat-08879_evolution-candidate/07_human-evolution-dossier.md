...
- Project ID: `obs-evo-cand-008879`
- EVOBC category candidate ID: `evobc-evo-cat-08879`
- External category reference: `evobc-cat-08879`
- Source category ID: `08879`
- Source label for human review: `轙`
- Source codepoints: `U+8F59`
...
- `obs-evo-cand-008879-route-category-staging`
...
- `obs-evo-cand-008879-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008879-route-evolution-graph`
