# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004912
...
- EVOBC candidate category: `evobc-evo-cat-04912`.
- Source label for search only: `潪`.
- Source codepoints for search only: `U+6F6A`.
