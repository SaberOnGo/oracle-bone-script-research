# obs-char-000878 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000878`
- primary external id: `hust-obc-cat-0990`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/878_obs-char-000878_hust-obc-cat-0990_orac
  le-character/03_visual-assets/001_asset-000883_hust-obc-cat-0990_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0990/G_0990_河680合24423出組.png`
- asset id: `asset-000883`
...
- source category: `0990`
- validation class: `877`
- source image route: `HUST-OBC/deciphered/0990/G_0990_河680合24423出組.png`
- asset id: `asset-000883`
...
- English observation: `Several thin curved and diagonal strokes form an
  open lower enclosure; detached short upper marks and right-side strokes
  remain visible.`
- 中文观察: `数条纤细弯曲和斜向笔形成下部开口轮廓；上方分离短笔和右侧笔仍清晰可见。`
...
- dataset label text: `㟔`
- dataset label codepoints: `U+37D4`
...
- filename catalog route clues: `Heji-like filename clue: 合24423
  (G_0990_河680合24423出組.png)`
...
- Which source records identify obs-char-000878 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000878？
