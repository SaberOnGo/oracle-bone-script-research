# Material Visual Observation / obs-comp-cand-002296 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002296`
- External reference / 外部参照: `obimd-sub-0qrnb6jbz5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020315_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/89m3dkhxyy/0qrnb6jbz5/0qrnb6jbz5.png`
- Checksum / 校验和:
  `c94e2ba38e82d99a5daebaab936d25f7b21018ae359fdde04ccf3a0a8f0ee238`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.10%.
- Marked-pixel bounds: (96,40)–(153,204); span 58 × 165 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.10%。
- 痕迹范围：(96,40)–(153,204)；跨度58 × 165 px；痕迹矩形高于宽。
