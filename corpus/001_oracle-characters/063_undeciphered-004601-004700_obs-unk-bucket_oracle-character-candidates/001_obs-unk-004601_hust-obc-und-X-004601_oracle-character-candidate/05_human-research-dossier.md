# obs-unk-004601 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004601`
- primary external id: `hust-obc-und-X-004601`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/001_obs-unk-004601_h
  ust-obc-und-X-004601_oracle-character-candidate/03_visual-assets/001_asset
  -006194_hust-obc-und-X-004601_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/157/X_？_8334_1.png`
- asset id: `asset-006194`
...
- source class: `HUST-OBC/undeciphered/X/157/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/157/X_？_8334_1.png`
- asset id: `asset-006194`
...
- English observation: `Three separated forms, upper caps, and lower hook`
  `recorded.`
- 中文观察: `已记录三个分离形体、顶部横痕和下部钩痕。`
...
- Which source records identify obs-unk-004601 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004601？
