...
Project ID: `obs-evo-cand-004318`
...
- Project ID: `obs-evo-cand-004318`
- EVOBC category candidate ID: `evobc-evo-cat-04318`
- External category reference: `evobc-cat-04318`
- Source category ID: `04318`
- Source label for human review: `櫡`
- Source codepoints: `U+6AE1`
...
- `obs-evo-cand-004318-route-category-staging`
...
- `obs-evo-cand-004318-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004318-route-evolution-graph`
