...
Project ID: `obs-evo-cand-011363`
...
- Project ID: `obs-evo-cand-011363`
- EVOBC category candidate ID: `evobc-evo-cat-11363`
- External category reference: `evobc-cat-11363`
- Source category ID: `11363`
- Source label for human review: `𣀃`
- Source codepoints: `U+23003`
...
- `obs-evo-cand-011363-route-category-staging`
...
- `obs-evo-cand-011363-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011363-route-evolution-graph`
