# obs-unk-004401 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004401`
- primary external id: `hust-obc-und-L-004401`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/001_obs-unk-004401_h
  ust-obc-und-L-004401_oracle-character-candidate/03_visual-assets/001_asset
  -005994_hust-obc-und-L-004401_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4401/L_？_9803.jpg`
- asset id: `asset-005994`
...
- source class: `HUST-OBC/undeciphered/L/4401/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4401/L_？_9803.jpg`
- asset id: `asset-005994`
...
- English observation: `A rounded enclosing outline surrounds crossing`
  `inner traces and a darker lower curve.`
- 中文观察: `近圆弧外轮廓包围交叉内部痕迹，内部下方有较深弧痕。`
...
- Which source records identify obs-unk-004401 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004401？
