...
- `obs-evo-cand-011347-route-category-staging`
...
- `obs-evo-cand-011347-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011347-route-evolution-graph`
