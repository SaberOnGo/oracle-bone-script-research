...
- External category reference: `evobc-cat-01425`
- Source category ID: `01425`
- Source label for human review: `厜`
- Source codepoints: `U+539C`
...
- `obs-evo-cand-001425-route-category-staging`
...
- `obs-evo-cand-001425-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001425-route-evolution-graph`
