# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012928
...
- EVOBC candidate category: `evobc-evo-cat-12928`.
- Source label for search only: `𫋒`.
- Source codepoints for search only: `U+2B2D2`.
