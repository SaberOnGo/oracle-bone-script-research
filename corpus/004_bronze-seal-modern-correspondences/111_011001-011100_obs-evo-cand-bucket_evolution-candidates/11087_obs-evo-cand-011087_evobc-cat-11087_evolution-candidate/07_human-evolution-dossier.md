...
Project ID: `obs-evo-cand-011087`
...
- Project ID: `obs-evo-cand-011087`
- EVOBC category candidate ID: `evobc-evo-cat-11087`
- External category reference: `evobc-cat-11087`
- Source category ID: `11087`
- Source label for human review: `𡫳`
- Source codepoints: `U+21AF3`
...
- `obs-evo-cand-011087-route-category-staging`
...
- `obs-evo-cand-011087-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011087-route-evolution-graph`
