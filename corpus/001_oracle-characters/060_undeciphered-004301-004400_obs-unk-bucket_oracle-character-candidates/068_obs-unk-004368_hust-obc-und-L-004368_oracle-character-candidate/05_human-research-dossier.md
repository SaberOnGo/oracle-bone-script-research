# obs-unk-004368 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/068_obs-unk-004368_h
  ust-obc-und-L-004368_oracle-character-candidate/03_visual-assets/001_asset
  -005961_hust-obc-und-L-004368_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4368/L_？_9694.jpg`
- asset id: `asset-005961`
...
- source class: `HUST-OBC/undeciphered/L/4368/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4368/L_？_9694.jpg`
- asset id: `asset-005961`
...
- English observation: `Left curve, central round mark, and lower descent`
  `recorded.`
- 中文观察: `已记录左侧弧线、中央圆痕和下部下行痕。`
...
- Which source records identify obs-unk-004368 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004368？
