...
Project ID: `obs-evo-cand-012076`
...
- Project ID: `obs-evo-cand-012076`
- EVOBC category candidate ID: `evobc-evo-cat-12076`
- External category reference: `evobc-cat-12076`
- Source category ID: `12076`
- Source label for human review: `𦨢`
- Source codepoints: `U+26A22`
...
- `obs-evo-cand-012076-route-category-staging`
...
- `obs-evo-cand-012076-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012076-route-evolution-graph`
