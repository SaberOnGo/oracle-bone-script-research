...
- External category reference: `evobc-cat-09558`
- Source category ID: `09558`
- Source label for human review: `鑵`
...
- `obs-evo-cand-009558-route-category-staging`
...
- `obs-evo-cand-009558-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009558-route-evolution-graph`
