...
Project ID: `obs-evo-cand-000703`
...
- Project ID: `obs-evo-cand-000703`
- EVOBC category candidate ID: `evobc-evo-cat-00703`
- External category reference: `evobc-cat-00703`
- Source category ID: `00703`
- Source label for human review: `产`
- Source codepoints: `U+4EA7`
...
- `obs-evo-cand-000703-route-category-staging`
...
- `obs-evo-cand-000703-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000703-route-evolution-graph`
