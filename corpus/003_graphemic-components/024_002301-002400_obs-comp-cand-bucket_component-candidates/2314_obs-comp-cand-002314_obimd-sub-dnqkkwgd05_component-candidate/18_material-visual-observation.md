# Material Visual Observation / obs-comp-cand-002314 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002314`
- External reference / 外部参照: `obimd-sub-dnqkkwgd05`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020333_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dnqkkwgd05/dnqkkwgd05/dnqkkwgd05.png`
- Checksum / 校验和:
  `52e3549c95e0eda49344c657bd771ec9350a452f40cf3613b36208c174035991`
...
- Marked-pixel bounds: (76,38)–(169,209); span 94 × 172 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.11%。
- 痕迹范围：(76,38)–(169,209)；跨度94 × 172 px；痕迹矩形高于宽。
