# Material Visual Observation / obs-comp-cand-000962 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000962`
- External reference / 外部参照: `obimd-sub-20tmlpf5rq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014045_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/20tmlpf5rq/20tmlpf5rq/20tmlpf5rq.png`
- Checksum / 校验和:
  `79796bed74633042f128d7167c477ac2740081e9e986d556996126274aaa4e4d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.44%.
- Marked-pixel bounds: (58,50)–(202,202); span 145 × 153 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.44%。
- 痕迹范围：(58,50)–(202,202)；跨度145 × 153 px；痕迹矩形近方形。
