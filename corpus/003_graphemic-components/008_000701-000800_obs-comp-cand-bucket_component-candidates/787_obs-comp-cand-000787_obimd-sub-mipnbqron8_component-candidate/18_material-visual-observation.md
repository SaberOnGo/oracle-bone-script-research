# Material Visual Observation / obs-comp-cand-000787 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000787`
- External reference / 外部参照: `obimd-sub-mipnbqron8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013572_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6p9s6p6wyb/mipnbqron8/2cug6b4hh5.png`
- Checksum / 校验和:
  `2b9319ec82d6ccbbc47a6e874c65e8adae728c688941e18eb6207122682e0dc5`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.70%.
- Marked-pixel bounds: (82,29)–(167,220); span 86 × 192 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.70%。
- 痕迹范围：(82,29)–(167,220)；跨度86 × 192 px；痕迹矩形高于宽。
