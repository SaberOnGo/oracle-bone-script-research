# Material Visual Observation / obs-comp-cand-002152 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002152`
- External reference / 外部参照: `obimd-sub-wgdnu7e9t3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019793_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/k0pxsd02si/wgdnu7e9t3/wgdnu7e9t3.png`
- Checksum / 校验和:
  `9fafba4fc9df3837977b1bb7ca93360e757fea101349718df4743eff669abb29`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.59%.
- Marked-pixel bounds: (63,12)–(199,239); span 137 × 228 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.59%。
- 痕迹范围：(63,12)–(199,239)；跨度137 × 228 px；痕迹矩形高于宽。
