# Human Research Readiness Review / 正式研究准备复核: obs-evo-cand-005259
...
- Source label for lookup only: `狄`.
- Source codepoints for lookup only: `U+72C4`.
- Era/source code rows to open: `11`.
