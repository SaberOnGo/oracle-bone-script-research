# Material Visual Observation / obs-comp-cand-002683 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002683`
- External reference / 外部参照: `obimd-sub-murkq2p90n`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021259_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/econ137w5q/murkq2p90n/murkq2p90n.png`
- Checksum / 校验和:
  `b0d37a8bf728da10631dff94346c2c2502d22e673981a95b6ce93a5d70535c63`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.99%.
- Marked-pixel bounds: (40,53)–(217,187); span 178 × 135 px; the marked
  rectangle is wider than tall.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.99%。
- 痕迹范围：(40,53)–(217,187)；跨度178 × 135 px；痕迹矩形宽于高。
