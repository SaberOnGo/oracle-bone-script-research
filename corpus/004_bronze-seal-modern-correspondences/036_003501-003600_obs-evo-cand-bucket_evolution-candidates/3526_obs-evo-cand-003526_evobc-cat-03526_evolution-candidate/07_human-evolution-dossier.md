...
- External category reference: `evobc-cat-03526`
- Source category ID: `03526`
- Source label for human review: `擣`
- Source codepoints: `U+64E3`
...
- `obs-evo-cand-003526-route-category-staging`
...
- `obs-evo-cand-003526-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003526-route-evolution-graph`
