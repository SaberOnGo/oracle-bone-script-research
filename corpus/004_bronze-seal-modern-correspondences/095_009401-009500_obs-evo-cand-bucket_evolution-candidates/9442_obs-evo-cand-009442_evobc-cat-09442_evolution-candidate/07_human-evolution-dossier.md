...
- External category reference: `evobc-cat-09442`
- Source category ID: `09442`
- Source label for human review: `錫`
- Source codepoints: `U+932B`
...
- `obs-evo-cand-009442-route-category-staging`
...
- `obs-evo-cand-009442-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009442-route-evolution-graph`
