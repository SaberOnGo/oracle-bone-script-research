# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000189
...
| Glyph or codepoint route / 字形或码位路线 | 69 OBIMD route rows; examples U+F11B8; U+F11B9; 另有 67 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 69 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
