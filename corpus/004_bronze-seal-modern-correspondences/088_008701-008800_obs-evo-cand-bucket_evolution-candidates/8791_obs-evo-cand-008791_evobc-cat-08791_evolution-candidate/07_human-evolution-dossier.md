...
- External category reference: `evobc-cat-08791`
- Source category ID: `08791`
...
- `obs-evo-cand-008791-route-category-staging`
...
- `obs-evo-cand-008791-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008791-route-evolution-graph`
