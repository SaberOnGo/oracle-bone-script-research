...
- External category reference: `evobc-cat-11666`
- Source category ID: `11666`
- Source label for human review: `𤲀`
...
- `obs-evo-cand-011666-route-category-staging`
...
- `obs-evo-cand-011666-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011666-route-evolution-graph`
