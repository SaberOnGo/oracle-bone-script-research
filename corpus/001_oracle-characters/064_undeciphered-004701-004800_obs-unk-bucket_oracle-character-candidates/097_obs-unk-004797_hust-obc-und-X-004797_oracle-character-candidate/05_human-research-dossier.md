# obs-unk-004797 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/097_obs-unk-004797_h
  ust-obc-und-X-004797_oracle-character-candidate/03_visual-assets/001_asset
  -006390_hust-obc-und-X-004797_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/353/X_？_7336_1.png`
- asset id: `asset-006390`
...
- source class: `HUST-OBC/undeciphered/X/353/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/353/X_？_7336_1.png`
- asset id: `asset-006390`
...
- English observation: `upper branching group and long lower terminal`
- 中文观察: `上部分支结构和细长下部末端`
...
- Which source records identify obs-unk-004797 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004797？
