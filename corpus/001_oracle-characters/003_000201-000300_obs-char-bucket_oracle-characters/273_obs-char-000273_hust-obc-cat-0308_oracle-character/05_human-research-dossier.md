# obs-char-000273 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/273_obs-char-000273_hust-obc-cat-0308_orac
  le-character/03_visual-assets/001_asset-000278_hust-obc-cat-0308_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0308/G_0308_前2.4.1(甲).png`
- asset id: `asset-000278`
...
- source category: `0308`
- validation class: `272`
- source image route: `HUST-OBC/deciphered/0308/G_0308_前2.4.1(甲).png`
- asset id: `asset-000278`
...
- English observation: `The compact image has an angular outer outline, a
  diagonal internal stroke, and a long thin stroke descending on the right.`
- 中文观察: `小型图像有折角外轮廓，内部有一道斜向笔画，右侧另有长而纤细的下行笔画。`
...
- dataset label text: `㔪`
- dataset label codepoints: `U+352A`
...
- Which source records identify obs-char-000273 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000273？
