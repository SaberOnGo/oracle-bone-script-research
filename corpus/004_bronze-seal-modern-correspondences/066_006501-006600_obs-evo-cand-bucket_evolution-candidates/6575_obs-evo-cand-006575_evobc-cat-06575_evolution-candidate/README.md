# obs-evo-cand-006575 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-006575`
- EVOBC category candidate ID: `evobc-evo-cat-06575`
- External category ref: `evobc-cat-06575`
- Source label: `緄`
- Source codepoints: `U+7DC4`
- Image reference count: `24`
- Era token counts: `SS:1;WSC:23`
- Source token counts: `Book:5;Web:19`
