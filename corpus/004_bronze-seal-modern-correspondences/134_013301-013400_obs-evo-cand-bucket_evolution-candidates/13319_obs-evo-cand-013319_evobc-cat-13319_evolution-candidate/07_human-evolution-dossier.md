...
- External category reference: `evobc-cat-13319`
- Source category ID: `13319`
- Source label for human review: `𬡏`
- Source codepoints: `U+2C84F`
...
- `obs-evo-cand-013319-route-category-staging`
...
- `obs-evo-cand-013319-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013319-route-evolution-graph`
