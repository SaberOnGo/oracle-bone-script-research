# obs-unk-004206 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/006_obs-unk-004206_h
  ust-obc-und-L-004206_oracle-character-candidate/03_visual-assets/001_asset
  -005799_hust-obc-und-L-004206_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4206/L_？_9161.jpg`
- asset id: `asset-005799`
...
- source class: `HUST-OBC/undeciphered/L/4206/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4206/L_？_9161.jpg`
- asset id: `asset-005799`
...
- English observation: `Upper block, lower body, and two inner strokes visible.`
- 中文观察: `上部区域、下部形态和两条内部笔画可见。`
...
- Which source records identify obs-unk-004206 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004206？
