...
- `obs-evo-cand-001339-route-category-staging`
...
- `obs-evo-cand-001339-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001339-route-evolution-graph`
