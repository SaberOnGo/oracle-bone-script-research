# obs-unk-006060 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006060`
- primary external id: `hust-obc-und-X-006060`
...
- local review image route: `corpus/001_oracle-characters/077_undeciphered-006
  001-006100_obs-unk-bucket_oracle-character-candidates/060_obs-unk-006060_h
  ust-obc-und-X-006060_oracle-character-candidate/03_visual-assets/001_asset
  -007652_hust-obc-und-X-006060_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1616/X_？_3403_1.png`
- asset id: `asset-007652`
...
- source class: `HUST-OBC/undeciphered/X/1616/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1616/X_？_3403_1.png`
- asset id: `asset-007652`
...
- Which source records identify obs-unk-006060 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006060？
