...
Project ID: `obs-evo-cand-011953`
...
- Project ID: `obs-evo-cand-011953`
- EVOBC category candidate ID: `evobc-evo-cat-11953`
- External category reference: `evobc-cat-11953`
- Source category ID: `11953`
- Source label for human review: `𦁸`
- Source codepoints: `U+26078`
...
- `obs-evo-cand-011953-route-category-staging`
...
- `obs-evo-cand-011953-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011953-route-evolution-graph`
