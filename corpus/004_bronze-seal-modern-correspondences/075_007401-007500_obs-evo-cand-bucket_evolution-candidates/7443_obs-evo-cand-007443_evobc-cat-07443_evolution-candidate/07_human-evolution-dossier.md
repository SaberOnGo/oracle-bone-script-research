...
- Project ID: `obs-evo-cand-007443`
- EVOBC category candidate ID: `evobc-evo-cat-07443`
- External category reference: `evobc-cat-07443`
- Source category ID: `07443`
- Source label for human review: `萍`
- Source codepoints: `U+840D`
...
- `obs-evo-cand-007443-route-category-staging`
...
- `obs-evo-cand-007443-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007443-route-evolution-graph`
