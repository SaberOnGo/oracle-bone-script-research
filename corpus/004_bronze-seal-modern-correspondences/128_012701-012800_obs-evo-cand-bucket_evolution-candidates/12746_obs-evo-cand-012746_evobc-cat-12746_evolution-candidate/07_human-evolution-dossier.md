...
- External category reference: `evobc-cat-12746`
- Source category ID: `12746`
- Source label for human review: `𪌕`
...
- `obs-evo-cand-012746-route-category-staging`
...
- `obs-evo-cand-012746-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012746-route-evolution-graph`
