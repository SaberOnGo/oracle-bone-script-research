...
- Project ID: `obs-evo-cand-003260`
- EVOBC category candidate ID: `evobc-evo-cat-03260`
- External category reference: `evobc-cat-03260`
- Source category ID: `03260`
- Source label for human review: `扬`
- Source codepoints: `U+626C`
...
- `obs-evo-cand-003260-route-category-staging`
...
- `obs-evo-cand-003260-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003260-route-evolution-graph`
