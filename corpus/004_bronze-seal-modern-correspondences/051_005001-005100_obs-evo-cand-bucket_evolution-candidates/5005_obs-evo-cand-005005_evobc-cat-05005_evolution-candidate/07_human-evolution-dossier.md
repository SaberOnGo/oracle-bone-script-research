...
Project ID: `obs-evo-cand-005005`
...
- Project ID: `obs-evo-cand-005005`
- EVOBC category candidate ID: `evobc-evo-cat-05005`
- External category reference: `evobc-cat-05005`
- Source category ID: `05005`
- Source label for human review: `瀸`
- Source codepoints: `U+7038`
...
- `obs-evo-cand-005005-route-category-staging`
...
- `obs-evo-cand-005005-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005005-route-evolution-graph`
