# Material Visual Observation / obs-comp-cand-000028 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000028`
- External reference / 外部参照: `obimd-sub-8jtrxi583p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011180_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8jtrxi583p/8jtrxi583p/8jtrxi583p.png`
- Checksum / 校验和:
  `042b4d93c7619a420c29c1dbfa4865bc88b661732abe297cb4ff6363c34841a6`
...
- Marked-pixel bounds: (47,16)–(202,234); span 156 × 219 px; the marked
...
- 痕迹范围：(47,16)–(202,234)；跨度156 × 219 px；痕迹矩形高于宽。
