# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012774
...
- EVOBC candidate category: `evobc-evo-cat-12774`.
- Source label for search only: `𪔟`.
- Source codepoints for search only: `U+2A51F`.
