...
- External category reference: `evobc-cat-01882`
- Source category ID: `01882`
- Source label for human review: `埱`
- Source codepoints: `U+57F1`
...
- `obs-evo-cand-001882-route-category-staging`
...
- `obs-evo-cand-001882-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001882-route-evolution-graph`
