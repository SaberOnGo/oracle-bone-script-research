...
- External category reference: `evobc-cat-01317`
- Source category ID: `01317`
- Source label for human review: `勹`
...
- `obs-evo-cand-001317-route-category-staging`
...
- `obs-evo-cand-001317-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001317-route-evolution-graph`
