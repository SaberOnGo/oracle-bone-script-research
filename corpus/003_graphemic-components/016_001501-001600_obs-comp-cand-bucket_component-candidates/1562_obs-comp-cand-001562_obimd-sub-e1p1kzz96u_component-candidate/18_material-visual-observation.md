# Material Visual Observation / obs-comp-cand-001562 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001562`
- External reference / 外部参照: `obimd-sub-e1p1kzz96u`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017109_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/e1p1kzz96u/e1p1kzz96u/e1p1kzz96u.png`
- Checksum / 校验和:
  `7d4dcf52be465095ed84e4025d0b73e7dc1de6069617c5cacff2b60b40c05d26`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.34%.
- Marked-pixel bounds: (72,42)–(177,215); span 106 × 174 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.34%。
- 痕迹范围：(72,42)–(177,215)；跨度106 × 174 px；痕迹矩形高于宽。
