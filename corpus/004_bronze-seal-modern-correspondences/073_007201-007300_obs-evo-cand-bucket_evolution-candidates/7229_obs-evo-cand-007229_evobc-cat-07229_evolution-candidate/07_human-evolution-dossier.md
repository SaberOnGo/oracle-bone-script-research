...
- External category reference: `evobc-cat-07229`
- Source category ID: `07229`
- Source label for human review: `节`
...
- `obs-evo-cand-007229-route-category-staging`
...
- `obs-evo-cand-007229-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007229-route-evolution-graph`
