...
- External category reference: `evobc-cat-06494`
- Source category ID: `06494`
- Source label for human review: `絇`
- Source codepoints: `U+7D47`
...
- `obs-evo-cand-006494-route-category-staging`
...
- `obs-evo-cand-006494-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006494-route-evolution-graph`
