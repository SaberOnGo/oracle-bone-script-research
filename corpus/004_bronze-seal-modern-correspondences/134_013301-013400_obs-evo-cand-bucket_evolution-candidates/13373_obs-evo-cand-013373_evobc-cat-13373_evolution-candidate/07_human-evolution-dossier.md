...
Project ID: `obs-evo-cand-013373`
...
- Project ID: `obs-evo-cand-013373`
- EVOBC category candidate ID: `evobc-evo-cat-13373`
- External category reference: `evobc-cat-13373`
- Source category ID: `13373`
- Source label for human review: `𬩸`
- Source codepoints: `U+2CA78`
...
- `obs-evo-cand-013373-route-category-staging`
...
- `obs-evo-cand-013373-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013373-route-evolution-graph`
