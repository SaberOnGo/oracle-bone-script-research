...
Project ID: `obs-insc-cw-cand-000134`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000134`
...
- Yingguo / 英国所藏: `y729` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `173` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `407` in source row; primary catalog entry pending
- Heji / 合集: `40205` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000134`
