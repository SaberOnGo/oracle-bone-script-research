...
- External category reference: `evobc-cat-02755`
- Source category ID: `02755`
- Source label for human review: `廑`
...
- `obs-evo-cand-002755-route-category-staging`
...
- `obs-evo-cand-002755-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002755-route-evolution-graph`
