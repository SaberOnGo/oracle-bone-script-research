...
Project ID: `obs-evo-cand-005617`
...
- Project ID: `obs-evo-cand-005617`
- EVOBC category candidate ID: `evobc-evo-cat-05617`
- External category reference: `evobc-cat-05617`
- Source category ID: `05617`
- Source label for human review: `疧`
- Source codepoints: `U+75A7`
...
- `obs-evo-cand-005617-route-category-staging`
...
- `obs-evo-cand-005617-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005617-route-evolution-graph`
