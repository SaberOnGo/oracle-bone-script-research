...
Project ID: `obs-evo-cand-001138`
...
- Project ID: `obs-evo-cand-001138`
- EVOBC category candidate ID: `evobc-evo-cat-01138`
- External category reference: `evobc-cat-01138`
- Source category ID: `01138`
- Source label for human review: `冲`
- Source codepoints: `U+51B2`
...
- `obs-evo-cand-001138-route-category-staging`
...
- `obs-evo-cand-001138-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001138-route-evolution-graph`
