...
Project ID: `obs-evo-cand-000319`
...
- Project ID: `obs-evo-cand-000319`
- EVOBC category candidate ID: `evobc-evo-cat-00319`
- External category reference: `evobc-cat-00319`
- Source category ID: `00319`
- Source label for human review: `䋈`
- Source codepoints: `U+42C8`
...
- `obs-evo-cand-000319-route-category-staging`
...
- `obs-evo-cand-000319-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000319-route-evolution-graph`
