...
- Project ID: `obs-evo-cand-004462`
- EVOBC category candidate ID: `evobc-evo-cat-04462`
- External category reference: `evobc-cat-04462`
- Source category ID: `04462`
- Source label for human review: `毹`
- Source codepoints: `U+6BF9`
...
- `obs-evo-cand-004462-route-category-staging`
...
- `obs-evo-cand-004462-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004462-route-evolution-graph`
