...
- External category reference: `evobc-cat-01730`
- Source category ID: `01730`
- Source label for human review: `噴`
- Source codepoints: `U+5674`
...
- `obs-evo-cand-001730-route-category-staging`
...
- `obs-evo-cand-001730-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001730-route-evolution-graph`
