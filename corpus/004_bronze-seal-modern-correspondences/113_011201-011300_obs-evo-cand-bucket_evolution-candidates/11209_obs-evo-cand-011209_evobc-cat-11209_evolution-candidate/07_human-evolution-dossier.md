...
Project ID: `obs-evo-cand-011209`
...
- Project ID: `obs-evo-cand-011209`
- EVOBC category candidate ID: `evobc-evo-cat-11209`
- External category reference: `evobc-cat-11209`
- Source category ID: `11209`
- Source label for human review: `𢔢`
- Source codepoints: `U+22522`
- Image reference count in source metadata: `18`
...
- `obs-evo-cand-011209-route-category-staging`
...
- `obs-evo-cand-011209-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011209-route-evolution-graph`
