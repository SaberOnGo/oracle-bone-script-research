...
Project ID: `obs-evo-cand-000379`
...
- Project ID: `obs-evo-cand-000379`
- EVOBC category candidate ID: `evobc-evo-cat-00379`
- External category reference: `evobc-cat-00379`
- Source category ID: `00379`
- Source label for human review: `䒾`
- Source codepoints: `U+44BE`
...
- `obs-evo-cand-000379-route-category-staging`
...
- `obs-evo-cand-000379-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000379-route-evolution-graph`
