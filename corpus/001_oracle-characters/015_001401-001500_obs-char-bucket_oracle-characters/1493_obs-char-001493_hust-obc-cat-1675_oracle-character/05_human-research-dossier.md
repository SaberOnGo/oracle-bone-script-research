# obs-char-001493 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001493`
- primary external id: `hust-obc-cat-1675`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1493_obs-char-001493_hust-obc-cat-1675_ora
  cle-character/03_visual-assets/001_asset-001498_hust-obc-cat-1675_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1675/G_1675_乙7388反合19269反.png`
- asset id: `asset-001498`
...
- source category: `1675`
- validation class: `1492`
- source image route: `HUST-OBC/deciphered/1675/G_1675_乙7388反合19269反.png`
- asset id: `asset-001498`
...
- English observation: `Several upper bars lead into a central curve and a
  long left stroke.`
- 中文观察: `数条上部横笔连接中央弧线和长左侧笔画。`
...
- dataset label text: `㪁`
- dataset label codepoints: `U+3A81`
...
- filename catalog route clues: `Heji-like filename clue: 合19269
  (G_1675_乙7388反合19269反.png)`
...
- Which source records identify obs-char-001493 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001493？
