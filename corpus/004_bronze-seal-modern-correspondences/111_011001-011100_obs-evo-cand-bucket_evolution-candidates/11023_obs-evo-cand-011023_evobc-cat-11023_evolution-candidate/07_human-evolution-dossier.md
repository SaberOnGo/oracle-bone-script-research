...
Project ID: `obs-evo-cand-011023`
...
- Project ID: `obs-evo-cand-011023`
- EVOBC category candidate ID: `evobc-evo-cat-11023`
- External category reference: `evobc-cat-11023`
- Source category ID: `11023`
- Source label for human review: `𡙷`
- Source codepoints: `U+21677`
...
- `obs-evo-cand-011023-route-category-staging`
...
- `obs-evo-cand-011023-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011023-route-evolution-graph`
