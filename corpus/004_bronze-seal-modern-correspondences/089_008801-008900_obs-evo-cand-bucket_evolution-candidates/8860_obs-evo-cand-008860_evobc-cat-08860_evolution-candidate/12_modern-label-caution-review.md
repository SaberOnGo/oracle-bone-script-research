# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008860
...
- EVOBC candidate category: `evobc-evo-cat-08860`.
- Source label for search only: `輿`.
- Source codepoints for search only: `U+8F3F`.
