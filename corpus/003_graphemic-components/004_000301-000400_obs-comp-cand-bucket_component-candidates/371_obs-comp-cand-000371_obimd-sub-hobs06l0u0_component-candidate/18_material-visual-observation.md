# Material Visual Observation / obs-comp-cand-000371 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000371`
- External reference / 外部参照: `obimd-sub-hobs06l0u0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012294_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lv9rlaeib9/hobs06l0u0/hobs06l0u0.png`
- Checksum / 校验和:
  `e188276a651ce59abffbddd4e46ce39267035f3fda9a0885978d948dd136feb3`
...
- Marked-pixel bounds: (76,24)–(173,224); span 98 × 201 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.96%。
- 痕迹范围：(76,24)–(173,224)；跨度98 × 201 px；痕迹矩形高于宽。
