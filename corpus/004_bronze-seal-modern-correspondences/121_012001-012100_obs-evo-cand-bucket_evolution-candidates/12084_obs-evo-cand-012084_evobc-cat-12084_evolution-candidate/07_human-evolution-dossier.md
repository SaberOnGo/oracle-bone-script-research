...
- External category reference: `evobc-cat-12084`
- Source category ID: `12084`
- Source label for human review: `𦫓`
- Source codepoints: `U+26AD3`
...
- `obs-evo-cand-012084-route-category-staging`
...
- `obs-evo-cand-012084-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012084-route-evolution-graph`
