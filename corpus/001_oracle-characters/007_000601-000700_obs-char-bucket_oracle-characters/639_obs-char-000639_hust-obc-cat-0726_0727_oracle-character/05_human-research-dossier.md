# obs-char-000639 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000639`
- primary external id: `hust-obc-cat-0726_0727`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/639_obs-char-000639_hust-obc-cat-0726_0727
  _oracle-character/03_visual-assets/001_asset-000644_hust-obc-cat-0726_0727
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0726_0727/0726/G_0726_京津2737合79
  25賓組.png`
- asset id: `asset-000644`
...
- source category: `0726_0727`
- validation class: `638`
- source image route: `HUST-OBC/deciphered/0726_0727/0726/G_0726_京津2737合7925賓組
  .png`
- asset id: `asset-000644`
...
- English observation: `The tiny image shows two detached pointed marks at
  left and a narrow bent vertical form at right with a small upper angle and
  long lower tail.`
- 中文观察: `微小图像显示左侧两处分离尖痕，以及右侧带小上折角和长下尾的狭窄弯竖形。`
...
- dataset label text: `㛌㛍`
- dataset label codepoints: `U+36CC;U+36CD`
...
- graph edge count: `2`
- codepoint routes: `U+36CC;U+36CD`
...
- filename catalog route clues: `Heji-like filename clue: 合7925
  (G_0726_京津2737合7925賓組.png)`
...
- Which source records identify obs-char-000639 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000639？
