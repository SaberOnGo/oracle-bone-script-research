# obs-unk-008983 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008983`
- primary external id: `hust-obc-und-YH-008983`
...
- local review image route: `corpus/001_oracle-characters/106_undeciphered-008
  901-009000_obs-unk-bucket_oracle-character-candidates/083_obs-unk-008983_h
  ust-obc-und-YH-008983_oracle-character-candidate/03_visual-assets/001_asse
  t-010574_hust-obc-und-YH-008983_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60FEB/H_？_60FEB_0.png`
- asset id: `asset-010574`
...
- source class: `HUST-OBC/undeciphered/Y+H/60FEB/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60FEB/H_？_60FEB_0.png`
- asset id: `asset-010574`
...
- Which source records identify obs-unk-008983 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008983？
