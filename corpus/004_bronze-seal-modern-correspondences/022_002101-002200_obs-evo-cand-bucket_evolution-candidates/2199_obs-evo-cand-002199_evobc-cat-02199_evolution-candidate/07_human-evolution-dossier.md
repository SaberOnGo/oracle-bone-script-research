...
- External category reference: `evobc-cat-02199`
- Source category ID: `02199`
- Source label for human review: `婚`
...
- `obs-evo-cand-002199-route-category-staging`
...
- `obs-evo-cand-002199-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002199-route-evolution-graph`
