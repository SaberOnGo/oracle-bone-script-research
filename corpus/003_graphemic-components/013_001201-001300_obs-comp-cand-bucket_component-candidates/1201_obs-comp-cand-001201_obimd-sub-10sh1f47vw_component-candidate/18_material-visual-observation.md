# Material Visual Observation / obs-comp-cand-001201 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001201`
- External reference / 外部参照: `obimd-sub-10sh1f47vw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015432_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/10sh1f47vw/10sh1f47vw/10sh1f47vw.png`
- Checksum / 校验和:
  `0344bc79643433113020b67ba57b0722397d01bea73d60b8475e1a9a6b1c2a7c`
...
- Marked-pixel bounds: (77,34)–(172,211); span 96 × 178 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.77%。
- 痕迹范围：(77,34)–(172,211)；跨度96 × 178 px；痕迹矩形高于宽。
