...
Project ID: `obs-evo-cand-012241`
...
- Project ID: `obs-evo-cand-012241`
- EVOBC category candidate ID: `evobc-evo-cat-12241`
- External category reference: `evobc-cat-12241`
- Source category ID: `12241`
- Source label for human review: `𧪞`
- Source codepoints: `U+27A9E`
...
- `obs-evo-cand-012241-route-category-staging`
...
- `obs-evo-cand-012241-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012241-route-evolution-graph`
