# obs-unk-004201 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004201`
- primary external id: `hust-obc-und-L-004201`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/001_obs-unk-004201_h
  ust-obc-und-L-004201_oracle-character-candidate/03_visual-assets/001_asset
  -005794_hust-obc-und-L-004201_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4201/L_？_9151.jpg`
- asset id: `asset-005794`
...
- source class: `HUST-OBC/undeciphered/L/4201/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4201/L_？_9151.jpg`
- asset id: `asset-005794`
...
- English observation: `Lower loop, right stroke, and middle crossing visible.`
- 中文观察: `下部环状痕迹、右侧高笔画和中部交叉处可见。`
...
- Which source records identify obs-unk-004201 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004201？
