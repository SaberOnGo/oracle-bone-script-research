# obs-char-000604 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/604_obs-char-000604_hust-obc-cat-0688_orac
  le-character/03_visual-assets/001_asset-000609_hust-obc-cat-0688_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0688/X_0688_4932_1.png`
- asset id: `asset-000609`
...
- source category: `0688`
- validation class: `603`
- source image route: `HUST-OBC/deciphered/0688/X_0688_4932_1.png`
- asset id: `asset-000609`
...
- English observation: `A long central stroke descends to a sharp point,
  with an angular upper-right branch and large open curved loops on both
  lower sides.`
- 中文观察: `长中央笔向下收成尖端，右上有折角枝笔，下部两侧各有大型开口弯环。`
...
- dataset label text: `㚦`
- dataset label codepoints: `U+36A6`
...
- Which source records identify obs-char-000604 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000604？
