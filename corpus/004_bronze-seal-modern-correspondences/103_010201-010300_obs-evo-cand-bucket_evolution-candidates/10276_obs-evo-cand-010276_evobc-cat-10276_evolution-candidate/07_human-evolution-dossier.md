...
Project ID: `obs-evo-cand-010276`
...
- Project ID: `obs-evo-cand-010276`
- EVOBC category candidate ID: `evobc-evo-cat-10276`
- External category reference: `evobc-cat-10276`
- Source category ID: `10276`
- Source label for human review: `驷`
- Source codepoints: `U+9A77`
...
- `obs-evo-cand-010276-route-category-staging`
...
- `obs-evo-cand-010276-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010276-route-evolution-graph`
