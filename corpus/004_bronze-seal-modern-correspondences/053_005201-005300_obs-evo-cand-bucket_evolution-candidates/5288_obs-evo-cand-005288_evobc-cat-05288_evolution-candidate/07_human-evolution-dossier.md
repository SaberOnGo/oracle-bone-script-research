...
- External category reference: `evobc-cat-05288`
- Source category ID: `05288`
- Source label for human review: `猋`
...
- `obs-evo-cand-005288-route-category-staging`
...
- `obs-evo-cand-005288-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005288-route-evolution-graph`
