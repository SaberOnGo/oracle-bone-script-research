...
- Project ID: `obs-evo-cand-009132`
- EVOBC category candidate ID: `evobc-evo-cat-09132`
- External category reference: `evobc-cat-09132`
- Source category ID: `09132`
- Source label for human review: `郉`
- Source codepoints: `U+90C9`
...
- `obs-evo-cand-009132-route-category-staging`
...
- `obs-evo-cand-009132-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009132-route-evolution-graph`
