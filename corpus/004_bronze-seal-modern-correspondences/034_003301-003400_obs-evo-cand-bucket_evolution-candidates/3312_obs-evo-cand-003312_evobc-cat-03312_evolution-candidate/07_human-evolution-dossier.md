...
Project ID: `obs-evo-cand-003312`
...
- Project ID: `obs-evo-cand-003312`
- EVOBC category candidate ID: `evobc-evo-cat-03312`
- External category reference: `evobc-cat-03312`
- Source category ID: `03312`
- Source label for human review: `拑`
- Source codepoints: `U+62D1`
...
- `obs-evo-cand-003312-route-category-staging`
...
- `obs-evo-cand-003312-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003312-route-evolution-graph`
