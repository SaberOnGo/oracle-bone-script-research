...
- External category reference: `evobc-cat-04498`
- Source category ID: `04498`
- Source label for human review: `汙`
...
- `obs-evo-cand-004498-route-category-staging`
...
- `obs-evo-cand-004498-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004498-route-evolution-graph`
