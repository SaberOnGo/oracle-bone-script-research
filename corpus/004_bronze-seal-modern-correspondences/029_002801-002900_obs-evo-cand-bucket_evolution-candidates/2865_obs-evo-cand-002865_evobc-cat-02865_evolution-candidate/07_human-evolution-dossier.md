...
- External category reference: `evobc-cat-02865`
- Source category ID: `02865`
- Source label for human review: `徉`
...
- `obs-evo-cand-002865-route-category-staging`
...
- `obs-evo-cand-002865-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002865-route-evolution-graph`
