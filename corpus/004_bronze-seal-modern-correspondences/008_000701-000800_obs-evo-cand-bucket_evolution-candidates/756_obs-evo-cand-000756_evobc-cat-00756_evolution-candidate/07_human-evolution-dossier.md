...
- External category reference: `evobc-cat-00756`
- Source category ID: `00756`
- Source label for human review: `任`
...
- `obs-evo-cand-000756-route-category-staging`
...
- `obs-evo-cand-000756-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000756-route-evolution-graph`
