...
Project ID: `obs-insc-cw-cand-000457`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000457`
...
- Source page section: `Period III Group 13` /
  `第 III 期第 13 组`
- Source section key: `period-iii-group-13`
...
- Yingguo / 英国所藏: `y2336` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `592` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `381` in source row; primary catalog entry pending
- Heji / 合集: `41308` in source row; primary catalog entry pending
...
- Group and batch / 组类与批次: group `13`; batch or pit context pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000457`
