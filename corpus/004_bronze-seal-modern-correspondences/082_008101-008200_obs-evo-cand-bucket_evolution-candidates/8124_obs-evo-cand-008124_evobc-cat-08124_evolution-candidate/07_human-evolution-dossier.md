...
Project ID: `obs-evo-cand-008124`
...
- Project ID: `obs-evo-cand-008124`
- EVOBC category candidate ID: `evobc-evo-cat-08124`
- External category reference: `evobc-cat-08124`
- Source category ID: `08124`
- Source label for human review: `訅`
- Source codepoints: `U+8A05`
...
- `obs-evo-cand-008124-route-category-staging`
...
- `obs-evo-cand-008124-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008124-route-evolution-graph`
