# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006252
...
- EVOBC candidate category: `evobc-evo-cat-06252`.
- Source label for search only: `笺`.
- Source codepoints for search only: `U+7B3A`.
