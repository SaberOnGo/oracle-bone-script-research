...
- External category reference: `evobc-cat-06507`
- Source category ID: `06507`
- Source label for human review: `絜`
- Source codepoints: `U+7D5C`
...
- `obs-evo-cand-006507-route-category-staging`
...
- `obs-evo-cand-006507-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006507-route-evolution-graph`
