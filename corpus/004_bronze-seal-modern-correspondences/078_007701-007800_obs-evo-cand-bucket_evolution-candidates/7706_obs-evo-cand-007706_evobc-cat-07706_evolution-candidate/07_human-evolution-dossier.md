...
- External category reference: `evobc-cat-07706`
- Source category ID: `07706`
- Source label for human review: `號`
- Source codepoints: `U+865F`
...
- `obs-evo-cand-007706-route-category-staging`
...
- `obs-evo-cand-007706-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007706-route-evolution-graph`
