...
Project ID: `obs-evo-cand-010655`
...
- Project ID: `obs-evo-cand-010655`
- EVOBC category candidate ID: `evobc-evo-cat-10655`
- External category reference: `evobc-cat-10655`
- Source category ID: `10655`
- Source label for human review: `黥`
- Source codepoints: `U+9EE5`
...
- `obs-evo-cand-010655-route-category-staging`
...
- `obs-evo-cand-010655-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010655-route-evolution-graph`
