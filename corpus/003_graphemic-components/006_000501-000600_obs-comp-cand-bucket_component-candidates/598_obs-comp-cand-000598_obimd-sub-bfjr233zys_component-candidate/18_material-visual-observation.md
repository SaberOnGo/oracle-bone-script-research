# Material Visual Observation / obs-comp-cand-000598 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000598`
- External reference / 外部参照: `obimd-sub-bfjr233zys`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013126_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/846cza5dwl/bfjr233zys/67658f8o6x.png`
- Checksum / 校验和:
  `869d90c8e707a938a85833799c4b7386fccb549bedeaabc0aac8668a8c9b79e8`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.29%.
- Marked-pixel bounds: (82,21)–(167,230); span 86 × 210 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.29%。
- 痕迹范围：(82,21)–(167,230)；跨度86 × 210 px；痕迹矩形高于宽。
