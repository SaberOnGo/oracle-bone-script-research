...
- External category reference: `evobc-cat-07813`
- Source category ID: `07813`
- Source label for human review: `蝟`
- Source codepoints: `U+875F`
...
- `obs-evo-cand-007813-route-category-staging`
...
- `obs-evo-cand-007813-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007813-route-evolution-graph`
