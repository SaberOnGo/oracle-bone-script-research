# obs-char-001135 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001135`
- primary external id: `hust-obc-cat-1268`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1135_obs-char-001135_hust-obc-cat-1268_ora
  cle-character/03_visual-assets/001_asset-001140_hust-obc-cat-1268_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1268/G_1268_乙12合21021𠂤組.png`
- asset id: `asset-001140`
...
- source category: `1268`
- validation class: `1134`
- source image route: `HUST-OBC/deciphered/1268/G_1268_乙12合21021𠂤組.png`
- asset id: `asset-001140`
...
- English observation: `A narrow upright form has a pointed upper fork, a
  long curved left side, and a separate lower pointed stroke.`
- 中文观察: `狭长直立形体有尖状上部分叉、长左侧弯笔和分离的下部尖状笔。`
...
- dataset label text: `㣪`
- dataset label codepoints: `U+38EA`
...
- graph edge count: `3`
- codepoint routes: `U+38EA`
- cross-source status: `matched_obimd_by_codepoint`
...
- matched source ids / 匹配来源 ID: `src-hust-obc; src-obimd`
- OBIMD candidate ids / OBIMD 候选 ID: `obimd-main-cand-002631`
- OBIMD external refs / OBIMD 外部引用: `obimd-main-lgmn04qz1f`
- OBIMD transcription field / OBIMD 转写字段: `󿯽`
...
- matched OBIMD main UIDs: `lgmn04qz1f`
...
- filename catalog route clues: `Heji-like filename clue: 合21021
  (G_1268_乙12合21021𠂤組.png)`
...
- Which source records identify obs-char-001135 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001135？
