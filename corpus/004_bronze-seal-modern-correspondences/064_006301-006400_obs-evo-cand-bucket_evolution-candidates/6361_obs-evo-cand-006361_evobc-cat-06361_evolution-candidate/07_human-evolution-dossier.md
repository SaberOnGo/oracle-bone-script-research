...
- External category reference: `evobc-cat-06361`
- Source category ID: `06361`
- Source label: `簺`
...
- `obs-evo-cand-006361-route-category-staging`
...
- `obs-evo-cand-006361-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006361-route-evolution-graph`
