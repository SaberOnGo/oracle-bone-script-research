# obs-char-001040 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001040`
- primary external id: `hust-obc-cat-1166`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1040_obs-char-001040_hust-obc-cat-1166_ora
  cle-character/03_visual-assets/001_asset-001045_hust-obc-cat-1166_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1166/G_1166_乙2040(甲).png`
- asset id: `asset-001045`
...
- source category: `1166`
- validation class: `1039`
- source image route: `HUST-OBC/deciphered/1166/G_1166_乙2040(甲).png`
- asset id: `asset-001045`
...
- English observation: `A narrow upright form has two pointed upper
  branches, a small central oval-like opening, and a long lower stem.`
- 中文观察: `狭长直立形体有两条尖状上部分枝、小型中央椭圆状空隙和长下部笔干。`
...
- dataset label text: `㢄`
- dataset label codepoints: `U+3884`
...
- Which source records identify obs-char-001040 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001040？
