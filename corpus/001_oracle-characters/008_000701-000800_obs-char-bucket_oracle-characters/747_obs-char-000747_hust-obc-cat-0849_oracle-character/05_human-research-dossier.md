# obs-char-000747 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/747_obs-char-000747_hust-obc-cat-0849_orac
  le-character/03_visual-assets/001_asset-000752_hust-obc-cat-0849_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0849/G_0849_京津5556.png`
- asset id: `asset-000752`
...
- source category: `0849`
- validation class: `746`
- source image route: `HUST-OBC/deciphered/0849/G_0849_京津5556.png`
- asset id: `asset-000752`
...
- English observation: `Two parallel branching stems each have a hooked or
  forked upper end, a middle crossing, and several long diagonal roots
  spreading below.`
...
- dataset label text: `㝇`
- dataset label codepoints: `U+3747`
...
- Which source records identify obs-char-000747 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000747？
