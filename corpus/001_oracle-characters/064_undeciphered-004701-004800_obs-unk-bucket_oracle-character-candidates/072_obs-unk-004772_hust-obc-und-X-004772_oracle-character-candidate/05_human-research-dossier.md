# obs-unk-004772 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004772`
- primary external id: `hust-obc-und-X-004772`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/072_obs-unk-004772_h
  ust-obc-und-X-004772_oracle-character-candidate/03_visual-assets/001_asset
  -006365_hust-obc-und-X-004772_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/328/X_？_7312_1.png`
- asset id: `asset-006365`
...
- source class: `HUST-OBC/undeciphered/X/328/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/328/X_？_7312_1.png`
- asset id: `asset-006365`
...
- English observation: `detached fragments, upper openings, and lower stroke`
- 中文观察: `分离片段、上部开口和下部笔画`
...
- Which source records identify obs-unk-004772 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004772？
