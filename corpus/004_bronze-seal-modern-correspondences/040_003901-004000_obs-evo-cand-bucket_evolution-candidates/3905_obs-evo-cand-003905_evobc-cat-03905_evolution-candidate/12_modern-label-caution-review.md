# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003905
...
- EVOBC candidate category: `evobc-evo-cat-03905`.
- Source label for search only: `杼`.
- Source codepoints for search only: `U+677C`.
