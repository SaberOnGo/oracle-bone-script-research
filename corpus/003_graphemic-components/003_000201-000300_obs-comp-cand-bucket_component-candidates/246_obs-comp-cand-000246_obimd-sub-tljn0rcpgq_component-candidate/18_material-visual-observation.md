# Material Visual Observation / obs-comp-cand-000246 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000246`
- External reference / 外部参照: `obimd-sub-tljn0rcpgq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011892_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/49lxhylgu1/tljn0rcpgq/tljn0rcpgq.png`
- Checksum / 校验和:
  `d2a4112bb8e8b162d502aae1141f969875963095e9fc372b97e66e50e88d3a7e`
...
- Marked-pixel bounds: (64,26)–(185,224); span 122 × 199 px; the marked
...
- 痕迹范围：(64,26)–(185,224)；跨度122 × 199 px；痕迹矩形高于宽。
