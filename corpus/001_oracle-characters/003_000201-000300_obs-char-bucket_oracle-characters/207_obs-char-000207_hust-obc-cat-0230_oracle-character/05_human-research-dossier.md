# obs-char-000207 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/207_obs-char-000207_hust-obc-cat-0230_orac
  le-character/03_visual-assets/001_asset-000212_hust-obc-cat-0230_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0230/G_0230_佚757(甲).png`
- asset id: `asset-000212`
...
- source category: `0230`
- validation class: `206`
- source image route: `HUST-OBC/deciphered/0230/G_0230_佚757(甲).png`
- asset id: `asset-000212`
...
- English observation: `The image has two short forked marks on the left and
  a pointed upper-right form connected to a long curved descending stroke.`
- 中文观察: `图像左侧有两道短分叉痕，右上方有尖状形，连接长弯曲下行笔。`
...
- dataset label text: `㓜`
- dataset label codepoints: `U+34DC`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/019_obs-evo-can
  d-000019_evobc-cat-00019_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/019_obs-evo-cand-000019_evobc-cat-00019_evolu
...
- Which source records identify obs-char-000207 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000207？
