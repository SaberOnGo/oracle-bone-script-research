...
- External category reference: `evobc-cat-00836`
- Source category ID: `00836`
- Source label for human review: `來`
- Source codepoints: `U+4F86`
- Image reference count in source metadata: `219`
...
- `obs-evo-cand-000836-route-category-staging`
...
- `obs-evo-cand-000836-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000836-route-evolution-graph`
