# Material Visual Observation / obs-comp-cand-000557 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000557`
- External reference / 外部参照: `obimd-sub-nonh2c9f7j`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012809_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/nonh2c9f7j/nonh2c9f7j/nonh2c9f7j.png`
- Checksum / 校验和:
  `991addf1c27d5bec23a54c4194aa5e9600297f6d17336775a4c7687f7de638d9`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.76%.
- Marked-pixel bounds: (55,40)–(194,209); span 140 × 170 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.76%。
- 痕迹范围：(55,40)–(194,209)；跨度140 × 170 px；痕迹矩形高于宽。
