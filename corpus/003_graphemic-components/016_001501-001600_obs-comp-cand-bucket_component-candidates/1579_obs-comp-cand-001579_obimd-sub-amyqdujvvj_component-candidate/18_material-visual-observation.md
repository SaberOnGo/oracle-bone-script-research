# Material Visual Observation / obs-comp-cand-001579 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001579`
- External reference / 外部参照: `obimd-sub-amyqdujvvj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017160_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ggmxiphq64/amyqdujvvj/amyqdujvvj.png`
- Checksum / 校验和:
  `6b7f64c5ece59c0d743da5a36530446830a97b6be25eceda48a6beaecbdf2e09`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.22%.
- Marked-pixel bounds: (46,40)–(199,214); span 154 × 175 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.22%。
- 痕迹范围：(46,40)–(199,214)；跨度154 × 175 px；痕迹矩形近方形。
