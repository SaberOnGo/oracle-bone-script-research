# obs-evo-cand-009667 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-009667`
- EVOBC category candidate ID: `evobc-evo-cat-09667`
- External category ref: `evobc-cat-09667`
- Source label: `闢`
- Source codepoints: `U+95E2`
- Image reference count: `79`
- Era token counts: `BI:48;CS:1;SAC:1;SS:3;WSC:26`
- Source token counts: `Book:18;Web:61`

## Observed Code Rows / 观察到的代码行

- era 1 / BI: 48 image references
