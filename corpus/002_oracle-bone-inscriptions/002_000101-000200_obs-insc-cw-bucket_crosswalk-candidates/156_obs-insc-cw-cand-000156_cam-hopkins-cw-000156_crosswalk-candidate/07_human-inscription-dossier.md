...
- Yingguo / 英国所藏: `y885` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `1` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `594` in source row; primary catalog entry pending
- Heji / 合集: `40204` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000156`
