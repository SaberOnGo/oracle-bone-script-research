# Material Visual Observation / obs-comp-cand-001541 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001541`
- External reference / 外部参照: `obimd-sub-veivf19dt0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016955_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/z8n1dxtc9q/veivf19dt0/veivf19dt0.png`
- Checksum / 校验和:
  `7dd845a91492619a3d56ebf735c01de521d2890e195c2d711f0479ee30478885`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.15%.
- Marked-pixel bounds: (53,35)–(202,209); span 150 × 175 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.15%。
- 痕迹范围：(53,35)–(202,209)；跨度150 × 175 px；痕迹矩形近方形。
