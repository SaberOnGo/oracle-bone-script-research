# obs-comp-cand-002385 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002385`
- 首选外部 ID: `obimd-sub-t2lqza150m`
- OBIMD subcharacter UID: `t2lqza150m`
- OBIMD main character UID: `ptserhps1f`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+B4FCD;U+FDA87; U+FDA88; 另有 1 项
