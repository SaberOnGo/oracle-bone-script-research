# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-000349
...
- candidate_component_id: `obs-comp-cand-000349`
- primary_external_ref_id: `obimd-sub-qtpmmeo3aw`
- source_subcharacter_uid: `qtpmmeo3aw`
...
- glyph_codepoint_uplus_sample: `U+F2024, U+F2025, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-012273` | `001_asset-012273_img.png` | `9927827f995943b14cb2387e9b1395529809efcffdcab8a8b0e8d008fea10926` |
