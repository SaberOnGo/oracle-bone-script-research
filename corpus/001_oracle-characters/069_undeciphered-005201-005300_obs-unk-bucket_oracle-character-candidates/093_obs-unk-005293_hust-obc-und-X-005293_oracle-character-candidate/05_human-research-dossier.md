# obs-unk-005293 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005293`
- primary external id: `hust-obc-und-X-005293`
...
- local review image route: `corpus/001_oracle-characters/069_undeciphered-005
  201-005300_obs-unk-bucket_oracle-character-candidates/093_obs-unk-005293_h
  ust-obc-und-X-005293_oracle-character-candidate/03_visual-assets/001_asset
  -006886_hust-obc-und-X-005293_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/849/X_？_7812_1.png`
- asset id: `asset-006886`
...
- source class: `HUST-OBC/undeciphered/X/849/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/849/X_？_7812_1.png`
- asset id: `asset-006886`
...
- Which source records identify obs-unk-005293 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005293？
