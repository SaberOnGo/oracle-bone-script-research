# Material Visual Observation / obs-comp-cand-002517 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002517`
- External reference / 外部参照: `obimd-sub-h0gzv3styy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020872_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h0gzv3styy/h0gzv3styy/67kmgrspzq.png`
- Checksum / 校验和:
  `77dbf1e0c4b51a66f4c0bbe9b86323d4ca9fc900b1512f28393ca0eb33537bc0`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.00%.
- Marked-pixel bounds: (90,44)–(159,202); span 70 × 159 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.00%。
- 痕迹范围：(90,44)–(159,202)；跨度70 × 159 px；痕迹矩形高于宽。
