...
Project ID: `obs-insc-cw-cand-000182`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000182`
...
- Source page section: `Period I Group 14` /
  `第 I 期第 14 组`
- Source section key: `period-i-group-14`
- Section declared count: `16`
- Section observed row count: `16`
...
- Yingguo / 英国所藏: `y1106` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `196` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `696` in source row; primary catalog entry pending
- Heji / 合集: `40352` in source row; primary catalog entry pending
...
- Group and batch / 组类与批次: group `14`; batch or pit context pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000182`
