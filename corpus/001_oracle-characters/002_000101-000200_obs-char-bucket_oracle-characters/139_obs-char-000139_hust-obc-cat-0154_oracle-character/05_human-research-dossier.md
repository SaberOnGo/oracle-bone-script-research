# obs-char-000139 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/139_obs-char-000139_hust-obc-cat-0154_orac
  le-character/03_visual-assets/001_asset-000144_hust-obc-cat-0154_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0154/G_0154_乙6378反合14022反賓組.png
  `
- asset id: `asset-000144`
...
- source category: `0154`
- validation class: `138`
- source image route: `HUST-OBC/deciphered/0154/G_0154_乙6378反合14022反賓組.png`
- asset id: `asset-000144`
...
- English observation: `The image has a central crossing point with four
  uneven strokes spreading upward and downward, including a curved
  lower-left stroke.`
- 中文观察: `图像中部有交叉点，四道长短不齐的笔画向上下展开，其中左下方有弯曲笔。`
...
- dataset label text: `㒐`
- dataset label codepoints: `U+3490`
...
- filename catalog route clues: `Heji-like filename clue: 合14022
...
- Which source records identify obs-char-000139 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000139？
