# Material Visual Observation / obs-comp-cand-001697 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001697`
- External reference / 外部参照: `obimd-sub-r90d2o0i9y`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017613_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/r90d2o0i9y/r90d2o0i9y/r90d2o0i9y.png`
- Checksum / 校验和:
  `a580368700dd92da108fbf8b72152970fa7cb45be60940a3e3d9df79f1ab98b2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.00%.
- Marked-pixel bounds: (72,44)–(177,200); span 106 × 157 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.00%。
- 痕迹范围：(72,44)–(177,200)；跨度106 × 157 px；痕迹矩形高于宽。
