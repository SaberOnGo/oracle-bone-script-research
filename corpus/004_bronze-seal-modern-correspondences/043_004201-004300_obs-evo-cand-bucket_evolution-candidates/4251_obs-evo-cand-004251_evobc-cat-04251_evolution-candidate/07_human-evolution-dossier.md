...
- External category reference: `evobc-cat-04251`
- Source category ID: `04251`
- Source label for human review: `樴`
...
- `obs-evo-cand-004251-route-category-staging`
...
- `obs-evo-cand-004251-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004251-route-evolution-graph`
