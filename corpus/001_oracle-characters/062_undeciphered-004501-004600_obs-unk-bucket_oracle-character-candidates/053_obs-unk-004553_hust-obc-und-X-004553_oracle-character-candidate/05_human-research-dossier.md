# obs-unk-004553 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/053_obs-unk-004553_h
  ust-obc-und-X-004553_oracle-character-candidate/03_visual-assets/001_asset
  -006146_hust-obc-und-X-004553_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/109/X_？_8291_1.png`
- asset id: `asset-006146`
...
- source class: `HUST-OBC/undeciphered/X/109/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/109/X_？_8291_1.png`
- asset id: `asset-006146`
...
- English observation: `Upper cap, openings, and lower traces recorded.`
- 中文观察: `已记录上部帽状轮廓、开口和下部痕迹。`
...
- Which source records identify obs-unk-004553 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004553？
