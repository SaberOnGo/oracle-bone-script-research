...
- External category reference: `evobc-cat-06012`
- Source category ID: `06012`
- Source label for human review: `禂`
...
- `obs-evo-cand-006012-route-category-staging`
...
- `obs-evo-cand-006012-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006012-route-evolution-graph`
