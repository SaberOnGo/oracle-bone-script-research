# obs-unk-004352 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/052_obs-unk-004352_h
  ust-obc-und-L-004352_oracle-character-candidate/03_visual-assets/001_asset
  -005945_hust-obc-und-L-004352_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4352/L_？_9650.jpg`
- asset id: `asset-005945`
...
- source class: `HUST-OBC/undeciphered/L/4352/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4352/L_？_9650.jpg`
- asset id: `asset-005945`
...
- English observation: `Curved upper traces, central bend, and lower arc`
  `recorded.`
- 中文观察: `已记录上部弯曲痕、中部弯折和下部弧线。`
...
- Which source records identify obs-unk-004352 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004352？
