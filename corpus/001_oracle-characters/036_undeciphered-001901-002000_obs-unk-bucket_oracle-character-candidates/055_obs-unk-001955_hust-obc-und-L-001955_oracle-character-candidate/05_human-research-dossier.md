# obs-unk-001955 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/036_undeciphered-001
  901-002000_obs-unk-bucket_oracle-character-candidates/055_obs-unk-001955_h
  ust-obc-und-L-001955_oracle-character-candidate/03_visual-assets/001_asset
  -003548_hust-obc-und-L-001955_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/1955/L_？_1734.jpg`
- asset id: `asset-003548`
...
- source class: `HUST-OBC/undeciphered/L/1955/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/1955/L_？_1734.jpg`
- asset id: `asset-003548`
...
- Which source records identify obs-unk-001955 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-001955？
