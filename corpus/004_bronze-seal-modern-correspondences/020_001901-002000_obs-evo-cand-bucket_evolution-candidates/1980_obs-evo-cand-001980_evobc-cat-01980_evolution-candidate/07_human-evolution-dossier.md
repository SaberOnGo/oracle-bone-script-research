...
- External category reference: `evobc-cat-01980`
- Source category ID: `01980`
- Source label for human review: `壻`
- Source codepoints: `U+58FB`
...
- `obs-evo-cand-001980-route-category-staging`
...
- `obs-evo-cand-001980-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001980-route-evolution-graph`
