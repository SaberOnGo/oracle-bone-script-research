# obs-char-000600 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/600_obs-char-000600_hust-obc-cat-0684_orac
  le-character/03_visual-assets/001_asset-000605_hust-obc-cat-0684_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0684/G_0684_乙703合3217.png`
- asset id: `asset-000605`
...
- source category: `0684`
- validation class: `599`
- source image route: `HUST-OBC/deciphered/0684/G_0684_乙703合3217.png`
- asset id: `asset-000605`
...
- English observation: `A bold rounded outer loop has a wide split at the
  top, a curved internal divider, and two sides that converge into a narrow
  pointed bottom.`
...
- dataset label text: `㚢`
- dataset label codepoints: `U+36A2`
...
- filename catalog route clues: `Heji-like filename clue: 合3217
...
- Which source records identify obs-char-000600 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000600？
