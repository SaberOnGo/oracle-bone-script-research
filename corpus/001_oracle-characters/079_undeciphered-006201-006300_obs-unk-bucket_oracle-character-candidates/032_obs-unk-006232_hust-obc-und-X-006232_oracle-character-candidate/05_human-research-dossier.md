# obs-unk-006232 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006232`
- primary external id: `hust-obc-und-X-006232`
...
- local review image route: `corpus/001_oracle-characters/079_undeciphered-006
  201-006300_obs-unk-bucket_oracle-character-candidates/032_obs-unk-006232_h
  ust-obc-und-X-006232_oracle-character-candidate/03_visual-assets/001_asset
  -007824_hust-obc-und-X-006232_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1788/X_？_4529_1.png`
- asset id: `asset-007824`
...
- source class: `HUST-OBC/undeciphered/X/1788/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1788/X_？_4529_1.png`
- asset id: `asset-007824`
...
- Which source records identify obs-unk-006232 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006232？
