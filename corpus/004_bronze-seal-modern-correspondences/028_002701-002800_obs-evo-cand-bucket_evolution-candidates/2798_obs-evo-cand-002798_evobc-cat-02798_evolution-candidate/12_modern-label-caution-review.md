# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002798
...
- EVOBC candidate category: `evobc-evo-cat-02798`.
- Source label for search only: `弛`.
- Source codepoints for search only: `U+5F1B`.
