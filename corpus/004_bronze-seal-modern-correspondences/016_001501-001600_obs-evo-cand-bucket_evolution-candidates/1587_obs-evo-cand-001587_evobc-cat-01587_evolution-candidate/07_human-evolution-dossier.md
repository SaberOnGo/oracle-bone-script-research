...
- External category reference: `evobc-cat-01587`
- Source category ID: `01587`
- Source label for human review: `哥`
- Source codepoints: `U+54E5`
...
- `obs-evo-cand-001587-route-category-staging`
...
- `obs-evo-cand-001587-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001587-route-evolution-graph`
