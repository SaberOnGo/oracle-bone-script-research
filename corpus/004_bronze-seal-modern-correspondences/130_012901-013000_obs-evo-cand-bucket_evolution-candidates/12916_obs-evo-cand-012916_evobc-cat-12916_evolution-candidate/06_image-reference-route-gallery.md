...
- `obs-evo-cand-012916-route-category-staging`
...
- `obs-evo-cand-012916-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012916-route-evolution-graph`
