# Material Visual Observation / obs-comp-cand-001850 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001850`
- External reference / 外部参照: `obimd-sub-mbh2ez0d6d`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018229_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/mgs4xhu5g3/mbh2ez0d6d/mbh2ez0d6d.png`
- Checksum / 校验和:
  `93fca3523ba9dfb7efee85fb7c1a796e87597c21a52785ef9ec4f517423e3b70`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.72%.
- Marked-pixel bounds: (81,28)–(188,227); span 108 × 200 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.72%。
- 痕迹范围：(81,28)–(188,227)；跨度108 × 200 px；痕迹矩形高于宽。
