...
- External category reference: `evobc-cat-06123`
- Source category ID: `06123`
- Source label for human review: `穅`
...
- `obs-evo-cand-006123-route-category-staging`
...
- `obs-evo-cand-006123-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006123-route-evolution-graph`
