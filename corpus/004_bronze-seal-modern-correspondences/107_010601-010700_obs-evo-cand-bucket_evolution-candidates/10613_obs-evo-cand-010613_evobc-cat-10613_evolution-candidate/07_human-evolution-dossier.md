...
- External category reference: `evobc-cat-10613`
- Source category ID: `10613`
...
- `obs-evo-cand-010613-route-category-staging`
...
- `obs-evo-cand-010613-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010613-route-evolution-graph`
