# Material Visual Observation / obs-comp-cand-002585 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002585`
- External reference / 外部参照: `obimd-sub-jv49djokvb`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021124_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jv49djokvb/jv49djokvb/jv49djokvb.png`
- Checksum / 校验和:
  `1033befa8a2b13a8e165e675dbfa8f647ae3f6f4a8ee0df23e9e5e16fb85cfa3`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.69%.
- Marked-pixel bounds: (80,24)–(167,225); span 88 × 202 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.69%。
- 痕迹范围：(80,24)–(167,225)；跨度88 × 202 px；痕迹矩形高于宽。
