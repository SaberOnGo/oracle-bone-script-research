# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-007023
...
- EVOBC candidate category: `evobc-evo-cat-07023`.
- Source label for search only: `胎`.
- Source codepoints for search only: `U+80CE`.
