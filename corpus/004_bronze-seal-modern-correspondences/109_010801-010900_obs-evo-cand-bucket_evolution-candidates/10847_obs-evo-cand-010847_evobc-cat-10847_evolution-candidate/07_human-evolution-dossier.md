...
- External category reference: `evobc-cat-10847`
- Source category ID: `10847`
- Source label for human review: `𠝌`
...
- `obs-evo-cand-010847-route-category-staging`
...
- `obs-evo-cand-010847-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010847-route-evolution-graph`
