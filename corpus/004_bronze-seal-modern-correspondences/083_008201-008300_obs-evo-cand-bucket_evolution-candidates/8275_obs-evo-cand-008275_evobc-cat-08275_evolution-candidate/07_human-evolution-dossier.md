...
- External category reference: `evobc-cat-08275`
- Source category ID: `08275`
...
- `obs-evo-cand-008275-route-category-staging`
...
- `obs-evo-cand-008275-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008275-route-evolution-graph`
