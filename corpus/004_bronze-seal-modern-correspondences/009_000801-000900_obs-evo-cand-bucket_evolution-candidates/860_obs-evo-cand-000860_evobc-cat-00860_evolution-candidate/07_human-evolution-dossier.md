...
- External category reference: `evobc-cat-00860`
- Source category ID: `00860`
- Source label for human review: `侨`
...
- `obs-evo-cand-000860-route-category-staging`
...
- `obs-evo-cand-000860-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000860-route-evolution-graph`
