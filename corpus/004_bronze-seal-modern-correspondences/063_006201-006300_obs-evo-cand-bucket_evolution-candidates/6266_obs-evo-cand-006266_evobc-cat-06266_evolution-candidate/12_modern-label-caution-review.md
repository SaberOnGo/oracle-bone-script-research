# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006266
...
- Project ID: `obs-evo-cand-006266`.
- EVOBC candidate category: `evobc-evo-cat-06266`.
- Source label for search only: `筝`.
- Source codepoints for search only: `U+7B5D`.
