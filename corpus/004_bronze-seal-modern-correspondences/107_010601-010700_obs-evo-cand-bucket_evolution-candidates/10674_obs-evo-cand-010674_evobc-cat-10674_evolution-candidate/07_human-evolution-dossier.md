...
- External category reference: `evobc-cat-10674`
- Source category ID: `10674`
- Source label for human review: `黿`
- Source codepoints: `U+9EFF`
...
- `obs-evo-cand-010674-route-category-staging`
...
- `obs-evo-cand-010674-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010674-route-evolution-graph`
