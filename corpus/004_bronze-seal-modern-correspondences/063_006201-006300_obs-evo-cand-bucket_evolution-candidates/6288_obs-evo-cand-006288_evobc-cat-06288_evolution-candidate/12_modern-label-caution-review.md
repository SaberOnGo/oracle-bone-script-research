# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006288
...
- EVOBC candidate category: `evobc-evo-cat-06288`.
- Source label for search only: `箋`.
- Source codepoints for search only: `U+7B8B`.
