# src-oracle-mnist Material Access Index / src-oracle-mnist 资料访问索引
...
| --- | --- | --- | --- |
| Source summary / 来源摘要 | `README.md` | present | source ID `src-oracle-mnist` |
...
| Downloaded metadata profiles / 已下载 metadata profile | `05_metadata-profile-route-index.csv` | profile_rows_present | 2 row(s); metrics: downloaded_readme_size_bytes;registered_dataset_scope |
...
- Risk note / 风险提示: Useful for recognition tests but too narrow for corpus construction.
