# obs-char-000637 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/637_obs-char-000637_hust-obc-cat-0724_orac
  le-character/03_visual-assets/001_asset-000642_hust-obc-cat-0724_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0724/G_0724_京津1110合11383.png`
- asset id: `asset-000642`
...
- source category: `0724`
- validation class: `636`
- source image route: `HUST-OBC/deciphered/0724/G_0724_京津1110合11383.png`
- asset id: `asset-000642`
...
- English observation: `A compact angular cluster has a small pointed upper
  loop, crossing middle strokes, and several thin forked branches descending
  to both sides.`
...
- dataset label text: `㛊`
- dataset label codepoints: `U+36CA`
...
- filename catalog route clues: `Heji-like filename clue: 合11383
  (G_0724_京津1110合11383.png)`
...
- Which source records identify obs-char-000637 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000637？
