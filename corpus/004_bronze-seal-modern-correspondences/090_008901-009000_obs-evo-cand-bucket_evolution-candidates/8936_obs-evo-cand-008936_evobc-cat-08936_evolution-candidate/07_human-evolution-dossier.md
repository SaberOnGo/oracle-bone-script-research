...
Project ID: `obs-evo-cand-008936`
...
- Project ID: `obs-evo-cand-008936`
- EVOBC category candidate ID: `evobc-evo-cat-08936`
- External category reference: `evobc-cat-08936`
- Source category ID: `08936`
- Source label for human review: `迂`
- Source codepoints: `U+8FC2`
...
- `obs-evo-cand-008936-route-category-staging`
...
- `obs-evo-cand-008936-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008936-route-evolution-graph`
