# obs-unk-004190 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/090_obs-unk-004190_h
  ust-obc-und-L-004190_oracle-character-candidate/03_visual-assets/001_asset
  -005783_hust-obc-und-L-004190_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4190/L_？_9112.jpg`
- asset id: `asset-005783`
...
- source class: `HUST-OBC/undeciphered/L/4190/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4190/L_？_9112.jpg`
- asset id: `asset-005783`
...
- English observation: `Upper stroke has curled ends; two shafts descend.`
- 中文观察: `上部横笔画两端有弯曲痕迹；下方有两条直立笔画。`
...
- Which source records identify obs-unk-004190 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004190？
