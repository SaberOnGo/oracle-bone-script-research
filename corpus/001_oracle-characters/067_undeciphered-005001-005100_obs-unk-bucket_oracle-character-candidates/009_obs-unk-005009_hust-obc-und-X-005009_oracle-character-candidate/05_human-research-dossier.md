# obs-unk-005009 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005009`
- primary external id: `hust-obc-und-X-005009`
...
- local review image route: `corpus/001_oracle-characters/067_undeciphered-005
  001-005100_obs-unk-bucket_oracle-character-candidates/009_obs-unk-005009_h
  ust-obc-und-X-005009_oracle-character-candidate/03_visual-assets/001_asset
  -006602_hust-obc-und-X-005009_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/565/X_？_7542_1.png`
- asset id: `asset-006602`
...
- source class: `HUST-OBC/undeciphered/X/565/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/565/X_？_7542_1.png`
- asset id: `asset-006602`
...
- Which source records identify obs-unk-005009 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005009？
