...
- External category reference: `evobc-cat-09351`
- Source category ID: `09351`
- Source label for human review: `鈿`
...
- `obs-evo-cand-009351-route-category-staging`
...
- `obs-evo-cand-009351-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009351-route-evolution-graph`
