# obs-unk-004928 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004928`
- primary external id: `hust-obc-und-X-004928`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/028_obs-unk-004928_h
  ust-obc-und-X-004928_oracle-character-candidate/03_visual-assets/001_asset
  -006521_hust-obc-und-X-004928_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/484/X_？_7468_1.png`
- asset id: `asset-006521`
...
- Upper and lower rounded outlines meet a segmented lower branch.
...
- source class: `HUST-OBC/undeciphered/X/484/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/484/X_？_7468_1.png`
- asset id: `asset-006521`
...
- Which source records identify obs-unk-004928 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004928？
