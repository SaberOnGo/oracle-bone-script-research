# obs-unk-004320 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004320`
- primary external id: `hust-obc-und-L-004320`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/020_obs-unk-004320_h
  ust-obc-und-L-004320_oracle-character-candidate/03_visual-assets/001_asset
  -005913_hust-obc-und-L-004320_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4320/L_？_955.jpg`
- asset id: `asset-005913`
...
- source class: `HUST-OBC/undeciphered/L/4320/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4320/L_？_955.jpg`
- asset id: `asset-005913`
...
- English observation: `Upper short traces, diagonal stroke, and lower hook
  recorded.`
- 中文观察: `已记录上部短痕、斜向笔痕和右下钩状痕迹。`
...
- Which source records identify obs-unk-004320 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004320？
