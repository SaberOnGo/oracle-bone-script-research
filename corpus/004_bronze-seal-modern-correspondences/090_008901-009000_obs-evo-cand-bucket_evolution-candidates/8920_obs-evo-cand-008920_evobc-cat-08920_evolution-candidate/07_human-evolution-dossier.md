...
Project ID: `obs-evo-cand-008920`
...
- Project ID: `obs-evo-cand-008920`
- EVOBC category candidate ID: `evobc-evo-cat-08920`
- External category reference: `evobc-cat-08920`
- Source category ID: `08920`
- Source label for human review: `辬`
- Source codepoints: `U+8FAC`
...
- `obs-evo-cand-008920-route-category-staging`
...
- `obs-evo-cand-008920-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008920-route-evolution-graph`
