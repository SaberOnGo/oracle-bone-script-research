...
- External category reference: `evobc-cat-12279`
- Source category ID: `12279`
- Source label for human review: `𧵛`
...
- `obs-evo-cand-012279-route-category-staging`
...
- `obs-evo-cand-012279-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012279-route-evolution-graph`
