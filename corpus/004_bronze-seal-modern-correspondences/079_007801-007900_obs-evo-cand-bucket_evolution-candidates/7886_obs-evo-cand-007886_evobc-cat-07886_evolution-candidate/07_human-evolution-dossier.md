...
- External category reference: `evobc-cat-07886`
- Source category ID: `07886`
- Source label for human review: `蠭`
...
- `obs-evo-cand-007886-route-category-staging`
...
- `obs-evo-cand-007886-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007886-route-evolution-graph`
