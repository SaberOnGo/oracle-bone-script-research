...
- Local image / 本地图像:
  `03_visual-assets/001_asset-001131_hust-obc-cat-1257_glyph.png`
- Local metadata / 本地 metadata:
  `03_visual-assets/001_asset-001131_hust-obc-cat-1257_glyph.yaml`
- Source image path / 来源图像路径:
  `HUST-OBC/deciphered/1257/G_1257_京都2142合27972無名組.png`
