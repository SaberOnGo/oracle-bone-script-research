# obs-char-000380 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000380`
- primary external id: `hust-obc-cat-0432`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/380_obs-char-000380_hust-obc-cat-0432_orac
  le-character/03_visual-assets/001_asset-000385_hust-obc-cat-0432_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0432/G_0432_前4.1.2(甲).png`
- asset id: `asset-000385`
...
- source category: `0432`
- validation class: `379`
- source image route: `HUST-OBC/deciphered/0432/G_0432_前4.1.2(甲).png`
- asset id: `asset-000385`
...
- English observation: `A curved hook-like upper contour continues into a
  thin vertical lower stroke.`
...
- dataset label text: `㖦`
- dataset label codepoints: `U+35A6`
...
- Which source records identify obs-char-000380 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000380？
