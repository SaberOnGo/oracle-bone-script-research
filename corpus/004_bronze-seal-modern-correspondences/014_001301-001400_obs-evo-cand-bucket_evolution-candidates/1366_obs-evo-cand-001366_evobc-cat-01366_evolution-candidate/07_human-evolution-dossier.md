...
- External category reference: `evobc-cat-01366`
- Source category ID: `01366`
- Source label for human review: `升`
- Source codepoints: `U+5347`
- Image reference count in source metadata: `121`
...
- `obs-evo-cand-001366-route-category-staging`
...
- `obs-evo-cand-001366-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001366-route-evolution-graph`
