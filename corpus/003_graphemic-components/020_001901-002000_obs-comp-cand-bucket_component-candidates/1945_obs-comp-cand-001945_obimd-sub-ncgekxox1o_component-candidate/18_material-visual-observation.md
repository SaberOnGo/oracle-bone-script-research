# Material Visual Observation / obs-comp-cand-001945 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001945`
- External reference / 外部参照: `obimd-sub-ncgekxox1o`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018755_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ncgekxox1o/ncgekxox1o/ncgekxox1o.png`
- Checksum / 校验和:
  `be582d707400d7509a429fc87463db7185140f772bdf9e7169df97bf06c5f43f`
...
- Marked-pixel bounds: (64,17)–(211,231); span 148 × 215 px; the marked
...
- 痕迹范围：(64,17)–(211,231)；跨度148 × 215 px；痕迹矩形高于宽。
