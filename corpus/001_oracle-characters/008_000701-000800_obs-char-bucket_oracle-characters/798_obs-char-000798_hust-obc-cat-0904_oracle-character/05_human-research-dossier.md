# obs-char-000798 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/798_obs-char-000798_hust-obc-cat-0904_orac
  le-character/03_visual-assets/001_asset-000803_hust-obc-cat-0904_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0904/G_0904_京津4387(甲).png`
- asset id: `asset-000803`
...
- source category: `0904`
- validation class: `797`
- source image route: `HUST-OBC/deciphered/0904/G_0904_京津4387(甲).png`
- asset id: `asset-000803`
...
- English observation: `Two adjacent stems fork into short upper branches
  and descend toward a small detached U-shaped opening at the bottom.`
...
- dataset label text: `㝾`
- dataset label codepoints: `U+377E`
...
- Which source records identify obs-char-000798 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000798？
