...
Project ID: `obs-evo-cand-013299`
...
- Project ID: `obs-evo-cand-013299`
- EVOBC category candidate ID: `evobc-evo-cat-13299`
- External category reference: `evobc-cat-13299`
- Source category ID: `13299`
- Source label for human review: `𬚋`
- Source codepoints: `U+2C68B`
...
- `obs-evo-cand-013299-route-category-staging`
...
- `obs-evo-cand-013299-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013299-route-evolution-graph`
