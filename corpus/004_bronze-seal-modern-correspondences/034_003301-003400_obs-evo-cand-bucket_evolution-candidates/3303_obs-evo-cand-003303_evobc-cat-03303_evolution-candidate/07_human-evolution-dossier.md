...
- Project ID: `obs-evo-cand-003303`
- EVOBC category candidate ID: `evobc-evo-cat-03303`
- External category reference: `evobc-cat-03303`
- Source category ID: `03303`
- Source label for human review: `拂`
- Source codepoints: `U+62C2`
...
- `obs-evo-cand-003303-route-category-staging`
...
- `obs-evo-cand-003303-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003303-route-evolution-graph`
