...
Project ID: `obs-evo-cand-007997`
...
- Project ID: `obs-evo-cand-007997`
- EVOBC category candidate ID: `evobc-evo-cat-07997`
- External category reference: `evobc-cat-07997`
- Source category ID: `07997`
- Source label for human review: `裾`
- Source codepoints: `U+88FE`
...
- `obs-evo-cand-007997-route-category-staging`
...
- `obs-evo-cand-007997-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007997-route-evolution-graph`
