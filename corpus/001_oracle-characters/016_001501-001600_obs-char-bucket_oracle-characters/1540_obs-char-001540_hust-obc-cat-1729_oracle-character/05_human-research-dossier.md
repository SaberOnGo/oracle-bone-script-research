# obs-char-001540 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001540`
- primary external id: `hust-obc-cat-1729`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1540_obs-char-001540_hust-obc-cat-1729_ora
  cle-character/03_visual-assets/001_asset-001545_hust-obc-cat-1729_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1729/L_1729_1557.jpg`
- asset id: `asset-001545`
...
- source category: `1729`
- validation class: `1539`
- source image route: `HUST-OBC/deciphered/1729/L_1729_1557.jpg`
- asset id: `asset-001545`
...
- English observation: `A very faint narrow form shows a central vertical
  with short side branches.`
- 中文观察: `极浅淡的狭长形体显示中央竖笔和短侧向分枝。`
...
- dataset label text: `㪷`
- dataset label codepoints: `U+3AB7`
...
- Which source records identify obs-char-001540 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001540？
