# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001060
...
| --- | --- | --- | --- |
| `obimd-glyph-link-015516` | 󶁳 | `U+F6073` | `reviewed_metadata_only` |
| `obimd-glyph-link-015517` | 󶁴 | `U+F6074` | `reviewed_metadata_only` |
| `obimd-glyph-link-015518` | 󶁵 | `U+F6075` | `reviewed_metadata_only` |
