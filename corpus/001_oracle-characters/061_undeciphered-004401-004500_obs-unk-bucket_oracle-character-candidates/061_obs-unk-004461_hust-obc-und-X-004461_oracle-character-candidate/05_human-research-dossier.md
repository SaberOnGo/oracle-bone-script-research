# obs-unk-004461 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/061_obs-unk-004461_h
  ust-obc-und-X-004461_oracle-character-candidate/03_visual-assets/001_asset
  -006054_hust-obc-und-X-004461_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/17/X_？_8196_1.png`
- asset id: `asset-006054`
...
- source class: `HUST-OBC/undeciphered/X/17/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/17/X_？_8196_1.png`
- asset id: `asset-006054`
...
- English observation: A narrow vertical stroke extends from a thicker upper
  tip; two rounded openings appear above a forked lower terminal.
- 中文观察: 顶部有窄长竖痕，中下部有两个圆弧开口，底端呈分叉。
...
- Which source records identify obs-unk-004461 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004461？
