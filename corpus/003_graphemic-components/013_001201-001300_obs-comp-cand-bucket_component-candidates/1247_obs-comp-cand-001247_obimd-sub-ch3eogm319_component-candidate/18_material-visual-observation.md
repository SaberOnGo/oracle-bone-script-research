# Material Visual Observation / obs-comp-cand-001247 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001247`
- External reference / 外部参照: `obimd-sub-ch3eogm319`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015485_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ch3eogm319/ch3eogm319/ch3eogm319.png`
- Checksum / 校验和:
  `4fc14831ea9f2d3f766c9a79c0a6665881c4d41e0551bf133e2ac9f92f4ec1c4`
...
- Marked-pixel bounds: (86,56)–(193,205); span 108 × 150 px; the marked
...
- 痕迹范围：(86,56)–(193,205)；跨度108 × 150 px；痕迹矩形高于宽。
