# obs-evo-cand-005140 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-05140`
- Source label: `熹`
- Source codepoints: `U+71B9`
- Image reference count: `60`
- Era token counts: `OBC:59;SS:1`
- Source token counts: `Book:29;Web:31`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 59 image references
