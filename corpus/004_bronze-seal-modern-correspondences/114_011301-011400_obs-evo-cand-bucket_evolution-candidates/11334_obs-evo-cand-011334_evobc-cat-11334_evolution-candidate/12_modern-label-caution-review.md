# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-011334
...
- EVOBC candidate category: `evobc-evo-cat-11334`.
- Source label for search only: `𢼭`.
- Source codepoints for search only: `U+22F2D`.
