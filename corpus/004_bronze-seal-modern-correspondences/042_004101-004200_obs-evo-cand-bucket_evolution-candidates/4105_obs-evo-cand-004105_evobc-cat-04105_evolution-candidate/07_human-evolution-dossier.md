...
Project ID: `obs-evo-cand-004105`
...
- Project ID: `obs-evo-cand-004105`
- EVOBC category candidate ID: `evobc-evo-cat-04105`
- External category reference: `evobc-cat-04105`
- Source category ID: `04105`
- Source label for human review: `棪`
- Source codepoints: `U+68EA`
...
- `obs-evo-cand-004105-route-category-staging`
...
- `obs-evo-cand-004105-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004105-route-evolution-graph`
