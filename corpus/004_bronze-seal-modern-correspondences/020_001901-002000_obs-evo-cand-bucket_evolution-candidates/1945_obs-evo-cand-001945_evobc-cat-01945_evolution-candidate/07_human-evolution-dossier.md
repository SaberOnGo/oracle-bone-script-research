...
- External category reference: `evobc-cat-01945`
- Source category ID: `01945`
...
- `obs-evo-cand-001945-route-category-staging`
...
- `obs-evo-cand-001945-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001945-route-evolution-graph`
