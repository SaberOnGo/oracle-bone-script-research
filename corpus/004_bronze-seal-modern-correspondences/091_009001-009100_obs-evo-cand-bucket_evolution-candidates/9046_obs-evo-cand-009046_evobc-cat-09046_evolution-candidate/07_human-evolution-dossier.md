...
- External category reference: `evobc-cat-09046`
- Source category ID: `09046`
- Source label for human review: `遡`
...
- `obs-evo-cand-009046-route-category-staging`
...
- `obs-evo-cand-009046-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009046-route-evolution-graph`
