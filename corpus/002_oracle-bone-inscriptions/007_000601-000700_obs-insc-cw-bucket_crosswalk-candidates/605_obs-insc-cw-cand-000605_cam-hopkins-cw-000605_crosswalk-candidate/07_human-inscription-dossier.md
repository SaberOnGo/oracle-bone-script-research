...
Project ID: `obs-insc-cw-cand-000605`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000605`
...
- Yingguo / 英国所藏: `y2664` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `392` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `513` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000605`
