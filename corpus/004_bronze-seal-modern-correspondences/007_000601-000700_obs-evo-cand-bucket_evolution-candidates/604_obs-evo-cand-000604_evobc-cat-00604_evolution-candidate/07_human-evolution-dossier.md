...
- External category reference: `evobc-cat-00604`
- Source category ID: `00604`
- Source label for human review: `七`
- Source codepoints: `U+4E03`
...
- `obs-evo-cand-000604-route-category-staging`
...
- `obs-evo-cand-000604-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000604-route-evolution-graph`
