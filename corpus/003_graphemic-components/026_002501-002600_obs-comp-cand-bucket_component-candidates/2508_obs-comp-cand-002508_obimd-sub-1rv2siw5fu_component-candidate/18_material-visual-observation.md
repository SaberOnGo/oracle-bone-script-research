# Material Visual Observation / obs-comp-cand-002508 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002508`
- External reference / 外部参照: `obimd-sub-1rv2siw5fu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020783_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fd6c02qezd/1rv2siw5fu/1rv2siw5fu.png`
- Checksum / 校验和:
  `aa233f25112eaf4cd059fd40e48492fd0a97bb5827876bbcbfcceca0b0199f5b`
...
- Marked-pixel bounds: (92,39)–(163,208); span 72 × 170 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.07%。
- 痕迹范围：(92,39)–(163,208)；跨度72 × 170 px；痕迹矩形高于宽。
