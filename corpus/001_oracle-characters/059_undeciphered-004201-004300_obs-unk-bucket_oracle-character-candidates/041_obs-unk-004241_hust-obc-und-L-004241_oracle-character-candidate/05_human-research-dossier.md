# obs-unk-004241 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004241`
- primary external id: `hust-obc-und-L-004241`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/041_obs-unk-004241_h
  ust-obc-und-L-004241_oracle-character-candidate/03_visual-assets/001_asset
  -005834_hust-obc-und-L-004241_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4241/L_？_9328.jpg`
- asset id: `asset-005834`
...
- source class: `HUST-OBC/undeciphered/L/4241/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4241/L_？_9328.jpg`
- asset id: `asset-005834`
...
- English observation: `Upper curves, central trace, pointed terminal visible.`
- 中文观察: `上部弯曲笔画、中央痕迹和尖细下端可见。`
...
- Which source records identify obs-unk-004241 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004241？
