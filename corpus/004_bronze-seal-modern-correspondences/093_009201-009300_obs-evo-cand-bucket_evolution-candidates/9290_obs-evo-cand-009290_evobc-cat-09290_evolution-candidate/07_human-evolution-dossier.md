...
- Project ID: `obs-evo-cand-009290`
- EVOBC category candidate ID: `evobc-evo-cat-09290`
- External category reference: `evobc-cat-09290`
- Source category ID: `09290`
- Source label for human review: `醻`
- Source codepoints: `U+91BB`
...
- `obs-evo-cand-009290-route-category-staging`
...
- `obs-evo-cand-009290-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009290-route-evolution-graph`
