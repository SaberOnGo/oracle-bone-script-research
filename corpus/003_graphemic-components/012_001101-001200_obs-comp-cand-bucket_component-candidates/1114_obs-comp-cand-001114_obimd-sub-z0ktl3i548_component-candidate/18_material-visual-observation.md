# Material Visual Observation / obs-comp-cand-001114 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001114`
- External reference / 外部参照: `obimd-sub-z0ktl3i548`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015055_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/doqvaj2vzu/z0ktl3i548/z0ktl3i548.png`
- Checksum / 校验和:
  `dd3f96c2bcdb6b251dcfdd7b1765994a58be357b0609bfad51cbafc10e76f1ff`
...
- Marked-pixel bounds: (89,25)–(160,224); span 72 × 200 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.19%。
- 痕迹范围：(89,25)–(160,224)；跨度72 × 200 px；痕迹矩形高于宽。
