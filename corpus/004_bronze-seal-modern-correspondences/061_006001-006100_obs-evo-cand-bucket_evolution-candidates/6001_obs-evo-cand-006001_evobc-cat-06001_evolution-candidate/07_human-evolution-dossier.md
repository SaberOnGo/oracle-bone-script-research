...
- External category reference: `evobc-cat-06001`
- Source category ID: `06001`
- Source label for human review: `祯`
...
- `obs-evo-cand-006001-route-category-staging`
...
- `obs-evo-cand-006001-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006001-route-evolution-graph`
