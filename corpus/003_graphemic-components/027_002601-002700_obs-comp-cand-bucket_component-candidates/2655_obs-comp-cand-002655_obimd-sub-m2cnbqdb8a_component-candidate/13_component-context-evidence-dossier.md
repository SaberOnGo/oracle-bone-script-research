# obs-comp-cand-002655 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002655`
- 首选外部 ID: `obimd-sub-m2cnbqdb8a`
- OBIMD subcharacter UID: `m2cnbqdb8a`
- OBIMD main character UID: `m2cnbqdb8a`
- 来源 ID: `src-obimd`
...
- codepoint 示例: U+FEF5E; U+FEF5F; 另有 20 项
