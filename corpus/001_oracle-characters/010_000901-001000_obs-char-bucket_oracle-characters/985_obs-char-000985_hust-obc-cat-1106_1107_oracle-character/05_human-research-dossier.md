# obs-char-000985 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000985`
- primary external id: `hust-obc-cat-1106_1107`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/985_obs-char-000985_hust-obc-cat-1106_1107
  _oracle-character/03_visual-assets/001_asset-000990_hust-obc-cat-1106_1107
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1106_1107/1106/G_1106_京津3453合26
  092出組.png`
- asset id: `asset-000990`
...
- source category: `1106_1107`
- validation class: `984`
- source image route: `HUST-OBC/deciphered/1106_1107/1106/G_1106_京津3453合26092出
  組.png`
- asset id: `asset-000990`
...
- English observation: `A short upper branch leads into a long curved lower
  enclosure with side projections.`
- 中文观察: `短上部分枝连接长弯曲下部闭合轮廓，并带有侧伸笔。`
...
- dataset label text: `㡈㡉`
- dataset label codepoints: `U+3848;U+3849`
...
- graph edge count: `2`
- codepoint routes: `U+3848;U+3849`
...
- filename catalog route clues: `Heji-like filename clue: 合26092
...
- Which source records identify obs-char-000985 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000985？
