# obs-char-001191 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001191`
- primary external id: `hust-obc-cat-1332`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1191_obs-char-001191_hust-obc-cat-1332_ora
  cle-character/03_visual-assets/001_asset-001196_hust-obc-cat-1332_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1332/L_1332_3293.jpg`
- asset id: `asset-001196`
...
- source category: `1332`
- validation class: `1190`
- source image route: `HUST-OBC/deciphered/1332/L_1332_3293.jpg`
- asset id: `asset-001196`
...
- English observation: `The faint compact cluster combines several short
  angular crossings and a darker pointed lower stroke.`
- 中文观察: `较淡的紧凑笔群结合数个短折角交叉和较深的尖状下部笔。`
...
- dataset label text: `㤪`
- dataset label codepoints: `U+392A`
...
- Which source records identify obs-char-001191 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001191？
