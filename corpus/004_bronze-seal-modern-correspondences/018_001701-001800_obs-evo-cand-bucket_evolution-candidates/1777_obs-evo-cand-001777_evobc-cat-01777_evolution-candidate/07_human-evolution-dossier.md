...
- External category reference: `evobc-cat-01777`
- Source category ID: `01777`
- Source label for human review: `圆`
- Source codepoints: `U+5706`
...
- `obs-evo-cand-001777-route-category-staging`
...
- `obs-evo-cand-001777-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001777-route-evolution-graph`
