...
- External category reference: `evobc-cat-08701`
- Source category ID: `08701`
- Source label for human review: `趽`
- Source codepoints: `U+8DBD`
...
- `obs-evo-cand-008701-route-category-staging`
...
- `obs-evo-cand-008701-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008701-route-evolution-graph`
