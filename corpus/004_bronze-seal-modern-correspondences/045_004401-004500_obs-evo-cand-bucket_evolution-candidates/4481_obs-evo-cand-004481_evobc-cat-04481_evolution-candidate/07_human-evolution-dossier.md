...
Project ID: `obs-evo-cand-004481`
...
- Project ID: `obs-evo-cand-004481`
- EVOBC category candidate ID: `evobc-evo-cat-04481`
- External category reference: `evobc-cat-04481`
- Source category ID: `04481`
- Source label for human review: `氿`
- Source codepoints: `U+6C3F`
...
- `obs-evo-cand-004481-route-category-staging`
...
- `obs-evo-cand-004481-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004481-route-evolution-graph`
