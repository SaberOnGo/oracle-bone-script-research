# Material Visual Observation / obs-comp-cand-002121 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002121`
- External reference / 外部参照: `obimd-sub-cg4js9hmt2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019678_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/yuucprnzb5/cg4js9hmt2/cg4js9hmt2.png`
- Checksum / 校验和:
  `0d9a13ca723d6f98c53fbe16b1a47718cf96103d5ddc22b72c2062a08bc7472a`
...
- Marked-pixel bounds: (64,27)–(191,225); span 128 × 199 px; the marked
...
- 痕迹范围：(64,27)–(191,225)；跨度128 × 199 px；痕迹矩形高于宽。
