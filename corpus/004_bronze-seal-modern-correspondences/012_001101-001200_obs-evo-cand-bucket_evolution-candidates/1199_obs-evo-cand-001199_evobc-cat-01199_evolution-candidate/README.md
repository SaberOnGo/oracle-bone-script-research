# obs-evo-cand-001199 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-001199`
- EVOBC category candidate ID: `evobc-evo-cat-01199`
- External category ref: `evobc-cat-01199`
- Source label: `利`
- Source codepoints: `U+5229`
- Image reference count: `198`
- Era token counts: `BI:17;CS:2;OBC:77;SAC:9;SS:3;WSC:90`
- Source token counts: `Book:66;Web:132`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 77 image references
- era 1 / BI: 17 image references
- era 2 / SS: 3 image references
- era 3 / SAC: 9 image references
- era 4 / WSC: 90 image references
- era 5 / CS: 2 image references
- source 0 / Web:1633: 1 image references
- source 1 / Web:105952;說文Web:58: 109 image references
