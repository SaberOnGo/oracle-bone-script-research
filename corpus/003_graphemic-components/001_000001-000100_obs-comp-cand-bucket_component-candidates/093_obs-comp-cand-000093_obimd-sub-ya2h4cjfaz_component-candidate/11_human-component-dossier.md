# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-000093
...
- candidate_component_id: `obs-comp-cand-000093`
- primary_external_ref_id: `obimd-sub-ya2h4cjfaz`
- source_subcharacter_uid: `ya2h4cjfaz`
- source_main_character_uid: `ya2h4cjfaz`
- main_character_external_ref_id: `obimd-main-ya2h4cjfaz`
...
- glyph_codepoint_uplus_sample: `U+2420E;U+B4C35;U+F08EA, U+F08EB, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-011505` | `001_asset-011505_img.png` | `108a90f3ee011faadeeb251b2b35e197bff71c4a3508be75a6953d2f429ef1cd` |
