# obs-evo-cand-001518 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-001518`
- EVOBC category candidate ID: `evobc-evo-cat-01518`
- External category ref: `evobc-cat-01518`
- Source label: `吳`
- Source codepoints: `U+5433`
- Image reference count: `105`
- Era token counts: `BI:65;CS:2;SS:3;WSC:35`
- Source token counts: `Book:29;Web:76`

## Observed Code Rows / 观察到的代码行

- era 1 / BI: 65 image references
