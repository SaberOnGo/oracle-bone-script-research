...
Project ID: `obs-evo-cand-005020`
...
- Project ID: `obs-evo-cand-005020`
- EVOBC category candidate ID: `evobc-evo-cat-05020`
- External category reference: `evobc-cat-05020`
- Source category ID: `05020`
- Source label for human review: `灝`
- Source codepoints: `U+705D`
...
- `obs-evo-cand-005020-route-category-staging`
...
- `obs-evo-cand-005020-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005020-route-evolution-graph`
