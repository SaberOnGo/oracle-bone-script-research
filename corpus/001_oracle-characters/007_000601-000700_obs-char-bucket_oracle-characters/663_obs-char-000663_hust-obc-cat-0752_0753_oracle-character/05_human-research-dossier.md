# obs-char-000663 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000663`
- primary external id: `hust-obc-cat-0752_0753`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/663_obs-char-000663_hust-obc-cat-0752_0753
  _oracle-character/03_visual-assets/001_asset-000668_hust-obc-cat-0752_0753
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0752_0753/0752/G_0752_甲1360(甲).
  png`
- asset id: `asset-000668`
...
- source category: `0752_0753`
- validation class: `662`
- source image route: `HUST-OBC/deciphered/0752_0753/0752/G_0752_甲1360(甲).png`
- asset id: `asset-000668`
...
- English observation: `Three detached bold forms are aligned horizontally:
  two compact crossed branching clusters at left and center, and a curved
  loop with long pointed legs at right.`
- 中文观察: `三个分离粗重形横向排列：左、中为两个紧凑交叉分枝笔群，右侧为带长尖腿的弯环。`
...
- dataset label text: `㛦㛧`
- dataset label codepoints: `U+36E6;U+36E7`
...
- graph edge count: `2`
- codepoint routes: `U+36E6;U+36E7`
...
- Which source records identify obs-char-000663 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000663？
