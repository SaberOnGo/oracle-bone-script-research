...
- External category reference: `evobc-cat-09131`
- Source category ID: `09131`
- Source label for human review: `郈`
...
- `obs-evo-cand-009131-route-category-staging`
...
- `obs-evo-cand-009131-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009131-route-evolution-graph`
