...
Project ID: `obs-evo-cand-003611`
...
- Project ID: `obs-evo-cand-003611`
- EVOBC category candidate ID: `evobc-evo-cat-03611`
- External category reference: `evobc-cat-03611`
- Source category ID: `03611`
- Source label for human review: `數`
- Source codepoints: `U+6578`
...
- `obs-evo-cand-003611-route-category-staging`
...
- `obs-evo-cand-003611-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003611-route-evolution-graph`
