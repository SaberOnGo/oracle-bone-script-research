# obs-unk-005608 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005608`
- primary external id: `hust-obc-und-X-005608`
...
- local review image route: `corpus/001_oracle-characters/073_undeciphered-005
  601-005700_obs-unk-bucket_oracle-character-candidates/008_obs-unk-005608_h
  ust-obc-und-X-005608_oracle-character-candidate/03_visual-assets/001_asset
  -007201_hust-obc-und-X-005608_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1164/X_？_8119_1.png`
- asset id: `asset-007201`
...
- source class: `HUST-OBC/undeciphered/X/1164/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1164/X_？_8119_1.png`
- asset id: `asset-007201`
...
- Which source records identify obs-unk-005608 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005608？
