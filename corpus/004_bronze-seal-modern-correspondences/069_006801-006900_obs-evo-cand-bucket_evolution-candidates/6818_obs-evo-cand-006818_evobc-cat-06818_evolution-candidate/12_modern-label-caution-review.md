# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006818
...
- EVOBC candidate category: `evobc-evo-cat-06818`.
- Source label for search only: `置`.
- Source codepoints for search only: `U+7F6E`.
