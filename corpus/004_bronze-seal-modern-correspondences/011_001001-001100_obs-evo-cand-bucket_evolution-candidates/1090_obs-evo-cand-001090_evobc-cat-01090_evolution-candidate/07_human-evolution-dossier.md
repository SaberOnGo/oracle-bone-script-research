...
- External category reference: `evobc-cat-01090`
- Source category ID: `01090`
- Source label for human review: `兩`
- Source codepoints: `U+5169`
...
- `obs-evo-cand-001090-route-category-staging`
...
- `obs-evo-cand-001090-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001090-route-evolution-graph`
