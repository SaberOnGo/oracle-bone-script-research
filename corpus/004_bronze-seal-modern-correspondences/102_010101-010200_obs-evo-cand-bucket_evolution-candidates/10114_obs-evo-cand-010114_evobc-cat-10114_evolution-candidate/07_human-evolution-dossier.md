...
- External category reference: `evobc-cat-10114`
- Source category ID: `10114`
- Source label for human review: `餥`
- Source codepoints: `U+9925`
...
- `obs-evo-cand-010114-route-category-staging`
...
- `obs-evo-cand-010114-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010114-route-evolution-graph`
