# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002074
...
| --- | --- | --- | --- |
| `obimd-glyph-link-032024` | 󻼋 | `U+FBF0B` | `reviewed_metadata_only` |
| `obimd-glyph-link-032025` | 󻼌 | `U+FBF0C` | `reviewed_metadata_only` |
