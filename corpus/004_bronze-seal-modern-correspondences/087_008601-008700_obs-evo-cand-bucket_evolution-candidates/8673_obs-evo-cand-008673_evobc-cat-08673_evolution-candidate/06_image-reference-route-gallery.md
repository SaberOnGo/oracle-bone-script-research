...
- `obs-evo-cand-008673-route-category-staging`
...
- `obs-evo-cand-008673-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008673-route-evolution-graph`
