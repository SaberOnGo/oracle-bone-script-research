...
- External category reference: `evobc-cat-05051`
- Source category ID: `05051`
- Source label for human review: `炫`
...
- `obs-evo-cand-005051-route-category-staging`
...
- `obs-evo-cand-005051-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005051-route-evolution-graph`
