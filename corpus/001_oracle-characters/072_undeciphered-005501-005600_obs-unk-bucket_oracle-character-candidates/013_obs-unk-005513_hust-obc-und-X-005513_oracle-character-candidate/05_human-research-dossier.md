# obs-unk-005513 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005513`
- primary external id: `hust-obc-und-X-005513`
...
- local review image route: `corpus/001_oracle-characters/072_undeciphered-005
  501-005600_obs-unk-bucket_oracle-character-candidates/013_obs-unk-005513_h
  ust-obc-und-X-005513_oracle-character-candidate/03_visual-assets/001_asset
  -007106_hust-obc-und-X-005513_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1069/X_？_8031_1.png`
- asset id: `asset-007106`
...
- source class: `HUST-OBC/undeciphered/X/1069/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1069/X_？_8031_1.png`
- asset id: `asset-007106`
...
- Which source records identify obs-unk-005513 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005513？
