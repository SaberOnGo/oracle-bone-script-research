...
- Project ID: `obs-evo-cand-005143`
- EVOBC category candidate ID: `evobc-evo-cat-05143`
- External category reference: `evobc-cat-05143`
- Source category ID: `05143`
- Source label for human review: `燂`
- Source codepoints: `U+71C2`
...
- `obs-evo-cand-005143-route-category-staging`
...
- `obs-evo-cand-005143-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005143-route-evolution-graph`
