...
- External category reference: `evobc-cat-07153`
- Source category ID: `07153`
- Source label for human review: `臘`
...
- `obs-evo-cand-007153-route-category-staging`
...
- `obs-evo-cand-007153-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007153-route-evolution-graph`
