...
Project ID: `obs-evo-cand-011228`
...
- Project ID: `obs-evo-cand-011228`
- EVOBC category candidate ID: `evobc-evo-cat-11228`
- External category reference: `evobc-cat-11228`
- Source category ID: `11228`
- Source label for human review: `𢙇`
- Source codepoints: `U+22647`
...
- `obs-evo-cand-011228-route-category-staging`
...
- `obs-evo-cand-011228-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011228-route-evolution-graph`
