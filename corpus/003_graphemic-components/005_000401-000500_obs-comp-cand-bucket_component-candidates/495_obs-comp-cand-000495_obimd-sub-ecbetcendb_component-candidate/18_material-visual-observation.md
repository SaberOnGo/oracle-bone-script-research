# Material Visual Observation / obs-comp-cand-000495 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000495`
- External reference / 外部参照: `obimd-sub-ecbetcendb`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012731_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ecbetcendb/ecbetcendb/ecbetcendb.png`
- Checksum / 校验和:
  `f92031b3567d36abbfd47d037aef52386d8a3479fa66ce96ef8689d374cc2c50`
...
- Marked-pixel bounds: (70,30)–(179,219); span 110 × 190 px; the marked
...
- 痕迹范围：(70,30)–(179,219)；跨度110 × 190 px；痕迹矩形高于宽。
