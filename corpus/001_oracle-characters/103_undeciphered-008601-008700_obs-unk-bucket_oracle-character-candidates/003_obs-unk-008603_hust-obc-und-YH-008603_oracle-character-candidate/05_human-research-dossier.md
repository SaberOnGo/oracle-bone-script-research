# obs-unk-008603 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008603`
- primary external id: `hust-obc-und-YH-008603`
...
- local review image route: `corpus/001_oracle-characters/103_undeciphered-008
  601-008700_obs-unk-bucket_oracle-character-candidates/003_obs-unk-008603_h
  ust-obc-und-YH-008603_oracle-character-candidate/03_visual-assets/001_asse
  t-010194_hust-obc-und-YH-008603_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60C57/H_？_60C57_0.png`
- asset id: `asset-010194`
...
- source class: `HUST-OBC/undeciphered/Y+H/60C57/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60C57/H_？_60C57_0.png`
- asset id: `asset-010194`
...
- Which source records identify obs-unk-008603 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008603？
