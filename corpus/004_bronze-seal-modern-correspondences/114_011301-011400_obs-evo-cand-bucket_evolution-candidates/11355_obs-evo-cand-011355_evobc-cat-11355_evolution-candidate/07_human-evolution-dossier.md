...
- External category reference: `evobc-cat-11355`
- Source category ID: `11355`
- Source label for human review: `𢿆`
- Source codepoints: `U+22FC6`
...
- `obs-evo-cand-011355-route-category-staging`
...
- `obs-evo-cand-011355-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011355-route-evolution-graph`
