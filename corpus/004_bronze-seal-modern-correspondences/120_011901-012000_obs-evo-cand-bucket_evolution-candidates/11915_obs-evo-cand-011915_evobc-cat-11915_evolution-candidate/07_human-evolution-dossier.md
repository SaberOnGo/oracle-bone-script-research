...
- External category reference: `evobc-cat-11915`
- Source category ID: `11915`
- Source label for human review: `𥸬`
...
- `obs-evo-cand-011915-route-category-staging`
...
- `obs-evo-cand-011915-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011915-route-evolution-graph`
