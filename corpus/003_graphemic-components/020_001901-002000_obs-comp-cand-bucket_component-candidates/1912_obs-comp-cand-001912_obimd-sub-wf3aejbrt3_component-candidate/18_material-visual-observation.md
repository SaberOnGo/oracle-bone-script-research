# Material Visual Observation / obs-comp-cand-001912 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001912`
- External reference / 外部参照: `obimd-sub-wf3aejbrt3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018322_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wf3aejbrt3/wf3aejbrt3/wf3aejbrt3.png`
- Checksum / 校验和:
  `69319887994c256dbd91344f061b9158cea82b9d217d7eb797ce74f6319fed0b`
...
- Marked-pixel bounds: (61,46)–(203,210); span 143 × 165 px; the marked
...
- 痕迹范围：(61,46)–(203,210)；跨度143 × 165 px；痕迹矩形近方形。
