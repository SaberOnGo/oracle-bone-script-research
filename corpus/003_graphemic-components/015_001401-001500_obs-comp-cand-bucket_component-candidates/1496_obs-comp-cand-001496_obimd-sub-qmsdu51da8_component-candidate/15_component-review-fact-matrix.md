# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001496
...
| Glyph or codepoint route / 字形或码位路线 | 86 OBIMD route rows; examples U+5357;U+F8915; U+F8916; 另有 84 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 86 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
