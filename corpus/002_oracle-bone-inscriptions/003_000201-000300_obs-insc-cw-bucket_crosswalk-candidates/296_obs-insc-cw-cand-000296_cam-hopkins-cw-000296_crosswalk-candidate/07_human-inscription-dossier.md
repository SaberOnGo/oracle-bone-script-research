...
Project ID: `obs-insc-cw-cand-000296`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000296`
...
- Yingguo / 英国所藏: `y1928` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `268` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `26` in source row; primary catalog entry pending
- Heji / 合集: `40931` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000296`
