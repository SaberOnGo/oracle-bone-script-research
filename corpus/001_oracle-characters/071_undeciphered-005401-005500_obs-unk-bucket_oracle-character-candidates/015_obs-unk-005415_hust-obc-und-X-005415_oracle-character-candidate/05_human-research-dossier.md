# obs-unk-005415 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005415`
- primary external id: `hust-obc-und-X-005415`
...
- local review image route: `corpus/001_oracle-characters/071_undeciphered-005
  401-005500_obs-unk-bucket_oracle-character-candidates/015_obs-unk-005415_h
  ust-obc-und-X-005415_oracle-character-candidate/03_visual-assets/001_asset
  -007008_hust-obc-und-X-005415_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/971/X_？_7935_1.png`
- asset id: `asset-007008`
...
- source class: `HUST-OBC/undeciphered/X/971/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/971/X_？_7935_1.png`
- asset id: `asset-007008`
...
- Which source records identify obs-unk-005415 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005415？
