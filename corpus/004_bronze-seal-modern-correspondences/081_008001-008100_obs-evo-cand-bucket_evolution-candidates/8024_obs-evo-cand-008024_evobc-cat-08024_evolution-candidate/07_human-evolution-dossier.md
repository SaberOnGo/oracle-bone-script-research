...
- External category reference: `evobc-cat-08024`
- Source category ID: `08024`
- Source label for human review: `褿`
- Source codepoints: `U+893F`
...
- `obs-evo-cand-008024-route-category-staging`
...
- `obs-evo-cand-008024-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008024-route-evolution-graph`
