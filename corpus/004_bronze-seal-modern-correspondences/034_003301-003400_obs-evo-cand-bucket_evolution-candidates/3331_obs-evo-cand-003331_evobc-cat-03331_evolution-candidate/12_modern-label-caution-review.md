# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003331
...
- EVOBC candidate category: `evobc-evo-cat-03331`.
- Source label for search only: `拱`.
- Source codepoints for search only: `U+62F1`.
