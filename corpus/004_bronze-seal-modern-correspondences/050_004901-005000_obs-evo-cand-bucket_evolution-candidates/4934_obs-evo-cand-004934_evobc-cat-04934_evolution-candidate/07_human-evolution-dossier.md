...
Project ID: `obs-evo-cand-004934`
...
- Project ID: `obs-evo-cand-004934`
- EVOBC category candidate ID: `evobc-evo-cat-04934`
- External category reference: `evobc-cat-04934`
- Source category ID: `04934`
- Source label for human review: `澗`
- Source codepoints: `U+6F97`
...
- `obs-evo-cand-004934-route-category-staging`
...
- `obs-evo-cand-004934-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004934-route-evolution-graph`
