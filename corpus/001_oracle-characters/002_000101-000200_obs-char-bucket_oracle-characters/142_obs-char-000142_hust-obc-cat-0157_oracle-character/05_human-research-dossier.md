# obs-char-000142 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000142`
- primary external id: `hust-obc-cat-0157`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/142_obs-char-000142_hust-obc-cat-0157_orac
  le-character/03_visual-assets/001_asset-000147_hust-obc-cat-0157_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0157/X_0157_3803_1.png`
- asset id: `asset-000147`
...
- source category: `0157`
- validation class: `141`
- source image route: `HUST-OBC/deciphered/0157/X_0157_3803_1.png`
- asset id: `asset-000147`
...
- English observation: `The broad image combines a heavy left vertical with
  two horizontal bands and a separate tall curved form on the right.`
- 中文观察: `宽大图像左侧有粗重竖笔和两道横向带状笔，右侧另有一处高而弯曲的形体。`
...
- dataset label text: `㒓`
- dataset label codepoints: `U+3493`
...
- Which source records identify obs-char-000142 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000142？
