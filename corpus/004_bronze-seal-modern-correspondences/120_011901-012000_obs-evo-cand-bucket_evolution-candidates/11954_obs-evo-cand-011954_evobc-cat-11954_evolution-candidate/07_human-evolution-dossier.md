...
- External category reference: `evobc-cat-11954`
- Source category ID: `11954`
- Source label for human review: `𦂁`
- Source codepoints: `U+26081`
...
- `obs-evo-cand-011954-route-category-staging`
...
- `obs-evo-cand-011954-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011954-route-evolution-graph`
