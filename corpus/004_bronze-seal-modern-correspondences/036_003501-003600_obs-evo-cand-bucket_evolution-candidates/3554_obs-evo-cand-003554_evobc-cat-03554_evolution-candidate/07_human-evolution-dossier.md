...
Project ID: `obs-evo-cand-003554`
...
- Project ID: `obs-evo-cand-003554`
- EVOBC category candidate ID: `evobc-evo-cat-03554`
- External category reference: `evobc-cat-03554`
- Source category ID: `03554`
- Source label for human review: `支`
- Source codepoints: `U+652F`
...
- `obs-evo-cand-003554-route-category-staging`
...
- `obs-evo-cand-003554-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003554-route-evolution-graph`
