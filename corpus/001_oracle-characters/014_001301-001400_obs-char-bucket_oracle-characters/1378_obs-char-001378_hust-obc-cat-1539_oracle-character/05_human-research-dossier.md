# obs-char-001378 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001378`
- primary external id: `hust-obc-cat-1539`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1378_obs-char-001378_hust-obc-cat-1539_ora
  cle-character/03_visual-assets/001_asset-001383_hust-obc-cat-1539_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1539/G_1539_續3.30.7(甲).png`
- asset id: `asset-001383`
...
- source category: `1539`
- validation class: `1377`
- source image route: `HUST-OBC/deciphered/1539/G_1539_續3.30.7(甲).png`
- asset id: `asset-001383`
...
- English observation: `A narrow composite has repeated left ticks, an upper
  enclosure, and a lower branch.`
- 中文观察: `狭长组合形体有重复左侧短笔、上部框形和下部分枝。`
...
- dataset label text: `㧹`
- dataset label codepoints: `U+39F9`
...
- Which source records identify obs-char-001378 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001378？
