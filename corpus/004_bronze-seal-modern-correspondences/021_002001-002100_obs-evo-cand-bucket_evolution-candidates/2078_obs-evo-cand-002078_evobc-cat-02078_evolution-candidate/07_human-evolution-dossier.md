...
- External category reference: `evobc-cat-02078`
- Source category ID: `02078`
- Source label for human review: `妐`
...
- `obs-evo-cand-002078-route-category-staging`
...
- `obs-evo-cand-002078-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002078-route-evolution-graph`
