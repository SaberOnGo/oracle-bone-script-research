...
- External category reference: `evobc-cat-04416`
- Source category ID: `04416`
- Source label for human review: `殟`
- Source codepoints: `U+6B9F`
...
- `obs-evo-cand-004416-route-category-staging`
...
- `obs-evo-cand-004416-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004416-route-evolution-graph`
