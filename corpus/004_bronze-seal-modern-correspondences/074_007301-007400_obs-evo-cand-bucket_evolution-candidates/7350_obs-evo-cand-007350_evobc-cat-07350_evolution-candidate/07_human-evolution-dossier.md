...
- External category reference: `evobc-cat-07350`
- Source category ID: `07350`
- Source label for human review: `荐`
- Source codepoints: `U+8350`
...
- `obs-evo-cand-007350-route-category-staging`
...
- `obs-evo-cand-007350-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007350-route-evolution-graph`
