...
- External category reference: `evobc-cat-03538`
- Source category ID: `03538`
- Source label for human review: `擾`
- Source codepoints: `U+64FE`
...
- `obs-evo-cand-003538-route-category-staging`
...
- `obs-evo-cand-003538-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003538-route-evolution-graph`
