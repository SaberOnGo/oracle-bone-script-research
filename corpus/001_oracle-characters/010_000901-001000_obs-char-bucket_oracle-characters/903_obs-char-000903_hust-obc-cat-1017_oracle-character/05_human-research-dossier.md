# obs-char-000903 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/903_obs-char-000903_hust-obc-cat-1017_orac
  le-character/03_visual-assets/001_asset-000908_hust-obc-cat-1017_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1017/H_1017_60672_0.png`
- asset id: `asset-000908`
...
- source category: `1017`
- validation class: `902`
- source image route: `HUST-OBC/deciphered/1017/H_1017_60672_0.png`
- asset id: `asset-000908`
...
- dataset label text: `㟯`
- dataset label codepoints: `U+37EF`
...
- filename catalog route clues: `catalog-like filename clue: H_1017
  (H_1017_60672_0.png)`
...
- Which source records identify obs-char-000903 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000903？
