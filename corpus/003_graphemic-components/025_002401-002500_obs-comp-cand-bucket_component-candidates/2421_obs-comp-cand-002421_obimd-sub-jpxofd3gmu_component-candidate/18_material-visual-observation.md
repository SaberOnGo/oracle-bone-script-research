# Material Visual Observation / obs-comp-cand-002421 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002421`
- External reference / 外部参照: `obimd-sub-jpxofd3gmu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020492_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jpxofd3gmu/jpxofd3gmu/jpxofd3gmu.png`
- Checksum / 校验和:
  `33a4d6b9fdf4f4677d06811edf0432135ff8f03d07ebd9f3bb9a3e2e638ff1cd`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 15.39%.
- Marked-pixel bounds: (52,18)–(204,230); span 153 × 213 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占15.39%。
- 痕迹范围：(52,18)–(204,230)；跨度153 × 213 px；痕迹矩形高于宽。
