# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004241
...
- EVOBC candidate category: `evobc-evo-cat-04241`.
- Source label for search only: `樛`.
- Source codepoints for search only: `U+6A1B`.
