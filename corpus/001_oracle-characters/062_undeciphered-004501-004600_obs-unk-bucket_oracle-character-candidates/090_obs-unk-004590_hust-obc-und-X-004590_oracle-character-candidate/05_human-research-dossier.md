# obs-unk-004590 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004590`
- primary external id: `hust-obc-und-X-004590`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/090_obs-unk-004590_h
  ust-obc-und-X-004590_oracle-character-candidate/03_visual-assets/001_asset
  -006183_hust-obc-und-X-004590_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/146/X_？_8324_1.png`
- asset id: `asset-006183`
...
- source class: `HUST-OBC/undeciphered/X/146/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/146/X_？_8324_1.png`
- asset id: `asset-006183`
...
- English observation: `Rounded top, two hanging traces, and right opening`
  `recorded.`
- 中文观察: `已记录圆曲上部、两条悬垂痕和右侧开口。`
...
- Which source records identify obs-unk-004590 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004590？
