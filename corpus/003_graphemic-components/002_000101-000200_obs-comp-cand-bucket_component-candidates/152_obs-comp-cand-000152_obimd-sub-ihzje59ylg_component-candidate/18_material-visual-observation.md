# Material Visual Observation / obs-comp-cand-000152 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000152`
- External reference / 外部参照: `obimd-sub-ihzje59ylg`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011564_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ihzje59ylg/ihzje59ylg/ihzje59ylg.png`
- Checksum / 校验和:
  `8fdd2f6d8165d5e9c55c2536faa18ee95c6706866e5a70c96c3db28a97a9908f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.62%.
- Marked-pixel bounds: (37,35)–(225,208); span 189 × 174 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.62%。
- 痕迹范围：(37,35)–(225,208)；跨度189 × 174 px；痕迹矩形近方形。
