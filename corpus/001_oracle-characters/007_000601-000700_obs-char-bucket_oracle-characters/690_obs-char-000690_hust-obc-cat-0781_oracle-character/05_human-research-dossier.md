# obs-char-000690 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000690`
- primary external id: `hust-obc-cat-0781`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/690_obs-char-000690_hust-obc-cat-0781_orac
  le-character/03_visual-assets/001_asset-000695_hust-obc-cat-0781_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0781/G_0781_乙1968合1772賓組.png`
- asset id: `asset-000695`
...
- source category: `0781`
- validation class: `689`
- source image route: `HUST-OBC/deciphered/0781/G_0781_乙1968合1772賓組.png`
- asset id: `asset-000695`
...
- English observation: `Two detached wavy horizontal lines form an upper
  pair; below them, a rounded rectangular outline contains one short central
  horizontal bar.`
- 中文观察: `两条分离波折横线组成上部一对；其下圆角矩形轮廓内含一条短中央横栏。`
...
- dataset label text: `㜃`
- dataset label codepoints: `U+3703`
...
- filename catalog route clues: `Heji-like filename clue: 合1772
  (G_0781_乙1968合1772賓組.png)`
...
- Which source records identify obs-char-000690 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000690？
