# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002194
...
| --- | --- | --- | --- |
| `obimd-glyph-link-034074` | 󼨇 | `U+FCA07` | `reviewed_metadata_only` |
| `obimd-glyph-link-034075` | 󼨈 | `U+FCA08` | `reviewed_metadata_only` |
