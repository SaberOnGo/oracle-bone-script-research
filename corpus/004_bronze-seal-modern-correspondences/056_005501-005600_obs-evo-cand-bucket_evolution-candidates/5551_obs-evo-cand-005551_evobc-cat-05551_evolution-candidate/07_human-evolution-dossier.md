...
- External category reference: `evobc-cat-05551`
- Source category ID: `05551`
- Source label for human review: `甹`
...
- `obs-evo-cand-005551-route-category-staging`
...
- `obs-evo-cand-005551-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005551-route-evolution-graph`
