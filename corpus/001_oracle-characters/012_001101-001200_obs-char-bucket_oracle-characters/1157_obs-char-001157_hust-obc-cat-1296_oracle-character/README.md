...
- Directory / 目录: `corpus/001_oracle-characters/012_001101-001200_obs-char-bucket_oracle-characters/1157_obs-char-001157_hust-obc-cat-1296_oracle-character`

## Visual Material Status / 图像资料状态

- Status / 状态: `committed_review_image_derivative`
- Source image reference rows / 来源图像路径引用行数: `1`
- Committed glyph image / 已提交字形图像: 03_visual-assets/001_asset-001162_hust-obc-cat-1296_glyph.png
