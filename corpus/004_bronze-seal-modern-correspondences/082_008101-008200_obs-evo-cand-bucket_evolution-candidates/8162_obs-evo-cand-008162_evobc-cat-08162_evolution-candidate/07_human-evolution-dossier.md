...
- Project ID: `obs-evo-cand-008162`
- EVOBC category candidate ID: `evobc-evo-cat-08162`
- External category reference: `evobc-cat-08162`
- Source category ID: `08162`
- Source label for human review: `証`
- Source codepoints: `U+8A3C`
...
- `obs-evo-cand-008162-route-category-staging`
...
- `obs-evo-cand-008162-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008162-route-evolution-graph`
