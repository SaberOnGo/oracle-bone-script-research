...
- External category reference: `evobc-cat-12439`
- Source category ID: `12439`
- Source label for human review: `𨜅`
...
- `obs-evo-cand-012439-route-category-staging`
...
- `obs-evo-cand-012439-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012439-route-evolution-graph`
