# obs-comp-cand-001648 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001648`
- 首选外部 ID: `obimd-sub-pjmzvla929`
- OBIMD subcharacter UID: `pjmzvla929`
- OBIMD main character UID: `qg6bx6xlgq`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+F992C; U+F992D; 另有 1 项
