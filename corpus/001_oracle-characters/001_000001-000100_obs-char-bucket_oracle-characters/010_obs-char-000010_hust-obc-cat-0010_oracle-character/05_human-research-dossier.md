# obs-char-000010 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000010`
- primary external id: `hust-obc-cat-0010`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/010_obs-char-000010_hust-obc-cat-0010_orac
  le-character/03_visual-assets/001_asset-000015_hust-obc-cat-0010_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0010/G_0010_乙8526合22173子組.png`
- asset id: `asset-000015`
...
- source category: `0010`
- validation class: `9`
- source image route: `HUST-OBC/deciphered/0010/G_0010_乙8526合22173子組.png`
- asset id: `asset-000015`
...
- English observation: `The image shows a rectangular outer contour, an
  angular interior stroke, and a short downward tail.`
- 中文观察: `图像呈长方形外轮廓，内部有折角笔画，并向下伸出短尾。`
...
- dataset label text: `㐀`
- dataset label codepoints: `U+3400`
...
- filename catalog route clues: `Heji-like filename clue: 合22173
  (G_0010_乙8526合22173子組.png)`
...
- Which source records identify obs-char-000010 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000010？
