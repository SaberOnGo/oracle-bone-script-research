# obs-char-000590 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000590`
- primary external id: `hust-obc-cat-0669`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/590_obs-char-000590_hust-obc-cat-0669_orac
  le-character/03_visual-assets/001_asset-000595_hust-obc-cat-0669_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0669/G_0669_乙8823合22287子組.png`
- asset id: `asset-000595`
...
- source category: `0669`
- validation class: `589`
- source image route: `HUST-OBC/deciphered/0669/G_0669_乙8823合22287子組.png`
- asset id: `asset-000595`
...
- English observation: `A very narrow vertical chain contains several
  stacked pointed loops or crossings and continues into two thin separated
  lower extensions.`
- 中文观察: `极狭长竖向链内有数个层叠尖环或交叉，下端延续为两条纤细分离笔。`
...
- dataset label text: `㚓`
- dataset label codepoints: `U+3693`
...
- filename catalog route clues: `Heji-like filename clue: 合22287
  (G_0669_乙8823合22287子組.png)`
...
- Which source records identify obs-char-000590 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000590？
