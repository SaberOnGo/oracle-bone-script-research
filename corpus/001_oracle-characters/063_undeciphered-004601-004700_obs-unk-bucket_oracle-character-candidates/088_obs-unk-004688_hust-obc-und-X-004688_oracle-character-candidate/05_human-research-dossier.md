# obs-unk-004688 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/088_obs-unk-004688_h
  ust-obc-und-X-004688_oracle-character-candidate/03_visual-assets/001_asset
  -006281_hust-obc-und-X-004688_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/244/X_？_8412_1.png`
- asset id: `asset-006281`
...
- source class: `HUST-OBC/undeciphered/X/244/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/244/X_？_8412_1.png`
- asset id: `asset-006281`
...
- English observation: `sparse forked strokes with detached lower fragments`
- 中文观察: `带分离下部残片的稀疏分叉笔画`
...
- Which source records identify obs-unk-004688 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004688？
