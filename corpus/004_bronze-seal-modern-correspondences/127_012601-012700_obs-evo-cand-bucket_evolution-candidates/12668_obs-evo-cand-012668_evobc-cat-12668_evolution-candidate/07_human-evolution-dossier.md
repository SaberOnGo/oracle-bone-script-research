...
Project ID: `obs-evo-cand-012668`
...
- Project ID: `obs-evo-cand-012668`
- EVOBC category candidate ID: `evobc-evo-cat-12668`
- External category reference: `evobc-cat-12668`
- Source category ID: `12668`
- Source label for human review: `𩪖`
- Source codepoints: `U+29A96`
...
- `obs-evo-cand-012668-route-category-staging`
...
- `obs-evo-cand-012668-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012668-route-evolution-graph`
