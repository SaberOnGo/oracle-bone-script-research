...
- External category reference: `evobc-cat-08092`
- Source category ID: `08092`
- Source label for human review: `觑`
- Source codepoints: `U+89D1`
...
- `obs-evo-cand-008092-route-category-staging`
...
- `obs-evo-cand-008092-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008092-route-evolution-graph`
