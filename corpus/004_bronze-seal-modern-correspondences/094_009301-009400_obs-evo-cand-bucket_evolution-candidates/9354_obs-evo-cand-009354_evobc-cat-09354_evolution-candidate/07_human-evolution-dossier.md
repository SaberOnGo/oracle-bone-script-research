...
- External category reference: `evobc-cat-09354`
- Source category ID: `09354`
- Source label for human review: `鉈`
- Source codepoints: `U+9248`
...
- `obs-evo-cand-009354-route-category-staging`
...
- `obs-evo-cand-009354-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009354-route-evolution-graph`
