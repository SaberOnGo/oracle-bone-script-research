...
- External category reference: `evobc-cat-12041`
- Source category ID: `12041`
- Source label: `𦙔`
...
- `obs-evo-cand-012041-route-category-staging`
...
- `obs-evo-cand-012041-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-012041-route-evolution-graph`
