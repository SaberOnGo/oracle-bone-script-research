# obs-unk-006263 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/079_undeciphered-006
  201-006300_obs-unk-bucket_oracle-character-candidates/063_obs-unk-006263_h
  ust-obc-und-X-006263_oracle-character-candidate/03_visual-assets/001_asset
  -007855_hust-obc-und-X-006263_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1819/X_？_4754_1.png`
- asset id: `asset-007855`
...
- source class: `HUST-OBC/undeciphered/X/1819/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1819/X_？_4754_1.png`
- asset id: `asset-007855`
...
- Which source records identify obs-unk-006263 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006263？
