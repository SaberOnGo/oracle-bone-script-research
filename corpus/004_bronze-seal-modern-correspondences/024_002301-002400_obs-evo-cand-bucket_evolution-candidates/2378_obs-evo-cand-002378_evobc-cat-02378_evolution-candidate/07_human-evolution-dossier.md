...
- External category reference: `evobc-cat-02378`
- Source category ID: `02378`
- Source label for human review: `宜`
- Source codepoints: `U+5B9C`
- Image reference count in source metadata: `220`
...
- `obs-evo-cand-002378-route-category-staging`
...
- `obs-evo-cand-002378-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002378-route-evolution-graph`
