# obs-char-001486 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1486_obs-char-001486_hust-obc-cat-1668_ora
  cle-character/03_visual-assets/001_asset-001491_hust-obc-cat-1668_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1668/G_1668_乙1424合21787.png`
- asset id: `asset-001491`
...
- source category: `1668`
- validation class: `1485`
- source image route: `HUST-OBC/deciphered/1668/G_1668_乙1424合21787.png`
- asset id: `asset-001491`
...
- English observation: `A dark upper enclosure leads into a branching lower
  stem and side stroke.`
- 中文观察: `深色上部框形连接下部分枝竖干和侧部笔画。`
...
- dataset label text: `㩺`
- dataset label codepoints: `U+3A7A`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00145`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00145`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00145`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/145_obs-evo-can
  d-000145_evobc-cat-00145_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/145_obs-evo-cand-000145_evobc-cat-00145_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合21787
  (G_1668_乙1424合21787.png)`
...
- Which source records identify obs-char-001486 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001486？
