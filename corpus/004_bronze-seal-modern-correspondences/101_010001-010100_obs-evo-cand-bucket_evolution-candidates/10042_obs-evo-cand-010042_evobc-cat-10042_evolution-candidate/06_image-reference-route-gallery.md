...
- `obs-evo-cand-010042-route-category-staging`
...
- `obs-evo-cand-010042-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010042-route-evolution-graph`
