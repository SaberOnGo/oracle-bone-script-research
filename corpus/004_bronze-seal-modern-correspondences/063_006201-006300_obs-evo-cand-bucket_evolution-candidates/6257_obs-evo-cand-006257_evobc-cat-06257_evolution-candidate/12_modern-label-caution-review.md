# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006257
...
- EVOBC candidate category: `evobc-evo-cat-06257`.
- Source label for search only: `筊`.
- Source codepoints for search only: `U+7B4A`.
