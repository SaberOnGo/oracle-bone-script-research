...
- Project ID: `obs-evo-cand-003221`
- EVOBC category candidate ID: `evobc-evo-cat-03221`
- External category reference: `evobc-cat-03221`
- Source category ID: `03221`
- Source label for human review: `戩`
- Source codepoints: `U+6229`
...
- `obs-evo-cand-003221-route-category-staging`
...
- `obs-evo-cand-003221-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003221-route-evolution-graph`
