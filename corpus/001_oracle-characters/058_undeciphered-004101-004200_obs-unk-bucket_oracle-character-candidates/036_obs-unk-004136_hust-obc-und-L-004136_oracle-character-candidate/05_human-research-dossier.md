# obs-unk-004136 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004136`
- primary external id: `hust-obc-und-L-004136`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/036_obs-unk-004136_h
  ust-obc-und-L-004136_oracle-character-candidate/03_visual-assets/001_asset
  -005729_hust-obc-und-L-004136_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4136/L_？_8939.jpg`
- asset id: `asset-005729`
...
- source class: `HUST-OBC/undeciphered/L/4136/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4136/L_？_8939.jpg`
- asset id: `asset-005729`
...
- English observation: A rounded outline occupies the upper area;
  a curved stroke descends from its lower part.
- 中文观察：上部有圆弧状轮廓；一条弯曲痕迹从下部向下延伸。
...
- Which source records identify obs-unk-004136 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004136？
