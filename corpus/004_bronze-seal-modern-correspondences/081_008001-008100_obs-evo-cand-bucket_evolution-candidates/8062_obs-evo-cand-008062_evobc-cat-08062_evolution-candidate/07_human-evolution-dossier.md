...
- External category reference: `evobc-cat-08062`
- Source category ID: `08062`
- Source label for human review: `覛`
...
- `obs-evo-cand-008062-route-category-staging`
...
- `obs-evo-cand-008062-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008062-route-evolution-graph`
