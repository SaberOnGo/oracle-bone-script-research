...
- External category reference: `evobc-cat-07616`
- Source category ID: `07616`
- Source label for human review: `薠`
...
- `obs-evo-cand-007616-route-category-staging`
...
- `obs-evo-cand-007616-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007616-route-evolution-graph`
