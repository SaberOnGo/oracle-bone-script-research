# Material Visual Observation / obs-comp-cand-002738 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002738`
- External reference / 外部参照: `obimd-sub-kvjaqv4fa1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021354_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kvjaqv4fa1/kvjaqv4fa1/kvjaqv4fa1.png`
- Checksum / 校验和:
  `7d30f7fd4c6e801c8bfb22295e127bee7bdc9a03044ca81f9284d71709a06bb0`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 17.05%.
- Marked-pixel bounds: (20,37)–(229,226); span 210 × 190 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占17.05%。
- 痕迹范围：(20,37)–(229,226)；跨度210 × 190 px；痕迹矩形近方形。
