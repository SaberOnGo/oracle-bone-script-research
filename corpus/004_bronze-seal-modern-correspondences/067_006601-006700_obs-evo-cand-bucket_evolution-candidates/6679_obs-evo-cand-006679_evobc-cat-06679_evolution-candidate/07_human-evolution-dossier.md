...
- External category reference: `evobc-cat-06679`
- Source category ID: `06679`
- Source label for human review: `繛`
- Source codepoints: `U+7E5B`
...
- `obs-evo-cand-006679-route-category-staging`
...
- `obs-evo-cand-006679-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006679-route-evolution-graph`
