...
- External category reference: `evobc-cat-00121`
- Source category ID: `00121`
- Source label for human review: `㤷`
...
- `obs-evo-cand-000121-route-category-staging`
...
- `obs-evo-cand-000121-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000121-route-evolution-graph`
