# obs-evo-cand-006858 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-006858`
- EVOBC category candidate ID: `evobc-evo-cat-06858`
- External category ref: `evobc-cat-06858`
- Source label: `義`
- Source codepoints: `U+7FA9`
- Image reference count: `214`
- Era token counts: `BI:66;CS:1;OBC:42;SAC:15;SS:2;WSC:88`
- Source token counts: `Book:59;Web:155`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 42 image references
- era 1 / BI: 66 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 15 image references
- era 4 / WSC: 88 image references
- era 5 / CS: 1 image references
- source 0 / Web:1633: 1 image references
- source 1 / Web:105952;說文Web:58: 133 image references
- source 2 / Book:17600: 5 image references
- source 3 / Book:21681: 31 image references
- source 4 / Book:9131: 15 image references
- source 5 / Book:32794: 2 image references
