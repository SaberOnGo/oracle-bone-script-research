# Material Visual Observation / obs-comp-cand-002086 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002086`
- External reference / 外部参照: `obimd-sub-xzku05tqy7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019532_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/u7v6rlhp81/xzku05tqy7/xzku05tqy7.png`
- Checksum / 校验和:
  `2e71ffc5fcf8a619c4bb9e17797c0d9bcd4c6ad22fff68cd7e1549ffe182f702`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.63%.
- Marked-pixel bounds: (76,33)–(173,212); span 98 × 180 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.63%。
- 痕迹范围：(76,33)–(173,212)；跨度98 × 180 px；痕迹矩形高于宽。
