# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002539
...
| --- | --- | --- | --- |
| `obimd-glyph-link-038885` | 󾙑 | `U+FE651` | `reviewed_metadata_only` |
| `obimd-glyph-link-038886` | 󾙒 | `U+FE652` | `reviewed_metadata_only` |
| `obimd-glyph-link-038887` | 󾙓 | `U+FE653` | `reviewed_metadata_only` |
