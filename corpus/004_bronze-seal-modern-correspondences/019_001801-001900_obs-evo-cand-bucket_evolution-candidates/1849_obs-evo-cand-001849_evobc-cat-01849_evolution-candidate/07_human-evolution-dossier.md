...
- Project ID: `obs-evo-cand-001849`
- EVOBC category candidate ID: `evobc-evo-cat-01849`
- External category reference: `evobc-cat-01849`
- Source category ID: `01849`
- Source label for human review: `垒`
- Source codepoints: `U+5792`
...
- `obs-evo-cand-001849-route-category-staging`
...
- `obs-evo-cand-001849-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001849-route-evolution-graph`
