...
- Project ID: `obs-evo-cand-010863`
- EVOBC category candidate ID: `evobc-evo-cat-10863`
- External category reference: `evobc-cat-10863`
- Source category ID: `10863`
- Source label for human review: `𠣜`
- Source codepoints: `U+208DC`
...
- `obs-evo-cand-010863-route-category-staging`
...
- `obs-evo-cand-010863-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010863-route-evolution-graph`
