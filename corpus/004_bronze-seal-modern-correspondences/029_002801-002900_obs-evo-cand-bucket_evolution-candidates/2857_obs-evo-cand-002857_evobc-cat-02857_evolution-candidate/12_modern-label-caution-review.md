# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002857
...
- EVOBC candidate category: `evobc-evo-cat-02857`.
- Source label for search only: `彻`.
- Source codepoints for search only: `U+5F7B`.
