...
- External category reference: `evobc-cat-02750`
- Source category ID: `02750`
- Source label for human review: `廉`
...
- `obs-evo-cand-002750-route-category-staging`
...
- `obs-evo-cand-002750-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002750-route-evolution-graph`
