# Material Visual Observation / obs-comp-cand-002489 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002489`
- External reference / 外部参照: `obimd-sub-tjt5illw2p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020709_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tjt5illw2p/tjt5illw2p/tjt5illw2p.png`
- Checksum / 校验和:
  `9aba41b6a5426f931e86c5ffbc1a0650901d1d891acdccced8f621ac1c3f5e2a`
...
- Marked-pixel bounds: (74,28)–(191,224); span 118 × 197 px; the marked
...
- 痕迹范围：(74,28)–(191,224)；跨度118 × 197 px；痕迹矩形高于宽。
