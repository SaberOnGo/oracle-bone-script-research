...
- External category reference: `evobc-cat-12742`
- Source category ID: `12742`
- Source label for human review: `𪉲`
...
- `obs-evo-cand-012742-route-category-staging`
...
- `obs-evo-cand-012742-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012742-route-evolution-graph`
