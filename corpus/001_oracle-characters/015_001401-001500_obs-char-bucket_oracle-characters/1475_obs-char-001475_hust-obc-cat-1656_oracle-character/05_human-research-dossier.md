# obs-char-001475 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001475`
- primary external id: `hust-obc-cat-1656`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1475_obs-char-001475_hust-obc-cat-1656_ora
  cle-character/03_visual-assets/001_asset-001480_hust-obc-cat-1656_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1656/L_1656_13759.jpg`
- asset id: `asset-001480`
...
- source category: `1656`
- validation class: `1474`
- source image route: `HUST-OBC/deciphered/1656/L_1656_13759.jpg`
- asset id: `asset-001480`
...
- English observation: `Two faint adjacent forms repeat a narrow stem and
  small side branches.`
- 中文观察: `两个浅淡相邻形体重复狭长竖干和小型侧部分枝。`
...
- dataset label text: `㩮`
- dataset label codepoints: `U+3A6E`
...
- Which source records identify obs-char-001475 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001475？
