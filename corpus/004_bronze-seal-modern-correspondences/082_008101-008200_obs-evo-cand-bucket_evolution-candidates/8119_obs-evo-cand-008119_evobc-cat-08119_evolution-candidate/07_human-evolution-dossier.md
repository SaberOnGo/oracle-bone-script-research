...
- External category reference: `evobc-cat-08119`
- Source category ID: `08119`
- Source label for human review: `觼`
...
- `obs-evo-cand-008119-route-category-staging`
...
- `obs-evo-cand-008119-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008119-route-evolution-graph`
