...
- External category reference: `evobc-cat-07106`
- Source category ID: `07106`
- Source label: `腯`
...
- `obs-evo-cand-007106-route-category-staging`
...
- `obs-evo-cand-007106-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007106-route-evolution-graph`
