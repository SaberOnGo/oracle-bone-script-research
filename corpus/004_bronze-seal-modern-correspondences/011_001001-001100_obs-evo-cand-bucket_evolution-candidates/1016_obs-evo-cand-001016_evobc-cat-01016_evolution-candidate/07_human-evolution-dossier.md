...
- External category reference: `evobc-cat-01016`
- Source category ID: `01016`
- Source label for human review: `僖`
...
- `obs-evo-cand-001016-route-category-staging`
...
- `obs-evo-cand-001016-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001016-route-evolution-graph`
