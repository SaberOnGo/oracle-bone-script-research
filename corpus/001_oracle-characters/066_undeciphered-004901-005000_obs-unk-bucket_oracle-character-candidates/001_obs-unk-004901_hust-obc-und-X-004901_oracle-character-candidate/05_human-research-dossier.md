# obs-unk-004901 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004901`
- primary external id: `hust-obc-und-X-004901`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/001_obs-unk-004901_h
  ust-obc-und-X-004901_oracle-character-candidate/03_visual-assets/001_asset
  -006494_hust-obc-und-X-004901_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/457/X_？_7437_1.png`
- asset id: `asset-006494`
...
- source class: `HUST-OBC/undeciphered/X/457/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/457/X_？_7437_1.png`
- asset id: `asset-006494`
...
- English observation: `right curved outline and diagonal crossing`
- 中文观察: `右侧弧形外框和中央斜向交叉`
...
- Which source records identify obs-unk-004901 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004901？
