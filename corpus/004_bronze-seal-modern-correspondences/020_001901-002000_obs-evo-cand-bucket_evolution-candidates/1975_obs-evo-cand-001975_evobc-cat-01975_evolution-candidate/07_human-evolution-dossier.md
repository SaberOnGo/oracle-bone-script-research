...
- Project ID: `obs-evo-cand-001975`
- EVOBC category candidate ID: `evobc-evo-cat-01975`
- External category reference: `evobc-cat-01975`
- Source category ID: `01975`
- Source label for human review: `壴`
- Source codepoints: `U+58F4`
...
- `obs-evo-cand-001975-route-category-staging`
...
- `obs-evo-cand-001975-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001975-route-evolution-graph`
