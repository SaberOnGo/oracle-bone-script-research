# obs-unk-004287 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/087_obs-unk-004287_h
  ust-obc-und-L-004287_oracle-character-candidate/03_visual-assets/001_asset
  -005880_hust-obc-und-L-004287_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4287/L_？_9466.jpg`
- asset id: `asset-005880`
...
- source class: `HUST-OBC/undeciphered/L/4287/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4287/L_？_9466.jpg`
- asset id: `asset-005880`
...
- English observation: `Upper angular cluster, right bar, lower traces visible.`
- 中文观察: `上部折角痕迹组、右侧横痕和下部痕迹可见。`
...
- Which source records identify obs-unk-004287 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004287？
