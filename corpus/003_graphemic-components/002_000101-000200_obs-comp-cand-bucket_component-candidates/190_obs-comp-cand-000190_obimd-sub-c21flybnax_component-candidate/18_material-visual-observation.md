# Material Visual Observation / obs-comp-cand-000190 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000190`
- External reference / 外部参照: `obimd-sub-c21flybnax`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011751_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/c21flybnax/c21flybnax/c21flybnax.png`
- Checksum / 校验和:
  `1794a1771858ab4945a7257c1eaeb7568f142a1c850785073a689e7cf2a3e054`
...
- Marked-pixel bounds: (56,35)–(193,205); span 138 × 171 px; the marked
...
- 痕迹范围：(56,35)–(193,205)；跨度138 × 171 px；痕迹矩形高于宽。
