...
Project ID: `obs-evo-cand-003151`
...
- Project ID: `obs-evo-cand-003151`
- EVOBC category candidate ID: `evobc-evo-cat-03151`
- External category reference: `evobc-cat-03151`
- Source category ID: `03151`
- Source label for human review: `憙`
- Source codepoints: `U+6199`
- Image reference count in source metadata: `58`
...
- `obs-evo-cand-003151-route-category-staging`
...
- `obs-evo-cand-003151-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003151-route-evolution-graph`
