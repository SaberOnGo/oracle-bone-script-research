# obs-unk-003955 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003955`
- primary external id: `hust-obc-und-L-003955`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/055_obs-unk-003955_h
  ust-obc-und-L-003955_oracle-character-candidate/03_visual-assets/001_asset
  -005548_hust-obc-und-L-003955_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3955/L_？_8341.jpg`
- asset id: `asset-005548`
...
- source class: `HUST-OBC/undeciphered/L/3955/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3955/L_？_8341.jpg`
- asset id: `asset-005548`
...
- English observation: A broad upper stroke bends near the right and sends a
  curved trace downward; a separate curved trace remains lower and left.
- 中文观察：较宽上部痕迹在右侧转折并向下连出弧痕，左下另有分开的弧形痕迹。
...
- Which source records identify obs-unk-003955 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003955？
