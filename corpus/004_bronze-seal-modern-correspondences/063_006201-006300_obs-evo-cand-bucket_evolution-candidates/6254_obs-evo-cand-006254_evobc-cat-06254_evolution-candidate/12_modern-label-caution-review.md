# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006254
...
- EVOBC candidate category: `evobc-evo-cat-06254`.
- Source label for search only: `笿`.
- Source codepoints for search only: `U+7B3F`.
