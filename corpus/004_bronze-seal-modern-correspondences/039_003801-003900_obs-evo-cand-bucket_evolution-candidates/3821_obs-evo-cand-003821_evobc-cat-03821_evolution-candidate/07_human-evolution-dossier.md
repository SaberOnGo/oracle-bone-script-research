...
- External category reference: `evobc-cat-03821`
- Source category ID: `03821`
- Source label for human review: `替`
- Source codepoints: `U+66FF`
...
- `obs-evo-cand-003821-route-category-staging`
...
- `obs-evo-cand-003821-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003821-route-evolution-graph`
