...
Project ID: `obs-evo-cand-007292`
...
- Project ID: `obs-evo-cand-007292`
- EVOBC category candidate ID: `evobc-evo-cat-07292`
- External category reference: `evobc-cat-07292`
- Source category ID: `07292`
- Source label for human review: `苴`
- Source codepoints: `U+82F4`
...
- `obs-evo-cand-007292-route-category-staging`
...
- `obs-evo-cand-007292-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007292-route-evolution-graph`
