# Material Visual Observation / obs-comp-cand-000585 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000585`
- External reference / 外部参照: `obimd-sub-l170p06wip`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013113_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/l170p06wip/l170p06wip/l170p06wip.png`
- Checksum / 校验和:
  `a1e9a2979c366964d1bb69eec76bd4b5b84c70d0936eef68d5a405b82768015a`
...
- Marked-pixel bounds: (76,47)–(173,209); span 98 × 163 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.25%。
- 痕迹范围：(76,47)–(173,209)；跨度98 × 163 px；痕迹矩形高于宽。
