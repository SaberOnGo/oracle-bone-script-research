# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004270
...
- EVOBC candidate category: `evobc-evo-cat-04270`.
- Source label for search only: `橜`.
- Source codepoints for search only: `U+6A5C`.
