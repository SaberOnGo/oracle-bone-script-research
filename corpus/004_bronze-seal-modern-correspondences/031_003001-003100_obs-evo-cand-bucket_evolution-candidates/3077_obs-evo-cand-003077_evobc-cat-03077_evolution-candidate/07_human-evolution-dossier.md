...
Project ID: `obs-evo-cand-003077`
...
- Project ID: `obs-evo-cand-003077`
- EVOBC category candidate ID: `evobc-evo-cat-03077`
- External category reference: `evobc-cat-03077`
- Source category ID: `03077`
- Source label for human review: `愉`
- Source codepoints: `U+6109`
...
- `obs-evo-cand-003077-route-category-staging`
...
- `obs-evo-cand-003077-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003077-route-evolution-graph`
