# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-009662
...
- EVOBC candidate category: `evobc-evo-cat-09662`.
- Source label for search only: `闛`.
- Source codepoints for search only: `U+95DB`.
