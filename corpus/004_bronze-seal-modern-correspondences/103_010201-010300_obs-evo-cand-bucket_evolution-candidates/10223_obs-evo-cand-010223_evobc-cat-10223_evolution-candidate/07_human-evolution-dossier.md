...
- External category reference: `evobc-cat-10223`
- Source category ID: `10223`
- Source label for human review: `騢`
...
- `obs-evo-cand-010223-route-category-staging`
...
- `obs-evo-cand-010223-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010223-route-evolution-graph`
