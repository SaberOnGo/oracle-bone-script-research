# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000692
...
| --- | --- | --- | --- |
| `obimd-glyph-link-010027` | 򮛡󳼮 | `U+AE6E1;U+F3F2E` | `reviewed_metadata_only` |
| `obimd-glyph-link-010028` | 󳼯 | `U+F3F2F` | `reviewed_metadata_only` |
| `obimd-glyph-link-010029` | 󳼰 | `U+F3F30` | `reviewed_metadata_only` |
| `obimd-glyph-link-010030` | 󳼱 | `U+F3F31` | `reviewed_metadata_only` |
