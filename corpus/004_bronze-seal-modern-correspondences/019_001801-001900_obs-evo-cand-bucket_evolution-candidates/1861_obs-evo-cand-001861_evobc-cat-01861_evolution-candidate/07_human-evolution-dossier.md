...
- External category reference: `evobc-cat-01861`
- Source category ID: `01861`
- Source label for human review: `垤`
...
- `obs-evo-cand-001861-route-category-staging`
...
- `obs-evo-cand-001861-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001861-route-evolution-graph`
