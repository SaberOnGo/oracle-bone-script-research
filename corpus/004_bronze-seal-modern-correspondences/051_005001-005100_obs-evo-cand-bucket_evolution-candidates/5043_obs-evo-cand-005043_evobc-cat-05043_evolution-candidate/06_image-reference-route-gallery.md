...
- `obs-evo-cand-005043-route-category-staging`
...
- `obs-evo-cand-005043-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005043-route-evolution-graph`
