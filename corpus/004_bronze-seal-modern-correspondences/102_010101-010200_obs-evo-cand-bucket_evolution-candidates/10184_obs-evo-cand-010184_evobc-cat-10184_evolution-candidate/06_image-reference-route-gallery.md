...
- `obs-evo-cand-010184-route-category-staging`
...
- `obs-evo-cand-010184-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010184-route-evolution-graph`
