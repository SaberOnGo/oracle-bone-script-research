...
- Project ID: `obs-evo-cand-005394`
- EVOBC category candidate ID: `evobc-evo-cat-05394`
- External category reference: `evobc-cat-05394`
- Source category ID: `05394`
- Source label for human review: `珵`
- Source codepoints: `U+73F5`
...
- `obs-evo-cand-005394-route-category-staging`
...
- `obs-evo-cand-005394-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005394-route-evolution-graph`
