# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006847
...
- EVOBC candidate category: `evobc-evo-cat-06847`.
- Source label for search only: `羛`.
- Source codepoints for search only: `U+7F9B`.
