# obs-char-000328 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/328_obs-char-000328_hust-obc-cat-0370_orac
  le-character/03_visual-assets/001_asset-000333_hust-obc-cat-0370_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0370/G_0370_甲骨文0.png`
- asset id: `asset-000333`
...
- source category: `0370`
- validation class: `327`
- source image route: `HUST-OBC/deciphered/0370/G_0370_甲骨文0.png`
- asset id: `asset-000333`
...
- dataset label text: `㕨`
- dataset label codepoints: `U+3568`
...
- Which source records identify obs-char-000328 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000328？
