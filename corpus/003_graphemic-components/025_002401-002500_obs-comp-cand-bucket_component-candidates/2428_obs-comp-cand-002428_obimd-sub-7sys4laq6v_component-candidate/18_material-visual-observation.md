# Material Visual Observation / obs-comp-cand-002428 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002428`
- External reference / 外部参照: `obimd-sub-7sys4laq6v`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020499_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7sys4laq6v/7sys4laq6v/04xjxa2vd4.png`
- Checksum / 校验和:
  `60889a239505a418a447ffafb7e15c4984ac2dfb7677f93bccbfa18ac84c72af`
...
- Marked-pixel bounds: (85,35)–(164,209); span 80 × 175 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.41%。
- 痕迹范围：(85,35)–(164,209)；跨度80 × 175 px；痕迹矩形高于宽。
