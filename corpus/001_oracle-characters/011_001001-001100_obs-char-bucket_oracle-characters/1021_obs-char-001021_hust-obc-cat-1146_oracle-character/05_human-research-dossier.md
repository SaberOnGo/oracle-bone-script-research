# obs-char-001021 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1021_obs-char-001021_hust-obc-cat-1146_ora
  cle-character/03_visual-assets/001_asset-001026_hust-obc-cat-1146_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1146/G_1146_乙5470合1076賓組.png`
- asset id: `asset-001026`
...
- source category: `1146`
- validation class: `1020`
- source image route: `HUST-OBC/deciphered/1146/G_1146_乙5470合1076賓組.png`
- asset id: `asset-001026`
...
- English observation: `A low horizontal wedge-like form has a dark interior
  division, a pointed right end, and three detached lower strokes.`
- 中文观察: `低位横向楔状形体有深色内部分隔、尖状右端和三条分离下部笔。`
...
- dataset label text: `㡰`
- dataset label codepoints: `U+3870`
...
- filename catalog route clues: `Heji-like filename clue: 合1076
  (G_1146_乙5470合1076賓組.png)`
...
- Which source records identify obs-char-001021 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001021？
