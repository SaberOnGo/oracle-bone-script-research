# obs-char-001542 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1542_obs-char-001542_hust-obc-cat-1731_ora
  cle-character/03_visual-assets/001_asset-001547_hust-obc-cat-1731_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1731/G_1731_珠655(甲).png`
- asset id: `asset-001547`
...
- source category: `1731`
- validation class: `1541`
- source image route: `HUST-OBC/deciphered/1731/G_1731_珠655(甲).png`
- asset id: `asset-001547`
...
- English observation: `Two stacked enclosures show repeated upper prongs
  and a broad lower rectangular contour.`
- 中文观察: `两个上下叠置框形有重复上部分叉和宽大的下部矩形轮廓。`
...
- dataset label text: `㪹`
- dataset label codepoints: `U+3AB9`
...
- Which source records identify obs-char-001542 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001542？
