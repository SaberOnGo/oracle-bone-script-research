...
Project ID: `obs-evo-cand-013300`
...
- Project ID: `obs-evo-cand-013300`
- EVOBC category candidate ID: `evobc-evo-cat-13300`
- External category reference: `evobc-cat-13300`
- Source category ID: `13300`
- Source label for human review: `𬚩`
- Source codepoints: `U+2C6A9`
...
- `obs-evo-cand-013300-route-category-staging`
...
- `obs-evo-cand-013300-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013300-route-evolution-graph`
