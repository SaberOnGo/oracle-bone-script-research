# Material Visual Observation / obs-comp-cand-000772 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000772`
- External reference / 外部参照: `obimd-sub-ju36m47psc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013535_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ju36m47psc/ju36m47psc/ju36m47psc.png`
- Checksum / 校验和:
  `be83ad64a9b93d6a02863ae44c0b2074d31f4c624e6aff25c832b9094c11d428`
...
- Marked-pixel bounds: (79,25)–(170,224); span 92 × 200 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.60%。
- 痕迹范围：(79,25)–(170,224)；跨度92 × 200 px；痕迹矩形高于宽。
