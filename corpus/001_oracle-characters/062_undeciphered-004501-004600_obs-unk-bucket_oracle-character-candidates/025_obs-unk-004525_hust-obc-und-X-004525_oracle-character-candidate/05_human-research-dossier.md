# obs-unk-004525 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004525`
- primary external id: `hust-obc-und-X-004525`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/025_obs-unk-004525_h
  ust-obc-und-X-004525_oracle-character-candidate/03_visual-assets/001_asset
  -006118_hust-obc-und-X-004525_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/81/X_？_8264_1.png`
- asset id: `asset-006118`
...
- source class: `HUST-OBC/undeciphered/X/81/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/81/X_？_8264_1.png`
- asset id: `asset-006118`
...
- English observation: `Main trace, broad base, and detached marks recorded.`
- 中文观察: `已记录中央下行痕迹、宽横底部和分离小痕迹。`
...
- Which source records identify obs-unk-004525 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004525？
