# Material Visual Observation / obs-comp-cand-001410 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001410`
- External reference / 外部参照: `obimd-sub-fkhhsjy5jk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015829_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fkhhsjy5jk/fkhhsjy5jk/fkhhsjy5jk.png`
- Checksum / 校验和:
  `73b94df95f596a5297535a65899679652db5d6f4983ef6e32043a8ced6b0d314`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.40%.
- Marked-pixel bounds: (54,19)–(201,229); span 148 × 211 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.40%。
- 痕迹范围：(54,19)–(201,229)；跨度148 × 211 px；痕迹矩形高于宽。
