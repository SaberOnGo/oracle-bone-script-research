...
- Project ID: `obs-evo-cand-002124`
- EVOBC category candidate ID: `evobc-evo-cat-02124`
- External category reference: `evobc-cat-02124`
- Source category ID: `02124`
- Source label for human review: `姕`
- Source codepoints: `U+59D5`
...
- `obs-evo-cand-002124-route-category-staging`
...
- `obs-evo-cand-002124-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002124-route-evolution-graph`
