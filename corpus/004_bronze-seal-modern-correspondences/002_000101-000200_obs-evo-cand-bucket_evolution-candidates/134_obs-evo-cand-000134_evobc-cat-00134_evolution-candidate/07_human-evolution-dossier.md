...
- External category reference: `evobc-cat-00134`
- Source category ID: `00134`
- Source label for human review: `㦂`
...
- `obs-evo-cand-000134-route-category-staging`
...
- `obs-evo-cand-000134-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000134-route-evolution-graph`
