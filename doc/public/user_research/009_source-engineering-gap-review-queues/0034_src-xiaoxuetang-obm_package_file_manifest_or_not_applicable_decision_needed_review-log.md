...
- Review log draft ID / 复核日志草稿 ID: `source-engineering-gap-review-log-draft-0034`
- Source engineering gap ID / 来源工程缺口 ID: `source-engineering-gap-0034`
...
`current_stage=cleaned;download_status_counts=downloaded_access_restricted_page:4;downloaded_count=4;download_log_count=4;checksum_present_count=4;field_map_count=6;package_manifest_count=0;metadata_profile_count=0;graph_edge_count=0;downloaded_file_bytes=147668;gap_type=package_file_manifest_or_not_applicable_decision_needed`
...
- checksum_present_count: `4`
- field_map_count: `6`
- package_manifest_count: `0`
- metadata_profile_count: `0`
- graph_edge_count: `0`
- downloaded_file_bytes: `147668`
