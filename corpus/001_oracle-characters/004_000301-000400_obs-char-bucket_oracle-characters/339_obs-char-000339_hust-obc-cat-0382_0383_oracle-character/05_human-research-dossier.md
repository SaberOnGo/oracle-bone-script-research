# obs-char-000339 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000339`
- primary external id: `hust-obc-cat-0382_0383`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/339_obs-char-000339_hust-obc-cat-0382_0383
  _oracle-character/03_visual-assets/001_asset-000344_hust-obc-cat-0382_0383
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0382_0383/0382/L_0382_11323.jpg
  `
- asset id: `asset-000344`
...
- source category: `0382_0383`
- validation class: `338`
- source image route: `HUST-OBC/deciphered/0382_0383/0382/L_0382_11323.jpg`
- asset id: `asset-000344`
...
- English observation: `The low-contrast gray image shows a compact dark
  rounded cluster at the left and a detached curved stroke at the right;
  contrast needs recheck.`
- 中文观察: `低对比度灰色图像左侧有紧凑深色圆弧笔画群，右侧有分离的弧形笔画；对比度仍需复核。`
...
- dataset label text: `㕴㕵`
- dataset label codepoints: `U+3574;U+3575`
...
- graph edge count: `2`
- codepoint routes: `U+3574;U+3575`
...
- Which source records identify obs-char-000339 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000339？
