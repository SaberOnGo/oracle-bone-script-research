# Material Visual Observation / obs-comp-cand-000918 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000918`
- External reference / 外部参照: `obimd-sub-60lzmbmrwp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014001_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/60lzmbmrwp/60lzmbmrwp/60lzmbmrwp.png`
- Checksum / 校验和:
  `45ea06431e17f6711d29fb88669df9c067aa35eb50c5210fa5ef45b2eabf6178`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.37%.
- Marked-pixel bounds: (65,42)–(187,209); span 123 × 168 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.37%。
- 痕迹范围：(65,42)–(187,209)；跨度123 × 168 px；痕迹矩形高于宽。
