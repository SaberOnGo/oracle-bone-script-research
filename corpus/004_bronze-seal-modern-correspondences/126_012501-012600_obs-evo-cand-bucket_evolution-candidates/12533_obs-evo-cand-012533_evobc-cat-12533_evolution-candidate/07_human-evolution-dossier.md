...
Project ID: `obs-evo-cand-012533`
...
- Project ID: `obs-evo-cand-012533`
- EVOBC category candidate ID: `evobc-evo-cat-12533`
- External category reference: `evobc-cat-12533`
- Source category ID: `12533`
- Source label for human review: `𨾊`
- Source codepoints: `U+28F8A`
...
- `obs-evo-cand-012533-route-category-staging`
...
- `obs-evo-cand-012533-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012533-route-evolution-graph`
