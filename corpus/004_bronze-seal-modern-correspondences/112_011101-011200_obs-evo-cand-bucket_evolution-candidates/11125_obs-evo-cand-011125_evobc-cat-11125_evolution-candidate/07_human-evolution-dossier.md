...
- Project ID: `obs-evo-cand-011125`
- EVOBC category candidate ID: `evobc-evo-cat-11125`
- External category reference: `evobc-cat-11125`
- Source category ID: `11125`
- Source label for human review: `𡽎`
- Source codepoints: `U+21F4E`
...
- `obs-evo-cand-011125-route-category-staging`
...
- `obs-evo-cand-011125-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011125-route-evolution-graph`
