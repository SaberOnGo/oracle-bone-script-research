# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001494
...
| --- | --- | --- | --- |
| `obimd-glyph-link-022507` | 󸣽 | `U+F88FD` | `reviewed_metadata_only` |
| `obimd-glyph-link-022508` | 󸣾 | `U+F88FE` | `reviewed_metadata_only` |
| `obimd-glyph-link-022509` | 󸣿 | `U+F88FF` | `reviewed_metadata_only` |
