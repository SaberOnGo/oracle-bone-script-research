# Material Visual Observation / obs-comp-cand-002040 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002040`
- External reference / 外部参照: `obimd-sub-xcwma5914e`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019367_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xcwma5914e/xcwma5914e/xcwma5914e.png`
- Checksum / 校验和:
  `71a201b5dc835eece7076cf10080442ed49f25d724dd7ab33a8368ede43c6ba1`
...
- Marked-pixel bounds: (80,17)–(153,232); span 74 × 216 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.31%。
- 痕迹范围：(80,17)–(153,232)；跨度74 × 216 px；痕迹矩形高于宽。
