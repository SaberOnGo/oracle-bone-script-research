# obs-char-000741 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000741`
- primary external id: `hust-obc-cat-0843`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/741_obs-char-000741_hust-obc-cat-0843_orac
  le-character/03_visual-assets/001_asset-000746_hust-obc-cat-0843_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0843/G_0843_乙1192合3158.png`
- asset id: `asset-000746`
...
- source category: `0843`
- validation class: `740`
- source image route: `HUST-OBC/deciphered/0843/G_0843_乙1192合3158.png`
- asset id: `asset-000746`
...
- English observation: `A narrow vertical outline forks at both ends and
  encloses two stacked almond-shaped openings divided by a central
  crossing.`
- 中文观察: `狭长竖向轮廓上下两端均分叉，内部有两个纵向叠置的杏仁形空隙，并由中央交叉分隔。`
...
- dataset label text: `㝁`
- dataset label codepoints: `U+3741`
...
- filename catalog route clues: `Heji-like filename clue: 合3158
  (G_0843_乙1192合3158.png)`
...
- Which source records identify obs-char-000741 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000741？
