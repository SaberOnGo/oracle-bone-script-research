# Material Visual Observation / obs-comp-cand-002294 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002294`
- External reference / 外部参照: `obimd-sub-89m3dkhxyy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020291_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/89m3dkhxyy/89m3dkhxyy/0bcq5osq41.png`
- Checksum / 校验和:
  `e82851f8d7b1e1c067c7ff5a164c6bccd79299ef68d255deadfa2cd91efc344e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.76%.
- Marked-pixel bounds: (110,24)–(139,223); span 30 × 200 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.76%。
- 痕迹范围：(110,24)–(139,223)；跨度30 × 200 px；痕迹矩形高于宽。
