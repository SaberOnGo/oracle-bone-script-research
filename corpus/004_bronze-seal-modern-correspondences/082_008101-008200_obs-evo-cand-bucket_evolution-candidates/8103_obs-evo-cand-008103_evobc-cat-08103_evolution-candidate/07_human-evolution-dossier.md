...
- External category reference: `evobc-cat-08103`
- Source category ID: `08103`
- Source label for human review: `解`
- Source codepoints: `U+89E3`
- Image reference count in source metadata: `77`
...
- `obs-evo-cand-008103-route-category-staging`
...
- `obs-evo-cand-008103-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008103-route-evolution-graph`
