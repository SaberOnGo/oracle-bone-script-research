# Material Visual Observation / obs-comp-cand-000179 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000179`
- External reference / 外部参照: `obimd-sub-3wku1ohk1p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011591_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3wku1ohk1p/3wku1ohk1p/3wku1ohk1p.png`
- Checksum / 校验和:
  `837b13aae7fd1a7c3c43a282a4517293113d9ecbb9ec9cb233d1841f0a71a02c`
...
- Marked-pixel bounds: (54,69)–(195,174); span 142 × 106 px; the marked
...
- 痕迹范围：(54,69)–(195,174)；跨度142 × 106 px；痕迹矩形宽于高。
