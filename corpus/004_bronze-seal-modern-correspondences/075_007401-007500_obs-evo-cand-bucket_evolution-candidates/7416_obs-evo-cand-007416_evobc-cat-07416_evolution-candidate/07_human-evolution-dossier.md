...
- External category reference: `evobc-cat-07416`
- Source category ID: `07416`
- Source label for human review: `菣`
...
- `obs-evo-cand-007416-route-category-staging`
...
- `obs-evo-cand-007416-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007416-route-evolution-graph`
