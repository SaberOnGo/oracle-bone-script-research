...
- External category reference: `evobc-cat-08198`
- Source category ID: `08198`
- Source label for human review: `詯`
...
- `obs-evo-cand-008198-route-category-staging`
...
- `obs-evo-cand-008198-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008198-route-evolution-graph`
