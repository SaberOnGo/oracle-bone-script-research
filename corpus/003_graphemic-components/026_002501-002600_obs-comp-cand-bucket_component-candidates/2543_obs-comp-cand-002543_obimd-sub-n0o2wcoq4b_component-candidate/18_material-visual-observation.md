# Material Visual Observation / obs-comp-cand-002543 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002543`
- External reference / 外部参照: `obimd-sub-n0o2wcoq4b`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021062_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/n0o2wcoq4b/n0o2wcoq4b/n0o2wcoq4b.png`
- Checksum / 校验和:
  `2f6f92fb9c91978208b8c5d366c6316f9dca59f4db42d9086073d2f46301acbf`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.28%.
- Marked-pixel bounds: (49,37)–(204,215); span 156 × 179 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.28%。
- 痕迹范围：(49,37)–(204,215)；跨度156 × 179 px；痕迹矩形近方形。
