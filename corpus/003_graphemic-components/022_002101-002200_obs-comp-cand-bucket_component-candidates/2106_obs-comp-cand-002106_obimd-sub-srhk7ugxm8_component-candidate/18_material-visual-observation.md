# Material Visual Observation / obs-comp-cand-002106 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002106`
- External reference / 外部参照: `obimd-sub-srhk7ugxm8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019557_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/srhk7ugxm8/srhk7ugxm8/srhk7ugxm8.png`
- Checksum / 校验和:
  `46ac75152de52f8f9b7b48bdaab46bdde31eccd50df5cf56b0600709c046b79c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.44%.
- Marked-pixel bounds: (93,18)–(161,225); span 69 × 208 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.44%。
- 痕迹范围：(93,18)–(161,225)；跨度69 × 208 px；痕迹矩形高于宽。
