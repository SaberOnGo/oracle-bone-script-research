...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1162`
...
- Source image / 来源图: `G_1162_乙3400合1285賓組.png`
- Image / 图像: `001_asset-001042_hust-obc-cat-1162_glyph.png`
...
- target node: `obimd-main-cand-002325`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- target node: `evobc-evo-cat-00097`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- OBIMD candidate ids / OBIMD 候选 ID: `obimd-main-cand-002325`
- OBIMD external refs / OBIMD 外部引用: `obimd-main-i9rq6029zl`
- OBIMD transcription field / OBIMD 转写字段: `򩦚|㢀`
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00097`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00097`
...
- Matched candidate folders / 匹配候选目录: `evobc-evo-cat-00097`
- Human review files / 人类复核文件:
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/097_obs-evo-cand-000097_evobc-cat-00097_evoluti
...
- Matched OBIMD main UIDs / OBIMD 主字 UID: `i9rq6029zl`
...
- Source label text / 来源标签文字: `㢀`
- Source label codepoint / 来源标签 codepoint: `U+3880`
