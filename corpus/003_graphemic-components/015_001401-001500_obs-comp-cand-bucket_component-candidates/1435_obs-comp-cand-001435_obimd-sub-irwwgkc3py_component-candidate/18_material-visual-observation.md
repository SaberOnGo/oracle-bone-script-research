# Material Visual Observation / obs-comp-cand-001435 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001435`
- External reference / 外部参照: `obimd-sub-irwwgkc3py`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016012_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/irwwgkc3py/irwwgkc3py/irwwgkc3py.png`
- Checksum / 校验和:
  `86ab013563bb061e14c8663a356617346d643d11c90a3f478d4316cc6deaf1ac`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.55%.
- Marked-pixel bounds: (71,23)–(172,229); span 102 × 207 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.55%。
- 痕迹范围：(71,23)–(172,229)；跨度102 × 207 px；痕迹矩形高于宽。
