...
- External category reference: `evobc-cat-05468`
- Source category ID: `05468`
- Source label for human review: `璗`
- Source codepoints: `U+7497`
...
- `obs-evo-cand-005468-route-category-staging`
...
- `obs-evo-cand-005468-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005468-route-evolution-graph`
