...
Project ID: `obs-evo-cand-005012`
...
- Project ID: `obs-evo-cand-005012`
- EVOBC category candidate ID: `evobc-evo-cat-05012`
- External category reference: `evobc-cat-05012`
- Source category ID: `05012`
- Source label for human review: `灉`
- Source codepoints: `U+7049`
...
- `obs-evo-cand-005012-route-category-staging`
...
- `obs-evo-cand-005012-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005012-route-evolution-graph`
