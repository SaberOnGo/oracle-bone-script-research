# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012853
...
- Project ID: `obs-evo-cand-012853`.
- EVOBC candidate category: `evobc-evo-cat-12853`.
- Source label for search only: `𪭊`.
- Source codepoints for search only: `U+2AB4A`.
