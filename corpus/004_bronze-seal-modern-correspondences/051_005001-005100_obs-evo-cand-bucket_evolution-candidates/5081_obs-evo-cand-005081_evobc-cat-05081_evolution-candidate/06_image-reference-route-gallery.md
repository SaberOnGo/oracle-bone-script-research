...
- `obs-evo-cand-005081-route-category-staging`
...
- `obs-evo-cand-005081-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005081-route-evolution-graph`
