# Material Visual Observation / obs-comp-cand-001000 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001000`
- External reference / 外部参照: `obimd-sub-tfktlwhxjy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014438_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zsc0qawq79/tfktlwhxjy/tfktlwhxjy.png`
- Checksum / 校验和:
  `898a28273330646f27dfc4f88beb33139ef8aee9f81fa55e3f16cf07552e466d`
...
- Marked-pixel bounds: (75,41)–(174,203); span 100 × 163 px; the marked
...
- 痕迹范围：(75,41)–(174,203)；跨度100 × 163 px；痕迹矩形高于宽。
