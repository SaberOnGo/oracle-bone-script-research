# obs-unk-004680 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/080_obs-unk-004680_h
  ust-obc-und-X-004680_oracle-character-candidate/03_visual-assets/001_asset
  -006273_hust-obc-und-X-004680_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/236/X_？_7224_1.png`
- asset id: `asset-006273`
...
- source class: `HUST-OBC/undeciphered/X/236/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/236/X_？_7224_1.png`
- asset id: `asset-006273`
...
- English observation: `left openings and tall right stroke; views pending`
- 中文观察: `左侧开口与右侧高笔画，另三视图待取`
...
- Which source records identify obs-unk-004680 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004680？
