# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010217
...
- EVOBC candidate category: `evobc-evo-cat-10217`.
- Source label for search only: `騏`.
- Source codepoints for search only: `U+9A0F`.
