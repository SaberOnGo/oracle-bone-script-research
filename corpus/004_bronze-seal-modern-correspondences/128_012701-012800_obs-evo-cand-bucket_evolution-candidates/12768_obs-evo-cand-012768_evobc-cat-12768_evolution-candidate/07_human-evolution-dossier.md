...
- Project ID: `obs-evo-cand-012768`
- EVOBC category candidate ID: `evobc-evo-cat-12768`
- External category reference: `evobc-cat-12768`
- Source category ID: `12768`
- Source label for human review: `𪓨`
- Source codepoints: `U+2A4E8`
...
- `obs-evo-cand-012768-route-category-staging`
...
- `obs-evo-cand-012768-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012768-route-evolution-graph`
