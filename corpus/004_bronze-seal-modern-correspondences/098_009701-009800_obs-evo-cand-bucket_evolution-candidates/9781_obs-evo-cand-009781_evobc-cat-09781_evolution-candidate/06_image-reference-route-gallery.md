...
- `obs-evo-cand-009781-route-category-staging`
...
- `obs-evo-cand-009781-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009781-route-evolution-graph`
