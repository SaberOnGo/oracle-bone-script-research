...
- `obs-evo-cand-004097-route-category-staging`
...
- `obs-evo-cand-004097-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004097-route-evolution-graph`
