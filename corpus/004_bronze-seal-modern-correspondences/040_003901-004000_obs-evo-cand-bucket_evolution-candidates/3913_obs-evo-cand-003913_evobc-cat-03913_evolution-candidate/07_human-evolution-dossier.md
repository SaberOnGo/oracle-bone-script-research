...
- External category reference: `evobc-cat-03913`
- Source category ID: `03913`
- Source label for human review: `枇`
- Source codepoints: `U+6787`
...
- `obs-evo-cand-003913-route-category-staging`
...
- `obs-evo-cand-003913-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003913-route-evolution-graph`
