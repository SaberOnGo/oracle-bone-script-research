...
- External category reference: `evobc-cat-08161`
- Source category ID: `08161`
- Source label: `診`
...
- `obs-evo-cand-008161-route-category-staging`
...
- `obs-evo-cand-008161-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008161-route-evolution-graph`
