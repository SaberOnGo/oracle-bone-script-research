...
Project ID: `obs-evo-cand-002837`
...
- Project ID: `obs-evo-cand-002837`
- EVOBC category candidate ID: `evobc-evo-cat-02837`
- External category reference: `evobc-cat-02837`
- Source category ID: `02837`
- Source label for human review: `彘`
- Source codepoints: `U+5F58`
...
- `obs-evo-cand-002837-route-category-staging`
...
- `obs-evo-cand-002837-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002837-route-evolution-graph`
