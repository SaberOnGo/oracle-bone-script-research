...
- Project ID: `obs-evo-cand-004017`
- EVOBC category candidate ID: `evobc-evo-cat-04017`
- External category reference: `evobc-cat-04017`
- Source category ID: `04017`
- Source label for human review: `桃`
- Source codepoints: `U+6843`
...
- `obs-evo-cand-004017-route-category-staging`
...
- `obs-evo-cand-004017-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004017-route-evolution-graph`
