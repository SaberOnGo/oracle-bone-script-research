# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002723
...
- EVOBC candidate category: `evobc-evo-cat-02723`.
- Source label for search only: `庚`.
- Source codepoints for search only: `U+5E9A`.
