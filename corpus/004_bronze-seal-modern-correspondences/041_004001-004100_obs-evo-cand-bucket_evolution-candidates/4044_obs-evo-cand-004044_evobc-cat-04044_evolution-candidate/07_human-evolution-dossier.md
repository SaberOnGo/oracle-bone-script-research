...
Project ID: `obs-evo-cand-004044`
...
- Project ID: `obs-evo-cand-004044`
- EVOBC category candidate ID: `evobc-evo-cat-04044`
- External category reference: `evobc-cat-04044`
- Source category ID: `04044`
- Source label for human review: `桼`
- Source codepoints: `U+687C`
...
- `obs-evo-cand-004044-route-category-staging`
...
- `obs-evo-cand-004044-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004044-route-evolution-graph`
