# obs-unk-004126 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004126`
- primary external id: `hust-obc-und-L-004126`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/026_obs-unk-004126_h
  ust-obc-und-L-004126_oracle-character-candidate/03_visual-assets/001_asset
  -005719_hust-obc-und-L-004126_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4126/L_？_8892.jpg`
- asset id: `asset-005719`
...
- source class: `HUST-OBC/undeciphered/L/4126/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4126/L_？_8892.jpg`
- asset id: `asset-005719`
...
- English observation: A narrow upright cluster has an angular left trace;
  short strokes extend toward the upper right.
- 中文观察：窄长痕迹簇左侧有折转痕迹；短痕迹向右上方伸出。
...
- Which source records identify obs-unk-004126 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004126？
