# Material Visual Observation / obs-comp-cand-001043 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001043`
- External reference / 外部参照: `obimd-sub-9ayc3k0dxu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014593_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9ayc3k0dxu/9ayc3k0dxu/9ayc3k0dxu.png`
- Checksum / 校验和:
  `9bb1e8995d1f8ec9e88db115c149c2de3ca55c99754fafe555d60edc384a243e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.99%.
- Marked-pixel bounds: (78,37)–(171,216); span 94 × 180 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.99%。
- 痕迹范围：(78,37)–(171,216)；跨度94 × 180 px；痕迹矩形高于宽。
