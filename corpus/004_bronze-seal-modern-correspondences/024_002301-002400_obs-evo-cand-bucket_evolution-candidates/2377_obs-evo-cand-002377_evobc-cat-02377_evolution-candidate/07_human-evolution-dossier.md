...
Project ID: `obs-evo-cand-002377`
...
- Project ID: `obs-evo-cand-002377`
- EVOBC category candidate ID: `evobc-evo-cat-02377`
- External category reference: `evobc-cat-02377`
- Source category ID: `02377`
- Source label for human review: `宛`
- Source codepoints: `U+5B9B`
...
- `obs-evo-cand-002377-route-category-staging`
...
- `obs-evo-cand-002377-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002377-route-evolution-graph`
