# obs-char-001315 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001315`
- primary external id: `hust-obc-cat-1470`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1315_obs-char-001315_hust-obc-cat-1470_ora
  cle-character/03_visual-assets/001_asset-001320_hust-obc-cat-1470_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1470/H_1470_60D2E_0.png`
- asset id: `asset-001320`
...
- source category: `1470`
- validation class: `1314`
- source image route: `HUST-OBC/deciphered/1470/H_1470_60D2E_0.png`
- asset id: `asset-001320`
...
- English observation: `A large composite form has detached left strokes, a
  central pointed branching cluster, and a lower rounded loop.`
- 中文观察: `大型组合形体有分离的左侧笔画、中央尖状分枝群和下部圆拱环形。`
...
- dataset label text: `㦴`
- dataset label codepoints: `U+39B4`
...
- filename catalog route clues: `catalog-like filename clue: H_1470
  (H_1470_60D2E_0.png)`
...
- Which source records identify obs-char-001315 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001315？
