...
- `obs-evo-cand-012843-route-category-staging`
...
- `obs-evo-cand-012843-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012843-route-evolution-graph`
