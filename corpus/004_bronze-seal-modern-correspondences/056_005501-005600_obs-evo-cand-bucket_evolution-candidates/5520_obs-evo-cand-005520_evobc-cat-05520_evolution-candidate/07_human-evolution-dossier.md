...
- External category reference: `evobc-cat-05520`
- Source category ID: `05520`
- Source label for human review: `甃`
- Source codepoints: `U+7503`
...
- `obs-evo-cand-005520-route-category-staging`
...
- `obs-evo-cand-005520-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005520-route-evolution-graph`
