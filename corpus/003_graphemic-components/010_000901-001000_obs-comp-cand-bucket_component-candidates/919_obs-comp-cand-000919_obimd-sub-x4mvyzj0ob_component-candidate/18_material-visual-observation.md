# Material Visual Observation / obs-comp-cand-000919 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000919`
- External reference / 外部参照: `obimd-sub-x4mvyzj0ob`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014002_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/x4mvyzj0ob/x4mvyzj0ob/x4mvyzj0ob.png`
- Checksum / 校验和:
  `c7a046da3930a0d2219e1f2b844d04a9529daceb3441d989fa9fd3e1e592f406`
...
- Marked-pixel bounds: (53,21)–(182,230); span 130 × 210 px; the marked
...
- 痕迹范围：(53,21)–(182,230)；跨度130 × 210 px；痕迹矩形高于宽。
