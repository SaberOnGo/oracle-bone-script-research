...
- Project ID: `obs-evo-cand-005180`
- EVOBC category candidate ID: `evobc-evo-cat-05180`
- External category reference: `evobc-cat-05180`
- Source category ID: `05180`
- Source label for human review: `爭`
- Source codepoints: `U+722D`
...
- `obs-evo-cand-005180-route-category-staging`
...
- `obs-evo-cand-005180-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005180-route-evolution-graph`
