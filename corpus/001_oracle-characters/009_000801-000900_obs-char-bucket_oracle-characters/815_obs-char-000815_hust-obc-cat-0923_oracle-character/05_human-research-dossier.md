# obs-char-000815 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000815`
- primary external id: `hust-obc-cat-0923`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/815_obs-char-000815_hust-obc-cat-0923_orac
  le-character/03_visual-assets/001_asset-000820_hust-obc-cat-0923_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0923/G_0923_存下729合41014.png`
- asset id: `asset-000820`
...
- source category: `0923`
- validation class: `814`
- source image route: `HUST-OBC/deciphered/0923/G_0923_存下729合41014.png`
- asset id: `asset-000820`
...
- English observation: `A bold rounded upper stroke bends over a central
  horizontal, while a separate curved lower stroke turns downward and left.`
- 中文观察: `粗重弯曲上笔在中央横笔上方弯折，下方另有弯曲笔向下左转折。`
...
- dataset label text: `㞑`
- dataset label codepoints: `U+3791`
...
- filename catalog route clues: `Heji-like filename clue: 合41014
  (G_0923_存下729合41014.png)`
...
- Which source records identify obs-char-000815 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000815？
