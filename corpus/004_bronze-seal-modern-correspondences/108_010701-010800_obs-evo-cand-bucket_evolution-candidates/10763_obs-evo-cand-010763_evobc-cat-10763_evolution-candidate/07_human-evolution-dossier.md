...
- External category reference: `evobc-cat-10763`
- Source category ID: `10763`
- Source label for human review: `𠀙`
...
- `obs-evo-cand-010763-route-category-staging`
...
- `obs-evo-cand-010763-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010763-route-evolution-graph`
