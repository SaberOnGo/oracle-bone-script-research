# Material Visual Observation / obs-comp-cand-001891 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001891`
- External reference / 外部参照: `obimd-sub-28yjralexi`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018270_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/28yjralexi/28yjralexi/28yjralexi.png`
- Checksum / 校验和:
  `66eeda80fb13181eb8a39fb4004c5aa501b50e893a7721cca9a1af7750e7306b`
...
- Marked-pixel bounds: (57,20)–(182,224); span 126 × 205 px; the marked
...
- 痕迹范围：(57,20)–(182,224)；跨度126 × 205 px；痕迹矩形高于宽。
