...
- External category reference: `evobc-cat-03414`
- Source category ID: `03414`
- Source label for human review: `推`
- Source codepoints: `U+63A8`
...
- `obs-evo-cand-003414-route-category-staging`
...
- `obs-evo-cand-003414-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003414-route-evolution-graph`
