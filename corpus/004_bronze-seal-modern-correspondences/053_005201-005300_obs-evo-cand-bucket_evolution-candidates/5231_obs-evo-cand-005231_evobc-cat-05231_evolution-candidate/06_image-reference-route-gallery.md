...
- `obs-evo-cand-005231-route-category-staging`
...
- `obs-evo-cand-005231-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005231-route-evolution-graph`
