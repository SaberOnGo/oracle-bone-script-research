...
Project ID: `obs-evo-cand-006113`
...
- Project ID: `obs-evo-cand-006113`
- EVOBC category candidate ID: `evobc-evo-cat-06113`
- External category reference: `evobc-cat-06113`
- Source category ID: `06113`
- Source label for human review: `稷`
- Source codepoints: `U+7A37`
...
- `obs-evo-cand-006113-route-category-staging`
...
- `obs-evo-cand-006113-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006113-route-evolution-graph`
