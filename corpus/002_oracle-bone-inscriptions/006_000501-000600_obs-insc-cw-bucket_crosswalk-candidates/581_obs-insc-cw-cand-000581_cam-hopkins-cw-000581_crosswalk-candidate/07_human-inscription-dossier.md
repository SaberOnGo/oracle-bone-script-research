...
- Yingguo / 英国所藏: `y2627` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `401` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `470` in source row; primary catalog entry pending
- Heji / 合集: `41845` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000581`
