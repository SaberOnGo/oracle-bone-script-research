# obs-char-001074 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001074`
- primary external id: `hust-obc-cat-1201`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1074_obs-char-001074_hust-obc-cat-1201_ora
  cle-character/03_visual-assets/001_asset-001079_hust-obc-cat-1201_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1201/G_1201_甲444(甲).png`
- asset id: `asset-001079`
...
- source category: `1201`
- validation class: `1073`
- source image route: `HUST-OBC/deciphered/1201/G_1201_甲444(甲).png`
- asset id: `asset-001079`
...
- English observation: `A narrow curved upper form has two pointed
  projections, a small central loop, and a short lower branching stroke.`
...
- dataset label text: `㢧`
- dataset label codepoints: `U+38A7`
...
- Which source records identify obs-char-001074 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001074？
