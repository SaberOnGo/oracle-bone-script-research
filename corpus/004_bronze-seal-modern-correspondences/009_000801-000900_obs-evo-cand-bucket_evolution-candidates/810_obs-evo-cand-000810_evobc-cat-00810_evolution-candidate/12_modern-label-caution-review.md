# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000810
...
- EVOBC candidate category: `evobc-evo-cat-00810`.
- Source label for search only: `作`.
- Source codepoints for search only: `U+4F5C`.
