# obs-char-001410 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1410_obs-char-001410_hust-obc-cat-1579_ora
  cle-character/03_visual-assets/001_asset-001415_hust-obc-cat-1579_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1579/G_1579_甲2375合21427.png`
- asset id: `asset-001415`
...
- source category: `1579`
- validation class: `1409`
- source image route: `HUST-OBC/deciphered/1579/G_1579_甲2375合21427.png`
- asset id: `asset-001415`
...
- English observation: `A large leaf-like enclosure contains a smaller
  rounded inner form.`
- 中文观察: `大型叶状框形内部有较小圆拱形体。`
...
- dataset label text: `㨡`
- dataset label codepoints: `U+3A21`
...
- filename catalog route clues: `Heji-like filename clue: 合21427
  (G_1579_甲2375合21427.png)`
...
- Which source records identify obs-char-001410 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001410？
