...
Project ID: `obs-evo-cand-004094`
...
- Project ID: `obs-evo-cand-004094`
- EVOBC category candidate ID: `evobc-evo-cat-04094`
- External category reference: `evobc-cat-04094`
- Source category ID: `04094`
- Source label for human review: `棖`
- Source codepoints: `U+68D6`
...
- `obs-evo-cand-004094-route-category-staging`
...
- `obs-evo-cand-004094-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004094-route-evolution-graph`
