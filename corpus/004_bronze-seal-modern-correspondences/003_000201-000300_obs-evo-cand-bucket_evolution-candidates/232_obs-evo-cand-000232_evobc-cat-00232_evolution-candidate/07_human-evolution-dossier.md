...
- External category reference: `evobc-cat-00232`
- Source category ID: `00232`
- Source label for human review: `㹲`
- Source codepoints: `U+3E72`
...
- `obs-evo-cand-000232-route-category-staging`
...
- `obs-evo-cand-000232-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000232-route-evolution-graph`
