...
- External category reference: `evobc-cat-09826`
- Source category ID: `09826`
- Source label for human review: `雝`
...
- `obs-evo-cand-009826-route-category-staging`
...
- `obs-evo-cand-009826-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009826-route-evolution-graph`
