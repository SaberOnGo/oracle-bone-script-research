# obs-unk-004466 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/066_obs-unk-004466_h
  ust-obc-und-X-004466_oracle-character-candidate/03_visual-assets/001_asset
  -006059_hust-obc-und-X-004466_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/22/X_？_8201_1.png`
- asset id: `asset-006059`
...
- source class: `HUST-OBC/undeciphered/X/22/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/22/X_？_8201_1.png`
- asset id: `asset-006059`
...
- English observation: A top horizontal trace spans hanging forms with loop-like
  openings and small marks below.
- 中文观察: 顶部横痕悬接带环状开口的痕迹，下方散有小圆点。
...
- Which source records identify obs-unk-004466 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004466？
