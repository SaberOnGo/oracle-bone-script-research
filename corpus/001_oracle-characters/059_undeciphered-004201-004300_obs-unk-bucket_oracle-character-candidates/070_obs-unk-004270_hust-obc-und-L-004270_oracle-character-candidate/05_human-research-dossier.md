# obs-unk-004270 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/070_obs-unk-004270_h
  ust-obc-und-L-004270_oracle-character-candidate/03_visual-assets/001_asset
  -005863_hust-obc-und-L-004270_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4270/L_？_9427.jpg`
- asset id: `asset-005863`
...
- source class: `HUST-OBC/undeciphered/L/4270/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4270/L_？_9427.jpg`
- asset id: `asset-005863`
...
- English observation: `Upper bar, outlined block, right diagonal visible.`
- 中文观察: `上部横痕、轮廓块面和右侧斜痕可见。`
...
- Which source records identify obs-unk-004270 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004270？
