...
Project ID: `obs-evo-cand-005375`
...
- Project ID: `obs-evo-cand-005375`
- EVOBC category candidate ID: `evobc-evo-cat-05375`
- External category reference: `evobc-cat-05375`
- Source category ID: `05375`
- Source label for human review: `珏`
- Source codepoints: `U+73CF`
...
- `obs-evo-cand-005375-route-category-staging`
...
- `obs-evo-cand-005375-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005375-route-evolution-graph`
