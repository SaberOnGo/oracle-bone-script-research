# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010697
...
- EVOBC candidate category: `evobc-evo-cat-10697`.
- Source label for search only: `鼪`.
- Source codepoints for search only: `U+9F2A`.
