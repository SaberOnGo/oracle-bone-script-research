...
- External category reference: `evobc-cat-07471`
- Source category ID: `07471`
- Source label for human review: `葛`
- Source codepoints: `U+845B`
...
- `obs-evo-cand-007471-route-category-staging`
...
- `obs-evo-cand-007471-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007471-route-evolution-graph`
