# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008819
...
- EVOBC candidate category: `evobc-evo-cat-08819`.
- Source label for search only: `軺`.
- Source codepoints for search only: `U+8EFA`.
