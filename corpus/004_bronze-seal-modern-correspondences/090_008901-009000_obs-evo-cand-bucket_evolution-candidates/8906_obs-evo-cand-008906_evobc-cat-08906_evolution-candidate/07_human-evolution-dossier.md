...
- External category reference: `evobc-cat-08906`
- Source category ID: `08906`
- Source label for human review: `辛`
- Source codepoints: `U+8F9B`
- Image reference count in source metadata: `416`
...
- source `1`
  ...
  image references: 154
- source `2`
  token: `Book:17600`
  image references: 35
- source `3`
  token: `Book:21681`
  image references: 169
- source `4`
  token: `Book:9131`
  image references: 8
- source `5`
...
- `obs-evo-cand-008906-route-category-staging`
...
- `obs-evo-cand-008906-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008906-route-evolution-graph`
