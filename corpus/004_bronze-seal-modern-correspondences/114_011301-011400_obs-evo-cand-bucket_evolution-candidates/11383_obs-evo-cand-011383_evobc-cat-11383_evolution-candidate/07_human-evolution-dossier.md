...
- External category reference: `evobc-cat-11383`
- Source category ID: `11383`
- Source label for human review: `𣃭`
...
- `obs-evo-cand-011383-route-category-staging`
...
- `obs-evo-cand-011383-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011383-route-evolution-graph`
