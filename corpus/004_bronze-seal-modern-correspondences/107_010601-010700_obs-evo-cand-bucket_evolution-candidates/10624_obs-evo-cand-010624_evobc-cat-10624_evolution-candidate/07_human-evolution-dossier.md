...
- Project ID: `obs-evo-cand-010624`
- EVOBC category candidate ID: `evobc-evo-cat-10624`
- External category reference: `evobc-cat-10624`
- Source category ID: `10624`
- Source label for human review: `麩`
- Source codepoints: `U+9EA9`
...
- `obs-evo-cand-010624-route-category-staging`
...
- `obs-evo-cand-010624-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010624-route-evolution-graph`
