# obs-char-000842 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000842`
- primary external id: `hust-obc-cat-0951`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/842_obs-char-000842_hust-obc-cat-0951_orac
  le-character/03_visual-assets/001_asset-000847_hust-obc-cat-0951_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0951/G_0951_京津1929合27798何組.png`
- asset id: `asset-000847`
...
- source category: `0951`
- validation class: `841`
- source image route: `HUST-OBC/deciphered/0951/G_0951_京津1929合27798何組.png`
- asset id: `asset-000847`
...
- English observation: `A rounded rectangular top frame sits above a central
  stem; short side strokes and two long lower strokes descend below it.`
- 中文观察: `圆弧矩形上框位于中央笔干上方；短侧笔和两条长下笔从框下延伸。`
...
- dataset label text: `㞭`
- dataset label codepoints: `U+37AD`
...
- filename catalog route clues: `Heji-like filename clue: 合27798
  (G_0951_京津1929合27798何組.png)`
...
- Which source records identify obs-char-000842 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000842？
