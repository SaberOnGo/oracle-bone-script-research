...
Project ID: `obs-evo-cand-008817`
...
- Project ID: `obs-evo-cand-008817`
- EVOBC category candidate ID: `evobc-evo-cat-08817`
- External category reference: `evobc-cat-08817`
- Source category ID: `08817`
- Source label for human review: `軸`
- Source codepoints: `U+8EF8`
...
- `obs-evo-cand-008817-route-category-staging`
...
- `obs-evo-cand-008817-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008817-route-evolution-graph`
