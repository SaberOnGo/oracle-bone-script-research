# Human Research Readiness Review / 人类研究准备度复核: coll-obj-cand-00020
...
| --- | --- | --- |
| Catalog source | `764` | `02_collection-source-index.csv` |
...
- Which source description, ink observation, or image route requires
