# obs-evo-cand-012145 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-12145`
- Source label for human review: `𧇽`
- Source codepoints: `U+271FD`
- Image reference count: `15`
- Era token counts: `SS:1;WSC:14`
- Source token counts: `Book:14;說文Web:1`
