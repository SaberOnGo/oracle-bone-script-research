# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000798
...
- EVOBC candidate category: `evobc-evo-cat-00798`.
- Source label for search only: `位`.
- Source codepoints for search only: `U+4F4D`.
