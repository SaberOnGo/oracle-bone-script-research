# Material Visual Observation / obs-comp-cand-000610 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000610`
- External reference / 外部参照: `obimd-sub-tzpd74rbvm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013173_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/l3wc3uouh6/tzpd74rbvm/tzpd74rbvm.png`
- Checksum / 校验和:
  `edf54c2926f01f70ec03ec03d5310143b7a86cb93d7490205a044d7823f37c9a`
...
- Marked-pixel bounds: (45,22)–(199,227); span 155 × 206 px; the marked
...
- 痕迹范围：(45,22)–(199,227)；跨度155 × 206 px；痕迹矩形高于宽。
