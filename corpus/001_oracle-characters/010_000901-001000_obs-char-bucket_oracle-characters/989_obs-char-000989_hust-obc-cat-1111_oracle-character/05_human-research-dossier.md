# obs-char-000989 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000989`
- primary external id: `hust-obc-cat-1111`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/989_obs-char-000989_hust-obc-cat-1111_orac
  le-character/03_visual-assets/001_asset-000994_hust-obc-cat-1111_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1111/H_1111_60507_0.png`
- asset id: `asset-000994`
...
- source category: `1111`
- validation class: `988`
- source image route: `HUST-OBC/deciphered/1111/H_1111_60507_0.png`
- asset id: `asset-000994`
...
- English observation: `A tall central enclosure with a looped top is
  flanked by a separate left branching stroke and a right curved stroke.`
- 中文观察: `高长中央闭合轮廓顶部有环状笔，左侧有分离分枝笔，右侧有弯曲笔。`
...
- dataset label text: `㡍`
- dataset label codepoints: `U+384D`
...
- filename catalog route clues: `catalog-like filename clue: H_1111
  (H_1111_60507_0.png)`
...
- Which source records identify obs-char-000989 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000989？
