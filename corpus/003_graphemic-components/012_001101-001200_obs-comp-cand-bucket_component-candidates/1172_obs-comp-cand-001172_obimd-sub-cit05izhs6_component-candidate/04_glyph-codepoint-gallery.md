# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001172
...
| --- | --- | --- | --- |
| `obimd-glyph-link-017562` | 󶰙 | `U+F6C19` | `reviewed_metadata_only` |
| `obimd-glyph-link-017563` | 󶰚 | `U+F6C1A` | `reviewed_metadata_only` |
