...
- External category reference: `evobc-cat-02212`
- Source category ID: `02212`
- Source label for human review: `婭`
...
- `obs-evo-cand-002212-route-category-staging`
...
- `obs-evo-cand-002212-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002212-route-evolution-graph`
