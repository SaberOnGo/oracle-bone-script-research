# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-002550
...
- candidate_component_id: `obs-comp-cand-002550`
- primary_external_ref_id: `obimd-sub-fwo4rzegus`
- source_subcharacter_uid: `fwo4rzegus`
...
- glyph_codepoint_uplus_sample: `U+FE771, U+FE772, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-021082` | `001_asset-021082_img.png` | `fb7f5650cc77f4b7efa2dfed98923f07315496a587d39fb00a1d1a375869f3a9` |
