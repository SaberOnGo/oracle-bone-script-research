...
Project ID: `obs-evo-cand-002406`
...
- Project ID: `obs-evo-cand-002406`
- EVOBC category candidate ID: `evobc-evo-cat-02406`
- External category reference: `evobc-cat-02406`
- Source category ID: `02406`
- Source label for human review: `寁`
- Source codepoints: `U+5BC1`
...
- `obs-evo-cand-002406-route-category-staging`
...
- `obs-evo-cand-002406-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002406-route-evolution-graph`
