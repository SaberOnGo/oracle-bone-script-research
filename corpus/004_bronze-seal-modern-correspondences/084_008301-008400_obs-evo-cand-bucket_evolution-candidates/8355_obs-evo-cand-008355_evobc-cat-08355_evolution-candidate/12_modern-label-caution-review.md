# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008355
...
- EVOBC candidate category: `evobc-evo-cat-08355`.
- Source label for search only: `譏`.
- Source codepoints for search only: `U+8B4F`.
