...
- External category reference: `evobc-cat-00342`
- Source category ID: `00342`
- Source label for human review: `䍑`
...
- `obs-evo-cand-000342-route-category-staging`
...
- `obs-evo-cand-000342-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000342-route-evolution-graph`
