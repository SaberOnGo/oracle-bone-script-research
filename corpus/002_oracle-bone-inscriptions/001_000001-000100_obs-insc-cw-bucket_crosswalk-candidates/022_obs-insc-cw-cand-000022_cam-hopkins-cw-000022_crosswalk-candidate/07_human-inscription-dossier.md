...
Project ID: `obs-insc-cw-cand-000022`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000022`
...
- Yingguo / 英国所藏: `y129` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `8` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `408` in source row; primary catalog entry pending
- Heji / 合集: `40524` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000022`
