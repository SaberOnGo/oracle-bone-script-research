...
- Project ID: `obs-evo-cand-011223`
- EVOBC category candidate ID: `evobc-evo-cat-11223`
- External category reference: `evobc-cat-11223`
- Source category ID: `11223`
- Source label for human review: `𢗡`
- Source codepoints: `U+225E1`
...
- `obs-evo-cand-011223-route-category-staging`
...
- `obs-evo-cand-011223-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011223-route-evolution-graph`
