# obs-char-000051 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/051_obs-char-000051_hust-obc-cat-0059_orac
  le-character/03_visual-assets/001_asset-000056_hust-obc-cat-0059_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0059/G_0059_乙2593(甲).png`
- asset id: `asset-000056`
...
- source category: `0059`
- validation class: `50`
- source image route: `HUST-OBC/deciphered/0059/G_0059_乙2593(甲).png`
- asset id: `asset-000056`
...
- dataset label text: `㐱`
- dataset label codepoints: `U+3431`
...
- OBIMD candidate ids / OBIMD 候选 ID: `obimd-main-cand-001015`
- OBIMD external refs / OBIMD 外部引用: `obimd-main-omtx3jpdtq`
- OBIMD transcription field / OBIMD 转写字段: `㐱`
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00006`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00006`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00006`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/006_obs-evo-can
  d-000006_evobc-cat-00006_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/006_obs-evo-cand-000006_evobc-cat-00006_evolu
...
- Which source records identify obs-char-000051 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000051？
