# obs-unk-007527 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-007527`
- primary external id: `hust-obc-und-YH-007527`
...
- local review image route: `corpus/001_oracle-characters/092_undeciphered-007
  501-007600_obs-unk-bucket_oracle-character-candidates/027_obs-unk-007527_h
  ust-obc-und-YH-007527_oracle-character-candidate/03_visual-assets/001_asse
  t-009118_hust-obc-und-YH-007527_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6009D/H_？_6009D_0.png`
- asset id: `asset-009118`
...
- source class: `HUST-OBC/undeciphered/Y+H/6009D/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6009D/H_？_6009D_0.png`
- asset id: `asset-009118`
...
- Which source records identify obs-unk-007527 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007527？
