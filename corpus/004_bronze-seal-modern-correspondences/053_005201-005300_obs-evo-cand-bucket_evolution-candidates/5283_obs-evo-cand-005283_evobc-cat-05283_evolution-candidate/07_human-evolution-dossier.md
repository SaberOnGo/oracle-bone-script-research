...
- Project ID: `obs-evo-cand-005283`
- EVOBC category candidate ID: `evobc-evo-cat-05283`
- External category reference: `evobc-cat-05283`
- Source category ID: `05283`
- Source label for human review: `狻`
- Source codepoints: `U+72FB`
...
- `obs-evo-cand-005283-route-category-staging`
...
- `obs-evo-cand-005283-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005283-route-evolution-graph`
