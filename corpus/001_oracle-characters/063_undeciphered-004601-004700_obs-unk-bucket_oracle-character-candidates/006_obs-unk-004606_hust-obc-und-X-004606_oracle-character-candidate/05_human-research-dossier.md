# obs-unk-004606 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/006_obs-unk-004606_h
  ust-obc-und-X-004606_oracle-character-candidate/03_visual-assets/001_asset
  -006199_hust-obc-und-X-004606_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/162/X_？_8338_1.png`
- asset id: `asset-006199`
...
- source class: `HUST-OBC/undeciphered/X/162/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/162/X_？_8338_1.png`
- asset id: `asset-006199`
...
- English observation: `rectangular frame, inner crossed form, corners`
- 中文观察: `矩形框、框内交叉形体和下角延伸已记录。`
...
- Which source records identify obs-unk-004606 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004606？
