# Material Visual Observation / obs-comp-cand-001279 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001279`
- External reference / 外部参照: `obimd-sub-q40isurmbx`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015564_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/q40isurmbx/q40isurmbx/q40isurmbx.png`
- Checksum / 校验和:
  `b8c9fbc29d1bd8bb9ad022b04f049e9aae8b8f0e22530fc3b5f6f12fcf10baac`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.85%.
- Marked-pixel bounds: (75,36)–(174,218); span 100 × 183 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.85%。
- 痕迹范围：(75,36)–(174,218)；跨度100 × 183 px；痕迹矩形高于宽。
