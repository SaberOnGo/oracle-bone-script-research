...
Project ID: `obs-evo-cand-003348`
...
- Project ID: `obs-evo-cand-003348`
- EVOBC category candidate ID: `evobc-evo-cat-03348`
- External category reference: `evobc-cat-03348`
- Source category ID: `03348`
- Source label for human review: `挠`
- Source codepoints: `U+6320`
...
- `obs-evo-cand-003348-route-category-staging`
...
- `obs-evo-cand-003348-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003348-route-evolution-graph`
