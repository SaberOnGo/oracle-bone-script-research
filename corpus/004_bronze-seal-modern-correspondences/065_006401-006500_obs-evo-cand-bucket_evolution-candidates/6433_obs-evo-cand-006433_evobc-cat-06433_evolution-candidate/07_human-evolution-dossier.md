...
- External category reference: `evobc-cat-06433`
- Source category ID: `06433`
- Source label for human review: `糪`
...
- `obs-evo-cand-006433-route-category-staging`
...
- `obs-evo-cand-006433-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006433-route-evolution-graph`
