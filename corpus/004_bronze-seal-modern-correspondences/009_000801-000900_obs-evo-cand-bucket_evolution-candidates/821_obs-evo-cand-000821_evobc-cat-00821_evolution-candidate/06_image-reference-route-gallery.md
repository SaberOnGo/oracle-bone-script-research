...
- `obs-evo-cand-000821-route-category-staging`
...
- `obs-evo-cand-000821-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000821-route-evolution-graph`
