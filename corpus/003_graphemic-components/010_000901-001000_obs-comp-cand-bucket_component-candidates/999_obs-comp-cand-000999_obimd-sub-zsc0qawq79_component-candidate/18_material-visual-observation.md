# Material Visual Observation / obs-comp-cand-000999 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000999`
- External reference / 外部参照: `obimd-sub-zsc0qawq79`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014437_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zsc0qawq79/zsc0qawq79/zsc0qawq79.png`
- Checksum / 校验和:
  `0a1c79c6a6b155e2b75ff2bbc956eb2c00ee36d53e6ca98a342ce8a0dffcbe22`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.40%.
- Marked-pixel bounds: (87,23)–(173,227); span 87 × 205 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.40%。
- 痕迹范围：(87,23)–(173,227)；跨度87 × 205 px；痕迹矩形高于宽。
