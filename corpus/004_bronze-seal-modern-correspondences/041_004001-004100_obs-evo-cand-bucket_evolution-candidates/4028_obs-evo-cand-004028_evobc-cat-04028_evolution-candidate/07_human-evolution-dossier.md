...
- External category reference: `evobc-cat-04028`
- Source category ID: `04028`
- Source label for human review: `桒`
- Source codepoints: `U+6852`
...
- `obs-evo-cand-004028-route-category-staging`
...
- `obs-evo-cand-004028-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004028-route-evolution-graph`
