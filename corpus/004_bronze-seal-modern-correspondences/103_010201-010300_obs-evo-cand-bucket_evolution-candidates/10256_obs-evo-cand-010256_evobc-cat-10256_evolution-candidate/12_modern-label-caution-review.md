# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010256
...
- EVOBC candidate category: `evobc-evo-cat-10256`.
- Source label for search only: `驘`.
- Source codepoints for search only: `U+9A58`.
