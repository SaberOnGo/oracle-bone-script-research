# Material Visual Observation / obs-comp-cand-002701 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002701`
- External reference / 外部参照: `obimd-sub-n4zypvvycn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021277_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/n4zypvvycn/n4zypvvycn/n4zypvvycn.png`
- Checksum / 校验和:
  `6210b35952afcaa272d69c1df92c0ce4ed5e3fbc69a40231ac2c1bb27d3a515b`
...
- Marked-pixel bounds: (95,17)–(165,227); span 71 × 211 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.26%。
- 痕迹范围：(95,17)–(165,227)；跨度71 × 211 px；痕迹矩形高于宽。
