...
Project ID: `obs-evo-cand-006744`
...
- Project ID: `obs-evo-cand-006744`
- EVOBC category candidate ID: `evobc-evo-cat-06744`
- External category reference: `evobc-cat-06744`
- Source category ID: `06744`
- Source label for human review: `绍`
- Source codepoints: `U+7ECD`
...
- `obs-evo-cand-006744-route-category-staging`
...
- `obs-evo-cand-006744-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006744-route-evolution-graph`
