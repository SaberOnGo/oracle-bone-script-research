...
- External category reference: `evobc-cat-05364`
- Source category ID: `05364`
- Source label for human review: `玲`
...
- `obs-evo-cand-005364-route-category-staging`
...
- `obs-evo-cand-005364-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005364-route-evolution-graph`
