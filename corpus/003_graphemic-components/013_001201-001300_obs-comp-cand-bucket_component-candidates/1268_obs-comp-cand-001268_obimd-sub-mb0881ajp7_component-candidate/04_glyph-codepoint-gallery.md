# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001268
...
| --- | --- | --- | --- |
| `obimd-glyph-link-019121` | 󷓯 | `U+F74EF` | `reviewed_metadata_only` |
| `obimd-glyph-link-019122` | 󷓰 | `U+F74F0` | `reviewed_metadata_only` |
| `obimd-glyph-link-019123` | 󷓱 | `U+F74F1` | `reviewed_metadata_only` |
