# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000707
...
- EVOBC candidate category: `evobc-evo-cat-00707`.
- Source label for search only: `京`.
- Source codepoints for search only: `U+4EAC`.
