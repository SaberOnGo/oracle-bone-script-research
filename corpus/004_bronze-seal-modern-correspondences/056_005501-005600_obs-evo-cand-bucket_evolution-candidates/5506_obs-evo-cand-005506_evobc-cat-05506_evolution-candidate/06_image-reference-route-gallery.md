...
- `obs-evo-cand-005506-route-category-staging`
...
- `obs-evo-cand-005506-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005506-route-evolution-graph`
