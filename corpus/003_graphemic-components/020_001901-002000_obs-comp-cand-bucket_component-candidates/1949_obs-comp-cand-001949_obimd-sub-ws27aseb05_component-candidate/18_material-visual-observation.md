# Material Visual Observation / obs-comp-cand-001949 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001949`
- External reference / 外部参照: `obimd-sub-ws27aseb05`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018759_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jyskjcj861/ws27aseb05/ws27aseb05.png`
- Checksum / 校验和:
  `063fbd90ecc9d69fc1781417c62ff58887802ecd35d6b0f23a45b8d46cb8cc88`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.14%.
- Marked-pixel bounds: (58,29)–(215,221); span 158 × 193 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.14%。
- 痕迹范围：(58,29)–(215,221)；跨度158 × 193 px；痕迹矩形高于宽。
