...
- Project ID: `obs-evo-cand-005690`
- EVOBC category candidate ID: `evobc-evo-cat-05690`
- External category reference: `evobc-cat-05690`
- Source category ID: `05690`
- Source label for human review: `癇`
- Source codepoints: `U+7647`
...
- `obs-evo-cand-005690-route-category-staging`
...
- `obs-evo-cand-005690-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005690-route-evolution-graph`
