# Material Visual Observation / obs-unk-002650
...
- Project ID / 项目 ID: `obs-unk-002650`
- Source / 来源: `src-hust-obc`
- Primary external reference / 首选外部参考:
  `hust-obc-und-L-002650`
- Committed image / 已提交图像:
  `03_visual-assets/001_asset-004243_hust-obc-und-L-002650_glyph.jpg`
- Opened derivative / 已打开派生件: the committed review image

## Direct Visual Record / 直接可见记录

- English observation: A short upper horizontal stroke intersects a central
  vertical line. A long line descends on the right, while two short angular
  strokes branch from the lower central area.
- 中文观察：上部短横笔痕交叉中央纵线。右侧有一条较长下行笔痕，中央
  下部向两侧分出两条短折角笔痕。
