# obs-unk-008859 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008859`
- primary external id: `hust-obc-und-YH-008859`
...
- local review image route: `corpus/001_oracle-characters/105_undeciphered-008
  801-008900_obs-unk-bucket_oracle-character-candidates/059_obs-unk-008859_h
  ust-obc-und-YH-008859_oracle-character-candidate/03_visual-assets/001_asse
  t-010450_hust-obc-und-YH-008859_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60EA4/H_？_60EA4_0.png`
- asset id: `asset-010450`
...
- source class: `HUST-OBC/undeciphered/Y+H/60EA4/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60EA4/H_？_60EA4_0.png`
...
- Which source records identify obs-unk-008859 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008859？
