# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003981
...
- EVOBC candidate category: `evobc-evo-cat-03981`.
- Source label for search only: `柶`.
- Source codepoints for search only: `U+67F6`.
