...
- `obs-evo-cand-007027-route-category-staging`
...
- `obs-evo-cand-007027-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007027-route-evolution-graph`
