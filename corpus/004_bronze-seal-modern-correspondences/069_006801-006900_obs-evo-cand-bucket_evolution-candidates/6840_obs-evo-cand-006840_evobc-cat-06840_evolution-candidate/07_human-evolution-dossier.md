...
- External category reference: `evobc-cat-06840`
- Source category ID: `06840`
- Source label for human review: `美`
- Source codepoints: `U+7F8E`
...
- `obs-evo-cand-006840-route-category-staging`
...
- `obs-evo-cand-006840-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006840-route-evolution-graph`
