...
- External category reference: `evobc-cat-00455`
- Source category ID: `00455`
- Source label for human review: `䟊`
...
- `obs-evo-cand-000455-route-category-staging`
...
- `obs-evo-cand-000455-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000455-route-evolution-graph`
