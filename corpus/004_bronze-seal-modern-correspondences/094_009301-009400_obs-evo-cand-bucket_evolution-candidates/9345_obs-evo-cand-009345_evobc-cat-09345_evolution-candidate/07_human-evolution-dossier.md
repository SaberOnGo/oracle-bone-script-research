...
Project ID: `obs-evo-cand-009345`
...
- Project ID: `obs-evo-cand-009345`
- EVOBC category candidate ID: `evobc-evo-cat-09345`
- External category reference: `evobc-cat-09345`
- Source category ID: `09345`
- Source label for human review: `鈭`
- Source codepoints: `U+922D`
...
- `obs-evo-cand-009345-route-category-staging`
...
- `obs-evo-cand-009345-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009345-route-evolution-graph`
