# obs-char-001032 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001032`
- primary external id: `hust-obc-cat-1157`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1032_obs-char-001032_hust-obc-cat-1157_ora
  cle-character/03_visual-assets/001_asset-001037_hust-obc-cat-1157_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1157/G_1157_乙1277合376賓組.png`
- asset id: `asset-001037`
...
- source category: `1157`
- validation class: `1031`
- source image route: `HUST-OBC/deciphered/1157/G_1157_乙1277合376賓組.png`
- asset id: `asset-001037`
...
- English observation: `A tall thin left form with a pointed upper stroke
  stands beside a separate small rounded rectangular enclosure.`
- 中文观察: `带尖状上笔的高而纤细左侧形体旁有分离的小型圆弧矩形闭合轮廓。`
...
- dataset label text: `㡻`
- dataset label codepoints: `U+387B`
...
- Which source records identify obs-char-001032 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001032？
