# obs-unk-004810 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004810`
- primary external id: `hust-obc-und-X-004810`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/010_obs-unk-004810_h
  ust-obc-und-X-004810_oracle-character-candidate/03_visual-assets/001_asset
  -006403_hust-obc-und-X-004810_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/366/X_？_7351_1.png`
- asset id: `asset-006403`
...
- source class: `HUST-OBC/undeciphered/X/366/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/366/X_？_7351_1.png`
- asset id: `asset-006403`
...
- English observation: `two upper strokes and lower openings`
- 中文观察: `上部两条笔画和下部开口`
...
- Which source records identify obs-unk-004810 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004810？
