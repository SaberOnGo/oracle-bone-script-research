# Material Visual Observation / obs-comp-cand-001424 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001424`
- External reference / 外部参照: `obimd-sub-v0vpglxpcz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016001_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/v0vpglxpcz/v0vpglxpcz/v0vpglxpcz.png`
- Checksum / 校验和:
  `f1a71134dd09c3cfc787cfc8163d66b1f010ce008ff562008b6f309fb62652f5`
...
- Marked-pixel bounds: (88,24)–(161,220); span 74 × 197 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.80%。
- 痕迹范围：(88,24)–(161,220)；跨度74 × 197 px；痕迹矩形高于宽。
