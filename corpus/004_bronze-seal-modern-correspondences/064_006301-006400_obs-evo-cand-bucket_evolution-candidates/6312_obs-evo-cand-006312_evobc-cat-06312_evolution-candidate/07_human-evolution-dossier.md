...
- External category reference: `evobc-cat-06312`
- Source category ID: `06312`
- Source label for human review: `篅`
...
- `obs-evo-cand-006312-route-category-staging`
...
- `obs-evo-cand-006312-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006312-route-evolution-graph`
