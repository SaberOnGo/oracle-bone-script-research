# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010459
...
- EVOBC candidate category: `evobc-evo-cat-10459`.
- Source label for search only: `鱻`.
- Source codepoints for search only: `U+9C7B`.
