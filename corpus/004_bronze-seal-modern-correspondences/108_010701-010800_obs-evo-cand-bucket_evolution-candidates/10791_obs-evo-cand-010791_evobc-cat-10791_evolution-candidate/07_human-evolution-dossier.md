...
- External category reference: `evobc-cat-10791`
- Source category ID: `10791`
- Source label for human review: `𠇷`
- Source codepoints: `U+201F7`
...
- `obs-evo-cand-010791-route-category-staging`
...
- `obs-evo-cand-010791-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010791-route-evolution-graph`
