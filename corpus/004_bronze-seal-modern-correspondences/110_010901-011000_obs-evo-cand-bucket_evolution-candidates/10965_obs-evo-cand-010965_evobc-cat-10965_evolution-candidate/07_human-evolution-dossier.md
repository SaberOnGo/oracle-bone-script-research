...
Project ID: `obs-evo-cand-010965`
...
- Project ID: `obs-evo-cand-010965`
- EVOBC category candidate ID: `evobc-evo-cat-10965`
- External category reference: `evobc-cat-10965`
- Source category ID: `10965`
- Source label for human review: `𡄰`
- Source codepoints: `U+21130`
...
- `obs-evo-cand-010965-route-category-staging`
...
- `obs-evo-cand-010965-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010965-route-evolution-graph`
