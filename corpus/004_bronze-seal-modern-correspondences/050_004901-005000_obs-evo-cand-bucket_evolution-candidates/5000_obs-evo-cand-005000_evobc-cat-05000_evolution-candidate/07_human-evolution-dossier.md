...
- External category reference: `evobc-cat-05000`
- Source category ID: `05000`
- Source label for human review: `瀱`
...
- `obs-evo-cand-005000-route-category-staging`
...
- `obs-evo-cand-005000-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005000-route-evolution-graph`
