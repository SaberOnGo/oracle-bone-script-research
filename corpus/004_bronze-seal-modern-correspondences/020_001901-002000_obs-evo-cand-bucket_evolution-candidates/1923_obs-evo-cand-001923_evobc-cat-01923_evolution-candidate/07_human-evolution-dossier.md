...
- External category reference: `evobc-cat-01923`
- Source category ID: `01923`
- Source label for human review: `塞`
- Source codepoints: `U+585E`
- Image reference count in source metadata: `51`
...
- `obs-evo-cand-001923-route-category-staging`
...
- `obs-evo-cand-001923-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001923-route-evolution-graph`
