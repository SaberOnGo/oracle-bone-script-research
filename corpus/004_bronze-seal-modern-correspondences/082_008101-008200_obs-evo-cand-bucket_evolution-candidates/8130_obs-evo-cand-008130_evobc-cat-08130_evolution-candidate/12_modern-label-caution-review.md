# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008130
...
- EVOBC candidate category: `evobc-evo-cat-08130`.
- Source label for search only: `訌`.
- Source codepoints for search only: `U+8A0C`.
