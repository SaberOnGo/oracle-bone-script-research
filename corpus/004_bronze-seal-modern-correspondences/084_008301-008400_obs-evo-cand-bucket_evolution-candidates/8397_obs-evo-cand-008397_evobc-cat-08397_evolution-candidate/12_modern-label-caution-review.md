# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008397
...
- EVOBC candidate category: `evobc-evo-cat-08397`.
- Source label for search only: `讚`.
- Source codepoints for search only: `U+8B9A`.
