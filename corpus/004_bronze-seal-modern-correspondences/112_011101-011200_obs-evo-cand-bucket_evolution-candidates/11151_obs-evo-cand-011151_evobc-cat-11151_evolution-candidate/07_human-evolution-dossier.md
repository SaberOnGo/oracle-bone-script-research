...
- External category reference: `evobc-cat-11151`
- Source category ID: `11151`
- Source label for human review: `𢆽`
- Source codepoints: `U+221BD`
...
- `obs-evo-cand-011151-route-category-staging`
...
- `obs-evo-cand-011151-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011151-route-evolution-graph`
