# Material Visual Observation / obs-comp-cand-002092 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002092`
- External reference / 外部参照: `obimd-sub-1tvpevfzmn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019538_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1tvpevfzmn/1tvpevfzmn/1tvpevfzmn.png`
- Checksum / 校验和:
  `cb3f1d94eb383b1bd43447ce42020e7dd270bd0294ec33abdd2c3d804125d266`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.77%.
- Marked-pixel bounds: (62,21)–(200,225); span 139 × 205 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.77%。
- 痕迹范围：(62,21)–(200,225)；跨度139 × 205 px；痕迹矩形高于宽。
