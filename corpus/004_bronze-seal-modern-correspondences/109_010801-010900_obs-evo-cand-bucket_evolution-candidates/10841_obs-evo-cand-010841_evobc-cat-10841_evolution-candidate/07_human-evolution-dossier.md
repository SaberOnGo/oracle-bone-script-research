...
- External category reference: `evobc-cat-10841`
- Source category ID: `10841`
...
- `obs-evo-cand-010841-route-category-staging`
...
- `obs-evo-cand-010841-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010841-route-evolution-graph`
