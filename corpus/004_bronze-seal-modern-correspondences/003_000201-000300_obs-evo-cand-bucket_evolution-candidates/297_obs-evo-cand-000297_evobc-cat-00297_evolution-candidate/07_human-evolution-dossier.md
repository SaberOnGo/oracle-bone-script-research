...
- External category reference: `evobc-cat-00297`
- Source category ID: `00297`
- Source label for human review: `䇊`
...
- `obs-evo-cand-000297-route-category-staging`
...
- `obs-evo-cand-000297-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000297-route-evolution-graph`
