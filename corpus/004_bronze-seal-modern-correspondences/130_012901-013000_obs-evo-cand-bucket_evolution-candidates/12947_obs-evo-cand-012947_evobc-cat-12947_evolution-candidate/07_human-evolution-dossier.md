...
- External category reference: `evobc-cat-12947`
- Source category ID: `12947`
- Source label for human review: `𫑠`
...
- `obs-evo-cand-012947-route-category-staging`
...
- `obs-evo-cand-012947-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012947-route-evolution-graph`
