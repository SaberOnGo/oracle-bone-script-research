...
- External category reference: `evobc-cat-10931`
- Source category ID: `10931`
- Source label for human review: `𠮵`
...
- `obs-evo-cand-010931-route-category-staging`
...
- `obs-evo-cand-010931-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010931-route-evolution-graph`
