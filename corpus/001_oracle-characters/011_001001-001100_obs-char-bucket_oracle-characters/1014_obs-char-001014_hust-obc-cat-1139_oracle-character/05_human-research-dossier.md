# obs-char-001014 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001014`
- primary external id: `hust-obc-cat-1139`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1014_obs-char-001014_hust-obc-cat-1139_ora
  cle-character/03_visual-assets/001_asset-001019_hust-obc-cat-1139_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1139/G_1139_乙584合14630賓組.png`
- asset id: `asset-001019`
...
- source category: `1139`
- validation class: `1013`
- source image route: `HUST-OBC/deciphered/1139/G_1139_乙584合14630賓組.png`
- asset id: `asset-001019`
...
- English observation: `A horizontally oriented wedge-like contour has a
  thick outer edge and a short interior dividing stroke.`
- 中文观察: `横向展开的楔状轮廓有粗重外缘和一条短内部分隔笔。`
...
- dataset label text: `㡩`
- dataset label codepoints: `U+3869`
...
- filename catalog route clues: `Heji-like filename clue: 合14630
  (G_1139_乙584合14630賓組.png)`
...
- Which source records identify obs-char-001014 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001014？
