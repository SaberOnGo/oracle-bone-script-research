...
- `obs-evo-cand-001345-route-category-staging`
...
- `obs-evo-cand-001345-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001345-route-evolution-graph`
