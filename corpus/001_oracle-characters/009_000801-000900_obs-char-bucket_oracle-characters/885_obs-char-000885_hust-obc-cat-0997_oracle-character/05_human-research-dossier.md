# obs-char-000885 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000885`
- primary external id: `hust-obc-cat-0997`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/885_obs-char-000885_hust-obc-cat-0997_orac
  le-character/03_visual-assets/001_asset-000890_hust-obc-cat-0997_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0997/G_0997_前2.19.2合8357賓組.png`
- asset id: `asset-000890`
...
- source category: `0997`
- validation class: `884`
- source image route: `HUST-OBC/deciphered/0997/G_0997_前2.19.2合8357賓組.png`
- asset id: `asset-000890`
...
- English observation: `A tall narrow form has a long curved left contour,
  small internal looped marks, and scattered short strokes toward the lower
  end.`
...
- dataset label text: `㟛`
- dataset label codepoints: `U+37DB`
...
- filename catalog route clues: `Heji-like filename clue: 合8357
...
- Which source records identify obs-char-000885 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000885？
