# obs-unk-004932 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004932`
- primary external id: `hust-obc-und-X-004932`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/032_obs-unk-004932_h
  ust-obc-und-X-004932_oracle-character-candidate/03_visual-assets/001_asset
  -006525_hust-obc-und-X-004932_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/488/X_？_7472_1.png`
- asset id: `asset-006525`
...
- An upper curved boundary and lower triangular opening are visible.
...
- source class: `HUST-OBC/undeciphered/X/488/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/488/X_？_7472_1.png`
- asset id: `asset-006525`
...
- Which source records identify obs-unk-004932 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004932？
