...
Project ID: `obs-evo-cand-011371`
...
- Project ID: `obs-evo-cand-011371`
- EVOBC category candidate ID: `evobc-evo-cat-11371`
- External category reference: `evobc-cat-11371`
- Source category ID: `11371`
- Source label for human review: `𣀮`
- Source codepoints: `U+2302E`
...
- `obs-evo-cand-011371-route-category-staging`
...
- `obs-evo-cand-011371-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011371-route-evolution-graph`
