...
Project ID: `obs-evo-cand-010435`
...
- Project ID: `obs-evo-cand-010435`
- EVOBC category candidate ID: `evobc-evo-cat-10435`
- External category reference: `evobc-cat-10435`
- Source category ID: `10435`
- Source label for human review: `鰨`
- Source codepoints: `U+9C28`
...
- `obs-evo-cand-010435-route-category-staging`
...
- `obs-evo-cand-010435-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010435-route-evolution-graph`
