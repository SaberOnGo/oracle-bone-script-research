...
Project ID: `obs-evo-cand-011051`
...
- Project ID: `obs-evo-cand-011051`
- EVOBC category candidate ID: `evobc-evo-cat-11051`
- External category reference: `evobc-cat-11051`
- Source category ID: `11051`
- Source label for human review: `𡣎`
- Source codepoints: `U+218CE`
...
- `obs-evo-cand-011051-route-category-staging`
...
- `obs-evo-cand-011051-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011051-route-evolution-graph`
