# obs-comp-cand-002733 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002733`
- 首选外部 ID: `obimd-sub-sc05m6ppyd`
- OBIMD subcharacter UID: `sc05m6ppyd`
- OBIMD main character UID: `sc05m6ppyd`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+FF6A9; U+FF6AA; 另有 1 项
