# obs-char-001288 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1288_obs-char-001288_hust-obc-cat-1440_ora
  cle-character/03_visual-assets/001_asset-001293_hust-obc-cat-1440_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1440/G_1440_合17468(甲).png`
- asset id: `asset-001293`
...
- source category: `1440`
- validation class: `1287`
- source image route: `HUST-OBC/deciphered/1440/G_1440_合17468(甲).png`
- asset id: `asset-001293`
...
- English observation: `A broad peaked upper arch sits above a lower
  branching cluster with an open central gap.`
...
- dataset label text: `㦖`
- dataset label codepoints: `U+3996`
...
- filename catalog route clues: `Heji-like filename clue: 合17468
  (G_1440_合17468(甲).png)`
...
- Which source records identify obs-char-001288 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001288？
