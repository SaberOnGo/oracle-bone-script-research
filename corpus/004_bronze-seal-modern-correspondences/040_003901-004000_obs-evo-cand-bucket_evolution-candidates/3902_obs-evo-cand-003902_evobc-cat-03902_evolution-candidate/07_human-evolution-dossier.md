...
- Project ID: `obs-evo-cand-003902`
- EVOBC category candidate ID: `evobc-evo-cat-03902`
- External category reference: `evobc-cat-03902`
- Source category ID: `03902`
- Source label for human review: `杷`
- Source codepoints: `U+6777`
...
- `obs-evo-cand-003902-route-category-staging`
...
- `obs-evo-cand-003902-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003902-route-evolution-graph`
