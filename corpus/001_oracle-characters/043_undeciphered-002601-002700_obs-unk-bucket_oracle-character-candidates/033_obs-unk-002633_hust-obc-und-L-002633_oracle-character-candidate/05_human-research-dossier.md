# obs-unk-002633 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002633`
- primary external id: `hust-obc-und-L-002633`
...
- local review image route: `corpus/001_oracle-characters/043_undeciphered-002
  601-002700_obs-unk-bucket_oracle-character-candidates/033_obs-unk-002633_h
  ust-obc-und-L-002633_oracle-character-candidate/03_visual-assets/001_asset
  -004226_hust-obc-und-L-002633_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2633/L_？_4101.jpg`
- asset id: `asset-004226`
...
- source class: `HUST-OBC/undeciphered/L/2633/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2633/L_？_4101.jpg`
- asset id: `asset-004226`
...
- Which source records identify obs-unk-002633 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002633？
