...
Project ID: `obs-evo-cand-001567`
...
- Project ID: `obs-evo-cand-001567`
- EVOBC category candidate ID: `evobc-evo-cat-01567`
- External category reference: `evobc-cat-01567`
- Source category ID: `01567`
- Source label for human review: `咬`
- Source codepoints: `U+54AC`
...
- `obs-evo-cand-001567-route-category-staging`
...
- `obs-evo-cand-001567-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001567-route-evolution-graph`
