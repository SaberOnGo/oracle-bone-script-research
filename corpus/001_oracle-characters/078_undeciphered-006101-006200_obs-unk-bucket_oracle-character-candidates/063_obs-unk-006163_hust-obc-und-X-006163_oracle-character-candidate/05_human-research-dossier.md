# obs-unk-006163 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/078_undeciphered-006
  101-006200_obs-unk-bucket_oracle-character-candidates/063_obs-unk-006163_h
  ust-obc-und-X-006163_oracle-character-candidate/03_visual-assets/001_asset
  -007755_hust-obc-und-X-006163_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1719/X_？_4051_1.png`
- asset id: `asset-007755`
...
- source class: `HUST-OBC/undeciphered/X/1719/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1719/X_？_4051_1.png`
- asset id: `asset-007755`
...
- Which source records identify obs-unk-006163 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006163？
