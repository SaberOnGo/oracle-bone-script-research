# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010715
...
- EVOBC candidate category: `evobc-evo-cat-10715`.
- Source label for search only: `齏`.
- Source codepoints for search only: `U+9F4F`.
