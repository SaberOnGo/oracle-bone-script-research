# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010485
...
- EVOBC candidate category: `evobc-evo-cat-10485`.
- Source label for search only: `鴔`.
- Source codepoints for search only: `U+9D14`.
