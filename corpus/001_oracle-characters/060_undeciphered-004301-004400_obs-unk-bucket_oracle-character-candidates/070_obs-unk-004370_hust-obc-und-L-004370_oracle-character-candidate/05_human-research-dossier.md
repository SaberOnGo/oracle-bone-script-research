# obs-unk-004370 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004370`
- primary external id: `hust-obc-und-L-004370`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/070_obs-unk-004370_h
  ust-obc-und-L-004370_oracle-character-candidate/03_visual-assets/001_asset
  -005963_hust-obc-und-L-004370_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4370/L_？_9698.jpg`
- asset id: `asset-005963`
...
- source class: `HUST-OBC/undeciphered/L/4370/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4370/L_？_9698.jpg`
- asset id: `asset-005963`
...
- English observation: `Upper right mark, central branches, and right`
  `descent recorded.`
- 中文观察: `已记录右上痕、中央分支和右侧下行痕。`
...
- Which source records identify obs-unk-004370 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004370？
