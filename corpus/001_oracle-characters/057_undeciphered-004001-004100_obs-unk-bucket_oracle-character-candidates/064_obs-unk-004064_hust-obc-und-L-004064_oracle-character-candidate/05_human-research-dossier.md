# obs-unk-004064 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004064`
- primary external id: `hust-obc-und-L-004064`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/064_obs-unk-004064_h
  ust-obc-und-L-004064_oracle-character-candidate/03_visual-assets/001_asset
  -005657_hust-obc-und-L-004064_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4064/L_？_8706.jpg`
- asset id: `asset-005657`
...
- source class: `HUST-OBC/undeciphered/L/4064/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4064/L_？_8706.jpg`
- asset id: `asset-005657`
...
- English observation: A short upper crossing of traces descends toward a
  broad lower rectangular or trapezoid-like contour. Its coarse arrangement
  appears visually similar to candidate 004058; no checksum or deduplication
...
- Which source records identify obs-unk-004064 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004064？
