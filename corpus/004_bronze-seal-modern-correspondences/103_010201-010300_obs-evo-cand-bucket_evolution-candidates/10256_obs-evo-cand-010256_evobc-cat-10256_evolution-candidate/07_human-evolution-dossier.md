...
- External category reference: `evobc-cat-10256`
- Source category ID: `10256`
- Source label for human review: `驘`
- Source codepoints: `U+9A58`
...
- `obs-evo-cand-010256-route-category-staging`
...
- `obs-evo-cand-010256-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010256-route-evolution-graph`
