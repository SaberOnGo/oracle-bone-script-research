...
Project ID: `obs-evo-cand-000360`
...
- Project ID: `obs-evo-cand-000360`
- EVOBC category candidate ID: `evobc-evo-cat-00360`
- External category reference: `evobc-cat-00360`
- Source category ID: `00360`
- Source label for human review: `䐄`
- Source codepoints: `U+4404`
...
- `obs-evo-cand-000360-route-category-staging`
...
- `obs-evo-cand-000360-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000360-route-evolution-graph`
