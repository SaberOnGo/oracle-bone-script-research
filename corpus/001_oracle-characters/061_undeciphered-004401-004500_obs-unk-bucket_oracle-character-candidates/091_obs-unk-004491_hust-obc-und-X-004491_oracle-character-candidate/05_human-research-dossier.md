# obs-unk-004491 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/091_obs-unk-004491_h
  ust-obc-und-X-004491_oracle-character-candidate/03_visual-assets/001_asset
  -006084_hust-obc-und-X-004491_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/47/X_？_7206_1.png`
- asset id: `asset-006084`
...
- source class: `HUST-OBC/undeciphered/X/47/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/47/X_？_7206_1.png`
- asset id: `asset-006084`
...
- English observation: `The left prongs, central junction, right branch, and two
  long diagonal traces are directly recorded.`
- 中文观察: `已直接记录左端尖突、中央交会、右侧分支和两条长斜向痕迹。`
...
- Which source records identify obs-unk-004491 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004491？
