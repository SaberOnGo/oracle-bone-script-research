# obs-char-000310 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/310_obs-char-000310_hust-obc-cat-0350_orac
  le-character/03_visual-assets/001_asset-000315_hust-obc-cat-0350_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0350/H_0350_603F2_0.png`
- asset id: `asset-000315`
...
- source category: `0350`
- validation class: `309`
- source image route: `HUST-OBC/deciphered/0350/H_0350_603F2_0.png`
- asset id: `asset-000315`
...
- English observation: `The image shows a large U-like curved stroke and a
  detached small angular mark near the upper right.`
- 中文观察: `图像有大型 U 形弧曲笔画，右上方另有分离的小型折角痕迹。`
...
- dataset label text: `㕔`
- dataset label codepoints: `U+3554`
...
- filename catalog route clues: `catalog-like filename clue: H_0350
  (H_0350_603F2_0.png)`
...
- Which source records identify obs-char-000310 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000310？
