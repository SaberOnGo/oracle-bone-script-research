# obs-unk-004904 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004904`
- primary external id: `hust-obc-und-X-004904`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/004_obs-unk-004904_h
  ust-obc-und-X-004904_oracle-character-candidate/03_visual-assets/001_asset
  -006497_hust-obc-und-X-004904_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/460/X_？_7126_1.png`
- asset id: `asset-006497`
...
- source class: `HUST-OBC/undeciphered/X/460/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/460/X_？_7126_1.png`
- asset id: `asset-006497`
...
- English observation: `dense upper group and overlapping lower strokes`
- 中文观察: `密集上部结构和重叠的下部笔画`
...
- Which source records identify obs-unk-004904 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004904？
