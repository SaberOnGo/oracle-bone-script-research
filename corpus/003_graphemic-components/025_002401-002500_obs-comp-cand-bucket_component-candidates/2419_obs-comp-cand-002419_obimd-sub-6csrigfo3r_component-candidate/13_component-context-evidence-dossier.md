# obs-comp-cand-002419 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002419`
- 首选外部 ID: `obimd-sub-6csrigfo3r`
- OBIMD subcharacter UID: `6csrigfo3r`
- OBIMD main character UID: `6csrigfo3r`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+C4965;U+FDCCC; U+FDCCD; 另有 2 项
