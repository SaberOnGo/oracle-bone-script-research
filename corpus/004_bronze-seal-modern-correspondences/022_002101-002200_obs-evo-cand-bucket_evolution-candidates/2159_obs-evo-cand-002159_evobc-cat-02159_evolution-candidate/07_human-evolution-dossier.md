...
Project ID: `obs-evo-cand-002159`
...
- Project ID: `obs-evo-cand-002159`
- EVOBC category candidate ID: `evobc-evo-cat-02159`
- External category reference: `evobc-cat-02159`
- Source category ID: `02159`
- Source label for human review: `娋`
- Source codepoints: `U+5A0B`
...
- `obs-evo-cand-002159-route-category-staging`
...
- `obs-evo-cand-002159-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002159-route-evolution-graph`
