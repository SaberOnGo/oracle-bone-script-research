...
- External category reference: `evobc-cat-09543`
- Source category ID: `09543`
- Source label for human review: `鑊`
- Source codepoints: `U+944A`
...
- `obs-evo-cand-009543-route-category-staging`
...
- `obs-evo-cand-009543-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009543-route-evolution-graph`
