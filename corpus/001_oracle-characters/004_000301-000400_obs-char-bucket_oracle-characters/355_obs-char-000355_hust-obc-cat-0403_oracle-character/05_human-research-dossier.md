# obs-char-000355 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/355_obs-char-000355_hust-obc-cat-0403_orac
  le-character/03_visual-assets/001_asset-000360_hust-obc-cat-0403_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0403/G_0403_乙906合13514組.png`
- asset id: `asset-000360`
...
- source category: `0403`
- validation class: `354`
- source image route: `HUST-OBC/deciphered/0403/G_0403_乙906合13514組.png`
- asset id: `asset-000360`
...
- English observation: `The image has a broad rounded lower enclosure, a
  central descending stroke, and short side strokes beneath a small upper
  bar.`
- 中文观察: `图像下部有宽圆弧闭合轮廓，中部有下行笔画，上方小横笔画下有短侧向痕迹。`
...
- dataset label text: `㖉`
- dataset label codepoints: `U+3589`
...
- filename catalog route clues: `Heji-like filename clue: 合13514
...
- Which source records identify obs-char-000355 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000355？
