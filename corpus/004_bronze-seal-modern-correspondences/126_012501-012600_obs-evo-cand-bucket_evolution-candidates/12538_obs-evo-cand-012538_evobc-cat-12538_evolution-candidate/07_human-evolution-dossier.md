...
- External category reference: `evobc-cat-12538`
- Source category ID: `12538`
- Source label for human review: `𨾷`
...
- `obs-evo-cand-012538-route-category-staging`
...
- `obs-evo-cand-012538-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012538-route-evolution-graph`
