...
- External category reference: `evobc-cat-06558`
- Source category ID: `06558`
- Source label for human review: `綮`
- Source codepoints: `U+7DAE`
...
- `obs-evo-cand-006558-route-category-staging`
...
- `obs-evo-cand-006558-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006558-route-evolution-graph`
