# obs-comp-cand-000862 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000862`
- 首选外部 ID: `obimd-sub-qeqvpjsnyn`
- OBIMD subcharacter UID: `qeqvpjsnyn`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+65E1;U+F4DFE; U+F4DFF
