# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006335
...
- EVOBC candidate category: `evobc-evo-cat-06335`.
- Source label for search only: `篼`.
- Source codepoints for search only: `U+7BFC`.
