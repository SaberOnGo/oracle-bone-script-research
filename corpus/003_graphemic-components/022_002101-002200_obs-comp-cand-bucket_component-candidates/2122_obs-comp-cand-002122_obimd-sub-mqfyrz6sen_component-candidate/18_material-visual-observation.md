# Material Visual Observation / obs-comp-cand-002122 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002122`
- External reference / 外部参照: `obimd-sub-mqfyrz6sen`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019679_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/mqfyrz6sen/mqfyrz6sen/mqfyrz6sen.png`
- Checksum / 校验和:
  `0b4cc1ccfffbc94db9b1629d8773971d16978a4a7ae997a9ea8a4b7b5112a252`
...
- Marked-pixel bounds: (73,35)–(166,212); span 94 × 178 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.54%。
- 痕迹范围：(73,35)–(166,212)；跨度94 × 178 px；痕迹矩形高于宽。
