# obs-char-000331 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000331`
- primary external id: `hust-obc-cat-0373`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/331_obs-char-000331_hust-obc-cat-0373_orac
  le-character/03_visual-assets/001_asset-000336_hust-obc-cat-0373_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0373/G_0373_前6.55.3合18650.png`
- asset id: `asset-000336`
...
- source category: `0373`
- validation class: `330`
- source image route: `HUST-OBC/deciphered/0373/G_0373_前6.55.3合18650.png`
- asset id: `asset-000336`
...
- English observation: `A central tall form with a pointed top is surrounded
  by four small detached rounded marks and a middle enclosure.`
- 中文观察: `中部高直形体顶部尖突，周围有四个分离的小型圆弧痕迹，中部另有闭合轮廓。`
...
- dataset label text: `㕫`
- dataset label codepoints: `U+356B`
...
- filename catalog route clues: `Heji-like filename clue: 合18650
...
- Which source records identify obs-char-000331 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000331？
