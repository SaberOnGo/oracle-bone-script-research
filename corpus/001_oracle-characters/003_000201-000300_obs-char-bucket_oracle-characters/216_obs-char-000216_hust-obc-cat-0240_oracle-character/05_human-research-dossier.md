# obs-char-000216 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/216_obs-char-000216_hust-obc-cat-0240_orac
  le-character/03_visual-assets/001_asset-000221_hust-obc-cat-0240_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0240/G_0240_甲骨文0.png`
- asset id: `asset-000221`
...
- source category: `0240`
- validation class: `215`
- source image route: `HUST-OBC/deciphered/0240/G_0240_甲骨文0.png`
- asset id: `asset-000221`
...
- English observation: `The image has a three-peaked upper cluster,
  horizontal internal bands, a compact lower block, and a separate curved
  stroke on the right.`
...
- dataset label text: `㓦`
- dataset label codepoints: `U+34E6`
...
- Which source records identify obs-char-000216 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000216？
