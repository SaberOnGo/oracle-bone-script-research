# obs-unk-000802 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/025_undeciphered-000
  801-000900_obs-unk-bucket_oracle-character-candidates/002_obs-unk-000802_h
  ust-obc-und-L-000802_oracle-character-candidate/03_visual-assets/001_asset
  -002395_hust-obc-und-L-000802_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/802/L_？_1233.jpg`
- asset id: `asset-002395`
...
- source class: `HUST-OBC/undeciphered/L/802/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/802/L_？_1233.jpg`
- asset id: `asset-002395`
...
- Which source records identify obs-unk-000802 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000802？
