...
Project ID: `obs-evo-cand-005698`
...
- Project ID: `obs-evo-cand-005698`
- EVOBC category candidate ID: `evobc-evo-cat-05698`
- External category reference: `evobc-cat-05698`
- Source category ID: `05698`
- Source label for human review: `癘`
- Source codepoints: `U+7658`
...
- `obs-evo-cand-005698-route-category-staging`
...
- `obs-evo-cand-005698-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005698-route-evolution-graph`
