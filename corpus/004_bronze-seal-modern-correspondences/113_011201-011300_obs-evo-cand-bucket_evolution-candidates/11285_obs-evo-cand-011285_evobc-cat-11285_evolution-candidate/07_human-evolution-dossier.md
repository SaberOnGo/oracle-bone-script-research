...
- External category reference: `evobc-cat-11285`
- Source category ID: `11285`
- Source label: `𢦚`
...
- `obs-evo-cand-011285-route-category-staging`
...
- `obs-evo-cand-011285-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011285-route-evolution-graph`
