...
- External category reference: `evobc-cat-10029`
- Source category ID: `10029`
- Source label for human review: `顡`
- Source codepoints: `U+9861`
...
- `obs-evo-cand-010029-route-category-staging`
...
- `obs-evo-cand-010029-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010029-route-evolution-graph`
