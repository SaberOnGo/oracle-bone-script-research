# obs-char-001356 Visual Gallery / obs-char-001356 图像资料页
...
- Project ID / 项目 ID: `obs-char-001356`
- Primary external reference / 首选外部参考: `hust-obc-cat-1513`
...
## obs-char-001356-visual-source-001 / 图像条目

![obs-char-001356 glyph candidate](03_visual-assets/001_asset-001361_hust-obc-cat-1513_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-001361_hust-obc-cat-1513_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-001361_hust-obc-cat-1513_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/1513/G_1513_甲骨文0.png`
