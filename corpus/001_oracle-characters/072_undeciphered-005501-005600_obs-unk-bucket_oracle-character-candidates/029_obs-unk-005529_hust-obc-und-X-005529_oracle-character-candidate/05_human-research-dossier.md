# obs-unk-005529 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005529`
- primary external id: `hust-obc-und-X-005529`
...
- local review image route: `corpus/001_oracle-characters/072_undeciphered-005
  501-005600_obs-unk-bucket_oracle-character-candidates/029_obs-unk-005529_h
  ust-obc-und-X-005529_oracle-character-candidate/03_visual-assets/001_asset
  -007122_hust-obc-und-X-005529_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1085/X_？_8045_1.png`
- asset id: `asset-007122`
...
- source class: `HUST-OBC/undeciphered/X/1085/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1085/X_？_8045_1.png`
- asset id: `asset-007122`
...
- Which source records identify obs-unk-005529 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005529？
