...
- `obs-evo-cand-000493-route-category-staging`
...
- `obs-evo-cand-000493-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000493-route-evolution-graph`
