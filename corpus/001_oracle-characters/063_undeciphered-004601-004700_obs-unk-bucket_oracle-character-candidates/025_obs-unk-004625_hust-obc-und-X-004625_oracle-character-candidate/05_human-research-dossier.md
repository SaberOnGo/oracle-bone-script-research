# obs-unk-004625 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/025_obs-unk-004625_h
  ust-obc-und-X-004625_oracle-character-candidate/03_visual-assets/001_asset
  -006218_hust-obc-und-X-004625_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/181/X_？_8355_1.png`
- asset id: `asset-006218`
...
- source class: `HUST-OBC/undeciphered/X/181/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/181/X_？_8355_1.png`
- asset id: `asset-006218`
...
- English observation: `upper arch, lower enclosure, left detached dots`
- 中文观察: `上部弧形、下部小框和左侧分离点痕已记录。`
...
- Which source records identify obs-unk-004625 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004625？
