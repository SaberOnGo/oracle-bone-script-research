...
- Project ID: `obs-evo-cand-010281`
- EVOBC category candidate ID: `evobc-evo-cat-10281`
- External category reference: `evobc-cat-10281`
- Source category ID: `10281`
- Source label for human review: `骄`
- Source codepoints: `U+9A84`
...
- `obs-evo-cand-010281-route-category-staging`
...
- `obs-evo-cand-010281-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010281-route-evolution-graph`
