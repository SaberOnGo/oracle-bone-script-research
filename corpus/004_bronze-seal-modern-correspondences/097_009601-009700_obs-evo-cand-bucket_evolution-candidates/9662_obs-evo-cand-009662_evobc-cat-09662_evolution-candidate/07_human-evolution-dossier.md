...
- External category reference: `evobc-cat-09662`
- Source category ID: `09662`
- Source label for human review: `闛`
- Source codepoints: `U+95DB`
...
- `obs-evo-cand-009662-route-category-staging`
...
- `obs-evo-cand-009662-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009662-route-evolution-graph`
