...
Project ID: `obs-insc-cw-cand-000202`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000202`
...
- Period label: `I`
- Classification group: `16`
- Declared group count: `18`
...
- Source page section: `Period I Group 16` /
  `第 I 期第 16 组`
- Source section key: `period-i-group-16`
- Section declared count: `18`
- Section observed row count: `18`
...
- Yingguo / 英国所藏: `y1187` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `122` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `501` in source row; primary catalog entry pending
- Heji / 合集: `39716` in source row; primary catalog entry pending
...
- Group and batch / 组类与批次: group `16`; batch or pit context pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000202`
