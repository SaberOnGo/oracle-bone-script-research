# Material Visual Observation / obs-comp-cand-002564 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002564`
- External reference / 外部参照: `obimd-sub-gcbnox9x1n`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021096_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gcbnox9x1n/gcbnox9x1n/gcbnox9x1n.png`
- Checksum / 校验和:
  `722e0d854f26adc1573b70f6e3dee88b8d29a008ab9f0829c3d5cdaf6c271048`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 14.09%.
- Marked-pixel bounds: (64,18)–(173,231); span 110 × 214 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占14.09%。
- 痕迹范围：(64,18)–(173,231)；跨度110 × 214 px；痕迹矩形高于宽。
