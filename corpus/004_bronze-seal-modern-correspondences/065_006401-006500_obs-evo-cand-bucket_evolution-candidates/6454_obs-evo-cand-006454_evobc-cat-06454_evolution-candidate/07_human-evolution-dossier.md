...
Project ID: `obs-evo-cand-006454`
...
- Project ID: `obs-evo-cand-006454`
- EVOBC category candidate ID: `evobc-evo-cat-06454`
- External category reference: `evobc-cat-06454`
- Source category ID: `06454`
- Source label for human review: `紑`
- Source codepoints: `U+7D11`
...
- `obs-evo-cand-006454-route-category-staging`
...
- `obs-evo-cand-006454-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006454-route-evolution-graph`
