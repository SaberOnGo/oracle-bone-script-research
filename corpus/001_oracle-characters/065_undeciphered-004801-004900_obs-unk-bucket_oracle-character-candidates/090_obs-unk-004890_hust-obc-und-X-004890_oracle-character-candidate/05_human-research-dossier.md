# obs-unk-004890 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004890`
- primary external id: `hust-obc-und-X-004890`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/090_obs-unk-004890_h
  ust-obc-und-X-004890_oracle-character-candidate/03_visual-assets/001_asset
  -006483_hust-obc-und-X-004890_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/446/X_？_7428_1.png`
- asset id: `asset-006483`
...
- source class: `HUST-OBC/undeciphered/X/446/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/446/X_？_7428_1.png`
- asset id: `asset-006483`
...
- English observation: `diamond-like upper outline and lower U-like group`
- 中文观察: `菱形上部外框和下部 U 形结构`
...
- Which source records identify obs-unk-004890 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004890？
