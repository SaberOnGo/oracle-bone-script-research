...
Project ID: `obs-evo-cand-001832`
...
- Project ID: `obs-evo-cand-001832`
- EVOBC category candidate ID: `evobc-evo-cat-01832`
- External category reference: `evobc-cat-01832`
- Source category ID: `01832`
- Source label for human review: `坱`
- Source codepoints: `U+5771`
...
- `obs-evo-cand-001832-route-category-staging`
...
- `obs-evo-cand-001832-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001832-route-evolution-graph`
