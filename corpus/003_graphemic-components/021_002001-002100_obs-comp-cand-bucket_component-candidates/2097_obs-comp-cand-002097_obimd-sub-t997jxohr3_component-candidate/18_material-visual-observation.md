# Material Visual Observation / obs-comp-cand-002097 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002097`
- External reference / 外部参照: `obimd-sub-t997jxohr3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019543_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/t997jxohr3/t997jxohr3/t997jxohr3.png`
- Checksum / 校验和:
  `c995aeafa92a11f1762d9313d1b2ab7d2bfa90d9b2faf7ef8c8e92463a2d63e5`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.33%.
- Marked-pixel bounds: (52,35)–(193,201); span 142 × 167 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.33%。
- 痕迹范围：(52,35)–(193,201)；跨度142 × 167 px；痕迹矩形近方形。
