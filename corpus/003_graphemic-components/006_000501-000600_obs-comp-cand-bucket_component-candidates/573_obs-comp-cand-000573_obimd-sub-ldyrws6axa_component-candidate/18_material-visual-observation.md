# Material Visual Observation / obs-comp-cand-000573 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000573`
- External reference / 外部参照: `obimd-sub-ldyrws6axa`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012825_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/v8blfuvx4g/ldyrws6axa/ldyrws6axa.png`
- Checksum / 校验和:
  `f514e1adb1cb894a55e08a6c51de80c0ea2fc31985e733ea90dd58a29035968f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.47%.
- Marked-pixel bounds: (65,45)–(184,201); span 120 × 157 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.47%。
- 痕迹范围：(65,45)–(184,201)；跨度120 × 157 px；痕迹矩形高于宽。
