# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001281
...
- EVOBC candidate category: `evobc-evo-cat-01281`.
- Source label for search only: `劾`.
- Source codepoints for search only: `U+52BE`.
