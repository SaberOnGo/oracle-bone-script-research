...
Project ID: `obs-evo-cand-013673`
...
- Project ID: `obs-evo-cand-013673`
- EVOBC category candidate ID: `evobc-evo-cat-13673`
- External category reference: `evobc-cat-13673`
- Source category ID: `13673`
- Source label for human review: `𮥕`
- Source codepoints: `U+2E955`
...
- `obs-evo-cand-013673-route-category-staging`
...
- `obs-evo-cand-013673-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013673-route-evolution-graph`
