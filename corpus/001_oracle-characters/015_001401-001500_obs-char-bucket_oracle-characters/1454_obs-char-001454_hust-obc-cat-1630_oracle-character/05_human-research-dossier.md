# obs-char-001454 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001454`
- primary external id: `hust-obc-cat-1630`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1454_obs-char-001454_hust-obc-cat-1630_ora
  cle-character/03_visual-assets/001_asset-001459_hust-obc-cat-1630_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1630/G_1630_乙2957反合9810反賓組.png`
- asset id: `asset-001459`
...
- source category: `1630`
- validation class: `1453`
- source image route: `HUST-OBC/deciphered/1630/G_1630_乙2957反合9810反賓組.png`
- asset id: `asset-001459`
...
- English observation: `An open upper cluster sits above a small rectangular
  lower enclosure.`
- 中文观察: `开放上部笔画群位于小型下部矩形框形之上。`
...
- dataset label text: `㩔`
- dataset label codepoints: `U+3A54`
...
- filename catalog route clues: `Heji-like filename clue: 合9810
  (G_1630_乙2957反合9810反賓組.png)`
...
- Which source records identify obs-char-001454 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001454？
