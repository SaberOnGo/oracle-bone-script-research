...
Project ID: `obs-insc-cw-cand-000107`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000107`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000107` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y602` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `113` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `685` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `39930` [route_present_image_or_text_not_collected]
