...
- External category reference: `evobc-cat-05643`
- Source category ID: `05643`
- Source label for human review: `痙`
- Source codepoints: `U+75D9`
...
- `obs-evo-cand-005643-route-category-staging`
...
- `obs-evo-cand-005643-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005643-route-evolution-graph`
