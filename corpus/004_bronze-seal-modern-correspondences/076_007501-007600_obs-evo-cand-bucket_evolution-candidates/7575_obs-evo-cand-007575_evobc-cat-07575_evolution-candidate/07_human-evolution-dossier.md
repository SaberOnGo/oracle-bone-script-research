...
Project ID: `obs-evo-cand-007575`
...
- Project ID: `obs-evo-cand-007575`
- EVOBC category candidate ID: `evobc-evo-cat-07575`
- External category reference: `evobc-cat-07575`
- Source category ID: `07575`
- Source label for human review: `蕃`
- Source codepoints: `U+8543`
...
- `obs-evo-cand-007575-route-category-staging`
...
- `obs-evo-cand-007575-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007575-route-evolution-graph`
