...
- External category reference: `evobc-cat-07062`
- Source category ID: `07062`
- Source label for human review: `脘`
- Source codepoints: `U+8118`
...
- `obs-evo-cand-007062-route-category-staging`
...
- `obs-evo-cand-007062-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007062-route-evolution-graph`
