# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013217
...
- EVOBC candidate category: `evobc-evo-cat-13217`.
- Source label for search only: `𬆬`.
- Source codepoints for search only: `U+2C1AC`.
