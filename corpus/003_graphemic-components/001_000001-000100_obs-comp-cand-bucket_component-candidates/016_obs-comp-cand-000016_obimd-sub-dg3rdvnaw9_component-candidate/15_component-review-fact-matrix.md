# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000016
...
| Glyph or codepoint route / 字形或码位路线 | 21 OBIMD route rows; examples U+F0169; U+F016A; 另有 19 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 21 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
