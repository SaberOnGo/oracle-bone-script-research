...
- External category reference: `evobc-cat-06495`
- Source category ID: `06495`
- Source label for human review: `絈`
- Source codepoints: `U+7D48`
...
- `obs-evo-cand-006495-route-category-staging`
...
- `obs-evo-cand-006495-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006495-route-evolution-graph`
