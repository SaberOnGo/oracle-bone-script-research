# Material Visual Observation / obs-comp-cand-000331 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000331`
- External reference / 外部参照: `obimd-sub-z5hsbrw198`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012255_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/z5hsbrw198/z5hsbrw198/z5hsbrw198.png`
- Checksum / 校验和:
  `fafdf8342cf8752ce1f0a6fa822f3d532cc1e4075b302d2dc6a94bf21486ff79`
...
- Marked-pixel bounds: (52,30)–(197,214); span 146 × 185 px; the marked
...
- 痕迹范围：(52,30)–(197,214)；跨度146 × 185 px；痕迹矩形高于宽。
