# obs-comp-cand-001804 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001804`
- 首选外部 ID: `obimd-sub-tvnicmgqzf`
- OBIMD subcharacter UID: `tvnicmgqzf`
- OBIMD main character UID: `tvnicmgqzf`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `6`
- codepoint 示例: U+9B3C;U+FA568; U+FA569; 另有 4 项
