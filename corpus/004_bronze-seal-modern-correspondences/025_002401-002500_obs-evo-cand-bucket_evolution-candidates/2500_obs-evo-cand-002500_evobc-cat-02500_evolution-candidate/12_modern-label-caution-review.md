# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002500
...
- EVOBC candidate category: `evobc-evo-cat-02500`.
- Source label for search only: `届`.
- Source codepoints for search only: `U+5C4A`.
