...
- External category reference: `evobc-cat-04506`
- Source category ID: `04506`
- Source label for human review: `汥`
- Source codepoints: `U+6C65`
...
- `obs-evo-cand-004506-route-category-staging`
...
- `obs-evo-cand-004506-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004506-route-evolution-graph`
