# obs-unk-004312 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004312`
- primary external id: `hust-obc-und-L-004312`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/012_obs-unk-004312_h
  ust-obc-und-L-004312_oracle-character-candidate/03_visual-assets/001_asset
  -005905_hust-obc-und-L-004312_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4312/L_？_951.jpg`
- asset id: `asset-005905`
...
- source class: `HUST-OBC/undeciphered/L/4312/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4312/L_？_951.jpg`
- asset id: `asset-005905`
...
- English observation: `Upper bend, long diagonal, lower bar visible.`
- 中文观察: `上部折弯、长斜痕和下部长横痕可见。`
...
- Which source records identify obs-unk-004312 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004312？
