# obs-unk-006447 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006447`
- primary external id: `hust-obc-und-X-006447`
...
- local review image route: `corpus/001_oracle-characters/081_undeciphered-006
  401-006500_obs-unk-bucket_oracle-character-candidates/047_obs-unk-006447_h
  ust-obc-und-X-006447_oracle-character-candidate/03_visual-assets/001_asset
  -008038_hust-obc-und-X-006447_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2003/X_？_564_1.png`
- asset id: `asset-008038`
...
- source class: `HUST-OBC/undeciphered/X/2003/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2003/X_？_564_1.png`
- asset id: `asset-008038`
...
- Which source records identify obs-unk-006447 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006447？
