...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0198`
...
- Source image / 来源图: `X_0198_3694_1.png`
- Image / 图像: `001_asset-000184_hust-obc-cat-0198_glyph.png`
...
- target node: `evobc-evo-cat-00018`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC image references / EvoBC 图像引用数: `9`
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/018_obs-evo-cand-000018_evobc-cat-00018_evoluti
...
- Source label text / 来源标签文字: `㒼`
- Source label codepoint / 来源标签 codepoint: `U+34BC`
