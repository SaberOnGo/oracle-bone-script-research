...
- External category reference: `evobc-cat-05978`
- Source category ID: `05978`
- Source label for human review: `祋`
- Source codepoints: `U+794B`
...
- `obs-evo-cand-005978-route-category-staging`
...
- `obs-evo-cand-005978-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005978-route-evolution-graph`
