# obs-char-001061 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001061`
- primary external id: `hust-obc-cat-1188`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1061_obs-char-001061_hust-obc-cat-1188_ora
  cle-character/03_visual-assets/001_asset-001066_hust-obc-cat-1188_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1188/G_1188_存194合18156.png`
- asset id: `asset-001066`
...
- source category: `1188`
- validation class: `1060`
- source image route: `HUST-OBC/deciphered/1188/G_1188_存194合18156.png`
- asset id: `asset-001066`
...
- English observation: `A narrow dark branching cluster has several pointed
  upper projections, a central upright, and split lower strokes.`
- 中文观察: `狭长深色分枝笔群有数条尖状上部外伸、中央直立笔和分开的下部笔。`
...
- dataset label text: `㢚`
- dataset label codepoints: `U+389A`
...
- filename catalog route clues: `Heji-like filename clue: 合18156
...
- Which source records identify obs-char-001061 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001061？
