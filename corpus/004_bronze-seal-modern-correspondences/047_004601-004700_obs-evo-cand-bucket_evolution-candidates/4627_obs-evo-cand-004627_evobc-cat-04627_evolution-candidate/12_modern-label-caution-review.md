# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004627
...
- EVOBC candidate category: `evobc-evo-cat-04627`.
- Source label for search only: `洝`.
- Source codepoints for search only: `U+6D1D`.
