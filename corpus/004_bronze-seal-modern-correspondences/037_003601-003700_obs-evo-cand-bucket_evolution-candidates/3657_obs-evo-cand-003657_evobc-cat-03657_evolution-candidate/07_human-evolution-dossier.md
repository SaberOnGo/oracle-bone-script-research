...
- External category reference: `evobc-cat-03657`
- Source category ID: `03657`
- Source label for human review: `方`
- Source codepoints: `U+65B9`
- Image reference count in source metadata: `280`
...
- `obs-evo-cand-003657-route-category-staging`
...
- `obs-evo-cand-003657-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003657-route-evolution-graph`
