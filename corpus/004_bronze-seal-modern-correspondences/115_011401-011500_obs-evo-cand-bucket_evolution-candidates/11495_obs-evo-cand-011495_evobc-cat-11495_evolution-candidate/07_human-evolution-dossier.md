...
- Project ID: `obs-evo-cand-011495`
- EVOBC category candidate ID: `evobc-evo-cat-11495`
- External category reference: `evobc-cat-11495`
- Source category ID: `11495`
- Source label for human review: `𣫍`
- Source codepoints: `U+23ACD`
...
- `obs-evo-cand-011495-route-category-staging`
...
- `obs-evo-cand-011495-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011495-route-evolution-graph`
