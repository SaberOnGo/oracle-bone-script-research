# Material Visual Observation / obs-comp-cand-001320 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001320`
- External reference / 外部参照: `obimd-sub-ra331b8ndl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015657_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4y18ww0a1m/ra331b8ndl/ra331b8ndl.png`
- Checksum / 校验和:
  `a8aa8ec85cd13fe4401d3a423ea7f6259ffda7363d21d7b92877498010b96129`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.32%.
- Marked-pixel bounds: (88,25)–(161,225); span 74 × 201 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.32%。
- 痕迹范围：(88,25)–(161,225)；跨度74 × 201 px；痕迹矩形高于宽。
