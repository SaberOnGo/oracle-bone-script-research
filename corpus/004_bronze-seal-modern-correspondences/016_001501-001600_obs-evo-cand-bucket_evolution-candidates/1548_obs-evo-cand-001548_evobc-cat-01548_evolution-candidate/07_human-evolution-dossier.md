...
Project ID: `obs-evo-cand-001548`
...
- Project ID: `obs-evo-cand-001548`
- EVOBC category candidate ID: `evobc-evo-cat-01548`
- External category reference: `evobc-cat-01548`
- Source category ID: `01548`
- Source label for human review: `呻`
- Source codepoints: `U+547B`
...
- `obs-evo-cand-001548-route-category-staging`
...
- `obs-evo-cand-001548-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001548-route-evolution-graph`
