# obs-unk-004016 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/016_obs-unk-004016_h
  ust-obc-und-L-004016_oracle-character-candidate/03_visual-assets/001_asset
  -005609_hust-obc-und-L-004016_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4016/L_？_8542.jpg`
- asset id: `asset-005609`
...
- source class: `HUST-OBC/undeciphered/L/4016/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4016/L_？_8542.jpg`
- asset id: `asset-005609`
...
- English observation: l area.
A pointed triangular or chevron-like trace is near the
  upper center, with a narrow vertical trace below it. A separate wavy
- 中文观察：上部中央有尖顶的三角或折角状痕迹，下方接近中央处有一条窄直痕；下缘有独立的波曲状痕迹，中央
  周围还可见少量分离痕迹。
...
- Which source records identify obs-unk-004016 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004016？
