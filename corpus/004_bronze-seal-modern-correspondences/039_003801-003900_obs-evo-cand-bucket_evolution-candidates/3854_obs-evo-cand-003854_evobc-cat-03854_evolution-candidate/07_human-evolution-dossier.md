...
Project ID: `obs-evo-cand-003854`
...
- Project ID: `obs-evo-cand-003854`
- EVOBC category candidate ID: `evobc-evo-cat-03854`
- External category reference: `evobc-cat-03854`
- Source category ID: `03854`
- Source label for human review: `朱`
- Source codepoints: `U+6731`
...
- `obs-evo-cand-003854-route-category-staging`
...
- `obs-evo-cand-003854-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003854-route-evolution-graph`
