...
- External category reference: `evobc-cat-12295`
- Source category ID: `12295`
- Source label for human review: `𧺹`
- Source codepoints: `U+27EB9`
...
- `obs-evo-cand-012295-route-category-staging`
...
- `obs-evo-cand-012295-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012295-route-evolution-graph`
