...
- External category reference: `evobc-cat-06648`
- Source category ID: `06648`
- Source label for human review: `縱`
...
- `obs-evo-cand-006648-route-category-staging`
...
- `obs-evo-cand-006648-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006648-route-evolution-graph`
