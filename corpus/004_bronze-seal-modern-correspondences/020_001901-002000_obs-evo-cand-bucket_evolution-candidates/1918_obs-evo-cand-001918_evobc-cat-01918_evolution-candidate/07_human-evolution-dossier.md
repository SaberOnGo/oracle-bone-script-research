...
- External category reference: `evobc-cat-01918`
- Source category ID: `01918`
- Source label for human review: `塓`
...
- `obs-evo-cand-001918-route-category-staging`
...
- `obs-evo-cand-001918-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001918-route-evolution-graph`
