...
- External category reference: `evobc-cat-00112`
- Source category ID: `00112`
- Source label for human review: `㣼`
...
- `obs-evo-cand-000112-route-category-staging`
...
- `obs-evo-cand-000112-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000112-route-evolution-graph`
