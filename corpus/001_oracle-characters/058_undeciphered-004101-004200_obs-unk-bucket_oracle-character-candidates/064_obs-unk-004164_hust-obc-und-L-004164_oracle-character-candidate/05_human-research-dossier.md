# obs-unk-004164 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004164`
- primary external id: `hust-obc-und-L-004164`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/064_obs-unk-004164_h
  ust-obc-und-L-004164_oracle-character-candidate/03_visual-assets/001_asset
  -005757_hust-obc-und-L-004164_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4164/L_？_9024.jpg`
- asset id: `asset-005757`
...
- source class: `HUST-OBC/undeciphered/L/4164/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4164/L_？_9024.jpg`
- asset id: `asset-005757`
...
- English observation: A long upright axis crosses a short upper stroke and a
  small lower-left angular mark.
- 中文观察: 长直立轴线穿过上部短笔画，左下有小型折角痕迹。
...
- Which source records identify obs-unk-004164 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004164？
