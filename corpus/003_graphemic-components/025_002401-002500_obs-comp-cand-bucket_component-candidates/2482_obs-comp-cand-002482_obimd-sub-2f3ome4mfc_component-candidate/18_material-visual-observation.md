# Material Visual Observation / obs-comp-cand-002482 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002482`
- External reference / 外部参照: `obimd-sub-2f3ome4mfc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020670_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lvakruz2kz/2f3ome4mfc/2f3ome4mfc.png`
- Checksum / 校验和:
  `3ae1df627ebbbbe199cf9839db8948bd7bfe37b9517fece5daeac92ff4ebf2bf`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.86%.
- Marked-pixel bounds: (56,49)–(193,205); span 138 × 157 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.86%。
- 痕迹范围：(56,49)–(193,205)；跨度138 × 157 px；痕迹矩形近方形。
