...
Project ID: `obs-evo-cand-005530`
...
- Project ID: `obs-evo-cand-005530`
- EVOBC category candidate ID: `evobc-evo-cat-05530`
- External category reference: `evobc-cat-05530`
- Source category ID: `05530`
- Source label for human review: `甚`
- Source codepoints: `U+751A`
- Image reference count in source metadata: `67`
...
- `obs-evo-cand-005530-route-category-staging`
...
- `obs-evo-cand-005530-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005530-route-evolution-graph`
