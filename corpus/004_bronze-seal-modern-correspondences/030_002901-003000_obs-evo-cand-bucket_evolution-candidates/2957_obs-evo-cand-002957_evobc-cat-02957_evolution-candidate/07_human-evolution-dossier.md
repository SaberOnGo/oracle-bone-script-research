...
Project ID: `obs-evo-cand-002957`
...
- Project ID: `obs-evo-cand-002957`
- EVOBC category candidate ID: `evobc-evo-cat-02957`
- External category reference: `evobc-cat-02957`
- Source category ID: `02957`
- Source label for human review: `怳`
- Source codepoints: `U+6033`
...
- `obs-evo-cand-002957-route-category-staging`
...
- `obs-evo-cand-002957-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002957-route-evolution-graph`
