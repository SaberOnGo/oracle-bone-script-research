# obs-char-000068 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000068`
- primary external id: `hust-obc-cat-0078`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/068_obs-char-000068_hust-obc-cat-0078_orac
  le-character/03_visual-assets/001_asset-000073_hust-obc-cat-0078_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0078/L_0078_7727.jpg`
- asset id: `asset-000073`
...
- source category: `0078`
- validation class: `67`
- source image route: `HUST-OBC/deciphered/0078/L_0078_7727.jpg`
- asset id: `asset-000073`
...
- English observation: `The small gray image has a tall rectangular outer
  frame, curved interior marks, and three short lower projections.`
- 中文观察: `小型灰度图像有高长方形外框、内部弯曲痕迹和三条短下伸笔画。`
...
- dataset label text: `㑄`
- dataset label codepoints: `U+3444`
...
- Which source records identify obs-char-000068 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000068？
