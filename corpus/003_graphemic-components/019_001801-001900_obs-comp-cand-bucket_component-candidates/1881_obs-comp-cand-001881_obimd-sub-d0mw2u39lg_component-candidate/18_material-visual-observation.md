# Material Visual Observation / obs-comp-cand-001881 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001881`
- External reference / 外部参照: `obimd-sub-d0mw2u39lg`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018260_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/d0mw2u39lg/d0mw2u39lg/d0mw2u39lg.png`
- Checksum / 校验和:
  `9ea24276d5ceff9c8d341ac8be8456c562887d7cc4a7def468021942d6241b49`
...
- Marked-pixel bounds: (64,22)–(189,232); span 126 × 211 px; the marked
...
- 痕迹范围：(64,22)–(189,232)；跨度126 × 211 px；痕迹矩形高于宽。
