# obs-unk-003261 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/049_undeciphered-003
  201-003300_obs-unk-bucket_oracle-character-candidates/061_obs-unk-003261_h
  ust-obc-und-L-003261_oracle-character-candidate/03_visual-assets/001_asset
  -004854_hust-obc-und-L-003261_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3261/L_？_6158.jpg`
- asset id: `asset-004854`
...
- source class: `HUST-OBC/undeciphered/L/3261/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3261/L_？_6158.jpg`
- asset id: `asset-004854`
...
- Which source records identify obs-unk-003261 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003261？
