...
- External category reference: `evobc-cat-05589`
- Source category ID: `05589`
- Source label for human review: `畺`
- Source codepoints: `U+757A`
...
- `obs-evo-cand-005589-route-category-staging`
...
- `obs-evo-cand-005589-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005589-route-evolution-graph`
