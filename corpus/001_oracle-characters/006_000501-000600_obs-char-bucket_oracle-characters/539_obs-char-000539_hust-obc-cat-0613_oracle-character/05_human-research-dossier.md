# obs-char-000539 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000539`
- primary external id: `hust-obc-cat-0613`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/539_obs-char-000539_hust-obc-cat-0613_orac
  le-character/03_visual-assets/001_asset-000544_hust-obc-cat-0613_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0613/G_0613_存2225(甲).png`
- asset id: `asset-000544`
...
- source category: `0613`
- validation class: `538`
- source image route: `HUST-OBC/deciphered/0613/G_0613_存2225(甲).png`
- asset id: `asset-000544`
...
- English observation: `A thin central branching stroke forks near the top
  and crosses a leftward diagonal; three separate lower vertical marks and
  one right-side dash remain detached.`
- 中文观察: `纤细中央分支笔近顶部叉开并与左向斜笔交叉，下方三条竖痕和右侧一短痕彼此分离。`
...
- dataset label text: `㙛`
- dataset label codepoints: `U+365B`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00041`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00041`
- EvoBC image reference count / EvoBC 图像引用数: `3`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00041`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/041_obs-evo-can
  d-000041_evobc-cat-00041_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/041_obs-evo-cand-000041_evobc-cat-00041_evolu
...
- Which source records identify obs-char-000539 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000539？
