# obs-unk-004524 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/024_obs-unk-004524_h
  ust-obc-und-X-004524_oracle-character-candidate/03_visual-assets/001_asset
  -006117_hust-obc-und-X-004524_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/80/X_？_7209_1.png`
- asset id: `asset-006117`
...
- source class: `HUST-OBC/undeciphered/X/80/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/80/X_？_7209_1.png`
- asset id: `asset-006117`
...
- English observation: `The two linked groups, central opening, descenders, side
  branch, and image-count discrepancy are directly recorded.`
- 中文观察: `已直接记录两组连接痕、中央空隙、下伸痕、侧分支和数量差异。`
...
- Which source records identify obs-unk-004524 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004524？
