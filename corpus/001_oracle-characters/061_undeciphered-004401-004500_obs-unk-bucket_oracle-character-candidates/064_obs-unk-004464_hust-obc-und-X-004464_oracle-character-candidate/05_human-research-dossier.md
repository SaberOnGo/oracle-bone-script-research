# obs-unk-004464 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/064_obs-unk-004464_h
  ust-obc-und-X-004464_oracle-character-candidate/03_visual-assets/001_asset
  -006057_hust-obc-und-X-004464_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/20/X_？_8199_1.png`
- asset id: `asset-006057`
...
- source class: `HUST-OBC/undeciphered/X/20/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/20/X_？_8199_1.png`
- asset id: `asset-006057`
...
- English observation: Two adjacent mark groups show enclosed openings,
  divergent lower terminals, and a framed right-hand section.
- 中文观察: 两组相邻痕迹含封闭开口、分开的左侧下端和框状右侧部分。
...
- Which source records identify obs-unk-004464 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004464？
