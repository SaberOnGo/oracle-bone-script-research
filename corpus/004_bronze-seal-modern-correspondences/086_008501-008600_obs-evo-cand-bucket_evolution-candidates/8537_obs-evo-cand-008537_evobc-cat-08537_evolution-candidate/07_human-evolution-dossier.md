...
- External category reference: `evobc-cat-08537`
- Source category ID: `08537`
- Source label for human review: `貢`
...
- `obs-evo-cand-008537-route-category-staging`
...
- `obs-evo-cand-008537-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008537-route-evolution-graph`
