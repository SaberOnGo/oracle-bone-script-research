...
- Project ID: `obs-evo-cand-004315`
- EVOBC category candidate ID: `evobc-evo-cat-04315`
- External category reference: `evobc-cat-04315`
- Source category ID: `04315`
- Source label for human review: `櫜`
- Source codepoints: `U+6ADC`
...
- `obs-evo-cand-004315-route-category-staging`
...
- `obs-evo-cand-004315-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004315-route-evolution-graph`
