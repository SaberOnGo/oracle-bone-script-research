# Material Visual Observation / obs-comp-cand-002161 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002161`
- External reference / 外部参照: `obimd-sub-dm48ktdqz2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019834_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/u3lh7tekno/dm48ktdqz2/az1hu4ste7.png`
- Checksum / 校验和:
  `e88dac043f5ccd6436d0f6cfdaef245e88d070cbc6cfdca23df63c2d243463f1`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.44%.
- Marked-pixel bounds: (92,26)–(157,217); span 66 × 192 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.44%。
- 痕迹范围：(92,26)–(157,217)；跨度66 × 192 px；痕迹矩形高于宽。
