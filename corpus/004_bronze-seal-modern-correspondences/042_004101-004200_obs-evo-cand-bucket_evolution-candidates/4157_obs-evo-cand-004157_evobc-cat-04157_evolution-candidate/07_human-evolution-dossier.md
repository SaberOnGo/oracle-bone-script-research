...
- External category reference: `evobc-cat-04157`
- Source category ID: `04157`
- Source label for human review: `楞`
- Source codepoints: `U+695E`
...
- `obs-evo-cand-004157-route-category-staging`
...
- `obs-evo-cand-004157-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004157-route-evolution-graph`
