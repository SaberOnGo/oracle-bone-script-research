# obs-evo-cand-006220 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-06220`
- Source label for human review: `竺`
- Source codepoints: `U+7AFA`
- Image reference count: `40`
- Era token counts: `SAC:2;SS:1;WSC:37`
- Source token counts: `Book:31;Web:9`
