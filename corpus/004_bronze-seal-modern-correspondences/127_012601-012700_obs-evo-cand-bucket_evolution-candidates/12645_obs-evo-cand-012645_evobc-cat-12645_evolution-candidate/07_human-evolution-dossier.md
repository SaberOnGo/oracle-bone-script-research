...
- External category reference: `evobc-cat-12645`
- Source category ID: `12645`
- Source label for human review: `𩠡`
- Source codepoints: `U+29821`
...
- `obs-evo-cand-012645-route-category-staging`
...
- `obs-evo-cand-012645-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012645-route-evolution-graph`
