# obs-evo-cand-003837 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-003837`
- EVOBC category candidate ID: `evobc-evo-cat-03837`
- External category ref: `evobc-cat-03837`
- Source label: `朕`
- Source codepoints: `U+6715`
- Image reference count: `318`
- Era token counts: `BI:212;OBC:79;SAC:13;SS:1;WSC:13`
- Source token counts: `Book:196;Web:122`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 79 image references
- era 1 / BI: 212 image references
- era 2 / SS: 1 image references
- era 3 / SAC: 13 image references
...
- source 3 / Book:21681: 141 image references
- source 4 / Book:9131: 13 image references
