...
- External category reference: `evobc-cat-04125`
- Source category ID: `04125`
- Source label for human review: `椓`
...
- `obs-evo-cand-004125-route-category-staging`
...
- `obs-evo-cand-004125-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004125-route-evolution-graph`
