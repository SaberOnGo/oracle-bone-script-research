# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000842
...
- EVOBC candidate category: `evobc-evo-cat-00842`.
- Source label for search only: `侍`.
- Source codepoints for search only: `U+4F8D`.
