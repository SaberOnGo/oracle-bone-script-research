# Material Visual Observation / obs-comp-cand-000529 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000529`
- External reference / 外部参照: `obimd-sub-7yjwgquvai`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012763_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0ln5rvbsug/7yjwgquvai/7yjwgquvai.png`
- Checksum / 校验和:
  `3293aa27ecceac1c94dcd6c672e9964d994bf9e6f8c1007998935f53226cc0b1`
...
- Marked-pixel bounds: (57,39)–(192,209); span 136 × 171 px; the marked
...
- 痕迹范围：(57,39)–(192,209)；跨度136 × 171 px；痕迹矩形高于宽。
