...
- External category reference: `evobc-cat-08758`
- Source category ID: `08758`
- Source label for human review: `蹐`
- Source codepoints: `U+8E50`
...
- `obs-evo-cand-008758-route-category-staging`
...
- `obs-evo-cand-008758-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008758-route-evolution-graph`
