# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002319
...
| --- | --- | --- | --- |
| `obimd-glyph-link-035796` | 򰵏󽔨 | `U+B0D4F;U+FD528` | `reviewed_metadata_only` |
| `obimd-glyph-link-035797` | 󽔩 | `U+FD529` | `reviewed_metadata_only` |
| `obimd-glyph-link-035798` | 󽔪 | `U+FD52A` | `reviewed_metadata_only` |
