# obs-char-000569 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000569`
- primary external id: `hust-obc-cat-0645`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/569_obs-char-000569_hust-obc-cat-0645_orac
  le-character/03_visual-assets/001_asset-000574_hust-obc-cat-0645_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0645/G_0645_乙4810.png`
- asset id: `asset-000574`
...
- source category: `0645`
- validation class: `568`
- source image route: `HUST-OBC/deciphered/0645/G_0645_乙4810.png`
- asset id: `asset-000574`
...
- English observation: `A slender central stroke bends around itself to form
  a narrow middle loop, with a short upper diagonal and a broad horizontal
  crossing near the bottom.`
- 中文观察: `狭长中央笔回弯形成窄中环，上部带短斜笔，近底部有宽横向交叉。`
...
- dataset label text: `㙻`
- dataset label codepoints: `U+367B`
...
- Which source records identify obs-char-000569 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000569？
