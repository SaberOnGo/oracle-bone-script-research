...
- Project ID: `obs-evo-cand-005672`
- EVOBC category candidate ID: `evobc-evo-cat-05672`
- External category reference: `evobc-cat-05672`
- Source category ID: `05672`
- Source label for human review: `瘢`
- Source codepoints: `U+7622`
...
- `obs-evo-cand-005672-route-category-staging`
...
- `obs-evo-cand-005672-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005672-route-evolution-graph`
