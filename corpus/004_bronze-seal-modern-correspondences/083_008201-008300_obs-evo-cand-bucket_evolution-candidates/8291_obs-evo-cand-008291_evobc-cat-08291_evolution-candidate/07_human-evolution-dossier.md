...
Project ID: `obs-evo-cand-008291`
...
- Project ID: `obs-evo-cand-008291`
- EVOBC category candidate ID: `evobc-evo-cat-08291`
- External category reference: `evobc-cat-08291`
- Source category ID: `08291`
- Source label for human review: `諳`
- Source codepoints: `U+8AF3`
...
- `obs-evo-cand-008291-route-category-staging`
...
- `obs-evo-cand-008291-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008291-route-evolution-graph`
