# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002384
...
| --- | --- | --- | --- |
| `obimd-glyph-link-036729` | 㯥󽩺 | `U+3BE5;U+FDA7A` | `reviewed_metadata_only` |
| `obimd-glyph-link-036730` | 󽩻 | `U+FDA7B` | `reviewed_metadata_only` |
