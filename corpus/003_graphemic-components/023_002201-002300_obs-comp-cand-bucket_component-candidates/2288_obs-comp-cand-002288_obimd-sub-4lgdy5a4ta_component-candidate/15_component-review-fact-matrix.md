# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002288
...
| Glyph or codepoint route / 字形或码位路线 | 114 OBIMD route rows; examples U+8FB0;U+FD26F; U+FD270; 另有 112 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 114 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
