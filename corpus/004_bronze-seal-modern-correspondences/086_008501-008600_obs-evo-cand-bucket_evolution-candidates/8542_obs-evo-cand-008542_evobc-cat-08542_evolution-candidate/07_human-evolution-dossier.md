...
- External category reference: `evobc-cat-08542`
- Source category ID: `08542`
- Source label for human review: `販`
- Source codepoints: `U+8CA9`
...
- `obs-evo-cand-008542-route-category-staging`
...
- `obs-evo-cand-008542-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008542-route-evolution-graph`
