...
Project ID: `obs-evo-cand-003049`
...
- Project ID: `obs-evo-cand-003049`
- EVOBC category candidate ID: `evobc-evo-cat-03049`
- External category reference: `evobc-cat-03049`
- Source category ID: `03049`
- Source label for human review: `惙`
- Source codepoints: `U+60D9`
...
- `obs-evo-cand-003049-route-category-staging`
...
- `obs-evo-cand-003049-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003049-route-evolution-graph`
