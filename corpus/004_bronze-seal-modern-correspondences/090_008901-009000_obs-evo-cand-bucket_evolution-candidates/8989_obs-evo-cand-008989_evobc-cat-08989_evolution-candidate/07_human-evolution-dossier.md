...
- External category reference: `evobc-cat-08989`
- Source category ID: `08989`
- Source label for human review: `透`
...
- `obs-evo-cand-008989-route-category-staging`
...
- `obs-evo-cand-008989-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008989-route-evolution-graph`
