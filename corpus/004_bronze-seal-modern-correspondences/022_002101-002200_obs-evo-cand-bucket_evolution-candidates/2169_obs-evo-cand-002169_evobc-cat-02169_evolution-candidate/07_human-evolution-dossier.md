...
- External category reference: `evobc-cat-02169`
- Source category ID: `02169`
- Source label for human review: `娜`
- Source codepoints: `U+5A1C`
...
- `obs-evo-cand-002169-route-category-staging`
...
- `obs-evo-cand-002169-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002169-route-evolution-graph`
