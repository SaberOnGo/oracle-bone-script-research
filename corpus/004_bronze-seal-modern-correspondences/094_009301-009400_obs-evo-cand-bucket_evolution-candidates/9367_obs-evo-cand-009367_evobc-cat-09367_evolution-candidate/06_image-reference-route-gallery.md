...
- `obs-evo-cand-009367-route-category-staging`
...
- `obs-evo-cand-009367-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009367-route-evolution-graph`
