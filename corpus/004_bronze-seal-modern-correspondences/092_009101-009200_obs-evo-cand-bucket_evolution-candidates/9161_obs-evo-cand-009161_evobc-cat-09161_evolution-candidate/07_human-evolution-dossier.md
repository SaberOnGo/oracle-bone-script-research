...
- Project ID: `obs-evo-cand-009161`
- EVOBC category candidate ID: `evobc-evo-cat-09161`
- External category reference: `evobc-cat-09161`
- Source category ID: `09161`
- Source label for human review: `郯`
- Source codepoints: `U+90EF`
...
- `obs-evo-cand-009161-route-category-staging`
...
- `obs-evo-cand-009161-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009161-route-evolution-graph`
