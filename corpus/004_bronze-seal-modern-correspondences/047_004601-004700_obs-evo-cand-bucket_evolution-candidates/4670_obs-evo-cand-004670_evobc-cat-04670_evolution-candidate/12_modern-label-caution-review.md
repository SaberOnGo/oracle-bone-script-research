# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004670
...
- EVOBC candidate category: `evobc-evo-cat-04670`.
- Source label for search only: `浸`.
- Source codepoints for search only: `U+6D78`.
