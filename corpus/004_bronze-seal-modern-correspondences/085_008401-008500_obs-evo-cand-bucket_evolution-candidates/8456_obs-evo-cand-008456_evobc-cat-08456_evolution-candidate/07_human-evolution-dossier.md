...
- External category reference: `evobc-cat-08456`
- Source category ID: `08456`
- Source label for human review: `谚`
- Source codepoints: `U+8C1A`
...
- `obs-evo-cand-008456-route-category-staging`
...
- `obs-evo-cand-008456-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008456-route-evolution-graph`
