# obs-char-000197 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000197`
- primary external id: `hust-obc-cat-0219`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/197_obs-char-000197_hust-obc-cat-0219_orac
  le-character/03_visual-assets/001_asset-000202_hust-obc-cat-0219_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0219/G_0219_合33069(甲).png`
- asset id: `asset-000202`
...
- source category: `0219`
- validation class: `196`
- source image route: `HUST-OBC/deciphered/0219/G_0219_合33069(甲).png`
- asset id: `asset-000202`
...
- English observation: `The image has a rounded angular upper loop connected
  to a long curved stroke that descends and hooks near the lower right.`
...
- dataset label text: `㓑`
- dataset label codepoints: `U+34D1`
...
- Which source records identify obs-char-000197 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000197？
