# Material Visual Observation / obs-comp-cand-001737 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001737`
- External reference / 外部参照: `obimd-sub-2dhfv1barj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017938_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/iuzkqe17tf/2dhfv1barj/2dhfv1barj.png`
- Checksum / 校验和:
  `f8a89d8be9637065490d1037c14d4dd27db4a40597e543085f89eacc4dc72caf`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.02%.
- Marked-pixel bounds: (68,42)–(181,204); span 114 × 163 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.02%。
- 痕迹范围：(68,42)–(181,204)；跨度114 × 163 px；痕迹矩形高于宽。
