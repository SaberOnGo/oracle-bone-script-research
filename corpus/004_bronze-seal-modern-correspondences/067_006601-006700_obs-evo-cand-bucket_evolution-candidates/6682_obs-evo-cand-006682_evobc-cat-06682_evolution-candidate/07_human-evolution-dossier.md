...
- External category reference: `evobc-cat-06682`
- Source category ID: `06682`
- Source label for human review: `繟`
...
- `obs-evo-cand-006682-route-category-staging`
...
- `obs-evo-cand-006682-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006682-route-evolution-graph`
