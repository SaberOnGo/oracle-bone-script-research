...
- External category reference: `evobc-cat-08173`
- Source category ID: `08173`
- Source label for human review: `詎`
...
- `obs-evo-cand-008173-route-category-staging`
...
- `obs-evo-cand-008173-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008173-route-evolution-graph`
