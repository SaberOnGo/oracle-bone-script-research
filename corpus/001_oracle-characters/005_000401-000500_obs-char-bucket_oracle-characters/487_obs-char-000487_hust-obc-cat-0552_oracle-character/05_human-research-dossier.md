# obs-char-000487 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000487`
- primary external id: `hust-obc-cat-0552`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/487_obs-char-000487_hust-obc-cat-0552_orac
  le-character/03_visual-assets/001_asset-000492_hust-obc-cat-0552_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0552/G_0552_庫658(甲).png`
- asset id: `asset-000492`
...
- source category: `0552`
- validation class: `486`
- source image route: `HUST-OBC/deciphered/0552/G_0552_庫658(甲).png`
- asset id: `asset-000492`
...
- English observation: `A pointed upper outline contains several detached
  short vertical marks and a curved inner stroke, with one long diagonal
  line descending from the lower right.`
- 中文观察: `尖顶上部轮廓内有数条分离短竖和一条弯曲内笔，右下伸出一条长斜线。`
...
- dataset label text: `㘞`
- dataset label codepoints: `U+361E`
...
- Which source records identify obs-char-000487 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000487？
