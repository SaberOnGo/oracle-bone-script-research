...
Project ID: `obs-evo-cand-013116`
...
- Project ID: `obs-evo-cand-013116`
- EVOBC category candidate ID: `evobc-evo-cat-13116`
- External category reference: `evobc-cat-13116`
- Source category ID: `13116`
- Source label for human review: `𫶠`
- Source codepoints: `U+2BDA0`
...
- `obs-evo-cand-013116-route-category-staging`
...
- `obs-evo-cand-013116-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013116-route-evolution-graph`
