...
- Project ID: `obs-evo-cand-003895`
- EVOBC category candidate ID: `evobc-evo-cat-03895`
- External category reference: `evobc-cat-03895`
- Source category ID: `03895`
- Source label for human review: `杯`
- Source codepoints: `U+676F`
...
- `obs-evo-cand-003895-route-category-staging`
...
- `obs-evo-cand-003895-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003895-route-evolution-graph`
