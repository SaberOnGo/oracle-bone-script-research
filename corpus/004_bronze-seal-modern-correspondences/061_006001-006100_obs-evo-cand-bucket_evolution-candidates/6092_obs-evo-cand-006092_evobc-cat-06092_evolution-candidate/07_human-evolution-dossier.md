...
Project ID: `obs-evo-cand-006092`
...
- Project ID: `obs-evo-cand-006092`
- EVOBC category candidate ID: `evobc-evo-cat-06092`
- External category reference: `evobc-cat-06092`
- Source category ID: `06092`
- Source label for human review: `程`
- Source codepoints: `U+7A0B`
...
- `obs-evo-cand-006092-route-category-staging`
...
- `obs-evo-cand-006092-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006092-route-evolution-graph`
