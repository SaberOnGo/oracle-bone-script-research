# Material Visual Observation / obs-comp-cand-002317 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002317`
- External reference / 外部参照: `obimd-sub-3jzeliplnn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020336_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3jzeliplnn/3jzeliplnn/3jzeliplnn.png`
- Checksum / 校验和:
  `0be14f65036b4b47ec41636c0aa5d936aadcb299706c8432e44e887365c8926f`
...
- Marked-pixel bounds: (76,23)–(189,230); span 114 × 208 px; the marked
...
- 痕迹范围：(76,23)–(189,230)；跨度114 × 208 px；痕迹矩形高于宽。
