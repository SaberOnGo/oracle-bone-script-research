...
- External category reference: `evobc-cat-07562`
- Source category ID: `07562`
- Source label for human review: `蔦`
...
- `obs-evo-cand-007562-route-category-staging`
...
- `obs-evo-cand-007562-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007562-route-evolution-graph`
