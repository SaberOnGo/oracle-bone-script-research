# obs-char-000987 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000987`
- primary external id: `hust-obc-cat-1109`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/987_obs-char-000987_hust-obc-cat-1109_orac
  le-character/03_visual-assets/001_asset-000992_hust-obc-cat-1109_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1109/G_1109_乙29合20768𠂤組.png`
- asset id: `asset-000992`
...
- source category: `1109`
- validation class: `986`
- source image route: `HUST-OBC/deciphered/1109/G_1109_乙29合20768𠂤組.png`
- asset id: `asset-000992`
...
- English observation: `A pointed upper projection sits above a compact
  enclosed central form and two lower branches.`
- 中文观察: `尖形上伸笔位于紧密中央闭合形体之上，下方有两条分枝。`
...
- dataset label text: `㡋`
- dataset label codepoints: `U+384B`
...
- Which source records identify obs-char-000987 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000987？
