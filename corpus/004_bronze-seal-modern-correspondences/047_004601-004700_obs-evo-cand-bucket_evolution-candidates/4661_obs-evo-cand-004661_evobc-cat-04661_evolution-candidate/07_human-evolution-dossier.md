...
- External category reference: `evobc-cat-04661`
- Source category ID: `04661`
- Source label for human review: `浥`
...
- `obs-evo-cand-004661-route-category-staging`
...
- `obs-evo-cand-004661-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004661-route-evolution-graph`
