# obs-unk-004882 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/082_obs-unk-004882_h
  ust-obc-und-X-004882_oracle-character-candidate/03_visual-assets/001_asset
  -006475_hust-obc-und-X-004882_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/438/X_？_7420_1.png`
- asset id: `asset-006475`
...
- source class: `HUST-OBC/undeciphered/X/438/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/438/X_？_7420_1.png`
- asset id: `asset-006475`
...
- English observation: `tall upper group and dense lower form`
- 中文观察: `上部长结构和密集下部形体`
...
- Which source records identify obs-unk-004882 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004882？
