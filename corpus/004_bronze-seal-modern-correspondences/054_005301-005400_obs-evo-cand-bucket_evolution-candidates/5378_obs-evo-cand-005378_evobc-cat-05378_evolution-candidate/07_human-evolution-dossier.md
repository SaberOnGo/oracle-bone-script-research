...
- External category reference: `evobc-cat-05378`
- Source category ID: `05378`
- Source label for human review: `珕`
- Source codepoints: `U+73D5`
...
- `obs-evo-cand-005378-route-category-staging`
...
- `obs-evo-cand-005378-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005378-route-evolution-graph`
