# obs-comp-cand-000128 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000128`
- 首选外部 ID: `obimd-sub-m87lblai6p`
- OBIMD subcharacter UID: `m87lblai6p`
- OBIMD main character UID: `m87lblai6p`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+6C9D;U+F0C28; U+F0C29; 另有 1 项
