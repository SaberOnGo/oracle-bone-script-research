...
- External category reference: `evobc-cat-04321`
- Source category ID: `04321`
- Source label for human review: `櫬`
- Source codepoints: `U+6AEC`
...
- `obs-evo-cand-004321-route-category-staging`
...
- `obs-evo-cand-004321-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004321-route-evolution-graph`
