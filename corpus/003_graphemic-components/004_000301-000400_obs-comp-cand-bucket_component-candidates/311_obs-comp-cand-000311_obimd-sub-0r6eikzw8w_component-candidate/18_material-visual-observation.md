# Material Visual Observation / obs-comp-cand-000311 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000311`
- External reference / 外部参照: `obimd-sub-0r6eikzw8w`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012238_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0r6eikzw8w/0r6eikzw8w/0r6eikzw8w.png`
- Checksum / 校验和:
  `188336f99dd2a3d547f1f88bc40fa8ba9a516e64ce39ac99c16d249de9a6c90b`
...
- Marked-pixel bounds: (89,21)–(160,232); span 72 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.79%。
- 痕迹范围：(89,21)–(160,232)；跨度72 × 212 px；痕迹矩形高于宽。
