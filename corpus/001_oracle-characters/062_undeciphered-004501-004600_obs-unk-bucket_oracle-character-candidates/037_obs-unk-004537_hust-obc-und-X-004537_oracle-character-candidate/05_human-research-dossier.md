# obs-unk-004537 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004537`
- primary external id: `hust-obc-und-X-004537`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/037_obs-unk-004537_h
  ust-obc-und-X-004537_oracle-character-candidate/03_visual-assets/001_asset
  -006130_hust-obc-und-X-004537_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/93/X_？_8276_1.png`
- asset id: `asset-006130`
...
- source class: `HUST-OBC/undeciphered/X/93/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/93/X_？_8276_1.png`
- asset id: `asset-006130`
...
- English observation: `Upper enclosure, branches, and lower stem recorded.`
- 中文观察: `已记录上部轮廓、分支和下部长痕。`
...
- Which source records identify obs-unk-004537 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004537？
