...
- Project ID: `obs-evo-cand-011131`
- EVOBC category candidate ID: `evobc-evo-cat-11131`
- External category reference: `evobc-cat-11131`
- Source category ID: `11131`
- Source label for human review: `𡿨`
- Source codepoints: `U+21FE8`
...
- `obs-evo-cand-011131-route-category-staging`
...
- `obs-evo-cand-011131-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011131-route-evolution-graph`
