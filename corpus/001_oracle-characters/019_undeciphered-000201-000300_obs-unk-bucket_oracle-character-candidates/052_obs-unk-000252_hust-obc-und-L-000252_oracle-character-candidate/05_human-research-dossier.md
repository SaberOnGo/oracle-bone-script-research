# obs-unk-000252 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000252`
- primary external id: `hust-obc-und-L-000252`
...
- local review image route: `corpus/001_oracle-characters/019_undeciphered-000
  201-000300_obs-unk-bucket_oracle-character-candidates/052_obs-unk-000252_h
  ust-obc-und-L-000252_oracle-character-candidate/03_visual-assets/001_asset
  -001845_hust-obc-und-L-000252_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/252/L_？_10781.jpg`
- asset id: `asset-001845`
...
- source class: `HUST-OBC/undeciphered/L/252/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/252/L_？_10781.jpg`
- asset id: `asset-001845`
...
- Which source records identify obs-unk-000252 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000252？
