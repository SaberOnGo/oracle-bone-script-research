...
Project ID: `obs-evo-cand-010537`
...
- Project ID: `obs-evo-cand-010537`
- EVOBC category candidate ID: `evobc-evo-cat-10537`
- External category reference: `evobc-cat-10537`
- Source category ID: `10537`
- Source label for human review: `鶴`
- Source codepoints: `U+9DB4`
...
- `obs-evo-cand-010537-route-category-staging`
...
- `obs-evo-cand-010537-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010537-route-evolution-graph`
