...
- Project ID / 项目 ID: `obs-char-000621`
- Primary external ID / 首选外部 ID: `hust-obc-cat-0706`
...
- Source image / 来源图: `G_0706_乙1904合1351.png`
- Image / 图像: `001_asset-000626_hust-obc-cat-0706_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合1351
...
- target node: `obimd-main-cand-001412`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- target node: `evobc-evo-cat-00049`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC image references / EvoBC 图像引用数: `88`
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/049_obs-evo-cand-000049_evobc-cat-00049_evoluti
...
- Matched OBIMD main UIDs / OBIMD 主字 UID: `1mkqz99m8b`
- Component human files / 构件人类档案: `none`
...
- Source label text / 来源标签文字: `㚸`
- Source label codepoint / 来源标签 codepoint: `U+36B8`
