...
Project ID: `obs-evo-cand-006936`
...
- Project ID: `obs-evo-cand-006936`
- EVOBC category candidate ID: `evobc-evo-cat-06936`
- External category reference: `evobc-cat-06936`
- Source category ID: `06936`
- Source label for human review: `聂`
- Source codepoints: `U+8042`
...
- `obs-evo-cand-006936-route-category-staging`
...
- `obs-evo-cand-006936-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006936-route-evolution-graph`
