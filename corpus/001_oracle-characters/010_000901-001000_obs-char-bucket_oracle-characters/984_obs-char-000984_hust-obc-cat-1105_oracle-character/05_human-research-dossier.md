# obs-char-000984 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/984_obs-char-000984_hust-obc-cat-1105_orac
  le-character/03_visual-assets/001_asset-000989_hust-obc-cat-1105_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1105/G_1105_京津5284合37497黃組.png`
- asset id: `asset-000989`
...
- source category: `1105`
- validation class: `983`
- source image route: `HUST-OBC/deciphered/1105/G_1105_京津5284合37497黃組.png`
- asset id: `asset-000989`
...
- English observation: `A small dark branching cluster combines an upper
  fork, a central rounded band, and lower split strokes.`
...
- dataset label text: `㡇`
- dataset label codepoints: `U+3847`
...
- filename catalog route clues: `Heji-like filename clue: 合37497
...
- Which source records identify obs-char-000984 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000984？
