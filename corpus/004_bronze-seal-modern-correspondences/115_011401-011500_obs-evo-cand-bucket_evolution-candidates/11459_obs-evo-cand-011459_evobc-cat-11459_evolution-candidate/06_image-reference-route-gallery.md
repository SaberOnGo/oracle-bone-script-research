...
- `obs-evo-cand-011459-route-category-staging`
...
- `obs-evo-cand-011459-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011459-route-evolution-graph`
