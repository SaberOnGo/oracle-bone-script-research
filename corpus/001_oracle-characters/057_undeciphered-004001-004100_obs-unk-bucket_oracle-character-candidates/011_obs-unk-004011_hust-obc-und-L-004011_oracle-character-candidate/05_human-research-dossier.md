# obs-unk-004011 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/011_obs-unk-004011_h
  ust-obc-und-L-004011_oracle-character-candidate/03_visual-assets/001_asset
  -005604_hust-obc-und-L-004011_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4011/L_？_852.jpg`
- asset id: `asset-005604`
...
- source class: `HUST-OBC/undeciphered/L/4011/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4011/L_？_852.jpg`
- asset id: `asset-005604`
...
- English observation: Three short marks sit above a long diagonal or
  descending trace, with a smaller lower side branch.
- 中文观察：三条短痕迹位于长斜向或下行痕迹之上，下部有较小侧向分支。
...
- Which source records identify obs-unk-004011 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004011？
