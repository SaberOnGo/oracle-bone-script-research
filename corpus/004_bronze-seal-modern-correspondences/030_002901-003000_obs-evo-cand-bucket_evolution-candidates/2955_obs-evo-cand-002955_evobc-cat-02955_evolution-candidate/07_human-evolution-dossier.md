...
- Project ID: `obs-evo-cand-002955`
- EVOBC category candidate ID: `evobc-evo-cat-02955`
- External category reference: `evobc-cat-02955`
- Source category ID: `02955`
- Source label for human review: `怱`
- Source codepoints: `U+6031`
...
- `obs-evo-cand-002955-route-category-staging`
...
- `obs-evo-cand-002955-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002955-route-evolution-graph`
