# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000340
...
| Glyph or codepoint route / 字形或码位路线 | 29 OBIMD route rows; examples U+8C6D;U+F1F5A; U+F1F5B; 另有 27 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
