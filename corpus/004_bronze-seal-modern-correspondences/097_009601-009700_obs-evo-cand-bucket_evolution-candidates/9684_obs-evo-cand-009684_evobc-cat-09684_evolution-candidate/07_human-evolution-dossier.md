...
Project ID: `obs-evo-cand-009684`
...
- Project ID: `obs-evo-cand-009684`
- EVOBC category candidate ID: `evobc-evo-cat-09684`
- External category reference: `evobc-cat-09684`
- Source category ID: `09684`
- Source label for human review: `阅`
- Source codepoints: `U+9605`
...
- `obs-evo-cand-009684-route-category-staging`
...
- `obs-evo-cand-009684-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009684-route-evolution-graph`
