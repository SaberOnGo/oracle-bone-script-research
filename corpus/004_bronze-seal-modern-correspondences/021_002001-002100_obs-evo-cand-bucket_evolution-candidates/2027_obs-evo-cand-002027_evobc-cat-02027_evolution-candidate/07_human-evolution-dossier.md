...
- External category reference: `evobc-cat-02027`
- Source category ID: `02027`
- Source label for human review: `奃`
- Source codepoints: `U+5943`
...
- `obs-evo-cand-002027-route-category-staging`
...
- `obs-evo-cand-002027-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002027-route-evolution-graph`
