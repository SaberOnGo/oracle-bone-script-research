...
- External category reference: `evobc-cat-04410`
- Source category ID: `04410`
- Source label for human review: `残`
...
- `obs-evo-cand-004410-route-category-staging`
...
- `obs-evo-cand-004410-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004410-route-evolution-graph`
