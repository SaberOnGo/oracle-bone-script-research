# obs-unk-006440 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/081_undeciphered-006
  401-006500_obs-unk-bucket_oracle-character-candidates/040_obs-unk-006440_h
  ust-obc-und-X-006440_oracle-character-candidate/03_visual-assets/001_asset
  -008031_hust-obc-und-X-006440_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1996/X_？_5630_1.png`
- asset id: `asset-008031`
...
- source class: `HUST-OBC/undeciphered/X/1996/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1996/X_？_5630_1.png`
- asset id: `asset-008031`
...
- Which source records identify obs-unk-006440 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006440？
