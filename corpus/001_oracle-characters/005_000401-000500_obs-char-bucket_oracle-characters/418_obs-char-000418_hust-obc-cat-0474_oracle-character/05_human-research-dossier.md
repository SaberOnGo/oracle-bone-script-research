# obs-char-000418 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/418_obs-char-000418_hust-obc-cat-0474_orac
  le-character/03_visual-assets/001_asset-000423_hust-obc-cat-0474_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0474/G_0474_前8.6.1(甲).png`
- asset id: `asset-000423`
...
- source category: `0474`
- validation class: `417`
- source image route: `HUST-OBC/deciphered/0474/G_0474_前8.6.1(甲).png`
- asset id: `asset-000423`
...
- English observation: `A broad curved outer stroke surrounds a compact
  central enclosure and several thin upper marks.`
- 中文观察: `宽大弧形外部笔画围绕紧凑中央闭合轮廓和数条纤细上部痕迹。`
...
- dataset label text: `㗐`
- dataset label codepoints: `U+35D0`
...
- Which source records identify obs-char-000418 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000418？
