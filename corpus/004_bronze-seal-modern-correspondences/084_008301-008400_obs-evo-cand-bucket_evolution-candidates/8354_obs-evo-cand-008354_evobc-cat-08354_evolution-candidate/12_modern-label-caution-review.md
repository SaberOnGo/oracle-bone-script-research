# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008354
...
- EVOBC candidate category: `evobc-evo-cat-08354`.
- Source label for search only: `譎`.
- Source codepoints for search only: `U+8B4E`.
