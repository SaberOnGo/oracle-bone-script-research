...
Project ID: `obs-evo-cand-001146`
...
- Project ID: `obs-evo-cand-001146`
- EVOBC category candidate ID: `evobc-evo-cat-01146`
- External category reference: `evobc-cat-01146`
- Source category ID: `01146`
- Source label for human review: `准`
- Source codepoints: `U+51C6`
...
- `obs-evo-cand-001146-route-category-staging`
...
- `obs-evo-cand-001146-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001146-route-evolution-graph`
