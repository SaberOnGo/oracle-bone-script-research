...
Project ID: `obs-evo-cand-011118`
...
- Project ID: `obs-evo-cand-011118`
- EVOBC category candidate ID: `evobc-evo-cat-11118`
- External category reference: `evobc-cat-11118`
- Source category ID: `11118`
- Source label for human review: `𡹈`
- Source codepoints: `U+21E48`
...
- `obs-evo-cand-011118-route-category-staging`
...
- `obs-evo-cand-011118-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011118-route-evolution-graph`
