...
Project ID: `obs-evo-cand-000417`
...
- Project ID: `obs-evo-cand-000417`
- EVOBC category candidate ID: `evobc-evo-cat-00417`
- External category reference: `evobc-cat-00417`
- Source category ID: `00417`
- Source label for human review: `䙺`
- Source codepoints: `U+467A`
...
- `obs-evo-cand-000417-route-category-staging`
...
- `obs-evo-cand-000417-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000417-route-evolution-graph`
