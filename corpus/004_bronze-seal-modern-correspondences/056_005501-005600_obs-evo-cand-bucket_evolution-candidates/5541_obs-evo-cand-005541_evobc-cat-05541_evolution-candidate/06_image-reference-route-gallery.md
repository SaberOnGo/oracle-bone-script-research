...
- `obs-evo-cand-005541-route-category-staging`
...
- `obs-evo-cand-005541-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005541-route-evolution-graph`
