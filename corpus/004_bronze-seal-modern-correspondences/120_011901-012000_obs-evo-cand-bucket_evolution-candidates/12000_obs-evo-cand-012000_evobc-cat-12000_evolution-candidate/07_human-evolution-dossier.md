...
Project ID: `obs-evo-cand-012000`
...
- Project ID: `obs-evo-cand-012000`
- EVOBC category candidate ID: `evobc-evo-cat-12000`
- External category reference: `evobc-cat-12000`
- Source category ID: `12000`
- Source label for human review: `𦍮`
- Source codepoints: `U+2636E`
...
- `obs-evo-cand-012000-route-category-staging`
...
- `obs-evo-cand-012000-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012000-route-evolution-graph`
