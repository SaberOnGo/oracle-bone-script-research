...
Project ID: `obs-evo-cand-012420`
...
- Project ID: `obs-evo-cand-012420`
- EVOBC category candidate ID: `evobc-evo-cat-12420`
- External category reference: `evobc-cat-12420`
- Source category ID: `12420`
- Source label for human review: `𨛅`
- Source codepoints: `U+286C5`
...
- `obs-evo-cand-012420-route-category-staging`
...
- `obs-evo-cand-012420-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012420-route-evolution-graph`
