...
- External category reference: `evobc-cat-06336`
- Source category ID: `06336`
- Source label for human review: `篽`
...
- `obs-evo-cand-006336-route-category-staging`
...
- `obs-evo-cand-006336-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006336-route-evolution-graph`
