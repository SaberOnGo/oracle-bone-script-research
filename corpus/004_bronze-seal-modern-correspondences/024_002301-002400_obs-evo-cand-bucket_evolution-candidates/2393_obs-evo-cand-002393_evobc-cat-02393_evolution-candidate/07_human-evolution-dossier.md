...
Project ID: `obs-evo-cand-002393`
...
- Project ID: `obs-evo-cand-002393`
- EVOBC category candidate ID: `evobc-evo-cat-02393`
- External category reference: `evobc-cat-02393`
- Source category ID: `02393`
- Source label for human review: `宮`
- Source codepoints: `U+5BAE`
- Image reference count in source metadata: `155`
...
- `obs-evo-cand-002393-route-category-staging`
...
- `obs-evo-cand-002393-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002393-route-evolution-graph`
