# obs-unk-005024 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/067_undeciphered-005
  001-005100_obs-unk-bucket_oracle-character-candidates/024_obs-unk-005024_h
  ust-obc-und-X-005024_oracle-character-candidate/03_visual-assets/001_asset
  -006617_hust-obc-und-X-005024_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/580/X_？_7556_1.png`
- asset id: `asset-006617`
...
- source class: `HUST-OBC/undeciphered/X/580/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/580/X_？_7556_1.png`
- asset id: `asset-006617`
...
- Which source records identify obs-unk-005024 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005024？
