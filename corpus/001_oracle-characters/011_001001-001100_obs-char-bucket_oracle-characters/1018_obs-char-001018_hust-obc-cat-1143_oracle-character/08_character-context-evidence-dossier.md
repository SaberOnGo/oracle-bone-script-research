...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1143`
...
- Source image / 来源图: `H_1143_605E8_0.png`
- Image / 图像: `001_asset-001023_hust-obc-cat-1143_glyph.png`
...
- target node: `evobc-evo-cat-00092`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/092_obs-evo-cand-000092_evobc-cat-00092_evoluti
...
- Source label text / 来源标签文字: `㡭`
- Source label codepoint / 来源标签 codepoint: `U+386D`
