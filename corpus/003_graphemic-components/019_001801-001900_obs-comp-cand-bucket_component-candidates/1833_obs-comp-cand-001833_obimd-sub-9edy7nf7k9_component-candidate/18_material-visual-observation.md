# Material Visual Observation / obs-comp-cand-001833 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001833`
- External reference / 外部参照: `obimd-sub-9edy7nf7k9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018159_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7h3wu2xyyf/9edy7nf7k9/9edy7nf7k9.png`
- Checksum / 校验和:
  `5f50613a4a36c32a0c5e4b3be3cf6a2054b2a51389aed0f9846055bd1ec59264`
...
- Marked-pixel bounds: (57,20)–(181,229); span 125 × 210 px; the marked
...
- 痕迹范围：(57,20)–(181,229)；跨度125 × 210 px；痕迹矩形高于宽。
