...
- External category reference: `evobc-cat-08645`
- Source category ID: `08645`
- Source label for human review: `赘`
- Source codepoints: `U+8D58`
...
- `obs-evo-cand-008645-route-category-staging`
...
- `obs-evo-cand-008645-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008645-route-evolution-graph`
