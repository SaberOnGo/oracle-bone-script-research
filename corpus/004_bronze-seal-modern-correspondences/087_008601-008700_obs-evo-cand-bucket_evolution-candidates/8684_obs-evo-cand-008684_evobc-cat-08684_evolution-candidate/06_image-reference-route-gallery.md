...
- `obs-evo-cand-008684-route-category-staging`
...
- `obs-evo-cand-008684-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008684-route-evolution-graph`
