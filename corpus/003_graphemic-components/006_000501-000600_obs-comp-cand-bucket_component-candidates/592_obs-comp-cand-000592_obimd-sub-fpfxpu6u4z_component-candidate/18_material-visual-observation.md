# Material Visual Observation / obs-comp-cand-000592 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000592`
- External reference / 外部参照: `obimd-sub-fpfxpu6u4z`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013120_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fpfxpu6u4z/fpfxpu6u4z/fpfxpu6u4z.png`
- Checksum / 校验和:
  `b4d29155f82fa6336b0e558347b8babcae233f13da7316a91a39a2a71772e533`
...
- Marked-pixel bounds: (60,25)–(197,228); span 138 × 204 px; the marked
...
- 痕迹范围：(60,25)–(197,228)；跨度138 × 204 px；痕迹矩形高于宽。
