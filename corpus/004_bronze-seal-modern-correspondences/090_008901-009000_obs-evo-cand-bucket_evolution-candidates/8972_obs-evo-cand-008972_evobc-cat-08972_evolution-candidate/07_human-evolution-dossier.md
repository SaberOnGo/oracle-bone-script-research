...
Project ID: `obs-evo-cand-008972`
...
- Project ID: `obs-evo-cand-008972`
- EVOBC category candidate ID: `evobc-evo-cat-08972`
- External category reference: `evobc-cat-08972`
- Source category ID: `08972`
- Source label for human review: `迸`
- Source codepoints: `U+8FF8`
...
- `obs-evo-cand-008972-route-category-staging`
...
- `obs-evo-cand-008972-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008972-route-evolution-graph`
