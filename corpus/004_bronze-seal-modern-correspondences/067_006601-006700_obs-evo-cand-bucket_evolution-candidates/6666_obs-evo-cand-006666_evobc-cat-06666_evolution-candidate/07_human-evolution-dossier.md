...
- External category reference: `evobc-cat-06666`
- Source category ID: `06666`
- Source label for human review: `繈`
...
- `obs-evo-cand-006666-route-category-staging`
...
- `obs-evo-cand-006666-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006666-route-evolution-graph`
