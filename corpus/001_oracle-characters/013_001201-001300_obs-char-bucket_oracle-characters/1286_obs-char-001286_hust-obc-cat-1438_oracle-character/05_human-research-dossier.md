# obs-char-001286 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1286_obs-char-001286_hust-obc-cat-1438_ora
  cle-character/03_visual-assets/001_asset-001291_hust-obc-cat-1438_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1438/G_1438_拾10.1(甲).png`
- asset id: `asset-001291`
...
- source category: `1438`
- validation class: `1285`
- source image route: `HUST-OBC/deciphered/1438/G_1438_拾10.1(甲).png`
- asset id: `asset-001291`
...
- English observation: `A tall form has a pointed upper enclosure, a central
  cross-stroke, and two long outer descending lines.`
- 中文观察: `高直形体有尖顶上部框形、中央横笔和两条长外侧下行线。`
...
- dataset label text: `㦔`
- dataset label codepoints: `U+3994`
...
- Which source records identify obs-char-001286 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001286？
