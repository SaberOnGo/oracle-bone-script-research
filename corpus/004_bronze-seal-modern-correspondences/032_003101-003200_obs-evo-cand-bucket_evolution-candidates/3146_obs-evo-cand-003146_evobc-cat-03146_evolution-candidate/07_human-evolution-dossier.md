...
- External category reference: `evobc-cat-03146`
- Source category ID: `03146`
- Source label for human review: `憏`
...
- `obs-evo-cand-003146-route-category-staging`
...
- `obs-evo-cand-003146-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003146-route-evolution-graph`
