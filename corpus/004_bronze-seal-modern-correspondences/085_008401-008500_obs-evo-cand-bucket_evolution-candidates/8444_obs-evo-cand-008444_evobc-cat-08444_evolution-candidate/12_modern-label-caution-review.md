# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008444
...
- EVOBC candidate category: `evobc-evo-cat-08444`.
- Source label for search only: `读`.
- Source codepoints for search only: `U+8BFB`.
