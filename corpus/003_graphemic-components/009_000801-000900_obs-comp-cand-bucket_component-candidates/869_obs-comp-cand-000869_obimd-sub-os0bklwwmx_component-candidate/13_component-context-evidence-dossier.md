# obs-comp-cand-000869 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000869`
- 首选外部 ID: `obimd-sub-os0bklwwmx`
- OBIMD subcharacter UID: `os0bklwwmx`
- OBIMD main character UID: `os0bklwwmx`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `8`
- codepoint 示例: U+5439;U+F4E3B; U+F4E3C; 另有 6 项
