# obs-char-000732 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/732_obs-char-000732_hust-obc-cat-0833_orac
  le-character/03_visual-assets/001_asset-000737_hust-obc-cat-0833_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0833/G_0833_中大260.png`
- asset id: `asset-000737`
...
- source category: `0833`
- validation class: `731`
- source image route: `HUST-OBC/deciphered/0833/G_0833_中大260.png`
- asset id: `asset-000737`
...
- English observation: `A tall central upright has a pointed arrow-like top,
  a long horizontal crossing the upper middle, and two outward diagonal
  branches near its lower end.`
- 中文观察: `高长中央竖笔具有尖箭状顶端，上中部贯穿一条长横，下端附近伸出两条外展斜枝。`
...
- dataset label text: `㜷`
- dataset label codepoints: `U+3737`
...
- Which source records identify obs-char-000732 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000732？
