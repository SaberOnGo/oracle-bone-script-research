# Material Visual Observation / obs-comp-cand-001503 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001503`
- External reference / 外部参照: `obimd-sub-8st8h2b5yr`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016431_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8st8h2b5yr/8st8h2b5yr/8st8h2b5yr.png`
- Checksum / 校验和:
  `5f85972c49613881771bc7ebda1e3acaf7b796ec364c3d5ebbf8072315fe735e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.63%.
- Marked-pixel bounds: (72,24)–(187,222); span 116 × 199 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.63%。
- 痕迹范围：(72,24)–(187,222)；跨度116 × 199 px；痕迹矩形高于宽。
