# obs-unk-003975 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003975`
- primary external id: `hust-obc-und-L-003975`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/075_obs-unk-003975_h
  ust-obc-und-L-003975_oracle-character-candidate/03_visual-assets/001_asset
  -005568_hust-obc-und-L-003975_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3975/L_？_8404.jpg`
- asset id: `asset-005568`
...
- source class: `HUST-OBC/undeciphered/L/3975/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3975/L_？_8404.jpg`
- asset id: `asset-005568`
...
- English observation: A compact upper cluster sits above a broad bar with short
  lower angular traces and a small rounded right mark.
- 中文观察：紧凑上部痕迹组位于较宽横痕之上，下方有短折线和右侧小圆弧痕迹。
...
- Which source records identify obs-unk-003975 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003975？
