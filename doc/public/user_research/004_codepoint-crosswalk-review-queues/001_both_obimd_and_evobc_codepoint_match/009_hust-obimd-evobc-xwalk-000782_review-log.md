...
- Review log draft ID / 复核日志草稿 ID: `codepoint-crosswalk-review-log-draft-009`
- Codepoint review task ID / codepoint 复核任务 ID: `codepoint-crosswalk-review-009`
...
- Crosswalk candidate ID / 交叉候选 ID: `hust-obimd-evobc-xwalk-000782`
- Suggested oracle character ID / 建议甲骨单字 ID: `obs-char-000782`
- Promotion queue ID / 提升队列 ID: `hust-obc-obs-char-promo-000782`
...
- HUST external ref / HUST 外部引用: `hust-obc-cat-0886`
- HUST label codepoints / HUST 标签 codepoint: `U+376C`
- OBIMD main candidates / OBIMD 主字候选: `obimd-main-cand-000981`
- EVOBC category candidates / EVOBC 类别候选: `evobc-evo-cat-00075`
- EVOBC image reference count / EVOBC 图像引用数: `69`
- EVOBC has oracle-bone refs / EVOBC 是否含甲骨引用: `false`
...
- `corpus/001_oracle-characters/008_000701-000800_obs-char-bucket_oracle-characters/001_hust-obc-candidate-packet-manifest.csv`
- `corpus/001_oracle-characters/008_000701-000800_obs-char-bucket_oracle-characters/782_obs-char-000782_hust-obc-cat-0886_oracle-character/01_candidate-character-packet.json`
...
- Route availability ID: `codepoint-route-availability-009`
...
- Review task ID: `codepoint-crosswalk-review-009`
- Crosswalk candidate ID: `hust-obimd-evobc-xwalk-000782`
- Suggested oracle character ID: `obs-char-000782`
- HUST candidate packet ID: `hust-obc-candidate-packet-000782`
...
- OBIMD row count: `1`
- OBIMD source UIDs: `gxkrzcoj69`
- OBIMD review statuses: `obimd-main-cand-000981=reviewed_metadata_only`
- OBIMD rights statuses: `obimd-main-cand-000981=licensed_for_repository`
- EVOBC row count: `1`
- EVOBC source category IDs: `00075`
- EVOBC has bronze refs: `true`
- EVOBC has seal refs: `false`
- EVOBC review statuses: `evobc-evo-cat-00075=reviewed_metadata_only`
- EVOBC rights statuses: `evobc-evo-cat-00075=source_marked_risk_noted`
...
- Does `hust-obimd-evobc-xwalk-000782` remain unpromoted and undeciphered?
