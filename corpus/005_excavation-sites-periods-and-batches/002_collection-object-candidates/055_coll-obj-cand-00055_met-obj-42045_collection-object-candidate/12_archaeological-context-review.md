# Archaeological Context Review / 考古语境复核: coll-obj-cand-00055
...
| --- | --- | --- |
| Institution | `Metropolitan Museum of Art, New York, NY` | `02_collection-source-index.csv` |
| Catalog or accession | `67.43.14` | `02_collection-source-index.csv` |
| Source item | `42045` | `01_collection-object-packet.json` |
...
| Period or date | `Shang dynasty ca. 1600-1046 BCE` | `08_collection-provenance-evidence-dossier.md` |
