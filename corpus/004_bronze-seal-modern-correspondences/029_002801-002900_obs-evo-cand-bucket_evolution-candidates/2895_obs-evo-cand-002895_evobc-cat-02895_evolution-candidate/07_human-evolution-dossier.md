...
- External category reference: `evobc-cat-02895`
- Source category ID: `02895`
- Source label for human review: `心`
- Source codepoints: `U+5FC3`
- Image reference count in source metadata: `234`
...
- `obs-evo-cand-002895-route-category-staging`
...
- `obs-evo-cand-002895-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002895-route-evolution-graph`
