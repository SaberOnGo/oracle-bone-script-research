# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010230
...
- EVOBC candidate category: `evobc-evo-cat-10230`.
- Source label for search only: `騫`.
- Source codepoints for search only: `U+9A2B`.
