...
- `obs-evo-cand-007363-route-category-staging`
...
- `obs-evo-cand-007363-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007363-route-evolution-graph`
