...
- External category reference: `evobc-cat-00524`
- Source category ID: `00524`
- Source label for human review: `䧍`
...
- `obs-evo-cand-000524-route-category-staging`
...
- `obs-evo-cand-000524-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000524-route-evolution-graph`
