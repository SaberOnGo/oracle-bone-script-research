...
Project ID: `obs-evo-cand-000086`
...
- Project ID: `obs-evo-cand-000086`
- EVOBC category candidate ID: `evobc-evo-cat-00086`
- External category reference: `evobc-cat-00086`
- Source category ID: `00086`
- Source label for human review: `㞷`
- Source codepoints: `U+37B7`
...
- `obs-evo-cand-000086-route-category-staging`
...
- `obs-evo-cand-000086-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000086-route-evolution-graph`
