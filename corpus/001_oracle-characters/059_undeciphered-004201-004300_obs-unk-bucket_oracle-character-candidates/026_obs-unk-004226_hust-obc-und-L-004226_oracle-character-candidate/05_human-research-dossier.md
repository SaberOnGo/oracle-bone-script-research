# obs-unk-004226 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004226`
- primary external id: `hust-obc-und-L-004226`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/026_obs-unk-004226_h
  ust-obc-und-L-004226_oracle-character-candidate/03_visual-assets/001_asset
  -005819_hust-obc-und-L-004226_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4226/L_？_9243.jpg`
- asset id: `asset-005819`
...
- source class: `HUST-OBC/undeciphered/L/4226/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4226/L_？_9243.jpg`
- asset id: `asset-005819`
...
- English observation: `Left outline, inner trace, right curved stroke visible.`
- 中文观察: `左侧轮廓、内部痕迹和右侧弯曲笔画可见。`
...
- Which source records identify obs-unk-004226 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004226？
