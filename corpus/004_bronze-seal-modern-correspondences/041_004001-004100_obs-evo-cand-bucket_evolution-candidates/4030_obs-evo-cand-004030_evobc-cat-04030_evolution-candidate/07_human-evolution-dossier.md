...
Project ID: `obs-evo-cand-004030`
...
- Project ID: `obs-evo-cand-004030`
- EVOBC category candidate ID: `evobc-evo-cat-04030`
- External category reference: `evobc-cat-04030`
- Source category ID: `04030`
- Source label for human review: `桔`
- Source codepoints: `U+6854`
...
- `obs-evo-cand-004030-route-category-staging`
...
- `obs-evo-cand-004030-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004030-route-evolution-graph`
