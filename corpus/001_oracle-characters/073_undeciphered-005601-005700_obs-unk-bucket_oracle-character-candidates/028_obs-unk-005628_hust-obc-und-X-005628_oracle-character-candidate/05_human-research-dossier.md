# obs-unk-005628 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005628`
- primary external id: `hust-obc-und-X-005628`
...
- local review image route: `corpus/001_oracle-characters/073_undeciphered-005
  601-005700_obs-unk-bucket_oracle-character-candidates/028_obs-unk-005628_h
  ust-obc-und-X-005628_oracle-character-candidate/03_visual-assets/001_asset
  -007221_hust-obc-und-X-005628_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1184/X_？_8138_1.png`
- asset id: `asset-007221`
...
- source class: `HUST-OBC/undeciphered/X/1184/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1184/X_？_8138_1.png`
- asset id: `asset-007221`
...
- Which source records identify obs-unk-005628 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005628？
