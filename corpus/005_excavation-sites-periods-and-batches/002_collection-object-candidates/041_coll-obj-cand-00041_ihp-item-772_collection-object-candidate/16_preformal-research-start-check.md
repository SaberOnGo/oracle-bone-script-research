# Preformal Research Start Check / 正式研究开始前开包核查: coll-obj-cand-00041
...
Open `18_live-source-evidence-review.md` after the object page and before any
visual or inscription comparison.
...
| --- | --- | --- |
| 1 | `02_collection-source-index.csv` | `772` |
