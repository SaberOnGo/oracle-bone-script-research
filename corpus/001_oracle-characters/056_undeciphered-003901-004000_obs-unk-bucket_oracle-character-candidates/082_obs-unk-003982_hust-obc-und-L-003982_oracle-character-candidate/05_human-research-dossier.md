# obs-unk-003982 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003982`
- primary external id: `hust-obc-und-L-003982`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/082_obs-unk-003982_h
  ust-obc-und-L-003982_oracle-character-candidate/03_visual-assets/001_asset
  -005575_hust-obc-und-L-003982_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3982/L_？_8430.jpg`
- asset id: `asset-005575`
...
- source class: `HUST-OBC/undeciphered/L/3982/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3982/L_？_8430.jpg`
- asset id: `asset-005575`
...
- English observation: A small upper enclosure leads into a descending curved
  or diagonal trace with a short middle branch.
- 中文观察：小上部围合轮廓连向弧向或斜向下行痕迹，中部有短分支。
...
- Which source records identify obs-unk-003982 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003982？
