...
- External category reference: `evobc-cat-13348`
- Source category ID: `13348`
- Source label for human review: `𬤳`
...
- `obs-evo-cand-013348-route-category-staging`
...
- `obs-evo-cand-013348-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013348-route-evolution-graph`
