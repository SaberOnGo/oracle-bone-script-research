# obs-unk-004799 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004799`
- primary external id: `hust-obc-und-X-004799`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/099_obs-unk-004799_h
  ust-obc-und-X-004799_oracle-character-candidate/03_visual-assets/001_asset
  -006392_hust-obc-und-X-004799_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/355/X_？_7338_1.png`
- asset id: `asset-006392`
...
- source class: `HUST-OBC/undeciphered/X/355/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/355/X_？_7338_1.png`
- asset id: `asset-006392`
...
- English observation: `dense upper group and separate lower openings`
- 中文观察: `密集上部结构和分离的下部开口`
...
- Which source records identify obs-unk-004799 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004799？
