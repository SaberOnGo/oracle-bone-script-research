# obs-unk-004870 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004870`
- primary external id: `hust-obc-und-X-004870`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/070_obs-unk-004870_h
  ust-obc-und-X-004870_oracle-character-candidate/03_visual-assets/001_asset
  -006463_hust-obc-und-X-004870_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/426/X_？_7123_1.png`
- asset id: `asset-006463`
...
- source class: `HUST-OBC/undeciphered/X/426/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/426/X_？_7123_1.png`
- asset id: `asset-006463`
...
- English observation: `three upper groups and separated lower marks`
- 中文观察: `上部三组结构和分开的下部标记`
...
- Which source records identify obs-unk-004870 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004870？
