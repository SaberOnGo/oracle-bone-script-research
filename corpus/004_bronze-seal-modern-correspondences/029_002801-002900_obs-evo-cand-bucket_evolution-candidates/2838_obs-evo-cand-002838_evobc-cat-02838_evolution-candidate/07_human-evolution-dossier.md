...
- External category reference: `evobc-cat-02838`
- Source category ID: `02838`
- Source label for human review: `彙`
...
- `obs-evo-cand-002838-route-category-staging`
...
- `obs-evo-cand-002838-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002838-route-evolution-graph`
