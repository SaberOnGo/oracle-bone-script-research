...
- External category reference: `evobc-cat-09297`
- Source category ID: `09297`
- Source label for human review: `释`
- Source codepoints: `U+91CA`
...
- `obs-evo-cand-009297-route-category-staging`
...
- `obs-evo-cand-009297-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009297-route-evolution-graph`
