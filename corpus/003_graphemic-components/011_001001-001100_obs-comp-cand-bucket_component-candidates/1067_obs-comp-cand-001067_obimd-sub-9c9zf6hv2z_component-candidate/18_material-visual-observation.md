# Material Visual Observation / obs-comp-cand-001067 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001067`
- External reference / 外部参照: `obimd-sub-9c9zf6hv2z`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014617_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9c9zf6hv2z/9c9zf6hv2z/9c9zf6hv2z.png`
- Checksum / 校验和:
  `371241255d2255d7fb6ad686481fa26f5991255b925d28ffd074ff0a015110ac`
...
- Marked-pixel bounds: (77,31)–(172,223); span 96 × 193 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.57%。
- 痕迹范围：(77,31)–(172,223)；跨度96 × 193 px；痕迹矩形高于宽。
