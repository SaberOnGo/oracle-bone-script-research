...
- External category reference: `evobc-cat-11386`
- Source category ID: `11386`
- Source label for human review: `𣃺`
...
- `obs-evo-cand-011386-route-category-staging`
...
- `obs-evo-cand-011386-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011386-route-evolution-graph`
