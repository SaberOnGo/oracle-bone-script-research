...
Project ID: `obs-evo-cand-007672`
...
- Project ID: `obs-evo-cand-007672`
- EVOBC category candidate ID: `evobc-evo-cat-07672`
- External category reference: `evobc-cat-07672`
- Source category ID: `07672`
- Source label for human review: `蘠`
- Source codepoints: `U+8620`
...
- `obs-evo-cand-007672-route-category-staging`
...
- `obs-evo-cand-007672-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007672-route-evolution-graph`
