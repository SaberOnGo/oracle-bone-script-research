...
Project ID: `obs-evo-cand-003176`
...
- Project ID: `obs-evo-cand-003176`
- EVOBC category candidate ID: `evobc-evo-cat-03176`
- External category reference: `evobc-cat-03176`
- Source category ID: `03176`
- Source label for human review: `懌`
- Source codepoints: `U+61CC`
...
- `obs-evo-cand-003176-route-category-staging`
...
- `obs-evo-cand-003176-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003176-route-evolution-graph`
