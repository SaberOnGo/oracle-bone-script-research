# obs-char-001042 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001042`
- primary external id: `hust-obc-cat-1168`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1042_obs-char-001042_hust-obc-cat-1168_ora
  cle-character/03_visual-assets/001_asset-001047_hust-obc-cat-1168_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1168/G_1168_甲骨文.png`
- asset id: `asset-001047`
...
- source category: `1168`
- validation class: `1041`
- source image route: `HUST-OBC/deciphered/1168/G_1168_甲骨文.png`
- asset id: `asset-001047`
...
- English observation: `A single thick square-like enclosure is formed by
  four nearly straight sides, with no visible interior mark.`
- 中文观察: `单个粗重方框状闭合轮廓由近似直线的四边构成，内部未见明显笔迹。`
...
- dataset label text: `㢆`
- dataset label codepoints: `U+3886`
...
- Which source records identify obs-char-001042 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001042？
