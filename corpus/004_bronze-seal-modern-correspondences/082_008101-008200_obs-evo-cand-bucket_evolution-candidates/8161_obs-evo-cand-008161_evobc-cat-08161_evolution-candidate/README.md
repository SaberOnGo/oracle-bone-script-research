# obs-evo-cand-008161 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-008161`
- EVOBC category candidate ID: `evobc-evo-cat-08161`
- External category ref: `evobc-cat-08161`
- Source label: `診`
- Source codepoints: `U+8A3A`
- Image reference count: `15`
- Era token counts: `SS:2;WSC:13`
