# Material Visual Observation / obs-comp-cand-000705 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000705`
- External reference / 外部参照: `obimd-sub-1yymlqlzl6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013381_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1yymlqlzl6/1yymlqlzl6/1yymlqlzl6.png`
- Checksum / 校验和:
  `7c987c3c1442d91ba9f71ba89981ca1204b475466cc124db282c47790c9f00b2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.75%.
- Marked-pixel bounds: (95,25)–(154,227); span 60 × 203 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.75%。
- 痕迹范围：(95,25)–(154,227)；跨度60 × 203 px；痕迹矩形高于宽。
