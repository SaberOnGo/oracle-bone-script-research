# Material Visual Observation / obs-comp-cand-001409 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001409`
- External reference / 外部参照: `obimd-sub-r1lyc5x0pa`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015828_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/r1lyc5x0pa/r1lyc5x0pa/r1lyc5x0pa.png`
- Checksum / 校验和:
  `74d20712688cce99e751e73f19735cf83ab908152e87cdee47afbf5a5e9dd8ed`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.30%.
- Marked-pixel bounds: (78,56)–(171,190); span 94 × 135 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.30%。
- 痕迹范围：(78,56)–(171,190)；跨度94 × 135 px；痕迹矩形高于宽。
