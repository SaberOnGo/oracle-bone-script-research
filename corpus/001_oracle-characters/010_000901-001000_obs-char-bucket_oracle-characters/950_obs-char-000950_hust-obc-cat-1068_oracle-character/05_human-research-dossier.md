# obs-char-000950 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/950_obs-char-000950_hust-obc-cat-1068_orac
  le-character/03_visual-assets/001_asset-000955_hust-obc-cat-1068_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1068/G_1068_乙4538合635賓組.png`
- asset id: `asset-000955`
...
- source category: `1068`
- validation class: `949`
- source image route: `HUST-OBC/deciphered/1068/G_1068_乙4538合635賓組.png`
- asset id: `asset-000955`
...
- English observation: `A bold central diamond-like loop has pointed upper
  and lower strokes and detached side marks.`
- 中文观察: `粗重中央菱形近似环状笔有尖形上、下伸笔和分离侧痕迹。`
...
- dataset label text: `㠢`
- dataset label codepoints: `U+3822`
...
- filename catalog route clues: `Heji-like filename clue: 合635
...
- Which source records identify obs-char-000950 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000950？
