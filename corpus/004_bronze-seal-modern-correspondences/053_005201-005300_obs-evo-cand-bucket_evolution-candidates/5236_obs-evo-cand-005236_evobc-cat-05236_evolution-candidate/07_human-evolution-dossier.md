...
- External category reference: `evobc-cat-05236`
- Source category ID: `05236`
- Source label for human review: `犖`
...
- `obs-evo-cand-005236-route-category-staging`
...
- `obs-evo-cand-005236-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005236-route-evolution-graph`
