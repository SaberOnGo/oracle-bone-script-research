# obs-unk-003901 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003901`
- primary external id: `hust-obc-und-L-003901`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/001_obs-unk-003901_h
  ust-obc-und-L-003901_oracle-character-candidate/03_visual-assets/001_asset
  -005494_hust-obc-und-L-003901_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3901/L_？_8214.jpg`
- asset id: `asset-005494`
...
- source class: `HUST-OBC/undeciphered/L/3901/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3901/L_？_8214.jpg`
- asset id: `asset-005494`
...
- Which source records identify obs-unk-003901 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003901？
