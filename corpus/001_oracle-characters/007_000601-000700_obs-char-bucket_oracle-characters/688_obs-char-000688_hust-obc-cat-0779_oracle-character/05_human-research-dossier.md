# obs-char-000688 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/688_obs-char-000688_hust-obc-cat-0779_orac
  le-character/03_visual-assets/001_asset-000693_hust-obc-cat-0779_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0779/G_0779_京津4450合29272.png`
- asset id: `asset-000693`
...
- source category: `0779`
- validation class: `687`
- source image route: `HUST-OBC/deciphered/0779/G_0779_京津4450合29272.png`
- asset id: `asset-000693`
...
- English observation: `A tall curving stem sends a short branch leftward
  and ends beside a small lower polygonal loop containing one tiny central
  mark.`
...
- dataset label text: `㜁`
- dataset label codepoints: `U+3701`
...
- filename catalog route clues: `Heji-like filename clue: 合29272
  (G_0779_京津4450合29272.png)`
...
- Which source records identify obs-char-000688 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000688？
