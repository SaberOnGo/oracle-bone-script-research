...
- Project ID: `obs-evo-cand-007682`
- EVOBC category candidate ID: `evobc-evo-cat-07682`
- External category reference: `evobc-cat-07682`
- Source category ID: `07682`
- Source label for human review: `蘸`
- Source codepoints: `U+8638`
...
- `obs-evo-cand-007682-route-category-staging`
...
- `obs-evo-cand-007682-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007682-route-evolution-graph`
