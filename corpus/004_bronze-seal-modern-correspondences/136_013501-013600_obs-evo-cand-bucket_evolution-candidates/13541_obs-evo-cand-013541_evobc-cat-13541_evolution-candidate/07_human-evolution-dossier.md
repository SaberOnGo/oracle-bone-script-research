...
- External category reference: `evobc-cat-13541`
- Source category ID: `13541`
- Source label for human review: `𭤌`
...
- `obs-evo-cand-013541-route-category-staging`
...
- `obs-evo-cand-013541-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013541-route-evolution-graph`
