...
- External category reference: `evobc-cat-05859`
- Source category ID: `05859`
- Source label for human review: `瞯`
...
- `obs-evo-cand-005859-route-category-staging`
...
- `obs-evo-cand-005859-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005859-route-evolution-graph`
