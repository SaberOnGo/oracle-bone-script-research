# Material Visual Observation / obs-comp-cand-002269 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002269`
- External reference / 外部参照: `obimd-sub-mvfn7g0qwu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020153_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/mvfn7g0qwu/mvfn7g0qwu/mvfn7g0qwu.png`
- Checksum / 校验和:
  `209d590e909aaeeb2b4c7b0ad1c45cf0d4a1055517bd7fbe7cbe678eabbc325d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.36%.
- Marked-pixel bounds: (61,41)–(188,203); span 128 × 163 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.36%。
- 痕迹范围：(61,41)–(188,203)；跨度128 × 163 px；痕迹矩形高于宽。
