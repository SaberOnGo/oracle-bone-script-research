# Material Visual Observation / obs-comp-cand-001126 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001126`
- External reference / 外部参照: `obimd-sub-aw5cu31vd7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015080_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fgo9aomfqj/aw5cu31vd7/aw5cu31vd7.png`
- Checksum / 校验和:
  `ec9b67b2bc197b4dc48013220117159737f427ad5db6acf2877e6afc13967b4d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.38%.
- Marked-pixel bounds: (80,33)–(168,218); span 89 × 186 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.38%。
- 痕迹范围：(80,33)–(168,218)；跨度89 × 186 px；痕迹矩形高于宽。
