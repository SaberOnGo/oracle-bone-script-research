# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006119
...
- EVOBC candidate category: `evobc-evo-cat-06119`.
- Source label for search only: `稾`.
- Source codepoints for search only: `U+7A3E`.
