# Material Visual Observation / obs-comp-cand-002198 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002198`
- External reference / 外部参照: `obimd-sub-anku02zxgu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019904_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/anku02zxgu/anku02zxgu/anku02zxgu.png`
- Checksum / 校验和:
  `a4bc5de8692bb8c5a331be869599ef7b4360f759565a85c47ace6cd67f801c62`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.05%.
- Marked-pixel bounds: (89,38)–(160,208); span 72 × 171 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.05%。
- 痕迹范围：(89,38)–(160,208)；跨度72 × 171 px；痕迹矩形高于宽。
