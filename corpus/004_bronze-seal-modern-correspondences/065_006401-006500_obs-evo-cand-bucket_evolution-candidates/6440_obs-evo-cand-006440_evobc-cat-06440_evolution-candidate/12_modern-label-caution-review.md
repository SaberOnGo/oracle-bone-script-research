# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006440
...
- EVOBC candidate category: `evobc-evo-cat-06440`.
- Source label for search only: `糿`.
- Source codepoints for search only: `U+7CFF`.
