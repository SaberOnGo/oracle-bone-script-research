...
Project ID: `obs-evo-cand-007445`
...
- Project ID: `obs-evo-cand-007445`
- EVOBC category candidate ID: `evobc-evo-cat-07445`
- External category reference: `evobc-cat-07445`
- Source category ID: `07445`
- Source label for human review: `萐`
- Source codepoints: `U+8410`
...
- `obs-evo-cand-007445-route-category-staging`
...
- `obs-evo-cand-007445-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007445-route-evolution-graph`
