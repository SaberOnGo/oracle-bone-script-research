...
- Project ID: `obs-evo-cand-009026`
- EVOBC category candidate ID: `evobc-evo-cat-09026`
- External category reference: `evobc-cat-09026`
- Source category ID: `09026`
- Source label for human review: `遊`
- Source codepoints: `U+904A`
...
- `obs-evo-cand-009026-route-category-staging`
...
- `obs-evo-cand-009026-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009026-route-evolution-graph`
