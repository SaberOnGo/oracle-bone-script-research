...
- External category reference: `evobc-cat-00380`
- Source category ID: `00380`
- Source label for human review: `䓘`
...
- `obs-evo-cand-000380-route-category-staging`
...
- `obs-evo-cand-000380-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000380-route-evolution-graph`
