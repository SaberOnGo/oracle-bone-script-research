...
- External category reference: `evobc-cat-02913`
- Source category ID: `02913`
- Source label for human review: `忥`
...
- `obs-evo-cand-002913-route-category-staging`
...
- `obs-evo-cand-002913-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002913-route-evolution-graph`
