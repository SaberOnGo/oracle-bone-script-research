...
Project ID: `obs-evo-cand-011522`
...
- Project ID: `obs-evo-cand-011522`
- EVOBC category candidate ID: `evobc-evo-cat-11522`
- External category reference: `evobc-cat-11522`
- Source category ID: `11522`
- Source label for human review: `𣶃`
- Source codepoints: `U+23D83`
...
- `obs-evo-cand-011522-route-category-staging`
...
- `obs-evo-cand-011522-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011522-route-evolution-graph`
