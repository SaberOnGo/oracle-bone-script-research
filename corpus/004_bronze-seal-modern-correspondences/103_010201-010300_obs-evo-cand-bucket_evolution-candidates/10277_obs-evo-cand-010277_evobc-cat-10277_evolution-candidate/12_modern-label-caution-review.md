# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010277
...
- EVOBC candidate category: `evobc-evo-cat-10277`.
- Source label for search only: `驻`.
- Source codepoints for search only: `U+9A7B`.
