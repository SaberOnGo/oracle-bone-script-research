# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000148
...
| --- | --- | --- | --- |
| `obimd-glyph-link-002028` | 󰸉 | `U+F0E09` | `reviewed_metadata_only` |
| `obimd-glyph-link-002029` | 󰸊 | `U+F0E0A` | `reviewed_metadata_only` |
