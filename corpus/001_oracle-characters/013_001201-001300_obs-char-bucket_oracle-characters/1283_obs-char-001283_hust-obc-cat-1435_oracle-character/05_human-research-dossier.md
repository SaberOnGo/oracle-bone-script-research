# obs-char-001283 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1283_obs-char-001283_hust-obc-cat-1435_ora
  cle-character/03_visual-assets/001_asset-001288_hust-obc-cat-1435_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1435/G_1435_京津1498合10208賓組.png`
- asset id: `asset-001288`
...
- source category: `1435`
- validation class: `1282`
- source image route: `HUST-OBC/deciphered/1435/G_1435_京津1498合10208賓組.png`
- asset id: `asset-001288`
...
- English observation: `A narrow sloping form has a rounded inner loop,
  several short crossing marks, and a long lower stem.`
- 中文观察: `狭长倾斜形体有圆拱内部环形、数个短交叉标记和长下部笔干。`
...
- dataset label text: `㦑`
- dataset label codepoints: `U+3991`
...
- filename catalog route clues: `Heji-like filename clue: 合10208
  (G_1435_京津1498合10208賓組.png)`
...
- Which source records identify obs-char-001283 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001283？
