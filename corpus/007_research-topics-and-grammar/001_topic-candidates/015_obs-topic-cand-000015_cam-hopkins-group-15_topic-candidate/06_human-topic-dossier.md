...
| field | value |
| --- | --- |
| English source label | birth and disease |
| Chinese source label | 生育、疾病 |
| reported total | 2 |
...
| route summary | value |
| --- | --- |
| linked crosswalk route count | 2 |
| route index | 04_inscription-crosswalk-route-index.csv |

| route id | crosswalk id | period | Heji route |
| --- | --- | --- | --- |
| obs-topic-cand-000015-crosswalk-route-001 | obs-insc-cw-cand-000184 | I | ***** |
| obs-topic-cand-000015-crosswalk-route-002 | obs-insc-cw-cand-000364 | II | 40374 |
