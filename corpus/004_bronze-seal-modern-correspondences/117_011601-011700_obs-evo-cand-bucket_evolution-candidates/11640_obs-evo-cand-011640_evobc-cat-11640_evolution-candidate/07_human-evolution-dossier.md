...
Project ID: `obs-evo-cand-011640`
...
- Project ID: `obs-evo-cand-011640`
- EVOBC category candidate ID: `evobc-evo-cat-11640`
- External category reference: `evobc-cat-11640`
- Source category ID: `11640`
- Source label for human review: `𤦁`
- Source codepoints: `U+24981`
...
- `obs-evo-cand-011640-route-category-staging`
...
- `obs-evo-cand-011640-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011640-route-evolution-graph`
