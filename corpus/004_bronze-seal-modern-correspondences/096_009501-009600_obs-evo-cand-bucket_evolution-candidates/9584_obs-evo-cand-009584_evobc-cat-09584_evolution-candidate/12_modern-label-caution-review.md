# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-009584
...
- EVOBC candidate category: `evobc-evo-cat-09584`.
- Source label for search only: `铲`.
- Source codepoints for search only: `U+94F2`.
