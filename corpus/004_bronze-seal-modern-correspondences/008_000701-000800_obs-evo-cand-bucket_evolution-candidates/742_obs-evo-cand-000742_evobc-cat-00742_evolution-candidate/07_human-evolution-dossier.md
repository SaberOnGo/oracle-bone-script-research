...
Project ID: `obs-evo-cand-000742`
...
- Project ID: `obs-evo-cand-000742`
- EVOBC category candidate ID: `evobc-evo-cat-00742`
- External category reference: `evobc-cat-00742`
- Source category ID: `00742`
- Source label for human review: `仞`
- Source codepoints: `U+4EDE`
...
- `obs-evo-cand-000742-route-category-staging`
...
- `obs-evo-cand-000742-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000742-route-evolution-graph`
