# Material Visual Observation / obs-comp-cand-001767 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001767`
- External reference / 外部参照: `obimd-sub-04jb55nlsh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017968_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/04jb55nlsh/04jb55nlsh/04jb55nlsh.png`
- Checksum / 校验和:
  `81d837fffdcfaf22150fba50a9bea129735d870b8df2b839a3f58f53fb98389e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.32%.
- Marked-pixel bounds: (71,32)–(191,220); span 121 × 189 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.32%。
- 痕迹范围：(71,32)–(191,220)；跨度121 × 189 px；痕迹矩形高于宽。
