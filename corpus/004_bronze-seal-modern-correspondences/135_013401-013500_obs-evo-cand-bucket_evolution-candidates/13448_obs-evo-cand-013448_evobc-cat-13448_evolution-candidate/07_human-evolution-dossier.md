...
Project ID: `obs-evo-cand-013448`
...
- Project ID: `obs-evo-cand-013448`
- EVOBC category candidate ID: `evobc-evo-cat-13448`
- External category reference: `evobc-cat-13448`
- Source category ID: `13448`
- Source label for human review: `𬷗`
- Source codepoints: `U+2CDD7`
...
- `obs-evo-cand-013448-route-category-staging`
...
- `obs-evo-cand-013448-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013448-route-evolution-graph`
