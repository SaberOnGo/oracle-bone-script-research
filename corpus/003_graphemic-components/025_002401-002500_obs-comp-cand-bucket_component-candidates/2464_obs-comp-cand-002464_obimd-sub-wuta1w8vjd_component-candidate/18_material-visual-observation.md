# Material Visual Observation / obs-comp-cand-002464 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002464`
- External reference / 外部参照: `obimd-sub-wuta1w8vjd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020649_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qw5vx1k0rw/wuta1w8vjd/wuta1w8vjd.png`
- Checksum / 校验和:
  `64431a10d994d29ae70529a08eb0a8ac6c23748a8d323cedd45c0285a54d6ae8`
...
- Marked-pixel bounds: (74,12)–(159,240); span 86 × 229 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.75%。
- 痕迹范围：(74,12)–(159,240)；跨度86 × 229 px；痕迹矩形高于宽。
