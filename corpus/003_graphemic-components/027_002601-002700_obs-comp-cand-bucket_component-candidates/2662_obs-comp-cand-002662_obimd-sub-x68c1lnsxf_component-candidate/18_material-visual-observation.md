# Material Visual Observation / obs-comp-cand-002662 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002662`
- External reference / 外部参照: `obimd-sub-x68c1lnsxf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021238_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/x68c1lnsxf/x68c1lnsxf/x68c1lnsxf.png`
- Checksum / 校验和:
  `ebf73fce6764a5055470a04b74a02612c5c1e8d4e6bd8d8c9b1ef7e06e92b691`
...
- Marked-pixel bounds: (82,23)–(193,223); span 112 × 201 px; the marked
...
- 痕迹范围：(82,23)–(193,223)；跨度112 × 201 px；痕迹矩形高于宽。
