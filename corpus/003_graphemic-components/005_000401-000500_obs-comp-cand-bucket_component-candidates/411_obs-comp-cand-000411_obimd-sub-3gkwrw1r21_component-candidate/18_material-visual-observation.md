# Material Visual Observation / obs-comp-cand-000411 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000411`
- External reference / 外部参照: `obimd-sub-3gkwrw1r21`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012334_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/d339lim5ps/3gkwrw1r21/3gkwrw1r21.png`
- Checksum / 校验和:
  `f39381133ba778ceaf3da52198347308660c21bcf59dff076682f9e6fd8df601`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.99%.
- Marked-pixel bounds: (51,32)–(198,225); span 148 × 194 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.99%。
- 痕迹范围：(51,32)–(198,225)；跨度148 × 194 px；痕迹矩形高于宽。
