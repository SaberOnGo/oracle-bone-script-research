...
Project ID: `obs-evo-cand-005282`
...
- Project ID: `obs-evo-cand-005282`
- EVOBC category candidate ID: `evobc-evo-cat-05282`
- External category reference: `evobc-cat-05282`
- Source category ID: `05282`
- Source label for human review: `狺`
- Source codepoints: `U+72FA`
...
- `obs-evo-cand-005282-route-category-staging`
...
- `obs-evo-cand-005282-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005282-route-evolution-graph`
