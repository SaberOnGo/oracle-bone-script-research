# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001720
...
| --- | --- | --- | --- |
| `obimd-glyph-link-026762` | 󺂫 | `U+FA0AB` | `reviewed_metadata_only` |
| `obimd-glyph-link-026763` | 󺂬 | `U+FA0AC` | `reviewed_metadata_only` |
