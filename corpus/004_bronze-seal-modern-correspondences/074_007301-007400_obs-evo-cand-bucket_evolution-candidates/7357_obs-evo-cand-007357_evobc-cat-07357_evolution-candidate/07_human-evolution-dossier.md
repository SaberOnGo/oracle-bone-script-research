...
- External category reference: `evobc-cat-07357`
- Source category ID: `07357`
- Source label for human review: `荣`
...
- `obs-evo-cand-007357-route-category-staging`
...
- `obs-evo-cand-007357-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007357-route-evolution-graph`
