# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000592
...
- EVOBC candidate category: `evobc-evo-cat-00592`.
- Source label for search only: `䵻`.
- Source codepoints for search only: `U+4D7B`.
