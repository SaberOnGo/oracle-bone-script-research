...
- `obs-evo-cand-004746-route-category-staging`
...
- `obs-evo-cand-004746-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004746-route-evolution-graph`
