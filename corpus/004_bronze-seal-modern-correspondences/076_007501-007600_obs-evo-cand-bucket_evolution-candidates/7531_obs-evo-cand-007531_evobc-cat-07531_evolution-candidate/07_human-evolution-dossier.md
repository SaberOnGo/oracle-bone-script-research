...
- External category reference: `evobc-cat-07531`
- Source category ID: `07531`
- Source label for human review: `蓨`
...
- `obs-evo-cand-007531-route-category-staging`
...
- `obs-evo-cand-007531-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007531-route-evolution-graph`
