# obs-unk-004176 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004176`
- primary external id: `hust-obc-und-L-004176`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/076_obs-unk-004176_h
  ust-obc-und-L-004176_oracle-character-candidate/03_visual-assets/001_asset
  -005769_hust-obc-und-L-004176_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4176/L_？_9047.jpg`
- asset id: `asset-005769`
...
- source class: `HUST-OBC/undeciphered/L/4176/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4176/L_？_9047.jpg`
- asset id: `asset-005769`
...
- English observation: Slanting upper strokes meet a pointed group above a
  lower rectangular outline.
- 中文观察: 上部斜向笔画汇入尖角组，下方有近矩形轮廓。
...
- Which source records identify obs-unk-004176 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004176？
