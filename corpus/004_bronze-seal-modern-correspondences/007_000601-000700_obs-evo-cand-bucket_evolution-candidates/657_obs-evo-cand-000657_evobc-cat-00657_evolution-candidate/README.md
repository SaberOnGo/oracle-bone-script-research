# obs-evo-cand-000657 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-00657`
- Source label: `之`
- Source codepoints: `U+4E4B`
- Image reference count: `1000`
- Era token counts: `BI:70;CS:3;OBC:89;SAC:42;SS:2;WSC:794`
- Source token counts: `Book:113;Web:887`
...
- era 3 / SAC: 42 image references
- era 4 / WSC: 794 image references
- era 5 / CS: 3 image references
- source 0 / Web:1633: 1 image references
- source 1 / Web:105952;說文Web:58: 864 image references
- source 2 / Book:17600: 31 image references
- source 3 / Book:21681: 9 image references
- source 4 / Book:9131: 42 image references
