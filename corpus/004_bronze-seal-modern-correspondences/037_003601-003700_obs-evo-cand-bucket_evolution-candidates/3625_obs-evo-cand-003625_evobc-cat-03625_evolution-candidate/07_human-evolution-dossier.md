...
- External category reference: `evobc-cat-03625`
- Source category ID: `03625`
- Source label for human review: `文`
- Source codepoints: `U+6587`
- Image reference count in source metadata: `399`
...
- `obs-evo-cand-003625-route-category-staging`
...
- `obs-evo-cand-003625-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003625-route-evolution-graph`
