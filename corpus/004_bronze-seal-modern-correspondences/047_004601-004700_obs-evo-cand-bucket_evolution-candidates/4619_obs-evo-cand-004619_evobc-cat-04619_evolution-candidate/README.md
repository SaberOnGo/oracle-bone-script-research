# obs-evo-cand-004619 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-004619`
- EVOBC category candidate ID: `evobc-evo-cat-04619`
- External category ref: `evobc-cat-04619`
- Source label for human review: `洒`
- Source codepoints: `U+6D12`
- Image reference count: `37`
- Era token counts: `CS:1;OBC:30;SS:3;WSC:3`
- Source token counts: `Book:4;Web:33`
