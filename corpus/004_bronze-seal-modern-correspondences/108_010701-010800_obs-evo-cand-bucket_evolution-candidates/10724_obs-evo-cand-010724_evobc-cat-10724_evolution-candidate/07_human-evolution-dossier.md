...
Project ID: `obs-evo-cand-010724`
...
- Project ID: `obs-evo-cand-010724`
- EVOBC category candidate ID: `evobc-evo-cat-10724`
- External category reference: `evobc-cat-10724`
- Source category ID: `10724`
- Source label for human review: `齞`
- Source codepoints: `U+9F5E`
...
- `obs-evo-cand-010724-route-category-staging`
...
- `obs-evo-cand-010724-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010724-route-evolution-graph`
