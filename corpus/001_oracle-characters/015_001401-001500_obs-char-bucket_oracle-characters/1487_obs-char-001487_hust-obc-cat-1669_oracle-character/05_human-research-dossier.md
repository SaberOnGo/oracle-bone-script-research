# obs-char-001487 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1487_obs-char-001487_hust-obc-cat-1669_ora
  cle-character/03_visual-assets/001_asset-001492_hust-obc-cat-1669_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1669/L_1669_5493.jpg`
- asset id: `asset-001492`
...
- source category: `1669`
- validation class: `1486`
- source image route: `HUST-OBC/deciphered/1669/L_1669_5493.jpg`
- asset id: `asset-001492`
...
- English observation: `A faint upper cluster sits above a divided
  rectangular lower enclosure.`
- 中文观察: `浅淡上部笔画群位于隔分下部矩形框形之上。`
...
- dataset label text: `㩻`
- dataset label codepoints: `U+3A7B`
...
- Which source records identify obs-char-001487 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001487？
