...
- External category reference: `evobc-cat-08377`
- Source category ID: `08377`
- Source label for human review: `譸`
...
- `obs-evo-cand-008377-route-category-staging`
...
- `obs-evo-cand-008377-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008377-route-evolution-graph`
