...
Project ID: `obs-evo-cand-000436`
...
- Project ID: `obs-evo-cand-000436`
- EVOBC category candidate ID: `evobc-evo-cat-00436`
- External category reference: `evobc-cat-00436`
- Source category ID: `00436`
- Source label for human review: `䜌`
- Source codepoints: `U+470C`
...
- `obs-evo-cand-000436-route-category-staging`
...
- `obs-evo-cand-000436-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000436-route-evolution-graph`
