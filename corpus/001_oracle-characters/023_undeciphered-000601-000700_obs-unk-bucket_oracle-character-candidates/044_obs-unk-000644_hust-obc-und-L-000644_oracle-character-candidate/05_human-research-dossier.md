# obs-unk-000644 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000644`
- primary external id: `hust-obc-und-L-000644`
...
- local review image route: `corpus/001_oracle-characters/023_undeciphered-000
  601-000700_obs-unk-bucket_oracle-character-candidates/044_obs-unk-000644_h
  ust-obc-und-L-000644_oracle-character-candidate/03_visual-assets/001_asset
  -002237_hust-obc-und-L-000644_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/644/L_？_1194.jpg`
- asset id: `asset-002237`
...
- source class: `HUST-OBC/undeciphered/L/644/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/644/L_？_1194.jpg`
- asset id: `asset-002237`
...
- Which source records identify obs-unk-000644 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000644？
