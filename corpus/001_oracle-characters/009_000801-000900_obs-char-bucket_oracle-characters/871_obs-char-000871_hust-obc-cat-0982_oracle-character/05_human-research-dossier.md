# obs-char-000871 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000871`
- primary external id: `hust-obc-cat-0982`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/871_obs-char-000871_hust-obc-cat-0982_orac
  le-character/03_visual-assets/001_asset-000876_hust-obc-cat-0982_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0982/G_0982_乙3422(甲).png`
- asset id: `asset-000876`
...
- source category: `0982`
- validation class: `870`
- source image route: `HUST-OBC/deciphered/0982/G_0982_乙3422(甲).png`
- asset id: `asset-000876`
...
- English observation: `A thin pointed upper outline descends into rounded
  middle marks and a shallow lower bar with two short legs; a right mark is
  detached.`
- 中文观察: `纤细尖形上部轮廓向下连接圆弧中部痕迹和带两条短腿的浅横底笔；右侧痕迹分离。`
...
- dataset label text: `㟌`
- dataset label codepoints: `U+37CC`
...
- Which source records identify obs-char-000871 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000871？
