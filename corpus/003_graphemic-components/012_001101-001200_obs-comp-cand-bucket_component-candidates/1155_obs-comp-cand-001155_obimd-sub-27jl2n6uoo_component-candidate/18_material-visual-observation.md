# Material Visual Observation / obs-comp-cand-001155 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001155`
- External reference / 外部参照: `obimd-sub-27jl2n6uoo`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015345_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/27jl2n6uoo/27jl2n6uoo/27jl2n6uoo.png`
- Checksum / 校验和:
  `c410bdfba6c650e5c0239ae8094370bf72df8fbad22f208c9f7ade5bac700616`
...
- Marked-pixel bounds: (81,20)–(185,227); span 105 × 208 px; the marked
...
- 痕迹范围：(81,20)–(185,227)；跨度105 × 208 px；痕迹矩形高于宽。
