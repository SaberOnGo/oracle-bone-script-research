...
- External category reference: `evobc-cat-01364`
- Source category ID: `01364`
- Source label for human review: `千`
- Source codepoints: `U+5343`
...
- `obs-evo-cand-001364-route-category-staging`
...
- `obs-evo-cand-001364-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001364-route-evolution-graph`
