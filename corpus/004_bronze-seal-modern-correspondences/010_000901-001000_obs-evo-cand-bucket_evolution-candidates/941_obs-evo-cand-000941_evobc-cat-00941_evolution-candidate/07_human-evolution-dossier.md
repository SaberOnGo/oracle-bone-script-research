...
- Project ID: `obs-evo-cand-000941`
- EVOBC category candidate ID: `evobc-evo-cat-00941`
- External category reference: `evobc-cat-00941`
- Source category ID: `00941`
- Source label for human review: `倭`
- Source codepoints: `U+502D`
...
- `obs-evo-cand-000941-route-category-staging`
...
- `obs-evo-cand-000941-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000941-route-evolution-graph`
