# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012960
...
- EVOBC candidate category: `evobc-evo-cat-12960`.
- Source label for search only: `𫒴`.
- Source codepoints for search only: `U+2B4B4`.
