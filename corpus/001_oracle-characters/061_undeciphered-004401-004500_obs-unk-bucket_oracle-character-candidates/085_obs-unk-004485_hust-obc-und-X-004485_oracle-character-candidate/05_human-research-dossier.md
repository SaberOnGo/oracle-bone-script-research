# obs-unk-004485 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004485`
- primary external id: `hust-obc-und-X-004485`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/085_obs-unk-004485_h
  ust-obc-und-X-004485_oracle-character-candidate/03_visual-assets/001_asset
  -006078_hust-obc-und-X-004485_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/41/X_？_8221_1.png`
- asset id: `asset-006078`
...
- source class: `HUST-OBC/undeciphered/X/41/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/41/X_？_8221_1.png`
- asset id: `asset-006078`
...
- English observation: A rounded upper loop and two short bars sit above
  branching lower traces.
- 中文观察: 圆弧上部开口和两条短横痕位于分支下部痕迹之上。
...
- Which source records identify obs-unk-004485 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004485？
