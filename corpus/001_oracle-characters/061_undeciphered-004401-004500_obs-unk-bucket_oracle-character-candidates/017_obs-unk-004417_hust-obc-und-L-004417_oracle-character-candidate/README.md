# obs-unk-004417 Local Object Materials / obs-unk-004417 本地对象资料
...
- Local review image / 本地复核图像: `03_visual-assets/001_asset-006010_hust-obc-und-L-004417_glyph.jpg`

## Object Summary / 对象摘要

- Project ID / 项目 ID: `obs-unk-004417`
- Primary external reference / 首选外部参考: `hust-obc-und-L-004417`
- Source group / 来源分组: `L` (Oracle Bone Script: Six Digit Numerical Code)
- Source class path / 来源分类路径: `HUST-OBC/undeciphered/L/4417/`
- Source image path / 来源图像路径: `HUST-OBC/undeciphered/L/4417/L_？_9889.jpg`
- Asset ID / 资产 ID: `asset-006010`
