# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012766
...
- EVOBC candidate category: `evobc-evo-cat-12766`.
- Source label for search only: `𪓜`.
- Source codepoints for search only: `U+2A4DC`.
