# Material Visual Observation / obs-comp-cand-000790 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000790`
- External reference / 外部参照: `obimd-sub-72l1rujscv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013589_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6p9s6p6wyb/72l1rujscv/72l1rujscv.png`
- Checksum / 校验和:
  `337e46527738d845f25a43fb461ae654c813db32f91be3f402fc01e1f2b90db6`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.75%.
- Marked-pixel bounds: (70,23)–(179,228); span 110 × 206 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.75%。
- 痕迹范围：(70,23)–(179,228)；跨度110 × 206 px；痕迹矩形高于宽。
