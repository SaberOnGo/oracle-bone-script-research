...
- `obs-evo-cand-002347-route-category-staging`
...
- `obs-evo-cand-002347-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002347-route-evolution-graph`
