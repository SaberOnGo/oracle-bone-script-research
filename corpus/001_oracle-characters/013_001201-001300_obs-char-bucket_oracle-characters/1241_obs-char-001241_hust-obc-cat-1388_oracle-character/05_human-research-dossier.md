# obs-char-001241 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001241`
- primary external id: `hust-obc-cat-1388`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1241_obs-char-001241_hust-obc-cat-1388_ora
  cle-character/03_visual-assets/001_asset-001246_hust-obc-cat-1388_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1388/G_1388_乙730合7571賓組.png`
- asset id: `asset-001246`
...
- source category: `1388`
- validation class: `1240`
- source image route: `HUST-OBC/deciphered/1388/G_1388_乙730合7571賓組.png`
- asset id: `asset-001246`
...
- English observation: `A dense branching form has several pointed upper
  arms, a central descending stroke, and a long lower taper.`
- 中文观察: `密集的分枝形体有数个尖状上部支臂、中央下行笔画和一条向下渐尖的长笔画。`
...
- dataset label text: `㥢`
- dataset label codepoints: `U+3962`
...
- filename catalog route clues: `Heji-like filename clue: 合7571
  (G_1388_乙730合7571賓組.png)`
...
- Which source records identify obs-char-001241 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001241？
