# obs-unk-004953 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004953`
- primary external id: `hust-obc-und-X-004953`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/053_obs-unk-004953_h
  ust-obc-und-X-004953_oracle-character-candidate/03_visual-assets/001_asset
  -006546_hust-obc-und-X-004953_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/509/X_？_7491_1.png`
- asset id: `asset-006546`
...
- A curved central descent and right triangular opening are visible.
- The source packet expects two views; one local view is present.
- 直接记录：`14_material-visual-observation.md`
- 可见中央弧形下行笔画和右侧三角形开口。
- 来源包记录应有两个视图；当前仅有一个本地图像。
...
- source class: `HUST-OBC/undeciphered/X/509/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/509/X_？_7491_1.png`
- asset id: `asset-006546`
...
- Which source records identify obs-unk-004953 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004953？
