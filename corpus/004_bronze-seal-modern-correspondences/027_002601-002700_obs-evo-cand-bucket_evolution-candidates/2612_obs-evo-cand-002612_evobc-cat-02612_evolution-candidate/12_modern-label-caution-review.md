# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002612
...
- EVOBC candidate category: `evobc-evo-cat-02612`.
- Source label for search only: `巟`.
- Source codepoints for search only: `U+5DDF`.
