...
Project ID: `obs-evo-cand-005073`
...
- Project ID: `obs-evo-cand-005073`
- EVOBC category candidate ID: `evobc-evo-cat-05073`
- External category reference: `evobc-cat-05073`
- Source category ID: `05073`
- Source label for human review: `烟`
- Source codepoints: `U+70DF`
...
- `obs-evo-cand-005073-route-category-staging`
...
- `obs-evo-cand-005073-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005073-route-evolution-graph`
