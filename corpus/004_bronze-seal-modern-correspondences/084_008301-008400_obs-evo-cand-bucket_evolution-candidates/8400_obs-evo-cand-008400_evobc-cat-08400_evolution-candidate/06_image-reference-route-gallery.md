...
- `obs-evo-cand-008400-route-category-staging`
...
- `obs-evo-cand-008400-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008400-route-evolution-graph`
