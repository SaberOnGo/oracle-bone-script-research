# obs-unk-008144 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008144`
- primary external id: `hust-obc-und-YH-008144`
...
- local review image route: `corpus/001_oracle-characters/098_undeciphered-008
  101-008200_obs-unk-bucket_oracle-character-candidates/044_obs-unk-008144_h
  ust-obc-und-YH-008144_oracle-character-candidate/03_visual-assets/001_asse
  t-009735_hust-obc-und-YH-008144_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/607CC/Y_？_607CC.jpg`
- asset id: `asset-009735`
...
- source class: `HUST-OBC/undeciphered/Y+H/607CC/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/607CC/Y_？_607CC.jpg`
- asset id: `asset-009735`
...
- Which source records identify obs-unk-008144 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008144？
