...
Project ID: `obs-evo-cand-000407`
...
- Project ID: `obs-evo-cand-000407`
- EVOBC category candidate ID: `evobc-evo-cat-00407`
- External category reference: `evobc-cat-00407`
- Source category ID: `00407`
- Source label for human review: `䘤`
- Source codepoints: `U+4624`
...
- `obs-evo-cand-000407-route-category-staging`
...
- `obs-evo-cand-000407-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000407-route-evolution-graph`
