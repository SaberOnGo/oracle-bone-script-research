# Material Visual Observation / obs-comp-cand-000727 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000727`
- External reference / 外部参照: `obimd-sub-00f3sg6op0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013454_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tyn2yfryvp/00f3sg6op0/00f3sg6op0.png`
- Checksum / 校验和:
  `5a9d2e52d8b0e9050a95497576b709caefdc886ff01cebc4166207728c27830a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.49%.
- Marked-pixel bounds: (77,39)–(172,216); span 96 × 178 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.49%。
- 痕迹范围：(77,39)–(172,216)；跨度96 × 178 px；痕迹矩形高于宽。
