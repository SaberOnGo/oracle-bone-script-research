# obs-char-001484 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001484`
- primary external id: `hust-obc-cat-1666`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1484_obs-char-001484_hust-obc-cat-1666_ora
  cle-character/03_visual-assets/001_asset-001489_hust-obc-cat-1666_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1666/G_1666_後2.37.13.png`
- asset id: `asset-001489`
...
- source category: `1666`
- validation class: `1483`
- source image route: `HUST-OBC/deciphered/1666/G_1666_後2.37.13.png`
- asset id: `asset-001489`
...
- English observation: `A symmetrical vertical form has inner enclosures and
  repeated side prongs.`
- 中文观察: `对称竖向形体有内部框形和重复侧部分叉。`
...
- dataset label text: `㩸`
- dataset label codepoints: `U+3A78`
...
- Which source records identify obs-char-001484 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001484？
