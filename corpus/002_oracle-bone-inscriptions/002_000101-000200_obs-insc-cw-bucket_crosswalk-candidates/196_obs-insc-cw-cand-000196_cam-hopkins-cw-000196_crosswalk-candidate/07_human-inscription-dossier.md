...
Project ID: `obs-insc-cw-cand-000196`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000196`
...
- Yingguo / 英国所藏: `y1175` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `51` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `623` in source row; primary catalog entry pending
- Heji / 合集: `40430` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000196`
