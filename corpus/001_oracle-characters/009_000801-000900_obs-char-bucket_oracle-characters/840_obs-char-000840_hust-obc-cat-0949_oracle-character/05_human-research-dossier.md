# obs-char-000840 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000840`
- primary external id: `hust-obc-cat-0949`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/840_obs-char-000840_hust-obc-cat-0949_orac
  le-character/03_visual-assets/001_asset-000845_hust-obc-cat-0949_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0949/G_0949_乙3222合14572賓組.png`
- asset id: `asset-000845`
...
- source category: `0949`
- validation class: `839`
- source image route: `HUST-OBC/deciphered/0949/G_0949_乙3222合14572賓組.png`
- asset id: `asset-000845`
...
- English observation: `Two separated narrow curving strokes descend in
  parallel; the left has a pointed upper bend and the right tapers to a long
  lower tip.`
- 中文观察: `两条分离的狭长弯曲笔平行下行；左笔上端有尖形弯折，右笔向下收成长尖端。`
...
- dataset label text: `㞫`
- dataset label codepoints: `U+37AB`
...
- filename catalog route clues: `Heji-like filename clue: 合14572
...
- Which source records identify obs-char-000840 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000840？
