# obs-comp-cand-002318 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002318`
- 首选外部 ID: `obimd-sub-pyrvvfnduf`
- OBIMD subcharacter UID: `pyrvvfnduf`
- OBIMD main character UID: `3jzeliplnn`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+FD521; U+FD522; 另有 3 项
