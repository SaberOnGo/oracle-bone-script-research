# obs-unk-005277 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005277`
- primary external id: `hust-obc-und-X-005277`
...
- local review image route: `corpus/001_oracle-characters/069_undeciphered-005
  201-005300_obs-unk-bucket_oracle-character-candidates/077_obs-unk-005277_h
  ust-obc-und-X-005277_oracle-character-candidate/03_visual-assets/001_asset
  -006870_hust-obc-und-X-005277_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/833/X_？_7794_1.png`
- asset id: `asset-006870`
...
- source class: `HUST-OBC/undeciphered/X/833/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/833/X_？_7794_1.png`
...
- Which source records identify obs-unk-005277 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005277？
