# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008501
...
- EVOBC candidate category: `evobc-evo-cat-08501`.
- Source label for search only: `豬`.
- Source codepoints for search only: `U+8C6C`.
