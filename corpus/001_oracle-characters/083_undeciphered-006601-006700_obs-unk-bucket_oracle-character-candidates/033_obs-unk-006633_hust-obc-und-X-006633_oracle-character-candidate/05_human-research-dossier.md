# obs-unk-006633 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/083_undeciphered-006
  601-006700_obs-unk-bucket_oracle-character-candidates/033_obs-unk-006633_h
  ust-obc-und-X-006633_oracle-character-candidate/03_visual-assets/001_asset
  -008224_hust-obc-und-X-006633_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2189/X_？_6509_1.png`
- asset id: `asset-008224`
...
- source class: `HUST-OBC/undeciphered/X/2189/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2189/X_？_6509_1.png`
- asset id: `asset-008224`
...
- Which source records identify obs-unk-006633 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006633？
