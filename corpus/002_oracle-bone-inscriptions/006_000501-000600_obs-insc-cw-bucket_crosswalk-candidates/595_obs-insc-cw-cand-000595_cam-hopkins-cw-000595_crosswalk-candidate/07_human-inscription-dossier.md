...
- Yingguo / 英国所藏: `y2646` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `395` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `482` in source row; primary catalog entry pending
- Heji / 合集: `41928` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000595`
