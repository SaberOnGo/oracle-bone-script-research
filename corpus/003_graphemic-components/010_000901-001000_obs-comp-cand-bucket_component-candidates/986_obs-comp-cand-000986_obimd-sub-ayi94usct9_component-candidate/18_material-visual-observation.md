# Material Visual Observation / obs-comp-cand-000986 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000986`
- External reference / 外部参照: `obimd-sub-ayi94usct9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014356_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/valpak04h2/ayi94usct9/ayi94usct9.png`
- Checksum / 校验和:
  `5145df5b71bb623fdbf06b5bb4034fe68b1ef295cf310757cca4b7fa40d8d487`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.62%.
- Marked-pixel bounds: (68,22)–(181,223); span 114 × 202 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.62%。
- 痕迹范围：(68,22)–(181,223)；跨度114 × 202 px；痕迹矩形高于宽。
