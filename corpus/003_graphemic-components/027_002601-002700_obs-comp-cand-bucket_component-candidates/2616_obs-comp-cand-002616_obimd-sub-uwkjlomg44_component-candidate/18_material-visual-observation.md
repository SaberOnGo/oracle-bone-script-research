# Material Visual Observation / obs-comp-cand-002616 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002616`
- External reference / 外部参照: `obimd-sub-uwkjlomg44`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021155_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/uwkjlomg44/uwkjlomg44/uwkjlomg44.png`
- Checksum / 校验和:
  `83741dfec9eaf8ddfbc3fa47cb4948c22d00071d663c8b06c12b72a9ed8ca5f3`
...
- Marked-pixel bounds: (89,9)–(177,239); span 89 × 231 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.37%。
- 痕迹范围：(89,9)–(177,239)；跨度89 × 231 px；痕迹矩形高于宽。
