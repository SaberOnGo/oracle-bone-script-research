...
Project ID: `obs-evo-cand-001028`
...
- Project ID: `obs-evo-cand-001028`
- EVOBC category candidate ID: `evobc-evo-cat-01028`
- External category reference: `evobc-cat-01028`
- Source category ID: `01028`
- Source label for human review: `僮`
- Source codepoints: `U+50EE`
...
- `obs-evo-cand-001028-route-category-staging`
...
- `obs-evo-cand-001028-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001028-route-evolution-graph`
