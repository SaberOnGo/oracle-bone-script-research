...
- External category reference: `evobc-cat-07655`
- Source category ID: `07655`
- Source label for human review: `藸`
...
- `obs-evo-cand-007655-route-category-staging`
...
- `obs-evo-cand-007655-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007655-route-evolution-graph`
