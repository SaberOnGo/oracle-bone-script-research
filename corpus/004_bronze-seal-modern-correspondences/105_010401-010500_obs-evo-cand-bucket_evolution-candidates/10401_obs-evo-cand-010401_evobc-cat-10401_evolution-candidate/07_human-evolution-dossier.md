...
- External category reference: `evobc-cat-10401`
- Source category ID: `10401`
- Source label for human review: `鮫`
...
- `obs-evo-cand-010401-route-category-staging`
...
- `obs-evo-cand-010401-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010401-route-evolution-graph`
