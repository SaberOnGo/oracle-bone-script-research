# Material Visual Observation / obs-comp-cand-002231 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002231`
- External reference / 外部参照: `obimd-sub-irhl4zo3lu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020044_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/irhl4zo3lu/irhl4zo3lu/irhl4zo3lu.png`
- Checksum / 校验和:
  `7848e0603822ccedd3dc6add753ca01041eebeef38f1579c81657883ae884f4d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.56%.
- Marked-pixel bounds: (49,19)–(192,228); span 144 × 210 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.56%。
- 痕迹范围：(49,19)–(192,228)；跨度144 × 210 px；痕迹矩形高于宽。
