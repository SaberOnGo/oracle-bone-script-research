...
- External category reference: `evobc-cat-00126`
- Source category ID: `00126`
- Source label for human review: `㥊`
- Source codepoints: `U+394A`
...
- `obs-evo-cand-000126-route-category-staging`
...
- `obs-evo-cand-000126-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000126-route-evolution-graph`
