# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000935
...
| --- | --- | --- | --- |
| `obimd-glyph-link-013524` | 򩂖󵐣 | `U+A9096;U+F5423` | `reviewed_metadata_only` |
| `obimd-glyph-link-013525` | 󵐤 | `U+F5424` | `reviewed_metadata_only` |
| `obimd-glyph-link-013526` | 󵐥 | `U+F5425` | `reviewed_metadata_only` |
| `obimd-glyph-link-013527` | 󵐦 | `U+F5426` | `reviewed_metadata_only` |
| `obimd-glyph-link-013528` | 󵐧 | `U+F5427` | `reviewed_metadata_only` |
