...
- External category reference: `evobc-cat-13231`
- Source category ID: `13231`
- Source label for human review: `𬋝`
- Source codepoints: `U+2C2DD`
...
- `obs-evo-cand-013231-route-category-staging`
...
- `obs-evo-cand-013231-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013231-route-evolution-graph`
