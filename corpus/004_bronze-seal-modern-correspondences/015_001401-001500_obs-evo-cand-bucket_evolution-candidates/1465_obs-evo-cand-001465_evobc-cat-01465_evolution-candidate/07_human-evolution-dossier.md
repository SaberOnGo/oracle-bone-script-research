...
- External category reference: `evobc-cat-01465`
- Source category ID: `01465`
- Source label for human review: `叛`
...
- `obs-evo-cand-001465-route-category-staging`
...
- `obs-evo-cand-001465-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001465-route-evolution-graph`
