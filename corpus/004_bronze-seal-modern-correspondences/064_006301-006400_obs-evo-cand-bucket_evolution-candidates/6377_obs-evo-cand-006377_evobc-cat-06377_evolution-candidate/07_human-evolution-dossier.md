...
- External category reference: `evobc-cat-06377`
- Source category ID: `06377`
- Source label: `籠`
...
- `obs-evo-cand-006377-route-category-staging`
...
- `obs-evo-cand-006377-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006377-route-evolution-graph`
