...
- External category reference: `evobc-cat-13130`
- Source category ID: `13130`
- Source label for human review: `𫸠`
- Source codepoints: `U+2BE20`
...
- `obs-evo-cand-013130-route-category-staging`
...
- `obs-evo-cand-013130-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013130-route-evolution-graph`
