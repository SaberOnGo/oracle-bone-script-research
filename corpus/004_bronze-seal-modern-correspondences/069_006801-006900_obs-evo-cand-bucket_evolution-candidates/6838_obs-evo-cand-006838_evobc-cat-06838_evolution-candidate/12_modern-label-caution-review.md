# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006838
...
- EVOBC candidate category: `evobc-evo-cat-06838`.
- Source label for search only: `羌`.
- Source codepoints for search only: `U+7F8C`.
