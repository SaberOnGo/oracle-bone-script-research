...
- External category reference: `evobc-cat-11221`
- Source category ID: `11221`
- Source label for human review: `𢗛`
...
- `obs-evo-cand-011221-route-category-staging`
...
- `obs-evo-cand-011221-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011221-route-evolution-graph`
