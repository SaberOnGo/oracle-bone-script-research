# Material Visual Observation / obs-comp-cand-001293 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001293`
- External reference / 外部参照: `obimd-sub-h8exoqnpru`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015578_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h8exoqnpru/h8exoqnpru/h8exoqnpru.png`
- Checksum / 校验和:
  `0f209f9872c74ee81f20942c6c583ebdd54b560293c65bf4da31c9faa91c9365`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.51%.
- Marked-pixel bounds: (90,29)–(159,224); span 70 × 196 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.51%。
- 痕迹范围：(90,29)–(159,224)；跨度70 × 196 px；痕迹矩形高于宽。
