# Material Visual Observation / obs-comp-cand-000432 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000432`
- External reference / 外部参照: `obimd-sub-tmjnpesb5l`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012355_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ewiqwj2bq8/tmjnpesb5l/tmjnpesb5l.png`
- Checksum / 校验和:
  `c4b6bfaf242a5c16b47ee1bc821e87fe37e48e642d6a132df906c29f3652997c`
...
- Marked-pixel bounds: (85,21)–(164,227); span 80 × 207 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.78%。
- 痕迹范围：(85,21)–(164,227)；跨度80 × 207 px；痕迹矩形高于宽。
