...
- External category reference: `evobc-cat-01857`
- Source category ID: `01857`
- Source label for human review: `垟`
- Source codepoints: `U+579F`
...
- `obs-evo-cand-001857-route-category-staging`
...
- `obs-evo-cand-001857-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001857-route-evolution-graph`
