# Material Visual Observation / obs-comp-cand-000037 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000037`
- External reference / 外部参照: `obimd-sub-7udfap69mj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011294_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7udfap69mj/7udfap69mj/7udfap69mj.png`
- Checksum / 校验和:
  `840cba88ba382ea47bfd911066c7d2900cf99da5967ef0b465c9b50639762a84`
...
- Marked-pixel bounds: (76,28)–(173,228); span 98 × 201 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.33%。
- 痕迹范围：(76,28)–(173,228)；跨度98 × 201 px；痕迹矩形高于宽。
