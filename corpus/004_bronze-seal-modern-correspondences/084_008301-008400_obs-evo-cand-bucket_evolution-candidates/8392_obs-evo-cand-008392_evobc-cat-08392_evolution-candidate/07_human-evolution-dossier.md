...
Project ID: `obs-evo-cand-008392`
...
- Project ID: `obs-evo-cand-008392`
- EVOBC category candidate ID: `evobc-evo-cat-08392`
- External category reference: `evobc-cat-08392`
- Source category ID: `08392`
- Source label for human review: `讕`
- Source codepoints: `U+8B95`
...
- `obs-evo-cand-008392-route-category-staging`
...
- `obs-evo-cand-008392-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008392-route-evolution-graph`
