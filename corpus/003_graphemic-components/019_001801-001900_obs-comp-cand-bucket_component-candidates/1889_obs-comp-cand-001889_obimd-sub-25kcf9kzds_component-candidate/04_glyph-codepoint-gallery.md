# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001889
...
| --- | --- | --- | --- |
| `obimd-glyph-link-028691` | 򦸀󺲶 | `U+A6E00;U+FACB6` | `reviewed_metadata_only` |
| `obimd-glyph-link-028692` | 󺲷 | `U+FACB7` | `reviewed_metadata_only` |
| `obimd-glyph-link-028693` | 󺲸 | `U+FACB8` | `reviewed_metadata_only` |
