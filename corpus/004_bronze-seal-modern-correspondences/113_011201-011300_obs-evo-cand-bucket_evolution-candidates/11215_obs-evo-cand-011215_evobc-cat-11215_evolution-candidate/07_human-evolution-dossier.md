...
- External category reference: `evobc-cat-11215`
- Source category ID: `11215`
- Source label for human review: `𢖇`
- Source codepoints: `U+22587`
...
- `obs-evo-cand-011215-route-category-staging`
...
- `obs-evo-cand-011215-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011215-route-evolution-graph`
