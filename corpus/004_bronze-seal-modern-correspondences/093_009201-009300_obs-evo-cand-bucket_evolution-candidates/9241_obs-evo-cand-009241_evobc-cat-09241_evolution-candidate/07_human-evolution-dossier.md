...
- External category reference: `evobc-cat-09241`
- Source category ID: `09241`
- Source label for human review: `酏`
...
- `obs-evo-cand-009241-route-category-staging`
...
- `obs-evo-cand-009241-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009241-route-evolution-graph`
