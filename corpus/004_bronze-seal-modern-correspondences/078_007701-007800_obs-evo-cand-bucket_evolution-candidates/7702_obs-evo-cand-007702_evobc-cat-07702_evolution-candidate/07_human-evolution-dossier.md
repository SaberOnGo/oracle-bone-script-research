...
- External category reference: `evobc-cat-07702`
- Source category ID: `07702`
- Source label for human review: `虚`
- Source codepoints: `U+865A`
...
- `obs-evo-cand-007702-route-category-staging`
...
- `obs-evo-cand-007702-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007702-route-evolution-graph`
