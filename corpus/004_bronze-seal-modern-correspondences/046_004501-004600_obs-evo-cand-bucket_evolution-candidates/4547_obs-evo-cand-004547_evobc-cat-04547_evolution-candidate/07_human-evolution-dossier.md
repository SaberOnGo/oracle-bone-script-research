...
- External category reference: `evobc-cat-04547`
- Source category ID: `04547`
- Source label for human review: `沟`
- Source codepoints: `U+6C9F`
...
- `obs-evo-cand-004547-route-category-staging`
...
- `obs-evo-cand-004547-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004547-route-evolution-graph`
