...
- External category reference: `evobc-cat-09903`
- Source category ID: `09903`
- Source label for human review: `鞁`
- Source codepoints: `U+9781`
...
- `obs-evo-cand-009903-route-category-staging`
...
- `obs-evo-cand-009903-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009903-route-evolution-graph`
