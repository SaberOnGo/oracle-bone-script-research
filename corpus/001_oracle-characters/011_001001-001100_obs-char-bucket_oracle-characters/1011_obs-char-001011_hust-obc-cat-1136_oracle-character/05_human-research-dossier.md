# obs-char-001011 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001011`
- primary external id: `hust-obc-cat-1136`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1011_obs-char-001011_hust-obc-cat-1136_ora
  cle-character/03_visual-assets/001_asset-001016_hust-obc-cat-1136_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1136/G_1136_佚932合30792無名組.png`
- asset id: `asset-001016`
...
- source category: `1136`
- validation class: `1010`
- source image route: `HUST-OBC/deciphered/1136/G_1136_佚932合30792無名組.png`
- asset id: `asset-001016`
...
- English observation: `Two slender angular upright forms are separated
  within the image; the left has a small lower loop and the right has a
  taller branching stroke.`
- 中文观察: `图像中有两个分离的狭长棱角直立形体；左侧带小型下部环笔，右侧带较高分枝笔。`
...
- dataset label text: `㡦`
- dataset label codepoints: `U+3866`
...
- filename catalog route clues: `Heji-like filename clue: 合30792
  (G_1136_佚932合30792無名組.png)`
...
- Which source records identify obs-char-001011 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001011？
