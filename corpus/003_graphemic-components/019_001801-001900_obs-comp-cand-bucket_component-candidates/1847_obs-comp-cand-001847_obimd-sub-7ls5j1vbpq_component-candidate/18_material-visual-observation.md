# Material Visual Observation / obs-comp-cand-001847 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001847`
- External reference / 外部参照: `obimd-sub-7ls5j1vbpq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018208_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7ls5j1vbpq/7ls5j1vbpq/7ls5j1vbpq.png`
- Checksum / 校验和:
  `502fb5f9168829200045cd92855d7a84d1b7ec7af038f79911ea58c9eb11a6e7`
...
- Marked-pixel bounds: (69,29)–(186,220); span 118 × 192 px; the marked
...
- 痕迹范围：(69,29)–(186,220)；跨度118 × 192 px；痕迹矩形高于宽。
