# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002577
...
- EVOBC candidate category: `evobc-evo-cat-02577`.
- Source label for search only: `嵍`.
- Source codepoints for search only: `U+5D4D`.
