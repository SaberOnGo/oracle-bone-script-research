# Material Visual Observation / obs-unk-002668
...
- Primary external reference / 首选外部参考:
  `hust-obc-und-L-002668`
- Committed image / 已提交图像:
  `03_visual-assets/001_asset-004261_hust-obc-und-L-002668_glyph.jpg`
- Opened derivative / 已打开派生件: the committed review image

## Direct Visual Record / 直接可见记录

- English observation: Short strokes branch from the upper center. A central
  line descends to a horizontal base that encloses a pale lower area.
- 中文观察：上部中央分出短笔痕。一条中央笔痕向下接至横向底部，底部围
  住较浅的下方区域。
