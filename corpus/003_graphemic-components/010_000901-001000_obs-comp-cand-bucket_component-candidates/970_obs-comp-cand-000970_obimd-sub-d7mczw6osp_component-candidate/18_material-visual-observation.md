# Material Visual Observation / obs-comp-cand-000970 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000970`
- External reference / 外部参照: `obimd-sub-d7mczw6osp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014137_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/d7mczw6osp/d7mczw6osp/0rbj6zl5d0.png`
- Checksum / 校验和:
  `d1c36c8c189e1fdc1c0f6f7bc1fc5388491da016c01acec5e65cb6e5d5930ba2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.73%.
- Marked-pixel bounds: (95,43)–(154,207); span 60 × 165 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.73%。
- 痕迹范围：(95,43)–(154,207)；跨度60 × 165 px；痕迹矩形高于宽。
