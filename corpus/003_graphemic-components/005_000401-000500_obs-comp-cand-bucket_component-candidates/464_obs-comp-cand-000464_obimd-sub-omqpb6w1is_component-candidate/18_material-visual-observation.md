# Material Visual Observation / obs-comp-cand-000464 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000464`
- External reference / 外部参照: `obimd-sub-omqpb6w1is`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012612_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8gro2b24ja/omqpb6w1is/omqpb6w1is.png`
- Checksum / 校验和:
  `69ef19cfb17a66de5912cf94209029e4e00a782910e8607c93e76bb9c14d0768`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.11%.
- Marked-pixel bounds: (56,46)–(204,202); span 149 × 157 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.11%。
- 痕迹范围：(56,46)–(204,202)；跨度149 × 157 px；痕迹矩形近方形。
