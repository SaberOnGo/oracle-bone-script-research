# Human Research Readiness Review / 正式研究准备复核: obs-evo-cand-011081
...
- Source label for lookup only: `𡩡`.
- Source codepoints for lookup only: `U+21A61`.
- Era/source code rows to open: `7`.
