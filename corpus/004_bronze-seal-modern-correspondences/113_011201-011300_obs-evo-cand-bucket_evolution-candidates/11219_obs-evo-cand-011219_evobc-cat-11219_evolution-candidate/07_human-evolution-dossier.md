...
- External category reference: `evobc-cat-11219`
- Source category ID: `11219`
- Source label for human review: `𢗊`
- Source codepoints: `U+225CA`
...
- `obs-evo-cand-011219-route-category-staging`
...
- `obs-evo-cand-011219-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011219-route-evolution-graph`
