# obs-unk-008170 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008170`
- primary external id: `hust-obc-und-YH-008170`
...
- local review image route: `corpus/001_oracle-characters/098_undeciphered-008
  101-008200_obs-unk-bucket_oracle-character-candidates/070_obs-unk-008170_h
  ust-obc-und-YH-008170_oracle-character-candidate/03_visual-assets/001_asse
  t-009761_hust-obc-und-YH-008170_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6081C/H_？_6081C_0.png`
- asset id: `asset-009761`
...
- source class: `HUST-OBC/undeciphered/Y+H/6081C/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6081C/H_？_6081C_0.png`
- asset id: `asset-009761`
...
- Which source records identify obs-unk-008170 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008170？
