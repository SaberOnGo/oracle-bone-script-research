# Material Visual Observation / obs-comp-cand-002331 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002331`
- External reference / 外部参照: `obimd-sub-8l2orhbsvl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020350_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8l2orhbsvl/8l2orhbsvl/8l2orhbsvl.png`
- Checksum / 校验和:
  `3a687feb374cc254112e2870ae4974035149e2884475a812b8dc391968261aec`
...
- Marked-pixel bounds: (86,31)–(176,216); span 91 × 186 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.86%。
- 痕迹范围：(86,31)–(176,216)；跨度91 × 186 px；痕迹矩形高于宽。
