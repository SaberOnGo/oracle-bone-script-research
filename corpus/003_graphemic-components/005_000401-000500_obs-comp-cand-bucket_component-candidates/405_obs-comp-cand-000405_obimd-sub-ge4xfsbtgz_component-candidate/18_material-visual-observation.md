# Material Visual Observation / obs-comp-cand-000405 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000405`
- External reference / 外部参照: `obimd-sub-ge4xfsbtgz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012328_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ge4xfsbtgz/ge4xfsbtgz/ge4xfsbtgz.png`
- Checksum / 校验和:
  `34ce87cbbf3b83cd6468f439c36fdda03d669fd8675ccfd2a5fbad229a517815`
...
- Marked-pixel bounds: (64,40)–(185,209); span 122 × 170 px; the marked
...
- 痕迹范围：(64,40)–(185,209)；跨度122 × 170 px；痕迹矩形高于宽。
