# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000608
...
| --- | --- | --- | --- |
| `obimd-glyph-link-009122` | 󳦑 | `U+F3991` | `reviewed_metadata_only` |
| `obimd-glyph-link-009123` | 󳦒 | `U+F3992` | `reviewed_metadata_only` |
