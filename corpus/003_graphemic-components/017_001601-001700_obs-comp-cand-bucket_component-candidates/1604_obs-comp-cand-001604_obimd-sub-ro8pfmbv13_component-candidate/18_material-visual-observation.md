# Material Visual Observation / obs-comp-cand-001604 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001604`
- External reference / 外部参照: `obimd-sub-ro8pfmbv13`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017280_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6wyksx413f/ro8pfmbv13/ro8pfmbv13.png`
- Checksum / 校验和:
  `a525250513db25212de6c235c4f8ec26c420b28a6659d389f9b8648f7ef9235d`
...
- Marked-pixel bounds: (94,21)–(155,222); span 62 × 202 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.82%。
- 痕迹范围：(94,21)–(155,222)；跨度62 × 202 px；痕迹矩形高于宽。
