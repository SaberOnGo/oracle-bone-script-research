...
- Project ID: `obs-evo-cand-001667`
- EVOBC category candidate ID: `evobc-evo-cat-01667`
- External category reference: `evobc-cat-01667`
- Source category ID: `01667`
- Source label for human review: `嗅`
- Source codepoints: `U+55C5`
...
- `obs-evo-cand-001667-route-category-staging`
...
- `obs-evo-cand-001667-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001667-route-evolution-graph`
