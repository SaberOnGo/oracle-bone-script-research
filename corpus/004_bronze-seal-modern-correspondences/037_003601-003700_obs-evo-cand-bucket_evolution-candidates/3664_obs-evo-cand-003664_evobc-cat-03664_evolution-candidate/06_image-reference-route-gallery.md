...
- `obs-evo-cand-003664-route-category-staging`
...
- `obs-evo-cand-003664-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003664-route-evolution-graph`
