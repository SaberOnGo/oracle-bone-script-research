...
- External category reference: `evobc-cat-06725`
- Source category ID: `06725`
- Source label for human review: `级`
...
- `obs-evo-cand-006725-route-category-staging`
...
- `obs-evo-cand-006725-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006725-route-evolution-graph`
