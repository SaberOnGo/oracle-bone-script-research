...
- Yingguo / 英国所藏: `y1994` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `438` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `78` in source row; primary catalog entry pending
- Heji / 合集: `41020` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000323`
