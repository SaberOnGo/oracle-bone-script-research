# obs-unk-000638 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/023_undeciphered-000
  601-000700_obs-unk-bucket_oracle-character-candidates/038_obs-unk-000638_h
  ust-obc-und-L-000638_oracle-character-candidate/03_visual-assets/001_asset
  -002231_hust-obc-und-L-000638_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/638/L_？_1192.jpg`
- asset id: `asset-002231`
...
- source class: `HUST-OBC/undeciphered/L/638/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/638/L_？_1192.jpg`
- asset id: `asset-002231`
...
- Which source records identify obs-unk-000638 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000638？
