...
- External category reference: `evobc-cat-10586`
- Source category ID: `10586`
...
- `obs-evo-cand-010586-route-category-staging`
...
- `obs-evo-cand-010586-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010586-route-evolution-graph`
