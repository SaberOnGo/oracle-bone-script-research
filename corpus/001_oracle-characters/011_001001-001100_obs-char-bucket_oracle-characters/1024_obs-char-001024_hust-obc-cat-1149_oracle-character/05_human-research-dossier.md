# obs-char-001024 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001024`
- primary external id: `hust-obc-cat-1149`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1024_obs-char-001024_hust-obc-cat-1149_ora
  cle-character/03_visual-assets/001_asset-001029_hust-obc-cat-1149_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1149/G_1149_甲骨文.png`
- asset id: `asset-001029`
...
- source category: `1149`
- validation class: `1023`
- source image route: `HUST-OBC/deciphered/1149/G_1149_甲骨文.png`
- asset id: `asset-001029`
...
- English observation: `A dense left cluster has several upright projections
  and a dark rounded interior mark, beside a separate thin curved stroke on
  the right.`
- 中文观察: `密集左侧笔群有数条直立外伸和深色圆弧内笔，右侧另有分离的纤细弯曲笔。`
...
- dataset label text: `㡳`
- dataset label codepoints: `U+3873`
...
- Which source records identify obs-char-001024 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001024？
