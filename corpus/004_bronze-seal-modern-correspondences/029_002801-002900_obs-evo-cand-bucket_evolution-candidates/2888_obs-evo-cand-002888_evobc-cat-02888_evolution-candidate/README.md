# obs-evo-cand-002888 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-002888`
- EVOBC category candidate ID: `evobc-evo-cat-02888`
- External category ref: `evobc-cat-02888`
- Source label for human review: `徵`
- Source codepoints: `U+5FB5`
- Image reference count: `117`
- Era token counts: `BI:25;CS:1;OBC:52;SS:3;WSC:36`
- Source token counts: `Book:56;Web:61`
