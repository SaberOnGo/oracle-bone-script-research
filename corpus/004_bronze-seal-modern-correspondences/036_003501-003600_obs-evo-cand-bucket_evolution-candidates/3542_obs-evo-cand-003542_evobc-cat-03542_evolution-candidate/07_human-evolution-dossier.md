...
- External category reference: `evobc-cat-03542`
- Source category ID: `03542`
- Source label for human review: `攎`
- Source codepoints: `U+650E`
...
- `obs-evo-cand-003542-route-category-staging`
...
- `obs-evo-cand-003542-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003542-route-evolution-graph`
