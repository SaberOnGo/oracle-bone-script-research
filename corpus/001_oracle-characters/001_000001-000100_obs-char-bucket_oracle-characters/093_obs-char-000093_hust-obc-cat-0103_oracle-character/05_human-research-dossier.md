# obs-char-000093 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000093`
- primary external id: `hust-obc-cat-0103`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/093_obs-char-000093_hust-obc-cat-0103_orac
  le-character/03_visual-assets/001_asset-000098_hust-obc-cat-0103_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0103/G_0103_乙5689合655賓組.png`
- asset id: `asset-000098`
...
- source category: `0103`
- validation class: `92`
- source image route: `HUST-OBC/deciphered/0103/G_0103_乙5689合655賓組.png`
- asset id: `asset-000098`
...
- English observation: `The isolated image is a thick curved stroke that
  bends inward from the upper left and tapers toward the lower end.`
- 中文观察: `孤立图像是一道粗弯曲笔画，自左上向内弯转，并向下端逐渐变细。`
...
- dataset label text: `㑝`
- dataset label codepoints: `U+345D`
...
- filename catalog route clues: `Heji-like filename clue: 合655
  (G_0103_乙5689合655賓組.png)`
...
- Which source records identify obs-char-000093 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000093？
