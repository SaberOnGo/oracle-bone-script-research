...
- External category reference: `evobc-cat-13005`
- Source category ID: `13005`
- Source label for human review: `𫣖`
- Source codepoints: `U+2B8D6`
...
- `obs-evo-cand-013005-route-category-staging`
...
- `obs-evo-cand-013005-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013005-route-evolution-graph`
