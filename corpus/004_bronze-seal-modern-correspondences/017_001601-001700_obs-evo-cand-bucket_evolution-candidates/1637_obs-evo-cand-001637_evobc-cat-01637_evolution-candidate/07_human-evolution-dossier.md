...
- External category reference: `evobc-cat-01637`
- Source category ID: `01637`
- Source label for human review: `啾`
- Source codepoints: `U+557E`
...
- `obs-evo-cand-001637-route-category-staging`
...
- `obs-evo-cand-001637-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001637-route-evolution-graph`
