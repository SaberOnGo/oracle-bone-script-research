...
- External category reference: `evobc-cat-04334`
- Source category ID: `04334`
- Source label for human review: `欙`
- Source codepoints: `U+6B19`
...
- `obs-evo-cand-004334-route-category-staging`
...
- `obs-evo-cand-004334-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004334-route-evolution-graph`
