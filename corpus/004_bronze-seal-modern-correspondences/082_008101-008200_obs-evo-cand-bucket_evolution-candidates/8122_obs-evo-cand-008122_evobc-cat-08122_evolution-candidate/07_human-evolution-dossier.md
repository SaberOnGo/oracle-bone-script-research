...
- External category reference: `evobc-cat-08122`
- Source category ID: `08122`
- Source label for human review: `訂`
...
- `obs-evo-cand-008122-route-category-staging`
...
- `obs-evo-cand-008122-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008122-route-evolution-graph`
