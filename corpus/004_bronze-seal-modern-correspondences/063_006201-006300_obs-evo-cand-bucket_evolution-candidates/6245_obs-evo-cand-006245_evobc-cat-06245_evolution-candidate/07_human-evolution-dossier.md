...
Project ID: `obs-evo-cand-006245`
...
- Project ID: `obs-evo-cand-006245`
- EVOBC category candidate ID: `evobc-evo-cat-06245`
- External category reference: `evobc-cat-06245`
- Source category ID: `06245`
- Source label for human review: `笯`
- Source codepoints: `U+7B2F`
...
- `obs-evo-cand-006245-route-category-staging`
...
- `obs-evo-cand-006245-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006245-route-evolution-graph`
