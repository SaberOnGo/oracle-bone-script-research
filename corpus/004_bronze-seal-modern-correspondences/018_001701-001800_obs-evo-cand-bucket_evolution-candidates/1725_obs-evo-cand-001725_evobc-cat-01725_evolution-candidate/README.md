# obs-evo-cand-001725 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-001725`
- EVOBC category candidate ID: `evobc-evo-cat-01725`
- External category ref: `evobc-cat-01725`
- Source label: `噬`
- Source codepoints: `U+566C`
- Image reference count: `20`
- Era token counts: `SS:1;WSC:19`
- Source token counts: `Book:19;Web:1`
