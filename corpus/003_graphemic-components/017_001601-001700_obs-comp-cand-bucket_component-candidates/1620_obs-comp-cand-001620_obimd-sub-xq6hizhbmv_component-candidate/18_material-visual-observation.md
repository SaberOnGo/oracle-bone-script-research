# Material Visual Observation / obs-comp-cand-001620 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001620`
- External reference / 外部参照: `obimd-sub-xq6hizhbmv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017296_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xq6hizhbmv/xq6hizhbmv/xq6hizhbmv.png`
- Checksum / 校验和:
  `f24e9fc24be4a78954d5e094e1963136e64b693fb3464b25d1a9ff06f51cf0d5`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.72%.
- Marked-pixel bounds: (77,31)–(172,212); span 96 × 182 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.72%。
- 痕迹范围：(77,31)–(172,212)；跨度96 × 182 px；痕迹矩形高于宽。
