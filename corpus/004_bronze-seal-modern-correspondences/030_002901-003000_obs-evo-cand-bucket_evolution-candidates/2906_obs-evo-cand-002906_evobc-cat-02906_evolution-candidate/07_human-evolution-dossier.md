...
- External category reference: `evobc-cat-02906`
- Source category ID: `02906`
- Source label for human review: `志`
- Source codepoints: `U+5FD7`
- Image reference count in source metadata: `94`
...
- `obs-evo-cand-002906-route-category-staging`
...
- `obs-evo-cand-002906-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002906-route-evolution-graph`
