# obs-char-000204 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000204`
- primary external id: `hust-obc-cat-0227`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/204_obs-char-000204_hust-obc-cat-0227_orac
  le-character/03_visual-assets/001_asset-000209_hust-obc-cat-0227_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0227/G_0227_前8.13.2合21623子組.png
  `
- asset id: `asset-000209`
...
- source category: `0227`
- validation class: `203`
- source image route: `HUST-OBC/deciphered/0227/G_0227_前8.13.2合21623子組.png`
- asset id: `asset-000209`
...
- English observation: `The very narrow image has a thin vertical stroke
  with a short curved branch projecting toward the lower right.`
- 中文观察: `极狭长图像有细竖笔，并在下方右侧伸出短弯曲分支。`
...
- dataset label text: `㓙`
- dataset label codepoints: `U+34D9`
...
- filename catalog route clues: `Heji-like filename clue: 合21623
  (G_0227_前8.13.2合21623子組.png)`
...
- Which source records identify obs-char-000204 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000204？
