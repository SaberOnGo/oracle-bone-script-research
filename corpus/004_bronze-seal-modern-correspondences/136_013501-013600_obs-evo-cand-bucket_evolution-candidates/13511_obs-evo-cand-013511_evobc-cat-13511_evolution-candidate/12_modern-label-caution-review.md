# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013511
...
- EVOBC candidate category: `evobc-evo-cat-13511`.
- Source label for search only: `𭔐`.
- Source codepoints for search only: `U+2D510`.
