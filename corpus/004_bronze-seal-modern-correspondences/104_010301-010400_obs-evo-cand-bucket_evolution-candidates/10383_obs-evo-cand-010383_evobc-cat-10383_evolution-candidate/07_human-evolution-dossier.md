...
- External category reference: `evobc-cat-10383`
- Source category ID: `10383`
- Source label for human review: `鮁`
- Source codepoints: `U+9B81`
...
- `obs-evo-cand-010383-route-category-staging`
...
- `obs-evo-cand-010383-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010383-route-evolution-graph`
