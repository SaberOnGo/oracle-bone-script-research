...
- External category reference: `evobc-cat-00650`
- Source category ID: `00650`
- Source label for human review: `丿`
...
- `obs-evo-cand-000650-route-category-staging`
...
- `obs-evo-cand-000650-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000650-route-evolution-graph`
