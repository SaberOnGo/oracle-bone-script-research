...
- Project ID: `obs-evo-cand-012272`
- EVOBC category candidate ID: `evobc-evo-cat-12272`
- External category reference: `evobc-cat-12272`
- Source category ID: `12272`
- Source label for human review: `𧲷`
- Source codepoints: `U+27CB7`
...
- `obs-evo-cand-012272-route-category-staging`
...
- `obs-evo-cand-012272-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012272-route-evolution-graph`
