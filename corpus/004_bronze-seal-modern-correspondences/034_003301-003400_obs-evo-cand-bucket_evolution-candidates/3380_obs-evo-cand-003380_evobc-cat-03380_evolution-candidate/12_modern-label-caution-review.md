# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003380
...
- EVOBC candidate category: `evobc-evo-cat-03380`.
- Source label for search only: `捪`.
- Source codepoints for search only: `U+636A`.
