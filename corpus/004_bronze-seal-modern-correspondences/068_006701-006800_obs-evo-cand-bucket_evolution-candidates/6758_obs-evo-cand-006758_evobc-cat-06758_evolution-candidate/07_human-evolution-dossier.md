...
Project ID: `obs-evo-cand-006758`
...
- Project ID: `obs-evo-cand-006758`
- EVOBC category candidate ID: `evobc-evo-cat-06758`
- External category reference: `evobc-cat-06758`
- Source category ID: `06758`
- Source label for human review: `续`
- Source codepoints: `U+7EED`
...
- `obs-evo-cand-006758-route-category-staging`
...
- `obs-evo-cand-006758-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006758-route-evolution-graph`
