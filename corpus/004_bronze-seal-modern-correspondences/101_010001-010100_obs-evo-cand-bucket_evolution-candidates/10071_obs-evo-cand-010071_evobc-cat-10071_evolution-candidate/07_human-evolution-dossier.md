...
- External category reference: `evobc-cat-10071`
- Source category ID: `10071`
- Source label for human review: `颺`
...
- `obs-evo-cand-010071-route-category-staging`
...
- `obs-evo-cand-010071-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010071-route-evolution-graph`
