...
- External category reference: `evobc-cat-04541`
- Source category ID: `04541`
- Source label for human review: `沔`
- Source codepoints: `U+6C94`
...
- `obs-evo-cand-004541-route-category-staging`
...
- `obs-evo-cand-004541-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004541-route-evolution-graph`
