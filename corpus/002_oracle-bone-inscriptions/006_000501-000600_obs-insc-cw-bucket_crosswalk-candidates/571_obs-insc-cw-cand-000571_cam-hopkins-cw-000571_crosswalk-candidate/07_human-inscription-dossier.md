...
- Yingguo / 英国所藏: `y2589` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `602` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `602` in source row; primary catalog entry pending
- Heji / 合集: `41870` in source row; primary catalog entry pending
