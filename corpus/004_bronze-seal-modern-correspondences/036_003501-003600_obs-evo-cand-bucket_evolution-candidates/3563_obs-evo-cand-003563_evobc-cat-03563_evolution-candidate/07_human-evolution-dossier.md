...
- External category reference: `evobc-cat-03563`
- Source category ID: `03563`
- Source label for human review: `攻`
...
- `obs-evo-cand-003563-route-category-staging`
...
- `obs-evo-cand-003563-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003563-route-evolution-graph`
