# obs-unk-004145 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/045_obs-unk-004145_h
  ust-obc-und-L-004145_oracle-character-candidate/03_visual-assets/001_asset
  -005738_hust-obc-und-L-004145_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4145/L_？_8967.jpg`
- asset id: `asset-005738`
...
- source class: `HUST-OBC/undeciphered/L/4145/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4145/L_？_8967.jpg`
- asset id: `asset-005738`
...
- English observation: A thin central trace sits below an upper-left mark
  and an upper-right rounded dark mark.
- 中文观察：较细中央痕迹位于左上痕迹和右上圆弧状深色痕迹下方。
...
- Which source records identify obs-unk-004145 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004145？
