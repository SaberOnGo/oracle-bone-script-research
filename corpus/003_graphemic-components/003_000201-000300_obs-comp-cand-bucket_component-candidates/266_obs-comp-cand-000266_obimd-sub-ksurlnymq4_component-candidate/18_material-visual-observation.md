# Material Visual Observation / obs-comp-cand-000266 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000266`
- External reference / 外部参照: `obimd-sub-ksurlnymq4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011911_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ksurlnymq4/ksurlnymq4/ksurlnymq4.png`
- Checksum / 校验和:
  `6fef9ee0c6f6b833c1184a32e51d6a57f01b3fa5643c55add8cd3adb83faaf27`
...
- Marked-pixel bounds: (73,21)–(176,223); span 104 × 203 px; the marked
...
- 痕迹范围：(73,21)–(176,223)；跨度104 × 203 px；痕迹矩形高于宽。
