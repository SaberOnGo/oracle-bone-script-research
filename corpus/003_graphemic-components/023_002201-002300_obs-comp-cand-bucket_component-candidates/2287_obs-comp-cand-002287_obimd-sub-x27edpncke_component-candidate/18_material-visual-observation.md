# Material Visual Observation / obs-comp-cand-002287 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002287`
- External reference / 外部参照: `obimd-sub-x27edpncke`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020171_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5jcghtltbx/x27edpncke/x27edpncke.png`
- Checksum / 校验和:
  `16691309d753d2e1a596481f2172c3e1e375b11ade17262bcf7f67017eaa3d13`
...
- Marked-pixel bounds: (81,30)–(168,213); span 88 × 184 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.38%。
- 痕迹范围：(81,30)–(168,213)；跨度88 × 184 px；痕迹矩形高于宽。
