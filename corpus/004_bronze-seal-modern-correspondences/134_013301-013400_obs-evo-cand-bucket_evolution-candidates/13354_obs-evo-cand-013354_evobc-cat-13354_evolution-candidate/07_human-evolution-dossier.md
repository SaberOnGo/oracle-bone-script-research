...
- Project ID: `obs-evo-cand-013354`
- EVOBC category candidate ID: `evobc-evo-cat-13354`
- External category reference: `evobc-cat-13354`
- Source category ID: `13354`
- Source label for human review: `𬥡`
- Source codepoints: `U+2C961`
...
- `obs-evo-cand-013354-route-category-staging`
...
- `obs-evo-cand-013354-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013354-route-evolution-graph`
