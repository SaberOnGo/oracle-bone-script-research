...
- Yingguo / 英国所藏: `y1179` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `95` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `525` in source row; primary catalog entry pending
- Heji / 合集: `39873` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000199`
