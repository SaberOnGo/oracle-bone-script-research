# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002510
...
- EVOBC candidate category: `evobc-evo-cat-02510`.
- Source label for search only: `屚`.
- Source codepoints for search only: `U+5C5A`.
