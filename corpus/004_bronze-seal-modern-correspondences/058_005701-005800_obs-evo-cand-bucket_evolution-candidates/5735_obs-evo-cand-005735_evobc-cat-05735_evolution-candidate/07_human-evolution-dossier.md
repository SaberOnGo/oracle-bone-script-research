...
- External category reference: `evobc-cat-05735`
- Source category ID: `05735`
- Source label for human review: `皴`
...
- `obs-evo-cand-005735-route-category-staging`
...
- `obs-evo-cand-005735-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005735-route-evolution-graph`
