...
- External category reference: `evobc-cat-10890`
- Source category ID: `10890`
- Source label: `𠧴`
...
- `obs-evo-cand-010890-route-category-staging`
...
- `obs-evo-cand-010890-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010890-route-evolution-graph`
