...
- External category reference: `evobc-cat-13464`
- Source category ID: `13464`
- Source label for human review: `𬽢`
- Source codepoints: `U+2CF62`
...
- `obs-evo-cand-013464-route-category-staging`
...
- `obs-evo-cand-013464-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013464-route-evolution-graph`
