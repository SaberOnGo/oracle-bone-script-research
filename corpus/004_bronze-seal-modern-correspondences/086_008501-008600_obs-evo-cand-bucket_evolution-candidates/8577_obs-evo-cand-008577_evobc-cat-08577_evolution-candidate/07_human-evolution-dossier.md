...
- Project ID: `obs-evo-cand-008577`
- EVOBC category candidate ID: `evobc-evo-cat-08577`
- External category reference: `evobc-cat-08577`
- Source category ID: `08577`
- Source label for human review: `賚`
- Source codepoints: `U+8CDA`
...
- `obs-evo-cand-008577-route-category-staging`
...
- `obs-evo-cand-008577-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008577-route-evolution-graph`
