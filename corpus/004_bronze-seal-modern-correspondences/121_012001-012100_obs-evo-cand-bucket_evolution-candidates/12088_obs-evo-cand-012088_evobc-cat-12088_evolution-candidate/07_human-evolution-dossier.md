...
- External category reference: `evobc-cat-12088`
- Source category ID: `12088`
- Source label for human review: `𦬕`
- Source codepoints: `U+26B15`
...
- `obs-evo-cand-012088-route-category-staging`
...
- `obs-evo-cand-012088-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012088-route-evolution-graph`
