...
- External category reference: `evobc-cat-12453`
- Source category ID: `12453`
- Source label for human review: `𨞃`
...
- `obs-evo-cand-012453-route-category-staging`
...
- `obs-evo-cand-012453-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012453-route-evolution-graph`
