...
Project ID: `obs-evo-cand-012513`
...
- Project ID: `obs-evo-cand-012513`
- EVOBC category candidate ID: `evobc-evo-cat-12513`
- External category reference: `evobc-cat-12513`
- Source category ID: `12513`
- Source label for human review: `𨷼`
- Source codepoints: `U+28DFC`
...
- `obs-evo-cand-012513-route-category-staging`
...
- `obs-evo-cand-012513-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012513-route-evolution-graph`
