# obs-char-000126 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/126_obs-char-000126_hust-obc-cat-0140_orac
  le-character/03_visual-assets/001_asset-000131_hust-obc-cat-0140_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0140/G_0140_乙4936反合891反賓組.png`
- asset id: `asset-000131`
...
- source category: `0140`
- validation class: `125`
- source image route: `HUST-OBC/deciphered/0140/G_0140_乙4936反合891反賓組.png`
- asset id: `asset-000131`
...
- English observation: `The image contains four long upright curved strokes
  with pointed upper tips and uneven tapering lower ends.`
- 中文观察: `图像含四道长而直立的弯曲笔画，上端有尖点，下端收笔长短不齐。`
...
- dataset label text: `㒂`
- dataset label codepoints: `U+3482`
...
- filename catalog route clues: `Heji-like filename clue: 合891
...
- Which source records identify obs-char-000126 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000126？
