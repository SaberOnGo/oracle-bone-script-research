# Material Visual Observation / obs-comp-cand-000638 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000638`
- External reference / 外部参照: `obimd-sub-6vdibqvqd8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013201_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6vdibqvqd8/6vdibqvqd8/6vdibqvqd8.png`
- Checksum / 校验和:
  `750aeab57269d5bd1f4e2a0215dda2b25ab3037bf50483a573cc010f2058d06f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.33%.
- Marked-pixel bounds: (76,22)–(177,224); span 102 × 203 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.33%。
- 痕迹范围：(76,22)–(177,224)；跨度102 × 203 px；痕迹矩形高于宽。
