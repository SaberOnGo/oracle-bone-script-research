# Material Visual Observation / obs-comp-cand-002098 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002098`
- External reference / 外部参照: `obimd-sub-ghln7uplih`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019544_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ghln7uplih/ghln7uplih/ghln7uplih.png`
- Checksum / 校验和:
  `8949a248da0342e1fc9681dbcf2f9388191044eaa627817ca9888a7cb235aae9`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.14%.
- Marked-pixel bounds: (73,25)–(194,223); span 122 × 199 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.14%。
- 痕迹范围：(73,25)–(194,223)；跨度122 × 199 px；痕迹矩形高于宽。
