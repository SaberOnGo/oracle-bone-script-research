...
- `obs-evo-cand-002917-route-category-staging`
...
- `obs-evo-cand-002917-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002917-route-evolution-graph`
