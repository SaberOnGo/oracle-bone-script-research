# obs-unk-004321 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/021_obs-unk-004321_h
  ust-obc-und-L-004321_oracle-character-candidate/03_visual-assets/001_asset
  -005914_hust-obc-und-L-004321_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4321/L_？_9554.jpg`
- asset id: `asset-005914`
...
- source class: `HUST-OBC/undeciphered/L/4321/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4321/L_？_9554.jpg`
- asset id: `asset-005914`
...
- English observation: `Broad upper curve and separated lower strokes
  recorded.`
- 中文观察: `已记录上部宽弧和分开的下部痕迹。`
...
- Which source records identify obs-unk-004321 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004321？
