...
Project ID: `obs-evo-cand-002222`
...
- Project ID: `obs-evo-cand-002222`
- EVOBC category candidate ID: `evobc-evo-cat-02222`
- External category reference: `evobc-cat-02222`
- Source category ID: `02222`
- Source label for human review: `媅`
- Source codepoints: `U+5A85`
...
- `obs-evo-cand-002222-route-category-staging`
...
- `obs-evo-cand-002222-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002222-route-evolution-graph`
