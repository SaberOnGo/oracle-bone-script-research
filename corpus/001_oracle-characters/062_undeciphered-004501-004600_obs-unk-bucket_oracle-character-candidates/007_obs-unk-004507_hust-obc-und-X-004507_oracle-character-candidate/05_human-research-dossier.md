# obs-unk-004507 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/007_obs-unk-004507_h
  ust-obc-und-X-004507_oracle-character-candidate/03_visual-assets/001_asset
  -006100_hust-obc-und-X-004507_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/63/X_？_8248_1.png`
- asset id: `asset-006100`
...
- source class: `HUST-OBC/undeciphered/X/63/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/63/X_？_8248_1.png`
- asset id: `asset-006100`
...
- English observation: `The left hooked curve, right trace, and detached upper
  marks are directly recorded.`
- 中文观察: `已直接记录左侧钩转弧痕、右侧下行痕和上部小分离痕。`
...
- Which source records identify obs-unk-004507 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004507？
