# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000706
...
- EVOBC candidate category: `evobc-evo-cat-00706`.
- Source label for search only: `享`.
- Source codepoints for search only: `U+4EAB`.
