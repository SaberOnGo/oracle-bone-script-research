...
- Project ID: `obs-evo-cand-006716`
- EVOBC category candidate ID: `evobc-evo-cat-06716`
- External category reference: `evobc-cat-06716`
- Source category ID: `06716`
- Source label for human review: `纕`
- Source codepoints: `U+7E95`
...
- `obs-evo-cand-006716-route-category-staging`
...
- `obs-evo-cand-006716-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006716-route-evolution-graph`
