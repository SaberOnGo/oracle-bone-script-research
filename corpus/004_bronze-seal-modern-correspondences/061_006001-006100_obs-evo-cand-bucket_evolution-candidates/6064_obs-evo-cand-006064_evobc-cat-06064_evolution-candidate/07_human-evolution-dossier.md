...
- Project ID: `obs-evo-cand-006064`
- EVOBC category candidate ID: `evobc-evo-cat-06064`
- External category reference: `evobc-cat-06064`
- Source category ID: `06064`
- Source label for human review: `秘`
- Source codepoints: `U+79D8`
...
- `obs-evo-cand-006064-route-category-staging`
...
- `obs-evo-cand-006064-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006064-route-evolution-graph`
