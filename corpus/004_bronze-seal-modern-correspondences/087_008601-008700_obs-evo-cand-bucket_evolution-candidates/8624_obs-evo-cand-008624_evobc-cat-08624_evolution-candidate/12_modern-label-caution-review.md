# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008624
...
- EVOBC candidate category: `evobc-evo-cat-08624`.
- Source label for search only: `贫`.
- Source codepoints for search only: `U+8D2B`.
