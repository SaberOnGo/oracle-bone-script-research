# obs-comp-cand-001923 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001923`
- 首选外部 ID: `obimd-sub-mywhauy2tm`
- OBIMD subcharacter UID: `mywhauy2tm`
- OBIMD main character UID: `mywhauy2tm`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+4F9C;U+FAF01; U+FAF02
