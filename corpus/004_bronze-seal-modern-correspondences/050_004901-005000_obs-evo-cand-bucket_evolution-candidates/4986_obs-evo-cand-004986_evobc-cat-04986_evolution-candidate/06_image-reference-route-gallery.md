...
- `obs-evo-cand-004986-route-category-staging`
...
- `obs-evo-cand-004986-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004986-route-evolution-graph`
