# obs-char-000731 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000731`
- primary external id: `hust-obc-cat-0832`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/731_obs-char-000731_hust-obc-cat-0832_orac
  le-character/03_visual-assets/001_asset-000736_hust-obc-cat-0832_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0832/G_0832_珠121合37363黃組.png`
- asset id: `asset-000736`
...
- source category: `0832`
- validation class: `730`
- source image route: `HUST-OBC/deciphered/0832/G_0832_珠121合37363黃組.png`
- asset id: `asset-000736`
...
- English observation: `A single bold vertical silhouette forks into two
  rounded upper arms, narrows at the middle, then expands into short side
  projections and a pointed lower tail.`
...
- dataset label text: `㜶`
- dataset label codepoints: `U+3736`
...
- filename catalog route clues: `Heji-like filename clue: 合37363
  (G_0832_珠121合37363黃組.png)`
...
- Which source records identify obs-char-000731 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000731？
