...
- Project ID: `obs-evo-cand-000217`
- EVOBC category candidate ID: `evobc-evo-cat-00217`
- External category reference: `evobc-cat-00217`
- Source category ID: `00217`
- Source label for human review: `㵯`
- Source codepoints: `U+3D6F`
...
- `obs-evo-cand-000217-route-category-staging`
...
- `obs-evo-cand-000217-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000217-route-evolution-graph`
