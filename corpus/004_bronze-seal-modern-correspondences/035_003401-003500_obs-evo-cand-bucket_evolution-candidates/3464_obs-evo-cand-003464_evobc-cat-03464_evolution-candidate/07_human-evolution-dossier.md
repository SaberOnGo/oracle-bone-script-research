...
- External category reference: `evobc-cat-03464`
- Source category ID: `03464`
- Source label for human review: `搵`
- Source codepoints: `U+6435`
...
- `obs-evo-cand-003464-route-category-staging`
...
- `obs-evo-cand-003464-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003464-route-evolution-graph`
