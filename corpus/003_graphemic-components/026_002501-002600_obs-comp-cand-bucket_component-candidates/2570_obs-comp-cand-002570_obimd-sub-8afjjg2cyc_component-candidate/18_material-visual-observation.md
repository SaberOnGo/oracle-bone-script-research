# Material Visual Observation / obs-comp-cand-002570 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002570`
- External reference / 外部参照: `obimd-sub-8afjjg2cyc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021102_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8afjjg2cyc/8afjjg2cyc/8afjjg2cyc.png`
- Checksum / 校验和:
  `62253063f50be331370a95ff0594669aba22e1d91cd191cd816c72f93e88d04f`
...
- Marked-pixel bounds: (80,48)–(169,212); span 90 × 165 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.68%。
- 痕迹范围：(80,48)–(169,212)；跨度90 × 165 px；痕迹矩形高于宽。
