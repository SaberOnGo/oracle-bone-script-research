# Material Visual Observation / obs-comp-cand-002579 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002579`
- External reference / 外部参照: `obimd-sub-u8a9zwvbvy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021111_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/u8a9zwvbvy/u8a9zwvbvy/u8a9zwvbvy.png`
- Checksum / 校验和:
  `c1c4907701d2ce2bc454c7fc1dc1687b444fda93f5cea672e0d317153d398ebf`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.70%.
- Marked-pixel bounds: (70,38)–(177,206); span 108 × 169 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.70%。
- 痕迹范围：(70,38)–(177,206)；跨度108 × 169 px；痕迹矩形高于宽。
