# Material Visual Observation / obs-comp-cand-002021 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002021`
- External reference / 外部参照: `obimd-sub-9ypw4dceci`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019348_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9ypw4dceci/9ypw4dceci/9ypw4dceci.png`
- Checksum / 校验和:
  `ffbf71467301fc72e4751d9ea104f99d6b1e761f0685a468aee66153b9d598d6`
...
- Marked-pixel bounds: (81,48)–(168,195); span 88 × 148 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.72%。
- 痕迹范围：(81,48)–(168,195)；跨度88 × 148 px；痕迹矩形高于宽。
