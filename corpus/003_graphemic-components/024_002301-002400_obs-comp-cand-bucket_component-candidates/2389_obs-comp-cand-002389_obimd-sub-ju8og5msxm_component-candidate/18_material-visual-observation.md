# Material Visual Observation / obs-comp-cand-002389 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002389`
- External reference / 外部参照: `obimd-sub-ju8og5msxm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020460_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ju8og5msxm/ju8og5msxm/ju8og5msxm.png`
- Checksum / 校验和:
  `c69a4c9a68c82e604ce2bf9743705654798527dbe73c0e9455a4f6f10e73a23a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.93%.
- Marked-pixel bounds: (37,60)–(219,195); span 183 × 136 px; the marked
  rectangle is wider than tall.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.93%。
- 痕迹范围：(37,60)–(219,195)；跨度183 × 136 px；痕迹矩形宽于高。
