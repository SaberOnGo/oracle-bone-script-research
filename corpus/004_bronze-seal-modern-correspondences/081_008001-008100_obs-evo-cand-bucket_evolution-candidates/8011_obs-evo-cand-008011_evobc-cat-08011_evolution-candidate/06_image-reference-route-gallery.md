...
- `obs-evo-cand-008011-route-category-staging`
...
- `obs-evo-cand-008011-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008011-route-evolution-graph`
