...
- Project ID: `obs-evo-cand-012965`
- EVOBC category candidate ID: `evobc-evo-cat-12965`
- External category reference: `evobc-cat-12965`
- Source category ID: `12965`
- Source label for human review: `𫕀`
- Source codepoints: `U+2B540`
...
- `obs-evo-cand-012965-route-category-staging`
...
- `obs-evo-cand-012965-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012965-route-evolution-graph`
