...
- External category reference: `evobc-cat-05728`
- Source category ID: `05728`
- Source label for human review: `皢`
- Source codepoints: `U+76A2`
...
- `obs-evo-cand-005728-route-category-staging`
...
- `obs-evo-cand-005728-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005728-route-evolution-graph`
