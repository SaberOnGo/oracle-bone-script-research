...
- Project ID: `obs-evo-cand-001858`
- EVOBC category candidate ID: `evobc-evo-cat-01858`
- External category reference: `evobc-cat-01858`
- Source category ID: `01858`
- Source label for human review: `垠`
- Source codepoints: `U+57A0`
...
- `obs-evo-cand-001858-route-category-staging`
...
- `obs-evo-cand-001858-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001858-route-evolution-graph`
