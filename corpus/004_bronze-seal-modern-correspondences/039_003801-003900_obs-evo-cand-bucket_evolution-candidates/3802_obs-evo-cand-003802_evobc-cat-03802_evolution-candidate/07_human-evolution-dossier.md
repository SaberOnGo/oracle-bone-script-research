...
Project ID: `obs-evo-cand-003802`
...
- Project ID: `obs-evo-cand-003802`
- EVOBC category candidate ID: `evobc-evo-cat-03802`
- External category reference: `evobc-cat-03802`
- Source category ID: `03802`
- Source label for human review: `曟`
- Source codepoints: `U+66DF`
...
- `obs-evo-cand-003802-route-category-staging`
...
- `obs-evo-cand-003802-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003802-route-evolution-graph`
