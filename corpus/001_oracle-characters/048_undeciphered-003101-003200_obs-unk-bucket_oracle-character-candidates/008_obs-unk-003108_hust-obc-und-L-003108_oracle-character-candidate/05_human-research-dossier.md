# obs-unk-003108 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003108`
- primary external id: `hust-obc-und-L-003108`
...
- local review image route: `corpus/001_oracle-characters/048_undeciphered-003
  101-003200_obs-unk-bucket_oracle-character-candidates/008_obs-unk-003108_h
  ust-obc-und-L-003108_oracle-character-candidate/03_visual-assets/001_asset
  -004701_hust-obc-und-L-003108_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3108/L_？_5628.jpg`
- asset id: `asset-004701`
...
- source class: `HUST-OBC/undeciphered/L/3108/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3108/L_？_5628.jpg`
- asset id: `asset-004701`
...
- Which source records identify obs-unk-003108 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003108？
