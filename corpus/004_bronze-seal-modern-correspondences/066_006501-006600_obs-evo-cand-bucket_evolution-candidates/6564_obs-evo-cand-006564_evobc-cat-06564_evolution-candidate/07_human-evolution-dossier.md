...
- External category reference: `evobc-cat-06564`
- Source category ID: `06564`
...
- `obs-evo-cand-006564-route-category-staging`
...
- `obs-evo-cand-006564-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006564-route-evolution-graph`
