# obs-unk-004580 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004580`
- primary external id: `hust-obc-und-X-004580`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/080_obs-unk-004580_h
  ust-obc-und-X-004580_oracle-character-candidate/03_visual-assets/001_asset
  -006173_hust-obc-und-X-004580_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/136/X_？_7214_1.png`
- asset id: `asset-006173`
...
- source class: `HUST-OBC/undeciphered/X/136/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/136/X_？_7214_1.png`
- asset id: `asset-006173`
...
- English observation: `Curved cap, open loop, diagonal edge, and missing`
  `second image recorded.`
- 中文观察: `已记录弧形顶、开放环、斜边以及缺失的第二张图。`
...
- Which source records identify obs-unk-004580 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004580？
