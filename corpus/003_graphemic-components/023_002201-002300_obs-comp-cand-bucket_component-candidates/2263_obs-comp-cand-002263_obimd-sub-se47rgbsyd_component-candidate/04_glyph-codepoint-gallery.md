# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002263
...
| --- | --- | --- | --- |
| `obimd-glyph-link-034947` | 򲤪󼿨 | `U+B292A;U+FCFE8` | `reviewed_metadata_only` |
| `obimd-glyph-link-034948` | 󼿩 | `U+FCFE9` | `reviewed_metadata_only` |
