# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006720
...
- EVOBC candidate category: `evobc-evo-cat-06720`.
- Source label for search only: `纚`.
- Source codepoints for search only: `U+7E9A`.
