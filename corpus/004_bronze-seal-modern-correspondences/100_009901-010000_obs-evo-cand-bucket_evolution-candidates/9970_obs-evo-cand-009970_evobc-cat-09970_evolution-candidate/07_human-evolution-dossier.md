...
- External category reference: `evobc-cat-09970`
- Source category ID: `09970`
- Source label for human review: `頃`
- Source codepoints: `U+9803`
...
- `obs-evo-cand-009970-route-category-staging`
...
- `obs-evo-cand-009970-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009970-route-evolution-graph`
