...
- External category reference: `evobc-cat-10582`
- Source category ID: `10582`
- Source label for human review: `鸟`
...
- `obs-evo-cand-010582-route-category-staging`
...
- `obs-evo-cand-010582-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010582-route-evolution-graph`
