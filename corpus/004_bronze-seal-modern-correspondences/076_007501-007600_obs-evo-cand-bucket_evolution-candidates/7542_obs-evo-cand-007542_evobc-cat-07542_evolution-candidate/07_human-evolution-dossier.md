...
- Project ID: `obs-evo-cand-007542`
- EVOBC category candidate ID: `evobc-evo-cat-07542`
- External category reference: `evobc-cat-07542`
- Source category ID: `07542`
- Source label for human review: `蓻`
- Source codepoints: `U+84FB`
...
- `obs-evo-cand-007542-route-category-staging`
...
- `obs-evo-cand-007542-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007542-route-evolution-graph`
