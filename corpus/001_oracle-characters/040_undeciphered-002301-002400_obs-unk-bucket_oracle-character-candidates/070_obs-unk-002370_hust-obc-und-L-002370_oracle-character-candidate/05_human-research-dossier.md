# obs-unk-002370 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002370`
- primary external id: `hust-obc-und-L-002370`
...
- local review image route: `corpus/001_oracle-characters/040_undeciphered-002
  301-002400_obs-unk-bucket_oracle-character-candidates/070_obs-unk-002370_h
  ust-obc-und-L-002370_oracle-character-candidate/03_visual-assets/001_asset
  -003963_hust-obc-und-L-002370_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2370/L_？_3225.jpg`
- asset id: `asset-003963`
...
- source class: `HUST-OBC/undeciphered/L/2370/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2370/L_？_3225.jpg`
- asset id: `asset-003963`
...
- Which source records identify obs-unk-002370 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002370？
