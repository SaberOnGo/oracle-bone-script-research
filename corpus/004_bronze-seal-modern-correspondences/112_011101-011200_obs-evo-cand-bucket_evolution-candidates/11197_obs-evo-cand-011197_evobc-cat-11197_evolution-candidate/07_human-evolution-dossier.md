...
- External category reference: `evobc-cat-11197`
- Source category ID: `11197`
- Source label for human review: `𢓀`
...
- `obs-evo-cand-011197-route-category-staging`
...
- `obs-evo-cand-011197-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011197-route-evolution-graph`
