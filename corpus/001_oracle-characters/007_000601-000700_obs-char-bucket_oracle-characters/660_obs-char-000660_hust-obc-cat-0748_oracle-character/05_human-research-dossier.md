# obs-char-000660 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000660`
- primary external id: `hust-obc-cat-0748`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/660_obs-char-000660_hust-obc-cat-0748_orac
  le-character/03_visual-assets/001_asset-000665_hust-obc-cat-0748_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0748/G_0748_佚274合31622何組.png`
- asset id: `asset-000665`
...
- source category: `0748`
- validation class: `659`
- source image route: `HUST-OBC/deciphered/0748/G_0748_佚274合31622何組.png`
- asset id: `asset-000665`
...
- English observation: `The tiny image contains two detached cross-shaped
  marks at upper left, a small loop on a forked stem below them, and a
  separate crossed zigzag form at right.`
- 中文观察: `微小图像含左上两个分离叉形痕、其下叉干上的小环，以及右侧分离交叉锯折形。`
...
- dataset label text: `㛢`
- dataset label codepoints: `U+36E2`
...
- filename catalog route clues: `Heji-like filename clue: 合31622
  (G_0748_佚274合31622何組.png)`
...
- Which source records identify obs-char-000660 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000660？
