# obs-char-001294 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001294`
- primary external id: `hust-obc-cat-1446_1447`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1294_obs-char-001294_hust-obc-cat-1446_144
  7_oracle-character/03_visual-assets/001_asset-001299_hust-obc-cat-1446_144
  7_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1446_1447/1446/G_1446_乙468合3619
  6.png`
- asset id: `asset-001299`
...
- source category: `1446_1447`
- validation class: `1293`
- source image route: `HUST-OBC/deciphered/1446_1447/1446/G_1446_乙468合36196.pn
  g`
- asset id: `asset-001299`
...
- English observation: `A small tall angular cluster has a sloping upper
  enclosure, a central descending stroke, and a pointed base.`
- 中文观察: `小型高直折角笔画群有倾斜上部框形、中央下行笔画和尖状底部。`
...
- dataset label text: `㦜㦝`
- dataset label codepoints: `U+399C;U+399D`
...
- graph edge count: `2`
- codepoint routes: `U+399C;U+399D`
...
- filename catalog route clues: `Heji-like filename clue: 合36196
  (G_1446_乙468合36196.png)`
...
- Which source records identify obs-char-001294 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001294？
