...
Project ID: `obs-evo-cand-006002`
...
- Project ID: `obs-evo-cand-006002`
- EVOBC category candidate ID: `evobc-evo-cat-06002`
- External category reference: `evobc-cat-06002`
- Source category ID: `06002`
- Source label for human review: `祰`
- Source codepoints: `U+7970`
...
- `obs-evo-cand-006002-route-category-staging`
...
- `obs-evo-cand-006002-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006002-route-evolution-graph`
