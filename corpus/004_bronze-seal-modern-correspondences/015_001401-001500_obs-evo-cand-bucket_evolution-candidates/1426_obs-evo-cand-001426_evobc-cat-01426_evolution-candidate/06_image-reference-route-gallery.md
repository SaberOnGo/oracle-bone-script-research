...
- `obs-evo-cand-001426-route-category-staging`
...
- `obs-evo-cand-001426-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001426-route-evolution-graph`
