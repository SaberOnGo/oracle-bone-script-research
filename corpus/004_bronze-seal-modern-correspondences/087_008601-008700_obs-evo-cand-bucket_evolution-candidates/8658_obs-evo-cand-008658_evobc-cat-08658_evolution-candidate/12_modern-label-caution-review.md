# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008658
...
- EVOBC candidate category: `evobc-evo-cat-08658`.
- Source label for search only: `赬`.
- Source codepoints for search only: `U+8D6C`.
