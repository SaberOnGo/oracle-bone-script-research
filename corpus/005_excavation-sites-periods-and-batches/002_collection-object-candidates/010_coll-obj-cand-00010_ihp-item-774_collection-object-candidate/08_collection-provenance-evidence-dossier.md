# Collection Provenance Evidence Dossier / 馆藏来源证据档案: coll-obj-cand-00010
...
The page displays `隻（獲）白兕。`. It remains source-reported text, not an
independent transcription or project reading.
