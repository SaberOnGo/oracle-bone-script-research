...
- Project ID: `obs-evo-cand-001167`
- EVOBC category candidate ID: `evobc-evo-cat-01167`
- External category reference: `evobc-cat-01167`
- Source category ID: `01167`
- Source label for human review: `凵`
- Source codepoints: `U+51F5`
...
- `obs-evo-cand-001167-route-category-staging`
...
- `obs-evo-cand-001167-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001167-route-evolution-graph`
