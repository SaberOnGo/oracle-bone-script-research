...
- External category reference: `evobc-cat-01310`
- Source category ID: `01310`
- Source label for human review: `勮`
...
- `obs-evo-cand-001310-route-category-staging`
...
- `obs-evo-cand-001310-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001310-route-evolution-graph`
