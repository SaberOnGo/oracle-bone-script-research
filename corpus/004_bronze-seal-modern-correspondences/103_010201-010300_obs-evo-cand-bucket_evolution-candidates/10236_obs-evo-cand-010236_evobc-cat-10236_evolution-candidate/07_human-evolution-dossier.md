...
- External category reference: `evobc-cat-10236`
- Source category ID: `10236`
- Source label for human review: `騱`
...
- `obs-evo-cand-010236-route-category-staging`
...
- `obs-evo-cand-010236-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010236-route-evolution-graph`
