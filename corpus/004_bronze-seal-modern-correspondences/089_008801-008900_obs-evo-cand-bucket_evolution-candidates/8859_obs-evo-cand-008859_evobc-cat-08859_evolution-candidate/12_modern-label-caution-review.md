# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008859
...
- EVOBC candidate category: `evobc-evo-cat-08859`.
- Source label for search only: `輾`.
- Source codepoints for search only: `U+8F3E`.
