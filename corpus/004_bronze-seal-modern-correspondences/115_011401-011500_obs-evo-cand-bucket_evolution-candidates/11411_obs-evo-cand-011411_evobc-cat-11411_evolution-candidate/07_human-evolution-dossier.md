...
Project ID: `obs-evo-cand-011411`
...
- Project ID: `obs-evo-cand-011411`
- EVOBC category candidate ID: `evobc-evo-cat-11411`
- External category reference: `evobc-cat-11411`
- Source category ID: `11411`
- Source label for human review: `𣉬`
- Source codepoints: `U+2326C`
...
- `obs-evo-cand-011411-route-category-staging`
...
- `obs-evo-cand-011411-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011411-route-evolution-graph`
