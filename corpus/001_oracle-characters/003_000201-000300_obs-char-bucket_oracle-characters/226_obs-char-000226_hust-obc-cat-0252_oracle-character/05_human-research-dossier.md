# obs-char-000226 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000226`
- primary external id: `hust-obc-cat-0252`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/226_obs-char-000226_hust-obc-cat-0252_orac
  le-character/03_visual-assets/001_asset-000231_hust-obc-cat-0252_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0252/G_0252_後2.25.11(甲).png`
- asset id: `asset-000231`
...
- source category: `0252`
- validation class: `225`
- source image route: `HUST-OBC/deciphered/0252/G_0252_後2.25.11(甲).png`
- asset id: `asset-000231`
...
- English observation: `The image has a rounded lower frame, several short
  forked upper strokes, and small interior marks around a central vertical
  axis.`
- 中文观察: `图像下部有圆弧框，上方有数道短分叉笔，中央竖轴周围有小内部痕迹。`
...
- dataset label text: `㓲`
- dataset label codepoints: `U+34F2`
...
- Which source records identify obs-char-000226 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000226？
