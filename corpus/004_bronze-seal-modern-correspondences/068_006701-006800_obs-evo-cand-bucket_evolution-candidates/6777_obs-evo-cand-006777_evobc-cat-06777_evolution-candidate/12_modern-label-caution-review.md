# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006777
...
- EVOBC candidate category: `evobc-evo-cat-06777`.
- Source label for search only: `缚`.
- Source codepoints for search only: `U+7F1A`.
