# Material Visual Observation / obs-comp-cand-002445 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002445`
- External reference / 外部参照: `obimd-sub-sinjn961eq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020617_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/sinjn961eq/sinjn961eq/sinjn961eq.png`
- Checksum / 校验和:
  `48e50a71942bbc0e89bce2ad7cfb9e4d6ca5f192267d00a62d2002ac8bf4ae0f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.25%.
- Marked-pixel bounds: (75,41)–(195,209); span 121 × 169 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.25%。
- 痕迹范围：(75,41)–(195,209)；跨度121 × 169 px；痕迹矩形高于宽。
