...
Project ID: `obs-evo-cand-000763`
...
- Project ID: `obs-evo-cand-000763`
- EVOBC category candidate ID: `evobc-evo-cat-00763`
- External category reference: `evobc-cat-00763`
- Source category ID: `00763`
- Source label for human review: `伉`
- Source codepoints: `U+4F09`
...
- `obs-evo-cand-000763-route-category-staging`
...
- `obs-evo-cand-000763-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000763-route-evolution-graph`
