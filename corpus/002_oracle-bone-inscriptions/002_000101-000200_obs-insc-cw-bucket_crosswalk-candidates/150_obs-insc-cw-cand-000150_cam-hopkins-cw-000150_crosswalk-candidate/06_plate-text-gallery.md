...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000150` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y834` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `155` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `569` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `40075` [route_present_image_or_text_not_collected]
