...
- External category reference: `evobc-cat-04282`
- Source category ID: `04282`
- Source label for human review: `檄`
- Source codepoints: `U+6A84`
...
- `obs-evo-cand-004282-route-category-staging`
...
- `obs-evo-cand-004282-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004282-route-evolution-graph`
