# obs-unk-004183 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004183`
- primary external id: `hust-obc-und-L-004183`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/083_obs-unk-004183_h
  ust-obc-und-L-004183_oracle-character-candidate/03_visual-assets/001_asset
  -005776_hust-obc-und-L-004183_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4183/L_？_9067.jpg`
- asset id: `asset-005776`
...
- source class: `HUST-OBC/undeciphered/L/4183/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4183/L_？_9067.jpg`
- asset id: `asset-005776`
...
- English observation: A central enclosure contains a dark mark and two upper
  projections.
- 中文观察: 中央包围轮廓内有深色痕迹，上缘有两处外突。
...
- Which source records identify obs-unk-004183 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004183？
