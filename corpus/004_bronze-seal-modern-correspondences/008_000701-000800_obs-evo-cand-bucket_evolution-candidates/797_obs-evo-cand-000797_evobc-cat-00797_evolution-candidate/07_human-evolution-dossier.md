...
- External category reference: `evobc-cat-00797`
- Source category ID: `00797`
- Source label for human review: `佋`
...
- `obs-evo-cand-000797-route-category-staging`
...
- `obs-evo-cand-000797-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000797-route-evolution-graph`
