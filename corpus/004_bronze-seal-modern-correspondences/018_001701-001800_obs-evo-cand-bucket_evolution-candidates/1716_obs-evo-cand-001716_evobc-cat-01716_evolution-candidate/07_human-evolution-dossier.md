...
- External category reference: `evobc-cat-01716`
- Source category ID: `01716`
- Source label for human review: `噑`
- Source codepoints: `U+5651`
...
- `obs-evo-cand-001716-route-category-staging`
...
- `obs-evo-cand-001716-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001716-route-evolution-graph`
