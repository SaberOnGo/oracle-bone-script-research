# obs-unk-004624 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004624`
- primary external id: `hust-obc-und-X-004624`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/024_obs-unk-004624_h
  ust-obc-und-X-004624_oracle-character-candidate/03_visual-assets/001_asset
  -006217_hust-obc-und-X-004624_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/180/X_？_7218_1.png`
- asset id: `asset-006217`
...
- source class: `HUST-OBC/undeciphered/X/180/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/180/X_？_7218_1.png`
- asset id: `asset-006217`
...
- English observation: `branching center, lower opening, pointed trace`
- 中文观察: `中央分支、下部开口和右下尖状痕已记录。`
...
- Which source records identify obs-unk-004624 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004624？
