# obs-char-000857 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/857_obs-char-000857_hust-obc-cat-0966_orac
  le-character/03_visual-assets/001_asset-000862_hust-obc-cat-0966_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0966/G_0966_甲骨文.png`
- asset id: `asset-000862`
...
- source category: `0966`
- validation class: `856`
- source image route: `HUST-OBC/deciphered/0966/G_0966_甲骨文.png`
- asset id: `asset-000862`
...
- English observation: `A tall curved left stroke and detached short marks
  flank a central pointed enclosure crossed by a horizontal stroke, with a
  long lower stem.`
...
- dataset label text: `㞼`
- dataset label codepoints: `U+37BC`
...
- Which source records identify obs-char-000857 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000857？
