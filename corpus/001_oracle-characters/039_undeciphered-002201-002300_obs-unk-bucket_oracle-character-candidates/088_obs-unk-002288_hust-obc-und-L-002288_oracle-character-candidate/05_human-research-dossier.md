# obs-unk-002288 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002288`
- primary external id: `hust-obc-und-L-002288`
...
- local review image route: `corpus/001_oracle-characters/039_undeciphered-002
  201-002300_obs-unk-bucket_oracle-character-candidates/088_obs-unk-002288_h
  ust-obc-und-L-002288_oracle-character-candidate/03_visual-assets/001_asset
  -003881_hust-obc-und-L-002288_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2288/L_？_2928.jpg`
- asset id: `asset-003881`
...
- source class: `HUST-OBC/undeciphered/L/2288/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2288/L_？_2928.jpg`
- asset id: `asset-003881`
...
- Which source records identify obs-unk-002288 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002288？
