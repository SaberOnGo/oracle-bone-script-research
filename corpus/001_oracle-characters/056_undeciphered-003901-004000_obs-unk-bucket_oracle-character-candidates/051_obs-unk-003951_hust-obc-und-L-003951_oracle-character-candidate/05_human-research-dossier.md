# obs-unk-003951 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/051_obs-unk-003951_h
  ust-obc-und-L-003951_oracle-character-candidate/03_visual-assets/001_asset
  -005544_hust-obc-und-L-003951_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3951/L_？_8337.jpg`
- asset id: `asset-005544`
...
- source class: `HUST-OBC/undeciphered/L/3951/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3951/L_？_8337.jpg`
- asset id: `asset-005544`
...
- English observation: A broad curved trace spans the upper area; several
  narrow diagonal traces descend below it, with one extending farther down.
- 中文观察: 上部有宽弧向痕迹，下方有数条狭窄斜向痕迹，其中一条更向下延伸。
...
- Which source records identify obs-unk-003951 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003951？
