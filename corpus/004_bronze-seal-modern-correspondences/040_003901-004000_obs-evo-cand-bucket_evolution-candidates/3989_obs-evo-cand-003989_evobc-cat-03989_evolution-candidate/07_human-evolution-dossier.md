...
- External category reference: `evobc-cat-03989`
- Source category ID: `03989`
- Source label for human review: `栔`
- Source codepoints: `U+6814`
...
- `obs-evo-cand-003989-route-category-staging`
...
- `obs-evo-cand-003989-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003989-route-evolution-graph`
