...
Project ID: `obs-evo-cand-011765`
...
- Project ID: `obs-evo-cand-011765`
- EVOBC category candidate ID: `evobc-evo-cat-11765`
- External category reference: `evobc-cat-11765`
- Source category ID: `11765`
- Source label for human review: `𥃇`
- Source codepoints: `U+250C7`
...
- `obs-evo-cand-011765-route-category-staging`
...
- `obs-evo-cand-011765-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011765-route-evolution-graph`
