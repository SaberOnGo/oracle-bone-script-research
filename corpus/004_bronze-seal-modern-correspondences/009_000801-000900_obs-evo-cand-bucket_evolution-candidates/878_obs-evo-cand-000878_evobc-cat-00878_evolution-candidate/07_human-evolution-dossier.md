...
- External category reference: `evobc-cat-00878`
- Source category ID: `00878`
- Source label for human review: `俈`
- Source codepoints: `U+4FC8`
- Image reference count in source metadata: `43`
...
- `obs-evo-cand-000878-route-category-staging`
...
- `obs-evo-cand-000878-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000878-route-evolution-graph`
