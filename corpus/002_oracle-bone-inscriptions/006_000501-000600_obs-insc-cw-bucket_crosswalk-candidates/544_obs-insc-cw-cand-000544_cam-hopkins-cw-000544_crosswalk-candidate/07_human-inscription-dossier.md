...
Project ID: `obs-insc-cw-cand-000544`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000544`
...
- Yingguo / 英国所藏: `y2546` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `358` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `453` in source row; primary catalog entry pending
- Heji / 合集: `41819` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000544`
