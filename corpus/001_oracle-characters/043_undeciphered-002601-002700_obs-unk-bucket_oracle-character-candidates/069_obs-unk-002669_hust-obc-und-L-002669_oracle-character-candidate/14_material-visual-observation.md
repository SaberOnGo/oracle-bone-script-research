# Material Visual Observation / obs-unk-002669
...
- English observation: A compact upper knot narrows into a descending central
  stroke. Several short branches spread below, with a longer stroke along
  the right edge.
- 中文观察：紧凑的上部笔痕群收窄为中央下行笔痕。下部向两侧分出数条短
  分支，右缘有一条较长笔痕。
