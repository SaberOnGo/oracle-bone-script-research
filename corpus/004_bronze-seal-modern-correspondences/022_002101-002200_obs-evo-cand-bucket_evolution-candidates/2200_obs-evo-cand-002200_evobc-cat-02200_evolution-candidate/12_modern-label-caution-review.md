# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002200
...
- EVOBC candidate category: `evobc-evo-cat-02200`.
- Source label for search only: `婜`.
- Source codepoints for search only: `U+5A5C`.
