...
- External category reference: `evobc-cat-03569`
- Source category ID: `03569`
- Source label for human review: `敂`
...
- `obs-evo-cand-003569-route-category-staging`
...
- `obs-evo-cand-003569-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003569-route-evolution-graph`
