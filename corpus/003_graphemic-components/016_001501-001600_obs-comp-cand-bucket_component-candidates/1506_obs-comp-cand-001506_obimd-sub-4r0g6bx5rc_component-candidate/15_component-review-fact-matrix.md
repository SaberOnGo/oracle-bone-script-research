# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001506
...
| Glyph or codepoint route / 字形或码位路线 | 36 OBIMD route rows; examples U+9149;U+F8B14; U+F8B15; 另有 34 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 36 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
