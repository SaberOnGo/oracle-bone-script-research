...
- External category reference: `evobc-cat-01377`
- Source category ID: `01377`
- Source label for human review: `单`
- Source codepoints: `U+5355`
...
- `obs-evo-cand-001377-route-category-staging`
...
- `obs-evo-cand-001377-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001377-route-evolution-graph`
