# Material Visual Observation / obs-comp-cand-001743 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001743`
- External reference / 外部参照: `obimd-sub-lvgrvm4vun`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017944_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fybnj2savm/lvgrvm4vun/lvgrvm4vun.png`
- Checksum / 校验和:
  `9a69ceaeb907b7d98b5d3494589f31145b2e64b6c58cb60541a170092792dbda`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.97%.
- Marked-pixel bounds: (75,27)–(176,222); span 102 × 196 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.97%。
- 痕迹范围：(75,27)–(176,222)；跨度102 × 196 px；痕迹矩形高于宽。
