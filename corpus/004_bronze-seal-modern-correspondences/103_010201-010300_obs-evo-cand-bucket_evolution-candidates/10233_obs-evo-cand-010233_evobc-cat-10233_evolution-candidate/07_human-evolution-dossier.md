...
- Project ID: `obs-evo-cand-010233`
- EVOBC category candidate ID: `evobc-evo-cat-10233`
- External category reference: `evobc-cat-10233`
- Source category ID: `10233`
- Source label for human review: `騮`
- Source codepoints: `U+9A2E`
...
- `obs-evo-cand-010233-route-category-staging`
...
- `obs-evo-cand-010233-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010233-route-evolution-graph`
