# Material Visual Observation / obs-comp-cand-002084 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002084`
- External reference / 外部参照: `obimd-sub-65l1kwga5y`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019471_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/65l1kwga5y/65l1kwga5y/65l1kwga5y.png`
- Checksum / 校验和:
  `05f5507aa0774e15fce26053342c1774c81724bcadc37d8d9de5e587f5b390b9`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.81%.
- Marked-pixel bounds: (69,18)–(177,231); span 109 × 214 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.81%。
- 痕迹范围：(69,18)–(177,231)；跨度109 × 214 px；痕迹矩形高于宽。
