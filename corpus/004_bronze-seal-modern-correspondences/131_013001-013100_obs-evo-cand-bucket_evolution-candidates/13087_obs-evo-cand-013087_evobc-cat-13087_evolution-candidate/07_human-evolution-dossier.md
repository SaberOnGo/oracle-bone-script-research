...
- External category reference: `evobc-cat-13087`
- Source category ID: `13087`
- Source label for human review: `𫲾`
- Source codepoints: `U+2BCBE`
...
- `obs-evo-cand-013087-route-category-staging`
...
- `obs-evo-cand-013087-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013087-route-evolution-graph`
