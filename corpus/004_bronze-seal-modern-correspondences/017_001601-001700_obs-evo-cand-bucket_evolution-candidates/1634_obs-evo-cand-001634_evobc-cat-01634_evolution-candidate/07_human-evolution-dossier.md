...
- External category reference: `evobc-cat-01634`
- Source category ID: `01634`
- Source label for human review: `啬`
- Source codepoints: `U+556C`
...
- `obs-evo-cand-001634-route-category-staging`
...
- `obs-evo-cand-001634-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001634-route-evolution-graph`
