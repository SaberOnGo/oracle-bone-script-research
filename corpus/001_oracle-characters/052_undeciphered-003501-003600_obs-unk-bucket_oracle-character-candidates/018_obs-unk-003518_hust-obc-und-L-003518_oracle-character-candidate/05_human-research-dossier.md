# obs-unk-003518 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003518`
- primary external id: `hust-obc-und-L-003518`
...
- local review image route: `corpus/001_oracle-characters/052_undeciphered-003
  501-003600_obs-unk-bucket_oracle-character-candidates/018_obs-unk-003518_h
  ust-obc-und-L-003518_oracle-character-candidate/03_visual-assets/001_asset
  -005111_hust-obc-und-L-003518_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3518/L_？_6909.jpg`
- asset id: `asset-005111`
...
- source class: `HUST-OBC/undeciphered/L/3518/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3518/L_？_6909.jpg`
- asset id: `asset-005111`
...
- Which source records identify obs-unk-003518 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003518？
