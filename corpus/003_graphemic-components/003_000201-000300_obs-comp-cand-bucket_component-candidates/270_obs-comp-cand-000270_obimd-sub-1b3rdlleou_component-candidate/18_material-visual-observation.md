# Material Visual Observation / obs-comp-cand-000270 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000270`
- External reference / 外部参照: `obimd-sub-1b3rdlleou`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011915_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1b3rdlleou/1b3rdlleou/1b3rdlleou.png`
- Checksum / 校验和:
  `a75e7d8611c98606f6a6b2ed53c0d221702c37356f36945af9dcecb0290b82bc`
...
- Marked-pixel bounds: (71,29)–(178,226); span 108 × 198 px; the marked
...
- 痕迹范围：(71,29)–(178,226)；跨度108 × 198 px；痕迹矩形高于宽。
