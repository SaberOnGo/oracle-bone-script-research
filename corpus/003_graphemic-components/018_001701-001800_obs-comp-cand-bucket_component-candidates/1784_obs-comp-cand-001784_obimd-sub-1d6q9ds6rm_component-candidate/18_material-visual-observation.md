# Material Visual Observation / obs-comp-cand-001784 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001784`
- External reference / 外部参照: `obimd-sub-1d6q9ds6rm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018005_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1d6q9ds6rm/1d6q9ds6rm/1d6q9ds6rm.png`
- Checksum / 校验和:
  `998cb651819b21b72bafd56248ee412076e4b6f8c0da8d0d97c16d5b77fbdeb6`
...
- Marked-pixel bounds: (74,35)–(180,207); span 107 × 173 px; the marked
...
- 痕迹范围：(74,35)–(180,207)；跨度107 × 173 px；痕迹矩形高于宽。
