# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002380
...
- EVOBC candidate category: `evobc-evo-cat-02380`.
- Source label for search only: `实`.
- Source codepoints for search only: `U+5B9E`.
