...
|---|---|---|
| Source Codepoint Route | `U+3880` | not identity |
| HUST candidate route | `hust-obc-cat-1162` | not reading |
| OBIMD route | `obimd-main-cand-002325` | not component |
| EVOBC route | `evobc-evo-cat-00097` | not evolution |
