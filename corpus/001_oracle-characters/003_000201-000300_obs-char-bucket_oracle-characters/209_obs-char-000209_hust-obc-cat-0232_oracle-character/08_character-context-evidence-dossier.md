...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0232`
...
- Source image / 来源图: `G_0232_乙2262合4814賓組.png`
- Image / 图像: `001_asset-000214_hust-obc-cat-0232_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合4814
...
- target node: `obimd-main-cand-003002`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- target node: `evobc-evo-cat-00021`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC image references / EvoBC 图像引用数: `28`
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/021_obs-evo-cand-000021_evobc-cat-00021_evoluti
...
- Matched OBIMD main UIDs / OBIMD 主字 UID: `nzqdb3i249`
...
- Source label text / 来源标签文字: `㓞`
- Source label codepoint / 来源标签 codepoint: `U+34DE`
