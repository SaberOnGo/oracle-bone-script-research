...
- External category reference: `evobc-cat-05124`
- Source category ID: `05124`
- Source label for human review: `熊`
...
- `obs-evo-cand-005124-route-category-staging`
...
- `obs-evo-cand-005124-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005124-route-evolution-graph`
