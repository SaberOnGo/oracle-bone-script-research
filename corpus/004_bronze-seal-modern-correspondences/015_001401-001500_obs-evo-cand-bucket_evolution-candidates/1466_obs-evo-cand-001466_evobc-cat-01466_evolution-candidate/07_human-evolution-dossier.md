...
- External category reference: `evobc-cat-01466`
- Source category ID: `01466`
- Source label for human review: `叜`
- Source codepoints: `U+53DC`
...
- `obs-evo-cand-001466-route-category-staging`
...
- `obs-evo-cand-001466-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001466-route-evolution-graph`
