# obs-char-000407 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000407`
- primary external id: `hust-obc-cat-0463`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/407_obs-char-000407_hust-obc-cat-0463_orac
  le-character/03_visual-assets/001_asset-000412_hust-obc-cat-0463_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0463/G_0463_甲骨文.png`
- asset id: `asset-000412`
...
- source category: `0463`
- validation class: `406`
- source image route: `HUST-OBC/deciphered/0463/G_0463_甲骨文.png`
- asset id: `asset-000412`
...
- English observation: `Two separated forms are visible: a compact looped
  angular form at left and a forked vertical stem with short branches at
  right.`
- 中文观察: `可见两个分离形体：左侧为紧凑环折形，右侧为带短分支的分叉竖向主干。`
...
- dataset label text: `㗅`
- dataset label codepoints: `U+35C5`
...
- Which source records identify obs-char-000407 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000407？
