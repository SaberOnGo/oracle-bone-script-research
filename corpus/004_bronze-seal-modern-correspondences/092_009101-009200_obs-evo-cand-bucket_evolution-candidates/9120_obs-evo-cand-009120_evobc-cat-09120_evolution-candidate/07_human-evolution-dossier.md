...
- External category reference: `evobc-cat-09120`
- Source category ID: `09120`
- Source label for human review: `邼`
...
- `obs-evo-cand-009120-route-category-staging`
...
- `obs-evo-cand-009120-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009120-route-evolution-graph`
