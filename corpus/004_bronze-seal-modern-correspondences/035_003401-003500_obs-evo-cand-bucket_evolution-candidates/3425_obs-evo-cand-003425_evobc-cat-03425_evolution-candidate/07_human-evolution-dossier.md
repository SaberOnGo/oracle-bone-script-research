...
- External category reference: `evobc-cat-03425`
- Source category ID: `03425`
- Source label for human review: `插`
...
- `obs-evo-cand-003425-route-category-staging`
...
- `obs-evo-cand-003425-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003425-route-evolution-graph`
