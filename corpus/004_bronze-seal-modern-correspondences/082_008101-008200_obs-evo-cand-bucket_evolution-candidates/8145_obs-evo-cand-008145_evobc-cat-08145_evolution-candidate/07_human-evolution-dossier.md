...
- External category reference: `evobc-cat-08145`
- Source category ID: `08145`
- Source label for human review: `訡`
...
- `obs-evo-cand-008145-route-category-staging`
...
- `obs-evo-cand-008145-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008145-route-evolution-graph`
