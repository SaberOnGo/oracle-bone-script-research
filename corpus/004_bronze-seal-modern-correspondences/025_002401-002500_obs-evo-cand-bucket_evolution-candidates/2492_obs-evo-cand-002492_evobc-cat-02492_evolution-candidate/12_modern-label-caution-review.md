# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002492
...
- EVOBC candidate category: `evobc-evo-cat-02492`.
- Source label for search only: `尽`.
- Source codepoints for search only: `U+5C3D`.
