...
- External category reference: `evobc-cat-02953`
- Source category ID: `02953`
- Source label for human review: `怮`
...
- `obs-evo-cand-002953-route-category-staging`
...
- `obs-evo-cand-002953-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002953-route-evolution-graph`
