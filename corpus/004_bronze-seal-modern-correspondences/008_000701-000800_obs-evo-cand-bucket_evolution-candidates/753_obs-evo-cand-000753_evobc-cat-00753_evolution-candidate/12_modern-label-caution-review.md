# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000753
...
- EVOBC candidate category: `evobc-evo-cat-00753`.
- Source label for search only: `件`.
- Source codepoints for search only: `U+4EF6`.
