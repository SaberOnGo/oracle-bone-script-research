# Material Visual Observation / obs-comp-cand-000418 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000418`
- External reference / 外部参照: `obimd-sub-0zij73e4bo`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012341_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0zij73e4bo/0zij73e4bo/0zij73e4bo.png`
- Checksum / 校验和:
  `1ba50ad5320dd44c10ac7baf73cb5ad323e4be3f55071d6160bc891d5c9c6edd`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.87%.
- Marked-pixel bounds: (85,24)–(164,222); span 80 × 199 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.87%。
- 痕迹范围：(85,24)–(164,222)；跨度80 × 199 px；痕迹矩形高于宽。
