# Material Visual Observation / obs-comp-cand-001291 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001291`
- External reference / 外部参照: `obimd-sub-bxk4wfwnci`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015576_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bxk4wfwnci/bxk4wfwnci/bxk4wfwnci.png`
- Checksum / 校验和:
  `9a4d3533aa9c8d985ccc993ae30ad2ae32480c4de132f6da70f74ac88a0e9208`
...
- Marked-pixel bounds: (91,32)–(158,222); span 68 × 191 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.49%。
- 痕迹范围：(91,32)–(158,222)；跨度68 × 191 px；痕迹矩形高于宽。
