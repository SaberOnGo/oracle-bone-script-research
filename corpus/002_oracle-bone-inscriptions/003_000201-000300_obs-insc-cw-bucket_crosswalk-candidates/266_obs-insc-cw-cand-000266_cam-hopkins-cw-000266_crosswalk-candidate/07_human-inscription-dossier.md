...
- Yingguo / 英国所藏: `y1777` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `544` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `620` in source row; primary catalog entry pending
- Heji / 合集: `40896` in source row; primary catalog entry pending
