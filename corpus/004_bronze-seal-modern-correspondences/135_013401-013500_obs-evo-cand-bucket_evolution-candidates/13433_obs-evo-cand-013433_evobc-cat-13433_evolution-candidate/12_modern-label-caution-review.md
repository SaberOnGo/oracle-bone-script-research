# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013433
...
- EVOBC candidate category: `evobc-evo-cat-13433`.
- Source label for search only: `𬲋`.
- Source codepoints for search only: `U+2CC8B`.
