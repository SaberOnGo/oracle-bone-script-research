...
Project ID: `obs-evo-cand-010330`
...
- Project ID: `obs-evo-cand-010330`
- EVOBC category candidate ID: `evobc-evo-cat-10330`
- External category reference: `evobc-cat-10330`
- Source category ID: `10330`
- Source label for human review: `鬒`
- Source codepoints: `U+9B12`
...
- `obs-evo-cand-010330-route-category-staging`
...
- `obs-evo-cand-010330-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010330-route-evolution-graph`
