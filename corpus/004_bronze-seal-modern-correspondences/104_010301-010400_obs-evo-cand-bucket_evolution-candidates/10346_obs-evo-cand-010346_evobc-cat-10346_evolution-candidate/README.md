# obs-evo-cand-010346 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-010346`
- EVOBC category candidate ID: `evobc-evo-cat-10346`
- External category ref: `evobc-cat-10346`
- Source label: `鬲`
- Source codepoints: `U+9B32`
- Image reference count: `191`
- Era token counts: `BI:92;CS:1;OBC:37;SAC:35;SS:2;WSC:24`
- Source token counts: `Book:101;Web:90`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 37 image references
- era 1 / BI: 92 image references
...
- source 3 / Book:21681: 38 image references
