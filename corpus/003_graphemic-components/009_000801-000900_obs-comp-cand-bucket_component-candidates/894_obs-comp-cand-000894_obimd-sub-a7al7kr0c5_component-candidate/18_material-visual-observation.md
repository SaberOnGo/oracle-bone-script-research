# Material Visual Observation / obs-comp-cand-000894 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000894`
- External reference / 外部参照: `obimd-sub-a7al7kr0c5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013966_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/a7al7kr0c5/a7al7kr0c5/a7al7kr0c5.png`
- Checksum / 校验和:
  `49c4697071237316b4bbe0a04e9817f4ba5aaf668b0426e12bbe47dac514daee`
...
- Marked-pixel bounds: (84,27)–(166,217); span 83 × 191 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.05%。
- 痕迹范围：(84,27)–(166,217)；跨度83 × 191 px；痕迹矩形高于宽。
