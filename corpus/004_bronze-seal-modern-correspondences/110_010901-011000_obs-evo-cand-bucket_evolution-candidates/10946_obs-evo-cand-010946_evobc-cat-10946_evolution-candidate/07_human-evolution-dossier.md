...
- Project ID: `obs-evo-cand-010946`
- EVOBC category candidate ID: `evobc-evo-cat-10946`
- External category reference: `evobc-cat-10946`
- Source category ID: `10946`
- Source label for human review: `𠶸`
- Source codepoints: `U+20DB8`
...
- `obs-evo-cand-010946-route-category-staging`
...
- `obs-evo-cand-010946-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010946-route-evolution-graph`
