...
- Project ID: `obs-evo-cand-001699`
- EVOBC category candidate ID: `evobc-evo-cat-01699`
- External category reference: `evobc-cat-01699`
- Source category ID: `01699`
- Source label for human review: `嘖`
- Source codepoints: `U+5616`
...
- `obs-evo-cand-001699-route-category-staging`
...
- `obs-evo-cand-001699-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001699-route-evolution-graph`
