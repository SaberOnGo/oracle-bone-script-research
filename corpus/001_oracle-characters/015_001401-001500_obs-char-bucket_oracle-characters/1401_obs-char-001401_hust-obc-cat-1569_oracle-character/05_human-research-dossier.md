# obs-char-001401 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1401_obs-char-001401_hust-obc-cat-1569_ora
  cle-character/03_visual-assets/001_asset-001406_hust-obc-cat-1569_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1569/G_1569_拾4.9(甲).png`
- asset id: `asset-001406`
...
- source category: `1569`
- validation class: `1400`
- source image route: `HUST-OBC/deciphered/1569/G_1569_拾4.9(甲).png`
- asset id: `asset-001406`
...
- English observation: `A tall open form has an angular upper cap, a central
  body, and lower prongs.`
- 中文观察: `高大开放形体有角状上盖、中央主体和下部分叉。`
...
- dataset label text: `㨗`
- dataset label codepoints: `U+3A17`
...
- Which source records identify obs-char-001401 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001401？
