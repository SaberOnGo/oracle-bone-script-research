...
- External category reference: `evobc-cat-02842`
- Source category ID: `02842`
- Source label for human review: `形`
- Source codepoints: `U+5F62`
...
- `obs-evo-cand-002842-route-category-staging`
...
- `obs-evo-cand-002842-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002842-route-evolution-graph`
