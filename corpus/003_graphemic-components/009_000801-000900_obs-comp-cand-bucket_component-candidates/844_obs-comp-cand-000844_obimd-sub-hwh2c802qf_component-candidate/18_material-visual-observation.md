# Material Visual Observation / obs-comp-cand-000844 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000844`
- External reference / 外部参照: `obimd-sub-hwh2c802qf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013715_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xvt1om20u0/hwh2c802qf/hwh2c802qf.png`
- Checksum / 校验和:
  `a4529eac2f1db40b5a12e9f32b4ec3b52b8d774ed2c74e5e0130f802b0013285`
...
- Marked-pixel bounds: (83,16)–(155,230); span 73 × 215 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.54%。
- 痕迹范围：(83,16)–(155,230)；跨度73 × 215 px；痕迹矩形高于宽。
