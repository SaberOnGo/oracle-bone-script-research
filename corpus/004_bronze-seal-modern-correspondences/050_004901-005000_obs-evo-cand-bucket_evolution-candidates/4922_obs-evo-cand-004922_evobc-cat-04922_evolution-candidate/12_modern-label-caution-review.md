# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004922
...
- EVOBC candidate category: `evobc-evo-cat-04922`.
- Source label for search only: `潿`.
- Source codepoints for search only: `U+6F7F`.
