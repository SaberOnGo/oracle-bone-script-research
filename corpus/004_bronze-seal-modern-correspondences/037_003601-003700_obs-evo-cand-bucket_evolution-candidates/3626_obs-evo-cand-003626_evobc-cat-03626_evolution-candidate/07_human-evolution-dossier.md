...
Project ID: `obs-evo-cand-003626`
...
- Project ID: `obs-evo-cand-003626`
- EVOBC category candidate ID: `evobc-evo-cat-03626`
- External category reference: `evobc-cat-03626`
- Source category ID: `03626`
- Source label for human review: `斋`
- Source codepoints: `U+658B`
...
- `obs-evo-cand-003626-route-category-staging`
...
- `obs-evo-cand-003626-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003626-route-evolution-graph`
