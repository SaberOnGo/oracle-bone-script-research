...
- External category reference: `evobc-cat-05571`
- Source category ID: `05571`
- Source label for human review: `畜`
- Source codepoints: `U+755C`
...
- `obs-evo-cand-005571-route-category-staging`
...
- `obs-evo-cand-005571-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005571-route-evolution-graph`
