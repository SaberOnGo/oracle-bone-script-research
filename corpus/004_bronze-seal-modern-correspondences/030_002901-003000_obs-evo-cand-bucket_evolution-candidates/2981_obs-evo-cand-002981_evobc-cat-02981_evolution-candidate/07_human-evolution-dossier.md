...
- External category reference: `evobc-cat-02981`
- Source category ID: `02981`
- Source label for human review: `恥`
- Source codepoints: `U+6065`
...
- `obs-evo-cand-002981-route-category-staging`
...
- `obs-evo-cand-002981-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002981-route-evolution-graph`
