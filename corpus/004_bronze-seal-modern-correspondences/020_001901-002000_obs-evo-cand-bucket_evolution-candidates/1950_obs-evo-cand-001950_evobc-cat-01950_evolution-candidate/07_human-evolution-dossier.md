...
- External category reference: `evobc-cat-01950`
- Source category ID: `01950`
- Source label for human review: `墼`
- Source codepoints: `U+58BC`
...
- `obs-evo-cand-001950-route-category-staging`
...
- `obs-evo-cand-001950-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001950-route-evolution-graph`
