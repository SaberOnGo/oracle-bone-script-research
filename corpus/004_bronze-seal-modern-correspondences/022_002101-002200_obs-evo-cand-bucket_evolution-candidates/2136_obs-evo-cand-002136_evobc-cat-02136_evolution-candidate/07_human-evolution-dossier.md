...
- External category reference: `evobc-cat-02136`
- Source category ID: `02136`
- Source label for human review: `姨`
...
- `obs-evo-cand-002136-route-category-staging`
...
- `obs-evo-cand-002136-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002136-route-evolution-graph`
