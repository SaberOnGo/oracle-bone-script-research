# obs-char-000211 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000211`
- primary external id: `hust-obc-cat-0234`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/211_obs-char-000211_hust-obc-cat-0234_orac
  le-character/03_visual-assets/001_asset-000216_hust-obc-cat-0234_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0234/G_0234_乙7688合2043.png`
- asset id: `asset-000216`
...
- source category: `0234`
- validation class: `210`
- source image route: `HUST-OBC/deciphered/0234/G_0234_乙7688合2043.png`
- asset id: `asset-000216`
...
- English observation: `The image has a triangular upper frame with a
  horizontal internal bar, a broad lower stroke, and a separate angular form
  on the right.`
- 中文观察: `图像上方有三角框，内部有横笔，下方有宽笔，右侧另有分离的折角形。`
...
- dataset label text: `㓠`
- dataset label codepoints: `U+34E0`
...
- filename catalog route clues: `Heji-like filename clue: 合2043
  (G_0234_乙7688合2043.png)`
...
- Which source records identify obs-char-000211 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000211？
