...
- External category reference: `evobc-cat-02330`
- Source category ID: `02330`
- Source label for human review: `字`
- Source codepoints: `U+5B57`
...
- `obs-evo-cand-002330-route-category-staging`
...
- `obs-evo-cand-002330-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002330-route-evolution-graph`
