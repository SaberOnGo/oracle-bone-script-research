...
- External category reference: `evobc-cat-01817`
- Source category ID: `01817`
- Source label for human review: `块`
...
- `obs-evo-cand-001817-route-category-staging`
...
- `obs-evo-cand-001817-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001817-route-evolution-graph`
