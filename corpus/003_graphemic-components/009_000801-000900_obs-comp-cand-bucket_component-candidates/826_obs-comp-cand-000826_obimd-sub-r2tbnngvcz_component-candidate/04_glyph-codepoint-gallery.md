# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000826
...
| --- | --- | --- | --- |
| `obimd-glyph-link-011859` | 建󴪆 | `U+5EFA;U+F4A86` | `reviewed_metadata_only` |
| `obimd-glyph-link-011860` | 󴪇 | `U+F4A87` | `reviewed_metadata_only` |
