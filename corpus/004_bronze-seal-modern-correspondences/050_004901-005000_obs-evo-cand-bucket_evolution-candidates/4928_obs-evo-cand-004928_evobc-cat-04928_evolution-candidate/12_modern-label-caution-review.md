# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004928
...
- EVOBC candidate category: `evobc-evo-cat-04928`.
- Source label for search only: `澌`.
- Source codepoints for search only: `U+6F8C`.
