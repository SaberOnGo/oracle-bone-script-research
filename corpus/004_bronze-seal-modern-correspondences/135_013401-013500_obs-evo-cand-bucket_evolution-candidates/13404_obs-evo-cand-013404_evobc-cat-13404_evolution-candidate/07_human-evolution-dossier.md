...
- External category reference: `evobc-cat-13404`
- Source category ID: `13404`
- Source label for human review: `𬬢`
...
- `obs-evo-cand-013404-route-category-staging`
...
- `obs-evo-cand-013404-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013404-route-evolution-graph`
