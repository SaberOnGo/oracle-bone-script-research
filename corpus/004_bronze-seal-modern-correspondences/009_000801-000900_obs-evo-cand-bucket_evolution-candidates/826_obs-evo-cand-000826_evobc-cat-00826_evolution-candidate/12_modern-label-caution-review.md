# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000826
...
- EVOBC candidate category: `evobc-evo-cat-00826`.
- Source label for search only: `佻`.
- Source codepoints for search only: `U+4F7B`.
