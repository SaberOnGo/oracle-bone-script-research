# obs-xwalk-cand-000769 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+375F` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-0873` | not reading |
