...
- External category reference: `evobc-cat-09602`
- Source category ID: `09602`
- Source label for human review: `锻`
...
- `obs-evo-cand-009602-route-category-staging`
...
- `obs-evo-cand-009602-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009602-route-evolution-graph`
