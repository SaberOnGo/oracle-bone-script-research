# Material Visual Observation / obs-comp-cand-001026 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001026`
- External reference / 外部参照: `obimd-sub-zrxiogzeqd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014519_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/188qgh86vq/zrxiogzeqd/zrxiogzeqd.png`
- Checksum / 校验和:
  `f69407347cd764118ce3db0dd0a42f4a352b45173868ee33f91bddc50bd6625a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.41%.
- Marked-pixel bounds: (75,29)–(174,225); span 100 × 197 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.41%。
- 痕迹范围：(75,29)–(174,225)；跨度100 × 197 px；痕迹矩形高于宽。
