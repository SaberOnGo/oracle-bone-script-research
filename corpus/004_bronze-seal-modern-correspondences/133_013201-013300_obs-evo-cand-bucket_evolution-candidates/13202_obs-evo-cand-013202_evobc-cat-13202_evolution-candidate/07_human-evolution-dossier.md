...
- External category reference: `evobc-cat-13202`
- Source category ID: `13202`
- Source label for human review: `𬅡`
- Source codepoints: `U+2C161`
...
- `obs-evo-cand-013202-route-category-staging`
...
- `obs-evo-cand-013202-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013202-route-evolution-graph`
