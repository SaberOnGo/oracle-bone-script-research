# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002584
...
- EVOBC candidate category: `evobc-evo-cat-02584`.
- Source label for search only: `嵟`.
- Source codepoints for search only: `U+5D5F`.
