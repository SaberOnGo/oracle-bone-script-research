# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006344
...
- EVOBC candidate category: `evobc-evo-cat-06344`.
- Source label for search only: `簍`.
- Source codepoints for search only: `U+7C0D`.
