# Material Visual Observation / obs-comp-cand-000486 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000486`
- External reference / 外部参照: `obimd-sub-4sde8iwfgp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012722_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7kjgfmjunm/4sde8iwfgp/4sde8iwfgp.png`
- Checksum / 校验和:
  `edafa9ae3a58b44ca17fc78557be2f9873bd7a2bdfe49e20ee6606f6936fee99`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.35%.
- Marked-pixel bounds: (51,44)–(204,221); span 154 × 178 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.35%。
- 痕迹范围：(51,44)–(204,221)；跨度154 × 178 px；痕迹矩形近方形。
