# obs-char-001453 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1453_obs-char-001453_hust-obc-cat-1629_ora
  cle-character/03_visual-assets/001_asset-001458_hust-obc-cat-1629_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1629/G_1629_乙282合10474𠂤賓間.png`
- asset id: `asset-001458`
...
- source category: `1629`
- validation class: `1452`
- source image route: `HUST-OBC/deciphered/1629/G_1629_乙282合10474𠂤賓間.png`
- asset id: `asset-001458`
...
- English observation: `A pointed upper cap leads to layered strokes and
  three lower prongs.`
...
- dataset label text: `㩓`
- dataset label codepoints: `U+3A53`
...
- Which source records identify obs-char-001453 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001453？
