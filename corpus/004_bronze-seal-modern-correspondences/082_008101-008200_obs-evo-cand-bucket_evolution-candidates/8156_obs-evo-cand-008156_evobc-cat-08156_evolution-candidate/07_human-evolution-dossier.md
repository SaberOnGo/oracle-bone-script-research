...
- External category reference: `evobc-cat-08156`
- Source category ID: `08156`
- Source label for human review: `許`
- Source codepoints: `U+8A31`
...
- `obs-evo-cand-008156-route-category-staging`
...
- `obs-evo-cand-008156-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008156-route-evolution-graph`
