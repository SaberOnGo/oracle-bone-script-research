...
- External category reference: `evobc-cat-06986`
- Source category ID: `06986`
- Source label for human review: `肙`
- Source codepoints: `U+8099`
...
- `obs-evo-cand-006986-route-category-staging`
...
- `obs-evo-cand-006986-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006986-route-evolution-graph`
