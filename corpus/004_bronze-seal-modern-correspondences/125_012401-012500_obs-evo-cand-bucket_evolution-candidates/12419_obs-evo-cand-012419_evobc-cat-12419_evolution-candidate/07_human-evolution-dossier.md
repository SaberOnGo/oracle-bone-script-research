...
- External category reference: `evobc-cat-12419`
- Source category ID: `12419`
- Source label for human review: `𨛁`
...
- `obs-evo-cand-012419-route-category-staging`
...
- `obs-evo-cand-012419-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012419-route-evolution-graph`
