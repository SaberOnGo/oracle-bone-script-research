# Material Visual Observation / obs-comp-cand-000747 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000747`
- External reference / 外部参照: `obimd-sub-ep7qnow4pv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013512_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ep7qnow4pv/ep7qnow4pv/ep7qnow4pv.png`
- Checksum / 校验和:
  `e8b0cac0afd20d448e8792e6349a6672754938b7c87ed8fb892305d82a9c043f`
...
- Marked-pixel bounds: (81,44)–(168,215); span 88 × 172 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.31%。
- 痕迹范围：(81,44)–(168,215)；跨度88 × 172 px；痕迹矩形高于宽。
