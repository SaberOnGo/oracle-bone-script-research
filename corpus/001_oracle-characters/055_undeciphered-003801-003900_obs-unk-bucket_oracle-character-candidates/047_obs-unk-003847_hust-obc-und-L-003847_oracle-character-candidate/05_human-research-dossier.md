# obs-unk-003847 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/055_undeciphered-003
  801-003900_obs-unk-bucket_oracle-character-candidates/047_obs-unk-003847_h
  ust-obc-und-L-003847_oracle-character-candidate/03_visual-assets/001_asset
  -005440_hust-obc-und-L-003847_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3847/L_？_8059.jpg`
- asset id: `asset-005440`
...
- source class: `HUST-OBC/undeciphered/L/3847/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3847/L_？_8059.jpg`
- asset id: `asset-005440`
...
- Which source records identify obs-unk-003847 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003847？
