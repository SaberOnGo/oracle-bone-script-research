...
- External category reference: `evobc-cat-00888`
- Source category ID: `00888`
- Source label for human review: `俗`
- Source codepoints: `U+4FD7`
...
- `obs-evo-cand-000888-route-category-staging`
...
- `obs-evo-cand-000888-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000888-route-evolution-graph`
