# Material Visual Observation / obs-comp-cand-001803 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001803`
- External reference / 外部参照: `obimd-sub-7nnyrveaif`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018024_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7nnyrveaif/7nnyrveaif/7nnyrveaif.png`
- Checksum / 校验和:
  `86a56d3d3823decaa61b39c93721f9b372a7d6699abcfbe8dda0a81cf9a0024b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.50%.
- Marked-pixel bounds: (57,60)–(199,197); span 143 × 138 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.50%。
- 痕迹范围：(57,60)–(199,197)；跨度143 × 138 px；痕迹矩形近方形。
