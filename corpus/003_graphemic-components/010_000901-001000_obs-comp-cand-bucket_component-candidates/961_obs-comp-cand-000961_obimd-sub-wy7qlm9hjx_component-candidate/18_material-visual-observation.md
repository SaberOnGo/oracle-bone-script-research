# Material Visual Observation / obs-comp-cand-000961 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000961`
- External reference / 外部参照: `obimd-sub-wy7qlm9hjx`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014044_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wy7qlm9hjx/wy7qlm9hjx/wy7qlm9hjx.png`
- Checksum / 校验和:
  `e20162ee236fbae775f89e8dbe83e92a29d3ab233b4f76fb648b1022c16db8c6`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.81%.
- Marked-pixel bounds: (54,53)–(195,199); span 142 × 147 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.81%。
- 痕迹范围：(54,53)–(195,199)；跨度142 × 147 px；痕迹矩形近方形。
