...
- External category reference: `evobc-cat-03925`
- Source category ID: `03925`
...
- `obs-evo-cand-003925-route-category-staging`
...
- `obs-evo-cand-003925-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003925-route-evolution-graph`
