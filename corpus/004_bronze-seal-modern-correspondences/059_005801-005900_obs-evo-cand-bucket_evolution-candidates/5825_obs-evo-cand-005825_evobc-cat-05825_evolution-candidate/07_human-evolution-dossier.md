...
- External category reference: `evobc-cat-05825`
- Source category ID: `05825`
- Source label for human review: `睔`
- Source codepoints: `U+7754`
...
- `obs-evo-cand-005825-route-category-staging`
...
- `obs-evo-cand-005825-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005825-route-evolution-graph`
