# obs-unk-004187 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004187`
- primary external id: `hust-obc-und-L-004187`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/087_obs-unk-004187_h
  ust-obc-und-L-004187_oracle-character-candidate/03_visual-assets/001_asset
  -005780_hust-obc-und-L-004187_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4187/L_？_9109.jpg`
- asset id: `asset-005780`
...
- source class: `HUST-OBC/undeciphered/L/4187/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4187/L_？_9109.jpg`
- asset id: `asset-005780`
...
- English observation: `A broad upper band and inner dark area; two strokes
descend from its lower edge.`
- 中文观察: `可见宽大的上部笔画和较深内部区域；下缘伸出两条长
笔画。`
...
- Which source records identify obs-unk-004187 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004187？
