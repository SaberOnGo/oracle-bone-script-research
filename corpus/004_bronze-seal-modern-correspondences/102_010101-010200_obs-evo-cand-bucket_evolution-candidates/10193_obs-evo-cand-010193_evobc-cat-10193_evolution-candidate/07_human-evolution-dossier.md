...
- External category reference: `evobc-cat-10193`
- Source category ID: `10193`
- Source label for human review: `駢`
...
- `obs-evo-cand-010193-route-category-staging`
...
- `obs-evo-cand-010193-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010193-route-evolution-graph`
