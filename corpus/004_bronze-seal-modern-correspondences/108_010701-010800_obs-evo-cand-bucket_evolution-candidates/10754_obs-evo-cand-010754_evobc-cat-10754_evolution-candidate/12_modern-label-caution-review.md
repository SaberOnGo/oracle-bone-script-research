# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010754
...
- EVOBC candidate category: `evobc-evo-cat-10754`.
- Source label for search only: `龜`.
- Source codepoints for search only: `U+9F9C`.
