...
Project ID: `obs-evo-cand-006993`
...
- Project ID: `obs-evo-cand-006993`
- EVOBC category candidate ID: `evobc-evo-cat-06993`
- External category reference: `evobc-cat-06993`
- Source category ID: `06993`
- Source label for human review: `肤`
- Source codepoints: `U+80A4`
...
- `obs-evo-cand-006993-route-category-staging`
...
- `obs-evo-cand-006993-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006993-route-evolution-graph`
