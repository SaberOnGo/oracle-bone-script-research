...
Project ID: `obs-evo-cand-002455`
...
- Project ID: `obs-evo-cand-002455`
- EVOBC category candidate ID: `evobc-evo-cat-02455`
- External category reference: `evobc-cat-02455`
- Source category ID: `02455`
- Source label for human review: `封`
- Source codepoints: `U+5C01`
...
- `obs-evo-cand-002455-route-category-staging`
...
- `obs-evo-cand-002455-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002455-route-evolution-graph`
