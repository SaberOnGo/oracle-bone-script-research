...
Project ID: `obs-evo-cand-008434`
...
- Project ID: `obs-evo-cand-008434`
- EVOBC category candidate ID: `evobc-evo-cat-08434`
- External category reference: `evobc-cat-08434`
- Source category ID: `08434`
- Source label for human review: `诫`
- Source codepoints: `U+8BEB`
...
- `obs-evo-cand-008434-route-category-staging`
...
- `obs-evo-cand-008434-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008434-route-evolution-graph`
