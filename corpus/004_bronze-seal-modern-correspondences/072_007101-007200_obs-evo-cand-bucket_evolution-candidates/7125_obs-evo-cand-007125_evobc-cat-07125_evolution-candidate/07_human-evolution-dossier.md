...
- External category reference: `evobc-cat-07125`
- Source category ID: `07125`
- Source label for human review: `膚`
...
- `obs-evo-cand-007125-route-category-staging`
...
- `obs-evo-cand-007125-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007125-route-evolution-graph`
