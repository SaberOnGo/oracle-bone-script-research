...
- External category reference: `evobc-cat-05299`
- Source category ID: `05299`
- Source label for human review: `猨`
...
- `obs-evo-cand-005299-route-category-staging`
...
- `obs-evo-cand-005299-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005299-route-evolution-graph`
