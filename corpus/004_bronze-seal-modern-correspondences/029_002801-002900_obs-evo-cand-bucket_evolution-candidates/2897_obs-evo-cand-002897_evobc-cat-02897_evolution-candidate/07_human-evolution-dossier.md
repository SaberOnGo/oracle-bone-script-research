...
- Project ID: `obs-evo-cand-002897`
- EVOBC category candidate ID: `evobc-evo-cat-02897`
- External category reference: `evobc-cat-02897`
- Source category ID: `02897`
- Source label for human review: `必`
- Source codepoints: `U+5FC5`
...
- `obs-evo-cand-002897-route-category-staging`
...
- `obs-evo-cand-002897-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002897-route-evolution-graph`
