...
Project ID: `obs-evo-cand-010990`
...
- Project ID: `obs-evo-cand-010990`
- EVOBC category candidate ID: `evobc-evo-cat-10990`
- External category reference: `evobc-cat-10990`
- Source category ID: `10990`
- Source label for human review: `𡍁`
- Source codepoints: `U+21341`
...
- `obs-evo-cand-010990-route-category-staging`
...
- `obs-evo-cand-010990-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010990-route-evolution-graph`
