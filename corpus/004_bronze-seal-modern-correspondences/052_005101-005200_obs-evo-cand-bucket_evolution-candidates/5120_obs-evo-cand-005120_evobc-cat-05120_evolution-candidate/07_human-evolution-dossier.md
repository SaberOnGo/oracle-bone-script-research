...
Project ID: `obs-evo-cand-005120`
...
- Project ID: `obs-evo-cand-005120`
- EVOBC category candidate ID: `evobc-evo-cat-05120`
- External category reference: `evobc-cat-05120`
- Source category ID: `05120`
- Source label for human review: `煽`
- Source codepoints: `U+717D`
...
- `obs-evo-cand-005120-route-category-staging`
...
- `obs-evo-cand-005120-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005120-route-evolution-graph`
