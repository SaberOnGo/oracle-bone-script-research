...
Project ID: `obs-evo-cand-013523`
...
- Project ID: `obs-evo-cand-013523`
- EVOBC category candidate ID: `evobc-evo-cat-13523`
- External category reference: `evobc-cat-13523`
- Source category ID: `13523`
- Source label for human review: `𭝅`
- Source codepoints: `U+2D745`
...
- `obs-evo-cand-013523-route-category-staging`
...
- `obs-evo-cand-013523-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013523-route-evolution-graph`
