...
- External category reference: `evobc-cat-06426`
- Source category ID: `06426`
- Source label for human review: `糜`
- Source codepoints: `U+7CDC`
...
- `obs-evo-cand-006426-route-category-staging`
...
- `obs-evo-cand-006426-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006426-route-evolution-graph`
