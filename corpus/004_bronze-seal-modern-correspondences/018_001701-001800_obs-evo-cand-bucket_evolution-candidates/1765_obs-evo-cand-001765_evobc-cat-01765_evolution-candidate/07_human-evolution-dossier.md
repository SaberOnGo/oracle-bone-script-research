...
- External category reference: `evobc-cat-01765`
- Source category ID: `01765`
- Source label for human review: `困`
- Source codepoints: `U+56F0`
...
- `obs-evo-cand-001765-route-category-staging`
...
- `obs-evo-cand-001765-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001765-route-evolution-graph`
