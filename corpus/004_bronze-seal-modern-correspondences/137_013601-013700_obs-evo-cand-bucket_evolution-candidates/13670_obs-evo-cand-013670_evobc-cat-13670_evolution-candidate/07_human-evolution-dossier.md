...
- Project ID: `obs-evo-cand-013670`
- EVOBC category candidate ID: `evobc-evo-cat-13670`
- External category reference: `evobc-cat-13670`
- Source category ID: `13670`
- Source label for human review: `𮣧`
- Source codepoints: `U+2E8E7`
...
- `obs-evo-cand-013670-route-category-staging`
...
- `obs-evo-cand-013670-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013670-route-evolution-graph`
