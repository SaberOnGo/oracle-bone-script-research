...
Project ID: `obs-evo-cand-008599`
...
- Project ID: `obs-evo-cand-008599`
- EVOBC category candidate ID: `evobc-evo-cat-08599`
- External category reference: `evobc-cat-08599`
- Source category ID: `08599`
- Source label for human review: `購`
- Source codepoints: `U+8CFC`
...
- `obs-evo-cand-008599-route-category-staging`
...
- `obs-evo-cand-008599-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008599-route-evolution-graph`
