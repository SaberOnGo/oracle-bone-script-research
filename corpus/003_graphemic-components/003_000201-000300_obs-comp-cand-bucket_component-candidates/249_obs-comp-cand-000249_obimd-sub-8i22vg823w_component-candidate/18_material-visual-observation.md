# Material Visual Observation / obs-comp-cand-000249 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000249`
- External reference / 外部参照: `obimd-sub-8i22vg823w`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011895_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8i22vg823w/8i22vg823w/8i22vg823w.png`
- Checksum / 校验和:
  `cd2169f8a7d6d284e85acf447af6cbecb982d7291274167b76b7d8c0b95857bb`
...
- Marked-pixel bounds: (57,46)–(192,203); span 136 × 158 px; the marked
...
- 痕迹范围：(57,46)–(192,203)；跨度136 × 158 px；痕迹矩形近方形。
