# obs-char-000585 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000585`
- primary external id: `hust-obc-cat-0664`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/585_obs-char-000585_hust-obc-cat-0664_orac
  le-character/03_visual-assets/001_asset-000590_hust-obc-cat-0664_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0664/G_0664_乙5123合21653子組.png`
- asset id: `asset-000590`
...
- source category: `0664`
- validation class: `584`
- source image route: `HUST-OBC/deciphered/0664/G_0664_乙5123合21653子組.png`
- asset id: `asset-000590`
...
- English observation: `The faint low-contrast image shows separated narrow
  marks at left and a thin wavering vertical form with a small middle loop
  and long lower stroke at right.`
- 中文观察: `淡弱低对比度图像显示左侧分离狭痕，以及右侧带小中环和长下笔的纤细波折竖形。`
...
- dataset label text: `㚎`
- dataset label codepoints: `U+368E`
...
- filename catalog route clues: `Heji-like filename clue: 合21653
  (G_0664_乙5123合21653子組.png)`
...
- Which source records identify obs-char-000585 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000585？
