# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008184
...
- EVOBC candidate category: `evobc-evo-cat-08184`.
- Source label for search only: `詠`.
- Source codepoints for search only: `U+8A60`.
