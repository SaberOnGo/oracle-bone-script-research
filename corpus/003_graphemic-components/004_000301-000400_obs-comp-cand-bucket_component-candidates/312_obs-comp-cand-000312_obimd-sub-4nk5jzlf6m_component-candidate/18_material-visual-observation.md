# Material Visual Observation / obs-comp-cand-000312 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000312`
- External reference / 外部参照: `obimd-sub-4nk5jzlf6m`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012239_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4nk5jzlf6m/4nk5jzlf6m/4nk5jzlf6m.png`
- Checksum / 校验和:
  `fdd2759dd97f58582dee44c0961a474037696f46d54ed64153eca77054837dbf`
...
- Marked-pixel bounds: (71,38)–(178,211); span 108 × 174 px; the marked
...
- 痕迹范围：(71,38)–(178,211)；跨度108 × 174 px；痕迹矩形高于宽。
