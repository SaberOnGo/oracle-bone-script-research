# obs-char-000362 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000362`
- primary external id: `hust-obc-cat-0412`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/362_obs-char-000362_hust-obc-cat-0412_orac
  le-character/03_visual-assets/001_asset-000367_hust-obc-cat-0412_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0412/G_0412_乙222(甲).png`
- asset id: `asset-000367`
...
- source category: `0412`
- validation class: `361`
- source image route: `HUST-OBC/deciphered/0412/G_0412_乙222(甲).png`
- asset id: `asset-000367`
...
- English observation: `A short upper horizontal stroke sits above a compact
  central mark and a broad lower horizontal base.`
- 中文观察: `短上横笔画位于紧凑中部痕迹和宽下横底笔画之上。`
...
- dataset label text: `㖒`
- dataset label codepoints: `U+3592`
...
- Which source records identify obs-char-000362 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000362？
