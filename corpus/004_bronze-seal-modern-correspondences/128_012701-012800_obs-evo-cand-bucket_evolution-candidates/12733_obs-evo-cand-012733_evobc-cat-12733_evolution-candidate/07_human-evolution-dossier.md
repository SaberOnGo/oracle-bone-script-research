...
Project ID: `obs-evo-cand-012733`
...
- Project ID: `obs-evo-cand-012733`
- EVOBC category candidate ID: `evobc-evo-cat-12733`
- External category reference: `evobc-cat-12733`
- Source category ID: `12733`
- Source label for human review: `𪆐`
- Source codepoints: `U+2A190`
...
- `obs-evo-cand-012733-route-category-staging`
...
- `obs-evo-cand-012733-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012733-route-evolution-graph`
