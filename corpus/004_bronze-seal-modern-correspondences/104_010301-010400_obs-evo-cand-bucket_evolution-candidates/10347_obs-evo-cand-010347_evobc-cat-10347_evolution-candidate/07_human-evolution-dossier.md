...
- Project ID: `obs-evo-cand-010347`
- EVOBC category candidate ID: `evobc-evo-cat-10347`
- External category reference: `evobc-cat-10347`
- Source category ID: `10347`
- Source label for human review: `鬳`
- Source codepoints: `U+9B33`
...
- `obs-evo-cand-010347-route-category-staging`
...
- `obs-evo-cand-010347-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010347-route-evolution-graph`
