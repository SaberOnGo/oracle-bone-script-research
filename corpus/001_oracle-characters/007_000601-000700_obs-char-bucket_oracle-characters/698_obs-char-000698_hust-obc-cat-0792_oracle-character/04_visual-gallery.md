# obs-char-000698 Visual Gallery / obs-char-000698 图像资料页
...
- Project ID / 项目 ID: `obs-char-000698`
- Primary external reference / 首选外部参考: `hust-obc-cat-0792`
...
## obs-char-000698-visual-source-001 / 图像条目

![obs-char-000698 glyph candidate](03_visual-assets/001_asset-000703_hust-obc-cat-0792_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000703_hust-obc-cat-0792_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000703_hust-obc-cat-0792_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/0792/G_0792_合22942出組.png`
