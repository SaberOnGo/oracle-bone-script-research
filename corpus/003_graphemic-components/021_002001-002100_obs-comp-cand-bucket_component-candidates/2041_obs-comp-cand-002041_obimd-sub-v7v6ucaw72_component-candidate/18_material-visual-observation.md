# Material Visual Observation / obs-comp-cand-002041 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002041`
- External reference / 外部参照: `obimd-sub-v7v6ucaw72`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019368_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/v7v6ucaw72/v7v6ucaw72/v7v6ucaw72.png`
- Checksum / 校验和:
  `dc8539bd2d44943abaf043d46cabdf847f221dafe5c4d8d73ef1ceae2309fb37`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.95%.
- Marked-pixel bounds: (78,34)–(171,220); span 94 × 187 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.95%。
- 痕迹范围：(78,34)–(171,220)；跨度94 × 187 px；痕迹矩形高于宽。
