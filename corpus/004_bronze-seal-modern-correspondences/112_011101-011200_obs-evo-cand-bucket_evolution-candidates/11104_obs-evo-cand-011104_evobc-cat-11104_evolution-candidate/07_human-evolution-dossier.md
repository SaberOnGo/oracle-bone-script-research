...
Project ID: `obs-evo-cand-011104`
...
- Project ID: `obs-evo-cand-011104`
- EVOBC category candidate ID: `evobc-evo-cat-11104`
- External category reference: `evobc-cat-11104`
- Source category ID: `11104`
- Source label for human review: `𡲯`
- Source codepoints: `U+21CAF`
...
- `obs-evo-cand-011104-route-category-staging`
...
- `obs-evo-cand-011104-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011104-route-evolution-graph`
