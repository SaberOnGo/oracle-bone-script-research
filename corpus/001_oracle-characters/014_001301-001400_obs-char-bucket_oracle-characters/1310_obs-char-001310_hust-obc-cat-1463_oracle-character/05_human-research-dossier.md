# obs-char-001310 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001310`
- primary external id: `hust-obc-cat-1463`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1310_obs-char-001310_hust-obc-cat-1463_ora
  cle-character/03_visual-assets/001_asset-001315_hust-obc-cat-1463_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1463/G_1463_甲骨文.png`
- asset id: `asset-001315`
...
- source category: `1463`
- validation class: `1309`
- source image route: `HUST-OBC/deciphered/1463/G_1463_甲骨文.png`
- asset id: `asset-001315`
...
- English observation: `A small dense cluster has a rounded upper crossing,
  repeated short inner strokes, and a lower stem.`
- 中文观察: `小型密集笔画群有圆拱上部交叉笔、重复的内部短笔和下部笔干。`
...
- dataset label text: `㦭`
- dataset label codepoints: `U+39AD`
...
- Which source records identify obs-char-001310 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001310？
