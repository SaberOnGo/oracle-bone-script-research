# Material Visual Observation / obs-comp-cand-000456 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000456`
- External reference / 外部参照: `obimd-sub-5zjto89nh6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012604_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5zjto89nh6/5zjto89nh6/5zjto89nh6.png`
- Checksum / 校验和:
  `25ea2c242a375719a87ace36dfc2a1d7c3e0a72014d42aaacac319b24dded611`
...
- Marked-pixel bounds: (82,17)–(167,228); span 86 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.15%。
- 痕迹范围：(82,17)–(167,228)；跨度86 × 212 px；痕迹矩形高于宽。
