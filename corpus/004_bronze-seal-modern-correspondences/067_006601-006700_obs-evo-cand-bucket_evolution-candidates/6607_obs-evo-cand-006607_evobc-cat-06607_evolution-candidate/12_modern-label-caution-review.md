# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006607
...
- EVOBC candidate category: `evobc-evo-cat-06607`.
- Source label for search only: `緬`.
- Source codepoints for search only: `U+7DEC`.
