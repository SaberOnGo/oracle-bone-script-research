# obs-char-000514 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000514`
- primary external id: `hust-obc-cat-0585`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/514_obs-char-000514_hust-obc-cat-0585_orac
  le-character/03_visual-assets/001_asset-000519_hust-obc-cat-0585_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0585/G_0585_甲骨文.png`
- asset id: `asset-000519`
...
- source category: `0585`
- validation class: `513`
- source image route: `HUST-OBC/deciphered/0585/G_0585_甲骨文.png`
- asset id: `asset-000519`
...
- English observation: `A narrow zigzag vertical form contains a small
  central loop, with a long upper diagonal and a short bent lower
  extension.`
- 中文观察: `狭长折线竖形中部有小环，上方为长斜笔，下方为短弯折延伸。`
...
- dataset label text: `㘿`
- dataset label codepoints: `U+363F`
...
- Which source records identify obs-char-000514 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000514？
