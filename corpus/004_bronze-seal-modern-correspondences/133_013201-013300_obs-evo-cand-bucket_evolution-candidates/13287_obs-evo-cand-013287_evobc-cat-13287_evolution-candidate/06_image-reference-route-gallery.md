...
- `obs-evo-cand-013287-route-category-staging`
...
- `obs-evo-cand-013287-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013287-route-evolution-graph`
