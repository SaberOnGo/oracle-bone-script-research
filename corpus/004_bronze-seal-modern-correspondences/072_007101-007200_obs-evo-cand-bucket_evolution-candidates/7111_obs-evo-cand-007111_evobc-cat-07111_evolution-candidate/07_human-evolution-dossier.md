...
- Project ID: `obs-evo-cand-007111`
- EVOBC category candidate ID: `evobc-evo-cat-07111`
- External category reference: `evobc-cat-07111`
- Source category ID: `07111`
- Source label for human review: `腸`
- Source codepoints: `U+8178`
...
- `obs-evo-cand-007111-route-category-staging`
...
- `obs-evo-cand-007111-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007111-route-evolution-graph`
