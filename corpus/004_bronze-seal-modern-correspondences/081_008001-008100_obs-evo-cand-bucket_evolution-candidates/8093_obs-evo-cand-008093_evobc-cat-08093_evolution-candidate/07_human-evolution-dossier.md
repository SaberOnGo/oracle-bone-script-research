...
- External category reference: `evobc-cat-08093`
- Source category ID: `08093`
- Source label for human review: `角`
- Source codepoints: `U+89D2`
- Image reference count in source metadata: `135`
...
- `obs-evo-cand-008093-route-category-staging`
...
- `obs-evo-cand-008093-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008093-route-evolution-graph`
