# Material Visual Observation / obs-comp-cand-000049 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000049`
- External reference / 外部参照: `obimd-sub-jbgbxt897u`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011415_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jbgbxt897u/jbgbxt897u/3v7cvwdbgv.png`
- Checksum / 校验和:
  `a71d06cfa03a1e17af245d98cb6b411da56fe06311ae75d3c97b04e2b8c528ae`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.68%.
- Marked-pixel bounds: (105,22)–(144,221); span 40 × 200 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.68%。
- 痕迹范围：(105,22)–(144,221)；跨度40 × 200 px；痕迹矩形高于宽。
