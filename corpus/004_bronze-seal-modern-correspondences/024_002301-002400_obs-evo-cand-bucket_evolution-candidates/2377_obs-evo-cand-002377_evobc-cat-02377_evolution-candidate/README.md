# obs-evo-cand-002377 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-02377`
- Source label: `宛`
- Source codepoints: `U+5B9B`
- Image reference count: `58`
- Era token counts: `BI:10;CS:1;OBC:27;SS:3;WSC:17`
- Source token counts: `Book:20;Web:38`
