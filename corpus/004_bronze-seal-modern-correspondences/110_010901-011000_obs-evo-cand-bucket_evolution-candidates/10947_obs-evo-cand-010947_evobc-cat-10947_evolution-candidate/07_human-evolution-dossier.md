...
- External category reference: `evobc-cat-10947`
- Source category ID: `10947`
- Source label for human review: `𠶹`
...
- `obs-evo-cand-010947-route-category-staging`
...
- `obs-evo-cand-010947-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010947-route-evolution-graph`
