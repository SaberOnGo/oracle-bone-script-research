# obs-char-000183 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/183_obs-char-000183_hust-obc-cat-0202_orac
  le-character/03_visual-assets/001_asset-000188_hust-obc-cat-0202_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0202/G_0202_乙533合454賓組.png`
- asset id: `asset-000188`
...
- source category: `0202`
- validation class: `182`
- source image route: `HUST-OBC/deciphered/0202/G_0202_乙533合454賓組.png`
- asset id: `asset-000188`
...
- dataset label text: `㓀`
- dataset label codepoints: `U+34C0`
...
- Which source records identify obs-char-000183 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000183？
