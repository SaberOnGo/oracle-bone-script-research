# obs-char-000317 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000317`
- primary external id: `hust-obc-cat-0357`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/317_obs-char-000317_hust-obc-cat-0357_orac
  le-character/03_visual-assets/001_asset-000322_hust-obc-cat-0357_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0357/G_0357_京津4860合31731無名組.png
  `
- asset id: `asset-000322`
...
- source category: `0357`
- validation class: `316`
- source image route: `HUST-OBC/deciphered/0357/G_0357_京津4860合31731無名組.png`
- asset id: `asset-000322`
...
- English observation: `A curved upper stroke and small left enclosure
  accompany a long branching stroke descending along the right side.`
- 中文观察: `图像上方有弧形笔画和左侧小型闭合轮廓，右侧有长分叉笔画向下延伸。`
...
- dataset label text: `㕛`
- dataset label codepoints: `U+355B`
...
- filename catalog route clues: `Heji-like filename clue: 合31731
  (G_0357_京津4860合31731無名組.png)`
...
- Which source records identify obs-char-000317 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000317？
