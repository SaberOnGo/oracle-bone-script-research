# obs-char-000535 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/535_obs-char-000535_hust-obc-cat-0609_orac
  le-character/03_visual-assets/001_asset-000540_hust-obc-cat-0609_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0609/G_0609_乙1107合21888子組.png`
- asset id: `asset-000540`
...
- source category: `0609`
- validation class: `534`
- source image route: `HUST-OBC/deciphered/0609/G_0609_乙1107合21888子組.png`
- asset id: `asset-000540`
...
- English observation: `A small oval loop has several short strokes
  radiating upward; a long diagonal crosses its right side and continues
  beside a curved descending line.`
...
- dataset label text: `㙗`
- dataset label codepoints: `U+3657`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00040`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00040`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00040`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/040_obs-evo-can
  d-000040_evobc-cat-00040_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/040_obs-evo-cand-000040_evobc-cat-00040_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合21888
  (G_0609_乙1107合21888子組.png)`
...
- Which source records identify obs-char-000535 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000535？
