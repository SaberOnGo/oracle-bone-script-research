# obs-unk-005021 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/067_undeciphered-005
  001-005100_obs-unk-bucket_oracle-character-candidates/021_obs-unk-005021_h
  ust-obc-und-X-005021_oracle-character-candidate/03_visual-assets/001_asset
  -006614_hust-obc-und-X-005021_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/577/X_？_7553_1.png`
- asset id: `asset-006614`
...
- source class: `HUST-OBC/undeciphered/X/577/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/577/X_？_7553_1.png`
- asset id: `asset-006614`
...
- Which source records identify obs-unk-005021 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005021？
