...
- Source URL / 来源链接: https://github.com/wm-bupt/oracle-mnist
- Scope / 适用范围: Small benchmark dataset of oracle character images for machine
  learning; not a comprehensive decipherment corpus.
...
### Route 001
- Download ID / 下载 ID: dl-oracle-mnist-readme
...
- Local temp path / 本地临时路径: tmp/source_downloads/dl-oracle-mnist-readme.md
...
### Route 001
- Package file ID / 来源包文件 ID: pkg-file-000026
- Source package ID / 来源包 ID: light-src-oracle-mnist
- File name / 文件名: dl-oracle-mnist-readme.md
...
### Route 001
- Profile ID / 概况 ID: metadata-profile-000058
- Evidence download ID / 证据下载 ID: dl-oracle-mnist-readme
- Metadata file / 元数据文件: README.md
- Profile metric / 概况指标: registered_dataset_scope
- Profile value / 概况值: small_oracle_character_image_benchmark
- Profile unit / 概况单位: scope_label
- Import relevance / 导入相关性: Records Oracle-MNIST as an AI benchmark route rather
  than a comprehensive corpus source
- Caution / 提醒: Benchmark metadata only; do not use as scholarly decipherment
  evidence
- Review status / 复核状态: reviewed_metadata_only

### Route 002
- Profile ID / 概况 ID: metadata-profile-000059
- Evidence download ID / 证据下载 ID: dl-oracle-mnist-readme
- Metadata file / 元数据文件: README.md
