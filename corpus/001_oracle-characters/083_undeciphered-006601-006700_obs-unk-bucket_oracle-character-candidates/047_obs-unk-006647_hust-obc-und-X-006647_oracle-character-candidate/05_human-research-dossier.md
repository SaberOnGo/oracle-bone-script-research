# obs-unk-006647 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/083_undeciphered-006
  601-006700_obs-unk-bucket_oracle-character-candidates/047_obs-unk-006647_h
  ust-obc-und-X-006647_oracle-character-candidate/03_visual-assets/001_asset
  -008238_hust-obc-und-X-006647_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2203/X_？_663_1.png`
- asset id: `asset-008238`
...
- source class: `HUST-OBC/undeciphered/X/2203/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2203/X_？_663_1.png`
- asset id: `asset-008238`
...
- Which source records identify obs-unk-006647 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006647？
