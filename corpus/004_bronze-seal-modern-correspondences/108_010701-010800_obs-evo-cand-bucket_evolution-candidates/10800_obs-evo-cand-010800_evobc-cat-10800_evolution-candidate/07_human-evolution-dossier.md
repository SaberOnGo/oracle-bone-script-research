...
- External category reference: `evobc-cat-10800`
- Source category ID: `10800`
- Source label for human review: `𠊂`
...
- `obs-evo-cand-010800-route-category-staging`
...
- `obs-evo-cand-010800-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010800-route-evolution-graph`
