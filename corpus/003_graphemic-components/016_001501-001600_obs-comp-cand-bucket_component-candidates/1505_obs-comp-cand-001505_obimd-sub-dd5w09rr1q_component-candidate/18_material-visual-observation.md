# Material Visual Observation / obs-comp-cand-001505 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001505`
- External reference / 外部参照: `obimd-sub-dd5w09rr1q`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016433_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dd5w09rr1q/dd5w09rr1q/dd5w09rr1q.png`
- Checksum / 校验和:
  `d162e5ee378bece370179070076f771f7ac03a2af443d17cfdcc33f201dfd00e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.24%.
- Marked-pixel bounds: (38,26)–(212,220); span 175 × 195 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.24%。
- 痕迹范围：(38,26)–(212,220)；跨度175 × 195 px；痕迹矩形近方形。
