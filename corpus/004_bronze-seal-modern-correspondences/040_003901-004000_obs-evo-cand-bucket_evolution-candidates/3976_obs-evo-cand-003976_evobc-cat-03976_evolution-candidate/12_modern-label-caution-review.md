# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003976
...
- EVOBC candidate category: `evobc-evo-cat-03976`.
- Source label for search only: `柱`.
- Source codepoints for search only: `U+67F1`.
