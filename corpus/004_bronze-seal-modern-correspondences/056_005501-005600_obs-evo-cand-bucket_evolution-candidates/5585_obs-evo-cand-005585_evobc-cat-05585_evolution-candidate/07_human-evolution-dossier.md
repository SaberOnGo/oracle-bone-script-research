...
Project ID: `obs-evo-cand-005585`
...
- Project ID: `obs-evo-cand-005585`
- EVOBC category candidate ID: `evobc-evo-cat-05585`
- External category reference: `evobc-cat-05585`
- Source category ID: `05585`
- Source label for human review: `當`
- Source codepoints: `U+7576`
...
- `obs-evo-cand-005585-route-category-staging`
...
- `obs-evo-cand-005585-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005585-route-evolution-graph`
