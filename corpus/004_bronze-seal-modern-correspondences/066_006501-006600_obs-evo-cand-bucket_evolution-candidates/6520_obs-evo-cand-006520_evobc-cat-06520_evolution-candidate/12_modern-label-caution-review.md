# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006520
...
- EVOBC candidate category: `evobc-evo-cat-06520`.
- Source label for search only: `絭`.
- Source codepoints for search only: `U+7D6D`.
