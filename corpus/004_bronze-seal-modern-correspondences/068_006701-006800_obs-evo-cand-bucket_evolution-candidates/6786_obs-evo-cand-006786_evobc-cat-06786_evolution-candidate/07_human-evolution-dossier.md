...
- External category reference: `evobc-cat-06786`
- Source category ID: `06786`
- Source label for human review: `缾`
- Source codepoints: `U+7F3E`
...
- `obs-evo-cand-006786-route-category-staging`
...
- `obs-evo-cand-006786-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006786-route-evolution-graph`
