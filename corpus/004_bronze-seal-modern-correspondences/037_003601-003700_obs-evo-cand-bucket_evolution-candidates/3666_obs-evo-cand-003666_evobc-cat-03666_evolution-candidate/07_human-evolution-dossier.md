...
- External category reference: `evobc-cat-03666`
- Source category ID: `03666`
- Source label for human review: `旅`
- Source codepoints: `U+65C5`
- Image reference count in source metadata: `319`
...
- `obs-evo-cand-003666-route-category-staging`
...
- `obs-evo-cand-003666-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003666-route-evolution-graph`
