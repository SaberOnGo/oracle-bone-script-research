# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000760
...
| --- | --- | --- | --- |
| `obimd-glyph-link-011035` | 󿴞 | `U+FFD1E` | `reviewed_metadata_only` |
| `obimd-glyph-link-011036` | 󴔄 | `U+F4504` | `reviewed_metadata_only` |
