...
- Project ID: `obs-evo-cand-009522`
- EVOBC category candidate ID: `evobc-evo-cat-09522`
- External category reference: `evobc-cat-09522`
- Source category ID: `09522`
- Source label for human review: `鐍`
- Source codepoints: `U+940D`
...
- `obs-evo-cand-009522-route-category-staging`
...
- `obs-evo-cand-009522-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009522-route-evolution-graph`
