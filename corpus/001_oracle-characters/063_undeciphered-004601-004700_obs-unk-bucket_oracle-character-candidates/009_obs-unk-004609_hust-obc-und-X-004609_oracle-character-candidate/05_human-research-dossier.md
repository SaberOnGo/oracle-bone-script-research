# obs-unk-004609 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/009_obs-unk-004609_h
  ust-obc-und-X-004609_oracle-character-candidate/03_visual-assets/001_asset
  -006202_hust-obc-und-X-004609_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/165/X_？_8341_1.png`
- asset id: `asset-006202`
...
- source class: `HUST-OBC/undeciphered/X/165/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/165/X_？_8341_1.png`
- asset id: `asset-006202`
...
- English observation: `rounded frame, two openings, lower hooked stem`
- 中文观察: `弧角框体、两个空隙和下部钩形痕迹已记录。`
...
- Which source records identify obs-unk-004609 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004609？
