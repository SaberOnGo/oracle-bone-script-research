# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001475
...
- EVOBC candidate category: `evobc-evo-cat-01475`.
- Source label for search only: `只`.
- Source codepoints for search only: `U+53EA`.
