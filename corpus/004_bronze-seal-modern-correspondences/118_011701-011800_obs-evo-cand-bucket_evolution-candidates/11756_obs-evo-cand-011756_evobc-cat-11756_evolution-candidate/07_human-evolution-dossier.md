...
- External category reference: `evobc-cat-11756`
- Source category ID: `11756`
- Source label for human review: `𥁺`
- Source codepoints: `U+2507A`
...
- `obs-evo-cand-011756-route-category-staging`
...
- `obs-evo-cand-011756-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011756-route-evolution-graph`
