# Material Visual Observation / obs-comp-cand-001741 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001741`
- External reference / 外部参照: `obimd-sub-h4cvei8pel`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017942_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/iuzkqe17tf/h4cvei8pel/h4cvei8pel.png`
- Checksum / 校验和:
  `8d123b893b589ff43b4a74119a8a48b9d7507b9efe0b6598f29b9bc2007ea996`
...
- Marked-pixel bounds: (83,13)–(175,238); span 93 × 226 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.82%。
- 痕迹范围：(83,13)–(175,238)；跨度93 × 226 px；痕迹矩形高于宽。
