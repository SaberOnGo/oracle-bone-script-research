# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000998
...
| Glyph or codepoint route / 字形或码位路线 | 10 OBIMD route rows; examples U+C9B5E;U+F5AAB; U+F5AAC; 另有 8 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
