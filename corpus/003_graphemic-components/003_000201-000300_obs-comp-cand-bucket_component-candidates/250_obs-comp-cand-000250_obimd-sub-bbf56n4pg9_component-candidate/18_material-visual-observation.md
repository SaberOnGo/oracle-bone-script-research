# Material Visual Observation / obs-comp-cand-000250 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000250`
- External reference / 外部参照: `obimd-sub-bbf56n4pg9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011896_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bbf56n4pg9/bbf56n4pg9/bbf56n4pg9.png`
- Checksum / 校验和:
  `c0eab91029eb209e93184f62fd201fd12775166532a608cfa68ac61e3c9a9877`
...
- Marked-pixel bounds: (61,33)–(188,219); span 128 × 187 px; the marked
...
- 痕迹范围：(61,33)–(188,219)；跨度128 × 187 px；痕迹矩形高于宽。
