# Material Visual Observation / obs-comp-cand-001685 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001685`
- External reference / 外部参照: `obimd-sub-88n7gfxlqz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017601_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/88n7gfxlqz/88n7gfxlqz/88n7gfxlqz.png`
- Checksum / 校验和:
  `1ff61e96c5ddb8fe1ca22c8affde9b77a61265c0063727d699f012e42ed6c7ed`
...
- Marked-pixel bounds: (67,47)–(183,212); span 117 × 166 px; the marked
...
- 痕迹范围：(67,47)–(183,212)；跨度117 × 166 px；痕迹矩形高于宽。
