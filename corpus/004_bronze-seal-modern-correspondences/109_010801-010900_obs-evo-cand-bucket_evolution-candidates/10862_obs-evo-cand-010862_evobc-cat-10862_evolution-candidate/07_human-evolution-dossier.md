...
- External category reference: `evobc-cat-10862`
- Source category ID: `10862`
- Source label for human review: `𠢦`
- Source codepoints: `U+208A6`
...
- `obs-evo-cand-010862-route-category-staging`
...
- `obs-evo-cand-010862-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010862-route-evolution-graph`
