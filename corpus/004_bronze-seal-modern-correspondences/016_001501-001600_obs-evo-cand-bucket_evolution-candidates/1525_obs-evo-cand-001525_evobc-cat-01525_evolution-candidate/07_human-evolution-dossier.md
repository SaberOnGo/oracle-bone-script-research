...
- External category reference: `evobc-cat-01525`
- Source category ID: `01525`
- Source label for human review: `吻`
...
- `obs-evo-cand-001525-route-category-staging`
...
- `obs-evo-cand-001525-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001525-route-evolution-graph`
