...
- External category reference: `evobc-cat-13103`
- Source category ID: `13103`
- Source label for human review: `𫴂`
- Source codepoints: `U+2BD02`
...
- `obs-evo-cand-013103-route-category-staging`
...
- `obs-evo-cand-013103-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013103-route-evolution-graph`
