...
- Project ID: `obs-evo-cand-003334`
- EVOBC category candidate ID: `evobc-evo-cat-03334`
- External category reference: `evobc-cat-03334`
- Source category ID: `03334`
- Source label for human review: `拹`
- Source codepoints: `U+62F9`
...
- `obs-evo-cand-003334-route-category-staging`
...
- `obs-evo-cand-003334-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003334-route-evolution-graph`
