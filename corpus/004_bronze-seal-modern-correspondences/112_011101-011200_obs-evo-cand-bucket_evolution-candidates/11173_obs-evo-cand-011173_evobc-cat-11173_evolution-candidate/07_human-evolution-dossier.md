...
- External category reference: `evobc-cat-11173`
- Source category ID: `11173`
- Source label for human review: `𢍪`
- Source codepoints: `U+2236A`
- Image reference count in source metadata: `50`
...
- `obs-evo-cand-011173-route-category-staging`
...
- `obs-evo-cand-011173-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011173-route-evolution-graph`
