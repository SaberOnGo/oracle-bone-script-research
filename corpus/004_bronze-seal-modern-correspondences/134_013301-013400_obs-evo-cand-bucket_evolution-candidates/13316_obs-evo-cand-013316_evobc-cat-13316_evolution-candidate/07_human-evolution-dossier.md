...
- External category reference: `evobc-cat-13316`
- Source category ID: `13316`
- Source label for human review: `𬟿`
- Source codepoints: `U+2C7FF`
...
- `obs-evo-cand-013316-route-category-staging`
...
- `obs-evo-cand-013316-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013316-route-evolution-graph`
