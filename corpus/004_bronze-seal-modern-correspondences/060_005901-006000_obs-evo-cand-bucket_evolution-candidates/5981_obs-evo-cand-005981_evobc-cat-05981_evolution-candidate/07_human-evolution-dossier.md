...
- External category reference: `evobc-cat-05981`
- Source category ID: `05981`
- Source label for human review: `祓`
...
- `obs-evo-cand-005981-route-category-staging`
...
- `obs-evo-cand-005981-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005981-route-evolution-graph`
