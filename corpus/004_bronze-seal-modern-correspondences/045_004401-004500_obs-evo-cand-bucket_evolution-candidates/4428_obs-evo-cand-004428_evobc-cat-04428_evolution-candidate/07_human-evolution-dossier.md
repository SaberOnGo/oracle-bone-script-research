...
- External category reference: `evobc-cat-04428`
- Source category ID: `04428`
- Source label for human review: `殷`
...
- `obs-evo-cand-004428-route-category-staging`
...
- `obs-evo-cand-004428-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004428-route-evolution-graph`
