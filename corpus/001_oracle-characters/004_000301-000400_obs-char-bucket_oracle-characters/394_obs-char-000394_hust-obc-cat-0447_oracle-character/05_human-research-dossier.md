# obs-char-000394 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000394`
- primary external id: `hust-obc-cat-0447`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/394_obs-char-000394_hust-obc-cat-0447_orac
  le-character/03_visual-assets/001_asset-000399_hust-obc-cat-0447_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0447/G_0447_乙131合19983𠂤組.png`
- asset id: `asset-000399`
...
- source category: `0447`
- validation class: `393`
- source image route: `HUST-OBC/deciphered/0447/G_0447_乙131合19983𠂤組.png`
- asset id: `asset-000399`
...
- English observation: `A thin curved outline contains a pointed side
  enclosure, with a separate narrow right-side trace; contrast needs
  recheck.`
- 中文观察: `纤细弧形轮廓含尖状侧部闭合形，右侧另有狭窄痕迹；对比度需要复核。`
...
- dataset label text: `㖵`
- dataset label codepoints: `U+35B5`
...
- filename catalog route clues: `Heji-like filename clue: 合19983
  (G_0447_乙131合19983𠂤組.png)`
...
- Which source records identify obs-char-000394 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000394？
