# obs-unk-003960 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003960`
- primary external id: `hust-obc-und-L-003960`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/060_obs-unk-003960_h
  ust-obc-und-L-003960_oracle-character-candidate/03_visual-assets/001_asset
  -005553_hust-obc-und-L-003960_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3960/L_？_8353.jpg`
- asset id: `asset-005553`
...
- source class: `HUST-OBC/undeciphered/L/3960/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3960/L_？_8353.jpg`
- asset id: `asset-005553`
...
- English observation: Curved and crossing upper traces sit above a broad lower
  enclosure with a short central descending stroke.
- 中文观察：弧向和交叉上部痕迹位于较宽下部围合轮廓之上，中央短痕向下进入
  围合内。
...
- Which source records identify obs-unk-003960 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003960？
