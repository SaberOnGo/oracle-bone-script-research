...
- External category reference: `evobc-cat-08675`
- Source category ID: `08675`
- Source label: `越`
...
- `obs-evo-cand-008675-route-category-staging`
...
- `obs-evo-cand-008675-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-008675-route-evolution-graph`
