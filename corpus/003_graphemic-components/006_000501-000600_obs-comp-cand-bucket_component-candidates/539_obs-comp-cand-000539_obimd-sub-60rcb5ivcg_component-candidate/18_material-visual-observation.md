# Material Visual Observation / obs-comp-cand-000539 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000539`
- External reference / 外部参照: `obimd-sub-60rcb5ivcg`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012773_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/orpiitt449/60rcb5ivcg/60rcb5ivcg.png`
- Checksum / 校验和:
  `52c3128c6a09579bfd00c8441313ff0b4fcaf8d473db92276ca5f2004a8c4f76`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.07%.
- Marked-pixel bounds: (96,22)–(153,225); span 58 × 204 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.07%。
- 痕迹范围：(96,22)–(153,225)；跨度58 × 204 px；痕迹矩形高于宽。
