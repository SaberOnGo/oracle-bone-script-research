# obs-unk-000156 Local Object Materials / obs-unk-000156 本地对象资料
...
- Local review image / 本地复核图像: `03_visual-assets/001_asset-001749_hust-obc-und-L-000156_glyph.jpg`

## Object Summary / 对象摘要

- Project ID / 项目 ID: `obs-unk-000156`
- Primary external reference / 首选外部参考: `hust-obc-und-L-000156`
- Source group / 来源分组: `L` (Oracle Bone Script: Six Digit Numerical Code)
- Source class path / 来源分类路径: `HUST-OBC/undeciphered/L/156/`
- Source image path / 来源图像路径: `HUST-OBC/undeciphered/L/156/L_？_1050.jpg`
- Asset ID / 资产 ID: `asset-001749`
