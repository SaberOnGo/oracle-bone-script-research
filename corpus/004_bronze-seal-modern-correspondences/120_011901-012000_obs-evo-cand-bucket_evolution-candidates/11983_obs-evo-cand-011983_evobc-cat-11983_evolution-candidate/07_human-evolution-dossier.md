...
- External category reference: `evobc-cat-11983`
- Source category ID: `11983`
- Source label for human review: `𦇃`
- Source codepoints: `U+261C3`
...
- `obs-evo-cand-011983-route-category-staging`
...
- `obs-evo-cand-011983-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011983-route-evolution-graph`
