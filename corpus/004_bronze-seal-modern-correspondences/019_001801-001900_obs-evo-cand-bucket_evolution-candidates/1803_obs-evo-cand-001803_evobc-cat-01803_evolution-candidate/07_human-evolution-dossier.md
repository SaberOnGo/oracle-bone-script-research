...
- External category reference: `evobc-cat-01803`
- Source category ID: `01803`
- Source label for human review: `址`
- Source codepoints: `U+5740`
...
- `obs-evo-cand-001803-route-category-staging`
...
- `obs-evo-cand-001803-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001803-route-evolution-graph`
