...
- External category reference: `evobc-cat-00347`
- Source category ID: `00347`
- Source label for human review: `䍢`
- Source codepoints: `U+4362`
...
- `obs-evo-cand-000347-route-category-staging`
...
- `obs-evo-cand-000347-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000347-route-evolution-graph`
