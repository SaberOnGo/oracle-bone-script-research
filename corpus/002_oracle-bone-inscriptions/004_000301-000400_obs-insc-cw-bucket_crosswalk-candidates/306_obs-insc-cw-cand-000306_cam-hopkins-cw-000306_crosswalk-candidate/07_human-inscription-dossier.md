...
- Yingguo / 英国所藏: `y1954` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `461` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `21` in source row; primary catalog entry pending
- Heji / 合集: `41145` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000306`
