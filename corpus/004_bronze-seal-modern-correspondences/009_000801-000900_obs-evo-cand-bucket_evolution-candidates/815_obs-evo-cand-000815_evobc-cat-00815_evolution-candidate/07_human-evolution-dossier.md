...
Project ID: `obs-evo-cand-000815`
...
- Project ID: `obs-evo-cand-000815`
- EVOBC category candidate ID: `evobc-evo-cat-00815`
- External category reference: `evobc-cat-00815`
- Source category ID: `00815`
- Source label for human review: `佤`
- Source codepoints: `U+4F64`
...
- `obs-evo-cand-000815-route-category-staging`
...
- `obs-evo-cand-000815-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000815-route-evolution-graph`
