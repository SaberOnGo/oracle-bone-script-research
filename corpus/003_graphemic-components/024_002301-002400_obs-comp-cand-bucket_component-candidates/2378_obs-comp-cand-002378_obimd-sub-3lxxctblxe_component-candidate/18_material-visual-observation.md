# Material Visual Observation / obs-comp-cand-002378 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002378`
- External reference / 外部参照: `obimd-sub-3lxxctblxe`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020449_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3lxxctblxe/3lxxctblxe/3lxxctblxe.png`
- Checksum / 校验和:
  `68523e3972ac016f5cc3b37fd8a5961c0999082f355c439d14582001109f48e5`
...
- Marked-pixel bounds: (73,27)–(176,220); span 104 × 194 px; the marked
...
- 痕迹范围：(73,27)–(176,220)；跨度104 × 194 px；痕迹矩形高于宽。
