# obs-unk-004026 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/026_obs-unk-004026_h
  ust-obc-und-L-004026_oracle-character-candidate/03_visual-assets/001_asset
  -005619_hust-obc-und-L-004026_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4026/L_？_8598.jpg`
- asset id: `asset-005619`
...
- source class: `HUST-OBC/undeciphered/L/4026/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4026/L_？_8598.jpg`
- asset id: `asset-005619`
...
- 中文观察：两条高向尖顶轮廓并列；下部两者之间有横向或梯形痕迹组合，中央较深。
    图像未显示外侧轮廓的完整末端。
...
- Which source records identify obs-unk-004026 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004026？
