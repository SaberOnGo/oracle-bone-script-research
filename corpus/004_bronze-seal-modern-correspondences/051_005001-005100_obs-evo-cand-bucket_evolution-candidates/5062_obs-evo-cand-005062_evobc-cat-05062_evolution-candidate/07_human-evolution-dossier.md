...
- External category reference: `evobc-cat-05062`
- Source category ID: `05062`
- Source label for human review: `烈`
- Source codepoints: `U+70C8`
...
- `obs-evo-cand-005062-route-category-staging`
...
- `obs-evo-cand-005062-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005062-route-evolution-graph`
