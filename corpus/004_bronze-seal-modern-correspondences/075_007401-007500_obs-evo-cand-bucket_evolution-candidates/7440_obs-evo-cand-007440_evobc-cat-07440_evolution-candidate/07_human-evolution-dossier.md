...
- Project ID: `obs-evo-cand-007440`
- EVOBC category candidate ID: `evobc-evo-cat-07440`
- External category reference: `evobc-cat-07440`
- Source category ID: `07440`
- Source label for human review: `萊`
- Source codepoints: `U+840A`
...
- `obs-evo-cand-007440-route-category-staging`
...
- `obs-evo-cand-007440-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007440-route-evolution-graph`
