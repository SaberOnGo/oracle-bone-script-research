# obs-unk-004481 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/081_obs-unk-004481_h
  ust-obc-und-X-004481_oracle-character-candidate/03_visual-assets/001_asset
  -006074_hust-obc-und-X-004481_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/37/X_？_8215_1.png`
- asset id: `asset-006074`
...
- source class: `HUST-OBC/undeciphered/X/37/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/37/X_？_8215_1.png`
- asset id: `asset-006074`
...
- English observation: A large triangular outline narrows at a central crossing
  above a lower area with a small inner branch.
- 中文观察: 大型三角框状痕迹在中央交叉处收窄，下部有小分支内痕。
...
- Which source records identify obs-unk-004481 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004481？
