...
- External category reference: `evobc-cat-10615`
- Source category ID: `10615`
- Source label for human review: `麝`
...
- `obs-evo-cand-010615-route-category-staging`
...
- `obs-evo-cand-010615-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010615-route-evolution-graph`
