# obs-unk-004747 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004747`
- primary external id: `hust-obc-und-X-004747`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/047_obs-unk-004747_h
  ust-obc-und-X-004747_oracle-character-candidate/03_visual-assets/001_asset
  -006340_hust-obc-und-X-004747_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/303/X_？_7289_1.png`
- asset id: `asset-006340`
...
- source class: `HUST-OBC/undeciphered/X/303/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/303/X_？_7289_1.png`
- asset id: `asset-006340`
...
- English observation: `branching upper group with long lower terminal`
- 中文观察: `带下部长末笔的上部分支组`
...
- Which source records identify obs-unk-004747 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004747？
