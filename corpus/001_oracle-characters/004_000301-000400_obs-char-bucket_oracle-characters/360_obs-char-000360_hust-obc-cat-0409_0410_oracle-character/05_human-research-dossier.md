# obs-char-000360 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000360`
- primary external id: `hust-obc-cat-0409_0410`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/360_obs-char-000360_hust-obc-cat-0409_0410
  _oracle-character/03_visual-assets/001_asset-000365_hust-obc-cat-0409_0410
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0409_0410/0409/G_0409_京都3241(甲)
  .png`
- asset id: `asset-000365`
...
- source category: `0409_0410`
- validation class: `359`
- source image route: `HUST-OBC/deciphered/0409_0410/0409/G_0409_京都3241(甲).png
  `
- asset id: `asset-000365`
...
- English observation: `A central rounded enclosure is crossed by horizontal
  and vertical strokes, with pointed forms extending in four directions.`
- 中文观察: `中部圆弧闭合轮廓被横竖笔画交叉，四个方向均有尖状形体延伸。`
...
- dataset label text: `㖏㖐`
- dataset label codepoints: `U+358F;U+3590`
...
- graph edge count: `2`
- codepoint routes: `U+358F;U+3590`
...
- Which source records identify obs-char-000360 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000360？
