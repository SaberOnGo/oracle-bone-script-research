...
- External category reference: `evobc-cat-02229`
- Source category ID: `02229`
- Source label for human review: `媒`
- Source codepoints: `U+5A92`
...
- `obs-evo-cand-002229-route-category-staging`
...
- `obs-evo-cand-002229-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002229-route-evolution-graph`
