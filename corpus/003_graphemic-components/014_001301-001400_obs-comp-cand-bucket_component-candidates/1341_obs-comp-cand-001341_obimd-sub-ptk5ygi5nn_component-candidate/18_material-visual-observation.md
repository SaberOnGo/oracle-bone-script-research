# Material Visual Observation / obs-comp-cand-001341 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001341`
- External reference / 外部参照: `obimd-sub-ptk5ygi5nn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015724_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/f9f0lfjetk/ptk5ygi5nn/ptk5ygi5nn.png`
- Checksum / 校验和:
  `085c5cd3fcc3c04ce5f5bf041ce3c755f26c1bfc1dac8132dc6e280fd710ea5f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.88%.
- Marked-pixel bounds: (61,50)–(188,195); span 128 × 146 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.88%。
- 痕迹范围：(61,50)–(188,195)；跨度128 × 146 px；痕迹矩形近方形。
