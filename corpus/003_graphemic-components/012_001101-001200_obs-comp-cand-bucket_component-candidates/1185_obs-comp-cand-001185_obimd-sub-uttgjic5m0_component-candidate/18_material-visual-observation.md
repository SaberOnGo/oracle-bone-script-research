# Material Visual Observation / obs-comp-cand-001185 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001185`
- External reference / 外部参照: `obimd-sub-uttgjic5m0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015375_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/upv9mf4trj/uttgjic5m0/uttgjic5m0.png`
- Checksum / 校验和:
  `52ef55641d06804587999fc54a539989bc0c0f4c16378476c34fce6cd20effa6`
...
- Marked-pixel bounds: (78,24)–(184,225); span 107 × 202 px; the marked
...
- 痕迹范围：(78,24)–(184,225)；跨度107 × 202 px；痕迹矩形高于宽。
