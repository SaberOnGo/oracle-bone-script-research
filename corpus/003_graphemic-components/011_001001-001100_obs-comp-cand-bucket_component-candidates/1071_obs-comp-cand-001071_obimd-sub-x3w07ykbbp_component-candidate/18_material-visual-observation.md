# Material Visual Observation / obs-comp-cand-001071 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001071`
- External reference / 外部参照: `obimd-sub-x3w07ykbbp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014621_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/a7fntjnau2/x3w07ykbbp/x3w07ykbbp.png`
- Checksum / 校验和:
  `f47e50a57b92bd5ea5ffd45b960589e81caf933b7dc664e168648868f1c36c0c`
...
- Marked-pixel bounds: (88,23)–(161,226); span 74 × 204 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.49%。
- 痕迹范围：(88,23)–(161,226)；跨度74 × 204 px；痕迹矩形高于宽。
