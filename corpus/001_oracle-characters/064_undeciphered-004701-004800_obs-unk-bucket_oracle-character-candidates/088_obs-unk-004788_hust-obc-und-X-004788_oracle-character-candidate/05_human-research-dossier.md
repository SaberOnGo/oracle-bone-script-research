# obs-unk-004788 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004788`
- primary external id: `hust-obc-und-X-004788`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/088_obs-unk-004788_h
  ust-obc-und-X-004788_oracle-character-candidate/03_visual-assets/001_asset
  -006381_hust-obc-und-X-004788_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/344/X_？_7326_1.png`
- asset id: `asset-006381`
...
- source class: `HUST-OBC/undeciphered/X/344/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/344/X_？_7326_1.png`
- asset id: `asset-006381`
...
- English observation: `upper enclosure, lower opening, and right curve`
- 中文观察: `上部围合、下部开口和右侧曲线`
...
- Which source records identify obs-unk-004788 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004788？
