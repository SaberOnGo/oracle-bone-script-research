...
- External category reference: `evobc-cat-04905`
- Source category ID: `04905`
- Source label for human review: `潢`
...
- `obs-evo-cand-004905-route-category-staging`
...
- `obs-evo-cand-004905-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004905-route-evolution-graph`
