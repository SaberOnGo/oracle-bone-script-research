# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003233
...
- EVOBC candidate category: `evobc-evo-cat-03233`.
- Source label for search only: `戼`.
- Source codepoints for search only: `U+623C`.
