# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002623
...
| Glyph or codepoint route / 字形或码位路线 | 45 OBIMD route rows; examples U+FEC7B; U+FEC7C; 另有 43 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
