...
Project ID: `obs-evo-cand-010196`
...
- Project ID: `obs-evo-cand-010196`
- EVOBC category candidate ID: `evobc-evo-cat-10196`
- External category reference: `evobc-cat-10196`
- Source category ID: `10196`
- Source label for human review: `駪`
- Source codepoints: `U+99EA`
...
- `obs-evo-cand-010196-route-category-staging`
...
- `obs-evo-cand-010196-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010196-route-evolution-graph`
