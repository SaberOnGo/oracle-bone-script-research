# Material Visual Observation / obs-comp-cand-000417 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000417`
- External reference / 外部参照: `obimd-sub-p8enf49eh4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012340_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/exg6lsn5w7/p8enf49eh4/p8enf49eh4.png`
- Checksum / 校验和:
  `e9a2ad4bc91abc9d6972586f3edda4d9b1ebd2255e6f3be82b9186875e04f4f5`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.51%.
- Marked-pixel bounds: (70,45)–(179,215); span 110 × 171 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.51%。
- 痕迹范围：(70,45)–(179,215)；跨度110 × 171 px；痕迹矩形高于宽。
