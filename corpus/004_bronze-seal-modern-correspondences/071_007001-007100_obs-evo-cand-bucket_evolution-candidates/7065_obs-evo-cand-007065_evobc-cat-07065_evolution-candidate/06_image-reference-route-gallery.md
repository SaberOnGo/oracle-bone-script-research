...
- `obs-evo-cand-007065-route-category-staging`
...
- `obs-evo-cand-007065-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007065-route-evolution-graph`
