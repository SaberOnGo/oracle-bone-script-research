...
Project ID: `obs-evo-cand-000275`
...
- Project ID: `obs-evo-cand-000275`
- EVOBC category candidate ID: `evobc-evo-cat-00275`
- External category reference: `evobc-cat-00275`
- Source category ID: `00275`
- Source label for human review: `䁧`
- Source codepoints: `U+4067`
...
- `obs-evo-cand-000275-route-category-staging`
...
- `obs-evo-cand-000275-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000275-route-evolution-graph`
