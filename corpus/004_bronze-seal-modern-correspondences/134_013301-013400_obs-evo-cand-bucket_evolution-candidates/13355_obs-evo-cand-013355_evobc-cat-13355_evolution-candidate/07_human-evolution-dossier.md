...
- External category reference: `evobc-cat-13355`
- Source category ID: `13355`
- Source label for human review: `𬥢`
- Source codepoints: `U+2C962`
...
- `obs-evo-cand-013355-route-category-staging`
...
- `obs-evo-cand-013355-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013355-route-evolution-graph`
