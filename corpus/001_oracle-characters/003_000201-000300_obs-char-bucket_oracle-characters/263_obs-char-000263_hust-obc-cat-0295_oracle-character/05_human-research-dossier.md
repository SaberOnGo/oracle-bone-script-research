# obs-char-000263 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/263_obs-char-000263_hust-obc-cat-0295_orac
  le-character/03_visual-assets/001_asset-000268_hust-obc-cat-0295_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0295/G_0295_佚211合34124歷組.png`
- asset id: `asset-000268`
...
- source category: `0295`
- validation class: `262`
- source image route: `HUST-OBC/deciphered/0295/G_0295_佚211合34124歷組.png`
- asset id: `asset-000268`
...
- English observation: `The narrow image shows a tall outer stroke with a
  small stacked enclosed form near the center; the lower end remains partly
  open.`
- 中文观察: `狭长图像有高而外侧的笔画，中部附近有小型叠置闭合形体，下端仍部分开放。`
...
- dataset label text: `㔝`
- dataset label codepoints: `U+351D`
...
- filename catalog route clues: `Heji-like filename clue: 合34124
  (G_0295_佚211合34124歷組.png)`
...
- Which source records identify obs-char-000263 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000263？
