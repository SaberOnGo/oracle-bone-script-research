# Material Visual Observation / obs-comp-cand-001961 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001961`
- External reference / 外部参照: `obimd-sub-eq0zcoihok`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018771_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/eq0zcoihok/eq0zcoihok/eq0zcoihok.png`
- Checksum / 校验和:
  `4ff550619b73448ef44a214f4acbdcc59d65391313d90d04b8140417d9922b69`
...
- Marked-pixel bounds: (80,22)–(166,225); span 87 × 204 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.45%。
- 痕迹范围：(80,22)–(166,225)；跨度87 × 204 px；痕迹矩形高于宽。
