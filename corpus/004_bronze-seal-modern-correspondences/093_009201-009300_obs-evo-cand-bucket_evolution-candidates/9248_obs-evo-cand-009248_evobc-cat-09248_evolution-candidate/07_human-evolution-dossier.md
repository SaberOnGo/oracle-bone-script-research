...
- Project ID: `obs-evo-cand-009248`
- EVOBC category candidate ID: `evobc-evo-cat-09248`
- External category reference: `evobc-cat-09248`
- Source category ID: `09248`
- Source label for human review: `酤`
- Source codepoints: `U+9164`
...
- `obs-evo-cand-009248-route-category-staging`
...
- `obs-evo-cand-009248-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009248-route-evolution-graph`
