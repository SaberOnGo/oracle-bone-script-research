...
- Project ID / 项目 ID: `obs-char-000717`
- Primary external ID / 首选外部 ID: `hust-obc-cat-0814`
...
- Source image / 来源图: `G_0814_合1030正賓組.png`
- Image / 图像: `001_asset-000722_hust-obc-cat-0814_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合1030
  (G_0814_合1030正賓組.png)`
...
- target node: `obimd-main-cand-002147`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Matched OBIMD main UIDs / OBIMD 主字 UID: `w35ugpg42y`
...
- Source label text / 来源标签文字: `㜤`
- Source label codepoint / 来源标签 codepoint: `U+3724`
