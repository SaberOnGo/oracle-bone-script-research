...
- External category reference: `evobc-cat-07548`
- Source category ID: `07548`
- Source label for human review: `蔈`
...
- `obs-evo-cand-007548-route-category-staging`
...
- `obs-evo-cand-007548-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007548-route-evolution-graph`
