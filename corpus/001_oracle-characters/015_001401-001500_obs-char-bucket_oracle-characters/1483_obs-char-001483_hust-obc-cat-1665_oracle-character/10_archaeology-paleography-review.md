# obs-char-001483 Archaeology Paleography Review

# obs-char-001483 考古文字复核档案
...
- first local image: `001_asset-001488_hust-obc-cat-1665_glyph.png`
- first source image: `G_1665_合36417(甲).png`
...
- source label text: `㩷`
- source label codepoints: `U+3A77`
