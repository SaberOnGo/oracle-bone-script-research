...
- `obs-evo-cand-003124-route-category-staging`
...
- `obs-evo-cand-003124-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003124-route-evolution-graph`
