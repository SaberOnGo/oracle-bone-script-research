...
Project ID: `obs-evo-cand-000809`
...
- Project ID: `obs-evo-cand-000809`
- EVOBC category candidate ID: `evobc-evo-cat-00809`
- External category reference: `evobc-cat-00809`
- Source category ID: `00809`
- Source label for human review: `佛`
- Source codepoints: `U+4F5B`
...
- `obs-evo-cand-000809-route-category-staging`
...
- `obs-evo-cand-000809-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000809-route-evolution-graph`
