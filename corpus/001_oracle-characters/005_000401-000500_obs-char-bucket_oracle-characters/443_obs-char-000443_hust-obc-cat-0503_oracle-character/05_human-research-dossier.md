# obs-char-000443 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000443`
- primary external id: `hust-obc-cat-0503`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/443_obs-char-000443_hust-obc-cat-0503_orac
  le-character/03_visual-assets/001_asset-000448_hust-obc-cat-0503_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0503/G_0503_乙424(甲).png`
- asset id: `asset-000448`
...
- source category: `0503`
- validation class: `442`
- source image route: `HUST-OBC/deciphered/0503/G_0503_乙424(甲).png`
- asset id: `asset-000448`
...
- English observation: `The very small image shows a narrow vertical form
  with two stacked enclosed marks near the top, a curved middle stroke, and
  a thin angular tail.`
...
- dataset label text: `㗭`
- dataset label codepoints: `U+35ED`
...
- Which source records identify obs-char-000443 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000443？
