...
- External category reference: `evobc-cat-05614`
- Source category ID: `05614`
- Source label for human review: `疣`
- Source codepoints: `U+75A3`
...
- `obs-evo-cand-005614-route-category-staging`
...
- `obs-evo-cand-005614-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005614-route-evolution-graph`
