# Material Visual Observation / obs-unk-002644
...
- Project ID / 项目 ID: `obs-unk-002644`
- Source / 来源: `src-hust-obc`
- Primary external reference / 首选外部参考:
  `hust-obc-und-L-002644`
- Committed image / 已提交图像:
  `03_visual-assets/001_asset-004237_hust-obc-und-L-002644_glyph.jpg`
- Opened derivative / 已打开派生件: the committed review image

## Direct Visual Record / 直接可见记录

- English observation: A compact dark cluster combines short horizontal,
  vertical, and diagonal strokes. The left side projects outward and the
  lower edge narrows into separate ends.
- 中文观察：紧凑的深色笔痕群由短横、纵向和斜向笔痕组成。左侧向外伸出，
  下缘收窄为彼此分开的末端。
