# obs-comp-cand-000087 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000087`
- 首选外部 ID: `obimd-sub-aawiifil1h`
- OBIMD subcharacter UID: `aawiifil1h`
- OBIMD main character UID: `aawiifil1h`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+F08A5; U+F08A6; 另有 3 项
