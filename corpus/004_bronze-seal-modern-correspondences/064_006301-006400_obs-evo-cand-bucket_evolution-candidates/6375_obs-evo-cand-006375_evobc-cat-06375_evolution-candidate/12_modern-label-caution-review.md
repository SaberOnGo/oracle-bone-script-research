# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006375
...
- EVOBC candidate category: `evobc-evo-cat-06375`.
- Source label for search only: `籚`.
- Source codepoints for search only: `U+7C5A`.
