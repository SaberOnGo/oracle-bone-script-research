...
- External category reference: `evobc-cat-13677`
- Source category ID: `13677`
- Source label for human review: `𮥼`
- Source codepoints: `U+2E97C`
...
- `obs-evo-cand-013677-route-category-staging`
...
- `obs-evo-cand-013677-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013677-route-evolution-graph`
