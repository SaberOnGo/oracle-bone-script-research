...
Project ID: `obs-evo-cand-010673`
...
- Project ID: `obs-evo-cand-010673`
- EVOBC category candidate ID: `evobc-evo-cat-10673`
- External category reference: `evobc-cat-10673`
- Source category ID: `10673`
- Source label for human review: `黾`
- Source codepoints: `U+9EFE`
...
- `obs-evo-cand-010673-route-category-staging`
...
- `obs-evo-cand-010673-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010673-route-evolution-graph`
