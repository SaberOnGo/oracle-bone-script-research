# obs-unk-004236 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/036_obs-unk-004236_h
  ust-obc-und-L-004236_oracle-character-candidate/03_visual-assets/001_asset
  -005829_hust-obc-und-L-004236_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4236/L_？_9298.jpg`
- asset id: `asset-005829`
...
- source class: `HUST-OBC/undeciphered/L/4236/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4236/L_？_9298.jpg`
- asset id: `asset-005829`
...
- English observation: `Upper outline, inner bars, central stroke visible.`
- 中文观察: `上部轮廓、内部横笔画和中央笔画可见。`
...
- Which source records identify obs-unk-004236 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004236？
