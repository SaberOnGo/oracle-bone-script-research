...
Project ID: `obs-evo-cand-005760`
...
- Project ID: `obs-evo-cand-005760`
- EVOBC category candidate ID: `evobc-evo-cat-05760`
- External category reference: `evobc-cat-05760`
- Source category ID: `05760`
- Source label for human review: `盡`
- Source codepoints: `U+76E1`
...
- `obs-evo-cand-005760-route-category-staging`
...
- `obs-evo-cand-005760-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005760-route-evolution-graph`
