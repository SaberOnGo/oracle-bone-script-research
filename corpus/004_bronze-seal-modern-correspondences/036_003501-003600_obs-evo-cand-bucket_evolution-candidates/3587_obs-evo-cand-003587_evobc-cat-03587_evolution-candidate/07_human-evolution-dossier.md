...
Project ID: `obs-evo-cand-003587`
...
- Project ID: `obs-evo-cand-003587`
- EVOBC category candidate ID: `evobc-evo-cat-03587`
- External category reference: `evobc-cat-03587`
- Source category ID: `03587`
- Source label for human review: `敗`
- Source codepoints: `U+6557`
- Image reference count in source metadata: `176`
...
- `obs-evo-cand-003587-route-category-staging`
...
- `obs-evo-cand-003587-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003587-route-evolution-graph`
