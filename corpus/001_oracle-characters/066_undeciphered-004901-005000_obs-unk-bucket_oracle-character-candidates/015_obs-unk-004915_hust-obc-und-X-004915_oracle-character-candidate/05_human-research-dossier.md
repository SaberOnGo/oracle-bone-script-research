# obs-unk-004915 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004915`
- primary external id: `hust-obc-und-X-004915`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/015_obs-unk-004915_h
  ust-obc-und-X-004915_oracle-character-candidate/03_visual-assets/001_asset
  -006508_hust-obc-und-X-004915_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/471/X_？_7127_1.png`
- asset id: `asset-006508`
...
- A central junction has an opening and several lower branches.
- The single source view is present locally.
- 直接记录：`14_material-visual-observation.md`
- 中央连接处有一个开口，并向下分出数条分枝。
- 单一来源视图已在本地保存。
...
- source class: `HUST-OBC/undeciphered/X/471/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/471/X_？_7127_1.png`
- asset id: `asset-006508`
...
- Which source records identify obs-unk-004915 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004915？
