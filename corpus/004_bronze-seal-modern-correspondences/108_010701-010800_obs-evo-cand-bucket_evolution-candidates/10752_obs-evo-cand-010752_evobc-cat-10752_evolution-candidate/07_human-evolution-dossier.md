...
- Project ID: `obs-evo-cand-010752`
- EVOBC category candidate ID: `evobc-evo-cat-10752`
- External category reference: `evobc-cat-10752`
- Source category ID: `10752`
- Source label for human review: `龙`
- Source codepoints: `U+9F99`
...
- `obs-evo-cand-010752-route-category-staging`
...
- `obs-evo-cand-010752-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010752-route-evolution-graph`
