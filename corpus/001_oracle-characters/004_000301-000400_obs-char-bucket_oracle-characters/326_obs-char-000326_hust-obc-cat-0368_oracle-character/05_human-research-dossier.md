# obs-char-000326 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/326_obs-char-000326_hust-obc-cat-0368_orac
  le-character/03_visual-assets/001_asset-000331_hust-obc-cat-0368_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0368/G_0368_乙1049合21729子組.png`
- asset id: `asset-000331`
...
- source category: `0368`
- validation class: `325`
- source image route: `HUST-OBC/deciphered/0368/G_0368_乙1049合21729子組.png`
- asset id: `asset-000331`
...
- English observation: `Two rounded terminal forms are joined by an upper
  horizontal stroke, with a single central vertical stroke descending
  below.`
...
- dataset label text: `㕦`
- dataset label codepoints: `U+3566`
...
- OBIMD candidate ids / OBIMD 候选 ID: `obimd-main-cand-000891`
- OBIMD external refs / OBIMD 外部引用: `obimd-main-x0w8luxhhs`
- OBIMD transcription field / OBIMD 转写字段: `㕦`
...
- matched OBIMD main UIDs: `x0w8luxhhs`
- object-local component human files / 对象内构件人类档案:
  corpus/003_graphemic-components/007_000601-000700_obs-comp-cand-bucket_compo
  nent-candidates/621_obs-comp-cand-000621_obimd-sub-x0w8luxhhs_component-cand
  idate/README.md
  corpus/003_graphemic-components/007_000601-000700_obs-comp-cand-bucket_compo
  nent-candidates/621_obs-comp-cand-000621_obimd-sub-x0w8luxhhs_component-cand
...
- filename catalog route clues: `Heji-like filename clue: 合21729
  (G_0368_乙1049合21729子組.png)`
...
- Which source records identify obs-char-000326 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000326？
