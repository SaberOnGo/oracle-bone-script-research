...
Project ID: `obs-evo-cand-013554`
...
- Project ID: `obs-evo-cand-013554`
- EVOBC category candidate ID: `evobc-evo-cat-13554`
- External category reference: `evobc-cat-13554`
- Source category ID: `13554`
- Source label for human review: `𭪨`
- Source codepoints: `U+2DAA8`
...
- `obs-evo-cand-013554-route-category-staging`
...
- `obs-evo-cand-013554-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013554-route-evolution-graph`
