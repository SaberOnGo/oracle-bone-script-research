# obs-char-001319 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001319`
- primary external id: `hust-obc-cat-1475`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1319_obs-char-001319_hust-obc-cat-1475_ora
  cle-character/03_visual-assets/001_asset-001324_hust-obc-cat-1475_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1475/X_1475_770_1.png`
- asset id: `asset-001324`
...
- source category: `1475`
- validation class: `1318`
- source image route: `HUST-OBC/deciphered/1475/X_1475_770_1.png`
- asset id: `asset-001324`
...
- dataset label text: `㦹`
- dataset label codepoints: `U+39B9`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00140`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00140`
- EvoBC image reference count / EvoBC 图像引用数: `16`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00140`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/140_obs-evo-can
  d-000140_evobc-cat-00140_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/140_obs-evo-cand-000140_evobc-cat-00140_evolu
...
- Which source records identify obs-char-001319 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001319？
