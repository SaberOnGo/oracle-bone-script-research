# obs-unk-004008 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/008_obs-unk-004008_h
  ust-obc-und-L-004008_oracle-character-candidate/03_visual-assets/001_asset
  -005601_hust-obc-und-L-004008_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4008/L_？_8498.jpg`
- asset id: `asset-005601`
...
- source class: `HUST-OBC/undeciphered/L/4008/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4008/L_？_8498.jpg`
- asset id: `asset-005601`
...
- English observation: A rectangular outline is on the left and a smaller
  rounded trace is on the right; a lower horizontal trace crosses between them.
- 中文观察：左侧有矩形轮廓，右侧有较小圆弧状痕迹；下部横向痕迹在两者之间
  穿过。
...
- Which source records identify obs-unk-004008 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004008？
