...
- Project ID: `obs-evo-cand-007815`
- EVOBC category candidate ID: `evobc-evo-cat-07815`
- External category reference: `evobc-cat-07815`
- Source category ID: `07815`
- Source label for human review: `蝡`
- Source codepoints: `U+8761`
...
- `obs-evo-cand-007815-route-category-staging`
...
- `obs-evo-cand-007815-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007815-route-evolution-graph`
