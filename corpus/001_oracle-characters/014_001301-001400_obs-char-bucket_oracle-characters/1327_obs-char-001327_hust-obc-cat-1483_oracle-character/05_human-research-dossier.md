# obs-char-001327 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1327_obs-char-001327_hust-obc-cat-1483_ora
  cle-character/03_visual-assets/001_asset-001332_hust-obc-cat-1483_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1483/G_1483_乙1150(甲).png`
- asset id: `asset-001332`
...
- source category: `1483`
- validation class: `1326`
- source image route: `HUST-OBC/deciphered/1483/G_1483_乙1150(甲).png`
- asset id: `asset-001332`
...
- dataset label text: `㧁`
- dataset label codepoints: `U+39C1`
...
- Which source records identify obs-char-001327 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001327？
