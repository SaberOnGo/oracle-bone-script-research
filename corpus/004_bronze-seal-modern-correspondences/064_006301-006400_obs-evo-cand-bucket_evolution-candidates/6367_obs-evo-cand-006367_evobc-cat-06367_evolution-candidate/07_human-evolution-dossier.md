...
Project ID: `obs-evo-cand-006367`
...
- Project ID: `obs-evo-cand-006367`
- EVOBC category candidate ID: `evobc-evo-cat-06367`
- External category reference: `evobc-cat-06367`
- Source category ID: `06367`
- Source label for human review: `籋`
- Source codepoints: `U+7C4B`
...
- `obs-evo-cand-006367-route-category-staging`
...
- `obs-evo-cand-006367-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006367-route-evolution-graph`
