# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012780
...
- EVOBC candidate category: `evobc-evo-cat-12780`.
- Source label for search only: `𪖜`.
- Source codepoints for search only: `U+2A59C`.
