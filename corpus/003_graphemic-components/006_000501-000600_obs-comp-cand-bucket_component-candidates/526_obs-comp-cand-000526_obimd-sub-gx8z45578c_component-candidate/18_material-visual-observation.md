# Material Visual Observation / obs-comp-cand-000526 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000526`
- External reference / 外部参照: `obimd-sub-gx8z45578c`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012760_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gx8z45578c/gx8z45578c/gx8z45578c.png`
- Checksum / 校验和:
  `80077603a89b1138ef4d7a11aa8ddaba01252162eb608ef4110cbe3f81c4665a`
...
- Marked-pixel bounds: (76,24)–(173,225); span 98 × 202 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.64%。
- 痕迹范围：(76,24)–(173,225)；跨度98 × 202 px；痕迹矩形高于宽。
