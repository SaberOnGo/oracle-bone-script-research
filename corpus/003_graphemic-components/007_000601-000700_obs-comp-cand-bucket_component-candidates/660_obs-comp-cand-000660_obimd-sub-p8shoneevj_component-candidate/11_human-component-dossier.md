# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-000660
...
- candidate_component_id: `obs-comp-cand-000660`
- primary_external_ref_id: `obimd-sub-p8shoneevj`
- source_subcharacter_uid: `p8shoneevj`
- source_main_character_uid: `p8shoneevj`
- main_character_external_ref_id: `obimd-main-p8shoneevj`
...
- glyph_codepoint_uplus_sample: `U+F3CC6, U+F3CC7`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-013223` | `001_asset-013223_img.png` | `9b20acfc878047cead4e6440fd1bc02437a8e476f4af5cf780bbd0670f69e2be` |
