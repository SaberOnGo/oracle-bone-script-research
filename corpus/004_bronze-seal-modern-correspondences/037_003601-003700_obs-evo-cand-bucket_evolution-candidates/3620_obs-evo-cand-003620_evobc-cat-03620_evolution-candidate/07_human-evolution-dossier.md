...
- External category reference: `evobc-cat-03620`
- Source category ID: `03620`
- Source label: `斂`
...
- `obs-evo-cand-003620-route-category-staging`
...
- `obs-evo-cand-003620-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003620-route-evolution-graph`
