# obs-unk-004101 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/001_obs-unk-004101_h
  ust-obc-und-L-004101_oracle-character-candidate/03_visual-assets/001_asset
  -005694_hust-obc-und-L-004101_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4101/L_？_8821.jpg`
- asset id: `asset-005694`
...
- source class: `HUST-OBC/undeciphered/L/4101/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4101/L_？_8821.jpg`
- asset id: `asset-005694`
...
- English observation: A short upright trace appears above a darker lower
  group. The lower group contains two slanting traces that meet around a
  small angular area; the exact joins and endpoints are uncertain.
- 中文观察：图像上方有一条短的竖向痕迹，下方是较深的痕迹组。
...
- Which source records identify obs-unk-004101 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004101？
