# Material Visual Observation / obs-comp-cand-001873 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001873`
- External reference / 外部参照: `obimd-sub-uqs2fdx4y0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018252_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lfox6x1ojm/uqs2fdx4y0/uqs2fdx4y0.png`
- Checksum / 校验和:
  `f7ce728ec03217de6f5e38197d4d274f9eb63139b423a54784502e819fb1b219`
...
- Marked-pixel bounds: (61,17)–(189,228); span 129 × 212 px; the marked
...
- 痕迹范围：(61,17)–(189,228)；跨度129 × 212 px；痕迹矩形高于宽。
