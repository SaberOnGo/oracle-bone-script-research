...
- Project ID: `obs-evo-cand-007889`
- EVOBC category candidate ID: `evobc-evo-cat-07889`
- External category reference: `evobc-cat-07889`
- Source category ID: `07889`
- Source label for human review: `蠲`
- Source codepoints: `U+8832`
...
- `obs-evo-cand-007889-route-category-staging`
...
- `obs-evo-cand-007889-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007889-route-evolution-graph`
