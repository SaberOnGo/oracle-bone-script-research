...
Project ID: `obs-evo-cand-012638`
...
- Project ID: `obs-evo-cand-012638`
- EVOBC category candidate ID: `evobc-evo-cat-12638`
- External category reference: `evobc-cat-12638`
- Source category ID: `12638`
- Source label for human review: `𩞯`
- Source codepoints: `U+297AF`
...
- `obs-evo-cand-012638-route-category-staging`
...
- `obs-evo-cand-012638-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012638-route-evolution-graph`
