...
- External category reference: `evobc-cat-00335`
- Source category ID: `00335`
- Source label for human review: `䌙`
...
- `obs-evo-cand-000335-route-category-staging`
...
- `obs-evo-cand-000335-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000335-route-evolution-graph`
