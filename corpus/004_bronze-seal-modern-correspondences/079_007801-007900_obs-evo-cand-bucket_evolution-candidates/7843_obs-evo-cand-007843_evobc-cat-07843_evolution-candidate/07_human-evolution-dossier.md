...
Project ID: `obs-evo-cand-007843`
...
- Project ID: `obs-evo-cand-007843`
- EVOBC category candidate ID: `evobc-evo-cat-07843`
- External category reference: `evobc-cat-07843`
- Source category ID: `07843`
- Source label for human review: `螾`
- Source codepoints: `U+87BE`
...
- `obs-evo-cand-007843-route-category-staging`
...
- `obs-evo-cand-007843-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007843-route-evolution-graph`
