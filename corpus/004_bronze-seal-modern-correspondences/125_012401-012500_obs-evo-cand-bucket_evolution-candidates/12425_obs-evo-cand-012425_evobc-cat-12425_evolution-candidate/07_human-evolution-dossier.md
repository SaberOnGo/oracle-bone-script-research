...
Project ID: `obs-evo-cand-012425`
...
- Project ID: `obs-evo-cand-012425`
- EVOBC category candidate ID: `evobc-evo-cat-12425`
- External category reference: `evobc-cat-12425`
- Source category ID: `12425`
- Source label for human review: `𨛓`
- Source codepoints: `U+286D3`
...
- `obs-evo-cand-012425-route-category-staging`
...
- `obs-evo-cand-012425-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012425-route-evolution-graph`
