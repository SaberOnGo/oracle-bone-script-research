# obs-unk-007534 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-007534`
- primary external id: `hust-obc-und-YH-007534`
...
- local review image route: `corpus/001_oracle-characters/092_undeciphered-007
  501-007600_obs-unk-bucket_oracle-character-candidates/034_obs-unk-007534_h
  ust-obc-und-YH-007534_oracle-character-candidate/03_visual-assets/001_asse
  t-009125_hust-obc-und-YH-007534_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/600A7/Y_？_600A7.jpg`
- asset id: `asset-009125`
...
- source class: `HUST-OBC/undeciphered/Y+H/600A7/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/600A7/Y_？_600A7.jpg`
- asset id: `asset-009125`
...
- Which source records identify obs-unk-007534 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007534？
