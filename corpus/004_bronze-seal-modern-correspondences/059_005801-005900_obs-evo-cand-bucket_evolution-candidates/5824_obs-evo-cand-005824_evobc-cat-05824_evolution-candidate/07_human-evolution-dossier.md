...
- External category reference: `evobc-cat-05824`
- Source category ID: `05824`
- Source label: `睒`
...
- `obs-evo-cand-005824-route-category-staging`
...
- `obs-evo-cand-005824-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005824-route-evolution-graph`
