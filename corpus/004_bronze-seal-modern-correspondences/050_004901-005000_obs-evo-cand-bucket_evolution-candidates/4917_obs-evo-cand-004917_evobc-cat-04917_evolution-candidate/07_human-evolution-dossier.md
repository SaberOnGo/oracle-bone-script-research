...
- External category reference: `evobc-cat-04917`
- Source category ID: `04917`
- Source label for human review: `潶`
- Source codepoints: `U+6F76`
...
- `obs-evo-cand-004917-route-category-staging`
...
- `obs-evo-cand-004917-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004917-route-evolution-graph`
