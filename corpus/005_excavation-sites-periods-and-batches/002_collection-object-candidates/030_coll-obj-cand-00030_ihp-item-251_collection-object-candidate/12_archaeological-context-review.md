# Archaeological Context Review / 考古语境复核: coll-obj-cand-00030
...
| Source item | `251` | `01_collection-object-packet.json` |
| Catalog description | `Ping 0469` | `01_collection-object-packet.json` |
