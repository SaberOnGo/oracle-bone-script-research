...
Project ID: `obs-evo-cand-001382`
...
- Project ID: `obs-evo-cand-001382`
- EVOBC category candidate ID: `evobc-evo-cat-01382`
- External category reference: `evobc-cat-01382`
- Source category ID: `01382`
- Source label for human review: `卜`
- Source codepoints: `U+535C`
- Image reference count in source metadata: `122`
...
- `obs-evo-cand-001382-route-category-staging`
...
- `obs-evo-cand-001382-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001382-route-evolution-graph`
