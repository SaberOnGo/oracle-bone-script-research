# Material Visual Observation / obs-comp-cand-000812 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000812`
- External reference / 外部参照: `obimd-sub-aetgi1oyaa`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013608_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/aetgi1oyaa/aetgi1oyaa/02w7v7qq0z.png`
- Checksum / 校验和:
  `6921a9a2baa1a382ec13c9f66f4a780c5892e7fa784931d257ccf0a9aa88140f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.39%.
- Marked-pixel bounds: (81,33)–(168,218); span 88 × 186 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.39%。
- 痕迹范围：(81,33)–(168,218)；跨度88 × 186 px；痕迹矩形高于宽。
