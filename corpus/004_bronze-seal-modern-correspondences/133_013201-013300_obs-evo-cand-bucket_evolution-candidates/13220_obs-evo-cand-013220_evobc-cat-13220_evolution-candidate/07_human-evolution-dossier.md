...
- External category reference: `evobc-cat-13220`
- Source category ID: `13220`
- Source label for human review: `𬆴`
- Source codepoints: `U+2C1B4`
...
- `obs-evo-cand-013220-route-category-staging`
...
- `obs-evo-cand-013220-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013220-route-evolution-graph`
