# obs-unk-004034 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004034`
- primary external id: `hust-obc-und-L-004034`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/034_obs-unk-004034_h
  ust-obc-und-L-004034_oracle-character-candidate/03_visual-assets/001_asset
  -005627_hust-obc-und-L-004034_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4034/L_？_8618.jpg`
- asset id: `asset-005627`
...
- source class: `HUST-OBC/undeciphered/L/4034/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4034/L_？_8618.jpg`
- asset id: `asset-005627`
...
- English observation: A narrow peaked outline sits above a broad rounded lower
  outline. Several vertical or curved traces appear inside the lower area. The
  small crop does not show the complete outer boundary.
- 中文观察：窄而尖顶的轮廓位于宽大的圆弧下部轮廓之上；下部内部可见数条直立或弯曲
    痕迹。图像较小，未显示完整外缘。
...
- Which source records identify obs-unk-004034 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004034？
