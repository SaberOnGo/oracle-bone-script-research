...
- `obs-evo-cand-002247-route-category-staging`
...
- `obs-evo-cand-002247-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002247-route-evolution-graph`
