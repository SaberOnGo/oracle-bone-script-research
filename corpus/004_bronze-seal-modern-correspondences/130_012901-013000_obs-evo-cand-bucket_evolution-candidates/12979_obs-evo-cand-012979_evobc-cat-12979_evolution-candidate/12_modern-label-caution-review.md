# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012979
...
- EVOBC candidate category: `evobc-evo-cat-12979`.
- Source label for search only: `𫚽`.
- Source codepoints for search only: `U+2B6BD`.
