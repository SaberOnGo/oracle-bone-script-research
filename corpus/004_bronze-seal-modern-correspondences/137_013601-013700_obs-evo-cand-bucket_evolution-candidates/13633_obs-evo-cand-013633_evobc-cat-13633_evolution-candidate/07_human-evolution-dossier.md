...
- External category reference: `evobc-cat-13633`
- Source category ID: `13633`
- Source label for human review: `𮓷`
...
- `obs-evo-cand-013633-route-category-staging`
...
- `obs-evo-cand-013633-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013633-route-evolution-graph`
