...
- External category reference: `evobc-cat-08783`
- Source category ID: `08783`
- Source label for human review: `躡`
...
- `obs-evo-cand-008783-route-category-staging`
...
- `obs-evo-cand-008783-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008783-route-evolution-graph`
