...
- External category reference: `evobc-cat-06882`
- Source category ID: `06882`
- Source label for human review: `翔`
...
- `obs-evo-cand-006882-route-category-staging`
...
- `obs-evo-cand-006882-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006882-route-evolution-graph`
