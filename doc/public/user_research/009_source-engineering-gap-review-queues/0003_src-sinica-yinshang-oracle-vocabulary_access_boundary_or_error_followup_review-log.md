...
- Review log draft ID / 复核日志草稿 ID: `source-engineering-gap-review-log-draft-0003`
...
`current_stage=pending_human_review;download_status_counts=download_error:1;downloaded_count=0;download_log_count=1;checksum_present_count=0;field_map_count=2;package_manifest_count=0;metadata_profile_count=2;graph_edge_count=0;downloaded_file_bytes=0;gap_type=access_boundary_or_error_followup`
...
- Evidence snapshot ID / 证据快照 ID: `source-engineering-gap-evidence-snapshot-0003`
