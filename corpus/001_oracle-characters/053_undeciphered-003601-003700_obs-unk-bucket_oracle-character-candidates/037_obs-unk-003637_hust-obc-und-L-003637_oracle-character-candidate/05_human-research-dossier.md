# obs-unk-003637 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003637`
- primary external id: `hust-obc-und-L-003637`
...
- local review image route: `corpus/001_oracle-characters/053_undeciphered-003
  601-003700_obs-unk-bucket_oracle-character-candidates/037_obs-unk-003637_h
  ust-obc-und-L-003637_oracle-character-candidate/03_visual-assets/001_asset
  -005230_hust-obc-und-L-003637_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3637/L_？_7424.jpg`
- asset id: `asset-005230`
...
- source class: `HUST-OBC/undeciphered/L/3637/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3637/L_？_7424.jpg`
- asset id: `asset-005230`
...
- Which source records identify obs-unk-003637 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003637？
