# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006699
...
- EVOBC candidate category: `evobc-evo-cat-06699`.
- Source label for search only: `繼`.
- Source codepoints for search only: `U+7E7C`.
