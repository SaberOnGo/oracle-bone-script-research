...
- External category reference: `evobc-cat-00332`
- Source category ID: `00332`
- Source label for human review: `䋿`
...
- `obs-evo-cand-000332-route-category-staging`
...
- `obs-evo-cand-000332-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000332-route-evolution-graph`
