...
- External category reference: `evobc-cat-04421`
- Source category ID: `04421`
- Source label for human review: `殫`
- Source codepoints: `U+6BAB`
...
- `obs-evo-cand-004421-route-category-staging`
...
- `obs-evo-cand-004421-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004421-route-evolution-graph`
