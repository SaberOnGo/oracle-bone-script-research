...
- Project ID: `obs-evo-cand-006497`
- EVOBC category candidate ID: `evobc-evo-cat-06497`
- External category reference: `evobc-cat-06497`
- Source category ID: `06497`
- Source label for human review: `絏`
- Source codepoints: `U+7D4F`
...
- `obs-evo-cand-006497-route-category-staging`
...
- `obs-evo-cand-006497-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006497-route-evolution-graph`
