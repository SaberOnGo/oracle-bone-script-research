...
- External category reference: `evobc-cat-00330`
- Source category ID: `00330`
- Source label for human review: `䋼`
- Source codepoints: `U+42FC`
...
- `obs-evo-cand-000330-route-category-staging`
...
- `obs-evo-cand-000330-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000330-route-evolution-graph`
