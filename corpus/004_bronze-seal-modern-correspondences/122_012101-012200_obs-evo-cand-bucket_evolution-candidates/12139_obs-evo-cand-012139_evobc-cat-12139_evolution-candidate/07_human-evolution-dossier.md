...
- External category reference: `evobc-cat-12139`
- Source category ID: `12139`
- Source label for human review: `𧆣`
- Source codepoints: `U+271A3`
...
- `obs-evo-cand-012139-route-category-staging`
...
- `obs-evo-cand-012139-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012139-route-evolution-graph`
