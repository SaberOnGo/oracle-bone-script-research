...
- External category reference: `evobc-cat-03356`
- Source category ID: `03356`
- Source label for human review: `挹`
...
- `obs-evo-cand-003356-route-category-staging`
...
- `obs-evo-cand-003356-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003356-route-evolution-graph`
