...
- External category reference: `evobc-cat-02234`
- Source category ID: `02234`
- Source label for human review: `媞`
- Source codepoints: `U+5A9E`
...
- `obs-evo-cand-002234-route-category-staging`
...
- `obs-evo-cand-002234-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002234-route-evolution-graph`
