# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010630
...
- EVOBC candidate category: `evobc-evo-cat-10630`.
- Source label for search only: `麻`.
- Source codepoints for search only: `U+9EBB`.
