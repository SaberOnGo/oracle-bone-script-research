...
- External category reference: `evobc-cat-01662`
- Source category ID: `01662`
- Source label for human review: `喿`
- Source codepoints: `U+55BF`
- Image reference count in source metadata: `24`
...
- `obs-evo-cand-001662-route-category-staging`
...
- `obs-evo-cand-001662-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001662-route-evolution-graph`
