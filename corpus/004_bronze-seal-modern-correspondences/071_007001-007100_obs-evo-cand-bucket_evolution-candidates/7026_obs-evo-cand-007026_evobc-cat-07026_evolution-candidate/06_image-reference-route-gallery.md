...
- `obs-evo-cand-007026-route-category-staging`
...
- `obs-evo-cand-007026-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007026-route-evolution-graph`
