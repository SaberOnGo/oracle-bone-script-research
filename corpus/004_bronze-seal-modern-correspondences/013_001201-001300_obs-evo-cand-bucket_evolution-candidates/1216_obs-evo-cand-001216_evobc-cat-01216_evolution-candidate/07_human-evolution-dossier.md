...
- External category reference: `evobc-cat-01216`
- Source category ID: `01216`
- Source label for human review: `則`
- Source codepoints: `U+5247`
- Image reference count in source metadata: `348`
...
- era `4`
  token: `WSC`
  image references: 264
- era `5`
  token: `CS`
  image references: 2
- source `1`
  token: `Web:105952;說文Web:58`
  image references: 272
- source `2`
  token: `Book:17600`
  image references: 2
- source `3`
...
- `obs-evo-cand-001216-route-category-staging`
...
- `obs-evo-cand-001216-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001216-route-evolution-graph`
