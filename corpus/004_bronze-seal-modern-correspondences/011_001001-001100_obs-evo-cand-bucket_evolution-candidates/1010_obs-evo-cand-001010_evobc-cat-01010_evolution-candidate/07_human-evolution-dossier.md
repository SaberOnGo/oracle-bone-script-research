...
Project ID: `obs-evo-cand-001010`
...
- Project ID: `obs-evo-cand-001010`
- EVOBC category candidate ID: `evobc-evo-cat-01010`
- External category reference: `evobc-cat-01010`
- Source category ID: `01010`
- Source label for human review: `像`
- Source codepoints: `U+50CF`
...
- `obs-evo-cand-001010-route-category-staging`
...
- `obs-evo-cand-001010-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001010-route-evolution-graph`
