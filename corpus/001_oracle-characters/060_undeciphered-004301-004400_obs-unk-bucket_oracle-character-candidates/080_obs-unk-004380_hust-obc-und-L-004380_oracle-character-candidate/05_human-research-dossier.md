# obs-unk-004380 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004380`
- primary external id: `hust-obc-und-L-004380`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/080_obs-unk-004380_h
  ust-obc-und-L-004380_oracle-character-candidate/03_visual-assets/001_asset
  -005973_hust-obc-und-L-004380_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4380/L_？_9731.jpg`
- asset id: `asset-005973`
...
- source class: `HUST-OBC/undeciphered/L/4380/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4380/L_？_9731.jpg`
- asset id: `asset-005973`
...
- English observation: `A rounded lower-left mass and short projections`
  `are visible; a long curved trace rises on the right.`
- 中文观察: `左下有较圆痕迹群和短伸出痕迹，右侧有向上弯曲的长痕。`
...
- Which source records identify obs-unk-004380 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004380？
