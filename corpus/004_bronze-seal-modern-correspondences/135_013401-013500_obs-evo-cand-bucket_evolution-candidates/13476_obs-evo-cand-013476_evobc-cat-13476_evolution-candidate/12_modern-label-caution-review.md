# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013476
...
- EVOBC candidate category: `evobc-evo-cat-13476`.
- Source label for search only: `𭄝`.
- Source codepoints for search only: `U+2D11D`.
