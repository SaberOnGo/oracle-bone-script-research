# obs-unk-004131 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004131`
- primary external id: `hust-obc-und-L-004131`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/031_obs-unk-004131_h
  ust-obc-und-L-004131_oracle-character-candidate/03_visual-assets/001_asset
  -005724_hust-obc-und-L-004131_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4131/L_？_8900.jpg`
- asset id: `asset-005724`
...
- source class: `HUST-OBC/undeciphered/L/4131/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4131/L_？_8900.jpg`
- asset id: `asset-005724`
...
- English observation: Two upright trace groups stand side by side;
  the right group has short diagonal marks.
- 中文观察：两组竖向痕迹并列；右侧一组带短斜向笔痕。
...
- Which source records identify obs-unk-004131 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004131？
