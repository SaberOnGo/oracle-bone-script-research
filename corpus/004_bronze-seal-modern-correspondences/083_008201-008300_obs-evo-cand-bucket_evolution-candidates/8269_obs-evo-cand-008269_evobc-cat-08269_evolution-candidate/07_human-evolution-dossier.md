...
- External category reference: `evobc-cat-08269`
- Source category ID: `08269`
- Source label: `諒`
...
- `obs-evo-cand-008269-route-category-staging`
...
- `obs-evo-cand-008269-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008269-route-evolution-graph`
