# Material Visual Observation / obs-comp-cand-000248 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000248`
- External reference / 外部参照: `obimd-sub-hl0ffm8toi`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011894_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hl0ffm8toi/hl0ffm8toi/hl0ffm8toi.png`
- Checksum / 校验和:
  `8406289197d05361672ad99632dac62c9834ec30aaab689c8e06262ed0c9b622`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.91%.
- Marked-pixel bounds: (61,40)–(188,210); span 128 × 171 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.91%。
- 痕迹范围：(61,40)–(188,210)；跨度128 × 171 px；痕迹矩形高于宽。
