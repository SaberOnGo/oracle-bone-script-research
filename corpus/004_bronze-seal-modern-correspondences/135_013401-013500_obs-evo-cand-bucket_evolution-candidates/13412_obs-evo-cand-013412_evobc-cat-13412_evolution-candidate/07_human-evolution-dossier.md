...
- Project ID: `obs-evo-cand-013412`
- EVOBC category candidate ID: `evobc-evo-cat-13412`
- External category reference: `evobc-cat-13412`
- Source category ID: `13412`
- Source label for human review: `𬮏`
- Source codepoints: `U+2CB8F`
...
- `obs-evo-cand-013412-route-category-staging`
...
- `obs-evo-cand-013412-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013412-route-evolution-graph`
