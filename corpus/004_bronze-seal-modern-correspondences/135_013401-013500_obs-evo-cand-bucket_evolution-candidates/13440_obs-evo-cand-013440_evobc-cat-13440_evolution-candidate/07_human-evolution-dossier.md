...
- Project ID: `obs-evo-cand-013440`
- EVOBC category candidate ID: `evobc-evo-cat-13440`
- External category reference: `evobc-cat-13440`
- Source category ID: `13440`
- Source label for human review: `𬴘`
- Source codepoints: `U+2CD18`
- Image reference count in source metadata: `13`
...
- `obs-evo-cand-013440-route-category-staging`
...
- `obs-evo-cand-013440-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013440-route-evolution-graph`
