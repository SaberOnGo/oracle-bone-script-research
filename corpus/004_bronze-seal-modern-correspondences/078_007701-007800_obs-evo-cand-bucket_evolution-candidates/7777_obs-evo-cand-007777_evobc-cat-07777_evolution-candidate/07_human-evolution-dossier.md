...
- External category reference: `evobc-cat-07777`
- Source category ID: `07777`
- Source label for human review: `蜓`
- Source codepoints: `U+8713`
...
- `obs-evo-cand-007777-route-category-staging`
...
- `obs-evo-cand-007777-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007777-route-evolution-graph`
