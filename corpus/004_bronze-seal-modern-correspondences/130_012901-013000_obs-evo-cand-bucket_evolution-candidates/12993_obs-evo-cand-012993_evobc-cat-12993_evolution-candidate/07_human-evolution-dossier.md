...
- External category reference: `evobc-cat-12993`
- Source category ID: `12993`
- Source label for human review: `𫡜`
...
- `obs-evo-cand-012993-route-category-staging`
...
- `obs-evo-cand-012993-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012993-route-evolution-graph`
