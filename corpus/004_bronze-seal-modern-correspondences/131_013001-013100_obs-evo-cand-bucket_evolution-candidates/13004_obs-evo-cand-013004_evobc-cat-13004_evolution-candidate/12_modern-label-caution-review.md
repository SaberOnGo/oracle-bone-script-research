# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013004
...
- EVOBC candidate category: `evobc-evo-cat-13004`.
- Source label for search only: `𫣑`.
- Source codepoints for search only: `U+2B8D1`.
