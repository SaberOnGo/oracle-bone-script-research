# obs-unk-004013 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004013`
- primary external id: `hust-obc-und-L-004013`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/013_obs-unk-004013_h
  ust-obc-und-L-004013_oracle-character-candidate/03_visual-assets/001_asset
  -005606_hust-obc-und-L-004013_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4013/L_？_8539.jpg`
- asset id: `asset-005606`
...
- source class: `HUST-OBC/undeciphered/L/4013/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4013/L_？_8539.jpg`
- asset id: `asset-005606`
...
- English observation: A compact enclosed outline appears near the
  center. Two long descending curved traces flank the lower area, and a small
  dark or crossing mark is visible inside the upper outline.
- 中文观察：上部中央可见紧凑的封闭轮廓；下方两条较长的弧形痕迹向下延伸，左右分列；上部轮廓内部可见小型
  暗部或交叉痕迹。
...
- Which source records identify obs-unk-004013 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004013？
