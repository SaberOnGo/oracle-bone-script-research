...
- External category reference: `evobc-cat-04140`
- Source category ID: `04140`
- Source label for human review: `楄`
- Source codepoints: `U+6944`
...
- `obs-evo-cand-004140-route-category-staging`
...
- `obs-evo-cand-004140-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004140-route-evolution-graph`
