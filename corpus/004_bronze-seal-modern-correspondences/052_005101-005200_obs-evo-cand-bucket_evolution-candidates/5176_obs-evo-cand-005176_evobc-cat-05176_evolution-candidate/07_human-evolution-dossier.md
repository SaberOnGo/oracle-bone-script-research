...
- Project ID: `obs-evo-cand-005176`
- EVOBC category candidate ID: `evobc-evo-cat-05176`
- External category reference: `evobc-cat-05176`
- Source category ID: `05176`
- Source label for human review: `爤`
- Source codepoints: `U+7224`
...
- `obs-evo-cand-005176-route-category-staging`
...
- `obs-evo-cand-005176-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005176-route-evolution-graph`
