...
- External category reference: `evobc-cat-01233`
- Source category ID: `01233`
- Source label for human review: `剢`
- Source codepoints: `U+5262`
...
- `obs-evo-cand-001233-route-category-staging`
...
- `obs-evo-cand-001233-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001233-route-evolution-graph`
