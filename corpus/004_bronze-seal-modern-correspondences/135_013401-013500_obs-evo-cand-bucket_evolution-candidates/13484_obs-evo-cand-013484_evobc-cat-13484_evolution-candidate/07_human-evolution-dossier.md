...
Project ID: `obs-evo-cand-013484`
...
- Project ID: `obs-evo-cand-013484`
- EVOBC category candidate ID: `evobc-evo-cat-13484`
- External category reference: `evobc-cat-13484`
- Source category ID: `13484`
- Source label for human review: `𭅞`
- Source codepoints: `U+2D15E`
...
- `obs-evo-cand-013484-route-category-staging`
...
- `obs-evo-cand-013484-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013484-route-evolution-graph`
