# Material Visual Observation / obs-comp-cand-002303 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002303`
- External reference / 外部参照: `obimd-sub-z7utqlcs8m`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020322_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/z7utqlcs8m/z7utqlcs8m/z7utqlcs8m.png`
- Checksum / 校验和:
  `4f264791c8010f807b026a7ddea8029ca692e68277a658a08c7c2cc52435436f`
...
- Marked-pixel bounds: (70,47)–(178,199); span 109 × 153 px; the marked
...
- 痕迹范围：(70,47)–(178,199)；跨度109 × 153 px；痕迹矩形高于宽。
