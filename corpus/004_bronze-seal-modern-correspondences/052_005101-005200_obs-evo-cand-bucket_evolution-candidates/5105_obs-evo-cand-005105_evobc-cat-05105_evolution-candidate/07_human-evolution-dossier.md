...
- External category reference: `evobc-cat-05105`
- Source category ID: `05105`
- Source label: `煏`
...
- `obs-evo-cand-005105-route-category-staging`
...
- `obs-evo-cand-005105-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005105-route-evolution-graph`
