# Material Visual Observation / obs-comp-cand-002621 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002621`
- External reference / 外部参照: `obimd-sub-zqamwvhq33`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021160_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zqamwvhq33/zqamwvhq33/zqamwvhq33.png`
- Checksum / 校验和:
  `3a80e25604eb18bc64df93699baef095ded670030a54548bb9aad8aeaec2f49e`
...
- Marked-pixel bounds: (82,12)–(161,235); span 80 × 224 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.20%。
- 痕迹范围：(82,12)–(161,235)；跨度80 × 224 px；痕迹矩形高于宽。
