# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000153
...
- EVOBC candidate category: `evobc-evo-cat-00153`.
- Source label for search only: `㪿`.
- Source codepoints for search only: `U+3ABF`.
