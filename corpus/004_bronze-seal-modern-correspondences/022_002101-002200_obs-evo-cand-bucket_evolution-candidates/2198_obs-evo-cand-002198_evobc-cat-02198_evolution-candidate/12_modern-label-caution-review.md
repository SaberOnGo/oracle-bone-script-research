# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002198
...
- EVOBC candidate category: `evobc-evo-cat-02198`.
- Source label for search only: `婗`.
- Source codepoints for search only: `U+5A57`.
