# obs-char-000150 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/150_obs-char-000150_hust-obc-cat-0166_orac
  le-character/03_visual-assets/001_asset-000155_hust-obc-cat-0166_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0166/G_0166_存721合765賓組.png`
- asset id: `asset-000155`
...
- source category: `0166`
- validation class: `149`
- source image route: `HUST-OBC/deciphered/0166/G_0166_存721合765賓組.png`
- asset id: `asset-000155`
...
- English observation: `The image has two curved upper side strokes around a
  small rectangular middle enclosure, with a central vertical stroke below
  it.`
- 中文观察: `图像上方两侧有弯曲笔围绕小型长方形中部围合，下方接一条中央竖笔。`
...
- dataset label text: `㒜`
- dataset label codepoints: `U+349C`
...
- filename catalog route clues: `Heji-like filename clue: 合765
  (G_0166_存721合765賓組.png)`
...
- Which source records identify obs-char-000150 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000150？
