...
Project ID: `obs-evo-cand-011292`
...
- Project ID: `obs-evo-cand-011292`
- EVOBC category candidate ID: `evobc-evo-cat-11292`
- External category reference: `evobc-cat-11292`
- Source category ID: `11292`
- Source label for human review: `𢨂`
- Source codepoints: `U+22A02`
...
- `obs-evo-cand-011292-route-category-staging`
...
- `obs-evo-cand-011292-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011292-route-evolution-graph`
