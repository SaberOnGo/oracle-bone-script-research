# obs-unk-004431 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004431`
- primary external id: `hust-obc-und-L-004431`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/031_obs-unk-004431_h
  ust-obc-und-L-004431_oracle-character-candidate/03_visual-assets/001_asset
  -006024_hust-obc-und-L-004431_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4431/L_？_9930.jpg`
- asset id: `asset-006024`
...
- source class: `HUST-OBC/undeciphered/L/4431/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4431/L_？_9930.jpg`
- asset id: `asset-006024`
...
- English observation: `A long central stem crosses a darker lower`
  `curve and right trace.`
- 中文观察: `长中央竖痕穿过较深的下部弧线和右侧痕迹。`
...
- Which source records identify obs-unk-004431 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004431？
