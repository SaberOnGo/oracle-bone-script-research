...
- `obs-evo-cand-006918-route-category-staging`
...
- `obs-evo-cand-006918-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006918-route-evolution-graph`
