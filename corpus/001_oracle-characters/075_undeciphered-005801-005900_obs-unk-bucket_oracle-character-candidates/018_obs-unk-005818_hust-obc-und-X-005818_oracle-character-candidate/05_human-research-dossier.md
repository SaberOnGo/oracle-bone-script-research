# obs-unk-005818 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/075_undeciphered-005
  801-005900_obs-unk-bucket_oracle-character-candidates/018_obs-unk-005818_h
  ust-obc-und-X-005818_oracle-character-candidate/03_visual-assets/001_asset
  -007410_hust-obc-und-X-005818_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1374/X_？_1841_1.png`
- asset id: `asset-007410`
...
- source class: `HUST-OBC/undeciphered/X/1374/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1374/X_？_1841_1.png`
- asset id: `asset-007410`
...
- Which source records identify obs-unk-005818 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005818？
