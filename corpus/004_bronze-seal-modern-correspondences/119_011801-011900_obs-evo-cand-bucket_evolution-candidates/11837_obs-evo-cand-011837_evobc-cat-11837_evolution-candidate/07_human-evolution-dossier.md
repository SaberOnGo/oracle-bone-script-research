...
Project ID: `obs-evo-cand-011837`
...
- Project ID: `obs-evo-cand-011837`
- EVOBC category candidate ID: `evobc-evo-cat-11837`
- External category reference: `evobc-cat-11837`
- Source category ID: `11837`
- Source label for human review: `𥞐`
- Source codepoints: `U+25790`
...
- `obs-evo-cand-011837-route-category-staging`
...
- `obs-evo-cand-011837-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011837-route-evolution-graph`
