...
- External category reference: `evobc-cat-05641`
- Source category ID: `05641`
...
- `obs-evo-cand-005641-route-category-staging`
...
- `obs-evo-cand-005641-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005641-route-evolution-graph`
