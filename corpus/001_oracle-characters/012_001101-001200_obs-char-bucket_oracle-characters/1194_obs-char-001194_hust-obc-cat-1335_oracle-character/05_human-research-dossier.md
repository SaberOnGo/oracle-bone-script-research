# obs-char-001194 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1194_obs-char-001194_hust-obc-cat-1335_ora
  cle-character/03_visual-assets/001_asset-001199_hust-obc-cat-1335_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1335/G_1335_京都2894合33201𠂤歷間.png
  `
- asset id: `asset-001199`
...
- source category: `1335`
- validation class: `1193`
- source image route: `HUST-OBC/deciphered/1335/G_1335_京都2894合33201𠂤歷間.png`
- asset id: `asset-001199`
...
- English observation: `Two adjacent dense clusters have repeated angular
  branches and several pointed lower projections.`
- 中文观察: `两个相邻的密集笔群有重复折角分枝和数个尖状下部外伸笔。`
...
- dataset label text: `㤭`
- dataset label codepoints: `U+392D`
...
- filename catalog route clues: `Heji-like filename clue: 合33201
  (G_1335_京都2894合33201𠂤歷間.png)`
...
- Which source records identify obs-char-001194 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001194？
