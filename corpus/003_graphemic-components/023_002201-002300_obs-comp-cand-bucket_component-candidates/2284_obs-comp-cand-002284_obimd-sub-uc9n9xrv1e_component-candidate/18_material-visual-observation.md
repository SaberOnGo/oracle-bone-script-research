# Material Visual Observation / obs-comp-cand-002284 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002284`
- External reference / 外部参照: `obimd-sub-uc9n9xrv1e`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020168_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/uc9n9xrv1e/uc9n9xrv1e/uc9n9xrv1e.png`
- Checksum / 校验和:
  `489164eb2724ccdb65d69c8b5159e9656b30f44acb4b527d22479b48500646dd`
...
- Marked-pixel bounds: (69,22)–(177,229); span 109 × 208 px; the marked
...
- 痕迹范围：(69,22)–(177,229)；跨度109 × 208 px；痕迹矩形高于宽。
