...
- External category reference: `evobc-cat-03840`
- Source category ID: `03840`
- Source label for human review: `朙`
...
- `obs-evo-cand-003840-route-category-staging`
...
- `obs-evo-cand-003840-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003840-route-evolution-graph`
