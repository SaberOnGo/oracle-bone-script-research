...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000183` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y1116` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `143` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `636` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `40359` [route_present_image_or_text_not_collected]
