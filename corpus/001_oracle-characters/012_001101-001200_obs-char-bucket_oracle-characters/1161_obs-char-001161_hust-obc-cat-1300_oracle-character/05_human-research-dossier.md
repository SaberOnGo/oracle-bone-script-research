# obs-char-001161 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1161_obs-char-001161_hust-obc-cat-1300_ora
  cle-character/03_visual-assets/001_asset-001166_hust-obc-cat-1300_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1300/G_1300_甲骨文.png`
- asset id: `asset-001166`
...
- source category: `1300`
- validation class: `1160`
- source image route: `HUST-OBC/deciphered/1300/G_1300_甲骨文.png`
- asset id: `asset-001166`
...
- English observation: `A tall branching form has a curved left outer
  contour, a central upright, and a small angular side mark.`
- 中文观察: `高而分枝的形体有左侧弯曲外轮廓、中央直立笔和小型侧部折角痕迹。`
...
- dataset label text: `㤊`
- dataset label codepoints: `U+390A`
...
- Which source records identify obs-char-001161 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001161？
