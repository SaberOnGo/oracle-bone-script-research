...
Project ID: `obs-evo-cand-001887`
...
- Project ID: `obs-evo-cand-001887`
- EVOBC category candidate ID: `evobc-evo-cat-01887`
- External category reference: `evobc-cat-01887`
- Source category ID: `01887`
- Source label for human review: `埸`
- Source codepoints: `U+57F8`
...
- `obs-evo-cand-001887-route-category-staging`
...
- `obs-evo-cand-001887-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001887-route-evolution-graph`
