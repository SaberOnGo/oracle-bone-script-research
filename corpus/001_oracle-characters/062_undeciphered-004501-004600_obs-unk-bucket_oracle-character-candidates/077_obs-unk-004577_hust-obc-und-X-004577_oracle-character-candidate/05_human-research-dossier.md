# obs-unk-004577 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004577`
- primary external id: `hust-obc-und-X-004577`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/077_obs-unk-004577_h
  ust-obc-und-X-004577_oracle-character-candidate/03_visual-assets/001_asset
  -006170_hust-obc-und-X-004577_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/133/X_？_8312_1.png`
- asset id: `asset-006170`
...
- source class: `HUST-OBC/undeciphered/X/133/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/133/X_？_8312_1.png`
- asset id: `asset-006170`
...
- English observation: `Upper outline, central stroke, oval opening, and tip`
  `recorded.`
- 中文观察: `已记录上部轮廓、中央痕迹、椭圆开口和尖端。`
...
- Which source records identify obs-unk-004577 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004577？
