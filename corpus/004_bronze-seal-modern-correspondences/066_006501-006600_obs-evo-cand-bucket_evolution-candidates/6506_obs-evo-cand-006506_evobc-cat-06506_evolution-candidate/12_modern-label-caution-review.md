# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006506
...
- Project ID: `obs-evo-cand-006506`.
- EVOBC candidate category: `evobc-evo-cat-06506`.
- Source label for search only: `絛`.
- Source codepoints for search only: `U+7D5B`.
