# obs-comp-cand-001783 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001783`
- 首选外部 ID: `obimd-sub-upw1kn3nga`
- OBIMD subcharacter UID: `upw1kn3nga`
- OBIMD main character UID: `upw1kn3nga`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `9`
- codepoint 示例: U+A6D6E;U+FA3FE; U+FA3FF; 另有 7 项
