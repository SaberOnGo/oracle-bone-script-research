# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006785
...
- EVOBC candidate category: `evobc-evo-cat-06785`.
- Source label for search only: `缼`.
- Source codepoints for search only: `U+7F3C`.
