...
- External category reference: `evobc-cat-01412`
- Source category ID: `01412`
- Source label: `厄`
...
- `obs-evo-cand-001412-route-category-staging`
...
- `obs-evo-cand-001412-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001412-route-evolution-graph`
