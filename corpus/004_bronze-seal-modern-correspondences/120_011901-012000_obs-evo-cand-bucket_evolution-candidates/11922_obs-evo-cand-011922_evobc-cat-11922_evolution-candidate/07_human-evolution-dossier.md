...
- Project ID: `obs-evo-cand-011922`
- EVOBC category candidate ID: `evobc-evo-cat-11922`
- External category reference: `evobc-cat-11922`
- Source category ID: `11922`
- Source label for human review: `𥻝`
- Source codepoints: `U+25EDD`
...
- `obs-evo-cand-011922-route-category-staging`
...
- `obs-evo-cand-011922-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011922-route-evolution-graph`
