...
Project ID: `obs-evo-cand-004203`
...
- Project ID: `obs-evo-cand-004203`
- EVOBC category candidate ID: `evobc-evo-cat-04203`
- External category reference: `evobc-cat-04203`
- Source category ID: `04203`
- Source label for human review: `槈`
- Source codepoints: `U+69C8`
...
- `obs-evo-cand-004203-route-category-staging`
...
- `obs-evo-cand-004203-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004203-route-evolution-graph`
