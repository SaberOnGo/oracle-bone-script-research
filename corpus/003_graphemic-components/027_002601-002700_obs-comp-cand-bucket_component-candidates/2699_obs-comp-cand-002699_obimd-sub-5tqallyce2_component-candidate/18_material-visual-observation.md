# Material Visual Observation / obs-comp-cand-002699 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002699`
- External reference / 外部参照: `obimd-sub-5tqallyce2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021275_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5tqallyce2/5tqallyce2/5tqallyce2.png`
- Checksum / 校验和:
  `26a6faa20d4be5732eb92250838e636c5fcb31d369cc0fe9843a7772368998c5`
...
- Marked-pixel bounds: (97,20)–(155,231); span 59 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.43%。
- 痕迹范围：(97,20)–(155,231)；跨度59 × 212 px；痕迹矩形高于宽。
