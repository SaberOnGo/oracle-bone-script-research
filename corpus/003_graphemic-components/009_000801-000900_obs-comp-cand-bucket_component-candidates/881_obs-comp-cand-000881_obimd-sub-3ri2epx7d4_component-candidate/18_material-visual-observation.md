# Material Visual Observation / obs-comp-cand-000881 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000881`
- External reference / 外部参照: `obimd-sub-3ri2epx7d4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013953_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/o6m37o3l7o/3ri2epx7d4/3ri2epx7d4.png`
- Checksum / 校验和:
  `c5ce1f8beca0e56a8fbfb0080d0ab23acbacb898d20ff91ac26478cdf3741781`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.14%.
- Marked-pixel bounds: (51,35)–(194,212); span 144 × 178 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.14%。
- 痕迹范围：(51,35)–(194,212)；跨度144 × 178 px；痕迹矩形高于宽。
