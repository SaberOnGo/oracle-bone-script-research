# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000114
...
| --- | --- | --- | --- |
| `obimd-glyph-link-001702` | 󰫉 | `U+F0AC9` | `reviewed_metadata_only` |
| `obimd-glyph-link-001703` | 󰫊 | `U+F0ACA` | `reviewed_metadata_only` |
