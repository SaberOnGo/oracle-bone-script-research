...
- `obs-evo-cand-006479-route-category-staging`
...
- `obs-evo-cand-006479-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006479-route-evolution-graph`
