# obs-unk-004028 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004028`
- primary external id: `hust-obc-und-L-004028`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/028_obs-unk-004028_h
  ust-obc-und-L-004028_oracle-character-candidate/03_visual-assets/001_asset
  -005621_hust-obc-und-L-004028_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4028/L_？_8600.jpg`
- asset id: `asset-005621`
...
- source class: `HUST-OBC/undeciphered/L/4028/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4028/L_？_8600.jpg`
- asset id: `asset-005621`
...
- English observation: A dark branched trace occupies the upper center. Below
  it are several separated rounded or wavy horizontal traces, with a narrow
  vertical connection between the upper and lower areas. The crop is small.
- 中文观察：上部中央有深色分叉痕迹；下方有数条分离的圆弧或波曲横向痕迹，上下区域
    之间可见窄直连接痕。图像较小。
...
- Which source records identify obs-unk-004028 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004028？
