...
Project ID: `obs-insc-cw-cand-000132`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000132`
...
- Yingguo / 英国所藏: `y711` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `163` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `558` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000132`
