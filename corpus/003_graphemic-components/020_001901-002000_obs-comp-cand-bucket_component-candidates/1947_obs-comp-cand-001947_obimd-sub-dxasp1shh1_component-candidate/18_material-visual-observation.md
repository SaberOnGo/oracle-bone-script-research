# Material Visual Observation / obs-comp-cand-001947 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001947`
- External reference / 外部参照: `obimd-sub-dxasp1shh1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018757_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dxasp1shh1/dxasp1shh1/dxasp1shh1.png`
- Checksum / 校验和:
  `c65120eb906a8a5acdfa783bd427f559ebb7803505d9003cbe8c24595590ba08`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.78%.
- Marked-pixel bounds: (63,14)–(198,232); span 136 × 219 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.78%。
- 痕迹范围：(63,14)–(198,232)；跨度136 × 219 px；痕迹矩形高于宽。
