...
- External category reference: `evobc-cat-06605`
- Source category ID: `06605`
- Source label for human review: `緩`
- Source codepoints: `U+7DE9`
...
- `obs-evo-cand-006605-route-category-staging`
...
- `obs-evo-cand-006605-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006605-route-evolution-graph`
