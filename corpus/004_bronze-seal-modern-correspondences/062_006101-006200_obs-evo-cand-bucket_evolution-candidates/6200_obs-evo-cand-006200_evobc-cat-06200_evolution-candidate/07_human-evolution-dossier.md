...
- External category reference: `evobc-cat-06200`
- Source category ID: `06200`
- Source label for human review: `竝`
...
- `obs-evo-cand-006200-route-category-staging`
...
- `obs-evo-cand-006200-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006200-route-evolution-graph`
