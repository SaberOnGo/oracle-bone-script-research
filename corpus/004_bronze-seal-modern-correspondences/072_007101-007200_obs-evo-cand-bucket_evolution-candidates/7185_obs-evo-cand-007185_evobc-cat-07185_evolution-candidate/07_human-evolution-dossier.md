...
- External category reference: `evobc-cat-07185`
- Source category ID: `07185`
- Source label for human review: `舅`
...
- `obs-evo-cand-007185-route-category-staging`
...
- `obs-evo-cand-007185-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007185-route-evolution-graph`
