...
- External category reference: `evobc-cat-06547`
- Source category ID: `06547`
- Source label for human review: `綟`
...
- `obs-evo-cand-006547-route-category-staging`
...
- `obs-evo-cand-006547-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006547-route-evolution-graph`
