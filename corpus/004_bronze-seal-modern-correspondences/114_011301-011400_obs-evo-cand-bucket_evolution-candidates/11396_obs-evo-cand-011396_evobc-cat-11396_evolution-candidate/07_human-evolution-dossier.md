...
- External category reference: `evobc-cat-11396`
- Source category ID: `11396`
- Source label: `𣅉`
...
- `obs-evo-cand-011396-route-category-staging`
...
- `obs-evo-cand-011396-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011396-route-evolution-graph`
