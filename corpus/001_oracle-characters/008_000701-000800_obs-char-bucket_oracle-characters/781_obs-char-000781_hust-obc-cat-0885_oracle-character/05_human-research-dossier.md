# obs-char-000781 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000781`
- primary external id: `hust-obc-cat-0885`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/781_obs-char-000781_hust-obc-cat-0885_orac
  le-character/03_visual-assets/001_asset-000786_hust-obc-cat-0885_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0885/G_0885_京津243(甲).png`
- asset id: `asset-000786`
...
- source category: `0885`
- validation class: `780`
- source image route: `HUST-OBC/deciphered/0885/G_0885_京津243(甲).png`
- asset id: `asset-000786`
...
- English observation: `A narrow central stem passes through pointed
  crossings above and below a long enclosed teardrop-shaped opening.`
- 中文观察: `狭长中央干穿过上下尖形交叉，中央围出一个长水滴形空隙。`
...
- dataset label text: `㝫`
- dataset label codepoints: `U+376B`
...
- Which source records identify obs-char-000781 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000781？
