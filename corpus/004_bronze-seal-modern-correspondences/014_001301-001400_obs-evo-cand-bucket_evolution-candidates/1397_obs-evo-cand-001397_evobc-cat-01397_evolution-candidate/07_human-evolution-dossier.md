...
- External category reference: `evobc-cat-01397`
- Source category ID: `01397`
- Source label for human review: `印`
...
- `obs-evo-cand-001397-route-category-staging`
...
- `obs-evo-cand-001397-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001397-route-evolution-graph`
