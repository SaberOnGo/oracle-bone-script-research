...
- External category reference: `evobc-cat-08180`
- Source category ID: `08180`
- Source label for human review: `詗`
...
- `obs-evo-cand-008180-route-category-staging`
...
- `obs-evo-cand-008180-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008180-route-evolution-graph`
