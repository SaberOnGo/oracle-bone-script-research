# Human Collection Object Dossier / 馆藏对象研究档案: coll-obj-cand-00001
...
- project_id: `coll-obj-cand-00001`
...
- live result: two JPEG routes opened privately; one route returned HTML.
- 现场结果：两条 JPEG 路由仅在本地私下打开；一条路由返回 HTML。
