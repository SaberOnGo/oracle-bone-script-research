...
- Project ID: `obs-evo-cand-000400`
- EVOBC category candidate ID: `evobc-evo-cat-00400`
- External category reference: `evobc-cat-00400`
- Source category ID: `00400`
- Source label for human review: `䖪`
- Source codepoints: `U+45AA`
...
- `obs-evo-cand-000400-route-category-staging`
...
- `obs-evo-cand-000400-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000400-route-evolution-graph`
