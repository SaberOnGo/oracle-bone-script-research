# obs-unk-000234 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/019_undeciphered-000
  201-000300_obs-unk-bucket_oracle-character-candidates/034_obs-unk-000234_h
  ust-obc-und-L-000234_oracle-character-candidate/03_visual-assets/001_asset
  -001827_hust-obc-und-L-000234_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/234/L_？_1072.jpg`
- asset id: `asset-001827`
...
- source class: `HUST-OBC/undeciphered/L/234/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/234/L_？_1072.jpg`
- asset id: `asset-001827`
...
- Which source records identify obs-unk-000234 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000234？
