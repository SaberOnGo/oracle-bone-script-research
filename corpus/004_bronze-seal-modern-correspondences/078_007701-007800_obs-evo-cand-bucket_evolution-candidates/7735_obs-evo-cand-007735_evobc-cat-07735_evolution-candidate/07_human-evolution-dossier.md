...
- External category reference: `evobc-cat-07735`
- Source category ID: `07735`
- Source label for human review: `蚤`
- Source codepoints: `U+86A4`
...
- `obs-evo-cand-007735-route-category-staging`
...
- `obs-evo-cand-007735-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007735-route-evolution-graph`
