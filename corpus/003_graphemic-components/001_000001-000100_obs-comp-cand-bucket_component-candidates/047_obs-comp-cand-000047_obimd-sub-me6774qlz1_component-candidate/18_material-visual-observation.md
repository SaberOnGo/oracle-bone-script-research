# Material Visual Observation / obs-comp-cand-000047 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000047`
- External reference / 外部参照: `obimd-sub-me6774qlz1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011413_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ptr3rfuph8/me6774qlz1/me6774qlz1.png`
- Checksum / 校验和:
  `fc78e2d6bfcab8617c17bff05fcc837a0436e47db20fd126d146586f0373776e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.18%.
- Marked-pixel bounds: (64,28)–(202,219); span 139 × 192 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.18%。
- 痕迹范围：(64,28)–(202,219)；跨度139 × 192 px；痕迹矩形高于宽。
