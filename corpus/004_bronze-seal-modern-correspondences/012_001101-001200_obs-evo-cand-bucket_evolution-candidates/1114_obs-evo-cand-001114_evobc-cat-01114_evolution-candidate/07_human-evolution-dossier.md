...
Project ID: `obs-evo-cand-001114`
...
- Project ID: `obs-evo-cand-001114`
- EVOBC category candidate ID: `evobc-evo-cat-01114`
- External category reference: `evobc-cat-01114`
- Source category ID: `01114`
- Source label for human review: `册`
- Source codepoints: `U+518C`
...
- `obs-evo-cand-001114-route-category-staging`
...
- `obs-evo-cand-001114-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001114-route-evolution-graph`
