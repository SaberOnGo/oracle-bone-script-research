# obs-unk-005104 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005104`
- primary external id: `hust-obc-und-X-005104`
...
- local review image route: `corpus/001_oracle-characters/068_undeciphered-005
  101-005200_obs-unk-bucket_oracle-character-candidates/004_obs-unk-005104_h
  ust-obc-und-X-005104_oracle-character-candidate/03_visual-assets/001_asset
  -006697_hust-obc-und-X-005104_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/660/X_？_7628_1.png`
- asset id: `asset-006697`
...
- source class: `HUST-OBC/undeciphered/X/660/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/660/X_？_7628_1.png`
- asset id: `asset-006697`
...
- Which source records identify obs-unk-005104 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005104？
