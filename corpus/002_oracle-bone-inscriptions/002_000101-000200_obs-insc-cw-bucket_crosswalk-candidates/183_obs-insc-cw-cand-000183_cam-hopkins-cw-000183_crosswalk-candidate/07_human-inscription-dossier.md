...
Project ID: `obs-insc-cw-cand-000183`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000183`
...
- Yingguo / 英国所藏: `y1116` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `143` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `636` in source row; primary catalog entry pending
- Heji / 合集: `40359` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000183`
