# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010525
...
- EVOBC candidate category: `evobc-evo-cat-10525`.
- Source label for search only: `鶌`.
- Source codepoints for search only: `U+9D8C`.
