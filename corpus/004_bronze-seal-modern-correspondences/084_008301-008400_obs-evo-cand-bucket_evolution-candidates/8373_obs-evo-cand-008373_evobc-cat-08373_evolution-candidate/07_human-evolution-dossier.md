...
- Project ID: `obs-evo-cand-008373`
- EVOBC category candidate ID: `evobc-evo-cat-08373`
- External category reference: `evobc-cat-08373`
- Source category ID: `08373`
- Source label for human review: `譱`
- Source codepoints: `U+8B71`
...
- `obs-evo-cand-008373-route-category-staging`
...
- `obs-evo-cand-008373-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008373-route-evolution-graph`
