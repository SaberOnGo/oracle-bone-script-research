...
- External category reference: `evobc-cat-07387`
- Source category ID: `07387`
- Source label for human review: `莥`
- Source codepoints: `U+83A5`
...
- `obs-evo-cand-007387-route-category-staging`
...
- `obs-evo-cand-007387-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007387-route-evolution-graph`
