...
- External category reference: `evobc-cat-02509`
- Source category ID: `02509`
- Source label for human review: `屖`
- Source codepoints: `U+5C56`
...
- `obs-evo-cand-002509-route-category-staging`
...
- `obs-evo-cand-002509-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002509-route-evolution-graph`
