# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013548
...
- EVOBC candidate category: `evobc-evo-cat-13548`.
- Source label for search only: `𭧏`.
- Source codepoints for search only: `U+2D9CF`.
