...
- Project ID: `obs-evo-cand-012293`
- EVOBC category candidate ID: `evobc-evo-cat-12293`
- External category reference: `evobc-cat-12293`
- Source category ID: `12293`
- Source label for human review: `𧹣`
- Source codepoints: `U+27E63`
...
- `obs-evo-cand-012293-route-category-staging`
...
- `obs-evo-cand-012293-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012293-route-evolution-graph`
