# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004355
...
- EVOBC candidate category: `evobc-evo-cat-04355`.
- Source label for search only: `欻`.
- Source codepoints for search only: `U+6B3B`.
