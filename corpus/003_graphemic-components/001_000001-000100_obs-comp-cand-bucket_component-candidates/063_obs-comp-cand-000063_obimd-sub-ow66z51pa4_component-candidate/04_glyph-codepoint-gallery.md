# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000063
...
| --- | --- | --- | --- |
| `obimd-glyph-link-001081` | 󰘬 | `U+F062C` | `reviewed_metadata_only` |
| `obimd-glyph-link-001082` | 󰘭 | `U+F062D` | `reviewed_metadata_only` |
