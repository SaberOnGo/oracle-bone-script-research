# Material Visual Observation / obs-comp-cand-000993 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000993`
- External reference / 外部参照: `obimd-sub-cl4srojc09`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014363_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cl4srojc09/cl4srojc09/cl4srojc09.png`
- Checksum / 校验和:
  `c011389ac0011fcd49e2821d93c98839f36e20431ebb49d14d1491b95473e8a9`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.92%.
- Marked-pixel bounds: (75,42)–(174,220); span 100 × 179 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.92%。
- 痕迹范围：(75,42)–(174,220)；跨度100 × 179 px；痕迹矩形高于宽。
