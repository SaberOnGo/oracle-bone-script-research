# obs-char-001443 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1443_obs-char-001443_hust-obc-cat-1617_ora
  cle-character/03_visual-assets/001_asset-001448_hust-obc-cat-1617_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1617/X_1617_4205_1.png`
- asset id: `asset-001448`
...
- source category: `1617`
- validation class: `1442`
- source image route: `HUST-OBC/deciphered/1617/X_1617_4205_1.png`
- asset id: `asset-001448`
...
- dataset label text: `㩇`
- dataset label codepoints: `U+3A47`
...
- Which source records identify obs-char-001443 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001443？
