# obs-unk-008402 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/101_undeciphered-008
  401-008500_obs-unk-bucket_oracle-character-candidates/002_obs-unk-008402_h
  ust-obc-und-YH-008402_oracle-character-candidate/03_visual-assets/001_asse
  t-009993_hust-obc-und-YH-008402_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60A90/H_？_60A90_0.png`
- asset id: `asset-009993`
...
- source class: `HUST-OBC/undeciphered/Y+H/60A90/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60A90/H_？_60A90_0.png`
- asset id: `asset-009993`
...
- Which source records identify obs-unk-008402 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008402？
