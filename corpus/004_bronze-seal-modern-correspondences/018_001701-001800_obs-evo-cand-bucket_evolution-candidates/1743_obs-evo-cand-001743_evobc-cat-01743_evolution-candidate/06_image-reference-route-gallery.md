...
- `obs-evo-cand-001743-route-category-staging`
...
- `obs-evo-cand-001743-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001743-route-evolution-graph`
