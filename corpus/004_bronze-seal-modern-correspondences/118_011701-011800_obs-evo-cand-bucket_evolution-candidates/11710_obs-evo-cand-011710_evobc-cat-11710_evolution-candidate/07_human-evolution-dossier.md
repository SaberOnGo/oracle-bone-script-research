...
Project ID: `obs-evo-cand-011710`
...
- Project ID: `obs-evo-cand-011710`
- EVOBC category candidate ID: `evobc-evo-cat-11710`
- External category reference: `evobc-cat-11710`
- Source category ID: `11710`
- Source label for human review: `𤸔`
- Source codepoints: `U+24E14`
...
- `obs-evo-cand-011710-route-category-staging`
...
- `obs-evo-cand-011710-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011710-route-evolution-graph`
