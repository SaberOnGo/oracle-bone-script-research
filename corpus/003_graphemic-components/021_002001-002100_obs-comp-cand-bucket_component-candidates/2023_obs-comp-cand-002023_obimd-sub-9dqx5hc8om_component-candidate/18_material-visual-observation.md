# Material Visual Observation / obs-comp-cand-002023 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002023`
- External reference / 外部参照: `obimd-sub-9dqx5hc8om`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019350_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9ypw4dceci/9dqx5hc8om/9dqx5hc8om.png`
- Checksum / 校验和:
  `f3e2195a7c38c753586de07fc7f5eaac33cbb7ff4c511e0aa17b249bd6836e6f`
...
- Marked-pixel bounds: (79,39)–(169,203); span 91 × 165 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.88%。
- 痕迹范围：(79,39)–(169,203)；跨度91 × 165 px；痕迹矩形高于宽。
