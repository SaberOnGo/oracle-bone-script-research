# Material Visual Observation / obs-comp-cand-000392 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000392`
- External reference / 外部参照: `obimd-sub-oe7t1db7i8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012315_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/oe7t1db7i8/oe7t1db7i8/oe7t1db7i8.png`
- Checksum / 校验和:
  `b372048861193676c01bad252add5e61b71e2c2f0895107530e426ffeb613fbe`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.29%.
- Marked-pixel bounds: (88,25)–(161,226); span 74 × 202 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.29%。
- 痕迹范围：(88,25)–(161,226)；跨度74 × 202 px；痕迹矩形高于宽。
