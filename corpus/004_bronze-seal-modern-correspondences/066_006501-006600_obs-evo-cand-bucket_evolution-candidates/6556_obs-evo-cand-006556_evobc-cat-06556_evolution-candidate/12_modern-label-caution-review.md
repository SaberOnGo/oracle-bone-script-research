# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006556
...
- EVOBC candidate category: `evobc-evo-cat-06556`.
- Source label for search only: `綬`.
- Source codepoints for search only: `U+7DAC`.
