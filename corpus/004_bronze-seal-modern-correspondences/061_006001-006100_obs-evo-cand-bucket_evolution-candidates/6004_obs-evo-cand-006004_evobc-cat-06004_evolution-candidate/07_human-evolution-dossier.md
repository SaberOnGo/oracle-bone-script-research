...
- External category reference: `evobc-cat-06004`
- Source category ID: `06004`
- Source label for human review: `祲`
- Source codepoints: `U+7972`
...
- `obs-evo-cand-006004-route-category-staging`
...
- `obs-evo-cand-006004-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006004-route-evolution-graph`
