...
- External category reference: `evobc-cat-03682`
- Source category ID: `03682`
- Source label for human review: `既`
- Source codepoints: `U+65E2`
- Image reference count in source metadata: `484`
...
- `obs-evo-cand-003682-route-category-staging`
...
- `obs-evo-cand-003682-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003682-route-evolution-graph`
