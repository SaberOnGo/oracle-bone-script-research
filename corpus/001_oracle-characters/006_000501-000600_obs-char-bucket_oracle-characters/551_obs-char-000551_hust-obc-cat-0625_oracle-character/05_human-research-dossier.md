# obs-char-000551 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000551`
- primary external id: `hust-obc-cat-0625`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/551_obs-char-000551_hust-obc-cat-0625_orac
  le-character/03_visual-assets/001_asset-000556_hust-obc-cat-0625_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0625/H_0625_60AB7_0.png`
- asset id: `asset-000556`
...
- source category: `0625`
- validation class: `550`
- source image route: `HUST-OBC/deciphered/0625/H_0625_60AB7_0.png`
- asset id: `asset-000556`
...
- English observation: `A broad peaked roof spreads to both sides above a
  central upright outlined body, which is crossed by a middle bar and
  contains a narrow inner vertical.`
- 中文观察: `宽尖顶向两侧展开并覆盖中央直立轮廓体，轮廓体被中部横栏穿过，内有狭窄竖笔。`
...
- dataset label text: `㙧`
- dataset label codepoints: `U+3667`
...
- filename catalog route clues: `catalog-like filename clue: H_0625
  (H_0625_60AB7_0.png)`
...
- Which source records identify obs-char-000551 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000551？
