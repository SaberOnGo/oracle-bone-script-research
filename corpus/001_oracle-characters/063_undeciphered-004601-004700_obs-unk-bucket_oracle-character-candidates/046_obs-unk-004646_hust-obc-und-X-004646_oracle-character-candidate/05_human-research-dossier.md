# obs-unk-004646 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/046_obs-unk-004646_h
  ust-obc-und-X-004646_oracle-character-candidate/03_visual-assets/001_asset
  -006239_hust-obc-und-X-004646_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/202/X_？_7220_1.png`
- asset id: `asset-006239`
...
- source class: `HUST-OBC/undeciphered/X/202/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/202/X_？_7220_1.png`
- asset id: `asset-006239`
...
- English observation: `separated thin strokes with central branches`
- 中文观察: `带中央分支的分离细笔画`
...
- Which source records identify obs-unk-004646 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004646？
