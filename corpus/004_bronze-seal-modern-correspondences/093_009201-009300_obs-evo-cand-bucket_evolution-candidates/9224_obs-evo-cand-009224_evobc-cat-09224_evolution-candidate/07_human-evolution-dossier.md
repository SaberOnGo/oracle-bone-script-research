...
- External category reference: `evobc-cat-09224`
- Source category ID: `09224`
- Source label for human review: `鄻`
...
- `obs-evo-cand-009224-route-category-staging`
...
- `obs-evo-cand-009224-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009224-route-evolution-graph`
