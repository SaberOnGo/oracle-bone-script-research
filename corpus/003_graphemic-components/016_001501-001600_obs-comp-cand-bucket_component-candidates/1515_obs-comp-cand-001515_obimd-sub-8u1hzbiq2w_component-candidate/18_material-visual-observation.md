# Material Visual Observation / obs-comp-cand-001515 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001515`
- External reference / 外部参照: `obimd-sub-8u1hzbiq2w`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016478_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8u1hzbiq2w/8u1hzbiq2w/8u1hzbiq2w.png`
- Checksum / 校验和:
  `e3a2f55539893b4d48afd66828f079793cce9e4511107d551eb669a210e6f501`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.89%.
- Marked-pixel bounds: (65,22)–(189,226); span 125 × 205 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.89%。
- 痕迹范围：(65,22)–(189,226)；跨度125 × 205 px；痕迹矩形高于宽。
