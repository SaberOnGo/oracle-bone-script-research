...
- External category reference: `evobc-cat-01962`
- Source category ID: `01962`
- Source label for human review: `壙`
- Source codepoints: `U+58D9`
...
- `obs-evo-cand-001962-route-category-staging`
...
- `obs-evo-cand-001962-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001962-route-evolution-graph`
