# obs-char-000735 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000735`
- primary external id: `hust-obc-cat-0837`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/735_obs-char-000735_hust-obc-cat-0837_orac
  le-character/03_visual-assets/001_asset-000740_hust-obc-cat-0837_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0837/G_0837_林2.19.11合36409.png`
- asset id: `asset-000740`
...
- source category: `0837`
- validation class: `734`
- source image route: `HUST-OBC/deciphered/0837/G_0837_林2.19.11合36409.png`
- asset id: `asset-000740`
...
- English observation: `A central upright branches near the top and passes
  through a triangular roof-like frame into a lower rectangular enclosure
  divided by one vertical.`
- 中文观察: `中央竖笔在上部附近分枝，穿过三角屋顶状框后进入下部矩形围框，围框内有一条竖分隔。`
...
- dataset label text: `㜻`
- dataset label codepoints: `U+373B`
...
- filename catalog route clues: `Heji-like filename clue: 合36409
  (G_0837_林2.19.11合36409.png)`
...
- Which source records identify obs-char-000735 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000735？
