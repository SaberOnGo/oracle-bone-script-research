...
- External category reference: `evobc-cat-08418`
- Source category ID: `08418`
...
- `obs-evo-cand-008418-route-category-staging`
...
- `obs-evo-cand-008418-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008418-route-evolution-graph`
