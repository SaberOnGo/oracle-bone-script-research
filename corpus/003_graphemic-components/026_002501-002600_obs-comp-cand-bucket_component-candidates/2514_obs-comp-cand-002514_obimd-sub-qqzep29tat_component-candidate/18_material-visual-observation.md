# Material Visual Observation / obs-comp-cand-002514 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002514`
- External reference / 外部参照: `obimd-sub-qqzep29tat`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020838_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dp8imn8ze4/qqzep29tat/qqzep29tat.png`
- Checksum / 校验和:
  `3e456c1ba5b657d232d08b7f1b9362ced6f33644989691b255ffdaf47a3152d3`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 2.46%.
- Marked-pixel bounds: (74,46)–(179,208); span 106 × 163 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占2.46%。
- 痕迹范围：(74,46)–(179,208)；跨度106 × 163 px；痕迹矩形高于宽。
