# obs-unk-004819 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004819`
- primary external id: `hust-obc-und-X-004819`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/019_obs-unk-004819_h
  ust-obc-und-X-004819_oracle-character-candidate/03_visual-assets/001_asset
  -006412_hust-obc-und-X-004819_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/375/X_？_7359_1.png`
- asset id: `asset-006412`
...
- source class: `HUST-OBC/undeciphered/X/375/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/375/X_？_7359_1.png`
- asset id: `asset-006412`
...
- English observation: `separated row of groups with central pale openings`
- 中文观察: `分离排列的结构和中部浅色开口`
...
- Which source records identify obs-unk-004819 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004819？
