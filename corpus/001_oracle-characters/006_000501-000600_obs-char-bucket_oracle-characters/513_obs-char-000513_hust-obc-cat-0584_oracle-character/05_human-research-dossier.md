# obs-char-000513 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/513_obs-char-000513_hust-obc-cat-0584_orac
  le-character/03_visual-assets/001_asset-000518_hust-obc-cat-0584_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0584/G_0584_乙105合21306𠂤組.png`
- asset id: `asset-000518`
...
- source category: `0584`
- validation class: `512`
- source image route: `HUST-OBC/deciphered/0584/G_0584_乙105合21306𠂤組.png`
- asset id: `asset-000518`
...
- English observation: `Two long upright strokes frame a central diagonal
  crossing and a short right-pointing branch, leaving the lower ends open
  and separate.`
- 中文观察: `两条长直立笔夹着中央斜向交叉和一条短右向分支，下端开口并彼此分离。`
...
- dataset label text: `㘾`
- dataset label codepoints: `U+363E`
...
- Which source records identify obs-char-000513 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000513？
