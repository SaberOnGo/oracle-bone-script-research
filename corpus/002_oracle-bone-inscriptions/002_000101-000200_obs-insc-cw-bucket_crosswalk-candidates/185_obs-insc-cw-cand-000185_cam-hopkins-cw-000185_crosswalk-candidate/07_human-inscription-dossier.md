...
Project ID: `obs-insc-cw-cand-000185`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000185`
...
- Yingguo / 英国所藏: `y1133` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `153` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `496` in source row; primary catalog entry pending
- Heji / 合集: `39912` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000185`
