# obs-evo-cand-006886 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-06886`
- Source label for human review: `翟`
- Source codepoints: `U+7FDF`
- Image reference count: `50`
- Era token counts: `BI:3;OBC:26;SS:1;WSC:20`
- Source token counts: `Book:9;Web:41`
