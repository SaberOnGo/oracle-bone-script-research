...
Project ID: `obs-evo-cand-008187`
...
- Project ID: `obs-evo-cand-008187`
- EVOBC category candidate ID: `evobc-evo-cat-08187`
- External category reference: `evobc-cat-08187`
- Source category ID: `08187`
- Source label for human review: `詣`
- Source codepoints: `U+8A63`
...
- `obs-evo-cand-008187-route-category-staging`
...
- `obs-evo-cand-008187-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008187-route-evolution-graph`
