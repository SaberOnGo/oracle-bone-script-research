# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001758
...
| --- | --- | --- | --- |
| `obimd-glyph-link-027032` | 󺉛 | `U+FA25B` | `reviewed_metadata_only` |
| `obimd-glyph-link-027033` | 󺉜 | `U+FA25C` | `reviewed_metadata_only` |
| `obimd-glyph-link-027034` | 󺉝 | `U+FA25D` | `reviewed_metadata_only` |
| `obimd-glyph-link-027035` | 󺉞 | `U+FA25E` | `reviewed_metadata_only` |
| `obimd-glyph-link-027036` | 󺉟 | `U+FA25F` | `reviewed_metadata_only` |
