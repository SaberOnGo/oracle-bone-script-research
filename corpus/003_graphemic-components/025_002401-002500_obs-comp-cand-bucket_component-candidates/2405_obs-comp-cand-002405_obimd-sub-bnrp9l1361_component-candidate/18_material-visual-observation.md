# Material Visual Observation / obs-comp-cand-002405 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002405`
- External reference / 外部参照: `obimd-sub-bnrp9l1361`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020476_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/npykxas4c8/bnrp9l1361/bnrp9l1361.png`
- Checksum / 校验和:
  `532a6f2df2b7278a68edd3e7674ac3457159862479a3c6a898e43394b8640d07`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.61%.
- Marked-pixel bounds: (40,27)–(216,213); span 177 × 187 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.61%。
- 痕迹范围：(40,27)–(216,213)；跨度177 × 187 px；痕迹矩形近方形。
