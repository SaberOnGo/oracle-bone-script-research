...
- Project ID: `obs-evo-cand-007407`
- EVOBC category candidate ID: `evobc-evo-cat-07407`
- External category reference: `evobc-cat-07407`
- Source category ID: `07407`
- Source label for human review: `菌`
- Source codepoints: `U+83CC`
...
- `obs-evo-cand-007407-route-category-staging`
...
- `obs-evo-cand-007407-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007407-route-evolution-graph`
