...
- External category reference: `evobc-cat-06203`
- Source category ID: `06203`
- Source label for human review: `章`
...
- `obs-evo-cand-006203-route-category-staging`
...
- `obs-evo-cand-006203-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006203-route-evolution-graph`
