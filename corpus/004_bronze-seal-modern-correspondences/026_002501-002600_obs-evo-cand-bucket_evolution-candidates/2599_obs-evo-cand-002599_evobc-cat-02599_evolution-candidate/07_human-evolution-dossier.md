...
Project ID: `obs-evo-cand-002599`
...
- Project ID: `obs-evo-cand-002599`
- EVOBC category candidate ID: `evobc-evo-cat-02599`
- External category reference: `evobc-cat-02599`
- Source category ID: `02599`
- Source label for human review: `嶭`
- Source codepoints: `U+5DAD`
...
- `obs-evo-cand-002599-route-category-staging`
...
- `obs-evo-cand-002599-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002599-route-evolution-graph`
