...
- External category reference: `evobc-cat-07274`
- Source category ID: `07274`
- Source label for human review: `苒`
...
- `obs-evo-cand-007274-route-category-staging`
...
- `obs-evo-cand-007274-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007274-route-evolution-graph`
