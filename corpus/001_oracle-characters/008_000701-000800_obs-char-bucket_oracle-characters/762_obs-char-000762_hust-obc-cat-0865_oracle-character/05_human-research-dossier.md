# obs-char-000762 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/762_obs-char-000762_hust-obc-cat-0865_orac
  le-character/03_visual-assets/001_asset-000767_hust-obc-cat-0865_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0865/G_0865_前1.6.6合35584黃組.png`
- asset id: `asset-000767`
...
- source category: `0865`
- validation class: `761`
- source image route: `HUST-OBC/deciphered/0865/G_0865_前1.6.6合35584黃組.png`
- asset id: `asset-000767`
...
- dataset label text: `㝗`
- dataset label codepoints: `U+3757`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00069`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00069`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00069`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/069_obs-evo-can
  d-000069_evobc-cat-00069_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/069_obs-evo-cand-000069_evobc-cat-00069_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合35584
  (G_0865_前1.6.6合35584黃組.png)`
...
- Which source records identify obs-char-000762 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000762？
