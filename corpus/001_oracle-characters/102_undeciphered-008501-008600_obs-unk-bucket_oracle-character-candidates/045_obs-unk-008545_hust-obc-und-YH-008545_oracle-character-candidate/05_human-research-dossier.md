# obs-unk-008545 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008545`
- primary external id: `hust-obc-und-YH-008545`
...
- local review image route: `corpus/001_oracle-characters/102_undeciphered-008
  501-008600_obs-unk-bucket_oracle-character-candidates/045_obs-unk-008545_h
  ust-obc-und-YH-008545_oracle-character-candidate/03_visual-assets/001_asse
  t-010136_hust-obc-und-YH-008545_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60BDD/H_？_60BDD_0.png`
- asset id: `asset-010136`
...
- source class: `HUST-OBC/undeciphered/Y+H/60BDD/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60BDD/H_？_60BDD_0.png`
- asset id: `asset-010136`
...
- Which source records identify obs-unk-008545 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008545？
