# obs-char-001462 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1462_obs-char-001462_hust-obc-cat-1639_164
  0_1641_oracle-character/03_visual-assets/001_asset-001467_hust-obc-cat-163
  9_1640_1641_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1639_1640_1641/1639/G_1639_前2.9
  .6(甲).png`
- asset id: `asset-001467`
...
- source category: `1639_1640_1641`
- validation class: `1461`
- source image route: `HUST-OBC/deciphered/1639_1640_1641/1639/G_1639_前2.9.6(甲
  ).png`
- asset id: `asset-001467`
...
- English observation: `An open left frame is paired with a long right
  diagonal and side branches.`
...
- dataset label text: `㩝㩞㩟`
- dataset label codepoints: `U+3A5D;U+3A5E;U+3A5F`
...
- Which source records identify obs-char-001462 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001462？
