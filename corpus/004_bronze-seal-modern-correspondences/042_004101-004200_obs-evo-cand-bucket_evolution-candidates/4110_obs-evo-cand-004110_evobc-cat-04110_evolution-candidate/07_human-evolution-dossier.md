...
Project ID: `obs-evo-cand-004110`
...
- Project ID: `obs-evo-cand-004110`
- EVOBC category candidate ID: `evobc-evo-cat-04110`
- External category reference: `evobc-cat-04110`
- Source category ID: `04110`
- Source label for human review: `棳`
- Source codepoints: `U+68F3`
...
- `obs-evo-cand-004110-route-category-staging`
...
- `obs-evo-cand-004110-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004110-route-evolution-graph`
