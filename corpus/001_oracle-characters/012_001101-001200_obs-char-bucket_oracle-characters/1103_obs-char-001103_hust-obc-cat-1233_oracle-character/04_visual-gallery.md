...
- Local image / 本地图像:
  `03_visual-assets/001_asset-001108_hust-obc-cat-1233_glyph.png`
- Local metadata / 本地 metadata:
  `03_visual-assets/001_asset-001108_hust-obc-cat-1233_glyph.yaml`
- Source image path / 来源图像路径:
  `HUST-OBC/deciphered/1233/G_1233_後2.8.7合3337賓組.png`
