# Material Visual Observation / obs-comp-cand-001264 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001264`
- External reference / 外部参照: `obimd-sub-hvoexje4ex`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015502_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hvoexje4ex/hvoexje4ex/hvoexje4ex.png`
- Checksum / 校验和:
  `c9e05a203b08e2ce465777212772f250ba6d31a727f03944d3cd5da6595c0641`
...
- Marked-pixel bounds: (60,38)–(189,216); span 130 × 179 px; the marked
...
- 痕迹范围：(60,38)–(189,216)；跨度130 × 179 px；痕迹矩形高于宽。
