...
- External category reference: `evobc-cat-09593`
- Source category ID: `09593`
- Source label for human review: `锋`
- Source codepoints: `U+950B`
...
- `obs-evo-cand-009593-route-category-staging`
...
- `obs-evo-cand-009593-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009593-route-evolution-graph`
