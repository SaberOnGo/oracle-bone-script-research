# Material Visual Observation / obs-comp-cand-002191 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002191`
- External reference / 外部参照: `obimd-sub-j0vnggwxua`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019897_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tbh9vqe3ev/j0vnggwxua/j0vnggwxua.png`
- Checksum / 校验和:
  `87a29a470d267fdfa7db92fabca262ae2255f3851bc4702dbfdcf6480fe6b976`
...
- Marked-pixel bounds: (91,29)–(158,214); span 68 × 186 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.79%。
- 痕迹范围：(91,29)–(158,214)；跨度68 × 186 px；痕迹矩形高于宽。
