# obs-char-001184 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1184_obs-char-001184_hust-obc-cat-1324_ora
  cle-character/03_visual-assets/001_asset-001189_hust-obc-cat-1324_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1324/G_1324_乙8896(甲).png`
- asset id: `asset-001189`
...
- source category: `1324`
- validation class: `1183`
- source image route: `HUST-OBC/deciphered/1324/G_1324_乙8896(甲).png`
- asset id: `asset-001189`
...
- dataset label text: `㤢`
- dataset label codepoints: `U+3922`
...
- Which source records identify obs-char-001184 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001184？
