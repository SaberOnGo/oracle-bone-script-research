...
- External category reference: `evobc-cat-07708`
- Source category ID: `07708`
- Source label for human review: `虢`
- Source codepoints: `U+8662`
...
- `obs-evo-cand-007708-route-category-staging`
...
- `obs-evo-cand-007708-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007708-route-evolution-graph`
