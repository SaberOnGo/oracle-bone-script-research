...
- Project ID: `obs-evo-cand-011195`
- EVOBC category candidate ID: `evobc-evo-cat-11195`
- External category reference: `evobc-cat-11195`
- Source category ID: `11195`
- Source label for human review: `𢒚`
- Source codepoints: `U+2249A`
...
- `obs-evo-cand-011195-route-category-staging`
...
- `obs-evo-cand-011195-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011195-route-evolution-graph`
