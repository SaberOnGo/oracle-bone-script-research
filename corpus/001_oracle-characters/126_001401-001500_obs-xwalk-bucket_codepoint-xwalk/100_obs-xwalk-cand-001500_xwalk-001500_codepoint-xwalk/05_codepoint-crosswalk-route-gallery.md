# obs-xwalk-cand-001500 Codepoint Crosswalk Route Gallery

## Route Gallery / 路线索引

This gallery lists the local evidence routes a human reviewer should open.
...
| HUST candidate route | `corpus/001_oracle-characters/015_001401-001500_obs-char-bucket_oracle-characters/1500_obs-char-001500_hust-obc-cat-1682_1683_1684_oracle-character/01_candidate-character-packet.json` | open packet and local glyph dossier first |
...
- Glyph image route from the HUST candidate packet.
- Rubbing or photograph route, if the cited source exposes one.
- Inscription context route with plate and catalog evidence.
- Bibliography route for reading history and disagreement notes.
