# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008603
...
- EVOBC candidate category: `evobc-evo-cat-08603`.
- Source label for search only: `贊`.
- Source codepoints for search only: `U+8D0A`.
