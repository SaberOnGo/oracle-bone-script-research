...
- External category reference: `evobc-cat-04083`
- Source category ID: `04083`
- Source label for human review: `梵`
...
- `obs-evo-cand-004083-route-category-staging`
...
- `obs-evo-cand-004083-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004083-route-evolution-graph`
