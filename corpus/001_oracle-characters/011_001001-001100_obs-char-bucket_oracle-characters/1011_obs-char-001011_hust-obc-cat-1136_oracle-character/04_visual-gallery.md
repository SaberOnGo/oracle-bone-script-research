...
- Local image / 本地图像:
  `03_visual-assets/001_asset-001016_hust-obc-cat-1136_glyph.png`
- Local metadata / 本地 metadata:
  `03_visual-assets/001_asset-001016_hust-obc-cat-1136_glyph.yaml`
- Source image path / 来源图像路径:
  `HUST-OBC/deciphered/1136/G_1136_佚932合30792無名組.png`
