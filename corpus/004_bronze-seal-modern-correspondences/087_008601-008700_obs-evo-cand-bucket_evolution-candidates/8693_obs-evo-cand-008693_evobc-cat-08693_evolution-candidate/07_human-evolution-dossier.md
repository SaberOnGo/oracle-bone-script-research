...
- External category reference: `evobc-cat-08693`
- Source category ID: `08693`
- Source label: `趩`
...
- `obs-evo-cand-008693-route-category-staging`
...
- `obs-evo-cand-008693-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008693-route-evolution-graph`
