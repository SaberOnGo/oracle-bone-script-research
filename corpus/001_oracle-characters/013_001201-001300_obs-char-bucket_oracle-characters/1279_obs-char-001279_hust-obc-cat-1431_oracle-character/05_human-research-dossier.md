# obs-char-001279 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001279`
- primary external id: `hust-obc-cat-1431`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1279_obs-char-001279_hust-obc-cat-1431_ora
  cle-character/03_visual-assets/001_asset-001284_hust-obc-cat-1431_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1431/G_1431_乙1558.png`
- asset id: `asset-001284`
...
- source category: `1431`
- validation class: `1278`
- source image route: `HUST-OBC/deciphered/1431/G_1431_乙1558.png`
- asset id: `asset-001284`
...
- English observation: `A simple upright form has a sloping upper stroke, a
  central vertical, a left lower branch, and an open curve.`
- 中文观察: `简洁直立形体有倾斜上笔、中央竖笔、左下分枝和开放弧线。`
...
- dataset label text: `㦍`
- dataset label codepoints: `U+398D`
...
- Which source records identify obs-char-001279 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001279？
