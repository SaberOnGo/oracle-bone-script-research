# Material Visual Observation / obs-comp-cand-000321 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000321`
- External reference / 外部参照: `obimd-sub-9rettc8wd4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012248_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ajjda965yb/9rettc8wd4/9rettc8wd4.png`
- Checksum / 校验和:
  `6a5f921605e7847b5b160d07fc0b468cb7b7027bf38f2bd7e5ee4fae13af623b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.25%.
- Marked-pixel bounds: (38,43)–(211,198); span 174 × 156 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.25%。
- 痕迹范围：(38,43)–(211,198)；跨度174 × 156 px；痕迹矩形近方形。
