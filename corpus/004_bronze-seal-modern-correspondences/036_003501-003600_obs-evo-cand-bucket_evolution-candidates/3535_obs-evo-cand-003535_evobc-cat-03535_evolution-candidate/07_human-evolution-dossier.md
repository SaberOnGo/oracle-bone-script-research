...
- External category reference: `evobc-cat-03535`
- Source category ID: `03535`
- Source label for human review: `擯`
- Source codepoints: `U+64EF`
...
- `obs-evo-cand-003535-route-category-staging`
...
- `obs-evo-cand-003535-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003535-route-evolution-graph`
