...
- External category reference: `evobc-cat-11153`
- Source category ID: `11153`
...
- `obs-evo-cand-011153-route-category-staging`
...
- `obs-evo-cand-011153-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011153-route-evolution-graph`
