# obs-unk-005671 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005671`
- primary external id: `hust-obc-und-X-005671`
...
- local review image route: `corpus/001_oracle-characters/073_undeciphered-005
  601-005700_obs-unk-bucket_oracle-character-candidates/071_obs-unk-005671_h
  ust-obc-und-X-005671_oracle-character-candidate/03_visual-assets/001_asset
  -007264_hust-obc-und-X-005671_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1227/X_？_1030_1.png`
- asset id: `asset-007264`
...
- source class: `HUST-OBC/undeciphered/X/1227/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1227/X_？_1030_1.png`
- asset id: `asset-007264`
...
- Which source records identify obs-unk-005671 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005671？
