# Material Visual Observation / obs-comp-cand-000038 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000038`
- External reference / 外部参照: `obimd-sub-r4xlmwmdvl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011295_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/r4xlmwmdvl/r4xlmwmdvl/r4xlmwmdvl.png`
- Checksum / 校验和:
  `78f69a014b03d0d8fef8ff117cea935a03ab63bdf6e0864329cb777c11ac69db`
...
- Marked-pixel bounds: (64,29)–(188,224); span 125 × 196 px; the marked
...
- 痕迹范围：(64,29)–(188,224)；跨度125 × 196 px；痕迹矩形高于宽。
