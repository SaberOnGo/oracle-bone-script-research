...
- External category reference: `evobc-cat-09250`
- Source category ID: `09250`
- Source label for human review: `酩`
...
- `obs-evo-cand-009250-route-category-staging`
...
- `obs-evo-cand-009250-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009250-route-evolution-graph`
