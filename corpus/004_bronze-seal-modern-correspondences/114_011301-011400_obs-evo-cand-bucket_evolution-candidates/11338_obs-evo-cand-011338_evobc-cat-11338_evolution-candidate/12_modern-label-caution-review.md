# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-011338
...
- EVOBC candidate category: `evobc-evo-cat-11338`.
- Source label for search only: `𢽊`.
- Source codepoints for search only: `U+22F4A`.
