# obs-unk-004334 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/034_obs-unk-004334_h
  ust-obc-und-L-004334_oracle-character-candidate/03_visual-assets/001_asset
  -005927_hust-obc-und-L-004334_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4334/L_？_9576.jpg`
- asset id: `asset-005927`
...
- source class: `HUST-OBC/undeciphered/L/4334/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4334/L_？_9576.jpg`
- asset id: `asset-005927`
...
- English observation: `Angled upper trace and lower horizontal mark recorded.`
- 中文观察: `已记录上部角状痕迹和下部横向痕迹。`
...
- Which source records identify obs-unk-004334 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004334？
