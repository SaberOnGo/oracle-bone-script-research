...
- External category reference: `evobc-cat-09768`
- Source category ID: `09768`
- Source label for human review: `階`
- Source codepoints: `U+968E`
...
- `obs-evo-cand-009768-route-category-staging`
...
- `obs-evo-cand-009768-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009768-route-evolution-graph`
