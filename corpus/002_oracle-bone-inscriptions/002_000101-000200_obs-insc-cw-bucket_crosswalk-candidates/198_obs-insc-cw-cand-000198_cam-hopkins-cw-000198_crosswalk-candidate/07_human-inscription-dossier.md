...
- Yingguo / 英国所藏: `y1178` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `49` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `686` in source row; primary catalog entry pending
- Heji / 合集: `41833` in source row; primary catalog entry pending
