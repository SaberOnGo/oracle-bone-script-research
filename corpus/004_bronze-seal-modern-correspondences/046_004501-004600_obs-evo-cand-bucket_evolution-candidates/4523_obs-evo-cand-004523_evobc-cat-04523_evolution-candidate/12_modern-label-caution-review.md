# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004523
...
- EVOBC candidate category: `evobc-evo-cat-04523`.
- Source label for search only: `汻`.
- Source codepoints for search only: `U+6C7B`.
