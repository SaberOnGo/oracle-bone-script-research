...
- `obs-evo-cand-008714-route-category-staging`
...
- `obs-evo-cand-008714-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008714-route-evolution-graph`
