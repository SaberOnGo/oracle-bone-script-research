...
- External category reference: `evobc-cat-07715`
- Source category ID: `07715`
...
- `obs-evo-cand-007715-route-category-staging`
...
- `obs-evo-cand-007715-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007715-route-evolution-graph`
