...
- External category reference: `evobc-cat-07190`
- Source category ID: `07190`
...
- `obs-evo-cand-007190-route-category-staging`
...
- `obs-evo-cand-007190-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007190-route-evolution-graph`
