...
- External category reference: `evobc-cat-11235`
- Source category ID: `11235`
- Source label for human review: `𢚠`
...
- `obs-evo-cand-011235-route-category-staging`
...
- `obs-evo-cand-011235-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011235-route-evolution-graph`
