# Material Visual Observation / obs-comp-cand-001093 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001093`
- External reference / 外部参照: `obimd-sub-ct6ebuoqac`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014902_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/t1wd9fiznl/ct6ebuoqac/ct6ebuoqac.png`
- Checksum / 校验和:
  `80f9cf95f0ee7535c0233b3559430a30edcbbdee47bfdc5a185d42e3bfcfc9a0`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.41%.
- Marked-pixel bounds: (86,47)–(163,203); span 78 × 157 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.41%。
- 痕迹范围：(86,47)–(163,203)；跨度78 × 157 px；痕迹矩形高于宽。
