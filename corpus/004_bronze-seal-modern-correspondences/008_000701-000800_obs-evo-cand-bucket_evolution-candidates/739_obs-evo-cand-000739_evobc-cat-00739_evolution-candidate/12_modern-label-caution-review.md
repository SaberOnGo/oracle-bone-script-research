# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000739
...
- EVOBC candidate category: `evobc-evo-cat-00739`.
- Source label for search only: `仚`.
- Source codepoints for search only: `U+4EDA`.
