...
- External category reference: `evobc-cat-07044`
- Source category ID: `07044`
- Source label for human review: `胸`
- Source codepoints: `U+80F8`
...
- `obs-evo-cand-007044-route-category-staging`
...
- `obs-evo-cand-007044-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007044-route-evolution-graph`
