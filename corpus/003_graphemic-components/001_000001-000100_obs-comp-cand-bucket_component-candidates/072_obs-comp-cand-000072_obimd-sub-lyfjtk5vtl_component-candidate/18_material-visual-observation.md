# Material Visual Observation / obs-comp-cand-000072 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000072`
- External reference / 外部参照: `obimd-sub-lyfjtk5vtl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011484_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/nscqmvthk1/lyfjtk5vtl/lyfjtk5vtl.png`
- Checksum / 校验和:
  `2670724b8706d35f519dff015b5e5b3fd762428e033eb43b9e4d98a7f061abcf`
...
- Marked-pixel bounds: (85,19)–(164,229); span 80 × 211 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.72%。
- 痕迹范围：(85,19)–(164,229)；跨度80 × 211 px；痕迹矩形高于宽。
