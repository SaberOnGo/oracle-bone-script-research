...
- Project ID: `obs-evo-cand-002996`
- EVOBC category candidate ID: `evobc-evo-cat-02996`
- External category reference: `evobc-cat-02996`
- Source category ID: `02996`
- Source label for human review: `恿`
- Source codepoints: `U+607F`
...
- `obs-evo-cand-002996-route-category-staging`
...
- `obs-evo-cand-002996-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002996-route-evolution-graph`
