# obs-comp-cand-002701 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002701`
- 首选外部 ID: `obimd-sub-n4zypvvycn`
- OBIMD subcharacter UID: `n4zypvvycn`
- OBIMD main character UID: `n4zypvvycn`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+FF3AE; U+FF3AF; 另有 1 项
