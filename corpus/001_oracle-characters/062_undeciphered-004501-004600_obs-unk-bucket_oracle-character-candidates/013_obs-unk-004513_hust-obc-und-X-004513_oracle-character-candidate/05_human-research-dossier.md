# obs-unk-004513 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/013_obs-unk-004513_h
  ust-obc-und-X-004513_oracle-character-candidate/03_visual-assets/001_asset
  -006106_hust-obc-und-X-004513_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/69/X_？_7208_1.png`
- asset id: `asset-006106`
...
- source class: `HUST-OBC/undeciphered/X/69/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/69/X_？_7208_1.png`
- asset id: `asset-006106`
...
- English observation: `The horizontal band, upper branches, descending traces,
  and image-count discrepancy are directly recorded.`
- 中文观察: `已直接记录横带、上部分支、下行痕和图像数量差异。`
...
- Which source records identify obs-unk-004513 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004513？
