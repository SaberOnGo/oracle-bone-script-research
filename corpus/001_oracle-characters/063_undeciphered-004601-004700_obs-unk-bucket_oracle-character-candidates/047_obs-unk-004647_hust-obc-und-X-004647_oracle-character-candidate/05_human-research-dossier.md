# obs-unk-004647 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004647`
- primary external id: `hust-obc-und-X-004647`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/047_obs-unk-004647_h
  ust-obc-und-X-004647_oracle-character-candidate/03_visual-assets/001_asset
  -006240_hust-obc-und-X-004647_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/203/X_？_8375_1.png`
- asset id: `asset-006240`
...
- source class: `HUST-OBC/undeciphered/X/203/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/203/X_？_8375_1.png`
- asset id: `asset-006240`
...
- English observation: `tall leaning form with two pale openings`
- 中文观察: `带两个浅色开口的高倾斜形体`
...
- Which source records identify obs-unk-004647 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004647？
