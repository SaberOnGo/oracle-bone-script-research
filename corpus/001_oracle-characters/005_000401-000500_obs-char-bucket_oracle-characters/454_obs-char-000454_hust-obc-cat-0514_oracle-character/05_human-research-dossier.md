# obs-char-000454 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/454_obs-char-000454_hust-obc-cat-0514_orac
  le-character/03_visual-assets/001_asset-000459_hust-obc-cat-0514_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0514/G_0514_乙2596合14721.png`
- asset id: `asset-000459`
...
- source category: `0514`
- validation class: `453`
- source image route: `HUST-OBC/deciphered/0514/G_0514_乙2596合14721.png`
- asset id: `asset-000459`
...
- English observation: `A narrow upright form combines an angular open top,
  a small central enclosure, a short crossbar, and one long descending
  vertical stroke.`
...
- dataset label text: `㗸`
- dataset label codepoints: `U+35F8`
...
- Which source records identify obs-char-000454 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000454？
