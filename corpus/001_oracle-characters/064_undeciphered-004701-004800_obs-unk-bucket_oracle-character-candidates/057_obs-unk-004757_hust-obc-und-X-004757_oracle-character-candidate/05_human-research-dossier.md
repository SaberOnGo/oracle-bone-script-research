# obs-unk-004757 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004757`
- primary external id: `hust-obc-und-X-004757`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/057_obs-unk-004757_h
  ust-obc-und-X-004757_oracle-character-candidate/03_visual-assets/001_asset
  -006350_hust-obc-und-X-004757_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/313/X_？_7298_1.png`
- asset id: `asset-006350`
...
- source class: `HUST-OBC/undeciphered/X/313/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/313/X_？_7298_1.png`
- asset id: `asset-006350`
...
- English observation: `upper projections, lower enclosure, and thin terminal`
- 中文观察: `上部突起、下部围合结构和细长末端`
...
- Which source records identify obs-unk-004757 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004757？
