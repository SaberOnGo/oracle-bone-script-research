# obs-unk-004653 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/053_obs-unk-004653_h
  ust-obc-und-X-004653_oracle-character-candidate/03_visual-assets/001_asset
  -006246_hust-obc-und-X-004653_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/209/X_？_8381_1.png`
- asset id: `asset-006246`
...
- source class: `HUST-OBC/undeciphered/X/209/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/209/X_？_8381_1.png`
- asset id: `asset-006246`
...
- English observation: `peaked open contour with central descending stroke`
- 中文观察: `带中央下行笔画的尖顶开口轮廓`
...
- Which source records identify obs-unk-004653 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004653？
