...
Project ID: `obs-evo-cand-001693`
...
- Project ID: `obs-evo-cand-001693`
- EVOBC category candidate ID: `evobc-evo-cat-01693`
- External category reference: `evobc-cat-01693`
- Source category ID: `01693`
- Source label for human review: `嘍`
- Source codepoints: `U+560D`
...
- `obs-evo-cand-001693-route-category-staging`
...
- `obs-evo-cand-001693-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001693-route-evolution-graph`
