...
- Project ID: `obs-evo-cand-010419`
- EVOBC category candidate ID: `evobc-evo-cat-10419`
- External category reference: `evobc-cat-10419`
- Source category ID: `10419`
- Source label for human review: `鯨`
- Source codepoints: `U+9BE8`
...
- `obs-evo-cand-010419-route-category-staging`
...
- `obs-evo-cand-010419-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010419-route-evolution-graph`
