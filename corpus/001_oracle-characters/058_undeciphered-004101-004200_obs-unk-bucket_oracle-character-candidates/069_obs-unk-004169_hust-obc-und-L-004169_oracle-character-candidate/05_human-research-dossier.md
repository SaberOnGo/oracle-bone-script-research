# obs-unk-004169 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004169`
- primary external id: `hust-obc-und-L-004169`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/069_obs-unk-004169_h
  ust-obc-und-L-004169_oracle-character-candidate/03_visual-assets/001_asset
  -005762_hust-obc-und-L-004169_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4169/L_？_9035.jpg`
- asset id: `asset-005762`
...
- source class: `HUST-OBC/undeciphered/L/4169/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4169/L_？_9035.jpg`
- asset id: `asset-005762`
...
- English observation: A compact upper group has crossing strokes and lower
  left angular marks.
- 中文观察: 紧凑上部形态有交叉笔画，左下有折角痕迹。
...
- Which source records identify obs-unk-004169 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004169？
