...
Project ID: `obs-evo-cand-008308`
...
- Project ID: `obs-evo-cand-008308`
- EVOBC category candidate ID: `evobc-evo-cat-08308`
- External category reference: `evobc-cat-08308`
- Source category ID: `08308`
- Source label for human review: `謎`
- Source codepoints: `U+8B0E`
...
- `obs-evo-cand-008308-route-category-staging`
...
- `obs-evo-cand-008308-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008308-route-evolution-graph`
