# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001607
...
| --- | --- | --- | --- |
| `obimd-glyph-link-025091` | 響󹘸 | `U+97FF;U+F9638` | `reviewed_metadata_only` |
| `obimd-glyph-link-025092` | 󹘹 | `U+F9639` | `reviewed_metadata_only` |
