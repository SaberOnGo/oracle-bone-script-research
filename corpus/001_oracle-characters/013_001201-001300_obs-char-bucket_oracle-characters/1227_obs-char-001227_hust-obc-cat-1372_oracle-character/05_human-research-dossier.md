# obs-char-001227 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001227`
- primary external id: `hust-obc-cat-1372`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1227_obs-char-001227_hust-obc-cat-1372_ora
  cle-character/03_visual-assets/001_asset-001232_hust-obc-cat-1372_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1372/G_1372_乙8718(甲).png`
- asset id: `asset-001232`
...
- source category: `1372`
- validation class: `1226`
- source image route: `HUST-OBC/deciphered/1372/G_1372_乙8718(甲).png`
- asset id: `asset-001232`
...
- English observation: `A simple sloping stroke has a pointed upper end and
  a long curved lower hook.`
- 中文观察: `简洁斜向笔有尖状上端和长圆弧形下部钩笔。`
...
- dataset label text: `㥒`
- dataset label codepoints: `U+3952`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00127`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00127`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00127`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/127_obs-evo-can
  d-000127_evobc-cat-00127_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/127_obs-evo-cand-000127_evobc-cat-00127_evolu
...
- Which source records identify obs-char-001227 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001227？
