...
- External category reference: `evobc-cat-07731`
- Source category ID: `07731`
- Source label for human review: `蚘`
...
- `obs-evo-cand-007731-route-category-staging`
...
- `obs-evo-cand-007731-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007731-route-evolution-graph`
