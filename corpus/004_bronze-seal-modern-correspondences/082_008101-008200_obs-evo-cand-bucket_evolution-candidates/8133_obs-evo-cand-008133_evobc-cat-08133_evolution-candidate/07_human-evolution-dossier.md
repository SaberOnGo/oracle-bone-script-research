...
- External category reference: `evobc-cat-08133`
- Source category ID: `08133`
- Source label for human review: `訐`
...
- `obs-evo-cand-008133-route-category-staging`
...
- `obs-evo-cand-008133-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008133-route-evolution-graph`
