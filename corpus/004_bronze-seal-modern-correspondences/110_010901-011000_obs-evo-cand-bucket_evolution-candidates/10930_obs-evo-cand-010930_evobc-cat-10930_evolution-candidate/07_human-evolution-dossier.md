...
Project ID: `obs-evo-cand-010930`
...
- Project ID: `obs-evo-cand-010930`
- EVOBC category candidate ID: `evobc-evo-cat-10930`
- External category reference: `evobc-cat-10930`
- Source category ID: `10930`
- Source label for human review: `𠮯`
- Source codepoints: `U+20BAF`
- Image reference count in source metadata: `89`
...
- `obs-evo-cand-010930-route-category-staging`
...
- `obs-evo-cand-010930-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010930-route-evolution-graph`
