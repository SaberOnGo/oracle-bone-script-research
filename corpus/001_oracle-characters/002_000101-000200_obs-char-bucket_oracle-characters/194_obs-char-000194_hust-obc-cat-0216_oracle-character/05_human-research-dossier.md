# obs-char-000194 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000194`
- primary external id: `hust-obc-cat-0216`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/194_obs-char-000194_hust-obc-cat-0216_orac
  le-character/03_visual-assets/001_asset-000199_hust-obc-cat-0216_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0216/G_0216_河650合4078賓組.png`
- asset id: `asset-000199`
...
- source category: `0216`
- validation class: `193`
- source image route: `HUST-OBC/deciphered/0216/G_0216_河650合4078賓組.png`
- asset id: `asset-000199`
...
- dataset label text: `㓎`
- dataset label codepoints: `U+34CE`
...
- filename catalog route clues: `Heji-like filename clue: 合4078
  (G_0216_河650合4078賓組.png)`
...
- Which source records identify obs-char-000194 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000194？
