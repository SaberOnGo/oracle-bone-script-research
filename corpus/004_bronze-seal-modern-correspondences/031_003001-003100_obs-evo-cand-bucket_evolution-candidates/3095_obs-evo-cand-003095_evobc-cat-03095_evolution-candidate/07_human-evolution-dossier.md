...
- External category reference: `evobc-cat-03095`
- Source category ID: `03095`
- Source label for human review: `愯`
- Source codepoints: `U+612F`
...
- `obs-evo-cand-003095-route-category-staging`
...
- `obs-evo-cand-003095-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003095-route-evolution-graph`
