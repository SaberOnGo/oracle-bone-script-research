# obs-unk-004222 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/022_obs-unk-004222_h
  ust-obc-und-L-004222_oracle-character-candidate/03_visual-assets/001_asset
  -005815_hust-obc-und-L-004222_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4222/L_？_9228.jpg`
- asset id: `asset-005815`
...
- source class: `HUST-OBC/undeciphered/L/4222/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4222/L_？_9228.jpg`
- asset id: `asset-005815`
...
- English observation: `Open wedge, upper stroke, lower curve visible.`
- 中文观察: `开放楔状轮廓、上部笔画和下部弯曲笔画可见。`
...
- Which source records identify obs-unk-004222 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004222？
