...
- External category reference: `evobc-cat-12968`
- Source category ID: `12968`
- Source label for human review: `𫕝`
- Source codepoints: `U+2B55D`
...
- `obs-evo-cand-012968-route-category-staging`
...
- `obs-evo-cand-012968-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012968-route-evolution-graph`
