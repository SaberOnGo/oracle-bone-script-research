...
- Project ID: `obs-evo-cand-003011`
- EVOBC category candidate ID: `evobc-evo-cat-03011`
- External category reference: `evobc-cat-03011`
- Source category ID: `03011`
- Source label for human review: `悖`
- Source codepoints: `U+6096`
...
- `obs-evo-cand-003011-route-category-staging`
...
- `obs-evo-cand-003011-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003011-route-evolution-graph`
