# Material Visual Observation / obs-comp-cand-000415 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000415`
- External reference / 外部参照: `obimd-sub-9chx3kaelf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012338_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/exg6lsn5w7/9chx3kaelf/9chx3kaelf.png`
- Checksum / 校验和:
  `ee077891768de1f613b949fd0f39da56f85c0b2aeafa1b75f572a1bd62d1c014`
...
- Marked-pixel bounds: (76,38)–(173,211); span 98 × 174 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.18%。
- 痕迹范围：(76,38)–(173,211)；跨度98 × 174 px；痕迹矩形高于宽。
