...
- External category reference: `evobc-cat-13120`
- Source category ID: `13120`
- Source label for human review: `𫷄`
...
- `obs-evo-cand-013120-route-category-staging`
...
- `obs-evo-cand-013120-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013120-route-evolution-graph`
