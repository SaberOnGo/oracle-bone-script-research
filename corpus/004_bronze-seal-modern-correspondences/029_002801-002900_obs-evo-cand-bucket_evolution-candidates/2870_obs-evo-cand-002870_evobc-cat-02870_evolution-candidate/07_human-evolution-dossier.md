...
- External category reference: `evobc-cat-02870`
- Source category ID: `02870`
- Source label for human review: `徑`
...
- `obs-evo-cand-002870-route-category-staging`
...
- `obs-evo-cand-002870-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002870-route-evolution-graph`
