# Material Visual Observation / obs-comp-cand-000749 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000749`
- External reference / 外部参照: `obimd-sub-a675ctdqop`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013514_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/a675ctdqop/a675ctdqop/a675ctdqop.png`
- Checksum / 校验和:
  `653328682de7ce1e2af86d7768101edbdd3c6347713d9cf0e9ae9d7e6d0904aa`
...
- Marked-pixel bounds: (64,33)–(181,224); span 118 × 192 px; the marked
...
- 痕迹范围：(64,33)–(181,224)；跨度118 × 192 px；痕迹矩形高于宽。
