...
- External category reference: `evobc-cat-01668`
- Source category ID: `01668`
- Source label for human review: `嗇`
- Source codepoints: `U+55C7`
...
- `obs-evo-cand-001668-route-category-staging`
...
- `obs-evo-cand-001668-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001668-route-evolution-graph`
