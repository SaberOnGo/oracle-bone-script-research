...
- External category reference: `evobc-cat-06491`
- Source category ID: `06491`
- Source label for human review: `組`
- Source codepoints: `U+7D44`
...
- `obs-evo-cand-006491-route-category-staging`
...
- `obs-evo-cand-006491-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006491-route-evolution-graph`
