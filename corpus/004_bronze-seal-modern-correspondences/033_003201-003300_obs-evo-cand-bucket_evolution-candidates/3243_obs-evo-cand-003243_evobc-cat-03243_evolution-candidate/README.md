# obs-evo-cand-003243 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-003243`
- EVOBC category candidate ID: `evobc-evo-cat-03243`
- External category ref: `evobc-cat-03243`
- Source label: `手`
- Source codepoints: `U+624B`
- Image reference count: `53`
- Era token counts: `BI:37;CS:1;SS:3;WSC:12`
- Source token counts: `Book:30;Web:23`

## Observed Code Rows / 观察到的代码行

- era 1 / BI: 37 image references
