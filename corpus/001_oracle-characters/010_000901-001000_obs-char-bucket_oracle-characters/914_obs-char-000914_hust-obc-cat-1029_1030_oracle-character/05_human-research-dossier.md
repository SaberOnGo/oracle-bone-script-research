# obs-char-000914 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000914`
- primary external id: `hust-obc-cat-1029_1030`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/914_obs-char-000914_hust-obc-cat-1029_1030
  _oracle-character/03_visual-assets/001_asset-000919_hust-obc-cat-1029_1030
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1029_1030/1029/G_1029_乙2596合147
  21.png`
- asset id: `asset-000919`
...
- source category: `1029_1030`
- validation class: `913`
- source image route: `HUST-OBC/deciphered/1029_1030/1029/G_1029_乙2596合14721.p
  ng`
- asset id: `asset-000919`
...
- English observation: `Long upper diagonals cross at a central junction,
  with short detached side marks and multiple descending branches.`
- 中文观察: `长上斜笔在中央交会，旁有短小分离痕迹和多条下行分枝。`
...
- dataset label text: `㟻㟼`
- dataset label codepoints: `U+37FB;U+37FC`
...
- graph edge count: `2`
- codepoint routes: `U+37FB;U+37FC`
...
- filename catalog route clues: `Heji-like filename clue: 合14721
  (G_1029_乙2596合14721.png)`
...
- Which source records identify obs-char-000914 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000914？
