...
- External category reference: `evobc-cat-02934`
- Source category ID: `02934`
- Source label for human review: `怓`
- Source codepoints: `U+6013`
...
- `obs-evo-cand-002934-route-category-staging`
...
- `obs-evo-cand-002934-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002934-route-evolution-graph`
