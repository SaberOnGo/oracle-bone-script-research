...
- Yingguo / 英国所藏: `y560` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `101` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `600` in source row; primary catalog entry pending
- Heji / 合集: `39869` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000094`
