# obs-unk-004179 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004179`
- primary external id: `hust-obc-und-L-004179`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/079_obs-unk-004179_h
  ust-obc-und-L-004179_oracle-character-candidate/03_visual-assets/001_asset
  -005772_hust-obc-und-L-004179_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4179/L_？_9056.jpg`
- asset id: `asset-005772`
...
- source class: `HUST-OBC/undeciphered/L/4179/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4179/L_？_9056.jpg`
- asset id: `asset-005772`
...
- English observation: A long upper stroke crosses a compact lower angular
  group.
- 中文观察: 长上部笔画下方有紧凑的下部折角组。
...
- Which source records identify obs-unk-004179 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004179？
