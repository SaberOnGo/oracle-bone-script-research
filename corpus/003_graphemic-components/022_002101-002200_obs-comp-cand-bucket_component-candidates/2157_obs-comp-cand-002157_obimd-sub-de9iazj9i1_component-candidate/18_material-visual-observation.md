# Material Visual Observation / obs-comp-cand-002157 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002157`
- External reference / 外部参照: `obimd-sub-de9iazj9i1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019798_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cv483h1fw2/de9iazj9i1/de9iazj9i1.png`
- Checksum / 校验和:
  `4e451d838c4803a7d71d1236c4f2876fc13f73b2d2c04f36cc4972d7dc6d0e8d`
...
- Marked-pixel bounds: (91,18)–(164,230); span 74 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.63%。
- 痕迹范围：(91,18)–(164,230)；跨度74 × 213 px；痕迹矩形高于宽。
