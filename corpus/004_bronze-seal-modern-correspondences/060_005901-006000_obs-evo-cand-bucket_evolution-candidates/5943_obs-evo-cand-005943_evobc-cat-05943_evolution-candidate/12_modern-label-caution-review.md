# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-005943
...
- EVOBC candidate category: `evobc-evo-cat-05943`.
- Source label for search only: `磛`.
- Source codepoints for search only: `U+78DB`.
