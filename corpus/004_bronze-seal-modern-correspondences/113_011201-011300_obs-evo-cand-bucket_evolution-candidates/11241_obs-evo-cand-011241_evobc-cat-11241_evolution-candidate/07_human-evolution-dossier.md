...
- External category reference: `evobc-cat-11241`
- Source category ID: `11241`
- Source label for human review: `𢛇`
...
- `obs-evo-cand-011241-route-category-staging`
...
- `obs-evo-cand-011241-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011241-route-evolution-graph`
