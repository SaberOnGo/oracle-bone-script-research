...
- External category reference: `evobc-cat-12170`
- Source category ID: `12170`
- Source label for human review: `𧒾`
...
- `obs-evo-cand-012170-route-category-staging`
...
- `obs-evo-cand-012170-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012170-route-evolution-graph`
