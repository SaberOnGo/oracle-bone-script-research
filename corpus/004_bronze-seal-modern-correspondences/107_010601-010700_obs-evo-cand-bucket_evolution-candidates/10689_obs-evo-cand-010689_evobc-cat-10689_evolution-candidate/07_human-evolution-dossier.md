...
Project ID: `obs-evo-cand-010689`
...
- Project ID: `obs-evo-cand-010689`
- EVOBC category candidate ID: `evobc-evo-cat-10689`
- External category reference: `evobc-cat-10689`
- Source category ID: `10689`
- Source label for human review: `鼖`
- Source codepoints: `U+9F16`
...
- `obs-evo-cand-010689-route-category-staging`
...
- `obs-evo-cand-010689-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010689-route-evolution-graph`
