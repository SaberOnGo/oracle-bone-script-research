# obs-unk-004823 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/023_obs-unk-004823_h
  ust-obc-und-X-004823_oracle-character-candidate/03_visual-assets/001_asset
  -006416_hust-obc-und-X-004823_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/379/X_？_7363_1.png`
- asset id: `asset-006416`
...
- source class: `HUST-OBC/undeciphered/X/379/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/379/X_？_7363_1.png`
- asset id: `asset-006416`
...
- English observation: `central cluster, curved sides, and lower split stem`
- 中文观察: `中部结构、曲线侧笔画和下部分叉笔干`
...
- Which source records identify obs-unk-004823 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004823？
