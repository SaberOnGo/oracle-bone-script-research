# Collection Provenance Evidence Dossier / 馆藏来源证据档案: coll-obj-cand-00003

The live official-page, plate, and inscription check is recorded in
`18_live-source-evidence-review.md`. It remains source-reported evidence with
metadata-only rights, not a promoted object or formal inscription record.

现场官方页、图版和卜辞检查记录在 `18_live-source-evidence-review.md`。它仍是来源
报告证据，权利状态为仅元数据，不是已提升的对象或正式卜辞记录。
...
| source_row_id | `3` |
| object_page_url | `https://museum.sinica.edu.tw/en/collection/32/item/1213/` |
...
| asset_id | `` |
| asset_path | `` |
| thumbnail_url | `https://museum.sinica.edu.tw/_upload/image/collection_item/thumbnail/4636755e7bcd4f54.jpg` |
| source_image_url | `` |
...
| `source_collection_item_id` | `1213` |
| `object_title_en` | `Bing Bian 0008` |
| `catalog_reference_text` | `Bing Bian 0008` |
| `accession_number` | `` |
| `historical_period` | `` |
| `object_date` | `` |
| `provenience` | `` |
