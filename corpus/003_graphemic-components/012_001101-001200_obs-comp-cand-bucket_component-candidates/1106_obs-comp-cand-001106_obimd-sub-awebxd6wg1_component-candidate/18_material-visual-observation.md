# Material Visual Observation / obs-comp-cand-001106 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001106`
- External reference / 外部参照: `obimd-sub-awebxd6wg1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015047_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/awebxd6wg1/awebxd6wg1/awebxd6wg1.png`
- Checksum / 校验和:
  `fb27b3f2f7d3918956672a1fa40bb8fdcd71948c7f0511d51ce8832825561adc`
...
- Marked-pixel bounds: (80,48)–(169,205); span 90 × 158 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.49%。
- 痕迹范围：(80,48)–(169,205)；跨度90 × 158 px；痕迹矩形高于宽。
