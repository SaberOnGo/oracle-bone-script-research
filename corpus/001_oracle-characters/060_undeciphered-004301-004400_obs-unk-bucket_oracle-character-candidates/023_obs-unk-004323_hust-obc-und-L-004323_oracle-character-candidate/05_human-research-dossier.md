# obs-unk-004323 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/023_obs-unk-004323_h
  ust-obc-und-L-004323_oracle-character-candidate/03_visual-assets/001_asset
  -005916_hust-obc-und-L-004323_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4323/L_？_9556.jpg`
- asset id: `asset-005916`
...
- source class: `HUST-OBC/undeciphered/L/4323/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4323/L_？_9556.jpg`
- asset id: `asset-005916`
...
- English observation: `Compact upper diagonals and two long lower
  strokes recorded.`
- 中文观察: `已记录顶部紧密斜痕和两条较长下伸痕迹。`
...
- Which source records identify obs-unk-004323 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004323？
