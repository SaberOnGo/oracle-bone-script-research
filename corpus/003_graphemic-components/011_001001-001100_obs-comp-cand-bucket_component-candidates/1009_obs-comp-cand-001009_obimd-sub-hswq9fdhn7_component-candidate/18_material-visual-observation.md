# Material Visual Observation / obs-comp-cand-001009 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001009`
- External reference / 外部参照: `obimd-sub-hswq9fdhn7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014472_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/14byfgv30p/hswq9fdhn7/hswq9fdhn7.png`
- Checksum / 校验和:
  `0b91f267855eb0e2db4334cc22299a47467052e83a2eb8bad22dc78805f92fbf`
...
- Marked-pixel bounds: (70,28)–(161,213); span 92 × 186 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.72%。
- 痕迹范围：(70,28)–(161,213)；跨度92 × 186 px；痕迹矩形高于宽。
