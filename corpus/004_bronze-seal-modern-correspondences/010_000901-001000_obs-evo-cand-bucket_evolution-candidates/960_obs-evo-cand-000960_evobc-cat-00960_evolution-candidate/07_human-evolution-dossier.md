...
- External category reference: `evobc-cat-00960`
- Source category ID: `00960`
- Source label for human review: `偞`
...
- `obs-evo-cand-000960-route-category-staging`
...
- `obs-evo-cand-000960-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000960-route-evolution-graph`
