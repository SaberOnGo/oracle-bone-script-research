...
- Yingguo / 英国所藏: `y2578` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `413` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `514` in source row; primary catalog entry pending
