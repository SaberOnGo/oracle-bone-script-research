# Material Visual Observation / obs-comp-cand-000425 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000425`
- External reference / 外部参照: `obimd-sub-xyp0ngvyd7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012348_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xyp0ngvyd7/xyp0ngvyd7/xyp0ngvyd7.png`
- Checksum / 校验和:
  `b24c37309800027d8e234ea4613f2c6274e6494eb72e15394c89c2a2c501bd82`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.30%.
- Marked-pixel bounds: (61,49)–(188,196); span 128 × 148 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.30%。
- 痕迹范围：(61,49)–(188,196)；跨度128 × 148 px；痕迹矩形近方形。
