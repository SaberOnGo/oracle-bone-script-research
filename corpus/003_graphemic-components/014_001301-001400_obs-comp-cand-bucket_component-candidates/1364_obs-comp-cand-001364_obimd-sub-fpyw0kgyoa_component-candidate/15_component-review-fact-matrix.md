# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001364
...
| Glyph or codepoint route / 字形或码位路线 | 18 OBIMD route rows; examples U+F7C3B; U+F7C3C; 另有 16 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
