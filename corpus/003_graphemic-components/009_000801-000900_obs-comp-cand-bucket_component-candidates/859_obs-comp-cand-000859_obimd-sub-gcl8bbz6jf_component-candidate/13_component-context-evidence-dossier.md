# obs-comp-cand-000859 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000859`
- 首选外部 ID: `obimd-sub-gcl8bbz6jf`
- OBIMD subcharacter UID: `gcl8bbz6jf`
- OBIMD main character UID: `gcl8bbz6jf`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+F4DE8; U+F4DE9; 另有 1 项
