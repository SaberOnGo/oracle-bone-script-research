# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004370
...
- EVOBC candidate category: `evobc-evo-cat-04370`.
- Source label for search only: `歍`.
- Source codepoints for search only: `U+6B4D`.
