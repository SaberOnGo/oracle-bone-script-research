# obs-unk-004344 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004344`
- primary external id: `hust-obc-und-L-004344`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/044_obs-unk-004344_h
  ust-obc-und-L-004344_oracle-character-candidate/03_visual-assets/001_asset
  -005937_hust-obc-und-L-004344_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4344/L_？_9623.jpg`
- asset id: `asset-005937`
...
- source class: `HUST-OBC/undeciphered/L/4344/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4344/L_？_9623.jpg`
- asset id: `asset-005937`
...
- English observation: `Central vertical trace and middle crossing recorded.`
- 中文观察: `已记录中央纵向痕迹和中部交叉痕。`
...
- Which source records identify obs-unk-004344 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004344？
