# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012776
...
- EVOBC candidate category: `evobc-evo-cat-12776`.
- Source label for search only: `𪔿`.
- Source codepoints for search only: `U+2A53F`.
