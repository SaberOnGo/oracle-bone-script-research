...
- `obs-evo-cand-001833-route-category-staging`
...
- `obs-evo-cand-001833-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001833-route-evolution-graph`
