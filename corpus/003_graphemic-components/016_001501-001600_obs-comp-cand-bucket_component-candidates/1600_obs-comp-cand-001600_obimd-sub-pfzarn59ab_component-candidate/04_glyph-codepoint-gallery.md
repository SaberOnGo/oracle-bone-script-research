# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001600
...
| --- | --- | --- | --- |
| `obimd-glyph-link-024923` | 򡭯󹕳 | `U+A1B6F;U+F9573` | `reviewed_metadata_only` |
| `obimd-glyph-link-024924` | 󹕴 | `U+F9574` | `reviewed_metadata_only` |
| `obimd-glyph-link-024925` | 󹕵 | `U+F9575` | `reviewed_metadata_only` |
| `obimd-glyph-link-024926` | 󹕶 | `U+F9576` | `reviewed_metadata_only` |
