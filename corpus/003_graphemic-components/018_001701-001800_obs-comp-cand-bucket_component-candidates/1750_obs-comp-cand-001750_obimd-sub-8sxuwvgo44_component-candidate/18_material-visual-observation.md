# Material Visual Observation / obs-comp-cand-001750 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001750`
- External reference / 外部参照: `obimd-sub-8sxuwvgo44`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017951_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8sxuwvgo44/8sxuwvgo44/8sxuwvgo44.png`
- Checksum / 校验和:
  `76cef9d4383237a91b92cf3b68c90d9e00d18350de353cc1dafe6f99182e3914`
...
- Marked-pixel bounds: (87,19)–(159,230); span 73 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.06%。
- 痕迹范围：(87,19)–(159,230)；跨度73 × 212 px；痕迹矩形高于宽。
