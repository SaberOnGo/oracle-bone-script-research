...
- External category reference: `evobc-cat-07904`
- Source category ID: `07904`
- Source label for human review: `衎`
- Source codepoints: `U+884E`
...
- `obs-evo-cand-007904-route-category-staging`
...
- `obs-evo-cand-007904-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007904-route-evolution-graph`
