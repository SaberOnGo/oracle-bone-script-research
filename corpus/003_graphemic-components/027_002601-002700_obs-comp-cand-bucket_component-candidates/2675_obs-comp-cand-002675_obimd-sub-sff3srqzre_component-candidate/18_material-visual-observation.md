# Material Visual Observation / obs-comp-cand-002675 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002675`
- External reference / 外部参照: `obimd-sub-sff3srqzre`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021251_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/sff3srqzre/sff3srqzre/sff3srqzre.png`
- Checksum / 校验和:
  `36bb6d29bc577c205ce49a94b30a30d778b0a694f6971eccc45d56829e2e473f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.78%.
- Marked-pixel bounds: (85,20)–(171,229); span 87 × 210 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.78%。
- 痕迹范围：(85,20)–(171,229)；跨度87 × 210 px；痕迹矩形高于宽。
