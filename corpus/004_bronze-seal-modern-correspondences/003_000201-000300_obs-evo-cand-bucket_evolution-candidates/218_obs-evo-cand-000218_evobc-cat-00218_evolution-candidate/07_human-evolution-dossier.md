...
Project ID: `obs-evo-cand-000218`
...
- Project ID: `obs-evo-cand-000218`
- EVOBC category candidate ID: `evobc-evo-cat-00218`
- External category reference: `evobc-cat-00218`
- Source category ID: `00218`
- Source label for human review: `㵴`
- Source codepoints: `U+3D74`
...
- `obs-evo-cand-000218-route-category-staging`
...
- `obs-evo-cand-000218-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000218-route-evolution-graph`
