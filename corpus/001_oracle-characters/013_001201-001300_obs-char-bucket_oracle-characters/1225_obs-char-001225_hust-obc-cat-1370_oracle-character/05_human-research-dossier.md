# obs-char-001225 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1225_obs-char-001225_hust-obc-cat-1370_ora
  cle-character/03_visual-assets/001_asset-001230_hust-obc-cat-1370_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1370/L_1370_13471.jpg`
- asset id: `asset-001230`
...
- source category: `1370`
- validation class: `1224`
- source image route: `HUST-OBC/deciphered/1370/L_1370_13471.jpg`
- asset id: `asset-001230`
...
- English observation: `A faint compact cluster has two detached upper
  marks, a dense central lower form, and low contrast.`
- 中文观察: `较淡的紧凑笔群有两个分离上部痕迹、密集中央下部形体，图像对比度较低。`
...
- dataset label text: `㥐`
- dataset label codepoints: `U+3950`
...
- Which source records identify obs-char-001225 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001225？
