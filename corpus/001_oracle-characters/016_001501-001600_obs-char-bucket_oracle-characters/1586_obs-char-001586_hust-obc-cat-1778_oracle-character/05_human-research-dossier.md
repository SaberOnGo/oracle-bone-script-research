# obs-char-001586 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001586`
- primary external id: `hust-obc-cat-1778`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1586_obs-char-001586_hust-obc-cat-1778_ora
  cle-character/03_visual-assets/001_asset-001591_hust-obc-cat-1778_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1778/X_1778_5800_1.png`
- asset id: `asset-001591`
...
- source category: `1778`
- validation class: `1585`
- source image route: `HUST-OBC/deciphered/1778/X_1778_5800_1.png`
- asset id: `asset-001591`
...
- English observation: `A dark composite has a broad upper bar, a large
  lower opening, and a long right contour.`
- 中文观察: `深色组合形体有宽大上横笔、大型下部开口和右侧长轮廓。`
...
- dataset label text: `㫨`
- dataset label codepoints: `U+3AE8`
...
- Which source records identify obs-char-001586 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001586？
