...
Project ID: `obs-evo-cand-006104`
...
- Project ID: `obs-evo-cand-006104`
- EVOBC category candidate ID: `evobc-evo-cat-06104`
- External category reference: `evobc-cat-06104`
- Source category ID: `06104`
- Source label for human review: `稟`
- Source codepoints: `U+7A1F`
...
- `obs-evo-cand-006104-route-category-staging`
...
- `obs-evo-cand-006104-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006104-route-evolution-graph`
