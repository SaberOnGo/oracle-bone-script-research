# obs-char-000179 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/179_obs-char-000179_hust-obc-cat-0198_orac
  le-character/03_visual-assets/001_asset-000184_hust-obc-cat-0198_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0198/X_0198_3694_1.png`
- asset id: `asset-000184`
...
- source category: `0198`
- validation class: `178`
- source image route: `HUST-OBC/deciphered/0198/X_0198_3694_1.png`
- asset id: `asset-000184`
...
- English observation: `The large dark image has a heavy upper horizontal
  bar, two long side strokes, a central angular crossing form, and a small
  detached dot.`
...
- dataset label text: `㒼`
- dataset label codepoints: `U+34BC`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00018`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00018`
- EvoBC image reference count / EvoBC 图像引用数: `9`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00018`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/018_obs-evo-can
  d-000018_evobc-cat-00018_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/018_obs-evo-cand-000018_evobc-cat-00018_evolu
...
- Which source records identify obs-char-000179 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000179？
