...
- `obs-evo-cand-006257-route-category-staging`
...
- `obs-evo-cand-006257-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006257-route-evolution-graph`
