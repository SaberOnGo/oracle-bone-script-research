# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006258
...
- EVOBC candidate category: `evobc-evo-cat-06258`.
- Source label for search only: `筋`.
- Source codepoints for search only: `U+7B4B`.
