...
- Project ID: `obs-evo-cand-011007`
- EVOBC category candidate ID: `evobc-evo-cat-11007`
- External category reference: `evobc-cat-11007`
- Source category ID: `11007`
- Source label for human review: `𡒅`
- Source codepoints: `U+21485`
...
- `obs-evo-cand-011007-route-category-staging`
...
- `obs-evo-cand-011007-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011007-route-evolution-graph`
