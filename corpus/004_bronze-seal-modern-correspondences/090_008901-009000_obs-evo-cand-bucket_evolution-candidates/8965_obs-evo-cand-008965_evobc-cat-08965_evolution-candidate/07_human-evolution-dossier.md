...
- External category reference: `evobc-cat-08965`
- Source category ID: `08965`
- Source label for human review: `迭`
- Source codepoints: `U+8FED`
...
- `obs-evo-cand-008965-route-category-staging`
...
- `obs-evo-cand-008965-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008965-route-evolution-graph`
