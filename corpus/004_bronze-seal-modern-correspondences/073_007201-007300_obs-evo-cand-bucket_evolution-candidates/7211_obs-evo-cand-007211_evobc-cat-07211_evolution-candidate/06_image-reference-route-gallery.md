...
- `obs-evo-cand-007211-route-category-staging`
...
- `obs-evo-cand-007211-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007211-route-evolution-graph`
