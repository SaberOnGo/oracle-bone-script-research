...
- Project ID: `obs-evo-cand-007031`
- EVOBC category candidate ID: `evobc-evo-cat-07031`
- External category reference: `evobc-cat-07031`
- Source category ID: `07031`
- Source label for human review: `胛`
- Source codepoints: `U+80DB`
...
- `obs-evo-cand-007031-route-category-staging`
...
- `obs-evo-cand-007031-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007031-route-evolution-graph`
