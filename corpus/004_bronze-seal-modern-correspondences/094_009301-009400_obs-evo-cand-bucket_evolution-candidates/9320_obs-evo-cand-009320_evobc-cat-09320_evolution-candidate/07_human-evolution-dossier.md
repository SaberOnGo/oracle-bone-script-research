...
- External category reference: `evobc-cat-09320`
- Source category ID: `09320`
- Source label for human review: `釵`
...
- `obs-evo-cand-009320-route-category-staging`
...
- `obs-evo-cand-009320-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009320-route-evolution-graph`
