# obs-unk-004965 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/065_obs-unk-004965_h
  ust-obc-und-X-004965_oracle-character-candidate/03_visual-assets/001_asset
  -006558_hust-obc-und-X-004965_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/521/X_？_7502_1.png`
- asset id: `asset-006558`
...
- Rounded forms, a tall right stroke, and lower openings are visible.
...
- source class: `HUST-OBC/undeciphered/X/521/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/521/X_？_7502_1.png`
- asset id: `asset-006558`
...
- Which source records identify obs-unk-004965 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004965？
