...
- External category reference: `evobc-cat-13160`
- Source category ID: `13160`
- Source label for human review: `𫻹`
...
- `obs-evo-cand-013160-route-category-staging`
...
- `obs-evo-cand-013160-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013160-route-evolution-graph`
