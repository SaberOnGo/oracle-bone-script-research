...
- External category reference: `evobc-cat-03793`
- Source category ID: `03793`
- Source label for human review: `曆`
...
- `obs-evo-cand-003793-route-category-staging`
...
- `obs-evo-cand-003793-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003793-route-evolution-graph`
