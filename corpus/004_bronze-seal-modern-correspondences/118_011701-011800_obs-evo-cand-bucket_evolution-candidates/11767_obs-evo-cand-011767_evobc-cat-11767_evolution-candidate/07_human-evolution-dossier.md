...
- External category reference: `evobc-cat-11767`
- Source category ID: `11767`
- Source label for human review: `𥃡`
- Source codepoints: `U+250E1`
...
- `obs-evo-cand-011767-route-category-staging`
...
- `obs-evo-cand-011767-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011767-route-evolution-graph`
