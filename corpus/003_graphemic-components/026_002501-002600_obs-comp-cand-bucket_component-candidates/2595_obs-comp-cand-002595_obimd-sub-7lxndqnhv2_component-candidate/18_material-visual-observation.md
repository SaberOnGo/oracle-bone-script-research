# Material Visual Observation / obs-comp-cand-002595 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002595`
- External reference / 外部参照: `obimd-sub-7lxndqnhv2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021134_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7lxndqnhv2/7lxndqnhv2/7lxndqnhv2.png`
- Checksum / 校验和:
  `4c7be02688a127d63ff55cc49fd63c3cf2cc7d2eb0c8632966ecd7c6c4dc0cd2`
...
- Marked-pixel bounds: (69,25)–(169,223); span 101 × 199 px; the marked
...
- 痕迹范围：(69,25)–(169,223)；跨度101 × 199 px；痕迹矩形高于宽。
