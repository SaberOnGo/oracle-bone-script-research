...
Project ID: `obs-evo-cand-007861`
...
- Project ID: `obs-evo-cand-007861`
- EVOBC category candidate ID: `evobc-evo-cat-07861`
- External category reference: `evobc-cat-07861`
- Source category ID: `07861`
- Source label for human review: `蟫`
- Source codepoints: `U+87EB`
...
- `obs-evo-cand-007861-route-category-staging`
...
- `obs-evo-cand-007861-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007861-route-evolution-graph`
