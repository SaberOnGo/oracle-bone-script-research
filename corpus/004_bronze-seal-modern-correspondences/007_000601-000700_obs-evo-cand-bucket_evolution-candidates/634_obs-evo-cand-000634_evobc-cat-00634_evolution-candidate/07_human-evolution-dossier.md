...
- Project ID: `obs-evo-cand-000634`
- EVOBC category candidate ID: `evobc-evo-cat-00634`
- External category reference: `evobc-cat-00634`
- Source category ID: `00634`
- Source label for human review: `丬`
- Source codepoints: `U+4E2C`
...
- `obs-evo-cand-000634-route-category-staging`
...
- `obs-evo-cand-000634-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000634-route-evolution-graph`
