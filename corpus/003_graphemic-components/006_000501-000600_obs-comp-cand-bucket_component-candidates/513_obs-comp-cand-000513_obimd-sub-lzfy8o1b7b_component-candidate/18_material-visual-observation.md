# Material Visual Observation / obs-comp-cand-000513 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000513`
- External reference / 外部参照: `obimd-sub-lzfy8o1b7b`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012748_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lzfy8o1b7b/lzfy8o1b7b/lzfy8o1b7b.png`
- Checksum / 校验和:
  `3503e31f7c44da64e4b954edbcb24a602673454fad959c676e6efa28b973a678`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 14.46%.
- Marked-pixel bounds: (57,19)–(188,231); span 132 × 213 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占14.46%。
- 痕迹范围：(57,19)–(188,231)；跨度132 × 213 px；痕迹矩形高于宽。
