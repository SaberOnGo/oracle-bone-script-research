# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002402
...
- EVOBC candidate category: `evobc-evo-cat-02402`.
- Source label for search only: `宽`.
- Source codepoints for search only: `U+5BBD`.
