...
- External category reference: `evobc-cat-02884`
- Source category ID: `02884`
- Source label for human review: `徬`
...
- `obs-evo-cand-002884-route-category-staging`
...
- `obs-evo-cand-002884-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002884-route-evolution-graph`
