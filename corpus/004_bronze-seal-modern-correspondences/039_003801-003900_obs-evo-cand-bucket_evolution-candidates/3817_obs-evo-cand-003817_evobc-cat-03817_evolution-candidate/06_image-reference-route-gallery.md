...
- `obs-evo-cand-003817-route-category-staging`
...
- `obs-evo-cand-003817-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003817-route-evolution-graph`
