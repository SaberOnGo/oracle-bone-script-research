# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-000091
...
- candidate_component_id: `obs-comp-cand-000091`
- primary_external_ref_id: `obimd-sub-zssbtvgekq`
- source_subcharacter_uid: `zssbtvgekq`
...
- glyph_codepoint_uplus_sample: `U+F08DD, U+F08DE`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-011503` | `001_asset-011503_img.png` | `10fd5b50f5370b071d3fa6d6f1ffce610d69a4027015a0b0fa3aa37d0caffc13` |
