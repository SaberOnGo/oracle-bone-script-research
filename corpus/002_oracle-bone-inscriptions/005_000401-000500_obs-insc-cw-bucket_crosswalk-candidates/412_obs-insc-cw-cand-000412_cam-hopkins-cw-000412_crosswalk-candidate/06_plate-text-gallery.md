...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000412` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2214` [route_present_image_or_text_not_collected]
...
- `chalfant_reference`: Chalfant reference `32` [route_present_image_or_text_not_collected]
