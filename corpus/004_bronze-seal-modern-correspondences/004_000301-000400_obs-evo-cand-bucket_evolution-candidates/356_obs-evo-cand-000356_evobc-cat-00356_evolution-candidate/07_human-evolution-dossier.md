...
- Project ID: `obs-evo-cand-000356`
- EVOBC category candidate ID: `evobc-evo-cat-00356`
- External category reference: `evobc-cat-00356`
- Source category ID: `00356`
- Source label for human review: `䏧`
- Source codepoints: `U+43E7`
...
- `obs-evo-cand-000356-route-category-staging`
...
- `obs-evo-cand-000356-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000356-route-evolution-graph`
