...
- External category reference: `evobc-cat-05491`
- Source category ID: `05491`
- Source label for human review: `瓄`
...
- `obs-evo-cand-005491-route-category-staging`
...
- `obs-evo-cand-005491-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005491-route-evolution-graph`
