# obs-unk-004661 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004661`
- primary external id: `hust-obc-und-X-004661`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/061_obs-unk-004661_h
  ust-obc-und-X-004661_oracle-character-candidate/03_visual-assets/001_asset
  -006254_hust-obc-und-X-004661_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/217/X_？_8388_1.png`
- asset id: `asset-006254`
...
- source class: `HUST-OBC/undeciphered/X/217/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/217/X_？_8388_1.png`
- asset id: `asset-006254`
...
- English observation: `tapered contour with upper rectangular loop`
- 中文观察: `带上部矩形环的渐收轮廓`
...
- Which source records identify obs-unk-004661 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004661？
