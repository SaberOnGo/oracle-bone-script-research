...
- External category reference: `evobc-cat-03306`
- Source category ID: `03306`
- Source label for human review: `拈`
...
- `obs-evo-cand-003306-route-category-staging`
...
- `obs-evo-cand-003306-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003306-route-evolution-graph`
