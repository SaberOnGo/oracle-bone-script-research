# obs-char-000494 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000494`
- primary external id: `hust-obc-cat-0561`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/494_obs-char-000494_hust-obc-cat-0561_orac
  le-character/03_visual-assets/001_asset-000499_hust-obc-cat-0561_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0561/X_0561_3658_1.png`
- asset id: `asset-000499`
...
- source category: `0561`
- validation class: `493`
- source image route: `HUST-OBC/deciphered/0561/X_0561_3658_1.png`
- asset id: `asset-000499`
...
- dataset label text: `㘧`
- dataset label codepoints: `U+3627`
...
- Which source records identify obs-char-000494 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000494？
