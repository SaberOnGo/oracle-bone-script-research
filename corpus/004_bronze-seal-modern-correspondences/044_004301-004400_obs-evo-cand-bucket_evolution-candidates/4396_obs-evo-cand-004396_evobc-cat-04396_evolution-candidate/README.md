# obs-evo-cand-004396 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-04396`
- Source label: `歲`
- Source codepoints: `U+6B72`
- Image reference count: `395`
- Era token counts: `BI:31;CS:1;OBC:149;SAC:16;SS:1;WSC:197`
- Source token counts: `Book:105;Web:290`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 149 image references
- era 1 / BI: 31 image references
- era 2 / SS: 1 image references
- era 3 / SAC: 16 image references
- era 4 / WSC: 197 image references
- era 5 / CS: 1 image references
- source 0 / Web:1633: 3 image references
- source 1 / Web:105952;說文Web:58: 245 image references
