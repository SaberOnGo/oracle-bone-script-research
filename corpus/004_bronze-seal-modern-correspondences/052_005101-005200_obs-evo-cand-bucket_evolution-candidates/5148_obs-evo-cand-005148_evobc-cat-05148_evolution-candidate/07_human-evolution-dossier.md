...
- External category reference: `evobc-cat-05148`
- Source category ID: `05148`
- Source label for human review: `燋`
- Source codepoints: `U+71CB`
...
- `obs-evo-cand-005148-route-category-staging`
...
- `obs-evo-cand-005148-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005148-route-evolution-graph`
