...
- External category reference: `evobc-cat-07335`
- Source category ID: `07335`
- Source label for human review: `荀`
...
- `obs-evo-cand-007335-route-category-staging`
...
- `obs-evo-cand-007335-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007335-route-evolution-graph`
