# obs-evo-cand-002819 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-02819`
- Source label for human review: `弼`
- Source codepoints: `U+5F3C`
- Image reference count: `32`
- Era token counts: `BI:8;SS:1;WSC:23`
- Source token counts: `Book:14;Web:18`
