# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002762
...
- EVOBC candidate category: `evobc-evo-cat-02762`.
- Source label for search only: `廞`.
- Source codepoints for search only: `U+5EDE`.
