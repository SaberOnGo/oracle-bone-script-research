...
Project ID: `obs-evo-cand-009830`
...
- Project ID: `obs-evo-cand-009830`
- EVOBC category candidate ID: `evobc-evo-cat-09830`
- External category reference: `evobc-cat-09830`
- Source category ID: `09830`
- Source label for human review: `離`
- Source codepoints: `U+96E2`
...
- `obs-evo-cand-009830-route-category-staging`
...
- `obs-evo-cand-009830-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009830-route-evolution-graph`
