# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003201
...
- EVOBC candidate category: `evobc-evo-cat-03201`.
- Source label for search only: `戌`.
- Source codepoints for search only: `U+620C`.
