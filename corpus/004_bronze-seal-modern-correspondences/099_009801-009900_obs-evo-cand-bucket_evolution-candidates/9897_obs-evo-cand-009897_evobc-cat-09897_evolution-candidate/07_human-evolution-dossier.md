...
- Project ID: `obs-evo-cand-009897`
- EVOBC category candidate ID: `evobc-evo-cat-09897`
- External category reference: `evobc-cat-09897`
- Source category ID: `09897`
- Source label for human review: `靳`
- Source codepoints: `U+9773`
...
- `obs-evo-cand-009897-route-category-staging`
...
- `obs-evo-cand-009897-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009897-route-evolution-graph`
