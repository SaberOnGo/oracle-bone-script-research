...
- External category reference: `evobc-cat-04887`
- Source category ID: `04887`
- Source label: `漿`
...
- `obs-evo-cand-004887-route-category-staging`
...
- `obs-evo-cand-004887-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-004887-route-evolution-graph`
