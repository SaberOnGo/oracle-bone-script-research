...
- `obs-evo-cand-000845-route-category-staging`
...
- `obs-evo-cand-000845-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000845-route-evolution-graph`
