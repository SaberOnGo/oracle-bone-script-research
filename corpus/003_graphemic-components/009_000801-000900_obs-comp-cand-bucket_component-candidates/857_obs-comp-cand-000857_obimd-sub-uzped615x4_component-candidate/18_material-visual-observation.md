# Material Visual Observation / obs-comp-cand-000857 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000857`
- External reference / 外部参照: `obimd-sub-uzped615x4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013855_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/uzped615x4/uzped615x4/uzped615x4.png`
- Checksum / 校验和:
  `4e9f22e7f9a27abd148da6eeb45ded35e9b5899d8402c3d3c21f7d381cb153df`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.46%.
- Marked-pixel bounds: (62,19)–(190,228); span 129 × 210 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.46%。
- 痕迹范围：(62,19)–(190,228)；跨度129 × 210 px；痕迹矩形高于宽。
