...
- External category reference: `evobc-cat-11921`
- Source category ID: `11921`
- Source label for human review: `𥺳`
- Source codepoints: `U+25EB3`
...
- `obs-evo-cand-011921-route-category-staging`
...
- `obs-evo-cand-011921-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011921-route-evolution-graph`
