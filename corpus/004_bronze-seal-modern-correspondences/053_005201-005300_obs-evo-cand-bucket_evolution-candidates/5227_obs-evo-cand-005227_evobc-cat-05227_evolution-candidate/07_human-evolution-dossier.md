...
- Project ID: `obs-evo-cand-005227`
- EVOBC category candidate ID: `evobc-evo-cat-05227`
- External category reference: `evobc-cat-05227`
- Source category ID: `05227`
- Source label for human review: `犅`
- Source codepoints: `U+7285`
...
- `obs-evo-cand-005227-route-category-staging`
...
- `obs-evo-cand-005227-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005227-route-evolution-graph`
