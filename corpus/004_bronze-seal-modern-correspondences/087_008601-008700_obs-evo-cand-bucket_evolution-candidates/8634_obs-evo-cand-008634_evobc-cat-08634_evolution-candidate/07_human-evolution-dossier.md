...
- External category reference: `evobc-cat-08634`
- Source category ID: `08634`
- Source label for human review: `费`
- Source codepoints: `U+8D39`
...
- `obs-evo-cand-008634-route-category-staging`
...
- `obs-evo-cand-008634-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008634-route-evolution-graph`
