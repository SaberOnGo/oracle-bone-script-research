...
Project ID: `obs-evo-cand-004814`
...
- Project ID: `obs-evo-cand-004814`
- EVOBC category candidate ID: `evobc-evo-cat-04814`
- External category reference: `evobc-cat-04814`
- Source category ID: `04814`
- Source label for human review: `溢`
- Source codepoints: `U+6EA2`
...
- `obs-evo-cand-004814-route-category-staging`
...
- `obs-evo-cand-004814-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004814-route-evolution-graph`
