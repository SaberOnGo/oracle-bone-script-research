# obs-unk-004492 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/092_obs-unk-004492_h
  ust-obc-und-X-004492_oracle-character-candidate/03_visual-assets/001_asset
  -006085_hust-obc-und-X-004492_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/48/X_？_8229_1.png`
- asset id: `asset-006085`
...
- source class: `HUST-OBC/undeciphered/X/48/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/48/X_？_8229_1.png`
- asset id: `asset-006085`
...
- English observation: `The rounded base, two upright traces, inner openings,
  uneven upper ends, and rough raster edges are directly recorded.`
- 中文观察: `已直接记录圆弧基部、两条竖向痕迹、内部空白、上端差异和栅格粗糙边缘。`
...
- Which source records identify obs-unk-004492 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004492？
