# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-011091
...
- EVOBC candidate category: `evobc-evo-cat-11091`.
- Source label for search only: `𡭪`.
- Source codepoints for search only: `U+21B6A`.
