# obs-xwalk-cand-000570 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+367C` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-0646` | not reading |
