# obs-char-000940 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000940`
- primary external id: `hust-obc-cat-1057`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/940_obs-char-000940_hust-obc-cat-1057_orac
  le-character/03_visual-assets/001_asset-000945_hust-obc-cat-1057_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1057/X_1057_382_1.png`
- asset id: `asset-000945`
...
- source category: `1057`
- validation class: `939`
- source image route: `HUST-OBC/deciphered/1057/X_1057_382_1.png`
- asset id: `asset-000945`
...
- English observation: `A very large dark irregular cluster occupies the
  left and center, with a long separate curved stroke at right.`
- 中文观察: `大型深色不规则笔群占据左侧和中央，右侧另有一条长分离弯曲笔。`
...
- dataset label text: `㠗`
- dataset label codepoints: `U+3817`
...
- Which source records identify obs-char-000940 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000940？
