...
- External category reference: `evobc-cat-02273`
- Source category ID: `02273`
- Source label for human review: `嫥`
- Source codepoints: `U+5AE5`
...
- `obs-evo-cand-002273-route-category-staging`
...
- `obs-evo-cand-002273-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002273-route-evolution-graph`
