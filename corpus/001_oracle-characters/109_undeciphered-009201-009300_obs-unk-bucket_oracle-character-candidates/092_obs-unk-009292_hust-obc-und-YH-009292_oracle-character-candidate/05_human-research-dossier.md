# obs-unk-009292 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-009292`
- primary external id: `hust-obc-und-YH-009292`
...
- local review image route: `corpus/001_oracle-characters/109_undeciphered-009
  201-009300_obs-unk-bucket_oracle-character-candidates/092_obs-unk-009292_h
  ust-obc-und-YH-009292_oracle-character-candidate/03_visual-assets/001_asse
  t-010883_hust-obc-und-YH-009292_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/615F6/H_？_615F6_0.png`
- asset id: `asset-010883`
...
- source class: `HUST-OBC/undeciphered/Y+H/615F6/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/615F6/H_？_615F6_0.png`
- asset id: `asset-010883`
...
- Which source records identify obs-unk-009292 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009292？
