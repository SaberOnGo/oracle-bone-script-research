...
- External category reference: `evobc-cat-10357`
- Source category ID: `10357`
- Source label for human review: `魁`
- Source codepoints: `U+9B41`
...
- `obs-evo-cand-010357-route-category-staging`
...
- `obs-evo-cand-010357-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010357-route-evolution-graph`
