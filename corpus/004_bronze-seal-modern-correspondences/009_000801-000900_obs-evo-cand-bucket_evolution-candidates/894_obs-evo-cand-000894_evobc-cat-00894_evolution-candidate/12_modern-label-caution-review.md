# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000894
...
- EVOBC candidate category: `evobc-evo-cat-00894`.
- Source label for search only: `保`.
- Source codepoints for search only: `U+4FDD`.
