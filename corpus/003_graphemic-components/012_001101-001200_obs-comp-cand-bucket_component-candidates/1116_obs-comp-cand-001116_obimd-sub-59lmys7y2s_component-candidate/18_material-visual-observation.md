# Material Visual Observation / obs-comp-cand-001116 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001116`
- External reference / 外部参照: `obimd-sub-59lmys7y2s`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015057_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/59lmys7y2s/59lmys7y2s/59lmys7y2s.png`
- Checksum / 校验和:
  `35cc0febefb96b774618af89740f15546c212a3a6ea34b345ee19c5cc427cb90`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.32%.
- Marked-pixel bounds: (77,27)–(184,222); span 108 × 196 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.32%。
- 痕迹范围：(77,27)–(184,222)；跨度108 × 196 px；痕迹矩形高于宽。
