# obs-unk-007766 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-007766`
- primary external id: `hust-obc-und-YH-007766`
...
- local review image route: `corpus/001_oracle-characters/094_undeciphered-007
  701-007800_obs-unk-bucket_oracle-character-candidates/066_obs-unk-007766_h
  ust-obc-und-YH-007766_oracle-character-candidate/03_visual-assets/001_asse
  t-009357_hust-obc-und-YH-007766_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/602F8/Y_？_602F8.jpg`
- asset id: `asset-009357`
...
- source class: `HUST-OBC/undeciphered/Y+H/602F8/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/602F8/Y_？_602F8.jpg`
- asset id: `asset-009357`
...
- Which source records identify obs-unk-007766 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007766？
