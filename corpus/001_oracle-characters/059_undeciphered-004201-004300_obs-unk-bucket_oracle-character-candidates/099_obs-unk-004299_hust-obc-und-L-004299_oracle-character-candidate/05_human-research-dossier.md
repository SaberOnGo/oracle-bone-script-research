# obs-unk-004299 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004299`
- primary external id: `hust-obc-und-L-004299`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/099_obs-unk-004299_h
  ust-obc-und-L-004299_oracle-character-candidate/03_visual-assets/001_asset
  -005892_hust-obc-und-L-004299_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4299/L_？_9490.jpg`
- asset id: `asset-005892`
...
- source class: `HUST-OBC/undeciphered/L/4299/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4299/L_？_9490.jpg`
- asset id: `asset-005892`
...
- Which source records identify obs-unk-004299 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004299？
