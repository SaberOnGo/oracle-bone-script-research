# obs-char-000169 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000169`
- primary external id: `hust-obc-cat-0185`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/169_obs-char-000169_hust-obc-cat-0185_orac
  le-character/03_visual-assets/001_asset-000174_hust-obc-cat-0185_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0185/L_0185_8500.jpg`
- asset id: `asset-000174`
...
- source category: `0185`
- validation class: `168`
- source image route: `HUST-OBC/deciphered/0185/L_0185_8500.jpg`
- asset id: `asset-000174`
...
- English observation: `The narrow image has a long central descending
  stroke with short horizontal and diagonal branches extending to the left
  near the upper half.`
...
- dataset label text: `㒯`
- dataset label codepoints: `U+34AF`
...
- Which source records identify obs-char-000169 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000169？
