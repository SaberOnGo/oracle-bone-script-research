# obs-unk-004574 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004574`
- primary external id: `hust-obc-und-X-004574`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/074_obs-unk-004574_h
  ust-obc-und-X-004574_oracle-character-candidate/03_visual-assets/001_asset
  -006167_hust-obc-und-X-004574_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/130/X_？_8309_1.png`
- asset id: `asset-006167`
...
- source class: `HUST-OBC/undeciphered/X/130/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/130/X_？_8309_1.png`
- asset id: `asset-006167`
...
- English observation: `Upper crossing and three unequal lower branches`
  `recorded.`
- 中文观察: `已记录上部交叉和三条长度不等的下部分支。`
...
- Which source records identify obs-unk-004574 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004574？
