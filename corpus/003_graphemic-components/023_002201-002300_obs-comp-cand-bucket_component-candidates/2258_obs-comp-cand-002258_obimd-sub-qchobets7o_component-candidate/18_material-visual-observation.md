# Material Visual Observation / obs-comp-cand-002258 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002258`
- External reference / 外部参照: `obimd-sub-qchobets7o`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020071_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0yj8abtf8t/qchobets7o/qchobets7o.png`
- Checksum / 校验和:
  `6c5c3c8ee0cdf40c36e6b8dcced020b4534cb3a864a80bd49d6904816d72aee7`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.32%.
- Marked-pixel bounds: (78,31)–(174,219); span 97 × 189 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.32%。
- 痕迹范围：(78,31)–(174,219)；跨度97 × 189 px；痕迹矩形高于宽。
