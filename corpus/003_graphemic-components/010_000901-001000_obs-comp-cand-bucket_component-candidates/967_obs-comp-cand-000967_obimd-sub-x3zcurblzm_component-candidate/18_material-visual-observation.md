# Material Visual Observation / obs-comp-cand-000967 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000967`
- External reference / 外部参照: `obimd-sub-x3zcurblzm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014050_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/x3zcurblzm/x3zcurblzm/x3zcurblzm.png`
- Checksum / 校验和:
  `05c0ba189bac6caf3e8256816ef9a04fdd130f64512218cf59b64ba99df55745`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.53%.
- Marked-pixel bounds: (58,33)–(208,209); span 151 × 177 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.53%。
- 痕迹范围：(58,33)–(208,209)；跨度151 × 177 px；痕迹矩形近方形。
