...
Project ID: `obs-evo-cand-003452`
...
- Project ID: `obs-evo-cand-003452`
- EVOBC category candidate ID: `evobc-evo-cat-03452`
- External category reference: `evobc-cat-03452`
- Source category ID: `03452`
- Source label for human review: `搔`
- Source codepoints: `U+6414`
...
- `obs-evo-cand-003452-route-category-staging`
...
- `obs-evo-cand-003452-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003452-route-evolution-graph`
