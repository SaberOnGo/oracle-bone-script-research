...
- External category reference: `evobc-cat-09172`
- Source category ID: `09172`
- Source label: `郿`
...
- `obs-evo-cand-009172-route-category-staging`
...
- `obs-evo-cand-009172-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009172-route-evolution-graph`
