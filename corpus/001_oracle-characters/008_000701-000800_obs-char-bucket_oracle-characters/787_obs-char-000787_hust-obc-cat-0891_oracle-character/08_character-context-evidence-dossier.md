...
- Project ID / 项目 ID: `obs-char-000787`
- Primary external ID / 首选外部 ID: `hust-obc-cat-0891`
...
- Source image / 来源图: `G_0891_合36746黃組.png`
- Image / 图像: `001_asset-000792_hust-obc-cat-0891_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合36746
  (G_0891_合36746黃組.png)`
...
- target node: `evobc-evo-cat-00076`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC image references / EvoBC 图像引用数: `18`
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/076_obs-evo-cand-000076_evobc-cat-00076_evoluti
...
- Source label text / 来源标签文字: `㝱`
- Source label codepoint / 来源标签 codepoint: `U+3771`
