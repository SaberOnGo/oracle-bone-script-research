# Material Visual Observation / obs-comp-cand-001419 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001419`
- External reference / 外部参照: `obimd-sub-v2nizai7hr`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015838_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/v2nizai7hr/v2nizai7hr/v2nizai7hr.png`
- Checksum / 校验和:
  `7393e460a287dcdc1c64c2f7a2e59519cd8c081743327b5b187aebf817de388f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.67%.
- Marked-pixel bounds: (74,19)–(186,230); span 113 × 212 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.67%。
- 痕迹范围：(74,19)–(186,230)；跨度113 × 212 px；痕迹矩形高于宽。
