...
- External category reference: `evobc-cat-11854`
- Source category ID: `11854`
- Source label for human review: `𥧱`
- Source codepoints: `U+259F1`
...
- `obs-evo-cand-011854-route-category-staging`
...
- `obs-evo-cand-011854-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011854-route-evolution-graph`
