...
- Project ID: `obs-evo-cand-000665`
- EVOBC category candidate ID: `evobc-evo-cat-00665`
- External category reference: `evobc-cat-00665`
- Source category ID: `00665`
- Source label for human review: `乘`
- Source codepoints: `U+4E58`
...
- `obs-evo-cand-000665-route-category-staging`
...
- `obs-evo-cand-000665-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000665-route-evolution-graph`
