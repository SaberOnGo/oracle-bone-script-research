# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002925
...
- EVOBC candidate category: `evobc-evo-cat-02925`.
- Source label for search only: `忽`.
- Source codepoints for search only: `U+5FFD`.
