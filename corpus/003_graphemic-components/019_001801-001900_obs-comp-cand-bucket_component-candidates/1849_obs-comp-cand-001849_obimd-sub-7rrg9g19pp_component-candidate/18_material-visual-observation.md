# Material Visual Observation / obs-comp-cand-001849 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001849`
- External reference / 外部参照: `obimd-sub-7rrg9g19pp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018210_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/mgs4xhu5g3/7rrg9g19pp/2djat6w4dx.png`
- Checksum / 校验和:
  `dfc0aaae259f620cbfb97fd2b45e8cf68e840135ccbf84803facb7d8f185c2ea`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.34%.
- Marked-pixel bounds: (81,40)–(168,203); span 88 × 164 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.34%。
- 痕迹范围：(81,40)–(168,203)；跨度88 × 164 px；痕迹矩形高于宽。
