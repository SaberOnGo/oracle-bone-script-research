...
- External category reference: `evobc-cat-12770`
- Source category ID: `12770`
- Source label: `𪔅`
...
- `obs-evo-cand-012770-route-category-staging`
...
- `obs-evo-cand-012770-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012770-route-evolution-graph`
