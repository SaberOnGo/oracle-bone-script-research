# Material Visual Observation / obs-comp-cand-001109 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001109`
- External reference / 外部参照: `obimd-sub-ho95nnufi7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015050_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ho95nnufi7/ho95nnufi7/ho95nnufi7.png`
- Checksum / 校验和:
  `fbf72944498aa1a81aa4f8ebd7b5cd4abfac6ad229537e87c297f63904a31f35`
...
- Marked-pixel bounds: (73,42)–(165,209); span 93 × 168 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.95%。
- 痕迹范围：(73,42)–(165,209)；跨度93 × 168 px；痕迹矩形高于宽。
