...
- External category reference: `evobc-cat-10428`
- Source category ID: `10428`
- Source label for human review: `鰌`
...
- `obs-evo-cand-010428-route-category-staging`
...
- `obs-evo-cand-010428-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010428-route-evolution-graph`
