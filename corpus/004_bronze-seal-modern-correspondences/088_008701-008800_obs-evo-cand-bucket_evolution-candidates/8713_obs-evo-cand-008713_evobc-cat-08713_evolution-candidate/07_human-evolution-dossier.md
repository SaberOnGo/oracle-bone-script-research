...
Project ID: `obs-evo-cand-008713`
...
- Project ID: `obs-evo-cand-008713`
- EVOBC category candidate ID: `evobc-evo-cat-08713`
- External category reference: `evobc-cat-08713`
- Source category ID: `08713`
- Source label for human review: `跚`
- Source codepoints: `U+8DDA`
...
- `obs-evo-cand-008713-route-category-staging`
...
- `obs-evo-cand-008713-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008713-route-evolution-graph`
