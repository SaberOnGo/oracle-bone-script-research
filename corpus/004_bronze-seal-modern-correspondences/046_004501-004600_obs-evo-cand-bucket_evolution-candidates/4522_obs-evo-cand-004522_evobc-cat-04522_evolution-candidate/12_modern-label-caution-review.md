# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004522
...
- EVOBC candidate category: `evobc-evo-cat-04522`.
- Source label for search only: `決`.
- Source codepoints for search only: `U+6C7A`.
