...
- External category reference: `evobc-cat-10352`
- Source category ID: `10352`
- Source label for human review: `鬹`
- Source codepoints: `U+9B39`
...
- `obs-evo-cand-010352-route-category-staging`
...
- `obs-evo-cand-010352-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010352-route-evolution-graph`
