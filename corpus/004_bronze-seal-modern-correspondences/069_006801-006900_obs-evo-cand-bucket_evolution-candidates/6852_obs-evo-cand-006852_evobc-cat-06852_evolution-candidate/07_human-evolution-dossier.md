...
Project ID: `obs-evo-cand-006852`
...
- Project ID: `obs-evo-cand-006852`
- EVOBC category candidate ID: `evobc-evo-cat-06852`
- External category reference: `evobc-cat-06852`
- Source category ID: `06852`
- Source label for human review: `羠`
- Source codepoints: `U+7FA0`
...
- `obs-evo-cand-006852-route-category-staging`
...
- `obs-evo-cand-006852-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006852-route-evolution-graph`
