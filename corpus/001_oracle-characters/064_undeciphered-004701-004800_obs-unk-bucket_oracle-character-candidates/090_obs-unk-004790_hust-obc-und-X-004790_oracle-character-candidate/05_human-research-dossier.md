# obs-unk-004790 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/090_obs-unk-004790_h
  ust-obc-und-X-004790_oracle-character-candidate/03_visual-assets/001_asset
  -006383_hust-obc-und-X-004790_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/346/X_？_7328_1.png`
- asset id: `asset-006383`
...
- source class: `HUST-OBC/undeciphered/X/346/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/346/X_？_7328_1.png`
- asset id: `asset-006383`
...
- English observation: `tall upper strokes, middle openings, and lower loop`
- 中文观察: `上部长笔画、中部开口和下部环状结构`
...
- Which source records identify obs-unk-004790 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004790？
