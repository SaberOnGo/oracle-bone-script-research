# obs-xwalk-cand-000033 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+341C` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-0038` | not reading |
