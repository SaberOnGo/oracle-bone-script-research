...
- External category reference: `evobc-cat-07345`
- Source category ID: `07345`
- Source label for human review: `荋`
...
- `obs-evo-cand-007345-route-category-staging`
...
- `obs-evo-cand-007345-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007345-route-evolution-graph`
