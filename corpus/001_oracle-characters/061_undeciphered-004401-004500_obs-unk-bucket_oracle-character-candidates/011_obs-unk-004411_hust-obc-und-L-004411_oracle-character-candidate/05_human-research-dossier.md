# obs-unk-004411 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/011_obs-unk-004411_h
  ust-obc-und-L-004411_oracle-character-candidate/03_visual-assets/001_asset
  -006004_hust-obc-und-L-004411_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4411/L_？_9866.jpg`
- asset id: `asset-006004`
...
- source class: `HUST-OBC/undeciphered/L/4411/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4411/L_？_9866.jpg`
- asset id: `asset-006004`
...
- English observation: `Two rounded upper marks sit above a thin stem and broad`
  `horizontal base.`
- 中文观察: `两处上部圆弧痕迹位于细纵痕和宽横向基线之上。`
...
- Which source records identify obs-unk-004411 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004411？
