...
- External category reference: `evobc-cat-02322`
- Source category ID: `02322`
- Source label for human review: `孌`
- Source codepoints: `U+5B4C`
...
- `obs-evo-cand-002322-route-category-staging`
...
- `obs-evo-cand-002322-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002322-route-evolution-graph`
