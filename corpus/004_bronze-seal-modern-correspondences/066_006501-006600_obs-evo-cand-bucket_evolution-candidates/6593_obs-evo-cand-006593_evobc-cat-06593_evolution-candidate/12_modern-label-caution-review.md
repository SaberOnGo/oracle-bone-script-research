# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006593
...
- EVOBC candidate category: `evobc-evo-cat-06593`.
- Source label for search only: `緜`.
- Source codepoints for search only: `U+7DDC`.
