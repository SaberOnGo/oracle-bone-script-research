# obs-unk-008297 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008297`
- primary external id: `hust-obc-und-YH-008297`
...
- local review image route: `corpus/001_oracle-characters/099_undeciphered-008
  201-008300_obs-unk-bucket_oracle-character-candidates/097_obs-unk-008297_h
  ust-obc-und-YH-008297_oracle-character-candidate/03_visual-assets/001_asse
  t-009888_hust-obc-und-YH-008297_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/609AD/H_？_609AD_0.png`
- asset id: `asset-009888`
...
- source class: `HUST-OBC/undeciphered/Y+H/609AD/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/609AD/H_？_609AD_0.png`
- asset id: `asset-009888`
...
- Which source records identify obs-unk-008297 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008297？
