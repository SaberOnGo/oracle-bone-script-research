# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013039
...
- EVOBC candidate category: `evobc-evo-cat-13039`.
- Source label for search only: `𫨊`.
- Source codepoints for search only: `U+2BA0A`.
