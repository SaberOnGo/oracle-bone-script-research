# obs-char-001060 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1060_obs-char-001060_hust-obc-cat-1187_ora
  cle-character/03_visual-assets/001_asset-001065_hust-obc-cat-1187_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1187/G_1187_乙1845合22025.png`
- asset id: `asset-001065`
...
- source category: `1187`
- validation class: `1059`
- source image route: `HUST-OBC/deciphered/1187/G_1187_乙1845合22025.png`
- asset id: `asset-001065`
...
- English observation: `A slender branching form has a slanted upper-left
  stroke, a central crossing, and a forked lower-right extension.`
- 中文观察: `纤细分枝形体有左上斜笔、中央交叉和右下分叉外伸。`
...
- dataset label text: `㢙`
- dataset label codepoints: `U+3899`
...
- filename catalog route clues: `Heji-like filename clue: 合22025
...
- Which source records identify obs-char-001060 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001060？
