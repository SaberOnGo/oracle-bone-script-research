...
- External category reference: `evobc-cat-09057`
- Source category ID: `09057`
- Source label for human review: `遲`
...
- `obs-evo-cand-009057-route-category-staging`
...
- `obs-evo-cand-009057-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009057-route-evolution-graph`
