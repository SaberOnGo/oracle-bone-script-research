...
- External category reference: `evobc-cat-02700`
- Source category ID: `02700`
- Source label for human review: `幹`
...
- `obs-evo-cand-002700-route-category-staging`
...
- `obs-evo-cand-002700-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002700-route-evolution-graph`
