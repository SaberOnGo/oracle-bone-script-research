# obs-comp-cand-002624 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002624`
- 首选外部 ID: `obimd-sub-kqep0e5n7r`
- OBIMD subcharacter UID: `kqep0e5n7r`
- OBIMD main character UID: `kqep0e5n7r`
- 来源 ID: `src-obimd`
...
- codepoint 示例: U+FECAD; U+FECAE; 另有 18 项
