# obs-char-000777 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000777`
- primary external id: `hust-obc-cat-0881`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/777_obs-char-000777_hust-obc-cat-0881_orac
  le-character/03_visual-assets/001_asset-000782_hust-obc-cat-0881_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0881/G_0881_甲骨文0.png`
- asset id: `asset-000782`
...
- source category: `0881`
- validation class: `776`
- source image route: `HUST-OBC/deciphered/0881/G_0881_甲骨文0.png`
- asset id: `asset-000782`
...
- dataset label text: `㝧`
- dataset label codepoints: `U+3767`
...
- Which source records identify obs-char-000777 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000777？
