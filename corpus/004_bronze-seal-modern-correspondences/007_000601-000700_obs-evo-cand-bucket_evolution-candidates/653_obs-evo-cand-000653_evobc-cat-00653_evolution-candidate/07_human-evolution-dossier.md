...
- External category reference: `evobc-cat-00653`
- Source category ID: `00653`
- Source label: `久`
...
- `obs-evo-cand-000653-route-category-staging`
...
- `obs-evo-cand-000653-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000653-route-evolution-graph`
