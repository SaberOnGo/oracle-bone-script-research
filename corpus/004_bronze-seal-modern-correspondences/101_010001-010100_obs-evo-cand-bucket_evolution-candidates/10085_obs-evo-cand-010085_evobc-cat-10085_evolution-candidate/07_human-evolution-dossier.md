...
- Project ID: `obs-evo-cand-010085`
- EVOBC category candidate ID: `evobc-evo-cat-10085`
- External category reference: `evobc-cat-10085`
- Source category ID: `10085`
- Source label for human review: `飪`
- Source codepoints: `U+98EA`
...
- `obs-evo-cand-010085-route-category-staging`
...
- `obs-evo-cand-010085-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010085-route-evolution-graph`
