...
- External category reference: `evobc-cat-12108`
- Source category ID: `12108`
- Source label for human review: `𦴜`
- Source codepoints: `U+26D1C`
...
- `obs-evo-cand-012108-route-category-staging`
...
- `obs-evo-cand-012108-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012108-route-evolution-graph`
