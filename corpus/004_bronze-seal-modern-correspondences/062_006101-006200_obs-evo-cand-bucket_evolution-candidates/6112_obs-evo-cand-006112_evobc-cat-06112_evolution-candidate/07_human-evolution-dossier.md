...
- External category reference: `evobc-cat-06112`
- Source category ID: `06112`
- Source label for human review: `稴`
- Source codepoints: `U+7A34`
...
- `obs-evo-cand-006112-route-category-staging`
...
- `obs-evo-cand-006112-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006112-route-evolution-graph`
