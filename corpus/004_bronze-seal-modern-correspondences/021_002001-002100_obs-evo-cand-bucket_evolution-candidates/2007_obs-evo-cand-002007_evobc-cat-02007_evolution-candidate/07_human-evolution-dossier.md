...
Project ID: `obs-evo-cand-002007`
...
- Project ID: `obs-evo-cand-002007`
- EVOBC category candidate ID: `evobc-evo-cat-02007`
- External category reference: `evobc-cat-02007`
- Source category ID: `02007`
- Source label for human review: `夥`
- Source codepoints: `U+5925`
...
- `obs-evo-cand-002007-route-category-staging`
...
- `obs-evo-cand-002007-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002007-route-evolution-graph`
