# obs-char-000625 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/625_obs-char-000625_hust-obc-cat-0710_orac
  le-character/03_visual-assets/001_asset-000630_hust-obc-cat-0710_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0710/G_0710_乙3774合3825.png`
- asset id: `asset-000630`
...
- source category: `0710`
- validation class: `624`
- source image route: `HUST-OBC/deciphered/0710/G_0710_乙3774合3825.png`
- asset id: `asset-000630`
...
- English observation: `A thin stepped vertical arrangement combines a short
  upper stem with several crossbars and a separate lower upright crossed by
  one long horizontal.`
...
- dataset label text: `㚼`
- dataset label codepoints: `U+36BC`
...
- filename catalog route clues: `Heji-like filename clue: 合3825
  (G_0710_乙3774合3825.png)`
...
- Which source records identify obs-char-000625 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000625？
