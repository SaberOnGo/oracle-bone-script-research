...
Project ID: `obs-evo-cand-004434`
...
- Project ID: `obs-evo-cand-004434`
- EVOBC category candidate ID: `evobc-evo-cat-04434`
- External category reference: `evobc-cat-04434`
- Source category ID: `04434`
- Source label for human review: `殿`
- Source codepoints: `U+6BBF`
...
- `obs-evo-cand-004434-route-category-staging`
...
- `obs-evo-cand-004434-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004434-route-evolution-graph`
