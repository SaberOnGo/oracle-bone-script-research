...
Project ID: `obs-evo-cand-004883`
...
- Project ID: `obs-evo-cand-004883`
- EVOBC category candidate ID: `evobc-evo-cat-04883`
- External category reference: `evobc-cat-04883`
- Source category ID: `04883`
- Source label for human review: `漹`
- Source codepoints: `U+6F39`
...
- `obs-evo-cand-004883-route-category-staging`
...
- `obs-evo-cand-004883-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004883-route-evolution-graph`
