# obs-char-000244 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000244`
- primary external id: `hust-obc-cat-0272`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/244_obs-char-000244_hust-obc-cat-0272_orac
  le-character/03_visual-assets/001_asset-000249_hust-obc-cat-0272_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0272/G_0272_乙7723合11697賓組.png`
- asset id: `asset-000249`
...
- source category: `0272`
- validation class: `243`
- source image route: `HUST-OBC/deciphered/0272/G_0272_乙7723合11697賓組.png`
- asset id: `asset-000249`
...
- English observation: `The narrow image has a curved left-side stem, a
  pointed upper turn, and two short diagonal strokes opening toward the
  right.`
- 中文观察: `狭长图像有弯曲左侧主干、尖状上转笔，并向右展开两道短斜笔。`
...
- dataset label text: `㔆`
- dataset label codepoints: `U+3506`
...
- filename catalog route clues: `Heji-like filename clue: 合11697
  (G_0272_乙7723合11697賓組.png)`
...
- Which source records identify obs-char-000244 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000244？
