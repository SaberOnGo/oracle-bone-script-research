...
- External category reference: `evobc-cat-12995`
- Source category ID: `12995`
- Source label: `𫡪`
...
- `obs-evo-cand-012995-route-category-staging`
...
- `obs-evo-cand-012995-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012995-route-evolution-graph`
