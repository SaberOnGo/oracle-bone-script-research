...
- Project ID: `obs-evo-cand-005049`
- EVOBC category candidate ID: `evobc-evo-cat-05049`
- External category reference: `evobc-cat-05049`
- Source category ID: `05049`
- Source label for human review: `炦`
- Source codepoints: `U+70A6`
...
- `obs-evo-cand-005049-route-category-staging`
...
- `obs-evo-cand-005049-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005049-route-evolution-graph`
