...
- `obs-evo-cand-010671-route-category-staging`
...
- `obs-evo-cand-010671-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010671-route-evolution-graph`
