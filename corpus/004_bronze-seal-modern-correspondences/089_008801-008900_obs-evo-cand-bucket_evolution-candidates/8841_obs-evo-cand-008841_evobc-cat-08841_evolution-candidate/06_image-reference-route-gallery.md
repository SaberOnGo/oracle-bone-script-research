...
- `obs-evo-cand-008841-route-category-staging`
...
- `obs-evo-cand-008841-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008841-route-evolution-graph`
