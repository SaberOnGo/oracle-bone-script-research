...
- External category reference: `evobc-cat-06518`
- Source category ID: `06518`
- Source label for human review: `絫`
- Source codepoints: `U+7D6B`
...
- `obs-evo-cand-006518-route-category-staging`
...
- `obs-evo-cand-006518-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006518-route-evolution-graph`
