...
- 本项目 ID：`obs-evo-cand-001550`
- EVOBC 候选类别 ID：`evobc-evo-cat-01550`
- 外部类别引用：`evobc-cat-01550`
- 来源类别 ID：`01550`
- 来源标签：`命`
- 来源 codepoints：`U+547D`
- EVOBC 图像引用数量：`265`
...
- era `4`
  token: `WSC`
  image references: 157
- era `5`
  token: `CS`
  image references: 1
- source `1`
  token: `Web:105952;說文Web:58`
  image references: 173
- source `3`
  token: `Book:21681`
  image references: 29
- source `4`
...
- `obs-evo-cand-001550-route-category-staging`
...
- `obs-evo-cand-001550-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001550-route-evolution-graph`
