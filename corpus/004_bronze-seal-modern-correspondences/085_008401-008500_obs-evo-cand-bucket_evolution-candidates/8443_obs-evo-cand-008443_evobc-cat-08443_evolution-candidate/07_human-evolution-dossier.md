...
- External category reference: `evobc-cat-08443`
- Source category ID: `08443`
- Source label for human review: `诺`
...
- `obs-evo-cand-008443-route-category-staging`
...
- `obs-evo-cand-008443-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008443-route-evolution-graph`
