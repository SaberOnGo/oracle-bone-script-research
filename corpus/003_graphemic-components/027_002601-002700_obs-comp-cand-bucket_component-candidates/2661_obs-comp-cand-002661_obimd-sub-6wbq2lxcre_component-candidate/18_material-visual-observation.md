# Material Visual Observation / obs-comp-cand-002661 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002661`
- External reference / 外部参照: `obimd-sub-6wbq2lxcre`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021237_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6wbq2lxcre/6wbq2lxcre/6wbq2lxcre.png`
- Checksum / 校验和:
  `cccb92a84e604f133a40f0c1119ea3e393578434a8251aa804cbaaeb0e777bcb`
...
- Marked-pixel bounds: (84,21)–(167,226); span 84 × 206 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.21%。
- 痕迹范围：(84,21)–(167,226)；跨度84 × 206 px；痕迹矩形高于宽。
