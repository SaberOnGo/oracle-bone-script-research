# obs-unk-008812 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008812`
- primary external id: `hust-obc-und-YH-008812`
...
- local review image route: `corpus/001_oracle-characters/105_undeciphered-008
  801-008900_obs-unk-bucket_oracle-character-candidates/012_obs-unk-008812_h
  ust-obc-und-YH-008812_oracle-character-candidate/03_visual-assets/001_asse
  t-010403_hust-obc-und-YH-008812_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60E43/H_？_60E43_0.png`
- asset id: `asset-010403`
...
- source class: `HUST-OBC/undeciphered/Y+H/60E43/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60E43/H_？_60E43_0.png`
- asset id: `asset-010403`
...
- Which source records identify obs-unk-008812 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008812？
