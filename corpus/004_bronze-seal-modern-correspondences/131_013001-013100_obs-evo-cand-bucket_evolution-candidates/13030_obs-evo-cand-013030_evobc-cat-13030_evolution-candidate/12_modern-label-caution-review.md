# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013030
...
- EVOBC candidate category: `evobc-evo-cat-13030`.
- Source label for search only: `𫧖`.
- Source codepoints for search only: `U+2B9D6`.
