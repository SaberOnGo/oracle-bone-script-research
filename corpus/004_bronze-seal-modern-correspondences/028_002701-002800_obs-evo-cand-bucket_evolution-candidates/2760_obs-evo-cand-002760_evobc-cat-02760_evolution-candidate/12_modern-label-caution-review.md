# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002760
...
- EVOBC candidate category: `evobc-evo-cat-02760`.
- Source label for search only: `廚`.
- Source codepoints for search only: `U+5EDA`.
