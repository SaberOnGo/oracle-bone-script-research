...
- External category reference: `evobc-cat-11857`
- Source category ID: `11857`
- Source label: `𥩛`
...
- `obs-evo-cand-011857-route-category-staging`
...
- `obs-evo-cand-011857-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011857-route-evolution-graph`
