# Human Research Readiness Review / 正式研究准备复核: obs-evo-cand-002743
...
- Source label for lookup only: `庸`.
- Source codepoints for lookup only: `U+5EB8`.
- Era/source code rows to open: `12`.
