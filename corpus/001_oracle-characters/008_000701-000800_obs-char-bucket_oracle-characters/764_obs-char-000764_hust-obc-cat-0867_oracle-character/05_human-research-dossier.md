# obs-char-000764 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/764_obs-char-000764_hust-obc-cat-0867_orac
  le-character/03_visual-assets/001_asset-000769_hust-obc-cat-0867_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0867/L_0867_1094.jpg`
- asset id: `asset-000769`
...
- source category: `0867`
- validation class: `763`
- source image route: `HUST-OBC/deciphered/0867/L_0867_1094.jpg`
- asset id: `asset-000769`
...
- English observation: `The tiny faint image shows a left angular crossing
  with several short branches beside a small bent right outline; fine joins
  and openings remain unclear.`
...
- dataset label text: `㝙`
- dataset label codepoints: `U+3759`
...
- Which source records identify obs-char-000764 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000764？
