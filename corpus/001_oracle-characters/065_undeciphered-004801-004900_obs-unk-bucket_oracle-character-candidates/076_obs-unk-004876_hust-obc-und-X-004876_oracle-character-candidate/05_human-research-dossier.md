# obs-unk-004876 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004876`
- primary external id: `hust-obc-und-X-004876`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/076_obs-unk-004876_h
  ust-obc-und-X-004876_oracle-character-candidate/03_visual-assets/001_asset
  -006469_hust-obc-und-X-004876_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/432/X_？_7415_1.png`
- asset id: `asset-006469`
...
- source class: `HUST-OBC/undeciphered/X/432/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/432/X_？_7415_1.png`
- asset id: `asset-006469`
...
- English observation: `upper angular group and rounded lower enclosure`
- 中文观察: `上部折角结构和圆钝下部外框`
...
- Which source records identify obs-unk-004876 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004876？
