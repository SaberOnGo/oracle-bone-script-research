# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008194
...
- EVOBC candidate category: `evobc-evo-cat-08194`.
- Source label for search only: `詪`.
- Source codepoints for search only: `U+8A6A`.
