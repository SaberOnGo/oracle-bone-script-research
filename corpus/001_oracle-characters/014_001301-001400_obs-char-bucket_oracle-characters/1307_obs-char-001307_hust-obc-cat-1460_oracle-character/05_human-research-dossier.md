# obs-char-001307 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1307_obs-char-001307_hust-obc-cat-1460_ora
  cle-character/03_visual-assets/001_asset-001312_hust-obc-cat-1460_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1460/G_1460_乙6768合438賓組.png`
- asset id: `asset-001312`
...
- source category: `1460`
- validation class: `1306`
- source image route: `HUST-OBC/deciphered/1460/G_1460_乙6768合438賓組.png`
- asset id: `asset-001312`
...
- English observation: `A narrow branching form has an upper crossing, a
  left inner curve, and a long descending outer stroke.`
- 中文观察: `狭长分枝形体有上部交叉笔、左侧内部弧线和长下行外侧笔画。`
...
- dataset label text: `㦪`
- dataset label codepoints: `U+39AA`
...
- filename catalog route clues: `Heji-like filename clue: 合438
...
- Which source records identify obs-char-001307 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001307？
