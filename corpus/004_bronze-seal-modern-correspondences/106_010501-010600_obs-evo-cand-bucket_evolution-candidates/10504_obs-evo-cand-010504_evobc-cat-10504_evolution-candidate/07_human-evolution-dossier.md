...
Project ID: `obs-evo-cand-010504`
...
- Project ID: `obs-evo-cand-010504`
- EVOBC category candidate ID: `evobc-evo-cat-10504`
- External category reference: `evobc-cat-10504`
- Source category ID: `10504`
- Source label for human review: `鴻`
- Source codepoints: `U+9D3B`
...
- `obs-evo-cand-010504-route-category-staging`
...
- `obs-evo-cand-010504-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010504-route-evolution-graph`
