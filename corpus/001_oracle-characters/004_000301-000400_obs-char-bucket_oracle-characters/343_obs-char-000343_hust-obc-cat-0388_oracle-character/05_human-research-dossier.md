# obs-char-000343 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000343`
- primary external id: `hust-obc-cat-0388`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/343_obs-char-000343_hust-obc-cat-0388_orac
  le-character/03_visual-assets/001_asset-000348_hust-obc-cat-0388_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0388/G_0388_中大35.png`
- asset id: `asset-000348`
...
- source category: `0388`
- validation class: `342`
- source image route: `HUST-OBC/deciphered/0388/G_0388_中大35.png`
- asset id: `asset-000348`
...
- English observation: `The tall rectangular frame contains a central
  diamond-like enclosure and short horizontal divisions.`
- 中文观察: `高直方形框架内部有中部菱状闭合轮廓和数道短横分隔笔画。`
...
- dataset label text: `㕺`
- dataset label codepoints: `U+357A`
...
- Which source records identify obs-char-000343 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000343？
