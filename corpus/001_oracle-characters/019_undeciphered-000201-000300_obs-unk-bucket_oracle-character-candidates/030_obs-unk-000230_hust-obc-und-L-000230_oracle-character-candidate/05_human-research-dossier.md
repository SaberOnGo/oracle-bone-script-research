# obs-unk-000230 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/019_undeciphered-000
  201-000300_obs-unk-bucket_oracle-character-candidates/030_obs-unk-000230_h
  ust-obc-und-L-000230_oracle-character-candidate/03_visual-assets/001_asset
  -001823_hust-obc-und-L-000230_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/230/L_？_1071.jpg`
- asset id: `asset-001823`
...
- source class: `HUST-OBC/undeciphered/L/230/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/230/L_？_1071.jpg`
- asset id: `asset-001823`
...
- Which source records identify obs-unk-000230 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000230？
