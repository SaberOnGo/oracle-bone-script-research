...
Project ID: `obs-insc-cw-cand-000550`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000550`
...
- Yingguo / 英国所藏: `y2557` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `269` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `469` in source row; primary catalog entry pending
- Heji / 合集: `41765` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000550`
