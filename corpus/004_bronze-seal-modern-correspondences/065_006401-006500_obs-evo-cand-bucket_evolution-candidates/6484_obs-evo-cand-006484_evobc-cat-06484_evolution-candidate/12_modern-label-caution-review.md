# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006484
...
- EVOBC candidate category: `evobc-evo-cat-06484`.
- Source label for search only: `紻`.
- Source codepoints for search only: `U+7D3B`.
