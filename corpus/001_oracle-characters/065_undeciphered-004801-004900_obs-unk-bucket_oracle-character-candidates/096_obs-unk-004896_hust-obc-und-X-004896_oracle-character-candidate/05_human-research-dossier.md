# obs-unk-004896 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004896`
- primary external id: `hust-obc-und-X-004896`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/096_obs-unk-004896_h
  ust-obc-und-X-004896_oracle-character-candidate/03_visual-assets/001_asset
  -006489_hust-obc-und-X-004896_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/452/X_？_7432_1.png`
- asset id: `asset-006489`
...
- source class: `HUST-OBC/undeciphered/X/452/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/452/X_？_7432_1.png`
- asset id: `asset-006489`
...
- English observation: `narrow S-like curve with lower branches`
- 中文观察: `狭长 S 形弯曲笔画和下部分枝`
...
- Which source records identify obs-unk-004896 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004896？
