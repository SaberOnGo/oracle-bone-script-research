...
- Project ID: `obs-evo-cand-009126`
- EVOBC category candidate ID: `evobc-evo-cat-09126`
- External category reference: `evobc-cat-09126`
- Source category ID: `09126`
- Source label for human review: `郂`
- Source codepoints: `U+90C2`
...
- `obs-evo-cand-009126-route-category-staging`
...
- `obs-evo-cand-009126-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009126-route-evolution-graph`
