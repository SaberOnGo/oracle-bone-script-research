# obs-unk-006048 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/077_undeciphered-006
  001-006100_obs-unk-bucket_oracle-character-candidates/048_obs-unk-006048_h
  ust-obc-und-X-006048_oracle-character-candidate/03_visual-assets/001_asset
  -007640_hust-obc-und-X-006048_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1604/X_？_3376_1.png`
- asset id: `asset-007640`
...
- source class: `HUST-OBC/undeciphered/X/1604/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1604/X_？_3376_1.png`
- asset id: `asset-007640`
...
- Which source records identify obs-unk-006048 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006048？
