# obs-char-000893 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/893_obs-char-000893_hust-obc-cat-1005_orac
  le-character/03_visual-assets/001_asset-000898_hust-obc-cat-1005_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1005/G_1005_前2.27.6合37783.png`
- asset id: `asset-000898`
...
- source category: `1005`
- validation class: `892`
- source image route: `HUST-OBC/deciphered/1005/G_1005_前2.27.6合37783.png`
- asset id: `asset-000898`
...
- English observation: `A compact dark form combines a small detached mark,
  a central upright cluster, a broad lower curve, and several short upward
  projections.`
- 中文观察: `紧密深色形体结合小型分离痕迹、中央直立笔群、下部宽弯笔和数条上伸短笔。`
...
- dataset label text: `㟣`
- dataset label codepoints: `U+37E3`
...
- filename catalog route clues: `Heji-like filename clue: 合37783
...
- Which source records identify obs-char-000893 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000893？
