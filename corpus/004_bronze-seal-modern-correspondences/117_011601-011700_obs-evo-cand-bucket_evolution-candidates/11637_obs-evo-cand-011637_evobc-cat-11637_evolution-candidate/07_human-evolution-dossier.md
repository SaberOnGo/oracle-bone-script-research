...
Project ID: `obs-evo-cand-011637`
...
- Project ID: `obs-evo-cand-011637`
- EVOBC category candidate ID: `evobc-evo-cat-11637`
- External category reference: `evobc-cat-11637`
- Source category ID: `11637`
- Source label for human review: `𤤶`
- Source codepoints: `U+24936`
...
- `obs-evo-cand-011637-route-category-staging`
...
- `obs-evo-cand-011637-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011637-route-evolution-graph`
