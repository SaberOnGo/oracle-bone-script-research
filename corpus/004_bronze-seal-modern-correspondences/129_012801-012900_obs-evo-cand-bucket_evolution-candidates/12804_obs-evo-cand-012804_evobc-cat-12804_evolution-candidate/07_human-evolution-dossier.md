...
- External category reference: `evobc-cat-12804`
- Source category ID: `12804`
...
- `obs-evo-cand-012804-route-category-staging`
...
- `obs-evo-cand-012804-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012804-route-evolution-graph`
