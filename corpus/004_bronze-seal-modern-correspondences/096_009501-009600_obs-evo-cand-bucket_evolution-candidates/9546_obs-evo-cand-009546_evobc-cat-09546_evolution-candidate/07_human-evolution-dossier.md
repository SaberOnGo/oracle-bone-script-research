...
- External category reference: `evobc-cat-09546`
- Source category ID: `09546`
- Source label for human review: `鑑`
- Source codepoints: `U+9451`
...
- `obs-evo-cand-009546-route-category-staging`
...
- `obs-evo-cand-009546-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009546-route-evolution-graph`
