...
- External category reference: `evobc-cat-07343`
- Source category ID: `07343`
- Source label for human review: `草`
- Source codepoints: `U+8349`
...
- `obs-evo-cand-007343-route-category-staging`
...
- `obs-evo-cand-007343-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007343-route-evolution-graph`
