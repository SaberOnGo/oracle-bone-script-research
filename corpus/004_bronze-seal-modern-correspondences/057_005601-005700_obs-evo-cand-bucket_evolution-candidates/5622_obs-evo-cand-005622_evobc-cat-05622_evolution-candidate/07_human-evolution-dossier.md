...
- External category reference: `evobc-cat-05622`
- Source category ID: `05622`
- Source label for human review: `疴`
...
- `obs-evo-cand-005622-route-category-staging`
...
- `obs-evo-cand-005622-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005622-route-evolution-graph`
