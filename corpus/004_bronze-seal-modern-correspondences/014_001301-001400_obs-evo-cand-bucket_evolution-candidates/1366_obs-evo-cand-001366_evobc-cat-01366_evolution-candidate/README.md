# obs-evo-cand-001366 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-001366`
- EVOBC category candidate ID: `evobc-evo-cat-01366`
- External category ref: `evobc-cat-01366`
- Source label: `升`
- Source codepoints: `U+5347`
- Image reference count: `121`
- Era token counts: `BI:7;CS:1;OBC:84;SAC:3;SS:2;WSC:24`
- Source token counts: `Book:58;Web:63`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 84 image references
- era 1 / BI: 7 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 3 image references
- era 4 / WSC: 24 image references
- era 5 / CS: 1 image references
- source 0 / Web:1633: 1 image references
- source 1 / Web:105952;說文Web:58: 42 image references
