# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001348
...
- EVOBC candidate category: `evobc-evo-cat-01348`.
- Source label for search only: `匬`.
- Source codepoints for search only: `U+532C`.
