...
- External category reference: `evobc-cat-01669`
- Source category ID: `01669`
- Source label for human review: `嗌`
...
- `obs-evo-cand-001669-route-category-staging`
...
- `obs-evo-cand-001669-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001669-route-evolution-graph`
