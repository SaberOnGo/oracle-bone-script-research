# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001395
...
| --- | --- | --- | --- |
| `obimd-glyph-link-020885` | 𩛥󷻮 | `U+296E5;U+F7EEE` | `reviewed_metadata_only` |
| `obimd-glyph-link-020886` | 󷻯 | `U+F7EEF` | `reviewed_metadata_only` |
| `obimd-glyph-link-020887` | 󷻰 | `U+F7EF0` | `reviewed_metadata_only` |
| `obimd-glyph-link-020888` | 󷻱 | `U+F7EF1` | `reviewed_metadata_only` |
| `obimd-glyph-link-020889` | 󷻲 | `U+F7EF2` | `reviewed_metadata_only` |
