...
Project ID: `obs-evo-cand-000685`
...
- Project ID: `obs-evo-cand-000685`
- EVOBC category candidate ID: `evobc-evo-cat-00685`
- External category reference: `evobc-cat-00685`
- Source category ID: `00685`
- Source label for human review: `于`
- Source codepoints: `U+4E8E`
- Image reference count in source metadata: `295`
...
- `obs-evo-cand-000685-route-category-staging`
...
- `obs-evo-cand-000685-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000685-route-evolution-graph`
