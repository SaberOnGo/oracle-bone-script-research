...
- External category reference: `evobc-cat-01478`
- Source category ID: `01478`
- Source label for human review: `可`
- Source codepoints: `U+53EF`
...
- `obs-evo-cand-001478-route-category-staging`
...
- `obs-evo-cand-001478-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001478-route-evolution-graph`
