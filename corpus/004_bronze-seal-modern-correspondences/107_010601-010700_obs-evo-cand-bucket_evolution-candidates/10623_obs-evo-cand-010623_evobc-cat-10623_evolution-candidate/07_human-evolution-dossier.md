...
Project ID: `obs-evo-cand-010623`
...
- Project ID: `obs-evo-cand-010623`
- EVOBC category candidate ID: `evobc-evo-cat-10623`
- External category reference: `evobc-cat-10623`
- Source category ID: `10623`
- Source label for human review: `麧`
- Source codepoints: `U+9EA7`
...
- `obs-evo-cand-010623-route-category-staging`
...
- `obs-evo-cand-010623-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010623-route-evolution-graph`
