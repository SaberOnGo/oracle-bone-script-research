# Material Visual Observation / obs-comp-cand-000900 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000900`
- External reference / 外部参照: `obimd-sub-7grggyd1fj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013972_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1u3e5w4k2u/7grggyd1fj/7grggyd1fj.png`
- Checksum / 校验和:
  `da22896857c8ebdf8902a823abf8e9aa87555b2965d3d348ae0b43e71bdaf2e3`
...
- Marked-pixel bounds: (85,31)–(164,218); span 80 × 188 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.32%。
- 痕迹范围：(85,31)–(164,218)；跨度80 × 188 px；痕迹矩形高于宽。
