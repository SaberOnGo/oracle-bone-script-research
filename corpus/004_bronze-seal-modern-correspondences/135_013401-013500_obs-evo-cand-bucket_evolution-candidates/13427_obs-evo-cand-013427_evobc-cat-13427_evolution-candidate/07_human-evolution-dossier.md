...
- External category reference: `evobc-cat-13427`
- Source category ID: `13427`
- Source label for human review: `𬰰`
...
- `obs-evo-cand-013427-route-category-staging`
...
- `obs-evo-cand-013427-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013427-route-evolution-graph`
