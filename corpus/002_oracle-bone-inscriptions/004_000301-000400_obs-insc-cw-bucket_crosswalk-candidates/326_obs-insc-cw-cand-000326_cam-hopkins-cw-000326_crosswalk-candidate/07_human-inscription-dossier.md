...
Project ID: `obs-insc-cw-cand-000326`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000326`
...
- Source page section: `Period II Group 3` /
  `第 II 期第 3 组`
- Source section key: `period-ii-group-3`
...
- Yingguo / 英国所藏: `y1999` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `447` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `36` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000326`
