...
- Project ID / 项目 ID: `obs-char-001557`
- Primary external ID / 首选外部 ID: `hust-obc-cat-1748`
...
- Source image / 来源图: `L_1748_6326.jpg`
- Image / 图像: `001_asset-001562_hust-obc-cat-1748_glyph.png`
...
- target node: `evobc-evo-cat-00155`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/155_obs-evo-cand-000155_evobc-cat-00155_evoluti
...
- Source label text / 来源标签文字: `㫊`
- Source label codepoint / 来源标签 codepoint: `U+3ACA`
