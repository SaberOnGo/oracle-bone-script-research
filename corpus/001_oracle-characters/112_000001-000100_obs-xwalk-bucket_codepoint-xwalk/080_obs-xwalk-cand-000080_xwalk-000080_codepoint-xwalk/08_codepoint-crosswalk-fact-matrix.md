# obs-xwalk-cand-000080 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+3450` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-0090` | not reading |
