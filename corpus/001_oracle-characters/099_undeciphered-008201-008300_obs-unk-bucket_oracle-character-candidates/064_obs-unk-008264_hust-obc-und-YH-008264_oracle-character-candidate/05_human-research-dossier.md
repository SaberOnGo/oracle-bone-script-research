# obs-unk-008264 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008264`
- primary external id: `hust-obc-und-YH-008264`
...
- local review image route: `corpus/001_oracle-characters/099_undeciphered-008
  201-008300_obs-unk-bucket_oracle-character-candidates/064_obs-unk-008264_h
  ust-obc-und-YH-008264_oracle-character-candidate/03_visual-assets/001_asse
  t-009855_hust-obc-und-YH-008264_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/608FE/Y_？_608FE.jpg`
- asset id: `asset-009855`
...
- source class: `HUST-OBC/undeciphered/Y+H/608FE/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/608FE/Y_？_608FE.jpg`
- asset id: `asset-009855`
...
- Which source records identify obs-unk-008264 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008264？
