...
- Project ID: `obs-evo-cand-001689`
- EVOBC category candidate ID: `evobc-evo-cat-01689`
- External category reference: `evobc-cat-01689`
- Source category ID: `01689`
- Source label for human review: `嘅`
- Source codepoints: `U+5605`
...
- `obs-evo-cand-001689-route-category-staging`
...
- `obs-evo-cand-001689-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001689-route-evolution-graph`
