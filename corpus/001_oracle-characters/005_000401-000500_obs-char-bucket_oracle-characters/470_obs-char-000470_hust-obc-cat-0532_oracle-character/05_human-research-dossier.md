# obs-char-000470 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/470_obs-char-000470_hust-obc-cat-0532_orac
  le-character/03_visual-assets/001_asset-000475_hust-obc-cat-0532_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0532/G_0532_乙4832合14228賓組.png`
- asset id: `asset-000475`
...
- source category: `0532`
- validation class: `469`
- source image route: `HUST-OBC/deciphered/0532/G_0532_乙4832合14228賓組.png`
- asset id: `asset-000475`
...
- English observation: `Separated pointed outer strokes surround a central
  elongated loop crossed by a diagonal line; a thin detached vertical stroke
  stands at left.`
- 中文观察: `分离的尖顶外部笔画围绕中央细长环形，环内有斜线交叉，左侧另立一条纤细分离竖笔。`
...
- dataset label text: `㘊`
- dataset label codepoints: `U+360A`
...
- filename catalog route clues: `Heji-like filename clue: 合14228
...
- Which source records identify obs-char-000470 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000470？
