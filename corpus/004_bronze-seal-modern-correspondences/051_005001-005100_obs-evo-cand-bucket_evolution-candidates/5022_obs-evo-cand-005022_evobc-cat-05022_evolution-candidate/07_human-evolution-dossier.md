...
Project ID: `obs-evo-cand-005022`
...
- Project ID: `obs-evo-cand-005022`
- EVOBC category candidate ID: `evobc-evo-cat-05022`
- External category reference: `evobc-cat-05022`
- Source category ID: `05022`
- Source label for human review: `灡`
- Source codepoints: `U+7061`
...
- `obs-evo-cand-005022-route-category-staging`
...
- `obs-evo-cand-005022-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005022-route-evolution-graph`
