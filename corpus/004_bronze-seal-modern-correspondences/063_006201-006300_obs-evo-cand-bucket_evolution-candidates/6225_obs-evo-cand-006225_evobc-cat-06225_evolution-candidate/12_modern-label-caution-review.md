# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006225
...
- EVOBC candidate category: `evobc-evo-cat-06225`.
- Source label for search only: `笍`.
- Source codepoints for search only: `U+7B0D`.
