# Material Visual Observation / obs-comp-cand-002147 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002147`
- External reference / 外部参照: `obimd-sub-3nx6ei89pt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019735_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6x8v1c8903/3nx6ei89pt/3nx6ei89pt.png`
- Checksum / 校验和:
  `397a9725b28a46bbff0d296e94dc851c0e00204d7d7cf1d86d6239f3e701fac9`
...
- Marked-pixel bounds: (75,18)–(153,230); span 79 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.80%。
- 痕迹范围：(75,18)–(153,230)；跨度79 × 213 px；痕迹矩形高于宽。
