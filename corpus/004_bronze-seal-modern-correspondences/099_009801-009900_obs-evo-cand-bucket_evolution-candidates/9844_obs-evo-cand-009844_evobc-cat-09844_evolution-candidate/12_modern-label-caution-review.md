# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-009844
...
- EVOBC candidate category: `evobc-evo-cat-09844`.
- Source label for search only: `電`.
- Source codepoints for search only: `U+96FB`.
