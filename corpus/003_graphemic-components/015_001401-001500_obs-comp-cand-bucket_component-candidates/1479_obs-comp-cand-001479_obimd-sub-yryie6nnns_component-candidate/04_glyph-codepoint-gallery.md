# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001479
...
| --- | --- | --- | --- |
| `obimd-glyph-link-022358` | 򺈂󸞬 | `U+BA202;U+F87AC` | `reviewed_metadata_only` |
| `obimd-glyph-link-022359` | 󸞭 | `U+F87AD` | `reviewed_metadata_only` |
