# Material Visual Observation / obs-comp-cand-001169 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001169`
- External reference / 外部参照: `obimd-sub-7fhnqn7giq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015359_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7fhnqn7giq/7fhnqn7giq/7fhnqn7giq.png`
- Checksum / 校验和:
  `406510f3ce8455d20b057f092c49ef73afa055a3d9dfd250ed43120fbb909816`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.26%.
- Marked-pixel bounds: (79,37)–(170,208); span 92 × 172 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.26%。
- 痕迹范围：(79,37)–(170,208)；跨度92 × 172 px；痕迹矩形高于宽。
