...
Project ID: `obs-evo-cand-005050`
...
- Project ID: `obs-evo-cand-005050`
- EVOBC category candidate ID: `evobc-evo-cat-05050`
- External category reference: `evobc-cat-05050`
- Source category ID: `05050`
- Source label for human review: `炪`
- Source codepoints: `U+70AA`
...
- `obs-evo-cand-005050-route-category-staging`
...
- `obs-evo-cand-005050-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005050-route-evolution-graph`
