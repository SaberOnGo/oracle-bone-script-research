# obs-comp-cand-002350 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002350`
- 首选外部 ID: `obimd-sub-cod914fnx4`
- OBIMD subcharacter UID: `cod914fnx4`
- OBIMD main character UID: `cod914fnx4`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+BD88D;U+FD740; U+FD742; 另有 1 项
