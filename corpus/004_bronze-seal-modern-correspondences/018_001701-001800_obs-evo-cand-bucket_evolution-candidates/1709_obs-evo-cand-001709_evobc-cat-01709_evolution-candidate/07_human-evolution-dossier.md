...
Project ID: `obs-evo-cand-001709`
...
- Project ID: `obs-evo-cand-001709`
- EVOBC category candidate ID: `evobc-evo-cat-01709`
- External category reference: `evobc-cat-01709`
- Source category ID: `01709`
- Source label for human review: `嘽`
- Source codepoints: `U+563D`
...
- `obs-evo-cand-001709-route-category-staging`
...
- `obs-evo-cand-001709-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001709-route-evolution-graph`
