# Material Visual Observation / obs-comp-cand-001617 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001617`
- External reference / 外部参照: `obimd-sub-lyy6c5kh8d`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017293_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lyy6c5kh8d/lyy6c5kh8d/lyy6c5kh8d.png`
- Checksum / 校验和:
  `53db37b2ec83032b3fff6f6f1c0c887dfe3478c05f007367a8225822223d8652`
...
- Marked-pixel bounds: (80,31)–(169,220); span 90 × 190 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.26%。
- 痕迹范围：(80,31)–(169,220)；跨度90 × 190 px；痕迹矩形高于宽。
