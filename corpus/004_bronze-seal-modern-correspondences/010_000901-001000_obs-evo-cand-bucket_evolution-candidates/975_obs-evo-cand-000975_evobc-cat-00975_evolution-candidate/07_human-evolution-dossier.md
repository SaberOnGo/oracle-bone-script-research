...
- External category reference: `evobc-cat-00975`
- Source category ID: `00975`
- Source label for human review: `傅`
...
- `obs-evo-cand-000975-route-category-staging`
...
- `obs-evo-cand-000975-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000975-route-evolution-graph`
