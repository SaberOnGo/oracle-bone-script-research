# obs-char-001432 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001432`
- primary external id: `hust-obc-cat-1604`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1432_obs-char-001432_hust-obc-cat-1604_ora
  cle-character/03_visual-assets/001_asset-001437_hust-obc-cat-1604_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1604/G_1604_後2.18.8(甲).png`
- asset id: `asset-001437`
...
- source category: `1604`
- validation class: `1431`
- source image route: `HUST-OBC/deciphered/1604/G_1604_後2.18.8(甲).png`
- asset id: `asset-001437`
...
- English observation: `An open left frame stands beside a tall right stem
  with repeated side strokes.`
- 中文观察: `开放左侧框形旁有高大右侧竖干及重复侧部笔画。`
...
- dataset label text: `㨺`
- dataset label codepoints: `U+3A3A`
...
- Which source records identify obs-char-001432 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001432？
