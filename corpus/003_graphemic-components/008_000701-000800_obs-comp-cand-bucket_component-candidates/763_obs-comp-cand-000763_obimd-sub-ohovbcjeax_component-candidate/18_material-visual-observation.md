# Material Visual Observation / obs-comp-cand-000763 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000763`
- External reference / 外部参照: `obimd-sub-ohovbcjeax`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013526_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ohovbcjeax/ohovbcjeax/ohovbcjeax.png`
- Checksum / 校验和:
  `03ef702efb43dbec1d7c3ee4dab5849cd4bcf842af43e1cb0adbe67aa714a51b`
...
- Marked-pixel bounds: (85,26)–(164,230); span 80 × 205 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.36%。
- 痕迹范围：(85,26)–(164,230)；跨度80 × 205 px；痕迹矩形高于宽。
