...
Project ID: `obs-evo-cand-002644`
...
- Project ID: `obs-evo-cand-002644`
- EVOBC category candidate ID: `evobc-evo-cat-02644`
- External category reference: `evobc-cat-02644`
- Source category ID: `02644`
- Source label for human review: `帑`
- Source codepoints: `U+5E11`
...
- `obs-evo-cand-002644-route-category-staging`
...
- `obs-evo-cand-002644-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002644-route-evolution-graph`
