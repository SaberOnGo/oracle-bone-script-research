# obs-char-000829 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/829_obs-char-000829_hust-obc-cat-0937_orac
  le-character/03_visual-assets/001_asset-000834_hust-obc-cat-0937_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0937/G_0937_林1.8.12合38969.png`
- asset id: `asset-000834`
...
- source category: `0937`
- validation class: `828`
- source image route: `HUST-OBC/deciphered/0937/G_0937_林1.8.12合38969.png`
- asset id: `asset-000834`
...
- English observation: `Two long curved strokes at left stand beside a
  compact grid of short vertical and horizontal strokes; the groups remain
  separated.`
...
- dataset label text: `㞟`
- dataset label codepoints: `U+379F`
...
- filename catalog route clues: `Heji-like filename clue: 合38969
...
- Which source records identify obs-char-000829 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000829？
