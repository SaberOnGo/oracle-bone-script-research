...
- External category reference: `evobc-cat-10219`
- Source category ID: `10219`
- Source label for human review: `騕`
- Source codepoints: `U+9A15`
...
- `obs-evo-cand-010219-route-category-staging`
...
- `obs-evo-cand-010219-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010219-route-evolution-graph`
