# obs-unk-003990 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003990`
- primary external id: `hust-obc-und-L-003990`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/090_obs-unk-003990_h
  ust-obc-und-L-003990_oracle-character-candidate/03_visual-assets/001_asset
  -005583_hust-obc-und-L-003990_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3990/L_？_8445.jpg`
- asset id: `asset-005583`
...
- source class: `HUST-OBC/undeciphered/L/3990/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3990/L_？_8445.jpg`
- asset id: `asset-005583`
...
- English observation: A short upright mark rises from a wider upper trace;
  angled and curved strokes descend toward the cropped right margin.
- 中文观察：短直立痕迹从较宽上部痕迹向上伸出，
  斜向和弯曲痕迹向被裁切的右缘下行。
...
- Which source records identify obs-unk-003990 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003990？
