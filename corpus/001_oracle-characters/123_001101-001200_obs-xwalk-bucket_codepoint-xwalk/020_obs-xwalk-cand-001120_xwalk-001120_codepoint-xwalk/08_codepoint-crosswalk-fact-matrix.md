# obs-xwalk-cand-001120 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+38D9` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-1251` | not reading |
| OBIMD route / OBIMD 路线 | `obimd-main-cand-002637` | not component |
| EVOBC route / EVOBC 路线 | `evobc-evo-cat-00107` | not evolution |
| Source and rights trail / 来源与权利链 | `source_marked_risk_noted` | source-marked risk note required |
| Missing evidence route / 缺失证据路线 | `matched_obimd_and_evobc_by_codepoint` | not decipherment |
...
| HUST candidate route | `corpus/001_oracle-characters/012_001101-001200_obs-char-bucket_oracle-characters/1120_obs-char-001120_hust-obc-cat-1251_oracle-character/01_candidate-character-packet.json` | open packet and local glyph dossier first |
