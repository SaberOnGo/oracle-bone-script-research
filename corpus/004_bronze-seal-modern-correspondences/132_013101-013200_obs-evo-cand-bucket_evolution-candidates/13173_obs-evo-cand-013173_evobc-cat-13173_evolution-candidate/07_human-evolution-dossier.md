...
- External category reference: `evobc-cat-13173`
- Source category ID: `13173`
- Source label for human review: `𫿃`
...
- `obs-evo-cand-013173-route-category-staging`
...
- `obs-evo-cand-013173-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013173-route-evolution-graph`
