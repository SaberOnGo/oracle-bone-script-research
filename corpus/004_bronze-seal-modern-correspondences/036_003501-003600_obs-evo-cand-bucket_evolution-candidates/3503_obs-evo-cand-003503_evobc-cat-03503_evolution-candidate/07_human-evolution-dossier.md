...
Project ID: `obs-evo-cand-003503`
...
- Project ID: `obs-evo-cand-003503`
- EVOBC category candidate ID: `evobc-evo-cat-03503`
- External category reference: `evobc-cat-03503`
- Source category ID: `03503`
- Source label for human review: `撥`
- Source codepoints: `U+64A5`
...
- `obs-evo-cand-003503-route-category-staging`
...
- `obs-evo-cand-003503-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003503-route-evolution-graph`
