...
- External category reference: `evobc-cat-11202`
- Source category ID: `11202`
- Source label for human review: `𢓰`
- Source codepoints: `U+224F0`
...
- `obs-evo-cand-011202-route-category-staging`
...
- `obs-evo-cand-011202-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011202-route-evolution-graph`
