# obs-char-000148 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/148_obs-char-000148_hust-obc-cat-0164_orac
  le-character/03_visual-assets/001_asset-000153_hust-obc-cat-0164_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0164/G_0164_七S37.png`
- asset id: `asset-000153`
...
- source category: `0164`
- validation class: `147`
- source image route: `HUST-OBC/deciphered/0164/G_0164_七S37.png`
- asset id: `asset-000153`
...
- English observation: `The image has a central crossing, a long pointed
  descending stroke, and short outward projections on both sides near the
  upper half.`
- 中文观察: `图像中部有交叉点，向下延伸长而尖的主笔，上半部两侧有短向外伸笔。`
...
- dataset label text: `㒚`
- dataset label codepoints: `U+349A`
...
- Which source records identify obs-char-000148 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000148？
