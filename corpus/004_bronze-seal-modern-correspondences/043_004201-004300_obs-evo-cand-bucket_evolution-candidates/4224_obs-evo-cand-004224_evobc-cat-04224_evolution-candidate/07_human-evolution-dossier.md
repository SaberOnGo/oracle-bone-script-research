...
- External category reference: `evobc-cat-04224`
- Source category ID: `04224`
- Source label for human review: `槶`
...
- `obs-evo-cand-004224-route-category-staging`
...
- `obs-evo-cand-004224-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004224-route-evolution-graph`
