...
- External category reference: `evobc-cat-03140`
- Source category ID: `03140`
- Source label for human review: `憀`
...
- `obs-evo-cand-003140-route-category-staging`
...
- `obs-evo-cand-003140-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003140-route-evolution-graph`
