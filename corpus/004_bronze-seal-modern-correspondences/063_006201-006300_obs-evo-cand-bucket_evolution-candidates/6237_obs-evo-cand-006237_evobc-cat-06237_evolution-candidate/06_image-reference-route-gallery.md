...
- `obs-evo-cand-006237-route-category-staging`
...
- `obs-evo-cand-006237-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006237-route-evolution-graph`
