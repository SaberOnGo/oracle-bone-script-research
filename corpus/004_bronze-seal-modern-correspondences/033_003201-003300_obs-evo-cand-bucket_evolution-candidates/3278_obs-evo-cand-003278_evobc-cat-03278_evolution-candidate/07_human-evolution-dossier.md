...
- External category reference: `evobc-cat-03278`
- Source category ID: `03278`
- Source label for human review: `抑`
- Source codepoints: `U+6291`
...
- `obs-evo-cand-003278-route-category-staging`
...
- `obs-evo-cand-003278-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003278-route-evolution-graph`
