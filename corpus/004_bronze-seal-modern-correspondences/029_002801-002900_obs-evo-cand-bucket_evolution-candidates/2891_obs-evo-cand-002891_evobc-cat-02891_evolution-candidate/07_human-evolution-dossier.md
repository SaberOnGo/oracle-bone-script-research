...
- External category reference: `evobc-cat-02891`
- Source category ID: `02891`
- Source label: `徻`
...
- `obs-evo-cand-002891-route-category-staging`
...
- `obs-evo-cand-002891-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002891-route-evolution-graph`
