# Material Visual Observation / obs-comp-cand-001245 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001245`
- External reference / 外部参照: `obimd-sub-sx7ig5dria`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015483_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/sx7ig5dria/sx7ig5dria/sx7ig5dria.png`
- Checksum / 校验和:
  `393b8ae19200c6433491c20b5cce76ca02319c32ce19b3d1b812db1d87bfaed7`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.88%.
- Marked-pixel bounds: (47,11)–(193,241); span 147 × 231 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.88%。
- 痕迹范围：(47,11)–(193,241)；跨度147 × 231 px；痕迹矩形高于宽。
