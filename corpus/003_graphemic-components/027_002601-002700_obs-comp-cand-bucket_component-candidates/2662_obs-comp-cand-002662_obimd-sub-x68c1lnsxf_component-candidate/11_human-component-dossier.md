# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-002662
...
- candidate_component_id: `obs-comp-cand-002662`
- primary_external_ref_id: `obimd-sub-x68c1lnsxf`
- source_subcharacter_uid: `x68c1lnsxf`
- source_main_character_uid: `x68c1lnsxf`
- main_character_external_ref_id: `obimd-main-x68c1lnsxf`
...
- glyph_codepoint_uplus_sample: `U+FEFFB, U+FEFFC, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-021238` | `001_asset-021238_img.png` | `ebf73fce6764a5055470a04b74a02612c5c1e8d4e6bd8d8c9b1ef7e06e92b691` |
