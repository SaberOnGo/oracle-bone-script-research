# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004301
...
- EVOBC candidate category: `evobc-evo-cat-04301`.
- Source label for search only: `檻`.
- Source codepoints for search only: `U+6ABB`.
