# Material Visual Observation / obs-comp-cand-001133 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001133`
- External reference / 外部参照: `obimd-sub-jthh3lgecc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015087_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jthh3lgecc/jthh3lgecc/jthh3lgecc.png`
- Checksum / 校验和:
  `90af2f35c6362f7681d88317011157c7f6298e7570241b6bca57116a7b729017`
...
- Marked-pixel bounds: (57,53)–(189,200); span 133 × 148 px; the marked
...
- 痕迹范围：(57,53)–(189,200)；跨度133 × 148 px；痕迹矩形近方形。
