# obs-unk-009380 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/110_undeciphered-009
  301-009400_obs-unk-bucket_oracle-character-candidates/080_obs-unk-009380_h
  ust-obc-und-YH-009380_oracle-character-candidate/03_visual-assets/001_asse
  t-010971_hust-obc-und-YH-009380_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/617DF/H_？_617DF_0.png`
- asset id: `asset-010971`
...
- source class: `HUST-OBC/undeciphered/Y+H/617DF/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/617DF/H_？_617DF_0.png`
- asset id: `asset-010971`
...
- Which source records identify obs-unk-009380 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009380？
