...
- External category reference: `evobc-cat-00810`
- Source category ID: `00810`
- Source label for human review: `作`
- Source codepoints: `U+4F5C`
- Image reference count in source metadata: `101`
...
- `obs-evo-cand-000810-route-category-staging`
...
- `obs-evo-cand-000810-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000810-route-evolution-graph`
