# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002825
...
- EVOBC candidate category: `evobc-evo-cat-02825`.
- Source label for search only: `彊`.
- Source codepoints for search only: `U+5F4A`.
