...
- Project ID: `obs-evo-cand-013236`
- EVOBC category candidate ID: `evobc-evo-cat-13236`
- External category reference: `evobc-cat-13236`
- Source category ID: `13236`
- Source label for human review: `𬋽`
- Source codepoints: `U+2C2FD`
...
- `obs-evo-cand-013236-route-category-staging`
...
- `obs-evo-cand-013236-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013236-route-evolution-graph`
