...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000592` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2641` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `610` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `517` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `41953` [route_present_image_or_text_not_collected]
