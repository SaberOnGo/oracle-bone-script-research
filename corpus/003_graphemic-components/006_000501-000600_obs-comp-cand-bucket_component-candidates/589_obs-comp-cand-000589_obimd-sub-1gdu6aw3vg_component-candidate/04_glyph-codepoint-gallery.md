# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000589
...
| --- | --- | --- | --- |
| `obimd-glyph-link-008979` | 󅘵󿩈 | `U+C5635;U+FFA48` | `reviewed_metadata_only` |
| `obimd-glyph-link-008980` | 󳡎 | `U+F384E` | `reviewed_metadata_only` |
