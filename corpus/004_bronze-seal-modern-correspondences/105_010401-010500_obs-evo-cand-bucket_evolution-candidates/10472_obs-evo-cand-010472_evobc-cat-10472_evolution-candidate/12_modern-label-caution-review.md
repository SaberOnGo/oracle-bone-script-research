# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010472
...
- EVOBC candidate category: `evobc-evo-cat-10472`.
- Source label for search only: `鳬`.
- Source codepoints for search only: `U+9CEC`.
