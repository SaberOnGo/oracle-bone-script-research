# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008502
...
- EVOBC candidate category: `evobc-evo-cat-08502`.
- Source label for search only: `豭`.
- Source codepoints for search only: `U+8C6D`.
