...
- External category reference: `evobc-cat-08827`
- Source category ID: `08827`
- Source label: `較`
...
- `obs-evo-cand-008827-route-category-staging`
...
- `obs-evo-cand-008827-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-008827-route-evolution-graph`
