# obs-unk-005159 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/068_undeciphered-005
  101-005200_obs-unk-bucket_oracle-character-candidates/059_obs-unk-005159_h
  ust-obc-und-X-005159_oracle-character-candidate/03_visual-assets/001_asset
  -006752_hust-obc-und-X-005159_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/715/X_？_7149_1.png`
- asset id: `asset-006752`
...
- source class: `HUST-OBC/undeciphered/X/715/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/715/X_？_7149_1.png`
- asset id: `asset-006752`
...
- Which source records identify obs-unk-005159 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005159？
