# obs-char-001091 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001091`
- primary external id: `hust-obc-cat-1220`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1091_obs-char-001091_hust-obc-cat-1220_ora
  cle-character/03_visual-assets/001_asset-001096_hust-obc-cat-1220_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1220/G_1220_甲骨文.png`
- asset id: `asset-001096`
...
- source category: `1220`
- validation class: `1090`
- source image route: `HUST-OBC/deciphered/1220/G_1220_甲骨文.png`
- asset id: `asset-001096`
...
- dataset label text: `㢺`
- dataset label codepoints: `U+38BA`
...
- Which source records identify obs-char-001091 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001091？
