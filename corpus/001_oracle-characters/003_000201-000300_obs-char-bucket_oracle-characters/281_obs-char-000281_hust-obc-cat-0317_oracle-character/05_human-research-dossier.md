# obs-char-000281 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/281_obs-char-000281_hust-obc-cat-0317_orac
  le-character/03_visual-assets/001_asset-000286_hust-obc-cat-0317_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0317/H_0317_601CD_0.png`
- asset id: `asset-000286`
...
- source category: `0317`
- validation class: `280`
- source image route: `HUST-OBC/deciphered/0317/H_0317_601CD_0.png`
- asset id: `asset-000286`
...
- English observation: `The image has a large slanted rounded contour on the
  right, crossed by a descending stroke, with small separated marks at the
  left and lower right.`
- 中文观察: `图像右侧有大型倾斜弧形轮廓，中部有下行笔画穿过，左侧和右下方另有分离的小痕迹。`
...
- dataset label text: `㔳`
- dataset label codepoints: `U+3533`
...
- filename catalog route clues: `catalog-like filename clue: H_0317
  (H_0317_601CD_0.png)`
...
- Which source records identify obs-char-000281 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000281？
