# obs-unk-004800 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/100_obs-unk-004800_h
  ust-obc-und-X-004800_oracle-character-candidate/03_visual-assets/001_asset
  -006393_hust-obc-und-X-004800_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/356/X_？_7339_1.png`
- asset id: `asset-006393`
...
- source class: `HUST-OBC/undeciphered/X/356/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/356/X_？_7339_1.png`
- asset id: `asset-006393`
...
- English observation: `dark high-contrast image requires polarity review`
- 中文观察: `深色高对比图像需要核对黑白极性`
...
- Which source records identify obs-unk-004800 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004800？
