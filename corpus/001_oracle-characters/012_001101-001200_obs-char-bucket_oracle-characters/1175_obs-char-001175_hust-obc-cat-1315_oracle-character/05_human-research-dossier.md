# obs-char-001175 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001175`
- primary external id: `hust-obc-cat-1315`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1175_obs-char-001175_hust-obc-cat-1315_ora
  cle-character/03_visual-assets/001_asset-001180_hust-obc-cat-1315_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1315/G_1315_花502(甲).png`
- asset id: `asset-001180`
...
- source category: `1315`
- validation class: `1174`
- source image route: `HUST-OBC/deciphered/1315/G_1315_花502(甲).png`
- asset id: `asset-001180`
...
- English observation: `A small upright form has a pointed top, a short
  upper shoulder, and two long descending side strokes.`
...
- dataset label text: `㤙`
- dataset label codepoints: `U+3919`
...
- Which source records identify obs-char-001175 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001175？
