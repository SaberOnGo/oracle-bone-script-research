# obs-unk-003968 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/068_obs-unk-003968_h
  ust-obc-und-L-003968_oracle-character-candidate/03_visual-assets/001_asset
  -005561_hust-obc-und-L-003968_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3968/L_？_8382.jpg`
- asset id: `asset-005561`
...
- source class: `HUST-OBC/undeciphered/L/3968/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3968/L_？_8382.jpg`
- asset id: `asset-005561`
...
- English observation: A compact angular cap sits above a broad bar and short
  downward strokes with darker lower marks at both sides.
- 中文观察：紧凑折角上部痕迹位于较宽横痕之上，横痕下有短下行痕，左右下部
  可见较深痕迹。
...
- Which source records identify obs-unk-003968 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003968？
