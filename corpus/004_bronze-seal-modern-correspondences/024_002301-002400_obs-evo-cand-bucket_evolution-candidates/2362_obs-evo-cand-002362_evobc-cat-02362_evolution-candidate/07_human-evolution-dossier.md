...
- External category reference: `evobc-cat-02362`
- Source category ID: `02362`
- Source label for human review: `守`
- Source codepoints: `U+5B88`
...
- `obs-evo-cand-002362-route-category-staging`
...
- `obs-evo-cand-002362-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002362-route-evolution-graph`
