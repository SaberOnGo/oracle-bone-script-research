# obs-char-000644 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000644`
- primary external id: `hust-obc-cat-0732`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/644_obs-char-000644_hust-obc-cat-0732_orac
  le-character/03_visual-assets/001_asset-000649_hust-obc-cat-0732_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0732/X_0732_5460_1.png`
- asset id: `asset-000649`
...
- source category: `0732`
- validation class: `643`
- source image route: `HUST-OBC/deciphered/0732/X_0732_5460_1.png`
- asset id: `asset-000649`
...
- English observation: `A long bent stroke with a short inward branch stands
  at left; at right, a square upper loop rests on a branching stem with one
  long diagonal descent.`
- 中文观察: `左侧为带短内向枝的长弯笔；右侧方形上环立于分枝干上，并有一条长斜下笔。`
...
- dataset label text: `㛒`
- dataset label codepoints: `U+36D2`
...
- Which source records identify obs-char-000644 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000644？
