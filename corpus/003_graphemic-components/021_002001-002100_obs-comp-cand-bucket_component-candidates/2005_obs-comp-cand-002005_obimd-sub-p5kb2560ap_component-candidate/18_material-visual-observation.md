# Material Visual Observation / obs-comp-cand-002005 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002005`
- External reference / 外部参照: `obimd-sub-p5kb2560ap`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019285_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/67yxx2eqp0/p5kb2560ap/p5kb2560ap.png`
- Checksum / 校验和:
  `1c49daa21c137cb0b66c70b775fbbbafa5bdf272e3f624b3aa8d9a00a6b14e25`
...
- Marked-pixel bounds: (92,26)–(157,218); span 66 × 193 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.87%。
- 痕迹范围：(92,26)–(157,218)；跨度66 × 193 px；痕迹矩形高于宽。
