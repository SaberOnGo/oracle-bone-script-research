# obs-comp-cand-002662 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002662`
- 首选外部 ID: `obimd-sub-x68c1lnsxf`
- OBIMD subcharacter UID: `x68c1lnsxf`
- OBIMD main character UID: `x68c1lnsxf`
- 来源 ID: `src-obimd`
...
- codepoint 示例: U+FEFFB; U+FEFFC; 另有 14 项
