# obs-char-001425 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001425`
- primary external id: `hust-obc-cat-1597`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1425_obs-char-001425_hust-obc-cat-1597_ora
  cle-character/03_visual-assets/001_asset-001430_hust-obc-cat-1597_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1597/H_1597_6101D_0.png`
- asset id: `asset-001430`
...
- source category: `1597`
- validation class: `1424`
- source image route: `HUST-OBC/deciphered/1597/H_1597_6101D_0.png`
- asset id: `asset-001430`
...
- English observation: `A large composite has a peaked center, a broad lower
  enclosure, and long stems.`
- 中文观察: `大型组合形体有尖拱中央、宽大下部框形和长竖干。`
...
- dataset label text: `㨳`
- dataset label codepoints: `U+3A33`
...
- filename catalog route clues: `catalog-like filename clue: H_1597
  (H_1597_6101D_0.png)`
...
- Which source records identify obs-char-001425 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001425？
