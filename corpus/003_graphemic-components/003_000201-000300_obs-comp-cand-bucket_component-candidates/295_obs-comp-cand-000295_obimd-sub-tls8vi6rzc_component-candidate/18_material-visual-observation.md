# Material Visual Observation / obs-comp-cand-000295 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000295`
- External reference / 外部参照: `obimd-sub-tls8vi6rzc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012061_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1wismy95hz/tls8vi6rzc/tls8vi6rzc.png`
- Checksum / 校验和:
  `2072d2ac63e6275563c009ced0b3b909f4d47d25450a05934904828f12065451`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.35%.
- Marked-pixel bounds: (68,20)–(181,229); span 114 × 210 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.35%。
- 痕迹范围：(68,20)–(181,229)；跨度114 × 210 px；痕迹矩形高于宽。
