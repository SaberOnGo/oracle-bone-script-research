...
- External category reference: `evobc-cat-02681`
- Source category ID: `02681`
- Source label for human review: `幟`
- Source codepoints: `U+5E5F`
...
- `obs-evo-cand-002681-route-category-staging`
...
- `obs-evo-cand-002681-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002681-route-evolution-graph`
