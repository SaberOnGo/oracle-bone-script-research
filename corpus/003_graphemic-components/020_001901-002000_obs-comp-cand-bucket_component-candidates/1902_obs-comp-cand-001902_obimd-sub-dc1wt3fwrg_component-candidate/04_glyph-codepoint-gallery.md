# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001902
...
| --- | --- | --- | --- |
| `obimd-glyph-link-028784` | 򮚽󺶡 | `U+AE6BD;U+FADA1` | `reviewed_metadata_only` |
| `obimd-glyph-link-028785` | 󺶢 | `U+FADA2` | `reviewed_metadata_only` |
