...
- Source page section: `Period IV Group 3` /
  `第 IV 期第 3 组`
- Source section key: `period-iv-group-3`
...
- Yingguo / 英国所藏: `y2417` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `335` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `385` in source row; primary catalog entry pending
- Heji / 合集: `40920` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000493`
