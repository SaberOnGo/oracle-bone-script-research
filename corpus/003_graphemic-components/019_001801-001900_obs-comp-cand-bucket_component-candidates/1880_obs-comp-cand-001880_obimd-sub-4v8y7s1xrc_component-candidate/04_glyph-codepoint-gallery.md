# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001880
...
| --- | --- | --- | --- |
| `obimd-glyph-link-028557` | 󺮓 | `U+FAB93` | `reviewed_metadata_only` |
| `obimd-glyph-link-028558` | 󺰖 | `U+FAC16` | `reviewed_metadata_only` |
