# obs-comp-cand-001116 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001116`
- 首选外部 ID: `obimd-sub-59lmys7y2s`
- OBIMD subcharacter UID: `59lmys7y2s`
- OBIMD main character UID: `59lmys7y2s`
- 来源 ID: `src-obimd`
