# Material Visual Observation / obs-comp-cand-001113 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001113`
- External reference / 外部参照: `obimd-sub-doqvaj2vzu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015054_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/doqvaj2vzu/doqvaj2vzu/doqvaj2vzu.png`
- Checksum / 校验和:
  `178083c89f148f1eed298f1307d4781fe2ee1bb4b2e90967d2809745ba995b3e`
...
- Marked-pixel bounds: (82,26)–(162,218); span 81 × 193 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.70%。
- 痕迹范围：(82,26)–(162,218)；跨度81 × 193 px；痕迹矩形高于宽。
