# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000612
...
- EVOBC candidate category: `evobc-evo-cat-00612`.
- Source label for search only: `丌`.
- Source codepoints for search only: `U+4E0C`.
