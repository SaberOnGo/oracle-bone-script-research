# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000808
...
- EVOBC candidate category: `evobc-evo-cat-00808`.
- Source label for search only: `佚`.
- Source codepoints for search only: `U+4F5A`.
