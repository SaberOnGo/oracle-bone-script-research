...
- External category reference: `evobc-cat-10522`
- Source category ID: `10522`
- Source label for human review: `鶂`
- Source codepoints: `U+9D82`
...
- `obs-evo-cand-010522-route-category-staging`
...
- `obs-evo-cand-010522-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010522-route-evolution-graph`
