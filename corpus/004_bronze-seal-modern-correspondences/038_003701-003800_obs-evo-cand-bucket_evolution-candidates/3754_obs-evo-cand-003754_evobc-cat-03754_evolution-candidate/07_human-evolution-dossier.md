...
- Project ID: `obs-evo-cand-003754`
- EVOBC category candidate ID: `evobc-evo-cat-03754`
- External category reference: `evobc-cat-03754`
- Source category ID: `03754`
- Source label for human review: `晨`
- Source codepoints: `U+6668`
- Image reference count in source metadata: `102`
...
- `obs-evo-cand-003754-route-category-staging`
...
- `obs-evo-cand-003754-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003754-route-evolution-graph`
