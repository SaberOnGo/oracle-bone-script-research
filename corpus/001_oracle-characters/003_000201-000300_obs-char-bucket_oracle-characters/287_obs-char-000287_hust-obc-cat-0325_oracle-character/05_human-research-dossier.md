# obs-char-000287 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000287`
- primary external id: `hust-obc-cat-0325`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/287_obs-char-000287_hust-obc-cat-0325_orac
  le-character/03_visual-assets/001_asset-000292_hust-obc-cat-0325_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0325/G_0325_乙6273合10936賓組.png`
- asset id: `asset-000292`
...
- source category: `0325`
- validation class: `286`
- source image route: `HUST-OBC/deciphered/0325/G_0325_乙6273合10936賓組.png`
- asset id: `asset-000292`
...
- English observation: `The thin image has a long upright stroke at the
  left, a small angular mark near its upper end, and a separate rounded
  enclosure on the right.`
- 中文观察: `纤细图像左侧有长直立笔画，上端附近有小型折角痕迹，右侧另有分离的圆弧轮廓。`
...
- dataset label text: `㔻`
- dataset label codepoints: `U+353B`
...
- filename catalog route clues: `Heji-like filename clue: 合10936
  (G_0325_乙6273合10936賓組.png)`
...
- Which source records identify obs-char-000287 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000287？
