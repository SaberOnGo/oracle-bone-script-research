# obs-char-000202 Visual Gallery / obs-char-000202 图像资料页
...
- Primary external reference / 首选外部参考: `hust-obc-cat-0225`
...
## obs-char-000202-visual-source-001 / 图像条目

![obs-char-000202 glyph candidate](03_visual-assets/001_asset-000207_hust-obc-cat-0225_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000207_hust-obc-cat-0225_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000207_hust-obc-cat-0225_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/0225/G_0225_上(2).從(甲).9(楚).png`
