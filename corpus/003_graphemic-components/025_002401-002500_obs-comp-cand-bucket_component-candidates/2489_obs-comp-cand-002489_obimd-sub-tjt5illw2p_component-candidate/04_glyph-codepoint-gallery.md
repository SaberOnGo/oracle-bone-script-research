# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002489
...
| --- | --- | --- | --- |
| `obimd-glyph-link-038285` | 󾋰 | `U+FE2F0` | `reviewed_metadata_only` |
| `obimd-glyph-link-038286` | 󾋱 | `U+FE2F1` | `reviewed_metadata_only` |
| `obimd-glyph-link-038287` | 󾋳 | `U+FE2F3` | `reviewed_metadata_only` |
