# obs-unk-004538 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/038_obs-unk-004538_h
  ust-obc-und-X-004538_oracle-character-candidate/03_visual-assets/001_asset
  -006131_hust-obc-und-X-004538_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/94/X_？_8277_1.png`
- asset id: `asset-006131`
...
- source class: `HUST-OBC/undeciphered/X/94/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/94/X_？_8277_1.png`
- asset id: `asset-006131`
...
- English observation: `Bar, branches, and three open outlines recorded.`
- 中文观察: `已记录横痕、分支和三个开口轮廓。`
...
- Which source records identify obs-unk-004538 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004538？
