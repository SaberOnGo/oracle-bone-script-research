# obs-unk-001341 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-001341`
- primary external id: `hust-obc-und-L-001341`
...
- local review image route: `corpus/001_oracle-characters/030_undeciphered-001
  301-001400_obs-unk-bucket_oracle-character-candidates/041_obs-unk-001341_h
  ust-obc-und-L-001341_oracle-character-candidate/03_visual-assets/001_asset
  -002934_hust-obc-und-L-001341_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/1341/L_？_1380.jpg`
- asset id: `asset-002934`
...
- source class: `HUST-OBC/undeciphered/L/1341/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/1341/L_？_1380.jpg`
- asset id: `asset-002934`
...
- Which source records identify obs-unk-001341 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-001341？
