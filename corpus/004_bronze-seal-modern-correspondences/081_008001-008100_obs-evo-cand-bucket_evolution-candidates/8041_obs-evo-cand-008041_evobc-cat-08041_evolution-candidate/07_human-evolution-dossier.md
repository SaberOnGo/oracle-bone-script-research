...
Project ID: `obs-evo-cand-008041`
...
- Project ID: `obs-evo-cand-008041`
- EVOBC category candidate ID: `evobc-evo-cat-08041`
- External category reference: `evobc-cat-08041`
- Source category ID: `08041`
- Source label for human review: `襩`
- Source codepoints: `U+8969`
...
- `obs-evo-cand-008041-route-category-staging`
...
- `obs-evo-cand-008041-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008041-route-evolution-graph`
