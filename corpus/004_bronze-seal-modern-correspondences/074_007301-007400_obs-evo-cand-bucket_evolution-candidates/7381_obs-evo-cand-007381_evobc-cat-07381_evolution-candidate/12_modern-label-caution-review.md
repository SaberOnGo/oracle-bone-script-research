# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-007381
...
- EVOBC candidate category: `evobc-evo-cat-07381`.
- Source label for search only: `莜`.
- Source codepoints for search only: `U+839C`.
