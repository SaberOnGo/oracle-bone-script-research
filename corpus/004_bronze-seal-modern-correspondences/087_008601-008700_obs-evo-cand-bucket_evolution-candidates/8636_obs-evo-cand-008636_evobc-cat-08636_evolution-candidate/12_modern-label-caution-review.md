# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008636
...
- EVOBC candidate category: `evobc-evo-cat-08636`.
- Source label for search only: `贼`.
- Source codepoints for search only: `U+8D3C`.
