...
- Yingguo / 英国所藏: `y1953` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `427` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `76` in source row; primary catalog entry pending
- Heji / 合集: `40975` in source row; primary catalog entry pending
