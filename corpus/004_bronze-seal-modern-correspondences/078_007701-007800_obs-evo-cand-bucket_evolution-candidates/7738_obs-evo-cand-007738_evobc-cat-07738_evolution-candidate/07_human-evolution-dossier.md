...
- External category reference: `evobc-cat-07738`
- Source category ID: `07738`
- Source label for human review: `蚳`
- Source codepoints: `U+86B3`
...
- `obs-evo-cand-007738-route-category-staging`
...
- `obs-evo-cand-007738-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007738-route-evolution-graph`
