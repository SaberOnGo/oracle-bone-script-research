# Material Visual Observation / obs-comp-cand-000377 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000377`
- External reference / 外部参照: `obimd-sub-7fgd3fbmzi`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012300_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7fgd3fbmzi/7fgd3fbmzi/7fgd3fbmzi.png`
- Checksum / 校验和:
  `d098674845f3dee820e43f3d6e2f6259b357c69368b42e0e2ac7e72b6147cc4a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.67%.
- Marked-pixel bounds: (74,19)–(175,225); span 102 × 207 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.67%。
- 痕迹范围：(74,19)–(175,225)；跨度102 × 207 px；痕迹矩形高于宽。
