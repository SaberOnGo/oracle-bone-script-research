...
Project ID: `obs-evo-cand-001136`
...
- Project ID: `obs-evo-cand-001136`
- EVOBC category candidate ID: `evobc-evo-cat-01136`
- External category reference: `evobc-cat-01136`
- Source category ID: `01136`
- Source label for human review: `冯`
- Source codepoints: `U+51AF`
...
- `obs-evo-cand-001136-route-category-staging`
...
- `obs-evo-cand-001136-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001136-route-evolution-graph`
