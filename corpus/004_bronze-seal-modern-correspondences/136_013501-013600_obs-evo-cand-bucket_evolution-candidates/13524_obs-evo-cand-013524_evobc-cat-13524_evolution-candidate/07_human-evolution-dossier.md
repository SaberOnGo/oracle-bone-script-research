...
- External category reference: `evobc-cat-13524`
- Source category ID: `13524`
- Source label for human review: `𭝛`
...
- `obs-evo-cand-013524-route-category-staging`
...
- `obs-evo-cand-013524-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013524-route-evolution-graph`
