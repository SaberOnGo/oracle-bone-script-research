...
Project ID: `obs-evo-cand-011722`
...
- Project ID: `obs-evo-cand-011722`
- EVOBC category candidate ID: `evobc-evo-cat-11722`
- External category reference: `evobc-cat-11722`
- Source category ID: `11722`
- Source label for human review: `𤹿`
- Source codepoints: `U+24E7F`
...
- `obs-evo-cand-011722-route-category-staging`
...
- `obs-evo-cand-011722-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011722-route-evolution-graph`
