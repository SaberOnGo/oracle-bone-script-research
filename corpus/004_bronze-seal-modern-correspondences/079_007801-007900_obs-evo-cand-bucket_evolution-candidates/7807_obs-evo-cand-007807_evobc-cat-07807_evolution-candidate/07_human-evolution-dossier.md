...
- External category reference: `evobc-cat-07807`
- Source category ID: `07807`
- Source label for human review: `蝕`
...
- `obs-evo-cand-007807-route-category-staging`
...
- `obs-evo-cand-007807-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007807-route-evolution-graph`
