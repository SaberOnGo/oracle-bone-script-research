# Material Visual Observation / obs-comp-cand-001886 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001886`
- External reference / 外部参照: `obimd-sub-dj34rk4o3g`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018265_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wfyy86f1n0/dj34rk4o3g/dj34rk4o3g.png`
- Checksum / 校验和:
  `8608881e8728a07aa79995c447dbd2bbe7853c622bb9d27c69f06ed42f264416`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.15%.
- Marked-pixel bounds: (82,28)–(167,220); span 86 × 193 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.15%。
- 痕迹范围：(82,28)–(167,220)；跨度86 × 193 px；痕迹矩形高于宽。
