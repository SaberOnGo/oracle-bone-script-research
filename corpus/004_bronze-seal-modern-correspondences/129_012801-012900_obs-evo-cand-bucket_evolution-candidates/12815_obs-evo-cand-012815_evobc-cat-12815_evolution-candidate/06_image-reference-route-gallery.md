...
- `obs-evo-cand-012815-route-category-staging`
...
- `obs-evo-cand-012815-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012815-route-evolution-graph`
