...
- External category reference: `evobc-cat-04860`
- Source category ID: `04860`
- Source label for human review: `滿`
- Source codepoints: `U+6EFF`
...
- `obs-evo-cand-004860-route-category-staging`
...
- `obs-evo-cand-004860-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004860-route-evolution-graph`
