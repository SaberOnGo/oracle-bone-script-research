...
Project ID: `obs-evo-cand-012289`
...
- Project ID: `obs-evo-cand-012289`
- EVOBC category candidate ID: `evobc-evo-cat-12289`
- External category reference: `evobc-cat-12289`
- Source category ID: `12289`
- Source label for human review: `𧸘`
- Source codepoints: `U+27E18`
...
- `obs-evo-cand-012289-route-category-staging`
...
- `obs-evo-cand-012289-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012289-route-evolution-graph`
