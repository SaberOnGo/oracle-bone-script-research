# obs-evo-cand-002370 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-02370`
- Source label for human review: `宔`
- Source codepoints: `U+5B94`
- Image reference count: `25`
- Era token counts: `SAC:10;SS:1;WSC:14`
- Source token counts: `Book:24;Web:1`
