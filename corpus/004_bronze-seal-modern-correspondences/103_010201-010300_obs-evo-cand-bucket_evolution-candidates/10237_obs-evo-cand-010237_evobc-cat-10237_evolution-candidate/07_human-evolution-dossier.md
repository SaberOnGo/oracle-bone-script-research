...
- External category reference: `evobc-cat-10237`
- Source category ID: `10237`
- Source label for human review: `騶`
...
- `obs-evo-cand-010237-route-category-staging`
...
- `obs-evo-cand-010237-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010237-route-evolution-graph`
