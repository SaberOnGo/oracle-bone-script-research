...
- Yingguo / 英国所藏: `y1017` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `597` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `475` in source row; primary catalog entry pending
