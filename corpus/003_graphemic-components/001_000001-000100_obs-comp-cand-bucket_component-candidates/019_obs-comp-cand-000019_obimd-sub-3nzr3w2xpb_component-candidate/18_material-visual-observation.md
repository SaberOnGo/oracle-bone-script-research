# Material Visual Observation / obs-comp-cand-000019 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000019`
- External reference / 外部参照: `obimd-sub-3nzr3w2xpb`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011171_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3kadgutgs9/3nzr3w2xpb/3nzr3w2xpb.png`
- Checksum / 校验和:
  `91c3901b8214d87884c39c91bb2aef111fb0e4c65c5cc3efedffa0d20e2e6988`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 15.78%.
- Marked-pixel bounds: (33,26)–(216,221); span 184 × 196 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占15.78%。
- 痕迹范围：(33,26)–(216,221)；跨度184 × 196 px；痕迹矩形近方形。
