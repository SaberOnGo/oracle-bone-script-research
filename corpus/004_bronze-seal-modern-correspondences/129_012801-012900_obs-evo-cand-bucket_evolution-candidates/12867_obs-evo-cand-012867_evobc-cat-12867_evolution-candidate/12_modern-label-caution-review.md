# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012867
...
- Project ID: `obs-evo-cand-012867`.
- EVOBC candidate category: `evobc-evo-cat-12867`.
- Source label for search only: `𪲝`.
- Source codepoints for search only: `U+2AC9D`.
