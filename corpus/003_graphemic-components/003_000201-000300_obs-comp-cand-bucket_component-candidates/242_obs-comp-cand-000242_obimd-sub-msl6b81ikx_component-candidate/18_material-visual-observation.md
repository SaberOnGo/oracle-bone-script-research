# Material Visual Observation / obs-comp-cand-000242 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000242`
- External reference / 外部参照: `obimd-sub-msl6b81ikx`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011888_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/msl6b81ikx/msl6b81ikx/msl6b81ikx.png`
- Checksum / 校验和:
  `684da2c366fd9c5770fa0a9c93c6391d1ed34b33439a1dc9aa3da0e511b954b8`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.56%.
- Marked-pixel bounds: (65,38)–(184,208); span 120 × 171 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.56%。
- 痕迹范围：(65,38)–(184,208)；跨度120 × 171 px；痕迹矩形高于宽。
