...
- External category reference: `evobc-cat-04963`
- Source category ID: `04963`
- Source label for human review: `濜`
...
- `obs-evo-cand-004963-route-category-staging`
...
- `obs-evo-cand-004963-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004963-route-evolution-graph`
