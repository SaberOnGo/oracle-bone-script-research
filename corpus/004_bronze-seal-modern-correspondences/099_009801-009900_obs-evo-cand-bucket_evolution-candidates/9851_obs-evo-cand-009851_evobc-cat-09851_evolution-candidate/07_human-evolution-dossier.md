...
- External category reference: `evobc-cat-09851`
- Source category ID: `09851`
- Source label for human review: `霅`
- Source codepoints: `U+9705`
...
- `obs-evo-cand-009851-route-category-staging`
...
- `obs-evo-cand-009851-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009851-route-evolution-graph`
