# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001818
...
| Glyph or codepoint route / 字形或码位路线 | 106 OBIMD route rows; examples U+7592;U+75BE;U+FA655; U+FA656; 另有 104 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 106 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
