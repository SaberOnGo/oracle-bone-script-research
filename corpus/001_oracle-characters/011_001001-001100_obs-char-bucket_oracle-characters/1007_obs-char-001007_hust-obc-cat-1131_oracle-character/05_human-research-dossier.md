# obs-char-001007 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001007`
- primary external id: `hust-obc-cat-1131`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1007_obs-char-001007_hust-obc-cat-1131_ora
  cle-character/03_visual-assets/001_asset-001012_hust-obc-cat-1131_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1131/G_1131_甲骨文0.png`
- asset id: `asset-001012`
...
- source category: `1131`
- validation class: `1006`
- source image route: `HUST-OBC/deciphered/1131/G_1131_甲骨文0.png`
- asset id: `asset-001012`
...
- English observation: `A broad left U-shaped cluster appears beside a
  separate right upright branching cluster with a long descending terminal.`
- 中文观察: `宽大的左侧 U 形笔群旁有分离的右侧直立分枝笔群，并带长下行末笔。`
...
- dataset label text: `㡡`
- dataset label codepoints: `U+3861`
...
- Which source records identify obs-char-001007 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001007？
