# obs-char-000642 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/642_obs-char-000642_hust-obc-cat-0730_orac
  le-character/03_visual-assets/001_asset-000647_hust-obc-cat-0730_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0730/X_0730_1047_1.png`
- asset id: `asset-000647`
...
- source category: `0730`
- validation class: `641`
- source image route: `HUST-OBC/deciphered/0730/X_0730_1047_1.png`
- asset id: `asset-000647`
...
- English observation: `A dense bold upper cluster combines a rounded loop,
  long crossbar, and pointed hanging strokes; a separate right descent bends
  into an angular lower loop and long tail.`
...
- dataset label text: `㛐`
- dataset label codepoints: `U+36D0`
...
- Which source records identify obs-char-000642 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000642？
