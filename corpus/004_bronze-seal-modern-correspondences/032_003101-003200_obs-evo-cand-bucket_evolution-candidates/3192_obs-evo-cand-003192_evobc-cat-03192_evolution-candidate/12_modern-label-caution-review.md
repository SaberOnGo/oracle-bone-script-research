# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003192
...
- EVOBC candidate category: `evobc-evo-cat-03192`.
- Source label for search only: `懸`.
- Source codepoints for search only: `U+61F8`.
