# obs-unk-003995 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003995`
- primary external id: `hust-obc-und-L-003995`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/095_obs-unk-003995_h
  ust-obc-und-L-003995_oracle-character-candidate/03_visual-assets/001_asset
  -005588_hust-obc-und-L-003995_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3995/L_？_8454.jpg`
- asset id: `asset-005588`
...
- source class: `HUST-OBC/undeciphered/L/3995/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3995/L_？_8454.jpg`
- asset id: `asset-005588`
...
- English observation: A curved mark appears left of a compact enclosure-like
  outline; short strokes sit above and below in the tight crop.
- 中文观察：左侧有弯曲痕迹，旁边是较紧凑的围合状轮廓；上下各有短痕迹。
...
- Which source records identify obs-unk-003995 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003995？
