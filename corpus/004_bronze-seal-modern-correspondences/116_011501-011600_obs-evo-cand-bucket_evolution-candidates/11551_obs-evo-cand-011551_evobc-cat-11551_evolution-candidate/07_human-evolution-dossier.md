...
- Project ID: `obs-evo-cand-011551`
- EVOBC category candidate ID: `evobc-evo-cat-11551`
- External category reference: `evobc-cat-11551`
- Source category ID: `11551`
- Source label for human review: `𤄆`
- Source codepoints: `U+24106`
...
- `obs-evo-cand-011551-route-category-staging`
...
- `obs-evo-cand-011551-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011551-route-evolution-graph`
