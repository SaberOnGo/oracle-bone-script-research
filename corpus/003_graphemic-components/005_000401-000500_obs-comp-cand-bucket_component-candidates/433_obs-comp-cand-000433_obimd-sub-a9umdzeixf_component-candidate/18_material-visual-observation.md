# Material Visual Observation / obs-comp-cand-000433 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000433`
- External reference / 外部参照: `obimd-sub-a9umdzeixf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012356_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ewiqwj2bq8/a9umdzeixf/a9umdzeixf.png`
- Checksum / 校验和:
  `5b6da4df8c7daa90d05e27fd54e3773c98e16ef7124c81b6861c4bf3dea2b8ec`
...
- Marked-pixel bounds: (78,32)–(171,217); span 94 × 186 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.98%。
- 痕迹范围：(78,32)–(171,217)；跨度94 × 186 px；痕迹矩形高于宽。
