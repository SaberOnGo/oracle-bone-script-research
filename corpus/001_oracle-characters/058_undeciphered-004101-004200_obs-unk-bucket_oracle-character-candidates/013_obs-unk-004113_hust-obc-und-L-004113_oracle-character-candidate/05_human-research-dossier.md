# obs-unk-004113 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004113`
- primary external id: `hust-obc-und-L-004113`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/013_obs-unk-004113_h
  ust-obc-und-L-004113_oracle-character-candidate/03_visual-assets/001_asset
  -005706_hust-obc-und-L-004113_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4113/L_？_8849.jpg`
- asset id: `asset-005706`
...
- source class: `HUST-OBC/undeciphered/L/4113/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4113/L_？_8849.jpg`
- asset id: `asset-005706`
...
- English observation: The opened image shows two tall upper strokes, a dense
  middle cluster, and several descending lower traces.
- 中文观察：已打开图像可见两条高上部笔画、密集中部痕迹和下伸下部痕迹。
...
- Which source records identify obs-unk-004113 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004113？
