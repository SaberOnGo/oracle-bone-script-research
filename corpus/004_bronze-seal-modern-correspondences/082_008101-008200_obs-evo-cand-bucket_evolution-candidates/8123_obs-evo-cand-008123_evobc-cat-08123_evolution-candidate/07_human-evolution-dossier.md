...
- External category reference: `evobc-cat-08123`
- Source category ID: `08123`
- Source label for human review: `訄`
- Source codepoints: `U+8A04`
...
- `obs-evo-cand-008123-route-category-staging`
...
- `obs-evo-cand-008123-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008123-route-evolution-graph`
