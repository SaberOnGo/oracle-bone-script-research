# Material Visual Observation / obs-comp-cand-000061 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000061`
- External reference / 外部参照: `obimd-sub-hjfwaxkb60`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011474_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hjfwaxkb60/hjfwaxkb60/hjfwaxkb60.png`
- Checksum / 校验和:
  `a5fe6619e7c6ab9209e8c29729ceb35f60114d03fb7351b20f240c6b79b4b47d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.43%.
- Marked-pixel bounds: (65,48)–(184,193); span 120 × 146 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.43%。
- 痕迹范围：(65,48)–(184,193)；跨度120 × 146 px；痕迹矩形高于宽。
