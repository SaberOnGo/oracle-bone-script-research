# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013410
...
- EVOBC candidate category: `evobc-evo-cat-13410`.
- Source label for search only: `𬮊`.
- Source codepoints for search only: `U+2CB8A`.
