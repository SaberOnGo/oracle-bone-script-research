# obs-char-000292 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/292_obs-char-000292_hust-obc-cat-0331_orac
  le-character/03_visual-assets/001_asset-000297_hust-obc-cat-0331_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0331/G_0331_京都3016合22202子組.png`
- asset id: `asset-000297`
...
- source category: `0331`
- validation class: `291`
- source image route: `HUST-OBC/deciphered/0331/G_0331_京都3016合22202子組.png`
- asset id: `asset-000297`
...
- English observation: `The tall image contains a narrow rectangular
  framework with horizontal cross strokes and a small rounded enclosure at
  the lower end.`
- 中文观察: `高而狭的图像含窄长框架和数道横向交叉笔画，下端有小型圆弧闭合轮廓。`
...
- dataset label text: `㕁`
- dataset label codepoints: `U+3541`
...
- filename catalog route clues: `Heji-like filename clue: 合22202
...
- Which source records identify obs-char-000292 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000292？
