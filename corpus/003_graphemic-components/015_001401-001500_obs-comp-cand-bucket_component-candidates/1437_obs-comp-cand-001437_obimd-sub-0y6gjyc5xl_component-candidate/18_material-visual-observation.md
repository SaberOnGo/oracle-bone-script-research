# Material Visual Observation / obs-comp-cand-001437 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001437`
- External reference / 外部参照: `obimd-sub-0y6gjyc5xl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016014_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0y6gjyc5xl/0y6gjyc5xl/0y6gjyc5xl.png`
- Checksum / 校验和:
  `05e8814b79ffe602046e0fcb97310179ad0865c95884f027221c465d14943117`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.63%.
- Marked-pixel bounds: (56,19)–(193,226); span 138 × 208 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.63%。
- 痕迹范围：(56,19)–(193,226)；跨度138 × 208 px；痕迹矩形高于宽。
