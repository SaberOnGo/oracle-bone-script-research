...
Project ID: `obs-evo-cand-007150`
...
- Project ID: `obs-evo-cand-007150`
- EVOBC category candidate ID: `evobc-evo-cat-07150`
- External category reference: `evobc-cat-07150`
- Source category ID: `07150`
- Source label for human review: `臊`
- Source codepoints: `U+81CA`
...
- `obs-evo-cand-007150-route-category-staging`
...
- `obs-evo-cand-007150-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007150-route-evolution-graph`
