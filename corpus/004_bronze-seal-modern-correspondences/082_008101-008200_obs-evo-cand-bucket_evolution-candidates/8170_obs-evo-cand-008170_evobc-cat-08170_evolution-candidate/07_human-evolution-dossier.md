...
- External category reference: `evobc-cat-08170`
- Source category ID: `08170`
- Source label for human review: `詈`
- Source codepoints: `U+8A48`
...
- `obs-evo-cand-008170-route-category-staging`
...
- `obs-evo-cand-008170-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008170-route-evolution-graph`
