...
- Project ID: `obs-evo-cand-002149`
- EVOBC category candidate ID: `evobc-evo-cat-02149`
- External category reference: `evobc-cat-02149`
- Source category ID: `02149`
- Source label for human review: `姽`
- Source codepoints: `U+59FD`
...
- `obs-evo-cand-002149-route-category-staging`
...
- `obs-evo-cand-002149-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002149-route-evolution-graph`
