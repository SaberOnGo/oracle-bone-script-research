...
- External category reference: `evobc-cat-11856`
- Source category ID: `11856`
- Source label for human review: `𥨫`
...
- `obs-evo-cand-011856-route-category-staging`
...
- `obs-evo-cand-011856-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011856-route-evolution-graph`
