# obs-unk-004130 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004130`
- primary external id: `hust-obc-und-L-004130`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/030_obs-unk-004130_h
  ust-obc-und-L-004130_oracle-character-candidate/03_visual-assets/001_asset
  -005723_hust-obc-und-L-004130_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4130/L_？_8899.jpg`
- asset id: `asset-005723`
...
- source class: `HUST-OBC/undeciphered/L/4130/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4130/L_？_8899.jpg`
- asset id: `asset-005723`
...
- English observation: A compact upper mark extends rightward; a narrow
  vertical trace continues below with diagonal side marks.
- 中文观察：上部紧凑痕迹向右延出；下方窄竖向痕迹带斜向侧痕。
...
- Which source records identify obs-unk-004130 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004130？
