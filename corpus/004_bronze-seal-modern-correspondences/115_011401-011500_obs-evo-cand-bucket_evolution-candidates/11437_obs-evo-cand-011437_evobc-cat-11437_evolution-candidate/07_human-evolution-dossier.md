...
- External category reference: `evobc-cat-11437`
- Source category ID: `11437`
- Source label for human review: `𣓁`
- Source codepoints: `U+234C1`
...
- `obs-evo-cand-011437-route-category-staging`
...
- `obs-evo-cand-011437-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011437-route-evolution-graph`
