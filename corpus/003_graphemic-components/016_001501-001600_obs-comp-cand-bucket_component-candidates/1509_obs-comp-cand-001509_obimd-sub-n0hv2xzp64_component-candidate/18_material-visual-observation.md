# Material Visual Observation / obs-comp-cand-001509 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001509`
- External reference / 外部参照: `obimd-sub-n0hv2xzp64`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016472_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4r0g6bx5rc/n0hv2xzp64/n0hv2xzp64.png`
- Checksum / 校验和:
  `8cea94d6871f73f576e212d56993909518611d8536a8df4af99740e700ea5141`
...
- Marked-pixel bounds: (80,29)–(171,220); span 92 × 192 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.63%。
- 痕迹范围：(80,29)–(171,220)；跨度92 × 192 px；痕迹矩形高于宽。
