...
- External category reference: `evobc-cat-11566`
- Source category ID: `11566`
- Source label: `𤌊`
...
- `obs-evo-cand-011566-route-category-staging`
...
- `obs-evo-cand-011566-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011566-route-evolution-graph`
