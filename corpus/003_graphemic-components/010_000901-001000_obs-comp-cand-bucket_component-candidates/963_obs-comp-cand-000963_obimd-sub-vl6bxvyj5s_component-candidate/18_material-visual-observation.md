# Material Visual Observation / obs-comp-cand-000963 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000963`
- External reference / 外部参照: `obimd-sub-vl6bxvyj5s`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014046_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vl6bxvyj5s/vl6bxvyj5s/vl6bxvyj5s.png`
- Checksum / 校验和:
  `3f43a1f096926dee80fece21462dac2c88788da1c14bc19a731603c4c285a548`
...
- Marked-pixel bounds: (58,41)–(191,210); span 134 × 170 px; the marked
...
- 痕迹范围：(58,41)–(191,210)；跨度134 × 170 px；痕迹矩形高于宽。
