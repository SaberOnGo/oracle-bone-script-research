# obs-char-000202 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/202_obs-char-000202_hust-obc-cat-0225_orac
  le-character/03_visual-assets/001_asset-000207_hust-obc-cat-0225_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0225/G_0225_上(2).從(甲).9(楚).png`
- asset id: `asset-000207`
...
- source category: `0225`
- validation class: `201`
- source image route: `HUST-OBC/deciphered/0225/G_0225_上(2).從(甲).9(楚).png`
- asset id: `asset-000207`
...
- English observation: `The image has a dense upper branching cluster, a
  rounded lower-left loop, and a thin descending stroke on the right.`
...
- dataset label text: `㓗`
- dataset label codepoints: `U+34D7`
...
- Which source records identify obs-char-000202 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000202？
