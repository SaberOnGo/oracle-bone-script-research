...
Project ID: `obs-evo-cand-009935`
...
- Project ID: `obs-evo-cand-009935`
- EVOBC category candidate ID: `evobc-evo-cat-09935`
- External category reference: `evobc-cat-09935`
- Source category ID: `09935`
- Source label for human review: `韅`
- Source codepoints: `U+97C5`
...
- `obs-evo-cand-009935-route-category-staging`
...
- `obs-evo-cand-009935-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009935-route-evolution-graph`
