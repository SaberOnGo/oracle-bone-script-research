# obs-xwalk-cand-000370 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+359A` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-0420` | not reading |
