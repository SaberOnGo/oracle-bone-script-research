...
- External category reference: `evobc-cat-09184`
- Source category ID: `09184`
- Source label for human review: `鄍`
- Source codepoints: `U+910D`
...
- `obs-evo-cand-009184-route-category-staging`
...
- `obs-evo-cand-009184-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009184-route-evolution-graph`
