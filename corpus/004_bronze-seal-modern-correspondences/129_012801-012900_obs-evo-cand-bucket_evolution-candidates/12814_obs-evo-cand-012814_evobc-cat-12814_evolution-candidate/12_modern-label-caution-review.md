# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012814
...
- Project ID: `obs-evo-cand-012814`.
- EVOBC candidate category: `evobc-evo-cat-12814`.
- Source label for search only: `𪢽`.
- Source codepoints for search only: `U+2A8BD`.
