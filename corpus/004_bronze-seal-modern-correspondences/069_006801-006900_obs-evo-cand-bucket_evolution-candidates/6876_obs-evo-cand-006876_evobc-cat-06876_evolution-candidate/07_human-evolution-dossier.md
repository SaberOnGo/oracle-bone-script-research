...
- External category reference: `evobc-cat-06876`
- Source category ID: `06876`
- Source label for human review: `翊`
- Source codepoints: `U+7FCA`
...
- `obs-evo-cand-006876-route-category-staging`
...
- `obs-evo-cand-006876-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006876-route-evolution-graph`
