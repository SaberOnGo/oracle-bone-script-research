...
- External category reference: `evobc-cat-03869`
- Source category ID: `03869`
- Source label for human review: `杈`
- Source codepoints: `U+6748`
...
- `obs-evo-cand-003869-route-category-staging`
...
- `obs-evo-cand-003869-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003869-route-evolution-graph`
