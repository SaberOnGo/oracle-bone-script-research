...
- External category reference: `evobc-cat-12701`
- Source category ID: `12701`
- Source label for human review: `𩷑`
...
- `obs-evo-cand-012701-route-category-staging`
...
- `obs-evo-cand-012701-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012701-route-evolution-graph`
