...
- External category reference: `evobc-cat-06024`
- Source category ID: `06024`
- Source label for human review: `禘`
...
- `obs-evo-cand-006024-route-category-staging`
...
- `obs-evo-cand-006024-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006024-route-evolution-graph`
