...
Project ID: `obs-evo-cand-013275`
...
- Project ID: `obs-evo-cand-013275`
- EVOBC category candidate ID: `evobc-evo-cat-13275`
- External category reference: `evobc-cat-13275`
- Source category ID: `13275`
- Source label for human review: `𬔂`
- Source codepoints: `U+2C502`
...
- `obs-evo-cand-013275-route-category-staging`
...
- `obs-evo-cand-013275-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013275-route-evolution-graph`
