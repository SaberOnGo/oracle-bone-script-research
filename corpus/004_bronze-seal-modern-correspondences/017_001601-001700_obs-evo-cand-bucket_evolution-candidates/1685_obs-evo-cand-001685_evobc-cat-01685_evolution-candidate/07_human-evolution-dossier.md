...
Project ID: `obs-evo-cand-001685`
...
- Project ID: `obs-evo-cand-001685`
- EVOBC category candidate ID: `evobc-evo-cat-01685`
- External category reference: `evobc-cat-01685`
- Source category ID: `01685`
- Source label for human review: `嗾`
- Source codepoints: `U+55FE`
...
- `obs-evo-cand-001685-route-category-staging`
...
- `obs-evo-cand-001685-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001685-route-evolution-graph`
