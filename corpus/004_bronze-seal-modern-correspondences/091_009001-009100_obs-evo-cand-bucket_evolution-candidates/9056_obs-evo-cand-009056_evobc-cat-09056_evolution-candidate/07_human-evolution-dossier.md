...
- Project ID: `obs-evo-cand-009056`
- EVOBC category candidate ID: `evobc-evo-cat-09056`
- External category reference: `evobc-cat-09056`
- Source category ID: `09056`
- Source label for human review: `遱`
- Source codepoints: `U+9071`
...
- `obs-evo-cand-009056-route-category-staging`
...
- `obs-evo-cand-009056-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009056-route-evolution-graph`
