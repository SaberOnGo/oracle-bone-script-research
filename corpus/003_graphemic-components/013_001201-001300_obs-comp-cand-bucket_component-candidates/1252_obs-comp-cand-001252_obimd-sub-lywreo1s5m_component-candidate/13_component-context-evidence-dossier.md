# obs-comp-cand-001252 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001252`
- 首选外部 ID: `obimd-sub-lywreo1s5m`
- OBIMD subcharacter UID: `lywreo1s5m`
