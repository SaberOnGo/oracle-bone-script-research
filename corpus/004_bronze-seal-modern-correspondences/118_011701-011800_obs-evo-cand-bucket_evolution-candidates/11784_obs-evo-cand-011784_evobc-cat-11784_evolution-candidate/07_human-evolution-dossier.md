...
- External category reference: `evobc-cat-11784`
- Source category ID: `11784`
- Source label for human review: `𥈼`
- Source codepoints: `U+2523C`
...
- `obs-evo-cand-011784-route-category-staging`
...
- `obs-evo-cand-011784-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011784-route-evolution-graph`
