# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008545
...
- EVOBC candidate category: `evobc-evo-cat-08545`.
- Source label for search only: `責`.
- Source codepoints for search only: `U+8CAC`.
