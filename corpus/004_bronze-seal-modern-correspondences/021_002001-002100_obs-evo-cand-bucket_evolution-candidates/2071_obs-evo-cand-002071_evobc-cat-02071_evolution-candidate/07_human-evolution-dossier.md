...
- External category reference: `evobc-cat-02071`
- Source category ID: `02071`
- Source label for human review: `妆`
...
- `obs-evo-cand-002071-route-category-staging`
...
- `obs-evo-cand-002071-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002071-route-evolution-graph`
