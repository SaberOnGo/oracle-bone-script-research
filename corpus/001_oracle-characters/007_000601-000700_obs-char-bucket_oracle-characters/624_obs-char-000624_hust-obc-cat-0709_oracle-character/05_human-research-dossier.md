# obs-char-000624 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/624_obs-char-000624_hust-obc-cat-0709_orac
  le-character/03_visual-assets/001_asset-000629_hust-obc-cat-0709_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0709/G_0709_京津2004合32764歷組.png`
- asset id: `asset-000629`
...
- source category: `0709`
- validation class: `623`
- source image route: `HUST-OBC/deciphered/0709/G_0709_京津2004合32764歷組.png`
- asset id: `asset-000629`
...
- English observation: `Two detached groups stand side by side: a small
  squared open form at left and a tall right vertical with a hooked top,
  crossbar, and pointed lower spur.`
...
- dataset label text: `㚻`
- dataset label codepoints: `U+36BB`
...
- filename catalog route clues: `Heji-like filename clue: 合32764
...
- Which source records identify obs-char-000624 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000624？
