...
Project ID: `obs-evo-cand-007473`
...
- Project ID: `obs-evo-cand-007473`
- EVOBC category candidate ID: `evobc-evo-cat-07473`
- External category reference: `evobc-cat-07473`
- Source category ID: `07473`
- Source label for human review: `葠`
- Source codepoints: `U+8460`
...
- `obs-evo-cand-007473-route-category-staging`
...
- `obs-evo-cand-007473-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007473-route-evolution-graph`
