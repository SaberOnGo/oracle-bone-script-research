# Material Visual Observation / obs-comp-cand-001146 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001146`
- External reference / 外部参照: `obimd-sub-8pu7n71zyl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015281_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8pu7n71zyl/8pu7n71zyl/16dwre5y6a.png`
- Checksum / 校验和:
  `68d3533ce1e976dead0b1e85c0a4066972e0e215dde00049f414a44acc0dc3c9`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.92%.
- Marked-pixel bounds: (81,45)–(168,192); span 88 × 148 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.92%。
- 痕迹范围：(81,45)–(168,192)；跨度88 × 148 px；痕迹矩形高于宽。
