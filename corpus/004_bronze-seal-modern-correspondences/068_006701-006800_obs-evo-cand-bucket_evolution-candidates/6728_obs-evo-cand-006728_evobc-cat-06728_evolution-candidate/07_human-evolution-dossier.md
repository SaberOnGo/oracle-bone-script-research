...
- External category reference: `evobc-cat-06728`
- Source category ID: `06728`
- Source label for human review: `纯`
...
- `obs-evo-cand-006728-route-category-staging`
...
- `obs-evo-cand-006728-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006728-route-evolution-graph`
