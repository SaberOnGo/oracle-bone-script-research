...
Project ID: `obs-evo-cand-011791`
...
- Project ID: `obs-evo-cand-011791`
- EVOBC category candidate ID: `evobc-evo-cat-11791`
- External category reference: `evobc-cat-11791`
- Source category ID: `11791`
- Source label for human review: `𥍻`
- Source codepoints: `U+2537B`
...
- `obs-evo-cand-011791-route-category-staging`
...
- `obs-evo-cand-011791-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011791-route-evolution-graph`
