...
- External category reference: `evobc-cat-03992`
- Source category ID: `03992`
- Source label for human review: `栗`
- Source codepoints: `U+6817`
...
- `obs-evo-cand-003992-route-category-staging`
...
- `obs-evo-cand-003992-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003992-route-evolution-graph`
