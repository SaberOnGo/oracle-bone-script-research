# Material Visual Observation / obs-comp-cand-001436 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001436`
- External reference / 外部参照: `obimd-sub-yjzpdsoyyo`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016013_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/yjzpdsoyyo/yjzpdsoyyo/yjzpdsoyyo.png`
- Checksum / 校验和:
  `8e3493cf10871bb6044e6e480c5bc84bbb79d7e1eb426ea3fe0469c0a05a1929`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.05%.
- Marked-pixel bounds: (69,41)–(187,209); span 119 × 169 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.05%。
- 痕迹范围：(69,41)–(187,209)；跨度119 × 169 px；痕迹矩形高于宽。
