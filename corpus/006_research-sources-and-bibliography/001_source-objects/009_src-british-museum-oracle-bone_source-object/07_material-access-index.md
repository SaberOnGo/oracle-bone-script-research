# src-british-museum-oracle-bone Material Access Index / src-british-museum-oracle-bone 资料访问索引
...
| --- | --- | --- | --- |
| Source summary / 来源摘要 | `README.md` | present | source ID `src-british-museum-oracle-bone` |
| Human review sheet / 人工复核表 | `06_human-source-review-sheet.md` | present | source provenance and rights checklist |
| Download or access routes / 下载或访问路线 | `02_download-route-index.csv` | route_rows_present | 1 route row(s); statuses: http_error |
...
| Downloaded metadata profiles / 已下载 metadata profile | `05_metadata-profile-route-index.csv` | not_present_in_current_registers | 0 row(s); metrics: none |
