# Material Visual Observation / obs-comp-cand-000885 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000885`
- External reference / 外部参照: `obimd-sub-tyqkqh42tt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013957_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bwfz1jvlck/tyqkqh42tt/tyqkqh42tt.png`
- Checksum / 校验和:
  `0c73ab02a315d3d9e8b62b58e2f9547cc2ab07d06dc3b38e45555e144f298fdb`
...
- Marked-pixel bounds: (82,38)–(178,212); span 97 × 175 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.11%。
- 痕迹范围：(82,38)–(178,212)；跨度97 × 175 px；痕迹矩形高于宽。
