# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000991
...
| Glyph or codepoint route / 字形或码位路线 | 26 OBIMD route rows; examples U+F5A09; U+F5A0A; 另有 24 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
