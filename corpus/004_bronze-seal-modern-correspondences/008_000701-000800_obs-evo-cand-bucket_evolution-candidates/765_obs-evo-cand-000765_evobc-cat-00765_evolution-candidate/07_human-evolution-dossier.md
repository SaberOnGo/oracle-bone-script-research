...
- External category reference: `evobc-cat-00765`
- Source category ID: `00765`
- Source label for human review: `伋`
...
- `obs-evo-cand-000765-route-category-staging`
...
- `obs-evo-cand-000765-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000765-route-evolution-graph`
