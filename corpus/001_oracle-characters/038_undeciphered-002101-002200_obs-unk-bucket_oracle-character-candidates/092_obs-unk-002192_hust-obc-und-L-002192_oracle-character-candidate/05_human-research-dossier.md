# obs-unk-002192 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002192`
- primary external id: `hust-obc-und-L-002192`
...
- local review image route: `corpus/001_oracle-characters/038_undeciphered-002
  101-002200_obs-unk-bucket_oracle-character-candidates/092_obs-unk-002192_h
  ust-obc-und-L-002192_oracle-character-candidate/03_visual-assets/001_asset
  -003785_hust-obc-und-L-002192_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2192/L_？_2597.jpg`
- asset id: `asset-003785`
...
- source class: `HUST-OBC/undeciphered/L/2192/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2192/L_？_2597.jpg`
- asset id: `asset-003785`
...
- Which source records identify obs-unk-002192 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002192？
