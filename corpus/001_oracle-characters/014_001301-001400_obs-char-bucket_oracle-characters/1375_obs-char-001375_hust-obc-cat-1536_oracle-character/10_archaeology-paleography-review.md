# obs-char-001375 Archaeology Paleography Review

# obs-char-001375 考古文字复核档案
...
- first local image: `001_asset-001380_hust-obc-cat-1536_glyph.png`
- first source image: `G_1536_前2.8.3(甲).png`
...
- source label text: `㧶`
- source label codepoints: `U+39F6`
