...
Project ID: `obs-evo-cand-004894`
...
- Project ID: `obs-evo-cand-004894`
- EVOBC category candidate ID: `evobc-evo-cat-04894`
- External category reference: `evobc-cat-04894`
- Source category ID: `04894`
- Source label for human review: `潒`
- Source codepoints: `U+6F52`
...
- `obs-evo-cand-004894-route-category-staging`
...
- `obs-evo-cand-004894-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004894-route-evolution-graph`
