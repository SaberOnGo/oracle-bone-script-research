# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004754
...
- EVOBC candidate category: `evobc-evo-cat-04754`.
- Source label for search only: `渚`.
- Source codepoints for search only: `U+6E1A`.
