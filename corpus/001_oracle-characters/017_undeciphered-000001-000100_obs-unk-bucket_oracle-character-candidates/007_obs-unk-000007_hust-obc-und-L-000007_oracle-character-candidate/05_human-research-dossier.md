# obs-unk-000007 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000007`
- primary external id: `hust-obc-und-L-000007`
...
- local review image route: `corpus/001_oracle-characters/017_undeciphered-000
  001-000100_obs-unk-bucket_oracle-character-candidates/007_obs-unk-000007_h
  ust-obc-und-L-000007_oracle-character-candidate/03_visual-assets/001_asset
  -001600_hust-obc-und-L-000007_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/7/L_？_10031.jpg`
- asset id: `asset-001600`
...
- source class: `HUST-OBC/undeciphered/L/7/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/7/L_？_10031.jpg`
- asset id: `asset-001600`
...
- Which source records identify obs-unk-000007 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000007？
