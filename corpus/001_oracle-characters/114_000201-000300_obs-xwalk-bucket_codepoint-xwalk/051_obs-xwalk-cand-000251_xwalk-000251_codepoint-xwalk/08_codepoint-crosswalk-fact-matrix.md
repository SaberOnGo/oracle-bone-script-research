# obs-xwalk-cand-000251 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+350D` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-0279` | not reading |
