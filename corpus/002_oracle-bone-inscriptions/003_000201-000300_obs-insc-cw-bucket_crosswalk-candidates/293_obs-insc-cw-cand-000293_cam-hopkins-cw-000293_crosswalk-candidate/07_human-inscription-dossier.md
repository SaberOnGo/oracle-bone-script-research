...
Project ID: `obs-insc-cw-cand-000293`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000293`
...
- Yingguo / 英国所藏: `y1924` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `420` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `122` in source row; primary catalog entry pending
- Heji / 合集: `40926` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000293`
