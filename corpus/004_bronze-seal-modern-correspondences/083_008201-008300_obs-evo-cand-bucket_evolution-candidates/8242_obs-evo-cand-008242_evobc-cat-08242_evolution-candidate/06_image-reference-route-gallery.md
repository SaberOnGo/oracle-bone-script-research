...
- `obs-evo-cand-008242-route-category-staging`
...
- `obs-evo-cand-008242-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008242-route-evolution-graph`
