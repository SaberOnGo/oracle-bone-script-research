...
- `obs-evo-cand-013522-route-category-staging`
...
- `obs-evo-cand-013522-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013522-route-evolution-graph`
