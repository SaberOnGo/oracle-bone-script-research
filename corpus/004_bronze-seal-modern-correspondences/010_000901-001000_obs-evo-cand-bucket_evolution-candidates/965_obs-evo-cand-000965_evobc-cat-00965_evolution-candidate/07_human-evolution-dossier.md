...
- External category reference: `evobc-cat-00965`
- Source category ID: `00965`
...
- `obs-evo-cand-000965-route-category-staging`
...
- `obs-evo-cand-000965-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000965-route-evolution-graph`
