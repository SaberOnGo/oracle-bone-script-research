...
- Yingguo / 英国所藏: `y2344` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `585` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `101` in source row; primary catalog entry pending
