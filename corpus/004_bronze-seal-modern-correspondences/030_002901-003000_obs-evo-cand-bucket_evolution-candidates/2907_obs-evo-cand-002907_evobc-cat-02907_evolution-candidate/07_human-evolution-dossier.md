...
- External category reference: `evobc-cat-02907`
- Source category ID: `02907`
- Source label for human review: `忘`
- Source codepoints: `U+5FD8`
...
- `obs-evo-cand-002907-route-category-staging`
...
- `obs-evo-cand-002907-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002907-route-evolution-graph`
