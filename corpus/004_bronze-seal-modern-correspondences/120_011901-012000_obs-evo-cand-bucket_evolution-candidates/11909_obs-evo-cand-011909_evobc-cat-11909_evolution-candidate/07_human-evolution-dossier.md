...
Project ID: `obs-evo-cand-011909`
...
- Project ID: `obs-evo-cand-011909`
- EVOBC category candidate ID: `evobc-evo-cat-11909`
- External category reference: `evobc-cat-11909`
- Source category ID: `11909`
- Source label for human review: `𥷉`
- Source codepoints: `U+25DC9`
...
- `obs-evo-cand-011909-route-category-staging`
...
- `obs-evo-cand-011909-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011909-route-evolution-graph`
