...
- External category reference: `evobc-cat-02881`
- Source category ID: `02881`
- Source label for human review: `徧`
- Source codepoints: `U+5FA7`
...
- `obs-evo-cand-002881-route-category-staging`
...
- `obs-evo-cand-002881-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002881-route-evolution-graph`
