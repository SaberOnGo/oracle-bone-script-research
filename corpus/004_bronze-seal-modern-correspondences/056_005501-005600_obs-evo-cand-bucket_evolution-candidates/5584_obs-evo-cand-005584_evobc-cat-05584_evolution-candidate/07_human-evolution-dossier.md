...
Project ID: `obs-evo-cand-005584`
...
- Project ID: `obs-evo-cand-005584`
- EVOBC category candidate ID: `evobc-evo-cat-05584`
- External category reference: `evobc-cat-05584`
- Source category ID: `05584`
- Source label for human review: `畴`
- Source codepoints: `U+7574`
...
- `obs-evo-cand-005584-route-category-staging`
...
- `obs-evo-cand-005584-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005584-route-evolution-graph`
