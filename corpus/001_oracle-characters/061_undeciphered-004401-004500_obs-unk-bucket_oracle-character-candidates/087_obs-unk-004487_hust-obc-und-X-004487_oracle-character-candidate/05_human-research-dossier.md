# obs-unk-004487 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004487`
- primary external id: `hust-obc-und-X-004487`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/087_obs-unk-004487_h
  ust-obc-und-X-004487_oracle-character-candidate/03_visual-assets/001_asset
  -006080_hust-obc-und-X-004487_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/43/X_？_8224_1.png`
- asset id: `asset-006080`
...
- source class: `HUST-OBC/undeciphered/X/43/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/43/X_？_8224_1.png`
- asset id: `asset-006080`
...
- English observation: Isolated upper bars sit above a branching form with a
  small opening and multiple lower terminals.
- 中文观察: 孤立上部横痕位于带小开口和多条下部末端的分支痕迹之上。
...
- Which source records identify obs-unk-004487 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004487？
