# obs-char-001055 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1055_obs-char-001055_hust-obc-cat-1182_ora
  cle-character/03_visual-assets/001_asset-001060_hust-obc-cat-1182_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1182/G_1182_甲骨文.png`
- asset id: `asset-001060`
...
- source category: `1182`
- validation class: `1054`
- source image route: `HUST-OBC/deciphered/1182/G_1182_甲骨文.png`
- asset id: `asset-001060`
...
- English observation: `A complex upright cluster combines long left
  strokes, small detached upper marks, and a compact stacked right cluster.`
...
- dataset label text: `㢔`
- dataset label codepoints: `U+3894`
...
- Which source records identify obs-char-001055 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001055？
