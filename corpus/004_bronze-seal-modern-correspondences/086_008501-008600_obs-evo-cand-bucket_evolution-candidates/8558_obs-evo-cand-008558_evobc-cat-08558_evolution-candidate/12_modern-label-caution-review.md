# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008558
...
- EVOBC candidate category: `evobc-evo-cat-08558`.
- Source label for search only: `貼`.
- Source codepoints for search only: `U+8CBC`.
