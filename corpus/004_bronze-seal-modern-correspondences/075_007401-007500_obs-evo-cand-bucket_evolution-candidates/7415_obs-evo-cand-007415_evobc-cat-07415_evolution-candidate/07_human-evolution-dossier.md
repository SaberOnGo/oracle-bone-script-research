...
- External category reference: `evobc-cat-07415`
- Source category ID: `07415`
- Source label for human review: `菡`
- Source codepoints: `U+83E1`
...
- `obs-evo-cand-007415-route-category-staging`
...
- `obs-evo-cand-007415-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007415-route-evolution-graph`
