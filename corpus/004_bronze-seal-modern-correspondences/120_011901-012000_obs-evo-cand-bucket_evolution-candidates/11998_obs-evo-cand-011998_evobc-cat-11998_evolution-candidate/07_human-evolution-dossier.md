...
Project ID: `obs-evo-cand-011998`
...
- Project ID: `obs-evo-cand-011998`
- EVOBC category candidate ID: `evobc-evo-cat-11998`
- External category reference: `evobc-cat-11998`
- Source category ID: `11998`
- Source label for human review: `𦍧`
- Source codepoints: `U+26367`
...
- `obs-evo-cand-011998-route-category-staging`
...
- `obs-evo-cand-011998-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011998-route-evolution-graph`
