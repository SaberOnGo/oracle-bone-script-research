...
- External category reference: `evobc-cat-10572`
- Source category ID: `10572`
- Source label for human review: `鸃`
...
- `obs-evo-cand-010572-route-category-staging`
...
- `obs-evo-cand-010572-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010572-route-evolution-graph`
