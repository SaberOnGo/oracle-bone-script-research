# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002463
...
- EVOBC candidate category: `evobc-evo-cat-02463`.
- Source label for search only: `尋`.
- Source codepoints for search only: `U+5C0B`.
