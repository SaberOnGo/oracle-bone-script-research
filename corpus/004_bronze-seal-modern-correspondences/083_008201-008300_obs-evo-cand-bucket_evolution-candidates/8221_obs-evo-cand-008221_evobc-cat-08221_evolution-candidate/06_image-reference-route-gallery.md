...
- `obs-evo-cand-008221-route-category-staging`
...
- `obs-evo-cand-008221-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008221-route-evolution-graph`
