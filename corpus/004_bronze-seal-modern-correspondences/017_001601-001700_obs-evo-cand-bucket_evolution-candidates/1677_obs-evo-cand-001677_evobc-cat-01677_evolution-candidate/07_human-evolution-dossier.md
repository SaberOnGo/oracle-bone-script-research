...
Project ID: `obs-evo-cand-001677`
...
- Project ID: `obs-evo-cand-001677`
- EVOBC category candidate ID: `evobc-evo-cat-01677`
- External category reference: `evobc-cat-01677`
- Source category ID: `01677`
- Source label for human review: `嗞`
- Source codepoints: `U+55DE`
...
- `obs-evo-cand-001677-route-category-staging`
...
- `obs-evo-cand-001677-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001677-route-evolution-graph`
