...
- External category reference: `evobc-cat-01376`
- Source category ID: `01376`
- Source label for human review: `協`
- Source codepoints: `U+5354`
- Image reference count in source metadata: `48`
...
- `obs-evo-cand-001376-route-category-staging`
...
- `obs-evo-cand-001376-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001376-route-evolution-graph`
