...
- External category reference: `evobc-cat-09987`
- Source category ID: `09987`
- Source label for human review: `頞`
...
- `obs-evo-cand-009987-route-category-staging`
...
- `obs-evo-cand-009987-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009987-route-evolution-graph`
