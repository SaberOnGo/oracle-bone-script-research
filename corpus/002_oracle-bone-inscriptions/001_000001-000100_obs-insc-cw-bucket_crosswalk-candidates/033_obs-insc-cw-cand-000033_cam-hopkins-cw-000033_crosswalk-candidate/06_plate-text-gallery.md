...
Project ID: `obs-insc-cw-cand-000033`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000033`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000033` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y192` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `184` [route_present_image_or_text_not_collected]
