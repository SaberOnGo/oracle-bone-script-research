...
- External category reference: `evobc-cat-02597`
- Source category ID: `02597`
- Source label for human review: `嶧`
...
- `obs-evo-cand-002597-route-category-staging`
...
- `obs-evo-cand-002597-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002597-route-evolution-graph`
