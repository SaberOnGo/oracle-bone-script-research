...
Project ID: `obs-evo-cand-001848`
...
- Project ID: `obs-evo-cand-001848`
- EVOBC category candidate ID: `evobc-evo-cat-01848`
- External category reference: `evobc-cat-01848`
- Source category ID: `01848`
- Source label for human review: `垑`
- Source codepoints: `U+5791`
...
- `obs-evo-cand-001848-route-category-staging`
...
- `obs-evo-cand-001848-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001848-route-evolution-graph`
