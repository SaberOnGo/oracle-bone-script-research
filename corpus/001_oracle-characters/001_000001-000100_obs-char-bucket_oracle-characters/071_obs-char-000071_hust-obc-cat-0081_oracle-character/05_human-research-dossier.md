# obs-char-000071 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000071`
- primary external id: `hust-obc-cat-0081`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/071_obs-char-000071_hust-obc-cat-0081_orac
  le-character/03_visual-assets/001_asset-000076_hust-obc-cat-0081_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0081/G_0081_甲骨文.png`
- asset id: `asset-000076`
...
- source category: `0081`
- validation class: `70`
- source image route: `HUST-OBC/deciphered/0081/G_0081_甲骨文.png`
- asset id: `asset-000076`
...
- English observation: `The tiny image contains one short, thick horizontal
  stroke with slightly uneven edges.`
- 中文观察: `微小图像只有一条短而粗的横向笔画，边缘略不均匀。`
...
- dataset label text: `㑇`
- dataset label codepoints: `U+3447`
...
- Which source records identify obs-char-000071 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000071？
