...
Project ID: `obs-evo-cand-002636`
...
- Project ID: `obs-evo-cand-002636`
- EVOBC category candidate ID: `evobc-evo-cat-02636`
- External category reference: `evobc-cat-02636`
- Source category ID: `02636`
- Source label for human review: `币`
- Source codepoints: `U+5E01`
...
- `obs-evo-cand-002636-route-category-staging`
...
- `obs-evo-cand-002636-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002636-route-evolution-graph`
