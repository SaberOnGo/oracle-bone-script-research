...
Project ID: `obs-evo-cand-002308`
...
- Project ID: `obs-evo-cand-002308`
- EVOBC category candidate ID: `evobc-evo-cat-02308`
- External category reference: `evobc-cat-02308`
- Source category ID: `02308`
- Source label for human review: `嬭`
- Source codepoints: `U+5B2D`
...
- `obs-evo-cand-002308-route-category-staging`
...
- `obs-evo-cand-002308-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002308-route-evolution-graph`
