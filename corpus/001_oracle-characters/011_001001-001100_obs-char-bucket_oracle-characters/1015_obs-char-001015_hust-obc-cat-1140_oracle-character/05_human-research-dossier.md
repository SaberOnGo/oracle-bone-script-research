# obs-char-001015 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001015`
- primary external id: `hust-obc-cat-1140`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1015_obs-char-001015_hust-obc-cat-1140_ora
  cle-character/03_visual-assets/001_asset-001020_hust-obc-cat-1140_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1140/G_1140_乙4678合22050午組.png`
- asset id: `asset-001020`
...
- source category: `1140`
- validation class: `1014`
- source image route: `HUST-OBC/deciphered/1140/G_1140_乙4678合22050午組.png`
- asset id: `asset-001020`
...
- English observation: `A long upright stroke descends into a small angular
  lower enclosure that extends to a pointed right terminal.`
...
- dataset label text: `㡪`
- dataset label codepoints: `U+386A`
...
- filename catalog route clues: `Heji-like filename clue: 合22050
  (G_1140_乙4678合22050午組.png)`
...
- Which source records identify obs-char-001015 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001015？
