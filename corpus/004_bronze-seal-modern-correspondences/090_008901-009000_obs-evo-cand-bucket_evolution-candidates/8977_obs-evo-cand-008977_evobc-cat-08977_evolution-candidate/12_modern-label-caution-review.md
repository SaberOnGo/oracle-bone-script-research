# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008977
...
- EVOBC candidate category: `evobc-evo-cat-08977`.
- Source label for search only: `迾`.
- Source codepoints for search only: `U+8FFE`.
