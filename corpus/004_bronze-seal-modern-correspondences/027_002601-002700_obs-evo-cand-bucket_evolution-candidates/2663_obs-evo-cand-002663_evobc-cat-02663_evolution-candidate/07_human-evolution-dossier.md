...
- External category reference: `evobc-cat-02663`
- Source category ID: `02663`
- Source label for human review: `帴`
- Source codepoints: `U+5E34`
...
- `obs-evo-cand-002663-route-category-staging`
...
- `obs-evo-cand-002663-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002663-route-evolution-graph`
