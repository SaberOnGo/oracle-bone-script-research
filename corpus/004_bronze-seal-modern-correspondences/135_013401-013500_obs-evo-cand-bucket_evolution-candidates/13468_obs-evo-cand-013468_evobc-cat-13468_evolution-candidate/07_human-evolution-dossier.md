...
- External category reference: `evobc-cat-13468`
- Source category ID: `13468`
- Source label for human review: `𬿎`
- Source codepoints: `U+2CFCE`
...
- `obs-evo-cand-013468-route-category-staging`
...
- `obs-evo-cand-013468-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013468-route-evolution-graph`
