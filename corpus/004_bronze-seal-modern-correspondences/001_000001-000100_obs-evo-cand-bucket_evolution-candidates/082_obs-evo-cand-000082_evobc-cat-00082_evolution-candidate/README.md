# obs-evo-cand-000082 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-00082`
- Source label for human review: `㞝`
- Source codepoints: `U+379D`
- Image reference count: `31`
- Era token counts: `WSC:31`
- Source token counts: `Book:31`
