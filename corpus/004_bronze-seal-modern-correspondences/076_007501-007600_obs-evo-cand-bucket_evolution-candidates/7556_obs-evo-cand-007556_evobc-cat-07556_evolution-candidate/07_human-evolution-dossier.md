...
Project ID: `obs-evo-cand-007556`
...
- Project ID: `obs-evo-cand-007556`
- EVOBC category candidate ID: `evobc-evo-cat-07556`
- External category reference: `evobc-cat-07556`
- Source category ID: `07556`
- Source label for human review: `蔞`
- Source codepoints: `U+851E`
...
- `obs-evo-cand-007556-route-category-staging`
...
- `obs-evo-cand-007556-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007556-route-evolution-graph`
