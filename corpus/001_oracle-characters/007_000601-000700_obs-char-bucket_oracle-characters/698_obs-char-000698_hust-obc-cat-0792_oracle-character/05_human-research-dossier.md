# obs-char-000698 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/698_obs-char-000698_hust-obc-cat-0792_orac
  le-character/03_visual-assets/001_asset-000703_hust-obc-cat-0792_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0792/G_0792_合22942出組.png`
- asset id: `asset-000703`
...
- source category: `0792`
- validation class: `697`
- source image route: `HUST-OBC/deciphered/0792/G_0792_合22942出組.png`
- asset id: `asset-000703`
...
- English observation: `A tall left upright branches at mid-height and joins
  a rounded rectangular loop at its base; a separate thin slanting branched
  stroke descends at right.`
- 中文观察: `高长左竖在中部出枝，并连接底部圆角矩形环；右侧另有纤细分枝斜笔下垂。`
...
- dataset label text: `㜎`
- dataset label codepoints: `U+370E`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00060`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00060`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00060`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/060_obs-evo-can
  d-000060_evobc-cat-00060_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/060_obs-evo-cand-000060_evobc-cat-00060_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合22942
  (G_0792_合22942出組.png)`
...
- Which source records identify obs-char-000698 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000698？
