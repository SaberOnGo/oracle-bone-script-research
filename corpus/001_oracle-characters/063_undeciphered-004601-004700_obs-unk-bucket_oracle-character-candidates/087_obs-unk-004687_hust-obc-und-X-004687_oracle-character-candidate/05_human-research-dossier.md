# obs-unk-004687 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/087_obs-unk-004687_h
  ust-obc-und-X-004687_oracle-character-candidate/03_visual-assets/001_asset
  -006280_hust-obc-und-X-004687_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/243/X_？_8411_1.png`
- asset id: `asset-006280`
...
- source class: `HUST-OBC/undeciphered/X/243/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/243/X_？_8411_1.png`
- asset id: `asset-006280`
...
- English observation: `outlined upper cap with lower crossings; views pending`
- 中文观察: `带下部交叉和上部外线的轮廓形，视图待取`
...
- Which source records identify obs-unk-004687 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004687？
