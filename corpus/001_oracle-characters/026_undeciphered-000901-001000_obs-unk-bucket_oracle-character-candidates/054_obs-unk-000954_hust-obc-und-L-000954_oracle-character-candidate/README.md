# obs-unk-000954 Local Object Materials / obs-unk-000954 本地对象资料
...
- Local review image / 本地复核图像: `03_visual-assets/001_asset-002547_hust-obc-und-L-000954_glyph.jpg`

## Object Summary / 对象摘要

- Project ID / 项目 ID: `obs-unk-000954`
- Primary external reference / 首选外部参考: `hust-obc-und-L-000954`
- Source group / 来源分组: `L` (Oracle Bone Script: Six Digit Numerical Code)
- Source class path / 来源分类路径: `HUST-OBC/undeciphered/L/954/`
- Source image path / 来源图像路径: `HUST-OBC/undeciphered/L/954/L_？_12693.jpg`
- Asset ID / 资产 ID: `asset-002547`
