...
- `obs-evo-cand-002025-route-category-staging`
...
- `obs-evo-cand-002025-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002025-route-evolution-graph`
