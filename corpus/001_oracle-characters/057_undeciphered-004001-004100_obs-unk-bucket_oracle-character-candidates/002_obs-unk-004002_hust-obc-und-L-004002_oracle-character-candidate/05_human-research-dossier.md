# obs-unk-004002 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/002_obs-unk-004002_h
  ust-obc-und-L-004002_oracle-character-candidate/03_visual-assets/001_asset
  -005595_hust-obc-und-L-004002_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4002/L_？_8492.jpg`
- asset id: `asset-005595`
...
- source class: `HUST-OBC/undeciphered/L/4002/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4002/L_？_8492.jpg`
- asset id: `asset-005595`
...
- English observation: An angular closed outline occupies the crop, with a
  crossing trace through its center.
...
- Which source records identify obs-unk-004002 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004002？
