...
- External category reference: `evobc-cat-05085`
- Source category ID: `05085`
- Source label for human review: `焌`
- Source codepoints: `U+710C`
...
- `obs-evo-cand-005085-route-category-staging`
...
- `obs-evo-cand-005085-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005085-route-evolution-graph`
