...
- External category reference: `evobc-cat-07402`
- Source category ID: `07402`
- Source label for human review: `菅`
...
- `obs-evo-cand-007402-route-category-staging`
...
- `obs-evo-cand-007402-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007402-route-evolution-graph`
