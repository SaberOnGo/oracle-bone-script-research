...
- External category reference: `evobc-cat-05344`
- Source category ID: `05344`
- Source label for human review: `玉`
- Source codepoints: `U+7389`
- Image reference count in source metadata: `150`
...
- `obs-evo-cand-005344-route-category-staging`
...
- `obs-evo-cand-005344-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005344-route-evolution-graph`
