...
Project ID: `obs-evo-cand-008761`
...
- Project ID: `obs-evo-cand-008761`
- EVOBC category candidate ID: `evobc-evo-cat-08761`
- External category reference: `evobc-cat-08761`
- Source category ID: `08761`
- Source label for human review: `蹟`
- Source codepoints: `U+8E5F`
...
- `obs-evo-cand-008761-route-category-staging`
...
- `obs-evo-cand-008761-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008761-route-evolution-graph`
