...
- External category reference: `evobc-cat-13364`
- Source category ID: `13364`
- Source label for human review: `𬨲`
- Source codepoints: `U+2CA32`
...
- `obs-evo-cand-013364-route-category-staging`
...
- `obs-evo-cand-013364-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013364-route-evolution-graph`
