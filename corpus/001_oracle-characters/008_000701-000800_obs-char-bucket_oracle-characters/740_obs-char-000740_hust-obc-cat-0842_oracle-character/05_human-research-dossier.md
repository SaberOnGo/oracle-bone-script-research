# obs-char-000740 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000740`
- primary external id: `hust-obc-cat-0842`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/740_obs-char-000740_hust-obc-cat-0842_orac
  le-character/03_visual-assets/001_asset-000745_hust-obc-cat-0842_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0842/G_0842_乙1121合21873子組.png`
- asset id: `asset-000745`
...
- source category: `0842`
- validation class: `739`
- source image route: `HUST-OBC/deciphered/0842/G_0842_乙1121合21873子組.png`
- asset id: `asset-000745`
...
- English observation: `A nearly symmetrical central upright forks at the
  top, passes through a rounded divided middle frame, and ends in several
  short outward-spreading lower branches.`
- 中文观察: `近对称中央竖笔在顶部分叉，穿过带分隔的圆弯中框，末端伸出数条向外展开的短下枝。`
...
- dataset label text: `㝀`
- dataset label codepoints: `U+3740`
...
- filename catalog route clues: `Heji-like filename clue: 合21873
  (G_0842_乙1121合21873子組.png)`
...
- Which source records identify obs-char-000740 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000740？
