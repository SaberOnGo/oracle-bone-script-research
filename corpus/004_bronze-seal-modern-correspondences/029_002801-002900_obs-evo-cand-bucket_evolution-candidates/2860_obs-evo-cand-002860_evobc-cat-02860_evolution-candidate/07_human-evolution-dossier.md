...
Project ID: `obs-evo-cand-002860`
...
- Project ID: `obs-evo-cand-002860`
- EVOBC category candidate ID: `evobc-evo-cat-02860`
- External category reference: `evobc-cat-02860`
- Source category ID: `02860`
- Source label for human review: `征`
- Source codepoints: `U+5F81`
...
- `obs-evo-cand-002860-route-category-staging`
...
- `obs-evo-cand-002860-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002860-route-evolution-graph`
