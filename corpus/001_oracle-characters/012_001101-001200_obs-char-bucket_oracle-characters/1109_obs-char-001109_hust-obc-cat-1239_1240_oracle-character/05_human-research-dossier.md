# obs-char-001109 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001109`
- primary external id: `hust-obc-cat-1239_1240`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1109_obs-char-001109_hust-obc-cat-1239_124
  0_oracle-character/03_visual-assets/001_asset-001114_hust-obc-cat-1239_124
  0_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1239_1240/1239/G_1239_上(2).從(甲)
  .16(楚).png`
- asset id: `asset-001114`
...
- source category: `1239_1240`
- validation class: `1108`
- source image route: `HUST-OBC/deciphered/1239_1240/1239/G_1239_上(2).從(甲).16(
  楚).png`
- asset id: `asset-001114`
...
- English observation: `A narrow dense cluster combines stacked rounded
  loops, a central horizontal crossing, and short lower tapering strokes.`
- 中文观察: `狭长密集笔群结合叠置圆弧环笔、中央水平交叉和短下部收尖笔。`
...
- dataset label text: `㣍㣎`
- dataset label codepoints: `U+38CD;U+38CE`
...
- graph edge count: `2`
- codepoint routes: `U+38CD;U+38CE`
...
- Which source records identify obs-char-001109 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001109？
