# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002389
...
| --- | --- | --- | --- |
| `obimd-glyph-link-036759` | 󽫪 | `U+FDAEA` | `reviewed_metadata_only` |
| `obimd-glyph-link-036760` | 󽫫 | `U+FDAEB` | `reviewed_metadata_only` |
