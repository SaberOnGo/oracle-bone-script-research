...
- External category reference: `evobc-cat-02830`
- Source category ID: `02830`
- Source label for human review: `彑`
...
- `obs-evo-cand-002830-route-category-staging`
...
- `obs-evo-cand-002830-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002830-route-evolution-graph`
