...
- External category reference: `evobc-cat-02179`
- Source category ID: `02179`
- Source label for human review: `娭`
...
- `obs-evo-cand-002179-route-category-staging`
...
- `obs-evo-cand-002179-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002179-route-evolution-graph`
