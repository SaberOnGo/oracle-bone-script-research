...
- External category reference: `evobc-cat-02236`
- Source category ID: `02236`
- Source label for human review: `媡`
- Source codepoints: `U+5AA1`
...
- `obs-evo-cand-002236-route-category-staging`
...
- `obs-evo-cand-002236-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002236-route-evolution-graph`
