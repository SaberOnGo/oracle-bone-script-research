...
- External category reference: `evobc-cat-08240`
- Source category ID: `08240`
- Source label for human review: `誥`
...
- `obs-evo-cand-008240-route-category-staging`
...
- `obs-evo-cand-008240-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008240-route-evolution-graph`
