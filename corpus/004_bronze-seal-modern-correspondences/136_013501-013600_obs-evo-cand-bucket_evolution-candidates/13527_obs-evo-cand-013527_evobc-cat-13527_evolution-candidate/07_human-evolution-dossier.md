...
Project ID: `obs-evo-cand-013527`
...
- Project ID: `obs-evo-cand-013527`
- EVOBC category candidate ID: `evobc-evo-cat-13527`
- External category reference: `evobc-cat-13527`
- Source category ID: `13527`
- Source label for human review: `𭝼`
- Source codepoints: `U+2D77C`
...
- `obs-evo-cand-013527-route-category-staging`
...
- `obs-evo-cand-013527-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013527-route-evolution-graph`
