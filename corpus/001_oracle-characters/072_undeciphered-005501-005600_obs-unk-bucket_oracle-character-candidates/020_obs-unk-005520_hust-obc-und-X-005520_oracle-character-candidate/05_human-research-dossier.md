# obs-unk-005520 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005520`
- primary external id: `hust-obc-und-X-005520`
...
- local review image route: `corpus/001_oracle-characters/072_undeciphered-005
  501-005600_obs-unk-bucket_oracle-character-candidates/020_obs-unk-005520_h
  ust-obc-und-X-005520_oracle-character-candidate/03_visual-assets/001_asset
  -007113_hust-obc-und-X-005520_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1076/X_？_8037_1.png`
- asset id: `asset-007113`
...
- source class: `HUST-OBC/undeciphered/X/1076/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1076/X_？_8037_1.png`
- asset id: `asset-007113`
...
- Which source records identify obs-unk-005520 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005520？
