...
- Project ID: `obs-evo-cand-003377`
- EVOBC category candidate ID: `evobc-evo-cat-03377`
- External category reference: `evobc-cat-03377`
- Source category ID: `03377`
- Source label for human review: `捣`
- Source codepoints: `U+6363`
...
- `obs-evo-cand-003377-route-category-staging`
...
- `obs-evo-cand-003377-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003377-route-evolution-graph`
