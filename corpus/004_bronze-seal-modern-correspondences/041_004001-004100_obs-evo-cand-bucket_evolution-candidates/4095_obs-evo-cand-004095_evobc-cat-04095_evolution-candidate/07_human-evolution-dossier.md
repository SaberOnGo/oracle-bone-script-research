...
- Project ID: `obs-evo-cand-004095`
- EVOBC category candidate ID: `evobc-evo-cat-04095`
- External category reference: `evobc-cat-04095`
- Source category ID: `04095`
- Source label for human review: `棗`
- Source codepoints: `U+68D7`
...
- `obs-evo-cand-004095-route-category-staging`
...
- `obs-evo-cand-004095-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004095-route-evolution-graph`
