...
- External category reference: `evobc-cat-01628`
- Source category ID: `01628`
- Source label for human review: `啖`
- Source codepoints: `U+5556`
...
- `obs-evo-cand-001628-route-category-staging`
...
- `obs-evo-cand-001628-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001628-route-evolution-graph`
