...
Project ID: `obs-evo-cand-012036`
...
- Project ID: `obs-evo-cand-012036`
- EVOBC category candidate ID: `evobc-evo-cat-12036`
- External category reference: `evobc-cat-12036`
- Source category ID: `12036`
- Source label for human review: `𦗺`
- Source codepoints: `U+265FA`
...
- `obs-evo-cand-012036-route-category-staging`
...
- `obs-evo-cand-012036-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012036-route-evolution-graph`
