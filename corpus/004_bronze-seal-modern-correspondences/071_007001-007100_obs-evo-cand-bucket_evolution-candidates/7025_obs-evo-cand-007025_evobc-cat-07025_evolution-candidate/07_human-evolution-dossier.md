...
- Project ID: `obs-evo-cand-007025`
- EVOBC category candidate ID: `evobc-evo-cat-07025`
- External category reference: `evobc-cat-07025`
- Source category ID: `07025`
- Source label for human review: `胑`
- Source codepoints: `U+80D1`
...
- `obs-evo-cand-007025-route-category-staging`
...
- `obs-evo-cand-007025-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007025-route-evolution-graph`
