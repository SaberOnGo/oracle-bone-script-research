...
Project ID: `obs-insc-cw-cand-000145`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000145`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000145` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y810` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `28` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `645` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `40079` [route_present_image_or_text_not_collected]
