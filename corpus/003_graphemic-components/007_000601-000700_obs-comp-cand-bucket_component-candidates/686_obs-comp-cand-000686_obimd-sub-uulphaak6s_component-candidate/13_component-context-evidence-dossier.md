# obs-comp-cand-000686 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000686`
- 首选外部 ID: `obimd-sub-uulphaak6s`
- OBIMD subcharacter UID: `uulphaak6s`
- OBIMD main character UID: `uulphaak6s`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `6`
- codepoint 示例: U+F3ECA; U+F3ECB; 另有 4 项
