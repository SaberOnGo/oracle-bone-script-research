...
Project ID: `obs-evo-cand-002260`
...
- Project ID: `obs-evo-cand-002260`
- EVOBC category candidate ID: `evobc-evo-cat-02260`
- External category reference: `evobc-cat-02260`
- Source category ID: `02260`
- Source label for human review: `嫋`
- Source codepoints: `U+5ACB`
...
- `obs-evo-cand-002260-route-category-staging`
...
- `obs-evo-cand-002260-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002260-route-evolution-graph`
