...
- External category reference: `evobc-cat-07013`
- Source category ID: `07013`
- Source label for human review: `胁`
- Source codepoints: `U+80C1`
...
- `obs-evo-cand-007013-route-category-staging`
...
- `obs-evo-cand-007013-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007013-route-evolution-graph`
