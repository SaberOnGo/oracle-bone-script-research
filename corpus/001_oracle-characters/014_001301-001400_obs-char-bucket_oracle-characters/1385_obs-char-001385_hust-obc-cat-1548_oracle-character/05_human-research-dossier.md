# obs-char-001385 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1385_obs-char-001385_hust-obc-cat-1548_ora
  cle-character/03_visual-assets/001_asset-001390_hust-obc-cat-1548_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1548/L_1548_5821.jpg`
- asset id: `asset-001390`
...
- source category: `1548`
- validation class: `1384`
- source image route: `HUST-OBC/deciphered/1548/L_1548_5821.jpg`
- asset id: `asset-001390`
...
- English observation: `A faint compact cluster has a dark cap and several
  short lower branches.`
...
- dataset label text: `㨂`
- dataset label codepoints: `U+3A02`
...
- Which source records identify obs-char-001385 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001385？
