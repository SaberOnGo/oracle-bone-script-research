# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002790
...
- EVOBC candidate category: `evobc-evo-cat-02790`.
- Source label for search only: `式`.
- Source codepoints for search only: `U+5F0F`.
