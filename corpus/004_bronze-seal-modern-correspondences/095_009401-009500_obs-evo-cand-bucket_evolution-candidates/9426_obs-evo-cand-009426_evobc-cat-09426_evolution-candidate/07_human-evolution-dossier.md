...
- External category reference: `evobc-cat-09426`
- Source category ID: `09426`
- Source label for human review: `錍`
- Source codepoints: `U+930D`
...
- `obs-evo-cand-009426-route-category-staging`
...
- `obs-evo-cand-009426-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009426-route-evolution-graph`
