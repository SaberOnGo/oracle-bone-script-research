# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006384
...
- EVOBC candidate category: `evobc-evo-cat-06384`.
- Source label for search only: `籫`.
- Source codepoints for search only: `U+7C6B`.
