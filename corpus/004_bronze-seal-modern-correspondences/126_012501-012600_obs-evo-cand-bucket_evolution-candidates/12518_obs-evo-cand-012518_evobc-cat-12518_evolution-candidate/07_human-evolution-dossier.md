...
- Project ID: `obs-evo-cand-012518`
- EVOBC category candidate ID: `evobc-evo-cat-12518`
- External category reference: `evobc-cat-12518`
- Source category ID: `12518`
- Source label for human review: `𨸲`
- Source codepoints: `U+28E32`
...
- `obs-evo-cand-012518-route-category-staging`
...
- `obs-evo-cand-012518-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012518-route-evolution-graph`
