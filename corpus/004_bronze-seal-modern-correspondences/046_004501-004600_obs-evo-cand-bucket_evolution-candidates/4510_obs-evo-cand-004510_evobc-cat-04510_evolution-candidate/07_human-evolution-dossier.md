...
- Project ID: `obs-evo-cand-004510`
- EVOBC category candidate ID: `evobc-evo-cat-04510`
- External category reference: `evobc-cat-04510`
- Source category ID: `04510`
- Source label for human review: `汩`
- Source codepoints: `U+6C69`
...
- `obs-evo-cand-004510-route-category-staging`
...
- `obs-evo-cand-004510-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004510-route-evolution-graph`
