# Material Visual Observation / obs-comp-cand-002194 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002194`
- External reference / 外部参照: `obimd-sub-nuhuytxqfn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019900_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/a7mak4wuom/nuhuytxqfn/nuhuytxqfn.png`
- Checksum / 校验和:
  `d843c04c5383a7767ff73d87697aeb32539bb1d8055f493cc8649abf04985772`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.86%.
- Marked-pixel bounds: (61,39)–(188,206); span 128 × 168 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.86%。
- 痕迹范围：(61,39)–(188,206)；跨度128 × 168 px；痕迹矩形高于宽。
