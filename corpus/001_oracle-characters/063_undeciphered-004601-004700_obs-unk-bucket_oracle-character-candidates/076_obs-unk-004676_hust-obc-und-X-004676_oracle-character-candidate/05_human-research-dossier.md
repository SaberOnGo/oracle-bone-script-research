# obs-unk-004676 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/076_obs-unk-004676_h
  ust-obc-und-X-004676_oracle-character-candidate/03_visual-assets/001_asset
  -006269_hust-obc-und-X-004676_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/232/X_？_8401_1.png`
- asset id: `asset-006269`
...
- source class: `HUST-OBC/undeciphered/X/232/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/232/X_？_8401_1.png`
- asset id: `asset-006269`
...
- English observation: `tall form with upper inner line and lower openings`
- 中文观察: `带上部内线和下部开口的高形笔画`
...
- Which source records identify obs-unk-004676 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004676？
