# obs-unk-004365 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/065_obs-unk-004365_h
  ust-obc-und-L-004365_oracle-character-candidate/03_visual-assets/001_asset
  -005958_hust-obc-und-L-004365_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4365/L_？_9687.jpg`
- asset id: `asset-005958`
...
- source class: `HUST-OBC/undeciphered/L/4365/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4365/L_？_9687.jpg`
- asset id: `asset-005958`
...
- English observation: `Left broad trace, diagonal crossing, and right fork`
  `recorded.`
- 中文观察: `已记录左侧宽痕、斜向交叉和右侧分叉痕。`
...
- Which source records identify obs-unk-004365 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004365？
