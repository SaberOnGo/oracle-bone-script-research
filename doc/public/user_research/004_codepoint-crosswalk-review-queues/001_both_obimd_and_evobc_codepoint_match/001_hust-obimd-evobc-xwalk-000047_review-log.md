...
- Review log draft ID / 复核日志草稿 ID: `codepoint-crosswalk-review-log-draft-001`
- Codepoint review task ID / codepoint 复核任务 ID: `codepoint-crosswalk-review-001`
...
- Crosswalk candidate ID / 交叉候选 ID: `hust-obimd-evobc-xwalk-000047`
- Suggested oracle character ID / 建议甲骨单字 ID: `obs-char-000047`
- Promotion queue ID / 提升队列 ID: `hust-obc-obs-char-promo-000047`
...
- HUST external ref / HUST 外部引用: `hust-obc-cat-0055`
- HUST label codepoints / HUST 标签 codepoint: `U+342D`
- OBIMD main candidates / OBIMD 主字候选: `obimd-main-cand-002255`
- EVOBC category candidates / EVOBC 类别候选: `evobc-evo-cat-00005`
- EVOBC image reference count / EVOBC 图像引用数: `71`
...
- `corpus/001_oracle-characters/001_000001-000100_obs-char-bucket_oracle-characters/047_obs-char-000047_hust-obc-cat-0055_oracle-character/01_candidate-character-packet.json`
...
- Route availability ID: `codepoint-route-availability-001`
...
- Review task ID: `codepoint-crosswalk-review-001`
- Crosswalk candidate ID: `hust-obimd-evobc-xwalk-000047`
- Suggested oracle character ID: `obs-char-000047`
- HUST candidate packet ID: `hust-obc-candidate-packet-000047`
...
- OBIMD row count: `1`
- OBIMD source UIDs: `dxvqlu3dcd`
- OBIMD review statuses: `obimd-main-cand-002255=reviewed_metadata_only`
- OBIMD rights statuses: `obimd-main-cand-002255=licensed_for_repository`
- EVOBC row count: `1`
- EVOBC source category IDs: `00005`
- EVOBC has bronze refs: `true`
- EVOBC has seal refs: `false`
- EVOBC review statuses: `evobc-evo-cat-00005=reviewed_metadata_only`
- EVOBC rights statuses: `evobc-evo-cat-00005=source_marked_risk_noted`
...
- Does `hust-obimd-evobc-xwalk-000047` remain unpromoted and undeciphered?
