...
- `obs-evo-cand-006580-route-category-staging`
...
- `obs-evo-cand-006580-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006580-route-evolution-graph`
