# obs-unk-005793 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005793`
- primary external id: `hust-obc-und-X-005793`
...
- local review image route: `corpus/001_oracle-characters/074_undeciphered-005
  701-005800_obs-unk-bucket_oracle-character-candidates/093_obs-unk-005793_h
  ust-obc-und-X-005793_oracle-character-candidate/03_visual-assets/001_asset
  -007385_hust-obc-und-X-005793_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1349/X_？_1623_1.png`
- asset id: `asset-007385`
...
- source class: `HUST-OBC/undeciphered/X/1349/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1349/X_？_1623_1.png`
...
- Which source records identify obs-unk-005793 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005793？
