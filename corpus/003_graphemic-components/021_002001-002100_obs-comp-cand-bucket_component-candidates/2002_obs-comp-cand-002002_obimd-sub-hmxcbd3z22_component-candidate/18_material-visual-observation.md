# Material Visual Observation / obs-comp-cand-002002 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002002`
- External reference / 外部参照: `obimd-sub-hmxcbd3z22`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019222_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hmxcbd3z22/hmxcbd3z22/hmxcbd3z22.png`
- Checksum / 校验和:
  `046ea0075ea4285ff07bfdfcdd0c58e450a6dd0e13210cff9cc1ca790274b3dc`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.76%.
- Marked-pixel bounds: (65,44)–(183,192); span 119 × 149 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.76%。
- 痕迹范围：(65,44)–(183,192)；跨度119 × 149 px；痕迹矩形高于宽。
