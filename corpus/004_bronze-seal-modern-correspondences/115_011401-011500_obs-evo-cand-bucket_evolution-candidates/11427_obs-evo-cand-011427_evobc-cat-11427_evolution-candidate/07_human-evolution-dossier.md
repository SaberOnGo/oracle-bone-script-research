...
- Project ID: `obs-evo-cand-011427`
- EVOBC category candidate ID: `evobc-evo-cat-11427`
- External category reference: `evobc-cat-11427`
- Source category ID: `11427`
- Source label for human review: `𣏦`
- Source codepoints: `U+233E6`
...
- `obs-evo-cand-011427-route-category-staging`
...
- `obs-evo-cand-011427-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011427-route-evolution-graph`
