# Preformal Research Start Check / 正式研究开始前开包核查: coll-obj-cand-00017
...
| --- | --- | --- |
| 1 | `02_collection-source-index.csv` | `779` |
...
| 6 | `18_live-source-evidence-review.md` | source text, hashes, and glyph boundary |
