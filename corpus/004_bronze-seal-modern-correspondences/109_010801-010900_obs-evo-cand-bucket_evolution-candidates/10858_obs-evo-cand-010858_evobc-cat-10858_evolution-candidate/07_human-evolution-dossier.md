...
- External category reference: `evobc-cat-10858`
- Source category ID: `10858`
- Source label for human review: `𠡟`
...
- `obs-evo-cand-010858-route-category-staging`
...
- `obs-evo-cand-010858-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010858-route-evolution-graph`
