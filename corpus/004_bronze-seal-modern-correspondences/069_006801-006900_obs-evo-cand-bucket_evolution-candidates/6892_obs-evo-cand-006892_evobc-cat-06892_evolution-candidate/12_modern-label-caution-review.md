# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006892
...
- EVOBC candidate category: `evobc-evo-cat-06892`.
- Source label for search only: `翨`.
- Source codepoints for search only: `U+7FE8`.
