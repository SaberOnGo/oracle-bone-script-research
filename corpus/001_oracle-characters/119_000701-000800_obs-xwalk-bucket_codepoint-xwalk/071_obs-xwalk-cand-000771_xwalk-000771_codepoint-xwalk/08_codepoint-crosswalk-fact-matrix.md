...
|---|---|---|
| Source Codepoint Route | `U+3761` | not identity |
| HUST candidate route | `hust-obc-cat-0875` | not reading |
| OBIMD route | `obimd-main-cand-002291` | not component |
| EVOBC route | `evobc-evo-cat-00070` | not evolution |
