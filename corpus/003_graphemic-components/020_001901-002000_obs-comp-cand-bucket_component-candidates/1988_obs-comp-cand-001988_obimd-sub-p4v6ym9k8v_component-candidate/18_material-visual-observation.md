# Material Visual Observation / obs-comp-cand-001988 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001988`
- External reference / 外部参照: `obimd-sub-p4v6ym9k8v`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018980_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qe26dg343r/p4v6ym9k8v/p4v6ym9k8v.png`
- Checksum / 校验和:
  `1b03906d62cfc26c368697e135e90d0a2a7231de5ad22796532281fc65da5108`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.58%.
- Marked-pixel bounds: (97,24)–(152,225); span 56 × 202 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.58%。
- 痕迹范围：(97,24)–(152,225)；跨度56 × 202 px；痕迹矩形高于宽。
