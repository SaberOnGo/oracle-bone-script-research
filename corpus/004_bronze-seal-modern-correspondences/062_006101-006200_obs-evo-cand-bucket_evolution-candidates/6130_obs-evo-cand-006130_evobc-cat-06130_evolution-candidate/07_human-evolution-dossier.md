...
- External category reference: `evobc-cat-06130`
- Source category ID: `06130`
- Source label for human review: `穖`
- Source codepoints: `U+7A56`
...
- `obs-evo-cand-006130-route-category-staging`
...
- `obs-evo-cand-006130-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006130-route-evolution-graph`
