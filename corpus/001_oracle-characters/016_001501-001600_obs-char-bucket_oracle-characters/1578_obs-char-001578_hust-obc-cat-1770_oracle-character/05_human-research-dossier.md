# obs-char-001578 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001578`
- primary external id: `hust-obc-cat-1770`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1578_obs-char-001578_hust-obc-cat-1770_ora
  cle-character/03_visual-assets/001_asset-001583_hust-obc-cat-1770_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1770/G_1770_前2.10.1(甲).png`
- asset id: `asset-001583`
...
- source category: `1770`
- validation class: `1577`
- source image route: `HUST-OBC/deciphered/1770/G_1770_前2.10.1(甲).png`
- asset id: `asset-001583`
...
- English observation: `A stacked form has an upper crossbar, a narrow
  middle stem, and a lower rounded enclosure.`
- 中文观察: `上下叠置形体有上部横笔、狭长中部竖干和下部圆折框形。`
...
- dataset label text: `㫠`
- dataset label codepoints: `U+3AE0`
...
- Which source records identify obs-char-001578 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001578？
