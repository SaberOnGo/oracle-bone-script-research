...
Project ID: `obs-evo-cand-008050`
...
- Project ID: `obs-evo-cand-008050`
- EVOBC category candidate ID: `evobc-evo-cat-08050`
- External category reference: `evobc-cat-08050`
- Source category ID: `08050`
- Source label for human review: `要`
- Source codepoints: `U+8981`
...
- `obs-evo-cand-008050-route-category-staging`
...
- `obs-evo-cand-008050-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008050-route-evolution-graph`
