...
- External category reference: `evobc-cat-07671`
- Source category ID: `07671`
- Source label for human review: `蘞`
- Source codepoints: `U+861E`
...
- `obs-evo-cand-007671-route-category-staging`
...
- `obs-evo-cand-007671-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007671-route-evolution-graph`
