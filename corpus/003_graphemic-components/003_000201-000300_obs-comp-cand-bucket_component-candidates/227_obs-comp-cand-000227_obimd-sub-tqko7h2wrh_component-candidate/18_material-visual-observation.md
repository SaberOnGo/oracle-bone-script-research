# Material Visual Observation / obs-comp-cand-000227 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000227`
- External reference / 外部参照: `obimd-sub-tqko7h2wrh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011874_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tqko7h2wrh/tqko7h2wrh/tqko7h2wrh.png`
- Checksum / 校验和:
  `42d3b1ec49f54ebc19aaef9d6ed3806faba37f8defd335ab1e11924756e7b35a`
...
- Marked-pixel bounds: (45,29)–(204,222); span 160 × 194 px; the marked
...
- 痕迹范围：(45,29)–(204,222)；跨度160 × 194 px；痕迹矩形高于宽。
