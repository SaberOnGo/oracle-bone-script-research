...
- External category reference: `evobc-cat-11947`
- Source category ID: `11947`
- Source label for human review: `𦁉`
...
- `obs-evo-cand-011947-route-category-staging`
...
- `obs-evo-cand-011947-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011947-route-evolution-graph`
