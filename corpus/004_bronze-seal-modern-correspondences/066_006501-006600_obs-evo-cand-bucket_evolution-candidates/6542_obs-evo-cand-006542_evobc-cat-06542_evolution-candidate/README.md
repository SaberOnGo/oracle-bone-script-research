# obs-evo-cand-006542 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-006542`
- EVOBC category candidate ID: `evobc-evo-cat-06542`
- External category ref: `evobc-cat-06542`
- Source label for human review: `綏`
- Source codepoints: `U+7D8F`
- Image reference count: `74`
- Era token counts: `BI:1;SS:1;WSC:72`
- Source token counts: `Book:6;Web:68`
