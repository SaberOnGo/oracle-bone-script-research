...
- Project ID: `obs-evo-cand-008912`
- EVOBC category candidate ID: `evobc-evo-cat-08912`
- External category reference: `evobc-cat-08912`
- Source category ID: `08912`
- Source label for human review: `辡`
- Source codepoints: `U+8FA1`
...
- `obs-evo-cand-008912-route-category-staging`
...
- `obs-evo-cand-008912-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008912-route-evolution-graph`
