# obs-char-001173 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001173`
- primary external id: `hust-obc-cat-1313`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1173_obs-char-001173_hust-obc-cat-1313_ora
  cle-character/03_visual-assets/001_asset-001178_hust-obc-cat-1313_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1313/G_1313_乙7795合6834賓組.png`
- asset id: `asset-001178`
...
- source category: `1313`
- validation class: `1172`
- source image route: `HUST-OBC/deciphered/1313/G_1313_乙7795合6834賓組.png`
- asset id: `asset-001178`
...
- English observation: `A clean upright form has an upper crossing, two
  short side branches, and a long central stroke ending at a base.`
- 中文观察: `清晰的直立形体有上部交叉、两条短侧部分枝和延伸到底笔的中央长笔。`
...
- dataset label text: `㤗`
- dataset label codepoints: `U+3917`
...
- filename catalog route clues: `Heji-like filename clue: 合6834
  (G_1313_乙7795合6834賓組.png)`
...
- Which source records identify obs-char-001173 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001173？
