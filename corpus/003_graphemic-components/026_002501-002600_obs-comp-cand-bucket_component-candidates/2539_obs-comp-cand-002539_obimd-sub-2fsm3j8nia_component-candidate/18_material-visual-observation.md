# Material Visual Observation / obs-comp-cand-002539 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002539`
- External reference / 外部参照: `obimd-sub-2fsm3j8nia`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021058_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dcc90z03il/2fsm3j8nia/2fsm3j8nia.png`
- Checksum / 校验和:
  `60d8d585fe10644c24141f9418e97ea4977bee91d723f6421e5f961d173a90f0`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.83%.
- Marked-pixel bounds: (63,21)–(191,228); span 129 × 208 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.83%。
- 痕迹范围：(63,21)–(191,228)；跨度129 × 208 px；痕迹矩形高于宽。
