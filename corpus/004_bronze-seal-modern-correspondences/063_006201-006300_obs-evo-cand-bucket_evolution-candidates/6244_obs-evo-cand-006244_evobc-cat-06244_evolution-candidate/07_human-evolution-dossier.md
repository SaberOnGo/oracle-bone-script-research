...
Project ID: `obs-evo-cand-006244`
...
- Project ID: `obs-evo-cand-006244`
- EVOBC category candidate ID: `evobc-evo-cat-06244`
- External category reference: `evobc-cat-06244`
- Source category ID: `06244`
- Source label for human review: `笮`
- Source codepoints: `U+7B2E`
...
- `obs-evo-cand-006244-route-category-staging`
...
- `obs-evo-cand-006244-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006244-route-evolution-graph`
