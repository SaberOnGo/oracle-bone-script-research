# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004899
...
- EVOBC candidate category: `evobc-evo-cat-04899`.
- Source label for search only: `潚`.
- Source codepoints for search only: `U+6F5A`.
