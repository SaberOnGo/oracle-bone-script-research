# obs-char-001083 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001083`
- primary external id: `hust-obc-cat-1212`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1083_obs-char-001083_hust-obc-cat-1212_ora
  cle-character/03_visual-assets/001_asset-001088_hust-obc-cat-1212_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1212/G_1212_乙4508合22067午組.png`
- asset id: `asset-001088`
...
- source category: `1212`
- validation class: `1082`
- source image route: `HUST-OBC/deciphered/1212/G_1212_乙4508合22067午組.png`
- asset id: `asset-001088`
...
- English observation: `A wide horizontal form has a central upright
  crossing and two short lower side strokes.`
- 中文观察: `宽大的横向形体有中央直立交叉笔和两条短下部侧笔。`
...
- dataset label text: `㢲`
- dataset label codepoints: `U+38B2`
...
- filename catalog route clues: `Heji-like filename clue: 合22067
  (G_1212_乙4508合22067午組.png)`
...
- Which source records identify obs-char-001083 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001083？
