# obs-char-001271 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001271`
- primary external id: `hust-obc-cat-1421_1422`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1271_obs-char-001271_hust-obc-cat-1421_142
  2_oracle-character/03_visual-assets/001_asset-001276_hust-obc-cat-1421_142
  2_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1421_1422/1421/G_1421_乙8696合222
  89子組.png`
- asset id: `asset-001276`
...
- source category: `1421_1422`
- validation class: `1270`
- source image route: `HUST-OBC/deciphered/1421_1422/1421/G_1421_乙8696合22289子組
  .png`
- asset id: `asset-001276`
...
- English observation: `A central rounded rectangular form sits on a stem,
  with separated curving side marks and a short right dash.`
- 中文观察: `中央圆折矩形形体位于笔干之上，两侧有分离弧形标记，右侧另有短横点画。`
...
- dataset label text: `㦃㦄`
- dataset label codepoints: `U+3983;U+3984`
...
- graph edge count: `2`
- codepoint routes: `U+3983;U+3984`
...
- filename catalog route clues: `Heji-like filename clue: 合22289
...
- Which source records identify obs-char-001271 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001271？
