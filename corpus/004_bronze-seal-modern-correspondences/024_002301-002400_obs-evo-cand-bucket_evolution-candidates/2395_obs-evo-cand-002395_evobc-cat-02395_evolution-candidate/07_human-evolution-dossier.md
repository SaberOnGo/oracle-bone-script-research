...
Project ID: `obs-evo-cand-002395`
...
- Project ID: `obs-evo-cand-002395`
- EVOBC category candidate ID: `evobc-evo-cat-02395`
- External category reference: `evobc-cat-02395`
- Source category ID: `02395`
- Source label for human review: `害`
- Source codepoints: `U+5BB3`
- Image reference count in source metadata: `159`
...
- `obs-evo-cand-002395-route-category-staging`
...
- `obs-evo-cand-002395-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002395-route-evolution-graph`
