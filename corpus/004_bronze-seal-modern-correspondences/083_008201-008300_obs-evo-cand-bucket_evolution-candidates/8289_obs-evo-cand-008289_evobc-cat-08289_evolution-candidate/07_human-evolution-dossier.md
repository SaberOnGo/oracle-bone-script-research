...
- Project ID: `obs-evo-cand-008289`
- EVOBC category candidate ID: `evobc-evo-cat-08289`
- External category reference: `evobc-cat-08289`
- Source category ID: `08289`
- Source label for human review: `諰`
- Source codepoints: `U+8AF0`
...
- `obs-evo-cand-008289-route-category-staging`
...
- `obs-evo-cand-008289-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008289-route-evolution-graph`
