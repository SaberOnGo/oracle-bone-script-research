# Material Visual Observation / obs-comp-cand-000059 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000059`
- External reference / 外部参照: `obimd-sub-36wlwic8fh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011472_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vk0iw3x90b/36wlwic8fh/36wlwic8fh.png`
- Checksum / 校验和:
  `645d3e79c6bf2e21eebf5df4ba1f455e6cbc362bf0565b209da742c88b54e320`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.60%.
- Marked-pixel bounds: (54,46)–(195,201); span 142 × 156 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.60%。
- 痕迹范围：(54,46)–(195,201)；跨度142 × 156 px；痕迹矩形近方形。
