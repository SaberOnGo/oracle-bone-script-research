# obs-char-001579 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001579`
- primary external id: `hust-obc-cat-1771`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1579_obs-char-001579_hust-obc-cat-1771_ora
  cle-character/03_visual-assets/001_asset-001584_hust-obc-cat-1771_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1771/X_1771_4501_1.png`
- asset id: `asset-001584`
...
- source category: `1771`
- validation class: `1578`
- source image route: `HUST-OBC/deciphered/1771/X_1771_4501_1.png`
- asset id: `asset-001584`
...
- English observation: `Two large adjacent forms show branching left strokes
  and a right enclosure with long side branches.`
- 中文观察: `两个相邻大型形体左侧有分枝笔画，右侧有带长侧部分枝的框形。`
...
- dataset label text: `㫡`
- dataset label codepoints: `U+3AE1`
...
- Which source records identify obs-char-001579 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001579？
