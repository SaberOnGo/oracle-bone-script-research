...
Project ID: `obs-evo-cand-000943`
...
- Project ID: `obs-evo-cand-000943`
- EVOBC category candidate ID: `evobc-evo-cat-00943`
- External category reference: `evobc-cat-00943`
- Source category ID: `00943`
- Source label for human review: `值`
- Source codepoints: `U+503C`
...
- `obs-evo-cand-000943-route-category-staging`
...
- `obs-evo-cand-000943-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000943-route-evolution-graph`
