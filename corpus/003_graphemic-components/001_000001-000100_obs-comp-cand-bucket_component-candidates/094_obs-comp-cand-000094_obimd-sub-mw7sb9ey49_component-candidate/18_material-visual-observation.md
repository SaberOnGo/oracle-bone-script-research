# Material Visual Observation / obs-comp-cand-000094 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000094`
- External reference / 外部参照: `obimd-sub-mw7sb9ey49`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011506_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/mw7sb9ey49/mw7sb9ey49/mw7sb9ey49.png`
- Checksum / 校验和:
  `0631b0bb92cce92a8518a9dee906d10f29a83fb517da14680e9cc3a2cadfd53b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.71%.
- Marked-pixel bounds: (60,37)–(188,208); span 129 × 172 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.71%。
- 痕迹范围：(60,37)–(188,208)；跨度129 × 172 px；痕迹矩形高于宽。
