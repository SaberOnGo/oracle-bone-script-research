...
Project ID: `obs-evo-cand-012960`
...
- Project ID: `obs-evo-cand-012960`
- EVOBC category candidate ID: `evobc-evo-cat-12960`
- External category reference: `evobc-cat-12960`
- Source category ID: `12960`
- Source label for human review: `𫒴`
- Source codepoints: `U+2B4B4`
...
- `obs-evo-cand-012960-route-category-staging`
...
- `obs-evo-cand-012960-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012960-route-evolution-graph`
