...
Project ID: `obs-evo-cand-000793`
...
- Project ID: `obs-evo-cand-000793`
- EVOBC category candidate ID: `evobc-evo-cat-00793`
- External category reference: `evobc-cat-00793`
- Source category ID: `00793`
- Source label for human review: `佂`
- Source codepoints: `U+4F42`
...
- `obs-evo-cand-000793-route-category-staging`
...
- `obs-evo-cand-000793-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000793-route-evolution-graph`
