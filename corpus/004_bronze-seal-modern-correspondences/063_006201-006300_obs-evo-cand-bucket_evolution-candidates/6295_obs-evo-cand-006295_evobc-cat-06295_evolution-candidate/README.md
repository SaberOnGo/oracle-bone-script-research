# obs-evo-cand-006295 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-06295`
- Source label for human review: `箙`
- Source codepoints: `U+7B99`
- Image reference count: `81`
- Era token counts: `BI:2;OBC:56;SS:1;WSC:22`
- Source token counts: `Book:10;Web:71`
