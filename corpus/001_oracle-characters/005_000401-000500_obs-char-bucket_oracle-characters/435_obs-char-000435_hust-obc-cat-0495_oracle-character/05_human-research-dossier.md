# obs-char-000435 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000435`
- primary external id: `hust-obc-cat-0495`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/435_obs-char-000435_hust-obc-cat-0495_orac
  le-character/03_visual-assets/001_asset-000440_hust-obc-cat-0495_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0495/G_0495_屯3110.png`
- asset id: `asset-000440`
...
- source category: `0495`
- validation class: `434`
- source image route: `HUST-OBC/deciphered/0495/G_0495_屯3110.png`
- asset id: `asset-000440`
...
- English observation: `A gridded rectangular form at left is separated from
  a taller angular form at right with an upper crossing and a bent lower
  stroke.`
- 中文观察: `左侧网格状矩形与右侧较高折角形体分离，右侧上部交叉并有弯折下部笔画。`
...
- dataset label text: `㗥`
- dataset label codepoints: `U+35E5`
...
- Which source records identify obs-char-000435 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000435？
