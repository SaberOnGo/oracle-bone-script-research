# obs-comp-cand-000666 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000666`
- 首选外部 ID: `obimd-sub-84umwz5kds`
- OBIMD subcharacter UID: `84umwz5kds`
- OBIMD main character UID: `84umwz5kds`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+F3D6D; U+F3D6E; 另有 1 项
