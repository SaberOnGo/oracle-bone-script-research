...
Project ID: `obs-evo-cand-004496`
...
- Project ID: `obs-evo-cand-004496`
- EVOBC category candidate ID: `evobc-evo-cat-04496`
- External category reference: `evobc-cat-04496`
- Source category ID: `04496`
- Source label for human review: `汗`
- Source codepoints: `U+6C57`
...
- `obs-evo-cand-004496-route-category-staging`
...
- `obs-evo-cand-004496-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004496-route-evolution-graph`
