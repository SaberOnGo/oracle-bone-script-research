# obs-char-001554 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1554_obs-char-001554_hust-obc-cat-1745_ora
  cle-character/03_visual-assets/001_asset-001559_hust-obc-cat-1745_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1745/G_1745_前5.24.3合16981賓組.png
  `
- asset id: `asset-001559`
...
- source category: `1745`
- validation class: `1553`
- source image route: `HUST-OBC/deciphered/1745/G_1745_前5.24.3合16981賓組.png`
- asset id: `asset-001559`
...
- English observation: `A pointed upper enclosure leads into a narrow
  branching lower stroke.`
...
- dataset label text: `㫇`
- dataset label codepoints: `U+3AC7`
...
- filename catalog route clues: `Heji-like filename clue: 合16981
...
- Which source records identify obs-char-001554 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001554？
