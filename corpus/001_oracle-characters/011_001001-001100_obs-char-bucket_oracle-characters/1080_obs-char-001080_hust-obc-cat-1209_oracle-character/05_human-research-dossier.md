# obs-char-001080 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001080`
- primary external id: `hust-obc-cat-1209`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1080_obs-char-001080_hust-obc-cat-1209_ora
  cle-character/03_visual-assets/001_asset-001085_hust-obc-cat-1209_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1209/G_1209_甲916合35224歷組.png`
- asset id: `asset-001085`
...
- source category: `1209`
- validation class: `1079`
- source image route: `HUST-OBC/deciphered/1209/G_1209_甲916合35224歷組.png`
- asset id: `asset-001085`
...
- English observation: `A slender vertical form has a short upper horizontal
  bar, a small side turn at the center, and a long lower stroke.`
- 中文观察: `纤细竖向形体有短上部水平横笔、中央小侧转笔和长下行笔。`
...
- dataset label text: `㢯`
- dataset label codepoints: `U+38AF`
...
- filename catalog route clues: `Heji-like filename clue: 合35224
  (G_1209_甲916合35224歷組.png)`
...
- Which source records identify obs-char-001080 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001080？
