...
- External category reference: `evobc-cat-03295`
- Source category ID: `03295`
- Source label for human review: `抰`
- Source codepoints: `U+62B0`
...
- `obs-evo-cand-003295-route-category-staging`
...
- `obs-evo-cand-003295-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003295-route-evolution-graph`
