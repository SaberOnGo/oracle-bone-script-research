...
- External category reference: `evobc-cat-05688`
- Source category ID: `05688`
- Source label for human review: `癃`
- Source codepoints: `U+7643`
...
- `obs-evo-cand-005688-route-category-staging`
...
- `obs-evo-cand-005688-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005688-route-evolution-graph`
