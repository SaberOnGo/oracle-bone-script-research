# obs-char-001406 Archaeology Paleography Review

# obs-char-001406 考古文字复核档案
...
- first local image: `001_asset-001411_hust-obc-cat-1575_glyph.png`
- first source image: `G_1575_前4.47.2(甲).png`
...
- source label text: `㨝`
- source label codepoints: `U+3A1D`
