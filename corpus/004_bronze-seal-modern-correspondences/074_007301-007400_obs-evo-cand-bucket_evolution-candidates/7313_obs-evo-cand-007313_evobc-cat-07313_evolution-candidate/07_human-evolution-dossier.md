...
- External category reference: `evobc-cat-07313`
- Source category ID: `07313`
- Source label for human review: `茝`
...
- `obs-evo-cand-007313-route-category-staging`
...
- `obs-evo-cand-007313-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007313-route-evolution-graph`
