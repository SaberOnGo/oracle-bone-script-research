# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003928
...
- EVOBC candidate category: `evobc-evo-cat-03928`.
- Source label for search only: `果`.
- Source codepoints for search only: `U+679C`.
