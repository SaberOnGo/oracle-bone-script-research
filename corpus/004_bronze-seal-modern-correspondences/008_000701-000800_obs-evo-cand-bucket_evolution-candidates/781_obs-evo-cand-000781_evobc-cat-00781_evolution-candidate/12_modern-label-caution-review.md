# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000781
...
- EVOBC candidate category: `evobc-evo-cat-00781`.
- Source label for search only: `伪`.
- Source codepoints for search only: `U+4F2A`.
