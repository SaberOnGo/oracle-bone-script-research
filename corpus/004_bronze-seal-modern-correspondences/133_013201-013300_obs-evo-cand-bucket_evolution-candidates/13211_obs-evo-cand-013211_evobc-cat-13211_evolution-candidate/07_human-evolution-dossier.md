...
- Project ID: `obs-evo-cand-013211`
- EVOBC category candidate ID: `evobc-evo-cat-13211`
- External category reference: `evobc-cat-13211`
- Source category ID: `13211`
- Source label for human review: `𬆉`
- Source codepoints: `U+2C189`
...
- `obs-evo-cand-013211-route-category-staging`
...
- `obs-evo-cand-013211-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013211-route-evolution-graph`
