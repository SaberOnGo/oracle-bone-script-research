# obs-char-000846 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000846`
- primary external id: `hust-obc-cat-0955`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/846_obs-char-000846_hust-obc-cat-0955_orac
  le-character/03_visual-assets/001_asset-000851_hust-obc-cat-0955_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0955/G_0955_前2.10.3(甲).png`
- asset id: `asset-000851`
...
- source category: `0955`
- validation class: `845`
- source image route: `HUST-OBC/deciphered/0955/G_0955_前2.10.3(甲).png`
- asset id: `asset-000851`
...
- dataset label text: `㞱`
- dataset label codepoints: `U+37B1`
...
- Which source records identify obs-char-000846 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000846？
