# Material Visual Observation / obs-comp-cand-000260 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000260`
- External reference / 外部参照: `obimd-sub-sskw0jmzz7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011906_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/44ocjtdxxw/sskw0jmzz7/sskw0jmzz7.png`
- Checksum / 校验和:
  `b3a36631d6e3bc9af6c658a8298de36ef4f1abb1e636c7703b44b6c71be4c751`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.24%.
- Marked-pixel bounds: (94,37)–(155,211); span 62 × 175 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.24%。
- 痕迹范围：(94,37)–(155,211)；跨度62 × 175 px；痕迹矩形高于宽。
