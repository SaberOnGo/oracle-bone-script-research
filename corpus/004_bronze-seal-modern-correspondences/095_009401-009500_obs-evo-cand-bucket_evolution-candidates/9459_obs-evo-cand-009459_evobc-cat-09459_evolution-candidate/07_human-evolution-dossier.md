...
- External category reference: `evobc-cat-09459`
- Source category ID: `09459`
- Source label for human review: `鍤`
- Source codepoints: `U+9364`
...
- `obs-evo-cand-009459-route-category-staging`
...
- `obs-evo-cand-009459-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009459-route-evolution-graph`
