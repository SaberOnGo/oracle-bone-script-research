...
- Project ID: `obs-evo-cand-010266`
- EVOBC category candidate ID: `evobc-evo-cat-10266`
- External category reference: `evobc-cat-10266`
- Source category ID: `10266`
- Source label for human review: `驩`
- Source codepoints: `U+9A69`
...
- `obs-evo-cand-010266-route-category-staging`
...
- `obs-evo-cand-010266-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010266-route-evolution-graph`
