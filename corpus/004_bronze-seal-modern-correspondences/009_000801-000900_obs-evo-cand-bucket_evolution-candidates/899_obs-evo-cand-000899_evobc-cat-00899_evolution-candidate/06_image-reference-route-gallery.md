...
- `obs-evo-cand-000899-route-category-staging`
...
- `obs-evo-cand-000899-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000899-route-evolution-graph`
