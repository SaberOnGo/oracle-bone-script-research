...
Project ID: `obs-evo-cand-008476`
...
- Project ID: `obs-evo-cand-008476`
- EVOBC category candidate ID: `evobc-evo-cat-08476`
- External category reference: `evobc-cat-08476`
- Source category ID: `08476`
- Source label for human review: `豆`
- Source codepoints: `U+8C46`
...
- `obs-evo-cand-008476-route-category-staging`
...
- `obs-evo-cand-008476-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008476-route-evolution-graph`
