# Material Visual Observation / obs-comp-cand-001675 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001675`
- External reference / 外部参照: `obimd-sub-tx1j7svgq7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017591_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cixqnyxp9v/tx1j7svgq7/tx1j7svgq7.png`
- Checksum / 校验和:
  `c823660fc8fd25d6b1a8c0d25f8492e2b3330eb287e9209fa78e460a805590e0`
...
- Marked-pixel bounds: (65,54)–(184,190); span 120 × 137 px; the marked
...
- 痕迹范围：(65,54)–(184,190)；跨度120 × 137 px；痕迹矩形近方形。
