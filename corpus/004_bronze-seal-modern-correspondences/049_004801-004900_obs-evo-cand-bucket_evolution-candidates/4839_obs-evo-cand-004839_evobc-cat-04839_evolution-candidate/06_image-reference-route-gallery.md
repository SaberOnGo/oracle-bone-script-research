...
- `obs-evo-cand-004839-route-category-staging`
...
- `obs-evo-cand-004839-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004839-route-evolution-graph`
