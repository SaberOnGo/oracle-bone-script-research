# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001929
...
| Glyph or codepoint route / 字形或码位路线 | 377 OBIMD route rows; examples U+53D7;U+FAFA7; U+FAFA8; 另有 375 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 377 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
