# Material Visual Observation / obs-comp-cand-000778 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000778`
- External reference / 外部参照: `obimd-sub-xrunr8ile9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013540_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/yrxflndwvy/xrunr8ile9/xrunr8ile9.png`
- Checksum / 校验和:
  `1d5c416772ddb6ee2148fbe4b080f405968119b1b53faa9b37269c8cdb0e325f`
...
- Marked-pixel bounds: (64,58)–(184,193); span 121 × 136 px; the marked
...
- 痕迹范围：(64,58)–(184,193)；跨度121 × 136 px；痕迹矩形近方形。
