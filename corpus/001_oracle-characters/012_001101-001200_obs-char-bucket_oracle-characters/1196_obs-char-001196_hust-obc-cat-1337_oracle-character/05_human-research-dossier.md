# obs-char-001196 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1196_obs-char-001196_hust-obc-cat-1337_ora
  cle-character/03_visual-assets/001_asset-001201_hust-obc-cat-1337_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1337/G_1337_中大108(甲).png`
- asset id: `asset-001201`
...
- source category: `1337`
- validation class: `1195`
- source image route: `HUST-OBC/deciphered/1337/G_1337_中大108(甲).png`
- asset id: `asset-001201`
...
- English observation: `A narrow upright form has a central rectangular
  enclosure, forked upper and lower branches, and a long descending line.`
- 中文观察: `狭长直立形体有中央方形框廓、上下分叉笔和长下行线。`
...
- dataset label text: `㤯`
- dataset label codepoints: `U+392F`
...
- Which source records identify obs-char-001196 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001196？
