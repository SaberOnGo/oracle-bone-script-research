...
Project ID: `obs-evo-cand-006999`
...
- Project ID: `obs-evo-cand-006999`
- EVOBC category candidate ID: `evobc-evo-cat-06999`
- External category reference: `evobc-cat-06999`
- Source category ID: `06999`
- Source label for human review: `肫`
- Source codepoints: `U+80AB`
...
- `obs-evo-cand-006999-route-category-staging`
...
- `obs-evo-cand-006999-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006999-route-evolution-graph`
