# obs-char-000841 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000841`
- primary external id: `hust-obc-cat-0950`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/841_obs-char-000841_hust-obc-cat-0950_orac
  le-character/03_visual-assets/001_asset-000846_hust-obc-cat-0950_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0950/G_0950_甲骨文0.png`
- asset id: `asset-000846`
...
- source category: `0950`
- validation class: `840`
- source image route: `HUST-OBC/deciphered/0950/G_0950_甲骨文0.png`
- asset id: `asset-000846`
...
- English observation: `A tall narrow outline contains several parallel
  vertical strokes; the upper portion narrows to pointed angles and the
  lower strands remain separated.`
- 中文观察: `高长狭窄轮廓内有数条平行竖笔；上部收窄成尖形折角，下部笔条保持分离。`
...
- dataset label text: `㞬`
- dataset label codepoints: `U+37AC`
...
- Which source records identify obs-char-000841 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000841？
