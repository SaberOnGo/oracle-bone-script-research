...
- Project ID: `obs-evo-cand-000246`
- EVOBC category candidate ID: `evobc-evo-cat-00246`
- External category reference: `evobc-cat-00246`
- Source category ID: `00246`
- Source label for human review: `㽉`
- Source codepoints: `U+3F49`
...
- `obs-evo-cand-000246-route-category-staging`
...
- `obs-evo-cand-000246-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000246-route-evolution-graph`
