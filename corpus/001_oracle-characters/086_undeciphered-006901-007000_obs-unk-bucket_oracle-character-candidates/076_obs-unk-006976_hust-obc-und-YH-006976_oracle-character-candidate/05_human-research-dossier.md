# obs-unk-006976 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006976`
- primary external id: `hust-obc-und-YH-006976`
...
- local review image route: `corpus/001_oracle-characters/086_undeciphered-006
  901-007000_obs-unk-bucket_oracle-character-candidates/076_obs-unk-006976_h
  ust-obc-und-YH-006976_oracle-character-candidate/03_visual-assets/001_asse
  t-008567_hust-obc-und-YH-006976_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60473/H_？_60473_0.png`
- asset id: `asset-008567`
...
- source class: `HUST-OBC/undeciphered/Y+H/60473/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60473/H_？_60473_0.png`
- asset id: `asset-008567`
...
- Which source records identify obs-unk-006976 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006976？
