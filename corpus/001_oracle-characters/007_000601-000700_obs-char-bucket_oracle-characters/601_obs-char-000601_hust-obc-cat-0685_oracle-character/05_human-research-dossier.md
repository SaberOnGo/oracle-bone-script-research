# obs-char-000601 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000601`
- primary external id: `hust-obc-cat-0685`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/601_obs-char-000601_hust-obc-cat-0685_orac
  le-character/03_visual-assets/001_asset-000606_hust-obc-cat-0685_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0685/G_0685_乙3069合14034賓組.png`
- asset id: `asset-000606`
...
- source category: `0685`
- validation class: `600`
- source image route: `HUST-OBC/deciphered/0685/G_0685_乙3069合14034賓組.png`
- asset id: `asset-000606`
...
- English observation: `A single slender upright stroke bends slightly
  through the middle, with a short dark spur near the top and a broad hooked
  foot at the bottom.`
- 中文观察: `单条纤细直立笔在中部略弯，近顶部有短深色侧突，底部收成宽钩脚。`
...
- dataset label text: `㚣`
- dataset label codepoints: `U+36A3`
...
- filename catalog route clues: `Heji-like filename clue: 合14034
  (G_0685_乙3069合14034賓組.png)`
...
- Which source records identify obs-char-000601 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000601？
