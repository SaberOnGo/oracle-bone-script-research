...
- External category reference: `evobc-cat-01620`
- Source category ID: `01620`
- Source label for human review: `啇`
- Source codepoints: `U+5547`
...
- `obs-evo-cand-001620-route-category-staging`
...
- `obs-evo-cand-001620-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001620-route-evolution-graph`
