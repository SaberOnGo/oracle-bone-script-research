# Material Visual Observation / obs-comp-cand-000294 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000294`
- External reference / 外部参照: `obimd-sub-1wismy95hz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012002_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1wismy95hz/1wismy95hz/12aqk63c3h.png`
- Checksum / 校验和:
  `ccf8976c7eab9f598ada25c1b1ec6bfcedd77d3d39b7ff21a4d857f7fb861efe`
...
- Marked-pixel bounds: (65,37)–(184,212); span 120 × 176 px; the marked
...
- 痕迹范围：(65,37)–(184,212)；跨度120 × 176 px；痕迹矩形高于宽。
