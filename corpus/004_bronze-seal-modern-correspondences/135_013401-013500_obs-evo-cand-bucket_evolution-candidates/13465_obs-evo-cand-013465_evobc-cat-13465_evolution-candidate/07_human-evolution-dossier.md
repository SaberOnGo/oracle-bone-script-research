...
- External category reference: `evobc-cat-13465`
- Source category ID: `13465`
- Source label for human review: `𬾈`
...
- `obs-evo-cand-013465-route-category-staging`
...
- `obs-evo-cand-013465-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013465-route-evolution-graph`
