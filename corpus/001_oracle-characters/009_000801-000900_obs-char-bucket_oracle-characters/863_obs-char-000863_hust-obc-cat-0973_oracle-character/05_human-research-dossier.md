# obs-char-000863 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/863_obs-char-000863_hust-obc-cat-0973_orac
  le-character/03_visual-assets/001_asset-000868_hust-obc-cat-0973_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0973/G_0973_前2.16.2(甲).png`
- asset id: `asset-000868`
...
- source category: `0973`
- validation class: `862`
- source image route: `HUST-OBC/deciphered/0973/G_0973_前2.16.2(甲).png`
- asset id: `asset-000868`
...
- English observation: `A long curved stroke at left accompanies a broken
  diagonal chain of short marks at right; upper and lower joins are
  unclear.`
...
- dataset label text: `㟃`
- dataset label codepoints: `U+37C3`
...
- Which source records identify obs-char-000863 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000863？
