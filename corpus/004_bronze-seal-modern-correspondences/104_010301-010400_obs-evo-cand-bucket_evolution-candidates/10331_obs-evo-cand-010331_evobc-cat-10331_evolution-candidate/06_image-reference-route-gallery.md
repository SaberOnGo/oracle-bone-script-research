...
- `obs-evo-cand-010331-route-category-staging`
...
- `obs-evo-cand-010331-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010331-route-evolution-graph`
