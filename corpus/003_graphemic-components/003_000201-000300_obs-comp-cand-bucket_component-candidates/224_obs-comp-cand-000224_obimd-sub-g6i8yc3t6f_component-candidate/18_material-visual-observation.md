# Material Visual Observation / obs-comp-cand-000224 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000224`
- External reference / 外部参照: `obimd-sub-g6i8yc3t6f`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011869_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/g6i8yc3t6f/g6i8yc3t6f/g6i8yc3t6f.png`
- Checksum / 校验和:
  `8d3d31dcc9b9770e31facde477fa228c9b87c476e52af1541c8fd0f77ffb1c16`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.94%.
- Marked-pixel bounds: (61,48)–(188,195); span 128 × 148 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.94%。
- 痕迹范围：(61,48)–(188,195)；跨度128 × 148 px；痕迹矩形近方形。
