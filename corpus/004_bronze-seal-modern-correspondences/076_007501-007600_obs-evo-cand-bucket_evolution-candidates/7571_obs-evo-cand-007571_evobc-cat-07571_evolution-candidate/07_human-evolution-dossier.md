...
- External category reference: `evobc-cat-07571`
- Source category ID: `07571`
- Source label for human review: `蔼`
...
- `obs-evo-cand-007571-route-category-staging`
...
- `obs-evo-cand-007571-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007571-route-evolution-graph`
