# Material Visual Observation / obs-comp-cand-002696 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002696`
- External reference / 外部参照: `obimd-sub-4ctd3fq57q`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021272_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4ctd3fq57q/4ctd3fq57q/4ctd3fq57q.png`
- Checksum / 校验和:
  `d991182f45fc092cd2e5dd85c3ba43c506fde26159afe964ea7ec2eefb0dcf4c`
...
- Marked-pixel bounds: (96,20)–(157,230); span 62 × 211 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.97%。
- 痕迹范围：(96,20)–(157,230)；跨度62 × 211 px；痕迹矩形高于宽。
