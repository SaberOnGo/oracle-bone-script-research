# obs-char-001170 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1170_obs-char-001170_hust-obc-cat-1310_ora
  cle-character/03_visual-assets/001_asset-001175_hust-obc-cat-1310_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1310/G_1310_乙1126.png`
- asset id: `asset-001175`
...
- source category: `1310`
- validation class: `1169`
- source image route: `HUST-OBC/deciphered/1310/G_1310_乙1126.png`
- asset id: `asset-001175`
...
- English observation: `A broad angular upper arch has a central horizontal
  crossing and two pointed lower side strokes.`
- 中文观察: `宽大的折角上拱有中央横向交叉笔和两条尖状下部侧笔。`
...
- dataset label text: `㤔`
- dataset label codepoints: `U+3914`
...
- Which source records identify obs-char-001170 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001170？
