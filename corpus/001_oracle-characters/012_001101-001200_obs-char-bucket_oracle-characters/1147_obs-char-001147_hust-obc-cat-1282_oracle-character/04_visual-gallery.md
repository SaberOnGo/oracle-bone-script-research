...
- Local image / 本地图像:
  `03_visual-assets/001_asset-001152_hust-obc-cat-1282_glyph.png`
- Local metadata / 本地 metadata:
  `03_visual-assets/001_asset-001152_hust-obc-cat-1282_glyph.yaml`
- Source image path / 来源图像路径:
  `HUST-OBC/deciphered/1282/G_1282_後1.7.10合27632無名組.png`
