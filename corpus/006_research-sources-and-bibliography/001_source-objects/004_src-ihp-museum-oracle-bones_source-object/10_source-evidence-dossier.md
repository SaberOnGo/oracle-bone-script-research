...
- Provider / 提供方: Museum of the Institute of History and Philology Academia
  Sinica
- Source type / 来源类型: museum_collection
- Source URL / 来源链接: https://museum.sinica.edu.tw/en/collection/32/
- Scope / 适用范围: Museum collection overview and selected oracle bone artifacts
  with catalog-style labels.
...
### Route 001
- Download ID / 下载 ID: dl-ihp-museum-oracle-bones
- Artifact kind / 资料类型: museum_collection_page
- Status / 状态: downloaded
- HTTP status / HTTP 状态: 200
- File size bytes / 文件大小 bytes: 54136
...
- Local temp path / 本地临时路径: tmp/source_downloads/dl-ihp-museum-oracle-bones.html
...
### Route 001
- Package file ID / 来源包文件 ID: pkg-file-000018
- Source package ID / 来源包 ID: light-src-ihp-museum-oracle-bones
- File name / 文件名: dl-ihp-museum-oracle-bones.html
...
### Route 001
- Profile ID / 概况 ID: metadata-profile-000049
- Evidence download ID / 证据下载 ID: dl-ihp-museum-oracle-bones
- Metadata file / 元数据文件: collection_32.html
- Profile metric / 概况指标: registered_scope
- Profile value / 概况值: museum_collection_overview_and_selected_artifact_labels
- Profile unit / 概况单位: registered_scope_label
- Import relevance / 导入相关性: Records the IHP Museum page as a collection-level
  provenance route for later object review
- Caution / 提醒: Overview metadata only; image reuse and object-level claims
  require separate museum policy and row review
- Review status / 复核状态: reviewed_metadata_only

### Route 002
- Profile ID / 概况 ID: metadata-profile-000050
- Evidence download ID / 证据下载 ID: dl-ihp-museum-oracle-bones
- Metadata file / 元数据文件: collection_32.html
- Profile metric / 概况指标: downloaded_page_size_bytes
- Profile value / 概况值: 54136
- Profile unit / 概况单位: bytes
- Import relevance / 导入相关性: Confirms the lightweight collection page download
  size recorded in the source log
- Caution / 提醒: Downloaded page size is provenance metadata and not proof of
