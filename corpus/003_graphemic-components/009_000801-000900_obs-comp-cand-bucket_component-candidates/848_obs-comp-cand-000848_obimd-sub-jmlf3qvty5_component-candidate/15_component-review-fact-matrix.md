# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000848
...
| Glyph or codepoint route / 字形或码位路线 | 10 OBIMD route rows; examples U+F4C6B; U+F4C6C; 另有 8 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
