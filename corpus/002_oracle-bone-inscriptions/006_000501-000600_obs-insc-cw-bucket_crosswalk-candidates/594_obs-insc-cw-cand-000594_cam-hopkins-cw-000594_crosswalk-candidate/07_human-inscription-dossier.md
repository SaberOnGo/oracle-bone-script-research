...
Project ID: `obs-insc-cw-cand-000594`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000594`
...
- Yingguo / 英国所藏: `y2643` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `341` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `499` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000594`
