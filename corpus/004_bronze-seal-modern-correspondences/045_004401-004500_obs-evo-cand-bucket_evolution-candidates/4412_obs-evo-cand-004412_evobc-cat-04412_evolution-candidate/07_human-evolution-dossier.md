...
- Project ID: `obs-evo-cand-004412`
- EVOBC category candidate ID: `evobc-evo-cat-04412`
- External category reference: `evobc-cat-04412`
- Source category ID: `04412`
- Source label for human review: `殖`
- Source codepoints: `U+6B96`
...
- `obs-evo-cand-004412-route-category-staging`
...
- `obs-evo-cand-004412-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004412-route-evolution-graph`
