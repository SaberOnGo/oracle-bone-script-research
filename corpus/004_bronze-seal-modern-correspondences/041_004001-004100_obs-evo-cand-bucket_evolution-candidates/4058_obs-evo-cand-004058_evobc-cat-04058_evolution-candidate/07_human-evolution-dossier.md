...
- External category reference: `evobc-cat-04058`
- Source category ID: `04058`
- Source label for human review: `梔`
...
- `obs-evo-cand-004058-route-category-staging`
...
- `obs-evo-cand-004058-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004058-route-evolution-graph`
