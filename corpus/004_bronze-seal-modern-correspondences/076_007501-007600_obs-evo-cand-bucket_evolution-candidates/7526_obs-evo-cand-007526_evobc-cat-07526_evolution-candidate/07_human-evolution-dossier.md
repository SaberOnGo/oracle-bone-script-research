...
- External category reference: `evobc-cat-07526`
- Source category ID: `07526`
- Source label for human review: `蓏`
...
- `obs-evo-cand-007526-route-category-staging`
...
- `obs-evo-cand-007526-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007526-route-evolution-graph`
