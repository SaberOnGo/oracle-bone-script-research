...
- External category reference: `evobc-cat-11624`
- Source category ID: `11624`
- Source label for human review: `𤠖`
...
- `obs-evo-cand-011624-route-category-staging`
...
- `obs-evo-cand-011624-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011624-route-evolution-graph`
