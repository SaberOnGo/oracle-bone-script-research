...
- External category reference: `evobc-cat-06446`
- Source category ID: `06446`
- Source label for human review: `紅`
...
- `obs-evo-cand-006446-route-category-staging`
...
- `obs-evo-cand-006446-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006446-route-evolution-graph`
