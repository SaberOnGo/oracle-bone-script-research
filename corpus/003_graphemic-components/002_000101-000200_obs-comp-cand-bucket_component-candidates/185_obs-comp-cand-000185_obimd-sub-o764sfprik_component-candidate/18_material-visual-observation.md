# Material Visual Observation / obs-comp-cand-000185 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000185`
- External reference / 外部参照: `obimd-sub-o764sfprik`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011597_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/o764sfprik/o764sfprik/o764sfprik.png`
- Checksum / 校验和:
  `0676e823bcf85ea9572453f8d0c20869fbcb885c155d4f853f5c0279ec0f7747`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.86%.
- Marked-pixel bounds: (70,25)–(179,226); span 110 × 202 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.86%。
- 痕迹范围：(70,25)–(179,226)；跨度110 × 202 px；痕迹矩形高于宽。
