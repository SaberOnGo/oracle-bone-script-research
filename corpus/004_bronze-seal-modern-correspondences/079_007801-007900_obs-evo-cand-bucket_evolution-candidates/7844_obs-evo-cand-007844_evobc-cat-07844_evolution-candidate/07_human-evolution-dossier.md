...
Project ID: `obs-evo-cand-007844`
...
- Project ID: `obs-evo-cand-007844`
- EVOBC category candidate ID: `evobc-evo-cat-07844`
- External category reference: `evobc-cat-07844`
- Source category ID: `07844`
- Source label for human review: `蟁`
- Source codepoints: `U+87C1`
...
- `obs-evo-cand-007844-route-category-staging`
...
- `obs-evo-cand-007844-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007844-route-evolution-graph`
