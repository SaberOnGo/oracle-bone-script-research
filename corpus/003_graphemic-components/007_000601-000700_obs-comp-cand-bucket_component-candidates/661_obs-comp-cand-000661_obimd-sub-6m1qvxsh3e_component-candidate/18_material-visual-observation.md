# Material Visual Observation / obs-comp-cand-000661 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000661`
- External reference / 外部参照: `obimd-sub-6m1qvxsh3e`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013224_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6m1qvxsh3e/6m1qvxsh3e/6m1qvxsh3e.png`
- Checksum / 校验和:
  `c8a63394957c7943c13bc28e442b2431f9d087a491950684c80990365e6cd7bd`
...
- Marked-pixel bounds: (63,33)–(186,218); span 124 × 186 px; the marked
...
- 痕迹范围：(63,33)–(186,218)；跨度124 × 186 px；痕迹矩形高于宽。
