...
Project ID: `obs-evo-cand-009181`
...
- Project ID: `obs-evo-cand-009181`
- EVOBC category candidate ID: `evobc-evo-cat-09181`
- External category reference: `evobc-cat-09181`
- Source category ID: `09181`
- Source label for human review: `鄉`
- Source codepoints: `U+9109`
...
- `obs-evo-cand-009181-route-category-staging`
...
- `obs-evo-cand-009181-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009181-route-evolution-graph`
