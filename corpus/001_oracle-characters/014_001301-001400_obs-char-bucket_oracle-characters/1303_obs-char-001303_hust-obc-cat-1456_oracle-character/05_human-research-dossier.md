# obs-char-001303 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001303`
- primary external id: `hust-obc-cat-1456`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1303_obs-char-001303_hust-obc-cat-1456_ora
  cle-character/03_visual-assets/001_asset-001308_hust-obc-cat-1456_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1456/G_1456_乙324合21622子組.png`
- asset id: `asset-001308`
...
- source category: `1456`
- validation class: `1302`
- source image route: `HUST-OBC/deciphered/1456/G_1456_乙324合21622子組.png`
- asset id: `asset-001308`
...
- English observation: `Two small rounded enclosures are stacked on a
  central vertical with short side projections.`
- 中文观察: `两个小型圆拱框形沿中央竖笔上下排列，并带有短侧向外伸笔画。`
...
- dataset label text: `㦦`
- dataset label codepoints: `U+39A6`
...
- filename catalog route clues: `Heji-like filename clue: 合21622
  (G_1456_乙324合21622子組.png)`
...
- Which source records identify obs-char-001303 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001303？
