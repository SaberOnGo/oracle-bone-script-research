...
- External category reference: `evobc-cat-03298`
- Source category ID: `03298`
- Source label for human review: `抴`
- Source codepoints: `U+62B4`
...
- `obs-evo-cand-003298-route-category-staging`
...
- `obs-evo-cand-003298-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003298-route-evolution-graph`
