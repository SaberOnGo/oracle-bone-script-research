# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006274
...
- EVOBC candidate category: `evobc-evo-cat-06274`.
- Source label for search only: `筭`.
- Source codepoints for search only: `U+7B6D`.
