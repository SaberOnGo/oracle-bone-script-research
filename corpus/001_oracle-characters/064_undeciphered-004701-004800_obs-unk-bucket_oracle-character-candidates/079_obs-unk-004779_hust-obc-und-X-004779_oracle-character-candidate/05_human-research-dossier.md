# obs-unk-004779 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004779`
- primary external id: `hust-obc-und-X-004779`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/079_obs-unk-004779_h
  ust-obc-und-X-004779_oracle-character-candidate/03_visual-assets/001_asset
  -006372_hust-obc-und-X-004779_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/335/X_？_7319_1.png`
- asset id: `asset-006372`
...
- source class: `HUST-OBC/undeciphered/X/335/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/335/X_？_7319_1.png`
- asset id: `asset-006372`
...
- English observation: `central enclosure with detached fragments`
- 中文观察: `带分离片段的中央围合结构`
...
- Which source records identify obs-unk-004779 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004779？
