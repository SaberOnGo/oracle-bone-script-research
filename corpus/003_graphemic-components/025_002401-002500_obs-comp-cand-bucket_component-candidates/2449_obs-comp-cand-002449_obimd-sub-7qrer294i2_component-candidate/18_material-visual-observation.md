# Material Visual Observation / obs-comp-cand-002449 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002449`
- External reference / 外部参照: `obimd-sub-7qrer294i2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020621_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7qrer294i2/7qrer294i2/7qrer294i2.png`
- Checksum / 校验和:
  `48d68affdbf4dfcd6e41e29bc53bd7e119b5f445d5e8aad85914c855f45326d1`
...
- Marked-pixel bounds: (79,44)–(170,198); span 92 × 155 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.38%。
- 痕迹范围：(79,44)–(170,198)；跨度92 × 155 px；痕迹矩形高于宽。
