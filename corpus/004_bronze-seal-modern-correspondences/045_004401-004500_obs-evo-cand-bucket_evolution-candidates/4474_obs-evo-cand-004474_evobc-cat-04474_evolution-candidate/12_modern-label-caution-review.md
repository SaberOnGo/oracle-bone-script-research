# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004474
...
- EVOBC candidate category: `evobc-evo-cat-04474`.
- Source label for search only: `氛`.
- Source codepoints for search only: `U+6C1B`.
