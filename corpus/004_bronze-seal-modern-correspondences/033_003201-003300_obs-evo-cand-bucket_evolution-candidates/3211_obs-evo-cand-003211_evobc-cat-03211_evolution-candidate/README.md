# obs-evo-cand-003211 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-003211`
- EVOBC category candidate ID: `evobc-evo-cat-03211`
- External category ref: `evobc-cat-03211`
- Source label: `或`
- Source codepoints: `U+6216`
- Image reference count: `159`
- Era token counts: `BI:29;CS:1;OBC:25;SAC:11;SS:3;WSC:90`
- Source token counts: `Book:54;Web:105`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 25 image references
- era 1 / BI: 29 image references
