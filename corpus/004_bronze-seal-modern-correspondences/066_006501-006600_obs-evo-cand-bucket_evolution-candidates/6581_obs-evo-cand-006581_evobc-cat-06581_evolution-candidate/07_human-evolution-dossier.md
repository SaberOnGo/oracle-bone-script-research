...
Project ID: `obs-evo-cand-006581`
...
- Project ID: `obs-evo-cand-006581`
- EVOBC category candidate ID: `evobc-evo-cat-06581`
- External category reference: `evobc-cat-06581`
- Source category ID: `06581`
- Source label for human review: `緊`
- Source codepoints: `U+7DCA`
...
- `obs-evo-cand-006581-route-category-staging`
...
- `obs-evo-cand-006581-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006581-route-evolution-graph`
