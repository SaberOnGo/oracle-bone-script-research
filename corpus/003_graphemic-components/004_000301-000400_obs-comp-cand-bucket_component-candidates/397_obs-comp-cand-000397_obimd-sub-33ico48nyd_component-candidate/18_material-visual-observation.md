# Material Visual Observation / obs-comp-cand-000397 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000397`
- External reference / 外部参照: `obimd-sub-33ico48nyd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012320_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/33ico48nyd/33ico48nyd/33ico48nyd.png`
- Checksum / 校验和:
  `f2af6cd4e4934e960d33473d0ac3eaf0b4dc198df90f9cc70bc8af0cd1c8a963`
...
- Marked-pixel bounds: (72,26)–(177,218); span 106 × 193 px; the marked
...
- 痕迹范围：(72,26)–(177,218)；跨度106 × 193 px；痕迹矩形高于宽。
