# Material Visual Observation / obs-comp-cand-001922 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001922`
- External reference / 外部参照: `obimd-sub-c1qqrcek58`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018332_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/47v5slu9p5/c1qqrcek58/c1qqrcek58.png`
- Checksum / 校验和:
  `75532f80055c5083f19a2404e07827abc3783fee27ca256f5802e70220c164db`
...
- Marked-pixel bounds: (72,21)–(170,225); span 99 × 205 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.08%。
- 痕迹范围：(72,21)–(170,225)；跨度99 × 205 px；痕迹矩形高于宽。
