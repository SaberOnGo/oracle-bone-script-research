...
- `obs-evo-cand-009613-route-category-staging`
...
- `obs-evo-cand-009613-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009613-route-evolution-graph`
