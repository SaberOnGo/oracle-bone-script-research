...
- External category reference: `evobc-cat-08833`
- Source category ID: `08833`
- Source label: `輑`
...
- `obs-evo-cand-008833-route-category-staging`
...
- `obs-evo-cand-008833-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008833-route-evolution-graph`
