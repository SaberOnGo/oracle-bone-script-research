# obs-unk-004308 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004308`
- primary external id: `hust-obc-und-L-004308`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/008_obs-unk-004308_h
  ust-obc-und-L-004308_oracle-character-candidate/03_visual-assets/001_asset
  -005901_hust-obc-und-L-004308_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4308/L_？_9502.jpg`
- asset id: `asset-005901`
...
- source class: `HUST-OBC/undeciphered/L/4308/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4308/L_？_9502.jpg`
- asset id: `asset-005901`
...
- English observation: `Dense upper cluster, loops, long diagonals visible.`
- 中文观察: `密集上部痕迹组、环状痕迹和长斜痕可见。`
...
- Which source records identify obs-unk-004308 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004308？
