# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003244
...
- EVOBC candidate category: `evobc-evo-cat-03244`.
- Source label for search only: `扌`.
- Source codepoints for search only: `U+624C`.
