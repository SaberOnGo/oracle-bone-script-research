...
Project ID: `obs-evo-cand-003010`
...
- Project ID: `obs-evo-cand-003010`
- EVOBC category candidate ID: `evobc-evo-cat-03010`
- External category reference: `evobc-cat-03010`
- Source category ID: `03010`
- Source label for human review: `悔`
- Source codepoints: `U+6094`
...
- `obs-evo-cand-003010-route-category-staging`
...
- `obs-evo-cand-003010-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003010-route-evolution-graph`
