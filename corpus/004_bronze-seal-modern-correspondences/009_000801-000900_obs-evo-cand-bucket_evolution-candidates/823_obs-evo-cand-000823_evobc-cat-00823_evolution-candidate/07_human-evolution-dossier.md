...
- External category reference: `evobc-cat-00823`
- Source category ID: `00823`
- Source label for human review: `佶`
- Source codepoints: `U+4F76`
...
- `obs-evo-cand-000823-route-category-staging`
...
- `obs-evo-cand-000823-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000823-route-evolution-graph`
