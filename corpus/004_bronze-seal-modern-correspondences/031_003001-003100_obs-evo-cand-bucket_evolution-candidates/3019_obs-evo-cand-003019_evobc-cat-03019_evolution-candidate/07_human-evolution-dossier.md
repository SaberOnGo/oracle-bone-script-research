...
Project ID: `obs-evo-cand-003019`
...
- Project ID: `obs-evo-cand-003019`
- EVOBC category candidate ID: `evobc-evo-cat-03019`
- External category reference: `evobc-cat-03019`
- Source category ID: `03019`
- Source label for human review: `悤`
- Source codepoints: `U+60A4`
...
- `obs-evo-cand-003019-route-category-staging`
...
- `obs-evo-cand-003019-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003019-route-evolution-graph`
