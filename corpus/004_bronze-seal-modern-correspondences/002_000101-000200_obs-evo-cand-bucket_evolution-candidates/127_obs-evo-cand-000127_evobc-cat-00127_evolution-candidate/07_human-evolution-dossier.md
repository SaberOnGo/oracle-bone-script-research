...
- External category reference: `evobc-cat-00127`
- Source category ID: `00127`
- Source label for human review: `㥒`
- Source codepoints: `U+3952`
...
- `obs-evo-cand-000127-route-category-staging`
...
- `obs-evo-cand-000127-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000127-route-evolution-graph`
