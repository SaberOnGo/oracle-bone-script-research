...
- `obs-evo-cand-006861-route-category-staging`
...
- `obs-evo-cand-006861-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006861-route-evolution-graph`
