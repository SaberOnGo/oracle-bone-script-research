# obs-char-000351 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/351_obs-char-000351_hust-obc-cat-0398_orac
  le-character/03_visual-assets/001_asset-000356_hust-obc-cat-0398_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0398/G_0398_甲骨文0.png`
- asset id: `asset-000356`
...
- source category: `0398`
- validation class: `350`
- source image route: `HUST-OBC/deciphered/0398/G_0398_甲骨文0.png`
- asset id: `asset-000356`
...
- English observation: `The dense image contains overlapping angular
  enclosures, crossing strokes, and a pointed lower-left extension.`
- 中文观察: `密集图像含相互重叠的折角闭合轮廓、交叉笔画和左下方尖状延伸。`
...
- dataset label text: `㖄`
- dataset label codepoints: `U+3584`
...
- Which source records identify obs-char-000351 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000351？
