...
- External category reference: `evobc-cat-02845`
- Source category ID: `02845`
- Source label for human review: `彥`
...
- `obs-evo-cand-002845-route-category-staging`
...
- `obs-evo-cand-002845-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002845-route-evolution-graph`
