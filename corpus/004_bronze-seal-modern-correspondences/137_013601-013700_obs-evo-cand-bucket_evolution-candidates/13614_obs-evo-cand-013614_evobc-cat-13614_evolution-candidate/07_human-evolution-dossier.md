...
- External category reference: `evobc-cat-13614`
- Source category ID: `13614`
- Source label for human review: `𮊫`
- Source codepoints: `U+2E2AB`
...
- `obs-evo-cand-013614-route-category-staging`
...
- `obs-evo-cand-013614-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013614-route-evolution-graph`
