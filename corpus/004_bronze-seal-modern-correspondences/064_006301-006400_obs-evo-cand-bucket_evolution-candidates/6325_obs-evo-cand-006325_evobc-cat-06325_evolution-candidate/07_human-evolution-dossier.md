...
- External category reference: `evobc-cat-06325`
- Source category ID: `06325`
- Source label for human review: `篥`
- Source codepoints: `U+7BE5`
...
- `obs-evo-cand-006325-route-category-staging`
...
- `obs-evo-cand-006325-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006325-route-evolution-graph`
