# Material Visual Observation / obs-comp-cand-002350 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002350`
- External reference / 外部参照: `obimd-sub-cod914fnx4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020421_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cod914fnx4/cod914fnx4/cod914fnx4.png`
- Checksum / 校验和:
  `ebb21b66a14e93291a6afe1528c33039a3599eb9c9b30a4dd4d921d8b89e5f16`
...
- Marked-pixel bounds: (75,17)–(147,232); span 73 × 216 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.36%。
- 痕迹范围：(75,17)–(147,232)；跨度73 × 216 px；痕迹矩形高于宽。
