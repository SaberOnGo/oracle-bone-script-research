...
Project ID: `obs-evo-cand-003415`
...
- Project ID: `obs-evo-cand-003415`
- EVOBC category candidate ID: `evobc-evo-cat-03415`
- External category reference: `evobc-cat-03415`
- Source category ID: `03415`
- Source label for human review: `掩`
- Source codepoints: `U+63A9`
...
- `obs-evo-cand-003415-route-category-staging`
...
- `obs-evo-cand-003415-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003415-route-evolution-graph`
