...
- External category reference: `evobc-cat-09517`
- Source category ID: `09517`
- Source label for human review: `鐅`
...
- `obs-evo-cand-009517-route-category-staging`
...
- `obs-evo-cand-009517-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009517-route-evolution-graph`
