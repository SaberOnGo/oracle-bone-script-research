# Material Visual Observation / obs-comp-cand-002581 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002581`
- External reference / 外部参照: `obimd-sub-h3zr1w3onf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021120_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h3zr1w3onf/h3zr1w3onf/h3zr1w3onf.png`
- Checksum / 校验和:
  `7da65a6de61bbf78f17f1023923bbb0098c552afbcabcd790c190838ef00a4b9`
...
- Marked-pixel bounds: (83,28)–(170,225); span 88 × 198 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.05%。
- 痕迹范围：(83,28)–(170,225)；跨度88 × 198 px；痕迹矩形高于宽。
