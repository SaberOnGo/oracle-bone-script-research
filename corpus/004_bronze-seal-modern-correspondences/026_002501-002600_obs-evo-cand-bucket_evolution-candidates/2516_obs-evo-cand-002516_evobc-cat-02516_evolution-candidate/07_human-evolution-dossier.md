...
- External category reference: `evobc-cat-02516`
- Source category ID: `02516`
- Source label for human review: `屢`
...
- `obs-evo-cand-002516-route-category-staging`
...
- `obs-evo-cand-002516-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002516-route-evolution-graph`
