...
- External category reference: `evobc-cat-12101`
- Source category ID: `12101`
- Source label for human review: `𦲧`
...
- `obs-evo-cand-012101-route-category-staging`
...
- `obs-evo-cand-012101-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012101-route-evolution-graph`
