...
Project ID: `obs-evo-cand-010092`
...
- Project ID: `obs-evo-cand-010092`
- EVOBC category candidate ID: `evobc-evo-cat-10092`
- External category reference: `evobc-cat-10092`
- Source category ID: `10092`
- Source label for human review: `飶`
- Source codepoints: `U+98F6`
...
- `obs-evo-cand-010092-route-category-staging`
...
- `obs-evo-cand-010092-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010092-route-evolution-graph`
