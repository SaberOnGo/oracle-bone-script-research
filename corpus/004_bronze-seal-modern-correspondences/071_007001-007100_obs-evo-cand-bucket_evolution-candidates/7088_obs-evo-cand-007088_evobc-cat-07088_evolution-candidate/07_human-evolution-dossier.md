...
- External category reference: `evobc-cat-07088`
- Source category ID: `07088`
- Source label for human review: `腊`
...
- `obs-evo-cand-007088-route-category-staging`
...
- `obs-evo-cand-007088-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007088-route-evolution-graph`
