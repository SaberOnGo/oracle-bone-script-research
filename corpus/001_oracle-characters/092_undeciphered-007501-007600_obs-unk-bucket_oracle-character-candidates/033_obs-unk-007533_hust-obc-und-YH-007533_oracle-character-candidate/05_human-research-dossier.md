# obs-unk-007533 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/092_undeciphered-007
  501-007600_obs-unk-bucket_oracle-character-candidates/033_obs-unk-007533_h
  ust-obc-und-YH-007533_oracle-character-candidate/03_visual-assets/001_asse
  t-009124_hust-obc-und-YH-007533_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/600A6/H_？_600A6_0.png`
- asset id: `asset-009124`
...
- source class: `HUST-OBC/undeciphered/Y+H/600A6/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/600A6/H_？_600A6_0.png`
- asset id: `asset-009124`
...
- Which source records identify obs-unk-007533 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007533？
