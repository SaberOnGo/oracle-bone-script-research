# Material Visual Observation / obs-comp-cand-000582 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000582`
- External reference / 外部参照: `obimd-sub-zd8unl3rqn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013110_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zd8unl3rqn/zd8unl3rqn/zd8unl3rqn.png`
- Checksum / 校验和:
  `fc4e8f329b745d920c38be8393fc613199eec8b80601b6647dd63d1c8ed7015e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.77%.
- Marked-pixel bounds: (63,6)–(186,239); span 124 × 234 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.77%。
- 痕迹范围：(63,6)–(186,239)；跨度124 × 234 px；痕迹矩形高于宽。
