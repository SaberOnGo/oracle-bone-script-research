# obs-unk-004256 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004256`
- primary external id: `hust-obc-und-L-004256`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/056_obs-unk-004256_h
  ust-obc-und-L-004256_oracle-character-candidate/03_visual-assets/001_asset
  -005849_hust-obc-und-L-004256_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4256/L_？_9374.jpg`
- asset id: `asset-005849`
...
- source class: `HUST-OBC/undeciphered/L/4256/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4256/L_？_9374.jpg`
- asset id: `asset-005849`
...
- English observation: `Left vertical, crossing mark, curved terminal visible.`
- 中文观察: `左侧竖痕、上部交叉痕迹和右侧弯曲末端可见。`
...
- Which source records identify obs-unk-004256 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004256？
