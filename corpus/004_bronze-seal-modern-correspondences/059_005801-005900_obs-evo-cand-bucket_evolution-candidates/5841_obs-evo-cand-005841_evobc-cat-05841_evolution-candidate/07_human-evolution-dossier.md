...
Project ID: `obs-evo-cand-005841`
...
- Project ID: `obs-evo-cand-005841`
- EVOBC category candidate ID: `evobc-evo-cat-05841`
- External category reference: `evobc-cat-05841`
- Source category ID: `05841`
- Source label for human review: `睿`
- Source codepoints: `U+777F`
...
- `obs-evo-cand-005841-route-category-staging`
...
- `obs-evo-cand-005841-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005841-route-evolution-graph`
