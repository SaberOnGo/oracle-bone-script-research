# Material Visual Observation / obs-comp-cand-001167 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001167`
- External reference / 外部参照: `obimd-sub-2nz3zp3pmu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015357_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2nz3zp3pmu/2nz3zp3pmu/2nz3zp3pmu.png`
- Checksum / 校验和:
  `27b5b8f7986f66380c36d8e146edcf7d304a964fbcbf0596cd381798115ae59a`
...
- Marked-pixel bounds: (75,39)–(173,214); span 99 × 176 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.59%。
- 痕迹范围：(75,39)–(173,214)；跨度99 × 176 px；痕迹矩形高于宽。
