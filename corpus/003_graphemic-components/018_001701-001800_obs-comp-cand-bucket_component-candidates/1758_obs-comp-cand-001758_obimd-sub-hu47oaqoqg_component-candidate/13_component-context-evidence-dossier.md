# obs-comp-cand-001758 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001758`
- 首选外部 ID: `obimd-sub-hu47oaqoqg`
- OBIMD subcharacter UID: `hu47oaqoqg`
- OBIMD main character UID: `hu47oaqoqg`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+FA25B; U+FA25C; 另有 3 项
