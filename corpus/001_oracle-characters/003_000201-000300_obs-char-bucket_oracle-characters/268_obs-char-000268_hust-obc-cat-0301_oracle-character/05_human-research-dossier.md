# obs-char-000268 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000268`
- primary external id: `hust-obc-cat-0301`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/268_obs-char-000268_hust-obc-cat-0301_orac
  le-character/03_visual-assets/001_asset-000273_hust-obc-cat-0301_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0301/X_0301_3281_1.png`
- asset id: `asset-000273`
...
- source category: `0301`
- validation class: `267`
- source image route: `HUST-OBC/deciphered/0301/X_0301_3281_1.png`
- asset id: `asset-000273`
...
- English observation: `The small image shows a narrow curved upright stroke
  with a short forked branch near its upper end and a separate lower curve.`
- 中文观察: `小型图像有窄而弯曲的直立笔画，上端附近有短分叉，下面另有弧形痕迹。`
...
- dataset label text: `㔣`
- dataset label codepoints: `U+3523`
...
- Which source records identify obs-char-000268 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000268？
