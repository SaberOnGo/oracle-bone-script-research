...
- Yingguo / 英国所藏: `y2261` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `572` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `363` in source row; primary catalog entry pending
- Heji / 合集: `41320` in source row; primary catalog entry pending
