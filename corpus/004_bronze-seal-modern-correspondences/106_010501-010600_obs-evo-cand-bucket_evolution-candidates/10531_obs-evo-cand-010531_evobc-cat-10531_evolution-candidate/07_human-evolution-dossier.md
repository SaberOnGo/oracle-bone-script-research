...
- External category reference: `evobc-cat-10531`
- Source category ID: `10531`
- Source label for human review: `鶨`
...
- `obs-evo-cand-010531-route-category-staging`
...
- `obs-evo-cand-010531-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010531-route-evolution-graph`
