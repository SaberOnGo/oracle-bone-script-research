...
- External category reference: `evobc-cat-13657`
- Source category ID: `13657`
- Source label for human review: `𮟮`
- Source codepoints: `U+2E7EE`
...
- `obs-evo-cand-013657-route-category-staging`
...
- `obs-evo-cand-013657-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013657-route-evolution-graph`
