...
Project ID: `obs-evo-cand-010238`
...
- Project ID: `obs-evo-cand-010238`
- EVOBC category candidate ID: `evobc-evo-cat-10238`
- External category reference: `evobc-cat-10238`
- Source category ID: `10238`
- Source label for human review: `騷`
- Source codepoints: `U+9A37`
...
- `obs-evo-cand-010238-route-category-staging`
...
- `obs-evo-cand-010238-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010238-route-evolution-graph`
