# obs-char-000163 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000163`
- primary external id: `hust-obc-cat-0179`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/163_obs-char-000163_hust-obc-cat-0179_orac
  le-character/03_visual-assets/001_asset-000168_hust-obc-cat-0179_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0179/G_0179_甲3372(甲).png`
- asset id: `asset-000168`
...
- source category: `0179`
- validation class: `162`
- source image route: `HUST-OBC/deciphered/0179/G_0179_甲3372(甲).png`
- asset id: `asset-000168`
...
- English observation: `The narrow image has a small angular upper cap, a
  long curved outer stroke, and a short inner branch descending beside it.`
- 中文观察: `狭长图像上方有小型折角盖状笔，外侧有长弯曲笔，旁边有短内部分支下行。`
...
- dataset label text: `㒩`
- dataset label codepoints: `U+34A9`
...
- Which source records identify obs-char-000163 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000163？
