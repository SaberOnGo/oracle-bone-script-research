...
Project ID: `obs-insc-cw-cand-000251`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000251`
...
- Yingguo / 英国所藏: `y1609` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `152` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `387` in source row; primary catalog entry pending
- Heji / 合集: `40354` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000251`
