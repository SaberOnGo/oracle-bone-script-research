# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004846
...
- EVOBC candidate category: `evobc-evo-cat-04846`.
- Source label for search only: `滞`.
- Source codepoints for search only: `U+6EDE`.
