# obs-unk-005254 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/069_undeciphered-005
  201-005300_obs-unk-bucket_oracle-character-candidates/054_obs-unk-005254_h
  ust-obc-und-X-005254_oracle-character-candidate/03_visual-assets/001_asset
  -006847_hust-obc-und-X-005254_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/810/X_？_7773_1.png`
- asset id: `asset-006847`
...
- source class: `HUST-OBC/undeciphered/X/810/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/810/X_？_7773_1.png`
- asset id: `asset-006847`
...
- Which source records identify obs-unk-005254 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005254？
