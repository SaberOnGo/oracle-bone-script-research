...
- External category reference: `evobc-cat-00511`
- Source category ID: `00511`
- Source label for human review: `䤾`
...
- `obs-evo-cand-000511-route-category-staging`
...
- `obs-evo-cand-000511-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000511-route-evolution-graph`
