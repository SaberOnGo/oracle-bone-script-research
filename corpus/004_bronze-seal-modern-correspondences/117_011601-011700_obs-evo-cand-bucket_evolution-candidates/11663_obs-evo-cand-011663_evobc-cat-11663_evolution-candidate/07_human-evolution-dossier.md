...
- External category reference: `evobc-cat-11663`
- Source category ID: `11663`
- Source label for human review: `𤰶`
- Source codepoints: `U+24C36`
...
- `obs-evo-cand-011663-route-category-staging`
...
- `obs-evo-cand-011663-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011663-route-evolution-graph`
