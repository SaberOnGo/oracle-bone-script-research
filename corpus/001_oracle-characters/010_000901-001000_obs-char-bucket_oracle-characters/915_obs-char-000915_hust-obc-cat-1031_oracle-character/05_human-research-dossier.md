# obs-char-000915 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000915`
- primary external id: `hust-obc-cat-1031`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/915_obs-char-000915_hust-obc-cat-1031_orac
  le-character/03_visual-assets/001_asset-000920_hust-obc-cat-1031_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1031/G_1031_京津3160.png`
- asset id: `asset-000920`
...
- source category: `1031`
- validation class: `914`
- source image route: `HUST-OBC/deciphered/1031/G_1031_京津3160.png`
- asset id: `asset-000920`
...
- English observation: `A narrow stem has a small central loop, a short
  upper projection, and several long lower branches.`
- 中文观察: `狭长笔干有中央小环、短上伸笔和数条长下部分枝。`
...
- dataset label text: `㟽`
- dataset label codepoints: `U+37FD`
...
- Which source records identify obs-char-000915 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000915？
