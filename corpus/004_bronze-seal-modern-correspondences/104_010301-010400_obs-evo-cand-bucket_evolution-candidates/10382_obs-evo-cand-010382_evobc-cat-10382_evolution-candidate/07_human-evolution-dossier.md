...
- Project ID: `obs-evo-cand-010382`
- EVOBC category candidate ID: `evobc-evo-cat-10382`
- External category reference: `evobc-cat-10382`
- Source category ID: `10382`
- Source label for human review: `鮀`
- Source codepoints: `U+9B80`
...
- `obs-evo-cand-010382-route-category-staging`
...
- `obs-evo-cand-010382-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010382-route-evolution-graph`
