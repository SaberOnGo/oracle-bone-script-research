# Material Visual Observation / obs-comp-cand-000462 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000462`
- External reference / 外部参照: `obimd-sub-8gro2b24ja`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012610_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8gro2b24ja/8gro2b24ja/8gro2b24ja.png`
- Checksum / 校验和:
  `481b94b53c1ecf2ce17beeb3d7ef8e8f984ca9c77f1d2021516248e6551dce0e`
...
- Marked-pixel bounds: (83,32)–(167,219); span 85 × 188 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.34%。
- 痕迹范围：(83,32)–(167,219)；跨度85 × 188 px；痕迹矩形高于宽。
