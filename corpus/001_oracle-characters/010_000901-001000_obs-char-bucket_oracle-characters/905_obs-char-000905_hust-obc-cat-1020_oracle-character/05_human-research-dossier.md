# obs-char-000905 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000905`
- primary external id: `hust-obc-cat-1020`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/905_obs-char-000905_hust-obc-cat-1020_orac
  le-character/03_visual-assets/001_asset-000910_hust-obc-cat-1020_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1020/G_1020_後2.41.15合28198.png`
- asset id: `asset-000910`
...
- source category: `1020`
- validation class: `904`
- source image route: `HUST-OBC/deciphered/1020/G_1020_後2.41.15合28198.png`
- asset id: `asset-000910`
...
- English observation: `A compact rectangular upper lattice is joined to a
  lower rounded branching form with several short vertical strokes.`
- 中文观察: `紧密矩形上部格状笔群连接下方圆弧分枝形体，并带有数条短直立笔。`
...
- dataset label text: `㟲`
- dataset label codepoints: `U+37F2`
...
- filename catalog route clues: `Heji-like filename clue: 合28198
  (G_1020_後2.41.15合28198.png)`
...
- Which source records identify obs-char-000905 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000905？
