...
Project ID: `obs-evo-cand-011424`
...
- Project ID: `obs-evo-cand-011424`
- EVOBC category candidate ID: `evobc-evo-cat-11424`
- External category reference: `evobc-cat-11424`
- Source category ID: `11424`
- Source label for human review: `𣏕`
- Source codepoints: `U+233D5`
...
- `obs-evo-cand-011424-route-category-staging`
...
- `obs-evo-cand-011424-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011424-route-evolution-graph`
