# Material Visual Observation / obs-comp-cand-000601 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000601`
- External reference / 外部参照: `obimd-sub-8k76kao4ll`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013134_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8k76kao4ll/8k76kao4ll/8k76kao4ll.png`
- Checksum / 校验和:
  `a07475914fd4c998f1ea84667eba05f6ae538772e9ee1ca7709a8a0d2dcb436b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 14.58%.
- Marked-pixel bounds: (45,23)–(209,224); span 165 × 202 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占14.58%。
- 痕迹范围：(45,23)–(209,224)；跨度165 × 202 px；痕迹矩形高于宽。
