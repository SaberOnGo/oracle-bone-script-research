...
- Project ID: `obs-evo-cand-003720`
- EVOBC category candidate ID: `evobc-evo-cat-03720`
- External category reference: `evobc-cat-03720`
- Source category ID: `03720`
- Source label for human review: `昧`
- Source codepoints: `U+6627`
...
- `obs-evo-cand-003720-route-category-staging`
...
- `obs-evo-cand-003720-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003720-route-evolution-graph`
