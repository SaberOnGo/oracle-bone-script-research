...
- External category reference: `evobc-cat-09552`
- Source category ID: `09552`
- Source label for human review: `鑪`
...
- `obs-evo-cand-009552-route-category-staging`
...
- `obs-evo-cand-009552-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009552-route-evolution-graph`
