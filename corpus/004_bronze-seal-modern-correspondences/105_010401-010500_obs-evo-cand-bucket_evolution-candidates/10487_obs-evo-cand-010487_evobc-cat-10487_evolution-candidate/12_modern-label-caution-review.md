# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010487
...
- EVOBC candidate category: `evobc-evo-cat-10487`.
- Source label for search only: `鴚`.
- Source codepoints for search only: `U+9D1A`.
