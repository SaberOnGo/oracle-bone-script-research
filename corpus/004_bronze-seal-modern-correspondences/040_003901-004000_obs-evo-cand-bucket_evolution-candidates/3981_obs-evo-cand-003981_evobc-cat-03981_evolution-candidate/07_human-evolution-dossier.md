...
Project ID: `obs-evo-cand-003981`
...
- Project ID: `obs-evo-cand-003981`
- EVOBC category candidate ID: `evobc-evo-cat-03981`
- External category reference: `evobc-cat-03981`
- Source category ID: `03981`
- Source label for human review: `柶`
- Source codepoints: `U+67F6`
...
- `obs-evo-cand-003981-route-category-staging`
...
- `obs-evo-cand-003981-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003981-route-evolution-graph`
