...
- Project ID: `obs-evo-cand-009622`
- EVOBC category candidate ID: `evobc-evo-cat-09622`
- External category reference: `evobc-cat-09622`
- Source category ID: `09622`
- Source label for human review: `間`
- Source codepoints: `U+9593`
...
- `obs-evo-cand-009622-route-category-staging`
...
- `obs-evo-cand-009622-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009622-route-evolution-graph`
