...
- External category reference: `evobc-cat-10203`
- Source category ID: `10203`
- Source label for human review: `駹`
- Source codepoints: `U+99F9`
...
- `obs-evo-cand-010203-route-category-staging`
...
- `obs-evo-cand-010203-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010203-route-evolution-graph`
