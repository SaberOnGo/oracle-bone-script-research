# obs-unk-004888 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/088_obs-unk-004888_h
  ust-obc-und-X-004888_oracle-character-candidate/03_visual-assets/001_asset
  -006481_hust-obc-und-X-004888_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/444/X_？_7426_1.png`
- asset id: `asset-006481`
...
- source class: `HUST-OBC/undeciphered/X/444/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/444/X_？_7426_1.png`
- asset id: `asset-006481`
...
- English observation: `arch-like upper outline and lower forked group`
- 中文观察: `拱形上部外框和下部分叉结构`
...
- Which source records identify obs-unk-004888 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004888？
