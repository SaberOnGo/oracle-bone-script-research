...
Project ID: `obs-insc-cw-cand-000295`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000295`
...
- Yingguo / 英国所藏: `y1926` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `419` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `53` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000295`
