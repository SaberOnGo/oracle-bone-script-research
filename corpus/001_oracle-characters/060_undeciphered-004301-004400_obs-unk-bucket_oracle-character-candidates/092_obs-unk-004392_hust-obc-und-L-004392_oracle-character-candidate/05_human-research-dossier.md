# obs-unk-004392 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/092_obs-unk-004392_h
  ust-obc-und-L-004392_oracle-character-candidate/03_visual-assets/001_asset
  -005985_hust-obc-und-L-004392_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4392/L_？_9766.jpg`
- asset id: `asset-005985`
...
- source class: `HUST-OBC/undeciphered/L/4392/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4392/L_？_9766.jpg`
- asset id: `asset-005985`
...
- English observation: `A small left cluster sits beside a long`
  `descending right trace and an upper pointed outline.`
- 中文观察: `左侧小痕迹群旁有右侧下伸长痕和上部尖状轮廓。`
...
- Which source records identify obs-unk-004392 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004392？
