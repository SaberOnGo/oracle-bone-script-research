# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008207
...
- EVOBC candidate category: `evobc-evo-cat-08207`.
- Source label for search only: `詻`.
- Source codepoints for search only: `U+8A7B`.
