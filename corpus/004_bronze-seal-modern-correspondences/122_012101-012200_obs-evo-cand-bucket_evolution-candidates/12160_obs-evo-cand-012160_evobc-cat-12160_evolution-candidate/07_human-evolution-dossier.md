...
Project ID: `obs-evo-cand-012160`
...
- Project ID: `obs-evo-cand-012160`
- EVOBC category candidate ID: `evobc-evo-cat-12160`
- External category reference: `evobc-cat-12160`
- Source category ID: `12160`
- Source label for human review: `𧍣`
- Source codepoints: `U+27363`
...
- `obs-evo-cand-012160-route-category-staging`
...
- `obs-evo-cand-012160-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012160-route-evolution-graph`
