# Material Visual Observation / obs-comp-cand-002316 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002316`
- External reference / 外部参照: `obimd-sub-pdeu3hzht6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020335_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dnqkkwgd05/pdeu3hzht6/pdeu3hzht6.png`
- Checksum / 校验和:
  `c0d98a4acb9ce65ca2bc3e5f35cda940ecbd7ecb83c524a4d8cbacb2d6918a62`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.03%.
- Marked-pixel bounds: (78,33)–(171,212); span 94 × 180 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.03%。
- 痕迹范围：(78,33)–(171,212)；跨度94 × 180 px；痕迹矩形高于宽。
