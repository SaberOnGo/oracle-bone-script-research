# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004656
...
- EVOBC candidate category: `evobc-evo-cat-04656`.
- Source label for search only: `浚`.
- Source codepoints for search only: `U+6D5A`.
