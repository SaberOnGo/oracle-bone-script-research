...
- External category reference: `evobc-cat-13194`
- Source category ID: `13194`
- Source label for human review: `𬂊`
- Source codepoints: `U+2C08A`
...
- `obs-evo-cand-013194-route-category-staging`
...
- `obs-evo-cand-013194-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013194-route-evolution-graph`
