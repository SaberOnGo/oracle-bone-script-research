...
Project ID: `obs-insc-cw-cand-000179`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000179`
...
- Yingguo / 英国所藏: `y1080` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `25` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `654` in source row; primary catalog entry pending
- Heji / 合集: `40328` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000179`
