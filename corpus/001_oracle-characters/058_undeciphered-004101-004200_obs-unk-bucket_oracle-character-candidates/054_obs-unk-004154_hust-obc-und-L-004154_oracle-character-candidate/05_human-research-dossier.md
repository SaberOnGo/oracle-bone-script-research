# obs-unk-004154 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/054_obs-unk-004154_h
  ust-obc-und-L-004154_oracle-character-candidate/03_visual-assets/001_asset
  -005747_hust-obc-und-L-004154_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4154/L_？_9000.jpg`
- asset id: `asset-005747`
...
- source class: `HUST-OBC/undeciphered/L/4154/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4154/L_？_9000.jpg`
- asset id: `asset-005747`
...
- English observation: A narrow left trace has lower branching marks;
  a rounded right outline carries inner horizontal traces.
- 中文观察：左侧窄痕迹带下部分支；右侧圆弧轮廓带内部横向痕迹。
...
- Which source records identify obs-unk-004154 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004154？
