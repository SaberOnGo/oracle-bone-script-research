# obs-char-000574 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/574_obs-char-000574_hust-obc-cat-0650_orac
  le-character/03_visual-assets/001_asset-000579_hust-obc-cat-0650_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0650/G_0650_乙484合21722子組.png`
- asset id: `asset-000579`
...
- source category: `0650`
- validation class: `573`
- source image route: `HUST-OBC/deciphered/0650/G_0650_乙484合21722子組.png`
- asset id: `asset-000579`
...
- English observation: `A bold zigzag vertical trunk carries several short
  alternating side bars and widens into a dark horizontal base at the
  bottom.`
...
- dataset label text: `㚀`
- dataset label codepoints: `U+3680`
...
- filename catalog route clues: `Heji-like filename clue: 合21722
  (G_0650_乙484合21722子組.png)`
...
- Which source records identify obs-char-000574 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000574？
