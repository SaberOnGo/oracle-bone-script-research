# obs-unk-009047 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-009047`
- primary external id: `hust-obc-und-YH-009047`
...
- local review image route: `corpus/001_oracle-characters/107_undeciphered-009
  001-009100_obs-unk-bucket_oracle-character-candidates/047_obs-unk-009047_h
  ust-obc-und-YH-009047_oracle-character-candidate/03_visual-assets/001_asse
  t-010638_hust-obc-und-YH-009047_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/610EC/H_？_610EC_0.png`
- asset id: `asset-010638`
...
- source class: `HUST-OBC/undeciphered/Y+H/610EC/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/610EC/H_？_610EC_0.png`
- asset id: `asset-010638`
...
- Which source records identify obs-unk-009047 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009047？
