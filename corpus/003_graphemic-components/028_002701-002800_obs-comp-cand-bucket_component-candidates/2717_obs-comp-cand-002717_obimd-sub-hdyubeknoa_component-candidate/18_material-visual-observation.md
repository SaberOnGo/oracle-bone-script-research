# Material Visual Observation / obs-comp-cand-002717 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002717`
- External reference / 外部参照: `obimd-sub-hdyubeknoa`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021293_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hdyubeknoa/hdyubeknoa/hdyubeknoa.png`
- Checksum / 校验和:
  `ea0888cce7f6702fc0e422b24779cf1e3ddb137a2ba5ffd34203e57ce339c658`
...
- Marked-pixel bounds: (61,44)–(188,199); span 128 × 156 px; the marked
...
- 痕迹范围：(61,44)–(188,199)；跨度128 × 156 px；痕迹矩形高于宽。
