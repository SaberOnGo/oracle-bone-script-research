...
- Yingguo / 英国所藏: `y82` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `58` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `625` in source row; primary catalog entry pending
- Heji / 合集: `39618` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000017`
