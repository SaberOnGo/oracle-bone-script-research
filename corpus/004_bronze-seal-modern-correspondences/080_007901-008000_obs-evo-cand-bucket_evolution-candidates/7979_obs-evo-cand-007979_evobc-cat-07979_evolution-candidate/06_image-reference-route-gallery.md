...
- `obs-evo-cand-007979-route-category-staging`
...
- `obs-evo-cand-007979-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007979-route-evolution-graph`
