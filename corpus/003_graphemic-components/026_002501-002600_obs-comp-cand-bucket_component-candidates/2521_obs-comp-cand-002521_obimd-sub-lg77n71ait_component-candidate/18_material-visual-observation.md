# Material Visual Observation / obs-comp-cand-002521 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002521`
- External reference / 外部参照: `obimd-sub-lg77n71ait`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020901_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0uhj5zj3ce/lg77n71ait/1u7dxia3d0.png`
- Checksum / 校验和:
  `b87ac2e930c2e4db7a0899db43243aca6708467e47652f9d7d0725a45b3683ab`
...
- Marked-pixel bounds: (58,64)–(191,186); span 134 × 123 px; the marked
...
- 痕迹范围：(58,64)–(191,186)；跨度134 × 123 px；痕迹矩形近方形。
