...
Project ID: `obs-evo-cand-011863`
...
- Project ID: `obs-evo-cand-011863`
- EVOBC category candidate ID: `evobc-evo-cat-11863`
- External category reference: `evobc-cat-11863`
- Source category ID: `11863`
- Source label for human review: `𥪤`
- Source codepoints: `U+25AA4`
...
- `obs-evo-cand-011863-route-category-staging`
...
- `obs-evo-cand-011863-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011863-route-evolution-graph`
