# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000100
...
| --- | --- | --- | --- |
| `obimd-glyph-link-001523` | 󰦀 | `U+F0980` | `reviewed_metadata_only` |
| `obimd-glyph-link-001524` | 󰦁 | `U+F0981` | `reviewed_metadata_only` |
