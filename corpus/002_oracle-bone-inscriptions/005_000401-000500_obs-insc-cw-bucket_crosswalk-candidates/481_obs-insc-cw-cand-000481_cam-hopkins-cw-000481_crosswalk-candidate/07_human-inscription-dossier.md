...
Project ID: `obs-insc-cw-cand-000481`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000481`
...
- Source page section: `Period III Group 20` /
  `第 III 期第 20 组`
- Source section key: `period-iii-group-20`
...
- Yingguo / 英国所藏: `y2397` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `240` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `394` in source row; primary catalog entry pending
...
- Group and batch / 组类与批次: group `20`; batch or pit context pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000481`
