# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012788
...
- EVOBC candidate category: `evobc-evo-cat-12788`.
- Source label for search only: `𪚦`.
- Source codepoints for search only: `U+2A6A6`.
