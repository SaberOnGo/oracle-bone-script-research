# obs-char-000499 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000499`
- primary external id: `hust-obc-cat-0569_0570`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/499_obs-char-000499_hust-obc-cat-0569_0570
  _oracle-character/03_visual-assets/001_asset-000504_hust-obc-cat-0569_0570
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0569_0570/0569/G_0569_前6.31.5(甲
  ).png`
- asset id: `asset-000504`
...
- source category: `0569_0570`
- validation class: `498`
- source image route: `HUST-OBC/deciphered/0569_0570/0569/G_0569_前6.31.5(甲).pn
  g`
- asset id: `asset-000504`
...
- English observation: `The small narrow image shows an upper angular
  outlined cluster and a lower crossed branching cluster, with a long thin
  stroke descending along the right side.`
- 中文观察: `小型狭窄图像显示上部折角轮廓笔画群和下部交叉分支笔画群，右侧有一条长细笔下垂。`
...
- dataset label text: `㘯㘰`
- dataset label codepoints: `U+362F;U+3630`
...
- graph edge count: `2`
- codepoint routes: `U+362F;U+3630`
...
- Which source records identify obs-char-000499 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000499？
