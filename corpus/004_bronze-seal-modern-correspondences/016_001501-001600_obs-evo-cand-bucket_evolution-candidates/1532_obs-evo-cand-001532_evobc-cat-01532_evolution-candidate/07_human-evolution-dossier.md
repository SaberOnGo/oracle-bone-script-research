...
Project ID: `obs-evo-cand-001532`
...
- Project ID: `obs-evo-cand-001532`
- EVOBC category candidate ID: `evobc-evo-cat-01532`
- External category reference: `evobc-cat-01532`
- Source category ID: `01532`
- Source label for human review: `呈`
- Source codepoints: `U+5448`
...
- `obs-evo-cand-001532-route-category-staging`
...
- `obs-evo-cand-001532-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001532-route-evolution-graph`
