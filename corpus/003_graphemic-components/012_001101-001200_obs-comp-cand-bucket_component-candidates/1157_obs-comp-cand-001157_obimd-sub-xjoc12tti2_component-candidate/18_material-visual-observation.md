# Material Visual Observation / obs-comp-cand-001157 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001157`
- External reference / 外部参照: `obimd-sub-xjoc12tti2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015347_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xjoc12tti2/xjoc12tti2/xjoc12tti2.png`
- Checksum / 校验和:
  `6290975d90a961b055da328588bf5e36ba92db988fc27bdcc07615ad86dbcab3`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.68%.
- Marked-pixel bounds: (54,24)–(217,216); span 164 × 193 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.68%。
- 痕迹范围：(54,24)–(217,216)；跨度164 × 193 px；痕迹矩形近方形。
