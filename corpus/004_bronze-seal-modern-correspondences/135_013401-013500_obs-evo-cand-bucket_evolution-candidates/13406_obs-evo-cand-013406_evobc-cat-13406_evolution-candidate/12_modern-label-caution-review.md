# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013406
...
- EVOBC candidate category: `evobc-evo-cat-13406`.
- Source label for search only: `𬭍`.
- Source codepoints for search only: `U+2CB4D`.
