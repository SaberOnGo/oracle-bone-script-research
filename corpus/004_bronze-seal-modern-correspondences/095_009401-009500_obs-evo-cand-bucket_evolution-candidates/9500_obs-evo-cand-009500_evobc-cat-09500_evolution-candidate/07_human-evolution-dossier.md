...
Project ID: `obs-evo-cand-009500`
...
- Project ID: `obs-evo-cand-009500`
- EVOBC category candidate ID: `evobc-evo-cat-09500`
- External category reference: `evobc-cat-09500`
- Source category ID: `09500`
- Source label for human review: `鏓`
- Source codepoints: `U+93D3`
...
- `obs-evo-cand-009500-route-category-staging`
...
- `obs-evo-cand-009500-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009500-route-evolution-graph`
