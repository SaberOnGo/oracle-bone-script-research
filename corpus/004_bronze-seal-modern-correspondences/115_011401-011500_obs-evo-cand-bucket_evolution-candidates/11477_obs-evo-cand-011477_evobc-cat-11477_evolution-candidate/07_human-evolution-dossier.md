...
- External category reference: `evobc-cat-11477`
- Source category ID: `11477`
- Source label for human review: `𣥿`
- Source codepoints: `U+2397F`
...
- `obs-evo-cand-011477-route-category-staging`
...
- `obs-evo-cand-011477-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011477-route-evolution-graph`
