# obs-char-000872 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000872`
- primary external id: `hust-obc-cat-0983`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/872_obs-char-000872_hust-obc-cat-0983_orac
  le-character/03_visual-assets/001_asset-000877_hust-obc-cat-0983_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0983/G_0983_甲骨文0.png`
- asset id: `asset-000877`
...
- source category: `0983`
- validation class: `871`
- source image route: `HUST-OBC/deciphered/0983/G_0983_甲骨文0.png`
- asset id: `asset-000877`
...
- English observation: `A dense dark cluster has several pointed upper
  branches and a jagged lower descending section.`
- 中文观察: `密集深色笔群上部有数条尖形分枝，下部形成锯齿状下垂段。`
...
- dataset label text: `㟍`
- dataset label codepoints: `U+37CD`
...
- Which source records identify obs-char-000872 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000872？
