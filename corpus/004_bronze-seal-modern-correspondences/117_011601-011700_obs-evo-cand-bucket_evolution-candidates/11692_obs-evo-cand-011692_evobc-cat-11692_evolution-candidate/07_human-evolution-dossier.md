...
- Project ID: `obs-evo-cand-011692`
- EVOBC category candidate ID: `evobc-evo-cat-11692`
- External category reference: `evobc-cat-11692`
- Source category ID: `11692`
- Source label for human review: `𤶏`
- Source codepoints: `U+24D8F`
...
- `obs-evo-cand-011692-route-category-staging`
...
- `obs-evo-cand-011692-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011692-route-evolution-graph`
