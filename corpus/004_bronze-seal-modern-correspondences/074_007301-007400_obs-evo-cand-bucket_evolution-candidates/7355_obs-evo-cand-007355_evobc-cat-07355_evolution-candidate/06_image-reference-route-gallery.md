...
- `obs-evo-cand-007355-route-category-staging`
...
- `obs-evo-cand-007355-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007355-route-evolution-graph`
