...
- External category reference: `evobc-cat-12807`
- Source category ID: `12807`
- Source label for human review: `𪠙`
- Source codepoints: `U+2A819`
...
- `obs-evo-cand-012807-route-category-staging`
...
- `obs-evo-cand-012807-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012807-route-evolution-graph`
