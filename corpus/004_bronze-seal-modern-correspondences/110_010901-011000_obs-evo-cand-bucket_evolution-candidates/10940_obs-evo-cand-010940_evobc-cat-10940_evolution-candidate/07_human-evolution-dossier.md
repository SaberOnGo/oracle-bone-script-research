...
- External category reference: `evobc-cat-10940`
- Source category ID: `10940`
- Source label for human review: `𠳋`
- Source codepoints: `U+20CCB`
- Image reference count in source metadata: `31`
...
- `obs-evo-cand-010940-route-category-staging`
...
- `obs-evo-cand-010940-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010940-route-evolution-graph`
