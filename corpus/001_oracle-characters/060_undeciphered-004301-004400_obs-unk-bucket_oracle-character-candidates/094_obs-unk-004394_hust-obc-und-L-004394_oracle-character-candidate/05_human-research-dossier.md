# obs-unk-004394 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/094_obs-unk-004394_h
  ust-obc-und-L-004394_oracle-character-candidate/03_visual-assets/001_asset
  -005987_hust-obc-und-L-004394_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4394/L_？_9783.jpg`
- asset id: `asset-005987`
...
- source class: `HUST-OBC/undeciphered/L/4394/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4394/L_？_9783.jpg`
- asset id: `asset-005987`
...
- English observation: `A central outlined form has crossing traces and a left`
  `horizontal projection.`
- 中文观察: `中央轮廓内有交叉痕迹，并有一条向左的横向伸出痕迹。`
...
- Which source records identify obs-unk-004394 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004394？
