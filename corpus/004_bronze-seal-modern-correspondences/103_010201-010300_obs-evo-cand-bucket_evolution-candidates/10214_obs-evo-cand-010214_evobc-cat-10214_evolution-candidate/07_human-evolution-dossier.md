...
- External category reference: `evobc-cat-10214`
- Source category ID: `10214`
- Source label for human review: `騋`
...
- `obs-evo-cand-010214-route-category-staging`
...
- `obs-evo-cand-010214-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010214-route-evolution-graph`
