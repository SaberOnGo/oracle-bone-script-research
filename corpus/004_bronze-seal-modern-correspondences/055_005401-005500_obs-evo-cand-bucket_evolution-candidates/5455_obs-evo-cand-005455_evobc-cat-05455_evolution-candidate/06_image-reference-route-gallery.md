...
- `obs-evo-cand-005455-route-category-staging`
...
- `obs-evo-cand-005455-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005455-route-evolution-graph`
