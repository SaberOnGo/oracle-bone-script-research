...
Project ID: `obs-evo-cand-008311`
...
- Project ID: `obs-evo-cand-008311`
- EVOBC category candidate ID: `evobc-evo-cat-08311`
- External category reference: `evobc-cat-08311`
- Source category ID: `08311`
- Source label for human review: `謑`
- Source codepoints: `U+8B11`
...
- `obs-evo-cand-008311-route-category-staging`
...
- `obs-evo-cand-008311-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008311-route-evolution-graph`
