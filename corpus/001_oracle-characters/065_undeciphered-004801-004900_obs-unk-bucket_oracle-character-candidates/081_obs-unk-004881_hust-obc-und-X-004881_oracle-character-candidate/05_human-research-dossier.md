# obs-unk-004881 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004881`
- primary external id: `hust-obc-und-X-004881`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/081_obs-unk-004881_h
  ust-obc-und-X-004881_oracle-character-candidate/03_visual-assets/001_asset
  -006474_hust-obc-und-X-004881_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/437/X_？_7124_1.png`
- asset id: `asset-006474`
...
- source class: `HUST-OBC/undeciphered/X/437/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/437/X_？_7124_1.png`
- asset id: `asset-006474`
...
- English observation: `upper rounded marks and right curved outline`
- 中文观察: `上部圆钝标记和右侧弧形外框`
...
- Which source records identify obs-unk-004881 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004881？
