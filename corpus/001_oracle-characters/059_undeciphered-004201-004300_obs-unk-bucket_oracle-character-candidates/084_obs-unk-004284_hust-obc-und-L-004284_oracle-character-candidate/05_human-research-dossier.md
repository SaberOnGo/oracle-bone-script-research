# obs-unk-004284 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/084_obs-unk-004284_h
  ust-obc-und-L-004284_oracle-character-candidate/03_visual-assets/001_asset
  -005877_hust-obc-und-L-004284_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4284/L_？_946.jpg`
- asset id: `asset-005877`
...
- source class: `HUST-OBC/undeciphered/L/4284/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4284/L_？_946.jpg`
- asset id: `asset-005877`
...
- English observation: `Dark upper mass, split descents, right trace.`
- 中文观察: `深色上部痕迹、分开的下行痕迹和右侧痕迹可见。`
...
- Which source records identify obs-unk-004284 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004284？
