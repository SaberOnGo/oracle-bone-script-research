...
Project ID: `obs-evo-cand-012474`
...
- Project ID: `obs-evo-cand-012474`
- EVOBC category candidate ID: `evobc-evo-cat-12474`
- External category reference: `evobc-cat-12474`
- Source category ID: `12474`
- Source label for human review: `𨣷`
- Source codepoints: `U+288F7`
...
- `obs-evo-cand-012474-route-category-staging`
...
- `obs-evo-cand-012474-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012474-route-evolution-graph`
