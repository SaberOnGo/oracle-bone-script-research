# obs-unk-004886 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/086_obs-unk-004886_h
  ust-obc-und-X-004886_oracle-character-candidate/03_visual-assets/001_asset
  -006479_hust-obc-und-X-004886_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/442/X_？_7424_1.png`
- asset id: `asset-006479`
...
- source class: `HUST-OBC/undeciphered/X/442/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/442/X_？_7424_1.png`
- asset id: `asset-006479`
...
- English observation: `upper projections and dense middle mass`
- 中文观察: `上部突笔和中部密集形体`
...
- Which source records identify obs-unk-004886 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004886？
