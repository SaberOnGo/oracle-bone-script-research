...
- `obs-evo-cand-010313-route-category-staging`
...
- `obs-evo-cand-010313-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010313-route-evolution-graph`
