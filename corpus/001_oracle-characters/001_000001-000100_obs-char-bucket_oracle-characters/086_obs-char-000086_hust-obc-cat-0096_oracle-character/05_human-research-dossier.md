# obs-char-000086 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/086_obs-char-000086_hust-obc-cat-0096_orac
  le-character/03_visual-assets/001_asset-000091_hust-obc-cat-0096_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0096/G_0096_乙7741合811賓組.png`
- asset id: `asset-000091`
...
- source category: `0096`
- validation class: `85`
- source image route: `HUST-OBC/deciphered/0096/G_0096_乙7741合811賓組.png`
- asset id: `asset-000091`
...
- English observation: `The image has a tall central stem, a small
  rectangular loop on the left, and short branching strokes extending toward
  the right.`
...
- dataset label text: `㑖`
- dataset label codepoints: `U+3456`
...
- filename catalog route clues: `Heji-like filename clue: 合811
  (G_0096_乙7741合811賓組.png)`
...
- Which source records identify obs-char-000086 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000086？
