# obs-char-000897 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/897_obs-char-000897_hust-obc-cat-1010_1011
  _oracle-character/03_visual-assets/001_asset-000902_hust-obc-cat-1010_1011
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1010_1011/1010/G_1010_乙959(甲).p
  ng`
- asset id: `asset-000902`
...
- source category: `1010_1011`
- validation class: `896`
- source image route: `HUST-OBC/deciphered/1010_1011/1010/G_1010_乙959(甲).png`
- asset id: `asset-000902`
...
- English observation: `The image is dominated by a broad irregular curved
  outline, with a small isolated interior mark and a long descending stroke
  at right.`
...
- dataset label text: `㟨㟩`
- dataset label codepoints: `U+37E8;U+37E9`
...
- graph edge count: `2`
- codepoint routes: `U+37E8;U+37E9`
...
- Which source records identify obs-char-000897 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000897？
