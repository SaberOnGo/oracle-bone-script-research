...
- Project ID: `obs-evo-cand-013658`
- EVOBC category candidate ID: `evobc-evo-cat-13658`
- External category reference: `evobc-cat-13658`
- Source category ID: `13658`
- Source label for human review: `𮟳`
- Source codepoints: `U+2E7F3`
...
- `obs-evo-cand-013658-route-category-staging`
...
- `obs-evo-cand-013658-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013658-route-evolution-graph`
