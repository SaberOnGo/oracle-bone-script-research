# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-001407
...
- glyph_codepoint_uplus_sample: `U+CCA26;U+F80B2, U+F80B3, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-015826` | `001_asset-015826_img.png` | `9da8898a96fbe86a7bbb9a4787dfddf2947e0af3e6402030d258fc47326ad2ef` |
