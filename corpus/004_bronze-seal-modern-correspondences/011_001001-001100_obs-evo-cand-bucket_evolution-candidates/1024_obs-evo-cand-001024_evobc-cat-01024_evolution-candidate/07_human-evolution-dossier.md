...
Project ID: `obs-evo-cand-001024`
...
- Project ID: `obs-evo-cand-001024`
- EVOBC category candidate ID: `evobc-evo-cat-01024`
- External category reference: `evobc-cat-01024`
- Source category ID: `01024`
- Source label for human review: `僨`
- Source codepoints: `U+50E8`
...
- `obs-evo-cand-001024-route-category-staging`
...
- `obs-evo-cand-001024-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001024-route-evolution-graph`
