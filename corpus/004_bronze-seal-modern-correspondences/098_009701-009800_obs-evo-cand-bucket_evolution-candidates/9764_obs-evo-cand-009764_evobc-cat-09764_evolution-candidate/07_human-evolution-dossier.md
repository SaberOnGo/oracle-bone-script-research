...
- External category reference: `evobc-cat-09764`
- Source category ID: `09764`
- Source label for human review: `隉`
...
- `obs-evo-cand-009764-route-category-staging`
...
- `obs-evo-cand-009764-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009764-route-evolution-graph`
