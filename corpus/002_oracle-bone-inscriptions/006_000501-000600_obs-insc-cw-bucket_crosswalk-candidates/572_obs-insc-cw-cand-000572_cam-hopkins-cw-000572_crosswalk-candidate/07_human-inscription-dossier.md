...
- Yingguo / 英国所藏: `y2590` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `604` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `559` in source row; primary catalog entry pending
- Heji / 合集: `41868` in source row; primary catalog entry pending
