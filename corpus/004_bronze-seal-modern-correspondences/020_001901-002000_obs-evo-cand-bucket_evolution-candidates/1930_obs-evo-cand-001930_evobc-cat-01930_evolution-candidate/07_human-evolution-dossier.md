...
Project ID: `obs-evo-cand-001930`
...
- Project ID: `obs-evo-cand-001930`
- EVOBC category candidate ID: `evobc-evo-cat-01930`
- External category reference: `evobc-cat-01930`
- Source category ID: `01930`
- Source label for human review: `塾`
- Source codepoints: `U+587E`
...
- `obs-evo-cand-001930-route-category-staging`
...
- `obs-evo-cand-001930-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001930-route-evolution-graph`
