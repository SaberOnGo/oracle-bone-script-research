# obs-char-001110 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001110`
- primary external id: `hust-obc-cat-1241`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1110_obs-char-001110_hust-obc-cat-1241_ora
  cle-character/03_visual-assets/001_asset-001115_hust-obc-cat-1241_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1241/L_1241_8745.jpg`
- asset id: `asset-001115`
...
- source category: `1241`
- validation class: `1109`
- source image route: `HUST-OBC/deciphered/1241/L_1241_8745.jpg`
- asset id: `asset-001115`
...
- English observation: `A faint gray image shows two adjacent parts: a
  rounded left loop and an angular right cluster with a short upper bar;
  contrast is low.`
- 中文观察: `较淡灰色图像显示两个相邻部分：圆弧左侧环笔和带短上部横笔的棱角右侧笔群；对比度较低。`
...
- dataset label text: `㣏`
- dataset label codepoints: `U+38CF`
...
- Which source records identify obs-char-001110 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001110？
