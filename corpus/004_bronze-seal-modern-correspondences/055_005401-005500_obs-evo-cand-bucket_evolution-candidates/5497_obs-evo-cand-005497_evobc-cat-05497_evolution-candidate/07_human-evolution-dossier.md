...
- Project ID: `obs-evo-cand-005497`
- EVOBC category candidate ID: `evobc-evo-cat-05497`
- External category reference: `evobc-cat-05497`
- Source category ID: `05497`
- Source label for human review: `瓕`
- Source codepoints: `U+74D5`
...
- `obs-evo-cand-005497-route-category-staging`
...
- `obs-evo-cand-005497-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005497-route-evolution-graph`
