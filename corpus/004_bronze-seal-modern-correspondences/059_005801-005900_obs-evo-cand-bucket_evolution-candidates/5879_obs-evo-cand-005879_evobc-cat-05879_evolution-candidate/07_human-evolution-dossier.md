...
- External category reference: `evobc-cat-05879`
- Source category ID: `05879`
- Source label for human review: `矣`
- Source codepoints: `U+77E3`
- Image reference count in source metadata: `76`
...
- `obs-evo-cand-005879-route-category-staging`
...
- `obs-evo-cand-005879-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005879-route-evolution-graph`
