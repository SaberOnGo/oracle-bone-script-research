...
- Project ID: `obs-evo-cand-002225`
- EVOBC category candidate ID: `evobc-evo-cat-02225`
- External category reference: `evobc-cat-02225`
- Source category ID: `02225`
- Source label for human review: `媊`
- Source codepoints: `U+5A8A`
...
- `obs-evo-cand-002225-route-category-staging`
...
- `obs-evo-cand-002225-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002225-route-evolution-graph`
