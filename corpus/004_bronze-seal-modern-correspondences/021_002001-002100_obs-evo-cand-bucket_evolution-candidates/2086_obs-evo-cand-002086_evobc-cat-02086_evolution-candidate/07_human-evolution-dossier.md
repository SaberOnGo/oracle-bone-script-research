...
- External category reference: `evobc-cat-02086`
- Source category ID: `02086`
- Source label for human review: `妜`
...
- `obs-evo-cand-002086-route-category-staging`
...
- `obs-evo-cand-002086-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002086-route-evolution-graph`
