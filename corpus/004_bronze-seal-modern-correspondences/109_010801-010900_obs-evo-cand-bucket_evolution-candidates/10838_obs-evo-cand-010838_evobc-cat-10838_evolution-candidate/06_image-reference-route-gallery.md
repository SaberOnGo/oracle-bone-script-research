...
- `obs-evo-cand-010838-route-category-staging`
...
- `obs-evo-cand-010838-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010838-route-evolution-graph`
