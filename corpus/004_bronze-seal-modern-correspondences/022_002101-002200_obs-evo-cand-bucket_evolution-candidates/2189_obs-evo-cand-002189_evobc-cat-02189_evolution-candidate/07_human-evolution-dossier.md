...
- External category reference: `evobc-cat-02189`
- Source category ID: `02189`
- Source label for human review: `婄`
- Source codepoints: `U+5A44`
...
- `obs-evo-cand-002189-route-category-staging`
...
- `obs-evo-cand-002189-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002189-route-evolution-graph`
