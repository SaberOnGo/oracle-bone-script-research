# obs-unk-004635 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/035_obs-unk-004635_h
  ust-obc-und-X-004635_oracle-character-candidate/03_visual-assets/001_asset
  -006228_hust-obc-und-X-004635_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/191/X_？_7219_1.png`
- asset id: `asset-006228`
...
- source class: `HUST-OBC/undeciphered/X/191/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/191/X_？_7219_1.png`
- asset id: `asset-006228`
...
- English observation: `central junction, pale opening, pointed lower traces`
- 中文观察: `中央交接点、浅色开口和下部尖状痕已记录。`
...
- Which source records identify obs-unk-004635 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004635？
