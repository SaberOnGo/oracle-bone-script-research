# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004263
...
- EVOBC candidate category: `evobc-evo-cat-04263`.
- Source label for search only: `橎`.
- Source codepoints for search only: `U+6A4E`.
