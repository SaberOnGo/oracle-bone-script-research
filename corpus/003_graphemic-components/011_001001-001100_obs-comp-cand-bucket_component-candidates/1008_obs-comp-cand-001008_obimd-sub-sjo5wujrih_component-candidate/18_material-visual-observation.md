# Material Visual Observation / obs-comp-cand-001008 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001008`
- External reference / 外部参照: `obimd-sub-sjo5wujrih`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014471_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/sjo5wujrih/sjo5wujrih/sjo5wujrih.png`
- Checksum / 校验和:
  `3e6d13eb7bd8facb50a7befa56b962e886174908c8dd09cc5bc161a8d33a79fe`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.22%.
- Marked-pixel bounds: (29,34)–(223,226); span 195 × 193 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.22%。
- 痕迹范围：(29,34)–(223,226)；跨度195 × 193 px；痕迹矩形近方形。
