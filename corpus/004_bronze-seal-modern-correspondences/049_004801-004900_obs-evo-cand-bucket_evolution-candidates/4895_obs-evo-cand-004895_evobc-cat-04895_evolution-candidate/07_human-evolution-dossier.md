...
Project ID: `obs-evo-cand-004895`
...
- Project ID: `obs-evo-cand-004895`
- EVOBC category candidate ID: `evobc-evo-cat-04895`
- External category reference: `evobc-cat-04895`
- Source category ID: `04895`
- Source label for human review: `潓`
- Source codepoints: `U+6F53`
...
- `obs-evo-cand-004895-route-category-staging`
...
- `obs-evo-cand-004895-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004895-route-evolution-graph`
