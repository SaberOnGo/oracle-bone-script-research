# obs-char-001532 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1532_obs-char-001532_hust-obc-cat-1718_ora
  cle-character/03_visual-assets/001_asset-001537_hust-obc-cat-1718_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1718/X_1718_5969_1.png`
- asset id: `asset-001537`
...
- source category: `1718`
- validation class: `1531`
- source image route: `HUST-OBC/deciphered/1718/X_1718_5969_1.png`
- asset id: `asset-001537`
...
- English observation: `A tall composite has a broad upper bar, a central
  diamond loop, and long lower branches.`
...
- dataset label text: `㪬`
- dataset label codepoints: `U+3AAC`
...
- Which source records identify obs-char-001532 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001532？
