# Material Visual Observation / obs-comp-cand-001917 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001917`
- External reference / 外部参照: `obimd-sub-136xnn9igk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018327_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/oxa0ylq9ay/136xnn9igk/136xnn9igk.png`
- Checksum / 校验和:
  `306d2dd25f1937221843b02c04cc5411fcfef42811e0b1cf522ff02210b2044d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.64%.
- Marked-pixel bounds: (57,24)–(199,220); span 143 × 197 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.64%。
- 痕迹范围：(57,24)–(199,220)；跨度143 × 197 px；痕迹矩形高于宽。
