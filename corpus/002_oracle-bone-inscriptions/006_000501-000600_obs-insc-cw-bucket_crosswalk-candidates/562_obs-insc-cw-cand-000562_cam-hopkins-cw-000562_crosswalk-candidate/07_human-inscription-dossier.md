...
Project ID: `obs-insc-cw-cand-000562`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000562`
...
- Yingguo / 英国所藏: `y2574` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `407` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `376` in source row; primary catalog entry pending
- Heji / 合集: `41850` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000562`
