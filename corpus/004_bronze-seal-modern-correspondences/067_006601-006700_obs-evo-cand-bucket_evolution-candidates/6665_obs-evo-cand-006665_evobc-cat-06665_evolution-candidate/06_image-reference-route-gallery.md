...
- `obs-evo-cand-006665-route-category-staging`
...
- `obs-evo-cand-006665-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006665-route-evolution-graph`
