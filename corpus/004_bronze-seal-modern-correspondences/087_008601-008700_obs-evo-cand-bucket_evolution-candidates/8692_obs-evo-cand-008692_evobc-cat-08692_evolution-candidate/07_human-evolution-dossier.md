...
- External category reference: `evobc-cat-08692`
- Source category ID: `08692`
- Source label for human review: `趨`
- Source codepoints: `U+8DA8`
...
- `obs-evo-cand-008692-route-category-staging`
...
- `obs-evo-cand-008692-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008692-route-evolution-graph`
