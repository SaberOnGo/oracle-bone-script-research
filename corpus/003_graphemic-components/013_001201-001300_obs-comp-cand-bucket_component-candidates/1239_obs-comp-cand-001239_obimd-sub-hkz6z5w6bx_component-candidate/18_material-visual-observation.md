# Material Visual Observation / obs-comp-cand-001239 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001239`
- External reference / 外部参照: `obimd-sub-hkz6z5w6bx`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015477_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cdwgyw3kul/hkz6z5w6bx/hkz6z5w6bx.png`
- Checksum / 校验和:
  `8e2c5a508f43f5f2f014e5a91785b76a5f9baf062644fbcb36b40377d3fbb3cd`
...
- Marked-pixel bounds: (68,26)–(190,226); span 123 × 201 px; the marked
...
- 痕迹范围：(68,26)–(190,226)；跨度123 × 201 px；痕迹矩形高于宽。
