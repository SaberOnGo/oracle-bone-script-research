# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010232
...
- EVOBC candidate category: `evobc-evo-cat-10232`.
- Source label for search only: `騭`.
- Source codepoints for search only: `U+9A2D`.
