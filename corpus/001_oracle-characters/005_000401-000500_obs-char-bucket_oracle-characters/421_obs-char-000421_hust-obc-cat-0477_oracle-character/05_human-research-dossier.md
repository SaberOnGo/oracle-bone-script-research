# obs-char-000421 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/421_obs-char-000421_hust-obc-cat-0477_orac
  le-character/03_visual-assets/001_asset-000426_hust-obc-cat-0477_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0477/H_0477_6029F_0.png`
- asset id: `asset-000426`
...
- source category: `0477`
- validation class: `420`
- source image route: `HUST-OBC/deciphered/0477/H_0477_6029F_0.png`
- asset id: `asset-000426`
...
- English observation: `Two bold forms appear side by side: the left has a
  rectangular lower frame, while the right has crossed central strokes and
  an angular lower extension.`
- 中文观察: `两个粗重形体左右并列：左侧下部为矩形框架，右侧中央笔画交叉并向下折角延伸。`
...
- dataset label text: `㗓`
- dataset label codepoints: `U+35D3`
...
- filename catalog route clues: `catalog-like filename clue: H_0477
  (H_0477_6029F_0.png)`
...
- Which source records identify obs-char-000421 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000421？
