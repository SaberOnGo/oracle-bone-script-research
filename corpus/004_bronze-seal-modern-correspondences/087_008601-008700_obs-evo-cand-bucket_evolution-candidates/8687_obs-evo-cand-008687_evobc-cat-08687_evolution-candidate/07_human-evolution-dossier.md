...
Project ID: `obs-evo-cand-008687`
...
- Project ID: `obs-evo-cand-008687`
- EVOBC category candidate ID: `evobc-evo-cat-08687`
- External category reference: `evobc-cat-08687`
- Source category ID: `08687`
- Source label for human review: `趡`
- Source codepoints: `U+8DA1`
...
- `obs-evo-cand-008687-route-category-staging`
...
- `obs-evo-cand-008687-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008687-route-evolution-graph`
