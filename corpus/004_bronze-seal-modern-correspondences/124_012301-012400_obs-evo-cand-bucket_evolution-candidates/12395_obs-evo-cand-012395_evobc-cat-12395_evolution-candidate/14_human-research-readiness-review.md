# Human Research Readiness Review / 正式研究准备复核: obs-evo-cand-012395
...
- Source label for lookup only: `𨙜`.
- Source codepoints for lookup only: `U+2865C`.
- Era/source code rows to open: `3`.
