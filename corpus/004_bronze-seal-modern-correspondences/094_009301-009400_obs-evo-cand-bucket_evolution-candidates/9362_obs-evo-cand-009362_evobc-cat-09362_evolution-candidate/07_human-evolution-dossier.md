...
- Project ID: `obs-evo-cand-009362`
- EVOBC category candidate ID: `evobc-evo-cat-09362`
- External category reference: `evobc-cat-09362`
- Source category ID: `09362`
- Source label for human review: `鉙`
- Source codepoints: `U+9259`
...
- `obs-evo-cand-009362-route-category-staging`
...
- `obs-evo-cand-009362-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009362-route-evolution-graph`
