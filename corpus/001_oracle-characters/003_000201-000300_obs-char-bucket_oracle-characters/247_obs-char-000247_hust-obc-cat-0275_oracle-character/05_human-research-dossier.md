# obs-char-000247 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/247_obs-char-000247_hust-obc-cat-0275_orac
  le-character/03_visual-assets/001_asset-000252_hust-obc-cat-0275_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0275/G_0275_甲骨文.png`
- asset id: `asset-000252`
...
- source category: `0275`
- validation class: `246`
- source image route: `HUST-OBC/deciphered/0275/G_0275_甲骨文.png`
- asset id: `asset-000252`
...
- English observation: `A small rectangular grid-like form appears at the
  top, followed by a curved descending stroke with short side branches below
  it.`
- 中文观察: `顶部有小型矩形网格状形体，下方接弯曲下行笔，并带有短侧向分支。`
...
- dataset label text: `㔉`
- dataset label codepoints: `U+3509`
...
- Which source records identify obs-char-000247 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000247？
