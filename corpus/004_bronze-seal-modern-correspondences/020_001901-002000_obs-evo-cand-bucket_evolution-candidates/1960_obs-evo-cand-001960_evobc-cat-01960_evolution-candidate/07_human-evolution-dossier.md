...
Project ID: `obs-evo-cand-001960`
...
- Project ID: `obs-evo-cand-001960`
- EVOBC category candidate ID: `evobc-evo-cat-01960`
- External category reference: `evobc-cat-01960`
- Source category ID: `01960`
- Source label for human review: `壔`
- Source codepoints: `U+58D4`
...
- `obs-evo-cand-001960-route-category-staging`
...
- `obs-evo-cand-001960-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001960-route-evolution-graph`
