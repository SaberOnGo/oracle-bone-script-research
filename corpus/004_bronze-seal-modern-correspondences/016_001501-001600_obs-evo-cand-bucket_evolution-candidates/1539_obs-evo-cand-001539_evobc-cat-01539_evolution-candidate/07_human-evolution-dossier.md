...
Project ID: `obs-evo-cand-001539`
...
- Project ID: `obs-evo-cand-001539`
- EVOBC category candidate ID: `evobc-evo-cat-01539`
- External category reference: `evobc-cat-01539`
- Source category ID: `01539`
- Source label for human review: `周`
- Source codepoints: `U+5468`
- Image reference count in source metadata: `312`
...
- `obs-evo-cand-001539-route-category-staging`
...
- `obs-evo-cand-001539-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001539-route-evolution-graph`
