# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001976
...
| --- | --- | --- | --- |
| `obimd-glyph-link-030083` | 𬒿󻓋 | `U+2C4BF;U+FB4CB` | `reviewed_metadata_only` |
| `obimd-glyph-link-030084` | 󻓌 | `U+FB4CC` | `reviewed_metadata_only` |
| `obimd-glyph-link-030085` | 󻓍 | `U+FB4CD` | `reviewed_metadata_only` |
