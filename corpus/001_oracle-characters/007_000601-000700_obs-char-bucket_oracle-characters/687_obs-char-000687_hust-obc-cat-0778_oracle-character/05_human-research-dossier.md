# obs-char-000687 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/687_obs-char-000687_hust-obc-cat-0778_orac
  le-character/03_visual-assets/001_asset-000692_hust-obc-cat-0778_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0778/G_0778_甲185(甲).png`
- asset id: `asset-000692`
...
- source category: `0778`
- validation class: `686`
- source image route: `HUST-OBC/deciphered/0778/G_0778_甲185(甲).png`
- asset id: `asset-000692`
...
- English observation: `Two bold rectangular forms are stacked with a white
  gap between them: the upper encloses a small inner rectangle, and the
  lower has a broad uneven opening.`
...
- dataset label text: `㜀`
- dataset label codepoints: `U+3700`
...
- Which source records identify obs-char-000687 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000687？
