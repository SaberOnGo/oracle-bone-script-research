# obs-char-001127 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001127`
- primary external id: `hust-obc-cat-1258`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1127_obs-char-001127_hust-obc-cat-1258_ora
  cle-character/03_visual-assets/001_asset-001132_hust-obc-cat-1258_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1258/G_1258_佚937(甲).png`
- asset id: `asset-001132`
...
- source category: `1258`
- validation class: `1126`
- source image route: `HUST-OBC/deciphered/1258/G_1258_佚937(甲).png`
- asset id: `asset-001132`
...
- English observation: `A narrow dense cluster has repeated angular side
  strokes around a central stem and a pointed lower extension.`
- 中文观察: `狭长密集笔群围绕中央笔干有重复的棱角侧笔和尖状下部外伸。`
...
- dataset label text: `㣠`
- dataset label codepoints: `U+38E0`
...
- Which source records identify obs-char-001127 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001127？
