...
Project ID: `obs-evo-cand-013342`
...
- Project ID: `obs-evo-cand-013342`
- EVOBC category candidate ID: `evobc-evo-cat-13342`
- External category reference: `evobc-cat-13342`
- Source category ID: `13342`
- Source label for human review: `𬣃`
- Source codepoints: `U+2C8C3`
...
- `obs-evo-cand-013342-route-category-staging`
...
- `obs-evo-cand-013342-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013342-route-evolution-graph`
