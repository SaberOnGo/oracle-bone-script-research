# obs-char-001368 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001368`
- primary external id: `hust-obc-cat-1527`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1368_obs-char-001368_hust-obc-cat-1527_ora
  cle-character/03_visual-assets/001_asset-001373_hust-obc-cat-1527_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1527/Y_1527_60694.jpg`
- asset id: `asset-001373`
...
- source category: `1527`
- validation class: `1367`
- source image route: `HUST-OBC/deciphered/1527/Y_1527_60694.jpg`
- asset id: `asset-001373`
...
- English observation: `A tall left stem has repeated side branches beside a
  separate angular form.`
- 中文观察: `高大的左侧竖干有重复侧枝，旁边另有角状形体。`
...
- dataset label text: `㧭`
- dataset label codepoints: `U+39ED`
...
- Which source records identify obs-char-001368 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001368？
