...
Project ID: `obs-evo-cand-002360`
...
- Project ID: `obs-evo-cand-002360`
- EVOBC category candidate ID: `evobc-evo-cat-02360`
- External category reference: `evobc-cat-02360`
- Source category ID: `02360`
- Source label for human review: `宆`
- Source codepoints: `U+5B86`
...
- `obs-evo-cand-002360-route-category-staging`
...
- `obs-evo-cand-002360-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002360-route-evolution-graph`
