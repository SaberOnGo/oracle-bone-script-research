...
- External category reference: `evobc-cat-03643`
- Source category ID: `03643`
- Source label for human review: `斧`
- Source codepoints: `U+65A7`
...
- `obs-evo-cand-003643-route-category-staging`
...
- `obs-evo-cand-003643-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003643-route-evolution-graph`
