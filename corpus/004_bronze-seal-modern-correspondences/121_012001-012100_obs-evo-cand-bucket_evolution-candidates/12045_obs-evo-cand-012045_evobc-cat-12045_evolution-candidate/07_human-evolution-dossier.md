...
Project ID: `obs-evo-cand-012045`
...
- Project ID: `obs-evo-cand-012045`
- EVOBC category candidate ID: `evobc-evo-cat-12045`
- External category reference: `evobc-cat-12045`
- Source category ID: `12045`
- Source label for human review: `𦚖`
- Source codepoints: `U+26696`
...
- `obs-evo-cand-012045-route-category-staging`
...
- `obs-evo-cand-012045-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012045-route-evolution-graph`
