# Material Visual Observation / obs-comp-cand-000298 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000298`
- External reference / 外部参照: `obimd-sub-timdqpzz9v`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012064_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qzgadtxm9i/timdqpzz9v/timdqpzz9v.png`
- Checksum / 校验和:
  `7d531854b79cef8146da4aa6b288794ab3c4dc1bf220df50232aebc8902764a1`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.21%.
- Marked-pixel bounds: (65,24)–(184,222); span 120 × 199 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.21%。
- 痕迹范围：(65,24)–(184,222)；跨度120 × 199 px；痕迹矩形高于宽。
