...
Project ID: `obs-evo-cand-005920`
...
- Project ID: `obs-evo-cand-005920`
- EVOBC category candidate ID: `evobc-evo-cat-05920`
- External category reference: `evobc-cat-05920`
- Source category ID: `05920`
- Source label for human review: `碏`
- Source codepoints: `U+788F`
...
- `obs-evo-cand-005920-route-category-staging`
...
- `obs-evo-cand-005920-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005920-route-evolution-graph`
