...
- `obs-evo-cand-003345-route-category-staging`
...
- `obs-evo-cand-003345-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003345-route-evolution-graph`
