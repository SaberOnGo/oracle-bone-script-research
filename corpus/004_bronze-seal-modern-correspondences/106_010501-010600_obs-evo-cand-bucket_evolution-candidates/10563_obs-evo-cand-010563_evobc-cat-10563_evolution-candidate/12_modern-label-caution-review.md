# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010563
...
- EVOBC candidate category: `evobc-evo-cat-10563`.
- Source label for search only: `鷯`.
- Source codepoints for search only: `U+9DEF`.
