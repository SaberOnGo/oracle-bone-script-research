...
- External category reference: `evobc-cat-03165`
- Source category ID: `03165`
- Source label for human review: `憲`
...
- `obs-evo-cand-003165-route-category-staging`
...
- `obs-evo-cand-003165-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003165-route-evolution-graph`
