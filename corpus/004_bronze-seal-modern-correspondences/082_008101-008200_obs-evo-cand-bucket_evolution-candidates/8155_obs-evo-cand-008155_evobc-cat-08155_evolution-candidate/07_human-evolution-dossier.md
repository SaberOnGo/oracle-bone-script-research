...
- External category reference: `evobc-cat-08155`
- Source category ID: `08155`
- Source label for human review: `訯`
- Source codepoints: `U+8A2F`
...
- `obs-evo-cand-008155-route-category-staging`
...
- `obs-evo-cand-008155-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008155-route-evolution-graph`
