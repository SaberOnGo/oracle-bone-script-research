...
Project ID: `obs-evo-cand-010016`
...
- Project ID: `obs-evo-cand-010016`
- EVOBC category candidate ID: `evobc-evo-cat-10016`
- External category reference: `evobc-cat-10016`
- Source category ID: `10016`
- Source label for human review: `顏`
- Source codepoints: `U+984F`
...
- `obs-evo-cand-010016-route-category-staging`
...
- `obs-evo-cand-010016-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010016-route-evolution-graph`
