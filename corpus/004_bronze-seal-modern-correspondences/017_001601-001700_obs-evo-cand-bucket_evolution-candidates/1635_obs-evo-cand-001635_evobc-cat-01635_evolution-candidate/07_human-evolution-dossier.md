...
Project ID: `obs-evo-cand-001635`
...
- Project ID: `obs-evo-cand-001635`
- EVOBC category candidate ID: `evobc-evo-cat-01635`
- External category reference: `evobc-cat-01635`
- Source category ID: `01635`
- Source label for human review: `啸`
- Source codepoints: `U+5578`
...
- `obs-evo-cand-001635-route-category-staging`
...
- `obs-evo-cand-001635-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001635-route-evolution-graph`
