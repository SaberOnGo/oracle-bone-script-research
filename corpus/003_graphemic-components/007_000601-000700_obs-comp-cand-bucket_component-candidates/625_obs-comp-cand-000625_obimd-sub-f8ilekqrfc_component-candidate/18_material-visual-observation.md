# Material Visual Observation / obs-comp-cand-000625 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000625`
- External reference / 外部参照: `obimd-sub-f8ilekqrfc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013188_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/f8ilekqrfc/f8ilekqrfc/f8ilekqrfc.png`
- Checksum / 校验和:
  `5b289807955ab23b31868b10480b42a3d87aec6b1d15f7618656c0775d54b28c`
...
- Marked-pixel bounds: (85,18)–(163,226); span 79 × 209 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.64%。
- 痕迹范围：(85,18)–(163,226)；跨度79 × 209 px；痕迹矩形高于宽。
