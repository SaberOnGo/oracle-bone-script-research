# Material Visual Observation / obs-comp-cand-001995 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001995`
- External reference / 外部参照: `obimd-sub-qtpfktwrdi`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018987_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qtpfktwrdi/qtpfktwrdi/qtpfktwrdi.png`
- Checksum / 校验和:
  `fa1532ba89dd06473dea8417c4ff1107915c5cc3763c2e655946b13922835895`
...
- Marked-pixel bounds: (65,50)–(184,194); span 120 × 145 px; the marked
...
- 痕迹范围：(65,50)–(184,194)；跨度120 × 145 px；痕迹矩形高于宽。
