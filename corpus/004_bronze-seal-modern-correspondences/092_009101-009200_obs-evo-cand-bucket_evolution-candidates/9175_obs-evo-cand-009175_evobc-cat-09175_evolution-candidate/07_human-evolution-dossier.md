...
- External category reference: `evobc-cat-09175`
- Source category ID: `09175`
- Source label for human review: `鄃`
- Source codepoints: `U+9103`
...
- `obs-evo-cand-009175-route-category-staging`
...
- `obs-evo-cand-009175-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009175-route-evolution-graph`
