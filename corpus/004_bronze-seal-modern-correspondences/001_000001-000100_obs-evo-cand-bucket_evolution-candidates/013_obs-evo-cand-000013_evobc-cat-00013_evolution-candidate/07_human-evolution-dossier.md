...
- External category reference: `evobc-cat-00013`
- Source category ID: `00013`
- Source label for human review: `㒔`
- Source codepoints: `U+3494`
...
- `obs-evo-cand-000013-route-category-staging`
...
- `obs-evo-cand-000013-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000013-route-evolution-graph`
