# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001609
...
| --- | --- | --- | --- |
| `obimd-glyph-link-025100` | 򡭪󹎼 | `U+A1B6A;U+F93BC` | `reviewed_metadata_only` |
| `obimd-glyph-link-025101` | 󹙠 | `U+F9660` | `reviewed_metadata_only` |
