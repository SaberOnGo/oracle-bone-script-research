...
- External category reference: `evobc-cat-08150`
- Source category ID: `08150`
...
- `obs-evo-cand-008150-route-category-staging`
...
- `obs-evo-cand-008150-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008150-route-evolution-graph`
