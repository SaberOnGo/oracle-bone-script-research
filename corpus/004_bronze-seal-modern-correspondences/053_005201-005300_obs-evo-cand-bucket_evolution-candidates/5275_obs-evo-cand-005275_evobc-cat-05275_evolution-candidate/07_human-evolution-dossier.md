...
- External category reference: `evobc-cat-05275`
- Source category ID: `05275`
- Source label for human review: `狧`
- Source codepoints: `U+72E7`
...
- `obs-evo-cand-005275-route-category-staging`
...
- `obs-evo-cand-005275-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005275-route-evolution-graph`
