# obs-unk-004455 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004455`
- primary external id: `hust-obc-und-X-004455`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/055_obs-unk-004455_h
  ust-obc-und-X-004455_oracle-character-candidate/03_visual-assets/001_asset
  -006048_hust-obc-und-X-004455_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/11/X_？_8191_1.png`
- asset id: `asset-006048`
...
- source class: `HUST-OBC/undeciphered/X/11/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/11/X_？_8191_1.png`
- asset id: `asset-006048`
...
- English observation: `Two upper trace groups stand above separate`
  `lower branches.`
- 中文观察: `两组上部痕迹位于分离的下部分支之上。`
...
- Which source records identify obs-unk-004455 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004455？
