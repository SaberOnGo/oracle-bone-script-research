# Material Visual Observation / obs-comp-cand-000913 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000913`
- External reference / 外部参照: `obimd-sub-d9vtt5msc1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013996_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/d9vtt5msc1/d9vtt5msc1/d9vtt5msc1.png`
- Checksum / 校验和:
  `e99b711286f595269730f9d18e6e06b976729299e00749d8115be80d16d1a6ae`
...
- Marked-pixel bounds: (82,24)–(167,227); span 86 × 204 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.99%。
- 痕迹范围：(82,24)–(167,227)；跨度86 × 204 px；痕迹矩形高于宽。
