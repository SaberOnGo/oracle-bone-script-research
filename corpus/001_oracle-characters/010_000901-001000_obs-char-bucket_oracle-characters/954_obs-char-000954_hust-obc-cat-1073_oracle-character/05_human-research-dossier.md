# obs-char-000954 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000954`
- primary external id: `hust-obc-cat-1073`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/954_obs-char-000954_hust-obc-cat-1073_orac
  le-character/03_visual-assets/001_asset-000959_hust-obc-cat-1073_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1073/G_1073_甲844(甲).png`
- asset id: `asset-000959`
...
- source category: `1073`
- validation class: `953`
- source image route: `HUST-OBC/deciphered/1073/G_1073_甲844(甲).png`
- asset id: `asset-000959`
...
- English observation: `A central rectangular enclosure has four side
  projections and pointed upper and lower triangular strokes.`
- 中文观察: `中央矩形闭合轮廓有四条侧伸笔以及尖形上、下三角状笔。`
...
- dataset label text: `㠧`
- dataset label codepoints: `U+3827`
...
- Which source records identify obs-char-000954 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000954？
