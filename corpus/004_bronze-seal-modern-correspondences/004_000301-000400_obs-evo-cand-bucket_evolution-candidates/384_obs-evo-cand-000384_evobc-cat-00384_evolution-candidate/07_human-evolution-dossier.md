...
Project ID: `obs-evo-cand-000384`
...
- Project ID: `obs-evo-cand-000384`
- EVOBC category candidate ID: `evobc-evo-cat-00384`
- External category reference: `evobc-cat-00384`
- Source category ID: `00384`
- Source label for human review: `䓭`
- Source codepoints: `U+44ED`
...
- `obs-evo-cand-000384-route-category-staging`
...
- `obs-evo-cand-000384-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000384-route-evolution-graph`
