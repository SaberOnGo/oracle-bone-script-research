...
Project ID: `obs-evo-cand-006779`
...
- Project ID: `obs-evo-cand-006779`
- EVOBC category candidate ID: `evobc-evo-cat-06779`
- External category reference: `evobc-cat-06779`
- Source category ID: `06779`
- Source label for human review: `缠`
- Source codepoints: `U+7F20`
...
- `obs-evo-cand-006779-route-category-staging`
...
- `obs-evo-cand-006779-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006779-route-evolution-graph`
