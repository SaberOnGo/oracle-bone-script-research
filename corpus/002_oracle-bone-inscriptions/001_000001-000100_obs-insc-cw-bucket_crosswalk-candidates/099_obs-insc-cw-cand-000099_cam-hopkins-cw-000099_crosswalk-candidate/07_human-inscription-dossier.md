...
Project ID: `obs-insc-cw-cand-000099`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000099`
...
- Yingguo / 英国所藏: `y578` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `260a` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `538` in source row; primary catalog entry pending
- Heji / 合集: `39881` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000099`
