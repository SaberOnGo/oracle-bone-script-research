...
- External category reference: `evobc-cat-03150`
- Source category ID: `03150`
...
- `obs-evo-cand-003150-route-category-staging`
...
- `obs-evo-cand-003150-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003150-route-evolution-graph`
