# Material Visual Observation / obs-comp-cand-001099 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001099`
- External reference / 外部参照: `obimd-sub-xlscyddubk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014908_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xlscyddubk/xlscyddubk/06c1o1m5xb.png`
- Checksum / 校验和:
  `6438dd886333e22f7bf92fad4b23c7cee16bff45db6591307b1d24769f3fbd13`
...
- Marked-pixel bounds: (76,45)–(173,204); span 98 × 160 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.05%。
- 痕迹范围：(76,45)–(173,204)；跨度98 × 160 px；痕迹矩形高于宽。
