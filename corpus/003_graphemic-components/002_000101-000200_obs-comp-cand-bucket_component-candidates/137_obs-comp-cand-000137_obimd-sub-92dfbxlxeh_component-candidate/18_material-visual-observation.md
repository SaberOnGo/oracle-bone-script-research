# Material Visual Observation / obs-comp-cand-000137 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000137`
- External reference / 外部参照: `obimd-sub-92dfbxlxeh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011549_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/92dfbxlxeh/92dfbxlxeh/92dfbxlxeh.png`
- Checksum / 校验和:
  `62ee71ac660c01d9dd6f886734e890c1fc3a4493f60afa0a21d001bd4073ff16`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.78%.
- Marked-pixel bounds: (46,19)–(203,226); span 158 × 208 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.78%。
- 痕迹范围：(46,19)–(203,226)；跨度158 × 208 px；痕迹矩形高于宽。
