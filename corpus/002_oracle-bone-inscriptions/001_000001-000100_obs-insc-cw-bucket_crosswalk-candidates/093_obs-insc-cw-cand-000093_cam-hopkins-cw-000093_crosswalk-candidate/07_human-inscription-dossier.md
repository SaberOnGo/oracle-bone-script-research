...
Project ID: `obs-insc-cw-cand-000093`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000093`
...
- Yingguo / 英国所藏: `y559` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `108` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `524` in source row; primary catalog entry pending
- Heji / 合集: `39864` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000093`
