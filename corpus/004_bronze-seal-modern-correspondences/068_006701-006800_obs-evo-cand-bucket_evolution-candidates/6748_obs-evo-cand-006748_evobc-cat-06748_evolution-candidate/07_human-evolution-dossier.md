...
- External category reference: `evobc-cat-06748`
- Source category ID: `06748`
- Source label for human review: `绘`
- Source codepoints: `U+7ED8`
...
- `obs-evo-cand-006748-route-category-staging`
...
- `obs-evo-cand-006748-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006748-route-evolution-graph`
