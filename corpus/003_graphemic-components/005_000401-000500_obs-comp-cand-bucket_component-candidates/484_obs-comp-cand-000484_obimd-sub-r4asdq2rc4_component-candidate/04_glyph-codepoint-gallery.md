# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000484
...
| --- | --- | --- | --- |
| `obimd-glyph-link-007284` | 󲶱 | `U+F2DB1` | `reviewed_metadata_only` |
| `obimd-glyph-link-007285` | 󲶲 | `U+F2DB2` | `reviewed_metadata_only` |
