...
Project ID: `obs-insc-cw-cand-000111`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000111`
...
- Yingguo / 英国所藏: `y613` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `245` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `526` in source row; primary catalog entry pending
- Heji / 合集: `39925` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000111`
