# obs-unk-004403 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/003_obs-unk-004403_h
  ust-obc-und-L-004403_oracle-character-candidate/03_visual-assets/001_asset
  -005996_hust-obc-und-L-004403_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4403/L_？_9833.jpg`
- asset id: `asset-005996`
...
- source class: `HUST-OBC/undeciphered/L/4403/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4403/L_？_9833.jpg`
- asset id: `asset-005996`
...
- English observation: `A narrow upper trace splits below into two`
  `curved outward traces.`
- 中文观察: `上部窄痕向下分成两条向外弯曲的痕迹。`
...
- Which source records identify obs-unk-004403 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004403？
