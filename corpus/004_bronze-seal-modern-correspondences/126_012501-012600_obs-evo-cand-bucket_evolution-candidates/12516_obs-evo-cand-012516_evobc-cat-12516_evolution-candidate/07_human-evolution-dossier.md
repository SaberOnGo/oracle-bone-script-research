...
- External category reference: `evobc-cat-12516`
- Source category ID: `12516`
- Source label for human review: `𨸔`
- Source codepoints: `U+28E14`
...
- `obs-evo-cand-012516-route-category-staging`
...
- `obs-evo-cand-012516-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012516-route-evolution-graph`
