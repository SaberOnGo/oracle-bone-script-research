...
- Project ID: `obs-evo-cand-008469`
- EVOBC category candidate ID: `evobc-evo-cat-08469`
- External category reference: `evobc-cat-08469`
- Source category ID: `08469`
- Source label for human review: `谹`
- Source codepoints: `U+8C39`
...
- `obs-evo-cand-008469-route-category-staging`
...
- `obs-evo-cand-008469-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008469-route-evolution-graph`
