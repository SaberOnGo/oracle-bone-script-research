...
- External category reference: `evobc-cat-09931`
- Source category ID: `09931`
- Source label for human review: `鞹`
- Source codepoints: `U+97B9`
...
- `obs-evo-cand-009931-route-category-staging`
...
- `obs-evo-cand-009931-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009931-route-evolution-graph`
