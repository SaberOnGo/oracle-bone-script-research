# obs-unk-004083 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004083`
- primary external id: `hust-obc-und-L-004083`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/083_obs-unk-004083_h
  ust-obc-und-L-004083_oracle-character-candidate/03_visual-assets/001_asset
  -005676_hust-obc-und-L-004083_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4083/L_？_8763.jpg`
- asset id: `asset-005676`
...
- source class: `HUST-OBC/undeciphered/L/4083/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4083/L_？_8763.jpg`
- asset id: `asset-005676`
...
- English observation: Two rounded or loop-like dark traces appear in the
  upper area. A long slanting trace crosses downward through the center, with
  additional angular marks below; the joins and layering are unresolved.
...
- Which source records identify obs-unk-004083 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004083？
