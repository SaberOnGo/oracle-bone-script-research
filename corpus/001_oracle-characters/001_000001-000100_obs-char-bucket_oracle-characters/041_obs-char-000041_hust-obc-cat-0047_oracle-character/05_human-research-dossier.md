# obs-char-000041 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/041_obs-char-000041_hust-obc-cat-0047_orac
  le-character/03_visual-assets/001_asset-000046_hust-obc-cat-0047_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0047/H_0047_6062B_0.png`
- asset id: `asset-000046`
...
- source category: `0047`
- validation class: `40`
- source image route: `HUST-OBC/deciphered/0047/H_0047_6062B_0.png`
- asset id: `asset-000046`
...
- English observation: `The large image has two outer curving strokes,
  branching marks between them, and two small enclosed oval-like marks.`
...
- dataset label text: `㐥`
- dataset label codepoints: `U+3425`
...
- filename catalog route clues: `catalog-like filename clue: H_0047
  (H_0047_6062B_0.png)`
...
- Which source records identify obs-char-000041 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000041？
