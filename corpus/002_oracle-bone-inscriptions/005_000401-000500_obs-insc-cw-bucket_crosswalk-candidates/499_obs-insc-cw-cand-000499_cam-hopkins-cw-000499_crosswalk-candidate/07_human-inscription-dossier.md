...
- Source page section: `Period IV Group 11` /
  `第 IV 期第 11 组`
- Source section key: `period-iv-group-11`
...
- Yingguo / 英国所藏: `y2436` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `293` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `187` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000499`
