...
Project ID: `obs-insc-cw-cand-000203`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000203`
...
- Yingguo / 英国所藏: `y1194` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `67` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `641` in source row; primary catalog entry pending
- Heji / 合集: `39533` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000203`
