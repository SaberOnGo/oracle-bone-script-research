...
Project ID: `obs-evo-cand-006356`
...
- Project ID: `obs-evo-cand-006356`
- EVOBC category candidate ID: `evobc-evo-cat-06356`
- External category reference: `evobc-cat-06356`
- Source category ID: `06356`
- Source label for human review: `簪`
- Source codepoints: `U+7C2A`
...
- `obs-evo-cand-006356-route-category-staging`
...
- `obs-evo-cand-006356-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006356-route-evolution-graph`
