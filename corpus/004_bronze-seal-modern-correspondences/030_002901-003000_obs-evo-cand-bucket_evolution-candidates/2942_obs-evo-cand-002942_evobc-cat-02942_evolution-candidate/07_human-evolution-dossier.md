...
Project ID: `obs-evo-cand-002942`
...
- Project ID: `obs-evo-cand-002942`
- EVOBC category candidate ID: `evobc-evo-cat-02942`
- External category reference: `evobc-cat-02942`
- Source category ID: `02942`
- Source label for human review: `怞`
- Source codepoints: `U+601E`
...
- `obs-evo-cand-002942-route-category-staging`
...
- `obs-evo-cand-002942-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002942-route-evolution-graph`
