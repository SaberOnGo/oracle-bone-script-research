# obs-char-000278 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/278_obs-char-000278_hust-obc-cat-0314_orac
  le-character/03_visual-assets/001_asset-000283_hust-obc-cat-0314_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0314/G_0314_佚286合31437.png`
- asset id: `asset-000283`
...
- source category: `0314`
- validation class: `277`
- source image route: `HUST-OBC/deciphered/0314/G_0314_佚286合31437.png`
- asset id: `asset-000283`
...
- English observation: `The image has two upright sides joined by a low
  U-shaped base and a short horizontal bar; the right upper end is rounded
  and dark.`
- 中文观察: `图像有两道直立侧笔连接低位 U 形底部，并有短横画；右上端呈圆钝深色。`
...
- dataset label text: `㔰`
- dataset label codepoints: `U+3530`
...
- filename catalog route clues: `Heji-like filename clue: 合31437
  (G_0314_佚286合31437.png)`
...
- Which source records identify obs-char-000278 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000278？
