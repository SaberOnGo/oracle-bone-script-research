...
- External category reference: `evobc-cat-05559`
- Source category ID: `05559`
- Source label for human review: `畋`
- Source codepoints: `U+754B`
- Image reference count in source metadata: `68`
...
- `obs-evo-cand-005559-route-category-staging`
...
- `obs-evo-cand-005559-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005559-route-evolution-graph`
