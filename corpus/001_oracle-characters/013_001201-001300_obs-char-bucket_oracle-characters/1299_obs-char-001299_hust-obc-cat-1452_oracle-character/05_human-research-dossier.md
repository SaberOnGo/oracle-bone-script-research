# obs-char-001299 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001299`
- primary external id: `hust-obc-cat-1452`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1299_obs-char-001299_hust-obc-cat-1452_ora
  cle-character/03_visual-assets/001_asset-001304_hust-obc-cat-1452_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1452/H_1452_6040D_0.png`
- asset id: `asset-001304`
...
- source category: `1452`
- validation class: `1298`
- source image route: `HUST-OBC/deciphered/1452/H_1452_6040D_0.png`
- asset id: `asset-001304`
...
- English observation: `A large composite form has an upper forked cluster
  above a broad lower enclosure with an inner pointed stroke.`
- 中文观察: `大型组合形体上部为分叉笔画群，下方是宽大框形，内部有尖状笔画。`
...
- dataset label text: `㦢`
- dataset label codepoints: `U+39A2`
...
- filename catalog route clues: `catalog-like filename clue: H_1452
  (H_1452_6040D_0.png)`
...
- Which source records identify obs-char-001299 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001299？
