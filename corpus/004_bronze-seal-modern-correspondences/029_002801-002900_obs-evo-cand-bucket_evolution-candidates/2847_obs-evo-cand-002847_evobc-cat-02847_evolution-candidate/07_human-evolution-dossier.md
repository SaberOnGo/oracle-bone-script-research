...
Project ID: `obs-evo-cand-002847`
...
- Project ID: `obs-evo-cand-002847`
- EVOBC category candidate ID: `evobc-evo-cat-02847`
- External category reference: `evobc-cat-02847`
- Source category ID: `02847`
- Source label for human review: `彩`
- Source codepoints: `U+5F69`
...
- `obs-evo-cand-002847-route-category-staging`
...
- `obs-evo-cand-002847-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002847-route-evolution-graph`
