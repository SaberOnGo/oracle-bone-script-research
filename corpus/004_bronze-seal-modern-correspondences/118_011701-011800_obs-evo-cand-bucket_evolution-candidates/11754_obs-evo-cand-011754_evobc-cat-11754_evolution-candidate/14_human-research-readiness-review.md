# Human Research Readiness Review / 正式研究准备复核: obs-evo-cand-011754
...
- Source label for lookup only: `𥁕`.
- Source codepoints for lookup only: `U+25055`.
- Era/source code rows to open: `9`.
