# obs-unk-004724 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004724`
- primary external id: `hust-obc-und-X-004724`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/024_obs-unk-004724_h
  ust-obc-und-X-004724_oracle-character-candidate/03_visual-assets/001_asset
  -006317_hust-obc-und-X-004724_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/280/X_？_7260_1.png`
- asset id: `asset-006317`
...
- source class: `HUST-OBC/undeciphered/X/280/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/280/X_？_7260_1.png`
- asset id: `asset-006317`
...
- English observation: `dense sloping mass with two pale openings`
- 中文观察: `带两个浅色开口的密集斜向笔画组`
...
- Which source records identify obs-unk-004724 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004724？
