# Material Visual Observation / obs-comp-cand-001388 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001388`
- External reference / 外部参照: `obimd-sub-hzglrwxdtt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015807_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hzglrwxdtt/hzglrwxdtt/hzglrwxdtt.png`
- Checksum / 校验和:
  `8863c0babe2bf069c4325cf7333f2b60351fe72f8978e3ad8cc7694936dad043`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.78%.
- Marked-pixel bounds: (62,54)–(188,187); span 127 × 134 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.78%。
- 痕迹范围：(62,54)–(188,187)；跨度127 × 134 px；痕迹矩形近方形。
