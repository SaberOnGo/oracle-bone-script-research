...
- External category reference: `evobc-cat-06662`
- Source category ID: `06662`
- Source label for human review: `繃`
...
- `obs-evo-cand-006662-route-category-staging`
...
- `obs-evo-cand-006662-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006662-route-evolution-graph`
