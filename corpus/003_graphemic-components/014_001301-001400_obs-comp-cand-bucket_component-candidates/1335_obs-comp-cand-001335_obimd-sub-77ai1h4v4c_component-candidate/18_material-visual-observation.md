# Material Visual Observation / obs-comp-cand-001335 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001335`
- External reference / 外部参照: `obimd-sub-77ai1h4v4c`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015672_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/16xzhmtg43/77ai1h4v4c/77ai1h4v4c.png`
- Checksum / 校验和:
  `d25746b573d14426c75dcd264b6cd67a28893c7d71dfa1a01ca9fb099ce1a3df`
...
- Marked-pixel bounds: (69,37)–(180,213); span 112 × 177 px; the marked
...
- 痕迹范围：(69,37)–(180,213)；跨度112 × 177 px；痕迹矩形高于宽。
