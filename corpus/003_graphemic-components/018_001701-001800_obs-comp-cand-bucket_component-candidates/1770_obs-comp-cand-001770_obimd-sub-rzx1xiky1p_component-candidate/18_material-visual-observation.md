# Material Visual Observation / obs-comp-cand-001770 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001770`
- External reference / 外部参照: `obimd-sub-rzx1xiky1p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017971_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/soaedltvjs/rzx1xiky1p/rzx1xiky1p.png`
- Checksum / 校验和:
  `62facae9ae9570f954cd37e113458dbaced3381c822cb4a41395f0d356951392`
...
- Marked-pixel bounds: (68,40)–(181,206); span 114 × 167 px; the marked
...
- 痕迹范围：(68,40)–(181,206)；跨度114 × 167 px；痕迹矩形高于宽。
