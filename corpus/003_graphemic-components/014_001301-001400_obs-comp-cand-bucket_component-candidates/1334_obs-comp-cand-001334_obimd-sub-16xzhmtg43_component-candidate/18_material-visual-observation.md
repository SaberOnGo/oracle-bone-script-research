# Material Visual Observation / obs-comp-cand-001334 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001334`
- External reference / 外部参照: `obimd-sub-16xzhmtg43`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015671_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/16xzhmtg43/16xzhmtg43/16xzhmtg43.png`
- Checksum / 校验和:
  `09f907639890791951b5d90a4a0eb0b451073809eb29511273feded14b48d692`
...
- Marked-pixel bounds: (94,26)–(155,218); span 62 × 193 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.72%。
- 痕迹范围：(94,26)–(155,218)；跨度62 × 193 px；痕迹矩形高于宽。
