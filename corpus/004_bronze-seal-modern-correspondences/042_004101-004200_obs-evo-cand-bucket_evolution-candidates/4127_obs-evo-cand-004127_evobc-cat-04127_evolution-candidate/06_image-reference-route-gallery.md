...
- `obs-evo-cand-004127-route-category-staging`
...
- `obs-evo-cand-004127-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004127-route-evolution-graph`
