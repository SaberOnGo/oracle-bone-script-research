# obs-unk-004502 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004502`
- primary external id: `hust-obc-und-X-004502`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/002_obs-unk-004502_h
  ust-obc-und-X-004502_oracle-character-candidate/03_visual-assets/001_asset
  -006095_hust-obc-und-X-004502_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/58/X_？_7207_1.png`
- asset id: `asset-006095`
...
- source class: `HUST-OBC/undeciphered/X/58/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/58/X_？_7207_1.png`
- asset id: `asset-006095`
...
- English observation: `The central stem, diagonal branches, lower band gaps,
  and right projection are directly recorded.`
- 中文观察: `已直接记录中央主痕、斜向分支、横带空隙和右端外伸痕。`
...
- Which source records identify obs-unk-004502 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004502？
