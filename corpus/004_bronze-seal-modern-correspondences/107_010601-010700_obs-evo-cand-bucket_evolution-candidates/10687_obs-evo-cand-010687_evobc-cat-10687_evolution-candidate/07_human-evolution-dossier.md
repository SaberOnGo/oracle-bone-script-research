...
Project ID: `obs-evo-cand-010687`
...
- Project ID: `obs-evo-cand-010687`
- EVOBC category candidate ID: `evobc-evo-cat-10687`
- External category reference: `evobc-cat-10687`
- Source category ID: `10687`
- Source label for human review: `鼓`
- Source codepoints: `U+9F13`
...
- `obs-evo-cand-010687-route-category-staging`
...
- `obs-evo-cand-010687-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010687-route-evolution-graph`
