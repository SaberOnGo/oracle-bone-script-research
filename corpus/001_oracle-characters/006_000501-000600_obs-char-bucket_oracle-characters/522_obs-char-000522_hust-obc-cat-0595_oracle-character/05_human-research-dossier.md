# obs-char-000522 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/522_obs-char-000522_hust-obc-cat-0595_orac
  le-character/03_visual-assets/001_asset-000527_hust-obc-cat-0595_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0595/G_0595_乙2463合96賓組.png`
- asset id: `asset-000527`
...
- source category: `0595`
- validation class: `521`
- source image route: `HUST-OBC/deciphered/0595/G_0595_乙2463合96賓組.png`
- asset id: `asset-000527`
...
- English observation: `A broad angular baseline rises at both ends into
  three pointed peaks, with the tallest peak near the center.`
- 中文观察: `宽折角底线两端上升形成三个尖峰，其中中央附近的尖峰最高。`
...
- dataset label text: `㙉`
- dataset label codepoints: `U+3649`
...
- Which source records identify obs-char-000522 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000522？
