# Material Visual Observation / obs-comp-cand-000172 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000172`
- External reference / 外部参照: `obimd-sub-lebb92n5gt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011584_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lebb92n5gt/lebb92n5gt/lebb92n5gt.png`
- Checksum / 校验和:
  `287ba25cea35150a006e7baf96cac933519fe4b5fbf3bec61a9625e0c7a61a7a`
...
- Marked-pixel bounds: (86,25)–(163,224); span 78 × 200 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.41%。
- 痕迹范围：(86,25)–(163,224)；跨度78 × 200 px；痕迹矩形高于宽。
