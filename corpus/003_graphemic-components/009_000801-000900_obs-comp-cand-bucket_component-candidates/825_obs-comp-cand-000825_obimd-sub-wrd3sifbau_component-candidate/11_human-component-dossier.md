# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-000825
...
- candidate_component_id: `obs-comp-cand-000825`
- primary_external_ref_id: `obimd-sub-wrd3sifbau`
- source_subcharacter_uid: `wrd3sifbau`
- source_main_character_uid: `wrd3sifbau`
- main_character_external_ref_id: `obimd-main-wrd3sifbau`
...
- glyph_codepoint_uplus_sample: `U+F4A64, U+F4A65, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-013696` | `001_asset-013696_img.png` | `d1a0f7e9beee846bf31c8e300b98fc924e49828ae0e345edcb6312a694c7b704` |
