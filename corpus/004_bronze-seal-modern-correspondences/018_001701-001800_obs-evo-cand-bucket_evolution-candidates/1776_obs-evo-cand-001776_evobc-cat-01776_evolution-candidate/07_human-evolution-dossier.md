...
- External category reference: `evobc-cat-01776`
- Source category ID: `01776`
- Source label for human review: `圅`
...
- `obs-evo-cand-001776-route-category-staging`
...
- `obs-evo-cand-001776-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001776-route-evolution-graph`
