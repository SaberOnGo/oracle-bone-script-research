...
- `obs-evo-cand-005538-route-category-staging`
...
- `obs-evo-cand-005538-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005538-route-evolution-graph`
