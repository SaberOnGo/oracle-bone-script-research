...
- External category reference: `evobc-cat-11999`
- Source category ID: `11999`
- Source label for human review: `𦍩`
...
- `obs-evo-cand-011999-route-category-staging`
...
- `obs-evo-cand-011999-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011999-route-evolution-graph`
