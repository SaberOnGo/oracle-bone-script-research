...
- External category reference: `evobc-cat-12528`
- Source category ID: `12528`
- Source label for human review: `𨽸`
...
- `obs-evo-cand-012528-route-category-staging`
...
- `obs-evo-cand-012528-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012528-route-evolution-graph`
