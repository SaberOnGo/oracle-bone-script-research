...
- External category reference: `evobc-cat-10661`
- Source category ID: `10661`
- Source label for human review: `黲`
- Source codepoints: `U+9EF2`
...
- `obs-evo-cand-010661-route-category-staging`
...
- `obs-evo-cand-010661-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010661-route-evolution-graph`
