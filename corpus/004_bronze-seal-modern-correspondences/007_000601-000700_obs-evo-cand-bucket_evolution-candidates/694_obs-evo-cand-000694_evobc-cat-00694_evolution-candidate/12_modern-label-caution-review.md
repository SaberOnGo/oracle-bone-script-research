# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000694
...
- EVOBC candidate category: `evobc-evo-cat-00694`.
- Source label for search only: `亚`.
- Source codepoints for search only: `U+4E9A`.
