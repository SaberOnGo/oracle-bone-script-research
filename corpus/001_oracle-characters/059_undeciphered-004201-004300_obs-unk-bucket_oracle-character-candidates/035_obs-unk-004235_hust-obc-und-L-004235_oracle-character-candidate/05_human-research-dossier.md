# obs-unk-004235 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004235`
- primary external id: `hust-obc-und-L-004235`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/035_obs-unk-004235_h
  ust-obc-und-L-004235_oracle-character-candidate/03_visual-assets/001_asset
  -005828_hust-obc-und-L-004235_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4235/L_？_9297.jpg`
- asset id: `asset-005828`
...
- source class: `HUST-OBC/undeciphered/L/4235/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4235/L_？_9297.jpg`
- asset id: `asset-005828`
...
- English observation: `Left bars, lower diagonals, short branch visible.`
- 中文观察: `左侧短横笔画、下部斜笔画和短分支可见。`
...
- Which source records identify obs-unk-004235 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004235？
