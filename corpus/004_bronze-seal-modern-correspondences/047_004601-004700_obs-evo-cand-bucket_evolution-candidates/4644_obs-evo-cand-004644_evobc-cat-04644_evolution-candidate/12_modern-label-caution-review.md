# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004644
...
- EVOBC candidate category: `evobc-evo-cat-04644`.
- Source label for search only: `洽`.
- Source codepoints for search only: `U+6D3D`.
