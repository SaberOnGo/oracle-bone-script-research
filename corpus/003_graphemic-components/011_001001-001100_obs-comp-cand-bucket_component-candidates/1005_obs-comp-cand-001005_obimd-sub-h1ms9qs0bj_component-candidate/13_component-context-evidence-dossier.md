# obs-comp-cand-001005 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001005`
- 首选外部 ID: `obimd-sub-h1ms9qs0bj`
- OBIMD subcharacter UID: `h1ms9qs0bj`
- OBIMD main character UID: `jupa4d7mu6`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `6`
- codepoint 示例: U+F5B52; U+F5B53; 另有 4 项
