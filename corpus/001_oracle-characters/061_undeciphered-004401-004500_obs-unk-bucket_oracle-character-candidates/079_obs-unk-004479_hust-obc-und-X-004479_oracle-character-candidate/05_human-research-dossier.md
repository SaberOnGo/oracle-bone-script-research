# obs-unk-004479 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004479`
- primary external id: `hust-obc-und-X-004479`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/079_obs-unk-004479_h
  ust-obc-und-X-004479_oracle-character-candidate/03_visual-assets/001_asset
  -006072_hust-obc-und-X-004479_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/35/X_？_8213_1.png`
- asset id: `asset-006072`
...
- source class: `HUST-OBC/undeciphered/X/35/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/35/X_？_8213_1.png`
- asset id: `asset-006072`
- source image count: `6`
...
- English observation: A broad upper frame narrows to a crossing above a wide
  lower base with two openings.
- 中文观察: 宽上部框状痕迹收窄至交叉处，下方是带两个开口的底部轮廓。
...
- Which source records identify obs-unk-004479 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004479？
