...
- External category reference: `evobc-cat-06055`
- Source category ID: `06055`
- Source label for human review: `秉`
...
- `obs-evo-cand-006055-route-category-staging`
...
- `obs-evo-cand-006055-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006055-route-evolution-graph`
