# Material Visual Observation / obs-comp-cand-000646 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000646`
- External reference / 外部参照: `obimd-sub-0cyukofrr8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013209_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0cyukofrr8/0cyukofrr8/0cyukofrr8.png`
- Checksum / 校验和:
  `4659e05160b56e94d3880adbdc13787723cc95cc3c14006cbbaaf1efb6d7a16f`
...
- Marked-pixel bounds: (59,29)–(190,220); span 132 × 192 px; the marked
...
- 痕迹范围：(59,29)–(190,220)；跨度132 × 192 px；痕迹矩形高于宽。
