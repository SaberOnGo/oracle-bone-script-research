# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008198
...
- EVOBC candidate category: `evobc-evo-cat-08198`.
- Source label for search only: `詯`.
- Source codepoints for search only: `U+8A6F`.
