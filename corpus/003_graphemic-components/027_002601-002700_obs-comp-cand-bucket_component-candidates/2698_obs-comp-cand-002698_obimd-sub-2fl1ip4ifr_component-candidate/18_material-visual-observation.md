# Material Visual Observation / obs-comp-cand-002698 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002698`
- External reference / 外部参照: `obimd-sub-2fl1ip4ifr`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021274_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2fl1ip4ifr/2fl1ip4ifr/2fl1ip4ifr.png`
- Checksum / 校验和:
  `9c80fafaa5cb4ba987985240f35e6c3dd24336e05ee847a4c9601e0dcfbb7393`
...
- Marked-pixel bounds: (87,43)–(160,188); span 74 × 146 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.93%。
- 痕迹范围：(87,43)–(160,188)；跨度74 × 146 px；痕迹矩形高于宽。
