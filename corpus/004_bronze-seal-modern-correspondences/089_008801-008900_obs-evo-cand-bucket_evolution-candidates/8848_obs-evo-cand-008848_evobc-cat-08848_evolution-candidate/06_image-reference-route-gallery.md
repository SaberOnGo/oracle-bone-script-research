...
- `obs-evo-cand-008848-route-category-staging`
...
- `obs-evo-cand-008848-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008848-route-evolution-graph`
