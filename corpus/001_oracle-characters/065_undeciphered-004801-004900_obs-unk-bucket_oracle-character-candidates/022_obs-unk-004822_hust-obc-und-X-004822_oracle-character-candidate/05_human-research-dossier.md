# obs-unk-004822 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/022_obs-unk-004822_h
  ust-obc-und-X-004822_oracle-character-candidate/03_visual-assets/001_asset
  -006415_hust-obc-und-X-004822_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/378/X_？_7362_1.png`
- asset id: `asset-006415`
...
- source class: `HUST-OBC/undeciphered/X/378/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/378/X_？_7362_1.png`
- asset id: `asset-006415`
...
- English observation: `thresholded dark field with unresolved pale gaps`
- 中文观察: `阈值化暗色区域和未解析的浅色间隙`
...
- Which source records identify obs-unk-004822 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004822？
