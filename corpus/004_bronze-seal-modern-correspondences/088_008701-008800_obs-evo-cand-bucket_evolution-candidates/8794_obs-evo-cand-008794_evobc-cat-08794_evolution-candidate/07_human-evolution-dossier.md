...
Project ID: `obs-evo-cand-008794`
...
- Project ID: `obs-evo-cand-008794`
- EVOBC category candidate ID: `evobc-evo-cat-08794`
- External category reference: `evobc-cat-08794`
- Source category ID: `08794`
- Source label for human review: `軌`
- Source codepoints: `U+8ECC`
...
- `obs-evo-cand-008794-route-category-staging`
...
- `obs-evo-cand-008794-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008794-route-evolution-graph`
