# obs-unk-004701 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/001_obs-unk-004701_h
  ust-obc-und-X-004701_oracle-character-candidate/03_visual-assets/001_asset
  -006294_hust-obc-und-X-004701_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/257/X_？_7230_1.png`
- asset id: `asset-006294`
...
- source class: `HUST-OBC/undeciphered/X/257/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/257/X_？_7230_1.png`
- asset id: `asset-006294`
...
- English observation: `curved upper band with lower triangular opening`
- 中文观察: `带下部三角开口的弯曲上部笔画`
...
- Which source records identify obs-unk-004701 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004701？
