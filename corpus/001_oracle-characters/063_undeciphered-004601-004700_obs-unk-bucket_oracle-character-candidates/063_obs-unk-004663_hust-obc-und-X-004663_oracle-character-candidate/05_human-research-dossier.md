# obs-unk-004663 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004663`
- primary external id: `hust-obc-und-X-004663`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/063_obs-unk-004663_h
  ust-obc-und-X-004663_oracle-character-candidate/03_visual-assets/001_asset
  -006256_hust-obc-und-X-004663_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/219/X_？_8390_1.png`
- asset id: `asset-006256`
...
- source class: `HUST-OBC/undeciphered/X/219/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/219/X_？_8390_1.png`
- asset id: `asset-006256`
...
- English observation: `peaked contour with inner horizontal stroke`
- 中文观察: `带内部横向笔画的尖顶轮廓`
...
- Which source records identify obs-unk-004663 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004663？
