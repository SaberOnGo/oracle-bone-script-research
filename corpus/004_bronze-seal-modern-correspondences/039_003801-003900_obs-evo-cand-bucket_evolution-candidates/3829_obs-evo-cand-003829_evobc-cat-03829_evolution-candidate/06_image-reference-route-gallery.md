...
- `obs-evo-cand-003829-route-category-staging`
...
- `obs-evo-cand-003829-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003829-route-evolution-graph`
