# Material Visual Observation / obs-comp-cand-002275 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002275`
- External reference / 外部参照: `obimd-sub-4sax924k4m`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020159_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/x48fzxqgqn/4sax924k4m/4sax924k4m.png`
- Checksum / 校验和:
  `f572b45b1fb5619e9b61cf23440e4807a8dd155f3fa157c5e349e4c685ff9ba7`
...
- Marked-pixel bounds: (89,39)–(160,197); span 72 × 159 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.26%。
- 痕迹范围：(89,39)–(160,197)；跨度72 × 159 px；痕迹矩形高于宽。
