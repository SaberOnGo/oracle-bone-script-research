...
- External category reference: `evobc-cat-09932`
- Source category ID: `09932`
- Source label for human review: `鞼`
...
- `obs-evo-cand-009932-route-category-staging`
...
- `obs-evo-cand-009932-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009932-route-evolution-graph`
