# obs-char-000622 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000622`
- primary external id: `hust-obc-cat-0707`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/622_obs-char-000622_hust-obc-cat-0707_orac
  le-character/03_visual-assets/001_asset-000627_hust-obc-cat-0707_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0707/G_0707_乙4524合902賓組.png`
- asset id: `asset-000627`
...
- source category: `0707`
- validation class: `621`
- source image route: `HUST-OBC/deciphered/0707/G_0707_乙4524合902賓組.png`
- asset id: `asset-000627`
...
- English observation: `A slender central vertical carries several short
  upper crossbars, curves slightly leftward below them, and ends above a
  detached narrow base stroke.`
- 中文观察: `纤细中央竖笔带数条上部短横栏，其下略向左弯，并在分离狭底笔上方结束。`
...
- dataset label text: `㚹`
- dataset label codepoints: `U+36B9`
...
- filename catalog route clues: `Heji-like filename clue: 合902
  (G_0707_乙4524合902賓組.png)`
...
- Which source records identify obs-char-000622 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000622？
