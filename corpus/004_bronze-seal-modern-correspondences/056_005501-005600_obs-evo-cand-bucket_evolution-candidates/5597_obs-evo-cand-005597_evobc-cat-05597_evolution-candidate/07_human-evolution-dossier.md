...
Project ID: `obs-evo-cand-005597`
...
- Project ID: `obs-evo-cand-005597`
- EVOBC category candidate ID: `evobc-evo-cat-05597`
- External category reference: `evobc-cat-05597`
- Source category ID: `05597`
- Source label for human review: `疆`
- Source codepoints: `U+7586`
...
- `obs-evo-cand-005597-route-category-staging`
...
- `obs-evo-cand-005597-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005597-route-evolution-graph`
