# obs-unk-004695 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004695`
- primary external id: `hust-obc-und-X-004695`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/095_obs-unk-004695_h
  ust-obc-und-X-004695_oracle-character-candidate/03_visual-assets/001_asset
  -006288_hust-obc-und-X-004695_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/251/X_？_8418_1.png`
- asset id: `asset-006288`
...
- source class: `HUST-OBC/undeciphered/X/251/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/251/X_？_8418_1.png`
- asset id: `asset-006288`
...
- English observation: `central stem crossed by horizontal bands`
- 中文观察: `中央笔干与多条横向带状笔画交叉`
...
- Which source records identify obs-unk-004695 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004695？
