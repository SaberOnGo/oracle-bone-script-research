...
Project ID: `obs-evo-cand-003745`
...
- Project ID: `obs-evo-cand-003745`
- EVOBC category candidate ID: `evobc-evo-cat-03745`
- External category reference: `evobc-cat-03745`
- Source category ID: `03745`
- Source label for human review: `晚`
- Source codepoints: `U+665A`
...
- `obs-evo-cand-003745-route-category-staging`
...
- `obs-evo-cand-003745-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003745-route-evolution-graph`
