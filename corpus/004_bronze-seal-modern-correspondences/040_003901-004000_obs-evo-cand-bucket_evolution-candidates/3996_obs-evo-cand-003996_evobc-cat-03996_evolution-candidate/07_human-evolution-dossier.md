...
- Project ID: `obs-evo-cand-003996`
- EVOBC category candidate ID: `evobc-evo-cat-03996`
- External category reference: `evobc-cat-03996`
- Source category ID: `03996`
- Source label for human review: `栜`
- Source codepoints: `U+681C`
...
- `obs-evo-cand-003996-route-category-staging`
...
- `obs-evo-cand-003996-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003996-route-evolution-graph`
