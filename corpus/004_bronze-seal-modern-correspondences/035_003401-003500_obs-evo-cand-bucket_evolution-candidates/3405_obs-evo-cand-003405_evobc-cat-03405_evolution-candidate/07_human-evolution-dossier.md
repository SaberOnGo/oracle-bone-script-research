...
- External category reference: `evobc-cat-03405`
- Source category ID: `03405`
- Source label for human review: `掕`
...
- `obs-evo-cand-003405-route-category-staging`
...
- `obs-evo-cand-003405-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003405-route-evolution-graph`
