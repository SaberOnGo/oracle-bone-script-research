...
Project ID: `obs-evo-cand-009034`
...
- Project ID: `obs-evo-cand-009034`
- EVOBC category candidate ID: `evobc-evo-cat-09034`
- External category reference: `evobc-cat-09034`
- Source category ID: `09034`
- Source label for human review: `道`
- Source codepoints: `U+9053`
- Image reference count in source metadata: `188`
...
- `obs-evo-cand-009034-route-category-staging`
...
- `obs-evo-cand-009034-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009034-route-evolution-graph`
