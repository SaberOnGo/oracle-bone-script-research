# obs-unk-003225 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003225`
- primary external id: `hust-obc-und-L-003225`
...
- local review image route: `corpus/001_oracle-characters/049_undeciphered-003
  201-003300_obs-unk-bucket_oracle-character-candidates/025_obs-unk-003225_h
  ust-obc-und-L-003225_oracle-character-candidate/03_visual-assets/001_asset
  -004818_hust-obc-und-L-003225_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3225/L_？_6074.jpg`
- asset id: `asset-004818`
...
- source class: `HUST-OBC/undeciphered/L/3225/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3225/L_？_6074.jpg`
- asset id: `asset-004818`
...
- Which source records identify obs-unk-003225 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003225？
