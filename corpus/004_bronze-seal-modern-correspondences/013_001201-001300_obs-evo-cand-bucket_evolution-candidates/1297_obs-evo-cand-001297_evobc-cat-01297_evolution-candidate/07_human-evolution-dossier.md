...
- External category reference: `evobc-cat-01297`
- Source category ID: `01297`
- Source label for human review: `務`
...
- `obs-evo-cand-001297-route-category-staging`
...
- `obs-evo-cand-001297-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001297-route-evolution-graph`
