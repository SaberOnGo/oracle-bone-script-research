# Material Visual Observation / obs-comp-cand-002612 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002612`
- External reference / 外部参照: `obimd-sub-oipdyk6cbe`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021151_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/oipdyk6cbe/oipdyk6cbe/oipdyk6cbe.png`
- Checksum / 校验和:
  `3af757f16c260d6be880f51585c62f833b9011904d1f3ad6f1a52ecb1c4ca4ca`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.34%.
- Marked-pixel bounds: (77,12)–(202,235); span 126 × 224 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.34%。
- 痕迹范围：(77,12)–(202,235)；跨度126 × 224 px；痕迹矩形高于宽。
