...
Project ID: `obs-insc-cw-cand-000116`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000116`
...
- Yingguo / 英国所藏: `y635` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `127` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `660` in source row; primary catalog entry pending
- Heji / 合集: `39947` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000116`
