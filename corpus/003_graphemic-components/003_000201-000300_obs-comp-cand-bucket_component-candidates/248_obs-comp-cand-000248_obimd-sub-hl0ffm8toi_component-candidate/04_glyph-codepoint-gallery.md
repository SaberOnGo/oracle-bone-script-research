# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000248
...
| --- | --- | --- | --- |
| `obimd-glyph-link-003491` | 򩡡󱜎 | `U+A9861;U+F170E` | `reviewed_metadata_only` |
| `obimd-glyph-link-003492` | 󱜏 | `U+F170F` | `reviewed_metadata_only` |
