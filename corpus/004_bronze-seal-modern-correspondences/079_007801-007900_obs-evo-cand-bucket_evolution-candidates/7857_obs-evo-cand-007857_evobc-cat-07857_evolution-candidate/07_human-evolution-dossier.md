...
- External category reference: `evobc-cat-07857`
- Source category ID: `07857`
- Source label for human review: `蟣`
...
- `obs-evo-cand-007857-route-category-staging`
...
- `obs-evo-cand-007857-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007857-route-evolution-graph`
