# Material Visual Observation / obs-comp-cand-001123 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001123`
- External reference / 外部参照: `obimd-sub-n52ssmqnda`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015064_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/n52ssmqnda/n52ssmqnda/n52ssmqnda.png`
- Checksum / 校验和:
  `1fe8dac8de7c703729e6e2d05cfee47b6701389795ef9845fabd3322e6281ca1`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.38%.
- Marked-pixel bounds: (63,36)–(189,211); span 127 × 176 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.38%。
- 痕迹范围：(63,36)–(189,211)；跨度127 × 176 px；痕迹矩形高于宽。
