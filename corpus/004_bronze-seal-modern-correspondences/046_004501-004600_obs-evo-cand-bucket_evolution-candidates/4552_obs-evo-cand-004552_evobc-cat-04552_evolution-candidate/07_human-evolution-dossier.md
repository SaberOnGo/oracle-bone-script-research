...
- Project ID: `obs-evo-cand-004552`
- EVOBC category candidate ID: `evobc-evo-cat-04552`
- External category reference: `evobc-cat-04552`
- Source category ID: `04552`
- Source label for human review: `沬`
- Source codepoints: `U+6CAC`
- Image reference count in source metadata: `180`
...
- `obs-evo-cand-004552-route-category-staging`
...
- `obs-evo-cand-004552-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004552-route-evolution-graph`
