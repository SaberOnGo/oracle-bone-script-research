# Material Visual Observation / obs-comp-cand-001472 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001472`
- External reference / 外部参照: `obimd-sub-gqezg03aqo`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016049_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gqezg03aqo/gqezg03aqo/gqezg03aqo.png`
- Checksum / 校验和:
  `2c6aa0bce0272ce4e40612f150f95f3ff4dda07bee298b33cb9193952567dbf9`
...
- Marked-pixel bounds: (83,39)–(160,214); span 78 × 176 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.01%。
- 痕迹范围：(83,39)–(160,214)；跨度78 × 176 px；痕迹矩形高于宽。
