...
- `obs-evo-cand-006893-route-category-staging`
...
- `obs-evo-cand-006893-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006893-route-evolution-graph`
