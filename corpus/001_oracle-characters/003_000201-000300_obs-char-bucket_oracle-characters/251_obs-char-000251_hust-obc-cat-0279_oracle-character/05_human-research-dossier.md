# obs-char-000251 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000251`
- primary external id: `hust-obc-cat-0279`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/251_obs-char-000251_hust-obc-cat-0279_orac
  le-character/03_visual-assets/001_asset-000256_hust-obc-cat-0279_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0279/G_0279_乙1428合22187午組.png`
- asset id: `asset-000256`
...
- source category: `0279`
- validation class: `250`
- source image route: `HUST-OBC/deciphered/0279/G_0279_乙1428合22187午組.png`
- asset id: `asset-000256`
...
- English observation: `The image is a broad tapered horizontal stroke with
  a short curved branch dropping from its lower edge near the center.`
- 中文观察: `图像为宽而渐尖的横向笔画，中部附近从下缘垂下一道短弯曲分支。`
...
- dataset label text: `㔍`
- dataset label codepoints: `U+350D`
...
- filename catalog route clues: `Heji-like filename clue: 合22187
  (G_0279_乙1428合22187午組.png)`
...
- Which source records identify obs-char-000251 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000251？
