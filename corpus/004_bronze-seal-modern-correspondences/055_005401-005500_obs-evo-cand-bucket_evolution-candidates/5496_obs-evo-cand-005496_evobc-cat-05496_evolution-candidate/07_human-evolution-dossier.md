...
Project ID: `obs-evo-cand-005496`
...
- Project ID: `obs-evo-cand-005496`
- EVOBC category candidate ID: `evobc-evo-cat-05496`
- External category reference: `evobc-cat-05496`
- Source category ID: `05496`
- Source label for human review: `瓔`
- Source codepoints: `U+74D4`
...
- `obs-evo-cand-005496-route-category-staging`
...
- `obs-evo-cand-005496-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005496-route-evolution-graph`
