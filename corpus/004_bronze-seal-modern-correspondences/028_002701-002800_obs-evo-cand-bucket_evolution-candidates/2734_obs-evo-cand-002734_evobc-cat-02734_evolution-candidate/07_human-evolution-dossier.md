...
- External category reference: `evobc-cat-02734`
- Source category ID: `02734`
- Source label for human review: `庫`
- Source codepoints: `U+5EAB`
...
- `obs-evo-cand-002734-route-category-staging`
...
- `obs-evo-cand-002734-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002734-route-evolution-graph`
