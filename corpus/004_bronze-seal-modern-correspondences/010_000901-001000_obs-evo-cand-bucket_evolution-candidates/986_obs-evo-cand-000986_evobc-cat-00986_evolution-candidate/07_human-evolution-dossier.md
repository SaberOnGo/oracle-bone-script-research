...
- External category reference: `evobc-cat-00986`
- Source category ID: `00986`
- Source label for human review: `備`
- Source codepoints: `U+5099`
- Image reference count in source metadata: `130`
...
- `obs-evo-cand-000986-route-category-staging`
...
- `obs-evo-cand-000986-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000986-route-evolution-graph`
