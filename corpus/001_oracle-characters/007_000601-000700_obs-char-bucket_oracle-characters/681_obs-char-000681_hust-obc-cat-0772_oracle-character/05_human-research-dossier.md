# obs-char-000681 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/681_obs-char-000681_hust-obc-cat-0772_orac
  le-character/03_visual-assets/001_asset-000686_hust-obc-cat-0772_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0772/G_0772_乙1793合18013.png`
- asset id: `asset-000686`
...
- source category: `0772`
- validation class: `680`
- source image route: `HUST-OBC/deciphered/0772/G_0772_乙1793合18013.png`
- asset id: `asset-000686`
...
- English observation: `Two detached clusters stand side by side: a thin
  angular left form with crossing strokes, and a pointed cap above a
  rounded, horizontally divided outline at right.`
- 中文观察: `两个分离笔群并列：左侧为带交叉笔的纤细折角形，右侧尖顶位于带横隔的圆弯轮廓上。`
...
- dataset label text: `㛺`
- dataset label codepoints: `U+36FA`
...
- filename catalog route clues: `Heji-like filename clue: 合18013
...
- Which source records identify obs-char-000681 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000681？
