# obs-unk-004237 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004237`
- primary external id: `hust-obc-und-L-004237`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/037_obs-unk-004237_h
  ust-obc-und-L-004237_oracle-character-candidate/03_visual-assets/001_asset
  -005830_hust-obc-und-L-004237_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4237/L_？_9304.jpg`
- asset id: `asset-005830`
...
- source class: `HUST-OBC/undeciphered/L/4237/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4237/L_？_9304.jpg`
- asset id: `asset-005830`
...
- English observation: `Left curve, upper rounded trace, lower stroke visible.`
- 中文观察: `左侧弯曲痕迹、上部圆弧痕迹和下部笔画可见。`
...
- Which source records identify obs-unk-004237 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004237？
