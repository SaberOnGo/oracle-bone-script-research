# obs-unk-004664 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004664`
- primary external id: `hust-obc-und-X-004664`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/064_obs-unk-004664_h
  ust-obc-und-X-004664_oracle-character-candidate/03_visual-assets/001_asset
  -006257_hust-obc-und-X-004664_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/220/X_？_8391_1.png`
- asset id: `asset-006257`
...
- source class: `HUST-OBC/undeciphered/X/220/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/220/X_？_8391_1.png`
- asset id: `asset-006257`
...
- English observation: `separated strokes with two small openings`
- 中文观察: `带两个小开口的分离笔画`
...
- Which source records identify obs-unk-004664 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004664？
