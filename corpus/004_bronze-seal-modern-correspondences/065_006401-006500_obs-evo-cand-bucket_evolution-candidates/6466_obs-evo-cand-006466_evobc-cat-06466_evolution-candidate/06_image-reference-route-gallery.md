...
- `obs-evo-cand-006466-route-category-staging`
...
- `obs-evo-cand-006466-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006466-route-evolution-graph`
