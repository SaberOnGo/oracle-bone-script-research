...
- External category reference: `evobc-cat-02423`
- Source category ID: `02423`
- Source label for human review: `寖`
- Source codepoints: `U+5BD6`
...
- `obs-evo-cand-002423-route-category-staging`
...
- `obs-evo-cand-002423-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002423-route-evolution-graph`
