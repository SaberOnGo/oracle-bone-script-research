...
- External category reference: `evobc-cat-05291`
- Source category ID: `05291`
- Source label: `猒`
...
- `obs-evo-cand-005291-route-category-staging`
...
- `obs-evo-cand-005291-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005291-route-evolution-graph`
