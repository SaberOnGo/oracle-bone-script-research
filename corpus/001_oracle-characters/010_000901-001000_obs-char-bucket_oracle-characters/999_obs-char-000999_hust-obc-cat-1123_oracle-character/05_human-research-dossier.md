# obs-char-000999 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000999`
- primary external id: `hust-obc-cat-1123`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/999_obs-char-000999_hust-obc-cat-1123_orac
  le-character/03_visual-assets/001_asset-001004_hust-obc-cat-1123_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1123/G_1123_後1.18.10(甲).png`
- asset id: `asset-001004`
...
- source category: `1123`
- validation class: `998`
- source image route: `HUST-OBC/deciphered/1123/G_1123_後1.18.10(甲).png`
- asset id: `asset-001004`
...
- English observation: `A narrow branching cluster combines upper diagonal
  strokes, central horizontal and vertical marks, and lower side branches.`
- 中文观察: `狭长分枝笔群结合上部斜笔、中央横竖痕迹和下部侧分枝。`
...
- dataset label text: `㡙`
- dataset label codepoints: `U+3859`
...
- Which source records identify obs-char-000999 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000999？
