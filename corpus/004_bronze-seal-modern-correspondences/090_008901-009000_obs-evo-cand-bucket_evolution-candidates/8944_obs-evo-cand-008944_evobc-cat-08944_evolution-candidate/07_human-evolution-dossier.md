...
- External category reference: `evobc-cat-08944`
- Source category ID: `08944`
- Source label for human review: `迎`
- Source codepoints: `U+8FCE`
...
- `obs-evo-cand-008944-route-category-staging`
...
- `obs-evo-cand-008944-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008944-route-evolution-graph`
