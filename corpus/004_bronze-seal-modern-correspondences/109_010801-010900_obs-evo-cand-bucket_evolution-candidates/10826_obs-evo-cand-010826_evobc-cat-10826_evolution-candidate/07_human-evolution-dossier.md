...
- External category reference: `evobc-cat-10826`
- Source category ID: `10826`
- Source label for human review: `𠑥`
- Source codepoints: `U+20465`
...
- `obs-evo-cand-010826-route-category-staging`
...
- `obs-evo-cand-010826-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010826-route-evolution-graph`
