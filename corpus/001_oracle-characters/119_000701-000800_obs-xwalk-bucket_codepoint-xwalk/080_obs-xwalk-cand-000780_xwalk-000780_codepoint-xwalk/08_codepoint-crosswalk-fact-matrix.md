# obs-xwalk-cand-000780 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+376A` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-0884` | not reading |
| OBIMD route / OBIMD 路线 | `obimd-main-cand-003071` | not component |
| EVOBC route / EVOBC 路线 | `evobc-evo-cat-00074` | not evolution |
