# Material Visual Observation / obs-comp-cand-002004 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002004`
- External reference / 外部参照: `obimd-sub-67yxx2eqp0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019224_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/67yxx2eqp0/67yxx2eqp0/087rgcptm3.png`
- Checksum / 校验和:
  `2f10f0e8b3edd55ac416fee60b5a42a2325e0c44c3689b708c62d9e4575cb60d`
...
- Marked-pixel bounds: (92,25)–(157,218); span 66 × 194 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.33%。
- 痕迹范围：(92,25)–(157,218)；跨度66 × 194 px；痕迹矩形高于宽。
