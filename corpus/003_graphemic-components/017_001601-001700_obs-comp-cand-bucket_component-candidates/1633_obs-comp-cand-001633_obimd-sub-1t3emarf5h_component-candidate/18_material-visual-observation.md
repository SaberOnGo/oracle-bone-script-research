# Material Visual Observation / obs-comp-cand-001633 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001633`
- External reference / 外部参照: `obimd-sub-1t3emarf5h`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017309_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zolc6o82zt/1t3emarf5h/1t3emarf5h.png`
- Checksum / 校验和:
  `d8e5c8ab9284fd7037bc6613a94df6cdeb6773d4d578a4ca86b6d8f2389c54fc`
...
- Marked-pixel bounds: (86,29)–(163,217); span 78 × 189 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.51%。
- 痕迹范围：(86,29)–(163,217)；跨度78 × 189 px；痕迹矩形高于宽。
