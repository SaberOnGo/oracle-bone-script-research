...
- External category reference: `evobc-cat-07915`
- Source category ID: `07915`
- Source label for human review: `衡`
...
- `obs-evo-cand-007915-route-category-staging`
...
- `obs-evo-cand-007915-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007915-route-evolution-graph`
