# Material Visual Observation / obs-comp-cand-002419 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002419`
- External reference / 外部参照: `obimd-sub-6csrigfo3r`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020490_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6csrigfo3r/6csrigfo3r/6csrigfo3r.png`
- Checksum / 校验和:
  `3c75222d49a55edfd5f00e18e5ac2aabbe009c8a27a61aea93c7ae0674ae6480`
...
- Marked-pixel bounds: (64,49)–(185,196); span 122 × 148 px; the marked
...
- 痕迹范围：(64,49)–(185,196)；跨度122 × 148 px；痕迹矩形高于宽。
