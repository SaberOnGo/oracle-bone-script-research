...
- External category reference: `evobc-cat-13171`
- Source category ID: `13171`
...
- `obs-evo-cand-013171-route-category-staging`
...
- `obs-evo-cand-013171-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013171-route-evolution-graph`
