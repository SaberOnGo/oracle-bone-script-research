...
- External category reference: `evobc-cat-03800`
- Source category ID: `03800`
- Source label for human review: `曓`
- Source codepoints: `U+66D3`
...
- `obs-evo-cand-003800-route-category-staging`
...
- `obs-evo-cand-003800-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003800-route-evolution-graph`
