...
- External category reference: `evobc-cat-08765`
- Source category ID: `08765`
- Source label for human review: `蹤`
- Source codepoints: `U+8E64`
...
- `obs-evo-cand-008765-route-category-staging`
...
- `obs-evo-cand-008765-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008765-route-evolution-graph`
