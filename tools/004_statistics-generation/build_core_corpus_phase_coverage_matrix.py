...
SOURCE_PIPELINE_PHASE_ACTION_MISSING_EVIDENCE_REVIEW_OUTCOME_WAVE_HANDOFF_ASSIGNMENT_OUTCOME_SOURCE_HANDOFF_OUTCOME_CHECKLIST_OUTCOME_ROUTE_SUMMARY = Path(
    "corpus/009_statistics-and-derived-features/179_source-pipeline-phase-action-missing-evidence-review-outcome-wave-handoff-assignment-outcome-source-handoff-outcome-checklist-outcome-route-summary.json"
)
SOURCE_PIPELINE_PHASE_ACTION_MISSING_EVIDENCE_REVIEW_OUTCOME_WAVE_HANDOFF_ASSIGNMENT_OUTCOME_SOURCE_HANDOFF_OUTCOME_CHECKLIST_OUTCOME_ROUTE_SUMMARY_OUTCOME_SCAFFOLD = Path(
    "corpus/009_statistics-and-derived-features/180_source-pipeline-phase-action-missing-evidence-review-outcome-wave-handoff-assignment-outcome-source-handoff-outcome-checklist-outcome-route-summary-outcome-scaffold.csv"
)
...
SOURCE_PIPELINE_PHASE_ACTION_MISSING_EVIDENCE_REVIEW_OUTCOME_WAVE_HANDOFF_ASSIGNMENT_OUTCOME_SOURCE_HANDOFF_OUTCOME_CHECKLIST_OUTCOME_ROUTES_SUMMARY = Path(
    "corpus/009_statistics-and-derived-features/183_source-pipeline-phase-action-missing-evidence-review-outcome-wave-handoff-assignment-outcome-source-handoff-outcome-checklist-outcome-routes-summary.json"
)
SOURCE_PIPELINE_MISSING_EVIDENCE_OUTCOME_ROUTES_ASSIGNMENT_PLAN = Path(
    "corpus/009_statistics-and-derived-features/184_source-pipeline-missing-evidence-outcome-routes-assignment-plan.json"
)
...
def build_phase_rows(root: Path) -> list[dict[str, str]]:
    ...
    source_pipeline_action_missing_evidence_review_outcome_wave_handoff_assignment_outcome_source_handoff_outcome_checklist_outcome_route_summary_outcome_scaffold_rows = count_csv(
        root,
    ...
    source_pipeline_action_missing_evidence_review_outcome_wave_handoff_assignment_outcome_source_handoff_outcome_checklist_outcome_routes_summary_files = (
        1
        if (
            root
    ...
    source_pipeline_missing_evidence_outcome_routes_assignment_plan_files = (
        1 if (root / SOURCE_PIPELINE_MISSING_EVIDENCE_OUTCOME_ROUTES_ASSIGNMENT_PLAN).exists() else 0
    )
    source_pipeline_missing_evidence_outcome_routes_assignment_checklist_rows = count_csv(
        root,
        ...
        rows.append(
            {
                ...
                **phase_values,
                ...
                "source_pipeline_evidence_rows": str(
                    ...
                    + source_pipeline_action_missing_evidence_review_outcome_wave_handoff_assignment_outcome_source_handoff_outcome_checklist_outcome_routes_summary_files
                    + source_pipeline_missing_evidence_outcome_routes_assignment_plan_files
                    + source_pipeline_missing_evidence_outcome_routes_assignment_checklist_rows
                    if area == "research_sources_and_bibliography"
                    else 0
                ),
