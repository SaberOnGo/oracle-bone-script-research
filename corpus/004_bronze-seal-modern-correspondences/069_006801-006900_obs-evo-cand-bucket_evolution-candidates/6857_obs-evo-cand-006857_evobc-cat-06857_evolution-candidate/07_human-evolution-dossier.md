...
- External category reference: `evobc-cat-06857`
- Source category ID: `06857`
- Source label for human review: `羨`
- Source codepoints: `U+7FA8`
...
- `obs-evo-cand-006857-route-category-staging`
...
- `obs-evo-cand-006857-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006857-route-evolution-graph`
