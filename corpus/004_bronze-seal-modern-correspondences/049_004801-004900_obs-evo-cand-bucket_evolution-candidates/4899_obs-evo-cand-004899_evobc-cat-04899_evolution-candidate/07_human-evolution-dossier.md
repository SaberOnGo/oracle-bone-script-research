...
Project ID: `obs-evo-cand-004899`
...
- Project ID: `obs-evo-cand-004899`
- EVOBC category candidate ID: `evobc-evo-cat-04899`
- External category reference: `evobc-cat-04899`
- Source category ID: `04899`
- Source label for human review: `潚`
- Source codepoints: `U+6F5A`
...
- `obs-evo-cand-004899-route-category-staging`
...
- `obs-evo-cand-004899-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004899-route-evolution-graph`
