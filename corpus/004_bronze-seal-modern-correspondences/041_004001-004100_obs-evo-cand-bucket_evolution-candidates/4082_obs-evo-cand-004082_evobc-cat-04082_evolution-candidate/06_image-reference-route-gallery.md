...
- `obs-evo-cand-004082-route-category-staging`
...
- `obs-evo-cand-004082-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004082-route-evolution-graph`
