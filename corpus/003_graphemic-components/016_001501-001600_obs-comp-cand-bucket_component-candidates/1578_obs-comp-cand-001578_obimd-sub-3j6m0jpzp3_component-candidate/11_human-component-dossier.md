# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-001578
...
- glyph_codepoint_uplus_sample: `U+F9389, U+F938A, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-017159` | `001_asset-017159_img.png` | `5bbc7934a87951431e8ef028aadee4dadb678eebc4f6db829517018077a6ceff` |
