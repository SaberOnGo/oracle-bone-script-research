# Material Visual Observation / obs-comp-cand-002655 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002655`
- External reference / 外部参照: `obimd-sub-m2cnbqdb8a`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021231_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/m2cnbqdb8a/m2cnbqdb8a/m2cnbqdb8a.png`
- Checksum / 校验和:
  `171b3c0d13e979733d944b6eef59bf8cde80debefbc712b058c3ebba168400e8`
...
- Marked-pixel bounds: (97,22)–(154,225); span 58 × 204 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.72%。
- 痕迹范围：(97,22)–(154,225)；跨度58 × 204 px；痕迹矩形高于宽。
