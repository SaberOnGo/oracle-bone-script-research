# obs-char-000611 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000611`
- primary external id: `hust-obc-cat-0696`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/611_obs-char-000611_hust-obc-cat-0696_orac
  le-character/03_visual-assets/001_asset-000616_hust-obc-cat-0696_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0696/G_0696_甲骨文.png`
- asset id: `asset-000616`
...
- source category: `0696`
- validation class: `610`
- source image route: `HUST-OBC/deciphered/0696/G_0696_甲骨文.png`
- asset id: `asset-000616`
...
- English observation: `Several small stacked bars and bent marks stand
  above a pointed lower outline that contains a central fork and tiny
  detached marks.`
- 中文观察: `数条小型层叠横栏和弯痕位于尖底下部轮廓之上，轮廓内有中央叉笔和微小分离痕。`
...
- dataset label text: `㚮`
- dataset label codepoints: `U+36AE`
...
- Which source records identify obs-char-000611 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000611？
