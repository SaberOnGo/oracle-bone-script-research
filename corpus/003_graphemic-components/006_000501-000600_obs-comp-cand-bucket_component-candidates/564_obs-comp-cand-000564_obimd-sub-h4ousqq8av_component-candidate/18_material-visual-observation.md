# Material Visual Observation / obs-comp-cand-000564 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000564`
- External reference / 外部参照: `obimd-sub-h4ousqq8av`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012816_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h4ousqq8av/h4ousqq8av/h4ousqq8av.png`
- Checksum / 校验和:
  `be7c8fc2e8eb25a95cb9120eee5dcf9efb6a32adc5be6ae53b9220ff84fb61bf`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.77%.
- Marked-pixel bounds: (80,19)–(169,232); span 90 × 214 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.77%。
- 痕迹范围：(80,19)–(169,232)；跨度90 × 214 px；痕迹矩形高于宽。
