# obs-unk-004572 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004572`
- primary external id: `hust-obc-und-X-004572`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/072_obs-unk-004572_h
  ust-obc-und-X-004572_oracle-character-candidate/03_visual-assets/001_asset
  -006165_hust-obc-und-X-004572_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/128/X_？_8307_1.png`
- asset id: `asset-006165`
...
- source class: `HUST-OBC/undeciphered/X/128/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/128/X_？_8307_1.png`
- asset id: `asset-006165`
...
- English observation: `Two upper marks, open gaps, and lower curve recorded.`
- 中文观察: `已记录两个上部痕迹、开放空隙和下部弯曲痕迹。`
...
- Which source records identify obs-unk-004572 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004572？
