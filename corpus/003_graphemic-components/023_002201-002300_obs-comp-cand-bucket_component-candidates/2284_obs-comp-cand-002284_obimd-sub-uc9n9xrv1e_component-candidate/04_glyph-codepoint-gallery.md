# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002284
...
| --- | --- | --- | --- |
| `obimd-glyph-link-035278` | 򼔕󽈞 | `U+BC515;U+FD21E` | `reviewed_metadata_only` |
| `obimd-glyph-link-035279` | 󽈟 | `U+FD21F` | `reviewed_metadata_only` |
