...
- External category reference: `evobc-cat-06606`
- Source category ID: `06606`
- Source label for human review: `緪`
- Source codepoints: `U+7DEA`
...
- `obs-evo-cand-006606-route-category-staging`
...
- `obs-evo-cand-006606-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006606-route-evolution-graph`
