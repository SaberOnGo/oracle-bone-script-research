# Material Visual Observation / obs-comp-cand-001096 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001096`
- External reference / 外部参照: `obimd-sub-6bzmgp7e84`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014905_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6bzmgp7e84/6bzmgp7e84/6bzmgp7e84.png`
- Checksum / 校验和:
  `a42c61c12d942eef7f24e474e2626565255d194d120d6cfa82350af74c253e18`
...
- Marked-pixel bounds: (87,47)–(162,210); span 76 × 164 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.49%。
- 痕迹范围：(87,47)–(162,210)；跨度76 × 164 px；痕迹矩形高于宽。
