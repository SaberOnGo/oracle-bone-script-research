# obs-char-000739 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000739`
- primary external id: `hust-obc-cat-0841`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/739_obs-char-000739_hust-obc-cat-0841_orac
  le-character/03_visual-assets/001_asset-000744_hust-obc-cat-0841_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0841/G_0841_乙8895合22214子組.png`
- asset id: `asset-000744`
...
- source category: `0841`
- validation class: `738`
- source image route: `HUST-OBC/deciphered/0841/G_0841_乙8895合22214子組.png`
- asset id: `asset-000744`
...
- English observation: `A narrow upper stem forks and carries short side
  twigs, above a detached lower angular outline made from two horizontals
  and a bent left side.`
- 中文观察: `狭长上干分叉并带短侧枝，下方为分离的折角轮廓，由两条横笔和弯折左侧组成。`
...
- dataset label text: `㜿`
- dataset label codepoints: `U+373F`
...
- filename catalog route clues: `Heji-like filename clue: 合22214
  (G_0841_乙8895合22214子組.png)`
...
- Which source records identify obs-char-000739 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000739？
