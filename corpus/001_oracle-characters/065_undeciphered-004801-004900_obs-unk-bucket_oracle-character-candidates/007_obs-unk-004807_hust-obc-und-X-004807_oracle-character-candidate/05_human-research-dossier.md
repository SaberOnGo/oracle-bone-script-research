# obs-unk-004807 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004807`
- primary external id: `hust-obc-und-X-004807`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/007_obs-unk-004807_h
  ust-obc-und-X-004807_oracle-character-candidate/03_visual-assets/001_asset
  -006400_hust-obc-und-X-004807_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/363/X_？_7346_1.png`
- asset id: `asset-006400`
...
- source class: `HUST-OBC/undeciphered/X/363/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/363/X_？_7346_1.png`
- asset id: `asset-006400`
...
- English observation: `compact horizontal group with detached fragments`
- 中文观察: `带分离片段的紧凑横向结构`
...
- Which source records identify obs-unk-004807 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004807？
