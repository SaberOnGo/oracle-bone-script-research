...
- `obs-evo-cand-004021-route-category-staging`
...
- `obs-evo-cand-004021-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004021-route-evolution-graph`
