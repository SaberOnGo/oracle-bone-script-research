# obs-unk-009088 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/107_undeciphered-009
  001-009100_obs-unk-bucket_oracle-character-candidates/088_obs-unk-009088_h
  ust-obc-und-YH-009088_oracle-character-candidate/03_visual-assets/001_asse
  t-010679_hust-obc-und-YH-009088_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/611B8/H_？_611B8_0.png`
- asset id: `asset-010679`
...
- source class: `HUST-OBC/undeciphered/Y+H/611B8/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/611B8/H_？_611B8_0.png`
- asset id: `asset-010679`
...
- Which source records identify obs-unk-009088 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009088？
