...
Project ID: `obs-evo-cand-002241`
...
- Project ID: `obs-evo-cand-002241`
- EVOBC category candidate ID: `evobc-evo-cat-02241`
- External category reference: `evobc-cat-02241`
- Source category ID: `02241`
- Source label for human review: `媧`
- Source codepoints: `U+5AA7`
...
- `obs-evo-cand-002241-route-category-staging`
...
- `obs-evo-cand-002241-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002241-route-evolution-graph`
