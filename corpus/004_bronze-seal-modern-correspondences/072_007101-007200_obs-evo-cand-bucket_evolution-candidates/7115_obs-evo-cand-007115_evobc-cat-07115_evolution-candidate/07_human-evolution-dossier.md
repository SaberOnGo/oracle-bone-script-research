...
- External category reference: `evobc-cat-07115`
- Source category ID: `07115`
- Source label: `膀`
...
- `obs-evo-cand-007115-route-category-staging`
...
- `obs-evo-cand-007115-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007115-route-evolution-graph`
