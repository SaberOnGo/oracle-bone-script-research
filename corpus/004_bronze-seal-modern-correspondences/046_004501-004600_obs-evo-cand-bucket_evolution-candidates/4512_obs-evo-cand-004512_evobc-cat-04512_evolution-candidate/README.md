# obs-evo-cand-004512 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-04512`
- Source label for human review: `汫`
- Source codepoints: `U+6C6B`
- Image reference count: `24`
- Era token counts: `OBC:24`
- Source token counts: `Book:1;Web:23`
