...
Project ID: `obs-evo-cand-007371`
...
- Project ID: `obs-evo-cand-007371`
- EVOBC category candidate ID: `evobc-evo-cat-07371`
- External category reference: `evobc-cat-07371`
- Source category ID: `07371`
- Source label for human review: `莉`
- Source codepoints: `U+8389`
...
- `obs-evo-cand-007371-route-category-staging`
...
- `obs-evo-cand-007371-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007371-route-evolution-graph`
