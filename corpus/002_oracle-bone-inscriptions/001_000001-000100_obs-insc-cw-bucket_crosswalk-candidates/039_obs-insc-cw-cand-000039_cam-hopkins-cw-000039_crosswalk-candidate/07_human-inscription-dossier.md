...
Project ID: `obs-insc-cw-cand-000039`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000039`
...
- Yingguo / 英国所藏: `y207` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `205` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `386` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000039`
