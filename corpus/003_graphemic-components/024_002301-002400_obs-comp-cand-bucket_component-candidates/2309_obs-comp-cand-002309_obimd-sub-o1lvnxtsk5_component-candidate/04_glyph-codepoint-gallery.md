# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002309
...
| --- | --- | --- | --- |
| `obimd-glyph-link-035737` | 󽓀 | `U+FD4C0` | `reviewed_metadata_only` |
| `obimd-glyph-link-035738` | 󽓁 | `U+FD4C1` | `reviewed_metadata_only` |
| `obimd-glyph-link-035739` | 󽓂 | `U+FD4C2` | `reviewed_metadata_only` |
| `obimd-glyph-link-035740` | 󽓃 | `U+FD4C3` | `reviewed_metadata_only` |
