# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004367
...
- EVOBC candidate category: `evobc-evo-cat-04367`.
- Source label for search only: `歊`.
- Source codepoints for search only: `U+6B4A`.
