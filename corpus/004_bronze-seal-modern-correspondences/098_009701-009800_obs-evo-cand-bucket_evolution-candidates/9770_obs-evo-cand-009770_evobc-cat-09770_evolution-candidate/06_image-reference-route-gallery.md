...
- `obs-evo-cand-009770-route-category-staging`
...
- `obs-evo-cand-009770-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009770-route-evolution-graph`
