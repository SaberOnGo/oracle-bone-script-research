...
- External category reference: `evobc-cat-11596`
- Source category ID: `11596`
- Source label for human review: `𤙓`
- Source codepoints: `U+24653`
...
- `obs-evo-cand-011596-route-category-staging`
...
- `obs-evo-cand-011596-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011596-route-evolution-graph`
