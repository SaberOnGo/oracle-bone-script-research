# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010208
...
- EVOBC candidate category: `evobc-evo-cat-10208`.
- Source label for search only: `駿`.
- Source codepoints for search only: `U+99FF`.
