...
- External category reference: `evobc-cat-01118`
- Source category ID: `01118`
- Source label for human review: `冒`
...
- `obs-evo-cand-001118-route-category-staging`
...
- `obs-evo-cand-001118-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001118-route-evolution-graph`
