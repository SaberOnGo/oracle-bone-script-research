# obs-unk-004527 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/027_obs-unk-004527_h
  ust-obc-und-X-004527_oracle-character-candidate/03_visual-assets/001_asset
  -006120_hust-obc-und-X-004527_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/83/X_？_8267_1.png`
- asset id: `asset-006120`
...
- source class: `HUST-OBC/undeciphered/X/83/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/83/X_？_8267_1.png`
- asset id: `asset-006120`
...
- English observation: `Forked tip, band, opening, and side marks recorded.`
- 中文观察: `已记录分叉上端、上部带状痕迹、白色开口和两侧痕迹。`
...
- Which source records identify obs-unk-004527 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004527？
