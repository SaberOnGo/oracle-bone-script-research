...
- Project ID: `obs-evo-cand-001873`
- EVOBC category candidate ID: `evobc-evo-cat-01873`
- External category reference: `evobc-cat-01873`
- Source category ID: `01873`
- Source label for human review: `城`
- Source codepoints: `U+57CE`
...
- `obs-evo-cand-001873-route-category-staging`
...
- `obs-evo-cand-001873-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001873-route-evolution-graph`
