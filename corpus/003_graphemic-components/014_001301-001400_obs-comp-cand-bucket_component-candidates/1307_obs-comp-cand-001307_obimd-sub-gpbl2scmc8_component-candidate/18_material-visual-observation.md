# Material Visual Observation / obs-comp-cand-001307 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001307`
- External reference / 外部参照: `obimd-sub-gpbl2scmc8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015644_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6tjo4iag3l/gpbl2scmc8/gpbl2scmc8.png`
- Checksum / 校验和:
  `fe1236609ba029b7f2240f4327ebbe0bb8a4f83fc2065d3c315458a585f1c134`
...
- Marked-pixel bounds: (90,32)–(156,222); span 67 × 191 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.53%。
- 痕迹范围：(90,32)–(156,222)；跨度67 × 191 px；痕迹矩形高于宽。
