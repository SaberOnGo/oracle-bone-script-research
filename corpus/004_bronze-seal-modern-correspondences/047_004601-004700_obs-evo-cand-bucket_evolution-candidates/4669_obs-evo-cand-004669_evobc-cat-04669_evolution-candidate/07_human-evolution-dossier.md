...
- External category reference: `evobc-cat-04669`
- Source category ID: `04669`
...
- `obs-evo-cand-004669-route-category-staging`
...
- `obs-evo-cand-004669-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004669-route-evolution-graph`
