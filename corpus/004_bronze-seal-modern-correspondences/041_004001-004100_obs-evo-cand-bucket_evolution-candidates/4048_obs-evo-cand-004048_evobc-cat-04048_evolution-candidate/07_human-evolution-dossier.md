...
- External category reference: `evobc-cat-04048`
- Source category ID: `04048`
- Source label for human review: `梂`
- Source codepoints: `U+6882`
...
- `obs-evo-cand-004048-route-category-staging`
...
- `obs-evo-cand-004048-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004048-route-evolution-graph`
