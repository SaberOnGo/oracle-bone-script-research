...
- External category reference: `evobc-cat-12384`
- Source category ID: `12384`
- Source label for human review: `𨖽`
...
- `obs-evo-cand-012384-route-category-staging`
...
- `obs-evo-cand-012384-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012384-route-evolution-graph`
