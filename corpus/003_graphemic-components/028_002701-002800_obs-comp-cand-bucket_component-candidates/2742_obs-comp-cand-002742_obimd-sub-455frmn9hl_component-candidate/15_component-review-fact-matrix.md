# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002742
...
| Glyph or codepoint route / 字形或码位路线 | 35 OBIMD route rows; examples U+FF7A5; U+FF7A6; 另有 33 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
