# obs-char-001544 Archaeology Paleography Review

# obs-char-001544 考古文字复核档案
...
- first local image: `001_asset-001549_hust-obc-cat-1733_glyph.png`
- first source image: `G_1733_乙6533(甲).png`
...
- source label text: `㪻`
- source label codepoints: `U+3ABB`
