...
- Project ID: `obs-evo-cand-005352`
- EVOBC category candidate ID: `evobc-evo-cat-05352`
- External category reference: `evobc-cat-05352`
- Source category ID: `05352`
- Source label for human review: `玘`
- Source codepoints: `U+7398`
...
- `obs-evo-cand-005352-route-category-staging`
...
- `obs-evo-cand-005352-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005352-route-evolution-graph`
