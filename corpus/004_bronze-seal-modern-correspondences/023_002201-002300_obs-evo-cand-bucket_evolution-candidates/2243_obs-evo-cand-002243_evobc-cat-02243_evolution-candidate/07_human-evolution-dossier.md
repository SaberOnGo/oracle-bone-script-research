...
- External category reference: `evobc-cat-02243`
- Source category ID: `02243`
- Source label for human review: `媯`
...
- `obs-evo-cand-002243-route-category-staging`
...
- `obs-evo-cand-002243-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002243-route-evolution-graph`
