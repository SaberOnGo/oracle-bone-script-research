...
- External category reference: `evobc-cat-12549`
- Source category ID: `12549`
...
- `obs-evo-cand-012549-route-category-staging`
...
- `obs-evo-cand-012549-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012549-route-evolution-graph`
