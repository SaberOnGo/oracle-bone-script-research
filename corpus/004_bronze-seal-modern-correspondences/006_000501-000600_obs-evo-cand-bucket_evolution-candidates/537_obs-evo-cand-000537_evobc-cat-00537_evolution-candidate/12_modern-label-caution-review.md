# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000537
...
- EVOBC candidate category: `evobc-evo-cat-00537`.
- Source label for search only: `䩉`.
- Source codepoints for search only: `U+4A49`.
