# obs-unk-002741 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002741`
- primary external id: `hust-obc-und-L-002741`
...
- local review image route: `corpus/001_oracle-characters/044_undeciphered-002
  701-002800_obs-unk-bucket_oracle-character-candidates/041_obs-unk-002741_h
  ust-obc-und-L-002741_oracle-character-candidate/03_visual-assets/001_asset
  -004334_hust-obc-und-L-002741_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2741/L_？_4450.jpg`
- asset id: `asset-004334`
...
- source class: `HUST-OBC/undeciphered/L/2741/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2741/L_？_4450.jpg`
- asset id: `asset-004334`
...
- Which source records identify obs-unk-002741 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002741？
