# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008457
...
- EVOBC candidate category: `evobc-evo-cat-08457`.
- Source label for search only: `谛`.
- Source codepoints for search only: `U+8C1B`.
