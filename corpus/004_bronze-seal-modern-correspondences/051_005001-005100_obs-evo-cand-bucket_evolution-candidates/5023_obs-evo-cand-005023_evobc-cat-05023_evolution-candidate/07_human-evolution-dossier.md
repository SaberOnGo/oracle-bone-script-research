...
Project ID: `obs-evo-cand-005023`
...
- Project ID: `obs-evo-cand-005023`
- EVOBC category candidate ID: `evobc-evo-cat-05023`
- External category reference: `evobc-cat-05023`
- Source category ID: `05023`
- Source label for human review: `灥`
- Source codepoints: `U+7065`
...
- `obs-evo-cand-005023-route-category-staging`
...
- `obs-evo-cand-005023-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005023-route-evolution-graph`
