# obs-unk-006466 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006466`
- primary external id: `hust-obc-und-X-006466`
...
- local review image route: `corpus/001_oracle-characters/081_undeciphered-006
  401-006500_obs-unk-bucket_oracle-character-candidates/066_obs-unk-006466_h
  ust-obc-und-X-006466_oracle-character-candidate/03_visual-assets/001_asset
  -008057_hust-obc-und-X-006466_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2022/X_？_5666_1.png`
- asset id: `asset-008057`
...
- source class: `HUST-OBC/undeciphered/X/2022/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2022/X_？_5666_1.png`
- asset id: `asset-008057`
...
- Which source records identify obs-unk-006466 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006466？
