# obs-char-000280 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/280_obs-char-000280_hust-obc-cat-0316_orac
  le-character/03_visual-assets/001_asset-000285_hust-obc-cat-0316_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0316/G_0316_前8.4.8(甲).png`
- asset id: `asset-000285`
...
- source category: `0316`
- validation class: `279`
- source image route: `HUST-OBC/deciphered/0316/G_0316_前8.4.8(甲).png`
- asset id: `asset-000285`
...
- English observation: `The image has an angular curved outline on the left
  with a small internal opening, plus a separate descending stroke on the
  right.`
...
- dataset label text: `㔲`
- dataset label codepoints: `U+3532`
...
- Which source records identify obs-char-000280 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000280？
