# Material Visual Observation / obs-comp-cand-001368 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001368`
- External reference / 外部参照: `obimd-sub-vxc84yxcjn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015787_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/79c9fojxw0/vxc84yxcjn/vxc84yxcjn.png`
- Checksum / 校验和:
  `372363fc17dfa77332c8f47ffb597f0106d3102683ce7ab3a2a40088419c0dce`
...
- Marked-pixel bounds: (59,42)–(190,203); span 132 × 162 px; the marked
...
- 痕迹范围：(59,42)–(190,203)；跨度132 × 162 px；痕迹矩形高于宽。
