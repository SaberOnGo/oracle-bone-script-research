# Material Visual Observation / obs-comp-cand-000720 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000720`
- External reference / 外部参照: `obimd-sub-g5n5rqvdxo`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013432_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/g5n5rqvdxo/g5n5rqvdxo/g5n5rqvdxo.png`
- Checksum / 校验和:
  `a115a2b878ac6550f1ed0f708ab834e26d5243662d11d80e3e6d7d29ee4f3fef`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.60%.
- Marked-pixel bounds: (90,33)–(159,218); span 70 × 186 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.60%。
- 痕迹范围：(90,33)–(159,218)；跨度70 × 186 px；痕迹矩形高于宽。
