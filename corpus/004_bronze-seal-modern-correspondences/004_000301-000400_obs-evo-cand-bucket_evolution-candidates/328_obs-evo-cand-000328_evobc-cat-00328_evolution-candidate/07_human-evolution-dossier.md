...
- External category reference: `evobc-cat-00328`
- Source category ID: `00328`
- Source label for human review: `䋱`
...
- `obs-evo-cand-000328-route-category-staging`
...
- `obs-evo-cand-000328-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000328-route-evolution-graph`
