# Material Visual Observation / obs-comp-cand-001150 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001150`
- External reference / 外部参照: `obimd-sub-i5iv3migqj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015340_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/i5iv3migqj/i5iv3migqj/i5iv3migqj.png`
- Checksum / 校验和:
  `272889b3fe7a8883bda9e53a96a55e7061b2e6ae155cb78920af76d676f50350`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.59%.
- Marked-pixel bounds: (90,42)–(154,211); span 65 × 170 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.59%。
- 痕迹范围：(90,42)–(154,211)；跨度65 × 170 px；痕迹矩形高于宽。
