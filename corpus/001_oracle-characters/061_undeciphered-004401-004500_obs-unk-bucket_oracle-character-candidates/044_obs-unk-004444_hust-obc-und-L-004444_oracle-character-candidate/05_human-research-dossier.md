# obs-unk-004444 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/044_obs-unk-004444_h
  ust-obc-und-L-004444_oracle-character-candidate/03_visual-assets/001_asset
  -006037_hust-obc-und-L-004444_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4444/L_？_9990.jpg`
- asset id: `asset-006037`
...
- source class: `HUST-OBC/undeciphered/L/4444/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4444/L_？_9990.jpg`
- asset id: `asset-006037`
...
- English observation: `A peaked outer outline surrounds central and lower`
  `curved traces.`
- 中文观察: `尖顶外缘轮廓围住中央和下部弯曲痕迹。`
...
- Which source records identify obs-unk-004444 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004444？
