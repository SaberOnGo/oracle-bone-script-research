# obs-unk-007934 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/096_undeciphered-007
  901-008000_obs-unk-bucket_oracle-character-candidates/034_obs-unk-007934_h
  ust-obc-und-YH-007934_oracle-character-candidate/03_visual-assets/001_asse
  t-009525_hust-obc-und-YH-007934_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6050E/H_？_6050E_0.png`
- asset id: `asset-009525`
...
- source class: `HUST-OBC/undeciphered/Y+H/6050E/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6050E/H_？_6050E_0.png`
- asset id: `asset-009525`
...
- Which source records identify obs-unk-007934 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007934？
