# Material Visual Observation / obs-comp-cand-002309 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002309`
- External reference / 外部参照: `obimd-sub-o1lvnxtsk5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020328_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/s65fsavh28/o1lvnxtsk5/o1lvnxtsk5.png`
- Checksum / 校验和:
  `692eb46ea12a68a3ea249c99a56c1ce4bec5d257fe992cdba9509c4a1a0087e2`
...
- Marked-pixel bounds: (78,29)–(171,218); span 94 × 190 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.56%。
- 痕迹范围：(78,29)–(171,218)；跨度94 × 190 px；痕迹矩形高于宽。
