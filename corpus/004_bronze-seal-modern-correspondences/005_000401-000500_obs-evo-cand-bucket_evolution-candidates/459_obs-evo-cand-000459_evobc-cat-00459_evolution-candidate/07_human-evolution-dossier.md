...
- External category reference: `evobc-cat-00459`
- Source category ID: `00459`
- Source label for human review: `䟴`
...
- `obs-evo-cand-000459-route-category-staging`
...
- `obs-evo-cand-000459-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000459-route-evolution-graph`
