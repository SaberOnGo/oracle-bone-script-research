# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004246
...
- EVOBC candidate category: `evobc-evo-cat-04246`.
- Source label for search only: `模`.
- Source codepoints for search only: `U+6A21`.
