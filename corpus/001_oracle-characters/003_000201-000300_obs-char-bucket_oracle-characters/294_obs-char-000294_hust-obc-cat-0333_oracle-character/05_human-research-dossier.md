# obs-char-000294 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/294_obs-char-000294_hust-obc-cat-0333_orac
  le-character/03_visual-assets/001_asset-000299_hust-obc-cat-0333_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0333/G_0333_前1.30.5(甲).png`
- asset id: `asset-000299`
...
- source category: `0333`
- validation class: `293`
- source image route: `HUST-OBC/deciphered/0333/G_0333_前1.30.5(甲).png`
- asset id: `asset-000299`
...
- English observation: `The narrow image shows a long angled upper stroke, a
  descending side line, and a small lower enclosure containing a short
  horizontal mark.`
- 中文观察: `狭长图像有长斜向上部笔画和下行侧线，下部有带短内横画的小型闭合轮廓。`
...
- dataset label text: `㕃`
- dataset label codepoints: `U+3543`
...
- Which source records identify obs-char-000294 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000294？
