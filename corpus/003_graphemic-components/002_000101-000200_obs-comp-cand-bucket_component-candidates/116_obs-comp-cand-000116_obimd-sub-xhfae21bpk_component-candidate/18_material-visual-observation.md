# Material Visual Observation / obs-comp-cand-000116 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000116`
- External reference / 外部参照: `obimd-sub-xhfae21bpk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011528_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xhfae21bpk/xhfae21bpk/xhfae21bpk.png`
- Checksum / 校验和:
  `a61e71db34df443c99920a84a7c7ecf4c9e3442e4067181b90c7ac47d103e749`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.84%.
- Marked-pixel bounds: (62,34)–(210,220); span 149 × 187 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.84%。
- 痕迹范围：(62,34)–(210,220)；跨度149 × 187 px；痕迹矩形高于宽。
