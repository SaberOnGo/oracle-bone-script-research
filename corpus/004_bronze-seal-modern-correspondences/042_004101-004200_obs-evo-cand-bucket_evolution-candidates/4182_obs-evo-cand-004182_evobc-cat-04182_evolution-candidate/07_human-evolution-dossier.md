...
- Project ID: `obs-evo-cand-004182`
- EVOBC category candidate ID: `evobc-evo-cat-04182`
- External category reference: `evobc-cat-04182`
- Source category ID: `04182`
- Source label for human review: `榚`
- Source codepoints: `U+699A`
...
- `obs-evo-cand-004182-route-category-staging`
...
- `obs-evo-cand-004182-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004182-route-evolution-graph`
