# obs-char-001199 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001199`
- primary external id: `hust-obc-cat-1340`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1199_obs-char-001199_hust-obc-cat-1340_ora
  cle-character/03_visual-assets/001_asset-001204_hust-obc-cat-1340_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1340/G_1340_前4.1.7(甲).png`
- asset id: `asset-001204`
...
- source category: `1340`
- validation class: `1198`
- source image route: `HUST-OBC/deciphered/1340/G_1340_前4.1.7(甲).png`
- asset id: `asset-001204`
...
- English observation: `A faint dense form has two upper branching clusters,
  a broad horizontal middle, and unequal lower strokes.`
- 中文观察: `较淡的密集形体有两个上部分枝笔群、宽大的中部横笔和不等长下部笔。`
...
- dataset label text: `㤲`
- dataset label codepoints: `U+3932`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/117_obs-evo-can
  d-000117_evobc-cat-00117_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/117_obs-evo-cand-000117_evobc-cat-00117_evolu
...
- Which source records identify obs-char-001199 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001199？
