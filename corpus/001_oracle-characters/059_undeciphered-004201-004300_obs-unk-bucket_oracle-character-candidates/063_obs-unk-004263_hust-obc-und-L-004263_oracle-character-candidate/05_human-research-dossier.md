# obs-unk-004263 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/063_obs-unk-004263_h
  ust-obc-und-L-004263_oracle-character-candidate/03_visual-assets/001_asset
  -005856_hust-obc-und-L-004263_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4263/L_？_9399.jpg`
- asset id: `asset-005856`
...
- source class: `HUST-OBC/undeciphered/L/4263/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4263/L_？_9399.jpg`
- asset id: `asset-005856`
...
- English observation: `Upper bar, lower curve, right terminal visible.`
- 中文观察: `上部横痕、下部弯曲痕迹和右侧末端可见。`
...
- Which source records identify obs-unk-004263 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004263？
