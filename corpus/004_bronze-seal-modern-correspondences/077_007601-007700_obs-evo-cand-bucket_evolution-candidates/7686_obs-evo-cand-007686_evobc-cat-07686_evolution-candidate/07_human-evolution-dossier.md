...
- External category reference: `evobc-cat-07686`
- Source category ID: `07686`
- Source label for human review: `蘿`
- Source codepoints: `U+863F`
...
- `obs-evo-cand-007686-route-category-staging`
...
- `obs-evo-cand-007686-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007686-route-evolution-graph`
