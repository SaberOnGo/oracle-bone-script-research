# obs-unk-006198 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006198`
- primary external id: `hust-obc-und-X-006198`
...
- local review image route: `corpus/001_oracle-characters/078_undeciphered-006
  101-006200_obs-unk-bucket_oracle-character-candidates/098_obs-unk-006198_h
  ust-obc-und-X-006198_oracle-character-candidate/03_visual-assets/001_asset
  -007790_hust-obc-und-X-006198_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1754/X_？_4343_1.png`
- asset id: `asset-007790`
...
- source class: `HUST-OBC/undeciphered/X/1754/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1754/X_？_4343_1.png`
- asset id: `asset-007790`
...
- Which source records identify obs-unk-006198 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006198？
