...
- External category reference: `evobc-cat-04553`
- Source category ID: `04553`
- Source label for human review: `沭`
...
- `obs-evo-cand-004553-route-category-staging`
...
- `obs-evo-cand-004553-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004553-route-evolution-graph`
