...
- External category reference: `evobc-cat-02809`
- Source category ID: `02809`
...
- `obs-evo-cand-002809-route-category-staging`
...
- `obs-evo-cand-002809-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002809-route-evolution-graph`
