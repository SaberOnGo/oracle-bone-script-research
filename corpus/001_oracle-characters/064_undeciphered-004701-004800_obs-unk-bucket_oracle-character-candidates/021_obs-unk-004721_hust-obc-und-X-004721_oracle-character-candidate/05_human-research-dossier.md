# obs-unk-004721 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004721`
- primary external id: `hust-obc-und-X-004721`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/021_obs-unk-004721_h
  ust-obc-und-X-004721_oracle-character-candidate/03_visual-assets/001_asset
  -006314_hust-obc-und-X-004721_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/277/X_？_7253_1.png`
- asset id: `asset-006314`
...
- source class: `HUST-OBC/undeciphered/X/277/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/277/X_？_7253_1.png`
- asset id: `asset-006314`
...
- English observation: `upper upright strokes with lower zigzag`
- 中文观察: `带下部折线的上部竖向笔画组`
...
- Which source records identify obs-unk-004721 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004721？
