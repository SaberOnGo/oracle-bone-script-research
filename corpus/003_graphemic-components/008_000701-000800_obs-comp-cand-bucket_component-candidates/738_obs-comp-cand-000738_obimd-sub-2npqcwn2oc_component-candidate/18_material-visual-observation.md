# Material Visual Observation / obs-comp-cand-000738 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000738`
- External reference / 外部参照: `obimd-sub-2npqcwn2oc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013465_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2npqcwn2oc/2npqcwn2oc/2npqcwn2oc.png`
- Checksum / 校验和:
  `a4d3490492bbc8cb7f50cb0e7d1be89e3b5f6cefa412986d7bcf79b0b6554b5c`
...
- Marked-pixel bounds: (74,32)–(175,221); span 102 × 190 px; the marked
...
- 痕迹范围：(74,32)–(175,221)；跨度102 × 190 px；痕迹矩形高于宽。
