...
Project ID: `obs-evo-cand-005457`
...
- Project ID: `obs-evo-cand-005457`
- EVOBC category candidate ID: `evobc-evo-cat-05457`
- External category reference: `evobc-cat-05457`
- Source category ID: `05457`
- Source label for human review: `璀`
- Source codepoints: `U+7480`
...
- `obs-evo-cand-005457-route-category-staging`
...
- `obs-evo-cand-005457-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005457-route-evolution-graph`
