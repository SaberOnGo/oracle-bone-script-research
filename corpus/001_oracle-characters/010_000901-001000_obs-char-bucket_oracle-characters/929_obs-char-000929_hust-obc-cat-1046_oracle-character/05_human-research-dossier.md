# obs-char-000929 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/929_obs-char-000929_hust-obc-cat-1046_orac
  le-character/03_visual-assets/001_asset-000934_hust-obc-cat-1046_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1046/G_1046_甲骨文0.png`
- asset id: `asset-000934`
...
- source category: `1046`
- validation class: `928`
- source image route: `HUST-OBC/deciphered/1046/G_1046_甲骨文0.png`
- asset id: `asset-000934`
...
- dataset label text: `㠌`
- dataset label codepoints: `U+380C`
...
- Which source records identify obs-char-000929 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000929？
