# Material Visual Observation / obs-comp-cand-001311 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001311`
- External reference / 外部参照: `obimd-sub-qcyhoj9u1r`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015648_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/d0hauaf16v/qcyhoj9u1r/qcyhoj9u1r.png`
- Checksum / 校验和:
  `d1dc1420d0b648d32527031731c8a3499a6fed16b7327289a2de3b952d3d4c9d`
...
- Marked-pixel bounds: (88,26)–(160,228); span 73 × 203 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.89%。
- 痕迹范围：(88,26)–(160,228)；跨度73 × 203 px；痕迹矩形高于宽。
