# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004432
...
- EVOBC candidate category: `evobc-evo-cat-04432`.
- Source label for search only: `殼`.
- Source codepoints for search only: `U+6BBC`.
