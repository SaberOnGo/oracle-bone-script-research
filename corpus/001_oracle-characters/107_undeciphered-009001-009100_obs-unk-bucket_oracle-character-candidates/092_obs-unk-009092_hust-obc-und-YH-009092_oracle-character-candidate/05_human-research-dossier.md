# obs-unk-009092 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-009092`
- primary external id: `hust-obc-und-YH-009092`
...
- local review image route: `corpus/001_oracle-characters/107_undeciphered-009
  001-009100_obs-unk-bucket_oracle-character-candidates/092_obs-unk-009092_h
  ust-obc-und-YH-009092_oracle-character-candidate/03_visual-assets/001_asse
  t-010683_hust-obc-und-YH-009092_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/611BF/H_？_611BF_0.png`
- asset id: `asset-010683`
...
- source class: `HUST-OBC/undeciphered/Y+H/611BF/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/611BF/H_？_611BF_0.png`
- asset id: `asset-010683`
...
- Which source records identify obs-unk-009092 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009092？
