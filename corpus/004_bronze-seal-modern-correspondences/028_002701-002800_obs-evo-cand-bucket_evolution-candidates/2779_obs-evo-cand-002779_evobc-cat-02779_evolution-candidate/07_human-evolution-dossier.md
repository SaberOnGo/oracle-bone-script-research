...
- Project ID: `obs-evo-cand-002779`
- EVOBC category candidate ID: `evobc-evo-cat-02779`
- External category reference: `evobc-cat-02779`
- Source category ID: `02779`
- Source label for human review: `廾`
- Source codepoints: `U+5EFE`
...
- `obs-evo-cand-002779-route-category-staging`
...
- `obs-evo-cand-002779-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002779-route-evolution-graph`
