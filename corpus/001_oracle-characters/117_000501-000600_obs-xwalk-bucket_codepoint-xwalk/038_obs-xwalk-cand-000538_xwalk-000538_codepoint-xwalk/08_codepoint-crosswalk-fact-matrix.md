# obs-xwalk-cand-000538 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+365A` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-0612` | not reading |
