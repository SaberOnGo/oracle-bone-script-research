...
- External category reference: `evobc-cat-08715`
- Source category ID: `08715`
- Source label for human review: `距`
...
- `obs-evo-cand-008715-route-category-staging`
...
- `obs-evo-cand-008715-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008715-route-evolution-graph`
