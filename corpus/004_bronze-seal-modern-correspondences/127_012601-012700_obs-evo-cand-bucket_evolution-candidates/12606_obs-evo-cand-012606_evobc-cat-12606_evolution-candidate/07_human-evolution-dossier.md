...
- External category reference: `evobc-cat-12606`
- Source category ID: `12606`
- Source label for human review: `𩑔`
- Source codepoints: `U+29454`
...
- `obs-evo-cand-012606-route-category-staging`
...
- `obs-evo-cand-012606-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012606-route-evolution-graph`
