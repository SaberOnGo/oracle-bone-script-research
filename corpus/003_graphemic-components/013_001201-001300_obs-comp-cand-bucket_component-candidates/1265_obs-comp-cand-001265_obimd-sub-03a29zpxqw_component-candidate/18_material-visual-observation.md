# Material Visual Observation / obs-comp-cand-001265 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001265`
- External reference / 外部参照: `obimd-sub-03a29zpxqw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015503_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/03a29zpxqw/03a29zpxqw/03a29zpxqw.png`
- Checksum / 校验和:
  `2d881c8a15f8c208ef60a33a1a2c4ffde7b538d10702a982024f97bf1c86660e`
...
- Marked-pixel bounds: (65,55)–(184,199); span 120 × 145 px; the marked
...
- 痕迹范围：(65,55)–(184,199)；跨度120 × 145 px；痕迹矩形高于宽。
