# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002364
...
- EVOBC candidate category: `evobc-evo-cat-02364`.
- Source label for search only: `宋`.
- Source codepoints for search only: `U+5B8B`.
