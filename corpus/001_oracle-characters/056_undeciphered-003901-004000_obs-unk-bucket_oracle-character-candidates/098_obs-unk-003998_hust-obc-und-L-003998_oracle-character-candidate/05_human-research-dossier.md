# obs-unk-003998 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/098_obs-unk-003998_h
  ust-obc-und-L-003998_oracle-character-candidate/03_visual-assets/001_asset
  -005591_hust-obc-und-L-003998_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3998/L_？_8461.jpg`
- asset id: `asset-005591`
...
- source class: `HUST-OBC/undeciphered/L/3998/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3998/L_？_8461.jpg`
- asset id: `asset-005591`
...
- English observation: The image shows a broad upper band with short vertical
  notches and curved or descending traces below, close to its adjacent record.
- 中文观察：图像显示较宽上部痕迹、短直立缺口及下方弯曲或下行痕迹，与相邻
  记录较为接近。
...
- Which source records identify obs-unk-003998 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003998？
