...
Project ID: `obs-evo-cand-012326`
...
- Project ID: `obs-evo-cand-012326`
- EVOBC category candidate ID: `evobc-evo-cat-12326`
- External category reference: `evobc-cat-12326`
- Source category ID: `12326`
- Source label for human review: `𨌎`
- Source codepoints: `U+2830E`
...
- `obs-evo-cand-012326-route-category-staging`
...
- `obs-evo-cand-012326-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012326-route-evolution-graph`
