# obs-unk-004098 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004098`
- primary external id: `hust-obc-und-L-004098`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/098_obs-unk-004098_h
  ust-obc-und-L-004098_oracle-character-candidate/03_visual-assets/001_asset
  -005691_hust-obc-und-L-004098_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4098/L_？_8816.jpg`
- asset id: `asset-005691`
...
- source class: `HUST-OBC/undeciphered/L/4098/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4098/L_？_8816.jpg`
- asset id: `asset-005691`
...
- English observation: A narrow central outline tapers toward the bottom,
  with thin upright traces on both sides. Short branched marks rise above the
  upper edge; the central joins and lower endpoint remain uncertain.
...
- Which source records identify obs-unk-004098 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004098？
