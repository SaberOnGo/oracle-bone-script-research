# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006451
...
- EVOBC candidate category: `evobc-evo-cat-06451`.
- Source label for search only: `納`.
- Source codepoints for search only: `U+7D0D`.
