...
- External category reference: `evobc-cat-11973`
- Source category ID: `11973`
- Source label for human review: `𦄵`
...
- `obs-evo-cand-011973-route-category-staging`
...
- `obs-evo-cand-011973-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011973-route-evolution-graph`
