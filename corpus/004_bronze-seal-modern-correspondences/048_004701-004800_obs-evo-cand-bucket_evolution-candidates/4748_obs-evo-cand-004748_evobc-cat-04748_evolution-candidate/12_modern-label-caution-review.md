# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004748
...
- EVOBC candidate category: `evobc-evo-cat-04748`.
- Source label for search only: `渊`.
- Source codepoints for search only: `U+6E0A`.
