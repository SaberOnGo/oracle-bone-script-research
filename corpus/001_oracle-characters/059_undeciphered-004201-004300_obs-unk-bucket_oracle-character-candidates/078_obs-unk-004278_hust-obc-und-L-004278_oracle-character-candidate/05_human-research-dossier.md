# obs-unk-004278 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/078_obs-unk-004278_h
  ust-obc-und-L-004278_oracle-character-candidate/03_visual-assets/001_asset
  -005871_hust-obc-und-L-004278_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4278/L_？_945.jpg`
- asset id: `asset-005871`
...
- source class: `HUST-OBC/undeciphered/L/4278/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4278/L_？_945.jpg`
- asset id: `asset-005871`
...
- English observation: `Crossing diagonals, lower mark, separated ends visible.`
- 中文观察: `交叉斜痕、下部短痕和分开的上端可见。`
...
- Which source records identify obs-unk-004278 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004278？
