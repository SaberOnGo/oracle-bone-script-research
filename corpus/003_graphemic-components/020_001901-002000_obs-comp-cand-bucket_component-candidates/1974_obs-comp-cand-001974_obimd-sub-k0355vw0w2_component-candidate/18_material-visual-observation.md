# Material Visual Observation / obs-comp-cand-001974 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001974`
- External reference / 外部参照: `obimd-sub-k0355vw0w2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018966_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/32g5flgua0/k0355vw0w2/k0355vw0w2.png`
- Checksum / 校验和:
  `fd3723df6a67da0d7fe0f3a68c4955ab339a58616f3361b45b6622616f4611e3`
...
- Marked-pixel bounds: (65,39)–(184,206); span 120 × 168 px; the marked
...
- 痕迹范围：(65,39)–(184,206)；跨度120 × 168 px；痕迹矩形高于宽。
