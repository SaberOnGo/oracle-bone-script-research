# Material Visual Observation / obs-comp-cand-000399 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000399`
- External reference / 外部参照: `obimd-sub-fpq0j1p9ii`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012322_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fpq0j1p9ii/fpq0j1p9ii/fpq0j1p9ii.png`
- Checksum / 校验和:
  `4a0b9d44cccda4f910a58dab2ea48be4199098daf6ceba441afac469ee874a0a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.44%.
- Marked-pixel bounds: (74,31)–(175,217); span 102 × 187 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.44%。
- 痕迹范围：(74,31)–(175,217)；跨度102 × 187 px；痕迹矩形高于宽。
