...
- External category reference: `evobc-cat-05161`
- Source category ID: `05161`
- Source label for human review: `燹`
- Source codepoints: `U+71F9`
...
- `obs-evo-cand-005161-route-category-staging`
...
- `obs-evo-cand-005161-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005161-route-evolution-graph`
