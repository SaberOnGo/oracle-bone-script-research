...
- Source page section: `Period III Group 11` /
  `第 III 期第 11 组`
- Source section key: `period-iii-group-11`
...
- Yingguo / 英国所藏: `y2333` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `312` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000455`
