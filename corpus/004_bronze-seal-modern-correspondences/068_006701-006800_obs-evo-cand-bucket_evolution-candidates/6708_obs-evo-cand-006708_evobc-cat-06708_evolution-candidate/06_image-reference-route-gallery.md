...
- `obs-evo-cand-006708-route-category-staging`
...
- `obs-evo-cand-006708-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006708-route-evolution-graph`
