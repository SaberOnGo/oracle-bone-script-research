# Material Visual Observation / obs-comp-cand-001711 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001711`
- External reference / 外部参照: `obimd-sub-ny2e8bby33`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017849_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ny2e8bby33/ny2e8bby33/4q0epoc6ir.png`
- Checksum / 校验和:
  `1d154daa798569fb81414dd975e3c4eba7e8b23fcf47a6a0f9b56a0876f4bddb`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.33%.
- Marked-pixel bounds: (91,41)–(158,204); span 68 × 164 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.33%。
- 痕迹范围：(91,41)–(158,204)；跨度68 × 164 px；痕迹矩形高于宽。
