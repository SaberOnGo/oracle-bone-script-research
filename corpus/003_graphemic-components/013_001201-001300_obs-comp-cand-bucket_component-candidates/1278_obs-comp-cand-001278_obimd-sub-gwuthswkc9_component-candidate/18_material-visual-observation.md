# Material Visual Observation / obs-comp-cand-001278 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001278`
- External reference / 外部参照: `obimd-sub-gwuthswkc9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015563_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gwuthswkc9/gwuthswkc9/gwuthswkc9.png`
- Checksum / 校验和:
  `bbac32323f5325b07417ea841f5d43fcc5ae8a485588c428fa860f5bdd4c7fb7`
...
- Marked-pixel bounds: (71,28)–(187,227); span 117 × 200 px; the marked
...
- 痕迹范围：(71,28)–(187,227)；跨度117 × 200 px；痕迹矩形高于宽。
