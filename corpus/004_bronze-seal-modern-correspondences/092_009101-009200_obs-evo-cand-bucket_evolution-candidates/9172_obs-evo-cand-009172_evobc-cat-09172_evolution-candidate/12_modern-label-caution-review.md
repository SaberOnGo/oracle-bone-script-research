# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-009172
...
- EVOBC candidate category: `evobc-evo-cat-09172`.
- Source label for search only: `郿`.
- Source codepoints for search only: `U+90FF`.
