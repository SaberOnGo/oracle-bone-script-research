# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006625
...
- EVOBC candidate category: `evobc-evo-cat-06625`.
- Source label for search only: `縋`.
- Source codepoints for search only: `U+7E0B`.
