# Material Visual Observation / obs-comp-cand-000562 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000562`
- External reference / 外部参照: `obimd-sub-yq9jsr6b1b`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012814_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bey28jrhwu/yq9jsr6b1b/yq9jsr6b1b.png`
- Checksum / 校验和:
  `c733499d5f9c16e09121940927feec8116b79a31addc5734c4d34f6067326c86`
...
- Marked-pixel bounds: (81,32)–(167,219); span 87 × 188 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.84%。
- 痕迹范围：(81,32)–(167,219)；跨度87 × 188 px；痕迹矩形高于宽。
