...
Project ID: `obs-evo-cand-007805`
...
- Project ID: `obs-evo-cand-007805`
- EVOBC category candidate ID: `evobc-evo-cat-07805`
- External category reference: `evobc-cat-07805`
- Source category ID: `07805`
- Source label for human review: `蝒`
- Source codepoints: `U+8752`
...
- `obs-evo-cand-007805-route-category-staging`
...
- `obs-evo-cand-007805-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007805-route-evolution-graph`
