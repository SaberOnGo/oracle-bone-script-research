...
- External category reference: `evobc-cat-04699`
- Source category ID: `04699`
- Source label for human review: `涸`
...
- `obs-evo-cand-004699-route-category-staging`
...
- `obs-evo-cand-004699-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004699-route-evolution-graph`
