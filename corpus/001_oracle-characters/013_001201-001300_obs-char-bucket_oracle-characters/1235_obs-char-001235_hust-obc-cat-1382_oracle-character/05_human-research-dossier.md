# obs-char-001235 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001235`
- primary external id: `hust-obc-cat-1382`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1235_obs-char-001235_hust-obc-cat-1382_ora
  cle-character/03_visual-assets/001_asset-001240_hust-obc-cat-1382_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1382/G_1382_合26898(甲).png`
- asset id: `asset-001240`
...
- source category: `1382`
- validation class: `1234`
- source image route: `HUST-OBC/deciphered/1382/G_1382_合26898(甲).png`
- asset id: `asset-001240`
...
- English observation: `A small upright form has a pointed upper tip, a
  central rounded enclosure, and a long lower rounded stroke.`
- 中文观察: `小型直立形体有尖状上端、中央圆弧框廓和长下部圆弧笔。`
...
- dataset label text: `㥜`
- dataset label codepoints: `U+395C`
...
- filename catalog route clues: `Heji-like filename clue: 合26898
  (G_1382_合26898(甲).png)`
...
- Which source records identify obs-char-001235 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001235？
