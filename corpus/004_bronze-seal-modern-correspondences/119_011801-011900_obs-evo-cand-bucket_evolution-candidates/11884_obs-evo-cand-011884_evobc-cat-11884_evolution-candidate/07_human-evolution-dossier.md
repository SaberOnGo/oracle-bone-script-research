...
Project ID: `obs-evo-cand-011884`
...
- Project ID: `obs-evo-cand-011884`
- EVOBC category candidate ID: `evobc-evo-cat-11884`
- External category reference: `evobc-cat-11884`
- Source category ID: `11884`
- Source label for human review: `𥯊`
- Source codepoints: `U+25BCA`
...
- `obs-evo-cand-011884-route-category-staging`
...
- `obs-evo-cand-011884-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011884-route-evolution-graph`
