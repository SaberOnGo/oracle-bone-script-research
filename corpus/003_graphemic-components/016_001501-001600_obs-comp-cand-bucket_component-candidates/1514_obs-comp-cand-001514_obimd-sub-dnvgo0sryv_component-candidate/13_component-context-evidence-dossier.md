# obs-comp-cand-001514 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001514`
- 首选外部 ID: `obimd-sub-dnvgo0sryv`
- OBIMD subcharacter UID: `dnvgo0sryv`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+F8C29; U+F8C2A; 另有 3 项
