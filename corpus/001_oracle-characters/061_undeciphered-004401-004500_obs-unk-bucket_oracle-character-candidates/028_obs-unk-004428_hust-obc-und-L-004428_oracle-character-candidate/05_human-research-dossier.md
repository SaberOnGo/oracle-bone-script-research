# obs-unk-004428 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004428`
- primary external id: `hust-obc-und-L-004428`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/028_obs-unk-004428_h
  ust-obc-und-L-004428_oracle-character-candidate/03_visual-assets/001_asset
  -006021_hust-obc-und-L-004428_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4428/L_？_9927.jpg`
- asset id: `asset-006021`
...
- source class: `HUST-OBC/undeciphered/L/4428/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4428/L_？_9927.jpg`
- asset id: `asset-006021`
...
- English observation: `A rounded upper trace leads to a stem and lower base.`
- 中文观察: `上部圆弧痕迹通向竖痕和下部底座轮廓。`
...
- Which source records identify obs-unk-004428 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004428？
