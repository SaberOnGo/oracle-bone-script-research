...
- External category reference: `evobc-cat-07113`
- Source category ID: `07113`
- Source label for human review: `腻`
- Source codepoints: `U+817B`
...
- `obs-evo-cand-007113-route-category-staging`
...
- `obs-evo-cand-007113-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007113-route-evolution-graph`
