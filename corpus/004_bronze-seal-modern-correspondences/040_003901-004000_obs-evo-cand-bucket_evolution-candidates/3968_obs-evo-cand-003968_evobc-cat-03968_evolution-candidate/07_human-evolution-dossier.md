...
- External category reference: `evobc-cat-03968`
- Source category ID: `03968`
- Source label for human review: `柧`
...
- `obs-evo-cand-003968-route-category-staging`
...
- `obs-evo-cand-003968-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003968-route-evolution-graph`
