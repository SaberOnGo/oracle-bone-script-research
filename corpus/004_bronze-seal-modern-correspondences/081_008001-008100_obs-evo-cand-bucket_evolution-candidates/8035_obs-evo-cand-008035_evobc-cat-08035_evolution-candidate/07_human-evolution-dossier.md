...
- External category reference: `evobc-cat-08035`
- Source category ID: `08035`
- Source label for human review: `襛`
...
- `obs-evo-cand-008035-route-category-staging`
...
- `obs-evo-cand-008035-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008035-route-evolution-graph`
