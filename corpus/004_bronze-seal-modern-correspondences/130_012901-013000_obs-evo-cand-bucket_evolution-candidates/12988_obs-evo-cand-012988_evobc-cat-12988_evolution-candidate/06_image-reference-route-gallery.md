...
- `obs-evo-cand-012988-route-category-staging`
...
- `obs-evo-cand-012988-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012988-route-evolution-graph`
