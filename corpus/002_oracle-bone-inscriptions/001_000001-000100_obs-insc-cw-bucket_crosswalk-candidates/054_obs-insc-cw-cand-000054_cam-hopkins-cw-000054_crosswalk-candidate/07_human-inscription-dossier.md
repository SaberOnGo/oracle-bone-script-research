...
Project ID: `obs-insc-cw-cand-000054`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000054`
...
- Source page section: `Period I Group 3` /
  `第 I 期第 3 组`
- Source section key: `period-i-group-3`
- Section declared count: `33`
- Section observed row count: `33`
...
- Yingguo / 英国所藏: `y353` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `134` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `699` in source row; primary catalog entry pending
- Heji / 合集: `39781` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000054`
