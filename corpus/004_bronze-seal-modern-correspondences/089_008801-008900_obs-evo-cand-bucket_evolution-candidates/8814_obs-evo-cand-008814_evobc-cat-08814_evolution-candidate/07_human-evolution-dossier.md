...
- External category reference: `evobc-cat-08814`
- Source category ID: `08814`
- Source label for human review: `軵`
...
- `obs-evo-cand-008814-route-category-staging`
...
- `obs-evo-cand-008814-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008814-route-evolution-graph`
