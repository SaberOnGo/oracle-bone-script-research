...
- External category reference: `evobc-cat-05618`
- Source category ID: `05618`
- Source label for human review: `疩`
- Source codepoints: `U+75A9`
...
- `obs-evo-cand-005618-route-category-staging`
...
- `obs-evo-cand-005618-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005618-route-evolution-graph`
