...
Project ID: `obs-evo-cand-001490`
...
- Project ID: `obs-evo-cand-001490`
- EVOBC category candidate ID: `evobc-evo-cat-01490`
- External category reference: `evobc-cat-01490`
- Source category ID: `01490`
- Source label for human review: `吂`
- Source codepoints: `U+5402`
...
- `obs-evo-cand-001490-route-category-staging`
...
- `obs-evo-cand-001490-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001490-route-evolution-graph`
