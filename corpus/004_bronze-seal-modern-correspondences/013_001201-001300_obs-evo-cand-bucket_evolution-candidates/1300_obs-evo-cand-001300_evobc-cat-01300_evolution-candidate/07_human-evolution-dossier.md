...
- Project ID: `obs-evo-cand-001300`
- EVOBC category candidate ID: `evobc-evo-cat-01300`
- External category reference: `evobc-cat-01300`
- Source category ID: `01300`
- Source label for human review: `勞`
- Source codepoints: `U+52DE`
...
- `obs-evo-cand-001300-route-category-staging`
...
- `obs-evo-cand-001300-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001300-route-evolution-graph`
