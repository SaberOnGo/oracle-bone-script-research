...
- External category reference: `evobc-cat-01623`
- Source category ID: `01623`
- Source label for human review: `啍`
- Source codepoints: `U+554D`
...
- `obs-evo-cand-001623-route-category-staging`
...
- `obs-evo-cand-001623-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001623-route-evolution-graph`
