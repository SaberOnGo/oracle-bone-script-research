# obs-char-001306 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001306`
- primary external id: `hust-obc-cat-1459`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1306_obs-char-001306_hust-obc-cat-1459_ora
  cle-character/03_visual-assets/001_asset-001311_hust-obc-cat-1459_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1459/G_1459_乙6690合22094午組.png`
- asset id: `asset-001311`
...
- source category: `1459`
- validation class: `1305`
- source image route: `HUST-OBC/deciphered/1459/G_1459_乙6690合22094午組.png`
- asset id: `asset-001311`
...
- English observation: `A compact angular form has a short upper bar, a
  central descending stem, and two curved side strokes.`
- 中文观察: `紧凑折角形体有短上横笔、中央下行笔干和两条侧向弧笔。`
...
- dataset label text: `㦩`
- dataset label codepoints: `U+39A9`
...
- Which source records identify obs-char-001306 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001306？
