...
- Project ID: `obs-evo-cand-000231`
- EVOBC category candidate ID: `evobc-evo-cat-00231`
- External category reference: `evobc-cat-00231`
- Source category ID: `00231`
- Source label for human review: `㹠`
- Source codepoints: `U+3E60`
...
- `obs-evo-cand-000231-route-category-staging`
...
- `obs-evo-cand-000231-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000231-route-evolution-graph`
