...
- External category reference: `evobc-cat-02905`
- Source category ID: `02905`
- Source label for human review: `忖`
- Source codepoints: `U+5FD6`
...
- `obs-evo-cand-002905-route-category-staging`
...
- `obs-evo-cand-002905-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002905-route-evolution-graph`
