...
- `obs-evo-cand-000584-route-category-staging`
...
- `obs-evo-cand-000584-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000584-route-evolution-graph`
