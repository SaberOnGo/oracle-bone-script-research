...
- Project ID: `obs-evo-cand-001485`
- EVOBC category candidate ID: `evobc-evo-cat-01485`
- External category reference: `evobc-cat-01485`
- Source category ID: `01485`
- Source label for human review: `叶`
- Source codepoints: `U+53F6`
...
- `obs-evo-cand-001485-route-category-staging`
...
- `obs-evo-cand-001485-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001485-route-evolution-graph`
