...
- Project ID: `obs-evo-cand-001097`
- EVOBC category candidate ID: `evobc-evo-cat-01097`
- External category reference: `evobc-cat-01097`
- Source category ID: `01097`
- Source label for human review: `兴`
- Source codepoints: `U+5174`
...
- `obs-evo-cand-001097-route-category-staging`
...
- `obs-evo-cand-001097-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001097-route-evolution-graph`
