# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010743
...
- EVOBC candidate category: `evobc-evo-cat-10743`.
- Source label for search only: `齿`.
- Source codepoints for search only: `U+9F7F`.
