...
- Project ID: `obs-evo-cand-003433`
- EVOBC category candidate ID: `evobc-evo-cat-03433`
- External category reference: `evobc-cat-03433`
- Source category ID: `03433`
- Source label for human review: `揠`
- Source codepoints: `U+63E0`
...
- `obs-evo-cand-003433-route-category-staging`
...
- `obs-evo-cand-003433-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003433-route-evolution-graph`
