# obs-unk-004039 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/039_obs-unk-004039_h
  ust-obc-und-L-004039_oracle-character-candidate/03_visual-assets/001_asset
  -005632_hust-obc-und-L-004039_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4039/L_？_8633.jpg`
- asset id: `asset-005632`
...
- source class: `HUST-OBC/undeciphered/L/4039/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4039/L_？_8633.jpg`
- asset id: `asset-005632`
...
- English observation: A branching or crossed trace sits above a lower rounded
  or wavy outline. A narrow central trace appears between the upper and lower
  areas. The crop does not show the complete side edges.
- 中文观察：上部有分叉或交叉痕迹，下方是圆弧或波曲轮廓；上下区域之间可见窄直中央
    痕迹。图像未显示两侧完整边缘。
...
- Which source records identify obs-unk-004039 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004039？
