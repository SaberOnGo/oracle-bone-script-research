# obs-unk-006706 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006706`
- primary external id: `hust-obc-und-X-006706`
...
- local review image route: `corpus/001_oracle-characters/084_undeciphered-006
  701-006800_obs-unk-bucket_oracle-character-candidates/006_obs-unk-006706_h
  ust-obc-und-X-006706_oracle-character-candidate/03_visual-assets/001_asset
  -008297_hust-obc-und-X-006706_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2262/X_？_900_1.png`
- asset id: `asset-008297`
...
- source class: `HUST-OBC/undeciphered/X/2262/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2262/X_？_900_1.png`
- asset id: `asset-008297`
...
- Which source records identify obs-unk-006706 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006706？
