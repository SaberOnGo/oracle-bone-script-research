...
- External category reference: `evobc-cat-02132`
- Source category ID: `02132`
- Source label for human review: `姡`
- Source codepoints: `U+59E1`
...
- `obs-evo-cand-002132-route-category-staging`
...
- `obs-evo-cand-002132-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002132-route-evolution-graph`
