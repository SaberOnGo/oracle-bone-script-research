# obs-unk-009072 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-009072`
- primary external id: `hust-obc-und-YH-009072`
...
- local review image route: `corpus/001_oracle-characters/107_undeciphered-009
  001-009100_obs-unk-bucket_oracle-character-candidates/072_obs-unk-009072_h
  ust-obc-und-YH-009072_oracle-character-candidate/03_visual-assets/001_asse
  t-010663_hust-obc-und-YH-009072_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6118B/H_？_6118B_0.png`
- asset id: `asset-010663`
...
- source class: `HUST-OBC/undeciphered/Y+H/6118B/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6118B/H_？_6118B_0.png`
- asset id: `asset-010663`
...
- Which source records identify obs-unk-009072 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009072？
