...
- `obs-evo-cand-008267-route-category-staging`
...
- `obs-evo-cand-008267-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008267-route-evolution-graph`
