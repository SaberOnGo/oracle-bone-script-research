# obs-char-000453 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000453`
- primary external id: `hust-obc-cat-0513`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/453_obs-char-000453_hust-obc-cat-0513_orac
  le-character/03_visual-assets/001_asset-000458_hust-obc-cat-0513_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0513/H_0513_602E7_0.png`
- asset id: `asset-000458`
...
- source category: `0513`
- validation class: `452`
- source image route: `HUST-OBC/deciphered/0513/H_0513_602E7_0.png`
- asset id: `asset-000458`
...
- English observation: `A bold broad form has a leaf-shaped upper enclosure,
  crossed diagonal arms, a wide curved middle, a lower outlined area, and
  long outer descending strokes.`
- 中文观察: `粗重大型形体上部有叶状围框，中部斜臂交叉并呈宽弧，下方有轮廓区域及两条外侧长下行笔。`
...
- dataset label text: `㗷`
- dataset label codepoints: `U+35F7`
...
- filename catalog route clues: `catalog-like filename clue: H_0513
  (H_0513_602E7_0.png)`
...
- Which source records identify obs-char-000453 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000453？
