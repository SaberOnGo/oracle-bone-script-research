# obs-unk-004743 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004743`
- primary external id: `hust-obc-und-X-004743`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/043_obs-unk-004743_h
  ust-obc-und-X-004743_oracle-character-candidate/03_visual-assets/001_asset
  -006336_hust-obc-und-X-004743_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/299/X_？_7283_1.png`
- asset id: `asset-006336`
...
- source class: `HUST-OBC/undeciphered/X/299/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/299/X_？_7283_1.png`
- asset id: `asset-006336`
- source image count: `9`
...
- English observation: `dense branching group with lower loop`
- 中文观察: `带下部长环状笔画的密集分支组`
...
- Which source records identify obs-unk-004743 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004743？
