# obs-char-000417 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000417`
- primary external id: `hust-obc-cat-0473`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/417_obs-char-000417_hust-obc-cat-0473_orac
  le-character/03_visual-assets/001_asset-000422_hust-obc-cat-0473_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0473/G_0473_佚445合14027𠂤賓間.png`
- asset id: `asset-000422`
...
- source category: `0473`
- validation class: `416`
- source image route: `HUST-OBC/deciphered/0473/G_0473_佚445合14027𠂤賓間.png`
- asset id: `asset-000422`
...
- English observation: `A narrow central diagonal form combines a small
  upper loop, a right forked stem, and several lower angular strokes.`
- 中文观察: `狭窄中央斜向形体连接小型上部环形、右侧分叉主干和数条下部折角笔画。`
...
- dataset label text: `㗏`
- dataset label codepoints: `U+35CF`
...
- filename catalog route clues: `Heji-like filename clue: 合14027
  (G_0473_佚445合14027𠂤賓間.png)`
...
- Which source records identify obs-char-000417 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000417？
