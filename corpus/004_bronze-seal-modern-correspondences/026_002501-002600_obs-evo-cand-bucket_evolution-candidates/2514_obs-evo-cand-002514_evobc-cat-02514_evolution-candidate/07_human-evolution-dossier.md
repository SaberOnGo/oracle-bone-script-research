...
- External category reference: `evobc-cat-02514`
- Source category ID: `02514`
- Source label for human review: `屠`
...
- `obs-evo-cand-002514-route-category-staging`
...
- `obs-evo-cand-002514-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002514-route-evolution-graph`
