...
- External category reference: `evobc-cat-02087`
- Source category ID: `02087`
- Source label for human review: `妝`
...
- `obs-evo-cand-002087-route-category-staging`
...
- `obs-evo-cand-002087-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002087-route-evolution-graph`
