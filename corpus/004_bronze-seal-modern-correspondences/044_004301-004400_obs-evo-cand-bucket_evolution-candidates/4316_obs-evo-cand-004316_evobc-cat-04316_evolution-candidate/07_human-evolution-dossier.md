...
- External category reference: `evobc-cat-04316`
- Source category ID: `04316`
- Source label: `櫝`
...
- `obs-evo-cand-004316-route-category-staging`
...
- `obs-evo-cand-004316-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-004316-route-evolution-graph`
