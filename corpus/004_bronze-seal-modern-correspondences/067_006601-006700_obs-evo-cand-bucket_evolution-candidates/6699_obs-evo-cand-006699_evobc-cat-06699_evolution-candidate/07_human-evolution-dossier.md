...
Project ID: `obs-evo-cand-006699`
...
- Project ID: `obs-evo-cand-006699`
- EVOBC category candidate ID: `evobc-evo-cat-06699`
- External category reference: `evobc-cat-06699`
- Source category ID: `06699`
- Source label for human review: `繼`
- Source codepoints: `U+7E7C`
...
- `obs-evo-cand-006699-route-category-staging`
...
- `obs-evo-cand-006699-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006699-route-evolution-graph`
