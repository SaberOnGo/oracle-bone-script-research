# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002703
...
| Glyph or codepoint route / 字形或码位路线 | 10 OBIMD route rows; examples U+FF3CA; U+FF3CB; 另有 8 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
