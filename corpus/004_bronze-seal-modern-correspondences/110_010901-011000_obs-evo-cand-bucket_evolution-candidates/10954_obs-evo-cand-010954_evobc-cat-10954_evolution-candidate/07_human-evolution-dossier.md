...
Project ID: `obs-evo-cand-010954`
...
- Project ID: `obs-evo-cand-010954`
- EVOBC category candidate ID: `evobc-evo-cat-10954`
- External category reference: `evobc-cat-10954`
- Source category ID: `10954`
- Source label for human review: `𠼌`
- Source codepoints: `U+20F0C`
...
- `obs-evo-cand-010954-route-category-staging`
...
- `obs-evo-cand-010954-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010954-route-evolution-graph`
