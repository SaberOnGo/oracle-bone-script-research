# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008702
...
- EVOBC candidate category: `evobc-evo-cat-08702`.
- Source label for search only: `趾`.
- Source codepoints for search only: `U+8DBE`.
