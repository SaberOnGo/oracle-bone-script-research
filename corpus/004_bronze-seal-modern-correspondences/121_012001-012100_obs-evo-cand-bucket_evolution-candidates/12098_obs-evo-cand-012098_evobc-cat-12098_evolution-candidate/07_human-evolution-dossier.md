...
Project ID: `obs-evo-cand-012098`
...
- Project ID: `obs-evo-cand-012098`
- EVOBC category candidate ID: `evobc-evo-cat-12098`
- External category reference: `evobc-cat-12098`
- Source category ID: `12098`
- Source label for human review: `𦰹`
- Source codepoints: `U+26C39`
...
- `obs-evo-cand-012098-route-category-staging`
...
- `obs-evo-cand-012098-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012098-route-evolution-graph`
