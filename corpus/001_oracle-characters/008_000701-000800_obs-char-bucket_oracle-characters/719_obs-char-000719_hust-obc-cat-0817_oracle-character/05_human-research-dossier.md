# obs-char-000719 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/719_obs-char-000719_hust-obc-cat-0817_orac
  le-character/03_visual-assets/001_asset-000724_hust-obc-cat-0817_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0817/G_0817_甲1222(甲).png`
- asset id: `asset-000724`
...
- source category: `0817`
- validation class: `718`
- source image route: `HUST-OBC/deciphered/0817/G_0817_甲1222(甲).png`
- asset id: `asset-000724`
...
- English observation: `A bold high-sided U-shaped outline has a central
  vertical descending from its base to a long separate-looking horizontal
  foot.`
...
- dataset label text: `㜧`
- dataset label codepoints: `U+3727`
...
- Which source records identify obs-char-000719 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000719？
