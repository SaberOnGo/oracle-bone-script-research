...
- External category reference: `evobc-cat-11790`
- Source category ID: `11790`
- Source label: `𥋓`
...
- `obs-evo-cand-011790-route-category-staging`
...
- `obs-evo-cand-011790-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011790-route-evolution-graph`
