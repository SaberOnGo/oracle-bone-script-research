...
- Project ID / 项目 ID: `obs-char-000978`
- Primary external ID / 首选外部 ID: `hust-obc-cat-1098`
...
- Source image / 来源图: `G_1098_甲骨文0.png`
- Image / 图像: `001_asset-000983_hust-obc-cat-1098_glyph.png`
...
- target node: `evobc-evo-cat-00091`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC image references / EvoBC 图像引用数: `11`
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/091_obs-evo-cand-000091_evobc-cat-00091_evoluti
...
- Source label text / 来源标签文字: `㡀`
- Source label codepoint / 来源标签 codepoint: `U+3840`
