# Material Visual Observation / obs-comp-cand-001611 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001611`
- External reference / 外部参照: `obimd-sub-yo5h3qdl2s`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017287_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/yo5h3qdl2s/yo5h3qdl2s/yo5h3qdl2s.png`
- Checksum / 校验和:
  `768f02a3c75b448bab5c93e3c4942b88baa5ba9093dab8d5466217f9e64919e1`
...
- Marked-pixel bounds: (88,24)–(161,226); span 74 × 203 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.91%。
- 痕迹范围：(88,24)–(161,226)；跨度74 × 203 px；痕迹矩形高于宽。
