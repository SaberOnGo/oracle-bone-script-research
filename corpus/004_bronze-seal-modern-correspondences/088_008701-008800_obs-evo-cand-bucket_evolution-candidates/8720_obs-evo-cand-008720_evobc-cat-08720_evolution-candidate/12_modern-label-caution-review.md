# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008720
...
- EVOBC candidate category: `evobc-evo-cat-08720`.
- Source label for search only: `跪`.
- Source codepoints for search only: `U+8DEA`.
