# obs-unk-004019 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004019`
- primary external id: `hust-obc-und-L-004019`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/019_obs-unk-004019_h
  ust-obc-und-L-004019_oracle-character-candidate/03_visual-assets/001_asset
  -005612_hust-obc-und-L-004019_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4019/L_？_8572.jpg`
- asset id: `asset-005612`
...
- source class: `HUST-OBC/undeciphered/L/4019/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4019/L_？_8572.jpg`
- asset id: `asset-005612`
...
- English observation: A branching upright trace rises from a lower angular
  outline. The lower outline has a curved base and an open upper edge, with
  short side traces visible near both sides. The crop is tight.
- 中文观察：一条向上分叉的直立痕迹从下部折角轮廓中升起；下部轮廓有弧形底边
    和开放上缘，左右附近可见短侧痕。图像裁切较紧。
...
- Which source records identify obs-unk-004019 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004019？
