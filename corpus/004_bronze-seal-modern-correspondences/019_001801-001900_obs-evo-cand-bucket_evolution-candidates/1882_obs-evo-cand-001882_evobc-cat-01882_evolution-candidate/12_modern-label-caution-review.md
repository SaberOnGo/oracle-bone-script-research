# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001882
...
- EVOBC candidate category: `evobc-evo-cat-01882`.
- Source label for search only: `埱`.
- Source codepoints for search only: `U+57F1`.
