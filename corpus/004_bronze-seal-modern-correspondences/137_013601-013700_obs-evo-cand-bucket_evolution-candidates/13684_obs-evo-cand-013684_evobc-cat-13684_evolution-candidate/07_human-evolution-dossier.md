...
- Project ID: `obs-evo-cand-013684`
- EVOBC category candidate ID: `evobc-evo-cat-13684`
- External category reference: `evobc-cat-13684`
- Source category ID: `13684`
- Source label for human review: `𮩀`
- Source codepoints: `U+2EA40`
...
- `obs-evo-cand-013684-route-category-staging`
...
- `obs-evo-cand-013684-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013684-route-evolution-graph`
