# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-011903
...
- EVOBC candidate category: `evobc-evo-cat-11903`.
- Source label for search only: `𥴊`.
- Source codepoints for search only: `U+25D0A`.
