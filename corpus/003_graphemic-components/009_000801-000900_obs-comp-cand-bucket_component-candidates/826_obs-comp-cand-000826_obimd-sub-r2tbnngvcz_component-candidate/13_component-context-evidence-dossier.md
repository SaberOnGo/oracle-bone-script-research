# obs-comp-cand-000826 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000826`
- 首选外部 ID: `obimd-sub-r2tbnngvcz`
- OBIMD subcharacter UID: `r2tbnngvcz`
- OBIMD main character UID: `r2tbnngvcz`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+5EFA;U+F4A86; U+F4A87
