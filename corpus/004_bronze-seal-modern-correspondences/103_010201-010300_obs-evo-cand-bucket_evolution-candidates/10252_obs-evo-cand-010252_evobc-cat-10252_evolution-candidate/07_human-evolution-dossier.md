...
Project ID: `obs-evo-cand-010252`
...
- Project ID: `obs-evo-cand-010252`
- EVOBC category candidate ID: `evobc-evo-cat-10252`
- External category reference: `evobc-cat-10252`
- Source category ID: `10252`
- Source label for human review: `驔`
- Source codepoints: `U+9A54`
...
- `obs-evo-cand-010252-route-category-staging`
...
- `obs-evo-cand-010252-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010252-route-evolution-graph`
