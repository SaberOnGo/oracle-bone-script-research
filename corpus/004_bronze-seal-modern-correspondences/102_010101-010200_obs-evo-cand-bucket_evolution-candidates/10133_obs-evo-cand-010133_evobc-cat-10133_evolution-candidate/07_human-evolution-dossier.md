...
- External category reference: `evobc-cat-10133`
- Source category ID: `10133`
- Source label for human review: `饐`
...
- `obs-evo-cand-010133-route-category-staging`
...
- `obs-evo-cand-010133-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010133-route-evolution-graph`
