# obs-unk-004644 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/044_obs-unk-004644_h
  ust-obc-und-X-004644_oracle-character-candidate/03_visual-assets/001_asset
  -006237_hust-obc-und-X-004644_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/200/X_？_8373_1.png`
- asset id: `asset-006237`
...
- source class: `HUST-OBC/undeciphered/X/200/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/200/X_？_8373_1.png`
- asset id: `asset-006237`
...
- English observation: `separated strokes with an angular center group`
- 中文观察: `含中央角状组的分离笔画`
...
- Which source records identify obs-unk-004644 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004644？
