...
- Project ID: `obs-evo-cand-002358`
- EVOBC category candidate ID: `evobc-evo-cat-02358`
- External category reference: `evobc-cat-02358`
- Source category ID: `02358`
- Source label for human review: `宄`
- Source codepoints: `U+5B84`
...
- `obs-evo-cand-002358-route-category-staging`
...
- `obs-evo-cand-002358-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002358-route-evolution-graph`
