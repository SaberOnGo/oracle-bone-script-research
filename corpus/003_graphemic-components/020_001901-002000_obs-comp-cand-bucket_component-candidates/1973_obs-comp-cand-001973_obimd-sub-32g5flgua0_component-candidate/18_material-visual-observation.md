# Material Visual Observation / obs-comp-cand-001973 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001973`
- External reference / 外部参照: `obimd-sub-32g5flgua0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018965_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/32g5flgua0/32g5flgua0/32g5flgua0.png`
- Checksum / 校验和:
  `2de81bfda45c32cf9600d55e3821830c10c5aad3e43865ce6285942e1acfab11`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.83%.
- Marked-pixel bounds: (61,37)–(188,209); span 128 × 173 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.83%。
- 痕迹范围：(61,37)–(188,209)；跨度128 × 173 px；痕迹矩形高于宽。
