...
Project ID: `obs-evo-cand-004353`
...
- Project ID: `obs-evo-cand-004353`
- EVOBC category candidate ID: `evobc-evo-cat-04353`
- External category reference: `evobc-cat-04353`
- Source category ID: `04353`
- Source label for human review: `欹`
- Source codepoints: `U+6B39`
...
- `obs-evo-cand-004353-route-category-staging`
...
- `obs-evo-cand-004353-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004353-route-evolution-graph`
