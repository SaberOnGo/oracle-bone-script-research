...
- External category reference: `evobc-cat-04040`
- Source category ID: `04040`
- Source label for human review: `桶`
...
- `obs-evo-cand-004040-route-category-staging`
...
- `obs-evo-cand-004040-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004040-route-evolution-graph`
