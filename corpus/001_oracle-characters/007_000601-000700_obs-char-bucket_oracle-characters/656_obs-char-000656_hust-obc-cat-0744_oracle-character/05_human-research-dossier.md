# obs-char-000656 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/656_obs-char-000656_hust-obc-cat-0744_orac
  le-character/03_visual-assets/001_asset-000661_hust-obc-cat-0744_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0744/G_0744_乙5323合6928賓組.png`
- asset id: `asset-000661`
...
- source category: `0744`
- validation class: `655`
- source image route: `HUST-OBC/deciphered/0744/G_0744_乙5323合6928賓組.png`
- asset id: `asset-000661`
...
- English observation: `Two detached narrow forms stand side by side: a
  crossed forked cluster at left and a tall right stem with top forks, a
  small middle loop, and split lower legs.`
...
- dataset label text: `㛞`
- dataset label codepoints: `U+36DE`
...
- filename catalog route clues: `Heji-like filename clue: 合6928
...
- Which source records identify obs-char-000656 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000656？
