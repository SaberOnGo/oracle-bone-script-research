# obs-char-001075 Archaeology Paleography Review

# obs-char-001075 考古文字复核档案
...
- first local image: `001_asset-001080_hust-obc-cat-1202_glyph.png`
- first source image: `G_1202_拾5.7(甲).png`
...
- source label text: `㢨`
- source label codepoints: `U+38A8`
