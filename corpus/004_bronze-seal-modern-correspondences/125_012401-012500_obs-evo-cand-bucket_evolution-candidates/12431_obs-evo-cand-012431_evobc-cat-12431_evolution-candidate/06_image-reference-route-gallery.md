...
- `obs-evo-cand-012431-route-category-staging`
...
- `obs-evo-cand-012431-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012431-route-evolution-graph`
