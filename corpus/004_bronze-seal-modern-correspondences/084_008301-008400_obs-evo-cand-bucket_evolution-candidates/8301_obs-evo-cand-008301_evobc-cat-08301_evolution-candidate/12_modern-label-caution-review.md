# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008301
...
- EVOBC candidate category: `evobc-evo-cat-08301`.
- Source label for search only: `諾`.
- Source codepoints for search only: `U+8AFE`.
