# Material Visual Observation / obs-comp-cand-001444 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001444`
- External reference / 外部参照: `obimd-sub-pmv7vsrzx3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016021_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/5n56p5znf0/pmv7vsrzx3/pmv7vsrzx3.png`
- Checksum / 校验和:
  `8d321b64da625d53c15f25820ec8fdb63ff8322d13441f9d190635109b0caeaa`
...
- Marked-pixel bounds: (48,23)–(216,223); span 169 × 201 px; the marked
...
- 痕迹范围：(48,23)–(216,223)；跨度169 × 201 px；痕迹矩形近方形。
