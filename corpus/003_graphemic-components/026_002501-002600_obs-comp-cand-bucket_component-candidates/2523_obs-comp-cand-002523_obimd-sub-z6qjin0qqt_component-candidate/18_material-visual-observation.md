# Material Visual Observation / obs-comp-cand-002523 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002523`
- External reference / 外部参照: `obimd-sub-z6qjin0qqt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020913_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/z6qjin0qqt/z6qjin0qqt/z6qjin0qqt.png`
- Checksum / 校验和:
  `69a2013d600487f88ffe491582e423f4067aa6752350f5e24d15978dee9a236f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.84%.
- Marked-pixel bounds: (79,20)–(160,222); span 82 × 203 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.84%。
- 痕迹范围：(79,20)–(160,222)；跨度82 × 203 px；痕迹矩形高于宽。
