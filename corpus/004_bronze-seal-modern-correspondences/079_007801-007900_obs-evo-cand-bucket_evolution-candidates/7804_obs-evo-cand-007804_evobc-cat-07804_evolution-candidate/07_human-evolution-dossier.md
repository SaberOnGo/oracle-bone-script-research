...
- External category reference: `evobc-cat-07804`
- Source category ID: `07804`
- Source label for human review: `蝎`
...
- `obs-evo-cand-007804-route-category-staging`
...
- `obs-evo-cand-007804-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007804-route-evolution-graph`
