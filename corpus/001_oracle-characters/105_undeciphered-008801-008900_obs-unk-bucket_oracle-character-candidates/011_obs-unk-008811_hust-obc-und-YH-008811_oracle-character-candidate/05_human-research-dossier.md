# obs-unk-008811 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008811`
- primary external id: `hust-obc-und-YH-008811`
...
- local review image route: `corpus/001_oracle-characters/105_undeciphered-008
  801-008900_obs-unk-bucket_oracle-character-candidates/011_obs-unk-008811_h
  ust-obc-und-YH-008811_oracle-character-candidate/03_visual-assets/001_asse
  t-010402_hust-obc-und-YH-008811_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60E3C/H_？_60E3C_0.png`
- asset id: `asset-010402`
...
- source class: `HUST-OBC/undeciphered/Y+H/60E3C/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60E3C/H_？_60E3C_0.png`
- asset id: `asset-010402`
...
- Which source records identify obs-unk-008811 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008811？
