...
- `obs-evo-cand-012722-route-category-staging`
...
- `obs-evo-cand-012722-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012722-route-evolution-graph`
