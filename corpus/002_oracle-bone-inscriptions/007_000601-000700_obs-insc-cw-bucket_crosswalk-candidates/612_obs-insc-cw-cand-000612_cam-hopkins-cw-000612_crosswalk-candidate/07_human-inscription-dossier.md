...
- Yingguo / 英国所藏: `ybu04` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: 待查: missing CUL reference in source row
- Chalfant / Chalfant 著录: `639` in source row; primary catalog entry pending
