...
- `obs-evo-cand-008492-route-category-staging`
...
- `obs-evo-cand-008492-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008492-route-evolution-graph`
