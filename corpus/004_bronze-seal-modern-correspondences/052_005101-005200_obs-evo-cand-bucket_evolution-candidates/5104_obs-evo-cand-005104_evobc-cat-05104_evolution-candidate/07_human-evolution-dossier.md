...
Project ID: `obs-evo-cand-005104`
...
- Project ID: `obs-evo-cand-005104`
- EVOBC category candidate ID: `evobc-evo-cat-05104`
- External category reference: `evobc-cat-05104`
- Source category ID: `05104`
- Source label for human review: `煎`
- Source codepoints: `U+714E`
...
- `obs-evo-cand-005104-route-category-staging`
...
- `obs-evo-cand-005104-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005104-route-evolution-graph`
