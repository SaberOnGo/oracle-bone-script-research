...
- External category reference: `evobc-cat-12529`
- Source category ID: `12529`
- Source label for human review: `𨽺`
- Source codepoints: `U+28F7A`
...
- `obs-evo-cand-012529-route-category-staging`
...
- `obs-evo-cand-012529-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012529-route-evolution-graph`
