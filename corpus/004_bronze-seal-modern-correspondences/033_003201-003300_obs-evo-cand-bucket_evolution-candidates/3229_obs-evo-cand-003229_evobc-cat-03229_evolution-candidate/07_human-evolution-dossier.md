...
Project ID: `obs-evo-cand-003229`
...
- Project ID: `obs-evo-cand-003229`
- EVOBC category candidate ID: `evobc-evo-cat-03229`
- External category reference: `evobc-cat-03229`
- Source category ID: `03229`
- Source label for human review: `户`
- Source codepoints: `U+6237`
...
- `obs-evo-cand-003229-route-category-staging`
...
- `obs-evo-cand-003229-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003229-route-evolution-graph`
