# obs-char-000685 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000685`
- primary external id: `hust-obc-cat-0776`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/685_obs-char-000685_hust-obc-cat-0776_orac
  le-character/03_visual-assets/001_asset-000690_hust-obc-cat-0776_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0776/G_0776_乙6686合9012.png`
- asset id: `asset-000690`
...
- source category: `0776`
- validation class: `684`
- source image route: `HUST-OBC/deciphered/0776/G_0776_乙6686合9012.png`
- asset id: `asset-000690`
...
- English observation: `A long slanting stem with a small crossed spur at
  the top bends toward a rounded angular loop on its lower right, leaving a
  broad white opening.`
...
- dataset label text: `㛾`
- dataset label codepoints: `U+36FE`
...
- filename catalog route clues: `Heji-like filename clue: 合9012
...
- Which source records identify obs-char-000685 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000685？
