...
- `obs-evo-cand-012438-route-category-staging`
...
- `obs-evo-cand-012438-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012438-route-evolution-graph`
