# obs-evo-cand-011313 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-011313`
- EVOBC category candidate ID: `evobc-evo-cat-11313`
- External category ref: `evobc-cat-11313`
- Source label: `𢱭`
- Source codepoints: `U+22C6D`
- Image reference count: `118`
- Era token counts: `BI:105;WSC:13`
- Source token counts: `Book:118`

## Observed Code Rows / 观察到的代码行

- era 1 / BI: 105 image references
- era 4 / WSC: 13 image references
- source 3 / Book:21681: 105 image references
