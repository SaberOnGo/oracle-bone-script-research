...
- `obs-evo-cand-002601-route-category-staging`
...
- `obs-evo-cand-002601-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002601-route-evolution-graph`
