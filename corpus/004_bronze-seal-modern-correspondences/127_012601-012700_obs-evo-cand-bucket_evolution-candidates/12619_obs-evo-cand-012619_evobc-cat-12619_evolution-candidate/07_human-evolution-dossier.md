...
- Project ID: `obs-evo-cand-012619`
- EVOBC category candidate ID: `evobc-evo-cat-12619`
- External category reference: `evobc-cat-12619`
- Source category ID: `12619`
- Source label for human review: `𩕾`
- Source codepoints: `U+2957E`
- Image reference count in source metadata: `6`
...
- `obs-evo-cand-012619-route-category-staging`
...
- `obs-evo-cand-012619-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012619-route-evolution-graph`
