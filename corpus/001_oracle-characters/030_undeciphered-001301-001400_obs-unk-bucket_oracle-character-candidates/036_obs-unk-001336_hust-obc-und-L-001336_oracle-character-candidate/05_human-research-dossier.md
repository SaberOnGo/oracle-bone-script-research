# obs-unk-001336 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-001336`
- primary external id: `hust-obc-und-L-001336`
...
- local review image route: `corpus/001_oracle-characters/030_undeciphered-001
  301-001400_obs-unk-bucket_oracle-character-candidates/036_obs-unk-001336_h
  ust-obc-und-L-001336_oracle-character-candidate/03_visual-assets/001_asset
  -002929_hust-obc-und-L-001336_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/1336/L_？_1379.jpg`
- asset id: `asset-002929`
...
- source class: `HUST-OBC/undeciphered/L/1336/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/1336/L_？_1379.jpg`
- asset id: `asset-002929`
...
- Which source records identify obs-unk-001336 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-001336？
