...
- `obs-evo-cand-012876-route-category-staging`
...
- `obs-evo-cand-012876-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012876-route-evolution-graph`
