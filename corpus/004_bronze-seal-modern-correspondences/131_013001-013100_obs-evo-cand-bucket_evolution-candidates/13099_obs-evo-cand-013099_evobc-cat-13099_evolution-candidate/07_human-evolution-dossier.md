...
Project ID: `obs-evo-cand-013099`
...
- Project ID: `obs-evo-cand-013099`
- EVOBC category candidate ID: `evobc-evo-cat-13099`
- External category reference: `evobc-cat-13099`
- Source category ID: `13099`
- Source label for human review: `𫳧`
- Source codepoints: `U+2BCE7`
...
- `obs-evo-cand-013099-route-category-staging`
...
- `obs-evo-cand-013099-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013099-route-evolution-graph`
