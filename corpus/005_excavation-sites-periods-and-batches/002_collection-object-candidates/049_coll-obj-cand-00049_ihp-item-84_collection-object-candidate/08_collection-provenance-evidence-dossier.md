# Collection Provenance Evidence Dossier / 馆藏来源证据档案: coll-obj-cand-00049
...
| source_row_id | `49` |
| object_page_url | `https://museum.sinica.edu.tw/en/collection/32/item/84/` |
...
| asset_id | `` |
| asset_path | `` |
| thumbnail_url | `https://museum.sinica.edu.tw/_upload/image/collection_item/thumbnail/dc1169455341.jpg` |
| source_image_url | `` |
...
| `source_collection_item_id` | `84` |
| `object_title_en` | `Inscribed Animal Bone Fragment I 8672` |
| `catalog_reference_text` | `I 8672` |
| `accession_number` | `` |
| `historical_period` | `` |
| `object_date` | `` |
| `provenience` | `` |
