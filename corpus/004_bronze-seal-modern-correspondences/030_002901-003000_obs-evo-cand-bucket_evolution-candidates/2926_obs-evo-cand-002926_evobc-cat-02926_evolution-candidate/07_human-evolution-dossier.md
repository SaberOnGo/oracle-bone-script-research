...
- Project ID: `obs-evo-cand-002926`
- EVOBC category candidate ID: `evobc-evo-cat-02926`
- External category reference: `evobc-cat-02926`
- Source category ID: `02926`
- Source label for human review: `忿`
- Source codepoints: `U+5FFF`
...
- `obs-evo-cand-002926-route-category-staging`
...
- `obs-evo-cand-002926-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002926-route-evolution-graph`
