...
Project ID: `obs-evo-cand-003634`
...
- Project ID: `obs-evo-cand-003634`
- EVOBC category candidate ID: `evobc-evo-cat-03634`
- External category reference: `evobc-cat-03634`
- Source category ID: `03634`
- Source label for human review: `斝`
- Source codepoints: `U+659D`
...
- `obs-evo-cand-003634-route-category-staging`
...
- `obs-evo-cand-003634-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003634-route-evolution-graph`
