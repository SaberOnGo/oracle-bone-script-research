...
Project ID: `obs-evo-cand-004808`
...
- Project ID: `obs-evo-cand-004808`
- EVOBC category candidate ID: `evobc-evo-cat-04808`
- External category reference: `evobc-cat-04808`
- Source category ID: `04808`
- Source label for human review: `準`
- Source codepoints: `U+6E96`
...
- `obs-evo-cand-004808-route-category-staging`
...
- `obs-evo-cand-004808-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004808-route-evolution-graph`
