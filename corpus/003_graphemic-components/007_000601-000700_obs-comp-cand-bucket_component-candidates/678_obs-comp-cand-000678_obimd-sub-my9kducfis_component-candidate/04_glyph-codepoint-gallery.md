# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000678
...
| --- | --- | --- | --- |
| `obimd-glyph-link-009933` | 替󳹥 | `U+66FF;U+F3E65` | `reviewed_metadata_only` |
| `obimd-glyph-link-009934` | 󳹦 | `U+F3E66` | `reviewed_metadata_only` |
