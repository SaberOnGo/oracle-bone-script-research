...
- External category reference: `evobc-cat-06442`
- Source category ID: `06442`
...
- `obs-evo-cand-006442-route-category-staging`
...
- `obs-evo-cand-006442-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006442-route-evolution-graph`
