...
- External category reference: `evobc-cat-05402`
- Source category ID: `05402`
- Source label for human review: `理`
- Source codepoints: `U+7406`
...
- `obs-evo-cand-005402-route-category-staging`
...
- `obs-evo-cand-005402-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005402-route-evolution-graph`
