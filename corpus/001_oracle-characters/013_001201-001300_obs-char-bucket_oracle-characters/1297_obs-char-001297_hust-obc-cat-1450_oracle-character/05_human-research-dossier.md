# obs-char-001297 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001297`
- primary external id: `hust-obc-cat-1450`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1297_obs-char-001297_hust-obc-cat-1450_ora
  cle-character/03_visual-assets/001_asset-001302_hust-obc-cat-1450_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1450/G_1450_乙768合17230賓組.png`
- asset id: `asset-001302`
...
- source category: `1450`
- validation class: `1296`
- source image route: `HUST-OBC/deciphered/1450/G_1450_乙768合17230賓組.png`
- asset id: `asset-001302`
...
- English observation: `A simple branching form has a central stem, two
  upper arms, a long right cross-stroke, and paired lower curves.`
- 中文观察: `简洁分枝形体有中央笔干、两条上部支臂、长右侧横笔和成对下部弧线。`
...
- dataset label text: `㦠`
- dataset label codepoints: `U+39A0`
...
- filename catalog route clues: `Heji-like filename clue: 合17230
...
- Which source records identify obs-char-001297 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001297？
