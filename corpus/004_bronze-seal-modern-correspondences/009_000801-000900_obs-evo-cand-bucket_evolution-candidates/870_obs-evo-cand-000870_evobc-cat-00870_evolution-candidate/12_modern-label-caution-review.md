# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000870
...
- EVOBC candidate category: `evobc-evo-cat-00870`.
- Source label for search only: `便`.
- Source codepoints for search only: `U+4FBF`.
