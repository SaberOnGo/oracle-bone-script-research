# Material Visual Observation / obs-comp-cand-002143 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002143`
- External reference / 外部参照: `obimd-sub-vv49yzcfqq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019731_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6x8v1c8903/vv49yzcfqq/vv49yzcfqq.png`
- Checksum / 校验和:
  `c769626dc434125501c3c6881615a4bbbbab256059005bd03c8658d395b363cc`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.02%.
- Marked-pixel bounds: (80,45)–(169,199); span 90 × 155 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.02%。
- 痕迹范围：(80,45)–(169,199)；跨度90 × 155 px；痕迹矩形高于宽。
