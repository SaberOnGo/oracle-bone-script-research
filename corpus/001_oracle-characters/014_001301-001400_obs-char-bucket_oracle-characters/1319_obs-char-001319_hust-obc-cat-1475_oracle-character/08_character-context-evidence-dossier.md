...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1475`
...
- Source image / 来源图: `X_1475_770_1.png`
- Image / 图像: `001_asset-001324_hust-obc-cat-1475_glyph.png`
...
- target node: `evobc-evo-cat-00140`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC image references / EvoBC 图像引用数: `16`
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/140_obs-evo-cand-000140_evobc-cat-00140_evoluti
...
- Source label text / 来源标签文字: `㦹`
- Source label codepoint / 来源标签 codepoint: `U+39B9`
