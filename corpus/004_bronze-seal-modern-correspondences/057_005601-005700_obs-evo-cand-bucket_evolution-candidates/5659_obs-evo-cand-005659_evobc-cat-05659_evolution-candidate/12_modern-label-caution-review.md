# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-005659
...
- EVOBC candidate category: `evobc-evo-cat-05659`.
- Source label for search only: `痿`.
- Source codepoints for search only: `U+75FF`.
