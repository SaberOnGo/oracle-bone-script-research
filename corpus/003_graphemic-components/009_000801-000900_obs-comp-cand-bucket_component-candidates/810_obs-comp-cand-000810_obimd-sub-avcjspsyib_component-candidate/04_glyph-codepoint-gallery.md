# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000810
...
| --- | --- | --- | --- |
| `obimd-glyph-link-011688` | 㲻󴤣 | `U+3CBB;U+F4923` | `reviewed_metadata_only` |
| `obimd-glyph-link-011689` | 󴤤 | `U+F4924` | `reviewed_metadata_only` |
