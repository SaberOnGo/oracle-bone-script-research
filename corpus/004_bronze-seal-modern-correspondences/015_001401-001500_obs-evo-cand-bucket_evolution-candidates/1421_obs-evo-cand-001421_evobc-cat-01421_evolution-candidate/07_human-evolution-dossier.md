...
- External category reference: `evobc-cat-01421`
- Source category ID: `01421`
- Source label: `厖`
...
- `obs-evo-cand-001421-route-category-staging`
...
- `obs-evo-cand-001421-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001421-route-evolution-graph`
