...
- External category reference: `evobc-cat-12324`
- Source category ID: `12324`
- Source label for human review: `𨌁`
...
- `obs-evo-cand-012324-route-category-staging`
...
- `obs-evo-cand-012324-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012324-route-evolution-graph`
