# obs-evo-cand-003589 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-003589`
- EVOBC category candidate ID: `evobc-evo-cat-03589`
- External category ref: `evobc-cat-03589`
- Source label: `教`
- Source codepoints: `U+6559`
- Image reference count: `163`
- Era token counts: `BI:14;CS:1;OBC:51;SAC:3;SS:4;WSC:90`
- Source token counts: `Book:51;Web:112`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 51 image references
- era 1 / BI: 14 image references
