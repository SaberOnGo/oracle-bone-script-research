...
- External category reference: `evobc-cat-06037`
- Source category ID: `06037`
- Source label: `禰`
...
- `obs-evo-cand-006037-route-category-staging`
...
- `obs-evo-cand-006037-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006037-route-evolution-graph`
