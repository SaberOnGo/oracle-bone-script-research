...
Project ID: `obs-evo-cand-000016`
...
- Project ID: `obs-evo-cand-000016`
- EVOBC category candidate ID: `evobc-evo-cat-00016`
- External category reference: `evobc-cat-00016`
- Source category ID: `00016`
- Source label for human review: `㒳`
- Source codepoints: `U+34B3`
...
- `obs-evo-cand-000016-route-category-staging`
...
- `obs-evo-cand-000016-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000016-route-evolution-graph`
