# obs-char-001577 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001577`
- primary external id: `hust-obc-cat-1769`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1577_obs-char-001577_hust-obc-cat-1769_ora
  cle-character/03_visual-assets/001_asset-001582_hust-obc-cat-1769_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1769/G_1769_佚226背(甲).png`
- asset id: `asset-001582`
...
- source category: `1769`
- validation class: `1576`
- source image route: `HUST-OBC/deciphered/1769/G_1769_佚226背(甲).png`
- asset id: `asset-001582`
...
- English observation: `A broad bent enclosure has segmented upper strokes
  and a rectangular lower extension.`
- 中文观察: `宽大的弯折框形有分段上部笔画和矩形下部延伸。`
...
- dataset label text: `㫟`
- dataset label codepoints: `U+3ADF`
...
- Which source records identify obs-char-001577 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001577？
