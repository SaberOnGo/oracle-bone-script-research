# obs-char-001317 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001317`
- primary external id: `hust-obc-cat-1473`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1317_obs-char-001317_hust-obc-cat-1473_ora
  cle-character/03_visual-assets/001_asset-001322_hust-obc-cat-1473_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1473/G_1473_乙1075合878.png`
- asset id: `asset-001322`
...
- source category: `1473`
- validation class: `1316`
- source image route: `HUST-OBC/deciphered/1473/G_1473_乙1075合878.png`
- asset id: `asset-001322`
...
- English observation: `A narrow image contains an upper leaf-like curve and
  a separate small lower hooked mark.`
- 中文观察: `狭长图像中有上部叶状弧线和一个分离的小型下部钩状标记。`
...
- dataset label text: `㦷`
- dataset label codepoints: `U+39B7`
...
- filename catalog route clues: `Heji-like filename clue: 合878
  (G_1473_乙1075合878.png)`
...
- Which source records identify obs-char-001317 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001317？
