# obs-unk-008072 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/097_undeciphered-008
  001-008100_obs-unk-bucket_oracle-character-candidates/072_obs-unk-008072_h
  ust-obc-und-YH-008072_oracle-character-candidate/03_visual-assets/001_asse
  t-009663_hust-obc-und-YH-008072_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/606C8/H_？_606C8_0.png`
- asset id: `asset-009663`
...
- source class: `HUST-OBC/undeciphered/Y+H/606C8/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/606C8/H_？_606C8_0.png`
- asset id: `asset-009663`
...
- Which source records identify obs-unk-008072 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008072？
