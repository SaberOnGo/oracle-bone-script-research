# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-000309
...
- candidate_component_id: `obs-comp-cand-000309`
- primary_external_ref_id: `obimd-sub-h204u5h9ms`
- source_subcharacter_uid: `h204u5h9ms`
- source_main_character_uid: `h204u5h9ms`
- main_character_external_ref_id: `obimd-main-h204u5h9ms`
...
- glyph_codepoint_uplus_sample: `U+7261;U+F1C6D, U+F1C6E, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-012171` | `001_asset-012171_img.png` | `84af335e539b6d6f72224bfa77dc07e951356655a50c8e1246d6a06719c7b7f8` |
