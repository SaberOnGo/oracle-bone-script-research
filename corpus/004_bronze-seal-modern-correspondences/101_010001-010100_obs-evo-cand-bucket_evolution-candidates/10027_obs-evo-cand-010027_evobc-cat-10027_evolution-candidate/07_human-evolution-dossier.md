...
- External category reference: `evobc-cat-10027`
- Source category ID: `10027`
- Source label for human review: `顝`
...
- `obs-evo-cand-010027-route-category-staging`
...
- `obs-evo-cand-010027-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010027-route-evolution-graph`
