...
Project ID: `obs-evo-cand-000598`
...
- Project ID: `obs-evo-cand-000598`
- EVOBC category candidate ID: `evobc-evo-cat-00598`
- External category reference: `evobc-cat-00598`
- Source category ID: `00598`
- Source label for human review: `䶐`
- Source codepoints: `U+4D90`
...
- `obs-evo-cand-000598-route-category-staging`
...
- `obs-evo-cand-000598-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000598-route-evolution-graph`
