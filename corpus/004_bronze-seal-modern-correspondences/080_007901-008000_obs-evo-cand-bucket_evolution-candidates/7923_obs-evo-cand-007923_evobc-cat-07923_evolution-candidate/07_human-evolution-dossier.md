...
- External category reference: `evobc-cat-07923`
- Source category ID: `07923`
- Source label for human review: `衫`
- Source codepoints: `U+886B`
...
- `obs-evo-cand-007923-route-category-staging`
...
- `obs-evo-cand-007923-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007923-route-evolution-graph`
