# Material Visual Observation / obs-comp-cand-001087 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001087`
- External reference / 外部参照: `obimd-sub-fmdym8mxmv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014830_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fmdym8mxmv/fmdym8mxmv/02wtarisug.png`
- Checksum / 校验和:
  `8f28700c8b22ee72c7c14301708852451ccf802cfe6c2e9d7375714e132a21d9`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.96%.
- Marked-pixel bounds: (90,45)–(159,204); span 70 × 160 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.96%。
- 痕迹范围：(90,45)–(159,204)；跨度70 × 160 px；痕迹矩形高于宽。
