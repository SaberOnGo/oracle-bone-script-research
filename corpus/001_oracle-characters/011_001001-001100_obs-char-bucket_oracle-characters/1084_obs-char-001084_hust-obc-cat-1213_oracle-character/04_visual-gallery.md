# obs-char-001084 Visual Gallery / obs-char-001084 图像资料页
...
- Project ID / 项目 ID: `obs-char-001084`
- Primary external reference / 首选外部参考: `hust-obc-cat-1213`
...
## obs-char-001084-visual-source-001 / 图像条目

![obs-char-001084 glyph candidate](03_visual-assets/001_asset-001089_hust-obc-cat-1213_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-001089_hust-obc-cat-1213_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-001089_hust-obc-cat-1213_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/1213/G_1213_佚722(甲).png`
