...
- Project ID: `obs-evo-cand-004171`
- EVOBC category candidate ID: `evobc-evo-cat-04171`
- External category reference: `evobc-cat-04171`
- Source category ID: `04171`
- Source label for human review: `楷`
- Source codepoints: `U+6977`
...
- `obs-evo-cand-004171-route-category-staging`
...
- `obs-evo-cand-004171-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004171-route-evolution-graph`
