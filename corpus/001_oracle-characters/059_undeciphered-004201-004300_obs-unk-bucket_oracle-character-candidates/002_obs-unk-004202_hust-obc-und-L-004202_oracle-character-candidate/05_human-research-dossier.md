# obs-unk-004202 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004202`
- primary external id: `hust-obc-und-L-004202`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/002_obs-unk-004202_h
  ust-obc-und-L-004202_oracle-character-candidate/03_visual-assets/001_asset
  -005795_hust-obc-und-L-004202_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4202/L_？_9153.jpg`
- asset id: `asset-005795`
...
- source class: `HUST-OBC/undeciphered/L/4202/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4202/L_？_9153.jpg`
- asset id: `asset-005795`
...
- English observation: `Upper slants, dark middle mark, and lower extensions.`
- 中文观察: `上部斜笔画、较深中部痕迹和下部外伸笔画可见。`
...
- Which source records identify obs-unk-004202 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004202？
