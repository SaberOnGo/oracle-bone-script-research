...
- Project ID: `obs-evo-cand-000934`
- EVOBC category candidate ID: `evobc-evo-cat-00934`
- External category reference: `evobc-cat-00934`
- Source category ID: `00934`
- Source label for human review: `倢`
- Source codepoints: `U+5022`
...
- `obs-evo-cand-000934-route-category-staging`
...
- `obs-evo-cand-000934-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000934-route-evolution-graph`
