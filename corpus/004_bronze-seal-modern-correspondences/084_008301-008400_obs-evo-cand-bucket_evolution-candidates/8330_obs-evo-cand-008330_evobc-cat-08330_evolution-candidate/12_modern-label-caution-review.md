# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008330
...
- EVOBC candidate category: `evobc-evo-cat-08330`.
- Source label for search only: `謬`.
- Source codepoints for search only: `U+8B2C`.
