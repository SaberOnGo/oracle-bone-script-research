...
Project ID: `obs-evo-cand-009762`
...
- Project ID: `obs-evo-cand-009762`
- EVOBC category candidate ID: `evobc-evo-cat-09762`
- External category reference: `evobc-cat-09762`
- Source category ID: `09762`
- Source label for human review: `隆`
- Source codepoints: `U+9686`
...
- `obs-evo-cand-009762-route-category-staging`
...
- `obs-evo-cand-009762-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009762-route-evolution-graph`
