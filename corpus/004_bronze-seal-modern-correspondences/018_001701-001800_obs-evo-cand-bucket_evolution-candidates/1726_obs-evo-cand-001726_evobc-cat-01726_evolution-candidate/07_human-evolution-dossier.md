...
- External category reference: `evobc-cat-01726`
- Source category ID: `01726`
- Source label for human review: `噭`
...
- `obs-evo-cand-001726-route-category-staging`
...
- `obs-evo-cand-001726-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001726-route-evolution-graph`
