...
- External category reference: `evobc-cat-12414`
- Source category ID: `12414`
- Source label for human review: `𨚮`
- Source codepoints: `U+286AE`
...
- `obs-evo-cand-012414-route-category-staging`
...
- `obs-evo-cand-012414-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012414-route-evolution-graph`
