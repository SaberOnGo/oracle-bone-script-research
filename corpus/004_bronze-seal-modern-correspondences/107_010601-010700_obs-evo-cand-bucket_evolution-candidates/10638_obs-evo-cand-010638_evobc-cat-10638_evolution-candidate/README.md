# obs-evo-cand-010638 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-10638`
- Source label for human review: `黍`
- Source codepoints: `U+9ECD`
- Image reference count: `191`
- Era token counts: `BI:4;CS:3;OBC:165;SS:2;WSC:17`
- Source token counts: `Book:57;Web:134`
