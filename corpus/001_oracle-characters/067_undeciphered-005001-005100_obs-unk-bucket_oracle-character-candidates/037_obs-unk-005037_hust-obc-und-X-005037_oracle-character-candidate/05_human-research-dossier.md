# obs-unk-005037 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005037`
- primary external id: `hust-obc-und-X-005037`
...
- local review image route: `corpus/001_oracle-characters/067_undeciphered-005
  001-005100_obs-unk-bucket_oracle-character-candidates/037_obs-unk-005037_h
  ust-obc-und-X-005037_oracle-character-candidate/03_visual-assets/001_asset
  -006630_hust-obc-und-X-005037_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/593/X_？_7138_1.png`
- asset id: `asset-006630`
...
- source class: `HUST-OBC/undeciphered/X/593/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/593/X_？_7138_1.png`
- asset id: `asset-006630`
