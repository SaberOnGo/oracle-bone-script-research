...
- Yingguo / 英国所藏: `y1282` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `22` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `502` in source row; primary catalog entry pending
- Heji / 合集: `40525` in source row; primary catalog entry pending
