...
- Project ID: `obs-evo-cand-004952`
- EVOBC category candidate ID: `evobc-evo-cat-04952`
- External category reference: `evobc-cat-04952`
- Source category ID: `04952`
- Source label for human review: `激`
- Source codepoints: `U+6FC0`
...
- `obs-evo-cand-004952-route-category-staging`
...
- `obs-evo-cand-004952-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004952-route-evolution-graph`
