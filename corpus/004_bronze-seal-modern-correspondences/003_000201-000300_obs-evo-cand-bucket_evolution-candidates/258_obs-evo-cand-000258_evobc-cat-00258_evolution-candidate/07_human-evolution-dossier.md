...
- Project ID: `obs-evo-cand-000258`
- EVOBC category candidate ID: `evobc-evo-cat-00258`
- External category reference: `evobc-cat-00258`
- Source category ID: `00258`
- Source label for human review: `㾒`
- Source codepoints: `U+3F92`
...
- `obs-evo-cand-000258-route-category-staging`
...
- `obs-evo-cand-000258-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000258-route-evolution-graph`
