# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001001
...
- EVOBC candidate category: `evobc-evo-cat-01001`.
- Source label for search only: `傿`.
- Source codepoints for search only: `U+50BF`.
