...
- Project ID: `obs-evo-cand-011036`
- EVOBC category candidate ID: `evobc-evo-cat-11036`
- External category reference: `evobc-cat-11036`
- Source category ID: `11036`
- Source label for human review: `𡜁`
- Source codepoints: `U+21701`
...
- `obs-evo-cand-011036-route-category-staging`
...
- `obs-evo-cand-011036-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011036-route-evolution-graph`
