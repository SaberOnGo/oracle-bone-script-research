# Material Visual Observation / obs-comp-cand-002493 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002493`
- External reference / 外部参照: `obimd-sub-p77d58vew4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020715_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/p77d58vew4/p77d58vew4/p77d58vew4.png`
- Checksum / 校验和:
  `cb6e494f727faa9055e867357b6964a258063c5283ec7a82bcfe5e531c0bdc2c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.94%.
- Marked-pixel bounds: (63,77)–(184,176); span 122 × 100 px; the marked
  rectangle is wider than tall.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.94%。
- 痕迹范围：(63,77)–(184,176)；跨度122 × 100 px；痕迹矩形宽于高。
