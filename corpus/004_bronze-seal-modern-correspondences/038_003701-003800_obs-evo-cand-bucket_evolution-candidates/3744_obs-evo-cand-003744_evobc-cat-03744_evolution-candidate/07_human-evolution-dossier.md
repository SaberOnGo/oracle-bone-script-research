...
Project ID: `obs-evo-cand-003744`
...
- Project ID: `obs-evo-cand-003744`
- EVOBC category candidate ID: `evobc-evo-cat-03744`
- External category reference: `evobc-cat-03744`
- Source category ID: `03744`
- Source label for human review: `晙`
- Source codepoints: `U+6659`
...
- `obs-evo-cand-003744-route-category-staging`
...
- `obs-evo-cand-003744-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003744-route-evolution-graph`
