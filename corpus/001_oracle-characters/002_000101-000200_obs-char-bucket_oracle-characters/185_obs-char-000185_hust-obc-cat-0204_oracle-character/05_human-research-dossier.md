# obs-char-000185 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000185`
- primary external id: `hust-obc-cat-0204`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/185_obs-char-000185_hust-obc-cat-0204_orac
  le-character/03_visual-assets/001_asset-000190_hust-obc-cat-0204_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0204/G_0204_京津1531合7205.png`
- asset id: `asset-000190`
...
- source category: `0204`
- validation class: `184`
- source image route: `HUST-OBC/deciphered/0204/G_0204_京津1531合7205.png`
- asset id: `asset-000190`
...
- English observation: `The image has a narrow forked upper stem and several
  curved overlapping strokes gathered in the lower half.`
- 中文观察: `图像上方有窄分叉主笔，下半部聚集数道相互重叠的弯曲笔。`
...
- dataset label text: `㓂`
- dataset label codepoints: `U+34C2`
...
- filename catalog route clues: `Heji-like filename clue: 合7205
  (G_0204_京津1531合7205.png)`
...
- Which source records identify obs-char-000185 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000185？
