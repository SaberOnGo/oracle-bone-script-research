...
Project ID: `obs-evo-cand-006141`
...
- Project ID: `obs-evo-cand-006141`
- EVOBC category candidate ID: `evobc-evo-cat-06141`
- External category reference: `evobc-cat-06141`
- Source category ID: `06141`
- Source label for human review: `穮`
- Source codepoints: `U+7A6E`
...
- `obs-evo-cand-006141-route-category-staging`
...
- `obs-evo-cand-006141-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006141-route-evolution-graph`
