...
- Project ID: `obs-evo-cand-008609`
- EVOBC category candidate ID: `evobc-evo-cat-08609`
- External category reference: `evobc-cat-08609`
- Source category ID: `08609`
- Source label for human review: `贖`
- Source codepoints: `U+8D16`
...
- `obs-evo-cand-008609-route-category-staging`
...
- `obs-evo-cand-008609-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008609-route-evolution-graph`
