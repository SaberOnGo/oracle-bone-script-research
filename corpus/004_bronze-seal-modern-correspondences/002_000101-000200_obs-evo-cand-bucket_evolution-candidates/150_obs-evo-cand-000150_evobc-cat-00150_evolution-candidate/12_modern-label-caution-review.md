# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000150
...
- EVOBC candidate category: `evobc-evo-cat-00150`.
- Source label for search only: `㪚`.
- Source codepoints for search only: `U+3A9A`.
