...
- `obs-evo-cand-008806-route-category-staging`
...
- `obs-evo-cand-008806-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008806-route-evolution-graph`
