...
- External category reference: `evobc-cat-12022`
- Source category ID: `12022`
- Source label for human review: `𦒻`
...
- `obs-evo-cand-012022-route-category-staging`
...
- `obs-evo-cand-012022-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012022-route-evolution-graph`
