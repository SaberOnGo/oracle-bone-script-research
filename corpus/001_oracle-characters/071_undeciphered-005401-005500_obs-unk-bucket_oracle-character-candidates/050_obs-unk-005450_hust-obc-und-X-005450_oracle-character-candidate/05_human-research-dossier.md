# obs-unk-005450 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005450`
- primary external id: `hust-obc-und-X-005450`
...
- local review image route: `corpus/001_oracle-characters/071_undeciphered-005
  401-005500_obs-unk-bucket_oracle-character-candidates/050_obs-unk-005450_h
  ust-obc-und-X-005450_oracle-character-candidate/03_visual-assets/001_asset
  -007043_hust-obc-und-X-005450_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1006/X_？_7967_1.png`
- asset id: `asset-007043`
...
- source class: `HUST-OBC/undeciphered/X/1006/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1006/X_？_7967_1.png`
- asset id: `asset-007043`
...
- Which source records identify obs-unk-005450 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005450？
