...
Project ID: `obs-evo-cand-012706`
...
- Project ID: `obs-evo-cand-012706`
- EVOBC category candidate ID: `evobc-evo-cat-12706`
- External category reference: `evobc-cat-12706`
- Source category ID: `12706`
- Source label for human review: `𩻇`
- Source codepoints: `U+29EC7`
...
- `obs-evo-cand-012706-route-category-staging`
...
- `obs-evo-cand-012706-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012706-route-evolution-graph`
