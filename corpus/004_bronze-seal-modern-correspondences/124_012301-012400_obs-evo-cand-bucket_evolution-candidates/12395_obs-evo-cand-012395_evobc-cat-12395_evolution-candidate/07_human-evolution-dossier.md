...
- Project ID: `obs-evo-cand-012395`
- EVOBC category candidate ID: `evobc-evo-cat-12395`
- External category reference: `evobc-cat-12395`
- Source category ID: `12395`
- Source label for human review: `𨙜`
- Source codepoints: `U+2865C`
...
- `obs-evo-cand-012395-route-category-staging`
...
- `obs-evo-cand-012395-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012395-route-evolution-graph`
