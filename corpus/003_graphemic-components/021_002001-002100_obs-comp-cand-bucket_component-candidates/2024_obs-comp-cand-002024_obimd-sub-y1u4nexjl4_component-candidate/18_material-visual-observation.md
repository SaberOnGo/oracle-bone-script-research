# Material Visual Observation / obs-comp-cand-002024 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002024`
- External reference / 外部参照: `obimd-sub-y1u4nexjl4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019351_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/y1u4nexjl4/y1u4nexjl4/y1u4nexjl4.png`
- Checksum / 校验和:
  `fdcce94d18a54164b846bfc4bad09c7b6de3aa55ffd7f88278ec518e1d46f563`
...
- Marked-pixel bounds: (80,29)–(165,220); span 86 × 192 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.72%。
- 痕迹范围：(80,29)–(165,220)；跨度86 × 192 px；痕迹矩形高于宽。
