# Material Visual Observation / obs-comp-cand-001557 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001557`
- External reference / 外部参照: `obimd-sub-t8t8mnjat0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017104_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/f0j9ho8ua2/t8t8mnjat0/t8t8mnjat0.png`
- Checksum / 校验和:
  `fb04286cb339d47ce765ab559bb63585d0ac4c7060d33016e88eb2fc4a0cbc04`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.11%.
- Marked-pixel bounds: (87,41)–(170,202); span 84 × 162 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.11%。
- 痕迹范围：(87,41)–(170,202)；跨度84 × 162 px；痕迹矩形高于宽。
