# Material Visual Observation / obs-comp-cand-000863 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000863`
- External reference / 外部参照: `obimd-sub-t8wk947lu1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013860_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qeqvpjsnyn/t8wk947lu1/t8wk947lu1.png`
- Checksum / 校验和:
  `2e087e09ce4b4f7a0536c6ec3c5235d403fad4a981dbe2f9466c657d217392ea`
...
- Marked-pixel bounds: (92,36)–(179,224); span 88 × 189 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.59%。
- 痕迹范围：(92,36)–(179,224)；跨度88 × 189 px；痕迹矩形高于宽。
