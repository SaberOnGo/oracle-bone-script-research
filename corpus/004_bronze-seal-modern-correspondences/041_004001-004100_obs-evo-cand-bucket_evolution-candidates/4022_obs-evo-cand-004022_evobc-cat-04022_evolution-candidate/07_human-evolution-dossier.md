...
Project ID: `obs-evo-cand-004022`
...
- Project ID: `obs-evo-cand-004022`
- EVOBC category candidate ID: `evobc-evo-cat-04022`
- External category reference: `evobc-cat-04022`
- Source category ID: `04022`
- Source label for human review: `桋`
- Source codepoints: `U+684B`
...
- `obs-evo-cand-004022-route-category-staging`
...
- `obs-evo-cand-004022-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004022-route-evolution-graph`
