...
- Project ID: `obs-evo-cand-005175`
- EVOBC category candidate ID: `evobc-evo-cat-05175`
- External category reference: `evobc-cat-05175`
- Source category ID: `05175`
- Source label for human review: `爢`
- Source codepoints: `U+7222`
...
- `obs-evo-cand-005175-route-category-staging`
...
- `obs-evo-cand-005175-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005175-route-evolution-graph`
