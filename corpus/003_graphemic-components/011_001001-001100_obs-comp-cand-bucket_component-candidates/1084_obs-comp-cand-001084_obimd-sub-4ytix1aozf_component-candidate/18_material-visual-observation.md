# Material Visual Observation / obs-comp-cand-001084 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001084`
- External reference / 外部参照: `obimd-sub-4ytix1aozf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014781_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4ytix1aozf/4ytix1aozf/4ytix1aozf.png`
- Checksum / 校验和:
  `27852b73336362780aab7ac3dbba79a6c481fd2478f39b97dd0a4c74e9eceb6b`
...
- Marked-pixel bounds: (63,69)–(197,185); span 135 × 117 px; the marked
...
- 痕迹范围：(63,69)–(197,185)；跨度135 × 117 px；痕迹矩形近方形。
