...
Project ID: `obs-insc-cw-cand-000301`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000301`
...
- Yingguo / 英国所藏: `y1940` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `421` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `75` in source row; primary catalog entry pending
- Heji / 合集: `40959` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000301`
