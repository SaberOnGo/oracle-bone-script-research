# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004679
...
- EVOBC candidate category: `evobc-evo-cat-04679`.
- Source label for search only: `涌`.
- Source codepoints for search only: `U+6D8C`.
