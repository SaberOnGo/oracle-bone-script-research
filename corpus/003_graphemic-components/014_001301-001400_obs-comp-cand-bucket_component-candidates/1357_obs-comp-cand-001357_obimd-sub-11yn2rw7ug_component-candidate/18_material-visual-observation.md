# Material Visual Observation / obs-comp-cand-001357 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001357`
- External reference / 外部参照: `obimd-sub-11yn2rw7ug`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015746_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tsa3qlzed1/11yn2rw7ug/11yn2rw7ug.png`
- Checksum / 校验和:
  `07f6bb8e77d4b731d3476fd827e29b824d4c1c0db4029147351fde53339e2331`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 14.61%.
- Marked-pixel bounds: (47,32)–(217,221); span 171 × 190 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占14.61%。
- 痕迹范围：(47,32)–(217,221)；跨度171 × 190 px；痕迹矩形近方形。
