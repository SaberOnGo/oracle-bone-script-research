# obs-comp-cand-000109 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000109`
- 首选外部 ID: `obimd-sub-4qzyneuyru`
- OBIMD subcharacter UID: `4qzyneuyru`
- OBIMD main character UID: `xjnn5c8ctk`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+F0A5C; U+F0A5D; 另有 1 项
