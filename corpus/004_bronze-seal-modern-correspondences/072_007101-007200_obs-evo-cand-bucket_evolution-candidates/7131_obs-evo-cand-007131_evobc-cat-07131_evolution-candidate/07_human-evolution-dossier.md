...
- External category reference: `evobc-cat-07131`
- Source category ID: `07131`
- Source label for human review: `膢`
...
- `obs-evo-cand-007131-route-category-staging`
...
- `obs-evo-cand-007131-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007131-route-evolution-graph`
