# Material Visual Observation / obs-comp-cand-001602 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001602`
- External reference / 外部参照: `obimd-sub-m2rpfrft4m`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017278_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/m2rpfrft4m/m2rpfrft4m/m2rpfrft4m.png`
- Checksum / 校验和:
  `3e5d8b2a50d88e97ce96106589830763417baa4ca3f163d589ee1febd1a0b934`
...
- Marked-pixel bounds: (86,34)–(166,215); span 81 × 182 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.59%。
- 痕迹范围：(86,34)–(166,215)；跨度81 × 182 px；痕迹矩形高于宽。
