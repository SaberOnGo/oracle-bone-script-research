# obs-evo-cand-000601 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-000601`
- EVOBC category candidate ID: `evobc-evo-cat-00601`
- External category ref: `evobc-cat-00601`
- Source label: `一`
- Source codepoints: `U+4E00`
- Image reference count: `427`
- Era token counts: `BI:43;CS:1;OBC:26;SAC:6;SS:3;WSC:348`
- Source token counts: `Book:79;Web:348`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 26 image references
- era 1 / BI: 43 image references
- era 2 / SS: 3 image references
- era 3 / SAC: 6 image references
- era 4 / WSC: 348 image references
- era 5 / CS: 1 image references
- source 1 / Web:105952;說文Web:58: 348 image references
- source 2 / Book:17600: 22 image references
- source 3 / Book:21681: 27 image references
