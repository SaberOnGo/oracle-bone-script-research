# obs-char-000944 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/944_obs-char-000944_hust-obc-cat-1061_orac
  le-character/03_visual-assets/001_asset-000949_hust-obc-cat-1061_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1061/G_1061_佚547合37471黃組.png`
- asset id: `asset-000949`
...
- source category: `1061`
- validation class: `943`
- source image route: `HUST-OBC/deciphered/1061/G_1061_佚547合37471黃組.png`
- asset id: `asset-000949`
...
- English observation: `A compact dense form combines a dark upper fork, a
  central descending stroke, lower loops, and a right branch.`
- 中文观察: `紧密密集形体结合深色上部叉形笔、中央下行笔、下部环状笔和右侧分枝。`
...
- dataset label text: `㠛`
- dataset label codepoints: `U+381B`
...
- filename catalog route clues: `Heji-like filename clue: 合37471
  (G_1061_佚547合37471黃組.png)`
...
- Which source records identify obs-char-000944 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000944？
