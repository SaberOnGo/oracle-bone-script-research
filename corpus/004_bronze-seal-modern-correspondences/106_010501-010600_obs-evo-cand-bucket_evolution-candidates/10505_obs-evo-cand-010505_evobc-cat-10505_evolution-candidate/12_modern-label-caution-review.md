# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010505
...
- EVOBC candidate category: `evobc-evo-cat-10505`.
- Source label for search only: `鴿`.
- Source codepoints for search only: `U+9D3F`.
