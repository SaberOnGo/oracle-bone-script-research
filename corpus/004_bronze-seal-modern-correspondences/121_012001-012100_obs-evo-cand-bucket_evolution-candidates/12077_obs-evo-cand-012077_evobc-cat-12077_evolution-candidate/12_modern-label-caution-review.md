# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012077
...
- EVOBC candidate category: `evobc-evo-cat-12077`.
- Source label for search only: `𦨪`.
- Source codepoints for search only: `U+26A2A`.
