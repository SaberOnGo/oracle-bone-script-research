...
- External category reference: `evobc-cat-12004`
- Source category ID: `12004`
- Source label for human review: `𦎍`
- Source codepoints: `U+2638D`
...
- `obs-evo-cand-012004-route-category-staging`
...
- `obs-evo-cand-012004-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012004-route-evolution-graph`
