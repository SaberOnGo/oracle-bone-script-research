...
Project ID: `obs-evo-cand-003586`
...
- Project ID: `obs-evo-cand-003586`
- EVOBC category candidate ID: `evobc-evo-cat-03586`
- External category reference: `evobc-cat-03586`
- Source category ID: `03586`
- Source label for human review: `敖`
- Source codepoints: `U+6556`
...
- `obs-evo-cand-003586-route-category-staging`
...
- `obs-evo-cand-003586-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003586-route-evolution-graph`
