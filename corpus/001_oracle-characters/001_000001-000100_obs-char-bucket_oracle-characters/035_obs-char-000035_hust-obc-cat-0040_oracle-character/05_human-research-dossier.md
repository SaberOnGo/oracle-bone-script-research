# obs-char-000035 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/035_obs-char-000035_hust-obc-cat-0040_orac
  le-character/03_visual-assets/001_asset-000040_hust-obc-cat-0040_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0040/G_0040_乙1077合3544.png`
- asset id: `asset-000040`
...
- source category: `0040`
- validation class: `34`
- source image route: `HUST-OBC/deciphered/0040/G_0040_乙1077合3544.png`
- asset id: `asset-000040`
...
- English observation: `The compact image contains a small branching form
  beside a rectangular framework with an upper diagonal stroke.`
- 中文观察: `紧凑图像含一处小型分叉形体，旁边是带上方斜笔画的长方形框架。`
...
- dataset label text: `㐞`
- dataset label codepoints: `U+341E`
...
- filename catalog route clues: `Heji-like filename clue: 合3544
...
- Which source records identify obs-char-000035 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000035？
