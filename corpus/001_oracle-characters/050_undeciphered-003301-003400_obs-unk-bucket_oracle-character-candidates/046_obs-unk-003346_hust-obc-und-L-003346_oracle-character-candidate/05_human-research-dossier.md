# obs-unk-003346 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/050_undeciphered-003
  301-003400_obs-unk-bucket_oracle-character-candidates/046_obs-unk-003346_h
  ust-obc-und-L-003346_oracle-character-candidate/03_visual-assets/001_asset
  -004939_hust-obc-und-L-003346_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3346/L_？_6374.jpg`
- asset id: `asset-004939`
...
- source class: `HUST-OBC/undeciphered/L/3346/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3346/L_？_6374.jpg`
- asset id: `asset-004939`
...
- Which source records identify obs-unk-003346 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003346？
