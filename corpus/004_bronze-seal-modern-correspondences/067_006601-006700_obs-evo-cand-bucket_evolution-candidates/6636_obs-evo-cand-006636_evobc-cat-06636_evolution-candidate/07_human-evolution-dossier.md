...
- Project ID: `obs-evo-cand-006636`
- EVOBC category candidate ID: `evobc-evo-cat-06636`
- External category reference: `evobc-cat-06636`
- Source category ID: `06636`
- Source label for human review: `縞`
- Source codepoints: `U+7E1E`
...
- `obs-evo-cand-006636-route-category-staging`
...
- `obs-evo-cand-006636-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006636-route-evolution-graph`
