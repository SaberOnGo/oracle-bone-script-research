# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006126
...
- EVOBC candidate category: `evobc-evo-cat-06126`.
- Source label for search only: `穋`.
- Source codepoints for search only: `U+7A4B`.
