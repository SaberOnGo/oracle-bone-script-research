# obs-char-001119 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1119_obs-char-001119_hust-obc-cat-1250_ora
  cle-character/03_visual-assets/001_asset-001124_hust-obc-cat-1250_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1250/G_1250_乙146合19863𠂤組.png`
- asset id: `asset-001124`
...
- source category: `1250`
- validation class: `1118`
- source image route: `HUST-OBC/deciphered/1250/G_1250_乙146合19863𠂤組.png`
- asset id: `asset-001124`
...
- English observation: `A compact narrow form has two pointed upper branches
  and a lower forked extension.`
- 中文观察: `紧密狭长形体有两个尖状上部分枝和下部叉状外伸。`
...
- dataset label text: `㣘`
- dataset label codepoints: `U+38D8`
...
- filename catalog route clues: `Heji-like filename clue: 合19863
  (G_1250_乙146合19863𠂤組.png)`
...
- Which source records identify obs-char-001119 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001119？
