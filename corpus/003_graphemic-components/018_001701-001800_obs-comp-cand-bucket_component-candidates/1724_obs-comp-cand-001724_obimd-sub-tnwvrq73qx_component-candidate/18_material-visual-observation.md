# Material Visual Observation / obs-comp-cand-001724 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001724`
- External reference / 外部参照: `obimd-sub-tnwvrq73qx`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017903_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tnwvrq73qx/tnwvrq73qx/tnwvrq73qx.png`
- Checksum / 校验和:
  `cb43f0715f1383a0c13c88aa5a8d1cbcfbaf069746db541ef20b6b7bfcfbad3b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.01%.
- Marked-pixel bounds: (55,27)–(210,226); span 156 × 200 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.01%。
- 痕迹范围：(55,27)–(210,226)；跨度156 × 200 px；痕迹矩形高于宽。
