# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006634
...
- EVOBC candidate category: `evobc-evo-cat-06634`.
- Source label for search only: `縛`.
- Source codepoints for search only: `U+7E1B`.
