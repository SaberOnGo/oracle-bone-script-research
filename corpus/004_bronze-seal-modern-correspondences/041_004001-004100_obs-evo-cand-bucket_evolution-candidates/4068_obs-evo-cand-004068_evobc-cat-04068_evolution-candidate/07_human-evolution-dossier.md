...
- External category reference: `evobc-cat-04068`
- Source category ID: `04068`
- Source label: `梤`
...
- `obs-evo-cand-004068-route-category-staging`
...
- `obs-evo-cand-004068-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004068-route-evolution-graph`
