# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001356
...
| --- | --- | --- | --- |
| `obimd-glyph-link-020140` | 󷬖 | `U+F7B16` | `reviewed_metadata_only` |
| `obimd-glyph-link-020141` | 󷬗 | `U+F7B17` | `reviewed_metadata_only` |
| `obimd-glyph-link-020142` | 󷬘 | `U+F7B18` | `reviewed_metadata_only` |
