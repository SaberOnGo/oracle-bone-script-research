...
- External category reference: `evobc-cat-12064`
- Source category ID: `12064`
- Source label: `𦢇`
...
- `obs-evo-cand-012064-route-category-staging`
...
- `obs-evo-cand-012064-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012064-route-evolution-graph`
