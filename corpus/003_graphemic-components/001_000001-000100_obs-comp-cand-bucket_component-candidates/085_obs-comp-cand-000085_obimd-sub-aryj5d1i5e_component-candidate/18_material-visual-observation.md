# Material Visual Observation / obs-comp-cand-000085 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000085`
- External reference / 外部参照: `obimd-sub-aryj5d1i5e`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011497_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/d20ybazw7f/aryj5d1i5e/aryj5d1i5e.png`
- Checksum / 校验和:
  `ae479d15c5cc6193a2e3c5917a57042db673d1670167de3a124f40b77f707825`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.73%.
- Marked-pixel bounds: (64,23)–(185,220); span 122 × 198 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.73%。
- 痕迹范围：(64,23)–(185,220)；跨度122 × 198 px；痕迹矩形高于宽。
