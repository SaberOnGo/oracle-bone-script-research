# obs-char-000092 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000092`
- primary external id: `hust-obc-cat-0102`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/092_obs-char-000092_hust-obc-cat-0102_orac
  le-character/03_visual-assets/001_asset-000097_hust-obc-cat-0102_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0102/G_0102_七X13合33140𠂤賓間.png`
- asset id: `asset-000097`
...
- source category: `0102`
- validation class: `91`
- source image route: `HUST-OBC/deciphered/0102/G_0102_七X13合33140𠂤賓間.png`
- asset id: `asset-000097`
...
- English observation: `The image contains two rounded upper loops joined by
  crossing strokes and two curved lower hooks on opposite sides.`
- 中文观察: `图像上方有两个弧形环，彼此由交叉笔画连接，下方两侧各有弯曲钩状笔。`
...
- dataset label text: `㑜`
- dataset label codepoints: `U+345C`
...
- filename catalog route clues: `Heji-like filename clue: 合33140
  (G_0102_七X13合33140𠂤賓間.png)`
...
- Which source records identify obs-char-000092 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000092？
