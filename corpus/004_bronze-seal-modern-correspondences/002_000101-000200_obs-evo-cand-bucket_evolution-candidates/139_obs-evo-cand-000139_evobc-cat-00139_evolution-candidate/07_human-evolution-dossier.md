...
- External category reference: `evobc-cat-00139`
- Source category ID: `00139`
- Source label for human review: `㦵`
...
- `obs-evo-cand-000139-route-category-staging`
...
- `obs-evo-cand-000139-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000139-route-evolution-graph`
