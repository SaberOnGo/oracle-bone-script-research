# Material Visual Observation / obs-comp-cand-002039 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002039`
- External reference / 外部参照: `obimd-sub-4fmbo8y6en`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019366_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4noufqnl4f/4fmbo8y6en/4fmbo8y6en.png`
- Checksum / 校验和:
  `9b0a1bd82debd7da3ba8a0bfc684d7c9511299b4c5f29c51de68aaeede269cfe`
...
- Marked-pixel bounds: (78,32)–(171,212); span 94 × 181 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.94%。
- 痕迹范围：(78,32)–(171,212)；跨度94 × 181 px；痕迹矩形高于宽。
