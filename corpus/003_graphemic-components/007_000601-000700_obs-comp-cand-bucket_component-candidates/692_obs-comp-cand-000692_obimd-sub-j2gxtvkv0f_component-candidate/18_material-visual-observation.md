# Material Visual Observation / obs-comp-cand-000692 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000692`
- External reference / 外部参照: `obimd-sub-j2gxtvkv0f`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013291_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/i1qbimwfk6/j2gxtvkv0f/j2gxtvkv0f.png`
- Checksum / 校验和:
  `e76524f4dcd7362bd1814f005d48e73572b03b53ece2d66420043af0f5975f1a`
...
- Marked-pixel bounds: (68,38)–(181,211); span 114 × 174 px; the marked
...
- 痕迹范围：(68,38)–(181,211)；跨度114 × 174 px；痕迹矩形高于宽。
