# obs-char-000464 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000464`
- primary external id: `hust-obc-cat-0526`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/464_obs-char-000464_hust-obc-cat-0526_orac
  le-character/03_visual-assets/001_asset-000469_hust-obc-cat-0526_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0526/G_0526_京都2330(甲).png`
- asset id: `asset-000469`
...
- source category: `0526`
- validation class: `463`
- source image route: `HUST-OBC/deciphered/0526/G_0526_京都2330(甲).png`
- asset id: `asset-000469`
...
- English observation: `An angular outer outline surrounds a compact curled
  inner cluster, with two long slightly curved strokes descending below the
  center.`
- 中文观察: `折角外轮廓围绕紧凑卷曲内笔画群，中央下方有两条略弯的长笔下垂。`
...
- dataset label text: `㘄`
- dataset label codepoints: `U+3604`
...
- Which source records identify obs-char-000464 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000464？
