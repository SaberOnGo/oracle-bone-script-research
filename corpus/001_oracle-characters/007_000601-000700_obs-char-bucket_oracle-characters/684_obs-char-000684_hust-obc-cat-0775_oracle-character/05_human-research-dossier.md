# obs-char-000684 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000684`
- primary external id: `hust-obc-cat-0775`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/684_obs-char-000684_hust-obc-cat-0775_orac
  le-character/03_visual-assets/001_asset-000689_hust-obc-cat-0775_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0775/G_0775_乙1054合6828.png`
- asset id: `asset-000689`
...
- source category: `0775`
- validation class: `683`
- source image route: `HUST-OBC/deciphered/0775/G_0775_乙1054合6828.png`
- asset id: `asset-000689`
...
- English observation: `A detached pointed pair of bent strokes stands above
  a shallow lower rectangular basin with a long base and short uneven
  upright sides.`
- 中文观察: `一对分离尖折笔位于浅下部矩形槽上方，槽体带长底线和高低不齐的短竖边。`
...
- dataset label text: `㛽`
- dataset label codepoints: `U+36FD`
...
- filename catalog route clues: `Heji-like filename clue: 合6828
  (G_0775_乙1054合6828.png)`
...
- Which source records identify obs-char-000684 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000684？
