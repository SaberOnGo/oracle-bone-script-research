...
Project ID: `obs-evo-cand-008669`
...
- Project ID: `obs-evo-cand-008669`
- EVOBC category candidate ID: `evobc-evo-cat-08669`
- External category reference: `evobc-cat-08669`
- Source category ID: `08669`
- Source label for human review: `趀`
- Source codepoints: `U+8D80`
...
- `obs-evo-cand-008669-route-category-staging`
...
- `obs-evo-cand-008669-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008669-route-evolution-graph`
