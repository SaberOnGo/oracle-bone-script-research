# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000238
...
| --- | --- | --- | --- |
| `obimd-glyph-link-003302` | 󱗎 | `U+F15CE` | `reviewed_metadata_only` |
| `obimd-glyph-link-003303` | 󱗏 | `U+F15CF` | `reviewed_metadata_only` |
