...
- External category reference: `evobc-cat-09444`
- Source category ID: `09444`
- Source label for human review: `錮`
- Source codepoints: `U+932E`
...
- `obs-evo-cand-009444-route-category-staging`
...
- `obs-evo-cand-009444-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009444-route-evolution-graph`
