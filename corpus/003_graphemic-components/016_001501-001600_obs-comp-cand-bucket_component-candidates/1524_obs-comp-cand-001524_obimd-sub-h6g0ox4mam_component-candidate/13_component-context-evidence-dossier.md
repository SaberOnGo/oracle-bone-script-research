# obs-comp-cand-001524 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001524`
- 首选外部 ID: `obimd-sub-h6g0ox4mam`
- OBIMD subcharacter UID: `h6g0ox4mam`
- OBIMD main character UID: `m74wrlidvc`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+C7C22;U+F8D3A; U+F8D3B; 另有 2 项
