# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008903
...
- EVOBC candidate category: `evobc-evo-cat-08903`.
- Source label for search only: `输`.
- Source codepoints for search only: `U+8F93`.
