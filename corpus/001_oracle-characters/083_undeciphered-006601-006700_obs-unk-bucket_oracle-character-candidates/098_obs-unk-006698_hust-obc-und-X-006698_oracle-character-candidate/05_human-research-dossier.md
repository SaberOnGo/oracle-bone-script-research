# obs-unk-006698 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006698`
- primary external id: `hust-obc-und-X-006698`
...
- local review image route: `corpus/001_oracle-characters/083_undeciphered-006
  601-006700_obs-unk-bucket_oracle-character-candidates/098_obs-unk-006698_h
  ust-obc-und-X-006698_oracle-character-candidate/03_visual-assets/001_asset
  -008289_hust-obc-und-X-006698_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2254/X_？_887_1.png`
- asset id: `asset-008289`
...
- source class: `HUST-OBC/undeciphered/X/2254/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2254/X_？_887_1.png`
- asset id: `asset-008289`
...
- Which source records identify obs-unk-006698 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006698？
