# obs-comp-cand-001904 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001904`
- 首选外部 ID: `obimd-sub-rawz6rhrtd`
- OBIMD subcharacter UID: `rawz6rhrtd`
...
- codepoint 示例: U+FADB1; U+FADB2; 另有 8 项
