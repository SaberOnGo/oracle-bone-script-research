# obs-evo-cand-005153 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-005153`
- EVOBC category candidate ID: `evobc-evo-cat-05153`
- External category ref: `evobc-cat-05153`
- Source label for human review: `燕`
- Source codepoints: `U+71D5`
- Image reference count: `61`
- Era token counts: `CS:1;OBC:53;SS:2;WSC:5`
- Source token counts: `Book:21;Web:40`
