# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004422
...
- EVOBC candidate category: `evobc-evo-cat-04422`.
- Source label for search only: `殬`.
- Source codepoints for search only: `U+6BAC`.
