...
- Project ID: `obs-evo-cand-002130`
- EVOBC category candidate ID: `evobc-evo-cat-02130`
- External category reference: `evobc-cat-02130`
- Source category ID: `02130`
- Source label for human review: `姝`
- Source codepoints: `U+59DD`
...
- `obs-evo-cand-002130-route-category-staging`
...
- `obs-evo-cand-002130-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002130-route-evolution-graph`
