# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001892
...
- EVOBC candidate category: `evobc-evo-cat-01892`.
- Source label for search only: `埾`.
- Source codepoints for search only: `U+57FE`.
