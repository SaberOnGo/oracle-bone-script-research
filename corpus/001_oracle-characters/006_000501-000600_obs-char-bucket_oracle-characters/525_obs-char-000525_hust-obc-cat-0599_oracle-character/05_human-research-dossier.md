# obs-char-000525 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/525_obs-char-000525_hust-obc-cat-0599_orac
  le-character/03_visual-assets/001_asset-000530_hust-obc-cat-0599_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0599/H_0599_609C8_0.png`
- asset id: `asset-000530`
...
- source category: `0599`
- validation class: `524`
- source image route: `HUST-OBC/deciphered/0599/H_0599_609C8_0.png`
- asset id: `asset-000530`
...
- English observation: `Two separated bold clusters show a broad hooked
  upper arch with a small top loop and a lower open-topped angular outline
  with two peaks.`
...
- dataset label text: `㙍`
- dataset label codepoints: `U+364D`
...
- filename catalog route clues: `catalog-like filename clue: H_0599
  (H_0599_609C8_0.png)`
...
- Which source records identify obs-char-000525 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000525？
