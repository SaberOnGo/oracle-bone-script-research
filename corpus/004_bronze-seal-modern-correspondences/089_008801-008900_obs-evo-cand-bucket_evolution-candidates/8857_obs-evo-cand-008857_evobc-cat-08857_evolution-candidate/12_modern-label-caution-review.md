# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008857
...
- EVOBC candidate category: `evobc-evo-cat-08857`.
- Source label for search only: `輻`.
- Source codepoints for search only: `U+8F3B`.
