...
- External category reference: `evobc-cat-11245`
- Source category ID: `11245`
- Source label for human review: `𢜦`
- Source codepoints: `U+22726`
...
- `obs-evo-cand-011245-route-category-staging`
...
- `obs-evo-cand-011245-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011245-route-evolution-graph`
