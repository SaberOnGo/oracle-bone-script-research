...
Project ID: `obs-evo-cand-006008`
...
- Project ID: `obs-evo-cand-006008`
- EVOBC category candidate ID: `evobc-evo-cat-06008`
- External category reference: `evobc-cat-06008`
- Source category ID: `06008`
- Source label for human review: `祺`
- Source codepoints: `U+797A`
...
- `obs-evo-cand-006008-route-category-staging`
...
- `obs-evo-cand-006008-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006008-route-evolution-graph`
