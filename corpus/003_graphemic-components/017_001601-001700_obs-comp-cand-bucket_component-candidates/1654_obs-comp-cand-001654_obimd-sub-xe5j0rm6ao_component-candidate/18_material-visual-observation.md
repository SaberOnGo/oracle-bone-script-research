# Material Visual Observation / obs-comp-cand-001654 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001654`
- External reference / 外部参照: `obimd-sub-xe5j0rm6ao`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017330_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xe5j0rm6ao/xe5j0rm6ao/xe5j0rm6ao.png`
- Checksum / 校验和:
  `0a8615b78bc8a9ff8755c777822da164e0ad5bdec1bbffa3ac4bc69c1ea31bb7`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.33%.
- Marked-pixel bounds: (61,29)–(197,218); span 137 × 190 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.33%。
- 痕迹范围：(61,29)–(197,218)；跨度137 × 190 px；痕迹矩形高于宽。
