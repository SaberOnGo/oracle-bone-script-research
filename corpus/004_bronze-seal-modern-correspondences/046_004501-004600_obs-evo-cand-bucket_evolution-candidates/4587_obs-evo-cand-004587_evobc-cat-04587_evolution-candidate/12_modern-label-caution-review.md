# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004587
...
- EVOBC candidate category: `evobc-evo-cat-04587`.
- Source label for search only: `泝`.
- Source codepoints for search only: `U+6CDD`.
