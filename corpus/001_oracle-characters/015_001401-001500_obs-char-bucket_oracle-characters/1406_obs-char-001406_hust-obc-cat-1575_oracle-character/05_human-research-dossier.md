# obs-char-001406 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001406`
- primary external id: `hust-obc-cat-1575`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1406_obs-char-001406_hust-obc-cat-1575_ora
  cle-character/03_visual-assets/001_asset-001411_hust-obc-cat-1575_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1575/G_1575_前4.47.2(甲).png`
- asset id: `asset-001411`
...
- source category: `1575`
- validation class: `1405`
- source image route: `HUST-OBC/deciphered/1575/G_1575_前4.47.2(甲).png`
- asset id: `asset-001411`
...
- English observation: `A horizontal upper frame sits above two separated
  symmetrical branch clusters.`
- 中文观察: `水平上部框形位于两个分离对称分枝群之上。`
...
- dataset label text: `㨝`
- dataset label codepoints: `U+3A1D`
...
- Which source records identify obs-char-001406 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001406？
