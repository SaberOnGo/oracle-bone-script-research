# Material Visual Observation / obs-comp-cand-001462 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001462`
- External reference / 外部参照: `obimd-sub-luw8r1fj9l`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016039_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/luw8r1fj9l/luw8r1fj9l/luw8r1fj9l.png`
- Checksum / 校验和:
  `3416fcd67ee80260fab818bb1620b253d9c8dd8373d1f7ac560f23491125d45f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.73%.
- Marked-pixel bounds: (42,34)–(203,217); span 162 × 184 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.73%。
- 痕迹范围：(42,34)–(203,217)；跨度162 × 184 px；痕迹矩形近方形。
