# obs-unk-004386 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/086_obs-unk-004386_h
  ust-obc-und-L-004386_oracle-character-candidate/03_visual-assets/001_asset
  -005979_hust-obc-und-L-004386_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4386/L_？_9749.jpg`
- asset id: `asset-005979`
...
- source class: `HUST-OBC/undeciphered/L/4386/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4386/L_？_9749.jpg`
- asset id: `asset-005979`
...
- English observation: `Two upper angular points sit above a rounded`
  `lower outline with several projections.`
- 中文观察: `上部有两个斜角转折点，下方是带多处伸出痕迹的圆弧轮廓。`
...
- Which source records identify obs-unk-004386 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004386？
