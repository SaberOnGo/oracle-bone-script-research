...
- External category reference: `evobc-cat-10945`
- Source category ID: `10945`
- Source label for human review: `𠶷`
...
- `obs-evo-cand-010945-route-category-staging`
...
- `obs-evo-cand-010945-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010945-route-evolution-graph`
