# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001659
...
- EVOBC candidate category: `evobc-evo-cat-01659`.
- Source label for search only: `單`.
- Source codepoints for search only: `U+55AE`.
