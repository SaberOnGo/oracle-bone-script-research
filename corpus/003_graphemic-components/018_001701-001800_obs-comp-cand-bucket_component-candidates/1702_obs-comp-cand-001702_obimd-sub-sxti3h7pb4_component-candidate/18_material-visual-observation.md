# Material Visual Observation / obs-comp-cand-001702 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001702`
- External reference / 外部参照: `obimd-sub-sxti3h7pb4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017618_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ebehpv21xt/sxti3h7pb4/sxti3h7pb4.png`
- Checksum / 校验和:
  `f2c08b2548369707b68d591da37a7aecf511c999b6c601b99c7dea3dba4bbbab`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.61%.
- Marked-pixel bounds: (78,23)–(174,223); span 97 × 201 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.61%。
- 痕迹范围：(78,23)–(174,223)；跨度97 × 201 px；痕迹矩形高于宽。
