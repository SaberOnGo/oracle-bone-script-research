# obs-char-000078 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000078`
- primary external id: `hust-obc-cat-0088`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/078_obs-char-000078_hust-obc-cat-0088_orac
  le-character/03_visual-assets/001_asset-000083_hust-obc-cat-0088_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0088/G_0088_乙6664合11497賓組.png`
- asset id: `asset-000083`
...
- source category: `0088`
- validation class: `77`
- source image route: `HUST-OBC/deciphered/0088/G_0088_乙6664合11497賓組.png`
- asset id: `asset-000083`
...
- English observation: `The small image has two broad curved horizontal
  strokes, one above the other, with an open gap between them.`
- 中文观察: `小型图像有上下两条宽而弯曲的横向笔画，中间留有开放间隔。`
...
- dataset label text: `㑎`
- dataset label codepoints: `U+344E`
...
- filename catalog route clues: `Heji-like filename clue: 合11497
  (G_0088_乙6664合11497賓組.png)`
...
- Which source records identify obs-char-000078 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000078？
