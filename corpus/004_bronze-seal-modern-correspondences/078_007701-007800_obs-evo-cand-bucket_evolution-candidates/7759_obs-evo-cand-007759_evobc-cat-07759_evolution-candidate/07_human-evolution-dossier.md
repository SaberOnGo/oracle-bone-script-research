...
- External category reference: `evobc-cat-07759`
- Source category ID: `07759`
- Source label for human review: `蛮`
...
- `obs-evo-cand-007759-route-category-staging`
...
- `obs-evo-cand-007759-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007759-route-evolution-graph`
