# obs-unk-008004 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/097_undeciphered-008
  001-008100_obs-unk-bucket_oracle-character-candidates/004_obs-unk-008004_h
  ust-obc-und-YH-008004_oracle-character-candidate/03_visual-assets/001_asse
  t-009595_hust-obc-und-YH-008004_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/605F6/H_？_605F6_0.png`
- asset id: `asset-009595`
...
- source class: `HUST-OBC/undeciphered/Y+H/605F6/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/605F6/H_？_605F6_0.png`
- asset id: `asset-009595`
...
- Which source records identify obs-unk-008004 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008004？
