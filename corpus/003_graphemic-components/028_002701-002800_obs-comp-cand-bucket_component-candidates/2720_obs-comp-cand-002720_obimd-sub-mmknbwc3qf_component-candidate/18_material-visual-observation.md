# Material Visual Observation / obs-comp-cand-002720 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002720`
- External reference / 外部参照: `obimd-sub-mmknbwc3qf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021296_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/mmknbwc3qf/mmknbwc3qf/0k6hx0fns9.png`
- Checksum / 校验和:
  `76a8edc365842a244976506786958665b9e4760d1687c6473ff8fd6b88e82cff`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.68%.
- Marked-pixel bounds: (54,61)–(195,198); span 142 × 138 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.68%。
- 痕迹范围：(54,61)–(195,198)；跨度142 × 138 px；痕迹矩形近方形。
