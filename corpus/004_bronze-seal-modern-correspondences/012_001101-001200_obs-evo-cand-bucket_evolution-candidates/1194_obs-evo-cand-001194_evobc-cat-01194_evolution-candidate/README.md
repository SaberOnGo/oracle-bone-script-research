# obs-evo-cand-001194 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-001194`
- EVOBC category candidate ID: `evobc-evo-cat-01194`
- External category ref: `evobc-cat-01194`
- Source label: `初`
- Source codepoints: `U+521D`
- Image reference count: `194`
- Era token counts: `BI:107;CS:1;OBC:32;SAC:37;SS:2;WSC:15`
- Source token counts: `Book:98;Web:96`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 32 image references
...
- source 2 / Book:17600: 1 image references
- source 3 / Book:21681: 53 image references
- source 4 / Book:9131: 37 image references
- source 5 / Book:32794: 4 image references
