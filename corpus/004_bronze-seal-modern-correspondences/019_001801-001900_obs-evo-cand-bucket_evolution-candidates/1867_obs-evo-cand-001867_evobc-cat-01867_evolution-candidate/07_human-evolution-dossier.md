...
- External category reference: `evobc-cat-01867`
- Source category ID: `01867`
- Source label for human review: `垽`
- Source codepoints: `U+57BD`
...
- `obs-evo-cand-001867-route-category-staging`
...
- `obs-evo-cand-001867-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001867-route-evolution-graph`
