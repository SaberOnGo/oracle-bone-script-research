# obs-evo-cand-002620 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-002620`
- EVOBC category candidate ID: `evobc-evo-cat-02620`
- External category ref: `evobc-cat-02620`
- Source label: `巨`
- Source codepoints: `U+5DE8`
- Image reference count: `70`
- Era token counts: `BI:33;CS:2;SAC:2;SS:4;WSC:29`
- Source token counts: `Book:35;Web:35`

## Observed Code Rows / 观察到的代码行

- era 1 / BI: 33 image references
