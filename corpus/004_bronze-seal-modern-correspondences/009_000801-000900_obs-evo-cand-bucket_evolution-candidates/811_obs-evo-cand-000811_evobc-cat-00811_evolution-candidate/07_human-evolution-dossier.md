...
Project ID: `obs-evo-cand-000811`
...
- Project ID: `obs-evo-cand-000811`
- EVOBC category candidate ID: `evobc-evo-cat-00811`
- External category reference: `evobc-cat-00811`
- Source category ID: `00811`
- Source label for human review: `佝`
- Source codepoints: `U+4F5D`
...
- `obs-evo-cand-000811-route-category-staging`
...
- `obs-evo-cand-000811-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000811-route-evolution-graph`
