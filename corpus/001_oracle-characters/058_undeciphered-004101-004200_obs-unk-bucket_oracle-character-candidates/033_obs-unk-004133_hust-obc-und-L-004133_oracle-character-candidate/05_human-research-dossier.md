# obs-unk-004133 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004133`
- primary external id: `hust-obc-und-L-004133`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/033_obs-unk-004133_h
  ust-obc-und-L-004133_oracle-character-candidate/03_visual-assets/001_asset
  -005726_hust-obc-und-L-004133_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4133/L_？_8906.jpg`
- asset id: `asset-005726`
...
- source class: `HUST-OBC/undeciphered/L/4133/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4133/L_？_8906.jpg`
- asset id: `asset-005726`
...
- English observation: A compact dark cluster has crossing angled traces;
  a taller trace rises near the center-right.
- 中文观察：紧凑深色痕迹簇包含交叉折角痕迹；中央偏右有较高痕迹。
...
- Which source records identify obs-unk-004133 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004133？
