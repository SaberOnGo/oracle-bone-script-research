...
- Project ID: `obs-evo-cand-013314`
- EVOBC category candidate ID: `evobc-evo-cat-13314`
- External category reference: `evobc-cat-13314`
- Source category ID: `13314`
- Source label for human review: `𬟬`
- Source codepoints: `U+2C7EC`
...
- `obs-evo-cand-013314-route-category-staging`
...
- `obs-evo-cand-013314-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013314-route-evolution-graph`
