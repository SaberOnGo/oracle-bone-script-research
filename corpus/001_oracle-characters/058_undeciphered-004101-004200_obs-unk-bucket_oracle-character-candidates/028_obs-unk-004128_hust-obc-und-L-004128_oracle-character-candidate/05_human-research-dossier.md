# obs-unk-004128 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/028_obs-unk-004128_h
  ust-obc-und-L-004128_oracle-character-candidate/03_visual-assets/001_asset
  -005721_hust-obc-und-L-004128_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4128/L_？_8894.jpg`
- asset id: `asset-005721`
...
- source class: `HUST-OBC/undeciphered/L/4128/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4128/L_？_8894.jpg`
- asset id: `asset-005721`
...
- English observation: A compact upright group has a broken left trace;
  short strokes project toward the upper right.
- 中文观察：紧凑竖向痕迹簇左侧有断续痕迹；短痕迹向右上方伸出。
...
- Which source records identify obs-unk-004128 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004128？
