...
- External category reference: `evobc-cat-07621`
- Source category ID: `07621`
- Source label for human review: `薪`
- Source codepoints: `U+85AA`
...
- `obs-evo-cand-007621-route-category-staging`
...
- `obs-evo-cand-007621-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007621-route-evolution-graph`
