# obs-unk-008492 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008492`
- primary external id: `hust-obc-und-YH-008492`
...
- local review image route: `corpus/001_oracle-characters/101_undeciphered-008
  401-008500_obs-unk-bucket_oracle-character-candidates/092_obs-unk-008492_h
  ust-obc-und-YH-008492_oracle-character-candidate/03_visual-assets/001_asse
  t-010083_hust-obc-und-YH-008492_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60B7C/H_？_60B7C_0.png`
- asset id: `asset-010083`
...
- source class: `HUST-OBC/undeciphered/Y+H/60B7C/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60B7C/H_？_60B7C_0.png`
- asset id: `asset-010083`
...
- Which source records identify obs-unk-008492 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008492？
