# obs-char-000562 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000562`
- primary external id: `hust-obc-cat-0637`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/562_obs-char-000562_hust-obc-cat-0637_orac
  le-character/03_visual-assets/001_asset-000567_hust-obc-cat-0637_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0637/G_0637_合36908(甲).png`
- asset id: `asset-000567`
...
- source category: `0637`
- validation class: `561`
- source image route: `HUST-OBC/deciphered/0637/G_0637_合36908(甲).png`
- asset id: `asset-000567`
...
- English observation: `A small tall irregular outer outline contains
  several short vertical, diagonal, and crossing marks and narrows into a
  pointed lower end.`
- 中文观察: `小型高长不规则外轮廓内有数条短竖、短斜和交叉痕，下部收窄为尖端。`
...
- dataset label text: `㙳`
- dataset label codepoints: `U+3673`
...
- filename catalog route clues: `Heji-like filename clue: 合36908
  (G_0637_合36908(甲).png)`
...
- Which source records identify obs-char-000562 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000562？
