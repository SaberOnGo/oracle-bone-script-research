# Material Visual Observation / obs-comp-cand-002372 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002372`
- External reference / 外部参照: `obimd-sub-bluyc51w9k`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020443_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bluyc51w9k/bluyc51w9k/bluyc51w9k.png`
- Checksum / 校验和:
  `0e5de1ec20c0cdfaa493a33541c84e4c01b0714f7f97fd403017757f22392857`
...
- Marked-pixel bounds: (97,30)–(153,224); span 57 × 195 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.58%。
- 痕迹范围：(97,30)–(153,224)；跨度57 × 195 px；痕迹矩形高于宽。
