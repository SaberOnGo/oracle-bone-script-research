# Material Visual Observation / obs-comp-cand-000912 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000912`
- External reference / 外部参照: `obimd-sub-9m5jjuadiy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013984_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7p7pi5fxkj/9m5jjuadiy/02oevvnz5u.png`
- Checksum / 校验和:
  `fd1f6f6570133420bcbdfe1c85038dc4c2967541fec27f2f56fdc698b42d27e1`
...
- Marked-pixel bounds: (75,39)–(174,211); span 100 × 173 px; the marked
...
- 痕迹范围：(75,39)–(174,211)；跨度100 × 173 px；痕迹矩形高于宽。
