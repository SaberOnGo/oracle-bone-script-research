# Material Visual Observation / obs-comp-cand-002187 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002187`
- External reference / 外部参照: `obimd-sub-vm64inyv8p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019893_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kyjr61sdkq/vm64inyv8p/vm64inyv8p.png`
- Checksum / 校验和:
  `f817f84e908f11ecb2ad895727d004bab622afaeb8f4e930b88a515d965f4e8e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.71%.
- Marked-pixel bounds: (70,35)–(183,205); span 114 × 171 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.71%。
- 痕迹范围：(70,35)–(183,205)；跨度114 × 171 px；痕迹矩形高于宽。
