# obs-unk-002024 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002024`
- primary external id: `hust-obc-und-L-002024`
...
- local review image route: `corpus/001_oracle-characters/037_undeciphered-002
  001-002100_obs-unk-bucket_oracle-character-candidates/024_obs-unk-002024_h
  ust-obc-und-L-002024_oracle-character-candidate/03_visual-assets/001_asset
  -003617_hust-obc-und-L-002024_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2024/L_？_2022.jpg`
- asset id: `asset-003617`
...
- source class: `HUST-OBC/undeciphered/L/2024/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2024/L_？_2022.jpg`
- asset id: `asset-003617`
...
- Which source records identify obs-unk-002024 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002024？
