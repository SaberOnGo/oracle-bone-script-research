# Material Visual Observation / obs-comp-cand-001467 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001467`
- External reference / 外部参照: `obimd-sub-41hw4n8rsf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016044_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/o2g1mpwg2a/41hw4n8rsf/41hw4n8rsf.png`
- Checksum / 校验和:
  `587121cdbd64b80259dfb650b27a3a150f841902b8e365f43ca3294bd94d4570`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.82%.
- Marked-pixel bounds: (74,33)–(175,220); span 102 × 188 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.82%。
- 痕迹范围：(74,33)–(175,220)；跨度102 × 188 px；痕迹矩形高于宽。
