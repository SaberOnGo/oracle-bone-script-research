...
- External category reference: `evobc-cat-12917`
- Source category ID: `12917`
- Source label for human review: `𫅡`
- Source codepoints: `U+2B161`
...
- `obs-evo-cand-012917-route-category-staging`
...
- `obs-evo-cand-012917-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012917-route-evolution-graph`
