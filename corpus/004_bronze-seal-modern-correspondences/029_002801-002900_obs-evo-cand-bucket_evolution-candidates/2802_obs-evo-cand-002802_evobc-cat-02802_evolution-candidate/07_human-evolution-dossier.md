...
- External category reference: `evobc-cat-02802`
- Source category ID: `02802`
- Source label: `张`
...
- `obs-evo-cand-002802-route-category-staging`
...
- `obs-evo-cand-002802-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002802-route-evolution-graph`
