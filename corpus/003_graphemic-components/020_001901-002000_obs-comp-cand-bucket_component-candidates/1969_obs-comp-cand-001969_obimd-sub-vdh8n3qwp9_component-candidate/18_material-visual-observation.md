# Material Visual Observation / obs-comp-cand-001969 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001969`
- External reference / 外部参照: `obimd-sub-vdh8n3qwp9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018961_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h82z1bo3i3/vdh8n3qwp9/vdh8n3qwp9.png`
- Checksum / 校验和:
  `b25e3dfef6699f8281aaa3bd9390da20e6328d0921ce89a7cbd0e635a063b776`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.37%.
- Marked-pixel bounds: (70,32)–(179,213); span 110 × 182 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.37%。
- 痕迹范围：(70,32)–(179,213)；跨度110 × 182 px；痕迹矩形高于宽。
