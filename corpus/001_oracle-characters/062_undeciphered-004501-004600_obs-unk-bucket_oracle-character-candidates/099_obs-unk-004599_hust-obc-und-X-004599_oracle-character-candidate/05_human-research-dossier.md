# obs-unk-004599 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/099_obs-unk-004599_h
  ust-obc-und-X-004599_oracle-character-candidate/03_visual-assets/001_asset
  -006192_hust-obc-und-X-004599_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/155/X_？_8332_1.png`
- asset id: `asset-006192`
...
- source class: `HUST-OBC/undeciphered/X/155/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/155/X_？_8332_1.png`
- asset id: `asset-006192`
...
- English observation: `No stable glyph boundary; source-quality review`
  `required.`
- 中文观察: `未形成稳定字形边界，需要复核来源图像质量。`
...
- Which source records identify obs-unk-004599 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004599？
