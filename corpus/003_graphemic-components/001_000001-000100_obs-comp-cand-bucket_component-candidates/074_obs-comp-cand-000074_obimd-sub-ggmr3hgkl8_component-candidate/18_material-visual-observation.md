# Material Visual Observation / obs-comp-cand-000074 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000074`
- External reference / 外部参照: `obimd-sub-ggmr3hgkl8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011486_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/t4tioxlhov/ggmr3hgkl8/ggmr3hgkl8.png`
- Checksum / 校验和:
  `56c99ac3fb670e41f82d4f180b1787d993a86a510dfef2cc318061a25a6a2405`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.99%.
- Marked-pixel bounds: (56,31)–(193,203); span 138 × 173 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.99%。
- 痕迹范围：(56,31)–(193,203)；跨度138 × 173 px；痕迹矩形高于宽。
