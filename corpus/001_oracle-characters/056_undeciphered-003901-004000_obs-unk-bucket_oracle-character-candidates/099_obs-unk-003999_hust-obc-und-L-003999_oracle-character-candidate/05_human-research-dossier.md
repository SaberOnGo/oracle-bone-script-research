# obs-unk-003999 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/099_obs-unk-003999_h
  ust-obc-und-L-003999_oracle-character-candidate/03_visual-assets/001_asset
  -005592_hust-obc-und-L-003999_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3999/L_？_8462.jpg`
- asset id: `asset-005592`
...
- source class: `HUST-OBC/undeciphered/L/3999/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3999/L_？_8462.jpg`
- asset id: `asset-005592`
...
- English observation: The opened raster appears uniformly blank at the
  available resolution; no distinguishable mark was visible in this review.
- 中文观察：当前分辨率下栅格图像看起来均匀空白；本次检查未见可辨痕迹。
...
- Which source records identify obs-unk-003999 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003999？
