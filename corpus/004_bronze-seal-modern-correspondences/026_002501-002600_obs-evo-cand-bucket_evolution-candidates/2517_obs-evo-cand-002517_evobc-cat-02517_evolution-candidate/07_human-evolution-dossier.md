...
- External category reference: `evobc-cat-02517`
- Source category ID: `02517`
- Source label for human review: `層`
- Source codepoints: `U+5C64`
...
- `obs-evo-cand-002517-route-category-staging`
...
- `obs-evo-cand-002517-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002517-route-evolution-graph`
