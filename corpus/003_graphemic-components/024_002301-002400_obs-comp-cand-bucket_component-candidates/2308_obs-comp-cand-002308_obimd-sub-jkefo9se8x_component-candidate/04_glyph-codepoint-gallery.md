# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002308
...
| --- | --- | --- | --- |
| `obimd-glyph-link-035733` | 󽒻 | `U+FD4BB` | `reviewed_metadata_only` |
| `obimd-glyph-link-035734` | 󽒼 | `U+FD4BC` | `reviewed_metadata_only` |
| `obimd-glyph-link-035735` | 󽒽 | `U+FD4BD` | `reviewed_metadata_only` |
| `obimd-glyph-link-035736` | 󽒾 | `U+FD4BE` | `reviewed_metadata_only` |
