...
Project ID: `obs-evo-cand-012418`
...
- Project ID: `obs-evo-cand-012418`
- EVOBC category candidate ID: `evobc-evo-cat-12418`
- External category reference: `evobc-cat-12418`
- Source category ID: `12418`
- Source label for human review: `𨚹`
- Source codepoints: `U+286B9`
...
- `obs-evo-cand-012418-route-category-staging`
...
- `obs-evo-cand-012418-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012418-route-evolution-graph`
