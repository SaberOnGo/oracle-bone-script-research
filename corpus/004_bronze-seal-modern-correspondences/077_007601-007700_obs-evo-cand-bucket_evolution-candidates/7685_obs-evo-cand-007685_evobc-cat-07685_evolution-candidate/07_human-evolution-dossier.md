...
- External category reference: `evobc-cat-07685`
- Source category ID: `07685`
- Source label for human review: `蘽`
- Source codepoints: `U+863D`
...
- `obs-evo-cand-007685-route-category-staging`
...
- `obs-evo-cand-007685-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007685-route-evolution-graph`
