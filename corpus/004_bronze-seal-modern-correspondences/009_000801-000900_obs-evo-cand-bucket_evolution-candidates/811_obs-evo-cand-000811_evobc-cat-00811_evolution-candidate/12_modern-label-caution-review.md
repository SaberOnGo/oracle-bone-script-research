# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000811
...
- EVOBC candidate category: `evobc-evo-cat-00811`.
- Source label for search only: `佝`.
- Source codepoints for search only: `U+4F5D`.
