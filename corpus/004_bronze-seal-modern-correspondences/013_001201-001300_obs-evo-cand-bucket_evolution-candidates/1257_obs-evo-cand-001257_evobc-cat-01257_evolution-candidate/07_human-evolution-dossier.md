...
- External category reference: `evobc-cat-01257`
- Source category ID: `01257`
- Source label for human review: `劍`
- Source codepoints: `U+528D`
...
- `obs-evo-cand-001257-route-category-staging`
...
- `obs-evo-cand-001257-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001257-route-evolution-graph`
