...
- External category reference: `evobc-cat-09910`
- Source category ID: `09910`
- Source label for human review: `鞍`
- Source codepoints: `U+978D`
...
- `obs-evo-cand-009910-route-category-staging`
...
- `obs-evo-cand-009910-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009910-route-evolution-graph`
