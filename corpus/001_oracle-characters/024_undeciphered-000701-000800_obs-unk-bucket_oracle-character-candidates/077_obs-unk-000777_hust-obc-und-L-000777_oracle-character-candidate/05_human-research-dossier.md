# obs-unk-000777 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000777`
- primary external id: `hust-obc-und-L-000777`
...
- local review image route: `corpus/001_oracle-characters/024_undeciphered-000
  701-000800_obs-unk-bucket_oracle-character-candidates/077_obs-unk-000777_h
  ust-obc-und-L-000777_oracle-character-candidate/03_visual-assets/001_asset
  -002370_hust-obc-und-L-000777_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/777/L_？_12279.jpg`
- asset id: `asset-002370`
...
- source class: `HUST-OBC/undeciphered/L/777/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/777/L_？_12279.jpg`
- asset id: `asset-002370`
...
- Which source records identify obs-unk-000777 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000777？
