...
Project ID: `obs-evo-cand-000176`
...
- Project ID: `obs-evo-cand-000176`
- EVOBC category candidate ID: `evobc-evo-cat-00176`
- External category reference: `evobc-cat-00176`
- Source category ID: `00176`
- Source label for human review: `㮰`
- Source codepoints: `U+3BB0`
...
- `obs-evo-cand-000176-route-category-staging`
...
- `obs-evo-cand-000176-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000176-route-evolution-graph`
