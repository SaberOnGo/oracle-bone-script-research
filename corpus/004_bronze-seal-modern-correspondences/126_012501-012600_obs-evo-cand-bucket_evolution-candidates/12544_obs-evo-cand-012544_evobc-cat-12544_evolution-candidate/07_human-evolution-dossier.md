...
- External category reference: `evobc-cat-12544`
- Source category ID: `12544`
- Source label for human review: `𩀛`
- Source codepoints: `U+2901B`
...
- `obs-evo-cand-012544-route-category-staging`
...
- `obs-evo-cand-012544-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012544-route-evolution-graph`
