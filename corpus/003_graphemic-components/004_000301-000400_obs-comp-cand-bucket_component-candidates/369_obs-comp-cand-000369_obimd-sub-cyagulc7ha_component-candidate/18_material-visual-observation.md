# Material Visual Observation / obs-comp-cand-000369 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000369`
- External reference / 外部参照: `obimd-sub-cyagulc7ha`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012292_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cyagulc7ha/cyagulc7ha/cyagulc7ha.png`
- Checksum / 校验和:
  `fdd98286dca26fefc4aec1126f9f9628d9f53b6a8697c63a28a657855bdbdabf`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.56%.
- Marked-pixel bounds: (78,36)–(171,214); span 94 × 179 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.56%。
- 痕迹范围：(78,36)–(171,214)；跨度94 × 179 px；痕迹矩形高于宽。
