...
- External category reference: `evobc-cat-08208`
- Source category ID: `08208`
- Source label for human review: `詽`
...
- `obs-evo-cand-008208-route-category-staging`
...
- `obs-evo-cand-008208-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008208-route-evolution-graph`
