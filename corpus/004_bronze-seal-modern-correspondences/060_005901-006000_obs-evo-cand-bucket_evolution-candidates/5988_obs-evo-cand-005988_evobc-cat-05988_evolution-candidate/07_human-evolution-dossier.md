...
- External category reference: `evobc-cat-05988`
- Source category ID: `05988`
- Source label for human review: `祚`
- Source codepoints: `U+795A`
...
- `obs-evo-cand-005988-route-category-staging`
...
- `obs-evo-cand-005988-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005988-route-evolution-graph`
