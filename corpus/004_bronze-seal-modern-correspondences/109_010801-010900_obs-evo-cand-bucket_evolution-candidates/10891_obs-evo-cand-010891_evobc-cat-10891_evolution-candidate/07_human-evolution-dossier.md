...
- External category reference: `evobc-cat-10891`
- Source category ID: `10891`
- Source label for human review: `𠨅`
- Source codepoints: `U+20A05`
...
- `obs-evo-cand-010891-route-category-staging`
...
- `obs-evo-cand-010891-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010891-route-evolution-graph`
