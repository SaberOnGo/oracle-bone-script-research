...
- External category reference: `evobc-cat-05486`
- Source category ID: `05486`
- Source label: `璶`
...
- `obs-evo-cand-005486-route-category-staging`
...
- `obs-evo-cand-005486-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-005486-route-evolution-graph`
