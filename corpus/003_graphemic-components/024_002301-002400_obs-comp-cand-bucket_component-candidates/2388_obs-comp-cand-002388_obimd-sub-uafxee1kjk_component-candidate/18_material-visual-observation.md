# Material Visual Observation / obs-comp-cand-002388 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002388`
- External reference / 外部参照: `obimd-sub-uafxee1kjk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020459_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/uafxee1kjk/uafxee1kjk/uafxee1kjk.png`
- Checksum / 校验和:
  `4afa47e375449f419f46a91ba325f2d566179da002433f1797446485e0fb8b3c`
...
- Marked-pixel bounds: (72,28)–(175,223); span 104 × 196 px; the marked
...
- 痕迹范围：(72,28)–(175,223)；跨度104 × 196 px；痕迹矩形高于宽。
