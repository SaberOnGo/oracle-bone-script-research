# Material Visual Observation / obs-comp-cand-000606 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000606`
- External reference / 外部参照: `obimd-sub-s9y9vbblxa`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013139_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/s9y9vbblxa/s9y9vbblxa/16x4yt5cpk.png`
- Checksum / 校验和:
  `5fa51a846d6127418554182b448e12411fd2c7c5a692eb34dec823c5b36e65c5`
...
- Marked-pixel bounds: (78,43)–(171,211); span 94 × 169 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.21%。
- 痕迹范围：(78,43)–(171,211)；跨度94 × 169 px；痕迹矩形高于宽。
