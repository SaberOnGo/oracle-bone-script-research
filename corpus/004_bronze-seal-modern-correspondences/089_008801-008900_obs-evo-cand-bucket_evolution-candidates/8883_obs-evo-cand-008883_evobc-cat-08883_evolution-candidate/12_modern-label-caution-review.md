# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008883
...
- EVOBC candidate category: `evobc-evo-cat-08883`.
- Source label for search only: `轟`.
- Source codepoints for search only: `U+8F5F`.
