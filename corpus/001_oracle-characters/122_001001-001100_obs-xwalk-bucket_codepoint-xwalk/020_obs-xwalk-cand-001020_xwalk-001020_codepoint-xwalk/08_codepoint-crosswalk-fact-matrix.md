# obs-xwalk-cand-001020 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+386F` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-1145` | not reading |
