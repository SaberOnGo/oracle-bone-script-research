...
Project ID: `obs-evo-cand-005819`
...
- Project ID: `obs-evo-cand-005819`
- EVOBC category candidate ID: `evobc-evo-cat-05819`
- External category reference: `evobc-cat-05819`
- Source category ID: `05819`
- Source label for human review: `睅`
- Source codepoints: `U+7745`
...
- `obs-evo-cand-005819-route-category-staging`
...
- `obs-evo-cand-005819-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005819-route-evolution-graph`
