...
- `obs-evo-cand-003548-route-category-staging`
...
- `obs-evo-cand-003548-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003548-route-evolution-graph`
