...
Project ID: `obs-evo-cand-012942`
...
- Project ID: `obs-evo-cand-012942`
- EVOBC category candidate ID: `evobc-evo-cat-12942`
- External category reference: `evobc-cat-12942`
- Source category ID: `12942`
- Source label for human review: `𫑂`
- Source codepoints: `U+2B442`
...
- `obs-evo-cand-012942-route-category-staging`
...
- `obs-evo-cand-012942-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012942-route-evolution-graph`
