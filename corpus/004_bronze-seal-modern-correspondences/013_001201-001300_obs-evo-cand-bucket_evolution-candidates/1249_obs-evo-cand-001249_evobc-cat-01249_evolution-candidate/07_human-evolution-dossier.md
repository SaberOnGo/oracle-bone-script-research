...
Project ID: `obs-evo-cand-001249`
...
- Project ID: `obs-evo-cand-001249`
- EVOBC category candidate ID: `evobc-evo-cat-01249`
- External category reference: `evobc-cat-01249`
- Source category ID: `01249`
- Source label for human review: `劀`
- Source codepoints: `U+5280`
...
- `obs-evo-cand-001249-route-category-staging`
...
- `obs-evo-cand-001249-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001249-route-evolution-graph`
