...
Project ID: `obs-insc-cw-cand-000013`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000013`
...
- Yingguo / 英国所藏: `y66` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `19` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `451` in source row; primary catalog entry pending
- Heji / 合集: `39602` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000013`
