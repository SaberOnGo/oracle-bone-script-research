...
- External category reference: `evobc-cat-13310`
- Source category ID: `13310`
- Source label for human review: `𬜫`
...
- `obs-evo-cand-013310-route-category-staging`
...
- `obs-evo-cand-013310-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013310-route-evolution-graph`
