...
Project ID: `obs-insc-cw-cand-000439`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000439`
...
- Yingguo / 英国所藏: `y2290` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `278` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `370` in source row; primary catalog entry pending
- Heji / 合集: `41349` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000439`
