# obs-unk-004895 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004895`
- primary external id: `hust-obc-und-X-004895`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/095_obs-unk-004895_h
  ust-obc-und-X-004895_oracle-character-candidate/03_visual-assets/001_asset
  -006488_hust-obc-und-X-004895_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/451/X_？_7431_1.png`
- asset id: `asset-006488`
...
- source class: `HUST-OBC/undeciphered/X/451/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/451/X_？_7431_1.png`
- asset id: `asset-006488`
...
- English observation: `pointed upper arch and long curved descent`
- 中文观察: `尖顶上部拱形外框和长弧形下行笔画`
...
- Which source records identify obs-unk-004895 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004895？
