# obs-char-000100 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/100_obs-char-000100_hust-obc-cat-0111_orac
  le-character/03_visual-assets/001_asset-000105_hust-obc-cat-0111_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0111/G_0111_前2.6.6(甲).png`
- asset id: `asset-000105`
...
- source category: `0111`
- validation class: `99`
- source image route: `HUST-OBC/deciphered/0111/G_0111_前2.6.6(甲).png`
- asset id: `asset-000105`
...
- dataset label text: `㑥`
- dataset label codepoints: `U+3465`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/011_obs-evo-can
  d-000011_evobc-cat-00011_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/011_obs-evo-cand-000011_evobc-cat-00011_evolu
...
- Which source records identify obs-char-000100 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000100？
