...
- External category reference: `evobc-cat-06520`
- Source category ID: `06520`
- Source label for human review: `絭`
- Source codepoints: `U+7D6D`
...
- `obs-evo-cand-006520-route-category-staging`
...
- `obs-evo-cand-006520-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006520-route-evolution-graph`
