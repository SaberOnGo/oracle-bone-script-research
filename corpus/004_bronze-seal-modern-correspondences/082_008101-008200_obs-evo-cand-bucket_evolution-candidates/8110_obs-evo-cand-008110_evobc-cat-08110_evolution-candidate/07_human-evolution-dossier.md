...
- External category reference: `evobc-cat-08110`
- Source category ID: `08110`
- Source label for human review: `觱`
...
- `obs-evo-cand-008110-route-category-staging`
...
- `obs-evo-cand-008110-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008110-route-evolution-graph`
