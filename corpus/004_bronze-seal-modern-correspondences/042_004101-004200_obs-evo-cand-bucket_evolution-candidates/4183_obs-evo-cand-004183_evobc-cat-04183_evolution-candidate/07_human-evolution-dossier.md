...
Project ID: `obs-evo-cand-004183`
...
- Project ID: `obs-evo-cand-004183`
- EVOBC category candidate ID: `evobc-evo-cat-04183`
- External category reference: `evobc-cat-04183`
- Source category ID: `04183`
- Source label for human review: `榛`
- Source codepoints: `U+699B`
...
- `obs-evo-cand-004183-route-category-staging`
...
- `obs-evo-cand-004183-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004183-route-evolution-graph`
