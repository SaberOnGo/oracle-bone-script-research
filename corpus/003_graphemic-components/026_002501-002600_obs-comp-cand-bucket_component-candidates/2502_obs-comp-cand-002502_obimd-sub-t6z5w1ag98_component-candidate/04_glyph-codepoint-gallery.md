# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002502
...
| --- | --- | --- | --- |
| `obimd-glyph-link-038366` | 󾎓 | `U+FE393` | `reviewed_metadata_only` |
| `obimd-glyph-link-038367` | 󾎔 | `U+FE394` | `reviewed_metadata_only` |
| `obimd-glyph-link-038368` | 󾎕 | `U+FE395` | `reviewed_metadata_only` |
| `obimd-glyph-link-038369` | 󾎖 | `U+FE396` | `reviewed_metadata_only` |
| `obimd-glyph-link-038370` | 󾎗 | `U+FE397` | `reviewed_metadata_only` |
