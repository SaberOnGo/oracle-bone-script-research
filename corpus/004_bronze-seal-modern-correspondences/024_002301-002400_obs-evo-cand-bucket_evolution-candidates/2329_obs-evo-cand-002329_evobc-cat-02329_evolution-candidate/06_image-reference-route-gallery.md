...
- `obs-evo-cand-002329-route-category-staging`
...
- `obs-evo-cand-002329-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002329-route-evolution-graph`
