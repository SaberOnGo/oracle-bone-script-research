# obs-char-000450 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000450`
- primary external id: `hust-obc-cat-0510`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/450_obs-char-000450_hust-obc-cat-0510_orac
  le-character/03_visual-assets/001_asset-000455_hust-obc-cat-0510_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0510/L_0510_5414.jpg`
- asset id: `asset-000455`
...
- source category: `0510`
- validation class: `449`
- source image route: `HUST-OBC/deciphered/0510/L_0510_5414.jpg`
- asset id: `asset-000455`
...
- English observation: `The very small low-contrast image shows two similar
  separated forms, each with a small outlined top and two thin strokes
  descending at angles.`
- 中文观察: `极小低对比度图像显示两个相似分离形体，各有小型轮廓顶部和两条斜向下垂的细笔。`
...
- dataset label text: `㗴`
- dataset label codepoints: `U+35F4`
...
- Which source records identify obs-char-000450 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000450？
