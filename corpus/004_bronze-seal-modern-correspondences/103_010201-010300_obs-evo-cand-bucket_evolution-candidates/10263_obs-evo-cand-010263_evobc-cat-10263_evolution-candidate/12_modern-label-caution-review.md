# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010263
...
- EVOBC candidate category: `evobc-evo-cat-10263`.
- Source label for search only: `驤`.
- Source codepoints for search only: `U+9A64`.
