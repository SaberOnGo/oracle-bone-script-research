...
Project ID: `obs-evo-cand-006281`
...
- Project ID: `obs-evo-cand-006281`
- EVOBC category candidate ID: `evobc-evo-cat-06281`
- External category reference: `evobc-cat-06281`
- Source category ID: `06281`
- Source label for human review: `签`
- Source codepoints: `U+7B7E`
...
- `obs-evo-cand-006281-route-category-staging`
...
- `obs-evo-cand-006281-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006281-route-evolution-graph`
