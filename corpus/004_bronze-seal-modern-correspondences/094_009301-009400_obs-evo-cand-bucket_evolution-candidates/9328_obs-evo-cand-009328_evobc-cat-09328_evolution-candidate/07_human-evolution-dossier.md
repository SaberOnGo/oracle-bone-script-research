...
- External category reference: `evobc-cat-09328`
- Source category ID: `09328`
- Source label for human review: `鈇`
- Source codepoints: `U+9207`
...
- `obs-evo-cand-009328-route-category-staging`
...
- `obs-evo-cand-009328-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009328-route-evolution-graph`
