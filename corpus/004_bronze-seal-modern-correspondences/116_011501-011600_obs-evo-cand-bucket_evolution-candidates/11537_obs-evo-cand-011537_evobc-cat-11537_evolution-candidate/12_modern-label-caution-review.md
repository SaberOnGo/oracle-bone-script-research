# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-011537
...
- EVOBC candidate category: `evobc-evo-cat-11537`.
- Source label for search only: `𣽊`.
- Source codepoints for search only: `U+23F4A`.
