# obs-unk-005219 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005219`
- primary external id: `hust-obc-und-X-005219`
...
- local review image route: `corpus/001_oracle-characters/069_undeciphered-005
  201-005300_obs-unk-bucket_oracle-character-candidates/019_obs-unk-005219_h
  ust-obc-und-X-005219_oracle-character-candidate/03_visual-assets/001_asset
  -006812_hust-obc-und-X-005219_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/775/X_？_7740_1.png`
- asset id: `asset-006812`
...
- source class: `HUST-OBC/undeciphered/X/775/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/775/X_？_7740_1.png`
- asset id: `asset-006812`
...
- Which source records identify obs-unk-005219 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005219？
