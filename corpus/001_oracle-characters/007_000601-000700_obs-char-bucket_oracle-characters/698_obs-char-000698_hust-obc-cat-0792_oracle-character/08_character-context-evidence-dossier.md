...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0792`
...
- Source image / 来源图: `G_0792_合22942出組.png`
- Image / 图像: `001_asset-000703_hust-obc-cat-0792_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合22942
  (G_0792_合22942出組.png)`
...
- target node: `evobc-evo-cat-00060`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/060_obs-evo-cand-000060_evobc-cat-00060_evoluti
...
- Source label text / 来源标签文字: `㜎`
- Source label codepoint / 来源标签 codepoint: `U+370E`
