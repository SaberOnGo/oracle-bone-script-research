...
- `obs-evo-cand-002723-route-category-staging`
...
- `obs-evo-cand-002723-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002723-route-evolution-graph`
