# obs-char-000345 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000345`
- primary external id: `hust-obc-cat-0390`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/345_obs-char-000345_hust-obc-cat-0390_orac
  le-character/03_visual-assets/001_asset-000350_hust-obc-cat-0390_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0390/G_0390_乙1731合9753.png`
- asset id: `asset-000350`
...
- source category: `0390`
- validation class: `344`
- source image route: `HUST-OBC/deciphered/0390/G_0390_乙1731合9753.png`
- asset id: `asset-000350`
...
- dataset label text: `㕼`
- dataset label codepoints: `U+357C`
...
- filename catalog route clues: `Heji-like filename clue: 合9753
  (G_0390_乙1731合9753.png)`
...
- Which source records identify obs-char-000345 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000345？
