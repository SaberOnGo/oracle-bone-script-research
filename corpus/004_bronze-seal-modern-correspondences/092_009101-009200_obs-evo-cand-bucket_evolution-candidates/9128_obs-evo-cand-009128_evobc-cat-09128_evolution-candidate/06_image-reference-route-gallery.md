...
- `obs-evo-cand-009128-route-category-staging`
...
- `obs-evo-cand-009128-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009128-route-evolution-graph`
