# obs-char-000632 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/632_obs-char-000632_hust-obc-cat-0718_0719
  _oracle-character/03_visual-assets/001_asset-000637_hust-obc-cat-0718_0719
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0718_0719/0718/G_0718_乙1128反.pn
  g`
- asset id: `asset-000637`
...
- source category: `0718_0719`
- validation class: `631`
- source image route: `HUST-OBC/deciphered/0718_0719/0718/G_0718_乙1128反.png`
- asset id: `asset-000637`
...
- English observation: `A single tall irregular outline encloses two stacked
  rectangular spaces separated by a thick middle divider, with uneven
  corners and sides.`
- 中文观察: `单个高长不规则外框包围两个由粗中隔分开的层叠矩形空隙，边角和侧边不齐。`
...
- dataset label text: `㛄㛅`
- dataset label codepoints: `U+36C4;U+36C5`
...
- graph edge count: `2`
- codepoint routes: `U+36C4;U+36C5`
...
- Which source records identify obs-char-000632 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000632？
