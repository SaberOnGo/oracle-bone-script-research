# obs-char-000865 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000865`
- primary external id: `hust-obc-cat-0975`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/865_obs-char-000865_hust-obc-cat-0975_orac
  le-character/03_visual-assets/001_asset-000870_hust-obc-cat-0975_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0975/G_0975_後1.15.2合24452.png`
- asset id: `asset-000870`
...
- source category: `0975`
- validation class: `864`
- source image route: `HUST-OBC/deciphered/0975/G_0975_後1.15.2合24452.png`
- asset id: `asset-000870`
...
- English observation: `A rounded rectangular enclosure contains several
  long vertical internal strokes; their lower ends remain visibly separate.`
...
- dataset label text: `㟅`
- dataset label codepoints: `U+37C5`
...
- filename catalog route clues: `Heji-like filename clue: 合24452
  (G_0975_後1.15.2合24452.png)`
...
- Which source records identify obs-char-000865 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000865？
