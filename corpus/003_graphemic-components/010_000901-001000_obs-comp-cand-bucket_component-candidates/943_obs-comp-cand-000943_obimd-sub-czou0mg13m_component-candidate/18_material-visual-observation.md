# Material Visual Observation / obs-comp-cand-000943 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000943`
- External reference / 外部参照: `obimd-sub-czou0mg13m`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014026_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/czou0mg13m/czou0mg13m/czou0mg13m.png`
- Checksum / 校验和:
  `2aa6c629fe281f6117e9319837a5b5a1fbb221d9add3fff5c6a3437bf4d3162c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.16%.
- Marked-pixel bounds: (57,45)–(184,209); span 128 × 165 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.16%。
- 痕迹范围：(57,45)–(184,209)；跨度128 × 165 px；痕迹矩形高于宽。
