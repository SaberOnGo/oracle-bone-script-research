...
Project ID: `obs-evo-cand-000047`
...
- Project ID: `obs-evo-cand-000047`
- EVOBC category candidate ID: `evobc-evo-cat-00047`
- External category reference: `evobc-cat-00047`
- Source category ID: `00047`
- Source label for human review: `㚩`
- Source codepoints: `U+36A9`
...
- `obs-evo-cand-000047-route-category-staging`
...
- `obs-evo-cand-000047-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000047-route-evolution-graph`
