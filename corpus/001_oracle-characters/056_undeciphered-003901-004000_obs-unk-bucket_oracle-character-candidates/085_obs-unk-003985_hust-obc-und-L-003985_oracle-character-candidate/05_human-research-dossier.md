# obs-unk-003985 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003985`
- primary external id: `hust-obc-und-L-003985`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/085_obs-unk-003985_h
  ust-obc-und-L-003985_oracle-character-candidate/03_visual-assets/001_asset
  -005578_hust-obc-und-L-003985_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3985/L_？_8439.jpg`
- asset id: `asset-005578`
...
- source class: `HUST-OBC/undeciphered/L/3985/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3985/L_？_8439.jpg`
- asset id: `asset-005578`
...
- English observation: The upper trace has short upright branches; a narrow
  central mark descends into several curved or angled lower strokes.
- 中文观察：上部痕迹带有短直立分支；中部痕迹向下延伸至数条弯曲或斜向痕迹。
...
- Which source records identify obs-unk-003985 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003985？
