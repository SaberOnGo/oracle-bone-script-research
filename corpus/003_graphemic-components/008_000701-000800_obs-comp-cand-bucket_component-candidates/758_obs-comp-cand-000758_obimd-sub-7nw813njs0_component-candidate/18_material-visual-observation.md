# Material Visual Observation / obs-comp-cand-000758 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000758`
- External reference / 外部参照: `obimd-sub-7nw813njs0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013522_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7nw813njs0/7nw813njs0/7nw813njs0.png`
- Checksum / 校验和:
  `0c06dc2ac848480325bdb76ef46d051e7e1885d12a10dc834788ad7f61a9211f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.32%.
- Marked-pixel bounds: (73,24)–(176,228); span 104 × 205 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.32%。
- 痕迹范围：(73,24)–(176,228)；跨度104 × 205 px；痕迹矩形高于宽。
