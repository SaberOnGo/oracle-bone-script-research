# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008894
...
- EVOBC candidate category: `evobc-evo-cat-08894`.
- Source label for search only: `轻`.
- Source codepoints for search only: `U+8F7B`.
