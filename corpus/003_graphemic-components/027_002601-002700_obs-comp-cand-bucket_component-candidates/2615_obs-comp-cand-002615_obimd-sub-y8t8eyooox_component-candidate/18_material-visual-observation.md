# Material Visual Observation / obs-comp-cand-002615 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002615`
- External reference / 外部参照: `obimd-sub-y8t8eyooox`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021154_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/y8t8eyooox/y8t8eyooox/y8t8eyooox.png`
- Checksum / 校验和:
  `5c9f38832fc9a39adb88dcb10836dd08da0d32afc3254d46ea593d927ac40b45`
...
- Marked-pixel bounds: (84,15)–(177,239); span 94 × 225 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.96%。
- 痕迹范围：(84,15)–(177,239)；跨度94 × 225 px；痕迹矩形高于宽。
