...
- Yingguo / 英国所藏: `y2013` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `509` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `27` in source row; primary catalog entry pending
