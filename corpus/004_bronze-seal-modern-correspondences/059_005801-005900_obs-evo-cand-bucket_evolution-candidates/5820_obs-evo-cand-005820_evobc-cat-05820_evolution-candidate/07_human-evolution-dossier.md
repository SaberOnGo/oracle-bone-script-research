...
- Project ID: `obs-evo-cand-005820`
- EVOBC category candidate ID: `evobc-evo-cat-05820`
- External category reference: `evobc-cat-05820`
- Source category ID: `05820`
- Source label for human review: `睇`
- Source codepoints: `U+7747`
...
- `obs-evo-cand-005820-route-category-staging`
...
- `obs-evo-cand-005820-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005820-route-evolution-graph`
