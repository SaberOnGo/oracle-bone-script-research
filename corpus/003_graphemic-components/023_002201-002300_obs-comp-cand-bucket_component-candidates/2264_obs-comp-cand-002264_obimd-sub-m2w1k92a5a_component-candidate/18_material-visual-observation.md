# Material Visual Observation / obs-comp-cand-002264 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002264`
- External reference / 外部参照: `obimd-sub-m2w1k92a5a`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020077_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/m2w1k92a5a/m2w1k92a5a/0soo2chvzb.png`
- Checksum / 校验和:
  `8023f0e622a48e592fb2e9102c0a206da056eeb3b54956d1a8b9c96a11392bef`
...
- Marked-pixel bounds: (71,43)–(178,200); span 108 × 158 px; the marked
...
- 痕迹范围：(71,43)–(178,200)；跨度108 × 158 px；痕迹矩形高于宽。
