# Material Visual Observation / obs-comp-cand-001296 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001296`
- External reference / 外部参照: `obimd-sub-hcsv6oxj1l`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015633_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hcsv6oxj1l/hcsv6oxj1l/hcsv6oxj1l.png`
- Checksum / 校验和:
  `e8e2416a08140065d82c084aaec97aec2c0da659aa5ccde9b5c546bea896bd98`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.25%.
- Marked-pixel bounds: (71,26)–(180,220); span 110 × 195 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.25%。
- 痕迹范围：(71,26)–(180,220)；跨度110 × 195 px；痕迹矩形高于宽。
