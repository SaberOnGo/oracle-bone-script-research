...
- External category reference: `evobc-cat-12159`
- Source category ID: `12159`
- Source label for human review: `𧍓`
...
- `obs-evo-cand-012159-route-category-staging`
...
- `obs-evo-cand-012159-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012159-route-evolution-graph`
