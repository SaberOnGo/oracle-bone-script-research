# Material Visual Observation / obs-comp-cand-000166 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000166`
- External reference / 外部参照: `obimd-sub-mej5mbo9gj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011578_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lxao6q3l56/mej5mbo9gj/mej5mbo9gj.png`
- Checksum / 校验和:
  `65e942b37d15a6b69c71014b26ba6c8e0ba22085a900014c342721c4adec1154`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.94%.
- Marked-pixel bounds: (93,21)–(156,217); span 64 × 197 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.94%。
- 痕迹范围：(93,21)–(156,217)；跨度64 × 197 px；痕迹矩形高于宽。
