# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006158
...
- EVOBC candidate category: `evobc-evo-cat-06158`.
- Source label for search only: `窊`.
- Source codepoints for search only: `U+7A8A`.
