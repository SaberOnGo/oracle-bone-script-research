...
- Yingguo / 英国所藏: `y408` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `55` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `481` in source row; primary catalog entry pending
- Heji / 合集: `39538` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000061`
