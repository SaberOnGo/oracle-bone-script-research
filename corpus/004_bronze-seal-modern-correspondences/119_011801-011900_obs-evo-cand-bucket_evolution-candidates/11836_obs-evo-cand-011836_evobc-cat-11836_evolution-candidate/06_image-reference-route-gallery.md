...
- `obs-evo-cand-011836-route-category-staging`
...
- `obs-evo-cand-011836-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011836-route-evolution-graph`
