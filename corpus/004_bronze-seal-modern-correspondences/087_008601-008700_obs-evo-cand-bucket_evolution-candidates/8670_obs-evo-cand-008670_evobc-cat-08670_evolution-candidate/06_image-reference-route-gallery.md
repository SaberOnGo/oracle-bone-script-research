...
- `obs-evo-cand-008670-route-category-staging`
...
- `obs-evo-cand-008670-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008670-route-evolution-graph`
