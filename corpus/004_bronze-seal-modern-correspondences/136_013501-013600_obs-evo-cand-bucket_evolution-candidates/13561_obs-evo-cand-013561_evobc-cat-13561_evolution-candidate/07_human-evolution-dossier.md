...
Project ID: `obs-evo-cand-013561`
...
- Project ID: `obs-evo-cand-013561`
- EVOBC category candidate ID: `evobc-evo-cat-13561`
- External category reference: `evobc-cat-13561`
- Source category ID: `13561`
- Source label for human review: `𭭞`
- Source codepoints: `U+2DB5E`
...
- `obs-evo-cand-013561-route-category-staging`
...
- `obs-evo-cand-013561-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013561-route-evolution-graph`
