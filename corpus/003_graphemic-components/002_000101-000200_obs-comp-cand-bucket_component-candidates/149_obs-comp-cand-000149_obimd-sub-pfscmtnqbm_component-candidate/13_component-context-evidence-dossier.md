# obs-comp-cand-000149 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000149`
- 首选外部 ID: `obimd-sub-pfscmtnqbm`
- OBIMD subcharacter UID: `pfscmtnqbm`
- OBIMD main character UID: `pfscmtnqbm`
- 来源 ID: `src-obimd`
