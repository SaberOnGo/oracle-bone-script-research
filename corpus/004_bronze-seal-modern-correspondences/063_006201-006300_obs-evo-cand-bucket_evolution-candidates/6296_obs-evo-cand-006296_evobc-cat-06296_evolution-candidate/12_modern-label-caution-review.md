# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006296
...
- EVOBC candidate category: `evobc-evo-cat-06296`.
- Source label for search only: `箛`.
- Source codepoints for search only: `U+7B9B`.
