# Material Visual Observation / obs-comp-cand-000673 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000673`
- External reference / 外部参照: `obimd-sub-p5mp3xbn99`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013236_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/p5mp3xbn99/p5mp3xbn99/p5mp3xbn99.png`
- Checksum / 校验和:
  `133a9820f3384de4f0d882ad92b0078abff7edfe58f4bd3b0b99e0846ca4508c`
...
- Marked-pixel bounds: (56,36)–(194,216); span 139 × 181 px; the marked
...
- 痕迹范围：(56,36)–(194,216)；跨度139 × 181 px；痕迹矩形高于宽。
