...
- External category reference: `evobc-cat-09803`
- Source category ID: `09803`
- Source label for human review: `雃`
- Source codepoints: `U+96C3`
...
- `obs-evo-cand-009803-route-category-staging`
...
- `obs-evo-cand-009803-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009803-route-evolution-graph`
