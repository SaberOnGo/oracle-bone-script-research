# obs-char-000229 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000229`
- primary external id: `hust-obc-cat-0255`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/229_obs-char-000229_hust-obc-cat-0255_orac
  le-character/03_visual-assets/001_asset-000234_hust-obc-cat-0255_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0255/H_0255_61607_0.png`
- asset id: `asset-000234`
...
- source category: `0255`
- validation class: `228`
- source image route: `HUST-OBC/deciphered/0255/H_0255_61607_0.png`
- asset id: `asset-000234`
...
- English observation: `The large image has a deep rounded outer frame, a
  pointed inner crossing form, two stacked lower enclosures, and a separate
  right upright.`
- 中文观察: `大幅图像有深圆弧外框，内部有尖状交叉形，下方有两层叠置围合，右侧另有竖笔。`
...
- dataset label text: `㓵`
- dataset label codepoints: `U+34F5`
...
- filename catalog route clues: `catalog-like filename clue: H_0255
  (H_0255_61607_0.png)`
...
- Which source records identify obs-char-000229 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000229？
