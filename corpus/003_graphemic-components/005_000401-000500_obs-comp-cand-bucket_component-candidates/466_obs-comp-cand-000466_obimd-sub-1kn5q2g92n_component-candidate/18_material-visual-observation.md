# Material Visual Observation / obs-comp-cand-000466 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000466`
- External reference / 外部参照: `obimd-sub-1kn5q2g92n`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012614_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8gro2b24ja/1kn5q2g92n/1kn5q2g92n.png`
- Checksum / 校验和:
  `4eaf609567c0011335ff2ef95a370a1908a3a5361c8b40ffa069701a3727edd4`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.08%.
- Marked-pixel bounds: (75,52)–(187,202); span 113 × 151 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.08%。
- 痕迹范围：(75,52)–(187,202)；跨度113 × 151 px；痕迹矩形高于宽。
