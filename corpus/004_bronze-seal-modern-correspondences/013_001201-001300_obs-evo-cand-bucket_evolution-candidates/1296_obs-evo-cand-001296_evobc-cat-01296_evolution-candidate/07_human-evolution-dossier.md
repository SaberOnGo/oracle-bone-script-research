...
- External category reference: `evobc-cat-01296`
- Source category ID: `01296`
- Source label for human review: `勘`
- Source codepoints: `U+52D8`
...
- `obs-evo-cand-001296-route-category-staging`
...
- `obs-evo-cand-001296-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001296-route-evolution-graph`
