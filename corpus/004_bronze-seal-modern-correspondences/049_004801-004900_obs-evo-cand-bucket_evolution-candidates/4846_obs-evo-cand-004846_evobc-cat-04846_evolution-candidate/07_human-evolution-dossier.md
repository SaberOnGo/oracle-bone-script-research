...
Project ID: `obs-evo-cand-004846`
...
- Project ID: `obs-evo-cand-004846`
- EVOBC category candidate ID: `evobc-evo-cat-04846`
- External category reference: `evobc-cat-04846`
- Source category ID: `04846`
- Source label for human review: `滞`
- Source codepoints: `U+6EDE`
...
- `obs-evo-cand-004846-route-category-staging`
...
- `obs-evo-cand-004846-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004846-route-evolution-graph`
