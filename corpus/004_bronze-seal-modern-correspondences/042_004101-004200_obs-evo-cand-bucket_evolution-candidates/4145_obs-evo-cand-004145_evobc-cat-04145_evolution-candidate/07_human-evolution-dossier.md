...
- External category reference: `evobc-cat-04145`
- Source category ID: `04145`
- Source label for human review: `楋`
- Source codepoints: `U+694B`
...
- `obs-evo-cand-004145-route-category-staging`
...
- `obs-evo-cand-004145-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004145-route-evolution-graph`
