# obs-char-000028 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000028`
- primary external id: `hust-obc-cat-0033`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/028_obs-char-000028_hust-obc-cat-0033_orac
  le-character/03_visual-assets/001_asset-000033_hust-obc-cat-0033_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0033/X_0033_828_1.png`
- asset id: `asset-000033`
...
- source category: `0033`
- validation class: `27`
- source image route: `HUST-OBC/deciphered/0033/X_0033_828_1.png`
- asset id: `asset-000033`
...
- English observation: `The image contains a broad lower enclosure, an upper
  looped mark, and two detached strokes to the right.`
- 中文观察: `图像含宽大的下部框形、上方环状痕迹，右侧另有两条分离笔画。`
...
- dataset label text: `㐗`
- dataset label codepoints: `U+3417`
...
- Which source records identify obs-char-000028 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000028？
