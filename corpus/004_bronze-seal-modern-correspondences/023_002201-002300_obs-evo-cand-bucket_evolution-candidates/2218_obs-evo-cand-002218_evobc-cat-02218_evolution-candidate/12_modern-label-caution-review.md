# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002218
...
- EVOBC candidate category: `evobc-evo-cat-02218`.
- Source label for search only: `婾`.
- Source codepoints for search only: `U+5A7E`.
