...
- External category reference: `evobc-cat-05286`
- Source category ID: `05286`
- Source label for human review: `狾`
- Source codepoints: `U+72FE`
...
- `obs-evo-cand-005286-route-category-staging`
...
- `obs-evo-cand-005286-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005286-route-evolution-graph`
