...
Project ID: `obs-evo-cand-002534`
...
- Project ID: `obs-evo-cand-002534`
- EVOBC category candidate ID: `evobc-evo-cat-02534`
- External category reference: `evobc-cat-02534`
- Source category ID: `02534`
- Source label for human review: `岌`
- Source codepoints: `U+5C8C`
...
- `obs-evo-cand-002534-route-category-staging`
...
- `obs-evo-cand-002534-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002534-route-evolution-graph`
