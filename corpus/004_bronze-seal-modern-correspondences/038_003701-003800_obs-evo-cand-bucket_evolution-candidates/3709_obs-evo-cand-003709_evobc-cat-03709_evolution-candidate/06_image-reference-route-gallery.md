...
- `obs-evo-cand-003709-route-category-staging`
...
- `obs-evo-cand-003709-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003709-route-evolution-graph`
