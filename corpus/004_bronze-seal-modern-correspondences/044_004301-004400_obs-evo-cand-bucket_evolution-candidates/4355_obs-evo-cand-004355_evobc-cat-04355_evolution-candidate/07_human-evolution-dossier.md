...
Project ID: `obs-evo-cand-004355`
...
- Project ID: `obs-evo-cand-004355`
- EVOBC category candidate ID: `evobc-evo-cat-04355`
- External category reference: `evobc-cat-04355`
- Source category ID: `04355`
- Source label for human review: `欻`
- Source codepoints: `U+6B3B`
...
- `obs-evo-cand-004355-route-category-staging`
...
- `obs-evo-cand-004355-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004355-route-evolution-graph`
