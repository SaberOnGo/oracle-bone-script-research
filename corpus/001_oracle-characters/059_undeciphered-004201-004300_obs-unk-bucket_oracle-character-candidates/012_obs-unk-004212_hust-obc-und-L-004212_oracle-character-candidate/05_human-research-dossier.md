# obs-unk-004212 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004212`
- primary external id: `hust-obc-und-L-004212`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/012_obs-unk-004212_h
  ust-obc-und-L-004212_oracle-character-candidate/03_visual-assets/001_asset
  -005805_hust-obc-und-L-004212_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4212/L_？_9191.jpg`
- asset id: `asset-005805`
...
- source class: `HUST-OBC/undeciphered/L/4212/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4212/L_？_9191.jpg`
- asset id: `asset-005805`
...
- English observation: `Upper block, right trace, and lower curve visible.`
- 中文观察: `上部区域、右侧痕迹和下部弧形可见。`
...
- Which source records identify obs-unk-004212 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004212？
