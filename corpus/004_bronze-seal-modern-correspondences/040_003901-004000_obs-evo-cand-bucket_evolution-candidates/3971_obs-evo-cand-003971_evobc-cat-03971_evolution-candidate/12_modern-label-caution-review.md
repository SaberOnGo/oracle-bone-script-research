# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003971
...
- EVOBC candidate category: `evobc-evo-cat-03971`.
- Source label for search only: `柬`.
- Source codepoints for search only: `U+67EC`.
