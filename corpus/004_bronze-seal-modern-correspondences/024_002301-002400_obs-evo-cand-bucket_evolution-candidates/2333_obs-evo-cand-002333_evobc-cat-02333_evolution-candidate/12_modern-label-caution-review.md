# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002333
...
- EVOBC candidate category: `evobc-evo-cat-02333`.
- Source label for search only: `孚`.
- Source codepoints for search only: `U+5B5A`.
