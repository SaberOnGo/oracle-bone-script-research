# Material Visual Observation / obs-comp-cand-000208 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000208`
- External reference / 外部参照: `obimd-sub-pa13rewdd9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011769_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/pa13rewdd9/pa13rewdd9/06h1p8u7hn.png`
- Checksum / 校验和:
  `4b76617bbcf5f62d050d0b81f17e0f0de98e7be8c90133e5b740a10d2bc6e6f3`
...
- Marked-pixel bounds: (80,17)–(169,232); span 90 × 216 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.22%。
- 痕迹范围：(80,17)–(169,232)；跨度90 × 216 px；痕迹矩形高于宽。
