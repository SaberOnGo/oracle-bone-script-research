...
- External category reference: `evobc-cat-01897`
- Source category ID: `01897`
- Source label for human review: `堇`
...
- `obs-evo-cand-001897-route-category-staging`
...
- `obs-evo-cand-001897-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001897-route-evolution-graph`
