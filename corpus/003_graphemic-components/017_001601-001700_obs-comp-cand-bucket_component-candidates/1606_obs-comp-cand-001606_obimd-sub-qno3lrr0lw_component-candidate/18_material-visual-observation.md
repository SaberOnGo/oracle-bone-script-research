# Material Visual Observation / obs-comp-cand-001606 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001606`
- External reference / 外部参照: `obimd-sub-qno3lrr0lw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017282_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wujt49n5q0/qno3lrr0lw/qno3lrr0lw.png`
- Checksum / 校验和:
  `19306910987208c22c75054c747d39fe992cb4b3cdb04a06fe73dc227495c2db`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.01%.
- Marked-pixel bounds: (93,17)–(172,232); span 80 × 216 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.01%。
- 痕迹范围：(93,17)–(172,232)；跨度80 × 216 px；痕迹矩形高于宽。
