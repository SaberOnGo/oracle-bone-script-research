...
- External category reference: `evobc-cat-06674`
- Source category ID: `06674`
- Source label for human review: `繕`
...
- `obs-evo-cand-006674-route-category-staging`
...
- `obs-evo-cand-006674-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006674-route-evolution-graph`
