# obs-unk-004762 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/062_obs-unk-004762_h
  ust-obc-und-X-004762_oracle-character-candidate/03_visual-assets/001_asset
  -006355_hust-obc-und-X-004762_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/318/X_？_7302_1.png`
- asset id: `asset-006355`
...
- source class: `HUST-OBC/undeciphered/X/318/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/318/X_？_7302_1.png`
- asset id: `asset-006355`
...
- English observation: `dense sloping group with multiple pale openings`
- 中文观察: `带多个浅色开口的密集斜向结构`
...
- Which source records identify obs-unk-004762 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004762？
