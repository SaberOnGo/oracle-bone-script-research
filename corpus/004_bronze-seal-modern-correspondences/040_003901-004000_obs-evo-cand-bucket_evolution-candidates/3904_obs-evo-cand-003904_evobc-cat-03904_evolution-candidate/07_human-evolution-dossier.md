...
Project ID: `obs-evo-cand-003904`
...
- Project ID: `obs-evo-cand-003904`
- EVOBC category candidate ID: `evobc-evo-cat-03904`
- External category reference: `evobc-cat-03904`
- Source category ID: `03904`
- Source label for human review: `杺`
- Source codepoints: `U+677A`
...
- `obs-evo-cand-003904-route-category-staging`
...
- `obs-evo-cand-003904-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003904-route-evolution-graph`
