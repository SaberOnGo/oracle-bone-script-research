# Material Visual Observation / obs-comp-cand-001322 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001322`
- External reference / 外部参照: `obimd-sub-zdpjpcrjtm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015659_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ls1cvnh96s/zdpjpcrjtm/zdpjpcrjtm.png`
- Checksum / 校验和:
  `c08af23996c3a3dadfc7614e0eea5b18905aadd4c9122fed7a7ebb15edb1f0bb`
...
- Marked-pixel bounds: (80,19)–(168,231); span 89 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.29%。
- 痕迹范围：(80,19)–(168,231)；跨度89 × 213 px；痕迹矩形高于宽。
