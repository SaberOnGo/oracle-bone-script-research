# obs-char-000272 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000272`
- primary external id: `hust-obc-cat-0307`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/272_obs-char-000272_hust-obc-cat-0307_orac
  le-character/03_visual-assets/001_asset-000277_hust-obc-cat-0307_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0307/G_0307_乙103合20927.png`
- asset id: `asset-000277`
...
- source category: `0307`
- validation class: `271`
- source image route: `HUST-OBC/deciphered/0307/G_0307_乙103合20927.png`
- asset id: `asset-000277`
...
- English observation: `The image shows two separated upright forms; each
  has a curved upper end, a short diagonal branch, and a tapering lower
  stroke.`
- 中文观察: `图像有两个分离的直立形体；各自上端弯曲，并有短斜向分支和渐细下行笔画。`
...
- dataset label text: `㔩`
- dataset label codepoints: `U+3529`
...
- filename catalog route clues: `Heji-like filename clue: 合20927
  (G_0307_乙103合20927.png)`
...
- Which source records identify obs-char-000272 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000272？
