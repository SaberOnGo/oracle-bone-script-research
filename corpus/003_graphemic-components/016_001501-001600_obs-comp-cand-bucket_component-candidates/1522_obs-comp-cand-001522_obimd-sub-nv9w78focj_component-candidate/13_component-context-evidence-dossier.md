# obs-comp-cand-001522 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001522`
- 首选外部 ID: `obimd-sub-nv9w78focj`
- OBIMD subcharacter UID: `nv9w78focj`
- OBIMD main character UID: `nv9w78focj`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `7`
- codepoint 示例: U+C7C23;U+F8F7F; U+F8F80; 另有 5 项
