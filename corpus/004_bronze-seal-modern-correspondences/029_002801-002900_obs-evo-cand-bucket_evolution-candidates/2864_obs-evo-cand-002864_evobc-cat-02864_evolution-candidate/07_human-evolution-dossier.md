...
Project ID: `obs-evo-cand-002864`
...
- Project ID: `obs-evo-cand-002864`
- EVOBC category candidate ID: `evobc-evo-cat-02864`
- External category reference: `evobc-cat-02864`
- Source category ID: `02864`
- Source label for human review: `很`
- Source codepoints: `U+5F88`
...
- `obs-evo-cand-002864-route-category-staging`
...
- `obs-evo-cand-002864-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002864-route-evolution-graph`
