# obs-unk-004952 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/052_obs-unk-004952_h
  ust-obc-und-X-004952_oracle-character-candidate/03_visual-assets/001_asset
  -006545_hust-obc-und-X-004952_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/508/X_？_7490_1.png`
- asset id: `asset-006545`
...
- Two separated narrow groups have small openings and curved descents.
- The single source view is present locally.
- 直接记录：`14_material-visual-observation.md`
- 两组分开的狭窄结构各有小开口和弧形下行笔画。
- 单一来源视图已在本地保存。
...
- source class: `HUST-OBC/undeciphered/X/508/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/508/X_？_7490_1.png`
- asset id: `asset-006545`
...
- Which source records identify obs-unk-004952 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004952？
