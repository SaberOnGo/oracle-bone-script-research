...
- Project ID: `obs-evo-cand-000295`
- EVOBC category candidate ID: `evobc-evo-cat-00295`
- External category reference: `evobc-cat-00295`
- Source category ID: `00295`
- Source label for human review: `䇃`
- Source codepoints: `U+41C3`
...
- `obs-evo-cand-000295-route-category-staging`
...
- `obs-evo-cand-000295-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000295-route-evolution-graph`
