...
Project ID: `obs-evo-cand-009889`
...
- Project ID: `obs-evo-cand-009889`
- EVOBC category candidate ID: `evobc-evo-cat-09889`
- External category reference: `evobc-cat-09889`
- Source category ID: `09889`
- Source label for human review: `面`
- Source codepoints: `U+9762`
...
- `obs-evo-cand-009889-route-category-staging`
...
- `obs-evo-cand-009889-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009889-route-evolution-graph`
