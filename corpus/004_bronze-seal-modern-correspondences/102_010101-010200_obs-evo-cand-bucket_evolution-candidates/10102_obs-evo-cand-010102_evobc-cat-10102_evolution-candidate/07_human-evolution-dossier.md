...
- Project ID: `obs-evo-cand-010102`
- EVOBC category candidate ID: `evobc-evo-cat-10102`
- External category reference: `evobc-cat-10102`
- Source category ID: `10102`
- Source label for human review: `餈`
- Source codepoints: `U+9908`
...
- `obs-evo-cand-010102-route-category-staging`
...
- `obs-evo-cand-010102-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010102-route-evolution-graph`
