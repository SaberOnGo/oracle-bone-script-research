# Material Visual Observation / obs-comp-cand-000215 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000215`
- External reference / 外部参照: `obimd-sub-mjkreq3d3z`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011860_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fn6hszube7/mjkreq3d3z/mjkreq3d3z.png`
- Checksum / 校验和:
  `16aec63c7a702f0339b38c50d7a1e03f1cd2113e541e10f31b7fe4cd837a4f10`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.45%.
- Marked-pixel bounds: (78,28)–(171,221); span 94 × 194 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.45%。
- 痕迹范围：(78,28)–(171,221)；跨度94 × 194 px；痕迹矩形高于宽。
