...
- External category reference: `evobc-cat-02719`
- Source category ID: `02719`
- Source label: `底`
...
- `obs-evo-cand-002719-route-category-staging`
...
- `obs-evo-cand-002719-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002719-route-evolution-graph`
