# Material Visual Observation / obs-comp-cand-000346 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000346`
- External reference / 外部参照: `obimd-sub-2ozxziwmky`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012270_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/34ks61j1m8/2ozxziwmky/2ozxziwmky.png`
- Checksum / 校验和:
  `8621267bdca7406b17b293cd08d34f7a4b227bf48d725f2e2d57a126a31de4ba`
...
- Marked-pixel bounds: (75,33)–(174,215); span 100 × 183 px; the marked
...
- 痕迹范围：(75,33)–(174,215)；跨度100 × 183 px；痕迹矩形高于宽。
