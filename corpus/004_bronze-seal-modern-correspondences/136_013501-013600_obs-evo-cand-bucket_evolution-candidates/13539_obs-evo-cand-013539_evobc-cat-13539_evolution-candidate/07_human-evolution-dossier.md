...
- External category reference: `evobc-cat-13539`
- Source category ID: `13539`
- Source label: `𭤆`
...
- `obs-evo-cand-013539-route-category-staging`
...
- `obs-evo-cand-013539-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013539-route-evolution-graph`
