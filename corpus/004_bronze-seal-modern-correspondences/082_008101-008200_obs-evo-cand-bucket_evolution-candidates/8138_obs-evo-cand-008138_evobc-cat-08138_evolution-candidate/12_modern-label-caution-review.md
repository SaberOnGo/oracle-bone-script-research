# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008138
...
- EVOBC candidate category: `evobc-evo-cat-08138`.
- Source label for search only: `訖`.
- Source codepoints for search only: `U+8A16`.
