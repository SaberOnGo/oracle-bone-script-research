...
Project ID: `obs-evo-cand-004664`
...
- Project ID: `obs-evo-cand-004664`
- EVOBC category candidate ID: `evobc-evo-cat-04664`
- External category reference: `evobc-cat-04664`
- Source category ID: `04664`
- Source label for human review: `浩`
- Source codepoints: `U+6D69`
...
- `obs-evo-cand-004664-route-category-staging`
...
- `obs-evo-cand-004664-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004664-route-evolution-graph`
