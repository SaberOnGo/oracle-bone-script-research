...
Project ID: `obs-evo-cand-003945`
...
- Project ID: `obs-evo-cand-003945`
- EVOBC category candidate ID: `evobc-evo-cat-03945`
- External category reference: `evobc-cat-03945`
- Source category ID: `03945`
- Source label for human review: `柁`
- Source codepoints: `U+67C1`
...
- `obs-evo-cand-003945-route-category-staging`
...
- `obs-evo-cand-003945-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003945-route-evolution-graph`
