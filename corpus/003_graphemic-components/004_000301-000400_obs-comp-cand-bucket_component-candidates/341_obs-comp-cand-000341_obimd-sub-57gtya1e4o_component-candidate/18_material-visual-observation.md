# Material Visual Observation / obs-comp-cand-000341 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000341`
- External reference / 外部参照: `obimd-sub-57gtya1e4o`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012265_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jvuf4ut3c5/57gtya1e4o/57gtya1e4o.png`
- Checksum / 校验和:
  `68c3b8095a8bf30217e6d72d52eae703f91f99bbc3eb3ba46a83f47ddf83c2df`
...
- Marked-pixel bounds: (85,42)–(164,211); span 80 × 170 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.60%。
- 痕迹范围：(85,42)–(164,211)；跨度80 × 170 px；痕迹矩形高于宽。
