...
- External category reference: `evobc-cat-09535`
- Source category ID: `09535`
- Source label for human review: `鐲`
...
- `obs-evo-cand-009535-route-category-staging`
...
- `obs-evo-cand-009535-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009535-route-evolution-graph`
