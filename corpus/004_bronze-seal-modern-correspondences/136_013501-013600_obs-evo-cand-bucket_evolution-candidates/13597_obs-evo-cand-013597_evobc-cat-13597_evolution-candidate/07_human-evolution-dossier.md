...
- External category reference: `evobc-cat-13597`
- Source category ID: `13597`
- Source label for human review: `𮀀`
...
- `obs-evo-cand-013597-route-category-staging`
...
- `obs-evo-cand-013597-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013597-route-evolution-graph`
