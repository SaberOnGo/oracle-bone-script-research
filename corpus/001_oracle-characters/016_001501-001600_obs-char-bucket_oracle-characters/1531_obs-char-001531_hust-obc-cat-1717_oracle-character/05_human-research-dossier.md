# obs-char-001531 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1531_obs-char-001531_hust-obc-cat-1717_ora
  cle-character/03_visual-assets/001_asset-001536_hust-obc-cat-1717_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1717/G_1717_寧滬1.313合30958無名組.pn
  g`
- asset id: `asset-001536`
...
- source category: `1717`
- validation class: `1530`
- source image route: `HUST-OBC/deciphered/1717/G_1717_寧滬1.313合30958無名組.png`
- asset id: `asset-001536`
...
- English observation: `Two small adjacent marks combine a narrow angular
  form with a branching vertical form.`
...
- dataset label text: `㪫`
- dataset label codepoints: `U+3AAB`
...
- filename catalog route clues: `Heji-like filename clue: 合30958
...
- Which source records identify obs-char-001531 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001531？
