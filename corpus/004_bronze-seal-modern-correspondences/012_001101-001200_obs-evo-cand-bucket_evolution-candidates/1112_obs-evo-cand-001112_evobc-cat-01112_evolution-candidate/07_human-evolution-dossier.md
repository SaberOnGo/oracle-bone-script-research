...
- External category reference: `evobc-cat-01112`
- Source category ID: `01112`
- Source label for human review: `冉`
- Source codepoints: `U+5189`
...
- `obs-evo-cand-001112-route-category-staging`
...
- `obs-evo-cand-001112-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001112-route-evolution-graph`
