# Material Visual Observation / obs-comp-cand-001937 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001937`
- External reference / 外部参照: `obimd-sub-j1sekhafab`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018723_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/mm49eilaqb/j1sekhafab/j1sekhafab.png`
- Checksum / 校验和:
  `41b26bc1186e0073ac896dcf097ba0c410bc6daf1f916734669019d356b9960f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.09%.
- Marked-pixel bounds: (98,31)–(194,223); span 97 × 193 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.09%。
- 痕迹范围：(98,31)–(194,223)；跨度97 × 193 px；痕迹矩形高于宽。
