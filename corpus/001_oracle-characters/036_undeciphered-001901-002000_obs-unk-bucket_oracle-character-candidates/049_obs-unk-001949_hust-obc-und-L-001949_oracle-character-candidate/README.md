# obs-unk-001949 Local Object Materials / obs-unk-001949 本地对象资料
...
- Local review image / 本地复核图像: `03_visual-assets/001_asset-003542_hust-obc-und-L-001949_glyph.jpg`

## Object Summary / 对象摘要

- Project ID / 项目 ID: `obs-unk-001949`
- Primary external reference / 首选外部参考: `hust-obc-und-L-001949`
- Source group / 来源分组: `L` (Oracle Bone Script: Six Digit Numerical Code)
- Source class path / 来源分类路径: `HUST-OBC/undeciphered/L/1949/`
- Source image path / 来源图像路径: `HUST-OBC/undeciphered/L/1949/L_？_1688.jpg`
- Asset ID / 资产 ID: `asset-003542`
