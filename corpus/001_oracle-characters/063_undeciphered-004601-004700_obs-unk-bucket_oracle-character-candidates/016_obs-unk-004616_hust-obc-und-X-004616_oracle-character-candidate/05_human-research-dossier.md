# obs-unk-004616 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/016_obs-unk-004616_h
  ust-obc-und-X-004616_oracle-character-candidate/03_visual-assets/001_asset
  -006209_hust-obc-und-X-004616_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/172/X_？_8347_1.png`
- asset id: `asset-006209`
...
- source class: `HUST-OBC/undeciphered/X/172/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/172/X_？_8347_1.png`
- asset id: `asset-006209`
...
- English observation: `tall outline, long opening, rounded lower base`
- 中文观察: `高长轮廓、长浅色开口和圆弧底部已记录。`
...
- Which source records identify obs-unk-004616 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004616？
