...
Project ID: `obs-evo-cand-007463`
...
- Project ID: `obs-evo-cand-007463`
- EVOBC category candidate ID: `evobc-evo-cat-07463`
- External category reference: `evobc-cat-07463`
- Source category ID: `07463`
- Source label for human review: `葌`
- Source codepoints: `U+844C`
...
- `obs-evo-cand-007463-route-category-staging`
...
- `obs-evo-cand-007463-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007463-route-evolution-graph`
