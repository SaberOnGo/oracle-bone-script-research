...
- External category reference: `evobc-cat-01815`
- Source category ID: `01815`
- Source label for human review: `坑`
...
- `obs-evo-cand-001815-route-category-staging`
...
- `obs-evo-cand-001815-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001815-route-evolution-graph`
