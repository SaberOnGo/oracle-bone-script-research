# obs-char-000753 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/753_obs-char-000753_hust-obc-cat-0855_orac
  le-character/03_visual-assets/001_asset-000758_hust-obc-cat-0855_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0855/G_0855_佚195(甲).png`
- asset id: `asset-000758`
...
- source category: `0855`
- validation class: `752`
- source image route: `HUST-OBC/deciphered/0855/G_0855_佚195(甲).png`
- asset id: `asset-000758`
...
- dataset label text: `㝍`
- dataset label codepoints: `U+374D`
...
- Which source records identify obs-char-000753 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000753？
