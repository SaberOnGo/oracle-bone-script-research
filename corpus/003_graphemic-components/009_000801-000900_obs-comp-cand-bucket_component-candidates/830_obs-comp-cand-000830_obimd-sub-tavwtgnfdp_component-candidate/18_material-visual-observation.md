# Material Visual Observation / obs-comp-cand-000830 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000830`
- External reference / 外部参照: `obimd-sub-tavwtgnfdp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013701_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tavwtgnfdp/tavwtgnfdp/tavwtgnfdp.png`
- Checksum / 校验和:
  `1bb0fb24730b45357205967d6d4bd89b1a6b5081930791da7a586d6cb0b2c697`
...
- Marked-pixel bounds: (92,19)–(166,229); span 75 × 211 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.95%。
- 痕迹范围：(92,19)–(166,229)；跨度75 × 211 px；痕迹矩形高于宽。
