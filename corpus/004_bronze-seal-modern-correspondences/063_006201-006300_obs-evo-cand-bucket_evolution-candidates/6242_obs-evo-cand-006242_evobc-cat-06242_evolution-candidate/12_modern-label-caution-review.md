# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006242
...
- EVOBC candidate category: `evobc-evo-cat-06242`.
- Source label for search only: `第`.
- Source codepoints for search only: `U+7B2C`.
