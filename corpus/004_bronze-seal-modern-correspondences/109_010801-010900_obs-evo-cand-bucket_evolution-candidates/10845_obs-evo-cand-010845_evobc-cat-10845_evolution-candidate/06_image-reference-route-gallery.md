...
- `obs-evo-cand-010845-route-category-staging`
...
- `obs-evo-cand-010845-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010845-route-evolution-graph`
