# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002528
...
- EVOBC candidate category: `evobc-evo-cat-02528`.
- Source label for search only: `屽`.
- Source codepoints for search only: `U+5C7D`.
