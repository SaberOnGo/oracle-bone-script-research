...
Project ID: `obs-evo-cand-006684`
...
- Project ID: `obs-evo-cand-006684`
- EVOBC category candidate ID: `evobc-evo-cat-06684`
- External category reference: `evobc-cat-06684`
- Source category ID: `06684`
- Source label for human review: `繡`
- Source codepoints: `U+7E61`
...
- `obs-evo-cand-006684-route-category-staging`
...
- `obs-evo-cand-006684-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006684-route-evolution-graph`
