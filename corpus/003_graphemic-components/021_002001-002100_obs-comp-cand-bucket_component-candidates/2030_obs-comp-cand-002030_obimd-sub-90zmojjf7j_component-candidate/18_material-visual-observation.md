# Material Visual Observation / obs-comp-cand-002030 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002030`
- External reference / 外部参照: `obimd-sub-90zmojjf7j`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019357_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/90zmojjf7j/90zmojjf7j/90zmojjf7j.png`
- Checksum / 校验和:
  `c6de81ad6e879df416b46a667060a933b7f6f5a3107ff4956d42205fce732e6c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.81%.
- Marked-pixel bounds: (54,32)–(207,215); span 154 × 184 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.81%。
- 痕迹范围：(54,32)–(207,215)；跨度154 × 184 px；痕迹矩形近方形。
