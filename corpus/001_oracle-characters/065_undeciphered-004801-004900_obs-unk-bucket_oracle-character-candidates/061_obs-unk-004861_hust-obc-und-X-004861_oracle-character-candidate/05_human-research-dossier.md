# obs-unk-004861 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/061_obs-unk-004861_h
  ust-obc-und-X-004861_oracle-character-candidate/03_visual-assets/001_asset
  -006454_hust-obc-und-X-004861_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/417/X_？_7401_1.png`
- asset id: `asset-006454`
...
- source class: `HUST-OBC/undeciphered/X/417/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/417/X_？_7401_1.png`
- asset id: `asset-006454`
...
- English observation: `central branching junction and lower opening`
- 中文观察: `中部交叉分支和下部开口`
...
- Which source records identify obs-unk-004861 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004861？
