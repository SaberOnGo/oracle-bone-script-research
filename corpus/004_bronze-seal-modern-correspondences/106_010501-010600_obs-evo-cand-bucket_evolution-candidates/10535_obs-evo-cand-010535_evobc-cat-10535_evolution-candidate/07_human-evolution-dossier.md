...
- External category reference: `evobc-cat-10535`
- Source category ID: `10535`
- Source label for human review: `鶯`
- Source codepoints: `U+9DAF`
...
- `obs-evo-cand-010535-route-category-staging`
...
- `obs-evo-cand-010535-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010535-route-evolution-graph`
