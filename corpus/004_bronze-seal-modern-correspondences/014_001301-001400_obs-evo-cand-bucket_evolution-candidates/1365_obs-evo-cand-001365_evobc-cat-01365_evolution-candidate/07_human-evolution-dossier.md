...
- External category reference: `evobc-cat-01365`
- Source category ID: `01365`
- Source label for human review: `卅`
- Source codepoints: `U+5345`
...
- `obs-evo-cand-001365-route-category-staging`
...
- `obs-evo-cand-001365-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001365-route-evolution-graph`
