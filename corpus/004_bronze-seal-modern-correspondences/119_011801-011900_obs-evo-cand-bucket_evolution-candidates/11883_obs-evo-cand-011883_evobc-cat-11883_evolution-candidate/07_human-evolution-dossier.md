...
- External category reference: `evobc-cat-11883`
- Source category ID: `11883`
- Source label for human review: `𥮨`
...
- `obs-evo-cand-011883-route-category-staging`
...
- `obs-evo-cand-011883-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011883-route-evolution-graph`
