...
- External category reference: `evobc-cat-08557`
- Source category ID: `08557`
- Source label for human review: `費`
...
- `obs-evo-cand-008557-route-category-staging`
...
- `obs-evo-cand-008557-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008557-route-evolution-graph`
