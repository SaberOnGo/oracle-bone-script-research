...
Project ID: `obs-evo-cand-003576`
...
- Project ID: `obs-evo-cand-003576`
- EVOBC category candidate ID: `evobc-evo-cat-03576`
- External category reference: `evobc-cat-03576`
- Source category ID: `03576`
- Source label for human review: `敉`
- Source codepoints: `U+6549`
...
- `obs-evo-cand-003576-route-category-staging`
...
- `obs-evo-cand-003576-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003576-route-evolution-graph`
