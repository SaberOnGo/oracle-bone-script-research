...
- External category reference: `evobc-cat-09004`
- Source category ID: `09004`
- Source label for human review: `逧`
- Source codepoints: `U+9027`
...
- `obs-evo-cand-009004-route-category-staging`
...
- `obs-evo-cand-009004-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009004-route-evolution-graph`
