...
- External category reference: `evobc-cat-01281`
- Source category ID: `01281`
- Source label for human review: `劾`
- Source codepoints: `U+52BE`
...
- `obs-evo-cand-001281-route-category-staging`
...
- `obs-evo-cand-001281-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001281-route-evolution-graph`
