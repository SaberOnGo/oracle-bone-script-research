...
- External category reference: `evobc-cat-02101`
- Source category ID: `02101`
- Source label for human review: `妴`
- Source codepoints: `U+59B4`
...
- `obs-evo-cand-002101-route-category-staging`
...
- `obs-evo-cand-002101-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002101-route-evolution-graph`
