...
- `obs-evo-cand-004227-route-category-staging`
...
- `obs-evo-cand-004227-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004227-route-evolution-graph`
