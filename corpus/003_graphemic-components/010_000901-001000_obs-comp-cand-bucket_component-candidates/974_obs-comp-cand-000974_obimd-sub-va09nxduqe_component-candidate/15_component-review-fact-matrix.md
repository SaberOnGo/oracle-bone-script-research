...
| Glyph or codepoint route | 16 OBIMD route rows; examples U+F5801; U+F5802; 另有 14 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence | 0 local image rows; not_found_in_registered_source_package_route_indexed | 06_component-visual-index.csv; 07_component-visual-gallery.md |
