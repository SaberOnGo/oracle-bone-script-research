# obs-char-000153 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000153`
- primary external id: `hust-obc-cat-0169`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/153_obs-char-000153_hust-obc-cat-0169_orac
  le-character/03_visual-assets/001_asset-000158_hust-obc-cat-0169_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0169/G_0169_甲骨文0.png`
- asset id: `asset-000158`
...
- source category: `0169`
- validation class: `152`
- source image route: `HUST-OBC/deciphered/0169/G_0169_甲骨文0.png`
- asset id: `asset-000158`
...
- English observation: `The image has a small curved upper mark, a compact
  stacked middle form, and a rounded open stroke curving along the lower
  edge.`
- 中文观察: `图像上方有小弯曲痕迹，中部为紧凑叠置形体，下缘有沿边弯曲的开放笔画。`
...
- dataset label text: `㒟`
- dataset label codepoints: `U+349F`
...
- Which source records identify obs-char-000153 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000153？
