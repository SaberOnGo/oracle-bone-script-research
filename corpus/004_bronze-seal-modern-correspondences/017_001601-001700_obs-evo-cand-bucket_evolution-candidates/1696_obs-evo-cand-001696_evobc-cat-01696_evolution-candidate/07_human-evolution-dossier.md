...
Project ID: `obs-evo-cand-001696`
...
- Project ID: `obs-evo-cand-001696`
- EVOBC category candidate ID: `evobc-evo-cat-01696`
- External category reference: `evobc-cat-01696`
- Source category ID: `01696`
- Source label for human review: `嘑`
- Source codepoints: `U+5611`
...
- `obs-evo-cand-001696-route-category-staging`
...
- `obs-evo-cand-001696-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001696-route-evolution-graph`
