# obs-unk-008227 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008227`
- primary external id: `hust-obc-und-YH-008227`
...
- local review image route: `corpus/001_oracle-characters/099_undeciphered-008
  201-008300_obs-unk-bucket_oracle-character-candidates/027_obs-unk-008227_h
  ust-obc-und-YH-008227_oracle-character-candidate/03_visual-assets/001_asse
  t-009818_hust-obc-und-YH-008227_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/608CF/H_？_608CF_0.png`
- asset id: `asset-009818`
...
- source class: `HUST-OBC/undeciphered/Y+H/608CF/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/608CF/H_？_608CF_0.png`
- asset id: `asset-009818`
...
- Which source records identify obs-unk-008227 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008227？
