# obs-xwalk-cand-000051 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+3431` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-0059` | not reading |
| OBIMD route / OBIMD 路线 | `obimd-main-cand-001015` | not component |
| EVOBC route / EVOBC 路线 | `evobc-evo-cat-00006` | not evolution |
...
| HUST candidate route | `corpus/001_oracle-characters/001_000001-000100_obs-char-bucket_oracle-characters/051_obs-char-000051_hust-obc-cat-0059_oracle-character/01_candidate-character-packet.json` | open packet and local glyph dossier first |
