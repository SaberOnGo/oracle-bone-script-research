# Material Visual Observation / obs-comp-cand-002668 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002668`
- External reference / 外部参照: `obimd-sub-40egrp3age`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021244_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/40egrp3age/40egrp3age/40egrp3age.png`
- Checksum / 校验和:
  `b4bdbd00289a30ca23da7fda100a5dd4da1f989298983b471bd0c6b6469d1afc`
...
- Marked-pixel bounds: (92,21)–(158,228); span 67 × 208 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.53%。
- 痕迹范围：(92,21)–(158,228)；跨度67 × 208 px；痕迹矩形高于宽。
