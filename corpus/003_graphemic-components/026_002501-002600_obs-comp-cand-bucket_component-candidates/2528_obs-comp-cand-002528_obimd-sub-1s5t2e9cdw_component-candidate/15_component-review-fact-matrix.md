# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-002528
...
| Glyph or codepoint route / 字形或码位路线 | 62 OBIMD route rows; examples U+4E4E;U+547C;U+FE57E; U+FE57F; 另有 60 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 62 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
