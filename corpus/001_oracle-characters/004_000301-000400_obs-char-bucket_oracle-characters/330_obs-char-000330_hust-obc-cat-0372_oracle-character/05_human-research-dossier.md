# obs-char-000330 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/330_obs-char-000330_hust-obc-cat-0372_orac
  le-character/03_visual-assets/001_asset-000335_hust-obc-cat-0372_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0372/X_0372_471_1.png`
- asset id: `asset-000335`
...
- source category: `0372`
- validation class: `329`
- source image route: `HUST-OBC/deciphered/0372/X_0372_471_1.png`
- asset id: `asset-000335`
...
- English observation: `The large dark composite form contains an upper
  angular mass, a central rectangular enclosure, and several curved lower
  strokes.`
- 中文观察: `大型深色复合形体含上部折角形体、中部方形闭合轮廓和数道下部弧形笔画。`
...
- dataset label text: `㕪`
- dataset label codepoints: `U+356A`
...
- Which source records identify obs-char-000330 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000330？
