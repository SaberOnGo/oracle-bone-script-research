# obs-char-000188 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/188_obs-char-000188_hust-obc-cat-0208_orac
  le-character/03_visual-assets/001_asset-000193_hust-obc-cat-0208_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0208/G_0208_京津1380合7414賓組.png`
- asset id: `asset-000193`
...
- source category: `0208`
- validation class: `187`
- source image route: `HUST-OBC/deciphered/0208/G_0208_京津1380合7414賓組.png`
- asset id: `asset-000193`
...
- English observation: `The broad image has several upright strokes crossing
  a horizontal banded form, with diagonal projections extending below both
  sides.`
...
- dataset label text: `㓆`
- dataset label codepoints: `U+34C6`
...
- filename catalog route clues: `Heji-like filename clue: 合7414
...
- Which source records identify obs-char-000188 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000188？
