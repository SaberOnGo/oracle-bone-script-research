# Material Visual Observation / obs-comp-cand-000347 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000347`
- External reference / 外部参照: `obimd-sub-gbcz1nzomu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012271_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gbcz1nzomu/gbcz1nzomu/gbcz1nzomu.png`
- Checksum / 校验和:
  `7addd5ce3e8f394e5e5fb42414d156071674f744289ee6f63dacc030c04c32d4`
...
- Marked-pixel bounds: (81,25)–(168,224); span 88 × 200 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.38%。
- 痕迹范围：(81,25)–(168,224)；跨度88 × 200 px；痕迹矩形高于宽。
