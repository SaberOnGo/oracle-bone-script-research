...
- External category reference: `evobc-cat-08089`
- Source category ID: `08089`
- Source label for human review: `览`
...
- `obs-evo-cand-008089-route-category-staging`
...
- `obs-evo-cand-008089-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008089-route-evolution-graph`
