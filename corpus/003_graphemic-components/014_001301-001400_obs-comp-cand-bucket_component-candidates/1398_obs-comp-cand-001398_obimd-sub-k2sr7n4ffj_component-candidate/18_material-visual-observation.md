# Material Visual Observation / obs-comp-cand-001398 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001398`
- External reference / 外部参照: `obimd-sub-k2sr7n4ffj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015817_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/k2sr7n4ffj/k2sr7n4ffj/k2sr7n4ffj.png`
- Checksum / 校验和:
  `50716f3718447072237972b777be736e797da56ee63f45b95a310c00b715d8fd`
...
- Marked-pixel bounds: (55,54)–(194,198); span 140 × 145 px; the marked
...
- 痕迹范围：(55,54)–(194,198)；跨度140 × 145 px；痕迹矩形近方形。
