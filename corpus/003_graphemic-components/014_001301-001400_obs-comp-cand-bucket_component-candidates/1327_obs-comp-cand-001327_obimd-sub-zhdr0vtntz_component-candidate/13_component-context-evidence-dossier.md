# obs-comp-cand-001327 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001327`
- 首选外部 ID: `obimd-sub-zhdr0vtntz`
- OBIMD subcharacter UID: `zhdr0vtntz`
- OBIMD main character UID: `zhdr0vtntz`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+30320;U+F78C4; U+F78C5; 另有 2 项
