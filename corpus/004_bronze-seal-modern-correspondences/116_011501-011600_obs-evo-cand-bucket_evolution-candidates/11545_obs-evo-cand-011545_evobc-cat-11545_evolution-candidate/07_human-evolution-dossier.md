...
Project ID: `obs-evo-cand-011545`
...
- Project ID: `obs-evo-cand-011545`
- EVOBC category candidate ID: `evobc-evo-cat-11545`
- External category reference: `evobc-cat-11545`
- Source category ID: `11545`
- Source label for human review: `𤁱`
- Source codepoints: `U+24071`
...
- `obs-evo-cand-011545-route-category-staging`
...
- `obs-evo-cand-011545-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011545-route-evolution-graph`
