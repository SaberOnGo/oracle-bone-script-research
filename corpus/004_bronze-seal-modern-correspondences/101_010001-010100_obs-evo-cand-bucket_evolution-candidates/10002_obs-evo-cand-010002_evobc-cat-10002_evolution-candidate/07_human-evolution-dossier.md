...
- External category reference: `evobc-cat-10002`
- Source category ID: `10002`
- Source label for human review: `頵`
...
- `obs-evo-cand-010002-route-category-staging`
...
- `obs-evo-cand-010002-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010002-route-evolution-graph`
