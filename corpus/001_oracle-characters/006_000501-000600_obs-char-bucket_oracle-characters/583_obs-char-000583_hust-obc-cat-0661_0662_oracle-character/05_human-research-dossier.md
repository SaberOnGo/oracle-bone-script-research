# obs-char-000583 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/583_obs-char-000583_hust-obc-cat-0661_0662
  _oracle-character/03_visual-assets/001_asset-000588_hust-obc-cat-0661_0662
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0661_0662/0661/G_0661_乙5523合221
  19午組.png`
- asset id: `asset-000588`
...
- source category: `0661_0662`
- validation class: `582`
- source image route: `HUST-OBC/deciphered/0661_0662/0661/G_0661_乙5523合22119午組
  .png`
- asset id: `asset-000588`
...
- English observation: `Four detached dark diagonal strokes are arranged in
  a descending loose column, with unequal lengths and wide white gaps
  between them.`
- 中文观察: `四条分离深色斜笔组成下行疏列，长度不等，彼此之间留有宽白隙。`
...
- dataset label text: `㚋㚌`
- dataset label codepoints: `U+368B;U+368C`
...
- filename catalog route clues: `Heji-like filename clue: 合22119
  (G_0661_乙5523合22119午組.png)`
...
- Which source records identify obs-char-000583 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000583？
