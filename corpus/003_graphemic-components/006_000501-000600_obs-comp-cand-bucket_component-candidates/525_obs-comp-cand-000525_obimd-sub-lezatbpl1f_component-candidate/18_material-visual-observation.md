# Material Visual Observation / obs-comp-cand-000525 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000525`
- External reference / 外部参照: `obimd-sub-lezatbpl1f`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012759_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lezatbpl1f/lezatbpl1f/lezatbpl1f.png`
- Checksum / 校验和:
  `a9b9f2154f8cc60cbeae5777c6589cc7adbf4ed21ec8af30e6600bc27a8d0eca`
...
- Marked-pixel bounds: (53,32)–(196,216); span 144 × 185 px; the marked
...
- 痕迹范围：(53,32)–(196,216)；跨度144 × 185 px；痕迹矩形高于宽。
