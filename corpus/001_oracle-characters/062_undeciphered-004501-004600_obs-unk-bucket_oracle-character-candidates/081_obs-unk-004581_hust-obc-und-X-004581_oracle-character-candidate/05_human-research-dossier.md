# obs-unk-004581 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/081_obs-unk-004581_h
  ust-obc-und-X-004581_oracle-character-candidate/03_visual-assets/001_asset
  -006174_hust-obc-und-X-004581_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/137/X_？_8315_1.png`
- asset id: `asset-006174`
...
- source class: `HUST-OBC/undeciphered/X/137/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/137/X_？_8315_1.png`
- asset id: `asset-006174`
...
- English observation: `Three stacked openings and lower enclosure recorded.`
- 中文观察: `已记录三个上下排列的开口和下部轮廓。`
...
- Which source records identify obs-unk-004581 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004581？
