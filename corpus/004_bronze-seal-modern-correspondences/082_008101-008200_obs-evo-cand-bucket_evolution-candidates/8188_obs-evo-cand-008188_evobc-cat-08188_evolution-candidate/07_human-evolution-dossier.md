...
- External category reference: `evobc-cat-08188`
- Source category ID: `08188`
- Source label: `詤`
...
- `obs-evo-cand-008188-route-category-staging`
...
- `obs-evo-cand-008188-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008188-route-evolution-graph`
