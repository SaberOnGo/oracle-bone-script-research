...
Project ID: `obs-evo-cand-010345`
...
- Project ID: `obs-evo-cand-010345`
- EVOBC category candidate ID: `evobc-evo-cat-10345`
- External category reference: `evobc-cat-10345`
- Source category ID: `10345`
- Source label for human review: `鬱`
- Source codepoints: `U+9B31`
...
- `obs-evo-cand-010345-route-category-staging`
...
- `obs-evo-cand-010345-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010345-route-evolution-graph`
