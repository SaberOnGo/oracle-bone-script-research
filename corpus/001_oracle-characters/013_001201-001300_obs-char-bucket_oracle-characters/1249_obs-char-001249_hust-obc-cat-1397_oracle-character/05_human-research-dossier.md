# obs-char-001249 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001249`
- primary external id: `hust-obc-cat-1397`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1249_obs-char-001249_hust-obc-cat-1397_ora
  cle-character/03_visual-assets/001_asset-001254_hust-obc-cat-1397_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1397/G_1397_乙3188合939賓組.png`
- asset id: `asset-001254`
...
- source category: `1397`
- validation class: `1248`
- source image route: `HUST-OBC/deciphered/1397/G_1397_乙3188合939賓組.png`
- asset id: `asset-001254`
...
- English observation: `A compact dark form has an open upper edge, several
  upright divisions, and a squared lower enclosure.`
- 中文观察: `紧凑的深色形体上缘开放，有数条直立分隔笔画和方折的下部框形。`
...
- dataset label text: `㥫`
- dataset label codepoints: `U+396B`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00130`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00130`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00130`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/130_obs-evo-can
  d-000130_evobc-cat-00130_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/130_obs-evo-cand-000130_evobc-cat-00130_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合939
  (G_1397_乙3188合939賓組.png)`
...
- Which source records identify obs-char-001249 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001249？
