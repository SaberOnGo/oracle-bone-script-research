# Material Visual Observation / obs-comp-cand-000883 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000883`
- External reference / 外部参照: `obimd-sub-zh4yjr25wv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013955_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zh4yjr25wv/zh4yjr25wv/zh4yjr25wv.png`
- Checksum / 校验和:
  `0765808c398cb6656f6cf5d8111365ab04b574535f36c492a5d8404edcd0a200`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.49%.
- Marked-pixel bounds: (60,23)–(200,231); span 141 × 209 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.49%。
- 痕迹范围：(60,23)–(200,231)；跨度141 × 209 px；痕迹矩形高于宽。
