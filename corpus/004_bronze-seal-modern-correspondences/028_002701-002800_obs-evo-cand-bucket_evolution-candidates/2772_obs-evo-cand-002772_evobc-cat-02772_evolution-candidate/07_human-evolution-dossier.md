...
- Project ID: `obs-evo-cand-002772`
- EVOBC category candidate ID: `evobc-evo-cat-02772`
- External category reference: `evobc-cat-02772`
- Source category ID: `02772`
- Source label for human review: `廮`
- Source codepoints: `U+5EEE`
...
- `obs-evo-cand-002772-route-category-staging`
...
- `obs-evo-cand-002772-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002772-route-evolution-graph`
