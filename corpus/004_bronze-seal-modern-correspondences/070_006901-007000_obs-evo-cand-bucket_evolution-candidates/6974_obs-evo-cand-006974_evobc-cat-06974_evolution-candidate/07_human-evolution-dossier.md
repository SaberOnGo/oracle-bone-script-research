...
- External category reference: `evobc-cat-06974`
- Source category ID: `06974`
- Source label for human review: `肇`
- Source codepoints: `U+8087`
- Image reference count in source metadata: `138`
...
- `obs-evo-cand-006974-route-category-staging`
...
- `obs-evo-cand-006974-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006974-route-evolution-graph`
