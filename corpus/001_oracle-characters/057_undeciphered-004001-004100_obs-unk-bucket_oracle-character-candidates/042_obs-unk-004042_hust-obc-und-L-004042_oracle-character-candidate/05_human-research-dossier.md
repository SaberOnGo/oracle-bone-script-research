# obs-unk-004042 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004042`
- primary external id: `hust-obc-und-L-004042`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/042_obs-unk-004042_h
  ust-obc-und-L-004042_oracle-character-candidate/03_visual-assets/001_asset
  -005635_hust-obc-und-L-004042_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4042/L_？_8636.jpg`
- asset id: `asset-005635`
...
- source class: `HUST-OBC/undeciphered/L/4042/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4042/L_？_8636.jpg`
- asset id: `asset-005635`
...
- English observation: A thin vertical trace extends from a small upper mark.
  Two slanting traces branch from the lower center and end in separate
  rounded or hooked marks. The crop does not establish whether the branches
  join.
...
- Which source records identify obs-unk-004042 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004042？
