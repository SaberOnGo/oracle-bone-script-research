...
- `obs-evo-cand-010212-route-category-staging`
...
- `obs-evo-cand-010212-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010212-route-evolution-graph`
