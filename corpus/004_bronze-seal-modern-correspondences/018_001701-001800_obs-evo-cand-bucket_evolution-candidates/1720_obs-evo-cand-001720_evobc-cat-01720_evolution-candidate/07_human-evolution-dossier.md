...
- External category reference: `evobc-cat-01720`
- Source category ID: `01720`
- Source label for human review: `噧`
...
- `obs-evo-cand-001720-route-category-staging`
...
- `obs-evo-cand-001720-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001720-route-evolution-graph`
