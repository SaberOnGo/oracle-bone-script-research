# obs-xwalk-cand-001178 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+391C` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-1318` | not reading |
