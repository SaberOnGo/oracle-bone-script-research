...
- External category reference: `evobc-cat-07462`
- Source category ID: `07462`
- Source label for human review: `葉`
...
- `obs-evo-cand-007462-route-category-staging`
...
- `obs-evo-cand-007462-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007462-route-evolution-graph`
