...
- External category reference: `evobc-cat-09092`
- Source category ID: `09092`
- Source label for human review: `邚`
...
- `obs-evo-cand-009092-route-category-staging`
...
- `obs-evo-cand-009092-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009092-route-evolution-graph`
