# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006120
...
- EVOBC candidate category: `evobc-evo-cat-06120`.
- Source label for search only: `稿`.
- Source codepoints for search only: `U+7A3F`.
