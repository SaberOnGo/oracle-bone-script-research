...
- External category reference: `evobc-cat-03051`
- Source category ID: `03051`
- Source label for human review: `惜`
- Source codepoints: `U+60DC`
...
- `obs-evo-cand-003051-route-category-staging`
...
- `obs-evo-cand-003051-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003051-route-evolution-graph`
