# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003327
...
- EVOBC candidate category: `evobc-evo-cat-03327`.
- Source label for search only: `括`.
- Source codepoints for search only: `U+62EC`.
