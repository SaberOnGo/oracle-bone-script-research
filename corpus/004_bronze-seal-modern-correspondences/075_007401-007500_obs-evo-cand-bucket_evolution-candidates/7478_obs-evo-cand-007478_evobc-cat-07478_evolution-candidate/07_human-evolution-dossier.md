...
- External category reference: `evobc-cat-07478`
- Source category ID: `07478`
- Source label for human review: `葨`
- Source codepoints: `U+8468`
...
- `obs-evo-cand-007478-route-category-staging`
...
- `obs-evo-cand-007478-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007478-route-evolution-graph`
