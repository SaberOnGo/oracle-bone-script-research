# obs-unk-004615 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004615`
- primary external id: `hust-obc-und-X-004615`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/015_obs-unk-004615_h
  ust-obc-und-X-004615_oracle-character-candidate/03_visual-assets/001_asset
  -006208_hust-obc-und-X-004615_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/171/X_？_8346_1.png`
- asset id: `asset-006208`
...
- source class: `HUST-OBC/undeciphered/X/171/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/171/X_？_8346_1.png`
- asset id: `asset-006208`
...
- English observation: `upper loop, narrow shaft, lower enclosed bulge`
- 中文观察: `顶部环状痕、狭窄竖痕和下部空腔已记录。`
...
- Which source records identify obs-unk-004615 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004615？
