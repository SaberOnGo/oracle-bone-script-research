...
- External category reference: `evobc-cat-06576`
- Source category ID: `06576`
- Source label for human review: `緅`
- Source codepoints: `U+7DC5`
...
- `obs-evo-cand-006576-route-category-staging`
...
- `obs-evo-cand-006576-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006576-route-evolution-graph`
