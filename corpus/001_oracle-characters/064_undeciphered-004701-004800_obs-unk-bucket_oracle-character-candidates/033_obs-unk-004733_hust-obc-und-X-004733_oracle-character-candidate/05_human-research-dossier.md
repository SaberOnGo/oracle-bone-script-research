# obs-unk-004733 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/033_obs-unk-004733_h
  ust-obc-und-X-004733_oracle-character-candidate/03_visual-assets/001_asset
  -006326_hust-obc-und-X-004733_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/289/X_？_7268_1.png`
- asset id: `asset-006326`
...
- source class: `HUST-OBC/undeciphered/X/289/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/289/X_？_7268_1.png`
- asset id: `asset-006326`
...
- English observation: `separated groups with curved lower traces`
- 中文观察: `带下部弯曲痕迹的分离笔画组`
...
- Which source records identify obs-unk-004733 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004733？
