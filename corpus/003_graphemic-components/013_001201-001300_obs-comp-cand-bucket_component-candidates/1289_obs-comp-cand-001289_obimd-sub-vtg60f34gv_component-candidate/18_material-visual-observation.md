# Material Visual Observation / obs-comp-cand-001289 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001289`
- External reference / 外部参照: `obimd-sub-vtg60f34gv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015574_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vtg60f34gv/vtg60f34gv/vtg60f34gv.png`
- Checksum / 校验和:
  `e6e06623261e378d212c918c23bee4eeaddfbdad5684896865329b5a56953b82`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.31%.
- Marked-pixel bounds: (99,19)–(150,230); span 52 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.31%。
- 痕迹范围：(99,19)–(150,230)；跨度52 × 212 px；痕迹矩形高于宽。
