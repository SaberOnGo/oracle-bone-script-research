# Material Visual Observation / obs-comp-cand-002642 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002642`
- External reference / 外部参照: `obimd-sub-zd6rk7oghq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021191_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zd6rk7oghq/zd6rk7oghq/zd6rk7oghq.png`
- Checksum / 校验和:
  `82631de18f9cda1c90e8e7aa475b2ec4ee4a9841e73493e9575ecdfb312bf078`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.06%.
- Marked-pixel bounds: (89,22)–(162,224); span 74 × 203 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.06%。
- 痕迹范围：(89,22)–(162,224)；跨度74 × 203 px；痕迹矩形高于宽。
