# obs-char-000370 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000370`
- primary external id: `hust-obc-cat-0420`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/370_obs-char-000370_hust-obc-cat-0420_orac
  le-character/03_visual-assets/001_asset-000375_hust-obc-cat-0420_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0420/X_0420_3336_1.png`
- asset id: `asset-000375`
...
- source category: `0420`
- validation class: `369`
- source image route: `HUST-OBC/deciphered/0420/X_0420_3336_1.png`
- asset id: `asset-000375`
...
- English observation: `A large sweeping angular contour crosses a central
  vertical stroke and continues into several long curved descenders.`
- 中文观察: `大型弧折轮廓横跨中央竖笔画，并向下延伸出数条长弧形笔画。`
...
- dataset label text: `㖚`
- dataset label codepoints: `U+359A`
...
- Which source records identify obs-char-000370 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000370？
