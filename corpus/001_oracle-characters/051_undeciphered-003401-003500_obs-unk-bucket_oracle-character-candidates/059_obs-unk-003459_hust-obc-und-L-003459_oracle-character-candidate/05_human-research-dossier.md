# obs-unk-003459 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/051_undeciphered-003
  401-003500_obs-unk-bucket_oracle-character-candidates/059_obs-unk-003459_h
  ust-obc-und-L-003459_oracle-character-candidate/03_visual-assets/001_asset
  -005052_hust-obc-und-L-003459_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3459/L_？_6686.jpg`
- asset id: `asset-005052`
...
- source class: `HUST-OBC/undeciphered/L/3459/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3459/L_？_6686.jpg`
- asset id: `asset-005052`
...
- Which source records identify obs-unk-003459 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003459？
