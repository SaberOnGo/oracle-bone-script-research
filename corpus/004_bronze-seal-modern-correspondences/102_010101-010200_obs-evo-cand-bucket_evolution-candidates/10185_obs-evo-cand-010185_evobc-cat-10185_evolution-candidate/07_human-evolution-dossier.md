...
- External category reference: `evobc-cat-10185`
- Source category ID: `10185`
- Source label for human review: `駕`
...
- `obs-evo-cand-010185-route-category-staging`
...
- `obs-evo-cand-010185-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010185-route-evolution-graph`
