# obs-char-000400 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000400`
- primary external id: `hust-obc-cat-0453`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/400_obs-char-000400_hust-obc-cat-0453_orac
  le-character/03_visual-assets/001_asset-000405_hust-obc-cat-0453_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0453/G_0453_乙1329合21557.png`
- asset id: `asset-000405`
...
- source category: `0453`
- validation class: `399`
- source image route: `HUST-OBC/deciphered/0453/G_0453_乙1329合21557.png`
- asset id: `asset-000405`
...
- English observation: `The image contains a compact hooked and looped form
  at left and a detached capped vertical stroke at right.`
- 中文观察: `图像左侧有紧凑钩曲环形形体，右侧有分离的带横帽竖笔画。`
...
- dataset label text: `㖻`
- dataset label codepoints: `U+35BB`
...
- filename catalog route clues: `Heji-like filename clue: 合21557
...
- Which source records identify obs-char-000400 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000400？
