# obs-char-001570 Visual Gallery / obs-char-001570 图像资料页
...
- Primary external reference / 首选外部参考: `hust-obc-cat-1762`
...
## obs-char-001570-visual-source-001 / 图像条目

![obs-char-001570 glyph candidate](03_visual-assets/001_asset-001575_hust-obc-cat-1762_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-001575_hust-obc-cat-1762_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-001575_hust-obc-cat-1762_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/1762/G_1762_前1.15.6(甲).png`
