# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006499
...
- EVOBC candidate category: `evobc-evo-cat-06499`.
- Source label for search only: `絑`.
- Source codepoints for search only: `U+7D51`.
