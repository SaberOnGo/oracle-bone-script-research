...
- External category reference: `evobc-cat-01229`
- Source category ID: `01229`
- Source label for human review: `剜`
...
- `obs-evo-cand-001229-route-category-staging`
...
- `obs-evo-cand-001229-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001229-route-evolution-graph`
