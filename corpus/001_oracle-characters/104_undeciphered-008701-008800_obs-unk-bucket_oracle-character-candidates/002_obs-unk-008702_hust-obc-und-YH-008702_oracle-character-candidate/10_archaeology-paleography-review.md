# obs-unk-008702 Archaeology Paleography Review

# obs-unk-008702 考古文字复核档案
...
- first local image: `001_asset-010293_hust-obc-und-YH-008702_glyph.jpg`
- first source image: `H_？_60D3E_0.png`
...
- codepoint routes: pending: check packet, source register, or graph route
- cross-source status: pending: check packet, source register, or graph route
...
- graph route files: pending: check packet, source register, or graph route
- graph files: 009_character-asset-graph-edges.jsonl
...
- download or access ids: dl-hust-obc-figshare-raw
- source metadata files: pending: check packet, source register, or graph route
- rights status: `source_marked_risk_noted`
- risk note: Figshare package metadata reports CC BY 4.0; Scie...
