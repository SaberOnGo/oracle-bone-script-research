...
- External category reference: `evobc-cat-11850`
- Source category ID: `11850`
- Source label for human review: `𥧑`
- Source codepoints: `U+259D1`
...
- `obs-evo-cand-011850-route-category-staging`
...
- `obs-evo-cand-011850-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011850-route-evolution-graph`
