...
- External category reference: `evobc-cat-10130`
- Source category ID: `10130`
- Source label for human review: `饋`
...
- `obs-evo-cand-010130-route-category-staging`
...
- `obs-evo-cand-010130-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010130-route-evolution-graph`
