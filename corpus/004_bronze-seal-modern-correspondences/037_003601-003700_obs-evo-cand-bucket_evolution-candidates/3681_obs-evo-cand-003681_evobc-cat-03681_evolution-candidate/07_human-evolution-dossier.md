...
Project ID: `obs-evo-cand-003681`
...
- Project ID: `obs-evo-cand-003681`
- EVOBC category candidate ID: `evobc-evo-cat-03681`
- External category reference: `evobc-cat-03681`
- Source category ID: `03681`
- Source label for human review: `旡`
- Source codepoints: `U+65E1`
...
- `obs-evo-cand-003681-route-category-staging`
...
- `obs-evo-cand-003681-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003681-route-evolution-graph`
