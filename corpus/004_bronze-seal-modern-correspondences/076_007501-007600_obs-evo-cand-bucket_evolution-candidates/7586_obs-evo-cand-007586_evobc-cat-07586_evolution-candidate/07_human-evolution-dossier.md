...
- External category reference: `evobc-cat-07586`
- Source category ID: `07586`
- Source label for human review: `蕡`
- Source codepoints: `U+8561`
...
- `obs-evo-cand-007586-route-category-staging`
...
- `obs-evo-cand-007586-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007586-route-evolution-graph`
