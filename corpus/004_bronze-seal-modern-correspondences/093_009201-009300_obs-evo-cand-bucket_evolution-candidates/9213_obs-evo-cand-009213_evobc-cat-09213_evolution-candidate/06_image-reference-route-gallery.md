...
- `obs-evo-cand-009213-route-category-staging`
...
- `obs-evo-cand-009213-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009213-route-evolution-graph`
