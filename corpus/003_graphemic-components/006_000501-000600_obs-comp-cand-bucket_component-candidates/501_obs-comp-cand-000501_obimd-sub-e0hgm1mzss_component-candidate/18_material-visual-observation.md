# Material Visual Observation / obs-comp-cand-000501 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000501`
- External reference / 外部参照: `obimd-sub-e0hgm1mzss`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012737_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/30vdsr9swu/e0hgm1mzss/e0hgm1mzss.png`
- Checksum / 校验和:
  `1a2f6f149f662b642147526cee1f675e00714f63fc2b524abffdbbfe999f7469`
...
- Marked-pixel bounds: (67,36)–(182,206); span 116 × 171 px; the marked
...
- 痕迹范围：(67,36)–(182,206)；跨度116 × 171 px；痕迹矩形高于宽。
