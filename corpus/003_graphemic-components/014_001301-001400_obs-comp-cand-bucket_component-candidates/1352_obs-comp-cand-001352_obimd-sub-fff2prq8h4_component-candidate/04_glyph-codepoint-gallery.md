# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001352
...
| --- | --- | --- | --- |
| `obimd-glyph-link-020102` | 󷫧 | `U+F7AE7` | `reviewed_metadata_only` |
| `obimd-glyph-link-020103` | 󷫨 | `U+F7AE8` | `reviewed_metadata_only` |
