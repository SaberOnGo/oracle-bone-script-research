...
Project ID: `obs-evo-cand-004357`
...
- Project ID: `obs-evo-cand-004357`
- EVOBC category candidate ID: `evobc-evo-cat-04357`
- External category reference: `evobc-cat-04357`
- Source category ID: `04357`
- Source label for human review: `欽`
- Source codepoints: `U+6B3D`
...
- `obs-evo-cand-004357-route-category-staging`
...
- `obs-evo-cand-004357-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004357-route-evolution-graph`
