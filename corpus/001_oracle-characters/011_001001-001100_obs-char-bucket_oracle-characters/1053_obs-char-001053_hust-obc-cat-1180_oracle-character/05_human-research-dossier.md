# obs-char-001053 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001053`
- primary external id: `hust-obc-cat-1180`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1053_obs-char-001053_hust-obc-cat-1180_ora
  cle-character/03_visual-assets/001_asset-001058_hust-obc-cat-1180_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1180/G_1180_戩19.1(甲).png`
- asset id: `asset-001058`
...
- source category: `1180`
- validation class: `1052`
- source image route: `HUST-OBC/deciphered/1180/G_1180_戩19.1(甲).png`
- asset id: `asset-001058`
...
- English observation: `A dense upright form has a short upper rectangular
  band, crossed lower strokes, and side projections.`
- 中文观察: `密集直立形体有短上部矩形带、交叉下部笔和侧向外伸笔。`
...
- dataset label text: `㢒`
- dataset label codepoints: `U+3892`
...
- Which source records identify obs-char-001053 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001053？
