...
- Project ID: `obs-evo-cand-010380`
- EVOBC category candidate ID: `evobc-evo-cat-10380`
- External category reference: `evobc-cat-10380`
- Source category ID: `10380`
- Source label for human review: `魾`
- Source codepoints: `U+9B7E`
...
- `obs-evo-cand-010380-route-category-staging`
...
- `obs-evo-cand-010380-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010380-route-evolution-graph`
