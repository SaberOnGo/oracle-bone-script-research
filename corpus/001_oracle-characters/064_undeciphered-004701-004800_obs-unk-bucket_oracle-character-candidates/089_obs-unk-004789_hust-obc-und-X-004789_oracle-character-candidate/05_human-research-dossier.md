# obs-unk-004789 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/089_obs-unk-004789_h
  ust-obc-und-X-004789_oracle-character-candidate/03_visual-assets/001_asset
  -006382_hust-obc-und-X-004789_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/345/X_？_7327_1.png`
- asset id: `asset-006382`
...
- source class: `HUST-OBC/undeciphered/X/345/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/345/X_？_7327_1.png`
- asset id: `asset-006382`
...
- English observation: `broad lower enclosure with internal openings`
- 中文观察: `带内部开口的宽大下部围合结构`
...
- Which source records identify obs-unk-004789 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004789？
