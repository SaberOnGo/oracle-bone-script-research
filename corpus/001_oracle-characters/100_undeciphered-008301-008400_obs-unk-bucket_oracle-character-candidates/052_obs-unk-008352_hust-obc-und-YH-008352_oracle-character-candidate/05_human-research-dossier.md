# obs-unk-008352 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008352`
- primary external id: `hust-obc-und-YH-008352`
...
- local review image route: `corpus/001_oracle-characters/100_undeciphered-008
  301-008400_obs-unk-bucket_oracle-character-candidates/052_obs-unk-008352_h
  ust-obc-und-YH-008352_oracle-character-candidate/03_visual-assets/001_asse
  t-009943_hust-obc-und-YH-008352_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60A22/H_？_60A22_0.png`
- asset id: `asset-009943`
...
- source class: `HUST-OBC/undeciphered/Y+H/60A22/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60A22/H_？_60A22_0.png`
- asset id: `asset-009943`
...
- Which source records identify obs-unk-008352 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008352？
