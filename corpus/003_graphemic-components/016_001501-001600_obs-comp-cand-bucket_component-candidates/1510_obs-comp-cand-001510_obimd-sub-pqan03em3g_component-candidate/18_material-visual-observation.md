# Material Visual Observation / obs-comp-cand-001510 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001510`
- External reference / 外部参照: `obimd-sub-pqan03em3g`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016473_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4r0g6bx5rc/pqan03em3g/pqan03em3g.png`
- Checksum / 校验和:
  `31417a1fb0b2bd0c024e7513b0bb3bd0edcb0a0d39c6010655d5edcb42e7735a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.02%.
- Marked-pixel bounds: (85,18)–(169,226); span 85 × 209 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.02%。
- 痕迹范围：(85,18)–(169,226)；跨度85 × 209 px；痕迹矩形高于宽。
