...
- Project ID: `obs-evo-cand-001719`
- EVOBC category candidate ID: `evobc-evo-cat-01719`
- External category reference: `evobc-cat-01719`
- Source category ID: `01719`
- Source label for human review: `噤`
- Source codepoints: `U+5664`
...
- `obs-evo-cand-001719-route-category-staging`
...
- `obs-evo-cand-001719-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001719-route-evolution-graph`
