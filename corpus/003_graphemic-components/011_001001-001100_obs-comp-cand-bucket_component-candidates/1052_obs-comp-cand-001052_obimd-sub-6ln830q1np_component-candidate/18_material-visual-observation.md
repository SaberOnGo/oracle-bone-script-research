# Material Visual Observation / obs-comp-cand-001052 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001052`
- External reference / 外部参照: `obimd-sub-6ln830q1np`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014602_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vqo5659li5/6ln830q1np/6ln830q1np.png`
- Checksum / 校验和:
  `aebc615f69426e6e0037cf47ea2d333d83faf38e1f437ac37715fef88f86306e`
...
- Marked-pixel bounds: (99,22)–(169,224); span 71 × 203 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.31%。
- 痕迹范围：(99,22)–(169,224)；跨度71 × 203 px；痕迹矩形高于宽。
