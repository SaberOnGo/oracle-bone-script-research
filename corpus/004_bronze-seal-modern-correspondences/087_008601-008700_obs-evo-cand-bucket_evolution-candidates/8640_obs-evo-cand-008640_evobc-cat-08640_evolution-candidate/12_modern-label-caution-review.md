# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008640
...
- EVOBC candidate category: `evobc-evo-cat-08640`.
- Source label for search only: `赋`.
- Source codepoints for search only: `U+8D4B`.
