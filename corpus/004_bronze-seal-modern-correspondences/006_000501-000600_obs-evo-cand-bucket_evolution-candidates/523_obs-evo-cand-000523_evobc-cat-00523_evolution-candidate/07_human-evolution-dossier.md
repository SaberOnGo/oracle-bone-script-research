...
Project ID: `obs-evo-cand-000523`
...
- Project ID: `obs-evo-cand-000523`
- EVOBC category candidate ID: `evobc-evo-cat-00523`
- External category reference: `evobc-cat-00523`
- Source category ID: `00523`
- Source label for human review: `䧅`
- Source codepoints: `U+49C5`
...
- `obs-evo-cand-000523-route-category-staging`
...
- `obs-evo-cand-000523-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000523-route-evolution-graph`
