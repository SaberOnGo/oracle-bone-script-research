...
- External category reference: `evobc-cat-09025`
- Source category ID: `09025`
- Source label for human review: `遉`
...
- `obs-evo-cand-009025-route-category-staging`
...
- `obs-evo-cand-009025-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009025-route-evolution-graph`
