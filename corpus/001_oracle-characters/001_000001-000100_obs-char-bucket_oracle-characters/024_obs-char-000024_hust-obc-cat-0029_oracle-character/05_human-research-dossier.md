# obs-char-000024 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/024_obs-char-000024_hust-obc-cat-0029_orac
  le-character/03_visual-assets/001_asset-000029_hust-obc-cat-0029_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0029/H_0029_60B9A_0.png`
- asset id: `asset-000029`
...
- source category: `0029`
- validation class: `23`
- source image route: `HUST-OBC/deciphered/0029/H_0029_60B9A_0.png`
- asset id: `asset-000029`
...
- dataset label text: `㐓`
- dataset label codepoints: `U+3413`
...
- filename catalog route clues: `catalog-like filename clue: H_0029
  (H_0029_60B9A_0.png)`
...
- Which source records identify obs-char-000024 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000024？
