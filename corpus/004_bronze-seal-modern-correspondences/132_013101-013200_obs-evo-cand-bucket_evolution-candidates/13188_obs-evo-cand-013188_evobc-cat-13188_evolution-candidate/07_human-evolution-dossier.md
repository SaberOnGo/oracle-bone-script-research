...
Project ID: `obs-evo-cand-013188`
...
- Project ID: `obs-evo-cand-013188`
- EVOBC category candidate ID: `evobc-evo-cat-13188`
- External category reference: `evobc-cat-13188`
- Source category ID: `13188`
- Source label for human review: `𬀜`
- Source codepoints: `U+2C01C`
...
- `obs-evo-cand-013188-route-category-staging`
...
- `obs-evo-cand-013188-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013188-route-evolution-graph`
