...
Project ID: `obs-evo-cand-001615`
...
- Project ID: `obs-evo-cand-001615`
- EVOBC category candidate ID: `evobc-evo-cat-01615`
- External category reference: `evobc-cat-01615`
- Source category ID: `01615`
- Source label for human review: `唸`
- Source codepoints: `U+5538`
...
- `obs-evo-cand-001615-route-category-staging`
...
- `obs-evo-cand-001615-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001615-route-evolution-graph`
