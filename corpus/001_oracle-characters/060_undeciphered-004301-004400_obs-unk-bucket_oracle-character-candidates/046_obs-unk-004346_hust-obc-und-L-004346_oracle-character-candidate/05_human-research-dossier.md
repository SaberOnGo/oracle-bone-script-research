# obs-unk-004346 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004346`
- primary external id: `hust-obc-und-L-004346`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/046_obs-unk-004346_h
  ust-obc-und-L-004346_oracle-character-candidate/03_visual-assets/001_asset
  -005939_hust-obc-und-L-004346_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4346/L_？_9625.jpg`
- asset id: `asset-005939`
...
- source class: `HUST-OBC/undeciphered/L/4346/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4346/L_？_9625.jpg`
- asset id: `asset-005939`
...
- English observation: `Upper cluster, right arm, and tapered lower end`
  `recorded.`
- 中文观察: `已记录上部痕迹簇、右侧外伸痕和收窄下端。`
...
- Which source records identify obs-unk-004346 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004346？
