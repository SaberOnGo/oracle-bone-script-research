...
- Review log draft ID / 复核日志草稿 ID: `xxt-obm-access-review-log-draft-0004`
- Follow-up review task ID / 后续复核任务 ID: `xxt-obm-followup-review-0004`
...
- Targeted download ID / 目标下载 ID: `dl-xxt-obm-guide`
- Targeted URL / 目标 URL:
-   - `https://xiaoxue.iis.sinica.edu.tw/obm/Content/Docs/Get_Started.pdf`
...
- profile_ids: `missing; see concrete questions below`
- profile_areas: `missing; see concrete questions below`
- profile_review_statuses: `missing; see concrete questions below`
- profile_normalized_values: `missing; see concrete questions below`
- staging_row_count: `0`
...
- Queue Metadata Snapshot / 队列 metadata 快照:
  - Download manifest row / 下载 manifest 行:
    - targeted_download_id: `dl-xxt-obm-guide`
    - targeted_url:
    -   - `https://xiaoxue.iis.sinica.edu.tw/obm/Content/Docs/Get_Started.pdf`
    - artifact_kind: `user_guide_pdf`
    - download_status: `downloaded_access_restricted_page`
- Notes / 备注:
...
- Concrete Missing-Item Questions / 具体缺失项待查问题:
  - English: Which 011_core-institutional-access-profile rows match this route?
  - 简体中文：本路线是否有对应的 011_core-institutional-access-profile 行？
