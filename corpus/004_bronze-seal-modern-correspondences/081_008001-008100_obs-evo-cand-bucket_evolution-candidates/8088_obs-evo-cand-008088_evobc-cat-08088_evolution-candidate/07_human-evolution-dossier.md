...
- Project ID: `obs-evo-cand-008088`
- EVOBC category candidate ID: `evobc-evo-cat-08088`
- External category reference: `evobc-cat-08088`
- Source category ID: `08088`
- Source label for human review: `视`
- Source codepoints: `U+89C6`
...
- `obs-evo-cand-008088-route-category-staging`
...
- `obs-evo-cand-008088-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008088-route-evolution-graph`
