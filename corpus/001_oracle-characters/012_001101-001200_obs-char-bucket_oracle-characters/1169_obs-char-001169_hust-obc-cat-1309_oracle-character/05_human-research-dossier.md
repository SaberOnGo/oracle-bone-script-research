# obs-char-001169 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001169`
- primary external id: `hust-obc-cat-1309`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1169_obs-char-001169_hust-obc-cat-1309_ora
  cle-character/03_visual-assets/001_asset-001174_hust-obc-cat-1309_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1309/G_1309_合36418(甲).png`
- asset id: `asset-001174`
...
- source category: `1309`
- validation class: `1168`
- source image route: `HUST-OBC/deciphered/1309/G_1309_合36418(甲).png`
- asset id: `asset-001174`
...
- English observation: `A dense irregular left cluster has an upper loop, a
  long right outer stroke, and several short lower projections.`
- 中文观察: `密集不规则左侧笔群有上部环、长右侧外笔和数条短下部外伸笔。`
...
- dataset label text: `㤓`
- dataset label codepoints: `U+3913`
...
- filename catalog route clues: `Heji-like filename clue: 合36418
  (G_1309_合36418(甲).png)`
...
- Which source records identify obs-char-001169 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001169？
