# obs-unk-003992 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003992`
- primary external id: `hust-obc-und-L-003992`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/092_obs-unk-003992_h
  ust-obc-und-L-003992_oracle-character-candidate/03_visual-assets/001_asset
  -005585_hust-obc-und-L-003992_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3992/L_？_8450.jpg`
- asset id: `asset-005585`
...
- source class: `HUST-OBC/undeciphered/L/3992/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3992/L_？_8450.jpg`
- asset id: `asset-005585`
...
- English observation: Two close curving traces run downward from a small upper
  cluster; a long diagonal stroke extends toward lower left.
- 中文观察：两条相近弯曲痕迹从上部小痕迹簇向下延伸；
  长斜向痕迹伸向左下方。
...
- Which source records identify obs-unk-003992 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003992？
