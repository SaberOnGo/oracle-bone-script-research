# obs-char-000283 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/283_obs-char-000283_hust-obc-cat-0319_orac
  le-character/03_visual-assets/001_asset-000288_hust-obc-cat-0319_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0319/G_0319_乙5199反合11040反.png`
- asset id: `asset-000288`
...
- source category: `0319`
- validation class: `282`
- source image route: `HUST-OBC/deciphered/0319/G_0319_乙5199反合11040反.png`
- asset id: `asset-000288`
...
- English observation: `The narrow image has a long upper horizontal stroke,
  a small lower-left enclosure with an inner bar, and a long descending
  stroke at the right.`
- 中文观察: `狭长图像上方有长横画，下方左侧有带内横画的小型闭合轮廓，右侧有长下行笔画。`
...
- dataset label text: `㔵`
- dataset label codepoints: `U+3535`
...
- filename catalog route clues: `Heji-like filename clue: 合11040
  (G_0319_乙5199反合11040反.png)`
...
- Which source records identify obs-char-000283 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000283？
