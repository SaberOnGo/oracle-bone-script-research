# obs-evo-cand-008947 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-08947`
- Source label for human review: `近`
- Source codepoints: `U+8FD1`
- Image reference count: `39`
- Era token counts: `CS:1;SS:3;WSC:35`
- Source token counts: `Book:9;Web:30`
