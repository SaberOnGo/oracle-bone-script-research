# obs-char-000124 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/124_obs-char-000124_hust-obc-cat-0138_orac
  le-character/03_visual-assets/001_asset-000129_hust-obc-cat-0138_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0138/G_0138_乙3468合10613賓組.png`
- asset id: `asset-000129`
...
- source category: `0138`
- validation class: `123`
- source image route: `HUST-OBC/deciphered/0138/G_0138_乙3468合10613賓組.png`
- asset id: `asset-000129`
...
- English observation: `The image has a pointed central upper mark, a
  descending central stroke, and several short detached marks arranged on
  both sides.`
- 中文观察: `图像上方有尖状中央痕迹，中部向下有主笔，两侧排列着数道分离短痕。`
...
- dataset label text: `㒀`
- dataset label codepoints: `U+3480`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00012`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00012`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00012`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/012_obs-evo-can
  d-000012_evobc-cat-00012_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/012_obs-evo-cand-000012_evobc-cat-00012_evolu
...
- Which source records identify obs-char-000124 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000124？
