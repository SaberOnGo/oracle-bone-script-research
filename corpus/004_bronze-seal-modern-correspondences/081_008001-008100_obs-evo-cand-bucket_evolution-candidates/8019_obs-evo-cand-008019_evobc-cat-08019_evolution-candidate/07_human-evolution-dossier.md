...
Project ID: `obs-evo-cand-008019`
...
- Project ID: `obs-evo-cand-008019`
- EVOBC category candidate ID: `evobc-evo-cat-08019`
- External category reference: `evobc-cat-08019`
- Source category ID: `08019`
- Source label for human review: `褱`
- Source codepoints: `U+8931`
...
- `obs-evo-cand-008019-route-category-staging`
...
- `obs-evo-cand-008019-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008019-route-evolution-graph`
