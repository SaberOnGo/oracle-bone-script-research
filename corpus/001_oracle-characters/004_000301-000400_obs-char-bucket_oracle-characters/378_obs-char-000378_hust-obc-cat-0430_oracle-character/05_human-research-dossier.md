# obs-char-000378 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000378`
- primary external id: `hust-obc-cat-0430`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/378_obs-char-000378_hust-obc-cat-0430_orac
  le-character/03_visual-assets/001_asset-000383_hust-obc-cat-0430_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0430/H_0430_60106_0.png`
- asset id: `asset-000383`
...
- source category: `0430`
- validation class: `377`
- source image route: `HUST-OBC/deciphered/0430/H_0430_60106_0.png`
- asset id: `asset-000383`
...
- English observation: `A bold central vertical stroke branches into two
  sweeping upper arms and a large open lower curve; a separate short lower
  mark is visible.`
- 中文观察: `粗重中央竖笔画分出两条弧形上臂和大型开放下部曲线；下方另见短痕迹。`
...
- dataset label text: `㖤`
- dataset label codepoints: `U+35A4`
...
- filename catalog route clues: `catalog-like filename clue: H_0430
  (H_0430_60106_0.png)`
...
- Which source records identify obs-char-000378 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000378？
