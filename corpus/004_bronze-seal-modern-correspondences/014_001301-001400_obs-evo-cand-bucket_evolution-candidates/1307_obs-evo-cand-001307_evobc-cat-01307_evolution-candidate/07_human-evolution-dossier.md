...
Project ID: `obs-evo-cand-001307`
...
- Project ID: `obs-evo-cand-001307`
- EVOBC category candidate ID: `evobc-evo-cat-01307`
- External category reference: `evobc-cat-01307`
- Source category ID: `01307`
- Source label for human review: `勦`
- Source codepoints: `U+52E6`
...
- `obs-evo-cand-001307-route-category-staging`
...
- `obs-evo-cand-001307-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001307-route-evolution-graph`
