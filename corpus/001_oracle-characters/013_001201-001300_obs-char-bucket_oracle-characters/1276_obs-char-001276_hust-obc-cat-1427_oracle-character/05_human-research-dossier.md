# obs-char-001276 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001276`
- primary external id: `hust-obc-cat-1427`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1276_obs-char-001276_hust-obc-cat-1427_ora
  cle-character/03_visual-assets/001_asset-001281_hust-obc-cat-1427_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1427/H_1427_608B1_0.png`
- asset id: `asset-001281`
...
- source category: `1427`
- validation class: `1275`
- source image route: `HUST-OBC/deciphered/1427/H_1427_608B1_0.png`
- asset id: `asset-001281`
...
- English observation: `A large complex form has a peaked upper bar, a
  central enclosed mark, side branches, and a sweeping lower stroke.`
- 中文观察: `大型复杂形体有尖顶上部横笔、中央框内标记、两侧分枝和一条横扫式下部长笔画。`
...
- dataset label text: `㦉`
- dataset label codepoints: `U+3989`
...
- filename catalog route clues: `catalog-like filename clue: H_1427
  (H_1427_608B1_0.png)`
...
- Which source records identify obs-char-001276 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001276？
