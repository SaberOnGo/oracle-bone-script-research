...
- `obs-evo-cand-005209-route-category-staging`
...
- `obs-evo-cand-005209-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005209-route-evolution-graph`
