...
Project ID: `obs-evo-cand-002030`
...
- Project ID: `obs-evo-cand-002030`
- EVOBC category candidate ID: `evobc-evo-cat-02030`
- External category reference: `evobc-cat-02030`
- Source category ID: `02030`
- Source label for human review: `奇`
- Source codepoints: `U+5947`
...
- `obs-evo-cand-002030-route-category-staging`
...
- `obs-evo-cand-002030-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002030-route-evolution-graph`
