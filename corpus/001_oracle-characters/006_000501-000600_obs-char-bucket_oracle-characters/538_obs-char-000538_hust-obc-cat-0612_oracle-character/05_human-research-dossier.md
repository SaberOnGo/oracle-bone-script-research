# obs-char-000538 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/538_obs-char-000538_hust-obc-cat-0612_orac
  le-character/03_visual-assets/001_asset-000543_hust-obc-cat-0612_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0612/G_0612_後2.30.8合26845出組.png
  `
- asset id: `asset-000543`
...
- source category: `0612`
- validation class: `537`
- source image route: `HUST-OBC/deciphered/0612/G_0612_後2.30.8合26845出組.png`
- asset id: `asset-000543`
...
- English observation: `A short sloping top bar caps a long curved
  descending stem, with two opposing short branches spreading near the upper
  middle.`
- 中文观察: `短斜顶横盖住长弯下行主干，上中部附近有两条相向短枝向两侧展开。`
...
- dataset label text: `㙚`
- dataset label codepoints: `U+365A`
...
- filename catalog route clues: `Heji-like filename clue: 合26845
...
- Which source records identify obs-char-000538 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000538？
