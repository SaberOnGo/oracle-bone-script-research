# Material Visual Observation / obs-comp-cand-001548 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001548`
- External reference / 外部参照: `obimd-sub-3h9yxituqj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016962_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6hyn7a9bnx/3h9yxituqj/3h9yxituqj.png`
- Checksum / 校验和:
  `62822aadb7238a43566d1d638a0660efbb5bc425667e3af66a910208905207d8`
...
- Marked-pixel bounds: (62,33)–(187,206); span 126 × 174 px; the marked
...
- 痕迹范围：(62,33)–(187,206)；跨度126 × 174 px；痕迹矩形高于宽。
