...
- Project ID: `obs-evo-cand-012095`
- EVOBC category candidate ID: `evobc-evo-cat-12095`
- External category reference: `evobc-cat-12095`
- Source category ID: `12095`
- Source label for human review: `𦯽`
- Source codepoints: `U+26BFD`
...
- `obs-evo-cand-012095-route-category-staging`
...
- `obs-evo-cand-012095-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012095-route-evolution-graph`
