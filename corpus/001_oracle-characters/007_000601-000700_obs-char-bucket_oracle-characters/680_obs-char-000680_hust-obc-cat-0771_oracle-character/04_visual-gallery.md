# obs-char-000680 Visual Gallery / obs-char-000680 图像资料页
...
- Project ID / 项目 ID: `obs-char-000680`
- Primary external reference / 首选外部参考: `hust-obc-cat-0771`
...
## obs-char-000680-visual-source-001 / 图像条目

![obs-char-000680 glyph candidate](03_visual-assets/001_asset-000685_hust-obc-cat-0771_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000685_hust-obc-cat-0771_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000685_hust-obc-cat-0771_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/0771/G_0771_前4.33.6合18805賓組.png`
