# obs-evo-cand-005063 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-05063`
- Source label: `烏`
- Source codepoints: `U+70CF`
- Image reference count: `540`
- Era token counts: `BI:38;CS:1;SAC:13;SS:1;WSC:487`
- Source token counts: `Book:79;Web:461`
...
- era 4 / WSC: 487 image references
- era 5 / CS: 1 image references
- source 1 / Web:105952;說文Web:58: 461 image references
- source 3 / Book:21681: 10 image references
- source 4 / Book:9131: 13 image references
- source 5 / Book:32794: 56 image references
