# obs-char-001240 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001240`
- primary external id: `hust-obc-cat-1387`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1240_obs-char-001240_hust-obc-cat-1387_ora
  cle-character/03_visual-assets/001_asset-001245_hust-obc-cat-1387_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1387/G_1387_甲骨文0.png`
- asset id: `asset-001245`
...
- source category: `1387`
- validation class: `1239`
- source image route: `HUST-OBC/deciphered/1387/G_1387_甲骨文0.png`
- asset id: `asset-001245`
...
- English observation: `A large peaked form has a central triangular
  enclosure, detached side strokes, and a small lower loop.`
- 中文观察: `大型尖顶形体有中央三角框廓、分离的侧笔和小型下部环。`
...
- dataset label text: `㥡`
- dataset label codepoints: `U+3961`
...
- Which source records identify obs-char-001240 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001240？
