...
- External category reference: `evobc-cat-08084`
- Source category ID: `08084`
- Source label for human review: `见`
- Source codepoints: `U+89C1`
...
- `obs-evo-cand-008084-route-category-staging`
...
- `obs-evo-cand-008084-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008084-route-evolution-graph`
