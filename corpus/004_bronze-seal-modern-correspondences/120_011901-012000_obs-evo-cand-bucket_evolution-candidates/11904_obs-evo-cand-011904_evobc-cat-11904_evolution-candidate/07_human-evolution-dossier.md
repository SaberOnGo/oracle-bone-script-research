...
- Project ID: `obs-evo-cand-011904`
- EVOBC category candidate ID: `evobc-evo-cat-11904`
- External category reference: `evobc-cat-11904`
- Source category ID: `11904`
- Source label for human review: `𥴐`
- Source codepoints: `U+25D10`
...
- `obs-evo-cand-011904-route-category-staging`
...
- `obs-evo-cand-011904-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011904-route-evolution-graph`
