# obs-unk-004324 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/024_obs-unk-004324_h
  ust-obc-und-L-004324_oracle-character-candidate/03_visual-assets/001_asset
  -005917_hust-obc-und-L-004324_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4324/L_？_9557.jpg`
- asset id: `asset-005917`
...
- source class: `HUST-OBC/undeciphered/L/4324/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4324/L_？_9557.jpg`
- asset id: `asset-005917`
...
- English observation: `Broad upper slant, central bend, and lower hook
  recorded.`
- 中文观察: `已记录上部宽斜痕、中央弯折和下部钩状痕迹。`
...
- Which source records identify obs-unk-004324 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004324？
