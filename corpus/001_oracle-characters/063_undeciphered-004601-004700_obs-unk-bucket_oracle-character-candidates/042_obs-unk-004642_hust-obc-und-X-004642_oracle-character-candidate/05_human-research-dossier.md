# obs-unk-004642 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004642`
- primary external id: `hust-obc-und-X-004642`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/042_obs-unk-004642_h
  ust-obc-und-X-004642_oracle-character-candidate/03_visual-assets/001_asset
  -006235_hust-obc-und-X-004642_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/198/X_？_8371_1.png`
- asset id: `asset-006235`
...
- source class: `HUST-OBC/undeciphered/X/198/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/198/X_？_8371_1.png`
- asset id: `asset-006235`
...
- English observation: `diagonal upper stroke and curled lower loop`
- 中文观察: `上方斜向笔画与下方卷曲环状形体`
...
- Which source records identify obs-unk-004642 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004642？
