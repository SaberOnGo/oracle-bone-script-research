...
- Project ID: `obs-evo-cand-002223`
- EVOBC category candidate ID: `evobc-evo-cat-02223`
- External category reference: `evobc-cat-02223`
- Source category ID: `02223`
- Source label for human review: `媆`
- Source codepoints: `U+5A86`
...
- `obs-evo-cand-002223-route-category-staging`
...
- `obs-evo-cand-002223-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002223-route-evolution-graph`
