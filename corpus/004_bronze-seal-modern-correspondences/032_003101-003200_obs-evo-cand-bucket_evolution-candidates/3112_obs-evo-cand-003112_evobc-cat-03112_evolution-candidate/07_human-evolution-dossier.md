...
- External category reference: `evobc-cat-03112`
- Source category ID: `03112`
- Source label for human review: `慒`
- Source codepoints: `U+6152`
...
- `obs-evo-cand-003112-route-category-staging`
...
- `obs-evo-cand-003112-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003112-route-evolution-graph`
