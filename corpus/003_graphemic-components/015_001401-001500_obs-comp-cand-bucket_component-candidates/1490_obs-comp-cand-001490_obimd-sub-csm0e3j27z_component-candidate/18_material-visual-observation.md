# Material Visual Observation / obs-comp-cand-001490 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001490`
- External reference / 外部参照: `obimd-sub-csm0e3j27z`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016101_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/34yhwco17n/csm0e3j27z/csm0e3j27z.png`
- Checksum / 校验和:
  `c1ef25b629308dead4acb7ab16912bce4aa12ba7bde8280361c3f38e8c334f02`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.12%.
- Marked-pixel bounds: (84,38)–(165,207); span 82 × 170 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.12%。
- 痕迹范围：(84,38)–(165,207)；跨度82 × 170 px；痕迹矩形高于宽。
