...
- External category reference: `evobc-cat-00115`
- Source category ID: `00115`
- Source label for human review: `㤞`
- Source codepoints: `U+391E`
...
- `obs-evo-cand-000115-route-category-staging`
...
- `obs-evo-cand-000115-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000115-route-evolution-graph`
