...
- `obs-evo-cand-012773-route-category-staging`
...
- `obs-evo-cand-012773-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012773-route-evolution-graph`
