# Material Visual Observation / obs-comp-cand-002072 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002072`
- External reference / 外部参照: `obimd-sub-p6gn06lpie`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019459_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/p6gn06lpie/p6gn06lpie/p6gn06lpie.png`
- Checksum / 校验和:
  `46fee128da9d8c627613f32495d72b5e4029ac889d4a824b74804051ba9e6afb`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.10%.
- Marked-pixel bounds: (56,24)–(208,224); span 153 × 201 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.10%。
- 痕迹范围：(56,24)–(208,224)；跨度153 × 201 px；痕迹矩形高于宽。
