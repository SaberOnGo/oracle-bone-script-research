# Material Visual Observation / obs-comp-cand-001340 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001340`
- External reference / 外部参照: `obimd-sub-f9f0lfjetk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015723_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/f9f0lfjetk/f9f0lfjetk/f9f0lfjetk.png`
- Checksum / 校验和:
  `793552c079159db273711a7acf5805911014095b5971c79ea7a15d2ab76fabb7`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.57%.
- Marked-pixel bounds: (57,51)–(192,191); span 136 × 141 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.57%。
- 痕迹范围：(57,51)–(192,191)；跨度136 × 141 px；痕迹矩形近方形。
