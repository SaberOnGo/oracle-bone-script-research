...
- `obs-evo-cand-001931-route-category-staging`
...
- `obs-evo-cand-001931-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001931-route-evolution-graph`
