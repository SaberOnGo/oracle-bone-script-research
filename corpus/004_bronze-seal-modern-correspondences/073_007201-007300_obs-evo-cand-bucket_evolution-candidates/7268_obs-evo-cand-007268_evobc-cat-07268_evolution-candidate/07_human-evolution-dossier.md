...
Project ID: `obs-evo-cand-007268`
...
- Project ID: `obs-evo-cand-007268`
- EVOBC category candidate ID: `evobc-evo-cat-07268`
- External category reference: `evobc-cat-07268`
- Source category ID: `07268`
- Source label for human review: `芼`
- Source codepoints: `U+82BC`
...
- `obs-evo-cand-007268-route-category-staging`
...
- `obs-evo-cand-007268-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007268-route-evolution-graph`
