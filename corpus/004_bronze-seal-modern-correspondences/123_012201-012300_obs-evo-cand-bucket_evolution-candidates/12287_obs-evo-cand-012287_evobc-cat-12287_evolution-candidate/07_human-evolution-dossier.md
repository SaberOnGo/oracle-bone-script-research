...
- External category reference: `evobc-cat-12287`
- Source category ID: `12287`
- Source label for human review: `𧷀`
- Source codepoints: `U+27DC0`
...
- `obs-evo-cand-012287-route-category-staging`
...
- `obs-evo-cand-012287-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012287-route-evolution-graph`
