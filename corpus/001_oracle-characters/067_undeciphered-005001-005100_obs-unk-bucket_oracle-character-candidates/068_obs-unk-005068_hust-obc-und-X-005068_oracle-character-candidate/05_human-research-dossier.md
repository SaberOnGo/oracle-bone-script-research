# obs-unk-005068 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/067_undeciphered-005
  001-005100_obs-unk-bucket_oracle-character-candidates/068_obs-unk-005068_h
  ust-obc-und-X-005068_oracle-character-candidate/03_visual-assets/001_asset
  -006661_hust-obc-und-X-005068_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/624/X_？_7596_1.png`
- asset id: `asset-006661`
...
- source class: `HUST-OBC/undeciphered/X/624/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/624/X_？_7596_1.png`
- asset id: `asset-006661`
...
- Which source records identify obs-unk-005068 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005068？
