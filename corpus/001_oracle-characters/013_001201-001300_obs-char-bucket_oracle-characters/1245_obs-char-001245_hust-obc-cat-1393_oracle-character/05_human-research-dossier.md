# obs-char-001245 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1245_obs-char-001245_hust-obc-cat-1393_ora
  cle-character/03_visual-assets/001_asset-001250_hust-obc-cat-1393_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1393/G_1393_前7.6.3合7921賓組.png`
- asset id: `asset-001250`
...
- source category: `1393`
- validation class: `1244`
- source image route: `HUST-OBC/deciphered/1393/G_1393_前7.6.3合7921賓組.png`
- asset id: `asset-001250`
...
- dataset label text: `㥧`
- dataset label codepoints: `U+3967`
...
- filename catalog route clues: `Heji-like filename clue: 合7921
...
- Which source records identify obs-char-001245 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001245？
