...
- External category reference: `evobc-cat-09842`
- Source category ID: `09842`
- Source label for human review: `雹`
- Source codepoints: `U+96F9`
...
- `obs-evo-cand-009842-route-category-staging`
...
- `obs-evo-cand-009842-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009842-route-evolution-graph`
