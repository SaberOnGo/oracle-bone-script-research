...
Project ID: `obs-evo-cand-000907`
...
- Project ID: `obs-evo-cand-000907`
- EVOBC category candidate ID: `evobc-evo-cat-00907`
- External category reference: `evobc-cat-00907`
- Source category ID: `00907`
- Source label for human review: `俴`
- Source codepoints: `U+4FF4`
...
- `obs-evo-cand-000907-route-category-staging`
...
- `obs-evo-cand-000907-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000907-route-evolution-graph`
