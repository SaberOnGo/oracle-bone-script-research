...
- `obs-evo-cand-008425-route-category-staging`
...
- `obs-evo-cand-008425-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008425-route-evolution-graph`
