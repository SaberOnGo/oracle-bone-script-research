...
- External category reference: `evobc-cat-01158`
- Source category ID: `01158`
- Source label for human review: `几`
...
- `obs-evo-cand-001158-route-category-staging`
...
- `obs-evo-cand-001158-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001158-route-evolution-graph`
