...
- External category reference: `evobc-cat-12670`
- Source category ID: `12670`
- Source label for human review: `𩫏`
- Source codepoints: `U+29ACF`
- Image reference count in source metadata: `70`
...
- `obs-evo-cand-012670-route-category-staging`
...
- `obs-evo-cand-012670-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012670-route-evolution-graph`
