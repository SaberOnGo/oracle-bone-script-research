...
- External category reference: `evobc-cat-02352`
- Source category ID: `02352`
- Source label for human review: `孽`
- Source codepoints: `U+5B7D`
- Image reference count in source metadata: `69`
...
- `obs-evo-cand-002352-route-category-staging`
...
- `obs-evo-cand-002352-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002352-route-evolution-graph`
