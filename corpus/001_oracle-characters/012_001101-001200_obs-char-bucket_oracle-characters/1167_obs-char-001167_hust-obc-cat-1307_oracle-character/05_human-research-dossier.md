# obs-char-001167 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001167`
- primary external id: `hust-obc-cat-1307`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1167_obs-char-001167_hust-obc-cat-1307_ora
  cle-character/03_visual-assets/001_asset-001172_hust-obc-cat-1307_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1307/G_1307_續1.14.3合1590賓組.png`
- asset id: `asset-001172`
...
- source category: `1307`
- validation class: `1166`
- source image route: `HUST-OBC/deciphered/1307/G_1307_續1.14.3合1590賓組.png`
- asset id: `asset-001172`
...
- English observation: `A compact curved enclosure has a small inner loop, a
  pointed upper tip, and a long descending right stroke.`
- 中文观察: `紧凑的弯曲框廓有小型内部环、尖状上端和长右侧下行笔。`
...
- dataset label text: `㤑`
- dataset label codepoints: `U+3911`
...
- filename catalog route clues: `Heji-like filename clue: 合1590
...
- Which source records identify obs-char-001167 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001167？
