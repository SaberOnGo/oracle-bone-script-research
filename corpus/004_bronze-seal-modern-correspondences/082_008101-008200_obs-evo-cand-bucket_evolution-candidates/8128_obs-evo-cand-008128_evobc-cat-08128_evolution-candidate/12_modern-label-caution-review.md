# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008128
...
- EVOBC candidate category: `evobc-evo-cat-08128`.
- Source label for search only: `訊`.
- Source codepoints for search only: `U+8A0A`.
