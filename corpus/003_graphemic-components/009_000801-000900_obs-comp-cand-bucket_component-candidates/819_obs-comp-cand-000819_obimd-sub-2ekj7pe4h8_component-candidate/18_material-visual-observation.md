# Material Visual Observation / obs-comp-cand-000819 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000819`
- External reference / 外部参照: `obimd-sub-2ekj7pe4h8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013690_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2ekj7pe4h8/2ekj7pe4h8/2ekj7pe4h8.png`
- Checksum / 校验和:
  `dd41eeb003953ed984a809bfb957d497758a001548549cc8247beb6df6fd68eb`
...
- Marked-pixel bounds: (62,24)–(189,225); span 128 × 202 px; the marked
...
- 痕迹范围：(62,24)–(189,225)；跨度128 × 202 px；痕迹矩形高于宽。
