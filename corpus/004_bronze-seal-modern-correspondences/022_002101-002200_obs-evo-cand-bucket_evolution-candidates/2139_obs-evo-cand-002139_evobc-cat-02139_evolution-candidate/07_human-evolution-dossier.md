...
- External category reference: `evobc-cat-02139`
- Source category ID: `02139`
- Source label for human review: `姬`
- Source codepoints: `U+59EC`
- Image reference count in source metadata: `238`
...
- `obs-evo-cand-002139-route-category-staging`
...
- `obs-evo-cand-002139-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002139-route-evolution-graph`
