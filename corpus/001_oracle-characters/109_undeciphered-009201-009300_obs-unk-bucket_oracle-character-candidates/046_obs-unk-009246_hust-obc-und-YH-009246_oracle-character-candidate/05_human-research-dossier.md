# obs-unk-009246 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-009246`
- primary external id: `hust-obc-und-YH-009246`
...
- local review image route: `corpus/001_oracle-characters/109_undeciphered-009
  201-009300_obs-unk-bucket_oracle-character-candidates/046_obs-unk-009246_h
  ust-obc-und-YH-009246_oracle-character-candidate/03_visual-assets/001_asse
  t-010837_hust-obc-und-YH-009246_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/613FD/H_？_613FD_0.png`
- asset id: `asset-010837`
...
- source class: `HUST-OBC/undeciphered/Y+H/613FD/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/613FD/H_？_613FD_0.png`
- asset id: `asset-010837`
...
- Which source records identify obs-unk-009246 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009246？
