...
Project ID: `obs-evo-cand-002563`
...
- Project ID: `obs-evo-cand-002563`
- EVOBC category candidate ID: `evobc-evo-cat-02563`
- External category reference: `evobc-cat-02563`
- Source category ID: `02563`
- Source label for human review: `崒`
- Source codepoints: `U+5D12`
...
- `obs-evo-cand-002563-route-category-staging`
...
- `obs-evo-cand-002563-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002563-route-evolution-graph`
