# Material Visual Observation / obs-comp-cand-001356 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001356`
- External reference / 外部参照: `obimd-sub-s9s2kwlc5v`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015745_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/b1ojfpwayk/s9s2kwlc5v/s9s2kwlc5v.png`
- Checksum / 校验和:
  `58317b4b90455e0cd19c31100de959dab19992034e469fb8bf3ccf132fbfb339`
...
- Marked-pixel bounds: (68,43)–(181,205); span 114 × 163 px; the marked
...
- 痕迹范围：(68,43)–(181,205)；跨度114 × 163 px；痕迹矩形高于宽。
