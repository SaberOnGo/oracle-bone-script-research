...
- External category reference: `evobc-cat-02763`
- Source category ID: `02763`
- Source label: `廟`
...
- `obs-evo-cand-002763-route-category-staging`
...
- `obs-evo-cand-002763-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002763-route-evolution-graph`
