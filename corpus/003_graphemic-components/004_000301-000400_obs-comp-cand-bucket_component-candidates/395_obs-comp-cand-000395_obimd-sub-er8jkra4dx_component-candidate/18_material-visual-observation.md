# Material Visual Observation / obs-comp-cand-000395 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000395`
- External reference / 外部参照: `obimd-sub-er8jkra4dx`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012318_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/er8jkra4dx/er8jkra4dx/er8jkra4dx.png`
- Checksum / 校验和:
  `0d200efcc46e9c0b9ed9955e71cb55c99fb990a3805fe45bf8b95cb61f312b69`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 14.66%.
- Marked-pixel bounds: (44,17)–(219,230); span 176 × 214 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占14.66%。
- 痕迹范围：(44,17)–(219,230)；跨度176 × 214 px；痕迹矩形高于宽。
