...
Project ID: `obs-insc-cw-cand-000162`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000162`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000162` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y956` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `234` [route_present_image_or_text_not_collected]
