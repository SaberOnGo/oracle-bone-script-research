# obs-unk-004519 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004519`
- primary external id: `hust-obc-und-X-004519`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/019_obs-unk-004519_h
  ust-obc-und-X-004519_oracle-character-candidate/03_visual-assets/001_asset
  -006112_hust-obc-und-X-004519_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/75/X_？_8259_1.png`
- asset id: `asset-006112`
...
- source class: `HUST-OBC/undeciphered/X/75/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/75/X_？_8259_1.png`
- asset id: `asset-006112`
...
- English observation: `The central stem, upper and lower horizontal traces,
  and tapered upper-left end are directly recorded.`
- 中文观察: `已直接记录中央主痕、上下横痕和左上端收尖形态。`
...
- Which source records identify obs-unk-004519 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004519？
