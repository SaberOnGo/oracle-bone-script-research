...
- External category reference: `evobc-cat-13549`
- Source category ID: `13549`
- Source label for human review: `𭨄`
- Source codepoints: `U+2DA04`
...
- `obs-evo-cand-013549-route-category-staging`
...
- `obs-evo-cand-013549-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013549-route-evolution-graph`
