# obs-char-001092 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001092`
- primary external id: `hust-obc-cat-1221`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1092_obs-char-001092_hust-obc-cat-1221_ora
  cle-character/03_visual-assets/001_asset-001097_hust-obc-cat-1221_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1221/G_1221_京都263(甲).png`
- asset id: `asset-001097`
...
- source category: `1221`
- validation class: `1091`
- source image route: `HUST-OBC/deciphered/1221/G_1221_京都263(甲).png`
- asset id: `asset-001097`
...
- English observation: `A narrow form combines a short left branch, a
  central upright, and a rounded right enclosure.`
- 中文观察: `狭长形体结合左侧短分枝、中央直立笔和右侧圆弧闭合轮廓。`
...
- dataset label text: `㢻`
- dataset label codepoints: `U+38BB`
...
- Which source records identify obs-char-001092 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001092？
