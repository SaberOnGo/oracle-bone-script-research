...
Project ID: `obs-insc-cw-cand-000456`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000456`
...
- Source page section: `Period III Group 12` /
  `第 III 期第 12 组`
- Source section key: `period-iii-group-12`
...
- Yingguo / 英国所藏: `y2335` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `306` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `212` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000456`
