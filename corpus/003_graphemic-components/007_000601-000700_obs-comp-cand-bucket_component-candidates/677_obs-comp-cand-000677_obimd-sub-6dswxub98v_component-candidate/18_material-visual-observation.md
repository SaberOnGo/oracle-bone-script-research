# Material Visual Observation / obs-comp-cand-000677 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000677`
- External reference / 外部参照: `obimd-sub-6dswxub98v`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013276_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xmfpjivigx/6dswxub98v/6dswxub98v.png`
- Checksum / 校验和:
  `0942698a95f59a879b8c611643cab4cd6fe97527b4b942d0b61772b8b98eb661`
...
- Marked-pixel bounds: (57,45)–(192,207); span 136 × 163 px; the marked
...
- 痕迹范围：(57,45)–(192,207)；跨度136 × 163 px；痕迹矩形近方形。
