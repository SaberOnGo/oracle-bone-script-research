# Material Visual Observation / obs-comp-cand-001999 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001999`
- External reference / 外部参照: `obimd-sub-2r7lrqai1j`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019137_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qmvfvw99v9/2r7lrqai1j/0rarlseeh2.png`
- Checksum / 校验和:
  `05c9fb0c92472a96f7289231c52fa29c82aba1d1dbc22c34a2e8b18eaa329e59`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.78%.
- Marked-pixel bounds: (64,45)–(185,199); span 122 × 155 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.78%。
- 痕迹范围：(64,45)–(185,199)；跨度122 × 155 px；痕迹矩形高于宽。
