...
- External category reference: `evobc-cat-08683`
- Source category ID: `08683`
- Source label: `趛`
...
- `obs-evo-cand-008683-route-category-staging`
...
- `obs-evo-cand-008683-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-008683-route-evolution-graph`
