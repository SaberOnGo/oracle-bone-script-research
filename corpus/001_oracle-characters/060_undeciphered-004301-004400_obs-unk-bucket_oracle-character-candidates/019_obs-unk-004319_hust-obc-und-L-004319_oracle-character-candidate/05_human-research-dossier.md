# obs-unk-004319 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/019_obs-unk-004319_h
  ust-obc-und-L-004319_oracle-character-candidate/03_visual-assets/001_asset
  -005912_hust-obc-und-L-004319_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4319/L_？_954.jpg`
- asset id: `asset-005912`
...
- source class: `HUST-OBC/undeciphered/L/4319/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4319/L_？_954.jpg`
- asset id: `asset-005912`
...
- English observation: `Upper open curves and central descending trace
  recorded.`
- 中文观察: `已记录上部开口曲线和中央下伸痕迹。`
...
- Which source records identify obs-unk-004319 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004319？
