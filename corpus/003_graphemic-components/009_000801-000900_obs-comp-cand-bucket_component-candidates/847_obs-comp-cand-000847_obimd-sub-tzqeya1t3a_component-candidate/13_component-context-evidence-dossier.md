# obs-comp-cand-000847 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000847`
- 首选外部 ID: `obimd-sub-tzqeya1t3a`
- OBIMD subcharacter UID: `tzqeya1t3a`
- OBIMD main character UID: `tzqeya1t3a`
- 来源 ID: `src-obimd`
