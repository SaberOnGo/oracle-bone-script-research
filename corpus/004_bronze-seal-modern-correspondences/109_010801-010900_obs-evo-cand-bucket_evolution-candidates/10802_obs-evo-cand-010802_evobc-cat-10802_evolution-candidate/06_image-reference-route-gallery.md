...
- `obs-evo-cand-010802-route-category-staging`
...
- `obs-evo-cand-010802-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010802-route-evolution-graph`
