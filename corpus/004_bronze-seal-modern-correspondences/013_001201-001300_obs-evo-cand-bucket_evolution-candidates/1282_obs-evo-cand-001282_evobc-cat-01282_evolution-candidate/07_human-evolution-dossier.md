...
- External category reference: `evobc-cat-01282`
- Source category ID: `01282`
- Source label for human review: `势`
- Source codepoints: `U+52BF`
...
- `obs-evo-cand-001282-route-category-staging`
...
- `obs-evo-cand-001282-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001282-route-evolution-graph`
