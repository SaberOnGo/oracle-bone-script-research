...
Project ID: `obs-evo-cand-010128`
...
- Project ID: `obs-evo-cand-010128`
- EVOBC category candidate ID: `evobc-evo-cat-10128`
- External category reference: `evobc-cat-10128`
- Source category ID: `10128`
- Source label for human review: `饁`
- Source codepoints: `U+9941`
...
- `obs-evo-cand-010128-route-category-staging`
...
- `obs-evo-cand-010128-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010128-route-evolution-graph`
