...
Project ID: `obs-evo-cand-003429`
...
- Project ID: `obs-evo-cand-003429`
- EVOBC category candidate ID: `evobc-evo-cat-03429`
- External category reference: `evobc-cat-03429`
- Source category ID: `03429`
- Source label for human review: `揚`
- Source codepoints: `U+63DA`
- Image reference count in source metadata: `183`
...
- `obs-evo-cand-003429-route-category-staging`
...
- `obs-evo-cand-003429-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003429-route-evolution-graph`
