# obs-char-001186 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001186`
- primary external id: `hust-obc-cat-1326`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1186_obs-char-001186_hust-obc-cat-1326_ora
  cle-character/03_visual-assets/001_asset-001191_hust-obc-cat-1326_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1326/G_1326_乙930合11460賓組.png`
- asset id: `asset-001191`
...
- source category: `1326`
- validation class: `1185`
- source image route: `HUST-OBC/deciphered/1326/G_1326_乙930合11460賓組.png`
- asset id: `asset-001191`
...
- English observation: `A narrow sloping form has several short curved bands
  and a long thin descending lower stroke.`
- 中文观察: `狭长斜向形体有数条短弯曲带和一条细长下行笔。`
...
- dataset label text: `㤤`
- dataset label codepoints: `U+3924`
...
- filename catalog route clues: `Heji-like filename clue: 合11460
  (G_1326_乙930合11460賓組.png)`
...
- Which source records identify obs-char-001186 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001186？
