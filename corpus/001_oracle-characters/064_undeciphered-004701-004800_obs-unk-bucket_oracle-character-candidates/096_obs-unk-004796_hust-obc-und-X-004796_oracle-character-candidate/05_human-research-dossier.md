# obs-unk-004796 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004796`
- primary external id: `hust-obc-und-X-004796`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/096_obs-unk-004796_h
  ust-obc-und-X-004796_oracle-character-candidate/03_visual-assets/001_asset
  -006389_hust-obc-und-X-004796_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/352/X_？_7335_1.png`
- asset id: `asset-006389`
...
- source class: `HUST-OBC/undeciphered/X/352/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/352/X_？_7335_1.png`
- asset id: `asset-006389`
...
- English observation: `upper opening, detached fragments, and lower terminal`
- 中文观察: `上部开口、分离片段和下部末端`
...
- Which source records identify obs-unk-004796 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004796？
