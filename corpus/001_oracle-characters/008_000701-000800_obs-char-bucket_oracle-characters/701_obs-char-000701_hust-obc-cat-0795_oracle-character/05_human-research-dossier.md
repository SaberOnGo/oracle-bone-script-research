# obs-char-000701 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000701`
- primary external id: `hust-obc-cat-0795`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/701_obs-char-000701_hust-obc-cat-0795_orac
  le-character/03_visual-assets/001_asset-000706_hust-obc-cat-0795_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0795/G_0795_佚506合11505賓組.png`
- asset id: `asset-000706`
...
- source category: `0795`
- validation class: `700`
- source image route: `HUST-OBC/deciphered/0795/G_0795_佚506合11505賓組.png`
- asset id: `asset-000706`
...
- English observation: `Three detached rounded rectangular loops form a
  triangular arrangement, with one above and two below; each contains a
  short horizontal inner bar or white slit.`
- 中文观察: `三个分离圆角矩形环组成上一个、下两个的三角排列，每个内部均有短横栏或白色横隙。`
...
- dataset label text: `㜑`
- dataset label codepoints: `U+3711`
...
- filename catalog route clues: `Heji-like filename clue: 合11505
  (G_0795_佚506合11505賓組.png)`
...
- Which source records identify obs-char-000701 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000701？
