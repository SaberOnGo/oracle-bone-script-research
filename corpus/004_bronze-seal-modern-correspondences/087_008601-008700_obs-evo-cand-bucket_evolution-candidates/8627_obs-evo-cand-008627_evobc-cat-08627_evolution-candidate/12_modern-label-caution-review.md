# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008627
...
- EVOBC candidate category: `evobc-evo-cat-08627`.
- Source label for search only: `贯`.
- Source codepoints for search only: `U+8D2F`.
