...
- External category reference: `evobc-cat-11830`
- Source category ID: `11830`
- Source label for human review: `𥝁`
- Source codepoints: `U+25741`
...
- `obs-evo-cand-011830-route-category-staging`
...
- `obs-evo-cand-011830-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011830-route-evolution-graph`
