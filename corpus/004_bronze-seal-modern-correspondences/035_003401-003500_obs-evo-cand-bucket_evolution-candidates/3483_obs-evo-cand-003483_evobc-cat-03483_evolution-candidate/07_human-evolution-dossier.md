...
- External category reference: `evobc-cat-03483`
- Source category ID: `03483`
- Source label for human review: `摳`
- Source codepoints: `U+6473`
...
- `obs-evo-cand-003483-route-category-staging`
...
- `obs-evo-cand-003483-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003483-route-evolution-graph`
