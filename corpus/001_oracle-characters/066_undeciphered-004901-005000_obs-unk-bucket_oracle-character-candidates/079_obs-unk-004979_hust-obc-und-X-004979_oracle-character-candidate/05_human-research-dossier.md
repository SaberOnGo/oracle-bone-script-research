# obs-unk-004979 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/079_obs-unk-004979_h
  ust-obc-und-X-004979_oracle-character-candidate/03_visual-assets/001_asset
  -006572_hust-obc-und-X-004979_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/535/X_？_7515_1.png`
- asset id: `asset-006572`
...
- An upper opening, central crossing, and two lower branches are visible.
...
- source class: `HUST-OBC/undeciphered/X/535/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/535/X_？_7515_1.png`
- asset id: `asset-006572`
...
- Which source records identify obs-unk-004979 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004979？
