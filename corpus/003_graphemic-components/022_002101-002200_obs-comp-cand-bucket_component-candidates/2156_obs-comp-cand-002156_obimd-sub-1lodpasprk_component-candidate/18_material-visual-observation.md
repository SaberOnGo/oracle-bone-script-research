# Material Visual Observation / obs-comp-cand-002156 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002156`
- External reference / 外部参照: `obimd-sub-1lodpasprk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019797_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cv483h1fw2/1lodpasprk/1lodpasprk.png`
- Checksum / 校验和:
  `bc9858cc3fc77f13b82388deea4fd781839802bbf9d4d5dddd20f7ebed2f019a`
...
- Marked-pixel bounds: (95,26)–(154,222); span 60 × 197 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.88%。
- 痕迹范围：(95,26)–(154,222)；跨度60 × 197 px；痕迹矩形高于宽。
