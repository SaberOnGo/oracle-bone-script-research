...
- External category reference: `evobc-cat-04892`
- Source category ID: `04892`
- Source label for human review: `潏`
- Source codepoints: `U+6F4F`
...
- `obs-evo-cand-004892-route-category-staging`
...
- `obs-evo-cand-004892-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004892-route-evolution-graph`
