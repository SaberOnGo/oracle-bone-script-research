# obs-char-000145 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000145`
- primary external id: `hust-obc-cat-0160`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/145_obs-char-000145_hust-obc-cat-0160_orac
  le-character/03_visual-assets/001_asset-000150_hust-obc-cat-0160_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0160/G_0160_乙4761合6943賓組.png`
- asset id: `asset-000150`
...
- source category: `0160`
- validation class: `144`
- source image route: `HUST-OBC/deciphered/0160/G_0160_乙4761合6943賓組.png`
- asset id: `asset-000150`
...
- English observation: `The image has a broad angular upper chevron, a
  rounded open lower-left frame, and a central descending stroke with a
  short branch.`
...
- dataset label text: `㒖`
- dataset label codepoints: `U+3496`
...
- filename catalog route clues: `Heji-like filename clue: 合6943
  (G_0160_乙4761合6943賓組.png)`
...
- Which source records identify obs-char-000145 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000145？
