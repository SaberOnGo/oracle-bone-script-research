...
Project ID: `obs-evo-cand-005424`
...
- Project ID: `obs-evo-cand-005424`
- EVOBC category candidate ID: `evobc-evo-cat-05424`
- External category reference: `evobc-cat-05424`
- Source category ID: `05424`
- Source label for human review: `琴`
- Source codepoints: `U+7434`
...
- `obs-evo-cand-005424-route-category-staging`
...
- `obs-evo-cand-005424-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005424-route-evolution-graph`
