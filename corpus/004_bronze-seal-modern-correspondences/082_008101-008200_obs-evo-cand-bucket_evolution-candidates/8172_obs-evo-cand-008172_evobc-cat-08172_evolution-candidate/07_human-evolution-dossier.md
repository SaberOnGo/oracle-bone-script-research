...
- External category reference: `evobc-cat-08172`
- Source category ID: `08172`
- Source label: `詍`
...
- `obs-evo-cand-008172-route-category-staging`
...
- `obs-evo-cand-008172-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008172-route-evolution-graph`
