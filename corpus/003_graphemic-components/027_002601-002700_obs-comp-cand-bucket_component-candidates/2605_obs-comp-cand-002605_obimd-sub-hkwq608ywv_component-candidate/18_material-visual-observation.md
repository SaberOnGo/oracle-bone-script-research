# Material Visual Observation / obs-comp-cand-002605 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002605`
- External reference / 外部参照: `obimd-sub-hkwq608ywv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021144_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hkwq608ywv/hkwq608ywv/hkwq608ywv.png`
- Checksum / 校验和:
  `e86d186ed192f37599e767d635f84c4def6b20d8d8d889c14a1a4700d878c88e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.69%.
- Marked-pixel bounds: (67,35)–(193,222); span 127 × 188 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.69%。
- 痕迹范围：(67,35)–(193,222)；跨度127 × 188 px；痕迹矩形高于宽。
