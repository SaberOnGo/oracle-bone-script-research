...
- Project ID / 项目 ID: `obs-char-000750`
- Primary external ID / 首选外部 ID: `hust-obc-cat-0852`
...
- Source image / 来源图: `G_0852_乙960(甲).png`
- Image / 图像: `001_asset-000755_hust-obc-cat-0852_glyph.png`
...
- target node: `obimd-main-cand-001708`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- OBIMD candidate ids / OBIMD 候选 ID: `obimd-main-cand-001708`
- OBIMD external refs / OBIMD 外部引用: `obimd-main-mqa9ifrvq4`
- OBIMD transcription field / OBIMD 转写字段: `㝊`
...
- Matched OBIMD main UIDs / OBIMD 主字 UID: `mqa9ifrvq4`
...
- Source label text / 来源标签文字: `㝊`
- Source label codepoint / 来源标签 codepoint: `U+374A`
