# Material Visual Observation / obs-comp-cand-002007 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002007`
- External reference / 外部参照: `obimd-sub-l4lq5esn5g`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019287_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/l4lq5esn5g/l4lq5esn5g/l4lq5esn5g.png`
- Checksum / 校验和:
  `0cdec58c37e4bd2b274c6a0065e1ead1944f01b765d092d2b93438cb6704d188`
...
- Marked-pixel bounds: (80,43)–(175,212); span 96 × 170 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.14%。
- 痕迹范围：(80,43)–(175,212)；跨度96 × 170 px；痕迹矩形高于宽。
