# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004900
...
- Project ID: `obs-evo-cand-004900`.
- EVOBC candidate category: `evobc-evo-cat-04900`.
- Source label for search only: `潛`.
- Source codepoints for search only: `U+6F5B`.
