...
Project ID: `obs-evo-cand-004806`
...
- Project ID: `obs-evo-cand-004806`
- EVOBC category candidate ID: `evobc-evo-cat-04806`
- External category reference: `evobc-cat-04806`
- Source category ID: `04806`
- Source label for human review: `溑`
- Source codepoints: `U+6E91`
...
- `obs-evo-cand-004806-route-category-staging`
...
- `obs-evo-cand-004806-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004806-route-evolution-graph`
