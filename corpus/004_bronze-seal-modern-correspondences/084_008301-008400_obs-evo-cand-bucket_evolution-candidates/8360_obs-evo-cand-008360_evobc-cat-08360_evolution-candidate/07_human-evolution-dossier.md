...
- Project ID: `obs-evo-cand-008360`
- EVOBC category candidate ID: `evobc-evo-cat-08360`
- External category reference: `evobc-cat-08360`
- Source category ID: `08360`
- Source label for human review: `識`
- Source codepoints: `U+8B58`
...
- `obs-evo-cand-008360-route-category-staging`
...
- `obs-evo-cand-008360-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008360-route-evolution-graph`
