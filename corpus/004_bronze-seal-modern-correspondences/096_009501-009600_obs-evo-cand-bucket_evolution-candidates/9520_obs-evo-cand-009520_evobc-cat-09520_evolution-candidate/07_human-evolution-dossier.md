...
Project ID: `obs-evo-cand-009520`
...
- Project ID: `obs-evo-cand-009520`
- EVOBC category candidate ID: `evobc-evo-cat-09520`
- External category reference: `evobc-cat-09520`
- Source category ID: `09520`
- Source label for human review: `鐉`
- Source codepoints: `U+9409`
...
- `obs-evo-cand-009520-route-category-staging`
...
- `obs-evo-cand-009520-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009520-route-evolution-graph`
