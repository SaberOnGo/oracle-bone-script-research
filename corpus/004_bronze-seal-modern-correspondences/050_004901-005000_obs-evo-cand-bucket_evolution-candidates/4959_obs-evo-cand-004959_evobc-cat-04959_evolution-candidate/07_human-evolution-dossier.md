...
- External category reference: `evobc-cat-04959`
- Source category ID: `04959`
- Source label for human review: `濏`
...
- `obs-evo-cand-004959-route-category-staging`
...
- `obs-evo-cand-004959-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004959-route-evolution-graph`
