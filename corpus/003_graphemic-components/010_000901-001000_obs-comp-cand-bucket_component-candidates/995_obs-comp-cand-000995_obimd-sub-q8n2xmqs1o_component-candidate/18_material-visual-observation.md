# Material Visual Observation / obs-comp-cand-000995 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000995`
- External reference / 外部参照: `obimd-sub-q8n2xmqs1o`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014365_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/q8n2xmqs1o/q8n2xmqs1o/q8n2xmqs1o.png`
- Checksum / 校验和:
  `a302fc58628f55db83965e6ffdc5fd9c3c5bb4374ef73774c9c148c2bd9297aa`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.60%.
- Marked-pixel bounds: (87,28)–(175,227); span 89 × 200 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.60%。
- 痕迹范围：(87,28)–(175,227)；跨度89 × 200 px；痕迹矩形高于宽。
