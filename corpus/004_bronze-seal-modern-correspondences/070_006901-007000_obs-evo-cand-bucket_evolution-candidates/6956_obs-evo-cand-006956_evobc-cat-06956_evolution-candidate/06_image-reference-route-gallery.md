...
- `obs-evo-cand-006956-route-category-staging`
...
- `obs-evo-cand-006956-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006956-route-evolution-graph`
