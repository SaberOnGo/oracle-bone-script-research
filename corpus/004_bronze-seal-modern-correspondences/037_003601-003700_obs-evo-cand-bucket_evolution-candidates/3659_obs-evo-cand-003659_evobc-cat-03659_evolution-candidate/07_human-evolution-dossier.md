...
- External category reference: `evobc-cat-03659`
- Source category ID: `03659`
- Source label for human review: `於`
- Source codepoints: `U+65BC`
- Image reference count in source metadata: `465`
...
- era `4`
  token: `WSC`
  image references: 434
- era `5`
  token: `CS`
  image references: 2
- source `1`
  token: `Web:105952;說文Web:58`
  image references: 465
...
- `obs-evo-cand-003659-route-category-staging`
...
- `obs-evo-cand-003659-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003659-route-evolution-graph`
