...
- Project ID: `obs-evo-cand-012445`
- EVOBC category candidate ID: `evobc-evo-cat-12445`
- External category reference: `evobc-cat-12445`
- Source category ID: `12445`
- Source label for human review: `𨜖`
- Source codepoints: `U+28716`
...
- `obs-evo-cand-012445-route-category-staging`
...
- `obs-evo-cand-012445-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012445-route-evolution-graph`
