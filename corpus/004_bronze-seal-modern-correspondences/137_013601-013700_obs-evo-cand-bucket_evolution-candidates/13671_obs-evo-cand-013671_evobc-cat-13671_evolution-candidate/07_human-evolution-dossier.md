...
- External category reference: `evobc-cat-13671`
- Source category ID: `13671`
- Source label for human review: `𮣰`
- Source codepoints: `U+2E8F0`
...
- `obs-evo-cand-013671-route-category-staging`
...
- `obs-evo-cand-013671-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013671-route-evolution-graph`
