...
Project ID: `obs-evo-cand-005613`
...
- Project ID: `obs-evo-cand-005613`
- EVOBC category candidate ID: `evobc-evo-cat-05613`
- External category reference: `evobc-cat-05613`
- Source category ID: `05613`
- Source label for human review: `疢`
- Source codepoints: `U+75A2`
...
- `obs-evo-cand-005613-route-category-staging`
...
- `obs-evo-cand-005613-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005613-route-evolution-graph`
