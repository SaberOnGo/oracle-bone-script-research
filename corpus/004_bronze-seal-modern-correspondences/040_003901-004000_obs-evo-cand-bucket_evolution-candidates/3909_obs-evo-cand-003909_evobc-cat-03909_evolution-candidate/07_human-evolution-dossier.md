...
Project ID: `obs-evo-cand-003909`
...
- Project ID: `obs-evo-cand-003909`
- EVOBC category candidate ID: `evobc-evo-cat-03909`
- External category reference: `evobc-cat-03909`
- Source category ID: `03909`
- Source label for human review: `极`
- Source codepoints: `U+6781`
...
- `obs-evo-cand-003909-route-category-staging`
...
- `obs-evo-cand-003909-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003909-route-evolution-graph`
