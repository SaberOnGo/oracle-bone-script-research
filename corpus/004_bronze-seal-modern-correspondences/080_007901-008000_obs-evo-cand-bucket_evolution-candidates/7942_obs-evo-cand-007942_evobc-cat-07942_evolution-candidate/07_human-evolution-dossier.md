...
- External category reference: `evobc-cat-07942`
- Source category ID: `07942`
- Source label for human review: `袑`
...
- `obs-evo-cand-007942-route-category-staging`
...
- `obs-evo-cand-007942-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007942-route-evolution-graph`
