...
- `obs-evo-cand-005892-route-category-staging`
...
- `obs-evo-cand-005892-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005892-route-evolution-graph`
