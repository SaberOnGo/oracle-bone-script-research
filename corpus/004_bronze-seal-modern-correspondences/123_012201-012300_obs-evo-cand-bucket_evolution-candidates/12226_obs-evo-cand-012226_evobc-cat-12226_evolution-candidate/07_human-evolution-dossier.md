...
- Project ID: `obs-evo-cand-012226`
- EVOBC category candidate ID: `evobc-evo-cat-12226`
- External category reference: `evobc-cat-12226`
- Source category ID: `12226`
- Source label for human review: `𧦤`
- Source codepoints: `U+279A4`
...
- `obs-evo-cand-012226-route-category-staging`
...
- `obs-evo-cand-012226-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012226-route-evolution-graph`
