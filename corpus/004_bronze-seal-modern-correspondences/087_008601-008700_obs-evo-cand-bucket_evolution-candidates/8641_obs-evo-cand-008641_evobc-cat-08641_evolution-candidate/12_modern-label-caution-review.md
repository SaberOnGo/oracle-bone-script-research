# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008641
...
- EVOBC candidate category: `evobc-evo-cat-08641`.
- Source label for search only: `赌`.
- Source codepoints for search only: `U+8D4C`.
