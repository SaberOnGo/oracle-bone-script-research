# obs-unk-002460 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002460`
- primary external id: `hust-obc-und-L-002460`
...
- local review image route: `corpus/001_oracle-characters/041_undeciphered-002
  401-002500_obs-unk-bucket_oracle-character-candidates/060_obs-unk-002460_h
  ust-obc-und-L-002460_oracle-character-candidate/03_visual-assets/001_asset
  -004053_hust-obc-und-L-002460_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2460/L_？_3606.jpg`
- asset id: `asset-004053`
...
- source class: `HUST-OBC/undeciphered/L/2460/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2460/L_？_3606.jpg`
- asset id: `asset-004053`
...
- Which source records identify obs-unk-002460 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002460？
