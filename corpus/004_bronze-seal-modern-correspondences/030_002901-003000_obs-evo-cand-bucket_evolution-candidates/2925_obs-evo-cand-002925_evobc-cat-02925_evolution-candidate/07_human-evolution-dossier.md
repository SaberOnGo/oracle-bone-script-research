...
- External category reference: `evobc-cat-02925`
- Source category ID: `02925`
- Source label for human review: `忽`
- Source codepoints: `U+5FFD`
...
- `obs-evo-cand-002925-route-category-staging`
...
- `obs-evo-cand-002925-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002925-route-evolution-graph`
