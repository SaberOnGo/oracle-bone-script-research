...
- External category reference: `evobc-cat-09275`
- Source category ID: `09275`
- Source label for human review: `醠`
...
- `obs-evo-cand-009275-route-category-staging`
...
- `obs-evo-cand-009275-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009275-route-evolution-graph`
