# Material Visual Observation / obs-comp-cand-002226 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002226`
- External reference / 外部参照: `obimd-sub-kh67ey65hl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020039_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kh67ey65hl/kh67ey65hl/kh67ey65hl.png`
- Checksum / 校验和:
  `80abc20ad1ff16e75989f416e9bff2828d74675990d0fc3a686aa78e1bed42c3`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.64%.
- Marked-pixel bounds: (76,20)–(160,231); span 85 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.64%。
- 痕迹范围：(76,20)–(160,231)；跨度85 × 212 px；痕迹矩形高于宽。
