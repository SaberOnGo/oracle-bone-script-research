# obs-evo-cand-005878 / EVOBC evolution-category candidate
...
- EVOBC category candidate ID: `evobc-evo-cat-05878`
- External category ref: `evobc-cat-05878`
- Source label for human review: `矢`
- Source codepoints: `U+77E2`
- Image reference count: `142`
- Era token counts: `BI:37;CS:1;OBC:62;SAC:1;SS:2;WSC:39`
- Source token counts: `Book:50;Web:92`
