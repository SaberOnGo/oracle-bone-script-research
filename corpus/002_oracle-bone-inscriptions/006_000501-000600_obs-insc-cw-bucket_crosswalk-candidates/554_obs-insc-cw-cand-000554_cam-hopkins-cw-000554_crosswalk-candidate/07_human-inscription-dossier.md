...
- Yingguo / 英国所藏: `y2562` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `363` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `544` in source row; primary catalog entry pending
- Heji / 合集: `41768` in source row; primary catalog entry pending
