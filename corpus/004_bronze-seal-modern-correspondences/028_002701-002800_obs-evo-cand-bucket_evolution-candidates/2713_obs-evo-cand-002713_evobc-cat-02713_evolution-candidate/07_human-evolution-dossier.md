...
Project ID: `obs-evo-cand-002713`
...
- Project ID: `obs-evo-cand-002713`
- EVOBC category candidate ID: `evobc-evo-cat-02713`
- External category reference: `evobc-cat-02713`
- Source category ID: `02713`
- Source label for human review: `庍`
- Source codepoints: `U+5E8D`
...
- `obs-evo-cand-002713-route-category-staging`
...
- `obs-evo-cand-002713-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002713-route-evolution-graph`
