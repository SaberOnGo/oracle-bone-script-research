...
- `obs-evo-cand-002090-route-category-staging`
...
- `obs-evo-cand-002090-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002090-route-evolution-graph`
