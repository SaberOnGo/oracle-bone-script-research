...
- External category reference: `evobc-cat-06354`
- Source category ID: `06354`
- Source label for human review: `簦`
- Source codepoints: `U+7C26`
...
- `obs-evo-cand-006354-route-category-staging`
...
- `obs-evo-cand-006354-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006354-route-evolution-graph`
