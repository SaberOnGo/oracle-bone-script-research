# Material Visual Observation / obs-comp-cand-002094 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002094`
- External reference / 外部参照: `obimd-sub-03w9kgybpz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019540_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/03w9kgybpz/03w9kgybpz/03w9kgybpz.png`
- Checksum / 校验和:
  `349039737e4f5599ad3b0fe622089643d1e47fbf57a0d55ba38d06081e4e7833`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.89%.
- Marked-pixel bounds: (65,18)–(197,234); span 133 × 217 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.89%。
- 痕迹范围：(65,18)–(197,234)；跨度133 × 217 px；痕迹矩形高于宽。
