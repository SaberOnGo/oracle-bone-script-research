# obs-unk-004085 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004085`
- primary external id: `hust-obc-und-L-004085`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/085_obs-unk-004085_h
  ust-obc-und-L-004085_oracle-character-candidate/03_visual-assets/001_asset
  -005678_hust-obc-und-L-004085_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4085/L_？_8766.jpg`
- asset id: `asset-005678`
...
- source class: `HUST-OBC/undeciphered/L/4085/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4085/L_？_8766.jpg`
- asset id: `asset-005678`
...
- English observation: Several curved or branching traces rise above a broad
  rounded lower outline. The lower form has a darker interior and a short
  horizontal edge; the branch joins and lower boundary remain uncertain.
...
- Which source records identify obs-unk-004085 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004085？
