...
- External category reference: `evobc-cat-00657`
- Source category ID: `00657`
- Source label for human review: `之`
- Source codepoints: `U+4E4B`
- Image reference count in source metadata: `1000`
...
- `obs-evo-cand-000657-route-category-staging`
...
- `obs-evo-cand-000657-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000657-route-evolution-graph`
