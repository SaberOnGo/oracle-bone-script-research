...
Project ID: `obs-evo-cand-003922`
...
- Project ID: `obs-evo-cand-003922`
- EVOBC category candidate ID: `evobc-evo-cat-03922`
- External category reference: `evobc-cat-03922`
- Source category ID: `03922`
- Source label for human review: `枒`
- Source codepoints: `U+6792`
...
- `obs-evo-cand-003922-route-category-staging`
...
- `obs-evo-cand-003922-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003922-route-evolution-graph`
