...
- External category reference: `evobc-cat-08666`
- Source category ID: `08666`
- Source label for human review: `赹`
...
- `obs-evo-cand-008666-route-category-staging`
...
- `obs-evo-cand-008666-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008666-route-evolution-graph`
