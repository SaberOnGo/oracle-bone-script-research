# src-ihp-museum-oracle-bones Material Access Index / src-ihp-museum-oracle-bones 资料访问索引
...
| --- | --- | --- | --- |
| Source summary / 来源摘要 | `README.md` | present | source ID `src-ihp-museum-oracle-bones` |
| Human review sheet / 人工复核表 | `06_human-source-review-sheet.md` | present | source provenance and rights checklist |
| Download or access routes / 下载或访问路线 | `02_download-route-index.csv` | route_rows_present | 1 route row(s); statuses: downloaded |
| Package or file manifest routes / 来源包或文件清单路线 | `03_package-route-index.csv` | route_rows_present | 1 route row(s); kinds: lightweight_html_page |
| Field maps / 字段映射 | `04_field-map-route-index.csv` | not_present_in_current_registers | 0 row(s); target records: none |
| Downloaded metadata profiles / 已下载 metadata profile | `05_metadata-profile-route-index.csv` | profile_rows_present | 2 row(s); metrics: downloaded_page_size_bytes;registered_scope |
