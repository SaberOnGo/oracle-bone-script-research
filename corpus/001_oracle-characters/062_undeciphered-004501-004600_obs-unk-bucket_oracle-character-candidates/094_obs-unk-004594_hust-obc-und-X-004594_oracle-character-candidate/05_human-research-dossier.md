# obs-unk-004594 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004594`
- primary external id: `hust-obc-und-X-004594`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/094_obs-unk-004594_h
  ust-obc-und-X-004594_oracle-character-candidate/03_visual-assets/001_asset
  -006187_hust-obc-und-X-004594_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/150/X_？_8327_1.png`
- asset id: `asset-006187`
...
- source class: `HUST-OBC/undeciphered/X/150/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/150/X_？_8327_1.png`
- asset id: `asset-006187`
...
- English observation: `Two separated trace clusters and a detached dot`
  `recorded.`
- 中文观察: `已记录两个分离痕迹簇和一个分离小点。`
...
- Which source records identify obs-unk-004594 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004594？
