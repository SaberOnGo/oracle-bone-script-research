# obs-unk-003456 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003456`
- primary external id: `hust-obc-und-L-003456`
...
- local review image route: `corpus/001_oracle-characters/051_undeciphered-003
  401-003500_obs-unk-bucket_oracle-character-candidates/056_obs-unk-003456_h
  ust-obc-und-L-003456_oracle-character-candidate/03_visual-assets/001_asset
  -005049_hust-obc-und-L-003456_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3456/L_？_6683.jpg`
- asset id: `asset-005049`
...
- source class: `HUST-OBC/undeciphered/L/3456/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3456/L_？_6683.jpg`
- asset id: `asset-005049`
...
- Which source records identify obs-unk-003456 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003456？
