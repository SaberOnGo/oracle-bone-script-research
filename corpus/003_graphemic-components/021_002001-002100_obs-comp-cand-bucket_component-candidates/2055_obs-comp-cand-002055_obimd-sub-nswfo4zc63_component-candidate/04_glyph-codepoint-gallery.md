# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002055
...
| --- | --- | --- | --- |
| `obimd-glyph-link-031604` | 󻴉 | `U+FBD09` | `reviewed_metadata_only` |
| `obimd-glyph-link-031605` | 󻴊 | `U+FBD0A` | `reviewed_metadata_only` |
| `obimd-glyph-link-031606` | 󻴋 | `U+FBD0B` | `reviewed_metadata_only` |
