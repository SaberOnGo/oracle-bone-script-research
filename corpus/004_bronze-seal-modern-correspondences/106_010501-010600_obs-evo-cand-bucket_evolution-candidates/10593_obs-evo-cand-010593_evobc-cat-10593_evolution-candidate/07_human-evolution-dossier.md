...
Project ID: `obs-evo-cand-010593`
...
- Project ID: `obs-evo-cand-010593`
- EVOBC category candidate ID: `evobc-evo-cat-10593`
- External category reference: `evobc-cat-10593`
- Source category ID: `10593`
- Source label for human review: `鹵`
- Source codepoints: `U+9E75`
...
- `obs-evo-cand-010593-route-category-staging`
...
- `obs-evo-cand-010593-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010593-route-evolution-graph`
