# obs-unk-007802 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/095_undeciphered-007
  801-007900_obs-unk-bucket_oracle-character-candidates/002_obs-unk-007802_h
  ust-obc-und-YH-007802_oracle-character-candidate/03_visual-assets/001_asse
  t-009393_hust-obc-und-YH-007802_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/6039E/H_？_6039E_0.png`
- asset id: `asset-009393`
...
- source class: `HUST-OBC/undeciphered/Y+H/6039E/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/6039E/H_？_6039E_0.png`
- asset id: `asset-009393`
...
- Which source records identify obs-unk-007802 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007802？
