# Material Visual Observation / obs-comp-cand-001652 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001652`
- External reference / 外部参照: `obimd-sub-ahpipvmufk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017328_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ahpipvmufk/ahpipvmufk/ahpipvmufk.png`
- Checksum / 校验和:
  `dcc136cfabde141ea023cef07fa9c540652cb16884a40384209750ac28cac97d`
...
- Marked-pixel bounds: (70,27)–(189,214); span 120 × 188 px; the marked
...
- 痕迹范围：(70,27)–(189,214)；跨度120 × 188 px；痕迹矩形高于宽。
