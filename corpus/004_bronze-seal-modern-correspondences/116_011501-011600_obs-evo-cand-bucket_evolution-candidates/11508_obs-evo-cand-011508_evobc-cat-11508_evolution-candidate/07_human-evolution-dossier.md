...
Project ID: `obs-evo-cand-011508`
...
- Project ID: `obs-evo-cand-011508`
- EVOBC category candidate ID: `evobc-evo-cat-11508`
- External category reference: `evobc-cat-11508`
- Source category ID: `11508`
- Source label for human review: `𣰃`
- Source codepoints: `U+23C03`
...
- `obs-evo-cand-011508-route-category-staging`
...
- `obs-evo-cand-011508-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011508-route-evolution-graph`
