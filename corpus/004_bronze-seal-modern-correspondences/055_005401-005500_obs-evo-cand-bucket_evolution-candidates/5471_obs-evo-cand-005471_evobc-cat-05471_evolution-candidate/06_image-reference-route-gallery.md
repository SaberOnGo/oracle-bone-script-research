...
- `obs-evo-cand-005471-route-category-staging`
...
- `obs-evo-cand-005471-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005471-route-evolution-graph`
