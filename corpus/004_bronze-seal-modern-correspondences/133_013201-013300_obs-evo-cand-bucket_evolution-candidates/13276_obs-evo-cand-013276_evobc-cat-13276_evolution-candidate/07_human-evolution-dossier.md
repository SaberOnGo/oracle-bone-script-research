...
Project ID: `obs-evo-cand-013276`
...
- Project ID: `obs-evo-cand-013276`
- EVOBC category candidate ID: `evobc-evo-cat-13276`
- External category reference: `evobc-cat-13276`
- Source category ID: `13276`
- Source label for human review: `𬔅`
- Source codepoints: `U+2C505`
...
- `obs-evo-cand-013276-route-category-staging`
...
- `obs-evo-cand-013276-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013276-route-evolution-graph`
