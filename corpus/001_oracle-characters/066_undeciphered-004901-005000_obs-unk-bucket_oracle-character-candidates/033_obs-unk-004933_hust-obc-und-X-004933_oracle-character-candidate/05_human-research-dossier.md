# obs-unk-004933 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004933`
- primary external id: `hust-obc-und-X-004933`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/033_obs-unk-004933_h
  ust-obc-und-X-004933_oracle-character-candidate/03_visual-assets/001_asset
  -006526_hust-obc-und-X-004933_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/489/X_？_7473_1.png`
- asset id: `asset-006526`
...
- A three-way upper fork and a separate right group are visible.
...
- source class: `HUST-OBC/undeciphered/X/489/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/489/X_？_7473_1.png`
- asset id: `asset-006526`
...
- Which source records identify obs-unk-004933 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004933？
