# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001065
...
| --- | --- | --- | --- |
| `obimd-glyph-link-015667` | 󶅫 | `U+F616B` | `reviewed_metadata_only` |
| `obimd-glyph-link-015668` | 󶅬 | `U+F616C` | `reviewed_metadata_only` |
