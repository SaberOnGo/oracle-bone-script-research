# obs-unk-004121 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004121`
- primary external id: `hust-obc-und-L-004121`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/021_obs-unk-004121_h
  ust-obc-und-L-004121_oracle-character-candidate/03_visual-assets/001_asset
  -005714_hust-obc-und-L-004121_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4121/L_？_8877.jpg`
- asset id: `asset-005714`
...
- source class: `HUST-OBC/undeciphered/L/4121/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4121/L_？_8877.jpg`
- asset id: `asset-005714`
...
- English observation: The opened image shows a broad upper form, crossing
  middle strokes, and thin branching traces below.
- 中文观察：已打开图像可见宽上部形态、中央交叉笔画和下部细分支痕迹。
...
- Which source records identify obs-unk-004121 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004121？
