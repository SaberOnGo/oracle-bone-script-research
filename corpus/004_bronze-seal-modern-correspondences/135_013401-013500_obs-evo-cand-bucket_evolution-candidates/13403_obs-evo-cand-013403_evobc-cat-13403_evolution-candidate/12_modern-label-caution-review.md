# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013403
...
- EVOBC candidate category: `evobc-evo-cat-13403`.
- Source label for search only: `𬬚`.
- Source codepoints for search only: `U+2CB1A`.
