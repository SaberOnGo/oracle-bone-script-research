# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000172
...
| --- | --- | --- | --- |
| `obimd-glyph-link-002185` | 󰽝 | `U+F0F5D` | `reviewed_metadata_only` |
| `obimd-glyph-link-002186` | 󰽞 | `U+F0F5E` | `reviewed_metadata_only` |
