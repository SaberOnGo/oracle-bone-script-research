# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010735
...
- EVOBC candidate category: `evobc-evo-cat-10735`.
- Source label for search only: `齱`.
- Source codepoints for search only: `U+9F71`.
