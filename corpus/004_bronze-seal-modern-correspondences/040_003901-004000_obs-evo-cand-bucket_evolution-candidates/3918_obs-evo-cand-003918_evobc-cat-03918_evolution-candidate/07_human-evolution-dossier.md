...
Project ID: `obs-evo-cand-003918`
...
- Project ID: `obs-evo-cand-003918`
- EVOBC category candidate ID: `evobc-evo-cat-03918`
- External category reference: `evobc-cat-03918`
- Source category ID: `03918`
- Source label for human review: `枎`
- Source codepoints: `U+678E`
...
- `obs-evo-cand-003918-route-category-staging`
...
- `obs-evo-cand-003918-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003918-route-evolution-graph`
