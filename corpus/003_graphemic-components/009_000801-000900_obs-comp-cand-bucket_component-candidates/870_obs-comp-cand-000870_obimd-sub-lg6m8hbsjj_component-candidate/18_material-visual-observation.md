# Material Visual Observation / obs-comp-cand-000870 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000870`
- External reference / 外部参照: `obimd-sub-lg6m8hbsjj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013867_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/os0bklwwmx/lg6m8hbsjj/lg6m8hbsjj.png`
- Checksum / 校验和:
  `510201c34c06aadbad7f2713abd007e9910001b6971aa02fbb3e0add2418300a`
...
- Marked-pixel bounds: (78,50)–(193,211); span 116 × 162 px; the marked
...
- 痕迹范围：(78,50)–(193,211)；跨度116 × 162 px；痕迹矩形高于宽。
