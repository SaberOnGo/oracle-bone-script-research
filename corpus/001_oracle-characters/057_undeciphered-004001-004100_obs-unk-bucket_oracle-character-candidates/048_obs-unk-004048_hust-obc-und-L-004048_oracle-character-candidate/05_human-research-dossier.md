# obs-unk-004048 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004048`
- primary external id: `hust-obc-und-L-004048`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/048_obs-unk-004048_h
  ust-obc-und-L-004048_oracle-character-candidate/03_visual-assets/001_asset
  -005641_hust-obc-und-L-004048_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4048/L_？_8658.jpg`
- asset id: `asset-005641`
...
- source class: `HUST-OBC/undeciphered/L/4048/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4048/L_？_8658.jpg`
- asset id: `asset-005641`
...
- English observation: An arched outer contour spans the upper and central
  crop, with a central peak or ridge. The left lower side has a short trailing
  stroke; the right side descends into a long curved line. Openings and joins
  remain uncertain.
...
- Which source records identify obs-unk-004048 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004048？
