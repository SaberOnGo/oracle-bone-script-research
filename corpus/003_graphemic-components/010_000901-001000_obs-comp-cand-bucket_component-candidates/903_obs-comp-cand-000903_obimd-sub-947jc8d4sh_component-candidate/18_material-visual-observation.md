# Material Visual Observation / obs-comp-cand-000903 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000903`
- External reference / 外部参照: `obimd-sub-947jc8d4sh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013975_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/947jc8d4sh/947jc8d4sh/947jc8d4sh.png`
- Checksum / 校验和:
  `435b684119f7c7d59fa78cfb6770ce83842088853c5efe9e2c4b96696d14fda3`
...
- Marked-pixel bounds: (65,31)–(186,221); span 122 × 191 px; the marked
...
- 痕迹范围：(65,31)–(186,221)；跨度122 × 191 px；痕迹矩形高于宽。
