...
- External category reference: `evobc-cat-10758`
- Source category ID: `10758`
- Source label for human review: `龠`
- Source codepoints: `U+9FA0`
- Image reference count in source metadata: `132`
...
- `obs-evo-cand-010758-route-category-staging`
...
- `obs-evo-cand-010758-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010758-route-evolution-graph`
