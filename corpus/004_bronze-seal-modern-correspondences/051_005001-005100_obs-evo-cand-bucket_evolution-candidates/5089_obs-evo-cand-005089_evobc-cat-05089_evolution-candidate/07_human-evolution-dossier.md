...
- External category reference: `evobc-cat-05089`
- Source category ID: `05089`
- Source label for human review: `焜`
- Source codepoints: `U+711C`
...
- `obs-evo-cand-005089-route-category-staging`
...
- `obs-evo-cand-005089-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005089-route-evolution-graph`
