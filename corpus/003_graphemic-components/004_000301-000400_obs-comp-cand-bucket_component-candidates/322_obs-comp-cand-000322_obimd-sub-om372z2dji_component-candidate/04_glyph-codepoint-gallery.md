# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000322
...
| --- | --- | --- | --- |
| `obimd-glyph-link-004848` | 󿳳 | `U+FFCF3` | `reviewed_metadata_only` |
| `obimd-glyph-link-004849` | 󱸩 | `U+F1E29` | `reviewed_metadata_only` |
