...
Project ID: `obs-evo-cand-011515`
...
- Project ID: `obs-evo-cand-011515`
- EVOBC category candidate ID: `evobc-evo-cat-11515`
- External category reference: `evobc-cat-11515`
- Source category ID: `11515`
- Source label for human review: `𣳌`
- Source codepoints: `U+23CCC`
...
- `obs-evo-cand-011515-route-category-staging`
...
- `obs-evo-cand-011515-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011515-route-evolution-graph`
