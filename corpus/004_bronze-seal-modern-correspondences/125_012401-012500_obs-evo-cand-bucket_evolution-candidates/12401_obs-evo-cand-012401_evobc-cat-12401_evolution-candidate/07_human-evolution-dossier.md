...
Project ID: `obs-evo-cand-012401`
...
- Project ID: `obs-evo-cand-012401`
- EVOBC category candidate ID: `evobc-evo-cat-12401`
- External category reference: `evobc-cat-12401`
- Source category ID: `12401`
- Source label for human review: `𨙹`
- Source codepoints: `U+28679`
...
- `obs-evo-cand-012401-route-category-staging`
...
- `obs-evo-cand-012401-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012401-route-evolution-graph`
