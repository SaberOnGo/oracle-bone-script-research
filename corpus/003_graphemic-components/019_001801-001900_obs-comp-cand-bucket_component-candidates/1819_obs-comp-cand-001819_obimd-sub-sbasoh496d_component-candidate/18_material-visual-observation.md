# Material Visual Observation / obs-comp-cand-001819 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001819`
- External reference / 外部参照: `obimd-sub-sbasoh496d`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018145_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qmspt85dhp/sbasoh496d/sbasoh496d.png`
- Checksum / 校验和:
  `952646b54b123ca839a26e52166160141fd198d306c4e6cc3d5090913e321e4c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.54%.
- Marked-pixel bounds: (77,39)–(172,219); span 96 × 181 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.54%。
- 痕迹范围：(77,39)–(172,219)；跨度96 × 181 px；痕迹矩形高于宽。
