# obs-unk-004390 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004390`
- primary external id: `hust-obc-und-L-004390`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/090_obs-unk-004390_h
  ust-obc-und-L-004390_oracle-character-candidate/03_visual-assets/001_asset
  -005983_hust-obc-und-L-004390_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4390/L_？_9761.jpg`
- asset id: `asset-005983`
...
- source class: `HUST-OBC/undeciphered/L/4390/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4390/L_？_9761.jpg`
- asset id: `asset-005983`
...
- English observation: `Upper angular traces lead toward a small lower outline;`
  `a broad curved trace runs along the bottom.`
- 中文观察: `上部斜角痕迹向下指向小轮廓，下缘有较宽弧形痕迹。`
...
- Which source records identify obs-unk-004390 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004390？
