...
- `obs-evo-cand-012883-route-category-staging`
...
- `obs-evo-cand-012883-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012883-route-evolution-graph`
