...
- Project ID: `obs-evo-cand-008303`
- EVOBC category candidate ID: `evobc-evo-cat-08303`
- External category reference: `evobc-cat-08303`
- Source category ID: `08303`
- Source label for human review: `謁`
- Source codepoints: `U+8B01`
...
- `obs-evo-cand-008303-route-category-staging`
...
- `obs-evo-cand-008303-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008303-route-evolution-graph`
