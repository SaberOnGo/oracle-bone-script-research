# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002318
...
| --- | --- | --- | --- |
| `obimd-glyph-link-035791` | 󽔡 | `U+FD521` | `reviewed_metadata_only` |
| `obimd-glyph-link-035792` | 󽔢 | `U+FD522` | `reviewed_metadata_only` |
| `obimd-glyph-link-035793` | 󽔣 | `U+FD523` | `reviewed_metadata_only` |
| `obimd-glyph-link-035794` | 󽔤 | `U+FD524` | `reviewed_metadata_only` |
| `obimd-glyph-link-035795` | 󽔥 | `U+FD525` | `reviewed_metadata_only` |
