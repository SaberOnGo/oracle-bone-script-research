...
- External category reference: `evobc-cat-13635`
- Source category ID: `13635`
- Source label for human review: `𮕈`
- Source codepoints: `U+2E548`
...
- `obs-evo-cand-013635-route-category-staging`
...
- `obs-evo-cand-013635-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013635-route-evolution-graph`
