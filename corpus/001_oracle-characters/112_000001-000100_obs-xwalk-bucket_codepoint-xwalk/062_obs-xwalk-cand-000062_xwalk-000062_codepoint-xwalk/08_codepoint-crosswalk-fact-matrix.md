# obs-xwalk-cand-000062 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+343E` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-0072` | not reading |
