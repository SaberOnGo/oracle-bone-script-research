...
- External category reference: `evobc-cat-13470`
- Source category ID: `13470`
- Source label for human review: `𭁳`
...
- `obs-evo-cand-013470-route-category-staging`
...
- `obs-evo-cand-013470-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013470-route-evolution-graph`
