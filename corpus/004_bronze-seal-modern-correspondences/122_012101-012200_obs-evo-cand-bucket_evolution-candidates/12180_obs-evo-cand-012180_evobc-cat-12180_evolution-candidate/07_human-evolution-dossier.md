...
- External category reference: `evobc-cat-12180`
- Source category ID: `12180`
- Source label for human review: `𧖸`
...
- `obs-evo-cand-012180-route-category-staging`
...
- `obs-evo-cand-012180-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012180-route-evolution-graph`
