# obs-unk-005580 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005580`
- primary external id: `hust-obc-und-X-005580`
...
- local review image route: `corpus/001_oracle-characters/072_undeciphered-005
  501-005600_obs-unk-bucket_oracle-character-candidates/080_obs-unk-005580_h
  ust-obc-und-X-005580_oracle-character-candidate/03_visual-assets/001_asset
  -007173_hust-obc-und-X-005580_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1136/X_？_8091_1.png`
- asset id: `asset-007173`
...
- source class: `HUST-OBC/undeciphered/X/1136/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1136/X_？_8091_1.png`
- asset id: `asset-007173`
...
- Which source records identify obs-unk-005580 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005580？
