...
Project ID: `obs-evo-cand-008862`
...
- Project ID: `obs-evo-cand-008862`
- EVOBC category candidate ID: `evobc-evo-cat-08862`
- External category reference: `evobc-cat-08862`
- Source category ID: `08862`
- Source label for human review: `轂`
- Source codepoints: `U+8F42`
...
- `obs-evo-cand-008862-route-category-staging`
...
- `obs-evo-cand-008862-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008862-route-evolution-graph`
