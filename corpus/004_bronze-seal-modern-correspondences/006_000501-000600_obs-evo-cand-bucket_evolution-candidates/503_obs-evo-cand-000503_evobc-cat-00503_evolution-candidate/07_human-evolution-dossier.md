...
- Project ID: `obs-evo-cand-000503`
- EVOBC category candidate ID: `evobc-evo-cat-00503`
- External category reference: `evobc-cat-00503`
- Source category ID: `00503`
- Source label for human review: `䣭`
- Source codepoints: `U+48ED`
...
- `obs-evo-cand-000503-route-category-staging`
...
- `obs-evo-cand-000503-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000503-route-evolution-graph`
