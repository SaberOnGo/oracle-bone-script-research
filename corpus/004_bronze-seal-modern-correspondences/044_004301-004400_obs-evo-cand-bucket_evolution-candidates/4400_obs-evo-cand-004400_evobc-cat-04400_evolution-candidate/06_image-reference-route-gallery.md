...
- `obs-evo-cand-004400-route-category-staging`
...
- `obs-evo-cand-004400-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004400-route-evolution-graph`
