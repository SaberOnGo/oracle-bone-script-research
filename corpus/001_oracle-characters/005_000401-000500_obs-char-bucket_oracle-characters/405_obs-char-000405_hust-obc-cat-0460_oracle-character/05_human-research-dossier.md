# obs-char-000405 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000405`
- primary external id: `hust-obc-cat-0460`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/405_obs-char-000405_hust-obc-cat-0460_orac
  le-character/03_visual-assets/001_asset-000410_hust-obc-cat-0460_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0460/G_0460_前8.2.1(甲).png`
- asset id: `asset-000410`
...
- source category: `0460`
- validation class: `404`
- source image route: `HUST-OBC/deciphered/0460/G_0460_前8.2.1(甲).png`
- asset id: `asset-000410`
...
- English observation: `A small detached circular enclosure with a central
  mark sits left of a separate looping and zigzag form.`
- 中文观察: `带中央痕迹的小型分离圆形轮廓位于左侧，右侧另有独立的环曲折线形体。`
...
- dataset label text: `㗂`
- dataset label codepoints: `U+35C2`
...
- Which source records identify obs-char-000405 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000405？
