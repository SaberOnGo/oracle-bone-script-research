...
- Project ID: `obs-evo-cand-013602`
- EVOBC category candidate ID: `evobc-evo-cat-13602`
- External category reference: `evobc-cat-13602`
- Source category ID: `13602`
- Source label for human review: `𮄲`
- Source codepoints: `U+2E132`
...
- `obs-evo-cand-013602-route-category-staging`
...
- `obs-evo-cand-013602-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013602-route-evolution-graph`
