...
- External category reference: `evobc-cat-06931`
- Source category ID: `06931`
- Source label for human review: `耹`
- Source codepoints: `U+8039`
...
- `obs-evo-cand-006931-route-category-staging`
...
- `obs-evo-cand-006931-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006931-route-evolution-graph`
