...
- External category reference: `evobc-cat-01105`
- Source category ID: `01105`
- Source label for human review: `兽`
...
- `obs-evo-cand-001105-route-category-staging`
...
- `obs-evo-cand-001105-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001105-route-evolution-graph`
