# obs-comp-cand-000437 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000437`
- 首选外部 ID: `obimd-sub-18jj79so8p`
- OBIMD subcharacter UID: `18jj79so8p`
- OBIMD main character UID: `18jj79so8p`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+AE74B;U+F288E; U+F288F
