...
- `obs-evo-cand-002976-route-category-staging`
...
- `obs-evo-cand-002976-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002976-route-evolution-graph`
