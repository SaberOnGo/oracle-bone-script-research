...
- External category reference: `evobc-cat-06298`
- Source category ID: `06298`
- Source label for human review: `箠`
...
- `obs-evo-cand-006298-route-category-staging`
...
- `obs-evo-cand-006298-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006298-route-evolution-graph`
