# obs-char-001474 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001474`
- primary external id: `hust-obc-cat-1655`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1474_obs-char-001474_hust-obc-cat-1655_ora
  cle-character/03_visual-assets/001_asset-001479_hust-obc-cat-1655_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1655/G_1655_輯佚0576正(甲).png`
- asset id: `asset-001479`
...
- source category: `1655`
- validation class: `1473`
- source image route: `HUST-OBC/deciphered/1655/G_1655_輯佚0576正(甲).png`
- asset id: `asset-001479`
...
- English observation: `A compact composite has divided upper bars, a small
  middle loop, and a stem.`
- 中文观察: `紧凑组合形体有隔分上横笔、小型中部环形和竖干。`
...
- dataset label text: `㩭`
- dataset label codepoints: `U+3A6D`
...
- Which source records identify obs-char-001474 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001474？
