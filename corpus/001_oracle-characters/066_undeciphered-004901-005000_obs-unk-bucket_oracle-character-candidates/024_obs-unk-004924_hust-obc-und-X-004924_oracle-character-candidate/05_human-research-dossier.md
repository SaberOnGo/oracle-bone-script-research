# obs-unk-004924 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004924`
- primary external id: `hust-obc-und-X-004924`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/024_obs-unk-004924_h
  ust-obc-und-X-004924_oracle-character-candidate/03_visual-assets/001_asset
  -006517_hust-obc-und-X-004924_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/480/X_？_7465_1.png`
- asset id: `asset-006517`
...
- Two separated groups are visible with pointed strokes on the right.
- The single source view is present locally.
- 直接记录：`14_material-visual-observation.md`
- 可见两组彼此分开的结构，右侧下缘有尖端笔画。
- 单一来源视图已在本地保存。
...
- source class: `HUST-OBC/undeciphered/X/480/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/480/X_？_7465_1.png`
- asset id: `asset-006517`
...
- Which source records identify obs-unk-004924 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004924？
