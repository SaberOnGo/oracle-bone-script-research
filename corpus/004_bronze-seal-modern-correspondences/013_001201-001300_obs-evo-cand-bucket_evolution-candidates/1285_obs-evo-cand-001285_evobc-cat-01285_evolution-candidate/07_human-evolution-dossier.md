...
- External category reference: `evobc-cat-01285`
- Source category ID: `01285`
- Source label for human review: `勃`
- Source codepoints: `U+52C3`
...
- `obs-evo-cand-001285-route-category-staging`
...
- `obs-evo-cand-001285-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001285-route-evolution-graph`
