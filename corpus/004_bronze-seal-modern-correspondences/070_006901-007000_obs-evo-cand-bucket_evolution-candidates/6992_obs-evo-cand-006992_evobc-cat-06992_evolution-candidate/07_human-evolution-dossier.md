...
- External category reference: `evobc-cat-06992`
- Source category ID: `06992`
- Source label for human review: `肣`
- Source codepoints: `U+80A3`
...
- `obs-evo-cand-006992-route-category-staging`
...
- `obs-evo-cand-006992-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006992-route-evolution-graph`
