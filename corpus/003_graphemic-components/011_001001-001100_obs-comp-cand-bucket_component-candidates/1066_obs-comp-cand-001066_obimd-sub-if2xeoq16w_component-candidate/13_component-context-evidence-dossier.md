# obs-comp-cand-001066 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001066`
- 首选外部 ID: `obimd-sub-if2xeoq16w`
- OBIMD subcharacter UID: `if2xeoq16w`
- OBIMD main character UID: `if2xeoq16w`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+A6D70;U+F617C; U+F617D
