# obs-char-001559 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1559_obs-char-001559_hust-obc-cat-1750_ora
  cle-character/03_visual-assets/001_asset-001564_hust-obc-cat-1750_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1750/X_1750_3442_1.png`
- asset id: `asset-001564`
...
- source category: `1750`
- validation class: `1558`
- source image route: `HUST-OBC/deciphered/1750/X_1750_3442_1.png`
- asset id: `asset-001564`
...
- English observation: `A dark composite has an upper branch, two lower
  openings, and crossed bottom strokes.`
...
- dataset label text: `㫌`
- dataset label codepoints: `U+3ACC`
...
- Which source records identify obs-char-001559 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001559？
