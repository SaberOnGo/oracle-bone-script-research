...
- Project ID: `obs-evo-cand-010998`
- EVOBC category candidate ID: `evobc-evo-cat-10998`
- External category reference: `evobc-cat-10998`
- Source category ID: `10998`
- Source label for human review: `𡏇`
- Source codepoints: `U+213C7`
...
- `obs-evo-cand-010998-route-category-staging`
...
- `obs-evo-cand-010998-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010998-route-evolution-graph`
