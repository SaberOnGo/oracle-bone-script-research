...
- External category reference: `evobc-cat-03482`
- Source category ID: `03482`
- Source label for human review: `摯`
- Source codepoints: `U+646F`
...
- `obs-evo-cand-003482-route-category-staging`
...
- `obs-evo-cand-003482-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003482-route-evolution-graph`
