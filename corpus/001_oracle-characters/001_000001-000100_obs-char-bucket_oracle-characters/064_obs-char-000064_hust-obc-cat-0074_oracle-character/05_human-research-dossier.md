# obs-char-000064 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/064_obs-char-000064_hust-obc-cat-0074_orac
  le-character/03_visual-assets/001_asset-000069_hust-obc-cat-0074_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0074/X_0074_6341_1.png`
- asset id: `asset-000069`
...
- source category: `0074`
- validation class: `63`
- source image route: `HUST-OBC/deciphered/0074/X_0074_6341_1.png`
- asset id: `asset-000069`
...
- English observation: `The large dark image combines many horizontal and
  branching strokes with a long lower-left stem and a curved lower-right
  descent.`
- 中文观察: `大型深色图像含多条横向和分叉笔画，左下有长主干，右下有弯曲下行笔画。`
...
- dataset label text: `㑀`
- dataset label codepoints: `U+3440`
...
- Which source records identify obs-char-000064 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000064？
