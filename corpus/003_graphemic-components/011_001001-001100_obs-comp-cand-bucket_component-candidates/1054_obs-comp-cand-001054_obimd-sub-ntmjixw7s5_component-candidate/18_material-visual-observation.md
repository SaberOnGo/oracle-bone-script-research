# Material Visual Observation / obs-comp-cand-001054 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001054`
- External reference / 外部参照: `obimd-sub-ntmjixw7s5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014604_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ntmjixw7s5/ntmjixw7s5/ntmjixw7s5.png`
- Checksum / 校验和:
  `5d04c9ceebc56491050ccc9c761e4d4d962830acce8dc73447b62f7b04e38517`
...
- Marked-pixel bounds: (97,24)–(152,220); span 56 × 197 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.18%。
- 痕迹范围：(97,24)–(152,220)；跨度56 × 197 px；痕迹矩形高于宽。
