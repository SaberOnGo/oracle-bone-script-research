# obs-char-000438 Visual Gallery / obs-char-000438 图像资料页
...
- Project ID / 项目 ID: `obs-char-000438`
- Primary external reference / 首选外部参考: `hust-obc-cat-0498`
...
## obs-char-000438-visual-source-001 / 图像条目

![obs-char-000438 glyph candidate](03_visual-assets/001_asset-000443_hust-obc-cat-0498_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000443_hust-obc-cat-0498_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000443_hust-obc-cat-0498_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/0498/G_0498_乙519(甲).png`
