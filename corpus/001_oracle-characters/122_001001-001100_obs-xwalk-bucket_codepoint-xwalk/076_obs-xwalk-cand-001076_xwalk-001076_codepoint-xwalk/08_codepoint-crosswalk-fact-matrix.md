# obs-xwalk-cand-001076 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+38A9` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-1203` | not reading |
