...
- Project ID: `obs-evo-cand-002088`
- EVOBC category candidate ID: `evobc-evo-cat-02088`
- External category reference: `evobc-cat-02088`
- Source category ID: `02088`
- Source label for human review: `妞`
- Source codepoints: `U+599E`
...
- `obs-evo-cand-002088-route-category-staging`
...
- `obs-evo-cand-002088-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002088-route-evolution-graph`
