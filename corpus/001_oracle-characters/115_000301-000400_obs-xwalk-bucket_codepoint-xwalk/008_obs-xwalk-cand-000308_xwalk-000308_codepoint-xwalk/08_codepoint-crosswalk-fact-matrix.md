# obs-xwalk-cand-000308 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+3552` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-0348` | not reading |
