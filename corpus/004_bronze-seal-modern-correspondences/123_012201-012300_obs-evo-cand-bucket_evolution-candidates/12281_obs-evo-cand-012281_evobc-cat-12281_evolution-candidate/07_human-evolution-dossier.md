...
- External category reference: `evobc-cat-12281`
- Source category ID: `12281`
- Source label for human review: `𧶁`
...
- `obs-evo-cand-012281-route-category-staging`
...
- `obs-evo-cand-012281-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012281-route-evolution-graph`
