...
- External category reference: `evobc-cat-01278`
- Source category ID: `01278`
- Source label for human review: `劵`
...
- `obs-evo-cand-001278-route-category-staging`
...
- `obs-evo-cand-001278-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001278-route-evolution-graph`
