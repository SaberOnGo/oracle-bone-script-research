# obs-evo-cand-000710 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-000710`
- EVOBC category candidate ID: `evobc-evo-cat-00710`
- External category ref: `evobc-cat-00710`
- Source label: `亯`
- Source codepoints: `U+4EAF`
- Image reference count: `229`
- Era token counts: `BI:128;OBC:64;SAC:24;SS:1;WSC:12`
- Source token counts: `Book:181;Web:48`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 64 image references
- era 1 / BI: 128 image references
...
- source 1 / Web:105952;說文Web:58: 26 image references
