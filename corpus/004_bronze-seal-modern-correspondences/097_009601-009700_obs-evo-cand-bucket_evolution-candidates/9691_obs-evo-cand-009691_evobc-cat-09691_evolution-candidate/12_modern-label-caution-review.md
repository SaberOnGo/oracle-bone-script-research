# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-009691
...
- EVOBC candidate category: `evobc-evo-cat-09691`.
- Source label for search only: `队`.
- Source codepoints for search only: `U+961F`.
