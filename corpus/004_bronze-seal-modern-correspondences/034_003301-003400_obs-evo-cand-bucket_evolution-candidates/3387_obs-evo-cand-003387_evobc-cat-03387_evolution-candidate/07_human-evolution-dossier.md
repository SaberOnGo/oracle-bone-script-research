...
Project ID: `obs-evo-cand-003387`
...
- Project ID: `obs-evo-cand-003387`
- EVOBC category candidate ID: `evobc-evo-cat-03387`
- External category reference: `evobc-cat-03387`
- Source category ID: `03387`
- Source label for human review: `捼`
- Source codepoints: `U+637C`
...
- `obs-evo-cand-003387-route-category-staging`
...
- `obs-evo-cand-003387-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003387-route-evolution-graph`
