# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000854
...
- EVOBC candidate category: `evobc-evo-cat-00854`.
- Source label for search only: `侜`.
- Source codepoints for search only: `U+4F9C`.
