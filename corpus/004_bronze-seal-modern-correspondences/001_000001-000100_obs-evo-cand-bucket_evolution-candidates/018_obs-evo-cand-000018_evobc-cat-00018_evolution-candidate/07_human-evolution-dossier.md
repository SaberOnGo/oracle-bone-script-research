...
- Project ID: `obs-evo-cand-000018`
- EVOBC category candidate ID: `evobc-evo-cat-00018`
- External category reference: `evobc-cat-00018`
- Source category ID: `00018`
- Source label for human review: `㒼`
- Source codepoints: `U+34BC`
...
- `obs-evo-cand-000018-route-category-staging`
...
- `obs-evo-cand-000018-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000018-route-evolution-graph`
