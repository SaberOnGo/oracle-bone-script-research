...
Project ID: `obs-evo-cand-006345`
...
- Project ID: `obs-evo-cand-006345`
- EVOBC category candidate ID: `evobc-evo-cat-06345`
- External category reference: `evobc-cat-06345`
- Source category ID: `06345`
- Source label for human review: `簎`
- Source codepoints: `U+7C0E`
...
- `obs-evo-cand-006345-route-category-staging`
...
- `obs-evo-cand-006345-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006345-route-evolution-graph`
