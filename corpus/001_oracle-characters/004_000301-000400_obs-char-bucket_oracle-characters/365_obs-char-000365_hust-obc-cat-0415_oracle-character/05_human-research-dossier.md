# obs-char-000365 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/365_obs-char-000365_hust-obc-cat-0415_orac
  le-character/03_visual-assets/001_asset-000370_hust-obc-cat-0415_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0415/G_0415_合37507黃組.png`
- asset id: `asset-000370`
...
- source category: `0415`
- validation class: `364`
- source image route: `HUST-OBC/deciphered/0415/G_0415_合37507黃組.png`
- asset id: `asset-000370`
...
- English observation: `The small dark image shows a thin vertical trace
  with a pointed upper hook and an irregular lower cluster; recheck is
  needed.`
...
- dataset label text: `㖕`
- dataset label codepoints: `U+3595`
...
- filename catalog route clues: `Heji-like filename clue: 合37507
  (G_0415_合37507黃組.png)`
...
- Which source records identify obs-char-000365 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000365？
