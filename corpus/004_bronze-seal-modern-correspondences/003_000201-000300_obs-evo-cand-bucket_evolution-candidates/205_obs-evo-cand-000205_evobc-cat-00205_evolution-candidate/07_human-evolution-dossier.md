...
Project ID: `obs-evo-cand-000205`
...
- Project ID: `obs-evo-cand-000205`
- EVOBC category candidate ID: `evobc-evo-cat-00205`
- External category reference: `evobc-cat-00205`
- Source category ID: `00205`
- Source label for human review: `㳒`
- Source codepoints: `U+3CD2`
...
- `obs-evo-cand-000205-route-category-staging`
...
- `obs-evo-cand-000205-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000205-route-evolution-graph`
