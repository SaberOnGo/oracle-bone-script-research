...
- External category reference: `evobc-cat-12273`
- Source category ID: `12273`
- Source label for human review: `𧳭`
- Source codepoints: `U+27CED`
...
- `obs-evo-cand-012273-route-category-staging`
...
- `obs-evo-cand-012273-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012273-route-evolution-graph`
