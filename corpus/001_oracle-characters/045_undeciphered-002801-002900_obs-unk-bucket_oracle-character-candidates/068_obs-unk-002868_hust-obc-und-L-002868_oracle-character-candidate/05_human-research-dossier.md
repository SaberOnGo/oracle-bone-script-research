# obs-unk-002868 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002868`
- primary external id: `hust-obc-und-L-002868`
...
- local review image route: `corpus/001_oracle-characters/045_undeciphered-002
  801-002900_obs-unk-bucket_oracle-character-candidates/068_obs-unk-002868_h
  ust-obc-und-L-002868_oracle-character-candidate/03_visual-assets/001_asset
  -004461_hust-obc-und-L-002868_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2868/L_？_4870.jpg`
- asset id: `asset-004461`
...
- source class: `HUST-OBC/undeciphered/L/2868/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2868/L_？_4870.jpg`
- asset id: `asset-004461`
...
- Which source records identify obs-unk-002868 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002868？
