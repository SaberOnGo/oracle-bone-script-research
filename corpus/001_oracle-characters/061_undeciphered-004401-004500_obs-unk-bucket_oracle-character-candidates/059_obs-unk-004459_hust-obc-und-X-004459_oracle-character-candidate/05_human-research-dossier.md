# obs-unk-004459 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004459`
- primary external id: `hust-obc-und-X-004459`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/059_obs-unk-004459_h
  ust-obc-und-X-004459_oracle-character-candidate/03_visual-assets/001_asset
  -006052_hust-obc-und-X-004459_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/15/X_？_8194_1.png`
- asset id: `asset-006052`
...
- source class: `HUST-OBC/undeciphered/X/15/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/15/X_？_8194_1.png`
- asset id: `asset-006052`
...
- English observation: A rectangular outline rests above two parallel lower
  bars.
- 中文观察: `框状轮廓位于两条平行下部横线之上。`
...
- Which source records identify obs-unk-004459 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004459？
