...
- External category reference: `evobc-cat-09570`
- Source category ID: `09570`
- Source label for human review: `钞`
- Source codepoints: `U+949E`
...
- `obs-evo-cand-009570-route-category-staging`
...
- `obs-evo-cand-009570-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009570-route-evolution-graph`
