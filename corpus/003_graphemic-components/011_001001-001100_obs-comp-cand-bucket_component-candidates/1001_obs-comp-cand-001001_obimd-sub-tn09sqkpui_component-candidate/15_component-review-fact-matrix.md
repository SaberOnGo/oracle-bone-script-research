# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001001
...
| Glyph or codepoint route / 字形或码位路线 | 26 OBIMD route rows; examples U+F5B00; U+F5B01; 另有 24 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 26 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
