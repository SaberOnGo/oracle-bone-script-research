...
- External category reference: `evobc-cat-09986`
- Source category ID: `09986`
- Source label for human review: `頛`
- Source codepoints: `U+981B`
...
- `obs-evo-cand-009986-route-category-staging`
...
- `obs-evo-cand-009986-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009986-route-evolution-graph`
