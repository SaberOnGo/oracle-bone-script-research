...
Project ID: `obs-evo-cand-013341`
...
- Project ID: `obs-evo-cand-013341`
- EVOBC category candidate ID: `evobc-evo-cat-13341`
- External category reference: `evobc-cat-13341`
- Source category ID: `13341`
- Source label for human review: `𬣂`
- Source codepoints: `U+2C8C2`
...
- `obs-evo-cand-013341-route-category-staging`
...
- `obs-evo-cand-013341-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013341-route-evolution-graph`
