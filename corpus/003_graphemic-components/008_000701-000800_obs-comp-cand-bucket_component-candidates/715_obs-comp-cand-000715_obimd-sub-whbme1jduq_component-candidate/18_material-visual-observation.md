# Material Visual Observation / obs-comp-cand-000715 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000715`
- External reference / 外部参照: `obimd-sub-whbme1jduq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013427_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lr27sngh2z/whbme1jduq/whbme1jduq.png`
- Checksum / 校验和:
  `5a8068e21a980bad5d656009dab67c6b8cf04fa49905fc4bab3a1c115ed83e59`
...
- Marked-pixel bounds: (82,24)–(167,228); span 86 × 205 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.63%。
- 痕迹范围：(82,24)–(167,228)；跨度86 × 205 px；痕迹矩形高于宽。
