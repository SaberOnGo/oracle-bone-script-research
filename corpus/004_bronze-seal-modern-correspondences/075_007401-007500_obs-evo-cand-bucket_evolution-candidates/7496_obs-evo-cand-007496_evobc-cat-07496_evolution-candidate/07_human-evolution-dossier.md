...
Project ID: `obs-evo-cand-007496`
...
- Project ID: `obs-evo-cand-007496`
- EVOBC category candidate ID: `evobc-evo-cat-07496`
- External category reference: `evobc-cat-07496`
- Source category ID: `07496`
- Source label for human review: `蒔`
- Source codepoints: `U+8494`
...
- `obs-evo-cand-007496-route-category-staging`
...
- `obs-evo-cand-007496-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007496-route-evolution-graph`
