...
- Project ID: `obs-evo-cand-006722`
- EVOBC category candidate ID: `evobc-evo-cat-06722`
- External category reference: `evobc-cat-06722`
- Source category ID: `06722`
- Source label for human review: `纠`
- Source codepoints: `U+7EA0`
...
- `obs-evo-cand-006722-route-category-staging`
...
- `obs-evo-cand-006722-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006722-route-evolution-graph`
