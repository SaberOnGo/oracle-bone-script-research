# Material Visual Observation / obs-comp-cand-001297 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001297`
- External reference / 外部参照: `obimd-sub-2sdz63p9g6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015634_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2sdz63p9g6/2sdz63p9g6/2sdz63p9g6.png`
- Checksum / 校验和:
  `7c88f9015bcf70af41488fe331463c0d170f6bb9d2910291b6d4dcf4561c97fe`
...
- Marked-pixel bounds: (78,22)–(171,226); span 94 × 205 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.10%。
- 痕迹范围：(78,22)–(171,226)；跨度94 × 205 px；痕迹矩形高于宽。
