# obs-unk-004707 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004707`
- primary external id: `hust-obc-und-X-004707`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/007_obs-unk-004707_h
  ust-obc-und-X-004707_oracle-character-candidate/03_visual-assets/001_asset
  -006300_hust-obc-und-X-004707_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/263/X_？_7235_1.png`
- asset id: `asset-006300`
...
- source class: `HUST-OBC/undeciphered/X/263/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/263/X_？_7235_1.png`
- asset id: `asset-006300`
...
- English observation: `tall right stroke with lower curved junction`
- 中文观察: `带下部弯曲连接处的右侧高竖笔画`
...
- Which source records identify obs-unk-004707 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004707？
