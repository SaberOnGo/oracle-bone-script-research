...
- Review draft ID / 复核草稿 ID: `source-pipeline-missing-evidence-review-draft-015`
...
- metadata_profile_ids: `metadata-profile-000053;metadata-`
  `profile-000054;metadata-profile-000055`
- large_source_package_ids: `none`
- source_download_log_ids: `dl-tsinghua-oracle-bones-overview`
- source_field_map_ids: `field-map-000021;field-map-000022`
- source_package_file_ids: `pkg-file-000029`
...
- download log ids / 下载记录 ID: `dl-tsinghua-oracle-bones-overview`
- metadata profile ids / metadata profile ID: `metadata-`
  `profile-000053;metadata-profile-000054;metadata-profile-000055`
- large source package ids / 大型来源包 ID: `none`
- source field map ids / 字段映射 ID: `field-map-000021;field-map-000022`
- package file ids / package file ID: `pkg-file-000029`
