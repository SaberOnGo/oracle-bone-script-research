# obs-unk-003130 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003130`
- primary external id: `hust-obc-und-L-003130`
...
- local review image route: `corpus/001_oracle-characters/048_undeciphered-003
  101-003200_obs-unk-bucket_oracle-character-candidates/030_obs-unk-003130_h
  ust-obc-und-L-003130_oracle-character-candidate/03_visual-assets/001_asset
  -004723_hust-obc-und-L-003130_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3130/L_？_5704.jpg`
- asset id: `asset-004723`
...
- source class: `HUST-OBC/undeciphered/L/3130/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3130/L_？_5704.jpg`
- asset id: `asset-004723`
...
- Which source records identify obs-unk-003130 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003130？
