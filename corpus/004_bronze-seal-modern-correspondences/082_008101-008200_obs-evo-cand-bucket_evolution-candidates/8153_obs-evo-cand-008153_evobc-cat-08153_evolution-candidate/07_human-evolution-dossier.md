...
- External category reference: `evobc-cat-08153`
- Source category ID: `08153`
- Source label for human review: `訬`
...
- `obs-evo-cand-008153-route-category-staging`
...
- `obs-evo-cand-008153-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008153-route-evolution-graph`
