# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002713
...
- EVOBC candidate category: `evobc-evo-cat-02713`.
- Source label for search only: `庍`.
- Source codepoints for search only: `U+5E8D`.
