...
- Project ID: `obs-evo-cand-000095`
- EVOBC category candidate ID: `evobc-evo-cat-00095`
- External category reference: `evobc-cat-00095`
- Source category ID: `00095`
- Source label for human review: `㡼`
- Source codepoints: `U+387C`
...
- `obs-evo-cand-000095-route-category-staging`
...
- `obs-evo-cand-000095-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000095-route-evolution-graph`
