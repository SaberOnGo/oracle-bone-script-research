# obs-char-000449 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/449_obs-char-000449_hust-obc-cat-0509_orac
  le-character/03_visual-assets/001_asset-000454_hust-obc-cat-0509_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0509/G_0509_佚586合21071𠂤組.png`
- asset id: `asset-000454`
...
- source category: `0509`
- validation class: `448`
- source image route: `HUST-OBC/deciphered/0509/G_0509_佚586合21071𠂤組.png`
- asset id: `asset-000454`
...
- English observation: `A single narrow form has a pointed outer loop
  enclosing crossed angular strokes, with a long curved line descending from
  the lower end.`
...
- dataset label text: `㗳`
- dataset label codepoints: `U+35F3`
...
- filename catalog route clues: `Heji-like filename clue: 合21071
...
- Which source records identify obs-char-000449 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000449？
