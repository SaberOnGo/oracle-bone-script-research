...
- Project ID: `obs-evo-cand-004765`
- EVOBC category candidate ID: `evobc-evo-cat-04765`
- External category reference: `evobc-cat-04765`
- Source category ID: `04765`
- Source label for human review: `渭`
- Source codepoints: `U+6E2D`
...
- `obs-evo-cand-004765-route-category-staging`
...
- `obs-evo-cand-004765-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004765-route-evolution-graph`
