...
- External category reference: `evobc-cat-02462`
- Source category ID: `02462`
- Source label for human review: `尊`
- Source codepoints: `U+5C0A`
- Image reference count in source metadata: `367`
...
- `obs-evo-cand-002462-route-category-staging`
...
- `obs-evo-cand-002462-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002462-route-evolution-graph`
