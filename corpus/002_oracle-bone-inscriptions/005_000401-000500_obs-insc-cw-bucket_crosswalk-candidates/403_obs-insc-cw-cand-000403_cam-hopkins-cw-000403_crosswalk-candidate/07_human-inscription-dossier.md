...
Project ID: `obs-insc-cw-cand-000403`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000403`
...
- Source page section: `Period II Group 18` /
  `第 II 期第 18 组`
- Source section key: `period-ii-group-18`
...
- Yingguo / 英国所藏: `y2188` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `A8` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000403`
