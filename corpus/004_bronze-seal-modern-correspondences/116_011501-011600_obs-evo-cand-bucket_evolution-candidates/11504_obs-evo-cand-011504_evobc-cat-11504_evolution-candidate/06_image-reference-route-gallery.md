...
- `obs-evo-cand-011504-route-category-staging`
...
- `obs-evo-cand-011504-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011504-route-evolution-graph`
