# obs-char-001536 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1536_obs-char-001536_hust-obc-cat-1722_ora
  cle-character/03_visual-assets/001_asset-001541_hust-obc-cat-1722_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1722/G_1722_佚882(甲).png`
- asset id: `asset-001541`
...
- source category: `1722`
- validation class: `1535`
- source image route: `HUST-OBC/deciphered/1722/G_1722_佚882(甲).png`
- asset id: `asset-001541`
...
- dataset label text: `㪰`
- dataset label codepoints: `U+3AB0`
...
- Which source records identify obs-char-001536 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001536？
