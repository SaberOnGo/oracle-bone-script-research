# obs-unk-004746 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004746`
- primary external id: `hust-obc-und-X-004746`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/046_obs-unk-004746_h
  ust-obc-und-X-004746_oracle-character-candidate/03_visual-assets/001_asset
  -006339_hust-obc-und-X-004746_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/302/X_？_7288_1.png`
- asset id: `asset-006339`
...
- source class: `HUST-OBC/undeciphered/X/302/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/302/X_？_7288_1.png`
- asset id: `asset-006339`
...
- English observation: `rectangular upper enclosure with lower band`
- 中文观察: `带下部横带的矩形上部围合结构`
...
- Which source records identify obs-unk-004746 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004746？
