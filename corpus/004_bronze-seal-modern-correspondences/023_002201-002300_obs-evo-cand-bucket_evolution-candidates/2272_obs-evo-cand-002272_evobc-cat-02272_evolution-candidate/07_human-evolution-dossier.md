...
Project ID: `obs-evo-cand-002272`
...
- Project ID: `obs-evo-cand-002272`
- EVOBC category candidate ID: `evobc-evo-cat-02272`
- External category reference: `evobc-cat-02272`
- Source category ID: `02272`
- Source label for human review: `嫣`
- Source codepoints: `U+5AE3`
...
- `obs-evo-cand-002272-route-category-staging`
...
- `obs-evo-cand-002272-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002272-route-evolution-graph`
