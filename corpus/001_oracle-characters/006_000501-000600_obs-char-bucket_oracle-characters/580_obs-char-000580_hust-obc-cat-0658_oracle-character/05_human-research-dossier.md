# obs-char-000580 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000580`
- primary external id: `hust-obc-cat-0658`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/580_obs-char-000580_hust-obc-cat-0658_orac
  le-character/03_visual-assets/001_asset-000585_hust-obc-cat-0658_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0658/G_0658_粹863(甲).png`
- asset id: `asset-000585`
...
- source category: `0658`
- validation class: `579`
- source image route: `HUST-OBC/deciphered/0658/G_0658_粹863(甲).png`
- asset id: `asset-000585`
...
- English observation: `Two detached long slightly curving vertical strokes
  stand nearly parallel, each carrying two short angled side branches at
  different heights.`
- 中文观察: `两条分离长微弯竖笔近乎平行排列，各自在不同高度带两条短折侧枝。`
...
- dataset label text: `㚈`
- dataset label codepoints: `U+3688`
...
- Which source records identify obs-char-000580 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000580？
