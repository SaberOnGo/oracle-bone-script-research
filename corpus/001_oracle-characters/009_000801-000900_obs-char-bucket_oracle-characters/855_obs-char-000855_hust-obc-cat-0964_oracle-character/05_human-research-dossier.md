# obs-char-000855 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/855_obs-char-000855_hust-obc-cat-0964_orac
  le-character/03_visual-assets/001_asset-000860_hust-obc-cat-0964_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0964/G_0964_甲骨文0.png`
- asset id: `asset-000860`
...
- source category: `0964`
- validation class: `854`
- source image route: `HUST-OBC/deciphered/0964/G_0964_甲骨文0.png`
- asset id: `asset-000860`
...
- English observation: `A shallow bowl-like lower outline supports two
  rising strokes; short detached marks flank the upper and side areas.`
...
- dataset label text: `㞺`
- dataset label codepoints: `U+37BA`
...
- Which source records identify obs-char-000855 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000855？
