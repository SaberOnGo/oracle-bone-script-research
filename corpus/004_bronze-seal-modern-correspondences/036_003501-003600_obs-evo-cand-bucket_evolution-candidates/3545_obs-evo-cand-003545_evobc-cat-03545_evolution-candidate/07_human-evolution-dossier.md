...
- External category reference: `evobc-cat-03545`
- Source category ID: `03545`
- Source label for human review: `攘`
...
- `obs-evo-cand-003545-route-category-staging`
...
- `obs-evo-cand-003545-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003545-route-evolution-graph`
