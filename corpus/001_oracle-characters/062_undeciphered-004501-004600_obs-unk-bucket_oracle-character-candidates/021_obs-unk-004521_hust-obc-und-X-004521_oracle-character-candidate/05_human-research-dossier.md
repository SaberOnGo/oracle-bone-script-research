# obs-unk-004521 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/021_obs-unk-004521_h
  ust-obc-und-X-004521_oracle-character-candidate/03_visual-assets/001_asset
  -006114_hust-obc-und-X-004521_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/77/X_？_8261_1.png`
- asset id: `asset-006114`
...
- source class: `HUST-OBC/undeciphered/X/77/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/77/X_？_8261_1.png`
- asset id: `asset-006114`
...
- English observation: `The two separated groups, upper detached mark, lower
  curve, and visible gap are directly recorded.`
- 中文观察: `已直接记录两组分离痕、上部分离小痕、下部弧线和可见间隔。`
...
- Which source records identify obs-unk-004521 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004521？
