# obs-char-000943 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/943_obs-char-000943_hust-obc-cat-1060_orac
  le-character/03_visual-assets/001_asset-000948_hust-obc-cat-1060_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1060/L_1060_1787.jpg`
- asset id: `asset-000948`
...
- source category: `1060`
- validation class: `942`
- source image route: `HUST-OBC/deciphered/1060/L_1060_1787.jpg`
- asset id: `asset-000948`
...
- English observation: `A faint narrow form has a short upper cross-stroke,
  a central descending line, and lower V-shaped branches.`
- 中文观察: `灰度较淡狭长形体有上部短横笔、中央下行线和下部 V 形分枝。`
...
- dataset label text: `㠚`
- dataset label codepoints: `U+381A`
...
- Which source records identify obs-char-000943 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000943？
