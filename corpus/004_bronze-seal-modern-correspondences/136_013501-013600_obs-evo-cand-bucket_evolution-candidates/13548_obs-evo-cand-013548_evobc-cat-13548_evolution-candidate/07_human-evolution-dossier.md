...
Project ID: `obs-evo-cand-013548`
...
- Project ID: `obs-evo-cand-013548`
- EVOBC category candidate ID: `evobc-evo-cat-13548`
- External category reference: `evobc-cat-13548`
- Source category ID: `13548`
- Source label for human review: `𭧏`
- Source codepoints: `U+2D9CF`
...
- `obs-evo-cand-013548-route-category-staging`
...
- `obs-evo-cand-013548-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013548-route-evolution-graph`
