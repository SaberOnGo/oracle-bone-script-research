...
- `obs-evo-cand-009879-route-category-staging`
...
- `obs-evo-cand-009879-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009879-route-evolution-graph`
