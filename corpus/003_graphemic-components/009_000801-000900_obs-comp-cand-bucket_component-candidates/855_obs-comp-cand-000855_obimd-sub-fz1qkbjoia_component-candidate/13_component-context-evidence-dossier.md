# obs-comp-cand-000855 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000855`
- 首选外部 ID: `obimd-sub-fz1qkbjoia`
- OBIMD subcharacter UID: `fz1qkbjoia`
...
- codepoint 示例: U+F4D2D; U+F4D2E; 另有 28 项
