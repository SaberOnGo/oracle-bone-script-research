# obs-char-000117 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/117_obs-char-000117_hust-obc-cat-0131_orac
  le-character/03_visual-assets/001_asset-000122_hust-obc-cat-0131_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0131/G_0131_乙1275.png`
- asset id: `asset-000122`
...
- source category: `0131`
- validation class: `116`
- source image route: `HUST-OBC/deciphered/0131/G_0131_乙1275.png`
- asset id: `asset-000122`
...
- English observation: `The image combines a small triangular upper form
  with two inner upright strokes and a broad open lower frame beneath a
  horizontal bar.`
...
- dataset label text: `㑹`
- dataset label codepoints: `U+3479`
...
- Which source records identify obs-char-000117 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000117？
