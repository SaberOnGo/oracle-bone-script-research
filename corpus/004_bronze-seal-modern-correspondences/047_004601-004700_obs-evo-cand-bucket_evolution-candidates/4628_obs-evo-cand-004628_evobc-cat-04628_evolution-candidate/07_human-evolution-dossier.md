...
Project ID: `obs-evo-cand-004628`
...
- Project ID: `obs-evo-cand-004628`
- EVOBC category candidate ID: `evobc-evo-cat-04628`
- External category reference: `evobc-cat-04628`
- Source category ID: `04628`
- Source label for human review: `洞`
- Source codepoints: `U+6D1E`
...
- `obs-evo-cand-004628-route-category-staging`
...
- `obs-evo-cand-004628-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004628-route-evolution-graph`
