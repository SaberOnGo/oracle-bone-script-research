...
- Project ID: `obs-evo-cand-010836`
- EVOBC category candidate ID: `evobc-evo-cat-10836`
- External category reference: `evobc-cat-10836`
- Source category ID: `10836`
- Source label for human review: `𠔁`
- Source codepoints: `U+20501`
...
- `obs-evo-cand-010836-route-category-staging`
...
- `obs-evo-cand-010836-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010836-route-evolution-graph`
