...
- Project ID: `obs-evo-cand-007744`
- EVOBC category candidate ID: `evobc-evo-cat-07744`
- External category reference: `evobc-cat-07744`
- Source category ID: `07744`
- Source label for human review: `蛉`
- Source codepoints: `U+86C9`
...
- `obs-evo-cand-007744-route-category-staging`
...
- `obs-evo-cand-007744-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007744-route-evolution-graph`
