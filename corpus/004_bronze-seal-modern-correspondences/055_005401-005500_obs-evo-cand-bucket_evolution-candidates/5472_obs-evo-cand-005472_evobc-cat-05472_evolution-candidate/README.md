# obs-evo-cand-005472 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-05472`
- Source label: `璞`
- Source codepoints: `U+749E`
- Image reference count: `41`
- Era token counts: `OBC:41`
- Source token counts: `Book:19;Web:22`
