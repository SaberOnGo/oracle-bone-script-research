...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1216`
...
- Source image / 来源图: `G_1216_前5.10.1(甲).png`
- Image / 图像: `001_asset-001092_hust-obc-cat-1216_glyph.png`
...
- target node: `evobc-evo-cat-00102`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00102`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00102`
...
- Matched candidate folders / 匹配候选目录: `evobc-evo-cat-00102`
- Human review files / 人类复核文件:
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/102_obs-evo-cand-000102_evobc-cat-00102_evoluti
...
- Source label text / 来源标签文字: `㢶`
- Source label codepoint / 来源标签 codepoint: `U+38B6`
