# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008153
...
- EVOBC candidate category: `evobc-evo-cat-08153`.
- Source label for search only: `訬`.
- Source codepoints for search only: `U+8A2C`.
