...
|---|---|---|
| Source Codepoint Route | `U+3AC3` | not identity |
| HUST candidate route | `hust-obc-cat-1741` | not reading |
| OBIMD route | `obimd-main-cand-002692` | not component |
| EVOBC route | `evobc-evo-cat-00154` | not evolution |
