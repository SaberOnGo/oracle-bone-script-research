...
- External category reference: `evobc-cat-13656`
- Source category ID: `13656`
- Source label for human review: `𮟪`
...
- `obs-evo-cand-013656-route-category-staging`
...
- `obs-evo-cand-013656-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013656-route-evolution-graph`
