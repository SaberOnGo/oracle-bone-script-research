# obs-evo-cand-010239 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-010239`
- EVOBC category candidate ID: `evobc-evo-cat-10239`
- External category ref: `evobc-cat-10239`
- Source label: `騹`
- Source codepoints: `U+9A39`
- Image reference count: `13`
- Era token counts: `WSC:13`
- Source token counts: `Book:1;Web:12`
