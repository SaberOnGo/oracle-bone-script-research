# obs-unk-009162 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/108_undeciphered-009
  101-009200_obs-unk-bucket_oracle-character-candidates/062_obs-unk-009162_h
  ust-obc-und-YH-009162_oracle-character-candidate/03_visual-assets/001_asse
  t-010753_hust-obc-und-YH-009162_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/612C0/Y_？_612C0.jpg`
- asset id: `asset-010753`
...
- source class: `HUST-OBC/undeciphered/Y+H/612C0/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/612C0/Y_？_612C0.jpg`
...
- Which source records identify obs-unk-009162 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009162？
