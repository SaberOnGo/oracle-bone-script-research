...
Project ID: `obs-insc-cw-cand-000520`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000520`
...
- Yingguo / 英国所藏: `y2508` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `343` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `743` in source row; primary catalog entry pending
- Heji / 合集: `41709` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000520`
