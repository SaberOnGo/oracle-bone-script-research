# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002376
...
- EVOBC candidate category: `evobc-evo-cat-02376`.
- Source label for search only: `定`.
- Source codepoints for search only: `U+5B9A`.
