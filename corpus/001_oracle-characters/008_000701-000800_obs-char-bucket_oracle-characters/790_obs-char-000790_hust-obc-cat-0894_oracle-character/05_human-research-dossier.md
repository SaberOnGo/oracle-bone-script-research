# obs-char-000790 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000790`
- primary external id: `hust-obc-cat-0894`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/790_obs-char-000790_hust-obc-cat-0894_orac
  le-character/03_visual-assets/001_asset-000795_hust-obc-cat-0894_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0894/X_0894_4144_1.png`
- asset id: `asset-000795`
...
- source category: `0894`
- validation class: `789`
- source image route: `HUST-OBC/deciphered/0894/X_0894_4144_1.png`
- asset id: `asset-000795`
...
- English observation: `A bold left branching mass extends horizontally
  toward a rounded open right outline; the right junction continues downward
  into a long segmented vertical tail.`
- 中文观察: `粗重左侧分枝笔群横向伸向右侧圆弯开口轮廓；右侧接点向下延续为长段状竖尾。`
...
- dataset label text: `㝴`
- dataset label codepoints: `U+3774`
...
- Which source records identify obs-char-000790 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000790？
