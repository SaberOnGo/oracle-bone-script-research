# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002608
...
| --- | --- | --- | --- |
| `obimd-glyph-link-039559` | 󿬮 | `U+FFB2E` | `reviewed_metadata_only` |
| `obimd-glyph-link-039560` | 󾮈 | `U+FEB88` | `reviewed_metadata_only` |
| `obimd-glyph-link-039561` | 󾮉 | `U+FEB89` | `reviewed_metadata_only` |
