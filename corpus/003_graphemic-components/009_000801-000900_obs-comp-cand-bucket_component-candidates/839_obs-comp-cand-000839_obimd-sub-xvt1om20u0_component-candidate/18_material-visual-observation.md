# Material Visual Observation / obs-comp-cand-000839 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000839`
- External reference / 外部参照: `obimd-sub-xvt1om20u0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013710_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xvt1om20u0/xvt1om20u0/xvt1om20u0.png`
- Checksum / 校验和:
  `53fa1f1a9c91bdb296f33d28247e88e2acc8404303c27d30ae1b9b122a23b8a3`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.21%.
- Marked-pixel bounds: (55,18)–(185,230); span 131 × 213 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.21%。
- 痕迹范围：(55,18)–(185,230)；跨度131 × 213 px；痕迹矩形高于宽。
