# Material Visual Observation / obs-comp-cand-002399 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002399`
- External reference / 外部参照: `obimd-sub-pqtlskkq5f`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020470_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/pqtlskkq5f/pqtlskkq5f/pqtlskkq5f.png`
- Checksum / 校验和:
  `c734f4534c6d0e1bb4e2cc0ad86692da554f861d8e779595a998b6a2f0590592`
...
- Marked-pixel bounds: (71,47)–(178,205); span 108 × 159 px; the marked
...
- 痕迹范围：(71,47)–(178,205)；跨度108 × 159 px；痕迹矩形高于宽。
