...
- External category reference: `evobc-cat-00864`
- Source category ID: `00864`
- Source label for human review: `侲`
- Source codepoints: `U+4FB2`
...
- `obs-evo-cand-000864-route-category-staging`
...
- `obs-evo-cand-000864-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000864-route-evolution-graph`
