...
Project ID: `obs-evo-cand-003002`
...
- Project ID: `obs-evo-cand-003002`
- EVOBC category candidate ID: `evobc-evo-cat-03002`
- External category reference: `evobc-cat-03002`
- Source category ID: `03002`
- Source label for human review: `悈`
- Source codepoints: `U+6088`
...
- `obs-evo-cand-003002-route-category-staging`
...
- `obs-evo-cand-003002-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003002-route-evolution-graph`
