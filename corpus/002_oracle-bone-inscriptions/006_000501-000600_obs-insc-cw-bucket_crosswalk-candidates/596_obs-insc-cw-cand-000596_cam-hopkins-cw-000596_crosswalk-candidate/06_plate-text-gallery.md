...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000596` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2647` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `399` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `465` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `41923` [route_present_image_or_text_not_collected]
