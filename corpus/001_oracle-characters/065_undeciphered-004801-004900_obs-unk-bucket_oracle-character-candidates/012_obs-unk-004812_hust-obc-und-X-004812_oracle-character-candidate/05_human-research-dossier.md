# obs-unk-004812 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004812`
- primary external id: `hust-obc-und-X-004812`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/012_obs-unk-004812_h
  ust-obc-und-X-004812_oracle-character-candidate/03_visual-assets/001_asset
  -006405_hust-obc-und-X-004812_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/368/X_？_7353_1.png`
- asset id: `asset-006405`
...
- source class: `HUST-OBC/undeciphered/X/368/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/368/X_？_7353_1.png`
- asset id: `asset-006405`
...
- English observation: `separated upper groups and right enclosure`
- 中文观察: `分离的上部结构和右侧围合`
...
- Which source records identify obs-unk-004812 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004812？
