# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004275
...
- EVOBC candidate category: `evobc-evo-cat-04275`.
- Source label for search only: `橪`.
- Source codepoints for search only: `U+6A6A`.
