...
- External category reference: `evobc-cat-09397`
- Source category ID: `09397`
- Source label for human review: `銷`
- Source codepoints: `U+92B7`
...
- `obs-evo-cand-009397-route-category-staging`
...
- `obs-evo-cand-009397-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009397-route-evolution-graph`
