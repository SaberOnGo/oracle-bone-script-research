...
- External category reference: `evobc-cat-10786`
- Source category ID: `10786`
- Source label for human review: `𠆆`
- Source codepoints: `U+20186`
...
- `obs-evo-cand-010786-route-category-staging`
...
- `obs-evo-cand-010786-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010786-route-evolution-graph`
