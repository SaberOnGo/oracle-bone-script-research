# obs-char-001267 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001267`
- primary external id: `hust-obc-cat-1417`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1267_obs-char-001267_hust-obc-cat-1417_ora
  cle-character/03_visual-assets/001_asset-001272_hust-obc-cat-1417_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1417/H_1417_617F3_0.png`
- asset id: `asset-001272`
...
- source category: `1417`
- validation class: `1266`
- source image route: `HUST-OBC/deciphered/1417/H_1417_617F3_0.png`
- asset id: `asset-001272`
...
- English observation: `A broad peaked enclosure contains three elongated
  inner marks with varied curves and pointed ends.`
- 中文观察: `宽大的尖顶框形内部有三条纵长笔画，曲直和端部形状各不相同。`
...
- dataset label text: `㥿`
- dataset label codepoints: `U+397F`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00133`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00133`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00133`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/133_obs-evo-can
  d-000133_evobc-cat-00133_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/133_obs-evo-cand-000133_evobc-cat-00133_evolu
...
- filename catalog route clues: `catalog-like filename clue: H_1417
  (H_1417_617F3_0.png)`
...
- Which source records identify obs-char-001267 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001267？
