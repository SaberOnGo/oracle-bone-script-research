# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013195
...
- EVOBC candidate category: `evobc-evo-cat-13195`.
- Source label for search only: `𬂦`.
- Source codepoints for search only: `U+2C0A6`.
