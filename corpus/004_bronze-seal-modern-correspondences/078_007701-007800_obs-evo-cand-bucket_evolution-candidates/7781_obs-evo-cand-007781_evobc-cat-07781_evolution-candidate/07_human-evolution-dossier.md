...
- External category reference: `evobc-cat-07781`
- Source category ID: `07781`
- Source label for human review: `蜙`
...
- `obs-evo-cand-007781-route-category-staging`
...
- `obs-evo-cand-007781-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007781-route-evolution-graph`
