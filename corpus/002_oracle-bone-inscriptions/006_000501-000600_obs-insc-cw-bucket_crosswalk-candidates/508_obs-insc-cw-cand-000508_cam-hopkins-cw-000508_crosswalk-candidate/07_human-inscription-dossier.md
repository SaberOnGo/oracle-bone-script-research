...
- Source page section: `Period IV Group 19` /
  `第 IV 期第 19 组`
- Source section key: `period-iv-group-19`
...
- Yingguo / 英国所藏: `y2483` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `331` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `396` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000508`
