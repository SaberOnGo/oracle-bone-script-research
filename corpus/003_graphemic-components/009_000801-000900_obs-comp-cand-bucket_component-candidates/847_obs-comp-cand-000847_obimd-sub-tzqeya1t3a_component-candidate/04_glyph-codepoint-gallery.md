# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000847
...
| --- | --- | --- | --- |
| `obimd-glyph-link-012113` | 󴱊 | `U+F4C4A` | `reviewed_metadata_only` |
| `obimd-glyph-link-012114` | 󴱋 | `U+F4C4B` | `reviewed_metadata_only` |
