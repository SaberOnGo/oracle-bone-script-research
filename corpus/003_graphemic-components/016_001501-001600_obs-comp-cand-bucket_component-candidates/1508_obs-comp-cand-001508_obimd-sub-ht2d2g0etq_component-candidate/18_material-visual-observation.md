# Material Visual Observation / obs-comp-cand-001508 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001508`
- External reference / 外部参照: `obimd-sub-ht2d2g0etq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016471_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4r0g6bx5rc/ht2d2g0etq/ht2d2g0etq.png`
- Checksum / 校验和:
  `4d1ebd5144525f5e919d1ae98795a103449d262067df6b1dd24054f83df5f7cf`
...
- Marked-pixel bounds: (81,24)–(173,225); span 93 × 202 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.64%。
- 痕迹范围：(81,24)–(173,225)；跨度93 × 202 px；痕迹矩形高于宽。
