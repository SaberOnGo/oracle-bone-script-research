# Material Visual Observation / obs-comp-cand-001040 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001040`
- External reference / 外部参照: `obimd-sub-vgtvawlq60`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014590_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vgtvawlq60/vgtvawlq60/vgtvawlq60.png`
- Checksum / 校验和:
  `d81a3caf91466ae5b3ffd426806adcbad090559d568930d0381a0e306ade51fc`
...
- Marked-pixel bounds: (70,16)–(167,232); span 98 × 217 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.39%。
- 痕迹范围：(70,16)–(167,232)；跨度98 × 217 px；痕迹矩形高于宽。
