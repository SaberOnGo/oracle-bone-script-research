...
Project ID: `obs-evo-cand-003123`
...
- Project ID: `obs-evo-cand-003123`
- EVOBC category candidate ID: `evobc-evo-cat-03123`
- External category reference: `evobc-cat-03123`
- Source category ID: `03123`
- Source label for human review: `慧`
- Source codepoints: `U+6167`
...
- `obs-evo-cand-003123-route-category-staging`
...
- `obs-evo-cand-003123-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003123-route-evolution-graph`
