# obs-char-000988 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000988`
- primary external id: `hust-obc-cat-1110`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/988_obs-char-000988_hust-obc-cat-1110_orac
  le-character/03_visual-assets/001_asset-000993_hust-obc-cat-1110_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1110/H_1110_611F8_0.png`
- asset id: `asset-000993`
...
- source category: `1110`
- validation class: `987`
- source image route: `HUST-OBC/deciphered/1110/H_1110_611F8_0.png`
- asset id: `asset-000993`
...
- English observation: `A very bold form combines a left segmented
  rectangular cluster, a central upright, and an irregular right descending
  cluster.`
- 中文观察: `粗重形体结合左侧分段矩形笔群、中央直立笔和不规则右侧下行笔群。`
...
- dataset label text: `㡌`
- dataset label codepoints: `U+384C`
...
- filename catalog route clues: `catalog-like filename clue: H_1110
  (H_1110_611F8_0.png)`
...
- Which source records identify obs-char-000988 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000988？
