...
- `obs-evo-cand-007114-route-category-staging`
...
- `obs-evo-cand-007114-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007114-route-evolution-graph`
