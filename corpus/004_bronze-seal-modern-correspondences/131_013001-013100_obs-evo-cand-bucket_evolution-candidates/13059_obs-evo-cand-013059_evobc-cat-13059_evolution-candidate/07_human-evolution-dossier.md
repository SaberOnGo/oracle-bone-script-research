...
- External category reference: `evobc-cat-13059`
- Source category ID: `13059`
- Source label for human review: `𫭓`
- Source codepoints: `U+2BB53`
...
- `obs-evo-cand-013059-route-category-staging`
...
- `obs-evo-cand-013059-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013059-route-evolution-graph`
