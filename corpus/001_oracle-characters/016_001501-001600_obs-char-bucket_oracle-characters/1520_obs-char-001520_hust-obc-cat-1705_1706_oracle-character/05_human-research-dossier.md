# obs-char-001520 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001520`
- primary external id: `hust-obc-cat-1705_1706`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1520_obs-char-001520_hust-obc-cat-1705_170
  6_oracle-character/03_visual-assets/001_asset-001525_hust-obc-cat-1705_170
  6_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1705_1706/1705/X_1705_472_1.png
  `
- asset id: `asset-001525`
...
- source category: `1705_1706`
- validation class: `1519`
- source image route: `HUST-OBC/deciphered/1705_1706/1705/X_1705_472_1.png`
- asset id: `asset-001525`
...
- English observation: `A tall composite has layered upper bars, a small
  left enclosure, and a long angled lower stroke.`
- 中文观察: `高大组合形体有层叠上横笔、左侧小框形和长斜向下部笔画。`
...
- dataset label text: `㪟㪠`
- dataset label codepoints: `U+3A9F;U+3AA0`
...
- graph edge count: `2`
- codepoint routes: `U+3A9F;U+3AA0`
...
- Which source records identify obs-char-001520 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001520？
