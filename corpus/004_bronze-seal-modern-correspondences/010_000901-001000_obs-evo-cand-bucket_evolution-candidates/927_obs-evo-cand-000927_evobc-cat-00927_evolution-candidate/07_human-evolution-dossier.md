...
Project ID: `obs-evo-cand-000927`
...
- Project ID: `obs-evo-cand-000927`
- EVOBC category candidate ID: `evobc-evo-cat-00927`
- External category reference: `evobc-cat-00927`
- Source category ID: `00927`
- Source label for human review: `倚`
- Source codepoints: `U+501A`
...
- `obs-evo-cand-000927-route-category-staging`
...
- `obs-evo-cand-000927-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000927-route-evolution-graph`
