# obs-unk-004693 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004693`
- primary external id: `hust-obc-und-X-004693`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/093_obs-unk-004693_h
  ust-obc-und-X-004693_oracle-character-candidate/03_visual-assets/001_asset
  -006286_hust-obc-und-X-004693_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/249/X_？_8416_1.png`
- asset id: `asset-006286`
...
- source class: `HUST-OBC/undeciphered/X/249/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/249/X_？_8416_1.png`
- asset id: `asset-006286`
...
- English observation: `upper prongs with three lower parallel strokes`
- 中文观察: `带三条下部平行笔画的上部尖突组`
...
- Which source records identify obs-unk-004693 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004693？
