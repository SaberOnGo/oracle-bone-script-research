...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000087` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y551` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `102` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `592` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `40032` [route_present_image_or_text_not_collected]
