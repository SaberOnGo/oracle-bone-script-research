# obs-char-001026 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1026_obs-char-001026_hust-obc-cat-1151_ora
  cle-character/03_visual-assets/001_asset-001031_hust-obc-cat-1151_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1151/X_1151_1766_1.png`
- asset id: `asset-001031`
...
- source category: `1151`
- validation class: `1025`
- source image route: `HUST-OBC/deciphered/1151/X_1151_1766_1.png`
- asset id: `asset-001031`
...
- dataset label text: `㡵`
- dataset label codepoints: `U+3875`
...
- Which source records identify obs-char-001026 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001026？
