...
Project ID: `obs-evo-cand-010112`
...
- Project ID: `obs-evo-cand-010112`
- EVOBC category candidate ID: `evobc-evo-cat-10112`
- External category reference: `evobc-cat-10112`
- Source category ID: `10112`
- Source label for human review: `餞`
- Source codepoints: `U+991E`
...
- `obs-evo-cand-010112-route-category-staging`
...
- `obs-evo-cand-010112-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010112-route-evolution-graph`
