# obs-unk-004501 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004501`
- primary external id: `hust-obc-und-X-004501`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/001_obs-unk-004501_h
  ust-obc-und-X-004501_oracle-character-candidate/03_visual-assets/001_asset
  -006094_hust-obc-und-X-004501_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/57/X_？_8243_1.png`
- asset id: `asset-006094`
...
- source class: `HUST-OBC/undeciphered/X/57/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/57/X_？_8243_1.png`
- asset id: `asset-006094`
...
- English observation: `The left opening, crossbar, long lower trace, and two
  separated right traces are directly recorded.`
- 中文观察: `已直接记录左侧空隙、横痕、向下长痕和右侧两条分离长痕。`
...
- Which source records identify obs-unk-004501 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004501？
