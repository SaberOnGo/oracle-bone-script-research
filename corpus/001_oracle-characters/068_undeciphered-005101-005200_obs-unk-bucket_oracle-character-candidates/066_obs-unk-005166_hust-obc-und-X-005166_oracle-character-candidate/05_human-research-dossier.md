# obs-unk-005166 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/068_undeciphered-005
  101-005200_obs-unk-bucket_oracle-character-candidates/066_obs-unk-005166_h
  ust-obc-und-X-005166_oracle-character-candidate/03_visual-assets/001_asset
  -006759_hust-obc-und-X-005166_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/722/X_？_7689_1.png`
- asset id: `asset-006759`
...
- source class: `HUST-OBC/undeciphered/X/722/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/722/X_？_7689_1.png`
- asset id: `asset-006759`
...
- Which source records identify obs-unk-005166 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005166？
