...
- External category reference: `evobc-cat-03863`
- Source category ID: `03863`
- Source label for human review: `朿`
...
- `obs-evo-cand-003863-route-category-staging`
...
- `obs-evo-cand-003863-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003863-route-evolution-graph`
