...
- External category reference: `evobc-cat-08603`
- Source category ID: `08603`
- Source label for human review: `贊`
- Source codepoints: `U+8D0A`
...
- `obs-evo-cand-008603-route-category-staging`
...
- `obs-evo-cand-008603-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008603-route-evolution-graph`
