# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004915
...
- EVOBC candidate category: `evobc-evo-cat-04915`.
- Source label for search only: `潯`.
- Source codepoints for search only: `U+6F6F`.
