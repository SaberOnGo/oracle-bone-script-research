...
- `obs-evo-cand-000017-route-category-staging`
...
- `obs-evo-cand-000017-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000017-route-evolution-graph`
