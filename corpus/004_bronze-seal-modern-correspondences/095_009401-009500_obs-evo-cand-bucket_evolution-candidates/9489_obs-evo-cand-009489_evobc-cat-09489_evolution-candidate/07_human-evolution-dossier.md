...
Project ID: `obs-evo-cand-009489`
...
- Project ID: `obs-evo-cand-009489`
- EVOBC category candidate ID: `evobc-evo-cat-09489`
- External category reference: `evobc-cat-09489`
- Source category ID: `09489`
- Source label for human review: `鎮`
- Source codepoints: `U+93AE`
...
- `obs-evo-cand-009489-route-category-staging`
...
- `obs-evo-cand-009489-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009489-route-evolution-graph`
