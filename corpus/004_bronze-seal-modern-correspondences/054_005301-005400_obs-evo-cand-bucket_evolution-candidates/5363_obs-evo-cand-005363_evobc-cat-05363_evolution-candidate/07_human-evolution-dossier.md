...
- External category reference: `evobc-cat-05363`
- Source category ID: `05363`
- Source label for human review: `玱`
...
- `obs-evo-cand-005363-route-category-staging`
...
- `obs-evo-cand-005363-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005363-route-evolution-graph`
