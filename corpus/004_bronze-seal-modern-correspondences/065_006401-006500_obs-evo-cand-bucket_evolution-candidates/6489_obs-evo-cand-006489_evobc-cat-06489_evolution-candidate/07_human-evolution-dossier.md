...
- External category reference: `evobc-cat-06489`
- Source category ID: `06489`
- Source label for human review: `終`
- Source codepoints: `U+7D42`
- Image reference count in source metadata: `147`
...
- `obs-evo-cand-006489-route-category-staging`
...
- `obs-evo-cand-006489-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006489-route-evolution-graph`
