# obs-char-001148 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001148`
- primary external id: `hust-obc-cat-1283`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1148_obs-char-001148_hust-obc-cat-1283_ora
  cle-character/03_visual-assets/001_asset-001153_hust-obc-cat-1283_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1283/X_1283_5437_1.png`
- asset id: `asset-001153`
...
- source category: `1283`
- validation class: `1147`
- source image route: `HUST-OBC/deciphered/1283/X_1283_5437_1.png`
- asset id: `asset-001153`
...
- English observation: `A large dense multipart form has two upper curved
  masses, a long central descending stroke, and irregular lower hooks.`
- 中文观察: `大型密集的多部分形体有两个上部弯曲块面、中央长下行笔和不规则下部钩笔。`
...
- dataset label text: `㣹`
- dataset label codepoints: `U+38F9`
...
- Which source records identify obs-char-001148 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001148？
