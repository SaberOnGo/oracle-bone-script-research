# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010672
...
- EVOBC candidate category: `evobc-evo-cat-10672`.
- Source label for search only: `黽`.
- Source codepoints for search only: `U+9EFD`.
