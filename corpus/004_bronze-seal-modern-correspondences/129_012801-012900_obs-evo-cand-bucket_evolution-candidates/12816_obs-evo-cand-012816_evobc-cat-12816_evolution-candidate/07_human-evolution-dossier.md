...
- Project ID: `obs-evo-cand-012816`
- EVOBC category candidate ID: `evobc-evo-cat-12816`
- External category reference: `evobc-cat-12816`
- Source category ID: `12816`
- Source label for human review: `𪣬`
- Source codepoints: `U+2A8EC`
...
- `obs-evo-cand-012816-route-category-staging`
...
- `obs-evo-cand-012816-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012816-route-evolution-graph`
