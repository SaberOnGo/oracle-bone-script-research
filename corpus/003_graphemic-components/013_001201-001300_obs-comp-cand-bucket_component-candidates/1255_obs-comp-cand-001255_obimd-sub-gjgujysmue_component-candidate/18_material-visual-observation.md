# Material Visual Observation / obs-comp-cand-001255 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001255`
- External reference / 外部参照: `obimd-sub-gjgujysmue`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015493_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gjgujysmue/gjgujysmue/gjgujysmue.png`
- Checksum / 校验和:
  `3ca7979252c97cb2c39f3f99b5e0dc89d754884fe04c36a43f7ab6a094de5f69`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.18%.
- Marked-pixel bounds: (65,23)–(208,222); span 144 × 200 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.18%。
- 痕迹范围：(65,23)–(208,222)；跨度144 × 200 px；痕迹矩形高于宽。
