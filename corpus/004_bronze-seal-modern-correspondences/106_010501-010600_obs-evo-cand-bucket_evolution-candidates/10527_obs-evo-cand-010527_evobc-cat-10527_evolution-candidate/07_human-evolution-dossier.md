...
- External category reference: `evobc-cat-10527`
- Source category ID: `10527`
- Source label for human review: `鶖`
...
- `obs-evo-cand-010527-route-category-staging`
...
- `obs-evo-cand-010527-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010527-route-evolution-graph`
