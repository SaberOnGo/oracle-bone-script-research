# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012980
...
- EVOBC candidate category: `evobc-evo-cat-12980`.
- Source label for search only: `𫛓`.
- Source codepoints for search only: `U+2B6D3`.
