# obs-char-000748 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/748_obs-char-000748_hust-obc-cat-0850_orac
  le-character/03_visual-assets/001_asset-000753_hust-obc-cat-0850_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0850/G_0850_甲骨文.png`
- asset id: `asset-000753`
...
- source category: `0850`
- validation class: `747`
- source image route: `HUST-OBC/deciphered/0850/G_0850_甲骨文.png`
- asset id: `asset-000753`
...
- dataset label text: `㝈`
- dataset label codepoints: `U+3748`
...
- Which source records identify obs-char-000748 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000748？
