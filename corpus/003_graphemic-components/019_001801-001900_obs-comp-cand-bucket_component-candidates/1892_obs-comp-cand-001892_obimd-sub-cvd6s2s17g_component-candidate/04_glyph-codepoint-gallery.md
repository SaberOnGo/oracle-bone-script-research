# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001892
...
| --- | --- | --- | --- |
| `obimd-glyph-link-028703` | 򰶑󺳯 | `U+B0D91;U+FACEF` | `reviewed_metadata_only` |
| `obimd-glyph-link-028704` | 󺳰 | `U+FACF0` | `reviewed_metadata_only` |
