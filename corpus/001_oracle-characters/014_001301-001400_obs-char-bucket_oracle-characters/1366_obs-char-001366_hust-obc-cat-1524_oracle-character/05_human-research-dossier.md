# obs-char-001366 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001366`
- primary external id: `hust-obc-cat-1524`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1366_obs-char-001366_hust-obc-cat-1524_ora
  cle-character/03_visual-assets/001_asset-001371_hust-obc-cat-1524_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1524/G_1524_合4853(甲).png`
- asset id: `asset-001371`
...
- source category: `1524`
- validation class: `1365`
- source image route: `HUST-OBC/deciphered/1524/G_1524_合4853(甲).png`
- asset id: `asset-001371`
...
- English observation: `A pointed upper fork stands above a compact divided
  lower enclosure.`
- 中文观察: `尖状上部分叉位于紧凑的下部隔分框形之上。`
...
- dataset label text: `㧪`
- dataset label codepoints: `U+39EA`
...
- filename catalog route clues: `Heji-like filename clue: 合4853
  (G_1524_合4853(甲).png)`
...
- Which source records identify obs-char-001366 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001366？
