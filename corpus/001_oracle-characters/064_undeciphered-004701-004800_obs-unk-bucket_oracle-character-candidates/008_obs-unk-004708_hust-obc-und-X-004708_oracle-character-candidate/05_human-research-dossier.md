# obs-unk-004708 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/008_obs-unk-004708_h
  ust-obc-und-X-004708_oracle-character-candidate/03_visual-assets/001_asset
  -006301_hust-obc-und-X-004708_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/264/X_？_7236_1.png`
- asset id: `asset-006301`
...
- source class: `HUST-OBC/undeciphered/X/264/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/264/X_？_7236_1.png`
- asset id: `asset-006301`
...
- English observation: `long left vertical with enclosed angled opening`
- 中文观察: `带斜向围合开口的左侧长竖笔画`
...
- Which source records identify obs-unk-004708 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004708？
