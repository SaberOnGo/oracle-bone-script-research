...
Project ID: `obs-evo-cand-009572`
...
- Project ID: `obs-evo-cand-009572`
- EVOBC category candidate ID: `evobc-evo-cat-09572`
- External category reference: `evobc-cat-09572`
- Source category ID: `09572`
- Source label for human review: `钦`
- Source codepoints: `U+94A6`
...
- `obs-evo-cand-009572-route-category-staging`
...
- `obs-evo-cand-009572-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009572-route-evolution-graph`
