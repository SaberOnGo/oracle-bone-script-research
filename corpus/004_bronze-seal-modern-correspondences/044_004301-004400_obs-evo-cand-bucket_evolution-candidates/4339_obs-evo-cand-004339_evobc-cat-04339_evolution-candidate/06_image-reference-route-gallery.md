...
- `obs-evo-cand-004339-route-category-staging`
...
- `obs-evo-cand-004339-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004339-route-evolution-graph`
