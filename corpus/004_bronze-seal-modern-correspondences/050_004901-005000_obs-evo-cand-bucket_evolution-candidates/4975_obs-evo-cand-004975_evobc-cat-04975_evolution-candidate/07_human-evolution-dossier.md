...
Project ID: `obs-evo-cand-004975`
...
- Project ID: `obs-evo-cand-004975`
- EVOBC category candidate ID: `evobc-evo-cat-04975`
- External category reference: `evobc-cat-04975`
- Source category ID: `04975`
- Source label for human review: `濯`
- Source codepoints: `U+6FEF`
...
- `obs-evo-cand-004975-route-category-staging`
...
- `obs-evo-cand-004975-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004975-route-evolution-graph`
