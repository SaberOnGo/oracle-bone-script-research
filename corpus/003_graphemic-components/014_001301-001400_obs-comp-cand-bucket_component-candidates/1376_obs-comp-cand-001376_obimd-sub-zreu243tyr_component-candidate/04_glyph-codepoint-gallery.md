# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001376
...
| --- | --- | --- | --- |
| `obimd-glyph-link-020607` | 󷵠 | `U+F7D60` | `reviewed_metadata_only` |
| `obimd-glyph-link-020608` | 󷵡 | `U+F7D61` | `reviewed_metadata_only` |
