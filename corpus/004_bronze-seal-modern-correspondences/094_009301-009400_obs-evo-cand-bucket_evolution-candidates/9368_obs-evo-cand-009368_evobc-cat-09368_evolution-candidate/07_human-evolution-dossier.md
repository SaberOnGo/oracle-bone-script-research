...
Project ID: `obs-evo-cand-009368`
...
- Project ID: `obs-evo-cand-009368`
- EVOBC category candidate ID: `evobc-evo-cat-09368`
- External category reference: `evobc-cat-09368`
- Source category ID: `09368`
- Source label for human review: `鉥`
- Source codepoints: `U+9265`
...
- `obs-evo-cand-009368-route-category-staging`
...
- `obs-evo-cand-009368-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009368-route-evolution-graph`
