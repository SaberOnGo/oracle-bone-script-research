# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008160
...
- EVOBC candidate category: `evobc-evo-cat-08160`.
- Source label for search only: `訹`.
- Source codepoints for search only: `U+8A39`.
