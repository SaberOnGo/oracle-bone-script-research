...
Project ID: `obs-evo-cand-004489`
...
- Project ID: `obs-evo-cand-004489`
- EVOBC category candidate ID: `evobc-evo-cat-04489`
- External category reference: `evobc-cat-04489`
- Source category ID: `04489`
- Source label for human review: `汋`
- Source codepoints: `U+6C4B`
...
- `obs-evo-cand-004489-route-category-staging`
...
- `obs-evo-cand-004489-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004489-route-evolution-graph`
