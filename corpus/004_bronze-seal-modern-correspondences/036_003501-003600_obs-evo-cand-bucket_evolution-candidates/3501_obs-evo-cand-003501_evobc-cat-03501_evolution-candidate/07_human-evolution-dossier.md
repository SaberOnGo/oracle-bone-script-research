...
- External category reference: `evobc-cat-03501`
- Source category ID: `03501`
- Source label for human review: `撢`
- Source codepoints: `U+64A2`
...
- `obs-evo-cand-003501-route-category-staging`
...
- `obs-evo-cand-003501-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003501-route-evolution-graph`
