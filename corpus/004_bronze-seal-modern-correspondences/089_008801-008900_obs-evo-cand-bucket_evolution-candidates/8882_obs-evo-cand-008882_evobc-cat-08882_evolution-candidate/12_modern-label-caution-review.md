# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008882
...
- EVOBC candidate category: `evobc-evo-cat-08882`.
- Source label for search only: `轝`.
- Source codepoints for search only: `U+8F5D`.
