# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-000487
...
- candidate_component_id: `obs-comp-cand-000487`
- primary_external_ref_id: `obimd-sub-vp4cxkje4s`
- source_subcharacter_uid: `vp4cxkje4s`
- source_main_character_uid: `vp4cxkje4s`
- main_character_external_ref_id: `obimd-main-vp4cxkje4s`
...
- glyph_codepoint_uplus_sample: `U+F2DE0, U+F2DE1, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-012723` | `001_asset-012723_img.png` | `6870bd4700976ed1f2919ba02488d77368bd2e77e47c67c13cadab6b7ba856e2` |
