# obs-evo-cand-003953 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-003953`
- EVOBC category candidate ID: `evobc-evo-cat-03953`
- External category ref: `evobc-cat-03953`
- Source label: `柏`
- Source codepoints: `U+67CF`
- Image reference count: `43`
- Era token counts: `BI:2;OBC:27;SAC:2;SS:1;WSC:11`
- Source token counts: `Book:13;Web:30`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 27 image references
- era 1 / BI: 2 image references
- era 2 / SS: 1 image references
- era 3 / SAC: 2 image references
- era 4 / WSC: 11 image references
