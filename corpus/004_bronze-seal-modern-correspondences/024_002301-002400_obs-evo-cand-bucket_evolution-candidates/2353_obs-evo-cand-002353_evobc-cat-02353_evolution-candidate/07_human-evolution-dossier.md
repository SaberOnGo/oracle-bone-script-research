...
- External category reference: `evobc-cat-02353`
- Source category ID: `02353`
- Source label for human review: `孿`
...
- `obs-evo-cand-002353-route-category-staging`
...
- `obs-evo-cand-002353-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002353-route-evolution-graph`
