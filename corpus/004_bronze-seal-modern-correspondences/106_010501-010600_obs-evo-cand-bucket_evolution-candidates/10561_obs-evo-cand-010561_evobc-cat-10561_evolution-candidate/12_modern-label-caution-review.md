# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010561
...
- EVOBC candidate category: `evobc-evo-cat-10561`.
- Source label for search only: `鷫`.
- Source codepoints for search only: `U+9DEB`.
