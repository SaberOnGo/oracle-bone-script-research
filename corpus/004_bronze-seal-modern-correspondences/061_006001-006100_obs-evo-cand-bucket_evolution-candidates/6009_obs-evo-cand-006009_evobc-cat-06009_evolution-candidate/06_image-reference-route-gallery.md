...
- `obs-evo-cand-006009-route-category-staging`
...
- `obs-evo-cand-006009-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006009-route-evolution-graph`
