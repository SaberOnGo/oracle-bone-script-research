...
- External category reference: `evobc-cat-01756`
- Source category ID: `01756`
- Source label for human review: `回`
- Source codepoints: `U+56DE`
...
- `obs-evo-cand-001756-route-category-staging`
...
- `obs-evo-cand-001756-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001756-route-evolution-graph`
