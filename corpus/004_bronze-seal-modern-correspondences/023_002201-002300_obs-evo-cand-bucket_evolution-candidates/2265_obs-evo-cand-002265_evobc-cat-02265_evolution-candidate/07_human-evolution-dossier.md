...
- External category reference: `evobc-cat-02265`
- Source category ID: `02265`
- Source label for human review: `嫙`
...
- `obs-evo-cand-002265-route-category-staging`
...
- `obs-evo-cand-002265-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002265-route-evolution-graph`
