# obs-comp-cand-000605 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000605`
- 首选外部 ID: `obimd-sub-0umdgqu77x`
- OBIMD subcharacter UID: `0umdgqu77x`
- OBIMD main character UID: `0umdgqu77x`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+60A4;U+F396C; U+F396D
