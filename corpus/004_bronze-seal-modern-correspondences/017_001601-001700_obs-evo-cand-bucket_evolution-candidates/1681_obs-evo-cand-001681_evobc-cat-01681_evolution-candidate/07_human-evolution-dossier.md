...
Project ID: `obs-evo-cand-001681`
...
- Project ID: `obs-evo-cand-001681`
- EVOBC category candidate ID: `evobc-evo-cat-01681`
- External category reference: `evobc-cat-01681`
- Source category ID: `01681`
- Source label for human review: `嗷`
- Source codepoints: `U+55F7`
...
- `obs-evo-cand-001681-route-category-staging`
...
- `obs-evo-cand-001681-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001681-route-evolution-graph`
