...
Project ID: `obs-evo-cand-003514`
...
- Project ID: `obs-evo-cand-003514`
- EVOBC category candidate ID: `evobc-evo-cat-03514`
- External category reference: `evobc-cat-03514`
- Source category ID: `03514`
- Source label for human review: `擅`
- Source codepoints: `U+64C5`
...
- `obs-evo-cand-003514-route-category-staging`
...
- `obs-evo-cand-003514-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003514-route-evolution-graph`
