# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003676
...
- EVOBC candidate category: `evobc-evo-cat-03676`.
- Source label for search only: `旛`.
- Source codepoints for search only: `U+65DB`.
