...
Project ID: `obs-evo-cand-009189`
...
- Project ID: `obs-evo-cand-009189`
- EVOBC category candidate ID: `evobc-evo-cat-09189`
- External category reference: `evobc-cat-09189`
- Source category ID: `09189`
- Source label for human review: `鄒`
- Source codepoints: `U+9112`
...
- `obs-evo-cand-009189-route-category-staging`
...
- `obs-evo-cand-009189-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009189-route-evolution-graph`
