# obs-char-000483 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/483_obs-char-000483_hust-obc-cat-0548_orac
  le-character/03_visual-assets/001_asset-000488_hust-obc-cat-0548_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0548/X_0548_3550_1.png`
- asset id: `asset-000488`
...
- source category: `0548`
- validation class: `482`
- source image route: `HUST-OBC/deciphered/0548/X_0548_3550_1.png`
- asset id: `asset-000488`
...
- English observation: `An irregular polygonal outer frame encloses several
  closely spaced parallel curved strokes descending from a shared upper
  area.`
...
- dataset label text: `㘚`
- dataset label codepoints: `U+361A`
...
- Which source records identify obs-char-000483 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000483？
