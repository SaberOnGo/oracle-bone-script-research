...
- External category reference: `evobc-cat-08860`
- Source category ID: `08860`
- Source label for human review: `輿`
- Source codepoints: `U+8F3F`
...
- `obs-evo-cand-008860-route-category-staging`
...
- `obs-evo-cand-008860-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008860-route-evolution-graph`
