...
- External category reference: `evobc-cat-02002`
- Source category ID: `02002`
- Source label for human review: `多`
- Source codepoints: `U+591A`
- Image reference count in source metadata: `246`
...
- `obs-evo-cand-002002-route-category-staging`
...
- `obs-evo-cand-002002-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002002-route-evolution-graph`
