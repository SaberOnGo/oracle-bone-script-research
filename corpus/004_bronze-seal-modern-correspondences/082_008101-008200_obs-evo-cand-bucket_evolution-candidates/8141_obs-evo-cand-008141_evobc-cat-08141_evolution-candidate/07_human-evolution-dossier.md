...
- Project ID: `obs-evo-cand-008141`
- EVOBC category candidate ID: `evobc-evo-cat-08141`
- External category reference: `evobc-cat-08141`
- Source category ID: `08141`
- Source label for human review: `訛`
- Source codepoints: `U+8A1B`
...
- `obs-evo-cand-008141-route-category-staging`
...
- `obs-evo-cand-008141-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008141-route-evolution-graph`
