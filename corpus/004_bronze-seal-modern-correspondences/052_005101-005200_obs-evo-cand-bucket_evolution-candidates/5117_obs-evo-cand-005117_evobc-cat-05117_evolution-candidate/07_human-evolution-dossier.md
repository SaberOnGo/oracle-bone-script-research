...
- External category reference: `evobc-cat-05117`
- Source category ID: `05117`
- Source label for human review: `煩`
...
- `obs-evo-cand-005117-route-category-staging`
...
- `obs-evo-cand-005117-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005117-route-evolution-graph`
