...
- External category reference: `evobc-cat-05449`
- Source category ID: `05449`
- Source label for human review: `瑬`
- Source codepoints: `U+746C`
...
- `obs-evo-cand-005449-route-category-staging`
...
- `obs-evo-cand-005449-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005449-route-evolution-graph`
