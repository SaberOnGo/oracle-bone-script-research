...
- External category reference: `evobc-cat-13330`
- Source category ID: `13330`
- Source label for human review: `𬢍`
...
- `obs-evo-cand-013330-route-category-staging`
...
- `obs-evo-cand-013330-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013330-route-evolution-graph`
