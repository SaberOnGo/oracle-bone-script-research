...
Project ID: `obs-evo-cand-007782`
...
- Project ID: `obs-evo-cand-007782`
- EVOBC category candidate ID: `evobc-evo-cat-07782`
- External category reference: `evobc-cat-07782`
- Source category ID: `07782`
- Source label for human review: `蜚`
- Source codepoints: `U+871A`
...
- `obs-evo-cand-007782-route-category-staging`
...
- `obs-evo-cand-007782-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007782-route-evolution-graph`
