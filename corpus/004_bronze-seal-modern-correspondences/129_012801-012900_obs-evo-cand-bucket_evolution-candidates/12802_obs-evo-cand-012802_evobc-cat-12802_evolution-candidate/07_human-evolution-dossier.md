...
- External category reference: `evobc-cat-12802`
- Source category ID: `12802`
- Source label for human review: `𪠅`
...
- `obs-evo-cand-012802-route-category-staging`
...
- `obs-evo-cand-012802-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012802-route-evolution-graph`
