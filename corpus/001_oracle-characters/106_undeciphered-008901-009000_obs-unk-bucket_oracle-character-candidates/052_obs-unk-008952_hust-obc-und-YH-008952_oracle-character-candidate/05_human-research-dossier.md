# obs-unk-008952 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008952`
- primary external id: `hust-obc-und-YH-008952`
...
- local review image route: `corpus/001_oracle-characters/106_undeciphered-008
  901-009000_obs-unk-bucket_oracle-character-candidates/052_obs-unk-008952_h
  ust-obc-und-YH-008952_oracle-character-candidate/03_visual-assets/001_asse
  t-010543_hust-obc-und-YH-008952_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60FAD/Y_？_60FAD.jpg`
- asset id: `asset-010543`
...
- source class: `HUST-OBC/undeciphered/Y+H/60FAD/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60FAD/Y_？_60FAD.jpg`
- asset id: `asset-010543`
...
- Which source records identify obs-unk-008952 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008952？
