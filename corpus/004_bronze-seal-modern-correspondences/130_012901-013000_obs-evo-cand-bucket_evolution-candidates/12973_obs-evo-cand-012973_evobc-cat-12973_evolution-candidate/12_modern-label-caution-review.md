# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012973
...
- EVOBC candidate category: `evobc-evo-cat-12973`.
- Source label for search only: `𫗑`.
- Source codepoints for search only: `U+2B5D1`.
