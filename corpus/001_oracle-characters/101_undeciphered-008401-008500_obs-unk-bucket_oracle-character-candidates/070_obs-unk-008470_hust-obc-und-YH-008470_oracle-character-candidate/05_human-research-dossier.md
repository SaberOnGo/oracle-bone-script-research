# obs-unk-008470 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008470`
- primary external id: `hust-obc-und-YH-008470`
...
- local review image route: `corpus/001_oracle-characters/101_undeciphered-008
  401-008500_obs-unk-bucket_oracle-character-candidates/070_obs-unk-008470_h
  ust-obc-und-YH-008470_oracle-character-candidate/03_visual-assets/001_asse
  t-010061_hust-obc-und-YH-008470_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60B3B/H_？_60B3B_0.png`
- asset id: `asset-010061`
...
- source class: `HUST-OBC/undeciphered/Y+H/60B3B/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60B3B/H_？_60B3B_0.png`
- asset id: `asset-010061`
...
- Which source records identify obs-unk-008470 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008470？
