...
- `obs-evo-cand-009763-route-category-staging`
...
- `obs-evo-cand-009763-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009763-route-evolution-graph`
