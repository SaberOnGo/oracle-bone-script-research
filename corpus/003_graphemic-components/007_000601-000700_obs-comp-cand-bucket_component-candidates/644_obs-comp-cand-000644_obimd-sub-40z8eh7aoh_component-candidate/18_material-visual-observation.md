# Material Visual Observation / obs-comp-cand-000644 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000644`
- External reference / 外部参照: `obimd-sub-40z8eh7aoh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013207_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3lrj040600/40z8eh7aoh/40z8eh7aoh.png`
- Checksum / 校验和:
  `05c20f7a48fafd7263a65591533a11d2348237f0ef8cb9af22c9e5fd18e9342f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.40%.
- Marked-pixel bounds: (63,26)–(193,225); span 131 × 200 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.40%。
- 痕迹范围：(63,26)–(193,225)；跨度131 × 200 px；痕迹矩形高于宽。
