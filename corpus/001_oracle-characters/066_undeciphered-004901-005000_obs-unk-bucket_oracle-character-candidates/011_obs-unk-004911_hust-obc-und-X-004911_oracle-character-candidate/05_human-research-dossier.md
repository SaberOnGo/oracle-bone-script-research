# obs-unk-004911 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004911`
- primary external id: `hust-obc-und-X-004911`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/011_obs-unk-004911_h
  ust-obc-und-X-004911_oracle-character-candidate/03_visual-assets/001_asset
  -006504_hust-obc-und-X-004911_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/467/X_？_7452_1.png`
- asset id: `asset-006504`
...
- The image is high contrast and contains pale openings in a dark crop.
- Stroke separation remains pending a non-thresholded source image.
...
- source class: `HUST-OBC/undeciphered/X/467/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/467/X_？_7452_1.png`
- asset id: `asset-006504`
...
- Which source records identify obs-unk-004911 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004911？
