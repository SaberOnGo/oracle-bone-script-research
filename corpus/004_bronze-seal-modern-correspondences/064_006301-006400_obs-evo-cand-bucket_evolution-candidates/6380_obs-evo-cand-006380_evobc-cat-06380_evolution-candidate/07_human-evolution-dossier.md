...
- External category reference: `evobc-cat-06380`
- Source category ID: `06380`
- Source label for human review: `籤`
- Source codepoints: `U+7C64`
...
- `obs-evo-cand-006380-route-category-staging`
...
- `obs-evo-cand-006380-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006380-route-evolution-graph`
