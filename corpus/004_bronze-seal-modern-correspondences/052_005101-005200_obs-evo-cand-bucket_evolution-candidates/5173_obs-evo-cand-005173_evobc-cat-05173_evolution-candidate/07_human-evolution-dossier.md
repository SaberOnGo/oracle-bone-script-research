...
- External category reference: `evobc-cat-05173`
- Source category ID: `05173`
- Source label for human review: `爞`
- Source codepoints: `U+721E`
...
- `obs-evo-cand-005173-route-category-staging`
...
- `obs-evo-cand-005173-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005173-route-evolution-graph`
