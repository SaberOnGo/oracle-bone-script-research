# Material Visual Observation / obs-comp-cand-001696 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001696`
- External reference / 外部参照: `obimd-sub-tp35ajzbj3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017612_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3eorzalgl4/tp35ajzbj3/tp35ajzbj3.png`
- Checksum / 校验和:
  `2d646bd5d831baf862b5528cb01de9e1a0d3ba797d0e0571c970697e144bb8ca`
...
- Marked-pixel bounds: (62,15)–(186,234); span 125 × 220 px; the marked
...
- 痕迹范围：(62,15)–(186,234)；跨度125 × 220 px；痕迹矩形高于宽。
