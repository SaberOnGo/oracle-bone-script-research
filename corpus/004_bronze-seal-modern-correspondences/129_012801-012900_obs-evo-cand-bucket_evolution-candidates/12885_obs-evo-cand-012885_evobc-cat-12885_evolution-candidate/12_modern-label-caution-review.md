# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012885
...
- EVOBC candidate category: `evobc-evo-cat-12885`.
- Source label for search only: `𪹽`.
- Source codepoints for search only: `U+2AE7D`.
