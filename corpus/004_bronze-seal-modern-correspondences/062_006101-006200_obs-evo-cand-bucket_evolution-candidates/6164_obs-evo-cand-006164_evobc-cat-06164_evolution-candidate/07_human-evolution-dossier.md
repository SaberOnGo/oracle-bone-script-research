...
Project ID: `obs-evo-cand-006164`
...
- Project ID: `obs-evo-cand-006164`
- EVOBC category candidate ID: `evobc-evo-cat-06164`
- External category reference: `evobc-cat-06164`
- Source category ID: `06164`
- Source label for human review: `窔`
- Source codepoints: `U+7A94`
...
- `obs-evo-cand-006164-route-category-staging`
...
- `obs-evo-cand-006164-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006164-route-evolution-graph`
