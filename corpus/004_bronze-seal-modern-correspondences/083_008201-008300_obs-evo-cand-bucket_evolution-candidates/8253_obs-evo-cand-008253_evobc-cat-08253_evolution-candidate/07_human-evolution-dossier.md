...
- External category reference: `evobc-cat-08253`
- Source category ID: `08253`
- Source label for human review: `誼`
- Source codepoints: `U+8ABC`
...
- `obs-evo-cand-008253-route-category-staging`
...
- `obs-evo-cand-008253-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008253-route-evolution-graph`
