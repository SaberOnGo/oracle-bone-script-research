...
Project ID: `obs-evo-cand-011421`
...
- Project ID: `obs-evo-cand-011421`
- EVOBC category candidate ID: `evobc-evo-cat-11421`
- External category reference: `evobc-cat-11421`
- Source category ID: `11421`
- Source label for human review: `𣎧`
- Source codepoints: `U+233A7`
...
- `obs-evo-cand-011421-route-category-staging`
...
- `obs-evo-cand-011421-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011421-route-evolution-graph`
