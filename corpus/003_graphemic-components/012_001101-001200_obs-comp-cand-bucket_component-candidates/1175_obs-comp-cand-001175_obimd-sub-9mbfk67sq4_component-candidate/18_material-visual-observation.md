# Material Visual Observation / obs-comp-cand-001175 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001175`
- External reference / 外部参照: `obimd-sub-9mbfk67sq4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015365_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9mbfk67sq4/9mbfk67sq4/9mbfk67sq4.png`
- Checksum / 校验和:
  `ed4bafe802bd0615f31ef0915aeb89a90a63816f440ed08ce142909bbca7e253`
...
- Marked-pixel bounds: (91,20)–(152,227); span 62 × 208 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.90%。
- 痕迹范围：(91,20)–(152,227)；跨度62 × 208 px；痕迹矩形高于宽。
