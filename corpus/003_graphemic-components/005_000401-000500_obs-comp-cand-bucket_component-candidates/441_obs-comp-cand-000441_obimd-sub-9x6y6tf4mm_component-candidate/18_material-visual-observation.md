# Material Visual Observation / obs-comp-cand-000441 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000441`
- External reference / 外部参照: `obimd-sub-9x6y6tf4mm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012364_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/nqghhf5br6/9x6y6tf4mm/9x6y6tf4mm.png`
- Checksum / 校验和:
  `dcd3561b53828a69d4a39f62b2aa5ac020655113c516e60913cd87b8c5788099`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.52%.
- Marked-pixel bounds: (80,21)–(169,226); span 90 × 206 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.52%。
- 痕迹范围：(80,21)–(169,226)；跨度90 × 206 px；痕迹矩形高于宽。
