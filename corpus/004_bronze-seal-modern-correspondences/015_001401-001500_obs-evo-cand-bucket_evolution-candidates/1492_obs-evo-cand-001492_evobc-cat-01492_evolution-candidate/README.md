# obs-evo-cand-001492 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-001492`
- EVOBC category candidate ID: `evobc-evo-cat-01492`
- External category ref: `evobc-cat-01492`
- Source label: `各`
- Source codepoints: `U+5404`
- Image reference count: `275`
- Era token counts: `BI:84;CS:1;OBC:112;SAC:3;SS:2;WSC:73`
- Source token counts: `Book:126;Web:149`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 112 image references
- era 1 / BI: 84 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 3 image references
- era 4 / WSC: 73 image references
- era 5 / CS: 1 image references
- source 0 / Web:1633: 1 image references
- source 1 / Web:105952;說文Web:58: 126 image references
- source 2 / Book:17600: 45 image references
- source 3 / Book:21681: 42 image references
- source 4 / Book:9131: 3 image references
