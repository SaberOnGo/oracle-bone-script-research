# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-001148
...
- candidate_component_id: `obs-comp-cand-001148`
- primary_external_ref_id: `obimd-sub-khqn7h3zps`
- source_subcharacter_uid: `khqn7h3zps`
- source_main_character_uid: `khqn7h3zps`
- main_character_external_ref_id: `obimd-main-khqn7h3zps`
...
- glyph_codepoint_uplus_sample: `U+F6A15, U+F6A16, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-015338` | `001_asset-015338_img.png` | `85c79ea934a76c807d018df905d0336093d5f74d8d7b0260c091c8219b5d08d0` |
