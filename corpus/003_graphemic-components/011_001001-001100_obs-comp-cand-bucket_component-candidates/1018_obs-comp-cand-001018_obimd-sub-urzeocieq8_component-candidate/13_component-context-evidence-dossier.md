# obs-comp-cand-001018 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001018`
- 首选外部 ID: `obimd-sub-urzeocieq8`
- OBIMD subcharacter UID: `urzeocieq8`
- OBIMD main character UID: `urzeocieq8`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `9`
- codepoint 示例: U+F5C59; U+F5C5A; 另有 7 项
