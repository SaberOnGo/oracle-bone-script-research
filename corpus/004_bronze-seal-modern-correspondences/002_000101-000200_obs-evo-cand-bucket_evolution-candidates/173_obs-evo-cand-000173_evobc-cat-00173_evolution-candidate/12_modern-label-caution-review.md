# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000173
...
- EVOBC candidate category: `evobc-evo-cat-00173`.
- Source label for search only: `㮚`.
- Source codepoints for search only: `U+3B9A`.
