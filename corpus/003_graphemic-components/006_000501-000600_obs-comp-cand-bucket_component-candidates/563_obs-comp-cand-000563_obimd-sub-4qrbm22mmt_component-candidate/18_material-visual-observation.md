# Material Visual Observation / obs-comp-cand-000563 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000563`
- External reference / 外部参照: `obimd-sub-4qrbm22mmt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012815_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4qrbm22mmt/4qrbm22mmt/4qrbm22mmt.png`
- Checksum / 校验和:
  `5066bbef7c5e173d0b49117063ca90d7dad65412e8f82be62c5f5f657d3d2e6a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.40%.
- Marked-pixel bounds: (79,26)–(170,221); span 92 × 196 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.40%。
- 痕迹范围：(79,26)–(170,221)；跨度92 × 196 px；痕迹矩形高于宽。
