...
Project ID: `obs-evo-cand-001125`
...
- Project ID: `obs-evo-cand-001125`
- EVOBC category candidate ID: `evobc-evo-cat-01125`
- External category reference: `evobc-cat-01125`
- Source category ID: `01125`
- Source label for human review: `军`
- Source codepoints: `U+519B`
...
- `obs-evo-cand-001125-route-category-staging`
...
- `obs-evo-cand-001125-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001125-route-evolution-graph`
