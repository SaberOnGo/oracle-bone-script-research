# Material Visual Observation / obs-comp-cand-002643 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002643`
- External reference / 外部参照: `obimd-sub-ymikxh8lgo`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021192_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ymikxh8lgo/ymikxh8lgo/ymikxh8lgo.png`
- Checksum / 校验和:
  `65a37120b356c1d101b1f0b4e7d44cb5e6ab2e1753d4acb07dde7f84f854aa1c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.03%.
- Marked-pixel bounds: (95,20)–(155,230); span 61 × 211 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.03%。
- 痕迹范围：(95,20)–(155,230)；跨度61 × 211 px；痕迹矩形高于宽。
