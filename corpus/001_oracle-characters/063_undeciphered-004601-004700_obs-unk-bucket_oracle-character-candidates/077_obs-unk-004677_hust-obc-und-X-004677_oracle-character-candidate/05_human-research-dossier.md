# obs-unk-004677 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004677`
- primary external id: `hust-obc-und-X-004677`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/077_obs-unk-004677_h
  ust-obc-und-X-004677_oracle-character-candidate/03_visual-assets/001_asset
  -006270_hust-obc-und-X-004677_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/233/X_？_8402_1.png`
- asset id: `asset-006270`
...
- source class: `HUST-OBC/undeciphered/X/233/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/233/X_？_8402_1.png`
- asset id: `asset-006270`
...
- English observation: `tall stem with crossing diagonal and side fragment`
- 中文观察: `带交叉斜笔和侧向残片的高形笔画`
...
- Which source records identify obs-unk-004677 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004677？
