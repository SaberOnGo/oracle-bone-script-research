# obs-unk-004197 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004197`
- primary external id: `hust-obc-und-L-004197`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/097_obs-unk-004197_h
  ust-obc-und-L-004197_oracle-character-candidate/03_visual-assets/001_asset
  -005790_hust-obc-und-L-004197_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4197/L_？_9139.jpg`
- asset id: `asset-005790`
...
- source class: `HUST-OBC/undeciphered/L/4197/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4197/L_？_9139.jpg`
- asset id: `asset-005790`
...
- English observation: `Two upper traces and a lower curve are visible.`
- 中文观察: `上部两条痕迹和下方独立的弧形笔画可见。`
...
- Which source records identify obs-unk-004197 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004197？
