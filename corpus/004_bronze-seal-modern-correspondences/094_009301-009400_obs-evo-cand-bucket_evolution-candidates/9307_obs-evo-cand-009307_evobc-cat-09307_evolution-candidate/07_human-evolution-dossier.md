...
- External category reference: `evobc-cat-09307`
- Source category ID: `09307`
- Source label for human review: `釜`
- Source codepoints: `U+91DC`
...
- `obs-evo-cand-009307-route-category-staging`
...
- `obs-evo-cand-009307-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009307-route-evolution-graph`
