# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012799
...
- EVOBC candidate category: `evobc-evo-cat-12799`.
- Source label for search only: `𪟌`.
- Source codepoints for search only: `U+2A7CC`.
