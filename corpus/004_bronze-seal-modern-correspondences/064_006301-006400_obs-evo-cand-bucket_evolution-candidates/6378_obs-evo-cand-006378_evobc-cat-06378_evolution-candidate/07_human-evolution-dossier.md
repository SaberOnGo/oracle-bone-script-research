...
- Project ID: `obs-evo-cand-006378`
- EVOBC category candidate ID: `evobc-evo-cat-06378`
- External category reference: `evobc-cat-06378`
- Source category ID: `06378`
- Source label for human review: `籢`
- Source codepoints: `U+7C62`
...
- `obs-evo-cand-006378-route-category-staging`
...
- `obs-evo-cand-006378-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006378-route-evolution-graph`
