# Material Visual Observation / obs-comp-cand-000805 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000805`
- External reference / 外部参照: `obimd-sub-eadbesllam`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013602_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/eadbesllam/eadbesllam/eadbesllam.png`
- Checksum / 校验和:
  `dc58f1e68e13c5b04942239375f3e9955babf223e2a096bc8501f2c0731cb7c5`
...
- Marked-pixel bounds: (55,37)–(194,214); span 140 × 178 px; the marked
...
- 痕迹范围：(55,37)–(194,214)；跨度140 × 178 px；痕迹矩形高于宽。
