# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006642
...
- EVOBC candidate category: `evobc-evo-cat-06642`.
- Source label for search only: `縪`.
- Source codepoints for search only: `U+7E2A`.
