...
- External category reference: `evobc-cat-07550`
- Source category ID: `07550`
- Source label for human review: `蔑`
...
- `obs-evo-cand-007550-route-category-staging`
...
- `obs-evo-cand-007550-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007550-route-evolution-graph`
