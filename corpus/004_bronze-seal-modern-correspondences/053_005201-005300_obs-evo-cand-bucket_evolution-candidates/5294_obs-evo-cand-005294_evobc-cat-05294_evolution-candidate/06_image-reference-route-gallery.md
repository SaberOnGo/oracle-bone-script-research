...
- `obs-evo-cand-005294-route-category-staging`
...
- `obs-evo-cand-005294-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005294-route-evolution-graph`
