...
- External category reference: `evobc-cat-10754`
- Source category ID: `10754`
- Source label for human review: `龜`
- Source codepoints: `U+9F9C`
...
- `obs-evo-cand-010754-route-category-staging`
...
- `obs-evo-cand-010754-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010754-route-evolution-graph`
