# Material Visual Observation / obs-comp-cand-000771 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000771`
- External reference / 外部参照: `obimd-sub-bh3e3oql61`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013534_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bh3e3oql61/bh3e3oql61/bh3e3oql61.png`
- Checksum / 校验和:
  `215743f8b94728a5daeba32734a41a1f64465f65c600f775338f72df58b33d19`
...
- Marked-pixel bounds: (81,19)–(158,233); span 78 × 215 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.27%。
- 痕迹范围：(81,19)–(158,233)；跨度78 × 215 px；痕迹矩形高于宽。
