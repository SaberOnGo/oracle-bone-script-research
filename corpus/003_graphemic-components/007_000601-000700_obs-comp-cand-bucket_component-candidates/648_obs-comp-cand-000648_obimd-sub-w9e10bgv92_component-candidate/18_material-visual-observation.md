# Material Visual Observation / obs-comp-cand-000648 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000648`
- External reference / 外部参照: `obimd-sub-w9e10bgv92`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013211_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0cyukofrr8/w9e10bgv92/w9e10bgv92.png`
- Checksum / 校验和:
  `1fd75349477f1f8f5a51de77404ef5f4d9aef58dd245d98bf5ec97b8f3d42887`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.58%.
- Marked-pixel bounds: (62,39)–(187,214); span 126 × 176 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.58%。
- 痕迹范围：(62,39)–(187,214)；跨度126 × 176 px；痕迹矩形高于宽。
