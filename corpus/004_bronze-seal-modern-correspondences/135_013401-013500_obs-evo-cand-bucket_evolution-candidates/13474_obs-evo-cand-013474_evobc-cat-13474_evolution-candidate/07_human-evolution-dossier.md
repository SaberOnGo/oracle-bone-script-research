...
- External category reference: `evobc-cat-13474`
- Source category ID: `13474`
- Source label for human review: `𭄁`
...
- `obs-evo-cand-013474-route-category-staging`
...
- `obs-evo-cand-013474-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013474-route-evolution-graph`
