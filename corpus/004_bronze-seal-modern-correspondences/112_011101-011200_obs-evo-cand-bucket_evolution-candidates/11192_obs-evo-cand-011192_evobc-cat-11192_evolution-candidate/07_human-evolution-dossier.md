...
Project ID: `obs-evo-cand-011192`
...
- Project ID: `obs-evo-cand-011192`
- EVOBC category candidate ID: `evobc-evo-cat-11192`
- External category reference: `evobc-cat-11192`
- Source category ID: `11192`
- Source label for human review: `𢑩`
- Source codepoints: `U+22469`
...
- `obs-evo-cand-011192-route-category-staging`
...
- `obs-evo-cand-011192-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011192-route-evolution-graph`
