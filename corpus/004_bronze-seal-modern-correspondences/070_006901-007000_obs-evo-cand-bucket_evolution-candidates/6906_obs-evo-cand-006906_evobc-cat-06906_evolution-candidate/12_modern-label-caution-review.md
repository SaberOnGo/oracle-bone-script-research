# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006906
...
- EVOBC candidate category: `evobc-evo-cat-06906`.
- Source label for search only: `翾`.
- Source codepoints for search only: `U+7FFE`.
