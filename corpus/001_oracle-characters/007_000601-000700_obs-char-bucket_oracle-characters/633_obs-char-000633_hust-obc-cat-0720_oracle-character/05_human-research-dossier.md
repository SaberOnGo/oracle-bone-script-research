# obs-char-000633 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/633_obs-char-000633_hust-obc-cat-0720_orac
  le-character/03_visual-assets/001_asset-000638_hust-obc-cat-0720_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0720/G_0720_上(2).從(甲).10(楚).png
  `
- asset id: `asset-000638`
...
- source category: `0720`
- validation class: `632`
- source image route: `HUST-OBC/deciphered/0720/G_0720_上(2).從(甲).10(楚).png`
- asset id: `asset-000638`
...
- English observation: `A tall left vertical carries several short diagonal
  inner bars and joins a broad angular upper-right loop from which a long
  slanting tail descends.`
- 中文观察: `高长左竖带数条短斜内栏，并连接宽大右上折角环，环下伸出长斜尾笔。`
...
- dataset label text: `㛆`
- dataset label codepoints: `U+36C6`
...
- Which source records identify obs-char-000633 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000633？
