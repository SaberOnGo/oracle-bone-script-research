...
- External category reference: `evobc-cat-13519`
- Source category ID: `13519`
- Source label for human review: `𭚋`
- Source codepoints: `U+2D68B`
...
- `obs-evo-cand-013519-route-category-staging`
...
- `obs-evo-cand-013519-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013519-route-evolution-graph`
