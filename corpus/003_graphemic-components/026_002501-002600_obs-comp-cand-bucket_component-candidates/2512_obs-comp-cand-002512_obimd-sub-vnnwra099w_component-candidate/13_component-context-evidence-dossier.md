# obs-comp-cand-002512 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002512`
- 首选外部 ID: `obimd-sub-vnnwra099w`
- OBIMD subcharacter UID: `vnnwra099w`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+FE401; U+FE402; 另有 2 项
