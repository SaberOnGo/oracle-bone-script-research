...
- External category reference: `evobc-cat-10793`
- Source category ID: `10793`
- Source label for human review: `𠈖`
...
- `obs-evo-cand-010793-route-category-staging`
...
- `obs-evo-cand-010793-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010793-route-evolution-graph`
