# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006244
...
- EVOBC candidate category: `evobc-evo-cat-06244`.
- Source label for search only: `笮`.
- Source codepoints for search only: `U+7B2E`.
