...
- External category reference: `evobc-cat-08432`
- Source category ID: `08432`
- Source label for human review: `该`
- Source codepoints: `U+8BE5`
...
- `obs-evo-cand-008432-route-category-staging`
...
- `obs-evo-cand-008432-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008432-route-evolution-graph`
