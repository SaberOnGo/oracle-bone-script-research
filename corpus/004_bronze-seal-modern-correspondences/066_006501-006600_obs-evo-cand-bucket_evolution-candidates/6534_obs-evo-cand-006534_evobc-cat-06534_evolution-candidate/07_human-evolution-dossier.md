...
- External category reference: `evobc-cat-06534`
- Source category ID: `06534`
- Source label for human review: `綃`
- Source codepoints: `U+7D83`
...
- `obs-evo-cand-006534-route-category-staging`
...
- `obs-evo-cand-006534-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006534-route-evolution-graph`
