# obs-unk-004665 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/065_obs-unk-004665_h
  ust-obc-und-X-004665_oracle-character-candidate/03_visual-assets/001_asset
  -006258_hust-obc-und-X-004665_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/221/X_？_8392_1.png`
- asset id: `asset-006258`
...
- source class: `HUST-OBC/undeciphered/X/221/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/221/X_？_8392_1.png`
- asset id: `asset-006258`
...
- English observation: `forked upper stroke with small opening and right curve`
- 中文观察: `带小开口和右侧弧线的上部叉形笔画`
...
- Which source records identify obs-unk-004665 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004665？
