# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002704
...
- EVOBC candidate category: `evobc-evo-cat-02704`.
- Source label for search only: `幽`.
- Source codepoints for search only: `U+5E7D`.
