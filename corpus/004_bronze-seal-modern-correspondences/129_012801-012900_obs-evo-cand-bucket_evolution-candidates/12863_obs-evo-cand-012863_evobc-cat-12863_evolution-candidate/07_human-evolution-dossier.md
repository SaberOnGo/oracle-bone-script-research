...
Project ID: `obs-evo-cand-012863`
...
- Project ID: `obs-evo-cand-012863`
- EVOBC category candidate ID: `evobc-evo-cat-12863`
- External category reference: `evobc-cat-12863`
- Source category ID: `12863`
- Source label for human review: `𪰔`
- Source codepoints: `U+2AC14`
...
- `obs-evo-cand-012863-route-category-staging`
...
- `obs-evo-cand-012863-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012863-route-evolution-graph`
