# Material Visual Observation / obs-comp-cand-002663 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002663`
- External reference / 外部参照: `obimd-sub-m26yvo17yk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021239_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/m26yvo17yk/m26yvo17yk/m26yvo17yk.png`
- Checksum / 校验和:
  `badec23623b33dc232c51721aff3e15772afb36154ed7f1b5981981e6f8dd16f`
...
- Marked-pixel bounds: (92,16)–(152,231); span 61 × 216 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.89%。
- 痕迹范围：(92,16)–(152,231)；跨度61 × 216 px；痕迹矩形高于宽。
