...
Project ID: `obs-evo-cand-011062`
...
- Project ID: `obs-evo-cand-011062`
- EVOBC category candidate ID: `evobc-evo-cat-11062`
- External category reference: `evobc-cat-11062`
- Source category ID: `11062`
- Source label for human review: `𡧊`
- Source codepoints: `U+219CA`
- Image reference count in source metadata: `56`
...
- `obs-evo-cand-011062-route-category-staging`
...
- `obs-evo-cand-011062-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011062-route-evolution-graph`
