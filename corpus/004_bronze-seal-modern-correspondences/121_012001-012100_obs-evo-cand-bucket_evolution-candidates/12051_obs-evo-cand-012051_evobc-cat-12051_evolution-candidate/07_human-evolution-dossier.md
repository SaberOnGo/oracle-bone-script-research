...
Project ID: `obs-evo-cand-012051`
...
- Project ID: `obs-evo-cand-012051`
- EVOBC category candidate ID: `evobc-evo-cat-12051`
- External category reference: `evobc-cat-12051`
- Source category ID: `12051`
- Source label for human review: `𦝠`
- Source codepoints: `U+26760`
...
- `obs-evo-cand-012051-route-category-staging`
...
- `obs-evo-cand-012051-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012051-route-evolution-graph`
