...
Project ID: `obs-evo-cand-000148`
...
- Project ID: `obs-evo-cand-000148`
- EVOBC category candidate ID: `evobc-evo-cat-00148`
- External category reference: `evobc-cat-00148`
- Source category ID: `00148`
- Source label for human review: `㪔`
- Source codepoints: `U+3A94`
...
- `obs-evo-cand-000148-route-category-staging`
...
- `obs-evo-cand-000148-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000148-route-evolution-graph`
