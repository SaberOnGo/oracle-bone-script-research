...
- External category reference: `evobc-cat-05174`
- Source category ID: `05174`
- Source label for human review: `爟`
- Source codepoints: `U+721F`
...
- `obs-evo-cand-005174-route-category-staging`
...
- `obs-evo-cand-005174-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005174-route-evolution-graph`
