# obs-char-000916 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000916`
- primary external id: `hust-obc-cat-1032`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/916_obs-char-000916_hust-obc-cat-1032_orac
  le-character/03_visual-assets/001_asset-000921_hust-obc-cat-1032_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1032/G_1032_前5.33.4合26631出組.png
  `
- asset id: `asset-000921`
...
- source category: `1032`
- validation class: `915`
- source image route: `HUST-OBC/deciphered/1032/G_1032_前5.33.4合26631出組.png`
- asset id: `asset-000921`
...
- dataset label text: `㟾`
- dataset label codepoints: `U+37FE`
...
- filename catalog route clues: `Heji-like filename clue: 合26631
...
- Which source records identify obs-char-000916 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000916？
