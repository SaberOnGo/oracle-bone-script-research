...
- Project ID: `obs-evo-cand-008146`
- EVOBC category candidate ID: `evobc-evo-cat-08146`
- External category reference: `evobc-cat-08146`
- Source category ID: `08146`
- Source label for human review: `訢`
- Source codepoints: `U+8A22`
...
- `obs-evo-cand-008146-route-category-staging`
...
- `obs-evo-cand-008146-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008146-route-evolution-graph`
