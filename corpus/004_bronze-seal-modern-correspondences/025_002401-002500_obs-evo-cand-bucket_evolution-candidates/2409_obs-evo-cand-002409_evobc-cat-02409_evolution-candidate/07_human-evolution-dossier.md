...
- External category reference: `evobc-cat-02409`
- Source category ID: `02409`
- Source label for human review: `寅`
- Source codepoints: `U+5BC5`
- Image reference count in source metadata: `228`
...
- `obs-evo-cand-002409-route-category-staging`
...
- `obs-evo-cand-002409-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002409-route-evolution-graph`
