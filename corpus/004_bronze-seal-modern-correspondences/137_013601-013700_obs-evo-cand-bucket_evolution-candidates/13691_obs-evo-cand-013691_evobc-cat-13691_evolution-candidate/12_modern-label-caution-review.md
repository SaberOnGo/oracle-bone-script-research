# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013691
...
- EVOBC candidate category: `evobc-evo-cat-13691`.
- Source label for search only: `𮫝`.
- Source codepoints for search only: `U+2EADD`.
