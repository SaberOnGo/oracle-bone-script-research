# obs-char-001121 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1121_obs-char-001121_hust-obc-cat-1252_ora
  cle-character/03_visual-assets/001_asset-001126_hust-obc-cat-1252_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1252/G_1252_乙6672合11498賓組.png`
- asset id: `asset-001126`
...
- source category: `1252`
- validation class: `1120`
- source image route: `HUST-OBC/deciphered/1252/G_1252_乙6672合11498賓組.png`
- asset id: `asset-001126`
...
- dataset label text: `㣚`
- dataset label codepoints: `U+38DA`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00108`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00108`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00108`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/108_obs-evo-can
  d-000108_evobc-cat-00108_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/108_obs-evo-cand-000108_evobc-cat-00108_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合11498
  (G_1252_乙6672合11498賓組.png)`
...
- Which source records identify obs-char-001121 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001121？
