...
- External category reference: `evobc-cat-09616`
- Source category ID: `09616`
- Source label for human review: `開`
...
- `obs-evo-cand-009616-route-category-staging`
...
- `obs-evo-cand-009616-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009616-route-evolution-graph`
