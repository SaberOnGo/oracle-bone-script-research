# obs-char-001033 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1033_obs-char-001033_hust-obc-cat-1158_ora
  cle-character/03_visual-assets/001_asset-001038_hust-obc-cat-1158_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1158/G_1158_前5.31.3(甲).png`
- asset id: `asset-001038`
...
- source category: `1158`
- validation class: `1032`
- source image route: `HUST-OBC/deciphered/1158/G_1158_前5.31.3(甲).png`
- asset id: `asset-001038`
...
- English observation: `A narrow branching cluster has pointed upper
  projections, a small central enclosure, and a long lower loop-like
  stroke.`
- 中文观察: `狭长分枝笔群有尖状上部外伸、小型中央闭合笔和长下部环状弯笔。`
...
- dataset label text: `㡼`
- dataset label codepoints: `U+387C`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/095_obs-evo-can
  d-000095_evobc-cat-00095_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/095_obs-evo-cand-000095_evobc-cat-00095_evolu
...
- Which source records identify obs-char-001033 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001033？
