...
- `obs-evo-cand-000396-route-category-staging`
...
- `obs-evo-cand-000396-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000396-route-evolution-graph`
