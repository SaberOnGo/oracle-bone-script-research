# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008900
...
- EVOBC candidate category: `evobc-evo-cat-08900`.
- Source label for search only: `辍`.
- Source codepoints for search only: `U+8F8D`.
