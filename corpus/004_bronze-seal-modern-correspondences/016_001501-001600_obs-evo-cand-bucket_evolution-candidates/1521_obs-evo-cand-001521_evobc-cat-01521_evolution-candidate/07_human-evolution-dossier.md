...
- External category reference: `evobc-cat-01521`
- Source category ID: `01521`
- Source label for human review: `吷`
- Source codepoints: `U+5437`
...
- `obs-evo-cand-001521-route-category-staging`
...
- `obs-evo-cand-001521-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001521-route-evolution-graph`
