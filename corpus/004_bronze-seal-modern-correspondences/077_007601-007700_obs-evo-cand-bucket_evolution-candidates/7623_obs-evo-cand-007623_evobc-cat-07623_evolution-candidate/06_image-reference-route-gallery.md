...
- `obs-evo-cand-007623-route-category-staging`
...
- `obs-evo-cand-007623-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007623-route-evolution-graph`
