# Material Visual Observation / obs-comp-cand-001906 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001906`
- External reference / 外部参照: `obimd-sub-vha0ssegay`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018316_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vha0ssegay/vha0ssegay/vha0ssegay.png`
- Checksum / 校验和:
  `338b6db6b478d2e59a28cedd7bf9b811a43865701e10afc6004f08a650ef1f3f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.87%.
- Marked-pixel bounds: (40,26)–(208,223); span 169 × 198 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.87%。
- 痕迹范围：(40,26)–(208,223)；跨度169 × 198 px；痕迹矩形近方形。
