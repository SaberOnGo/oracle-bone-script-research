# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008124
...
- EVOBC candidate category: `evobc-evo-cat-08124`.
- Source label for search only: `訅`.
- Source codepoints for search only: `U+8A05`.
