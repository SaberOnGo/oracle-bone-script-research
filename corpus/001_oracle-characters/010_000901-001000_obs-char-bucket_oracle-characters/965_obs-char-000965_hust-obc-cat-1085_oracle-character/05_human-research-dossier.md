# obs-char-000965 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000965`
- primary external id: `hust-obc-cat-1085`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/965_obs-char-000965_hust-obc-cat-1085_orac
  le-character/03_visual-assets/001_asset-000970_hust-obc-cat-1085_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1085/G_1085_乙152合20364𠂤組.png`
- asset id: `asset-000970`
...
- source category: `1085`
- validation class: `964`
- source image route: `HUST-OBC/deciphered/1085/G_1085_乙152合20364𠂤組.png`
- asset id: `asset-000970`
...
- English observation: `A rounded lower enclosure supports a pointed
  oval-like upper form, with a thick open base.`
- 中文观察: `圆弧下部闭合轮廓承托尖形椭圆状上部形体，并有粗重开放底笔。`
...
- dataset label text: `㠳`
- dataset label codepoints: `U+3833`
...
- filename catalog route clues: `Heji-like filename clue: 合20364
  (G_1085_乙152合20364𠂤組.png)`
...
- Which source records identify obs-char-000965 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000965？
