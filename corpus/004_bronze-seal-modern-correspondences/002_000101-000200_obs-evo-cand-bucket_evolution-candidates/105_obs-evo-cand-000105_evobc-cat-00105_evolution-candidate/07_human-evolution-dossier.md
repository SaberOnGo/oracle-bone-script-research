...
- External category reference: `evobc-cat-00105`
- Source category ID: `00105`
- Source label for human review: `㣇`
- Source codepoints: `U+38C7`
...
- `obs-evo-cand-000105-route-category-staging`
...
- `obs-evo-cand-000105-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000105-route-evolution-graph`
