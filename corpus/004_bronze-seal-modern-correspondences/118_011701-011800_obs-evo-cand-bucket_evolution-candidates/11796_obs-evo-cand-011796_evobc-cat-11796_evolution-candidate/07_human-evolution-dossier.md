...
- Project ID: `obs-evo-cand-011796`
- EVOBC category candidate ID: `evobc-evo-cat-11796`
- External category reference: `evobc-cat-11796`
- Source category ID: `11796`
- Source label for human review: `𥏫`
- Source codepoints: `U+253EB`
...
- `obs-evo-cand-011796-route-category-staging`
...
- `obs-evo-cand-011796-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011796-route-evolution-graph`
