...
Project ID: `obs-evo-cand-009555`
...
- Project ID: `obs-evo-cand-009555`
- EVOBC category candidate ID: `evobc-evo-cat-09555`
- External category reference: `evobc-cat-09555`
- Source category ID: `09555`
- Source label for human review: `鑱`
- Source codepoints: `U+9471`
...
- `obs-evo-cand-009555-route-category-staging`
...
- `obs-evo-cand-009555-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009555-route-evolution-graph`
