# obs-evo-cand-001216 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-01216`
- Source label: `則`
- Source codepoints: `U+5247`
- Image reference count: `348`
- Era token counts: `BI:61;CS:2;OBC:3;SAC:14;SS:4;WSC:264`
- Source token counts: `Book:76;Web:272`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 3 image references
- era 1 / BI: 61 image references
- era 2 / SS: 4 image references
- era 3 / SAC: 14 image references
- era 4 / WSC: 264 image references
- era 5 / CS: 2 image references
- source 1 / Web:105952;說文Web:58: 272 image references
