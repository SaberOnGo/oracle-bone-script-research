...
- `obs-evo-cand-012658-route-category-staging`
...
- `obs-evo-cand-012658-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012658-route-evolution-graph`
