...
- External category reference: `evobc-cat-03970`
- Source category ID: `03970`
- Source label for human review: `柫`
- Source codepoints: `U+67EB`
...
- `obs-evo-cand-003970-route-category-staging`
...
- `obs-evo-cand-003970-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003970-route-evolution-graph`
