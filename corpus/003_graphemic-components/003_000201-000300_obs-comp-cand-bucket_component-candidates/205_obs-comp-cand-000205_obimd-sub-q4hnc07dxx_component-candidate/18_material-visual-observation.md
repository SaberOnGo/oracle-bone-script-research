# Material Visual Observation / obs-comp-cand-000205 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000205`
- External reference / 外部参照: `obimd-sub-q4hnc07dxx`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011766_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h44zkm9mt8/q4hnc07dxx/q4hnc07dxx.png`
- Checksum / 校验和:
  `9f5fb5728bd6981f647ffc84d4ddd553ed1ff99cb8ba4de09ccb523b7be82cba`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.72%.
- Marked-pixel bounds: (55,51)–(194,197); span 140 × 147 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.72%。
- 痕迹范围：(55,51)–(194,197)；跨度140 × 147 px；痕迹矩形近方形。
