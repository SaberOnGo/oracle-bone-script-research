# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002282
...
| --- | --- | --- | --- |
| `obimd-glyph-link-035259` | 򼔓󽇞 | `U+BC513;U+FD1DE` | `reviewed_metadata_only` |
| `obimd-glyph-link-035260` | 󽇟 | `U+FD1DF` | `reviewed_metadata_only` |
