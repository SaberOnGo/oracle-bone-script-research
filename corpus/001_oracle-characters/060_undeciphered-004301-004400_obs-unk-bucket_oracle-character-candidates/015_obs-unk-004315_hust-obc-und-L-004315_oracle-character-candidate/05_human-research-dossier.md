# obs-unk-004315 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004315`
- primary external id: `hust-obc-und-L-004315`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/015_obs-unk-004315_h
  ust-obc-und-L-004315_oracle-character-candidate/03_visual-assets/001_asset
  -005908_hust-obc-und-L-004315_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4315/L_？_9513.jpg`
- asset id: `asset-005908`
...
- source class: `HUST-OBC/undeciphered/L/4315/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4315/L_？_9513.jpg`
- asset id: `asset-005908`
...
- English observation: `Bent upper trace and several descending
  lower strokes recorded.`
- 中文观察: `已记录上部弯痕和数条向下延伸的下部笔痕。`
...
- Which source records identify obs-unk-004315 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004315？
