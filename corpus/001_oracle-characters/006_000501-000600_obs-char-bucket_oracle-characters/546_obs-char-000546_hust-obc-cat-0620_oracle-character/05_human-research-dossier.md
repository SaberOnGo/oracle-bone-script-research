# obs-char-000546 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000546`
- primary external id: `hust-obc-cat-0620`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/546_obs-char-000546_hust-obc-cat-0620_orac
  le-character/03_visual-assets/001_asset-000551_hust-obc-cat-0620_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0620/G_0620_前2.27.5合37473黃組.png
  `
- asset id: `asset-000551`
...
- source category: `0620`
- validation class: `545`
- source image route: `HUST-OBC/deciphered/0620/G_0620_前2.27.5合37473黃組.png`
- asset id: `asset-000551`
...
- English observation: `A single long tapered vertical is crossed near the
  middle by a horizontal bar and has one short diagonal branch rising to the
  upper right.`
...
- dataset label text: `㙢`
- dataset label codepoints: `U+3662`
...
- filename catalog route clues: `Heji-like filename clue: 合37473
  (G_0620_前2.27.5合37473黃組.png)`
...
- Which source records identify obs-char-000546 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000546？
