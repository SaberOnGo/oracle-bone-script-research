...
- External category reference: `evobc-cat-09994`
- Source category ID: `09994`
- Source label for human review: `頦`
...
- `obs-evo-cand-009994-route-category-staging`
...
- `obs-evo-cand-009994-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009994-route-evolution-graph`
