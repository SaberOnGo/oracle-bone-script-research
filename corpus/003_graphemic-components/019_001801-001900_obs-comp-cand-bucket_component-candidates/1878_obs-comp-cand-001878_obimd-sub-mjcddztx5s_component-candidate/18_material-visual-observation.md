# Material Visual Observation / obs-comp-cand-001878 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001878`
- External reference / 外部参照: `obimd-sub-mjcddztx5s`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018257_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2ao64scs41/mjcddztx5s/mjcddztx5s.png`
- Checksum / 校验和:
  `f02db9f13f9ecb6b1c14743f4ebe561843e296b0407947573ddca479771c0baf`
...
- Marked-pixel bounds: (51,28)–(208,216); span 158 × 189 px; the marked
...
- 痕迹范围：(51,28)–(208,216)；跨度158 × 189 px；痕迹矩形近方形。
