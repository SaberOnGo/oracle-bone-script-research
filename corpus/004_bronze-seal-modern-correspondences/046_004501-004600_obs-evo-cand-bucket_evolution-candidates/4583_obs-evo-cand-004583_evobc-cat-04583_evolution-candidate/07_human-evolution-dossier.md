...
- External category reference: `evobc-cat-04583`
- Source category ID: `04583`
- Source label for human review: `泗`
...
- `obs-evo-cand-004583-route-category-staging`
...
- `obs-evo-cand-004583-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004583-route-evolution-graph`
