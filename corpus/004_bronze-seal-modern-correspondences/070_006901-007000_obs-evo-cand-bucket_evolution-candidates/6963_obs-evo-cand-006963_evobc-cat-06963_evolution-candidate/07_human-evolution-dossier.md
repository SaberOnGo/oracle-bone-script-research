...
Project ID: `obs-evo-cand-006963`
...
- Project ID: `obs-evo-cand-006963`
- EVOBC category candidate ID: `evobc-evo-cat-06963`
- External category reference: `evobc-cat-06963`
- Source category ID: `06963`
- Source label for human review: `職`
- Source codepoints: `U+8077`
...
- `obs-evo-cand-006963-route-category-staging`
...
- `obs-evo-cand-006963-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006963-route-evolution-graph`
