...
- External category reference: `evobc-cat-03117`
- Source category ID: `03117`
- Source label for human review: `慘`
...
- `obs-evo-cand-003117-route-category-staging`
...
- `obs-evo-cand-003117-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003117-route-evolution-graph`
