# obs-char-000140 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/140_obs-char-000140_hust-obc-cat-0155_orac
  le-character/03_visual-assets/001_asset-000145_hust-obc-cat-0155_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0155/L_0155_6144.jpg`
- asset id: `asset-000145`
...
- source category: `0155`
- validation class: `139`
- source image route: `HUST-OBC/deciphered/0155/L_0155_6144.jpg`
- asset id: `asset-000145`
...
- English observation: `The low-resolution gray image has a small horizontal
  upper enclosure and a thin central stroke descending below it with a short
  side mark.`
- 中文观察: `低分辨率灰度图像上方有小型横向围合痕迹，下方有细直主笔，并带短侧向痕迹。`
...
- dataset label text: `㒑`
- dataset label codepoints: `U+3491`
...
- Which source records identify obs-char-000140 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000140？
