...
- External category reference: `evobc-cat-00876`
- Source category ID: `00876`
- Source label for human review: `俆`
...
- `obs-evo-cand-000876-route-category-staging`
...
- `obs-evo-cand-000876-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000876-route-evolution-graph`
