# obs-unk-003950 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/050_obs-unk-003950_h
  ust-obc-und-L-003950_oracle-character-candidate/03_visual-assets/001_asset
  -005543_hust-obc-und-L-003950_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3950/L_？_8336.jpg`
- asset id: `asset-005543`
...
- source class: `HUST-OBC/undeciphered/L/3950/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3950/L_？_8336.jpg`
- asset id: `asset-005543`
...
- English observation: Two slanting traces cross above a broad rounded or
  diamond-like lower outline with a narrow opening.
- 中文观察: 上方两条斜向痕迹相交，下方有带狭窄开口的宽圆弧或菱状轮廓。
...
- Which source records identify obs-unk-003950 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003950？
