# Material Visual Observation / obs-comp-cand-002229 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002229`
- External reference / 外部参照: `obimd-sub-ve0ebxq620`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020042_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ve0ebxq620/ve0ebxq620/ve0ebxq620.png`
- Checksum / 校验和:
  `8505f1eea7af37237e7b34857f108147833a27399927d7b33ea11ee1a9c86732`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.87%.
- Marked-pixel bounds: (43,20)–(189,227); span 147 × 208 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.87%。
- 痕迹范围：(43,20)–(189,227)；跨度147 × 208 px；痕迹矩形高于宽。
