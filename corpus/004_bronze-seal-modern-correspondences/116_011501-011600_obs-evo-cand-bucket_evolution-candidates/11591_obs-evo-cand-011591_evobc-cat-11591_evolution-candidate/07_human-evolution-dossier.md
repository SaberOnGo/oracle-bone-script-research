...
- External category reference: `evobc-cat-11591`
- Source category ID: `11591`
- Source label: `𤖺`
...
- `obs-evo-cand-011591-route-category-staging`
...
- `obs-evo-cand-011591-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011591-route-evolution-graph`
