...
Project ID: `obs-evo-cand-004874`
...
- Project ID: `obs-evo-cand-004874`
- EVOBC category candidate ID: `evobc-evo-cat-04874`
- External category reference: `evobc-cat-04874`
- Source category ID: `04874`
- Source label for human review: `漢`
- Source codepoints: `U+6F22`
...
- `obs-evo-cand-004874-route-category-staging`
...
- `obs-evo-cand-004874-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004874-route-evolution-graph`
