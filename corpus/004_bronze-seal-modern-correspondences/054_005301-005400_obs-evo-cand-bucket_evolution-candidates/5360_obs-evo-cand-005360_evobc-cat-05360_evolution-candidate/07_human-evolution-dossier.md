...
- External category reference: `evobc-cat-05360`
- Source category ID: `05360`
- Source label for human review: `玫`
- Source codepoints: `U+73AB`
...
- `obs-evo-cand-005360-route-category-staging`
...
- `obs-evo-cand-005360-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005360-route-evolution-graph`
