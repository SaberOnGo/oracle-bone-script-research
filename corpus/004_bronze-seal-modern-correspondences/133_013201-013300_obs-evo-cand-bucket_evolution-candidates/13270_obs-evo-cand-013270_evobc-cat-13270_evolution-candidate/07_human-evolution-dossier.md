...
- Project ID: `obs-evo-cand-013270`
- EVOBC category candidate ID: `evobc-evo-cat-13270`
- External category reference: `evobc-cat-13270`
- Source category ID: `13270`
- Source label for human review: `𬓚`
- Source codepoints: `U+2C4DA`
...
- `obs-evo-cand-013270-route-category-staging`
...
- `obs-evo-cand-013270-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013270-route-evolution-graph`
