...
- External category reference: `evobc-cat-00364`
- Source category ID: `00364`
- Source label for human review: `䐣`
- Source codepoints: `U+4423`
...
- `obs-evo-cand-000364-route-category-staging`
...
- `obs-evo-cand-000364-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000364-route-evolution-graph`
