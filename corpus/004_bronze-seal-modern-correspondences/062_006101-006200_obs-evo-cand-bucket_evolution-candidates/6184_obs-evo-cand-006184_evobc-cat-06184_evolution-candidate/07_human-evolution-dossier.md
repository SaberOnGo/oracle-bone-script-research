...
Project ID: `obs-evo-cand-006184`
...
- Project ID: `obs-evo-cand-006184`
- EVOBC category candidate ID: `evobc-evo-cat-06184`
- External category reference: `evobc-cat-06184`
- Source category ID: `06184`
- Source label for human review: `窶`
- Source codepoints: `U+7AB6`
...
- `obs-evo-cand-006184-route-category-staging`
...
- `obs-evo-cand-006184-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006184-route-evolution-graph`
