# obs-char-000002 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/002_obs-char-000002_hust-obc-cat-0002_orac
  le-character/03_visual-assets/001_asset-000007_hust-obc-cat-0002_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0002/G_0002_京津2120合4366賓組.png`
- asset id: `asset-000007`
...
- source category: `0002`
- validation class: `1`
- source image route: `HUST-OBC/deciphered/0002/G_0002_京津2120合4366賓組.png`
- asset id: `asset-000007`
...
- English observation: `The image shows an open angular form, a long upper
  stroke, a curved right-side loop, and two short lower projections.`
- 中文观察: `图像呈开放的折角形，上方有长横向笔画，右侧有弯曲环状部分，下面有两处短伸出。`
...
- dataset label text: `⺄`
- dataset label codepoints: `U+2E84`
...
- filename catalog route clues: `Heji-like filename clue: 合4366
...
- Which source records identify obs-char-000002 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000002？
