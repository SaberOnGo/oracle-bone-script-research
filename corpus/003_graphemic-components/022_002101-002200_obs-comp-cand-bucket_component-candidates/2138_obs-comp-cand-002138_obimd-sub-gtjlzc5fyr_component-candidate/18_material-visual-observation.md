# Material Visual Observation / obs-comp-cand-002138 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002138`
- External reference / 外部参照: `obimd-sub-gtjlzc5fyr`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019695_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gtjlzc5fyr/gtjlzc5fyr/gtjlzc5fyr.png`
- Checksum / 校验和:
  `602b93bd0fdfaf62c7fe6b3295b77e5a646b4d825dc0c0d29d1ede1bcdcc1fe3`
...
- Marked-pixel bounds: (79,20)–(148,227); span 70 × 208 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.70%。
- 痕迹范围：(79,20)–(148,227)；跨度70 × 208 px；痕迹矩形高于宽。
