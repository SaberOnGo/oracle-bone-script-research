# obs-unk-004610 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004610`
- primary external id: `hust-obc-und-X-004610`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/010_obs-unk-004610_h
  ust-obc-und-X-004610_oracle-character-candidate/03_visual-assets/001_asset
  -006203_hust-obc-und-X-004610_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/166/X_？_8342_1.png`
- asset id: `asset-006203`
...
- source class: `HUST-OBC/undeciphered/X/166/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/166/X_？_8342_1.png`
- asset id: `asset-006203`
...
- English observation: `curved contour, inner vertical trace, lower hook`
- 中文观察: `弯曲轮廓、内部竖痕和下部钩端已记录。`
...
- Which source records identify obs-unk-004610 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004610？
