...
Project ID: `obs-evo-cand-012633`
...
- Project ID: `obs-evo-cand-012633`
- EVOBC category candidate ID: `evobc-evo-cat-12633`
- External category reference: `evobc-cat-12633`
- Source category ID: `12633`
- Source label for human review: `𩜏`
- Source codepoints: `U+2970F`
...
- `obs-evo-cand-012633-route-category-staging`
...
- `obs-evo-cand-012633-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012633-route-evolution-graph`
