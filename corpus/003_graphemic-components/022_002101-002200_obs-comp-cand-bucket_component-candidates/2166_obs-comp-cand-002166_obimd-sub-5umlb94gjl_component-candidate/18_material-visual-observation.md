# Material Visual Observation / obs-comp-cand-002166 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002166`
- External reference / 外部参照: `obimd-sub-5umlb94gjl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019867_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/u3lh7tekno/5umlb94gjl/5umlb94gjl.png`
- Checksum / 校验和:
  `5c81581cc32ad9becaa0cf11645821f40fdff7b2e4d0ea24e32156869078056b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.04%.
- Marked-pixel bounds: (88,27)–(161,218); span 74 × 192 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.04%。
- 痕迹范围：(88,27)–(161,218)；跨度74 × 192 px；痕迹矩形高于宽。
