...
- External category reference: `evobc-cat-00341`
- Source category ID: `00341`
- Source label for human review: `䍄`
...
- `obs-evo-cand-000341-route-category-staging`
...
- `obs-evo-cand-000341-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000341-route-evolution-graph`
