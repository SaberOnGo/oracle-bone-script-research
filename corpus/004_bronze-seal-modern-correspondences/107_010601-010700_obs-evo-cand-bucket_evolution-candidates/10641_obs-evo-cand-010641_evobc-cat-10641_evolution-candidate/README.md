# obs-evo-cand-010641 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-010641`
- EVOBC category candidate ID: `evobc-evo-cat-10641`
- External category ref: `evobc-cat-10641`
- Source label: `黑`
- Source codepoints: `U+9ED1`
- Image reference count: `77`
- Era token counts: `BI:10;CS:1;OBC:44;SAC:3;SS:2;WSC:17`
- Source token counts: `Book:28;Web:49`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 44 image references
- era 1 / BI: 10 image references
