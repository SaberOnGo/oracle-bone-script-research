# obs-unk-004296 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004296`
- primary external id: `hust-obc-und-L-004296`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/096_obs-unk-004296_h
  ust-obc-und-L-004296_oracle-character-candidate/03_visual-assets/001_asset
  -005889_hust-obc-und-L-004296_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4296/L_？_9485.jpg`
- asset id: `asset-005889`
...
- source class: `HUST-OBC/undeciphered/L/4296/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4296/L_？_9485.jpg`
- asset id: `asset-005889`
...
- English observation: `Open upper cluster, long diagonal, lower split visible.`
- 中文观察: `开放上部痕迹组、长斜痕和下部断开处可见。`
...
- Which source records identify obs-unk-004296 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004296？
