# Material Visual Observation / obs-comp-cand-000109 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000109`
- External reference / 外部参照: `obimd-sub-4qzyneuyru`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011521_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xjnn5c8ctk/4qzyneuyru/4qzyneuyru.png`
- Checksum / 校验和:
  `c9e54e3f1502977c1a36c44cdd18f77af8395adcf99c3248fc67e8df799d33ac`
...
- Marked-pixel bounds: (61,43)–(188,211); span 128 × 169 px; the marked
...
- 痕迹范围：(61,43)–(188,211)；跨度128 × 169 px；痕迹矩形高于宽。
