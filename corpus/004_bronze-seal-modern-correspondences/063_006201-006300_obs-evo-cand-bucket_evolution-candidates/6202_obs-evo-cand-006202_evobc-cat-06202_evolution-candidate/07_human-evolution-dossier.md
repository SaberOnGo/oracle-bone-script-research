...
- External category reference: `evobc-cat-06202`
- Source category ID: `06202`
- Source label for human review: `竟`
- Source codepoints: `U+7ADF`
...
- `obs-evo-cand-006202-route-category-staging`
...
- `obs-evo-cand-006202-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006202-route-evolution-graph`
