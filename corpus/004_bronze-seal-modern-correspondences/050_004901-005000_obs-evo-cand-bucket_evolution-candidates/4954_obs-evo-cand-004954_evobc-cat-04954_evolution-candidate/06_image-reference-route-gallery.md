...
- `obs-evo-cand-004954-route-category-staging`
...
- `obs-evo-cand-004954-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004954-route-evolution-graph`
