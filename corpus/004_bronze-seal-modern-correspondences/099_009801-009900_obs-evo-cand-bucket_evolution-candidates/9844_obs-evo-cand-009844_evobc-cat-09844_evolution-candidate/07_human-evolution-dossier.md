...
- External category reference: `evobc-cat-09844`
- Source category ID: `09844`
- Source label for human review: `電`
...
- `obs-evo-cand-009844-route-category-staging`
...
- `obs-evo-cand-009844-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009844-route-evolution-graph`
