...
- External category reference: `evobc-cat-00265`
- Source category ID: `00265`
- Source label for human review: `㾸`
- Source codepoints: `U+3FB8`
...
- `obs-evo-cand-000265-route-category-staging`
...
- `obs-evo-cand-000265-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000265-route-evolution-graph`
