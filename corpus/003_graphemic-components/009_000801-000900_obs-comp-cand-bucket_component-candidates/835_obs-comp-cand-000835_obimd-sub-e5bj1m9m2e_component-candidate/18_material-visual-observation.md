# Material Visual Observation / obs-comp-cand-000835 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000835`
- External reference / 外部参照: `obimd-sub-e5bj1m9m2e`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013706_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/e5bj1m9m2e/e5bj1m9m2e/e5bj1m9m2e.png`
- Checksum / 校验和:
  `2b1e655d602b1f59282ecb8d9f8ba97d0b72f687b14f2c722e2c3a49ea44ce2d`
...
- Marked-pixel bounds: (86,26)–(168,226); span 83 × 201 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.09%。
- 痕迹范围：(86,26)–(168,226)；跨度83 × 201 px；痕迹矩形高于宽。
