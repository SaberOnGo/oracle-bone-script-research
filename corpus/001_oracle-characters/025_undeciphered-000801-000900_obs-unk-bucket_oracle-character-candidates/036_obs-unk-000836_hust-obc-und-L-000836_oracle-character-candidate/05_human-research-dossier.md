# obs-unk-000836 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000836`
- primary external id: `hust-obc-und-L-000836`
...
- local review image route: `corpus/001_oracle-characters/025_undeciphered-000
  801-000900_obs-unk-bucket_oracle-character-candidates/036_obs-unk-000836_h
  ust-obc-und-L-000836_oracle-character-candidate/03_visual-assets/001_asset
  -002429_hust-obc-und-L-000836_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/836/L_？_1241.jpg`
- asset id: `asset-002429`
...
- source class: `HUST-OBC/undeciphered/L/836/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/836/L_？_1241.jpg`
- asset id: `asset-002429`
...
- Which source records identify obs-unk-000836 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000836？
