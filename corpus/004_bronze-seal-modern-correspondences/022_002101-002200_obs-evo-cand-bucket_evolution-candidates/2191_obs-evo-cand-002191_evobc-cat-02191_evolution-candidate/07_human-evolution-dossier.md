...
Project ID: `obs-evo-cand-002191`
...
- Project ID: `obs-evo-cand-002191`
- EVOBC category candidate ID: `evobc-evo-cat-02191`
- External category reference: `evobc-cat-02191`
- Source category ID: `02191`
- Source label for human review: `婌`
- Source codepoints: `U+5A4C`
...
- `obs-evo-cand-002191-route-category-staging`
...
- `obs-evo-cand-002191-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002191-route-evolution-graph`
