...
- External category reference: `evobc-cat-12173`
- Source category ID: `12173`
- Source label for human review: `𧕢`
...
- `obs-evo-cand-012173-route-category-staging`
...
- `obs-evo-cand-012173-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012173-route-evolution-graph`
