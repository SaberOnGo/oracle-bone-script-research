# obs-comp-cand-002653 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002653`
- 首选外部 ID: `obimd-sub-qbd1goytzz`
- OBIMD subcharacter UID: `qbd1goytzz`
- OBIMD main character UID: `qbd1goytzz`
- 来源 ID: `src-obimd`
...
- codepoint 示例: U+FEF48; U+FEF49; 另有 11 项
