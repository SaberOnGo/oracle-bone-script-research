...
- External category reference: `evobc-cat-08506`
- Source category ID: `08506`
- Source label for human review: `豵`
- Source codepoints: `U+8C75`
...
- `obs-evo-cand-008506-route-category-staging`
...
- `obs-evo-cand-008506-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008506-route-evolution-graph`
