# Material Visual Observation / obs-comp-cand-000128 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000128`
- External reference / 外部参照: `obimd-sub-m87lblai6p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011540_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/m87lblai6p/m87lblai6p/m87lblai6p.png`
- Checksum / 校验和:
  `3ba944799f385ca096aafc468ec66f45eca7d70ef40f75be4c45b82d50033a24`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.46%.
- Marked-pixel bounds: (50,35)–(198,211); span 149 × 177 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.46%。
- 痕迹范围：(50,35)–(198,211)；跨度149 × 177 px；痕迹矩形近方形。
