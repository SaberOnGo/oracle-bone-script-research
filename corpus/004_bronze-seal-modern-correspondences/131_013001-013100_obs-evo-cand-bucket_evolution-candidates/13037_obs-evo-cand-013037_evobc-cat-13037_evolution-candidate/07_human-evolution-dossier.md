...
- External category reference: `evobc-cat-13037`
- Source category ID: `13037`
- Source label for human review: `𫧺`
- Source codepoints: `U+2B9FA`
...
- `obs-evo-cand-013037-route-category-staging`
...
- `obs-evo-cand-013037-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013037-route-evolution-graph`
