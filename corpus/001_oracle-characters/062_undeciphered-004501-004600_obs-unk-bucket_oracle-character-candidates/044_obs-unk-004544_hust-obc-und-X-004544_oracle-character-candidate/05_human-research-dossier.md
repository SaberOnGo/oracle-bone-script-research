# obs-unk-004544 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004544`
- primary external id: `hust-obc-und-X-004544`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/044_obs-unk-004544_h
  ust-obc-und-X-004544_oracle-character-candidate/03_visual-assets/001_asset
  -006137_hust-obc-und-X-004544_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/100/X_？_8283_1.png`
- asset id: `asset-006137`
...
- source class: `HUST-OBC/undeciphered/X/100/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/100/X_？_8283_1.png`
- asset id: `asset-006137`
...
- English observation: `Outline, middle band, and lower points recorded.`
- 中文观察: `已记录封闭轮廓、中部横带和下部尖点。`
...
- Which source records identify obs-unk-004544 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004544？
