...
- External category reference: `evobc-cat-11225`
- Source category ID: `11225`
- Source label for human review: `𢘫`
...
- `obs-evo-cand-011225-route-category-staging`
...
- `obs-evo-cand-011225-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011225-route-evolution-graph`
