# Material Visual Observation / obs-comp-cand-001053 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001053`
- External reference / 外部参照: `obimd-sub-dnmwbqd36a`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014603_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dnmwbqd36a/dnmwbqd36a/dnmwbqd36a.png`
- Checksum / 校验和:
  `28e98a2668314ed85875b661cd15879e4c900d0b636c906cb6a89192b1d8645b`
...
- Marked-pixel bounds: (95,24)–(165,224); span 71 × 201 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.03%。
- 痕迹范围：(95,24)–(165,224)；跨度71 × 201 px；痕迹矩形高于宽。
