...
- External category reference: `evobc-cat-01804`
- Source category ID: `01804`
- Source label for human review: `坁`
- Source codepoints: `U+5741`
...
- `obs-evo-cand-001804-route-category-staging`
...
- `obs-evo-cand-001804-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001804-route-evolution-graph`
