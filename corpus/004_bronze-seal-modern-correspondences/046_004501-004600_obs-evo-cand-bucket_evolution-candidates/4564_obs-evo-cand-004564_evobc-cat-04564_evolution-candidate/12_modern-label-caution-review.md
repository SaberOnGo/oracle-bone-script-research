# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004564
...
- EVOBC candidate category: `evobc-evo-cat-04564`.
- Source label for search only: `沽`.
- Source codepoints for search only: `U+6CBD`.
