# obs-unk-004010 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/010_obs-unk-004010_h
  ust-obc-und-L-004010_oracle-character-candidate/03_visual-assets/001_asset
  -005603_hust-obc-und-L-004010_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4010/L_？_851.jpg`
- asset id: `asset-005603`
...
- source class: `HUST-OBC/undeciphered/L/4010/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4010/L_？_851.jpg`
- asset id: `asset-005603`
...
- English observation: A pointed upper outline contains a narrow central mark;
  several thin strokes hang below it.
- 中文观察：尖状上部轮廓内有窄的中部痕迹，下方悬有数条细痕迹。
...
- Which source records identify obs-unk-004010 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004010？
