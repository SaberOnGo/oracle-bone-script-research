# obs-char-001086 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001086`
- primary external id: `hust-obc-cat-1215`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1086_obs-char-001086_hust-obc-cat-1215_ora
  cle-character/03_visual-assets/001_asset-001091_hust-obc-cat-1215_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1215/H_1215_60486_0.png`
- asset id: `asset-001091`
...
- source category: `1215`
- validation class: `1085`
- source image route: `HUST-OBC/deciphered/1215/H_1215_60486_0.png`
- asset id: `asset-001091`
...
- English observation: `A large dark left form has a rounded upper curve and
  long lower strokes, beside a separate tall angular stroke on the right.`
- 中文观察: `大型深色左侧形体有圆弧上部弯笔和长下部笔，右侧另有分离的高而棱角直立笔。`
...
- dataset label text: `㢵`
- dataset label codepoints: `U+38B5`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00101`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00101`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00101`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/101_obs-evo-can
  d-000101_evobc-cat-00101_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/101_obs-evo-cand-000101_evobc-cat-00101_evolu
...
- filename catalog route clues: `catalog-like filename clue: H_1215
  (H_1215_60486_0.png)`
...
- Which source records identify obs-char-001086 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001086？
