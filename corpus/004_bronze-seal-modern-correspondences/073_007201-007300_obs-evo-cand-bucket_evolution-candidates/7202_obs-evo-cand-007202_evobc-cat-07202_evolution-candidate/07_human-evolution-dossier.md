...
- External category reference: `evobc-cat-07202`
- Source category ID: `07202`
- Source label for human review: `般`
- Source codepoints: `U+822C`
- Image reference count in source metadata: `232`
...
- `obs-evo-cand-007202-route-category-staging`
...
- `obs-evo-cand-007202-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007202-route-evolution-graph`
