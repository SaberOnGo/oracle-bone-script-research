...
- External category reference: `evobc-cat-05373`
- Source category ID: `05373`
- Source label for human review: `珌`
- Source codepoints: `U+73CC`
...
- `obs-evo-cand-005373-route-category-staging`
...
- `obs-evo-cand-005373-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005373-route-evolution-graph`
