...
- `obs-evo-cand-007643-route-category-staging`
...
- `obs-evo-cand-007643-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007643-route-evolution-graph`
