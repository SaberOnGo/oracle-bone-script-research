# obs-char-000696 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/696_obs-char-000696_hust-obc-cat-0790_orac
  le-character/03_visual-assets/001_asset-000701_hust-obc-cat-0790_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0790/G_0790_佚600合19569.png`
- asset id: `asset-000701`
...
- source category: `0790`
- validation class: `695`
- source image route: `HUST-OBC/deciphered/0790/G_0790_佚600合19569.png`
- asset id: `asset-000701`
...
- English observation: `A rounded lower rectangular outline with a short
  inner horizontal supports two detached upright stems, each ending above in
  a small fork.`
...
- dataset label text: `㜌`
- dataset label codepoints: `U+370C`
...
- filename catalog route clues: `Heji-like filename clue: 合19569
...
- Which source records identify obs-char-000696 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000696？
