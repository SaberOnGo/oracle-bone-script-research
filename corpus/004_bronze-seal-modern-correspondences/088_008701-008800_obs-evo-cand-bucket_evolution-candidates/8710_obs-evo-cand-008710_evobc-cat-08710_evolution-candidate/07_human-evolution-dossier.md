...
Project ID: `obs-evo-cand-008710`
...
- Project ID: `obs-evo-cand-008710`
- EVOBC category candidate ID: `evobc-evo-cat-08710`
- External category reference: `evobc-cat-08710`
- Source category ID: `08710`
- Source label for human review: `跎`
- Source codepoints: `U+8DCE`
...
- `obs-evo-cand-008710-route-category-staging`
...
- `obs-evo-cand-008710-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008710-route-evolution-graph`
