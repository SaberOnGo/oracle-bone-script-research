# Material Visual Observation / obs-comp-cand-000951 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000951`
- External reference / 外部参照: `obimd-sub-107xndjbdn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014034_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/107xndjbdn/107xndjbdn/107xndjbdn.png`
- Checksum / 校验和:
  `8c6a6e15992a60e2c8539160e3936becda176021149a49ef2c5b2dfb7cab80da`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.48%.
- Marked-pixel bounds: (51,52)–(204,197); span 154 × 146 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.48%。
- 痕迹范围：(51,52)–(204,197)；跨度154 × 146 px；痕迹矩形近方形。
