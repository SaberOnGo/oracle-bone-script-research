...
- External category reference: `evobc-cat-06978`
- Source category ID: `06978`
- Source label for human review: `肋`
- Source codepoints: `U+808B`
...
- `obs-evo-cand-006978-route-category-staging`
...
- `obs-evo-cand-006978-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006978-route-evolution-graph`
