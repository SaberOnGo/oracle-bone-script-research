# obs-unk-004460 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004460`
- primary external id: `hust-obc-und-X-004460`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/060_obs-unk-004460_h
  ust-obc-und-X-004460_oracle-character-candidate/03_visual-assets/001_asset
  -006053_hust-obc-und-X-004460_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/16/X_？_8195_1.png`
- asset id: `asset-006053`
...
- source class: `HUST-OBC/undeciphered/X/16/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/16/X_？_8195_1.png`
- asset id: `asset-006053`
...
- English observation: A left branching trace stands beside a separate right
  diagonal mark.
- 中文观察: `左侧分支痕迹旁有分离的右侧斜向痕迹。`
...
- Which source records identify obs-unk-004460 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004460？
