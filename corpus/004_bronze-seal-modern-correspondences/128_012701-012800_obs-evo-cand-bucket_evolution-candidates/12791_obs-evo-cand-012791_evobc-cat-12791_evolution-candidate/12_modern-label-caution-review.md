# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012791
...
- EVOBC candidate category: `evobc-evo-cat-12791`.
- Source label for search only: `𪛊`.
- Source codepoints for search only: `U+2A6CA`.
