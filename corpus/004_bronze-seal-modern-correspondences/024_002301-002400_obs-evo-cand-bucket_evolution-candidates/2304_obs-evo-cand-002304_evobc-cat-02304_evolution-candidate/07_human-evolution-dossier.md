...
- External category reference: `evobc-cat-02304`
- Source category ID: `02304`
- Source label for human review: `嬥`
...
- `obs-evo-cand-002304-route-category-staging`
...
- `obs-evo-cand-002304-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002304-route-evolution-graph`
