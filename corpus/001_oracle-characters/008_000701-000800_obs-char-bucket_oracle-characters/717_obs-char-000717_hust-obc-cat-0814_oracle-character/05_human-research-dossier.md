# obs-char-000717 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/717_obs-char-000717_hust-obc-cat-0814_orac
  le-character/03_visual-assets/001_asset-000722_hust-obc-cat-0814_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0814/G_0814_合1030正賓組.png`
- asset id: `asset-000722`
...
- source category: `0814`
- validation class: `716`
- source image route: `HUST-OBC/deciphered/0814/G_0814_合1030正賓組.png`
- asset id: `asset-000722`
...
- English observation: `Three detached outlined forms are stacked
  vertically: an angular roof-like chevron, a middle trapezoidal frame
  divided by verticals, and a shallow lower basin.`
- 中文观察: `三个分离轮廓形竖向层叠：折角屋脊形、中部被竖线分隔的梯形框和浅下槽。`
...
- dataset label text: `㜤`
- dataset label codepoints: `U+3724`
...
- OBIMD candidate ids / OBIMD 候选 ID: `obimd-main-cand-002147`
- OBIMD external refs / OBIMD 外部引用: `obimd-main-w35ugpg42y`
- OBIMD transcription field / OBIMD 转写字段: `㜤`
...
- matched OBIMD main UIDs: `w35ugpg42y`
...
- filename catalog route clues: `Heji-like filename clue: 合1030
  (G_0814_合1030正賓組.png)`
...
- Which source records identify obs-char-000717 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000717？
