# obs-unk-004641 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/041_obs-unk-004641_h
  ust-obc-und-X-004641_oracle-character-candidate/03_visual-assets/001_asset
  -006234_hust-obc-und-X-004641_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/197/X_？_8370_1.png`
- asset id: `asset-006234`
...
- source class: `HUST-OBC/undeciphered/X/197/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/197/X_？_8370_1.png`
- asset id: `asset-006234`
...
- English observation: `tall left arch beside a thick right loop`
- 中文观察: `左侧高拱形与右侧粗重环状形体`
...
- Which source records identify obs-unk-004641 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004641？
