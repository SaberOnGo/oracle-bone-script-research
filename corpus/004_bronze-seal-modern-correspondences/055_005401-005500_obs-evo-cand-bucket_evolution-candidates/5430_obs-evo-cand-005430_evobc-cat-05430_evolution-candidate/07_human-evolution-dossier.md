...
Project ID: `obs-evo-cand-005430`
...
- Project ID: `obs-evo-cand-005430`
- EVOBC category candidate ID: `evobc-evo-cat-05430`
- External category reference: `evobc-cat-05430`
- Source category ID: `05430`
- Source label for human review: `瑁`
- Source codepoints: `U+7441`
...
- `obs-evo-cand-005430-route-category-staging`
...
- `obs-evo-cand-005430-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005430-route-evolution-graph`
