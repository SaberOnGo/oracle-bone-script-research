# Material Visual Observation / obs-comp-cand-002606 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002606`
- External reference / 外部参照: `obimd-sub-wbs71h9u0v`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021145_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wbs71h9u0v/wbs71h9u0v/wbs71h9u0v.png`
- Checksum / 校验和:
  `1c05812411e044f77a9bd3c50e1d5afba6d4c23ebe8b73d636a4343b6cdea6c2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.60%.
- Marked-pixel bounds: (67,23)–(193,225); span 127 × 203 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.60%。
- 痕迹范围：(67,23)–(193,225)；跨度127 × 203 px；痕迹矩形高于宽。
