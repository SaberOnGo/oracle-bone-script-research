...
- External category reference: `evobc-cat-00822`
- Source category ID: `00822`
- Source label for human review: `併`
- Source codepoints: `U+4F75`
...
- `obs-evo-cand-000822-route-category-staging`
...
- `obs-evo-cand-000822-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000822-route-evolution-graph`
