# obs-unk-004873 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/073_obs-unk-004873_h
  ust-obc-und-X-004873_oracle-character-candidate/03_visual-assets/001_asset
  -006466_hust-obc-und-X-004873_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/429/X_？_7412_1.png`
- asset id: `asset-006466`
...
- source class: `HUST-OBC/undeciphered/X/429/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/429/X_？_7412_1.png`
- asset id: `asset-006466`
...
- English observation: `separated upper mark and broad lower enclosure`
- 中文观察: `分离的上部标记和宽大下部外框`
...
- Which source records identify obs-unk-004873 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004873？
