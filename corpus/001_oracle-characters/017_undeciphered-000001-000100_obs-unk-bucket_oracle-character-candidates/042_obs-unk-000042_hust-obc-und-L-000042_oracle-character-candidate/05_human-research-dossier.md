# obs-unk-000042 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000042`
- primary external id: `hust-obc-und-L-000042`
...
- local review image route: `corpus/001_oracle-characters/017_undeciphered-000
  001-000100_obs-unk-bucket_oracle-character-candidates/042_obs-unk-000042_h
  ust-obc-und-L-000042_oracle-character-candidate/03_visual-assets/001_asset
  -001635_hust-obc-und-L-000042_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/42/L_？_10129.jpg`
- asset id: `asset-001635`
...
- source class: `HUST-OBC/undeciphered/L/42/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/42/L_？_10129.jpg`
- asset id: `asset-001635`
...
- Which source records identify obs-unk-000042 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000042？
