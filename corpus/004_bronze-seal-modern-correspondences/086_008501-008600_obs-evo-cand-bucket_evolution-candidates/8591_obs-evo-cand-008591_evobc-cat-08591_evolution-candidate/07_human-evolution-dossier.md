...
- External category reference: `evobc-cat-08591`
- Source category ID: `08591`
- Source label: `賲`
...
- `obs-evo-cand-008591-route-category-staging`
...
- `obs-evo-cand-008591-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008591-route-evolution-graph`
