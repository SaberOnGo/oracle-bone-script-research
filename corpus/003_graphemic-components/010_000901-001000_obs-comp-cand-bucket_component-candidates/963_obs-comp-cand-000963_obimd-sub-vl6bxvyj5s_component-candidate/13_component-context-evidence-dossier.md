# obs-comp-cand-000963 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000963`
- 首选外部 ID: `obimd-sub-vl6bxvyj5s`
- OBIMD subcharacter UID: `vl6bxvyj5s`
- OBIMD main character UID: `vl6bxvyj5s`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+59DB;U+F5662; U+F5663; 另有 1 项
