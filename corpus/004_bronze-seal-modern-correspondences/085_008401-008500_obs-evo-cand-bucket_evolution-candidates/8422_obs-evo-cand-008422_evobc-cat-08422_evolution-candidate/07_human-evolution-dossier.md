...
- External category reference: `evobc-cat-08422`
- Source category ID: `08422`
- Source label for human review: `译`
...
- `obs-evo-cand-008422-route-category-staging`
...
- `obs-evo-cand-008422-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008422-route-evolution-graph`
