# obs-char-000329 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/329_obs-char-000329_hust-obc-cat-0371_orac
  le-character/03_visual-assets/001_asset-000334_hust-obc-cat-0371_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0371/G_0371_甲骨文0.png`
- asset id: `asset-000334`
...
- source category: `0371`
- validation class: `328`
- source image route: `HUST-OBC/deciphered/0371/G_0371_甲骨文0.png`
- asset id: `asset-000334`
...
- English observation: `The dark image has a thick central rounded
  enclosure, a pointed left upper stroke, and a long curved stroke
...
- dataset label text: `㕩`
- dataset label codepoints: `U+3569`
...
- Which source records identify obs-char-000329 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000329？
