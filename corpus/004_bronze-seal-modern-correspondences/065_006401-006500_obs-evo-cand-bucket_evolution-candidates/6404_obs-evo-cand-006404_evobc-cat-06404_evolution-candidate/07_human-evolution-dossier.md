...
- External category reference: `evobc-cat-06404`
- Source category ID: `06404`
- Source label for human review: `粦`
...
- `obs-evo-cand-006404-route-category-staging`
...
- `obs-evo-cand-006404-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006404-route-evolution-graph`
