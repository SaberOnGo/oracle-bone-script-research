...
Project ID: `obs-insc-cw-cand-000046`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000046`
...
- Yingguo / 英国所藏: `y284` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `200` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `497` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000046`
