...
Project ID: `obs-evo-cand-005365`
...
- Project ID: `obs-evo-cand-005365`
- EVOBC category candidate ID: `evobc-evo-cat-05365`
- External category reference: `evobc-cat-05365`
- Source category ID: `05365`
- Source label for human review: `玼`
- Source codepoints: `U+73BC`
...
- `obs-evo-cand-005365-route-category-staging`
...
- `obs-evo-cand-005365-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005365-route-evolution-graph`
