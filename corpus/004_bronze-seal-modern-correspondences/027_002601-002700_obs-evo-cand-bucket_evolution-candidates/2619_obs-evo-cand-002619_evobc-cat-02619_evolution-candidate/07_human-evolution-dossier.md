...
Project ID: `obs-evo-cand-002619`
...
- Project ID: `obs-evo-cand-002619`
- EVOBC category candidate ID: `evobc-evo-cat-02619`
- External category reference: `evobc-cat-02619`
- Source category ID: `02619`
- Source label for human review: `巧`
- Source codepoints: `U+5DE7`
...
- `obs-evo-cand-002619-route-category-staging`
...
- `obs-evo-cand-002619-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002619-route-evolution-graph`
