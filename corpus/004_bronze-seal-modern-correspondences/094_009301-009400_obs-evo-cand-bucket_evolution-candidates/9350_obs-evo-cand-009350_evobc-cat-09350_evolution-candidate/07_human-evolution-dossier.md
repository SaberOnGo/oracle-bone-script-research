...
- External category reference: `evobc-cat-09350`
- Source category ID: `09350`
- Source label for human review: `鈹`
- Source codepoints: `U+9239`
...
- `obs-evo-cand-009350-route-category-staging`
...
- `obs-evo-cand-009350-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009350-route-evolution-graph`
