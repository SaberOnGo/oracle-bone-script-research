...
This object is a Cambridge/Hopkins inscription crosswalk candidate only. It is metadata for catalog review; it is not a formal obi-* inscription record, not an object identity claim, not a transcription, not an inscription reading, and not a decipherment conclusion.
