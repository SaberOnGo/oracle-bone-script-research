# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000828
...
- EVOBC candidate category: `evobc-evo-cat-00828`.
- Source label for search only: `佽`.
- Source codepoints for search only: `U+4F7D`.
