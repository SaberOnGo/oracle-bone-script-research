# obs-unk-004063 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004063`
- primary external id: `hust-obc-und-L-004063`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/063_obs-unk-004063_h
  ust-obc-und-L-004063_oracle-character-candidate/03_visual-assets/001_asset
  -005656_hust-obc-und-L-004063_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4063/L_？_8696.jpg`
- asset id: `asset-005656`
...
- source class: `HUST-OBC/undeciphered/L/4063/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4063/L_？_8696.jpg`
- asset id: `asset-005656`
...
- English observation: An angular open contour runs across the upper and
  right side. A long slanting trace descends into a darker crossed or
  triangular lower cluster. The lower joins and the outer opening are unclear.
...
- Which source records identify obs-unk-004063 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004063？
