...
Project ID: `obs-evo-cand-010388`
...
- Project ID: `obs-evo-cand-010388`
- EVOBC category candidate ID: `evobc-evo-cat-10388`
- External category reference: `evobc-cat-10388`
- Source category ID: `10388`
- Source label for human review: `鮍`
- Source codepoints: `U+9B8D`
...
- `obs-evo-cand-010388-route-category-staging`
...
- `obs-evo-cand-010388-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010388-route-evolution-graph`
