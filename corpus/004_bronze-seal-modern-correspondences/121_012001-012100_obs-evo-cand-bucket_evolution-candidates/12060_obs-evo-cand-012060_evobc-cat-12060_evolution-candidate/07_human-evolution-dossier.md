...
- External category reference: `evobc-cat-12060`
- Source category ID: `12060`
- Source label for human review: `𦠄`
...
- `obs-evo-cand-012060-route-category-staging`
...
- `obs-evo-cand-012060-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012060-route-evolution-graph`
