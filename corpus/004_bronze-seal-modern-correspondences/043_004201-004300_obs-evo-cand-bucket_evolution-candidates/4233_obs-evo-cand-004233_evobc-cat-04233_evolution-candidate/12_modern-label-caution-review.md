# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004233
...
- EVOBC candidate category: `evobc-evo-cat-04233`.
- Source label for search only: `樅`.
- Source codepoints for search only: `U+6A05`.
