...
- External category reference: `evobc-cat-05624`
- Source category ID: `05624`
- Source label for human review: `疸`
- Source codepoints: `U+75B8`
...
- `obs-evo-cand-005624-route-category-staging`
...
- `obs-evo-cand-005624-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005624-route-evolution-graph`
