...
- External category reference: `evobc-cat-09188`
- Source category ID: `09188`
- Source label for human review: `鄑`
- Source codepoints: `U+9111`
...
- `obs-evo-cand-009188-route-category-staging`
...
- `obs-evo-cand-009188-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009188-route-evolution-graph`
