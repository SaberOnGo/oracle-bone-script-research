...
- External category reference: `evobc-cat-04854`
- Source category ID: `04854`
- Source label for human review: `滱`
- Source codepoints: `U+6EF1`
...
- `obs-evo-cand-004854-route-category-staging`
...
- `obs-evo-cand-004854-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004854-route-evolution-graph`
