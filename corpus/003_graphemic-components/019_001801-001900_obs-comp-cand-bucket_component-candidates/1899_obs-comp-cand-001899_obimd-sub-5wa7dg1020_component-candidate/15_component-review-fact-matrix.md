# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001899
...
| Glyph or codepoint route / 字形或码位路线 | 10 OBIMD route rows; examples U+AE6C1;U+FAD7A; U+FAD7B; 另有 8 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
