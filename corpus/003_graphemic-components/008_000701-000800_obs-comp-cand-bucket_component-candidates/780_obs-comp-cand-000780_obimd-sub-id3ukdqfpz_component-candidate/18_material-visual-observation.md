# Material Visual Observation / obs-comp-cand-000780 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000780`
- External reference / 外部参照: `obimd-sub-id3ukdqfpz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013542_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/yrxflndwvy/id3ukdqfpz/id3ukdqfpz.png`
- Checksum / 校验和:
  `dbbe7c2692bedc8607ace936e96f2c0ec7d95e6290e687425128f0d1068f8b24`
...
- Marked-pixel bounds: (69,26)–(180,225); span 112 × 200 px; the marked
...
- 痕迹范围：(69,26)–(180,225)；跨度112 × 200 px；痕迹矩形高于宽。
