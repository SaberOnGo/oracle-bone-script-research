...
- External category reference: `evobc-cat-09710`
- Source category ID: `09710`
- Source label for human review: `阸`
- Source codepoints: `U+9638`
...
- `obs-evo-cand-009710-route-category-staging`
...
- `obs-evo-cand-009710-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009710-route-evolution-graph`
