# Material Visual Observation / obs-comp-cand-000025 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000025`
- External reference / 外部参照: `obimd-sub-zmixmtzym6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011177_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zmixmtzym6/zmixmtzym6/zmixmtzym6.png`
- Checksum / 校验和:
  `fcbc138fb3181555c5124a534c7bb62063afb24698b87037b32255499abf4926`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.15%.
- Marked-pixel bounds: (59,19)–(190,229); span 132 × 211 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.15%。
- 痕迹范围：(59,19)–(190,229)；跨度132 × 211 px；痕迹矩形高于宽。
