...
- External category reference: `evobc-cat-03949`
- Source category ID: `03949`
- Source label for human review: `柆`
...
- `obs-evo-cand-003949-route-category-staging`
...
- `obs-evo-cand-003949-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003949-route-evolution-graph`
