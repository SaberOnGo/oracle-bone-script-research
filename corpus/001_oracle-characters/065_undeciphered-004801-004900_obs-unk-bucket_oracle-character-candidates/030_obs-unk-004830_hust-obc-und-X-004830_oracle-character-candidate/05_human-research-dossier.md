# obs-unk-004830 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/030_obs-unk-004830_h
  ust-obc-und-X-004830_oracle-character-candidate/03_visual-assets/001_asset
  -006423_hust-obc-und-X-004830_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/386/X_？_7369_1.png`
- asset id: `asset-006423`
...
- source class: `HUST-OBC/undeciphered/X/386/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/386/X_？_7369_1.png`
- asset id: `asset-006423`
...
- English observation: `central crossing and broad lower opening`
- 中文观察: `中部交叉和下部宽大开口`
...
- Which source records identify obs-unk-004830 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004830？
