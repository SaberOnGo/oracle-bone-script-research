# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002038
...
| --- | --- | --- | --- |
| `obimd-glyph-link-031351` | 󻮡 | `U+FBBA1` | `reviewed_metadata_only` |
| `obimd-glyph-link-031352` | 󻮢 | `U+FBBA2` | `reviewed_metadata_only` |
