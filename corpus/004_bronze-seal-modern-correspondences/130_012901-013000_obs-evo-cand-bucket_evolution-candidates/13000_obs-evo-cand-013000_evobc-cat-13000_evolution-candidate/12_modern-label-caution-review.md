# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013000
...
- EVOBC candidate category: `evobc-evo-cat-13000`.
- Source label for search only: `𫢢`.
- Source codepoints for search only: `U+2B8A2`.
