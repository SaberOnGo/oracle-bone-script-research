# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002160
...
- EVOBC candidate category: `evobc-evo-cat-02160`.
- Source label for search only: `娎`.
- Source codepoints for search only: `U+5A0E`.
