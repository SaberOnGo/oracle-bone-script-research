# obs-char-000822 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000822`
- primary external id: `hust-obc-cat-0930`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/822_obs-char-000822_hust-obc-cat-0930_orac
  le-character/03_visual-assets/001_asset-000827_hust-obc-cat-0930_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0930/G_0930_乙2035(甲).png`
- asset id: `asset-000827`
...
- source category: `0930`
- validation class: `821`
- source image route: `HUST-OBC/deciphered/0930/G_0930_乙2035(甲).png`
- asset id: `asset-000827`
...
- English observation: `A thin central upright branches at the top and lower
  center; two detached short side strokes flank it and a pointed stem
  descends below.`
- 中文观察: `纤细中央直立笔在顶部和下中部都有分枝；两条分离的短侧笔分列两旁，下方延伸尖形笔干。`
...
- dataset label text: `㞘`
- dataset label codepoints: `U+3798`
...
- Which source records identify obs-char-000822 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000822？
