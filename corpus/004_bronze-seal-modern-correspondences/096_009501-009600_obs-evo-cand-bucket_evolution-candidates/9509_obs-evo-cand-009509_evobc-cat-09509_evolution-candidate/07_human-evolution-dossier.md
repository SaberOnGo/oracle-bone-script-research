...
- External category reference: `evobc-cat-09509`
- Source category ID: `09509`
- Source label for human review: `鏤`
- Source codepoints: `U+93E4`
...
- `obs-evo-cand-009509-route-category-staging`
...
- `obs-evo-cand-009509-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009509-route-evolution-graph`
