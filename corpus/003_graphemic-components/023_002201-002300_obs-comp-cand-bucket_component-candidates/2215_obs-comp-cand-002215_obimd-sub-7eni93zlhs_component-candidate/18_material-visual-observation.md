# Material Visual Observation / obs-comp-cand-002215 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002215`
- External reference / 外部参照: `obimd-sub-7eni93zlhs`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019999_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7eni93zlhs/7eni93zlhs/7eni93zlhs.png`
- Checksum / 校验和:
  `ae5d72ee91e2b406a99204f1574c69b0200cbf81a5c236f0bb80bd5978f9c68f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.86%.
- Marked-pixel bounds: (58,27)–(191,220); span 134 × 194 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.86%。
- 痕迹范围：(58,27)–(191,220)；跨度134 × 194 px；痕迹矩形高于宽。
