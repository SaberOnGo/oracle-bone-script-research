# Material Visual Observation / obs-comp-cand-000050 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000050`
- External reference / 外部参照: `obimd-sub-0ppa3hvekl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011446_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0ppa3hvekl/0ppa3hvekl/0ppa3hvekl.png`
- Checksum / 校验和:
  `954fbe87ce212859046adb389c28113d5d58e4ebeff3babf7ee85383e69677c6`
...
- Marked-pixel bounds: (56,42)–(193,213); span 138 × 172 px; the marked
...
- 痕迹范围：(56,42)–(193,213)；跨度138 × 172 px；痕迹矩形高于宽。
