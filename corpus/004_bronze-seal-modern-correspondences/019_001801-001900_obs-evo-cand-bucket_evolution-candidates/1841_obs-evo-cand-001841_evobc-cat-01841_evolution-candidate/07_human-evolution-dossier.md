...
- External category reference: `evobc-cat-01841`
- Source category ID: `01841`
- Source label for human review: `坿`
- Source codepoints: `U+577F`
...
- `obs-evo-cand-001841-route-category-staging`
...
- `obs-evo-cand-001841-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001841-route-evolution-graph`
