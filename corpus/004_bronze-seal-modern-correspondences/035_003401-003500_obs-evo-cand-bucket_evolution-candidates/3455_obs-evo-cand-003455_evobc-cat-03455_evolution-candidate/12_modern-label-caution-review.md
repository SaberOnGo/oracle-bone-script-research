# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003455
...
- EVOBC candidate category: `evobc-evo-cat-03455`.
- Source label for search only: `搜`.
- Source codepoints for search only: `U+641C`.
