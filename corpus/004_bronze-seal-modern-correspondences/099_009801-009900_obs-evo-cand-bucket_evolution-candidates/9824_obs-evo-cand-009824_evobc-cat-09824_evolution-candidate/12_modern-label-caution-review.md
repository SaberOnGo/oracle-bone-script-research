# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-009824
...
- EVOBC candidate category: `evobc-evo-cat-09824`.
- Source label for search only: `雛`.
- Source codepoints for search only: `U+96DB`.
