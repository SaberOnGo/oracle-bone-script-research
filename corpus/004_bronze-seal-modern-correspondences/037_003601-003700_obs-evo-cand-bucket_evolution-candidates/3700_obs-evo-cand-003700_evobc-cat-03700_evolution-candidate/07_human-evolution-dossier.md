...
Project ID: `obs-evo-cand-003700`
...
- Project ID: `obs-evo-cand-003700`
- EVOBC category candidate ID: `evobc-evo-cat-03700`
- External category reference: `evobc-cat-03700`
- Source category ID: `03700`
- Source label for human review: `昂`
- Source codepoints: `U+6602`
...
- `obs-evo-cand-003700-route-category-staging`
...
- `obs-evo-cand-003700-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003700-route-evolution-graph`
