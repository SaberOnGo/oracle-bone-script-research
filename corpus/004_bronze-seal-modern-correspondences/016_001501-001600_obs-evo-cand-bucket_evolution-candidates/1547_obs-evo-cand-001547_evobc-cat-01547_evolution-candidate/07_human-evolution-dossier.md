...
- Project ID: `obs-evo-cand-001547`
- EVOBC category candidate ID: `evobc-evo-cat-01547`
- External category reference: `evobc-cat-01547`
- Source category ID: `01547`
- Source label for human review: `呸`
- Source codepoints: `U+5478`
...
- `obs-evo-cand-001547-route-category-staging`
...
- `obs-evo-cand-001547-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001547-route-evolution-graph`
