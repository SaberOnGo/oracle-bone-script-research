...
- External category reference: `evobc-cat-08974`
- Source category ID: `08974`
- Source label for human review: `迺`
- Source codepoints: `U+8FFA`
...
- `obs-evo-cand-008974-route-category-staging`
...
- `obs-evo-cand-008974-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008974-route-evolution-graph`
