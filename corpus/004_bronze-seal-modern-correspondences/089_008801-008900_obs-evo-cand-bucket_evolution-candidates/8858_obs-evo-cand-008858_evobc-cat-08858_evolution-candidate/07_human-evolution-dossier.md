...
- External category reference: `evobc-cat-08858`
- Source category ID: `08858`
- Source label for human review: `輼`
...
- `obs-evo-cand-008858-route-category-staging`
...
- `obs-evo-cand-008858-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008858-route-evolution-graph`
