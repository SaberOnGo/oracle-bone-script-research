# obs-unk-004437 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/037_obs-unk-004437_h
  ust-obc-und-L-004437_oracle-character-candidate/03_visual-assets/001_asset
  -006030_hust-obc-und-L-004437_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4437/L_？_9967.jpg`
- asset id: `asset-006030`
...
- source class: `HUST-OBC/undeciphered/L/4437/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4437/L_？_9967.jpg`
- asset id: `asset-006030`
...
- English observation: `Tall side traces surround a pointed upper outline`
  `and lower base.`
- 中文观察: `两侧高痕围住尖角上部轮廓和下部底线。`
...
- Which source records identify obs-unk-004437 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004437？
