...
Project ID: `obs-evo-cand-013229`
...
- Project ID: `obs-evo-cand-013229`
- EVOBC category candidate ID: `evobc-evo-cat-13229`
- External category reference: `evobc-cat-13229`
- Source category ID: `13229`
- Source label for human review: `𬊜`
- Source codepoints: `U+2C29C`
...
- `obs-evo-cand-013229-route-category-staging`
...
- `obs-evo-cand-013229-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013229-route-evolution-graph`
