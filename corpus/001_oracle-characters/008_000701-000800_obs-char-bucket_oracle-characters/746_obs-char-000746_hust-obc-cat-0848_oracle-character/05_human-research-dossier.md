# obs-char-000746 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/746_obs-char-000746_hust-obc-cat-0848_orac
  le-character/03_visual-assets/001_asset-000751_hust-obc-cat-0848_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0848/G_0848_中大168.png`
- asset id: `asset-000751`
...
- source category: `0848`
- validation class: `745`
- source image route: `HUST-OBC/deciphered/0848/G_0848_中大168.png`
- asset id: `asset-000751`
...
- English observation: `Two narrow forms stand close together: the left
  curves around a small upper opening and extends into a long tail, while
  the right stem forks above and branches below.`
- 中文观察: `两个狭长形紧邻：左形围出小型上部空隙并延成长尾，右侧竖干上端分叉、下部分枝。`
...
- dataset label text: `㝆`
- dataset label codepoints: `U+3746`
...
- Which source records identify obs-char-000746 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000746？
