# obs-unk-004012 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004012`
- primary external id: `hust-obc-und-L-004012`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/012_obs-unk-004012_h
  ust-obc-und-L-004012_oracle-character-candidate/03_visual-assets/001_asset
  -005605_hust-obc-und-L-004012_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4012/L_？_8526.jpg`
- asset id: `asset-005605`
...
- source class: `HUST-OBC/undeciphered/L/4012/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4012/L_？_8526.jpg`
- asset id: `asset-005605`
...
- English observation: A tall arched outline rises around a lower cluster of
  curved traces; a separate upright stroke borders the right side.
- 中文观察：高耸弧形轮廓围绕下部弯曲痕迹簇，右侧有独立直立痕迹。
...
- Which source records identify obs-unk-004012 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004012？
