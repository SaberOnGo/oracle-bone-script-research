# Material Visual Observation / obs-comp-cand-000909 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000909`
- External reference / 外部参照: `obimd-sub-kgyxegwfqu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013981_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/sdos1cdyy4/kgyxegwfqu/kgyxegwfqu.png`
- Checksum / 校验和:
  `09b95fcafdeb2f2aabaff33f10a66ac1e919caeba17ab0aa9110c47e8e7883cb`
...
- Marked-pixel bounds: (84,35)–(165,215); span 82 × 181 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.67%。
- 痕迹范围：(84,35)–(165,215)；跨度82 × 181 px；痕迹矩形高于宽。
