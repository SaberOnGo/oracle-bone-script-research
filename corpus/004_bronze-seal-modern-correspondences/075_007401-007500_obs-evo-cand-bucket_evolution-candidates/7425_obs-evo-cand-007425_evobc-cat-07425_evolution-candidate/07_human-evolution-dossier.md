...
- External category reference: `evobc-cat-07425`
- Source category ID: `07425`
- Source label for human review: `菸`
...
- `obs-evo-cand-007425-route-category-staging`
...
- `obs-evo-cand-007425-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007425-route-evolution-graph`
