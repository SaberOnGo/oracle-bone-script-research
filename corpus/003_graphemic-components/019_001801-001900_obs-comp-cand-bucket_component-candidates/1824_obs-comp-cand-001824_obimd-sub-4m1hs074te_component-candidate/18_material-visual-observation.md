# Material Visual Observation / obs-comp-cand-001824 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001824`
- External reference / 外部参照: `obimd-sub-4m1hs074te`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018150_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/sywfwn7sg1/4m1hs074te/4m1hs074te.png`
- Checksum / 校验和:
  `754aaeffbbefd056f9f45156cd56bccde65a70f9b369ccbaca8822051fa1774a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.04%.
- Marked-pixel bounds: (38,49)–(213,196); span 176 × 148 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.04%。
- 痕迹范围：(38,49)–(213,196)；跨度176 × 148 px；痕迹矩形近方形。
