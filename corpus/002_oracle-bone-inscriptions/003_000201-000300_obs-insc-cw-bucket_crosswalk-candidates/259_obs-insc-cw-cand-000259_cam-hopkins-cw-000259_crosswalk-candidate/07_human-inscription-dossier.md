...
Project ID: `obs-insc-cw-cand-000259`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000259`
...
- Yingguo / 英国所藏: `y1751` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: 待查: missing CUL reference in source row
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000259`
...
- Missing reference types: `cambridge_university_library, chalfant, heji`
