# Material Visual Observation / obs-comp-cand-000642 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000642`
- External reference / 外部参照: `obimd-sub-c0j4lyz6aj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013205_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/c0j4lyz6aj/c0j4lyz6aj/c0j4lyz6aj.png`
- Checksum / 校验和:
  `7de747d6128598aebe9bb9fbce4e50d9e2b6896d3214e0d9c12d0b9f479d13d2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.75%.
- Marked-pixel bounds: (66,19)–(187,229); span 122 × 211 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.75%。
- 痕迹范围：(66,19)–(187,229)；跨度122 × 211 px；痕迹矩形高于宽。
