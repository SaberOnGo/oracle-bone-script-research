...
- `obs-evo-cand-009980-route-category-staging`
...
- `obs-evo-cand-009980-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009980-route-evolution-graph`
