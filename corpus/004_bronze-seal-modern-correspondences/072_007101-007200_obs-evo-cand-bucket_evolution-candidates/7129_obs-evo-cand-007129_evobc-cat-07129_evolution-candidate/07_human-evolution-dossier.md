...
Project ID: `obs-evo-cand-007129`
...
- Project ID: `obs-evo-cand-007129`
- EVOBC category candidate ID: `evobc-evo-cat-07129`
- External category reference: `evobc-cat-07129`
- Source category ID: `07129`
- Source label for human review: `膟`
- Source codepoints: `U+819F`
...
- `obs-evo-cand-007129-route-category-staging`
...
- `obs-evo-cand-007129-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007129-route-evolution-graph`
