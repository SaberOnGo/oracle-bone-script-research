# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002314
...
- EVOBC candidate category: `evobc-evo-cat-02314`.
- Source label for search only: `嬻`.
- Source codepoints for search only: `U+5B3B`.
