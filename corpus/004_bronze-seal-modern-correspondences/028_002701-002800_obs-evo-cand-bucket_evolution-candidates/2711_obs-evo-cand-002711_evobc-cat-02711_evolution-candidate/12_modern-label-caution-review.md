# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002711
...
- EVOBC candidate category: `evobc-evo-cat-02711`.
- Source label for search only: `床`.
- Source codepoints for search only: `U+5E8A`.
