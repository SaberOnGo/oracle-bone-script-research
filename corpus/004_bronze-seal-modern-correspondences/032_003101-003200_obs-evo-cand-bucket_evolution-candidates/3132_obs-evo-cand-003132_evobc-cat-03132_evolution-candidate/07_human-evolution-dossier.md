...
- Project ID: `obs-evo-cand-003132`
- EVOBC category candidate ID: `evobc-evo-cat-03132`
- External category reference: `evobc-cat-03132`
- Source category ID: `03132`
- Source label for human review: `慵`
- Source codepoints: `U+6175`
...
- `obs-evo-cand-003132-route-category-staging`
...
- `obs-evo-cand-003132-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003132-route-evolution-graph`
