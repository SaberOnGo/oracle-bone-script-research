...
Project ID: `obs-evo-cand-012887`
...
- Project ID: `obs-evo-cand-012887`
- EVOBC category candidate ID: `evobc-evo-cat-12887`
- External category reference: `evobc-cat-12887`
- Source category ID: `12887`
- Source label for human review: `𪺛`
- Source codepoints: `U+2AE9B`
...
- `obs-evo-cand-012887-route-category-staging`
...
- `obs-evo-cand-012887-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012887-route-evolution-graph`
