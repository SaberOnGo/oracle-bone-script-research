# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003821
...
- EVOBC candidate category: `evobc-evo-cat-03821`.
- Source label for search only: `替`.
- Source codepoints for search only: `U+66FF`.
