# obs-evo-cand-003062 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-003062`
- EVOBC category candidate ID: `evobc-evo-cat-03062`
- External category ref: `evobc-cat-03062`
- Source label: `惪`
- Source codepoints: `U+60EA`
- Image reference count: `133`
- Era token counts: `BI:7;WSC:126`
- Source token counts: `Book:3;Web:130`

## Observed Code Rows / 观察到的代码行

- era 1 / BI: 7 image references
- era 4 / WSC: 126 image references
