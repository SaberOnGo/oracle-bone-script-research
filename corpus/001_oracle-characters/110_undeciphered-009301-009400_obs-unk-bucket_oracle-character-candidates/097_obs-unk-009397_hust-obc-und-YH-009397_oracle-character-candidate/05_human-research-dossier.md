# obs-unk-009397 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-009397`
- primary external id: `hust-obc-und-YH-009397`
...
- local review image route: `corpus/001_oracle-characters/110_undeciphered-009
  301-009400_obs-unk-bucket_oracle-character-candidates/097_obs-unk-009397_h
  ust-obc-und-YH-009397_oracle-character-candidate/03_visual-assets/001_asse
  t-010988_hust-obc-und-YH-009397_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/618CA/Y_？_618CA.jpg`
- asset id: `asset-010988`
...
- source class: `HUST-OBC/undeciphered/Y+H/618CA/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/618CA/Y_？_618CA.jpg`
- asset id: `asset-010988`
...
- Which source records identify obs-unk-009397 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009397？
