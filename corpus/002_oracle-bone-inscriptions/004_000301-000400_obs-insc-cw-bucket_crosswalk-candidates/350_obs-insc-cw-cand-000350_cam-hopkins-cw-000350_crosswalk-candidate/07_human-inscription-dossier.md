...
- Source page section: `Period II Group 6` /
  `第 II 期第 6 组`
- Source section key: `period-ii-group-6`
...
- Yingguo / 英国所藏: `y2038` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `449` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `85` in source row; primary catalog entry pending
- Heji / 合集: `41070` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000350`
