...
Project ID: `obs-evo-cand-012378`
...
- Project ID: `obs-evo-cand-012378`
- EVOBC category candidate ID: `evobc-evo-cat-12378`
- External category reference: `evobc-cat-12378`
- Source category ID: `12378`
- Source label for human review: `𨖄`
- Source codepoints: `U+28584`
...
- `obs-evo-cand-012378-route-category-staging`
...
- `obs-evo-cand-012378-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012378-route-evolution-graph`
