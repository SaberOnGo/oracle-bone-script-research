...
- `obs-evo-cand-011374-route-category-staging`
...
- `obs-evo-cand-011374-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011374-route-evolution-graph`
