...
Project ID: `obs-evo-cand-013426`
...
- Project ID: `obs-evo-cand-013426`
- EVOBC category candidate ID: `evobc-evo-cat-13426`
- External category reference: `evobc-cat-13426`
- Source category ID: `13426`
- Source label for human review: `𬰭`
- Source codepoints: `U+2CC2D`
...
- `obs-evo-cand-013426-route-category-staging`
...
- `obs-evo-cand-013426-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013426-route-evolution-graph`
