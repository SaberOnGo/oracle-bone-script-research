...
Project ID: `obs-insc-cw-cand-000170`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000170`
...
- Yingguo / 英国所藏: `y1013` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `587` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `208` in source row; primary catalog entry pending
- Heji / 合集: `41605` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000170`
