# obs-char-000096 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/096_obs-char-000096_hust-obc-cat-0106_0107
  _oracle-character/03_visual-assets/001_asset-000101_hust-obc-cat-0106_0107
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0106_0107/0106/G_0106_乙2392(甲).
  png`
- asset id: `asset-000101`
...
- source category: `0106_0107`
- validation class: `95`
- source image route: `HUST-OBC/deciphered/0106_0107/0106/G_0106_乙2392(甲).png`
- asset id: `asset-000101`
...
- English observation: `The narrow image has several short upper marks, a
  descending central stroke, and two angular lower strokes opening to the
  sides.`
...
- dataset label text: `㑠㑡`
- dataset label codepoints: `U+3460;U+3461`
...
- Which source records identify obs-char-000096 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000096？
