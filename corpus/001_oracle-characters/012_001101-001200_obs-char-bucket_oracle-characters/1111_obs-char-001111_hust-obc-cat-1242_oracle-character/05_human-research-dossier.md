# obs-char-001111 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001111`
- primary external id: `hust-obc-cat-1242`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1111_obs-char-001111_hust-obc-cat-1242_ora
  cle-character/03_visual-assets/001_asset-001116_hust-obc-cat-1242_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1242/G_1242_乙155合20222.png`
- asset id: `asset-001116`
...
- source category: `1242`
- validation class: `1110`
- source image route: `HUST-OBC/deciphered/1242/G_1242_乙155合20222.png`
- asset id: `asset-001116`
...
- English observation: `A low open enclosure has a central upright rising to
  a pointed upper tip and short side extensions.`
- 中文观察: `低位开放闭合轮廓有中央直立笔，向上收为尖状顶端，两侧有短外伸。`
...
- dataset label text: `㣐`
- dataset label codepoints: `U+38D0`
...
- filename catalog route clues: `Heji-like filename clue: 合20222
...
- Which source records identify obs-char-001111 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001111？
