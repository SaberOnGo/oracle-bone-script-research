# obs-unk-008904 Local Object Materials / obs-unk-008904 本地对象资料
...
- Local review image / 本地复核图像: `03_visual-assets/001_asset-010495_hust-obc-und-YH-008904_glyph.jpg`

## Object Summary / 对象摘要

- Project ID / 项目 ID: `obs-unk-008904`
- Primary external reference / 首选外部参考: `hust-obc-und-YH-008904`
- Source group / 来源分组: `Y+H` (YinQiWenYuan + HWOBC)
- Source class path / 来源分类路径: `HUST-OBC/undeciphered/Y+H/60F44/`
- Source image path / 来源图像路径: `HUST-OBC/undeciphered/Y+H/60F44/H_？_60F44_0.png`
