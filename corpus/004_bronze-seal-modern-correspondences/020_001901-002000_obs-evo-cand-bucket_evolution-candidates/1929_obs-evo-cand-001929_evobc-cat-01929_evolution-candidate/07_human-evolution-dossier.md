...
Project ID: `obs-evo-cand-001929`
...
- Project ID: `obs-evo-cand-001929`
- EVOBC category candidate ID: `evobc-evo-cat-01929`
- External category reference: `evobc-cat-01929`
- Source category ID: `01929`
- Source label for human review: `塼`
- Source codepoints: `U+587C`
...
- `obs-evo-cand-001929-route-category-staging`
...
- `obs-evo-cand-001929-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001929-route-evolution-graph`
