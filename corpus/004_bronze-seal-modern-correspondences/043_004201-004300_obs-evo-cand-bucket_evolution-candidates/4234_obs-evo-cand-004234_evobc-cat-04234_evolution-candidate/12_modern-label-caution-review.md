# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004234
...
- EVOBC candidate category: `evobc-evo-cat-04234`.
- Source label for search only: `樊`.
- Source codepoints for search only: `U+6A0A`.
