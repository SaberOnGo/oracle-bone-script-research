...
- External category reference: `evobc-cat-08847`
- Source category ID: `08847`
- Source label for human review: `輦`
...
- `obs-evo-cand-008847-route-category-staging`
...
- `obs-evo-cand-008847-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008847-route-evolution-graph`
