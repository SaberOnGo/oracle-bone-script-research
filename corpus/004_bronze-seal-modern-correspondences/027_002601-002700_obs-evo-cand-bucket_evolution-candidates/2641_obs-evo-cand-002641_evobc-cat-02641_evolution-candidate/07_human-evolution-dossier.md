...
- External category reference: `evobc-cat-02641`
- Source category ID: `02641`
- Source label for human review: `帊`
...
- `obs-evo-cand-002641-route-category-staging`
...
- `obs-evo-cand-002641-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002641-route-evolution-graph`
