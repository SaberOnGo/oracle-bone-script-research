...
- Yingguo / 英国所藏: `y686` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `129` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `410` in source row; primary catalog entry pending
- Heji / 合集: `39975` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000131`
