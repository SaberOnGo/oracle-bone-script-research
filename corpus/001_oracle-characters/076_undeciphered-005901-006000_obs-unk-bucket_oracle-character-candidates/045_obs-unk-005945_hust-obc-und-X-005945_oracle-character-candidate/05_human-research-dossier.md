# obs-unk-005945 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/076_undeciphered-005
  901-006000_obs-unk-bucket_oracle-character-candidates/045_obs-unk-005945_h
  ust-obc-und-X-005945_oracle-character-candidate/03_visual-assets/001_asset
  -007537_hust-obc-und-X-005945_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1501/X_？_2696_1.png`
- asset id: `asset-007537`
...
- source class: `HUST-OBC/undeciphered/X/1501/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1501/X_？_2696_1.png`
- asset id: `asset-007537`
...
- Which source records identify obs-unk-005945 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005945？
