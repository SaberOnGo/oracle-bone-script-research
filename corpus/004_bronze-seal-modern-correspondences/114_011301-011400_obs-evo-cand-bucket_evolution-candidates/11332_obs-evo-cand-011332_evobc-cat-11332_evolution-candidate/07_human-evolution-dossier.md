...
- External category reference: `evobc-cat-11332`
- Source category ID: `11332`
- Source label for human review: `𢼕`
- Source codepoints: `U+22F15`
...
- `obs-evo-cand-011332-route-category-staging`
...
- `obs-evo-cand-011332-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011332-route-evolution-graph`
