# obs-char-001078 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1078_obs-char-001078_hust-obc-cat-1206_ora
  cle-character/03_visual-assets/001_asset-001083_hust-obc-cat-1206_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1206/G_1206_乙6274反合10936反賓組.png
  `
- asset id: `asset-001083`
...
- source category: `1206`
- validation class: `1077`
- source image route: `HUST-OBC/deciphered/1206/G_1206_乙6274反合10936反賓組.png`
- asset id: `asset-001083`
...
- English observation: `A pointed upper contour narrows into a single long
  central upright and ends at a short horizontal base.`
- 中文观察: `尖状上部轮廓收束为单条长中央直立笔，末端接短水平底笔。`
...
- dataset label text: `㢬`
- dataset label codepoints: `U+38AC`
...
- Which source records identify obs-char-001078 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001078？
