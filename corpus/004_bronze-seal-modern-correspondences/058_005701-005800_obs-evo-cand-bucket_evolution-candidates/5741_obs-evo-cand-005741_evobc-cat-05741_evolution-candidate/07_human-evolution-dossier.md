...
Project ID: `obs-evo-cand-005741`
...
- Project ID: `obs-evo-cand-005741`
- EVOBC category candidate ID: `evobc-evo-cat-05741`
- External category reference: `evobc-cat-05741`
- Source category ID: `05741`
- Source label for human review: `盆`
- Source codepoints: `U+76C6`
...
- `obs-evo-cand-005741-route-category-staging`
...
- `obs-evo-cand-005741-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005741-route-evolution-graph`
