...
- External category reference: `evobc-cat-10030`
- Source category ID: `10030`
- Source label for human review: `顤`
- Source codepoints: `U+9864`
...
- `obs-evo-cand-010030-route-category-staging`
...
- `obs-evo-cand-010030-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010030-route-evolution-graph`
