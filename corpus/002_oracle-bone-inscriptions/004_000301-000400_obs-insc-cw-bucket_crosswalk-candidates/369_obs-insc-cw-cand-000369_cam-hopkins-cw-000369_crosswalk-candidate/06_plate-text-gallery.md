...
Project ID: `obs-insc-cw-cand-000369`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000369`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000369` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2106` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `470` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `98` [route_present_image_or_text_not_collected]
