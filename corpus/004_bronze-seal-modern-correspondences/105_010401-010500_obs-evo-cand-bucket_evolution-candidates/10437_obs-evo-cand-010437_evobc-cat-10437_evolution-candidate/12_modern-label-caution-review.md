# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010437
...
- EVOBC candidate category: `evobc-evo-cat-10437`.
- Source label for search only: `鰫`.
- Source codepoints for search only: `U+9C2B`.
