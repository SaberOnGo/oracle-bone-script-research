# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010381
...
- EVOBC candidate category: `evobc-evo-cat-10381`.
- Source label for search only: `魿`.
- Source codepoints for search only: `U+9B7F`.
