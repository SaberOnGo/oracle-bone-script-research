...
- Project ID: `obs-evo-cand-012679`
- EVOBC category candidate ID: `evobc-evo-cat-12679`
- External category reference: `evobc-cat-12679`
- Source category ID: `12679`
- Source label for human review: `𩭾`
- Source codepoints: `U+29B7E`
...
- `obs-evo-cand-012679-route-category-staging`
...
- `obs-evo-cand-012679-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012679-route-evolution-graph`
