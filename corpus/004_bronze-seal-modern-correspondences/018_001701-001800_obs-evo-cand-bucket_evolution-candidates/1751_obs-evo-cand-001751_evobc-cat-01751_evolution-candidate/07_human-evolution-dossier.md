...
- External category reference: `evobc-cat-01751`
- Source category ID: `01751`
- Source label for human review: `囋`
...
- `obs-evo-cand-001751-route-category-staging`
...
- `obs-evo-cand-001751-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001751-route-evolution-graph`
