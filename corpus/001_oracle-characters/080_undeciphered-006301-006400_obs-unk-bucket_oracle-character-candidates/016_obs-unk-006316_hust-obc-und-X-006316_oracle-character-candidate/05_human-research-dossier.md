# obs-unk-006316 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006316`
- primary external id: `hust-obc-und-X-006316`
...
- local review image route: `corpus/001_oracle-characters/080_undeciphered-006
  301-006400_obs-unk-bucket_oracle-character-candidates/016_obs-unk-006316_h
  ust-obc-und-X-006316_oracle-character-candidate/03_visual-assets/001_asset
  -007907_hust-obc-und-X-006316_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1872/X_？_5104_1.png`
- asset id: `asset-007907`
...
- source class: `HUST-OBC/undeciphered/X/1872/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1872/X_？_5104_1.png`
...
- Which source records identify obs-unk-006316 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006316？
