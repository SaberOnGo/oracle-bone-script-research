# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004316
...
- EVOBC candidate category: `evobc-evo-cat-04316`.
- Source label for search only: `櫝`.
- Source codepoints for search only: `U+6ADD`.
