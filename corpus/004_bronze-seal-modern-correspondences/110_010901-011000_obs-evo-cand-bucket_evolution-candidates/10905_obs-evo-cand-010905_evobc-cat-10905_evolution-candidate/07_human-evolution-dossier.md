...
Project ID: `obs-evo-cand-010905`
...
- Project ID: `obs-evo-cand-010905`
- EVOBC category candidate ID: `evobc-evo-cat-10905`
- External category reference: `evobc-cat-10905`
- Source category ID: `10905`
- Source label for human review: `𠪀`
- Source codepoints: `U+20A80`
...
- `obs-evo-cand-010905-route-category-staging`
...
- `obs-evo-cand-010905-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010905-route-evolution-graph`
