# obs-unk-004435 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004435`
- primary external id: `hust-obc-und-L-004435`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/035_obs-unk-004435_h
  ust-obc-und-L-004435_oracle-character-candidate/03_visual-assets/001_asset
  -006028_hust-obc-und-L-004435_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4435/L_？_9965.jpg`
- asset id: `asset-006028`
...
- source class: `HUST-OBC/undeciphered/L/4435/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4435/L_？_9965.jpg`
- asset id: `asset-006028`
...
- English observation: `Crossing traces link a left stem to a rounded`
  `right outline.`
- 中文观察: `交叉痕迹连接左侧竖干和右侧圆弧轮廓。`
...
- Which source records identify obs-unk-004435 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004435？
