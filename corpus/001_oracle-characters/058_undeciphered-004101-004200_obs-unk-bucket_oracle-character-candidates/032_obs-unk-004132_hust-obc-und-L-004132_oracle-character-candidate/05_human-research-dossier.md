# obs-unk-004132 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/032_obs-unk-004132_h
  ust-obc-und-L-004132_oracle-character-candidate/03_visual-assets/001_asset
  -005725_hust-obc-und-L-004132_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4132/L_？_8903.jpg`
- asset id: `asset-005725`
...
- source class: `HUST-OBC/undeciphered/L/4132/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4132/L_？_8903.jpg`
- asset id: `asset-005725`
...
- English observation: A narrow central trace has lateral marks;
  a taller right trace carries repeated small diagonal marks.
- 中文观察：中央窄痕迹带侧向笔痕；右侧较高痕迹带重复小斜痕。
...
- Which source records identify obs-unk-004132 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004132？
