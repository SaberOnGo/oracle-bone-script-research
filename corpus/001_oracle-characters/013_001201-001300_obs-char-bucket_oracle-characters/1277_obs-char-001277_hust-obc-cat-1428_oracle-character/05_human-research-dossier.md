# obs-char-001277 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1277_obs-char-001277_hust-obc-cat-1428_ora
  cle-character/03_visual-assets/001_asset-001282_hust-obc-cat-1428_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1428/G_1428_鐵104.1(甲).png`
- asset id: `asset-001282`
...
- validation class: `1276`
- source image route: `HUST-OBC/deciphered/1428/G_1428_鐵104.1(甲).png`
- asset id: `asset-001282`
...
- English observation: `Two separated narrow forms each have an upper
  cross-stroke, a central stem, and a long curved lower line.`
- 中文观察: `两个分离的狭长形体各有上部横笔、中央笔干和长弯曲下行线。`
...
- dataset label text: `㦊`
- dataset label codepoints: `U+398A`
...
- Which source records identify obs-char-001277 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001277？
