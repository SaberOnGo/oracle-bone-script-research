# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004410
...
- EVOBC candidate category: `evobc-evo-cat-04410`.
- Source label for search only: `残`.
- Source codepoints for search only: `U+6B8B`.
