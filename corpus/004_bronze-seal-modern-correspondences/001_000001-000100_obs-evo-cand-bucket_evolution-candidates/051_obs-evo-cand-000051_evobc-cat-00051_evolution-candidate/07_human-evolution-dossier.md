...
Project ID: `obs-evo-cand-000051`
...
- Project ID: `obs-evo-cand-000051`
- EVOBC category candidate ID: `evobc-evo-cat-00051`
- External category reference: `evobc-cat-00051`
- Source category ID: `00051`
- Source label for human review: `㛅`
- Source codepoints: `U+36C5`
...
- `obs-evo-cand-000051-route-category-staging`
...
- `obs-evo-cand-000051-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000051-route-evolution-graph`
