# Material Visual Observation / obs-comp-cand-001727 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001727`
- External reference / 外部参照: `obimd-sub-2vsix7bgfw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017912_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kkt3pdctdg/2vsix7bgfw/2vsix7bgfw.png`
- Checksum / 校验和:
  `a6f6e71a6eb15011f6cae4a67f8e95228d53ec349782e813b4e0386a1146985f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.22%.
- Marked-pixel bounds: (76,44)–(173,201); span 98 × 158 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.22%。
- 痕迹范围：(76,44)–(173,201)；跨度98 × 158 px；痕迹矩形高于宽。
