...
Project ID: `obs-evo-cand-013384`
...
- Project ID: `obs-evo-cand-013384`
- EVOBC category candidate ID: `evobc-evo-cat-13384`
- External category reference: `evobc-cat-13384`
- Source category ID: `13384`
- Source label for human review: `𬪎`
- Source codepoints: `U+2CA8E`
...
- `obs-evo-cand-013384-route-category-staging`
...
- `obs-evo-cand-013384-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013384-route-evolution-graph`
