# obs-char-001212 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1212_obs-char-001212_hust-obc-cat-1357_ora
  cle-character/03_visual-assets/001_asset-001217_hust-obc-cat-1357_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1357/G_1357_掇2.24合29375無名組.png`
- asset id: `asset-001217`
...
- source category: `1357`
- validation class: `1211`
- source image route: `HUST-OBC/deciphered/1357/G_1357_掇2.24合29375無名組.png`
- asset id: `asset-001217`
...
- English observation: `A peaked upper frame has two side branches and a
  rounded lower loop with a short central stroke.`
...
- dataset label text: `㥃`
- dataset label codepoints: `U+3943`
...
- filename catalog route clues: `Heji-like filename clue: 合29375
...
- Which source records identify obs-char-001212 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001212？
