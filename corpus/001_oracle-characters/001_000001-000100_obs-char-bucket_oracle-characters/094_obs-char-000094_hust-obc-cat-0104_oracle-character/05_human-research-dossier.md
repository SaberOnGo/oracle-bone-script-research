# obs-char-000094 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000094`
- primary external id: `hust-obc-cat-0104`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/094_obs-char-000094_hust-obc-cat-0104_orac
  le-character/03_visual-assets/001_asset-000099_hust-obc-cat-0104_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0104/G_0104_乙5783合1076賓組.png`
- asset id: `asset-000099`
...
- source category: `0104`
- validation class: `93`
- source image route: `HUST-OBC/deciphered/0104/G_0104_乙5783合1076賓組.png`
- asset id: `asset-000099`
...
- dataset label text: `㑞`
- dataset label codepoints: `U+345E`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/010_obs-evo-can
  d-000010_evobc-cat-00010_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/010_obs-evo-cand-000010_evobc-cat-00010_evolu
...
- Which source records identify obs-char-000094 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000094？
