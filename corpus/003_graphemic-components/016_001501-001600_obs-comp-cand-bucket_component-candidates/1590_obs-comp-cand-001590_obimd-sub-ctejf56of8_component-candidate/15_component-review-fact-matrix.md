# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001590
...
| Glyph or codepoint route / 字形或码位路线 | 52 OBIMD route rows; examples U+4F59;U+F94AE; U+F94AF; 另有 50 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 52 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
