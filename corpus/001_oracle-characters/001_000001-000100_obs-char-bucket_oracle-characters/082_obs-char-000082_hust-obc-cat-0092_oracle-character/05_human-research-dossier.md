# obs-char-000082 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/082_obs-char-000082_hust-obc-cat-0092_orac
  le-character/03_visual-assets/001_asset-000087_hust-obc-cat-0092_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0092/G_0092_乙4320合8381賓組.png`
- asset id: `asset-000087`
...
- source category: `0092`
- validation class: `81`
- source image route: `HUST-OBC/deciphered/0092/G_0092_乙4320合8381賓組.png`
- asset id: `asset-000087`
...
- English observation: `The image shows an open angular frame with a tall
  left stroke, a long lower baseline, and a diagonal stroke descending from
  above.`
...
- dataset label text: `㑒`
- dataset label codepoints: `U+3452`
...
- filename catalog route clues: `Heji-like filename clue: 合8381
...
- Which source records identify obs-char-000082 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000082？
