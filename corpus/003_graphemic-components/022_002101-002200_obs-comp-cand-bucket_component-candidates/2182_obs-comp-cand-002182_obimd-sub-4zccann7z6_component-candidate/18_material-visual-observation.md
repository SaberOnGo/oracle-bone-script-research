# Material Visual Observation / obs-comp-cand-002182 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002182`
- External reference / 外部参照: `obimd-sub-4zccann7z6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019888_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hk9f0607uj/4zccann7z6/4zccann7z6.png`
- Checksum / 校验和:
  `51729dd8b94eb510ac92ddd0c4d8a2ada49f01b981641ec052ea6275207a1d51`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 14.80%.
- Marked-pixel bounds: (64,27)–(189,226); span 126 × 200 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占14.80%。
- 痕迹范围：(64,27)–(189,226)；跨度126 × 200 px；痕迹矩形高于宽。
