# obs-char-001183 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001183`
- primary external id: `hust-obc-cat-1323`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1183_obs-char-001183_hust-obc-cat-1323_ora
  cle-character/03_visual-assets/001_asset-001188_hust-obc-cat-1323_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1323/G_1323_甲骨文0.png`
- asset id: `asset-001188`
...
- source category: `1323`
- validation class: `1182`
- source image route: `HUST-OBC/deciphered/1323/G_1323_甲骨文0.png`
- asset id: `asset-001188`
...
- English observation: `A bold upright form combines a broad upper
  cross-stroke, a central vertical, and several lower horizontal turns.`
- 中文观察: `粗重直立形体结合宽大上部横笔、中央竖笔和数个下部横向转折。`
...
- dataset label text: `㤡`
- dataset label codepoints: `U+3921`
...
- Which source records identify obs-char-001183 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001183？
