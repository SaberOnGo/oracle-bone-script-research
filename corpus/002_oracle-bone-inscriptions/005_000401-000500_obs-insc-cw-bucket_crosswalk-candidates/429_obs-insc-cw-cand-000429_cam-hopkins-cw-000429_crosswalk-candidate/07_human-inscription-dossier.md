...
Project ID: `obs-insc-cw-cand-000429`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000429`
...
- Source page section: `Period III Group 1` /
  `第 III 期第 1 组`
- Source section key: `period-iii-group-1`
- Section declared count: `7`
- Section observed row count: `7`
...
- Yingguo / 英国所藏: `y2260` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `338` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `28` in source row; primary catalog entry pending
- Heji / 合集: `41473` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000429`
