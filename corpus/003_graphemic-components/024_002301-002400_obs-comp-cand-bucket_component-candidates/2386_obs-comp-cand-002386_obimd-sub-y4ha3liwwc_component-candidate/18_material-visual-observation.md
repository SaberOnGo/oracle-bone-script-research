# Material Visual Observation / obs-comp-cand-002386 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002386`
- External reference / 外部参照: `obimd-sub-y4ha3liwwc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020457_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/y4ha3liwwc/y4ha3liwwc/y4ha3liwwc.png`
- Checksum / 校验和:
  `c76eafda9fa1ae95b026147c14c2a45e37e4f2d799cb72339330e1e214a05218`
...
- Marked-pixel bounds: (80,19)–(157,231); span 78 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.26%。
- 痕迹范围：(80,19)–(157,231)；跨度78 × 213 px；痕迹矩形高于宽。
