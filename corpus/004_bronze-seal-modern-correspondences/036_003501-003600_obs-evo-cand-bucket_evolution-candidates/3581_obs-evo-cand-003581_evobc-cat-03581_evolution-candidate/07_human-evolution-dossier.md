...
- External category reference: `evobc-cat-03581`
- Source category ID: `03581`
- Source label for human review: `救`
...
- `obs-evo-cand-003581-route-category-staging`
...
- `obs-evo-cand-003581-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003581-route-evolution-graph`
