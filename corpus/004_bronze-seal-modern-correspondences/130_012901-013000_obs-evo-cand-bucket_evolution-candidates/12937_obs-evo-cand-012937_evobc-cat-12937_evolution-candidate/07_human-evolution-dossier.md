...
- External category reference: `evobc-cat-12937`
- Source category ID: `12937`
- Source label: `𫐟`
...
- `obs-evo-cand-012937-route-category-staging`
...
- `obs-evo-cand-012937-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012937-route-evolution-graph`
