...
- External category reference: `evobc-cat-05975`
- Source category ID: `05975`
- Source label for human review: `祈`
- Source codepoints: `U+7948`
...
- `obs-evo-cand-005975-route-category-staging`
...
- `obs-evo-cand-005975-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005975-route-evolution-graph`
