...
- External category reference: `evobc-cat-02771`
- Source category ID: `02771`
...
- `obs-evo-cand-002771-route-category-staging`
...
- `obs-evo-cand-002771-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002771-route-evolution-graph`
