...
- External category reference: `evobc-cat-01089`
- Source category ID: `01089`
- Source label for human review: `全`
...
- `obs-evo-cand-001089-route-category-staging`
...
- `obs-evo-cand-001089-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001089-route-evolution-graph`
