# obs-unk-007548 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-007548`
- primary external id: `hust-obc-und-YH-007548`
...
- local review image route: `corpus/001_oracle-characters/092_undeciphered-007
  501-007600_obs-unk-bucket_oracle-character-candidates/048_obs-unk-007548_h
  ust-obc-und-YH-007548_oracle-character-candidate/03_visual-assets/001_asse
  t-009139_hust-obc-und-YH-007548_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/600B8/Y_？_600B8.jpg`
- asset id: `asset-009139`
...
- source class: `HUST-OBC/undeciphered/Y+H/600B8/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/600B8/Y_？_600B8.jpg`
- asset id: `asset-009139`
...
- Which source records identify obs-unk-007548 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007548？
