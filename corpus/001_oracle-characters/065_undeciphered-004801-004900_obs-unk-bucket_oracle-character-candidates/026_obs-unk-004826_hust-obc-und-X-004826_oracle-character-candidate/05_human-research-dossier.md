# obs-unk-004826 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/026_obs-unk-004826_h
  ust-obc-und-X-004826_oracle-character-candidate/03_visual-assets/001_asset
  -006419_hust-obc-und-X-004826_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/382/X_？_7119_1.png`
- asset id: `asset-006419`
...
- source class: `HUST-OBC/undeciphered/X/382/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/382/X_？_7119_1.png`
- asset id: `asset-006419`
...
- English observation: `upper crossing, pointed stroke, and lower curve`
- 中文观察: `上部交叉、尖状笔画和下部曲线`
...
- Which source records identify obs-unk-004826 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004826？
