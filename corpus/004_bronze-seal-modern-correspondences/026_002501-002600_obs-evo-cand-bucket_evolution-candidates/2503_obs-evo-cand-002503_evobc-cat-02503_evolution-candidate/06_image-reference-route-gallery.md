...
- `obs-evo-cand-002503-route-category-staging`
...
- `obs-evo-cand-002503-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002503-route-evolution-graph`
