...
Project ID: `obs-evo-cand-001747`
...
- Project ID: `obs-evo-cand-001747`
- EVOBC category candidate ID: `evobc-evo-cat-01747`
- External category reference: `evobc-cat-01747`
- Source category ID: `01747`
- Source label for human review: `嚸`
- Source codepoints: `U+56B8`
...
- `obs-evo-cand-001747-route-category-staging`
...
- `obs-evo-cand-001747-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001747-route-evolution-graph`
