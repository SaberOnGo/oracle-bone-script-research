...
- External category reference: `evobc-cat-10100`
- Source category ID: `10100`
...
- `obs-evo-cand-010100-route-category-staging`
...
- `obs-evo-cand-010100-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010100-route-evolution-graph`
