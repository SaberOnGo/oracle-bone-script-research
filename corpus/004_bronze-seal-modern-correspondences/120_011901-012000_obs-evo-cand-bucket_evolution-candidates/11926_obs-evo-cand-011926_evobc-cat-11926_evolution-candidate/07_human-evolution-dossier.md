...
- External category reference: `evobc-cat-11926`
- Source category ID: `11926`
- Source label for human review: `𥾐`
...
- `obs-evo-cand-011926-route-category-staging`
...
- `obs-evo-cand-011926-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011926-route-evolution-graph`
