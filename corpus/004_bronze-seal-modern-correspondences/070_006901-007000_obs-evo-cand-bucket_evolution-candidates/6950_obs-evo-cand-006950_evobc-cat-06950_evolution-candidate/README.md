# obs-evo-cand-006950 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-06950`
- Source label for human review: `聚`
- Source codepoints: `U+805A`
- Image reference count: `32`
- Era token counts: `CS:1;SS:2;WSC:29`
- Source token counts: `Book:13;Web:19`
