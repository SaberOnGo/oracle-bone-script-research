# obs-char-001027 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001027`
- primary external id: `hust-obc-cat-1152`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1027_obs-char-001027_hust-obc-cat-1152_ora
  cle-character/03_visual-assets/001_asset-001032_hust-obc-cat-1152_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1152/G_1152_乙1986合32賓組.png`
- asset id: `asset-001032`
...
- source category: `1152`
- validation class: `1026`
- source image route: `HUST-OBC/deciphered/1152/G_1152_乙1986合32賓組.png`
- asset id: `asset-001032`
...
- English observation: `A small horizontal rectangular enclosure is
  separated above two long thin descending curved strokes.`
- 中文观察: `小型横向矩形闭合轮廓位于两条长而纤细的下行弯曲笔之上，彼此分离。`
...
- dataset label text: `㡶`
- dataset label codepoints: `U+3876`
...
- filename catalog route clues: `Heji-like filename clue: 合32
  (G_1152_乙1986合32賓組.png)`
...
- Which source records identify obs-char-001027 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001027？
