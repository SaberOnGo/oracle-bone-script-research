# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002809
...
- EVOBC candidate category: `evobc-evo-cat-02809`.
- Source label for search only: `弯`.
- Source codepoints for search only: `U+5F2F`.
