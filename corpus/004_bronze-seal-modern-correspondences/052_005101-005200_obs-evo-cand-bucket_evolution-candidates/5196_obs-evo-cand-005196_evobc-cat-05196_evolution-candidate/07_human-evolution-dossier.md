...
- Project ID: `obs-evo-cand-005196`
- EVOBC category candidate ID: `evobc-evo-cat-05196`
- External category reference: `evobc-cat-05196`
- Source category ID: `05196`
- Source label for human review: `版`
- Source codepoints: `U+7248`
...
- `obs-evo-cand-005196-route-category-staging`
...
- `obs-evo-cand-005196-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005196-route-evolution-graph`
