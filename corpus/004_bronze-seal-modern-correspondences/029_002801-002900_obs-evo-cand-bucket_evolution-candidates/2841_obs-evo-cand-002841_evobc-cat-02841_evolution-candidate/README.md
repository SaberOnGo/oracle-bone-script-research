# obs-evo-cand-002841 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-02841`
- Source label: `彡`
- Source codepoints: `U+5F61`
- Image reference count: `93`
- Era token counts: `CS:1;OBC:90;SS:2`
- Source token counts: `Book:34;Web:59`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 90 image references
