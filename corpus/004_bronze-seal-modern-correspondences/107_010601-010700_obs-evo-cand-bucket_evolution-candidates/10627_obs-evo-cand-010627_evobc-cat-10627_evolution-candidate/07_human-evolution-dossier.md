...
- External category reference: `evobc-cat-10627`
- Source category ID: `10627`
- Source label for human review: `麰`
...
- `obs-evo-cand-010627-route-category-staging`
...
- `obs-evo-cand-010627-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010627-route-evolution-graph`
