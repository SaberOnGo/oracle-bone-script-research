...
- External category reference: `evobc-cat-04356`
- Source category ID: `04356`
- Source label for human review: `欼`
- Source codepoints: `U+6B3C`
...
- `obs-evo-cand-004356-route-category-staging`
...
- `obs-evo-cand-004356-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004356-route-evolution-graph`
