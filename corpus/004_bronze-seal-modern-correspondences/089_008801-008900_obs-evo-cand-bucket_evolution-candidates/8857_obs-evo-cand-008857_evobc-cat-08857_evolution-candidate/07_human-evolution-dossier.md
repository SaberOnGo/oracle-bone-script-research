...
- External category reference: `evobc-cat-08857`
- Source category ID: `08857`
- Source label for human review: `輻`
- Source codepoints: `U+8F3B`
...
- `obs-evo-cand-008857-route-category-staging`
...
- `obs-evo-cand-008857-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008857-route-evolution-graph`
