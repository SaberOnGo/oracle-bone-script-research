...
- External category reference: `evobc-cat-07096`
- Source category ID: `07096`
- Source label for human review: `腔`
...
- `obs-evo-cand-007096-route-category-staging`
...
- `obs-evo-cand-007096-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007096-route-evolution-graph`
