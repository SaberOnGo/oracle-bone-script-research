# obs-char-000070 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/070_obs-char-000070_hust-obc-cat-0080_orac
  le-character/03_visual-assets/001_asset-000075_hust-obc-cat-0080_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0080/G_0080_佚386合367賓組.png`
- asset id: `asset-000075`
...
- source category: `0080`
- validation class: `69`
- source image route: `HUST-OBC/deciphered/0080/G_0080_佚386合367賓組.png`
- asset id: `asset-000075`
...
- English observation: `The tiny gray image contains a curved left form with
  a short top bar and a separate upright hooked stroke on the right.`
...
- dataset label text: `㑆`
- dataset label codepoints: `U+3446`
...
- filename catalog route clues: `Heji-like filename clue: 合367
  (G_0080_佚386合367賓組.png)`
...
- Which source records identify obs-char-000070 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000070？
