...
- External category reference: `evobc-cat-01238`
- Source category ID: `01238`
...
- `obs-evo-cand-001238-route-category-staging`
...
- `obs-evo-cand-001238-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001238-route-evolution-graph`
