# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000028
...
| --- | --- | --- | --- |
| `obimd-glyph-link-000501` | 侚󰋈 | `U+4F9A;U+F02C8` | `reviewed_metadata_only` |
| `obimd-glyph-link-000502` | 󰋉 | `U+F02C9` | `reviewed_metadata_only` |
