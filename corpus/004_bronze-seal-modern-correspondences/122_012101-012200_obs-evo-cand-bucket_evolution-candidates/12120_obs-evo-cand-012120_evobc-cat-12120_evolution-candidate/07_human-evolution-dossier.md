...
- Project ID: `obs-evo-cand-012120`
- EVOBC category candidate ID: `evobc-evo-cat-12120`
- External category reference: `evobc-cat-12120`
- Source category ID: `12120`
- Source label for human review: `𦽏`
- Source codepoints: `U+26F4F`
...
- `obs-evo-cand-012120-route-category-staging`
...
- `obs-evo-cand-012120-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012120-route-evolution-graph`
