# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010534
...
- EVOBC candidate category: `evobc-evo-cat-10534`.
- Source label for search only: `鶬`.
- Source codepoints for search only: `U+9DAC`.
