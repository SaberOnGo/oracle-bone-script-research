...
Candidate collection object ID: `ihp-mus-obj-00015`
...
- Open `18_live-source-evidence-review.md` and verify the three private image
  routes, hashes, page description, and source-only boundary.
