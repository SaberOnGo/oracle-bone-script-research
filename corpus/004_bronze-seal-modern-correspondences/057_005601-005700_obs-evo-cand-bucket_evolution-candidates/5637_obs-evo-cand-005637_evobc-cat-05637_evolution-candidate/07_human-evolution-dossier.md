...
Project ID: `obs-evo-cand-005637`
...
- Project ID: `obs-evo-cand-005637`
- EVOBC category candidate ID: `evobc-evo-cat-05637`
- External category reference: `evobc-cat-05637`
- Source category ID: `05637`
- Source label for human review: `痎`
- Source codepoints: `U+75CE`
...
- `obs-evo-cand-005637-route-category-staging`
...
- `obs-evo-cand-005637-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005637-route-evolution-graph`
