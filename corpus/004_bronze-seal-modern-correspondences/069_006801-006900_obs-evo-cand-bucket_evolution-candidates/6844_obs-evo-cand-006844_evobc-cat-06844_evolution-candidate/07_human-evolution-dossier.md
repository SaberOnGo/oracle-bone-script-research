...
- External category reference: `evobc-cat-06844`
- Source category ID: `06844`
- Source label for human review: `羕`
- Source codepoints: `U+7F95`
...
- `obs-evo-cand-006844-route-category-staging`
...
- `obs-evo-cand-006844-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006844-route-evolution-graph`
