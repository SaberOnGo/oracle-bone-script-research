# Material Visual Observation / obs-comp-cand-002715 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002715`
- External reference / 外部参照: `obimd-sub-7835wu5opl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021291_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1gypkp7d7r/7835wu5opl/7835wu5opl.png`
- Checksum / 校验和:
  `f69d8e4b059fbfe6100a6bf63378d68104f23c742ade432bd05970b6b001a655`
...
- Marked-pixel bounds: (71,30)–(199,213); span 129 × 184 px; the marked
...
- 痕迹范围：(71,30)–(199,213)；跨度129 × 184 px；痕迹矩形高于宽。
