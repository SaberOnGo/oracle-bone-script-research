# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000841
...
- EVOBC candidate category: `evobc-evo-cat-00841`.
- Source label for search only: `例`.
- Source codepoints for search only: `U+4F8B`.
