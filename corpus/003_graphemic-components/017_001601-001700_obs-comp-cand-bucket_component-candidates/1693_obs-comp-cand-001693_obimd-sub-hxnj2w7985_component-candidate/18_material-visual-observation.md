# Material Visual Observation / obs-comp-cand-001693 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001693`
- External reference / 外部参照: `obimd-sub-hxnj2w7985`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017609_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3eorzalgl4/hxnj2w7985/hxnj2w7985.png`
- Checksum / 校验和:
  `b968731f637f77cb3f974e9380c968432fe1ac375f6f6ce71f960d21aef06010`
...
- Marked-pixel bounds: (87,33)–(166,212); span 80 × 180 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.93%。
- 痕迹范围：(87,33)–(166,212)；跨度80 × 180 px；痕迹矩形高于宽。
