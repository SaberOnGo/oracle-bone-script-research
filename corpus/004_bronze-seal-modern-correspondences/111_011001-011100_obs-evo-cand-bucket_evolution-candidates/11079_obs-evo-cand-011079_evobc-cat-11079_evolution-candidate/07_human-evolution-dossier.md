...
- Project ID: `obs-evo-cand-011079`
- EVOBC category candidate ID: `evobc-evo-cat-11079`
- External category reference: `evobc-cat-11079`
- Source category ID: `11079`
- Source label for human review: `𡩜`
- Source codepoints: `U+21A5C`
...
- `obs-evo-cand-011079-route-category-staging`
...
- `obs-evo-cand-011079-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011079-route-evolution-graph`
