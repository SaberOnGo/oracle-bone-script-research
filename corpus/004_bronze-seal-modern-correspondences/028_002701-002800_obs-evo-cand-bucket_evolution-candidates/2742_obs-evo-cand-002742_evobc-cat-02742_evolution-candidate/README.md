# obs-evo-cand-002742 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-002742`
- EVOBC category candidate ID: `evobc-evo-cat-02742`
- External category ref: `evobc-cat-02742`
- Source label for human review: `康`
- Source codepoints: `U+5EB7`
- Image reference count: `90`
- Era token counts: `BI:60;CS:2;OBC:13;SS:3;WSC:12`
- Source token counts: `Book:24;Web:66`
