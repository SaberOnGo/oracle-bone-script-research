# obs-char-000931 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000931`
- primary external id: `hust-obc-cat-1048`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/931_obs-char-000931_hust-obc-cat-1048_orac
  le-character/03_visual-assets/001_asset-000936_hust-obc-cat-1048_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1048/G_1048_乙1943合795賓組.png`
- asset id: `asset-000936`
...
- source category: `1048`
- validation class: `930`
- source image route: `HUST-OBC/deciphered/1048/G_1048_乙1943合795賓組.png`
- asset id: `asset-000936`
...
- English observation: `A compact leaf-like upper cluster leads into a
  descending central stem with a branching lower side form.`
...
- dataset label text: `㠎`
- dataset label codepoints: `U+380E`
...
- filename catalog route clues: `Heji-like filename clue: 合795
  (G_1048_乙1943合795賓組.png)`
...
- Which source records identify obs-char-000931 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000931？
