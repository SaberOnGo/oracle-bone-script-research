# obs-unk-004755 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004755`
- primary external id: `hust-obc-und-X-004755`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/055_obs-unk-004755_h
  ust-obc-und-X-004755_oracle-character-candidate/03_visual-assets/001_asset
  -006348_hust-obc-und-X-004755_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/311/X_？_7296_1.png`
- asset id: `asset-006348`
...
- source class: `HUST-OBC/undeciphered/X/311/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/311/X_？_7296_1.png`
- asset id: `asset-006348`
...
- English observation: `rounded upper enclosure with a lower zigzag`
- 中文观察: `带下部折线的圆钝上部围合结构`
...
- Which source records identify obs-unk-004755 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004755？
