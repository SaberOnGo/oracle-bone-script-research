...
- Project ID: `obs-evo-cand-012260`
- EVOBC category candidate ID: `evobc-evo-cat-12260`
- External category reference: `evobc-cat-12260`
- Source category ID: `12260`
- Source label for human review: `𧮩`
- Source codepoints: `U+27BA9`
...
- `obs-evo-cand-012260-route-category-staging`
...
- `obs-evo-cand-012260-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012260-route-evolution-graph`
