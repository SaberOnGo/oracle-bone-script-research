# obs-unk-004508 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004508`
- primary external id: `hust-obc-und-X-004508`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/008_obs-unk-004508_h
  ust-obc-und-X-004508_oracle-character-candidate/03_visual-assets/001_asset
  -006101_hust-obc-und-X-004508_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/64/X_？_8249_1.png`
- asset id: `asset-006101`
...
- source class: `HUST-OBC/undeciphered/X/64/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/64/X_？_8249_1.png`
- asset id: `asset-006101`
...
- English observation: `The pointed outer contour, separate inner traces, and
  unequal lower ends are directly recorded.`
- 中文观察: `已直接记录尖顶外轮廓、分离内部痕和不等高下端。`
...
- Which source records identify obs-unk-004508 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004508？
