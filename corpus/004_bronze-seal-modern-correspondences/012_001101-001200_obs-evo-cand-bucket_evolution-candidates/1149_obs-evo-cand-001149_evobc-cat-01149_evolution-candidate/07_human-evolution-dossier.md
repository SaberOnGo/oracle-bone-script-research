...
- Project ID: `obs-evo-cand-001149`
- EVOBC category candidate ID: `evobc-evo-cat-01149`
- External category reference: `evobc-cat-01149`
- Source category ID: `01149`
- Source label for human review: `凋`
- Source codepoints: `U+51CB`
...
- `obs-evo-cand-001149-route-category-staging`
...
- `obs-evo-cand-001149-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001149-route-evolution-graph`
