# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006502
...
- EVOBC candidate category: `evobc-evo-cat-06502`.
- Source label for search only: `絕`.
- Source codepoints for search only: `U+7D55`.
