# Material Visual Observation / obs-comp-cand-001962 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001962`
- External reference / 外部参照: `obimd-sub-9vw70byryn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018772_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9vw70byryn/9vw70byryn/9vw70byryn.png`
- Checksum / 校验和:
  `70a2deab35e7c62fbc6c7564a5a9cc9564731d812bc9251b9b103f0f2b18fa84`
...
- Marked-pixel bounds: (83,20)–(169,229); span 87 × 210 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.76%。
- 痕迹范围：(83,20)–(169,229)；跨度87 × 210 px；痕迹矩形高于宽。
