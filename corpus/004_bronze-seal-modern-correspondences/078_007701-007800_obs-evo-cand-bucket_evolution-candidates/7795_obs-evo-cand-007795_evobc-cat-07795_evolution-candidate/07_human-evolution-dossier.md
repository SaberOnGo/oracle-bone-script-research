...
- External category reference: `evobc-cat-07795`
- Source category ID: `07795`
- Source label for human review: `蜸`
...
- `obs-evo-cand-007795-route-category-staging`
...
- `obs-evo-cand-007795-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007795-route-evolution-graph`
