...
Project ID: `obs-evo-cand-004033`
...
- Project ID: `obs-evo-cand-004033`
- EVOBC category candidate ID: `evobc-evo-cat-04033`
- External category reference: `evobc-cat-04033`
- Source category ID: `04033`
- Source label for human review: `桩`
- Source codepoints: `U+6869`
...
- `obs-evo-cand-004033-route-category-staging`
...
- `obs-evo-cand-004033-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004033-route-evolution-graph`
