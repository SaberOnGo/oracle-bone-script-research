...
- External category reference: `evobc-cat-10991`
- Source category ID: `10991`
- Source label for human review: `𡍊`
- Source codepoints: `U+2134A`
...
- `obs-evo-cand-010991-route-category-staging`
...
- `obs-evo-cand-010991-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010991-route-evolution-graph`
