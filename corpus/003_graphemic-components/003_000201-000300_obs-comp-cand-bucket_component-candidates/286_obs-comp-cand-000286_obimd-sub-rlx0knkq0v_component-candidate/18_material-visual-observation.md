# Material Visual Observation / obs-comp-cand-000286 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000286`
- External reference / 外部参照: `obimd-sub-rlx0knkq0v`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011928_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/rlx0knkq0v/rlx0knkq0v/0o4upl2dmk.png`
- Checksum / 校验和:
  `3f1aeba6c59f3dada72029d0fdda4c8daac0817f22005b2bb0002df473f4232d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.00%.
- Marked-pixel bounds: (61,48)–(188,200); span 128 × 153 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.00%。
- 痕迹范围：(61,48)–(188,200)；跨度128 × 153 px；痕迹矩形近方形。
