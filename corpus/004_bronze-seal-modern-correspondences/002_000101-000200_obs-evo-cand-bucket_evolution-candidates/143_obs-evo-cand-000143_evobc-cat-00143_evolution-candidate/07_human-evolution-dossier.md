...
- External category reference: `evobc-cat-00143`
- Source category ID: `00143`
- Source label for human review: `㧔`
...
- `obs-evo-cand-000143-route-category-staging`
...
- `obs-evo-cand-000143-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000143-route-evolution-graph`
