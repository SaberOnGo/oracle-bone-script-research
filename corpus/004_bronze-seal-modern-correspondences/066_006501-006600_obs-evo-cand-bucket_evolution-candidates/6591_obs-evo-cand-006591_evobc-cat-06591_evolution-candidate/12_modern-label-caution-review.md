# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006591
...
- EVOBC candidate category: `evobc-evo-cat-06591`.
- Source label for search only: `線`.
- Source codepoints for search only: `U+7DDA`.
