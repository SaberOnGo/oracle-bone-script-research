# obs-char-001501 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1501_obs-char-001501_hust-obc-cat-1685_ora
  cle-character/03_visual-assets/001_asset-001506_hust-obc-cat-1685_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1685/G_1685_七W12.png`
- asset id: `asset-001506`
...
- source category: `1685`
- validation class: `1500`
- source image route: `HUST-OBC/deciphered/1685/G_1685_七W12.png`
- asset id: `asset-001506`
...
- English observation: `A compact composite has upper forked strokes, a
  right enclosure, and two descending lines.`
...
- dataset label text: `㪋`
- dataset label codepoints: `U+3A8B`
...
- Which source records identify obs-char-001501 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001501？
