...
- External category reference: `evobc-cat-10294`
- Source category ID: `10294`
- Source label for human review: `骹`
- Source codepoints: `U+9AB9`
...
- `obs-evo-cand-010294-route-category-staging`
...
- `obs-evo-cand-010294-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010294-route-evolution-graph`
