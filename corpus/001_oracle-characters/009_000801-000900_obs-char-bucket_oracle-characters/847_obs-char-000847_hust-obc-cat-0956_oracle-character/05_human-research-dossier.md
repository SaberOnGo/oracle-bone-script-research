# obs-char-000847 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000847`
- primary external id: `hust-obc-cat-0956`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/847_obs-char-000847_hust-obc-cat-0956_orac
  le-character/03_visual-assets/001_asset-000852_hust-obc-cat-0956_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0956/G_0956_甲骨文.png`
- asset id: `asset-000852`
...
- source category: `0956`
- validation class: `846`
- source image route: `HUST-OBC/deciphered/0956/G_0956_甲骨文.png`
- asset id: `asset-000852`
...
- English observation: `The small gray image shows a central crossing with
  short upper branches and two detached lower marks; fine joins are
  unclear.`
- 中文观察: `小型灰度图像显示中央交叉、上方短分枝和下方两处分离痕迹；细连接难辨。`
...
- dataset label text: `㞲`
- dataset label codepoints: `U+37B2`
...
- Which source records identify obs-char-000847 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000847？
