# obs-char-001558 Archaeology Paleography Review

# obs-char-001558 考古文字复核档案
...
- first local image: `001_asset-001563_hust-obc-cat-1749_glyph.png`
- first source image: `G_1749_後2.18.8(甲).png`
...
- source label text: `㫋`
- source label codepoints: `U+3ACB`
