...
- `obs-evo-cand-001973-route-category-staging`
...
- `obs-evo-cand-001973-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001973-route-evolution-graph`
