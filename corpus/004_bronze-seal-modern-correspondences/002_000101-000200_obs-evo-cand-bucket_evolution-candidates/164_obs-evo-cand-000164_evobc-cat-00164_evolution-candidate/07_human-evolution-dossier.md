...
- Project ID: `obs-evo-cand-000164`
- EVOBC category candidate ID: `evobc-evo-cat-00164`
- External category reference: `evobc-cat-00164`
- Source category ID: `00164`
- Source label for human review: `㭒`
- Source codepoints: `U+3B52`
...
- `obs-evo-cand-000164-route-category-staging`
...
- `obs-evo-cand-000164-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000164-route-evolution-graph`
