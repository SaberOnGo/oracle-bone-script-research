...
Project ID: `obs-evo-cand-000883`
...
- Project ID: `obs-evo-cand-000883`
- EVOBC category candidate ID: `evobc-evo-cat-00883`
- External category reference: `evobc-cat-00883`
- Source category ID: `00883`
- Source label for human review: `俎`
- Source codepoints: `U+4FCE`
...
- `obs-evo-cand-000883-route-category-staging`
...
- `obs-evo-cand-000883-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000883-route-evolution-graph`
