...
- External category reference: `evobc-cat-00688`
- Source category ID: `00688`
- Source label for human review: `互`
- Source codepoints: `U+4E92`
...
- `obs-evo-cand-000688-route-category-staging`
...
- `obs-evo-cand-000688-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000688-route-evolution-graph`
