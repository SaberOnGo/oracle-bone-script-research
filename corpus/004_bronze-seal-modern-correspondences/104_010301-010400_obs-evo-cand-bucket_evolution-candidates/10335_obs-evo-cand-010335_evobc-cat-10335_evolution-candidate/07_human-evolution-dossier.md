...
- External category reference: `evobc-cat-10335`
- Source category ID: `10335`
- Source label for human review: `鬢`
...
- `obs-evo-cand-010335-route-category-staging`
...
- `obs-evo-cand-010335-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010335-route-evolution-graph`
