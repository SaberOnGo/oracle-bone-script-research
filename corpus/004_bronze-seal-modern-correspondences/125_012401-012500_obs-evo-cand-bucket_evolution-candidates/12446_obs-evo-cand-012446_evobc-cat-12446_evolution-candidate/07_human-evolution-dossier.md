...
Project ID: `obs-evo-cand-012446`
...
- Project ID: `obs-evo-cand-012446`
- EVOBC category candidate ID: `evobc-evo-cat-12446`
- External category reference: `evobc-cat-12446`
- Source category ID: `12446`
- Source label for human review: `𨜴`
- Source codepoints: `U+28734`
...
- `obs-evo-cand-012446-route-category-staging`
...
- `obs-evo-cand-012446-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012446-route-evolution-graph`
