# obs-char-000262 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/262_obs-char-000262_hust-obc-cat-0294_orac
  le-character/03_visual-assets/001_asset-000267_hust-obc-cat-0294_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0294/X_0294_4356_1.png`
- asset id: `asset-000267`
...
- source category: `0294`
- validation class: `261`
- source image route: `HUST-OBC/deciphered/0294/X_0294_4356_1.png`
- asset id: `asset-000267`
...
- English observation: `The tall image has two long upright strokes, three
  short horizontal bars near the top, and a central forked form beneath
  them.`
...
- dataset label text: `㔜`
- dataset label codepoints: `U+351C`
...
- Which source records identify obs-char-000262 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000262？
