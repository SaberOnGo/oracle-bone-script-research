# obs-char-000726 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/726_obs-char-000726_hust-obc-cat-0825_0826
  _oracle-character/03_visual-assets/001_asset-000731_hust-obc-cat-0825_0826
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0825_0826/0825/G_0825_前7.38.1(甲
  ).png`
- asset id: `asset-000731`
...
- source category: `0825_0826`
- validation class: `725`
- source image route: `HUST-OBC/deciphered/0825_0826/0825/G_0825_前7.38.1(甲).pn
  g`
- asset id: `asset-000731`
...
- English observation: `A small angular upper outline crosses a central
  upright and short middle bar, then narrows into one long slightly wavering
  lower stroke.`
- 中文观察: `小型折角上轮廓与中央竖笔及中部短横相交，随后收束为一条略有波折的长下笔。`
...
- dataset label text: `㜯㜰`
- dataset label codepoints: `U+372F;U+3730`
...
- Which source records identify obs-char-000726 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000726？
