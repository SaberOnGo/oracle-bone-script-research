...
Project ID: `obs-insc-cw-cand-000561`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000561`
...
- Period label: `V`
- Classification group: `12`
- Declared group count: `12`
...
- Source page section: `Period V Group 12` /
  `第 V 期第 12 组`
- Source section key: `period-v-group-12`
- Section declared count: `12`
- Section observed row count: `12`
...
- Yingguo / 英国所藏: `y2573` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `410` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `348` in source row; primary catalog entry pending
- Heji / 合集: `41855` in source row; primary catalog entry pending
...
- Group and batch / 组类与批次: group `12`; batch or pit context pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000561`
