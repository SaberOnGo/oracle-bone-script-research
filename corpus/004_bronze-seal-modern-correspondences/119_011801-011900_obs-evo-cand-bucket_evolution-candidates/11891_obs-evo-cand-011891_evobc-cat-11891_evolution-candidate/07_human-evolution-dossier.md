...
- External category reference: `evobc-cat-11891`
- Source category ID: `11891`
- Source label for human review: `𥰶`
- Source codepoints: `U+25C36`
...
- `obs-evo-cand-011891-route-category-staging`
...
- `obs-evo-cand-011891-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011891-route-evolution-graph`
