...
- External category reference: `evobc-cat-02998`
- Source category ID: `02998`
- Source label for human review: `悃`
...
- `obs-evo-cand-002998-route-category-staging`
...
- `obs-evo-cand-002998-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002998-route-evolution-graph`
