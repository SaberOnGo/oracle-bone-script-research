...
- External category reference: `evobc-cat-09076`
- Source category ID: `09076`
- Source label for human review: `邇`
...
- `obs-evo-cand-009076-route-category-staging`
...
- `obs-evo-cand-009076-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009076-route-evolution-graph`
