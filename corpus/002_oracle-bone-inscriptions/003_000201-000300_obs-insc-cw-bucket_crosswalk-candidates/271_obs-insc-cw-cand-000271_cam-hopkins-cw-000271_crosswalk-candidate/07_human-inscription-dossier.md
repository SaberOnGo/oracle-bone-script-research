...
- Yingguo / 英国所藏: `y1822` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `557` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `622` in source row; primary catalog entry pending
- Heji / 合集: `40888` in source row; primary catalog entry pending
