# Material Visual Observation / obs-comp-cand-001619 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001619`
- External reference / 外部参照: `obimd-sub-hxwcv9yfyk`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017295_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hxwcv9yfyk/hxwcv9yfyk/hxwcv9yfyk.png`
- Checksum / 校验和:
  `f6c7649001554cef69748814876aa98e9a0b7532dcaf7d4e7be247713b056434`
...
- Marked-pixel bounds: (55,33)–(189,203); span 135 × 171 px; the marked
...
- 痕迹范围：(55,33)–(189,203)；跨度135 × 171 px；痕迹矩形高于宽。
