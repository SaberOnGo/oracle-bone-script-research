# obs-comp-cand-001059 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001059`
- 首选外部 ID: `obimd-sub-alvcqy8hjj`
- OBIMD subcharacter UID: `alvcqy8hjj`
- OBIMD main character UID: `alvcqy8hjj`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+2C6EB;U+F6066; U+F6067; 另有 1 项
