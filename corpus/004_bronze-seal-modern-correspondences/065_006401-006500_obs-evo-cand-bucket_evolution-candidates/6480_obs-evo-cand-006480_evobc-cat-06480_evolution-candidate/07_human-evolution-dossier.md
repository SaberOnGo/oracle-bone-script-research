...
- Project ID: `obs-evo-cand-006480`
- EVOBC category candidate ID: `evobc-evo-cat-06480`
- External category reference: `evobc-cat-06480`
- Source category ID: `06480`
- Source label for human review: `紵`
- Source codepoints: `U+7D35`
...
- `obs-evo-cand-006480-route-category-staging`
...
- `obs-evo-cand-006480-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006480-route-evolution-graph`
