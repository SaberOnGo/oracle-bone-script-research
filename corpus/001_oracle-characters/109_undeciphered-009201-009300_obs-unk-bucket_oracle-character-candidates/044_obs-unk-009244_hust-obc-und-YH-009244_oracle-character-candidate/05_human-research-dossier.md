# obs-unk-009244 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-009244`
- primary external id: `hust-obc-und-YH-009244`
...
- local review image route: `corpus/001_oracle-characters/109_undeciphered-009
  201-009300_obs-unk-bucket_oracle-character-candidates/044_obs-unk-009244_h
  ust-obc-und-YH-009244_oracle-character-candidate/03_visual-assets/001_asse
  t-010835_hust-obc-und-YH-009244_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/613FB/H_？_613FB_0.png`
- asset id: `asset-010835`
...
- source class: `HUST-OBC/undeciphered/Y+H/613FB/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/613FB/H_？_613FB_0.png`
- asset id: `asset-010835`
...
- Which source records identify obs-unk-009244 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009244？
