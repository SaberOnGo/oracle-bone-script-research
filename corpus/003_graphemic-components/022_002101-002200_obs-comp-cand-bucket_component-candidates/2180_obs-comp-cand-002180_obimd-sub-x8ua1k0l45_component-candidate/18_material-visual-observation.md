# Material Visual Observation / obs-comp-cand-002180 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002180`
- External reference / 外部参照: `obimd-sub-x8ua1k0l45`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019881_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hk9f0607uj/x8ua1k0l45/3vc671b0n3.png`
- Checksum / 校验和:
  `8f3ceab6bbeedd74fe250b4cd41061801cce306d2c309b455b4d3174d3bf8159`
...
- Marked-pixel bounds: (89,32)–(160,212); span 72 × 181 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.36%。
- 痕迹范围：(89,32)–(160,212)；跨度72 × 181 px；痕迹矩形高于宽。
