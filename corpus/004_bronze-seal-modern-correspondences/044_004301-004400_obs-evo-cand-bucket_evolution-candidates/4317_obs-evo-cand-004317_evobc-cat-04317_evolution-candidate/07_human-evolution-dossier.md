...
- External category reference: `evobc-cat-04317`
- Source category ID: `04317`
...
- `obs-evo-cand-004317-route-category-staging`
...
- `obs-evo-cand-004317-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004317-route-evolution-graph`
