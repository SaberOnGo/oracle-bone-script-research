...
- Project ID: `obs-evo-cand-001181`
- EVOBC category candidate ID: `evobc-evo-cat-01181`
- External category reference: `evobc-cat-01181`
- Source category ID: `01181`
- Source label for human review: `刉`
- Source codepoints: `U+5209`
...
- `obs-evo-cand-001181-route-category-staging`
...
- `obs-evo-cand-001181-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001181-route-evolution-graph`
