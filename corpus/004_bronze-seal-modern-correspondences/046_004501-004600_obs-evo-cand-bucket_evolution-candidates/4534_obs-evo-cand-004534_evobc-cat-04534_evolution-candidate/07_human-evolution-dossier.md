...
Project ID: `obs-evo-cand-004534`
...
- Project ID: `obs-evo-cand-004534`
- EVOBC category candidate ID: `evobc-evo-cat-04534`
- External category reference: `evobc-cat-04534`
- Source category ID: `04534`
- Source label for human review: `沉`
- Source codepoints: `U+6C89`
...
- `obs-evo-cand-004534-route-category-staging`
...
- `obs-evo-cand-004534-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004534-route-evolution-graph`
