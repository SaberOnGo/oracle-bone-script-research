# obs-unk-006437 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/081_undeciphered-006
  401-006500_obs-unk-bucket_oracle-character-candidates/037_obs-unk-006437_h
  ust-obc-und-X-006437_oracle-character-candidate/03_visual-assets/001_asset
  -008028_hust-obc-und-X-006437_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1993/X_？_5626_1.png`
- asset id: `asset-008028`
...
- source class: `HUST-OBC/undeciphered/X/1993/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1993/X_？_5626_1.png`
- asset id: `asset-008028`
...
- Which source records identify obs-unk-006437 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006437？
