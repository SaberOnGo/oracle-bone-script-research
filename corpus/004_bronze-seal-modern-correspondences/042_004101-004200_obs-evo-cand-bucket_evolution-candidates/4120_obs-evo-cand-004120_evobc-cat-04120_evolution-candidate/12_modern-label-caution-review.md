# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004120
...
- EVOBC candidate category: `evobc-evo-cat-04120`.
- Source label for search only: `椌`.
- Source codepoints for search only: `U+690C`.
