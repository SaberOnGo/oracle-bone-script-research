...
- Project ID: `obs-evo-cand-012509`
- EVOBC category candidate ID: `evobc-evo-cat-12509`
- External category reference: `evobc-cat-12509`
- Source category ID: `12509`
- Source label for human review: `𨳿`
- Source codepoints: `U+28CFF`
...
- `obs-evo-cand-012509-route-category-staging`
...
- `obs-evo-cand-012509-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012509-route-evolution-graph`
