...
- External category reference: `evobc-cat-07887`
- Source category ID: `07887`
- Source label for human review: `蠰`
- Source codepoints: `U+8830`
...
- `obs-evo-cand-007887-route-category-staging`
...
- `obs-evo-cand-007887-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007887-route-evolution-graph`
