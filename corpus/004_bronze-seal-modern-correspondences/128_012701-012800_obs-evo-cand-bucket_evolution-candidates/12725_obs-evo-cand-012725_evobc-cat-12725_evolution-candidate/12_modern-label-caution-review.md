# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012725
...
- EVOBC candidate category: `evobc-evo-cat-12725`.
- Source label for search only: `𪂪`.
- Source codepoints for search only: `U+2A0AA`.
