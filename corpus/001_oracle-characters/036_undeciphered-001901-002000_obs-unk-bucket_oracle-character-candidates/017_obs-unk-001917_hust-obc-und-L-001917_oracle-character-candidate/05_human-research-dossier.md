# obs-unk-001917 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-001917`
- primary external id: `hust-obc-und-L-001917`
...
- local review image route: `corpus/001_oracle-characters/036_undeciphered-001
  901-002000_obs-unk-bucket_oracle-character-candidates/017_obs-unk-001917_h
  ust-obc-und-L-001917_oracle-character-candidate/03_visual-assets/001_asset
  -003510_hust-obc-und-L-001917_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/1917/L_？_1583.jpg`
- asset id: `asset-003510`
...
- source class: `HUST-OBC/undeciphered/L/1917/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/1917/L_？_1583.jpg`
- asset id: `asset-003510`
...
- Which source records identify obs-unk-001917 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-001917？
