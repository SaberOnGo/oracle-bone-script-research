...
- External category reference: `evobc-cat-04430`
- Source category ID: `04430`
- Source label for human review: `殹`
- Source codepoints: `U+6BB9`
...
- `obs-evo-cand-004430-route-category-staging`
...
- `obs-evo-cand-004430-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004430-route-evolution-graph`
