...
- External category reference: `evobc-cat-08270`
- Source category ID: `08270`
- Source label for human review: `諓`
...
- `obs-evo-cand-008270-route-category-staging`
...
- `obs-evo-cand-008270-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008270-route-evolution-graph`
