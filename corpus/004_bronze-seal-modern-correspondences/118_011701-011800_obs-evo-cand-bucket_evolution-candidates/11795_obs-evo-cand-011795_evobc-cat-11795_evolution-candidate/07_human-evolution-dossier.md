...
- External category reference: `evobc-cat-11795`
- Source category ID: `11795`
- Source label for human review: `𥏚`
- Source codepoints: `U+253DA`
...
- `obs-evo-cand-011795-route-category-staging`
...
- `obs-evo-cand-011795-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011795-route-evolution-graph`
