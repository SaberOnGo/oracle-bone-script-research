# Material Visual Observation / obs-comp-cand-000694 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000694`
- External reference / 外部参照: `obimd-sub-cyv9807bcj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013293_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cyv9807bcj/cyv9807bcj/cyv9807bcj.png`
- Checksum / 校验和:
  `d07484fa4353a452bcac0169fb78f8631dbf33a7ca2fb19f38628acdbc022721`
...
- Marked-pixel bounds: (75,20)–(184,226); span 110 × 207 px; the marked
...
- 痕迹范围：(75,20)–(184,226)；跨度110 × 207 px；痕迹矩形高于宽。
