# obs-evo-cand-005264 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-005264`
- EVOBC category candidate ID: `evobc-evo-cat-05264`
- External category ref: `evobc-cat-05264`
- Source label: `狐`
- Source codepoints: `U+72D0`
- Image reference count: `93`
- Era token counts: `BI:1;CS:1;OBC:52;SS:2;WSC:37`
- Source token counts: `Book:26;Web:67`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 52 image references
- era 1 / BI: 1 image references
