...
Project ID: `obs-evo-cand-008354`
...
- Project ID: `obs-evo-cand-008354`
- EVOBC category candidate ID: `evobc-evo-cat-08354`
- External category reference: `evobc-cat-08354`
- Source category ID: `08354`
- Source label for human review: `譎`
- Source codepoints: `U+8B4E`
...
- `obs-evo-cand-008354-route-category-staging`
...
- `obs-evo-cand-008354-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008354-route-evolution-graph`
