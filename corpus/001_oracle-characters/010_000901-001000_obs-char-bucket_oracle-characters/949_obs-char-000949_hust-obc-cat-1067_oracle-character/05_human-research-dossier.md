# obs-char-000949 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/949_obs-char-000949_hust-obc-cat-1067_orac
  le-character/03_visual-assets/001_asset-000954_hust-obc-cat-1067_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1067/G_1067_前8.11.2合31812無名組.pn
  g`
- asset id: `asset-000954`
...
- source category: `1067`
- validation class: `948`
- source image route: `HUST-OBC/deciphered/1067/G_1067_前8.11.2合31812無名組.png`
- asset id: `asset-000954`
...
- dataset label text: `㠡`
- dataset label codepoints: `U+3821`
...
- filename catalog route clues: `Heji-like filename clue: 合31812
...
- Which source records identify obs-char-000949 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000949？
