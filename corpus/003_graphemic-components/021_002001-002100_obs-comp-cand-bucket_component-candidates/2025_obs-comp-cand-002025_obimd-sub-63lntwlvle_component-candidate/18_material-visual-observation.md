# Material Visual Observation / obs-comp-cand-002025 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002025`
- External reference / 外部参照: `obimd-sub-63lntwlvle`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019352_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/y1u4nexjl4/63lntwlvle/63lntwlvle.png`
- Checksum / 校验和:
  `d155a0fecd482dc5948decba1a533b9967ab7a7e49374f878d6f22b0ee378766`
...
- Marked-pixel bounds: (75,44)–(174,204); span 100 × 161 px; the marked
...
- 痕迹范围：(75,44)–(174,204)；跨度100 × 161 px；痕迹矩形高于宽。
