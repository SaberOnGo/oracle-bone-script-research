...
Project ID: `obs-insc-cw-cand-000299`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000299`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000299` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y1933` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `426` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `7` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `40939` [route_present_image_or_text_not_collected]
