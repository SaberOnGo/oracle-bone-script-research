...
- External category reference: `evobc-cat-13509`
- Source category ID: `13509`
- Source label for human review: `𭔉`
- Source codepoints: `U+2D509`
...
- `obs-evo-cand-013509-route-category-staging`
...
- `obs-evo-cand-013509-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013509-route-evolution-graph`
