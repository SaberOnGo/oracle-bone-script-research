# Material Visual Observation / obs-comp-cand-001578 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001578`
- External reference / 外部参照: `obimd-sub-3j6m0jpzp3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017159_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ggmxiphq64/3j6m0jpzp3/3j6m0jpzp3.png`
- Checksum / 校验和:
  `5bbc7934a87951431e8ef028aadee4dadb678eebc4f6db829517018077a6ceff`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.48%.
- Marked-pixel bounds: (67,34)–(182,220); span 116 × 187 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.48%。
- 痕迹范围：(67,34)–(182,220)；跨度116 × 187 px；痕迹矩形高于宽。
