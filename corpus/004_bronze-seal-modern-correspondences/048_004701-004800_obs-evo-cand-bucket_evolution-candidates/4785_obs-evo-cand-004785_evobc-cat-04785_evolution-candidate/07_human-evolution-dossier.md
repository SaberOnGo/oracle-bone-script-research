...
- External category reference: `evobc-cat-04785`
- Source category ID: `04785`
- Source label for human review: `湔`
- Source codepoints: `U+6E54`
...
- `obs-evo-cand-004785-route-category-staging`
...
- `obs-evo-cand-004785-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004785-route-evolution-graph`
