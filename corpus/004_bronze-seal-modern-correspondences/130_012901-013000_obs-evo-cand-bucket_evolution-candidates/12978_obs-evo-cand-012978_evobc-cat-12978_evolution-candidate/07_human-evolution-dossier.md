...
Project ID: `obs-evo-cand-012978`
...
- Project ID: `obs-evo-cand-012978`
- EVOBC category candidate ID: `evobc-evo-cat-12978`
- External category reference: `evobc-cat-12978`
- Source category ID: `12978`
- Source label for human review: `𫙼`
- Source codepoints: `U+2B67C`
...
- `obs-evo-cand-012978-route-category-staging`
...
- `obs-evo-cand-012978-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012978-route-evolution-graph`
