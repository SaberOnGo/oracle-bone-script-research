# obs-char-000162 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000162`
- primary external id: `hust-obc-cat-0178`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/162_obs-char-000162_hust-obc-cat-0178_orac
  le-character/03_visual-assets/001_asset-000167_hust-obc-cat-0178_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0178/X_0178_3804_1.png`
- asset id: `asset-000167`
...
- source category: `0178`
- validation class: `161`
- source image route: `HUST-OBC/deciphered/0178/X_0178_3804_1.png`
- asset id: `asset-000167`
...
- English observation: `The broad image contains a separate curved stroke on
  the left and a deep V-shaped form on the right ending in a compact
  rectangular block.`
- 中文观察: `宽大图像左侧有分离的弯曲笔，右侧为深 V 形结构，下端接紧凑长方形块。`
...
- dataset label text: `㒨`
- dataset label codepoints: `U+34A8`
...
- Which source records identify obs-char-000162 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000162？
