...
- Project ID: `obs-evo-cand-012059`
- EVOBC category candidate ID: `evobc-evo-cat-12059`
- External category reference: `evobc-cat-12059`
- Source category ID: `12059`
- Source label for human review: `𦟨`
- Source codepoints: `U+267E8`
...
- `obs-evo-cand-012059-route-category-staging`
...
- `obs-evo-cand-012059-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012059-route-evolution-graph`
