# obs-xwalk-cand-000768 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+375E` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-0872` | not reading |
