...
- `obs-evo-cand-005957-route-category-staging`
...
- `obs-evo-cand-005957-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005957-route-evolution-graph`
