...
Project ID: `obs-evo-cand-009201`
...
- Project ID: `obs-evo-cand-009201`
- EVOBC category candidate ID: `evobc-evo-cat-09201`
- External category reference: `evobc-cat-09201`
- Source category ID: `09201`
- Source label for human review: `鄠`
- Source codepoints: `U+9120`
...
- `obs-evo-cand-009201-route-category-staging`
...
- `obs-evo-cand-009201-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009201-route-evolution-graph`
