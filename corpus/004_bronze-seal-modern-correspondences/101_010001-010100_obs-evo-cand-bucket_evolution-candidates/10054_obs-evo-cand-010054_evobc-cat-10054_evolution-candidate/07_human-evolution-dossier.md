...
- Project ID: `obs-evo-cand-010054`
- EVOBC category candidate ID: `evobc-evo-cat-10054`
- External category reference: `evobc-cat-10054`
- Source category ID: `10054`
- Source label for human review: `颈`
- Source codepoints: `U+9888`
...
- `obs-evo-cand-010054-route-category-staging`
...
- `obs-evo-cand-010054-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010054-route-evolution-graph`
