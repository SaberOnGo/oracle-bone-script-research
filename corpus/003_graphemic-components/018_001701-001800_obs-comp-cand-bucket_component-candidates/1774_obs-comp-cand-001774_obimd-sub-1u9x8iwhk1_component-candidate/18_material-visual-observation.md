# Material Visual Observation / obs-comp-cand-001774 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001774`
- External reference / 外部参照: `obimd-sub-1u9x8iwhk1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017975_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8sbbzthl9w/1u9x8iwhk1/1u9x8iwhk1.png`
- Checksum / 校验和:
  `0fbc7f8e06bf777b4a6d0aa9c482ad1a8af1e075727555dd885728611cda9222`
...
- Marked-pixel bounds: (71,25)–(178,207); span 108 × 183 px; the marked
...
- 痕迹范围：(71,25)–(178,207)；跨度108 × 183 px；痕迹矩形高于宽。
