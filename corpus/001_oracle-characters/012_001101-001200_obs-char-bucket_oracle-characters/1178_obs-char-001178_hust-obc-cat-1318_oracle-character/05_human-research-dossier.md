# obs-char-001178 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001178`
- primary external id: `hust-obc-cat-1318`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1178_obs-char-001178_hust-obc-cat-1318_ora
  cle-character/03_visual-assets/001_asset-001183_hust-obc-cat-1318_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1318/H_1318_604E9_0.png`
- asset id: `asset-001183`
...
- source category: `1318`
- validation class: `1177`
- source image route: `HUST-OBC/deciphered/1318/H_1318_604E9_0.png`
- asset id: `asset-001183`
...
- English observation: `A tall pale form has a long central upright
  separating two curved outer strokes with short side branches.`
- 中文观察: `高而较淡的形体有长中央直立笔，分隔两条带短侧枝的弯曲外笔。`
...
- dataset label text: `㤜`
- dataset label codepoints: `U+391C`
...
- filename catalog route clues: `catalog-like filename clue: H_1318
  (H_1318_604E9_0.png)`
...
- Which source records identify obs-char-001178 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001178？
