# obs-unk-004794 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/094_obs-unk-004794_h
  ust-obc-und-X-004794_oracle-character-candidate/03_visual-assets/001_asset
  -006387_hust-obc-und-X-004794_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/350/X_？_7332_1.png`
- asset id: `asset-006387`
...
- source class: `HUST-OBC/undeciphered/X/350/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/350/X_？_7332_1.png`
- asset id: `asset-006387`
...
- English observation: `rounded enclosure, internal band, and lower terminal`
- 中文观察: `圆钝围合、内部带状结构和下部末端`
...
- Which source records identify obs-unk-004794 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004794？
