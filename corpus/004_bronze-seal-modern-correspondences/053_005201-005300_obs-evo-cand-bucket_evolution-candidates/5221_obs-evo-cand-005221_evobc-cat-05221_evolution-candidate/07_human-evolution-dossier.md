...
Project ID: `obs-evo-cand-005221`
...
- Project ID: `obs-evo-cand-005221`
- EVOBC category candidate ID: `evobc-evo-cat-05221`
- External category reference: `evobc-cat-05221`
- Source category ID: `05221`
- Source label for human review: `牻`
- Source codepoints: `U+727B`
...
- `obs-evo-cand-005221-route-category-staging`
...
- `obs-evo-cand-005221-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005221-route-evolution-graph`
