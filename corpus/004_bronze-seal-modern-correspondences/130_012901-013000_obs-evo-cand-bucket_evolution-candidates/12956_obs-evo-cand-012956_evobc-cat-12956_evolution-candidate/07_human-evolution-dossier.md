...
Project ID: `obs-evo-cand-012956`
...
- Project ID: `obs-evo-cand-012956`
- EVOBC category candidate ID: `evobc-evo-cat-12956`
- External category reference: `evobc-cat-12956`
- Source category ID: `12956`
- Source label for human review: `𫒉`
- Source codepoints: `U+2B489`
...
- `obs-evo-cand-012956-route-category-staging`
...
- `obs-evo-cand-012956-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012956-route-evolution-graph`
