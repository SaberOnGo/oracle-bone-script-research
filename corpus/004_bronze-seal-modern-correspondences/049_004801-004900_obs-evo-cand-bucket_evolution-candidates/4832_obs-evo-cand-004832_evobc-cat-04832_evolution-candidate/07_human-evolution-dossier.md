...
Project ID: `obs-evo-cand-004832`
...
- Project ID: `obs-evo-cand-004832`
- EVOBC category candidate ID: `evobc-evo-cat-04832`
- External category reference: `evobc-cat-04832`
- Source category ID: `04832`
- Source label for human review: `滄`
- Source codepoints: `U+6EC4`
...
- `obs-evo-cand-004832-route-category-staging`
...
- `obs-evo-cand-004832-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004832-route-evolution-graph`
