...
- `obs-evo-cand-002001-route-category-staging`
...
- `obs-evo-cand-002001-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002001-route-evolution-graph`
