# Material Visual Observation / obs-comp-cand-001056 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001056`
- External reference / 外部参照: `obimd-sub-iocxq8h80p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014606_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jcsf6ohzo1/iocxq8h80p/iocxq8h80p.png`
- Checksum / 校验和:
  `09718e1ae2d96861239537f12a06e32de3533333c167fe20b281fbbfd5f0286f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.25%.
- Marked-pixel bounds: (89,28)–(160,226); span 72 × 199 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.25%。
- 痕迹范围：(89,28)–(160,226)；跨度72 × 199 px；痕迹矩形高于宽。
