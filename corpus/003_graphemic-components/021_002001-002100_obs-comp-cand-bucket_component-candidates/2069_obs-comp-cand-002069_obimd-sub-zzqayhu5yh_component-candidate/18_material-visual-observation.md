# Material Visual Observation / obs-comp-cand-002069 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002069`
- External reference / 外部参照: `obimd-sub-zzqayhu5yh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019456_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0tk0pmitom/zzqayhu5yh/zzqayhu5yh.png`
- Checksum / 校验和:
  `b8968148a3fe8718fb380597ca3fe6af03704948d5d5b670f5d9ef750fd246c3`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.77%.
- Marked-pixel bounds: (66,19)–(191,229); span 126 × 211 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.77%。
- 痕迹范围：(66,19)–(191,229)；跨度126 × 211 px；痕迹矩形高于宽。
