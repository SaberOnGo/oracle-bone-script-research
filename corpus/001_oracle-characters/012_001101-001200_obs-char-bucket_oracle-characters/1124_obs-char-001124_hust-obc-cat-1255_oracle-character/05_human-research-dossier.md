# obs-char-001124 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1124_obs-char-001124_hust-obc-cat-1255_ora
  cle-character/03_visual-assets/001_asset-001129_hust-obc-cat-1255_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1255/L_1255_1501.jpg`
- asset id: `asset-001129`
...
- source category: `1255`
- validation class: `1123`
- source image route: `HUST-OBC/deciphered/1255/L_1255_1501.jpg`
- asset id: `asset-001129`
...
- English observation: `A faint gray diagonal cluster has a pointed upper
  fork, a curved central stem, and short lower branches; contrast is low.`
- 中文观察: `较淡灰色斜向笔群有尖状上部分叉、弯曲中央笔干和短下部分枝；对比度较低。`
...
- dataset label text: `㣝`
- dataset label codepoints: `U+38DD`
...
- Which source records identify obs-char-001124 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001124？
