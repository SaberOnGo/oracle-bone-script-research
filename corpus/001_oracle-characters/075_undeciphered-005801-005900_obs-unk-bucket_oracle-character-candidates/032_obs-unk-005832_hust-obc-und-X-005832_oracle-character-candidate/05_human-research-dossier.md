# obs-unk-005832 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/075_undeciphered-005
  801-005900_obs-unk-bucket_oracle-character-candidates/032_obs-unk-005832_h
  ust-obc-und-X-005832_oracle-character-candidate/03_visual-assets/001_asset
  -007424_hust-obc-und-X-005832_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1388/X_？_1922_1.png`
- asset id: `asset-007424`
...
- source class: `HUST-OBC/undeciphered/X/1388/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1388/X_？_1922_1.png`
- asset id: `asset-007424`
...
- Which source records identify obs-unk-005832 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005832？
