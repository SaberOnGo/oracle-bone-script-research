# obs-unk-004930 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004930`
- primary external id: `hust-obc-und-X-004930`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/030_obs-unk-004930_h
  ust-obc-und-X-004930_oracle-character-candidate/03_visual-assets/001_asset
  -006523_hust-obc-und-X-004930_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/486/X_？_7470_1.png`
- asset id: `asset-006523`
...
- A tall outline contains stacked openings and a jagged lower branch.
...
- source class: `HUST-OBC/undeciphered/X/486/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/486/X_？_7470_1.png`
- asset id: `asset-006523`
...
- Which source records identify obs-unk-004930 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004930？
