# obs-comp-cand-000172 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000172`
- 首选外部 ID: `obimd-sub-lebb92n5gt`
- OBIMD subcharacter UID: `lebb92n5gt`
- OBIMD main character UID: `lebb92n5gt`
- 来源 ID: `src-obimd`
