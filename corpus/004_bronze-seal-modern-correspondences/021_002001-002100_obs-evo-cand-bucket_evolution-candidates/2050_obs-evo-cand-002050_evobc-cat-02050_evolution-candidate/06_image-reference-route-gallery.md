...
- `obs-evo-cand-002050-route-category-staging`
...
- `obs-evo-cand-002050-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002050-route-evolution-graph`
