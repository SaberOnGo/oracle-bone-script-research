# obs-unk-000001 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000001`
- primary external id: `hust-obc-und-L-000001`
...
- local review image route: `corpus/001_oracle-characters/017_undeciphered-000
  001-000100_obs-unk-bucket_oracle-character-candidates/001_obs-unk-000001_h
  ust-obc-und-L-000001_oracle-character-candidate/03_visual-assets/001_asset
  -001594_hust-obc-und-L-000001_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/1/L_？_10000.jpg`
- asset id: `asset-001594`
...
- source class: `HUST-OBC/undeciphered/L/1/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/1/L_？_10000.jpg`
- asset id: `asset-001594`
...
- Which source records identify obs-unk-000001 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000001？
