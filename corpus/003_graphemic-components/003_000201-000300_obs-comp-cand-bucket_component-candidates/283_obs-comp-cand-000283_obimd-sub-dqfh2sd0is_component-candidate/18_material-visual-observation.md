# Material Visual Observation / obs-comp-cand-000283 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000283`
- External reference / 外部参照: `obimd-sub-dqfh2sd0is`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011925_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/g8k12dfmg6/dqfh2sd0is/dqfh2sd0is.png`
- Checksum / 校验和:
  `23e182031ceef913706cd94d9b01575f4849c8cdcf34f3ab5e7502bedadaa291`
...
- Marked-pixel bounds: (48,41)–(201,207); span 154 × 167 px; the marked
...
- 痕迹范围：(48,41)–(201,207)；跨度154 × 167 px；痕迹矩形近方形。
