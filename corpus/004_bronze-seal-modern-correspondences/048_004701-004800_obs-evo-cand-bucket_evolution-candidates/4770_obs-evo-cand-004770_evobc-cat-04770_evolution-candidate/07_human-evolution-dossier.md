...
- External category reference: `evobc-cat-04770`
- Source category ID: `04770`
- Source label for human review: `渻`
...
- `obs-evo-cand-004770-route-category-staging`
...
- `obs-evo-cand-004770-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004770-route-evolution-graph`
