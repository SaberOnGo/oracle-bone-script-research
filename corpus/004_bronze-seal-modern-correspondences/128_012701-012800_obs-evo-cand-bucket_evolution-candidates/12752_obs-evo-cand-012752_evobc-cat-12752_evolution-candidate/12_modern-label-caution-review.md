# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012752
...
- EVOBC candidate category: `evobc-evo-cat-12752`.
- Source label for search only: `𪏮`.
- Source codepoints for search only: `U+2A3EE`.
