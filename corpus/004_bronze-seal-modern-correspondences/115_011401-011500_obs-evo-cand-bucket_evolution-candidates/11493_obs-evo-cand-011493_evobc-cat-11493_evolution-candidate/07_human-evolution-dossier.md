...
Project ID: `obs-evo-cand-011493`
...
- Project ID: `obs-evo-cand-011493`
- EVOBC category candidate ID: `evobc-evo-cat-11493`
- External category reference: `evobc-cat-11493`
- Source category ID: `11493`
- Source label for human review: `𣪴`
- Source codepoints: `U+23AB4`
...
- `obs-evo-cand-011493-route-category-staging`
...
- `obs-evo-cand-011493-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011493-route-evolution-graph`
