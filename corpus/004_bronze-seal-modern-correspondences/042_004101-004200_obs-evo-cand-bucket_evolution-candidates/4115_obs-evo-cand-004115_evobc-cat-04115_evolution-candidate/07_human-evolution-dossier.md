...
Project ID: `obs-evo-cand-004115`
...
- Project ID: `obs-evo-cand-004115`
- EVOBC category candidate ID: `evobc-evo-cat-04115`
- External category reference: `evobc-cat-04115`
- Source category ID: `04115`
- Source label for human review: `椃`
- Source codepoints: `U+6903`
...
- `obs-evo-cand-004115-route-category-staging`
...
- `obs-evo-cand-004115-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004115-route-evolution-graph`
