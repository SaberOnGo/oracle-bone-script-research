...
- External category reference: `evobc-cat-01678`
- Source category ID: `01678`
- Source label for human review: `嗢`
- Source codepoints: `U+55E2`
...
- `obs-evo-cand-001678-route-category-staging`
...
- `obs-evo-cand-001678-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001678-route-evolution-graph`
