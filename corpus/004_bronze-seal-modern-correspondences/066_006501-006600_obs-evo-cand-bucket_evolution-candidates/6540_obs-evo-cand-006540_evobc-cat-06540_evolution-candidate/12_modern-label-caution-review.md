# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006540
...
- EVOBC candidate category: `evobc-evo-cat-06540`.
- Source label for search only: `綌`.
- Source codepoints for search only: `U+7D8C`.
