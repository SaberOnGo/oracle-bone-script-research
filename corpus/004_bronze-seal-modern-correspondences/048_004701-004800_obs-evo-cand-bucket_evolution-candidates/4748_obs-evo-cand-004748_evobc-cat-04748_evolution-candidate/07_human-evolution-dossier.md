...
Project ID: `obs-evo-cand-004748`
...
- Project ID: `obs-evo-cand-004748`
- EVOBC category candidate ID: `evobc-evo-cat-04748`
- External category reference: `evobc-cat-04748`
- Source category ID: `04748`
- Source label for human review: `渊`
- Source codepoints: `U+6E0A`
...
- `obs-evo-cand-004748-route-category-staging`
...
- `obs-evo-cand-004748-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004748-route-evolution-graph`
