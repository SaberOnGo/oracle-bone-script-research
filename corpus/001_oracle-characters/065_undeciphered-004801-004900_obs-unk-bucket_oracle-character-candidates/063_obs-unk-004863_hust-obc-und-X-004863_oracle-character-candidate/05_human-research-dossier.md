# obs-unk-004863 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/063_obs-unk-004863_h
  ust-obc-und-X-004863_oracle-character-candidate/03_visual-assets/001_asset
  -006456_hust-obc-und-X-004863_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/419/X_？_7403_1.png`
- asset id: `asset-006456`
...
- source class: `HUST-OBC/undeciphered/X/419/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/419/X_？_7403_1.png`
- asset id: `asset-006456`
...
- English observation: `dense upper group and lower U-shaped opening`
- 中文观察: `上部密集结构和下部 U 形开口`
...
- Which source records identify obs-unk-004863 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004863？
