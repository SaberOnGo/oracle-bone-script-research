...
- External category reference: `evobc-cat-00410`
- Source category ID: `00410`
- Source label for human review: `䘸`
...
- `obs-evo-cand-000410-route-category-staging`
...
- `obs-evo-cand-000410-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000410-route-evolution-graph`
