...
- External category reference: `evobc-cat-12337`
- Source category ID: `12337`
- Source label for human review: `𨏵`
- Source codepoints: `U+283F5`
...
- `obs-evo-cand-012337-route-category-staging`
...
- `obs-evo-cand-012337-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012337-route-evolution-graph`
