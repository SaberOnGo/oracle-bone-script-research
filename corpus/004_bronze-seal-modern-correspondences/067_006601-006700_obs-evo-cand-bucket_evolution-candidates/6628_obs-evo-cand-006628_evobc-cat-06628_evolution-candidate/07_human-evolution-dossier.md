...
Project ID: `obs-evo-cand-006628`
...
- Project ID: `obs-evo-cand-006628`
- EVOBC category candidate ID: `evobc-evo-cat-06628`
- External category reference: `evobc-cat-06628`
- Source category ID: `06628`
- Source label for human review: `縐`
- Source codepoints: `U+7E10`
...
- `obs-evo-cand-006628-route-category-staging`
...
- `obs-evo-cand-006628-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006628-route-evolution-graph`
