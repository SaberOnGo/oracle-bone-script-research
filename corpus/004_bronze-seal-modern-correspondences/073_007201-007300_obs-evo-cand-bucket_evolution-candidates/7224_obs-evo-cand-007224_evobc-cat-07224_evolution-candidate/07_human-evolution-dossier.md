...
Project ID: `obs-evo-cand-007224`
...
- Project ID: `obs-evo-cand-007224`
- EVOBC category candidate ID: `evobc-evo-cat-07224`
- External category reference: `evobc-cat-07224`
- Source category ID: `07224`
- Source label for human review: `艼`
- Source codepoints: `U+827C`
...
- `obs-evo-cand-007224-route-category-staging`
...
- `obs-evo-cand-007224-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007224-route-evolution-graph`
