...
- External category reference: `evobc-cat-13159`
- Source category ID: `13159`
- Source label for human review: `𫻯`
...
- `obs-evo-cand-013159-route-category-staging`
...
- `obs-evo-cand-013159-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013159-route-evolution-graph`
