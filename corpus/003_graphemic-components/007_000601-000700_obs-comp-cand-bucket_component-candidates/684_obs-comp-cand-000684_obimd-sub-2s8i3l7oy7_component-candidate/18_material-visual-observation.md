# Material Visual Observation / obs-comp-cand-000684 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000684`
- External reference / 外部参照: `obimd-sub-2s8i3l7oy7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013283_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2s8i3l7oy7/2s8i3l7oy7/2s8i3l7oy7.png`
- Checksum / 校验和:
  `4b262cc2cbc437c4434f060d437176afd37ce6238a03e26505ba79ed755bfbc4`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.91%.
- Marked-pixel bounds: (53,45)–(196,207); span 144 × 163 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.91%。
- 痕迹范围：(53,45)–(196,207)；跨度144 × 163 px；痕迹矩形近方形。
