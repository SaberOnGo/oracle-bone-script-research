# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001692
...
- EVOBC candidate category: `evobc-evo-cat-01692`.
- Source label for search only: `嘌`.
- Source codepoints for search only: `U+560C`.
