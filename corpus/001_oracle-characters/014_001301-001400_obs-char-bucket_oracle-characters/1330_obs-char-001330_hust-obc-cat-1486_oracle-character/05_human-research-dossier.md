# obs-char-001330 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001330`
- primary external id: `hust-obc-cat-1486`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1330_obs-char-001330_hust-obc-cat-1486_ora
  cle-character/03_visual-assets/001_asset-001335_hust-obc-cat-1486_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1486/G_1486_後2.42.8合30273無名組.pn
  g`
- asset id: `asset-001335`
...
- source category: `1486`
- validation class: `1329`
- source image route: `HUST-OBC/deciphered/1486/G_1486_後2.42.8合30273無名組.png`
- asset id: `asset-001335`
...
- English observation: `Separated marks include a small upper chevron, a
  short left stroke, and a long curved right branch.`
- 中文观察: `分离标记包括小型上部尖折笔、短左侧笔和长弯曲右侧分枝。`
...
- dataset label text: `㧄`
- dataset label codepoints: `U+39C4`
...
- filename catalog route clues: `Heji-like filename clue: 合30273
...
- Which source records identify obs-char-001330 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001330？
