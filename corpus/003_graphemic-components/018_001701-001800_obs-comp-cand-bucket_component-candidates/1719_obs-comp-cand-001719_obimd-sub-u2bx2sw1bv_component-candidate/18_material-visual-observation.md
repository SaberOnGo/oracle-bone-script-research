# Material Visual Observation / obs-comp-cand-001719 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001719`
- External reference / 外部参照: `obimd-sub-u2bx2sw1bv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017898_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/u2bx2sw1bv/u2bx2sw1bv/u2bx2sw1bv.png`
- Checksum / 校验和:
  `325d55122b9e77801535e1bb00e8a40a13361bd425df922bf4e6dc92b271338c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.57%.
- Marked-pixel bounds: (77,19)–(169,227); span 93 × 209 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.57%。
- 痕迹范围：(77,19)–(169,227)；跨度93 × 209 px；痕迹矩形高于宽。
