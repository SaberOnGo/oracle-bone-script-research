# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010562
...
- EVOBC candidate category: `evobc-evo-cat-10562`.
- Source label for search only: `鷮`.
- Source codepoints for search only: `U+9DEE`.
