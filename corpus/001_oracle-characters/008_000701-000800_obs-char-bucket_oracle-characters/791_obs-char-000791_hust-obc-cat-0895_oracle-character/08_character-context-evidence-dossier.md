...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0895`
...
- Source image / 来源图: `G_0895_乙1206合974賓組.png`
- Image / 图像: `001_asset-000796_hust-obc-cat-0895_glyph.png`
...
- target node: `obimd-main-cand-000853`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- target node: `evobc-evo-cat-00078`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC image references / EvoBC 图像引用数: `52`
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/078_obs-evo-cand-000078_evobc-cat-00078_evoluti
...
- Matched OBIMD main UIDs / OBIMD 主字 UID: `e19hd5tm0i`
...
- Source label text / 来源标签文字: `㝵`
- Source label codepoint / 来源标签 codepoint: `U+3775`
