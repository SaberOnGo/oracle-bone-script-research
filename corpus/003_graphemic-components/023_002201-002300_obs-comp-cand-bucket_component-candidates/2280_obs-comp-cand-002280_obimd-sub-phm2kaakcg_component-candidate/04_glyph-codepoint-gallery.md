# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002280
...
| --- | --- | --- | --- |
| `obimd-glyph-link-035237` | 辥󽆤 | `U+8FA5;U+FD1A4` | `reviewed_metadata_only` |
| `obimd-glyph-link-035238` | 󽆦 | `U+FD1A6` | `reviewed_metadata_only` |
| `obimd-glyph-link-035239` | 󽆧 | `U+FD1A7` | `reviewed_metadata_only` |
| `obimd-glyph-link-035240` | 󽆥 | `U+FD1A5` | `reviewed_metadata_only` |
