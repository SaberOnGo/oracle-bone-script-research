# obs-char-000755 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000755`
- primary external id: `hust-obc-cat-0857`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/755_obs-char-000755_hust-obc-cat-0857_orac
  le-character/03_visual-assets/001_asset-000760_hust-obc-cat-0857_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0857/H_0857_610C7_0.png`
- asset id: `asset-000760`
...
- source category: `0857`
- validation class: `754`
- source image route: `HUST-OBC/deciphered/0857/H_0857_610C7_0.png`
- asset id: `asset-000760`
...
- English observation: `A single tall curved upright bends into a long
  horizontal foot at the bottom and carries one short descending diagonal
  branch near its pointed upper end.`
...
- dataset label text: `㝏`
- dataset label codepoints: `U+374F`
...
- filename catalog route clues: `catalog-like filename clue: H_0857
  (H_0857_610C7_0.png)`
...
- Which source records identify obs-char-000755 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000755？
