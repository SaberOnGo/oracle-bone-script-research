...
- External category reference: `evobc-cat-01057`
- Source category ID: `01057`
- Source label for human review: `儲`
...
- `obs-evo-cand-001057-route-category-staging`
...
- `obs-evo-cand-001057-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001057-route-evolution-graph`
