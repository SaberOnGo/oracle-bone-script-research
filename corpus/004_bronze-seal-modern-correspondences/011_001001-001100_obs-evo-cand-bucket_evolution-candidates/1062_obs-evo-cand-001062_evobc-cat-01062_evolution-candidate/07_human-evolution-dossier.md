...
Project ID: `obs-evo-cand-001062`
...
- Project ID: `obs-evo-cand-001062`
- EVOBC category candidate ID: `evobc-evo-cat-01062`
- External category reference: `evobc-cat-01062`
- Source category ID: `01062`
- Source label for human review: `儽`
- Source codepoints: `U+513D`
...
- `obs-evo-cand-001062-route-category-staging`
...
- `obs-evo-cand-001062-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001062-route-evolution-graph`
