# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000613
...
- EVOBC candidate category: `evobc-evo-cat-00613`.
- Source label for search only: `不`.
- Source codepoints for search only: `U+4E0D`.
