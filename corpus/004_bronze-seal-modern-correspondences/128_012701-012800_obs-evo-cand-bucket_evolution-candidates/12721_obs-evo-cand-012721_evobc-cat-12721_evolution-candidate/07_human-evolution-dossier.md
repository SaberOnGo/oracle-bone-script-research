...
Project ID: `obs-evo-cand-012721`
...
- Project ID: `obs-evo-cand-012721`
- EVOBC category candidate ID: `evobc-evo-cat-12721`
- External category reference: `evobc-cat-12721`
- Source category ID: `12721`
- Source label for human review: `𪀃`
- Source codepoints: `U+2A003`
...
- `obs-evo-cand-012721-route-category-staging`
...
- `obs-evo-cand-012721-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012721-route-evolution-graph`
