...
- External category reference: `evobc-cat-02379`
- Source category ID: `02379`
- Source label for human review: `宝`
- Source codepoints: `U+5B9D`
...
- `obs-evo-cand-002379-route-category-staging`
...
- `obs-evo-cand-002379-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002379-route-evolution-graph`
