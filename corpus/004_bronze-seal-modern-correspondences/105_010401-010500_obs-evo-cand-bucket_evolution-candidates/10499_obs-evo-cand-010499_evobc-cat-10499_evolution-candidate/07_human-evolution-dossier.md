...
Project ID: `obs-evo-cand-010499`
...
- Project ID: `obs-evo-cand-010499`
- EVOBC category candidate ID: `evobc-evo-cat-10499`
- External category reference: `evobc-cat-10499`
- Source category ID: `10499`
- Source label for human review: `鴩`
- Source codepoints: `U+9D29`
...
- `obs-evo-cand-010499-route-category-staging`
...
- `obs-evo-cand-010499-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010499-route-evolution-graph`
