...
- External category reference: `evobc-cat-08777`
- Source category ID: `08777`
- Source label for human review: `躋`
...
- `obs-evo-cand-008777-route-category-staging`
...
- `obs-evo-cand-008777-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008777-route-evolution-graph`
