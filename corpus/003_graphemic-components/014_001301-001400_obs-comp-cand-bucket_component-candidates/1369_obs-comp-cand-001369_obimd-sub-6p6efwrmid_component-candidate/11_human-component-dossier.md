# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-001369
...
- candidate_component_id: `obs-comp-cand-001369`
- primary_external_ref_id: `obimd-sub-6p6efwrmid`
- source_subcharacter_uid: `6p6efwrmid`
- source_main_character_uid: `6p6efwrmid`
- main_character_external_ref_id: `obimd-main-6p6efwrmid`
...
- glyph_codepoint_uplus_sample: `U+F7CCF, U+F7CD0, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-015788` | `001_asset-015788_img.png` | `cbf57e303b8cdd4c822eea55cd9dde3018a0504789d71395d1a41d39fac4193d` |
