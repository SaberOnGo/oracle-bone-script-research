# obs-comp-cand-002183 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002183`
- 首选外部 ID: `obimd-sub-a5yunoxatt`
- OBIMD subcharacter UID: `a5yunoxatt`
- OBIMD main character UID: `a5yunoxatt`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+5099;U+F4ABC; U+F4ABD
