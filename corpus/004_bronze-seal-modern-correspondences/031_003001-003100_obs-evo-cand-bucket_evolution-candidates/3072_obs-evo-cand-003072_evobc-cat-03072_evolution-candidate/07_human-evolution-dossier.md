...
- External category reference: `evobc-cat-03072`
- Source category ID: `03072`
- Source label for human review: `愁`
- Source codepoints: `U+6101`
...
- `obs-evo-cand-003072-route-category-staging`
...
- `obs-evo-cand-003072-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003072-route-evolution-graph`
