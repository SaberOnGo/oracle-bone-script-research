# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006751
...
- EVOBC candidate category: `evobc-evo-cat-06751`.
- Source label for search only: `绝`.
- Source codepoints for search only: `U+7EDD`.
