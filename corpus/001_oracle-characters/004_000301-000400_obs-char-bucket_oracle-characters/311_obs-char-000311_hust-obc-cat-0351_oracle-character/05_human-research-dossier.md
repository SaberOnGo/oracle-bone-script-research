# obs-char-000311 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000311`
- primary external id: `hust-obc-cat-0351`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/311_obs-char-000311_hust-obc-cat-0351_orac
  le-character/03_visual-assets/001_asset-000316_hust-obc-cat-0351_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0351/G_0351_乙1984反合902反賓組.png`
- asset id: `asset-000316`
...
- source category: `0351`
- validation class: `310`
- source image route: `HUST-OBC/deciphered/0351/G_0351_乙1984反合902反賓組.png`
- asset id: `asset-000316`
...
- English observation: `A tall central vertical stroke has an upper
  branching cross form, a small left lower enclosure, and a short horizontal
  foot.`
- 中文观察: `图像有高直中轴，上方为分叉交叉形，左下方有小型闭合轮廓，底部有短横笔画。`
...
- dataset label text: `㕕`
- dataset label codepoints: `U+3555`
...
- Which source records identify obs-char-000311 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000311？
