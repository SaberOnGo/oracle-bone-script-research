...
Project ID: `obs-evo-cand-001034`
...
- Project ID: `obs-evo-cand-001034`
- EVOBC category candidate ID: `evobc-evo-cat-01034`
- External category reference: `evobc-cat-01034`
- Source category ID: `01034`
- Source label for human review: `僻`
- Source codepoints: `U+50FB`
...
- `obs-evo-cand-001034-route-category-staging`
...
- `obs-evo-cand-001034-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001034-route-evolution-graph`
