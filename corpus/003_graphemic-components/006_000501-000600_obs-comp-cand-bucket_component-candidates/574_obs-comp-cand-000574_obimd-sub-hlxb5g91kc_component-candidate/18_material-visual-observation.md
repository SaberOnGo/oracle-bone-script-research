# Material Visual Observation / obs-comp-cand-000574 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000574`
- External reference / 外部参照: `obimd-sub-hlxb5g91kc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012826_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hlxb5g91kc/hlxb5g91kc/01x617r92n.png`
- Checksum / 校验和:
  `50bf436d584c7111b10d3fbbbece41ed6d12144f7d69176e8b88b2b68fee0d8e`
...
- Marked-pixel bounds: (85,47)–(164,203); span 80 × 157 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.09%。
- 痕迹范围：(85,47)–(164,203)；跨度80 × 157 px；痕迹矩形高于宽。
