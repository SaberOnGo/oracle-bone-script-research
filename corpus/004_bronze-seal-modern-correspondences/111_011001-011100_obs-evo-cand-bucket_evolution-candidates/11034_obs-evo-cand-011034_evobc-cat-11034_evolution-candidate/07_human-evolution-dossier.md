...
Project ID: `obs-evo-cand-011034`
...
- Project ID: `obs-evo-cand-011034`
- EVOBC category candidate ID: `evobc-evo-cat-11034`
- External category reference: `evobc-cat-11034`
- Source category ID: `11034`
- Source label for human review: `𡛳`
- Source codepoints: `U+216F3`
...
- `obs-evo-cand-011034-route-category-staging`
...
- `obs-evo-cand-011034-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011034-route-evolution-graph`
