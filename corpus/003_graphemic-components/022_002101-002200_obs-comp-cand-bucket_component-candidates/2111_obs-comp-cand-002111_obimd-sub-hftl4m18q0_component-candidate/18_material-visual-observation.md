# Material Visual Observation / obs-comp-cand-002111 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002111`
- External reference / 外部参照: `obimd-sub-hftl4m18q0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019562_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hftl4m18q0/hftl4m18q0/0nz29z0nh1.png`
- Checksum / 校验和:
  `7d36840b88adfb859657f74806f5d09508b807596986507f77915ebbd3134f9f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.89%.
- Marked-pixel bounds: (66,39)–(183,204); span 118 × 166 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.89%。
- 痕迹范围：(66,39)–(183,204)；跨度118 × 166 px；痕迹矩形高于宽。
