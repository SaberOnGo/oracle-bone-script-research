# obs-char-000738 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000738`
- primary external id: `hust-obc-cat-0840`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/738_obs-char-000738_hust-obc-cat-0840_orac
  le-character/03_visual-assets/001_asset-000743_hust-obc-cat-0840_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0840/G_0840_七卩67(甲).png`
- asset id: `asset-000743`
...
- source category: `0840`
- validation class: `737`
- source image route: `HUST-OBC/deciphered/0840/G_0840_七卩67(甲).png`
- asset id: `asset-000743`
...
- English observation: `A tilted polygonal loop rests on a short horizontal
  base at left; a separate right upright crosses a diagonal and divides into
  several upper and lower branches.`
- 中文观察: `左侧倾斜多边环立于短横底线上；右侧独立竖笔与斜笔交叉，并分出数条上下支笔。`
...
- dataset label text: `㜾`
- dataset label codepoints: `U+373E`
...
- Which source records identify obs-char-000738 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000738？
