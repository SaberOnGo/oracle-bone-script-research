...
- `obs-evo-cand-007977-route-category-staging`
...
- `obs-evo-cand-007977-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-007977-route-evolution-graph`
