...
- External category reference: `evobc-cat-10557`
- Source category ID: `10557`
- Source label for human review: `鷟`
...
- `obs-evo-cand-010557-route-category-staging`
...
- `obs-evo-cand-010557-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010557-route-evolution-graph`
