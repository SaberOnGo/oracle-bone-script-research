...
- External category reference: `evobc-cat-01273`
- Source category ID: `01273`
- Source label for human review: `劬`
- Source codepoints: `U+52AC`
...
- `obs-evo-cand-001273-route-category-staging`
...
- `obs-evo-cand-001273-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001273-route-evolution-graph`
