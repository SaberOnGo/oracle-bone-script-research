...
- External category reference: `evobc-cat-00637`
- Source category ID: `00637`
- Source label for human review: `丯`
- Source codepoints: `U+4E2F`
...
- `obs-evo-cand-000637-route-category-staging`
...
- `obs-evo-cand-000637-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000637-route-evolution-graph`
