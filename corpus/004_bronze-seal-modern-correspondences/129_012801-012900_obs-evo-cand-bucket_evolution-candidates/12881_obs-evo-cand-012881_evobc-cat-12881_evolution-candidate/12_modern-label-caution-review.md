# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012881
...
- EVOBC candidate category: `evobc-evo-cat-12881`.
- Source label for search only: `𪷾`.
- Source codepoints for search only: `U+2ADFE`.
