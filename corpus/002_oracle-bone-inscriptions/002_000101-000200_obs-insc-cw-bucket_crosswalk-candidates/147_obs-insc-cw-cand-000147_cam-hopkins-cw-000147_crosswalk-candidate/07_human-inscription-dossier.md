...
- Yingguo / 英国所藏: `y818` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `14` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `373` in source row; primary catalog entry pending
- Heji / 合集: `40118` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000147`
