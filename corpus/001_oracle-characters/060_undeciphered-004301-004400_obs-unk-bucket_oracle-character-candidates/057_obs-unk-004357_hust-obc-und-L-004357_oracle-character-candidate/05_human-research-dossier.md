# obs-unk-004357 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/057_obs-unk-004357_h
  ust-obc-und-L-004357_oracle-character-candidate/03_visual-assets/001_asset
  -005950_hust-obc-und-L-004357_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4357/L_？_9661.jpg`
- asset id: `asset-005950`
...
- source class: `HUST-OBC/undeciphered/L/4357/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4357/L_？_9661.jpg`
- asset id: `asset-005950`
...
- English observation: `Right vertical trace, upper cluster, and lower curve`
  `recorded.`
- 中文观察: `已记录右侧纵痕、上部痕迹簇和下部弯痕。`
...
- Which source records identify obs-unk-004357 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004357？
