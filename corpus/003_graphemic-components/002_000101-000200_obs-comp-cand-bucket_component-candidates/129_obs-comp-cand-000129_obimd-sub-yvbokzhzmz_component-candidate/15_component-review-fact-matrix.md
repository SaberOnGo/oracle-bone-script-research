# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000129
...
| Glyph or codepoint route / 字形或码位路线 | 3 OBIMD route rows; examples U+5DDD;U+F0C2D; U+F0C2E; 另有 1 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
