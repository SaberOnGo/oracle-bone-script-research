# obs-char-000691 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/691_obs-char-000691_hust-obc-cat-0782_orac
  le-character/03_visual-assets/001_asset-000696_hust-obc-cat-0782_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0782/G_0782_京津3261(甲).png`
- asset id: `asset-000696`
...
- source category: `0782`
- validation class: `690`
- source image route: `HUST-OBC/deciphered/0782/G_0782_京津3261(甲).png`
- asset id: `asset-000696`
...
- English observation: `A rounded rectangular loop with a short inner
  horizontal stands at left; a separate tall wavering stroke at right begins
  with a dark hooked top and narrows downward.`
...
- dataset label text: `㜄`
- dataset label codepoints: `U+3704`
...
- Which source records identify obs-char-000691 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000691？
