...
Project ID: `obs-evo-cand-010458`
...
- Project ID: `obs-evo-cand-010458`
- EVOBC category candidate ID: `evobc-evo-cat-10458`
- External category reference: `evobc-cat-10458`
- Source category ID: `10458`
- Source label for human review: `鱺`
- Source codepoints: `U+9C7A`
...
- `obs-evo-cand-010458-route-category-staging`
...
- `obs-evo-cand-010458-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010458-route-evolution-graph`
