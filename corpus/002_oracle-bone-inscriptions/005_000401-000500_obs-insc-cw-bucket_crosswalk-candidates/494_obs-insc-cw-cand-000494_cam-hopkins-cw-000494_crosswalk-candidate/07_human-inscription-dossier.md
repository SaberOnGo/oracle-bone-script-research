...
- Yingguo / 英国所藏: `y2422` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `333` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `200` in source row; primary catalog entry pending
- Heji / 合集: `41527` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000494`
