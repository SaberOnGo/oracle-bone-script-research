...
Project ID: `obs-evo-cand-013598`
...
- Project ID: `obs-evo-cand-013598`
- EVOBC category candidate ID: `evobc-evo-cat-13598`
- External category reference: `evobc-cat-13598`
- Source category ID: `13598`
- Source label for human review: `𮃸`
- Source codepoints: `U+2E0F8`
...
- `obs-evo-cand-013598-route-category-staging`
...
- `obs-evo-cand-013598-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013598-route-evolution-graph`
