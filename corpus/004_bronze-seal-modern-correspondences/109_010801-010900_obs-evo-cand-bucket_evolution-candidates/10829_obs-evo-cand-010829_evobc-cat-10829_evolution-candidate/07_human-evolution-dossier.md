...
- External category reference: `evobc-cat-10829`
- Source category ID: `10829`
- Source label for human review: `𠒋`
- Source codepoints: `U+2048B`
...
- `obs-evo-cand-010829-route-category-staging`
...
- `obs-evo-cand-010829-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010829-route-evolution-graph`
