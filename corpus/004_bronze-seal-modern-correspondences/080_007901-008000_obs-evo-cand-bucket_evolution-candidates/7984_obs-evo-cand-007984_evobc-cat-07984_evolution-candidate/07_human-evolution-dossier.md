...
- External category reference: `evobc-cat-07984`
- Source category ID: `07984`
- Source label for human review: `裨`
- Source codepoints: `U+88E8`
...
- `obs-evo-cand-007984-route-category-staging`
...
- `obs-evo-cand-007984-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007984-route-evolution-graph`
