# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008155
...
- EVOBC candidate category: `evobc-evo-cat-08155`.
- Source label for search only: `訯`.
- Source codepoints for search only: `U+8A2F`.
