...
- External category reference: `evobc-cat-02831`
- Source category ID: `02831`
- Source label for human review: `归`
...
- `obs-evo-cand-002831-route-category-staging`
...
- `obs-evo-cand-002831-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002831-route-evolution-graph`
