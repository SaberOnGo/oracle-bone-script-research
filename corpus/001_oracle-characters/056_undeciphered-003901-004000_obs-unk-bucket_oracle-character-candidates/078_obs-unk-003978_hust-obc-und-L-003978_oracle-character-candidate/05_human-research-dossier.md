# obs-unk-003978 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003978`
- primary external id: `hust-obc-und-L-003978`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/078_obs-unk-003978_h
  ust-obc-und-L-003978_oracle-character-candidate/03_visual-assets/001_asset
  -005571_hust-obc-und-L-003978_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3978/L_？_8416.jpg`
- asset id: `asset-005571`
...
- source class: `HUST-OBC/undeciphered/L/3978/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3978/L_？_8416.jpg`
- asset id: `asset-005571`
...
- English observation: A separate left curve sits beside a dense cluster with
  crossing angular strokes and a short lower fork.
- 中文观察：分开左侧弧痕邻近紧凑痕迹组，组内有交叉折线和下方短分叉。
...
- Which source records identify obs-unk-003978 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003978？
