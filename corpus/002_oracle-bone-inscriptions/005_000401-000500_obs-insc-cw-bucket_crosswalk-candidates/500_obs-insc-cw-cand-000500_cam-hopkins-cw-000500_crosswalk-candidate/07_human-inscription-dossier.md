...
Project ID: `obs-insc-cw-cand-000500`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000500`
...
- Source page section: `Period IV Group 13` /
  `第 IV 期第 13 组`
- Source section key: `period-iv-group-13`
...
- Yingguo / 英国所藏: `y2439` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `582` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000500`
