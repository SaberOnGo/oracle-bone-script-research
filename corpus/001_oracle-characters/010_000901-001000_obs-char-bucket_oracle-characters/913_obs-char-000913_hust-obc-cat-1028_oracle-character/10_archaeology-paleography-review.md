# obs-char-000913 Archaeology Paleography Review

# obs-char-000913 考古文字复核档案
...
- first local image: `001_asset-000918_hust-obc-cat-1028_glyph.png`
- first source image: `G_1028_拾12.10(甲).png`
...
- source label text: `㟺`
- source label codepoints: `U+37FA`
