...
- 项目 ID: `obs-char-000633`
- 首选外部 ID: `hust-obc-cat-0720`
- 来源 ID: `src-hust-obc`
...
- 来源图像路线数: `1`
- 本地复核图像数: `1`
- 首个来源图像名: `G_0720_上(2).從(甲).10(楚).png`
- 首个本地图像名: `001_asset-000638_hust-obc-cat-0720_glyph.png`
