...
- External category reference: `evobc-cat-03392`
- Source category ID: `03392`
- Source label for human review: `掃`
- Source codepoints: `U+6383`
...
- `obs-evo-cand-003392-route-category-staging`
...
- `obs-evo-cand-003392-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003392-route-evolution-graph`
