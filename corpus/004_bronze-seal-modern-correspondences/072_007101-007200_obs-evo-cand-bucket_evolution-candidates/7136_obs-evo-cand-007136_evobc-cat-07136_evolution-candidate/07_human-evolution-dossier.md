...
Project ID: `obs-evo-cand-007136`
...
- Project ID: `obs-evo-cand-007136`
- EVOBC category candidate ID: `evobc-evo-cat-07136`
- External category reference: `evobc-cat-07136`
- Source category ID: `07136`
- Source label for human review: `膳`
- Source codepoints: `U+81B3`
...
- `obs-evo-cand-007136-route-category-staging`
...
- `obs-evo-cand-007136-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007136-route-evolution-graph`
