# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004665
...
- EVOBC candidate category: `evobc-evo-cat-04665`.
- Source label for search only: `浪`.
- Source codepoints for search only: `U+6D6A`.
