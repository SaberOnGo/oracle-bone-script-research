...
- External category reference: `evobc-cat-02931`
- Source category ID: `02931`
- Source label for human review: `怍`
- Source codepoints: `U+600D`
...
- `obs-evo-cand-002931-route-category-staging`
...
- `obs-evo-cand-002931-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002931-route-evolution-graph`
