...
- External category reference: `evobc-cat-01524`
- Source category ID: `01524`
- Source label for human review: `吺`
- Source codepoints: `U+543A`
...
- `obs-evo-cand-001524-route-category-staging`
...
- `obs-evo-cand-001524-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001524-route-evolution-graph`
